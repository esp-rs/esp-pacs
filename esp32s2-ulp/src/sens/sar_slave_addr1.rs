...
///Field `I2C_SLAVE_ADDR1` reader - RTC I2C slave address 1
pub type I2C_SLAVE_ADDR1_R = crate::FieldReader<u16>;
///Field `I2C_SLAVE_ADDR1` writer - RTC I2C slave address 1
pub type I2C_SLAVE_ADDR1_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `I2C_SLAVE_ADDR0` reader - RTC I2C slave address 0
pub type I2C_SLAVE_ADDR0_R = crate::FieldReader<u16>;
///Field `I2C_SLAVE_ADDR0` writer - RTC I2C slave address 0
