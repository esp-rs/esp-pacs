...
///Field `COCPU_TOUCH_DONE_INT_CLR` writer - TOUCH_DONE_INT interrupt clear bit
pub type COCPU_TOUCH_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_TOUCH_INACTIVE_INT_CLR` writer - TOUCH_INACTIVE_INT interrupt clear bit
pub type COCPU_TOUCH_INACTIVE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_TOUCH_ACTIVE_INT_CLR` writer - TOUCH_ACTIVE_INT interrupt clear bit
pub type COCPU_TOUCH_ACTIVE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC1_INT_CLR` writer - SARADC1_DONE_INT interrupt clear bit
pub type COCPU_SARADC1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_INT_CLR` writer - SARADC2_DONE_INT interrupt clear bit
pub type COCPU_SARADC2_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_TSENS_INT_CLR` writer - TSENS_DONE_INT interrupt clear bit
pub type COCPU_TSENS_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_START_INT_CLR` writer - RISCV_START_INT interrupt clear bit
pub type COCPU_START_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SW_INT_CLR` writer - SW_INT interrupt clear bit
pub type COCPU_SW_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SWD_INT_CLR` writer - SWD_INT interrupt clear bit
...
impl W {
    ///Bit 0 - TOUCH_DONE_INT interrupt clear bit
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 1 - TOUCH_INACTIVE_INT interrupt clear bit
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 2 - TOUCH_ACTIVE_INT interrupt clear bit
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`sar_cocpu_int_clr::W`](W) writer structure
