...
#[doc = "Field `ULP_CP_TIMER_SLP_CYCLE` reader - Set sleep cycles for ULP coprocessor timer"]
pub type ULP_CP_TIMER_SLP_CYCLE_R = crate::FieldReader<u32>;
#[doc = "Field `ULP_CP_TIMER_SLP_CYCLE` writer - Set sleep cycles for ULP coprocessor timer"]
...
impl W {
    #[doc = "Bits 8:31 - Set sleep cycles for ULP coprocessor timer"]
    #[inline(always)]
    pub fn ulp_cp_timer_slp_cycle(&mut self) -> ULP_CP_TIMER_SLP_CYCLE_W<'_, ULP_CP_TIMER_1_SPEC> {
        ULP_CP_TIMER_SLP_CYCLE_W::new(self, 8)
    }
}
#[doc = "Configure sleep cycle of the timer\n\nYou can [`read`](crate::Reg::read) this register and get [`ulp_cp_timer_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ulp_cp_timer_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
