...
///Field `SLP_SEL` reader - 1: enable sleep mode. 0: no sleep mode.
pub type SLP_SEL_R = crate::BitReader;
///Field `SLP_SEL` writer - 1: enable sleep mode. 0: no sleep mode.
...
///`read()` method returns [`rtc_pad20::R`](R) reader structure
impl crate::Readable for RTC_PAD20_SPEC {}
///`write(|w| ..)` method takes [`rtc_pad20::W`](W) writer structure
