///Register `SAR_I2C_IO` reader
pub type R = crate::R<SAR_I2C_IO_SPEC>;
///Register `SAR_I2C_IO` writer
pub type W = crate::W<SAR_I2C_IO_SPEC>;
///Field `SAR_DEBUG_BIT_SEL` reader -
pub type SAR_DEBUG_BIT_SEL_R = crate::FieldReader;
///Field `SAR_DEBUG_BIT_SEL` writer -
pub type SAR_DEBUG_BIT_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `SAR_I2C_SCL_SEL` reader - Selects a pad the RTC I2C SCL signal connects to. 0: use TOUCH PAD0. 1: use TOUCH PAD2.
pub type SAR_I2C_SCL_SEL_R = crate::FieldReader;
///Field `SAR_I2C_SCL_SEL` writer - Selects a pad the RTC I2C SCL signal connects to. 0: use TOUCH PAD0. 1: use TOUCH PAD2.
pub type SAR_I2C_SCL_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SAR_I2C_SDA_SEL` reader - Selects a pad the RTC I2C SDA signal connects to. 0: use TOUCH PAD1. 1: use TOUCH PAD3.
pub type SAR_I2C_SDA_SEL_R = crate::FieldReader;
///Field `SAR_I2C_SDA_SEL` writer - Selects a pad the RTC I2C SDA signal connects to. 0: use TOUCH PAD1. 1: use TOUCH PAD3.
...
impl R {
    ...
    ///Bits 28:29 - Selects a pad the RTC I2C SCL signal connects to. 0: use TOUCH PAD0. 1: use TOUCH PAD2.
    #[inline(always)]
    pub fn sar_i2c_scl_sel(&self) -> SAR_I2C_SCL_SEL_R {
        SAR_I2C_SCL_SEL_R::new(((self.bits >> 28) & 3) as u8)
    }
    ///Bits 30:31 - Selects a pad the RTC I2C SDA signal connects to. 0: use TOUCH PAD1. 1: use TOUCH PAD3.
    #[inline(always)]
...
///`read()` method returns [`sar_i2c_io::R`](R) reader structure
impl crate::Readable for SAR_I2C_IO_SPEC {}
///`write(|w| ..)` method takes [`sar_i2c_io::W`](W) writer structure
