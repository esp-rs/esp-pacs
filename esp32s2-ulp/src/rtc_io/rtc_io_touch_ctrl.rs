...
///`read()` method returns [`rtc_io_touch_ctrl::R`](R) reader structure
impl crate::Readable for RTC_IO_TOUCH_CTRL_SPEC {}
///`write(|w| ..)` method takes [`rtc_io_touch_ctrl::W`](W) writer structure
