...
///Field `SLAVE_ADDR` reader - slave address
pub type SLAVE_ADDR_R = crate::FieldReader<u16>;
///Field `SLAVE_ADDR` writer - slave address
pub type SLAVE_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `ADDR_10BIT_EN` reader - This field is used to enable the slave 10-bit addressing mode.
pub type ADDR_10BIT_EN_R = crate::BitReader;
///Field `ADDR_10BIT_EN` writer - This field is used to enable the slave 10-bit addressing mode.
...
impl R {
    ...
    ///Bit 31 - This field is used to enable the slave 10-bit addressing mode.
    #[inline(always)]
