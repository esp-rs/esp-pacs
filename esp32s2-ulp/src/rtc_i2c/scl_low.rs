...
///Field `PERIOD` reader - This register is used to configure how many clock cycles SCL remains low.
pub type PERIOD_R = crate::FieldReader<u32>;
///Field `PERIOD` writer - This register is used to configure how many clock cycles SCL remains low.
pub type PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19 - This register is used to configure how many clock cycles SCL remains low.
    #[inline(always)]
