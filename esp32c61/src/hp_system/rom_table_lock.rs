...
#[doc = "Field `ROM_TABLE_LOCK` reader - Configures whether or not to lock the value contained in HP_SYSTEM_ROM_TABLE. \\\\ 0: Unlock \\\\ 1: Lock \\\\"]
pub type ROM_TABLE_LOCK_R = crate::BitReader;
#[doc = "Field `ROM_TABLE_LOCK` writer - Configures whether or not to lock the value contained in HP_SYSTEM_ROM_TABLE. \\\\ 0: Unlock \\\\ 1: Lock \\\\"]
pub type ROM_TABLE_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether or not to lock the value contained in HP_SYSTEM_ROM_TABLE. \\\\ 0: Unlock \\\\ 1: Lock \\\\"]
    #[inline(always)]
