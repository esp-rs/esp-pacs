...
#[doc = "Field `T(0-1)` reader - Write 1 to enable the TIMG_T%s_INT interrupt."]
pub type T_R = crate::BitReader;
#[doc = "Field `T(0-1)` writer - Write 1 to enable the TIMG_T%s_INT interrupt."]
pub type T_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `WDT` reader - Write 1 to enable the TIMG_WDT_INT interrupt."]
pub type WDT_R = crate::BitReader;
#[doc = "Field `WDT` writer - Write 1 to enable the TIMG_WDT_INT interrupt."]
pub type WDT_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Write 1 to enable the TIMG_T(0-1)_INT interrupt."]
    #[doc = ""]
