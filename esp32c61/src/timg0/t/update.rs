...
#[doc = "Field `T0_UPDATE` reader - Configures to latch the counter value. \\\\ 0: Latch \\\\ 1: Latch \\\\"]
pub type T0_UPDATE_R = crate::BitReader;
#[doc = "Field `T0_UPDATE` writer - Configures to latch the counter value. \\\\ 0: Latch \\\\ 1: Latch \\\\"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UPDATE")
            .field("t0_update", &self.t0_update())
            .finish()
    }
}
impl W {
    #[doc = "Bit 31 - Configures to latch the counter value. \\\\ 0: Latch \\\\ 1: Latch \\\\"]
    #[inline(always)]
    pub fn t0_update(&mut self) -> T0_UPDATE_W<'_, UPDATE_SPEC> {
