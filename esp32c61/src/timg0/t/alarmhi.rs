...
#[doc = "Field `T0_ALARM_HI` reader - Configures the high 22 bits of timer 0 alarm trigger time-base counter value. Valid only when TIMG_T0_ALARM_EN is 1. \\\\ Measurement unit: T0_clk \\\\"]
pub type T0_ALARM_HI_R = crate::FieldReader<u32>;
#[doc = "Field `T0_ALARM_HI` writer - Configures the high 22 bits of timer 0 alarm trigger time-base counter value. Valid only when TIMG_T0_ALARM_EN is 1. \\\\ Measurement unit: T0_clk \\\\"]
pub type T0_ALARM_HI_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ...
    pub fn t0_alarm_hi(&self) -> T0_ALARM_HI_R {
        T0_ALARM_HI_R::new(self.bits & 0x003f_ffff)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ALARMHI")
            .field("t0_alarm_hi", &self.t0_alarm_hi())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:21 - Configures the high 22 bits of timer 0 alarm trigger time-base counter value. Valid only when TIMG_T0_ALARM_EN is 1. \\\\ Measurement unit: T0_clk \\\\"]
    #[inline(always)]
    pub fn t0_alarm_hi(&mut self) -> T0_ALARM_HI_W<'_, ALARMHI_SPEC> {
        T0_ALARM_HI_W::new(self, 0)
    }
}
