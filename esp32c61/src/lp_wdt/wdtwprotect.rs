...
#[doc = "Field `WDT_WKEY` reader - Configure this field to lock or unlock RWDT`s configuration registers.\\\\0x50D83AA1: unlock the RWDT configuration registers.\\\\ Others value: Lock the RWDT configuration register which can`t be modified by software."]
pub type WDT_WKEY_R = crate::FieldReader<u32>;
#[doc = "Field `WDT_WKEY` writer - Configure this field to lock or unlock RWDT`s configuration registers.\\\\0x50D83AA1: unlock the RWDT configuration registers.\\\\ Others value: Lock the RWDT configuration register which can`t be modified by software."]
