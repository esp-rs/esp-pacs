...
#[doc = "Field `LP_WDT_INT_CLR` writer - Configure whether to clear the timeout interrupt signal sent by RWDT to CPU.\\\\0: No\\\\1: Yes"]
pub type LP_WDT_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn lp_wdt_int_clr(&mut self) -> LP_WDT_INT_CLR_W<'_, INT_CLR_SPEC> {
        LP_WDT_INT_CLR_W::new(self, 31)
    }
}
