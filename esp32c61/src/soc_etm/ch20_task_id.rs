...
#[doc = "Field `CH20_TASK_ID` reader - Configures ch20_task_id"]
pub type CH20_TASK_ID_R = crate::FieldReader;
#[doc = "Field `CH20_TASK_ID` writer - Configures ch20_task_id"]
pub type CH20_TASK_ID_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures ch20_task_id"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH20_TASK_ID")
            .field("ch20_task_id", &self.ch20_task_id())
            .finish()
    }
}
impl W {
...
#[doc = "Channel20 task id register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch20_task_id::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch20_task_id::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
