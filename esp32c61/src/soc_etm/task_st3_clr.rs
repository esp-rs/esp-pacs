...
impl W {
    ...
    pub fn regdma_task_start2_st_clr(
        &mut self,
    ) -> REGDMA_TASK_START2_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn regdma_task_start3_st_clr(
        &mut self,
    ) -> REGDMA_TASK_START3_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn tmpsnsr_task_start_sample_st_clr(
        &mut self,
    ) -> TMPSNSR_TASK_START_SAMPLE_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn tmpsnsr_task_stop_sample_st_clr(
        &mut self,
    ) -> TMPSNSR_TASK_STOP_SAMPLE_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn i2s0_task_start_rx_st_clr(
        &mut self,
    ) -> I2S0_TASK_START_RX_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn i2s0_task_start_tx_st_clr(
        &mut self,
    ) -> I2S0_TASK_START_TX_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn i2s0_task_stop_rx_st_clr(
        &mut self,
    ) -> I2S0_TASK_STOP_RX_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn i2s0_task_stop_tx_st_clr(
        &mut self,
    ) -> I2S0_TASK_STOP_TX_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_task_start_rx_st_clr(
        &mut self,
    ) -> I2S1_TASK_START_RX_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_task_start_tx_st_clr(
        &mut self,
    ) -> I2S1_TASK_START_TX_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_task_stop_rx_st_clr(
        &mut self,
    ) -> I2S1_TASK_STOP_RX_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_task_stop_tx_st_clr(
        &mut self,
    ) -> I2S1_TASK_STOP_TX_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn ulp_task_wakeup_cpu_st_clr(
        &mut self,
    ) -> ULP_TASK_WAKEUP_CPU_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn ulp_task_int_cpu_st_clr(&mut self) -> ULP_TASK_INT_CPU_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_task_start_st_clr(&mut self) -> RTC_TASK_START_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_task_stop_st_clr(&mut self) -> RTC_TASK_STOP_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_task_clr_st_clr(&mut self) -> RTC_TASK_CLR_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn rtc_task_triggerflw_st_clr(
        &mut self,
    ) -> RTC_TASK_TRIGGERFLW_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn gdma_ahb_task_in_start_ch0_st_clr(
        &mut self,
    ) -> GDMA_AHB_TASK_IN_START_CH0_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn gdma_ahb_task_in_start_ch1_st_clr(
        &mut self,
    ) -> GDMA_AHB_TASK_IN_START_CH1_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn gdma_ahb_task_in_start_ch2_st_clr(
        &mut self,
    ) -> GDMA_AHB_TASK_IN_START_CH2_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
    ...
    pub fn gdma_ahb_task_out_start_ch0_st_clr(
        &mut self,
    ) -> GDMA_AHB_TASK_OUT_START_CH0_ST_CLR_W<'_, TASK_ST3_CLR_SPEC> {
