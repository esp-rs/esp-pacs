...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH9_TASK_ID")
            .field("ch9_task_id", &self.ch9_task_id())
            .finish()
    }
}
impl W {
...
#[doc = "Channel9 task id register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch9_task_id::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch9_task_id::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
