...
impl W {
    ...
    #[inline(always)]
    pub fn regdma_evt_done1_st_clr(&mut self) -> REGDMA_EVT_DONE1_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn regdma_evt_done2_st_clr(&mut self) -> REGDMA_EVT_DONE2_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn regdma_evt_done3_st_clr(&mut self) -> REGDMA_EVT_DONE3_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn regdma_evt_err0_st_clr(&mut self) -> REGDMA_EVT_ERR0_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn regdma_evt_err1_st_clr(&mut self) -> REGDMA_EVT_ERR1_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn regdma_evt_err2_st_clr(&mut self) -> REGDMA_EVT_ERR2_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn regdma_evt_err3_st_clr(&mut self) -> REGDMA_EVT_ERR3_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn tmpsnsr_evt_over_limit_st_clr(
        &mut self,
    ) -> TMPSNSR_EVT_OVER_LIMIT_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s0_evt_rx_done_st_clr(&mut self) -> I2S0_EVT_RX_DONE_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s0_evt_tx_done_st_clr(&mut self) -> I2S0_EVT_TX_DONE_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn i2s0_evt_x_words_received_st_clr(
        &mut self,
    ) -> I2S0_EVT_X_WORDS_RECEIVED_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn i2s0_evt_x_words_sent_st_clr(
        &mut self,
    ) -> I2S0_EVT_X_WORDS_SENT_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_evt_rx_done_st_clr(&mut self) -> I2S1_EVT_RX_DONE_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_evt_tx_done_st_clr(&mut self) -> I2S1_EVT_TX_DONE_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn i2s1_evt_x_words_received_st_clr(
        &mut self,
    ) -> I2S1_EVT_X_WORDS_RECEIVED_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn i2s1_evt_x_words_sent_st_clr(
        &mut self,
    ) -> I2S1_EVT_X_WORDS_SENT_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn ulp_evt_err_intr_st_clr(&mut self) -> ULP_EVT_ERR_INTR_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn ulp_evt_halt_st_clr(&mut self) -> ULP_EVT_HALT_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn ulp_evt_start_intr_st_clr(
        &mut self,
    ) -> ULP_EVT_START_INTR_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_evt_tick_st_clr(&mut self) -> RTC_EVT_TICK_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_evt_ovf_st_clr(&mut self) -> RTC_EVT_OVF_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_evt_cmp_st_clr(&mut self) -> RTC_EVT_CMP_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_done_ch0_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_DONE_CH0_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_done_ch1_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_DONE_CH1_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_done_ch2_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_DONE_CH2_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_suc_eof_ch0_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_SUC_EOF_CH0_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_suc_eof_ch1_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_SUC_EOF_CH1_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_suc_eof_ch2_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_SUC_EOF_CH2_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_fifo_empty_ch0_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_FIFO_EMPTY_CH0_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_fifo_empty_ch1_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_FIFO_EMPTY_CH1_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_fifo_empty_ch2_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_FIFO_EMPTY_CH2_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
    ...
    pub fn gdma_ahb_evt_in_fifo_full_ch0_st_clr(
        &mut self,
    ) -> GDMA_AHB_EVT_IN_FIFO_FULL_CH0_ST_CLR_W<'_, EVT_ST2_CLR_SPEC> {
