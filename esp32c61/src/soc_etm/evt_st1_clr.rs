...
impl W {
    ...
    #[doc = "Bit 8 - Configures whether or not to clear LEDC_evt_time_ovf_timer0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn ledc_evt_time_ovf_timer0_st_clr(
        &mut self,
    ) -> LEDC_EVT_TIME_OVF_TIMER0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        LEDC_EVT_TIME_OVF_TIMER0_ST_CLR_W::new(self, 8)
    }
    #[doc = "Bit 9 - Configures whether or not to clear LEDC_evt_time_ovf_timer1 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn ledc_evt_time_ovf_timer1_st_clr(
        &mut self,
    ) -> LEDC_EVT_TIME_OVF_TIMER1_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        LEDC_EVT_TIME_OVF_TIMER1_ST_CLR_W::new(self, 9)
    }
    #[doc = "Bit 10 - Configures whether or not to clear LEDC_evt_time_ovf_timer2 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn ledc_evt_time_ovf_timer2_st_clr(
        &mut self,
    ) -> LEDC_EVT_TIME_OVF_TIMER2_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        LEDC_EVT_TIME_OVF_TIMER2_ST_CLR_W::new(self, 10)
    }
    #[doc = "Bit 11 - Configures whether or not to clear LEDC_evt_time_ovf_timer3 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn ledc_evt_time_ovf_timer3_st_clr(
        &mut self,
    ) -> LEDC_EVT_TIME_OVF_TIMER3_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        LEDC_EVT_TIME_OVF_TIMER3_ST_CLR_W::new(self, 11)
    }
    #[doc = "Bit 12 - Configures whether or not to clear LEDC_evt_timer0_cmp trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn ledc_evt_timer0_cmp_st_clr(
        &mut self,
    ) -> LEDC_EVT_TIMER0_CMP_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        LEDC_EVT_TIMER0_CMP_ST_CLR_W::new(self, 12)
    }
    #[doc = "Bit 13 - Configures whether or not to clear LEDC_evt_timer1_cmp trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn ledc_evt_timer1_cmp_st_clr(
        &mut self,
    ) -> LEDC_EVT_TIMER1_CMP_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        LEDC_EVT_TIMER1_CMP_ST_CLR_W::new(self, 13)
    }
    #[doc = "Bit 14 - Configures whether or not to clear LEDC_evt_timer2_cmp trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn ledc_evt_timer2_cmp_st_clr(
        &mut self,
    ) -> LEDC_EVT_TIMER2_CMP_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        LEDC_EVT_TIMER2_CMP_ST_CLR_W::new(self, 14)
    }
    #[doc = "Bit 15 - Configures whether or not to clear LEDC_evt_timer3_cmp trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn ledc_evt_timer3_cmp_st_clr(
        &mut self,
    ) -> LEDC_EVT_TIMER3_CMP_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        LEDC_EVT_TIMER3_CMP_ST_CLR_W::new(self, 15)
    }
    #[doc = "Bit 16 - Configures whether or not to clear TG0_evt_cnt_cmp_timer0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn tg0_evt_cnt_cmp_timer0_st_clr(
        &mut self,
    ) -> TG0_EVT_CNT_CMP_TIMER0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        TG0_EVT_CNT_CMP_TIMER0_ST_CLR_W::new(self, 16)
    }
    #[doc = "Bit 17 - Configures whether or not to clear TG0_evt_cnt_cmp_timer1 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn tg0_evt_cnt_cmp_timer1_st_clr(
        &mut self,
    ) -> TG0_EVT_CNT_CMP_TIMER1_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        TG0_EVT_CNT_CMP_TIMER1_ST_CLR_W::new(self, 17)
    }
    #[doc = "Bit 18 - Configures whether or not to clear TG1_evt_cnt_cmp_timer0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn tg1_evt_cnt_cmp_timer0_st_clr(
        &mut self,
    ) -> TG1_EVT_CNT_CMP_TIMER0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        TG1_EVT_CNT_CMP_TIMER0_ST_CLR_W::new(self, 18)
    }
    #[doc = "Bit 19 - Configures whether or not to clear TG1_evt_cnt_cmp_timer1 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn tg1_evt_cnt_cmp_timer1_st_clr(
        &mut self,
    ) -> TG1_EVT_CNT_CMP_TIMER1_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        TG1_EVT_CNT_CMP_TIMER1_ST_CLR_W::new(self, 19)
    }
    ...
    #[doc = "Bit 23 - Configures whether or not to clear ADC_evt_conv_cmplt0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn adc_evt_conv_cmplt0_st_clr(
        &mut self,
    ) -> ADC_EVT_CONV_CMPLT0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        ADC_EVT_CONV_CMPLT0_ST_CLR_W::new(self, 23)
    }
    #[doc = "Bit 24 - Configures whether or not to clear ADC_evt_eq_above_thresh0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn adc_evt_eq_above_thresh0_st_clr(
        &mut self,
    ) -> ADC_EVT_EQ_ABOVE_THRESH0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        ADC_EVT_EQ_ABOVE_THRESH0_ST_CLR_W::new(self, 24)
    }
    #[doc = "Bit 25 - Configures whether or not to clear ADC_evt_eq_above_thresh1 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn adc_evt_eq_above_thresh1_st_clr(
        &mut self,
    ) -> ADC_EVT_EQ_ABOVE_THRESH1_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        ADC_EVT_EQ_ABOVE_THRESH1_ST_CLR_W::new(self, 25)
    }
    #[doc = "Bit 26 - Configures whether or not to clear ADC_evt_eq_below_thresh0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn adc_evt_eq_below_thresh0_st_clr(
        &mut self,
    ) -> ADC_EVT_EQ_BELOW_THRESH0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        ADC_EVT_EQ_BELOW_THRESH0_ST_CLR_W::new(self, 26)
    }
    #[doc = "Bit 27 - Configures whether or not to clear ADC_evt_eq_below_thresh1 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn adc_evt_eq_below_thresh1_st_clr(
        &mut self,
    ) -> ADC_EVT_EQ_BELOW_THRESH1_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        ADC_EVT_EQ_BELOW_THRESH1_ST_CLR_W::new(self, 27)
    }
    #[doc = "Bit 28 - Configures whether or not to clear ADC_evt_result_done0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn adc_evt_result_done0_st_clr(
        &mut self,
    ) -> ADC_EVT_RESULT_DONE0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        ADC_EVT_RESULT_DONE0_ST_CLR_W::new(self, 28)
    }
    #[doc = "Bit 29 - Configures whether or not to clear ADC_evt_stopped0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn adc_evt_stopped0_st_clr(&mut self) -> ADC_EVT_STOPPED0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        ADC_EVT_STOPPED0_ST_CLR_W::new(self, 29)
    }
    #[doc = "Bit 30 - Configures whether or not to clear ADC_evt_started0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn adc_evt_started0_st_clr(&mut self) -> ADC_EVT_STARTED0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
        ADC_EVT_STARTED0_ST_CLR_W::new(self, 30)
    }
    #[doc = "Bit 31 - Configures whether or not to clear REGDMA_evt_done0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn regdma_evt_done0_st_clr(&mut self) -> REGDMA_EVT_DONE0_ST_CLR_W<'_, EVT_ST1_CLR_SPEC> {
