...
pub type CH5_EVT_ID_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    #[doc = "Bits 0:6 - Configures ch5_evt_id"]
    #[inline(always)]
    pub fn ch5_evt_id(&self) -> CH5_EVT_ID_R {
        CH5_EVT_ID_R::new((self.bits & 0x7f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH5_EVT_ID")
            .field("ch5_evt_id", &self.ch5_evt_id())
            .finish()
    }
}
impl W {
...
#[doc = "Channel5 event id register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch5_evt_id::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch5_evt_id::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
