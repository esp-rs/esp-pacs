...
#[doc = "Field `EFUSE_INTR_PASS_IN_SEC` reader - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type EFUSE_INTR_PASS_IN_SEC_R = crate::BitReader;
#[doc = "Field `EFUSE_INTR_PASS_IN_SEC` writer - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type EFUSE_INTR_PASS_IN_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn efuse_intr_pass_in_sec(&self) -> EFUSE_INTR_PASS_IN_SEC_R {
        EFUSE_INTR_PASS_IN_SEC_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EFUSE_INTR_MAP")
            ...
            .field("efuse_intr_pass_in_sec", &self.efuse_intr_pass_in_sec())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn efuse_intr_map(&mut self) -> EFUSE_INTR_MAP_W<'_, EFUSE_INTR_MAP_SPEC> {
        EFUSE_INTR_MAP_W::new(self, 0)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn efuse_intr_pass_in_sec(&mut self) -> EFUSE_INTR_PASS_IN_SEC_W<'_, EFUSE_INTR_MAP_SPEC> {
        EFUSE_INTR_PASS_IN_SEC_W::new(self, 8)
    }
}
