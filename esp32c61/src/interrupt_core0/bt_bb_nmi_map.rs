...
#[doc = "Field `BT_BB_NMI_PASS_IN_SEC` reader - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type BT_BB_NMI_PASS_IN_SEC_R = crate::BitReader;
#[doc = "Field `BT_BB_NMI_PASS_IN_SEC` writer - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type BT_BB_NMI_PASS_IN_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn bt_bb_nmi_pass_in_sec(&self) -> BT_BB_NMI_PASS_IN_SEC_R {
        BT_BB_NMI_PASS_IN_SEC_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BT_BB_NMI_MAP")
            ...
            .field("bt_bb_nmi_pass_in_sec", &self.bt_bb_nmi_pass_in_sec())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn bt_bb_nmi_map(&mut self) -> BT_BB_NMI_MAP_W<'_, BT_BB_NMI_MAP_SPEC> {
        BT_BB_NMI_MAP_W::new(self, 0)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn bt_bb_nmi_pass_in_sec(&mut self) -> BT_BB_NMI_PASS_IN_SEC_W<'_, BT_BB_NMI_MAP_SPEC> {
        BT_BB_NMI_PASS_IN_SEC_W::new(self, 8)
    }
}
