...
impl W {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn tg1_t1_intr_map(&mut self) -> TG1_T1_INTR_MAP_W<'_, TG1_T1_INTR_MAP_SPEC> {
        TG1_T1_INTR_MAP_W::new(self, 0)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn tg1_t1_intr_pass_in_sec(
        &mut self,
    ) -> TG1_T1_INTR_PASS_IN_SEC_W<'_, TG1_T1_INTR_MAP_SPEC> {
