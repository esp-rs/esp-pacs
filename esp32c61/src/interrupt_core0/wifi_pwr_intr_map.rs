...
#[doc = "Field `WIFI_PWR_INTR_PASS_IN_SEC` reader - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type WIFI_PWR_INTR_PASS_IN_SEC_R = crate::BitReader;
#[doc = "Field `WIFI_PWR_INTR_PASS_IN_SEC` writer - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type WIFI_PWR_INTR_PASS_IN_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn wifi_pwr_intr_pass_in_sec(&self) -> WIFI_PWR_INTR_PASS_IN_SEC_R {
        WIFI_PWR_INTR_PASS_IN_SEC_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("WIFI_PWR_INTR_MAP")
            ...
            .field(
                "wifi_pwr_intr_pass_in_sec",
                &self.wifi_pwr_intr_pass_in_sec(),
            )
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn wifi_pwr_intr_map(&mut self) -> WIFI_PWR_INTR_MAP_W<'_, WIFI_PWR_INTR_MAP_SPEC> {
        WIFI_PWR_INTR_MAP_W::new(self, 0)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn wifi_pwr_intr_pass_in_sec(
        &mut self,
    ) -> WIFI_PWR_INTR_PASS_IN_SEC_W<'_, WIFI_PWR_INTR_MAP_SPEC> {
        WIFI_PWR_INTR_PASS_IN_SEC_W::new(self, 8)
    }
}
