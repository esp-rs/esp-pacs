...
#[doc = "Field `LP_RTC_TIMER_INTR_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type LP_RTC_TIMER_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `LP_RTC_TIMER_INTR_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type LP_RTC_TIMER_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `LP_RTC_TIMER_INTR_PASS_IN_SEC` reader - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type LP_RTC_TIMER_INTR_PASS_IN_SEC_R = crate::BitReader;
#[doc = "Field `LP_RTC_TIMER_INTR_PASS_IN_SEC` writer - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type LP_RTC_TIMER_INTR_PASS_IN_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn lp_rtc_timer_intr_map(&self) -> LP_RTC_TIMER_INTR_MAP_R {
        LP_RTC_TIMER_INTR_MAP_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn lp_rtc_timer_intr_pass_in_sec(&self) -> LP_RTC_TIMER_INTR_PASS_IN_SEC_R {
        LP_RTC_TIMER_INTR_PASS_IN_SEC_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_RTC_TIMER_INTR_MAP")
            ...
            .field(
                "lp_rtc_timer_intr_pass_in_sec",
                &self.lp_rtc_timer_intr_pass_in_sec(),
            )
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn lp_rtc_timer_intr_map(
        &mut self,
    ) -> LP_RTC_TIMER_INTR_MAP_W<'_, LP_RTC_TIMER_INTR_MAP_SPEC> {
        LP_RTC_TIMER_INTR_MAP_W::new(self, 0)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn lp_rtc_timer_intr_pass_in_sec(
        &mut self,
    ) -> LP_RTC_TIMER_INTR_PASS_IN_SEC_W<'_, LP_RTC_TIMER_INTR_MAP_SPEC> {
        LP_RTC_TIMER_INTR_PASS_IN_SEC_W::new(self, 8)
    }
}
