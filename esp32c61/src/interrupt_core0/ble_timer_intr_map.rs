...
#[doc = "Field `BLE_TIMER_INTR_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type BLE_TIMER_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `BLE_TIMER_INTR_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type BLE_TIMER_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `BLE_TIMER_INTR_PASS_IN_SEC` reader - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type BLE_TIMER_INTR_PASS_IN_SEC_R = crate::BitReader;
#[doc = "Field `BLE_TIMER_INTR_PASS_IN_SEC` writer - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type BLE_TIMER_INTR_PASS_IN_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn ble_timer_intr_map(&self) -> BLE_TIMER_INTR_MAP_R {
        BLE_TIMER_INTR_MAP_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn ble_timer_intr_pass_in_sec(&self) -> BLE_TIMER_INTR_PASS_IN_SEC_R {
        BLE_TIMER_INTR_PASS_IN_SEC_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLE_TIMER_INTR_MAP")
            ...
            .field(
                "ble_timer_intr_pass_in_sec",
                &self.ble_timer_intr_pass_in_sec(),
            )
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn ble_timer_intr_map(&mut self) -> BLE_TIMER_INTR_MAP_W<'_, BLE_TIMER_INTR_MAP_SPEC> {
        BLE_TIMER_INTR_MAP_W::new(self, 0)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn ble_timer_intr_pass_in_sec(
        &mut self,
    ) -> BLE_TIMER_INTR_PASS_IN_SEC_W<'_, BLE_TIMER_INTR_MAP_SPEC> {
        BLE_TIMER_INTR_PASS_IN_SEC_W::new(self, 8)
    }
}
