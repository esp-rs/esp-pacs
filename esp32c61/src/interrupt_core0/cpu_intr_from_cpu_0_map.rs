...
#[doc = "Field `CPU_INTR_FROM_CPU_0_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type CPU_INTR_FROM_CPU_0_MAP_R = crate::FieldReader;
#[doc = "Field `CPU_INTR_FROM_CPU_0_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type CPU_INTR_FROM_CPU_0_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `CPU_INTR_FROM_CPU_0_PASS_IN_SEC` reader - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type CPU_INTR_FROM_CPU_0_PASS_IN_SEC_R = crate::BitReader;
#[doc = "Field `CPU_INTR_FROM_CPU_0_PASS_IN_SEC` writer - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type CPU_INTR_FROM_CPU_0_PASS_IN_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn cpu_intr_from_cpu_0_map(&self) -> CPU_INTR_FROM_CPU_0_MAP_R {
        CPU_INTR_FROM_CPU_0_MAP_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn cpu_intr_from_cpu_0_pass_in_sec(&self) -> CPU_INTR_FROM_CPU_0_PASS_IN_SEC_R {
        CPU_INTR_FROM_CPU_0_PASS_IN_SEC_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CPU_INTR_FROM_CPU_0_MAP")
            ...
            .field(
                "cpu_intr_from_cpu_0_pass_in_sec",
                &self.cpu_intr_from_cpu_0_pass_in_sec(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn cpu_intr_from_cpu_0_map(
        &mut self,
    ) -> CPU_INTR_FROM_CPU_0_MAP_W<'_, CPU_INTR_FROM_CPU_0_MAP_SPEC> {
        CPU_INTR_FROM_CPU_0_MAP_W::new(self, 0)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn cpu_intr_from_cpu_0_pass_in_sec(
        &mut self,
    ) -> CPU_INTR_FROM_CPU_0_PASS_IN_SEC_W<'_, CPU_INTR_FROM_CPU_0_MAP_SPEC> {
        CPU_INTR_FROM_CPU_0_PASS_IN_SEC_W::new(self, 8)
    }
}
