...
#[doc = "Field `MODEM_PERI_TIMEOUT_INTR_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type MODEM_PERI_TIMEOUT_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `MODEM_PERI_TIMEOUT_INTR_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type MODEM_PERI_TIMEOUT_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `MODEM_PERI_TIMEOUT_INTR_PASS_IN_SEC` reader - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type MODEM_PERI_TIMEOUT_INTR_PASS_IN_SEC_R = crate::BitReader;
#[doc = "Field `MODEM_PERI_TIMEOUT_INTR_PASS_IN_SEC` writer - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type MODEM_PERI_TIMEOUT_INTR_PASS_IN_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn modem_peri_timeout_intr_map(&self) -> MODEM_PERI_TIMEOUT_INTR_MAP_R {
        MODEM_PERI_TIMEOUT_INTR_MAP_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn modem_peri_timeout_intr_pass_in_sec(&self) -> MODEM_PERI_TIMEOUT_INTR_PASS_IN_SEC_R {
        MODEM_PERI_TIMEOUT_INTR_PASS_IN_SEC_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MODEM_PERI_TIMEOUT_INTR_MAP")
            ...
            .field(
                "modem_peri_timeout_intr_pass_in_sec",
                &self.modem_peri_timeout_intr_pass_in_sec(),
            )
            .finish()
    }
}
