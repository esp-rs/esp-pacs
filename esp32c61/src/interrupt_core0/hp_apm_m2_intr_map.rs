...
#[doc = "Field `HP_APM_M2_INTR_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type HP_APM_M2_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `HP_APM_M2_INTR_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type HP_APM_M2_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `HP_APM_M2_INTR_PASS_IN_SEC` reader - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type HP_APM_M2_INTR_PASS_IN_SEC_R = crate::BitReader;
#[doc = "Field `HP_APM_M2_INTR_PASS_IN_SEC` writer - Configures the PASS_IN_SEC flag of the interrupt source."]
pub type HP_APM_M2_INTR_PASS_IN_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn hp_apm_m2_intr_map(&self) -> HP_APM_M2_INTR_MAP_R {
        HP_APM_M2_INTR_MAP_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn hp_apm_m2_intr_pass_in_sec(&self) -> HP_APM_M2_INTR_PASS_IN_SEC_R {
        HP_APM_M2_INTR_PASS_IN_SEC_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_APM_M2_INTR_MAP")
            ...
            .field(
                "hp_apm_m2_intr_pass_in_sec",
                &self.hp_apm_m2_intr_pass_in_sec(),
            )
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn hp_apm_m2_intr_map(&mut self) -> HP_APM_M2_INTR_MAP_W<'_, HP_APM_M2_INTR_MAP_SPEC> {
        HP_APM_M2_INTR_MAP_W::new(self, 0)
    }
    #[doc = "Bit 8 - Configures the PASS_IN_SEC flag of the interrupt source."]
    #[inline(always)]
    pub fn hp_apm_m2_intr_pass_in_sec(
        &mut self,
    ) -> HP_APM_M2_INTR_PASS_IN_SEC_W<'_, HP_APM_M2_INTR_MAP_SPEC> {
        HP_APM_M2_INTR_PASS_IN_SEC_W::new(self, 8)
    }
}
