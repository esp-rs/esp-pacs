...
#[doc = "Field `TSENS_CLK_SEL` reader - Configures the clock source of the temperature sensor.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
pub type TSENS_CLK_SEL_R = crate::BitReader;
#[doc = "Field `TSENS_CLK_SEL` writer - Configures the clock source of the temperature sensor.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
...
#[doc = "Field `TSENS_RST_EN` reader - Set 1 to reset tsens module"]
pub type TSENS_RST_EN_R = crate::BitReader;
#[doc = "Field `TSENS_RST_EN` writer - Set 1 to reset tsens module"]
pub type TSENS_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 20 - Configures the clock source of the temperature sensor.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 23 - Set 1 to reset tsens module"]
    #[inline(always)]
