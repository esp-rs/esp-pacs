...
impl R {
    ...
    pub fn rom_clkgate_force_on(&self) -> ROM_CLKGATE_FORCE_ON_R {
        ROM_CLKGATE_FORCE_ON_R::new(((self.bits >> 4) & 3) as u8)
    }
}
...
#[doc = "`reset()` method sets SRAM_POWER_CONF_0 to value 0x03"]
