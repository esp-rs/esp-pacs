...
#[doc = "Field `TG0_WDT_RST_EN` reader - Set 1 to reset timer_group0 wdt module"]
pub type TG0_WDT_RST_EN_R = crate::BitReader;
#[doc = "Field `TG0_WDT_RST_EN` writer - Set 1 to reset timer_group0 wdt module"]
pub type TG0_WDT_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TG1_WDT_RST_EN` reader - Set 1 to reset timer_group1 wdt module"]
pub type TG1_WDT_RST_EN_R = crate::BitReader;
#[doc = "Field `TG1_WDT_RST_EN` writer - Set 1 to reset timer_group1 wdt module"]
pub type TG1_WDT_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Set 1 to reset timer_group0 wdt module"]
    #[inline(always)]
    pub fn tg0_wdt_rst_en(&self) -> TG0_WDT_RST_EN_R {
        TG0_WDT_RST_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set 1 to reset timer_group1 wdt module"]
    #[inline(always)]
