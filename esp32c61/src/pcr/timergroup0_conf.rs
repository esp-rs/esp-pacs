...
#[doc = "Field `TG0_RST_EN` reader - Set 1 to reset timer_group0 module"]
pub type TG0_RST_EN_R = crate::BitReader;
#[doc = "Field `TG0_RST_EN` writer - Set 1 to reset timer_group0 module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset timer_group0 module"]
    #[inline(always)]
