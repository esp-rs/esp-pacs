...
#[doc = "Field `UART1_SCLK_EN` reader - Set 1 to enable uart1 function clock"]
pub type UART1_SCLK_EN_R = crate::BitReader;
#[doc = "Field `UART1_SCLK_EN` writer - Set 1 to enable uart1 function clock"]
...
impl R {
    ...
    #[doc = "Bit 22 - Set 1 to enable uart1 function clock"]
    #[inline(always)]
