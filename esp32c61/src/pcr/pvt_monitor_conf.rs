...
#[doc = "Field `PVT_MONITOR_RST_EN` reader - Set 1 to reset all pvt monitor module"]
pub type PVT_MONITOR_RST_EN_R = crate::BitReader;
#[doc = "Field `PVT_MONITOR_RST_EN` writer - Set 1 to reset all pvt monitor module"]
...
#[doc = "Field `PVT_MONITOR_SITE2_RST_EN` reader - Set 1 to reset cpu pvt monitor site"]
pub type PVT_MONITOR_SITE2_RST_EN_R = crate::BitReader;
#[doc = "Field `PVT_MONITOR_SITE2_RST_EN` writer - Set 1 to reset cpu pvt monitor site"]
pub type PVT_MONITOR_SITE2_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PVT_MONITOR_SITE3_CLK_EN` reader - Set 1 to enable function clock of modem pvt module"]
pub type PVT_MONITOR_SITE3_CLK_EN_R = crate::BitReader;
#[doc = "Field `PVT_MONITOR_SITE3_CLK_EN` writer - Set 1 to enable function clock of modem pvt module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset all pvt monitor module"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Set 1 to reset cpu pvt monitor site"]
    #[inline(always)]
    pub fn pvt_monitor_site2_rst_en(&self) -> PVT_MONITOR_SITE2_RST_EN_R {
        PVT_MONITOR_SITE2_RST_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Set 1 to enable function clock of modem pvt module"]
    #[inline(always)]
    pub fn pvt_monitor_site3_clk_en(&self) -> PVT_MONITOR_SITE3_CLK_EN_R {
        PVT_MONITOR_SITE3_CLK_EN_R::new(((self.bits >> 5) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PVT_MONITOR_CONF")
            ...
            .field("pvt_monitor_site2_rst_en", &self.pvt_monitor_site2_rst_en())
...
impl W {
    ...
    #[doc = "Bit 4 - Set 1 to reset cpu pvt monitor site"]
    #[inline(always)]
    pub fn pvt_monitor_site2_rst_en(
        &mut self,
    ) -> PVT_MONITOR_SITE2_RST_EN_W<'_, PVT_MONITOR_CONF_SPEC> {
        PVT_MONITOR_SITE2_RST_EN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Set 1 to enable function clock of modem pvt module"]
    #[inline(always)]
    pub fn pvt_monitor_site3_clk_en(
        ...
        PVT_MONITOR_SITE3_CLK_EN_W::new(self, 5)
    }
}
...
#[doc = "`reset()` method sets PVT_MONITOR_CONF to value 0x29"]
