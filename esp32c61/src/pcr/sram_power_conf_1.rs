...
impl R {
    ...
    #[doc = "Bits 20:24 - 1: Force to open the clock and bypass the gate-clock when accessing the SRAM. 0: A gate-clock will be used when accessing the SRAM."]
    #[inline(always)]
    pub fn sram_clkgate_force_on(&self) -> SRAM_CLKGATE_FORCE_ON_R {
        SRAM_CLKGATE_FORCE_ON_R::new(((self.bits >> 20) & 0x1f) as u8)
    }
}
...
impl W {
    #[doc = "Bits 0:4 - Set this bit to force power up SRAM"]
    #[inline(always)]
    pub fn sram_force_pu(&mut self) -> SRAM_FORCE_PU_W<'_, SRAM_POWER_CONF_1_SPEC> {
        SRAM_FORCE_PU_W::new(self, 0)
    }
    #[doc = "Bits 10:14 - Set this bit to force power down SRAM."]
    #[inline(always)]
    pub fn sram_force_pd(&mut self) -> SRAM_FORCE_PD_W<'_, SRAM_POWER_CONF_1_SPEC> {
