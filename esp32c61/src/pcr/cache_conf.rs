...
#[doc = "Field `CACHE_RST_EN` reader - Set 1 to reset cache module"]
pub type CACHE_RST_EN_R = crate::BitReader;
#[doc = "Field `CACHE_RST_EN` writer - Set 1 to reset cache module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset cache module"]
    #[inline(always)]
