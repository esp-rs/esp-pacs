...
#[doc = "Field `MSPI_AXI_RST_EN` reader - Set 1 to reset axi_clock domain of mspi module"]
pub type MSPI_AXI_RST_EN_R = crate::BitReader;
#[doc = "Field `MSPI_AXI_RST_EN` writer - Set 1 to reset axi_clock domain of mspi module"]
