...
#[doc = "Field `ASSIST_RST_EN` reader - Set 1 to reset assist module"]
pub type ASSIST_RST_EN_R = crate::BitReader;
#[doc = "Field `ASSIST_RST_EN` writer - Set 1 to reset assist module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset assist module"]
    #[inline(always)]
