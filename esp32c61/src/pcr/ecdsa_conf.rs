...
#[doc = "Field `ECDSA_RST_EN` reader - Set 1 to reset ecdsa module"]
pub type ECDSA_RST_EN_R = crate::BitReader;
#[doc = "Field `ECDSA_RST_EN` writer - Set 1 to reset ecdsa module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset ecdsa module"]
    #[inline(always)]
