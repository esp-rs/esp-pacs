...
#[doc = "Field `LP_INTERRUPT_SOURCE` reader - BIT5~BIT0: pmu_lp_int, modem_lp_int, lp_timer_lp_int, reserved, reserved, lp_io_int"]
pub type LP_INTERRUPT_SOURCE_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:5 - BIT5~BIT0: pmu_lp_int, modem_lp_int, lp_timer_lp_int, reserved, reserved, lp_io_int"]
    #[inline(always)]
