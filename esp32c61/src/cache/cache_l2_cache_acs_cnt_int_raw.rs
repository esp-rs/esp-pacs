...
impl W {
    ...
    pub fn cache_l2_ibus0_ovf_int_raw(
        &mut self,
    ) -> CACHE_L2_IBUS0_OVF_INT_RAW_W<CACHE_L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
    ...
    pub fn cache_l2_ibus1_ovf_int_raw(
        &mut self,
    ) -> CACHE_L2_IBUS1_OVF_INT_RAW_W<CACHE_L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
    ...
    pub fn cache_l2_ibus2_ovf_int_raw(
        &mut self,
    ) -> CACHE_L2_IBUS2_OVF_INT_RAW_W<CACHE_L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
    ...
    pub fn cache_l2_ibus3_ovf_int_raw(
        &mut self,
    ) -> CACHE_L2_IBUS3_OVF_INT_RAW_W<CACHE_L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
    ...
    pub fn cache_l2_dbus0_ovf_int_raw(
        &mut self,
    ) -> CACHE_L2_DBUS0_OVF_INT_RAW_W<CACHE_L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
    ...
    pub fn cache_l2_dbus1_ovf_int_raw(
        &mut self,
    ) -> CACHE_L2_DBUS1_OVF_INT_RAW_W<CACHE_L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
    ...
    pub fn cache_l2_dbus2_ovf_int_raw(
        &mut self,
    ) -> CACHE_L2_DBUS2_OVF_INT_RAW_W<CACHE_L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
    ...
    pub fn cache_l2_dbus3_ovf_int_raw(
        &mut self,
    ) -> CACHE_L2_DBUS3_OVF_INT_RAW_W<CACHE_L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
