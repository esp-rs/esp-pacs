...
#[doc = "Field `ICACHE_SHUT_IBUS0` reader - The bit is used to disable core0 ibus access L1-ICache, 0: enable, 1: disable"]
pub type ICACHE_SHUT_IBUS0_R = crate::BitReader;
#[doc = "Field `ICACHE_SHUT_IBUS0` writer - The bit is used to disable core0 ibus access L1-ICache, 0: enable, 1: disable"]
pub type ICACHE_SHUT_IBUS0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ICACHE_SHUT_IBUS1` reader - The bit is used to disable core1 ibus access L1-ICache, 0: enable, 1: disable"]
pub type ICACHE_SHUT_IBUS1_R = crate::BitReader;
#[doc = "Field `ICACHE_SHUT_IBUS1` writer - The bit is used to disable core1 ibus access L1-ICache, 0: enable, 1: disable"]
pub type ICACHE_SHUT_IBUS1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `ICACHE_UNDEF_OP` reader - Reserved"]
pub type ICACHE_UNDEF_OP_R = crate::FieldReader;
#[doc = "Field `ICACHE_UNDEF_OP` writer - Reserved"]
pub type ICACHE_UNDEF_OP_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bit 0 - The bit is used to disable core0 ibus access L1-ICache, 0: enable, 1: disable"]
    #[inline(always)]
    pub fn icache_shut_ibus0(&self) -> ICACHE_SHUT_IBUS0_R {
        ICACHE_SHUT_IBUS0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The bit is used to disable core1 ibus access L1-ICache, 0: enable, 1: disable"]
    #[inline(always)]
    pub fn icache_shut_ibus1(&self) -> ICACHE_SHUT_IBUS1_R {
        ICACHE_SHUT_IBUS1_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn icache_undef_op(&self) -> ICACHE_UNDEF_OP_R {
        ICACHE_UNDEF_OP_R::new(((self.bits >> 8) & 0xff) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ICACHE_CTRL")
            .field("icache_shut_ibus0", &self.icache_shut_ibus0())
            .field("icache_shut_ibus1", &self.icache_shut_ibus1())
            .field("icache_shut_ibus2", &self.icache_shut_ibus2())
            .field("icache_shut_ibus3", &self.icache_shut_ibus3())
            .field("icache_undef_op", &self.icache_undef_op())
            .finish()
    }
}
impl W {
