...
#[doc = "Field `IBUS0_MISS_CNT` reader - The register records the number of missing when bus0 accesses L1-ICache0."]
pub type IBUS0_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of missing when bus0 accesses L1-ICache0."]
    #[inline(always)]
    pub fn ibus0_miss_cnt(&self) -> IBUS0_MISS_CNT_R {
        IBUS0_MISS_CNT_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IBUS0_ACS_MISS_CNT")
            .field("ibus0_miss_cnt", &self.ibus0_miss_cnt())
            .finish()
    }
}
