...
impl R {
    ...
    pub fn hp_active_hp_regulator_slp_connect_en(&self) -> HP_ACTIVE_HP_REGULATOR_SLP_CONNECT_EN_R {
        HP_ACTIVE_HP_REGULATOR_SLP_CONNECT_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    pub fn hp_active_hp_regulator_slp_connect_en(
        ...
        HP_ACTIVE_HP_REGULATOR_SLP_CONNECT_EN_W::new(self, 3)
    }
    #[doc = "Bit 14 - need_des"]
    #[inline(always)]
...
#[doc = "`reset()` method sets HP_ACTIVE_HP_REGULATOR0 to value 0xc667_7188"]
impl crate::Resettable for HP_ACTIVE_HP_REGULATOR0_SPEC {
    const RESET_VALUE: u32 = 0xc667_7188;
}
