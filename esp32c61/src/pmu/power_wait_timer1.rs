...
#[doc = "Field `DG_LP_PD_WAIT_TIMER` reader - need_des"]
pub type DG_LP_PD_WAIT_TIMER_R = crate::FieldReader<u16>;
#[doc = "Field `DG_LP_PD_WAIT_TIMER` writer - need_des"]
pub type DG_LP_PD_WAIT_TIMER_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ...
    #[inline(always)]
    pub fn dg_lp_pd_wait_timer(&self) -> DG_LP_PD_WAIT_TIMER_R {
        DG_LP_PD_WAIT_TIMER_R::new(((self.bits >> 23) & 0x01ff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("POWER_WAIT_TIMER1")
            ...
            .field("dg_lp_pd_wait_timer", &self.dg_lp_pd_wait_timer())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bits 23:31 - need_des"]
    #[inline(always)]
    pub fn dg_lp_pd_wait_timer(&mut self) -> DG_LP_PD_WAIT_TIMER_W<'_, POWER_WAIT_TIMER1_SPEC> {
        DG_LP_PD_WAIT_TIMER_W::new(self, 23)
    }
}
...
#[doc = "`reset()` method sets POWER_WAIT_TIMER1 to value 0x7fbf_7e00"]
impl crate::Resettable for POWER_WAIT_TIMER1_SPEC {
    const RESET_VALUE: u32 = 0x7fbf_7e00;
}
