...
#[doc = "Field `PREP_DONE_INT_CLR` writer - Set this bit to clear the ecdsa_prep_done_int interrupt"]
pub type PREP_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PROC_DONE_INT_CLR` writer - Set this bit to clear the ecdsa_proc_done_int interrupt"]
pub type PROC_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `POST_DONE_INT_CLR` writer - Set this bit to clear the ecdsa_post_done_int interrupt"]
