...
#[doc = "Field `MAIN_TIMER_TAR_HIGH1` reader - Configures the higher 16 bits of the trigger threshold for the RTC timer compare1"]
pub type MAIN_TIMER_TAR_HIGH1_R = crate::FieldReader<u16>;
#[doc = "Field `MAIN_TIMER_TAR_HIGH1` writer - Configures the higher 16 bits of the trigger threshold for the RTC timer compare1"]
pub type MAIN_TIMER_TAR_HIGH1_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `MAIN_TIMER_TAR_EN1` writer - Configure this bit to enable the timer compare1 alarm.\\\\0: Disable \\\\1: Enable"]
