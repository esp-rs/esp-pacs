...
#[doc = "Field `MAIN_TIMER_OVERFLOW` writer - Clear the RTC main timer overflow clear interrupt.."]
pub type MAIN_TIMER_OVERFLOW_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `MAIN_TIMER` writer - Clear the RTC main timer clear interrupt.."]
