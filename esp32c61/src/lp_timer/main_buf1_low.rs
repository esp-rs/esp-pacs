...
#[doc = "Field `MAIN_TIMER_BUF1_LOW` reader - RTC timer buffer1 low bits register"]
pub type MAIN_TIMER_BUF1_LOW_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - RTC timer buffer1 low bits register"]
    #[inline(always)]
...
#[doc = "RTC timer buffer1 low bits register\n\nYou can [`read`](crate::Reg::read) this register and get [`main_buf1_low::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
