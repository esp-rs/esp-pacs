...
#[doc = "Field `AHBINF_RESP_ERR_CH_ID` reader - Represents the AHB response error request channel id.bit\\[1\\]=1:TX channel.\\\\bit\\[1\\]=0:RX channel.\\\\"]
...
impl R {
    ...
    #[doc = "Bits 5:6 - Represents the AHB response error request channel id.bit\\[1\\]=1:TX channel.\\\\bit\\[1\\]=0:RX channel.\\\\"]
    #[inline(always)]
    pub fn ahbinf_resp_err_ch_id(&self) -> AHBINF_RESP_ERR_CH_ID_R {
        AHBINF_RESP_ERR_CH_ID_R::new(((self.bits >> 5) & 3) as u8)
    }
}
