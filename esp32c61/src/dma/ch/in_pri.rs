...
#[doc = "Field `RX_PRI` reader - Configures the priority of RX channel 0.The larger of the value, the higher of the priority.."]
pub type RX_PRI_R = crate::FieldReader;
#[doc = "Field `RX_PRI` writer - Configures the priority of RX channel 0.The larger of the value, the higher of the priority.."]
