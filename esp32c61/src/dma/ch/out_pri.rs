...
#[doc = "Field `TX_PRI` reader - Configures the priority of TX channel 0.The larger of the value, the higher of the priority.."]
pub type TX_PRI_R = crate::FieldReader;
#[doc = "Field `TX_PRI` writer - Configures the priority of TX channel 0.The larger of the value, the higher of the priority.."]
