...
#[doc = "Field `OUTLINK_STOP` writer - Configures whether to stop AHB_DMA's TX channel 0 from transmitting data.\\\\0: Invalid. No effect\\\\1: Stop\\\\"]
pub type OUTLINK_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTLINK_START` writer - Configures whether to enable AHB_DMA's TX channel 0 for data transfer.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUTLINK_START_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTLINK_RESTART` writer - Configures whether to restart TX channel 0 for AHB_DMA transfer.\\\\0: Invalid. No effect\\\\1: Restart\\\\"]
