...
#[doc = "Field `IN_DONE` reader - Write 1 to enable AHB_DMA_IN_DONE_CH0_INT"]
pub type IN_DONE_R = crate::BitReader;
#[doc = "Field `IN_DONE` writer - Write 1 to enable AHB_DMA_IN_DONE_CH0_INT"]
pub type IN_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_SUC_EOF` reader - Write 1 to enable AHB_DMA_IN_SUC_EOF_CH0_INT"]
pub type IN_SUC_EOF_R = crate::BitReader;
#[doc = "Field `IN_SUC_EOF` writer - Write 1 to enable AHB_DMA_IN_SUC_EOF_CH0_INT"]
pub type IN_SUC_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_ERR_EOF` reader - Write 1 to enable AHB_DMA_IN_ERR_EOF_CH0_INT"]
pub type IN_ERR_EOF_R = crate::BitReader;
#[doc = "Field `IN_ERR_EOF` writer - Write 1 to enable AHB_DMA_IN_ERR_EOF_CH0_INT"]
pub type IN_ERR_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_DSCR_ERR` reader - Write 1 to enable AHB_DMA_IN_DSCR_ERR_CH0_INT"]
pub type IN_DSCR_ERR_R = crate::BitReader;
#[doc = "Field `IN_DSCR_ERR` writer - Write 1 to enable AHB_DMA_IN_DSCR_ERR_CH0_INT"]
pub type IN_DSCR_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_DSCR_EMPTY` reader - Write 1 to enable AHB_DMA_IN_DSCR_EMPTY_CH0_INT"]
pub type IN_DSCR_EMPTY_R = crate::BitReader;
#[doc = "Field `IN_DSCR_EMPTY` writer - Write 1 to enable AHB_DMA_IN_DSCR_EMPTY_CH0_INT"]
pub type IN_DSCR_EMPTY_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_OVF` reader - Write 1 to enable AHB_DMA_INFIFO_OVF_CH0_INT"]
pub type INFIFO_OVF_R = crate::BitReader;
#[doc = "Field `INFIFO_OVF` writer - Write 1 to enable AHB_DMA_INFIFO_OVF_CH0_INT"]
pub type INFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_UDF` reader - Write 1 to enable AHB_DMA_INFIFO_UDF_CH0_INT"]
pub type INFIFO_UDF_R = crate::BitReader;
#[doc = "Field `INFIFO_UDF` writer - Write 1 to enable AHB_DMA_INFIFO_UDF_CH0_INT"]
pub type INFIFO_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_AHBINF_RESP_ERR` reader - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH0_INT"]
pub type IN_AHBINF_RESP_ERR_R = crate::BitReader;
#[doc = "Field `IN_AHBINF_RESP_ERR` writer - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH0_INT"]
pub type IN_AHBINF_RESP_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn in_ahbinf_resp_err(&self) -> IN_AHBINF_RESP_ERR_R {
        IN_AHBINF_RESP_ERR_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ENA")
            ...
            .field("in_ahbinf_resp_err", &self.in_ahbinf_resp_err())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 7 - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH0_INT"]
    #[inline(always)]
    pub fn in_ahbinf_resp_err(&mut self) -> IN_AHBINF_RESP_ERR_W<'_, ENA_SPEC> {
        IN_AHBINF_RESP_ERR_W::new(self, 7)
    }
}
