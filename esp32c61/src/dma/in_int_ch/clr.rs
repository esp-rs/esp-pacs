...
#[doc = "Field `IN_DONE` writer - Write 1 to clear AHB_DMA_IN_DONE_CH0_INT"]
pub type IN_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_SUC_EOF` writer - Write 1 to clear AHB_DMA_IN_SUC_EOF_CH0_INT"]
pub type IN_SUC_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_ERR_EOF` writer - Write 1 to clear AHB_DMA_IN_ERR_EOF_CH0_INT"]
pub type IN_ERR_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_DSCR_ERR` writer - Write 1 to clear AHB_DMA_IN_DSCR_ERR_CH0_INT"]
pub type IN_DSCR_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_DSCR_EMPTY` writer - Write 1 to clear AHB_DMA_IN_DSCR_EMPTY_CH0_INT"]
pub type IN_DSCR_EMPTY_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `INFIFO_OVF` writer - Write 1 to clear AHB_DMA_INFIFO_OVF_CH0_INT"]
pub type INFIFO_OVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `INFIFO_UDF` writer - Write 1 to clear AHB_DMA_INFIFO_UDF_CH0_INT"]
pub type INFIFO_UDF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_AHBINF_RESP_ERR` writer - Write 1 to clear AHB_DMA_IN_RESP_ERR_CH0_INT"]
pub type IN_AHBINF_RESP_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn in_ahbinf_resp_err(&mut self) -> IN_AHBINF_RESP_ERR_W<'_, CLR_SPEC> {
