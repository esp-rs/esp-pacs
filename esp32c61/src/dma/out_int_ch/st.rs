...
#[doc = "Field `OUT_DONE` reader - The masked interrupt status of AHB_DMA_OUT_DONE_CH0_INT"]
pub type OUT_DONE_R = crate::BitReader;
#[doc = "Field `OUT_EOF` reader - The masked interrupt status of AHB_DMA_OUT_EOF_CH0_INT"]
pub type OUT_EOF_R = crate::BitReader;
#[doc = "Field `OUT_DSCR_ERR` reader - The masked interrupt status of AHB_DMA_OUT_DSCR_ERR_CH0_INT"]
pub type OUT_DSCR_ERR_R = crate::BitReader;
#[doc = "Field `OUT_TOTAL_EOF` reader - The masked interrupt status of AHB_DMA_OUT_TOTAL_EOF_CH0_INT"]
pub type OUT_TOTAL_EOF_R = crate::BitReader;
#[doc = "Field `OUTFIFO_OVF` reader - The masked interrupt status of AHB_DMA_OUTFIFO_OVF_CH0_INT"]
pub type OUTFIFO_OVF_R = crate::BitReader;
#[doc = "Field `OUTFIFO_UDF` reader - The masked interrupt status of AHB_DMA_OUTFIFO_UDF_CH0_INT"]
pub type OUTFIFO_UDF_R = crate::BitReader;
#[doc = "Field `OUT_AHBINF_RESP_ERR` reader - The masked interrupt status of AHB_DMA_OUT_RESP_ERR_CH0_INT"]
