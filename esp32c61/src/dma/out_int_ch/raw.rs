...
#[doc = "Field `OUT_DONE` reader - The raw interrupt status of AHB_DMA_OUT_DONE_CH0_INT"]
pub type OUT_DONE_R = crate::BitReader;
#[doc = "Field `OUT_DONE` writer - The raw interrupt status of AHB_DMA_OUT_DONE_CH0_INT"]
pub type OUT_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_EOF` reader - The raw interrupt status of AHB_DMA_OUT_EOF_CH0_INT"]
pub type OUT_EOF_R = crate::BitReader;
#[doc = "Field `OUT_EOF` writer - The raw interrupt status of AHB_DMA_OUT_EOF_CH0_INT"]
pub type OUT_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_DSCR_ERR` reader - The raw interrupt status of AHB_DMA_OUT_DSCR_ERR_CH0_INT"]
pub type OUT_DSCR_ERR_R = crate::BitReader;
#[doc = "Field `OUT_DSCR_ERR` writer - The raw interrupt status of AHB_DMA_OUT_DSCR_ERR_CH0_INT"]
pub type OUT_DSCR_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_TOTAL_EOF` reader - The raw interrupt status of AHB_DMA_OUT_TOTAL_EOF_CH0_INT"]
pub type OUT_TOTAL_EOF_R = crate::BitReader;
#[doc = "Field `OUT_TOTAL_EOF` writer - The raw interrupt status of AHB_DMA_OUT_TOTAL_EOF_CH0_INT"]
pub type OUT_TOTAL_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_OVF` reader - The raw interrupt status of AHB_DMA_OUTFIFO_OVF_CH0_INT"]
pub type OUTFIFO_OVF_R = crate::BitReader;
#[doc = "Field `OUTFIFO_OVF` writer - The raw interrupt status of AHB_DMA_OUTFIFO_OVF_CH0_INT"]
pub type OUTFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_UDF` reader - The raw interrupt status of AHB_DMA_OUTFIFO_UDF_CH0_INT"]
pub type OUTFIFO_UDF_R = crate::BitReader;
#[doc = "Field `OUTFIFO_UDF` writer - The raw interrupt status of AHB_DMA_OUTFIFO_UDF_CH0_INT"]
pub type OUTFIFO_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_AHBINF_RESP_ERR` reader - The raw interrupt status of AHB_DMA_OUT_RESP_ERR_CH0_INT"]
pub type OUT_AHBINF_RESP_ERR_R = crate::BitReader;
#[doc = "Field `OUT_AHBINF_RESP_ERR` writer - The raw interrupt status of AHB_DMA_OUT_RESP_ERR_CH0_INT"]
pub type OUT_AHBINF_RESP_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn out_ahbinf_resp_err(&self) -> OUT_AHBINF_RESP_ERR_R {
        OUT_AHBINF_RESP_ERR_R::new(((self.bits >> 6) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RAW")
            ...
            .field("out_ahbinf_resp_err", &self.out_ahbinf_resp_err())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 6 - The raw interrupt status of AHB_DMA_OUT_RESP_ERR_CH0_INT"]
    #[inline(always)]
    pub fn out_ahbinf_resp_err(&mut self) -> OUT_AHBINF_RESP_ERR_W<'_, RAW_SPEC> {
        OUT_AHBINF_RESP_ERR_W::new(self, 6)
    }
}
