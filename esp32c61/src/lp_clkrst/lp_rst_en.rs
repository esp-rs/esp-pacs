...
#[doc = "Field `POR_ST_WAIT_FORCE_EN` reader - reserved"]
pub type POR_ST_WAIT_FORCE_EN_R = crate::BitReader;
#[doc = "Field `POR_ST_WAIT_FORCE_EN` writer - reserved"]
pub type POR_ST_WAIT_FORCE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 27 - reserved"]
    #[inline(always)]
    pub fn por_st_wait_force_en(&self) -> POR_ST_WAIT_FORCE_EN_R {
        POR_ST_WAIT_FORCE_EN_R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_RST_EN")
            .field("por_st_wait_force_en", &self.por_st_wait_force_en())
...
impl W {
    #[doc = "Bit 27 - reserved"]
    #[inline(always)]
    pub fn por_st_wait_force_en(&mut self) -> POR_ST_WAIT_FORCE_EN_W<'_, LP_RST_EN_SPEC> {
        POR_ST_WAIT_FORCE_EN_W::new(self, 27)
    }
    #[doc = "Bit 28 - Configures whether or not to reset EFUSE_CTRL always-on part 0: Invalid.No effect 1: Reset"]
    #[inline(always)]
