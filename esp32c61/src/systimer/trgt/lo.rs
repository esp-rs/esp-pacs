...
#[doc = "Field `LO` reader - Configures the alarm value to be loaded to COMP0, low 32 bits."]
pub type LO_R = crate::FieldReader<u32>;
#[doc = "Field `LO` writer - Configures the alarm value to be loaded to COMP0, low 32 bits."]
