...
#[doc = "Field `TARGET2_LO_RO` reader - Represents the actual target value of COMP2, low 32 bits."]
pub type TARGET2_LO_RO_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the actual target value of COMP2, low 32 bits."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REAL_TARGET2_LO")
            .field("target2_lo_ro", &self.target2_lo_ro())
            .finish()
    }
}
#[doc = "Actual target value of COMP2, low 32 bits\n\nYou can [`read`](crate::Reg::read) this register and get [`real_target2_lo::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
