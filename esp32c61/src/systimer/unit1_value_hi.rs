...
#[doc = "Field `TIMER_UNIT1_VALUE_HI` reader - Represents UNIT1 read value, high 20 bits."]
pub type TIMER_UNIT1_VALUE_HI_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:19 - Represents UNIT1 read value, high 20 bits."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UNIT1_VALUE_HI")
            .field("timer_unit1_value_hi", &self.timer_unit1_value_hi())
            .finish()
    }
}
#[doc = "UNIT1 value, high 20 bits\n\nYou can [`read`](crate::Reg::read) this register and get [`unit1_value_hi::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
