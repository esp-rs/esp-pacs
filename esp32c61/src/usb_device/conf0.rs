...
#[doc = "Field `USB_PHY_TX_EDGE_SEL` reader - Control at which clock edge the dp and dm are sent to USB PHY, 0: tx output at clock negative edge. 1: tx output at clock positive edge."]
pub type USB_PHY_TX_EDGE_SEL_R = crate::BitReader;
#[doc = "Field `USB_PHY_TX_EDGE_SEL` writer - Control at which clock edge the dp and dm are sent to USB PHY, 0: tx output at clock negative edge. 1: tx output at clock positive edge."]
pub type USB_PHY_TX_EDGE_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn usb_phy_tx_edge_sel(&self) -> USB_PHY_TX_EDGE_SEL_R {
        USB_PHY_TX_EDGE_SEL_R::new(((self.bits >> 16) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF0")
            ...
            .field("usb_phy_tx_edge_sel", &self.usb_phy_tx_edge_sel())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 16 - Control at which clock edge the dp and dm are sent to USB PHY, 0: tx output at clock negative edge. 1: tx output at clock positive edge."]
    #[inline(always)]
    pub fn usb_phy_tx_edge_sel(&mut self) -> USB_PHY_TX_EDGE_SEL_W<'_, CONF0_SPEC> {
        USB_PHY_TX_EDGE_SEL_W::new(self, 16)
    }
}
