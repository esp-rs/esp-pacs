...
#[doc = "Field `JTAG_IN_FLUSH` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT interrupt."]
pub type JTAG_IN_FLUSH_R = crate::BitReader;
#[doc = "Field `SOF` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_SOF_INT interrupt."]
pub type SOF_R = crate::BitReader;
#[doc = "Field `SERIAL_OUT_RECV_PKT` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT interrupt."]
pub type SERIAL_OUT_RECV_PKT_R = crate::BitReader;
#[doc = "Field `SERIAL_IN_EMPTY` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT interrupt."]
pub type SERIAL_IN_EMPTY_R = crate::BitReader;
#[doc = "Field `PID_ERR` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_PID_ERR_INT interrupt."]
pub type PID_ERR_R = crate::BitReader;
#[doc = "Field `CRC5_ERR` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_CRC5_ERR_INT interrupt."]
pub type CRC5_ERR_R = crate::BitReader;
#[doc = "Field `CRC16_ERR` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_CRC16_ERR_INT interrupt."]
pub type CRC16_ERR_R = crate::BitReader;
#[doc = "Field `STUFF_ERR` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_STUFF_ERR_INT interrupt."]
pub type STUFF_ERR_R = crate::BitReader;
#[doc = "Field `IN_TOKEN_REC_IN_EP1` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT interrupt."]
pub type IN_TOKEN_REC_IN_EP1_R = crate::BitReader;
#[doc = "Field `USB_BUS_RESET` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_USB_BUS_RESET_INT interrupt."]
pub type USB_BUS_RESET_R = crate::BitReader;
#[doc = "Field `OUT_EP1_ZERO_PAYLOAD` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_OUT_EP1_ZERO_PAYLOAD_INT interrupt."]
pub type OUT_EP1_ZERO_PAYLOAD_R = crate::BitReader;
#[doc = "Field `OUT_EP2_ZERO_PAYLOAD` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_OUT_EP2_ZERO_PAYLOAD_INT interrupt."]
pub type OUT_EP2_ZERO_PAYLOAD_R = crate::BitReader;
#[doc = "Field `RTS_CHG` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_RTS_CHG_INT interrupt."]
pub type RTS_CHG_R = crate::BitReader;
#[doc = "Field `DTR_CHG` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_DTR_CHG_INT interrupt."]
pub type DTR_CHG_R = crate::BitReader;
#[doc = "Field `GET_LINE_CODE` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_GET_LINE_CODE_INT interrupt."]
pub type GET_LINE_CODE_R = crate::BitReader;
#[doc = "Field `SET_LINE_CODE` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_SET_LINE_CODE_INT interrupt."]
