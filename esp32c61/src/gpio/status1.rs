...
#[doc = "Field `INTERRUPT` reader - GPIO interrupt status register for GPIO32-33"]
pub type INTERRUPT_R = crate::FieldReader;
#[doc = "Field `INTERRUPT` writer - GPIO interrupt status register for GPIO32-33"]
pub type INTERRUPT_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 0:1 - GPIO interrupt status register for GPIO32-33"]
    #[inline(always)]
    pub fn interrupt(&self) -> INTERRUPT_R {
        INTERRUPT_R::new((self.bits & 3) as u8)
    }
}
