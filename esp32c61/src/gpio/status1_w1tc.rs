...
#[doc = "Field `STATUS1_W1TC` writer - GPIO interrupt status clear register for GPIO32-33"]
pub type STATUS1_W1TC_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl W {
    #[doc = "Bits 0:1 - GPIO interrupt status clear register for GPIO32-33"]
    #[inline(always)]
