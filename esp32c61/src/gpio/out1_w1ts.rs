...
#[doc = "Field `OUT1_W1TS` writer - GPIO output set register for GPIO32-33"]
pub type OUT1_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl W {
    #[doc = "Bits 0:1 - GPIO output set register for GPIO32-33"]
    #[inline(always)]
