...
#[doc = "Field `STATUS_INTERRUPT_NEXT1` reader - GPIO interrupt source register for GPIO32-33"]
pub type STATUS_INTERRUPT_NEXT1_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:1 - GPIO interrupt source register for GPIO32-33"]
    #[inline(always)]
    pub fn status_interrupt_next1(&self) -> STATUS_INTERRUPT_NEXT1_R {
        STATUS_INTERRUPT_NEXT1_R::new((self.bits & 3) as u8)
    }
}
