...
#[doc = "Field `INT_ENA` reader - set bit 13 to enable gpio_procpu_int. set bit 15 to enable gpio_sdio_int."]
pub type INT_ENA_R = crate::FieldReader;
#[doc = "Field `INT_ENA` writer - set bit 13 to enable gpio_procpu_int. set bit 15 to enable gpio_sdio_int."]
