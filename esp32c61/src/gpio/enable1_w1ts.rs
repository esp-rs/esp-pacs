...
#[doc = "Field `ENABLE1_W1TS` writer - GPIO output enable set register for GPIO32-33"]
pub type ENABLE1_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl W {
    #[doc = "Bits 0:1 - GPIO output enable set register for GPIO32-33"]
    #[inline(always)]
