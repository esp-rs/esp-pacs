...
#[doc = "Field `DATA` reader - GPIO output enable register for GPIO32-33"]
pub type DATA_R = crate::FieldReader;
#[doc = "Field `DATA` writer - GPIO output enable register for GPIO32-33"]
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 0:1 - GPIO output enable register for GPIO32-33"]
    #[inline(always)]
    pub fn data(&self) -> DATA_R {
        DATA_R::new((self.bits & 3) as u8)
    }
}
