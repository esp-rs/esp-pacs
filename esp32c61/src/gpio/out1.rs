...
#[doc = "Field `DATA_ORIG` reader - GPIO output register for GPIO32-33"]
pub type DATA_ORIG_R = crate::FieldReader;
#[doc = "Field `DATA_ORIG` writer - GPIO output register for GPIO32-33"]
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 0:1 - GPIO output register for GPIO32-33"]
    #[inline(always)]
    pub fn data_orig(&self) -> DATA_ORIG_R {
        DATA_ORIG_R::new((self.bits & 3) as u8)
    }
}
