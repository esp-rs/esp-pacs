...
impl W {
    ...
    pub fn sdio_slc_frhost_bit_int_clr(
        &mut self,
        n: u8,
    ) -> SDIO_SLC_FRHOST_BIT_INT_CLR_W<SLC1INT_CLR_SPEC> {
    ...
    pub fn sdio_slc1_rx_clrart_int_clr(
        &mut self,
    ) -> SDIO_SLC1_RX_CLRART_INT_CLR_W<SLC1INT_CLR_SPEC> {
    ...
    pub fn sdio_slc1_tx_clrart_int_clr(
        &mut self,
    ) -> SDIO_SLC1_TX_CLRART_INT_CLR_W<SLC1INT_CLR_SPEC> {
        SDIO_SLC1_TX_CLRART_INT_CLR_W::new(self, 9)
    }
    #[doc = "Bit 10 - Write 1 to clear interrupt SLC1_RX_UDF_INT."]
    #[inline(always)]
    pub fn sdio_slc1_rx_udf_int_clr(&mut self) -> SDIO_SLC1_RX_UDF_INT_CLR_W<SLC1INT_CLR_SPEC> {
        SDIO_SLC1_RX_UDF_INT_CLR_W::new(self, 10)
    }
    #[doc = "Bit 11 - Write 1 to clear interrupt SLC1_TX_OVF_INT."]
    #[inline(always)]
    pub fn sdio_slc1_tx_ovf_int_clr(&mut self) -> SDIO_SLC1_TX_OVF_INT_CLR_W<SLC1INT_CLR_SPEC> {
        SDIO_SLC1_TX_OVF_INT_CLR_W::new(self, 11)
    }
    #[doc = "Bit 14 - Write 1 to clear interrupt SLC1_TX_DONE_INT."]
    #[inline(always)]
    pub fn sdio_slc1_tx_done_int_clr(&mut self) -> SDIO_SLC1_TX_DONE_INT_CLR_W<SLC1INT_CLR_SPEC> {
    ...
    pub fn sdio_slc1_tx_suc_eof_int_clr(
        &mut self,
    ) -> SDIO_SLC1_TX_SUC_EOF_INT_CLR_W<SLC1INT_CLR_SPEC> {
        SDIO_SLC1_TX_SUC_EOF_INT_CLR_W::new(self, 15)
    }
    #[doc = "Bit 16 - Write 1 to clear interrupt SLC1_RX_DONE_INT."]
    #[inline(always)]
    pub fn sdio_slc1_rx_done_int_clr(&mut self) -> SDIO_SLC1_RX_DONE_INT_CLR_W<SLC1INT_CLR_SPEC> {
        SDIO_SLC1_RX_DONE_INT_CLR_W::new(self, 16)
    }
    #[doc = "Bit 17 - Write 1 to clear interrupt SLC1_RX_EOF_INT."]
    #[inline(always)]
    pub fn sdio_slc1_rx_eof_int_clr(&mut self) -> SDIO_SLC1_RX_EOF_INT_CLR_W<SLC1INT_CLR_SPEC> {
    ...
    pub fn sdio_slc1_tx_dscr_err_int_clr(
        &mut self,
    ) -> SDIO_SLC1_TX_DSCR_ERR_INT_CLR_W<SLC1INT_CLR_SPEC> {
    ...
    pub fn sdio_slc1_rx_dscr_err_int_clr(
        &mut self,
    ) -> SDIO_SLC1_RX_DSCR_ERR_INT_CLR_W<SLC1INT_CLR_SPEC> {
