#[doc = "Register `SLC1INT_RAW` reader"]
pub type R = crate::R<SLC1INT_RAW_SPEC>;
#[doc = "Register `SLC1INT_RAW` writer"]
pub type W = crate::W<SLC1INT_RAW_SPEC>;
...
#[doc = "Field `SDIO_SLC1_RX_START_INT_RAW` reader - The raw interrupt status of SLC1_RX_START_INT."]
pub type SDIO_SLC1_RX_START_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_RX_START_INT_RAW` writer - The raw interrupt status of SLC1_RX_START_INT."]
pub type SDIO_SLC1_RX_START_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIO_SLC1_TX_START_INT_RAW` reader - The raw interrupt status of SLC1_TX_START_INT."]
pub type SDIO_SLC1_TX_START_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_TX_START_INT_RAW` writer - The raw interrupt status of SLC1_TX_START_INT."]
pub type SDIO_SLC1_TX_START_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIO_SLC1_RX_UDF_INT_RAW` reader - The raw interrupt status of SLC1_RX_UDF_INT."]
pub type SDIO_SLC1_RX_UDF_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_RX_UDF_INT_RAW` writer - The raw interrupt status of SLC1_RX_UDF_INT."]
pub type SDIO_SLC1_RX_UDF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIO_SLC1_TX_OVF_INT_RAW` reader - The raw interrupt status of SLC1_TX_OVF_INT."]
pub type SDIO_SLC1_TX_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_TX_OVF_INT_RAW` writer - The raw interrupt status of SLC1_TX_OVF_INT."]
pub type SDIO_SLC1_TX_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIO_SLC1_TX_DONE_INT_RAW` reader - The raw interrupt status of SLC1_TX_DONE_INT."]
pub type SDIO_SLC1_TX_DONE_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_TX_DONE_INT_RAW` writer - The raw interrupt status of SLC1_TX_DONE_INT."]
pub type SDIO_SLC1_TX_DONE_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIO_SLC1_TX_SUC_EOF_INT_RAW` reader - The raw interrupt status of SLC1_TX_SUC_EOF_INT."]
pub type SDIO_SLC1_TX_SUC_EOF_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_TX_SUC_EOF_INT_RAW` writer - The raw interrupt status of SLC1_TX_SUC_EOF_INT."]
pub type SDIO_SLC1_TX_SUC_EOF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIO_SLC1_RX_DONE_INT_RAW` reader - The raw interrupt status of SLC1_RX_DONE_INT."]
pub type SDIO_SLC1_RX_DONE_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_RX_DONE_INT_RAW` writer - The raw interrupt status of SLC1_RX_DONE_INT."]
pub type SDIO_SLC1_RX_DONE_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIO_SLC1_RX_EOF_INT_RAW` reader - The raw interrupt status of SLC1_RX_EOF_INT."]
pub type SDIO_SLC1_RX_EOF_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_RX_EOF_INT_RAW` writer - The raw interrupt status of SLC1_RX_EOF_INT."]
pub type SDIO_SLC1_RX_EOF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIO_SLC1_TX_DSCR_ERR_INT_RAW` reader - The raw interrupt status of SLC1_TX_DSCR_ERR_INT."]
pub type SDIO_SLC1_TX_DSCR_ERR_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_TX_DSCR_ERR_INT_RAW` writer - The raw interrupt status of SLC1_TX_DSCR_ERR_INT."]
pub type SDIO_SLC1_TX_DSCR_ERR_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIO_SLC1_RX_DSCR_ERR_INT_RAW` reader - The raw interrupt status of SLC1_RX_DSCR_ERR_INT."]
pub type SDIO_SLC1_RX_DSCR_ERR_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDIO_SLC1_RX_DSCR_ERR_INT_RAW` writer - The raw interrupt status of SLC1_RX_DSCR_ERR_INT."]
pub type SDIO_SLC1_RX_DSCR_ERR_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn sdio_slc1_rx_start_int_raw(&self) -> SDIO_SLC1_RX_START_INT_RAW_R {
        SDIO_SLC1_RX_START_INT_RAW_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - The raw interrupt status of SLC1_TX_START_INT."]
    #[inline(always)]
    pub fn sdio_slc1_tx_start_int_raw(&self) -> SDIO_SLC1_TX_START_INT_RAW_R {
        SDIO_SLC1_TX_START_INT_RAW_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - The raw interrupt status of SLC1_RX_UDF_INT."]
    #[inline(always)]
    pub fn sdio_slc1_rx_udf_int_raw(&self) -> SDIO_SLC1_RX_UDF_INT_RAW_R {
        SDIO_SLC1_RX_UDF_INT_RAW_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - The raw interrupt status of SLC1_TX_OVF_INT."]
    #[inline(always)]
    pub fn sdio_slc1_tx_ovf_int_raw(&self) -> SDIO_SLC1_TX_OVF_INT_RAW_R {
        SDIO_SLC1_TX_OVF_INT_RAW_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 14 - The raw interrupt status of SLC1_TX_DONE_INT."]
    #[inline(always)]
    pub fn sdio_slc1_tx_done_int_raw(&self) -> SDIO_SLC1_TX_DONE_INT_RAW_R {
        SDIO_SLC1_TX_DONE_INT_RAW_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - The raw interrupt status of SLC1_TX_SUC_EOF_INT."]
    #[inline(always)]
    pub fn sdio_slc1_tx_suc_eof_int_raw(&self) -> SDIO_SLC1_TX_SUC_EOF_INT_RAW_R {
        SDIO_SLC1_TX_SUC_EOF_INT_RAW_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - The raw interrupt status of SLC1_RX_DONE_INT."]
    #[inline(always)]
    pub fn sdio_slc1_rx_done_int_raw(&self) -> SDIO_SLC1_RX_DONE_INT_RAW_R {
        SDIO_SLC1_RX_DONE_INT_RAW_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - The raw interrupt status of SLC1_RX_EOF_INT."]
    #[inline(always)]
    pub fn sdio_slc1_rx_eof_int_raw(&self) -> SDIO_SLC1_RX_EOF_INT_RAW_R {
        SDIO_SLC1_RX_EOF_INT_RAW_R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 19 - The raw interrupt status of SLC1_TX_DSCR_ERR_INT."]
    #[inline(always)]
    pub fn sdio_slc1_tx_dscr_err_int_raw(&self) -> SDIO_SLC1_TX_DSCR_ERR_INT_RAW_R {
        SDIO_SLC1_TX_DSCR_ERR_INT_RAW_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - The raw interrupt status of SLC1_RX_DSCR_ERR_INT."]
    #[inline(always)]
    pub fn sdio_slc1_rx_dscr_err_int_raw(&self) -> SDIO_SLC1_RX_DSCR_ERR_INT_RAW_R {
        SDIO_SLC1_RX_DSCR_ERR_INT_RAW_R::new(((self.bits >> 20) & 1) != 0)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SLC1INT_RAW")
            .field(
            ...
            .field(
                ...
                &self.sdio_slc1_rx_start_int_raw(),
            )
            .field(
                "sdio_slc1_tx_start_int_raw",
                &self.sdio_slc1_tx_start_int_raw(),
            )
            .field("sdio_slc1_rx_udf_int_raw", &self.sdio_slc1_rx_udf_int_raw())
            .field("sdio_slc1_tx_ovf_int_raw", &self.sdio_slc1_tx_ovf_int_raw())
            .field(
                "sdio_slc1_tx_done_int_raw",
                &self.sdio_slc1_tx_done_int_raw(),
            )
            .field(
                "sdio_slc1_tx_suc_eof_int_raw",
                &self.sdio_slc1_tx_suc_eof_int_raw(),
            )
            .field(
                "sdio_slc1_rx_done_int_raw",
                &self.sdio_slc1_rx_done_int_raw(),
            )
            .field("sdio_slc1_rx_eof_int_raw", &self.sdio_slc1_rx_eof_int_raw())
            .field(
                "sdio_slc1_tx_dscr_err_int_raw",
                &self.sdio_slc1_tx_dscr_err_int_raw(),
            )
            .field(
                "sdio_slc1_rx_dscr_err_int_raw",
                &self.sdio_slc1_rx_dscr_err_int_raw(),
            )
            .finish()
    }
}
...
#[doc = "SLC1 to slave raw interrupt status\n\nYou can [`read`](crate::Reg::read) this register and get [`slc1int_raw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`slc1int_raw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SLC1INT_RAW_SPEC;
impl crate::RegisterSpec for SLC1INT_RAW_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`slc1int_raw::R`](R) reader structure"]
impl crate::Readable for SLC1INT_RAW_SPEC {}
#[doc = "`write(|w| ..)` method takes [`slc1int_raw::W`](W) writer structure"]
impl crate::Writable for SLC1INT_RAW_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SLC1INT_RAW to value 0"]
impl crate::Resettable for SLC1INT_RAW_SPEC {}
