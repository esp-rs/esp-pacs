...
pub struct RegisterBlock {
    ...
    pin: [PIN; 7],
    _reserved12: [u8; 0x0264],
    func_out_sel_cfg: [FUNC_OUT_SEL_CFG; 7],
    _reserved13: [u8; 0x012c],
...
impl RegisterBlock {
    ...
    #[doc = "0x30..0x4c - LP_GPIO%s configuration register"]
    #[inline(always)]
    ...
    #[doc = "0x2b0..0x2cc - Configuration register for LP_GPIO%s output"]
    #[inline(always)]
