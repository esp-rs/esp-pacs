#[doc = "Register `MEM_DPA_CTRL` reader"]
pub type R = crate::R<MEM_DPA_CTRL_SPEC>;
#[doc = "Register `MEM_DPA_CTRL` writer"]
pub type W = crate::W<MEM_DPA_CTRL_SPEC>;
...
impl W {
    #[doc = "Bits 0:2 - Set the security level of spi mem cryption. 0: Shut off cryption DPA funtion. 1-7: The bigger the number is, the more secure the cryption is. (Note that the performance of cryption will decrease together with this number increasing)"]
    #[inline(always)]
    pub fn crypt_security_level(&mut self) -> CRYPT_SECURITY_LEVEL_W<MEM_DPA_CTRL_SPEC> {
        CRYPT_SECURITY_LEVEL_W::new(self, 0)
    }
    #[doc = "Bit 3 - Only available when SPI_CRYPT_SECURITY_LEVEL is not 0. 1: Enable DPA in the calculation that using key 1 or key 2. 0: Enable DPA only in the calculation that using key 1."]
    #[inline(always)]
    pub fn crypt_calc_d_dpa_en(&mut self) -> CRYPT_CALC_D_DPA_EN_W<MEM_DPA_CTRL_SPEC> {
        CRYPT_CALC_D_DPA_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - 1: MSPI XTS DPA clock gate is controlled by SPI_CRYPT_CALC_D_DPA_EN and SPI_CRYPT_SECURITY_LEVEL. 0: Controlled by efuse bits."]
    #[inline(always)]
    pub fn crypt_dpa_select_register(&mut self) -> CRYPT_DPA_SELECT_REGISTER_W<MEM_DPA_CTRL_SPEC> {
        CRYPT_DPA_SELECT_REGISTER_W::new(self, 4)
    }
}
#[doc = "SPI memory cryption DPA register\n\nYou can [`read`](crate::Reg::read) this register and get [`mem_dpa_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mem_dpa_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MEM_DPA_CTRL_SPEC;
impl crate::RegisterSpec for MEM_DPA_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mem_dpa_ctrl::R`](R) reader structure"]
impl crate::Readable for MEM_DPA_CTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mem_dpa_ctrl::W`](W) writer structure"]
impl crate::Writable for MEM_DPA_CTRL_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MEM_DPA_CTRL to value 0x0f"]
impl crate::Resettable for MEM_DPA_CTRL_SPEC {
