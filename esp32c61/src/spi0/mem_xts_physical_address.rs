#[doc = "Register `MEM_XTS_PHYSICAL_ADDRESS` reader"]
pub type R = crate::R<MEM_XTS_PHYSICAL_ADDRESS_SPEC>;
#[doc = "Register `MEM_XTS_PHYSICAL_ADDRESS` writer"]
pub type W = crate::W<MEM_XTS_PHYSICAL_ADDRESS_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MEM_XTS_PHYSICAL_ADDRESS")
...
impl W {
    ...
    pub fn xts_physical_address(
        &mut self,
    ) -> XTS_PHYSICAL_ADDRESS_W<MEM_XTS_PHYSICAL_ADDRESS_SPEC> {
        XTS_PHYSICAL_ADDRESS_W::new(self, 0)
    }
}
#[doc = "Manual Encryption physical address register\n\nYou can [`read`](crate::Reg::read) this register and get [`mem_xts_physical_address::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mem_xts_physical_address::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MEM_XTS_PHYSICAL_ADDRESS_SPEC;
impl crate::RegisterSpec for MEM_XTS_PHYSICAL_ADDRESS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mem_xts_physical_address::R`](R) reader structure"]
impl crate::Readable for MEM_XTS_PHYSICAL_ADDRESS_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mem_xts_physical_address::W`](W) writer structure"]
impl crate::Writable for MEM_XTS_PHYSICAL_ADDRESS_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MEM_XTS_PHYSICAL_ADDRESS to value 0"]
impl crate::Resettable for MEM_XTS_PHYSICAL_ADDRESS_SPEC {}
