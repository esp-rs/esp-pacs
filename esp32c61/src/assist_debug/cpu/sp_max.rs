...
#[doc = "Field `SP_MAX` reader - Configures the upper bound address of SP."]
pub type SP_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `SP_MAX` writer - Configures the upper bound address of SP."]
pub type SP_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the upper bound address of SP."]
    #[inline(always)]
    pub fn sp_max(&self) -> SP_MAX_R {
        SP_MAX_R::new(self.bits)
    }
}
