...
#[doc = "Field `RCD_RECORDEN` reader - Configures whether to enable PC logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG starts to record PC in real time\\\\"]
pub type RCD_RECORDEN_R = crate::BitReader;
#[doc = "Field `RCD_RECORDEN` writer - Configures whether to enable PC logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG starts to record PC in real time\\\\"]
