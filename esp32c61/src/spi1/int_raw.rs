...
impl R {
    ...
    pub fn brown_out_int_raw(&self) -> BROWN_OUT_INT_RAW_R {
        BROWN_OUT_INT_RAW_R::new(((self.bits >> 10) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW")
            .field("per_end_int_raw", &self.per_end_int_raw())
            .field("pes_end_int_raw", &self.pes_end_int_raw())
            .field("wpe_end_int_raw", &self.wpe_end_int_raw())
            .field("slv_st_end_int_raw", &self.slv_st_end_int_raw())
            .field("mst_st_end_int_raw", &self.mst_st_end_int_raw())
            .field("brown_out_int_raw", &self.brown_out_int_raw())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - The raw bit for SPI_MEM_PER_END_INT interrupt. 1: Triggered when Auto Resume command (0x7A) is sent and flash is resumed successfully. 0: Others."]
    #[inline(always)]
    pub fn per_end_int_raw(&mut self) -> PER_END_INT_RAW_W<'_, INT_RAW_SPEC> {
        PER_END_INT_RAW_W::new(self, 0)
    }
    #[doc = "Bit 1 - The raw bit for SPI_MEM_PES_END_INT interrupt.1: Triggered when Auto Suspend command (0x75) is sent and flash is suspended successfully. 0: Others."]
    #[inline(always)]
    pub fn pes_end_int_raw(&mut self) -> PES_END_INT_RAW_W<'_, INT_RAW_SPEC> {
        PES_END_INT_RAW_W::new(self, 1)
    }
    #[doc = "Bit 2 - The raw bit for SPI_MEM_WPE_END_INT interrupt. 1: Triggered when WRSR/PP/SE/BE/CE is sent and flash is already idle. 0: Others."]
    #[inline(always)]
    pub fn wpe_end_int_raw(&mut self) -> WPE_END_INT_RAW_W<'_, INT_RAW_SPEC> {
    ...
    #[doc = "Bit 10 - The raw bit for SPI_MEM_BROWN_OUT_INT interrupt. 1: Triggered condition is that chip is loosing power and RTC module sends out brown out close flash request to SPI1. After SPI1 sends out suspend command to flash, this interrupt is triggered and MSPI returns to idle state. 0: Others."]
    #[inline(always)]
    pub fn brown_out_int_raw(&mut self) -> BROWN_OUT_INT_RAW_W<'_, INT_RAW_SPEC> {
        BROWN_OUT_INT_RAW_W::new(self, 10)
    }
}
