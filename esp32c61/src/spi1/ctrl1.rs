...
#[doc = "Field `CS_HOLD_DLY_RES` reader - After RES/DP/HPM/PES command is sent, SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\\[9:0\\] * 128) SPI_CLK cycles."]
pub type CS_HOLD_DLY_RES_R = crate::FieldReader<u16>;
#[doc = "Field `CS_HOLD_DLY_RES` writer - After RES/DP/HPM/PES command is sent, SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\\[9:0\\] * 128) SPI_CLK cycles."]
pub type CS_HOLD_DLY_RES_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
#[doc = "Field `CS_HOLD_DLY_PER` reader - After PER command is sent, SPI1 waits (SPI_MEM_CS_HOLD_DLY_PER\\[9:0\\] * 128) SPI_CLK cycles."]
pub type CS_HOLD_DLY_PER_R = crate::FieldReader<u16>;
#[doc = "Field `CS_HOLD_DLY_PER` writer - After PER command is sent, SPI1 waits (SPI_MEM_CS_HOLD_DLY_PER\\[9:0\\] * 128) SPI_CLK cycles."]
...
impl W {
    ...
    #[doc = "Bits 12:21 - After PER command is sent, SPI1 waits (SPI_MEM_CS_HOLD_DLY_PER\\[9:0\\] * 128) SPI_CLK cycles."]
    #[inline(always)]
    pub fn cs_hold_dly_per(&mut self) -> CS_HOLD_DLY_PER_W<CTRL1_SPEC> {
...
#[doc = "`reset()` method sets CTRL1 to value 0x003f_fffc"]
