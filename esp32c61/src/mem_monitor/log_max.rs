...
#[doc = "Field `LOG_MAX` reader - Configures the upper bound address of the monitored address space."]
pub type LOG_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `LOG_MAX` writer - Configures the upper bound address of the monitored address space."]
pub type LOG_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the upper bound address of the monitored address space."]
    #[inline(always)]
