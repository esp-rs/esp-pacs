...
impl W {
    ...
    #[doc = "Bits 24:26 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn etm_task_gpio29_sel(&mut self) -> ETM_TASK_GPIO29_SEL_W<ETM_TASK_P5_CFG_SPEC> {
        ETM_TASK_GPIO29_SEL_W::new(self, 24)
    }
    #[doc = "Bit 29 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn etm_task_gpio29_en(&mut self) -> ETM_TASK_GPIO29_EN_W<ETM_TASK_P5_CFG_SPEC> {
