...
impl W {
    ...
    #[doc = "Bits 12:14 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio12_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P2_CFG_SPEC> {
        GPIO_SEL_W::new(self, 12)
    }
    #[doc = "Bits 18:20 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio13_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P2_CFG_SPEC> {
        GPIO_SEL_W::new(self, 18)
    }
    #[doc = "Bits 24:26 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio14_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P2_CFG_SPEC> {
    ...
    #[doc = "Bit 17 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio12_en(&mut self) -> GPIO_EN_W<ETM_TASK_P2_CFG_SPEC> {
        GPIO_EN_W::new(self, 17)
    }
    #[doc = "Bit 23 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio13_en(&mut self) -> GPIO_EN_W<ETM_TASK_P2_CFG_SPEC> {
        GPIO_EN_W::new(self, 23)
    }
    #[doc = "Bit 29 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio14_en(&mut self) -> GPIO_EN_W<ETM_TASK_P2_CFG_SPEC> {
