...
#[doc = "Field `WK_CHAR0` reader - Configures wakeup character 0."]
pub type WK_CHAR0_R = crate::FieldReader;
#[doc = "Field `WK_CHAR0` writer - Configures wakeup character 0."]
pub type WK_CHAR0_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures wakeup character 0."]
    #[inline(always)]
