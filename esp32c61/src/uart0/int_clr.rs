...
#[doc = "Field `RXFIFO_FULL_INT_CLR` writer - Write 1 to clear UART_RXFIFO_FULL_INT."]
pub type RXFIFO_FULL_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TXFIFO_EMPTY_INT_CLR` writer - Write 1 to clear UART_TXFIFO_EMPTY_INT."]
pub type TXFIFO_EMPTY_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PARITY_ERR_INT_CLR` writer - Write 1 to clear UART_PARITY_ERR_INT."]
pub type PARITY_ERR_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FRM_ERR_INT_CLR` writer - Write 1 to clear UART_FRM_ERR_INT."]
pub type FRM_ERR_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RXFIFO_OVF_INT_CLR` writer - Write 1 to clear UART_RXFIFO_OVF_INT."]
pub type RXFIFO_OVF_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DSR_CHG_INT_CLR` writer - Write 1 to clear UART_DSR_CHG_INT."]
pub type DSR_CHG_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CTS_CHG_INT_CLR` writer - Write 1 to clear UART_CTS_CHG_INT."]
pub type CTS_CHG_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BRK_DET_INT_CLR` writer - Write 1 to clear UART_BRK_DET_INT."]
pub type BRK_DET_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RXFIFO_TOUT_INT_CLR` writer - Write 1 to clear UART_RXFIFO_TOUT_INT."]
pub type RXFIFO_TOUT_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SW_XON_INT_CLR` writer - Write 1 to clear UART_SW_XON_INT."]
pub type SW_XON_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SW_XOFF_INT_CLR` writer - Write 1 to clear UART_SW_XOFF_INT."]
pub type SW_XOFF_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `GLITCH_DET_INT_CLR` writer - Write 1 to clear UART_GLITCH_DET_INT."]
pub type GLITCH_DET_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_BRK_DONE_INT_CLR` writer - Write 1 to clear UART_TX_BRK_DONE_INT."]
pub type TX_BRK_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_BRK_IDLE_DONE_INT_CLR` writer - Write 1 to clear UART_TX_BRK_IDLE_DONE_INT."]
pub type TX_BRK_IDLE_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_DONE_INT_CLR` writer - Write 1 to clear UART_TX_DONE_INT."]
pub type TX_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RS485_PARITY_ERR_INT_CLR` writer - Write 1 to clear UART_RS485_PARITY_ERR_INT."]
pub type RS485_PARITY_ERR_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RS485_FRM_ERR_INT_CLR` writer - Write 1 to clear UART_RS485_FRM_ERR_INT."]
pub type RS485_FRM_ERR_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RS485_CLASH_INT_CLR` writer - Write 1 to clear UART_RS485_CLASH_INT."]
pub type RS485_CLASH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `AT_CMD_CHAR_DET_INT_CLR` writer - Write 1 to clear UART_AT_CMD_CHAR_DET_INT."]
pub type AT_CMD_CHAR_DET_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `WAKEUP_INT_CLR` writer - Write 1 to clear UART_WAKEUP_INT."]
...
impl W {
    ...
    #[inline(always)]
    pub fn rxfifo_full_int_clr(&mut self) -> RXFIFO_FULL_INT_CLR_W<'_, INT_CLR_SPEC> {
        RXFIFO_FULL_INT_CLR_W::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 to clear UART_TXFIFO_EMPTY_INT."]
    #[inline(always)]
    pub fn txfifo_empty_int_clr(&mut self) -> TXFIFO_EMPTY_INT_CLR_W<'_, INT_CLR_SPEC> {
        TXFIFO_EMPTY_INT_CLR_W::new(self, 1)
    }
    #[doc = "Bit 2 - Write 1 to clear UART_PARITY_ERR_INT."]
    #[inline(always)]
    pub fn parity_err_int_clr(&mut self) -> PARITY_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
        PARITY_ERR_INT_CLR_W::new(self, 2)
    }
    #[doc = "Bit 3 - Write 1 to clear UART_FRM_ERR_INT."]
    #[inline(always)]
    pub fn frm_err_int_clr(&mut self) -> FRM_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn dsr_chg_int_clr(&mut self) -> DSR_CHG_INT_CLR_W<'_, INT_CLR_SPEC> {
        DSR_CHG_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to clear UART_CTS_CHG_INT."]
    #[inline(always)]
    pub fn cts_chg_int_clr(&mut self) -> CTS_CHG_INT_CLR_W<'_, INT_CLR_SPEC> {
        CTS_CHG_INT_CLR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to clear UART_BRK_DET_INT."]
    #[inline(always)]
    pub fn brk_det_int_clr(&mut self) -> BRK_DET_INT_CLR_W<'_, INT_CLR_SPEC> {
        BRK_DET_INT_CLR_W::new(self, 7)
    }
    #[doc = "Bit 8 - Write 1 to clear UART_RXFIFO_TOUT_INT."]
    #[inline(always)]
    pub fn rxfifo_tout_int_clr(&mut self) -> RXFIFO_TOUT_INT_CLR_W<'_, INT_CLR_SPEC> {
        RXFIFO_TOUT_INT_CLR_W::new(self, 8)
    }
    #[doc = "Bit 9 - Write 1 to clear UART_SW_XON_INT."]
    #[inline(always)]
    pub fn sw_xon_int_clr(&mut self) -> SW_XON_INT_CLR_W<'_, INT_CLR_SPEC> {
        SW_XON_INT_CLR_W::new(self, 9)
    }
    #[doc = "Bit 10 - Write 1 to clear UART_SW_XOFF_INT."]
    #[inline(always)]
    pub fn sw_xoff_int_clr(&mut self) -> SW_XOFF_INT_CLR_W<'_, INT_CLR_SPEC> {
        SW_XOFF_INT_CLR_W::new(self, 10)
    }
    #[doc = "Bit 11 - Write 1 to clear UART_GLITCH_DET_INT."]
    #[inline(always)]
    pub fn glitch_det_int_clr(&mut self) -> GLITCH_DET_INT_CLR_W<'_, INT_CLR_SPEC> {
        GLITCH_DET_INT_CLR_W::new(self, 11)
    }
    #[doc = "Bit 12 - Write 1 to clear UART_TX_BRK_DONE_INT."]
    #[inline(always)]
    pub fn tx_brk_done_int_clr(&mut self) -> TX_BRK_DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
        TX_BRK_DONE_INT_CLR_W::new(self, 12)
    }
    #[doc = "Bit 13 - Write 1 to clear UART_TX_BRK_IDLE_DONE_INT."]
    #[inline(always)]
    pub fn tx_brk_idle_done_int_clr(&mut self) -> TX_BRK_IDLE_DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rs485_parity_err_int_clr(&mut self) -> RS485_PARITY_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
        RS485_PARITY_ERR_INT_CLR_W::new(self, 15)
    }
    #[doc = "Bit 16 - Write 1 to clear UART_RS485_FRM_ERR_INT."]
    #[inline(always)]
    pub fn rs485_frm_err_int_clr(&mut self) -> RS485_FRM_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
        RS485_FRM_ERR_INT_CLR_W::new(self, 16)
    }
    #[doc = "Bit 17 - Write 1 to clear UART_RS485_CLASH_INT."]
    #[inline(always)]
    pub fn rs485_clash_int_clr(&mut self) -> RS485_CLASH_INT_CLR_W<'_, INT_CLR_SPEC> {
        RS485_CLASH_INT_CLR_W::new(self, 17)
    }
    #[doc = "Bit 18 - Write 1 to clear UART_AT_CMD_CHAR_DET_INT."]
    #[inline(always)]
    pub fn at_cmd_char_det_int_clr(&mut self) -> AT_CMD_CHAR_DET_INT_CLR_W<'_, INT_CLR_SPEC> {
        AT_CMD_CHAR_DET_INT_CLR_W::new(self, 18)
    }
    #[doc = "Bit 19 - Write 1 to clear UART_WAKEUP_INT."]
    #[inline(always)]
    pub fn wakeup_int_clr(&mut self) -> WAKEUP_INT_CLR_W<'_, INT_CLR_SPEC> {
