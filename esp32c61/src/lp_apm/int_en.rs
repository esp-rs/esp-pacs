...
#[doc = "Field `M_APM(0-0)` reader - Configures to enable APM M%s interrupt.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M_APM_R = crate::BitReader;
#[doc = "Field `M_APM(0-0)` writer - Configures to enable APM M%s interrupt.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M_APM_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Configures to enable APM M(0-0) interrupt.\\\\ 0: disable \\\\ 1: enable \\\\"]
    #[doc = ""]
    ...
    pub fn m_apm_iter(&self) -> impl Iterator<Item = M_APM_R> + '_ {
        (0..1).map(move |n| M_APM_R::new(((self.bits >> (n * 0)) & 1) != 0))
    }
