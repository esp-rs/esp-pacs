...
#[doc = "Field `SPI_BUF4` reader - 32-bit data buffer 0."]
pub type SPI_BUF4_R = crate::FieldReader<u32>;
#[doc = "Field `SPI_BUF4` writer - 32-bit data buffer 0."]
...
impl W {
    #[doc = "Bits 0:31 - 32-bit data buffer 0."]
    #[inline(always)]
    pub fn spi_buf4(&mut self) -> SPI_BUF4_W<'_, SPI_W4_SPEC> {
        SPI_BUF4_W::new(self, 0)
    }
}
#[doc = "SPI CPU-controlled buffer4\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_w4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_w4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
