...
#[doc = "Field `SPI_USR_COMMAND_VALUE` reader - Configures the command value. Can be configured in CONF state."]
pub type SPI_USR_COMMAND_VALUE_R = crate::FieldReader<u16>;
#[doc = "Field `SPI_USR_COMMAND_VALUE` writer - Configures the command value. Can be configured in CONF state."]
pub type SPI_USR_COMMAND_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `SPI_MST_REMPTY_ERR_END_EN` reader - Configures whether or not to end the SPI transfer when SPI TX AFIFO read empty error occurs in master full-/half-duplex transfers. \\\\ 0: Not end \\\\ 1: End \\\\"]
pub type SPI_MST_REMPTY_ERR_END_EN_R = crate::BitReader;
#[doc = "Field `SPI_MST_REMPTY_ERR_END_EN` writer - Configures whether or not to end the SPI transfer when SPI TX AFIFO read empty error occurs in master full-/half-duplex transfers. \\\\ 0: Not end \\\\ 1: End \\\\"]
pub type SPI_MST_REMPTY_ERR_END_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPI_USR_COMMAND_BITLEN` reader - Configures the bit length of command state. This value is (expected bit number - 1). Can be configured in CONF state."]
pub type SPI_USR_COMMAND_BITLEN_R = crate::FieldReader;
#[doc = "Field `SPI_USR_COMMAND_BITLEN` writer - Configures the bit length of command state. This value is (expected bit number - 1). Can be configured in CONF state."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_USER2")
            .field("spi_usr_command_value", &self.spi_usr_command_value())
            .field(
                "spi_mst_rempty_err_end_en",
                &self.spi_mst_rempty_err_end_en(),
            )
            .field("spi_usr_command_bitlen", &self.spi_usr_command_bitlen())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:15 - Configures the command value. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_usr_command_value(&mut self) -> SPI_USR_COMMAND_VALUE_W<'_, SPI_USER2_SPEC> {
        SPI_USR_COMMAND_VALUE_W::new(self, 0)
    }
    #[doc = "Bit 27 - Configures whether or not to end the SPI transfer when SPI TX AFIFO read empty error occurs in master full-/half-duplex transfers. \\\\ 0: Not end \\\\ 1: End \\\\"]
    #[inline(always)]
    pub fn spi_mst_rempty_err_end_en(&mut self) -> SPI_MST_REMPTY_ERR_END_EN_W<'_, SPI_USER2_SPEC> {
        SPI_MST_REMPTY_ERR_END_EN_W::new(self, 27)
    }
    #[doc = "Bits 28:31 - Configures the bit length of command state. This value is (expected bit number - 1). Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_usr_command_bitlen(&mut self) -> SPI_USR_COMMAND_BITLEN_W<'_, SPI_USER2_SPEC> {
        SPI_USR_COMMAND_BITLEN_W::new(self, 28)
    }
}
#[doc = "SPI USER control register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_user2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_user2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
