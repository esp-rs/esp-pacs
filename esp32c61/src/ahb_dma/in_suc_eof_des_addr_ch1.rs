...
#[doc = "Field `IN_SUC_EOF_DES_ADDR_CH1` reader - Represents the address of the receive descriptor when the EOF bit in this descriptor is 1."]
pub type IN_SUC_EOF_DES_ADDR_CH1_R = crate::FieldReader<u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_SUC_EOF_DES_ADDR_CH1")
            .field("in_suc_eof_des_addr_ch1", &self.in_suc_eof_des_addr_ch1())
            .finish()
    }
}
#[doc = "Receive descriptor address when EOF occurs on RX channel 1\n\nYou can [`read`](crate::Reg::read) this register and get [`in_suc_eof_des_addr_ch1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
