...
#[doc = "Field `OUT_EOF_BFR_DES_ADDR_CH1` reader - Represents the address of the transmit descriptor before the last transmit descriptor."]
pub type OUT_EOF_BFR_DES_ADDR_CH1_R = crate::FieldReader<u32>;
impl R {
    ...
    pub fn out_eof_bfr_des_addr_ch1(&self) -> OUT_EOF_BFR_DES_ADDR_CH1_R {
        OUT_EOF_BFR_DES_ADDR_CH1_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_EOF_BFR_DES_ADDR_CH1")
            .field("out_eof_bfr_des_addr_ch1", &self.out_eof_bfr_des_addr_ch1())
            .finish()
    }
}
#[doc = "The last transmit descriptor address when EOF occurs on TX channel 1\n\nYou can [`read`](crate::Reg::read) this register and get [`out_eof_bfr_des_addr_ch1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
