...
pub type INLINK_DSCR_BF1_CH0_R = crate::FieldReader<u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_DSCR_BF1_CH0")
            .field("inlink_dscr_bf1_ch0", &self.inlink_dscr_bf1_ch0())
            .finish()
    }
}
#[doc = "The second-to-last receive descriptor address of RX channel 0\n\nYou can [`read`](crate::Reg::read) this register and get [`in_dscr_bf1_ch0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
