...
impl W {
    ...
    #[inline(always)]
    pub fn outlink_stop_ch0(&mut self) -> OUTLINK_STOP_CH0_W<OUT_LINK_CH0_SPEC> {
    ...
    #[inline(always)]
    pub fn outlink_start_ch0(&mut self) -> OUTLINK_START_CH0_W<OUT_LINK_CH0_SPEC> {
    ...
    #[inline(always)]
    pub fn outlink_restart_ch0(&mut self) -> OUTLINK_RESTART_CH0_W<OUT_LINK_CH0_SPEC> {
        OUTLINK_RESTART_CH0_W::new(self, 2)
    }
}
#[doc = "Push control register of TX channel 0\n\nYou can [`read`](crate::Reg::read) this register and get [`out_link_ch0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`out_link_ch0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets OUT_LINK_CH0 to value 0x08"]
