...
impl W {
    ...
    #[doc = "Bit 5 - Write 1 to enable AHB_DMA_INFIFO_OVF_CH0_INT"]
    #[inline(always)]
    pub fn infifo_ovf_ch0_int_ena(&mut self) -> INFIFO_OVF_CH0_INT_ENA_W<IN_INT_ENA_CH0_SPEC> {
        INFIFO_OVF_CH0_INT_ENA_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to enable AHB_DMA_INFIFO_UDF_CH0_INT"]
    #[inline(always)]
    pub fn infifo_udf_ch0_int_ena(&mut self) -> INFIFO_UDF_CH0_INT_ENA_W<IN_INT_ENA_CH0_SPEC> {
        INFIFO_UDF_CH0_INT_ENA_W::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH0_INT"]
    #[inline(always)]
    pub fn in_ahbinf_resp_err_ch0_int_ena(
        &mut self,
    ) -> IN_AHBINF_RESP_ERR_CH0_INT_ENA_W<IN_INT_ENA_CH0_SPEC> {
        IN_AHBINF_RESP_ERR_CH0_INT_ENA_W::new(self, 7)
    }
}
#[doc = "Interrupt enable bits of RX channel 0\n\nYou can [`read`](crate::Reg::read) this register and get [`in_int_ena_ch0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`in_int_ena_ch0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
