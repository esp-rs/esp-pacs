...
pub type R = crate::R<OUT_DSCR_CH1_SPEC>;
#[doc = "Field `OUTLINK_DSCR_CH1` reader - Represents the address of the next transmit descriptor y+1 pointed by the current transmit descriptor that has already been fetched."]
pub type OUTLINK_DSCR_CH1_R = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn outlink_dscr_ch1(&self) -> OUTLINK_DSCR_CH1_R {
        OUTLINK_DSCR_CH1_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DSCR_CH1")
            .field("outlink_dscr_ch1", &self.outlink_dscr_ch1())
            .finish()
    }
}
#[doc = "Current transmit descriptor address of TX channel 1\n\nYou can [`read`](crate::Reg::read) this register and get [`out_dscr_ch1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
