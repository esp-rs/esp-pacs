...
pub type INFIFO_OVF_CH0_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_UDF_CH0_INT_CLR` writer - Write 1 to clear AHB_DMA_INFIFO_UDF_CH0_INT"]
pub type INFIFO_UDF_CH0_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_AHBINF_RESP_ERR_CH0_INT_CLR` writer - Write 1 to clear AHB_DMA_IN_RESP_ERR_CH0_INT"]
pub type IN_AHBINF_RESP_ERR_CH0_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn infifo_ovf_ch0_int_clr(&mut self) -> INFIFO_OVF_CH0_INT_CLR_W<IN_INT_CLR_CH0_SPEC> {
        INFIFO_OVF_CH0_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to clear AHB_DMA_INFIFO_UDF_CH0_INT"]
    #[inline(always)]
    pub fn infifo_udf_ch0_int_clr(&mut self) -> INFIFO_UDF_CH0_INT_CLR_W<IN_INT_CLR_CH0_SPEC> {
        INFIFO_UDF_CH0_INT_CLR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to clear AHB_DMA_IN_RESP_ERR_CH0_INT"]
    #[inline(always)]
    pub fn in_ahbinf_resp_err_ch0_int_clr(
        &mut self,
    ) -> IN_AHBINF_RESP_ERR_CH0_INT_CLR_W<IN_INT_CLR_CH0_SPEC> {
        IN_AHBINF_RESP_ERR_CH0_INT_CLR_W::new(self, 7)
    }
}
#[doc = "Interrupt clear bits of RX channel 0\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`in_int_clr_ch0::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
