...
#[doc = "Field `INLINK_DSCR_BF1_CH1` reader - Represents the address of the previous receive descriptor x-1 that has already been fetched."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_DSCR_BF1_CH1")
            .field("inlink_dscr_bf1_ch1", &self.inlink_dscr_bf1_ch1())
            .finish()
    }
}
#[doc = "The second-to-last receive descriptor address of RX channel 1\n\nYou can [`read`](crate::Reg::read) this register and get [`in_dscr_bf1_ch1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
