...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DSCR_BF0_CH0")
            .field("outlink_dscr_bf0_ch0", &self.outlink_dscr_bf0_ch0())
            .finish()
    }
}
#[doc = "The last transmit descriptor address of TX channel 0\n\nYou can [`read`](crate::Reg::read) this register and get [`out_dscr_bf0_ch0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
