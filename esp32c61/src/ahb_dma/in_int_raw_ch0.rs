...
impl W {
    ...
    #[doc = "Bit 5 - The raw interrupt status of AHB_DMA_INFIFO_OVF_CH0_INT"]
    #[inline(always)]
    pub fn infifo_ovf_ch0_int_raw(&mut self) -> INFIFO_OVF_CH0_INT_RAW_W<IN_INT_RAW_CH0_SPEC> {
        INFIFO_OVF_CH0_INT_RAW_W::new(self, 5)
    }
    #[doc = "Bit 6 - The raw interrupt status of AHB_DMA_INFIFO_UDF_CH0_INT"]
    #[inline(always)]
    pub fn infifo_udf_ch0_int_raw(&mut self) -> INFIFO_UDF_CH0_INT_RAW_W<IN_INT_RAW_CH0_SPEC> {
    ...
    pub fn in_ahbinf_resp_err_ch0_int_raw(
        &mut self,
    ) -> IN_AHBINF_RESP_ERR_CH0_INT_RAW_W<IN_INT_RAW_CH0_SPEC> {
