...
#[doc = "Field `OUTLINK_DSCR_BF1_CH1` reader - Represents the address of the previous transmit descriptor y-1 that has already been fetched."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DSCR_BF1_CH1")
            .field("outlink_dscr_bf1_ch1", &self.outlink_dscr_bf1_ch1())
            .finish()
    }
}
#[doc = "The second-to-last transmit descriptor address of TX channel 1\n\nYou can [`read`](crate::Reg::read) this register and get [`out_dscr_bf1_ch1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
