...
#[doc = "Field `CORE_0_AREA_DRAM0_1_MAX` reader - Configures the upper bound address of Data bus region 1."]
pub type CORE_0_AREA_DRAM0_1_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_0_AREA_DRAM0_1_MAX` writer - Configures the upper bound address of Data bus region 1."]
