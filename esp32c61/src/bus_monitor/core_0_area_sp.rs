...
#[doc = "Field `CORE_0_AREA_SP` reader - Represents the SP value when an interrupt is triggered during region monitoring."]
pub type CORE_0_AREA_SP_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the SP value when an interrupt is triggered during region monitoring."]
    #[inline(always)]
