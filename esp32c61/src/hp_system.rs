...
impl RegisterBlock {
    ...
    #[doc = "0x30 - ROM-Table lock register"]
    #[inline(always)]
    pub const fn rom_table_lock(&self) -> &ROM_TABLE_LOCK {
        &self.rom_table_lock
    }
    #[doc = "0x34 - ROM-Table register"]
    #[inline(always)]
    pub const fn rom_table(&self) -> &ROM_TABLE {
        &self.rom_table
    }
    #[doc = "0x38 - Core Debug RunStall configurion register"]
    #[inline(always)]
    ...
    #[doc = "0x4c - redcy eco register."]
    #[inline(always)]
    pub const fn rnd_eco(&self) -> &RND_ECO {
        &self.rnd_eco
    }
    #[doc = "0x50 - redcy eco low register."]
    #[inline(always)]
    pub const fn rnd_eco_low(&self) -> &RND_ECO_LOW {
        &self.rnd_eco_low
    }
    #[doc = "0x54 - redcy eco high register."]
    #[inline(always)]
    pub const fn rnd_eco_high(&self) -> &RND_ECO_HIGH {
        &self.rnd_eco_high
    }
    #[doc = "0x58 - HP-SYSTEM debug register"]
    #[inline(always)]
    pub const fn debug(&self) -> &DEBUG {
        &self.debug
    }
    #[doc = "0x5c - HP-SYSTEM clock gating configure register"]
    #[inline(always)]
    pub const fn clock_gate(&self) -> &CLOCK_GATE {
        &self.clock_gate
    }
    #[doc = "0x60 - AXI mst priority configuration register"]
    #[inline(always)]
    pub const fn axi_mst_pri(&self) -> &AXI_MST_PRI {
        &self.axi_mst_pri
    }
    #[doc = "0x64 - SDIO Control configuration register"]
    #[inline(always)]
...
pub mod rom_table;
#[doc = "CORE_DEBUG_RUNSTALL_CONF (r) register accessor: Core Debug RunStall configurion register\n\nYou can [`read`](crate::Reg::read) this register and get [`core_debug_runstall_conf::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@core_debug_runstall_conf`] module"]
