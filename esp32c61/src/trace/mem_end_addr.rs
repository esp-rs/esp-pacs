...
#[doc = "Field `MEM_END_ADDR` reader - Configures the end address of the trace memory."]
pub type MEM_END_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `MEM_END_ADDR` writer - Configures the end address of the trace memory."]
