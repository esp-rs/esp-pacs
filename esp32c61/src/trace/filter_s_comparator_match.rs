...
#[doc = "Field `S_MATCH` reader - Configures the match value for the secondary comparator"]
pub type S_MATCH_R = crate::FieldReader<u32>;
#[doc = "Field `S_MATCH` writer - Configures the match value for the secondary comparator"]
pub type S_MATCH_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the match value for the secondary comparator"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Configures the match value for the secondary comparator"]
    #[inline(always)]
    pub fn s_match(&mut self) -> S_MATCH_W<'_, FILTER_S_COMPARATOR_MATCH_SPEC> {
