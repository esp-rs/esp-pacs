...
#[doc = "Field `DATA_ORIG` reader - Configures the output value of LP_GPIO0 ~ 6 output in simple LP_GPIO output mode.\\\\ 0: Low level\\\\ 1: High level\\\\ The value of bit0 ~ bit6 correspond to the output value of LP_GPIO0 ~ LP_GPIO6 respectively. Bit7 ~ bit31 are invalid.\\\\"]
pub type DATA_ORIG_R = crate::FieldReader;
#[doc = "Field `DATA_ORIG` writer - Configures the output value of LP_GPIO0 ~ 6 output in simple LP_GPIO output mode.\\\\ 0: Low level\\\\ 1: High level\\\\ The value of bit0 ~ bit6 correspond to the output value of LP_GPIO0 ~ LP_GPIO6 respectively. Bit7 ~ bit31 are invalid.\\\\"]
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    ...
    pub fn data_orig(&self) -> DATA_ORIG_R {
        DATA_ORIG_R::new((self.bits & 0x7f) as u8)
    }
}
