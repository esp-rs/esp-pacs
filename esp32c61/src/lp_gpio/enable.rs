...
#[doc = "Field `DATA` reader - Configures whether or not to enable the output of LP_GPIO0 ~ LP_GPIO6.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit0 ~ bit6 are corresponding to LP_GPIO0 ~ LP_GPIO6. Bit7 ~ bit31 are invalid.\\\\"]
pub type DATA_R = crate::FieldReader;
#[doc = "Field `DATA` writer - Configures whether or not to enable the output of LP_GPIO0 ~ LP_GPIO6.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit0 ~ bit6 are corresponding to LP_GPIO0 ~ LP_GPIO6. Bit7 ~ bit31 are invalid.\\\\"]
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
