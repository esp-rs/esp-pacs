...
#[doc = "Field `DUTY_CHNG_END_CH(0-5)` reader - This is the masked interrupt status bit for the DUTY_CHNG_END_CH%s interrupt when LEDC.INT_ENA.DUTY_CHNG_END_CHx is set to 1."]
pub type DUTY_CHNG_END_CH_R = crate::BitReader;
#[doc = "Field `OVF_CNT_CH(0-5)` reader - This is the masked interrupt status bit for the LEDC.INT_RAW.OVF_CNT_CH%s interrupt when LEDC.INT_ENA.OVF_CNT_CHx is set to 1."]
...
impl R {
    ...
    #[doc = "This is the masked interrupt status bit for the DUTY_CHNG_END_CH(0-5) interrupt when LEDC.INT_ENA.DUTY_CHNG_END_CHx is set to 1."]
    #[doc = ""]
    ...
    #[doc = "This is the masked interrupt status bit for the LEDC.INT_RAW.OVF_CNT_CH(0-5) interrupt when LEDC.INT_ENA.OVF_CNT_CHx is set to 1."]
    #[doc = ""]
    ...
    #[doc = "Bit 10 - This is the masked interrupt status bit for the LEDC.INT_RAW.OVF_CNT_CH0 interrupt when LEDC.INT_ENA.OVF_CNT_CHx is set to 1."]
    #[inline(always)]
    pub fn ovf_cnt_ch0(&self) -> OVF_CNT_CH_R {
        OVF_CNT_CH_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - This is the masked interrupt status bit for the LEDC.INT_RAW.OVF_CNT_CH1 interrupt when LEDC.INT_ENA.OVF_CNT_CHx is set to 1."]
    #[inline(always)]
    pub fn ovf_cnt_ch1(&self) -> OVF_CNT_CH_R {
        OVF_CNT_CH_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - This is the masked interrupt status bit for the LEDC.INT_RAW.OVF_CNT_CH2 interrupt when LEDC.INT_ENA.OVF_CNT_CHx is set to 1."]
    #[inline(always)]
    pub fn ovf_cnt_ch2(&self) -> OVF_CNT_CH_R {
        OVF_CNT_CH_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - This is the masked interrupt status bit for the LEDC.INT_RAW.OVF_CNT_CH3 interrupt when LEDC.INT_ENA.OVF_CNT_CHx is set to 1."]
    #[inline(always)]
    pub fn ovf_cnt_ch3(&self) -> OVF_CNT_CH_R {
        OVF_CNT_CH_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - This is the masked interrupt status bit for the LEDC.INT_RAW.OVF_CNT_CH4 interrupt when LEDC.INT_ENA.OVF_CNT_CHx is set to 1."]
    #[inline(always)]
    pub fn ovf_cnt_ch4(&self) -> OVF_CNT_CH_R {
        OVF_CNT_CH_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - This is the masked interrupt status bit for the LEDC.INT_RAW.OVF_CNT_CH5 interrupt when LEDC.INT_ENA.OVF_CNT_CHx is set to 1."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            .field("timer0_ovf", &self.timer0_ovf().bit())
            .field("timer1_ovf", &self.timer1_ovf().bit())
            .field("timer2_ovf", &self.timer2_ovf().bit())
            .field("timer3_ovf", &self.timer3_ovf().bit())
            .field("duty_chng_end_ch0", &self.duty_chng_end_ch0().bit())
            .field("duty_chng_end_ch1", &self.duty_chng_end_ch1().bit())
            .field("duty_chng_end_ch2", &self.duty_chng_end_ch2().bit())
            .field("duty_chng_end_ch3", &self.duty_chng_end_ch3().bit())
            .field("duty_chng_end_ch4", &self.duty_chng_end_ch4().bit())
            .field("duty_chng_end_ch5", &self.duty_chng_end_ch5().bit())
            .field("ovf_cnt_ch0", &self.ovf_cnt_ch0().bit())
            .field("ovf_cnt_ch1", &self.ovf_cnt_ch1().bit())
            .field("ovf_cnt_ch2", &self.ovf_cnt_ch2().bit())
            .field("ovf_cnt_ch3", &self.ovf_cnt_ch3().bit())
            .field("ovf_cnt_ch4", &self.ovf_cnt_ch4().bit())
            .field("ovf_cnt_ch5", &self.ovf_cnt_ch5().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
