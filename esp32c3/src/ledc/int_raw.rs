...
pub type LSTIMER0_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LSTIMER1_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LSTIMER2_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LSTIMER3_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DUTY_CHNG_END_LSCH0_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DUTY_CHNG_END_LSCH1_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DUTY_CHNG_END_LSCH2_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DUTY_CHNG_END_LSCH3_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DUTY_CHNG_END_LSCH4_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DUTY_CHNG_END_LSCH5_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OVF_CNT_LSCH0_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OVF_CNT_LSCH1_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OVF_CNT_LSCH2_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OVF_CNT_LSCH3_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OVF_CNT_LSCH4_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OVF_CNT_LSCH5_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lstimer0_ovf_int_raw(&mut self) -> LSTIMER0_OVF_INT_RAW_W<INT_RAW_SPEC> {
        LSTIMER0_OVF_INT_RAW_W::new(self, 0)
    }
    #[doc = "Bit 1 - reg_lstimer1_ovf_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer1_ovf_int_raw(&mut self) -> LSTIMER1_OVF_INT_RAW_W<INT_RAW_SPEC> {
        LSTIMER1_OVF_INT_RAW_W::new(self, 1)
    }
    #[doc = "Bit 2 - reg_lstimer2_ovf_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer2_ovf_int_raw(&mut self) -> LSTIMER2_OVF_INT_RAW_W<INT_RAW_SPEC> {
        LSTIMER2_OVF_INT_RAW_W::new(self, 2)
    }
    #[doc = "Bit 3 - reg_lstimer3_ovf_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer3_ovf_int_raw(&mut self) -> LSTIMER3_OVF_INT_RAW_W<INT_RAW_SPEC> {
        LSTIMER3_OVF_INT_RAW_W::new(self, 3)
    }
    #[doc = "Bit 4 - reg_duty_chng_end_lsch0_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch0_int_raw(&mut self) -> DUTY_CHNG_END_LSCH0_INT_RAW_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH0_INT_RAW_W::new(self, 4)
    }
    #[doc = "Bit 5 - reg_duty_chng_end_lsch1_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch1_int_raw(&mut self) -> DUTY_CHNG_END_LSCH1_INT_RAW_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH1_INT_RAW_W::new(self, 5)
    }
    #[doc = "Bit 6 - reg_duty_chng_end_lsch2_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch2_int_raw(&mut self) -> DUTY_CHNG_END_LSCH2_INT_RAW_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH2_INT_RAW_W::new(self, 6)
    }
    #[doc = "Bit 7 - reg_duty_chng_end_lsch3_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch3_int_raw(&mut self) -> DUTY_CHNG_END_LSCH3_INT_RAW_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH3_INT_RAW_W::new(self, 7)
    }
    #[doc = "Bit 8 - reg_duty_chng_end_lsch4_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch4_int_raw(&mut self) -> DUTY_CHNG_END_LSCH4_INT_RAW_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH4_INT_RAW_W::new(self, 8)
    }
    #[doc = "Bit 9 - reg_duty_chng_end_lsch5_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch5_int_raw(&mut self) -> DUTY_CHNG_END_LSCH5_INT_RAW_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH5_INT_RAW_W::new(self, 9)
    }
    #[doc = "Bit 10 - reg_ovf_cnt_lsch0_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch0_int_raw(&mut self) -> OVF_CNT_LSCH0_INT_RAW_W<INT_RAW_SPEC> {
        OVF_CNT_LSCH0_INT_RAW_W::new(self, 10)
    }
    #[doc = "Bit 11 - reg_ovf_cnt_lsch1_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch1_int_raw(&mut self) -> OVF_CNT_LSCH1_INT_RAW_W<INT_RAW_SPEC> {
        OVF_CNT_LSCH1_INT_RAW_W::new(self, 11)
    }
    #[doc = "Bit 12 - reg_ovf_cnt_lsch2_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch2_int_raw(&mut self) -> OVF_CNT_LSCH2_INT_RAW_W<INT_RAW_SPEC> {
        OVF_CNT_LSCH2_INT_RAW_W::new(self, 12)
    }
    #[doc = "Bit 13 - reg_ovf_cnt_lsch3_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch3_int_raw(&mut self) -> OVF_CNT_LSCH3_INT_RAW_W<INT_RAW_SPEC> {
        OVF_CNT_LSCH3_INT_RAW_W::new(self, 13)
    }
    #[doc = "Bit 14 - reg_ovf_cnt_lsch4_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch4_int_raw(&mut self) -> OVF_CNT_LSCH4_INT_RAW_W<INT_RAW_SPEC> {
        OVF_CNT_LSCH4_INT_RAW_W::new(self, 14)
    }
    #[doc = "Bit 15 - reg_ovf_cnt_lsch5_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch5_int_raw(&mut self) -> OVF_CNT_LSCH5_INT_RAW_W<INT_RAW_SPEC> {
        OVF_CNT_LSCH5_INT_RAW_W::new(self, 15)
    }
}
