...
pub type LSTIMER0_OVF_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LSTIMER1_OVF_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LSTIMER2_OVF_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LSTIMER3_OVF_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_LSCH0_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_LSCH1_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_LSCH2_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_LSCH3_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_LSCH4_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_LSCH5_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OVF_CNT_LSCH0_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OVF_CNT_LSCH1_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OVF_CNT_LSCH2_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OVF_CNT_LSCH3_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OVF_CNT_LSCH4_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OVF_CNT_LSCH5_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lstimer0_ovf_int_raw(&mut self) -> LSTIMER0_OVF_INT_RAW_W<INT_RAW_SPEC, 0> {
        LSTIMER0_OVF_INT_RAW_W::new(self)
    }
    #[doc = "Bit 1 - reg_lstimer1_ovf_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer1_ovf_int_raw(&mut self) -> LSTIMER1_OVF_INT_RAW_W<INT_RAW_SPEC, 1> {
        LSTIMER1_OVF_INT_RAW_W::new(self)
    }
    #[doc = "Bit 2 - reg_lstimer2_ovf_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer2_ovf_int_raw(&mut self) -> LSTIMER2_OVF_INT_RAW_W<INT_RAW_SPEC, 2> {
        LSTIMER2_OVF_INT_RAW_W::new(self)
    }
    #[doc = "Bit 3 - reg_lstimer3_ovf_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer3_ovf_int_raw(&mut self) -> LSTIMER3_OVF_INT_RAW_W<INT_RAW_SPEC, 3> {
    ...
    pub fn duty_chng_end_lsch0_int_raw(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH0_INT_RAW_W<INT_RAW_SPEC, 4> {
    ...
    pub fn duty_chng_end_lsch1_int_raw(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH1_INT_RAW_W<INT_RAW_SPEC, 5> {
    ...
    pub fn duty_chng_end_lsch2_int_raw(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH2_INT_RAW_W<INT_RAW_SPEC, 6> {
    ...
    pub fn duty_chng_end_lsch3_int_raw(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH3_INT_RAW_W<INT_RAW_SPEC, 7> {
    ...
    pub fn duty_chng_end_lsch4_int_raw(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH4_INT_RAW_W<INT_RAW_SPEC, 8> {
    ...
    pub fn duty_chng_end_lsch5_int_raw(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH5_INT_RAW_W<INT_RAW_SPEC, 9> {
        DUTY_CHNG_END_LSCH5_INT_RAW_W::new(self)
    }
    #[doc = "Bit 10 - reg_ovf_cnt_lsch0_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch0_int_raw(&mut self) -> OVF_CNT_LSCH0_INT_RAW_W<INT_RAW_SPEC, 10> {
        OVF_CNT_LSCH0_INT_RAW_W::new(self)
    }
    #[doc = "Bit 11 - reg_ovf_cnt_lsch1_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch1_int_raw(&mut self) -> OVF_CNT_LSCH1_INT_RAW_W<INT_RAW_SPEC, 11> {
        OVF_CNT_LSCH1_INT_RAW_W::new(self)
    }
    #[doc = "Bit 12 - reg_ovf_cnt_lsch2_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch2_int_raw(&mut self) -> OVF_CNT_LSCH2_INT_RAW_W<INT_RAW_SPEC, 12> {
        OVF_CNT_LSCH2_INT_RAW_W::new(self)
    }
    #[doc = "Bit 13 - reg_ovf_cnt_lsch3_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch3_int_raw(&mut self) -> OVF_CNT_LSCH3_INT_RAW_W<INT_RAW_SPEC, 13> {
        OVF_CNT_LSCH3_INT_RAW_W::new(self)
    }
    #[doc = "Bit 14 - reg_ovf_cnt_lsch4_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch4_int_raw(&mut self) -> OVF_CNT_LSCH4_INT_RAW_W<INT_RAW_SPEC, 14> {
        OVF_CNT_LSCH4_INT_RAW_W::new(self)
    }
    #[doc = "Bit 15 - reg_ovf_cnt_lsch5_int_raw."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_lsch5_int_raw(&mut self) -> OVF_CNT_LSCH5_INT_RAW_W<INT_RAW_SPEC, 15> {
