...
///Field `TIMER_SEL` reader - reg_timer_sel_lsch0.
pub type TIMER_SEL_R = crate::FieldReader;
///Field `TIMER_SEL` writer - reg_timer_sel_lsch0.
pub type TIMER_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SIG_OUT_EN` reader - reg_sig_out_en_lsch0.
pub type SIG_OUT_EN_R = crate::BitReader;
///Field `SIG_OUT_EN` writer - reg_sig_out_en_lsch0.
pub type SIG_OUT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IDLE_LV` reader - reg_idle_lv_lsch0.
pub type IDLE_LV_R = crate::BitReader;
///Field `IDLE_LV` writer - reg_idle_lv_lsch0.
pub type IDLE_LV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PARA_UP` writer - reg_para_up_lsch0.
pub type PARA_UP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OVF_NUM` reader - reg_ovf_num_lsch0.
pub type OVF_NUM_R = crate::FieldReader<u16>;
///Field `OVF_NUM` writer - reg_ovf_num_lsch0.
pub type OVF_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `OVF_CNT_EN` reader - reg_ovf_cnt_en_lsch0.
pub type OVF_CNT_EN_R = crate::BitReader;
///Field `OVF_CNT_EN` writer - reg_ovf_cnt_en_lsch0.
pub type OVF_CNT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OVF_CNT_RESET` writer - reg_ovf_cnt_reset_lsch0.
