...
pub type RETENTION_LINK_ADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 27, O, u32>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn retention_link_addr(&mut self) -> RETENTION_LINK_ADDR_W<RETENTION_CTRL_SPEC, 0> {
