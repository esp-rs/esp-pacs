...
///Field `DONE` reader - reg_peri_backup_done_int_raw
pub type DONE_R = crate::BitReader;
///Field `ERR` reader - reg_peri_backup_err_int_raw
...
///`read()` method returns [`peri_backup_int_raw::R`](R) reader structure
impl crate::Readable for PERI_BACKUP_INT_RAW_SPEC {}
///`reset()` method sets PERI_BACKUP_INT_RAW to value 0
