///Register `PERI_BACKUP_INT_CLR` writer
pub type W = crate::W<PERI_BACKUP_INT_CLR_SPEC>;
///Field `DONE` writer - reg_peri_backup_done_int_clr
pub type DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `ERR` writer - reg_peri_backup_err_int_clr
...
///`write(|w| ..)` method takes [`peri_backup_int_clr::W`](W) writer structure
impl crate::Writable for PERI_BACKUP_INT_CLR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x03;
}
///`reset()` method sets PERI_BACKUP_INT_CLR to value 0
