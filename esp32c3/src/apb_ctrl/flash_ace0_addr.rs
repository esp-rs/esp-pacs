///Register `FLASH_ACE0_ADDR` reader
pub type R = crate::R<FLASH_ACE0_ADDR_SPEC>;
///Register `FLASH_ACE0_ADDR` writer
pub type W = crate::W<FLASH_ACE0_ADDR_SPEC>;
///Field `S` reader - reg_flash_ace0_addr_s
pub type S_R = crate::FieldReader<u32>;
///Field `S` writer - reg_flash_ace0_addr_s
pub type S_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - reg_flash_ace0_addr_s
    #[inline(always)]
    pub fn s(&self) -> S_R {
        S_R::new(self.bits)
    }
...
///`read()` method returns [`flash_ace0_addr::R`](R) reader structure
impl crate::Readable for FLASH_ACE0_ADDR_SPEC {}
///`write(|w| ..)` method takes [`flash_ace0_addr::W`](W) writer structure
