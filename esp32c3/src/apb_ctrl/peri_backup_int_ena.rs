///Register `PERI_BACKUP_INT_ENA` reader
pub type R = crate::R<PERI_BACKUP_INT_ENA_SPEC>;
///Register `PERI_BACKUP_INT_ENA` writer
pub type W = crate::W<PERI_BACKUP_INT_ENA_SPEC>;
///Field `DONE` reader - reg_peri_backup_done_int_ena
pub type DONE_R = crate::BitReader;
///Field `DONE` writer - reg_peri_backup_done_int_ena
pub type DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ERR` reader - reg_peri_backup_err_int_ena
pub type ERR_R = crate::BitReader;
///Field `ERR` writer - reg_peri_backup_err_int_ena
...
///`read()` method returns [`peri_backup_int_ena::R`](R) reader structure
impl crate::Readable for PERI_BACKUP_INT_ENA_SPEC {}
///`write(|w| ..)` method takes [`peri_backup_int_ena::W`](W) writer structure
impl crate::Writable for PERI_BACKUP_INT_ENA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PERI_BACKUP_INT_ENA to value 0
