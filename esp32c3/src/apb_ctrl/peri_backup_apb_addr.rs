///Register `PERI_BACKUP_APB_ADDR` reader
pub type R = crate::R<PERI_BACKUP_APB_ADDR_SPEC>;
///Register `PERI_BACKUP_APB_ADDR` writer
pub type W = crate::W<PERI_BACKUP_APB_ADDR_SPEC>;
///Field `BACKUP_APB_START_ADDR` reader - reg_backup_apb_start_addr
pub type BACKUP_APB_START_ADDR_R = crate::FieldReader<u32>;
///Field `BACKUP_APB_START_ADDR` writer - reg_backup_apb_start_addr
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PERI_BACKUP_APB_ADDR")
            .field("backup_apb_start_addr", &self.backup_apb_start_addr())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`peri_backup_apb_addr::R`](R) reader structure
impl crate::Readable for PERI_BACKUP_APB_ADDR_SPEC {}
///`write(|w| ..)` method takes [`peri_backup_apb_addr::W`](W) writer structure
impl crate::Writable for PERI_BACKUP_APB_ADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PERI_BACKUP_APB_ADDR to value 0
