...
///Field `ROM_CLKGATE_FORCE_ON` reader - reg_rom_clkgate_force_on
pub type ROM_CLKGATE_FORCE_ON_R = crate::FieldReader;
///Field `ROM_CLKGATE_FORCE_ON` writer - reg_rom_clkgate_force_on
pub type ROM_CLKGATE_FORCE_ON_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SRAM_CLKGATE_FORCE_ON` reader - reg_sram_clkgate_force_on
pub type SRAM_CLKGATE_FORCE_ON_R = crate::FieldReader;
///Field `SRAM_CLKGATE_FORCE_ON` writer - reg_sram_clkgate_force_on
...
///`reset()` method sets CLKGATE_FORCE_ON to value 0x3f
