...
///Field `FORCE_OFF` reader - DIG_ISO force off
pub type FORCE_OFF_R = crate::BitReader;
///Field `FORCE_OFF` writer - DIG_ISO force off
pub type FORCE_OFF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FORCE_ON` reader - DIG_ISO force on
pub type FORCE_ON_R = crate::BitReader;
///Field `FORCE_ON` writer - DIG_ISO force on
...
///Field `BT_FORCE_ISO` reader - bt force ISO
...
///Field `BT_FORCE_NOISO` reader - bt force no ISO
...
///Field `DG_PERI_FORCE_ISO` reader - Digital peri force ISO
pub type DG_PERI_FORCE_ISO_R = crate::BitReader;
///Field `DG_PERI_FORCE_ISO` writer - Digital peri force ISO
pub type DG_PERI_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_PERI_FORCE_NOISO` reader - digital peri force no ISO
...
///Field `CPU_TOP_FORCE_ISO` reader - cpu force ISO
pub type CPU_TOP_FORCE_ISO_R = crate::BitReader;
///Field `CPU_TOP_FORCE_ISO` writer - cpu force ISO
pub type CPU_TOP_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CPU_TOP_FORCE_NOISO` reader - cpu force no ISO
