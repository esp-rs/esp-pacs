...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DIG_ISO")
            ...
            .field("bt_force_iso", &self.bt_force_iso().bit())
            .field("bt_force_noiso", &self.bt_force_noiso().bit())
            .field("dg_peri_force_iso", &self.dg_peri_force_iso().bit())
            .field("dg_peri_force_noiso", &self.dg_peri_force_noiso().bit())
            .field("cpu_top_force_iso", &self.cpu_top_force_iso().bit())
            .field("cpu_top_force_noiso", &self.cpu_top_force_noiso().bit())
