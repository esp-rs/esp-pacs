...
///Field `WDT_STG3` reader - 1: interrupt stage en
pub type WDT_STG3_R = crate::FieldReader;
///Field `WDT_STG3` writer - 1: interrupt stage en
pub type WDT_STG3_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG2` reader - 1: interrupt stage en
pub type WDT_STG2_R = crate::FieldReader;
///Field `WDT_STG2` writer - 1: interrupt stage en
pub type WDT_STG2_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG1` reader - 1: interrupt stage en
pub type WDT_STG1_R = crate::FieldReader;
///Field `WDT_STG1` writer - 1: interrupt stage en
pub type WDT_STG1_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG0` reader - 1: interrupt stage en
pub type WDT_STG0_R = crate::FieldReader;
///Field `WDT_STG0` writer - 1: interrupt stage en
