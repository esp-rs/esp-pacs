...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ANA_CONF")
            .field("reset_por_force_pd", &self.reset_por_force_pd().bit())
            .field("reset_por_force_pu", &self.reset_por_force_pu().bit())
            .field("glitch_rst_en", &self.glitch_rst_en().bit())
            ...
            .field("pvtmon_pu", &self.pvtmon_pu().bit())
