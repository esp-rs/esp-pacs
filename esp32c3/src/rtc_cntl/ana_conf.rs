...
///Field `RESET_POR_FORCE_PD` reader - force no bypass i2c power on reset
...
///Field `RESET_POR_FORCE_PU` reader - force bypass i2c power on reset
pub type RESET_POR_FORCE_PU_R = crate::BitReader;
///Field `RESET_POR_FORCE_PU` writer - force bypass i2c power on reset
pub type RESET_POR_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GLITCH_RST_EN` reader - enable glitch reset
pub type GLITCH_RST_EN_R = crate::BitReader;
///Field `GLITCH_RST_EN` writer - enable glitch reset
...
///Field `PVTMON_PU` reader - 1: PVTMON power up
...
///Field `PLL_I2C_PU` reader - power up pll i2c
pub type PLL_I2C_PU_R = crate::BitReader;
///Field `PLL_I2C_PU` writer - power up pll i2c
...
///`reset()` method sets ANA_CONF to value 0x00c4_0000
