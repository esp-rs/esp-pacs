...
///Field `DG_VDD_DRV_B_SLP` reader -
pub type DG_VDD_DRV_B_SLP_R = crate::FieldReader;
///Field `DG_VDD_DRV_B_SLP` writer -
pub type DG_VDD_DRV_B_SLP_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DG_VDD_DRV_B_SLP_EN` reader -
pub type DG_VDD_DRV_B_SLP_EN_R = crate::BitReader;
///Field `DG_VDD_DRV_B_SLP_EN` writer -
pub type DG_VDD_DRV_B_SLP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_BUF_IDLE` reader - bias buf when rtc in normal work state
pub type BIAS_BUF_IDLE_R = crate::BitReader;
///Field `BIAS_BUF_IDLE` writer - bias buf when rtc in normal work state
pub type BIAS_BUF_IDLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_BUF_WAKE` reader - bias buf when rtc in wakeup state
pub type BIAS_BUF_WAKE_R = crate::BitReader;
///Field `BIAS_BUF_WAKE` writer - bias buf when rtc in wakeup state
pub type BIAS_BUF_WAKE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_BUF_DEEP_SLP` reader - bias buf when rtc in sleep state
pub type BIAS_BUF_DEEP_SLP_R = crate::BitReader;
///Field `BIAS_BUF_DEEP_SLP` writer - bias buf when rtc in sleep state
pub type BIAS_BUF_DEEP_SLP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_BUF_MONITOR` reader - bias buf when rtc in monitor state
pub type BIAS_BUF_MONITOR_R = crate::BitReader;
///Field `BIAS_BUF_MONITOR` writer - bias buf when rtc in monitor state
