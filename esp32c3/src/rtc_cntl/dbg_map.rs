...
pub type RTC_GPIO_PIN5_MUX_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DBG_MAP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN4_MUX_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DBG_MAP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN3_MUX_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DBG_MAP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN2_MUX_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DBG_MAP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN1_MUX_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DBG_MAP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN0_MUX_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DBG_MAP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN5_FUN_SEL_W<'a, const O: u8> =
...
pub type RTC_GPIO_PIN4_FUN_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DBG_MAP_SPEC, u8, u8, 4, O>;
...
pub type RTC_GPIO_PIN3_FUN_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DBG_MAP_SPEC, u8, u8, 4, O>;
...
pub type RTC_GPIO_PIN2_FUN_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DBG_MAP_SPEC, u8, u8, 4, O>;
...
pub type RTC_GPIO_PIN1_FUN_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DBG_MAP_SPEC, u8, u8, 4, O>;
...
pub type RTC_GPIO_PIN0_FUN_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DBG_MAP_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    #[doc = "Bit 2 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin5_mux_sel(&mut self) -> RTC_GPIO_PIN5_MUX_SEL_W<2> {
        RTC_GPIO_PIN5_MUX_SEL_W::new(self)
    }
    #[doc = "Bit 3 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin4_mux_sel(&mut self) -> RTC_GPIO_PIN4_MUX_SEL_W<3> {
        RTC_GPIO_PIN4_MUX_SEL_W::new(self)
    }
    #[doc = "Bit 4 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin3_mux_sel(&mut self) -> RTC_GPIO_PIN3_MUX_SEL_W<4> {
        RTC_GPIO_PIN3_MUX_SEL_W::new(self)
    }
    #[doc = "Bit 5 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin2_mux_sel(&mut self) -> RTC_GPIO_PIN2_MUX_SEL_W<5> {
        RTC_GPIO_PIN2_MUX_SEL_W::new(self)
    }
    #[doc = "Bit 6 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin1_mux_sel(&mut self) -> RTC_GPIO_PIN1_MUX_SEL_W<6> {
        RTC_GPIO_PIN1_MUX_SEL_W::new(self)
    }
    #[doc = "Bit 7 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin0_mux_sel(&mut self) -> RTC_GPIO_PIN0_MUX_SEL_W<7> {
        RTC_GPIO_PIN0_MUX_SEL_W::new(self)
    }
    #[doc = "Bits 8:11 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin5_fun_sel(&mut self) -> RTC_GPIO_PIN5_FUN_SEL_W<8> {
        RTC_GPIO_PIN5_FUN_SEL_W::new(self)
    }
    #[doc = "Bits 12:15 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin4_fun_sel(&mut self) -> RTC_GPIO_PIN4_FUN_SEL_W<12> {
        RTC_GPIO_PIN4_FUN_SEL_W::new(self)
    }
    #[doc = "Bits 16:19 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin3_fun_sel(&mut self) -> RTC_GPIO_PIN3_FUN_SEL_W<16> {
        RTC_GPIO_PIN3_FUN_SEL_W::new(self)
    }
    #[doc = "Bits 20:23 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin2_fun_sel(&mut self) -> RTC_GPIO_PIN2_FUN_SEL_W<20> {
        RTC_GPIO_PIN2_FUN_SEL_W::new(self)
    }
    #[doc = "Bits 24:27 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin1_fun_sel(&mut self) -> RTC_GPIO_PIN1_FUN_SEL_W<24> {
        RTC_GPIO_PIN1_FUN_SEL_W::new(self)
    }
    #[doc = "Bits 28:31 - use for debug"]
    #[inline(always)]
    pub fn rtc_gpio_pin0_fun_sel(&mut self) -> RTC_GPIO_PIN0_FUN_SEL_W<28> {
