...
///Field `BROWN_OUT_ANA_RST_EN` reader - brown_out origin reset enable
pub type BROWN_OUT_ANA_RST_EN_R = crate::BitReader;
///Field `BROWN_OUT_ANA_RST_EN` writer - brown_out origin reset enable
...
///Field `DET` reader - the flag of brown det from analog
...
impl R {
    ...
    ///Bit 28 - brown_out origin reset enable
    #[inline(always)]
    ...
    ///Bit 31 - the flag of brown det from analog
    #[inline(always)]
