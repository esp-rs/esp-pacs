...
///Field `ANA_CLK_DIV_VLD` reader - used to sync div bus. clear vld before set reg_rtc_ana_clk_div
pub type ANA_CLK_DIV_VLD_R = crate::BitReader;
///Field `ANA_CLK_DIV_VLD` writer - used to sync div bus. clear vld before set reg_rtc_ana_clk_div
pub type ANA_CLK_DIV_VLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ANA_CLK_DIV` reader - the clk divider num of RTC_CLK
pub type ANA_CLK_DIV_R = crate::FieldReader;
///Field `ANA_CLK_DIV` writer - the clk divider num of RTC_CLK
pub type ANA_CLK_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SLOW_CLK_NEXT_EDGE` reader - flag rtc_slow_clk_next_edge
pub type SLOW_CLK_NEXT_EDGE_R = crate::BitReader;
///Field `SLOW_CLK_NEXT_EDGE` writer - flag rtc_slow_clk_next_edge
