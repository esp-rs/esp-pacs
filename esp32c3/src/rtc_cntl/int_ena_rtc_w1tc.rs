...
///Field `SLP_WAKEUP` writer - clear sleep wakeup interrupt enable
pub type SLP_WAKEUP_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `SLP_REJECT` writer - clear sleep reject interrupt enable
pub type SLP_REJECT_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `WDT` writer - clear RTC WDT interrupt enable
pub type WDT_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `BROWN_OUT` writer - clear brown out interrupt enable
pub type BROWN_OUT_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `MAIN_TIMER` writer - Clear RTC main timer interrupt enable
pub type MAIN_TIMER_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `SWD` writer - clear super watch dog interrupt enable
pub type SWD_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `XTAL32K_DEAD` writer - clear xtal32k_dead interrupt enable
pub type XTAL32K_DEAD_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `GLITCH_DET` writer - clear gitch det interrupt enable
pub type GLITCH_DET_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `BBPLL_CAL` writer - clear bbpll cal interrupt enable
