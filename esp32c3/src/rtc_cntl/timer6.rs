...
///Field `DG_PERI_WAIT_TIMER` reader - digital peri power domain wakeup time
...
///Field `DG_PERI_POWERUP_TIMER` reader - digital peri power domain power on time
...
///`reset()` method sets TIMER6 to value 0x0a08_0000
