...
///`read()` method returns [`dbg_sar_sel::R`](R) reader structure
impl crate::Readable for DBG_SAR_SEL_SPEC {}
///`write(|w| ..)` method takes [`dbg_sar_sel::W`](W) writer structure
impl crate::Writable for DBG_SAR_SEL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DBG_SAR_SEL to value 0
