...
pub type DBOOST_FORCE_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, RTC_CNTL_SPEC, bool, O>;
...
pub type DBOOST_FORCE_PU_W<'a, const O: u8> = crate::BitWriter<'a, u32, RTC_CNTL_SPEC, bool, O>;
