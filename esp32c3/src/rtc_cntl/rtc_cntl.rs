///Register `RTC_CNTL` reader
pub type R = crate::R<RTC_CNTL_SPEC>;
///Register `RTC_CNTL` writer
pub type W = crate::W<RTC_CNTL_SPEC>;
///Field `DIG_REG_CAL_EN` reader - software enable digital regulator cali
pub type DIG_REG_CAL_EN_R = crate::BitReader;
///Field `DIG_REG_CAL_EN` writer - software enable digital regulator cali
...
///Field `REGULATOR_FORCE_PU` reader - RTC_REG force power up
...
///`read()` method returns [`rtc_cntl::R`](R) reader structure
impl crate::Readable for RTC_CNTL_SPEC {}
///`write(|w| ..)` method takes [`rtc_cntl::W`](W) writer structure
impl crate::Writable for RTC_CNTL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RTC_CNTL to value 0xa000_0000
