...
///Field `SDIO_DTHDRV` reader - Tieh = 1 mode drive ability. Initially set to 0 to limit charge current
pub type SDIO_DTHDRV_R = crate::FieldReader;
///Field `SDIO_DTHDRV` writer - Tieh = 1 mode drive ability. Initially set to 0 to limit charge current
...
///Field `SDIO_INITI` reader - add resistor from ldo output to ground. 0: no res
...
///Field `SDIO_FORCE` reader - 1: use SW option to control SDIO_REG
...
///Field `_1P8_READY` reader - read only register for REG1P8_READY
...
///Field `XPD_SDIO` reader -
pub type XPD_SDIO_R = crate::BitReader;
///Field `XPD_SDIO` writer -
