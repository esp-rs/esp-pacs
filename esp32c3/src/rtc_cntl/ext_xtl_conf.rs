...
///Field `XTAL32K_GPIO_SEL` reader - XTAL_32K sel. 0: external XTAL_32K
pub type XTAL32K_GPIO_SEL_R = crate::BitReader;
///Field `XTAL32K_GPIO_SEL` writer - XTAL_32K sel. 0: external XTAL_32K
...
///Field `XTL_EXT_CTR_EN` reader - enable gpio configure xtal power on
pub type XTL_EXT_CTR_EN_R = crate::BitReader;
///Field `XTL_EXT_CTR_EN` writer - enable gpio configure xtal power on
