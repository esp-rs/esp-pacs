...
///Field `FORCE_DOWNLOAD_BOOT` reader - force chip entry download mode
pub type FORCE_DOWNLOAD_BOOT_R = crate::BitReader;
///Field `FORCE_DOWNLOAD_BOOT` writer - force chip entry download mode
pub type FORCE_DOWNLOAD_BOOT_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - force chip entry download mode
    #[inline(always)]
