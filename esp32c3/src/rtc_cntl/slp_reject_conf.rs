...
pub type SLEEP_REJECT_ENA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 18, O, u32>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sleep_reject_ena(&mut self) -> SLEEP_REJECT_ENA_W<SLP_REJECT_CONF_SPEC, 12> {
