...
///Field `CLK_EN` reader - Clock enable bit of configuration registers for sigma delta modulation.
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - Clock enable bit of configuration registers for sigma delta modulation.
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 31 - Clock enable bit of configuration registers for sigma delta modulation.
    #[inline(always)]
