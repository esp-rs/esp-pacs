///Register `RD_SYS_PART1_DATA2` reader
pub type R = crate::R<RD_SYS_PART1_DATA2_SPEC>;
///Field `SYS_DATA_PART1_2` reader - Stores the second 32 bits of the first part of system data.
pub type SYS_DATA_PART1_2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the second 32 bits of the first part of system data.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_SYS_PART1_DATA2")
            .field("sys_data_part1_2", &self.sys_data_part1_2())
            .finish()
    }
}
...
///`read()` method returns [`rd_sys_part1_data2::R`](R) reader structure
