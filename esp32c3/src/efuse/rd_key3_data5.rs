///Register `RD_KEY3_DATA5` reader
pub type R = crate::R<RD_KEY3_DATA5_SPEC>;
///Field `KEY3_DATA5` reader - Stores the fifth 32 bits of KEY3.
pub type KEY3_DATA5_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the fifth 32 bits of KEY3.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_KEY3_DATA5")
            .field("key3_data5", &self.key3_data5())
            .finish()
    }
}
...
///`read()` method returns [`rd_key3_data5::R`](R) reader structure
