///Register `RD_KEY5_DATA3` reader
pub type R = crate::R<RD_KEY5_DATA3_SPEC>;
///Field `KEY5_DATA3` reader - Stores the third 32 bits of KEY5.
pub type KEY5_DATA3_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the third 32 bits of KEY5.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_KEY5_DATA3")
            .field("key5_data3", &self.key5_data3())
            .finish()
    }
}
...
///`read()` method returns [`rd_key5_data3::R`](R) reader structure
