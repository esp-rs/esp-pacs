...
///Field `DIS_DOWNLOAD_MODE_ERR` reader - If DIS_DOWNLOAD_MODE is 1, then it indicates a programming error.
pub type DIS_DOWNLOAD_MODE_ERR_R = crate::BitReader;
///Field `DIS_LEGACY_SPI_BOOT_ERR` reader - If DIS_LEGACY_SPI_BOOT is 1, then it indicates a programming error.
pub type DIS_LEGACY_SPI_BOOT_ERR_R = crate::BitReader;
///Field `UART_PRINT_CHANNEL_ERR` reader - If UART_PRINT_CHANNEL is 1, then it indicates a programming error.
pub type UART_PRINT_CHANNEL_ERR_R = crate::BitReader;
///Field `FLASH_ECC_MODE_ERR` reader - If FLASH_ECC_MODE is 1, then it indicates a programming error.
pub type FLASH_ECC_MODE_ERR_R = crate::BitReader;
///Field `DIS_USB_DOWNLOAD_MODE_ERR` reader - If DIS_USB_DOWNLOAD_MODE is 1, then it indicates a programming error.
pub type DIS_USB_DOWNLOAD_MODE_ERR_R = crate::BitReader;
///Field `ENABLE_SECURITY_DOWNLOAD_ERR` reader - If ENABLE_SECURITY_DOWNLOAD is 1, then it indicates a programming error.
pub type ENABLE_SECURITY_DOWNLOAD_ERR_R = crate::BitReader;
///Field `UART_PRINT_CONTROL_ERR` reader - If any bit in UART_PRINT_CONTROL is 1, then it indicates a programming error.
pub type UART_PRINT_CONTROL_ERR_R = crate::FieldReader;
///Field `PIN_POWER_SELECTION_ERR` reader - If PIN_POWER_SELECTION is 1, then it indicates a programming error.
pub type PIN_POWER_SELECTION_ERR_R = crate::BitReader;
///Field `FLASH_TYPE_ERR` reader - If FLASH_TYPE is 1, then it indicates a programming error.
pub type FLASH_TYPE_ERR_R = crate::BitReader;
///Field `FLASH_PAGE_SIZE_ERR` reader - If any bits in FLASH_PAGE_SIZE is 1, then it indicates a programming error.
pub type FLASH_PAGE_SIZE_ERR_R = crate::FieldReader;
///Field `FLASH_ECC_EN_ERR` reader - If FLASH_ECC_EN_ERR is 1, then it indicates a programming error.
pub type FLASH_ECC_EN_ERR_R = crate::BitReader;
///Field `FORCE_SEND_RESUME_ERR` reader - If FORCE_SEND_RESUME is 1, then it indicates a programming error.
pub type FORCE_SEND_RESUME_ERR_R = crate::BitReader;
///Field `SECURE_VERSION_ERR` reader - If any bit in SECURE_VERSION is 1, then it indicates a programming error.
