///Register `RD_USR_DATA4` reader
pub type R = crate::R<RD_USR_DATA4_SPEC>;
///Field `USR_DATA4` reader - Stores the fourth 32 bits of BLOCK3 (user).
pub type USR_DATA4_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the fourth 32 bits of BLOCK3 (user).
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_USR_DATA4")
            .field("usr_data4", &self.usr_data4())
            .finish()
    }
}
...
///`read()` method returns [`rd_usr_data4::R`](R) reader structure
