///Register `RD_KEY5_DATA0` reader
pub type R = crate::R<RD_KEY5_DATA0_SPEC>;
///Field `KEY5_DATA0` reader - Stores the zeroth 32 bits of KEY5.
pub type KEY5_DATA0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the zeroth 32 bits of KEY5.
    #[inline(always)]
...
///`read()` method returns [`rd_key5_data0::R`](R) reader structure
