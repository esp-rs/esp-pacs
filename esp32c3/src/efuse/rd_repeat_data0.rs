...
///Field `RD_DIS` reader - Set this bit to disable reading from BlOCK4-10.
pub type RD_DIS_R = crate::FieldReader;
///Field `DIS_RTC_RAM_BOOT` reader - Set this bit to disable boot from RTC RAM.
pub type DIS_RTC_RAM_BOOT_R = crate::BitReader;
///Field `DIS_ICACHE` reader - Set this bit to disable Icache.
pub type DIS_ICACHE_R = crate::BitReader;
///Field `DIS_USB_JTAG` reader - Set this bit to disable function of usb switch to jtag in module of usb device.
...
///Field `DIS_USB_DEVICE` reader - Set this bit to disable usb device.
pub type DIS_USB_DEVICE_R = crate::BitReader;
///Field `DIS_FORCE_DOWNLOAD` reader - Set this bit to disable the function that forces chip into download mode.
pub type DIS_FORCE_DOWNLOAD_R = crate::BitReader;
///Field `RPT4_RESERVED6` reader - Reserved (used for four backups method).
pub type RPT4_RESERVED6_R = crate::BitReader;
///Field `DIS_CAN` reader - Set this bit to disable CAN function.
pub type DIS_CAN_R = crate::BitReader;
///Field `JTAG_SEL_ENABLE` reader - Set this bit to enable selection between usb_to_jtag and pad_to_jtag through strapping gpio10 when both reg_dis_usb_jtag and reg_dis_pad_jtag are equal to 0.
pub type JTAG_SEL_ENABLE_R = crate::BitReader;
///Field `SOFT_DIS_JTAG` reader - Set these bits to disable JTAG in the soft way (odd number 1 means disable ). JTAG can be enabled in HMAC module.
pub type SOFT_DIS_JTAG_R = crate::FieldReader;
///Field `DIS_PAD_JTAG` reader - Set this bit to disable JTAG in the hard way. JTAG is disabled permanently.
pub type DIS_PAD_JTAG_R = crate::BitReader;
///Field `DIS_DOWNLOAD_MANUAL_ENCRYPT` reader - Set this bit to disable flash encryption when in download boot modes.
pub type DIS_DOWNLOAD_MANUAL_ENCRYPT_R = crate::BitReader;
///Field `USB_DREFH` reader - Controls single-end input threshold vrefh, 1.76 V to 2 V with step of 80 mV, stored in eFuse.
pub type USB_DREFH_R = crate::FieldReader;
///Field `USB_DREFL` reader - Controls single-end input threshold vrefl, 0.8 V to 1.04 V with step of 80 mV, stored in eFuse.
pub type USB_DREFL_R = crate::FieldReader;
///Field `USB_EXCHG_PINS` reader - Set this bit to exchange USB D+ and D- pins.
pub type USB_EXCHG_PINS_R = crate::BitReader;
///Field `VDD_SPI_AS_GPIO` reader - Set this bit to vdd spi pin function as gpio.
pub type VDD_SPI_AS_GPIO_R = crate::BitReader;
///Field `BTLC_GPIO_ENABLE` reader - Enable btlc gpio.
pub type BTLC_GPIO_ENABLE_R = crate::FieldReader;
///Field `POWERGLITCH_EN` reader - Set this bit to enable power glitch function.
pub type POWERGLITCH_EN_R = crate::BitReader;
///Field `POWER_GLITCH_DSENSE` reader - Sample delay configuration of power glitch.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA0")
            ...
            .field("rpt4_reserved6", &self.rpt4_reserved6())
            ...
            .field("btlc_gpio_enable", &self.btlc_gpio_enable())
