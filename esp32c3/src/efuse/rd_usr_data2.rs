///Register `RD_USR_DATA2` reader
pub type R = crate::R<RD_USR_DATA2_SPEC>;
///Field `USR_DATA2` reader - Stores the second 32 bits of BLOCK3 (user).
pub type USR_DATA2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the second 32 bits of BLOCK3 (user).
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_USR_DATA2")
            .field("usr_data2", &self.usr_data2())
            .finish()
    }
}
...
///`read()` method returns [`rd_usr_data2::R`](R) reader structure
