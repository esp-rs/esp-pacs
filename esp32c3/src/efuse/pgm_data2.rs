...
///Field `PGM_DATA_2` reader - The content of the 2nd 32-bit data to be programmed.
pub type PGM_DATA_2_R = crate::FieldReader<u32>;
///Field `PGM_DATA_2` writer - The content of the 2nd 32-bit data to be programmed.
