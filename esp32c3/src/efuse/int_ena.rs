...
///Field `READ_DONE` reader - The enable signal for read_done interrupt.
pub type READ_DONE_R = crate::BitReader;
///Field `READ_DONE` writer - The enable signal for read_done interrupt.
pub type READ_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PGM_DONE` reader - The enable signal for pgm_done interrupt.
pub type PGM_DONE_R = crate::BitReader;
///Field `PGM_DONE` writer - The enable signal for pgm_done interrupt.
