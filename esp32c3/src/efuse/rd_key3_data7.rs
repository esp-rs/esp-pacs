///Register `RD_KEY3_DATA7` reader
pub type R = crate::R<RD_KEY3_DATA7_SPEC>;
///Field `KEY3_DATA7` reader - Stores the seventh 32 bits of KEY3.
pub type KEY3_DATA7_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the seventh 32 bits of KEY3.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_key3_data7::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_KEY3_DATA7_SPEC;
impl crate::RegisterSpec for RD_KEY3_DATA7_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_key3_data7::R`](R) reader structure
