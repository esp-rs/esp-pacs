...
///Field `OP_CODE` reader - 0x5A5A: Operate programming command 0x5AA5: Operate read command.
pub type OP_CODE_R = crate::FieldReader<u16>;
///Field `OP_CODE` writer - 0x5A5A: Operate programming command 0x5AA5: Operate read command.
pub type OP_CODE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - 0x5A5A: Operate programming command 0x5AA5: Operate read command.
    #[inline(always)]
