...
pub type PGM_DATA_3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PGM_DATA_3` writer - The content of the 3rd 32-bit data to be programmed."]
pub type PGM_DATA_3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PGM_DATA3_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - The content of the 3rd 32-bit data to be programmed."]
    #[inline(always)]
    pub fn pgm_data_3(&mut self) -> PGM_DATA_3_W<0> {
