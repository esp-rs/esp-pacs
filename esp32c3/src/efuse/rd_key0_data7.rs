///Register `RD_KEY0_DATA7` reader
pub type R = crate::R<RD_KEY0_DATA7_SPEC>;
///Field `KEY0_DATA7` reader - Stores the seventh 32 bits of KEY0.
pub type KEY0_DATA7_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the seventh 32 bits of KEY0.
    #[inline(always)]
...
///`read()` method returns [`rd_key0_data7::R`](R) reader structure
