...
///Field `PGM_RS_DATA_1` reader - The content of the 1st 32-bit RS code to be programmed.
pub type PGM_RS_DATA_1_R = crate::FieldReader<u32>;
///Field `PGM_RS_DATA_1` writer - The content of the 1st 32-bit RS code to be programmed.
