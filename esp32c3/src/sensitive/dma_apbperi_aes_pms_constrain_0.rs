...
pub type DMA_APBPERI_AES_PMS_CONSTRAIN_LOCK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn dma_apbperi_aes_pms_constrain_lock(
        &mut self,
    ) -> DMA_APBPERI_AES_PMS_CONSTRAIN_LOCK_W<DMA_APBPERI_AES_PMS_CONSTRAIN_0_SPEC, 0> {
