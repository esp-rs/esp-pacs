///Register `CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_0` reader
pub type R = crate::R<CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_0_SPEC>;
///Register `CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_0` writer
...
///`read()` method returns [`core_x_iram0_dram0_dma_split_line_constrain_0::R`](R) reader structure
impl crate::Readable for CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_0_SPEC {}
///`write(|w| ..)` method takes [`core_x_iram0_dram0_dma_split_line_constrain_0::W`](W) writer structure
