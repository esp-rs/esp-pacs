///Register `REGION_PMS_CONSTRAIN_3` reader
pub type R = crate::R<REGION_PMS_CONSTRAIN_3_SPEC>;
///Register `REGION_PMS_CONSTRAIN_3` writer
pub type W = crate::W<REGION_PMS_CONSTRAIN_3_SPEC>;
///Field `REGION_PMS_CONSTRAIN_ADDR_0` reader - region_pms_constrain_addr_0
pub type REGION_PMS_CONSTRAIN_ADDR_0_R = crate::FieldReader<u32>;
///Field `REGION_PMS_CONSTRAIN_ADDR_0` writer - region_pms_constrain_addr_0
...
///`read()` method returns [`region_pms_constrain_3::R`](R) reader structure
impl crate::Readable for REGION_PMS_CONSTRAIN_3_SPEC {}
///`write(|w| ..)` method takes [`region_pms_constrain_3::W`](W) writer structure
impl crate::Writable for REGION_PMS_CONSTRAIN_3_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets REGION_PMS_CONSTRAIN_3 to value 0
