...
///Field `CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_0` reader - core_x_iram0_sram_line_0_category_0
pub type CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_0_R = crate::FieldReader;
///Field `CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_0` writer - core_x_iram0_sram_line_0_category_0
pub type CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_1` reader - core_x_iram0_sram_line_0_category_1
pub type CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_1_R = crate::FieldReader;
///Field `CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_1` writer - core_x_iram0_sram_line_0_category_1
pub type CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_2` reader - core_x_iram0_sram_line_0_category_2
pub type CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_2_R = crate::FieldReader;
///Field `CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_2` writer - core_x_iram0_sram_line_0_category_2
pub type CORE_X_IRAM0_SRAM_LINE_0_CATEGORY_2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_SRAM_LINE_0_SPLITADDR` reader - core_x_iram0_sram_line_0_splitaddr
pub type CORE_X_IRAM0_SRAM_LINE_0_SPLITADDR_R = crate::FieldReader;
///Field `CORE_X_IRAM0_SRAM_LINE_0_SPLITADDR` writer - core_x_iram0_sram_line_0_splitaddr
pub type CORE_X_IRAM0_SRAM_LINE_0_SPLITADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:1 - core_x_iram0_sram_line_0_category_0
    #[inline(always)]
