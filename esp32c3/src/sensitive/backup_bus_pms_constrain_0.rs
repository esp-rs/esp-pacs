...
///Field `BACKUP_BUS_PMS_CONSTRAIN_LOCK` reader - backup_bus_pms_constrain_lock
pub type BACKUP_BUS_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_LOCK` writer - backup_bus_pms_constrain_lock
pub type BACKUP_BUS_PMS_CONSTRAIN_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - backup_bus_pms_constrain_lock
    #[inline(always)]
