...
impl W {
    ...
    > {
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_0_W::new(self, 0)
    }
    ///Bits 2:3 - dma_apbperi_adc_dac_pms_constrain_sram_world_0_pms_1
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_adc_dac_pms_constrain_sram_world_0_pms_1(
        &mut self,
    ) -> DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_1_W<
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1_SPEC,
    > {
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_1_W::new(self, 2)
    }
    ///Bits 4:5 - dma_apbperi_adc_dac_pms_constrain_sram_world_0_pms_2
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_adc_dac_pms_constrain_sram_world_0_pms_2(
        &mut self,
    ) -> DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_2_W<
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1_SPEC,
    > {
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_2_W::new(self, 4)
    }
    ///Bits 6:7 - dma_apbperi_adc_dac_pms_constrain_sram_world_0_pms_3
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_adc_dac_pms_constrain_sram_world_0_pms_3(
        ...
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1_SPEC,
    > {
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_3_W::new(self, 6)
    }
    ///Bits 12:13 - dma_apbperi_adc_dac_pms_constrain_sram_world_1_pms_0
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_adc_dac_pms_constrain_sram_world_1_pms_0(
        &mut self,
    ) -> DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_1_PMS_0_W<
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1_SPEC,
    > {
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_1_PMS_0_W::new(self, 12)
    }
    ///Bits 14:15 - dma_apbperi_adc_dac_pms_constrain_sram_world_1_pms_1
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_adc_dac_pms_constrain_sram_world_1_pms_1(
        &mut self,
    ) -> DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_1_PMS_1_W<
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1_SPEC,
    > {
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_1_PMS_1_W::new(self, 14)
    }
    ///Bits 16:17 - dma_apbperi_adc_dac_pms_constrain_sram_world_1_pms_2
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_adc_dac_pms_constrain_sram_world_1_pms_2(
        ...
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1_SPEC,
    > {
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_1_PMS_2_W::new(self, 16)
    }
    ///Bits 18:19 - dma_apbperi_adc_dac_pms_constrain_sram_world_1_pms_3
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_adc_dac_pms_constrain_sram_world_1_pms_3(
        ...
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1_SPEC,
    > {
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_SRAM_WORLD_1_PMS_3_W::new(self, 18)
    }
}
...
///`reset()` method sets DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_1 to value 0x000f_f0ff
