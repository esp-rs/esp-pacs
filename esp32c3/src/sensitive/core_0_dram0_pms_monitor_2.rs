...
///Field `CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR` reader - core_0_dram0_pms_monitor_violate_intr
pub type CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_R = crate::BitReader;
///Field `CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_LOCK` reader - core_0_dram0_pms_monitor_violate_status_lock
pub type CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_LOCK_R = crate::BitReader;
///Field `CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD` reader - core_0_dram0_pms_monitor_violate_status_world
pub type CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD_R = crate::FieldReader;
///Field `CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_ADDR` reader - core_0_dram0_pms_monitor_violate_status_addr
...
impl R {
    ...
    ///Bits 2:3 - core_0_dram0_pms_monitor_violate_status_world
    #[inline(always)]
