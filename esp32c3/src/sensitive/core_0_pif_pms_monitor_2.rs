...
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR` reader - core_0_pif_pms_monitor_violate_intr
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HPORT_0` reader - core_0_pif_pms_monitor_violate_status_hport_0
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HPORT_0_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HSIZE` reader - core_0_pif_pms_monitor_violate_status_hsize
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HSIZE_R = crate::FieldReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HWRITE` reader - core_0_pif_pms_monitor_violate_status_hwrite
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HWRITE_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HWORLD` reader - core_0_pif_pms_monitor_violate_status_hworld
...
impl R {
    ...
    ///Bits 2:4 - core_0_pif_pms_monitor_violate_status_hsize
    #[inline(always)]
    ...
    ///Bit 5 - core_0_pif_pms_monitor_violate_status_hwrite
    #[inline(always)]
    ...
    ///Bits 6:7 - core_0_pif_pms_monitor_violate_status_hworld
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_0_pif_pms_monitor_2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_PIF_PMS_MONITOR_2_SPEC;
impl crate::RegisterSpec for CORE_0_PIF_PMS_MONITOR_2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_0_pif_pms_monitor_2::R`](R) reader structure
