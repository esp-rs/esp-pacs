...
pub type CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_TIMER_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_WDG_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_world_0_timer(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_TIMER_W<CORE_0_PIF_PMS_CONSTRAIN_1_SPEC, 12> {
    ...
    pub fn core_0_pif_pms_constrain_world_0_wdg(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_WDG_W<CORE_0_PIF_PMS_CONSTRAIN_1_SPEC, 18> {
