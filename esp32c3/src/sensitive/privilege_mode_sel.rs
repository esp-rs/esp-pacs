///Register `PRIVILEGE_MODE_SEL` reader
pub type R = crate::R<PRIVILEGE_MODE_SEL_SPEC>;
///Register `PRIVILEGE_MODE_SEL` writer
pub type W = crate::W<PRIVILEGE_MODE_SEL_SPEC>;
///Field `PRIVILEGE_MODE_SEL` reader - privilege_mode_sel
pub type PRIVILEGE_MODE_SEL_R = crate::BitReader;
///Field `PRIVILEGE_MODE_SEL` writer - privilege_mode_sel
...
///`read()` method returns [`privilege_mode_sel::R`](R) reader structure
impl crate::Readable for PRIVILEGE_MODE_SEL_SPEC {}
///`write(|w| ..)` method takes [`privilege_mode_sel::W`](W) writer structure
impl crate::Writable for PRIVILEGE_MODE_SEL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRIVILEGE_MODE_SEL to value 0
