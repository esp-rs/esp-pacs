...
///Field `INTERNAL_SRAM_USAGE_CPU_CACHE` reader - internal_sram_usage_cpu_cache
pub type INTERNAL_SRAM_USAGE_CPU_CACHE_R = crate::BitReader;
///Field `INTERNAL_SRAM_USAGE_CPU_CACHE` writer - internal_sram_usage_cpu_cache
pub type INTERNAL_SRAM_USAGE_CPU_CACHE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTERNAL_SRAM_USAGE_CPU_SRAM` reader - internal_sram_usage_cpu_sram
pub type INTERNAL_SRAM_USAGE_CPU_SRAM_R = crate::FieldReader;
///Field `INTERNAL_SRAM_USAGE_CPU_SRAM` writer - internal_sram_usage_cpu_sram
pub type INTERNAL_SRAM_USAGE_CPU_SRAM_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bit 0 - internal_sram_usage_cpu_cache
    #[inline(always)]
    ...
    ///Bits 1:3 - internal_sram_usage_cpu_sram
    #[inline(always)]
...
///`reset()` method sets INTERNAL_SRAM_USAGE_1 to value 0x0f
