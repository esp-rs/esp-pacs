///Register `REGION_PMS_CONSTRAIN_8` reader
pub type R = crate::R<REGION_PMS_CONSTRAIN_8_SPEC>;
///Register `REGION_PMS_CONSTRAIN_8` writer
pub type W = crate::W<REGION_PMS_CONSTRAIN_8_SPEC>;
///Field `REGION_PMS_CONSTRAIN_ADDR_5` reader - region_pms_constrain_addr_5
pub type REGION_PMS_CONSTRAIN_ADDR_5_R = crate::FieldReader<u32>;
///Field `REGION_PMS_CONSTRAIN_ADDR_5` writer - region_pms_constrain_addr_5
pub type REGION_PMS_CONSTRAIN_ADDR_5_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - region_pms_constrain_addr_5
    #[inline(always)]
...
///`read()` method returns [`region_pms_constrain_8::R`](R) reader structure
impl crate::Readable for REGION_PMS_CONSTRAIN_8_SPEC {}
///`write(|w| ..)` method takes [`region_pms_constrain_8::W`](W) writer structure
impl crate::Writable for REGION_PMS_CONSTRAIN_8_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets REGION_PMS_CONSTRAIN_8 to value 0
