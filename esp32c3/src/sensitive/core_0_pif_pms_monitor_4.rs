///Register `CORE_0_PIF_PMS_MONITOR_4` reader
pub type R = crate::R<CORE_0_PIF_PMS_MONITOR_4_SPEC>;
///Register `CORE_0_PIF_PMS_MONITOR_4` writer
pub type W = crate::W<CORE_0_PIF_PMS_MONITOR_4_SPEC>;
///Field `CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR` reader - core_0_pif_pms_monitor_nonword_violate_clr
pub type CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR` writer - core_0_pif_pms_monitor_nonword_violate_clr
pub type CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_EN` reader - core_0_pif_pms_monitor_nonword_violate_en
pub type CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_EN_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_EN` writer - core_0_pif_pms_monitor_nonword_violate_en
...
impl R {
    ...
    ///Bit 1 - core_0_pif_pms_monitor_nonword_violate_en
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_0_pif_pms_monitor_4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_0_pif_pms_monitor_4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_PIF_PMS_MONITOR_4_SPEC;
impl crate::RegisterSpec for CORE_0_PIF_PMS_MONITOR_4_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_0_pif_pms_monitor_4::R`](R) reader structure
impl crate::Readable for CORE_0_PIF_PMS_MONITOR_4_SPEC {}
///`write(|w| ..)` method takes [`core_0_pif_pms_monitor_4::W`](W) writer structure
