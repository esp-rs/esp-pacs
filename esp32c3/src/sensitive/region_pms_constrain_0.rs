///Register `REGION_PMS_CONSTRAIN_0` reader
pub type R = crate::R<REGION_PMS_CONSTRAIN_0_SPEC>;
///Register `REGION_PMS_CONSTRAIN_0` writer
pub type W = crate::W<REGION_PMS_CONSTRAIN_0_SPEC>;
///Field `REGION_PMS_CONSTRAIN_LOCK` reader - region_pms_constrain_lock
pub type REGION_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
///Field `REGION_PMS_CONSTRAIN_LOCK` writer - region_pms_constrain_lock
pub type REGION_PMS_CONSTRAIN_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - region_pms_constrain_lock
    #[inline(always)]
...
///`read()` method returns [`region_pms_constrain_0::R`](R) reader structure
impl crate::Readable for REGION_PMS_CONSTRAIN_0_SPEC {}
///`write(|w| ..)` method takes [`region_pms_constrain_0::W`](W) writer structure
impl crate::Writable for REGION_PMS_CONSTRAIN_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets REGION_PMS_CONSTRAIN_0 to value 0
