...
///Field `DMA_APBPERI_PMS_MONITOR_LOCK` reader - dma_apbperi_pms_monitor_lock
pub type DMA_APBPERI_PMS_MONITOR_LOCK_R = crate::BitReader;
///Field `DMA_APBPERI_PMS_MONITOR_LOCK` writer - dma_apbperi_pms_monitor_lock
pub type DMA_APBPERI_PMS_MONITOR_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - dma_apbperi_pms_monitor_lock
    #[inline(always)]
