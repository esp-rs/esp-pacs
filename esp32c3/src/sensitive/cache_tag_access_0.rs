...
#[doc = "Field `CACHE_TAG_ACCESS_LOCK` reader - cache_tag_access_lock"]
pub type CACHE_TAG_ACCESS_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `CACHE_TAG_ACCESS_LOCK` writer - cache_tag_access_lock"]
pub type CACHE_TAG_ACCESS_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CACHE_TAG_ACCESS_0_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - cache_tag_access_lock"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cache_tag_access_lock(&mut self) -> CACHE_TAG_ACCESS_LOCK_W<0> {
