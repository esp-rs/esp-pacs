...
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_CLR` reader - core_0_pif_pms_monitor_violate_clr
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_CLR_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_CLR` writer - core_0_pif_pms_monitor_violate_clr
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_EN` reader - core_0_pif_pms_monitor_violate_en
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_EN_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_EN` writer - core_0_pif_pms_monitor_violate_en
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - core_0_pif_pms_monitor_violate_clr
    #[inline(always)]
    ...
    ///Bit 1 - core_0_pif_pms_monitor_violate_en
    #[inline(always)]
