///Register `REGION_PMS_CONSTRAIN_10` reader
pub type R = crate::R<REGION_PMS_CONSTRAIN_10_SPEC>;
///Register `REGION_PMS_CONSTRAIN_10` writer
pub type W = crate::W<REGION_PMS_CONSTRAIN_10_SPEC>;
///Field `REGION_PMS_CONSTRAIN_ADDR_7` reader - region_pms_constrain_addr_7
pub type REGION_PMS_CONSTRAIN_ADDR_7_R = crate::FieldReader<u32>;
///Field `REGION_PMS_CONSTRAIN_ADDR_7` writer - region_pms_constrain_addr_7
pub type REGION_PMS_CONSTRAIN_ADDR_7_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - region_pms_constrain_addr_7
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION_PMS_CONSTRAIN_10")
            .field(
                ...
                &self.region_pms_constrain_addr_7(),
            )
            .finish()
    }
}
...
///`read()` method returns [`region_pms_constrain_10::R`](R) reader structure
impl crate::Readable for REGION_PMS_CONSTRAIN_10_SPEC {}
///`write(|w| ..)` method takes [`region_pms_constrain_10::W`](W) writer structure
impl crate::Writable for REGION_PMS_CONSTRAIN_10_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets REGION_PMS_CONSTRAIN_10 to value 0
