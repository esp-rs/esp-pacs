...
pub type REGION_PMS_CONSTRAIN_ADDR_7_R = crate::FieldReader<u32, u32>;
...
pub type REGION_PMS_CONSTRAIN_ADDR_7_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, REGION_PMS_CONSTRAIN_10_SPEC, u32, u32, 30, O>;
impl R {
    #[doc = "Bits 0:29 - region_pms_constrain_addr_7"]
    #[inline(always)]
    pub fn region_pms_constrain_addr_7(&self) -> REGION_PMS_CONSTRAIN_ADDR_7_R {
        REGION_PMS_CONSTRAIN_ADDR_7_R::new((self.bits & 0x3fff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:29 - region_pms_constrain_addr_7"]
