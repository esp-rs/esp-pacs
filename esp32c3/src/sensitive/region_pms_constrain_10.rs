...
impl W {
    ...
    pub fn region_pms_constrain_addr_7(
        &mut self,
    ) -> REGION_PMS_CONSTRAIN_ADDR_7_W<'_, REGION_PMS_CONSTRAIN_10_SPEC> {
        REGION_PMS_CONSTRAIN_ADDR_7_W::new(self, 0)
    }
}
#[doc = "SENSITIVE_REGION_PMS_CONSTRAIN_10_REG\n\nYou can [`read`](crate::Reg::read) this register and get [`region_pms_constrain_10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`region_pms_constrain_10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
