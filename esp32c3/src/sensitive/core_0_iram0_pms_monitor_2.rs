///Register `CORE_0_IRAM0_PMS_MONITOR_2` reader
pub type R = crate::R<CORE_0_IRAM0_PMS_MONITOR_2_SPEC>;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR` reader - core_0_iram0_pms_monitor_violate_intr
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_R = crate::BitReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WR` reader - core_0_iram0_pms_monitor_violate_status_wr
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WR_R = crate::BitReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_LOADSTORE` reader - core_0_iram0_pms_monitor_violate_status_loadstore
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_LOADSTORE_R = crate::BitReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD` reader - core_0_iram0_pms_monitor_violate_status_world
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD_R = crate::FieldReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_ADDR` reader - core_0_iram0_pms_monitor_violate_status_addr
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bit 0 - core_0_iram0_pms_monitor_violate_intr
    #[inline(always)]
    ...
    ///Bit 1 - core_0_iram0_pms_monitor_violate_status_wr
    #[inline(always)]
    ...
    ///Bits 3:4 - core_0_iram0_pms_monitor_violate_status_world
    #[inline(always)]
    ...
    ///Bits 5:28 - core_0_iram0_pms_monitor_violate_status_addr
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_IRAM0_PMS_MONITOR_2")
            .field(
                ...
                &self.core_0_iram0_pms_monitor_violate_intr(),
            )
            .field(
                "core_0_iram0_pms_monitor_violate_status_wr",
                &self.core_0_iram0_pms_monitor_violate_status_wr(),
            )
            .field(
            ...
            .field(
                ...
                &self.core_0_iram0_pms_monitor_violate_status_world(),
            )
            .field(
                "core_0_iram0_pms_monitor_violate_status_addr",
                &self.core_0_iram0_pms_monitor_violate_status_addr(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_0_iram0_pms_monitor_2::R`](R) reader structure
