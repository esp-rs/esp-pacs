...
///Field `DMA_APBPERI_PMS_MONITOR_VIOLATE_STATUS_WR` reader - dma_apbperi_pms_monitor_violate_status_wr
pub type DMA_APBPERI_PMS_MONITOR_VIOLATE_STATUS_WR_R = crate::BitReader;
///Field `DMA_APBPERI_PMS_MONITOR_VIOLATE_STATUS_BYTEEN` reader - dma_apbperi_pms_monitor_violate_status_byteen
pub type DMA_APBPERI_PMS_MONITOR_VIOLATE_STATUS_BYTEEN_R = crate::FieldReader;
impl R {
    ///Bit 0 - dma_apbperi_pms_monitor_violate_status_wr
    #[inline(always)]
    ...
    ///Bits 1:4 - dma_apbperi_pms_monitor_violate_status_byteen
    #[inline(always)]
