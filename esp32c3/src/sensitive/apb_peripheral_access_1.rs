...
///Field `APB_PERIPHERAL_ACCESS_SPLIT_BURST` reader - apb_peripheral_access_split_burst
pub type APB_PERIPHERAL_ACCESS_SPLIT_BURST_R = crate::BitReader;
///Field `APB_PERIPHERAL_ACCESS_SPLIT_BURST` writer - apb_peripheral_access_split_burst
pub type APB_PERIPHERAL_ACCESS_SPLIT_BURST_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - apb_peripheral_access_split_burst
    #[inline(always)]
