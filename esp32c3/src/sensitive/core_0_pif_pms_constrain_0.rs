...
#[doc = "Field `CORE_0_PIF_PMS_CONSTRAIN_LOCK` reader - core_0_pif_pms_constrain_lock"]
pub type CORE_0_PIF_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
#[doc = "Field `CORE_0_PIF_PMS_CONSTRAIN_LOCK` writer - core_0_pif_pms_constrain_lock"]
pub type CORE_0_PIF_PMS_CONSTRAIN_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - core_0_pif_pms_constrain_lock"]
    #[inline(always)]
...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_lock(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_LOCK_W<'_, CORE_0_PIF_PMS_CONSTRAIN_0_SPEC> {
        CORE_0_PIF_PMS_CONSTRAIN_LOCK_W::new(self, 0)
    }
}
#[doc = "SENSITIVE_CORE_0_PIF_PMS_CONSTRAIN_0_REG\n\nYou can [`read`](crate::Reg::read) this register and get [`core_0_pif_pms_constrain_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_0_pif_pms_constrain_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
