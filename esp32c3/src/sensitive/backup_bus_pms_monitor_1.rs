...
///Field `BACKUP_BUS_PMS_MONITOR_VIOLATE_CLR` reader - backup_bus_pms_monitor_violate_clr
pub type BACKUP_BUS_PMS_MONITOR_VIOLATE_CLR_R = crate::BitReader;
///Field `BACKUP_BUS_PMS_MONITOR_VIOLATE_CLR` writer - backup_bus_pms_monitor_violate_clr
pub type BACKUP_BUS_PMS_MONITOR_VIOLATE_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BACKUP_BUS_PMS_MONITOR_VIOLATE_EN` reader - backup_bus_pms_monitor_violate_en
pub type BACKUP_BUS_PMS_MONITOR_VIOLATE_EN_R = crate::BitReader;
///Field `BACKUP_BUS_PMS_MONITOR_VIOLATE_EN` writer - backup_bus_pms_monitor_violate_en
