...
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HADDR` reader - core_0_pif_pms_monitor_violate_status_haddr
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - core_0_pif_pms_monitor_violate_status_haddr
    #[inline(always)]
