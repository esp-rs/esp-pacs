...
///Field `INTERNAL_SRAM_USAGE_LOCK` reader - internal_sram_usage_lock
pub type INTERNAL_SRAM_USAGE_LOCK_R = crate::BitReader;
///Field `INTERNAL_SRAM_USAGE_LOCK` writer - internal_sram_usage_lock
pub type INTERNAL_SRAM_USAGE_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - internal_sram_usage_lock
    #[inline(always)]
