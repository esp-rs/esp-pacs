...
impl W {
    ...
    pub fn core_x_dram0_pms_constrain_lock(
        &mut self,
    ) -> CORE_X_DRAM0_PMS_CONSTRAIN_LOCK_W<'_, CORE_X_DRAM0_PMS_CONSTRAIN_0_SPEC> {
        CORE_X_DRAM0_PMS_CONSTRAIN_LOCK_W::new(self, 0)
    }
}
#[doc = "SENSITIVE_CORE_X_DRAM0_PMS_CONSTRAIN_0_REG\n\nYou can [`read`](crate::Reg::read) this register and get [`core_x_dram0_pms_constrain_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_x_dram0_pms_constrain_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
