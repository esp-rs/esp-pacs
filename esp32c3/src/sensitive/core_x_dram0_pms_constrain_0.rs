...
///Field `CORE_X_DRAM0_PMS_CONSTRAIN_LOCK` reader - core_x_dram0_pms_constrain_lock
pub type CORE_X_DRAM0_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
///Field `CORE_X_DRAM0_PMS_CONSTRAIN_LOCK` writer - core_x_dram0_pms_constrain_lock
