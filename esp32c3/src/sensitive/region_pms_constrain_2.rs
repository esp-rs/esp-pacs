///Register `REGION_PMS_CONSTRAIN_2` reader
pub type R = crate::R<REGION_PMS_CONSTRAIN_2_SPEC>;
///Register `REGION_PMS_CONSTRAIN_2` writer
pub type W = crate::W<REGION_PMS_CONSTRAIN_2_SPEC>;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_0` reader - region_pms_constrain_world_1_area_0
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_0_R = crate::FieldReader;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_0` writer - region_pms_constrain_world_1_area_0
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_1` reader - region_pms_constrain_world_1_area_1
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_1_R = crate::FieldReader;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_1` writer - region_pms_constrain_world_1_area_1
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_2` reader - region_pms_constrain_world_1_area_2
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_2_R = crate::FieldReader;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_2` writer - region_pms_constrain_world_1_area_2
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_3` reader - region_pms_constrain_world_1_area_3
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_3_R = crate::FieldReader;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_3` writer - region_pms_constrain_world_1_area_3
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_3_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_4` reader - region_pms_constrain_world_1_area_4
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_4_R = crate::FieldReader;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_4` writer - region_pms_constrain_world_1_area_4
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_4_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_5` reader - region_pms_constrain_world_1_area_5
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_5_R = crate::FieldReader;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_5` writer - region_pms_constrain_world_1_area_5
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_5_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_6` reader - region_pms_constrain_world_1_area_6
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_6_R = crate::FieldReader;
///Field `REGION_PMS_CONSTRAIN_WORLD_1_AREA_6` writer - region_pms_constrain_world_1_area_6
pub type REGION_PMS_CONSTRAIN_WORLD_1_AREA_6_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - region_pms_constrain_world_1_area_0
    #[inline(always)]
    ...
    ///Bits 2:3 - region_pms_constrain_world_1_area_1
    #[inline(always)]
    ...
    ///Bits 4:5 - region_pms_constrain_world_1_area_2
    #[inline(always)]
    ...
    ///Bits 6:7 - region_pms_constrain_world_1_area_3
    #[inline(always)]
    ...
    ///Bits 8:9 - region_pms_constrain_world_1_area_4
    #[inline(always)]
...
///`read()` method returns [`region_pms_constrain_2::R`](R) reader structure
impl crate::Readable for REGION_PMS_CONSTRAIN_2_SPEC {}
///`write(|w| ..)` method takes [`region_pms_constrain_2::W`](W) writer structure
impl crate::Writable for REGION_PMS_CONSTRAIN_2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets REGION_PMS_CONSTRAIN_2 to value 0x3fff
