    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION_PMS_CONSTRAIN_2")
            .field(
                ...
                &self.region_pms_constrain_world_1_area_0().bits(),
            )
            .field(
                "region_pms_constrain_world_1_area_1",
                &self.region_pms_constrain_world_1_area_1().bits(),
            )
            .field(
                "region_pms_constrain_world_1_area_2",
                &self.region_pms_constrain_world_1_area_2().bits(),
            )
            .field(
                "region_pms_constrain_world_1_area_3",
                &self.region_pms_constrain_world_1_area_3().bits(),
            )
            .field(
                "region_pms_constrain_world_1_area_4",
                &self.region_pms_constrain_world_1_area_4().bits(),
            )
            .field(
                "region_pms_constrain_world_1_area_5",
                &self.region_pms_constrain_world_1_area_5().bits(),
            )
            .field(
                "region_pms_constrain_world_1_area_6",
                &self.region_pms_constrain_world_1_area_6().bits(),
            )
            .finish()
    }
}
