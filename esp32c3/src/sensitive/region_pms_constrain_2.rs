...
impl W {
    ...
    pub fn region_pms_constrain_world_1_area_0(
        &mut self,
    ) -> REGION_PMS_CONSTRAIN_WORLD_1_AREA_0_W<'_, REGION_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn region_pms_constrain_world_1_area_1(
        &mut self,
    ) -> REGION_PMS_CONSTRAIN_WORLD_1_AREA_1_W<'_, REGION_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn region_pms_constrain_world_1_area_2(
        &mut self,
    ) -> REGION_PMS_CONSTRAIN_WORLD_1_AREA_2_W<'_, REGION_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn region_pms_constrain_world_1_area_3(
        &mut self,
    ) -> REGION_PMS_CONSTRAIN_WORLD_1_AREA_3_W<'_, REGION_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn region_pms_constrain_world_1_area_4(
        &mut self,
    ) -> REGION_PMS_CONSTRAIN_WORLD_1_AREA_4_W<'_, REGION_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn region_pms_constrain_world_1_area_5(
        &mut self,
    ) -> REGION_PMS_CONSTRAIN_WORLD_1_AREA_5_W<'_, REGION_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn region_pms_constrain_world_1_area_6(
        &mut self,
    ) -> REGION_PMS_CONSTRAIN_WORLD_1_AREA_6_W<'_, REGION_PMS_CONSTRAIN_2_SPEC> {
