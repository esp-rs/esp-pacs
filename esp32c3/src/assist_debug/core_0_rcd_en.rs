...
///Field `CORE_0_RCD_RECORDEN` reader - reg_core_0_rcd_recorden
pub type CORE_0_RCD_RECORDEN_R = crate::BitReader;
///Field `CORE_0_RCD_RECORDEN` writer - reg_core_0_rcd_recorden
pub type CORE_0_RCD_RECORDEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_RCD_PDEBUGEN` reader - reg_core_0_rcd_pdebugen
pub type CORE_0_RCD_PDEBUGEN_R = crate::BitReader;
///Field `CORE_0_RCD_PDEBUGEN` writer - reg_core_0_rcd_pdebugen
