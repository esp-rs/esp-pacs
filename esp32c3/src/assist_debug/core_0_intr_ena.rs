...
pub type CORE_0_IRAM0_EXCEPTION_MONITOR_RLS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_0_DRAM0_EXCEPTION_MONITOR_RLS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn core_0_iram0_exception_monitor_rls(
        &mut self,
    ) -> CORE_0_IRAM0_EXCEPTION_MONITOR_RLS_W<CORE_0_INTR_ENA_SPEC, 10> {
    ...
    pub fn core_0_dram0_exception_monitor_rls(
        &mut self,
    ) -> CORE_0_DRAM0_EXCEPTION_MONITOR_RLS_W<CORE_0_INTR_ENA_SPEC, 11> {
