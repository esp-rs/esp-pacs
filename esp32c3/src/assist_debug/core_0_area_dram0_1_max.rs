...
///Field `CORE_0_AREA_DRAM0_1_MAX` reader - reg_core_0_area_dram0_1_max
pub type CORE_0_AREA_DRAM0_1_MAX_R = crate::FieldReader<u32>;
///Field `CORE_0_AREA_DRAM0_1_MAX` writer - reg_core_0_area_dram0_1_max
pub type CORE_0_AREA_DRAM0_1_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - reg_core_0_area_dram0_1_max
    #[inline(always)]
