...
///Field `LOG_MEM_FULL_FLAG` reader - reg_log_mem_full_flag
pub type LOG_MEM_FULL_FLAG_R = crate::BitReader;
///Field `CLR_LOG_MEM_FULL_FLAG` reader - reg_clr_log_mem_full_flag
pub type CLR_LOG_MEM_FULL_FLAG_R = crate::BitReader;
///Field `CLR_LOG_MEM_FULL_FLAG` writer - reg_clr_log_mem_full_flag
pub type CLR_LOG_MEM_FULL_FLAG_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - reg_log_mem_full_flag
    #[inline(always)]
