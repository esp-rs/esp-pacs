...
pub type CORE_0_AREA_PIF_0_MIN_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_0_AREA_PIF_0_MIN` writer - reg_core_0_area_pif_0_min"]
pub type CORE_0_AREA_PIF_0_MIN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_0_AREA_PIF_0_MIN_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - reg_core_0_area_pif_0_min"]
    #[inline(always)]
    pub fn core_0_area_pif_0_min(&mut self) -> CORE_0_AREA_PIF_0_MIN_W<0> {
