...
///Field `ASSIST_DEBUG_DATE` reader - reg_assist_debug_date
pub type ASSIST_DEBUG_DATE_R = crate::FieldReader<u32>;
///Field `ASSIST_DEBUG_DATE` writer - reg_assist_debug_date
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DATE")
            .field("assist_debug_date", &self.assist_debug_date())
            .finish()
    }
}
impl W {
...
///`reset()` method sets DATE to value 0x0200_8010
