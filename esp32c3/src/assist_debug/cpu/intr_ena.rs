...
impl W {
    ...
    #[doc = "Bit 10 - reg_core_0_iram0_exception_monitor_ena"]
    #[inline(always)]
    pub fn iram0_exception_monitor_rls(&mut self) -> IRAM0_EXCEPTION_MONITOR_RLS_W<INTR_ENA_SPEC> {
        IRAM0_EXCEPTION_MONITOR_RLS_W::new(self, 10)
    }
    #[doc = "Bit 11 - reg_core_0_dram0_exception_monitor_ena"]
    #[inline(always)]
    pub fn dram0_exception_monitor_rls(&mut self) -> DRAM0_EXCEPTION_MONITOR_RLS_W<INTR_ENA_SPEC> {
