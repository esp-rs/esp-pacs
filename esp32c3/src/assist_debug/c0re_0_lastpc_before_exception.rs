///Register `C0RE_0_LASTPC_BEFORE_EXCEPTION` reader
pub type R = crate::R<C0RE_0_LASTPC_BEFORE_EXCEPTION_SPEC>;
///Field `CORE_0_LASTPC_BEFORE_EXC` reader - reg_core_0_lastpc_before_exc
pub type CORE_0_LASTPC_BEFORE_EXC_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - reg_core_0_lastpc_before_exc
    #[inline(always)]
...
///`read()` method returns [`c0re_0_lastpc_before_exception::R`](R) reader structure
impl crate::Readable for C0RE_0_LASTPC_BEFORE_EXCEPTION_SPEC {}
///`reset()` method sets C0RE_0_LASTPC_BEFORE_EXCEPTION to value 0
