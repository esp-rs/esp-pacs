///Register `CORE_0_DRAM0_EXCEPTION_MONITOR_2` reader
pub type R = crate::R<CORE_0_DRAM0_EXCEPTION_MONITOR_2_SPEC>;
///Field `CORE_0_DRAM0_RECORDING_ADDR_1` reader - reg_core_0_dram0_recording_addr_1
pub type CORE_0_DRAM0_RECORDING_ADDR_1_R = crate::FieldReader<u32>;
///Field `CORE_0_DRAM0_RECORDING_WR_1` reader - reg_core_0_dram0_recording_wr_1
pub type CORE_0_DRAM0_RECORDING_WR_1_R = crate::BitReader;
///Field `CORE_0_DRAM0_RECORDING_BYTEEN_1` reader - reg_core_0_dram0_recording_byteen_1
pub type CORE_0_DRAM0_RECORDING_BYTEEN_1_R = crate::FieldReader;
impl R {
    ///Bits 0:23 - reg_core_0_dram0_recording_addr_1
    #[inline(always)]
...
///`read()` method returns [`core_0_dram0_exception_monitor_2::R`](R) reader structure
