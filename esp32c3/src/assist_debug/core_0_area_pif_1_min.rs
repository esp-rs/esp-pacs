...
///Field `CORE_0_AREA_PIF_1_MIN` reader - reg_core_0_area_pif_1_min
pub type CORE_0_AREA_PIF_1_MIN_R = crate::FieldReader<u32>;
///Field `CORE_0_AREA_PIF_1_MIN` writer - reg_core_0_area_pif_1_min
pub type CORE_0_AREA_PIF_1_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - reg_core_0_area_pif_1_min
    #[inline(always)]
