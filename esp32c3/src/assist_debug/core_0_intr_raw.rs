    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_INTR_RAW")
            .field(
                ...
                &self.core_0_area_dram0_0_rd_raw().bit(),
            )
            .field(
                "core_0_area_dram0_0_wr_raw",
                &self.core_0_area_dram0_0_wr_raw().bit(),
            )
            .field(
                "core_0_area_dram0_1_rd_raw",
                &self.core_0_area_dram0_1_rd_raw().bit(),
            )
            .field(
                "core_0_area_dram0_1_wr_raw",
                &self.core_0_area_dram0_1_wr_raw().bit(),
            )
            .field(
                "core_0_area_pif_0_rd_raw",
                &self.core_0_area_pif_0_rd_raw().bit(),
            )
            .field(
                "core_0_area_pif_0_wr_raw",
                &self.core_0_area_pif_0_wr_raw().bit(),
            )
            .field(
                "core_0_area_pif_1_rd_raw",
                &self.core_0_area_pif_1_rd_raw().bit(),
            )
            .field(
                "core_0_area_pif_1_wr_raw",
                &self.core_0_area_pif_1_wr_raw().bit(),
            )
            .field(
            ...
            .field(
                ...
                &self.core_0_iram0_exception_monitor_raw().bit(),
            )
            .field(
                "core_0_dram0_exception_monitor_raw",
                &self.core_0_dram0_exception_monitor_raw().bit(),
            )
            .finish()
    }
}
