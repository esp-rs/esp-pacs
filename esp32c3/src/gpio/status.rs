...
///Field `INTERRUPT` reader - GPIO interrupt status register for GPIO0-25
pub type INTERRUPT_R = crate::FieldReader<u32>;
///Field `INTERRUPT` writer - GPIO interrupt status register for GPIO0-25
pub type INTERRUPT_W<'a, REG> = crate::FieldWriter<'a, REG, 26, u32>;
impl R {
    ///Bits 0:25 - GPIO interrupt status register for GPIO0-25
    #[inline(always)]
