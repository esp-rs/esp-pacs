///Register `RX_MESSAGE_CNT` reader
pub type R = crate::R<RX_MESSAGE_CNT_SPEC>;
///Field `RX_MESSAGE_COUNTER` reader - This register reflects the number of messages available within the RX FIFO.
pub type RX_MESSAGE_COUNTER_R = crate::FieldReader;
impl R {
    ///Bits 0:6 - This register reflects the number of messages available within the RX FIFO.
    #[inline(always)]
...
///`read()` method returns [`rx_message_cnt::R`](R) reader structure
