...
impl R {
    ...
    ///Bits 6:7 - This register contains information about error types: 00: bit error; 01: form error; 10: stuff error; 11: other type of error
    #[inline(always)]
...
///`read()` method returns [`err_code_cap::R`](R) reader structure
