...
impl RegisterBlock {
    ...
    ///0x10 - RMT_CH0CONF0_REG.
    #[inline(always)]
    pub const fn ch0_tx_conf0(&self) -> &CH_TX_CONF0 {
        self.ch_tx_conf0(0)
    }
    ///0x14 - RMT_CH1CONF1_REG.
    #[inline(always)]
    ...
    ///0x24 - RMT_CH2CONF1_REG.
    #[inline(always)]
    pub const fn ch3_rx_conf1(&self) -> &CH_RX_CONF1 {
        self.ch_rx_conf1(1)
    }
    ///0x28..0x30 - RMT_CH%sSTATUS_REG.
    #[inline(always)]
    ...
    ///0x40 - RMT_INT_ENA_REG.
    #[inline(always)]
    pub const fn int_ena(&self) -> &INT_ENA {
        &self.int_ena
    }
    ///0x44 - RMT_INT_CLR_REG.
    #[inline(always)]
    pub const fn int_clr(&self) -> &INT_CLR {
        &self.int_clr
    }
    ///0x48..0x50 - RMT_CH%sCARRIER_DUTY_REG.
    #[inline(always)]
...
///RMT_CH%sDATA_REG.
pub mod chdata;
/**CH_TX_CONF0 (rw) register accessor: RMT_CH%sCONF%s_REG.
...
///RMT_CH%sCONF%s_REG.
pub mod ch_tx_conf0;
/**CH_RX_CONF0 (rw) register accessor: RMT_CH2CONF0_REG.
...
///RMT_CH2CONF0_REG.
pub mod ch_rx_conf0;
/**CH_RX_CONF1 (rw) register accessor: RMT_CH2CONF1_REG.
...
///RMT_CH2CONF1_REG.
pub mod ch_rx_conf1;
/**CH_TX_STATUS (r) register accessor: RMT_CH%sSTATUS_REG.
...
/**INT_RAW (rw) register accessor: RMT_INT_RAW_REG.
...
///RMT_INT_RAW_REG.
pub mod int_raw;
/**INT_ST (r) register accessor: RMT_INT_ST_REG.
...
///RMT_INT_ST_REG.
pub mod int_st;
/**INT_ENA (rw) register accessor: RMT_INT_ENA_REG.
...
///RMT_INT_ENA_REG.
pub mod int_ena;
/**INT_CLR (w) register accessor: RMT_INT_CLR_REG.
...
///RMT_INT_CLR_REG.
pub mod int_clr;
/**CHCARRIER_DUTY (rw) register accessor: RMT_CH%sCARRIER_DUTY_REG.
...
/**CH_RX_CARRIER_RM (rw) register accessor: RMT_CH2_RX_CARRIER_RM_REG.
...
/**CH_TX_LIM (rw) register accessor: RMT_CH%s_TX_LIM_REG.
...
///RMT_CH%s_TX_LIM_REG.
pub mod ch_tx_lim;
/**CH_RX_LIM (rw) register accessor: RMT_CH2_RX_LIM_REG.
...
///RMT_CH2_RX_LIM_REG.
pub mod ch_rx_lim;
/**SYS_CONF (rw) register accessor: RMT_SYS_CONF_REG.
...
///RMT_TX_SIM_REG.
pub mod tx_sim;
/**REF_CNT_RST (w) register accessor: RMT_REF_CNT_RST_REG.
...
///RMT_REF_CNT_RST_REG.
pub mod ref_cnt_rst;
/**DATE (rw) register accessor: RMT_DATE_REG.
