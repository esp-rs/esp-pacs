#[doc = "Register `RX_CH0CONF1` reader"]
pub struct R(crate::R<RX_CH0CONF1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RX_CH0CONF1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RX_CH0CONF1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RX_CH0CONF1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RX_CH0CONF1` writer"]
pub struct W(crate::W<RX_CH0CONF1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RX_CH0CONF1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RX_CH0CONF1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RX_CH0CONF1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RX_EN_W<'a, const O: u8> = crate::BitWriter<'a, RX_CH0CONF1_SPEC, O>;
#[doc = "Field `MEM_WR_RST` writer - reg_mem_wr_rst_ch2."]
pub type MEM_WR_RST_W<'a, const O: u8> = crate::BitWriter<'a, RX_CH0CONF1_SPEC, O>;
#[doc = "Field `APB_MEM_RST` writer - reg_apb_mem_rst_ch2."]
pub type APB_MEM_RST_W<'a, const O: u8> = crate::BitWriter<'a, RX_CH0CONF1_SPEC, O>;
...
pub type MEM_OWNER_W<'a, const O: u8> = crate::BitWriter<'a, RX_CH0CONF1_SPEC, O>;
...
pub type RX_FILTER_EN_W<'a, const O: u8> = crate::BitWriter<'a, RX_CH0CONF1_SPEC, O>;
...
pub type RX_FILTER_THRES_W<'a, const O: u8> = crate::FieldWriter<'a, RX_CH0CONF1_SPEC, 8, O>;
...
pub type MEM_RX_WRAP_EN_W<'a, const O: u8> = crate::BitWriter<'a, RX_CH0CONF1_SPEC, O>;
#[doc = "Field `AFIFO_RST` writer - reg_afifo_rst_ch2."]
pub type AFIFO_RST_W<'a, const O: u8> = crate::BitWriter<'a, RX_CH0CONF1_SPEC, O>;
#[doc = "Field `CONF_UPDATE` writer - reg_conf_update_ch2."]
pub type CONF_UPDATE_W<'a, const O: u8> = crate::BitWriter<'a, RX_CH0CONF1_SPEC, O>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RX_CH0CONF1_SPEC> {
...
#[doc = "RMT_CH2CONF1_REG.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rx_ch0conf1](index.html) module"]
pub struct RX_CH0CONF1_SPEC;
impl crate::RegisterSpec for RX_CH0CONF1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rx_ch0conf1::R](R) reader structure"]
impl crate::Readable for RX_CH0CONF1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rx_ch0conf1::W](W) writer structure"]
impl crate::Writable for RX_CH0CONF1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RX_CH0CONF1 to value 0x01e8"]
impl crate::Resettable for RX_CH0CONF1_SPEC {
