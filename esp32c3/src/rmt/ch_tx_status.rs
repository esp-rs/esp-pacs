...
///Field `MEM_RADDR_EX` reader - reg_mem_raddr_ex_ch0.
pub type MEM_RADDR_EX_R = crate::FieldReader<u16>;
///Field `STATE` reader - reg_state_ch0.
pub type STATE_R = crate::FieldReader;
///Field `APB_MEM_WADDR` reader - reg_apb_mem_waddr_ch0.
pub type APB_MEM_WADDR_R = crate::FieldReader<u16>;
///Field `APB_MEM_RD_ERR` reader - reg_apb_mem_rd_err_ch0.
pub type APB_MEM_RD_ERR_R = crate::BitReader;
///Field `MEM_EMPTY` reader - reg_mem_empty_ch0.
pub type MEM_EMPTY_R = crate::BitReader;
///Field `APB_MEM_WR_ERR` reader - reg_apb_mem_wr_err_ch0.
pub type APB_MEM_WR_ERR_R = crate::BitReader;
///Field `APB_MEM_RADDR` reader - reg_apb_mem_raddr_ch0.
