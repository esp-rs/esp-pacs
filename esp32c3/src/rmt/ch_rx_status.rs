...
///Field `MEM_WADDR_EX` reader - reg_mem_waddr_ex_ch2.
pub type MEM_WADDR_EX_R = crate::FieldReader<u16>;
///Field `APB_MEM_RADDR` reader - reg_apb_mem_raddr_ch2.
pub type APB_MEM_RADDR_R = crate::FieldReader<u16>;
///Field `STATE` reader - reg_state_ch2.
pub type STATE_R = crate::FieldReader;
///Field `MEM_OWNER_ERR` reader - reg_mem_owner_err_ch2.
pub type MEM_OWNER_ERR_R = crate::BitReader;
///Field `MEM_FULL` reader - reg_mem_full_ch2.
pub type MEM_FULL_R = crate::BitReader;
///Field `APB_MEM_RD_ERR` reader - reg_apb_mem_rd_err_ch2.
