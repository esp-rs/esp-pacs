...
///Field `TX_LIM` reader - reg_rmt_tx_lim_ch0.
pub type TX_LIM_R = crate::FieldReader<u16>;
///Field `TX_LIM` writer - reg_rmt_tx_lim_ch0.
pub type TX_LIM_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `TX_LOOP_NUM` reader - reg_rmt_tx_loop_num_ch0.
pub type TX_LOOP_NUM_R = crate::FieldReader<u16>;
///Field `TX_LOOP_NUM` writer - reg_rmt_tx_loop_num_ch0.
pub type TX_LOOP_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `TX_LOOP_CNT_EN` reader - reg_rmt_tx_loop_cnt_en_ch0.
pub type TX_LOOP_CNT_EN_R = crate::BitReader;
///Field `TX_LOOP_CNT_EN` writer - reg_rmt_tx_loop_cnt_en_ch0.
pub type TX_LOOP_CNT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOOP_COUNT_RESET` writer - reg_loop_count_reset_ch0.
