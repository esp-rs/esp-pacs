...
///Field `APB_FIFO_MASK` reader - reg_apb_fifo_mask.
pub type APB_FIFO_MASK_R = crate::BitReader;
///Field `APB_FIFO_MASK` writer - reg_apb_fifo_mask.
pub type APB_FIFO_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_CLK_FORCE_ON` reader - reg_mem_clk_force_on.
pub type MEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `MEM_CLK_FORCE_ON` writer - reg_mem_clk_force_on.
pub type MEM_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_FORCE_PD` reader - reg_rmt_mem_force_pd.
pub type MEM_FORCE_PD_R = crate::BitReader;
///Field `MEM_FORCE_PD` writer - reg_rmt_mem_force_pd.
pub type MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_FORCE_PU` reader - reg_rmt_mem_force_pu.
pub type MEM_FORCE_PU_R = crate::BitReader;
///Field `MEM_FORCE_PU` writer - reg_rmt_mem_force_pu.
pub type MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCLK_DIV_NUM` reader - reg_rmt_sclk_div_num.
pub type SCLK_DIV_NUM_R = crate::FieldReader;
///Field `SCLK_DIV_NUM` writer - reg_rmt_sclk_div_num.
pub type SCLK_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SCLK_DIV_A` reader - reg_rmt_sclk_div_a.
pub type SCLK_DIV_A_R = crate::FieldReader;
///Field `SCLK_DIV_A` writer - reg_rmt_sclk_div_a.
pub type SCLK_DIV_A_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `SCLK_DIV_B` reader - reg_rmt_sclk_div_b.
pub type SCLK_DIV_B_R = crate::FieldReader;
///Field `SCLK_DIV_B` writer - reg_rmt_sclk_div_b.
pub type SCLK_DIV_B_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `SCLK_SEL` reader - reg_rmt_sclk_sel.
pub type SCLK_SEL_R = crate::FieldReader;
///Field `SCLK_SEL` writer - reg_rmt_sclk_sel.
pub type SCLK_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SCLK_ACTIVE` reader - reg_rmt_sclk_active.
pub type SCLK_ACTIVE_R = crate::BitReader;
///Field `SCLK_ACTIVE` writer - reg_rmt_sclk_active.
...
///`read()` method returns [`sys_conf::R`](R) reader structure
impl crate::Readable for SYS_CONF_SPEC {}
///`write(|w| ..)` method takes [`sys_conf::W`](W) writer structure
