...
///Field `CH_TX_END(0-1)` writer - reg_ch%s_tx_end_int_clr.
pub type CH_TX_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_RX_END(2-3)` writer - reg_ch2_rx_end_int_clr.
pub type CH_RX_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_TX_ERR(0-1)` writer - reg_ch%s_err_int_clr.
pub type CH_TX_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_RX_ERR(2-3)` writer - reg_ch2_err_int_clr.
pub type CH_RX_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_TX_THR_EVENT(0-1)` writer - reg_ch%s_tx_thr_event_int_clr.
pub type CH_TX_THR_EVENT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_RX_THR_EVENT(2-3)` writer - reg_ch2_rx_thr_event_int_clr.
pub type CH_RX_THR_EVENT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_TX_LOOP(0-1)` writer - reg_ch%s_tx_loop_int_clr.
