...
pub type RX_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2CONF1_SPEC, bool, O>;
#[doc = "Field `MEM_WR_RST` writer - reg_mem_wr_rst_ch2."]
pub type MEM_WR_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2CONF1_SPEC, bool, O>;
#[doc = "Field `APB_MEM_RST` writer - reg_apb_mem_rst_ch2."]
pub type APB_MEM_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2CONF1_SPEC, bool, O>;
...
pub type MEM_OWNER_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2CONF1_SPEC, bool, O>;
...
pub type RX_FILTER_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2CONF1_SPEC, bool, O>;
...
pub type RX_FILTER_THRES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH2CONF1_SPEC, u8, u8, 8, O>;
...
pub type MEM_RX_WRAP_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2CONF1_SPEC, bool, O>;
#[doc = "Field `AFIFO_RST` writer - reg_afifo_rst_ch2."]
pub type AFIFO_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2CONF1_SPEC, bool, O>;
#[doc = "Field `CONF_UPDATE` writer - reg_conf_update_ch2."]
pub type CONF_UPDATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH2CONF1_SPEC, bool, O>;
impl R {
