...
///Field `RX_EN` reader - reg_rx_en_ch2.
pub type RX_EN_R = crate::BitReader;
///Field `RX_EN` writer - reg_rx_en_ch2.
pub type RX_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_WR_RST` writer - reg_mem_wr_rst_ch2.
pub type MEM_WR_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APB_MEM_RST` writer - reg_apb_mem_rst_ch2.
pub type APB_MEM_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_OWNER` reader - reg_mem_owner_ch2.
pub type MEM_OWNER_R = crate::BitReader;
///Field `MEM_OWNER` writer - reg_mem_owner_ch2.
pub type MEM_OWNER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_FILTER_EN` reader - reg_rx_filter_en_ch2.
pub type RX_FILTER_EN_R = crate::BitReader;
///Field `RX_FILTER_EN` writer - reg_rx_filter_en_ch2.
pub type RX_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_FILTER_THRES` reader - reg_rx_filter_thres_ch2.
pub type RX_FILTER_THRES_R = crate::FieldReader;
///Field `RX_FILTER_THRES` writer - reg_rx_filter_thres_ch2.
pub type RX_FILTER_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `MEM_RX_WRAP_EN` reader - reg_mem_rx_wrap_en_ch2.
pub type MEM_RX_WRAP_EN_R = crate::BitReader;
///Field `MEM_RX_WRAP_EN` writer - reg_mem_rx_wrap_en_ch2.
pub type MEM_RX_WRAP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AFIFO_RST` writer - reg_afifo_rst_ch2.
pub type AFIFO_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CONF_UPDATE` writer - reg_conf_update_ch2.
