...
///Field `XPD_WAIT` reader - the time that power up tsens need wait
pub type XPD_WAIT_R = crate::FieldReader<u16>;
///Field `XPD_WAIT` writer - the time that power up tsens need wait
pub type XPD_WAIT_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `XPD_FORCE` reader - force power up tsens
pub type XPD_FORCE_R = crate::FieldReader;
///Field `XPD_FORCE` writer - force power up tsens
pub type XPD_FORCE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CLK_INV` reader - inv tsens clk
pub type CLK_INV_R = crate::BitReader;
///Field `CLK_INV` writer - inv tsens clk
pub type CLK_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_SEL` reader - tsens clk select
pub type CLK_SEL_R = crate::BitReader;
///Field `CLK_SEL` writer - tsens clk select
...
///`read()` method returns [`tsens_ctrl2::R`](R) reader structure
impl crate::Readable for TSENS_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`tsens_ctrl2::W`](W) writer structure
