...
/**MAC_INTR_MAP (rw) register accessor: mac intr map register
...
/**MAC_NMI_MAP (rw) register accessor: mac nmi_intr map register
...
pub mod mac_nmi_map;
/**PWR_INTR_MAP (rw) register accessor: pwr intr map register
...
/**BB_INT_MAP (rw) register accessor: bb intr map register
...
pub mod bb_int_map;
/**BT_MAC_INT_MAP (rw) register accessor: bt intr map register
...
/**BT_BB_INT_MAP (rw) register accessor: bb_bt intr map register
...
/**BT_BB_NMI_MAP (rw) register accessor: bb_bt_nmi intr map register
...
/**RWBT_IRQ_MAP (rw) register accessor: rwbt intr map register
...
/**RWBLE_IRQ_MAP (rw) register accessor: rwble intr map register
...
/**RWBT_NMI_MAP (rw) register accessor: rwbt_nmi intr map register
...
/**RWBLE_NMI_MAP (rw) register accessor: rwble_nmi intr map register
...
/**SLC0_INTR_MAP (rw) register accessor: slc0 intr map register
...
/**SLC1_INTR_MAP (rw) register accessor: slc1 intr map register
...
/**APB_CTRL_INTR_MAP (rw) register accessor: apb_ctrl intr map register
...
/**UHCI0_INTR_MAP (rw) register accessor: uchi0 intr map register
...
/**GPIO_INTERRUPT_PRO_MAP (rw) register accessor: gpio intr map register
...
/**GPIO_INTERRUPT_PRO_NMI_MAP (rw) register accessor: gpio_pro intr map register
...
/**SPI_INTR_1_MAP (rw) register accessor: gpio_pro_nmi intr map register
...
/**SPI_INTR_2_MAP (rw) register accessor: spi1 intr map register
...
/**I2S1_INT_MAP (rw) register accessor: spi2 intr map register
...
/**UART_INTR_MAP (rw) register accessor: i2s1 intr map register
...
/**UART1_INTR_MAP (rw) register accessor: uart1 intr map register
...
/**LEDC_INT_MAP (rw) register accessor: ledc intr map register
...
/**CAN_INT_MAP (rw) register accessor: can intr map register
...
pub mod can_int_map;
/**USB_INTR_MAP (rw) register accessor: usb intr map register
...
/**RTC_CORE_INTR_MAP (rw) register accessor: rtc intr map register
...
/**RMT_INTR_MAP (rw) register accessor: rmt intr map register
...
/**I2C_EXT0_INTR_MAP (rw) register accessor: i2c intr map register
...
/**TIMER_INT1_MAP (rw) register accessor: timer1 intr map register
...
/**TIMER_INT2_MAP (rw) register accessor: timer2 intr map register
...
/**TG_T0_INT_MAP (rw) register accessor: tg to intr map register
...
/**TG_WDT_INT_MAP (rw) register accessor: tg wdt intr map register
...
/**TG1_T0_INT_MAP (rw) register accessor: tg1 to intr map register
...
/**TG1_WDT_INT_MAP (rw) register accessor: tg1 wdt intr map register
...
/**CACHE_IA_INT_MAP (rw) register accessor: cache ia intr map register
...
/**SYSTIMER_TARGET0_INT_MAP (rw) register accessor: systimer intr map register
...
/**SYSTIMER_TARGET1_INT_MAP (rw) register accessor: systimer target1 intr map register
...
/**SYSTIMER_TARGET2_INT_MAP (rw) register accessor: systimer target2 intr map register
...
/**SPI_MEM_REJECT_INTR_MAP (rw) register accessor: spi mem reject intr map register
...
/**ICACHE_PRELOAD_INT_MAP (rw) register accessor: icache perload intr map register
...
/**ICACHE_SYNC_INT_MAP (rw) register accessor: icache sync intr map register
...
/**APB_ADC_INT_MAP (rw) register accessor: adc intr map register
...
/**DMA_CH0_INT_MAP (rw) register accessor: dma ch0 intr map register
...
/**DMA_CH1_INT_MAP (rw) register accessor: dma ch1 intr map register
...
/**DMA_CH2_INT_MAP (rw) register accessor: dma ch2 intr map register
...
/**RSA_INT_MAP (rw) register accessor: rsa intr map register
...
pub mod rsa_int_map;
/**AES_INT_MAP (rw) register accessor: aes intr map register
...
pub mod aes_int_map;
/**SHA_INT_MAP (rw) register accessor: sha intr map register
...
pub mod sha_int_map;
/**CPU_INTR_FROM_CPU_0_MAP (rw) register accessor: cpu from cpu 0 intr map register
...
/**CPU_INTR_FROM_CPU_1_MAP (rw) register accessor: cpu from cpu 0 intr map register
...
/**CPU_INTR_FROM_CPU_2_MAP (rw) register accessor: cpu from cpu 1 intr map register
...
/**CPU_INTR_FROM_CPU_3_MAP (rw) register accessor: cpu from cpu 3 intr map register
...
/**ASSIST_DEBUG_INTR_MAP (rw) register accessor: assist debug intr map register
...
/**DMA_APBPERI_PMS_MONITOR_VIOLATE_INTR_MAP (rw) register accessor: dma pms violatile intr map register
...
/**CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP (rw) register accessor: iram0 pms violatile intr map register
...
/**CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_MAP (rw) register accessor: mac intr map register
...
/**CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP (rw) register accessor: mac intr map register
...
/**CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP (rw) register accessor: mac intr map register
...
/**BACKUP_PMS_VIOLATE_INTR_MAP (rw) register accessor: mac intr map register
...
/**CACHE_CORE0_ACS_INT_MAP (rw) register accessor: mac intr map register
...
/**CPU_INT_EIP_STATUS (r) register accessor: mac intr map register
...
/**INTERRUPT_REG_DATE (rw) register accessor: mac intr map register
