...
pub type OUT_CHECK_OWNER_CH1_R = crate::BitReader<bool>;
#[doc = "Field `OUT_CHECK_OWNER_CH1` writer - Set this bit to enable checking the owner attribute of the link descriptor."]
pub type OUT_CHECK_OWNER_CH1_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, OUT_CONF1_CH1_SPEC, bool, O>;
impl R {
...
impl W {
    #[doc = "Bit 12 - Set this bit to enable checking the owner attribute of the link descriptor."]
    #[inline(always)]
    pub fn out_check_owner_ch1(&mut self) -> OUT_CHECK_OWNER_CH1_W<12> {
        OUT_CHECK_OWNER_CH1_W::new(self)
    }
