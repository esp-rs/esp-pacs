...
///Field `DATE` reader - register version.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - register version.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - register version.
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x0200_8250
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0200_8250;
}
