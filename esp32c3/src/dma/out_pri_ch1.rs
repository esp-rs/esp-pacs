...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_pri(&mut self) -> TX_PRI_W<OUT_PRI_CH1_SPEC, 0> {
        TX_PRI_W::new(self)
    }
...
#[doc = "DMA_OUT_PRI_CH1_REG.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`out_pri_ch1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`out_pri_ch1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
