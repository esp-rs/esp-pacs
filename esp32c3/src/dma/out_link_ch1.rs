...
pub type OUTLINK_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, OUT_LINK_CH1_SPEC, 20, O, u32>;
...
pub type OUTLINK_STOP_W<'a, const O: u8> = crate::BitWriter<'a, OUT_LINK_CH1_SPEC, O>;
...
pub type OUTLINK_START_W<'a, const O: u8> = crate::BitWriter<'a, OUT_LINK_CH1_SPEC, O>;
...
pub type OUTLINK_RESTART_W<'a, const O: u8> = crate::BitWriter<'a, OUT_LINK_CH1_SPEC, O>;
