...
pub type OUT_RST_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CONF0_CH2_SPEC, O>;
#[doc = "Field `OUT_LOOP_TEST` reader - reserved"]
pub type OUT_LOOP_TEST_R = crate::BitReader;
#[doc = "Field `OUT_LOOP_TEST` writer - reserved"]
pub type OUT_LOOP_TEST_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CONF0_CH2_SPEC, O>;
...
pub type OUT_AUTO_WRBACK_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CONF0_CH2_SPEC, O>;
...
pub type OUT_EOF_MODE_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CONF0_CH2_SPEC, O>;
...
pub type OUTDSCR_BURST_EN_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CONF0_CH2_SPEC, O>;
...
pub type OUT_DATA_BURST_EN_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CONF0_CH2_SPEC, O>;
impl R {
