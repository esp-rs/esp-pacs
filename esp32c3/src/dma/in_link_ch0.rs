...
pub type INLINK_ADDR_CH0_W<'a, const O: u8> =
...
pub type INLINK_AUTO_RET_CH0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, IN_LINK_CH0_SPEC, bool, O>;
...
pub type INLINK_STOP_CH0_W<'a, const O: u8> = crate::BitWriter<'a, u32, IN_LINK_CH0_SPEC, bool, O>;
...
pub type INLINK_START_CH0_W<'a, const O: u8> = crate::BitWriter<'a, u32, IN_LINK_CH0_SPEC, bool, O>;
...
pub type INLINK_RESTART_CH0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, IN_LINK_CH0_SPEC, bool, O>;
...
impl W {
    #[doc = "Bits 0:19 - This register stores the 20 least significant bits of the first inlink descriptor's address."]
    #[inline(always)]
    pub fn inlink_addr_ch0(&mut self) -> INLINK_ADDR_CH0_W<0> {
        INLINK_ADDR_CH0_W::new(self)
    }
    #[doc = "Bit 20 - Set this bit to return to current inlink descriptor's address, when there are some errors in current receiving data."]
    #[inline(always)]
    pub fn inlink_auto_ret_ch0(&mut self) -> INLINK_AUTO_RET_CH0_W<20> {
        INLINK_AUTO_RET_CH0_W::new(self)
    }
    #[doc = "Bit 21 - Set this bit to stop dealing with the inlink descriptors."]
    #[inline(always)]
    pub fn inlink_stop_ch0(&mut self) -> INLINK_STOP_CH0_W<21> {
        INLINK_STOP_CH0_W::new(self)
    }
    #[doc = "Bit 22 - Set this bit to start dealing with the inlink descriptors."]
    #[inline(always)]
    pub fn inlink_start_ch0(&mut self) -> INLINK_START_CH0_W<22> {
        INLINK_START_CH0_W::new(self)
    }
    #[doc = "Bit 23 - Set this bit to mount a new inlink descriptor."]
    #[inline(always)]
    pub fn inlink_restart_ch0(&mut self) -> INLINK_RESTART_CH0_W<23> {
