...
pub type INLINK_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, IN_LINK_CH1_SPEC, 20, O, u32, u32>;
...
pub type INLINK_AUTO_RET_W<'a, const O: u8> = crate::BitWriter<'a, IN_LINK_CH1_SPEC, O>;
...
pub type INLINK_STOP_W<'a, const O: u8> = crate::BitWriter<'a, IN_LINK_CH1_SPEC, O>;
...
pub type INLINK_START_W<'a, const O: u8> = crate::BitWriter<'a, IN_LINK_CH1_SPEC, O>;
...
pub type INLINK_RESTART_W<'a, const O: u8> = crate::BitWriter<'a, IN_LINK_CH1_SPEC, O>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<IN_LINK_CH1_SPEC> {
