...
#[doc = "Field `PERI_IN_SEL_CH1` reader - This register is used to select peripheral for Rx channel 1. 0:SPI2. 1: reserved. 2: UHCI0. 3: I2S0. 4: reserved. 5: reserved. 6: AES. 7: SHA. 8: ADC_DAC."]
pub type PERI_IN_SEL_CH1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PERI_IN_SEL_CH1` writer - This register is used to select peripheral for Rx channel 1. 0:SPI2. 1: reserved. 2: UHCI0. 3: I2S0. 4: reserved. 5: reserved. 6: AES. 7: SHA. 8: ADC_DAC."]
pub type PERI_IN_SEL_CH1_W<'a, const O: u8> =
...
impl W {
    #[doc = "Bits 0:5 - This register is used to select peripheral for Rx channel 1. 0:SPI2. 1: reserved. 2: UHCI0. 3: I2S0. 4: reserved. 5: reserved. 6: AES. 7: SHA. 8: ADC_DAC."]
    #[inline(always)]
    pub fn peri_in_sel_ch1(&mut self) -> PERI_IN_SEL_CH1_W<0> {
        PERI_IN_SEL_CH1_W::new(self)
    }
