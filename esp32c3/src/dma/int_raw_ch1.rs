...
pub type IN_DONE_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type IN_SUC_EOF_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type IN_ERR_EOF_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type OUT_DONE_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type OUT_EOF_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type IN_DSCR_ERR_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type OUT_DSCR_ERR_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type IN_DSCR_EMPTY_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type OUT_TOTAL_EOF_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type INFIFO_OVF_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type INFIFO_UDF_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type OUTFIFO_OVF_CH1_INT_RAW_R = crate::BitReader<bool>;
...
pub type OUTFIFO_UDF_CH1_INT_RAW_R = crate::BitReader<bool>;
impl R {
    ...
    pub fn out_done_ch1_int_raw(&self) -> OUT_DONE_CH1_INT_RAW_R {
        OUT_DONE_CH1_INT_RAW_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn out_eof_ch1_int_raw(&self) -> OUT_EOF_CH1_INT_RAW_R {
        OUT_EOF_CH1_INT_RAW_R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    pub fn in_dscr_err_ch1_int_raw(&self) -> IN_DSCR_ERR_CH1_INT_RAW_R {
        IN_DSCR_ERR_CH1_INT_RAW_R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    pub fn out_dscr_err_ch1_int_raw(&self) -> OUT_DSCR_ERR_CH1_INT_RAW_R {
        OUT_DSCR_ERR_CH1_INT_RAW_R::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    pub fn in_dscr_empty_ch1_int_raw(&self) -> IN_DSCR_EMPTY_CH1_INT_RAW_R {
        IN_DSCR_EMPTY_CH1_INT_RAW_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    pub fn out_total_eof_ch1_int_raw(&self) -> OUT_TOTAL_EOF_CH1_INT_RAW_R {
        OUT_TOTAL_EOF_CH1_INT_RAW_R::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    pub fn infifo_ovf_ch1_int_raw(&self) -> INFIFO_OVF_CH1_INT_RAW_R {
        INFIFO_OVF_CH1_INT_RAW_R::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    pub fn infifo_udf_ch1_int_raw(&self) -> INFIFO_UDF_CH1_INT_RAW_R {
        INFIFO_UDF_CH1_INT_RAW_R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    pub fn outfifo_ovf_ch1_int_raw(&self) -> OUTFIFO_OVF_CH1_INT_RAW_R {
        OUTFIFO_OVF_CH1_INT_RAW_R::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn outfifo_udf_ch1_int_raw(&self) -> OUTFIFO_UDF_CH1_INT_RAW_R {
        OUTFIFO_UDF_CH1_INT_RAW_R::new(((self.bits >> 12) & 1) != 0)
    }
}
