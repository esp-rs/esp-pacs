...
#[doc = "Register `INT_RAW_CH1` writer"]
pub struct W(crate::W<INT_RAW_CH1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INT_RAW_CH1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INT_RAW_CH1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INT_RAW_CH1_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Field `IN_DONE` writer - The raw interrupt bit turns to high level when the last data pointed by one inlink descriptor has been received for Rx channel 1."]
pub type IN_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
pub type IN_SUC_EOF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `IN_ERR_EOF` writer - The raw interrupt bit turns to high level when data error is detected only in the case that the peripheral is UHCI0 for Rx channel 1. For other peripherals, this raw interrupt is reserved."]
pub type IN_ERR_EOF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `OUT_DONE` writer - The raw interrupt bit turns to high level when the last data pointed by one outlink descriptor has been transmitted to peripherals for Tx channel 1."]
pub type OUT_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `OUT_EOF` writer - The raw interrupt bit turns to high level when the last data pointed by one outlink descriptor has been read from memory for Tx channel 1."]
pub type OUT_EOF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `IN_DSCR_ERR` writer - The raw interrupt bit turns to high level when detecting inlink descriptor error, including owner error, the second and third word error of inlink descriptor for Rx channel 1."]
pub type IN_DSCR_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `OUT_DSCR_ERR` writer - The raw interrupt bit turns to high level when detecting outlink descriptor error, including owner error, the second and third word error of outlink descriptor for Tx channel 1."]
pub type OUT_DSCR_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `IN_DSCR_EMPTY` writer - The raw interrupt bit turns to high level when Rx buffer pointed by inlink is full and receiving data is not completed, but there is no more inlink for Rx channel 1."]
pub type IN_DSCR_EMPTY_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `OUT_TOTAL_EOF` writer - The raw interrupt bit turns to high level when data corresponding a outlink (includes one link descriptor or few link descriptors) is transmitted out for Tx channel 1."]
pub type OUT_TOTAL_EOF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `INFIFO_OVF` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 1 is overflow."]
pub type INFIFO_OVF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `INFIFO_UDF` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 1 is underflow."]
pub type INFIFO_UDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `OUTFIFO_OVF` writer - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 1 is overflow."]
pub type OUTFIFO_OVF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
...
#[doc = "Field `OUTFIFO_UDF` writer - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 1 is underflow."]
pub type OUTFIFO_UDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_CH1_SPEC, bool, O>;
impl R {
...
#[doc = "`write(|w| ..)` method takes [int_raw_ch1::W](W) writer structure"]
impl crate::Writable for INT_RAW_CH1_SPEC {
    type Writer = W;
