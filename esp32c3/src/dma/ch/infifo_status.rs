...
///Field `INFIFO_FULL` reader - L1 Rx FIFO full signal for Rx channel 0.
pub type INFIFO_FULL_R = crate::BitReader;
///Field `INFIFO_EMPTY` reader - L1 Rx FIFO empty signal for Rx channel 0.
pub type INFIFO_EMPTY_R = crate::BitReader;
///Field `INFIFO_CNT` reader - The register stores the byte number of the data in L1 Rx FIFO for Rx channel 0.
