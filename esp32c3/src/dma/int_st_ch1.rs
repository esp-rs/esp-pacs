...
pub type R = crate::R<INT_ST_CH1_SPEC>;
...
#[doc = "DMA_INT_ST_CH1_REG.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`int_st_ch1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
