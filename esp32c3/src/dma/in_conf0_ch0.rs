...
pub type IN_RST_W<'a, const O: u8> = crate::BitWriter<'a, IN_CONF0_CH0_SPEC, O>;
#[doc = "Field `IN_LOOP_TEST` reader - reserved"]
pub type IN_LOOP_TEST_R = crate::BitReader;
#[doc = "Field `IN_LOOP_TEST` writer - reserved"]
pub type IN_LOOP_TEST_W<'a, const O: u8> = crate::BitWriter<'a, IN_CONF0_CH0_SPEC, O>;
...
pub type INDSCR_BURST_EN_W<'a, const O: u8> = crate::BitWriter<'a, IN_CONF0_CH0_SPEC, O>;
...
pub type IN_DATA_BURST_EN_W<'a, const O: u8> = crate::BitWriter<'a, IN_CONF0_CH0_SPEC, O>;
...
pub type MEM_TRANS_EN_W<'a, const O: u8> = crate::BitWriter<'a, IN_CONF0_CH0_SPEC, O>;
impl R {
