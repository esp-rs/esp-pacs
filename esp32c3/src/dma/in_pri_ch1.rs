...
pub type R = crate::R<IN_PRI_CH1_SPEC>;
#[doc = "Register `IN_PRI_CH1` writer"]
pub type W = crate::W<IN_PRI_CH1_SPEC>;
#[doc = "Field `RX_PRI` reader - The priority of Rx channel 1. The larger of the value, the higher of the priority."]
pub type RX_PRI_R = crate::FieldReader;
#[doc = "Field `RX_PRI` writer - The priority of Rx channel 1. The larger of the value, the higher of the priority."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_PRI_CH1")
            .field("rx_pri", &format_args!("{}", self.rx_pri().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<IN_PRI_CH1_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_pri(&mut self) -> RX_PRI_W<IN_PRI_CH1_SPEC, 0> {
        RX_PRI_W::new(self)
    }
...
#[doc = "DMA_IN_PRI_CH1_REG.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`in_pri_ch1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`in_pri_ch1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
