...
pub type PERI_OUT_SEL_CH1_R = crate::FieldReader<u8, u8>;
...
pub type PERI_OUT_SEL_CH1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OUT_PERI_SEL_CH1_SPEC, u8, u8, 6, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:5 - This register is used to select peripheral for Tx channel 1. 0:SPI2. 1: reserved. 2: UHCI0. 3: I2S0. 4: reserved. 5: reserved. 6: AES. 7: SHA. 8: ADC_DAC."]
    #[inline(always)]
    pub fn peri_out_sel_ch1(&mut self) -> PERI_OUT_SEL_CH1_W<0> {
        PERI_OUT_SEL_CH1_W::new(self)
    }
