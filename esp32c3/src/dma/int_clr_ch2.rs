...
pub type W = crate::W<INT_CLR_CH2_SPEC>;
...
impl core::fmt::Debug for crate::generic::Reg<INT_CLR_CH2_SPEC> {
...
#[doc = "DMA_INT_CLR_CH2_REG.\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`int_clr_ch2::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
