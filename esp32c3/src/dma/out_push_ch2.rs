...
pub type OUTFIFO_WDATA_W<'a, const O: u8> = crate::FieldWriter<'a, OUT_PUSH_CH2_SPEC, 9, O, u16>;
...
pub type OUTFIFO_PUSH_W<'a, const O: u8> = crate::BitWriter<'a, OUT_PUSH_CH2_SPEC, O>;
impl R {
