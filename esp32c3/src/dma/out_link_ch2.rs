...
pub type OUTLINK_ADDR_CH2_R = crate::FieldReader<u32, u32>;
...
pub type OUTLINK_PARK_CH2_R = crate::BitReader<bool>;
impl R {
...
impl W {
    #[doc = "Bits 0:19 - This register stores the 20 least significant bits of the first outlink descriptor's address."]
    #[inline(always)]
    pub fn outlink_addr_ch2(&mut self) -> OUTLINK_ADDR_CH2_W<0> {
        OUTLINK_ADDR_CH2_W::new(self)
    }
    #[doc = "Bit 20 - Set this bit to stop dealing with the outlink descriptors."]
    #[inline(always)]
    pub fn outlink_stop_ch2(&mut self) -> OUTLINK_STOP_CH2_W<20> {
        OUTLINK_STOP_CH2_W::new(self)
    }
    #[doc = "Bit 21 - Set this bit to start dealing with the outlink descriptors."]
    #[inline(always)]
    pub fn outlink_start_ch2(&mut self) -> OUTLINK_START_CH2_W<21> {
        OUTLINK_START_CH2_W::new(self)
    }
    #[doc = "Bit 22 - Set this bit to restart a new outlink from the last address."]
    #[inline(always)]
    pub fn outlink_restart_ch2(&mut self) -> OUTLINK_RESTART_CH2_W<22> {
        OUTLINK_RESTART_CH2_W::new(self)
    }
