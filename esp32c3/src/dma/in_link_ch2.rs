...
pub type INLINK_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, IN_LINK_CH2_SPEC, 20, O, u32, u32>;
...
pub type INLINK_AUTO_RET_W<'a, const O: u8> = crate::BitWriter<'a, IN_LINK_CH2_SPEC, O>;
...
pub type INLINK_STOP_W<'a, const O: u8> = crate::BitWriter<'a, IN_LINK_CH2_SPEC, O>;
...
pub type INLINK_START_W<'a, const O: u8> = crate::BitWriter<'a, IN_LINK_CH2_SPEC, O>;
...
pub type INLINK_RESTART_W<'a, const O: u8> = crate::BitWriter<'a, IN_LINK_CH2_SPEC, O>;
