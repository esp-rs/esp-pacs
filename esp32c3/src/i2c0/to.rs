...
///Field `TIME_OUT_VALUE` reader - reg_time_out_value
pub type TIME_OUT_VALUE_R = crate::FieldReader;
///Field `TIME_OUT_VALUE` writer - reg_time_out_value
pub type TIME_OUT_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `TIME_OUT_EN` reader - reg_time_out_en
pub type TIME_OUT_EN_R = crate::BitReader;
///Field `TIME_OUT_EN` writer - reg_time_out_en
