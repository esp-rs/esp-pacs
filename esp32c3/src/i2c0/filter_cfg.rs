...
///Field `SCL_FILTER_THRES` reader - reg_scl_filter_thres
pub type SCL_FILTER_THRES_R = crate::FieldReader;
///Field `SCL_FILTER_THRES` writer - reg_scl_filter_thres
pub type SCL_FILTER_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SDA_FILTER_THRES` reader - reg_sda_filter_thres
pub type SDA_FILTER_THRES_R = crate::FieldReader;
///Field `SDA_FILTER_THRES` writer - reg_sda_filter_thres
pub type SDA_FILTER_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SCL_FILTER_EN` reader - reg_scl_filter_en
pub type SCL_FILTER_EN_R = crate::BitReader;
///Field `SCL_FILTER_EN` writer - reg_scl_filter_en
pub type SCL_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDA_FILTER_EN` reader - reg_sda_filter_en
pub type SDA_FILTER_EN_R = crate::BitReader;
///Field `SDA_FILTER_EN` writer - reg_sda_filter_en
