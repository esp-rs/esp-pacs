...
///Field `SDA_FORCE_OUT` reader - reg_sda_force_out
pub type SDA_FORCE_OUT_R = crate::BitReader;
///Field `SDA_FORCE_OUT` writer - reg_sda_force_out
pub type SDA_FORCE_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCL_FORCE_OUT` reader - reg_scl_force_out
pub type SCL_FORCE_OUT_R = crate::BitReader;
///Field `SCL_FORCE_OUT` writer - reg_scl_force_out
pub type SCL_FORCE_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAMPLE_SCL_LEVEL` reader - reg_sample_scl_level
pub type SAMPLE_SCL_LEVEL_R = crate::BitReader;
///Field `SAMPLE_SCL_LEVEL` writer - reg_sample_scl_level
pub type SAMPLE_SCL_LEVEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_FULL_ACK_LEVEL` reader - reg_rx_full_ack_level
pub type RX_FULL_ACK_LEVEL_R = crate::BitReader;
///Field `RX_FULL_ACK_LEVEL` writer - reg_rx_full_ack_level
pub type RX_FULL_ACK_LEVEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MS_MODE` reader - reg_ms_mode
pub type MS_MODE_R = crate::BitReader;
///Field `MS_MODE` writer - reg_ms_mode
pub type MS_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_START` writer - reg_trans_start
pub type TRANS_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_LSB_FIRST` reader - reg_tx_lsb_first
...
///Field `RX_LSB_FIRST` reader - reg_rx_lsb_first
pub type RX_LSB_FIRST_R = crate::BitReader;
///Field `RX_LSB_FIRST` writer - reg_rx_lsb_first
...
///Field `ARBITRATION_EN` reader - reg_arbitration_en
pub type ARBITRATION_EN_R = crate::BitReader;
///Field `ARBITRATION_EN` writer - reg_arbitration_en
pub type ARBITRATION_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FSM_RST` writer - reg_fsm_rst
pub type FSM_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CONF_UPGATE` writer - reg_conf_upgate
pub type CONF_UPGATE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_TX_AUTO_START_EN` reader - reg_slv_tx_auto_start_en
pub type SLV_TX_AUTO_START_EN_R = crate::BitReader;
///Field `SLV_TX_AUTO_START_EN` writer - reg_slv_tx_auto_start_en
pub type SLV_TX_AUTO_START_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADDR_10BIT_RW_CHECK_EN` reader - reg_addr_10bit_rw_check_en
pub type ADDR_10BIT_RW_CHECK_EN_R = crate::BitReader;
///Field `ADDR_10BIT_RW_CHECK_EN` writer - reg_addr_10bit_rw_check_en
pub type ADDR_10BIT_RW_CHECK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADDR_BROADCASTING_EN` reader - reg_addr_broadcasting_en
pub type ADDR_BROADCASTING_EN_R = crate::BitReader;
///Field `ADDR_BROADCASTING_EN` writer - reg_addr_broadcasting_en
