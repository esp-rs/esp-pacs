...
///Field `SCL_HIGH_PERIOD` reader - reg_scl_high_period
pub type SCL_HIGH_PERIOD_R = crate::FieldReader<u16>;
///Field `SCL_HIGH_PERIOD` writer - reg_scl_high_period
pub type SCL_HIGH_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `SCL_WAIT_HIGH_PERIOD` reader - reg_scl_wait_high_period
pub type SCL_WAIT_HIGH_PERIOD_R = crate::FieldReader;
///Field `SCL_WAIT_HIGH_PERIOD` writer - reg_scl_wait_high_period
