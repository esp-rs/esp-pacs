...
///Field `SCL_ST_TO_I2C` reader - reg_scl_st_to_regno more than 23
pub type SCL_ST_TO_I2C_R = crate::FieldReader;
///Field `SCL_ST_TO_I2C` writer - reg_scl_st_to_regno more than 23
pub type SCL_ST_TO_I2C_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_scl_st_to_regno more than 23
    #[inline(always)]
