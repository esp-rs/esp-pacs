...
///Field `RXFIFO_WM` reader - reg_rxfifo_wm_int_st
pub type RXFIFO_WM_R = crate::BitReader;
///Field `TXFIFO_WM` reader - reg_txfifo_wm_int_st
pub type TXFIFO_WM_R = crate::BitReader;
///Field `RXFIFO_OVF` reader - reg_rxfifo_ovf_int_st
pub type RXFIFO_OVF_R = crate::BitReader;
///Field `END_DETECT` reader - reg_end_detect_int_st
pub type END_DETECT_R = crate::BitReader;
///Field `BYTE_TRANS_DONE` reader - reg_byte_trans_done_int_st
pub type BYTE_TRANS_DONE_R = crate::BitReader;
///Field `ARBITRATION_LOST` reader - reg_arbitration_lost_int_st
pub type ARBITRATION_LOST_R = crate::BitReader;
///Field `MST_TXFIFO_UDF` reader - reg_mst_txfifo_udf_int_st
pub type MST_TXFIFO_UDF_R = crate::BitReader;
///Field `TRANS_COMPLETE` reader - reg_trans_complete_int_st
pub type TRANS_COMPLETE_R = crate::BitReader;
///Field `TIME_OUT` reader - reg_time_out_int_st
pub type TIME_OUT_R = crate::BitReader;
///Field `TRANS_START` reader - reg_trans_start_int_st
pub type TRANS_START_R = crate::BitReader;
///Field `NACK` reader - reg_nack_int_st
pub type NACK_R = crate::BitReader;
///Field `TXFIFO_OVF` reader - reg_txfifo_ovf_int_st
pub type TXFIFO_OVF_R = crate::BitReader;
///Field `RXFIFO_UDF` reader - reg_rxfifo_udf_int_st
pub type RXFIFO_UDF_R = crate::BitReader;
///Field `SCL_ST_TO` reader - reg_scl_st_to_int_st
pub type SCL_ST_TO_R = crate::BitReader;
///Field `SCL_MAIN_ST_TO` reader - reg_scl_main_st_to_int_st
pub type SCL_MAIN_ST_TO_R = crate::BitReader;
///Field `DET_START` reader - reg_det_start_int_st
pub type DET_START_R = crate::BitReader;
///Field `SLAVE_STRETCH` reader - reg_slave_stretch_int_st
pub type SLAVE_STRETCH_R = crate::BitReader;
///Field `GENERAL_CALL` reader - reg_general_call_int_st
