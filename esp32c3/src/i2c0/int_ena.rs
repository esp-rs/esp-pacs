...
///Field `RXFIFO_WM` reader - reg_rxfifo_wm_int_ena
pub type RXFIFO_WM_R = crate::BitReader;
///Field `RXFIFO_WM` writer - reg_rxfifo_wm_int_ena
pub type RXFIFO_WM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_WM` reader - reg_txfifo_wm_int_ena
pub type TXFIFO_WM_R = crate::BitReader;
///Field `TXFIFO_WM` writer - reg_txfifo_wm_int_ena
pub type TXFIFO_WM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_OVF` reader - reg_rxfifo_ovf_int_ena
pub type RXFIFO_OVF_R = crate::BitReader;
///Field `RXFIFO_OVF` writer - reg_rxfifo_ovf_int_ena
pub type RXFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `END_DETECT` reader - reg_end_detect_int_ena
pub type END_DETECT_R = crate::BitReader;
///Field `END_DETECT` writer - reg_end_detect_int_ena
pub type END_DETECT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BYTE_TRANS_DONE` reader - reg_byte_trans_done_int_ena
pub type BYTE_TRANS_DONE_R = crate::BitReader;
///Field `BYTE_TRANS_DONE` writer - reg_byte_trans_done_int_ena
pub type BYTE_TRANS_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ARBITRATION_LOST` reader - reg_arbitration_lost_int_ena
pub type ARBITRATION_LOST_R = crate::BitReader;
///Field `ARBITRATION_LOST` writer - reg_arbitration_lost_int_ena
pub type ARBITRATION_LOST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MST_TXFIFO_UDF` reader - reg_mst_txfifo_udf_int_ena
pub type MST_TXFIFO_UDF_R = crate::BitReader;
///Field `MST_TXFIFO_UDF` writer - reg_mst_txfifo_udf_int_ena
pub type MST_TXFIFO_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_COMPLETE` reader - reg_trans_complete_int_ena
pub type TRANS_COMPLETE_R = crate::BitReader;
///Field `TRANS_COMPLETE` writer - reg_trans_complete_int_ena
pub type TRANS_COMPLETE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIME_OUT` reader - reg_time_out_int_ena
pub type TIME_OUT_R = crate::BitReader;
///Field `TIME_OUT` writer - reg_time_out_int_ena
pub type TIME_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_START` reader - reg_trans_start_int_ena
pub type TRANS_START_R = crate::BitReader;
///Field `TRANS_START` writer - reg_trans_start_int_ena
pub type TRANS_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `NACK` reader - reg_nack_int_ena
pub type NACK_R = crate::BitReader;
///Field `NACK` writer - reg_nack_int_ena
pub type NACK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_OVF` reader - reg_txfifo_ovf_int_ena
pub type TXFIFO_OVF_R = crate::BitReader;
///Field `TXFIFO_OVF` writer - reg_txfifo_ovf_int_ena
pub type TXFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_UDF` reader - reg_rxfifo_udf_int_ena
pub type RXFIFO_UDF_R = crate::BitReader;
///Field `RXFIFO_UDF` writer - reg_rxfifo_udf_int_ena
pub type RXFIFO_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCL_ST_TO` reader - reg_scl_st_to_int_ena
pub type SCL_ST_TO_R = crate::BitReader;
///Field `SCL_ST_TO` writer - reg_scl_st_to_int_ena
pub type SCL_ST_TO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCL_MAIN_ST_TO` reader - reg_scl_main_st_to_int_ena
pub type SCL_MAIN_ST_TO_R = crate::BitReader;
///Field `SCL_MAIN_ST_TO` writer - reg_scl_main_st_to_int_ena
pub type SCL_MAIN_ST_TO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DET_START` reader - reg_det_start_int_ena
pub type DET_START_R = crate::BitReader;
///Field `DET_START` writer - reg_det_start_int_ena
pub type DET_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLAVE_STRETCH` reader - reg_slave_stretch_int_ena
pub type SLAVE_STRETCH_R = crate::BitReader;
///Field `SLAVE_STRETCH` writer - reg_slave_stretch_int_ena
pub type SLAVE_STRETCH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GENERAL_CALL` reader - reg_general_call_int_ena
pub type GENERAL_CALL_R = crate::BitReader;
///Field `GENERAL_CALL` writer - reg_general_call_int_ena
