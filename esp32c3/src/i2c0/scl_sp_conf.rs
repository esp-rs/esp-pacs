...
///Field `SCL_RST_SLV_EN` reader - reg_scl_rst_slv_en
pub type SCL_RST_SLV_EN_R = crate::BitReader;
///Field `SCL_RST_SLV_EN` writer - reg_scl_rst_slv_en
pub type SCL_RST_SLV_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCL_RST_SLV_NUM` reader - reg_scl_rst_slv_num
pub type SCL_RST_SLV_NUM_R = crate::FieldReader;
///Field `SCL_RST_SLV_NUM` writer - reg_scl_rst_slv_num
pub type SCL_RST_SLV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `SCL_PD_EN` reader - reg_scl_pd_en
pub type SCL_PD_EN_R = crate::BitReader;
///Field `SCL_PD_EN` writer - reg_scl_pd_en
pub type SCL_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDA_PD_EN` reader - reg_sda_pd_en
pub type SDA_PD_EN_R = crate::BitReader;
///Field `SDA_PD_EN` writer - reg_sda_pd_en
