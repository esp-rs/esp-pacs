...
///Field `SLAVE_ADDR` reader - reg_slave_addr
pub type SLAVE_ADDR_R = crate::FieldReader<u16>;
///Field `SLAVE_ADDR` writer - reg_slave_addr
pub type SLAVE_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `ADDR_10BIT_EN` reader - reg_addr_10bit_en
pub type ADDR_10BIT_EN_R = crate::BitReader;
///Field `ADDR_10BIT_EN` writer - reg_addr_10bit_en
