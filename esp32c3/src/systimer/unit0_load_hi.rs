...
pub type TIMER_UNIT0_LOAD_HI_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UNIT0_LOAD_HI_SPEC, u32, u32, 20, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:19 - timer unit0 load high 32 bit"]
    #[inline(always)]
    pub fn timer_unit0_load_hi(&mut self) -> TIMER_UNIT0_LOAD_HI_W<0> {
