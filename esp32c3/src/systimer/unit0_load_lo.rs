...
#[doc = "Field `TIMER_UNIT0_LOAD_LO` reader - timer unit0 load low 32 bit"]
pub type TIMER_UNIT0_LOAD_LO_R = crate::FieldReader<u32>;
#[doc = "Field `TIMER_UNIT0_LOAD_LO` writer - timer unit0 load low 32 bit"]
pub type TIMER_UNIT0_LOAD_LO_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer_unit0_load_lo(&mut self) -> TIMER_UNIT0_LOAD_LO_W<UNIT0_LOAD_LO_SPEC, 0> {
