...
impl RegisterBlock {
    ///0x00 - USB_DEVICE_EP1_REG.
    #[inline(always)]
    pub const fn ep1(&self) -> &EP1 {
        &self.ep1
    }
    ///0x04 - USB_DEVICE_EP1_CONF_REG.
    #[inline(always)]
    pub const fn ep1_conf(&self) -> &EP1_CONF {
        &self.ep1_conf
    }
    ///0x08 - USB_DEVICE_INT_RAW_REG.
    #[inline(always)]
    pub const fn int_raw(&self) -> &INT_RAW {
        &self.int_raw
    }
    ///0x0c - USB_DEVICE_INT_ST_REG.
    #[inline(always)]
    pub const fn int_st(&self) -> &INT_ST {
        &self.int_st
    }
    ///0x10 - USB_DEVICE_INT_ENA_REG.
    #[inline(always)]
    pub const fn int_ena(&self) -> &INT_ENA {
        &self.int_ena
    }
    ///0x14 - USB_DEVICE_INT_CLR_REG.
    #[inline(always)]
    pub const fn int_clr(&self) -> &INT_CLR {
        &self.int_clr
    }
    ///0x18 - USB_DEVICE_CONF0_REG.
    #[inline(always)]
    pub const fn conf0(&self) -> &CONF0 {
        &self.conf0
    }
    ///0x1c - USB_DEVICE_TEST_REG.
    #[inline(always)]
    pub const fn test(&self) -> &TEST {
        &self.test
    }
    ///0x20 - USB_DEVICE_JFIFO_ST_REG.
    #[inline(always)]
    pub const fn jfifo_st(&self) -> &JFIFO_ST {
        &self.jfifo_st
    }
    ///0x24 - USB_DEVICE_FRAM_NUM_REG.
    #[inline(always)]
    pub const fn fram_num(&self) -> &FRAM_NUM {
        &self.fram_num
    }
    ///0x28 - USB_DEVICE_IN_EP0_ST_REG.
    #[inline(always)]
    pub const fn in_ep0_st(&self) -> &IN_EP0_ST {
        &self.in_ep0_st
    }
    ///0x2c - USB_DEVICE_IN_EP1_ST_REG.
    #[inline(always)]
    ...
    ///0x34 - USB_DEVICE_IN_EP3_ST_REG.
    #[inline(always)]
    pub const fn in_ep3_st(&self) -> &IN_EP3_ST {
        &self.in_ep3_st
    }
    ///0x38 - USB_DEVICE_OUT_EP0_ST_REG.
    #[inline(always)]
    pub const fn out_ep0_st(&self) -> &OUT_EP0_ST {
        &self.out_ep0_st
    }
    ///0x3c - USB_DEVICE_OUT_EP1_ST_REG.
    #[inline(always)]
    pub const fn out_ep1_st(&self) -> &OUT_EP1_ST {
        &self.out_ep1_st
    }
    ///0x40 - USB_DEVICE_OUT_EP2_ST_REG.
    #[inline(always)]
    pub const fn out_ep2_st(&self) -> &OUT_EP2_ST {
        &self.out_ep2_st
    }
    ///0x44 - USB_DEVICE_MISC_CONF_REG.
    #[inline(always)]
    pub const fn misc_conf(&self) -> &MISC_CONF {
        &self.misc_conf
    }
    ///0x48 - USB_DEVICE_MEM_CONF_REG.
    #[inline(always)]
    pub const fn mem_conf(&self) -> &MEM_CONF {
        &self.mem_conf
    }
    ///0x80 - USB_DEVICE_DATE_REG.
    #[inline(always)]
    pub const fn date(&self) -> &DATE {
        &self.date
    }
}
/**EP1 (rw) register accessor: USB_DEVICE_EP1_REG.
...
pub mod ep1_conf;
/**INT_RAW (rw) register accessor: USB_DEVICE_INT_RAW_REG.
...
pub mod int_raw;
/**INT_ST (r) register accessor: USB_DEVICE_INT_ST_REG.
...
pub mod int_st;
/**INT_ENA (rw) register accessor: USB_DEVICE_INT_ENA_REG.
...
pub mod int_ena;
/**INT_CLR (w) register accessor: USB_DEVICE_INT_CLR_REG.
...
pub mod int_clr;
/**CONF0 (rw) register accessor: USB_DEVICE_CONF0_REG.
...
///USB_DEVICE_TEST_REG.
pub mod test;
/**JFIFO_ST (rw) register accessor: USB_DEVICE_JFIFO_ST_REG.
...
pub mod fram_num;
/**IN_EP0_ST (r) register accessor: USB_DEVICE_IN_EP0_ST_REG.
...
pub mod in_ep0_st;
/**IN_EP1_ST (r) register accessor: USB_DEVICE_IN_EP1_ST_REG.
...
pub mod in_ep1_st;
/**IN_EP2_ST (r) register accessor: USB_DEVICE_IN_EP2_ST_REG.
...
pub mod in_ep2_st;
/**IN_EP3_ST (r) register accessor: USB_DEVICE_IN_EP3_ST_REG.
...
pub mod in_ep3_st;
/**OUT_EP0_ST (r) register accessor: USB_DEVICE_OUT_EP0_ST_REG.
...
pub mod out_ep0_st;
/**OUT_EP1_ST (r) register accessor: USB_DEVICE_OUT_EP1_ST_REG.
...
pub mod out_ep1_st;
/**OUT_EP2_ST (r) register accessor: USB_DEVICE_OUT_EP2_ST_REG.
...
pub mod misc_conf;
/**MEM_CONF (rw) register accessor: USB_DEVICE_MEM_CONF_REG.
...
pub mod mem_conf;
/**DATE (rw) register accessor: USB_DEVICE_DATE_REG.
