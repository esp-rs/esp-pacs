...
///Field `WDT_CLK_IS_ACTIVE` reader - reg_wdt_clk_is_active.
pub type WDT_CLK_IS_ACTIVE_R = crate::BitReader;
///Field `WDT_CLK_IS_ACTIVE` writer - reg_wdt_clk_is_active.
pub type WDT_CLK_IS_ACTIVE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER_CLK_IS_ACTIVE` reader - reg_timer_clk_is_active.
pub type TIMER_CLK_IS_ACTIVE_R = crate::BitReader;
///Field `TIMER_CLK_IS_ACTIVE` writer - reg_timer_clk_is_active.
