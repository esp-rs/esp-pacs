...
///`read()` method returns [`ntimg_date::R`](R) reader structure
impl crate::Readable for NTIMG_DATE_SPEC {}
///`write(|w| ..)` method takes [`ntimg_date::W`](W) writer structure
impl crate::Writable for NTIMG_DATE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets NTIMG_DATE to value 0x0200_6191
