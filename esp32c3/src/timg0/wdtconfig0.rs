...
///Field `WDT_APPCPU_RESET_EN` reader - reg_wdt_appcpu_reset_en.
pub type WDT_APPCPU_RESET_EN_R = crate::BitReader;
///Field `WDT_APPCPU_RESET_EN` writer - reg_wdt_appcpu_reset_en.
pub type WDT_APPCPU_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_PROCPU_RESET_EN` reader - reg_wdt_procpu_reset_en.
pub type WDT_PROCPU_RESET_EN_R = crate::BitReader;
///Field `WDT_PROCPU_RESET_EN` writer - reg_wdt_procpu_reset_en.
pub type WDT_PROCPU_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_FLASHBOOT_MOD_EN` reader - reg_wdt_flashboot_mod_en.
pub type WDT_FLASHBOOT_MOD_EN_R = crate::BitReader;
///Field `WDT_FLASHBOOT_MOD_EN` writer - reg_wdt_flashboot_mod_en.
pub type WDT_FLASHBOOT_MOD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_SYS_RESET_LENGTH` reader - reg_wdt_sys_reset_length.
pub type WDT_SYS_RESET_LENGTH_R = crate::FieldReader;
///Field `WDT_SYS_RESET_LENGTH` writer - reg_wdt_sys_reset_length.
pub type WDT_SYS_RESET_LENGTH_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_CPU_RESET_LENGTH` reader - reg_wdt_cpu_reset_length.
pub type WDT_CPU_RESET_LENGTH_R = crate::FieldReader;
///Field `WDT_CPU_RESET_LENGTH` writer - reg_wdt_cpu_reset_length.
pub type WDT_CPU_RESET_LENGTH_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_USE_XTAL` reader - reg_wdt_use_xtal.
