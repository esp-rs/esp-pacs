...
///Field `TRANS_END_INT_ENA` reader - The bit is used to enable the interrupt of spi0_mst_st controlled transmitting is done.
pub type TRANS_END_INT_ENA_R = crate::BitReader;
///Field `TRANS_END_INT_ENA` writer - The bit is used to enable the interrupt of spi0_mst_st controlled transmitting is done.
pub type TRANS_END_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CSPI_ST_TRANS_END` reader - The bit is used to indicate the spi0_slv_st controlled transmitting is done.
pub type CSPI_ST_TRANS_END_R = crate::BitReader;
///Field `CSPI_ST_TRANS_END` writer - The bit is used to indicate the spi0_slv_st controlled transmitting is done.
pub type CSPI_ST_TRANS_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CSPI_ST_TRANS_END_INT_ENA` reader - The bit is used to enable the interrupt of spi0_slv_st controlled transmitting is done.
