...
#[doc = "Field `APP2` reader - The raw bit for SPI_APP2_INT interrupt. The value is only controlled by application."]
pub type APP2_R = crate::BitReader;
#[doc = "Field `APP2` writer - The raw bit for SPI_APP2_INT interrupt. The value is only controlled by application."]
pub type APP2_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `APP1` reader - The raw bit for SPI_APP1_INT interrupt. The value is only controlled by application."]
pub type APP1_R = crate::BitReader;
#[doc = "Field `APP1` writer - The raw bit for SPI_APP1_INT interrupt. The value is only controlled by application."]
