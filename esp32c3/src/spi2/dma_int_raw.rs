...
///Field `APP2` reader - The raw bit for SPI_APP2_INT interrupt. The value is only controlled by application.
...
///Field `APP1` reader - The raw bit for SPI_APP1_INT interrupt. The value is only controlled by application.
