...
///Field `OUT_EOF` reader - This is the interrupt raw bit. Triggered when there are some errors in EOF in the
...
///Field `APP_CTRL0` reader - Soft control int raw bit.
pub type APP_CTRL0_R = crate::BitReader;
///Field `APP_CTRL0` writer - Soft control int raw bit.
pub type APP_CTRL0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APP_CTRL1` reader - Soft control int raw bit.
pub type APP_CTRL1_R = crate::BitReader;
///Field `APP_CTRL1` writer - Soft control int raw bit.
