...
pub type SEND_Q4_WORD1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, REG_Q4_WORD1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - a"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - a"]
    #[inline(always)]
    pub fn send_q4_word1(&mut self) -> SEND_Q4_WORD1_W<0> {
...
#[doc = "a\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [reg_q4_word1](index.html) module"]
