...
///Field `DATE` reader - Those bits stores the version information of XTS-AES.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - Those bits stores the version information of XTS-AES.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Those bits stores the version information of XTS-AES.
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x2020_0623
