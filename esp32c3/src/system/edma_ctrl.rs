...
///Field `EDMA_CLK_ON` reader - reg_edma_clk_on
pub type EDMA_CLK_ON_R = crate::BitReader;
///Field `EDMA_CLK_ON` writer - reg_edma_clk_on
pub type EDMA_CLK_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EDMA_RESET` reader - reg_edma_reset
pub type EDMA_RESET_R = crate::BitReader;
///Field `EDMA_RESET` writer - reg_edma_reset
