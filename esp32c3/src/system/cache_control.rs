...
///Field `ICACHE_CLK_ON` reader - reg_icache_clk_on
pub type ICACHE_CLK_ON_R = crate::BitReader;
///Field `ICACHE_CLK_ON` writer - reg_icache_clk_on
pub type ICACHE_CLK_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ICACHE_RESET` reader - reg_icache_reset
pub type ICACHE_RESET_R = crate::BitReader;
///Field `ICACHE_RESET` writer - reg_icache_reset
pub type ICACHE_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_CLK_ON` reader - reg_dcache_clk_on
pub type DCACHE_CLK_ON_R = crate::BitReader;
///Field `DCACHE_CLK_ON` writer - reg_dcache_clk_on
pub type DCACHE_CLK_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_RESET` reader - reg_dcache_reset
pub type DCACHE_RESET_R = crate::BitReader;
///Field `DCACHE_RESET` writer - reg_dcache_reset
