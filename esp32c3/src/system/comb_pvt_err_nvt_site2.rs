///Register `COMB_PVT_ERR_NVT_SITE2` reader
pub type R = crate::R<COMB_PVT_ERR_NVT_SITE2_SPEC>;
///Field `COMB_TIMING_ERR_CNT_NVT_SITE2` reader - reg_comb_timing_err_cnt_nvt_site2
pub type COMB_TIMING_ERR_CNT_NVT_SITE2_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - reg_comb_timing_err_cnt_nvt_site2
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PVT_ERR_NVT_SITE2")
            .field(
                ...
                &self.comb_timing_err_cnt_nvt_site2(),
            )
            .finish()
    }
}
...
You can [`read`](crate::generic::Reg::read) this register and get [`comb_pvt_err_nvt_site2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct COMB_PVT_ERR_NVT_SITE2_SPEC;
impl crate::RegisterSpec for COMB_PVT_ERR_NVT_SITE2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`comb_pvt_err_nvt_site2::R`](R) reader structure
