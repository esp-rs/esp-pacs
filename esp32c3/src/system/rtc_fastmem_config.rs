...
///Field `RTC_MEM_CRC_START` reader - reg_rtc_mem_crc_start
pub type RTC_MEM_CRC_START_R = crate::BitReader;
///Field `RTC_MEM_CRC_START` writer - reg_rtc_mem_crc_start
pub type RTC_MEM_CRC_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RTC_MEM_CRC_ADDR` reader - reg_rtc_mem_crc_addr
pub type RTC_MEM_CRC_ADDR_R = crate::FieldReader<u16>;
///Field `RTC_MEM_CRC_ADDR` writer - reg_rtc_mem_crc_addr
pub type RTC_MEM_CRC_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `RTC_MEM_CRC_LEN` reader - reg_rtc_mem_crc_len
pub type RTC_MEM_CRC_LEN_R = crate::FieldReader<u16>;
///Field `RTC_MEM_CRC_LEN` writer - reg_rtc_mem_crc_len
pub type RTC_MEM_CRC_LEN_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `RTC_MEM_CRC_FINISH` reader - reg_rtc_mem_crc_finish
