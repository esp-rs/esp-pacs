...
///Field `CLK_EN_ASSIST_DEBUG` reader - reg_clk_en_assist_debug
pub type CLK_EN_ASSIST_DEBUG_R = crate::BitReader;
///Field `CLK_EN_ASSIST_DEBUG` writer - reg_clk_en_assist_debug
pub type CLK_EN_ASSIST_DEBUG_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_EN_DEDICATED_GPIO` reader - reg_clk_en_dedicated_gpio
pub type CLK_EN_DEDICATED_GPIO_R = crate::BitReader;
///Field `CLK_EN_DEDICATED_GPIO` writer - reg_clk_en_dedicated_gpio
