///Register `COMB_PVT_ERR_LVT_SITE0` reader
pub type R = crate::R<COMB_PVT_ERR_LVT_SITE0_SPEC>;
///Field `COMB_TIMING_ERR_CNT_LVT_SITE0` reader - reg_comb_timing_err_cnt_lvt_site0
pub type COMB_TIMING_ERR_CNT_LVT_SITE0_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - reg_comb_timing_err_cnt_lvt_site0
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`comb_pvt_err_lvt_site0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct COMB_PVT_ERR_LVT_SITE0_SPEC;
impl crate::RegisterSpec for COMB_PVT_ERR_LVT_SITE0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`comb_pvt_err_lvt_site0::R`](R) reader structure
