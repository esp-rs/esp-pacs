///Register `COMB_PVT_ERR_LVT_SITE2` reader
pub type R = crate::R<COMB_PVT_ERR_LVT_SITE2_SPEC>;
///Field `COMB_TIMING_ERR_CNT_LVT_SITE2` reader - reg_comb_timing_err_cnt_lvt_site2
pub type COMB_TIMING_ERR_CNT_LVT_SITE2_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - reg_comb_timing_err_cnt_lvt_site2
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PVT_ERR_LVT_SITE2")
            .field(
                ...
                &self.comb_timing_err_cnt_lvt_site2(),
            )
            .finish()
    }
}
...
///`read()` method returns [`comb_pvt_err_lvt_site2::R`](R) reader structure
