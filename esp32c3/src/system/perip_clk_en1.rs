...
///Field `CRYPTO_AES_CLK_EN` reader - reg_crypto_aes_clk_en
pub type CRYPTO_AES_CLK_EN_R = crate::BitReader;
///Field `CRYPTO_AES_CLK_EN` writer - reg_crypto_aes_clk_en
pub type CRYPTO_AES_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_SHA_CLK_EN` reader - reg_crypto_sha_clk_en
pub type CRYPTO_SHA_CLK_EN_R = crate::BitReader;
///Field `CRYPTO_SHA_CLK_EN` writer - reg_crypto_sha_clk_en
pub type CRYPTO_SHA_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_RSA_CLK_EN` reader - reg_crypto_rsa_clk_en
pub type CRYPTO_RSA_CLK_EN_R = crate::BitReader;
///Field `CRYPTO_RSA_CLK_EN` writer - reg_crypto_rsa_clk_en
pub type CRYPTO_RSA_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_DS_CLK_EN` reader - reg_crypto_ds_clk_en
pub type CRYPTO_DS_CLK_EN_R = crate::BitReader;
///Field `CRYPTO_DS_CLK_EN` writer - reg_crypto_ds_clk_en
pub type CRYPTO_DS_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_HMAC_CLK_EN` reader - reg_crypto_hmac_clk_en
pub type CRYPTO_HMAC_CLK_EN_R = crate::BitReader;
///Field `CRYPTO_HMAC_CLK_EN` writer - reg_crypto_hmac_clk_en
pub type CRYPTO_HMAC_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_CLK_EN` reader - reg_dma_clk_en
pub type DMA_CLK_EN_R = crate::BitReader;
///Field `DMA_CLK_EN` writer - reg_dma_clk_en
pub type DMA_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDIO_HOST_CLK_EN` reader - reg_sdio_host_clk_en
pub type SDIO_HOST_CLK_EN_R = crate::BitReader;
///Field `SDIO_HOST_CLK_EN` writer - reg_sdio_host_clk_en
pub type SDIO_HOST_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_CAM_CLK_EN` reader - reg_lcd_cam_clk_en
pub type LCD_CAM_CLK_EN_R = crate::BitReader;
///Field `LCD_CAM_CLK_EN` writer - reg_lcd_cam_clk_en
pub type LCD_CAM_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART2_CLK_EN` reader - reg_uart2_clk_en
pub type UART2_CLK_EN_R = crate::BitReader;
///Field `UART2_CLK_EN` writer - reg_uart2_clk_en
pub type UART2_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TSENS_CLK_EN` reader - reg_tsens_clk_en
pub type TSENS_CLK_EN_R = crate::BitReader;
///Field `TSENS_CLK_EN` writer - reg_tsens_clk_en
...
///`reset()` method sets PERIP_CLK_EN1 to value 0x0200
