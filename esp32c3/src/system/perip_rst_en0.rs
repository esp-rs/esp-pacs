...
///Field `ADC2_ARB_RST` reader - reg_adc2_arb_rst
pub type ADC2_ARB_RST_R = crate::BitReader;
///Field `ADC2_ARB_RST` writer - reg_adc2_arb_rst
pub type ADC2_ARB_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI4_RST` reader - reg_spi4_rst
pub type SPI4_RST_R = crate::BitReader;
///Field `SPI4_RST` writer - reg_spi4_rst
