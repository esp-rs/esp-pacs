///Register `CACHE_ACS_CNT_CLR` writer
pub type W = crate::W<CACHE_ACS_CNT_CLR_SPEC>;
///Field `IBUS_ACS_CNT_CLR` writer - The bit is used to clear ibus counter.
pub type IBUS_ACS_CNT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DBUS_ACS_CNT_CLR` writer - The bit is used to clear dbus counter.
...
///`write(|w| ..)` method takes [`cache_acs_cnt_clr::W`](W) writer structure
