...
pub type DBUS_PMS_BOUNDARY2_W<'a, const O: u8> =
    crate::FieldWriter<'a, DBUS_PMS_TBL_BOUNDARY2_SPEC, 12, O, u16, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbus_pms_boundary2(&mut self) -> DBUS_PMS_BOUNDARY2_W<0> {
