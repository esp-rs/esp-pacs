...
pub type DBUS_PMS_BOUNDARY2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DBUS_PMS_TBL_BOUNDARY2")
            .field(
                "dbus_pms_boundary2",
                &format_args!("{}", self.dbus_pms_boundary2().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DBUS_PMS_TBL_BOUNDARY2_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbus_pms_boundary2(&mut self) -> DBUS_PMS_BOUNDARY2_W<DBUS_PMS_TBL_BOUNDARY2_SPEC, 0> {
