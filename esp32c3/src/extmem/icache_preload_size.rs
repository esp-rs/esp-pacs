///Register `ICACHE_PRELOAD_SIZE` reader
pub type R = crate::R<ICACHE_PRELOAD_SIZE_SPEC>;
///Register `ICACHE_PRELOAD_SIZE` writer
...
///`read()` method returns [`icache_preload_size::R`](R) reader structure
impl crate::Readable for ICACHE_PRELOAD_SIZE_SPEC {}
///`write(|w| ..)` method takes [`icache_preload_size::W`](W) writer structure
