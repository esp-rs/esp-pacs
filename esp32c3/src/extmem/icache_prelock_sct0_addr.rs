///Register `ICACHE_PRELOCK_SCT0_ADDR` reader
pub type R = crate::R<ICACHE_PRELOCK_SCT0_ADDR_SPEC>;
///Register `ICACHE_PRELOCK_SCT0_ADDR` writer
pub type W = crate::W<ICACHE_PRELOCK_SCT0_ADDR_SPEC>;
///Field `ICACHE_PRELOCK_SCT0_ADDR` reader - The bits are used to configure the first start virtual address of data prelock, which is combined with ICACHE_PRELOCK_SCT0_SIZE_REG
pub type ICACHE_PRELOCK_SCT0_ADDR_R = crate::FieldReader<u32>;
///Field `ICACHE_PRELOCK_SCT0_ADDR` writer - The bits are used to configure the first start virtual address of data prelock, which is combined with ICACHE_PRELOCK_SCT0_SIZE_REG
...
///`read()` method returns [`icache_prelock_sct0_addr::R`](R) reader structure
impl crate::Readable for ICACHE_PRELOCK_SCT0_ADDR_SPEC {}
///`write(|w| ..)` method takes [`icache_prelock_sct0_addr::W`](W) writer structure
