///Register `IBUS_PMS_TBL_LOCK` reader
pub type R = crate::R<IBUS_PMS_TBL_LOCK_SPEC>;
///Register `IBUS_PMS_TBL_LOCK` writer
pub type W = crate::W<IBUS_PMS_TBL_LOCK_SPEC>;
///Field `IBUS_PMS_LOCK` reader - The bit is used to configure the ibus permission control section boundary0
pub type IBUS_PMS_LOCK_R = crate::BitReader;
///Field `IBUS_PMS_LOCK` writer - The bit is used to configure the ibus permission control section boundary0
pub type IBUS_PMS_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - The bit is used to configure the ibus permission control section boundary0
    #[inline(always)]
...
///`read()` method returns [`ibus_pms_tbl_lock::R`](R) reader structure
impl crate::Readable for IBUS_PMS_TBL_LOCK_SPEC {}
///`write(|w| ..)` method takes [`ibus_pms_tbl_lock::W`](W) writer structure
impl crate::Writable for IBUS_PMS_TBL_LOCK_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets IBUS_PMS_TBL_LOCK to value 0
