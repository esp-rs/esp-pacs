...
pub struct R(crate::R<ICACHE_PRELOCK_SCT1_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ICACHE_PRELOCK_SCT1_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ICACHE_PRELOCK_SCT1_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ICACHE_PRELOCK_SCT1_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ICACHE_PRELOCK_SCT1_ADDR` writer"]
pub struct W(crate::W<ICACHE_PRELOCK_SCT1_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ICACHE_PRELOCK_SCT1_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ICACHE_PRELOCK_SCT1_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ICACHE_PRELOCK_SCT1_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ICACHE_PRELOCK_SCT1_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type ICACHE_PRELOCK_SCT1_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, ICACHE_PRELOCK_SCT1_ADDR_SPEC, 32, O, u32, u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ICACHE_PRELOCK_SCT1_ADDR")
            .field(
                ...
                &format_args!("{}", self.icache_prelock_sct1_addr().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<ICACHE_PRELOCK_SCT1_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icache_prelock_sct1_addr(&mut self) -> ICACHE_PRELOCK_SCT1_ADDR_W<0> {
        ICACHE_PRELOCK_SCT1_ADDR_W::new(self)
    }
...
#[doc = "This description will be updated in the near future.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [icache_prelock_sct1_addr](index.html) module"]
