...
///Field `CORE0_DBUS_ACS_MSK_IC` reader - The bit is used to enable interrupt by cpu access icache while the corresponding dbus is disabled which include speculative access.
pub type CORE0_DBUS_ACS_MSK_IC_R = crate::BitReader;
///Field `CORE0_DBUS_ACS_MSK_IC` writer - The bit is used to enable interrupt by cpu access icache while the corresponding dbus is disabled which include speculative access.
...
///Field `CORE0_DBUS_WR_IC` reader - The bit is used to enable interrupt by dbus trying to write icache
pub type CORE0_DBUS_WR_IC_R = crate::BitReader;
///Field `CORE0_DBUS_WR_IC` writer - The bit is used to enable interrupt by dbus trying to write icache
...
impl W {
    ...
    pub fn core0_dbus_acs_msk_ic(
        &mut self,
    ) -> CORE0_DBUS_ACS_MSK_IC_W<CORE0_ACS_CACHE_INT_ENA_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_dbus_wr_ic(&mut self) -> CORE0_DBUS_WR_IC_W<CORE0_ACS_CACHE_INT_ENA_SPEC> {
