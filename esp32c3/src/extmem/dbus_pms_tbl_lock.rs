///Register `DBUS_PMS_TBL_LOCK` reader
pub type R = crate::R<DBUS_PMS_TBL_LOCK_SPEC>;
///Register `DBUS_PMS_TBL_LOCK` writer
pub type W = crate::W<DBUS_PMS_TBL_LOCK_SPEC>;
///Field `DBUS_PMS_LOCK` reader - The bit is used to configure the ibus permission control section boundary0
pub type DBUS_PMS_LOCK_R = crate::BitReader;
///Field `DBUS_PMS_LOCK` writer - The bit is used to configure the ibus permission control section boundary0
...
///`read()` method returns [`dbus_pms_tbl_lock::R`](R) reader structure
impl crate::Readable for DBUS_PMS_TBL_LOCK_SPEC {}
///`write(|w| ..)` method takes [`dbus_pms_tbl_lock::W`](W) writer structure
impl crate::Writable for DBUS_PMS_TBL_LOCK_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DBUS_PMS_TBL_LOCK to value 0
