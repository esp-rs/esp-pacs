...
pub type DBUS_PMS_BOUNDARY1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbus_pms_boundary1(&mut self) -> DBUS_PMS_BOUNDARY1_W<DBUS_PMS_TBL_BOUNDARY1_SPEC, 0> {
