...
pub struct R(crate::R<DBUS_TO_FLASH_END_VADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DBUS_TO_FLASH_END_VADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DBUS_TO_FLASH_END_VADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DBUS_TO_FLASH_END_VADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DBUS_TO_FLASH_END_VADDR` writer"]
pub struct W(crate::W<DBUS_TO_FLASH_END_VADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DBUS_TO_FLASH_END_VADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DBUS_TO_FLASH_END_VADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DBUS_TO_FLASH_END_VADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DBUS_TO_FLASH_END_VADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DBUS_TO_FLASH_END_VADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbus_to_flash_end_vaddr(&mut self) -> DBUS_TO_FLASH_END_VADDR_W<0> {
...
#[doc = "This description will be updated in the near future.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dbus_to_flash_end_vaddr](index.html) module"]
...
impl crate::Resettable for DBUS_TO_FLASH_END_VADDR_SPEC {
    const RESET_VALUE: Self::Ux = 0x3c7f_ffff;
}
