///Register `ICACHE_AUTOLOAD_SCT0_SIZE` reader
pub type R = crate::R<ICACHE_AUTOLOAD_SCT0_SIZE_SPEC>;
///Register `ICACHE_AUTOLOAD_SCT0_SIZE` writer
pub type W = crate::W<ICACHE_AUTOLOAD_SCT0_SIZE_SPEC>;
///Field `ICACHE_AUTOLOAD_SCT0_SIZE` reader - The bits are used to configure the length of the first section for autoload operation. It should be combined with icache_autoload_sct0_ena.
pub type ICACHE_AUTOLOAD_SCT0_SIZE_R = crate::FieldReader<u32>;
///Field `ICACHE_AUTOLOAD_SCT0_SIZE` writer - The bits are used to configure the length of the first section for autoload operation. It should be combined with icache_autoload_sct0_ena.
pub type ICACHE_AUTOLOAD_SCT0_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 27, u32>;
impl R {
    ///Bits 0:26 - The bits are used to configure the length of the first section for autoload operation. It should be combined with icache_autoload_sct0_ena.
    #[inline(always)]
...
///`read()` method returns [`icache_autoload_sct0_size::R`](R) reader structure
impl crate::Readable for ICACHE_AUTOLOAD_SCT0_SIZE_SPEC {}
///`write(|w| ..)` method takes [`icache_autoload_sct0_size::W`](W) writer structure
