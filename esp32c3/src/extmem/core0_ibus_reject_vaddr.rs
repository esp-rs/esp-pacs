///Register `CORE0_IBUS_REJECT_VADDR` reader
pub type R = crate::R<CORE0_IBUS_REJECT_VADDR_SPEC>;
///Field `CORE0_IBUS_VADDR` reader - The bits are used to indicate the virtual address of CPU access ibus when authentication fail.
...
///`read()` method returns [`core0_ibus_reject_vaddr::R`](R) reader structure
