///Register `DBUS_PMS_TBL_ATTR` reader
pub type R = crate::R<DBUS_PMS_TBL_ATTR_SPEC>;
///Register `DBUS_PMS_TBL_ATTR` writer
pub type W = crate::W<DBUS_PMS_TBL_ATTR_SPEC>;
///Field `DBUS_PMS_SCT1_ATTR` reader - The bit is used to configure attribute of the dbus permission control section1, bit0: load in world0, bit2: load in world1
pub type DBUS_PMS_SCT1_ATTR_R = crate::FieldReader;
///Field `DBUS_PMS_SCT1_ATTR` writer - The bit is used to configure attribute of the dbus permission control section1, bit0: load in world0, bit2: load in world1
pub type DBUS_PMS_SCT1_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DBUS_PMS_SCT2_ATTR` reader - The bit is used to configure attribute of the dbus permission control section2, bit0: load in world0, bit2: load in world1
pub type DBUS_PMS_SCT2_ATTR_R = crate::FieldReader;
///Field `DBUS_PMS_SCT2_ATTR` writer - The bit is used to configure attribute of the dbus permission control section2, bit0: load in world0, bit2: load in world1
pub type DBUS_PMS_SCT2_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - The bit is used to configure attribute of the dbus permission control section1, bit0: load in world0, bit2: load in world1
    #[inline(always)]
    pub fn dbus_pms_sct1_attr(&self) -> DBUS_PMS_SCT1_ATTR_R {
        DBUS_PMS_SCT1_ATTR_R::new((self.bits & 3) as u8)
    }
    ///Bits 2:3 - The bit is used to configure attribute of the dbus permission control section2, bit0: load in world0, bit2: load in world1
    #[inline(always)]
...
///`read()` method returns [`dbus_pms_tbl_attr::R`](R) reader structure
impl crate::Readable for DBUS_PMS_TBL_ATTR_SPEC {}
///`write(|w| ..)` method takes [`dbus_pms_tbl_attr::W`](W) writer structure
impl crate::Writable for DBUS_PMS_TBL_ATTR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DBUS_PMS_TBL_ATTR to value 0x0f
