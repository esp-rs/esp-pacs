///Register `IBUS_PMS_TBL_BOUNDARY1` reader
pub type R = crate::R<IBUS_PMS_TBL_BOUNDARY1_SPEC>;
///Register `IBUS_PMS_TBL_BOUNDARY1` writer
pub type W = crate::W<IBUS_PMS_TBL_BOUNDARY1_SPEC>;
///Field `IBUS_PMS_BOUNDARY1` reader - The bit is used to configure the ibus permission control section boundary1
pub type IBUS_PMS_BOUNDARY1_R = crate::FieldReader<u16>;
///Field `IBUS_PMS_BOUNDARY1` writer - The bit is used to configure the ibus permission control section boundary1
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IBUS_PMS_TBL_BOUNDARY1")
            .field("ibus_pms_boundary1", &self.ibus_pms_boundary1())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`ibus_pms_tbl_boundary1::R`](R) reader structure
impl crate::Readable for IBUS_PMS_TBL_BOUNDARY1_SPEC {}
///`write(|w| ..)` method takes [`ibus_pms_tbl_boundary1::W`](W) writer structure
impl crate::Writable for IBUS_PMS_TBL_BOUNDARY1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets IBUS_PMS_TBL_BOUNDARY1 to value 0x0800
