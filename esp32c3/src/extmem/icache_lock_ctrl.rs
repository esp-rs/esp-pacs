...
///Field `ICACHE_UNLOCK_ENA` reader - The bit is used to enable unlock operation. It will be cleared by hardware after unlock operation done.
...
///Field `ICACHE_LOCK_DONE` reader - The bit is used to indicate unlock/lock operation is finished.
...
///`read()` method returns [`icache_lock_ctrl::R`](R) reader structure
impl crate::Readable for ICACHE_LOCK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`icache_lock_ctrl::W`](W) writer structure
