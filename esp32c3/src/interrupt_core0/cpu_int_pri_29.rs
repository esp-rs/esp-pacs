...
#[doc = "Field `CPU_PRI_29_MAP` reader - reg_core0_cpu_pri_29_map"]
pub type CPU_PRI_29_MAP_R = crate::FieldReader;
#[doc = "Field `CPU_PRI_29_MAP` writer - reg_core0_cpu_pri_29_map"]
pub type CPU_PRI_29_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bits 0:3 - reg_core0_cpu_pri_29_map"]
    #[inline(always)]
    pub fn cpu_pri_29_map(&self) -> CPU_PRI_29_MAP_R {
        CPU_PRI_29_MAP_R::new((self.bits & 0x0f) as u8)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CPU_INT_PRI_29")
            .field(
                "cpu_pri_29_map",
                &format_args!("{}", self.cpu_pri_29_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CPU_INT_PRI_29_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_pri_29_map(&mut self) -> CPU_PRI_29_MAP_W<CPU_INT_PRI_29_SPEC> {
        CPU_PRI_29_MAP_W::new(self, 0)
    }
}
...
#[doc = "`reset()` method sets CPU_INT_PRI_29 to value 0"]
impl crate::Resettable for CPU_INT_PRI_29_SPEC {
