...
pub type R = crate::R<CPU_INT_PRI_12_SPEC>;
#[doc = "Register `CPU_INT_PRI_12` writer"]
pub type W = crate::W<CPU_INT_PRI_12_SPEC>;
#[doc = "Field `CPU_PRI_12_MAP` reader - reg_core0_cpu_pri_12_map"]
pub type CPU_PRI_12_MAP_R = crate::FieldReader;
#[doc = "Field `CPU_PRI_12_MAP` writer - reg_core0_cpu_pri_12_map"]
pub type CPU_PRI_12_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
    #[doc = "Bits 0:3 - reg_core0_cpu_pri_12_map"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_pri_12_map(&mut self) -> CPU_PRI_12_MAP_W<CPU_INT_PRI_12_SPEC, 0> {
        CPU_PRI_12_MAP_W::new(self)
    }
