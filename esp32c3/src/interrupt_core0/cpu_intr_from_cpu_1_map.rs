...
///Field `CPU_INTR_FROM_CPU_1_MAP` reader - reg_core0_cpu_intr_from_cpu_1_map
pub type CPU_INTR_FROM_CPU_1_MAP_R = crate::FieldReader;
///Field `CPU_INTR_FROM_CPU_1_MAP` writer - reg_core0_cpu_intr_from_cpu_1_map
pub type CPU_INTR_FROM_CPU_1_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_cpu_intr_from_cpu_1_map
    #[inline(always)]
