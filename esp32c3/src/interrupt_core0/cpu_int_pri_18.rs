...
pub type CPU_PRI_18_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_pri_18_map(&mut self) -> CPU_PRI_18_MAP_W<CPU_INT_PRI_18_SPEC> {
        CPU_PRI_18_MAP_W::new(self, 0)
    }
}
