...
///Field `RTC_CORE_INTR_MAP` reader - reg_core0_rtc_core_intr_map
pub type RTC_CORE_INTR_MAP_R = crate::FieldReader;
///Field `RTC_CORE_INTR_MAP` writer - reg_core0_rtc_core_intr_map
pub type RTC_CORE_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_rtc_core_intr_map
    #[inline(always)]
...
///`reset()` method sets RTC_CORE_INTR_MAP to value 0
