...
///Field `SPI_MEM_REJECT_INTR_MAP` reader - reg_core0_spi_mem_reject_intr_map
pub type SPI_MEM_REJECT_INTR_MAP_R = crate::FieldReader;
///Field `SPI_MEM_REJECT_INTR_MAP` writer - reg_core0_spi_mem_reject_intr_map
pub type SPI_MEM_REJECT_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_spi_mem_reject_intr_map
    #[inline(always)]
...
///`reset()` method sets SPI_MEM_REJECT_INTR_MAP to value 0
