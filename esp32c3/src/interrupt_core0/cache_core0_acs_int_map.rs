...
///Field `CACHE_CORE0_ACS_INT_MAP` reader - reg_core0_cache_core0_acs_int_map
pub type CACHE_CORE0_ACS_INT_MAP_R = crate::FieldReader;
///Field `CACHE_CORE0_ACS_INT_MAP` writer - reg_core0_cache_core0_acs_int_map
pub type CACHE_CORE0_ACS_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_cache_core0_acs_int_map
    #[inline(always)]
...
///`reset()` method sets CACHE_CORE0_ACS_INT_MAP to value 0
