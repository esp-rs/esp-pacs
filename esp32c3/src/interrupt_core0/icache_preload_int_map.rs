...
///Field `ICACHE_PRELOAD_INT_MAP` reader - reg_core0_icache_preload_int_map
pub type ICACHE_PRELOAD_INT_MAP_R = crate::FieldReader;
///Field `ICACHE_PRELOAD_INT_MAP` writer - reg_core0_icache_preload_int_map
pub type ICACHE_PRELOAD_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_icache_preload_int_map
    #[inline(always)]
