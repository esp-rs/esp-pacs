...
///Field `INTERRUPT_REG_DATE` reader - reg_core0_interrupt_reg_date
pub type INTERRUPT_REG_DATE_R = crate::FieldReader<u32>;
///Field `INTERRUPT_REG_DATE` writer - reg_core0_interrupt_reg_date
...
///`reset()` method sets INTERRUPT_REG_DATE to value 0x0200_7210
