...
///Field `RWBLE_NMI_MAP` reader - reg_core0_rwble_nmi_map
pub type RWBLE_NMI_MAP_R = crate::FieldReader;
///Field `RWBLE_NMI_MAP` writer - reg_core0_rwble_nmi_map
pub type RWBLE_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_rwble_nmi_map
    #[inline(always)]
...
///`reset()` method sets RWBLE_NMI_MAP to value 0
