...
///Field `ICACHE_SYNC_INT_MAP` reader - reg_core0_icache_sync_int_map
pub type ICACHE_SYNC_INT_MAP_R = crate::FieldReader;
///Field `ICACHE_SYNC_INT_MAP` writer - reg_core0_icache_sync_int_map
pub type ICACHE_SYNC_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_icache_sync_int_map
    #[inline(always)]
...
///`reset()` method sets ICACHE_SYNC_INT_MAP to value 0
