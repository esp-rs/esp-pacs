///Register `APB_CTRL_INTR_MAP` reader
pub type R = crate::R<APB_CTRL_INTR_MAP_SPEC>;
///Register `APB_CTRL_INTR_MAP` writer
pub type W = crate::W<APB_CTRL_INTR_MAP_SPEC>;
///Field `APB_CTRL_INTR_MAP` reader - reg_core0_apb_ctrl_intr_map
pub type APB_CTRL_INTR_MAP_R = crate::FieldReader;
///Field `APB_CTRL_INTR_MAP` writer - reg_core0_apb_ctrl_intr_map
pub type APB_CTRL_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_apb_ctrl_intr_map
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB_CTRL_INTR_MAP")
            .field("apb_ctrl_intr_map", &self.apb_ctrl_intr_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`apb_ctrl_intr_map::R`](R) reader structure
impl crate::Readable for APB_CTRL_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`apb_ctrl_intr_map::W`](W) writer structure
impl crate::Writable for APB_CTRL_INTR_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APB_CTRL_INTR_MAP to value 0
