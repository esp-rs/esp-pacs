...
///Field `BACKUP_PMS_VIOLATE_INTR_MAP` reader - reg_core0_backup_pms_violate_intr_map
pub type BACKUP_PMS_VIOLATE_INTR_MAP_R = crate::FieldReader;
///Field `BACKUP_PMS_VIOLATE_INTR_MAP` writer - reg_core0_backup_pms_violate_intr_map
pub type BACKUP_PMS_VIOLATE_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_backup_pms_violate_intr_map
    #[inline(always)]
...
///`reset()` method sets BACKUP_PMS_VIOLATE_INTR_MAP to value 0
