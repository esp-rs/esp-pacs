///Register `DMA_CH0_INT_MAP` reader
pub type R = crate::R<DMA_CH0_INT_MAP_SPEC>;
///Register `DMA_CH0_INT_MAP` writer
pub type W = crate::W<DMA_CH0_INT_MAP_SPEC>;
///Field `DMA_CH0_INT_MAP` reader - reg_core0_dma_ch0_int_map
pub type DMA_CH0_INT_MAP_R = crate::FieldReader;
///Field `DMA_CH0_INT_MAP` writer - reg_core0_dma_ch0_int_map
pub type DMA_CH0_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_dma_ch0_int_map
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`dma_ch0_int_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dma_ch0_int_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DMA_CH0_INT_MAP_SPEC;
impl crate::RegisterSpec for DMA_CH0_INT_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dma_ch0_int_map::R`](R) reader structure
impl crate::Readable for DMA_CH0_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`dma_ch0_int_map::W`](W) writer structure
impl crate::Writable for DMA_CH0_INT_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMA_CH0_INT_MAP to value 0
