...
///Field `SLC1_INTR_MAP` reader - reg_core0_slc1_intr_map
pub type SLC1_INTR_MAP_R = crate::FieldReader;
///Field `SLC1_INTR_MAP` writer - reg_core0_slc1_intr_map
pub type SLC1_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_slc1_intr_map
    #[inline(always)]
...
///`reset()` method sets SLC1_INTR_MAP to value 0
