...
///Field `APB_ADC_INT_MAP` reader - reg_core0_apb_adc_int_map
pub type APB_ADC_INT_MAP_R = crate::FieldReader;
///Field `APB_ADC_INT_MAP` writer - reg_core0_apb_adc_int_map
...
///`reset()` method sets APB_ADC_INT_MAP to value 0
