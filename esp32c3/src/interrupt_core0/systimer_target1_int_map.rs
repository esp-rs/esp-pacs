...
///Field `SYSTIMER_TARGET1_INT_MAP` reader - reg_core0_systimer_target1_int_map
pub type SYSTIMER_TARGET1_INT_MAP_R = crate::FieldReader;
///Field `SYSTIMER_TARGET1_INT_MAP` writer - reg_core0_systimer_target1_int_map
pub type SYSTIMER_TARGET1_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_systimer_target1_int_map
    #[inline(always)]
