...
///Field `BT_MAC_INT_MAP` reader - reg_core0_bt_mac_int_map
pub type BT_MAC_INT_MAP_R = crate::FieldReader;
///Field `BT_MAC_INT_MAP` writer - reg_core0_bt_mac_int_map
pub type BT_MAC_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_bt_mac_int_map
    #[inline(always)]
...
///`reset()` method sets BT_MAC_INT_MAP to value 0
