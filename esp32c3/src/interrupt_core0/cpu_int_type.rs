///Register `CPU_INT_TYPE` reader
pub type R = crate::R<CPU_INT_TYPE_SPEC>;
///Register `CPU_INT_TYPE` writer
pub type W = crate::W<CPU_INT_TYPE_SPEC>;
///Field `CPU_INT_TYPE` reader - reg_core0_cpu_int_type
pub type CPU_INT_TYPE_R = crate::FieldReader<u32>;
///Field `CPU_INT_TYPE` writer - reg_core0_cpu_int_type
pub type CPU_INT_TYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - reg_core0_cpu_int_type
    #[inline(always)]
