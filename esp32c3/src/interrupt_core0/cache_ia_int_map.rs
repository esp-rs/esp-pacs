...
#[doc = "Field `CACHE_IA_INT_MAP` reader - reg_core0_cache_ia_int_map"]
pub type CACHE_IA_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CACHE_IA_INT_MAP` writer - reg_core0_cache_ia_int_map"]
pub type CACHE_IA_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - reg_core0_cache_ia_int_map"]
    #[inline(always)]
...
#[doc = "`reset()` method sets CACHE_IA_INT_MAP to value 0"]
