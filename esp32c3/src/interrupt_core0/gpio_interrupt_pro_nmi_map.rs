...
///Field `GPIO_INTERRUPT_PRO_NMI_MAP` reader - reg_core0_gpio_interrupt_pro_nmi_map
pub type GPIO_INTERRUPT_PRO_NMI_MAP_R = crate::FieldReader;
///Field `GPIO_INTERRUPT_PRO_NMI_MAP` writer - reg_core0_gpio_interrupt_pro_nmi_map
pub type GPIO_INTERRUPT_PRO_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_gpio_interrupt_pro_nmi_map
    #[inline(always)]
