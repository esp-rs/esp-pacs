...
///Field `TG_T0_INT_MAP` reader - reg_core0_tg_t0_int_map
pub type TG_T0_INT_MAP_R = crate::FieldReader;
///Field `TG_T0_INT_MAP` writer - reg_core0_tg_t0_int_map
pub type TG_T0_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - reg_core0_tg_t0_int_map
    #[inline(always)]
...
///`reset()` method sets TG_T0_INT_MAP to value 0
