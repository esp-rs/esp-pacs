...
///Field `TEXT_IN` reader - This bits stores text_in_0 that is a part of source text material.
pub type TEXT_IN_R = crate::FieldReader<u32>;
///Field `TEXT_IN` writer - This bits stores text_in_0 that is a part of source text material.
pub type TEXT_IN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
    ///Bits 0:31 - This bits stores text_in_0 that is a part of source text material.
    #[inline(always)]
