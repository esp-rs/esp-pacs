...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn text_in_2(&mut self) -> TEXT_IN_2_W<TEXT_IN_2_SPEC> {
        TEXT_IN_2_W::new(self, 0)
    }
}
