...
impl RegisterBlock {
    ///0x00..0x10 - Cluster INT_CH%s, containing INT_RAW_CH?, INT_ST_CH?, INT_ENA_CH?, INT_CLR_CH?
    #[inline(always)]
...
///DMA_AHB_TEST_REG.
pub mod ahb_test;
/**MISC_CONF (rw) register accessor: DMA_MISC_CONF_REG.
...
///DMA_MISC_CONF_REG.
pub mod misc_conf;
/**DATE (rw) register accessor: DMA_DATE_REG.
