...
///Field `CALC_DONE` reader - The interrupt enable bit for the i2s_rx_done_int interrupt
pub type CALC_DONE_R = crate::BitReader;
///Field `CALC_DONE` writer - The interrupt enable bit for the i2s_rx_done_int interrupt
