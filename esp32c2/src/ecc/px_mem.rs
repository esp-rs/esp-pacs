...
pub struct R(crate::R<PX_MEM_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PX_MEM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PX_MEM_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PX_MEM_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PX_MEM[%s]` writer"]
pub struct W(crate::W<PX_MEM_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PX_MEM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PX_MEM_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PX_MEM_SPEC>) -> Self {
        W(writer)
    }
}
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PX_MEM_SPEC> {
