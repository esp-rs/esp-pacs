...
///Field `DATE` reader - This is the the version register.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - This is the the version register.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This is the the version register.
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x0210_6243
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0210_6243;
}
