...
pub type TXFIFO_START_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TXFIFO_START_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - This is the I2C txfifo first address."]
    #[inline(always)]
    pub fn txfifo_start_addr(&mut self) -> TXFIFO_START_ADDR_W<0> {
