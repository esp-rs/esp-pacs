...
pub type PADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
impl R {
    #[doc = "Bits 0:5 - Physical page number"]
    #[inline(always)]
    pub fn paddr(&self) -> PADDR_R {
        PADDR_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bit 6 - Set to mark this entry invalid"]
    #[inline(always)]
    pub fn invalid(&self) -> INVALID_R {
        INVALID_R::new(((self.bits >> 6) & 1) != 0)
    }
}
