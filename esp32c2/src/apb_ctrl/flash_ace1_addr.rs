...
///Field `S` reader - reg_flash_ace1_addr_s
pub type S_R = crate::FieldReader<u32>;
///Field `S` writer - reg_flash_ace1_addr_s
pub type S_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - reg_flash_ace1_addr_s
    #[inline(always)]
    pub fn s(&self) -> S_R {
        S_R::new(self.bits)
    }
...
///`reset()` method sets FLASH_ACE1_ADDR to value 0x0040_0000
