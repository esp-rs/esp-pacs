...
///Field `FLASH_ACE1_SIZE` reader - reg_flash_ace1_size
pub type FLASH_ACE1_SIZE_R = crate::FieldReader<u16>;
///Field `FLASH_ACE1_SIZE` writer - reg_flash_ace1_size
pub type FLASH_ACE1_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
impl R {
    ///Bits 0:12 - reg_flash_ace1_size
    #[inline(always)]
...
///`reset()` method sets FLASH_ACE1_SIZE to value 0x0400
