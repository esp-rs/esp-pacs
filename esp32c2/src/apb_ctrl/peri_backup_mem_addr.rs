///Register `PERI_BACKUP_MEM_ADDR` reader
pub type R = crate::R<PERI_BACKUP_MEM_ADDR_SPEC>;
///Register `PERI_BACKUP_MEM_ADDR` writer
pub type W = crate::W<PERI_BACKUP_MEM_ADDR_SPEC>;
///Field `BACKUP_MEM_START_ADDR` reader - reg_backup_mem_start_addr
pub type BACKUP_MEM_START_ADDR_R = crate::FieldReader<u32>;
///Field `BACKUP_MEM_START_ADDR` writer - reg_backup_mem_start_addr
pub type BACKUP_MEM_START_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - reg_backup_mem_start_addr
    #[inline(always)]
...
///`read()` method returns [`peri_backup_mem_addr::R`](R) reader structure
impl crate::Readable for PERI_BACKUP_MEM_ADDR_SPEC {}
///`write(|w| ..)` method takes [`peri_backup_mem_addr::W`](W) writer structure
impl crate::Writable for PERI_BACKUP_MEM_ADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PERI_BACKUP_MEM_ADDR to value 0
