///Register `PERI_BACKUP_INT_ST` reader
pub type R = crate::R<PERI_BACKUP_INT_ST_SPEC>;
///Field `DONE` reader - reg_peri_backup_done_int_st
pub type DONE_R = crate::BitReader;
///Field `ERR` reader - reg_peri_backup_err_int_st
pub type ERR_R = crate::BitReader;
impl R {
    ///Bit 0 - reg_peri_backup_done_int_st
    #[inline(always)]
    pub fn done(&self) -> DONE_R {
        DONE_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - reg_peri_backup_err_int_st
    #[inline(always)]
...
///`read()` method returns [`peri_backup_int_st::R`](R) reader structure
impl crate::Readable for PERI_BACKUP_INT_ST_SPEC {}
///`reset()` method sets PERI_BACKUP_INT_ST to value 0
