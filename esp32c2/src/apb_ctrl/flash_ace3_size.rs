///Register `FLASH_ACE3_SIZE` reader
pub type R = crate::R<FLASH_ACE3_SIZE_SPEC>;
///Register `FLASH_ACE3_SIZE` writer
pub type W = crate::W<FLASH_ACE3_SIZE_SPEC>;
///Field `FLASH_ACE3_SIZE` reader - reg_flash_ace3_size
pub type FLASH_ACE3_SIZE_R = crate::FieldReader<u16>;
///Field `FLASH_ACE3_SIZE` writer - reg_flash_ace3_size
pub type FLASH_ACE3_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
impl R {
    ///Bits 0:12 - reg_flash_ace3_size
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FLASH_ACE3_SIZE")
            .field("flash_ace3_size", &self.flash_ace3_size())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flash_ace3_size(&mut self) -> FLASH_ACE3_SIZE_W<FLASH_ACE3_SIZE_SPEC> {
        FLASH_ACE3_SIZE_W::new(self, 0)
    }
}
...
///`read()` method returns [`flash_ace3_size::R`](R) reader structure
impl crate::Readable for FLASH_ACE3_SIZE_SPEC {}
///`write(|w| ..)` method takes [`flash_ace3_size::W`](W) writer structure
impl crate::Writable for FLASH_ACE3_SIZE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FLASH_ACE3_SIZE to value 0x0400
