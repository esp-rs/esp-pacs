...
///`read()` method returns [`flash_ace0_size::R`](R) reader structure
impl crate::Readable for FLASH_ACE0_SIZE_SPEC {}
///`write(|w| ..)` method takes [`flash_ace0_size::W`](W) writer structure
impl crate::Writable for FLASH_ACE0_SIZE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FLASH_ACE0_SIZE to value 0x0400
