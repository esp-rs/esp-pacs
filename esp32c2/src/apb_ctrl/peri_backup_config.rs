///Register `PERI_BACKUP_CONFIG` reader
pub type R = crate::R<PERI_BACKUP_CONFIG_SPEC>;
///Register `PERI_BACKUP_CONFIG` writer
pub type W = crate::W<PERI_BACKUP_CONFIG_SPEC>;
///Field `PERI_BACKUP_FLOW_ERR` reader - reg_peri_backup_flow_err
pub type PERI_BACKUP_FLOW_ERR_R = crate::FieldReader;
///Field `PERI_BACKUP_BURST_LIMIT` reader - reg_peri_backup_burst_limit
pub type PERI_BACKUP_BURST_LIMIT_R = crate::FieldReader;
///Field `PERI_BACKUP_BURST_LIMIT` writer - reg_peri_backup_burst_limit
pub type PERI_BACKUP_BURST_LIMIT_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `PERI_BACKUP_TOUT_THRES` reader - reg_peri_backup_tout_thres
pub type PERI_BACKUP_TOUT_THRES_R = crate::FieldReader<u16>;
///Field `PERI_BACKUP_TOUT_THRES` writer - reg_peri_backup_tout_thres
pub type PERI_BACKUP_TOUT_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `PERI_BACKUP_SIZE` reader - reg_peri_backup_size
pub type PERI_BACKUP_SIZE_R = crate::FieldReader<u16>;
///Field `PERI_BACKUP_SIZE` writer - reg_peri_backup_size
pub type PERI_BACKUP_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `PERI_BACKUP_START` writer - reg_peri_backup_start
pub type PERI_BACKUP_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PERI_BACKUP_TO_MEM` reader - reg_peri_backup_to_mem
pub type PERI_BACKUP_TO_MEM_R = crate::BitReader;
///Field `PERI_BACKUP_TO_MEM` writer - reg_peri_backup_to_mem
pub type PERI_BACKUP_TO_MEM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PERI_BACKUP_ENA` reader - reg_peri_backup_ena
pub type PERI_BACKUP_ENA_R = crate::BitReader;
///Field `PERI_BACKUP_ENA` writer - reg_peri_backup_ena
...
///`read()` method returns [`peri_backup_config::R`](R) reader structure
impl crate::Readable for PERI_BACKUP_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`peri_backup_config::W`](W) writer structure
impl crate::Writable for PERI_BACKUP_CONFIG_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PERI_BACKUP_CONFIG to value 0x6480
