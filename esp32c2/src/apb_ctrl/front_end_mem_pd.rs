///Register `FRONT_END_MEM_PD` reader
pub type R = crate::R<FRONT_END_MEM_PD_SPEC>;
///Register `FRONT_END_MEM_PD` writer
pub type W = crate::W<FRONT_END_MEM_PD_SPEC>;
///Field `AGC_MEM_FORCE_PU` reader - reg_agc_mem_force_pu
pub type AGC_MEM_FORCE_PU_R = crate::BitReader;
///Field `AGC_MEM_FORCE_PU` writer - reg_agc_mem_force_pu
pub type AGC_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AGC_MEM_FORCE_PD` reader - reg_agc_mem_force_pd
pub type AGC_MEM_FORCE_PD_R = crate::BitReader;
///Field `AGC_MEM_FORCE_PD` writer - reg_agc_mem_force_pd
pub type AGC_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PBUS_MEM_FORCE_PU` reader - reg_pbus_mem_force_pu
pub type PBUS_MEM_FORCE_PU_R = crate::BitReader;
///Field `PBUS_MEM_FORCE_PU` writer - reg_pbus_mem_force_pu
pub type PBUS_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PBUS_MEM_FORCE_PD` reader - reg_pbus_mem_force_pd
pub type PBUS_MEM_FORCE_PD_R = crate::BitReader;
///Field `PBUS_MEM_FORCE_PD` writer - reg_pbus_mem_force_pd
pub type PBUS_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DC_MEM_FORCE_PU` reader - reg_dc_mem_force_pu
pub type DC_MEM_FORCE_PU_R = crate::BitReader;
///Field `DC_MEM_FORCE_PU` writer - reg_dc_mem_force_pu
pub type DC_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DC_MEM_FORCE_PD` reader - reg_dc_mem_force_pd
pub type DC_MEM_FORCE_PD_R = crate::BitReader;
///Field `DC_MEM_FORCE_PD` writer - reg_dc_mem_force_pd
pub type DC_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FREQ_MEM_FORCE_PU` reader - reg_freq_mem_force_pu
pub type FREQ_MEM_FORCE_PU_R = crate::BitReader;
///Field `FREQ_MEM_FORCE_PU` writer - reg_freq_mem_force_pu
pub type FREQ_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FREQ_MEM_FORCE_PD` reader - reg_freq_mem_force_pd
pub type FREQ_MEM_FORCE_PD_R = crate::BitReader;
///Field `FREQ_MEM_FORCE_PD` writer - reg_freq_mem_force_pd
...
///`read()` method returns [`front_end_mem_pd::R`](R) reader structure
impl crate::Readable for FRONT_END_MEM_PD_SPEC {}
///`write(|w| ..)` method takes [`front_end_mem_pd::W`](W) writer structure
