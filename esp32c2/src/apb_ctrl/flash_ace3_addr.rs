///Register `FLASH_ACE3_ADDR` reader
pub type R = crate::R<FLASH_ACE3_ADDR_SPEC>;
///Register `FLASH_ACE3_ADDR` writer
pub type W = crate::W<FLASH_ACE3_ADDR_SPEC>;
///Field `S` reader - reg_flash_ace3_addr_s
pub type S_R = crate::FieldReader<u32>;
///Field `S` writer - reg_flash_ace3_addr_s
pub type S_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - reg_flash_ace3_addr_s
    #[inline(always)]
    pub fn s(&self) -> S_R {
        S_R::new(self.bits)
    }
...
///`read()` method returns [`flash_ace3_addr::R`](R) reader structure
impl crate::Readable for FLASH_ACE3_ADDR_SPEC {}
///`write(|w| ..)` method takes [`flash_ace3_addr::W`](W) writer structure
impl crate::Writable for FLASH_ACE3_ADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FLASH_ACE3_ADDR to value 0x00c0_0000
