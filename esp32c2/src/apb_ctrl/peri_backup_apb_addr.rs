...
#[doc = "APB_CTRL_PERI_BACKUP_APB_ADDR_REG_REG\n\nYou can [`read`](crate::Reg::read) this register and get [`peri_backup_apb_addr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`peri_backup_apb_addr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
