...
#[doc = "Field `S` reader - reg_flash_ace2_addr_s"]
pub type S_R = crate::FieldReader<u32>;
#[doc = "Field `S` writer - reg_flash_ace2_addr_s"]
pub type S_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31 - reg_flash_ace2_addr_s"]
    #[inline(always)]
    pub fn s(&self) -> S_R {
        S_R::new(self.bits)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn s(&mut self) -> S_W<FLASH_ACE2_ADDR_SPEC, 0> {
        S_W::new(self)
    }
...
#[doc = "`reset()` method sets FLASH_ACE2_ADDR to value 0x0080_0000"]
