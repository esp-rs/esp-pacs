...
/**SYSCLK_CONF (rw) register accessor: APB_CTRL_SYSCLK_CONF_REG
...
pub mod tick_conf;
/**CLK_OUT_EN (rw) register accessor: APB_CTRL_CLK_OUT_EN_REG
...
pub mod clk_out_en;
/**WIFI_BB_CFG (rw) register accessor: APB_CTRL_WIFI_BB_CFG_REG
...
pub mod wifi_bb_cfg;
/**WIFI_BB_CFG_2 (rw) register accessor: APB_CTRL_WIFI_BB_CFG_2_REG
...
pub mod wifi_rst_en;
/**HOST_INF_SEL (rw) register accessor: APB_CTRL_HOST_INF_SEL_REG
...
/**EXT_MEM_PMS_LOCK (rw) register accessor: APB_CTRL_EXT_MEM_PMS_LOCK_REG
...
/**FLASH_ACE0_ATTR (rw) register accessor: APB_CTRL_FLASH_ACE0_ATTR_REG
...
/**FLASH_ACE1_ATTR (rw) register accessor: APB_CTRL_FLASH_ACE1_ATTR_REG
...
/**FLASH_ACE2_ATTR (rw) register accessor: APB_CTRL_FLASH_ACE2_ATTR_REG
...
/**FLASH_ACE3_ATTR (rw) register accessor: APB_CTRL_FLASH_ACE3_ATTR_REG
...
/**FLASH_ACE0_ADDR (rw) register accessor: APB_CTRL_FLASH_ACE0_ADDR_REG
...
/**FLASH_ACE1_ADDR (rw) register accessor: APB_CTRL_FLASH_ACE1_ADDR_REG
...
/**FLASH_ACE2_ADDR (rw) register accessor: APB_CTRL_FLASH_ACE2_ADDR_REG
...
/**FLASH_ACE3_ADDR (rw) register accessor: APB_CTRL_FLASH_ACE3_ADDR_REG
...
/**FLASH_ACE0_SIZE (rw) register accessor: APB_CTRL_FLASH_ACE0_SIZE_REG
...
/**FLASH_ACE1_SIZE (rw) register accessor: APB_CTRL_FLASH_ACE1_SIZE_REG
...
/**FLASH_ACE2_SIZE (rw) register accessor: APB_CTRL_FLASH_ACE2_SIZE_REG
...
/**FLASH_ACE3_SIZE (rw) register accessor: APB_CTRL_FLASH_ACE3_SIZE_REG
...
/**SPI_MEM_PMS_CTRL (rw) register accessor: APB_CTRL_SPI_MEM_PMS_CTRL_REG
...
/**SPI_MEM_REJECT_ADDR (r) register accessor: APB_CTRL_SPI_MEM_REJECT_ADDR_REG
...
pub mod sdio_ctrl;
/**REDCY_SIG0 (rw) register accessor: APB_CTRL_REDCY_SIG0_REG_REG
...
pub mod redcy_sig0;
/**REDCY_SIG1 (rw) register accessor: APB_CTRL_REDCY_SIG1_REG_REG
...
pub mod redcy_sig1;
/**FRONT_END_MEM_PD (rw) register accessor: APB_CTRL_FRONT_END_MEM_PD_REG
...
/**RETENTION_CTRL (rw) register accessor: APB_CTRL_RETENTION_CTRL_REG
...
/**CLKGATE_FORCE_ON (rw) register accessor: Memory power configuration registers
...
/**MEM_POWER_UP (rw) register accessor: Memory power configuration registers
...
/**RND_DATA (r) register accessor: APB_CTRL_RND_DATA_REG
...
pub mod rnd_data;
/**PERI_BACKUP_CONFIG (rw) register accessor: APB_CTRL_PERI_BACKUP_CONFIG_REG_REG
...
/**PERI_BACKUP_APB_ADDR (rw) register accessor: APB_CTRL_PERI_BACKUP_APB_ADDR_REG_REG
...
/**PERI_BACKUP_INT_ST (r) register accessor: APB_CTRL_PERI_BACKUP_INT_ST_REG
...
/**PERI_BACKUP_INT_ENA (rw) register accessor: APB_CTRL_PERI_BACKUP_INT_ENA_REG
...
/**PERI_BACKUP_INT_CLR (w) register accessor: APB_CTRL_PERI_BACKUP_INT_CLR_REG
...
/**DATE (rw) register accessor: APB_CTRL_DATE_REG
