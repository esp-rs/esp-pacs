...
#[doc = "Field `OVF` reader - The interrupt enable bit for the LEDC_TIMER0_OVF_INT interrupt."]
pub type OVF_R = crate::BitReader;
#[doc = "Field `OVF` writer - The interrupt enable bit for the LEDC_TIMER0_OVF_INT interrupt."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovf(&mut self) -> OVF_W<INT_ENA_SPEC> {
        OVF_W::new(self, 0)
    }
    #[doc = "Bit 1 - The interrupt enable bit for the LEDC_TIMER1_OVF_INT interrupt."]
    #[inline(always)]
