...
pub type OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `OVF_INT_ENA` writer - The interrupt enable bit for the LEDC_TIMER0_OVF_INT interrupt."]
pub type OVF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            .field("ovf_int_ena", &format_args!("{}", self.ovf_int_ena().bit()))
            .field(
                "timer1_ovf_int_ena",
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovf_int_ena(&mut self) -> OVF_INT_ENA_W<INT_ENA_SPEC, 0> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch0_int_ena(&mut self) -> OVF_CNT_CH0_INT_ENA_W<INT_ENA_SPEC, 10> {
        OVF_CNT_CH0_INT_ENA_W::new(self)
    }
    #[doc = "Bit 11 - The interrupt enable bit for the LEDC_OVF_CNT_CH1_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch1_int_ena(&mut self) -> OVF_CNT_CH1_INT_ENA_W<INT_ENA_SPEC, 11> {
        OVF_CNT_CH1_INT_ENA_W::new(self)
    }
    #[doc = "Bit 12 - The interrupt enable bit for the LEDC_OVF_CNT_CH2_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch2_int_ena(&mut self) -> OVF_CNT_CH2_INT_ENA_W<INT_ENA_SPEC, 12> {
        OVF_CNT_CH2_INT_ENA_W::new(self)
    }
    #[doc = "Bit 13 - The interrupt enable bit for the LEDC_OVF_CNT_CH3_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch3_int_ena(&mut self) -> OVF_CNT_CH3_INT_ENA_W<INT_ENA_SPEC, 13> {
        OVF_CNT_CH3_INT_ENA_W::new(self)
    }
    #[doc = "Bit 14 - The interrupt enable bit for the LEDC_OVF_CNT_CH4_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch4_int_ena(&mut self) -> OVF_CNT_CH4_INT_ENA_W<INT_ENA_SPEC, 14> {
        OVF_CNT_CH4_INT_ENA_W::new(self)
    }
    #[doc = "Bit 15 - The interrupt enable bit for the LEDC_OVF_CNT_CH5_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch5_int_ena(&mut self) -> OVF_CNT_CH5_INT_ENA_W<INT_ENA_SPEC, 15> {
