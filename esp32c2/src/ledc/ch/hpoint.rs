...
///Field `HPOINT` reader - The output value changes to high when the selected timers has reached the value specified by this register.
pub type HPOINT_R = crate::FieldReader<u16>;
///Field `HPOINT` writer - The output value changes to high when the selected timers has reached the value specified by this register.
pub type HPOINT_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    ///Bits 0:13 - The output value changes to high when the selected timers has reached the value specified by this register.
    #[inline(always)]
