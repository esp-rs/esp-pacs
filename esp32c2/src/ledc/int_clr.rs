...
pub type OVF_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovf_int_clr(&mut self) -> OVF_INT_CLR_W<INT_CLR_SPEC, 0> {
