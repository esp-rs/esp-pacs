...
pub type OVF_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type TIMER1_OVF_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type TIMER2_OVF_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type TIMER3_OVF_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type DUTY_CHNG_END_CH0_INT_RAW_W<'a, const O: u8> =
...
pub type DUTY_CHNG_END_CH1_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type DUTY_CHNG_END_CH2_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type DUTY_CHNG_END_CH3_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type DUTY_CHNG_END_CH4_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type DUTY_CHNG_END_CH5_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type OVF_CNT_CH0_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type OVF_CNT_CH1_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type OVF_CNT_CH2_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type OVF_CNT_CH3_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type OVF_CNT_CH4_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
pub type OVF_CNT_CH5_INT_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
impl R {
    ...
    pub fn ovf_cnt_ch0_int_raw(&self) -> OVF_CNT_CH0_INT_RAW_R {
        OVF_CNT_CH0_INT_RAW_R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    pub fn ovf_cnt_ch1_int_raw(&self) -> OVF_CNT_CH1_INT_RAW_R {
        OVF_CNT_CH1_INT_RAW_R::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn ovf_cnt_ch2_int_raw(&self) -> OVF_CNT_CH2_INT_RAW_R {
        OVF_CNT_CH2_INT_RAW_R::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    pub fn ovf_cnt_ch3_int_raw(&self) -> OVF_CNT_CH3_INT_RAW_R {
        OVF_CNT_CH3_INT_RAW_R::new(((self.bits >> 13) & 1) != 0)
    }
    ...
    pub fn ovf_cnt_ch4_int_raw(&self) -> OVF_CNT_CH4_INT_RAW_R {
        OVF_CNT_CH4_INT_RAW_R::new(((self.bits >> 14) & 1) != 0)
    }
    ...
    pub fn ovf_cnt_ch5_int_raw(&self) -> OVF_CNT_CH5_INT_RAW_R {
        OVF_CNT_CH5_INT_RAW_R::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Triggered when the timer0 has reached its maximum counter value."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_int_raw(&mut self) -> OVF_INT_RAW_W<0> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch0_int_raw(&mut self) -> OVF_CNT_CH0_INT_RAW_W<10> {
        OVF_CNT_CH0_INT_RAW_W::new(self)
    }
    #[doc = "Bit 11 - Interrupt raw bit for channel 1. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH1."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch1_int_raw(&mut self) -> OVF_CNT_CH1_INT_RAW_W<11> {
        OVF_CNT_CH1_INT_RAW_W::new(self)
    }
    #[doc = "Bit 12 - Interrupt raw bit for channel 2. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH2."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch2_int_raw(&mut self) -> OVF_CNT_CH2_INT_RAW_W<12> {
        OVF_CNT_CH2_INT_RAW_W::new(self)
    }
    #[doc = "Bit 13 - Interrupt raw bit for channel 3. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH3."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch3_int_raw(&mut self) -> OVF_CNT_CH3_INT_RAW_W<13> {
        OVF_CNT_CH3_INT_RAW_W::new(self)
    }
    #[doc = "Bit 14 - Interrupt raw bit for channel 4. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH4."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch4_int_raw(&mut self) -> OVF_CNT_CH4_INT_RAW_W<14> {
        OVF_CNT_CH4_INT_RAW_W::new(self)
    }
    #[doc = "Bit 15 - Interrupt raw bit for channel 5. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH5."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch5_int_raw(&mut self) -> OVF_CNT_CH5_INT_RAW_W<15> {
