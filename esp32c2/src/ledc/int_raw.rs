...
#[doc = "Field `OVF` reader - Triggered when the timer0 has reached its maximum counter value."]
pub type OVF_R = crate::BitReader;
#[doc = "Field `OVF` writer - Triggered when the timer0 has reached its maximum counter value."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovf(&mut self) -> OVF_W<INT_RAW_SPEC> {
        OVF_W::new(self, 0)
    }
    #[doc = "Bit 1 - Triggered when the timer1 has reached its maximum counter value."]
    #[inline(always)]
