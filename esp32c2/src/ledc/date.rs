...
pub type LEDC_DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LEDC_DATE` writer - This is the version control register."]
pub type LEDC_DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATE_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ledc_date(&mut self) -> LEDC_DATE_W<0> {
...
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x1906_1700;
}
