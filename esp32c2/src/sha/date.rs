...
///Field `DATE` reader - Sha date information/ sha version information.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - Sha date information/ sha version information.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Sha date information/ sha version information.
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x2020_0616
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x2020_0616;
}
