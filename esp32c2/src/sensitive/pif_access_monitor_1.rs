...
pub type PIF_ACCESS_MONITOR_NONWORD_VIOLATE_CLR_R = crate::BitReader<bool>;
...
pub type PIF_ACCESS_MONITOR_NONWORD_VIOLATE_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PIF_ACCESS_MONITOR_1_SPEC, bool, O>;
#[doc = "Field `PIF_ACCESS_MONITOR_NONWORD_VIOLATE_EN` reader - Need add description"]
pub type PIF_ACCESS_MONITOR_NONWORD_VIOLATE_EN_R = crate::BitReader<bool>;
