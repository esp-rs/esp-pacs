///Register `PIF_ACCESS_MONITOR_3` reader
pub type R = crate::R<PIF_ACCESS_MONITOR_3_SPEC>;
///Field `PIF_ACCESS_MONITOR_NONWORD_VIOLATE_STATUS_HADDR` reader - Need add description
...
///`read()` method returns [`pif_access_monitor_3::R`](R) reader structure
impl crate::Readable for PIF_ACCESS_MONITOR_3_SPEC {}
///`reset()` method sets PIF_ACCESS_MONITOR_3 to value 0
