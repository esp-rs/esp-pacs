///Register `PIF_ACCESS_MONITOR_2` reader
pub type R = crate::R<PIF_ACCESS_MONITOR_2_SPEC>;
///Field `PIF_ACCESS_MONITOR_NONWORD_VIOLATE_INTR` reader - Need add description
pub type PIF_ACCESS_MONITOR_NONWORD_VIOLATE_INTR_R = crate::BitReader;
///Field `PIF_ACCESS_MONITOR_NONWORD_VIOLATE_STATUS_HSIZE` reader - Need add description
...
///`read()` method returns [`pif_access_monitor_2::R`](R) reader structure
impl crate::Readable for PIF_ACCESS_MONITOR_2_SPEC {}
///`reset()` method sets PIF_ACCESS_MONITOR_2 to value 0
