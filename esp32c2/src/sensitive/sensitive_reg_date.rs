///Register `SENSITIVE_REG_DATE` reader
pub type R = crate::R<SENSITIVE_REG_DATE_SPEC>;
///Register `SENSITIVE_REG_DATE` writer
pub type W = crate::W<SENSITIVE_REG_DATE_SPEC>;
///Field `SENSITIVE_REG_DATE` reader - Need add description
pub type SENSITIVE_REG_DATE_R = crate::FieldReader<u32>;
///Field `SENSITIVE_REG_DATE` writer - Need add description
pub type SENSITIVE_REG_DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SENSITIVE_REG_DATE")
            .field("sensitive_reg_date", &self.sensitive_reg_date())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`sensitive_reg_date::R`](R) reader structure
impl crate::Readable for SENSITIVE_REG_DATE_SPEC {}
///`write(|w| ..)` method takes [`sensitive_reg_date::W`](W) writer structure
impl crate::Writable for SENSITIVE_REG_DATE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SENSITIVE_REG_DATE to value 0x0210_6301
impl crate::Resettable for SENSITIVE_REG_DATE_SPEC {
    const RESET_VALUE: u32 = 0x0210_6301;
}
