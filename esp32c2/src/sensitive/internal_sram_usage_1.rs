...
///Field `INTERNAL_SRAM_USAGE_CPU_CACHE` reader - Need add description
pub type INTERNAL_SRAM_USAGE_CPU_CACHE_R = crate::BitReader;
///Field `INTERNAL_SRAM_USAGE_CPU_CACHE` writer - Need add description
pub type INTERNAL_SRAM_USAGE_CPU_CACHE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTERNAL_SRAM_USAGE_CPU_SRAM` reader - Need add description
pub type INTERNAL_SRAM_USAGE_CPU_SRAM_R = crate::FieldReader;
///Field `INTERNAL_SRAM_USAGE_CPU_SRAM` writer - Need add description
