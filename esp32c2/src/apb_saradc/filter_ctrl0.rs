...
///Field `FILTER_CHANNEL1` reader - Need add description
pub type FILTER_CHANNEL1_R = crate::FieldReader;
///Field `FILTER_CHANNEL1` writer - Need add description
pub type FILTER_CHANNEL1_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `FILTER_CHANNEL0` reader - apb_adc1_filter_factor
pub type FILTER_CHANNEL0_R = crate::FieldReader;
///Field `FILTER_CHANNEL0` writer - apb_adc1_filter_factor
...
impl R {
    ///Bits 18:21 - Need add description
    #[inline(always)]
