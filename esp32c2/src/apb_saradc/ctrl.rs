...
///Field `START_FORCE` reader - Need add description
pub type START_FORCE_R = crate::BitReader;
///Field `START_FORCE` writer - Need add description
pub type START_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `START` reader - Need add description
pub type START_R = crate::BitReader;
///Field `START` writer - Need add description
pub type START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_CLK_GATED` reader - Need add description
pub type SAR_CLK_GATED_R = crate::BitReader;
///Field `SAR_CLK_GATED` writer - Need add description
