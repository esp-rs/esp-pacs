...
///Field `ONETIME_ATTEN` reader - Need add description
pub type ONETIME_ATTEN_R = crate::FieldReader;
///Field `ONETIME_ATTEN` writer - Need add description
pub type ONETIME_ATTEN_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `ONETIME_CHANNEL` reader - Need add description
pub type ONETIME_CHANNEL_R = crate::FieldReader;
///Field `ONETIME_CHANNEL` writer - Need add description
pub type ONETIME_CHANNEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `ONETIME_START` reader - Need add description
pub type ONETIME_START_R = crate::BitReader;
///Field `ONETIME_START` writer - Need add description
pub type ONETIME_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC2_ONETIME_SAMPLE` reader - Need add description
pub type SARADC2_ONETIME_SAMPLE_R = crate::BitReader;
///Field `SARADC2_ONETIME_SAMPLE` writer - Need add description
pub type SARADC2_ONETIME_SAMPLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC1_ONETIME_SAMPLE` reader - Need add description
pub type SARADC1_ONETIME_SAMPLE_R = crate::BitReader;
///Field `SARADC1_ONETIME_SAMPLE` writer - Need add description
