...
pub type REG_CLKM_DIV_NUM_W<'a> = crate::FieldWriter<'a, u32, APB_ADC_CLKM_CONF_SPEC, u8, u8, 8, 0>;
...
pub type REG_CLKM_DIV_B_W<'a> = crate::FieldWriter<'a, u32, APB_ADC_CLKM_CONF_SPEC, u8, u8, 6, 8>;
...
pub type REG_CLKM_DIV_A_W<'a> = crate::FieldWriter<'a, u32, APB_ADC_CLKM_CONF_SPEC, u8, u8, 6, 14>;
#[doc = "Field `CLK_EN` reader - Need add description"]
pub type CLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `CLK_EN` writer - Need add description"]
pub type CLK_EN_W<'a> = crate::BitWriter<'a, u32, APB_ADC_CLKM_CONF_SPEC, bool, 20>;
...
pub type REG_CLK_SEL_W<'a> = crate::FieldWriter<'a, u32, APB_ADC_CLKM_CONF_SPEC, u8, u8, 2, 21>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - Integral I2S clock divider value"]
    #[inline(always)]
    pub fn reg_clkm_div_num(&mut self) -> REG_CLKM_DIV_NUM_W {
        REG_CLKM_DIV_NUM_W::new(self)
    }
    #[doc = "Bits 8:13 - Fractional clock divider numerator value"]
    #[inline(always)]
    pub fn reg_clkm_div_b(&mut self) -> REG_CLKM_DIV_B_W {
        REG_CLKM_DIV_B_W::new(self)
    }
    #[doc = "Bits 14:19 - Fractional clock divider denominator value"]
    #[inline(always)]
    pub fn reg_clkm_div_a(&mut self) -> REG_CLKM_DIV_A_W {
