...
///Field `THRES1_CHANNEL` reader - Need add description
pub type THRES1_CHANNEL_R = crate::FieldReader;
///Field `THRES1_CHANNEL` writer - Need add description
pub type THRES1_CHANNEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `THRES1_HIGH` reader - saradc1's thres0 monitor thres
pub type THRES1_HIGH_R = crate::FieldReader<u16>;
///Field `THRES1_HIGH` writer - saradc1's thres0 monitor thres
pub type THRES1_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `THRES1_LOW` reader - saradc1's thres0 monitor thres
pub type THRES1_LOW_R = crate::FieldReader<u16>;
///Field `THRES1_LOW` writer - saradc1's thres0 monitor thres
