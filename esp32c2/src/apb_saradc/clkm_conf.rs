...
///Field `CLK_EN` reader - Need add description
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - Need add description
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_SEL` reader - Set this bit to enable clk_apll
pub type CLK_SEL_R = crate::FieldReader;
///Field `CLK_SEL` writer - Set this bit to enable clk_apll
