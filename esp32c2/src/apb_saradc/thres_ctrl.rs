...
///Field `THRES_ALL_EN` reader - Need add description
pub type THRES_ALL_EN_R = crate::BitReader;
///Field `THRES_ALL_EN` writer - Need add description
pub type THRES_ALL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES3_EN` reader - Need add description
pub type THRES3_EN_R = crate::BitReader;
///Field `THRES3_EN` writer - Need add description
pub type THRES3_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES2_EN` reader - Need add description
pub type THRES2_EN_R = crate::BitReader;
///Field `THRES2_EN` writer - Need add description
pub type THRES2_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES1_EN` reader - Need add description
pub type THRES1_EN_R = crate::BitReader;
///Field `THRES1_EN` writer - Need add description
pub type THRES1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES0_EN` reader - Need add description
pub type THRES0_EN_R = crate::BitReader;
///Field `THRES0_EN` writer - Need add description
