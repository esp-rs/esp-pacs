...
#[doc = "Field `SARADC_MEAS_NUM_LIMIT` reader - Need add description"]
pub type SARADC_MEAS_NUM_LIMIT_R = crate::BitReader<bool>;
#[doc = "Field `SARADC_MEAS_NUM_LIMIT` writer - Need add description"]
pub type SARADC_MEAS_NUM_LIMIT_W<'a> = crate::BitWriter<'a, u32, CTRL2_SPEC, bool, 0>;
...
pub type SARADC_MAX_MEAS_NUM_W<'a> = crate::FieldWriter<'a, u32, CTRL2_SPEC, u8, u8, 8, 1>;
...
pub type SARADC_SAR1_INV_W<'a> = crate::BitWriter<'a, u32, CTRL2_SPEC, bool, 9>;
...
pub type SARADC_SAR2_INV_W<'a> = crate::BitWriter<'a, u32, CTRL2_SPEC, bool, 10>;
...
pub type SARADC_TIMER_TARGET_W<'a> = crate::FieldWriter<'a, u32, CTRL2_SPEC, u16, u16, 12, 12>;
...
pub type SARADC_TIMER_EN_W<'a> = crate::BitWriter<'a, u32, CTRL2_SPEC, bool, 24>;
impl R {
