...
///Field `XPD_FORCE` reader - Need add description
pub type XPD_FORCE_R = crate::FieldReader;
///Field `XPD_FORCE` writer - Need add description
pub type XPD_FORCE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CLK_INV` reader - Need add description
pub type CLK_INV_R = crate::BitReader;
///Field `CLK_INV` writer - Need add description
pub type CLK_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_SEL` reader - Need add description
pub type CLK_SEL_R = crate::BitReader;
///Field `CLK_SEL` writer - Need add description
