...
pub type OUTLINK_ADDR_CH0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OUT_LINK_CH0_SPEC, u32, u32, 20, O>;
...
pub type OUTLINK_STOP_CH0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, OUT_LINK_CH0_SPEC, bool, O>;
...
pub type OUTLINK_START_CH0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, OUT_LINK_CH0_SPEC, bool, O>;
...
pub type OUTLINK_RESTART_CH0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, OUT_LINK_CH0_SPEC, bool, O>;
...
impl W {
    #[doc = "Bits 0:19 - This register stores the 20 least significant bits of the first outlink descriptor's address."]
    #[inline(always)]
    pub fn outlink_addr_ch0(&mut self) -> OUTLINK_ADDR_CH0_W<0> {
        OUTLINK_ADDR_CH0_W::new(self)
    }
    #[doc = "Bit 20 - Set this bit to stop dealing with the outlink descriptors."]
    #[inline(always)]
    pub fn outlink_stop_ch0(&mut self) -> OUTLINK_STOP_CH0_W<20> {
        OUTLINK_STOP_CH0_W::new(self)
    }
    #[doc = "Bit 21 - Set this bit to start dealing with the outlink descriptors."]
    #[inline(always)]
    pub fn outlink_start_ch0(&mut self) -> OUTLINK_START_CH0_W<21> {
        OUTLINK_START_CH0_W::new(self)
    }
    #[doc = "Bit 22 - Set this bit to restart a new outlink from the last address."]
    #[inline(always)]
    pub fn outlink_restart_ch0(&mut self) -> OUTLINK_RESTART_CH0_W<22> {
