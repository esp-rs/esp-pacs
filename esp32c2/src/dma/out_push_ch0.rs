...
pub type OUTFIFO_WDATA_CH0_W<'a, const O: u8> =
...
pub type OUTFIFO_PUSH_CH0_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, OUT_PUSH_CH0_SPEC, bool, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:8 - This register stores the data that need to be pushed into DMA FIFO."]
    #[inline(always)]
    pub fn outfifo_wdata_ch0(&mut self) -> OUTFIFO_WDATA_CH0_W<0> {
        OUTFIFO_WDATA_CH0_W::new(self)
    }
    #[doc = "Bit 9 - Set this bit to push data into DMA FIFO."]
    #[inline(always)]
    pub fn outfifo_push_ch0(&mut self) -> OUTFIFO_PUSH_CH0_W<9> {
