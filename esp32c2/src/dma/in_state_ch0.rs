...
pub type INLINK_DSCR_ADDR_CH0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `IN_DSCR_STATE_CH0` reader - reserved"]
pub type IN_DSCR_STATE_CH0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IN_STATE_CH0` reader - reserved"]
pub type IN_STATE_CH0_R = crate::FieldReader<u8, u8>;
impl R {
    ...
    pub fn inlink_dscr_addr_ch0(&self) -> INLINK_DSCR_ADDR_CH0_R {
        INLINK_DSCR_ADDR_CH0_R::new((self.bits & 0x0003_ffff) as u32)
    }
