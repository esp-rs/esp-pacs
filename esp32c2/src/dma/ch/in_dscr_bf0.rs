///Register `IN_DSCR_BF0` reader
pub type R = crate::R<IN_DSCR_BF0_SPEC>;
///Field `INLINK_DSCR_BF0` reader - The address of the last inlink descriptor x-1.
pub type INLINK_DSCR_BF0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The address of the last inlink descriptor x-1.
    #[inline(always)]
...
///`read()` method returns [`in_dscr_bf0::R`](R) reader structure
