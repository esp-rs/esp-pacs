...
///Field `REG_DATE` reader - Version control register
pub type REG_DATE_R = crate::FieldReader<u32>;
///Field `REG_DATE` writer - Version control register
...
///`reset()` method sets DATE to value 0x0210_6190
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0210_6190;
}
