...
///Field `STATUS_W1TS` writer - GPIO interrupt status set register for GPIO0-24
pub type STATUS_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
...
impl W {
    ///Bits 0:24 - GPIO interrupt status set register for GPIO0-24
    #[inline(always)]
    #[must_use]
