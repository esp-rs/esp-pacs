#[doc = "Register `PIN16` reader"]
pub struct R(crate::R<PIN16_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIN16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIN16_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIN16_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIN16` writer"]
pub struct W(crate::W<PIN16_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIN16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIN16_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIN16_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SYNC2_BYPASS_W<'a> = crate::FieldWriter<'a, u32, PIN16_SPEC, u8, u8, 2, 0>;
...
pub type PAD_DRIVER_W<'a> = crate::BitWriter<'a, u32, PIN16_SPEC, bool, 2>;
...
pub type SYNC1_BYPASS_W<'a> = crate::FieldWriter<'a, u32, PIN16_SPEC, u8, u8, 2, 3>;
...
pub type INT_TYPE_W<'a> = crate::FieldWriter<'a, u32, PIN16_SPEC, u8, u8, 3, 7>;
...
pub type WAKEUP_ENABLE_W<'a> = crate::BitWriter<'a, u32, PIN16_SPEC, bool, 10>;
#[doc = "Field `CONFIG` reader - reserved"]
pub type CONFIG_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CONFIG` writer - reserved"]
pub type CONFIG_W<'a> = crate::FieldWriter<'a, u32, PIN16_SPEC, u8, u8, 2, 11>;
...
pub type INT_ENA_W<'a> = crate::FieldWriter<'a, u32, PIN16_SPEC, u8, u8, 5, 13>;
impl R {
...
#[doc = "GPIO pin configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pin16](index.html) module"]
pub struct PIN16_SPEC;
impl crate::RegisterSpec for PIN16_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pin16::R](R) reader structure"]
impl crate::Readable for PIN16_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pin16::W](W) writer structure"]
impl crate::Writable for PIN16_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIN16 to value 0"]
impl crate::Resettable for PIN16_SPEC {
    #[inline(always)]
