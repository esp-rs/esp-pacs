...
#[doc = "Field `FUNC94_IN_SEL` reader - set this value: s=0-53: connect GPIO\\[s\\] to this port. s=0x38: set this port always high level. s=0x3C: set this port always low level."]
pub type FUNC94_IN_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FUNC94_IN_SEL` writer - set this value: s=0-53: connect GPIO\\[s\\] to this port. s=0x38: set this port always high level. s=0x3C: set this port always low level."]
pub type FUNC94_IN_SEL_W<'a> = crate::FieldWriter<'a, u32, FUNC94_IN_SEL_CFG_SPEC, u8, u8, 5, 0>;
...
pub type FUNC94_IN_INV_SEL_W<'a> = crate::BitWriter<'a, u32, FUNC94_IN_SEL_CFG_SPEC, bool, 5>;
...
pub type SIG94_IN_SEL_W<'a> = crate::BitWriter<'a, u32, FUNC94_IN_SEL_CFG_SPEC, bool, 6>;
impl R {
...
#[doc = "`reset()` method sets FUNC94_IN_SEL_CFG to value 0"]
