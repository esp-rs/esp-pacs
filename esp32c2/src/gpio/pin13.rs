...
pub struct R(crate::R<PIN13_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIN13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIN13_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIN13_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIN13` writer"]
pub struct W(crate::W<PIN13_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIN13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIN13_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIN13_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SYNC2_BYPASS_W<'a> = crate::FieldWriter<'a, u32, PIN13_SPEC, u8, u8, 2, 0>;
...
pub type PAD_DRIVER_W<'a> = crate::BitWriter<'a, u32, PIN13_SPEC, bool, 2>;
...
pub type SYNC1_BYPASS_W<'a> = crate::FieldWriter<'a, u32, PIN13_SPEC, u8, u8, 2, 3>;
...
pub type INT_TYPE_W<'a> = crate::FieldWriter<'a, u32, PIN13_SPEC, u8, u8, 3, 7>;
...
pub type WAKEUP_ENABLE_W<'a> = crate::BitWriter<'a, u32, PIN13_SPEC, bool, 10>;
#[doc = "Field `CONFIG` reader - reserved"]
pub type CONFIG_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CONFIG` writer - reserved"]
pub type CONFIG_W<'a> = crate::FieldWriter<'a, u32, PIN13_SPEC, u8, u8, 2, 11>;
...
pub type INT_ENA_W<'a> = crate::FieldWriter<'a, u32, PIN13_SPEC, u8, u8, 5, 13>;
impl R {
