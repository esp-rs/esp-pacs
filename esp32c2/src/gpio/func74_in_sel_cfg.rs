...
pub type FUNC74_IN_SEL_W<'a> = crate::FieldWriter<'a, u32, FUNC74_IN_SEL_CFG_SPEC, u8, u8, 5, 0>;
...
pub type FUNC74_IN_INV_SEL_W<'a> = crate::BitWriter<'a, u32, FUNC74_IN_SEL_CFG_SPEC, bool, 5>;
...
pub type SIG74_IN_SEL_W<'a> = crate::BitWriter<'a, u32, FUNC74_IN_SEL_CFG_SPEC, bool, 6>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - set this value: s=0-53: connect GPIO\\[s\\] to this port. s=0x38: set this port always high level. s=0x3C: set this port always low level."]
    #[inline(always)]
    pub fn func74_in_sel(&mut self) -> FUNC74_IN_SEL_W {
        FUNC74_IN_SEL_W::new(self)
    }
    #[doc = "Bit 5 - set this bit to invert input signal. 1:invert. 0:not invert."]
    #[inline(always)]
    pub fn func74_in_inv_sel(&mut self) -> FUNC74_IN_INV_SEL_W {
        FUNC74_IN_INV_SEL_W::new(self)
    }
    #[doc = "Bit 6 - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
    #[inline(always)]
    pub fn sig74_in_sel(&mut self) -> SIG74_IN_SEL_W {
