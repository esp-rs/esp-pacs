...
///Field `INTERRUPT` reader - GPIO interrupt status register for GPIO0-24
pub type INTERRUPT_R = crate::FieldReader<u32>;
///Field `INTERRUPT` writer - GPIO interrupt status register for GPIO0-24
pub type INTERRUPT_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
    ///Bits 0:24 - GPIO interrupt status register for GPIO0-24
    #[inline(always)]
