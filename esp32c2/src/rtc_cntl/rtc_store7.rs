...
pub type RTC_SCRATCH7_W<'a> = crate::FieldWriter<'a, u32, RTC_STORE7_SPEC, u32, u32, 32, 0>;
impl R {
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_store7](index.html) module"]
pub struct RTC_STORE7_SPEC;
impl crate::RegisterSpec for RTC_STORE7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_store7::R](R) reader structure"]
impl crate::Readable for RTC_STORE7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_store7::W](W) writer structure"]
