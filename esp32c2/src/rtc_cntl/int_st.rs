...
///Field `SLP_WAKEUP` writer - sleep wakeup interrupt state
...
///Field `BROWN_OUT` writer - brown out interrupt state
...
///Field `MAIN_TIMER` writer - RTC main timer interrupt state
...
///Field `SWD` writer - super watch dog interrupt state
