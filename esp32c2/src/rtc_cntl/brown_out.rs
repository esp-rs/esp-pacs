...
///Field `BROWN_OUT_RST_SEL` reader - 1: 4-pos reset
pub type BROWN_OUT_RST_SEL_R = crate::BitReader;
///Field `BROWN_OUT_RST_SEL` writer - 1: 4-pos reset
pub type BROWN_OUT_RST_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BROWN_OUT_ANA_RST_EN` reader - Need add desc
pub type BROWN_OUT_ANA_RST_EN_R = crate::BitReader;
///Field `BROWN_OUT_ANA_RST_EN` writer - Need add desc
pub type BROWN_OUT_ANA_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BROWN_OUT_CNT_CLR` reader - clear brown out counter
...
///Field `DET` reader - Need add desc
pub type DET_R = crate::BitReader;
///Field `DET` writer - Need add desc
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn det(&mut self) -> DET_W<BROWN_OUT_SPEC> {
        DET_W::new(self, 31)
    }
}
