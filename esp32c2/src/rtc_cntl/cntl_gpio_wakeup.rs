...
///`read()` method returns [`cntl_gpio_wakeup::R`](R) reader structure
impl crate::Readable for CNTL_GPIO_WAKEUP_SPEC {}
///`write(|w| ..)` method takes [`cntl_gpio_wakeup::W`](W) writer structure
impl crate::Writable for CNTL_GPIO_WAKEUP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CNTL_GPIO_WAKEUP to value 0
