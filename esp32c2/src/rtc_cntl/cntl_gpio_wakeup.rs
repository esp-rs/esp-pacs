...
pub type RTC_GPIO_WAKEUP_STATUS_W<'a, const O: u8> =
...
pub type RTC_GPIO_WAKEUP_STATUS_CLR_W<'a, const O: u8> =
...
pub type RTC_GPIO_PIN_CLK_GATE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN5_INT_TYPE_W<'a, const O: u8> =
...
pub type RTC_GPIO_PIN4_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, u8, u8, 3, O>;
...
pub type RTC_GPIO_PIN3_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, u8, u8, 3, O>;
...
pub type RTC_GPIO_PIN2_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, u8, u8, 3, O>;
...
pub type RTC_GPIO_PIN1_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, u8, u8, 3, O>;
...
pub type RTC_GPIO_PIN0_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, u8, u8, 3, O>;
...
pub type RTC_GPIO_PIN5_WAKEUP_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN4_WAKEUP_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN3_WAKEUP_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN2_WAKEUP_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN1_WAKEUP_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, bool, O>;
...
pub type RTC_GPIO_PIN0_WAKEUP_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CNTL_GPIO_WAKEUP_SPEC, bool, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:5 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_wakeup_status(&mut self) -> RTC_GPIO_WAKEUP_STATUS_W<0> {
        RTC_GPIO_WAKEUP_STATUS_W::new(self)
    }
    #[doc = "Bit 6 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_wakeup_status_clr(&mut self) -> RTC_GPIO_WAKEUP_STATUS_CLR_W<6> {
        RTC_GPIO_WAKEUP_STATUS_CLR_W::new(self)
    }
    #[doc = "Bit 7 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin_clk_gate(&mut self) -> RTC_GPIO_PIN_CLK_GATE_W<7> {
        RTC_GPIO_PIN_CLK_GATE_W::new(self)
    }
    #[doc = "Bits 8:10 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin5_int_type(&mut self) -> RTC_GPIO_PIN5_INT_TYPE_W<8> {
        RTC_GPIO_PIN5_INT_TYPE_W::new(self)
    }
    #[doc = "Bits 11:13 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin4_int_type(&mut self) -> RTC_GPIO_PIN4_INT_TYPE_W<11> {
        RTC_GPIO_PIN4_INT_TYPE_W::new(self)
    }
    #[doc = "Bits 14:16 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin3_int_type(&mut self) -> RTC_GPIO_PIN3_INT_TYPE_W<14> {
        RTC_GPIO_PIN3_INT_TYPE_W::new(self)
    }
    #[doc = "Bits 17:19 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin2_int_type(&mut self) -> RTC_GPIO_PIN2_INT_TYPE_W<17> {
        RTC_GPIO_PIN2_INT_TYPE_W::new(self)
    }
    #[doc = "Bits 20:22 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin1_int_type(&mut self) -> RTC_GPIO_PIN1_INT_TYPE_W<20> {
        RTC_GPIO_PIN1_INT_TYPE_W::new(self)
    }
    #[doc = "Bits 23:25 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin0_int_type(&mut self) -> RTC_GPIO_PIN0_INT_TYPE_W<23> {
        RTC_GPIO_PIN0_INT_TYPE_W::new(self)
    }
    #[doc = "Bit 26 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin5_wakeup_enable(&mut self) -> RTC_GPIO_PIN5_WAKEUP_ENABLE_W<26> {
        RTC_GPIO_PIN5_WAKEUP_ENABLE_W::new(self)
    }
    #[doc = "Bit 27 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin4_wakeup_enable(&mut self) -> RTC_GPIO_PIN4_WAKEUP_ENABLE_W<27> {
        RTC_GPIO_PIN4_WAKEUP_ENABLE_W::new(self)
    }
    #[doc = "Bit 28 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin3_wakeup_enable(&mut self) -> RTC_GPIO_PIN3_WAKEUP_ENABLE_W<28> {
        RTC_GPIO_PIN3_WAKEUP_ENABLE_W::new(self)
    }
    #[doc = "Bit 29 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin2_wakeup_enable(&mut self) -> RTC_GPIO_PIN2_WAKEUP_ENABLE_W<29> {
        RTC_GPIO_PIN2_WAKEUP_ENABLE_W::new(self)
    }
    #[doc = "Bit 30 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin1_wakeup_enable(&mut self) -> RTC_GPIO_PIN1_WAKEUP_ENABLE_W<30> {
        RTC_GPIO_PIN1_WAKEUP_ENABLE_W::new(self)
    }
    #[doc = "Bit 31 - Need add desc"]
    #[inline(always)]
    pub fn rtc_gpio_pin0_wakeup_enable(&mut self) -> RTC_GPIO_PIN0_WAKEUP_ENABLE_W<31> {
