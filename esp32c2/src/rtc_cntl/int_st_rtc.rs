...
pub type SLP_WAKEUP_INT_ST_W<'a> = crate::BitWriter<'a, u32, INT_ST_RTC_SPEC, bool, 0>;
...
pub type SLP_REJECT_INT_ST_W<'a> = crate::BitWriter<'a, u32, INT_ST_RTC_SPEC, bool, 1>;
...
pub type RTC_WDT_INT_ST_W<'a> = crate::BitWriter<'a, u32, INT_ST_RTC_SPEC, bool, 3>;
...
pub type RTC_BROWN_OUT_INT_ST_W<'a> = crate::BitWriter<'a, u32, INT_ST_RTC_SPEC, bool, 9>;
...
pub type RTC_MAIN_TIMER_INT_ST_W<'a> = crate::BitWriter<'a, u32, INT_ST_RTC_SPEC, bool, 10>;
...
pub type RTC_SWD_INT_ST_W<'a> = crate::BitWriter<'a, u32, INT_ST_RTC_SPEC, bool, 15>;
...
pub type RTC_BBPLL_CAL_INT_ST_W<'a> = crate::BitWriter<'a, u32, INT_ST_RTC_SPEC, bool, 20>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 3 - RTC WDT interrupt state"]
    #[inline(always)]
    pub fn rtc_wdt_int_st(&mut self) -> RTC_WDT_INT_ST_W {
        RTC_WDT_INT_ST_W::new(self)
    }
    #[doc = "Bit 9 - brown out interrupt state"]
    #[inline(always)]
    pub fn rtc_brown_out_int_st(&mut self) -> RTC_BROWN_OUT_INT_ST_W {
        RTC_BROWN_OUT_INT_ST_W::new(self)
    }
    #[doc = "Bit 10 - RTC main timer interrupt state"]
    #[inline(always)]
    pub fn rtc_main_timer_int_st(&mut self) -> RTC_MAIN_TIMER_INT_ST_W {
        RTC_MAIN_TIMER_INT_ST_W::new(self)
    }
    #[doc = "Bit 15 - super watch dog interrupt state"]
    #[inline(always)]
    pub fn rtc_swd_int_st(&mut self) -> RTC_SWD_INT_ST_W {
        RTC_SWD_INT_ST_W::new(self)
    }
    #[doc = "Bit 20 - Need add desc"]
    #[inline(always)]
    pub fn rtc_bbpll_cal_int_st(&mut self) -> RTC_BBPLL_CAL_INT_ST_W {
