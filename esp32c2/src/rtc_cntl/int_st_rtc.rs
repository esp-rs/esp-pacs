...
pub type SLP_WAKEUP_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLP_REJECT_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type WDT_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BROWN_OUT_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MAIN_TIMER_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SWD_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BBPLL_CAL_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slp_wakeup_int_st(&mut self) -> SLP_WAKEUP_INT_ST_W<INT_ST_RTC_SPEC, 0> {
        SLP_WAKEUP_INT_ST_W::new(self)
    }
    #[doc = "Bit 1 - sleep reject interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn slp_reject_int_st(&mut self) -> SLP_REJECT_INT_ST_W<INT_ST_RTC_SPEC, 1> {
        SLP_REJECT_INT_ST_W::new(self)
    }
    #[doc = "Bit 3 - RTC WDT interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn wdt_int_st(&mut self) -> WDT_INT_ST_W<INT_ST_RTC_SPEC, 3> {
        WDT_INT_ST_W::new(self)
    }
    #[doc = "Bit 9 - brown out interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn brown_out_int_st(&mut self) -> BROWN_OUT_INT_ST_W<INT_ST_RTC_SPEC, 9> {
        BROWN_OUT_INT_ST_W::new(self)
    }
    #[doc = "Bit 10 - RTC main timer interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn main_timer_int_st(&mut self) -> MAIN_TIMER_INT_ST_W<INT_ST_RTC_SPEC, 10> {
        MAIN_TIMER_INT_ST_W::new(self)
    }
    #[doc = "Bit 15 - super watch dog interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn swd_int_st(&mut self) -> SWD_INT_ST_W<INT_ST_RTC_SPEC, 15> {
        SWD_INT_ST_W::new(self)
    }
    #[doc = "Bit 20 - Need add desc"]
    #[inline(always)]
    #[must_use]
    pub fn bbpll_cal_int_st(&mut self) -> BBPLL_CAL_INT_ST_W<INT_ST_RTC_SPEC, 20> {
