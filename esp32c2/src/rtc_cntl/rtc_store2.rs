...
#[doc = "Field `RTC_SCRATCH2` reader - Need add desc"]
pub type RTC_SCRATCH2_R = crate::FieldReader<u32, u32>;
#[doc = "Field `RTC_SCRATCH2` writer - Need add desc"]
pub type RTC_SCRATCH2_W<'a> = crate::FieldWriter<'a, u32, RTC_STORE2_SPEC, u32, u32, 32, 0>;
impl R {
