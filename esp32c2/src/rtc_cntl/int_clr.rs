...
///Field `SLP_WAKEUP` reader - Clear sleep wakeup interrupt state
...
///Field `SLP_REJECT` reader - Clear sleep reject interrupt state
...
///Field `WDT` reader - Clear RTC WDT interrupt state
pub type WDT_R = crate::BitReader;
///Field `WDT` writer - Clear RTC WDT interrupt state
pub type WDT_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `BROWN_OUT` reader - Clear brown out interrupt state
...
///Field `MAIN_TIMER` reader - Clear RTC main timer interrupt state
...
///Field `SWD` reader - Clear super watch dog interrupt state
