...
///Field `DBG_ATTEN_MONITOR` reader - DBG_ATTEN when rtc in active state
pub type DBG_ATTEN_MONITOR_R = crate::FieldReader;
///Field `DBG_ATTEN_MONITOR` writer - DBG_ATTEN when rtc in active state
pub type DBG_ATTEN_MONITOR_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `DBG_ATTEN_ACTIVE` reader - Need add desc
pub type DBG_ATTEN_ACTIVE_R = crate::FieldReader;
///Field `DBG_ATTEN_ACTIVE` writer - Need add desc
