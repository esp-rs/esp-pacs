...
///Field `ANA_CLK_DIV` reader - Need add desc
pub type ANA_CLK_DIV_R = crate::FieldReader;
///Field `ANA_CLK_DIV` writer - Need add desc
pub type ANA_CLK_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SLOW_CLK_NEXT_EDGE` reader - Need add desc
pub type SLOW_CLK_NEXT_EDGE_R = crate::BitReader;
///Field `SLOW_CLK_NEXT_EDGE` writer - Need add desc
