...
///Field `SW_PROCPU_RST` reader - PRO CPU SW reset
...
///Field `XTL_EXT_CTR_SEL` reader - Need add desc
pub type XTL_EXT_CTR_SEL_R = crate::FieldReader;
///Field `XTL_EXT_CTR_SEL` writer - Need add desc
pub type XTL_EXT_CTR_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `ANALOG_FORCE_ISO` reader - Need add desc
pub type ANALOG_FORCE_ISO_R = crate::BitReader;
///Field `ANALOG_FORCE_ISO` writer - Need add desc
pub type ANALOG_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ANALOG_FORCE_NOISO` reader - Need add desc
pub type ANALOG_FORCE_NOISO_R = crate::BitReader;
///Field `ANALOG_FORCE_NOISO` writer - Need add desc
...
///Field `SW_SYS_RST` reader - SW system reset
...
///`reset()` method sets OPTIONS0 to value 0x1000_a000
