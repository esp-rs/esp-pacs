...
pub type XTL_EN_WAIT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type XTL_EXT_CTR_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xtl_en_wait(&mut self) -> XTL_EN_WAIT_W<OPTIONS0_SPEC, 14> {
        XTL_EN_WAIT_W::new(self)
    }
    #[doc = "Bits 20:22 - Need add desc"]
    #[inline(always)]
    #[must_use]
    pub fn xtl_ext_ctr_sel(&mut self) -> XTL_EXT_CTR_SEL_W<OPTIONS0_SPEC, 20> {
...
impl crate::Resettable for OPTIONS0_SPEC {
    const RESET_VALUE: Self::Ux = 0x1000_a000;
}
