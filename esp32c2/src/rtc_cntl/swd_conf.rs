...
pub type SWD_RESET_FLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWD_CONF_SPEC, bool, O>;
...
pub type SWD_FEED_INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWD_CONF_SPEC, bool, O>;
...
impl W {
    #[doc = "Bit 0 - swd reset flag"]
    #[inline(always)]
    pub fn swd_reset_flag(&mut self) -> SWD_RESET_FLAG_W<0> {
        SWD_RESET_FLAG_W::new(self)
    }
    #[doc = "Bit 1 - swd interrupt for feeding"]
    #[inline(always)]
    pub fn swd_feed_int(&mut self) -> SWD_FEED_INT_W<1> {
