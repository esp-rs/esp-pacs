...
///Field `SWD_RESET_FLAG` reader - swd reset flag
pub type SWD_RESET_FLAG_R = crate::BitReader;
///Field `SWD_RESET_FLAG` writer - swd reset flag
pub type SWD_RESET_FLAG_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD_FEED_INT` reader - swd interrupt for feeding
pub type SWD_FEED_INT_R = crate::BitReader;
///Field `SWD_FEED_INT` writer - swd interrupt for feeding
pub type SWD_FEED_INT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD_BYPASS_RST` reader - Need add desc
pub type SWD_BYPASS_RST_R = crate::BitReader;
///Field `SWD_BYPASS_RST` writer - Need add desc
pub type SWD_BYPASS_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD_SIGNAL_WIDTH` reader - adjust signal width send to swd
pub type SWD_SIGNAL_WIDTH_R = crate::FieldReader<u16>;
///Field `SWD_SIGNAL_WIDTH` writer - adjust signal width send to swd
pub type SWD_SIGNAL_WIDTH_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `SWD_RST_FLAG_CLR` reader - reset swd reset flag
pub type SWD_RST_FLAG_CLR_R = crate::BitReader;
///Field `SWD_RST_FLAG_CLR` writer - reset swd reset flag
pub type SWD_RST_FLAG_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD_FEED` reader - Sw feed swd
pub type SWD_FEED_R = crate::BitReader;
///Field `SWD_FEED` writer - Sw feed swd
pub type SWD_FEED_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD_DISABLE` reader - disabel SWD
pub type SWD_DISABLE_R = crate::BitReader;
///Field `SWD_DISABLE` writer - disabel SWD
pub type SWD_DISABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD_AUTO_FEED_EN` reader - automatically feed swd when int comes
