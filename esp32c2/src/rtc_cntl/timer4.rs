...
///Field `DG_WRAP_WAIT_TIMER` reader - Need add desc
pub type DG_WRAP_WAIT_TIMER_R = crate::FieldReader<u16>;
///Field `DG_WRAP_WAIT_TIMER` writer - Need add desc
pub type DG_WRAP_WAIT_TIMER_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `DG_WRAP_POWERUP_TIMER` reader - Need add desc
pub type DG_WRAP_POWERUP_TIMER_R = crate::FieldReader;
///Field `DG_WRAP_POWERUP_TIMER` writer - Need add desc
...
///`reset()` method sets TIMER4 to value 0x1020_0000
