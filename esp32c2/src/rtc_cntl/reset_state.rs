...
///Field `RESET_CAUSE_PROCPU` writer - reset cause of PRO CPU
...
///Field `DRESET_MASK_PROCPU` reader - Need add desc
pub type DRESET_MASK_PROCPU_R = crate::BitReader;
///Field `DRESET_MASK_PROCPU` writer - Need add desc
...
///`reset()` method sets RESET_STATE to value 0x2000
