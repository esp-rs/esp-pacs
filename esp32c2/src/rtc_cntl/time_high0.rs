...
pub type RTC_TIMER_VALUE0_HIGH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIME_HIGH0_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - RTC timer high 16 bits"]
    #[inline(always)]
    pub fn rtc_timer_value0_high(&mut self) -> RTC_TIMER_VALUE0_HIGH_W<0> {
