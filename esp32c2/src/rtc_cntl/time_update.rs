...
///Field `TIMER_SYS_STALL` reader - Enable to record system stall time
pub type TIMER_SYS_STALL_R = crate::BitReader;
///Field `TIMER_SYS_STALL` writer - Enable to record system stall time
pub type TIMER_SYS_STALL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER_XTL_OFF` reader - Enable to record 40M XTAL OFF time
pub type TIMER_XTL_OFF_R = crate::BitReader;
///Field `TIMER_XTL_OFF` writer - Enable to record 40M XTAL OFF time
pub type TIMER_XTL_OFF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER_SYS_RST` reader - enable to record system reset time
pub type TIMER_SYS_RST_R = crate::BitReader;
///Field `TIMER_SYS_RST` writer - enable to record system reset time
pub type TIMER_SYS_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIME_UPDATE` reader - Set 1: to update register with RTC timer
