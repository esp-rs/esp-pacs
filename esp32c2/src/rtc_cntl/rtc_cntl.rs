...
///Field `DIG_REG_CAL_EN` reader - Need add desc
pub type DIG_REG_CAL_EN_R = crate::BitReader;
///Field `DIG_REG_CAL_EN` writer - Need add desc
...
///Field `REGULATOR_FORCE_PU` reader - Need add desc
pub type REGULATOR_FORCE_PU_R = crate::BitReader;
///Field `REGULATOR_FORCE_PU` writer - Need add desc
...
///`reset()` method sets RTC_CNTL to value 0x8000_0000
