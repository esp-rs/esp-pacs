...
///Register `LOW_POWER_ST` writer
pub type W = crate::W<LOW_POWER_ST_SPEC>;
///Field `XPD_DIG` reader - digital wrap power down
pub type XPD_DIG_R = crate::BitReader;
///Field `XPD_DIG` writer - digital wrap power down
pub type XPD_DIG_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_STATE_START` reader - touch should start to work
pub type TOUCH_STATE_START_R = crate::BitReader;
///Field `TOUCH_STATE_START` writer - touch should start to work
pub type TOUCH_STATE_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_STATE_SWITCH` reader - touch is about to working. Switch rtc main state
pub type TOUCH_STATE_SWITCH_R = crate::BitReader;
///Field `TOUCH_STATE_SWITCH` writer - touch is about to working. Switch rtc main state
pub type TOUCH_STATE_SWITCH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_STATE_SLP` reader - touch is in sleep state
pub type TOUCH_STATE_SLP_R = crate::BitReader;
///Field `TOUCH_STATE_SLP` writer - touch is in sleep state
pub type TOUCH_STATE_SLP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_STATE_DONE` reader - touch is done
pub type TOUCH_STATE_DONE_R = crate::BitReader;
///Field `TOUCH_STATE_DONE` writer - touch is done
pub type TOUCH_STATE_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_STATE_START` reader - ulp/cocpu should start to work
pub type COCPU_STATE_START_R = crate::BitReader;
///Field `COCPU_STATE_START` writer - ulp/cocpu should start to work
pub type COCPU_STATE_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_STATE_SWITCH` reader - ulp/cocpu is about to working. Switch rtc main state
pub type COCPU_STATE_SWITCH_R = crate::BitReader;
///Field `COCPU_STATE_SWITCH` writer - ulp/cocpu is about to working. Switch rtc main state
pub type COCPU_STATE_SWITCH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_STATE_SLP` reader - ulp/cocpu is in sleep state
pub type COCPU_STATE_SLP_R = crate::BitReader;
///Field `COCPU_STATE_SLP` writer - ulp/cocpu is in sleep state
pub type COCPU_STATE_SLP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_STATE_DONE` reader - ulp/cocpu is done
pub type COCPU_STATE_DONE_R = crate::BitReader;
///Field `COCPU_STATE_DONE` writer - ulp/cocpu is done
pub type COCPU_STATE_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_STATE_XTAL_ISO` reader - no use any more
pub type MAIN_STATE_XTAL_ISO_R = crate::BitReader;
///Field `MAIN_STATE_XTAL_ISO` writer - no use any more
pub type MAIN_STATE_XTAL_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_STATE_PLL_ON` reader - rtc main state machine is in states that pll should be running
pub type MAIN_STATE_PLL_ON_R = crate::BitReader;
///Field `MAIN_STATE_PLL_ON` writer - rtc main state machine is in states that pll should be running
pub type MAIN_STATE_PLL_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RDY_FOR_WAKEUP` reader - rtc is ready to receive wake up trigger from wake up source
pub type RDY_FOR_WAKEUP_R = crate::BitReader;
///Field `RDY_FOR_WAKEUP` writer - rtc is ready to receive wake up trigger from wake up source
pub type RDY_FOR_WAKEUP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_STATE_WAIT_END` reader - rtc main state machine has been waited for some cycles
pub type MAIN_STATE_WAIT_END_R = crate::BitReader;
///Field `MAIN_STATE_WAIT_END` writer - rtc main state machine has been waited for some cycles
pub type MAIN_STATE_WAIT_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_WAKEUP_STATE` reader - rtc main state machine is in the states of wakeup process
pub type IN_WAKEUP_STATE_R = crate::BitReader;
///Field `IN_WAKEUP_STATE` writer - rtc main state machine is in the states of wakeup process
pub type IN_WAKEUP_STATE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_LOW_POWER_STATE` reader - rtc main state machine is in the states of low power
pub type IN_LOW_POWER_STATE_R = crate::BitReader;
///Field `IN_LOW_POWER_STATE` writer - rtc main state machine is in the states of low power
pub type IN_LOW_POWER_STATE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_STATE_IN_WAIT_8M` reader - rtc main state machine is in wait 8m state
pub type MAIN_STATE_IN_WAIT_8M_R = crate::BitReader;
///Field `MAIN_STATE_IN_WAIT_8M` writer - rtc main state machine is in wait 8m state
pub type MAIN_STATE_IN_WAIT_8M_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_STATE_IN_WAIT_PLL` reader - rtc main state machine is in wait pll state
pub type MAIN_STATE_IN_WAIT_PLL_R = crate::BitReader;
///Field `MAIN_STATE_IN_WAIT_PLL` writer - rtc main state machine is in wait pll state
pub type MAIN_STATE_IN_WAIT_PLL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_STATE_IN_WAIT_XTL` reader - rtc main state machine is in wait xtal state
pub type MAIN_STATE_IN_WAIT_XTL_R = crate::BitReader;
///Field `MAIN_STATE_IN_WAIT_XTL` writer - rtc main state machine is in wait xtal state
pub type MAIN_STATE_IN_WAIT_XTL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_STATE_IN_SLP` reader - rtc main state machine is in sleep state
pub type MAIN_STATE_IN_SLP_R = crate::BitReader;
///Field `MAIN_STATE_IN_SLP` writer - rtc main state machine is in sleep state
pub type MAIN_STATE_IN_SLP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_STATE_IN_IDLE` reader - rtc main state machine is in idle state
pub type MAIN_STATE_IN_IDLE_R = crate::BitReader;
///Field `MAIN_STATE_IN_IDLE` writer - rtc main state machine is in idle state
pub type MAIN_STATE_IN_IDLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_STATE` reader - rtc main state machine status
pub type MAIN_STATE_R = crate::FieldReader;
///Field `MAIN_STATE` writer - rtc main state machine status
...
///`read()` method returns [`low_power_st::R`](R) reader structure
impl crate::Readable for LOW_POWER_ST_SPEC {}
///`write(|w| ..)` method takes [`low_power_st::W`](W) writer structure
