...
pub type XPD_DIG_W<'a, const O: u8> = crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_TOUCH_STATE_START_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_TOUCH_STATE_SWITCH_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_TOUCH_STATE_SLP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_TOUCH_STATE_DONE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_COCPU_STATE_START_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_COCPU_STATE_SWITCH_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_COCPU_STATE_SLP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_COCPU_STATE_DONE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_MAIN_STATE_XTAL_ISO_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_MAIN_STATE_PLL_ON_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_RDY_FOR_WAKEUP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_MAIN_STATE_WAIT_END_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_IN_WAKEUP_STATE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_IN_LOW_POWER_STATE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_MAIN_STATE_IN_WAIT_8M_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_MAIN_STATE_IN_WAIT_PLL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_MAIN_STATE_IN_WAIT_XTL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_MAIN_STATE_IN_SLP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_MAIN_STATE_IN_IDLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LOW_POWER_ST_SPEC, bool, O>;
...
pub type RTC_MAIN_STATE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LOW_POWER_ST_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 9 - touch should start to work"]
    #[inline(always)]
    pub fn rtc_touch_state_start(&mut self) -> RTC_TOUCH_STATE_START_W<9> {
        RTC_TOUCH_STATE_START_W::new(self)
    }
    #[doc = "Bit 10 - touch is about to working. Switch rtc main state"]
    #[inline(always)]
    pub fn rtc_touch_state_switch(&mut self) -> RTC_TOUCH_STATE_SWITCH_W<10> {
        RTC_TOUCH_STATE_SWITCH_W::new(self)
    }
    #[doc = "Bit 11 - touch is in sleep state"]
    #[inline(always)]
    pub fn rtc_touch_state_slp(&mut self) -> RTC_TOUCH_STATE_SLP_W<11> {
        RTC_TOUCH_STATE_SLP_W::new(self)
    }
    #[doc = "Bit 12 - touch is done"]
    #[inline(always)]
    pub fn rtc_touch_state_done(&mut self) -> RTC_TOUCH_STATE_DONE_W<12> {
        RTC_TOUCH_STATE_DONE_W::new(self)
    }
    #[doc = "Bit 13 - ulp/cocpu should start to work"]
    #[inline(always)]
    pub fn rtc_cocpu_state_start(&mut self) -> RTC_COCPU_STATE_START_W<13> {
        RTC_COCPU_STATE_START_W::new(self)
    }
    #[doc = "Bit 14 - ulp/cocpu is about to working. Switch rtc main state"]
    #[inline(always)]
    pub fn rtc_cocpu_state_switch(&mut self) -> RTC_COCPU_STATE_SWITCH_W<14> {
        RTC_COCPU_STATE_SWITCH_W::new(self)
    }
    #[doc = "Bit 15 - ulp/cocpu is in sleep state"]
    #[inline(always)]
    pub fn rtc_cocpu_state_slp(&mut self) -> RTC_COCPU_STATE_SLP_W<15> {
        RTC_COCPU_STATE_SLP_W::new(self)
    }
    #[doc = "Bit 16 - ulp/cocpu is done"]
    #[inline(always)]
    pub fn rtc_cocpu_state_done(&mut self) -> RTC_COCPU_STATE_DONE_W<16> {
        RTC_COCPU_STATE_DONE_W::new(self)
    }
    #[doc = "Bit 17 - no use any more"]
    #[inline(always)]
    pub fn rtc_main_state_xtal_iso(&mut self) -> RTC_MAIN_STATE_XTAL_ISO_W<17> {
        RTC_MAIN_STATE_XTAL_ISO_W::new(self)
    }
    #[doc = "Bit 18 - rtc main state machine is in states that pll should be running"]
    #[inline(always)]
    pub fn rtc_main_state_pll_on(&mut self) -> RTC_MAIN_STATE_PLL_ON_W<18> {
        RTC_MAIN_STATE_PLL_ON_W::new(self)
    }
    #[doc = "Bit 19 - rtc is ready to receive wake up trigger from wake up source"]
    #[inline(always)]
    pub fn rtc_rdy_for_wakeup(&mut self) -> RTC_RDY_FOR_WAKEUP_W<19> {
        RTC_RDY_FOR_WAKEUP_W::new(self)
    }
    #[doc = "Bit 20 - rtc main state machine has been waited for some cycles"]
    #[inline(always)]
    pub fn rtc_main_state_wait_end(&mut self) -> RTC_MAIN_STATE_WAIT_END_W<20> {
        RTC_MAIN_STATE_WAIT_END_W::new(self)
    }
    #[doc = "Bit 21 - rtc main state machine is in the states of wakeup process"]
    #[inline(always)]
    pub fn rtc_in_wakeup_state(&mut self) -> RTC_IN_WAKEUP_STATE_W<21> {
        RTC_IN_WAKEUP_STATE_W::new(self)
    }
    #[doc = "Bit 22 - rtc main state machine is in the states of low power"]
    #[inline(always)]
    pub fn rtc_in_low_power_state(&mut self) -> RTC_IN_LOW_POWER_STATE_W<22> {
        RTC_IN_LOW_POWER_STATE_W::new(self)
    }
    #[doc = "Bit 23 - rtc main state machine is in wait 8m state"]
    #[inline(always)]
    pub fn rtc_main_state_in_wait_8m(&mut self) -> RTC_MAIN_STATE_IN_WAIT_8M_W<23> {
        RTC_MAIN_STATE_IN_WAIT_8M_W::new(self)
    }
    #[doc = "Bit 24 - rtc main state machine is in wait pll state"]
    #[inline(always)]
    pub fn rtc_main_state_in_wait_pll(&mut self) -> RTC_MAIN_STATE_IN_WAIT_PLL_W<24> {
        RTC_MAIN_STATE_IN_WAIT_PLL_W::new(self)
    }
    #[doc = "Bit 25 - rtc main state machine is in wait xtal state"]
    #[inline(always)]
    pub fn rtc_main_state_in_wait_xtl(&mut self) -> RTC_MAIN_STATE_IN_WAIT_XTL_W<25> {
        RTC_MAIN_STATE_IN_WAIT_XTL_W::new(self)
    }
    #[doc = "Bit 26 - rtc main state machine is in sleep state"]
    #[inline(always)]
    pub fn rtc_main_state_in_slp(&mut self) -> RTC_MAIN_STATE_IN_SLP_W<26> {
        RTC_MAIN_STATE_IN_SLP_W::new(self)
    }
    #[doc = "Bit 27 - rtc main state machine is in idle state"]
    #[inline(always)]
    pub fn rtc_main_state_in_idle(&mut self) -> RTC_MAIN_STATE_IN_IDLE_W<27> {
        RTC_MAIN_STATE_IN_IDLE_W::new(self)
    }
    #[doc = "Bits 28:31 - rtc main state machine status"]
    #[inline(always)]
    pub fn rtc_main_state(&mut self) -> RTC_MAIN_STATE_W<28> {
