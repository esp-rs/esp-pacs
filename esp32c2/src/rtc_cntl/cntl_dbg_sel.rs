...
///`read()` method returns [`cntl_dbg_sel::R`](R) reader structure
impl crate::Readable for CNTL_DBG_SEL_SPEC {}
///`write(|w| ..)` method takes [`cntl_dbg_sel::W`](W) writer structure
impl crate::Writable for CNTL_DBG_SEL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CNTL_DBG_SEL to value 0
