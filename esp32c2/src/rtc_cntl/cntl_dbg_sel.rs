...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn debug_12m_no_gating(&mut self) -> DEBUG_12M_NO_GATING_W<CNTL_DBG_SEL_SPEC, 1> {
        DEBUG_12M_NO_GATING_W::new(self)
    }
    #[doc = "Bits 2:6 - Need add desc"]
    #[inline(always)]
    #[must_use]
    pub fn debug_bit_sel(&mut self) -> DEBUG_BIT_SEL_W<CNTL_DBG_SEL_SPEC, 2> {
        DEBUG_BIT_SEL_W::new(self)
    }
    #[doc = "Bits 7:11 - Need add desc"]
    #[inline(always)]
    #[must_use]
    pub fn debug_sel0(&mut self) -> DEBUG_SEL0_W<CNTL_DBG_SEL_SPEC, 7> {
        DEBUG_SEL0_W::new(self)
    }
    #[doc = "Bits 12:16 - Need add desc"]
    #[inline(always)]
    #[must_use]
    pub fn debug_sel1(&mut self) -> DEBUG_SEL1_W<CNTL_DBG_SEL_SPEC, 12> {
        DEBUG_SEL1_W::new(self)
    }
    #[doc = "Bits 17:21 - Need add desc"]
    #[inline(always)]
    #[must_use]
    pub fn debug_sel2(&mut self) -> DEBUG_SEL2_W<CNTL_DBG_SEL_SPEC, 17> {
        DEBUG_SEL2_W::new(self)
    }
    #[doc = "Bits 22:26 - Need add desc"]
    #[inline(always)]
    #[must_use]
    pub fn debug_sel3(&mut self) -> DEBUG_SEL3_W<CNTL_DBG_SEL_SPEC, 22> {
