...
pub struct W(crate::W<TIME_LOW1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIME_LOW1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIME_LOW1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIME_LOW1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TIMER_VALUE1_LOW_W<'a, const O: u8> = crate::FieldWriter<'a, TIME_LOW1_SPEC, 32, O, u32>;
impl R {
