...
///Register `TIME_LOW0` writer
pub type W = crate::W<TIME_LOW0_SPEC>;
///Field `TIMER_VALUE0_LOW` reader - RTC timer low 32 bits
pub type TIMER_VALUE0_LOW_R = crate::FieldReader<u32>;
///Field `TIMER_VALUE0_LOW` writer - RTC timer low 32 bits
...
You can [`read`](crate::generic::Reg::read) this register and get [`time_low0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`time_low0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
...
///`write(|w| ..)` method takes [`time_low0::W`](W) writer structure
