...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn retention_clk_sel(&mut self) -> RETENTION_CLK_SEL_W<CNTL_RETENTION_CTRL_SPEC, 18> {
        RETENTION_CLK_SEL_W::new(self)
    }
    #[doc = "Bits 19:21 - Need add desc"]
    #[inline(always)]
    #[must_use]
    pub fn retention_done_wait(&mut self) -> RETENTION_DONE_WAIT_W<CNTL_RETENTION_CTRL_SPEC, 19> {
    ...
    pub fn retention_clkoff_wait(
        &mut self,
    ) -> RETENTION_CLKOFF_WAIT_W<CNTL_RETENTION_CTRL_SPEC, 22> {
        RETENTION_CLKOFF_WAIT_W::new(self)
    }
    #[doc = "Bit 26 - Need add desc"]
    #[inline(always)]
    #[must_use]
    pub fn retention_en(&mut self) -> RETENTION_EN_W<CNTL_RETENTION_CTRL_SPEC, 26> {
        RETENTION_EN_W::new(self)
    }
    #[doc = "Bits 27:31 - wait cycles for rention operation"]
    #[inline(always)]
    #[must_use]
    pub fn retention_wait(&mut self) -> RETENTION_WAIT_W<CNTL_RETENTION_CTRL_SPEC, 27> {
