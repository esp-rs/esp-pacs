...
///Field `SW_CPU_INT` reader - rtc software interrupt to main cpu
...
///Field `SLP_REJECT_CAUSE_CLR` reader - clear rtc sleep reject cause
...
///Field `APB2RTC_BRIDGE_SEL` reader - 1: APB to RTC using bridge
pub type APB2RTC_BRIDGE_SEL_R = crate::BitReader;
///Field `APB2RTC_BRIDGE_SEL` writer - 1: APB to RTC using bridge
...
///Field `SDIO_ACTIVE_IND` writer - SDIO active indication
