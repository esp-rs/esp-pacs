...
pub type ICACHE_SHUT_IBUS_W<'a, const O: u8> = crate::BitWriter<'a, ICACHE_CTRL1_SPEC, O>;
...
pub type ICACHE_SHUT_DBUS_W<'a, const O: u8> = crate::BitWriter<'a, ICACHE_CTRL1_SPEC, O>;
impl R {
