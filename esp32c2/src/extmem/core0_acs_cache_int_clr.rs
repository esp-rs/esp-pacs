...
pub type CORE0_DBUS_ACS_MSK_IC_INT_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, CORE0_ACS_CACHE_INT_CLR_SPEC, O>;
#[doc = "Field `CORE0_DBUS_REJECT_INT_CLR` writer - The bit is used to clear interrupt by authentication fail."]
pub type CORE0_DBUS_REJECT_INT_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, CORE0_ACS_CACHE_INT_CLR_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_ibus_acs_msk_ic_int_clr(&mut self) -> CORE0_IBUS_ACS_MSK_IC_INT_CLR_W<0> {
        CORE0_IBUS_ACS_MSK_IC_INT_CLR_W::new(self)
    }
    #[doc = "Bit 1 - The bit is used to clear interrupt by ibus trying to write icache"]
    #[inline(always)]
    #[must_use]
    pub fn core0_ibus_wr_ic_int_clr(&mut self) -> CORE0_IBUS_WR_IC_INT_CLR_W<1> {
        CORE0_IBUS_WR_IC_INT_CLR_W::new(self)
    }
    #[doc = "Bit 2 - The bit is used to clear interrupt by authentication fail."]
    #[inline(always)]
    #[must_use]
    pub fn core0_ibus_reject_int_clr(&mut self) -> CORE0_IBUS_REJECT_INT_CLR_W<2> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_dbus_acs_msk_ic_int_clr(&mut self) -> CORE0_DBUS_ACS_MSK_IC_INT_CLR_W<3> {
        CORE0_DBUS_ACS_MSK_IC_INT_CLR_W::new(self)
    }
    #[doc = "Bit 4 - The bit is used to clear interrupt by authentication fail."]
    #[inline(always)]
    #[must_use]
    pub fn core0_dbus_reject_int_clr(&mut self) -> CORE0_DBUS_REJECT_INT_CLR_W<4> {
        CORE0_DBUS_REJECT_INT_CLR_W::new(self)
    }
    #[doc = "Bit 5 - The bit is used to clear interrupt by dbus trying to write icache"]
    #[inline(always)]
    #[must_use]
    pub fn core0_dbus_wr_ic_int_clr(&mut self) -> CORE0_DBUS_WR_IC_INT_CLR_W<5> {
