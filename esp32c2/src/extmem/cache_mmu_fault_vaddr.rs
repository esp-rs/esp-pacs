///Register `CACHE_MMU_FAULT_VADDR` reader
pub type R = crate::R<CACHE_MMU_FAULT_VADDR_SPEC>;
///Field `CACHE_MMU_FAULT_VADDR` reader - The bits are used to indicate the virtual address which cause mmu fault..
...
///`read()` method returns [`cache_mmu_fault_vaddr::R`](R) reader structure
