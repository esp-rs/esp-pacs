...
///Field `CACHE_IGNORE_PRELOAD_MMU_ENTRY_FAULT` reader - The bit is used to disable checking mmu entry fault by preload operation.
pub type CACHE_IGNORE_PRELOAD_MMU_ENTRY_FAULT_R = crate::BitReader;
///Field `CACHE_IGNORE_PRELOAD_MMU_ENTRY_FAULT` writer - The bit is used to disable checking mmu entry fault by preload operation.
pub type CACHE_IGNORE_PRELOAD_MMU_ENTRY_FAULT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CACHE_IGNORE_SYNC_MMU_ENTRY_FAULT` reader - The bit is used to disable checking mmu entry fault by sync operation.
pub type CACHE_IGNORE_SYNC_MMU_ENTRY_FAULT_R = crate::BitReader;
///Field `CACHE_IGNORE_SYNC_MMU_ENTRY_FAULT` writer - The bit is used to disable checking mmu entry fault by sync operation.
pub type CACHE_IGNORE_SYNC_MMU_ENTRY_FAULT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CACHE_TRACE_ENA` reader - The bit is used to enable cache trace function.
pub type CACHE_TRACE_ENA_R = crate::BitReader;
///Field `CACHE_TRACE_ENA` writer - The bit is used to enable cache trace function.
pub type CACHE_TRACE_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CACHE_MMU_PAGE_SIZE` reader - This bit is used to choose mmu page size. 2:64KB. 1. 32KB. 0: 16KB
pub type CACHE_MMU_PAGE_SIZE_R = crate::FieldReader;
///Field `CACHE_MMU_PAGE_SIZE` writer - This bit is used to choose mmu page size. 2:64KB. 1. 32KB. 0: 16KB
...
///`read()` method returns [`cache_conf_misc::R`](R) reader structure
impl crate::Readable for CACHE_CONF_MISC_SPEC {}
///`write(|w| ..)` method takes [`cache_conf_misc::W`](W) writer structure
