...
pub type DBUS_TO_FLASH_END_VADDR_W<'a> =
    crate::FieldWriter<'a, u32, DBUS_TO_FLASH_END_VADDR_SPEC, u32, u32, 32, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the end virtual address of dbus to access flash. The register is used to give constraints to dbus access counter."]
    #[inline(always)]
    pub fn dbus_to_flash_end_vaddr(&mut self) -> DBUS_TO_FLASH_END_VADDR_W {
