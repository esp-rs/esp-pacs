...
pub type ENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICACHE_FREEZE_SPEC, bool, O>;
...
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICACHE_FREEZE_SPEC, bool, O>;
