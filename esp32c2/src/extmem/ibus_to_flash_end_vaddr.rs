///Register `IBUS_TO_FLASH_END_VADDR` reader
pub type R = crate::R<IBUS_TO_FLASH_END_VADDR_SPEC>;
///Register `IBUS_TO_FLASH_END_VADDR` writer
pub type W = crate::W<IBUS_TO_FLASH_END_VADDR_SPEC>;
///Field `IBUS_TO_FLASH_END_VADDR` reader - The bits are used to configure the end virtual address of ibus to access flash. The register is used to give constraints to ibus access counter.
pub type IBUS_TO_FLASH_END_VADDR_R = crate::FieldReader<u32>;
///Field `IBUS_TO_FLASH_END_VADDR` writer - The bits are used to configure the end virtual address of ibus to access flash. The register is used to give constraints to ibus access counter.
...
///`read()` method returns [`ibus_to_flash_end_vaddr::R`](R) reader structure
impl crate::Readable for IBUS_TO_FLASH_END_VADDR_SPEC {}
///`write(|w| ..)` method takes [`ibus_to_flash_end_vaddr::W`](W) writer structure
impl crate::Writable for IBUS_TO_FLASH_END_VADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets IBUS_TO_FLASH_END_VADDR to value 0x423f_ffff
