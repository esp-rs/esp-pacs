...
pub type SPI_MEM_FWRITE_DUAL_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 12>;
...
pub type SPI_MEM_FWRITE_QUAD_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 13>;
...
pub type SPI_MEM_FWRITE_DIO_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 14>;
...
pub type SPI_MEM_FWRITE_QIO_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 15>;
...
pub type SPI_MEM_USR_MISO_HIGHPART_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 24>;
...
pub type SPI_MEM_USR_MOSI_HIGHPART_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 25>;
...
pub type SPI_MEM_USR_MOSI_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 27>;
...
pub type SPI_MEM_USR_MISO_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 28>;
...
pub type SPI_MEM_USR_ADDR_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 30>;
...
pub type SPI_MEM_USR_COMMAND_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, 31>;
impl R {
...
impl W {
    ...
    pub fn spi_mem_usr_miso_highpart(&mut self) -> SPI_MEM_USR_MISO_HIGHPART_W {
        SPI_MEM_USR_MISO_HIGHPART_W::new(self)
    }
    #[doc = "Bit 25 - write-data phase only access to high-part of the buffer spi_mem_w8~spi_mem_w15. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_usr_mosi_highpart(&mut self) -> SPI_MEM_USR_MOSI_HIGHPART_W {
        SPI_MEM_USR_MOSI_HIGHPART_W::new(self)
    }
    #[doc = "Bit 26 - SPI clock is disable in dummy phase when the bit is enable."]
    #[inline(always)]
