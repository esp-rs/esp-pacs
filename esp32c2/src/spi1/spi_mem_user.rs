...
pub type SPI_MEM_USR_MISO_HIGHPART_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, O>;
...
pub type SPI_MEM_USR_MOSI_HIGHPART_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_MEM_USER_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bit 24 - read-data phase only access to high-part of the buffer spi_mem_w8~spi_mem_w15. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_usr_miso_highpart(&mut self) -> SPI_MEM_USR_MISO_HIGHPART_W<24> {
        SPI_MEM_USR_MISO_HIGHPART_W::new(self)
    }
    #[doc = "Bit 25 - write-data phase only access to high-part of the buffer spi_mem_w8~spi_mem_w15. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_usr_mosi_highpart(&mut self) -> SPI_MEM_USR_MOSI_HIGHPART_W<25> {
