...
pub type SPI_MEM_FCS_CRC_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_MEM_CTRL_SPEC, bool, O>;
...
pub type SPI_MEM_TX_CRC_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_MEM_CTRL_SPEC, bool, O>;
...
pub type SPI_MEM_RESANDRES_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_MEM_CTRL_SPEC, bool, O>;
...
pub type SPI_MEM_WRSR_2B_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MEM_CTRL_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bit 10 - For SPI1, initialize crc32 module before writing encrypted data to flash. Active low."]
    #[inline(always)]
    pub fn spi_mem_fcs_crc_en(&mut self) -> SPI_MEM_FCS_CRC_EN_W<10> {
        SPI_MEM_FCS_CRC_EN_W::new(self)
    }
    #[doc = "Bit 11 - For SPI1, enable crc32 when writing encrypted data to flash. 1: enable 0:disable"]
    #[inline(always)]
    pub fn spi_mem_tx_crc_en(&mut self) -> SPI_MEM_TX_CRC_EN_W<11> {
