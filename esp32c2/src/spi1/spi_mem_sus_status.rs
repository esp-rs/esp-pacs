...
pub type SPI_MEM_FLASH_SUS_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_SUS_STATUS_SPEC, bool, 0>;
...
pub type SPI_MEM_WAIT_PESR_CMD_2B_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_SUS_STATUS_SPEC, bool, 1>;
...
pub type SPI_MEM_FLASH_HPM_DLY_128_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_SUS_STATUS_SPEC, bool, 2>;
...
pub type SPI_MEM_FLASH_RES_DLY_128_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_SUS_STATUS_SPEC, bool, 3>;
...
pub type SPI_MEM_FLASH_DP_DLY_128_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_SUS_STATUS_SPEC, bool, 4>;
...
pub type SPI_MEM_FLASH_PER_DLY_128_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_SUS_STATUS_SPEC, bool, 5>;
...
pub type SPI_MEM_FLASH_PES_DLY_128_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_SUS_STATUS_SPEC, bool, 6>;
...
pub type SPI_MEM_SPI0_LOCK_EN_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_SUS_STATUS_SPEC, bool, 7>;
impl R {
...
#[doc = "`reset()` method sets SPI_MEM_SUS_STATUS to value 0"]
