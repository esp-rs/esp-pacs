...
pub struct R(crate::R<SPI_MEM_W15_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPI_MEM_W15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPI_MEM_W15_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPI_MEM_W15_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPI_MEM_W15` writer"]
pub struct W(crate::W<SPI_MEM_W15_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI_MEM_W15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI_MEM_W15_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI_MEM_W15_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SPI_MEM_BUF15` reader - data buffer"]
pub type SPI_MEM_BUF15_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_MEM_BUF15` writer - data buffer"]
pub type SPI_MEM_BUF15_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_MEM_W15_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn spi_mem_buf15(&mut self) -> SPI_MEM_BUF15_W<0> {
