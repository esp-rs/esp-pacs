...
pub type SPI_MEM_FLASH_PER_R = crate::BitReader<bool>;
...
pub type SPI_MEM_FLASH_PER_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, bool, 0>;
...
pub type SPI_MEM_FLASH_PES_R = crate::BitReader<bool>;
...
pub type SPI_MEM_FLASH_PES_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, bool, 1>;
...
pub type SPI_MEM_FLASH_PER_WAIT_EN_R = crate::BitReader<bool>;
...
pub type SPI_MEM_FLASH_PER_WAIT_EN_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, bool, 2>;
...
pub type SPI_MEM_FLASH_PES_WAIT_EN_R = crate::BitReader<bool>;
...
pub type SPI_MEM_FLASH_PES_WAIT_EN_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, bool, 3>;
...
pub type SPI_MEM_PES_PER_EN_R = crate::BitReader<bool>;
...
pub type SPI_MEM_PES_PER_EN_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, bool, 4>;
#[doc = "Field `SPI_MEM_FLASH_PES_EN` reader - Set this bit to enable Auto-suspending function."]
pub type SPI_MEM_FLASH_PES_EN_R = crate::BitReader<bool>;
#[doc = "Field `SPI_MEM_FLASH_PES_EN` writer - Set this bit to enable Auto-suspending function."]
pub type SPI_MEM_FLASH_PES_EN_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, bool, 5>;
...
pub type SPI_MEM_PESR_END_MSK_W<'a> =
    crate::FieldWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, u16, u16, 16, 6>;
...
pub type SPI_FMEM_RD_SUS_2B_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, bool, 22>;
...
pub type SPI_MEM_PER_END_EN_R = crate::BitReader<bool>;
...
pub type SPI_MEM_PER_END_EN_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, bool, 23>;
...
pub type SPI_MEM_PES_END_EN_R = crate::BitReader<bool>;
...
pub type SPI_MEM_PES_END_EN_W<'a> =
    crate::BitWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, bool, 24>;
...
pub type SPI_MEM_SUS_TIMEOUT_CNT_R = crate::FieldReader<u8, u8>;
...
pub type SPI_MEM_SUS_TIMEOUT_CNT_W<'a> =
    crate::FieldWriter<'a, u32, SPI_MEM_FLASH_SUS_CTRL_SPEC, u8, u8, 7, 25>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 22 - 1: Read two bytes when check flash SUS/SUS1/SUS2 status bit. 0: Read one byte when check flash SUS/SUS1/SUS2 status bit"]
    #[inline(always)]
    pub fn spi_fmem_rd_sus_2b(&mut self) -> SPI_FMEM_RD_SUS_2B_W {
