...
#[doc = "Field `SPI_MEM_SPI1_MST_ST` reader - The current status of SPI1 master FSM."]
pub type SPI_MEM_SPI1_MST_ST_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SPI_MEM_MSPI_ST` reader - The current status of SPI1 slave FSM: mspi_st. 0: idle state, 1: preparation state, 2: send command state, 3: send address state, 4: wait state, 5: read data state, 6:write data state, 7: done state, 8: read data end state."]
pub type SPI_MEM_MSPI_ST_R = crate::FieldReader<u8, u8>;
...
pub type SPI_MEM_FLASH_PE_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 17>;
...
pub type SPI_MEM_USR_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 18>;
...
pub type SPI_MEM_FLASH_HPM_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 19>;
...
pub type SPI_MEM_FLASH_RES_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 20>;
...
pub type SPI_MEM_FLASH_DP_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 21>;
...
pub type SPI_MEM_FLASH_CE_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 22>;
...
pub type SPI_MEM_FLASH_BE_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 23>;
...
pub type SPI_MEM_FLASH_SE_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 24>;
...
pub type SPI_MEM_FLASH_PP_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 25>;
...
pub type SPI_MEM_FLASH_WRSR_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 26>;
...
pub type SPI_MEM_FLASH_RDSR_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 27>;
...
pub type SPI_MEM_FLASH_RDID_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 28>;
...
pub type SPI_MEM_FLASH_WRDI_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 29>;
...
pub type SPI_MEM_FLASH_WREN_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 30>;
...
pub type SPI_MEM_FLASH_READ_W<'a> = crate::BitWriter<'a, u32, SPI_MEM_CMD_SPEC, bool, 31>;
impl R {
    #[doc = "Bits 0:3 - The current status of SPI1 master FSM."]
    #[inline(always)]
    pub fn spi_mem_spi1_mst_st(&self) -> SPI_MEM_SPI1_MST_ST_R {
        SPI_MEM_SPI1_MST_ST_R::new((self.bits & 0x0f) as u8)
    }
    ...
    #[inline(always)]
    pub fn spi_mem_mspi_st(&self) -> SPI_MEM_MSPI_ST_R {
        SPI_MEM_MSPI_ST_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
