...
pub type SPI_MEM_FLASH_PER_COMMAND_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_MEM_FLASH_SUS_CMD_SPEC, u8, u8, 8, O>;
...
impl W {
    #[doc = "Bits 0:7 - Program/Erase resume command."]
    #[inline(always)]
    pub fn spi_mem_flash_per_command(&mut self) -> SPI_MEM_FLASH_PER_COMMAND_W<0> {
        SPI_MEM_FLASH_PER_COMMAND_W::new(self)
    }
    #[doc = "Bits 8:15 - Program/Erase suspend command."]
    #[inline(always)]
    pub fn spi_mem_flash_pes_command(&mut self) -> SPI_MEM_FLASH_PES_COMMAND_W<8> {
