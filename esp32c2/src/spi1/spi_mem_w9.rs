...
pub type SPI_MEM_BUF9_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_MEM_BUF9` writer - data buffer"]
pub type SPI_MEM_BUF9_W<'a> = crate::FieldWriter<'a, u32, SPI_MEM_W9_SPEC, u32, u32, 32, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn spi_mem_buf9(&mut self) -> SPI_MEM_BUF9_W {
