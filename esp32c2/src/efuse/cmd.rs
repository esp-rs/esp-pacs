...
///Field `BLK_NUM` reader - The serial number of the block to be programmed. Value 0-3 corresponds to block number 0-3, respectively.
pub type BLK_NUM_R = crate::FieldReader;
///Field `BLK_NUM` writer - The serial number of the block to be programmed. Value 0-3 corresponds to block number 0-3, respectively.
