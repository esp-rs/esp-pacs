...
#[doc = "Field `DATA` reader - The content of the 0th 32-bit RS code to be programmed."]
pub type DATA_R = crate::FieldReader<u32>;
#[doc = "Field `DATA` writer - The content of the 0th 32-bit RS code to be programmed."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DATA_W<PGM_CHECK_VALUE_SPEC> {
        DATA_W::new(self, 0)
    }
}
