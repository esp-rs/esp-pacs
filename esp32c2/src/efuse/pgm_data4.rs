...
#[doc = "Field `PGM_DATA_4` reader - The content of the 4th 32-bit data to be programmed."]
pub type PGM_DATA_4_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PGM_DATA_4` writer - The content of the 4th 32-bit data to be programmed."]
pub type PGM_DATA_4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PGM_DATA4_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - The content of the 4th 32-bit data to be programmed."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pgm_data_4(&mut self) -> PGM_DATA_4_W<0> {
        PGM_DATA_4_W::new(self)
    }
