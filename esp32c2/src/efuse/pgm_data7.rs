...
///Field `PGM_DATA_7` reader - The content of the 7th 32-bit data to be programmed.
pub type PGM_DATA_7_R = crate::FieldReader<u32>;
///Field `PGM_DATA_7` writer - The content of the 7th 32-bit data to be programmed.
