///Register `RD_BLK2_DATA3` reader
pub type R = crate::R<RD_BLK2_DATA3_SPEC>;
///Field `PVT_HIGH` reader - Store the bit \[5:14\] of pvt.
pub type PVT_HIGH_R = crate::FieldReader<u16>;
///Field `ADC_CALIBRATION_0` reader - Store the bit \[0:21\] of ADC calibration data.
pub type ADC_CALIBRATION_0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:9 - Store the bit \[5:14\] of pvt.
    #[inline(always)]
    pub fn pvt_high(&self) -> PVT_HIGH_R {
        PVT_HIGH_R::new((self.bits & 0x03ff) as u16)
    }
    ///Bits 10:31 - Store the bit \[0:21\] of ADC calibration data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_blk2_data3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_BLK2_DATA3_SPEC;
impl crate::RegisterSpec for RD_BLK2_DATA3_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_blk2_data3::R`](R) reader structure
impl crate::Readable for RD_BLK2_DATA3_SPEC {}
///`reset()` method sets RD_BLK2_DATA3 to value 0
