///Register `RD_BLK3_DATA2` reader
pub type R = crate::R<RD_BLK3_DATA2_SPEC>;
///Field `BLK3_DATA2` reader - Store the third 32-bit of Block3.
pub type BLK3_DATA2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Store the third 32-bit of Block3.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_blk3_data2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_BLK3_DATA2_SPEC;
impl crate::RegisterSpec for RD_BLK3_DATA2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_blk3_data2::R`](R) reader structure
impl crate::Readable for RD_BLK3_DATA2_SPEC {}
///`reset()` method sets RD_BLK3_DATA2 to value 0
