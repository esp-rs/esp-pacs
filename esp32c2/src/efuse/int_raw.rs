...
///Field `READ_DONE` reader - The raw bit signal for read_done interrupt.
pub type READ_DONE_R = crate::BitReader;
///Field `READ_DONE` writer - The raw bit signal for read_done interrupt.
pub type READ_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PGM_DONE` reader - The raw bit signal for pgm_done interrupt.
pub type PGM_DONE_R = crate::BitReader;
///Field `PGM_DONE` writer - The raw bit signal for pgm_done interrupt.
