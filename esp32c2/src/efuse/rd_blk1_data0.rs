///Register `RD_BLK1_DATA0` reader
pub type R = crate::R<RD_BLK1_DATA0_SPEC>;
///Field `SYSTEM_DATA0` reader - Stores the bits \[0:31\] of system data.
pub type SYSTEM_DATA0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the bits \[0:31\] of system data.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_BLK1_DATA0")
            .field("system_data0", &self.system_data0())
            .finish()
    }
}
...
///`read()` method returns [`rd_blk1_data0::R`](R) reader structure
impl crate::Readable for RD_BLK1_DATA0_SPEC {}
///`reset()` method sets RD_BLK1_DATA0 to value 0
