///Register `RD_BLK3_DATA5` reader
pub type R = crate::R<RD_BLK3_DATA5_SPEC>;
///Field `BLK3_DATA5` reader - Store the sixth 32-bit of Block3.
pub type BLK3_DATA5_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Store the sixth 32-bit of Block3.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_BLK3_DATA5")
            .field("blk3_data5", &self.blk3_data5())
            .finish()
    }
}
...
///`read()` method returns [`rd_blk3_data5::R`](R) reader structure
impl crate::Readable for RD_BLK3_DATA5_SPEC {}
///`reset()` method sets RD_BLK3_DATA5 to value 0
