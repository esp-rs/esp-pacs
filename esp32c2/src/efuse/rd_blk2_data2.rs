///Register `RD_BLK2_DATA2` reader
pub type R = crate::R<RD_BLK2_DATA2_SPEC>;
///Field `LDO_VOL_BIAS_CONFIG_HIGH` reader - Store the bit \[3:29\] of ido configuration parameters.
pub type LDO_VOL_BIAS_CONFIG_HIGH_R = crate::FieldReader<u32>;
///Field `PVT_LOW` reader - Store the bit \[0:4\] of pvt.
pub type PVT_LOW_R = crate::FieldReader;
impl R {
    ///Bits 0:26 - Store the bit \[3:29\] of ido configuration parameters.
    #[inline(always)]
    pub fn ldo_vol_bias_config_high(&self) -> LDO_VOL_BIAS_CONFIG_HIGH_R {
        LDO_VOL_BIAS_CONFIG_HIGH_R::new(self.bits & 0x07ff_ffff)
    }
    ///Bits 27:31 - Store the bit \[0:4\] of pvt.
    #[inline(always)]
...
///`read()` method returns [`rd_blk2_data2::R`](R) reader structure
impl crate::Readable for RD_BLK2_DATA2_SPEC {}
///`reset()` method sets RD_BLK2_DATA2 to value 0
