...
///Field `DIS_PAD_JTAG_ERR` reader - If any bit in DIS_PAD_JTAG is 1, then it indicates a programming error.
pub type DIS_PAD_JTAG_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_ICACHE_ERR` reader - If any bit in this filed is 1, then it indicates a programming error.
pub type DIS_DOWNLOAD_ICACHE_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_MANUAL_ENCRYPT_ERR` reader - If any bit in DIS_DOWNLOAD_MANUAL_ENCRYPT is 1, then it indicates a programming error.
pub type DIS_DOWNLOAD_MANUAL_ENCRYPT_ERR_R = crate::BitReader;
///Field `SPI_BOOT_ENCRYPT_DECRYPT_CNT_ERR` reader - If any bit in SPI_BOOT_ENCRYPT_DECRYPT_CNT is 1, then it indicates a programming error.
pub type SPI_BOOT_ENCRYPT_DECRYPT_CNT_ERR_R = crate::FieldReader;
///Field `XTS_KEY_LENGTH_256_ERR` reader - If any bit in XTS_KEY_LENGTH_256 is 1, then it indicates a programming error.
...
///Field `FORCE_SEND_RESUME_ERR` reader - If any bit in FORCE_SEND_RESUME is 1, then it indicates a programming error.
pub type FORCE_SEND_RESUME_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_MODE_ERR` reader - If any bit in this filed is 1, then it indicates a programming error.
pub type DIS_DOWNLOAD_MODE_ERR_R = crate::BitReader;
///Field `DIS_DIRECT_BOOT_ERR` reader - If any bit in this filed is 1, then it indicates a programming error.
pub type DIS_DIRECT_BOOT_ERR_R = crate::BitReader;
///Field `ENABLE_SECURITY_DOWNLOAD_ERR` reader - If any bit in this filed is 1, then it indicates a programming error.
pub type ENABLE_SECURITY_DOWNLOAD_ERR_R = crate::BitReader;
///Field `FLASH_TPUW_ERR` reader - If any bit in this filed is 1, then it indicates a programming error.
pub type FLASH_TPUW_ERR_R = crate::FieldReader;
///Field `SECURE_BOOT_EN_ERR` reader - If any bit in this filed is 1, then it indicates a programming error.
pub type SECURE_BOOT_EN_ERR_R = crate::BitReader;
///Field `RPT4_RESERVED_ERR` reader - Reserved.
...
///`read()` method returns [`rd_repeat_err::R`](R) reader structure
impl crate::Readable for RD_REPEAT_ERR_SPEC {}
///`reset()` method sets RD_REPEAT_ERR to value 0
