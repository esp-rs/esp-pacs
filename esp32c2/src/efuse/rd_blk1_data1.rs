///Register `RD_BLK1_DATA1` reader
pub type R = crate::R<RD_BLK1_DATA1_SPEC>;
///Field `SYSTEM_DATA1` reader - Stores the bits \[32:63\] of system data.
pub type SYSTEM_DATA1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the bits \[32:63\] of system data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_blk1_data1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_BLK1_DATA1_SPEC;
impl crate::RegisterSpec for RD_BLK1_DATA1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_blk1_data1::R`](R) reader structure
impl crate::Readable for RD_BLK1_DATA1_SPEC {}
///`reset()` method sets RD_BLK1_DATA1 to value 0
