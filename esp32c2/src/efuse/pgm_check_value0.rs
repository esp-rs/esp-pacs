...
///Field `PGM_RS_DATA_0` reader - The content of the 0th 32-bit RS code to be programmed.
pub type PGM_RS_DATA_0_R = crate::FieldReader<u32>;
///Field `PGM_RS_DATA_0` writer - The content of the 0th 32-bit RS code to be programmed.
