///Register `RD_BLK2_DATA7` reader
pub type R = crate::R<RD_BLK2_DATA7_SPEC>;
///Field `BLK2_RESERVED_DATA_1` reader - Store the bit \[21:52\] of block2 reserved data.
pub type BLK2_RESERVED_DATA_1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Store the bit \[21:52\] of block2 reserved data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_blk2_data7::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_BLK2_DATA7_SPEC;
impl crate::RegisterSpec for RD_BLK2_DATA7_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_blk2_data7::R`](R) reader structure
impl crate::Readable for RD_BLK2_DATA7_SPEC {}
///`reset()` method sets RD_BLK2_DATA7 to value 0
