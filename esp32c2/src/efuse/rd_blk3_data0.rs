///Register `RD_BLK3_DATA0` reader
pub type R = crate::R<RD_BLK3_DATA0_SPEC>;
///Field `BLK3_DATA0` reader - Store the first 32-bit of Block3.
pub type BLK3_DATA0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Store the first 32-bit of Block3.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_blk3_data0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_BLK3_DATA0_SPEC;
impl crate::RegisterSpec for RD_BLK3_DATA0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_blk3_data0::R`](R) reader structure
impl crate::Readable for RD_BLK3_DATA0_SPEC {}
///`reset()` method sets RD_BLK3_DATA0 to value 0
