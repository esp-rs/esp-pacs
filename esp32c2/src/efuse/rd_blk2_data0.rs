///Register `RD_BLK2_DATA0` reader
pub type R = crate::R<RD_BLK2_DATA0_SPEC>;
///Field `BLK2_DATA0` reader - Store the bit \[0:31\] of MAC.
pub type BLK2_DATA0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Store the bit \[0:31\] of MAC.
    #[inline(always)]
...
///`read()` method returns [`rd_blk2_data0::R`](R) reader structure
impl crate::Readable for RD_BLK2_DATA0_SPEC {}
///`reset()` method sets RD_BLK2_DATA0 to value 0
