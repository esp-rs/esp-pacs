///Register `RD_BLK2_DATA1` reader
pub type R = crate::R<RD_BLK2_DATA1_SPEC>;
///Field `MAC_ID_HIGH` reader - Store the bit \[31:47\] of MAC.
pub type MAC_ID_HIGH_R = crate::FieldReader<u16>;
///Field `WAFER_VERSION` reader - Store wafer version.
pub type WAFER_VERSION_R = crate::FieldReader;
///Field `PKG_VERSION` reader - Store package version.
pub type PKG_VERSION_R = crate::FieldReader;
///Field `BLK2_EFUSE_VERSION` reader - Store efuse version.
pub type BLK2_EFUSE_VERSION_R = crate::FieldReader;
///Field `RF_REF_I_BIAS_CONFIG` reader - Store rf configuration parameters.
pub type RF_REF_I_BIAS_CONFIG_R = crate::FieldReader;
///Field `LDO_VOL_BIAS_CONFIG_LOW` reader - Store the bit \[0:2\] of ido configuration parameters.
...
///`read()` method returns [`rd_blk2_data1::R`](R) reader structure
impl crate::Readable for RD_BLK2_DATA1_SPEC {}
///`reset()` method sets RD_BLK2_DATA1 to value 0
