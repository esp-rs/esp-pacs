///Register `RD_BLK3_DATA1` reader
pub type R = crate::R<RD_BLK3_DATA1_SPEC>;
///Field `BLK3_DATA1` reader - Store the second 32-bit of Block3.
pub type BLK3_DATA1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Store the second 32-bit of Block3.
    #[inline(always)]
...
///`read()` method returns [`rd_blk3_data1::R`](R) reader structure
impl crate::Readable for RD_BLK3_DATA1_SPEC {}
///`reset()` method sets RD_BLK3_DATA1 to value 0
