...
///Field `THR_A` reader - Configures hold time for efuse read.
pub type THR_A_R = crate::FieldReader;
///Field `THR_A` writer - Configures hold time for efuse read.
pub type THR_A_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `TRD` reader - Configures pulse time for efuse read.
pub type TRD_R = crate::FieldReader;
///Field `TRD` writer - Configures pulse time for efuse read.
pub type TRD_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `TSUR_A` reader - Configures setup time for efuse read.
pub type TSUR_A_R = crate::FieldReader;
///Field `TSUR_A` writer - Configures setup time for efuse read.
...
///`reset()` method sets RD_TIM_CONF to value 0x1201_0201
