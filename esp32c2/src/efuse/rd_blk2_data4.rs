///Register `RD_BLK2_DATA4` reader
pub type R = crate::R<RD_BLK2_DATA4_SPEC>;
///Field `ADC_CALIBRATION_1` reader - Store the bit \[22:53\] of ADC calibration data.
pub type ADC_CALIBRATION_1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Store the bit \[22:53\] of ADC calibration data.
    #[inline(always)]
...
///`read()` method returns [`rd_blk2_data4::R`](R) reader structure
impl crate::Readable for RD_BLK2_DATA4_SPEC {}
///`reset()` method sets RD_BLK2_DATA4 to value 0
