...
///Field `TSUP_A` reader - Configures setup time for efuse program.
pub type TSUP_A_R = crate::FieldReader;
///Field `TSUP_A` writer - Configures setup time for efuse program.
...
impl R {
    ///Bits 0:7 - Configures setup time for efuse program.
    #[inline(always)]
...
///`reset()` method sets WR_TIM_CONF1 to value 0x0030_0001
