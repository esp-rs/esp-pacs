...
///Field `THP_A` reader - Configures hold time for efuse program.
pub type THP_A_R = crate::FieldReader;
///Field `THP_A` writer - Configures hold time for efuse program.
pub type THP_A_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `TPGM_INACTIVE` reader - Configures pulse time for burning '0' bit.
pub type TPGM_INACTIVE_R = crate::FieldReader;
///Field `TPGM_INACTIVE` writer - Configures pulse time for burning '0' bit.
pub type TPGM_INACTIVE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `TPGM` reader - Configures pulse time for burning '1' bit.
pub type TPGM_R = crate::FieldReader<u16>;
///Field `TPGM` writer - Configures pulse time for burning '1' bit.
pub type TPGM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:7 - Configures hold time for efuse program.
    #[inline(always)]
    ...
    ///Bits 16:31 - Configures pulse time for burning '1' bit.
    #[inline(always)]
