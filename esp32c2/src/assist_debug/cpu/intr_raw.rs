...
#[doc = "Field `SP_SPILL_MIN_RAW` reader - sp underlow monitor interrupt status register"]
pub type SP_SPILL_MIN_RAW_R = crate::BitReader;
#[doc = "Field `SP_SPILL_MAX_RAW` reader - sp overflow monitor interupt status register"]
