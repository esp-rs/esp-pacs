...
///Field `CORE_0_SP_SPILL_MIN_INTR_ENA` reader - enbale sp underlow monitor interrupt
pub type CORE_0_SP_SPILL_MIN_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_SP_SPILL_MIN_INTR_ENA` writer - enbale sp underlow monitor interrupt
pub type CORE_0_SP_SPILL_MIN_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_SP_SPILL_MAX_INTR_ENA` reader - enbale sp overflow monitor interrupt
pub type CORE_0_SP_SPILL_MAX_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_SP_SPILL_MAX_INTR_ENA` writer - enbale sp overflow monitor interrupt
pub type CORE_0_SP_SPILL_MAX_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - enbale sp underlow monitor interrupt
    #[inline(always)]
    pub fn core_0_sp_spill_min_intr_ena(&self) -> CORE_0_SP_SPILL_MIN_INTR_ENA_R {
        CORE_0_SP_SPILL_MIN_INTR_ENA_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - enbale sp overflow monitor interrupt
    #[inline(always)]
