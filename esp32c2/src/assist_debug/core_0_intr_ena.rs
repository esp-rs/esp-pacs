...
pub type CORE_0_SP_SPILL_MIN_INTR_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, CORE_0_INTR_ENA_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_sp_spill_min_intr_ena(&mut self) -> CORE_0_SP_SPILL_MIN_INTR_ENA_W<0> {
        CORE_0_SP_SPILL_MIN_INTR_ENA_W::new(self)
    }
    #[doc = "Bit 1 - enbale sp overflow monitor interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_sp_spill_max_intr_ena(&mut self) -> CORE_0_SP_SPILL_MAX_INTR_ENA_W<1> {
