...
///`read()` method returns [`modem_lp_timer_conf::R`](R) reader structure
impl crate::Readable for MODEM_LP_TIMER_CONF_SPEC {}
///`write(|w| ..)` method takes [`modem_lp_timer_conf::W`](W) writer structure
impl crate::Writable for MODEM_LP_TIMER_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MODEM_LP_TIMER_CONF to value 0
