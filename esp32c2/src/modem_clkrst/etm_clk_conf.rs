...
///`read()` method returns [`etm_clk_conf::R`](R) reader structure
impl crate::Readable for ETM_CLK_CONF_SPEC {}
///`write(|w| ..)` method takes [`etm_clk_conf::W`](W) writer structure
impl crate::Writable for ETM_CLK_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ETM_CLK_CONF to value 0
