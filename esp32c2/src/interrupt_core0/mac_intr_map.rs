///Register `MAC_INTR_MAP` reader
pub type R = crate::R<MAC_INTR_MAP_SPEC>;
///Register `MAC_INTR_MAP` writer
pub type W = crate::W<MAC_INTR_MAP_SPEC>;
///Field `WIFI_MAC_INT_MAP` reader - Need add description
pub type WIFI_MAC_INT_MAP_R = crate::FieldReader;
///Field `WIFI_MAC_INT_MAP` writer - Need add description
...
///`read()` method returns [`mac_intr_map::R`](R) reader structure
impl crate::Readable for MAC_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`mac_intr_map::W`](W) writer structure
impl crate::Writable for MAC_INTR_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MAC_INTR_MAP to value 0
