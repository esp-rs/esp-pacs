...
pub type CPU_PRI_24_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CPU_PRI_24_MAP` writer - Need add description"]
pub type CPU_PRI_24_MAP_W<'a> = crate::FieldWriter<'a, u32, CPU_INT_PRI_24_SPEC, u8, u8, 4, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:3 - Need add description"]
    #[inline(always)]
    pub fn cpu_pri_24_map(&mut self) -> CPU_PRI_24_MAP_W {
