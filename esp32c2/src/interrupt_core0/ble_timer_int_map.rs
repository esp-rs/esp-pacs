///Register `BLE_TIMER_INT_MAP` reader
pub type R = crate::R<BLE_TIMER_INT_MAP_SPEC>;
///Register `BLE_TIMER_INT_MAP` writer
pub type W = crate::W<BLE_TIMER_INT_MAP_SPEC>;
///Field `BLE_TIMER_INT_MAP` reader - Need add description
pub type BLE_TIMER_INT_MAP_R = crate::FieldReader;
///Field `BLE_TIMER_INT_MAP` writer - Need add description
...
///`read()` method returns [`ble_timer_int_map::R`](R) reader structure
impl crate::Readable for BLE_TIMER_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`ble_timer_int_map::W`](W) writer structure
impl crate::Writable for BLE_TIMER_INT_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets BLE_TIMER_INT_MAP to value 0
