///Register `WIFI_PWR_INT_MAP` reader
pub type R = crate::R<WIFI_PWR_INT_MAP_SPEC>;
///Register `WIFI_PWR_INT_MAP` writer
pub type W = crate::W<WIFI_PWR_INT_MAP_SPEC>;
///Field `WIFI_PWR_INT_MAP` reader - Need add description
pub type WIFI_PWR_INT_MAP_R = crate::FieldReader;
///Field `WIFI_PWR_INT_MAP` writer - Need add description
pub type WIFI_PWR_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("WIFI_PWR_INT_MAP")
            .field("wifi_pwr_int_map", &self.wifi_pwr_int_map())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wifi_pwr_int_map(&mut self) -> WIFI_PWR_INT_MAP_W<WIFI_PWR_INT_MAP_SPEC> {
        WIFI_PWR_INT_MAP_W::new(self, 0)
    }
}
...
///`read()` method returns [`wifi_pwr_int_map::R`](R) reader structure
impl crate::Readable for WIFI_PWR_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`wifi_pwr_int_map::W`](W) writer structure
impl crate::Writable for WIFI_PWR_INT_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets WIFI_PWR_INT_MAP to value 0
