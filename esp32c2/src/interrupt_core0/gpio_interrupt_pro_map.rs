...
#[doc = "Field `GPIO_INTERRUPT_PRO_MAP` reader - Need add description"]
pub type GPIO_INTERRUPT_PRO_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GPIO_INTERRUPT_PRO_MAP` writer - Need add description"]
pub type GPIO_INTERRUPT_PRO_MAP_W<'a> =
    crate::FieldWriter<'a, u32, GPIO_INTERRUPT_PRO_MAP_SPEC, u8, u8, 5, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - Need add description"]
    #[inline(always)]
    pub fn gpio_interrupt_pro_map(&mut self) -> GPIO_INTERRUPT_PRO_MAP_W {
