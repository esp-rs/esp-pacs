...
pub type SPI_MEM_REJECT_INTR_MAP_W<'a> =
    crate::FieldWriter<'a, u32, SPI_MEM_REJECT_INTR_MAP_SPEC, u8, u8, 5, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - Need add description"]
    #[inline(always)]
    pub fn spi_mem_reject_intr_map(&mut self) -> SPI_MEM_REJECT_INTR_MAP_W {
