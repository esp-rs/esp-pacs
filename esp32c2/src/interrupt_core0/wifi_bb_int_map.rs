///Register `WIFI_BB_INT_MAP` reader
pub type R = crate::R<WIFI_BB_INT_MAP_SPEC>;
///Register `WIFI_BB_INT_MAP` writer
pub type W = crate::W<WIFI_BB_INT_MAP_SPEC>;
///Field `WIFI_BB_INT_MAP` reader - Need add description
pub type WIFI_BB_INT_MAP_R = crate::FieldReader;
///Field `WIFI_BB_INT_MAP` writer - Need add description
...
You can [`read`](crate::generic::Reg::read) this register and get [`wifi_bb_int_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wifi_bb_int_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct WIFI_BB_INT_MAP_SPEC;
impl crate::RegisterSpec for WIFI_BB_INT_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`wifi_bb_int_map::R`](R) reader structure
impl crate::Readable for WIFI_BB_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`wifi_bb_int_map::W`](W) writer structure
impl crate::Writable for WIFI_BB_INT_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets WIFI_BB_INT_MAP to value 0
