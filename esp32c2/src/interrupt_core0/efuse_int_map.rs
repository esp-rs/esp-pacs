...
#[doc = "Field `EFUSE_INT_MAP` reader - Need add description"]
pub type EFUSE_INT_MAP_R = crate::FieldReader;
#[doc = "Field `EFUSE_INT_MAP` writer - Need add description"]
pub type EFUSE_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn efuse_int_map(&mut self) -> EFUSE_INT_MAP_W<EFUSE_INT_MAP_SPEC, 0> {
