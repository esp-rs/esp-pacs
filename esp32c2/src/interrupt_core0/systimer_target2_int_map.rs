...
pub type SYSTIMER_TARGET2_INT_MAP_W<'a> =
    crate::FieldWriter<'a, u32, SYSTIMER_TARGET2_INT_MAP_SPEC, u8, u8, 5, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - Need add description"]
    #[inline(always)]
    pub fn systimer_target2_int_map(&mut self) -> SYSTIMER_TARGET2_INT_MAP_W {
