///Register `COEX_INT_MAP` reader
pub type R = crate::R<COEX_INT_MAP_SPEC>;
///Register `COEX_INT_MAP` writer
pub type W = crate::W<COEX_INT_MAP_SPEC>;
///Field `COEX_INT_MAP` reader - Need add description
pub type COEX_INT_MAP_R = crate::FieldReader;
///Field `COEX_INT_MAP` writer - Need add description
...
///`read()` method returns [`coex_int_map::R`](R) reader structure
impl crate::Readable for COEX_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`coex_int_map::W`](W) writer structure
impl crate::Writable for COEX_INT_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets COEX_INT_MAP to value 0
