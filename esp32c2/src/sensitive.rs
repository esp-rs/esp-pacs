...
/**ROM_TABLE_LOCK (rw) register accessor: register description
...
/**ROM_TABLE (rw) register accessor: register description
...
///register description
pub mod rom_table;
/**APB_PERIPHERAL_ACCESS_0 (rw) register accessor: register description
...
/**CACHE_TAG_ACCESS_1 (rw) register accessor: register description
...
/**CACHE_MMU_ACCESS_0 (rw) register accessor: register description
...
/**CACHE_MMU_ACCESS_1 (rw) register accessor: register description
...
/**PIF_ACCESS_MONITOR_0 (rw) register accessor: register description
...
///register description
pub mod clock_gate;
/**SENSITIVE_REG_DATE (rw) register accessor: register description
