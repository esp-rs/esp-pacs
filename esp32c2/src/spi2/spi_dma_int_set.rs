...
impl W {
    ...
    #[inline(always)]
    pub fn spi_mst_tx_afifo_rempty_err_int_set(&mut self) -> SPI_MST_TX_AFIFO_REMPTY_ERR_INT_SET_W {
        SPI_MST_TX_AFIFO_REMPTY_ERR_INT_SET_W::new(self)
    }
    #[doc = "Bit 19 - The software set bit for SPI_APP2_INT interrupt."]
    #[inline(always)]
    pub fn spi_app2_int_set(&mut self) -> SPI_APP2_INT_SET_W {
        SPI_APP2_INT_SET_W::new(self)
    }
    #[doc = "Bit 20 - The software set bit for SPI_APP1_INT interrupt."]
    #[inline(always)]
    pub fn spi_app1_int_set(&mut self) -> SPI_APP1_INT_SET_W {
