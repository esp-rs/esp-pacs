...
///Field `DMA_INFIFO_FULL_ERR_INT_SET` writer - The software set bit for SPI_DMA_INFIFO_FULL_ERR_INT interrupt.
pub type DMA_INFIFO_FULL_ERR_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_OUTFIFO_EMPTY_ERR_INT_SET` writer - The software set bit for SPI_DMA_OUTFIFO_EMPTY_ERR_INT interrupt.
pub type DMA_OUTFIFO_EMPTY_ERR_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_EX_QPI_INT_SET` writer - The software set bit for SPI slave Ex_QPI interrupt.
pub type SLV_EX_QPI_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_EN_QPI_INT_SET` writer - The software set bit for SPI slave En_QPI interrupt.
pub type SLV_EN_QPI_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMD7_INT_SET` writer - The software set bit for SPI slave CMD7 interrupt.
pub type SLV_CMD7_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMD8_INT_SET` writer - The software set bit for SPI slave CMD8 interrupt.
pub type SLV_CMD8_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMD9_INT_SET` writer - The software set bit for SPI slave CMD9 interrupt.
pub type SLV_CMD9_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMDA_INT_SET` writer - The software set bit for SPI slave CMDA interrupt.
pub type SLV_CMDA_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_RD_DMA_DONE_INT_SET` writer - The software set bit for SPI_SLV_RD_DMA_DONE_INT interrupt.
pub type SLV_RD_DMA_DONE_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_WR_DMA_DONE_INT_SET` writer - The software set bit for SPI_SLV_WR_DMA_DONE_INT interrupt.
pub type SLV_WR_DMA_DONE_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_RD_BUF_DONE_INT_SET` writer - The software set bit for SPI_SLV_RD_BUF_DONE_INT interrupt.
pub type SLV_RD_BUF_DONE_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_WR_BUF_DONE_INT_SET` writer - The software set bit for SPI_SLV_WR_BUF_DONE_INT interrupt.
pub type SLV_WR_BUF_DONE_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_DONE_INT_SET` writer - The software set bit for SPI_TRANS_DONE_INT interrupt.
pub type TRANS_DONE_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_SEG_TRANS_DONE_INT_SET` writer - The software set bit for SPI_DMA_SEG_TRANS_DONE_INT interrupt.
pub type DMA_SEG_TRANS_DONE_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEG_MAGIC_ERR_INT_SET` writer - The software set bit for SPI_SEG_MAGIC_ERR_INT interrupt.
pub type SEG_MAGIC_ERR_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_BUF_ADDR_ERR_INT_SET` writer - The software set bit for SPI_SLV_BUF_ADDR_ERR_INT interrupt.
pub type SLV_BUF_ADDR_ERR_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMD_ERR_INT_SET` writer - The software set bit for SPI_SLV_CMD_ERR_INT interrupt.
pub type SLV_CMD_ERR_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MST_RX_AFIFO_WFULL_ERR_INT_SET` writer - The software set bit for SPI_MST_RX_AFIFO_WFULL_ERR_INT interrupt.
pub type MST_RX_AFIFO_WFULL_ERR_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MST_TX_AFIFO_REMPTY_ERR_INT_SET` writer - The software set bit for SPI_MST_TX_AFIFO_REMPTY_ERR_INT interrupt.
pub type MST_TX_AFIFO_REMPTY_ERR_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APP2_INT_SET` writer - The software set bit for SPI_APP2_INT interrupt.
pub type APP2_INT_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APP1_INT_SET` writer - The software set bit for SPI_APP1_INT interrupt.
...
///`write(|w| ..)` method takes [`dma_int_set::W`](W) writer structure
