...
pub type DIN4_MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIN_MODE_SPEC, u8, u8, 2, O>;
...
pub type DIN5_MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIN_MODE_SPEC, u8, u8, 2, O>;
...
pub type DIN6_MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIN_MODE_SPEC, u8, u8, 2, O>;
...
pub type DIN7_MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIN_MODE_SPEC, u8, u8, 2, O>;
...
pub type TIMING_HCLK_ACTIVE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DIN_MODE_SPEC, bool, O>;
impl R {
