...
pub type SPI_CONF_BITLEN_W<'a> = crate::FieldWriter<'a, u32, SPI_CMD_SPEC, u32, u32, 18, 0>;
...
pub type SPI_UPDATE_W<'a> = crate::BitWriter<'a, u32, SPI_CMD_SPEC, bool, 23>;
...
pub type SPI_USR_W<'a> = crate::BitWriter<'a, u32, SPI_CMD_SPEC, bool, 24>;
impl R {
