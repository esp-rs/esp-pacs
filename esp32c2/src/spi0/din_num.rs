...
pub type DIN0_NUM_W<'a, const O: u8> = crate::BitWriter<'a, u32, DIN_NUM_SPEC, bool, O>;
...
pub type DIN1_NUM_W<'a, const O: u8> = crate::BitWriter<'a, u32, DIN_NUM_SPEC, bool, O>;
...
pub type DIN2_NUM_W<'a, const O: u8> = crate::BitWriter<'a, u32, DIN_NUM_SPEC, bool, O>;
...
pub type DIN3_NUM_W<'a, const O: u8> = crate::BitWriter<'a, u32, DIN_NUM_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 1 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn din1_num(&mut self) -> DIN1_NUM_W<1> {
        DIN1_NUM_W::new(self)
    }
    #[doc = "Bit 2 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn din2_num(&mut self) -> DIN2_NUM_W<2> {
        DIN2_NUM_W::new(self)
    }
    #[doc = "Bit 3 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn din3_num(&mut self) -> DIN3_NUM_W<3> {
        DIN3_NUM_W::new(self)
    }
