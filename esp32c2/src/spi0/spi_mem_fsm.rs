...
pub type SPI_MEM_CSPI_LOCK_DELAY_TIME_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_MEM_FSM_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    #[doc = "Bits 7:11 - The lock delay time of SPI0/1 arbiter by spi0_slv_st, after PER is sent by SPI1."]
    #[inline(always)]
    pub fn spi_mem_cspi_lock_delay_time(&mut self) -> SPI_MEM_CSPI_LOCK_DELAY_TIME_W<7> {
