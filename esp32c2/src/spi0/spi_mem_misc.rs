...
pub type SPI_MEM_TRANS_END_W<'a, const O: u8> =
...
pub type SPI_MEM_TRANS_END_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_MEM_MISC_SPEC, bool, O>;
...
pub type SPI_MEM_CSPI_ST_TRANS_END_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_MEM_MISC_SPEC, bool, O>;
...
pub type SPI_MEM_CSPI_ST_TRANS_END_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_MEM_MISC_SPEC, bool, O>;
...
impl W {
    #[doc = "Bit 3 - The bit is used to indicate the spi0_mst_st controlled transmitting is done."]
    #[inline(always)]
    pub fn spi_mem_trans_end(&mut self) -> SPI_MEM_TRANS_END_W<3> {
        SPI_MEM_TRANS_END_W::new(self)
    }
    #[doc = "Bit 4 - The bit is used to enable the interrupt of spi0_mst_st controlled transmitting is done."]
    #[inline(always)]
    pub fn spi_mem_trans_end_int_ena(&mut self) -> SPI_MEM_TRANS_END_INT_ENA_W<4> {
        SPI_MEM_TRANS_END_INT_ENA_W::new(self)
    }
    #[doc = "Bit 5 - The bit is used to indicate the spi0_slv_st controlled transmitting is done."]
    #[inline(always)]
    pub fn spi_mem_cspi_st_trans_end(&mut self) -> SPI_MEM_CSPI_ST_TRANS_END_W<5> {
        SPI_MEM_CSPI_ST_TRANS_END_W::new(self)
    }
    #[doc = "Bit 6 - The bit is used to enable the interrupt of spi0_slv_st controlled transmitting is done."]
    #[inline(always)]
    pub fn spi_mem_cspi_st_trans_end_int_ena(&mut self) -> SPI_MEM_CSPI_ST_TRANS_END_INT_ENA_W<6> {
