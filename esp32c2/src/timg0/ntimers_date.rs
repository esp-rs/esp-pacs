...
///Field `NTIMGS_DATE` reader - Timer version control register
pub type NTIMGS_DATE_R = crate::FieldReader<u32>;
///Field `NTIMGS_DATE` writer - Timer version control register
...
///`reset()` method sets NTIMERS_DATE to value 0x0200_6191
