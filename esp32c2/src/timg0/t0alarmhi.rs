...
#[doc = "Field `T0_ALARM_HI` reader - Timer 0 alarm trigger time-base counter value, high 22 bits."]
pub type T0_ALARM_HI_R = crate::FieldReader<u32, u32>;
#[doc = "Field `T0_ALARM_HI` writer - Timer 0 alarm trigger time-base counter value, high 22 bits."]
pub type T0_ALARM_HI_W<'a> = crate::FieldWriter<'a, u32, T0ALARMHI_SPEC, u32, u32, 22, 0>;
impl R {
    #[doc = "Bits 0:21 - Timer 0 alarm trigger time-base counter value, high 22 bits."]
    #[inline(always)]
