...
#[doc = "Field `ALARM_HI` reader - Timer 0 alarm trigger time-base counter value, high 22 bits."]
pub type ALARM_HI_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ALARM_HI` writer - Timer 0 alarm trigger time-base counter value, high 22 bits."]
