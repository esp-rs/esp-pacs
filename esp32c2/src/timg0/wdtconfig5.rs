///Register `WDTCONFIG5` reader
pub type R = crate::R<WDTCONFIG5_SPEC>;
///Register `WDTCONFIG5` writer
pub type W = crate::W<WDTCONFIG5_SPEC>;
///Field `WDT_STG3_HOLD` reader - Stage 3 timeout value, in MWDT clock cycles.
pub type WDT_STG3_HOLD_R = crate::FieldReader<u32>;
///Field `WDT_STG3_HOLD` writer - Stage 3 timeout value, in MWDT clock cycles.
pub type WDT_STG3_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Stage 3 timeout value, in MWDT clock cycles.
    #[inline(always)]
...
///`read()` method returns [`wdtconfig5::R`](R) reader structure
impl crate::Readable for WDTCONFIG5_SPEC {}
///`write(|w| ..)` method takes [`wdtconfig5::W`](W) writer structure
