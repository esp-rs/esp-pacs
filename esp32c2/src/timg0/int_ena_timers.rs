...
///Field `T(0-0)` reader - The interrupt enable bit for the TIMG_T%s_INT interrupt.
pub type T_R = crate::BitReader;
///Field `T(0-0)` writer - The interrupt enable bit for the TIMG_T%s_INT interrupt.
...
impl R {
    ///The interrupt enable bit for the TIMG_T(0-0)_INT interrupt.
    ///
