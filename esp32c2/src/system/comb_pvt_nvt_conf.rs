...
pub type COMB_PATH_LEN_NVT_W<'a> =
    crate::FieldWriter<'a, u32, COMB_PVT_NVT_CONF_SPEC, u8, u8, 6, 0>;
#[doc = "Field `COMB_ERR_CNT_CLR_NVT` writer - reg_comb_err_cnt_clr_nvt"]
pub type COMB_ERR_CNT_CLR_NVT_W<'a> = crate::BitWriter<'a, u32, COMB_PVT_NVT_CONF_SPEC, bool, 6>;
...
pub type COMB_PVT_MONITOR_EN_NVT_W<'a> = crate::BitWriter<'a, u32, COMB_PVT_NVT_CONF_SPEC, bool, 7>;
impl R {
...
impl W {
    #[doc = "Bits 0:5 - reg_comb_path_len_nvt"]
    #[inline(always)]
    pub fn comb_path_len_nvt(&mut self) -> COMB_PATH_LEN_NVT_W {
        COMB_PATH_LEN_NVT_W::new(self)
    }
    #[doc = "Bit 6 - reg_comb_err_cnt_clr_nvt"]
    #[inline(always)]
    pub fn comb_err_cnt_clr_nvt(&mut self) -> COMB_ERR_CNT_CLR_NVT_W {
        COMB_ERR_CNT_CLR_NVT_W::new(self)
    }
    #[doc = "Bit 7 - reg_comb_pvt_monitor_en_nvt"]
    #[inline(always)]
    pub fn comb_pvt_monitor_en_nvt(&mut self) -> COMB_PVT_MONITOR_EN_NVT_W {
