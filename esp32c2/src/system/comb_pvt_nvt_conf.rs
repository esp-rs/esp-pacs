///Register `COMB_PVT_NVT_CONF` reader
pub type R = crate::R<COMB_PVT_NVT_CONF_SPEC>;
///Register `COMB_PVT_NVT_CONF` writer
pub type W = crate::W<COMB_PVT_NVT_CONF_SPEC>;
///Field `COMB_PATH_LEN_NVT` reader - reg_comb_path_len_nvt
pub type COMB_PATH_LEN_NVT_R = crate::FieldReader;
///Field `COMB_PATH_LEN_NVT` writer - reg_comb_path_len_nvt
pub type COMB_PATH_LEN_NVT_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `COMB_ERR_CNT_CLR_NVT` writer - reg_comb_err_cnt_clr_nvt
pub type COMB_ERR_CNT_CLR_NVT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COMB_PVT_MONITOR_EN_NVT` reader - reg_comb_pvt_monitor_en_nvt
pub type COMB_PVT_MONITOR_EN_NVT_R = crate::BitReader;
///Field `COMB_PVT_MONITOR_EN_NVT` writer - reg_comb_pvt_monitor_en_nvt
...
impl R {
    ...
    ///Bit 7 - reg_comb_pvt_monitor_en_nvt
    #[inline(always)]
...
impl W {
    ...
    ///Bit 6 - reg_comb_err_cnt_clr_nvt
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`comb_pvt_nvt_conf::R`](R) reader structure
impl crate::Readable for COMB_PVT_NVT_CONF_SPEC {}
///`write(|w| ..)` method takes [`comb_pvt_nvt_conf::W`](W) writer structure
