...
///Field `REDUNDANT_ECO_DRIVE` reader - reg_redundant_eco_drive
pub type REDUNDANT_ECO_DRIVE_R = crate::BitReader;
///Field `REDUNDANT_ECO_DRIVE` writer - reg_redundant_eco_drive
pub type REDUNDANT_ECO_DRIVE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REDUNDANT_ECO_RESULT` reader - reg_redundant_eco_result
