...
///Field `CLK_EN_ASSIST_DEBUG` reader - Set 1 to open assist_debug module clock
pub type CLK_EN_ASSIST_DEBUG_R = crate::BitReader;
///Field `CLK_EN_ASSIST_DEBUG` writer - Set 1 to open assist_debug module clock
pub type CLK_EN_ASSIST_DEBUG_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_EN_DEDICATED_GPIO` reader - Set 1 to open dedicated_gpio module clk
pub type CLK_EN_DEDICATED_GPIO_R = crate::BitReader;
///Field `CLK_EN_DEDICATED_GPIO` writer - Set 1 to open dedicated_gpio module clk
