...
#[doc = "Field `CPU_INTR_FROM_CPU_0` reader - Set 1 to generate cpu interrupt 0"]
pub type CPU_INTR_FROM_CPU_0_R = crate::BitReader<bool>;
#[doc = "Field `CPU_INTR_FROM_CPU_0` writer - Set 1 to generate cpu interrupt 0"]
pub type CPU_INTR_FROM_CPU_0_W<'a> = crate::BitWriter<'a, u32, CPU_INTR_FROM_CPU_0_SPEC, bool, 0>;
impl R {
    #[doc = "Bit 0 - Set 1 to generate cpu interrupt 0"]
    #[inline(always)]
