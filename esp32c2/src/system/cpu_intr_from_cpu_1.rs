...
#[doc = "Field `CPU_INTR_FROM_CPU_1` reader - Set 1 to generate cpu interrupt 1"]
pub type CPU_INTR_FROM_CPU_1_R = crate::BitReader<bool>;
#[doc = "Field `CPU_INTR_FROM_CPU_1` writer - Set 1 to generate cpu interrupt 1"]
pub type CPU_INTR_FROM_CPU_1_W<'a> = crate::BitWriter<'a, u32, CPU_INTR_FROM_CPU_1_SPEC, bool, 0>;
impl R {
...
impl W {
    ...
    pub fn cpu_intr_from_cpu_1(&mut self) -> CPU_INTR_FROM_CPU_1_W {
        CPU_INTR_FROM_CPU_1_W::new(self)
    }
...
#[doc = "interrupt generate register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cpu_intr_from_cpu_1](index.html) module"]
