...
pub type COMB_PATH_LEN_HVT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COMB_PVT_HVT_CONF_SPEC, u8, u8, 6, O>;
...
impl W {
    ...
    #[inline(always)]
    pub fn comb_err_cnt_clr_hvt(&mut self) -> COMB_ERR_CNT_CLR_HVT_W<6> {
        COMB_ERR_CNT_CLR_HVT_W::new(self)
    }
    #[doc = "Bit 7 - reg_comb_pvt_monitor_en_hvt"]
    #[inline(always)]
    pub fn comb_pvt_monitor_en_hvt(&mut self) -> COMB_PVT_MONITOR_EN_HVT_W<7> {
