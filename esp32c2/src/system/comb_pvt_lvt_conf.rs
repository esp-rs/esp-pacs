...
pub type COMB_PATH_LEN_LVT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comb_err_cnt_clr_lvt(&mut self) -> COMB_ERR_CNT_CLR_LVT_W<COMB_PVT_LVT_CONF_SPEC, 6> {
    ...
    pub fn comb_pvt_monitor_en_lvt(
        &mut self,
    ) -> COMB_PVT_MONITOR_EN_LVT_W<COMB_PVT_LVT_CONF_SPEC, 7> {
