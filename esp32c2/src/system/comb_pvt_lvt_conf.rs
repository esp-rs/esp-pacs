...
pub type COMB_PATH_LEN_LVT_W<'a> =
    crate::FieldWriter<'a, u32, COMB_PVT_LVT_CONF_SPEC, u8, u8, 6, 0>;
#[doc = "Field `COMB_ERR_CNT_CLR_LVT` writer - reg_comb_err_cnt_clr_lvt"]
pub type COMB_ERR_CNT_CLR_LVT_W<'a> = crate::BitWriter<'a, u32, COMB_PVT_LVT_CONF_SPEC, bool, 6>;
...
pub type COMB_PVT_MONITOR_EN_LVT_W<'a> = crate::BitWriter<'a, u32, COMB_PVT_LVT_CONF_SPEC, bool, 7>;
impl R {
...
impl W {
    #[doc = "Bits 0:5 - reg_comb_path_len_lvt"]
    #[inline(always)]
    pub fn comb_path_len_lvt(&mut self) -> COMB_PATH_LEN_LVT_W {
        COMB_PATH_LEN_LVT_W::new(self)
    }
    #[doc = "Bit 6 - reg_comb_err_cnt_clr_lvt"]
    #[inline(always)]
    pub fn comb_err_cnt_clr_lvt(&mut self) -> COMB_ERR_CNT_CLR_LVT_W {
        COMB_ERR_CNT_CLR_LVT_W::new(self)
    }
    #[doc = "Bit 7 - reg_comb_pvt_monitor_en_lvt"]
    #[inline(always)]
    pub fn comb_pvt_monitor_en_lvt(&mut self) -> COMB_PVT_MONITOR_EN_LVT_W {
