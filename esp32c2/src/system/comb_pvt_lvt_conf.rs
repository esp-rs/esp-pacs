...
pub type COMB_PATH_LEN_LVT_W<'a, const O: u8> =
    crate::FieldWriter<'a, COMB_PVT_LVT_CONF_SPEC, 6, O>;
#[doc = "Field `COMB_ERR_CNT_CLR_LVT` writer - reg_comb_err_cnt_clr_lvt"]
pub type COMB_ERR_CNT_CLR_LVT_W<'a, const O: u8> = crate::BitWriter<'a, COMB_PVT_LVT_CONF_SPEC, O>;
...
pub type COMB_PVT_MONITOR_EN_LVT_W<'a, const O: u8> =
    crate::BitWriter<'a, COMB_PVT_LVT_CONF_SPEC, O>;
impl R {
