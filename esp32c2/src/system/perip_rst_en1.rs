...
///Field `CRYPTO_ECC_RST` reader - Set 1 to let CRYPTO_ECC reset
pub type CRYPTO_ECC_RST_R = crate::BitReader;
///Field `CRYPTO_ECC_RST` writer - Set 1 to let CRYPTO_ECC reset
...
///Field `TSENS_RST` reader - Set 1 to let TSENS reset
pub type TSENS_RST_R = crate::BitReader;
///Field `TSENS_RST` writer - Set 1 to let TSENS reset
...
///`reset()` method sets PERIP_RST_EN1 to value 0x46
