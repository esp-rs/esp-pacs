///Register `COMB_PVT_ERR_LVT_SITE3` reader
pub type R = crate::R<COMB_PVT_ERR_LVT_SITE3_SPEC>;
///Field `COMB_TIMING_ERR_CNT_LVT_SITE3` reader - reg_comb_timing_err_cnt_lvt_site3
pub type COMB_TIMING_ERR_CNT_LVT_SITE3_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - reg_comb_timing_err_cnt_lvt_site3
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PVT_ERR_LVT_SITE3")
            .field(
                ...
                &self.comb_timing_err_cnt_lvt_site3(),
            )
            .finish()
    }
}
...
You can [`read`](crate::generic::Reg::read) this register and get [`comb_pvt_err_lvt_site3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct COMB_PVT_ERR_LVT_SITE3_SPEC;
impl crate::RegisterSpec for COMB_PVT_ERR_LVT_SITE3_SPEC {
    type Ux = u32;
}
///`read()` method returns [`comb_pvt_err_lvt_site3::R`](R) reader structure
