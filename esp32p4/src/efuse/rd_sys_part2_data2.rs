...
#[doc = "Field `SYS_DATA_PART2_2` reader - Represents the second 32-bit of second part of system data."]
pub type SYS_DATA_PART2_2_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the second 32-bit of second part of system data."]
    #[inline(always)]
