///Register `APB2OTP_BLK3_W6` reader
pub type R = crate::R<APB2OTP_BLK3_W6_SPEC>;
///Field `APB2OTP_BLOCK3_W6` reader - Otp block3 word6 data.
pub type APB2OTP_BLOCK3_W6_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block3 word6 data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk3_w6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK3_W6_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK3_W6_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk3_w6::R`](R) reader structure
