///Register `APB2OTP_BLK0_BACKUP3_W4` reader
pub type R = crate::R<APB2OTP_BLK0_BACKUP3_W4_SPEC>;
///Field `APB2OTP_BLOCK0_BACKUP3_W4` reader - Otp block0 backup3 word4 data.
...
///`read()` method returns [`apb2otp_blk0_backup3_w4::R`](R) reader structure
