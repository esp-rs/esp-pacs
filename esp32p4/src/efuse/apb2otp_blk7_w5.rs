///Register `APB2OTP_BLK7_W5` reader
pub type R = crate::R<APB2OTP_BLK7_W5_SPEC>;
///Field `APB2OTP_BLOCK7_W5` reader - Otp block7 word5 data.
pub type APB2OTP_BLOCK7_W5_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block7 word5 data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk7_w5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK7_W5_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK7_W5_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk7_w5::R`](R) reader structure
