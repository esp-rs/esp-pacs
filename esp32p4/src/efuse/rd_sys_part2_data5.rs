...
#[doc = "Field `SYS_DATA_PART2_5` reader - Represents the fifth 32-bit of second part of system data."]
pub type SYS_DATA_PART2_5_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the fifth 32-bit of second part of system data."]
    #[inline(always)]
...
#[doc = "Represents rd_sys_part2_data\n\nYou can [`read`](crate::Reg::read) this register and get [`rd_sys_part2_data5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
