///Register `RD_USR_DATA1` reader
pub type R = crate::R<RD_USR_DATA1_SPEC>;
///Field `USR_DATA1` reader - Stores the first 32 bits of BLOCK3 (user).
pub type USR_DATA1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the first 32 bits of BLOCK3 (user).
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_USR_DATA1")
            .field("usr_data1", &self.usr_data1())
            .finish()
    }
}
...
///`read()` method returns [`rd_usr_data1::R`](R) reader structure
