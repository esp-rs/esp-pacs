///Register `APB2OTP_BLK8_W7` reader
pub type R = crate::R<APB2OTP_BLK8_W7_SPEC>;
///Field `APB2OTP_BLOCK8_W7` reader - Otp block8 word7 data.
pub type APB2OTP_BLOCK8_W7_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block8 word7 data.
    #[inline(always)]
...
///`read()` method returns [`apb2otp_blk8_w7::R`](R) reader structure
