...
///Field `PGM_DATA_6` reader - Configures the 6th 32-bit data to be programmed.
pub type PGM_DATA_6_R = crate::FieldReader<u32>;
///Field `PGM_DATA_6` writer - Configures the 6th 32-bit data to be programmed.
pub type PGM_DATA_6_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures the 6th 32-bit data to be programmed.
    #[inline(always)]
