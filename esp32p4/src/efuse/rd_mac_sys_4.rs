///Register `RD_MAC_SYS_4` reader
pub type R = crate::R<RD_MAC_SYS_4_SPEC>;
///Field `SYS_DATA_PART0_1` reader - Stores the first 32 bits of the zeroth part of system data.
pub type SYS_DATA_PART0_1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the first 32 bits of the zeroth part of system data.
    #[inline(always)]
...
///`read()` method returns [`rd_mac_sys_4::R`](R) reader structure
