///Register `APB2OTP_BLK0_BACKUP4_W1` reader
pub type R = crate::R<APB2OTP_BLK0_BACKUP4_W1_SPEC>;
///Field `APB2OTP_BLOCK0_BACKUP4_W1` reader - Otp block0 backup4 word1 data.
...
///`read()` method returns [`apb2otp_blk0_backup4_w1::R`](R) reader structure
