///Register `APB2OTP_BLK6_W7` reader
pub type R = crate::R<APB2OTP_BLK6_W7_SPEC>;
///Field `APB2OTP_BLOCK6_W7` reader - Otp block6 word7 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk6_w7::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK6_W7_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK6_W7_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk6_w7::R`](R) reader structure
