///Register `APB2OTP_BLK3_W9` reader
pub type R = crate::R<APB2OTP_BLK3_W9_SPEC>;
///Field `APB2OTP_BLOCK3_W9` reader - Otp block3 word9 data.
pub type APB2OTP_BLOCK3_W9_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block3 word9 data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk3_w9::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK3_W9_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK3_W9_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk3_w9::R`](R) reader structure
