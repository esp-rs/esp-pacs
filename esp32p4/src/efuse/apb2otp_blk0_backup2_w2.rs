///Register `APB2OTP_BLK0_BACKUP2_W2` reader
pub type R = crate::R<APB2OTP_BLK0_BACKUP2_W2_SPEC>;
///Field `APB2OTP_BLOCK0_BACKUP2_W2` reader - Otp block0 backup2 word2 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk0_backup2_w2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK0_BACKUP2_W2_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK0_BACKUP2_W2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk0_backup2_w2::R`](R) reader structure
