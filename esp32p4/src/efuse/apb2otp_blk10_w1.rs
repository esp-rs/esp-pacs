///Register `APB2OTP_BLK10_W1` reader
pub type R = crate::R<APB2OTP_BLK10_W1_SPEC>;
///Field `APB2OTP_BLOCK10_W1` reader - Otp block10 word1 data.
pub type APB2OTP_BLOCK10_W1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block10 word1 data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk10_w1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK10_W1_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK10_W1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk10_w1::R`](R) reader structure
