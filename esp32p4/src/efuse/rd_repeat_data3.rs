...
///Field `DIS_USB_SERIAL_JTAG_ROM_PRINT` reader - Represents whether print from USB-Serial-JTAG is disabled or enabled. 1: disabled. 0: enabled.
pub type DIS_USB_SERIAL_JTAG_ROM_PRINT_R = crate::BitReader;
///Field `LOCK_KM_KEY` reader - TBD
...
///Field `HYS_EN_PAD` reader - Represents whether the hysteresis function of corresponding PAD is enabled. 1: enabled. 0:disabled.
pub type HYS_EN_PAD_R = crate::BitReader;
///Field `DCDC_VSET` reader - Set the dcdc voltage default.
pub type DCDC_VSET_R = crate::FieldReader;
impl R {
    ...
    ///Bit 26 - Represents whether the hysteresis function of corresponding PAD is enabled. 1: enabled. 0:disabled.
    #[inline(always)]
    pub fn hys_en_pad(&self) -> HYS_EN_PAD_R {
        HYS_EN_PAD_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bits 27:31 - Set the dcdc voltage default.
    #[inline(always)]
    pub fn dcdc_vset(&self) -> DCDC_VSET_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA3")
            ...
            .field("dcdc_vset", &self.dcdc_vset())
            .finish()
    }
}
