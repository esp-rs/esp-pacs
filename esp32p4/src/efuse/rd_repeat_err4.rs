...
///Field `_0PXA_TIEH_SEL_0_ERR` reader - Indicates a programming error of 0PXA_TIEH_SEL_0.
pub type _0PXA_TIEH_SEL_0_ERR_R = crate::FieldReader;
///Field `_0PXA_TIEH_SEL_1_ERR` reader - Indicates a programming error of 0PXA_TIEH_SEL_1.
pub type _0PXA_TIEH_SEL_1_ERR_R = crate::FieldReader;
///Field `_0PXA_TIEH_SEL_2_ERR` reader - Indicates a programming error of 0PXA_TIEH_SEL_2.
pub type _0PXA_TIEH_SEL_2_ERR_R = crate::FieldReader;
///Field `_0PXA_TIEH_SEL_3_ERR` reader - Indicates a programming error of 0PXA_TIEH_SEL_3.
pub type _0PXA_TIEH_SEL_3_ERR_R = crate::FieldReader;
///Field `KM_DISABLE_DEPLOY_MODE_ERR` reader - TBD.
pub type KM_DISABLE_DEPLOY_MODE_ERR_R = crate::FieldReader;
///Field `USB_DEVICE_DREFL_ERR` reader - Indicates a programming error of USB_DEVICE_DREFL.
pub type USB_DEVICE_DREFL_ERR_R = crate::FieldReader;
///Field `USB_OTG11_DREFL_ERR` reader - Indicates a programming error of USB_OTG11_DREFL.
pub type USB_OTG11_DREFL_ERR_R = crate::FieldReader;
///Field `HP_PWR_SRC_SEL_ERR` reader - Indicates a programming error of HP_PWR_SRC_SEL.
pub type HP_PWR_SRC_SEL_ERR_R = crate::BitReader;
///Field `DCDC_VSET_EN_ERR` reader - Indicates a programming error of DCDC_VSET_EN.
pub type DCDC_VSET_EN_ERR_R = crate::BitReader;
///Field `DIS_WDT_ERR` reader - Indicates a programming error of DIS_WDT.
pub type DIS_WDT_ERR_R = crate::BitReader;
///Field `DIS_SWD_ERR` reader - Indicates a programming error of DIS_SWD.
pub type DIS_SWD_ERR_R = crate::BitReader;
impl R {
    ///Bits 0:1 - Indicates a programming error of 0PXA_TIEH_SEL_0.
    #[inline(always)]
    pub fn _0pxa_tieh_sel_0_err(&self) -> _0PXA_TIEH_SEL_0_ERR_R {
        _0PXA_TIEH_SEL_0_ERR_R::new((self.bits & 3) as u8)
    }
    ///Bits 2:3 - Indicates a programming error of 0PXA_TIEH_SEL_1.
    #[inline(always)]
    pub fn _0pxa_tieh_sel_1_err(&self) -> _0PXA_TIEH_SEL_1_ERR_R {
        _0PXA_TIEH_SEL_1_ERR_R::new(((self.bits >> 2) & 3) as u8)
    }
    ///Bits 4:5 - Indicates a programming error of 0PXA_TIEH_SEL_2.
    #[inline(always)]
    pub fn _0pxa_tieh_sel_2_err(&self) -> _0PXA_TIEH_SEL_2_ERR_R {
        _0PXA_TIEH_SEL_2_ERR_R::new(((self.bits >> 4) & 3) as u8)
    }
    ///Bits 6:7 - Indicates a programming error of 0PXA_TIEH_SEL_3.
    #[inline(always)]
