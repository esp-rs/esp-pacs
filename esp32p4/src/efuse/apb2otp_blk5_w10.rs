///Register `APB2OTP_BLK5_W10` reader
pub type R = crate::R<APB2OTP_BLK5_W10_SPEC>;
///Field `APB2OTP_BLOCK5_W10` reader - Otp block5 word10 data.
pub type APB2OTP_BLOCK5_W10_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block5 word10 data.
    #[inline(always)]
...
///`read()` method returns [`apb2otp_blk5_w10::R`](R) reader structure
