...
///Field `MAC_SYS_ERR_NUM` reader - The value of this signal means the number of error bytes.
pub type MAC_SYS_ERR_NUM_R = crate::FieldReader;
///Field `MAC_SYS_FAIL` reader - 0: Means no failure and that the data of MAC_SPI_8M is reliable 1: Means that programming user data failed and the number of error bytes is over 6.
pub type MAC_SYS_FAIL_R = crate::BitReader;
///Field `SYS_PART1_ERR_NUM` reader - The value of this signal means the number of error bytes.
