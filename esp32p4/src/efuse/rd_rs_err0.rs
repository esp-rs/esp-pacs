...
#[doc = "Field `MAC_SYS_ERR_NUM` reader - The value of this signal means the number of error bytes."]
pub type MAC_SYS_ERR_NUM_R = crate::FieldReader;
#[doc = "Field `MAC_SYS_FAIL` reader - 0: Means no failure and that the data of MAC_SPI_8M is reliable 1: Means that programming user data failed and the number of error bytes is over 6."]
pub type MAC_SYS_FAIL_R = crate::BitReader;
#[doc = "Field `SYS_PART1_ERR_NUM` reader - The value of this signal means the number of error bytes."]
pub type SYS_PART1_ERR_NUM_R = crate::FieldReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn mac_sys_err_num(&self) -> MAC_SYS_ERR_NUM_R {
        MAC_SYS_ERR_NUM_R::new((self.bits & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn mac_sys_fail(&self) -> MAC_SYS_FAIL_R {
        MAC_SYS_FAIL_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bits 4:6 - The value of this signal means the number of error bytes."]
    #[inline(always)]
    pub fn sys_part1_err_num(&self) -> SYS_PART1_ERR_NUM_R {
        SYS_PART1_ERR_NUM_R::new(((self.bits >> 4) & 7) as u8)
    }
