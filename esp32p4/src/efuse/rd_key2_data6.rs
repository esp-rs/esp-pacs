///Register `RD_KEY2_DATA6` reader
pub type R = crate::R<RD_KEY2_DATA6_SPEC>;
///Field `KEY2_DATA6` reader - Stores the sixth 32 bits of KEY2.
pub type KEY2_DATA6_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the sixth 32 bits of KEY2.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_KEY2_DATA6")
            .field("key2_data6", &self.key2_data6())
            .finish()
    }
}
...
///`read()` method returns [`rd_key2_data6::R`](R) reader structure
