///Register `APB2OTP_BLK0_BACKUP4_W3` reader
pub type R = crate::R<APB2OTP_BLK0_BACKUP4_W3_SPEC>;
///Field `APB2OTP_BLOCK0_BACKUP4_W3` reader - Otp block0 backup4 word3 data.
pub type APB2OTP_BLOCK0_BACKUP4_W3_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block0 backup4 word3 data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk0_backup4_w3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK0_BACKUP4_W3_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK0_BACKUP4_W3_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk0_backup4_w3::R`](R) reader structure
