...
///Field `_0PXA_TIEH_SEL_0` reader - TBD
pub type _0PXA_TIEH_SEL_0_R = crate::FieldReader;
///Field `_0PXA_TIEH_SEL_1` reader - TBD.
pub type _0PXA_TIEH_SEL_1_R = crate::FieldReader;
///Field `_0PXA_TIEH_SEL_2` reader - TBD.
pub type _0PXA_TIEH_SEL_2_R = crate::FieldReader;
///Field `_0PXA_TIEH_SEL_3` reader - TBD.
pub type _0PXA_TIEH_SEL_3_R = crate::FieldReader;
///Field `KM_DISABLE_DEPLOY_MODE` reader - TBD.
pub type KM_DISABLE_DEPLOY_MODE_R = crate::FieldReader;
///Field `USB_DEVICE_DREFL` reader - Represents the usb device single-end input low threhold, 0.8 V to 1.04 V with step of 80 mV.
pub type USB_DEVICE_DREFL_R = crate::FieldReader;
///Field `USB_OTG11_DREFL` reader - Represents the usb otg11 single-end input low threhold, 0.8 V to 1.04 V with step of 80 mV.
pub type USB_OTG11_DREFL_R = crate::FieldReader;
///Field `HP_PWR_SRC_SEL` reader - HP system power source select. 0:LDO. 1: DCDC.
pub type HP_PWR_SRC_SEL_R = crate::BitReader;
///Field `DCDC_VSET_EN` reader - Select dcdc vset use efuse_dcdc_vset.
pub type DCDC_VSET_EN_R = crate::BitReader;
///Field `DIS_WDT` reader - Set this bit to disable watch dog.
pub type DIS_WDT_R = crate::BitReader;
///Field `DIS_SWD` reader - Set this bit to disable super-watchdog.
