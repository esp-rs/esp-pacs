///Register `RD_MAC_SYS_1` reader
pub type R = crate::R<RD_MAC_SYS_1_SPEC>;
///Field `MAC_1` reader - Stores the high 16 bits of MAC address.
pub type MAC_1_R = crate::FieldReader<u16>;
///Field `MAC_EXT` reader - Stores the extended bits of MAC address.
pub type MAC_EXT_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - Stores the high 16 bits of MAC address.
    #[inline(always)]
    pub fn mac_1(&self) -> MAC_1_R {
        MAC_1_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - Stores the extended bits of MAC address.
    #[inline(always)]
...
///`read()` method returns [`rd_mac_sys_1::R`](R) reader structure
