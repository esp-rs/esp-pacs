///Register `APB2OTP_BLK1_W2` reader
pub type R = crate::R<APB2OTP_BLK1_W2_SPEC>;
///Field `APB2OTP_BLOCK1_W2` reader - Otp block1 word2 data.
pub type APB2OTP_BLOCK1_W2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block1 word2 data.
    #[inline(always)]
...
///`read()` method returns [`apb2otp_blk1_w2::R`](R) reader structure
