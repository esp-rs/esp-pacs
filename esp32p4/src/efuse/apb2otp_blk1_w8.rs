///Register `APB2OTP_BLK1_W8` reader
pub type R = crate::R<APB2OTP_BLK1_W8_SPEC>;
///Field `APB2OTP_BLOCK1_W8` reader - Otp block1 word8 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk1_w8::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK1_W8_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK1_W8_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk1_w8::R`](R) reader structure
