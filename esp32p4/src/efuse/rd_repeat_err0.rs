...
///Field `DIS_USB_DEVICE_EXCHG_PINS_ERR` reader - Indicates a programming error of DIS_USB_DEVICE_EXCHG_PINS.
pub type DIS_USB_DEVICE_EXCHG_PINS_ERR_R = crate::BitReader;
///Field `DIS_USB_OTG11_EXCHG_PINS_ERR` reader - Indicates a programming error of DIS_USB_OTG11_EXCHG_PINS.
...
///Field `DIS_USB_SERIAL_JTAG_ERR` reader - Indicates a programming error of DIS_USB_SERIAL_JTAG.
...
///Field `DIS_TWAI_ERR` reader - Indicates a programming error of DIS_TWAI.
...
///Field `USB_DEVICE_DREFH_ERR` reader - Indicates a programming error of USB_DEVICE_DREFH.
pub type USB_DEVICE_DREFH_ERR_R = crate::FieldReader;
///Field `USB_OTG11_DREFH_ERR` reader - Indicates a programming error of USB_OTG11_DREFH.
pub type USB_OTG11_DREFH_ERR_R = crate::FieldReader;
///Field `USB_PHY_SEL_ERR` reader - Indicates a programming error of USB_PHY_SEL.
pub type USB_PHY_SEL_ERR_R = crate::BitReader;
///Field `HUK_GEN_STATE_LOW_ERR` reader - Indicates a programming error of HUK_GEN_STATE_LOW.
...
impl R {
    ...
    ///Bit 7 - Indicates a programming error of DIS_USB_DEVICE_EXCHG_PINS.
    #[inline(always)]
    ...
    ///Bit 8 - Indicates a programming error of DIS_USB_OTG11_EXCHG_PINS.
    #[inline(always)]
    ...
    ///Bit 11 - Indicates a programming error of DIS_USB_SERIAL_JTAG.
    #[inline(always)]
    ...
    ///Bit 14 - Indicates a programming error of DIS_TWAI.
    #[inline(always)]
