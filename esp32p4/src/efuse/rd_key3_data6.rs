///Register `RD_KEY3_DATA6` reader
pub type R = crate::R<RD_KEY3_DATA6_SPEC>;
///Field `KEY3_DATA6` reader - Stores the sixth 32 bits of KEY3.
pub type KEY3_DATA6_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the sixth 32 bits of KEY3.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_KEY3_DATA6")
            .field("key3_data6", &self.key3_data6())
            .finish()
    }
}
...
///`read()` method returns [`rd_key3_data6::R`](R) reader structure
