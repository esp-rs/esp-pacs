...
///Field `KM_HUK_GEN_STATE_HIGH_ERR` reader - Indicates a programming error of HUK_GEN_STATE_HIGH.
pub type KM_HUK_GEN_STATE_HIGH_ERR_R = crate::FieldReader;
///Field `KM_RND_SWITCH_CYCLE_ERR` reader - Indicates a programming error of KM_RND_SWITCH_CYCLE.
pub type KM_RND_SWITCH_CYCLE_ERR_R = crate::FieldReader;
///Field `KM_DEPLOY_ONLY_ONCE_ERR` reader - Indicates a programming error of KM_DEPLOY_ONLY_ONCE.
pub type KM_DEPLOY_ONLY_ONCE_ERR_R = crate::FieldReader;
///Field `FORCE_USE_KEY_MANAGER_KEY_ERR` reader - Indicates a programming error of FORCE_USE_KEY_MANAGER_KEY.
pub type FORCE_USE_KEY_MANAGER_KEY_ERR_R = crate::FieldReader;
///Field `FORCE_DISABLE_SW_INIT_KEY_ERR` reader - Indicates a programming error of FORCE_DISABLE_SW_INIT_KEY.
pub type FORCE_DISABLE_SW_INIT_KEY_ERR_R = crate::BitReader;
///Field `XTS_KEY_LENGTH_256_ERR` reader - Indicates a programming error of XTS_KEY_LENGTH_256.
...
impl R {
    ...
    ///Bit 13 - Indicates a programming error of FORCE_DISABLE_SW_INIT_KEY.
    #[inline(always)]
    ...
    ///Bit 14 - Indicates a programming error of XTS_KEY_LENGTH_256.
    #[inline(always)]
