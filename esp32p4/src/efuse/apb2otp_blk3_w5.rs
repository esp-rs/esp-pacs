///Register `APB2OTP_BLK3_W5` reader
pub type R = crate::R<APB2OTP_BLK3_W5_SPEC>;
///Field `APB2OTP_BLOCK3_W5` reader - Otp block3 word5 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk3_w5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK3_W5_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK3_W5_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk3_w5::R`](R) reader structure
