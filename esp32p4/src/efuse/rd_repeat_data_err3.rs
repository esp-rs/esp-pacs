...
impl R {
    ...
    #[inline(always)]
    pub fn key_purpose_0_h_err(&self) -> KEY_PURPOSE_0_H_ERR_R {
        KEY_PURPOSE_0_H_ERR_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - Represents the programming error of EFUSE_KEY_PURPOSE_1_H"]
    #[inline(always)]
    pub fn key_purpose_1_h_err(&self) -> KEY_PURPOSE_1_H_ERR_R {
        KEY_PURPOSE_1_H_ERR_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - Represents the programming error of EFUSE_KEY_PURPOSE_2_H"]
    #[inline(always)]
    pub fn key_purpose_2_h_err(&self) -> KEY_PURPOSE_2_H_ERR_R {
        KEY_PURPOSE_2_H_ERR_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - Represents the programming error of EFUSE_KEY_PURPOSE_3_H"]
    #[inline(always)]
    pub fn key_purpose_3_h_err(&self) -> KEY_PURPOSE_3_H_ERR_R {
        KEY_PURPOSE_3_H_ERR_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Represents the programming error of EFUSE_KEY_PURPOSE_4_H"]
    #[inline(always)]
    pub fn key_purpose_4_h_err(&self) -> KEY_PURPOSE_4_H_ERR_R {
        KEY_PURPOSE_4_H_ERR_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA_ERR3")
            ...
            .field("key_purpose_0_h_err", &self.key_purpose_0_h_err())
            .field("key_purpose_1_h_err", &self.key_purpose_1_h_err())
            .field("key_purpose_2_h_err", &self.key_purpose_2_h_err())
            .field("key_purpose_3_h_err", &self.key_purpose_3_h_err())
            .field("key_purpose_4_h_err", &self.key_purpose_4_h_err())
            .finish()
    }
}
