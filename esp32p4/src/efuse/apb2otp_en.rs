///Register `APB2OTP_EN` reader
pub type R = crate::R<APB2OTP_EN_SPEC>;
///Register `APB2OTP_EN` writer
pub type W = crate::W<APB2OTP_EN_SPEC>;
///Field `APB2OTP_APB2OTP_EN` reader - Apb2otp mode enable signal.
pub type APB2OTP_APB2OTP_EN_R = crate::BitReader;
///Field `APB2OTP_APB2OTP_EN` writer - Apb2otp mode enable signal.
pub type APB2OTP_APB2OTP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Apb2otp mode enable signal.
    #[inline(always)]
...
///`read()` method returns [`apb2otp_en::R`](R) reader structure
impl crate::Readable for APB2OTP_EN_SPEC {}
///`write(|w| ..)` method takes [`apb2otp_en::W`](W) writer structure
