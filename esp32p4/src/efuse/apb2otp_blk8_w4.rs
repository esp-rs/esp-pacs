///Register `APB2OTP_BLK8_W4` reader
pub type R = crate::R<APB2OTP_BLK8_W4_SPEC>;
///Field `APB2OTP_BLOCK8_W4` reader - Otp block8 word4 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk8_w4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK8_W4_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK8_W4_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk8_w4::R`](R) reader structure
