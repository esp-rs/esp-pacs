...
///Field `PGM_RS_DATA_2` reader - Configures the 2nd 32-bit RS code to be programmed.
pub type PGM_RS_DATA_2_R = crate::FieldReader<u32>;
///Field `PGM_RS_DATA_2` writer - Configures the 2nd 32-bit RS code to be programmed.
pub type PGM_RS_DATA_2_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures the 2nd 32-bit RS code to be programmed.
    #[inline(always)]
