///Register `RD_KEY0_DATA3` reader
pub type R = crate::R<RD_KEY0_DATA3_SPEC>;
///Field `KEY0_DATA3` reader - Stores the third 32 bits of KEY0.
pub type KEY0_DATA3_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the third 32 bits of KEY0.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_key0_data3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_KEY0_DATA3_SPEC;
impl crate::RegisterSpec for RD_KEY0_DATA3_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_key0_data3::R`](R) reader structure
