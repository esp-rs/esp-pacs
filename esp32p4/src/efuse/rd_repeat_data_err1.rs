...
pub type RECOVERY_BOOTLOADER_FLASH_SECTOR_8_10_ERR_R = crate::FieldReader;
...
pub type RECOVERY_BOOTLOADER_FLASH_SECTOR_11_11_ERR_R = crate::BitReader;
...
impl R {
    ...
    pub fn recovery_bootloader_flash_sector_8_10_err(
        &self,
    ) -> RECOVERY_BOOTLOADER_FLASH_SECTOR_8_10_ERR_R {
        RECOVERY_BOOTLOADER_FLASH_SECTOR_8_10_ERR_R::new((self.bits & 7) as u8)
    }
    ...
    pub fn recovery_bootloader_flash_sector_11_11_err(
        &self,
    ) -> RECOVERY_BOOTLOADER_FLASH_SECTOR_11_11_ERR_R {
        RECOVERY_BOOTLOADER_FLASH_SECTOR_11_11_ERR_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn km_rnd_switch_cycle_err(&self) -> KM_RND_SWITCH_CYCLE_ERR_R {
        KM_RND_SWITCH_CYCLE_ERR_R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    pub fn km_xts_key_length_256_err(&self) -> KM_XTS_KEY_LENGTH_256_ERR_R {
        KM_XTS_KEY_LENGTH_256_ERR_R::new(((self.bits >> 14) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA_ERR1")
            .field(
                "recovery_bootloader_flash_sector_8_10_err",
                &self.recovery_bootloader_flash_sector_8_10_err(),
            )
            .field(
                "recovery_bootloader_flash_sector_11_11_err",
                &self.recovery_bootloader_flash_sector_11_11_err(),
            )
