///Register `RD_SYS_PART1_DATA3` reader
pub type R = crate::R<RD_SYS_PART1_DATA3_SPEC>;
///Field `SYS_DATA_PART1_3` reader - Stores the third 32 bits of the first part of system data.
pub type SYS_DATA_PART1_3_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the third 32 bits of the first part of system data.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_SYS_PART1_DATA3")
            .field("sys_data_part1_3", &self.sys_data_part1_3())
            .finish()
    }
}
...
///`read()` method returns [`rd_sys_part1_data3::R`](R) reader structure
