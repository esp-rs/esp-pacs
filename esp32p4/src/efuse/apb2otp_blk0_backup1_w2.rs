///Register `APB2OTP_BLK0_BACKUP1_W2` reader
pub type R = crate::R<APB2OTP_BLK0_BACKUP1_W2_SPEC>;
///Field `APB2OTP_BLOCK0_BACKUP1_W2` reader - Otp block0 backup1 word2 data.
pub type APB2OTP_BLOCK0_BACKUP1_W2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block0 backup1 word2 data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`apb2otp_blk0_backup1_w2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APB2OTP_BLK0_BACKUP1_W2_SPEC;
impl crate::RegisterSpec for APB2OTP_BLK0_BACKUP1_W2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`apb2otp_blk0_backup1_w2::R`](R) reader structure
