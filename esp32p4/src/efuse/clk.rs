...
///Field `MEM_FORCE_PD` reader - Set this bit to force eFuse SRAM into power-saving mode.
pub type MEM_FORCE_PD_R = crate::BitReader;
///Field `MEM_FORCE_PD` writer - Set this bit to force eFuse SRAM into power-saving mode.
...
///Field `MEM_FORCE_PU` reader - Set this bit to force eFuse SRAM into working mode.
pub type MEM_FORCE_PU_R = crate::BitReader;
///Field `MEM_FORCE_PU` writer - Set this bit to force eFuse SRAM into working mode.
pub type MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EN` reader - Set this bit to force enable eFuse register configuration clock signal.
pub type EN_R = crate::BitReader;
///Field `EN` writer - Set this bit to force enable eFuse register configuration clock signal.
...
impl R {
    ...
    ///Bit 16 - Set this bit to force enable eFuse register configuration clock signal.
    #[inline(always)]
    pub fn en(&self) -> EN_R {
