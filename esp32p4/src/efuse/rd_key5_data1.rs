///Register `RD_KEY5_DATA1` reader
pub type R = crate::R<RD_KEY5_DATA1_SPEC>;
///Field `KEY5_DATA1` reader - Stores the first 32 bits of KEY5.
pub type KEY5_DATA1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the first 32 bits of KEY5.
    #[inline(always)]
...
///`read()` method returns [`rd_key5_data1::R`](R) reader structure
