...
///Field `ECDSA_ENABLE_SOFT_K` reader - Represents whether hardware random number k is forced used in ESDCA. 1: force used. 0: not force used.
...
///Field `FLASH_TYPE` reader - The type of interfaced flash. 0: four data lines, 1: eight data lines.
...
///Field `FLASH_ECC_EN` reader - Set this bit to enable ecc for flash boot.
pub type FLASH_ECC_EN_R = crate::BitReader;
///Field `DIS_USB_OTG_DOWNLOAD_MODE` reader - Set this bit to disable download via USB-OTG.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA2")
            ...
            .field("ecdsa_enable_soft_k", &self.ecdsa_enable_soft_k())
