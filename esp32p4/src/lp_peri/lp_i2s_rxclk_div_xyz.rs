...
impl W {
    ...
    pub fn lp_i2s_rx_clkm_div_yn1(
        &mut self,
    ) -> LP_I2S_RX_CLKM_DIV_YN1_W<'_, LP_I2S_RXCLK_DIV_XYZ_SPEC> {
        LP_I2S_RX_CLKM_DIV_YN1_W::new(self, 4)
    }
    #[doc = "Bits 5:13 - need_des"]
    #[inline(always)]
    pub fn lp_i2s_rx_clkm_div_z(
        &mut self,
    ) -> LP_I2S_RX_CLKM_DIV_Z_W<'_, LP_I2S_RXCLK_DIV_XYZ_SPEC> {
        LP_I2S_RX_CLKM_DIV_Z_W::new(self, 5)
    }
    #[doc = "Bits 14:22 - need_des"]
    #[inline(always)]
    pub fn lp_i2s_rx_clkm_div_y(
        &mut self,
    ) -> LP_I2S_RX_CLKM_DIV_Y_W<'_, LP_I2S_RXCLK_DIV_XYZ_SPEC> {
        LP_I2S_RX_CLKM_DIV_Y_W::new(self, 14)
    }
    #[doc = "Bits 23:31 - need_des"]
    #[inline(always)]
    pub fn lp_i2s_rx_clkm_div_x(
        &mut self,
    ) -> LP_I2S_RX_CLKM_DIV_X_W<'_, LP_I2S_RXCLK_DIV_XYZ_SPEC> {
        LP_I2S_RX_CLKM_DIV_X_W::new(self, 23)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`lp_i2s_rxclk_div_xyz::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lp_i2s_rxclk_div_xyz::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LP_I2S_RXCLK_DIV_XYZ_SPEC;
impl crate::RegisterSpec for LP_I2S_RXCLK_DIV_XYZ_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lp_i2s_rxclk_div_xyz::R`](R) reader structure"]
