...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ADC_CTRL")
            ...
            .field("lpadc_func_div_num", &self.lpadc_func_div_num().bits())
            .field("lpadc_sar2_div_num", &self.lpadc_sar2_div_num().bits())
            .field("lpadc_sar1_div_num", &self.lpadc_sar1_div_num().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
