...
///`read()` method returns [`adc_ctrl::R`](R) reader structure
impl crate::Readable for ADC_CTRL_SPEC {}
///`write(|w| ..)` method takes [`adc_ctrl::W`](W) writer structure
