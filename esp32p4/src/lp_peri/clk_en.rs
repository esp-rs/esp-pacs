...
///Field `CK_EN_LP_CORE` writer - write 1 to force on lp_core clk
...
impl R {
    ...
    ///Bit 31 - write 1 to force on lp_core clk
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLK_EN")
            .field("ck_en_rng", &self.ck_en_rng())
            .field("ck_en_lp_tsens", &self.ck_en_lp_tsens())
            .field("ck_en_lp_pms", &self.ck_en_lp_pms())
            .field("ck_en_lp_efuse", &self.ck_en_lp_efuse())
            .field("ck_en_lp_iomux", &self.ck_en_lp_iomux())
            .field("ck_en_lp_touch", &self.ck_en_lp_touch())
            .field("ck_en_lp_spi", &self.ck_en_lp_spi())
            .field("ck_en_lp_adc", &self.ck_en_lp_adc())
            .field("ck_en_lp_i2s_tx", &self.ck_en_lp_i2s_tx())
            .field("ck_en_lp_i2s_rx", &self.ck_en_lp_i2s_rx())
            .field("ck_en_lp_i2s", &self.ck_en_lp_i2s())
            .field("ck_en_lp_i2cmst", &self.ck_en_lp_i2cmst())
            .field("ck_en_lp_i2c", &self.ck_en_lp_i2c())
            .field("ck_en_lp_uart", &self.ck_en_lp_uart())
            .field("ck_en_lp_intr", &self.ck_en_lp_intr())
            .field("ck_en_lp_core", &self.ck_en_lp_core())
            .finish()
    }
}
impl W {
