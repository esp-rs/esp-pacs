///Register `LP_I2S_TXCLK_DIV_NUM` reader
pub type R = crate::R<LP_I2S_TXCLK_DIV_NUM_SPEC>;
///Register `LP_I2S_TXCLK_DIV_NUM` writer
pub type W = crate::W<LP_I2S_TXCLK_DIV_NUM_SPEC>;
///Field `LP_I2S_TX_CLKM_DIV_NUM` reader - need_des
pub type LP_I2S_TX_CLKM_DIV_NUM_R = crate::FieldReader;
///Field `LP_I2S_TX_CLKM_DIV_NUM` writer - need_des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_I2S_TXCLK_DIV_NUM")
            .field("lp_i2s_tx_clkm_div_num", &self.lp_i2s_tx_clkm_div_num())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`lp_i2s_txclk_div_num::R`](R) reader structure
impl crate::Readable for LP_I2S_TXCLK_DIV_NUM_SPEC {}
///`write(|w| ..)` method takes [`lp_i2s_txclk_div_num::W`](W) writer structure
