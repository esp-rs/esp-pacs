...
///`read()` method returns [`lp_i2s_txclk_div_xyz::R`](R) reader structure
impl crate::Readable for LP_I2S_TXCLK_DIV_XYZ_SPEC {}
///`write(|w| ..)` method takes [`lp_i2s_txclk_div_xyz::W`](W) writer structure
