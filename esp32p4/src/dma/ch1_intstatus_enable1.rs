#[doc = "Register `CH1_INTSTATUS_ENABLE1` reader"]
pub type R = crate::R<CH1_INTSTATUS_ENABLE1_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH1_INTSTATUS_ENABLE1")
            .field(
                "ch1_enable_ecc_prot_chmem_correrr_intstat",
                &format_args!("{}", self.ch1_enable_ecc_prot_chmem_correrr_intstat().bit()),
            )
            .field(
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CH1_INTSTATUS_ENABLE1_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch1_intstatus_enable1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH1_INTSTATUS_ENABLE1_SPEC;
impl crate::RegisterSpec for CH1_INTSTATUS_ENABLE1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1_intstatus_enable1::R`](R) reader structure"]
impl crate::Readable for CH1_INTSTATUS_ENABLE1_SPEC {}
#[doc = "`reset()` method sets CH1_INTSTATUS_ENABLE1 to value 0x0f"]
impl crate::Resettable for CH1_INTSTATUS_ENABLE1_SPEC {
