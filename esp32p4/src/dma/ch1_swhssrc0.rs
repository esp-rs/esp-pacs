#[doc = "Register `CH1_SWHSSRC0` reader"]
pub type R = crate::R<CH1_SWHSSRC0_SPEC>;
#[doc = "Register `CH1_SWHSSRC0` writer"]
pub type W = crate::W<CH1_SWHSSRC0_SPEC>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CH1_SWHSSRC0_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_req_src(&mut self) -> CH1_SWHS_REQ_SRC_W<CH1_SWHSSRC0_SPEC> {
        CH1_SWHS_REQ_SRC_W::new(self, 0)
    }
    #[doc = "Bit 1 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_req_src_we(&mut self) -> CH1_SWHS_REQ_SRC_WE_W<CH1_SWHSSRC0_SPEC> {
        CH1_SWHS_REQ_SRC_WE_W::new(self, 1)
    }
    #[doc = "Bit 2 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_sglreq_src(&mut self) -> CH1_SWHS_SGLREQ_SRC_W<CH1_SWHSSRC0_SPEC> {
        CH1_SWHS_SGLREQ_SRC_W::new(self, 2)
    }
    #[doc = "Bit 3 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_sglreq_src_we(&mut self) -> CH1_SWHS_SGLREQ_SRC_WE_W<CH1_SWHSSRC0_SPEC> {
        CH1_SWHS_SGLREQ_SRC_WE_W::new(self, 3)
    }
    #[doc = "Bit 4 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_lst_src(&mut self) -> CH1_SWHS_LST_SRC_W<CH1_SWHSSRC0_SPEC> {
        CH1_SWHS_LST_SRC_W::new(self, 4)
    }
    #[doc = "Bit 5 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_lst_src_we(&mut self) -> CH1_SWHS_LST_SRC_WE_W<CH1_SWHSSRC0_SPEC> {
...
pub struct CH1_SWHSSRC0_SPEC;
impl crate::RegisterSpec for CH1_SWHSSRC0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1_swhssrc0::R`](R) reader structure"]
impl crate::Readable for CH1_SWHSSRC0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch1_swhssrc0::W`](W) writer structure"]
impl crate::Writable for CH1_SWHSSRC0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH1_SWHSSRC0 to value 0"]
impl crate::Resettable for CH1_SWHSSRC0_SPEC {
