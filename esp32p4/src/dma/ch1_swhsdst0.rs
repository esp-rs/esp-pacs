#[doc = "Register `CH1_SWHSDST0` reader"]
pub type R = crate::R<CH1_SWHSDST0_SPEC>;
#[doc = "Register `CH1_SWHSDST0` writer"]
pub type W = crate::W<CH1_SWHSDST0_SPEC>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CH1_SWHSDST0_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_req_dst(&mut self) -> CH1_SWHS_REQ_DST_W<CH1_SWHSDST0_SPEC> {
        CH1_SWHS_REQ_DST_W::new(self, 0)
    }
    #[doc = "Bit 1 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_req_dst_we(&mut self) -> CH1_SWHS_REQ_DST_WE_W<CH1_SWHSDST0_SPEC> {
        CH1_SWHS_REQ_DST_WE_W::new(self, 1)
    }
    #[doc = "Bit 2 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_sglreq_dst(&mut self) -> CH1_SWHS_SGLREQ_DST_W<CH1_SWHSDST0_SPEC> {
        CH1_SWHS_SGLREQ_DST_W::new(self, 2)
    }
    #[doc = "Bit 3 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_sglreq_dst_we(&mut self) -> CH1_SWHS_SGLREQ_DST_WE_W<CH1_SWHSDST0_SPEC> {
        CH1_SWHS_SGLREQ_DST_WE_W::new(self, 3)
    }
    #[doc = "Bit 4 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_lst_dst(&mut self) -> CH1_SWHS_LST_DST_W<CH1_SWHSDST0_SPEC> {
        CH1_SWHS_LST_DST_W::new(self, 4)
    }
    #[doc = "Bit 5 - NA"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_swhs_lst_dst_we(&mut self) -> CH1_SWHS_LST_DST_WE_W<CH1_SWHSDST0_SPEC> {
...
pub struct CH1_SWHSDST0_SPEC;
impl crate::RegisterSpec for CH1_SWHSDST0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1_swhsdst0::R`](R) reader structure"]
impl crate::Readable for CH1_SWHSDST0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch1_swhsdst0::W`](W) writer structure"]
impl crate::Writable for CH1_SWHSDST0_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH1_SWHSDST0 to value 0"]
impl crate::Resettable for CH1_SWHSDST0_SPEC {
