...
///`read()` method returns [`lowpower_cfg1::R`](R) reader structure
impl crate::Readable for LOWPOWER_CFG1_SPEC {}
///`write(|w| ..)` method takes [`lowpower_cfg1::W`](W) writer structure
