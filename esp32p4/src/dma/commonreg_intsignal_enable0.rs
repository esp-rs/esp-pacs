...
impl W {
    ...
    pub fn enable_slvif_commonreg_dec_err_intsignal(
        &mut self,
    ) -> ENABLE_SLVIF_COMMONREG_DEC_ERR_INTSIGNAL_W<'_, COMMONREG_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn enable_slvif_commonreg_wr2ro_err_intsignal(
        &mut self,
    ) -> ENABLE_SLVIF_COMMONREG_WR2RO_ERR_INTSIGNAL_W<'_, COMMONREG_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn enable_slvif_commonreg_rd2wo_err_intsignal(
        &mut self,
    ) -> ENABLE_SLVIF_COMMONREG_RD2WO_ERR_INTSIGNAL_W<'_, COMMONREG_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn enable_slvif_commonreg_wronhold_err_intsignal(
        &mut self,
    ) -> ENABLE_SLVIF_COMMONREG_WRONHOLD_ERR_INTSIGNAL_W<'_, COMMONREG_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn enable_slvif_undefinedreg_dec_err_intsignal(
        &mut self,
    ) -> ENABLE_SLVIF_UNDEFINEDREG_DEC_ERR_INTSIGNAL_W<'_, COMMONREG_INTSIGNAL_ENABLE0_SPEC> {
