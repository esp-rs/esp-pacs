///Register `COMMONREG_INTSIGNAL_ENABLE0` reader
pub type R = crate::R<COMMONREG_INTSIGNAL_ENABLE0_SPEC>;
///Register `COMMONREG_INTSIGNAL_ENABLE0` writer
pub type W = crate::W<COMMONREG_INTSIGNAL_ENABLE0_SPEC>;
///Field `ENABLE_SLVIF_COMMONREG_DEC_ERR_INTSIGNAL` reader - NA
pub type ENABLE_SLVIF_COMMONREG_DEC_ERR_INTSIGNAL_R = crate::BitReader;
///Field `ENABLE_SLVIF_COMMONREG_DEC_ERR_INTSIGNAL` writer - NA
...
///`read()` method returns [`commonreg_intsignal_enable0::R`](R) reader structure
impl crate::Readable for COMMONREG_INTSIGNAL_ENABLE0_SPEC {}
///`write(|w| ..)` method takes [`commonreg_intsignal_enable0::W`](W) writer structure
