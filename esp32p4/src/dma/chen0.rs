...
///`read()` method returns [`chen0::R`](R) reader structure
impl crate::Readable for CHEN0_SPEC {}
///`write(|w| ..)` method takes [`chen0::W`](W) writer structure
