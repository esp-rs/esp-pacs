#[doc = "Register `CH1_INTSIGNAL_ENABLE0` reader"]
pub type R = crate::R<CH1_INTSIGNAL_ENABLE0_SPEC>;
#[doc = "Register `CH1_INTSIGNAL_ENABLE0` writer"]
pub type W = crate::W<CH1_INTSIGNAL_ENABLE0_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH1_INTSIGNAL_ENABLE0")
            .field(
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CH1_INTSIGNAL_ENABLE0_SPEC> {
...
impl W {
    ...
    pub fn ch1_enable_block_tfr_done_intsignal(
        &mut self,
    ) -> CH1_ENABLE_BLOCK_TFR_DONE_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_dma_tfr_done_intsignal(
        &mut self,
    ) -> CH1_ENABLE_DMA_TFR_DONE_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_src_transcomp_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SRC_TRANSCOMP_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_dst_transcomp_intsignal(
        &mut self,
    ) -> CH1_ENABLE_DST_TRANSCOMP_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_src_dec_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SRC_DEC_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_dst_dec_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_DST_DEC_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_src_slv_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SRC_SLV_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_dst_slv_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_DST_SLV_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_lli_rd_dec_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_LLI_RD_DEC_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_lli_wr_dec_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_LLI_WR_DEC_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_lli_rd_slv_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_LLI_RD_SLV_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_lli_wr_slv_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_LLI_WR_SLV_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_shadowreg_or_lli_invalid_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SHADOWREG_OR_LLI_INVALID_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_slvif_multiblktype_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SLVIF_MULTIBLKTYPE_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_slvif_dec_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SLVIF_DEC_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_slvif_wr2ro_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SLVIF_WR2RO_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_slvif_rd2rwo_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SLVIF_RD2RWO_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_slvif_wronchen_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SLVIF_WRONCHEN_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_slvif_shadowreg_wron_valid_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SLVIF_SHADOWREG_WRON_VALID_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_slvif_wronhold_err_intsignal(
        &mut self,
    ) -> CH1_ENABLE_SLVIF_WRONHOLD_ERR_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_ch_lock_cleared_intsignal(
        &mut self,
    ) -> CH1_ENABLE_CH_LOCK_CLEARED_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_ch_src_suspended_intsignal(
        &mut self,
    ) -> CH1_ENABLE_CH_SRC_SUSPENDED_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_ch_suspended_intsignal(
        &mut self,
    ) -> CH1_ENABLE_CH_SUSPENDED_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_ch_disabled_intsignal(
        &mut self,
    ) -> CH1_ENABLE_CH_DISABLED_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
    ...
    pub fn ch1_enable_ch_aborted_intsignal(
        &mut self,
    ) -> CH1_ENABLE_CH_ABORTED_INTSIGNAL_W<CH1_INTSIGNAL_ENABLE0_SPEC> {
...
pub struct CH1_INTSIGNAL_ENABLE0_SPEC;
impl crate::RegisterSpec for CH1_INTSIGNAL_ENABLE0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1_intsignal_enable0::R`](R) reader structure"]
impl crate::Readable for CH1_INTSIGNAL_ENABLE0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ch1_intsignal_enable0::W`](W) writer structure"]
impl crate::Writable for CH1_INTSIGNAL_ENABLE0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH1_INTSIGNAL_ENABLE0 to value 0xfa3f_7ffb"]
impl crate::Resettable for CH1_INTSIGNAL_ENABLE0_SPEC {
