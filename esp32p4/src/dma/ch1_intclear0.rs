#[doc = "Register `CH1_INTCLEAR0` writer"]
pub type W = crate::W<CH1_INTCLEAR0_SPEC>;
...
impl core::fmt::Debug for crate::generic::Reg<CH1_INTCLEAR0_SPEC> {
...
impl W {
    ...
    pub fn ch1_clear_block_tfr_done_intstat(
        &mut self,
    ) -> CH1_CLEAR_BLOCK_TFR_DONE_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_dma_tfr_done_intstat(
        &mut self,
    ) -> CH1_CLEAR_DMA_TFR_DONE_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_src_transcomp_intstat(
        &mut self,
    ) -> CH1_CLEAR_SRC_TRANSCOMP_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_dst_transcomp_intstat(
        &mut self,
    ) -> CH1_CLEAR_DST_TRANSCOMP_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_src_dec_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SRC_DEC_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_dst_dec_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_DST_DEC_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_src_slv_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SRC_SLV_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_dst_slv_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_DST_SLV_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_lli_rd_dec_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_LLI_RD_DEC_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_lli_wr_dec_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_LLI_WR_DEC_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_lli_rd_slv_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_LLI_RD_SLV_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_lli_wr_slv_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_LLI_WR_SLV_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_shadowreg_or_lli_invalid_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SHADOWREG_OR_LLI_INVALID_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_slvif_multiblktype_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SLVIF_MULTIBLKTYPE_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_slvif_dec_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SLVIF_DEC_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_slvif_wr2ro_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SLVIF_WR2RO_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_slvif_rd2rwo_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SLVIF_RD2RWO_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_slvif_wronchen_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SLVIF_WRONCHEN_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_slvif_shadowreg_wron_valid_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SLVIF_SHADOWREG_WRON_VALID_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_slvif_wronhold_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SLVIF_WRONHOLD_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_slvif_wrparity_err_intstat(
        &mut self,
    ) -> CH1_CLEAR_SLVIF_WRPARITY_ERR_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_ch_lock_cleared_intstat(
        &mut self,
    ) -> CH1_CLEAR_CH_LOCK_CLEARED_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_ch_src_suspended_intstat(
        &mut self,
    ) -> CH1_CLEAR_CH_SRC_SUSPENDED_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_ch_suspended_intstat(
        &mut self,
    ) -> CH1_CLEAR_CH_SUSPENDED_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_ch_disabled_intstat(
        &mut self,
    ) -> CH1_CLEAR_CH_DISABLED_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
    ...
    pub fn ch1_clear_ch_aborted_intstat(
        &mut self,
    ) -> CH1_CLEAR_CH_ABORTED_INTSTAT_W<CH1_INTCLEAR0_SPEC> {
        CH1_CLEAR_CH_ABORTED_INTSTAT_W::new(self, 31)
    }
}
#[doc = "NA\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch1_intclear0::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH1_INTCLEAR0_SPEC;
impl crate::RegisterSpec for CH1_INTCLEAR0_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ch1_intclear0::W`](W) writer structure"]
impl crate::Writable for CH1_INTCLEAR0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH1_INTCLEAR0 to value 0"]
impl crate::Resettable for CH1_INTCLEAR0_SPEC {
