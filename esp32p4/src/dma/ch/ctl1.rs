...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CTL1")
            .field("ch1_ar_prot", &self.ch1_ar_prot().bits())
            .field("ch1_aw_prot", &self.ch1_aw_prot().bits())
            .field("ch1_arlen_en", &self.ch1_arlen_en().bit())
            .field("ch1_arlen", &self.ch1_arlen().bits())
            .field("ch1_awlen_en", &self.ch1_awlen_en().bit())
            .field("ch1_awlen", &self.ch1_awlen().bits())
            .field("ch1_src_stat_en", &self.ch1_src_stat_en().bit())
            .field("ch1_dst_stat_en", &self.ch1_dst_stat_en().bit())
            .field("ch1_ioc_blktfr", &self.ch1_ioc_blktfr().bit())
            .field(
                "ch1_shadowreg_or_lli_last",
                &self.ch1_shadowreg_or_lli_last().bit(),
            )
            .field(
                "ch1_shadowreg_or_lli_valid",
                &self.ch1_shadowreg_or_lli_valid().bit(),
            )
            .finish()
    }
}
