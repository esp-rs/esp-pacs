...
///`read()` method returns [`ctl1::R`](R) reader structure
impl crate::Readable for CTL1_SPEC {}
///`write(|w| ..)` method takes [`ctl1::W`](W) writer structure
