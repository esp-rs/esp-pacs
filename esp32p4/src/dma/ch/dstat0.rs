///Register `DSTAT0` reader
pub type R = crate::R<DSTAT0_SPEC>;
///Field `CH1_DSTAT` reader - NA
...
You can [`read`](crate::generic::Reg::read) this register and get [`dstat0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DSTAT0_SPEC;
impl crate::RegisterSpec for DSTAT0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dstat0::R`](R) reader structure
impl crate::Readable for DSTAT0_SPEC {}
///`reset()` method sets DSTAT0 to value 0
