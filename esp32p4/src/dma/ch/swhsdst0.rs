...
///Field `CH1_SWHS_LST_DST` reader - NA
pub type CH1_SWHS_LST_DST_R = crate::BitReader;
///Field `CH1_SWHS_LST_DST` writer - NA
...
///`read()` method returns [`swhsdst0::R`](R) reader structure
impl crate::Readable for SWHSDST0_SPEC {}
///`write(|w| ..)` method takes [`swhsdst0::W`](W) writer structure
impl crate::Writable for SWHSDST0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SWHSDST0 to value 0
