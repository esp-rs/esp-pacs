...
///`read()` method returns [`swhssrc0::R`](R) reader structure
impl crate::Readable for SWHSSRC0_SPEC {}
///`write(|w| ..)` method takes [`swhssrc0::W`](W) writer structure
impl crate::Writable for SWHSSRC0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SWHSSRC0 to value 0
