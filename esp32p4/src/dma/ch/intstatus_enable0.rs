    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INTSTATUS_ENABLE0")
            .field(
                ...
                &self.ch1_enable_block_tfr_done_intstat().bit(),
            )
            .field(
                "ch1_enable_dma_tfr_done_intstat",
                &self.ch1_enable_dma_tfr_done_intstat().bit(),
            )
            .field(
                "ch1_enable_src_transcomp_intstat",
                &self.ch1_enable_src_transcomp_intstat().bit(),
            )
            .field(
                "ch1_enable_dst_transcomp_intstat",
                &self.ch1_enable_dst_transcomp_intstat().bit(),
            )
            .field(
                "ch1_enable_src_dec_err_intstat",
                &self.ch1_enable_src_dec_err_intstat().bit(),
            )
            .field(
                "ch1_enable_dst_dec_err_intstat",
                &self.ch1_enable_dst_dec_err_intstat().bit(),
            )
            .field(
                "ch1_enable_src_slv_err_intstat",
                &self.ch1_enable_src_slv_err_intstat().bit(),
            )
            .field(
                "ch1_enable_dst_slv_err_intstat",
                &self.ch1_enable_dst_slv_err_intstat().bit(),
            )
            .field(
                "ch1_enable_lli_rd_dec_err_intstat",
                &self.ch1_enable_lli_rd_dec_err_intstat().bit(),
            )
            .field(
                "ch1_enable_lli_wr_dec_err_intstat",
                &self.ch1_enable_lli_wr_dec_err_intstat().bit(),
            )
            .field(
                "ch1_enable_lli_rd_slv_err_intstat",
                &self.ch1_enable_lli_rd_slv_err_intstat().bit(),
            )
            .field(
                "ch1_enable_lli_wr_slv_err_intstat",
                &self.ch1_enable_lli_wr_slv_err_intstat().bit(),
            )
            .field(
            ...
            .field(
                ...
                &self.ch1_enable_slvif_multiblktype_err_intstat().bit(),
            )
            .field(
                "ch1_enable_slvif_dec_err_intstat",
                &self.ch1_enable_slvif_dec_err_intstat().bit(),
            )
            .field(
                "ch1_enable_slvif_wr2ro_err_intstat",
                &self.ch1_enable_slvif_wr2ro_err_intstat().bit(),
            )
            .field(
                "ch1_enable_slvif_rd2rwo_err_intstat",
                &self.ch1_enable_slvif_rd2rwo_err_intstat().bit(),
            )
            .field(
                "ch1_enable_slvif_wronchen_err_intstat",
                &self.ch1_enable_slvif_wronchen_err_intstat().bit(),
            )
            .field(
            ...
            .field(
                ...
                &self.ch1_enable_slvif_wronhold_err_intstat().bit(),
            )
            .field(
                "ch1_enable_slvif_wrparity_err_intstat",
                &self.ch1_enable_slvif_wrparity_err_intstat().bit(),
            )
            .field(
                "ch1_enable_ch_lock_cleared_intstat",
                &self.ch1_enable_ch_lock_cleared_intstat().bit(),
            )
            .field(
                "ch1_enable_ch_src_suspended_intstat",
                &self.ch1_enable_ch_src_suspended_intstat().bit(),
            )
            .field(
                "ch1_enable_ch_suspended_intstat",
                &self.ch1_enable_ch_suspended_intstat().bit(),
            )
            .field(
                "ch1_enable_ch_disabled_intstat",
                &self.ch1_enable_ch_disabled_intstat().bit(),
            )
            .field(
                "ch1_enable_ch_aborted_intstat",
                &self.ch1_enable_ch_aborted_intstat().bit(),
            )
            .finish()
    }
}
