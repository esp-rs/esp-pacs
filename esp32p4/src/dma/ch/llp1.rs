...
You can [`read`](crate::generic::Reg::read) this register and get [`llp1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`llp1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct LLP1_SPEC;
impl crate::RegisterSpec for LLP1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`llp1::R`](R) reader structure
impl crate::Readable for LLP1_SPEC {}
///`write(|w| ..)` method takes [`llp1::W`](W) writer structure
impl crate::Writable for LLP1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LLP1 to value 0
