...
///`read()` method returns [`chen1::R`](R) reader structure
impl crate::Readable for CHEN1_SPEC {}
///`write(|w| ..)` method takes [`chen1::W`](W) writer structure
