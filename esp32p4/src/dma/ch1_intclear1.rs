#[doc = "Register `CH1_INTCLEAR1` writer"]
pub type W = crate::W<CH1_INTCLEAR1_SPEC>;
...
impl core::fmt::Debug for crate::generic::Reg<CH1_INTCLEAR1_SPEC> {
...
impl W {
    ...
    pub fn ch1_clear_ecc_prot_chmem_correrr_intstat(
        &mut self,
    ) -> CH1_CLEAR_ECC_PROT_CHMEM_CORRERR_INTSTAT_W<CH1_INTCLEAR1_SPEC> {
    ...
    pub fn ch1_clear_ecc_prot_chmem_uncorrerr_intstat(
        &mut self,
    ) -> CH1_CLEAR_ECC_PROT_CHMEM_UNCORRERR_INTSTAT_W<CH1_INTCLEAR1_SPEC> {
    ...
    pub fn ch1_clear_ecc_prot_uidmem_correrr_intstat(
        &mut self,
    ) -> CH1_CLEAR_ECC_PROT_UIDMEM_CORRERR_INTSTAT_W<CH1_INTCLEAR1_SPEC> {
    ...
    pub fn ch1_clear_ecc_prot_uidmem_uncorrerr_intstat(
        &mut self,
    ) -> CH1_CLEAR_ECC_PROT_UIDMEM_UNCORRERR_INTSTAT_W<CH1_INTCLEAR1_SPEC> {
...
#[doc = "NA\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch1_intclear1::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH1_INTCLEAR1_SPEC;
impl crate::RegisterSpec for CH1_INTCLEAR1_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ch1_intclear1::W`](W) writer structure"]
impl crate::Writable for CH1_INTCLEAR1_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH1_INTCLEAR1 to value 0"]
impl crate::Resettable for CH1_INTCLEAR1_SPEC {
