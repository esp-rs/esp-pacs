...
impl W {
    ...
    pub fn clear_slvif_commonreg_dec_err_intstat(
        &mut self,
    ) -> CLEAR_SLVIF_COMMONREG_DEC_ERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_slvif_commonreg_wr2ro_err_intstat(
        &mut self,
    ) -> CLEAR_SLVIF_COMMONREG_WR2RO_ERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_slvif_commonreg_rd2wo_err_intstat(
        &mut self,
    ) -> CLEAR_SLVIF_COMMONREG_RD2WO_ERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_slvif_commonreg_wronhold_err_intstat(
        &mut self,
    ) -> CLEAR_SLVIF_COMMONREG_WRONHOLD_ERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_slvif_commonreg_wrparity_err_intstat(
        &mut self,
    ) -> CLEAR_SLVIF_COMMONREG_WRPARITY_ERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_slvif_undefinedreg_dec_err_intstat(
        &mut self,
    ) -> CLEAR_SLVIF_UNDEFINEDREG_DEC_ERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif1_rch0_eccprot_correrr_intstat(
        &mut self,
    ) -> CLEAR_MXIF1_RCH0_ECCPROT_CORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif1_rch0_eccprot_uncorrerr_intstat(
        &mut self,
    ) -> CLEAR_MXIF1_RCH0_ECCPROT_UNCORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif1_rch1_eccprot_correrr_intstat(
        &mut self,
    ) -> CLEAR_MXIF1_RCH1_ECCPROT_CORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif1_rch1_eccprot_uncorrerr_intstat(
        &mut self,
    ) -> CLEAR_MXIF1_RCH1_ECCPROT_UNCORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif1_bch_eccprot_correrr_intstat(
        &mut self,
    ) -> CLEAR_MXIF1_BCH_ECCPROT_CORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif1_bch_eccprot_uncorrerr_intstat(
        &mut self,
    ) -> CLEAR_MXIF1_BCH_ECCPROT_UNCORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif2_rch0_eccprot_correrr_intstat(
        &mut self,
    ) -> CLEAR_MXIF2_RCH0_ECCPROT_CORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif2_rch0_eccprot_uncorrerr_intstat(
        &mut self,
    ) -> CLEAR_MXIF2_RCH0_ECCPROT_UNCORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif2_rch1_eccprot_correrr_intstat(
        &mut self,
    ) -> CLEAR_MXIF2_RCH1_ECCPROT_CORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif2_rch1_eccprot_uncorrerr_intstat(
        &mut self,
    ) -> CLEAR_MXIF2_RCH1_ECCPROT_UNCORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif2_bch_eccprot_correrr_intstat(
        &mut self,
    ) -> CLEAR_MXIF2_BCH_ECCPROT_CORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
    ...
    pub fn clear_mxif2_bch_eccprot_uncorrerr_intstat(
        &mut self,
    ) -> CLEAR_MXIF2_BCH_ECCPROT_UNCORRERR_INTSTAT_W<'_, COMMONREG_INTCLEAR0_SPEC> {
