#[doc = "Register `CH1_INTSTATUS1` reader"]
pub type R = crate::R<CH1_INTSTATUS1_SPEC>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CH1_INTSTATUS1_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch1_intstatus1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CH1_INTSTATUS1_SPEC;
impl crate::RegisterSpec for CH1_INTSTATUS1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1_intstatus1::R`](R) reader structure"]
impl crate::Readable for CH1_INTSTATUS1_SPEC {}
#[doc = "`reset()` method sets CH1_INTSTATUS1 to value 0"]
impl crate::Resettable for CH1_INTSTATUS1_SPEC {
