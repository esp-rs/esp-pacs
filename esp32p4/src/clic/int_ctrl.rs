...
#[doc = "Field `INT_ATTR_SHV` reader - 1 means hardware-vectored interrupt."]
pub type INT_ATTR_SHV_R = crate::BitReader;
#[doc = "Field `INT_ATTR_SHV` writer - 1 means hardware-vectored interrupt."]
pub type INT_ATTR_SHV_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INT_ATTR_TRIG` reader - Trigger type/polarity."]
pub type INT_ATTR_TRIG_R = crate::FieldReader;
#[doc = "Field `INT_ATTR_TRIG` writer - Trigger type/polarity."]
pub type INT_ATTR_TRIG_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `INT_ATTR_MODE` reader - Privilege mode of the interrupt (fixed by hardware)."]
pub type INT_ATTR_MODE_R = crate::FieldReader;
#[doc = "Field `INT_CTL` reader - Interrupt priority/level control."]
pub type INT_CTL_R = crate::FieldReader;
#[doc = "Field `INT_CTL` writer - Interrupt priority/level control."]
