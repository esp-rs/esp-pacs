...
///Cluster IN_CH%s, containing IN_INT_RAW_CH?, IN_INT_ST_CH?, IN_INT_ENA_CH?, IN_INT_CLR_CH?, IN_CONF0_CH?, IN_CONF1_CH?, INFIFO_STATUS_CH?, IN_POP_CH?, IN_LINK1_CH?, IN_LINK2_CH?, IN_STATE_CH?, IN_SUC_EOF_DES_ADDR_CH?, IN_ERR_EOF_DES_ADDR_CH?, IN_DSCR_CH?, IN_DSCR_BF0_CH?, IN_DSCR_BF1_CH?, IN_PRI_CH?, IN_PERI_SEL_CH?, IN_CRC_INIT_DATA_CH?, RX_CRC_WIDTH_CH?, IN_CRC_CLEAR_CH?, IN_CRC_FINAL_RESULT_CH?, RX_CRC_EN_WR_DATA_CH?, RX_CRC_EN_ADDR_CH?, RX_CRC_DATA_EN_WR_DATA_CH?, RX_CRC_DATA_EN_ADDR_CH?
...
///Cluster OUT_CH%s, containing OUT_INT_RAW_CH?, OUT_INT_ST_CH?, OUT_INT_ENA_CH?, OUT_INT_CLR_CH?, OUT_CONF0_CH?, OUT_CONF1_CH?, OUTFIFO_STATUS_CH?, OUT_PUSH_CH?, OUT_LINK1_CH?, OUT_LINK2_CH?, OUT_STATE_CH?, OUT_EOF_DES_ADDR_CH?, OUT_EOF_BFR_DES_ADDR_CH?, OUT_DSCR_CH?, OUT_DSCR_BF0_CH?, OUT_DSCR_BF1_CH?, OUT_PRI_CH?, OUT_PERI_SEL_CH?, OUT_CRC_INIT_DATA_CH?, TX_CRC_WIDTH_CH?, OUT_CRC_CLEAR_CH?, OUT_CRC_FINAL_RESULT_CH?, TX_CRC_EN_WR_DATA_CH?, TX_CRC_EN_ADDR_CH?, TX_CRC_DATA_EN_WR_DATA_CH?, TX_CRC_DATA_EN_ADDR_CH?
pub mod out_ch;
/**ARB_TIMEOUT (rw) register accessor: This retister is used to config arbiter time slice
...
pub mod arb_timeout;
/**WEIGHT_EN (rw) register accessor: This register is used to config arbiter weight function to on or off
...
pub mod weight_en;
/**IN_MEM_CONF (rw) register accessor: Mem power configure register of Rx channel
...
/**EXTR_MEM_START_ADDR (rw) register accessor: The start address of accessible address space.
...
/**EXTR_MEM_END_ADDR (rw) register accessor: The end address of accessible address space. The access address beyond this range would lead to descriptor error.
...
/**IN_RESET_AVAIL_CH (r) register accessor: The rx channel 0 reset valid_flag register.
...
/**OUT_RESET_AVAIL_CH (r) register accessor: The tx channel 0 reset valid_flag register.
...
///MISC register
pub mod misc_conf;
/**RDN_RESULT (rw) register accessor: reserved
...
///reserved
pub mod rdn_result;
/**RDN_ECO_HIGH (rw) register accessor: reserved
...
/**RDN_ECO_LOW (rw) register accessor: reserved
...
///reserved
pub mod rdn_eco_low;
/**WRESP_CNT (r) register accessor: AXI wr responce cnt register.
...
pub mod wresp_cnt;
/**RRESP_CNT (r) register accessor: AXI wr responce cnt register.
...
///AXI wr responce cnt register.
pub mod rresp_cnt;
/**INFIFO_STATUS1_CH (r) register accessor: Receive FIFO status of Rx channel 0
...
/**OUTFIFO_STATUS1_CH (r) register accessor: Receive FIFO status of Tx channel 0
