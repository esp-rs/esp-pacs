...
///Field `SRP_SESSEND_OVERRIDE` reader - This bit is used to enable the software over-ride of srp session end signal. 1'b0: the signal is controlled by the chip input, 1'b1: the signal is controlled by the software.
pub type SRP_SESSEND_OVERRIDE_R = crate::BitReader;
///Field `SRP_SESSEND_OVERRIDE` writer - This bit is used to enable the software over-ride of srp session end signal. 1'b0: the signal is controlled by the chip input, 1'b1: the signal is controlled by the software.
pub type SRP_SESSEND_OVERRIDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SRP_SESSEND_VALUE` reader - Software over-ride value of srp session end signal.
pub type SRP_SESSEND_VALUE_R = crate::BitReader;
///Field `SRP_SESSEND_VALUE` writer - Software over-ride value of srp session end signal.
pub type SRP_SESSEND_VALUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_SEL` reader - Select internal external PHY. 1'b0: Select internal PHY, 1'b1: Select external PHY.
pub type PHY_SEL_R = crate::BitReader;
///Field `PHY_SEL` writer - Select internal external PHY. 1'b0: Select internal PHY, 1'b1: Select external PHY.
pub type PHY_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DFIFO_FORCE_PD` reader - Force the dfifo to go into low power mode. The data in dfifo will not lost.
pub type DFIFO_FORCE_PD_R = crate::BitReader;
///Field `DFIFO_FORCE_PD` writer - Force the dfifo to go into low power mode. The data in dfifo will not lost.
pub type DFIFO_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DBNCE_FLTR_BYPASS` reader - Bypass Debounce filters for avalid,bvalid,vbusvalid,session end, id signals
pub type DBNCE_FLTR_BYPASS_R = crate::BitReader;
///Field `DBNCE_FLTR_BYPASS` writer - Bypass Debounce filters for avalid,bvalid,vbusvalid,session end, id signals
pub type DBNCE_FLTR_BYPASS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXCHG_PINS_OVERRIDE` reader - Enable software controlle USB D+ D- exchange
pub type EXCHG_PINS_OVERRIDE_R = crate::BitReader;
///Field `EXCHG_PINS_OVERRIDE` writer - Enable software controlle USB D+ D- exchange
pub type EXCHG_PINS_OVERRIDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXCHG_PINS` reader - USB D+ D- exchange. 1'b0: don't change, 1'b1: exchange D+ D-.
pub type EXCHG_PINS_R = crate::BitReader;
///Field `EXCHG_PINS` writer - USB D+ D- exchange. 1'b0: don't change, 1'b1: exchange D+ D-.
...
///Field `VREF_OVERRIDE` reader - Enable software controlle input threshold.
pub type VREF_OVERRIDE_R = crate::BitReader;
///Field `VREF_OVERRIDE` writer - Enable software controlle input threshold.
pub type VREF_OVERRIDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PAD_PULL_OVERRIDE` reader - Enable software controlle USB D+ D- pullup pulldown.
pub type PAD_PULL_OVERRIDE_R = crate::BitReader;
///Field `PAD_PULL_OVERRIDE` writer - Enable software controlle USB D+ D- pullup pulldown.
pub type PAD_PULL_OVERRIDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DP_PULLUP` reader - Controlle USB D+ pullup.
pub type DP_PULLUP_R = crate::BitReader;
///Field `DP_PULLUP` writer - Controlle USB D+ pullup.
pub type DP_PULLUP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DP_PULLDOWN` reader - Controlle USB D+ pulldown.
pub type DP_PULLDOWN_R = crate::BitReader;
///Field `DP_PULLDOWN` writer - Controlle USB D+ pulldown.
pub type DP_PULLDOWN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DM_PULLUP` reader - Controlle USB D+ pullup.
pub type DM_PULLUP_R = crate::BitReader;
///Field `DM_PULLUP` writer - Controlle USB D+ pullup.
pub type DM_PULLUP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DM_PULLDOWN` reader - Controlle USB D+ pulldown.
pub type DM_PULLDOWN_R = crate::BitReader;
///Field `DM_PULLDOWN` writer - Controlle USB D+ pulldown.
pub type DM_PULLDOWN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PULLUP_VALUE` reader - Controlle pullup value. 1'b0: typical value is 2.4K, 1'b1: typical value is 1.2K.
pub type PULLUP_VALUE_R = crate::BitReader;
///Field `PULLUP_VALUE` writer - Controlle pullup value. 1'b0: typical value is 2.4K, 1'b1: typical value is 1.2K.
...
///Field `AHB_CLK_FORCE_ON` reader - Force ahb clock always on.
pub type AHB_CLK_FORCE_ON_R = crate::BitReader;
///Field `AHB_CLK_FORCE_ON` writer - Force ahb clock always on.
pub type AHB_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_CLK_FORCE_ON` reader - Force phy clock always on.
pub type PHY_CLK_FORCE_ON_R = crate::BitReader;
///Field `PHY_CLK_FORCE_ON` writer - Force phy clock always on.
pub type PHY_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_TX_EDGE_SEL` reader - Select phy tx signal output clock edge. 1'b0: negedge, 1'b1: posedge.
pub type PHY_TX_EDGE_SEL_R = crate::BitReader;
///Field `PHY_TX_EDGE_SEL` writer - Select phy tx signal output clock edge. 1'b0: negedge, 1'b1: posedge.
pub type PHY_TX_EDGE_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DFIFO_FORCE_PU` reader - Disable the dfifo to go into low power mode. The data in dfifo will not lost.
pub type DFIFO_FORCE_PU_R = crate::BitReader;
///Field `DFIFO_FORCE_PU` writer - Disable the dfifo to go into low power mode. The data in dfifo will not lost.
pub type DFIFO_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_EN` reader - Disable auto clock gating of CSR registers.
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - Disable auto clock gating of CSR registers.
...
///`read()` method returns [`otg_conf::R`](R) reader structure
impl crate::Readable for OTG_CONF_SPEC {}
///`write(|w| ..)` method takes [`otg_conf::W`](W) writer structure
