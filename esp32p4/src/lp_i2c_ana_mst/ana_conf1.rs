...
///`read()` method returns [`ana_conf1::R`](R) reader structure
impl crate::Readable for ANA_CONF1_SPEC {}
///`write(|w| ..)` method takes [`ana_conf1::W`](W) writer structure
