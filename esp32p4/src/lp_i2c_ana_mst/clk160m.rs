///Register `CLK160M` reader
pub type R = crate::R<CLK160M_SPEC>;
///Register `CLK160M` writer
pub type W = crate::W<CLK160M_SPEC>;
///Field `CLK_I2C_MST_SEL_160M` reader - need des
pub type CLK_I2C_MST_SEL_160M_R = crate::BitReader;
///Field `CLK_I2C_MST_SEL_160M` writer - need des
...
///`read()` method returns [`clk160m::R`](R) reader structure
impl crate::Readable for CLK160M_SPEC {}
///`write(|w| ..)` method takes [`clk160m::W`](W) writer structure
