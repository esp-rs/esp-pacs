///Register `I2C_BURST_STATUS` reader
pub type R = crate::R<I2C_BURST_STATUS_SPEC>;
///Register `I2C_BURST_STATUS` writer
pub type W = crate::W<I2C_BURST_STATUS_SPEC>;
///Field `I2C_MST_BURST_DONE` reader - need des
pub type I2C_MST_BURST_DONE_R = crate::BitReader;
///Field `I2C_MST0_BURST_ERR_FLAG` reader - need des
pub type I2C_MST0_BURST_ERR_FLAG_R = crate::BitReader;
///Field `I2C_MST1_BURST_ERR_FLAG` reader - need des
pub type I2C_MST1_BURST_ERR_FLAG_R = crate::BitReader;
///Field `I2C_MST_BURST_TIMEOUT_CNT` reader - need des
pub type I2C_MST_BURST_TIMEOUT_CNT_R = crate::FieldReader<u16>;
///Field `I2C_MST_BURST_TIMEOUT_CNT` writer - need des
...
///`read()` method returns [`i2c_burst_status::R`](R) reader structure
impl crate::Readable for I2C_BURST_STATUS_SPEC {}
///`write(|w| ..)` method takes [`i2c_burst_status::W`](W) writer structure
