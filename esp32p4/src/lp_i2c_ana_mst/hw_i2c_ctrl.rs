...
///`read()` method returns [`hw_i2c_ctrl::R`](R) reader structure
impl crate::Readable for HW_I2C_CTRL_SPEC {}
///`write(|w| ..)` method takes [`hw_i2c_ctrl::W`](W) writer structure
