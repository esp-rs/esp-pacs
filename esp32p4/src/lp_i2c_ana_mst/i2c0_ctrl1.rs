...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C0_CTRL1")
            .field("i2c0_scl_pulse_dur", &self.i2c0_scl_pulse_dur())
            .field("i2c0_sda_side_guard", &self.i2c0_sda_side_guard())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`i2c0_ctrl1::R`](R) reader structure
impl crate::Readable for I2C0_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`i2c0_ctrl1::W`](W) writer structure
