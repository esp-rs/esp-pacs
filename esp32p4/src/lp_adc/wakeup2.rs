///Register `WAKEUP2` reader
pub type R = crate::R<WAKEUP2_SPEC>;
///Register `WAKEUP2` writer
pub type W = crate::W<WAKEUP2_SPEC>;
///Field `SAR2_WAKEUP_TH_LOW` reader - Lower threshold.
pub type SAR2_WAKEUP_TH_LOW_R = crate::FieldReader<u16>;
///Field `SAR2_WAKEUP_TH_LOW` writer - Lower threshold.
pub type SAR2_WAKEUP_TH_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `SAR2_WAKEUP_TH_HIGH` reader - Upper threshold.
pub type SAR2_WAKEUP_TH_HIGH_R = crate::FieldReader<u16>;
///Field `SAR2_WAKEUP_TH_HIGH` writer - Upper threshold.
pub type SAR2_WAKEUP_TH_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `SAR2_WAKEUP_OVER_UPPER_TH` reader - Indicates that this wakeup event arose from exceeding upper threshold.
pub type SAR2_WAKEUP_OVER_UPPER_TH_R = crate::BitReader;
///Field `SAR2_WAKEUP_EN` reader - Wakeup function enable.
pub type SAR2_WAKEUP_EN_R = crate::BitReader;
///Field `SAR2_WAKEUP_EN` writer - Wakeup function enable.
pub type SAR2_WAKEUP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR2_WAKEUP_MODE` reader - 0:absolute value comparison mode. 1: relative value comparison mode.
pub type SAR2_WAKEUP_MODE_R = crate::BitReader;
///Field `SAR2_WAKEUP_MODE` writer - 0:absolute value comparison mode. 1: relative value comparison mode.
...
///`read()` method returns [`wakeup2::R`](R) reader structure
impl crate::Readable for WAKEUP2_SPEC {}
///`write(|w| ..)` method takes [`wakeup2::W`](W) writer structure
