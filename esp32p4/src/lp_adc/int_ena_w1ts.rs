///Register `INT_ENA_W1TS` writer
pub type W = crate::W<INT_ENA_W1TS_SPEC>;
///Field `COCPU_SARADC1_INT_ENA_W1TS` writer - ADC1 Conversion is done, write 1 to assert int enable.
pub type COCPU_SARADC1_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_INT_ENA_W1TS` writer - ADC2 Conversion is done, write 1 to assert int enable.
pub type COCPU_SARADC2_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC1_ERROR_INT_ENA_W1TS` writer - An errro occurs from ADC1, write 1 to assert int enable.
pub type COCPU_SARADC1_ERROR_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_ERROR_INT_ENA_W1TS` writer - An errro occurs from ADC2, write 1 to assert int enable.
pub type COCPU_SARADC2_ERROR_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC1_WAKE_INT_ENA_W1TS` writer - A wakeup event is triggered from ADC1, write 1 to assert int enable.
pub type COCPU_SARADC1_WAKE_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_WAKE_INT_ENA_W1TS` writer - A wakeup event is triggered from ADC2, write 1 to assert int enable.
...
impl W {
    ///Bit 0 - ADC1 Conversion is done, write 1 to assert int enable.
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 1 - ADC2 Conversion is done, write 1 to assert int enable.
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 2 - An errro occurs from ADC1, write 1 to assert int enable.
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 3 - An errro occurs from ADC2, write 1 to assert int enable.
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 4 - A wakeup event is triggered from ADC1, write 1 to assert int enable.
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 5 - A wakeup event is triggered from ADC2, write 1 to assert int enable.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`int_ena_w1ts::W`](W) writer structure
