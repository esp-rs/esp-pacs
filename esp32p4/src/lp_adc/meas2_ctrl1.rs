///Register `MEAS2_CTRL1` reader
pub type R = crate::R<MEAS2_CTRL1_SPEC>;
///Register `MEAS2_CTRL1` writer
...
///`read()` method returns [`meas2_ctrl1::R`](R) reader structure
impl crate::Readable for MEAS2_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`meas2_ctrl1::W`](W) writer structure
