///Register `MEAS2_CTRL2` reader
pub type R = crate::R<MEAS2_CTRL2_SPEC>;
///Register `MEAS2_CTRL2` writer
...
///`read()` method returns [`meas2_ctrl2::R`](R) reader structure
impl crate::Readable for MEAS2_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`meas2_ctrl2::W`](W) writer structure
