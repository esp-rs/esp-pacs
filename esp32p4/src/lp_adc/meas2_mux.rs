///Register `MEAS2_MUX` reader
pub type R = crate::R<MEAS2_MUX_SPEC>;
///Register `MEAS2_MUX` writer
pub type W = crate::W<MEAS2_MUX_SPEC>;
///Field `SAR2_PWDET_CCT` reader - SAR2_PWDET_CCT.
pub type SAR2_PWDET_CCT_R = crate::FieldReader;
///Field `SAR2_PWDET_CCT` writer - SAR2_PWDET_CCT.
...
///`read()` method returns [`meas2_mux::R`](R) reader structure
impl crate::Readable for MEAS2_MUX_SPEC {}
///`write(|w| ..)` method takes [`meas2_mux::W`](W) writer structure
