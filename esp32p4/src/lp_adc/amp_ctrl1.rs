...
///`read()` method returns [`amp_ctrl1::R`](R) reader structure
impl crate::Readable for AMP_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`amp_ctrl1::W`](W) writer structure
