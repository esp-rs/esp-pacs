...
impl W {
    #[doc = "Bit 0 - ADC1 Conversion is done, int raw."]
    #[inline(always)]
    pub fn cocpu_saradc1_int_raw(&mut self) -> COCPU_SARADC1_INT_RAW_W<'_, COCPU_INT_RAW_SPEC> {
        COCPU_SARADC1_INT_RAW_W::new(self, 0)
    }
    #[doc = "Bit 1 - ADC2 Conversion is done, int raw."]
    #[inline(always)]
    pub fn cocpu_saradc2_int_raw(&mut self) -> COCPU_SARADC2_INT_RAW_W<'_, COCPU_INT_RAW_SPEC> {
    ...
    pub fn cocpu_saradc1_error_int_raw(
        &mut self,
    ) -> COCPU_SARADC1_ERROR_INT_RAW_W<'_, COCPU_INT_RAW_SPEC> {
    ...
    pub fn cocpu_saradc2_error_int_raw(
        &mut self,
    ) -> COCPU_SARADC2_ERROR_INT_RAW_W<'_, COCPU_INT_RAW_SPEC> {
    ...
    pub fn cocpu_saradc1_wake_int_raw(
        &mut self,
    ) -> COCPU_SARADC1_WAKE_INT_RAW_W<'_, COCPU_INT_RAW_SPEC> {
    ...
    pub fn cocpu_saradc2_wake_int_raw(
        &mut self,
    ) -> COCPU_SARADC2_WAKE_INT_RAW_W<'_, COCPU_INT_RAW_SPEC> {
