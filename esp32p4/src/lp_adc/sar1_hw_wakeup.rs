///Register `SAR1_HW_WAKEUP` reader
pub type R = crate::R<SAR1_HW_WAKEUP_SPEC>;
///Register `SAR1_HW_WAKEUP` writer
pub type W = crate::W<SAR1_HW_WAKEUP_SPEC>;
///Field `ADC1_HW_READ_EN_I` reader - Enable hardware automatic sampling.
pub type ADC1_HW_READ_EN_I_R = crate::BitReader;
///Field `ADC1_HW_READ_EN_I` writer - Enable hardware automatic sampling.
pub type ADC1_HW_READ_EN_I_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC1_HW_READ_RATE_I` reader - Hardware automatic sampling rate.
pub type ADC1_HW_READ_RATE_I_R = crate::FieldReader<u16>;
///Field `ADC1_HW_READ_RATE_I` writer - Hardware automatic sampling rate.
...
///`read()` method returns [`sar1_hw_wakeup::R`](R) reader structure
impl crate::Readable for SAR1_HW_WAKEUP_SPEC {}
///`write(|w| ..)` method takes [`sar1_hw_wakeup::W`](W) writer structure
