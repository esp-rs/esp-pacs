...
///`read()` method returns [`meas1_ctrl1::R`](R) reader structure
impl crate::Readable for MEAS1_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`meas1_ctrl1::W`](W) writer structure
