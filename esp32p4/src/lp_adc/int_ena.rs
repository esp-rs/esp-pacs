...
///Field `COCPU_SARADC1_INT_ENA` reader - ADC1 Conversion is done, int enable.
pub type COCPU_SARADC1_INT_ENA_R = crate::BitReader;
///Field `COCPU_SARADC1_INT_ENA` writer - ADC1 Conversion is done, int enable.
pub type COCPU_SARADC1_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_INT_ENA` reader - ADC2 Conversion is done, int enable.
pub type COCPU_SARADC2_INT_ENA_R = crate::BitReader;
///Field `COCPU_SARADC2_INT_ENA` writer - ADC2 Conversion is done, int enable.
pub type COCPU_SARADC2_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC1_ERROR_INT_ENA` reader - An errro occurs from ADC1, int enable.
pub type COCPU_SARADC1_ERROR_INT_ENA_R = crate::BitReader;
///Field `COCPU_SARADC1_ERROR_INT_ENA` writer - An errro occurs from ADC1, int enable.
pub type COCPU_SARADC1_ERROR_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_ERROR_INT_ENA` reader - An errro occurs from ADC2, int enable.
pub type COCPU_SARADC2_ERROR_INT_ENA_R = crate::BitReader;
///Field `COCPU_SARADC2_ERROR_INT_ENA` writer - An errro occurs from ADC2, int enable.
pub type COCPU_SARADC2_ERROR_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC1_WAKE_INT_ENA` reader - A wakeup event is triggered from ADC1, int enable.
pub type COCPU_SARADC1_WAKE_INT_ENA_R = crate::BitReader;
///Field `COCPU_SARADC1_WAKE_INT_ENA` writer - A wakeup event is triggered from ADC1, int enable.
pub type COCPU_SARADC1_WAKE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_WAKE_INT_ENA` reader - A wakeup event is triggered from ADC2, int enable.
pub type COCPU_SARADC2_WAKE_INT_ENA_R = crate::BitReader;
///Field `COCPU_SARADC2_WAKE_INT_ENA` writer - A wakeup event is triggered from ADC2, int enable.
pub type COCPU_SARADC2_WAKE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - ADC1 Conversion is done, int enable.
    #[inline(always)]
    pub fn cocpu_saradc1_int_ena(&self) -> COCPU_SARADC1_INT_ENA_R {
        COCPU_SARADC1_INT_ENA_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - ADC2 Conversion is done, int enable.
    #[inline(always)]
