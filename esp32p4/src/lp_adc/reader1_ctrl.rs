///Register `READER1_CTRL` reader
pub type R = crate::R<READER1_CTRL_SPEC>;
///Register `READER1_CTRL` writer
...
///Field `SAR1_INT_EN` reader - Enable saradc1 to send out interrupt.
pub type SAR1_INT_EN_R = crate::BitReader;
///Field `SAR1_INT_EN` writer - Enable saradc1 to send out interrupt.
pub type SAR1_INT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR1_EN_PAD_FORCE_ENABLE` reader - Force enable adc en_pad to analog circuit 2'b11: force enable .
pub type SAR1_EN_PAD_FORCE_ENABLE_R = crate::FieldReader;
///Field `SAR1_EN_PAD_FORCE_ENABLE` writer - Force enable adc en_pad to analog circuit 2'b11: force enable .
...
///`read()` method returns [`reader1_ctrl::R`](R) reader structure
impl crate::Readable for READER1_CTRL_SPEC {}
///`write(|w| ..)` method takes [`reader1_ctrl::W`](W) writer structure
