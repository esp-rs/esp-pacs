///Register `READER2_CTRL` reader
pub type R = crate::R<READER2_CTRL_SPEC>;
///Register `READER2_CTRL` writer
...
///Field `SAR2_CLK_GATED` reader - N/A
pub type SAR2_CLK_GATED_R = crate::BitReader;
///Field `SAR2_CLK_GATED` writer - N/A
pub type SAR2_CLK_GATED_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR2_SAMPLE_NUM` reader - N/A
pub type SAR2_SAMPLE_NUM_R = crate::FieldReader;
///Field `SAR2_SAMPLE_NUM` writer - N/A
pub type SAR2_SAMPLE_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SAR2_EN_PAD_FORCE_ENABLE` reader - Force enable adc en_pad to analog circuit 2'b11: force enable .
pub type SAR2_EN_PAD_FORCE_ENABLE_R = crate::FieldReader;
///Field `SAR2_EN_PAD_FORCE_ENABLE` writer - Force enable adc en_pad to analog circuit 2'b11: force enable .
...
///`read()` method returns [`reader2_ctrl::R`](R) reader structure
impl crate::Readable for READER2_CTRL_SPEC {}
///`write(|w| ..)` method takes [`reader2_ctrl::W`](W) writer structure
