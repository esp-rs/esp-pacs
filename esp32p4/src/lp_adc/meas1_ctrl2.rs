///Register `MEAS1_CTRL2` reader
pub type R = crate::R<MEAS1_CTRL2_SPEC>;
///Register `MEAS1_CTRL2` writer
...
///`read()` method returns [`meas1_ctrl2::R`](R) reader structure
impl crate::Readable for MEAS1_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`meas1_ctrl2::W`](W) writer structure
