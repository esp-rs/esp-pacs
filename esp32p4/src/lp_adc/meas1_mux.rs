///Register `MEAS1_MUX` reader
pub type R = crate::R<MEAS1_MUX_SPEC>;
///Register `MEAS1_MUX` writer
...
///`read()` method returns [`meas1_mux::R`](R) reader structure
impl crate::Readable for MEAS1_MUX_SPEC {}
///`write(|w| ..)` method takes [`meas1_mux::W`](W) writer structure
