///Register `FORCE_WPD_SAR` reader
pub type R = crate::R<FORCE_WPD_SAR_SPEC>;
///Register `FORCE_WPD_SAR` writer
pub type W = crate::W<FORCE_WPD_SAR_SPEC>;
///Field `FORCE_XPD_SAR1` reader - 2'b11:software control, force on. 2'b10:software control, force off. 2'b0x:hardware control.
pub type FORCE_XPD_SAR1_R = crate::FieldReader;
///Field `FORCE_XPD_SAR1` writer - 2'b11:software control, force on. 2'b10:software control, force off. 2'b0x:hardware control.
pub type FORCE_XPD_SAR1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `FORCE_XPD_SAR2` reader - 2'b11:software control, force on. 2'b10:software control, force off. 2'b0x:hardware control.
pub type FORCE_XPD_SAR2_R = crate::FieldReader;
///Field `FORCE_XPD_SAR2` writer - 2'b11:software control, force on. 2'b10:software control, force off. 2'b0x:hardware control.
pub type FORCE_XPD_SAR2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - 2'b11:software control, force on. 2'b10:software control, force off. 2'b0x:hardware control.
    #[inline(always)]
    pub fn force_xpd_sar1(&self) -> FORCE_XPD_SAR1_R {
        FORCE_XPD_SAR1_R::new((self.bits & 3) as u8)
    }
    ///Bits 2:3 - 2'b11:software control, force on. 2'b10:software control, force off. 2'b0x:hardware control.
    #[inline(always)]
...
///`read()` method returns [`force_wpd_sar::R`](R) reader structure
impl crate::Readable for FORCE_WPD_SAR_SPEC {}
///`write(|w| ..)` method takes [`force_wpd_sar::W`](W) writer structure
