...
///`read()` method returns [`amp_ctrl3::R`](R) reader structure
impl crate::Readable for AMP_CTRL3_SPEC {}
///`write(|w| ..)` method takes [`amp_ctrl3::W`](W) writer structure
