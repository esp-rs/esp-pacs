...
///Field `COCPU_SARADC1_INT_CLR` writer - ADC1 Conversion is done, int clear.
pub type COCPU_SARADC1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_INT_CLR` writer - ADC2 Conversion is done, int clear.
pub type COCPU_SARADC2_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC1_ERROR_INT_CLR` writer - An errro occurs from ADC1, int clear.
pub type COCPU_SARADC1_ERROR_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_ERROR_INT_CLR` writer - An errro occurs from ADC2, int clear.
pub type COCPU_SARADC2_ERROR_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC1_WAKE_INT_CLR` writer - A wakeup event is triggered from ADC1, int clear.
pub type COCPU_SARADC1_WAKE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SARADC2_WAKE_INT_CLR` writer - A wakeup event is triggered from ADC2, int clear.
