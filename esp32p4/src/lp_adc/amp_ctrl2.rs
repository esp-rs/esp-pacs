...
///`read()` method returns [`amp_ctrl2::R`](R) reader structure
impl crate::Readable for AMP_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`amp_ctrl2::W`](W) writer structure
