...
///`read()` method returns [`vddbat_charge_cntl::R`](R) reader structure
impl crate::Readable for VDDBAT_CHARGE_CNTL_SPEC {}
///`write(|w| ..)` method takes [`vddbat_charge_cntl::W`](W) writer structure
