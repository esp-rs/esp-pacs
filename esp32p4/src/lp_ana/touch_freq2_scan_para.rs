...
///`read()` method returns [`touch_freq2_scan_para::R`](R) reader structure
impl crate::Readable for TOUCH_FREQ2_SCAN_PARA_SPEC {}
///`write(|w| ..)` method takes [`touch_freq2_scan_para::W`](W) writer structure
impl crate::Writable for TOUCH_FREQ2_SCAN_PARA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_FREQ2_SCAN_PARA to value 0
