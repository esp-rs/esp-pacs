...
///`read()` method returns [`touch_mux1::R`](R) reader structure
impl crate::Readable for TOUCH_MUX1_SPEC {}
///`write(|w| ..)` method takes [`touch_mux1::W`](W) writer structure
impl crate::Writable for TOUCH_MUX1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_MUX1 to value 0
