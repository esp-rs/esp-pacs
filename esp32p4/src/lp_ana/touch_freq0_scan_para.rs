///Register `TOUCH_FREQ0_SCAN_PARA` reader
pub type R = crate::R<TOUCH_FREQ0_SCAN_PARA_SPEC>;
///Register `TOUCH_FREQ0_SCAN_PARA` writer
pub type W = crate::W<TOUCH_FREQ0_SCAN_PARA_SPEC>;
///Field `TOUCH_FREQ0_DCAP_LPF` reader - need_des
pub type TOUCH_FREQ0_DCAP_LPF_R = crate::FieldReader;
///Field `TOUCH_FREQ0_DCAP_LPF` writer - need_des
pub type TOUCH_FREQ0_DCAP_LPF_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `TOUCH_FREQ0_DRES_LPF` reader - need_des
pub type TOUCH_FREQ0_DRES_LPF_R = crate::FieldReader;
///Field `TOUCH_FREQ0_DRES_LPF` writer - need_des
pub type TOUCH_FREQ0_DRES_LPF_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_FREQ0_DRV_LS` reader - need_des
pub type TOUCH_FREQ0_DRV_LS_R = crate::FieldReader;
///Field `TOUCH_FREQ0_DRV_LS` writer - need_des
pub type TOUCH_FREQ0_DRV_LS_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TOUCH_FREQ0_DRV_HS` reader - need_des
pub type TOUCH_FREQ0_DRV_HS_R = crate::FieldReader;
///Field `TOUCH_FREQ0_DRV_HS` writer - need_des
pub type TOUCH_FREQ0_DRV_HS_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `TOUCH_FREQ0_DBIAS` reader - need_des
pub type TOUCH_FREQ0_DBIAS_R = crate::FieldReader;
///Field `TOUCH_FREQ0_DBIAS` writer - need_des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TOUCH_FREQ0_SCAN_PARA")
...
You can [`read`](crate::generic::Reg::read) this register and get [`touch_freq0_scan_para::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`touch_freq0_scan_para::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct TOUCH_FREQ0_SCAN_PARA_SPEC;
impl crate::RegisterSpec for TOUCH_FREQ0_SCAN_PARA_SPEC {
    type Ux = u32;
}
///`read()` method returns [`touch_freq0_scan_para::R`](R) reader structure
impl crate::Readable for TOUCH_FREQ0_SCAN_PARA_SPEC {}
///`write(|w| ..)` method takes [`touch_freq0_scan_para::W`](W) writer structure
impl crate::Writable for TOUCH_FREQ0_SCAN_PARA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_FREQ0_SCAN_PARA to value 0
impl crate::Resettable for TOUCH_FREQ0_SCAN_PARA_SPEC {
