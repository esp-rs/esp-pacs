...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vddbat_charger(&mut self) -> VDDBAT_CHARGER_W<VDDBAT_BOD_CNTL_SPEC> {
        VDDBAT_CHARGER_W::new(self, 10)
    }
    ///Bit 11 - need_des
    #[inline(always)]
    #[must_use]
    pub fn vddbat_cnt_clr(&mut self) -> VDDBAT_CNT_CLR_W<VDDBAT_BOD_CNTL_SPEC> {
    ...
    pub fn vddbat_undervoltage_target(
        &mut self,
    ) -> VDDBAT_UNDERVOLTAGE_TARGET_W<VDDBAT_BOD_CNTL_SPEC> {
        VDDBAT_UNDERVOLTAGE_TARGET_W::new(self, 22)
    }
}
/**need_des

You can [`read`](crate::generic::Reg::read) this register and get [`vddbat_bod_cntl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`vddbat_bod_cntl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct VDDBAT_BOD_CNTL_SPEC;
impl crate::RegisterSpec for VDDBAT_BOD_CNTL_SPEC {
    type Ux = u32;
}
///`read()` method returns [`vddbat_bod_cntl::R`](R) reader structure
impl crate::Readable for VDDBAT_BOD_CNTL_SPEC {}
///`write(|w| ..)` method takes [`vddbat_bod_cntl::W`](W) writer structure
