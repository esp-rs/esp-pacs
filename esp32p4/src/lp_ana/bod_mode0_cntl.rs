...
You can [`read`](crate::generic::Reg::read) this register and get [`bod_mode0_cntl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bod_mode0_cntl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BOD_MODE0_CNTL_SPEC;
impl crate::RegisterSpec for BOD_MODE0_CNTL_SPEC {
    type Ux = u32;
}
///`read()` method returns [`bod_mode0_cntl::R`](R) reader structure
impl crate::Readable for BOD_MODE0_CNTL_SPEC {}
///`write(|w| ..)` method takes [`bod_mode0_cntl::W`](W) writer structure
