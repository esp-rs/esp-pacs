///Register `TOUCH_PAD3_TH0` reader
pub type R = crate::R<TOUCH_PAD3_TH0_SPEC>;
///Register `TOUCH_PAD3_TH0` writer
pub type W = crate::W<TOUCH_PAD3_TH0_SPEC>;
///Field `TOUCH_PAD3_TH0` reader - Reserved
pub type TOUCH_PAD3_TH0_R = crate::FieldReader<u16>;
///Field `TOUCH_PAD3_TH0` writer - Reserved
...
///`read()` method returns [`touch_pad3_th0::R`](R) reader structure
impl crate::Readable for TOUCH_PAD3_TH0_SPEC {}
///`write(|w| ..)` method takes [`touch_pad3_th0::W`](W) writer structure
impl crate::Writable for TOUCH_PAD3_TH0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_PAD3_TH0 to value 0
