...
You can [`read`](crate::generic::Reg::read) this register and get [`touch_mux0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`touch_mux0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct TOUCH_MUX0_SPEC;
impl crate::RegisterSpec for TOUCH_MUX0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`touch_mux0::R`](R) reader structure
impl crate::Readable for TOUCH_MUX0_SPEC {}
///`write(|w| ..)` method takes [`touch_mux0::W`](W) writer structure
impl crate::Writable for TOUCH_MUX0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_MUX0 to value 0x2000_0000
