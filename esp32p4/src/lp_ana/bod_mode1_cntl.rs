///Register `BOD_MODE1_CNTL` reader
pub type R = crate::R<BOD_MODE1_CNTL_SPEC>;
///Register `BOD_MODE1_CNTL` writer
pub type W = crate::W<BOD_MODE1_CNTL_SPEC>;
///Field `BOD_MODE1_RESET_ENA` reader - need_des
pub type BOD_MODE1_RESET_ENA_R = crate::BitReader;
///Field `BOD_MODE1_RESET_ENA` writer - need_des
...
///`read()` method returns [`bod_mode1_cntl::R`](R) reader structure
impl crate::Readable for BOD_MODE1_CNTL_SPEC {}
///`write(|w| ..)` method takes [`bod_mode1_cntl::W`](W) writer structure
