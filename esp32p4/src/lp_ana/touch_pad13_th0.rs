#[doc = "Register `TOUCH_PAD13_TH0` reader"]
pub type R = crate::R<TOUCH_PAD13_TH0_SPEC>;
#[doc = "Register `TOUCH_PAD13_TH0` writer"]
...
impl W {
    #[doc = "Bits 16:31 - Reserved"]
    #[inline(always)]
    pub fn touch_pad13_th0(&mut self) -> TOUCH_PAD13_TH0_W<'_, TOUCH_PAD13_TH0_SPEC> {
        TOUCH_PAD13_TH0_W::new(self, 16)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`touch_pad13_th0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`touch_pad13_th0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TOUCH_PAD13_TH0_SPEC;
impl crate::RegisterSpec for TOUCH_PAD13_TH0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`touch_pad13_th0::R`](R) reader structure"]
impl crate::Readable for TOUCH_PAD13_TH0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`touch_pad13_th0::W`](W) writer structure"]
impl crate::Writable for TOUCH_PAD13_TH0_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TOUCH_PAD13_TH0 to value 0"]
