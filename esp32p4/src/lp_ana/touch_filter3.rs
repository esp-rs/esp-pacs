...
///`read()` method returns [`touch_filter3::R`](R) reader structure
impl crate::Readable for TOUCH_FILTER3_SPEC {}
///`write(|w| ..)` method takes [`touch_filter3::W`](W) writer structure
impl crate::Writable for TOUCH_FILTER3_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_FILTER3 to value 0
