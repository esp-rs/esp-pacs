...
///`read()` method returns [`vdd_source_cntl::R`](R) reader structure
impl crate::Readable for VDD_SOURCE_CNTL_SPEC {}
///`write(|w| ..)` method takes [`vdd_source_cntl::W`](W) writer structure
