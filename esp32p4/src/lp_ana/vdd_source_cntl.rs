...
impl W {
    ...
    #[inline(always)]
    pub fn vbat_event_record_clr(&mut self) -> VBAT_EVENT_RECORD_CLR_W<'_, VDD_SOURCE_CNTL_SPEC> {
        VBAT_EVENT_RECORD_CLR_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - need_des"]
    #[inline(always)]
    pub fn bod_source_ena(&mut self) -> BOD_SOURCE_ENA_W<'_, VDD_SOURCE_CNTL_SPEC> {
