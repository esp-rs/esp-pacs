...
///`read()` method returns [`touch_slp0::R`](R) reader structure
impl crate::Readable for TOUCH_SLP0_SPEC {}
///`write(|w| ..)` method takes [`touch_slp0::W`](W) writer structure
impl crate::Writable for TOUCH_SLP0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_SLP0 to value 0x001e_0000
