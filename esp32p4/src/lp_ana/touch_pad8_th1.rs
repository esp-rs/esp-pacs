///Register `TOUCH_PAD8_TH1` reader
pub type R = crate::R<TOUCH_PAD8_TH1_SPEC>;
///Register `TOUCH_PAD8_TH1` writer
pub type W = crate::W<TOUCH_PAD8_TH1_SPEC>;
///Field `TOUCH_PAD8_TH1` reader - Reserved
pub type TOUCH_PAD8_TH1_R = crate::FieldReader<u16>;
///Field `TOUCH_PAD8_TH1` writer - Reserved
...
///`read()` method returns [`touch_pad8_th1::R`](R) reader structure
impl crate::Readable for TOUCH_PAD8_TH1_SPEC {}
///`write(|w| ..)` method takes [`touch_pad8_th1::W`](W) writer structure
impl crate::Writable for TOUCH_PAD8_TH1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_PAD8_TH1 to value 0
