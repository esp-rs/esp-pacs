///Register `TOUCH_CLR` writer
pub type W = crate::W<TOUCH_CLR_SPEC>;
///Field `TOUCH_CHANNEL_CLR` writer - need_des
pub type TOUCH_CHANNEL_CLR_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `TOUCH_STATUS_CLR` writer - need_des
...
///`write(|w| ..)` method takes [`touch_clr::W`](W) writer structure
impl crate::Writable for TOUCH_CLR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_CLR to value 0
