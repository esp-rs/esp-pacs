///Register `WR_JTAG` writer
pub type W = crate::W<WR_JTAG_SPEC>;
///Field `WR_JTAG` writer - 32-bit of key to be compared.
...
impl W {
    ///Bits 0:31 - 32-bit of key to be compared.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`wr_jtag::W`](W) writer structure
