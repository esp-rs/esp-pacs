...
#[doc = "Field `SET_START` writer - Configures whether or not to enable HMAC. \\\\0: Disable HMAC \\\\1: Enable HMAC"]
...
impl W {
    #[doc = "Bit 0 - Configures whether or not to enable HMAC. \\\\0: Disable HMAC \\\\1: Enable HMAC"]
    #[inline(always)]
    pub fn set_start(&mut self) -> SET_START_W<'_, SET_START_SPEC> {
