...
#[doc = "Field `SET_TEXT_END` writer - Configures whether to start hardware padding. \\\\0: No effect \\\\1: Start hardware padding"]
...
impl W {
    #[doc = "Bit 0 - Configures whether to start hardware padding. \\\\0: No effect \\\\1: Start hardware padding"]
    #[inline(always)]
