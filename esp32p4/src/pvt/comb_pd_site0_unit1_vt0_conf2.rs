    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE0_UNIT1_VT0_CONF2")
            .field(
                ...
                &format_args!("{}", self.monitor_edg_mod_vt0_pd_site0_unit1().bits()),
            )
            .field(
                "delay_ovf_vt0_pd_site0_unit1",
                &format_args!("{}", self.delay_ovf_vt0_pd_site0_unit1().bit()),
            )
            .field(
                "timing_err_cnt_o_vt0_pd_site0_unit1",
                &format_args!("{}", self.timing_err_cnt_o_vt0_pd_site0_unit1().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<COMB_PD_SITE0_UNIT1_VT0_CONF2_SPEC> {
