///Register `DBIAS_CMD3` reader
pub type R = crate::R<DBIAS_CMD3_SPEC>;
///Register `DBIAS_CMD3` writer
pub type W = crate::W<DBIAS_CMD3_SPEC>;
///Field `DBIAS_CMD3` reader - needs field desc
pub type DBIAS_CMD3_R = crate::FieldReader<u32>;
///Field `DBIAS_CMD3` writer - needs field desc
...
///`read()` method returns [`dbias_cmd3::R`](R) reader structure
impl crate::Readable for DBIAS_CMD3_SPEC {}
///`write(|w| ..)` method takes [`dbias_cmd3::W`](W) writer structure
