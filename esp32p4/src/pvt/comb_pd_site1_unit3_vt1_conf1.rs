    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE1_UNIT3_VT1_CONF1")
            .field(
                ...
                &format_args!("{}", self.monitor_en_vt1_pd_site1_unit3().bit()),
            )
            .field(
                "delay_limit_vt1_pd_site1_unit3",
                &format_args!("{}", self.delay_limit_vt1_pd_site1_unit3().bits()),
            )
            .field(
                "delay_num_o_vt1_pd_site1_unit3",
                &format_args!("{}", self.delay_num_o_vt1_pd_site1_unit3().bits()),
            )
            .field(
                "timing_err_vt1_pd_site1_unit3",
                &format_args!("{}", self.timing_err_vt1_pd_site1_unit3().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<COMB_PD_SITE1_UNIT3_VT1_CONF1_SPEC> {
