///Register `DBIAS_CHANNEL1_SEL` reader
pub type R = crate::R<DBIAS_CHANNEL1_SEL_SPEC>;
///Register `DBIAS_CHANNEL1_SEL` writer
pub type W = crate::W<DBIAS_CHANNEL1_SEL_SPEC>;
///Field `DBIAS_CHANNEL1_CFG` reader - needs field desc
pub type DBIAS_CHANNEL1_CFG_R = crate::FieldReader<u32>;
///Field `DBIAS_CHANNEL1_CFG` writer - needs field desc
...
///`read()` method returns [`dbias_channel1_sel::R`](R) reader structure
impl crate::Readable for DBIAS_CHANNEL1_SEL_SPEC {}
///`write(|w| ..)` method takes [`dbias_channel1_sel::W`](W) writer structure
