///Register `DBIAS_CMD2` reader
pub type R = crate::R<DBIAS_CMD2_SPEC>;
///Register `DBIAS_CMD2` writer
pub type W = crate::W<DBIAS_CMD2_SPEC>;
///Field `DBIAS_CMD2` reader - needs field desc
pub type DBIAS_CMD2_R = crate::FieldReader<u32>;
///Field `DBIAS_CMD2` writer - needs field desc
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbias_cmd2(&mut self) -> DBIAS_CMD2_W<DBIAS_CMD2_SPEC> {
...
///`read()` method returns [`dbias_cmd2::R`](R) reader structure
impl crate::Readable for DBIAS_CMD2_SPEC {}
///`write(|w| ..)` method takes [`dbias_cmd2::W`](W) writer structure
