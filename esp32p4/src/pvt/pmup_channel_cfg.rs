...
///`read()` method returns [`pmup_channel_cfg::R`](R) reader structure
impl crate::Readable for PMUP_CHANNEL_CFG_SPEC {}
///`write(|w| ..)` method takes [`pmup_channel_cfg::W`](W) writer structure
