    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE1_UNIT1_VT2_CONF1")
            .field(
                ...
                &self.monitor_en_vt2_pd_site1_unit1().bit(),
            )
            .field(
                "delay_limit_vt2_pd_site1_unit1",
                &self.delay_limit_vt2_pd_site1_unit1().bits(),
            )
            .field(
                "delay_num_o_vt2_pd_site1_unit1",
                &self.delay_num_o_vt2_pd_site1_unit1().bits(),
            )
            .field(
                "timing_err_vt2_pd_site1_unit1",
                &self.timing_err_vt2_pd_site1_unit1().bit(),
            )
            .finish()
    }
}
