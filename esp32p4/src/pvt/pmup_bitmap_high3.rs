///Register `PMUP_BITMAP_HIGH3` reader
pub type R = crate::R<PMUP_BITMAP_HIGH3_SPEC>;
///Register `PMUP_BITMAP_HIGH3` writer
pub type W = crate::W<PMUP_BITMAP_HIGH3_SPEC>;
///Field `PUMP_BITMAP_HIGH3` reader - select valid high channel3
pub type PUMP_BITMAP_HIGH3_R = crate::FieldReader<u32>;
///Field `PUMP_BITMAP_HIGH3` writer - select valid high channel3
pub type PUMP_BITMAP_HIGH3_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - select valid high channel3
    #[inline(always)]
...
///`read()` method returns [`pmup_bitmap_high3::R`](R) reader structure
impl crate::Readable for PMUP_BITMAP_HIGH3_SPEC {}
///`write(|w| ..)` method takes [`pmup_bitmap_high3::W`](W) writer structure
