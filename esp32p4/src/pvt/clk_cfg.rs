...
///`read()` method returns [`clk_cfg::R`](R) reader structure
impl crate::Readable for CLK_CFG_SPEC {}
///`write(|w| ..)` method takes [`clk_cfg::W`](W) writer structure
