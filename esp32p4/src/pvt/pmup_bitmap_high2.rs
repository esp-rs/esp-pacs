///Register `PMUP_BITMAP_HIGH2` reader
pub type R = crate::R<PMUP_BITMAP_HIGH2_SPEC>;
///Register `PMUP_BITMAP_HIGH2` writer
pub type W = crate::W<PMUP_BITMAP_HIGH2_SPEC>;
///Field `PUMP_BITMAP_HIGH2` reader - select valid high channel2
pub type PUMP_BITMAP_HIGH2_R = crate::FieldReader<u32>;
///Field `PUMP_BITMAP_HIGH2` writer - select valid high channel2
pub type PUMP_BITMAP_HIGH2_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - select valid high channel2
    #[inline(always)]
...
///`read()` method returns [`pmup_bitmap_high2::R`](R) reader structure
impl crate::Readable for PMUP_BITMAP_HIGH2_SPEC {}
///`write(|w| ..)` method takes [`pmup_bitmap_high2::W`](W) writer structure
