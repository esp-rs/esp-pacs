///Register `COMB_PD_SITE1_UNIT0_VT2_CONF1` reader
pub type R = crate::R<COMB_PD_SITE1_UNIT0_VT2_CONF1_SPEC>;
///Register `COMB_PD_SITE1_UNIT0_VT2_CONF1` writer
pub type W = crate::W<COMB_PD_SITE1_UNIT0_VT2_CONF1_SPEC>;
///Field `MONITOR_EN_VT2_PD_SITE1_UNIT0` reader - needs field desc
pub type MONITOR_EN_VT2_PD_SITE1_UNIT0_R = crate::BitReader;
///Field `MONITOR_EN_VT2_PD_SITE1_UNIT0` writer - needs field desc
pub type MONITOR_EN_VT2_PD_SITE1_UNIT0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT0` writer - needs field desc
pub type TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DELAY_LIMIT_VT2_PD_SITE1_UNIT0` reader - needs field desc
pub type DELAY_LIMIT_VT2_PD_SITE1_UNIT0_R = crate::FieldReader;
///Field `DELAY_LIMIT_VT2_PD_SITE1_UNIT0` writer - needs field desc
pub type DELAY_LIMIT_VT2_PD_SITE1_UNIT0_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DELAY_NUM_O_VT2_PD_SITE1_UNIT0` reader - needs field desc
pub type DELAY_NUM_O_VT2_PD_SITE1_UNIT0_R = crate::FieldReader;
///Field `TIMING_ERR_VT2_PD_SITE1_UNIT0` reader - needs field desc
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE1_UNIT0_VT2_CONF1")
            .field(
                ...
                &self.monitor_en_vt2_pd_site1_unit0(),
            )
            .field(
                "delay_limit_vt2_pd_site1_unit0",
                &self.delay_limit_vt2_pd_site1_unit0(),
            )
            .field(
                "delay_num_o_vt2_pd_site1_unit0",
                &self.delay_num_o_vt2_pd_site1_unit0(),
            )
            .field(
                "timing_err_vt2_pd_site1_unit0",
                &self.timing_err_vt2_pd_site1_unit0(),
            )
            .finish()
    }
}
...
///`read()` method returns [`comb_pd_site1_unit0_vt2_conf1::R`](R) reader structure
impl crate::Readable for COMB_PD_SITE1_UNIT0_VT2_CONF1_SPEC {}
///`write(|w| ..)` method takes [`comb_pd_site1_unit0_vt2_conf1::W`](W) writer structure
