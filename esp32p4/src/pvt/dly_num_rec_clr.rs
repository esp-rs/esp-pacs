#[doc = "Register `DLY_NUM_REC_CLR` reader"]
pub type R = crate::R<DLY_NUM_REC_CLR_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DLY_NUM_REC_CLR")
            .field("val", &self.val())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn val(&mut self) -> VAL_W<'_, DLY_NUM_REC_CLR_SPEC> {
        VAL_W::new(self, 0)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`dly_num_rec_clr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dly_num_rec_clr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DLY_NUM_REC_CLR_SPEC;
impl crate::RegisterSpec for DLY_NUM_REC_CLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dly_num_rec_clr::R`](R) reader structure"]
impl crate::Readable for DLY_NUM_REC_CLR_SPEC {}
