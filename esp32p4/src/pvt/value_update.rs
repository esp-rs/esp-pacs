///Register `VALUE_UPDATE` reader
pub type R = crate::R<VALUE_UPDATE_SPEC>;
///Register `VALUE_UPDATE` writer
pub type W = crate::W<VALUE_UPDATE_SPEC>;
///Field `VALUE_UPDATE` writer - needs field desc
pub type VALUE_UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BYPASS` reader - needs field desc
pub type BYPASS_R = crate::BitReader;
///Field `BYPASS` writer - needs field desc
...
///`read()` method returns [`value_update::R`](R) reader structure
impl crate::Readable for VALUE_UPDATE_SPEC {}
///`write(|w| ..)` method takes [`value_update::W`](W) writer structure
