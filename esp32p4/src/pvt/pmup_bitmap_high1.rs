///Register `PMUP_BITMAP_HIGH1` reader
pub type R = crate::R<PMUP_BITMAP_HIGH1_SPEC>;
///Register `PMUP_BITMAP_HIGH1` writer
pub type W = crate::W<PMUP_BITMAP_HIGH1_SPEC>;
///Field `PUMP_BITMAP_HIGH1` reader - select valid high channel1
pub type PUMP_BITMAP_HIGH1_R = crate::FieldReader<u32>;
///Field `PUMP_BITMAP_HIGH1` writer - select valid high channel1
pub type PUMP_BITMAP_HIGH1_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - select valid high channel1
    #[inline(always)]
...
///`read()` method returns [`pmup_bitmap_high1::R`](R) reader structure
impl crate::Readable for PMUP_BITMAP_HIGH1_SPEC {}
///`write(|w| ..)` method takes [`pmup_bitmap_high1::W`](W) writer structure
