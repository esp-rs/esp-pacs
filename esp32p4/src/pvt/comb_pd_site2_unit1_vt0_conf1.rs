    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE2_UNIT1_VT0_CONF1")
            .field(
                ...
                &self.monitor_en_vt0_pd_site2_unit1().bit(),
            )
            .field(
                "delay_limit_vt0_pd_site2_unit1",
                &self.delay_limit_vt0_pd_site2_unit1().bits(),
            )
            .field(
                "delay_num_o_vt0_pd_site2_unit1",
                &self.delay_num_o_vt0_pd_site2_unit1().bits(),
            )
            .field(
                "timing_err_vt0_pd_site2_unit1",
                &self.timing_err_vt0_pd_site2_unit1().bit(),
            )
            .finish()
    }
}
