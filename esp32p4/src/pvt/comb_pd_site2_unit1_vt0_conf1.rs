    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE2_UNIT1_VT0_CONF1")
            .field(
                ...
                &format_args!("{}", self.monitor_en_vt0_pd_site2_unit1().bit()),
            )
            .field(
                "delay_limit_vt0_pd_site2_unit1",
                &format_args!("{}", self.delay_limit_vt0_pd_site2_unit1().bits()),
            )
            .field(
                "delay_num_o_vt0_pd_site2_unit1",
                &format_args!("{}", self.delay_num_o_vt0_pd_site2_unit1().bits()),
            )
            .field(
                "timing_err_vt0_pd_site2_unit1",
                &format_args!("{}", self.timing_err_vt0_pd_site2_unit1().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<COMB_PD_SITE2_UNIT1_VT0_CONF1_SPEC> {
