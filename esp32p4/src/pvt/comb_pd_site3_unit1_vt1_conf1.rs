    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE3_UNIT1_VT1_CONF1")
            .field(
                ...
                &self.monitor_en_vt1_pd_site3_unit1().bit(),
            )
            .field(
                "delay_limit_vt1_pd_site3_unit1",
                &self.delay_limit_vt1_pd_site3_unit1().bits(),
            )
            .field(
                "delay_num_o_vt1_pd_site3_unit1",
                &self.delay_num_o_vt1_pd_site3_unit1().bits(),
            )
            .field(
                "timing_err_vt1_pd_site3_unit1",
                &self.timing_err_vt1_pd_site3_unit1().bit(),
            )
            .finish()
    }
}
