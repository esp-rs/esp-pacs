///Register `COMB_PD_SITE3_UNIT1_VT1_CONF1` reader
pub type R = crate::R<COMB_PD_SITE3_UNIT1_VT1_CONF1_SPEC>;
///Register `COMB_PD_SITE3_UNIT1_VT1_CONF1` writer
pub type W = crate::W<COMB_PD_SITE3_UNIT1_VT1_CONF1_SPEC>;
///Field `MONITOR_EN_VT1_PD_SITE3_UNIT1` reader - needs field desc
pub type MONITOR_EN_VT1_PD_SITE3_UNIT1_R = crate::BitReader;
///Field `MONITOR_EN_VT1_PD_SITE3_UNIT1` writer - needs field desc
pub type MONITOR_EN_VT1_PD_SITE3_UNIT1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMING_ERR_CNT_CLR_VT1_PD_SITE3_UNIT1` writer - needs field desc
pub type TIMING_ERR_CNT_CLR_VT1_PD_SITE3_UNIT1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DELAY_LIMIT_VT1_PD_SITE3_UNIT1` reader - needs field desc
pub type DELAY_LIMIT_VT1_PD_SITE3_UNIT1_R = crate::FieldReader;
///Field `DELAY_LIMIT_VT1_PD_SITE3_UNIT1` writer - needs field desc
pub type DELAY_LIMIT_VT1_PD_SITE3_UNIT1_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DELAY_NUM_O_VT1_PD_SITE3_UNIT1` reader - needs field desc
pub type DELAY_NUM_O_VT1_PD_SITE3_UNIT1_R = crate::FieldReader;
///Field `TIMING_ERR_VT1_PD_SITE3_UNIT1` reader - needs field desc
...
impl W {
    ...
    pub fn monitor_en_vt1_pd_site3_unit1(
        &mut self,
    ) -> MONITOR_EN_VT1_PD_SITE3_UNIT1_W<COMB_PD_SITE3_UNIT1_VT1_CONF1_SPEC> {
    ...
    pub fn timing_err_cnt_clr_vt1_pd_site3_unit1(
        &mut self,
    ) -> TIMING_ERR_CNT_CLR_VT1_PD_SITE3_UNIT1_W<COMB_PD_SITE3_UNIT1_VT1_CONF1_SPEC> {
    ...
    pub fn delay_limit_vt1_pd_site3_unit1(
        &mut self,
    ) -> DELAY_LIMIT_VT1_PD_SITE3_UNIT1_W<COMB_PD_SITE3_UNIT1_VT1_CONF1_SPEC> {
...
///`read()` method returns [`comb_pd_site3_unit1_vt1_conf1::R`](R) reader structure
impl crate::Readable for COMB_PD_SITE3_UNIT1_VT1_CONF1_SPEC {}
///`write(|w| ..)` method takes [`comb_pd_site3_unit1_vt1_conf1::W`](W) writer structure
