///Register `DBIAS_CMD1` reader
pub type R = crate::R<DBIAS_CMD1_SPEC>;
///Register `DBIAS_CMD1` writer
pub type W = crate::W<DBIAS_CMD1_SPEC>;
///Field `DBIAS_CMD1` reader - needs field desc
pub type DBIAS_CMD1_R = crate::FieldReader<u32>;
///Field `DBIAS_CMD1` writer - needs field desc
...
///`read()` method returns [`dbias_cmd1::R`](R) reader structure
impl crate::Readable for DBIAS_CMD1_SPEC {}
///`write(|w| ..)` method takes [`dbias_cmd1::W`](W) writer structure
