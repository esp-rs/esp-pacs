///Register `COMB_PD_SITE3_UNIT0_VT2_CONF1` reader
pub type R = crate::R<COMB_PD_SITE3_UNIT0_VT2_CONF1_SPEC>;
///Register `COMB_PD_SITE3_UNIT0_VT2_CONF1` writer
pub type W = crate::W<COMB_PD_SITE3_UNIT0_VT2_CONF1_SPEC>;
///Field `MONITOR_EN_VT2_PD_SITE3_UNIT0` reader - needs field desc
pub type MONITOR_EN_VT2_PD_SITE3_UNIT0_R = crate::BitReader;
///Field `MONITOR_EN_VT2_PD_SITE3_UNIT0` writer - needs field desc
pub type MONITOR_EN_VT2_PD_SITE3_UNIT0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMING_ERR_CNT_CLR_VT2_PD_SITE3_UNIT0` writer - needs field desc
pub type TIMING_ERR_CNT_CLR_VT2_PD_SITE3_UNIT0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DELAY_LIMIT_VT2_PD_SITE3_UNIT0` reader - needs field desc
pub type DELAY_LIMIT_VT2_PD_SITE3_UNIT0_R = crate::FieldReader;
///Field `DELAY_LIMIT_VT2_PD_SITE3_UNIT0` writer - needs field desc
pub type DELAY_LIMIT_VT2_PD_SITE3_UNIT0_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DELAY_NUM_O_VT2_PD_SITE3_UNIT0` reader - needs field desc
pub type DELAY_NUM_O_VT2_PD_SITE3_UNIT0_R = crate::FieldReader;
///Field `TIMING_ERR_VT2_PD_SITE3_UNIT0` reader - needs field desc
...
impl W {
    ...
    pub fn monitor_en_vt2_pd_site3_unit0(
        &mut self,
    ) -> MONITOR_EN_VT2_PD_SITE3_UNIT0_W<COMB_PD_SITE3_UNIT0_VT2_CONF1_SPEC> {
        MONITOR_EN_VT2_PD_SITE3_UNIT0_W::new(self, 0)
    }
    ...
    pub fn timing_err_cnt_clr_vt2_pd_site3_unit0(
        &mut self,
    ) -> TIMING_ERR_CNT_CLR_VT2_PD_SITE3_UNIT0_W<COMB_PD_SITE3_UNIT0_VT2_CONF1_SPEC> {
        TIMING_ERR_CNT_CLR_VT2_PD_SITE3_UNIT0_W::new(self, 1)
    }
    ///Bits 2:9 - needs field desc
    #[inline(always)]
    #[must_use]
    pub fn delay_limit_vt2_pd_site3_unit0(
        &mut self,
    ) -> DELAY_LIMIT_VT2_PD_SITE3_UNIT0_W<COMB_PD_SITE3_UNIT0_VT2_CONF1_SPEC> {
        DELAY_LIMIT_VT2_PD_SITE3_UNIT0_W::new(self, 2)
    }
}
/**needs desc
...
///`read()` method returns [`comb_pd_site3_unit0_vt2_conf1::R`](R) reader structure
impl crate::Readable for COMB_PD_SITE3_UNIT0_VT2_CONF1_SPEC {}
///`write(|w| ..)` method takes [`comb_pd_site3_unit0_vt2_conf1::W`](W) writer structure
impl crate::Writable for COMB_PD_SITE3_UNIT0_VT2_CONF1_SPEC {
