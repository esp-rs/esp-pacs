///Register `DBIAS_CMD0` reader
pub type R = crate::R<DBIAS_CMD0_SPEC>;
///Register `DBIAS_CMD0` writer
pub type W = crate::W<DBIAS_CMD0_SPEC>;
///Field `DBIAS_CMD0` reader - needs field desc
pub type DBIAS_CMD0_R = crate::FieldReader<u32>;
///Field `DBIAS_CMD0` writer - needs field desc
...
///`read()` method returns [`dbias_cmd0::R`](R) reader structure
impl crate::Readable for DBIAS_CMD0_SPEC {}
///`write(|w| ..)` method takes [`dbias_cmd0::W`](W) writer structure
