///Register `PMUP_BITMAP_LOW3` reader
pub type R = crate::R<PMUP_BITMAP_LOW3_SPEC>;
///Register `PMUP_BITMAP_LOW3` writer
pub type W = crate::W<PMUP_BITMAP_LOW3_SPEC>;
///Field `PUMP_BITMAP_LOW3` reader - select valid low channel3
pub type PUMP_BITMAP_LOW3_R = crate::FieldReader<u32>;
///Field `PUMP_BITMAP_LOW3` writer - select valid low channel3
pub type PUMP_BITMAP_LOW3_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - select valid low channel3
    #[inline(always)]
...
///`read()` method returns [`pmup_bitmap_low3::R`](R) reader structure
impl crate::Readable for PMUP_BITMAP_LOW3_SPEC {}
///`write(|w| ..)` method takes [`pmup_bitmap_low3::W`](W) writer structure
