    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE2_UNIT2_VT1_CONF1")
            .field(
                ...
                &self.monitor_en_vt1_pd_site2_unit2().bit(),
            )
            .field(
                "delay_limit_vt1_pd_site2_unit2",
                &self.delay_limit_vt1_pd_site2_unit2().bits(),
            )
            .field(
                "delay_num_o_vt1_pd_site2_unit2",
                &self.delay_num_o_vt1_pd_site2_unit2().bits(),
            )
            .field(
                "timing_err_vt1_pd_site2_unit2",
                &self.timing_err_vt1_pd_site2_unit2().bit(),
            )
            .finish()
    }
}
