///Register `COMB_PD_SITE2_UNIT2_VT1_CONF1` reader
pub type R = crate::R<COMB_PD_SITE2_UNIT2_VT1_CONF1_SPEC>;
///Register `COMB_PD_SITE2_UNIT2_VT1_CONF1` writer
pub type W = crate::W<COMB_PD_SITE2_UNIT2_VT1_CONF1_SPEC>;
///Field `MONITOR_EN_VT1_PD_SITE2_UNIT2` reader - needs field desc
pub type MONITOR_EN_VT1_PD_SITE2_UNIT2_R = crate::BitReader;
///Field `MONITOR_EN_VT1_PD_SITE2_UNIT2` writer - needs field desc
pub type MONITOR_EN_VT1_PD_SITE2_UNIT2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMING_ERR_CNT_CLR_VT1_PD_SITE2_UNIT2` writer - needs field desc
pub type TIMING_ERR_CNT_CLR_VT1_PD_SITE2_UNIT2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DELAY_LIMIT_VT1_PD_SITE2_UNIT2` reader - needs field desc
pub type DELAY_LIMIT_VT1_PD_SITE2_UNIT2_R = crate::FieldReader;
///Field `DELAY_LIMIT_VT1_PD_SITE2_UNIT2` writer - needs field desc
pub type DELAY_LIMIT_VT1_PD_SITE2_UNIT2_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DELAY_NUM_O_VT1_PD_SITE2_UNIT2` reader - needs field desc
pub type DELAY_NUM_O_VT1_PD_SITE2_UNIT2_R = crate::FieldReader;
///Field `TIMING_ERR_VT1_PD_SITE2_UNIT2` reader - needs field desc
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE2_UNIT2_VT1_CONF1")
            .field(
                ...
                &self.monitor_en_vt1_pd_site2_unit2(),
            )
            .field(
                "delay_limit_vt1_pd_site2_unit2",
                &self.delay_limit_vt1_pd_site2_unit2(),
            )
            .field(
                "delay_num_o_vt1_pd_site2_unit2",
                &self.delay_num_o_vt1_pd_site2_unit2(),
            )
            .field(
                "timing_err_vt1_pd_site2_unit2",
                &self.timing_err_vt1_pd_site2_unit2(),
            )
            .finish()
    }
}
...
///`read()` method returns [`comb_pd_site2_unit2_vt1_conf1::R`](R) reader structure
impl crate::Readable for COMB_PD_SITE2_UNIT2_VT1_CONF1_SPEC {}
///`write(|w| ..)` method takes [`comb_pd_site2_unit2_vt1_conf1::W`](W) writer structure
