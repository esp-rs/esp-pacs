    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE0_UNIT3_VT2_CONF1")
            .field(
                ...
                &self.monitor_en_vt2_pd_site0_unit3().bit(),
            )
            .field(
                "delay_limit_vt2_pd_site0_unit3",
                &self.delay_limit_vt2_pd_site0_unit3().bits(),
            )
            .field(
                "delay_num_o_vt2_pd_site0_unit3",
                &self.delay_num_o_vt2_pd_site0_unit3().bits(),
            )
            .field(
                "timing_err_vt2_pd_site0_unit3",
                &self.timing_err_vt2_pd_site0_unit3().bit(),
            )
            .finish()
    }
}
