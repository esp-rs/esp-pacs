...
///`read()` method returns [`pmup_drv_cfg::R`](R) reader structure
impl crate::Readable for PMUP_DRV_CFG_SPEC {}
///`write(|w| ..)` method takes [`pmup_drv_cfg::W`](W) writer structure
