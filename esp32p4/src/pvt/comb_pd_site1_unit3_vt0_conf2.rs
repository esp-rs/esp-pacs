    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE1_UNIT3_VT0_CONF2")
            .field(
                ...
                &format_args!("{}", self.monitor_edg_mod_vt0_pd_site1_unit3().bits()),
            )
            .field(
                "delay_ovf_vt0_pd_site1_unit3",
                &format_args!("{}", self.delay_ovf_vt0_pd_site1_unit3().bit()),
            )
            .field(
                "timing_err_cnt_o_vt0_pd_site1_unit3",
                &format_args!("{}", self.timing_err_cnt_o_vt0_pd_site1_unit3().bits()),
            )
            .finish()
    }
}
