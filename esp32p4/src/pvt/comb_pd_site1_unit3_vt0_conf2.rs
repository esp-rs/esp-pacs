///Register `COMB_PD_SITE1_UNIT3_VT0_CONF2` reader
pub type R = crate::R<COMB_PD_SITE1_UNIT3_VT0_CONF2_SPEC>;
///Register `COMB_PD_SITE1_UNIT3_VT0_CONF2` writer
pub type W = crate::W<COMB_PD_SITE1_UNIT3_VT0_CONF2_SPEC>;
///Field `MONITOR_EDG_MOD_VT0_PD_SITE1_UNIT3` reader - needs field desc
pub type MONITOR_EDG_MOD_VT0_PD_SITE1_UNIT3_R = crate::FieldReader;
///Field `MONITOR_EDG_MOD_VT0_PD_SITE1_UNIT3` writer - needs field desc
pub type MONITOR_EDG_MOD_VT0_PD_SITE1_UNIT3_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DELAY_OVF_VT0_PD_SITE1_UNIT3` reader - needs field desc
pub type DELAY_OVF_VT0_PD_SITE1_UNIT3_R = crate::BitReader;
///Field `TIMING_ERR_CNT_O_VT0_PD_SITE1_UNIT3` reader - needs field desc
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE1_UNIT3_VT0_CONF2")
            .field(
                ...
                &self.monitor_edg_mod_vt0_pd_site1_unit3(),
            )
            .field(
                "delay_ovf_vt0_pd_site1_unit3",
                &self.delay_ovf_vt0_pd_site1_unit3(),
            )
            .field(
                "timing_err_cnt_o_vt0_pd_site1_unit3",
                &self.timing_err_cnt_o_vt0_pd_site1_unit3(),
            )
            .finish()
    }
}
...
///`read()` method returns [`comb_pd_site1_unit3_vt0_conf2::R`](R) reader structure
impl crate::Readable for COMB_PD_SITE1_UNIT3_VT0_CONF2_SPEC {}
///`write(|w| ..)` method takes [`comb_pd_site1_unit3_vt0_conf2::W`](W) writer structure
