...
#[doc = "Register `COMB_PD_SITE1_UNIT2_VT0_CONF1` writer"]
...
#[doc = "Field `MONITOR_EN_VT0_PD_SITE1_UNIT2` writer - needs field desc"]
pub type MONITOR_EN_VT0_PD_SITE1_UNIT2_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIMING_ERR_CNT_CLR_VT0_PD_SITE1_UNIT2` writer - needs field desc"]
...
#[doc = "Field `DELAY_LIMIT_VT0_PD_SITE1_UNIT2` writer - needs field desc"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE1_UNIT2_VT0_CONF1")
            .field(
                ...
                &format_args!("{}", self.monitor_en_vt0_pd_site1_unit2().bit()),
            )
            .field(
                "delay_limit_vt0_pd_site1_unit2",
                &format_args!("{}", self.delay_limit_vt0_pd_site1_unit2().bits()),
            )
            .field(
                "delay_num_o_vt0_pd_site1_unit2",
                &format_args!("{}", self.delay_num_o_vt0_pd_site1_unit2().bits()),
            )
            .field(
                "timing_err_vt0_pd_site1_unit2",
                &format_args!("{}", self.timing_err_vt0_pd_site1_unit2().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<COMB_PD_SITE1_UNIT2_VT0_CONF1_SPEC> {
...
#[doc = "`write(|w| ..)` method takes [`comb_pd_site1_unit2_vt0_conf1::W`](W) writer structure"]
