    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE1_UNIT2_VT0_CONF1")
            .field(
                ...
                &self.monitor_en_vt0_pd_site1_unit2().bit(),
            )
            .field(
                "delay_limit_vt0_pd_site1_unit2",
                &self.delay_limit_vt0_pd_site1_unit2().bits(),
            )
            .field(
                "delay_num_o_vt0_pd_site1_unit2",
                &self.delay_num_o_vt0_pd_site1_unit2().bits(),
            )
            .field(
                "timing_err_vt0_pd_site1_unit2",
                &self.timing_err_vt0_pd_site1_unit2().bit(),
            )
            .finish()
    }
}
