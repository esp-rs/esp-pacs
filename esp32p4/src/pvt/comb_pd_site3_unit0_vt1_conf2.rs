#[doc = "Register `COMB_PD_SITE3_UNIT0_VT1_CONF2` reader"]
pub type R = crate::R<COMB_PD_SITE3_UNIT0_VT1_CONF2_SPEC>;
#[doc = "Register `COMB_PD_SITE3_UNIT0_VT1_CONF2` writer"]
pub type W = crate::W<COMB_PD_SITE3_UNIT0_VT1_CONF2_SPEC>;
#[doc = "Field `MONITOR_EDG_MOD_VT1_PD_SITE3_UNIT0` reader - needs field desc"]
pub type MONITOR_EDG_MOD_VT1_PD_SITE3_UNIT0_R = crate::FieldReader;
#[doc = "Field `MONITOR_EDG_MOD_VT1_PD_SITE3_UNIT0` writer - needs field desc"]
pub type MONITOR_EDG_MOD_VT1_PD_SITE3_UNIT0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `DELAY_OVF_VT1_PD_SITE3_UNIT0` reader - needs field desc"]
pub type DELAY_OVF_VT1_PD_SITE3_UNIT0_R = crate::BitReader;
#[doc = "Field `TIMING_ERR_CNT_O_VT1_PD_SITE3_UNIT0` reader - needs field desc"]
pub type TIMING_ERR_CNT_O_VT1_PD_SITE3_UNIT0_R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:1 - needs field desc"]
    #[inline(always)]
    pub fn monitor_edg_mod_vt1_pd_site3_unit0(&self) -> MONITOR_EDG_MOD_VT1_PD_SITE3_UNIT0_R {
    ...
    #[inline(always)]
    pub fn timing_err_cnt_o_vt1_pd_site3_unit0(&self) -> TIMING_ERR_CNT_O_VT1_PD_SITE3_UNIT0_R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE3_UNIT0_VT1_CONF2")
            .field(
                ...
                &format_args!("{}", self.monitor_edg_mod_vt1_pd_site3_unit0().bits()),
            )
            .field(
                "delay_ovf_vt1_pd_site3_unit0",
                &format_args!("{}", self.delay_ovf_vt1_pd_site3_unit0().bit()),
            )
            .field(
                "timing_err_cnt_o_vt1_pd_site3_unit0",
                &format_args!("{}", self.timing_err_cnt_o_vt1_pd_site3_unit0().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<COMB_PD_SITE3_UNIT0_VT1_CONF2_SPEC> {
...
#[doc = "`read()` method returns [`comb_pd_site3_unit0_vt1_conf2::R`](R) reader structure"]
impl crate::Readable for COMB_PD_SITE3_UNIT0_VT1_CONF2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`comb_pd_site3_unit0_vt1_conf2::W`](W) writer structure"]
impl crate::Writable for COMB_PD_SITE3_UNIT0_VT1_CONF2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets COMB_PD_SITE3_UNIT0_VT1_CONF2 to value 0"]
