///Register `DBIAS_CHANNEL_SEL1` reader
pub type R = crate::R<DBIAS_CHANNEL_SEL1_SPEC>;
///Register `DBIAS_CHANNEL_SEL1` writer
pub type W = crate::W<DBIAS_CHANNEL_SEL1_SPEC>;
///Field `DBIAS_CHANNEL4_SEL` reader - needs field desc
pub type DBIAS_CHANNEL4_SEL_R = crate::FieldReader;
///Field `DBIAS_CHANNEL4_SEL` writer - needs field desc
...
///`read()` method returns [`dbias_channel_sel1::R`](R) reader structure
impl crate::Readable for DBIAS_CHANNEL_SEL1_SPEC {}
///`write(|w| ..)` method takes [`dbias_channel_sel1::W`](W) writer structure
