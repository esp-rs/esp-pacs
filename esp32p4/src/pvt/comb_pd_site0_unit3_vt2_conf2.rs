///Register `COMB_PD_SITE0_UNIT3_VT2_CONF2` reader
pub type R = crate::R<COMB_PD_SITE0_UNIT3_VT2_CONF2_SPEC>;
///Register `COMB_PD_SITE0_UNIT3_VT2_CONF2` writer
pub type W = crate::W<COMB_PD_SITE0_UNIT3_VT2_CONF2_SPEC>;
///Field `MONITOR_EDG_MOD_VT2_PD_SITE0_UNIT3` reader - needs field desc
pub type MONITOR_EDG_MOD_VT2_PD_SITE0_UNIT3_R = crate::FieldReader;
///Field `MONITOR_EDG_MOD_VT2_PD_SITE0_UNIT3` writer - needs field desc
pub type MONITOR_EDG_MOD_VT2_PD_SITE0_UNIT3_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DELAY_OVF_VT2_PD_SITE0_UNIT3` reader - needs field desc
pub type DELAY_OVF_VT2_PD_SITE0_UNIT3_R = crate::BitReader;
///Field `TIMING_ERR_CNT_O_VT2_PD_SITE0_UNIT3` reader - needs field desc
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn monitor_edg_mod_vt2_pd_site0_unit3(
        &mut self,
    ) -> MONITOR_EDG_MOD_VT2_PD_SITE0_UNIT3_W<COMB_PD_SITE0_UNIT3_VT2_CONF2_SPEC> {
        MONITOR_EDG_MOD_VT2_PD_SITE0_UNIT3_W::new(self, 0)
    }
}
/**needs desc
...
///`read()` method returns [`comb_pd_site0_unit3_vt2_conf2::R`](R) reader structure
impl crate::Readable for COMB_PD_SITE0_UNIT3_VT2_CONF2_SPEC {}
///`write(|w| ..)` method takes [`comb_pd_site0_unit3_vt2_conf2::W`](W) writer structure
impl crate::Writable for COMB_PD_SITE0_UNIT3_VT2_CONF2_SPEC {
