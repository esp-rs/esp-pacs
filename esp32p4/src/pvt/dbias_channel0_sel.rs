///Register `DBIAS_CHANNEL0_SEL` reader
pub type R = crate::R<DBIAS_CHANNEL0_SEL_SPEC>;
///Register `DBIAS_CHANNEL0_SEL` writer
pub type W = crate::W<DBIAS_CHANNEL0_SEL_SPEC>;
///Field `DBIAS_CHANNEL0_CFG` reader - needs field desc
pub type DBIAS_CHANNEL0_CFG_R = crate::FieldReader<u32>;
///Field `DBIAS_CHANNEL0_CFG` writer - needs field desc
...
///`read()` method returns [`dbias_channel0_sel::R`](R) reader structure
impl crate::Readable for DBIAS_CHANNEL0_SEL_SPEC {}
///`write(|w| ..)` method takes [`dbias_channel0_sel::W`](W) writer structure
