...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `DOUT0_MODE` field.</div>"]
    #[inline(always)]
    pub fn dout_mode(&mut self, n: u8) -> DOUT_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[doc = "Bit 0 - DOUT0_MODE"]
    #[inline(always)]
    pub fn dout0_mode(&mut self) -> DOUT_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
        DOUT_MODE_W::new(self, 0)
    }
    #[doc = "Bit 1 - DOUT1_MODE"]
    #[inline(always)]
    pub fn dout1_mode(&mut self) -> DOUT_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
        DOUT_MODE_W::new(self, 1)
    }
    #[doc = "Bit 2 - DOUT2_MODE"]
    #[inline(always)]
    pub fn dout2_mode(&mut self) -> DOUT_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
        DOUT_MODE_W::new(self, 2)
    }
    #[doc = "Bit 3 - DOUT3_MODE"]
    #[inline(always)]
    pub fn dout3_mode(&mut self) -> DOUT_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
        DOUT_MODE_W::new(self, 3)
    }
    #[doc = "Bit 4 - DOUT4_MODE"]
    #[inline(always)]
    pub fn dout4_mode(&mut self) -> DOUT_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
        DOUT_MODE_W::new(self, 4)
    }
    #[doc = "Bit 5 - DOUT5_MODE"]
    #[inline(always)]
    pub fn dout5_mode(&mut self) -> DOUT_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
        DOUT_MODE_W::new(self, 5)
    }
    #[doc = "Bit 6 - DOUT6_MODE"]
    #[inline(always)]
    pub fn dout6_mode(&mut self) -> DOUT_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
        DOUT_MODE_W::new(self, 6)
    }
    #[doc = "Bit 7 - DOUT7_MODE"]
    #[inline(always)]
    pub fn dout7_mode(&mut self) -> DOUT_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
        DOUT_MODE_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn douts_mode(&mut self) -> DOUTS_MODE_W<'_, SMEM_DOUT_MODE_SPEC> {
