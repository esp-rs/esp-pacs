...
impl R {
    ...
    pub fn fmem_ecc_addr_en(&self) -> FMEM_ECC_ADDR_EN_R {
        FMEM_ECC_ADDR_EN_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
...
impl W {
    ...
    pub fn fmem_ecc_addr_en(&mut self) -> FMEM_ECC_ADDR_EN_W<'_, ECC_CTRL_SPEC> {
        FMEM_ECC_ADDR_EN_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
