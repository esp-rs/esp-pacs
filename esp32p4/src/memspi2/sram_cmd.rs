...
impl R {
    ...
    pub fn wdummy_dqs_always_out(&self) -> WDUMMY_DQS_ALWAYS_OUT_R {
        WDUMMY_DQS_ALWAYS_OUT_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn wdummy_always_out(&self) -> WDUMMY_ALWAYS_OUT_R {
        WDUMMY_ALWAYS_OUT_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn wdummy_dqs_always_out(&mut self) -> WDUMMY_DQS_ALWAYS_OUT_W<'_, SRAM_CMD_SPEC> {
        WDUMMY_DQS_ALWAYS_OUT_W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn wdummy_always_out(&mut self) -> WDUMMY_ALWAYS_OUT_W<'_, SRAM_CMD_SPEC> {
        WDUMMY_ALWAYS_OUT_W::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    ...
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn dqs_ie_always_on(&mut self) -> DQS_IE_ALWAYS_ON_W<'_, SRAM_CMD_SPEC> {
        DQS_IE_ALWAYS_ON_W::new(self, 30)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn data_ie_always_on(&mut self) -> DATA_IE_ALWAYS_ON_W<'_, SRAM_CMD_SPEC> {
