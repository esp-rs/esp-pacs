...
///Field `SCL_FILTER_THRES` reader - Configures the threshold pulse width to be filtered on SCL. When a pulse on the SCL input has smaller width than this register value, the I2C controller will ignore that pulse. Measurement unit: i2c_sclk
pub type SCL_FILTER_THRES_R = crate::FieldReader;
///Field `SCL_FILTER_THRES` writer - Configures the threshold pulse width to be filtered on SCL. When a pulse on the SCL input has smaller width than this register value, the I2C controller will ignore that pulse. Measurement unit: i2c_sclk
pub type SCL_FILTER_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SDA_FILTER_THRES` reader - Configures the threshold pulse width to be filtered on SDA. When a pulse on the SDA input has smaller width than this register value, the I2C controller will ignore that pulse. Measurement unit: i2c_sclk
pub type SDA_FILTER_THRES_R = crate::FieldReader;
///Field `SDA_FILTER_THRES` writer - Configures the threshold pulse width to be filtered on SDA. When a pulse on the SDA input has smaller width than this register value, the I2C controller will ignore that pulse. Measurement unit: i2c_sclk
pub type SDA_FILTER_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SCL_FILTER_EN` reader - Configures to enable the filter function for SCL.
pub type SCL_FILTER_EN_R = crate::BitReader;
///Field `SCL_FILTER_EN` writer - Configures to enable the filter function for SCL.
pub type SCL_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDA_FILTER_EN` reader - Configures to enable the filter function for SDA.
pub type SDA_FILTER_EN_R = crate::BitReader;
///Field `SDA_FILTER_EN` writer - Configures to enable the filter function for SDA.
pub type SDA_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:3 - Configures the threshold pulse width to be filtered on SCL. When a pulse on the SCL input has smaller width than this register value, the I2C controller will ignore that pulse. Measurement unit: i2c_sclk
    #[inline(always)]
    pub fn scl_filter_thres(&self) -> SCL_FILTER_THRES_R {
        SCL_FILTER_THRES_R::new((self.bits & 0x0f) as u8)
    }
    ///Bits 4:7 - Configures the threshold pulse width to be filtered on SDA. When a pulse on the SDA input has smaller width than this register value, the I2C controller will ignore that pulse. Measurement unit: i2c_sclk
    #[inline(always)]
    pub fn sda_filter_thres(&self) -> SDA_FILTER_THRES_R {
        SDA_FILTER_THRES_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
    ///Bit 8 - Configures to enable the filter function for SCL.
    #[inline(always)]
    pub fn scl_filter_en(&self) -> SCL_FILTER_EN_R {
        SCL_FILTER_EN_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Configures to enable the filter function for SDA.
    #[inline(always)]
