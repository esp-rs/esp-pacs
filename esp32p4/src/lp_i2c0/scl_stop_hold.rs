...
///Field `TIME` reader - Configures the delay after the STOP condition. Measurement unit: i2c_sclk
pub type TIME_R = crate::FieldReader<u16>;
///Field `TIME` writer - Configures the delay after the STOP condition. Measurement unit: i2c_sclk
pub type TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ///Bits 0:8 - Configures the delay after the STOP condition. Measurement unit: i2c_sclk
    #[inline(always)]
