///Register `SCL_MAIN_ST_TIME_OUT` reader
pub type R = crate::R<SCL_MAIN_ST_TIME_OUT_SPEC>;
///Register `SCL_MAIN_ST_TIME_OUT` writer
pub type W = crate::W<SCL_MAIN_ST_TIME_OUT_SPEC>;
///Field `SCL_MAIN_ST_TO_I2C` reader - Configures the threshold value of SCL_MAIN_FSM state unchanged period.nIt should be no more than 23. Measurement unit: i2c_sclk
pub type SCL_MAIN_ST_TO_I2C_R = crate::FieldReader;
///Field `SCL_MAIN_ST_TO_I2C` writer - Configures the threshold value of SCL_MAIN_FSM state unchanged period.nIt should be no more than 23. Measurement unit: i2c_sclk
pub type SCL_MAIN_ST_TO_I2C_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - Configures the threshold value of SCL_MAIN_FSM state unchanged period.nIt should be no more than 23. Measurement unit: i2c_sclk
    #[inline(always)]
...
///`read()` method returns [`scl_main_st_time_out::R`](R) reader structure
impl crate::Readable for SCL_MAIN_ST_TIME_OUT_SPEC {}
///`write(|w| ..)` method takes [`scl_main_st_time_out::W`](W) writer structure
