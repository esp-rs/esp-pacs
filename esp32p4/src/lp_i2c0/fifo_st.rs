...
impl R {
    ///Bits 0:3 - Represents the offset address of the APB reading from RXFIFO
    #[inline(always)]
    pub fn rxfifo_raddr(&self) -> RXFIFO_RADDR_R {
        RXFIFO_RADDR_R::new((self.bits & 0x0f) as u8)
    }
    ///Bits 5:8 - Represents the offset address of i2c module receiving data and writing to RXFIFO.
    #[inline(always)]
    pub fn rxfifo_waddr(&self) -> RXFIFO_WADDR_R {
        RXFIFO_WADDR_R::new(((self.bits >> 5) & 0x0f) as u8)
    }
    ///Bits 10:13 - Represents the offset address of i2c module reading from TXFIFO.
    #[inline(always)]
    pub fn txfifo_raddr(&self) -> TXFIFO_RADDR_R {
        TXFIFO_RADDR_R::new(((self.bits >> 10) & 0x0f) as u8)
    }
    ///Bits 15:18 - Represents the offset address of APB bus writing to TXFIFO.
    #[inline(always)]
