...
///Field `TIME` reader - Configures the time to hold the data after the falling edge of SCL. Measurement unit: i2c_sclk
pub type TIME_R = crate::FieldReader<u16>;
///Field `TIME` writer - Configures the time to hold the data after the falling edge of SCL. Measurement unit: i2c_sclk
pub type TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ///Bits 0:8 - Configures the time to hold the data after the falling edge of SCL. Measurement unit: i2c_sclk
    #[inline(always)]
