...
///Field `LP_AONCLKRST_HPCORE0_RESET_CAUSE_CLR` writer - need_des
...
///Field `LP_AONCLKRST_HPCORE1_RESET_CAUSE_CLR` writer - need_des
...
impl R {
    ///Bits 0:5 - 6'h1: POR reset 6'h9: PMU LP PERI power down reset 6'ha: PMU LP CPU reset 6'hf: brown out reset 6'h10: LP watchdog chip reset 6'h12: super watch dog reset 6'h13: glitch reset 6'h14: software reset
    #[inline(always)]
    ...
    ///Bit 25 - 1'b0: enable lpcore pmu_lp_cpu_reset reset_cause, 1'b1: disable lpcore pmu_lp_cpu_reset reset_cause
    #[inline(always)]
...
///`read()` method returns [`lp_aonclkrst_reset_cause::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_RESET_CAUSE_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_reset_cause::W`](W) writer structure
