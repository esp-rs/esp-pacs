///Register `LP_AONCLKRST_RC32K_CNTL` reader
pub type R = crate::R<LP_AONCLKRST_RC32K_CNTL_SPEC>;
///Register `LP_AONCLKRST_RC32K_CNTL` writer
pub type W = crate::W<LP_AONCLKRST_RC32K_CNTL_SPEC>;
///Field `LP_AONCLKRST_RC32K_DFREQ` reader - need_des
pub type LP_AONCLKRST_RC32K_DFREQ_R = crate::FieldReader<u32>;
///Field `LP_AONCLKRST_RC32K_DFREQ` writer - need_des
...
///`read()` method returns [`lp_aonclkrst_rc32k_cntl::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_RC32K_CNTL_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_rc32k_cntl::W`](W) writer structure
