...
///`read()` method returns [`lp_aonclkrst_hp_sdmmc_emac_rst_ctrl::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_HP_SDMMC_EMAC_RST_CTRL_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_hp_sdmmc_emac_rst_ctrl::W`](W) writer structure
