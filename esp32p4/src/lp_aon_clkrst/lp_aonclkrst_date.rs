///Register `LP_AONCLKRST_DATE` reader
pub type R = crate::R<LP_AONCLKRST_DATE_SPEC>;
///Register `LP_AONCLKRST_DATE` writer
pub type W = crate::W<LP_AONCLKRST_DATE_SPEC>;
///Field `LP_AONCLKRST_CLK_EN` reader - need_des
pub type LP_AONCLKRST_CLK_EN_R = crate::BitReader;
///Field `LP_AONCLKRST_CLK_EN` writer - need_des
...
///`read()` method returns [`lp_aonclkrst_date::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_DATE_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_date::W`](W) writer structure
