...
///`read()` method returns [`lp_aonclkrst_xtal32k::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_XTAL32K_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_xtal32k::W`](W) writer structure
