#[doc = "Register `LP_AONCLKRST_HPSYS_APM_RESET_BYPASS` reader"]
pub type R = crate::R<LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_SPEC>;
#[doc = "Register `LP_AONCLKRST_HPSYS_APM_RESET_BYPASS` writer"]
pub type W = crate::W<LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_SPEC>;
#[doc = "Field `LP_AONCLKRST_HPSYS_APM_RESET_BYPASS` reader - reserved"]
pub type LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_R = crate::FieldReader<u32>;
#[doc = "Field `LP_AONCLKRST_HPSYS_APM_RESET_BYPASS` writer - reserved"]
pub type LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - reserved"]
    #[inline(always)]
    pub fn lp_aonclkrst_hpsys_apm_reset_bypass(&self) -> LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_R {
...
impl W {
    ...
    pub fn lp_aonclkrst_hpsys_apm_reset_bypass(
        &mut self,
    ) -> LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_W<'_, LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_SPEC> {
        LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_W::new(self, 0)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`lp_aonclkrst_hpsys_apm_reset_bypass::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lp_aonclkrst_hpsys_apm_reset_bypass::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_SPEC;
impl crate::RegisterSpec for LP_AONCLKRST_HPSYS_APM_RESET_BYPASS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lp_aonclkrst_hpsys_apm_reset_bypass::R`](R) reader structure"]
