///Register `LP_AONCLKRST_HP_USB_CLKRST_CTRL1` reader
pub type R = crate::R<LP_AONCLKRST_HP_USB_CLKRST_CTRL1_SPEC>;
///Register `LP_AONCLKRST_HP_USB_CLKRST_CTRL1` writer
pub type W = crate::W<LP_AONCLKRST_HP_USB_CLKRST_CTRL1_SPEC>;
///Field `LP_AONCLKRST_RST_EN_USB_OTG20_ADP` reader - usb otg20 adp reset en
pub type LP_AONCLKRST_RST_EN_USB_OTG20_ADP_R = crate::BitReader;
///Field `LP_AONCLKRST_RST_EN_USB_OTG20_ADP` writer - usb otg20 adp reset en
pub type LP_AONCLKRST_RST_EN_USB_OTG20_ADP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_RST_EN_USB_OTG20_PHY` reader - usb otg20 phy reset en
pub type LP_AONCLKRST_RST_EN_USB_OTG20_PHY_R = crate::BitReader;
///Field `LP_AONCLKRST_RST_EN_USB_OTG20_PHY` writer - usb otg20 phy reset en
pub type LP_AONCLKRST_RST_EN_USB_OTG20_PHY_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_RST_EN_USB_OTG20` reader - usb otg20 reset en
pub type LP_AONCLKRST_RST_EN_USB_OTG20_R = crate::BitReader;
///Field `LP_AONCLKRST_RST_EN_USB_OTG20` writer - usb otg20 reset en
pub type LP_AONCLKRST_RST_EN_USB_OTG20_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_RST_EN_USB_OTG11` reader - usb org11 reset en
pub type LP_AONCLKRST_RST_EN_USB_OTG11_R = crate::BitReader;
///Field `LP_AONCLKRST_RST_EN_USB_OTG11` writer - usb org11 reset en
pub type LP_AONCLKRST_RST_EN_USB_OTG11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_RST_EN_USB_DEVICE` reader - usb device reset en
pub type LP_AONCLKRST_RST_EN_USB_DEVICE_R = crate::BitReader;
///Field `LP_AONCLKRST_RST_EN_USB_DEVICE` writer - usb device reset en
pub type LP_AONCLKRST_RST_EN_USB_DEVICE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_USB_OTG20_PHYREF_CLK_SRC_SEL` reader - usb otg20 hs phy src sel. 2'd0: 12m, 2'd1: 25m, 2'd2: pad_hsphy_refclk.
pub type LP_AONCLKRST_USB_OTG20_PHYREF_CLK_SRC_SEL_R = crate::FieldReader;
///Field `LP_AONCLKRST_USB_OTG20_PHYREF_CLK_SRC_SEL` writer - usb otg20 hs phy src sel. 2'd0: 12m, 2'd1: 25m, 2'd2: pad_hsphy_refclk.
pub type LP_AONCLKRST_USB_OTG20_PHYREF_CLK_SRC_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `LP_AONCLKRST_USB_OTG20_PHYREF_CLK_EN` reader - usb otg20 hs phy refclk enable.
pub type LP_AONCLKRST_USB_OTG20_PHYREF_CLK_EN_R = crate::BitReader;
///Field `LP_AONCLKRST_USB_OTG20_PHYREF_CLK_EN` writer - usb otg20 hs phy refclk enable.
pub type LP_AONCLKRST_USB_OTG20_PHYREF_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_USB_OTG20_ULPI_CLK_EN` reader - usb otg20 ulpi clock enable.
pub type LP_AONCLKRST_USB_OTG20_ULPI_CLK_EN_R = crate::BitReader;
///Field `LP_AONCLKRST_USB_OTG20_ULPI_CLK_EN` writer - usb otg20 ulpi clock enable.
pub type LP_AONCLKRST_USB_OTG20_ULPI_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - usb otg20 adp reset en
    #[inline(always)]
    ...
    ///Bits 28:29 - usb otg20 hs phy src sel. 2'd0: 12m, 2'd1: 25m, 2'd2: pad_hsphy_refclk.
    #[inline(always)]
    ...
    ///Bit 30 - usb otg20 hs phy refclk enable.
    #[inline(always)]
    ...
    ///Bit 31 - usb otg20 ulpi clock enable.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_AONCLKRST_HP_USB_CLKRST_CTRL1")
            .field(
                ...
                &self.lp_aonclkrst_rst_en_usb_otg20_adp(),
            )
            .field(
                "lp_aonclkrst_rst_en_usb_otg20_phy",
                &self.lp_aonclkrst_rst_en_usb_otg20_phy(),
            )
            .field(
                "lp_aonclkrst_rst_en_usb_otg20",
                &self.lp_aonclkrst_rst_en_usb_otg20(),
            )
            .field(
                "lp_aonclkrst_rst_en_usb_otg11",
                &self.lp_aonclkrst_rst_en_usb_otg11(),
            )
            .field(
                "lp_aonclkrst_rst_en_usb_device",
                &self.lp_aonclkrst_rst_en_usb_device(),
            )
            .field(
                "lp_aonclkrst_usb_otg20_phyref_clk_src_sel",
                &self.lp_aonclkrst_usb_otg20_phyref_clk_src_sel(),
            )
            .field(
                "lp_aonclkrst_usb_otg20_phyref_clk_en",
                &self.lp_aonclkrst_usb_otg20_phyref_clk_en(),
            )
            .field(
                "lp_aonclkrst_usb_otg20_ulpi_clk_en",
                &self.lp_aonclkrst_usb_otg20_ulpi_clk_en(),
            )
            .finish()
    }
}
...
///`read()` method returns [`lp_aonclkrst_hp_usb_clkrst_ctrl1::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_HP_USB_CLKRST_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_hp_usb_clkrst_ctrl1::W`](W) writer structure
