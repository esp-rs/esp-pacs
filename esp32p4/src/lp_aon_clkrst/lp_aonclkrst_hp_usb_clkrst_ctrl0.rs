///Register `LP_AONCLKRST_HP_USB_CLKRST_CTRL0` reader
pub type R = crate::R<LP_AONCLKRST_HP_USB_CLKRST_CTRL0_SPEC>;
///Register `LP_AONCLKRST_HP_USB_CLKRST_CTRL0` writer
pub type W = crate::W<LP_AONCLKRST_HP_USB_CLKRST_CTRL0_SPEC>;
///Field `LP_AONCLKRST_USB_OTG20_SLEEP_MODE` reader - unused.
pub type LP_AONCLKRST_USB_OTG20_SLEEP_MODE_R = crate::BitReader;
///Field `LP_AONCLKRST_USB_OTG20_SLEEP_MODE` writer - unused.
pub type LP_AONCLKRST_USB_OTG20_SLEEP_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_USB_OTG20_BK_SYS_CLK_EN` reader - unused.
pub type LP_AONCLKRST_USB_OTG20_BK_SYS_CLK_EN_R = crate::BitReader;
///Field `LP_AONCLKRST_USB_OTG20_BK_SYS_CLK_EN` writer - unused.
pub type LP_AONCLKRST_USB_OTG20_BK_SYS_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_USB_OTG11_SLEEP_MODE` reader - unused.
pub type LP_AONCLKRST_USB_OTG11_SLEEP_MODE_R = crate::BitReader;
///Field `LP_AONCLKRST_USB_OTG11_SLEEP_MODE` writer - unused.
pub type LP_AONCLKRST_USB_OTG11_SLEEP_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_USB_OTG11_BK_SYS_CLK_EN` reader - unused.
pub type LP_AONCLKRST_USB_OTG11_BK_SYS_CLK_EN_R = crate::BitReader;
///Field `LP_AONCLKRST_USB_OTG11_BK_SYS_CLK_EN` writer - unused.
pub type LP_AONCLKRST_USB_OTG11_BK_SYS_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_USB_OTG11_48M_CLK_EN` reader - usb otg11 fs phy clock enable.
pub type LP_AONCLKRST_USB_OTG11_48M_CLK_EN_R = crate::BitReader;
///Field `LP_AONCLKRST_USB_OTG11_48M_CLK_EN` writer - usb otg11 fs phy clock enable.
pub type LP_AONCLKRST_USB_OTG11_48M_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_USB_DEVICE_48M_CLK_EN` reader - usb device fs phy clock enable.
pub type LP_AONCLKRST_USB_DEVICE_48M_CLK_EN_R = crate::BitReader;
///Field `LP_AONCLKRST_USB_DEVICE_48M_CLK_EN` writer - usb device fs phy clock enable.
pub type LP_AONCLKRST_USB_DEVICE_48M_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_AONCLKRST_USB_48M_DIV_NUM` reader - usb 480m to 25m divide number.
pub type LP_AONCLKRST_USB_48M_DIV_NUM_R = crate::FieldReader;
///Field `LP_AONCLKRST_USB_48M_DIV_NUM` writer - usb 480m to 25m divide number.
pub type LP_AONCLKRST_USB_48M_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `LP_AONCLKRST_USB_25M_DIV_NUM` reader - usb 500m to 25m divide number.
pub type LP_AONCLKRST_USB_25M_DIV_NUM_R = crate::FieldReader;
///Field `LP_AONCLKRST_USB_25M_DIV_NUM` writer - usb 500m to 25m divide number.
pub type LP_AONCLKRST_USB_25M_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `LP_AONCLKRST_USB_12M_DIV_NUM` reader - usb 480m to 12m divide number.
pub type LP_AONCLKRST_USB_12M_DIV_NUM_R = crate::FieldReader;
///Field `LP_AONCLKRST_USB_12M_DIV_NUM` writer - usb 480m to 12m divide number.
...
impl R {
    ...
    ///Bits 14:21 - usb 500m to 25m divide number.
    #[inline(always)]
    ...
    ///Bits 22:29 - usb 480m to 12m divide number.
    #[inline(always)]
...
///`read()` method returns [`lp_aonclkrst_hp_usb_clkrst_ctrl0::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_HP_USB_CLKRST_CTRL0_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_hp_usb_clkrst_ctrl0::W`](W) writer structure
