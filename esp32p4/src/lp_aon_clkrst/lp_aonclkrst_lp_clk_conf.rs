...
///`read()` method returns [`lp_aonclkrst_lp_clk_conf::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_LP_CLK_CONF_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_lp_clk_conf::W`](W) writer structure
