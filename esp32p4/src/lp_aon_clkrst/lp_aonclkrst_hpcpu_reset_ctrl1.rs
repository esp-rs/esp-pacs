///Register `LP_AONCLKRST_HPCPU_RESET_CTRL1` reader
pub type R = crate::R<LP_AONCLKRST_HPCPU_RESET_CTRL1_SPEC>;
///Register `LP_AONCLKRST_HPCPU_RESET_CTRL1` writer
pub type W = crate::W<LP_AONCLKRST_HPCPU_RESET_CTRL1_SPEC>;
///Field `LP_AONCLKRST_HPCORE0_SW_STALL_CODE` reader - HP core0 software stall when set to 8'h86
pub type LP_AONCLKRST_HPCORE0_SW_STALL_CODE_R = crate::FieldReader;
///Field `LP_AONCLKRST_HPCORE0_SW_STALL_CODE` writer - HP core0 software stall when set to 8'h86
pub type LP_AONCLKRST_HPCORE0_SW_STALL_CODE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `LP_AONCLKRST_HPCORE1_SW_STALL_CODE` reader - HP core1 software stall when set to 8'h86
pub type LP_AONCLKRST_HPCORE1_SW_STALL_CODE_R = crate::FieldReader;
///Field `LP_AONCLKRST_HPCORE1_SW_STALL_CODE` writer - HP core1 software stall when set to 8'h86
...
///`read()` method returns [`lp_aonclkrst_hpcpu_reset_ctrl1::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_HPCPU_RESET_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_hpcpu_reset_ctrl1::W`](W) writer structure
