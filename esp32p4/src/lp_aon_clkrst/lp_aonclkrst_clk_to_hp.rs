...
///`read()` method returns [`lp_aonclkrst_clk_to_hp::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_CLK_TO_HP_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_clk_to_hp::W`](W) writer structure
