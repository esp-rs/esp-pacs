///Register `LP_AONCLKRST_FOSC_CNTL` reader
pub type R = crate::R<LP_AONCLKRST_FOSC_CNTL_SPEC>;
///Register `LP_AONCLKRST_FOSC_CNTL` writer
pub type W = crate::W<LP_AONCLKRST_FOSC_CNTL_SPEC>;
///Field `LP_AONCLKRST_FOSC_DFREQ` reader - need_des
pub type LP_AONCLKRST_FOSC_DFREQ_R = crate::FieldReader<u16>;
///Field `LP_AONCLKRST_FOSC_DFREQ` writer - need_des
...
impl W {
    ...
    pub fn lp_aonclkrst_fosc_dfreq(
        &mut self,
    ) -> LP_AONCLKRST_FOSC_DFREQ_W<LP_AONCLKRST_FOSC_CNTL_SPEC> {
...
///`read()` method returns [`lp_aonclkrst_fosc_cntl::R`](R) reader structure
impl crate::Readable for LP_AONCLKRST_FOSC_CNTL_SPEC {}
///`write(|w| ..)` method takes [`lp_aonclkrst_fosc_cntl::W`](W) writer structure
