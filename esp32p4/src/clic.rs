...
impl RegisterBlock {
    #[doc = "0x00 - CLIC interrupt configuration register."]
    #[inline(always)]
    pub const fn int_config(&self) -> &INT_CONFIG {
        &self.int_config
    }
    #[doc = "0x04 - CLIC interrupt information register."]
    #[inline(always)]
    pub const fn int_info(&self) -> &INT_INFO {
        &self.int_info
    }
    #[doc = "0x08 - CLIC interrupt threshold register."]
    #[inline(always)]
    pub const fn int_thresh(&self) -> &INT_THRESH {
        &self.int_thresh
    }
    #[doc = "0x1000..0x10c0 - Interrupt control register for source %s."]
    #[inline(always)]
