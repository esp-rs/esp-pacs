...
/**I2C0_CTRL (rw) register accessor: need des
...
///need des
pub mod i2c0_ctrl;
/**I2C1_CTRL (rw) register accessor: need des
...
///need des
pub mod i2c1_ctrl;
/**I2C0_CONF (rw) register accessor: need des
...
///need des
pub mod i2c0_conf;
/**I2C1_CONF (rw) register accessor: need des
...
///need des
pub mod i2c1_conf;
/**I2C_BURST_CONF (rw) register accessor: need des
...
/**I2C_BURST_STATUS (rw) register accessor: need des
...
/**ANA_CONF0 (rw) register accessor: need des
...
///need des
pub mod ana_conf0;
/**ANA_CONF1 (rw) register accessor: need des
...
///need des
pub mod ana_conf1;
/**ANA_CONF2 (rw) register accessor: need des
...
///need des
pub mod ana_conf2;
/**I2C0_CTRL1 (rw) register accessor: need des
...
///need des
pub mod i2c0_ctrl1;
/**I2C1_CTRL1 (rw) register accessor: need des
...
///need des
pub mod i2c1_ctrl1;
/**HW_I2C_CTRL (rw) register accessor: need des
...
///need des
pub mod hw_i2c_ctrl;
/**NOUSE (rw) register accessor: need des
...
///need des
pub mod nouse;
/**CLK160M (rw) register accessor: need des
