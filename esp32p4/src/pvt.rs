...
/**PMUP_BITMAP_HIGH0 (rw) register accessor: select valid pvt channel
...
/**PMUP_BITMAP_HIGH1 (rw) register accessor: select valid pvt channel
...
/**PMUP_BITMAP_HIGH2 (rw) register accessor: select valid pvt channel
...
/**PMUP_BITMAP_HIGH3 (rw) register accessor: select valid pvt channel
...
/**PMUP_BITMAP_HIGH4 (rw) register accessor: select valid pvt channel
...
/**PMUP_BITMAP_LOW0 (rw) register accessor: select valid pvt channel
...
/**PMUP_BITMAP_LOW1 (rw) register accessor: select valid pvt channel
...
/**PMUP_BITMAP_LOW2 (rw) register accessor: select valid pvt channel
...
/**PMUP_BITMAP_LOW3 (rw) register accessor: select valid pvt channel
...
/**PMUP_BITMAP_LOW4 (rw) register accessor: select valid pvt channel
...
/**PMUP_DRV_CFG (rw) register accessor: configure pump drv
...
/**PMUP_CHANNEL_CFG (rw) register accessor: configure the code of valid pump channel code
...
/**CLK_CFG (rw) register accessor: configure pvt clk
...
///configure pvt clk
pub mod clk_cfg;
/**DBIAS_CHANNEL_SEL0 (rw) register accessor: needs desc
...
/**DBIAS_CHANNEL_SEL1 (rw) register accessor: needs desc
...
/**DBIAS_CHANNEL0_SEL (rw) register accessor: needs desc
...
/**DBIAS_CHANNEL1_SEL (rw) register accessor: needs desc
...
/**DBIAS_CHANNEL2_SEL (rw) register accessor: needs desc
...
/**DBIAS_CHANNEL3_SEL (rw) register accessor: needs desc
...
/**DBIAS_CHANNEL4_SEL (rw) register accessor: needs desc
...
/**DBIAS_CMD0 (rw) register accessor: needs desc
...
///needs desc
pub mod dbias_cmd0;
/**DBIAS_CMD1 (rw) register accessor: needs desc
...
///needs desc
pub mod dbias_cmd1;
/**DBIAS_CMD2 (rw) register accessor: needs desc
...
///needs desc
pub mod dbias_cmd2;
/**DBIAS_CMD3 (rw) register accessor: needs desc
...
///needs desc
pub mod dbias_cmd3;
/**DBIAS_CMD4 (rw) register accessor: needs desc
...
///needs desc
pub mod dbias_cmd4;
/**DBIAS_TIMER (rw) register accessor: needs desc
...
///needs desc
pub mod dbias_timer;
/**COMB_PD_SITE0_UNIT0_VT0_CONF1 (rw) register accessor: needs desc
