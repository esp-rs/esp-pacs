...
///Field `SINGLE_DATA` reader - The configured constant channel data to be sent out.
pub type SINGLE_DATA_R = crate::FieldReader<u32>;
///Field `SINGLE_DATA` writer - The configured constant channel data to be sent out.
pub type SINGLE_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - The configured constant channel data to be sent out.
    #[inline(always)]
