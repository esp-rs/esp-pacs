///Register `FIFO_CNT` reader
pub type R = crate::R<FIFO_CNT_SPEC>;
///Register `FIFO_CNT` writer
pub type W = crate::W<FIFO_CNT_SPEC>;
///Field `TX_FIFO_CNT` reader - tx fifo counter value.
pub type TX_FIFO_CNT_R = crate::FieldReader<u32>;
///Field `TX_FIFO_CNT_RST` writer - Set this bit to reset tx fifo counter.
pub type TX_FIFO_CNT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:30 - tx fifo counter value.
    #[inline(always)]
...
impl W {
    ///Bit 31 - Set this bit to reset tx fifo counter.
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`fifo_cnt::R`](R) reader structure
impl crate::Readable for FIFO_CNT_SPEC {}
///`write(|w| ..)` method takes [`fifo_cnt::W`](W) writer structure
