///Register `RX_PDM2PCM_CONF` reader
pub type R = crate::R<RX_PDM2PCM_CONF_SPEC>;
///Register `RX_PDM2PCM_CONF` writer
pub type W = crate::W<RX_PDM2PCM_CONF_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_PDM2PCM_CONF")
...
pub struct RX_PDM2PCM_CONF_SPEC;
impl crate::RegisterSpec for RX_PDM2PCM_CONF_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rx_pdm2pcm_conf::R`](R) reader structure
impl crate::Readable for RX_PDM2PCM_CONF_SPEC {}
///`write(|w| ..)` method takes [`rx_pdm2pcm_conf::W`](W) writer structure
