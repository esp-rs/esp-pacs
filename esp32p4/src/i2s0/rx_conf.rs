...
impl R {
    ...
    ///Bits 4:5 - 0 : I2S Rx only stop when reg_rx_start is cleared. 1: Stop when reg_rx_start is 0 or in_suc_eof is 1. 2: Stop I2S RX when reg_rx_start is 0 or RX FIFO is full.
    #[inline(always)]
    pub fn rx_stop_mode(&self) -> RX_STOP_MODE_R {
        RX_STOP_MODE_R::new(((self.bits >> 4) & 3) as u8)
    }
    ///Bit 6 - Set this bit to enable receiver in mono mode
    #[inline(always)]
    ...
    ///Bit 13 - Set this bit to enable receiver in Phillips standard mode
    #[inline(always)]
    ...
    ///Bits 21:26 - Bit clock configuration bits in receiver mode.
    #[inline(always)]
...
impl crate::Resettable for RX_CONF_SPEC {
    const RESET_VALUE: u32 = 0x00c0_b600;
}
