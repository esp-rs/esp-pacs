...
impl R {
    #[doc = "Bits 8:12 - Indicates the cycle number of reading Rx FIFO."]
    #[inline(always)]
...
#[doc = "Parallel IO RX status register0\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_st0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
