...
#[doc = "Field `TX_FIFO_REMPTY` writer - Write 1 to clear TX_FIFO_REMPTY_INT."]
pub type TX_FIFO_REMPTY_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `RX_FIFO_WOVF` writer - Write 1 to clear RX_FIFO_WOVF_INT."]
pub type RX_FIFO_WOVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `TX_EOF` writer - Write 1 to clear TX_EOF_INT."]
