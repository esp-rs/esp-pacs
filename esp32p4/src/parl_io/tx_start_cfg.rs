///Register `TX_START_CFG` reader
pub type R = crate::R<TX_START_CFG_SPEC>;
///Register `TX_START_CFG` writer
pub type W = crate::W<TX_START_CFG_SPEC>;
///Field `TX_START` reader - Set this bit to start tx data transmit.
pub type TX_START_R = crate::BitReader;
///Field `TX_START` writer - Set this bit to start tx data transmit.
pub type TX_START_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 31 - Set this bit to start tx data transmit.
    #[inline(always)]
...
///`read()` method returns [`tx_start_cfg::R`](R) reader structure
impl crate::Readable for TX_START_CFG_SPEC {}
///`write(|w| ..)` method takes [`tx_start_cfg::W`](W) writer structure
