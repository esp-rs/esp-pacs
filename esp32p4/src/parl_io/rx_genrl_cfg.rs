...
impl W {
    #[doc = "Bit 12 - Set this bit to enable the clock gating of output rx clock."]
    #[inline(always)]
    pub fn rx_gating_en(&mut self) -> RX_GATING_EN_W<'_, RX_GENRL_CFG_SPEC> {
        RX_GATING_EN_W::new(self, 12)
    }
    #[doc = "Bits 13:28 - Configures threshold of timeout counter."]
    #[inline(always)]
    pub fn rx_timeout_thres(&mut self) -> RX_TIMEOUT_THRES_W<'_, RX_GENRL_CFG_SPEC> {
        RX_TIMEOUT_THRES_W::new(self, 13)
    }
    #[doc = "Bit 29 - Set this bit to enable timeout function to generate error eof."]
    #[inline(always)]
    pub fn rx_timeout_en(&mut self) -> RX_TIMEOUT_EN_W<'_, RX_GENRL_CFG_SPEC> {
        RX_TIMEOUT_EN_W::new(self, 29)
    }
    #[doc = "Bit 30 - Configures the DMA eof generated mechanism. 1'b0: eof generated by data bit length. 1'b1: eof generated by external enable signal."]
    #[inline(always)]
    pub fn rx_eof_gen_sel(&mut self) -> RX_EOF_GEN_SEL_W<'_, RX_GENRL_CFG_SPEC> {
