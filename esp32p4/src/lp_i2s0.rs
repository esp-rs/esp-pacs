...
/**VAD_CONF (rw) register accessor: I2S VAD Configure register
...
pub mod vad_conf;
/**VAD_RESULT (r) register accessor: I2S VAD Result register
...
pub mod vad_result;
/**RX_MEM_CONF (rw) register accessor: I2S VAD Observe register
...
pub mod rx_mem_conf;
/**INT_RAW (r) register accessor: I2S interrupt raw register, valid in level.
...
pub mod int_raw;
/**INT_ST (r) register accessor: I2S interrupt status register.
...
pub mod int_st;
/**INT_ENA (rw) register accessor: I2S interrupt enable register.
...
pub mod int_ena;
/**INT_CLR (w) register accessor: I2S interrupt clear register.
...
pub mod rx_conf1;
/**RX_TDM_CTRL (rw) register accessor: I2S TX TDM mode control register
...
pub mod rx_tdm_ctrl;
/**RX_TIMING (rw) register accessor: I2S RX timing control register
...
pub mod rx_timing;
/**LC_HUNG_CONF (rw) register accessor: I2S HUNG configure register.
...
/**RXEOF_NUM (rw) register accessor: I2S RX data number control register.
...
pub mod rxeof_num;
/**CONF_SIGLE_DATA (rw) register accessor: I2S signal data register
...
/**RX_PDM_CONF (rw) register accessor: I2S RX configure register
...
///I2S RX configure register
pub mod rx_pdm_conf;
/**ECO_LOW (rw) register accessor: I2S ECO register
...
///I2S ECO register
pub mod eco_low;
/**ECO_HIGH (rw) register accessor: I2S ECO register
...
///I2S ECO register
pub mod eco_high;
/**ECO_CONF (rw) register accessor: I2S ECO register
...
///I2S ECO register
pub mod eco_conf;
/**VAD_PARAM0 (rw) register accessor: I2S VAD Parameter register
...
pub mod vad_param0;
/**VAD_PARAM1 (rw) register accessor: I2S VAD Parameter register
...
///I2S VAD Parameter register
pub mod vad_param1;
/**VAD_PARAM2 (rw) register accessor: I2S VAD Parameter register
...
///I2S VAD Parameter register
pub mod vad_param2;
/**VAD_PARAM3 (rw) register accessor: I2S VAD Parameter register
...
///I2S VAD Parameter register
pub mod vad_param3;
/**VAD_PARAM4 (rw) register accessor: I2S VAD Parameter register
...
///I2S VAD Parameter register
pub mod vad_param4;
/**VAD_PARAM5 (rw) register accessor: I2S VAD Parameter register
...
///I2S VAD Parameter register
pub mod vad_param5;
/**VAD_PARAM6 (rw) register accessor: I2S VAD Parameter register
...
///I2S VAD Parameter register
pub mod vad_param6;
/**VAD_PARAM7 (rw) register accessor: I2S VAD Parameter register
...
///I2S VAD Parameter register
pub mod vad_param7;
/**VAD_PARAM8 (rw) register accessor: I2S VAD Parameter register
...
///I2S VAD Parameter register
pub mod vad_param8;
/**VAD_OB0 (r) register accessor: I2S VAD Observe register
...
///I2S VAD Observe register
pub mod vad_ob0;
/**VAD_OB1 (r) register accessor: I2S VAD Observe register
...
///I2S VAD Observe register
pub mod vad_ob1;
/**VAD_OB2 (r) register accessor: I2S VAD Observe register
...
///I2S VAD Observe register
pub mod vad_ob2;
/**VAD_OB3 (r) register accessor: I2S VAD Observe register
...
///I2S VAD Observe register
pub mod vad_ob3;
/**VAD_OB4 (r) register accessor: I2S VAD Observe register
...
///I2S VAD Observe register
pub mod vad_ob4;
/**VAD_OB5 (r) register accessor: I2S VAD Observe register
...
///I2S VAD Observe register
pub mod vad_ob5;
/**VAD_OB6 (r) register accessor: I2S VAD Observe register
...
///I2S VAD Observe register
pub mod vad_ob6;
/**VAD_OB7 (r) register accessor: I2S VAD Observe register
...
///I2S VAD Observe register
pub mod vad_ob7;
/**VAD_OB8 (r) register accessor: I2S VAD Observe register
...
///I2S VAD Observe register
pub mod vad_ob8;
/**CLK_GATE (rw) register accessor: Clock gate register
