...
///Field `CLK_EN` reader - 0: enable clock gating. 1: disable clock gating, clock always on.
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - 0: enable clock gating. 1: disable clock gating, clock always on.
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - 0: enable clock gating. 1: disable clock gating, clock always on.
    #[inline(always)]
