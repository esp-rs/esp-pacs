///Register `CSI_EN` reader
pub type R = crate::R<CSI_EN_SPEC>;
///Register `CSI_EN` writer
pub type W = crate::W<CSI_EN_SPEC>;
///Field `CSI_BRIG_EN` reader - 0: disable csi bridge. 1: enable csi bridge.
pub type CSI_BRIG_EN_R = crate::BitReader;
///Field `CSI_BRIG_EN` writer - 0: disable csi bridge. 1: enable csi bridge.
pub type CSI_BRIG_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - 0: disable csi bridge. 1: enable csi bridge.
    #[inline(always)]
...
///`read()` method returns [`csi_en::R`](R) reader structure
impl crate::Readable for CSI_EN_SPEC {}
///`write(|w| ..)` method takes [`csi_en::W`](W) writer structure
