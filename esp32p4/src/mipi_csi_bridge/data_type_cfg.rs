///Register `DATA_TYPE_CFG` reader
pub type R = crate::R<DATA_TYPE_CFG_SPEC>;
///Register `DATA_TYPE_CFG` writer
pub type W = crate::W<DATA_TYPE_CFG_SPEC>;
///Field `DATA_TYPE_MIN` reader - the min value of data type used for pixel filter.
pub type DATA_TYPE_MIN_R = crate::FieldReader;
///Field `DATA_TYPE_MIN` writer - the min value of data type used for pixel filter.
pub type DATA_TYPE_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `DATA_TYPE_MAX` reader - the max value of data type used for pixel filter.
pub type DATA_TYPE_MAX_R = crate::FieldReader;
///Field `DATA_TYPE_MAX` writer - the max value of data type used for pixel filter.
pub type DATA_TYPE_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - the min value of data type used for pixel filter.
    #[inline(always)]
    pub fn data_type_min(&self) -> DATA_TYPE_MIN_R {
        DATA_TYPE_MIN_R::new((self.bits & 0x3f) as u8)
    }
    ///Bits 8:13 - the max value of data type used for pixel filter.
    #[inline(always)]
...
///`read()` method returns [`data_type_cfg::R`](R) reader structure
impl crate::Readable for DATA_TYPE_CFG_SPEC {}
///`write(|w| ..)` method takes [`data_type_cfg::W`](W) writer structure
