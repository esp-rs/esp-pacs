///Register `HOST_CTRL` reader
pub type R = crate::R<HOST_CTRL_SPEC>;
///Register `HOST_CTRL` writer
pub type W = crate::W<HOST_CTRL_SPEC>;
///Field `CSI_ENABLECLK` reader - enable clock lane module of csi phy.
pub type CSI_ENABLECLK_R = crate::BitReader;
///Field `CSI_ENABLECLK` writer - enable clock lane module of csi phy.
pub type CSI_ENABLECLK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CSI_CFG_CLK_EN` reader - enable cfg_clk of csi host module.
pub type CSI_CFG_CLK_EN_R = crate::BitReader;
///Field `CSI_CFG_CLK_EN` writer - enable cfg_clk of csi host module.
pub type CSI_CFG_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOOPBK_TEST_EN` reader - for phy test by loopback dsi phy to csi phy.
pub type LOOPBK_TEST_EN_R = crate::BitReader;
///Field `LOOPBK_TEST_EN` writer - for phy test by loopback dsi phy to csi phy.
pub type LOOPBK_TEST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - enable clock lane module of csi phy.
    #[inline(always)]
    pub fn csi_enableclk(&self) -> CSI_ENABLECLK_R {
        CSI_ENABLECLK_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - enable cfg_clk of csi host module.
    #[inline(always)]
    pub fn csi_cfg_clk_en(&self) -> CSI_CFG_CLK_EN_R {
        CSI_CFG_CLK_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - for phy test by loopback dsi phy to csi phy.
    #[inline(always)]
...
///`read()` method returns [`host_ctrl::R`](R) reader structure
impl crate::Readable for HOST_CTRL_SPEC {}
///`write(|w| ..)` method takes [`host_ctrl::W`](W) writer structure
