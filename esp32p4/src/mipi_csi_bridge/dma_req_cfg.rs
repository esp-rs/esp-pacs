///Register `DMA_REQ_CFG` reader
pub type R = crate::R<DMA_REQ_CFG_SPEC>;
///Register `DMA_REQ_CFG` writer
pub type W = crate::W<DMA_REQ_CFG_SPEC>;
///Field `DMA_BURST_LEN` reader - DMA burst length.
pub type DMA_BURST_LEN_R = crate::FieldReader<u16>;
///Field `DMA_BURST_LEN` writer - DMA burst length.
pub type DMA_BURST_LEN_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `DMA_CFG_UPD_BY_BLK` reader - 1: reg_dma_burst_len &amp; reg_dma_burst_len will be updated by dma block finish. 0: updated by frame.
pub type DMA_CFG_UPD_BY_BLK_R = crate::BitReader;
///Field `DMA_CFG_UPD_BY_BLK` writer - 1: reg_dma_burst_len &amp; reg_dma_burst_len will be updated by dma block finish. 0: updated by frame.
pub type DMA_CFG_UPD_BY_BLK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_FORCE_RD_STATUS` reader - 1: mask dma request when reading frame info. 0: disable mask.
pub type DMA_FORCE_RD_STATUS_R = crate::BitReader;
///Field `DMA_FORCE_RD_STATUS` writer - 1: mask dma request when reading frame info. 0: disable mask.
pub type DMA_FORCE_RD_STATUS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:11 - DMA burst length.
    #[inline(always)]
    pub fn dma_burst_len(&self) -> DMA_BURST_LEN_R {
        DMA_BURST_LEN_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bit 12 - 1: reg_dma_burst_len &amp; reg_dma_burst_len will be updated by dma block finish. 0: updated by frame.
    #[inline(always)]
    pub fn dma_cfg_upd_by_blk(&self) -> DMA_CFG_UPD_BY_BLK_R {
        DMA_CFG_UPD_BY_BLK_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 16 - 1: mask dma request when reading frame info. 0: disable mask.
    #[inline(always)]
...
///`read()` method returns [`dma_req_cfg::R`](R) reader structure
impl crate::Readable for DMA_REQ_CFG_SPEC {}
///`write(|w| ..)` method takes [`dma_req_cfg::W`](W) writer structure
