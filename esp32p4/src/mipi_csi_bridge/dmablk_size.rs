///Register `DMABLK_SIZE` reader
pub type R = crate::R<DMABLK_SIZE_SPEC>;
///Register `DMABLK_SIZE` writer
pub type W = crate::W<DMABLK_SIZE_SPEC>;
///Field `DMABLK_SIZE` reader - the number of reg_dma_burst_len in a block
pub type DMABLK_SIZE_R = crate::FieldReader<u16>;
///Field `DMABLK_SIZE` writer - the number of reg_dma_burst_len in a block
pub type DMABLK_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
impl R {
    ///Bits 0:12 - the number of reg_dma_burst_len in a block
    #[inline(always)]
...
///`read()` method returns [`dmablk_size::R`](R) reader structure
impl crate::Readable for DMABLK_SIZE_SPEC {}
///`write(|w| ..)` method takes [`dmablk_size::W`](W) writer structure
