///Register `DMA_FRAME_INTERVAL` reader
pub type R = crate::R<DMA_FRAME_INTERVAL_SPEC>;
///Register `DMA_FRAME_INTERVAL` writer
pub type W = crate::W<DMA_FRAME_INTERVAL_SPEC>;
///Field `DMA_FRAME_SLOT` reader - this field configures the max frame_slot_cnt
pub type DMA_FRAME_SLOT_R = crate::FieldReader<u16>;
///Field `DMA_FRAME_SLOT` writer - this field configures the max frame_slot_cnt
pub type DMA_FRAME_SLOT_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `DMA_FRAME_INTERVAL` reader - this field configures the max frame_interval_cnt, frame_interval_cnt increased by 1 when frame_slot_cnt if full
pub type DMA_FRAME_INTERVAL_R = crate::FieldReader<u32>;
///Field `DMA_FRAME_INTERVAL` writer - this field configures the max frame_interval_cnt, frame_interval_cnt increased by 1 when frame_slot_cnt if full
pub type DMA_FRAME_INTERVAL_W<'a, REG> = crate::FieldWriter<'a, REG, 18, u32>;
///Field `DMA_MULTIBLK_EN` reader - this bit configures enable multi-blk transfer, 0: disable, 1: enable
pub type DMA_MULTIBLK_EN_R = crate::BitReader;
///Field `DMA_MULTIBLK_EN` writer - this bit configures enable multi-blk transfer, 0: disable, 1: enable
pub type DMA_MULTIBLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EN` reader - this bit configures enable interval between frame transfer, 0: disable, 1: enable
pub type EN_R = crate::BitReader;
///Field `EN` writer - this bit configures enable interval between frame transfer, 0: disable, 1: enable
pub type EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:9 - this field configures the max frame_slot_cnt
    #[inline(always)]
    ...
    ///Bit 29 - this bit configures enable interval between frame transfer, 0: disable, 1: enable
    #[inline(always)]
    pub fn en(&self) -> EN_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_FRAME_INTERVAL")
            .field("dma_frame_slot", &self.dma_frame_slot())
            .field("dma_frame_interval", &self.dma_frame_interval())
            .field("dma_multiblk_en", &self.dma_multiblk_en())
            .field("en", &self.en())
            .finish()
    }
}
...
///`read()` method returns [`dma_frame_interval::R`](R) reader structure
impl crate::Readable for DMA_FRAME_INTERVAL_SPEC {}
///`write(|w| ..)` method takes [`dma_frame_interval::W`](W) writer structure
