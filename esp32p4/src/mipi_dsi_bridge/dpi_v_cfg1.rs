///Register `DPI_V_CFG1` reader
pub type R = crate::R<DPI_V_CFG1_SPEC>;
///Register `DPI_V_CFG1` writer
pub type W = crate::W<DPI_V_CFG1_SPEC>;
///Field `VBANK` reader - this field configures the length between vsync and valid line (by line) for dpi output
pub type VBANK_R = crate::FieldReader<u16>;
///Field `VBANK` writer - this field configures the length between vsync and valid line (by line) for dpi output
pub type VBANK_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `VSYNC` reader - this field configures the length of vsync (by line) for dpi output
pub type VSYNC_R = crate::FieldReader<u16>;
///Field `VSYNC` writer - this field configures the length of vsync (by line) for dpi output
pub type VSYNC_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - this field configures the length between vsync and valid line (by line) for dpi output
    #[inline(always)]
    pub fn vbank(&self) -> VBANK_R {
        VBANK_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bits 16:27 - this field configures the length of vsync (by line) for dpi output
    #[inline(always)]
...
///`read()` method returns [`dpi_v_cfg1::R`](R) reader structure
impl crate::Readable for DPI_V_CFG1_SPEC {}
///`write(|w| ..)` method takes [`dpi_v_cfg1::W`](W) writer structure
