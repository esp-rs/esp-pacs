///Register `DPI_MISC_CONFIG` reader
pub type R = crate::R<DPI_MISC_CONFIG_SPEC>;
///Register `DPI_MISC_CONFIG` writer
pub type W = crate::W<DPI_MISC_CONFIG_SPEC>;
///Field `DPI_EN` reader - this bit configures enable of dpi output, 0: disable, 1: enable
pub type DPI_EN_R = crate::BitReader;
///Field `DPI_EN` writer - this bit configures enable of dpi output, 0: disable, 1: enable
pub type DPI_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FIFO_UNDERRUN_DISCARD_VCNT` reader - this field configures the underrun interrupt musk, when underrun occurs and line cnt is less then this field
pub type FIFO_UNDERRUN_DISCARD_VCNT_R = crate::FieldReader<u16>;
///Field `FIFO_UNDERRUN_DISCARD_VCNT` writer - this field configures the underrun interrupt musk, when underrun occurs and line cnt is less then this field
pub type FIFO_UNDERRUN_DISCARD_VCNT_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bit 0 - this bit configures enable of dpi output, 0: disable, 1: enable
    #[inline(always)]
    pub fn dpi_en(&self) -> DPI_EN_R {
        DPI_EN_R::new((self.bits & 1) != 0)
    }
    ///Bits 4:15 - this field configures the underrun interrupt musk, when underrun occurs and line cnt is less then this field
    #[inline(always)]
...
///`read()` method returns [`dpi_misc_config::R`](R) reader structure
impl crate::Readable for DPI_MISC_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`dpi_misc_config::W`](W) writer structure
