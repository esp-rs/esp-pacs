///Register `RAW_BUF_ALMOST_EMPTY_THRD` reader
pub type R = crate::R<RAW_BUF_ALMOST_EMPTY_THRD_SPEC>;
///Register `RAW_BUF_ALMOST_EMPTY_THRD` writer
pub type W = crate::W<RAW_BUF_ALMOST_EMPTY_THRD_SPEC>;
///Field `DSI_RAW_BUF_ALMOST_EMPTY_THRD` reader - this field configures the fifo almost empty threshold, is valid only when dmac as flow controller
pub type DSI_RAW_BUF_ALMOST_EMPTY_THRD_R = crate::FieldReader<u16>;
///Field `DSI_RAW_BUF_ALMOST_EMPTY_THRD` writer - this field configures the fifo almost empty threshold, is valid only when dmac as flow controller
pub type DSI_RAW_BUF_ALMOST_EMPTY_THRD_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
impl R {
    ///Bits 0:10 - this field configures the fifo almost empty threshold, is valid only when dmac as flow controller
    #[inline(always)]
...
///`read()` method returns [`raw_buf_almost_empty_thrd::R`](R) reader structure
impl crate::Readable for RAW_BUF_ALMOST_EMPTY_THRD_SPEC {}
///`write(|w| ..)` method takes [`raw_buf_almost_empty_thrd::W`](W) writer structure
