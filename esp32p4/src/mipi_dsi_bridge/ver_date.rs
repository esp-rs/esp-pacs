...
#[doc = "Field `VER_DATA` reader - Represents csv version"]
pub type VER_DATA_R = crate::FieldReader<u32>;
#[doc = "Field `VER_DATA` writer - Represents csv version"]
pub type VER_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Represents csv version"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Represents csv version"]
    #[inline(always)]
    pub fn ver_data(&mut self) -> VER_DATA_W<'_, VER_DATE_SPEC> {
...
#[doc = "`reset()` method sets VER_DATE to value 0x2025_0109"]
impl crate::Resettable for VER_DATE_SPEC {
    const RESET_VALUE: u32 = 0x2025_0109;
}
