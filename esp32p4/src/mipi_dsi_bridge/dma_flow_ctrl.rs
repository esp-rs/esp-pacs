///Register `DMA_FLOW_CTRL` reader
pub type R = crate::R<DMA_FLOW_CTRL_SPEC>;
///Register `DMA_FLOW_CTRL` writer
pub type W = crate::W<DMA_FLOW_CTRL_SPEC>;
///Field `DSI_DMA_FLOW_CONTROLLER` reader - this bit configures the flow controller, 0: dmac as flow controller, 1:dsi_bridge as flow controller
pub type DSI_DMA_FLOW_CONTROLLER_R = crate::BitReader;
///Field `DSI_DMA_FLOW_CONTROLLER` writer - this bit configures the flow controller, 0: dmac as flow controller, 1:dsi_bridge as flow controller
pub type DSI_DMA_FLOW_CONTROLLER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_FLOW_MULTIBLK_NUM` reader - this field configures the num of blocks when multi-blk is enable and dmac as flow controller
pub type DMA_FLOW_MULTIBLK_NUM_R = crate::FieldReader;
///Field `DMA_FLOW_MULTIBLK_NUM` writer - this field configures the num of blocks when multi-blk is enable and dmac as flow controller
pub type DMA_FLOW_MULTIBLK_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bit 0 - this bit configures the flow controller, 0: dmac as flow controller, 1:dsi_bridge as flow controller
    #[inline(always)]
    pub fn dsi_dma_flow_controller(&self) -> DSI_DMA_FLOW_CONTROLLER_R {
        DSI_DMA_FLOW_CONTROLLER_R::new((self.bits & 1) != 0)
    }
    ///Bits 4:7 - this field configures the num of blocks when multi-blk is enable and dmac as flow controller
    #[inline(always)]
...
///`read()` method returns [`dma_flow_ctrl::R`](R) reader structure
impl crate::Readable for DMA_FLOW_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dma_flow_ctrl::W`](W) writer structure
