...
#[doc = "Field `CLK_EN` reader - this bit configures force_on of dsi_bridge register clock gate"]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - this bit configures force_on of dsi_bridge register clock gate"]
