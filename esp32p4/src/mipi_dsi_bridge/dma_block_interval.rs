///Register `DMA_BLOCK_INTERVAL` reader
pub type R = crate::R<DMA_BLOCK_INTERVAL_SPEC>;
///Register `DMA_BLOCK_INTERVAL` writer
pub type W = crate::W<DMA_BLOCK_INTERVAL_SPEC>;
///Field `DMA_BLOCK_SLOT` reader - this field configures the max block_slot_cnt
pub type DMA_BLOCK_SLOT_R = crate::FieldReader<u16>;
///Field `DMA_BLOCK_SLOT` writer - this field configures the max block_slot_cnt
pub type DMA_BLOCK_SLOT_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `DMA_BLOCK_INTERVAL` reader - this field configures the max block_interval_cnt, block_interval_cnt increased by 1 when block_slot_cnt if full
pub type DMA_BLOCK_INTERVAL_R = crate::FieldReader<u32>;
///Field `DMA_BLOCK_INTERVAL` writer - this field configures the max block_interval_cnt, block_interval_cnt increased by 1 when block_slot_cnt if full
pub type DMA_BLOCK_INTERVAL_W<'a, REG> = crate::FieldWriter<'a, REG, 18, u32>;
///Field `RAW_NUM_TOTAL_AUTO_RELOAD` reader - this bit configures enable of auto reload reg_raw_num_total, 0: disable, 1: enable
pub type RAW_NUM_TOTAL_AUTO_RELOAD_R = crate::BitReader;
///Field `RAW_NUM_TOTAL_AUTO_RELOAD` writer - this bit configures enable of auto reload reg_raw_num_total, 0: disable, 1: enable
pub type RAW_NUM_TOTAL_AUTO_RELOAD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EN` reader - this bit configures enable of interval between dma block transfer, 0: disable, 1: enable
pub type EN_R = crate::BitReader;
///Field `EN` writer - this bit configures enable of interval between dma block transfer, 0: disable, 1: enable
pub type EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:9 - this field configures the max block_slot_cnt
    #[inline(always)]
    ...
    ///Bit 29 - this bit configures enable of interval between dma block transfer, 0: disable, 1: enable
    #[inline(always)]
    pub fn en(&self) -> EN_R {
...
///`read()` method returns [`dma_block_interval::R`](R) reader structure
impl crate::Readable for DMA_BLOCK_INTERVAL_SPEC {}
///`write(|w| ..)` method takes [`dma_block_interval::W`](W) writer structure
