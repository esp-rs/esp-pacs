///Register `MEM_AUX_CTRL` reader
pub type R = crate::R<MEM_AUX_CTRL_SPEC>;
///Register `MEM_AUX_CTRL` writer
pub type W = crate::W<MEM_AUX_CTRL_SPEC>;
///Field `DSI_MEM_AUX_CTRL` reader - this field configures dsi_bridge fifo memory aux ctrl
pub type DSI_MEM_AUX_CTRL_R = crate::FieldReader<u16>;
///Field `DSI_MEM_AUX_CTRL` writer - this field configures dsi_bridge fifo memory aux ctrl
pub type DSI_MEM_AUX_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    ///Bits 0:13 - this field configures dsi_bridge fifo memory aux ctrl
    #[inline(always)]
...
///`read()` method returns [`mem_aux_ctrl::R`](R) reader structure
impl crate::Readable for MEM_AUX_CTRL_SPEC {}
///`write(|w| ..)` method takes [`mem_aux_ctrl::W`](W) writer structure
