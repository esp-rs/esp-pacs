...
///`read()` method returns [`host_bist_ctl::R`](R) reader structure
impl crate::Readable for HOST_BIST_CTL_SPEC {}
///`write(|w| ..)` method takes [`host_bist_ctl::W`](W) writer structure
