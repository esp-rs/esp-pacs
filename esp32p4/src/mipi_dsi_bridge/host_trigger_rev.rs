///Register `HOST_TRIGGER_REV` reader
pub type R = crate::R<HOST_TRIGGER_REV_SPEC>;
///Register `HOST_TRIGGER_REV` writer
pub type W = crate::W<HOST_TRIGGER_REV_SPEC>;
///Field `TX_TRIGGER_REV_EN` reader - tx_trigger reverse. 0: disable, 1: enable
pub type TX_TRIGGER_REV_EN_R = crate::BitReader;
///Field `TX_TRIGGER_REV_EN` writer - tx_trigger reverse. 0: disable, 1: enable
pub type TX_TRIGGER_REV_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_TRIGGER_REV_EN` reader - rx_trigger reverse. 0: disable, 1: enable
pub type RX_TRIGGER_REV_EN_R = crate::BitReader;
///Field `RX_TRIGGER_REV_EN` writer - rx_trigger reverse. 0: disable, 1: enable
pub type RX_TRIGGER_REV_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - tx_trigger reverse. 0: disable, 1: enable
    #[inline(always)]
    pub fn tx_trigger_rev_en(&self) -> TX_TRIGGER_REV_EN_R {
        TX_TRIGGER_REV_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - rx_trigger reverse. 0: disable, 1: enable
    #[inline(always)]
...
///`read()` method returns [`host_trigger_rev::R`](R) reader structure
impl crate::Readable for HOST_TRIGGER_REV_SPEC {}
///`write(|w| ..)` method takes [`host_trigger_rev::W`](W) writer structure
