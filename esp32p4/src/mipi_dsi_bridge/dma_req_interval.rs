...
///Field `DMA_REQ_INTERVAL` reader - this field configures the interval between dma req events
pub type DMA_REQ_INTERVAL_R = crate::FieldReader<u16>;
///Field `DMA_REQ_INTERVAL` writer - this field configures the interval between dma req events
pub type DMA_REQ_INTERVAL_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - this field configures the interval between dma req events
    #[inline(always)]
