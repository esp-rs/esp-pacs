///Register `BLK_RAW_NUM_CFG` reader
pub type R = crate::R<BLK_RAW_NUM_CFG_SPEC>;
///Register `BLK_RAW_NUM_CFG` writer
pub type W = crate::W<BLK_RAW_NUM_CFG_SPEC>;
///Field `BLK_RAW_NUM_TOTAL` reader - this field configures number of total block pix bits/64
pub type BLK_RAW_NUM_TOTAL_R = crate::FieldReader<u32>;
///Field `BLK_RAW_NUM_TOTAL` writer - this field configures number of total block pix bits/64
pub type BLK_RAW_NUM_TOTAL_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
///Field `BLK_RAW_NUM_TOTAL_SET` writer - write 1 to reload reg_blk_raw_num_total to internal cnt
pub type BLK_RAW_NUM_TOTAL_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:21 - this field configures number of total block pix bits/64
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK_RAW_NUM_CFG")
            .field("blk_raw_num_total", &self.blk_raw_num_total())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`blk_raw_num_cfg::R`](R) reader structure
impl crate::Readable for BLK_RAW_NUM_CFG_SPEC {}
///`write(|w| ..)` method takes [`blk_raw_num_cfg::W`](W) writer structure
