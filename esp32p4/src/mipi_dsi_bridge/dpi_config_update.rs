///Register `DPI_CONFIG_UPDATE` writer
pub type W = crate::W<DPI_CONFIG_UPDATE_SPEC>;
///Field `DPI_CONFIG_UPDATE` writer - write 1 to this bit to update dpi config register MIPI_DSI_BRG_DPI_*
...
impl W {
    ///Bit 0 - write 1 to this bit to update dpi config register MIPI_DSI_BRG_DPI_*
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`dpi_config_update::W`](W) writer structure
