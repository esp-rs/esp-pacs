///Register `PHY_LP_LOOPBACK_CTRL` reader
pub type R = crate::R<PHY_LP_LOOPBACK_CTRL_SPEC>;
///Register `PHY_LP_LOOPBACK_CTRL` writer
...
///Field `PHY_LP_TXDATAESC_1` writer - txdataesc_1 ctrl when enable dsi phy lp_loopback_test
pub type PHY_LP_TXDATAESC_1_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PHY_LP_TXREQUESTESC_1` reader - txrequestesc_1 ctrl when enable dsi phy lp_loopback_test
pub type PHY_LP_TXREQUESTESC_1_R = crate::BitReader;
///Field `PHY_LP_TXREQUESTESC_1` writer - txrequestesc_1 ctrl when enable dsi phy lp_loopback_test
pub type PHY_LP_TXREQUESTESC_1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_LP_TXVALIDESC_1` reader - txvalidesc_1 ctrl when enable dsi phy lp_loopback_test
pub type PHY_LP_TXVALIDESC_1_R = crate::BitReader;
///Field `PHY_LP_TXVALIDESC_1` writer - txvalidesc_1 ctrl when enable dsi phy lp_loopback_test
...
///Field `PHY_LP_TXLPDTESC_1` writer - txlpdtesc_1 ctrl when enable dsi phy lp_loopback_test
...
///Field `PHY_LP_BASEDIR_1` writer - basedir_1 ctrl when enable dsi phy lp_loopback_test
...
///Field `PHY_LP_TXDATAESC_0` writer - txdataesc_0 ctrl when enable dsi phy lp_loopback_test
pub type PHY_LP_TXDATAESC_0_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PHY_LP_TXREQUESTESC_0` reader - txrequestesc_0 ctrl when enable dsi phy lp_loopback_test
pub type PHY_LP_TXREQUESTESC_0_R = crate::BitReader;
///Field `PHY_LP_TXREQUESTESC_0` writer - txrequestesc_0 ctrl when enable dsi phy lp_loopback_test
...
///Field `PHY_LP_TXVALIDESC_0` writer - txvalidesc_0 ctrl when enable dsi phy lp_loopback_test
pub type PHY_LP_TXVALIDESC_0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_LP_TXLPDTESC_0` reader - txlpdtesc_0 ctrl when enable dsi phy lp_loopback_test
pub type PHY_LP_TXLPDTESC_0_R = crate::BitReader;
///Field `PHY_LP_TXLPDTESC_0` writer - txlpdtesc_0 ctrl when enable dsi phy lp_loopback_test
...
///Field `PHY_LP_BASEDIR_0` writer - basedir_0 ctrl when enable dsi phy lp_loopback_test
pub type PHY_LP_BASEDIR_0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_LP_LOOPBACK_CHECK` writer - dsi phy lp_loopback test start check
pub type PHY_LP_LOOPBACK_CHECK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_LP_LOOPBACK_CHECK_DONE` reader - dsi phy lp_loopback test check done
pub type PHY_LP_LOOPBACK_CHECK_DONE_R = crate::BitReader;
///Field `PHY_LP_LOOPBACK_EN` reader - dsi phy lp_loopback ctrl en
pub type PHY_LP_LOOPBACK_EN_R = crate::BitReader;
///Field `PHY_LP_LOOPBACK_EN` writer - dsi phy lp_loopback ctrl en
pub type PHY_LP_LOOPBACK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_LP_LOOPBACK_OK` reader - result of dsi phy lp_loopback test
...
impl R {
    ...
    ///Bit 29 - dsi phy lp_loopback test check done
    #[inline(always)]
    ...
    ///Bit 31 - result of dsi phy lp_loopback test
    #[inline(always)]
...
///`read()` method returns [`phy_lp_loopback_ctrl::R`](R) reader structure
impl crate::Readable for PHY_LP_LOOPBACK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`phy_lp_loopback_ctrl::W`](W) writer structure
