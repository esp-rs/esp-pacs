...
///Field `DSI_EN` reader - this bit configures module enable of dsi_bridge. 0: disable, 1: enable
pub type DSI_EN_R = crate::BitReader;
///Field `DSI_EN` writer - this bit configures module enable of dsi_bridge. 0: disable, 1: enable
pub type DSI_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - this bit configures module enable of dsi_bridge. 0: disable, 1: enable
    #[inline(always)]
...
///`read()` method returns [`en::R`](R) reader structure
impl crate::Readable for EN_SPEC {}
///`write(|w| ..)` method takes [`en::W`](W) writer structure
