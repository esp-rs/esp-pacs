///Register `PHY_HS_LOOPBACK_CTRL` reader
pub type R = crate::R<PHY_HS_LOOPBACK_CTRL_SPEC>;
///Register `PHY_HS_LOOPBACK_CTRL` writer
pub type W = crate::W<PHY_HS_LOOPBACK_CTRL_SPEC>;
///Field `PHY_HS_TXDATAHS_1` reader - txdatahs_1 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_TXDATAHS_1_R = crate::FieldReader;
///Field `PHY_HS_TXDATAHS_1` writer - txdatahs_1 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_TXDATAHS_1_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PHY_HS_TXREQUESTDATAHS_1` reader - txrequestdatahs_1 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_TXREQUESTDATAHS_1_R = crate::BitReader;
///Field `PHY_HS_TXREQUESTDATAHS_1` writer - txrequestdatahs_1 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_TXREQUESTDATAHS_1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_HS_BASEDIR_1` reader - basedir_1 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_BASEDIR_1_R = crate::BitReader;
///Field `PHY_HS_BASEDIR_1` writer - basedir_1 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_BASEDIR_1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_HS_TXDATAHS_0` reader - txdatahs_0 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_TXDATAHS_0_R = crate::FieldReader;
///Field `PHY_HS_TXDATAHS_0` writer - txdatahs_0 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_TXDATAHS_0_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PHY_HS_TXREQUESTDATAHS_0` reader - txrequestdatahs_0 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_TXREQUESTDATAHS_0_R = crate::BitReader;
///Field `PHY_HS_TXREQUESTDATAHS_0` writer - txrequestdatahs_0 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_TXREQUESTDATAHS_0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_HS_BASEDIR_0` reader - basedir_0 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_BASEDIR_0_R = crate::BitReader;
///Field `PHY_HS_BASEDIR_0` writer - basedir_0 ctrl when enable dsi phy hs_loopback_test
pub type PHY_HS_BASEDIR_0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_HS_TXREQUESTHSCLK` reader - txrequesthsclk when enable dsi phy hs_loopback_test
pub type PHY_HS_TXREQUESTHSCLK_R = crate::BitReader;
///Field `PHY_HS_TXREQUESTHSCLK` writer - txrequesthsclk when enable dsi phy hs_loopback_test
pub type PHY_HS_TXREQUESTHSCLK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_HS_LOOPBACK_CHECK` writer - dsi phy hs_loopback test start check
pub type PHY_HS_LOOPBACK_CHECK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_HS_LOOPBACK_CHECK_DONE` reader - dsi phy hs_loopback test check done
pub type PHY_HS_LOOPBACK_CHECK_DONE_R = crate::BitReader;
///Field `PHY_HS_LOOPBACK_EN` reader - dsi phy hs_loopback ctrl en
pub type PHY_HS_LOOPBACK_EN_R = crate::BitReader;
///Field `PHY_HS_LOOPBACK_EN` writer - dsi phy hs_loopback ctrl en
pub type PHY_HS_LOOPBACK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PHY_HS_LOOPBACK_OK` reader - result of dsi phy hs_loopback test
...
impl R {
    ...
    ///Bit 9 - basedir_1 ctrl when enable dsi phy hs_loopback_test
    #[inline(always)]
    ...
    ///Bit 25 - basedir_0 ctrl when enable dsi phy hs_loopback_test
    #[inline(always)]
    ...
    ///Bit 29 - dsi phy hs_loopback test check done
    #[inline(always)]
    ...
    ///Bit 31 - result of dsi phy hs_loopback test
    #[inline(always)]
...
///`read()` method returns [`phy_hs_loopback_ctrl::R`](R) reader structure
impl crate::Readable for PHY_HS_LOOPBACK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`phy_hs_loopback_ctrl::W`](W) writer structure
