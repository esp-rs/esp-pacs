...
impl W {
    #[doc = "Bits 0:7 - txdatahs_1 ctrl when enable dsi phy hs_loopback_test"]
    #[inline(always)]
    pub fn phy_hs_txdatahs_1(&mut self) -> PHY_HS_TXDATAHS_1_W<'_, PHY_HS_LOOPBACK_CTRL_SPEC> {
    ...
    pub fn phy_hs_txrequestdatahs_1(
        &mut self,
    ) -> PHY_HS_TXREQUESTDATAHS_1_W<'_, PHY_HS_LOOPBACK_CTRL_SPEC> {
        PHY_HS_TXREQUESTDATAHS_1_W::new(self, 8)
    }
    #[doc = "Bit 9 - basedir_1 ctrl when enable dsi phy hs_loopback_test"]
    #[inline(always)]
    pub fn phy_hs_basedir_1(&mut self) -> PHY_HS_BASEDIR_1_W<'_, PHY_HS_LOOPBACK_CTRL_SPEC> {
        PHY_HS_BASEDIR_1_W::new(self, 9)
    }
    #[doc = "Bits 16:23 - txdatahs_0 ctrl when enable dsi phy hs_loopback_test"]
    #[inline(always)]
    pub fn phy_hs_txdatahs_0(&mut self) -> PHY_HS_TXDATAHS_0_W<'_, PHY_HS_LOOPBACK_CTRL_SPEC> {
    ...
    pub fn phy_hs_txrequestdatahs_0(
        &mut self,
    ) -> PHY_HS_TXREQUESTDATAHS_0_W<'_, PHY_HS_LOOPBACK_CTRL_SPEC> {
        PHY_HS_TXREQUESTDATAHS_0_W::new(self, 24)
    }
    #[doc = "Bit 25 - basedir_0 ctrl when enable dsi phy hs_loopback_test"]
    #[inline(always)]
    pub fn phy_hs_basedir_0(&mut self) -> PHY_HS_BASEDIR_0_W<'_, PHY_HS_LOOPBACK_CTRL_SPEC> {
    ...
    pub fn phy_hs_txrequesthsclk(
        &mut self,
    ) -> PHY_HS_TXREQUESTHSCLK_W<'_, PHY_HS_LOOPBACK_CTRL_SPEC> {
    ...
    pub fn phy_hs_loopback_check(
        &mut self,
    ) -> PHY_HS_LOOPBACK_CHECK_W<'_, PHY_HS_LOOPBACK_CTRL_SPEC> {
        PHY_HS_LOOPBACK_CHECK_W::new(self, 28)
    }
    #[doc = "Bit 30 - dsi phy hs_loopback ctrl en"]
    #[inline(always)]
    pub fn phy_hs_loopback_en(&mut self) -> PHY_HS_LOOPBACK_EN_W<'_, PHY_HS_LOOPBACK_CTRL_SPEC> {
