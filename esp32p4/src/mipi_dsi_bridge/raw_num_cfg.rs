///Register `RAW_NUM_CFG` reader
pub type R = crate::R<RAW_NUM_CFG_SPEC>;
///Register `RAW_NUM_CFG` writer
pub type W = crate::W<RAW_NUM_CFG_SPEC>;
///Field `RAW_NUM_TOTAL` reader - this field configures number of total pix bits/64
pub type RAW_NUM_TOTAL_R = crate::FieldReader<u32>;
///Field `RAW_NUM_TOTAL` writer - this field configures number of total pix bits/64
pub type RAW_NUM_TOTAL_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
///Field `UNALIGN_64BIT_EN` reader - this field configures whether the total pix bits is a multiple of 64bits. 0: align to 64-bit, 1: unalign to 64-bit
pub type UNALIGN_64BIT_EN_R = crate::BitReader;
///Field `UNALIGN_64BIT_EN` writer - this field configures whether the total pix bits is a multiple of 64bits. 0: align to 64-bit, 1: unalign to 64-bit
pub type UNALIGN_64BIT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RAW_NUM_TOTAL_SET` writer - this bit configures enable of reload reg_raw_num_total to internal cnt. 0: disable, 1: enable. valid only when dsi_bridge as flow controller
pub type RAW_NUM_TOTAL_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:21 - this field configures number of total pix bits/64
    #[inline(always)]
    pub fn raw_num_total(&self) -> RAW_NUM_TOTAL_R {
        RAW_NUM_TOTAL_R::new(self.bits & 0x003f_ffff)
    }
    ///Bit 22 - this field configures whether the total pix bits is a multiple of 64bits. 0: align to 64-bit, 1: unalign to 64-bit
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RAW_NUM_CFG")
            .field("raw_num_total", &self.raw_num_total())
            .field("unalign_64bit_en", &self.unalign_64bit_en())
            .finish()
    }
}
impl W {
    ...
    ///Bit 31 - this bit configures enable of reload reg_raw_num_total to internal cnt. 0: disable, 1: enable. valid only when dsi_bridge as flow controller
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`raw_num_cfg::R`](R) reader structure
impl crate::Readable for RAW_NUM_CFG_SPEC {}
///`write(|w| ..)` method takes [`raw_num_cfg::W`](W) writer structure
