...
impl W {
    #[doc = "Bits 0:21 - this field configures number of total pix bits/64"]
    #[inline(always)]
    pub fn raw_num_total(&mut self) -> RAW_NUM_TOTAL_W<'_, RAW_NUM_CFG_SPEC> {
        RAW_NUM_TOTAL_W::new(self, 0)
    }
    #[doc = "Bit 22 - this field configures whether the total pix bits is a multiple of 64bits. 0: align to 64-bit, 1: unalign to 64-bit"]
    #[inline(always)]
    pub fn unalign_64bit_en(&mut self) -> UNALIGN_64BIT_EN_W<'_, RAW_NUM_CFG_SPEC> {
    ...
    #[inline(always)]
    pub fn raw_num_total_set(&mut self) -> RAW_NUM_TOTAL_SET_W<'_, RAW_NUM_CFG_SPEC> {
