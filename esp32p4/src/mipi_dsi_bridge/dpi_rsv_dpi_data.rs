///Register `DPI_RSV_DPI_DATA` reader
pub type R = crate::R<DPI_RSV_DPI_DATA_SPEC>;
///Register `DPI_RSV_DPI_DATA` writer
pub type W = crate::W<DPI_RSV_DPI_DATA_SPEC>;
///Field `DPI_RSV_DATA` reader - this field controls the pixel data sent to dsi_host when dsi_bridge fifo underflow
pub type DPI_RSV_DATA_R = crate::FieldReader<u32>;
///Field `DPI_RSV_DATA` writer - this field controls the pixel data sent to dsi_host when dsi_bridge fifo underflow
pub type DPI_RSV_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - this field controls the pixel data sent to dsi_host when dsi_bridge fifo underflow
    #[inline(always)]
...
///`read()` method returns [`dpi_rsv_dpi_data::R`](R) reader structure
impl crate::Readable for DPI_RSV_DPI_DATA_SPEC {}
///`write(|w| ..)` method takes [`dpi_rsv_dpi_data::W`](W) writer structure
