...
///Field `DSI_CFG_REF_CLK_EN` reader - this bit configures the clk enable refclk and cfg_clk of dsi_host. 0: disable, 1: enable
pub type DSI_CFG_REF_CLK_EN_R = crate::BitReader;
///Field `DSI_CFG_REF_CLK_EN` writer - this bit configures the clk enable refclk and cfg_clk of dsi_host. 0: disable, 1: enable
pub type DSI_CFG_REF_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - this bit configures the clk enable refclk and cfg_clk of dsi_host. 0: disable, 1: enable
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_CTRL")
            .field("dsi_cfg_ref_clk_en", &self.dsi_cfg_ref_clk_en())
            .finish()
    }
}
impl W {
