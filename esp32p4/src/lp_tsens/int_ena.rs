...
///Field `COCPU_TSENS_WAKE` reader - Tsens wakeup interrupt enable.
pub type COCPU_TSENS_WAKE_R = crate::BitReader;
///Field `COCPU_TSENS_WAKE` writer - Tsens wakeup interrupt enable.
pub type COCPU_TSENS_WAKE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Tsens wakeup interrupt enable.
    #[inline(always)]
