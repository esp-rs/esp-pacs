...
///Field `WAKEUP_TH_LOW` reader - Lower threshold.
pub type WAKEUP_TH_LOW_R = crate::FieldReader;
///Field `WAKEUP_TH_LOW` writer - Lower threshold.
pub type WAKEUP_TH_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `WAKEUP_TH_HIGH` reader - Upper threshold.
pub type WAKEUP_TH_HIGH_R = crate::FieldReader;
///Field `WAKEUP_TH_HIGH` writer - Upper threshold.
pub type WAKEUP_TH_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `WAKEUP_OVER_UPPER_TH` reader - Indicates that this wakeup event arose from exceeding upper threshold.
pub type WAKEUP_OVER_UPPER_TH_R = crate::BitReader;
///Field `WAKEUP_EN` reader - Tsens wakeup enable.
pub type WAKEUP_EN_R = crate::BitReader;
///Field `WAKEUP_EN` writer - Tsens wakeup enable.
pub type WAKEUP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WAKEUP_MODE` reader - 0:absolute value comparison mode. 1: relative value comparison mode.
pub type WAKEUP_MODE_R = crate::BitReader;
///Field `WAKEUP_MODE` writer - 0:absolute value comparison mode. 1: relative value comparison mode.
pub type WAKEUP_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:7 - Lower threshold.
    #[inline(always)]
    pub fn wakeup_th_low(&self) -> WAKEUP_TH_LOW_R {
        WAKEUP_TH_LOW_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 14:21 - Upper threshold.
    #[inline(always)]
