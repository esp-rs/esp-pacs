...
///Field `OUT` reader - Temperature sensor data out.
pub type OUT_R = crate::FieldReader;
///Field `READY` reader - Indicate temperature sensor out ready.
pub type READY_R = crate::BitReader;
///Field `SAMPLE_EN` reader - Enable sample signal for wakeup module.
pub type SAMPLE_EN_R = crate::BitReader;
///Field `SAMPLE_EN` writer - Enable sample signal for wakeup module.
pub type SAMPLE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WAKEUP_MASK` reader - Wake up signal mask.
pub type WAKEUP_MASK_R = crate::BitReader;
///Field `WAKEUP_MASK` writer - Wake up signal mask.
pub type WAKEUP_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INT_EN` reader - Enable temperature sensor to send out interrupt.
pub type INT_EN_R = crate::BitReader;
///Field `INT_EN` writer - Enable temperature sensor to send out interrupt.
pub type INT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_INV` reader - Invert temperature sensor data.
pub type IN_INV_R = crate::BitReader;
///Field `IN_INV` writer - Invert temperature sensor data.
pub type IN_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_DIV` reader - Temperature sensor clock divider.
pub type CLK_DIV_R = crate::FieldReader;
///Field `CLK_DIV` writer - Temperature sensor clock divider.
pub type CLK_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `POWER_UP` reader - Temperature sensor power up.
pub type POWER_UP_R = crate::BitReader;
///Field `POWER_UP` writer - Temperature sensor power up.
pub type POWER_UP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `POWER_UP_FORCE` reader - 1: dump out &amp; power up controlled by SW, 0: by FSM.
pub type POWER_UP_FORCE_R = crate::BitReader;
///Field `POWER_UP_FORCE` writer - 1: dump out &amp; power up controlled by SW, 0: by FSM.
...
impl R {
    ...
    ///Bit 9 - Enable sample signal for wakeup module.
    #[inline(always)]
    pub fn sample_en(&self) -> SAMPLE_EN_R {
        SAMPLE_EN_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Wake up signal mask.
    #[inline(always)]
