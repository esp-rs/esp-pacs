...
///`read()` method returns [`pin5::R`](R) reader structure
impl crate::Readable for PIN5_SPEC {}
///`write(|w| ..)` method takes [`pin5::W`](W) writer structure
