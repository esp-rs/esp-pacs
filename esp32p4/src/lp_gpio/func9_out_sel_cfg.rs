...
///`read()` method returns [`func9_out_sel_cfg::R`](R) reader structure
impl crate::Readable for FUNC9_OUT_SEL_CFG_SPEC {}
///`write(|w| ..)` method takes [`func9_out_sel_cfg::W`](W) writer structure
