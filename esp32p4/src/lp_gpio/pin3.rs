...
impl W {
    #[doc = "Bit 0 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_pin3_wakeup_enable(&mut self) -> REG_GPIO_PIN3_WAKEUP_ENABLE_W<'_, PIN3_SPEC> {
        REG_GPIO_PIN3_WAKEUP_ENABLE_W::new(self, 0)
    }
    #[doc = "Bits 1:3 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_pin3_int_type(&mut self) -> REG_GPIO_PIN3_INT_TYPE_W<'_, PIN3_SPEC> {
        REG_GPIO_PIN3_INT_TYPE_W::new(self, 1)
    }
    #[doc = "Bit 4 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_pin3_pad_driver(&mut self) -> REG_GPIO_PIN3_PAD_DRIVER_W<'_, PIN3_SPEC> {
        REG_GPIO_PIN3_PAD_DRIVER_W::new(self, 4)
    }
    #[doc = "Bit 5 - need des"]
    #[inline(always)]
    pub fn reg_gpi3_pin0_edge_wakeup_clr(
        &mut self,
    ) -> REG_GPI3_PIN0_EDGE_WAKEUP_CLR_W<'_, PIN3_SPEC> {
