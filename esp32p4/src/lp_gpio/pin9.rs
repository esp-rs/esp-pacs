...
///`read()` method returns [`pin9::R`](R) reader structure
impl crate::Readable for PIN9_SPEC {}
///`write(|w| ..)` method takes [`pin9::W`](W) writer structure
