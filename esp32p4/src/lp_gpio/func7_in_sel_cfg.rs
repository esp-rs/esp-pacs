...
///`read()` method returns [`func7_in_sel_cfg::R`](R) reader structure
impl crate::Readable for FUNC7_IN_SEL_CFG_SPEC {}
///`write(|w| ..)` method takes [`func7_in_sel_cfg::W`](W) writer structure
