    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC11_OUT_SEL_CFG")
            .field(
                ...
                &format_args!("{}", self.reg_gpio_func11_oe_inv_sel().bit()),
            )
            .field(
                "reg_gpio_func11_oe_sel",
                &format_args!("{}", self.reg_gpio_func11_oe_sel().bit()),
            )
            .field(
                "reg_gpio_func11_out_inv_sel",
                &format_args!("{}", self.reg_gpio_func11_out_inv_sel().bit()),
            )
            .field(
                "reg_gpio_func11_out_sel",
                &format_args!("{}", self.reg_gpio_func11_out_sel().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<FUNC11_OUT_SEL_CFG_SPEC> {
