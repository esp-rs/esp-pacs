...
impl W {
    #[doc = "Bit 0 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_pin15_wakeup_enable(
        &mut self,
    ) -> REG_GPIO_PIN15_WAKEUP_ENABLE_W<'_, PIN15_SPEC> {
        REG_GPIO_PIN15_WAKEUP_ENABLE_W::new(self, 0)
    }
    #[doc = "Bits 1:3 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_pin15_int_type(&mut self) -> REG_GPIO_PIN15_INT_TYPE_W<'_, PIN15_SPEC> {
        REG_GPIO_PIN15_INT_TYPE_W::new(self, 1)
    }
    #[doc = "Bit 4 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_pin15_pad_driver(&mut self) -> REG_GPIO_PIN15_PAD_DRIVER_W<'_, PIN15_SPEC> {
    ...
    pub fn reg_gpi15_pin0_edge_wakeup_clr(
        &mut self,
    ) -> REG_GPI15_PIN0_EDGE_WAKEUP_CLR_W<'_, PIN15_SPEC> {
