    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PIN15")
            .field(
                ...
                &format_args!("{}", self.reg_gpio_pin15_wakeup_enable().bit()),
            )
            .field(
                "reg_gpio_pin15_int_type",
                &format_args!("{}", self.reg_gpio_pin15_int_type().bits()),
            )
            .field(
                "reg_gpio_pin15_pad_driver",
                &format_args!("{}", self.reg_gpio_pin15_pad_driver().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PIN15_SPEC> {
