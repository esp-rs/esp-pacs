    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC1_IN_SEL_CFG")
            .field(
                ...
                &format_args!("{}", self.reg_gpio_func1_in_inv_sel().bit()),
            )
            .field(
                "reg_gpio_sig1_in_sel",
                &format_args!("{}", self.reg_gpio_sig1_in_sel().bit()),
            )
            .field(
                "reg_gpio_func1_in_sel",
                &format_args!("{}", self.reg_gpio_func1_in_sel().bits()),
            )
            .finish()
    }
}
