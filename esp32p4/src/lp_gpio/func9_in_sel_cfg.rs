    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC9_IN_SEL_CFG")
            .field(
                ...
                &self.reg_gpio_func9_in_inv_sel(),
            )
            .field("reg_gpio_sig9_in_sel", &self.reg_gpio_sig9_in_sel())
            .field("reg_gpio_func9_in_sel", &self.reg_gpio_func9_in_sel())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`func9_in_sel_cfg::R`](R) reader structure
impl crate::Readable for FUNC9_IN_SEL_CFG_SPEC {}
///`write(|w| ..)` method takes [`func9_in_sel_cfg::W`](W) writer structure
