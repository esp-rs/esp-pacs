...
///`read()` method returns [`pin1::R`](R) reader structure
impl crate::Readable for PIN1_SPEC {}
///`write(|w| ..)` method takes [`pin1::W`](W) writer structure
