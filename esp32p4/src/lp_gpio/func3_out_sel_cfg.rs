...
impl W {
    ...
    pub fn reg_gpio_func3_oe_inv_sel(
        &mut self,
    ) -> REG_GPIO_FUNC3_OE_INV_SEL_W<'_, FUNC3_OUT_SEL_CFG_SPEC> {
        REG_GPIO_FUNC3_OE_INV_SEL_W::new(self, 0)
    }
    #[doc = "Bit 1 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_func3_oe_sel(&mut self) -> REG_GPIO_FUNC3_OE_SEL_W<'_, FUNC3_OUT_SEL_CFG_SPEC> {
    ...
    pub fn reg_gpio_func3_out_inv_sel(
        &mut self,
    ) -> REG_GPIO_FUNC3_OUT_INV_SEL_W<'_, FUNC3_OUT_SEL_CFG_SPEC> {
        REG_GPIO_FUNC3_OUT_INV_SEL_W::new(self, 2)
    }
    #[doc = "Bits 3:8 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_func3_out_sel(
        &mut self,
    ) -> REG_GPIO_FUNC3_OUT_SEL_W<'_, FUNC3_OUT_SEL_CFG_SPEC> {
        REG_GPIO_FUNC3_OUT_SEL_W::new(self, 3)
    }
}
#[doc = "Reserved\n\nYou can [`read`](crate::Reg::read) this register and get [`func3_out_sel_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`func3_out_sel_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
