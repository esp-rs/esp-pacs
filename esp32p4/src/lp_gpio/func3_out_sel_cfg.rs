...
///`read()` method returns [`func3_out_sel_cfg::R`](R) reader structure
impl crate::Readable for FUNC3_OUT_SEL_CFG_SPEC {}
///`write(|w| ..)` method takes [`func3_out_sel_cfg::W`](W) writer structure
