    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PIN0")
            .field(
                ...
                &self.reg_gpio_pin0_wakeup_enable(),
            )
            .field("reg_gpio_pin0_int_type", &self.reg_gpio_pin0_int_type())
            .field("reg_gpio_pin0_pad_driver", &self.reg_gpio_pin0_pad_driver())
            .finish()
    }
}
impl W {
