    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC11_IN_SEL_CFG")
            .field(
                ...
                &self.reg_gpio_func11_in_inv_sel(),
            )
            .field("reg_gpio_sig11_in_sel", &self.reg_gpio_sig11_in_sel())
            .field("reg_gpio_func11_in_sel", &self.reg_gpio_func11_in_sel())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`func11_in_sel_cfg::R`](R) reader structure
impl crate::Readable for FUNC11_IN_SEL_CFG_SPEC {}
///`write(|w| ..)` method takes [`func11_in_sel_cfg::W`](W) writer structure
