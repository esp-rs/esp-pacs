...
///`read()` method returns [`pin12::R`](R) reader structure
impl crate::Readable for PIN12_SPEC {}
///`write(|w| ..)` method takes [`pin12::W`](W) writer structure
