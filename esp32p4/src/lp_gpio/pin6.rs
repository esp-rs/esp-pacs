...
///`read()` method returns [`pin6::R`](R) reader structure
impl crate::Readable for PIN6_SPEC {}
///`write(|w| ..)` method takes [`pin6::W`](W) writer structure
