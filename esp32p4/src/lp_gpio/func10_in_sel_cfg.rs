...
///`read()` method returns [`func10_in_sel_cfg::R`](R) reader structure
impl crate::Readable for FUNC10_IN_SEL_CFG_SPEC {}
///`write(|w| ..)` method takes [`func10_in_sel_cfg::W`](W) writer structure
