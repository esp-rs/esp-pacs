    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC8_OUT_SEL_CFG")
            .field(
                ...
                &format_args!("{}", self.reg_gpio_func8_oe_inv_sel().bit()),
            )
            .field(
                "reg_gpio_func8_oe_sel",
                &format_args!("{}", self.reg_gpio_func8_oe_sel().bit()),
            )
            .field(
                "reg_gpio_func8_out_inv_sel",
                &format_args!("{}", self.reg_gpio_func8_out_inv_sel().bit()),
            )
            .field(
                "reg_gpio_func8_out_sel",
                &format_args!("{}", self.reg_gpio_func8_out_sel().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<FUNC8_OUT_SEL_CFG_SPEC> {
