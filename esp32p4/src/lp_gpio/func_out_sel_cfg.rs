...
#[doc = "Field `OE_INV_SEL` reader - Reserved"]
pub type OE_INV_SEL_R = crate::BitReader;
#[doc = "Field `OE_INV_SEL` writer - Reserved"]
pub type OE_INV_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OE_SEL` reader - Reserved"]
pub type OE_SEL_R = crate::BitReader;
#[doc = "Field `OE_SEL` writer - Reserved"]
pub type OE_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_INV_SEL` reader - Reserved"]
pub type OUT_INV_SEL_R = crate::BitReader;
#[doc = "Field `OUT_INV_SEL` writer - Reserved"]
pub type OUT_INV_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_SEL` reader - reg_gpio_func_out_sel\\[5:1\\]==16 -> output gpio register value to pad"]
pub type OUT_SEL_R = crate::FieldReader;
#[doc = "Field `OUT_SEL` writer - reg_gpio_func_out_sel\\[5:1\\]==16 -> output gpio register value to pad"]
pub type OUT_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bit 0 - Reserved"]
    #[inline(always)]
    pub fn oe_inv_sel(&self) -> OE_INV_SEL_R {
        OE_INV_SEL_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Reserved"]
    #[inline(always)]
    pub fn oe_sel(&self) -> OE_SEL_R {
        OE_SEL_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn out_inv_sel(&self) -> OUT_INV_SEL_R {
        OUT_INV_SEL_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bits 3:8 - reg_gpio_func_out_sel\\[5:1\\]==16 -> output gpio register value to pad"]
    #[inline(always)]
    pub fn out_sel(&self) -> OUT_SEL_R {
        OUT_SEL_R::new(((self.bits >> 3) & 0x3f) as u8)
    }
}
