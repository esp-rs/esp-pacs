///Register `FRAM_NUM` reader
pub type R = crate::R<FRAM_NUM_SPEC>;
///Field `SOF_FRAME_INDEX` reader - Frame index of received SOF frame.
pub type SOF_FRAME_INDEX_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:10 - Frame index of received SOF frame.
    #[inline(always)]
...
///`read()` method returns [`fram_num::R`](R) reader structure
