///Register `ECO_HIGH_48` reader
pub type R = crate::R<ECO_HIGH_48_SPEC>;
///Register `ECO_HIGH_48` writer
pub type W = crate::W<ECO_HIGH_48_SPEC>;
///Field `RND_ECO_HIGH_48` reader - Reserved.
pub type RND_ECO_HIGH_48_R = crate::FieldReader<u32>;
///Field `RND_ECO_HIGH_48` writer - Reserved.
...
///`read()` method returns [`eco_high_48::R`](R) reader structure
impl crate::Readable for ECO_HIGH_48_SPEC {}
///`write(|w| ..)` method takes [`eco_high_48::W`](W) writer structure
