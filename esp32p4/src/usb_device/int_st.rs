...
///Field `JTAG_IN_FLUSH` reader - The raw interrupt status bit for the USB_DEVICE_JTAG_IN_FLUSH_INT interrupt.
...
///Field `SERIAL_OUT_RECV_PKT` reader - The raw interrupt status bit for the USB_DEVICE_SERIAL_OUT_RECV_PKT_INT interrupt.
pub type SERIAL_OUT_RECV_PKT_R = crate::BitReader;
///Field `SERIAL_IN_EMPTY` reader - The raw interrupt status bit for the USB_DEVICE_SERIAL_IN_EMPTY_INT interrupt.
pub type SERIAL_IN_EMPTY_R = crate::BitReader;
///Field `PID_ERR` reader - The raw interrupt status bit for the USB_DEVICE_PID_ERR_INT interrupt.
pub type PID_ERR_R = crate::BitReader;
///Field `CRC5_ERR` reader - The raw interrupt status bit for the USB_DEVICE_CRC5_ERR_INT interrupt.
pub type CRC5_ERR_R = crate::BitReader;
///Field `CRC16_ERR` reader - The raw interrupt status bit for the USB_DEVICE_CRC16_ERR_INT interrupt.
pub type CRC16_ERR_R = crate::BitReader;
///Field `STUFF_ERR` reader - The raw interrupt status bit for the USB_DEVICE_STUFF_ERR_INT interrupt.
pub type STUFF_ERR_R = crate::BitReader;
///Field `IN_TOKEN_REC_IN_EP1` reader - The raw interrupt status bit for the USB_DEVICE_IN_TOKEN_REC_IN_EP1_INT interrupt.
pub type IN_TOKEN_REC_IN_EP1_R = crate::BitReader;
///Field `USB_BUS_RESET` reader - The raw interrupt status bit for the USB_DEVICE_USB_BUS_RESET_INT interrupt.
pub type USB_BUS_RESET_R = crate::BitReader;
///Field `OUT_EP1_ZERO_PAYLOAD` reader - The raw interrupt status bit for the USB_DEVICE_OUT_EP1_ZERO_PAYLOAD_INT interrupt.
pub type OUT_EP1_ZERO_PAYLOAD_R = crate::BitReader;
///Field `OUT_EP2_ZERO_PAYLOAD` reader - The raw interrupt status bit for the USB_DEVICE_OUT_EP2_ZERO_PAYLOAD_INT interrupt.
pub type OUT_EP2_ZERO_PAYLOAD_R = crate::BitReader;
///Field `RTS_CHG` reader - The raw interrupt status bit for the USB_DEVICE_RTS_CHG_INT interrupt.
pub type RTS_CHG_R = crate::BitReader;
///Field `DTR_CHG` reader - The raw interrupt status bit for the USB_DEVICE_DTR_CHG_INT interrupt.
pub type DTR_CHG_R = crate::BitReader;
///Field `GET_LINE_CODE` reader - The raw interrupt status bit for the USB_DEVICE_GET_LINE_CODE_INT interrupt.
pub type GET_LINE_CODE_R = crate::BitReader;
///Field `SET_LINE_CODE` reader - The raw interrupt status bit for the USB_DEVICE_SET_LINE_CODE_INT interrupt.
...
impl R {
    ...
    ///Bit 12 - The raw interrupt status bit for the USB_DEVICE_RTS_CHG_INT interrupt.
    #[inline(always)]
    pub fn rts_chg(&self) -> RTS_CHG_R {
        RTS_CHG_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - The raw interrupt status bit for the USB_DEVICE_DTR_CHG_INT interrupt.
    #[inline(always)]
    pub fn dtr_chg(&self) -> DTR_CHG_R {
        DTR_CHG_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - The raw interrupt status bit for the USB_DEVICE_GET_LINE_CODE_INT interrupt.
    #[inline(always)]
    pub fn get_line_code(&self) -> GET_LINE_CODE_R {
        GET_LINE_CODE_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - The raw interrupt status bit for the USB_DEVICE_SET_LINE_CODE_INT interrupt.
    #[inline(always)]
