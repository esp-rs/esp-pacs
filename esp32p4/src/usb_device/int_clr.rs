...
impl W {
    ...
    pub fn usb_serial_jtag_jtag_in_flush_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT_CLR_W<INT_CLR_SPEC> {
        USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT_CLR_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set this bit to clear the USB_DEVICE_JTAG_SOF_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn usb_serial_jtag_sof_int_clr(&mut self) -> USB_SERIAL_JTAG_SOF_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_serial_out_recv_pkt_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_serial_in_empty_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_pid_err_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_PID_ERR_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_crc5_err_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_CRC5_ERR_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_crc16_err_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_CRC16_ERR_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_stuff_err_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_STUFF_ERR_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_in_token_rec_in_ep1_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_usb_bus_reset_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_USB_BUS_RESET_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_out_ep1_zero_payload_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_OUT_EP1_ZERO_PAYLOAD_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_out_ep2_zero_payload_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_OUT_EP2_ZERO_PAYLOAD_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_rts_chg_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_RTS_CHG_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_dtr_chg_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_DTR_CHG_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_get_line_code_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_GET_LINE_CODE_INT_CLR_W<INT_CLR_SPEC> {
    ...
    pub fn usb_serial_jtag_set_line_code_int_clr(
        &mut self,
    ) -> USB_SERIAL_JTAG_SET_LINE_CODE_INT_CLR_W<INT_CLR_SPEC> {
