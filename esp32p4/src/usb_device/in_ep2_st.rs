///Register `IN_EP2_ST` reader
pub type R = crate::R<IN_EP2_ST_SPEC>;
///Field `IN_EP2_STATE` reader - State of IN Endpoint 2.
pub type IN_EP2_STATE_R = crate::FieldReader;
///Field `IN_EP2_WR_ADDR` reader - Write data address of IN endpoint 2.
pub type IN_EP2_WR_ADDR_R = crate::FieldReader;
///Field `IN_EP2_RD_ADDR` reader - Read data address of IN endpoint 2.
...
///`read()` method returns [`in_ep2_st::R`](R) reader structure
