...
///Field `CORE_0_SP_SPILL_MIN_CLR` writer - Core0 stackpoint underflow monitor interrupt clr
pub type CORE_0_SP_SPILL_MIN_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_SP_SPILL_MAX_CLR` writer - Core0 stackpoint overflow monitor interrupt clr
...
impl W {
    ...
    ///Bit 8 - Core0 stackpoint underflow monitor interrupt clr
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 9 - Core0 stackpoint overflow monitor interrupt clr
    #[inline(always)]
    #[must_use]
