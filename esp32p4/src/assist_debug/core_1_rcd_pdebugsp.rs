///Register `CORE_1_RCD_PDEBUGSP` reader
pub type R = crate::R<CORE_1_RCD_PDEBUGSP_SPEC>;
///Field `CORE_1_RCD_PDEBUGSP` reader - recorded sp
pub type CORE_1_RCD_PDEBUGSP_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - recorded sp
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_1_rcd_pdebugsp::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_1_RCD_PDEBUGSP_SPEC;
impl crate::RegisterSpec for CORE_1_RCD_PDEBUGSP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_1_rcd_pdebugsp::R`](R) reader structure
