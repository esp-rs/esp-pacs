...
impl W {
    ...
    pub fn core_0_area_dram0_0_rd_ena(
        &mut self,
    ) -> CORE_0_AREA_DRAM0_0_RD_ENA_W<CORE_0_INTR_ENA_SPEC> {
    ...
    pub fn core_0_area_dram0_0_wr_ena(
        &mut self,
    ) -> CORE_0_AREA_DRAM0_0_WR_ENA_W<CORE_0_INTR_ENA_SPEC> {
    ...
    pub fn core_0_area_dram0_1_rd_ena(
        &mut self,
    ) -> CORE_0_AREA_DRAM0_1_RD_ENA_W<CORE_0_INTR_ENA_SPEC> {
    ...
    pub fn core_0_area_dram0_1_wr_ena(
        &mut self,
    ) -> CORE_0_AREA_DRAM0_1_WR_ENA_W<CORE_0_INTR_ENA_SPEC> {
        CORE_0_AREA_DRAM0_1_WR_ENA_W::new(self, 3)
    }
    ///Bit 4 - Core0 PIF area0 read monitor enable
    #[inline(always)]
    #[must_use]
    pub fn core_0_area_pif_0_rd_ena(&mut self) -> CORE_0_AREA_PIF_0_RD_ENA_W<CORE_0_INTR_ENA_SPEC> {
        CORE_0_AREA_PIF_0_RD_ENA_W::new(self, 4)
    }
    ///Bit 5 - Core0 PIF area0 write monitor enable
    #[inline(always)]
    #[must_use]
    pub fn core_0_area_pif_0_wr_ena(&mut self) -> CORE_0_AREA_PIF_0_WR_ENA_W<CORE_0_INTR_ENA_SPEC> {
        CORE_0_AREA_PIF_0_WR_ENA_W::new(self, 5)
    }
    ///Bit 6 - Core0 PIF area1 read monitor enable
    #[inline(always)]
    #[must_use]
    pub fn core_0_area_pif_1_rd_ena(&mut self) -> CORE_0_AREA_PIF_1_RD_ENA_W<CORE_0_INTR_ENA_SPEC> {
        CORE_0_AREA_PIF_1_RD_ENA_W::new(self, 6)
    }
    ///Bit 7 - Core0 PIF area1 write monitor enable
    #[inline(always)]
    #[must_use]
    pub fn core_0_area_pif_1_wr_ena(&mut self) -> CORE_0_AREA_PIF_1_WR_ENA_W<CORE_0_INTR_ENA_SPEC> {
        CORE_0_AREA_PIF_1_WR_ENA_W::new(self, 7)
    }
    ///Bit 8 - Core0 stackpoint underflow monitor enable
    #[inline(always)]
    #[must_use]
    pub fn core_0_sp_spill_min_ena(&mut self) -> CORE_0_SP_SPILL_MIN_ENA_W<CORE_0_INTR_ENA_SPEC> {
        CORE_0_SP_SPILL_MIN_ENA_W::new(self, 8)
    }
    ///Bit 9 - Core0 stackpoint overflow monitor enable
    #[inline(always)]
    #[must_use]
    pub fn core_0_sp_spill_max_ena(&mut self) -> CORE_0_SP_SPILL_MAX_ENA_W<CORE_0_INTR_ENA_SPEC> {
    ...
    pub fn core_0_iram0_exception_monitor_ena(
        &mut self,
    ) -> CORE_0_IRAM0_EXCEPTION_MONITOR_ENA_W<CORE_0_INTR_ENA_SPEC> {
    ...
    pub fn core_0_dram0_exception_monitor_ena(
        &mut self,
    ) -> CORE_0_DRAM0_EXCEPTION_MONITOR_ENA_W<CORE_0_INTR_ENA_SPEC> {
