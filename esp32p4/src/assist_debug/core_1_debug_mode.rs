///Register `CORE_1_DEBUG_MODE` reader
pub type R = crate::R<CORE_1_DEBUG_MODE_SPEC>;
///Field `CORE_1_DEBUG_MODE` reader - cpu debug mode status, 1 means cpu enter debug mode.
pub type CORE_1_DEBUG_MODE_R = crate::BitReader;
///Field `CORE_1_DEBUG_MODULE_ACTIVE` reader - cpu debug_module active status
...
///`read()` method returns [`core_1_debug_mode::R`](R) reader structure
