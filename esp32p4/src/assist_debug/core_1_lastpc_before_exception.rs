///Register `CORE_1_LASTPC_BEFORE_EXCEPTION` reader
pub type R = crate::R<CORE_1_LASTPC_BEFORE_EXCEPTION_SPEC>;
///Field `CORE_1_LASTPC_BEFORE_EXC` reader - cpu's lastpc before exception
...
///`read()` method returns [`core_1_lastpc_before_exception::R`](R) reader structure
