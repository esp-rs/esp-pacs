///Register `CORE_1_AREA_PIF_0_MIN` reader
pub type R = crate::R<CORE_1_AREA_PIF_0_MIN_SPEC>;
///Register `CORE_1_AREA_PIF_0_MIN` writer
pub type W = crate::W<CORE_1_AREA_PIF_0_MIN_SPEC>;
///Field `CORE_1_AREA_PIF_0_MIN` reader - Core1 PIF region0 start addr
pub type CORE_1_AREA_PIF_0_MIN_R = crate::FieldReader<u32>;
///Field `CORE_1_AREA_PIF_0_MIN` writer - Core1 PIF region0 start addr
pub type CORE_1_AREA_PIF_0_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core1 PIF region0 start addr
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_area_pif_0_min(&mut self) -> CORE_1_AREA_PIF_0_MIN_W<CORE_1_AREA_PIF_0_MIN_SPEC> {
...
///`read()` method returns [`core_1_area_pif_0_min::R`](R) reader structure
impl crate::Readable for CORE_1_AREA_PIF_0_MIN_SPEC {}
///`write(|w| ..)` method takes [`core_1_area_pif_0_min::W`](W) writer structure
