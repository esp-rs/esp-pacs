///Register `CORE_1_INTR_RLS` reader
pub type R = crate::R<CORE_1_INTR_RLS_SPEC>;
///Register `CORE_1_INTR_RLS` writer
pub type W = crate::W<CORE_1_INTR_RLS_SPEC>;
///Field `CORE_1_AREA_DRAM0_0_RD_RLS` reader - Core1 dram0 area0 read monitor interrupt enable
pub type CORE_1_AREA_DRAM0_0_RD_RLS_R = crate::BitReader;
///Field `CORE_1_AREA_DRAM0_0_RD_RLS` writer - Core1 dram0 area0 read monitor interrupt enable
pub type CORE_1_AREA_DRAM0_0_RD_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_DRAM0_0_WR_RLS` reader - Core1 dram0 area0 write monitor interrupt enable
pub type CORE_1_AREA_DRAM0_0_WR_RLS_R = crate::BitReader;
///Field `CORE_1_AREA_DRAM0_0_WR_RLS` writer - Core1 dram0 area0 write monitor interrupt enable
pub type CORE_1_AREA_DRAM0_0_WR_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_DRAM0_1_RD_RLS` reader - Core1 dram0 area1 read monitor interrupt enable
pub type CORE_1_AREA_DRAM0_1_RD_RLS_R = crate::BitReader;
///Field `CORE_1_AREA_DRAM0_1_RD_RLS` writer - Core1 dram0 area1 read monitor interrupt enable
pub type CORE_1_AREA_DRAM0_1_RD_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_DRAM0_1_WR_RLS` reader - Core1 dram0 area1 write monitor interrupt enable
pub type CORE_1_AREA_DRAM0_1_WR_RLS_R = crate::BitReader;
///Field `CORE_1_AREA_DRAM0_1_WR_RLS` writer - Core1 dram0 area1 write monitor interrupt enable
pub type CORE_1_AREA_DRAM0_1_WR_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_PIF_0_RD_RLS` reader - Core1 PIF area0 read monitor interrupt enable
pub type CORE_1_AREA_PIF_0_RD_RLS_R = crate::BitReader;
///Field `CORE_1_AREA_PIF_0_RD_RLS` writer - Core1 PIF area0 read monitor interrupt enable
pub type CORE_1_AREA_PIF_0_RD_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_PIF_0_WR_RLS` reader - Core1 PIF area0 write monitor interrupt enable
pub type CORE_1_AREA_PIF_0_WR_RLS_R = crate::BitReader;
///Field `CORE_1_AREA_PIF_0_WR_RLS` writer - Core1 PIF area0 write monitor interrupt enable
pub type CORE_1_AREA_PIF_0_WR_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_PIF_1_RD_RLS` reader - Core1 PIF area1 read monitor interrupt enable
pub type CORE_1_AREA_PIF_1_RD_RLS_R = crate::BitReader;
///Field `CORE_1_AREA_PIF_1_RD_RLS` writer - Core1 PIF area1 read monitor interrupt enable
pub type CORE_1_AREA_PIF_1_RD_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_PIF_1_WR_RLS` reader - Core1 PIF area1 write monitor interrupt enable
pub type CORE_1_AREA_PIF_1_WR_RLS_R = crate::BitReader;
///Field `CORE_1_AREA_PIF_1_WR_RLS` writer - Core1 PIF area1 write monitor interrupt enable
pub type CORE_1_AREA_PIF_1_WR_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_SP_SPILL_MIN_RLS` reader - Core1 stackpoint underflow monitor interrupt enable
pub type CORE_1_SP_SPILL_MIN_RLS_R = crate::BitReader;
///Field `CORE_1_SP_SPILL_MIN_RLS` writer - Core1 stackpoint underflow monitor interrupt enable
pub type CORE_1_SP_SPILL_MIN_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_SP_SPILL_MAX_RLS` reader - Core1 stackpoint overflow monitor interrupt enable
pub type CORE_1_SP_SPILL_MAX_RLS_R = crate::BitReader;
///Field `CORE_1_SP_SPILL_MAX_RLS` writer - Core1 stackpoint overflow monitor interrupt enable
pub type CORE_1_SP_SPILL_MAX_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_IRAM0_EXCEPTION_MONITOR_RLS` reader - IBUS busy monitor interrupt enable
pub type CORE_1_IRAM0_EXCEPTION_MONITOR_RLS_R = crate::BitReader;
///Field `CORE_1_IRAM0_EXCEPTION_MONITOR_RLS` writer - IBUS busy monitor interrupt enable
pub type CORE_1_IRAM0_EXCEPTION_MONITOR_RLS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_DRAM0_EXCEPTION_MONITOR_RLS` reader - DBUS busy monitor interrupt enbale
pub type CORE_1_DRAM0_EXCEPTION_MONITOR_RLS_R = crate::BitReader;
///Field `CORE_1_DRAM0_EXCEPTION_MONITOR_RLS` writer - DBUS busy monitor interrupt enbale
...
impl R {
    ...
    ///Bit 8 - Core1 stackpoint underflow monitor interrupt enable
    #[inline(always)]
    pub fn core_1_sp_spill_min_rls(&self) -> CORE_1_SP_SPILL_MIN_RLS_R {
        CORE_1_SP_SPILL_MIN_RLS_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Core1 stackpoint overflow monitor interrupt enable
    #[inline(always)]
...
///`read()` method returns [`core_1_intr_rls::R`](R) reader structure
impl crate::Readable for CORE_1_INTR_RLS_SPEC {}
///`write(|w| ..)` method takes [`core_1_intr_rls::W`](W) writer structure
