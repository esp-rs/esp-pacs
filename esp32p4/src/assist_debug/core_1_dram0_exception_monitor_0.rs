...
///Field `CORE_1_DRAM0_RECORDING_WR_0` reader - reg_core_1_dram0_recording_wr_0
pub type CORE_1_DRAM0_RECORDING_WR_0_R = crate::BitReader;
///Field `CORE_1_DRAM0_RECORDING_BYTEEN_0` reader - reg_core_1_dram0_recording_byteen_0
pub type CORE_1_DRAM0_RECORDING_BYTEEN_0_R = crate::FieldReader<u16>;
impl R {
    ///Bit 0 - reg_core_1_dram0_recording_wr_0
    #[inline(always)]
    pub fn core_1_dram0_recording_wr_0(&self) -> CORE_1_DRAM0_RECORDING_WR_0_R {
        CORE_1_DRAM0_RECORDING_WR_0_R::new((self.bits & 1) != 0)
    }
    ///Bits 1:16 - reg_core_1_dram0_recording_byteen_0
    #[inline(always)]
