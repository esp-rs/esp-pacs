///Register `CORE_1_AREA_DRAM0_0_MAX` reader
pub type R = crate::R<CORE_1_AREA_DRAM0_0_MAX_SPEC>;
///Register `CORE_1_AREA_DRAM0_0_MAX` writer
pub type W = crate::W<CORE_1_AREA_DRAM0_0_MAX_SPEC>;
///Field `CORE_1_AREA_DRAM0_0_MAX` reader - Core1 dram0 region0 end addr
pub type CORE_1_AREA_DRAM0_0_MAX_R = crate::FieldReader<u32>;
///Field `CORE_1_AREA_DRAM0_0_MAX` writer - Core1 dram0 region0 end addr
pub type CORE_1_AREA_DRAM0_0_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core1 dram0 region0 end addr
    #[inline(always)]
...
///`read()` method returns [`core_1_area_dram0_0_max::R`](R) reader structure
impl crate::Readable for CORE_1_AREA_DRAM0_0_MAX_SPEC {}
///`write(|w| ..)` method takes [`core_1_area_dram0_0_max::W`](W) writer structure
