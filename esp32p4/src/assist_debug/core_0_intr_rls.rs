...
impl W {
    ...
    pub fn core_0_area_dram0_0_rd_rls(
        &mut self,
    ) -> CORE_0_AREA_DRAM0_0_RD_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_area_dram0_0_wr_rls(
        &mut self,
    ) -> CORE_0_AREA_DRAM0_0_WR_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_area_dram0_1_rd_rls(
        &mut self,
    ) -> CORE_0_AREA_DRAM0_1_RD_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_area_dram0_1_wr_rls(
        &mut self,
    ) -> CORE_0_AREA_DRAM0_1_WR_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_area_pif_0_rd_rls(
        &mut self,
    ) -> CORE_0_AREA_PIF_0_RD_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_area_pif_0_wr_rls(
        &mut self,
    ) -> CORE_0_AREA_PIF_0_WR_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_area_pif_1_rd_rls(
        &mut self,
    ) -> CORE_0_AREA_PIF_1_RD_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_area_pif_1_wr_rls(
        &mut self,
    ) -> CORE_0_AREA_PIF_1_WR_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_sp_spill_min_rls(
        &mut self,
    ) -> CORE_0_SP_SPILL_MIN_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_sp_spill_max_rls(
        &mut self,
    ) -> CORE_0_SP_SPILL_MAX_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_iram0_exception_monitor_rls(
        &mut self,
    ) -> CORE_0_IRAM0_EXCEPTION_MONITOR_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
    ...
    pub fn core_0_dram0_exception_monitor_rls(
        &mut self,
    ) -> CORE_0_DRAM0_EXCEPTION_MONITOR_RLS_W<'_, CORE_0_INTR_RLS_SPEC> {
