///Register `CLUT_CNT` reader
pub type R = crate::R<CLUT_CNT_SPEC>;
///Field `BLEND0_CLUT_CNT` reader - The write data counter of BLEND0 CLUT in fifo mode.
pub type BLEND0_CLUT_CNT_R = crate::FieldReader<u16>;
///Field `BLEND1_CLUT_CNT` reader - The write data counter of BLEND1 CLUT in fifo mode.
pub type BLEND1_CLUT_CNT_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:8 - The write data counter of BLEND0 CLUT in fifo mode.
    #[inline(always)]
    pub fn blend0_clut_cnt(&self) -> BLEND0_CLUT_CNT_R {
        BLEND0_CLUT_CNT_R::new((self.bits & 0x01ff) as u16)
    }
    ///Bits 9:17 - The write data counter of BLEND1 CLUT in fifo mode.
    #[inline(always)]
...
///`read()` method returns [`clut_cnt::R`](R) reader structure
