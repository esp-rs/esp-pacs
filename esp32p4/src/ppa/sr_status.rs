///Register `SR_STATUS` reader
pub type R = crate::R<SR_STATUS_SPEC>;
///Field `SR_RX_DSCR_SAMPLE_STATE` reader - Reserved.
pub type SR_RX_DSCR_SAMPLE_STATE_R = crate::FieldReader;
///Field `SR_RX_SCAN_STATE` reader - Reserved.
pub type SR_RX_SCAN_STATE_R = crate::FieldReader;
///Field `SR_TX_DSCR_SAMPLE_STATE` reader - Reserved.
pub type SR_TX_DSCR_SAMPLE_STATE_R = crate::FieldReader;
///Field `SR_TX_SCAN_STATE` reader - Reserved.
...
///`read()` method returns [`sr_status::R`](R) reader structure
