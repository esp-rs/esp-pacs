///Register `CLUT_CONF` reader
pub type R = crate::R<CLUT_CONF_SPEC>;
///Register `CLUT_CONF` writer
...
///Field `APB_FIFO_MASK` writer - 1'b0: fifo mode to wr/rd clut0/clut1 RAM through register PPA_SR_CLUT_DATA_REG/PPA_BLEND0_CLUT_DATA_REG/PPA_BLEND1_CLUT_DATA_REG. 1'b1: memory mode to wr/rd sr/blend0/blend1 clut RAM. The bit 11 and 10 of the waddr should be 01 to access sr clut and should be 10 to access blend0 clut and should be 11 to access blend 1 clut in memory mode.
pub type APB_FIFO_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BLEND0_CLUT_MEM_RST` reader - Write 1 then write 0 to this bit to reset BLEND0 CLUT.
pub type BLEND0_CLUT_MEM_RST_R = crate::BitReader;
///Field `BLEND0_CLUT_MEM_RST` writer - Write 1 then write 0 to this bit to reset BLEND0 CLUT.
pub type BLEND0_CLUT_MEM_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BLEND1_CLUT_MEM_RST` reader - Write 1 then write 0 to this bit to reset BLEND1 CLUT.
pub type BLEND1_CLUT_MEM_RST_R = crate::BitReader;
///Field `BLEND1_CLUT_MEM_RST` writer - Write 1 then write 0 to this bit to reset BLEND1 CLUT.
pub type BLEND1_CLUT_MEM_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BLEND0_CLUT_MEM_RDADDR_RST` reader - Write 1 then write 0 to reset the read address of BLEND0 CLUT in fifo mode.
pub type BLEND0_CLUT_MEM_RDADDR_RST_R = crate::BitReader;
///Field `BLEND0_CLUT_MEM_RDADDR_RST` writer - Write 1 then write 0 to reset the read address of BLEND0 CLUT in fifo mode.
pub type BLEND0_CLUT_MEM_RDADDR_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BLEND1_CLUT_MEM_RDADDR_RST` reader - Write 1 then write 0 to reset the read address of BLEND1 CLUT in fifo mode.
pub type BLEND1_CLUT_MEM_RDADDR_RST_R = crate::BitReader;
///Field `BLEND1_CLUT_MEM_RDADDR_RST` writer - Write 1 then write 0 to reset the read address of BLEND1 CLUT in fifo mode.
pub type BLEND1_CLUT_MEM_RDADDR_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BLEND0_CLUT_MEM_FORCE_PD` reader - 1: force power down BLEND CLUT memory.
pub type BLEND0_CLUT_MEM_FORCE_PD_R = crate::BitReader;
///Field `BLEND0_CLUT_MEM_FORCE_PD` writer - 1: force power down BLEND CLUT memory.
pub type BLEND0_CLUT_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BLEND0_CLUT_MEM_FORCE_PU` reader - 1: force power up BLEND CLUT memory.
pub type BLEND0_CLUT_MEM_FORCE_PU_R = crate::BitReader;
///Field `BLEND0_CLUT_MEM_FORCE_PU` writer - 1: force power up BLEND CLUT memory.
pub type BLEND0_CLUT_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BLEND0_CLUT_MEM_CLK_ENA` reader - 1: Force clock on for BLEND CLUT memory.
pub type BLEND0_CLUT_MEM_CLK_ENA_R = crate::BitReader;
///Field `BLEND0_CLUT_MEM_CLK_ENA` writer - 1: Force clock on for BLEND CLUT memory.
...
impl R {
    ...
    ///Bit 1 - Write 1 then write 0 to this bit to reset BLEND0 CLUT.
    #[inline(always)]
    pub fn blend0_clut_mem_rst(&self) -> BLEND0_CLUT_MEM_RST_R {
        BLEND0_CLUT_MEM_RST_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Write 1 then write 0 to this bit to reset BLEND1 CLUT.
    #[inline(always)]
...
///`read()` method returns [`clut_conf::R`](R) reader structure
impl crate::Readable for CLUT_CONF_SPEC {}
///`write(|w| ..)` method takes [`clut_conf::W`](W) writer structure
