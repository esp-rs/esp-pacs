///Register `SR_COLOR_MODE` reader
pub type R = crate::R<SR_COLOR_MODE_SPEC>;
///Register `SR_COLOR_MODE` writer
pub type W = crate::W<SR_COLOR_MODE_SPEC>;
///Field `SR_RX_CM` reader - The source image color mode for Scaling and Rotating engine Rx. 0: ARGB8888. 1: RGB888. 2: RGB565. 8: YUV420. others: Reserved.
pub type SR_RX_CM_R = crate::FieldReader;
///Field `SR_RX_CM` writer - The source image color mode for Scaling and Rotating engine Rx. 0: ARGB8888. 1: RGB888. 2: RGB565. 8: YUV420. others: Reserved.
pub type SR_RX_CM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SR_TX_CM` reader - The destination image color mode for Scaling and Rotating engine Tx. 0: ARGB8888. 1: RGB888. 2: RGB565. 8: YUV420. others: Reserved.
pub type SR_TX_CM_R = crate::FieldReader;
///Field `SR_TX_CM` writer - The destination image color mode for Scaling and Rotating engine Tx. 0: ARGB8888. 1: RGB888. 2: RGB565. 8: YUV420. others: Reserved.
pub type SR_TX_CM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `YUV_RX_RANGE` reader - YUV input range when reg_sr_rx_cm is 4'd8. 0: limit range. 1: full range
pub type YUV_RX_RANGE_R = crate::BitReader;
///Field `YUV_RX_RANGE` writer - YUV input range when reg_sr_rx_cm is 4'd8. 0: limit range. 1: full range
pub type YUV_RX_RANGE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `YUV_TX_RANGE` reader - YUV output range when reg_sr_tx_cm is 4'd8. 0: limit range. 1: full range
pub type YUV_TX_RANGE_R = crate::BitReader;
///Field `YUV_TX_RANGE` writer - YUV output range when reg_sr_tx_cm is 4'd8. 0: limit range. 1: full range
pub type YUV_TX_RANGE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `YUV2RGB_PROTOCAL` reader - YUV to RGB protocal when reg_sr_rx_cm is 4'd8. 0: BT601. 1: BT709
pub type YUV2RGB_PROTOCAL_R = crate::BitReader;
///Field `YUV2RGB_PROTOCAL` writer - YUV to RGB protocal when reg_sr_rx_cm is 4'd8. 0: BT601. 1: BT709
pub type YUV2RGB_PROTOCAL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RGB2YUV_PROTOCAL` reader - RGB to YUV protocal when reg_sr_tx_cm is 4'd8. 0: BT601. 1: BT709
pub type RGB2YUV_PROTOCAL_R = crate::BitReader;
///Field `RGB2YUV_PROTOCAL` writer - RGB to YUV protocal when reg_sr_tx_cm is 4'd8. 0: BT601. 1: BT709
pub type RGB2YUV_PROTOCAL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:3 - The source image color mode for Scaling and Rotating engine Rx. 0: ARGB8888. 1: RGB888. 2: RGB565. 8: YUV420. others: Reserved.
    #[inline(always)]
    pub fn sr_rx_cm(&self) -> SR_RX_CM_R {
        SR_RX_CM_R::new((self.bits & 0x0f) as u8)
    }
    ///Bits 4:7 - The destination image color mode for Scaling and Rotating engine Tx. 0: ARGB8888. 1: RGB888. 2: RGB565. 8: YUV420. others: Reserved.
    #[inline(always)]
    pub fn sr_tx_cm(&self) -> SR_TX_CM_R {
        SR_TX_CM_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
    ///Bit 8 - YUV input range when reg_sr_rx_cm is 4'd8. 0: limit range. 1: full range
    #[inline(always)]
    pub fn yuv_rx_range(&self) -> YUV_RX_RANGE_R {
        YUV_RX_RANGE_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - YUV output range when reg_sr_tx_cm is 4'd8. 0: limit range. 1: full range
    #[inline(always)]
    pub fn yuv_tx_range(&self) -> YUV_TX_RANGE_R {
        YUV_TX_RANGE_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - YUV to RGB protocal when reg_sr_rx_cm is 4'd8. 0: BT601. 1: BT709
    #[inline(always)]
    pub fn yuv2rgb_protocal(&self) -> YUV2RGB_PROTOCAL_R {
        YUV2RGB_PROTOCAL_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - RGB to YUV protocal when reg_sr_tx_cm is 4'd8. 0: BT601. 1: BT709
    #[inline(always)]
...
///`read()` method returns [`sr_color_mode::R`](R) reader structure
impl crate::Readable for SR_COLOR_MODE_SPEC {}
///`write(|w| ..)` method takes [`sr_color_mode::W`](W) writer structure
