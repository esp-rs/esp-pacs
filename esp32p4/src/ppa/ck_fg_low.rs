///Register `CK_FG_LOW` reader
pub type R = crate::R<CK_FG_LOW_SPEC>;
///Register `CK_FG_LOW` writer
pub type W = crate::W<CK_FG_LOW_SPEC>;
///Field `COLORKEY_FG_B_LOW` reader - color key lower threshold of foreground b channel
pub type COLORKEY_FG_B_LOW_R = crate::FieldReader;
///Field `COLORKEY_FG_B_LOW` writer - color key lower threshold of foreground b channel
pub type COLORKEY_FG_B_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `COLORKEY_FG_G_LOW` reader - color key lower threshold of foreground g channel
pub type COLORKEY_FG_G_LOW_R = crate::FieldReader;
///Field `COLORKEY_FG_G_LOW` writer - color key lower threshold of foreground g channel
pub type COLORKEY_FG_G_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `COLORKEY_FG_R_LOW` reader - color key lower threshold of foreground r channel
pub type COLORKEY_FG_R_LOW_R = crate::FieldReader;
///Field `COLORKEY_FG_R_LOW` writer - color key lower threshold of foreground r channel
pub type COLORKEY_FG_R_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - color key lower threshold of foreground b channel
    #[inline(always)]
    pub fn colorkey_fg_b_low(&self) -> COLORKEY_FG_B_LOW_R {
        COLORKEY_FG_B_LOW_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - color key lower threshold of foreground g channel
    #[inline(always)]
    pub fn colorkey_fg_g_low(&self) -> COLORKEY_FG_G_LOW_R {
        COLORKEY_FG_G_LOW_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - color key lower threshold of foreground r channel
    #[inline(always)]
...
///`read()` method returns [`ck_fg_low::R`](R) reader structure
impl crate::Readable for CK_FG_LOW_SPEC {}
///`write(|w| ..)` method takes [`ck_fg_low::W`](W) writer structure
