///Register `BLEND_ST` reader
pub type R = crate::R<BLEND_ST_SPEC>;
///Field `BLEND_SIZE_DIFF_ST` reader - 1: indicate the size of two image is different.
pub type BLEND_SIZE_DIFF_ST_R = crate::BitReader;
impl R {
    ///Bit 0 - 1: indicate the size of two image is different.
    #[inline(always)]
...
///`read()` method returns [`blend_st::R`](R) reader structure
