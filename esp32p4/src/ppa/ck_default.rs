///Register `CK_DEFAULT` reader
pub type R = crate::R<CK_DEFAULT_SPEC>;
///Register `CK_DEFAULT` writer
pub type W = crate::W<CK_DEFAULT_SPEC>;
///Field `COLORKEY_DEFAULT_B` reader - default B channle value of color key
pub type COLORKEY_DEFAULT_B_R = crate::FieldReader;
///Field `COLORKEY_DEFAULT_B` writer - default B channle value of color key
pub type COLORKEY_DEFAULT_B_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `COLORKEY_DEFAULT_G` reader - default G channle value of color key
pub type COLORKEY_DEFAULT_G_R = crate::FieldReader;
///Field `COLORKEY_DEFAULT_G` writer - default G channle value of color key
pub type COLORKEY_DEFAULT_G_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `COLORKEY_DEFAULT_R` reader - default R channle value of color key
pub type COLORKEY_DEFAULT_R_R = crate::FieldReader;
///Field `COLORKEY_DEFAULT_R` writer - default R channle value of color key
pub type COLORKEY_DEFAULT_R_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `COLORKEY_FG_BG_REVERSE` reader - when pixel in bg ck range but not in fg ck range, 0: the result is bg, 1: the result is fg
pub type COLORKEY_FG_BG_REVERSE_R = crate::BitReader;
///Field `COLORKEY_FG_BG_REVERSE` writer - when pixel in bg ck range but not in fg ck range, 0: the result is bg, 1: the result is fg
...
///`read()` method returns [`ck_default::R`](R) reader structure
impl crate::Readable for CK_DEFAULT_SPEC {}
///`write(|w| ..)` method takes [`ck_default::W`](W) writer structure
