...
///`read()` method returns [`sram_ctrl::R`](R) reader structure
impl crate::Readable for SRAM_CTRL_SPEC {}
///`write(|w| ..)` method takes [`sram_ctrl::W`](W) writer structure
