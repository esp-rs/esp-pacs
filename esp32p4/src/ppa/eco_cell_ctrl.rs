///Register `ECO_CELL_CTRL` reader
pub type R = crate::R<ECO_CELL_CTRL_SPEC>;
///Register `ECO_CELL_CTRL` writer
pub type W = crate::W<ECO_CELL_CTRL_SPEC>;
///Field `RDN_RESULT` reader - Reserved.
pub type RDN_RESULT_R = crate::BitReader;
///Field `RDN_ENA` reader - Reserved.
pub type RDN_ENA_R = crate::BitReader;
///Field `RDN_ENA` writer - Reserved.
...
///`read()` method returns [`eco_cell_ctrl::R`](R) reader structure
impl crate::Readable for ECO_CELL_CTRL_SPEC {}
///`write(|w| ..)` method takes [`eco_cell_ctrl::W`](W) writer structure
