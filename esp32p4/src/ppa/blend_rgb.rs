...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLEND_RGB")
            .field("blend1_rx_b", &self.blend1_rx_b())
            .field("blend1_rx_g", &self.blend1_rx_g())
            .field("blend1_rx_r", &self.blend1_rx_r())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`blend_rgb::R`](R) reader structure
impl crate::Readable for BLEND_RGB_SPEC {}
///`write(|w| ..)` method takes [`blend_rgb::W`](W) writer structure
