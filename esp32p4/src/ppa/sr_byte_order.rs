///Register `SR_BYTE_ORDER` reader
pub type R = crate::R<SR_BYTE_ORDER_SPEC>;
///Register `SR_BYTE_ORDER` writer
pub type W = crate::W<SR_BYTE_ORDER_SPEC>;
///Field `SR_RX_BYTE_SWAP_EN` reader - Set this bit to 1 the data into Rx channel 0 would be swapped in byte. The Byte0 and Byte1 would be swapped while byte 2 and byte 3 would be swappped.
pub type SR_RX_BYTE_SWAP_EN_R = crate::BitReader;
///Field `SR_RX_BYTE_SWAP_EN` writer - Set this bit to 1 the data into Rx channel 0 would be swapped in byte. The Byte0 and Byte1 would be swapped while byte 2 and byte 3 would be swappped.
pub type SR_RX_BYTE_SWAP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SR_RX_RGB_SWAP_EN` reader - Set this bit to 1 the data into Rx channel 0 would be swapped in rgb. It means rgb would be swap to bgr.
pub type SR_RX_RGB_SWAP_EN_R = crate::BitReader;
///Field `SR_RX_RGB_SWAP_EN` writer - Set this bit to 1 the data into Rx channel 0 would be swapped in rgb. It means rgb would be swap to bgr.
pub type SR_RX_RGB_SWAP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SR_MACRO_BK_RO_BYPASS` reader - Set this bit to 1 to bypass the macro block order function. This function is used to improve efficient accessing external memory.
pub type SR_MACRO_BK_RO_BYPASS_R = crate::BitReader;
///Field `SR_MACRO_BK_RO_BYPASS` writer - Set this bit to 1 to bypass the macro block order function. This function is used to improve efficient accessing external memory.
...
impl R {
    ...
    ///Bit 1 - Set this bit to 1 the data into Rx channel 0 would be swapped in rgb. It means rgb would be swap to bgr.
    #[inline(always)]
...
///`read()` method returns [`sr_byte_order::R`](R) reader structure
impl crate::Readable for SR_BYTE_ORDER_SPEC {}
///`write(|w| ..)` method takes [`sr_byte_order::W`](W) writer structure
