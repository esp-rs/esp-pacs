...
///Field `SR_EOF` writer - Set this bit to clear the PPA_SR_EOF_INT interrupt.
pub type SR_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `BLEND_EOF` writer - Set this bit to clear the PPA_BLEND_EOF_INT interrupt.
pub type BLEND_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `SR_PARAM_CFG_ERR` writer - Set this bit to clear the PPA_SR_RX_YSCAL_ERR_INT interrupt.
...
impl W {
    ///Bit 0 - Set this bit to clear the PPA_SR_EOF_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn sr_eof(&mut self) -> SR_EOF_W<INT_CLR_SPEC> {
        SR_EOF_W::new(self, 0)
    }
    ///Bit 1 - Set this bit to clear the PPA_BLEND_EOF_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn blend_eof(&mut self) -> BLEND_EOF_W<INT_CLR_SPEC> {
        BLEND_EOF_W::new(self, 1)
    }
    ///Bit 2 - Set this bit to clear the PPA_SR_RX_YSCAL_ERR_INT interrupt.
    #[inline(always)]
    #[must_use]
