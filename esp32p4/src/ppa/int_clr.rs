...
#[doc = "Field `BLEND_PARAM_CFG_ERR` writer - Set this bit to clear the PPA_BLEND_PARAM_CFG_ERR_INT interrupt."]
pub type BLEND_PARAM_CFG_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
