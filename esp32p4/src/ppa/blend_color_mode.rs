///Register `BLEND_COLOR_MODE` reader
pub type R = crate::R<BLEND_COLOR_MODE_SPEC>;
///Register `BLEND_COLOR_MODE` writer
pub type W = crate::W<BLEND_COLOR_MODE_SPEC>;
///Field `BLEND0_RX_CM` reader - The source image color mode for background plane. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 4: L8. 5: L4.
pub type BLEND0_RX_CM_R = crate::FieldReader;
///Field `BLEND0_RX_CM` writer - The source image color mode for background plane. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 4: L8. 5: L4.
pub type BLEND0_RX_CM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `BLEND1_RX_CM` reader - The source image color mode for foreground plane. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 4: L8. 5: L4. 6: A8. 7: A4.
pub type BLEND1_RX_CM_R = crate::FieldReader;
///Field `BLEND1_RX_CM` writer - The source image color mode for foreground plane. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 4: L8. 5: L4. 6: A8. 7: A4.
pub type BLEND1_RX_CM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `BLEND_TX_CM` reader - The destination image color mode for output of blender. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved..
pub type BLEND_TX_CM_R = crate::FieldReader;
///Field `BLEND_TX_CM` writer - The destination image color mode for output of blender. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved..
pub type BLEND_TX_CM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bits 0:3 - The source image color mode for background plane. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 4: L8. 5: L4.
    #[inline(always)]
    pub fn blend0_rx_cm(&self) -> BLEND0_RX_CM_R {
        BLEND0_RX_CM_R::new((self.bits & 0x0f) as u8)
    }
    ///Bits 4:7 - The source image color mode for foreground plane. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 4: L8. 5: L4. 6: A8. 7: A4.
    #[inline(always)]
    pub fn blend1_rx_cm(&self) -> BLEND1_RX_CM_R {
        BLEND1_RX_CM_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
    ///Bits 8:11 - The destination image color mode for output of blender. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved..
    #[inline(always)]
...
///`read()` method returns [`blend_color_mode::R`](R) reader structure
impl crate::Readable for BLEND_COLOR_MODE_SPEC {}
///`write(|w| ..)` method takes [`blend_color_mode::W`](W) writer structure
