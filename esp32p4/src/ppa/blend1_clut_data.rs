///Register `BLEND1_CLUT_DATA` reader
pub type R = crate::R<BLEND1_CLUT_DATA_SPEC>;
///Register `BLEND1_CLUT_DATA` writer
pub type W = crate::W<BLEND1_CLUT_DATA_SPEC>;
///Field `RDWR_WORD_BLEND1_CLUT` reader - Write and read data to/from CLUT RAM in foreground plane of blender engine through this field in fifo mode.
pub type RDWR_WORD_BLEND1_CLUT_R = crate::FieldReader<u32>;
///Field `RDWR_WORD_BLEND1_CLUT` writer - Write and read data to/from CLUT RAM in foreground plane of blender engine through this field in fifo mode.
pub type RDWR_WORD_BLEND1_CLUT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Write and read data to/from CLUT RAM in foreground plane of blender engine through this field in fifo mode.
    #[inline(always)]
...
///`read()` method returns [`blend1_clut_data::R`](R) reader structure
impl crate::Readable for BLEND1_CLUT_DATA_SPEC {}
///`write(|w| ..)` method takes [`blend1_clut_data::W`](W) writer structure
