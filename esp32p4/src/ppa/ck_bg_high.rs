...
impl W {
    #[doc = "Bits 0:7 - color key higher threshold of background b channel"]
    #[inline(always)]
    pub fn colorkey_bg_b_high(&mut self) -> COLORKEY_BG_B_HIGH_W<'_, CK_BG_HIGH_SPEC> {
        COLORKEY_BG_B_HIGH_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - color key higher threshold of background g channel"]
    #[inline(always)]
    pub fn colorkey_bg_g_high(&mut self) -> COLORKEY_BG_G_HIGH_W<'_, CK_BG_HIGH_SPEC> {
        COLORKEY_BG_G_HIGH_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - color key higher threshold of background r channel"]
    #[inline(always)]
    pub fn colorkey_bg_r_high(&mut self) -> COLORKEY_BG_R_HIGH_W<'_, CK_BG_HIGH_SPEC> {
