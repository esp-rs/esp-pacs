///Register `GPIO_O_HOLD_CTRL1` reader
pub type R = crate::R<GPIO_O_HOLD_CTRL1_SPEC>;
///Register `GPIO_O_HOLD_CTRL1` writer
pub type W = crate::W<GPIO_O_HOLD_CTRL1_SPEC>;
///Field `REG_GPIO_0_HOLD_HIGH` reader - hold control for gpio56~48
pub type REG_GPIO_0_HOLD_HIGH_R = crate::FieldReader<u16>;
///Field `REG_GPIO_0_HOLD_HIGH` writer - hold control for gpio56~48
pub type REG_GPIO_0_HOLD_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ///Bits 0:8 - hold control for gpio56~48
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPIO_O_HOLD_CTRL1")
            .field("reg_gpio_0_hold_high", &self.reg_gpio_0_hold_high())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`gpio_o_hold_ctrl1::R`](R) reader structure
impl crate::Readable for GPIO_O_HOLD_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`gpio_o_hold_ctrl1::W`](W) writer structure
