...
impl W {
    #[doc = "Bits 0:8 - hold control for gpio56~48"]
    #[inline(always)]
    pub fn reg_gpio_0_hold_high(&mut self) -> REG_GPIO_0_HOLD_HIGH_W<'_, GPIO_O_HOLD_CTRL1_SPEC> {
        REG_GPIO_0_HOLD_HIGH_W::new(self, 0)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio_o_hold_ctrl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio_o_hold_ctrl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
