///Register `PERI_MEM_CLK_FORCE_ON` reader
pub type R = crate::R<PERI_MEM_CLK_FORCE_ON_SPEC>;
///Register `PERI_MEM_CLK_FORCE_ON` writer
pub type W = crate::W<PERI_MEM_CLK_FORCE_ON_SPEC>;
///Field `RMT_MEM_CLK_FORCE_ON` reader - Set this bit to force on mem clk in rmt
pub type RMT_MEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `RMT_MEM_CLK_FORCE_ON` writer - Set this bit to force on mem clk in rmt
pub type RMT_MEM_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BITSCRAMBLER_TX_MEM_CLK_FORCE_ON` reader - Set this bit to force on tx mem clk in bitscrambler
pub type BITSCRAMBLER_TX_MEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `BITSCRAMBLER_TX_MEM_CLK_FORCE_ON` writer - Set this bit to force on tx mem clk in bitscrambler
pub type BITSCRAMBLER_TX_MEM_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BITSCRAMBLER_RX_MEM_CLK_FORCE_ON` reader - Set this bit to force on rx mem clk in bitscrambler
pub type BITSCRAMBLER_RX_MEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `BITSCRAMBLER_RX_MEM_CLK_FORCE_ON` writer - Set this bit to force on rx mem clk in bitscrambler
pub type BITSCRAMBLER_RX_MEM_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GDMA_MEM_CLK_FORCE_ON` reader - Set this bit to force on mem clk in gdma
pub type GDMA_MEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `GDMA_MEM_CLK_FORCE_ON` writer - Set this bit to force on mem clk in gdma
...
///`read()` method returns [`peri_mem_clk_force_on::R`](R) reader structure
impl crate::Readable for PERI_MEM_CLK_FORCE_ON_SPEC {}
///`write(|w| ..)` method takes [`peri_mem_clk_force_on::W`](W) writer structure
