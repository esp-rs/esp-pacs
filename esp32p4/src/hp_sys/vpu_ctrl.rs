...
///`read()` method returns [`vpu_ctrl::R`](R) reader structure
impl crate::Readable for VPU_CTRL_SPEC {}
///`write(|w| ..)` method takes [`vpu_ctrl::W`](W) writer structure
