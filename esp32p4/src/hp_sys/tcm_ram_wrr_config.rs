...
///`read()` method returns [`tcm_ram_wrr_config::R`](R) reader structure
impl crate::Readable for TCM_RAM_WRR_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`tcm_ram_wrr_config::W`](W) writer structure
