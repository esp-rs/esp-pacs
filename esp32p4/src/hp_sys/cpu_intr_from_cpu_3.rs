...
#[doc = "Field `CPU_INTR_FROM_CPU_3` reader - set 1 will triger a interrupt"]
pub type CPU_INTR_FROM_CPU_3_R = crate::BitReader;
#[doc = "Field `CPU_INTR_FROM_CPU_3` writer - set 1 will triger a interrupt"]
...
impl W {
    #[doc = "Bit 0 - set 1 will triger a interrupt"]
    #[inline(always)]
    pub fn cpu_intr_from_cpu_3(&mut self) -> CPU_INTR_FROM_CPU_3_W<'_, CPU_INTR_FROM_CPU_3_SPEC> {
