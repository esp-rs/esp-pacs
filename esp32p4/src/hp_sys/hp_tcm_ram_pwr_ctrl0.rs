    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_TCM_RAM_PWR_CTRL0")
            .field(
                ...
                &format_args!("{}", self.hp_reg_hp_tcm_clk_force_on().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<HP_TCM_RAM_PWR_CTRL0_SPEC> {
...
impl W {
    ...
    pub fn hp_reg_hp_tcm_clk_force_on(
        &mut self,
    ) -> HP_REG_HP_TCM_CLK_FORCE_ON_W<HP_TCM_RAM_PWR_CTRL0_SPEC> {
