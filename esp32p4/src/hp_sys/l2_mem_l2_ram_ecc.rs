...
impl W {
    ...
    pub fn reg_l2_ram_unit0_ecc_en(
        &mut self,
    ) -> REG_L2_RAM_UNIT0_ECC_EN_W<'_, L2_MEM_L2_RAM_ECC_SPEC> {
    ...
    pub fn reg_l2_ram_unit1_ecc_en(
        &mut self,
    ) -> REG_L2_RAM_UNIT1_ECC_EN_W<'_, L2_MEM_L2_RAM_ECC_SPEC> {
    ...
    pub fn reg_l2_ram_unit2_ecc_en(
        &mut self,
    ) -> REG_L2_RAM_UNIT2_ECC_EN_W<'_, L2_MEM_L2_RAM_ECC_SPEC> {
    ...
    pub fn reg_l2_ram_unit3_ecc_en(
        &mut self,
    ) -> REG_L2_RAM_UNIT3_ECC_EN_W<'_, L2_MEM_L2_RAM_ECC_SPEC> {
    ...
    pub fn reg_l2_ram_unit4_ecc_en(
        &mut self,
    ) -> REG_L2_RAM_UNIT4_ECC_EN_W<'_, L2_MEM_L2_RAM_ECC_SPEC> {
    ...
    pub fn reg_l2_ram_unit5_ecc_en(
        &mut self,
    ) -> REG_L2_RAM_UNIT5_ECC_EN_W<'_, L2_MEM_L2_RAM_ECC_SPEC> {
