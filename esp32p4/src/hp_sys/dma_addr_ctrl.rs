///Register `DMA_ADDR_CTRL` reader
pub type R = crate::R<DMA_ADDR_CTRL_SPEC>;
///Register `DMA_ADDR_CTRL` writer
pub type W = crate::W<DMA_ADDR_CTRL_SPEC>;
///Field `REG_SYS_DMA_ADDR_SEL` reader - 0 means dma access extmem use 8xxx_xxxx else use 4xxx_xxxx
pub type REG_SYS_DMA_ADDR_SEL_R = crate::BitReader;
///Field `REG_SYS_DMA_ADDR_SEL` writer - 0 means dma access extmem use 8xxx_xxxx else use 4xxx_xxxx
...
///`read()` method returns [`dma_addr_ctrl::R`](R) reader structure
impl crate::Readable for DMA_ADDR_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dma_addr_ctrl::W`](W) writer structure
