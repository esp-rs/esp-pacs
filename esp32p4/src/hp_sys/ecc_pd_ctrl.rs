...
///Field `ECC_MEM_FORCE_PD` reader - Set this bit to power down ecc internal memory.
pub type ECC_MEM_FORCE_PD_R = crate::BitReader;
///Field `ECC_MEM_FORCE_PD` writer - Set this bit to power down ecc internal memory.
...
///Field `ECC_MEM_PD` reader - Set this bit to force power down ecc internal memory.
pub type ECC_MEM_PD_R = crate::BitReader;
///Field `ECC_MEM_PD` writer - Set this bit to force power down ecc internal memory.
