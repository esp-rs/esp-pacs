///Register `TCM_PARITY_INT_RECORD` reader
pub type R = crate::R<TCM_PARITY_INT_RECORD_SPEC>;
///Field `TCM_PARITY_ERR_INT_ADDR` reader - hp tcm_parity_err_addr
pub type TCM_PARITY_ERR_INT_ADDR_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:12 - hp tcm_parity_err_addr
    #[inline(always)]
...
///`read()` method returns [`tcm_parity_int_record::R`](R) reader structure
