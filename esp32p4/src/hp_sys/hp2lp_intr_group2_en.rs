...
pub type R = crate::R<HP2LP_INTR_GROUP2_EN_SPEC>;
#[doc = "Register `HP2LP_INTR_GROUP2_EN` writer"]
pub type W = crate::W<HP2LP_INTR_GROUP2_EN_SPEC>;
#[doc = "Field `H2LP_INTR_GROUP2_EN` reader - Set each bit to enable corresponding peripheral interrupt to LP CPU."]
pub type H2LP_INTR_GROUP2_EN_R = crate::FieldReader<u32>;
#[doc = "Field `H2LP_INTR_GROUP2_EN` writer - Set each bit to enable corresponding peripheral interrupt to LP CPU."]
pub type H2LP_INTR_GROUP2_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Set each bit to enable corresponding peripheral interrupt to LP CPU."]
    #[inline(always)]
    pub fn h2lp_intr_group2_en(&self) -> H2LP_INTR_GROUP2_EN_R {
        H2LP_INTR_GROUP2_EN_R::new(self.bits)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP2LP_INTR_GROUP2_EN")
            .field("h2lp_intr_group2_en", &self.h2lp_intr_group2_en())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Set each bit to enable corresponding peripheral interrupt to LP CPU."]
    #[inline(always)]
    pub fn h2lp_intr_group2_en(&mut self) -> H2LP_INTR_GROUP2_EN_W<'_, HP2LP_INTR_GROUP2_EN_SPEC> {
        H2LP_INTR_GROUP2_EN_W::new(self, 0)
    }
}
...
pub struct HP2LP_INTR_GROUP2_EN_SPEC;
impl crate::RegisterSpec for HP2LP_INTR_GROUP2_EN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hp2lp_intr_group2_en::R`](R) reader structure"]
impl crate::Readable for HP2LP_INTR_GROUP2_EN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hp2lp_intr_group2_en::W`](W) writer structure"]
impl crate::Writable for HP2LP_INTR_GROUP2_EN_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets HP2LP_INTR_GROUP2_EN to value 0xffff_ffff"]
impl crate::Resettable for HP2LP_INTR_GROUP2_EN_SPEC {
