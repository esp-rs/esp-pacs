///Register `GPIO_O_HYS_CTRL1` reader
pub type R = crate::R<GPIO_O_HYS_CTRL1_SPEC>;
///Register `GPIO_O_HYS_CTRL1` writer
pub type W = crate::W<GPIO_O_HYS_CTRL1_SPEC>;
///Field `REG_GPIO_0_HYS_HIGH` reader - hys control for gpio56~48
pub type REG_GPIO_0_HYS_HIGH_R = crate::FieldReader<u16>;
///Field `REG_GPIO_0_HYS_HIGH` writer - hys control for gpio56~48
pub type REG_GPIO_0_HYS_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ///Bits 0:8 - hys control for gpio56~48
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`gpio_o_hys_ctrl1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio_o_hys_ctrl1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct GPIO_O_HYS_CTRL1_SPEC;
impl crate::RegisterSpec for GPIO_O_HYS_CTRL1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`gpio_o_hys_ctrl1::R`](R) reader structure
impl crate::Readable for GPIO_O_HYS_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`gpio_o_hys_ctrl1::W`](W) writer structure
