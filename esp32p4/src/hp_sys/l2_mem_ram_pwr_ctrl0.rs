///Register `L2_MEM_RAM_PWR_CTRL0` reader
pub type R = crate::R<L2_MEM_RAM_PWR_CTRL0_SPEC>;
///Register `L2_MEM_RAM_PWR_CTRL0` writer
pub type W = crate::W<L2_MEM_RAM_PWR_CTRL0_SPEC>;
///Field `REG_L2_MEM_CLK_FORCE_ON` reader - l2ram clk_gating force on
pub type REG_L2_MEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `REG_L2_MEM_CLK_FORCE_ON` writer - l2ram clk_gating force on
pub type REG_L2_MEM_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - l2ram clk_gating force on
    #[inline(always)]
...
///`read()` method returns [`l2_mem_ram_pwr_ctrl0::R`](R) reader structure
impl crate::Readable for L2_MEM_RAM_PWR_CTRL0_SPEC {}
///`write(|w| ..)` method takes [`l2_mem_ram_pwr_ctrl0::W`](W) writer structure
