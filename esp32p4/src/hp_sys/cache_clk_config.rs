...
impl W {
    #[doc = "Bit 0 - l2 cahce clk enable"]
    #[inline(always)]
    pub fn reg_l2_cache_clk_on(&mut self) -> REG_L2_CACHE_CLK_ON_W<'_, CACHE_CLK_CONFIG_SPEC> {
        REG_L2_CACHE_CLK_ON_W::new(self, 0)
    }
    #[doc = "Bit 1 - l1 dcahce clk enable"]
    #[inline(always)]
    pub fn reg_l1_d_cache_clk_on(&mut self) -> REG_L1_D_CACHE_CLK_ON_W<'_, CACHE_CLK_CONFIG_SPEC> {
        REG_L1_D_CACHE_CLK_ON_W::new(self, 1)
    }
    #[doc = "Bit 4 - l1 icahce1 clk enable"]
    #[inline(always)]
    pub fn reg_l1_i1_cache_clk_on(
        &mut self,
    ) -> REG_L1_I1_CACHE_CLK_ON_W<'_, CACHE_CLK_CONFIG_SPEC> {
        REG_L1_I1_CACHE_CLK_ON_W::new(self, 4)
    }
    #[doc = "Bit 5 - l1 icahce0 clk enable"]
    #[inline(always)]
    pub fn reg_l1_i0_cache_clk_on(
        &mut self,
    ) -> REG_L1_I0_CACHE_CLK_ON_W<'_, CACHE_CLK_CONFIG_SPEC> {
        REG_L1_I0_CACHE_CLK_ON_W::new(self, 5)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`cache_clk_config::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cache_clk_config::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
