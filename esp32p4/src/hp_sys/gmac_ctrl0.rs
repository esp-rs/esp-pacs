...
///`read()` method returns [`gmac_ctrl0::R`](R) reader structure
impl crate::Readable for GMAC_CTRL0_SPEC {}
///`write(|w| ..)` method takes [`gmac_ctrl0::W`](W) writer structure
