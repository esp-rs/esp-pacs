...
///Field `CPU_INTR_FROM_CPU_1` reader - set 1 will triger a interrupt
pub type CPU_INTR_FROM_CPU_1_R = crate::BitReader;
///Field `CPU_INTR_FROM_CPU_1` writer - set 1 will triger a interrupt
pub type CPU_INTR_FROM_CPU_1_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - set 1 will triger a interrupt
    #[inline(always)]
