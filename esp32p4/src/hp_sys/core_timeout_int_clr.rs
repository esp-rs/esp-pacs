///Register `CORE_TIMEOUT_INT_CLR` writer
pub type W = crate::W<CORE_TIMEOUT_INT_CLR_SPEC>;
///Field `CORE0_AHB_TIMEOUT_INT_CLR` writer - Write 1 to clear hp_core0_ahb_timeout int
pub type CORE0_AHB_TIMEOUT_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE1_AHB_TIMEOUT_INT_CLR` writer - Write 1 to clear hp_core1_ahb_timeout int
pub type CORE1_AHB_TIMEOUT_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE0_IBUS_TIMEOUT_INT_CLR` writer - Write 1 to clear hp_core0_ibus_timeout int
pub type CORE0_IBUS_TIMEOUT_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE1_IBUS_TIMEOUT_INT_CLR` writer - Write 1 to clear hp_core1_ibus_timeout int
pub type CORE1_IBUS_TIMEOUT_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE0_DBUS_TIMEOUT_INT_CLR` writer - Write 1 to clear hp_core0_dbus_timeout int
pub type CORE0_DBUS_TIMEOUT_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE1_DBUS_TIMEOUT_INT_CLR` writer - Write 1 to clear hp_core1_dbus_timeout int
...
impl W {
    ///Bit 0 - Write 1 to clear hp_core0_ahb_timeout int
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 1 - Write 1 to clear hp_core1_ahb_timeout int
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 2 - Write 1 to clear hp_core0_ibus_timeout int
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 3 - Write 1 to clear hp_core1_ibus_timeout int
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 4 - Write 1 to clear hp_core0_dbus_timeout int
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 5 - Write 1 to clear hp_core1_dbus_timeout int
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`core_timeout_int_clr::W`](W) writer structure
