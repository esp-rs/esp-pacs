///Register `L2_MEM_ERR_RESP_CTRL` reader
pub type R = crate::R<L2_MEM_ERR_RESP_CTRL_SPEC>;
///Register `L2_MEM_ERR_RESP_CTRL` writer
pub type W = crate::W<L2_MEM_ERR_RESP_CTRL_SPEC>;
///Field `L2_MEM_ERR_RESP_EN` reader - Set 1 to turn on l2mem error response
pub type L2_MEM_ERR_RESP_EN_R = crate::BitReader;
///Field `L2_MEM_ERR_RESP_EN` writer - Set 1 to turn on l2mem error response
...
///`read()` method returns [`l2_mem_err_resp_ctrl::R`](R) reader structure
impl crate::Readable for L2_MEM_ERR_RESP_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l2_mem_err_resp_ctrl::W`](W) writer structure
