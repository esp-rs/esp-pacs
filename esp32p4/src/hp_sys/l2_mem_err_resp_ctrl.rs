...
impl W {
    #[doc = "Bit 0 - Set 1 to turn on l2mem error response"]
    #[inline(always)]
    pub fn l2_mem_err_resp_en(&mut self) -> L2_MEM_ERR_RESP_EN_W<'_, L2_MEM_ERR_RESP_CTRL_SPEC> {
        L2_MEM_ERR_RESP_EN_W::new(self, 0)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`l2_mem_err_resp_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l2_mem_err_resp_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
