///Register `L2_MEM_SUBSIZE` reader
pub type R = crate::R<L2_MEM_SUBSIZE_SPEC>;
///Register `L2_MEM_SUBSIZE` writer
pub type W = crate::W<L2_MEM_SUBSIZE_SPEC>;
///Field `REG_L2_MEM_SUB_BLKSIZE` reader - l2mem sub block size 00=>32 01=>64 10=>128 11=>256
pub type REG_L2_MEM_SUB_BLKSIZE_R = crate::FieldReader;
///Field `REG_L2_MEM_SUB_BLKSIZE` writer - l2mem sub block size 00=>32 01=>64 10=>128 11=>256
pub type REG_L2_MEM_SUB_BLKSIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - l2mem sub block size 00=>32 01=>64 10=>128 11=>256
    #[inline(always)]
...
///`read()` method returns [`l2_mem_subsize::R`](R) reader structure
impl crate::Readable for L2_MEM_SUBSIZE_SPEC {}
///`write(|w| ..)` method takes [`l2_mem_subsize::W`](W) writer structure
