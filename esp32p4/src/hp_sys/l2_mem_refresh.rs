...
impl R {
    ...
    ///Bit 6 - Set 1 to reset l2mem_refresh_cnt
    #[inline(always)]
...
///`read()` method returns [`l2_mem_refresh::R`](R) reader structure
impl crate::Readable for L2_MEM_REFRESH_SPEC {}
///`write(|w| ..)` method takes [`l2_mem_refresh::W`](W) writer structure
