...
///Field `RNG_SAMPLE_ENABLE` reader - enable rng sample chain
pub type RNG_SAMPLE_ENABLE_R = crate::BitReader;
///Field `RNG_SAMPLE_ENABLE` writer - enable rng sample chain
pub type RNG_SAMPLE_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RNG_CHAIN_CLK_DIV_NUM` reader - chain clk div num to pad for debug
pub type RNG_CHAIN_CLK_DIV_NUM_R = crate::FieldReader;
///Field `RNG_CHAIN_CLK_DIV_NUM` writer - chain clk div num to pad for debug
pub type RNG_CHAIN_CLK_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `RNG_SAMPLE_CNT` reader - debug rng sample cnt
