///Register `TCM_ERR_RESP_CTRL` reader
pub type R = crate::R<TCM_ERR_RESP_CTRL_SPEC>;
///Register `TCM_ERR_RESP_CTRL` writer
pub type W = crate::W<TCM_ERR_RESP_CTRL_SPEC>;
///Field `TCM_ERR_RESP_EN` reader - Set 1 to turn on tcm error response
pub type TCM_ERR_RESP_EN_R = crate::BitReader;
///Field `TCM_ERR_RESP_EN` writer - Set 1 to turn on tcm error response
pub type TCM_ERR_RESP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to turn on tcm error response
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`tcm_err_resp_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tcm_err_resp_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct TCM_ERR_RESP_CTRL_SPEC;
impl crate::RegisterSpec for TCM_ERR_RESP_CTRL_SPEC {
    type Ux = u32;
}
///`read()` method returns [`tcm_err_resp_ctrl::R`](R) reader structure
impl crate::Readable for TCM_ERR_RESP_CTRL_SPEC {}
///`write(|w| ..)` method takes [`tcm_err_resp_ctrl::W`](W) writer structure
