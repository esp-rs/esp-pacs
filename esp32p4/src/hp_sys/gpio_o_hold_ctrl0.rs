...
impl W {
    #[doc = "Bits 0:31 - hold control for gpio47~16"]
    #[inline(always)]
    pub fn reg_gpio_0_hold_low(&mut self) -> REG_GPIO_0_HOLD_LOW_W<'_, GPIO_O_HOLD_CTRL0_SPEC> {
        REG_GPIO_0_HOLD_LOW_W::new(self, 0)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio_o_hold_ctrl0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio_o_hold_ctrl0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
