///Register `GPIO_O_HOLD_CTRL0` reader
pub type R = crate::R<GPIO_O_HOLD_CTRL0_SPEC>;
///Register `GPIO_O_HOLD_CTRL0` writer
pub type W = crate::W<GPIO_O_HOLD_CTRL0_SPEC>;
///Field `REG_GPIO_0_HOLD_LOW` reader - hold control for gpio47~16
pub type REG_GPIO_0_HOLD_LOW_R = crate::FieldReader<u32>;
///Field `REG_GPIO_0_HOLD_LOW` writer - hold control for gpio47~16
...
///`read()` method returns [`gpio_o_hold_ctrl0::R`](R) reader structure
impl crate::Readable for GPIO_O_HOLD_CTRL0_SPEC {}
///`write(|w| ..)` method takes [`gpio_o_hold_ctrl0::W`](W) writer structure
