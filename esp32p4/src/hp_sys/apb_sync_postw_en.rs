...
///`read()` method returns [`apb_sync_postw_en::R`](R) reader structure
impl crate::Readable for APB_SYNC_POSTW_EN_SPEC {}
///`write(|w| ..)` method takes [`apb_sync_postw_en::W`](W) writer structure
