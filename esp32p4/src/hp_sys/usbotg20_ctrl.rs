...
///`read()` method returns [`usbotg20_ctrl::R`](R) reader structure
impl crate::Readable for USBOTG20_CTRL_SPEC {}
///`write(|w| ..)` method takes [`usbotg20_ctrl::W`](W) writer structure
