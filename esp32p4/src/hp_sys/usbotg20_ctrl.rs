...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USBOTG20_CTRL")
            .field("otg_phy_test_done", &self.otg_phy_test_done().bit())
            .field("usb_mem_aux_ctrl", &self.usb_mem_aux_ctrl().bits())
            .field("phy_suspendm", &self.phy_suspendm().bit())
            .field("phy_suspend_force_en", &self.phy_suspend_force_en().bit())
            .field("phy_rstn", &self.phy_rstn().bit())
            .field("phy_reset_force_en", &self.phy_reset_force_en().bit())
            .field("phy_pll_force_en", &self.phy_pll_force_en().bit())
            .field("phy_pll_en", &self.phy_pll_en().bit())
            .field("otg_suspendm", &self.otg_suspendm().bit())
            .field("otg_phy_txbitstuff_en", &self.otg_phy_txbitstuff_en().bit())
            .field("otg_phy_refclk_mode", &self.otg_phy_refclk_mode().bit())
            .field("otg_phy_bisten", &self.otg_phy_bisten().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
