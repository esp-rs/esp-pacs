///Register `CORE_ERR_RESP_DIS` reader
pub type R = crate::R<CORE_ERR_RESP_DIS_SPEC>;
///Register `CORE_ERR_RESP_DIS` writer
pub type W = crate::W<CORE_ERR_RESP_DIS_SPEC>;
///Field `CORE_ERR_RESP_DIS` reader - Set bit0 to disable ibus err resp. Set bit1 to disable dbus err resp. Set bit 2 to disable ahb err resp.
pub type CORE_ERR_RESP_DIS_R = crate::FieldReader;
///Field `CORE_ERR_RESP_DIS` writer - Set bit0 to disable ibus err resp. Set bit1 to disable dbus err resp. Set bit 2 to disable ahb err resp.
...
///`read()` method returns [`core_err_resp_dis::R`](R) reader structure
impl crate::Readable for CORE_ERR_RESP_DIS_SPEC {}
///`write(|w| ..)` method takes [`core_err_resp_dis::W`](W) writer structure
