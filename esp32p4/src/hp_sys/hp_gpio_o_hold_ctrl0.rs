...
#[doc = "Field `HP_REG_GPIO_0_HOLD_LOW` reader - hold control for gpio47~16"]
pub type HP_REG_GPIO_0_HOLD_LOW_R = crate::FieldReader<u32>;
#[doc = "Field `HP_REG_GPIO_0_HOLD_LOW` writer - hold control for gpio47~16"]
pub type HP_REG_GPIO_0_HOLD_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - hold control for gpio47~16"]
    #[inline(always)]
    pub fn hp_reg_gpio_0_hold_low(&self) -> HP_REG_GPIO_0_HOLD_LOW_R {
        HP_REG_GPIO_0_HOLD_LOW_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_GPIO_O_HOLD_CTRL0")
            .field(
                "hp_reg_gpio_0_hold_low",
                &format_args!("{}", self.hp_reg_gpio_0_hold_low().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<HP_GPIO_O_HOLD_CTRL0_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_reg_gpio_0_hold_low(
        &mut self,
    ) -> HP_REG_GPIO_0_HOLD_LOW_W<HP_GPIO_O_HOLD_CTRL0_SPEC> {
        HP_REG_GPIO_0_HOLD_LOW_W::new(self, 0)
    }
