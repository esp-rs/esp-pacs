///Register `TCM_INT_RAW` reader
pub type R = crate::R<TCM_INT_RAW_SPEC>;
///Register `TCM_INT_RAW` writer
pub type W = crate::W<TCM_INT_RAW_SPEC>;
///Field `TCM_PARITY_ERR_INT_RAW` reader - need_des
pub type TCM_PARITY_ERR_INT_RAW_R = crate::BitReader;
///Field `TCM_PARITY_ERR_INT_RAW` writer - need_des
...
///`read()` method returns [`tcm_int_raw::R`](R) reader structure
impl crate::Readable for TCM_INT_RAW_SPEC {}
///`write(|w| ..)` method takes [`tcm_int_raw::W`](W) writer structure
