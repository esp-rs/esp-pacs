...
///`read()` method returns [`icm_cpu_h2x_cfg::R`](R) reader structure
impl crate::Readable for ICM_CPU_H2X_CFG_SPEC {}
///`write(|w| ..)` method takes [`icm_cpu_h2x_cfg::W`](W) writer structure
