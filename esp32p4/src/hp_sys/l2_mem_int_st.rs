///Register `L2_MEM_INT_ST` reader
pub type R = crate::R<L2_MEM_INT_ST_SPEC>;
///Field `REG_L2_MEM_ECC_ERR_INT_ST` reader - NA
pub type REG_L2_MEM_ECC_ERR_INT_ST_R = crate::BitReader;
///Field `REG_L2_MEM_EXCEED_ADDR_INT_ST` reader - NA
pub type REG_L2_MEM_EXCEED_ADDR_INT_ST_R = crate::BitReader;
///Field `REG_L2_MEM_ERR_RESP_INT_ST` reader - NA
...
You can [`read`](crate::generic::Reg::read) this register and get [`l2_mem_int_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L2_MEM_INT_ST_SPEC;
impl crate::RegisterSpec for L2_MEM_INT_ST_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l2_mem_int_st::R`](R) reader structure
