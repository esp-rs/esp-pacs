#[doc = "Register `HP_CORE_DBUS_TIMEOUT` reader"]
pub type R = crate::R<HP_CORE_DBUS_TIMEOUT_SPEC>;
#[doc = "Register `HP_CORE_DBUS_TIMEOUT` writer"]
pub type W = crate::W<HP_CORE_DBUS_TIMEOUT_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_CORE_DBUS_TIMEOUT")
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<HP_CORE_DBUS_TIMEOUT_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<HP_CORE_DBUS_TIMEOUT_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bits 1:16 - This field used to set hp core0&amp;1 dbus timeout threshold"]
    #[inline(always)]
    #[must_use]
    pub fn thres(&mut self) -> THRES_W<HP_CORE_DBUS_TIMEOUT_SPEC> {
        THRES_W::new(self, 1)
    }
...
pub struct HP_CORE_DBUS_TIMEOUT_SPEC;
impl crate::RegisterSpec for HP_CORE_DBUS_TIMEOUT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hp_core_dbus_timeout::R`](R) reader structure"]
impl crate::Readable for HP_CORE_DBUS_TIMEOUT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hp_core_dbus_timeout::W`](W) writer structure"]
impl crate::Writable for HP_CORE_DBUS_TIMEOUT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HP_CORE_DBUS_TIMEOUT to value 0x0001_ffff"]
impl crate::Resettable for HP_CORE_DBUS_TIMEOUT_SPEC {
