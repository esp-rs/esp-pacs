///Register `AHB2AXI_BRESP_ERR_INT_ST` reader
pub type R = crate::R<AHB2AXI_BRESP_ERR_INT_ST_SPEC>;
///Field `CPU_ICM_H2X_BRESP_ERR_INT_ST` reader - the masked interrupt status of cpu_icm_h2x_bresp_err
pub type CPU_ICM_H2X_BRESP_ERR_INT_ST_R = crate::BitReader;
impl R {
    ///Bit 31 - the masked interrupt status of cpu_icm_h2x_bresp_err
    #[inline(always)]
...
///`read()` method returns [`ahb2axi_bresp_err_int_st::R`](R) reader structure
