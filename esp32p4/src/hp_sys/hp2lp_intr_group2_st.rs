...
pub type R = crate::R<HP2LP_INTR_GROUP2_ST_SPEC>;
#[doc = "Field `H2LP_INTR_GROUP2_ST` reader - Each bit indicates the status of corresponding peripheral interrupt to LP CPU."]
pub type H2LP_INTR_GROUP2_ST_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Each bit indicates the status of corresponding peripheral interrupt to LP CPU."]
    #[inline(always)]
    pub fn h2lp_intr_group2_st(&self) -> H2LP_INTR_GROUP2_ST_R {
        H2LP_INTR_GROUP2_ST_R::new(self.bits)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP2LP_INTR_GROUP2_ST")
            .field("h2lp_intr_group2_st", &self.h2lp_intr_group2_st())
            .finish()
    }
}
...
pub struct HP2LP_INTR_GROUP2_ST_SPEC;
impl crate::RegisterSpec for HP2LP_INTR_GROUP2_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hp2lp_intr_group2_st::R`](R) reader structure"]
impl crate::Readable for HP2LP_INTR_GROUP2_ST_SPEC {}
#[doc = "`reset()` method sets HP2LP_INTR_GROUP2_ST to value 0"]
impl crate::Resettable for HP2LP_INTR_GROUP2_ST_SPEC {}
