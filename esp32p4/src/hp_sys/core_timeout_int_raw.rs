///Register `CORE_TIMEOUT_INT_RAW` reader
pub type R = crate::R<CORE_TIMEOUT_INT_RAW_SPEC>;
///Register `CORE_TIMEOUT_INT_RAW` writer
pub type W = crate::W<CORE_TIMEOUT_INT_RAW_SPEC>;
///Field `CORE0_AHB_TIMEOUT_INT_RAW` reader - the raw interrupt status of hp core0 ahb timeout
pub type CORE0_AHB_TIMEOUT_INT_RAW_R = crate::BitReader;
///Field `CORE0_AHB_TIMEOUT_INT_RAW` writer - the raw interrupt status of hp core0 ahb timeout
pub type CORE0_AHB_TIMEOUT_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE1_AHB_TIMEOUT_INT_RAW` reader - the raw interrupt status of hp core1 ahb timeout
pub type CORE1_AHB_TIMEOUT_INT_RAW_R = crate::BitReader;
///Field `CORE1_AHB_TIMEOUT_INT_RAW` writer - the raw interrupt status of hp core1 ahb timeout
pub type CORE1_AHB_TIMEOUT_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE0_IBUS_TIMEOUT_INT_RAW` reader - the raw interrupt status of hp core0 ibus timeout
pub type CORE0_IBUS_TIMEOUT_INT_RAW_R = crate::BitReader;
///Field `CORE0_IBUS_TIMEOUT_INT_RAW` writer - the raw interrupt status of hp core0 ibus timeout
pub type CORE0_IBUS_TIMEOUT_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE1_IBUS_TIMEOUT_INT_RAW` reader - the raw interrupt status of hp core1 ibus timeout
pub type CORE1_IBUS_TIMEOUT_INT_RAW_R = crate::BitReader;
///Field `CORE1_IBUS_TIMEOUT_INT_RAW` writer - the raw interrupt status of hp core1 ibus timeout
pub type CORE1_IBUS_TIMEOUT_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE0_DBUS_TIMEOUT_INT_RAW` reader - the raw interrupt status of hp core0 dbus timeout
pub type CORE0_DBUS_TIMEOUT_INT_RAW_R = crate::BitReader;
///Field `CORE0_DBUS_TIMEOUT_INT_RAW` writer - the raw interrupt status of hp core0 dbus timeout
pub type CORE0_DBUS_TIMEOUT_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE1_DBUS_TIMEOUT_INT_RAW` reader - the raw interrupt status of hp core1 dbus timeout
pub type CORE1_DBUS_TIMEOUT_INT_RAW_R = crate::BitReader;
///Field `CORE1_DBUS_TIMEOUT_INT_RAW` writer - the raw interrupt status of hp core1 dbus timeout
pub type CORE1_DBUS_TIMEOUT_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - the raw interrupt status of hp core0 ahb timeout
    #[inline(always)]
    pub fn core0_ahb_timeout_int_raw(&self) -> CORE0_AHB_TIMEOUT_INT_RAW_R {
        CORE0_AHB_TIMEOUT_INT_RAW_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - the raw interrupt status of hp core1 ahb timeout
    #[inline(always)]
    pub fn core1_ahb_timeout_int_raw(&self) -> CORE1_AHB_TIMEOUT_INT_RAW_R {
        CORE1_AHB_TIMEOUT_INT_RAW_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - the raw interrupt status of hp core0 ibus timeout
    #[inline(always)]
    pub fn core0_ibus_timeout_int_raw(&self) -> CORE0_IBUS_TIMEOUT_INT_RAW_R {
        CORE0_IBUS_TIMEOUT_INT_RAW_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - the raw interrupt status of hp core1 ibus timeout
    #[inline(always)]
    pub fn core1_ibus_timeout_int_raw(&self) -> CORE1_IBUS_TIMEOUT_INT_RAW_R {
        CORE1_IBUS_TIMEOUT_INT_RAW_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - the raw interrupt status of hp core0 dbus timeout
    #[inline(always)]
    pub fn core0_dbus_timeout_int_raw(&self) -> CORE0_DBUS_TIMEOUT_INT_RAW_R {
        CORE0_DBUS_TIMEOUT_INT_RAW_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - the raw interrupt status of hp core1 dbus timeout
    #[inline(always)]
...
///`read()` method returns [`core_timeout_int_raw::R`](R) reader structure
impl crate::Readable for CORE_TIMEOUT_INT_RAW_SPEC {}
///`write(|w| ..)` method takes [`core_timeout_int_raw::W`](W) writer structure
