...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_CPU_INT_FROM_CPU_1")
            .field(
                "hp_cpu_int_from_cpu_1",
                &format_args!("{}", self.hp_cpu_int_from_cpu_1().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<HP_CPU_INT_FROM_CPU_1_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_cpu_int_from_cpu_1(&mut self) -> HP_CPU_INT_FROM_CPU_1_W<HP_CPU_INT_FROM_CPU_1_SPEC> {
