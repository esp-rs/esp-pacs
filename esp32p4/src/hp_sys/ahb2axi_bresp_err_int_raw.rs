///Register `AHB2AXI_BRESP_ERR_INT_RAW` reader
pub type R = crate::R<AHB2AXI_BRESP_ERR_INT_RAW_SPEC>;
///Register `AHB2AXI_BRESP_ERR_INT_RAW` writer
pub type W = crate::W<AHB2AXI_BRESP_ERR_INT_RAW_SPEC>;
///Field `CPU_ICM_H2X_BRESP_ERR_INT_RAW` reader - the raw interrupt status of bresp error, triggered when if bresp err occurs in post write mode in ahb2axi.
pub type CPU_ICM_H2X_BRESP_ERR_INT_RAW_R = crate::BitReader;
///Field `CPU_ICM_H2X_BRESP_ERR_INT_RAW` writer - the raw interrupt status of bresp error, triggered when if bresp err occurs in post write mode in ahb2axi.
pub type CPU_ICM_H2X_BRESP_ERR_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - the raw interrupt status of bresp error, triggered when if bresp err occurs in post write mode in ahb2axi.
    #[inline(always)]
...
///`read()` method returns [`ahb2axi_bresp_err_int_raw::R`](R) reader structure
impl crate::Readable for AHB2AXI_BRESP_ERR_INT_RAW_SPEC {}
///`write(|w| ..)` method takes [`ahb2axi_bresp_err_int_raw::W`](W) writer structure
