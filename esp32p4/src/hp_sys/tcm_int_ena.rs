///Register `TCM_INT_ENA` reader
pub type R = crate::R<TCM_INT_ENA_SPEC>;
///Register `TCM_INT_ENA` writer
pub type W = crate::W<TCM_INT_ENA_SPEC>;
///Field `TCM_PARITY_ERR_INT_ENA` reader - need_des
pub type TCM_PARITY_ERR_INT_ENA_R = crate::BitReader;
///Field `TCM_PARITY_ERR_INT_ENA` writer - need_des
...
///`read()` method returns [`tcm_int_ena::R`](R) reader structure
impl crate::Readable for TCM_INT_ENA_SPEC {}
///`write(|w| ..)` method takes [`tcm_int_ena::W`](W) writer structure
