#[doc = "Register `HP_PSRAM_FLASH_ADDR_INTERCHANGE` reader"]
pub type R = crate::R<HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC>;
#[doc = "Register `HP_PSRAM_FLASH_ADDR_INTERCHANGE` writer"]
pub type W = crate::W<HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_PSRAM_FLASH_ADDR_INTERCHANGE")
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu(&mut self) -> CPU_W<HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC> {
        CPU_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set 1 to enable addr interchange between psram and flash in axi matrix when dma device access, lp core access and hp core access through ahb"]
    #[inline(always)]
    #[must_use]
    pub fn dma(&mut self) -> DMA_W<HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC> {
        DMA_W::new(self, 1)
    }
...
pub struct HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC;
impl crate::RegisterSpec for HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hp_psram_flash_addr_interchange::R`](R) reader structure"]
impl crate::Readable for HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hp_psram_flash_addr_interchange::W`](W) writer structure"]
impl crate::Writable for HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HP_PSRAM_FLASH_ADDR_INTERCHANGE to value 0"]
impl crate::Resettable for HP_PSRAM_FLASH_ADDR_INTERCHANGE_SPEC {
