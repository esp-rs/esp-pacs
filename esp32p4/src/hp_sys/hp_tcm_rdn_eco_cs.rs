...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_TCM_RDN_ECO_CS")
            .field(
                "hp_reg_hp_tcm_rdn_eco_en",
                &format_args!("{}", self.hp_reg_hp_tcm_rdn_eco_en().bit()),
            )
            .field(
                "hp_reg_hp_tcm_rdn_eco_result",
                &format_args!("{}", self.hp_reg_hp_tcm_rdn_eco_result().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<HP_TCM_RDN_ECO_CS_SPEC> {
...
impl W {
    ...
    pub fn hp_reg_hp_tcm_rdn_eco_en(
        &mut self,
    ) -> HP_REG_HP_TCM_RDN_ECO_EN_W<HP_TCM_RDN_ECO_CS_SPEC> {
