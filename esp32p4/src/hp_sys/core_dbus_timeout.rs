///Register `CORE_DBUS_TIMEOUT` reader
pub type R = crate::R<CORE_DBUS_TIMEOUT_SPEC>;
///Register `CORE_DBUS_TIMEOUT` writer
pub type W = crate::W<CORE_DBUS_TIMEOUT_SPEC>;
///Field `EN` reader - set this field to 1 to enable hp core0&amp;1 dbus timeout handle
pub type EN_R = crate::BitReader;
///Field `EN` writer - set this field to 1 to enable hp core0&amp;1 dbus timeout handle
pub type EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES` reader - This field used to set hp core0&amp;1 dbus timeout threshold
pub type THRES_R = crate::FieldReader<u16>;
///Field `THRES` writer - This field used to set hp core0&amp;1 dbus timeout threshold
pub type THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bit 0 - set this field to 1 to enable hp core0&amp;1 dbus timeout handle
    #[inline(always)]
    pub fn en(&self) -> EN_R {
        EN_R::new((self.bits & 1) != 0)
    }
    ///Bits 1:16 - This field used to set hp core0&amp;1 dbus timeout threshold
    #[inline(always)]
...
///`read()` method returns [`core_dbus_timeout::R`](R) reader structure
impl crate::Readable for CORE_DBUS_TIMEOUT_SPEC {}
///`write(|w| ..)` method takes [`core_dbus_timeout::W`](W) writer structure
