...
impl R {
    ...
    ///Bit 1 - Set 1 to reset tcm init cnt
    #[inline(always)]
...
///`read()` method returns [`tcm_init::R`](R) reader structure
impl crate::Readable for TCM_INIT_SPEC {}
///`write(|w| ..)` method takes [`tcm_init::W`](W) writer structure
