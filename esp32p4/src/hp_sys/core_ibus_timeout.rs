...
impl W {
    #[doc = "Bit 0 - set this field to 1 to enable hp core0&1 ibus timeout handle"]
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, CORE_IBUS_TIMEOUT_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bits 1:16 - This field used to set hp core0&1 ibus timeout threshold"]
    #[inline(always)]
    pub fn thres(&mut self) -> THRES_W<'_, CORE_IBUS_TIMEOUT_SPEC> {
        THRES_W::new(self, 1)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`core_ibus_timeout::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_ibus_timeout::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
