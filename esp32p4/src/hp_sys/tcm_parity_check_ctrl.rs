///Register `TCM_PARITY_CHECK_CTRL` reader
pub type R = crate::R<TCM_PARITY_CHECK_CTRL_SPEC>;
///Register `TCM_PARITY_CHECK_CTRL` writer
pub type W = crate::W<TCM_PARITY_CHECK_CTRL_SPEC>;
///Field `TCM_PARITY_CHECK_EN` reader - Set 1 to turn on tcm parity check
pub type TCM_PARITY_CHECK_EN_R = crate::BitReader;
///Field `TCM_PARITY_CHECK_EN` writer - Set 1 to turn on tcm parity check
...
///`read()` method returns [`tcm_parity_check_ctrl::R`](R) reader structure
impl crate::Readable for TCM_PARITY_CHECK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`tcm_parity_check_ctrl::W`](W) writer structure
