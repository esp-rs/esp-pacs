///Register `GMAC_CTRL1` reader
pub type R = crate::R<GMAC_CTRL1_SPEC>;
///Field `PTP_TIMESTAMP_L` reader - N/A
...
You can [`read`](crate::generic::Reg::read) this register and get [`gmac_ctrl1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct GMAC_CTRL1_SPEC;
impl crate::RegisterSpec for GMAC_CTRL1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`gmac_ctrl1::R`](R) reader structure
