...
///Field `CARRIER_LOW_THRES_CH` reader - The low level period in a carrier modulation mode is (REG_RMT_REG_CARRIER_LOW_THRES_CH%s + 1) for channel %s.
pub type CARRIER_LOW_THRES_CH_R = crate::FieldReader<u16>;
///Field `CARRIER_LOW_THRES_CH` writer - The low level period in a carrier modulation mode is (REG_RMT_REG_CARRIER_LOW_THRES_CH%s + 1) for channel %s.
pub type CARRIER_LOW_THRES_CH_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `CARRIER_HIGH_THRES_CH` reader - The high level period in a carrier modulation mode is (REG_RMT_REG_CARRIER_HIGH_THRES_CH%s + 1) for channel %s.
pub type CARRIER_HIGH_THRES_CH_R = crate::FieldReader<u16>;
///Field `CARRIER_HIGH_THRES_CH` writer - The high level period in a carrier modulation mode is (REG_RMT_REG_CARRIER_HIGH_THRES_CH%s + 1) for channel %s.
