///Register `RX_CH%sCONF0` reader
pub type R = crate::R<RX_CHCONF0_SPEC>;
///Register `RX_CH%sCONF0` writer
pub type W = crate::W<RX_CHCONF0_SPEC>;
///Field `DIV_CNT_CH4` reader - This register is used to configure the divider for clock of CHANNEL%s.
pub type DIV_CNT_CH4_R = crate::FieldReader;
///Field `DIV_CNT_CH4` writer - This register is used to configure the divider for clock of CHANNEL%s.
pub type DIV_CNT_CH4_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `IDLE_THRES_CH4` reader - When no edge is detected on the input signal and continuous clock cycles is longer than this register value, received process is finished.
pub type IDLE_THRES_CH4_R = crate::FieldReader<u16>;
///Field `IDLE_THRES_CH4` writer - When no edge is detected on the input signal and continuous clock cycles is longer than this register value, received process is finished.
pub type IDLE_THRES_CH4_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `MEM_SIZE_CH4` reader - This register is used to configure the maximum size of memory allocated to CHANNEL%s.
pub type MEM_SIZE_CH4_R = crate::FieldReader;
///Field `MEM_SIZE_CH4` writer - This register is used to configure the maximum size of memory allocated to CHANNEL%s.
pub type MEM_SIZE_CH4_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CARRIER_EN_CH4` reader - This is the carrier modulation enable-control bit for CHANNEL%s. 1: Add carrier modulation in the output signal. 0: No carrier modulation in sig_out.
pub type CARRIER_EN_CH4_R = crate::BitReader;
///Field `CARRIER_EN_CH4` writer - This is the carrier modulation enable-control bit for CHANNEL%s. 1: Add carrier modulation in the output signal. 0: No carrier modulation in sig_out.
pub type CARRIER_EN_CH4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CARRIER_OUT_LV_CH4` reader - This bit is used to configure the position of carrier wave for CHANNEL%s.1'h0: add carrier wave on low level.1'h1: add carrier wave on high level.
pub type CARRIER_OUT_LV_CH4_R = crate::BitReader;
///Field `CARRIER_OUT_LV_CH4` writer - This bit is used to configure the position of carrier wave for CHANNEL%s.1'h0: add carrier wave on low level.1'h1: add carrier wave on high level.
...
impl R {
    ...
    ///Bits 24:27 - This register is used to configure the maximum size of memory allocated to CHANNEL%s.
    #[inline(always)]
...
///`read()` method returns [`rx_chconf0::R`](R) reader structure
impl crate::Readable for RX_CHCONF0_SPEC {}
///`write(|w| ..)` method takes [`rx_chconf0::W`](W) writer structure
