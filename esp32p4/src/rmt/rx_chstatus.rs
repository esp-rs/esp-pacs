///Register `RX_CH%sSTATUS` reader
pub type R = crate::R<RX_CHSTATUS_SPEC>;
///Field `MEM_WADDR_EX_CH4` reader - This register records the memory address offset when receiver of CHANNEL%s is using the RAM.
pub type MEM_WADDR_EX_CH4_R = crate::FieldReader<u16>;
///Field `APB_MEM_RADDR_CH4` reader - This register records the memory address offset when reads RAM over APB bus.
pub type APB_MEM_RADDR_CH4_R = crate::FieldReader<u16>;
///Field `STATE_CH4` reader - This register records the FSM status of CHANNEL%s.
pub type STATE_CH4_R = crate::FieldReader;
///Field `MEM_OWNER_ERR_CH4` reader - This status bit will be set when the ownership of memory block is wrong.
pub type MEM_OWNER_ERR_CH4_R = crate::BitReader;
///Field `MEM_FULL_CH4` reader - This status bit will be set if the receiver receives more data than the memory size.
pub type MEM_FULL_CH4_R = crate::BitReader;
///Field `APB_MEM_RD_ERR_CH4` reader - This status bit will be set if the offset address out of memory size when reads via APB bus.
...
///`read()` method returns [`rx_chstatus::R`](R) reader structure
