///Register `TX_CH%sSTATUS` reader
pub type R = crate::R<TX_CHSTATUS_SPEC>;
///Field `MEM_RADDR_EX_CH0` reader - This register records the memory address offset when transmitter of CHANNEL%s is using the RAM.
pub type MEM_RADDR_EX_CH0_R = crate::FieldReader<u16>;
///Field `APB_MEM_WADDR_CH0` reader - This register records the memory address offset when writes RAM over APB bus.
pub type APB_MEM_WADDR_CH0_R = crate::FieldReader<u16>;
///Field `STATE_CH0` reader - This register records the FSM status of CHANNEL%s.
pub type STATE_CH0_R = crate::FieldReader;
///Field `MEM_EMPTY_CH0` reader - This status bit will be set when the data to be set is more than memory size and the wraparound mode is disabled.
pub type MEM_EMPTY_CH0_R = crate::BitReader;
///Field `APB_MEM_WR_ERR_CH0` reader - This status bit will be set if the offset address out of memory size when writes via APB bus.
...
///`read()` method returns [`tx_chstatus::R`](R) reader structure
