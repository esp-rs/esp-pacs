///Register `RX_CH%sCONF1` reader
pub type R = crate::R<RX_CHCONF1_SPEC>;
///Register `RX_CH%sCONF1` writer
pub type W = crate::W<RX_CHCONF1_SPEC>;
///Field `RX_EN_CH4` reader - Set this bit to enable receiver to receive data on CHANNEL%s.
pub type RX_EN_CH4_R = crate::BitReader;
///Field `RX_EN_CH4` writer - Set this bit to enable receiver to receive data on CHANNEL%s.
pub type RX_EN_CH4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_WR_RST_CH4` writer - Set this bit to reset write ram address for CHANNEL%s by accessing receiver.
pub type MEM_WR_RST_CH4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APB_MEM_RST_CH4` writer - Set this bit to reset W/R ram address for CHANNEL%s by accessing apb fifo.
pub type APB_MEM_RST_CH4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_OWNER_CH4` reader - This register marks the ownership of CHANNEL%s's ram block.1'h1: Receiver is using the ram. 1'h0: APB bus is using the ram.
pub type MEM_OWNER_CH4_R = crate::BitReader;
///Field `MEM_OWNER_CH4` writer - This register marks the ownership of CHANNEL%s's ram block.1'h1: Receiver is using the ram. 1'h0: APB bus is using the ram.
pub type MEM_OWNER_CH4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_FILTER_EN_CH4` reader - This is the receive filter's enable bit for CHANNEL%s.
pub type RX_FILTER_EN_CH4_R = crate::BitReader;
///Field `RX_FILTER_EN_CH4` writer - This is the receive filter's enable bit for CHANNEL%s.
pub type RX_FILTER_EN_CH4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_FILTER_THRES_CH4` reader - Ignores the input pulse when its width is smaller than this register value in APB clock periods (in receive mode).
pub type RX_FILTER_THRES_CH4_R = crate::FieldReader;
///Field `RX_FILTER_THRES_CH4` writer - Ignores the input pulse when its width is smaller than this register value in APB clock periods (in receive mode).
pub type RX_FILTER_THRES_CH4_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `MEM_RX_WRAP_EN_CH4` reader - This is the channel %s enable bit for wraparound mode: it will resume receiving at the start when the data to be received is more than its memory size.
pub type MEM_RX_WRAP_EN_CH4_R = crate::BitReader;
///Field `MEM_RX_WRAP_EN_CH4` writer - This is the channel %s enable bit for wraparound mode: it will resume receiving at the start when the data to be received is more than its memory size.
pub type MEM_RX_WRAP_EN_CH4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AFIFO_RST_CH4` writer - Reserved
pub type AFIFO_RST_CH4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CONF_UPDATE_CH4` writer - synchronization bit for CHANNEL%s
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_en_ch4(&mut self) -> RX_EN_CH4_W<RX_CHCONF1_SPEC> {
        RX_EN_CH4_W::new(self, 0)
    }
    ///Bit 1 - Set this bit to reset write ram address for CHANNEL%s by accessing receiver.
    #[inline(always)]
    #[must_use]
    pub fn mem_wr_rst_ch4(&mut self) -> MEM_WR_RST_CH4_W<RX_CHCONF1_SPEC> {
        MEM_WR_RST_CH4_W::new(self, 1)
    }
    ///Bit 2 - Set this bit to reset W/R ram address for CHANNEL%s by accessing apb fifo.
    #[inline(always)]
    #[must_use]
    pub fn apb_mem_rst_ch4(&mut self) -> APB_MEM_RST_CH4_W<RX_CHCONF1_SPEC> {
        APB_MEM_RST_CH4_W::new(self, 2)
    }
    ///Bit 3 - This register marks the ownership of CHANNEL%s's ram block.1'h1: Receiver is using the ram. 1'h0: APB bus is using the ram.
    #[inline(always)]
    #[must_use]
    pub fn mem_owner_ch4(&mut self) -> MEM_OWNER_CH4_W<RX_CHCONF1_SPEC> {
        MEM_OWNER_CH4_W::new(self, 3)
    }
    ///Bit 4 - This is the receive filter's enable bit for CHANNEL%s.
    #[inline(always)]
    #[must_use]
    pub fn rx_filter_en_ch4(&mut self) -> RX_FILTER_EN_CH4_W<RX_CHCONF1_SPEC> {
        RX_FILTER_EN_CH4_W::new(self, 4)
    }
    ///Bits 5:12 - Ignores the input pulse when its width is smaller than this register value in APB clock periods (in receive mode).
    #[inline(always)]
    #[must_use]
    pub fn rx_filter_thres_ch4(&mut self) -> RX_FILTER_THRES_CH4_W<RX_CHCONF1_SPEC> {
        RX_FILTER_THRES_CH4_W::new(self, 5)
    }
    ///Bit 13 - This is the channel %s enable bit for wraparound mode: it will resume receiving at the start when the data to be received is more than its memory size.
    #[inline(always)]
    #[must_use]
    pub fn mem_rx_wrap_en_ch4(&mut self) -> MEM_RX_WRAP_EN_CH4_W<RX_CHCONF1_SPEC> {
        MEM_RX_WRAP_EN_CH4_W::new(self, 13)
    }
    ///Bit 14 - Reserved
    #[inline(always)]
    #[must_use]
    pub fn afifo_rst_ch4(&mut self) -> AFIFO_RST_CH4_W<RX_CHCONF1_SPEC> {
        AFIFO_RST_CH4_W::new(self, 14)
    }
    ///Bit 15 - synchronization bit for CHANNEL%s
    #[inline(always)]
    #[must_use]
    pub fn conf_update_ch4(&mut self) -> CONF_UPDATE_CH4_W<RX_CHCONF1_SPEC> {
...
///`read()` method returns [`rx_chconf1::R`](R) reader structure
impl crate::Readable for RX_CHCONF1_SPEC {}
///`write(|w| ..)` method takes [`rx_chconf1::W`](W) writer structure
