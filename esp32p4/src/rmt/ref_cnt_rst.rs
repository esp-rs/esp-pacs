...
///Field `TX_REF_CNT_RST_CH0` writer - This register is used to reset the clock divider of CHANNEL0.
pub type TX_REF_CNT_RST_CH0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_REF_CNT_RST_CH1` writer - This register is used to reset the clock divider of CHANNEL1.
pub type TX_REF_CNT_RST_CH1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_REF_CNT_RST_CH2` writer - This register is used to reset the clock divider of CHANNEL2.
pub type TX_REF_CNT_RST_CH2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_REF_CNT_RST_CH3` writer - This register is used to reset the clock divider of CHANNEL3.
pub type TX_REF_CNT_RST_CH3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_REF_CNT_RST_CH4` writer - This register is used to reset the clock divider of CHANNEL4.
pub type RX_REF_CNT_RST_CH4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_REF_CNT_RST_CH5` writer - This register is used to reset the clock divider of CHANNEL5.
pub type RX_REF_CNT_RST_CH5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_REF_CNT_RST_CH6` writer - This register is used to reset the clock divider of CHANNEL6.
pub type RX_REF_CNT_RST_CH6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_REF_CNT_RST_CH7` writer - This register is used to reset the clock divider of CHANNEL7.
