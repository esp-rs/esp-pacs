...
///Field `RX_LIM_CH4` reader - This register is used to configure the maximum entries that CHANNEL%s can receive.
pub type RX_LIM_CH4_R = crate::FieldReader<u16>;
///Field `RX_LIM_CH4` writer - This register is used to configure the maximum entries that CHANNEL%s can receive.
