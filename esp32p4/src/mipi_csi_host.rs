...
///NA
pub mod version;
/**N_LANES (rw) register accessor: NA
...
///NA
pub mod n_lanes;
/**CSI2_RESETN (rw) register accessor: NA
...
///NA
pub mod csi2_resetn;
/**INT_ST_MAIN (r) register accessor: NA
...
///NA
pub mod int_st_main;
/**PHY_SHUTDOWNZ (rw) register accessor: NA
...
/**DPHY_RSTZ (rw) register accessor: NA
...
///NA
pub mod phy_rx;
/**PHY_STOPSTATE (r) register accessor: NA
...
/**PHY_TEST_CTRL0 (rw) register accessor: NA
...
/**PHY_TEST_CTRL1 (rw) register accessor: NA
...
/**VC_EXTENSION (rw) register accessor: NA
...
/**PHY_CAL (r) register accessor: NA
...
///NA
pub mod phy_cal;
/**INT_ST_PHY_FATAL (r) register accessor: NA
...
/**INT_MSK_PHY_FATAL (rw) register accessor: NA
...
/**INT_FORCE_PHY_FATAL (rw) register accessor: NA
...
/**INT_ST_PKT_FATAL (r) register accessor: NA
...
/**INT_MSK_PKT_FATAL (rw) register accessor: NA
...
/**INT_FORCE_PKT_FATAL (rw) register accessor: NA
...
/**INT_ST_PHY (r) register accessor: NA
...
///NA
pub mod int_st_phy;
/**INT_MSK_PHY (rw) register accessor: NA
...
///NA
pub mod int_msk_phy;
/**INT_FORCE_PHY (rw) register accessor: NA
...
/**INT_ST_BNDRY_FRAME_FATAL (r) register accessor: NA
...
/**INT_MSK_DATA_ID (rw) register accessor: NA
...
/**INT_FORCE_DATA_ID (rw) register accessor: NA
...
/**INT_ST_ECC_CORRECTED (r) register accessor: NA
...
///NA
pub mod scrambling;
/**SCRAMBLING_SEED1 (rw) register accessor: NA
...
/**SCRAMBLING_SEED2 (rw) register accessor: NA
