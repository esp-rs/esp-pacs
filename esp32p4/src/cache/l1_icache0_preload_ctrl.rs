///Register `L1_ICACHE0_PRELOAD_CTRL` reader
pub type R = crate::R<L1_ICACHE0_PRELOAD_CTRL_SPEC>;
///Register `L1_ICACHE0_PRELOAD_CTRL` writer
pub type W = crate::W<L1_ICACHE0_PRELOAD_CTRL_SPEC>;
///Field `L1_ICACHE0_PRELOAD_ENA` reader - The bit is used to enable preload operation on L1-ICache0. It will be cleared by hardware automatically after preload operation is done.
pub type L1_ICACHE0_PRELOAD_ENA_R = crate::BitReader;
///Field `L1_ICACHE0_PRELOAD_ENA` writer - The bit is used to enable preload operation on L1-ICache0. It will be cleared by hardware automatically after preload operation is done.
pub type L1_ICACHE0_PRELOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE0_PRELOAD_DONE` reader - The bit is used to indicate whether preload operation is finished or not. 0: not finished. 1: finished.
pub type L1_ICACHE0_PRELOAD_DONE_R = crate::BitReader;
///Field `L1_ICACHE0_PRELOAD_ORDER` reader - The bit is used to configure the direction of preload operation. 0: ascending, 1: descending.
pub type L1_ICACHE0_PRELOAD_ORDER_R = crate::BitReader;
///Field `L1_ICACHE0_PRELOAD_ORDER` writer - The bit is used to configure the direction of preload operation. 0: ascending, 1: descending.
pub type L1_ICACHE0_PRELOAD_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE0_PRELOAD_RGID` reader - The bit is used to set the gid of l1 icache0 preload.
pub type L1_ICACHE0_PRELOAD_RGID_R = crate::FieldReader;
///Field `L1_ICACHE0_PRELOAD_RGID` writer - The bit is used to set the gid of l1 icache0 preload.
pub type L1_ICACHE0_PRELOAD_RGID_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bit 0 - The bit is used to enable preload operation on L1-ICache0. It will be cleared by hardware automatically after preload operation is done.
    #[inline(always)]
    ...
    ///Bits 3:6 - The bit is used to set the gid of l1 icache0 preload.
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_icache0_preload_order(
        &mut self,
    ) -> L1_ICACHE0_PRELOAD_ORDER_W<L1_ICACHE0_PRELOAD_CTRL_SPEC> {
    ...
    pub fn l1_icache0_preload_rgid(
        &mut self,
    ) -> L1_ICACHE0_PRELOAD_RGID_W<L1_ICACHE0_PRELOAD_CTRL_SPEC> {
...
///`read()` method returns [`l1_icache0_preload_ctrl::R`](R) reader structure
impl crate::Readable for L1_ICACHE0_PRELOAD_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l1_icache0_preload_ctrl::W`](W) writer structure
