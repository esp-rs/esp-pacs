///Register `L2_CACHE_PRELOAD_RST_CTRL` reader
pub type R = crate::R<L2_CACHE_PRELOAD_RST_CTRL_SPEC>;
///Register `L2_CACHE_PRELOAD_RST_CTRL` writer
pub type W = crate::W<L2_CACHE_PRELOAD_RST_CTRL_SPEC>;
///Field `L2_CACHE_PLD_RST` reader - set this bit to reset preload-logic inside L2-Cache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
pub type L2_CACHE_PLD_RST_R = crate::BitReader;
///Field `L2_CACHE_PLD_RST` writer - set this bit to reset preload-logic inside L2-Cache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
pub type L2_CACHE_PLD_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 5 - set this bit to reset preload-logic inside L2-Cache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
    #[inline(always)]
...
///`read()` method returns [`l2_cache_preload_rst_ctrl::R`](R) reader structure
impl crate::Readable for L2_CACHE_PRELOAD_RST_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_preload_rst_ctrl::W`](W) writer structure
