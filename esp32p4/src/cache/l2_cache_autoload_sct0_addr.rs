///Register `L2_CACHE_AUTOLOAD_SCT0_ADDR` reader
pub type R = crate::R<L2_CACHE_AUTOLOAD_SCT0_ADDR_SPEC>;
///Register `L2_CACHE_AUTOLOAD_SCT0_ADDR` writer
pub type W = crate::W<L2_CACHE_AUTOLOAD_SCT0_ADDR_SPEC>;
///Field `L2_CACHE_AUTOLOAD_SCT0_ADDR` reader - Those bits are used to configure the start virtual address of the first section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT0_SIZE and L2_CACHE_AUTOLOAD_SCT0_ENA.
pub type L2_CACHE_AUTOLOAD_SCT0_ADDR_R = crate::FieldReader<u32>;
///Field `L2_CACHE_AUTOLOAD_SCT0_ADDR` writer - Those bits are used to configure the start virtual address of the first section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT0_SIZE and L2_CACHE_AUTOLOAD_SCT0_ENA.
pub type L2_CACHE_AUTOLOAD_SCT0_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Those bits are used to configure the start virtual address of the first section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT0_SIZE and L2_CACHE_AUTOLOAD_SCT0_ENA.
    #[inline(always)]
...
///`read()` method returns [`l2_cache_autoload_sct0_addr::R`](R) reader structure
impl crate::Readable for L2_CACHE_AUTOLOAD_SCT0_ADDR_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_autoload_sct0_addr::W`](W) writer structure
