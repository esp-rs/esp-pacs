///Register `L1_DBUS0_ACS_NXTLVL_RD_CNT` reader
pub type R = crate::R<L1_DBUS0_ACS_NXTLVL_RD_CNT_SPEC>;
///Field `L1_DBUS0_NXTLVL_RD_CNT` reader - The register records the number of times that L1-DCache accesses L2-Cache due to bus0 accessing L1-DCache.
pub type L1_DBUS0_NXTLVL_RD_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of times that L1-DCache accesses L2-Cache due to bus0 accessing L1-DCache.
    #[inline(always)]
...
///`read()` method returns [`l1_dbus0_acs_nxtlvl_rd_cnt::R`](R) reader structure
