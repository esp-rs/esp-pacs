///Register `L2_DBUS0_ACS_NXTLVL_WR_CNT` reader
pub type R = crate::R<L2_DBUS0_ACS_NXTLVL_WR_CNT_SPEC>;
///Field `L2_DBUS0_NXTLVL_WR_CNT` reader - The register records the number of write back when L1-DCache accesses L2-Cache due to bus0 accessing L1-DCache.
pub type L2_DBUS0_NXTLVL_WR_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of write back when L1-DCache accesses L2-Cache due to bus0 accessing L1-DCache.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_DBUS0_ACS_NXTLVL_WR_CNT")
            .field("l2_dbus0_nxtlvl_wr_cnt", &self.l2_dbus0_nxtlvl_wr_cnt())
            .finish()
    }
}
...
///`read()` method returns [`l2_dbus0_acs_nxtlvl_wr_cnt::R`](R) reader structure
