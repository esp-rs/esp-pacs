///Register `L2_CACHE_PRELOCK_SCT1_ADDR` reader
pub type R = crate::R<L2_CACHE_PRELOCK_SCT1_ADDR_SPEC>;
///Register `L2_CACHE_PRELOCK_SCT1_ADDR` writer
pub type W = crate::W<L2_CACHE_PRELOCK_SCT1_ADDR_SPEC>;
///Field `L2_CACHE_PRELOCK_SCT1_ADDR` reader - Those bits are used to configure the start virtual address of the second section of prelock on L2-Cache, which should be used together with L2_CACHE_PRELOCK_SCT1_SIZE_REG
pub type L2_CACHE_PRELOCK_SCT1_ADDR_R = crate::FieldReader<u32>;
///Field `L2_CACHE_PRELOCK_SCT1_ADDR` writer - Those bits are used to configure the start virtual address of the second section of prelock on L2-Cache, which should be used together with L2_CACHE_PRELOCK_SCT1_SIZE_REG
pub type L2_CACHE_PRELOCK_SCT1_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Those bits are used to configure the start virtual address of the second section of prelock on L2-Cache, which should be used together with L2_CACHE_PRELOCK_SCT1_SIZE_REG
    #[inline(always)]
...
///`read()` method returns [`l2_cache_prelock_sct1_addr::R`](R) reader structure
impl crate::Readable for L2_CACHE_PRELOCK_SCT1_ADDR_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_prelock_sct1_addr::W`](W) writer structure
