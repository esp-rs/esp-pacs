///Register `L1_DCACHE_BLOCKSIZE_CONF` reader
pub type R = crate::R<L1_DCACHE_BLOCKSIZE_CONF_SPEC>;
///Field `L1_DCACHE_BLOCKSIZE_8` reader - The field is used to configureblocksize of L1-DCache as 8 bytes. This field and all other fields within this register is onehot.
pub type L1_DCACHE_BLOCKSIZE_8_R = crate::BitReader;
///Field `L1_DCACHE_BLOCKSIZE_16` reader - The field is used to configureblocksize of L1-DCache as 16 bytes. This field and all other fields within this register is onehot.
pub type L1_DCACHE_BLOCKSIZE_16_R = crate::BitReader;
///Field `L1_DCACHE_BLOCKSIZE_32` reader - The field is used to configureblocksize of L1-DCache as 32 bytes. This field and all other fields within this register is onehot.
pub type L1_DCACHE_BLOCKSIZE_32_R = crate::BitReader;
///Field `L1_DCACHE_BLOCKSIZE_64` reader - The field is used to configureblocksize of L1-DCache as 64 bytes. This field and all other fields within this register is onehot.
pub type L1_DCACHE_BLOCKSIZE_64_R = crate::BitReader;
///Field `L1_DCACHE_BLOCKSIZE_128` reader - The field is used to configureblocksize of L1-DCache as 128 bytes. This field and all other fields within this register is onehot.
pub type L1_DCACHE_BLOCKSIZE_128_R = crate::BitReader;
///Field `L1_DCACHE_BLOCKSIZE_256` reader - The field is used to configureblocksize of L1-DCache as 256 bytes. This field and all other fields within this register is onehot.
...
///`read()` method returns [`l1_dcache_blocksize_conf::R`](R) reader structure
