...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_DCACHE_BLOCKSIZE_CONF")
            .field("l1_dcache_blocksize_8", &self.l1_dcache_blocksize_8().bit())
            .field(
                "l1_dcache_blocksize_16",
                &self.l1_dcache_blocksize_16().bit(),
            )
            .field(
                "l1_dcache_blocksize_32",
                &self.l1_dcache_blocksize_32().bit(),
            )
            .field(
                "l1_dcache_blocksize_64",
                &self.l1_dcache_blocksize_64().bit(),
            )
            .field(
                "l1_dcache_blocksize_128",
                &self.l1_dcache_blocksize_128().bit(),
            )
            .field(
                "l1_dcache_blocksize_256",
                &self.l1_dcache_blocksize_256().bit(),
            )
            .finish()
    }
}
