///Register `L1_CACHE_DATA_MEM_POWER_CTRL` reader
pub type R = crate::R<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>;
///Register `L1_CACHE_DATA_MEM_POWER_CTRL` writer
pub type W = crate::W<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>;
///Field `L1_ICACHE0_DATA_MEM_FORCE_ON` reader - The bit is used to close clock gating of L1-ICache0 data memory. 1: close gating, 0: open clock gating.
pub type L1_ICACHE0_DATA_MEM_FORCE_ON_R = crate::BitReader;
///Field `L1_ICACHE0_DATA_MEM_FORCE_ON` writer - The bit is used to close clock gating of L1-ICache0 data memory. 1: close gating, 0: open clock gating.
pub type L1_ICACHE0_DATA_MEM_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE0_DATA_MEM_FORCE_PD` reader - The bit is used to power L1-ICache0 data memory down. 0: follow rtc_lslp, 1: power down
pub type L1_ICACHE0_DATA_MEM_FORCE_PD_R = crate::BitReader;
///Field `L1_ICACHE0_DATA_MEM_FORCE_PD` writer - The bit is used to power L1-ICache0 data memory down. 0: follow rtc_lslp, 1: power down
pub type L1_ICACHE0_DATA_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE0_DATA_MEM_FORCE_PU` reader - The bit is used to power L1-ICache0 data memory up. 0: follow rtc_lslp, 1: power up
pub type L1_ICACHE0_DATA_MEM_FORCE_PU_R = crate::BitReader;
///Field `L1_ICACHE0_DATA_MEM_FORCE_PU` writer - The bit is used to power L1-ICache0 data memory up. 0: follow rtc_lslp, 1: power up
pub type L1_ICACHE0_DATA_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_DATA_MEM_FORCE_ON` reader - The bit is used to close clock gating of L1-ICache1 data memory. 1: close gating, 0: open clock gating.
pub type L1_ICACHE1_DATA_MEM_FORCE_ON_R = crate::BitReader;
///Field `L1_ICACHE1_DATA_MEM_FORCE_ON` writer - The bit is used to close clock gating of L1-ICache1 data memory. 1: close gating, 0: open clock gating.
pub type L1_ICACHE1_DATA_MEM_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_DATA_MEM_FORCE_PD` reader - The bit is used to power L1-ICache1 data memory down. 0: follow rtc_lslp, 1: power down
pub type L1_ICACHE1_DATA_MEM_FORCE_PD_R = crate::BitReader;
///Field `L1_ICACHE1_DATA_MEM_FORCE_PD` writer - The bit is used to power L1-ICache1 data memory down. 0: follow rtc_lslp, 1: power down
pub type L1_ICACHE1_DATA_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_DATA_MEM_FORCE_PU` reader - The bit is used to power L1-ICache1 data memory up. 0: follow rtc_lslp, 1: power up
pub type L1_ICACHE1_DATA_MEM_FORCE_PU_R = crate::BitReader;
///Field `L1_ICACHE1_DATA_MEM_FORCE_PU` writer - The bit is used to power L1-ICache1 data memory up. 0: follow rtc_lslp, 1: power up
pub type L1_ICACHE1_DATA_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE2_DATA_MEM_FORCE_ON` reader - Reserved
pub type L1_ICACHE2_DATA_MEM_FORCE_ON_R = crate::BitReader;
///Field `L1_ICACHE2_DATA_MEM_FORCE_PD` reader - Reserved
pub type L1_ICACHE2_DATA_MEM_FORCE_PD_R = crate::BitReader;
///Field `L1_ICACHE2_DATA_MEM_FORCE_PU` reader - Reserved
pub type L1_ICACHE2_DATA_MEM_FORCE_PU_R = crate::BitReader;
///Field `L1_ICACHE3_DATA_MEM_FORCE_ON` reader - Reserved
pub type L1_ICACHE3_DATA_MEM_FORCE_ON_R = crate::BitReader;
///Field `L1_ICACHE3_DATA_MEM_FORCE_PD` reader - Reserved
pub type L1_ICACHE3_DATA_MEM_FORCE_PD_R = crate::BitReader;
///Field `L1_ICACHE3_DATA_MEM_FORCE_PU` reader - Reserved
pub type L1_ICACHE3_DATA_MEM_FORCE_PU_R = crate::BitReader;
///Field `L1_DCACHE_DATA_MEM_FORCE_ON` reader - The bit is used to close clock gating of L1-DCache data memory. 1: close gating, 0: open clock gating.
pub type L1_DCACHE_DATA_MEM_FORCE_ON_R = crate::BitReader;
///Field `L1_DCACHE_DATA_MEM_FORCE_ON` writer - The bit is used to close clock gating of L1-DCache data memory. 1: close gating, 0: open clock gating.
pub type L1_DCACHE_DATA_MEM_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DCACHE_DATA_MEM_FORCE_PD` reader - The bit is used to power L1-DCache data memory down. 0: follow rtc_lslp, 1: power down
pub type L1_DCACHE_DATA_MEM_FORCE_PD_R = crate::BitReader;
///Field `L1_DCACHE_DATA_MEM_FORCE_PD` writer - The bit is used to power L1-DCache data memory down. 0: follow rtc_lslp, 1: power down
pub type L1_DCACHE_DATA_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DCACHE_DATA_MEM_FORCE_PU` reader - The bit is used to power L1-DCache data memory up. 0: follow rtc_lslp, 1: power up
pub type L1_DCACHE_DATA_MEM_FORCE_PU_R = crate::BitReader;
///Field `L1_DCACHE_DATA_MEM_FORCE_PU` writer - The bit is used to power L1-DCache data memory up. 0: follow rtc_lslp, 1: power up
...
impl R {
    ...
    ///Bit 16 - The bit is used to close clock gating of L1-DCache data memory. 1: close gating, 0: open clock gating.
    #[inline(always)]
    pub fn l1_dcache_data_mem_force_on(&self) -> L1_DCACHE_DATA_MEM_FORCE_ON_R {
        L1_DCACHE_DATA_MEM_FORCE_ON_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - The bit is used to power L1-DCache data memory down. 0: follow rtc_lslp, 1: power down
    #[inline(always)]
    pub fn l1_dcache_data_mem_force_pd(&self) -> L1_DCACHE_DATA_MEM_FORCE_PD_R {
        L1_DCACHE_DATA_MEM_FORCE_PD_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - The bit is used to power L1-DCache data memory up. 0: follow rtc_lslp, 1: power up
    #[inline(always)]
...
///`read()` method returns [`l1_cache_data_mem_power_ctrl::R`](R) reader structure
impl crate::Readable for L1_CACHE_DATA_MEM_POWER_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_data_mem_power_ctrl::W`](W) writer structure
