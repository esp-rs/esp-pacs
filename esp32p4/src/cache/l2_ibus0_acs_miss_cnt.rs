///Register `L2_IBUS0_ACS_MISS_CNT` reader
pub type R = crate::R<L2_IBUS0_ACS_MISS_CNT_SPEC>;
///Field `L2_IBUS0_MISS_CNT` reader - The register records the number of missing when L1-ICache0 accesses L2-Cache due to bus0 accessing L1-ICache0.
pub type L2_IBUS0_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of missing when L1-ICache0 accesses L2-Cache due to bus0 accessing L1-ICache0.
    #[inline(always)]
...
///`read()` method returns [`l2_ibus0_acs_miss_cnt::R`](R) reader structure
