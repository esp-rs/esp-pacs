///Register `L1_ICACHE1_AUTOLOAD_SCT0_ADDR` reader
pub type R = crate::R<L1_ICACHE1_AUTOLOAD_SCT0_ADDR_SPEC>;
///Register `L1_ICACHE1_AUTOLOAD_SCT0_ADDR` writer
...
///Field `L1_ICACHE1_AUTOLOAD_SCT0_ADDR` writer - Those bits are used to configure the start virtual address of the first section for autoload operation on L1-ICache1. Note that it should be used together with L1_ICACHE1_AUTOLOAD_SCT0_SIZE and L1_ICACHE_AUTOLOAD_SCT0_ENA.
pub type L1_ICACHE1_AUTOLOAD_SCT0_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Those bits are used to configure the start virtual address of the first section for autoload operation on L1-ICache1. Note that it should be used together with L1_ICACHE1_AUTOLOAD_SCT0_SIZE and L1_ICACHE_AUTOLOAD_SCT0_ENA.
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_icache1_autoload_sct0_addr(
        &mut self,
    ) -> L1_ICACHE1_AUTOLOAD_SCT0_ADDR_W<L1_ICACHE1_AUTOLOAD_SCT0_ADDR_SPEC> {
...
///`read()` method returns [`l1_icache1_autoload_sct0_addr::R`](R) reader structure
impl crate::Readable for L1_ICACHE1_AUTOLOAD_SCT0_ADDR_SPEC {}
///`write(|w| ..)` method takes [`l1_icache1_autoload_sct0_addr::W`](W) writer structure
