    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_DCACHE_CACHESIZE_CONF")
            .field(
                ...
                &self.l1_dcache_cachesize_256().bit(),
            )
            .field(
                "l1_dcache_cachesize_512",
                &self.l1_dcache_cachesize_512().bit(),
            )
            .field(
                "l1_dcache_cachesize_1k",
                &self.l1_dcache_cachesize_1k().bit(),
            )
            .field(
                "l1_dcache_cachesize_2k",
                &self.l1_dcache_cachesize_2k().bit(),
            )
            .field(
                "l1_dcache_cachesize_4k",
                &self.l1_dcache_cachesize_4k().bit(),
            )
            .field(
                "l1_dcache_cachesize_8k",
                &self.l1_dcache_cachesize_8k().bit(),
            )
            .field(
                "l1_dcache_cachesize_16k",
                &self.l1_dcache_cachesize_16k().bit(),
            )
            .field(
                "l1_dcache_cachesize_32k",
                &self.l1_dcache_cachesize_32k().bit(),
            )
            .field(
                "l1_dcache_cachesize_64k",
                &self.l1_dcache_cachesize_64k().bit(),
            )
            .field(
                "l1_dcache_cachesize_128k",
                &self.l1_dcache_cachesize_128k().bit(),
            )
            .field(
                "l1_dcache_cachesize_256k",
                &self.l1_dcache_cachesize_256k().bit(),
            )
            .field(
                "l1_dcache_cachesize_512k",
                &self.l1_dcache_cachesize_512k().bit(),
            )
            .field(
                "l1_dcache_cachesize_1024k",
                &self.l1_dcache_cachesize_1024k().bit(),
            )
            .finish()
    }
}
