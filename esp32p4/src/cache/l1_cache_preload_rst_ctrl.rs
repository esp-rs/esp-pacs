///Register `L1_CACHE_PRELOAD_RST_CTRL` reader
pub type R = crate::R<L1_CACHE_PRELOAD_RST_CTRL_SPEC>;
///Register `L1_CACHE_PRELOAD_RST_CTRL` writer
pub type W = crate::W<L1_CACHE_PRELOAD_RST_CTRL_SPEC>;
///Field `L1_ICACHE0_PLD_RST` reader - set this bit to reset preload-logic inside L1-ICache0. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
pub type L1_ICACHE0_PLD_RST_R = crate::BitReader;
///Field `L1_ICACHE0_PLD_RST` writer - set this bit to reset preload-logic inside L1-ICache0. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
pub type L1_ICACHE0_PLD_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_PLD_RST` reader - set this bit to reset preload-logic inside L1-ICache1. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
pub type L1_ICACHE1_PLD_RST_R = crate::BitReader;
///Field `L1_ICACHE1_PLD_RST` writer - set this bit to reset preload-logic inside L1-ICache1. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
pub type L1_ICACHE1_PLD_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE2_PLD_RST` reader - Reserved
pub type L1_ICACHE2_PLD_RST_R = crate::BitReader;
///Field `L1_ICACHE3_PLD_RST` reader - Reserved
pub type L1_ICACHE3_PLD_RST_R = crate::BitReader;
///Field `L1_DCACHE_PLD_RST` reader - set this bit to reset preload-logic inside L1-DCache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
pub type L1_DCACHE_PLD_RST_R = crate::BitReader;
///Field `L1_DCACHE_PLD_RST` writer - set this bit to reset preload-logic inside L1-DCache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
...
///`read()` method returns [`l1_cache_preload_rst_ctrl::R`](R) reader structure
impl crate::Readable for L1_CACHE_PRELOAD_RST_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_preload_rst_ctrl::W`](W) writer structure
