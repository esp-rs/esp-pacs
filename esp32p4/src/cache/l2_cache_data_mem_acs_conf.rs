...
#[doc = "Register `L2_CACHE_DATA_MEM_ACS_CONF` writer"]
...
#[doc = "Field `L2_CACHE_DATA_MEM_RD_EN` writer - The bit is used to enable config-bus read L2-Cache data memoryory. 0: disable, 1: enable."]
...
#[doc = "Field `L2_CACHE_DATA_MEM_WR_EN` writer - The bit is used to enable config-bus write L2-Cache data memoryory. 0: disable, 1: enable."]
...
impl W {
    ...
    pub fn l2_cache_data_mem_rd_en(
        &mut self,
    ) -> L2_CACHE_DATA_MEM_RD_EN_W<'_, L2_CACHE_DATA_MEM_ACS_CONF_SPEC> {
