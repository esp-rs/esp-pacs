///Register `L1_CACHE_ACS_CNT_INT_ENA` reader
pub type R = crate::R<L1_CACHE_ACS_CNT_INT_ENA_SPEC>;
///Register `L1_CACHE_ACS_CNT_INT_ENA` writer
pub type W = crate::W<L1_CACHE_ACS_CNT_INT_ENA_SPEC>;
///Field `L1_IBUS0_OVF_INT_ENA` reader - The bit is used to enable interrupt of one of counters overflow that occurs in L1-ICache0 due to bus0 accesses L1-ICache0.
pub type L1_IBUS0_OVF_INT_ENA_R = crate::BitReader;
///Field `L1_IBUS0_OVF_INT_ENA` writer - The bit is used to enable interrupt of one of counters overflow that occurs in L1-ICache0 due to bus0 accesses L1-ICache0.
pub type L1_IBUS0_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_IBUS1_OVF_INT_ENA` reader - The bit is used to enable interrupt of one of counters overflow that occurs in L1-ICache1 due to bus1 accesses L1-ICache1.
pub type L1_IBUS1_OVF_INT_ENA_R = crate::BitReader;
///Field `L1_IBUS1_OVF_INT_ENA` writer - The bit is used to enable interrupt of one of counters overflow that occurs in L1-ICache1 due to bus1 accesses L1-ICache1.
pub type L1_IBUS1_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_IBUS2_OVF_INT_ENA` reader - Reserved
pub type L1_IBUS2_OVF_INT_ENA_R = crate::BitReader;
///Field `L1_IBUS3_OVF_INT_ENA` reader - Reserved
pub type L1_IBUS3_OVF_INT_ENA_R = crate::BitReader;
///Field `L1_DBUS0_OVF_INT_ENA` reader - The bit is used to enable interrupt of one of counters overflow that occurs in L1-DCache due to bus0 accesses L1-DCache.
pub type L1_DBUS0_OVF_INT_ENA_R = crate::BitReader;
///Field `L1_DBUS0_OVF_INT_ENA` writer - The bit is used to enable interrupt of one of counters overflow that occurs in L1-DCache due to bus0 accesses L1-DCache.
pub type L1_DBUS0_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DBUS1_OVF_INT_ENA` reader - The bit is used to enable interrupt of one of counters overflow that occurs in L1-DCache due to bus1 accesses L1-DCache.
pub type L1_DBUS1_OVF_INT_ENA_R = crate::BitReader;
///Field `L1_DBUS1_OVF_INT_ENA` writer - The bit is used to enable interrupt of one of counters overflow that occurs in L1-DCache due to bus1 accesses L1-DCache.
pub type L1_DBUS1_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DBUS2_OVF_INT_ENA` reader - Reserved
pub type L1_DBUS2_OVF_INT_ENA_R = crate::BitReader;
///Field `L1_DBUS3_OVF_INT_ENA` reader - Reserved
pub type L1_DBUS3_OVF_INT_ENA_R = crate::BitReader;
impl R {
    ///Bit 0 - The bit is used to enable interrupt of one of counters overflow that occurs in L1-ICache0 due to bus0 accesses L1-ICache0.
    #[inline(always)]
    pub fn l1_ibus0_ovf_int_ena(&self) -> L1_IBUS0_OVF_INT_ENA_R {
        L1_IBUS0_OVF_INT_ENA_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit is used to enable interrupt of one of counters overflow that occurs in L1-ICache1 due to bus1 accesses L1-ICache1.
    #[inline(always)]
...
///`read()` method returns [`l1_cache_acs_cnt_int_ena::R`](R) reader structure
impl crate::Readable for L1_CACHE_ACS_CNT_INT_ENA_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_acs_cnt_int_ena::W`](W) writer structure
