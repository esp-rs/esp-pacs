///Register `L2_CACHE_AUTOLOAD_SCT0_SIZE` reader
pub type R = crate::R<L2_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>;
///Register `L2_CACHE_AUTOLOAD_SCT0_SIZE` writer
pub type W = crate::W<L2_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>;
///Field `L2_CACHE_AUTOLOAD_SCT0_SIZE` reader - Those bits are used to configure the size of the first section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT0_ADDR and L2_CACHE_AUTOLOAD_SCT0_ENA.
pub type L2_CACHE_AUTOLOAD_SCT0_SIZE_R = crate::FieldReader<u32>;
///Field `L2_CACHE_AUTOLOAD_SCT0_SIZE` writer - Those bits are used to configure the size of the first section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT0_ADDR and L2_CACHE_AUTOLOAD_SCT0_ENA.
pub type L2_CACHE_AUTOLOAD_SCT0_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - Those bits are used to configure the size of the first section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT0_ADDR and L2_CACHE_AUTOLOAD_SCT0_ENA.
    #[inline(always)]
...
///`read()` method returns [`l2_cache_autoload_sct0_size::R`](R) reader structure
impl crate::Readable for L2_CACHE_AUTOLOAD_SCT0_SIZE_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_autoload_sct0_size::W`](W) writer structure
