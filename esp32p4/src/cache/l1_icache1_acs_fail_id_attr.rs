///Register `L1_ICACHE1_ACS_FAIL_ID_ATTR` reader
pub type R = crate::R<L1_ICACHE1_ACS_FAIL_ID_ATTR_SPEC>;
///Field `L1_ICACHE1_FAIL_ID` reader - The register records the ID of fail-access when cache1 accesses L1-ICache.
pub type L1_ICACHE1_FAIL_ID_R = crate::FieldReader<u16>;
///Field `L1_ICACHE1_FAIL_ATTR` reader - The register records the attribution of fail-access when cache1 accesses L1-ICache.
pub type L1_ICACHE1_FAIL_ATTR_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - The register records the ID of fail-access when cache1 accesses L1-ICache.
    #[inline(always)]
    pub fn l1_icache1_fail_id(&self) -> L1_ICACHE1_FAIL_ID_R {
        L1_ICACHE1_FAIL_ID_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - The register records the attribution of fail-access when cache1 accesses L1-ICache.
    #[inline(always)]
...
///`read()` method returns [`l1_icache1_acs_fail_id_attr::R`](R) reader structure
