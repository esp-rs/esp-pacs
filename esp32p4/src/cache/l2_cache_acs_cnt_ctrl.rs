///Register `L2_CACHE_ACS_CNT_CTRL` reader
pub type R = crate::R<L2_CACHE_ACS_CNT_CTRL_SPEC>;
///Register `L2_CACHE_ACS_CNT_CTRL` writer
pub type W = crate::W<L2_CACHE_ACS_CNT_CTRL_SPEC>;
///Field `L2_IBUS0_CNT_ENA` reader - The bit is used to enable ibus0 counter in L2-Cache.
pub type L2_IBUS0_CNT_ENA_R = crate::BitReader;
///Field `L2_IBUS0_CNT_ENA` writer - The bit is used to enable ibus0 counter in L2-Cache.
pub type L2_IBUS0_CNT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_IBUS1_CNT_ENA` reader - The bit is used to enable ibus1 counter in L2-Cache.
pub type L2_IBUS1_CNT_ENA_R = crate::BitReader;
///Field `L2_IBUS1_CNT_ENA` writer - The bit is used to enable ibus1 counter in L2-Cache.
pub type L2_IBUS1_CNT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_IBUS2_CNT_ENA` reader - Reserved
pub type L2_IBUS2_CNT_ENA_R = crate::BitReader;
///Field `L2_IBUS3_CNT_ENA` reader - Reserved
pub type L2_IBUS3_CNT_ENA_R = crate::BitReader;
///Field `L2_DBUS0_CNT_ENA` reader - The bit is used to enable dbus0 counter in L2-Cache.
pub type L2_DBUS0_CNT_ENA_R = crate::BitReader;
///Field `L2_DBUS0_CNT_ENA` writer - The bit is used to enable dbus0 counter in L2-Cache.
pub type L2_DBUS0_CNT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_DBUS1_CNT_ENA` reader - The bit is used to enable dbus1 counter in L2-Cache.
pub type L2_DBUS1_CNT_ENA_R = crate::BitReader;
///Field `L2_DBUS1_CNT_ENA` writer - The bit is used to enable dbus1 counter in L2-Cache.
pub type L2_DBUS1_CNT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_DBUS2_CNT_ENA` reader - Reserved
pub type L2_DBUS2_CNT_ENA_R = crate::BitReader;
///Field `L2_DBUS3_CNT_ENA` reader - Reserved
pub type L2_DBUS3_CNT_ENA_R = crate::BitReader;
///Field `L2_IBUS0_CNT_CLR` writer - The bit is used to clear ibus0 counter in L2-Cache.
pub type L2_IBUS0_CNT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_IBUS1_CNT_CLR` writer - The bit is used to clear ibus1 counter in L2-Cache.
pub type L2_IBUS1_CNT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_IBUS2_CNT_CLR` reader - Reserved
pub type L2_IBUS2_CNT_CLR_R = crate::BitReader;
///Field `L2_IBUS3_CNT_CLR` reader - Reserved
pub type L2_IBUS3_CNT_CLR_R = crate::BitReader;
///Field `L2_DBUS0_CNT_CLR` writer - The bit is used to clear dbus0 counter in L2-Cache.
pub type L2_DBUS0_CNT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_DBUS1_CNT_CLR` writer - The bit is used to clear dbus1 counter in L2-Cache.
pub type L2_DBUS1_CNT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_DBUS2_CNT_CLR` reader - Reserved
pub type L2_DBUS2_CNT_CLR_R = crate::BitReader;
///Field `L2_DBUS3_CNT_CLR` reader - Reserved
pub type L2_DBUS3_CNT_CLR_R = crate::BitReader;
impl R {
    ///Bit 8 - The bit is used to enable ibus0 counter in L2-Cache.
    #[inline(always)]
    pub fn l2_ibus0_cnt_ena(&self) -> L2_IBUS0_CNT_ENA_R {
        L2_IBUS0_CNT_ENA_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - The bit is used to enable ibus1 counter in L2-Cache.
    #[inline(always)]
    ...
    ///Bit 12 - The bit is used to enable dbus0 counter in L2-Cache.
    #[inline(always)]
    pub fn l2_dbus0_cnt_ena(&self) -> L2_DBUS0_CNT_ENA_R {
        L2_DBUS0_CNT_ENA_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - The bit is used to enable dbus1 counter in L2-Cache.
    #[inline(always)]
...
///`read()` method returns [`l2_cache_acs_cnt_ctrl::R`](R) reader structure
impl crate::Readable for L2_CACHE_ACS_CNT_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_acs_cnt_ctrl::W`](W) writer structure
