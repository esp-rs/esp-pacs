///Register `L2_CACHE_DEBUG_BUS` reader
pub type R = crate::R<L2_CACHE_DEBUG_BUS_SPEC>;
///Register `L2_CACHE_DEBUG_BUS` writer
pub type W = crate::W<L2_CACHE_DEBUG_BUS_SPEC>;
///Field `L2_CACHE_DEBUG_BUS` reader - This is a constant place where we can write data to or read data from the tag/data memory on the specified cache.
pub type L2_CACHE_DEBUG_BUS_R = crate::FieldReader<u32>;
///Field `L2_CACHE_DEBUG_BUS` writer - This is a constant place where we can write data to or read data from the tag/data memory on the specified cache.
...
///`read()` method returns [`l2_cache_debug_bus::R`](R) reader structure
impl crate::Readable for L2_CACHE_DEBUG_BUS_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_debug_bus::W`](W) writer structure
