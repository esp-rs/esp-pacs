///Register `L2_CACHE_ACS_FAIL_ADDR` reader
pub type R = crate::R<L2_CACHE_ACS_FAIL_ADDR_SPEC>;
///Field `L2_CACHE_FAIL_ADDR` reader - The register records the address of fail-access when L1-Cache accesses L2-Cache.
pub type L2_CACHE_FAIL_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the address of fail-access when L1-Cache accesses L2-Cache.
    #[inline(always)]
...
///`read()` method returns [`l2_cache_acs_fail_addr::R`](R) reader structure
