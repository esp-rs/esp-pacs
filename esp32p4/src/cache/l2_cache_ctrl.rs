...
///Field `L2_CACHE_SHUT_DMA` writer - The bit is used to disable DMA access L2-Cache, 0: enable, 1: disable
...
///Field `L2_CACHE_UNDEF_OP` writer - Reserved
...
///`write(|w| ..)` method takes [`l2_cache_ctrl::W`](W) writer structure
