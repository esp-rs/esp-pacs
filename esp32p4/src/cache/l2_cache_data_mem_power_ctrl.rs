...
impl W {
    ...
    pub fn l2_cache_data_mem_force_on(
        &mut self,
    ) -> L2_CACHE_DATA_MEM_FORCE_ON_W<'_, L2_CACHE_DATA_MEM_POWER_CTRL_SPEC> {
    ...
    pub fn l2_cache_data_mem_force_pd(
        &mut self,
    ) -> L2_CACHE_DATA_MEM_FORCE_PD_W<'_, L2_CACHE_DATA_MEM_POWER_CTRL_SPEC> {
    ...
    pub fn l2_cache_data_mem_force_pu(
        &mut self,
    ) -> L2_CACHE_DATA_MEM_FORCE_PU_W<'_, L2_CACHE_DATA_MEM_POWER_CTRL_SPEC> {
