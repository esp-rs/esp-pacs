///Register `L2_IBUS1_ACS_CONFLICT_CNT` reader
pub type R = crate::R<L2_IBUS1_ACS_CONFLICT_CNT_SPEC>;
///Field `L2_IBUS1_CONFLICT_CNT` reader - The register records the number of access-conflicts when L1-ICache1 accesses L2-Cache due to bus1 accessing L1-ICache1.
pub type L2_IBUS1_CONFLICT_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of access-conflicts when L1-ICache1 accesses L2-Cache due to bus1 accessing L1-ICache1.
    #[inline(always)]
...
///`read()` method returns [`l2_ibus1_acs_conflict_cnt::R`](R) reader structure
