///Register `L1_DCACHE_AUTOLOAD_SCT1_SIZE` reader
pub type R = crate::R<L1_DCACHE_AUTOLOAD_SCT1_SIZE_SPEC>;
///Register `L1_DCACHE_AUTOLOAD_SCT1_SIZE` writer
pub type W = crate::W<L1_DCACHE_AUTOLOAD_SCT1_SIZE_SPEC>;
///Field `L1_DCACHE_AUTOLOAD_SCT1_SIZE` reader - Those bits are used to configure the size of the second section for autoload operation on L1-DCache. Note that it should be used together with L1_DCACHE_AUTOLOAD_SCT1_ADDR and L1_DCACHE_AUTOLOAD_SCT1_ENA.
pub type L1_DCACHE_AUTOLOAD_SCT1_SIZE_R = crate::FieldReader<u32>;
///Field `L1_DCACHE_AUTOLOAD_SCT1_SIZE` writer - Those bits are used to configure the size of the second section for autoload operation on L1-DCache. Note that it should be used together with L1_DCACHE_AUTOLOAD_SCT1_ADDR and L1_DCACHE_AUTOLOAD_SCT1_ENA.
pub type L1_DCACHE_AUTOLOAD_SCT1_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - Those bits are used to configure the size of the second section for autoload operation on L1-DCache. Note that it should be used together with L1_DCACHE_AUTOLOAD_SCT1_ADDR and L1_DCACHE_AUTOLOAD_SCT1_ENA.
    #[inline(always)]
...
///`read()` method returns [`l1_dcache_autoload_sct1_size::R`](R) reader structure
impl crate::Readable for L1_DCACHE_AUTOLOAD_SCT1_SIZE_SPEC {}
///`write(|w| ..)` method takes [`l1_dcache_autoload_sct1_size::W`](W) writer structure
