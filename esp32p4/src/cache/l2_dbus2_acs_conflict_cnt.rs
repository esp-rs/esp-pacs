///Register `L2_DBUS2_ACS_CONFLICT_CNT` reader
pub type R = crate::R<L2_DBUS2_ACS_CONFLICT_CNT_SPEC>;
///Field `L2_DBUS2_CONFLICT_CNT` reader - The register records the number of access-conflicts when L1-DCache accesses L2-Cache due to bus2 accessing L1-DCache.
pub type L2_DBUS2_CONFLICT_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of access-conflicts when L1-DCache accesses L2-Cache due to bus2 accessing L1-DCache.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`l2_dbus2_acs_conflict_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L2_DBUS2_ACS_CONFLICT_CNT_SPEC;
impl crate::RegisterSpec for L2_DBUS2_ACS_CONFLICT_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l2_dbus2_acs_conflict_cnt::R`](R) reader structure
