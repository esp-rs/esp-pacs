...
///Field `L1_IBUS0_CNT_ENA` writer - The bit is used to enable ibus0 counter in L1-ICache0.
...
///Field `L1_IBUS1_CNT_ENA` writer - The bit is used to enable ibus1 counter in L1-ICache1.
...
///Field `L1_DBUS0_CNT_ENA` reader - The bit is used to enable dbus0 counter in L1-DCache.
pub type L1_DBUS0_CNT_ENA_R = crate::BitReader;
///Field `L1_DBUS0_CNT_ENA` writer - The bit is used to enable dbus0 counter in L1-DCache.
pub type L1_DBUS0_CNT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DBUS1_CNT_ENA` reader - The bit is used to enable dbus1 counter in L1-DCache.
pub type L1_DBUS1_CNT_ENA_R = crate::BitReader;
///Field `L1_DBUS1_CNT_ENA` writer - The bit is used to enable dbus1 counter in L1-DCache.
...
///Field `L1_IBUS0_CNT_CLR` writer - The bit is used to clear ibus0 counter in L1-ICache0.
pub type L1_IBUS0_CNT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_IBUS1_CNT_CLR` writer - The bit is used to clear ibus1 counter in L1-ICache1.
...
///Field `L1_DBUS0_CNT_CLR` writer - The bit is used to clear dbus0 counter in L1-DCache.
pub type L1_DBUS0_CNT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DBUS1_CNT_CLR` writer - The bit is used to clear dbus1 counter in L1-DCache.
