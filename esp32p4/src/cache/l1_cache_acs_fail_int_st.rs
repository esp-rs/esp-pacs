...
///Field `L1_ICACHE0_FAIL_INT_ST` reader - The bit indicates the interrupt status of access fail that occurs in L1-ICache0 due to cpu accesses L1-ICache.
pub type L1_ICACHE0_FAIL_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE1_FAIL_INT_ST` reader - The bit indicates the interrupt status of access fail that occurs in L1-ICache1 due to cpu accesses L1-ICache.
pub type L1_ICACHE1_FAIL_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE2_FAIL_INT_ST` reader - Reserved
pub type L1_ICACHE2_FAIL_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE3_FAIL_INT_ST` reader - Reserved
pub type L1_ICACHE3_FAIL_INT_ST_R = crate::BitReader;
///Field `L1_DCACHE_FAIL_INT_ST` reader - The bit indicates the interrupt status of access fail that occurs in L1-DCache due to cpu accesses L1-DCache.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_ACS_FAIL_INT_ST")
            ...
            .field("l1_dcache_fail_int_st", &self.l1_dcache_fail_int_st())
            .finish()
    }
}
...
///`read()` method returns [`l1_cache_acs_fail_int_st::R`](R) reader structure
