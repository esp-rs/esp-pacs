///Register `L1_DCACHE_ACS_FAIL_ADDR` reader
pub type R = crate::R<L1_DCACHE_ACS_FAIL_ADDR_SPEC>;
///Field `L1_DCACHE_FAIL_ADDR` reader - The register records the address of fail-access when cache accesses L1-DCache.
pub type L1_DCACHE_FAIL_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the address of fail-access when cache accesses L1-DCache.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_DCACHE_ACS_FAIL_ADDR")
            .field("l1_dcache_fail_addr", &self.l1_dcache_fail_addr())
            .finish()
    }
}
...
///`read()` method returns [`l1_dcache_acs_fail_addr::R`](R) reader structure
