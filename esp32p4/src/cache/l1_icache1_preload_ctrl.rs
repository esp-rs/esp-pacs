...
///Register `L1_ICACHE1_PRELOAD_CTRL` writer
pub type W = crate::W<L1_ICACHE1_PRELOAD_CTRL_SPEC>;
///Field `L1_ICACHE1_PRELOAD_ENA` reader - The bit is used to enable preload operation on L1-ICache1. It will be cleared by hardware automatically after preload operation is done.
pub type L1_ICACHE1_PRELOAD_ENA_R = crate::BitReader;
///Field `L1_ICACHE1_PRELOAD_ENA` writer - The bit is used to enable preload operation on L1-ICache1. It will be cleared by hardware automatically after preload operation is done.
pub type L1_ICACHE1_PRELOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_PRELOAD_DONE` reader - The bit is used to indicate whether preload operation is finished or not. 0: not finished. 1: finished.
pub type L1_ICACHE1_PRELOAD_DONE_R = crate::BitReader;
///Field `L1_ICACHE1_PRELOAD_ORDER` reader - The bit is used to configure the direction of preload operation. 0: ascending, 1: descending.
pub type L1_ICACHE1_PRELOAD_ORDER_R = crate::BitReader;
///Field `L1_ICACHE1_PRELOAD_ORDER` writer - The bit is used to configure the direction of preload operation. 0: ascending, 1: descending.
...
///Field `L1_ICACHE1_PRELOAD_RGID` writer - The bit is used to set the gid of l1 icache1 preload.
...
///`read()` method returns [`l1_icache1_preload_ctrl::R`](R) reader structure
impl crate::Readable for L1_ICACHE1_PRELOAD_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l1_icache1_preload_ctrl::W`](W) writer structure
