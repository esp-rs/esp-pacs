...
///Register `L2_CACHE_VADDR` writer
...
///Field `L2_CACHE_VADDR` writer - Those bits stores the virtual address which will decide where inside the specified tag memory object will be accessed.
...
///`write(|w| ..)` method takes [`l2_cache_vaddr::W`](W) writer structure
