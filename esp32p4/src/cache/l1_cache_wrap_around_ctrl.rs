///Register `L1_CACHE_WRAP_AROUND_CTRL` reader
pub type R = crate::R<L1_CACHE_WRAP_AROUND_CTRL_SPEC>;
///Register `L1_CACHE_WRAP_AROUND_CTRL` writer
pub type W = crate::W<L1_CACHE_WRAP_AROUND_CTRL_SPEC>;
///Field `L1_ICACHE0_WRAP` reader - Set this bit as 1 to enable L1-ICache0 wrap around mode.
pub type L1_ICACHE0_WRAP_R = crate::BitReader;
///Field `L1_ICACHE0_WRAP` writer - Set this bit as 1 to enable L1-ICache0 wrap around mode.
pub type L1_ICACHE0_WRAP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_WRAP` reader - Set this bit as 1 to enable L1-ICache1 wrap around mode.
pub type L1_ICACHE1_WRAP_R = crate::BitReader;
///Field `L1_ICACHE1_WRAP` writer - Set this bit as 1 to enable L1-ICache1 wrap around mode.
pub type L1_ICACHE1_WRAP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE2_WRAP` reader - Reserved
pub type L1_ICACHE2_WRAP_R = crate::BitReader;
///Field `L1_ICACHE3_WRAP` reader - Reserved
pub type L1_ICACHE3_WRAP_R = crate::BitReader;
///Field `L1_DCACHE_WRAP` reader - Set this bit as 1 to enable L1-DCache wrap around mode.
pub type L1_DCACHE_WRAP_R = crate::BitReader;
///Field `L1_DCACHE_WRAP` writer - Set this bit as 1 to enable L1-DCache wrap around mode.
pub type L1_DCACHE_WRAP_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit as 1 to enable L1-ICache0 wrap around mode.
    #[inline(always)]
    pub fn l1_icache0_wrap(&self) -> L1_ICACHE0_WRAP_R {
        L1_ICACHE0_WRAP_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set this bit as 1 to enable L1-ICache1 wrap around mode.
    #[inline(always)]
    ...
    ///Bit 4 - Set this bit as 1 to enable L1-DCache wrap around mode.
    #[inline(always)]
...
///`read()` method returns [`l1_cache_wrap_around_ctrl::R`](R) reader structure
impl crate::Readable for L1_CACHE_WRAP_AROUND_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_wrap_around_ctrl::W`](W) writer structure
