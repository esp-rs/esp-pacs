///Register `L2_CACHE_PRELOAD_CTRL` reader
...
///Field `L2_CACHE_PRELOAD_ENA` reader - The bit is used to enable preload operation on L2-Cache. It will be cleared by hardware automatically after preload operation is done.
pub type L2_CACHE_PRELOAD_ENA_R = crate::BitReader;
///Field `L2_CACHE_PRELOAD_ENA` writer - The bit is used to enable preload operation on L2-Cache. It will be cleared by hardware automatically after preload operation is done.
pub type L2_CACHE_PRELOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_CACHE_PRELOAD_DONE` reader - The bit is used to indicate whether preload operation is finished or not. 0: not finished. 1: finished.
pub type L2_CACHE_PRELOAD_DONE_R = crate::BitReader;
///Field `L2_CACHE_PRELOAD_ORDER` reader - The bit is used to configure the direction of preload operation. 0: ascending, 1: descending.
pub type L2_CACHE_PRELOAD_ORDER_R = crate::BitReader;
///Field `L2_CACHE_PRELOAD_ORDER` writer - The bit is used to configure the direction of preload operation. 0: ascending, 1: descending.
pub type L2_CACHE_PRELOAD_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_CACHE_PRELOAD_RGID` reader - The bit is used to set the gid of l2 cache preload.
pub type L2_CACHE_PRELOAD_RGID_R = crate::FieldReader;
///Field `L2_CACHE_PRELOAD_RGID` writer - The bit is used to set the gid of l2 cache preload.
...
///`read()` method returns [`l2_cache_preload_ctrl::R`](R) reader structure
impl crate::Readable for L2_CACHE_PRELOAD_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_preload_ctrl::W`](W) writer structure
