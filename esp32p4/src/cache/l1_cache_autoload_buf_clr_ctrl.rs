///Register `L1_CACHE_AUTOLOAD_BUF_CLR_CTRL` reader
pub type R = crate::R<L1_CACHE_AUTOLOAD_BUF_CLR_CTRL_SPEC>;
///Register `L1_CACHE_AUTOLOAD_BUF_CLR_CTRL` writer
pub type W = crate::W<L1_CACHE_AUTOLOAD_BUF_CLR_CTRL_SPEC>;
///Field `L1_ICACHE0_ALD_BUF_CLR` reader - set this bit to clear autoload-buffer inside L1-ICache0. If this bit is active, autoload will not work in L1-ICache0. This bit should not be active when autoload works in L1-ICache0.
pub type L1_ICACHE0_ALD_BUF_CLR_R = crate::BitReader;
///Field `L1_ICACHE0_ALD_BUF_CLR` writer - set this bit to clear autoload-buffer inside L1-ICache0. If this bit is active, autoload will not work in L1-ICache0. This bit should not be active when autoload works in L1-ICache0.
pub type L1_ICACHE0_ALD_BUF_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_ALD_BUF_CLR` reader - set this bit to clear autoload-buffer inside L1-ICache1. If this bit is active, autoload will not work in L1-ICache1. This bit should not be active when autoload works in L1-ICache1.
pub type L1_ICACHE1_ALD_BUF_CLR_R = crate::BitReader;
///Field `L1_ICACHE1_ALD_BUF_CLR` writer - set this bit to clear autoload-buffer inside L1-ICache1. If this bit is active, autoload will not work in L1-ICache1. This bit should not be active when autoload works in L1-ICache1.
pub type L1_ICACHE1_ALD_BUF_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE2_ALD_BUF_CLR` reader - Reserved
pub type L1_ICACHE2_ALD_BUF_CLR_R = crate::BitReader;
///Field `L1_ICACHE3_ALD_BUF_CLR` reader - Reserved
pub type L1_ICACHE3_ALD_BUF_CLR_R = crate::BitReader;
///Field `L1_DCACHE_ALD_BUF_CLR` reader - set this bit to clear autoload-buffer inside L1-DCache. If this bit is active, autoload will not work in L1-DCache. This bit should not be active when autoload works in L1-DCache.
pub type L1_DCACHE_ALD_BUF_CLR_R = crate::BitReader;
///Field `L1_DCACHE_ALD_BUF_CLR` writer - set this bit to clear autoload-buffer inside L1-DCache. If this bit is active, autoload will not work in L1-DCache. This bit should not be active when autoload works in L1-DCache.
pub type L1_DCACHE_ALD_BUF_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - set this bit to clear autoload-buffer inside L1-ICache0. If this bit is active, autoload will not work in L1-ICache0. This bit should not be active when autoload works in L1-ICache0.
    #[inline(always)]
    pub fn l1_icache0_ald_buf_clr(&self) -> L1_ICACHE0_ALD_BUF_CLR_R {
        L1_ICACHE0_ALD_BUF_CLR_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - set this bit to clear autoload-buffer inside L1-ICache1. If this bit is active, autoload will not work in L1-ICache1. This bit should not be active when autoload works in L1-ICache1.
    #[inline(always)]
    ...
    ///Bit 4 - set this bit to clear autoload-buffer inside L1-DCache. If this bit is active, autoload will not work in L1-DCache. This bit should not be active when autoload works in L1-DCache.
    #[inline(always)]
...
///`read()` method returns [`l1_cache_autoload_buf_clr_ctrl::R`](R) reader structure
impl crate::Readable for L1_CACHE_AUTOLOAD_BUF_CLR_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_autoload_buf_clr_ctrl::W`](W) writer structure
