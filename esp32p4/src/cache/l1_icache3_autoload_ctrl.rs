///Register `L1_ICACHE3_AUTOLOAD_CTRL` reader
pub type R = crate::R<L1_ICACHE3_AUTOLOAD_CTRL_SPEC>;
///Field `L1_ICACHE3_AUTOLOAD_ENA` reader - The bit is used to enable and disable autoload operation on L1-ICache3. 1: enable, 0: disable.
pub type L1_ICACHE3_AUTOLOAD_ENA_R = crate::BitReader;
///Field `L1_ICACHE3_AUTOLOAD_DONE` reader - The bit is used to indicate whether autoload operation on L1-ICache3 is finished or not. 0: not finished. 1: finished.
pub type L1_ICACHE3_AUTOLOAD_DONE_R = crate::BitReader;
///Field `L1_ICACHE3_AUTOLOAD_ORDER` reader - The bit is used to configure the direction of autoload operation on L1-ICache3. 0: ascending. 1: descending.
pub type L1_ICACHE3_AUTOLOAD_ORDER_R = crate::BitReader;
///Field `L1_ICACHE3_AUTOLOAD_TRIGGER_MODE` reader - The field is used to configure trigger mode of autoload operation on L1-ICache3. 0/3: miss-trigger, 1: hit-trigger, 2: miss-hit-trigger.
pub type L1_ICACHE3_AUTOLOAD_TRIGGER_MODE_R = crate::FieldReader;
///Field `L1_ICACHE3_AUTOLOAD_SCT0_ENA` reader - The bit is used to enable the first section for autoload operation on L1-ICache3.
pub type L1_ICACHE3_AUTOLOAD_SCT0_ENA_R = crate::BitReader;
///Field `L1_ICACHE3_AUTOLOAD_SCT1_ENA` reader - The bit is used to enable the second section for autoload operation on L1-ICache3.
pub type L1_ICACHE3_AUTOLOAD_SCT1_ENA_R = crate::BitReader;
///Field `L1_ICACHE3_AUTOLOAD_RGID` reader - The bit is used to set the gid of l1 icache3 autoload.
pub type L1_ICACHE3_AUTOLOAD_RGID_R = crate::FieldReader;
impl R {
    ///Bit 0 - The bit is used to enable and disable autoload operation on L1-ICache3. 1: enable, 0: disable.
    #[inline(always)]
    pub fn l1_icache3_autoload_ena(&self) -> L1_ICACHE3_AUTOLOAD_ENA_R {
        L1_ICACHE3_AUTOLOAD_ENA_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit is used to indicate whether autoload operation on L1-ICache3 is finished or not. 0: not finished. 1: finished.
    #[inline(always)]
    pub fn l1_icache3_autoload_done(&self) -> L1_ICACHE3_AUTOLOAD_DONE_R {
        L1_ICACHE3_AUTOLOAD_DONE_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - The bit is used to configure the direction of autoload operation on L1-ICache3. 0: ascending. 1: descending.
    #[inline(always)]
    pub fn l1_icache3_autoload_order(&self) -> L1_ICACHE3_AUTOLOAD_ORDER_R {
        L1_ICACHE3_AUTOLOAD_ORDER_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bits 3:4 - The field is used to configure trigger mode of autoload operation on L1-ICache3. 0/3: miss-trigger, 1: hit-trigger, 2: miss-hit-trigger.
    #[inline(always)]
    ...
    ///Bit 8 - The bit is used to enable the first section for autoload operation on L1-ICache3.
    #[inline(always)]
    ...
    ///Bit 9 - The bit is used to enable the second section for autoload operation on L1-ICache3.
    #[inline(always)]
    ...
    ///Bits 10:13 - The bit is used to set the gid of l1 icache3 autoload.
    #[inline(always)]
...
///`read()` method returns [`l1_icache3_autoload_ctrl::R`](R) reader structure
