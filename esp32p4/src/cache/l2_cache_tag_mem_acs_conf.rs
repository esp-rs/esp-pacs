...
impl W {
    ...
    pub fn l2_cache_tag_mem_rd_en(
        &mut self,
    ) -> L2_CACHE_TAG_MEM_RD_EN_W<'_, L2_CACHE_TAG_MEM_ACS_CONF_SPEC> {
    ...
    pub fn l2_cache_tag_mem_wr_en(
        &mut self,
    ) -> L2_CACHE_TAG_MEM_WR_EN_W<'_, L2_CACHE_TAG_MEM_ACS_CONF_SPEC> {
        L2_CACHE_TAG_MEM_WR_EN_W::new(self, 21)
    }
}
#[doc = "Cache tag memory access configure register\n\nYou can [`read`](crate::Reg::read) this register and get [`l2_cache_tag_mem_acs_conf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l2_cache_tag_mem_acs_conf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
