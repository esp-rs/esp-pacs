///Register `L2_CACHE_TAG_MEM_ACS_CONF` reader
pub type R = crate::R<L2_CACHE_TAG_MEM_ACS_CONF_SPEC>;
///Register `L2_CACHE_TAG_MEM_ACS_CONF` writer
pub type W = crate::W<L2_CACHE_TAG_MEM_ACS_CONF_SPEC>;
///Field `L2_CACHE_TAG_MEM_RD_EN` reader - The bit is used to enable config-bus read L2-Cache tag memoryory. 0: disable, 1: enable.
pub type L2_CACHE_TAG_MEM_RD_EN_R = crate::BitReader;
///Field `L2_CACHE_TAG_MEM_RD_EN` writer - The bit is used to enable config-bus read L2-Cache tag memoryory. 0: disable, 1: enable.
pub type L2_CACHE_TAG_MEM_RD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_CACHE_TAG_MEM_WR_EN` reader - The bit is used to enable config-bus write L2-Cache tag memoryory. 0: disable, 1: enable.
pub type L2_CACHE_TAG_MEM_WR_EN_R = crate::BitReader;
///Field `L2_CACHE_TAG_MEM_WR_EN` writer - The bit is used to enable config-bus write L2-Cache tag memoryory. 0: disable, 1: enable.
pub type L2_CACHE_TAG_MEM_WR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 20 - The bit is used to enable config-bus read L2-Cache tag memoryory. 0: disable, 1: enable.
    #[inline(always)]
    pub fn l2_cache_tag_mem_rd_en(&self) -> L2_CACHE_TAG_MEM_RD_EN_R {
        L2_CACHE_TAG_MEM_RD_EN_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - The bit is used to enable config-bus write L2-Cache tag memoryory. 0: disable, 1: enable.
    #[inline(always)]
...
///`read()` method returns [`l2_cache_tag_mem_acs_conf::R`](R) reader structure
impl crate::Readable for L2_CACHE_TAG_MEM_ACS_CONF_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_tag_mem_acs_conf::W`](W) writer structure
