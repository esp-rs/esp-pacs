///Register `L1_DCACHE_AUTOLOAD_SCT1_ADDR` reader
pub type R = crate::R<L1_DCACHE_AUTOLOAD_SCT1_ADDR_SPEC>;
///Register `L1_DCACHE_AUTOLOAD_SCT1_ADDR` writer
pub type W = crate::W<L1_DCACHE_AUTOLOAD_SCT1_ADDR_SPEC>;
///Field `L1_DCACHE_AUTOLOAD_SCT1_ADDR` reader - Those bits are used to configure the start virtual address of the second section for autoload operation on L1-DCache. Note that it should be used together with L1_DCACHE_AUTOLOAD_SCT1_SIZE and L1_DCACHE_AUTOLOAD_SCT1_ENA.
pub type L1_DCACHE_AUTOLOAD_SCT1_ADDR_R = crate::FieldReader<u32>;
///Field `L1_DCACHE_AUTOLOAD_SCT1_ADDR` writer - Those bits are used to configure the start virtual address of the second section for autoload operation on L1-DCache. Note that it should be used together with L1_DCACHE_AUTOLOAD_SCT1_SIZE and L1_DCACHE_AUTOLOAD_SCT1_ENA.
pub type L1_DCACHE_AUTOLOAD_SCT1_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Those bits are used to configure the start virtual address of the second section for autoload operation on L1-DCache. Note that it should be used together with L1_DCACHE_AUTOLOAD_SCT1_SIZE and L1_DCACHE_AUTOLOAD_SCT1_ENA.
    #[inline(always)]
...
///`read()` method returns [`l1_dcache_autoload_sct1_addr::R`](R) reader structure
impl crate::Readable for L1_DCACHE_AUTOLOAD_SCT1_ADDR_SPEC {}
///`write(|w| ..)` method takes [`l1_dcache_autoload_sct1_addr::W`](W) writer structure
