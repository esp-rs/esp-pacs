///Register `L1_ICACHE0_AUTOLOAD_SCT0_ADDR` reader
pub type R = crate::R<L1_ICACHE0_AUTOLOAD_SCT0_ADDR_SPEC>;
///Register `L1_ICACHE0_AUTOLOAD_SCT0_ADDR` writer
pub type W = crate::W<L1_ICACHE0_AUTOLOAD_SCT0_ADDR_SPEC>;
///Field `L1_ICACHE0_AUTOLOAD_SCT0_ADDR` reader - Those bits are used to configure the start virtual address of the first section for autoload operation on L1-ICache0. Note that it should be used together with L1_ICACHE0_AUTOLOAD_SCT0_SIZE and L1_ICACHE_AUTOLOAD_SCT0_ENA.
pub type L1_ICACHE0_AUTOLOAD_SCT0_ADDR_R = crate::FieldReader<u32>;
///Field `L1_ICACHE0_AUTOLOAD_SCT0_ADDR` writer - Those bits are used to configure the start virtual address of the first section for autoload operation on L1-ICache0. Note that it should be used together with L1_ICACHE0_AUTOLOAD_SCT0_SIZE and L1_ICACHE_AUTOLOAD_SCT0_ENA.
pub type L1_ICACHE0_AUTOLOAD_SCT0_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Those bits are used to configure the start virtual address of the first section for autoload operation on L1-ICache0. Note that it should be used together with L1_ICACHE0_AUTOLOAD_SCT0_SIZE and L1_ICACHE_AUTOLOAD_SCT0_ENA.
    #[inline(always)]
...
///`read()` method returns [`l1_icache0_autoload_sct0_addr::R`](R) reader structure
impl crate::Readable for L1_ICACHE0_AUTOLOAD_SCT0_ADDR_SPEC {}
///`write(|w| ..)` method takes [`l1_icache0_autoload_sct0_addr::W`](W) writer structure
