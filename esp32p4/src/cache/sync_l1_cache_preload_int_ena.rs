///Register `SYNC_L1_CACHE_PRELOAD_INT_ENA` reader
pub type R = crate::R<SYNC_L1_CACHE_PRELOAD_INT_ENA_SPEC>;
///Register `SYNC_L1_CACHE_PRELOAD_INT_ENA` writer
pub type W = crate::W<SYNC_L1_CACHE_PRELOAD_INT_ENA_SPEC>;
///Field `L1_ICACHE0_PLD_DONE_INT_ENA` reader - The bit is used to enable interrupt of L1-ICache0 preload-operation. If preload operation is done, interrupt occurs.
pub type L1_ICACHE0_PLD_DONE_INT_ENA_R = crate::BitReader;
///Field `L1_ICACHE0_PLD_DONE_INT_ENA` writer - The bit is used to enable interrupt of L1-ICache0 preload-operation. If preload operation is done, interrupt occurs.
pub type L1_ICACHE0_PLD_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_PLD_DONE_INT_ENA` reader - The bit is used to enable interrupt of L1-ICache1 preload-operation. If preload operation is done, interrupt occurs.
pub type L1_ICACHE1_PLD_DONE_INT_ENA_R = crate::BitReader;
///Field `L1_ICACHE1_PLD_DONE_INT_ENA` writer - The bit is used to enable interrupt of L1-ICache1 preload-operation. If preload operation is done, interrupt occurs.
pub type L1_ICACHE1_PLD_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE2_PLD_DONE_INT_ENA` reader - Reserved
pub type L1_ICACHE2_PLD_DONE_INT_ENA_R = crate::BitReader;
///Field `L1_ICACHE3_PLD_DONE_INT_ENA` reader - Reserved
pub type L1_ICACHE3_PLD_DONE_INT_ENA_R = crate::BitReader;
///Field `L1_DCACHE_PLD_DONE_INT_ENA` reader - The bit is used to enable interrupt of L1-DCache preload-operation. If preload operation is done, interrupt occurs.
pub type L1_DCACHE_PLD_DONE_INT_ENA_R = crate::BitReader;
///Field `L1_DCACHE_PLD_DONE_INT_ENA` writer - The bit is used to enable interrupt of L1-DCache preload-operation. If preload operation is done, interrupt occurs.
pub type L1_DCACHE_PLD_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYNC_DONE_INT_ENA` reader - The bit is used to enable interrupt of Cache sync-operation done.
pub type SYNC_DONE_INT_ENA_R = crate::BitReader;
///Field `SYNC_DONE_INT_ENA` writer - The bit is used to enable interrupt of Cache sync-operation done.
pub type SYNC_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE0_PLD_ERR_INT_ENA` reader - The bit is used to enable interrupt of L1-ICache0 preload-operation error.
pub type L1_ICACHE0_PLD_ERR_INT_ENA_R = crate::BitReader;
///Field `L1_ICACHE0_PLD_ERR_INT_ENA` writer - The bit is used to enable interrupt of L1-ICache0 preload-operation error.
pub type L1_ICACHE0_PLD_ERR_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_PLD_ERR_INT_ENA` reader - The bit is used to enable interrupt of L1-ICache1 preload-operation error.
pub type L1_ICACHE1_PLD_ERR_INT_ENA_R = crate::BitReader;
///Field `L1_ICACHE1_PLD_ERR_INT_ENA` writer - The bit is used to enable interrupt of L1-ICache1 preload-operation error.
pub type L1_ICACHE1_PLD_ERR_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE2_PLD_ERR_INT_ENA` reader - Reserved
pub type L1_ICACHE2_PLD_ERR_INT_ENA_R = crate::BitReader;
///Field `L1_ICACHE3_PLD_ERR_INT_ENA` reader - Reserved
pub type L1_ICACHE3_PLD_ERR_INT_ENA_R = crate::BitReader;
///Field `L1_DCACHE_PLD_ERR_INT_ENA` reader - The bit is used to enable interrupt of L1-DCache preload-operation error.
pub type L1_DCACHE_PLD_ERR_INT_ENA_R = crate::BitReader;
///Field `L1_DCACHE_PLD_ERR_INT_ENA` writer - The bit is used to enable interrupt of L1-DCache preload-operation error.
pub type L1_DCACHE_PLD_ERR_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYNC_ERR_INT_ENA` reader - The bit is used to enable interrupt of Cache sync-operation error.
pub type SYNC_ERR_INT_ENA_R = crate::BitReader;
///Field `SYNC_ERR_INT_ENA` writer - The bit is used to enable interrupt of Cache sync-operation error.
pub type SYNC_ERR_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - The bit is used to enable interrupt of L1-ICache0 preload-operation. If preload operation is done, interrupt occurs.
    #[inline(always)]
    pub fn l1_icache0_pld_done_int_ena(&self) -> L1_ICACHE0_PLD_DONE_INT_ENA_R {
        L1_ICACHE0_PLD_DONE_INT_ENA_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit is used to enable interrupt of L1-ICache1 preload-operation. If preload operation is done, interrupt occurs.
    #[inline(always)]
    ...
    ///Bit 4 - The bit is used to enable interrupt of L1-DCache preload-operation. If preload operation is done, interrupt occurs.
    #[inline(always)]
    ...
    ///Bit 8 - The bit is used to enable interrupt of L1-ICache1 preload-operation error.
    #[inline(always)]
    ...
    ///Bit 11 - The bit is used to enable interrupt of L1-DCache preload-operation error.
    #[inline(always)]
...
///`read()` method returns [`sync_l1_cache_preload_int_ena::R`](R) reader structure
impl crate::Readable for SYNC_L1_CACHE_PRELOAD_INT_ENA_SPEC {}
///`write(|w| ..)` method takes [`sync_l1_cache_preload_int_ena::W`](W) writer structure
