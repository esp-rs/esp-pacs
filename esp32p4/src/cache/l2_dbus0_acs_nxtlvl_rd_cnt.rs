///Register `L2_DBUS0_ACS_NXTLVL_RD_CNT` reader
pub type R = crate::R<L2_DBUS0_ACS_NXTLVL_RD_CNT_SPEC>;
///Field `L2_DBUS0_NXTLVL_RD_CNT` reader - The register records the number of times that L2-Cache accesses external memory due to L1-DCache accessing L2-Cache due to bus0 accessing L1-DCache.
pub type L2_DBUS0_NXTLVL_RD_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of times that L2-Cache accesses external memory due to L1-DCache accessing L2-Cache due to bus0 accessing L1-DCache.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_DBUS0_ACS_NXTLVL_RD_CNT")
            .field("l2_dbus0_nxtlvl_rd_cnt", &self.l2_dbus0_nxtlvl_rd_cnt())
            .finish()
    }
}
...
///`read()` method returns [`l2_dbus0_acs_nxtlvl_rd_cnt::R`](R) reader structure
