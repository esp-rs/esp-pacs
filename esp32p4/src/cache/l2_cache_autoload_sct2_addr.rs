...
///Register `L2_CACHE_AUTOLOAD_SCT2_ADDR` writer
pub type W = crate::W<L2_CACHE_AUTOLOAD_SCT2_ADDR_SPEC>;
///Field `L2_CACHE_AUTOLOAD_SCT2_ADDR` reader - Those bits are used to configure the start virtual address of the third section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT2_SIZE and L2_CACHE_AUTOLOAD_SCT2_ENA.
pub type L2_CACHE_AUTOLOAD_SCT2_ADDR_R = crate::FieldReader<u32>;
///Field `L2_CACHE_AUTOLOAD_SCT2_ADDR` writer - Those bits are used to configure the start virtual address of the third section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT2_SIZE and L2_CACHE_AUTOLOAD_SCT2_ENA.
...
impl W {
    ...
    pub fn l2_cache_autoload_sct2_addr(
        &mut self,
    ) -> L2_CACHE_AUTOLOAD_SCT2_ADDR_W<L2_CACHE_AUTOLOAD_SCT2_ADDR_SPEC> {
...
///`read()` method returns [`l2_cache_autoload_sct2_addr::R`](R) reader structure
impl crate::Readable for L2_CACHE_AUTOLOAD_SCT2_ADDR_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_autoload_sct2_addr::W`](W) writer structure
