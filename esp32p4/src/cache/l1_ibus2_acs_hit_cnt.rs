///Register `L1_IBUS2_ACS_HIT_CNT` reader
pub type R = crate::R<L1_IBUS2_ACS_HIT_CNT_SPEC>;
///Field `L1_IBUS2_HIT_CNT` reader - The register records the number of hits when bus2 accesses L1-ICache2.
pub type L1_IBUS2_HIT_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of hits when bus2 accesses L1-ICache2.
    #[inline(always)]
...
///`read()` method returns [`l1_ibus2_acs_hit_cnt::R`](R) reader structure
