///Register `L1_CACHE_DATA_MEM_ACS_CONF` reader
pub type R = crate::R<L1_CACHE_DATA_MEM_ACS_CONF_SPEC>;
///Register `L1_CACHE_DATA_MEM_ACS_CONF` writer
pub type W = crate::W<L1_CACHE_DATA_MEM_ACS_CONF_SPEC>;
///Field `L1_ICACHE0_DATA_MEM_RD_EN` reader - The bit is used to enable config-bus read L1-ICache0 data memoryory. 0: disable, 1: enable.
pub type L1_ICACHE0_DATA_MEM_RD_EN_R = crate::BitReader;
///Field `L1_ICACHE0_DATA_MEM_RD_EN` writer - The bit is used to enable config-bus read L1-ICache0 data memoryory. 0: disable, 1: enable.
pub type L1_ICACHE0_DATA_MEM_RD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE0_DATA_MEM_WR_EN` reader - The bit is used to enable config-bus write L1-ICache0 data memoryory. 0: disable, 1: enable.
pub type L1_ICACHE0_DATA_MEM_WR_EN_R = crate::BitReader;
///Field `L1_ICACHE0_DATA_MEM_WR_EN` writer - The bit is used to enable config-bus write L1-ICache0 data memoryory. 0: disable, 1: enable.
pub type L1_ICACHE0_DATA_MEM_WR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_DATA_MEM_RD_EN` reader - The bit is used to enable config-bus read L1-ICache1 data memoryory. 0: disable, 1: enable.
pub type L1_ICACHE1_DATA_MEM_RD_EN_R = crate::BitReader;
///Field `L1_ICACHE1_DATA_MEM_RD_EN` writer - The bit is used to enable config-bus read L1-ICache1 data memoryory. 0: disable, 1: enable.
pub type L1_ICACHE1_DATA_MEM_RD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_DATA_MEM_WR_EN` reader - The bit is used to enable config-bus write L1-ICache1 data memoryory. 0: disable, 1: enable.
pub type L1_ICACHE1_DATA_MEM_WR_EN_R = crate::BitReader;
///Field `L1_ICACHE1_DATA_MEM_WR_EN` writer - The bit is used to enable config-bus write L1-ICache1 data memoryory. 0: disable, 1: enable.
pub type L1_ICACHE1_DATA_MEM_WR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE2_DATA_MEM_RD_EN` reader - Reserved
pub type L1_ICACHE2_DATA_MEM_RD_EN_R = crate::BitReader;
///Field `L1_ICACHE2_DATA_MEM_WR_EN` reader - Reserved
pub type L1_ICACHE2_DATA_MEM_WR_EN_R = crate::BitReader;
///Field `L1_ICACHE3_DATA_MEM_RD_EN` reader - Reserved
pub type L1_ICACHE3_DATA_MEM_RD_EN_R = crate::BitReader;
///Field `L1_ICACHE3_DATA_MEM_WR_EN` reader - Reserved
pub type L1_ICACHE3_DATA_MEM_WR_EN_R = crate::BitReader;
///Field `L1_DCACHE_DATA_MEM_RD_EN` reader - The bit is used to enable config-bus read L1-DCache data memoryory. 0: disable, 1: enable.
pub type L1_DCACHE_DATA_MEM_RD_EN_R = crate::BitReader;
///Field `L1_DCACHE_DATA_MEM_RD_EN` writer - The bit is used to enable config-bus read L1-DCache data memoryory. 0: disable, 1: enable.
pub type L1_DCACHE_DATA_MEM_RD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DCACHE_DATA_MEM_WR_EN` reader - The bit is used to enable config-bus write L1-DCache data memoryory. 0: disable, 1: enable.
pub type L1_DCACHE_DATA_MEM_WR_EN_R = crate::BitReader;
///Field `L1_DCACHE_DATA_MEM_WR_EN` writer - The bit is used to enable config-bus write L1-DCache data memoryory. 0: disable, 1: enable.
pub type L1_DCACHE_DATA_MEM_WR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - The bit is used to enable config-bus read L1-ICache0 data memoryory. 0: disable, 1: enable.
    #[inline(always)]
    pub fn l1_icache0_data_mem_rd_en(&self) -> L1_ICACHE0_DATA_MEM_RD_EN_R {
        L1_ICACHE0_DATA_MEM_RD_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit is used to enable config-bus write L1-ICache0 data memoryory. 0: disable, 1: enable.
    #[inline(always)]
    pub fn l1_icache0_data_mem_wr_en(&self) -> L1_ICACHE0_DATA_MEM_WR_EN_R {
        L1_ICACHE0_DATA_MEM_WR_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 4 - The bit is used to enable config-bus read L1-ICache1 data memoryory. 0: disable, 1: enable.
    #[inline(always)]
    pub fn l1_icache1_data_mem_rd_en(&self) -> L1_ICACHE1_DATA_MEM_RD_EN_R {
        L1_ICACHE1_DATA_MEM_RD_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - The bit is used to enable config-bus write L1-ICache1 data memoryory. 0: disable, 1: enable.
    #[inline(always)]
    ...
    ///Bit 16 - The bit is used to enable config-bus read L1-DCache data memoryory. 0: disable, 1: enable.
    #[inline(always)]
    pub fn l1_dcache_data_mem_rd_en(&self) -> L1_DCACHE_DATA_MEM_RD_EN_R {
        L1_DCACHE_DATA_MEM_RD_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - The bit is used to enable config-bus write L1-DCache data memoryory. 0: disable, 1: enable.
    #[inline(always)]
...
///`read()` method returns [`l1_cache_data_mem_acs_conf::R`](R) reader structure
impl crate::Readable for L1_CACHE_DATA_MEM_ACS_CONF_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_data_mem_acs_conf::W`](W) writer structure
