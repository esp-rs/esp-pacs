...
#[doc = "Field `L1_ICACHE0_DATA_MEM_RD_EN` writer - The bit is used to enable config-bus read L1-ICache0 data memoryory. 0: disable, 1: enable."]
...
#[doc = "Field `L1_ICACHE0_DATA_MEM_WR_EN` writer - The bit is used to enable config-bus write L1-ICache0 data memoryory. 0: disable, 1: enable."]
...
#[doc = "Field `L1_ICACHE1_DATA_MEM_RD_EN` writer - The bit is used to enable config-bus read L1-ICache1 data memoryory. 0: disable, 1: enable."]
...
#[doc = "Field `L1_ICACHE1_DATA_MEM_WR_EN` writer - The bit is used to enable config-bus write L1-ICache1 data memoryory. 0: disable, 1: enable."]
...
#[doc = "Field `L1_DCACHE_DATA_MEM_RD_EN` reader - The bit is used to enable config-bus read L1-DCache data memoryory. 0: disable, 1: enable."]
pub type L1_DCACHE_DATA_MEM_RD_EN_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_DATA_MEM_RD_EN` writer - The bit is used to enable config-bus read L1-DCache data memoryory. 0: disable, 1: enable."]
pub type L1_DCACHE_DATA_MEM_RD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_DATA_MEM_WR_EN` reader - The bit is used to enable config-bus write L1-DCache data memoryory. 0: disable, 1: enable."]
pub type L1_DCACHE_DATA_MEM_WR_EN_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_DATA_MEM_WR_EN` writer - The bit is used to enable config-bus write L1-DCache data memoryory. 0: disable, 1: enable."]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_DATA_MEM_ACS_CONF")
            .field(
                ...
                &self.l1_icache0_data_mem_rd_en().bit(),
            )
            .field(
                "l1_icache0_data_mem_wr_en",
                &self.l1_icache0_data_mem_wr_en().bit(),
            )
            .field(
                "l1_icache1_data_mem_rd_en",
                &self.l1_icache1_data_mem_rd_en().bit(),
            )
            .field(
                "l1_icache1_data_mem_wr_en",
                &self.l1_icache1_data_mem_wr_en().bit(),
            )
            .field(
                "l1_icache2_data_mem_rd_en",
                &self.l1_icache2_data_mem_rd_en().bit(),
            )
            .field(
                "l1_icache2_data_mem_wr_en",
                &self.l1_icache2_data_mem_wr_en().bit(),
            )
            .field(
                "l1_icache3_data_mem_rd_en",
                &self.l1_icache3_data_mem_rd_en().bit(),
            )
            .field(
                "l1_icache3_data_mem_wr_en",
                &self.l1_icache3_data_mem_wr_en().bit(),
            )
            .field(
                "l1_dcache_data_mem_rd_en",
                &self.l1_dcache_data_mem_rd_en().bit(),
            )
            .field(
                "l1_dcache_data_mem_wr_en",
                &self.l1_dcache_data_mem_wr_en().bit(),
            )
            .finish()
    }
}
