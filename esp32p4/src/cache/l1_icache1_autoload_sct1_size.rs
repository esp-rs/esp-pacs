...
///Register `L1_ICACHE1_AUTOLOAD_SCT1_SIZE` writer
...
///Field `L1_ICACHE1_AUTOLOAD_SCT1_SIZE` writer - Those bits are used to configure the size of the second section for autoload operation on L1-ICache1. Note that it should be used together with L1_ICACHE1_AUTOLOAD_SCT1_ADDR and L1_ICACHE_AUTOLOAD_SCT1_ENA.
...
///`write(|w| ..)` method takes [`l1_icache1_autoload_sct1_size::W`](W) writer structure
