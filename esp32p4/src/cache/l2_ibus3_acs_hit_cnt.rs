///Register `L2_IBUS3_ACS_HIT_CNT` reader
pub type R = crate::R<L2_IBUS3_ACS_HIT_CNT_SPEC>;
///Field `L2_IBUS3_HIT_CNT` reader - The register records the number of hits when L1-ICache3 accesses L2-Cache due to bus3 accessing L1-ICache3.
pub type L2_IBUS3_HIT_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of hits when L1-ICache3 accesses L2-Cache due to bus3 accessing L1-ICache3.
    #[inline(always)]
...
///`read()` method returns [`l2_ibus3_acs_hit_cnt::R`](R) reader structure
