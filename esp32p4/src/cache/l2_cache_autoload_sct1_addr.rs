...
#[doc = "Register `L2_CACHE_AUTOLOAD_SCT1_ADDR` writer"]
pub type W = crate::W<L2_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>;
...
#[doc = "Field `L2_CACHE_AUTOLOAD_SCT1_ADDR` writer - Those bits are used to configure the start virtual address of the second section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT1_SIZE and L2_CACHE_AUTOLOAD_SCT1_ENA."]
pub type L2_CACHE_AUTOLOAD_SCT1_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_CACHE_AUTOLOAD_SCT1_ADDR")
            .field(
                ...
                &format_args!("{}", self.l2_cache_autoload_sct1_addr().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<L2_CACHE_AUTOLOAD_SCT1_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l2_cache_autoload_sct1_addr(
        &mut self,
    ) -> L2_CACHE_AUTOLOAD_SCT1_ADDR_W<L2_CACHE_AUTOLOAD_SCT1_ADDR_SPEC> {
        L2_CACHE_AUTOLOAD_SCT1_ADDR_W::new(self, 0)
    }
}
...
#[doc = "`write(|w| ..)` method takes [`l2_cache_autoload_sct1_addr::W`](W) writer structure"]
impl crate::Writable for L2_CACHE_AUTOLOAD_SCT1_ADDR_SPEC {
