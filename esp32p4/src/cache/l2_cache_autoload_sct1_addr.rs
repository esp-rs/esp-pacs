...
///Register `L2_CACHE_AUTOLOAD_SCT1_ADDR` writer
...
///Field `L2_CACHE_AUTOLOAD_SCT1_ADDR` writer - Those bits are used to configure the start virtual address of the second section for autoload operation on L2-Cache. Note that it should be used together with L2_CACHE_AUTOLOAD_SCT1_SIZE and L2_CACHE_AUTOLOAD_SCT1_ENA.
...
///`write(|w| ..)` method takes [`l2_cache_autoload_sct1_addr::W`](W) writer structure
