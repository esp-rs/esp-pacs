...
#[doc = "Field `L1_ICACHE1_PRELOCK_SCT0_EN` writer - The bit is used to enable the first section of prelock function on L1-ICache1."]
...
#[doc = "Field `L1_ICACHE1_PRELOCK_SCT1_EN` writer - The bit is used to enable the second section of prelock function on L1-ICache1."]
...
#[doc = "Field `L1_ICACHE1_PRELOCK_RGID` writer - The bit is used to set the gid of l1 icache1 prelock."]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_ICACHE1_PRELOCK_CONF")
            .field(
                ...
                &format_args!("{}", self.l1_icache1_prelock_sct0_en().bit()),
            )
            .field(
                "l1_icache1_prelock_sct1_en",
                &format_args!("{}", self.l1_icache1_prelock_sct1_en().bit()),
            )
            .field(
                "l1_icache1_prelock_rgid",
                &format_args!("{}", self.l1_icache1_prelock_rgid().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<L1_ICACHE1_PRELOCK_CONF_SPEC> {
...
impl W {
    ...
    pub fn l1_icache1_prelock_sct0_en(
        &mut self,
    ) -> L1_ICACHE1_PRELOCK_SCT0_EN_W<L1_ICACHE1_PRELOCK_CONF_SPEC> {
    ...
    pub fn l1_icache1_prelock_sct1_en(
        &mut self,
    ) -> L1_ICACHE1_PRELOCK_SCT1_EN_W<L1_ICACHE1_PRELOCK_CONF_SPEC> {
    ...
    pub fn l1_icache1_prelock_rgid(
        &mut self,
    ) -> L1_ICACHE1_PRELOCK_RGID_W<L1_ICACHE1_PRELOCK_CONF_SPEC> {
