...
///Register `L1_ICACHE1_PRELOCK_CONF` writer
...
///Field `L1_ICACHE1_PRELOCK_SCT0_EN` writer - The bit is used to enable the first section of prelock function on L1-ICache1.
...
///Field `L1_ICACHE1_PRELOCK_SCT1_EN` writer - The bit is used to enable the second section of prelock function on L1-ICache1.
...
///Field `L1_ICACHE1_PRELOCK_RGID` writer - The bit is used to set the gid of l1 icache1 prelock.
...
///`write(|w| ..)` method takes [`l1_icache1_prelock_conf::W`](W) writer structure
