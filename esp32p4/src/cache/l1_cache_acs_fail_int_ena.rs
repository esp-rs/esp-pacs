///Register `L1_CACHE_ACS_FAIL_INT_ENA` reader
pub type R = crate::R<L1_CACHE_ACS_FAIL_INT_ENA_SPEC>;
///Register `L1_CACHE_ACS_FAIL_INT_ENA` writer
pub type W = crate::W<L1_CACHE_ACS_FAIL_INT_ENA_SPEC>;
///Field `L1_ICACHE0_FAIL_INT_ENA` reader - The bit is used to enable interrupt of access fail that occurs in L1-ICache0 due to cpu accesses L1-ICache0.
pub type L1_ICACHE0_FAIL_INT_ENA_R = crate::BitReader;
///Field `L1_ICACHE0_FAIL_INT_ENA` writer - The bit is used to enable interrupt of access fail that occurs in L1-ICache0 due to cpu accesses L1-ICache0.
pub type L1_ICACHE0_FAIL_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE1_FAIL_INT_ENA` reader - The bit is used to enable interrupt of access fail that occurs in L1-ICache1 due to cpu accesses L1-ICache1.
pub type L1_ICACHE1_FAIL_INT_ENA_R = crate::BitReader;
///Field `L1_ICACHE1_FAIL_INT_ENA` writer - The bit is used to enable interrupt of access fail that occurs in L1-ICache1 due to cpu accesses L1-ICache1.
pub type L1_ICACHE1_FAIL_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE2_FAIL_INT_ENA` reader - Reserved
pub type L1_ICACHE2_FAIL_INT_ENA_R = crate::BitReader;
///Field `L1_ICACHE3_FAIL_INT_ENA` reader - Reserved
pub type L1_ICACHE3_FAIL_INT_ENA_R = crate::BitReader;
///Field `L1_DCACHE_FAIL_INT_ENA` reader - The bit is used to enable interrupt of access fail that occurs in L1-DCache due to cpu accesses L1-DCache.
pub type L1_DCACHE_FAIL_INT_ENA_R = crate::BitReader;
///Field `L1_DCACHE_FAIL_INT_ENA` writer - The bit is used to enable interrupt of access fail that occurs in L1-DCache due to cpu accesses L1-DCache.
pub type L1_DCACHE_FAIL_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - The bit is used to enable interrupt of access fail that occurs in L1-ICache0 due to cpu accesses L1-ICache0.
    #[inline(always)]
    pub fn l1_icache0_fail_int_ena(&self) -> L1_ICACHE0_FAIL_INT_ENA_R {
        L1_ICACHE0_FAIL_INT_ENA_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit is used to enable interrupt of access fail that occurs in L1-ICache1 due to cpu accesses L1-ICache1.
    #[inline(always)]
    ...
    ///Bit 4 - The bit is used to enable interrupt of access fail that occurs in L1-DCache due to cpu accesses L1-DCache.
    #[inline(always)]
...
///`read()` method returns [`l1_cache_acs_fail_int_ena::R`](R) reader structure
impl crate::Readable for L1_CACHE_ACS_FAIL_INT_ENA_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_acs_fail_int_ena::W`](W) writer structure
