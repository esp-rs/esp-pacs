///Register `L1_DBUS3_ACS_NXTLVL_WR_CNT` reader
pub type R = crate::R<L1_DBUS3_ACS_NXTLVL_WR_CNT_SPEC>;
///Field `L1_DBUS3_NXTLVL_WR_CNT` reader - The register records the number of write back when bus0 accesses L1-DCache.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_DBUS3_ACS_NXTLVL_WR_CNT")
            .field("l1_dbus3_nxtlvl_wr_cnt", &self.l1_dbus3_nxtlvl_wr_cnt())
            .finish()
    }
}
...
///`read()` method returns [`l1_dbus3_acs_nxtlvl_wr_cnt::R`](R) reader structure
