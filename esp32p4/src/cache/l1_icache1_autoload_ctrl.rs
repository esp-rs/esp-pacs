...
///Register `L1_ICACHE1_AUTOLOAD_CTRL` writer
...
///Field `L1_ICACHE1_AUTOLOAD_ENA` writer - The bit is used to enable and disable autoload operation on L1-ICache1. 1: enable, 0: disable.
...
///Field `L1_ICACHE1_AUTOLOAD_ORDER` writer - The bit is used to configure the direction of autoload operation on L1-ICache1. 0: ascending. 1: descending.
...
///Field `L1_ICACHE1_AUTOLOAD_TRIGGER_MODE` writer - The field is used to configure trigger mode of autoload operation on L1-ICache1. 0/3: miss-trigger, 1: hit-trigger, 2: miss-hit-trigger.
...
///Field `L1_ICACHE1_AUTOLOAD_SCT0_ENA` writer - The bit is used to enable the first section for autoload operation on L1-ICache1.
...
///Field `L1_ICACHE1_AUTOLOAD_SCT1_ENA` writer - The bit is used to enable the second section for autoload operation on L1-ICache1.
...
///Field `L1_ICACHE1_AUTOLOAD_RGID` writer - The bit is used to set the gid of l1 icache1 autoload.
...
///`write(|w| ..)` method takes [`l1_icache1_autoload_ctrl::W`](W) writer structure
