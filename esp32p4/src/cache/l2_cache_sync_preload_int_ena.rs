...
///Register `L2_CACHE_SYNC_PRELOAD_INT_ENA` writer
...
///Field `L2_CACHE_PLD_DONE_INT_ENA` writer - The bit is used to enable interrupt of L2-Cache preload-operation done.
...
///Field `L2_CACHE_PLD_ERR_INT_ENA` writer - The bit is used to enable interrupt of L2-Cache preload-operation error.
...
///`write(|w| ..)` method takes [`l2_cache_sync_preload_int_ena::W`](W) writer structure
