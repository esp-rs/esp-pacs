///Register `L1_IBUS2_ACS_NXTLVL_RD_CNT` reader
pub type R = crate::R<L1_IBUS2_ACS_NXTLVL_RD_CNT_SPEC>;
///Field `L1_IBUS2_NXTLVL_RD_CNT` reader - The register records the number of times that L1-ICache accesses L2-Cache due to bus2 accessing L1-ICache2.
pub type L1_IBUS2_NXTLVL_RD_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of times that L1-ICache accesses L2-Cache due to bus2 accessing L1-ICache2.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`l1_ibus2_acs_nxtlvl_rd_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L1_IBUS2_ACS_NXTLVL_RD_CNT_SPEC;
impl crate::RegisterSpec for L1_IBUS2_ACS_NXTLVL_RD_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l1_ibus2_acs_nxtlvl_rd_cnt::R`](R) reader structure
