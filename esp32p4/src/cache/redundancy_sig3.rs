///Register `REDUNDANCY_SIG3` reader
pub type R = crate::R<REDUNDANCY_SIG3_SPEC>;
///Register `REDUNDANCY_SIG3` writer
pub type W = crate::W<REDUNDANCY_SIG3_SPEC>;
///Field `REDCY_SIG3` reader - Those bits are prepared for ECO.
pub type REDCY_SIG3_R = crate::FieldReader<u32>;
///Field `REDCY_SIG3` writer - Those bits are prepared for ECO.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REDUNDANCY_SIG3")
            .field("redcy_sig3", &self.redcy_sig3())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`redundancy_sig3::R`](R) reader structure
impl crate::Readable for REDUNDANCY_SIG3_SPEC {}
///`write(|w| ..)` method takes [`redundancy_sig3::W`](W) writer structure
