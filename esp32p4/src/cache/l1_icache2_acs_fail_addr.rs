///Register `L1_ICACHE2_ACS_FAIL_ADDR` reader
pub type R = crate::R<L1_ICACHE2_ACS_FAIL_ADDR_SPEC>;
///Field `L1_ICACHE2_FAIL_ADDR` reader - The register records the address of fail-access when cache2 accesses L1-ICache.
pub type L1_ICACHE2_FAIL_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the address of fail-access when cache2 accesses L1-ICache.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`l1_icache2_acs_fail_addr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L1_ICACHE2_ACS_FAIL_ADDR_SPEC;
impl crate::RegisterSpec for L1_ICACHE2_ACS_FAIL_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l1_icache2_acs_fail_addr::R`](R) reader structure
