...
///Field `L1_ICACHE0_UNALLOC_CLR` writer - The bit is used to clear the unallocate request buffer of l1 icache0 where the unallocate request is responsed but not completed.
...
///Field `L1_ICACHE1_UNALLOC_CLR` writer - The bit is used to clear the unallocate request buffer of l1 icache1 where the unallocate request is responsed but not completed.
...
///Field `L1_DCACHE_UNALLOC_CLR` reader - The bit is used to clear the unallocate request buffer of l1 dcache where the unallocate request is responsed but not completed.
pub type L1_DCACHE_UNALLOC_CLR_R = crate::BitReader;
///Field `L1_DCACHE_UNALLOC_CLR` writer - The bit is used to clear the unallocate request buffer of l1 dcache where the unallocate request is responsed but not completed.
...
impl R {
    ...
    ///Bit 4 - The bit is used to clear the unallocate request buffer of l1 dcache where the unallocate request is responsed but not completed.
    #[inline(always)]
