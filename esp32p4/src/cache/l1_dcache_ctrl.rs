///Register `L1_DCACHE_CTRL` reader
pub type R = crate::R<L1_DCACHE_CTRL_SPEC>;
///Register `L1_DCACHE_CTRL` writer
pub type W = crate::W<L1_DCACHE_CTRL_SPEC>;
///Field `L1_DCACHE_SHUT_DBUS0` reader - The bit is used to disable core0 dbus access L1-DCache, 0: enable, 1: disable
pub type L1_DCACHE_SHUT_DBUS0_R = crate::BitReader;
///Field `L1_DCACHE_SHUT_DBUS0` writer - The bit is used to disable core0 dbus access L1-DCache, 0: enable, 1: disable
pub type L1_DCACHE_SHUT_DBUS0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DCACHE_SHUT_DBUS1` reader - The bit is used to disable core1 dbus access L1-DCache, 0: enable, 1: disable
pub type L1_DCACHE_SHUT_DBUS1_R = crate::BitReader;
///Field `L1_DCACHE_SHUT_DBUS1` writer - The bit is used to disable core1 dbus access L1-DCache, 0: enable, 1: disable
pub type L1_DCACHE_SHUT_DBUS1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DCACHE_SHUT_DBUS2` reader - Reserved
pub type L1_DCACHE_SHUT_DBUS2_R = crate::BitReader;
///Field `L1_DCACHE_SHUT_DBUS3` reader - Reserved
pub type L1_DCACHE_SHUT_DBUS3_R = crate::BitReader;
///Field `L1_DCACHE_SHUT_DMA` reader - The bit is used to disable DMA access L1-DCache, 0: enable, 1: disable
pub type L1_DCACHE_SHUT_DMA_R = crate::BitReader;
///Field `L1_DCACHE_SHUT_DMA` writer - The bit is used to disable DMA access L1-DCache, 0: enable, 1: disable
pub type L1_DCACHE_SHUT_DMA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_DCACHE_UNDEF_OP` reader - Reserved
pub type L1_DCACHE_UNDEF_OP_R = crate::FieldReader;
///Field `L1_DCACHE_UNDEF_OP` writer - Reserved
...
///`read()` method returns [`l1_dcache_ctrl::R`](R) reader structure
impl crate::Readable for L1_DCACHE_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l1_dcache_ctrl::W`](W) writer structure
