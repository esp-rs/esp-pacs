///Register `L1_ICACHE_CTRL` reader
pub type R = crate::R<L1_ICACHE_CTRL_SPEC>;
///Register `L1_ICACHE_CTRL` writer
pub type W = crate::W<L1_ICACHE_CTRL_SPEC>;
///Field `L1_ICACHE_SHUT_IBUS0` reader - The bit is used to disable core0 ibus access L1-ICache, 0: enable, 1: disable
pub type L1_ICACHE_SHUT_IBUS0_R = crate::BitReader;
///Field `L1_ICACHE_SHUT_IBUS0` writer - The bit is used to disable core0 ibus access L1-ICache, 0: enable, 1: disable
pub type L1_ICACHE_SHUT_IBUS0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE_SHUT_IBUS1` reader - The bit is used to disable core1 ibus access L1-ICache, 0: enable, 1: disable
pub type L1_ICACHE_SHUT_IBUS1_R = crate::BitReader;
///Field `L1_ICACHE_SHUT_IBUS1` writer - The bit is used to disable core1 ibus access L1-ICache, 0: enable, 1: disable
pub type L1_ICACHE_SHUT_IBUS1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE_SHUT_IBUS2` reader - Reserved
pub type L1_ICACHE_SHUT_IBUS2_R = crate::BitReader;
///Field `L1_ICACHE_SHUT_IBUS3` reader - Reserved
pub type L1_ICACHE_SHUT_IBUS3_R = crate::BitReader;
///Field `L1_ICACHE_UNDEF_OP` reader - Reserved
pub type L1_ICACHE_UNDEF_OP_R = crate::FieldReader;
///Field `L1_ICACHE_UNDEF_OP` writer - Reserved
...
///`read()` method returns [`l1_icache_ctrl::R`](R) reader structure
impl crate::Readable for L1_ICACHE_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l1_icache_ctrl::W`](W) writer structure
