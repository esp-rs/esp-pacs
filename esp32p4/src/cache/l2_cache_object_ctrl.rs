...
///Register `L2_CACHE_OBJECT_CTRL` writer
...
///Field `L2_CACHE_TAG_OBJECT` writer - Set this bit to set L2-Cache tag memory as object. This bit should be onehot with the others fields inside this register.
...
///Field `L2_CACHE_MEM_OBJECT` writer - Set this bit to set L2-Cache data memory as object. This bit should be onehot with the others fields inside this register.
...
///`write(|w| ..)` method takes [`l2_cache_object_ctrl::W`](W) writer structure
