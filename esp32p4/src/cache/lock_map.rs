///Register `LOCK_MAP` reader
pub type R = crate::R<LOCK_MAP_SPEC>;
///Register `LOCK_MAP` writer
pub type W = crate::W<LOCK_MAP_SPEC>;
///Field `LOCK_MAP` reader - Those bits are used to indicate which caches in the two-level cache structure will apply this lock/unlock operation. \[0\]: L1-ICache0, \[1\]: L1-ICache1, \[2\]: L1-ICache2, \[3\]: L1-ICache3, \[4\]: L1-DCache, \[5\]: L2-Cache.
pub type LOCK_MAP_R = crate::FieldReader;
///Field `LOCK_MAP` writer - Those bits are used to indicate which caches in the two-level cache structure will apply this lock/unlock operation. \[0\]: L1-ICache0, \[1\]: L1-ICache1, \[2\]: L1-ICache2, \[3\]: L1-ICache3, \[4\]: L1-DCache, \[5\]: L2-Cache.
pub type LOCK_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - Those bits are used to indicate which caches in the two-level cache structure will apply this lock/unlock operation. \[0\]: L1-ICache0, \[1\]: L1-ICache1, \[2\]: L1-ICache2, \[3\]: L1-ICache3, \[4\]: L1-DCache, \[5\]: L2-Cache.
    #[inline(always)]
...
///`read()` method returns [`lock_map::R`](R) reader structure
impl crate::Readable for LOCK_MAP_SPEC {}
///`write(|w| ..)` method takes [`lock_map::W`](W) writer structure
