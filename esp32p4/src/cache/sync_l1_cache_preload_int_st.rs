///Register `SYNC_L1_CACHE_PRELOAD_INT_ST` reader
...
///Field `L1_DCACHE_PLD_DONE_INT_ST` reader - The bit indicates the status of the interrupt that occurs only when L1-DCache preload-operation is done.
pub type L1_DCACHE_PLD_DONE_INT_ST_R = crate::BitReader;
///Field `SYNC_DONE_INT_ST` reader - The bit indicates the status of the interrupt that occurs only when Cache sync-operation is done.
...
///Field `L1_DCACHE_PLD_ERR_INT_ST` reader - The bit indicates the status of the interrupt of L1-DCache preload-operation error.
pub type L1_DCACHE_PLD_ERR_INT_ST_R = crate::BitReader;
///Field `SYNC_ERR_INT_ST` reader - The bit indicates the status of the interrupt of Cache sync-operation error.
...
impl R {
    ...
    ///Bit 4 - The bit indicates the status of the interrupt that occurs only when L1-DCache preload-operation is done.
    #[inline(always)]
    ...
    ///Bit 11 - The bit indicates the status of the interrupt of L1-DCache preload-operation error.
    #[inline(always)]
...
///`read()` method returns [`sync_l1_cache_preload_int_st::R`](R) reader structure
