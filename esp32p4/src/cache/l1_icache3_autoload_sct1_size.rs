///Register `L1_ICACHE3_AUTOLOAD_SCT1_SIZE` reader
pub type R = crate::R<L1_ICACHE3_AUTOLOAD_SCT1_SIZE_SPEC>;
///Field `L1_ICACHE3_AUTOLOAD_SCT1_SIZE` reader - Reserved
...
///`read()` method returns [`l1_icache3_autoload_sct1_size::R`](R) reader structure
