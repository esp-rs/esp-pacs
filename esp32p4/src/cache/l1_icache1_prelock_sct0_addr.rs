...
///Register `L1_ICACHE1_PRELOCK_SCT0_ADDR` writer
...
///Field `L1_ICACHE1_PRELOCK_SCT0_ADDR` writer - Those bits are used to configure the start virtual address of the first section of prelock on L1-ICache1, which should be used together with L1_ICACHE1_PRELOCK_SCT0_SIZE_REG
...
///`write(|w| ..)` method takes [`l1_icache1_prelock_sct0_addr::W`](W) writer structure
