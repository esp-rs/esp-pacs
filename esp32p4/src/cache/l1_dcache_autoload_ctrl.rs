    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_DCACHE_AUTOLOAD_CTRL")
            .field(
                ...
                &self.l1_dcache_autoload_ena().bit(),
            )
            .field(
                "l1_dcache_autoload_done",
                &self.l1_dcache_autoload_done().bit(),
            )
            .field(
                "l1_dcache_autoload_order",
                &self.l1_dcache_autoload_order().bit(),
            )
            .field(
                "l1_dcache_autoload_trigger_mode",
                &self.l1_dcache_autoload_trigger_mode().bits(),
            )
            .field(
                "l1_dcache_autoload_sct0_ena",
                &self.l1_dcache_autoload_sct0_ena().bit(),
            )
            .field(
                "l1_dcache_autoload_sct1_ena",
                &self.l1_dcache_autoload_sct1_ena().bit(),
            )
            .field(
                "l1_dcache_autoload_sct2_ena",
                &self.l1_dcache_autoload_sct2_ena().bit(),
            )
            .field(
                "l1_dcache_autoload_sct3_ena",
                &self.l1_dcache_autoload_sct3_ena().bit(),
            )
            .field(
                "l1_dcache_autoload_rgid",
                &self.l1_dcache_autoload_rgid().bits(),
            )
            .finish()
    }
}
