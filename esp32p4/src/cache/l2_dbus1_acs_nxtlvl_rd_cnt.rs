///Register `L2_DBUS1_ACS_NXTLVL_RD_CNT` reader
pub type R = crate::R<L2_DBUS1_ACS_NXTLVL_RD_CNT_SPEC>;
///Field `L2_DBUS1_NXTLVL_RD_CNT` reader - The register records the number of times that L2-Cache accesses external memory due to L1-DCache accessing L2-Cache due to bus1 accessing L1-DCache.
...
///`read()` method returns [`l2_dbus1_acs_nxtlvl_rd_cnt::R`](R) reader structure
