///Register `L2_CACHE_FREEZE_CTRL` reader
pub type R = crate::R<L2_CACHE_FREEZE_CTRL_SPEC>;
///Register `L2_CACHE_FREEZE_CTRL` writer
pub type W = crate::W<L2_CACHE_FREEZE_CTRL_SPEC>;
///Field `L2_CACHE_FREEZE_EN` reader - The bit is used to enable freeze operation on L2-Cache. It can be cleared by software.
pub type L2_CACHE_FREEZE_EN_R = crate::BitReader;
///Field `L2_CACHE_FREEZE_EN` writer - The bit is used to enable freeze operation on L2-Cache. It can be cleared by software.
pub type L2_CACHE_FREEZE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_CACHE_FREEZE_MODE` reader - The bit is used to configure mode of freeze operation L2-Cache. 0: a miss-access will not stuck. 1: a miss-access will stuck.
pub type L2_CACHE_FREEZE_MODE_R = crate::BitReader;
///Field `L2_CACHE_FREEZE_MODE` writer - The bit is used to configure mode of freeze operation L2-Cache. 0: a miss-access will not stuck. 1: a miss-access will stuck.
pub type L2_CACHE_FREEZE_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_CACHE_FREEZE_DONE` reader - The bit is used to indicate whether freeze operation on L2-Cache is finished or not. 0: not finished. 1: finished.
...
impl R {
    ...
    ///Bit 22 - The bit is used to indicate whether freeze operation on L2-Cache is finished or not. 0: not finished. 1: finished.
    #[inline(always)]
...
///`read()` method returns [`l2_cache_freeze_ctrl::R`](R) reader structure
impl crate::Readable for L2_CACHE_FREEZE_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_freeze_ctrl::W`](W) writer structure
