///Register `L1_ICACHE0_PRELOCK_CONF` reader
pub type R = crate::R<L1_ICACHE0_PRELOCK_CONF_SPEC>;
///Register `L1_ICACHE0_PRELOCK_CONF` writer
pub type W = crate::W<L1_ICACHE0_PRELOCK_CONF_SPEC>;
///Field `L1_ICACHE0_PRELOCK_SCT0_EN` reader - The bit is used to enable the first section of prelock function on L1-ICache0.
pub type L1_ICACHE0_PRELOCK_SCT0_EN_R = crate::BitReader;
///Field `L1_ICACHE0_PRELOCK_SCT0_EN` writer - The bit is used to enable the first section of prelock function on L1-ICache0.
pub type L1_ICACHE0_PRELOCK_SCT0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE0_PRELOCK_SCT1_EN` reader - The bit is used to enable the second section of prelock function on L1-ICache0.
pub type L1_ICACHE0_PRELOCK_SCT1_EN_R = crate::BitReader;
///Field `L1_ICACHE0_PRELOCK_SCT1_EN` writer - The bit is used to enable the second section of prelock function on L1-ICache0.
pub type L1_ICACHE0_PRELOCK_SCT1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_ICACHE0_PRELOCK_RGID` reader - The bit is used to set the gid of l1 icache0 prelock.
pub type L1_ICACHE0_PRELOCK_RGID_R = crate::FieldReader;
///Field `L1_ICACHE0_PRELOCK_RGID` writer - The bit is used to set the gid of l1 icache0 prelock.
pub type L1_ICACHE0_PRELOCK_RGID_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bit 0 - The bit is used to enable the first section of prelock function on L1-ICache0.
    #[inline(always)]
    pub fn l1_icache0_prelock_sct0_en(&self) -> L1_ICACHE0_PRELOCK_SCT0_EN_R {
        L1_ICACHE0_PRELOCK_SCT0_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit is used to enable the second section of prelock function on L1-ICache0.
    #[inline(always)]
    pub fn l1_icache0_prelock_sct1_en(&self) -> L1_ICACHE0_PRELOCK_SCT1_EN_R {
        L1_ICACHE0_PRELOCK_SCT1_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:5 - The bit is used to set the gid of l1 icache0 prelock.
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_icache0_prelock_sct0_en(
        &mut self,
    ) -> L1_ICACHE0_PRELOCK_SCT0_EN_W<L1_ICACHE0_PRELOCK_CONF_SPEC> {
    ...
    pub fn l1_icache0_prelock_sct1_en(
        &mut self,
    ) -> L1_ICACHE0_PRELOCK_SCT1_EN_W<L1_ICACHE0_PRELOCK_CONF_SPEC> {
    ...
    pub fn l1_icache0_prelock_rgid(
        &mut self,
    ) -> L1_ICACHE0_PRELOCK_RGID_W<L1_ICACHE0_PRELOCK_CONF_SPEC> {
...
///`read()` method returns [`l1_icache0_prelock_conf::R`](R) reader structure
impl crate::Readable for L1_ICACHE0_PRELOCK_CONF_SPEC {}
///`write(|w| ..)` method takes [`l1_icache0_prelock_conf::W`](W) writer structure
