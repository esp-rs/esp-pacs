...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DT_CFG")
            .field(
                "db_fed_upmethod",
                &format_args!("{}", self.db_fed_upmethod().bits()),
            )
            .field(
                "db_red_upmethod",
                &format_args!("{}", self.db_red_upmethod().bits()),
            )
            .field("db_deb_mode", &format_args!("{}", self.db_deb_mode().bit()))
            .field(
                "db_a_outswap",
                &format_args!("{}", self.db_a_outswap().bit()),
            )
            .field(
                "db_b_outswap",
                &format_args!("{}", self.db_b_outswap().bit()),
            )
            .field(
                "db_red_insel",
                &format_args!("{}", self.db_red_insel().bit()),
            )
            .field(
                "db_fed_insel",
                &format_args!("{}", self.db_fed_insel().bit()),
            )
            .field(
                "db_red_outinvert",
                &format_args!("{}", self.db_red_outinvert().bit()),
            )
            .field(
                "db_fed_outinvert",
                &format_args!("{}", self.db_fed_outinvert().bit()),
            )
            .field(
                "db_a_outbypass",
                &format_args!("{}", self.db_a_outbypass().bit()),
            )
            .field(
                "db_b_outbypass",
                &format_args!("{}", self.db_b_outbypass().bit()),
            )
            .field("db_clk_sel", &format_args!("{}", self.db_clk_sel().bit()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DT_CFG_SPEC> {
