///Register `OP%s_TSTMP_E2` reader
pub type R = crate::R<OP_TSTMP_E2_SPEC>;
///Register `OP%s_TSTMP_E2` writer
pub type W = crate::W<OP_TSTMP_E2_SPEC>;
///Field `OP_TSTMP_E2` reader - Configures generator%s timer stamp E2 value register
pub type OP_TSTMP_E2_R = crate::FieldReader<u16>;
///Field `OP_TSTMP_E2` writer - Configures generator%s timer stamp E2 value register
pub type OP_TSTMP_E2_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - Configures generator%s timer stamp E2 value register
    #[inline(always)]
...
///`read()` method returns [`op_tstmp_e2::R`](R) reader structure
impl crate::Readable for OP_TSTMP_E2_SPEC {}
///`write(|w| ..)` method takes [`op_tstmp_e2::W`](W) writer structure
