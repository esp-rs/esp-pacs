...
impl TIMER {
    ///0x00 - PWM timer0 period and update method configuration register.
    #[inline(always)]
    pub const fn cfg0(&self) -> &CFG0 {
        &self.cfg0
    }
    ///0x04 - PWM timer0 working mode and start/stop control register.
    #[inline(always)]
    pub const fn cfg1(&self) -> &CFG1 {
        &self.cfg1
    }
    ///0x08 - PWM timer0 sync function configuration register.
    #[inline(always)]
    pub const fn sync(&self) -> &SYNC {
        &self.sync
    }
    ///0x0c - PWM timer0 status register.
    #[inline(always)]
    pub const fn status(&self) -> &STATUS {
        &self.status
    }
}
/**CFG0 (rw) register accessor: PWM timer0 period and update method configuration register.
...
pub mod cfg0;
/**CFG1 (rw) register accessor: PWM timer0 working mode and start/stop control register.
...
pub mod cfg1;
/**SYNC (rw) register accessor: PWM timer0 sync function configuration register.
...
pub mod sync;
/**STATUS (r) register accessor: PWM timer0 status register.
