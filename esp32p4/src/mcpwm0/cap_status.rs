...
///Field `CAP0_EDGE` reader - Represents edge of last capture trigger on channel0.\\0: Posedge\\1: Negedge
pub type CAP0_EDGE_R = crate::BitReader;
///Field `CAP1_EDGE` reader - Represents edge of last capture trigger on channel1.\\0: Posedge\\1: Negedge
pub type CAP1_EDGE_R = crate::BitReader;
///Field `CAP2_EDGE` reader - Represents edge of last capture trigger on channel2.\\0: Posedge\\1: Negedge
pub type CAP2_EDGE_R = crate::BitReader;
impl R {
    ///Bit 0 - Represents edge of last capture trigger on channel0.\\0: Posedge\\1: Negedge
    #[inline(always)]
    pub fn cap0_edge(&self) -> CAP0_EDGE_R {
        CAP0_EDGE_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Represents edge of last capture trigger on channel1.\\0: Posedge\\1: Negedge
    #[inline(always)]
    pub fn cap1_edge(&self) -> CAP1_EDGE_R {
        CAP1_EDGE_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Represents edge of last capture trigger on channel2.\\0: Posedge\\1: Negedge
    #[inline(always)]
