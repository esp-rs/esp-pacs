...
///Field `CAP_TIMER_EN` reader - Configures whether or not to enable capture timer increment.\\0: Disable\\1: Enable
pub type CAP_TIMER_EN_R = crate::BitReader;
///Field `CAP_TIMER_EN` writer - Configures whether or not to enable capture timer increment.\\0: Disable\\1: Enable
pub type CAP_TIMER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAP_SYNCI_EN` reader - Configures whether or not to enable capture timer sync.\\0: Disable\\1: Enable
pub type CAP_SYNCI_EN_R = crate::BitReader;
///Field `CAP_SYNCI_EN` writer - Configures whether or not to enable capture timer sync.\\0: Disable\\1: Enable
pub type CAP_SYNCI_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAP_SYNCI_SEL` reader - Configures the selection of capture module sync input.\\0: None\\1: Timer0 sync_out\\2: Timer1 sync_out\\3: Timer2 sync_out\\4: SYNC0 from GPIO matrix\\5: SYNC1 from GPIO matrix\\6: SYNC2 from GPIO matrix\\7: None
pub type CAP_SYNCI_SEL_R = crate::FieldReader;
///Field `CAP_SYNCI_SEL` writer - Configures the selection of capture module sync input.\\0: None\\1: Timer0 sync_out\\2: Timer1 sync_out\\3: Timer2 sync_out\\4: SYNC0 from GPIO matrix\\5: SYNC1 from GPIO matrix\\6: SYNC2 from GPIO matrix\\7: None
pub type CAP_SYNCI_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `CAP_SYNC_SW` writer - Configures the generation of a capture timer sync when reg_cap_synci_en is 1.\\0: Invalid, No effect\\1: Trigger a capture timer sync, capture timer is loaded with value in phase register
pub type CAP_SYNC_SW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Configures whether or not to enable capture timer increment.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn cap_timer_en(&self) -> CAP_TIMER_EN_R {
        CAP_TIMER_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Configures whether or not to enable capture timer sync.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn cap_synci_en(&self) -> CAP_SYNCI_EN_R {
        CAP_SYNCI_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:4 - Configures the selection of capture module sync input.\\0: None\\1: Timer0 sync_out\\2: Timer1 sync_out\\3: Timer2 sync_out\\4: SYNC0 from GPIO matrix\\5: SYNC1 from GPIO matrix\\6: SYNC2 from GPIO matrix\\7: None
    #[inline(always)]
...
impl W {
    ...
    ///Bit 5 - Configures the generation of a capture timer sync when reg_cap_synci_en is 1.\\0: Invalid, No effect\\1: Trigger a capture timer sync, capture timer is loaded with value in phase register
    #[inline(always)]
    #[must_use]
