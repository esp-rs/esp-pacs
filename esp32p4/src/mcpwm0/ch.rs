...
/**GEN_STMP_CFG (rw) register accessor: Generator0 time stamp registers A and B transfer status and update method register
...
/**GEN_TSTMP_A (rw) register accessor: Generator0 time stamp A's shadow register
...
pub mod gen_tstmp_a;
/**GEN_TSTMP_B (rw) register accessor: Generator0 time stamp B's shadow register
...
pub mod gen_tstmp_b;
/**GEN_CFG0 (rw) register accessor: Generator0 fault event T0 and T1 configuration register
...
pub mod gen_cfg0;
/**GEN_FORCE (rw) register accessor: Generator0 output signal force mode register.
...
pub mod gen;
/**DT_CFG (rw) register accessor: Dead time configuration register
...
pub mod dt_cfg;
/**DT_FED_CFG (rw) register accessor: Falling edge delay (FED) shadow register
...
pub mod dt_fed_cfg;
/**DT_RED_CFG (rw) register accessor: Rising edge delay (RED) shadow register
...
pub mod dt_red_cfg;
/**CARRIER_CFG (rw) register accessor: Carrier0 configuration register
...
pub mod carrier_cfg;
/**FH_CFG0 (rw) register accessor: PWM0 A and PWM0 B trip events actions configuration register
...
pub mod fh_cfg0;
/**FH_CFG1 (rw) register accessor: Software triggers for fault handler actions configuration register
...
pub mod fh_cfg1;
/**FH_STATUS (r) register accessor: Fault events status register
