...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMER_STATUS")
            .field(
                "timer_value",
                &format_args!("{}", self.timer_value().bits()),
            )
            .field(
                "timer_direction",
                &format_args!("{}", self.timer_direction().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TIMER_STATUS_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "PWM timer%s status register.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`timer_status::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
