///Register `CAP_TIMER_PHASE` reader
pub type R = crate::R<CAP_TIMER_PHASE_SPEC>;
///Register `CAP_TIMER_PHASE` writer
pub type W = crate::W<CAP_TIMER_PHASE_SPEC>;
///Field `CAP_PHASE` reader - Configures phase value for capture timer sync operation.
pub type CAP_PHASE_R = crate::FieldReader<u32>;
///Field `CAP_PHASE` writer - Configures phase value for capture timer sync operation.
pub type CAP_PHASE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures phase value for capture timer sync operation.
    #[inline(always)]
...
///`read()` method returns [`cap_timer_phase::R`](R) reader structure
impl crate::Readable for CAP_TIMER_PHASE_SPEC {}
///`write(|w| ..)` method takes [`cap_timer_phase::W`](W) writer structure
