///Register `DT_RED_CFG` reader
pub type R = crate::R<DT_RED_CFG_SPEC>;
///Register `DT_RED_CFG` writer
pub type W = crate::W<DT_RED_CFG_SPEC>;
///Field `RED` reader - Configures shadow register for RED.
pub type RED_R = crate::FieldReader<u16>;
///Field `RED` writer - Configures shadow register for RED.
pub type RED_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - Configures shadow register for RED.
    #[inline(always)]
...
///`read()` method returns [`dt_red_cfg::R`](R) reader structure
impl crate::Readable for DT_RED_CFG_SPEC {}
///`write(|w| ..)` method takes [`dt_red_cfg::W`](W) writer structure
