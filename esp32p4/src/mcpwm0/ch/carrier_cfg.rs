...
///Field `EN` reader - Configures whether or not to enable carrier%s.\\0: Bypassed\\1: Enabled
pub type EN_R = crate::BitReader;
///Field `EN` writer - Configures whether or not to enable carrier%s.\\0: Bypassed\\1: Enabled
pub type EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRESCALE` reader - Configures the prescale value of PWM carrier%s clock (PC_clk), so that period of PC_clk = period of PWM_clk * (PWM_CARRIER%s_PRESCALE + 1)
pub type PRESCALE_R = crate::FieldReader;
///Field `PRESCALE` writer - Configures the prescale value of PWM carrier%s clock (PC_clk), so that period of PC_clk = period of PWM_clk * (PWM_CARRIER%s_PRESCALE + 1)
pub type PRESCALE_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `DUTY` reader - Configures carrier duty. Duty = PWM_CARRIER%s_DUTY / 8
pub type DUTY_R = crate::FieldReader;
///Field `DUTY` writer - Configures carrier duty. Duty = PWM_CARRIER%s_DUTY / 8
pub type DUTY_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `OSHTWTH` reader - Configures width of the first pulse. Measurement unit: Periods of the carrier.
pub type OSHTWTH_R = crate::FieldReader;
///Field `OSHTWTH` writer - Configures width of the first pulse. Measurement unit: Periods of the carrier.
pub type OSHTWTH_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `OUT_INVERT` reader - Configures whether or not to invert the output of PWM%s A and PWM%s B for this submodule.\\0: Normal\\1: Invert
pub type OUT_INVERT_R = crate::BitReader;
///Field `OUT_INVERT` writer - Configures whether or not to invert the output of PWM%s A and PWM%s B for this submodule.\\0: Normal\\1: Invert
pub type OUT_INVERT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_INVERT` reader - Configures whether or not to invert the input of PWM%s A and PWM%s B for this submodule.\\0: Normal\\1: Invert
pub type IN_INVERT_R = crate::BitReader;
///Field `IN_INVERT` writer - Configures whether or not to invert the input of PWM%s A and PWM%s B for this submodule.\\0: Normal\\1: Invert
pub type IN_INVERT_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Configures whether or not to enable carrier%s.\\0: Bypassed\\1: Enabled
    #[inline(always)]
    pub fn en(&self) -> EN_R {
        EN_R::new((self.bits & 1) != 0)
    }
    ///Bits 1:4 - Configures the prescale value of PWM carrier%s clock (PC_clk), so that period of PC_clk = period of PWM_clk * (PWM_CARRIER%s_PRESCALE + 1)
    #[inline(always)]
    pub fn prescale(&self) -> PRESCALE_R {
        PRESCALE_R::new(((self.bits >> 1) & 0x0f) as u8)
    }
    ///Bits 5:7 - Configures carrier duty. Duty = PWM_CARRIER%s_DUTY / 8
    #[inline(always)]
    pub fn duty(&self) -> DUTY_R {
        DUTY_R::new(((self.bits >> 5) & 7) as u8)
    }
    ///Bits 8:11 - Configures width of the first pulse. Measurement unit: Periods of the carrier.
    #[inline(always)]
    pub fn oshtwth(&self) -> OSHTWTH_R {
        OSHTWTH_R::new(((self.bits >> 8) & 0x0f) as u8)
    }
    ///Bit 12 - Configures whether or not to invert the output of PWM%s A and PWM%s B for this submodule.\\0: Normal\\1: Invert
    #[inline(always)]
    pub fn out_invert(&self) -> OUT_INVERT_R {
        OUT_INVERT_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - Configures whether or not to invert the input of PWM%s A and PWM%s B for this submodule.\\0: Normal\\1: Invert
    #[inline(always)]
