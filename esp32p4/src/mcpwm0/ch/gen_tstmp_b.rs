///Register `GEN_TSTMP_B` reader
pub type R = crate::R<GEN_TSTMP_B_SPEC>;
///Register `GEN_TSTMP_B` writer
pub type W = crate::W<GEN_TSTMP_B_SPEC>;
///Field `B` reader - Configures the value of PWM generator %s time stamp B's shadow register.
pub type B_R = crate::FieldReader<u16>;
///Field `B` writer - Configures the value of PWM generator %s time stamp B's shadow register.
pub type B_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - Configures the value of PWM generator %s time stamp B's shadow register.
    #[inline(always)]
    pub fn b(&self) -> B_R {
...
///`read()` method returns [`gen_tstmp_b::R`](R) reader structure
impl crate::Readable for GEN_TSTMP_B_SPEC {}
///`write(|w| ..)` method takes [`gen_tstmp_b::W`](W) writer structure
