...
You can [`read`](crate::generic::Reg::read) this register and get [`int_st_pld_crc_fatal::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct INT_ST_PLD_CRC_FATAL_SPEC;
impl crate::RegisterSpec for INT_ST_PLD_CRC_FATAL_SPEC {
    type Ux = u32;
}
///`read()` method returns [`int_st_pld_crc_fatal::R`](R) reader structure
