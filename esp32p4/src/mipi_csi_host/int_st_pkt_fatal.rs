///Register `INT_ST_PKT_FATAL` reader
pub type R = crate::R<INT_ST_PKT_FATAL_SPEC>;
///Field `ST_ERR_ECC_DOUBLE` reader - NA
pub type ST_ERR_ECC_DOUBLE_R = crate::BitReader;
///Field `ST_SHORTER_PAYLOAD` reader - NA
...
///`read()` method returns [`int_st_pkt_fatal::R`](R) reader structure
