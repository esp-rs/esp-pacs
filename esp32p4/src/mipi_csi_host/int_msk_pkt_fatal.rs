...
///`read()` method returns [`int_msk_pkt_fatal::R`](R) reader structure
impl crate::Readable for INT_MSK_PKT_FATAL_SPEC {}
///`write(|w| ..)` method takes [`int_msk_pkt_fatal::W`](W) writer structure
