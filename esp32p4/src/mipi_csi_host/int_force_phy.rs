...
///`read()` method returns [`int_force_phy::R`](R) reader structure
impl crate::Readable for INT_FORCE_PHY_SPEC {}
///`write(|w| ..)` method takes [`int_force_phy::W`](W) writer structure
