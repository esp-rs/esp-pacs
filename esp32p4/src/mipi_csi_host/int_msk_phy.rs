...
impl W {
    #[doc = "Bit 0 - NA"]
    #[inline(always)]
    pub fn mask_phy_errsoths_0(&mut self) -> MASK_PHY_ERRSOTHS_0_W<'_, INT_MSK_PHY_SPEC> {
        MASK_PHY_ERRSOTHS_0_W::new(self, 0)
    }
    #[doc = "Bit 1 - NA"]
    #[inline(always)]
    pub fn mask_phy_errsoths_1(&mut self) -> MASK_PHY_ERRSOTHS_1_W<'_, INT_MSK_PHY_SPEC> {
        MASK_PHY_ERRSOTHS_1_W::new(self, 1)
    }
    #[doc = "Bit 16 - NA"]
    #[inline(always)]
    pub fn mask_phy_erresc_0(&mut self) -> MASK_PHY_ERRESC_0_W<'_, INT_MSK_PHY_SPEC> {
        MASK_PHY_ERRESC_0_W::new(self, 16)
    }
    #[doc = "Bit 17 - NA"]
    #[inline(always)]
    pub fn mask_phy_erresc_1(&mut self) -> MASK_PHY_ERRESC_1_W<'_, INT_MSK_PHY_SPEC> {
