...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_FORCE_PLD_CRC_FATAL")
            .field("force_err_crc_vc0", &self.force_err_crc_vc0().bit())
            .field("force_err_crc_vc1", &self.force_err_crc_vc1().bit())
            .field("force_err_crc_vc2", &self.force_err_crc_vc2().bit())
            .field("force_err_crc_vc3", &self.force_err_crc_vc3().bit())
            .field("force_err_crc_vc4", &self.force_err_crc_vc4().bit())
            .field("force_err_crc_vc5", &self.force_err_crc_vc5().bit())
            .field("force_err_crc_vc6", &self.force_err_crc_vc6().bit())
            .field("force_err_crc_vc7", &self.force_err_crc_vc7().bit())
            .field("force_err_crc_vc8", &self.force_err_crc_vc8().bit())
            .field("force_err_crc_vc9", &self.force_err_crc_vc9().bit())
            .field("force_err_crc_vc10", &self.force_err_crc_vc10().bit())
            .field("force_err_crc_vc11", &self.force_err_crc_vc11().bit())
            .field("force_err_crc_vc12", &self.force_err_crc_vc12().bit())
            .field("force_err_crc_vc13", &self.force_err_crc_vc13().bit())
            .field("force_err_crc_vc14", &self.force_err_crc_vc14().bit())
            .field("force_err_crc_vc15", &self.force_err_crc_vc15().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
