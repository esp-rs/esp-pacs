...
///`read()` method returns [`int_force_pld_crc_fatal::R`](R) reader structure
impl crate::Readable for INT_FORCE_PLD_CRC_FATAL_SPEC {}
///`write(|w| ..)` method takes [`int_force_pld_crc_fatal::W`](W) writer structure
