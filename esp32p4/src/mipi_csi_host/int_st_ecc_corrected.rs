...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST_ECC_CORRECTED")
            .field(
                "st_err_ecc_corrected_vc0",
                &format_args!("{}", self.st_err_ecc_corrected_vc0().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc1",
                &format_args!("{}", self.st_err_ecc_corrected_vc1().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc2",
                &format_args!("{}", self.st_err_ecc_corrected_vc2().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc3",
                &format_args!("{}", self.st_err_ecc_corrected_vc3().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc4",
                &format_args!("{}", self.st_err_ecc_corrected_vc4().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc5",
                &format_args!("{}", self.st_err_ecc_corrected_vc5().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc6",
                &format_args!("{}", self.st_err_ecc_corrected_vc6().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc7",
                &format_args!("{}", self.st_err_ecc_corrected_vc7().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc8",
                &format_args!("{}", self.st_err_ecc_corrected_vc8().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc9",
                &format_args!("{}", self.st_err_ecc_corrected_vc9().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc10",
                &format_args!("{}", self.st_err_ecc_corrected_vc10().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc11",
                &format_args!("{}", self.st_err_ecc_corrected_vc11().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc12",
                &format_args!("{}", self.st_err_ecc_corrected_vc12().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc13",
                &format_args!("{}", self.st_err_ecc_corrected_vc13().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc14",
                &format_args!("{}", self.st_err_ecc_corrected_vc14().bit()),
            )
            .field(
                "st_err_ecc_corrected_vc15",
                &format_args!("{}", self.st_err_ecc_corrected_vc15().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<INT_ST_ECC_CORRECTED_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`int_st_ecc_corrected::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
