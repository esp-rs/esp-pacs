    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST_ECC_CORRECTED")
            .field(
                ...
                &self.st_err_ecc_corrected_vc0().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc1",
                &self.st_err_ecc_corrected_vc1().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc2",
                &self.st_err_ecc_corrected_vc2().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc3",
                &self.st_err_ecc_corrected_vc3().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc4",
                &self.st_err_ecc_corrected_vc4().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc5",
                &self.st_err_ecc_corrected_vc5().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc6",
                &self.st_err_ecc_corrected_vc6().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc7",
                &self.st_err_ecc_corrected_vc7().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc8",
                &self.st_err_ecc_corrected_vc8().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc9",
                &self.st_err_ecc_corrected_vc9().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc10",
                &self.st_err_ecc_corrected_vc10().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc11",
                &self.st_err_ecc_corrected_vc11().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc12",
                &self.st_err_ecc_corrected_vc12().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc13",
                &self.st_err_ecc_corrected_vc13().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc14",
                &self.st_err_ecc_corrected_vc14().bit(),
            )
            .field(
                "st_err_ecc_corrected_vc15",
                &self.st_err_ecc_corrected_vc15().bit(),
            )
            .finish()
    }
}
