...
///`read()` method returns [`dphy_rstz::R`](R) reader structure
impl crate::Readable for DPHY_RSTZ_SPEC {}
///`write(|w| ..)` method takes [`dphy_rstz::W`](W) writer structure
