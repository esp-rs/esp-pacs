///Register `PHY_SHUTDOWNZ` reader
pub type R = crate::R<PHY_SHUTDOWNZ_SPEC>;
///Register `PHY_SHUTDOWNZ` writer
...
///`read()` method returns [`phy_shutdownz::R`](R) reader structure
impl crate::Readable for PHY_SHUTDOWNZ_SPEC {}
///`write(|w| ..)` method takes [`phy_shutdownz::W`](W) writer structure
