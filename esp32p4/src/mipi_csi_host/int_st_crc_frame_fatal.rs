...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST_CRC_FRAME_FATAL")
            .field("st_err_frame_data_vc0", &self.st_err_frame_data_vc0())
            .field("st_err_frame_data_vc1", &self.st_err_frame_data_vc1())
            .field("st_err_frame_data_vc2", &self.st_err_frame_data_vc2())
            .field("st_err_frame_data_vc3", &self.st_err_frame_data_vc3())
            .field("st_err_frame_data_vc4", &self.st_err_frame_data_vc4())
            .field("st_err_frame_data_vc5", &self.st_err_frame_data_vc5())
            .field("st_err_frame_data_vc6", &self.st_err_frame_data_vc6())
            .field("st_err_frame_data_vc7", &self.st_err_frame_data_vc7())
            .field("st_err_frame_data_vc8", &self.st_err_frame_data_vc8())
            .field("st_err_frame_data_vc9", &self.st_err_frame_data_vc9())
            .field("st_err_frame_data_vc10", &self.st_err_frame_data_vc10())
            .field("st_err_frame_data_vc11", &self.st_err_frame_data_vc11())
            .field("st_err_frame_data_vc12", &self.st_err_frame_data_vc12())
            .field("st_err_frame_data_vc13", &self.st_err_frame_data_vc13())
            .field("st_err_frame_data_vc14", &self.st_err_frame_data_vc14())
            .field("st_err_frame_data_vc15", &self.st_err_frame_data_vc15())
            .finish()
    }
}
/**NA
...
///`read()` method returns [`int_st_crc_frame_fatal::R`](R) reader structure
