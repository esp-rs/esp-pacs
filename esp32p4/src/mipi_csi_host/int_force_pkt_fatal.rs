...
///`read()` method returns [`int_force_pkt_fatal::R`](R) reader structure
impl crate::Readable for INT_FORCE_PKT_FATAL_SPEC {}
///`write(|w| ..)` method takes [`int_force_pkt_fatal::W`](W) writer structure
