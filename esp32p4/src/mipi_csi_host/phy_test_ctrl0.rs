...
///`read()` method returns [`phy_test_ctrl0::R`](R) reader structure
impl crate::Readable for PHY_TEST_CTRL0_SPEC {}
///`write(|w| ..)` method takes [`phy_test_ctrl0::W`](W) writer structure
