...
///`read()` method returns [`int_msk_data_id::R`](R) reader structure
impl crate::Readable for INT_MSK_DATA_ID_SPEC {}
///`write(|w| ..)` method takes [`int_msk_data_id::W`](W) writer structure
