///Register `PHY_STOPSTATE` reader
pub type R = crate::R<PHY_STOPSTATE_SPEC>;
///Field `PHY_STOPSTATEDATA_0` reader - NA
pub type PHY_STOPSTATEDATA_0_R = crate::BitReader;
///Field `PHY_STOPSTATEDATA_1` reader - NA
pub type PHY_STOPSTATEDATA_1_R = crate::BitReader;
///Field `PHY_STOPSTATECLK` reader - NA
...
///`read()` method returns [`phy_stopstate::R`](R) reader structure
