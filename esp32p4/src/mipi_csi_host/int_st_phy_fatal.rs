///Register `INT_ST_PHY_FATAL` reader
pub type R = crate::R<INT_ST_PHY_FATAL_SPEC>;
///Field `ST_PHY_ERRSOTSYNCHS_0` reader - NA
pub type ST_PHY_ERRSOTSYNCHS_0_R = crate::BitReader;
///Field `ST_PHY_ERRSOTSYNCHS_1` reader - NA
...
You can [`read`](crate::generic::Reg::read) this register and get [`int_st_phy_fatal::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct INT_ST_PHY_FATAL_SPEC;
impl crate::RegisterSpec for INT_ST_PHY_FATAL_SPEC {
    type Ux = u32;
}
///`read()` method returns [`int_st_phy_fatal::R`](R) reader structure
