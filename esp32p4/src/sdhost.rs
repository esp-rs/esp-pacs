...
impl RegisterBlock {
    ...
    ///0x804 - SDIO raw ints register.
    #[inline(always)]
    pub const fn raw_ints(&self) -> &RAW_INTS {
        &self.raw_ints
    }
    ///0x808 - SDIO DLL clock control register.
    #[inline(always)]
    pub const fn dll_clk_conf(&self) -> &DLL_CLK_CONF {
        &self.dll_clk_conf
    }
    ///0x80c - SDIO DLL configuration register.
    #[inline(always)]
    pub const fn dll_conf(&self) -> &DLL_CONF {
        &self.dll_conf
    }
}
...
/**RAW_INTS (r) register accessor: SDIO raw ints register.
...
pub type RAW_INTS = crate::Reg<raw_ints::RAW_INTS_SPEC>;
///SDIO raw ints register.
pub mod raw_ints;
/**DLL_CLK_CONF (rw) register accessor: SDIO DLL clock control register.
...
pub type DLL_CLK_CONF = crate::Reg<dll_clk_conf::DLL_CLK_CONF_SPEC>;
///SDIO DLL clock control register.
pub mod dll_clk_conf;
/**DLL_CONF (rw) register accessor: SDIO DLL configuration register.
...
pub type DLL_CONF = crate::Reg<dll_conf::DLL_CONF_SPEC>;
