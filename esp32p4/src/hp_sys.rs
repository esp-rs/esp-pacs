...
/**VER_DATE (rw) register accessor: NA
...
///NA
pub mod ver_date;
/**CLK_EN (rw) register accessor: NA
...
///NA
pub mod clk_en;
/**CPU_INTR_FROM_CPU_0 (rw) register accessor: NA
...
/**CPU_INTR_FROM_CPU_1 (rw) register accessor: NA
...
/**CPU_INTR_FROM_CPU_2 (rw) register accessor: NA
...
/**CPU_INTR_FROM_CPU_3 (rw) register accessor: NA
...
/**CACHE_CLK_CONFIG (rw) register accessor: NA
...
/**CACHE_RESET_CONFIG (rw) register accessor: NA
...
/**DMA_ADDR_CTRL (rw) register accessor: NA
...
/**TCM_RAM_WRR_CONFIG (rw) register accessor: NA
...
/**TCM_SW_PARITY_BWE_MASK (rw) register accessor: NA
...
/**L2_ROM_PWR_CTRL0 (rw) register accessor: NA
...
/**PROBEA_CTRL (rw) register accessor: NA
...
///NA
pub mod probea_ctrl;
/**PROBEB_CTRL (rw) register accessor: NA
...
///NA
pub mod probeb_ctrl;
/**PROBE_OUT (r) register accessor: NA
...
///NA
pub mod probe_out;
/**L2_MEM_RAM_PWR_CTRL0 (rw) register accessor: NA
...
/**CRYPTO_CTRL (rw) register accessor: NA
...
///NA
pub mod crypto_ctrl;
/**GPIO_O_HOLD_CTRL0 (rw) register accessor: NA
...
/**GPIO_O_HOLD_CTRL1 (rw) register accessor: NA
...
/**RDN_ECO_CS (rw) register accessor: NA
...
///NA
pub mod rdn_eco_cs;
/**CACHE_APB_POSTW_EN (rw) register accessor: NA
...
/**L2_MEM_SUBSIZE (rw) register accessor: NA
...
/**L2_MEM_INT_RAW (rw) register accessor: NA
...
/**L2_MEM_INT_ST (r) register accessor: NA
...
/**L2_MEM_INT_ENA (rw) register accessor: NA
...
/**L2_MEM_INT_CLR (w) register accessor: NA
...
/**L2_MEM_L2_RAM_ECC (rw) register accessor: NA
...
/**L2_MEM_INT_RECORD0 (r) register accessor: NA
...
/**L2_MEM_INT_RECORD1 (r) register accessor: NA
...
/**L2_MEM_L2_CACHE_ECC (rw) register accessor: NA
...
/**L1CACHE_BUS0_ID (rw) register accessor: NA
...
/**L1CACHE_BUS1_ID (rw) register accessor: NA
...
/**L2_MEM_RDN_ECO_CS (rw) register accessor: NA
...
/**L2_MEM_RDN_ECO_LOW (rw) register accessor: NA
...
/**L2_MEM_RDN_ECO_HIGH (rw) register accessor: NA
...
/**TCM_RDN_ECO_CS (rw) register accessor: NA
...
/**TCM_RDN_ECO_LOW (rw) register accessor: NA
...
/**TCM_RDN_ECO_HIGH (rw) register accessor: NA
...
/**GPIO_DED_HOLD_CTRL (rw) register accessor: NA
...
/**L2_MEM_SW_ECC_BWE_MASK (rw) register accessor: NA
...
/**TCM_INT_RAW (rw) register accessor: need_des
...
///need_des
pub mod tcm_int_raw;
/**TCM_INT_ST (r) register accessor: need_des
...
///need_des
pub mod tcm_int_st;
/**TCM_INT_ENA (rw) register accessor: need_des
...
///need_des
pub mod tcm_int_ena;
/**TCM_INT_CLR (w) register accessor: need_des
...
///need_des
pub mod tcm_int_clr;
/**TCM_PARITY_INT_RECORD (r) register accessor: need_des
...
/**L2_CACHE_PWR_CTRL (rw) register accessor: NA
...
/**CORE_DEBUG_RUNSTALL_CONF (rw) register accessor: Core Debug runstall configure register
...
/**CORE_IBUS_TIMEOUT (rw) register accessor: need_des
...
/**CORE_DBUS_TIMEOUT (rw) register accessor: need_des
...
/**ICM_CPU_H2X_CFG (rw) register accessor: need_des
...
/**PERI1_APB_POSTW_EN (rw) register accessor: NA
...
/**BITSCRAMBLER_PERI_SEL (rw) register accessor: Bitscrambler Peri Sel
...
/**GDMA_CTRL (rw) register accessor: N/A
...
///N/A
pub mod gdma_ctrl;
/**GMAC_CTRL0 (rw) register accessor: N/A
...
///N/A
pub mod gmac_ctrl0;
/**GMAC_CTRL1 (r) register accessor: N/A
...
///N/A
pub mod gmac_ctrl1;
/**GMAC_CTRL2 (r) register accessor: N/A
...
///N/A
pub mod gmac_ctrl2;
/**VPU_CTRL (rw) register accessor: N/A
...
///N/A
pub mod vpu_ctrl;
/**USBOTG20_CTRL (rw) register accessor: N/A
...
/**TCM_ERR_RESP_CTRL (rw) register accessor: need_des
...
/**L2_MEM_REFRESH (rw) register accessor: NA
...
/**TCM_INIT (rw) register accessor: NA
...
///NA
pub mod tcm_init;
/**TCM_PARITY_CHECK_CTRL (rw) register accessor: need_des
...
/**CORE_TIMEOUT_INT_RAW (rw) register accessor: Hp core bus timeout interrupt raw register
...
/**CORE_TIMEOUT_INT_ENA (rw) register accessor: masked interrupt register
...
/**GPIO_O_HYS_CTRL1 (rw) register accessor: NA
...
/**RSA_PD_CTRL (rw) register accessor: rsa pd ctrl register
...
pub mod rsa_pd_ctrl;
/**ECC_PD_CTRL (rw) register accessor: ecc pd ctrl register
...
///rng cfg register
pub mod rng_cfg;
/**UART_PD_CTRL (rw) register accessor: ecc pd ctrl register
...
/**PERI_MEM_CLK_FORCE_ON (rw) register accessor: hp peri mem clk force on regpster
