///Register `SHA_MODE` reader
pub type R = crate::R<SHA_MODE_SPEC>;
///Register `SHA_MODE` writer
pub type W = crate::W<SHA_MODE_SPEC>;
///Field `SHA_MODE` reader - The work mode bits of SHA Calculator in ECDSA Accelerator. 1: SHA-224. 2: SHA-256. Others: invalid.
pub type SHA_MODE_R = crate::FieldReader;
///Field `SHA_MODE` writer - The work mode bits of SHA Calculator in ECDSA Accelerator. 1: SHA-224. 2: SHA-256. Others: invalid.
pub type SHA_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2 - The work mode bits of SHA Calculator in ECDSA Accelerator. 1: SHA-224. 2: SHA-256. Others: invalid.
    #[inline(always)]
...
///`read()` method returns [`sha_mode::R`](R) reader structure
impl crate::Readable for SHA_MODE_SPEC {}
///`write(|w| ..)` method takes [`sha_mode::W`](W) writer structure
