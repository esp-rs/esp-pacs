...
#[doc = "Field `DATE` reader - ECDSA version control register"]
pub type DATE_R = crate::FieldReader<u32>;
#[doc = "Field `DATE` writer - ECDSA version control register"]
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    #[doc = "Bits 0:27 - ECDSA version control register"]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x0230_4070"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0230_4070;
}
