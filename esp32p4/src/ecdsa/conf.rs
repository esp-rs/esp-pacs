...
///Field `WORK_MODE` reader - The work mode bits of ECDSA Accelerator. 0: Signature Verify Mode. 1: Signature Generate Mode. 2: Export Public Key Mode. 3: invalid.
pub type WORK_MODE_R = crate::FieldReader;
///Field `WORK_MODE` writer - The work mode bits of ECDSA Accelerator. 0: Signature Verify Mode. 1: Signature Generate Mode. 2: Export Public Key Mode. 3: invalid.
pub type WORK_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `ECC_CURVE` reader - The ecc curve select bit of ECDSA Accelerator. 0: P-192. 1: P-256.
pub type ECC_CURVE_R = crate::BitReader;
///Field `ECC_CURVE` writer - The ecc curve select bit of ECDSA Accelerator. 0: P-192. 1: P-256.
pub type ECC_CURVE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SOFTWARE_SET_K` reader - The source of k select bit. 0: k is automatically generated by hardware. 1: k is written by software.
pub type SOFTWARE_SET_K_R = crate::BitReader;
///Field `SOFTWARE_SET_K` writer - The source of k select bit. 0: k is automatically generated by hardware. 1: k is written by software.
pub type SOFTWARE_SET_K_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SOFTWARE_SET_Z` reader - The source of z select bit. 0: z is generated from SHA result. 1: z is written by software.
pub type SOFTWARE_SET_Z_R = crate::BitReader;
///Field `SOFTWARE_SET_Z` writer - The source of z select bit. 0: z is generated from SHA result. 1: z is written by software.
pub type SOFTWARE_SET_Z_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DETERMINISTIC_K` reader - The source of hardware generated k. 0: k is generated by TRNG. 1: k is generated by deterministic derivation algorithm.
pub type DETERMINISTIC_K_R = crate::BitReader;
///Field `DETERMINISTIC_K` writer - The source of hardware generated k. 0: k is generated by TRNG. 1: k is generated by deterministic derivation algorithm.
pub type DETERMINISTIC_K_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DETERMINISTIC_LOOP` reader - The (loop number - 1) value in the deterministic derivation algorithm to derive k.
pub type DETERMINISTIC_LOOP_R = crate::FieldReader<u16>;
///Field `DETERMINISTIC_LOOP` writer - The (loop number - 1) value in the deterministic derivation algorithm to derive k.
pub type DETERMINISTIC_LOOP_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:1 - The work mode bits of ECDSA Accelerator. 0: Signature Verify Mode. 1: Signature Generate Mode. 2: Export Public Key Mode. 3: invalid.
    #[inline(always)]
    pub fn work_mode(&self) -> WORK_MODE_R {
        WORK_MODE_R::new((self.bits & 3) as u8)
    }
    ///Bit 2 - The ecc curve select bit of ECDSA Accelerator. 0: P-192. 1: P-256.
    #[inline(always)]
    pub fn ecc_curve(&self) -> ECC_CURVE_R {
        ECC_CURVE_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - The source of k select bit. 0: k is automatically generated by hardware. 1: k is written by software.
    #[inline(always)]
    pub fn software_set_k(&self) -> SOFTWARE_SET_K_R {
        SOFTWARE_SET_K_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - The source of z select bit. 0: z is generated from SHA result. 1: z is written by software.
    #[inline(always)]
    pub fn software_set_z(&self) -> SOFTWARE_SET_Z_R {
        SOFTWARE_SET_Z_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - The source of hardware generated k. 0: k is generated by TRNG. 1: k is generated by deterministic derivation algorithm.
    #[inline(always)]
    pub fn deterministic_k(&self) -> DETERMINISTIC_K_R {
        DETERMINISTIC_K_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bits 6:21 - The (loop number - 1) value in the deterministic derivation algorithm to derive k.
    #[inline(always)]
