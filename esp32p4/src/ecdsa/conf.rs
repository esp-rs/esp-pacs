...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF")
            ...
            .field("ecc_curve", &self.ecc_curve().bit())
            .field("software_set_k", &self.software_set_k().bit())
            .field("software_set_z", &self.software_set_z().bit())
            .field("deterministic_k", &self.deterministic_k().bit())
            .field("deterministic_loop", &self.deterministic_loop().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
