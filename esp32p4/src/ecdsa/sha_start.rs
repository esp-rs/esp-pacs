///Register `SHA_START` writer
pub type W = crate::W<SHA_START_SPEC>;
///Field `SHA_START` writer - Write 1 to start the first caculation of SHA Calculator in ECDSA Accelerator. This bit will be self-cleared after configuration.
...
impl W {
    ///Bit 0 - Write 1 to start the first caculation of SHA Calculator in ECDSA Accelerator. This bit will be self-cleared after configuration.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`sha_start::W`](W) writer structure
