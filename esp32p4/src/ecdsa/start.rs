...
///Field `START` writer - Write 1 to start caculation of ECDSA Accelerator. This bit will be self-cleared after configuration.
pub type START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LOAD_DONE` writer - Write 1 to input load done signal of ECDSA Accelerator. This bit will be self-cleared after configuration.
pub type LOAD_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GET_DONE` writer - Write 1 to input get done signal of ECDSA Accelerator. This bit will be self-cleared after configuration.
...
impl W {
    ///Bit 0 - Write 1 to start caculation of ECDSA Accelerator. This bit will be self-cleared after configuration.
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> START_W<START_SPEC> {
        START_W::new(self, 0)
    }
    ///Bit 1 - Write 1 to input load done signal of ECDSA Accelerator. This bit will be self-cleared after configuration.
    #[inline(always)]
    #[must_use]
    pub fn load_done(&mut self) -> LOAD_DONE_W<START_SPEC> {
        LOAD_DONE_W::new(self, 1)
    }
    ///Bit 2 - Write 1 to input get done signal of ECDSA Accelerator. This bit will be self-cleared after configuration.
    #[inline(always)]
    #[must_use]
