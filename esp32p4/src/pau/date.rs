...
///Field `DATE` reader - REGDMA date information/ REGDMA version information.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - REGDMA date information/ REGDMA version information.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - REGDMA date information/ REGDMA version information.
    #[inline(always)]
