///Register `REGDMA_ETM_CTRL` writer
pub type W = crate::W<REGDMA_ETM_CTRL_SPEC>;
///Field `ETM_START_0` writer - etm_start_0 reg
pub type ETM_START_0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ETM_START_1` writer - etm_start_1 reg
pub type ETM_START_1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ETM_START_2` writer - etm_start_2 reg
pub type ETM_START_2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ETM_START_3` writer - etm_start_3 reg
...
///`write(|w| ..)` method takes [`regdma_etm_ctrl::W`](W) writer structure
