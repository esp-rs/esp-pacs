...
///`read()` method returns [`regdma_link_3_addr::R`](R) reader structure
impl crate::Readable for REGDMA_LINK_3_ADDR_SPEC {}
///`write(|w| ..)` method takes [`regdma_link_3_addr::W`](W) writer structure
