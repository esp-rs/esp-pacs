...
///`read()` method returns [`regdma_link_1_addr::R`](R) reader structure
impl crate::Readable for REGDMA_LINK_1_ADDR_SPEC {}
///`write(|w| ..)` method takes [`regdma_link_1_addr::W`](W) writer structure
