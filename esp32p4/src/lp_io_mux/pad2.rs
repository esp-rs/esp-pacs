///Register `PAD2` reader
pub type R = crate::R<PAD2_SPEC>;
///Register `PAD2` writer
pub type W = crate::W<PAD2_SPEC>;
///Field `REG_PAD2_DRV` reader - Reserved
pub type REG_PAD2_DRV_R = crate::FieldReader;
///Field `REG_PAD2_DRV` writer - Reserved
pub type REG_PAD2_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD2_RDE` reader - Reserved
pub type REG_PAD2_RDE_R = crate::BitReader;
///Field `REG_PAD2_RDE` writer - Reserved
pub type REG_PAD2_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD2_RUE` reader - Reserved
pub type REG_PAD2_RUE_R = crate::BitReader;
///Field `REG_PAD2_RUE` writer - Reserved
pub type REG_PAD2_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD2_MUX_SEL` reader - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD2_MUX_SEL_R = crate::BitReader;
///Field `REG_PAD2_MUX_SEL` writer - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD2_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD2_FUN_SEL` reader - function sel
pub type REG_PAD2_FUN_SEL_R = crate::FieldReader;
///Field `REG_PAD2_FUN_SEL` writer - function sel
pub type REG_PAD2_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD2_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD2_SLP_SEL_R = crate::BitReader;
///Field `REG_PAD2_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD2_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD2_SLP_IE` reader - input enable in sleep mode
pub type REG_PAD2_SLP_IE_R = crate::BitReader;
///Field `REG_PAD2_SLP_IE` writer - input enable in sleep mode
pub type REG_PAD2_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD2_SLP_OE` reader - output enable in sleep mode
pub type REG_PAD2_SLP_OE_R = crate::BitReader;
///Field `REG_PAD2_SLP_OE` writer - output enable in sleep mode
pub type REG_PAD2_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD2_FUN_IE` reader - input enable in work mode
pub type REG_PAD2_FUN_IE_R = crate::BitReader;
///Field `REG_PAD2_FUN_IE` writer - input enable in work mode
pub type REG_PAD2_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD2_FILTER_EN` reader - need des
pub type REG_PAD2_FILTER_EN_R = crate::BitReader;
///Field `REG_PAD2_FILTER_EN` writer - need des
...
///`read()` method returns [`pad2::R`](R) reader structure
impl crate::Readable for PAD2_SPEC {}
///`write(|w| ..)` method takes [`pad2::W`](W) writer structure
