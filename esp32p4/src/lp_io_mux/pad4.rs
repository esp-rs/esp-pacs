///Register `PAD4` reader
pub type R = crate::R<PAD4_SPEC>;
///Register `PAD4` writer
pub type W = crate::W<PAD4_SPEC>;
///Field `REG_PAD4_DRV` reader - Reserved
pub type REG_PAD4_DRV_R = crate::FieldReader;
///Field `REG_PAD4_DRV` writer - Reserved
pub type REG_PAD4_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD4_RDE` reader - Reserved
pub type REG_PAD4_RDE_R = crate::BitReader;
///Field `REG_PAD4_RDE` writer - Reserved
pub type REG_PAD4_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD4_RUE` reader - Reserved
pub type REG_PAD4_RUE_R = crate::BitReader;
///Field `REG_PAD4_RUE` writer - Reserved
pub type REG_PAD4_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD4_MUX_SEL` reader - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD4_MUX_SEL_R = crate::BitReader;
///Field `REG_PAD4_MUX_SEL` writer - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD4_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD4_FUN_SEL` reader - function sel
pub type REG_PAD4_FUN_SEL_R = crate::FieldReader;
///Field `REG_PAD4_FUN_SEL` writer - function sel
pub type REG_PAD4_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD4_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD4_SLP_SEL_R = crate::BitReader;
///Field `REG_PAD4_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD4_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD4_SLP_IE` reader - input enable in sleep mode
pub type REG_PAD4_SLP_IE_R = crate::BitReader;
///Field `REG_PAD4_SLP_IE` writer - input enable in sleep mode
pub type REG_PAD4_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD4_SLP_OE` reader - output enable in sleep mode
pub type REG_PAD4_SLP_OE_R = crate::BitReader;
///Field `REG_PAD4_SLP_OE` writer - output enable in sleep mode
pub type REG_PAD4_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD4_FUN_IE` reader - input enable in work mode
pub type REG_PAD4_FUN_IE_R = crate::BitReader;
///Field `REG_PAD4_FUN_IE` writer - input enable in work mode
pub type REG_PAD4_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD4_FILTER_EN` reader - need des
pub type REG_PAD4_FILTER_EN_R = crate::BitReader;
///Field `REG_PAD4_FILTER_EN` writer - need des
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_drv(&mut self) -> REG_PAD4_DRV_W<PAD4_SPEC> {
        REG_PAD4_DRV_W::new(self, 0)
    }
    ///Bit 2 - Reserved
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_rde(&mut self) -> REG_PAD4_RDE_W<PAD4_SPEC> {
        REG_PAD4_RDE_W::new(self, 2)
    }
    ///Bit 3 - Reserved
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_rue(&mut self) -> REG_PAD4_RUE_W<PAD4_SPEC> {
        REG_PAD4_RUE_W::new(self, 3)
    }
    ///Bit 4 - 1:use LP GPIO,0: use digital GPIO
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_mux_sel(&mut self) -> REG_PAD4_MUX_SEL_W<PAD4_SPEC> {
        REG_PAD4_MUX_SEL_W::new(self, 4)
    }
    ///Bits 5:6 - function sel
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_fun_sel(&mut self) -> REG_PAD4_FUN_SEL_W<PAD4_SPEC> {
        REG_PAD4_FUN_SEL_W::new(self, 5)
    }
    ///Bit 7 - 1: enable sleep mode during sleep,0: no sleep mode
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_slp_sel(&mut self) -> REG_PAD4_SLP_SEL_W<PAD4_SPEC> {
        REG_PAD4_SLP_SEL_W::new(self, 7)
    }
    ///Bit 8 - input enable in sleep mode
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_slp_ie(&mut self) -> REG_PAD4_SLP_IE_W<PAD4_SPEC> {
        REG_PAD4_SLP_IE_W::new(self, 8)
    }
    ///Bit 9 - output enable in sleep mode
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_slp_oe(&mut self) -> REG_PAD4_SLP_OE_W<PAD4_SPEC> {
        REG_PAD4_SLP_OE_W::new(self, 9)
    }
    ///Bit 10 - input enable in work mode
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_fun_ie(&mut self) -> REG_PAD4_FUN_IE_W<PAD4_SPEC> {
        REG_PAD4_FUN_IE_W::new(self, 10)
    }
    ///Bit 11 - need des
    #[inline(always)]
    #[must_use]
    pub fn reg_pad4_filter_en(&mut self) -> REG_PAD4_FILTER_EN_W<PAD4_SPEC> {
...
///`read()` method returns [`pad4::R`](R) reader structure
impl crate::Readable for PAD4_SPEC {}
///`write(|w| ..)` method takes [`pad4::W`](W) writer structure
