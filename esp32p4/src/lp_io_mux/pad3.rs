///Register `PAD3` reader
pub type R = crate::R<PAD3_SPEC>;
///Register `PAD3` writer
pub type W = crate::W<PAD3_SPEC>;
///Field `REG_PAD3_DRV` reader - Reserved
pub type REG_PAD3_DRV_R = crate::FieldReader;
///Field `REG_PAD3_DRV` writer - Reserved
pub type REG_PAD3_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD3_RDE` reader - Reserved
pub type REG_PAD3_RDE_R = crate::BitReader;
///Field `REG_PAD3_RDE` writer - Reserved
pub type REG_PAD3_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD3_RUE` reader - Reserved
pub type REG_PAD3_RUE_R = crate::BitReader;
///Field `REG_PAD3_RUE` writer - Reserved
pub type REG_PAD3_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD3_MUX_SEL` reader - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD3_MUX_SEL_R = crate::BitReader;
///Field `REG_PAD3_MUX_SEL` writer - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD3_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD3_FUN_SEL` reader - function sel
pub type REG_PAD3_FUN_SEL_R = crate::FieldReader;
///Field `REG_PAD3_FUN_SEL` writer - function sel
pub type REG_PAD3_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD3_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD3_SLP_SEL_R = crate::BitReader;
///Field `REG_PAD3_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD3_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD3_SLP_IE` reader - input enable in sleep mode
pub type REG_PAD3_SLP_IE_R = crate::BitReader;
///Field `REG_PAD3_SLP_IE` writer - input enable in sleep mode
pub type REG_PAD3_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD3_SLP_OE` reader - output enable in sleep mode
pub type REG_PAD3_SLP_OE_R = crate::BitReader;
///Field `REG_PAD3_SLP_OE` writer - output enable in sleep mode
pub type REG_PAD3_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD3_FUN_IE` reader - input enable in work mode
pub type REG_PAD3_FUN_IE_R = crate::BitReader;
///Field `REG_PAD3_FUN_IE` writer - input enable in work mode
pub type REG_PAD3_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD3_FILTER_EN` reader - need des
pub type REG_PAD3_FILTER_EN_R = crate::BitReader;
///Field `REG_PAD3_FILTER_EN` writer - need des
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_drv(&mut self) -> REG_PAD3_DRV_W<PAD3_SPEC> {
        REG_PAD3_DRV_W::new(self, 0)
    }
    ///Bit 2 - Reserved
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_rde(&mut self) -> REG_PAD3_RDE_W<PAD3_SPEC> {
        REG_PAD3_RDE_W::new(self, 2)
    }
    ///Bit 3 - Reserved
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_rue(&mut self) -> REG_PAD3_RUE_W<PAD3_SPEC> {
        REG_PAD3_RUE_W::new(self, 3)
    }
    ///Bit 4 - 1:use LP GPIO,0: use digital GPIO
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_mux_sel(&mut self) -> REG_PAD3_MUX_SEL_W<PAD3_SPEC> {
        REG_PAD3_MUX_SEL_W::new(self, 4)
    }
    ///Bits 5:6 - function sel
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_fun_sel(&mut self) -> REG_PAD3_FUN_SEL_W<PAD3_SPEC> {
        REG_PAD3_FUN_SEL_W::new(self, 5)
    }
    ///Bit 7 - 1: enable sleep mode during sleep,0: no sleep mode
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_slp_sel(&mut self) -> REG_PAD3_SLP_SEL_W<PAD3_SPEC> {
        REG_PAD3_SLP_SEL_W::new(self, 7)
    }
    ///Bit 8 - input enable in sleep mode
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_slp_ie(&mut self) -> REG_PAD3_SLP_IE_W<PAD3_SPEC> {
        REG_PAD3_SLP_IE_W::new(self, 8)
    }
    ///Bit 9 - output enable in sleep mode
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_slp_oe(&mut self) -> REG_PAD3_SLP_OE_W<PAD3_SPEC> {
        REG_PAD3_SLP_OE_W::new(self, 9)
    }
    ///Bit 10 - input enable in work mode
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_fun_ie(&mut self) -> REG_PAD3_FUN_IE_W<PAD3_SPEC> {
        REG_PAD3_FUN_IE_W::new(self, 10)
    }
    ///Bit 11 - need des
    #[inline(always)]
    #[must_use]
    pub fn reg_pad3_filter_en(&mut self) -> REG_PAD3_FILTER_EN_W<PAD3_SPEC> {
...
///`read()` method returns [`pad3::R`](R) reader structure
impl crate::Readable for PAD3_SPEC {}
///`write(|w| ..)` method takes [`pad3::W`](W) writer structure
