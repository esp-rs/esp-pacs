...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PAD0")
            .field("reg_pad0_drv", &self.reg_pad0_drv().bits())
            .field("reg_pad0_rde", &self.reg_pad0_rde().bit())
            .field("reg_pad0_rue", &self.reg_pad0_rue().bit())
            .field("reg_pad0_mux_sel", &self.reg_pad0_mux_sel().bit())
            .field("reg_pad0_fun_sel", &self.reg_pad0_fun_sel().bits())
            .field("reg_pad0_slp_sel", &self.reg_pad0_slp_sel().bit())
            .field("reg_pad0_slp_ie", &self.reg_pad0_slp_ie().bit())
            .field("reg_pad0_slp_oe", &self.reg_pad0_slp_oe().bit())
            .field("reg_pad0_fun_ie", &self.reg_pad0_fun_ie().bit())
            .field("reg_pad0_filter_en", &self.reg_pad0_filter_en().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
