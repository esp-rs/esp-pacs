///Register `PAD0` reader
pub type R = crate::R<PAD0_SPEC>;
///Register `PAD0` writer
pub type W = crate::W<PAD0_SPEC>;
///Field `REG_PAD0_DRV` reader - Reserved
pub type REG_PAD0_DRV_R = crate::FieldReader;
///Field `REG_PAD0_DRV` writer - Reserved
pub type REG_PAD0_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD0_RDE` reader - Reserved
pub type REG_PAD0_RDE_R = crate::BitReader;
///Field `REG_PAD0_RDE` writer - Reserved
pub type REG_PAD0_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD0_RUE` reader - Reserved
pub type REG_PAD0_RUE_R = crate::BitReader;
///Field `REG_PAD0_RUE` writer - Reserved
pub type REG_PAD0_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD0_MUX_SEL` reader - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD0_MUX_SEL_R = crate::BitReader;
///Field `REG_PAD0_MUX_SEL` writer - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD0_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD0_FUN_SEL` reader - function sel
pub type REG_PAD0_FUN_SEL_R = crate::FieldReader;
///Field `REG_PAD0_FUN_SEL` writer - function sel
pub type REG_PAD0_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD0_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD0_SLP_SEL_R = crate::BitReader;
///Field `REG_PAD0_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD0_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD0_SLP_IE` reader - input enable in sleep mode
pub type REG_PAD0_SLP_IE_R = crate::BitReader;
///Field `REG_PAD0_SLP_IE` writer - input enable in sleep mode
pub type REG_PAD0_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD0_SLP_OE` reader - output enable in sleep mode
pub type REG_PAD0_SLP_OE_R = crate::BitReader;
///Field `REG_PAD0_SLP_OE` writer - output enable in sleep mode
pub type REG_PAD0_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD0_FUN_IE` reader - input enable in work mode
pub type REG_PAD0_FUN_IE_R = crate::BitReader;
///Field `REG_PAD0_FUN_IE` writer - input enable in work mode
pub type REG_PAD0_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD0_FILTER_EN` reader - need des
pub type REG_PAD0_FILTER_EN_R = crate::BitReader;
///Field `REG_PAD0_FILTER_EN` writer - need des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PAD0")
            .field("reg_pad0_drv", &self.reg_pad0_drv())
            .field("reg_pad0_rde", &self.reg_pad0_rde())
            .field("reg_pad0_rue", &self.reg_pad0_rue())
            .field("reg_pad0_mux_sel", &self.reg_pad0_mux_sel())
            .field("reg_pad0_fun_sel", &self.reg_pad0_fun_sel())
            .field("reg_pad0_slp_sel", &self.reg_pad0_slp_sel())
            .field("reg_pad0_slp_ie", &self.reg_pad0_slp_ie())
            .field("reg_pad0_slp_oe", &self.reg_pad0_slp_oe())
            .field("reg_pad0_fun_ie", &self.reg_pad0_fun_ie())
            .field("reg_pad0_filter_en", &self.reg_pad0_filter_en())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pad0::R`](R) reader structure
impl crate::Readable for PAD0_SPEC {}
///`write(|w| ..)` method takes [`pad0::W`](W) writer structure
