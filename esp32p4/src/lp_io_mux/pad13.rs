///Register `PAD13` reader
pub type R = crate::R<PAD13_SPEC>;
///Register `PAD13` writer
pub type W = crate::W<PAD13_SPEC>;
///Field `REG_PAD13_DRV` reader - Reserved
pub type REG_PAD13_DRV_R = crate::FieldReader;
///Field `REG_PAD13_DRV` writer - Reserved
pub type REG_PAD13_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD13_RDE` reader - Reserved
pub type REG_PAD13_RDE_R = crate::BitReader;
///Field `REG_PAD13_RDE` writer - Reserved
pub type REG_PAD13_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD13_RUE` reader - Reserved
pub type REG_PAD13_RUE_R = crate::BitReader;
///Field `REG_PAD13_RUE` writer - Reserved
pub type REG_PAD13_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD13_MUX_SEL` reader - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD13_MUX_SEL_R = crate::BitReader;
///Field `REG_PAD13_MUX_SEL` writer - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD13_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD13_FUN_SEL` reader - function sel
pub type REG_PAD13_FUN_SEL_R = crate::FieldReader;
///Field `REG_PAD13_FUN_SEL` writer - function sel
pub type REG_PAD13_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD13_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD13_SLP_SEL_R = crate::BitReader;
///Field `REG_PAD13_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD13_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD13_SLP_IE` reader - input enable in sleep mode
pub type REG_PAD13_SLP_IE_R = crate::BitReader;
///Field `REG_PAD13_SLP_IE` writer - input enable in sleep mode
pub type REG_PAD13_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD13_SLP_OE` reader - output enable in sleep mode
pub type REG_PAD13_SLP_OE_R = crate::BitReader;
///Field `REG_PAD13_SLP_OE` writer - output enable in sleep mode
pub type REG_PAD13_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD13_FUN_IE` reader - input enable in work mode
pub type REG_PAD13_FUN_IE_R = crate::BitReader;
///Field `REG_PAD13_FUN_IE` writer - input enable in work mode
pub type REG_PAD13_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD13_FILTER_EN` reader - need des
pub type REG_PAD13_FILTER_EN_R = crate::BitReader;
///Field `REG_PAD13_FILTER_EN` writer - need des
...
///`read()` method returns [`pad13::R`](R) reader structure
impl crate::Readable for PAD13_SPEC {}
///`write(|w| ..)` method takes [`pad13::W`](W) writer structure
