...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PAD7")
            .field("reg_pad7_drv", &self.reg_pad7_drv().bits())
            .field("reg_pad7_rde", &self.reg_pad7_rde().bit())
            .field("reg_pad7_rue", &self.reg_pad7_rue().bit())
            .field("reg_pad7_mux_sel", &self.reg_pad7_mux_sel().bit())
            .field("reg_pad7_fun_sel", &self.reg_pad7_fun_sel().bits())
            .field("reg_pad7_slp_sel", &self.reg_pad7_slp_sel().bit())
            .field("reg_pad7_slp_ie", &self.reg_pad7_slp_ie().bit())
            .field("reg_pad7_slp_oe", &self.reg_pad7_slp_oe().bit())
            .field("reg_pad7_fun_ie", &self.reg_pad7_fun_ie().bit())
            .field("reg_pad7_filter_en", &self.reg_pad7_filter_en().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PAD7_SPEC> {
