...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PAD6")
            .field("reg_pad6_drv", &self.reg_pad6_drv().bits())
            .field("reg_pad6_rde", &self.reg_pad6_rde().bit())
            .field("reg_pad6_rue", &self.reg_pad6_rue().bit())
            .field("reg_pad6_mux_sel", &self.reg_pad6_mux_sel().bit())
            .field("reg_pad6_fun_sel", &self.reg_pad6_fun_sel().bits())
            .field("reg_pad6_slp_sel", &self.reg_pad6_slp_sel().bit())
            .field("reg_pad6_slp_ie", &self.reg_pad6_slp_ie().bit())
            .field("reg_pad6_slp_oe", &self.reg_pad6_slp_oe().bit())
            .field("reg_pad6_fun_ie", &self.reg_pad6_fun_ie().bit())
            .field("reg_pad6_filter_en", &self.reg_pad6_filter_en().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
