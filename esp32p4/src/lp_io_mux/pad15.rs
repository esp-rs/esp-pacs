///Register `PAD15` reader
pub type R = crate::R<PAD15_SPEC>;
///Register `PAD15` writer
pub type W = crate::W<PAD15_SPEC>;
///Field `REG_PAD15_DRV` reader - Reserved
pub type REG_PAD15_DRV_R = crate::FieldReader;
///Field `REG_PAD15_DRV` writer - Reserved
pub type REG_PAD15_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD15_RDE` reader - Reserved
pub type REG_PAD15_RDE_R = crate::BitReader;
///Field `REG_PAD15_RDE` writer - Reserved
pub type REG_PAD15_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD15_RUE` reader - Reserved
pub type REG_PAD15_RUE_R = crate::BitReader;
///Field `REG_PAD15_RUE` writer - Reserved
pub type REG_PAD15_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD15_MUX_SEL` reader - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD15_MUX_SEL_R = crate::BitReader;
///Field `REG_PAD15_MUX_SEL` writer - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD15_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD15_FUN_SEL` reader - function sel
pub type REG_PAD15_FUN_SEL_R = crate::FieldReader;
///Field `REG_PAD15_FUN_SEL` writer - function sel
pub type REG_PAD15_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD15_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD15_SLP_SEL_R = crate::BitReader;
///Field `REG_PAD15_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD15_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD15_SLP_IE` reader - input enable in sleep mode
pub type REG_PAD15_SLP_IE_R = crate::BitReader;
///Field `REG_PAD15_SLP_IE` writer - input enable in sleep mode
pub type REG_PAD15_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD15_SLP_OE` reader - output enable in sleep mode
pub type REG_PAD15_SLP_OE_R = crate::BitReader;
///Field `REG_PAD15_SLP_OE` writer - output enable in sleep mode
pub type REG_PAD15_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD15_FUN_IE` reader - input enable in work mode
pub type REG_PAD15_FUN_IE_R = crate::BitReader;
///Field `REG_PAD15_FUN_IE` writer - input enable in work mode
pub type REG_PAD15_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD15_FILTER_EN` reader - need des
pub type REG_PAD15_FILTER_EN_R = crate::BitReader;
///Field `REG_PAD15_FILTER_EN` writer - need des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PAD15")
            .field("reg_pad15_drv", &self.reg_pad15_drv())
            .field("reg_pad15_rde", &self.reg_pad15_rde())
            .field("reg_pad15_rue", &self.reg_pad15_rue())
            .field("reg_pad15_mux_sel", &self.reg_pad15_mux_sel())
            .field("reg_pad15_fun_sel", &self.reg_pad15_fun_sel())
            .field("reg_pad15_slp_sel", &self.reg_pad15_slp_sel())
            .field("reg_pad15_slp_ie", &self.reg_pad15_slp_ie())
            .field("reg_pad15_slp_oe", &self.reg_pad15_slp_oe())
            .field("reg_pad15_fun_ie", &self.reg_pad15_fun_ie())
            .field("reg_pad15_filter_en", &self.reg_pad15_filter_en())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pad15::R`](R) reader structure
impl crate::Readable for PAD15_SPEC {}
///`write(|w| ..)` method takes [`pad15::W`](W) writer structure
