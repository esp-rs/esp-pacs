...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PAD15")
            .field("reg_pad15_drv", &self.reg_pad15_drv().bits())
            .field("reg_pad15_rde", &self.reg_pad15_rde().bit())
            .field("reg_pad15_rue", &self.reg_pad15_rue().bit())
            .field("reg_pad15_mux_sel", &self.reg_pad15_mux_sel().bit())
            .field("reg_pad15_fun_sel", &self.reg_pad15_fun_sel().bits())
            .field("reg_pad15_slp_sel", &self.reg_pad15_slp_sel().bit())
            .field("reg_pad15_slp_ie", &self.reg_pad15_slp_ie().bit())
            .field("reg_pad15_slp_oe", &self.reg_pad15_slp_oe().bit())
            .field("reg_pad15_fun_ie", &self.reg_pad15_fun_ie().bit())
            .field("reg_pad15_filter_en", &self.reg_pad15_filter_en().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
