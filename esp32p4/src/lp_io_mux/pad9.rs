///Register `PAD9` reader
pub type R = crate::R<PAD9_SPEC>;
///Register `PAD9` writer
pub type W = crate::W<PAD9_SPEC>;
///Field `REG_PAD9_DRV` reader - Reserved
pub type REG_PAD9_DRV_R = crate::FieldReader;
///Field `REG_PAD9_DRV` writer - Reserved
pub type REG_PAD9_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD9_RDE` reader - Reserved
pub type REG_PAD9_RDE_R = crate::BitReader;
///Field `REG_PAD9_RDE` writer - Reserved
pub type REG_PAD9_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD9_RUE` reader - Reserved
pub type REG_PAD9_RUE_R = crate::BitReader;
///Field `REG_PAD9_RUE` writer - Reserved
pub type REG_PAD9_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD9_MUX_SEL` reader - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD9_MUX_SEL_R = crate::BitReader;
///Field `REG_PAD9_MUX_SEL` writer - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD9_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD9_FUN_SEL` reader - function sel
pub type REG_PAD9_FUN_SEL_R = crate::FieldReader;
///Field `REG_PAD9_FUN_SEL` writer - function sel
pub type REG_PAD9_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD9_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD9_SLP_SEL_R = crate::BitReader;
///Field `REG_PAD9_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD9_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD9_SLP_IE` reader - input enable in sleep mode
pub type REG_PAD9_SLP_IE_R = crate::BitReader;
///Field `REG_PAD9_SLP_IE` writer - input enable in sleep mode
pub type REG_PAD9_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD9_SLP_OE` reader - output enable in sleep mode
pub type REG_PAD9_SLP_OE_R = crate::BitReader;
///Field `REG_PAD9_SLP_OE` writer - output enable in sleep mode
pub type REG_PAD9_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD9_FUN_IE` reader - input enable in work mode
pub type REG_PAD9_FUN_IE_R = crate::BitReader;
///Field `REG_PAD9_FUN_IE` writer - input enable in work mode
pub type REG_PAD9_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD9_FILTER_EN` reader - need des
pub type REG_PAD9_FILTER_EN_R = crate::BitReader;
///Field `REG_PAD9_FILTER_EN` writer - need des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PAD9")
            .field("reg_pad9_drv", &self.reg_pad9_drv())
            .field("reg_pad9_rde", &self.reg_pad9_rde())
            .field("reg_pad9_rue", &self.reg_pad9_rue())
            .field("reg_pad9_mux_sel", &self.reg_pad9_mux_sel())
            .field("reg_pad9_fun_sel", &self.reg_pad9_fun_sel())
            .field("reg_pad9_slp_sel", &self.reg_pad9_slp_sel())
            .field("reg_pad9_slp_ie", &self.reg_pad9_slp_ie())
            .field("reg_pad9_slp_oe", &self.reg_pad9_slp_oe())
            .field("reg_pad9_fun_ie", &self.reg_pad9_fun_ie())
            .field("reg_pad9_filter_en", &self.reg_pad9_filter_en())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pad9::R`](R) reader structure
impl crate::Readable for PAD9_SPEC {}
///`write(|w| ..)` method takes [`pad9::W`](W) writer structure
