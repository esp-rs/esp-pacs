///Register `PAD14` reader
pub type R = crate::R<PAD14_SPEC>;
///Register `PAD14` writer
pub type W = crate::W<PAD14_SPEC>;
///Field `REG_PAD14_DRV` reader - Reserved
pub type REG_PAD14_DRV_R = crate::FieldReader;
///Field `REG_PAD14_DRV` writer - Reserved
pub type REG_PAD14_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD14_RDE` reader - Reserved
pub type REG_PAD14_RDE_R = crate::BitReader;
///Field `REG_PAD14_RDE` writer - Reserved
pub type REG_PAD14_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD14_RUE` reader - Reserved
pub type REG_PAD14_RUE_R = crate::BitReader;
///Field `REG_PAD14_RUE` writer - Reserved
pub type REG_PAD14_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD14_MUX_SEL` reader - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD14_MUX_SEL_R = crate::BitReader;
///Field `REG_PAD14_MUX_SEL` writer - 1:use LP GPIO,0: use digital GPIO
pub type REG_PAD14_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD14_FUN_SEL` reader - function sel
pub type REG_PAD14_FUN_SEL_R = crate::FieldReader;
///Field `REG_PAD14_FUN_SEL` writer - function sel
pub type REG_PAD14_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_PAD14_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD14_SLP_SEL_R = crate::BitReader;
///Field `REG_PAD14_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type REG_PAD14_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD14_SLP_IE` reader - input enable in sleep mode
pub type REG_PAD14_SLP_IE_R = crate::BitReader;
///Field `REG_PAD14_SLP_IE` writer - input enable in sleep mode
pub type REG_PAD14_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD14_SLP_OE` reader - output enable in sleep mode
pub type REG_PAD14_SLP_OE_R = crate::BitReader;
///Field `REG_PAD14_SLP_OE` writer - output enable in sleep mode
pub type REG_PAD14_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD14_FUN_IE` reader - input enable in work mode
pub type REG_PAD14_FUN_IE_R = crate::BitReader;
///Field `REG_PAD14_FUN_IE` writer - input enable in work mode
pub type REG_PAD14_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_PAD14_FILTER_EN` reader - need des
pub type REG_PAD14_FILTER_EN_R = crate::BitReader;
///Field `REG_PAD14_FILTER_EN` writer - need des
...
///`read()` method returns [`pad14::R`](R) reader structure
impl crate::Readable for PAD14_SPEC {}
///`write(|w| ..)` method takes [`pad14::W`](W) writer structure
