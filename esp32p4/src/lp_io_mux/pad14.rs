...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PAD14")
            .field(
                "reg_pad14_drv",
                &format_args!("{}", self.reg_pad14_drv().bits()),
            )
            .field(
                "reg_pad14_rde",
                &format_args!("{}", self.reg_pad14_rde().bit()),
            )
            .field(
                "reg_pad14_rue",
                &format_args!("{}", self.reg_pad14_rue().bit()),
            )
            .field(
                "reg_pad14_mux_sel",
                &format_args!("{}", self.reg_pad14_mux_sel().bit()),
            )
            .field(
                "reg_pad14_fun_sel",
                &format_args!("{}", self.reg_pad14_fun_sel().bits()),
            )
            .field(
                "reg_pad14_slp_sel",
                &format_args!("{}", self.reg_pad14_slp_sel().bit()),
            )
            .field(
                "reg_pad14_slp_ie",
                &format_args!("{}", self.reg_pad14_slp_ie().bit()),
            )
            .field(
                "reg_pad14_slp_oe",
                &format_args!("{}", self.reg_pad14_slp_oe().bit()),
            )
            .field(
                "reg_pad14_fun_ie",
                &format_args!("{}", self.reg_pad14_fun_ie().bit()),
            )
            .field(
                "reg_pad14_filter_en",
                &format_args!("{}", self.reg_pad14_filter_en().bit()),
            )
            .finish()
    }
}
