...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS")
            .field("stnotstop", &self.stnotstop().bit())
            .field("stmsg", &self.stmsg().bit())
            .field("stccch", &self.stccch().bit())
            .field("streqrd", &self.streqrd().bit())
            .field("streqwr", &self.streqwr().bit())
            .field("stdaa", &self.stdaa().bit())
            .field("sthdr", &self.sthdr().bit())
            .field("start", &self.start().bit())
            .field("matched", &self.matched().bit())
            .field("stop", &self.stop().bit())
            .field("rxpend", &self.rxpend().bit())
            .field("txnotfull", &self.txnotfull().bit())
            .field("dachg", &self.dachg().bit())
            .field("ccc", &self.ccc().bit())
            .field("errwarn", &self.errwarn().bit())
            .field("hdrmatch", &self.hdrmatch().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
