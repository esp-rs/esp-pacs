...
///Field `STNOTSTOP` reader - Is 1 if bus is busy(activity) and 0 when in a STOP condition. Other bits may also set when busy. Note that this can also be true from an S0 or S1 error, which waits for an Exit Pattern.
pub type STNOTSTOP_R = crate::BitReader;
///Field `STMSG` reader - Is 1 if this bus Slave is listening to the bus traffic or repsonding, If STNOSTOP=1, then this will be 0 when a non-matching address seen until next respeated START it STOP.
pub type STMSG_R = crate::BitReader;
///Field `STCCCH` reader - Is 1 if a CCC message is being handled automatically.
pub type STCCCH_R = crate::BitReader;
///Field `STREQRD` reader - 1 if the req in process is an sdr read from this slave or an IBI is being pushed out,
pub type STREQRD_R = crate::BitReader;
///Field `STREQWR` reader - NA
pub type STREQWR_R = crate::BitReader;
///Field `STDAA` reader - NA
pub type STDAA_R = crate::BitReader;
///Field `STHDR` reader - NA
pub type STHDR_R = crate::BitReader;
///Field `START` reader - NA
pub type START_R = crate::BitReader;
///Field `START` writer - NA
pub type START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MATCHED` reader - NA
pub type MATCHED_R = crate::BitReader;
///Field `MATCHED` writer - NA
pub type MATCHED_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `STOP` reader - NA
pub type STOP_R = crate::BitReader;
///Field `STOP` writer - NA
pub type STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXPEND` reader - Receiving a message from master,which is not being handled by block(not a CCC internally processed). For all but External FIFO, this uses DATACTRL RXTRIG, which defaults to not-empty. If DMA is enabled for RX, DMA will be signaled as well. Will self-clear if data is read(FIFO and non-FIFO)
pub type RXPEND_R = crate::BitReader;
///Field `TXNOTFULL` reader - Is 1 when the To-bus buffer/FIFO can accept more data to go out. Defau:1. For all but External FIFO, this uses DATACTRL TXTRIG,which defaults to not-full. If DMA is enabled for TX, it will also be signaled to provide more.
pub type TXNOTFULL_R = crate::BitReader;
///Field `DACHG` reader - The Slv Dynamic Address has been assigned, reassigned, or reset(lost) and is now in that state of being valid or none. Actual DA can be seen in the DYNADDR register. Note that this will also be used when MAP Auto feature is configured. This will be changing one or more MAP items. See DYNADDR and/or MAPCTRLn. DYNAADDR for the main DA(0) will indicate if last change was due to Auto MAP.
pub type DACHG_R = crate::BitReader;
///Field `DACHG` writer - The Slv Dynamic Address has been assigned, reassigned, or reset(lost) and is now in that state of being valid or none. Actual DA can be seen in the DYNADDR register. Note that this will also be used when MAP Auto feature is configured. This will be changing one or more MAP items. See DYNADDR and/or MAPCTRLn. DYNAADDR for the main DA(0) will indicate if last change was due to Auto MAP.
...
///Field `CCC` writer - A common -command-code(CCC), not handled by block, has been received. This acts differently between: *Broadcasted ones, which will then also correspond with RXPEND and the 1st byte will be the CCC(command) . *Direct ones, which may never be directed to this device. If it is, then the TXSEND or RXPEND will be triggered with this end the RXPEND will contain the command.
pub type CCC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ERRWARN` reader - NA
pub type ERRWARN_R = crate::BitReader;
///Field `HDRMATCH` reader - NA
pub type HDRMATCH_R = crate::BitReader;
///Field `HDRMATCH` writer - NA
pub type HDRMATCH_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Is 1 if bus is busy(activity) and 0 when in a STOP condition. Other bits may also set when busy. Note that this can also be true from an S0 or S1 error, which waits for an Exit Pattern.
    #[inline(always)]
    pub fn stnotstop(&self) -> STNOTSTOP_R {
        STNOTSTOP_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Is 1 if this bus Slave is listening to the bus traffic or repsonding, If STNOSTOP=1, then this will be 0 when a non-matching address seen until next respeated START it STOP.
    #[inline(always)]
    pub fn stmsg(&self) -> STMSG_R {
        STMSG_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Is 1 if a CCC message is being handled automatically.
    #[inline(always)]
    pub fn stccch(&self) -> STCCCH_R {
        STCCCH_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - 1 if the req in process is an sdr read from this slave or an IBI is being pushed out,
    #[inline(always)]
    ...
    ///Bit 11 - Receiving a message from master,which is not being handled by block(not a CCC internally processed). For all but External FIFO, this uses DATACTRL RXTRIG, which defaults to not-empty. If DMA is enabled for RX, DMA will be signaled as well. Will self-clear if data is read(FIFO and non-FIFO)
    #[inline(always)]
    pub fn rxpend(&self) -> RXPEND_R {
        RXPEND_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - Is 1 when the To-bus buffer/FIFO can accept more data to go out. Defau:1. For all but External FIFO, this uses DATACTRL TXTRIG,which defaults to not-full. If DMA is enabled for TX, it will also be signaled to provide more.
    #[inline(always)]
    pub fn txnotfull(&self) -> TXNOTFULL_R {
        TXNOTFULL_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - The Slv Dynamic Address has been assigned, reassigned, or reset(lost) and is now in that state of being valid or none. Actual DA can be seen in the DYNADDR register. Note that this will also be used when MAP Auto feature is configured. This will be changing one or more MAP items. See DYNADDR and/or MAPCTRLn. DYNAADDR for the main DA(0) will indicate if last change was due to Auto MAP.
    #[inline(always)]
    pub fn dachg(&self) -> DACHG_R {
        DACHG_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - A common -command-code(CCC), not handled by block, has been received. This acts differently between: *Broadcasted ones, which will then also correspond with RXPEND and the 1st byte will be the CCC(command) . *Direct ones, which may never be directed to this device. If it is, then the TXSEND or RXPEND will be triggered with this end the RXPEND will contain the command.
    #[inline(always)]
