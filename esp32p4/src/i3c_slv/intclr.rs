...
impl W {
    ...
    #[inline(always)]
    pub fn stop_clr(&mut self) -> STOP_CLR_W<'_, INTCLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rxpend_clr(&mut self) -> RXPEND_CLR_W<'_, INTCLR_SPEC> {
        RXPEND_CLR_W::new(self, 11)
    }
    #[doc = "Bit 12 - NA"]
    #[inline(always)]
    pub fn txsend_clr(&mut self) -> TXSEND_CLR_W<'_, INTCLR_SPEC> {
