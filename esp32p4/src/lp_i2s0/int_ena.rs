...
///Field `RX_FIFOMEM_UDF` writer - The interrupt enable bit for the i2s_rx_fifomem_udf_int interrupt
...
///Field `LP_VAD_DONE` writer - The interrupt enable bit for the vad_done_int interrupt
...
///Field `LP_VAD_RESET_DONE` writer - The interrupt enable bit for the vad_reset_done_int interrupt
pub type LP_VAD_RESET_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_MEM_THRESHOLD` reader - The interrupt enable bit for the rx_mem_threshold_int interrupt
pub type RX_MEM_THRESHOLD_R = crate::BitReader;
///Field `RX_MEM_THRESHOLD` writer - The interrupt enable bit for the rx_mem_threshold_int interrupt
...
impl R {
    ...
    ///Bit 1 - The interrupt enable bit for the i2s_rx_hung_int interrupt
    #[inline(always)]
    pub fn rx_hung(&self) -> RX_HUNG_R {
        RX_HUNG_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - The interrupt enable bit for the i2s_rx_fifomem_udf_int interrupt
    #[inline(always)]
    pub fn rx_fifomem_udf(&self) -> RX_FIFOMEM_UDF_R {
        RX_FIFOMEM_UDF_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - The interrupt enable bit for the vad_done_int interrupt
    #[inline(always)]
    pub fn lp_vad_done(&self) -> LP_VAD_DONE_R {
        LP_VAD_DONE_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - The interrupt enable bit for the vad_reset_done_int interrupt
    #[inline(always)]
    pub fn lp_vad_reset_done(&self) -> LP_VAD_RESET_DONE_R {
        LP_VAD_RESET_DONE_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - The interrupt enable bit for the rx_mem_threshold_int interrupt
    #[inline(always)]
