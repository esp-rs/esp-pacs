///Register `RX_PDM_CONF` reader
pub type R = crate::R<RX_PDM_CONF_SPEC>;
///Register `RX_PDM_CONF` writer
...
///Field `RX_PDM2PCM_AMPLIFY_NUM` reader - Configure PDM RX amplify number.
pub type RX_PDM2PCM_AMPLIFY_NUM_R = crate::FieldReader;
///Field `RX_PDM2PCM_AMPLIFY_NUM` writer - Configure PDM RX amplify number.
pub type RX_PDM2PCM_AMPLIFY_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `RX_PDM_HP_BYPASS` reader - I2S PDM RX bypass hp filter or not.
pub type RX_PDM_HP_BYPASS_R = crate::BitReader;
///Field `RX_PDM_HP_BYPASS` writer - I2S PDM RX bypass hp filter or not.
pub type RX_PDM_HP_BYPASS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_IIR_HP_MULT12_5` reader - The fourth parameter of PDM RX IIR_HP filter stage 2 is (504 + LP_I2S_RX_IIR_HP_MULT12_5\[2:0\])
pub type RX_IIR_HP_MULT12_5_R = crate::FieldReader;
///Field `RX_IIR_HP_MULT12_5` writer - The fourth parameter of PDM RX IIR_HP filter stage 2 is (504 + LP_I2S_RX_IIR_HP_MULT12_5\[2:0\])
pub type RX_IIR_HP_MULT12_5_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `RX_IIR_HP_MULT12_0` reader - The fourth parameter of PDM RX IIR_HP filter stage 1 is (504 + LP_I2S_RX_IIR_HP_MULT12_0\[2:0\])
pub type RX_IIR_HP_MULT12_0_R = crate::FieldReader;
///Field `RX_IIR_HP_MULT12_0` writer - The fourth parameter of PDM RX IIR_HP filter stage 1 is (504 + LP_I2S_RX_IIR_HP_MULT12_0\[2:0\])
pub type RX_IIR_HP_MULT12_0_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bit 19 - 1: Enable PDM2PCM RX mode. 0: DIsable.
    #[inline(always)]
    ...
    ///Bits 26:28 - The fourth parameter of PDM RX IIR_HP filter stage 2 is (504 + LP_I2S_RX_IIR_HP_MULT12_5\[2:0\])
    #[inline(always)]
    pub fn rx_iir_hp_mult12_5(&self) -> RX_IIR_HP_MULT12_5_R {
        RX_IIR_HP_MULT12_5_R::new(((self.bits >> 26) & 7) as u8)
    }
    ///Bits 29:31 - The fourth parameter of PDM RX IIR_HP filter stage 1 is (504 + LP_I2S_RX_IIR_HP_MULT12_0\[2:0\])
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_pdm2pcm_en(&mut self) -> RX_PDM2PCM_EN_W<RX_PDM_CONF_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_pdm_hp_bypass(&mut self) -> RX_PDM_HP_BYPASS_W<RX_PDM_CONF_SPEC> {
        RX_PDM_HP_BYPASS_W::new(self, 25)
    }
    ///Bits 26:28 - The fourth parameter of PDM RX IIR_HP filter stage 2 is (504 + LP_I2S_RX_IIR_HP_MULT12_5\[2:0\])
    #[inline(always)]
    #[must_use]
    pub fn rx_iir_hp_mult12_5(&mut self) -> RX_IIR_HP_MULT12_5_W<RX_PDM_CONF_SPEC> {
        RX_IIR_HP_MULT12_5_W::new(self, 26)
    }
    ///Bits 29:31 - The fourth parameter of PDM RX IIR_HP filter stage 1 is (504 + LP_I2S_RX_IIR_HP_MULT12_0\[2:0\])
    #[inline(always)]
    #[must_use]
    pub fn rx_iir_hp_mult12_0(&mut self) -> RX_IIR_HP_MULT12_0_W<RX_PDM_CONF_SPEC> {
...
///`read()` method returns [`rx_pdm_conf::R`](R) reader structure
impl crate::Readable for RX_PDM_CONF_SPEC {}
///`write(|w| ..)` method takes [`rx_pdm_conf::W`](W) writer structure
