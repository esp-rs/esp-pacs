///Register `VAD_PARAM8` reader
pub type R = crate::R<VAD_PARAM8_SPEC>;
///Register `VAD_PARAM8` writer
pub type W = crate::W<VAD_PARAM8_SPEC>;
///Field `PARAM_THRES_UPD_BDL` reader - Noise_std boundary low when updating threshold.
pub type PARAM_THRES_UPD_BDL_R = crate::FieldReader;
///Field `PARAM_THRES_UPD_BDL` writer - Noise_std boundary low when updating threshold.
pub type PARAM_THRES_UPD_BDL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PARAM_THRES_UPD_BDH` reader - Noise_std boundary high when updating threshold.
pub type PARAM_THRES_UPD_BDH_R = crate::FieldReader;
///Field `PARAM_THRES_UPD_BDH` writer - Noise_std boundary high when updating threshold.
pub type PARAM_THRES_UPD_BDH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PARAM_FEATURE_BURST` reader - VAD parameter
pub type PARAM_FEATURE_BURST_R = crate::FieldReader<u16>;
///Field `PARAM_FEATURE_BURST` writer - VAD parameter
pub type PARAM_FEATURE_BURST_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:7 - Noise_std boundary low when updating threshold.
    #[inline(always)]
    pub fn param_thres_upd_bdl(&self) -> PARAM_THRES_UPD_BDL_R {
        PARAM_THRES_UPD_BDL_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - Noise_std boundary high when updating threshold.
    #[inline(always)]
...
///`read()` method returns [`vad_param8::R`](R) reader structure
impl crate::Readable for VAD_PARAM8_SPEC {}
///`write(|w| ..)` method takes [`vad_param8::W`](W) writer structure
