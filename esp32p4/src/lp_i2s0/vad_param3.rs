...
///`read()` method returns [`vad_param3::R`](R) reader structure
impl crate::Readable for VAD_PARAM3_SPEC {}
///`write(|w| ..)` method takes [`vad_param3::W`](W) writer structure
