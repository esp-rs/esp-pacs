///Register `VAD_OB2` reader
pub type R = crate::R<VAD_OB2_SPEC>;
///Field `NOISE_AMP_OB` reader - Reg noise_amp observe signal
pub type NOISE_AMP_OB_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Reg noise_amp observe signal
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("VAD_OB2")
            .field("noise_amp_ob", &self.noise_amp_ob())
            .finish()
    }
}
...
///`read()` method returns [`vad_ob2::R`](R) reader structure
