...
///Field `CLK_EN` writer - set this bit to enable clock gate
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `VAD_CG_FORCE_ON` reader - VAD clock gate force on register
pub type VAD_CG_FORCE_ON_R = crate::BitReader;
///Field `VAD_CG_FORCE_ON` writer - VAD clock gate force on register
pub type VAD_CG_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_MEM_CG_FORCE_ON` reader - I2S rx mem clock gate force on register
pub type RX_MEM_CG_FORCE_ON_R = crate::BitReader;
///Field `RX_MEM_CG_FORCE_ON` writer - I2S rx mem clock gate force on register
pub type RX_MEM_CG_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_REG_CG_FORCE_ON` reader - I2S rx reg clock gate force on register
pub type RX_REG_CG_FORCE_ON_R = crate::BitReader;
///Field `RX_REG_CG_FORCE_ON` writer - I2S rx reg clock gate force on register
...
///`read()` method returns [`clk_gate::R`](R) reader structure
impl crate::Readable for CLK_GATE_SPEC {}
///`write(|w| ..)` method takes [`clk_gate::W`](W) writer structure
