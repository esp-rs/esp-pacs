...
///`read()` method returns [`vad_param1::R`](R) reader structure
impl crate::Readable for VAD_PARAM1_SPEC {}
///`write(|w| ..)` method takes [`vad_param1::W`](W) writer structure
