...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW")
            ...
            .field(
                "rx_fifomem_udf_int_raw",
                &format_args!("{}", self.rx_fifomem_udf_int_raw().bit()),
            )
            .field(
                "vad_done_int_raw",
                &format_args!("{}", self.vad_done_int_raw().bit()),
            )
            .field(
                "vad_reset_done_int_raw",
                &format_args!("{}", self.vad_reset_done_int_raw().bit()),
            )
            .field(
                "rx_mem_threshold_int_raw",
                &format_args!("{}", self.rx_mem_threshold_int_raw().bit()),
            )
            .finish()
    }
}
