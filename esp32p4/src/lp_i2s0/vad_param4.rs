...
///`read()` method returns [`vad_param4::R`](R) reader structure
impl crate::Readable for VAD_PARAM4_SPEC {}
///`write(|w| ..)` method takes [`vad_param4::W`](W) writer structure
