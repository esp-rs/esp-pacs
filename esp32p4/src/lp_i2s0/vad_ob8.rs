///Register `VAD_OB8` reader
pub type R = crate::R<VAD_OB8_SPEC>;
///Field `ENERGY_HIGH_OB` reader - Reg energy bit 63~32 observe signal
pub type ENERGY_HIGH_OB_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Reg energy bit 63~32 observe signal
    #[inline(always)]
...
///`read()` method returns [`vad_ob8::R`](R) reader structure
