...
///Field `RX_FIFOMEM_RESET` writer - Set this bit to reset Rx Syncfifomem
pub type RX_FIFOMEM_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    ///Bit 4 - Set this bit to reset Rx Syncfifomem
    #[inline(always)]
    #[must_use]
    pub fn rx_fifomem_reset(&mut self) -> RX_FIFOMEM_RESET_W<RX_CONF_SPEC> {
        RX_FIFOMEM_RESET_W::new(self, 4)
    }
    ///Bit 5 - Set this bit to enable receiver in mono mode
    #[inline(always)]
    #[must_use]
