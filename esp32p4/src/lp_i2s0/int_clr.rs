...
///Field `LP_VAD_RESET_DONE` writer - Set this bit to clear the vad_reset_done_int interrupt
pub type LP_VAD_RESET_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `RX_MEM_THRESHOLD` writer - Set this bit to clear the rx_mem_threshold_int interrupt
