...
///`read()` method returns [`vad_param7::R`](R) reader structure
impl crate::Readable for VAD_PARAM7_SPEC {}
///`write(|w| ..)` method takes [`vad_param7::W`](W) writer structure
