///Register `SPI_SMEM_DIN_HEX_NUM` reader
pub type R = crate::R<SPI_SMEM_DIN_HEX_NUM_SPEC>;
///Register `SPI_SMEM_DIN_HEX_NUM` writer
pub type W = crate::W<SPI_SMEM_DIN_HEX_NUM_SPEC>;
///Field `SPI_SMEM_DIN08_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN08_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN08_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN08_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN09_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN09_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN09_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN09_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN10_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN10_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN10_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN10_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN11_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN11_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN11_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN11_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN12_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN12_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN12_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN12_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN13_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN13_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN13_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN13_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN14_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN14_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN14_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN14_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN15_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN15_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN15_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DIN15_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DINS_HEX_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type SPI_SMEM_DINS_HEX_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DINS_HEX_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
...
///`read()` method returns [`spi_smem_din_hex_num::R`](R) reader structure
impl crate::Readable for SPI_SMEM_DIN_HEX_NUM_SPEC {}
///`write(|w| ..)` method takes [`spi_smem_din_hex_num::W`](W) writer structure
