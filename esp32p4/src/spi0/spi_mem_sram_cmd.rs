...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_SRAM_CMD")
            ...
            .field(
                "spi_mem_sdin_hex",
                &format_args!("{}", self.spi_mem_sdin_hex().bit()),
            )
            .field(
                "spi_mem_sdout_hex",
                &format_args!("{}", self.spi_mem_sdout_hex().bit()),
            )
            .field(
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sclk_mode(&mut self) -> SPI_MEM_SCLK_MODE_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SCLK_MODE_W::new(self, 0)
    }
    #[doc = "Bits 2:9 - Mode bits in the external RAM fast read mode it is combined with spi_mem_fastrd_mode bit."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_swb_mode(&mut self) -> SPI_MEM_SWB_MODE_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SWB_MODE_W::new(self, 2)
    }
    #[doc = "Bit 10 - For SPI0 external RAM , din phase apply 2 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_dio."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sdin_dual(&mut self) -> SPI_MEM_SDIN_DUAL_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDIN_DUAL_W::new(self, 10)
    }
    #[doc = "Bit 11 - For SPI0 external RAM , dout phase apply 2 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_dio."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sdout_dual(&mut self) -> SPI_MEM_SDOUT_DUAL_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDOUT_DUAL_W::new(self, 11)
    }
    #[doc = "Bit 12 - For SPI0 external RAM , address phase apply 2 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_dio."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_saddr_dual(&mut self) -> SPI_MEM_SADDR_DUAL_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SADDR_DUAL_W::new(self, 12)
    }
    #[doc = "Bit 14 - For SPI0 external RAM , din phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sdin_quad(&mut self) -> SPI_MEM_SDIN_QUAD_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDIN_QUAD_W::new(self, 14)
    }
    #[doc = "Bit 15 - For SPI0 external RAM , dout phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sdout_quad(&mut self) -> SPI_MEM_SDOUT_QUAD_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDOUT_QUAD_W::new(self, 15)
    }
    #[doc = "Bit 16 - For SPI0 external RAM , address phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_saddr_quad(&mut self) -> SPI_MEM_SADDR_QUAD_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SADDR_QUAD_W::new(self, 16)
    }
    #[doc = "Bit 17 - For SPI0 external RAM , cmd phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_scmd_quad(&mut self) -> SPI_MEM_SCMD_QUAD_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SCMD_QUAD_W::new(self, 17)
    }
    #[doc = "Bit 18 - For SPI0 external RAM , din phase apply 8 signals. 1: enable 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sdin_oct(&mut self) -> SPI_MEM_SDIN_OCT_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDIN_OCT_W::new(self, 18)
    }
    #[doc = "Bit 19 - For SPI0 external RAM , dout phase apply 8 signals. 1: enable 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sdout_oct(&mut self) -> SPI_MEM_SDOUT_OCT_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDOUT_OCT_W::new(self, 19)
    }
    #[doc = "Bit 20 - For SPI0 external RAM , address phase apply 4 signals. 1: enable 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_saddr_oct(&mut self) -> SPI_MEM_SADDR_OCT_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SADDR_OCT_W::new(self, 20)
    }
    #[doc = "Bit 21 - For SPI0 external RAM , cmd phase apply 8 signals. 1: enable 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_scmd_oct(&mut self) -> SPI_MEM_SCMD_OCT_W<SPI_MEM_SRAM_CMD_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sdummy_wout(&mut self) -> SPI_MEM_SDUMMY_WOUT_W<SPI_MEM_SRAM_CMD_SPEC> {
    ...
    pub fn spi_smem_wdummy_dqs_always_out(
        &mut self,
    ) -> SPI_SMEM_WDUMMY_DQS_ALWAYS_OUT_W<SPI_MEM_SRAM_CMD_SPEC> {
    ...
    pub fn spi_smem_wdummy_always_out(
        &mut self,
    ) -> SPI_SMEM_WDUMMY_ALWAYS_OUT_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_SMEM_WDUMMY_ALWAYS_OUT_W::new(self, 25)
    }
    #[doc = "Bit 26 - For SPI0 external RAM , din phase apply 16 signals. 1: enable 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sdin_hex(&mut self) -> SPI_MEM_SDIN_HEX_W<SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDIN_HEX_W::new(self, 26)
    }
    #[doc = "Bit 27 - For SPI0 external RAM , dout phase apply 16 signals. 1: enable 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_sdout_hex(&mut self) -> SPI_MEM_SDOUT_HEX_W<SPI_MEM_SRAM_CMD_SPEC> {
    ...
    pub fn spi_smem_dqs_ie_always_on(
        &mut self,
    ) -> SPI_SMEM_DQS_IE_ALWAYS_ON_W<SPI_MEM_SRAM_CMD_SPEC> {
    ...
    pub fn spi_smem_data_ie_always_on(
        &mut self,
    ) -> SPI_SMEM_DATA_IE_ALWAYS_ON_W<SPI_MEM_SRAM_CMD_SPEC> {
