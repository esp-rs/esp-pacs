...
///Field `DIN4_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type DIN4_NUM_R = crate::FieldReader;
///Field `DIN4_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type DIN4_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DIN5_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type DIN5_NUM_R = crate::FieldReader;
///Field `DIN5_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type DIN5_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DIN6_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type DIN6_NUM_R = crate::FieldReader;
///Field `DIN6_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type DIN6_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DIN7_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type DIN7_NUM_R = crate::FieldReader;
///Field `DIN7_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type DIN7_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DINS_NUM` reader - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
pub type DINS_NUM_R = crate::FieldReader;
///Field `DINS_NUM` writer - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,...
