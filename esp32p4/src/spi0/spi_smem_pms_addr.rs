...
///Field `S` reader - SPI1 external RAM PMS section %s start address value
pub type S_R = crate::FieldReader<u32>;
///Field `S` writer - SPI1 external RAM PMS section %s start address value
pub type S_W<'a, REG> = crate::FieldWriter<'a, REG, 27, u32>;
impl R {
    ///Bits 0:26 - SPI1 external RAM PMS section %s start address value
    #[inline(always)]
    pub fn s(&self) -> S_R {
