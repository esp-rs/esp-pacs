...
///Field `ECC_ERR` writer - The enable bit for SPI_MEM_ECC_ERR_INT interrupt.
...
///Field `AXI_WR_FLASH_ERR` writer - The enable bit for SPI_MEM_AXI_WR_FALSH_ERR_INT interrupt.
...
///Field `AXI_WADDR_ERR_INT__ENA` writer - The enable bit for SPI_MEM_AXI_WADDR_ERR_INT interrupt.
pub type AXI_WADDR_ERR_INT__ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DQS0_AFIFO_OVF` reader - The enable bit for SPI_MEM_DQS0_AFIFO_OVF_INT interrupt.
pub type DQS0_AFIFO_OVF_R = crate::BitReader;
///Field `DQS0_AFIFO_OVF` writer - The enable bit for SPI_MEM_DQS0_AFIFO_OVF_INT interrupt.
pub type DQS0_AFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DQS1_AFIFO_OVF` reader - The enable bit for SPI_MEM_DQS1_AFIFO_OVF_INT interrupt.
pub type DQS1_AFIFO_OVF_R = crate::BitReader;
///Field `DQS1_AFIFO_OVF` writer - The enable bit for SPI_MEM_DQS1_AFIFO_OVF_INT interrupt.
pub type DQS1_AFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BUS_FIFO1_UDF` reader - The enable bit for SPI_MEM_BUS_FIFO1_UDF_INT interrupt.
pub type BUS_FIFO1_UDF_R = crate::BitReader;
///Field `BUS_FIFO1_UDF` writer - The enable bit for SPI_MEM_BUS_FIFO1_UDF_INT interrupt.
pub type BUS_FIFO1_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BUS_FIFO0_UDF` reader - The enable bit for SPI_MEM_BUS_FIFO0_UDF_INT interrupt.
pub type BUS_FIFO0_UDF_R = crate::BitReader;
///Field `BUS_FIFO0_UDF` writer - The enable bit for SPI_MEM_BUS_FIFO0_UDF_INT interrupt.
...
impl R {
    ...
    ///Bit 28 - The enable bit for SPI_MEM_DQS0_AFIFO_OVF_INT interrupt.
    #[inline(always)]
    pub fn dqs0_afifo_ovf(&self) -> DQS0_AFIFO_OVF_R {
        DQS0_AFIFO_OVF_R::new(((self.bits >> 28) & 1) != 0)
    }
    ///Bit 29 - The enable bit for SPI_MEM_DQS1_AFIFO_OVF_INT interrupt.
    #[inline(always)]
    pub fn dqs1_afifo_ovf(&self) -> DQS1_AFIFO_OVF_R {
        DQS1_AFIFO_OVF_R::new(((self.bits >> 29) & 1) != 0)
    }
    ///Bit 30 - The enable bit for SPI_MEM_BUS_FIFO1_UDF_INT interrupt.
    #[inline(always)]
    pub fn bus_fifo1_udf(&self) -> BUS_FIFO1_UDF_R {
        BUS_FIFO1_UDF_R::new(((self.bits >> 30) & 1) != 0)
    }
    ///Bit 31 - The enable bit for SPI_MEM_BUS_FIFO0_UDF_INT interrupt.
    #[inline(always)]
