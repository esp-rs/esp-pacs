...
///Field `FSUB_PIN` reader - For SPI0, flash is connected to SUBPINs.
pub type FSUB_PIN_R = crate::BitReader;
///Field `FSUB_PIN` writer - For SPI0, flash is connected to SUBPINs.
pub type FSUB_PIN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SSUB_PIN` reader - For SPI0, sram is connected to SUBPINs.
pub type SSUB_PIN_R = crate::BitReader;
///Field `SSUB_PIN` writer - For SPI0, sram is connected to SUBPINs.
pub type SSUB_PIN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CK_IDLE_EDGE` reader - 1: SPI_CLK line is high when idle 0: spi clk line is low when idle
pub type CK_IDLE_EDGE_R = crate::BitReader;
///Field `CK_IDLE_EDGE` writer - 1: SPI_CLK line is high when idle 0: spi clk line is low when idle
