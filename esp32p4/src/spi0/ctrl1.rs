...
///Field `SPI_AR_SIZE0_1_SUPPORT_EN` reader - 1: MSPI supports ARSIZE 0~3. When ARSIZE =0~2, MSPI read address is 4*n and reply the real AXI read data back. 0: When ARSIZE 0~1, MSPI reply SLV_ERR.
pub type SPI_AR_SIZE0_1_SUPPORT_EN_R = crate::BitReader;
///Field `SPI_AR_SIZE0_1_SUPPORT_EN` writer - 1: MSPI supports ARSIZE 0~3. When ARSIZE =0~2, MSPI read address is 4*n and reply the real AXI read data back. 0: When ARSIZE 0~1, MSPI reply SLV_ERR.
pub type SPI_AR_SIZE0_1_SUPPORT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_AW_SIZE0_1_SUPPORT_EN` reader - 1: MSPI supports AWSIZE 0~3. 0: When AWSIZE 0~1, MSPI reply SLV_ERR.
pub type SPI_AW_SIZE0_1_SUPPORT_EN_R = crate::BitReader;
///Field `SPI_AW_SIZE0_1_SUPPORT_EN` writer - 1: MSPI supports AWSIZE 0~3. 0: When AWSIZE 0~1, MSPI reply SLV_ERR.
pub type SPI_AW_SIZE0_1_SUPPORT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_AXI_RDATA_BACK_FAST` reader - 1: Reply AXI read data to AXI bus when one AXI read beat data is available. 0: Reply AXI read data to AXI bus when all the read data is available.
pub type SPI_AXI_RDATA_BACK_FAST_R = crate::BitReader;
///Field `SPI_AXI_RDATA_BACK_FAST` writer - 1: Reply AXI read data to AXI bus when one AXI read beat data is available. 0: Reply AXI read data to AXI bus when all the read data is available.
pub type SPI_AXI_RDATA_BACK_FAST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RRESP_ECC_ERR_EN` reader - 1: RRESP is SLV_ERR when there is a ECC error in AXI read data. 0: RRESP is OKAY when there is a ECC error in AXI read data. The ECC error information is recorded in SPI_MEM_ECC_ERR_ADDR_REG.
pub type RRESP_ECC_ERR_EN_R = crate::BitReader;
///Field `RRESP_ECC_ERR_EN` writer - 1: RRESP is SLV_ERR when there is a ECC error in AXI read data. 0: RRESP is OKAY when there is a ECC error in AXI read data. The ECC error information is recorded in SPI_MEM_ECC_ERR_ADDR_REG.
pub type RRESP_ECC_ERR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AR_SPLICE_EN` reader - Set this bit to enable AXI Read Splice-transfer.
pub type AR_SPLICE_EN_R = crate::BitReader;
///Field `AR_SPLICE_EN` writer - Set this bit to enable AXI Read Splice-transfer.
pub type AR_SPLICE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AW_SPLICE_EN` reader - Set this bit to enable AXI Write Splice-transfer.
pub type AW_SPLICE_EN_R = crate::BitReader;
///Field `AW_SPLICE_EN` writer - Set this bit to enable AXI Write Splice-transfer.
pub type AW_SPLICE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RAM0_EN` reader - When SPI_MEM_DUAL_RAM_EN is 0 and SPI_MEM_RAM0_EN is 1, only EXT_RAM0 will be accessed. When SPI_MEM_DUAL_RAM_EN is 0 and SPI_MEM_RAM0_EN is 0, only EXT_RAM1 will be accessed. When SPI_MEM_DUAL_RAM_EN is 1, EXT_RAM0 and EXT_RAM1 will be accessed at the same time.
pub type RAM0_EN_R = crate::BitReader;
///Field `DUAL_RAM_EN` reader - Set this bit to enable DUAL-RAM mode, EXT_RAM0 and EXT_RAM1 will be accessed at the same time.
pub type DUAL_RAM_EN_R = crate::BitReader;
///Field `FAST_WRITE_EN` reader - Set this bit to write data faster, do not wait write data has been stored in tx_bus_fifo_l2. It will wait 4*T_clk_ctrl to insure the write data has been stored in tx_bus_fifo_l2.
pub type FAST_WRITE_EN_R = crate::BitReader;
///Field `FAST_WRITE_EN` writer - Set this bit to write data faster, do not wait write data has been stored in tx_bus_fifo_l2. It will wait 4*T_clk_ctrl to insure the write data has been stored in tx_bus_fifo_l2.
pub type FAST_WRITE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_RST` writer - The synchronous reset signal for SPI0 RX AFIFO and all the AES_MSPI SYNC FIFO to receive signals from AXI. Set this bit to reset these FIFO.
pub type RXFIFO_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_RST` writer - The synchronous reset signal for SPI0 TX AFIFO and all the AES_MSPI SYNC FIFO to send signals to AXI. Set this bit to reset these FIFO.
