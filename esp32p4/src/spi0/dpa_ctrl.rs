///Register `DPA_CTRL` reader
pub type R = crate::R<DPA_CTRL_SPEC>;
///Register `DPA_CTRL` writer
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_crypt_security_level(&mut self) -> SPI_CRYPT_SECURITY_LEVEL_W<DPA_CTRL_SPEC> {
        SPI_CRYPT_SECURITY_LEVEL_W::new(self, 0)
    }
    ///Bit 3 - Only available when SPI_CRYPT_SECURITY_LEVEL is not 0. 1: Enable DPA in the calculation that using key 1 or key 2. 0: Enable DPA only in the calculation that using key 1.
    #[inline(always)]
    #[must_use]
    pub fn spi_crypt_calc_d_dpa_en(&mut self) -> SPI_CRYPT_CALC_D_DPA_EN_W<DPA_CTRL_SPEC> {
    ...
    pub fn spi_crypt_dpa_select_register(
        &mut self,
    ) -> SPI_CRYPT_DPA_SELECT_REGISTER_W<DPA_CTRL_SPEC> {
        SPI_CRYPT_DPA_SELECT_REGISTER_W::new(self, 4)
    }
}
/**SPI memory cryption DPA register

You can [`read`](crate::generic::Reg::read) this register and get [`dpa_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dpa_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DPA_CTRL_SPEC;
impl crate::RegisterSpec for DPA_CTRL_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dpa_ctrl::R`](R) reader structure
impl crate::Readable for DPA_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dpa_ctrl::W`](W) writer structure
