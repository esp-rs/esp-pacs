...
///Field `SPI_SMEM_PMS_RD_ATTR` reader - 1: SPI1 external RAM PMS section %s read accessible. 0: Not allowed.
pub type SPI_SMEM_PMS_RD_ATTR_R = crate::BitReader;
///Field `SPI_SMEM_PMS_RD_ATTR` writer - 1: SPI1 external RAM PMS section %s read accessible. 0: Not allowed.
pub type SPI_SMEM_PMS_RD_ATTR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_PMS_WR_ATTR` reader - 1: SPI1 external RAM PMS section %s write accessible. 0: Not allowed.
pub type SPI_SMEM_PMS_WR_ATTR_R = crate::BitReader;
///Field `SPI_SMEM_PMS_WR_ATTR` writer - 1: SPI1 external RAM PMS section %s write accessible. 0: Not allowed.
pub type SPI_SMEM_PMS_WR_ATTR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_PMS_ECC` reader - SPI1 external RAM PMS section %s ECC mode, 1: enable ECC mode. 0: Disable it. The external RAM PMS section %s is configured by registers SPI_SMEM_PMS%s_ADDR_REG and SPI_SMEM_PMS%s_SIZE_REG.
pub type SPI_SMEM_PMS_ECC_R = crate::BitReader;
///Field `SPI_SMEM_PMS_ECC` writer - SPI1 external RAM PMS section %s ECC mode, 1: enable ECC mode. 0: Disable it. The external RAM PMS section %s is configured by registers SPI_SMEM_PMS%s_ADDR_REG and SPI_SMEM_PMS%s_SIZE_REG.
pub type SPI_SMEM_PMS_ECC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - 1: SPI1 external RAM PMS section %s read accessible. 0: Not allowed.
    #[inline(always)]
    pub fn spi_smem_pms_rd_attr(&self) -> SPI_SMEM_PMS_RD_ATTR_R {
        SPI_SMEM_PMS_RD_ATTR_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - 1: SPI1 external RAM PMS section %s write accessible. 0: Not allowed.
    #[inline(always)]
    pub fn spi_smem_pms_wr_attr(&self) -> SPI_SMEM_PMS_WR_ATTR_R {
        SPI_SMEM_PMS_WR_ATTR_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - SPI1 external RAM PMS section %s ECC mode, 1: enable ECC mode. 0: Disable it. The external RAM PMS section %s is configured by registers SPI_SMEM_PMS%s_ADDR_REG and SPI_SMEM_PMS%s_SIZE_REG.
    #[inline(always)]
