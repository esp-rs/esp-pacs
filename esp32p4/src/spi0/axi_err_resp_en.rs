///Register `AXI_ERR_RESP_EN` reader
pub type R = crate::R<AXI_ERR_RESP_EN_SPEC>;
///Register `AXI_ERR_RESP_EN` writer
pub type W = crate::W<AXI_ERR_RESP_EN_SPEC>;
///Field `AW_RESP_EN_MMU_VLD` reader - Set this bit to enable AXI response function for mmu valid err in axi write trans.
pub type AW_RESP_EN_MMU_VLD_R = crate::BitReader;
///Field `AW_RESP_EN_MMU_VLD` writer - Set this bit to enable AXI response function for mmu valid err in axi write trans.
pub type AW_RESP_EN_MMU_VLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AW_RESP_EN_MMU_GID` reader - Set this bit to enable AXI response function for mmu gid err in axi write trans.
pub type AW_RESP_EN_MMU_GID_R = crate::BitReader;
///Field `AW_RESP_EN_MMU_GID` writer - Set this bit to enable AXI response function for mmu gid err in axi write trans.
pub type AW_RESP_EN_MMU_GID_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AW_RESP_EN_AXI_SIZE` reader - Set this bit to enable AXI response function for axi size err in axi write trans.
pub type AW_RESP_EN_AXI_SIZE_R = crate::BitReader;
///Field `AW_RESP_EN_AXI_SIZE` writer - Set this bit to enable AXI response function for axi size err in axi write trans.
pub type AW_RESP_EN_AXI_SIZE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AW_RESP_EN_AXI_FLASH` reader - Set this bit to enable AXI response function for axi flash err in axi write trans.
pub type AW_RESP_EN_AXI_FLASH_R = crate::BitReader;
///Field `AW_RESP_EN_AXI_FLASH` writer - Set this bit to enable AXI response function for axi flash err in axi write trans.
pub type AW_RESP_EN_AXI_FLASH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AW_RESP_EN_MMU_ECC` reader - Set this bit to enable AXI response function for mmu ecc err in axi write trans.
pub type AW_RESP_EN_MMU_ECC_R = crate::BitReader;
///Field `AW_RESP_EN_MMU_ECC` writer - Set this bit to enable AXI response function for mmu ecc err in axi write trans.
pub type AW_RESP_EN_MMU_ECC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AW_RESP_EN_MMU_SENS` reader - Set this bit to enable AXI response function for mmu sens in err axi write trans.
pub type AW_RESP_EN_MMU_SENS_R = crate::BitReader;
///Field `AW_RESP_EN_MMU_SENS` writer - Set this bit to enable AXI response function for mmu sens in err axi write trans.
pub type AW_RESP_EN_MMU_SENS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AW_RESP_EN_AXI_WSTRB` reader - Set this bit to enable AXI response function for axi wstrb err in axi write trans.
pub type AW_RESP_EN_AXI_WSTRB_R = crate::BitReader;
///Field `AW_RESP_EN_AXI_WSTRB` writer - Set this bit to enable AXI response function for axi wstrb err in axi write trans.
pub type AW_RESP_EN_AXI_WSTRB_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AR_RESP_EN_MMU_VLD` reader - Set this bit to enable AXI response function for mmu valid err in axi read trans.
pub type AR_RESP_EN_MMU_VLD_R = crate::BitReader;
///Field `AR_RESP_EN_MMU_VLD` writer - Set this bit to enable AXI response function for mmu valid err in axi read trans.
pub type AR_RESP_EN_MMU_VLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AR_RESP_EN_MMU_GID` reader - Set this bit to enable AXI response function for mmu gid err in axi read trans.
pub type AR_RESP_EN_MMU_GID_R = crate::BitReader;
///Field `AR_RESP_EN_MMU_GID` writer - Set this bit to enable AXI response function for mmu gid err in axi read trans.
pub type AR_RESP_EN_MMU_GID_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AR_RESP_EN_MMU_ECC` reader - Set this bit to enable AXI response function for mmu ecc err in axi read trans.
pub type AR_RESP_EN_MMU_ECC_R = crate::BitReader;
///Field `AR_RESP_EN_MMU_ECC` writer - Set this bit to enable AXI response function for mmu ecc err in axi read trans.
pub type AR_RESP_EN_MMU_ECC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AR_RESP_EN_MMU_SENS` reader - Set this bit to enable AXI response function for mmu sensitive err in axi read trans.
pub type AR_RESP_EN_MMU_SENS_R = crate::BitReader;
///Field `AR_RESP_EN_MMU_SENS` writer - Set this bit to enable AXI response function for mmu sensitive err in axi read trans.
pub type AR_RESP_EN_MMU_SENS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AR_RESP_EN_AXI_SIZE` reader - Set this bit to enable AXI response function for axi size err in axi read trans.
pub type AR_RESP_EN_AXI_SIZE_R = crate::BitReader;
///Field `AR_RESP_EN_AXI_SIZE` writer - Set this bit to enable AXI response function for axi size err in axi read trans.
pub type AR_RESP_EN_AXI_SIZE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit to enable AXI response function for mmu valid err in axi write trans.
    #[inline(always)]
    pub fn aw_resp_en_mmu_vld(&self) -> AW_RESP_EN_MMU_VLD_R {
        AW_RESP_EN_MMU_VLD_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set this bit to enable AXI response function for mmu gid err in axi write trans.
    #[inline(always)]
    ...
    ///Bit 8 - Set this bit to enable AXI response function for mmu gid err in axi read trans.
    #[inline(always)]
    pub fn ar_resp_en_mmu_gid(&self) -> AR_RESP_EN_MMU_GID_R {
        AR_RESP_EN_MMU_GID_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Set this bit to enable AXI response function for mmu ecc err in axi read trans.
    #[inline(always)]
...
///`read()` method returns [`axi_err_resp_en::R`](R) reader structure
impl crate::Readable for AXI_ERR_RESP_EN_SPEC {}
///`write(|w| ..)` method takes [`axi_err_resp_en::W`](W) writer structure
impl crate::Writable for AXI_ERR_RESP_EN_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets AXI_ERR_RESP_EN to value 0
