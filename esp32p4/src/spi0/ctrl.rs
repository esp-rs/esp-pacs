...
///Field `WDUMMY_DQS_ALWAYS_OUT` reader - In the dummy phase of an MSPI write data transfer when accesses to flash, the level of SPI_DQS is output by the MSPI controller.
pub type WDUMMY_DQS_ALWAYS_OUT_R = crate::BitReader;
///Field `WDUMMY_DQS_ALWAYS_OUT` writer - In the dummy phase of an MSPI write data transfer when accesses to flash, the level of SPI_DQS is output by the MSPI controller.
pub type WDUMMY_DQS_ALWAYS_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDUMMY_ALWAYS_OUT` reader - In the dummy phase of an MSPI write data transfer when accesses to flash, the level of SPI_IO\[7:0\] is output by the MSPI controller.
pub type WDUMMY_ALWAYS_OUT_R = crate::BitReader;
///Field `WDUMMY_ALWAYS_OUT` writer - In the dummy phase of an MSPI write data transfer when accesses to flash, the level of SPI_IO\[7:0\] is output by the MSPI controller.
pub type WDUMMY_ALWAYS_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FDUMMY_RIN` reader - In an MSPI read data transfer when accesses to flash, the level of SPI_IO\[7:0\] is output by the MSPI controller in the first half part of dummy phase. It is used to mask invalid SPI_DQS in the half part of dummy phase.
pub type FDUMMY_RIN_R = crate::BitReader;
///Field `FDUMMY_RIN` writer - In an MSPI read data transfer when accesses to flash, the level of SPI_IO\[7:0\] is output by the MSPI controller in the first half part of dummy phase. It is used to mask invalid SPI_DQS in the half part of dummy phase.
pub type FDUMMY_RIN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FDUMMY_WOUT` reader - In an MSPI write data transfer when accesses to flash, the level of SPI_IO\[7:0\] is output by the MSPI controller in the second half part of dummy phase. It is used to pre-drive flash.
pub type FDUMMY_WOUT_R = crate::BitReader;
///Field `FDUMMY_WOUT` writer - In an MSPI write data transfer when accesses to flash, the level of SPI_IO\[7:0\] is output by the MSPI controller in the second half part of dummy phase. It is used to pre-drive flash.
...
///Field `FDOUT_OCT` writer - Apply 8 signals during write-data phase 1:enable 0: disable
...
///Field `FDIN_OCT` writer - Apply 8 signals during read-data phase 1:enable 0: disable
...
///Field `FADDR_OCT` writer - Apply 8 signals during address phase 1:enable 0: disable
...
///Field `FCMD_OCT` writer - Apply 8 signals during command phase 1:enable 0: disable
...
///Field `DQS_IE_ALWAYS_ON` reader - When accesses to flash, 1: the IE signals of pads connected to SPI_DQS are always 1. 0: Others.
pub type DQS_IE_ALWAYS_ON_R = crate::BitReader;
///Field `DQS_IE_ALWAYS_ON` writer - When accesses to flash, 1: the IE signals of pads connected to SPI_DQS are always 1. 0: Others.
pub type DQS_IE_ALWAYS_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DATA_IE_ALWAYS_ON` reader - When accesses to flash, 1: the IE signals of pads connected to SPI_IO\[7:0\] are always 1. 0: Others.
pub type DATA_IE_ALWAYS_ON_R = crate::BitReader;
///Field `DATA_IE_ALWAYS_ON` writer - When accesses to flash, 1: the IE signals of pads connected to SPI_IO\[7:0\] are always 1. 0: Others.
