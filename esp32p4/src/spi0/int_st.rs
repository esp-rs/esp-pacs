...
///Field `PMS_REJECT` reader - The status bit for SPI_MEM_PMS_REJECT_INT interrupt.
...
///Field `AXI_WADDR_ERR` reader - The enable bit for SPI_MEM_AXI_WADDR_ERR_INT interrupt.
pub type AXI_WADDR_ERR_R = crate::BitReader;
///Field `DQS0_AFIFO_OVF` reader - The status bit for SPI_MEM_DQS0_AFIFO_OVF_INT interrupt.
pub type DQS0_AFIFO_OVF_R = crate::BitReader;
///Field `DQS1_AFIFO_OVF` reader - The status bit for SPI_MEM_DQS1_AFIFO_OVF_INT interrupt.
pub type DQS1_AFIFO_OVF_R = crate::BitReader;
///Field `BUS_FIFO1_UDF` reader - The status bit for SPI_MEM_BUS_FIFO1_UDF_INT interrupt.
pub type BUS_FIFO1_UDF_R = crate::BitReader;
///Field `BUS_FIFO0_UDF` reader - The status bit for SPI_MEM_BUS_FIFO0_UDF_INT interrupt.
...
impl R {
    ...
    ///Bit 28 - The status bit for SPI_MEM_DQS0_AFIFO_OVF_INT interrupt.
    #[inline(always)]
    pub fn dqs0_afifo_ovf(&self) -> DQS0_AFIFO_OVF_R {
        DQS0_AFIFO_OVF_R::new(((self.bits >> 28) & 1) != 0)
    }
    ///Bit 29 - The status bit for SPI_MEM_DQS1_AFIFO_OVF_INT interrupt.
    #[inline(always)]
    pub fn dqs1_afifo_ovf(&self) -> DQS1_AFIFO_OVF_R {
        DQS1_AFIFO_OVF_R::new(((self.bits >> 29) & 1) != 0)
    }
    ///Bit 30 - The status bit for SPI_MEM_BUS_FIFO1_UDF_INT interrupt.
    #[inline(always)]
    pub fn bus_fifo1_udf(&self) -> BUS_FIFO1_UDF_R {
        BUS_FIFO1_UDF_R::new(((self.bits >> 30) & 1) != 0)
    }
    ///Bit 31 - The status bit for SPI_MEM_BUS_FIFO0_UDF_INT interrupt.
    #[inline(always)]
