...
///Field `AXI_REQ_EN` reader - For SPI0, AXI master access enable, 1: enable, 0:disable.
pub type AXI_REQ_EN_R = crate::BitReader;
///Field `AXI_REQ_EN` writer - For SPI0, AXI master access enable, 1: enable, 0:disable.
...
///Field `SPI_SAME_AW_AR_ADDR_CHK_EN` writer - Set this bit to check AXI read/write the same address region.
