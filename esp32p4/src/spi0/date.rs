...
///Field `DATE` reader - SPI0 register version.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - SPI0 register version.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - SPI0 register version.
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x0230_3100
