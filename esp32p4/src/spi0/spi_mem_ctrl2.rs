...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_ecc_cs_hold_time(&mut self) -> SPI_MEM_ECC_CS_HOLD_TIME_W<SPI_MEM_CTRL2_SPEC> {
    ...
    pub fn spi_mem_ecc_skip_page_corner(
        &mut self,
    ) -> SPI_MEM_ECC_SKIP_PAGE_CORNER_W<SPI_MEM_CTRL2_SPEC> {
    ...
    pub fn spi_mem_ecc_16to18_byte_en(
        &mut self,
    ) -> SPI_MEM_ECC_16TO18_BYTE_EN_W<SPI_MEM_CTRL2_SPEC> {
        SPI_MEM_ECC_16TO18_BYTE_EN_W::new(self, 14)
    }
    #[doc = "Bit 24 - Set this bit to enable SPI0 split one AXI read flash transfer into two SPI transfers when one transfer will cross flash or EXT_RAM page corner, valid no matter whether there is an ECC region or not."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_split_trans_en(&mut self) -> SPI_MEM_SPLIT_TRANS_EN_W<SPI_MEM_CTRL2_SPEC> {
...
#[doc = "`reset()` method sets SPI_MEM_CTRL2 to value 0x0100_2c21"]
impl crate::Resettable for SPI_MEM_CTRL2_SPEC {
    const RESET_VALUE: Self::Ux = 0x0100_2c21;
}
