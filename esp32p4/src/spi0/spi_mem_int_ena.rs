    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_INT_ENA")
            ...
            .field(
                ...
                &format_args!("{}", self.spi_mem_dqs0_afifo_ovf_int_ena().bit()),
            )
            .field(
                "spi_mem_dqs1_afifo_ovf_int_ena",
                &format_args!("{}", self.spi_mem_dqs1_afifo_ovf_int_ena().bit()),
            )
            .field(
                "spi_mem_bus_fifo1_udf_int_ena",
                &format_args!("{}", self.spi_mem_bus_fifo1_udf_int_ena().bit()),
            )
            .field(
                "spi_mem_bus_fifo0_udf_int_ena",
                &format_args!("{}", self.spi_mem_bus_fifo0_udf_int_ena().bit()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_ecc_err_int_ena(&mut self) -> SPI_MEM_ECC_ERR_INT_ENA_W<SPI_MEM_INT_ENA_SPEC> {
    ...
    pub fn spi_mem_axi_wr_flash_err_int_ena(
        &mut self,
    ) -> SPI_MEM_AXI_WR_FLASH_ERR_INT_ENA_W<SPI_MEM_INT_ENA_SPEC> {
    ...
    pub fn spi_mem_axi_waddr_err_int__ena(
        &mut self,
    ) -> SPI_MEM_AXI_WADDR_ERR_INT__ENA_W<SPI_MEM_INT_ENA_SPEC> {
    ...
    pub fn spi_mem_dqs0_afifo_ovf_int_ena(
        &mut self,
    ) -> SPI_MEM_DQS0_AFIFO_OVF_INT_ENA_W<SPI_MEM_INT_ENA_SPEC> {
    ...
    pub fn spi_mem_dqs1_afifo_ovf_int_ena(
        &mut self,
    ) -> SPI_MEM_DQS1_AFIFO_OVF_INT_ENA_W<SPI_MEM_INT_ENA_SPEC> {
    ...
    pub fn spi_mem_bus_fifo1_udf_int_ena(
        &mut self,
    ) -> SPI_MEM_BUS_FIFO1_UDF_INT_ENA_W<SPI_MEM_INT_ENA_SPEC> {
    ...
    pub fn spi_mem_bus_fifo0_udf_int_ena(
        &mut self,
    ) -> SPI_MEM_BUS_FIFO0_UDF_INT_ENA_W<SPI_MEM_INT_ENA_SPEC> {
