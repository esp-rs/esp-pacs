...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mmu_item_index(&mut self) -> SPI_MMU_ITEM_INDEX_W<MMU_ITEM_INDEX_SPEC> {
        SPI_MMU_ITEM_INDEX_W::new(self, 0)
    }
}
/**MSPI-MMU item index register

You can [`read`](crate::generic::Reg::read) this register and get [`mmu_item_index::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mmu_item_index::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct MMU_ITEM_INDEX_SPEC;
impl crate::RegisterSpec for MMU_ITEM_INDEX_SPEC {
    type Ux = u32;
}
///`read()` method returns [`mmu_item_index::R`](R) reader structure
impl crate::Readable for MMU_ITEM_INDEX_SPEC {}
///`write(|w| ..)` method takes [`mmu_item_index::W`](W) writer structure
