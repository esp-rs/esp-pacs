    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_INT_ST")
            ...
            .field(
                ...
                &format_args!("{}", self.spi_mem_dqs0_afifo_ovf_int_st().bit()),
            )
            .field(
                "spi_mem_dqs1_afifo_ovf_int_st",
                &format_args!("{}", self.spi_mem_dqs1_afifo_ovf_int_st().bit()),
            )
            .field(
                "spi_mem_bus_fifo1_udf_int_st",
                &format_args!("{}", self.spi_mem_bus_fifo1_udf_int_st().bit()),
            )
            .field(
                "spi_mem_bus_fifo0_udf_int_st",
                &format_args!("{}", self.spi_mem_bus_fifo0_udf_int_st().bit()),
            )
            .finish()
    }
}
...
#[doc = "SPI0 interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spi_mem_int_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
