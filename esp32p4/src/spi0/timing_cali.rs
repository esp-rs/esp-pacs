...
#[doc = "Field `DLL_TIMING_CALI` reader - Set this bit to enable DLL for timing calibration in DDR mode when accessed to flash."]
pub type DLL_TIMING_CALI_R = crate::BitReader;
#[doc = "Field `DLL_TIMING_CALI` writer - Set this bit to enable DLL for timing calibration in DDR mode when accessed to flash."]
