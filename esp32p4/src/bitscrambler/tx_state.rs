///Register `TX_STATE` reader
pub type R = crate::R<TX_STATE_SPEC>;
///Register `TX_STATE` writer
pub type W = crate::W<TX_STATE_SPEC>;
///Field `TX_IN_IDLE` reader - represents the bitscrambler tx core in halt mode
pub type TX_IN_IDLE_R = crate::BitReader;
///Field `TX_IN_RUN` reader - represents the bitscrambler tx core in run mode
pub type TX_IN_RUN_R = crate::BitReader;
///Field `TX_IN_WAIT` reader - represents the bitscrambler tx core in wait mode to wait write back done
pub type TX_IN_WAIT_R = crate::BitReader;
///Field `TX_IN_PAUSE` reader - represents the bitscrambler tx core in pause mode
pub type TX_IN_PAUSE_R = crate::BitReader;
///Field `TX_FIFO_EMPTY` reader - represents the bitscrambler tx fifo in empty state
pub type TX_FIFO_EMPTY_R = crate::BitReader;
///Field `TX_EOF_GET_CNT` reader - represents the bytes numbers of bitscrambler tx core when get EOF
pub type TX_EOF_GET_CNT_R = crate::FieldReader<u16>;
///Field `TX_EOF_OVERLOAD` reader - represents the some EOFs will be lost for bitscrambler tx core
pub type TX_EOF_OVERLOAD_R = crate::BitReader;
///Field `TX_EOF_TRACE_CLR` writer - write this bit to clear reg_bitscrambler_tx_eof_overload and reg_bitscrambler_tx_eof_get_cnt registers
pub type TX_EOF_TRACE_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - represents the bitscrambler tx core in halt mode
    #[inline(always)]
    pub fn tx_in_idle(&self) -> TX_IN_IDLE_R {
        TX_IN_IDLE_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - represents the bitscrambler tx core in run mode
    #[inline(always)]
    pub fn tx_in_run(&self) -> TX_IN_RUN_R {
        TX_IN_RUN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - represents the bitscrambler tx core in wait mode to wait write back done
    #[inline(always)]
    pub fn tx_in_wait(&self) -> TX_IN_WAIT_R {
        TX_IN_WAIT_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - represents the bitscrambler tx core in pause mode
    #[inline(always)]
    pub fn tx_in_pause(&self) -> TX_IN_PAUSE_R {
        TX_IN_PAUSE_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - represents the bitscrambler tx fifo in empty state
    #[inline(always)]
    pub fn tx_fifo_empty(&self) -> TX_FIFO_EMPTY_R {
        TX_FIFO_EMPTY_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bits 16:29 - represents the bytes numbers of bitscrambler tx core when get EOF
    #[inline(always)]
    pub fn tx_eof_get_cnt(&self) -> TX_EOF_GET_CNT_R {
        TX_EOF_GET_CNT_R::new(((self.bits >> 16) & 0x3fff) as u16)
    }
    ///Bit 30 - represents the some EOFs will be lost for bitscrambler tx core
    #[inline(always)]
...
impl W {
    ///Bit 31 - write this bit to clear reg_bitscrambler_tx_eof_overload and reg_bitscrambler_tx_eof_get_cnt registers
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`tx_state::R`](R) reader structure
impl crate::Readable for TX_STATE_SPEC {}
///`write(|w| ..)` method takes [`tx_state::W`](W) writer structure
