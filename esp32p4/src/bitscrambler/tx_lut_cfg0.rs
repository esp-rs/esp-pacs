///Register `TX_LUT_CFG0` reader
pub type R = crate::R<TX_LUT_CFG0_SPEC>;
///Register `TX_LUT_CFG0` writer
pub type W = crate::W<TX_LUT_CFG0_SPEC>;
///Field `TX_LUT_IDX` reader - write this bits to specify the bytes position of LUT RAM based on reg_bitscrambler_tx_lut_mode
pub type TX_LUT_IDX_R = crate::FieldReader<u16>;
///Field `TX_LUT_IDX` writer - write this bits to specify the bytes position of LUT RAM based on reg_bitscrambler_tx_lut_mode
pub type TX_LUT_IDX_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `TX_LUT_MODE` reader - write this bits to specify the bytes mode of LUT RAM, 0: 1 byte,1: 2bytes, 2: 4 bytes
pub type TX_LUT_MODE_R = crate::FieldReader;
///Field `TX_LUT_MODE` writer - write this bits to specify the bytes mode of LUT RAM, 0: 1 byte,1: 2bytes, 2: 4 bytes
pub type TX_LUT_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:10 - write this bits to specify the bytes position of LUT RAM based on reg_bitscrambler_tx_lut_mode
    #[inline(always)]
    pub fn tx_lut_idx(&self) -> TX_LUT_IDX_R {
        TX_LUT_IDX_R::new((self.bits & 0x07ff) as u16)
    }
    ///Bits 11:12 - write this bits to specify the bytes mode of LUT RAM, 0: 1 byte,1: 2bytes, 2: 4 bytes
    #[inline(always)]
...
///`read()` method returns [`tx_lut_cfg0::R`](R) reader structure
impl crate::Readable for TX_LUT_CFG0_SPEC {}
///`write(|w| ..)` method takes [`tx_lut_cfg0::W`](W) writer structure
