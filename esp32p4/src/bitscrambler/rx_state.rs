///Register `RX_STATE` reader
pub type R = crate::R<RX_STATE_SPEC>;
///Register `RX_STATE` writer
pub type W = crate::W<RX_STATE_SPEC>;
///Field `RX_IN_IDLE` reader - represents the bitscrambler rx core in halt mode
pub type RX_IN_IDLE_R = crate::BitReader;
///Field `RX_IN_RUN` reader - represents the bitscrambler rx core in run mode
pub type RX_IN_RUN_R = crate::BitReader;
///Field `RX_IN_WAIT` reader - represents the bitscrambler rx core in wait mode to wait write back done
pub type RX_IN_WAIT_R = crate::BitReader;
///Field `RX_IN_PAUSE` reader - represents the bitscrambler rx core in pause mode
pub type RX_IN_PAUSE_R = crate::BitReader;
///Field `RX_FIFO_FULL` reader - represents the bitscrambler rx fifo in full state
pub type RX_FIFO_FULL_R = crate::BitReader;
///Field `RX_EOF_GET_CNT` reader - represents the bytes numbers of bitscrambler rx core when get EOF
pub type RX_EOF_GET_CNT_R = crate::FieldReader<u16>;
///Field `RX_EOF_OVERLOAD` reader - represents the some EOFs will be lost for bitscrambler rx core
pub type RX_EOF_OVERLOAD_R = crate::BitReader;
///Field `RX_EOF_TRACE_CLR` writer - write this bit to clear reg_bitscrambler_rx_eof_overload and reg_bitscrambler_rx_eof_get_cnt registers
pub type RX_EOF_TRACE_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - represents the bitscrambler rx core in halt mode
    #[inline(always)]
    pub fn rx_in_idle(&self) -> RX_IN_IDLE_R {
        RX_IN_IDLE_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - represents the bitscrambler rx core in run mode
    #[inline(always)]
    pub fn rx_in_run(&self) -> RX_IN_RUN_R {
        RX_IN_RUN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - represents the bitscrambler rx core in wait mode to wait write back done
    #[inline(always)]
    pub fn rx_in_wait(&self) -> RX_IN_WAIT_R {
        RX_IN_WAIT_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - represents the bitscrambler rx core in pause mode
    #[inline(always)]
    pub fn rx_in_pause(&self) -> RX_IN_PAUSE_R {
        RX_IN_PAUSE_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - represents the bitscrambler rx fifo in full state
    #[inline(always)]
    pub fn rx_fifo_full(&self) -> RX_FIFO_FULL_R {
        RX_FIFO_FULL_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bits 16:29 - represents the bytes numbers of bitscrambler rx core when get EOF
    #[inline(always)]
    pub fn rx_eof_get_cnt(&self) -> RX_EOF_GET_CNT_R {
        RX_EOF_GET_CNT_R::new(((self.bits >> 16) & 0x3fff) as u16)
    }
    ///Bit 30 - represents the some EOFs will be lost for bitscrambler rx core
    #[inline(always)]
...
impl W {
    ///Bit 31 - write this bit to clear reg_bitscrambler_rx_eof_overload and reg_bitscrambler_rx_eof_get_cnt registers
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`rx_state::R`](R) reader structure
impl crate::Readable for RX_STATE_SPEC {}
///`write(|w| ..)` method takes [`rx_state::W`](W) writer structure
