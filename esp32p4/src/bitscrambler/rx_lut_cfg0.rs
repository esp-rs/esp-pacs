///Register `RX_LUT_CFG0` reader
pub type R = crate::R<RX_LUT_CFG0_SPEC>;
///Register `RX_LUT_CFG0` writer
pub type W = crate::W<RX_LUT_CFG0_SPEC>;
///Field `RX_LUT_IDX` reader - write this bits to specify the bytes position of LUT RAM based on reg_bitscrambler_rx_lut_mode
pub type RX_LUT_IDX_R = crate::FieldReader<u16>;
///Field `RX_LUT_IDX` writer - write this bits to specify the bytes position of LUT RAM based on reg_bitscrambler_rx_lut_mode
pub type RX_LUT_IDX_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `RX_LUT_MODE` reader - write this bits to specify the bytes mode of LUT RAM, 0: 1 byte,1: 2bytes, 2: 4 bytes
pub type RX_LUT_MODE_R = crate::FieldReader;
///Field `RX_LUT_MODE` writer - write this bits to specify the bytes mode of LUT RAM, 0: 1 byte,1: 2bytes, 2: 4 bytes
pub type RX_LUT_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:10 - write this bits to specify the bytes position of LUT RAM based on reg_bitscrambler_rx_lut_mode
    #[inline(always)]
...
///`read()` method returns [`rx_lut_cfg0::R`](R) reader structure
impl crate::Readable for RX_LUT_CFG0_SPEC {}
///`write(|w| ..)` method takes [`rx_lut_cfg0::W`](W) writer structure
