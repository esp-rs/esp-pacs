///Register `TX_TAILING_BITS` reader
pub type R = crate::R<TX_TAILING_BITS_SPEC>;
///Register `TX_TAILING_BITS` writer
pub type W = crate::W<TX_TAILING_BITS_SPEC>;
///Field `TX_TAILING_BITS` reader - write this bits to specify the extra data bit length after getting EOF
pub type TX_TAILING_BITS_R = crate::FieldReader<u16>;
///Field `TX_TAILING_BITS` writer - write this bits to specify the extra data bit length after getting EOF
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TX_TAILING_BITS")
            .field("tx_tailing_bits", &self.tx_tailing_bits())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`tx_tailing_bits::R`](R) reader structure
impl crate::Readable for TX_TAILING_BITS_SPEC {}
///`write(|w| ..)` method takes [`tx_tailing_bits::W`](W) writer structure
