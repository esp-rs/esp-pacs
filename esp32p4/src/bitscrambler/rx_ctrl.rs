...
impl W {
    ...
    ///Bit 8 - write this bit to reset the bitscrambler rx fifo
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`rx_ctrl::R`](R) reader structure
impl crate::Readable for RX_CTRL_SPEC {}
///`write(|w| ..)` method takes [`rx_ctrl::W`](W) writer structure
