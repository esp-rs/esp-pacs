///Register `RX_INST_CFG0` reader
pub type R = crate::R<RX_INST_CFG0_SPEC>;
///Register `RX_INST_CFG0` writer
pub type W = crate::W<RX_INST_CFG0_SPEC>;
///Field `RX_INST_IDX` reader - write this bits to specify the one of 8 instruction
pub type RX_INST_IDX_R = crate::FieldReader;
///Field `RX_INST_IDX` writer - write this bits to specify the one of 8 instruction
pub type RX_INST_IDX_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `RX_INST_POS` reader - write this bits to specify the bit position of 257 bit instruction which in units of 32 bits
pub type RX_INST_POS_R = crate::FieldReader;
///Field `RX_INST_POS` writer - write this bits to specify the bit position of 257 bit instruction which in units of 32 bits
...
///`read()` method returns [`rx_inst_cfg0::R`](R) reader structure
impl crate::Readable for RX_INST_CFG0_SPEC {}
///`write(|w| ..)` method takes [`rx_inst_cfg0::W`](W) writer structure
