...
///Register `TX_INST_CFG1` writer
pub type W = crate::W<TX_INST_CFG1_SPEC>;
///Field `TX_INST` reader - write this bits to update instruction which specified by BITSCRAMBLER_TX_INST_CFG0_REG, Read this bits to get instruction which specified by BITSCRAMBLER_TX_INST_CFG0_REG
pub type TX_INST_R = crate::FieldReader<u32>;
///Field `TX_INST` writer - write this bits to update instruction which specified by BITSCRAMBLER_TX_INST_CFG0_REG, Read this bits to get instruction which specified by BITSCRAMBLER_TX_INST_CFG0_REG
pub type TX_INST_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - write this bits to update instruction which specified by BITSCRAMBLER_TX_INST_CFG0_REG, Read this bits to get instruction which specified by BITSCRAMBLER_TX_INST_CFG0_REG
    #[inline(always)]
...
///`read()` method returns [`tx_inst_cfg1::R`](R) reader structure
impl crate::Readable for TX_INST_CFG1_SPEC {}
///`write(|w| ..)` method takes [`tx_inst_cfg1::W`](W) writer structure
