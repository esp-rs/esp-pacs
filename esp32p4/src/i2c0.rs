...
impl RegisterBlock {
    ...
    ///0x4c - Configures the delay between the SDA and SCL rising edge for a stop condition. Measurement unit: i2c_sclk
    #[inline(always)]
...
/**SCL_STOP_SETUP (rw) register accessor: Configures the delay between the SDA and SCL rising edge for a stop condition. Measurement unit: i2c_sclk
