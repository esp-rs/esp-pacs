...
impl RegisterBlock {
    ...
    ///0x64 - Configuration register for unit $n's step value.
    #[inline(always)]
    pub const fn u3_change_conf(&self) -> &U3_CHANGE_CONF {
        &self.u3_change_conf
    }
    ///0x68 - Configuration register for unit $n's step value.
    #[inline(always)]
    pub const fn u2_change_conf(&self) -> &U2_CHANGE_CONF {
        &self.u2_change_conf
    }
    ///0x6c - Configuration register for unit $n's step value.
    #[inline(always)]
    pub const fn u1_change_conf(&self) -> &U1_CHANGE_CONF {
        &self.u1_change_conf
    }
    ///0x70 - Configuration register for unit $n's step value.
    #[inline(always)]
...
pub mod ctrl;
/**U3_CHANGE_CONF (rw) register accessor: Configuration register for unit $n's step value.
...
/**U2_CHANGE_CONF (rw) register accessor: Configuration register for unit $n's step value.
...
/**U1_CHANGE_CONF (rw) register accessor: Configuration register for unit $n's step value.
...
/**U0_CHANGE_CONF (rw) register accessor: Configuration register for unit $n's step value.
