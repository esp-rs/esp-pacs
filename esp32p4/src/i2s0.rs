...
impl RegisterBlock {
    ...
    ///0x48 - I2S RX configure register
    #[inline(always)]
    ...
    ///0x74 - I2S sync counter register
    #[inline(always)]
    pub const fn fifo_cnt(&self) -> &FIFO_CNT {
        &self.fifo_cnt
    }
    ///0x78 - I2S sync counter register
    #[inline(always)]
    pub const fn bck_cnt(&self) -> &BCK_CNT {
        &self.bck_cnt
    }
    ///0x7c - Clock gate register
    #[inline(always)]
...
pub mod rx_conf;
/**TX_CONF (rw) register accessor: I2S TX configure register
...
pub mod rx_conf1;
/**TX_CONF1 (rw) register accessor: I2S TX configure register 1
...
pub mod tx_conf1;
/**TX_PCM2PDM_CONF (rw) register accessor: I2S TX PCM2PDM configuration register
...
/**TX_PCM2PDM_CONF1 (rw) register accessor: I2S TX PCM2PDM configuration register
...
/**RX_PDM2PCM_CONF (rw) register accessor: I2S RX configure register
...
pub mod rx_tdm_ctrl;
/**TX_TDM_CTRL (rw) register accessor: I2S TX TDM mode control register
...
pub mod rx_timing;
/**TX_TIMING (rw) register accessor: I2S TX timing control register
...
pub mod state;
/**ETM_CONF (rw) register accessor: I2S ETM configure register
...
pub mod etm_conf;
/**FIFO_CNT (rw) register accessor: I2S sync counter register
...
pub mod fifo_cnt;
/**BCK_CNT (rw) register accessor: I2S sync counter register
