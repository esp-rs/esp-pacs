///Register `SDA_SAMPLE_TIME` reader
pub type R = crate::R<SDA_SAMPLE_TIME_SPEC>;
///Register `SDA_SAMPLE_TIME` writer
pub type W = crate::W<SDA_SAMPLE_TIME_SPEC>;
///Field `REG_SDA_OD_SAMPLE_TIME` reader - It is used to adjust sda sample point when scl high under open drain speed
pub type REG_SDA_OD_SAMPLE_TIME_R = crate::FieldReader<u16>;
///Field `REG_SDA_OD_SAMPLE_TIME` writer - It is used to adjust sda sample point when scl high under open drain speed
pub type REG_SDA_OD_SAMPLE_TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `REG_SDA_PP_SAMPLE_TIME` reader - It is used to adjust sda sample point when scl high under push pull speed
pub type REG_SDA_PP_SAMPLE_TIME_R = crate::FieldReader;
///Field `REG_SDA_PP_SAMPLE_TIME` writer - It is used to adjust sda sample point when scl high under push pull speed
pub type REG_SDA_PP_SAMPLE_TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:8 - It is used to adjust sda sample point when scl high under open drain speed
    #[inline(always)]
    pub fn reg_sda_od_sample_time(&self) -> REG_SDA_OD_SAMPLE_TIME_R {
        REG_SDA_OD_SAMPLE_TIME_R::new((self.bits & 0x01ff) as u16)
    }
    ///Bits 9:13 - It is used to adjust sda sample point when scl high under push pull speed
    #[inline(always)]
...
///`read()` method returns [`sda_sample_time::R`](R) reader structure
impl crate::Readable for SDA_SAMPLE_TIME_SPEC {}
///`write(|w| ..)` method takes [`sda_sample_time::W`](W) writer structure
