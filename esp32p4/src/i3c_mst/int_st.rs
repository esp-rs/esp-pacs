...
///Field `TX_DATA_BUF_THLD` reader - This interrupt is generated when number of empty locations in transmit buffer is greater than or equal to threshold value specified by TX_EMPTY_BUS_THLD field in DATA_BUFFER_THLD_CTRL register. This interrupt will be cleared automatically when number of empty locations in transmit buffer is less than threshold value.
pub type TX_DATA_BUF_THLD_R = crate::BitReader;
///Field `RX_DATA_BUF_THLD` reader - This interrupt is generated when number of entries in receive buffer is greater than or equal to threshold value specified by RX_BUF_THLD field in DATA_BUFFER_THLD_CTRL register. This interrupt will be cleared automatically when number of entries in receive buffer is less than threshold value.
...
///Field `CMD_BUF_EMPTY_THLD` reader - This interrupt is generated when number of empty locations in command buffer is greater than or equal to threshold value specified by CMD_EMPTY_BUF_THLD field in BUFFER_THLD_CTRL register. This interrupt will be cleared automatically when number of empty locations in command buffer is less than threshold value.
pub type CMD_BUF_EMPTY_THLD_R = crate::BitReader;
///Field `RESP_READY` reader - This interrupt is generated when number of entries in response buffer is greater than or equal to threshold value specified by RESP_BUF_THLD field in BUFFER_THLD_CTRL register. This interrupt will be cleared automatically when number of entries in response buffer is less than threshold value.
pub type RESP_READY_R = crate::BitReader;
///Field `NXT_CMD_REQ_ERR` reader - This interrupt is generated if toc is 0(master will restart next command), but command buf is empty.
pub type NXT_CMD_REQ_ERR_R = crate::BitReader;
///Field `TRANSFER_ERR` reader - This interrupt is generated if any error occurs during transfer. The error type will be specified in the response packet associated with the command (in ERR_STATUS field of RESPONSE_BUFFER_PORT register). This bit can be cleared by writing 1'h1.
pub type TRANSFER_ERR_R = crate::BitReader;
///Field `TRANSFER_COMPLETE` reader - NA
pub type TRANSFER_COMPLETE_R = crate::BitReader;
///Field `COMMAND_DONE` reader - NA
pub type COMMAND_DONE_R = crate::BitReader;
///Field `DETECT_START` reader - NA
pub type DETECT_START_R = crate::BitReader;
///Field `RESP_BUF_OVF` reader - NA
pub type RESP_BUF_OVF_R = crate::BitReader;
///Field `IBI_DATA_BUF_OVF` reader - NA
pub type IBI_DATA_BUF_OVF_R = crate::BitReader;
///Field `IBI_STATUS_BUF_OVF` reader - NA
pub type IBI_STATUS_BUF_OVF_R = crate::BitReader;
///Field `IBI_HANDLE_DONE` reader - NA
pub type IBI_HANDLE_DONE_R = crate::BitReader;
///Field `IBI_DETECT` reader - NA
pub type IBI_DETECT_R = crate::BitReader;
///Field `CMD_CCC_MISMATCH` reader - NA
pub type CMD_CCC_MISMATCH_R = crate::BitReader;
impl R {
    ///Bit 0 - This interrupt is generated when number of empty locations in transmit buffer is greater than or equal to threshold value specified by TX_EMPTY_BUS_THLD field in DATA_BUFFER_THLD_CTRL register. This interrupt will be cleared automatically when number of empty locations in transmit buffer is less than threshold value.
    #[inline(always)]
    pub fn tx_data_buf_thld(&self) -> TX_DATA_BUF_THLD_R {
        TX_DATA_BUF_THLD_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - This interrupt is generated when number of entries in receive buffer is greater than or equal to threshold value specified by RX_BUF_THLD field in DATA_BUFFER_THLD_CTRL register. This interrupt will be cleared automatically when number of entries in receive buffer is less than threshold value.
    #[inline(always)]
    pub fn rx_data_buf_thld(&self) -> RX_DATA_BUF_THLD_R {
        RX_DATA_BUF_THLD_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Only used in master mode. This interrupt is generated when number of entries in IBI buffer is greater than or equal to threshold value specified by IBI_BUF_THLD field in BUFFER_THLD_CTRL register. This interrupt will be cleared automatically when number of entries in IBI buffer is less than threshold value.
    #[inline(always)]
    pub fn ibi_status_thld(&self) -> IBI_STATUS_THLD_R {
        IBI_STATUS_THLD_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - This interrupt is generated when number of empty locations in command buffer is greater than or equal to threshold value specified by CMD_EMPTY_BUF_THLD field in BUFFER_THLD_CTRL register. This interrupt will be cleared automatically when number of empty locations in command buffer is less than threshold value.
    #[inline(always)]
    pub fn cmd_buf_empty_thld(&self) -> CMD_BUF_EMPTY_THLD_R {
        CMD_BUF_EMPTY_THLD_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - This interrupt is generated when number of entries in response buffer is greater than or equal to threshold value specified by RESP_BUF_THLD field in BUFFER_THLD_CTRL register. This interrupt will be cleared automatically when number of entries in response buffer is less than threshold value.
    #[inline(always)]
    pub fn resp_ready(&self) -> RESP_READY_R {
        RESP_READY_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - This interrupt is generated if toc is 0(master will restart next command), but command buf is empty.
    #[inline(always)]
    pub fn nxt_cmd_req_err(&self) -> NXT_CMD_REQ_ERR_R {
        NXT_CMD_REQ_ERR_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - This interrupt is generated if any error occurs during transfer. The error type will be specified in the response packet associated with the command (in ERR_STATUS field of RESPONSE_BUFFER_PORT register). This bit can be cleared by writing 1'h1.
    #[inline(always)]
