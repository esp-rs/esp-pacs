...
///Field `REG_SCL_RSTART_SETUP_TIME` reader - I2C_SCL_RSTART_SETUP_TIME
pub type REG_SCL_RSTART_SETUP_TIME_R = crate::FieldReader<u16>;
///Field `REG_SCL_RSTART_SETUP_TIME` writer - I2C_SCL_RSTART_SETUP_TIME
pub type REG_SCL_RSTART_SETUP_TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ///Bits 0:8 - I2C_SCL_RSTART_SETUP_TIME
    #[inline(always)]
