#[doc = "Register `SCL_I3C_MST_OD_TIME` reader"]
pub type R = crate::R<SCL_I3C_MST_OD_TIME_SPEC>;
#[doc = "Register `SCL_I3C_MST_OD_TIME` writer"]
pub type W = crate::W<SCL_I3C_MST_OD_TIME_SPEC>;
#[doc = "Field `REG_I3C_MST_OD_LOW_PERIOD` reader - SCL Open-Drain low count for I3C transfers targeted to I3C devices."]
pub type REG_I3C_MST_OD_LOW_PERIOD_R = crate::FieldReader<u16>;
#[doc = "Field `REG_I3C_MST_OD_LOW_PERIOD` writer - SCL Open-Drain low count for I3C transfers targeted to I3C devices."]
pub type REG_I3C_MST_OD_LOW_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `REG_I3C_MST_OD_HIGH_PERIOD` reader - SCL Open-Drain High count for I3C transfers targeted to I3C devices."]
pub type REG_I3C_MST_OD_HIGH_PERIOD_R = crate::FieldReader<u16>;
#[doc = "Field `REG_I3C_MST_OD_HIGH_PERIOD` writer - SCL Open-Drain High count for I3C transfers targeted to I3C devices."]
pub type REG_I3C_MST_OD_HIGH_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - SCL Open-Drain low count for I3C transfers targeted to I3C devices."]
    #[inline(always)]
...
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`scl_i3c_mst_od_time::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scl_i3c_mst_od_time::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SCL_I3C_MST_OD_TIME_SPEC;
impl crate::RegisterSpec for SCL_I3C_MST_OD_TIME_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scl_i3c_mst_od_time::R`](R) reader structure"]
impl crate::Readable for SCL_I3C_MST_OD_TIME_SPEC {}
#[doc = "`write(|w| ..)` method takes [`scl_i3c_mst_od_time::W`](W) writer structure"]
impl crate::Writable for SCL_I3C_MST_OD_TIME_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SCL_I3C_MST_OD_TIME to value 0x0005_0019"]
