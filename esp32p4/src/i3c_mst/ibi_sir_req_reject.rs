///Register `IBI_SIR_REQ_REJECT` reader
pub type R = crate::R<IBI_SIR_REQ_REJECT_SPEC>;
///Register `IBI_SIR_REQ_REJECT` writer
...
///`read()` method returns [`ibi_sir_req_reject::R`](R) reader structure
impl crate::Readable for IBI_SIR_REQ_REJECT_SPEC {}
///`write(|w| ..)` method takes [`ibi_sir_req_reject::W`](W) writer structure
