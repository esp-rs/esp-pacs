...
///Field `TX_DATA_BUF_THLD` reader - Transmit Buffer threshold status enable.
pub type TX_DATA_BUF_THLD_R = crate::BitReader;
///Field `TX_DATA_BUF_THLD` writer - Transmit Buffer threshold status enable.
pub type TX_DATA_BUF_THLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_DATA_BUF_THLD` reader - Receive Buffer threshold status enable.
pub type RX_DATA_BUF_THLD_R = crate::BitReader;
///Field `RX_DATA_BUF_THLD` writer - Receive Buffer threshold status enable.
pub type RX_DATA_BUF_THLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IBI_STATUS_THLD` reader - Only used in master mode. IBI Buffer threshold status enable.
pub type IBI_STATUS_THLD_R = crate::BitReader;
///Field `IBI_STATUS_THLD` writer - Only used in master mode. IBI Buffer threshold status enable.
pub type IBI_STATUS_THLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CMD_BUF_EMPTY_THLD` reader - Command buffer ready status enable.
pub type CMD_BUF_EMPTY_THLD_R = crate::BitReader;
///Field `CMD_BUF_EMPTY_THLD` writer - Command buffer ready status enable.
pub type CMD_BUF_EMPTY_THLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RESP_READY` reader - Response buffer ready status enable.
pub type RESP_READY_R = crate::BitReader;
///Field `RESP_READY` writer - Response buffer ready status enable.
pub type RESP_READY_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `NXT_CMD_REQ_ERR` reader - next command request error status enable
pub type NXT_CMD_REQ_ERR_R = crate::BitReader;
///Field `NXT_CMD_REQ_ERR` writer - next command request error status enable
pub type NXT_CMD_REQ_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANSFER_ERR` reader - Transfer error status enable
pub type TRANSFER_ERR_R = crate::BitReader;
///Field `TRANSFER_ERR` writer - Transfer error status enable
...
///Field `TRANSFER_COMPLETE` writer - NA
