///Register `FPGA_DEBUG_PROBE` reader
pub type R = crate::R<FPGA_DEBUG_PROBE_SPEC>;
///Register `FPGA_DEBUG_PROBE` writer
pub type W = crate::W<FPGA_DEBUG_PROBE_SPEC>;
///Field `REG_I3C_MST_FPGA_DEBUG_PROBE` reader - For Debug Probe Test on FPGA
pub type REG_I3C_MST_FPGA_DEBUG_PROBE_R = crate::FieldReader<u32>;
///Field `REG_I3C_MST_FPGA_DEBUG_PROBE` writer - For Debug Probe Test on FPGA
pub type REG_I3C_MST_FPGA_DEBUG_PROBE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - For Debug Probe Test on FPGA
    #[inline(always)]
...
///`read()` method returns [`fpga_debug_probe::R`](R) reader structure
impl crate::Readable for FPGA_DEBUG_PROBE_SPEC {}
///`write(|w| ..)` method takes [`fpga_debug_probe::W`](W) writer structure
