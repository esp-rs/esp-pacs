///Register `RESET_CTRL` reader
pub type R = crate::R<RESET_CTRL_SPEC>;
///Register `RESET_CTRL` writer
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RESET_CTRL")
            .field("reg_cmd_buf_rst", &self.reg_cmd_buf_rst())
            .field("reg_resp_buf_rst", &self.reg_resp_buf_rst())
            .field("reg_tx_data_buf_buf_rst", &self.reg_tx_data_buf_buf_rst())
            .field("reg_rx_data_buf_rst", &self.reg_rx_data_buf_rst())
            .field("reg_ibi_data_buf_rst", &self.reg_ibi_data_buf_rst())
            .field("reg_ibi_status_buf_rst", &self.reg_ibi_status_buf_rst())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`reset_ctrl::R`](R) reader structure
impl crate::Readable for RESET_CTRL_SPEC {}
///`write(|w| ..)` method takes [`reset_ctrl::W`](W) writer structure
