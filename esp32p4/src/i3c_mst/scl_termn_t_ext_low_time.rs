///Register `SCL_TERMN_T_EXT_LOW_TIME` reader
pub type R = crate::R<SCL_TERMN_T_EXT_LOW_TIME_SPEC>;
///Register `SCL_TERMN_T_EXT_LOW_TIME` writer
pub type W = crate::W<SCL_TERMN_T_EXT_LOW_TIME_SPEC>;
///Field `REG_I3C_MST_TERMN_T_EXT_LOW_TIME` reader - NA
pub type REG_I3C_MST_TERMN_T_EXT_LOW_TIME_R = crate::FieldReader;
///Field `REG_I3C_MST_TERMN_T_EXT_LOW_TIME` writer - NA
...
///`read()` method returns [`scl_termn_t_ext_low_time::R`](R) reader structure
impl crate::Readable for SCL_TERMN_T_EXT_LOW_TIME_SPEC {}
///`write(|w| ..)` method takes [`scl_termn_t_ext_low_time::W`](W) writer structure
