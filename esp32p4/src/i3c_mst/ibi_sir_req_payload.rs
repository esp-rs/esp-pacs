///Register `IBI_SIR_REQ_PAYLOAD` reader
pub type R = crate::R<IBI_SIR_REQ_PAYLOAD_SPEC>;
///Register `IBI_SIR_REQ_PAYLOAD` writer
pub type W = crate::W<IBI_SIR_REQ_PAYLOAD_SPEC>;
///Field `REG_SIR_REQ_PAYLOAD` reader - NA
pub type REG_SIR_REQ_PAYLOAD_R = crate::FieldReader<u32>;
///Field `REG_SIR_REQ_PAYLOAD` writer - NA
...
///`read()` method returns [`ibi_sir_req_payload::R`](R) reader structure
impl crate::Readable for IBI_SIR_REQ_PAYLOAD_SPEC {}
///`write(|w| ..)` method takes [`ibi_sir_req_payload::W`](W) writer structure
