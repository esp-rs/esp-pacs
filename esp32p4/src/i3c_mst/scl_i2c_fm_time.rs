///Register `SCL_I2C_FM_TIME` reader
pub type R = crate::R<SCL_I2C_FM_TIME_SPEC>;
///Register `SCL_I2C_FM_TIME` writer
pub type W = crate::W<SCL_I2C_FM_TIME_SPEC>;
///Field `REG_I2C_FM_LOW_PERIOD` reader - NA
pub type REG_I2C_FM_LOW_PERIOD_R = crate::FieldReader<u16>;
///Field `REG_I2C_FM_LOW_PERIOD` writer - NA
pub type REG_I2C_FM_LOW_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `REG_I2C_FM_HIGH_PERIOD` reader - The SCL open-drain low count timing for I2C Fast Mode transfers.
pub type REG_I2C_FM_HIGH_PERIOD_R = crate::FieldReader<u16>;
///Field `REG_I2C_FM_HIGH_PERIOD` writer - The SCL open-drain low count timing for I2C Fast Mode transfers.
...
impl R {
    ...
    ///Bits 16:31 - The SCL open-drain low count timing for I2C Fast Mode transfers.
    #[inline(always)]
...
///`read()` method returns [`scl_i2c_fm_time::R`](R) reader structure
impl crate::Readable for SCL_I2C_FM_TIME_SPEC {}
///`write(|w| ..)` method takes [`scl_i2c_fm_time::W`](W) writer structure
