///Register `DEVICE_CTRL` reader
pub type R = crate::R<DEVICE_CTRL_SPEC>;
///Register `DEVICE_CTRL` writer
pub type W = crate::W<DEVICE_CTRL_SPEC>;
///Field `REG_BA_INCLUDE` reader - This bit is used to include I3C broadcast address(0x7E) for private transfer.(If I3C broadcast address is not include for the private transfer, In-Band Interrupts driven from Slaves may not win address arbitration. Hence IBIs will get delayed)
pub type REG_BA_INCLUDE_R = crate::BitReader;
///Field `REG_BA_INCLUDE` writer - This bit is used to include I3C broadcast address(0x7E) for private transfer.(If I3C broadcast address is not include for the private transfer, In-Band Interrupts driven from Slaves may not win address arbitration. Hence IBIs will get delayed)
pub type REG_BA_INCLUDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_TRANS_START` reader - Transfer Start
pub type REG_TRANS_START_R = crate::BitReader;
///Field `REG_TRANS_START` writer - Transfer Start
pub type REG_TRANS_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_CLK_EN` reader - NA
pub type REG_CLK_EN_R = crate::BitReader;
///Field `REG_CLK_EN` writer - NA
pub type REG_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_IBI_RSTART_TRANS_EN` reader - NA
pub type REG_IBI_RSTART_TRANS_EN_R = crate::BitReader;
///Field `REG_IBI_RSTART_TRANS_EN` writer - NA
pub type REG_IBI_RSTART_TRANS_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_AUTO_DIS_IBI_EN` reader - NA
pub type REG_AUTO_DIS_IBI_EN_R = crate::BitReader;
///Field `REG_AUTO_DIS_IBI_EN` writer - NA
pub type REG_AUTO_DIS_IBI_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_DMA_RX_EN` reader - NA
pub type REG_DMA_RX_EN_R = crate::BitReader;
///Field `REG_DMA_RX_EN` writer - NA
pub type REG_DMA_RX_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_DMA_TX_EN` reader - NA
pub type REG_DMA_TX_EN_R = crate::BitReader;
///Field `REG_DMA_TX_EN` writer - NA
pub type REG_DMA_TX_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_MULTI_SLV_SINGLE_CCC_EN` reader - 0: rx high bit first, 1: rx low bit first
pub type REG_MULTI_SLV_SINGLE_CCC_EN_R = crate::BitReader;
///Field `REG_MULTI_SLV_SINGLE_CCC_EN` writer - 0: rx high bit first, 1: rx low bit first
pub type REG_MULTI_SLV_SINGLE_CCC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_RX_BIT_ORDER` reader - 0: rx low byte fist, 1: rx high byte first
pub type REG_RX_BIT_ORDER_R = crate::BitReader;
///Field `REG_RX_BIT_ORDER` writer - 0: rx low byte fist, 1: rx high byte first
pub type REG_RX_BIT_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_RX_BYTE_ORDER` reader - NA
pub type REG_RX_BYTE_ORDER_R = crate::BitReader;
///Field `REG_RX_BYTE_ORDER` writer - NA
pub type REG_RX_BYTE_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_SCL_PULLUP_FORCE_EN` reader - This bit is used to force scl_pullup_en
pub type REG_SCL_PULLUP_FORCE_EN_R = crate::BitReader;
///Field `REG_SCL_PULLUP_FORCE_EN` writer - This bit is used to force scl_pullup_en
pub type REG_SCL_PULLUP_FORCE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_SCL_OE_FORCE_EN` reader - This bit is used to force scl_oe
pub type REG_SCL_OE_FORCE_EN_R = crate::BitReader;
///Field `REG_SCL_OE_FORCE_EN` writer - This bit is used to force scl_oe
pub type REG_SCL_OE_FORCE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_SDA_PP_RD_PULLUP_EN` reader - NA
pub type REG_SDA_PP_RD_PULLUP_EN_R = crate::BitReader;
///Field `REG_SDA_PP_RD_PULLUP_EN` writer - NA
pub type REG_SDA_PP_RD_PULLUP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_SDA_RD_TBIT_HLVL_PULLUP_EN` reader - NA
pub type REG_SDA_RD_TBIT_HLVL_PULLUP_EN_R = crate::BitReader;
///Field `REG_SDA_RD_TBIT_HLVL_PULLUP_EN` writer - NA
pub type REG_SDA_RD_TBIT_HLVL_PULLUP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_SDA_PP_WR_PULLUP_EN` reader - NA
pub type REG_SDA_PP_WR_PULLUP_EN_R = crate::BitReader;
///Field `REG_SDA_PP_WR_PULLUP_EN` writer - NA
pub type REG_SDA_PP_WR_PULLUP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_DATA_BYTE_CNT_UNLATCH` reader - 1: read current real-time updated value 0: read latch data byte cnt value
pub type REG_DATA_BYTE_CNT_UNLATCH_R = crate::BitReader;
///Field `REG_DATA_BYTE_CNT_UNLATCH` writer - 1: read current real-time updated value 0: read latch data byte cnt value
pub type REG_DATA_BYTE_CNT_UNLATCH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG_MEM_CLK_FORCE_ON` reader - 1: dev characteristic and address table memory clk date force on . 0 : clock gating by rd/wr.
pub type REG_MEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `REG_MEM_CLK_FORCE_ON` writer - 1: dev characteristic and address table memory clk date force on . 0 : clock gating by rd/wr.
pub type REG_MEM_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 1 - This bit is used to include I3C broadcast address(0x7E) for private transfer.(If I3C broadcast address is not include for the private transfer, In-Band Interrupts driven from Slaves may not win address arbitration. Hence IBIs will get delayed)
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DEVICE_CTRL")
            .field("reg_ba_include", &self.reg_ba_include())
            .field("reg_trans_start", &self.reg_trans_start())
            .field("reg_clk_en", &self.reg_clk_en())
            .field("reg_ibi_rstart_trans_en", &self.reg_ibi_rstart_trans_en())
            ...
            .field("reg_scl_oe_force_en", &self.reg_scl_oe_force_en())
            .field("reg_sda_pp_rd_pullup_en", &self.reg_sda_pp_rd_pullup_en())
            .field(
...
///`read()` method returns [`device_ctrl::R`](R) reader structure
impl crate::Readable for DEVICE_CTRL_SPEC {}
///`write(|w| ..)` method takes [`device_ctrl::W`](W) writer structure
