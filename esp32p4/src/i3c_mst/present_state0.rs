///Register `PRESENT_STATE0` reader
pub type R = crate::R<PRESENT_STATE0_SPEC>;
///Field `SDA_LVL` reader - This bit is used to check the SCL line level to recover from error and for debugging. This bit reflects the value of synchronized scl_in_a.
pub type SDA_LVL_R = crate::BitReader;
///Field `SCL_LVL` reader - This bit is used to check the SDA line level to recover from error and for debugging. This bit reflects the value of synchronized sda_in_a.
pub type SCL_LVL_R = crate::BitReader;
///Field `BUS_BUSY` reader - NA
pub type BUS_BUSY_R = crate::BitReader;
///Field `BUS_FREE` reader - NA
pub type BUS_FREE_R = crate::BitReader;
///Field `CMD_TID` reader - NA
pub type CMD_TID_R = crate::FieldReader;
///Field `SCL_GEN_FSM_STATE` reader - NA
pub type SCL_GEN_FSM_STATE_R = crate::FieldReader;
///Field `IBI_EV_HANDLE_FSM_STATE` reader - NA
pub type IBI_EV_HANDLE_FSM_STATE_R = crate::FieldReader;
///Field `I2C_MODE_FSM_STATE` reader - NA
pub type I2C_MODE_FSM_STATE_R = crate::FieldReader;
///Field `SDR_MODE_FSM_STATE` reader - NA
pub type SDR_MODE_FSM_STATE_R = crate::FieldReader;
///Field `DAA_MODE_FSM_STATE` reader - Reflects whether the Master Controller is in IDLE or not. This bit will be set when all the buffer(Command, Response, IBI, Transmit, Receive) are empty along with the Master State machine is in idle state. 0X0: not in idle 0x1: in idle
pub type DAA_MODE_FSM_STATE_R = crate::FieldReader;
///Field `MAIN_FSM_STATE` reader - NA
pub type MAIN_FSM_STATE_R = crate::FieldReader;
impl R {
    ///Bit 0 - This bit is used to check the SCL line level to recover from error and for debugging. This bit reflects the value of synchronized scl_in_a.
    #[inline(always)]
    pub fn sda_lvl(&self) -> SDA_LVL_R {
        SDA_LVL_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - This bit is used to check the SDA line level to recover from error and for debugging. This bit reflects the value of synchronized sda_in_a.
    #[inline(always)]
    ...
    ///Bits 26:28 - Reflects whether the Master Controller is in IDLE or not. This bit will be set when all the buffer(Command, Response, IBI, Transmit, Receive) are empty along with the Master State machine is in idle state. 0X0: not in idle 0x1: in idle
    #[inline(always)]
...
///`read()` method returns [`present_state0::R`](R) reader structure
