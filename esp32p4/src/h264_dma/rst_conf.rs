///Register `RST_CONF` reader
pub type R = crate::R<RST_CONF_SPEC>;
///Register `RST_CONF` writer
pub type W = crate::W<RST_CONF_SPEC>;
///Field `INTER_AXIM_RD_RST` reader - Write 1 then write 0 to this bit to reset axi master read data FIFO.
pub type INTER_AXIM_RD_RST_R = crate::BitReader;
///Field `INTER_AXIM_RD_RST` writer - Write 1 then write 0 to this bit to reset axi master read data FIFO.
pub type INTER_AXIM_RD_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_AXIM_WR_RST` reader - Write 1 then write 0 to this bit to reset axi master write data FIFO.
pub type INTER_AXIM_WR_RST_R = crate::BitReader;
///Field `INTER_AXIM_WR_RST` writer - Write 1 then write 0 to this bit to reset axi master write data FIFO.
pub type INTER_AXIM_WR_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXTER_AXIM_RD_RST` reader - Write 1 then write 0 to this bit to reset axi master read data FIFO.
pub type EXTER_AXIM_RD_RST_R = crate::BitReader;
///Field `EXTER_AXIM_RD_RST` writer - Write 1 then write 0 to this bit to reset axi master read data FIFO.
pub type EXTER_AXIM_RD_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXTER_AXIM_WR_RST` reader - Write 1 then write 0 to this bit to reset axi master write data FIFO.
pub type EXTER_AXIM_WR_RST_R = crate::BitReader;
///Field `EXTER_AXIM_WR_RST` writer - Write 1 then write 0 to this bit to reset axi master write data FIFO.
...
impl R {
    ///Bit 0 - Write 1 then write 0 to this bit to reset axi master read data FIFO.
    #[inline(always)]
    pub fn inter_axim_rd_rst(&self) -> INTER_AXIM_RD_RST_R {
        INTER_AXIM_RD_RST_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Write 1 then write 0 to this bit to reset axi master write data FIFO.
    #[inline(always)]
    pub fn inter_axim_wr_rst(&self) -> INTER_AXIM_WR_RST_R {
        INTER_AXIM_WR_RST_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Write 1 then write 0 to this bit to reset axi master read data FIFO.
    #[inline(always)]
    pub fn exter_axim_rd_rst(&self) -> EXTER_AXIM_RD_RST_R {
        EXTER_AXIM_RD_RST_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Write 1 then write 0 to this bit to reset axi master write data FIFO.
    #[inline(always)]
    pub fn exter_axim_wr_rst(&self) -> EXTER_AXIM_WR_RST_R {
        EXTER_AXIM_WR_RST_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - 1'h1: Force clock on for register. 1'h0: Support clock only when application writes registers.
    #[inline(always)]
...
///`read()` method returns [`rst_conf::R`](R) reader structure
impl crate::Readable for RST_CONF_SPEC {}
///`write(|w| ..)` method takes [`rst_conf::W`](W) writer structure
