...
#[doc = "Field `OUT_DSCR_STATE_CH1` reader - This register stores the current descriptor state machine state."]
pub type OUT_DSCR_STATE_CH1_R = crate::FieldReader;
#[doc = "Field `OUT_STATE_CH1` reader - This register stores the current control module state machine state."]
pub type OUT_STATE_CH1_R = crate::FieldReader;
#[doc = "Field `OUT_RESET_AVAIL_CH1` reader - This register indicate that if the channel reset is safety."]
pub type OUT_RESET_AVAIL_CH1_R = crate::BitReader;
impl R {
    ...
    pub fn out_state_ch1(&self) -> OUT_STATE_CH1_R {
        OUT_STATE_CH1_R::new(((self.bits >> 20) & 0x0f) as u8)
    }
    #[doc = "Bit 24 - This register indicate that if the channel reset is safety."]
    #[inline(always)]
    pub fn out_reset_avail_ch1(&self) -> OUT_RESET_AVAIL_CH1_R {
        OUT_RESET_AVAIL_CH1_R::new(((self.bits >> 24) & 1) != 0)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_STATE_CH1")
            .field(
                ...
                &format_args!("{}", self.outlink_dscr_addr_ch1().bits()),
            )
            .field(
                "out_dscr_state_ch1",
                &format_args!("{}", self.out_dscr_state_ch1().bits()),
            )
            .field(
                "out_state_ch1",
                &format_args!("{}", self.out_state_ch1().bits()),
            )
            .field(
                "out_reset_avail_ch1",
                &format_args!("{}", self.out_reset_avail_ch1().bit()),
            )
            .finish()
    }
}
...
#[doc = "`reset()` method sets OUT_STATE_CH1 to value 0x0100_0000"]
