...
///Field `BLOCK_START_ADDR` reader - RX Channel 5 destination start address
pub type BLOCK_START_ADDR_R = crate::FieldReader<u32>;
///Field `BLOCK_START_ADDR` writer - RX Channel 5 destination start address
pub type BLOCK_START_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - RX Channel 5 destination start address
    #[inline(always)]
