...
///Field `BLOCK_ROW_LENGTH_12LINE` reader - The number of bytes contained in a row block 12line in RX channel 5
pub type BLOCK_ROW_LENGTH_12LINE_R = crate::FieldReader<u16>;
///Field `BLOCK_ROW_LENGTH_12LINE` writer - The number of bytes contained in a row block 12line in RX channel 5
pub type BLOCK_ROW_LENGTH_12LINE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `BLOCK_ROW_LENGTH_4LINE` reader - The number of bytes contained in a row block 4line in RX channel 5
pub type BLOCK_ROW_LENGTH_4LINE_R = crate::FieldReader<u16>;
///Field `BLOCK_ROW_LENGTH_4LINE` writer - The number of bytes contained in a row block 4line in RX channel 5
pub type BLOCK_ROW_LENGTH_4LINE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - The number of bytes contained in a row block 12line in RX channel 5
    #[inline(always)]
    pub fn block_row_length_12line(&self) -> BLOCK_ROW_LENGTH_12LINE_R {
        BLOCK_ROW_LENGTH_12LINE_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - The number of bytes contained in a row block 4line in RX channel 5
    #[inline(always)]
...
///`reset()` method sets CONF2 to value 0x3c00_7800
