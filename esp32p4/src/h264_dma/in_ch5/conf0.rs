...
///Field `IN_MEM_BURST_LENGTH` reader - Block size of Rx channel 1. 0: single 1: 16 bytes 2: 32 bytes 3: 64 bytes 4: 128 bytes
pub type IN_MEM_BURST_LENGTH_R = crate::FieldReader;
///Field `IN_MEM_BURST_LENGTH` writer - Block size of Rx channel 1. 0: single 1: 16 bytes 2: 32 bytes 3: 64 bytes 4: 128 bytes
...
impl R {
    ...
    ///Bits 6:8 - Block size of Rx channel 1. 0: single 1: 16 bytes 2: 32 bytes 3: 64 bytes 4: 128 bytes
    #[inline(always)]
