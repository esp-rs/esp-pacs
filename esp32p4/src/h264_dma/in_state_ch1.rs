...
pub type INLINK_DSCR_ADDR_CH1_R = crate::FieldReader<u32>;
#[doc = "Field `IN_DSCR_STATE_CH1` reader - This register stores the current descriptor state machine state."]
pub type IN_DSCR_STATE_CH1_R = crate::FieldReader;
#[doc = "Field `IN_STATE_CH1` reader - This register stores the current control module state machine state."]
pub type IN_STATE_CH1_R = crate::FieldReader;
#[doc = "Field `IN_RESET_AVAIL_CH1` reader - This register indicate that if the channel reset is safety."]
pub type IN_RESET_AVAIL_CH1_R = crate::BitReader;
impl R {
    ...
    pub fn inlink_dscr_addr_ch1(&self) -> INLINK_DSCR_ADDR_CH1_R {
        INLINK_DSCR_ADDR_CH1_R::new(self.bits & 0x0003_ffff)
    }
    ...
    pub fn in_dscr_state_ch1(&self) -> IN_DSCR_STATE_CH1_R {
        IN_DSCR_STATE_CH1_R::new(((self.bits >> 18) & 3) as u8)
    }
    ...
    pub fn in_state_ch1(&self) -> IN_STATE_CH1_R {
        IN_STATE_CH1_R::new(((self.bits >> 20) & 7) as u8)
    }
    #[doc = "Bit 23 - This register indicate that if the channel reset is safety."]
    #[inline(always)]
    pub fn in_reset_avail_ch1(&self) -> IN_RESET_AVAIL_CH1_R {
        IN_RESET_AVAIL_CH1_R::new(((self.bits >> 23) & 1) != 0)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_STATE_CH1")
            .field(
                "inlink_dscr_addr_ch1",
                &format_args!("{}", self.inlink_dscr_addr_ch1().bits()),
            )
            .field(
                "in_dscr_state_ch1",
                &format_args!("{}", self.in_dscr_state_ch1().bits()),
            )
            .field(
                "in_state_ch1",
                &format_args!("{}", self.in_state_ch1().bits()),
            )
            .field(
                "in_reset_avail_ch1",
                &format_args!("{}", self.in_reset_avail_ch1().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<IN_STATE_CH1_SPEC> {
...
#[doc = "`reset()` method sets IN_STATE_CH1 to value 0x0080_0000"]
