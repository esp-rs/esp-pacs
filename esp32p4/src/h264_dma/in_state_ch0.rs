...
#[doc = "Field `INLINK_DSCR_ADDR_CH0` reader - This register stores the current inlink descriptor's address."]
pub type INLINK_DSCR_ADDR_CH0_R = crate::FieldReader<u32>;
#[doc = "Field `IN_DSCR_STATE_CH0` reader - This register stores the current descriptor state machine state."]
pub type IN_DSCR_STATE_CH0_R = crate::FieldReader;
#[doc = "Field `IN_STATE_CH0` reader - This register stores the current control module state machine state."]
pub type IN_STATE_CH0_R = crate::FieldReader;
#[doc = "Field `IN_RESET_AVAIL_CH0` reader - This register indicate that if the channel reset is safety."]
pub type IN_RESET_AVAIL_CH0_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn in_reset_avail_ch0(&self) -> IN_RESET_AVAIL_CH0_R {
        IN_RESET_AVAIL_CH0_R::new(((self.bits >> 23) & 1) != 0)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_STATE_CH0")
            .field(
                ...
                &format_args!("{}", self.inlink_dscr_addr_ch0().bits()),
            )
            .field(
                "in_dscr_state_ch0",
                &format_args!("{}", self.in_dscr_state_ch0().bits()),
            )
            .field(
                "in_state_ch0",
                &format_args!("{}", self.in_state_ch0().bits()),
            )
            .field(
                "in_reset_avail_ch0",
                &format_args!("{}", self.in_reset_avail_ch0().bit()),
            )
            .finish()
    }
}
...
#[doc = "`reset()` method sets IN_STATE_CH0 to value 0x0080_0000"]
