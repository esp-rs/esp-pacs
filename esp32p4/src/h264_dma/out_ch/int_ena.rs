...
///Field `OUTFIFO_OVF_L1` reader - The interrupt enable bit for the OUTFIFO_OVF_L1_CH_INT interrupt.
pub type OUTFIFO_OVF_L1_R = crate::BitReader;
///Field `OUTFIFO_OVF_L1` writer - The interrupt enable bit for the OUTFIFO_OVF_L1_CH_INT interrupt.
pub type OUTFIFO_OVF_L1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTFIFO_UDF_L1` reader - The interrupt enable bit for the OUTFIFO_UDF_L1_CH_INT interrupt.
pub type OUTFIFO_UDF_L1_R = crate::BitReader;
///Field `OUTFIFO_UDF_L1` writer - The interrupt enable bit for the OUTFIFO_UDF_L1_CH_INT interrupt.
pub type OUTFIFO_UDF_L1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTFIFO_OVF_L2` reader - The interrupt enable bit for the OUTFIFO_OVF_L2_CH_INT interrupt.
pub type OUTFIFO_OVF_L2_R = crate::BitReader;
///Field `OUTFIFO_OVF_L2` writer - The interrupt enable bit for the OUTFIFO_OVF_L2_CH_INT interrupt.
pub type OUTFIFO_OVF_L2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTFIFO_UDF_L2` reader - The interrupt enable bit for the OUTFIFO_UDF_L2_CH_INT interrupt.
pub type OUTFIFO_UDF_L2_R = crate::BitReader;
///Field `OUTFIFO_UDF_L2` writer - The interrupt enable bit for the OUTFIFO_UDF_L2_CH_INT interrupt.
pub type OUTFIFO_UDF_L2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_DSCR_TASK_OVF` reader - The interrupt enable bit for the OUT_DSCR_TASK_OVF_CH_INT interrupt.
pub type OUT_DSCR_TASK_OVF_R = crate::BitReader;
///Field `OUT_DSCR_TASK_OVF` writer - The interrupt enable bit for the OUT_DSCR_TASK_OVF_CH_INT interrupt.
...
impl R {
    ...
    ///Bit 8 - The interrupt enable bit for the OUT_DSCR_TASK_OVF_CH_INT interrupt.
    #[inline(always)]
