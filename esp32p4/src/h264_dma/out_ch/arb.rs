...
///Field `OUT_ARB_TOKEN_NUM` reader - Set the max number of token count of arbiter
pub type OUT_ARB_TOKEN_NUM_R = crate::FieldReader;
///Field `OUT_ARB_TOKEN_NUM` writer - Set the max number of token count of arbiter
pub type OUT_ARB_TOKEN_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `EXTER_OUT_ARB_PRIORITY` reader - Set the priority of channel
pub type EXTER_OUT_ARB_PRIORITY_R = crate::FieldReader;
///Field `EXTER_OUT_ARB_PRIORITY` writer - Set the priority of channel
pub type EXTER_OUT_ARB_PRIORITY_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `INTER_OUT_ARB_PRIORITY` reader - Set the priority of channel
pub type INTER_OUT_ARB_PRIORITY_R = crate::BitReader;
///Field `INTER_OUT_ARB_PRIORITY` writer - Set the priority of channel
...
///`reset()` method sets ARB to value 0x11
