///Register `BLOCK_BUF_LEN` reader
pub type R = crate::R<BLOCK_BUF_LEN_SPEC>;
///Field `OUT_BLOCK_BUF_LEN` reader - only for debug
pub type OUT_BLOCK_BUF_LEN_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:27 - only for debug
    #[inline(always)]
...
///`read()` method returns [`block_buf_len::R`](R) reader structure
impl crate::Readable for BLOCK_BUF_LEN_SPEC {}
///`reset()` method sets BLOCK_BUF_LEN to value 0
