...
///Field `OUTFIFO_OVF_L2` writer - Set this bit to clear the OUTFIFO_OVF_L2_CH_INT interrupt.
pub type OUTFIFO_OVF_L2_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `OUTFIFO_UDF_L2` writer - Set this bit to clear the OUTFIFO_UDF_L2_CH_INT interrupt.
pub type OUTFIFO_UDF_L2_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `OUT_DSCR_TASK_OVF` writer - Set this bit to clear the OUT_DSCR_TASK_OVF_CH_INT interrupt.
...
impl W {
    ...
    ///Bit 8 - Set this bit to clear the OUT_DSCR_TASK_OVF_CH_INT interrupt.
    #[inline(always)]
    #[must_use]
