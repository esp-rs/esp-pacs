...
///Field `OUTFIFO_FULL_L2` reader - Tx FIFO full signal for Tx channel 0.
pub type OUTFIFO_FULL_L2_R = crate::BitReader;
///Field `OUTFIFO_EMPTY_L2` reader - Tx FIFO empty signal for Tx channel 0.
pub type OUTFIFO_EMPTY_L2_R = crate::BitReader;
///Field `OUTFIFO_CNT_L2` reader - The register stores the byte number of the data in Tx FIFO for Tx channel 0.
pub type OUTFIFO_CNT_L2_R = crate::FieldReader;
///Field `OUTFIFO_FULL_L1` reader - Tx FIFO full signal for Tx channel 0.
pub type OUTFIFO_FULL_L1_R = crate::BitReader;
///Field `OUTFIFO_EMPTY_L1` reader - Tx FIFO empty signal for Tx channel 0.
pub type OUTFIFO_EMPTY_L1_R = crate::BitReader;
///Field `OUTFIFO_CNT_L1` reader - The register stores the byte number of the data in Tx FIFO for Tx channel 0.
pub type OUTFIFO_CNT_L1_R = crate::FieldReader;
///Field `OUTFIFO_FULL_L3` reader - Tx FIFO full signal for Tx channel 0.
pub type OUTFIFO_FULL_L3_R = crate::BitReader;
///Field `OUTFIFO_EMPTY_L3` reader - Tx FIFO empty signal for Tx channel 0.
pub type OUTFIFO_EMPTY_L3_R = crate::BitReader;
///Field `OUTFIFO_CNT_L3` reader - The register stores the 8byte number of the data in Tx FIFO for Tx channel 0.
pub type OUTFIFO_CNT_L3_R = crate::FieldReader;
impl R {
    ///Bit 0 - Tx FIFO full signal for Tx channel 0.
    #[inline(always)]
    pub fn outfifo_full_l2(&self) -> OUTFIFO_FULL_L2_R {
        OUTFIFO_FULL_L2_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Tx FIFO empty signal for Tx channel 0.
    #[inline(always)]
    pub fn outfifo_empty_l2(&self) -> OUTFIFO_EMPTY_L2_R {
        OUTFIFO_EMPTY_L2_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:5 - The register stores the byte number of the data in Tx FIFO for Tx channel 0.
    #[inline(always)]
    pub fn outfifo_cnt_l2(&self) -> OUTFIFO_CNT_L2_R {
        OUTFIFO_CNT_L2_R::new(((self.bits >> 2) & 0x0f) as u8)
    }
    ///Bit 6 - Tx FIFO full signal for Tx channel 0.
    #[inline(always)]
    pub fn outfifo_full_l1(&self) -> OUTFIFO_FULL_L1_R {
        OUTFIFO_FULL_L1_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Tx FIFO empty signal for Tx channel 0.
    #[inline(always)]
    pub fn outfifo_empty_l1(&self) -> OUTFIFO_EMPTY_L1_R {
        OUTFIFO_EMPTY_L1_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bits 8:12 - The register stores the byte number of the data in Tx FIFO for Tx channel 0.
    #[inline(always)]
    pub fn outfifo_cnt_l1(&self) -> OUTFIFO_CNT_L1_R {
        OUTFIFO_CNT_L1_R::new(((self.bits >> 8) & 0x1f) as u8)
    }
    ///Bit 16 - Tx FIFO full signal for Tx channel 0.
    #[inline(always)]
    pub fn outfifo_full_l3(&self) -> OUTFIFO_FULL_L3_R {
        OUTFIFO_FULL_L3_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - Tx FIFO empty signal for Tx channel 0.
    #[inline(always)]
    pub fn outfifo_empty_l3(&self) -> OUTFIFO_EMPTY_L3_R {
        OUTFIFO_EMPTY_L3_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bits 18:19 - The register stores the 8byte number of the data in Tx FIFO for Tx channel 0.
    #[inline(always)]
...
///`reset()` method sets FIFO_STATUS to value 0x0002_0082
