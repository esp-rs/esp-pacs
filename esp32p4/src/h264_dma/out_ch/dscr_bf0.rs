...
///Field `OUTLINK_DSCR_BF0` reader - The address of the last outlink descriptor's next address y-1.
pub type OUTLINK_DSCR_BF0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The address of the last outlink descriptor's next address y-1.
    #[inline(always)]
