...
///Field `OUT_ETM_EN` reader - Set this bit to 1 to enable ETM task function
pub type OUT_ETM_EN_R = crate::BitReader;
///Field `OUT_ETM_EN` writer - Set this bit to 1 to enable ETM task function
pub type OUT_ETM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_ETM_LOOP_EN` reader - when this bit is 1, dscr can be processed after receiving a task
pub type OUT_ETM_LOOP_EN_R = crate::BitReader;
///Field `OUT_ETM_LOOP_EN` writer - when this bit is 1, dscr can be processed after receiving a task
pub type OUT_ETM_LOOP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_DSCR_TASK_MAK` reader - ETM dscr_ready maximum cache numbers
pub type OUT_DSCR_TASK_MAK_R = crate::FieldReader;
///Field `OUT_DSCR_TASK_MAK` writer - ETM dscr_ready maximum cache numbers
