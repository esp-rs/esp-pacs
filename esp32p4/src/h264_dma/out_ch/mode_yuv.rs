...
You can [`read`](crate::generic::Reg::read) this register and get [`mode_yuv::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mode_yuv::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct MODE_YUV_SPEC;
impl crate::RegisterSpec for MODE_YUV_SPEC {
    type Ux = u32;
}
///`read()` method returns [`mode_yuv::R`](R) reader structure
impl crate::Readable for MODE_YUV_SPEC {}
///`write(|w| ..)` method takes [`mode_yuv::W`](W) writer structure
impl crate::Writable for MODE_YUV_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MODE_YUV to value 0
