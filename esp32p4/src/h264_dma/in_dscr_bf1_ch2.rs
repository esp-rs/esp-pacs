...
pub type R = crate::R<IN_DSCR_BF1_CH2_SPEC>;
#[doc = "Field `INLINK_DSCR_BF1_CH2` reader - The address of the second-to-last inlink descriptor's next address x-2."]
pub type INLINK_DSCR_BF1_CH2_R = crate::FieldReader<u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_DSCR_BF1_CH2")
            .field(
                "inlink_dscr_bf1_ch2",
                &format_args!("{}", self.inlink_dscr_bf1_ch2().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<IN_DSCR_BF1_CH2_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "RX CH2 second-to-last dscr addr register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`in_dscr_bf1_ch2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
