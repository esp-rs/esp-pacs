...
#[doc = "Field `OUT_DSCR_STATE_CH0` reader - This register stores the current descriptor state machine state."]
pub type OUT_DSCR_STATE_CH0_R = crate::FieldReader;
#[doc = "Field `OUT_STATE_CH0` reader - This register stores the current control module state machine state."]
pub type OUT_STATE_CH0_R = crate::FieldReader;
#[doc = "Field `OUT_RESET_AVAIL_CH0` reader - This register indicate that if the channel reset is safety."]
pub type OUT_RESET_AVAIL_CH0_R = crate::BitReader;
impl R {
    ...
    pub fn out_state_ch0(&self) -> OUT_STATE_CH0_R {
        OUT_STATE_CH0_R::new(((self.bits >> 20) & 0x0f) as u8)
    }
    #[doc = "Bit 24 - This register indicate that if the channel reset is safety."]
    #[inline(always)]
    pub fn out_reset_avail_ch0(&self) -> OUT_RESET_AVAIL_CH0_R {
        OUT_RESET_AVAIL_CH0_R::new(((self.bits >> 24) & 1) != 0)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_STATE_CH0")
            .field(
                ...
                &format_args!("{}", self.outlink_dscr_addr_ch0().bits()),
            )
            .field(
                "out_dscr_state_ch0",
                &format_args!("{}", self.out_dscr_state_ch0().bits()),
            )
            .field(
                "out_state_ch0",
                &format_args!("{}", self.out_state_ch0().bits()),
            )
            .field(
                "out_reset_avail_ch0",
                &format_args!("{}", self.out_reset_avail_ch0().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<OUT_STATE_CH0_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "TX CH0 state register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`out_state_ch0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets OUT_STATE_CH0 to value 0x0100_0000"]
