///Register `COUNTER_RST` reader
pub type R = crate::R<COUNTER_RST_SPEC>;
///Register `COUNTER_RST` writer
pub type W = crate::W<COUNTER_RST_SPEC>;
///Field `RX_CH0_EXTER_COUNTER_RST` reader - Write 1 then write 0 to this bit to reset rx ch0 counter.
pub type RX_CH0_EXTER_COUNTER_RST_R = crate::BitReader;
///Field `RX_CH0_EXTER_COUNTER_RST` writer - Write 1 then write 0 to this bit to reset rx ch0 counter.
pub type RX_CH0_EXTER_COUNTER_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_CH1_EXTER_COUNTER_RST` reader - Write 1 then write 0 to this bit to reset rx ch1 counter.
pub type RX_CH1_EXTER_COUNTER_RST_R = crate::BitReader;
///Field `RX_CH1_EXTER_COUNTER_RST` writer - Write 1 then write 0 to this bit to reset rx ch1 counter.
pub type RX_CH1_EXTER_COUNTER_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_CH2_INTER_COUNTER_RST` reader - Write 1 then write 0 to this bit to reset rx ch2 counter.
pub type RX_CH2_INTER_COUNTER_RST_R = crate::BitReader;
///Field `RX_CH2_INTER_COUNTER_RST` writer - Write 1 then write 0 to this bit to reset rx ch2 counter.
pub type RX_CH2_INTER_COUNTER_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_CH5_INTER_COUNTER_RST` reader - Write 1 then write 0 to this bit to reset rx ch5 counter.
pub type RX_CH5_INTER_COUNTER_RST_R = crate::BitReader;
///Field `RX_CH5_INTER_COUNTER_RST` writer - Write 1 then write 0 to this bit to reset rx ch5 counter.
pub type RX_CH5_INTER_COUNTER_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Write 1 then write 0 to this bit to reset rx ch0 counter.
    #[inline(always)]
    pub fn rx_ch0_exter_counter_rst(&self) -> RX_CH0_EXTER_COUNTER_RST_R {
        RX_CH0_EXTER_COUNTER_RST_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Write 1 then write 0 to this bit to reset rx ch1 counter.
    #[inline(always)]
    pub fn rx_ch1_exter_counter_rst(&self) -> RX_CH1_EXTER_COUNTER_RST_R {
        RX_CH1_EXTER_COUNTER_RST_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Write 1 then write 0 to this bit to reset rx ch2 counter.
    #[inline(always)]
    pub fn rx_ch2_inter_counter_rst(&self) -> RX_CH2_INTER_COUNTER_RST_R {
        RX_CH2_INTER_COUNTER_RST_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Write 1 then write 0 to this bit to reset rx ch5 counter.
    #[inline(always)]
...
///`read()` method returns [`counter_rst::R`](R) reader structure
impl crate::Readable for COUNTER_RST_SPEC {}
///`write(|w| ..)` method takes [`counter_rst::W`](W) writer structure
