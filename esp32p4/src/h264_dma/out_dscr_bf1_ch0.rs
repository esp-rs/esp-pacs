...
#[doc = "Field `OUTLINK_DSCR_BF1_CH0` reader - The address of the second-to-last outlink descriptor's next address y-2."]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DSCR_BF1_CH0")
            .field(
                ...
                &format_args!("{}", self.outlink_dscr_bf1_ch0().bits()),
            )
            .finish()
    }
}
