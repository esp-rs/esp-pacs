...
pub type R = crate::R<OUT_DSCR_BF1_CH1_SPEC>;
#[doc = "Field `OUTLINK_DSCR_BF1_CH1` reader - The address of the second-to-last outlink descriptor's next address y-2."]
pub type OUTLINK_DSCR_BF1_CH1_R = crate::FieldReader<u32>;
impl R {
    ...
    pub fn outlink_dscr_bf1_ch1(&self) -> OUTLINK_DSCR_BF1_CH1_R {
        OUTLINK_DSCR_BF1_CH1_R::new(self.bits)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DSCR_BF1_CH1")
            .field(
                "outlink_dscr_bf1_ch1",
                &format_args!("{}", self.outlink_dscr_bf1_ch1().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<OUT_DSCR_BF1_CH1_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "TX CH1 second-to-last dscr addr register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`out_dscr_bf1_ch1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
