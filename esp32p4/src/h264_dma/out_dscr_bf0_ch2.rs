...
#[doc = "Field `OUTLINK_DSCR_BF0_CH2` reader - The address of the last outlink descriptor's next address y-1."]
pub type OUTLINK_DSCR_BF0_CH2_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The address of the last outlink descriptor's next address y-1."]
    #[inline(always)]
    pub fn outlink_dscr_bf0_ch2(&self) -> OUTLINK_DSCR_BF0_CH2_R {
        OUTLINK_DSCR_BF0_CH2_R::new(self.bits)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DSCR_BF0_CH2")
            .field(
                ...
                &format_args!("{}", self.outlink_dscr_bf0_ch2().bits()),
            )
            .finish()
    }
}
