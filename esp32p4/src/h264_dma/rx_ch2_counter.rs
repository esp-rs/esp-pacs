///Register `RX_CH2_COUNTER` reader
pub type R = crate::R<RX_CH2_COUNTER_SPEC>;
///Field `RX_CH2_CNT` reader - rx ch2 counter register
pub type RX_CH2_CNT_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:10 - rx ch2 counter register
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rx_ch2_counter::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RX_CH2_COUNTER_SPEC;
impl crate::RegisterSpec for RX_CH2_COUNTER_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rx_ch2_counter::R`](R) reader structure
