...
#[doc = "Field `OUTLINK_DSCR_CH1` reader - The address of the next outlink descriptor address y."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DSCR_CH1")
            .field(
                "outlink_dscr_ch1",
                &format_args!("{}", self.outlink_dscr_ch1().bits()),
            )
            .finish()
    }
}
...
#[doc = "TX CH1 next dscr addr register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`out_dscr_ch1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
