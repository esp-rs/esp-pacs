///Register `RX_CH0_COUNTER` reader
pub type R = crate::R<RX_CH0_COUNTER_SPEC>;
///Field `RX_CH0_CNT` reader - rx ch0 counter register
pub type RX_CH0_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:22 - rx ch0 counter register
    #[inline(always)]
...
///`read()` method returns [`rx_ch0_counter::R`](R) reader structure
