///Register `INTER_MEM_END_ADDR0` reader
pub type R = crate::R<INTER_MEM_END_ADDR0_SPEC>;
///Register `INTER_MEM_END_ADDR0` writer
pub type W = crate::W<INTER_MEM_END_ADDR0_SPEC>;
///Field `ACCESS_INTER_MEM_END_ADDR0` reader - The end address of accessible address space. The access address beyond this range would lead to descriptor error.
pub type ACCESS_INTER_MEM_END_ADDR0_R = crate::FieldReader<u32>;
///Field `ACCESS_INTER_MEM_END_ADDR0` writer - The end address of accessible address space. The access address beyond this range would lead to descriptor error.
...
///`read()` method returns [`inter_mem_end_addr0::R`](R) reader structure
impl crate::Readable for INTER_MEM_END_ADDR0_SPEC {}
///`write(|w| ..)` method takes [`inter_mem_end_addr0::W`](W) writer structure
