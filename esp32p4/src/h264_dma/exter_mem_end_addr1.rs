///Register `EXTER_MEM_END_ADDR1` reader
pub type R = crate::R<EXTER_MEM_END_ADDR1_SPEC>;
///Register `EXTER_MEM_END_ADDR1` writer
pub type W = crate::W<EXTER_MEM_END_ADDR1_SPEC>;
///Field `ACCESS_EXTER_MEM_END_ADDR1` reader - The end address of accessible address space. The access address beyond this range would lead to descriptor error.
pub type ACCESS_EXTER_MEM_END_ADDR1_R = crate::FieldReader<u32>;
///Field `ACCESS_EXTER_MEM_END_ADDR1` writer - The end address of accessible address space. The access address beyond this range would lead to descriptor error.
...
///`read()` method returns [`exter_mem_end_addr1::R`](R) reader structure
impl crate::Readable for EXTER_MEM_END_ADDR1_SPEC {}
///`write(|w| ..)` method takes [`exter_mem_end_addr1::W`](W) writer structure
