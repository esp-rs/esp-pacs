///Register `OUT_ARB_CONFIG` reader
pub type R = crate::R<OUT_ARB_CONFIG_SPEC>;
///Register `OUT_ARB_CONFIG` writer
pub type W = crate::W<OUT_ARB_CONFIG_SPEC>;
///Field `OUT_ARB_TIMEOUT_NUM` reader - Set the max number of timeout count of arbiter
pub type OUT_ARB_TIMEOUT_NUM_R = crate::FieldReader<u16>;
///Field `OUT_ARB_TIMEOUT_NUM` writer - Set the max number of timeout count of arbiter
pub type OUT_ARB_TIMEOUT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `OUT_WEIGHT_EN` reader - reserved
pub type OUT_WEIGHT_EN_R = crate::BitReader;
///Field `OUT_WEIGHT_EN` writer - reserved
...
///`read()` method returns [`out_arb_config::R`](R) reader structure
impl crate::Readable for OUT_ARB_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`out_arb_config::W`](W) writer structure
