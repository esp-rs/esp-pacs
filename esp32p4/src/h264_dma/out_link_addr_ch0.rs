...
#[doc = "Field `OUTLINK_ADDR_CH0` reader - This register stores the first outlink descriptor's address."]
pub type OUTLINK_ADDR_CH0_R = crate::FieldReader<u32>;
#[doc = "Field `OUTLINK_ADDR_CH0` writer - This register stores the first outlink descriptor's address."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_LINK_ADDR_CH0")
            .field(
                "outlink_addr_ch0",
                &format_args!("{}", self.outlink_addr_ch0().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<OUT_LINK_ADDR_CH0_SPEC> {
