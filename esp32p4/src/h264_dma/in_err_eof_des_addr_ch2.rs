...
#[doc = "Field `IN_ERR_EOF_DES_ADDR_CH2` reader - This register stores the address of the inlink descriptor when there are some errors in current receiving data."]
pub type IN_ERR_EOF_DES_ADDR_CH2_R = crate::FieldReader<u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_ERR_EOF_DES_ADDR_CH2")
            .field(
                ...
                &format_args!("{}", self.in_err_eof_des_addr_ch2().bits()),
            )
            .finish()
    }
}
