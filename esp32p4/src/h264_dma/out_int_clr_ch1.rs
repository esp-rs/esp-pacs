...
#[doc = "Field `OUTFIFO_OVF_L1_CH1_INT_CLR` writer - Set this bit to clear the OUTFIFO_OVF_L1_CH_INT interrupt."]
pub type OUTFIFO_OVF_L1_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_UDF_L1_CH1_INT_CLR` writer - Set this bit to clear the OUTFIFO_UDF_L1_CH_INT interrupt."]
pub type OUTFIFO_UDF_L1_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_OVF_L2_CH1_INT_CLR` writer - Set this bit to clear the OUTFIFO_OVF_L2_CH_INT interrupt."]
pub type OUTFIFO_OVF_L2_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_UDF_L2_CH1_INT_CLR` writer - Set this bit to clear the OUTFIFO_UDF_L2_CH_INT interrupt."]
pub type OUTFIFO_UDF_L2_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_DSCR_TASK_OVF_CH1_INT_CLR` writer - Set this bit to clear the OUT_DSCR_TASK_OVF_CH_INT interrupt."]
pub type OUT_DSCR_TASK_OVF_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn outfifo_ovf_l1_ch1_int_clr(
        &mut self,
    ) -> OUTFIFO_OVF_L1_CH1_INT_CLR_W<OUT_INT_CLR_CH1_SPEC> {
        OUTFIFO_OVF_L1_CH1_INT_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - Set this bit to clear the OUTFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn outfifo_udf_l1_ch1_int_clr(
        &mut self,
    ) -> OUTFIFO_UDF_L1_CH1_INT_CLR_W<OUT_INT_CLR_CH1_SPEC> {
        OUTFIFO_UDF_L1_CH1_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Set this bit to clear the OUTFIFO_OVF_L2_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn outfifo_ovf_l2_ch1_int_clr(
        &mut self,
    ) -> OUTFIFO_OVF_L2_CH1_INT_CLR_W<OUT_INT_CLR_CH1_SPEC> {
        OUTFIFO_OVF_L2_CH1_INT_CLR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Set this bit to clear the OUTFIFO_UDF_L2_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn outfifo_udf_l2_ch1_int_clr(
        &mut self,
    ) -> OUTFIFO_UDF_L2_CH1_INT_CLR_W<OUT_INT_CLR_CH1_SPEC> {
        OUTFIFO_UDF_L2_CH1_INT_CLR_W::new(self, 7)
    }
    #[doc = "Bit 8 - Set this bit to clear the OUT_DSCR_TASK_OVF_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn out_dscr_task_ovf_ch1_int_clr(
        &mut self,
    ) -> OUT_DSCR_TASK_OVF_CH1_INT_CLR_W<OUT_INT_CLR_CH1_SPEC> {
        OUT_DSCR_TASK_OVF_CH1_INT_CLR_W::new(self, 8)
    }
...
#[doc = "TX CH1 interrupt clr register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`out_int_clr_ch1::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
