///Register `ERR_EOF_DES_ADDR` reader
pub type R = crate::R<ERR_EOF_DES_ADDR_SPEC>;
///Field `IN_ERR_EOF_DES_ADDR` reader - This register stores the address of the inlink descriptor when there are some errors in current receiving data.
pub type IN_ERR_EOF_DES_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the address of the inlink descriptor when there are some errors in current receiving data.
    #[inline(always)]
...
///`read()` method returns [`err_eof_des_addr::R`](R) reader structure
impl crate::Readable for ERR_EOF_DES_ADDR_SPEC {}
///`reset()` method sets ERR_EOF_DES_ADDR to value 0
