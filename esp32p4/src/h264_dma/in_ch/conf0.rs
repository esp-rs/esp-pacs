...
///Field `INDSCR_BURST_EN` reader - Set this bit to 1 to enable INCR burst transfer for Rx transmitting link descriptor when accessing SRAM.
pub type INDSCR_BURST_EN_R = crate::BitReader;
///Field `INDSCR_BURST_EN` writer - Set this bit to 1 to enable INCR burst transfer for Rx transmitting link descriptor when accessing SRAM.
pub type INDSCR_BURST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_ECC_AES_EN` reader - When access address space is ecc/aes area, this bit should be set to 1. In this case, the start address of square should be 16-bit aligned. The width of square multiply byte number of one pixel should be 16-bit aligned.
pub type IN_ECC_AES_EN_R = crate::BitReader;
///Field `IN_ECC_AES_EN` writer - When access address space is ecc/aes area, this bit should be set to 1. In this case, the start address of square should be 16-bit aligned. The width of square multiply byte number of one pixel should be 16-bit aligned.
...
///Field `IN_MEM_BURST_LENGTH` reader - Block size of Rx channel 0. 0: single 1: 16 bytes 2: 32 bytes 3: 64 bytes 4: 128 bytes
pub type IN_MEM_BURST_LENGTH_R = crate::FieldReader;
///Field `IN_MEM_BURST_LENGTH` writer - Block size of Rx channel 0. 0: single 1: 16 bytes 2: 32 bytes 3: 64 bytes 4: 128 bytes
pub type IN_MEM_BURST_LENGTH_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `IN_PAGE_BOUND_EN` reader - Set this bit to 1 to make sure AXI write data don't cross the address boundary which define by mem_burst_length
pub type IN_PAGE_BOUND_EN_R = crate::BitReader;
///Field `IN_PAGE_BOUND_EN` writer - Set this bit to 1 to make sure AXI write data don't cross the address boundary which define by mem_burst_length
pub type IN_PAGE_BOUND_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_RST` reader - Write 1 then write 0 to this bit to reset Rx channel
pub type IN_RST_R = crate::BitReader;
///Field `IN_RST` writer - Write 1 then write 0 to this bit to reset Rx channel
pub type IN_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_CMD_DISABLE` reader - Write 1 before reset and write 0 after reset
pub type IN_CMD_DISABLE_R = crate::BitReader;
///Field `IN_CMD_DISABLE` writer - Write 1 before reset and write 0 after reset
pub type IN_CMD_DISABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_ARB_WEIGHT_OPT_DIS` reader - Set this bit to 1 to disable arbiter optimum weight function.
pub type IN_ARB_WEIGHT_OPT_DIS_R = crate::BitReader;
///Field `IN_ARB_WEIGHT_OPT_DIS` writer - Set this bit to 1 to disable arbiter optimum weight function.
pub type IN_ARB_WEIGHT_OPT_DIS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 2 - Set this bit to 1 to enable INCR burst transfer for Rx transmitting link descriptor when accessing SRAM.
    #[inline(always)]
    ...
    ///Bits 6:8 - Block size of Rx channel 0. 0: single 1: 16 bytes 2: 32 bytes 3: 64 bytes 4: 128 bytes
    #[inline(always)]
    pub fn in_mem_burst_length(&self) -> IN_MEM_BURST_LENGTH_R {
        IN_MEM_BURST_LENGTH_R::new(((self.bits >> 6) & 7) as u8)
    }
    ///Bit 12 - Set this bit to 1 to make sure AXI write data don't cross the address boundary which define by mem_burst_length
    #[inline(always)]
    pub fn in_page_bound_en(&self) -> IN_PAGE_BOUND_EN_R {
        IN_PAGE_BOUND_EN_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 24 - Write 1 then write 0 to this bit to reset Rx channel
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF0")
            ...
            .field("in_arb_weight_opt_dis", &self.in_arb_weight_opt_dis())
            .finish()
    }
}
impl W {
