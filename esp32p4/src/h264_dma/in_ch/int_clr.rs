...
///Field `IN_DSCR_ERR` writer - Set this bit to clear the INDSCR_ERR_CH_INT interrupt.
...
///Field `INFIFO_OVF_L2` writer - Set this bit to clear the INFIFO_OVF_L2_CH_INT interrupt.
pub type INFIFO_OVF_L2_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `INFIFO_UDF_L2` writer - Set this bit to clear the INFIFO_UDF_L2_CH_INT interrupt.
...
///Field `IN_DSCR_TASK_OVF` writer - Set this bit to clear the IN_DSCR_TASK_OVF_CH_INT interrupt.
