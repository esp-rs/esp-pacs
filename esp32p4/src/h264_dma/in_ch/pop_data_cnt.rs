///Register `POP_DATA_CNT` reader
pub type R = crate::R<POP_DATA_CNT_SPEC>;
///Field `IN_CMDFIFO_POP_DATA_CNT` reader - only for debug
...
///`read()` method returns [`pop_data_cnt::R`](R) reader structure
impl crate::Readable for POP_DATA_CNT_SPEC {}
///`reset()` method sets POP_DATA_CNT to value 0x07
