...
///Field `INFIFO_FULL_L2` reader - Rx FIFO full signal for Rx channel.
pub type INFIFO_FULL_L2_R = crate::BitReader;
///Field `INFIFO_EMPTY_L2` reader - Rx FIFO empty signal for Rx channel.
pub type INFIFO_EMPTY_L2_R = crate::BitReader;
///Field `INFIFO_CNT_L2` reader - The register stores the byte number of the data in Rx FIFO for Rx channel.
pub type INFIFO_CNT_L2_R = crate::FieldReader;
///Field `INFIFO_FULL_L1` reader - Tx FIFO full signal for Tx channel 0.
pub type INFIFO_FULL_L1_R = crate::BitReader;
///Field `INFIFO_EMPTY_L1` reader - Tx FIFO empty signal for Tx channel 0.
pub type INFIFO_EMPTY_L1_R = crate::BitReader;
///Field `INFIFO_CNT_L1` reader - The register stores the byte number of the data in Tx FIFO for Tx channel 0.
pub type INFIFO_CNT_L1_R = crate::FieldReader;
///Field `INFIFO_FULL_L3` reader - Tx FIFO full signal for Tx channel 0.
pub type INFIFO_FULL_L3_R = crate::BitReader;
///Field `INFIFO_EMPTY_L3` reader - Tx FIFO empty signal for Tx channel 0.
pub type INFIFO_EMPTY_L3_R = crate::BitReader;
///Field `INFIFO_CNT_L3` reader - The register stores the 8byte number of the data in Tx FIFO for Tx channel 0.
pub type INFIFO_CNT_L3_R = crate::FieldReader;
impl R {
    ///Bit 0 - Rx FIFO full signal for Rx channel.
    #[inline(always)]
    pub fn infifo_full_l2(&self) -> INFIFO_FULL_L2_R {
        INFIFO_FULL_L2_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Rx FIFO empty signal for Rx channel.
    #[inline(always)]
    pub fn infifo_empty_l2(&self) -> INFIFO_EMPTY_L2_R {
        INFIFO_EMPTY_L2_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:5 - The register stores the byte number of the data in Rx FIFO for Rx channel.
    #[inline(always)]
