...
///Field `INFIFO_OVF_L2` reader - The interrupt enable bit for the INFIFO_OVF_L2_CH_INT interrupt.
pub type INFIFO_OVF_L2_R = crate::BitReader;
///Field `INFIFO_OVF_L2` writer - The interrupt enable bit for the INFIFO_OVF_L2_CH_INT interrupt.
pub type INFIFO_OVF_L2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_UDF_L2` reader - The interrupt enable bit for the INFIFO_UDF_L2_CH_INT interrupt.
pub type INFIFO_UDF_L2_R = crate::BitReader;
///Field `INFIFO_UDF_L2` writer - The interrupt enable bit for the INFIFO_UDF_L2_CH_INT interrupt.
...
///Field `IN_DSCR_TASK_OVF` reader - The interrupt enable bit for the IN_DSCR_TASK_OVF_CH_INT interrupt.
pub type IN_DSCR_TASK_OVF_R = crate::BitReader;
///Field `IN_DSCR_TASK_OVF` writer - The interrupt enable bit for the IN_DSCR_TASK_OVF_CH_INT interrupt.
...
impl R {
    ...
    ///Bit 4 - The interrupt enable bit for the INFIFO_OVF_L1_CH_INT interrupt.
    #[inline(always)]
    pub fn infifo_ovf_l1(&self) -> INFIFO_OVF_L1_R {
        INFIFO_OVF_L1_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - The interrupt enable bit for the INFIFO_UDF_L1_CH_INT interrupt.
    #[inline(always)]
    pub fn infifo_udf_l1(&self) -> INFIFO_UDF_L1_R {
        INFIFO_UDF_L1_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - The interrupt enable bit for the INFIFO_OVF_L2_CH_INT interrupt.
    #[inline(always)]
    pub fn infifo_ovf_l2(&self) -> INFIFO_OVF_L2_R {
        INFIFO_OVF_L2_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - The interrupt enable bit for the INFIFO_UDF_L2_CH_INT interrupt.
    #[inline(always)]
    pub fn infifo_udf_l2(&self) -> INFIFO_UDF_L2_R {
        INFIFO_UDF_L2_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - The interrupt enable bit for the IN_DSCR_EMPTY_CH_INT interrupt.
    #[inline(always)]
    pub fn in_dscr_empty(&self) -> IN_DSCR_EMPTY_R {
        IN_DSCR_EMPTY_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - The interrupt enable bit for the IN_DSCR_TASK_OVF_CH_INT interrupt.
    #[inline(always)]
