...
///Field `EXTER_IN_ARB_PRIORITY` reader - Set the priority of channel
pub type EXTER_IN_ARB_PRIORITY_R = crate::FieldReader;
///Field `EXTER_IN_ARB_PRIORITY` writer - Set the priority of channel
...
///`reset()` method sets ARB to value 0x51
