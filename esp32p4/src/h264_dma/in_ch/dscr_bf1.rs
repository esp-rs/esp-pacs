...
///Field `INLINK_DSCR_BF1` reader - The address of the second-to-last inlink descriptor's next address x-2.
pub type INLINK_DSCR_BF1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The address of the second-to-last inlink descriptor's next address x-2.
    #[inline(always)]
