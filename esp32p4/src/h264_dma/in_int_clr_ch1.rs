...
#[doc = "Field `IN_DSCR_ERR_CH1_INT_CLR` writer - Set this bit to clear the INDSCR_ERR_CH_INT interrupt."]
pub type IN_DSCR_ERR_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_OVF_L1_CH1_INT_CLR` writer - Set this bit to clear the INFIFO_OVF_L1_CH_INT interrupt."]
pub type INFIFO_OVF_L1_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_UDF_L1_CH1_INT_CLR` writer - Set this bit to clear the INFIFO_UDF_L1_CH_INT interrupt."]
pub type INFIFO_UDF_L1_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_OVF_L2_CH1_INT_CLR` writer - Set this bit to clear the INFIFO_OVF_L2_CH_INT interrupt."]
pub type INFIFO_OVF_L2_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_UDF_L2_CH1_INT_CLR` writer - Set this bit to clear the INFIFO_UDF_L2_CH_INT interrupt."]
pub type INFIFO_UDF_L2_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `IN_DSCR_TASK_OVF_CH1_INT_CLR` writer - Set this bit to clear the IN_DSCR_TASK_OVF_CH_INT interrupt."]
pub type IN_DSCR_TASK_OVF_CH1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn infifo_ovf_l1_ch1_int_clr(
        &mut self,
    ) -> INFIFO_OVF_L1_CH1_INT_CLR_W<IN_INT_CLR_CH1_SPEC> {
        INFIFO_OVF_L1_CH1_INT_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - Set this bit to clear the INFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_udf_l1_ch1_int_clr(
        &mut self,
    ) -> INFIFO_UDF_L1_CH1_INT_CLR_W<IN_INT_CLR_CH1_SPEC> {
        INFIFO_UDF_L1_CH1_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Set this bit to clear the INFIFO_OVF_L2_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_ovf_l2_ch1_int_clr(
        &mut self,
    ) -> INFIFO_OVF_L2_CH1_INT_CLR_W<IN_INT_CLR_CH1_SPEC> {
        INFIFO_OVF_L2_CH1_INT_CLR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Set this bit to clear the INFIFO_UDF_L2_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_udf_l2_ch1_int_clr(
        &mut self,
    ) -> INFIFO_UDF_L2_CH1_INT_CLR_W<IN_INT_CLR_CH1_SPEC> {
        INFIFO_UDF_L2_CH1_INT_CLR_W::new(self, 7)
    }
    ...
    pub fn in_dscr_empty_ch1_int_clr(
        ...
        IN_DSCR_EMPTY_CH1_INT_CLR_W::new(self, 8)
    }
    #[doc = "Bit 9 - Set this bit to clear the IN_DSCR_TASK_OVF_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn in_dscr_task_ovf_ch1_int_clr(
        &mut self,
    ) -> IN_DSCR_TASK_OVF_CH1_INT_CLR_W<IN_INT_CLR_CH1_SPEC> {
        IN_DSCR_TASK_OVF_CH1_INT_CLR_W::new(self, 9)
    }
}
#[doc = "RX CH1 interrupt clr register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`in_int_clr_ch1::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
