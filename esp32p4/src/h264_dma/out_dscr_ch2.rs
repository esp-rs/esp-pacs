...
#[doc = "Field `OUTLINK_DSCR_CH2` reader - The address of the next outlink descriptor address y."]
pub type OUTLINK_DSCR_CH2_R = crate::FieldReader<u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DSCR_CH2")
            .field(
                "outlink_dscr_ch2",
                &format_args!("{}", self.outlink_dscr_ch2().bits()),
            )
            .finish()
    }
}
