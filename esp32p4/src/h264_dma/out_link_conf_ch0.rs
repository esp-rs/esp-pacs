#[doc = "Register `OUT_LINK_CONF_CH0` reader"]
pub type R = crate::R<OUT_LINK_CONF_CH0_SPEC>;
#[doc = "Register `OUT_LINK_CONF_CH0` writer"]
pub type W = crate::W<OUT_LINK_CONF_CH0_SPEC>;
#[doc = "Field `OUTLINK_STOP_CH0` reader - Set this bit to stop dealing with the outlink descriptors."]
pub type OUTLINK_STOP_CH0_R = crate::BitReader;
...
pub type OUTLINK_START_CH0_R = crate::BitReader;
...
pub type OUTLINK_RESTART_CH0_R = crate::BitReader;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_LINK_CONF_CH0")
            .field(
                "outlink_stop_ch0",
                &format_args!("{}", self.outlink_stop_ch0().bit()),
            )
            .field(
                "outlink_start_ch0",
                &format_args!("{}", self.outlink_start_ch0().bit()),
            )
            .field(
                "outlink_restart_ch0",
                &format_args!("{}", self.outlink_restart_ch0().bit()),
            )
            .field(
                "outlink_park_ch0",
                &format_args!("{}", self.outlink_park_ch0().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<OUT_LINK_CONF_CH0_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn outlink_stop_ch0(&mut self) -> OUTLINK_STOP_CH0_W<OUT_LINK_CONF_CH0_SPEC> {
        OUTLINK_STOP_CH0_W::new(self, 20)
    }
    #[doc = "Bit 21 - Set this bit to start dealing with the outlink descriptors."]
    #[inline(always)]
    #[must_use]
    pub fn outlink_start_ch0(&mut self) -> OUTLINK_START_CH0_W<OUT_LINK_CONF_CH0_SPEC> {
        OUTLINK_START_CH0_W::new(self, 21)
    }
    #[doc = "Bit 22 - Set this bit to restart a new outlink from the last address."]
    #[inline(always)]
    #[must_use]
    pub fn outlink_restart_ch0(&mut self) -> OUTLINK_RESTART_CH0_W<OUT_LINK_CONF_CH0_SPEC> {
        OUTLINK_RESTART_CH0_W::new(self, 22)
    }
...
pub struct OUT_LINK_CONF_CH0_SPEC;
impl crate::RegisterSpec for OUT_LINK_CONF_CH0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`out_link_conf_ch0::R`](R) reader structure"]
impl crate::Readable for OUT_LINK_CONF_CH0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`out_link_conf_ch0::W`](W) writer structure"]
impl crate::Writable for OUT_LINK_CONF_CH0_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets OUT_LINK_CONF_CH0 to value 0x0080_0000"]
impl crate::Resettable for OUT_LINK_CONF_CH0_SPEC {
