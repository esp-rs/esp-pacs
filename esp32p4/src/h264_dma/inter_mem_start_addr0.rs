///Register `INTER_MEM_START_ADDR0` reader
pub type R = crate::R<INTER_MEM_START_ADDR0_SPEC>;
///Register `INTER_MEM_START_ADDR0` writer
pub type W = crate::W<INTER_MEM_START_ADDR0_SPEC>;
///Field `ACCESS_INTER_MEM_START_ADDR0` reader - The start address of accessible address space.
pub type ACCESS_INTER_MEM_START_ADDR0_R = crate::FieldReader<u32>;
///Field `ACCESS_INTER_MEM_START_ADDR0` writer - The start address of accessible address space.
...
///`read()` method returns [`inter_mem_start_addr0::R`](R) reader structure
impl crate::Readable for INTER_MEM_START_ADDR0_SPEC {}
///`write(|w| ..)` method takes [`inter_mem_start_addr0::W`](W) writer structure
