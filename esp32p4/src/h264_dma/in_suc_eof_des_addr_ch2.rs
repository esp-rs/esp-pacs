...
pub type R = crate::R<IN_SUC_EOF_DES_ADDR_CH2_SPEC>;
...
pub type IN_SUC_EOF_DES_ADDR_CH2_R = crate::FieldReader<u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_SUC_EOF_DES_ADDR_CH2")
            .field(
                ...
                &format_args!("{}", self.in_suc_eof_des_addr_ch2().bits()),
            )
            .finish()
    }
}
...
#[doc = "RX CH2 eof des addr register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`in_suc_eof_des_addr_ch2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
