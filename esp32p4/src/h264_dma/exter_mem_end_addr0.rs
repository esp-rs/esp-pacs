///Register `EXTER_MEM_END_ADDR0` reader
pub type R = crate::R<EXTER_MEM_END_ADDR0_SPEC>;
///Register `EXTER_MEM_END_ADDR0` writer
pub type W = crate::W<EXTER_MEM_END_ADDR0_SPEC>;
///Field `ACCESS_EXTER_MEM_END_ADDR0` reader - The end address of accessible address space. The access address beyond this range would lead to descriptor error.
pub type ACCESS_EXTER_MEM_END_ADDR0_R = crate::FieldReader<u32>;
///Field `ACCESS_EXTER_MEM_END_ADDR0` writer - The end address of accessible address space. The access address beyond this range would lead to descriptor error.
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EXTER_MEM_END_ADDR0")
            .field(
                ...
                &self.access_exter_mem_end_addr0(),
            )
            .finish()
    }
}
...
///`read()` method returns [`exter_mem_end_addr0::R`](R) reader structure
impl crate::Readable for EXTER_MEM_END_ADDR0_SPEC {}
///`write(|w| ..)` method takes [`exter_mem_end_addr0::W`](W) writer structure
