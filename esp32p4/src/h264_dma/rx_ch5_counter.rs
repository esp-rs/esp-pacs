///Register `RX_CH5_COUNTER` reader
pub type R = crate::R<RX_CH5_COUNTER_SPEC>;
///Field `RX_CH5_CNT` reader - rx ch5 counter register
pub type RX_CH5_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:16 - rx ch5 counter register
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_CH5_COUNTER")
            .field("rx_ch5_cnt", &self.rx_ch5_cnt())
            .finish()
    }
}
...
///`read()` method returns [`rx_ch5_counter::R`](R) reader structure
