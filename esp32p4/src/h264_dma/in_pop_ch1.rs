...
#[doc = "Field `INFIFO_RDATA_CH1` reader - This register stores the data popping from DMA Rx FIFO."]
pub type INFIFO_RDATA_CH1_R = crate::FieldReader<u16>;
#[doc = "Field `INFIFO_POP_CH1` reader - Set this bit to pop data from DMA Rx FIFO."]
pub type INFIFO_POP_CH1_R = crate::BitReader;
#[doc = "Field `INFIFO_POP_CH1` writer - Set this bit to pop data from DMA Rx FIFO."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_POP_CH1")
            .field(
                "infifo_rdata_ch1",
                &format_args!("{}", self.infifo_rdata_ch1().bits()),
            )
            .field(
                "infifo_pop_ch1",
                &format_args!("{}", self.infifo_pop_ch1().bit()),
            )
            .finish()
    }
}
...
#[doc = "`reset()` method sets IN_POP_CH1 to value 0x0400"]
