...
///`read()` method returns [`sw_standby_cfg::R`](R) reader structure
impl crate::Readable for SW_STANDBY_CFG_SPEC {}
///`write(|w| ..)` method takes [`sw_standby_cfg::W`](W) writer structure
