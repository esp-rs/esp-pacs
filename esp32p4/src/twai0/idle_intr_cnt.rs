///Register `IDLE_INTR_CNT` reader
pub type R = crate::R<IDLE_INTR_CNT_SPEC>;
///Register `IDLE_INTR_CNT` writer
pub type W = crate::W<IDLE_INTR_CNT_SPEC>;
///Field `IDLE_INTR_CNT` reader - Configure the number of cycles before triggering idle interrupt.
pub type IDLE_INTR_CNT_R = crate::FieldReader<u32>;
///Field `IDLE_INTR_CNT` writer - Configure the number of cycles before triggering idle interrupt.
pub type IDLE_INTR_CNT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configure the number of cycles before triggering idle interrupt.
    #[inline(always)]
...
///`read()` method returns [`idle_intr_cnt::R`](R) reader structure
impl crate::Readable for IDLE_INTR_CNT_SPEC {}
///`write(|w| ..)` method takes [`idle_intr_cnt::W`](W) writer structure
