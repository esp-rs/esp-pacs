...
///Field `RECEIVE_BUFFER` reader - 1: full, one or more complete messages are available in the RXFIFO. 0: empty, no message is available
pub type RECEIVE_BUFFER_R = crate::BitReader;
///Field `OVERRUN` reader - 1: overrun, a message was lost because there was not enough space for that message in the RXFIFO. 0: absent, no data overrun has occurred since the last clear data overrun command was given
pub type OVERRUN_R = crate::BitReader;
///Field `TRANSMIT_BUFFER` reader - 1: released, the CPU may write a message into the transmit buffer. 0: locked, the CPU cannot access the transmit buffer, a message is either waiting for transmission or is in the process of being transmitted
pub type TRANSMIT_BUFFER_R = crate::BitReader;
///Field `TRANSMISSION_COMPLETE` reader - 1: complete, last requested transmission has been successfully completed. 0: incomplete, previously requested transmission is not yet completed
pub type TRANSMISSION_COMPLETE_R = crate::BitReader;
///Field `RECEIVE` reader - 1: receive, the TWAI controller is receiving a message. 0: idle
pub type RECEIVE_R = crate::BitReader;
///Field `TRANSMIT` reader - 1: transmit, the TWAI controller is transmitting a message. 0: idle
pub type TRANSMIT_R = crate::BitReader;
///Field `ERR` reader - 1: error, at least one of the error counters has reached or exceeded the CPU warning limit defined by the Error Warning Limit Register (EWLR). 0: ok, both error counters are below the warning limit
pub type ERR_R = crate::BitReader;
///Field `NODE_BUS_OFF` reader - 1: bus-off, the TWAI controller is not involved in bus activities. 0: bus-on, the TWAI controller is involved in bus activities
pub type NODE_BUS_OFF_R = crate::BitReader;
///Field `MISS` reader - 1: current message is destroyed because of FIFO overflow.
