///Register `TIMESTAMP_CFG` reader
pub type R = crate::R<TIMESTAMP_CFG_SPEC>;
///Register `TIMESTAMP_CFG` writer
pub type W = crate::W<TIMESTAMP_CFG_SPEC>;
///Field `TS_ENABLE` reader - enable the timestamp collection function.
pub type TS_ENABLE_R = crate::BitReader;
///Field `TS_ENABLE` writer - enable the timestamp collection function.
pub type TS_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - enable the timestamp collection function.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMESTAMP_CFG")
            .field("ts_enable", &self.ts_enable())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`timestamp_cfg::R`](R) reader structure
impl crate::Readable for TIMESTAMP_CFG_SPEC {}
///`write(|w| ..)` method takes [`timestamp_cfg::W`](W) writer structure
