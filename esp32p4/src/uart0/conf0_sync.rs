...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn irda_dplx(&mut self) -> IRDA_DPLX_W<CONF0_SYNC_SPEC> {
        IRDA_DPLX_W::new(self, 7)
    }
    #[doc = "Bit 8 - This is the start enable bit for IrDA transmitter."]
    #[inline(always)]
    #[must_use]
    pub fn irda_tx_en(&mut self) -> IRDA_TX_EN_W<CONF0_SYNC_SPEC> {
        IRDA_TX_EN_W::new(self, 8)
    }
    #[doc = "Bit 9 - 1'h1: The IrDA transmitter's 11th bit is the same as 10th bit. 1'h0: Set IrDA transmitter's 11th bit to 0."]
    #[inline(always)]
    #[must_use]
    pub fn irda_wctl(&mut self) -> IRDA_WCTL_W<CONF0_SYNC_SPEC> {
        IRDA_WCTL_W::new(self, 9)
    }
    #[doc = "Bit 10 - Set this bit to invert the level of IrDA transmitter."]
    #[inline(always)]
    #[must_use]
    pub fn irda_tx_inv(&mut self) -> IRDA_TX_INV_W<CONF0_SYNC_SPEC> {
        IRDA_TX_INV_W::new(self, 10)
    }
    #[doc = "Bit 11 - Set this bit to invert the level of IrDA receiver."]
    #[inline(always)]
    #[must_use]
    pub fn irda_rx_inv(&mut self) -> IRDA_RX_INV_W<CONF0_SYNC_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn irda_en(&mut self) -> IRDA_EN_W<CONF0_SYNC_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn autobaud_en(&mut self) -> AUTOBAUD_EN_W<CONF0_SYNC_SPEC> {
