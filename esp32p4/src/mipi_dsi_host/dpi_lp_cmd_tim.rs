...
///`read()` method returns [`dpi_lp_cmd_tim::R`](R) reader structure
impl crate::Readable for DPI_LP_CMD_TIM_SPEC {}
///`write(|w| ..)` method takes [`dpi_lp_cmd_tim::W`](W) writer structure
