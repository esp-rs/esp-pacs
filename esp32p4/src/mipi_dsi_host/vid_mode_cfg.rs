...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("VID_MODE_CFG")
            .field("vid_mode_type", &self.vid_mode_type().bits())
            .field("lp_vsa_en", &self.lp_vsa_en().bit())
            .field("lp_vbp_en", &self.lp_vbp_en().bit())
            .field("lp_vfp_en", &self.lp_vfp_en().bit())
            .field("lp_vact_en", &self.lp_vact_en().bit())
            .field("lp_hbp_en", &self.lp_hbp_en().bit())
            .field("lp_hfp_en", &self.lp_hfp_en().bit())
            .field("frame_bta_ack_en", &self.frame_bta_ack_en().bit())
            .field("lp_cmd_en", &self.lp_cmd_en().bit())
            .field("vpg_en", &self.vpg_en().bit())
            .field("vpg_mode", &self.vpg_mode().bit())
            .field("vpg_orientation", &self.vpg_orientation().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
