...
///`read()` method returns [`vid_mode_cfg::R`](R) reader structure
impl crate::Readable for VID_MODE_CFG_SPEC {}
///`write(|w| ..)` method takes [`vid_mode_cfg::W`](W) writer structure
