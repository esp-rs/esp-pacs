///Register `DPI_LP_CMD_TIM_ACT` reader
pub type R = crate::R<DPI_LP_CMD_TIM_ACT_SPEC>;
///Field `INVACT_LPCMD_TIME_ACT` reader - NA
pub type INVACT_LPCMD_TIME_ACT_R = crate::FieldReader;
///Field `OUTVACT_LPCMD_TIME_ACT` reader - NA
...
///`read()` method returns [`dpi_lp_cmd_tim_act::R`](R) reader structure
