...
///`read()` method returns [`sdf_3d::R`](R) reader structure
impl crate::Readable for SDF_3D_SPEC {}
///`write(|w| ..)` method takes [`sdf_3d::W`](W) writer structure
