...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("VID_MODE_CFG_ACT")
            .field("vid_mode_type_act", &self.vid_mode_type_act().bits())
            .field("lp_vsa_en_act", &self.lp_vsa_en_act().bit())
            .field("lp_vbp_en_act", &self.lp_vbp_en_act().bit())
            .field("lp_vfp_en_act", &self.lp_vfp_en_act().bit())
            .field("lp_vact_en_act", &self.lp_vact_en_act().bit())
            .field("lp_hbp_en_act", &self.lp_hbp_en_act().bit())
            .field("lp_hfp_en_act", &self.lp_hfp_en_act().bit())
            .field("frame_bta_ack_en_act", &self.frame_bta_ack_en_act().bit())
            .field("lp_cmd_en_act", &self.lp_cmd_en_act().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
