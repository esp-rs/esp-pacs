...
///`read()` method returns [`gen_pld_data::R`](R) reader structure
impl crate::Readable for GEN_PLD_DATA_SPEC {}
///`write(|w| ..)` method takes [`gen_pld_data::W`](W) writer structure
