///Register `DBI_PARTITIONING_EN` reader
pub type R = crate::R<DBI_PARTITIONING_EN_SPEC>;
///Register `DBI_PARTITIONING_EN` writer
pub type W = crate::W<DBI_PARTITIONING_EN_SPEC>;
///Field `PARTITIONING_EN` reader - NA
pub type PARTITIONING_EN_R = crate::BitReader;
///Field `PARTITIONING_EN` writer - NA
...
///`read()` method returns [`dbi_partitioning_en::R`](R) reader structure
impl crate::Readable for DBI_PARTITIONING_EN_SPEC {}
///`write(|w| ..)` method takes [`dbi_partitioning_en::W`](W) writer structure
