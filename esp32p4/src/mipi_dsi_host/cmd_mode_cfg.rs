...
///`read()` method returns [`cmd_mode_cfg::R`](R) reader structure
impl crate::Readable for CMD_MODE_CFG_SPEC {}
///`write(|w| ..)` method takes [`cmd_mode_cfg::W`](W) writer structure
