...
///`read()` method returns [`dpi_color_coding::R`](R) reader structure
impl crate::Readable for DPI_COLOR_CODING_SPEC {}
///`write(|w| ..)` method takes [`dpi_color_coding::W`](W) writer structure
