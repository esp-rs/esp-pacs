...
///`read()` method returns [`vid_hbp_time::R`](R) reader structure
impl crate::Readable for VID_HBP_TIME_SPEC {}
///`write(|w| ..)` method takes [`vid_hbp_time::W`](W) writer structure
