...
///`read()` method returns [`vid_shadow_ctrl::R`](R) reader structure
impl crate::Readable for VID_SHADOW_CTRL_SPEC {}
///`write(|w| ..)` method takes [`vid_shadow_ctrl::W`](W) writer structure
