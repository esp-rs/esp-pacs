///Register `VID_HSA_TIME_ACT` reader
pub type R = crate::R<VID_HSA_TIME_ACT_SPEC>;
///Field `VID_HSA_TIME_ACT` reader - NA
...
You can [`read`](crate::generic::Reg::read) this register and get [`vid_hsa_time_act::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct VID_HSA_TIME_ACT_SPEC;
impl crate::RegisterSpec for VID_HSA_TIME_ACT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`vid_hsa_time_act::R`](R) reader structure
