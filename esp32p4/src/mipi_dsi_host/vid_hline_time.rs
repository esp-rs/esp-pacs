...
///`read()` method returns [`vid_hline_time::R`](R) reader structure
impl crate::Readable for VID_HLINE_TIME_SPEC {}
///`write(|w| ..)` method takes [`vid_hline_time::W`](W) writer structure
