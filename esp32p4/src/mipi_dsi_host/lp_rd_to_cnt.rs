...
///`read()` method returns [`lp_rd_to_cnt::R`](R) reader structure
impl crate::Readable for LP_RD_TO_CNT_SPEC {}
///`write(|w| ..)` method takes [`lp_rd_to_cnt::W`](W) writer structure
