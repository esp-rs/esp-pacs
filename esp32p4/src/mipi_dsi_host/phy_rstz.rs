...
///`read()` method returns [`phy_rstz::R`](R) reader structure
impl crate::Readable for PHY_RSTZ_SPEC {}
///`write(|w| ..)` method takes [`phy_rstz::W`](W) writer structure
