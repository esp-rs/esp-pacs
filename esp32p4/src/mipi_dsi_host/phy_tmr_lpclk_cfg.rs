...
///`read()` method returns [`phy_tmr_lpclk_cfg::R`](R) reader structure
impl crate::Readable for PHY_TMR_LPCLK_CFG_SPEC {}
///`write(|w| ..)` method takes [`phy_tmr_lpclk_cfg::W`](W) writer structure
