...
///`read()` method returns [`dpi_cfg_pol::R`](R) reader structure
impl crate::Readable for DPI_CFG_POL_SPEC {}
///`write(|w| ..)` method takes [`dpi_cfg_pol::W`](W) writer structure
