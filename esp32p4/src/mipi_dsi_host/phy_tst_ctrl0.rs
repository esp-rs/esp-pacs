///Register `PHY_TST_CTRL0` reader
pub type R = crate::R<PHY_TST_CTRL0_SPEC>;
///Register `PHY_TST_CTRL0` writer
...
///`read()` method returns [`phy_tst_ctrl0::R`](R) reader structure
impl crate::Readable for PHY_TST_CTRL0_SPEC {}
///`write(|w| ..)` method takes [`phy_tst_ctrl0::W`](W) writer structure
