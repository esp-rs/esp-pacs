///Register `VID_NULL_SIZE_ACT` reader
pub type R = crate::R<VID_NULL_SIZE_ACT_SPEC>;
///Field `VID_NULL_SIZE_ACT` reader - NA
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("VID_NULL_SIZE_ACT")
            .field("vid_null_size_act", &self.vid_null_size_act())
            .finish()
    }
}
/**NA
...
///`read()` method returns [`vid_null_size_act::R`](R) reader structure
