...
///`read()` method returns [`phy_ulps_ctrl::R`](R) reader structure
impl crate::Readable for PHY_ULPS_CTRL_SPEC {}
///`write(|w| ..)` method takes [`phy_ulps_ctrl::W`](W) writer structure
