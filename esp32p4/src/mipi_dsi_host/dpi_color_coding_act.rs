///Register `DPI_COLOR_CODING_ACT` reader
pub type R = crate::R<DPI_COLOR_CODING_ACT_SPEC>;
///Field `DPI_COLOR_CODING_ACT` reader - NA
pub type DPI_COLOR_CODING_ACT_R = crate::FieldReader;
///Field `LOOSELY18_EN_ACT` reader - NA
...
You can [`read`](crate::generic::Reg::read) this register and get [`dpi_color_coding_act::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DPI_COLOR_CODING_ACT_SPEC;
impl crate::RegisterSpec for DPI_COLOR_CODING_ACT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dpi_color_coding_act::R`](R) reader structure
