...
///`read()` method returns [`dbi_vcid::R`](R) reader structure
impl crate::Readable for DBI_VCID_SPEC {}
///`write(|w| ..)` method takes [`dbi_vcid::W`](W) writer structure
