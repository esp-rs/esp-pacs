...
///`read()` method returns [`edpi_te_hw_cfg::R`](R) reader structure
impl crate::Readable for EDPI_TE_HW_CFG_SPEC {}
///`write(|w| ..)` method takes [`edpi_te_hw_cfg::W`](W) writer structure
