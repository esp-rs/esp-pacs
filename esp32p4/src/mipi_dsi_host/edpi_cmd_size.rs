///Register `EDPI_CMD_SIZE` reader
pub type R = crate::R<EDPI_CMD_SIZE_SPEC>;
///Register `EDPI_CMD_SIZE` writer
pub type W = crate::W<EDPI_CMD_SIZE_SPEC>;
///Field `EDPI_ALLOWED_CMD_SIZE` reader - NA
pub type EDPI_ALLOWED_CMD_SIZE_R = crate::FieldReader<u16>;
///Field `EDPI_ALLOWED_CMD_SIZE` writer - NA
...
///`read()` method returns [`edpi_cmd_size::R`](R) reader structure
impl crate::Readable for EDPI_CMD_SIZE_SPEC {}
///`write(|w| ..)` method takes [`edpi_cmd_size::W`](W) writer structure
