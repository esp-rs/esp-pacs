...
///`read()` method returns [`lpclk_ctrl::R`](R) reader structure
impl crate::Readable for LPCLK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`lpclk_ctrl::W`](W) writer structure
