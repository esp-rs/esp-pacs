...
///`read()` method returns [`int_force1::R`](R) reader structure
impl crate::Readable for INT_FORCE1_SPEC {}
///`write(|w| ..)` method takes [`int_force1::W`](W) writer structure
