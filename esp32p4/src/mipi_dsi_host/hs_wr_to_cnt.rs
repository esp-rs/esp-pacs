...
///`read()` method returns [`hs_wr_to_cnt::R`](R) reader structure
impl crate::Readable for HS_WR_TO_CNT_SPEC {}
///`write(|w| ..)` method takes [`hs_wr_to_cnt::W`](W) writer structure
