...
///`read()` method returns [`pckhdl_cfg::R`](R) reader structure
impl crate::Readable for PCKHDL_CFG_SPEC {}
///`write(|w| ..)` method takes [`pckhdl_cfg::W`](W) writer structure
