...
///`read()` method returns [`vid_pkt_size::R`](R) reader structure
impl crate::Readable for VID_PKT_SIZE_SPEC {}
///`write(|w| ..)` method takes [`vid_pkt_size::W`](W) writer structure
