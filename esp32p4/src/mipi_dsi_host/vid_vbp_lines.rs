...
///`read()` method returns [`vid_vbp_lines::R`](R) reader structure
impl crate::Readable for VID_VBP_LINES_SPEC {}
///`write(|w| ..)` method takes [`vid_vbp_lines::W`](W) writer structure
