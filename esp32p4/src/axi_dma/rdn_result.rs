///Register `RDN_RESULT` reader
pub type R = crate::R<RDN_RESULT_SPEC>;
///Register `RDN_RESULT` writer
...
///`read()` method returns [`rdn_result::R`](R) reader structure
impl crate::Readable for RDN_RESULT_SPEC {}
///`write(|w| ..)` method takes [`rdn_result::W`](W) writer structure
