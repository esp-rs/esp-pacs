...
impl W {
    ...
    pub fn outfifo_l1_ovf_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_L1_OVF_CH_INT_CLR_W<OUT_INT_CLR_CH_SPEC> {
    ...
    pub fn outfifo_l1_udf_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_L1_UDF_CH_INT_CLR_W<OUT_INT_CLR_CH_SPEC> {
    ...
    pub fn outfifo_l2_ovf_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_L2_OVF_CH_INT_CLR_W<OUT_INT_CLR_CH_SPEC> {
    ...
    pub fn outfifo_l2_udf_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_L2_UDF_CH_INT_CLR_W<OUT_INT_CLR_CH_SPEC> {
    ...
    pub fn outfifo_l3_ovf_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_L3_OVF_CH_INT_CLR_W<OUT_INT_CLR_CH_SPEC> {
    ...
    pub fn outfifo_l3_udf_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_L3_UDF_CH_INT_CLR_W<OUT_INT_CLR_CH_SPEC> {
