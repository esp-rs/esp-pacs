...
#[doc = "Field `INFIFO_L1_OVF_CH_INT_RAW` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
pub type INFIFO_L1_OVF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `INFIFO_L1_OVF_CH_INT_RAW` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
pub type INFIFO_L1_OVF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_L1_UDF_CH_INT_RAW` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
pub type INFIFO_L1_UDF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `INFIFO_L1_UDF_CH_INT_RAW` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
pub type INFIFO_L1_UDF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_L2_OVF_CH_INT_RAW` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
pub type INFIFO_L2_OVF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `INFIFO_L2_OVF_CH_INT_RAW` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
pub type INFIFO_L2_OVF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_L2_UDF_CH_INT_RAW` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
pub type INFIFO_L2_UDF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `INFIFO_L2_UDF_CH_INT_RAW` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
pub type INFIFO_L2_UDF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_L3_OVF_CH_INT_RAW` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
pub type INFIFO_L3_OVF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `INFIFO_L3_OVF_CH_INT_RAW` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
pub type INFIFO_L3_OVF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_L3_UDF_CH_INT_RAW` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
pub type INFIFO_L3_UDF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `INFIFO_L3_UDF_CH_INT_RAW` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
pub type INFIFO_L3_UDF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn infifo_l1_ovf_ch_int_raw(&self) -> INFIFO_L1_OVF_CH_INT_RAW_R {
        INFIFO_L1_OVF_CH_INT_RAW_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    pub fn infifo_l1_udf_ch_int_raw(&self) -> INFIFO_L1_UDF_CH_INT_RAW_R {
        INFIFO_L1_UDF_CH_INT_RAW_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
    #[inline(always)]
    pub fn infifo_l2_ovf_ch_int_raw(&self) -> INFIFO_L2_OVF_CH_INT_RAW_R {
        INFIFO_L2_OVF_CH_INT_RAW_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    pub fn infifo_l2_udf_ch_int_raw(&self) -> INFIFO_L2_UDF_CH_INT_RAW_R {
        INFIFO_L2_UDF_CH_INT_RAW_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
    #[inline(always)]
    pub fn infifo_l3_ovf_ch_int_raw(&self) -> INFIFO_L3_OVF_CH_INT_RAW_R {
        INFIFO_L3_OVF_CH_INT_RAW_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    pub fn infifo_l3_udf_ch_int_raw(&self) -> INFIFO_L3_UDF_CH_INT_RAW_R {
        INFIFO_L3_UDF_CH_INT_RAW_R::new(((self.bits >> 10) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_INT_RAW")
            ...
            .field(
                "infifo_l1_ovf_ch_int_raw",
                &format_args!("{}", self.infifo_l1_ovf_ch_int_raw().bit()),
            )
            .field(
                "infifo_l1_udf_ch_int_raw",
                &format_args!("{}", self.infifo_l1_udf_ch_int_raw().bit()),
            )
            .field(
                "infifo_l2_ovf_ch_int_raw",
                &format_args!("{}", self.infifo_l2_ovf_ch_int_raw().bit()),
            )
            .field(
                "infifo_l2_udf_ch_int_raw",
                &format_args!("{}", self.infifo_l2_udf_ch_int_raw().bit()),
            )
            .field(
                "infifo_l3_ovf_ch_int_raw",
                &format_args!("{}", self.infifo_l3_ovf_ch_int_raw().bit()),
            )
            .field(
                "infifo_l3_udf_ch_int_raw",
                &format_args!("{}", self.infifo_l3_udf_ch_int_raw().bit()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn in_done_ch_int_raw(&mut self) -> IN_DONE_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        IN_DONE_CH_INT_RAW_W::new(self, 0)
    }
    #[doc = "Bit 1 - The raw interrupt bit turns to high level when the last data pointed by one inlink descriptor has been received for Rx channel 0. For UHCI0 the raw interrupt bit turns to high level when the last data pointed by one inlink descriptor has been received and no data error is detected for Rx channel 0."]
    #[inline(always)]
    #[must_use]
    pub fn in_suc_eof_ch_int_raw(&mut self) -> IN_SUC_EOF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        IN_SUC_EOF_CH_INT_RAW_W::new(self, 1)
    }
    #[doc = "Bit 2 - The raw interrupt bit turns to high level when data error is detected only in the case that the peripheral is UHCI0 for Rx channel 0. For other peripherals this raw interrupt is reserved."]
    #[inline(always)]
    #[must_use]
    pub fn in_err_eof_ch_int_raw(&mut self) -> IN_ERR_EOF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        IN_ERR_EOF_CH_INT_RAW_W::new(self, 2)
    }
    #[doc = "Bit 3 - The raw interrupt bit turns to high level when detecting inlink descriptor error including owner error and the second and third word error of inlink descriptor for Rx channel 0."]
    #[inline(always)]
    #[must_use]
    pub fn in_dscr_err_ch_int_raw(&mut self) -> IN_DSCR_ERR_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        IN_DSCR_ERR_CH_INT_RAW_W::new(self, 3)
    }
    #[doc = "Bit 4 - The raw interrupt bit turns to high level when Rx buffer pointed by inlink is full and receiving data is not completed but there is no more inlink for Rx channel 0."]
    #[inline(always)]
    #[must_use]
    pub fn in_dscr_empty_ch_int_raw(&mut self) -> IN_DSCR_EMPTY_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        IN_DSCR_EMPTY_CH_INT_RAW_W::new(self, 4)
    }
    #[doc = "Bit 5 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l1_ovf_ch_int_raw(&mut self) -> INFIFO_L1_OVF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        INFIFO_L1_OVF_CH_INT_RAW_W::new(self, 5)
    }
    #[doc = "Bit 6 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l1_udf_ch_int_raw(&mut self) -> INFIFO_L1_UDF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        INFIFO_L1_UDF_CH_INT_RAW_W::new(self, 6)
    }
    #[doc = "Bit 7 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l2_ovf_ch_int_raw(&mut self) -> INFIFO_L2_OVF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        INFIFO_L2_OVF_CH_INT_RAW_W::new(self, 7)
    }
    #[doc = "Bit 8 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l2_udf_ch_int_raw(&mut self) -> INFIFO_L2_UDF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        INFIFO_L2_UDF_CH_INT_RAW_W::new(self, 8)
    }
    #[doc = "Bit 9 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l3_ovf_ch_int_raw(&mut self) -> INFIFO_L3_OVF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        INFIFO_L3_OVF_CH_INT_RAW_W::new(self, 9)
    }
    #[doc = "Bit 10 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l3_udf_ch_int_raw(&mut self) -> INFIFO_L3_UDF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        INFIFO_L3_UDF_CH_INT_RAW_W::new(self, 10)
    }
}
