...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<IN_CONF0_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn in_burst_size_sel_ch(&mut self) -> IN_BURST_SIZE_SEL_CH_W<IN_CONF0_SPEC> {
        IN_BURST_SIZE_SEL_CH_W::new(self, 4)
    }
    #[doc = "Bit 7 - 1:mean disable cmd of this ch0"]
    #[inline(always)]
    #[must_use]
    pub fn in_cmd_disable_ch(&mut self) -> IN_CMD_DISABLE_CH_W<IN_CONF0_SPEC> {
        IN_CMD_DISABLE_CH_W::new(self, 7)
    }
    #[doc = "Bit 8 - 1: mean access ecc or aes domain,0: mean not"]
    #[inline(always)]
    #[must_use]
    pub fn in_ecc_aec_en_ch(&mut self) -> IN_ECC_AEC_EN_CH_W<IN_CONF0_SPEC> {
