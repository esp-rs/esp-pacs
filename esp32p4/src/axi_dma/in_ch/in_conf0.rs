...
impl W {
    ...
    #[doc = "Bits 4:6 - 3'b000-3'b100:burst length 8byte~128byte"]
    #[inline(always)]
    pub fn in_burst_size_sel(&mut self) -> IN_BURST_SIZE_SEL_W<'_, IN_CONF0_SPEC> {
        IN_BURST_SIZE_SEL_W::new(self, 4)
    }
    #[doc = "Bit 7 - 1:mean disable cmd of this ch0"]
    #[inline(always)]
    pub fn in_cmd_disable(&mut self) -> IN_CMD_DISABLE_W<'_, IN_CONF0_SPEC> {
        IN_CMD_DISABLE_W::new(self, 7)
    }
    #[doc = "Bit 8 - 1: mean access ecc or aes domain,0: mean not"]
    #[inline(always)]
    pub fn in_ecc_aec_en(&mut self) -> IN_ECC_AEC_EN_W<'_, IN_CONF0_SPEC> {
