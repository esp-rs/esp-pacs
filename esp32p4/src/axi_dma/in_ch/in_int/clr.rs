...
///Field `INFIFO_L1_OVF` writer - Set this bit to clear the INFIFO_OVF_L1_CH_INT interrupt.
pub type INFIFO_L1_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L1_UDF` writer - Set this bit to clear the INFIFO_UDF_L1_CH_INT interrupt.
pub type INFIFO_L1_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L2_OVF` writer - Set this bit to clear the INFIFO_OVF_L2_CH_INT interrupt.
pub type INFIFO_L2_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L2_UDF` writer - Set this bit to clear the INFIFO_UDF_L2_CH_INT interrupt.
pub type INFIFO_L2_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L3_OVF` writer - Set this bit to clear the INFIFO_OVF_L3_CH_INT interrupt.
pub type INFIFO_L3_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L3_UDF` writer - Set this bit to clear the INFIFO_UDF_L3_CH_INT interrupt.
...
impl W {
    ...
    ///Bit 7 - Set this bit to clear the INFIFO_OVF_L2_CH_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn infifo_l2_ovf(&mut self) -> INFIFO_L2_OVF_W<CLR_SPEC> {
        INFIFO_L2_OVF_W::new(self, 7)
    }
    ///Bit 8 - Set this bit to clear the INFIFO_UDF_L2_CH_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn infifo_l2_udf(&mut self) -> INFIFO_L2_UDF_W<CLR_SPEC> {
        INFIFO_L2_UDF_W::new(self, 8)
    }
    ///Bit 9 - Set this bit to clear the INFIFO_OVF_L3_CH_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn infifo_l3_ovf(&mut self) -> INFIFO_L3_OVF_W<CLR_SPEC> {
        INFIFO_L3_OVF_W::new(self, 9)
    }
    ///Bit 10 - Set this bit to clear the INFIFO_UDF_L3_CH_INT interrupt.
    #[inline(always)]
    #[must_use]
