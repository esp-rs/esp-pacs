...
///Field `INFIFO_L1_OVF` reader - The raw interrupt status bit for the INFIFO_OVF_L2_CH_INT interrupt.
pub type INFIFO_L1_OVF_R = crate::BitReader;
///Field `INFIFO_L1_UDF` reader - The raw interrupt status bit for the INFIFO_UDF_L2_CH_INT interrupt.
pub type INFIFO_L1_UDF_R = crate::BitReader;
///Field `INFIFO_L3_OVF` reader - The raw interrupt status bit for the INFIFO_OVF_L3_CH_INT interrupt.
pub type INFIFO_L3_OVF_R = crate::BitReader;
///Field `INFIFO_L3_UDF` reader - The raw interrupt status bit for the INFIFO_UDF_L3_CH_INT interrupt.
...
impl R {
    ...
    ///Bit 7 - The raw interrupt status bit for the INFIFO_OVF_L2_CH_INT interrupt.
    #[inline(always)]
    pub fn infifo_l1_ovf(&self) -> INFIFO_L1_OVF_R {
        INFIFO_L1_OVF_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - The raw interrupt status bit for the INFIFO_UDF_L2_CH_INT interrupt.
    #[inline(always)]
    pub fn infifo_l1_udf(&self) -> INFIFO_L1_UDF_R {
        INFIFO_L1_UDF_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - The raw interrupt status bit for the INFIFO_OVF_L3_CH_INT interrupt.
    #[inline(always)]
    pub fn infifo_l3_ovf(&self) -> INFIFO_L3_OVF_R {
        INFIFO_L3_OVF_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - The raw interrupt status bit for the INFIFO_UDF_L3_CH_INT interrupt.
    #[inline(always)]
