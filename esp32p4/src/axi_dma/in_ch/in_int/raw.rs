...
///Field `IN_SUC_EOF` reader - The raw interrupt bit turns to high level when the last data pointed by one inlink descriptor has been received for Rx channel 0. For UHCI0 the raw interrupt bit turns to high level when the last data pointed by one inlink descriptor has been received and no data error is detected for Rx channel 0.
pub type IN_SUC_EOF_R = crate::BitReader;
///Field `IN_SUC_EOF` writer - The raw interrupt bit turns to high level when the last data pointed by one inlink descriptor has been received for Rx channel 0. For UHCI0 the raw interrupt bit turns to high level when the last data pointed by one inlink descriptor has been received and no data error is detected for Rx channel 0.
pub type IN_SUC_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_ERR_EOF` reader - The raw interrupt bit turns to high level when data error is detected only in the case that the peripheral is UHCI0 for Rx channel 0. For other peripherals this raw interrupt is reserved.
...
///Field `IN_DSCR_ERR` reader - The raw interrupt bit turns to high level when detecting inlink descriptor error including owner error and the second and third word error of inlink descriptor for Rx channel 0.
pub type IN_DSCR_ERR_R = crate::BitReader;
///Field `IN_DSCR_ERR` writer - The raw interrupt bit turns to high level when detecting inlink descriptor error including owner error and the second and third word error of inlink descriptor for Rx channel 0.
...
///Field `INFIFO_L1_OVF` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow.
pub type INFIFO_L1_OVF_R = crate::BitReader;
///Field `INFIFO_L1_OVF` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow.
pub type INFIFO_L1_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L1_UDF` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow.
pub type INFIFO_L1_UDF_R = crate::BitReader;
///Field `INFIFO_L1_UDF` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow.
pub type INFIFO_L1_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L2_OVF` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow.
pub type INFIFO_L2_OVF_R = crate::BitReader;
///Field `INFIFO_L2_OVF` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow.
pub type INFIFO_L2_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L2_UDF` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow.
pub type INFIFO_L2_UDF_R = crate::BitReader;
///Field `INFIFO_L2_UDF` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow.
pub type INFIFO_L2_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L3_OVF` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow.
pub type INFIFO_L3_OVF_R = crate::BitReader;
///Field `INFIFO_L3_OVF` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow.
pub type INFIFO_L3_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_L3_UDF` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow.
pub type INFIFO_L3_UDF_R = crate::BitReader;
///Field `INFIFO_L3_UDF` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow.
...
impl R {
    ...
    ///Bit 7 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow.
    #[inline(always)]
    pub fn infifo_l2_ovf(&self) -> INFIFO_L2_OVF_R {
        INFIFO_L2_OVF_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow.
    #[inline(always)]
