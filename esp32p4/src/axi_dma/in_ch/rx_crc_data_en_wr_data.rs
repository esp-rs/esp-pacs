...
pub type RX_CRC_DATA_EN_WR_DATA_CH_R = crate::FieldReader<u16>;
#[doc = "Field `RX_CRC_DATA_EN_WR_DATA_CH` writer - reserved"]
pub type RX_CRC_DATA_EN_WR_DATA_CH_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - reserved"]
    #[inline(always)]
    pub fn rx_crc_data_en_wr_data_ch(&self) -> RX_CRC_DATA_EN_WR_DATA_CH_R {
        RX_CRC_DATA_EN_WR_DATA_CH_R::new((self.bits & 0xffff) as u16)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_CRC_DATA_EN_WR_DATA")
            .field(
                ...
                &format_args!("{}", self.rx_crc_data_en_wr_data_ch().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RX_CRC_DATA_EN_WR_DATA_SPEC> {
...
impl W {
    ...
    pub fn rx_crc_data_en_wr_data_ch(
        &mut self,
    ) -> RX_CRC_DATA_EN_WR_DATA_CH_W<RX_CRC_DATA_EN_WR_DATA_SPEC> {
