...
///Field `INFIFO_L3_FULL` reader - L3 Rx FIFO full signal for Rx channel 0.
pub type INFIFO_L3_FULL_R = crate::BitReader;
///Field `INFIFO_L3_EMPTY` reader - L3 Rx FIFO empty signal for Rx channel 0.
pub type INFIFO_L3_EMPTY_R = crate::BitReader;
///Field `INFIFO_L3_CNT` reader - The register stores the byte number of the data in L3 Rx FIFO for Rx channel 0.
pub type INFIFO_L3_CNT_R = crate::FieldReader;
///Field `INFIFO_L3_UDF` reader - L3 Rx FIFO under flow signal for Rx channel 0.
pub type INFIFO_L3_UDF_R = crate::BitReader;
///Field `INFIFO_L3_OVF` reader - L3 Rx FIFO over flow signal for Rx channel 0.
pub type INFIFO_L3_OVF_R = crate::BitReader;
///Field `INFIFO_L1_FULL` reader - L1 Rx FIFO full signal for Rx channel 0.
pub type INFIFO_L1_FULL_R = crate::BitReader;
///Field `INFIFO_L1_EMPTY` reader - L1 Rx FIFO empty signal for Rx channel 0.
pub type INFIFO_L1_EMPTY_R = crate::BitReader;
///Field `INFIFO_L1_UDF` reader - L1 Rx FIFO under flow signal for Rx channel 0.
pub type INFIFO_L1_UDF_R = crate::BitReader;
///Field `INFIFO_L1_OVF` reader - L1 Rx FIFO over flow signal for Rx channel 0.
pub type INFIFO_L1_OVF_R = crate::BitReader;
///Field `INFIFO_L2_FULL` reader - L2 Rx RAM full signal for Rx channel 0.
pub type INFIFO_L2_FULL_R = crate::BitReader;
///Field `INFIFO_L2_EMPTY` reader - L2 Rx RAM empty signal for Rx channel 0.
pub type INFIFO_L2_EMPTY_R = crate::BitReader;
///Field `INFIFO_L2_UDF` reader - L2 Rx FIFO under flow signal for Rx channel 0.
pub type INFIFO_L2_UDF_R = crate::BitReader;
///Field `INFIFO_L2_OVF` reader - L2 Rx FIFO over flow signal for Rx channel 0.
pub type INFIFO_L2_OVF_R = crate::BitReader;
///Field `IN_REMAIN_UNDER_1B` reader - reserved
pub type IN_REMAIN_UNDER_1B_R = crate::BitReader;
///Field `IN_REMAIN_UNDER_2B` reader - reserved
pub type IN_REMAIN_UNDER_2B_R = crate::BitReader;
///Field `IN_REMAIN_UNDER_3B` reader - reserved
pub type IN_REMAIN_UNDER_3B_R = crate::BitReader;
///Field `IN_REMAIN_UNDER_4B` reader - reserved
pub type IN_REMAIN_UNDER_4B_R = crate::BitReader;
///Field `IN_REMAIN_UNDER_5B` reader - reserved
pub type IN_REMAIN_UNDER_5B_R = crate::BitReader;
///Field `IN_REMAIN_UNDER_6B` reader - reserved
pub type IN_REMAIN_UNDER_6B_R = crate::BitReader;
///Field `IN_REMAIN_UNDER_7B` reader - reserved
pub type IN_REMAIN_UNDER_7B_R = crate::BitReader;
///Field `IN_REMAIN_UNDER_8B` reader - reserved
pub type IN_REMAIN_UNDER_8B_R = crate::BitReader;
///Field `IN_BUF_HUNGRY` reader - reserved
pub type IN_BUF_HUNGRY_R = crate::BitReader;
impl R {
    ///Bit 0 - L3 Rx FIFO full signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l3_full(&self) -> INFIFO_L3_FULL_R {
        INFIFO_L3_FULL_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - L3 Rx FIFO empty signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l3_empty(&self) -> INFIFO_L3_EMPTY_R {
        INFIFO_L3_EMPTY_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:7 - The register stores the byte number of the data in L3 Rx FIFO for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l3_cnt(&self) -> INFIFO_L3_CNT_R {
        INFIFO_L3_CNT_R::new(((self.bits >> 2) & 0x3f) as u8)
    }
    ///Bit 8 - L3 Rx FIFO under flow signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l3_udf(&self) -> INFIFO_L3_UDF_R {
        INFIFO_L3_UDF_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - L3 Rx FIFO over flow signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l3_ovf(&self) -> INFIFO_L3_OVF_R {
        INFIFO_L3_OVF_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - L1 Rx FIFO full signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l1_full(&self) -> INFIFO_L1_FULL_R {
        INFIFO_L1_FULL_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - L1 Rx FIFO empty signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l1_empty(&self) -> INFIFO_L1_EMPTY_R {
        INFIFO_L1_EMPTY_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - L1 Rx FIFO under flow signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l1_udf(&self) -> INFIFO_L1_UDF_R {
        INFIFO_L1_UDF_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - L1 Rx FIFO over flow signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l1_ovf(&self) -> INFIFO_L1_OVF_R {
        INFIFO_L1_OVF_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - L2 Rx RAM full signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l2_full(&self) -> INFIFO_L2_FULL_R {
        INFIFO_L2_FULL_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - L2 Rx RAM empty signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l2_empty(&self) -> INFIFO_L2_EMPTY_R {
        INFIFO_L2_EMPTY_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bit 16 - L2 Rx FIFO under flow signal for Rx channel 0.
    #[inline(always)]
    pub fn infifo_l2_udf(&self) -> INFIFO_L2_UDF_R {
        INFIFO_L2_UDF_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - L2 Rx FIFO over flow signal for Rx channel 0.
    #[inline(always)]
...
///`reset()` method sets INFIFO_STATUS to value 0x8803
