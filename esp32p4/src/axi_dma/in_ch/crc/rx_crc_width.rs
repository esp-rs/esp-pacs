...
///`read()` method returns [`rx_crc_width::R`](R) reader structure
impl crate::Readable for RX_CRC_WIDTH_SPEC {}
///`write(|w| ..)` method takes [`rx_crc_width::W`](W) writer structure
impl crate::Writable for RX_CRC_WIDTH_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RX_CRC_WIDTH to value 0
