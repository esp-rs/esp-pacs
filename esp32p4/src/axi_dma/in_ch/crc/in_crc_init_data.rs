///Register `IN_CRC_INIT_DATA` reader
pub type R = crate::R<IN_CRC_INIT_DATA_SPEC>;
///Register `IN_CRC_INIT_DATA` writer
pub type W = crate::W<IN_CRC_INIT_DATA_SPEC>;
///Field `IN_CRC_INIT_DATA` reader - This register is used to config ch0 of rx crc initial value
pub type IN_CRC_INIT_DATA_R = crate::FieldReader<u32>;
///Field `IN_CRC_INIT_DATA` writer - This register is used to config ch0 of rx crc initial value
pub type IN_CRC_INIT_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This register is used to config ch0 of rx crc initial value
    #[inline(always)]
...
///`read()` method returns [`in_crc_init_data::R`](R) reader structure
impl crate::Readable for IN_CRC_INIT_DATA_SPEC {}
///`write(|w| ..)` method takes [`in_crc_init_data::W`](W) writer structure
impl crate::Writable for IN_CRC_INIT_DATA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets IN_CRC_INIT_DATA to value 0xffff_ffff
