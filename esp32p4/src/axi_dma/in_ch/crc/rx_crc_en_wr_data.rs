///Register `RX_CRC_EN_WR_DATA` reader
pub type R = crate::R<RX_CRC_EN_WR_DATA_SPEC>;
///Register `RX_CRC_EN_WR_DATA` writer
pub type W = crate::W<RX_CRC_EN_WR_DATA_SPEC>;
///Field `RX_CRC_EN_WR_DATA` reader - This register is used to enable rx ch0 crc 32bit on/off
pub type RX_CRC_EN_WR_DATA_R = crate::FieldReader<u32>;
///Field `RX_CRC_EN_WR_DATA` writer - This register is used to enable rx ch0 crc 32bit on/off
pub type RX_CRC_EN_WR_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This register is used to enable rx ch0 crc 32bit on/off
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rx_crc_en_wr_data::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rx_crc_en_wr_data::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RX_CRC_EN_WR_DATA_SPEC;
impl crate::RegisterSpec for RX_CRC_EN_WR_DATA_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rx_crc_en_wr_data::R`](R) reader structure
impl crate::Readable for RX_CRC_EN_WR_DATA_SPEC {}
///`write(|w| ..)` method takes [`rx_crc_en_wr_data::W`](W) writer structure
impl crate::Writable for RX_CRC_EN_WR_DATA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RX_CRC_EN_WR_DATA to value 0
