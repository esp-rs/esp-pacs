///Register `IN_CRC_CLEAR` reader
pub type R = crate::R<IN_CRC_CLEAR_SPEC>;
///Register `IN_CRC_CLEAR` writer
pub type W = crate::W<IN_CRC_CLEAR_SPEC>;
///Field `IN_CRC_CLEAR` reader - This register is used to clear ch0 of rx crc result
pub type IN_CRC_CLEAR_R = crate::BitReader;
///Field `IN_CRC_CLEAR` writer - This register is used to clear ch0 of rx crc result
pub type IN_CRC_CLEAR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - This register is used to clear ch0 of rx crc result
    #[inline(always)]
...
///`read()` method returns [`in_crc_clear::R`](R) reader structure
impl crate::Readable for IN_CRC_CLEAR_SPEC {}
///`write(|w| ..)` method takes [`in_crc_clear::W`](W) writer structure
impl crate::Writable for IN_CRC_CLEAR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets IN_CRC_CLEAR to value 0
