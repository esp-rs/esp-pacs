...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_pri_ch(&mut self) -> RX_PRI_CH_W<IN_PRI_SPEC> {
        RX_PRI_CH_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - The weight of Rx channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn rx_ch_arb_weigh_ch(&mut self) -> RX_CH_ARB_WEIGH_CH_W<IN_PRI_SPEC> {
        RX_CH_ARB_WEIGH_CH_W::new(self, 4)
    }
    #[doc = "Bit 8 - 0: mean not optimazation weight function ,1: mean optimazation"]
    #[inline(always)]
    #[must_use]
    pub fn rx_arb_weigh_opt_dir_ch(&mut self) -> RX_ARB_WEIGH_OPT_DIR_CH_W<IN_PRI_SPEC> {
