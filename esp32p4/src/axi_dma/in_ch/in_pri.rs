...
///Field `RX_CH_ARB_WEIGH` reader - The weight of Rx channel 0
pub type RX_CH_ARB_WEIGH_R = crate::FieldReader;
///Field `RX_CH_ARB_WEIGH` writer - The weight of Rx channel 0
pub type RX_CH_ARB_WEIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `RX_ARB_WEIGH_OPT_DIR` reader - 0: mean not optimazation weight function ,1: mean optimazation
pub type RX_ARB_WEIGH_OPT_DIR_R = crate::BitReader;
///Field `RX_ARB_WEIGH_OPT_DIR` writer - 0: mean not optimazation weight function ,1: mean optimazation
...
impl R {
    ...
    ///Bits 4:7 - The weight of Rx channel 0
    #[inline(always)]
