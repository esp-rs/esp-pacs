...
impl IN_CH {
    ///0x00..0x10 - Cluster IN_INT, containing IN_INT_RAW, IN_INT_ST, IN_INT_ENA, IN_INT_CLR
    #[inline(always)]
    pub const fn in_int(&self) -> &IN_INT {
        &self.in_int
    }
    ///0x10 - Configure 0 register of Rx channel 0
    #[inline(always)]
    pub const fn in_conf0(&self) -> &IN_CONF0 {
        &self.in_conf0
    }
    ///0x14 - Configure 1 register of Rx channel 0
    #[inline(always)]
    ...
    ///0x24 - Link descriptor configure and control register of Rx channel 0
    #[inline(always)]
    pub const fn in_link2(&self) -> &IN_LINK2 {
        &self.in_link2
    }
    ///0x28 - Receive status of Rx channel 0
    #[inline(always)]
    pub const fn in_state(&self) -> &IN_STATE {
        &self.in_state
    }
    ///0x2c - Inlink descriptor address when EOF occurs of Rx channel 0
    #[inline(always)]
    pub const fn in_suc_eof_des_addr(&self) -> &IN_SUC_EOF_DES_ADDR {
        &self.in_suc_eof_des_addr
    }
    ///0x30 - Inlink descriptor address when errors occur of Rx channel 0
    #[inline(always)]
    pub const fn in_err_eof_des_addr(&self) -> &IN_ERR_EOF_DES_ADDR {
        &self.in_err_eof_des_addr
    }
    ///0x34 - Current inlink descriptor address of Rx channel 0
    #[inline(always)]
    pub const fn in_dscr(&self) -> &IN_DSCR {
        &self.in_dscr
    }
    ///0x38 - The last inlink descriptor address of Rx channel 0
    #[inline(always)]
    pub const fn in_dscr_bf0(&self) -> &IN_DSCR_BF0 {
        &self.in_dscr_bf0
    }
    ///0x3c - The second-to-last inlink descriptor address of Rx channel 0
    #[inline(always)]
    pub const fn in_dscr_bf1(&self) -> &IN_DSCR_BF1 {
        &self.in_dscr_bf1
    }
    ///0x40 - Priority register of Rx channel 0
    #[inline(always)]
    pub const fn in_pri(&self) -> &IN_PRI {
        &self.in_pri
    }
    ///0x44 - Peripheral selection of Rx channel 0
    #[inline(always)]
    pub const fn in_peri_sel(&self) -> &IN_PERI_SEL {
        &self.in_peri_sel
    }
    ///0x48..0x68 - Cluster CRC, containing IN_CRC_INIT_DATA, RX_CRC_WIDTH, IN_CRC_CLEAR, IN_CRC_FINAL_RESULT, RX_CRC_EN_WR_DATA, RX_CRC_EN_ADDR, RX_CRC_DATA_EN_WR_DATA, RX_CRC_DATA_EN_ADDR
    #[inline(always)]
...
pub mod in_pop;
/**IN_LINK1 (rw) register accessor: Link descriptor configure and control register of Rx channel 0
...
pub mod in_link1;
/**IN_LINK2 (rw) register accessor: Link descriptor configure and control register of Rx channel 0
