///Register `RRESP_CNT` reader
pub type R = crate::R<RRESP_CNT_SPEC>;
///Field `RRESP_CNT` reader - axi rd responce cnt reg.
pub type RRESP_CNT_R = crate::FieldReader;
impl R {
    ///Bits 0:3 - axi rd responce cnt reg.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rresp_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RRESP_CNT_SPEC;
impl crate::RegisterSpec for RRESP_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rresp_cnt::R`](R) reader structure
