///Register `EXTR_MEM_START_ADDR` reader
pub type R = crate::R<EXTR_MEM_START_ADDR_SPEC>;
///Register `EXTR_MEM_START_ADDR` writer
pub type W = crate::W<EXTR_MEM_START_ADDR_SPEC>;
///Field `ACCESS_EXTR_MEM_START_ADDR` reader - The start address of accessible address space.
pub type ACCESS_EXTR_MEM_START_ADDR_R = crate::FieldReader<u32>;
///Field `ACCESS_EXTR_MEM_START_ADDR` writer - The start address of accessible address space.
...
///`read()` method returns [`extr_mem_start_addr::R`](R) reader structure
impl crate::Readable for EXTR_MEM_START_ADDR_SPEC {}
///`write(|w| ..)` method takes [`extr_mem_start_addr::W`](W) writer structure
