///Register `OUT_RESET_AVAIL_CH%s` reader
pub type R = crate::R<OUT_RESET_AVAIL_CH_SPEC>;
///Field `OUT_RESET_AVAIL` reader - tx chan0 reset valid reg.
pub type OUT_RESET_AVAIL_R = crate::BitReader;
impl R {
    ///Bit 0 - tx chan0 reset valid reg.
    #[inline(always)]
...
///`read()` method returns [`out_reset_avail_ch::R`](R) reader structure
