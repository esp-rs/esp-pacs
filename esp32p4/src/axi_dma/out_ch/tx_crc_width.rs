...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TX_CRC_WIDTH_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_crc_width_ch(&mut self) -> TX_CRC_WIDTH_CH_W<TX_CRC_WIDTH_SPEC> {
        TX_CRC_WIDTH_CH_W::new(self, 0)
    }
    #[doc = "Bit 2 - reserved"]
    #[inline(always)]
    #[must_use]
    pub fn tx_crc_lautch_flga_ch(&mut self) -> TX_CRC_LAUTCH_FLGA_CH_W<TX_CRC_WIDTH_SPEC> {
