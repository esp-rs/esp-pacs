...
///Field `OUTFIFO_L3_FULL` reader - L3 Tx FIFO full signal for Tx channel0.
pub type OUTFIFO_L3_FULL_R = crate::BitReader;
///Field `OUTFIFO_L3_EMPTY` reader - L3 Tx FIFO empty signal for Tx channel0.
pub type OUTFIFO_L3_EMPTY_R = crate::BitReader;
///Field `OUTFIFO_L3_CNT` reader - The register stores the byte number of the data in L3 Tx FIFO for Tx channel0.
pub type OUTFIFO_L3_CNT_R = crate::FieldReader;
///Field `OUTFIFO_L3_UDF` reader - L3 Tx FIFO under flow signal for Tx channel0.
pub type OUTFIFO_L3_UDF_R = crate::BitReader;
///Field `OUTFIFO_L3_OVF` reader - L3 Tx FIFO over flow signal for Tx channel0.
pub type OUTFIFO_L3_OVF_R = crate::BitReader;
///Field `OUTFIFO_L1_FULL` reader - L1 Tx FIFO full signal for Tx channel0.
pub type OUTFIFO_L1_FULL_R = crate::BitReader;
///Field `OUTFIFO_L1_EMPTY` reader - L1 Tx FIFO empty signal for Tx channel0.
pub type OUTFIFO_L1_EMPTY_R = crate::BitReader;
///Field `OUTFIFO_L1_UDF` reader - L1 Tx FIFO under flow signal for Tx channel0.
pub type OUTFIFO_L1_UDF_R = crate::BitReader;
///Field `OUTFIFO_L1_OVF` reader - L1 Tx FIFO over flow signal for Tx channel0.
pub type OUTFIFO_L1_OVF_R = crate::BitReader;
///Field `OUTFIFO_L2_FULL` reader - L2 Tx RAM full signal for Tx channel0.
pub type OUTFIFO_L2_FULL_R = crate::BitReader;
///Field `OUTFIFO_L2_EMPTY` reader - L2 Tx RAM empty signal for Tx channel0.
pub type OUTFIFO_L2_EMPTY_R = crate::BitReader;
///Field `OUTFIFO_L2_UDF` reader - L2 Tx FIFO under flow signal for Tx channel0.
pub type OUTFIFO_L2_UDF_R = crate::BitReader;
///Field `OUTFIFO_L2_OVF` reader - L2 Tx FIFO over flow signal for Tx channel0.
...
///`reset()` method sets OUTFIFO_STATUS to value 0x7f80_8802
