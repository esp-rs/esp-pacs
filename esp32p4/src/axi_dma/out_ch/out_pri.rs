...
///Field `TX_PRI` reader - The priority of Tx channel0. The larger of the value the higher of the priority.
pub type TX_PRI_R = crate::FieldReader;
///Field `TX_PRI` writer - The priority of Tx channel0. The larger of the value the higher of the priority.
pub type TX_PRI_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TX_CH_ARB_WEIGH` reader - The weight of Tx channel0
pub type TX_CH_ARB_WEIGH_R = crate::FieldReader;
///Field `TX_CH_ARB_WEIGH` writer - The weight of Tx channel0
pub type TX_CH_ARB_WEIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TX_ARB_WEIGH_OPT_DIR` reader - 0: mean not optimazation weight function ,1: mean optimazation
pub type TX_ARB_WEIGH_OPT_DIR_R = crate::BitReader;
///Field `TX_ARB_WEIGH_OPT_DIR` writer - 0: mean not optimazation weight function ,1: mean optimazation
pub type TX_ARB_WEIGH_OPT_DIR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:3 - The priority of Tx channel0. The larger of the value the higher of the priority.
    #[inline(always)]
    pub fn tx_pri(&self) -> TX_PRI_R {
        TX_PRI_R::new((self.bits & 0x0f) as u8)
    }
    ///Bits 4:7 - The weight of Tx channel0
    #[inline(always)]
    pub fn tx_ch_arb_weigh(&self) -> TX_CH_ARB_WEIGH_R {
        TX_CH_ARB_WEIGH_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
    ///Bit 8 - 0: mean not optimazation weight function ,1: mean optimazation
    #[inline(always)]
