...
///Field `OUTFIFO_OVF` reader - The raw interrupt status bit for the OUTFIFO_OVF_L1_CH_INT interrupt.
pub type OUTFIFO_OVF_R = crate::BitReader;
///Field `OUTFIFO_UDF` reader - The raw interrupt status bit for the OUTFIFO_UDF_L1_CH_INT interrupt.
pub type OUTFIFO_UDF_R = crate::BitReader;
///Field `OUTFIFO_L1_OVF` reader - The raw interrupt status bit for the OUTFIFO_OVF_L2_CH_INT interrupt.
pub type OUTFIFO_L1_OVF_R = crate::BitReader;
///Field `OUTFIFO_L1_UDF` reader - The raw interrupt status bit for the OUTFIFO_UDF_L2_CH_INT interrupt.
pub type OUTFIFO_L1_UDF_R = crate::BitReader;
///Field `OUTFIFO_L3_OVF` reader - The raw interrupt status bit for the OUTFIFO_OVF_L3_CH_INT interrupt.
pub type OUTFIFO_L3_OVF_R = crate::BitReader;
///Field `OUTFIFO_L3_UDF` reader - The raw interrupt status bit for the OUTFIFO_UDF_L3_CH_INT interrupt.
...
impl R {
    ...
    pub fn outfifo_l1_ovf(&self) -> OUTFIFO_L1_OVF_R {
        OUTFIFO_L1_OVF_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - The raw interrupt status bit for the OUTFIFO_UDF_L2_CH_INT interrupt.
    #[inline(always)]
    pub fn outfifo_l1_udf(&self) -> OUTFIFO_L1_UDF_R {
        OUTFIFO_L1_UDF_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - The raw interrupt status bit for the OUTFIFO_OVF_L3_CH_INT interrupt.
    #[inline(always)]
    pub fn outfifo_l3_ovf(&self) -> OUTFIFO_L3_OVF_R {
        OUTFIFO_L3_OVF_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - The raw interrupt status bit for the OUTFIFO_UDF_L3_CH_INT interrupt.
    #[inline(always)]
