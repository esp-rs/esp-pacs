...
///Field `OUTFIFO_L1_OVF` writer - Set this bit to clear the OUTFIFO_OVF_L1_CH_INT interrupt.
pub type OUTFIFO_L1_OVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `OUTFIFO_L1_UDF` writer - Set this bit to clear the OUTFIFO_UDF_L1_CH_INT interrupt.
pub type OUTFIFO_L1_UDF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `OUTFIFO_L2_OVF` writer - Set this bit to clear the OUTFIFO_OVF_L2_CH_INT interrupt.
pub type OUTFIFO_L2_OVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `OUTFIFO_L2_UDF` writer - Set this bit to clear the OUTFIFO_UDF_L2_CH_INT interrupt.
pub type OUTFIFO_L2_UDF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `OUTFIFO_L3_OVF` writer - Set this bit to clear the OUTFIFO_OVF_L3_CH_INT interrupt.
pub type OUTFIFO_L3_OVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `OUTFIFO_L3_UDF` writer - Set this bit to clear the OUTFIFO_UDF_L3_CH_INT interrupt.
...
impl W {
    ...
    ///Bit 6 - Set this bit to clear the OUTFIFO_OVF_L2_CH_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn outfifo_l2_ovf(&mut self) -> OUTFIFO_L2_OVF_W<CLR_SPEC> {
        OUTFIFO_L2_OVF_W::new(self, 6)
    }
    ///Bit 7 - Set this bit to clear the OUTFIFO_UDF_L2_CH_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn outfifo_l2_udf(&mut self) -> OUTFIFO_L2_UDF_W<CLR_SPEC> {
        OUTFIFO_L2_UDF_W::new(self, 7)
    }
    ///Bit 8 - Set this bit to clear the OUTFIFO_OVF_L3_CH_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn outfifo_l3_ovf(&mut self) -> OUTFIFO_L3_OVF_W<CLR_SPEC> {
        OUTFIFO_L3_OVF_W::new(self, 8)
    }
    ///Bit 9 - Set this bit to clear the OUTFIFO_UDF_L3_CH_INT interrupt.
    #[inline(always)]
    #[must_use]
