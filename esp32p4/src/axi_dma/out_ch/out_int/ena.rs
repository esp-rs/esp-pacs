...
#[doc = "Field `OUT_LINK_SWITCH` reader - The interrupt enable bit for the OUT_LINK_SWITCH_CH_INT interrupt."]
pub type OUT_LINK_SWITCH_R = crate::BitReader;
#[doc = "Field `OUT_LINK_SWITCH` writer - The interrupt enable bit for the OUT_LINK_SWITCH_CH_INT interrupt."]
...
impl W {
    ...
    #[doc = "Bit 4 - The interrupt enable bit for the OUTFIFO_OVF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l1_ovf(&mut self) -> OUTFIFO_L1_OVF_W<'_, ENA_SPEC> {
        OUTFIFO_L1_OVF_W::new(self, 4)
    }
    #[doc = "Bit 5 - The interrupt enable bit for the OUTFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l1_udf(&mut self) -> OUTFIFO_L1_UDF_W<'_, ENA_SPEC> {
        OUTFIFO_L1_UDF_W::new(self, 5)
    }
    #[doc = "Bit 6 - The interrupt enable bit for the OUTFIFO_OVF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l2_ovf(&mut self) -> OUTFIFO_L2_OVF_W<'_, ENA_SPEC> {
        OUTFIFO_L2_OVF_W::new(self, 6)
    }
    #[doc = "Bit 7 - The interrupt enable bit for the OUTFIFO_UDF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l2_udf(&mut self) -> OUTFIFO_L2_UDF_W<'_, ENA_SPEC> {
        OUTFIFO_L2_UDF_W::new(self, 7)
    }
    #[doc = "Bit 8 - The interrupt enable bit for the OUTFIFO_OVF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l3_ovf(&mut self) -> OUTFIFO_L3_OVF_W<'_, ENA_SPEC> {
        OUTFIFO_L3_OVF_W::new(self, 8)
    }
    #[doc = "Bit 9 - The interrupt enable bit for the OUTFIFO_UDF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_l3_udf(&mut self) -> OUTFIFO_L3_UDF_W<'_, ENA_SPEC> {
        OUTFIFO_L3_UDF_W::new(self, 9)
    }
    #[doc = "Bit 10 - The interrupt enable bit for the OUT_LINK_SWITCH_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_link_switch(&mut self) -> OUT_LINK_SWITCH_W<'_, ENA_SPEC> {
