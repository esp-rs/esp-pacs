...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_CONF0")
            .field("out_rst_", &self.out_rst_().bit())
            ...
            .field("out_etm_en", &self.out_etm_en().bit())
            .field("out_burst_size_sel", &self.out_burst_size_sel().bits())
            .field("out_cmd_disable", &self.out_cmd_disable().bit())
            .field("out_ecc_aec_en", &self.out_ecc_aec_en().bit())
