...
///Field `OUT_RST_` reader - This bit is used to reset AXI_DMA channel0 Tx FSM and Tx FIFO pointer.
pub type OUT_RST__R = crate::BitReader;
///Field `OUT_RST_` writer - This bit is used to reset AXI_DMA channel0 Tx FSM and Tx FIFO pointer.
...
///Field `OUT_EOF_MODE` reader - EOF flag generation mode when transmitting data. 1: EOF flag for Tx channel0 is generated when data need to transmit has been popped from FIFO in AXI_DMA
pub type OUT_EOF_MODE_R = crate::BitReader;
///Field `OUT_EOF_MODE` writer - EOF flag generation mode when transmitting data. 1: EOF flag for Tx channel0 is generated when data need to transmit has been popped from FIFO in AXI_DMA
pub type OUT_EOF_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_ETM_EN` reader - Set this bit to 1 to enable etm control mode, dma Tx channel0 is triggered by etm task.
pub type OUT_ETM_EN_R = crate::BitReader;
///Field `OUT_ETM_EN` writer - Set this bit to 1 to enable etm control mode, dma Tx channel0 is triggered by etm task.
pub type OUT_ETM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_BURST_SIZE_SEL` reader - 3'b000-3'b100:burst length 8byte~128byte
pub type OUT_BURST_SIZE_SEL_R = crate::FieldReader;
///Field `OUT_BURST_SIZE_SEL` writer - 3'b000-3'b100:burst length 8byte~128byte
pub type OUT_BURST_SIZE_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `OUT_CMD_DISABLE` reader - 1:mean disable cmd of this ch0
pub type OUT_CMD_DISABLE_R = crate::BitReader;
///Field `OUT_CMD_DISABLE` writer - 1:mean disable cmd of this ch0
pub type OUT_CMD_DISABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_ECC_AEC_EN` reader - 1: mean access ecc or aes domain,0: mean not
pub type OUT_ECC_AEC_EN_R = crate::BitReader;
///Field `OUT_ECC_AEC_EN` writer - 1: mean access ecc or aes domain,0: mean not
pub type OUT_ECC_AEC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTDSCR_BURST_EN` reader - Set this bit to 1 to enable INCR burst transfer for Tx channel0 reading link descriptor when accessing internal SRAM.
pub type OUTDSCR_BURST_EN_R = crate::BitReader;
///Field `OUTDSCR_BURST_EN` writer - Set this bit to 1 to enable INCR burst transfer for Tx channel0 reading link descriptor when accessing internal SRAM.
pub type OUTDSCR_BURST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - This bit is used to reset AXI_DMA channel0 Tx FSM and Tx FIFO pointer.
    #[inline(always)]
    ...
    ///Bit 3 - EOF flag generation mode when transmitting data. 1: EOF flag for Tx channel0 is generated when data need to transmit has been popped from FIFO in AXI_DMA
    #[inline(always)]
    pub fn out_eof_mode(&self) -> OUT_EOF_MODE_R {
        OUT_EOF_MODE_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Set this bit to 1 to enable etm control mode, dma Tx channel0 is triggered by etm task.
    #[inline(always)]
    pub fn out_etm_en(&self) -> OUT_ETM_EN_R {
        OUT_ETM_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bits 5:7 - 3'b000-3'b100:burst length 8byte~128byte
    #[inline(always)]
    pub fn out_burst_size_sel(&self) -> OUT_BURST_SIZE_SEL_R {
        OUT_BURST_SIZE_SEL_R::new(((self.bits >> 5) & 7) as u8)
    }
    ///Bit 8 - 1:mean disable cmd of this ch0
    #[inline(always)]
    pub fn out_cmd_disable(&self) -> OUT_CMD_DISABLE_R {
        OUT_CMD_DISABLE_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - 1: mean access ecc or aes domain,0: mean not
    #[inline(always)]
    pub fn out_ecc_aec_en(&self) -> OUT_ECC_AEC_EN_R {
        OUT_ECC_AEC_EN_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Set this bit to 1 to enable INCR burst transfer for Tx channel0 reading link descriptor when accessing internal SRAM.
    #[inline(always)]
...
///`read()` method returns [`out_conf0::R`](R) reader structure
impl crate::Readable for OUT_CONF0_SPEC {}
///`write(|w| ..)` method takes [`out_conf0::W`](W) writer structure
