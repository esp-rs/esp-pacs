...
pub type TX_CRC_DATA_EN_WR_DATA_CH_R = crate::FieldReader<u16>;
#[doc = "Field `TX_CRC_DATA_EN_WR_DATA_CH` writer - reserved"]
pub type TX_CRC_DATA_EN_WR_DATA_CH_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - reserved"]
    #[inline(always)]
    pub fn tx_crc_data_en_wr_data_ch(&self) -> TX_CRC_DATA_EN_WR_DATA_CH_R {
        TX_CRC_DATA_EN_WR_DATA_CH_R::new((self.bits & 0xffff) as u16)
    }
}
...
impl W {
    ...
    pub fn tx_crc_data_en_wr_data_ch(
        &mut self,
    ) -> TX_CRC_DATA_EN_WR_DATA_CH_W<TX_CRC_DATA_EN_WR_DATA_SPEC> {
