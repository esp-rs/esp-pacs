...
///Field `OUTLINK_DSCR_BF1` reader - The address of the second-to-last outlink descriptor x-2.
pub type OUTLINK_DSCR_BF1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The address of the second-to-last outlink descriptor x-2.
    #[inline(always)]
