///Register `OUT_LINK1` reader
pub type R = crate::R<OUT_LINK1_SPEC>;
///Register `OUT_LINK1` writer
...
///`read()` method returns [`out_link1::R`](R) reader structure
impl crate::Readable for OUT_LINK1_SPEC {}
///`write(|w| ..)` method takes [`out_link1::W`](W) writer structure
impl crate::Writable for OUT_LINK1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OUT_LINK1 to value 0x08
