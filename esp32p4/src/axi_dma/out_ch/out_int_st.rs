#[doc = "Register `OUT_INT_ST` reader"]
pub type R = crate::R<OUT_INT_ST_SPEC>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<OUT_INT_ST_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "Masked interrupt of channel0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`out_int_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OUT_INT_ST_SPEC;
impl crate::RegisterSpec for OUT_INT_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`out_int_st::R`](R) reader structure"]
impl crate::Readable for OUT_INT_ST_SPEC {}
#[doc = "`reset()` method sets OUT_INT_ST to value 0"]
impl crate::Resettable for OUT_INT_ST_SPEC {
