...
///Field `OUTFIFO_WDATA` reader - This register stores the data that need to be pushed into AXI_DMA FIFO.
pub type OUTFIFO_WDATA_R = crate::FieldReader<u16>;
///Field `OUTFIFO_WDATA` writer - This register stores the data that need to be pushed into AXI_DMA FIFO.
pub type OUTFIFO_WDATA_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `OUTFIFO_PUSH` writer - Set this bit to push data into AXI_DMA FIFO.
pub type OUTFIFO_PUSH_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:8 - This register stores the data that need to be pushed into AXI_DMA FIFO.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 9 - Set this bit to push data into AXI_DMA FIFO.
    #[inline(always)]
    #[must_use]
