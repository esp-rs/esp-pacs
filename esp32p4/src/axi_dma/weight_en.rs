///Register `WEIGHT_EN` reader
pub type R = crate::R<WEIGHT_EN_SPEC>;
///Register `WEIGHT_EN` writer
pub type W = crate::W<WEIGHT_EN_SPEC>;
///Field `TX` reader - This register is used to config tx arbiter weight function off/on
pub type TX_R = crate::BitReader;
///Field `TX` writer - This register is used to config tx arbiter weight function off/on
pub type TX_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX` reader - This register is used to config rx arbiter weight function off/on
pub type RX_R = crate::BitReader;
///Field `RX` writer - This register is used to config rx arbiter weight function off/on
pub type RX_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - This register is used to config tx arbiter weight function off/on
    #[inline(always)]
    pub fn tx(&self) -> TX_R {
        TX_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - This register is used to config rx arbiter weight function off/on
    #[inline(always)]
    pub fn rx(&self) -> RX_R {
...
///`read()` method returns [`weight_en::R`](R) reader structure
impl crate::Readable for WEIGHT_EN_SPEC {}
///`write(|w| ..)` method takes [`weight_en::W`](W) writer structure
