...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn infifo_l1_ovf_ch_int_clr(&mut self) -> INFIFO_L1_OVF_CH_INT_CLR_W<IN_INT_CLR_CH_SPEC> {
        INFIFO_L1_OVF_CH_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Set this bit to clear the INFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l1_udf_ch_int_clr(&mut self) -> INFIFO_L1_UDF_CH_INT_CLR_W<IN_INT_CLR_CH_SPEC> {
        INFIFO_L1_UDF_CH_INT_CLR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Set this bit to clear the INFIFO_OVF_L2_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l2_ovf_ch_int_clr(&mut self) -> INFIFO_L2_OVF_CH_INT_CLR_W<IN_INT_CLR_CH_SPEC> {
        INFIFO_L2_OVF_CH_INT_CLR_W::new(self, 7)
    }
    #[doc = "Bit 8 - Set this bit to clear the INFIFO_UDF_L2_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l2_udf_ch_int_clr(&mut self) -> INFIFO_L2_UDF_CH_INT_CLR_W<IN_INT_CLR_CH_SPEC> {
        INFIFO_L2_UDF_CH_INT_CLR_W::new(self, 8)
    }
    #[doc = "Bit 9 - Set this bit to clear the INFIFO_OVF_L3_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l3_ovf_ch_int_clr(&mut self) -> INFIFO_L3_OVF_CH_INT_CLR_W<IN_INT_CLR_CH_SPEC> {
        INFIFO_L3_OVF_CH_INT_CLR_W::new(self, 9)
    }
    #[doc = "Bit 10 - Set this bit to clear the INFIFO_UDF_L3_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_l3_udf_ch_int_clr(&mut self) -> INFIFO_L3_UDF_CH_INT_CLR_W<IN_INT_CLR_CH_SPEC> {
