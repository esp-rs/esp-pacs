///Register `IN_MEM_CONF` reader
pub type R = crate::R<IN_MEM_CONF_SPEC>;
///Register `IN_MEM_CONF` writer
pub type W = crate::W<IN_MEM_CONF_SPEC>;
///Field `IN_MEM_CLK_FORCE_EN` reader - 1: Force to open the clock and bypass the gate-clock when accessing the RAM in AXI_DMA. 0: A gate-clock will be used when accessing the RAM in AXI_DMA.
pub type IN_MEM_CLK_FORCE_EN_R = crate::BitReader;
///Field `IN_MEM_CLK_FORCE_EN` writer - 1: Force to open the clock and bypass the gate-clock when accessing the RAM in AXI_DMA. 0: A gate-clock will be used when accessing the RAM in AXI_DMA.
pub type IN_MEM_CLK_FORCE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_MEM_FORCE_PU` reader - Force power up ram
pub type IN_MEM_FORCE_PU_R = crate::BitReader;
///Field `IN_MEM_FORCE_PU` writer - Force power up ram
pub type IN_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_MEM_FORCE_PD` reader - Force power down ram
pub type IN_MEM_FORCE_PD_R = crate::BitReader;
///Field `IN_MEM_FORCE_PD` writer - Force power down ram
pub type IN_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_MEM_CLK_FORCE_EN` reader - 1: Force to open the clock and bypass the gate-clock when accessing the RAM in AXI_DMA. 0: A gate-clock will be used when accessing the RAM in AXI_DMA.
pub type OUT_MEM_CLK_FORCE_EN_R = crate::BitReader;
///Field `OUT_MEM_CLK_FORCE_EN` writer - 1: Force to open the clock and bypass the gate-clock when accessing the RAM in AXI_DMA. 0: A gate-clock will be used when accessing the RAM in AXI_DMA.
pub type OUT_MEM_CLK_FORCE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_MEM_FORCE_PU` reader - Force power up ram
pub type OUT_MEM_FORCE_PU_R = crate::BitReader;
///Field `OUT_MEM_FORCE_PU` writer - Force power up ram
pub type OUT_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_MEM_FORCE_PD` reader - Force power down ram
pub type OUT_MEM_FORCE_PD_R = crate::BitReader;
///Field `OUT_MEM_FORCE_PD` writer - Force power down ram
pub type OUT_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - 1: Force to open the clock and bypass the gate-clock when accessing the RAM in AXI_DMA. 0: A gate-clock will be used when accessing the RAM in AXI_DMA.
    #[inline(always)]
    pub fn in_mem_clk_force_en(&self) -> IN_MEM_CLK_FORCE_EN_R {
        IN_MEM_CLK_FORCE_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Force power up ram
    #[inline(always)]
    pub fn in_mem_force_pu(&self) -> IN_MEM_FORCE_PU_R {
        IN_MEM_FORCE_PU_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Force power down ram
    #[inline(always)]
    pub fn in_mem_force_pd(&self) -> IN_MEM_FORCE_PD_R {
        IN_MEM_FORCE_PD_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - 1: Force to open the clock and bypass the gate-clock when accessing the RAM in AXI_DMA. 0: A gate-clock will be used when accessing the RAM in AXI_DMA.
    #[inline(always)]
    pub fn out_mem_clk_force_en(&self) -> OUT_MEM_CLK_FORCE_EN_R {
        OUT_MEM_CLK_FORCE_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Force power up ram
    #[inline(always)]
    pub fn out_mem_force_pu(&self) -> OUT_MEM_FORCE_PU_R {
        OUT_MEM_FORCE_PU_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Force power down ram
    #[inline(always)]
...
///`read()` method returns [`in_mem_conf::R`](R) reader structure
impl crate::Readable for IN_MEM_CONF_SPEC {}
///`write(|w| ..)` method takes [`in_mem_conf::W`](W) writer structure
