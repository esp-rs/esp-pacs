...
#[doc = "Field `ICM_RDN_ECO_HIGH` reader - "]
pub type ICM_RDN_ECO_HIGH_R = crate::FieldReader<u32>;
#[doc = "Field `ICM_RDN_ECO_HIGH` writer - "]
pub type ICM_RDN_ECO_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn icm_rdn_eco_high(&self) -> ICM_RDN_ECO_HIGH_R {
        ICM_RDN_ECO_HIGH_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ICM_RDN_ECO_HIGH")
            .field("icm_rdn_eco_high", &self.icm_rdn_eco_high())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn icm_rdn_eco_high(&mut self) -> ICM_RDN_ECO_HIGH_W<'_, ICM_RDN_ECO_HIGH_SPEC> {
        ICM_RDN_ECO_HIGH_W::new(self, 0)
    }
}
