...
#[doc = "CPU address hole info\n\nYou can [`read`](crate::Reg::read) this register and get [`icm_cpu_addrhole_info::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ICM_CPU_ADDRHOLE_INFO_SPEC;
impl crate::RegisterSpec for ICM_CPU_ADDRHOLE_INFO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`icm_cpu_addrhole_info::R`](R) reader structure"]
impl crate::Readable for ICM_CPU_ADDRHOLE_INFO_SPEC {}
#[doc = "`reset()` method sets ICM_CPU_ADDRHOLE_INFO to value 0"]
impl crate::Resettable for ICM_CPU_ADDRHOLE_INFO_SPEC {}
