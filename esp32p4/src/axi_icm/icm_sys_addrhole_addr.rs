...
#[doc = "Field `ICM_REG_ICM_SYS_ADDRHOLE_ADDR` reader - "]
pub type ICM_REG_ICM_SYS_ADDRHOLE_ADDR_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn icm_reg_icm_sys_addrhole_addr(&self) -> ICM_REG_ICM_SYS_ADDRHOLE_ADDR_R {
        ICM_REG_ICM_SYS_ADDRHOLE_ADDR_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ICM_SYS_ADDRHOLE_ADDR")
            .field(
                "icm_reg_icm_sys_addrhole_addr",
                &self.icm_reg_icm_sys_addrhole_addr(),
            )
            .finish()
    }
}
