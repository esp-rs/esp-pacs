...
pub type DLOCK_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ICM_SYS_ADDRHOLE_INT_CLR` writer - "]
pub type ICM_SYS_ADDRHOLE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ICM_CPU_ADDRHOLE_INT_CLR` writer - "]
pub type ICM_CPU_ADDRHOLE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn dlock_int_clr(&mut self) -> DLOCK_INT_CLR_W<'_, ICM_INT_CLR_SPEC> {
        DLOCK_INT_CLR_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn icm_sys_addrhole_int_clr(&mut self) -> ICM_SYS_ADDRHOLE_INT_CLR_W<'_, ICM_INT_CLR_SPEC> {
        ICM_SYS_ADDRHOLE_INT_CLR_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn icm_cpu_addrhole_int_clr(&mut self) -> ICM_CPU_ADDRHOLE_INT_CLR_W<'_, ICM_INT_CLR_SPEC> {
        ICM_CPU_ADDRHOLE_INT_CLR_W::new(self, 2)
    }
}
