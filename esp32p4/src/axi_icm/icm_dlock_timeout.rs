...
#[doc = "Field `DLOCK_TIMEOUT` reader - "]
pub type DLOCK_TIMEOUT_R = crate::FieldReader<u16>;
#[doc = "Field `DLOCK_TIMEOUT` writer - "]
pub type DLOCK_TIMEOUT_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
impl R {
    #[doc = "Bits 0:12"]
    #[inline(always)]
    pub fn dlock_timeout(&self) -> DLOCK_TIMEOUT_R {
        DLOCK_TIMEOUT_R::new((self.bits & 0x1fff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ICM_DLOCK_TIMEOUT")
            .field("dlock_timeout", &self.dlock_timeout())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:12"]
    #[inline(always)]
    pub fn dlock_timeout(&mut self) -> DLOCK_TIMEOUT_W<'_, ICM_DLOCK_TIMEOUT_SPEC> {
        DLOCK_TIMEOUT_W::new(self, 0)
    }
}
