...
#[doc = "Field `ICM_REG_VER_DATE` reader - "]
pub type ICM_REG_VER_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `ICM_REG_VER_DATE` writer - "]
pub type ICM_REG_VER_DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn icm_reg_ver_date(&self) -> ICM_REG_VER_DATE_R {
        ICM_REG_VER_DATE_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ICM_VER_DATE")
            .field("icm_reg_ver_date", &self.icm_reg_ver_date())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn icm_reg_ver_date(&mut self) -> ICM_REG_VER_DATE_W<'_, ICM_VER_DATE_SPEC> {
