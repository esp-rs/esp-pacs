///Register `DEMOSAIC_MATRIX_CTRL` reader
pub type R = crate::R<DEMOSAIC_MATRIX_CTRL_SPEC>;
///Register `DEMOSAIC_MATRIX_CTRL` writer
...
///Field `DEMOSAIC_TAIL_PIXEN_PULSE_TL` writer - matrix tail pixen low level threshold, should not to large to prevent expanding to next frame, only reg_demosaic_tail_pixen_pulse_th!=0 and reg_demosaic_tail_pixen_pulse_tl!=0 and reg_demosaic_tail_pixen_pulse_th &lt; reg_demosaic_tail_pixen_pulse_tl will enable tail pulse function
pub type DEMOSAIC_TAIL_PIXEN_PULSE_TL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DEMOSAIC_TAIL_PIXEN_PULSE_TH` reader - matrix tail pixen high level threshold, must &lt; hnum-1, only reg_demosaic_tail_pixen_pulse_th!=0 and reg_demosaic_tail_pixen_pulse_tl!=0 and reg_demosaic_tail_pixen_pulse_th &lt; reg_demosaic_tail_pixen_pulse_tl will enable tail pulse function
pub type DEMOSAIC_TAIL_PIXEN_PULSE_TH_R = crate::FieldReader;
///Field `DEMOSAIC_TAIL_PIXEN_PULSE_TH` writer - matrix tail pixen high level threshold, must &lt; hnum-1, only reg_demosaic_tail_pixen_pulse_th!=0 and reg_demosaic_tail_pixen_pulse_tl!=0 and reg_demosaic_tail_pixen_pulse_th &lt; reg_demosaic_tail_pixen_pulse_tl will enable tail pulse function
pub type DEMOSAIC_TAIL_PIXEN_PULSE_TH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DEMOSAIC_PADDING_DATA` reader - this field configures demosaic matrix padding data
pub type DEMOSAIC_PADDING_DATA_R = crate::FieldReader;
///Field `DEMOSAIC_PADDING_DATA` writer - this field configures demosaic matrix padding data
pub type DEMOSAIC_PADDING_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DEMOSAIC_PADDING_MODE` reader - this bit configures the padding mode of demosaic matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding
pub type DEMOSAIC_PADDING_MODE_R = crate::BitReader;
///Field `DEMOSAIC_PADDING_MODE` writer - this bit configures the padding mode of demosaic matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding
pub type DEMOSAIC_PADDING_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:7 - matrix tail pixen low level threshold, should not to large to prevent expanding to next frame, only reg_demosaic_tail_pixen_pulse_th!=0 and reg_demosaic_tail_pixen_pulse_tl!=0 and reg_demosaic_tail_pixen_pulse_th &lt; reg_demosaic_tail_pixen_pulse_tl will enable tail pulse function
    #[inline(always)]
    ...
    ///Bits 8:15 - matrix tail pixen high level threshold, must &lt; hnum-1, only reg_demosaic_tail_pixen_pulse_th!=0 and reg_demosaic_tail_pixen_pulse_tl!=0 and reg_demosaic_tail_pixen_pulse_th &lt; reg_demosaic_tail_pixen_pulse_tl will enable tail pulse function
    #[inline(always)]
...
///`read()` method returns [`demosaic_matrix_ctrl::R`](R) reader structure
impl crate::Readable for DEMOSAIC_MATRIX_CTRL_SPEC {}
///`write(|w| ..)` method takes [`demosaic_matrix_ctrl::W`](W) writer structure
