///Register `BLC_CTRL2` reader
pub type R = crate::R<BLC_CTRL2_SPEC>;
///Register `BLC_CTRL2` writer
pub type W = crate::W<BLC_CTRL2_SPEC>;
///Field `BLC_R3_TH` reader - this field configures black threshold when get blc average of bottom right channel
pub type BLC_R3_TH_R = crate::FieldReader;
///Field `BLC_R3_TH` writer - this field configures black threshold when get blc average of bottom right channel
pub type BLC_R3_TH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `BLC_R2_TH` reader - this field configures black threshold when get blc average of bottom left channel
pub type BLC_R2_TH_R = crate::FieldReader;
///Field `BLC_R2_TH` writer - this field configures black threshold when get blc average of bottom left channel
pub type BLC_R2_TH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `BLC_R1_TH` reader - this field configures black threshold when get blc average of top right channel
pub type BLC_R1_TH_R = crate::FieldReader;
///Field `BLC_R1_TH` writer - this field configures black threshold when get blc average of top right channel
pub type BLC_R1_TH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `BLC_R0_TH` reader - this field configures black threshold when get blc average of top left channel
pub type BLC_R0_TH_R = crate::FieldReader;
///Field `BLC_R0_TH` writer - this field configures black threshold when get blc average of top left channel
pub type BLC_R0_TH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures black threshold when get blc average of bottom right channel
    #[inline(always)]
    pub fn blc_r3_th(&self) -> BLC_R3_TH_R {
        BLC_R3_TH_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures black threshold when get blc average of bottom left channel
    #[inline(always)]
    pub fn blc_r2_th(&self) -> BLC_R2_TH_R {
        BLC_R2_TH_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures black threshold when get blc average of top right channel
    #[inline(always)]
    pub fn blc_r1_th(&self) -> BLC_R1_TH_R {
        BLC_R1_TH_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures black threshold when get blc average of top left channel
    #[inline(always)]
...
///`read()` method returns [`blc_ctrl2::R`](R) reader structure
impl crate::Readable for BLC_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`blc_ctrl2::W`](W) writer structure
