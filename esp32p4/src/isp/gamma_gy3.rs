///Register `GAMMA_GY3` reader
pub type R = crate::R<GAMMA_GY3_SPEC>;
///Register `GAMMA_GY3` writer
pub type W = crate::W<GAMMA_GY3_SPEC>;
///Field `GAMMA_G_Y0B` reader - this field configures the point 11 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y0B_R = crate::FieldReader;
///Field `GAMMA_G_Y0B` writer - this field configures the point 11 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y0B_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_G_Y0A` reader - this field configures the point 10 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y0A_R = crate::FieldReader;
///Field `GAMMA_G_Y0A` writer - this field configures the point 10 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y0A_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_G_Y09` reader - this field configures the point 9 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y09_R = crate::FieldReader;
///Field `GAMMA_G_Y09` writer - this field configures the point 9 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y09_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_G_Y08` reader - this field configures the point 8 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y08_R = crate::FieldReader;
///Field `GAMMA_G_Y08` writer - this field configures the point 8 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y08_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures the point 11 of Y-axis of g channel gamma curve
    #[inline(always)]
    pub fn gamma_g_y0b(&self) -> GAMMA_G_Y0B_R {
        GAMMA_G_Y0B_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures the point 10 of Y-axis of g channel gamma curve
    #[inline(always)]
    pub fn gamma_g_y0a(&self) -> GAMMA_G_Y0A_R {
        GAMMA_G_Y0A_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures the point 9 of Y-axis of g channel gamma curve
    #[inline(always)]
    pub fn gamma_g_y09(&self) -> GAMMA_G_Y09_R {
        GAMMA_G_Y09_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures the point 8 of Y-axis of g channel gamma curve
    #[inline(always)]
...
///`read()` method returns [`gamma_gy3::R`](R) reader structure
impl crate::Readable for GAMMA_GY3_SPEC {}
///`write(|w| ..)` method takes [`gamma_gy3::W`](W) writer structure
