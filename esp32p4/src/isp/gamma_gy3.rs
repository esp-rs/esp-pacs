...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GAMMA_GY3")
            .field(
                "gamma_g_y0b",
                &format_args!("{}", self.gamma_g_y0b().bits()),
            )
            .field(
                "gamma_g_y0a",
                &format_args!("{}", self.gamma_g_y0a().bits()),
            )
            .field(
                "gamma_g_y09",
                &format_args!("{}", self.gamma_g_y09().bits()),
            )
            .field(
                "gamma_g_y08",
                &format_args!("{}", self.gamma_g_y08().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<GAMMA_GY3_SPEC> {
...
impl crate::Resettable for GAMMA_GY3_SPEC {
    const RESET_VALUE: Self::Ux = 0x90a0_b0c0;
}
