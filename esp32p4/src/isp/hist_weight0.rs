///Register `HIST_WEIGHT0` reader
pub type R = crate::R<HIST_WEIGHT0_SPEC>;
///Register `HIST_WEIGHT0` writer
pub type W = crate::W<HIST_WEIGHT0_SPEC>;
///Field `HIST_WEIGHT_03` reader - this field configures weight of subwindow 03
pub type HIST_WEIGHT_03_R = crate::FieldReader;
///Field `HIST_WEIGHT_03` writer - this field configures weight of subwindow 03
pub type HIST_WEIGHT_03_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_02` reader - this field configures weight of subwindow 02
pub type HIST_WEIGHT_02_R = crate::FieldReader;
///Field `HIST_WEIGHT_02` writer - this field configures weight of subwindow 02
pub type HIST_WEIGHT_02_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_01` reader - this field configures weight of subwindow 01
pub type HIST_WEIGHT_01_R = crate::FieldReader;
///Field `HIST_WEIGHT_01` writer - this field configures weight of subwindow 01
pub type HIST_WEIGHT_01_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_00` reader - this field configures weight of subwindow 00 and sum of all weight should be 256
pub type HIST_WEIGHT_00_R = crate::FieldReader;
///Field `HIST_WEIGHT_00` writer - this field configures weight of subwindow 00 and sum of all weight should be 256
pub type HIST_WEIGHT_00_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures weight of subwindow 03
    #[inline(always)]
    pub fn hist_weight_03(&self) -> HIST_WEIGHT_03_R {
        HIST_WEIGHT_03_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures weight of subwindow 02
    #[inline(always)]
    pub fn hist_weight_02(&self) -> HIST_WEIGHT_02_R {
        HIST_WEIGHT_02_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures weight of subwindow 01
    #[inline(always)]
    pub fn hist_weight_01(&self) -> HIST_WEIGHT_01_R {
        HIST_WEIGHT_01_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures weight of subwindow 00 and sum of all weight should be 256
    #[inline(always)]
...
///`read()` method returns [`hist_weight0::R`](R) reader structure
impl crate::Readable for HIST_WEIGHT0_SPEC {}
///`write(|w| ..)` method takes [`hist_weight0::W`](W) writer structure
