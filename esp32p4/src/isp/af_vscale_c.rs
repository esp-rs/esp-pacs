///Register `AF_VSCALE_C` reader
pub type R = crate::R<AF_VSCALE_C_SPEC>;
///Register `AF_VSCALE_C` writer
pub type W = crate::W<AF_VSCALE_C_SPEC>;
///Field `AF_BPOINT_C` reader - this field configures right coordinate of focus window c, must &lt;= hnum-2
pub type AF_BPOINT_C_R = crate::FieldReader<u16>;
///Field `AF_BPOINT_C` writer - this field configures right coordinate of focus window c, must &lt;= hnum-2
pub type AF_BPOINT_C_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `AF_TPOINT_C` reader - this field configures bottom coordinate of focus window c, must &lt;= hnum-2
pub type AF_TPOINT_C_R = crate::FieldReader<u16>;
///Field `AF_TPOINT_C` writer - this field configures bottom coordinate of focus window c, must &lt;= hnum-2
pub type AF_TPOINT_C_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - this field configures right coordinate of focus window c, must &lt;= hnum-2
    #[inline(always)]
    pub fn af_bpoint_c(&self) -> AF_BPOINT_C_R {
        AF_BPOINT_C_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bits 16:27 - this field configures bottom coordinate of focus window c, must &lt;= hnum-2
    #[inline(always)]
...
///`read()` method returns [`af_vscale_c::R`](R) reader structure
impl crate::Readable for AF_VSCALE_C_SPEC {}
///`write(|w| ..)` method takes [`af_vscale_c::W`](W) writer structure
