///Register `AWB0_ACC_B` reader
pub type R = crate::R<AWB0_ACC_B_SPEC>;
///Field `AWB0_ACC_B` reader - this field represents accumulate of channel b of all white point of algo0
pub type AWB0_ACC_B_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - this field represents accumulate of channel b of all white point of algo0
    #[inline(always)]
...
///`read()` method returns [`awb0_acc_b::R`](R) reader structure
