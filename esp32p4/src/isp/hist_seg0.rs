///Register `HIST_SEG0` reader
pub type R = crate::R<HIST_SEG0_SPEC>;
///Register `HIST_SEG0` writer
pub type W = crate::W<HIST_SEG0_SPEC>;
///Field `HIST_SEG_3_4` reader - this field configures threshold of histogram bin 3 and bin 4
pub type HIST_SEG_3_4_R = crate::FieldReader;
///Field `HIST_SEG_3_4` writer - this field configures threshold of histogram bin 3 and bin 4
pub type HIST_SEG_3_4_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_SEG_2_3` reader - this field configures threshold of histogram bin 2 and bin 3
pub type HIST_SEG_2_3_R = crate::FieldReader;
///Field `HIST_SEG_2_3` writer - this field configures threshold of histogram bin 2 and bin 3
pub type HIST_SEG_2_3_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_SEG_1_2` reader - this field configures threshold of histogram bin 1 and bin 2
pub type HIST_SEG_1_2_R = crate::FieldReader;
///Field `HIST_SEG_1_2` writer - this field configures threshold of histogram bin 1 and bin 2
pub type HIST_SEG_1_2_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_SEG_0_1` reader - this field configures threshold of histogram bin 0 and bin 1
pub type HIST_SEG_0_1_R = crate::FieldReader;
///Field `HIST_SEG_0_1` writer - this field configures threshold of histogram bin 0 and bin 1
pub type HIST_SEG_0_1_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures threshold of histogram bin 3 and bin 4
    #[inline(always)]
    pub fn hist_seg_3_4(&self) -> HIST_SEG_3_4_R {
        HIST_SEG_3_4_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures threshold of histogram bin 2 and bin 3
    #[inline(always)]
    pub fn hist_seg_2_3(&self) -> HIST_SEG_2_3_R {
        HIST_SEG_2_3_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures threshold of histogram bin 1 and bin 2
    #[inline(always)]
    pub fn hist_seg_1_2(&self) -> HIST_SEG_1_2_R {
        HIST_SEG_1_2_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures threshold of histogram bin 0 and bin 1
    #[inline(always)]
...
///`read()` method returns [`hist_seg0::R`](R) reader structure
impl crate::Readable for HIST_SEG0_SPEC {}
///`write(|w| ..)` method takes [`hist_seg0::W`](W) writer structure
