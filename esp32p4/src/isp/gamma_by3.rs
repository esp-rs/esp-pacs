///Register `GAMMA_BY3` reader
pub type R = crate::R<GAMMA_BY3_SPEC>;
///Register `GAMMA_BY3` writer
pub type W = crate::W<GAMMA_BY3_SPEC>;
///Field `GAMMA_B_Y0B` reader - this field configures the point 11 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y0B_R = crate::FieldReader;
///Field `GAMMA_B_Y0B` writer - this field configures the point 11 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y0B_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_B_Y0A` reader - this field configures the point 10 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y0A_R = crate::FieldReader;
///Field `GAMMA_B_Y0A` writer - this field configures the point 10 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y0A_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_B_Y09` reader - this field configures the point 9 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y09_R = crate::FieldReader;
///Field `GAMMA_B_Y09` writer - this field configures the point 9 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y09_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_B_Y08` reader - this field configures the point 8 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y08_R = crate::FieldReader;
///Field `GAMMA_B_Y08` writer - this field configures the point 8 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y08_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures the point 11 of Y-axis of b channel gamma curve
    #[inline(always)]
    pub fn gamma_b_y0b(&self) -> GAMMA_B_Y0B_R {
        GAMMA_B_Y0B_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures the point 10 of Y-axis of b channel gamma curve
    #[inline(always)]
    pub fn gamma_b_y0a(&self) -> GAMMA_B_Y0A_R {
        GAMMA_B_Y0A_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures the point 9 of Y-axis of b channel gamma curve
    #[inline(always)]
    pub fn gamma_b_y09(&self) -> GAMMA_B_Y09_R {
        GAMMA_B_Y09_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures the point 8 of Y-axis of b channel gamma curve
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GAMMA_BY3")
            .field("gamma_b_y0b", &self.gamma_b_y0b())
            .field("gamma_b_y0a", &self.gamma_b_y0a())
            .field("gamma_b_y09", &self.gamma_b_y09())
            .field("gamma_b_y08", &self.gamma_b_y08())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`gamma_by3::R`](R) reader structure
impl crate::Readable for GAMMA_BY3_SPEC {}
///`write(|w| ..)` method takes [`gamma_by3::W`](W) writer structure
