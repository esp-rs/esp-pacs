///Register `DPC_MATRIX_CTRL` reader
pub type R = crate::R<DPC_MATRIX_CTRL_SPEC>;
///Register `DPC_MATRIX_CTRL` writer
pub type W = crate::W<DPC_MATRIX_CTRL_SPEC>;
///Field `DPC_TAIL_PIXEN_PULSE_TL` reader - matrix tail pixen low level threshold, should not to large to prevent expanding to next frame, only reg_dpc_tail_pixen_pulse_th!=0 and reg_dpc_tail_pixen_pulse_tl!=0 and reg_dpc_tail_pixen_pulse_th &lt; reg_dpc_tail_pixen_pulse_tl will enable tail pulse function
pub type DPC_TAIL_PIXEN_PULSE_TL_R = crate::FieldReader;
///Field `DPC_TAIL_PIXEN_PULSE_TL` writer - matrix tail pixen low level threshold, should not to large to prevent expanding to next frame, only reg_dpc_tail_pixen_pulse_th!=0 and reg_dpc_tail_pixen_pulse_tl!=0 and reg_dpc_tail_pixen_pulse_th &lt; reg_dpc_tail_pixen_pulse_tl will enable tail pulse function
pub type DPC_TAIL_PIXEN_PULSE_TL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DPC_TAIL_PIXEN_PULSE_TH` reader - matrix tail pixen high level threshold, must &lt; hnum-1, only reg_dpc_tail_pixen_pulse_th!=0 and reg_dpc_tail_pixen_pulse_tl!=0 and reg_dpc_tail_pixen_pulse_th &lt; reg_dpc_tail_pixen_pulse_tl will enable tail pulse function
pub type DPC_TAIL_PIXEN_PULSE_TH_R = crate::FieldReader;
///Field `DPC_TAIL_PIXEN_PULSE_TH` writer - matrix tail pixen high level threshold, must &lt; hnum-1, only reg_dpc_tail_pixen_pulse_th!=0 and reg_dpc_tail_pixen_pulse_tl!=0 and reg_dpc_tail_pixen_pulse_th &lt; reg_dpc_tail_pixen_pulse_tl will enable tail pulse function
pub type DPC_TAIL_PIXEN_PULSE_TH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DPC_PADDING_DATA` reader - this field configures dpc matrix padding data
pub type DPC_PADDING_DATA_R = crate::FieldReader;
///Field `DPC_PADDING_DATA` writer - this field configures dpc matrix padding data
pub type DPC_PADDING_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DPC_PADDING_MODE` reader - this bit configures the padding mode of dpc matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding
pub type DPC_PADDING_MODE_R = crate::BitReader;
///Field `DPC_PADDING_MODE` writer - this bit configures the padding mode of dpc matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding
...
impl R {
    ...
    ///Bit 24 - this bit configures the padding mode of dpc matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding
    #[inline(always)]
...
///`read()` method returns [`dpc_matrix_ctrl::R`](R) reader structure
impl crate::Readable for DPC_MATRIX_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dpc_matrix_ctrl::W`](W) writer structure
