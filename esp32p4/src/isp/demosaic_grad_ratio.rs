///Register `DEMOSAIC_GRAD_RATIO` reader
pub type R = crate::R<DEMOSAIC_GRAD_RATIO_SPEC>;
///Register `DEMOSAIC_GRAD_RATIO` writer
pub type W = crate::W<DEMOSAIC_GRAD_RATIO_SPEC>;
///Field `DEMOSAIC_GRAD_RATIO` reader - this field configures demosaic gradient select ratio
pub type DEMOSAIC_GRAD_RATIO_R = crate::FieldReader;
///Field `DEMOSAIC_GRAD_RATIO` writer - this field configures demosaic gradient select ratio
pub type DEMOSAIC_GRAD_RATIO_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - this field configures demosaic gradient select ratio
    #[inline(always)]
...
///`read()` method returns [`demosaic_grad_ratio::R`](R) reader structure
impl crate::Readable for DEMOSAIC_GRAD_RATIO_SPEC {}
///`write(|w| ..)` method takes [`demosaic_grad_ratio::W`](W) writer structure
