...
impl W {
    #[doc = "Bits 0:7 - this field configures median matrix padding data"]
    #[inline(always)]
    pub fn median_padding_data(&mut self) -> MEDIAN_PADDING_DATA_W<'_, MEDIAN_MATRIX_CTRL_SPEC> {
        MEDIAN_PADDING_DATA_W::new(self, 0)
    }
    #[doc = "Bit 8 - this bit configures the padding mode of median matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding"]
    #[inline(always)]
    pub fn median_padding_mode(&mut self) -> MEDIAN_PADDING_MODE_W<'_, MEDIAN_MATRIX_CTRL_SPEC> {
        MEDIAN_PADDING_MODE_W::new(self, 8)
    }
}
#[doc = "median pix2matrix ctrl\n\nYou can [`read`](crate::Reg::read) this register and get [`median_matrix_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`median_matrix_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
