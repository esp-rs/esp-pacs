///Register `MEDIAN_MATRIX_CTRL` reader
pub type R = crate::R<MEDIAN_MATRIX_CTRL_SPEC>;
///Register `MEDIAN_MATRIX_CTRL` writer
pub type W = crate::W<MEDIAN_MATRIX_CTRL_SPEC>;
///Field `MEDIAN_PADDING_DATA` reader - this field configures median matrix padding data
pub type MEDIAN_PADDING_DATA_R = crate::FieldReader;
///Field `MEDIAN_PADDING_DATA` writer - this field configures median matrix padding data
pub type MEDIAN_PADDING_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `MEDIAN_PADDING_MODE` reader - this bit configures the padding mode of median matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding
pub type MEDIAN_PADDING_MODE_R = crate::BitReader;
///Field `MEDIAN_PADDING_MODE` writer - this bit configures the padding mode of median matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding
pub type MEDIAN_PADDING_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:7 - this field configures median matrix padding data
    #[inline(always)]
    pub fn median_padding_data(&self) -> MEDIAN_PADDING_DATA_R {
        MEDIAN_PADDING_DATA_R::new((self.bits & 0xff) as u8)
    }
    ///Bit 8 - this bit configures the padding mode of median matrix. 0: use pixel in image to do padding 1: use reg_padding_data to do padding
    #[inline(always)]
...
///`read()` method returns [`median_matrix_ctrl::R`](R) reader structure
impl crate::Readable for MEDIAN_MATRIX_CTRL_SPEC {}
///`write(|w| ..)` method takes [`median_matrix_ctrl::W`](W) writer structure
