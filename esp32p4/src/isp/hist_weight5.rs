///Register `HIST_WEIGHT5` reader
pub type R = crate::R<HIST_WEIGHT5_SPEC>;
///Register `HIST_WEIGHT5` writer
pub type W = crate::W<HIST_WEIGHT5_SPEC>;
///Field `HIST_WEIGHT_43` reader - this field configures weight of subwindow 43
pub type HIST_WEIGHT_43_R = crate::FieldReader;
///Field `HIST_WEIGHT_43` writer - this field configures weight of subwindow 43
pub type HIST_WEIGHT_43_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_42` reader - this field configures weight of subwindow 42
pub type HIST_WEIGHT_42_R = crate::FieldReader;
///Field `HIST_WEIGHT_42` writer - this field configures weight of subwindow 42
pub type HIST_WEIGHT_42_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_41` reader - this field configures weight of subwindow 41
pub type HIST_WEIGHT_41_R = crate::FieldReader;
///Field `HIST_WEIGHT_41` writer - this field configures weight of subwindow 41
pub type HIST_WEIGHT_41_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_40` reader - this field configures weight of subwindow 40
pub type HIST_WEIGHT_40_R = crate::FieldReader;
///Field `HIST_WEIGHT_40` writer - this field configures weight of subwindow 40
pub type HIST_WEIGHT_40_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures weight of subwindow 43
    #[inline(always)]
    pub fn hist_weight_43(&self) -> HIST_WEIGHT_43_R {
        HIST_WEIGHT_43_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures weight of subwindow 42
    #[inline(always)]
    pub fn hist_weight_42(&self) -> HIST_WEIGHT_42_R {
        HIST_WEIGHT_42_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures weight of subwindow 41
    #[inline(always)]
    pub fn hist_weight_41(&self) -> HIST_WEIGHT_41_R {
        HIST_WEIGHT_41_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures weight of subwindow 40
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HIST_WEIGHT5")
            .field("hist_weight_43", &self.hist_weight_43())
            .field("hist_weight_42", &self.hist_weight_42())
            .field("hist_weight_41", &self.hist_weight_41())
            .field("hist_weight_40", &self.hist_weight_40())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`hist_weight5::R`](R) reader structure
impl crate::Readable for HIST_WEIGHT5_SPEC {}
///`write(|w| ..)` method takes [`hist_weight5::W`](W) writer structure
