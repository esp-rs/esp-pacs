///Register `AF_SUM_B` reader
pub type R = crate::R<AF_SUM_B_SPEC>;
///Field `AF_SUMB` reader - this field represents the result of accumulation of pix grad of focus window b
pub type AF_SUMB_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:29 - this field represents the result of accumulation of pix grad of focus window b
    #[inline(always)]
...
///`read()` method returns [`af_sum_b::R`](R) reader structure
