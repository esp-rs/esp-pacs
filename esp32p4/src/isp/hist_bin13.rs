///Register `HIST_BIN13` reader
pub type R = crate::R<HIST_BIN13_SPEC>;
///Field `HIST_BIN_13` reader - this field represents result of histogram bin 13
pub type HIST_BIN_13_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:16 - this field represents result of histogram bin 13
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HIST_BIN13")
            .field("hist_bin_13", &self.hist_bin_13())
            .finish()
    }
}
...
///`read()` method returns [`hist_bin13::R`](R) reader structure
