///Register `BF_SIGMA` reader
pub type R = crate::R<BF_SIGMA_SPEC>;
///Register `BF_SIGMA` writer
pub type W = crate::W<BF_SIGMA_SPEC>;
///Field `SIGMA` reader - this field configures the bayer denoising level, valid data from 2 to 20
pub type SIGMA_R = crate::FieldReader;
///Field `SIGMA` writer - this field configures the bayer denoising level, valid data from 2 to 20
pub type SIGMA_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - this field configures the bayer denoising level, valid data from 2 to 20
    #[inline(always)]
...
///`read()` method returns [`bf_sigma::R`](R) reader structure
impl crate::Readable for BF_SIGMA_SPEC {}
///`write(|w| ..)` method takes [`bf_sigma::W`](W) writer structure
