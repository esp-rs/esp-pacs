///Register `CCM_COEF1` reader
pub type R = crate::R<CCM_COEF1_SPEC>;
///Register `CCM_COEF1` writer
pub type W = crate::W<CCM_COEF1_SPEC>;
///Field `CCM_RB` reader - this field configures the color correction matrix coefficient
pub type CCM_RB_R = crate::FieldReader<u16>;
///Field `CCM_RB` writer - this field configures the color correction matrix coefficient
pub type CCM_RB_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `CCM_GR` reader - this field configures the color correction matrix coefficient
pub type CCM_GR_R = crate::FieldReader<u16>;
///Field `CCM_GR` writer - this field configures the color correction matrix coefficient
...
///`read()` method returns [`ccm_coef1::R`](R) reader structure
impl crate::Readable for CCM_COEF1_SPEC {}
///`write(|w| ..)` method takes [`ccm_coef1::W`](W) writer structure
