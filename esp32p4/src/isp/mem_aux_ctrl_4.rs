///Register `MEM_AUX_CTRL_4` reader
pub type R = crate::R<MEM_AUX_CTRL_4_SPEC>;
///Register `MEM_AUX_CTRL_4` writer
pub type W = crate::W<MEM_AUX_CTRL_4_SPEC>;
///Field `SHARP_MATRIX_UV_MEM_AUX_CTRL` reader - this field configures the mem_aux of sharp uv line buffer memory
pub type SHARP_MATRIX_UV_MEM_AUX_CTRL_R = crate::FieldReader<u16>;
///Field `SHARP_MATRIX_UV_MEM_AUX_CTRL` writer - this field configures the mem_aux of sharp uv line buffer memory
pub type SHARP_MATRIX_UV_MEM_AUX_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    ///Bits 0:13 - this field configures the mem_aux of sharp uv line buffer memory
    #[inline(always)]
...
///`read()` method returns [`mem_aux_ctrl_4::R`](R) reader structure
impl crate::Readable for MEM_AUX_CTRL_4_SPEC {}
///`write(|w| ..)` method takes [`mem_aux_ctrl_4::W`](W) writer structure
