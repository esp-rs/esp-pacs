///Register `GAMMA_RY1` reader
pub type R = crate::R<GAMMA_RY1_SPEC>;
///Register `GAMMA_RY1` writer
pub type W = crate::W<GAMMA_RY1_SPEC>;
///Field `GAMMA_R_Y03` reader - this field configures the point 3 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y03_R = crate::FieldReader;
///Field `GAMMA_R_Y03` writer - this field configures the point 3 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y03_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_R_Y02` reader - this field configures the point 2 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y02_R = crate::FieldReader;
///Field `GAMMA_R_Y02` writer - this field configures the point 2 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y02_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_R_Y01` reader - this field configures the point 1 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y01_R = crate::FieldReader;
///Field `GAMMA_R_Y01` writer - this field configures the point 1 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y01_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_R_Y00` reader - this field configures the point 0 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y00_R = crate::FieldReader;
///Field `GAMMA_R_Y00` writer - this field configures the point 0 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y00_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures the point 3 of Y-axis of r channel gamma curve
    #[inline(always)]
    pub fn gamma_r_y03(&self) -> GAMMA_R_Y03_R {
        GAMMA_R_Y03_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures the point 2 of Y-axis of r channel gamma curve
    #[inline(always)]
    pub fn gamma_r_y02(&self) -> GAMMA_R_Y02_R {
        GAMMA_R_Y02_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures the point 1 of Y-axis of r channel gamma curve
    #[inline(always)]
    pub fn gamma_r_y01(&self) -> GAMMA_R_Y01_R {
        GAMMA_R_Y01_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures the point 0 of Y-axis of r channel gamma curve
    #[inline(always)]
...
///`read()` method returns [`gamma_ry1::R`](R) reader structure
impl crate::Readable for GAMMA_RY1_SPEC {}
///`write(|w| ..)` method takes [`gamma_ry1::W`](W) writer structure
