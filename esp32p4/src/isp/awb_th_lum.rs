///Register `AWB_TH_LUM` reader
pub type R = crate::R<AWB_TH_LUM_SPEC>;
///Register `AWB_TH_LUM` writer
pub type W = crate::W<AWB_TH_LUM_SPEC>;
///Field `AWB_MIN_LUM` reader - this field configures lower threshold of r+g+b
pub type AWB_MIN_LUM_R = crate::FieldReader<u16>;
///Field `AWB_MIN_LUM` writer - this field configures lower threshold of r+g+b
pub type AWB_MIN_LUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `AWB_MAX_LUM` reader - this field configures upper threshold of r+g+b
pub type AWB_MAX_LUM_R = crate::FieldReader<u16>;
///Field `AWB_MAX_LUM` writer - this field configures upper threshold of r+g+b
pub type AWB_MAX_LUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    ///Bits 0:9 - this field configures lower threshold of r+g+b
    #[inline(always)]
    pub fn awb_min_lum(&self) -> AWB_MIN_LUM_R {
        AWB_MIN_LUM_R::new((self.bits & 0x03ff) as u16)
    }
    ///Bits 16:25 - this field configures upper threshold of r+g+b
    #[inline(always)]
...
///`read()` method returns [`awb_th_lum::R`](R) reader structure
impl crate::Readable for AWB_TH_LUM_SPEC {}
///`write(|w| ..)` method takes [`awb_th_lum::W`](W) writer structure
