///Register `GAMMA_GY2` reader
pub type R = crate::R<GAMMA_GY2_SPEC>;
///Register `GAMMA_GY2` writer
pub type W = crate::W<GAMMA_GY2_SPEC>;
///Field `GAMMA_G_Y07` reader - this field configures the point 7 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y07_R = crate::FieldReader;
///Field `GAMMA_G_Y07` writer - this field configures the point 7 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y07_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_G_Y06` reader - this field configures the point 6 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y06_R = crate::FieldReader;
///Field `GAMMA_G_Y06` writer - this field configures the point 6 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y06_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_G_Y05` reader - this field configures the point 5 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y05_R = crate::FieldReader;
///Field `GAMMA_G_Y05` writer - this field configures the point 5 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y05_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_G_Y04` reader - this field configures the point 4 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y04_R = crate::FieldReader;
///Field `GAMMA_G_Y04` writer - this field configures the point 4 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y04_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures the point 7 of Y-axis of g channel gamma curve
    #[inline(always)]
    pub fn gamma_g_y07(&self) -> GAMMA_G_Y07_R {
        GAMMA_G_Y07_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures the point 6 of Y-axis of g channel gamma curve
    #[inline(always)]
    pub fn gamma_g_y06(&self) -> GAMMA_G_Y06_R {
        GAMMA_G_Y06_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures the point 5 of Y-axis of g channel gamma curve
    #[inline(always)]
    pub fn gamma_g_y05(&self) -> GAMMA_G_Y05_R {
        GAMMA_G_Y05_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures the point 4 of Y-axis of g channel gamma curve
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GAMMA_GY2")
            .field("gamma_g_y07", &self.gamma_g_y07())
            .field("gamma_g_y06", &self.gamma_g_y06())
            .field("gamma_g_y05", &self.gamma_g_y05())
            .field("gamma_g_y04", &self.gamma_g_y04())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`gamma_gy2::R`](R) reader structure
impl crate::Readable for GAMMA_GY2_SPEC {}
///`write(|w| ..)` method takes [`gamma_gy2::W`](W) writer structure
