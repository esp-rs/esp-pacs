///Register `AF_VSCALE_A` reader
pub type R = crate::R<AF_VSCALE_A_SPEC>;
///Register `AF_VSCALE_A` writer
pub type W = crate::W<AF_VSCALE_A_SPEC>;
///Field `AF_BPOINT_A` reader - this field configures right coordinate of focus window a, must &lt;= hnum-2
pub type AF_BPOINT_A_R = crate::FieldReader<u16>;
///Field `AF_BPOINT_A` writer - this field configures right coordinate of focus window a, must &lt;= hnum-2
pub type AF_BPOINT_A_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `AF_TPOINT_A` reader - this field configures bottom coordinate of focus window a, must &lt;= hnum-2
pub type AF_TPOINT_A_R = crate::FieldReader<u16>;
///Field `AF_TPOINT_A` writer - this field configures bottom coordinate of focus window a, must &lt;= hnum-2
pub type AF_TPOINT_A_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - this field configures right coordinate of focus window a, must &lt;= hnum-2
    #[inline(always)]
    pub fn af_bpoint_a(&self) -> AF_BPOINT_A_R {
        AF_BPOINT_A_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bits 16:27 - this field configures bottom coordinate of focus window a, must &lt;= hnum-2
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AF_VSCALE_A")
            .field("af_bpoint_a", &self.af_bpoint_a())
            .field("af_tpoint_a", &self.af_tpoint_a())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`af_vscale_a::R`](R) reader structure
impl crate::Readable for AF_VSCALE_A_SPEC {}
///`write(|w| ..)` method takes [`af_vscale_a::W`](W) writer structure
