///Register `AF_SUM_C` reader
pub type R = crate::R<AF_SUM_C_SPEC>;
///Field `AF_SUMC` reader - this field represents the result of accumulation of pix grad of focus window c
pub type AF_SUMC_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:29 - this field represents the result of accumulation of pix grad of focus window c
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`af_sum_c::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct AF_SUM_C_SPEC;
impl crate::RegisterSpec for AF_SUM_C_SPEC {
    type Ux = u32;
}
///`read()` method returns [`af_sum_c::R`](R) reader structure
