///Register `CCM_COEF4` reader
pub type R = crate::R<CCM_COEF4_SPEC>;
///Register `CCM_COEF4` writer
pub type W = crate::W<CCM_COEF4_SPEC>;
///Field `CCM_BR` reader - this field configures the color correction matrix coefficient
pub type CCM_BR_R = crate::FieldReader<u16>;
///Field `CCM_BR` writer - this field configures the color correction matrix coefficient
pub type CCM_BR_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `CCM_BG` reader - this field configures the color correction matrix coefficient
pub type CCM_BG_R = crate::FieldReader<u16>;
///Field `CCM_BG` writer - this field configures the color correction matrix coefficient
...
///`read()` method returns [`ccm_coef4::R`](R) reader structure
impl crate::Readable for CCM_COEF4_SPEC {}
///`write(|w| ..)` method takes [`ccm_coef4::W`](W) writer structure
