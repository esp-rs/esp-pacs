///Register `AE_BLOCK_MEAN_4` reader
pub type R = crate::R<AE_BLOCK_MEAN_4_SPEC>;
///Field `AE_B34_MEAN` reader - this field configures block34 Y mean data
pub type AE_B34_MEAN_R = crate::FieldReader;
///Field `AE_B33_MEAN` reader - this field configures block33 Y mean data
pub type AE_B33_MEAN_R = crate::FieldReader;
///Field `AE_B32_MEAN` reader - this field configures block32 Y mean data
pub type AE_B32_MEAN_R = crate::FieldReader;
///Field `AE_B31_MEAN` reader - this field configures block31 Y mean data
pub type AE_B31_MEAN_R = crate::FieldReader;
impl R {
    ///Bits 0:7 - this field configures block34 Y mean data
    #[inline(always)]
    pub fn ae_b34_mean(&self) -> AE_B34_MEAN_R {
        AE_B34_MEAN_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures block33 Y mean data
    #[inline(always)]
    pub fn ae_b33_mean(&self) -> AE_B33_MEAN_R {
        AE_B33_MEAN_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures block32 Y mean data
    #[inline(always)]
    pub fn ae_b32_mean(&self) -> AE_B32_MEAN_R {
        AE_B32_MEAN_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures block31 Y mean data
    #[inline(always)]
...
///`read()` method returns [`ae_block_mean_4::R`](R) reader structure
