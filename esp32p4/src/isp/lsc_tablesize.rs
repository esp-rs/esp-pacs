///Register `LSC_TABLESIZE` reader
pub type R = crate::R<LSC_TABLESIZE_SPEC>;
///Register `LSC_TABLESIZE` writer
pub type W = crate::W<LSC_TABLESIZE_SPEC>;
///Field `LSC_XTABLESIZE` reader - this field configures lsc table size in x-direction
pub type LSC_XTABLESIZE_R = crate::FieldReader;
///Field `LSC_XTABLESIZE` writer - this field configures lsc table size in x-direction
pub type LSC_XTABLESIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this field configures lsc table size in x-direction
    #[inline(always)]
...
///`read()` method returns [`lsc_tablesize::R`](R) reader structure
impl crate::Readable for LSC_TABLESIZE_SPEC {}
///`write(|w| ..)` method takes [`lsc_tablesize::W`](W) writer structure
