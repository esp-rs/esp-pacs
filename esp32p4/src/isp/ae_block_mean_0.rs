///Register `AE_BLOCK_MEAN_0` reader
pub type R = crate::R<AE_BLOCK_MEAN_0_SPEC>;
///Field `AE_B03_MEAN` reader - this field configures block03 Y mean data
pub type AE_B03_MEAN_R = crate::FieldReader;
///Field `AE_B02_MEAN` reader - this field configures block02 Y mean data
pub type AE_B02_MEAN_R = crate::FieldReader;
///Field `AE_B01_MEAN` reader - this field configures block01 Y mean data
pub type AE_B01_MEAN_R = crate::FieldReader;
///Field `AE_B00_MEAN` reader - this field configures block00 Y mean data
pub type AE_B00_MEAN_R = crate::FieldReader;
impl R {
    ///Bits 0:7 - this field configures block03 Y mean data
    #[inline(always)]
    pub fn ae_b03_mean(&self) -> AE_B03_MEAN_R {
        AE_B03_MEAN_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures block02 Y mean data
    #[inline(always)]
    pub fn ae_b02_mean(&self) -> AE_B02_MEAN_R {
        AE_B02_MEAN_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures block01 Y mean data
    #[inline(always)]
    pub fn ae_b01_mean(&self) -> AE_B01_MEAN_R {
        AE_B01_MEAN_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures block00 Y mean data
    #[inline(always)]
...
///`read()` method returns [`ae_block_mean_0::R`](R) reader structure
