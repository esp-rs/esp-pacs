///Register `HIST_WEIGHT3` reader
pub type R = crate::R<HIST_WEIGHT3_SPEC>;
///Register `HIST_WEIGHT3` writer
pub type W = crate::W<HIST_WEIGHT3_SPEC>;
///Field `HIST_WEIGHT_30` reader - this field configures weight of subwindow 30
pub type HIST_WEIGHT_30_R = crate::FieldReader;
///Field `HIST_WEIGHT_30` writer - this field configures weight of subwindow 30
pub type HIST_WEIGHT_30_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_24` reader - this field configures weight of subwindow 24
pub type HIST_WEIGHT_24_R = crate::FieldReader;
///Field `HIST_WEIGHT_24` writer - this field configures weight of subwindow 24
pub type HIST_WEIGHT_24_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_23` reader - this field configures weight of subwindow 23
pub type HIST_WEIGHT_23_R = crate::FieldReader;
///Field `HIST_WEIGHT_23` writer - this field configures weight of subwindow 23
pub type HIST_WEIGHT_23_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_22` reader - this field configures weight of subwindow 22
pub type HIST_WEIGHT_22_R = crate::FieldReader;
///Field `HIST_WEIGHT_22` writer - this field configures weight of subwindow 22
pub type HIST_WEIGHT_22_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures weight of subwindow 30
    #[inline(always)]
    pub fn hist_weight_30(&self) -> HIST_WEIGHT_30_R {
        HIST_WEIGHT_30_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures weight of subwindow 24
    #[inline(always)]
    pub fn hist_weight_24(&self) -> HIST_WEIGHT_24_R {
        HIST_WEIGHT_24_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures weight of subwindow 23
    #[inline(always)]
    pub fn hist_weight_23(&self) -> HIST_WEIGHT_23_R {
        HIST_WEIGHT_23_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures weight of subwindow 22
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HIST_WEIGHT3")
            .field("hist_weight_30", &self.hist_weight_30())
            .field("hist_weight_24", &self.hist_weight_24())
            .field("hist_weight_23", &self.hist_weight_23())
            .field("hist_weight_22", &self.hist_weight_22())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`hist_weight3::R`](R) reader structure
impl crate::Readable for HIST_WEIGHT3_SPEC {}
///`write(|w| ..)` method takes [`hist_weight3::W`](W) writer structure
