///Register `GAMMA_GY1` reader
pub type R = crate::R<GAMMA_GY1_SPEC>;
///Register `GAMMA_GY1` writer
pub type W = crate::W<GAMMA_GY1_SPEC>;
///Field `GAMMA_G_Y03` reader - this field configures the point 3 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y03_R = crate::FieldReader;
///Field `GAMMA_G_Y03` writer - this field configures the point 3 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y03_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_G_Y02` reader - this field configures the point 2 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y02_R = crate::FieldReader;
///Field `GAMMA_G_Y02` writer - this field configures the point 2 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y02_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_G_Y01` reader - this field configures the point 1 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y01_R = crate::FieldReader;
///Field `GAMMA_G_Y01` writer - this field configures the point 1 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y01_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_G_Y00` reader - this field configures the point 0 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y00_R = crate::FieldReader;
///Field `GAMMA_G_Y00` writer - this field configures the point 0 of Y-axis of g channel gamma curve
pub type GAMMA_G_Y00_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures the point 3 of Y-axis of g channel gamma curve
    #[inline(always)]
    pub fn gamma_g_y03(&self) -> GAMMA_G_Y03_R {
        GAMMA_G_Y03_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures the point 2 of Y-axis of g channel gamma curve
    #[inline(always)]
    pub fn gamma_g_y02(&self) -> GAMMA_G_Y02_R {
        GAMMA_G_Y02_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures the point 1 of Y-axis of g channel gamma curve
    #[inline(always)]
    pub fn gamma_g_y01(&self) -> GAMMA_G_Y01_R {
        GAMMA_G_Y01_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures the point 0 of Y-axis of g channel gamma curve
    #[inline(always)]
...
///`read()` method returns [`gamma_gy1::R`](R) reader structure
impl crate::Readable for GAMMA_GY1_SPEC {}
///`write(|w| ..)` method takes [`gamma_gy1::W`](W) writer structure
