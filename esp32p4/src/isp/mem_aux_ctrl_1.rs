///Register `MEM_AUX_CTRL_1` reader
pub type R = crate::R<MEM_AUX_CTRL_1_SPEC>;
///Register `MEM_AUX_CTRL_1` writer
pub type W = crate::W<MEM_AUX_CTRL_1_SPEC>;
///Field `LSC_LUT_R_GR_MEM_AUX_CTRL` reader - this field configures the mem_aux of lsc r gr lut memory
pub type LSC_LUT_R_GR_MEM_AUX_CTRL_R = crate::FieldReader<u16>;
///Field `LSC_LUT_R_GR_MEM_AUX_CTRL` writer - this field configures the mem_aux of lsc r gr lut memory
pub type LSC_LUT_R_GR_MEM_AUX_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
///Field `LSC_LUT_GB_B_MEM_AUX_CTRL` reader - this field configures the mem_aux of lsc gb b lut memory
pub type LSC_LUT_GB_B_MEM_AUX_CTRL_R = crate::FieldReader<u16>;
///Field `LSC_LUT_GB_B_MEM_AUX_CTRL` writer - this field configures the mem_aux of lsc gb b lut memory
pub type LSC_LUT_GB_B_MEM_AUX_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    ///Bits 0:13 - this field configures the mem_aux of lsc r gr lut memory
    #[inline(always)]
    pub fn lsc_lut_r_gr_mem_aux_ctrl(&self) -> LSC_LUT_R_GR_MEM_AUX_CTRL_R {
        LSC_LUT_R_GR_MEM_AUX_CTRL_R::new((self.bits & 0x3fff) as u16)
    }
    ///Bits 16:29 - this field configures the mem_aux of lsc gb b lut memory
    #[inline(always)]
...
///`read()` method returns [`mem_aux_ctrl_1::R`](R) reader structure
impl crate::Readable for MEM_AUX_CTRL_1_SPEC {}
///`write(|w| ..)` method takes [`mem_aux_ctrl_1::W`](W) writer structure
