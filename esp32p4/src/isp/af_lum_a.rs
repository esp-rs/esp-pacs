///Register `AF_LUM_A` reader
pub type R = crate::R<AF_LUM_A_SPEC>;
///Field `AF_LUMA` reader - this field represents the result of accumulation of pix light of focus window a
pub type AF_LUMA_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:27 - this field represents the result of accumulation of pix light of focus window a
    #[inline(always)]
...
///`read()` method returns [`af_lum_a::R`](R) reader structure
