...
impl W {
    ...
    #[inline(always)]
    pub fn lut_cmd(&mut self) -> LUT_CMD_W<'_, LUT_CMD_SPEC> {
        LUT_CMD_W::new(self, 16)
    }
}
#[doc = "LUT command register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lut_cmd::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LUT_CMD_SPEC;
impl crate::RegisterSpec for LUT_CMD_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`lut_cmd::W`](W) writer structure"]
impl crate::Writable for LUT_CMD_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LUT_CMD to value 0"]
