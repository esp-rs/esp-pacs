///Register `DPC_CTRL` reader
pub type R = crate::R<DPC_CTRL_SPEC>;
///Register `DPC_CTRL` writer
pub type W = crate::W<DPC_CTRL_SPEC>;
///Field `DPC_CHECK_EN` reader - this bit configures the check mode enable. 0: disable, 1: enable
pub type DPC_CHECK_EN_R = crate::BitReader;
///Field `DPC_CHECK_EN` writer - this bit configures the check mode enable. 0: disable, 1: enable
pub type DPC_CHECK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `STA_EN` reader - this bit configures the sta dpc enable. 0: disable, 1: enable
pub type STA_EN_R = crate::BitReader;
///Field `STA_EN` writer - this bit configures the sta dpc enable. 0: disable, 1: enable
pub type STA_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DYN_EN` reader - this bit configures the dyn dpc enable. 0: disable, 1: enable
pub type DYN_EN_R = crate::BitReader;
///Field `DYN_EN` writer - this bit configures the dyn dpc enable. 0: disable, 1: enable
pub type DYN_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DPC_BLACK_EN` reader - this bit configures input image type select when in check mode, 0: white img, 1: black img
pub type DPC_BLACK_EN_R = crate::BitReader;
///Field `DPC_BLACK_EN` writer - this bit configures input image type select when in check mode, 0: white img, 1: black img
pub type DPC_BLACK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DPC_METHOD_SEL` reader - this bit configures dyn dpc method select. 0: simple method, 1: hard method
pub type DPC_METHOD_SEL_R = crate::BitReader;
///Field `DPC_METHOD_SEL` writer - this bit configures dyn dpc method select. 0: simple method, 1: hard method
pub type DPC_METHOD_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DPC_CHECK_OD_EN` reader - this bit configures output pixel data when in check mode or not. 0: no data output, 1: data output
pub type DPC_CHECK_OD_EN_R = crate::BitReader;
///Field `DPC_CHECK_OD_EN` writer - this bit configures output pixel data when in check mode or not. 0: no data output, 1: data output
pub type DPC_CHECK_OD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - this bit configures the check mode enable. 0: disable, 1: enable
    #[inline(always)]
    pub fn dpc_check_en(&self) -> DPC_CHECK_EN_R {
        DPC_CHECK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - this bit configures the sta dpc enable. 0: disable, 1: enable
    #[inline(always)]
    pub fn sta_en(&self) -> STA_EN_R {
        STA_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - this bit configures the dyn dpc enable. 0: disable, 1: enable
    #[inline(always)]
    pub fn dyn_en(&self) -> DYN_EN_R {
        DYN_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - this bit configures input image type select when in check mode, 0: white img, 1: black img
    #[inline(always)]
    pub fn dpc_black_en(&self) -> DPC_BLACK_EN_R {
        DPC_BLACK_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - this bit configures dyn dpc method select. 0: simple method, 1: hard method
    #[inline(always)]
    pub fn dpc_method_sel(&self) -> DPC_METHOD_SEL_R {
        DPC_METHOD_SEL_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - this bit configures output pixel data when in check mode or not. 0: no data output, 1: data output
    #[inline(always)]
...
///`read()` method returns [`dpc_ctrl::R`](R) reader structure
impl crate::Readable for DPC_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dpc_ctrl::W`](W) writer structure
