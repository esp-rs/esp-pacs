///Register `AWB_TH_RG` reader
pub type R = crate::R<AWB_TH_RG_SPEC>;
///Register `AWB_TH_RG` writer
pub type W = crate::W<AWB_TH_RG_SPEC>;
///Field `AWB_MIN_RG` reader - this field configures lower threshold of r/g, 2bit integer and 8bit fraction
pub type AWB_MIN_RG_R = crate::FieldReader<u16>;
///Field `AWB_MIN_RG` writer - this field configures lower threshold of r/g, 2bit integer and 8bit fraction
pub type AWB_MIN_RG_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `AWB_MAX_RG` reader - this field configures upper threshold of r/g, 2bit integer and 8bit fraction
pub type AWB_MAX_RG_R = crate::FieldReader<u16>;
///Field `AWB_MAX_RG` writer - this field configures upper threshold of r/g, 2bit integer and 8bit fraction
pub type AWB_MAX_RG_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    ///Bits 0:9 - this field configures lower threshold of r/g, 2bit integer and 8bit fraction
    #[inline(always)]
    pub fn awb_min_rg(&self) -> AWB_MIN_RG_R {
        AWB_MIN_RG_R::new((self.bits & 0x03ff) as u16)
    }
    ///Bits 16:25 - this field configures upper threshold of r/g, 2bit integer and 8bit fraction
    #[inline(always)]
...
///`read()` method returns [`awb_th_rg::R`](R) reader structure
impl crate::Readable for AWB_TH_RG_SPEC {}
///`write(|w| ..)` method takes [`awb_th_rg::W`](W) writer structure
