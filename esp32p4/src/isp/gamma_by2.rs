...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GAMMA_BY2")
            .field("gamma_b_y07", &self.gamma_b_y07().bits())
            .field("gamma_b_y06", &self.gamma_b_y06().bits())
            .field("gamma_b_y05", &self.gamma_b_y05().bits())
            .field("gamma_b_y04", &self.gamma_b_y04().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<GAMMA_BY2_SPEC> {
