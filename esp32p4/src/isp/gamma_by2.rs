///Register `GAMMA_BY2` reader
pub type R = crate::R<GAMMA_BY2_SPEC>;
///Register `GAMMA_BY2` writer
pub type W = crate::W<GAMMA_BY2_SPEC>;
///Field `GAMMA_B_Y07` reader - this field configures the point 7 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y07_R = crate::FieldReader;
///Field `GAMMA_B_Y07` writer - this field configures the point 7 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y07_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_B_Y06` reader - this field configures the point 6 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y06_R = crate::FieldReader;
///Field `GAMMA_B_Y06` writer - this field configures the point 6 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y06_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_B_Y05` reader - this field configures the point 5 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y05_R = crate::FieldReader;
///Field `GAMMA_B_Y05` writer - this field configures the point 5 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y05_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_B_Y04` reader - this field configures the point 4 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y04_R = crate::FieldReader;
///Field `GAMMA_B_Y04` writer - this field configures the point 4 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y04_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures the point 7 of Y-axis of b channel gamma curve
    #[inline(always)]
    pub fn gamma_b_y07(&self) -> GAMMA_B_Y07_R {
        GAMMA_B_Y07_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures the point 6 of Y-axis of b channel gamma curve
    #[inline(always)]
    pub fn gamma_b_y06(&self) -> GAMMA_B_Y06_R {
        GAMMA_B_Y06_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures the point 5 of Y-axis of b channel gamma curve
    #[inline(always)]
    pub fn gamma_b_y05(&self) -> GAMMA_B_Y05_R {
        GAMMA_B_Y05_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures the point 4 of Y-axis of b channel gamma curve
    #[inline(always)]
...
///`read()` method returns [`gamma_by2::R`](R) reader structure
impl crate::Readable for GAMMA_BY2_SPEC {}
///`write(|w| ..)` method takes [`gamma_by2::W`](W) writer structure
