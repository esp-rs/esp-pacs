///Register `HIST_BIN8` reader
pub type R = crate::R<HIST_BIN8_SPEC>;
///Field `HIST_BIN_8` reader - this field represents result of histogram bin 8
pub type HIST_BIN_8_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:16 - this field represents result of histogram bin 8
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HIST_BIN8")
            .field("hist_bin_8", &self.hist_bin_8())
            .finish()
    }
}
...
///`read()` method returns [`hist_bin8::R`](R) reader structure
