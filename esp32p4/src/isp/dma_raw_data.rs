///Register `DMA_RAW_DATA` reader
pub type R = crate::R<DMA_RAW_DATA_SPEC>;
///Register `DMA_RAW_DATA` writer
pub type W = crate::W<DMA_RAW_DATA_SPEC>;
///Field `DMA_RAW_NUM_TOTAL` reader - this field configures the the number of 64bits in a frame
pub type DMA_RAW_NUM_TOTAL_R = crate::FieldReader<u32>;
///Field `DMA_RAW_NUM_TOTAL` writer - this field configures the the number of 64bits in a frame
pub type DMA_RAW_NUM_TOTAL_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
///Field `DMA_RAW_NUM_TOTAL_SET` writer - write 1 to update reg_dma_raw_num_total
pub type DMA_RAW_NUM_TOTAL_SET_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:21 - this field configures the the number of 64bits in a frame
    #[inline(always)]
...
///`read()` method returns [`dma_raw_data::R`](R) reader structure
impl crate::Readable for DMA_RAW_DATA_SPEC {}
///`write(|w| ..)` method takes [`dma_raw_data::W`](W) writer structure
