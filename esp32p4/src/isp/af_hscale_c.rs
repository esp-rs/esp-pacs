///Register `AF_HSCALE_C` reader
pub type R = crate::R<AF_HSCALE_C_SPEC>;
///Register `AF_HSCALE_C` writer
pub type W = crate::W<AF_HSCALE_C_SPEC>;
///Field `AF_RPOINT_C` reader - this field configures left coordinate of focus window c, must >= 2
pub type AF_RPOINT_C_R = crate::FieldReader<u16>;
///Field `AF_RPOINT_C` writer - this field configures left coordinate of focus window c, must >= 2
pub type AF_RPOINT_C_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `AF_LPOINT_C` reader - this field configures top coordinate of focus window c, must >= 2
pub type AF_LPOINT_C_R = crate::FieldReader<u16>;
///Field `AF_LPOINT_C` writer - this field configures top coordinate of focus window c, must >= 2
pub type AF_LPOINT_C_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - this field configures left coordinate of focus window c, must >= 2
    #[inline(always)]
    pub fn af_rpoint_c(&self) -> AF_RPOINT_C_R {
        AF_RPOINT_C_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bits 16:27 - this field configures top coordinate of focus window c, must >= 2
    #[inline(always)]
...
///`read()` method returns [`af_hscale_c::R`](R) reader structure
impl crate::Readable for AF_HSCALE_C_SPEC {}
///`write(|w| ..)` method takes [`af_hscale_c::W`](W) writer structure
