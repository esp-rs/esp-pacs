///Register `AF_ENV_USER_TH_LUM` reader
pub type R = crate::R<AF_ENV_USER_TH_LUM_SPEC>;
///Register `AF_ENV_USER_TH_LUM` writer
pub type W = crate::W<AF_ENV_USER_TH_LUM_SPEC>;
///Field `AF_ENV_USER_THRESHOLD_LUM` reader - this field configures user setup env detect lum threshold
pub type AF_ENV_USER_THRESHOLD_LUM_R = crate::FieldReader<u32>;
///Field `AF_ENV_USER_THRESHOLD_LUM` writer - this field configures user setup env detect lum threshold
pub type AF_ENV_USER_THRESHOLD_LUM_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - this field configures user setup env detect lum threshold
    #[inline(always)]
...
///`read()` method returns [`af_env_user_th_lum::R`](R) reader structure
impl crate::Readable for AF_ENV_USER_TH_LUM_SPEC {}
///`write(|w| ..)` method takes [`af_env_user_th_lum::W`](W) writer structure
