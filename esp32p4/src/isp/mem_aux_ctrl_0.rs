///Register `MEM_AUX_CTRL_0` reader
pub type R = crate::R<MEM_AUX_CTRL_0_SPEC>;
///Register `MEM_AUX_CTRL_0` writer
pub type W = crate::W<MEM_AUX_CTRL_0_SPEC>;
///Field `HEADER_MEM_AUX_CTRL` reader - this field configures the mem_aux of isp input buffer memory
pub type HEADER_MEM_AUX_CTRL_R = crate::FieldReader<u16>;
///Field `HEADER_MEM_AUX_CTRL` writer - this field configures the mem_aux of isp input buffer memory
pub type HEADER_MEM_AUX_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
///Field `DPC_LUT_MEM_AUX_CTRL` reader - this field represents this field configures the mem_aux of dpc lut memory
pub type DPC_LUT_MEM_AUX_CTRL_R = crate::FieldReader<u16>;
///Field `DPC_LUT_MEM_AUX_CTRL` writer - this field represents this field configures the mem_aux of dpc lut memory
pub type DPC_LUT_MEM_AUX_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    ///Bits 0:13 - this field configures the mem_aux of isp input buffer memory
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MEM_AUX_CTRL_0")
            .field("header_mem_aux_ctrl", &self.header_mem_aux_ctrl())
            .field("dpc_lut_mem_aux_ctrl", &self.dpc_lut_mem_aux_ctrl())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`mem_aux_ctrl_0::R`](R) reader structure
impl crate::Readable for MEM_AUX_CTRL_0_SPEC {}
///`write(|w| ..)` method takes [`mem_aux_ctrl_0::W`](W) writer structure
