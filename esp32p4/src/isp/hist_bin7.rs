///Register `HIST_BIN7` reader
pub type R = crate::R<HIST_BIN7_SPEC>;
///Field `HIST_BIN_7` reader - this field represents result of histogram bin 7
pub type HIST_BIN_7_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:16 - this field represents result of histogram bin 7
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HIST_BIN7")
            .field("hist_bin_7", &self.hist_bin_7())
            .finish()
    }
}
...
///`read()` method returns [`hist_bin7::R`](R) reader structure
