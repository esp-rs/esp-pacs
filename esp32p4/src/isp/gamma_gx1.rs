...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GAMMA_GX1")
            .field("gamma_g_x07", &self.gamma_g_x07().bits())
            .field("gamma_g_x06", &self.gamma_g_x06().bits())
            .field("gamma_g_x05", &self.gamma_g_x05().bits())
            .field("gamma_g_x04", &self.gamma_g_x04().bits())
            .field("gamma_g_x03", &self.gamma_g_x03().bits())
            .field("gamma_g_x02", &self.gamma_g_x02().bits())
            .field("gamma_g_x01", &self.gamma_g_x01().bits())
            .field("gamma_g_x00", &self.gamma_g_x00().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
