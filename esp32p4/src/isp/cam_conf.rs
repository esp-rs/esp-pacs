///Register `CAM_CONF` reader
pub type R = crate::R<CAM_CONF_SPEC>;
///Register `CAM_CONF` writer
pub type W = crate::W<CAM_CONF_SPEC>;
///Field `CAM_DATA_ORDER` reader - this field configures data order of cam port, 0: cam_data_in, 1:{cam_data_in\[7:0\], cam_data_in\[15:8\]}
pub type CAM_DATA_ORDER_R = crate::BitReader;
///Field `CAM_DATA_ORDER` writer - this field configures data order of cam port, 0: cam_data_in, 1:{cam_data_in\[7:0\], cam_data_in\[15:8\]}
pub type CAM_DATA_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_2BYTE_MODE` reader - this field configures enable of cam 2 byte mode(input 2 bytes each clock). 0: disable, 1: enable
pub type CAM_2BYTE_MODE_R = crate::BitReader;
///Field `CAM_2BYTE_MODE` writer - this field configures enable of cam 2 byte mode(input 2 bytes each clock). 0: disable, 1: enable
pub type CAM_2BYTE_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_DATA_TYPE` reader - this field configures idi data type for image data, 0x2a: RAW8, 0x2b: RAW10, 0x2c: RAW12
pub type CAM_DATA_TYPE_R = crate::FieldReader;
///Field `CAM_DATA_TYPE` writer - this field configures idi data type for image data, 0x2a: RAW8, 0x2b: RAW10, 0x2c: RAW12
pub type CAM_DATA_TYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `CAM_DE_INV` reader - this bit configures cam data enable invert. 0: not invert, 1: invert
pub type CAM_DE_INV_R = crate::BitReader;
///Field `CAM_DE_INV` writer - this bit configures cam data enable invert. 0: not invert, 1: invert
pub type CAM_DE_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_HSYNC_INV` reader - this bit configures cam hsync invert. 0: not invert, 1: invert
pub type CAM_HSYNC_INV_R = crate::BitReader;
///Field `CAM_HSYNC_INV` writer - this bit configures cam hsync invert. 0: not invert, 1: invert
pub type CAM_HSYNC_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_VSYNC_INV` reader - this bit configures cam vsync invert. 0: not invert, 1: invert
pub type CAM_VSYNC_INV_R = crate::BitReader;
///Field `CAM_VSYNC_INV` writer - this bit configures cam vsync invert. 0: not invert, 1: invert
pub type CAM_VSYNC_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_VSYNC_FILTER_THRES` reader - this bit configures the number of clock of vsync filter length
pub type CAM_VSYNC_FILTER_THRES_R = crate::FieldReader;
///Field `CAM_VSYNC_FILTER_THRES` writer - this bit configures the number of clock of vsync filter length
pub type CAM_VSYNC_FILTER_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `CAM_VSYNC_FILTER_EN` reader - this bit configures vsync filter en
pub type CAM_VSYNC_FILTER_EN_R = crate::BitReader;
///Field `CAM_VSYNC_FILTER_EN` writer - this bit configures vsync filter en
pub type CAM_VSYNC_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - this field configures data order of cam port, 0: cam_data_in, 1:{cam_data_in\[7:0\], cam_data_in\[15:8\]}
    #[inline(always)]
    pub fn cam_data_order(&self) -> CAM_DATA_ORDER_R {
        CAM_DATA_ORDER_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - this field configures enable of cam 2 byte mode(input 2 bytes each clock). 0: disable, 1: enable
    #[inline(always)]
    pub fn cam_2byte_mode(&self) -> CAM_2BYTE_MODE_R {
        CAM_2BYTE_MODE_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:7 - this field configures idi data type for image data, 0x2a: RAW8, 0x2b: RAW10, 0x2c: RAW12
    #[inline(always)]
    pub fn cam_data_type(&self) -> CAM_DATA_TYPE_R {
        CAM_DATA_TYPE_R::new(((self.bits >> 2) & 0x3f) as u8)
    }
    ///Bit 8 - this bit configures cam data enable invert. 0: not invert, 1: invert
    #[inline(always)]
    pub fn cam_de_inv(&self) -> CAM_DE_INV_R {
        CAM_DE_INV_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - this bit configures cam hsync invert. 0: not invert, 1: invert
    #[inline(always)]
    pub fn cam_hsync_inv(&self) -> CAM_HSYNC_INV_R {
        CAM_HSYNC_INV_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - this bit configures cam vsync invert. 0: not invert, 1: invert
    #[inline(always)]
    pub fn cam_vsync_inv(&self) -> CAM_VSYNC_INV_R {
        CAM_VSYNC_INV_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bits 11:13 - this bit configures the number of clock of vsync filter length
    #[inline(always)]
    pub fn cam_vsync_filter_thres(&self) -> CAM_VSYNC_FILTER_THRES_R {
        CAM_VSYNC_FILTER_THRES_R::new(((self.bits >> 11) & 7) as u8)
    }
    ///Bit 14 - this bit configures vsync filter en
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CAM_CONF")
            .field("cam_data_order", &self.cam_data_order())
            .field("cam_2byte_mode", &self.cam_2byte_mode())
            .field("cam_data_type", &self.cam_data_type())
...
///`read()` method returns [`cam_conf::R`](R) reader structure
impl crate::Readable for CAM_CONF_SPEC {}
///`write(|w| ..)` method takes [`cam_conf::W`](W) writer structure
