///Register `DPC_DEADPIX_CNT` reader
pub type R = crate::R<DPC_DEADPIX_CNT_SPEC>;
///Field `DPC_DEADPIX_CNT` reader - this field represents the dead pixel count
pub type DPC_DEADPIX_CNT_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:9 - this field represents the dead pixel count
    #[inline(always)]
...
///`read()` method returns [`dpc_deadpix_cnt::R`](R) reader structure
