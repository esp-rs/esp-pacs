///Register `AWB0_ACC_G` reader
pub type R = crate::R<AWB0_ACC_G_SPEC>;
///Field `AWB0_ACC_G` reader - this field represents accumulate of channel g of all white point of algo0
pub type AWB0_ACC_G_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - this field represents accumulate of channel g of all white point of algo0
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AWB0_ACC_G")
            .field("awb0_acc_g", &self.awb0_acc_g())
            .finish()
    }
}
...
///`read()` method returns [`awb0_acc_g::R`](R) reader structure
