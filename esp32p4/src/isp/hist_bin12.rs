///Register `HIST_BIN12` reader
pub type R = crate::R<HIST_BIN12_SPEC>;
///Field `HIST_BIN_12` reader - this field represents result of histogram bin 12
pub type HIST_BIN_12_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:16 - this field represents result of histogram bin 12
    #[inline(always)]
...
///`read()` method returns [`hist_bin12::R`](R) reader structure
