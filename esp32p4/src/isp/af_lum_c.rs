///Register `AF_LUM_C` reader
pub type R = crate::R<AF_LUM_C_SPEC>;
///Field `AF_LUMC` reader - this field represents the result of accumulation of pix light of focus window c
pub type AF_LUMC_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:27 - this field represents the result of accumulation of pix light of focus window c
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`af_lum_c::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct AF_LUM_C_SPEC;
impl crate::RegisterSpec for AF_LUM_C_SPEC {
    type Ux = u32;
}
///`read()` method returns [`af_lum_c::R`](R) reader structure
