///Register `BLC_VALUE` reader
pub type R = crate::R<BLC_VALUE_SPEC>;
///Register `BLC_VALUE` writer
pub type W = crate::W<BLC_VALUE_SPEC>;
///Field `BLC_R3_VALUE` reader - this field configures the black level of bottom right channel of bayer img
pub type BLC_R3_VALUE_R = crate::FieldReader;
///Field `BLC_R3_VALUE` writer - this field configures the black level of bottom right channel of bayer img
pub type BLC_R3_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `BLC_R2_VALUE` reader - this field configures the black level of bottom left channel of bayer img
pub type BLC_R2_VALUE_R = crate::FieldReader;
///Field `BLC_R2_VALUE` writer - this field configures the black level of bottom left channel of bayer img
pub type BLC_R2_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `BLC_R1_VALUE` reader - this field configures the black level of top right channel of bayer img
pub type BLC_R1_VALUE_R = crate::FieldReader;
///Field `BLC_R1_VALUE` writer - this field configures the black level of top right channel of bayer img
pub type BLC_R1_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `BLC_R0_VALUE` reader - this field configures the black level of top left channel of bayer img
pub type BLC_R0_VALUE_R = crate::FieldReader;
///Field `BLC_R0_VALUE` writer - this field configures the black level of top left channel of bayer img
pub type BLC_R0_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures the black level of bottom right channel of bayer img
    #[inline(always)]
    pub fn blc_r3_value(&self) -> BLC_R3_VALUE_R {
        BLC_R3_VALUE_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures the black level of bottom left channel of bayer img
    #[inline(always)]
    pub fn blc_r2_value(&self) -> BLC_R2_VALUE_R {
        BLC_R2_VALUE_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures the black level of top right channel of bayer img
    #[inline(always)]
    pub fn blc_r1_value(&self) -> BLC_R1_VALUE_R {
        BLC_R1_VALUE_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures the black level of top left channel of bayer img
    #[inline(always)]
...
///`read()` method returns [`blc_value::R`](R) reader structure
impl crate::Readable for BLC_VALUE_SPEC {}
///`write(|w| ..)` method takes [`blc_value::W`](W) writer structure
