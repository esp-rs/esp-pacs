///Register `HIST_WEIGHT6` reader
pub type R = crate::R<HIST_WEIGHT6_SPEC>;
///Register `HIST_WEIGHT6` writer
pub type W = crate::W<HIST_WEIGHT6_SPEC>;
///Field `HIST_WEIGHT_44` reader - this field configures weight of subwindow 44
pub type HIST_WEIGHT_44_R = crate::FieldReader;
///Field `HIST_WEIGHT_44` writer - this field configures weight of subwindow 44
pub type HIST_WEIGHT_44_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures weight of subwindow 44
    #[inline(always)]
...
///`read()` method returns [`hist_weight6::R`](R) reader structure
impl crate::Readable for HIST_WEIGHT6_SPEC {}
///`write(|w| ..)` method takes [`hist_weight6::W`](W) writer structure
