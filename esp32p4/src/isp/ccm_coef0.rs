///Register `CCM_COEF0` reader
pub type R = crate::R<CCM_COEF0_SPEC>;
///Register `CCM_COEF0` writer
pub type W = crate::W<CCM_COEF0_SPEC>;
///Field `CCM_RR` reader - this field configures the color correction matrix coefficient
pub type CCM_RR_R = crate::FieldReader<u16>;
///Field `CCM_RR` writer - this field configures the color correction matrix coefficient
pub type CCM_RR_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `CCM_RG` reader - this field configures the color correction matrix coefficient
pub type CCM_RG_R = crate::FieldReader<u16>;
///Field `CCM_RG` writer - this field configures the color correction matrix coefficient
...
///`read()` method returns [`ccm_coef0::R`](R) reader structure
impl crate::Readable for CCM_COEF0_SPEC {}
///`write(|w| ..)` method takes [`ccm_coef0::W`](W) writer structure
