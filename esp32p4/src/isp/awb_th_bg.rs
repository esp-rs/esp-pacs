///Register `AWB_TH_BG` reader
pub type R = crate::R<AWB_TH_BG_SPEC>;
///Register `AWB_TH_BG` writer
pub type W = crate::W<AWB_TH_BG_SPEC>;
///Field `AWB_MIN_BG` reader - this field configures lower threshold of b/g, 2bit integer and 8bit fraction
pub type AWB_MIN_BG_R = crate::FieldReader<u16>;
///Field `AWB_MIN_BG` writer - this field configures lower threshold of b/g, 2bit integer and 8bit fraction
pub type AWB_MIN_BG_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `AWB_MAX_BG` reader - this field configures upper threshold of b/g, 2bit integer and 8bit fraction
pub type AWB_MAX_BG_R = crate::FieldReader<u16>;
///Field `AWB_MAX_BG` writer - this field configures upper threshold of b/g, 2bit integer and 8bit fraction
pub type AWB_MAX_BG_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    ///Bits 0:9 - this field configures lower threshold of b/g, 2bit integer and 8bit fraction
    #[inline(always)]
    pub fn awb_min_bg(&self) -> AWB_MIN_BG_R {
        AWB_MIN_BG_R::new((self.bits & 0x03ff) as u16)
    }
    ///Bits 16:25 - this field configures upper threshold of b/g, 2bit integer and 8bit fraction
    #[inline(always)]
...
///`read()` method returns [`awb_th_bg::R`](R) reader structure
impl crate::Readable for AWB_TH_BG_SPEC {}
///`write(|w| ..)` method takes [`awb_th_bg::W`](W) writer structure
