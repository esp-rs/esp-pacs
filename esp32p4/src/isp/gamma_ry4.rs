///Register `GAMMA_RY4` reader
pub type R = crate::R<GAMMA_RY4_SPEC>;
///Register `GAMMA_RY4` writer
pub type W = crate::W<GAMMA_RY4_SPEC>;
///Field `GAMMA_R_Y0F` reader - this field configures the point 15 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y0F_R = crate::FieldReader;
///Field `GAMMA_R_Y0F` writer - this field configures the point 15 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y0F_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_R_Y0E` reader - this field configures the point 14 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y0E_R = crate::FieldReader;
///Field `GAMMA_R_Y0E` writer - this field configures the point 14 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y0E_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_R_Y0D` reader - this field configures the point 13 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y0D_R = crate::FieldReader;
///Field `GAMMA_R_Y0D` writer - this field configures the point 13 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y0D_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_R_Y0C` reader - this field configures the point 12 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y0C_R = crate::FieldReader;
///Field `GAMMA_R_Y0C` writer - this field configures the point 12 of Y-axis of r channel gamma curve
pub type GAMMA_R_Y0C_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures the point 15 of Y-axis of r channel gamma curve
    #[inline(always)]
    pub fn gamma_r_y0f(&self) -> GAMMA_R_Y0F_R {
        GAMMA_R_Y0F_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures the point 14 of Y-axis of r channel gamma curve
    #[inline(always)]
    pub fn gamma_r_y0e(&self) -> GAMMA_R_Y0E_R {
        GAMMA_R_Y0E_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures the point 13 of Y-axis of r channel gamma curve
    #[inline(always)]
    pub fn gamma_r_y0d(&self) -> GAMMA_R_Y0D_R {
        GAMMA_R_Y0D_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures the point 12 of Y-axis of r channel gamma curve
    #[inline(always)]
...
///`read()` method returns [`gamma_ry4::R`](R) reader structure
impl crate::Readable for GAMMA_RY4_SPEC {}
///`write(|w| ..)` method takes [`gamma_ry4::W`](W) writer structure
