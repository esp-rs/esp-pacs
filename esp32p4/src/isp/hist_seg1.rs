///Register `HIST_SEG1` reader
pub type R = crate::R<HIST_SEG1_SPEC>;
///Register `HIST_SEG1` writer
pub type W = crate::W<HIST_SEG1_SPEC>;
///Field `HIST_SEG_7_8` reader - this field configures threshold of histogram bin 7 and bin 8
pub type HIST_SEG_7_8_R = crate::FieldReader;
///Field `HIST_SEG_7_8` writer - this field configures threshold of histogram bin 7 and bin 8
pub type HIST_SEG_7_8_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_SEG_6_7` reader - this field configures threshold of histogram bin 6 and bin 7
pub type HIST_SEG_6_7_R = crate::FieldReader;
///Field `HIST_SEG_6_7` writer - this field configures threshold of histogram bin 6 and bin 7
pub type HIST_SEG_6_7_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_SEG_5_6` reader - this field configures threshold of histogram bin 5 and bin 6
pub type HIST_SEG_5_6_R = crate::FieldReader;
///Field `HIST_SEG_5_6` writer - this field configures threshold of histogram bin 5 and bin 6
pub type HIST_SEG_5_6_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_SEG_4_5` reader - this field configures threshold of histogram bin 4 and bin 5
pub type HIST_SEG_4_5_R = crate::FieldReader;
///Field `HIST_SEG_4_5` writer - this field configures threshold of histogram bin 4 and bin 5
pub type HIST_SEG_4_5_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures threshold of histogram bin 7 and bin 8
    #[inline(always)]
    pub fn hist_seg_7_8(&self) -> HIST_SEG_7_8_R {
        HIST_SEG_7_8_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures threshold of histogram bin 6 and bin 7
    #[inline(always)]
    pub fn hist_seg_6_7(&self) -> HIST_SEG_6_7_R {
        HIST_SEG_6_7_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures threshold of histogram bin 5 and bin 6
    #[inline(always)]
    pub fn hist_seg_5_6(&self) -> HIST_SEG_5_6_R {
        HIST_SEG_5_6_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures threshold of histogram bin 4 and bin 5
    #[inline(always)]
...
///`read()` method returns [`hist_seg1::R`](R) reader structure
impl crate::Readable for HIST_SEG1_SPEC {}
///`write(|w| ..)` method takes [`hist_seg1::W`](W) writer structure
