///Register `AF_HSCALE_A` reader
pub type R = crate::R<AF_HSCALE_A_SPEC>;
///Register `AF_HSCALE_A` writer
pub type W = crate::W<AF_HSCALE_A_SPEC>;
///Field `AF_RPOINT_A` reader - this field configures left coordinate of focus window a, must >= 2
pub type AF_RPOINT_A_R = crate::FieldReader<u16>;
///Field `AF_RPOINT_A` writer - this field configures left coordinate of focus window a, must >= 2
pub type AF_RPOINT_A_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `AF_LPOINT_A` reader - this field configures top coordinate of focus window a, must >= 2
pub type AF_LPOINT_A_R = crate::FieldReader<u16>;
///Field `AF_LPOINT_A` writer - this field configures top coordinate of focus window a, must >= 2
pub type AF_LPOINT_A_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - this field configures left coordinate of focus window a, must >= 2
    #[inline(always)]
    pub fn af_rpoint_a(&self) -> AF_RPOINT_A_R {
        AF_RPOINT_A_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bits 16:27 - this field configures top coordinate of focus window a, must >= 2
    #[inline(always)]
...
///`read()` method returns [`af_hscale_a::R`](R) reader structure
impl crate::Readable for AF_HSCALE_A_SPEC {}
///`write(|w| ..)` method takes [`af_hscale_a::W`](W) writer structure
