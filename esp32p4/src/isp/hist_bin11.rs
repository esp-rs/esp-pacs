///Register `HIST_BIN11` reader
pub type R = crate::R<HIST_BIN11_SPEC>;
///Field `HIST_BIN_11` reader - this field represents result of histogram bin 11
pub type HIST_BIN_11_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:16 - this field represents result of histogram bin 11
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HIST_BIN11")
            .field("hist_bin_11", &self.hist_bin_11())
            .finish()
    }
}
...
///`read()` method returns [`hist_bin11::R`](R) reader structure
