///Register `AF_GEN_TH_CTRL` reader
pub type R = crate::R<AF_GEN_TH_CTRL_SPEC>;
///Register `AF_GEN_TH_CTRL` writer
pub type W = crate::W<AF_GEN_TH_CTRL_SPEC>;
///Field `AF_GEN_THRESHOLD_MIN` reader - this field configures min threshold when use auto_threshold
pub type AF_GEN_THRESHOLD_MIN_R = crate::FieldReader<u16>;
///Field `AF_GEN_THRESHOLD_MIN` writer - this field configures min threshold when use auto_threshold
pub type AF_GEN_THRESHOLD_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `AF_GEN_THRESHOLD_MAX` reader - this field configures max threshold when use auto_threshold
pub type AF_GEN_THRESHOLD_MAX_R = crate::FieldReader<u16>;
///Field `AF_GEN_THRESHOLD_MAX` writer - this field configures max threshold when use auto_threshold
pub type AF_GEN_THRESHOLD_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - this field configures min threshold when use auto_threshold
    #[inline(always)]
    pub fn af_gen_threshold_min(&self) -> AF_GEN_THRESHOLD_MIN_R {
        AF_GEN_THRESHOLD_MIN_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - this field configures max threshold when use auto_threshold
    #[inline(always)]
...
///`read()` method returns [`af_gen_th_ctrl::R`](R) reader structure
impl crate::Readable for AF_GEN_TH_CTRL_SPEC {}
///`write(|w| ..)` method takes [`af_gen_th_ctrl::W`](W) writer structure
