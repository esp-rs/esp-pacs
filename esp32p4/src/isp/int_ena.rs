...
///Field `ISP_DATA_TYPE_ERR` reader - write 1 to enable input data type error
pub type ISP_DATA_TYPE_ERR_R = crate::BitReader;
///Field `ISP_DATA_TYPE_ERR` writer - write 1 to enable input data type error
pub type ISP_DATA_TYPE_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ISP_ASYNC_FIFO_OVF` reader - write 1 to enable isp input fifo overflow
pub type ISP_ASYNC_FIFO_OVF_R = crate::BitReader;
///Field `ISP_ASYNC_FIFO_OVF` writer - write 1 to enable isp input fifo overflow
pub type ISP_ASYNC_FIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ISP_BUF_FULL` reader - write 1 to enable isp input buffer full
pub type ISP_BUF_FULL_R = crate::BitReader;
///Field `ISP_BUF_FULL` writer - write 1 to enable isp input buffer full
pub type ISP_BUF_FULL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ISP_HVNUM_SETTING_ERR` reader - write 1 to enable hnum and vnum setting format error
pub type ISP_HVNUM_SETTING_ERR_R = crate::BitReader;
///Field `ISP_HVNUM_SETTING_ERR` writer - write 1 to enable hnum and vnum setting format error
pub type ISP_HVNUM_SETTING_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ISP_DATA_TYPE_SETTING_ERR` reader - write 1 to enable setting invalid reg_data_type
pub type ISP_DATA_TYPE_SETTING_ERR_R = crate::BitReader;
///Field `ISP_DATA_TYPE_SETTING_ERR` writer - write 1 to enable setting invalid reg_data_type
pub type ISP_DATA_TYPE_SETTING_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ISP_MIPI_HNUM_UNMATCH` reader - write 1 to enable hnum setting unmatch with mipi input
pub type ISP_MIPI_HNUM_UNMATCH_R = crate::BitReader;
///Field `ISP_MIPI_HNUM_UNMATCH` writer - write 1 to enable hnum setting unmatch with mipi input
pub type ISP_MIPI_HNUM_UNMATCH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DPC_CHECK_DONE` reader - write 1 to enable dpc check done
pub type DPC_CHECK_DONE_R = crate::BitReader;
///Field `DPC_CHECK_DONE` writer - write 1 to enable dpc check done
pub type DPC_CHECK_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GAMMA_XCOORD_ERR` reader - write 1 to enable gamma setting error
pub type GAMMA_XCOORD_ERR_R = crate::BitReader;
///Field `GAMMA_XCOORD_ERR` writer - write 1 to enable gamma setting error
pub type GAMMA_XCOORD_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AE_MONITOR` reader - write 1 to enable ae monitor
pub type AE_MONITOR_R = crate::BitReader;
///Field `AE_MONITOR` writer - write 1 to enable ae monitor
...
///Field `AE_FRAME_DONE` writer - write 1 to enable ae
pub type AE_FRAME_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AF_FDONE` reader - write 1 to enable af statistic
pub type AF_FDONE_R = crate::BitReader;
///Field `AF_FDONE` writer - write 1 to enable af statistic
...
///Field `AF_ENV` writer - write 1 to enable af monitor
pub type AF_ENV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AWB_FDONE` reader - write 1 to enable awb
pub type AWB_FDONE_R = crate::BitReader;
///Field `AWB_FDONE` writer - write 1 to enable awb
pub type AWB_FDONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HIST_FDONE` reader - write 1 to enable histogram
pub type HIST_FDONE_R = crate::BitReader;
///Field `HIST_FDONE` writer - write 1 to enable histogram
pub type HIST_FDONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FRAME` reader - write 1 to enable isp frame end
pub type FRAME_R = crate::BitReader;
///Field `FRAME` writer - write 1 to enable isp frame end
pub type FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BLC_FRAME` reader - write 1 to enable blc frame done
pub type BLC_FRAME_R = crate::BitReader;
///Field `BLC_FRAME` writer - write 1 to enable blc frame done
pub type BLC_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LSC_FRAME` reader - write 1 to enable lsc frame done
pub type LSC_FRAME_R = crate::BitReader;
///Field `LSC_FRAME` writer - write 1 to enable lsc frame done
pub type LSC_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DPC_FRAME` reader - write 1 to enable dpc frame done
pub type DPC_FRAME_R = crate::BitReader;
///Field `DPC_FRAME` writer - write 1 to enable dpc frame done
pub type DPC_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BF_FRAME` reader - write 1 to enable bf frame done
pub type BF_FRAME_R = crate::BitReader;
///Field `BF_FRAME` writer - write 1 to enable bf frame done
pub type BF_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DEMOSAIC_FRAME` reader - write 1 to enable demosaic frame done
pub type DEMOSAIC_FRAME_R = crate::BitReader;
///Field `DEMOSAIC_FRAME` writer - write 1 to enable demosaic frame done
pub type DEMOSAIC_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEDIAN_FRAME` reader - write 1 to enable median frame done
pub type MEDIAN_FRAME_R = crate::BitReader;
///Field `MEDIAN_FRAME` writer - write 1 to enable median frame done
pub type MEDIAN_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CCM_FRAME` reader - write 1 to enable ccm frame done
pub type CCM_FRAME_R = crate::BitReader;
///Field `CCM_FRAME` writer - write 1 to enable ccm frame done
pub type CCM_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GAMMA_FRAME` reader - write 1 to enable gamma frame done
pub type GAMMA_FRAME_R = crate::BitReader;
///Field `GAMMA_FRAME` writer - write 1 to enable gamma frame done
pub type GAMMA_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RGB2YUV_FRAME` reader - write 1 to enable rgb2yuv frame done
pub type RGB2YUV_FRAME_R = crate::BitReader;
///Field `RGB2YUV_FRAME` writer - write 1 to enable rgb2yuv frame done
pub type RGB2YUV_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SHARP_FRAME` reader - write 1 to enable sharp frame done
pub type SHARP_FRAME_R = crate::BitReader;
///Field `SHARP_FRAME` writer - write 1 to enable sharp frame done
pub type SHARP_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COLOR_FRAME` reader - write 1 to enable color frame done
pub type COLOR_FRAME_R = crate::BitReader;
///Field `COLOR_FRAME` writer - write 1 to enable color frame done
pub type COLOR_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `YUV2RGB_FRAME` reader - write 1 to enable yuv2rgb frame done
pub type YUV2RGB_FRAME_R = crate::BitReader;
///Field `YUV2RGB_FRAME` writer - write 1 to enable yuv2rgb frame done
pub type YUV2RGB_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAIL_IDI_FRAME` reader - write 1 to enable isp_tail idi frame_end
pub type TAIL_IDI_FRAME_R = crate::BitReader;
///Field `TAIL_IDI_FRAME` writer - write 1 to enable isp_tail idi frame_end
pub type TAIL_IDI_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HEADER_IDI_FRAME` reader - write 1 to enable real input frame end of isp_input
pub type HEADER_IDI_FRAME_R = crate::BitReader;
///Field `HEADER_IDI_FRAME` writer - write 1 to enable real input frame end of isp_input
pub type HEADER_IDI_FRAME_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - write 1 to enable input data type error
    #[inline(always)]
    pub fn isp_data_type_err(&self) -> ISP_DATA_TYPE_ERR_R {
        ISP_DATA_TYPE_ERR_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - write 1 to enable isp input fifo overflow
    #[inline(always)]
    pub fn isp_async_fifo_ovf(&self) -> ISP_ASYNC_FIFO_OVF_R {
        ISP_ASYNC_FIFO_OVF_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - write 1 to enable isp input buffer full
    #[inline(always)]
    pub fn isp_buf_full(&self) -> ISP_BUF_FULL_R {
        ISP_BUF_FULL_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - write 1 to enable hnum and vnum setting format error
    #[inline(always)]
