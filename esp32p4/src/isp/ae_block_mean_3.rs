///Register `AE_BLOCK_MEAN_3` reader
pub type R = crate::R<AE_BLOCK_MEAN_3_SPEC>;
///Field `AE_B30_MEAN` reader - this field configures block30 Y mean data
pub type AE_B30_MEAN_R = crate::FieldReader;
///Field `AE_B24_MEAN` reader - this field configures block24 Y mean data
pub type AE_B24_MEAN_R = crate::FieldReader;
///Field `AE_B23_MEAN` reader - this field configures block23 Y mean data
pub type AE_B23_MEAN_R = crate::FieldReader;
///Field `AE_B22_MEAN` reader - this field configures block22 Y mean data
pub type AE_B22_MEAN_R = crate::FieldReader;
impl R {
    ///Bits 0:7 - this field configures block30 Y mean data
    #[inline(always)]
    pub fn ae_b30_mean(&self) -> AE_B30_MEAN_R {
        AE_B30_MEAN_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures block24 Y mean data
    #[inline(always)]
    pub fn ae_b24_mean(&self) -> AE_B24_MEAN_R {
        AE_B24_MEAN_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures block23 Y mean data
    #[inline(always)]
    pub fn ae_b23_mean(&self) -> AE_B23_MEAN_R {
        AE_B23_MEAN_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures block22 Y mean data
    #[inline(always)]
...
///`read()` method returns [`ae_block_mean_3::R`](R) reader structure
