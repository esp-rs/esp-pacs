///Register `AF_HSCALE_B` reader
pub type R = crate::R<AF_HSCALE_B_SPEC>;
///Register `AF_HSCALE_B` writer
pub type W = crate::W<AF_HSCALE_B_SPEC>;
///Field `AF_RPOINT_B` reader - this field configures left coordinate of focus window b, must >= 2
pub type AF_RPOINT_B_R = crate::FieldReader<u16>;
///Field `AF_RPOINT_B` writer - this field configures left coordinate of focus window b, must >= 2
pub type AF_RPOINT_B_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `AF_LPOINT_B` reader - this field configures top coordinate of focus window b, must >= 2
pub type AF_LPOINT_B_R = crate::FieldReader<u16>;
///Field `AF_LPOINT_B` writer - this field configures top coordinate of focus window b, must >= 2
pub type AF_LPOINT_B_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - this field configures left coordinate of focus window b, must >= 2
    #[inline(always)]
    pub fn af_rpoint_b(&self) -> AF_RPOINT_B_R {
        AF_RPOINT_B_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bits 16:27 - this field configures top coordinate of focus window b, must >= 2
    #[inline(always)]
...
///`read()` method returns [`af_hscale_b::R`](R) reader structure
impl crate::Readable for AF_HSCALE_B_SPEC {}
///`write(|w| ..)` method takes [`af_hscale_b::W`](W) writer structure
