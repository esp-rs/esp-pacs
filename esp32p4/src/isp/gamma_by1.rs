///Register `GAMMA_BY1` reader
pub type R = crate::R<GAMMA_BY1_SPEC>;
///Register `GAMMA_BY1` writer
pub type W = crate::W<GAMMA_BY1_SPEC>;
///Field `GAMMA_B_Y03` reader - this field configures the point 3 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y03_R = crate::FieldReader;
///Field `GAMMA_B_Y03` writer - this field configures the point 3 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y03_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_B_Y02` reader - this field configures the point 2 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y02_R = crate::FieldReader;
///Field `GAMMA_B_Y02` writer - this field configures the point 2 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y02_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_B_Y01` reader - this field configures the point 1 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y01_R = crate::FieldReader;
///Field `GAMMA_B_Y01` writer - this field configures the point 1 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y01_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GAMMA_B_Y00` reader - this field configures the point 0 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y00_R = crate::FieldReader;
///Field `GAMMA_B_Y00` writer - this field configures the point 0 of Y-axis of b channel gamma curve
pub type GAMMA_B_Y00_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures the point 3 of Y-axis of b channel gamma curve
    #[inline(always)]
    pub fn gamma_b_y03(&self) -> GAMMA_B_Y03_R {
        GAMMA_B_Y03_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures the point 2 of Y-axis of b channel gamma curve
    #[inline(always)]
    pub fn gamma_b_y02(&self) -> GAMMA_B_Y02_R {
        GAMMA_B_Y02_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures the point 1 of Y-axis of b channel gamma curve
    #[inline(always)]
    pub fn gamma_b_y01(&self) -> GAMMA_B_Y01_R {
        GAMMA_B_Y01_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures the point 0 of Y-axis of b channel gamma curve
    #[inline(always)]
...
///`read()` method returns [`gamma_by1::R`](R) reader structure
impl crate::Readable for GAMMA_BY1_SPEC {}
///`write(|w| ..)` method takes [`gamma_by1::W`](W) writer structure
