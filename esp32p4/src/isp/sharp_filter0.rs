///Register `SHARP_FILTER0` reader
pub type R = crate::R<SHARP_FILTER0_SPEC>;
///Register `SHARP_FILTER0` writer
pub type W = crate::W<SHARP_FILTER0_SPEC>;
///Field `SHARP_FILTER_COE00` reader - this field configures unsharp masking(usm) filter coefficient
pub type SHARP_FILTER_COE00_R = crate::FieldReader;
///Field `SHARP_FILTER_COE00` writer - this field configures unsharp masking(usm) filter coefficient
pub type SHARP_FILTER_COE00_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `SHARP_FILTER_COE01` reader - this field configures usm filter coefficient
pub type SHARP_FILTER_COE01_R = crate::FieldReader;
///Field `SHARP_FILTER_COE01` writer - this field configures usm filter coefficient
pub type SHARP_FILTER_COE01_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `SHARP_FILTER_COE02` reader - this field configures usm filter coefficient
pub type SHARP_FILTER_COE02_R = crate::FieldReader;
///Field `SHARP_FILTER_COE02` writer - this field configures usm filter coefficient
pub type SHARP_FILTER_COE02_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this field configures unsharp masking(usm) filter coefficient
    #[inline(always)]
...
///`read()` method returns [`sharp_filter0::R`](R) reader structure
impl crate::Readable for SHARP_FILTER0_SPEC {}
///`write(|w| ..)` method takes [`sharp_filter0::W`](W) writer structure
