///Register `SHARP_MATRIX_CTRL` reader
pub type R = crate::R<SHARP_MATRIX_CTRL_SPEC>;
///Register `SHARP_MATRIX_CTRL` writer
...
///Field `SHARP_TAIL_PIXEN_PULSE_TL` writer - matrix tail pixen low level threshold, should not to large to prevent expanding to next frame, only reg_demosaic_tail_pixen_pulse_th!=0 and reg_demosaic_tail_pixen_pulse_tl!=0 and reg_demosaic_tail_pixen_pulse_th &lt; reg_demosaic_tail_pixen_pulse_tl will enable tail pulse function
pub type SHARP_TAIL_PIXEN_PULSE_TL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SHARP_TAIL_PIXEN_PULSE_TH` reader - matrix tail pixen high level threshold, must &lt; hnum-1, only reg_sharp_tail_pixen_pulse_th!=0 and reg_sharp_tail_pixen_pulse_tl!=0 and reg_sharp_tail_pixen_pulse_th &lt; reg_sharp_tail_pixen_pulse_tl will enable tail pulse function
pub type SHARP_TAIL_PIXEN_PULSE_TH_R = crate::FieldReader;
///Field `SHARP_TAIL_PIXEN_PULSE_TH` writer - matrix tail pixen high level threshold, must &lt; hnum-1, only reg_sharp_tail_pixen_pulse_th!=0 and reg_sharp_tail_pixen_pulse_tl!=0 and reg_sharp_tail_pixen_pulse_th &lt; reg_sharp_tail_pixen_pulse_tl will enable tail pulse function
pub type SHARP_TAIL_PIXEN_PULSE_TH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SHARP_PADDING_DATA` reader - this field configures sharp padding data
pub type SHARP_PADDING_DATA_R = crate::FieldReader;
///Field `SHARP_PADDING_DATA` writer - this field configures sharp padding data
pub type SHARP_PADDING_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SHARP_PADDING_MODE` reader - this field configures sharp padding mode
pub type SHARP_PADDING_MODE_R = crate::BitReader;
///Field `SHARP_PADDING_MODE` writer - this field configures sharp padding mode
...
impl R {
    ...
    ///Bits 8:15 - matrix tail pixen high level threshold, must &lt; hnum-1, only reg_sharp_tail_pixen_pulse_th!=0 and reg_sharp_tail_pixen_pulse_tl!=0 and reg_sharp_tail_pixen_pulse_th &lt; reg_sharp_tail_pixen_pulse_tl will enable tail pulse function
    #[inline(always)]
...
///`read()` method returns [`sharp_matrix_ctrl::R`](R) reader structure
impl crate::Readable for SHARP_MATRIX_CTRL_SPEC {}
///`write(|w| ..)` method takes [`sharp_matrix_ctrl::W`](W) writer structure
