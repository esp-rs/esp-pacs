///Register `AF_VSCALE_B` reader
pub type R = crate::R<AF_VSCALE_B_SPEC>;
///Register `AF_VSCALE_B` writer
pub type W = crate::W<AF_VSCALE_B_SPEC>;
///Field `AF_BPOINT_B` reader - this field configures right coordinate of focus window b, must &lt;= hnum-2
pub type AF_BPOINT_B_R = crate::FieldReader<u16>;
///Field `AF_BPOINT_B` writer - this field configures right coordinate of focus window b, must &lt;= hnum-2
pub type AF_BPOINT_B_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `AF_TPOINT_B` reader - this field configures bottom coordinate of focus window b, must &lt;= hnum-2
pub type AF_TPOINT_B_R = crate::FieldReader<u16>;
///Field `AF_TPOINT_B` writer - this field configures bottom coordinate of focus window b, must &lt;= hnum-2
pub type AF_TPOINT_B_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - this field configures right coordinate of focus window b, must &lt;= hnum-2
    #[inline(always)]
    pub fn af_bpoint_b(&self) -> AF_BPOINT_B_R {
        AF_BPOINT_B_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bits 16:27 - this field configures bottom coordinate of focus window b, must &lt;= hnum-2
    #[inline(always)]
...
///`read()` method returns [`af_vscale_b::R`](R) reader structure
impl crate::Readable for AF_VSCALE_B_SPEC {}
///`write(|w| ..)` method takes [`af_vscale_b::W`](W) writer structure
