///Register `HIST_OFFS` reader
pub type R = crate::R<HIST_OFFS_SPEC>;
///Register `HIST_OFFS` writer
pub type W = crate::W<HIST_OFFS_SPEC>;
///Field `HIST_Y_OFFS` reader - this field configures y coordinate of first window
pub type HIST_Y_OFFS_R = crate::FieldReader<u16>;
///Field `HIST_Y_OFFS` writer - this field configures y coordinate of first window
pub type HIST_Y_OFFS_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `HIST_X_OFFS` reader - this field configures x coordinate of first window
pub type HIST_X_OFFS_R = crate::FieldReader<u16>;
///Field `HIST_X_OFFS` writer - this field configures x coordinate of first window
pub type HIST_X_OFFS_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - this field configures y coordinate of first window
    #[inline(always)]
    pub fn hist_y_offs(&self) -> HIST_Y_OFFS_R {
        HIST_Y_OFFS_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bits 16:27 - this field configures x coordinate of first window
    #[inline(always)]
...
///`read()` method returns [`hist_offs::R`](R) reader structure
impl crate::Readable for HIST_OFFS_SPEC {}
///`write(|w| ..)` method takes [`hist_offs::W`](W) writer structure
