///Register `HIST_BIN10` reader
pub type R = crate::R<HIST_BIN10_SPEC>;
///Field `HIST_BIN_10` reader - this field represents result of histogram bin 10
pub type HIST_BIN_10_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:16 - this field represents result of histogram bin 10
    #[inline(always)]
...
///`read()` method returns [`hist_bin10::R`](R) reader structure
