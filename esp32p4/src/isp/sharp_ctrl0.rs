///Register `SHARP_CTRL0` reader
pub type R = crate::R<SHARP_CTRL0_SPEC>;
///Register `SHARP_CTRL0` writer
pub type W = crate::W<SHARP_CTRL0_SPEC>;
///Field `SHARP_THRESHOLD_LOW` reader - this field configures sharpen threshold for detail
pub type SHARP_THRESHOLD_LOW_R = crate::FieldReader;
///Field `SHARP_THRESHOLD_LOW` writer - this field configures sharpen threshold for detail
pub type SHARP_THRESHOLD_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SHARP_THRESHOLD_HIGH` reader - this field configures sharpen threshold for edge
pub type SHARP_THRESHOLD_HIGH_R = crate::FieldReader;
///Field `SHARP_THRESHOLD_HIGH` writer - this field configures sharpen threshold for edge
pub type SHARP_THRESHOLD_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SHARP_AMOUNT_LOW` reader - this field configures sharpen amount for detail
pub type SHARP_AMOUNT_LOW_R = crate::FieldReader;
///Field `SHARP_AMOUNT_LOW` writer - this field configures sharpen amount for detail
pub type SHARP_AMOUNT_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SHARP_AMOUNT_HIGH` reader - this field configures sharpen amount for edge
pub type SHARP_AMOUNT_HIGH_R = crate::FieldReader;
///Field `SHARP_AMOUNT_HIGH` writer - this field configures sharpen amount for edge
pub type SHARP_AMOUNT_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures sharpen threshold for detail
    #[inline(always)]
    pub fn sharp_threshold_low(&self) -> SHARP_THRESHOLD_LOW_R {
        SHARP_THRESHOLD_LOW_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures sharpen threshold for edge
    #[inline(always)]
    pub fn sharp_threshold_high(&self) -> SHARP_THRESHOLD_HIGH_R {
        SHARP_THRESHOLD_HIGH_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures sharpen amount for detail
    #[inline(always)]
    pub fn sharp_amount_low(&self) -> SHARP_AMOUNT_LOW_R {
        SHARP_AMOUNT_LOW_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures sharpen amount for edge
    #[inline(always)]
...
///`read()` method returns [`sharp_ctrl0::R`](R) reader structure
impl crate::Readable for SHARP_CTRL0_SPEC {}
///`write(|w| ..)` method takes [`sharp_ctrl0::W`](W) writer structure
