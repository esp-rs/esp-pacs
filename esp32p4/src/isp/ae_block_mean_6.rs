///Register `AE_BLOCK_MEAN_6` reader
pub type R = crate::R<AE_BLOCK_MEAN_6_SPEC>;
///Field `AE_B44_MEAN` reader - this field configures block44 Y mean data
pub type AE_B44_MEAN_R = crate::FieldReader;
impl R {
    ///Bits 24:31 - this field configures block44 Y mean data
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`ae_block_mean_6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct AE_BLOCK_MEAN_6_SPEC;
impl crate::RegisterSpec for AE_BLOCK_MEAN_6_SPEC {
    type Ux = u32;
}
///`read()` method returns [`ae_block_mean_6::R`](R) reader structure
