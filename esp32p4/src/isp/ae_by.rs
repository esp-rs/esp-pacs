///Register `AE_BY` reader
pub type R = crate::R<AE_BY_SPEC>;
///Register `AE_BY` writer
pub type W = crate::W<AE_BY_SPEC>;
///Field `AE_Y_BSIZE` reader - this field configures every block y size
pub type AE_Y_BSIZE_R = crate::FieldReader<u16>;
///Field `AE_Y_BSIZE` writer - this field configures every block y size
pub type AE_Y_BSIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `AE_Y_START` reader - this field configures first block start y address
pub type AE_Y_START_R = crate::FieldReader<u16>;
///Field `AE_Y_START` writer - this field configures first block start y address
pub type AE_Y_START_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
impl R {
    ///Bits 0:10 - this field configures every block y size
    #[inline(always)]
    pub fn ae_y_bsize(&self) -> AE_Y_BSIZE_R {
        AE_Y_BSIZE_R::new((self.bits & 0x07ff) as u16)
    }
    ///Bits 11:21 - this field configures first block start y address
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AE_BY")
            .field("ae_y_bsize", &self.ae_y_bsize())
            .field("ae_y_start", &self.ae_y_start())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`ae_by::R`](R) reader structure
impl crate::Readable for AE_BY_SPEC {}
///`write(|w| ..)` method takes [`ae_by::W`](W) writer structure
