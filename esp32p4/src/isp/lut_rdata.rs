///Register `LUT_RDATA` reader
pub type R = crate::R<LUT_RDATA_SPEC>;
///Field `LUT_RDATA` reader - this field represents the read data of lut. read ISP_LUT_RDATA after write ISP_LUT_CMD register
pub type LUT_RDATA_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - this field represents the read data of lut. read ISP_LUT_RDATA after write ISP_LUT_CMD register
    #[inline(always)]
...
///`read()` method returns [`lut_rdata::R`](R) reader structure
