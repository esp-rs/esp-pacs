...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SHARP_FILTER2")
            .field("sharp_filter_coe20", &self.sharp_filter_coe20().bits())
            .field("sharp_filter_coe21", &self.sharp_filter_coe21().bits())
            .field("sharp_filter_coe22", &self.sharp_filter_coe22().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
