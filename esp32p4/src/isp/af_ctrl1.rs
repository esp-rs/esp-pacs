...
impl W {
    #[doc = "Bits 0:21 - this field configures pixnum used when calculating the autofocus threshold. Set to 0 to disable threshold calculation"]
    #[inline(always)]
    pub fn af_thpixnum(&mut self) -> AF_THPIXNUM_W<'_, AF_CTRL1_SPEC> {
        AF_THPIXNUM_W::new(self, 0)
    }
}
#[doc = "af control register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`af_ctrl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`af_ctrl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
