///Register `AF_CTRL1` reader
pub type R = crate::R<AF_CTRL1_SPEC>;
///Register `AF_CTRL1` writer
...
///Field `AF_THPIXNUM` writer - this field configures pixnum used when calculating the autofocus threshold. Set to 0 to disable threshold calculation
pub type AF_THPIXNUM_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - this field configures pixnum used when calculating the autofocus threshold. Set to 0 to disable threshold calculation
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AF_CTRL1")
            .field("af_thpixnum", &self.af_thpixnum())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`af_ctrl1::R`](R) reader structure
impl crate::Readable for AF_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`af_ctrl1::W`](W) writer structure
