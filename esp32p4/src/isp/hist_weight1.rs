///Register `HIST_WEIGHT1` reader
pub type R = crate::R<HIST_WEIGHT1_SPEC>;
///Register `HIST_WEIGHT1` writer
pub type W = crate::W<HIST_WEIGHT1_SPEC>;
///Field `HIST_WEIGHT_12` reader - this field configures weight of subwindow 12
pub type HIST_WEIGHT_12_R = crate::FieldReader;
///Field `HIST_WEIGHT_12` writer - this field configures weight of subwindow 12
pub type HIST_WEIGHT_12_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_11` reader - this field configures weight of subwindow 11
pub type HIST_WEIGHT_11_R = crate::FieldReader;
///Field `HIST_WEIGHT_11` writer - this field configures weight of subwindow 11
pub type HIST_WEIGHT_11_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_10` reader - this field configures weight of subwindow 10
pub type HIST_WEIGHT_10_R = crate::FieldReader;
///Field `HIST_WEIGHT_10` writer - this field configures weight of subwindow 10
pub type HIST_WEIGHT_10_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_WEIGHT_04` reader - this field configures weight of subwindow 04
pub type HIST_WEIGHT_04_R = crate::FieldReader;
///Field `HIST_WEIGHT_04` writer - this field configures weight of subwindow 04
pub type HIST_WEIGHT_04_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures weight of subwindow 12
    #[inline(always)]
    pub fn hist_weight_12(&self) -> HIST_WEIGHT_12_R {
        HIST_WEIGHT_12_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures weight of subwindow 11
    #[inline(always)]
    pub fn hist_weight_11(&self) -> HIST_WEIGHT_11_R {
        HIST_WEIGHT_11_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures weight of subwindow 10
    #[inline(always)]
    pub fn hist_weight_10(&self) -> HIST_WEIGHT_10_R {
        HIST_WEIGHT_10_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures weight of subwindow 04
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HIST_WEIGHT1")
            .field("hist_weight_12", &self.hist_weight_12())
            .field("hist_weight_11", &self.hist_weight_11())
            .field("hist_weight_10", &self.hist_weight_10())
            .field("hist_weight_04", &self.hist_weight_04())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`hist_weight1::R`](R) reader structure
impl crate::Readable for HIST_WEIGHT1_SPEC {}
///`write(|w| ..)` method takes [`hist_weight1::W`](W) writer structure
