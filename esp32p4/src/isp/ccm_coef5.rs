///Register `CCM_COEF5` reader
pub type R = crate::R<CCM_COEF5_SPEC>;
///Register `CCM_COEF5` writer
pub type W = crate::W<CCM_COEF5_SPEC>;
///Field `CCM_BB` reader - this field configures the color correction matrix coefficient
pub type CCM_BB_R = crate::FieldReader<u16>;
///Field `CCM_BB` writer - this field configures the color correction matrix coefficient
...
///`read()` method returns [`ccm_coef5::R`](R) reader structure
impl crate::Readable for CCM_COEF5_SPEC {}
///`write(|w| ..)` method takes [`ccm_coef5::W`](W) writer structure
