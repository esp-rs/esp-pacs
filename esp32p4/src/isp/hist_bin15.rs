///Register `HIST_BIN15` reader
pub type R = crate::R<HIST_BIN15_SPEC>;
///Field `HIST_BIN_15` reader - this field represents result of histogram bin 15
pub type HIST_BIN_15_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:16 - this field represents result of histogram bin 15
    #[inline(always)]
...
///`read()` method returns [`hist_bin15::R`](R) reader structure
