...
impl W {
    #[doc = "Bits 0:4 - this field configures usm filter coefficient"]
    #[inline(always)]
    pub fn sharp_filter_coe10(&mut self) -> SHARP_FILTER_COE10_W<'_, SHARP_FILTER1_SPEC> {
        SHARP_FILTER_COE10_W::new(self, 0)
    }
    #[doc = "Bits 5:9 - this field configures usm filter coefficient"]
    #[inline(always)]
    pub fn sharp_filter_coe11(&mut self) -> SHARP_FILTER_COE11_W<'_, SHARP_FILTER1_SPEC> {
        SHARP_FILTER_COE11_W::new(self, 5)
    }
    #[doc = "Bits 10:14 - this field configures usm filter coefficient"]
    #[inline(always)]
    pub fn sharp_filter_coe12(&mut self) -> SHARP_FILTER_COE12_W<'_, SHARP_FILTER1_SPEC> {
