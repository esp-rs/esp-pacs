///Register `HIST_SIZE` reader
pub type R = crate::R<HIST_SIZE_SPEC>;
///Register `HIST_SIZE` writer
pub type W = crate::W<HIST_SIZE_SPEC>;
///Field `HIST_Y_SIZE` reader - this field configures y direction size of subwindow
pub type HIST_Y_SIZE_R = crate::FieldReader<u16>;
///Field `HIST_Y_SIZE` writer - this field configures y direction size of subwindow
pub type HIST_Y_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `HIST_X_SIZE` reader - this field configures x direction size of subwindow
pub type HIST_X_SIZE_R = crate::FieldReader<u16>;
///Field `HIST_X_SIZE` writer - this field configures x direction size of subwindow
pub type HIST_X_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ///Bits 0:8 - this field configures y direction size of subwindow
    #[inline(always)]
    pub fn hist_y_size(&self) -> HIST_Y_SIZE_R {
        HIST_Y_SIZE_R::new((self.bits & 0x01ff) as u16)
    }
    ///Bits 16:24 - this field configures x direction size of subwindow
    #[inline(always)]
...
///`read()` method returns [`hist_size::R`](R) reader structure
impl crate::Readable for HIST_SIZE_SPEC {}
///`write(|w| ..)` method takes [`hist_size::W`](W) writer structure
