///Register `HIST_SEG2` reader
pub type R = crate::R<HIST_SEG2_SPEC>;
///Register `HIST_SEG2` writer
pub type W = crate::W<HIST_SEG2_SPEC>;
///Field `HIST_SEG_11_12` reader - this field configures threshold of histogram bin 11 and bin 12
pub type HIST_SEG_11_12_R = crate::FieldReader;
///Field `HIST_SEG_11_12` writer - this field configures threshold of histogram bin 11 and bin 12
pub type HIST_SEG_11_12_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_SEG_10_11` reader - this field configures threshold of histogram bin 10 and bin 11
pub type HIST_SEG_10_11_R = crate::FieldReader;
///Field `HIST_SEG_10_11` writer - this field configures threshold of histogram bin 10 and bin 11
pub type HIST_SEG_10_11_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_SEG_9_10` reader - this field configures threshold of histogram bin 9 and bin 10
pub type HIST_SEG_9_10_R = crate::FieldReader;
///Field `HIST_SEG_9_10` writer - this field configures threshold of histogram bin 9 and bin 10
pub type HIST_SEG_9_10_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `HIST_SEG_8_9` reader - this field configures threshold of histogram bin 8 and bin 9
pub type HIST_SEG_8_9_R = crate::FieldReader;
///Field `HIST_SEG_8_9` writer - this field configures threshold of histogram bin 8 and bin 9
pub type HIST_SEG_8_9_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - this field configures threshold of histogram bin 11 and bin 12
    #[inline(always)]
    pub fn hist_seg_11_12(&self) -> HIST_SEG_11_12_R {
        HIST_SEG_11_12_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:15 - this field configures threshold of histogram bin 10 and bin 11
    #[inline(always)]
    pub fn hist_seg_10_11(&self) -> HIST_SEG_10_11_R {
        HIST_SEG_10_11_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ///Bits 16:23 - this field configures threshold of histogram bin 9 and bin 10
    #[inline(always)]
    pub fn hist_seg_9_10(&self) -> HIST_SEG_9_10_R {
        HIST_SEG_9_10_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    ///Bits 24:31 - this field configures threshold of histogram bin 8 and bin 9
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HIST_SEG2")
            .field("hist_seg_11_12", &self.hist_seg_11_12())
            .field("hist_seg_10_11", &self.hist_seg_10_11())
            .field("hist_seg_9_10", &self.hist_seg_9_10())
            .field("hist_seg_8_9", &self.hist_seg_8_9())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`hist_seg2::R`](R) reader structure
impl crate::Readable for HIST_SEG2_SPEC {}
///`write(|w| ..)` method takes [`hist_seg2::W`](W) writer structure
