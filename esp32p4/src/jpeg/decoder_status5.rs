///Register `DECODER_STATUS5` reader
pub type R = crate::R<DECODER_STATUS5_SPEC>;
///Register `DECODER_STATUS5` writer
pub type W = crate::W<DECODER_STATUS5_SPEC>;
///Field `IDCT_HFM_DATA` reader - Reserved
pub type IDCT_HFM_DATA_R = crate::FieldReader<u16>;
///Field `NS0` reader - Reserved
pub type NS0_R = crate::FieldReader;
///Field `NS1` reader - Reserved
pub type NS1_R = crate::FieldReader;
///Field `NS2` reader - Reserved
pub type NS2_R = crate::FieldReader;
///Field `NS3` reader - Reserved
pub type NS3_R = crate::FieldReader;
///Field `DATA_LAST_O` reader - Reserved
pub type DATA_LAST_O_R = crate::BitReader;
///Field `RDN_RESULT` reader - redundant registers for jpeg
pub type RDN_RESULT_R = crate::BitReader;
///Field `RDN_ENA` reader - redundant control registers for jpeg
pub type RDN_ENA_R = crate::BitReader;
///Field `RDN_ENA` writer - redundant control registers for jpeg
...
impl R {
    ...
    ///Bit 29 - redundant registers for jpeg
    #[inline(always)]
    pub fn rdn_result(&self) -> RDN_RESULT_R {
        RDN_RESULT_R::new(((self.bits >> 29) & 1) != 0)
    }
    ///Bit 30 - redundant control registers for jpeg
    #[inline(always)]
...
///`read()` method returns [`decoder_status5::R`](R) reader structure
impl crate::Readable for DECODER_STATUS5_SPEC {}
///`write(|w| ..)` method takes [`decoder_status5::W`](W) writer structure
