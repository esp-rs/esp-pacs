///Register `DHT_TOTLEN_DC0` reader
pub type R = crate::R<DHT_TOTLEN_DC0_SPEC>;
///Field `DHT_TOTLEN_DC0` reader - write the numbers of 1~n codeword length sum from 1~16 of dc0 table
pub type DHT_TOTLEN_DC0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - write the numbers of 1~n codeword length sum from 1~16 of dc0 table
    #[inline(always)]
...
///`read()` method returns [`dht_totlen_dc0::R`](R) reader structure
