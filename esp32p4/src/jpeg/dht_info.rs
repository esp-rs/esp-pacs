...
impl W {
    #[doc = "Bits 0:3 - configure dht dc table 0 id"]
    #[inline(always)]
    pub fn dc0_dht_id(&mut self) -> DC0_DHT_ID_W<'_, DHT_INFO_SPEC> {
        DC0_DHT_ID_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - configure dht dc table 1 id"]
    #[inline(always)]
    pub fn dc1_dht_id(&mut self) -> DC1_DHT_ID_W<'_, DHT_INFO_SPEC> {
        DC1_DHT_ID_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - configure dht ac table 0 id"]
    #[inline(always)]
    pub fn ac0_dht_id(&mut self) -> AC0_DHT_ID_W<'_, DHT_INFO_SPEC> {
        AC0_DHT_ID_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - configure dht ac table 1 id"]
    #[inline(always)]
    pub fn ac1_dht_id(&mut self) -> AC1_DHT_ID_W<'_, DHT_INFO_SPEC> {
        AC1_DHT_ID_W::new(self, 12)
    }
}
#[doc = "Control and configuration registers\n\nYou can [`read`](crate::Reg::read) this register and get [`dht_info::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dht_info::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
