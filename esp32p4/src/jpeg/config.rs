...
///Field `FSM_RST` writer - fsm reset
pub type FSM_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `JPEG_START` writer - start to compress a new pic(in dma reg mode)
pub type JPEG_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `QNR_PRESITION` reader - 0:8bit qnr,1:12bit qnr(TBD)
pub type QNR_PRESITION_R = crate::BitReader;
///Field `QNR_PRESITION` writer - 0:8bit qnr,1:12bit qnr(TBD)
pub type QNR_PRESITION_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FF_CHECK_EN` reader - enable whether to add "00" after "ff"
pub type FF_CHECK_EN_R = crate::BitReader;
///Field `FF_CHECK_EN` writer - enable whether to add "00" after "ff"
pub type FF_CHECK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAMPLE_SEL` reader - 0:yuv444,1:yuv422, 2:yuv420
pub type SAMPLE_SEL_R = crate::FieldReader;
///Field `SAMPLE_SEL` writer - 0:yuv444,1:yuv422, 2:yuv420
pub type SAMPLE_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_LINKLIST_MODE` reader - 1:use linklist to configure dma
pub type DMA_LINKLIST_MODE_R = crate::BitReader;
///Field `DEBUG_DIRECT_OUT_EN` reader - 0:normal mode,1:debug mode for direct output from input
pub type DEBUG_DIRECT_OUT_EN_R = crate::BitReader;
///Field `DEBUG_DIRECT_OUT_EN` writer - 0:normal mode,1:debug mode for direct output from input
pub type DEBUG_DIRECT_OUT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GRAY_SEL` reader - 0:use non-fifo way to access qnr ram,1:use fifo way to access qnr ram
pub type GRAY_SEL_R = crate::BitReader;
///Field `GRAY_SEL` writer - 0:use non-fifo way to access qnr ram,1:use fifo way to access qnr ram
pub type GRAY_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LQNR_TBL_SEL` reader - choose luminance quntization table id(TBD)
pub type LQNR_TBL_SEL_R = crate::FieldReader;
///Field `LQNR_TBL_SEL` writer - choose luminance quntization table id(TBD)
pub type LQNR_TBL_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CQNR_TBL_SEL` reader - choose chrominance quntization table id (TBD)
pub type CQNR_TBL_SEL_R = crate::FieldReader;
///Field `CQNR_TBL_SEL` writer - choose chrominance quntization table id (TBD)
pub type CQNR_TBL_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `COLOR_SPACE` reader - configure picture's color space:0-rb888,1-yuv422,2-rgb565, 3-gray
pub type COLOR_SPACE_R = crate::FieldReader;
///Field `COLOR_SPACE` writer - configure picture's color space:0-rb888,1-yuv422,2-rgb565, 3-gray
pub type COLOR_SPACE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DHT_FIFO_EN` reader - 0:use non-fifo way to write dht len_total/codemin/value table,1:use fifo way to write dht len_total/codemin/value table. Reading dht len_total/codemin/value table only has nonfifo way
pub type DHT_FIFO_EN_R = crate::BitReader;
///Field `DHT_FIFO_EN` writer - 0:use non-fifo way to write dht len_total/codemin/value table,1:use fifo way to write dht len_total/codemin/value table. Reading dht len_total/codemin/value table only has nonfifo way
pub type DHT_FIFO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_CLK_FORCE_ON` reader - force memory's clock enabled
pub type MEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `MEM_CLK_FORCE_ON` writer - force memory's clock enabled
pub type MEM_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `JFIF_VER` reader - decode pause period to trigger decode_timeout int, the timeout periods =2 power (reg_decode_timeout_thres) -1
pub type JFIF_VER_R = crate::FieldReader;
///Field `JFIF_VER` writer - decode pause period to trigger decode_timeout int, the timeout periods =2 power (reg_decode_timeout_thres) -1
pub type JFIF_VER_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `DECODE_TIMEOUT_TASK_SEL` reader - 0: software use reset to abort decode process ,1: decoder abort decode process by itself
pub type DECODE_TIMEOUT_TASK_SEL_R = crate::BitReader;
///Field `DECODE_TIMEOUT_TASK_SEL` writer - 0: software use reset to abort decode process ,1: decoder abort decode process by itself
pub type DECODE_TIMEOUT_TASK_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SOFT_RST` reader - when set to 1, soft reset JPEG module except jpeg_reg module
pub type SOFT_RST_R = crate::BitReader;
///Field `SOFT_RST` writer - when set to 1, soft reset JPEG module except jpeg_reg module
pub type SOFT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FIFO_RST` reader - fifo reset
pub type FIFO_RST_R = crate::BitReader;
///Field `FIFO_RST` writer - fifo reset
pub type FIFO_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PIXEL_REV` reader - reverse the source color pixel
pub type PIXEL_REV_R = crate::BitReader;
///Field `PIXEL_REV` writer - reverse the source color pixel
pub type PIXEL_REV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TAILER_EN` reader - set this bit to add EOI of "0xffd9" at the end of bitstream
pub type TAILER_EN_R = crate::BitReader;
///Field `TAILER_EN` writer - set this bit to add EOI of "0xffd9" at the end of bitstream
pub type TAILER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PAUSE_EN` reader - set this bit to pause jpeg encoding
pub type PAUSE_EN_R = crate::BitReader;
///Field `PAUSE_EN` writer - set this bit to pause jpeg encoding
pub type PAUSE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_FORCE_PD` reader - 0: no operation,1:force jpeg memory to power down
pub type MEM_FORCE_PD_R = crate::BitReader;
///Field `MEM_FORCE_PD` writer - 0: no operation,1:force jpeg memory to power down
pub type MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_FORCE_PU` reader - 0: no operation,1:force jpeg memory to power up
pub type MEM_FORCE_PU_R = crate::BitReader;
///Field `MEM_FORCE_PU` writer - 0: no operation,1:force jpeg memory to power up
pub type MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MODE` reader - 0:encoder mode, 1: decoder mode
pub type MODE_R = crate::BitReader;
///Field `MODE` writer - 0:encoder mode, 1: decoder mode
pub type MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 2 - 0:8bit qnr,1:12bit qnr(TBD)
    #[inline(always)]
    pub fn qnr_presition(&self) -> QNR_PRESITION_R {
        QNR_PRESITION_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - enable whether to add "00" after "ff"
    #[inline(always)]
    pub fn ff_check_en(&self) -> FF_CHECK_EN_R {
        FF_CHECK_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bits 4:5 - 0:yuv444,1:yuv422, 2:yuv420
    #[inline(always)]
    pub fn sample_sel(&self) -> SAMPLE_SEL_R {
        SAMPLE_SEL_R::new(((self.bits >> 4) & 3) as u8)
    }
    ///Bit 6 - 1:use linklist to configure dma
    #[inline(always)]
    pub fn dma_linklist_mode(&self) -> DMA_LINKLIST_MODE_R {
        DMA_LINKLIST_MODE_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - 0:normal mode,1:debug mode for direct output from input
    #[inline(always)]
    pub fn debug_direct_out_en(&self) -> DEBUG_DIRECT_OUT_EN_R {
        DEBUG_DIRECT_OUT_EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - 0:use non-fifo way to access qnr ram,1:use fifo way to access qnr ram
    #[inline(always)]
    pub fn gray_sel(&self) -> GRAY_SEL_R {
        GRAY_SEL_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bits 9:10 - choose luminance quntization table id(TBD)
    #[inline(always)]
    pub fn lqnr_tbl_sel(&self) -> LQNR_TBL_SEL_R {
        LQNR_TBL_SEL_R::new(((self.bits >> 9) & 3) as u8)
    }
    ///Bits 11:12 - choose chrominance quntization table id (TBD)
    #[inline(always)]
    pub fn cqnr_tbl_sel(&self) -> CQNR_TBL_SEL_R {
        CQNR_TBL_SEL_R::new(((self.bits >> 11) & 3) as u8)
    }
    ///Bits 13:14 - configure picture's color space:0-rb888,1-yuv422,2-rgb565, 3-gray
    #[inline(always)]
    pub fn color_space(&self) -> COLOR_SPACE_R {
        COLOR_SPACE_R::new(((self.bits >> 13) & 3) as u8)
    }
    ///Bit 15 - 0:use non-fifo way to write dht len_total/codemin/value table,1:use fifo way to write dht len_total/codemin/value table. Reading dht len_total/codemin/value table only has nonfifo way
    #[inline(always)]
    pub fn dht_fifo_en(&self) -> DHT_FIFO_EN_R {
        DHT_FIFO_EN_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bit 16 - force memory's clock enabled
    #[inline(always)]
    pub fn mem_clk_force_on(&self) -> MEM_CLK_FORCE_ON_R {
        MEM_CLK_FORCE_ON_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bits 17:22 - decode pause period to trigger decode_timeout int, the timeout periods =2 power (reg_decode_timeout_thres) -1
    #[inline(always)]
    pub fn jfif_ver(&self) -> JFIF_VER_R {
        JFIF_VER_R::new(((self.bits >> 17) & 0x3f) as u8)
    }
    ///Bit 23 - 0: software use reset to abort decode process ,1: decoder abort decode process by itself
    #[inline(always)]
    pub fn decode_timeout_task_sel(&self) -> DECODE_TIMEOUT_TASK_SEL_R {
        DECODE_TIMEOUT_TASK_SEL_R::new(((self.bits >> 23) & 1) != 0)
    }
    ///Bit 24 - when set to 1, soft reset JPEG module except jpeg_reg module
    #[inline(always)]
...
impl W {
    ...
    ///Bit 1 - start to compress a new pic(in dma reg mode)
    #[inline(always)]
    #[must_use]
