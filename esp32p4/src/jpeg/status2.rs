///Register `STATUS2` reader
pub type R = crate::R<STATUS2_SPEC>;
///Field `SOURCE_PIXEL` reader - source pixels fetched from dma
pub type SOURCE_PIXEL_R = crate::FieldReader<u32>;
///Field `LAST_BLOCK` reader - indicate the encoding process for the last mcu of the picture
pub type LAST_BLOCK_R = crate::BitReader;
///Field `LAST_MCU` reader - indicate the encoding process for the last block of the picture
pub type LAST_MCU_R = crate::BitReader;
///Field `LAST_DC` reader - indicate the encoding process is at the header of the last block of the picture
pub type LAST_DC_R = crate::BitReader;
///Field `PACKFIFO_READY` reader - the jpeg pack_fifo ready signal, high active
pub type PACKFIFO_READY_R = crate::BitReader;
impl R {
    ///Bits 0:23 - source pixels fetched from dma
    #[inline(always)]
    pub fn source_pixel(&self) -> SOURCE_PIXEL_R {
        SOURCE_PIXEL_R::new(self.bits & 0x00ff_ffff)
    }
    ///Bit 24 - indicate the encoding process for the last mcu of the picture
    #[inline(always)]
    pub fn last_block(&self) -> LAST_BLOCK_R {
        LAST_BLOCK_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - indicate the encoding process for the last block of the picture
    #[inline(always)]
    pub fn last_mcu(&self) -> LAST_MCU_R {
        LAST_MCU_R::new(((self.bits >> 25) & 1) != 0)
    }
    ///Bit 26 - indicate the encoding process is at the header of the last block of the picture
    #[inline(always)]
    pub fn last_dc(&self) -> LAST_DC_R {
        LAST_DC_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bit 27 - the jpeg pack_fifo ready signal, high active
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS2")
            .field("source_pixel", &self.source_pixel())
            .field("last_block", &self.last_block())
            .field("last_mcu", &self.last_mcu())
            .field("last_dc", &self.last_dc())
...
///`read()` method returns [`status2::R`](R) reader structure
