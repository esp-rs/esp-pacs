///Register `STATUS3` reader
pub type R = crate::R<STATUS3_SPEC>;
///Field `YO` reader - component y transferred from rgb input
pub type YO_R = crate::FieldReader<u16>;
///Field `Y_READY` reader - component y valid signal, high active
pub type Y_READY_R = crate::BitReader;
///Field `CBO` reader - component cb transferred from rgb input
pub type CBO_R = crate::FieldReader<u16>;
///Field `CB_READY` reader - component cb valid signal, high active
pub type CB_READY_R = crate::BitReader;
///Field `CRO` reader - component cr transferred from rgb input
pub type CRO_R = crate::FieldReader<u16>;
///Field `CR_READY` reader - component cr valid signal, high active
pub type CR_READY_R = crate::BitReader;
impl R {
    ///Bits 0:8 - component y transferred from rgb input
    #[inline(always)]
    pub fn yo(&self) -> YO_R {
        YO_R::new((self.bits & 0x01ff) as u16)
    }
    ///Bit 9 - component y valid signal, high active
    #[inline(always)]
    pub fn y_ready(&self) -> Y_READY_R {
        Y_READY_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bits 10:18 - component cb transferred from rgb input
    #[inline(always)]
    pub fn cbo(&self) -> CBO_R {
        CBO_R::new(((self.bits >> 10) & 0x01ff) as u16)
    }
    ///Bit 19 - component cb valid signal, high active
    #[inline(always)]
    pub fn cb_ready(&self) -> CB_READY_R {
        CB_READY_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bits 20:28 - component cr transferred from rgb input
    #[inline(always)]
    pub fn cro(&self) -> CRO_R {
        CRO_R::new(((self.bits >> 20) & 0x01ff) as u16)
    }
    ///Bit 29 - component cr valid signal, high active
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS3")
            .field("yo", &self.yo())
            .field("y_ready", &self.y_ready())
            .field("cbo", &self.cbo())
            .field("cb_ready", &self.cb_ready())
            .field("cro", &self.cro())
            .field("cr_ready", &self.cr_ready())
            .finish()
    }
}
...
///`read()` method returns [`status3::R`](R) reader structure
