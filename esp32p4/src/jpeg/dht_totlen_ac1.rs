///Register `DHT_TOTLEN_AC1` reader
pub type R = crate::R<DHT_TOTLEN_AC1_SPEC>;
///Field `DHT_TOTLEN_AC1` reader - write the numbers of 1~n codeword length sum from 1~16 of ac1 table
pub type DHT_TOTLEN_AC1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - write the numbers of 1~n codeword length sum from 1~16 of ac1 table
    #[inline(always)]
...
///`read()` method returns [`dht_totlen_ac1::R`](R) reader structure
