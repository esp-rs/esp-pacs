///Register `DHT_VAl_AC0` reader
pub type R = crate::R<DHT_VAL_AC0_SPEC>;
///Field `DHT_VAL_AC0` reader - write codeword corresponding huffman values of ac0 table
pub type DHT_VAL_AC0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - write codeword corresponding huffman values of ac0 table
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`dht_val_ac0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DHT_VAL_AC0_SPEC;
impl crate::RegisterSpec for DHT_VAL_AC0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dht_val_ac0::R`](R) reader structure
