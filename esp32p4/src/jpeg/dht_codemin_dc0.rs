///Register `DHT_CODEMIN_DC0` reader
pub type R = crate::R<DHT_CODEMIN_DC0_SPEC>;
///Field `DHT_CODEMIN_DC0` reader - write the minimum codeword of code length from 1~16 of dc0 table. The codeword is left shifted to the MSB position of a 16bit word
pub type DHT_CODEMIN_DC0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - write the minimum codeword of code length from 1~16 of dc0 table. The codeword is left shifted to the MSB position of a 16bit word
    #[inline(always)]
...
///`read()` method returns [`dht_codemin_dc0::R`](R) reader structure
