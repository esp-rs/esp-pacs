///Register `T1QNR` reader
pub type R = crate::R<T1QNR_SPEC>;
///Field `CHROMINANCE_QNR_VAL` reader - write this reg to configure 64 quantization coefficient in t1 table
pub type CHROMINANCE_QNR_VAL_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - write this reg to configure 64 quantization coefficient in t1 table
    #[inline(always)]
...
///`read()` method returns [`t1qnr::R`](R) reader structure
