...
///Field `DONE` reader - This raw interrupt bit turns to high level when JPEG finishes encoding a picture..
pub type DONE_R = crate::BitReader;
///Field `DONE` writer - This raw interrupt bit turns to high level when JPEG finishes encoding a picture..
pub type DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RLE_PARALLEL_ERR` reader - The raw interrupt bit to sign that rle parallel error when decoding.
pub type RLE_PARALLEL_ERR_R = crate::BitReader;
///Field `RLE_PARALLEL_ERR` writer - The raw interrupt bit to sign that rle parallel error when decoding.
pub type RLE_PARALLEL_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CID_ERR` reader - The raw interrupt bit to sign that scan id check with component fails when decoding.
pub type CID_ERR_R = crate::BitReader;
///Field `CID_ERR` writer - The raw interrupt bit to sign that scan id check with component fails when decoding.
pub type CID_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `C_DHT_DC_ID_ERR` reader - The raw interrupt bit to sign that scan component's dc dht id check with dc dht table's id fails when decoding.
pub type C_DHT_DC_ID_ERR_R = crate::BitReader;
///Field `C_DHT_DC_ID_ERR` writer - The raw interrupt bit to sign that scan component's dc dht id check with dc dht table's id fails when decoding.
pub type C_DHT_DC_ID_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `C_DHT_AC_ID_ERR` reader - The raw interrupt bit to sign that scan component's ac dht id check with ac dht table's id fails when decoding.
pub type C_DHT_AC_ID_ERR_R = crate::BitReader;
///Field `C_DHT_AC_ID_ERR` writer - The raw interrupt bit to sign that scan component's ac dht id check with ac dht table's id fails when decoding.
pub type C_DHT_AC_ID_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `C_DQT_ID_ERR` reader - The raw interrupt bit to sign that scan component's dqt id check with dqt table's id fails when decoding.
pub type C_DQT_ID_ERR_R = crate::BitReader;
///Field `C_DQT_ID_ERR` writer - The raw interrupt bit to sign that scan component's dqt id check with dqt table's id fails when decoding.
pub type C_DQT_ID_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RST_UXP_ERR` reader - The raw interrupt bit to sign that RST header marker is detected but restart interval is 0 when decoding.
pub type RST_UXP_ERR_R = crate::BitReader;
///Field `RST_UXP_ERR` writer - The raw interrupt bit to sign that RST header marker is detected but restart interval is 0 when decoding.
pub type RST_UXP_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RST_CHECK_NONE_ERR` reader - The raw interrupt bit to sign that RST header marker is not detected but restart interval is not 0 when decoding.
pub type RST_CHECK_NONE_ERR_R = crate::BitReader;
///Field `RST_CHECK_NONE_ERR` writer - The raw interrupt bit to sign that RST header marker is not detected but restart interval is not 0 when decoding.
pub type RST_CHECK_NONE_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RST_CHECK_POS_ERR` reader - The raw interrupt bit to sign that RST header marker position mismatches with restart interval when decoding.
pub type RST_CHECK_POS_ERR_R = crate::BitReader;
///Field `RST_CHECK_POS_ERR` writer - The raw interrupt bit to sign that RST header marker position mismatches with restart interval when decoding.
pub type RST_CHECK_POS_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_EOF` reader - The raw interrupt bit turns to high level when the last pixel of one square has been transmitted for Tx channel.
pub type OUT_EOF_R = crate::BitReader;
///Field `OUT_EOF` writer - The raw interrupt bit turns to high level when the last pixel of one square has been transmitted for Tx channel.
pub type OUT_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SR_COLOR_MODE_ERR` reader - The raw interrupt bit to sign that the selected source color mode is not supported.
pub type SR_COLOR_MODE_ERR_R = crate::BitReader;
///Field `SR_COLOR_MODE_ERR` writer - The raw interrupt bit to sign that the selected source color mode is not supported.
pub type SR_COLOR_MODE_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCT_DONE` reader - The raw interrupt bit to sign that one dct calculation is finished.
pub type DCT_DONE_R = crate::BitReader;
///Field `DCT_DONE` writer - The raw interrupt bit to sign that one dct calculation is finished.
pub type DCT_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BS_LAST_BLOCK_EOF` reader - The raw interrupt bit to sign that the coding process for last block is finished.
pub type BS_LAST_BLOCK_EOF_R = crate::BitReader;
///Field `BS_LAST_BLOCK_EOF` writer - The raw interrupt bit to sign that the coding process for last block is finished.
pub type BS_LAST_BLOCK_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCAN_CHECK_NONE_ERR` reader - The raw interrupt bit to sign that SOS header marker is not detected but there are still components left to be decoded.
pub type SCAN_CHECK_NONE_ERR_R = crate::BitReader;
///Field `SCAN_CHECK_NONE_ERR` writer - The raw interrupt bit to sign that SOS header marker is not detected but there are still components left to be decoded.
pub type SCAN_CHECK_NONE_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCAN_CHECK_POS_ERR` reader - The raw interrupt bit to sign that SOS header marker position wrong when decoding.
pub type SCAN_CHECK_POS_ERR_R = crate::BitReader;
///Field `SCAN_CHECK_POS_ERR` writer - The raw interrupt bit to sign that SOS header marker position wrong when decoding.
pub type SCAN_CHECK_POS_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UXP_DET` reader - The raw interrupt bit to sign that unsupported header marker is detected when decoding.
pub type UXP_DET_R = crate::BitReader;
///Field `UXP_DET` writer - The raw interrupt bit to sign that unsupported header marker is detected when decoding.
pub type UXP_DET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EN_FRAME_EOF_ERR` reader - The raw interrupt bit to sign that received pixel blocks are smaller than expected when encoding.
pub type EN_FRAME_EOF_ERR_R = crate::BitReader;
///Field `EN_FRAME_EOF_ERR` writer - The raw interrupt bit to sign that received pixel blocks are smaller than expected when encoding.
pub type EN_FRAME_EOF_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EN_FRAME_EOF_LACK` reader - The raw interrupt bit to sign that the frame eof sign bit from dma input is missing when encoding. But the number of pixel blocks is enough.
pub type EN_FRAME_EOF_LACK_R = crate::BitReader;
///Field `EN_FRAME_EOF_LACK` writer - The raw interrupt bit to sign that the frame eof sign bit from dma input is missing when encoding. But the number of pixel blocks is enough.
pub type EN_FRAME_EOF_LACK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DE_FRAME_EOF_ERR` reader - The raw interrupt bit to sign that decoded blocks are smaller than expected when decoding.
pub type DE_FRAME_EOF_ERR_R = crate::BitReader;
///Field `DE_FRAME_EOF_ERR` writer - The raw interrupt bit to sign that decoded blocks are smaller than expected when decoding.
pub type DE_FRAME_EOF_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DE_FRAME_EOF_LACK` reader - The raw interrupt bit to sign that the either frame eof from dma input or eoi marker is missing when encoding. But the number of decoded blocks is enough.
pub type DE_FRAME_EOF_LACK_R = crate::BitReader;
///Field `DE_FRAME_EOF_LACK` writer - The raw interrupt bit to sign that the either frame eof from dma input or eoi marker is missing when encoding. But the number of decoded blocks is enough.
pub type DE_FRAME_EOF_LACK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SOS_UNMATCH_ERR` reader - The raw interrupt bit to sign that the component number of a scan is 0 or does not match the sos marker's length when decoding.
pub type SOS_UNMATCH_ERR_R = crate::BitReader;
///Field `SOS_UNMATCH_ERR` writer - The raw interrupt bit to sign that the component number of a scan is 0 or does not match the sos marker's length when decoding.
pub type SOS_UNMATCH_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MARKER_ERR_FST_SCAN` reader - The raw interrupt bit to sign that the first scan has header marker error when decoding.
pub type MARKER_ERR_FST_SCAN_R = crate::BitReader;
///Field `MARKER_ERR_FST_SCAN` writer - The raw interrupt bit to sign that the first scan has header marker error when decoding.
pub type MARKER_ERR_FST_SCAN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MARKER_ERR_OTHER_SCAN` reader - The raw interrupt bit to sign that the following scans but not the first scan have header marker error when decoding.
pub type MARKER_ERR_OTHER_SCAN_R = crate::BitReader;
///Field `MARKER_ERR_OTHER_SCAN` writer - The raw interrupt bit to sign that the following scans but not the first scan have header marker error when decoding.
pub type MARKER_ERR_OTHER_SCAN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UNDET` reader - The raw interrupt bit to sign that JPEG format is not detected at the eof data of a packet when decoding.
pub type UNDET_R = crate::BitReader;
///Field `UNDET` writer - The raw interrupt bit to sign that JPEG format is not detected at the eof data of a packet when decoding.
pub type UNDET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DECODE_TIMEOUT` reader - The raw interrupt bit to sign that decode pause time is longer than the setting decode timeout time when decoding.
pub type DECODE_TIMEOUT_R = crate::BitReader;
///Field `DECODE_TIMEOUT` writer - The raw interrupt bit to sign that decode pause time is longer than the setting decode timeout time when decoding.
