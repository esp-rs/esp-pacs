...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW")
            ...
            .field("rle_parallel_err", &self.rle_parallel_err().bit())
            .field("cid_err", &self.cid_err().bit())
            .field("c_dht_dc_id_err", &self.c_dht_dc_id_err().bit())
            .field("c_dht_ac_id_err", &self.c_dht_ac_id_err().bit())
            .field("c_dqt_id_err", &self.c_dqt_id_err().bit())
            .field("rst_uxp_err", &self.rst_uxp_err().bit())
            .field("rst_check_none_err", &self.rst_check_none_err().bit())
            .field("rst_check_pos_err", &self.rst_check_pos_err().bit())
            .field("out_eof", &self.out_eof().bit())
            .field("sr_color_mode_err", &self.sr_color_mode_err().bit())
            .field("dct_done", &self.dct_done().bit())
            .field("bs_last_block_eof", &self.bs_last_block_eof().bit())
            .field("scan_check_none_err", &self.scan_check_none_err().bit())
            .field("scan_check_pos_err", &self.scan_check_pos_err().bit())
            .field("uxp_det", &self.uxp_det().bit())
            .field("en_frame_eof_err", &self.en_frame_eof_err().bit())
            .field("en_frame_eof_lack", &self.en_frame_eof_lack().bit())
            .field("de_frame_eof_err", &self.de_frame_eof_err().bit())
            .field("de_frame_eof_lack", &self.de_frame_eof_lack().bit())
            .field("sos_unmatch_err", &self.sos_unmatch_err().bit())
            .field("marker_err_fst_scan", &self.marker_err_fst_scan().bit())
            .field("marker_err_other_scan", &self.marker_err_other_scan().bit())
            .field("undet", &self.undet().bit())
            .field("decode_timeout", &self.decode_timeout().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
