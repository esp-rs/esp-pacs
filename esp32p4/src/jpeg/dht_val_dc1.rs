///Register `DHT_VAl_DC1` reader
pub type R = crate::R<DHT_VAL_DC1_SPEC>;
///Field `DHT_VAL_DC1` reader - write codeword corresponding huffman values of dc1 table
pub type DHT_VAL_DC1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - write codeword corresponding huffman values of dc1 table
    #[inline(always)]
...
///`read()` method returns [`dht_val_dc1::R`](R) reader structure
