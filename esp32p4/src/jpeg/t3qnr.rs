///Register `T3QNR` reader
pub type R = crate::R<T3QNR_SPEC>;
///Field `T3_QNR_VAL` reader - write this reg to configure 64 quantization coefficient in t3 table
pub type T3_QNR_VAL_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - write this reg to configure 64 quantization coefficient in t3 table
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("T3QNR")
            .field("t3_qnr_val", &self.t3_qnr_val())
            .finish()
    }
}
...
///`read()` method returns [`t3qnr::R`](R) reader structure
