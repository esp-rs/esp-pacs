///Register `INTR1_0` reader
pub type R = crate::R<INTR1_0_SPEC>;
///Field `INT1_0` reader - GPIO interrupt 0 status register for GPIO32-56
pub type INT1_0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:24 - GPIO interrupt 0 status register for GPIO32-56
    #[inline(always)]
...
///`read()` method returns [`intr1_0::R`](R) reader structure
