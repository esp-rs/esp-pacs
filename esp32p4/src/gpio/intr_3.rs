///Register `INTR_3` reader
pub type R = crate::R<INTR_3_SPEC>;
///Field `INT_3` reader - GPIO interrupt 3 status register for GPIO0-31
pub type INT_3_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - GPIO interrupt 3 status register for GPIO0-31
    #[inline(always)]
...
///`read()` method returns [`intr_3::R`](R) reader structure
