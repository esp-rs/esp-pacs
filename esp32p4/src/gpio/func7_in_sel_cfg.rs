...
#[doc = "Field `FUNC7_IN_SEL` reader - set this value: s=0-56: connect GPIO\\[s\\] to this port. s=0x3F: set this port always high level. s=0x3E: set this port always low level."]
pub type FUNC7_IN_SEL_R = crate::FieldReader;
#[doc = "Field `FUNC7_IN_SEL` writer - set this value: s=0-56: connect GPIO\\[s\\] to this port. s=0x3F: set this port always high level. s=0x3E: set this port always low level."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC7_IN_SEL_CFG")
            ...
            .field(
                "func7_in_inv_sel",
                &format_args!("{}", self.func7_in_inv_sel().bit()),
            )
            .field("sig7_in_sel", &format_args!("{}", self.sig7_in_sel().bit()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<FUNC7_IN_SEL_CFG_SPEC> {
...
#[doc = "`reset()` method sets FUNC7_IN_SEL_CFG to value 0x3f"]
