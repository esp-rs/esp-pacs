...
///Field `DATA_ORIG` reader - GPIO output register for GPIO32-56
pub type DATA_ORIG_R = crate::FieldReader<u32>;
///Field `DATA_ORIG` writer - GPIO output register for GPIO32-56
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
    ///Bits 0:24 - GPIO output register for GPIO32-56
    #[inline(always)]
