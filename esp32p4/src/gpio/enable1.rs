...
///Field `DATA` reader - GPIO output enable register for GPIO32-56
pub type DATA_R = crate::FieldReader<u32>;
///Field `DATA` writer - GPIO output enable register for GPIO32-56
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
    ///Bits 0:24 - GPIO output enable register for GPIO32-56
    #[inline(always)]
