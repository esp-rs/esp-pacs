...
pub type R = crate::R<FUNC21_IN_SEL_CFG_SPEC>;
#[doc = "Register `FUNC21_IN_SEL_CFG` writer"]
pub type W = crate::W<FUNC21_IN_SEL_CFG_SPEC>;
#[doc = "Field `FUNC21_IN_SEL` reader - set this value: s=0-56: connect GPIO\\[s\\] to this port. s=0x3F: set this port always high level. s=0x3E: set this port always low level."]
pub type FUNC21_IN_SEL_R = crate::FieldReader;
#[doc = "Field `FUNC21_IN_SEL` writer - set this value: s=0-56: connect GPIO\\[s\\] to this port. s=0x3F: set this port always high level. s=0x3E: set this port always low level."]
pub type FUNC21_IN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `FUNC21_IN_INV_SEL` reader - set this bit to invert input signal. 1:invert. 0:not invert."]
pub type FUNC21_IN_INV_SEL_R = crate::BitReader;
#[doc = "Field `FUNC21_IN_INV_SEL` writer - set this bit to invert input signal. 1:invert. 0:not invert."]
pub type FUNC21_IN_INV_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SIG21_IN_SEL` reader - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
pub type SIG21_IN_SEL_R = crate::BitReader;
#[doc = "Field `SIG21_IN_SEL` writer - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
pub type SIG21_IN_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    pub fn func21_in_sel(&self) -> FUNC21_IN_SEL_R {
        FUNC21_IN_SEL_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bit 6 - set this bit to invert input signal. 1:invert. 0:not invert."]
    #[inline(always)]
    pub fn func21_in_inv_sel(&self) -> FUNC21_IN_INV_SEL_R {
        FUNC21_IN_INV_SEL_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
    #[inline(always)]
    pub fn sig21_in_sel(&self) -> SIG21_IN_SEL_R {
        SIG21_IN_SEL_R::new(((self.bits >> 7) & 1) != 0)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC21_IN_SEL_CFG")
            .field(
                "func21_in_sel",
                &format_args!("{}", self.func21_in_sel().bits()),
            )
            .field(
                "func21_in_inv_sel",
                &format_args!("{}", self.func21_in_inv_sel().bit()),
            )
            .field(
                "sig21_in_sel",
                &format_args!("{}", self.sig21_in_sel().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<FUNC21_IN_SEL_CFG_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func21_in_sel(&mut self) -> FUNC21_IN_SEL_W<FUNC21_IN_SEL_CFG_SPEC> {
        FUNC21_IN_SEL_W::new(self, 0)
    }
    #[doc = "Bit 6 - set this bit to invert input signal. 1:invert. 0:not invert."]
    #[inline(always)]
    #[must_use]
    pub fn func21_in_inv_sel(&mut self) -> FUNC21_IN_INV_SEL_W<FUNC21_IN_SEL_CFG_SPEC> {
        FUNC21_IN_INV_SEL_W::new(self, 6)
    }
    #[doc = "Bit 7 - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
    #[inline(always)]
    #[must_use]
    pub fn sig21_in_sel(&mut self) -> SIG21_IN_SEL_W<FUNC21_IN_SEL_CFG_SPEC> {
        SIG21_IN_SEL_W::new(self, 7)
    }
...
#[doc = "`reset()` method sets FUNC21_IN_SEL_CFG to value 0x3e"]
