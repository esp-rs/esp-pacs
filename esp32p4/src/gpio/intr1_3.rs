///Register `INTR1_3` reader
pub type R = crate::R<INTR1_3_SPEC>;
///Field `INT1_3` reader - GPIO interrupt 3 status register for GPIO32-56
pub type INT1_3_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:24 - GPIO interrupt 3 status register for GPIO32-56
    #[inline(always)]
...
///`read()` method returns [`intr1_3::R`](R) reader structure
