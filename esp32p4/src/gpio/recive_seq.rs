///Register `RECIVE_SEQ` reader
pub type R = crate::R<RECIVE_SEQ_SPEC>;
///Field `RECIVE_SEQ` reader - High speed sdio pad bist recive sequence
pub type RECIVE_SEQ_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - High speed sdio pad bist recive sequence
    #[inline(always)]
...
///`read()` method returns [`recive_seq::R`](R) reader structure
