///Register `ZERO_DET1_FILTER_CNT` reader
pub type R = crate::R<ZERO_DET1_FILTER_CNT_SPEC>;
///Register `ZERO_DET1_FILTER_CNT` writer
pub type W = crate::W<ZERO_DET1_FILTER_CNT_SPEC>;
///Field `ZERO_DET1_FILTER_CNT` reader - GPIO analog comparator zero detect filter count
pub type ZERO_DET1_FILTER_CNT_R = crate::FieldReader<u32>;
///Field `ZERO_DET1_FILTER_CNT` writer - GPIO analog comparator zero detect filter count
...
///`read()` method returns [`zero_det1_filter_cnt::R`](R) reader structure
impl crate::Readable for ZERO_DET1_FILTER_CNT_SPEC {}
///`write(|w| ..)` method takes [`zero_det1_filter_cnt::W`](W) writer structure
