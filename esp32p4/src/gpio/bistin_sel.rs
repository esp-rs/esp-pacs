///Register `BISTIN_SEL` reader
pub type R = crate::R<BISTIN_SEL_SPEC>;
///Register `BISTIN_SEL` writer
pub type W = crate::W<BISTIN_SEL_SPEC>;
///Field `BISTIN_SEL` reader - High speed sdio pad bist in pad sel 0:pad39, 1: pad40...
pub type BISTIN_SEL_R = crate::FieldReader;
///Field `BISTIN_SEL` writer - High speed sdio pad bist in pad sel 0:pad39, 1: pad40...
pub type BISTIN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bits 0:3 - High speed sdio pad bist in pad sel 0:pad39, 1: pad40...
    #[inline(always)]
...
///`read()` method returns [`bistin_sel::R`](R) reader structure
impl crate::Readable for BISTIN_SEL_SPEC {}
///`write(|w| ..)` method takes [`bistin_sel::W`](W) writer structure
