...
#[doc = "Field `FUNC35_IN_SEL` reader - set this value: s=0-56: connect GPIO\\[s\\] to this port. s=0x3F: set this port always high level. s=0x3E: set this port always low level."]
pub type FUNC35_IN_SEL_R = crate::FieldReader;
#[doc = "Field `FUNC35_IN_SEL` writer - set this value: s=0-56: connect GPIO\\[s\\] to this port. s=0x3F: set this port always high level. s=0x3E: set this port always low level."]
pub type FUNC35_IN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC35_IN_SEL_CFG")
            .field(
                "func35_in_sel",
                &format_args!("{}", self.func35_in_sel().bits()),
            )
            .field(
                "func35_in_inv_sel",
                &format_args!("{}", self.func35_in_inv_sel().bit()),
            )
            .field(
                "sig35_in_sel",
                &format_args!("{}", self.sig35_in_sel().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<FUNC35_IN_SEL_CFG_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func35_in_sel(&mut self) -> FUNC35_IN_SEL_W<FUNC35_IN_SEL_CFG_SPEC> {
        FUNC35_IN_SEL_W::new(self, 0)
    }
    #[doc = "Bit 6 - set this bit to invert input signal. 1:invert. 0:not invert."]
    #[inline(always)]
    #[must_use]
    pub fn func35_in_inv_sel(&mut self) -> FUNC35_IN_INV_SEL_W<FUNC35_IN_SEL_CFG_SPEC> {
        FUNC35_IN_INV_SEL_W::new(self, 6)
    }
    #[doc = "Bit 7 - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
    #[inline(always)]
    #[must_use]
    pub fn sig35_in_sel(&mut self) -> SIG35_IN_SEL_W<FUNC35_IN_SEL_CFG_SPEC> {
        SIG35_IN_SEL_W::new(self, 7)
    }
...
#[doc = "`reset()` method sets FUNC35_IN_SEL_CFG to value 0x3e"]
