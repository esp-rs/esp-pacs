...
///Field `COMP0_NEG` reader - analog comparator pos edge interrupt status
pub type COMP0_NEG_R = crate::BitReader;
///Field `COMP0_POS` reader - analog comparator neg edge interrupt status
pub type COMP0_POS_R = crate::BitReader;
///Field `COMP0_ALL` reader - analog comparator neg or pos edge interrupt status
pub type COMP0_ALL_R = crate::BitReader;
///Field `COMP1_NEG` reader - analog comparator pos edge interrupt status
pub type COMP1_NEG_R = crate::BitReader;
///Field `COMP1_POS` reader - analog comparator neg edge interrupt status
pub type COMP1_POS_R = crate::BitReader;
///Field `COMP1_ALL` reader - analog comparator neg or pos edge interrupt status
pub type COMP1_ALL_R = crate::BitReader;
///Field `BISTOK` reader - pad bistok interrupt status
pub type BISTOK_R = crate::BitReader;
///Field `BISTFAIL` reader - pad bistfail interrupt status
pub type BISTFAIL_R = crate::BitReader;
impl R {
    ///Bit 0 - analog comparator pos edge interrupt status
    #[inline(always)]
    pub fn comp0_neg(&self) -> COMP0_NEG_R {
        COMP0_NEG_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - analog comparator neg edge interrupt status
    #[inline(always)]
    pub fn comp0_pos(&self) -> COMP0_POS_R {
        COMP0_POS_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - analog comparator neg or pos edge interrupt status
    #[inline(always)]
    pub fn comp0_all(&self) -> COMP0_ALL_R {
        COMP0_ALL_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - analog comparator pos edge interrupt status
    #[inline(always)]
    pub fn comp1_neg(&self) -> COMP1_NEG_R {
        COMP1_NEG_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - analog comparator neg edge interrupt status
    #[inline(always)]
    pub fn comp1_pos(&self) -> COMP1_POS_R {
        COMP1_POS_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - analog comparator neg or pos edge interrupt status
    #[inline(always)]
    pub fn comp1_all(&self) -> COMP1_ALL_R {
        COMP1_ALL_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - pad bistok interrupt status
    #[inline(always)]
    pub fn bistok(&self) -> BISTOK_R {
        BISTOK_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - pad bistfail interrupt status
    #[inline(always)]
