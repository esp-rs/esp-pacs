...
///Field `STATUS1_W1TC` writer - GPIO interrupt status clear register for GPIO32-56
pub type STATUS1_W1TC_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
...
impl W {
    ///Bits 0:24 - GPIO interrupt status clear register for GPIO32-56
    #[inline(always)]
    #[must_use]
