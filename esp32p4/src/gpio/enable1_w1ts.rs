...
///Field `ENABLE1_W1TS` writer - GPIO output enable set register for GPIO32-56
pub type ENABLE1_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
...
impl W {
    ///Bits 0:24 - GPIO output enable set register for GPIO32-56
    #[inline(always)]
    #[must_use]
