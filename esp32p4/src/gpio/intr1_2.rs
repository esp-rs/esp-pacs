///Register `INTR1_2` reader
pub type R = crate::R<INTR1_2_SPEC>;
///Field `INT1_2` reader - GPIO interrupt 2 status register for GPIO32-56
pub type INT1_2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:24 - GPIO interrupt 2 status register for GPIO32-56
    #[inline(always)]
...
///`read()` method returns [`intr1_2::R`](R) reader structure
