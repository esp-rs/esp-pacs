...
#[doc = "Field `FUNC63_IN_SEL` reader - set this value: s=0-56: connect GPIO\\[s\\] to this port. s=0x3F: set this port always high level. s=0x3E: set this port always low level."]
pub type FUNC63_IN_SEL_R = crate::FieldReader;
#[doc = "Field `FUNC63_IN_SEL` writer - set this value: s=0-56: connect GPIO\\[s\\] to this port. s=0x3F: set this port always high level. s=0x3E: set this port always low level."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC63_IN_SEL_CFG")
            .field(
                "func63_in_sel",
                &format_args!("{}", self.func63_in_sel().bits()),
            )
            .field(
                "func63_in_inv_sel",
                &format_args!("{}", self.func63_in_inv_sel().bit()),
            )
            .field(
                "sig63_in_sel",
                &format_args!("{}", self.sig63_in_sel().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<FUNC63_IN_SEL_CFG_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func63_in_sel(&mut self) -> FUNC63_IN_SEL_W<FUNC63_IN_SEL_CFG_SPEC> {
        FUNC63_IN_SEL_W::new(self, 0)
    }
    #[doc = "Bit 6 - set this bit to invert input signal. 1:invert. 0:not invert."]
    #[inline(always)]
    #[must_use]
    pub fn func63_in_inv_sel(&mut self) -> FUNC63_IN_INV_SEL_W<FUNC63_IN_SEL_CFG_SPEC> {
        FUNC63_IN_INV_SEL_W::new(self, 6)
    }
    #[doc = "Bit 7 - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
    #[inline(always)]
    #[must_use]
    pub fn sig63_in_sel(&mut self) -> SIG63_IN_SEL_W<FUNC63_IN_SEL_CFG_SPEC> {
...
#[doc = "`reset()` method sets FUNC63_IN_SEL_CFG to value 0x3e"]
