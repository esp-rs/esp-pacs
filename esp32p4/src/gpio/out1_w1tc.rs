...
///Field `OUT1_W1TC` writer - GPIO output clear register for GPIO32-56
pub type OUT1_W1TC_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
...
impl W {
    ///Bits 0:24 - GPIO output clear register for GPIO32-56
    #[inline(always)]
    #[must_use]
