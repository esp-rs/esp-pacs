...
///Field `COMP0_NEG` reader - analog comparator pos edge interrupt enable
pub type COMP0_NEG_R = crate::BitReader;
///Field `COMP0_NEG` writer - analog comparator pos edge interrupt enable
pub type COMP0_NEG_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COMP0_POS` reader - analog comparator neg edge interrupt enable
pub type COMP0_POS_R = crate::BitReader;
///Field `COMP0_POS` writer - analog comparator neg edge interrupt enable
pub type COMP0_POS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COMP0_ALL` reader - analog comparator neg or pos edge interrupt enable
pub type COMP0_ALL_R = crate::BitReader;
///Field `COMP0_ALL` writer - analog comparator neg or pos edge interrupt enable
pub type COMP0_ALL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COMP1_NEG` reader - analog comparator pos edge interrupt enable
pub type COMP1_NEG_R = crate::BitReader;
///Field `COMP1_NEG` writer - analog comparator pos edge interrupt enable
pub type COMP1_NEG_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COMP1_POS` reader - analog comparator neg edge interrupt enable
pub type COMP1_POS_R = crate::BitReader;
///Field `COMP1_POS` writer - analog comparator neg edge interrupt enable
pub type COMP1_POS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COMP1_ALL` reader - analog comparator neg or pos edge interrupt enable
pub type COMP1_ALL_R = crate::BitReader;
///Field `COMP1_ALL` writer - analog comparator neg or pos edge interrupt enable
pub type COMP1_ALL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BISTOK` reader - pad bistok interrupt enable
...
///Field `BISTFAIL` reader - pad bistfail interrupt enable
