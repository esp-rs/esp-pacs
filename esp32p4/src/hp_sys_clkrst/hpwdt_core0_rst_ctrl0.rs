...
///`read()` method returns [`hpwdt_core0_rst_ctrl0::R`](R) reader structure
impl crate::Readable for HPWDT_CORE0_RST_CTRL0_SPEC {}
///`write(|w| ..)` method takes [`hpwdt_core0_rst_ctrl0::W`](W) writer structure
