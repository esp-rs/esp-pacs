...
///`read()` method returns [`soc_clk_ctrl3::R`](R) reader structure
impl crate::Readable for SOC_CLK_CTRL3_SPEC {}
///`write(|w| ..)` method takes [`soc_clk_ctrl3::W`](W) writer structure
