...
///`read()` method returns [`peri_clk_ctrl22::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL22_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl22::W`](W) writer structure
