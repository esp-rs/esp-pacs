...
///`read()` method returns [`peri_clk_ctrl25::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL25_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl25::W`](W) writer structure
