...
///`read()` method returns [`peri_clk_ctrl10::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL10_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl10::W`](W) writer structure
