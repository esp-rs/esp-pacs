...
///`read()` method returns [`peri_clk_ctrl111::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL111_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl111::W`](W) writer structure
