...
///`read()` method returns [`ref_clk_ctrl2::R`](R) reader structure
impl crate::Readable for REF_CLK_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`ref_clk_ctrl2::W`](W) writer structure
