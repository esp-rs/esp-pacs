...
impl W {
    #[doc = "Bits 0:7 - Reserved"]
    #[inline(always)]
    pub fn uart3_sclk_div_num(&mut self) -> UART3_SCLK_DIV_NUM_W<'_, PERI_CLK_CTRL114_SPEC> {
    ...
    pub fn uart3_sclk_div_numerator(
        &mut self,
    ) -> UART3_SCLK_DIV_NUMERATOR_W<'_, PERI_CLK_CTRL114_SPEC> {
    ...
    pub fn uart3_sclk_div_denominator(
        &mut self,
    ) -> UART3_SCLK_DIV_DENOMINATOR_W<'_, PERI_CLK_CTRL114_SPEC> {
        UART3_SCLK_DIV_DENOMINATOR_W::new(self, 16)
    }
    #[doc = "Bits 24:25 - Reserved"]
    #[inline(always)]
    pub fn uart4_clk_src_sel(&mut self) -> UART4_CLK_SRC_SEL_W<'_, PERI_CLK_CTRL114_SPEC> {
        UART4_CLK_SRC_SEL_W::new(self, 24)
    }
    #[doc = "Bit 26 - Reserved"]
    #[inline(always)]
    pub fn uart4_clk_en(&mut self) -> UART4_CLK_EN_W<'_, PERI_CLK_CTRL114_SPEC> {
