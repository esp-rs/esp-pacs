...
///`read()` method returns [`peri_clk_ctrl18::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL18_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl18::W`](W) writer structure
