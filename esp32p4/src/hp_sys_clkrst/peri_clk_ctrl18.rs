...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PERI_CLK_CTRL18")
            .field("i2s2_rx_div_y", &self.i2s2_rx_div_y())
            .field("i2s2_rx_div_z", &self.i2s2_rx_div_z())
            .field("i2s2_rx_div_yn1", &self.i2s2_rx_div_yn1())
            .field("i2s2_tx_clk_en", &self.i2s2_tx_clk_en())
            .field("i2s2_tx_clk_src_sel", &self.i2s2_tx_clk_src_sel())
            .field("i2s2_tx_div_n", &self.i2s2_tx_div_n())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:8 - Reserved"]
    #[inline(always)]
    pub fn i2s2_rx_div_y(&mut self) -> I2S2_RX_DIV_Y_W<'_, PERI_CLK_CTRL18_SPEC> {
        I2S2_RX_DIV_Y_W::new(self, 0)
    }
    #[doc = "Bits 9:17 - Reserved"]
    #[inline(always)]
    pub fn i2s2_rx_div_z(&mut self) -> I2S2_RX_DIV_Z_W<'_, PERI_CLK_CTRL18_SPEC> {
        I2S2_RX_DIV_Z_W::new(self, 9)
    }
    #[doc = "Bit 18 - Reserved"]
    #[inline(always)]
    pub fn i2s2_rx_div_yn1(&mut self) -> I2S2_RX_DIV_YN1_W<'_, PERI_CLK_CTRL18_SPEC> {
        I2S2_RX_DIV_YN1_W::new(self, 18)
    }
    #[doc = "Bit 19 - Reserved"]
    #[inline(always)]
    pub fn i2s2_tx_clk_en(&mut self) -> I2S2_TX_CLK_EN_W<'_, PERI_CLK_CTRL18_SPEC> {
        I2S2_TX_CLK_EN_W::new(self, 19)
    }
    #[doc = "Bits 20:21 - Reserved"]
    #[inline(always)]
    pub fn i2s2_tx_clk_src_sel(&mut self) -> I2S2_TX_CLK_SRC_SEL_W<'_, PERI_CLK_CTRL18_SPEC> {
        I2S2_TX_CLK_SRC_SEL_W::new(self, 20)
    }
    #[doc = "Bits 22:29 - Reserved"]
    #[inline(always)]
    pub fn i2s2_tx_div_n(&mut self) -> I2S2_TX_DIV_N_W<'_, PERI_CLK_CTRL18_SPEC> {
        I2S2_TX_DIV_N_W::new(self, 22)
    }
}
#[doc = "Reserved\n\nYou can [`read`](crate::Reg::read) this register and get [`peri_clk_ctrl18::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`peri_clk_ctrl18::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
