...
///`read()` method returns [`peri_clk_ctrl13::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL13_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl13::W`](W) writer structure
