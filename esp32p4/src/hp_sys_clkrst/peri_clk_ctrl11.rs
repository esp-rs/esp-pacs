...
///`read()` method returns [`peri_clk_ctrl11::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL11_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl11::W`](W) writer structure
