...
impl W {
    #[doc = "Bits 0:7 - Reserved"]
    #[inline(always)]
    pub fn i2c1_clk_div_num(&mut self) -> I2C1_CLK_DIV_NUM_W<'_, PERI_CLK_CTRL11_SPEC> {
        I2C1_CLK_DIV_NUM_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Reserved"]
    #[inline(always)]
    pub fn i2c1_clk_div_numerator(&mut self) -> I2C1_CLK_DIV_NUMERATOR_W<'_, PERI_CLK_CTRL11_SPEC> {
        I2C1_CLK_DIV_NUMERATOR_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Reserved"]
    #[inline(always)]
    pub fn i2c1_clk_div_denominator(
        &mut self,
    ) -> I2C1_CLK_DIV_DENOMINATOR_W<'_, PERI_CLK_CTRL11_SPEC> {
        I2C1_CLK_DIV_DENOMINATOR_W::new(self, 16)
    }
    #[doc = "Bit 24 - Reserved"]
    #[inline(always)]
    pub fn i2s0_rx_clk_en(&mut self) -> I2S0_RX_CLK_EN_W<'_, PERI_CLK_CTRL11_SPEC> {
        I2S0_RX_CLK_EN_W::new(self, 24)
    }
    #[doc = "Bits 25:26 - Reserved"]
    #[inline(always)]
    pub fn i2s0_rx_clk_src_sel(&mut self) -> I2S0_RX_CLK_SRC_SEL_W<'_, PERI_CLK_CTRL11_SPEC> {
