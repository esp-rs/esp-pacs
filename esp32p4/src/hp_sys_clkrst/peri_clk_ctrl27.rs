...
///`read()` method returns [`peri_clk_ctrl27::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL27_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl27::W`](W) writer structure
