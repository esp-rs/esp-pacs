...
///`read()` method returns [`peri_clk_ctrl116::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL116_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl116::W`](W) writer structure
