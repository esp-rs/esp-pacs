...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SOC_CLK_CTRL1")
            ...
            .field("regdma_sys_clk_en", &self.regdma_sys_clk_en())
            ...
            .field("dma2d_sys_clk_en", &self.dma2d_sys_clk_en())
            .field("vpu_sys_clk_en", &self.vpu_sys_clk_en())
            .field("jpeg_sys_clk_en", &self.jpeg_sys_clk_en())
            .field("ppa_sys_clk_en", &self.ppa_sys_clk_en())
            .field("csi_brg_sys_clk_en", &self.csi_brg_sys_clk_en())
            .field("csi_host_sys_clk_en", &self.csi_host_sys_clk_en())
            .field("dsi_sys_clk_en", &self.dsi_sys_clk_en())
            .field("emac_sys_clk_en", &self.emac_sys_clk_en())
            .field("sdmmc_sys_clk_en", &self.sdmmc_sys_clk_en())
            .field("usb_otg11_sys_clk_en", &self.usb_otg11_sys_clk_en())
            .field("usb_otg20_sys_clk_en", &self.usb_otg20_sys_clk_en())
            .field("uhci_sys_clk_en", &self.uhci_sys_clk_en())
            .field("uart0_sys_clk_en", &self.uart0_sys_clk_en())
            .field("uart1_sys_clk_en", &self.uart1_sys_clk_en())
            .field("uart2_sys_clk_en", &self.uart2_sys_clk_en())
            .field("uart3_sys_clk_en", &self.uart3_sys_clk_en())
            .field("uart4_sys_clk_en", &self.uart4_sys_clk_en())
            .field("parlio_sys_clk_en", &self.parlio_sys_clk_en())
            .field("etm_sys_clk_en", &self.etm_sys_clk_en())
            .field("pvt_sys_clk_en", &self.pvt_sys_clk_en())
...
///`read()` method returns [`soc_clk_ctrl1::R`](R) reader structure
impl crate::Readable for SOC_CLK_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`soc_clk_ctrl1::W`](W) writer structure
