...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PERI_CLK_CTRL14")
            .field(
                "i2s0_tx_div_y",
                &format_args!("{}", self.i2s0_tx_div_y().bits()),
            )
            .field(
                "i2s0_tx_div_z",
                &format_args!("{}", self.i2s0_tx_div_z().bits()),
            )
            .field(
                "i2s0_tx_div_yn1",
                &format_args!("{}", self.i2s0_tx_div_yn1().bit()),
            )
            .field(
                "i2s0_mst_clk_sel",
                &format_args!("{}", self.i2s0_mst_clk_sel().bit()),
            )
            .field(
                "i2s1_rx_clk_en",
                &format_args!("{}", self.i2s1_rx_clk_en().bit()),
            )
            .field(
                "i2s1_rx_clk_src_sel",
                &format_args!("{}", self.i2s1_rx_clk_src_sel().bits()),
            )
            .field(
                "i2s1_rx_div_n",
                &format_args!("{}", self.i2s1_rx_div_n().bits()),
            )
            .finish()
    }
}
