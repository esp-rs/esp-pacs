...
///`read()` method returns [`dbg_clk_ctrl1::R`](R) reader structure
impl crate::Readable for DBG_CLK_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`dbg_clk_ctrl1::W`](W) writer structure
