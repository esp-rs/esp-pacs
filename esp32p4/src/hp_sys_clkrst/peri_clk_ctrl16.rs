...
impl W {
    #[doc = "Bits 0:7 - Reserved"]
    #[inline(always)]
    pub fn i2s1_tx_div_n(&mut self) -> I2S1_TX_DIV_N_W<'_, PERI_CLK_CTRL16_SPEC> {
        I2S1_TX_DIV_N_W::new(self, 0)
    }
    #[doc = "Bits 8:16 - Reserved"]
    #[inline(always)]
    pub fn i2s1_tx_div_x(&mut self) -> I2S1_TX_DIV_X_W<'_, PERI_CLK_CTRL16_SPEC> {
        I2S1_TX_DIV_X_W::new(self, 8)
    }
    #[doc = "Bits 17:25 - Reserved"]
    #[inline(always)]
    pub fn i2s1_tx_div_y(&mut self) -> I2S1_TX_DIV_Y_W<'_, PERI_CLK_CTRL16_SPEC> {
        I2S1_TX_DIV_Y_W::new(self, 17)
    }
}
#[doc = "Reserved\n\nYou can [`read`](crate::Reg::read) this register and get [`peri_clk_ctrl16::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`peri_clk_ctrl16::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
