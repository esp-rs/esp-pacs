...
///`read()` method returns [`peri_clk_ctrl120::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL120_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl120::W`](W) writer structure
