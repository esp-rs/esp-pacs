...
///`read()` method returns [`ref_clk_ctrl0::R`](R) reader structure
impl crate::Readable for REF_CLK_CTRL0_SPEC {}
///`write(|w| ..)` method takes [`ref_clk_ctrl0::W`](W) writer structure
