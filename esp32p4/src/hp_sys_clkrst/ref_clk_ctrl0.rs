...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REF_CLK_CTRL0")
            ...
            .field("ref_240m_clk_div_num", &self.ref_240m_clk_div_num())
...
impl W {
    #[doc = "Bits 0:7 - Reserved"]
    #[inline(always)]
    pub fn ref_50m_clk_div_num(&mut self) -> REF_50M_CLK_DIV_NUM_W<'_, REF_CLK_CTRL0_SPEC> {
        REF_50M_CLK_DIV_NUM_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Reserved"]
    #[inline(always)]
    pub fn ref_25m_clk_div_num(&mut self) -> REF_25M_CLK_DIV_NUM_W<'_, REF_CLK_CTRL0_SPEC> {
        REF_25M_CLK_DIV_NUM_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Reserved"]
    #[inline(always)]
    pub fn ref_240m_clk_div_num(&mut self) -> REF_240M_CLK_DIV_NUM_W<'_, REF_CLK_CTRL0_SPEC> {
        REF_240M_CLK_DIV_NUM_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Reserved"]
    #[inline(always)]
    pub fn ref_160m_clk_div_num(&mut self) -> REF_160M_CLK_DIV_NUM_W<'_, REF_CLK_CTRL0_SPEC> {
        REF_160M_CLK_DIV_NUM_W::new(self, 24)
    }
}
#[doc = "Reserved\n\nYou can [`read`](crate::Reg::read) this register and get [`ref_clk_ctrl0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ref_clk_ctrl0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
