...
///`read()` method returns [`root_clk_ctrl2::R`](R) reader structure
impl crate::Readable for ROOT_CLK_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`root_clk_ctrl2::W`](W) writer structure
