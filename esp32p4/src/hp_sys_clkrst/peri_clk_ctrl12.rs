...
///`read()` method returns [`peri_clk_ctrl12::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL12_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl12::W`](W) writer structure
