...
///`read()` method returns [`peri_clk_ctrl20::R`](R) reader structure
impl crate::Readable for PERI_CLK_CTRL20_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_ctrl20::W`](W) writer structure
