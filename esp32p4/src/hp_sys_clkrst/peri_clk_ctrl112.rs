...
impl W {
    #[doc = "Bits 0:7 - Reserved"]
    #[inline(always)]
    pub fn uart1_sclk_div_num(&mut self) -> UART1_SCLK_DIV_NUM_W<'_, PERI_CLK_CTRL112_SPEC> {
    ...
    pub fn uart1_sclk_div_numerator(
        &mut self,
    ) -> UART1_SCLK_DIV_NUMERATOR_W<'_, PERI_CLK_CTRL112_SPEC> {
    ...
    pub fn uart1_sclk_div_denominator(
        &mut self,
    ) -> UART1_SCLK_DIV_DENOMINATOR_W<'_, PERI_CLK_CTRL112_SPEC> {
        UART1_SCLK_DIV_DENOMINATOR_W::new(self, 16)
    }
    #[doc = "Bits 24:25 - Reserved"]
    #[inline(always)]
    pub fn uart2_clk_src_sel(&mut self) -> UART2_CLK_SRC_SEL_W<'_, PERI_CLK_CTRL112_SPEC> {
        UART2_CLK_SRC_SEL_W::new(self, 24)
    }
    #[doc = "Bit 26 - Reserved"]
    #[inline(always)]
    pub fn uart2_clk_en(&mut self) -> UART2_CLK_EN_W<'_, PERI_CLK_CTRL112_SPEC> {
