///Register `CPU_SRC_FREQ0` reader
pub type R = crate::R<CPU_SRC_FREQ0_SPEC>;
///Field `CPU_SRC_FREQ` reader - cpu source clock frequency, step by 0.25MHz
pub type CPU_SRC_FREQ_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - cpu source clock frequency, step by 0.25MHz
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CPU_SRC_FREQ0")
            .field("cpu_src_freq", &self.cpu_src_freq())
            .finish()
    }
}
...
///`read()` method returns [`cpu_src_freq0::R`](R) reader structure
