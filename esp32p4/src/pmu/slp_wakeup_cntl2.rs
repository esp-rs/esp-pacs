///Register `SLP_WAKEUP_CNTL2` reader
pub type R = crate::R<SLP_WAKEUP_CNTL2_SPEC>;
///Register `SLP_WAKEUP_CNTL2` writer
pub type W = crate::W<SLP_WAKEUP_CNTL2_SPEC>;
///Field `WAKEUP_ENA` reader - need_des
pub type WAKEUP_ENA_R = crate::FieldReader<u32>;
///Field `WAKEUP_ENA` writer - need_des
...
///`read()` method returns [`slp_wakeup_cntl2::R`](R) reader structure
impl crate::Readable for SLP_WAKEUP_CNTL2_SPEC {}
///`write(|w| ..)` method takes [`slp_wakeup_cntl2::W`](W) writer structure
