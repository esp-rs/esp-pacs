///Register `POWER_PD_TOP_MASK` reader
pub type R = crate::R<POWER_PD_TOP_MASK_SPEC>;
///Register `POWER_PD_TOP_MASK` writer
pub type W = crate::W<POWER_PD_TOP_MASK_SPEC>;
///Field `XPD_TOP_MASK` reader - need_des
pub type XPD_TOP_MASK_R = crate::FieldReader;
///Field `XPD_TOP_MASK` writer - need_des
...
///`read()` method returns [`power_pd_top_mask::R`](R) reader structure
impl crate::Readable for POWER_PD_TOP_MASK_SPEC {}
///`write(|w| ..)` method takes [`power_pd_top_mask::W`](W) writer structure
