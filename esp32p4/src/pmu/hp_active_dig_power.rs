...
///Field `HP_ACTIVE_DCDC_SWITCH_PD_EN` reader - need_des
pub type HP_ACTIVE_DCDC_SWITCH_PD_EN_R = crate::BitReader;
///Field `HP_ACTIVE_DCDC_SWITCH_PD_EN` writer - need_des
...
///Field `HP_ACTIVE_PD_CNNT_PD_EN` reader - need_des
pub type HP_ACTIVE_PD_CNNT_PD_EN_R = crate::BitReader;
///Field `HP_ACTIVE_PD_CNNT_PD_EN` writer - need_des
...
impl W {
    ...
    pub fn hp_active_dcdc_switch_pd_en(
        &mut self,
    ) -> HP_ACTIVE_DCDC_SWITCH_PD_EN_W<HP_ACTIVE_DIG_POWER_SPEC> {
    ...
    pub fn hp_active_pd_cnnt_pd_en(
        &mut self,
    ) -> HP_ACTIVE_PD_CNNT_PD_EN_W<HP_ACTIVE_DIG_POWER_SPEC> {
