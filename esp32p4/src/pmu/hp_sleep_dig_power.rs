...
///Field `HP_SLEEP_DCDC_SWITCH_PD_EN` reader - need_des
pub type HP_SLEEP_DCDC_SWITCH_PD_EN_R = crate::BitReader;
///Field `HP_SLEEP_DCDC_SWITCH_PD_EN` writer - need_des
...
///Field `HP_SLEEP_PD_CNNT_PD_EN` reader - need_des
pub type HP_SLEEP_PD_CNNT_PD_EN_R = crate::BitReader;
///Field `HP_SLEEP_PD_CNNT_PD_EN` writer - need_des
