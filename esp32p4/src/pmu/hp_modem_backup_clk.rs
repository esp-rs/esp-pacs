///Register `HP_MODEM_BACKUP_CLK` writer
pub type W = crate::W<HP_MODEM_BACKUP_CLK_SPEC>;
///Field `HP_MODEM_BACKUP_ICG_FUNC_EN` writer - need_des
...
You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hp_modem_backup_clk::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct HP_MODEM_BACKUP_CLK_SPEC;
impl crate::RegisterSpec for HP_MODEM_BACKUP_CLK_SPEC {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`hp_modem_backup_clk::W`](W) writer structure
