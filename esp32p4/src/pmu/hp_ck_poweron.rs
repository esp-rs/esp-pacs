///Register `HP_CK_POWERON` reader
pub type R = crate::R<HP_CK_POWERON_SPEC>;
///Register `HP_CK_POWERON` writer
pub type W = crate::W<HP_CK_POWERON_SPEC>;
///Field `I2C_POR_WAIT_TARGET` reader - need_des
pub type I2C_POR_WAIT_TARGET_R = crate::FieldReader;
///Field `I2C_POR_WAIT_TARGET` writer - need_des
...
///`read()` method returns [`hp_ck_poweron::R`](R) reader structure
impl crate::Readable for HP_CK_POWERON_SPEC {}
///`write(|w| ..)` method takes [`hp_ck_poweron::W`](W) writer structure
