...
///`read()` method returns [`ext_ldo_p1_0p3a_ana::R`](R) reader structure
impl crate::Readable for EXT_LDO_P1_0P3A_ANA_SPEC {}
///`write(|w| ..)` method takes [`ext_ldo_p1_0p3a_ana::W`](W) writer structure
