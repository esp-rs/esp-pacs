    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EXT_LDO_P0_0P2A")
            .field(
                ...
                &self._0p2a_force_tieh_sel_0().bit(),
            )
            .field("_0p2a_xpd_0", &self._0p2a_xpd_0().bit())
            .field("_0p2a_tieh_sel_0", &self._0p2a_tieh_sel_0().bits())
            .field("_0p2a_tieh_pos_en_0", &self._0p2a_tieh_pos_en_0().bit())
            .field("_0p2a_tieh_neg_en_0", &self._0p2a_tieh_neg_en_0().bit())
            .field("_0p2a_tieh_0", &self._0p2a_tieh_0().bit())
            .field("_0p2a_target1_0", &self._0p2a_target1_0().bits())
            .field("_0p2a_target0_0", &self._0p2a_target0_0().bits())
            .field(
                "_0p2a_ldo_cnt_prescaler_sel_0",
                &self._0p2a_ldo_cnt_prescaler_sel_0().bit(),
            )
            .finish()
    }
}
