...
///`read()` method returns [`ext_ldo_p0_0p1a_ana::R`](R) reader structure
impl crate::Readable for EXT_LDO_P0_0P1A_ANA_SPEC {}
///`write(|w| ..)` method takes [`ext_ldo_p0_0p1a_ana::W`](W) writer structure
