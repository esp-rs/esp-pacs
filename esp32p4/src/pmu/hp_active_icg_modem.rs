///Register `HP_ACTIVE_ICG_MODEM` reader
...
///Field `HP_ACTIVE_DIG_ICG_MODEM_CODE` reader - need_des
pub type HP_ACTIVE_DIG_ICG_MODEM_CODE_R = crate::FieldReader;
///Field `HP_ACTIVE_DIG_ICG_MODEM_CODE` writer - need_des
...
///`read()` method returns [`hp_active_icg_modem::R`](R) reader structure
impl crate::Readable for HP_ACTIVE_ICG_MODEM_SPEC {}
///`write(|w| ..)` method takes [`hp_active_icg_modem::W`](W) writer structure
