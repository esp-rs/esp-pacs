///Register `POWER_PD_HPMEM_CNTL` reader
pub type R = crate::R<POWER_PD_HPMEM_CNTL_SPEC>;
///Register `POWER_PD_HPMEM_CNTL` writer
pub type W = crate::W<POWER_PD_HPMEM_CNTL_SPEC>;
///Field `FORCE_HP_MEM_RESET` reader - need_des
pub type FORCE_HP_MEM_RESET_R = crate::BitReader;
///Field `FORCE_HP_MEM_RESET` writer - need_des
...
///Field `FORCE_HP_MEM_NO_RESET` reader - need_des
pub type FORCE_HP_MEM_NO_RESET_R = crate::BitReader;
///Field `FORCE_HP_MEM_NO_RESET` writer - need_des
...
///`read()` method returns [`power_pd_hpmem_cntl::R`](R) reader structure
impl crate::Readable for POWER_PD_HPMEM_CNTL_SPEC {}
///`write(|w| ..)` method takes [`power_pd_hpmem_cntl::W`](W) writer structure
