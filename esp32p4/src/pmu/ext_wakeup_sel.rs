///Register `EXT_WAKEUP_SEL` reader
pub type R = crate::R<EXT_WAKEUP_SEL_SPEC>;
///Register `EXT_WAKEUP_SEL` writer
...
///`read()` method returns [`ext_wakeup_sel::R`](R) reader structure
impl crate::Readable for EXT_WAKEUP_SEL_SPEC {}
///`write(|w| ..)` method takes [`ext_wakeup_sel::W`](W) writer structure
