///Register `EXT_WAKEUP_LV` reader
pub type R = crate::R<EXT_WAKEUP_LV_SPEC>;
///Register `EXT_WAKEUP_LV` writer
...
///`read()` method returns [`ext_wakeup_lv::R`](R) reader structure
impl crate::Readable for EXT_WAKEUP_LV_SPEC {}
///`write(|w| ..)` method takes [`ext_wakeup_lv::W`](W) writer structure
