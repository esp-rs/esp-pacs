///Register `LP_CPU_PWR4` reader
pub type R = crate::R<LP_CPU_PWR4_SPEC>;
///Register `LP_CPU_PWR4` writer
pub type W = crate::W<LP_CPU_PWR4_SPEC>;
///Field `LP_CPU_REJECT_EN` reader - need_des
pub type LP_CPU_REJECT_EN_R = crate::FieldReader<u32>;
///Field `LP_CPU_REJECT_EN` writer - need_des
...
///`read()` method returns [`lp_cpu_pwr4::R`](R) reader structure
impl crate::Readable for LP_CPU_PWR4_SPEC {}
///`write(|w| ..)` method takes [`lp_cpu_pwr4::W`](W) writer structure
