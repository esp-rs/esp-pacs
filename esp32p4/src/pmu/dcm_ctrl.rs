///Register `DCM_CTRL` reader
pub type R = crate::R<DCM_CTRL_SPEC>;
///Register `DCM_CTRL` writer
pub type W = crate::W<DCM_CTRL_SPEC>;
///Field `DCDC_ON_REQ` writer - SW trigger dcdc on
pub type DCDC_ON_REQ_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCDC_OFF_REQ` writer - SW trigger dcdc off
...
impl R {
    ...
    ///Bit 29 - Enable analog mux to pull PAD TEST_DCDC voltage signal
    #[inline(always)]
...
///`read()` method returns [`dcm_ctrl::R`](R) reader structure
impl crate::Readable for DCM_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dcm_ctrl::W`](W) writer structure
