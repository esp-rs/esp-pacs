    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_SLEEP_LP_DIG_POWER")
            .field(
                ...
                &self.lp_sleep_lp_pad_slp_sel().bit(),
            )
            .field(
                "lp_sleep_bod_source_sel",
                &self.lp_sleep_bod_source_sel().bit(),
            )
            .field("lp_sleep_vddbat_mode", &self.lp_sleep_vddbat_mode().bits())
...
impl W {
    ...
    pub fn lp_sleep_lp_pad_slp_sel(
        &mut self,
    ) -> LP_SLEEP_LP_PAD_SLP_SEL_W<LP_SLEEP_LP_DIG_POWER_SPEC> {
