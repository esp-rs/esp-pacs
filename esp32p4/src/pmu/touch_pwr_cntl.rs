...
///`read()` method returns [`touch_pwr_cntl::R`](R) reader structure
impl crate::Readable for TOUCH_PWR_CNTL_SPEC {}
///`write(|w| ..)` method takes [`touch_pwr_cntl::W`](W) writer structure
