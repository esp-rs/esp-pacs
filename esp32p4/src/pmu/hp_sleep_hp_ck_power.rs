...
///Field `HP_SLEEP_XPD_PLL_I2C` reader - need_des
pub type HP_SLEEP_XPD_PLL_I2C_R = crate::FieldReader;
///Field `HP_SLEEP_XPD_PLL_I2C` writer - need_des
pub type HP_SLEEP_XPD_PLL_I2C_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `HP_SLEEP_XPD_PLL` reader - need_des
pub type HP_SLEEP_XPD_PLL_R = crate::FieldReader;
///Field `HP_SLEEP_XPD_PLL` writer - need_des
