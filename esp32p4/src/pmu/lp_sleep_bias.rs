...
///`read()` method returns [`lp_sleep_bias::R`](R) reader structure
impl crate::Readable for LP_SLEEP_BIAS_SPEC {}
///`write(|w| ..)` method takes [`lp_sleep_bias::W`](W) writer structure
