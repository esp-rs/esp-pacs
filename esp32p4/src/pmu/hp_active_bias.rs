...
///Field `HP_ACTIVE_DCM_VSET` reader - need_des
pub type HP_ACTIVE_DCM_VSET_R = crate::FieldReader;
///Field `HP_ACTIVE_DCM_VSET` writer - need_des
pub type HP_ACTIVE_DCM_VSET_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `HP_ACTIVE_DCM_MODE` reader - need_des
pub type HP_ACTIVE_DCM_MODE_R = crate::FieldReader;
///Field `HP_ACTIVE_DCM_MODE` writer - need_des
...
///Field `HP_ACTIVE_DBG_ATTEN` reader - need_des
pub type HP_ACTIVE_DBG_ATTEN_R = crate::FieldReader;
///Field `HP_ACTIVE_DBG_ATTEN` writer - need_des
