...
///`read()` method returns [`ext_ldo_p0_0p3a::R`](R) reader structure
impl crate::Readable for EXT_LDO_P0_0P3A_SPEC {}
///`write(|w| ..)` method takes [`ext_ldo_p0_0p3a::W`](W) writer structure
