///Register `HP_ACTIVE_BACKUP_CLK` reader
pub type R = crate::R<HP_ACTIVE_BACKUP_CLK_SPEC>;
///Register `HP_ACTIVE_BACKUP_CLK` writer
pub type W = crate::W<HP_ACTIVE_BACKUP_CLK_SPEC>;
///Field `HP_ACTIVE_BACKUP_ICG_FUNC_EN` reader - need_des
pub type HP_ACTIVE_BACKUP_ICG_FUNC_EN_R = crate::FieldReader<u32>;
///Field `HP_ACTIVE_BACKUP_ICG_FUNC_EN` writer - need_des
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_ACTIVE_BACKUP_CLK")
            .field(
                ...
                &self.hp_active_backup_icg_func_en(),
            )
            .finish()
    }
}
...
///`read()` method returns [`hp_active_backup_clk::R`](R) reader structure
impl crate::Readable for HP_ACTIVE_BACKUP_CLK_SPEC {}
///`write(|w| ..)` method takes [`hp_active_backup_clk::W`](W) writer structure
