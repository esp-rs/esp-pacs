...
///`read()` method returns [`power_pd_cnnt_cntl::R`](R) reader structure
impl crate::Readable for POWER_PD_CNNT_CNTL_SPEC {}
///`write(|w| ..)` method takes [`power_pd_cnnt_cntl::W`](W) writer structure
