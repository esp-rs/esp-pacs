...
///`read()` method returns [`power_pd_lpperi_cntl::R`](R) reader structure
impl crate::Readable for POWER_PD_LPPERI_CNTL_SPEC {}
///`write(|w| ..)` method takes [`power_pd_lpperi_cntl::W`](W) writer structure
