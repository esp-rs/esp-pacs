...
///`read()` method returns [`hp_sleep_lp_dig_power::R`](R) reader structure
impl crate::Readable for HP_SLEEP_LP_DIG_POWER_SPEC {}
///`write(|w| ..)` method takes [`hp_sleep_lp_dig_power::W`](W) writer structure
