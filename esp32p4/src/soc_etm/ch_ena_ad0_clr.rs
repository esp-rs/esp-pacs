...
///Field `CH_CLR(0-31)` writer - Configures whether or not to clear ch%s enable.\\0: Invalid, No effect\\1: Clear
...
impl W {
    ///Configures whether or not to clear ch(0-31) enable.\\0: Invalid, No effect\\1: Clear
    ///
    ...
    ///Bit 0 - Configures whether or not to clear ch0 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr0(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 0)
    }
    ///Bit 1 - Configures whether or not to clear ch1 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr1(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 1)
    }
    ///Bit 2 - Configures whether or not to clear ch2 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr2(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 2)
    }
    ///Bit 3 - Configures whether or not to clear ch3 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr3(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 3)
    }
    ///Bit 4 - Configures whether or not to clear ch4 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr4(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 4)
    }
    ///Bit 5 - Configures whether or not to clear ch5 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr5(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 5)
    }
    ///Bit 6 - Configures whether or not to clear ch6 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr6(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 6)
    }
    ///Bit 7 - Configures whether or not to clear ch7 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr7(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 7)
    }
    ///Bit 8 - Configures whether or not to clear ch8 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr8(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 8)
    }
    ///Bit 9 - Configures whether or not to clear ch9 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr9(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 9)
    }
    ///Bit 10 - Configures whether or not to clear ch10 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr10(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 10)
    }
    ///Bit 11 - Configures whether or not to clear ch11 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr11(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 11)
    }
    ///Bit 12 - Configures whether or not to clear ch12 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr12(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 12)
    }
    ///Bit 13 - Configures whether or not to clear ch13 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr13(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 13)
    }
    ///Bit 14 - Configures whether or not to clear ch14 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr14(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 14)
    }
    ///Bit 15 - Configures whether or not to clear ch15 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr15(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 15)
    }
    ///Bit 16 - Configures whether or not to clear ch16 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr16(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 16)
    }
    ///Bit 17 - Configures whether or not to clear ch17 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr17(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 17)
    }
    ///Bit 18 - Configures whether or not to clear ch18 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr18(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 18)
    }
    ///Bit 19 - Configures whether or not to clear ch19 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr19(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 19)
    }
    ///Bit 20 - Configures whether or not to clear ch20 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr20(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 20)
    }
    ///Bit 21 - Configures whether or not to clear ch21 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr21(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 21)
    }
    ///Bit 22 - Configures whether or not to clear ch22 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr22(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 22)
    }
    ///Bit 23 - Configures whether or not to clear ch23 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr23(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 23)
    }
    ///Bit 24 - Configures whether or not to clear ch24 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr24(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 24)
    }
    ///Bit 25 - Configures whether or not to clear ch25 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr25(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 25)
    }
    ///Bit 26 - Configures whether or not to clear ch26 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr26(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 26)
    }
    ///Bit 27 - Configures whether or not to clear ch27 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr27(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 27)
    }
    ///Bit 28 - Configures whether or not to clear ch28 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr28(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 28)
    }
    ///Bit 29 - Configures whether or not to clear ch29 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr29(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 29)
    }
    ///Bit 30 - Configures whether or not to clear ch30 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr30(&mut self) -> CH_CLR_W<CH_ENA_AD0_CLR_SPEC> {
        CH_CLR_W::new(self, 30)
    }
    ///Bit 31 - Configures whether or not to clear ch31 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
