...
///Field `CH_ENA(0-31)` reader - Represents ch%s enable status.\\0: Disable\\1: Enable
pub type CH_ENA_R = crate::BitReader;
///Field `CH_ENA(0-31)` writer - Represents ch%s enable status.\\0: Disable\\1: Enable
pub type CH_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Represents ch(0-31) enable status.\\0: Disable\\1: Enable
    ///
