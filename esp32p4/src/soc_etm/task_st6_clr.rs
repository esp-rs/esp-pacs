...
impl W {
    ...
    pub fn pdma_axi_task_in_start_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_TASK_IN_START_CH2_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_task_out_start_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_TASK_OUT_START_CH0_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_task_out_start_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_TASK_OUT_START_CH1_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_task_out_start_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_TASK_OUT_START_CH2_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn pmu_task_sleep_req_st_clr(
        &mut self,
    ) -> PMU_TASK_SLEEP_REQ_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_in_start_ch0_st_clr(
        &mut self,
    ) -> DMA2D_TASK_IN_START_CH0_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_in_start_ch1_st_clr(
        &mut self,
    ) -> DMA2D_TASK_IN_START_CH1_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_in_dscr_ready_ch0_st_clr(
        &mut self,
    ) -> DMA2D_TASK_IN_DSCR_READY_CH0_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_in_dscr_ready_ch1_st_clr(
        &mut self,
    ) -> DMA2D_TASK_IN_DSCR_READY_CH1_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_out_start_ch0_st_clr(
        &mut self,
    ) -> DMA2D_TASK_OUT_START_CH0_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_out_start_ch1_st_clr(
        &mut self,
    ) -> DMA2D_TASK_OUT_START_CH1_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_out_start_ch2_st_clr(
        &mut self,
    ) -> DMA2D_TASK_OUT_START_CH2_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_out_dscr_ready_ch0_st_clr(
        &mut self,
    ) -> DMA2D_TASK_OUT_DSCR_READY_CH0_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_out_dscr_ready_ch1_st_clr(
        &mut self,
    ) -> DMA2D_TASK_OUT_DSCR_READY_CH1_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_task_out_dscr_ready_ch2_st_clr(
        &mut self,
    ) -> DMA2D_TASK_OUT_DSCR_READY_CH2_ST_CLR_W<'_, TASK_ST6_CLR_SPEC> {
