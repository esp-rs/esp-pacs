    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TASK_ST2")
            .field(
                ...
                &self.ledc_task_timer0_pause_st().bit(),
            )
            .field(
                "ledc_task_timer1_pause_st",
                &self.ledc_task_timer1_pause_st().bit(),
            )
            .field(
                "ledc_task_timer2_pause_st",
                &self.ledc_task_timer2_pause_st().bit(),
            )
            .field(
                "ledc_task_timer3_pause_st",
                &self.ledc_task_timer3_pause_st().bit(),
            )
            .field(
                "ledc_task_gamma_restart_ch0_st",
                &self.ledc_task_gamma_restart_ch0_st().bit(),
            )
            .field(
                "ledc_task_gamma_restart_ch1_st",
                &self.ledc_task_gamma_restart_ch1_st().bit(),
            )
            .field(
                "ledc_task_gamma_restart_ch2_st",
                &self.ledc_task_gamma_restart_ch2_st().bit(),
            )
            .field(
                "ledc_task_gamma_restart_ch3_st",
                &self.ledc_task_gamma_restart_ch3_st().bit(),
            )
            .field(
                "ledc_task_gamma_restart_ch4_st",
                &self.ledc_task_gamma_restart_ch4_st().bit(),
            )
            .field(
                "ledc_task_gamma_restart_ch5_st",
                &self.ledc_task_gamma_restart_ch5_st().bit(),
            )
            .field(
                "ledc_task_gamma_restart_ch6_st",
                &self.ledc_task_gamma_restart_ch6_st().bit(),
            )
            .field(
                "ledc_task_gamma_restart_ch7_st",
                &self.ledc_task_gamma_restart_ch7_st().bit(),
            )
            .field(
                "ledc_task_gamma_pause_ch0_st",
                &self.ledc_task_gamma_pause_ch0_st().bit(),
            )
            .field(
                "ledc_task_gamma_pause_ch1_st",
                &self.ledc_task_gamma_pause_ch1_st().bit(),
            )
            .field(
                "ledc_task_gamma_pause_ch2_st",
                &self.ledc_task_gamma_pause_ch2_st().bit(),
            )
            .field(
                "ledc_task_gamma_pause_ch3_st",
                &self.ledc_task_gamma_pause_ch3_st().bit(),
            )
            .field(
                "ledc_task_gamma_pause_ch4_st",
                &self.ledc_task_gamma_pause_ch4_st().bit(),
            )
            .field(
                "ledc_task_gamma_pause_ch5_st",
                &self.ledc_task_gamma_pause_ch5_st().bit(),
            )
            .field(
                "ledc_task_gamma_pause_ch6_st",
                &self.ledc_task_gamma_pause_ch6_st().bit(),
            )
            .field(
                "ledc_task_gamma_pause_ch7_st",
                &self.ledc_task_gamma_pause_ch7_st().bit(),
            )
            .field(
                "ledc_task_gamma_resume_ch0_st",
                &self.ledc_task_gamma_resume_ch0_st().bit(),
            )
            .field(
                "ledc_task_gamma_resume_ch1_st",
                &self.ledc_task_gamma_resume_ch1_st().bit(),
            )
            .field(
                "ledc_task_gamma_resume_ch2_st",
                &self.ledc_task_gamma_resume_ch2_st().bit(),
            )
            .field(
                "ledc_task_gamma_resume_ch3_st",
                &self.ledc_task_gamma_resume_ch3_st().bit(),
            )
            .field(
                "ledc_task_gamma_resume_ch4_st",
                &self.ledc_task_gamma_resume_ch4_st().bit(),
            )
            .field(
                "ledc_task_gamma_resume_ch5_st",
                &self.ledc_task_gamma_resume_ch5_st().bit(),
            )
            .field(
                "ledc_task_gamma_resume_ch6_st",
                &self.ledc_task_gamma_resume_ch6_st().bit(),
            )
            .field(
                "ledc_task_gamma_resume_ch7_st",
                &self.ledc_task_gamma_resume_ch7_st().bit(),
            )
            .field(
                "tg0_task_cnt_start_timer0_st",
                &self.tg0_task_cnt_start_timer0_st().bit(),
            )
            .field(
                "tg0_task_alarm_start_timer0_st",
                &self.tg0_task_alarm_start_timer0_st().bit(),
            )
            .field(
                "tg0_task_cnt_stop_timer0_st",
                &self.tg0_task_cnt_stop_timer0_st().bit(),
            )
            .field(
                "tg0_task_cnt_reload_timer0_st",
                &self.tg0_task_cnt_reload_timer0_st().bit(),
            )
            .finish()
    }
}
