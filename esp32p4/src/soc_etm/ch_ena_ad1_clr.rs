...
///Field `CH_CLR(32-49)` writer - Configures whether or not to clear ch%s enable.\\0: Invalid, No effect\\1: Clear
...
impl W {
    ///Configures whether or not to clear ch(32-49) enable.\\0: Invalid, No effect\\1: Clear
    ///
    ...
    ///Bit 0 - Configures whether or not to clear ch32 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr32(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 0)
    }
    ///Bit 1 - Configures whether or not to clear ch33 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr33(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 1)
    }
    ///Bit 2 - Configures whether or not to clear ch34 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr34(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 2)
    }
    ///Bit 3 - Configures whether or not to clear ch35 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr35(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 3)
    }
    ///Bit 4 - Configures whether or not to clear ch36 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr36(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 4)
    }
    ///Bit 5 - Configures whether or not to clear ch37 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr37(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 5)
    }
    ///Bit 6 - Configures whether or not to clear ch38 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr38(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 6)
    }
    ///Bit 7 - Configures whether or not to clear ch39 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr39(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 7)
    }
    ///Bit 8 - Configures whether or not to clear ch40 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr40(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 8)
    }
    ///Bit 9 - Configures whether or not to clear ch41 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr41(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 9)
    }
    ///Bit 10 - Configures whether or not to clear ch42 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr42(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 10)
    }
    ///Bit 11 - Configures whether or not to clear ch43 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr43(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 11)
    }
    ///Bit 12 - Configures whether or not to clear ch44 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr44(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 12)
    }
    ///Bit 13 - Configures whether or not to clear ch45 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr45(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 13)
    }
    ///Bit 14 - Configures whether or not to clear ch46 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr46(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 14)
    }
    ///Bit 15 - Configures whether or not to clear ch47 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr47(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 15)
    }
    ///Bit 16 - Configures whether or not to clear ch48 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
    pub fn ch_clr48(&mut self) -> CH_CLR_W<CH_ENA_AD1_CLR_SPEC> {
        CH_CLR_W::new(self, 16)
    }
    ///Bit 17 - Configures whether or not to clear ch49 enable.\\0: Invalid, No effect\\1: Clear
    #[inline(always)]
    #[must_use]
