...
impl W {
    ...
    pub fn tg0_task_cnt_cap_timer0_st(
        &mut self,
    ) -> TG0_TASK_CNT_CAP_TIMER0_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg0_task_cnt_start_timer1_st(
        &mut self,
    ) -> TG0_TASK_CNT_START_TIMER1_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg0_task_alarm_start_timer1_st(
        &mut self,
    ) -> TG0_TASK_ALARM_START_TIMER1_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg0_task_cnt_stop_timer1_st(
        &mut self,
    ) -> TG0_TASK_CNT_STOP_TIMER1_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg0_task_cnt_reload_timer1_st(
        &mut self,
    ) -> TG0_TASK_CNT_RELOAD_TIMER1_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg0_task_cnt_cap_timer1_st(
        &mut self,
    ) -> TG0_TASK_CNT_CAP_TIMER1_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg1_task_cnt_start_timer0_st(
        &mut self,
    ) -> TG1_TASK_CNT_START_TIMER0_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg1_task_alarm_start_timer0_st(
        &mut self,
    ) -> TG1_TASK_ALARM_START_TIMER0_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg1_task_cnt_stop_timer0_st(
        &mut self,
    ) -> TG1_TASK_CNT_STOP_TIMER0_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg1_task_cnt_reload_timer0_st(
        &mut self,
    ) -> TG1_TASK_CNT_RELOAD_TIMER0_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg1_task_cnt_cap_timer0_st(
        &mut self,
    ) -> TG1_TASK_CNT_CAP_TIMER0_ST_W<'_, TASK_ST3_SPEC> {
    ...
    pub fn tg1_task_cnt_start_timer1_st(
        &mut self,
    ) -> TG1_TASK_CNT_START_TIMER1_ST_W<'_, TASK_ST3_SPEC> {
