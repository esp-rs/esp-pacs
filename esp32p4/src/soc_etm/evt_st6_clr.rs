...
pub type W = crate::W<EVT_ST6_CLR_SPEC>;
...
impl core::fmt::Debug for crate::generic::Reg<EVT_ST6_CLR_SPEC> {
...
impl W {
    ...
    pub fn pdma_ahb_evt_out_fifo_full_ch2_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_OUT_FIFO_FULL_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AHB_EVT_OUT_FIFO_FULL_CH2_ST_CLR_W::new(self, 0)
    }
    ...
    pub fn pdma_axi_evt_in_done_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_DONE_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_DONE_CH0_ST_CLR_W::new(self, 1)
    }
    ...
    pub fn pdma_axi_evt_in_done_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_DONE_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_DONE_CH1_ST_CLR_W::new(self, 2)
    }
    ...
    pub fn pdma_axi_evt_in_done_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_DONE_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_DONE_CH2_ST_CLR_W::new(self, 3)
    }
    ...
    pub fn pdma_axi_evt_in_suc_eof_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_SUC_EOF_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_SUC_EOF_CH0_ST_CLR_W::new(self, 4)
    }
    ...
    pub fn pdma_axi_evt_in_suc_eof_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_SUC_EOF_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_SUC_EOF_CH1_ST_CLR_W::new(self, 5)
    }
    ...
    pub fn pdma_axi_evt_in_suc_eof_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_SUC_EOF_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_SUC_EOF_CH2_ST_CLR_W::new(self, 6)
    }
    ...
    pub fn pdma_axi_evt_in_fifo_empty_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_EMPTY_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_FIFO_EMPTY_CH0_ST_CLR_W::new(self, 7)
    }
    ...
    pub fn pdma_axi_evt_in_fifo_empty_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_EMPTY_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_FIFO_EMPTY_CH1_ST_CLR_W::new(self, 8)
    }
    ...
    pub fn pdma_axi_evt_in_fifo_empty_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_EMPTY_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_FIFO_EMPTY_CH2_ST_CLR_W::new(self, 9)
    }
    ...
    pub fn pdma_axi_evt_in_fifo_full_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_FULL_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_FIFO_FULL_CH0_ST_CLR_W::new(self, 10)
    }
    ...
    pub fn pdma_axi_evt_in_fifo_full_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_FULL_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_FIFO_FULL_CH1_ST_CLR_W::new(self, 11)
    }
    ...
    pub fn pdma_axi_evt_in_fifo_full_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_FULL_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_IN_FIFO_FULL_CH2_ST_CLR_W::new(self, 12)
    }
    ...
    pub fn pdma_axi_evt_out_done_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_DONE_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_DONE_CH0_ST_CLR_W::new(self, 13)
    }
    ...
    pub fn pdma_axi_evt_out_done_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_DONE_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_DONE_CH1_ST_CLR_W::new(self, 14)
    }
    ...
    pub fn pdma_axi_evt_out_done_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_DONE_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_DONE_CH2_ST_CLR_W::new(self, 15)
    }
    ...
    pub fn pdma_axi_evt_out_eof_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_EOF_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_EOF_CH0_ST_CLR_W::new(self, 16)
    }
    ...
    pub fn pdma_axi_evt_out_eof_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_EOF_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_EOF_CH1_ST_CLR_W::new(self, 17)
    }
    ...
    pub fn pdma_axi_evt_out_eof_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_EOF_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_EOF_CH2_ST_CLR_W::new(self, 18)
    }
    ...
    pub fn pdma_axi_evt_out_total_eof_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_TOTAL_EOF_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_TOTAL_EOF_CH0_ST_CLR_W::new(self, 19)
    }
    ...
    pub fn pdma_axi_evt_out_total_eof_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_TOTAL_EOF_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_TOTAL_EOF_CH1_ST_CLR_W::new(self, 20)
    }
    ...
    pub fn pdma_axi_evt_out_total_eof_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_TOTAL_EOF_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_TOTAL_EOF_CH2_ST_CLR_W::new(self, 21)
    }
    ...
    pub fn pdma_axi_evt_out_fifo_empty_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_EMPTY_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_FIFO_EMPTY_CH0_ST_CLR_W::new(self, 22)
    }
    ...
    pub fn pdma_axi_evt_out_fifo_empty_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_EMPTY_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_FIFO_EMPTY_CH1_ST_CLR_W::new(self, 23)
    }
    ...
    pub fn pdma_axi_evt_out_fifo_empty_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_EMPTY_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_FIFO_EMPTY_CH2_ST_CLR_W::new(self, 24)
    }
    ...
    pub fn pdma_axi_evt_out_fifo_full_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_FULL_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_FIFO_FULL_CH0_ST_CLR_W::new(self, 25)
    }
    ...
    pub fn pdma_axi_evt_out_fifo_full_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_FULL_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_FIFO_FULL_CH1_ST_CLR_W::new(self, 26)
    }
    ...
    pub fn pdma_axi_evt_out_fifo_full_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_FULL_CH2_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PDMA_AXI_EVT_OUT_FIFO_FULL_CH2_ST_CLR_W::new(self, 27)
    }
    ...
    pub fn pmu_evt_sleep_weekup_st_clr(
        &mut self,
    ) -> PMU_EVT_SLEEP_WEEKUP_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        PMU_EVT_SLEEP_WEEKUP_ST_CLR_W::new(self, 28)
    }
    ...
    pub fn dma2d_evt_in_done_ch0_st_clr(
        &mut self,
    ) -> DMA2D_EVT_IN_DONE_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        DMA2D_EVT_IN_DONE_CH0_ST_CLR_W::new(self, 29)
    }
    ...
    pub fn dma2d_evt_in_done_ch1_st_clr(
        &mut self,
    ) -> DMA2D_EVT_IN_DONE_CH1_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        DMA2D_EVT_IN_DONE_CH1_ST_CLR_W::new(self, 30)
    }
    ...
    pub fn dma2d_evt_in_suc_eof_ch0_st_clr(
        &mut self,
    ) -> DMA2D_EVT_IN_SUC_EOF_CH0_ST_CLR_W<EVT_ST6_CLR_SPEC> {
        DMA2D_EVT_IN_SUC_EOF_CH0_ST_CLR_W::new(self, 31)
    }
...
#[doc = "Events trigger status clear register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`evt_st6_clr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EVT_ST6_CLR_SPEC;
impl crate::RegisterSpec for EVT_ST6_CLR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`evt_st6_clr::W`](W) writer structure"]
impl crate::Writable for EVT_ST6_CLR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets EVT_ST6_CLR to value 0"]
impl crate::Resettable for EVT_ST6_CLR_SPEC {
