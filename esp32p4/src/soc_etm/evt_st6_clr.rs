...
impl W {
    ...
    pub fn pdma_ahb_evt_out_fifo_full_ch2_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_OUT_FIFO_FULL_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_done_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_DONE_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_done_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_DONE_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_done_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_DONE_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_suc_eof_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_SUC_EOF_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_suc_eof_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_SUC_EOF_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_suc_eof_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_SUC_EOF_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_fifo_empty_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_EMPTY_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_fifo_empty_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_EMPTY_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_fifo_empty_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_EMPTY_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_fifo_full_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_FULL_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_fifo_full_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_FULL_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_in_fifo_full_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_IN_FIFO_FULL_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_done_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_DONE_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_done_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_DONE_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_done_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_DONE_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_eof_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_EOF_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_eof_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_EOF_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_eof_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_EOF_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_total_eof_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_TOTAL_EOF_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_total_eof_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_TOTAL_EOF_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_total_eof_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_TOTAL_EOF_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_fifo_empty_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_EMPTY_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_fifo_empty_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_EMPTY_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_fifo_empty_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_EMPTY_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_fifo_full_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_FULL_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_fifo_full_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_FULL_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pdma_axi_evt_out_fifo_full_ch2_st_clr(
        &mut self,
    ) -> PDMA_AXI_EVT_OUT_FIFO_FULL_CH2_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn pmu_evt_sleep_weekup_st_clr(
        &mut self,
    ) -> PMU_EVT_SLEEP_WEEKUP_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_evt_in_done_ch0_st_clr(
        &mut self,
    ) -> DMA2D_EVT_IN_DONE_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_evt_in_done_ch1_st_clr(
        &mut self,
    ) -> DMA2D_EVT_IN_DONE_CH1_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
    ...
    pub fn dma2d_evt_in_suc_eof_ch0_st_clr(
        &mut self,
    ) -> DMA2D_EVT_IN_SUC_EOF_CH0_ST_CLR_W<'_, EVT_ST6_CLR_SPEC> {
