...
impl W {
    ...
    pub fn regdma_task_start0_st_clr(
        &mut self,
    ) -> REGDMA_TASK_START0_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn regdma_task_start1_st_clr(
        &mut self,
    ) -> REGDMA_TASK_START1_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn regdma_task_start2_st_clr(
        &mut self,
    ) -> REGDMA_TASK_START2_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn regdma_task_start3_st_clr(
        &mut self,
    ) -> REGDMA_TASK_START3_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn tmpsnsr_task_start_sample_st_clr(
        &mut self,
    ) -> TMPSNSR_TASK_START_SAMPLE_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn tmpsnsr_task_stop_sample_st_clr(
        &mut self,
    ) -> TMPSNSR_TASK_STOP_SAMPLE_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn i2s0_task_start_rx_st_clr(
        &mut self,
    ) -> I2S0_TASK_START_RX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn i2s0_task_start_tx_st_clr(
        &mut self,
    ) -> I2S0_TASK_START_TX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn i2s0_task_stop_rx_st_clr(
        &mut self,
    ) -> I2S0_TASK_STOP_RX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn i2s0_task_stop_tx_st_clr(
        &mut self,
    ) -> I2S0_TASK_STOP_TX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn i2s1_task_start_rx_st_clr(
        &mut self,
    ) -> I2S1_TASK_START_RX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn i2s1_task_start_tx_st_clr(
        &mut self,
    ) -> I2S1_TASK_START_TX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn i2s1_task_stop_rx_st_clr(
        &mut self,
    ) -> I2S1_TASK_STOP_RX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn i2s1_task_stop_tx_st_clr(
        &mut self,
    ) -> I2S1_TASK_STOP_TX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s2_task_start_rx_st_clr(
        &mut self,
    ) -> I2S2_TASK_START_RX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s2_task_start_tx_st_clr(
        &mut self,
    ) -> I2S2_TASK_START_TX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s2_task_stop_rx_st_clr(
        &mut self,
    ) -> I2S2_TASK_STOP_RX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s2_task_stop_tx_st_clr(
        &mut self,
    ) -> I2S2_TASK_STOP_TX_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn pdma_ahb_task_in_start_ch0_st_clr(
        &mut self,
    ) -> PDMA_AHB_TASK_IN_START_CH0_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn pdma_ahb_task_in_start_ch1_st_clr(
        &mut self,
    ) -> PDMA_AHB_TASK_IN_START_CH1_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn pdma_ahb_task_in_start_ch2_st_clr(
        &mut self,
    ) -> PDMA_AHB_TASK_IN_START_CH2_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn pdma_ahb_task_out_start_ch0_st_clr(
        &mut self,
    ) -> PDMA_AHB_TASK_OUT_START_CH0_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn pdma_ahb_task_out_start_ch1_st_clr(
        &mut self,
    ) -> PDMA_AHB_TASK_OUT_START_CH1_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn pdma_ahb_task_out_start_ch2_st_clr(
        &mut self,
    ) -> PDMA_AHB_TASK_OUT_START_CH2_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn pdma_axi_task_in_start_ch0_st_clr(
        &mut self,
    ) -> PDMA_AXI_TASK_IN_START_CH0_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
    ...
    pub fn pdma_axi_task_in_start_ch1_st_clr(
        &mut self,
    ) -> PDMA_AXI_TASK_IN_START_CH1_ST_CLR_W<'_, TASK_ST5_CLR_SPEC> {
