...
///Field `CH_ENA(32-49)` reader - Represents ch%s enable status.\\0: Disable\\1: Enable
pub type CH_ENA_R = crate::BitReader;
///Field `CH_ENA(32-49)` writer - Represents ch%s enable status.\\0: Disable\\1: Enable
pub type CH_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Represents ch(32-49) enable status.\\0: Disable\\1: Enable
    ///
    ...
    ///Bit 0 - Represents ch32 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena32(&self) -> CH_ENA_R {
        CH_ENA_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Represents ch33 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena33(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Represents ch34 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena34(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Represents ch35 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena35(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Represents ch36 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena36(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Represents ch37 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena37(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Represents ch38 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena38(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Represents ch39 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena39(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - Represents ch40 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena40(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Represents ch41 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena41(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Represents ch42 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena42(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - Represents ch43 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena43(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - Represents ch44 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena44(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - Represents ch45 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena45(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - Represents ch46 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena46(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - Represents ch47 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena47(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bit 16 - Represents ch48 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
    pub fn ch_ena48(&self) -> CH_ENA_R {
        CH_ENA_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - Represents ch49 enable status.\\0: Disable\\1: Enable
    #[inline(always)]
