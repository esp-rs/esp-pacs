...
impl W {
    ...
    pub fn mcpwm1_evt_op0_tee2_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_OP0_TEE2_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    pub fn mcpwm1_evt_op1_tee2_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_OP1_TEE2_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    pub fn mcpwm1_evt_op2_tee2_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_OP2_TEE2_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    pub fn adc_evt_conv_cmplt0_st_clr(
        &mut self,
    ) -> ADC_EVT_CONV_CMPLT0_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_evt_rx_done_st_clr(&mut self) -> I2S1_EVT_RX_DONE_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_evt_tx_done_st_clr(&mut self) -> I2S1_EVT_TX_DONE_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    pub fn i2s1_evt_x_words_received_st_clr(
        &mut self,
    ) -> I2S1_EVT_X_WORDS_RECEIVED_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    pub fn i2s1_evt_x_words_sent_st_clr(
        &mut self,
    ) -> I2S1_EVT_X_WORDS_SENT_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s2_evt_rx_done_st_clr(&mut self) -> I2S2_EVT_RX_DONE_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s2_evt_tx_done_st_clr(&mut self) -> I2S2_EVT_TX_DONE_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    pub fn i2s2_evt_x_words_received_st_clr(
        &mut self,
    ) -> I2S2_EVT_X_WORDS_RECEIVED_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
    ...
    pub fn i2s2_evt_x_words_sent_st_clr(
        &mut self,
    ) -> I2S2_EVT_X_WORDS_SENT_ST_CLR_W<'_, EVT_ST4_CLR_SPEC> {
