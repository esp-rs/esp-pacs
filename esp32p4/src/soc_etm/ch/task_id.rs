///Register `TASK_ID` reader
pub type R = crate::R<TASK_ID_SPEC>;
///Register `TASK_ID` writer
pub type W = crate::W<TASK_ID_SPEC>;
///Field `TASK_ID` reader - Configures ch0_task_id
pub type TASK_ID_R = crate::FieldReader;
///Field `TASK_ID` writer - Configures ch0_task_id
pub type TASK_ID_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - Configures ch0_task_id
    #[inline(always)]
...
///`read()` method returns [`task_id::R`](R) reader structure
impl crate::Readable for TASK_ID_SPEC {}
///`write(|w| ..)` method takes [`task_id::W`](W) writer structure
