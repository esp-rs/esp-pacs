...
///Field `SCL_LOW_PERIOD` reader - Configures the low level width of the SCL Clock. Measurement unit: i2c_sclk.
pub type SCL_LOW_PERIOD_R = crate::FieldReader<u16>;
///Field `SCL_LOW_PERIOD` writer - Configures the low level width of the SCL Clock. Measurement unit: i2c_sclk.
pub type SCL_LOW_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ///Bits 0:8 - Configures the low level width of the SCL Clock. Measurement unit: i2c_sclk.
    #[inline(always)]
