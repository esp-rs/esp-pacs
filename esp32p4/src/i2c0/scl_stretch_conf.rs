...
///Field `STRETCH_PROTECT_NUM` reader - Configures the time period to release the SCL line from stretching to avoid timing violation. Usually it should be larger than the SDA setup time. Measurement unit: i2c_sclk
pub type STRETCH_PROTECT_NUM_R = crate::FieldReader<u16>;
///Field `STRETCH_PROTECT_NUM` writer - Configures the time period to release the SCL line from stretching to avoid timing violation. Usually it should be larger than the SDA setup time. Measurement unit: i2c_sclk
pub type STRETCH_PROTECT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `SLAVE_SCL_STRETCH_EN` reader - Configures to enable slave SCL stretch function. 0: Disable 1: Enable The SCL output line will be stretched low when reg_slave_scl_stretch_en is 1 and stretch event happens. The stretch cause can be seen in reg_stretch_cause.
pub type SLAVE_SCL_STRETCH_EN_R = crate::BitReader;
///Field `SLAVE_SCL_STRETCH_EN` writer - Configures to enable slave SCL stretch function. 0: Disable 1: Enable The SCL output line will be stretched low when reg_slave_scl_stretch_en is 1 and stretch event happens. The stretch cause can be seen in reg_stretch_cause.
pub type SLAVE_SCL_STRETCH_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLAVE_SCL_STRETCH_CLR` writer - Configures to clear the I2C slave SCL stretch function. 0: No effect 1: Clear
pub type SLAVE_SCL_STRETCH_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLAVE_BYTE_ACK_CTL_EN` reader - Configures to enable the function for slave to control ACK level. 0: Disable 1: Enable
pub type SLAVE_BYTE_ACK_CTL_EN_R = crate::BitReader;
///Field `SLAVE_BYTE_ACK_CTL_EN` writer - Configures to enable the function for slave to control ACK level. 0: Disable 1: Enable
pub type SLAVE_BYTE_ACK_CTL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLAVE_BYTE_ACK_LVL` reader - Set the ACK level when slave controlling ACK level function enables. 0: Low level 1: High level
pub type SLAVE_BYTE_ACK_LVL_R = crate::BitReader;
///Field `SLAVE_BYTE_ACK_LVL` writer - Set the ACK level when slave controlling ACK level function enables. 0: Low level 1: High level
pub type SLAVE_BYTE_ACK_LVL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:9 - Configures the time period to release the SCL line from stretching to avoid timing violation. Usually it should be larger than the SDA setup time. Measurement unit: i2c_sclk
    #[inline(always)]
    pub fn stretch_protect_num(&self) -> STRETCH_PROTECT_NUM_R {
        STRETCH_PROTECT_NUM_R::new((self.bits & 0x03ff) as u16)
    }
    ///Bit 10 - Configures to enable slave SCL stretch function. 0: Disable 1: Enable The SCL output line will be stretched low when reg_slave_scl_stretch_en is 1 and stretch event happens. The stretch cause can be seen in reg_stretch_cause.
    #[inline(always)]
    pub fn slave_scl_stretch_en(&self) -> SLAVE_SCL_STRETCH_EN_R {
        SLAVE_SCL_STRETCH_EN_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 12 - Configures to enable the function for slave to control ACK level. 0: Disable 1: Enable
    #[inline(always)]
    pub fn slave_byte_ack_ctl_en(&self) -> SLAVE_BYTE_ACK_CTL_EN_R {
        SLAVE_BYTE_ACK_CTL_EN_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - Set the ACK level when slave controlling ACK level function enables. 0: Low level 1: High level
    #[inline(always)]
...
impl W {
    ...
    ///Bit 11 - Configures to clear the I2C slave SCL stretch function. 0: No effect 1: Clear
    #[inline(always)]
    #[must_use]
