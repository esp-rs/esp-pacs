...
///Field `TIME` reader - Configures the time between the rising edge of SCL and the rising edge of SDA. Measurement unit: i2c_sclk
pub type TIME_R = crate::FieldReader<u16>;
///Field `TIME` writer - Configures the time between the rising edge of SCL and the rising edge of SDA. Measurement unit: i2c_sclk
pub type TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ///Bits 0:8 - Configures the time between the rising edge of SCL and the rising edge of SDA. Measurement unit: i2c_sclk
    #[inline(always)]
