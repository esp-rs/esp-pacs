...
#[doc = "Field `TIME` reader - Configures the sample time after a positive SCL edge. Measurement unit: i2c_sclk"]
pub type TIME_R = crate::FieldReader<u16>;
#[doc = "Field `TIME` writer - Configures the sample time after a positive SCL edge. Measurement unit: i2c_sclk"]
