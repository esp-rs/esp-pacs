...
#[doc = "Field `TIME` reader - Configures the time for sampling SDA.\\\\ Measurement unit: i2c_sclk \\\\"]
pub type TIME_R = crate::FieldReader<u16>;
#[doc = "Field `TIME` writer - Configures the time for sampling SDA.\\\\ Measurement unit: i2c_sclk \\\\"]
pub type TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    #[doc = "Bits 0:8 - Configures the time for sampling SDA.\\\\ Measurement unit: i2c_sclk \\\\"]
    #[inline(always)]
