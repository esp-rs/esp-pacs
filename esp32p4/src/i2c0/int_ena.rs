...
///Field `RXFIFO_WM` reader - Write 1 to enable I2C_RXFIFO_WM_INT interrupt.
pub type RXFIFO_WM_R = crate::BitReader;
///Field `RXFIFO_WM` writer - Write 1 to enable I2C_RXFIFO_WM_INT interrupt.
pub type RXFIFO_WM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_WM` reader - Write 1 to enable I2C_TXFIFO_WM_INT interrupt.
pub type TXFIFO_WM_R = crate::BitReader;
///Field `TXFIFO_WM` writer - Write 1 to enable I2C_TXFIFO_WM_INT interrupt.
pub type TXFIFO_WM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_OVF` reader - Write 1 to enable I2C_RXFIFO_OVF_INT interrupt.
pub type RXFIFO_OVF_R = crate::BitReader;
///Field `RXFIFO_OVF` writer - Write 1 to enable I2C_RXFIFO_OVF_INT interrupt.
pub type RXFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `END_DETECT` reader - Write 1 to enable the I2C_END_DETECT_INT interrupt.
pub type END_DETECT_R = crate::BitReader;
///Field `END_DETECT` writer - Write 1 to enable the I2C_END_DETECT_INT interrupt.
pub type END_DETECT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BYTE_TRANS_DONE` reader - Write 1 to enable the I2C_END_DETECT_INT interrupt.
pub type BYTE_TRANS_DONE_R = crate::BitReader;
///Field `BYTE_TRANS_DONE` writer - Write 1 to enable the I2C_END_DETECT_INT interrupt.
pub type BYTE_TRANS_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ARBITRATION_LOST` reader - Write 1 to enable the I2C_ARBITRATION_LOST_INT interrupt.
pub type ARBITRATION_LOST_R = crate::BitReader;
///Field `ARBITRATION_LOST` writer - Write 1 to enable the I2C_ARBITRATION_LOST_INT interrupt.
pub type ARBITRATION_LOST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MST_TXFIFO_UDF` reader - Write 1 to enable I2C_TRANS_COMPLETE_INT interrupt.
pub type MST_TXFIFO_UDF_R = crate::BitReader;
///Field `MST_TXFIFO_UDF` writer - Write 1 to enable I2C_TRANS_COMPLETE_INT interrupt.
pub type MST_TXFIFO_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_COMPLETE` reader - Write 1 to enable the I2C_TRANS_COMPLETE_INT interrupt.
pub type TRANS_COMPLETE_R = crate::BitReader;
///Field `TRANS_COMPLETE` writer - Write 1 to enable the I2C_TRANS_COMPLETE_INT interrupt.
pub type TRANS_COMPLETE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIME_OUT` reader - Write 1 to enable the I2C_TIME_OUT_INT interrupt.
pub type TIME_OUT_R = crate::BitReader;
///Field `TIME_OUT` writer - Write 1 to enable the I2C_TIME_OUT_INT interrupt.
pub type TIME_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_START` reader - Write 1 to enable the I2C_TRANS_START_INT interrupt.
pub type TRANS_START_R = crate::BitReader;
///Field `TRANS_START` writer - Write 1 to enable the I2C_TRANS_START_INT interrupt.
pub type TRANS_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `NACK` reader - Write 1 to enable I2C_SLAVE_STRETCH_INT interrupt.
pub type NACK_R = crate::BitReader;
///Field `NACK` writer - Write 1 to enable I2C_SLAVE_STRETCH_INT interrupt.
pub type NACK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_OVF` reader - Write 1 to enable I2C_TXFIFO_OVF_INT interrupt.
pub type TXFIFO_OVF_R = crate::BitReader;
///Field `TXFIFO_OVF` writer - Write 1 to enable I2C_TXFIFO_OVF_INT interrupt.
pub type TXFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_UDF` reader - Write 1 to enable I2C_RXFIFO_UDF_INT interrupt.
pub type RXFIFO_UDF_R = crate::BitReader;
///Field `RXFIFO_UDF` writer - Write 1 to enable I2C_RXFIFO_UDF_INT interrupt.
pub type RXFIFO_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCL_ST_TO` reader - Write 1 to enable I2C_SCL_ST_TO_INT interrupt.
pub type SCL_ST_TO_R = crate::BitReader;
///Field `SCL_ST_TO` writer - Write 1 to enable I2C_SCL_ST_TO_INT interrupt.
pub type SCL_ST_TO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCL_MAIN_ST_TO` reader - Write 1 to enable I2C_SCL_MAIN_ST_TO_INT interrupt.
pub type SCL_MAIN_ST_TO_R = crate::BitReader;
///Field `SCL_MAIN_ST_TO` writer - Write 1 to enable I2C_SCL_MAIN_ST_TO_INT interrupt.
pub type SCL_MAIN_ST_TO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DET_START` reader - Write 1 to enable I2C_DET_START_INT interrupt.
pub type DET_START_R = crate::BitReader;
///Field `DET_START` writer - Write 1 to enable I2C_DET_START_INT interrupt.
pub type DET_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLAVE_STRETCH` reader - Write 1 to enable I2C_SLAVE_STRETCH_INT interrupt.
pub type SLAVE_STRETCH_R = crate::BitReader;
///Field `SLAVE_STRETCH` writer - Write 1 to enable I2C_SLAVE_STRETCH_INT interrupt.
pub type SLAVE_STRETCH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GENERAL_CALL` reader - Write 1 to enable I2C_GENARAL_CALL_INT interrupt.
pub type GENERAL_CALL_R = crate::BitReader;
///Field `GENERAL_CALL` writer - Write 1 to enable I2C_GENARAL_CALL_INT interrupt.
pub type GENERAL_CALL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLAVE_ADDR_UNMATCH` reader - Write 1 to enable I2C_SLAVE_ADDR_UNMATCH_INT interrupt.
pub type SLAVE_ADDR_UNMATCH_R = crate::BitReader;
///Field `SLAVE_ADDR_UNMATCH` writer - Write 1 to enable I2C_SLAVE_ADDR_UNMATCH_INT interrupt.
pub type SLAVE_ADDR_UNMATCH_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Write 1 to enable I2C_RXFIFO_WM_INT interrupt.
    #[inline(always)]
    pub fn rxfifo_wm(&self) -> RXFIFO_WM_R {
        RXFIFO_WM_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Write 1 to enable I2C_TXFIFO_WM_INT interrupt.
    #[inline(always)]
    pub fn txfifo_wm(&self) -> TXFIFO_WM_R {
        TXFIFO_WM_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Write 1 to enable I2C_RXFIFO_OVF_INT interrupt.
    #[inline(always)]
    pub fn rxfifo_ovf(&self) -> RXFIFO_OVF_R {
        RXFIFO_OVF_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Write 1 to enable the I2C_END_DETECT_INT interrupt.
    #[inline(always)]
    pub fn end_detect(&self) -> END_DETECT_R {
        END_DETECT_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Write 1 to enable the I2C_END_DETECT_INT interrupt.
    #[inline(always)]
    pub fn byte_trans_done(&self) -> BYTE_TRANS_DONE_R {
        BYTE_TRANS_DONE_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Write 1 to enable the I2C_ARBITRATION_LOST_INT interrupt.
    #[inline(always)]
    pub fn arbitration_lost(&self) -> ARBITRATION_LOST_R {
        ARBITRATION_LOST_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Write 1 to enable I2C_TRANS_COMPLETE_INT interrupt.
    #[inline(always)]
    pub fn mst_txfifo_udf(&self) -> MST_TXFIFO_UDF_R {
        MST_TXFIFO_UDF_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Write 1 to enable the I2C_TRANS_COMPLETE_INT interrupt.
    #[inline(always)]
    pub fn trans_complete(&self) -> TRANS_COMPLETE_R {
        TRANS_COMPLETE_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - Write 1 to enable the I2C_TIME_OUT_INT interrupt.
    #[inline(always)]
    pub fn time_out(&self) -> TIME_OUT_R {
        TIME_OUT_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Write 1 to enable the I2C_TRANS_START_INT interrupt.
    #[inline(always)]
    pub fn trans_start(&self) -> TRANS_START_R {
        TRANS_START_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Write 1 to enable I2C_SLAVE_STRETCH_INT interrupt.
    #[inline(always)]
    pub fn nack(&self) -> NACK_R {
        NACK_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - Write 1 to enable I2C_TXFIFO_OVF_INT interrupt.
    #[inline(always)]
    pub fn txfifo_ovf(&self) -> TXFIFO_OVF_R {
        TXFIFO_OVF_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - Write 1 to enable I2C_RXFIFO_UDF_INT interrupt.
    #[inline(always)]
    pub fn rxfifo_udf(&self) -> RXFIFO_UDF_R {
        RXFIFO_UDF_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - Write 1 to enable I2C_SCL_ST_TO_INT interrupt.
    #[inline(always)]
    pub fn scl_st_to(&self) -> SCL_ST_TO_R {
        SCL_ST_TO_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - Write 1 to enable I2C_SCL_MAIN_ST_TO_INT interrupt.
    #[inline(always)]
    pub fn scl_main_st_to(&self) -> SCL_MAIN_ST_TO_R {
        SCL_MAIN_ST_TO_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - Write 1 to enable I2C_DET_START_INT interrupt.
    #[inline(always)]
    pub fn det_start(&self) -> DET_START_R {
        DET_START_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bit 16 - Write 1 to enable I2C_SLAVE_STRETCH_INT interrupt.
    #[inline(always)]
    pub fn slave_stretch(&self) -> SLAVE_STRETCH_R {
        SLAVE_STRETCH_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - Write 1 to enable I2C_GENARAL_CALL_INT interrupt.
    #[inline(always)]
    pub fn general_call(&self) -> GENERAL_CALL_R {
        GENERAL_CALL_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - Write 1 to enable I2C_SLAVE_ADDR_UNMATCH_INT interrupt.
    #[inline(always)]
