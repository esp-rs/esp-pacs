...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_fwrite_dual(&mut self) -> SPI_MEM_FWRITE_DUAL_W<SPI_MEM_USER_SPEC> {
        SPI_MEM_FWRITE_DUAL_W::new(self, 12)
    }
    #[doc = "Bit 13 - In the write operations read-data phase apply 4 signals"]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_fwrite_quad(&mut self) -> SPI_MEM_FWRITE_QUAD_W<SPI_MEM_USER_SPEC> {
        SPI_MEM_FWRITE_QUAD_W::new(self, 13)
    }
    #[doc = "Bit 14 - In the write operations address phase and read-data phase apply 2 signals."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_fwrite_dio(&mut self) -> SPI_MEM_FWRITE_DIO_W<SPI_MEM_USER_SPEC> {
        SPI_MEM_FWRITE_DIO_W::new(self, 14)
    }
    #[doc = "Bit 15 - In the write operations address phase and read-data phase apply 4 signals."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_fwrite_qio(&mut self) -> SPI_MEM_FWRITE_QIO_W<SPI_MEM_USER_SPEC> {
        SPI_MEM_FWRITE_QIO_W::new(self, 15)
    }
    #[doc = "Bit 24 - read-data phase only access to high-part of the buffer spi_mem_w8~spi_mem_w15. 1: enable 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_miso_highpart(&mut self) -> SPI_MEM_USR_MISO_HIGHPART_W<SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_MISO_HIGHPART_W::new(self, 24)
    }
    #[doc = "Bit 25 - write-data phase only access to high-part of the buffer spi_mem_w8~spi_mem_w15. 1: enable 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_mosi_highpart(&mut self) -> SPI_MEM_USR_MOSI_HIGHPART_W<SPI_MEM_USER_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_mosi(&mut self) -> SPI_MEM_USR_MOSI_W<SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_MOSI_W::new(self, 27)
    }
    #[doc = "Bit 28 - This bit enable the read-data phase of an operation."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_miso(&mut self) -> SPI_MEM_USR_MISO_W<SPI_MEM_USER_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_addr(&mut self) -> SPI_MEM_USR_ADDR_W<SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_ADDR_W::new(self, 30)
    }
    #[doc = "Bit 31 - This bit enable the command phase of an operation."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_command(&mut self) -> SPI_MEM_USR_COMMAND_W<SPI_MEM_USER_SPEC> {
