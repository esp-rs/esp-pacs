...
///Field `PER_END` reader - The enable bit for SPI_MEM_PER_END_INT interrupt.
pub type PER_END_R = crate::BitReader;
///Field `PER_END` writer - The enable bit for SPI_MEM_PER_END_INT interrupt.
pub type PER_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PES_END` reader - The enable bit for SPI_MEM_PES_END_INT interrupt.
...
///Field `WPE_END` reader - The enable bit for SPI_MEM_WPE_END_INT interrupt.
pub type WPE_END_R = crate::BitReader;
///Field `WPE_END` writer - The enable bit for SPI_MEM_WPE_END_INT interrupt.
...
///Field `BROWN_OUT` reader - The enable bit for SPI_MEM_BROWN_OUT_INT interrupt.
pub type BROWN_OUT_R = crate::BitReader;
///Field `BROWN_OUT` writer - The enable bit for SPI_MEM_BROWN_OUT_INT interrupt.
...
impl R {
    ...
    ///Bit 10 - The enable bit for SPI_MEM_BROWN_OUT_INT interrupt.
    #[inline(always)]
