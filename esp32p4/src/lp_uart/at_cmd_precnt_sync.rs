///Register `AT_CMD_PRECNT_SYNC` reader
pub type R = crate::R<AT_CMD_PRECNT_SYNC_SPEC>;
///Register `AT_CMD_PRECNT_SYNC` writer
pub type W = crate::W<AT_CMD_PRECNT_SYNC_SPEC>;
///Field `PRE_IDLE_NUM` reader - This register is used to configure the idle duration time before the first at_cmd is received by receiver.
pub type PRE_IDLE_NUM_R = crate::FieldReader<u16>;
///Field `PRE_IDLE_NUM` writer - This register is used to configure the idle duration time before the first at_cmd is received by receiver.
...
///`read()` method returns [`at_cmd_precnt_sync::R`](R) reader structure
impl crate::Readable for AT_CMD_PRECNT_SYNC_SPEC {}
///`write(|w| ..)` method takes [`at_cmd_precnt_sync::W`](W) writer structure
