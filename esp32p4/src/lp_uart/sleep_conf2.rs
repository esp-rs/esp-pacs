...
///Field `ACTIVE_THRESHOLD` writer - The uart is activated from light sleeping mode when the input rxd edge changes more times than this register value.
pub type ACTIVE_THRESHOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `RX_WAKE_UP_THRHD` reader - In wake up mode 1 this field is used to set the received data number threshold to wake up chip.
pub type RX_WAKE_UP_THRHD_R = crate::FieldReader;
///Field `RX_WAKE_UP_THRHD` writer - In wake up mode 1 this field is used to set the received data number threshold to wake up chip.
pub type RX_WAKE_UP_THRHD_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `WK_CHAR_NUM` reader - This register is used to select number of wake up char.
pub type WK_CHAR_NUM_R = crate::FieldReader;
///Field `WK_CHAR_NUM` writer - This register is used to select number of wake up char.
pub type WK_CHAR_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WK_CHAR_MASK` reader - This register is used to mask wake up char.
pub type WK_CHAR_MASK_R = crate::FieldReader;
///Field `WK_CHAR_MASK` writer - This register is used to mask wake up char.
pub type WK_CHAR_MASK_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `WK_MODE_SEL` reader - This register is used to select wake up mode. 0: RXD toggling to wake up. 1: received data number larger than
pub type WK_MODE_SEL_R = crate::FieldReader;
///Field `WK_MODE_SEL` writer - This register is used to select wake up mode. 0: RXD toggling to wake up. 1: received data number larger than
...
impl R {
    ...
    ///Bits 13:17 - In wake up mode 1 this field is used to set the received data number threshold to wake up chip.
    #[inline(always)]
...
///`read()` method returns [`sleep_conf2::R`](R) reader structure
impl crate::Readable for SLEEP_CONF2_SPEC {}
///`write(|w| ..)` method takes [`sleep_conf2::W`](W) writer structure
