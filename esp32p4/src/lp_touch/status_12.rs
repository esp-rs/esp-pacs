///Register `STATUS_12` reader
pub type R = crate::R<STATUS_12_SPEC>;
///Field `PAD12_DATA` reader - need_des
pub type PAD12_DATA_R = crate::FieldReader<u16>;
///Field `PAD12_DEBOUNCE_CNT` reader - need_des
pub type PAD12_DEBOUNCE_CNT_R = crate::FieldReader;
///Field `PAD12_NEG_NOISE_CNT` reader - need_des
...
///`read()` method returns [`status_12::R`](R) reader structure
