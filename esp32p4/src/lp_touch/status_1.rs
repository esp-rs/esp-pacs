///Register `STATUS_1` reader
pub type R = crate::R<STATUS_1_SPEC>;
///Field `PAD1_DATA` reader - need_des
pub type PAD1_DATA_R = crate::FieldReader<u16>;
///Field `PAD1_DEBOUNCE_CNT` reader - need_des
pub type PAD1_DEBOUNCE_CNT_R = crate::FieldReader;
///Field `PAD1_NEG_NOISE_CNT` reader - need_des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS_1")
            .field("pad1_data", &self.pad1_data())
            .field("pad1_debounce_cnt", &self.pad1_debounce_cnt())
            .field("pad1_neg_noise_cnt", &self.pad1_neg_noise_cnt())
            .finish()
    }
}
/**need_des
...
///`read()` method returns [`status_1::R`](R) reader structure
