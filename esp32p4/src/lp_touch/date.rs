...
impl W {
    #[doc = "Bits 0:27 - need_des"]
    #[inline(always)]
    pub fn rtc_date(&mut self) -> RTC_DATE_W<'_, DATE_SPEC> {
        RTC_DATE_W::new(self, 0)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn rtc_clk_en(&mut self) -> RTC_CLK_EN_W<'_, DATE_SPEC> {
...
#[doc = "`reset()` method sets DATE to value 0x0250_2194"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0250_2194;
}
