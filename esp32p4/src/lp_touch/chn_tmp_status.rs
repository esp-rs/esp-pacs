///Register `CHN_TMP_STATUS` reader
pub type R = crate::R<CHN_TMP_STATUS_SPEC>;
///Field `PAD_INACTIVE_STATUS` reader - need_des
pub type PAD_INACTIVE_STATUS_R = crate::FieldReader<u16>;
///Field `PAD_ACTIVE_STATUS` reader - need_des
...
///`read()` method returns [`chn_tmp_status::R`](R) reader structure
