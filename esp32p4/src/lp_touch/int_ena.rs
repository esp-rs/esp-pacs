...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn scan_done(&mut self) -> SCAN_DONE_W<'_, INT_ENA_SPEC> {
    ...
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn active(&mut self) -> ACTIVE_W<'_, INT_ENA_SPEC> {
        ACTIVE_W::new(self, 2)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    pub fn inactive(&mut self) -> INACTIVE_W<'_, INT_ENA_SPEC> {
        INACTIVE_W::new(self, 3)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    pub fn timeout(&mut self) -> TIMEOUT_W<'_, INT_ENA_SPEC> {
