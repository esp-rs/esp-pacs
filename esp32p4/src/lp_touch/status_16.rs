///Register `STATUS_16` reader
pub type R = crate::R<STATUS_16_SPEC>;
///Field `APPROACH_PAD2_CNT` reader - need_des
pub type APPROACH_PAD2_CNT_R = crate::FieldReader;
///Field `APPROACH_PAD1_CNT` reader - need_des
pub type APPROACH_PAD1_CNT_R = crate::FieldReader;
///Field `APPROACH_PAD0_CNT` reader - need_des
pub type APPROACH_PAD0_CNT_R = crate::FieldReader;
///Field `SLP_APPROACH_CNT` reader - need_des
...
///`read()` method returns [`status_16::R`](R) reader structure
