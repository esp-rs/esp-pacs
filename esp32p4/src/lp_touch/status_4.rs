///Register `STATUS_4` reader
pub type R = crate::R<STATUS_4_SPEC>;
///Field `PAD4_DATA` reader - need_des
pub type PAD4_DATA_R = crate::FieldReader<u16>;
///Field `PAD4_DEBOUNCE_CNT` reader - need_des
pub type PAD4_DEBOUNCE_CNT_R = crate::FieldReader;
///Field `PAD4_NEG_NOISE_CNT` reader - need_des
...
///`read()` method returns [`status_4::R`](R) reader structure
