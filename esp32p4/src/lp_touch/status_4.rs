...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS_4")
            .field("pad4_data", &self.pad4_data().bits())
            .field("pad4_debounce_cnt", &self.pad4_debounce_cnt().bits())
            .field("pad4_neg_noise_cnt", &self.pad4_neg_noise_cnt().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<STATUS_4_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`status_4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
