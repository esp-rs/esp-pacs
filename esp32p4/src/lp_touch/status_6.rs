///Register `STATUS_6` reader
pub type R = crate::R<STATUS_6_SPEC>;
///Field `PAD6_DATA` reader - need_des
pub type PAD6_DATA_R = crate::FieldReader<u16>;
///Field `PAD6_DEBOUNCE_CNT` reader - need_des
pub type PAD6_DEBOUNCE_CNT_R = crate::FieldReader;
///Field `PAD6_NEG_NOISE_CNT` reader - need_des
...
///`read()` method returns [`status_6::R`](R) reader structure
