...
/**LP_SYS_VER_DATE (rw) register accessor: need_des
...
/**CLK_SEL_CTRL (rw) register accessor: need_des
...
/**SYS_CTRL (rw) register accessor: need_des
...
///need_des
pub mod sys_ctrl;
/**LP_CLK_CTRL (rw) register accessor: need_des
...
///need_des
pub mod lp_clk_ctrl;
/**LP_RST_CTRL (rw) register accessor: need_des
...
///need_des
pub mod lp_rst_ctrl;
/**LP_CORE_BOOT_ADDR (rw) register accessor: need_des
...
/**EXT_WAKEUP1 (rw) register accessor: need_des
...
///need_des
pub mod ext_wakeup1;
/**EXT_WAKEUP1_STATUS (r) register accessor: need_des
...
/**LP_TCM_PWR_CTRL (rw) register accessor: need_des
...
/**BOOT_ADDR_HP_LP (rw) register accessor: need_des
...
/**LP_STORE0 (rw) register accessor: need_des
...
///need_des
pub mod lp_store0;
/**LP_STORE1 (rw) register accessor: need_des
...
///need_des
pub mod lp_store1;
/**LP_STORE2 (rw) register accessor: need_des
...
///need_des
pub mod lp_store2;
/**LP_STORE3 (rw) register accessor: need_des
...
///need_des
pub mod lp_store3;
/**LP_STORE4 (rw) register accessor: need_des
...
///need_des
pub mod lp_store4;
/**LP_STORE5 (rw) register accessor: need_des
...
///need_des
pub mod lp_store5;
/**LP_STORE6 (rw) register accessor: need_des
...
///need_des
pub mod lp_store6;
/**LP_STORE7 (rw) register accessor: need_des
...
///need_des
pub mod lp_store7;
/**LP_STORE8 (rw) register accessor: need_des
...
///need_des
pub mod lp_store8;
/**LP_STORE9 (rw) register accessor: need_des
...
///need_des
pub mod lp_store9;
/**LP_STORE10 (rw) register accessor: need_des
...
///need_des
pub mod lp_store10;
/**LP_STORE11 (rw) register accessor: need_des
...
///need_des
pub mod lp_store11;
/**LP_STORE12 (rw) register accessor: need_des
...
///need_des
pub mod lp_store12;
/**LP_STORE13 (rw) register accessor: need_des
...
///need_des
pub mod lp_store13;
/**LP_STORE14 (rw) register accessor: need_des
...
///need_des
pub mod lp_store14;
/**LP_STORE15 (rw) register accessor: need_des
...
///need_des
pub mod lp_store15;
/**LP_PROBEA_CTRL (rw) register accessor: need_des
...
/**LP_PROBEB_CTRL (rw) register accessor: need_des
...
/**LP_PROBE_OUT (r) register accessor: need_des
...
/**F2S_APB_BRG_CNTL (rw) register accessor: need_des
...
/**USB_CTRL (rw) register accessor: need_des
...
///need_des
pub mod usb_ctrl;
/**ANA_XPD_PAD_GROUP (rw) register accessor: need_des
...
/**LP_TCM_RAM_RDN_ECO_CS (rw) register accessor: need_des
...
/**LP_PMU_RDN_ECO_LOW (rw) register accessor: need_des
...
/**LP_PMU_RDN_ECO_HIGH (rw) register accessor: need_des
...
/**PAD_COMP0 (rw) register accessor: need_des
...
///need_des
pub mod pad_comp0;
/**PAD_COMP1 (rw) register accessor: need_des
...
///need_des
pub mod pad_comp1;
/**BACKUP_DMA_CFG0 (rw) register accessor: need_des
...
/**BACKUP_DMA_CFG1 (rw) register accessor: need_des
...
/**BACKUP_DMA_CFG2 (rw) register accessor: need_des
...
/**BOOT_ADDR_HP_CORE1 (rw) register accessor: need_des
...
/**LP_ADDRHOLE_ADDR (r) register accessor: need_des
...
/**LP_ADDRHOLE_INFO (r) register accessor: need_des
...
pub mod int_st;
/**INT_ENA (rw) register accessor: masked interrupt register
...
pub mod int_clr;
/**HP_MEM_AUX_CTRL (rw) register accessor: need_des
...
/**LP_MEM_AUX_CTRL (rw) register accessor: need_des
...
/**HP_ROM_AUX_CTRL (rw) register accessor: need_des
...
/**LP_ROM_AUX_CTRL (rw) register accessor: need_des
...
/**LP_CPU_DBG_PC (r) register accessor: need_des
...
/**LP_CPU_EXC_PC (r) register accessor: need_des
...
/**IDBUS_ADDRHOLE_ADDR (r) register accessor: need_des
...
/**IDBUS_ADDRHOLE_INFO (r) register accessor: need_des
...
/**HP_POR_RST_BYPASS_CTRL (rw) register accessor: need_des
...
///rng data register
pub mod rng_data;
/**LP_CORE_AHB_TIMEOUT (rw) register accessor: need_des
...
/**LP_CORE_IBUS_TIMEOUT (rw) register accessor: need_des
