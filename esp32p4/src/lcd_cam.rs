...
/**LCD_CLOCK (rw) register accessor: LCD clock config register.
...
pub mod lcd_clock;
/**CAM_CTRL (rw) register accessor: CAM config register.
...
///CAM config register.
pub mod cam_ctrl;
/**CAM_CTRL1 (rw) register accessor: CAM config register.
...
///CAM config register.
pub mod cam_ctrl1;
/**CAM_RGB_YUV (rw) register accessor: CAM YUV/RGB converter configuration register.
...
pub mod cam_rgb_yuv;
/**LCD_RGB_YUV (rw) register accessor: LCD YUV/RGB converter configuration register.
...
pub mod lcd_rgb_yuv;
/**LCD_USER (rw) register accessor: LCD config register.
...
///LCD config register.
pub mod lcd_user;
/**LCD_MISC (rw) register accessor: LCD config register.
...
///LCD config register.
pub mod lcd_misc;
/**LCD_CTRL (rw) register accessor: LCD config register.
...
///LCD config register.
pub mod lcd_ctrl;
/**LCD_CTRL1 (rw) register accessor: LCD config register.
...
///LCD config register.
pub mod lcd_ctrl1;
/**LCD_CTRL2 (rw) register accessor: LCD config register.
...
///LCD config register.
pub mod lcd_ctrl2;
/**LCD_FIRST_CMD_VAL (rw) register accessor: LCD config register.
...
/**LCD_LATTER_CMD_VAL (rw) register accessor: LCD config register.
...
/**LCD_DLY_MODE_CFG1 (rw) register accessor: LCD config register.
...
/**LCD_DLY_MODE_CFG2 (rw) register accessor: LCD config register.
...
/**LC_DMA_INT_ENA (rw) register accessor: LCDCAM interrupt enable register.
...
/**LC_DMA_INT_RAW (r) register accessor: LCDCAM interrupt raw register, valid in level.
...
/**LC_DMA_INT_ST (r) register accessor: LCDCAM interrupt status register.
...
/**LC_DMA_INT_CLR (w) register accessor: LCDCAM interrupt clear register.
...
/**LC_REG_DATE (rw) register accessor: Version register
