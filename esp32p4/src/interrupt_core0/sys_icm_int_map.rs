...
#[doc = "Field `CORE0_SYS_ICM_INT_MAP` reader - NA"]
pub type CORE0_SYS_ICM_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_SYS_ICM_INT_MAP` writer - NA"]
...
impl W {
    #[doc = "Bits 0:5 - NA"]
    #[inline(always)]
    pub fn core0_sys_icm_int_map(&mut self) -> CORE0_SYS_ICM_INT_MAP_W<'_, SYS_ICM_INT_MAP_SPEC> {
