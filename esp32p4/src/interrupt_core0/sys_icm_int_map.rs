///Register `SYS_ICM_INT_MAP` reader
pub type R = crate::R<SYS_ICM_INT_MAP_SPEC>;
///Register `SYS_ICM_INT_MAP` writer
pub type W = crate::W<SYS_ICM_INT_MAP_SPEC>;
///Field `CORE0_SYS_ICM_INT_MAP` reader - NA
pub type CORE0_SYS_ICM_INT_MAP_R = crate::FieldReader;
///Field `CORE0_SYS_ICM_INT_MAP` writer - NA
pub type CORE0_SYS_ICM_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - NA
    #[inline(always)]
    pub fn core0_sys_icm_int_map(&self) -> CORE0_SYS_ICM_INT_MAP_R {
        CORE0_SYS_ICM_INT_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYS_ICM_INT_MAP")
            .field("core0_sys_icm_int_map", &self.core0_sys_icm_int_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`sys_icm_int_map::R`](R) reader structure
impl crate::Readable for SYS_ICM_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`sys_icm_int_map::W`](W) writer structure
