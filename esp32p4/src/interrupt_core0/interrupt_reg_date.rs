...
#[doc = "Field `INTERRUPT_REG_DATE` reader - NA"]
pub type INTERRUPT_REG_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `INTERRUPT_REG_DATE` writer - NA"]
...
impl W {
    #[doc = "Bits 0:27 - NA"]
    #[inline(always)]
    pub fn interrupt_reg_date(&mut self) -> INTERRUPT_REG_DATE_W<'_, INTERRUPT_REG_DATE_SPEC> {
