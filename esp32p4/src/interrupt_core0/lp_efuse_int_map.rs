///Register `LP_EFUSE_INT_MAP` reader
pub type R = crate::R<LP_EFUSE_INT_MAP_SPEC>;
///Register `LP_EFUSE_INT_MAP` writer
pub type W = crate::W<LP_EFUSE_INT_MAP_SPEC>;
///Field `CORE0_LP_EFUSE_INT_MAP` reader - NA
pub type CORE0_LP_EFUSE_INT_MAP_R = crate::FieldReader;
///Field `CORE0_LP_EFUSE_INT_MAP` writer - NA
...
///`read()` method returns [`lp_efuse_int_map::R`](R) reader structure
impl crate::Readable for LP_EFUSE_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`lp_efuse_int_map::W`](W) writer structure
