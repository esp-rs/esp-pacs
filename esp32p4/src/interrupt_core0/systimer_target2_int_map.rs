...
#[doc = "Field `CORE0_SYSTIMER_TARGET2_INT_MAP` reader - NA"]
pub type CORE0_SYSTIMER_TARGET2_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_SYSTIMER_TARGET2_INT_MAP` writer - NA"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYSTIMER_TARGET2_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.core0_systimer_target2_int_map().bits()),
            )
            .finish()
    }
}
