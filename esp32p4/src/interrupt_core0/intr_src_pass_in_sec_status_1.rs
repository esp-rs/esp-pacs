...
#[doc = "Field `INTR_SRC_PASS_IN_SEC_STATUS_1` reader - NA"]
pub type INTR_SRC_PASS_IN_SEC_STATUS_1_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn intr_src_pass_in_sec_status_1(&self) -> INTR_SRC_PASS_IN_SEC_STATUS_1_R {
        INTR_SRC_PASS_IN_SEC_STATUS_1_R::new(self.bits)
    }
}
