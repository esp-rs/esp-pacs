...
#[doc = "Field `CORE0_CSI_BRIDGE_INT_MAP` reader - NA"]
pub type CORE0_CSI_BRIDGE_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_CSI_BRIDGE_INT_MAP` writer - NA"]
pub type CORE0_CSI_BRIDGE_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - NA"]
    #[inline(always)]
    pub fn core0_csi_bridge_int_map(&self) -> CORE0_CSI_BRIDGE_INT_MAP_R {
        CORE0_CSI_BRIDGE_INT_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CSI_BRIDGE_INT_MAP")
            .field("core0_csi_bridge_int_map", &self.core0_csi_bridge_int_map())
            .finish()
    }
}
impl W {
