...
#[doc = "Field `CORE0_AHB_PDMA_IN_CH1_INT_MAP` reader - NA"]
pub type CORE0_AHB_PDMA_IN_CH1_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_AHB_PDMA_IN_CH1_INT_MAP` writer - NA"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHB_PDMA_IN_CH1_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.core0_ahb_pdma_in_ch1_int_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<AHB_PDMA_IN_CH1_INT_MAP_SPEC> {
