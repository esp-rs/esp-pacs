...
#[doc = "Field `CORE0_TIMERGRP1_T0_INT_MAP` reader - NA"]
pub type CORE0_TIMERGRP1_T0_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_TIMERGRP1_T0_INT_MAP` writer - NA"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMERGRP1_T0_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.core0_timergrp1_t0_int_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TIMERGRP1_T0_INT_MAP_SPEC> {
