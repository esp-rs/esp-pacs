///Register `TIMERGRP1_T0_INT_MAP` reader
pub type R = crate::R<TIMERGRP1_T0_INT_MAP_SPEC>;
///Register `TIMERGRP1_T0_INT_MAP` writer
pub type W = crate::W<TIMERGRP1_T0_INT_MAP_SPEC>;
///Field `CORE0_TIMERGRP1_T0_INT_MAP` reader - NA
pub type CORE0_TIMERGRP1_T0_INT_MAP_R = crate::FieldReader;
///Field `CORE0_TIMERGRP1_T0_INT_MAP` writer - NA
pub type CORE0_TIMERGRP1_T0_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - NA
    #[inline(always)]
    pub fn core0_timergrp1_t0_int_map(&self) -> CORE0_TIMERGRP1_T0_INT_MAP_R {
        CORE0_TIMERGRP1_T0_INT_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMERGRP1_T0_INT_MAP")
            .field(
                ...
                &self.core0_timergrp1_t0_int_map(),
            )
            .finish()
    }
}
...
///`read()` method returns [`timergrp1_t0_int_map::R`](R) reader structure
impl crate::Readable for TIMERGRP1_T0_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`timergrp1_t0_int_map::W`](W) writer structure
