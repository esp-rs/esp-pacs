///Register `I2C0_INT_MAP` reader
pub type R = crate::R<I2C0_INT_MAP_SPEC>;
///Register `I2C0_INT_MAP` writer
pub type W = crate::W<I2C0_INT_MAP_SPEC>;
///Field `CORE0_I2C0_INT_MAP` reader - NA
pub type CORE0_I2C0_INT_MAP_R = crate::FieldReader;
///Field `CORE0_I2C0_INT_MAP` writer - NA
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C0_INT_MAP")
            .field("core0_i2c0_int_map", &self.core0_i2c0_int_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`i2c0_int_map::R`](R) reader structure
impl crate::Readable for I2C0_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`i2c0_int_map::W`](W) writer structure
