///Register `CAN1_INT_MAP` reader
pub type R = crate::R<CAN1_INT_MAP_SPEC>;
///Register `CAN1_INT_MAP` writer
pub type W = crate::W<CAN1_INT_MAP_SPEC>;
///Field `CORE0_CAN1_INT_MAP` reader - NA
pub type CORE0_CAN1_INT_MAP_R = crate::FieldReader;
///Field `CORE0_CAN1_INT_MAP` writer - NA
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CAN1_INT_MAP")
            .field("core0_can1_int_map", &self.core0_can1_int_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`can1_int_map::R`](R) reader structure
impl crate::Readable for CAN1_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`can1_int_map::W`](W) writer structure
