...
#[doc = "Field `CORE0_LP_I2C_INT_MAP` reader - NA"]
pub type CORE0_LP_I2C_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_LP_I2C_INT_MAP` writer - NA"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_I2C_INT_MAP")
            .field("core0_lp_i2c_int_map", &self.core0_lp_i2c_int_map().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<LP_I2C_INT_MAP_SPEC> {
