...
///Field `CORE0_ASSIST_DEBUG_INT_MAP` reader - NA
pub type CORE0_ASSIST_DEBUG_INT_MAP_R = crate::FieldReader;
///Field `CORE0_ASSIST_DEBUG_INT_MAP` writer - NA
pub type CORE0_ASSIST_DEBUG_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - NA
    #[inline(always)]
    pub fn core0_assist_debug_int_map(&self) -> CORE0_ASSIST_DEBUG_INT_MAP_R {
        CORE0_ASSIST_DEBUG_INT_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_assist_debug_int_map(
        &mut self,
    ) -> CORE0_ASSIST_DEBUG_INT_MAP_W<ASSIST_DEBUG_INT_MAP_SPEC> {
        CORE0_ASSIST_DEBUG_INT_MAP_W::new(self, 0)
    }
}
/**NA
