///Register `AXI_PDMA_OUT_CH2_INT_MAP` reader
pub type R = crate::R<AXI_PDMA_OUT_CH2_INT_MAP_SPEC>;
///Register `AXI_PDMA_OUT_CH2_INT_MAP` writer
pub type W = crate::W<AXI_PDMA_OUT_CH2_INT_MAP_SPEC>;
///Field `CORE0_AXI_PDMA_OUT_CH2_INT_MAP` reader - NA
pub type CORE0_AXI_PDMA_OUT_CH2_INT_MAP_R = crate::FieldReader;
///Field `CORE0_AXI_PDMA_OUT_CH2_INT_MAP` writer - NA
pub type CORE0_AXI_PDMA_OUT_CH2_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - NA
    #[inline(always)]
    pub fn core0_axi_pdma_out_ch2_int_map(&self) -> CORE0_AXI_PDMA_OUT_CH2_INT_MAP_R {
        CORE0_AXI_PDMA_OUT_CH2_INT_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_axi_pdma_out_ch2_int_map(
        &mut self,
    ) -> CORE0_AXI_PDMA_OUT_CH2_INT_MAP_W<AXI_PDMA_OUT_CH2_INT_MAP_SPEC> {
        CORE0_AXI_PDMA_OUT_CH2_INT_MAP_W::new(self, 0)
    }
}
/**NA
...
///`read()` method returns [`axi_pdma_out_ch2_int_map::R`](R) reader structure
impl crate::Readable for AXI_PDMA_OUT_CH2_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`axi_pdma_out_ch2_int_map::W`](W) writer structure
