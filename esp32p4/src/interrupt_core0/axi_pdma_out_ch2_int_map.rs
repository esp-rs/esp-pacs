...
#[doc = "Field `CORE0_AXI_PDMA_OUT_CH2_INT_MAP` reader - NA"]
pub type CORE0_AXI_PDMA_OUT_CH2_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_AXI_PDMA_OUT_CH2_INT_MAP` writer - NA"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AXI_PDMA_OUT_CH2_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.core0_axi_pdma_out_ch2_int_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<AXI_PDMA_OUT_CH2_INT_MAP_SPEC> {
