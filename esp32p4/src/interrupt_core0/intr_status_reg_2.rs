///Register `INTR_STATUS_REG_2` reader
pub type R = crate::R<INTR_STATUS_REG_2_SPEC>;
///Field `CORE0_INTR_STATUS_2` reader - NA
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INTR_STATUS_REG_2")
            .field("core0_intr_status_2", &self.core0_intr_status_2())
            .finish()
    }
}
/**NA
...
///`read()` method returns [`intr_status_reg_2::R`](R) reader structure
