...
#[doc = "Field `CORE0_SYSTIMER_TARGET1_INT_MAP` reader - NA"]
pub type CORE0_SYSTIMER_TARGET1_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_SYSTIMER_TARGET1_INT_MAP` writer - NA"]
pub type CORE0_SYSTIMER_TARGET1_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - NA"]
    #[inline(always)]
    pub fn core0_systimer_target1_int_map(&self) -> CORE0_SYSTIMER_TARGET1_INT_MAP_R {
        CORE0_SYSTIMER_TARGET1_INT_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYSTIMER_TARGET1_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.core0_systimer_target1_int_map().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_systimer_target1_int_map(
        &mut self,
    ) -> CORE0_SYSTIMER_TARGET1_INT_MAP_W<SYSTIMER_TARGET1_INT_MAP_SPEC> {
        CORE0_SYSTIMER_TARGET1_INT_MAP_W::new(self, 0)
    }
