///Register `PWM0_INT_MAP` reader
pub type R = crate::R<PWM0_INT_MAP_SPEC>;
///Register `PWM0_INT_MAP` writer
pub type W = crate::W<PWM0_INT_MAP_SPEC>;
///Field `CORE0_PWM0_INT_MAP` reader - NA
pub type CORE0_PWM0_INT_MAP_R = crate::FieldReader;
///Field `CORE0_PWM0_INT_MAP` writer - NA
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PWM0_INT_MAP")
            .field("core0_pwm0_int_map", &self.core0_pwm0_int_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pwm0_int_map::R`](R) reader structure
impl crate::Readable for PWM0_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`pwm0_int_map::W`](W) writer structure
