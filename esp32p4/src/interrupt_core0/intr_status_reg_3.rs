///Register `INTR_STATUS_REG_3` reader
pub type R = crate::R<INTR_STATUS_REG_3_SPEC>;
///Field `CORE0_INTR_STATUS_3` reader - NA
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INTR_STATUS_REG_3")
            .field("core0_intr_status_3", &self.core0_intr_status_3())
            .finish()
    }
}
/**NA
...
///`read()` method returns [`intr_status_reg_3::R`](R) reader structure
