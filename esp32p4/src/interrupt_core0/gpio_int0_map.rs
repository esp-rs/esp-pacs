///Register `GPIO_INT0_MAP` reader
pub type R = crate::R<GPIO_INT0_MAP_SPEC>;
///Register `GPIO_INT0_MAP` writer
pub type W = crate::W<GPIO_INT0_MAP_SPEC>;
///Field `CORE0_GPIO_INT0_MAP` reader - NA
pub type CORE0_GPIO_INT0_MAP_R = crate::FieldReader;
///Field `CORE0_GPIO_INT0_MAP` writer - NA
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_gpio_int0_map(&mut self) -> CORE0_GPIO_INT0_MAP_W<GPIO_INT0_MAP_SPEC> {
...
///`read()` method returns [`gpio_int0_map::R`](R) reader structure
impl crate::Readable for GPIO_INT0_MAP_SPEC {}
///`write(|w| ..)` method takes [`gpio_int0_map::W`](W) writer structure
