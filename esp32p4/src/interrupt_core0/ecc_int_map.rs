...
#[doc = "Field `CORE0_ECC_INT_MAP` reader - NA"]
pub type CORE0_ECC_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_ECC_INT_MAP` writer - NA"]
pub type CORE0_ECC_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - NA"]
    #[inline(always)]
    pub fn core0_ecc_int_map(&self) -> CORE0_ECC_INT_MAP_R {
        CORE0_ECC_INT_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ECC_INT_MAP")
            .field("core0_ecc_int_map", &self.core0_ecc_int_map().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_ecc_int_map(&mut self) -> CORE0_ECC_INT_MAP_W<ECC_INT_MAP_SPEC> {
        CORE0_ECC_INT_MAP_W::new(self, 0)
    }
}
