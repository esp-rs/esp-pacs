...
#[doc = "Field `AXI_PERF_MON_INT_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type AXI_PERF_MON_INT_MAP_R = crate::FieldReader;
#[doc = "Field `AXI_PERF_MON_INT_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type AXI_PERF_MON_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `AXI_PERF_MON_INT_SRC_PASS_IN_SEC` reader - NA"]
pub type AXI_PERF_MON_INT_SRC_PASS_IN_SEC_R = crate::BitReader;
#[doc = "Field `AXI_PERF_MON_INT_SRC_PASS_IN_SEC` writer - NA"]
pub type AXI_PERF_MON_INT_SRC_PASS_IN_SEC_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `AXI_PERF_MON_INT_SRC_IN_SEC_FLAG` reader - NA"]
pub type AXI_PERF_MON_INT_SRC_IN_SEC_FLAG_R = crate::BitReader;
#[doc = "Field `AXI_PERF_MON_INT_SRC_IN_SEC_FLAG` writer - NA"]
