...
#[doc = "Field `CORE0_PWM1_INT_MAP` reader - NA"]
pub type CORE0_PWM1_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE0_PWM1_INT_MAP` writer - NA"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PWM1_INT_MAP")
            .field("core0_pwm1_int_map", &self.core0_pwm1_int_map().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PWM1_INT_MAP_SPEC> {
