///Register `SET_START_MODEXP` writer
pub type W = crate::W<SET_START_MODEXP_SPEC>;
///Field `SET_START_MODEXP` writer - Configure whether or not to start the modular exponentiation. 0: No effect 1: Start
...
impl W {
    ///Bit 0 - Configure whether or not to start the modular exponentiation. 0: No effect 1: Start
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`set_start_modexp::W`](W) writer structure
