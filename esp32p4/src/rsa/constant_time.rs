...
///Field `CONSTANT_TIME` reader - Configures the constant_time option. 0: Acceleration 1: No acceleration (default)
pub type CONSTANT_TIME_R = crate::BitReader;
///Field `CONSTANT_TIME` writer - Configures the constant_time option. 0: Acceleration 1: No acceleration (default)
