...
pub mod clk_en;
/**EN (rw) register accessor: dsi bridge en register
...
pub mod en;
/**DMA_REQ_CFG (rw) register accessor: dsi bridge dma burst len register
...
pub mod dma_req_cfg;
/**RAW_NUM_CFG (rw) register accessor: dsi bridge raw number control register
...
pub mod raw_num_cfg;
/**RAW_BUF_CREDIT_CTL (rw) register accessor: dsi bridge credit register
...
/**FIFO_FLOW_STATUS (r) register accessor: dsi bridge raw buffer depth register
...
/**PIXEL_TYPE (rw) register accessor: dsi bridge dpi type control register
...
pub mod pixel_type;
/**DMA_BLOCK_INTERVAL (rw) register accessor: dsi bridge dma block interval control register
...
/**DMA_REQ_INTERVAL (rw) register accessor: dsi bridge dma req interval control register
...
/**DPI_LCD_CTL (rw) register accessor: dsi bridge dpi signal control register
...
pub mod dpi_lcd_ctl;
/**DPI_RSV_DPI_DATA (rw) register accessor: dsi bridge dpi reserved data register
...
/**DPI_V_CFG0 (rw) register accessor: dsi bridge dpi v config register 0
...
pub mod dpi_v_cfg0;
/**DPI_V_CFG1 (rw) register accessor: dsi bridge dpi v config register 1
...
pub mod dpi_v_cfg1;
/**DPI_H_CFG0 (rw) register accessor: dsi bridge dpi h config register 0
...
pub mod dpi_h_cfg0;
/**DPI_H_CFG1 (rw) register accessor: dsi bridge dpi h config register 1
...
pub mod dpi_h_cfg1;
/**DPI_MISC_CONFIG (rw) register accessor: dsi_bridge dpi misc config register
...
/**DPI_CONFIG_UPDATE (w) register accessor: dsi_bridge dpi config update register
...
/**INT_ENA (rw) register accessor: dsi_bridge interrupt enable register
...
pub mod int_ena;
/**INT_CLR (w) register accessor: dsi_bridge interrupt clear register
...
pub mod int_clr;
/**INT_RAW (rw) register accessor: dsi_bridge raw interrupt register
...
pub mod int_raw;
/**INT_ST (r) register accessor: dsi_bridge masked interrupt register
...
pub mod int_st;
/**HOST_BIST_CTL (rw) register accessor: dsi_bridge host bist control register
...
/**HOST_TRIGGER_REV (rw) register accessor: dsi_bridge host trigger reverse control register
...
/**BLK_RAW_NUM_CFG (rw) register accessor: dsi_bridge block raw number control register
...
/**DMA_FRAME_INTERVAL (rw) register accessor: dsi_bridge dam frame interval control register
...
/**MEM_AUX_CTRL (rw) register accessor: dsi_bridge mem aux control register
...
/**RDN_ECO_CS (rw) register accessor: dsi_bridge rdn eco cs register
...
pub mod rdn_eco_cs;
/**RDN_ECO_LOW (rw) register accessor: dsi_bridge rdn eco all low register
...
pub mod rdn_eco_low;
/**RDN_ECO_HIGH (rw) register accessor: dsi_bridge rdn eco all high register
...
/**HOST_CTRL (rw) register accessor: dsi_bridge host control register
...
pub mod host_ctrl;
/**MEM_CLK_CTRL (rw) register accessor: dsi_bridge mem force on control register
...
/**DMA_FLOW_CTRL (rw) register accessor: dsi_bridge dma flow controller register
...
/**RAW_BUF_ALMOST_EMPTY_THRD (rw) register accessor: dsi_bridge buffer empty threshold register
...
pub mod yuv_cfg;
/**PHY_LP_LOOPBACK_CTRL (rw) register accessor: dsi phy lp_loopback test ctrl
