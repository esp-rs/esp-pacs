...
/**READER1_CTRL (rw) register accessor: Control the read operation of ADC1.
...
/**READER1_STATUS (r) register accessor: N/A
...
/**MEAS1_CTRL1 (rw) register accessor: N/A
...
///N/A
pub mod meas1_ctrl1;
/**MEAS1_CTRL2 (rw) register accessor: ADC1 configuration registers.
...
pub mod meas1_ctrl2;
/**MEAS1_MUX (rw) register accessor: SAR ADC1 MUX register.
...
pub mod meas1_mux;
/**ATTEN1 (rw) register accessor: ADC1 attenuation registers.
...
pub mod atten1;
/**AMP_CTRL1 (rw) register accessor: N/A
...
///N/A
pub mod amp_ctrl1;
/**AMP_CTRL2 (rw) register accessor: N/A
...
///N/A
pub mod amp_ctrl2;
/**AMP_CTRL3 (rw) register accessor: N/A
...
///N/A
pub mod amp_ctrl3;
/**READER2_CTRL (rw) register accessor: Control the read operation of ADC2.
...
/**READER2_STATUS (r) register accessor: N/A
...
/**MEAS2_CTRL1 (rw) register accessor: ADC2 configuration registers.
...
pub mod meas2_ctrl1;
/**MEAS2_CTRL2 (rw) register accessor: ADC2 configuration registers.
...
///ADC2 configuration registers.
pub mod meas2_ctrl2;
/**MEAS2_MUX (rw) register accessor: SAR ADC2 MUX register.
...
pub mod meas2_mux;
/**ATTEN2 (rw) register accessor: ADC1 attenuation registers.
...
///ADC1 attenuation registers.
pub mod atten2;
/**FORCE_WPD_SAR (rw) register accessor: In sleep, force to use rtc to control ADC
...
/**MEAS_STATUS (r) register accessor: N/A
...
///N/A
pub mod meas_status;
/**REG_CLKEN (rw) register accessor: N/A
...
///N/A
pub mod reg_clken;
/**COCPU_INT_RAW (rw) register accessor: Interrupt raw registers.
...
pub mod int_clr;
/**INT_ENA_W1TS (w) register accessor: Interrupt enable assert registers.
...
/**INT_ENA_W1TC (w) register accessor: Interrupt enable deassert registers.
...
/**WAKEUP1 (rw) register accessor: ADC1 wakeup configuration registers.
...
pub mod wakeup1;
/**WAKEUP2 (rw) register accessor: ADC2 wakeup configuration registers.
...
pub mod wakeup2;
/**WAKEUP_SEL (rw) register accessor: Wakeup source select register.
...
pub mod wakeup_sel;
/**SAR1_HW_WAKEUP (rw) register accessor: Hardware automatic sampling registers for wakeup function.
...
/**SAR2_HW_WAKEUP (rw) register accessor: Hardware automatic sampling registers for wakeup function.
