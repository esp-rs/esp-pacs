    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_SLAVE")
            ...
            .field(
                ...
                &format_args!("{}", self.spi_dma_seg_magic_value().bits()),
            )
            .field("mode", &format_args!("{}", self.mode().bit()))
            .field(
                "spi_usr_conf",
                &format_args!("{}", self.spi_usr_conf().bit()),
            )
            .field(
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_seg_magic_value(&mut self) -> SPI_DMA_SEG_MAGIC_VALUE_W<SPI_SLAVE_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_usr_conf(&mut self) -> SPI_USR_CONF_W<SPI_SLAVE_SPEC> {
