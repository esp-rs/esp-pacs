    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_DMA_INT_ST")
            .field(
                ...
                &format_args!("{}", self.spi_dma_infifo_full_err_int_st().bit()),
            )
            .field(
                "spi_dma_outfifo_empty_err_int_st",
                &format_args!("{}", self.spi_dma_outfifo_empty_err_int_st().bit()),
            )
            .field(
                "spi_slv_ex_qpi_int_st",
                &format_args!("{}", self.spi_slv_ex_qpi_int_st().bit()),
            )
            .field(
                "spi_slv_en_qpi_int_st",
                &format_args!("{}", self.spi_slv_en_qpi_int_st().bit()),
            )
            .field(
                "spi_slv_cmd7_int_st",
                &format_args!("{}", self.spi_slv_cmd7_int_st().bit()),
            )
            .field(
                "spi_slv_cmd8_int_st",
                &format_args!("{}", self.spi_slv_cmd8_int_st().bit()),
            )
            .field(
                "spi_slv_cmd9_int_st",
                &format_args!("{}", self.spi_slv_cmd9_int_st().bit()),
            )
            .field(
                "spi_slv_cmda_int_st",
                &format_args!("{}", self.spi_slv_cmda_int_st().bit()),
            )
            .field(
                "spi_slv_rd_dma_done_int_st",
                &format_args!("{}", self.spi_slv_rd_dma_done_int_st().bit()),
            )
            .field(
                "spi_slv_wr_dma_done_int_st",
                &format_args!("{}", self.spi_slv_wr_dma_done_int_st().bit()),
            )
            .field(
                "spi_slv_rd_buf_done_int_st",
                &format_args!("{}", self.spi_slv_rd_buf_done_int_st().bit()),
            )
            .field(
                "spi_slv_wr_buf_done_int_st",
                &format_args!("{}", self.spi_slv_wr_buf_done_int_st().bit()),
            )
            .field(
                "spi_trans_done_int_st",
                &format_args!("{}", self.spi_trans_done_int_st().bit()),
            )
            .field(
                "spi_dma_seg_trans_done_int_st",
                &format_args!("{}", self.spi_dma_seg_trans_done_int_st().bit()),
            )
            .field(
                "spi_seg_magic_err_int_st",
                &format_args!("{}", self.spi_seg_magic_err_int_st().bit()),
            )
            .field(
                "spi_slv_buf_addr_err_int_st",
                &format_args!("{}", self.spi_slv_buf_addr_err_int_st().bit()),
            )
            .field(
                "spi_slv_cmd_err_int_st",
                &format_args!("{}", self.spi_slv_cmd_err_int_st().bit()),
            )
            .field(
                "spi_mst_rx_afifo_wfull_err_int_st",
                &format_args!("{}", self.spi_mst_rx_afifo_wfull_err_int_st().bit()),
            )
            .field(
                "spi_mst_tx_afifo_rempty_err_int_st",
                &format_args!("{}", self.spi_mst_tx_afifo_rempty_err_int_st().bit()),
            )
            .field(
                "spi_app2_int_st",
                &format_args!("{}", self.spi_app2_int_st().bit()),
            )
            .field(
                "spi_app1_int_st",
                &format_args!("{}", self.spi_app1_int_st().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SPI_DMA_INT_ST_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "SPI interrupt status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spi_dma_int_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
