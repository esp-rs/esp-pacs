...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_CTRL")
            ...
            .field(
                "spi_faddr_oct",
                &format_args!("{}", self.spi_faddr_oct().bit()),
            )
            .field(
                "spi_fcmd_dual",
            ...
            .field(
                "spi_fcmd_oct",
                &format_args!("{}", self.spi_fcmd_oct().bit()),
            )
            .field(
                "spi_fread_dual",
            ...
            .field(
                "spi_fread_oct",
                &format_args!("{}", self.spi_fread_oct().bit()),
            )
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_faddr_oct(&mut self) -> SPI_FADDR_OCT_W<SPI_CTRL_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_fcmd_oct(&mut self) -> SPI_FCMD_OCT_W<SPI_CTRL_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_fread_oct(&mut self) -> SPI_FREAD_OCT_W<SPI_CTRL_SPEC> {
