...
///Field `SEND_WORD` reader - Serves as quick sending register in specified mode in UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM.
pub type SEND_WORD_R = crate::FieldReader<u32>;
///Field `SEND_WORD` writer - Serves as quick sending register in specified mode in UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM.
