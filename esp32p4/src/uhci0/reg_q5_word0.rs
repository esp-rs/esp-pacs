...
#[doc = "Field `SEND_Q5_WORD0` reader - Serves as quick sending register in specified mode in UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM."]
pub type SEND_Q5_WORD0_R = crate::FieldReader<u32>;
#[doc = "Field `SEND_Q5_WORD0` writer - Serves as quick sending register in specified mode in UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM."]
