...
///Field `TXFIFO_TIMEOUT` reader - Stores the timeout value. DMA generates UHCI_TX_HUNG_INT for timeout when receiving data.
pub type TXFIFO_TIMEOUT_R = crate::FieldReader;
///Field `TXFIFO_TIMEOUT` writer - Stores the timeout value. DMA generates UHCI_TX_HUNG_INT for timeout when receiving data.
pub type TXFIFO_TIMEOUT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `TXFIFO_TIMEOUT_SHIFT` reader - Configures the maximum counter value.
pub type TXFIFO_TIMEOUT_SHIFT_R = crate::FieldReader;
///Field `TXFIFO_TIMEOUT_SHIFT` writer - Configures the maximum counter value.
pub type TXFIFO_TIMEOUT_SHIFT_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `TXFIFO_TIMEOUT_ENA` reader - Set this bit to enable TX FIFO timeout when receiving.
pub type TXFIFO_TIMEOUT_ENA_R = crate::BitReader;
///Field `TXFIFO_TIMEOUT_ENA` writer - Set this bit to enable TX FIFO timeout when receiving.
pub type TXFIFO_TIMEOUT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_TIMEOUT` reader - Stores the timeout value. DMA generates UHCI_TX_HUNG_INT for timeout when reading RAM data.
pub type RXFIFO_TIMEOUT_R = crate::FieldReader;
///Field `RXFIFO_TIMEOUT` writer - Stores the timeout value. DMA generates UHCI_TX_HUNG_INT for timeout when reading RAM data.
pub type RXFIFO_TIMEOUT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `RXFIFO_TIMEOUT_SHIFT` reader - Configures the maximum counter value.
pub type RXFIFO_TIMEOUT_SHIFT_R = crate::FieldReader;
///Field `RXFIFO_TIMEOUT_SHIFT` writer - Configures the maximum counter value.
pub type RXFIFO_TIMEOUT_SHIFT_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `RXFIFO_TIMEOUT_ENA` reader - Set this bit to enable TX FIFO timeout when DMA sending data.
pub type RXFIFO_TIMEOUT_ENA_R = crate::BitReader;
///Field `RXFIFO_TIMEOUT_ENA` writer - Set this bit to enable TX FIFO timeout when DMA sending data.
