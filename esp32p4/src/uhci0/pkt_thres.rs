...
///Field `PKT_THRS` reader - Configures the data packet's maximum length when UHCI_HEAD_EN is 0.
pub type PKT_THRS_R = crate::FieldReader<u16>;
///Field `PKT_THRS` writer - Configures the data packet's maximum length when UHCI_HEAD_EN is 0.
pub type PKT_THRS_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
impl R {
    ///Bits 0:12 - Configures the data packet's maximum length when UHCI_HEAD_EN is 0.
    #[inline(always)]
