...
///Field `UART_SEL` reader - Select which uart to connect with GDMA.
pub type UART_SEL_R = crate::FieldReader;
///Field `UART_SEL` writer - Select which uart to connect with GDMA.
...
impl R {
    ...
    ///Bits 2:4 - Select which uart to connect with GDMA.
    #[inline(always)]
