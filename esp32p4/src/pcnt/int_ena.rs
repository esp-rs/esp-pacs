    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            .field(
                ...
                &format_args!("{}", self.cnt_thr_event_u0_int_ena().bit()),
            )
            .field(
                "cnt_thr_event_u1_int_ena",
                &format_args!("{}", self.cnt_thr_event_u1_int_ena().bit()),
            )
            .field(
                "cnt_thr_event_u2_int_ena",
                &format_args!("{}", self.cnt_thr_event_u2_int_ena().bit()),
            )
            .field(
                "cnt_thr_event_u3_int_ena",
                &format_args!("{}", self.cnt_thr_event_u3_int_ena().bit()),
            )
            .finish()
    }
}
