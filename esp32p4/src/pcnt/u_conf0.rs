...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("U_CONF0")
            .field(
                "filter_thres_u",
                &format_args!("{}", self.filter_thres_u().bits()),
            )
            .field("filter_en_u", &format_args!("{}", self.filter_en_u().bit()))
            .field(
                "thr_zero_en_u",
                &format_args!("{}", self.thr_zero_en_u().bit()),
            )
            .field(
                "thr_h_lim_en_u",
                &format_args!("{}", self.thr_h_lim_en_u().bit()),
            )
            .field(
                "thr_l_lim_en_u",
                &format_args!("{}", self.thr_l_lim_en_u().bit()),
            )
            .field(
                "thr_thres0_en_u",
                &format_args!("{}", self.thr_thres0_en_u().bit()),
            )
            .field(
                "thr_thres1_en_u",
                &format_args!("{}", self.thr_thres1_en_u().bit()),
            )
            .field(
                "ch0_neg_mode_u",
                &format_args!("{}", self.ch0_neg_mode_u().bits()),
            )
            .field(
                "ch0_pos_mode_u",
                &format_args!("{}", self.ch0_pos_mode_u().bits()),
            )
            .field(
                "ch0_hctrl_mode_u",
                &format_args!("{}", self.ch0_hctrl_mode_u().bits()),
            )
            .field(
                "ch0_lctrl_mode_u",
                &format_args!("{}", self.ch0_lctrl_mode_u().bits()),
            )
            .field(
                "ch1_neg_mode_u",
                &format_args!("{}", self.ch1_neg_mode_u().bits()),
            )
            .field(
                "ch1_pos_mode_u",
                &format_args!("{}", self.ch1_pos_mode_u().bits()),
            )
            .field(
                "ch1_hctrl_mode_u",
                &format_args!("{}", self.ch1_hctrl_mode_u().bits()),
            )
            .field(
                "ch1_lctrl_mode_u",
                &format_args!("{}", self.ch1_lctrl_mode_u().bits()),
            )
            .finish()
    }
}
