///Register `U2_CHANGE_CONF` reader
pub type R = crate::R<U2_CHANGE_CONF_SPEC>;
///Register `U2_CHANGE_CONF` writer
pub type W = crate::W<U2_CHANGE_CONF_SPEC>;
///Field `CNT_STEP_U2` reader - Configures the step value for unit 2.
pub type CNT_STEP_U2_R = crate::FieldReader<u16>;
///Field `CNT_STEP_U2` writer - Configures the step value for unit 2.
pub type CNT_STEP_U2_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `CNT_STEP_LIM_U2` reader - Configures the step limit value for unit 2.
pub type CNT_STEP_LIM_U2_R = crate::FieldReader<u16>;
///Field `CNT_STEP_LIM_U2` writer - Configures the step limit value for unit 2.
pub type CNT_STEP_LIM_U2_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - Configures the step value for unit 2.
    #[inline(always)]
    pub fn cnt_step_u2(&self) -> CNT_STEP_U2_R {
        CNT_STEP_U2_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - Configures the step limit value for unit 2.
    #[inline(always)]
...
///`read()` method returns [`u2_change_conf::R`](R) reader structure
impl crate::Readable for U2_CHANGE_CONF_SPEC {}
///`write(|w| ..)` method takes [`u2_change_conf::W`](W) writer structure
