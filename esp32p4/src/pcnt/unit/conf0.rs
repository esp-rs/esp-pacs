...
///Field `FILTER_THRES` reader - This sets the maximum threshold, in APB_CLK cycles, for the filter. Any pulses with width less than this will be ignored when the filter is enabled.
pub type FILTER_THRES_R = crate::FieldReader<u16>;
///Field `FILTER_THRES` writer - This sets the maximum threshold, in APB_CLK cycles, for the filter. Any pulses with width less than this will be ignored when the filter is enabled.
pub type FILTER_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `FILTER_EN` reader - This is the enable bit for unit %s's input filter.
pub type FILTER_EN_R = crate::BitReader;
///Field `FILTER_EN` writer - This is the enable bit for unit %s's input filter.
pub type FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THR_ZERO_EN` reader - This is the enable bit for unit %s's zero comparator.
pub type THR_ZERO_EN_R = crate::BitReader;
///Field `THR_ZERO_EN` writer - This is the enable bit for unit %s's zero comparator.
pub type THR_ZERO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THR_H_LIM_EN` reader - This is the enable bit for unit %s's thr_h_lim comparator. Configures it to enable the high limit interrupt.
pub type THR_H_LIM_EN_R = crate::BitReader;
///Field `THR_H_LIM_EN` writer - This is the enable bit for unit %s's thr_h_lim comparator. Configures it to enable the high limit interrupt.
pub type THR_H_LIM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THR_L_LIM_EN` reader - This is the enable bit for unit %s's thr_l_lim comparator. Configures it to enable the low limit interrupt.
pub type THR_L_LIM_EN_R = crate::BitReader;
///Field `THR_L_LIM_EN` writer - This is the enable bit for unit %s's thr_l_lim comparator. Configures it to enable the low limit interrupt.
pub type THR_L_LIM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THR_THRES0_EN` reader - This is the enable bit for unit %s's thres0 comparator.
pub type THR_THRES0_EN_R = crate::BitReader;
///Field `THR_THRES0_EN` writer - This is the enable bit for unit %s's thres0 comparator.
pub type THR_THRES0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THR_THRES1_EN` reader - This is the enable bit for unit %s's thres1 comparator.
pub type THR_THRES1_EN_R = crate::BitReader;
///Field `THR_THRES1_EN` writer - This is the enable bit for unit %s's thres1 comparator.
