...
///Field `CNT_THRES0` reader - This register is used to configure the thres0 value for unit %s.
pub type CNT_THRES0_R = crate::FieldReader<u16>;
///Field `CNT_THRES0` writer - This register is used to configure the thres0 value for unit %s.
pub type CNT_THRES0_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `CNT_THRES1` reader - This register is used to configure the thres1 value for unit %s.
pub type CNT_THRES1_R = crate::FieldReader<u16>;
///Field `CNT_THRES1` writer - This register is used to configure the thres1 value for unit %s.
