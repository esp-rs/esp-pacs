///Register `U%s_CNT` reader
pub type R = crate::R<U_CNT_SPEC>;
///Field `CNT` reader - This register stores the current pulse count value for unit %s.
pub type CNT_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - This register stores the current pulse count value for unit %s.
    #[inline(always)]
...
///`read()` method returns [`u_cnt::R`](R) reader structure
