///Register `FILTER_S_COMPARATOR_MATCH` reader
pub type R = crate::R<FILTER_S_COMPARATOR_MATCH_SPEC>;
///Register `FILTER_S_COMPARATOR_MATCH` writer
pub type W = crate::W<FILTER_S_COMPARATOR_MATCH_SPEC>;
///Field `S_MATCH` reader - secondary comparator match value
pub type S_MATCH_R = crate::FieldReader<u32>;
///Field `S_MATCH` writer - secondary comparator match value
pub type S_MATCH_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - secondary comparator match value
    #[inline(always)]
...
///`read()` method returns [`filter_s_comparator_match::R`](R) reader structure
impl crate::Readable for FILTER_S_COMPARATOR_MATCH_SPEC {}
///`write(|w| ..)` method takes [`filter_s_comparator_match::W`](W) writer structure
