...
///Field `ON` writer - Configure whether or not start trace.\\1: start trace \\0: invalid\\
...
///Field `MEM_LOOP` reader - Configure memory loop mode. \\1: trace will loop wrtie trace_mem. \\0: when mem_current_addr at mem_end_addr, it will stop at the mem_end_addr\\
pub type MEM_LOOP_R = crate::BitReader;
///Field `MEM_LOOP` writer - Configure memory loop mode. \\1: trace will loop wrtie trace_mem. \\0: when mem_current_addr at mem_end_addr, it will stop at the mem_end_addr\\
pub type MEM_LOOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RESTART_ENA` reader - Configure whether or not enable auto-restart.\\1: enable\\0: disable\\
pub type RESTART_ENA_R = crate::BitReader;
///Field `RESTART_ENA` writer - Configure whether or not enable auto-restart.\\1: enable\\0: disable\\
pub type RESTART_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 2 - Configure memory loop mode. \\1: trace will loop wrtie trace_mem. \\0: when mem_current_addr at mem_end_addr, it will stop at the mem_end_addr\\
    #[inline(always)]
    pub fn mem_loop(&self) -> MEM_LOOP_R {
        MEM_LOOP_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Configure whether or not enable auto-restart.\\1: enable\\0: disable\\
    #[inline(always)]
...
impl W {
    ///Bit 0 - Configure whether or not start trace.\\1: start trace \\0: invalid\\
    #[inline(always)]
    #[must_use]
    pub fn on(&mut self) -> ON_W<TRIGGER_SPEC> {
        ON_W::new(self, 0)
    }
    ///Bit 1 - Configure whether or not stop trace.\\1: stop trace \\0: invalid\\
    #[inline(always)]
    #[must_use]
