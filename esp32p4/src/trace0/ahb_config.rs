///Register `AHB_CONFIG` reader
pub type R = crate::R<AHB_CONFIG_SPEC>;
///Register `AHB_CONFIG` writer
pub type W = crate::W<AHB_CONFIG_SPEC>;
///Field `HBURST` reader - set hburst
pub type HBURST_R = crate::FieldReader;
///Field `HBURST` writer - set hburst
pub type HBURST_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `MAX_INCR` reader - set max continuous access for incr mode
pub type MAX_INCR_R = crate::FieldReader;
///Field `MAX_INCR` writer - set max continuous access for incr mode
...
impl R {
    ...
    ///Bits 3:5 - set max continuous access for incr mode
    #[inline(always)]
...
///`read()` method returns [`ahb_config::R`](R) reader structure
impl crate::Readable for AHB_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`ahb_config::W`](W) writer structure
