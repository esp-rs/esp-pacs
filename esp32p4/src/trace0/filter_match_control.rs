///Register `FILTER_MATCH_CONTROL` reader
pub type R = crate::R<FILTER_MATCH_CONTROL_SPEC>;
///Register `FILTER_MATCH_CONTROL` writer
pub type W = crate::W<FILTER_MATCH_CONTROL_SPEC>;
///Field `MATCH_CHOICE_PRIVILEGE` reader - Select match which privilege level when \hyperref\[fielddesc:TRACEMATCHPRIVILEGE\]{TRACE_MATCH_PRIVILEGE} is set. \\1: machine mode. \\0: user mode
pub type MATCH_CHOICE_PRIVILEGE_R = crate::BitReader;
///Field `MATCH_CHOICE_PRIVILEGE` writer - Select match which privilege level when \hyperref\[fielddesc:TRACEMATCHPRIVILEGE\]{TRACE_MATCH_PRIVILEGE} is set. \\1: machine mode. \\0: user mode
pub type MATCH_CHOICE_PRIVILEGE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MATCH_VALUE_INTERRUPT` reader - Select which match which itype when \hyperref\[fielddesc:TRACEMATCHINTERRUPT\]{TRACE_MATCH_INTERRUP} is set. \\1: match itype of 2. \\0: match itype or 1.
pub type MATCH_VALUE_INTERRUPT_R = crate::BitReader;
///Field `MATCH_VALUE_INTERRUPT` writer - Select which match which itype when \hyperref\[fielddesc:TRACEMATCHINTERRUPT\]{TRACE_MATCH_INTERRUP} is set. \\1: match itype of 2. \\0: match itype or 1.
pub type MATCH_VALUE_INTERRUPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MATCH_CHOICE_ECAUSE` reader - specified which ecause matched.
pub type MATCH_CHOICE_ECAUSE_R = crate::FieldReader;
///Field `MATCH_CHOICE_ECAUSE` writer - specified which ecause matched.
pub type MATCH_CHOICE_ECAUSE_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bit 0 - Select match which privilege level when \hyperref\[fielddesc:TRACEMATCHPRIVILEGE\]{TRACE_MATCH_PRIVILEGE} is set. \\1: machine mode. \\0: user mode
    #[inline(always)]
...
///`read()` method returns [`filter_match_control::R`](R) reader structure
impl crate::Readable for FILTER_MATCH_CONTROL_SPEC {}
///`write(|w| ..)` method takes [`filter_match_control::W`](W) writer structure
