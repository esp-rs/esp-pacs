...
#[doc = "Field `ARB_TIMEOUT_NUM` reader - Arbiter timeout value"]
pub type ARB_TIMEOUT_NUM_R = crate::FieldReader<u16>;
#[doc = "Field `ARB_TIMEOUT_NUM` writer - Arbiter timeout value"]
pub type ARB_TIMEOUT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Arbiter timeout value"]
    #[inline(always)]
    pub fn arb_timeout_num(&self) -> ARB_TIMEOUT_NUM_R {
        ARB_TIMEOUT_NUM_R::new((self.bits & 0xffff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ARB_TIMEOUT")
            .field("arb_timeout_num", &self.arb_timeout_num())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:15 - Arbiter timeout value"]
    #[inline(always)]
    pub fn arb_timeout_num(&mut self) -> ARB_TIMEOUT_NUM_W<'_, ARB_TIMEOUT_SPEC> {
        ARB_TIMEOUT_NUM_W::new(self, 0)
    }
}
