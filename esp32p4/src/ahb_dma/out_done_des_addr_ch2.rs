...
pub type R = crate::R<OUT_DONE_DES_ADDR_CH2_SPEC>;
...
pub type OUT_DONE_DES_ADDR_CH2_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the address of the outlink descriptor when this descriptor is completed."]
    #[inline(always)]
    pub fn out_done_des_addr_ch2(&self) -> OUT_DONE_DES_ADDR_CH2_R {
        OUT_DONE_DES_ADDR_CH2_R::new(self.bits)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DONE_DES_ADDR_CH2")
            .field("out_done_des_addr_ch2", &self.out_done_des_addr_ch2())
            .finish()
    }
}
...
pub struct OUT_DONE_DES_ADDR_CH2_SPEC;
impl crate::RegisterSpec for OUT_DONE_DES_ADDR_CH2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`out_done_des_addr_ch2::R`](R) reader structure"]
impl crate::Readable for OUT_DONE_DES_ADDR_CH2_SPEC {}
#[doc = "`reset()` method sets OUT_DONE_DES_ADDR_CH2 to value 0"]
impl crate::Resettable for OUT_DONE_DES_ADDR_CH2_SPEC {}
