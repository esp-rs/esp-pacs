///Register `TX_CRC_DATA_EN_ADDR` reader
pub type R = crate::R<TX_CRC_DATA_EN_ADDR_SPEC>;
///Register `TX_CRC_DATA_EN_ADDR` writer
pub type W = crate::W<TX_CRC_DATA_EN_ADDR_SPEC>;
///Field `TX_CRC_DATA_EN_ADDR` reader - reserved
pub type TX_CRC_DATA_EN_ADDR_R = crate::FieldReader<u32>;
///Field `TX_CRC_DATA_EN_ADDR` writer - reserved
...
///`read()` method returns [`tx_crc_data_en_addr::R`](R) reader structure
impl crate::Readable for TX_CRC_DATA_EN_ADDR_SPEC {}
///`write(|w| ..)` method takes [`tx_crc_data_en_addr::W`](W) writer structure
impl crate::Writable for TX_CRC_DATA_EN_ADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TX_CRC_DATA_EN_ADDR to value 0
