...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TX_CRC_DATA_EN_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_crc_data_en_addr_ch(&mut self) -> TX_CRC_DATA_EN_ADDR_CH_W<TX_CRC_DATA_EN_ADDR_SPEC> {
