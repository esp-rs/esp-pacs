///Register `TX_CRC_EN_WR_DATA` reader
pub type R = crate::R<TX_CRC_EN_WR_DATA_SPEC>;
///Register `TX_CRC_EN_WR_DATA` writer
pub type W = crate::W<TX_CRC_EN_WR_DATA_SPEC>;
///Field `TX_CRC_EN_WR_DATA` reader - This register is used to enable tx ch0 crc 32bit on/off
pub type TX_CRC_EN_WR_DATA_R = crate::FieldReader<u32>;
///Field `TX_CRC_EN_WR_DATA` writer - This register is used to enable tx ch0 crc 32bit on/off
pub type TX_CRC_EN_WR_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This register is used to enable tx ch0 crc 32bit on/off
    #[inline(always)]
...
///`read()` method returns [`tx_crc_en_wr_data::R`](R) reader structure
impl crate::Readable for TX_CRC_EN_WR_DATA_SPEC {}
///`write(|w| ..)` method takes [`tx_crc_en_wr_data::W`](W) writer structure
impl crate::Writable for TX_CRC_EN_WR_DATA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TX_CRC_EN_WR_DATA to value 0
