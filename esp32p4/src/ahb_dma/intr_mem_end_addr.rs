///Register `INTR_MEM_END_ADDR` reader
pub type R = crate::R<INTR_MEM_END_ADDR_SPEC>;
///Register `INTR_MEM_END_ADDR` writer
pub type W = crate::W<INTR_MEM_END_ADDR_SPEC>;
///Field `ACCESS_INTR_MEM_END_ADDR` reader - The end address of accessible address space. The access address beyond this range would lead to descriptor error.
pub type ACCESS_INTR_MEM_END_ADDR_R = crate::FieldReader<u32>;
///Field `ACCESS_INTR_MEM_END_ADDR` writer - The end address of accessible address space. The access address beyond this range would lead to descriptor error.
...
///`read()` method returns [`intr_mem_end_addr::R`](R) reader structure
impl crate::Readable for INTR_MEM_END_ADDR_SPEC {}
///`write(|w| ..)` method takes [`intr_mem_end_addr::W`](W) writer structure
