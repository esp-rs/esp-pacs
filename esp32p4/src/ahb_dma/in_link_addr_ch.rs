...
#[doc = "Field `INLINK_ADDR_CH` reader - This register stores the 32 least significant bits of the first inlink descriptor's address."]
pub type INLINK_ADDR_CH_R = crate::FieldReader<u32>;
#[doc = "Field `INLINK_ADDR_CH` writer - This register stores the 32 least significant bits of the first inlink descriptor's address."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inlink_addr_ch(&mut self) -> INLINK_ADDR_CH_W<IN_LINK_ADDR_CH_SPEC> {
