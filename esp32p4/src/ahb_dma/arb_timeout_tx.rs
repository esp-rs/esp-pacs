///Register `ARB_TIMEOUT_TX` reader
pub type R = crate::R<ARB_TIMEOUT_TX_SPEC>;
///Register `ARB_TIMEOUT_TX` writer
pub type W = crate::W<ARB_TIMEOUT_TX_SPEC>;
///Field `ARB_TIMEOUT_TX` reader - This register is used to config arbiter time out value
pub type ARB_TIMEOUT_TX_R = crate::FieldReader<u16>;
///Field `ARB_TIMEOUT_TX` writer - This register is used to config arbiter time out value
...
///`read()` method returns [`arb_timeout_tx::R`](R) reader structure
impl crate::Readable for ARB_TIMEOUT_TX_SPEC {}
///`write(|w| ..)` method takes [`arb_timeout_tx::W`](W) writer structure
