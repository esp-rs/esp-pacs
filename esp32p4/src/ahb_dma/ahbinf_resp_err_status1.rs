...
#[doc = "Field `AHBINF_RESP_ERR_CH_ID` reader - Represents the AHB response error request channel id.bit\\[2\\]=1:TX channel.\\\\bit\\[2\\]=0:RX channel.\\\\"]
...
impl R {
    ...
    #[doc = "Bits 5:7 - Represents the AHB response error request channel id.bit\\[2\\]=1:TX channel.\\\\bit\\[2\\]=0:RX channel.\\\\"]
    #[inline(always)]
