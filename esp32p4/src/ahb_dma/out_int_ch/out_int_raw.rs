...
#[doc = "Field `OUT_DSCR_ERR_CH_INT_RAW` reader - The raw interrupt bit turns to high level when detecting outlink descriptor error including owner error and the second and third word error of outlink descriptor for Tx channel 0."]
pub type OUT_DSCR_ERR_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `OUT_DSCR_ERR_CH_INT_RAW` writer - The raw interrupt bit turns to high level when detecting outlink descriptor error including owner error and the second and third word error of outlink descriptor for Tx channel 0."]
...
#[doc = "Field `OUTFIFO_OVF_CH_INT_RAW` reader - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is overflow."]
pub type OUTFIFO_OVF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `OUTFIFO_OVF_CH_INT_RAW` writer - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is overflow."]
pub type OUTFIFO_OVF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_UDF_CH_INT_RAW` reader - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is underflow."]
pub type OUTFIFO_UDF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `OUTFIFO_UDF_CH_INT_RAW` writer - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is underflow."]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_INT_RAW")
            ...
            .field(
                ...
                &format_args!("{}", self.outfifo_ovf_ch_int_raw().bit()),
            )
            .field(
                "outfifo_udf_ch_int_raw",
                &format_args!("{}", self.outfifo_udf_ch_int_raw().bit()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn out_done_ch_int_raw(&mut self) -> OUT_DONE_CH_INT_RAW_W<OUT_INT_RAW_SPEC> {
        OUT_DONE_CH_INT_RAW_W::new(self, 0)
    }
    #[doc = "Bit 1 - The raw interrupt bit turns to high level when the last data pointed by one outlink descriptor has been read from memory for Tx channel 0."]
    #[inline(always)]
    #[must_use]
    pub fn out_eof_ch_int_raw(&mut self) -> OUT_EOF_CH_INT_RAW_W<OUT_INT_RAW_SPEC> {
        OUT_EOF_CH_INT_RAW_W::new(self, 1)
    }
    #[doc = "Bit 2 - The raw interrupt bit turns to high level when detecting outlink descriptor error including owner error and the second and third word error of outlink descriptor for Tx channel 0."]
    #[inline(always)]
    #[must_use]
    pub fn out_dscr_err_ch_int_raw(&mut self) -> OUT_DSCR_ERR_CH_INT_RAW_W<OUT_INT_RAW_SPEC> {
        OUT_DSCR_ERR_CH_INT_RAW_W::new(self, 2)
    }
    #[doc = "Bit 3 - The raw interrupt bit turns to high level when data corresponding a outlink (includes one link descriptor or few link descriptors) is transmitted out for Tx channel 0."]
    #[inline(always)]
    #[must_use]
    pub fn out_total_eof_ch_int_raw(&mut self) -> OUT_TOTAL_EOF_CH_INT_RAW_W<OUT_INT_RAW_SPEC> {
        OUT_TOTAL_EOF_CH_INT_RAW_W::new(self, 3)
    }
    #[doc = "Bit 4 - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is overflow."]
    #[inline(always)]
    #[must_use]
    pub fn outfifo_ovf_ch_int_raw(&mut self) -> OUTFIFO_OVF_CH_INT_RAW_W<OUT_INT_RAW_SPEC> {
        OUTFIFO_OVF_CH_INT_RAW_W::new(self, 4)
    }
    #[doc = "Bit 5 - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is underflow."]
    #[inline(always)]
    #[must_use]
    pub fn outfifo_udf_ch_int_raw(&mut self) -> OUTFIFO_UDF_CH_INT_RAW_W<OUT_INT_RAW_SPEC> {
