    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_INT_ENA")
            ...
            .field(
                ...
                &format_args!("{}", self.outfifo_ovf_ch_int_ena().bit()),
            )
            .field(
                "outfifo_udf_ch_int_ena",
                &format_args!("{}", self.outfifo_udf_ch_int_ena().bit()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn outfifo_ovf_ch_int_ena(&mut self) -> OUTFIFO_OVF_CH_INT_ENA_W<OUT_INT_ENA_SPEC> {
        OUTFIFO_OVF_CH_INT_ENA_W::new(self, 4)
    }
    #[doc = "Bit 5 - The interrupt enable bit for the OUTFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn outfifo_udf_ch_int_ena(&mut self) -> OUTFIFO_UDF_CH_INT_ENA_W<OUT_INT_ENA_SPEC> {
