...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn outfifo_ovf_ch_int_clr(&mut self) -> OUTFIFO_OVF_CH_INT_CLR_W<OUT_INT_CLR_SPEC> {
        OUTFIFO_OVF_CH_INT_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - Set this bit to clear the OUTFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn outfifo_udf_ch_int_clr(&mut self) -> OUTFIFO_UDF_CH_INT_CLR_W<OUT_INT_CLR_SPEC> {
