...
#[doc = "Field `OUT_DONE` writer - Write 1 to clear AHB_DMA_OUT_DONE_CH0_INT"]
pub type OUT_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_EOF` writer - Write 1 to clear AHB_DMA_OUT_EOF_CH0_INT"]
pub type OUT_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_DSCR_ERR` writer - Write 1 to clear AHB_DMA_OUT_DSCR_ERR_CH0_INT"]
pub type OUT_DSCR_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_TOTAL_EOF` writer - Write 1 to clear AHB_DMA_OUT_TOTAL_EOF_CH0_INT"]
pub type OUT_TOTAL_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUTFIFO_OVF` writer - Write 1 to clear AHB_DMA_OUTFIFO_OVF_CH0_INT"]
pub type OUTFIFO_OVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUTFIFO_UDF` writer - Write 1 to clear AHB_DMA_OUTFIFO_UDF_CH0_INT"]
pub type OUTFIFO_UDF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_AHBINF_RESP_ERR` writer - Write 1 to clear AHB_DMA_OUT_RESP_ERR_CH0_INT"]
pub type OUT_AHBINF_RESP_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn out_ahbinf_resp_err(&mut self) -> OUT_AHBINF_RESP_ERR_W<'_, CLR_SPEC> {
