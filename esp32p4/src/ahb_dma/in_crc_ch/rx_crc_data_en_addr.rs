///Register `RX_CRC_DATA_EN_ADDR` reader
pub type R = crate::R<RX_CRC_DATA_EN_ADDR_SPEC>;
///Register `RX_CRC_DATA_EN_ADDR` writer
pub type W = crate::W<RX_CRC_DATA_EN_ADDR_SPEC>;
///Field `RX_CRC_DATA_EN_ADDR` reader - reserved
pub type RX_CRC_DATA_EN_ADDR_R = crate::FieldReader<u32>;
///Field `RX_CRC_DATA_EN_ADDR` writer - reserved
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_CRC_DATA_EN_ADDR")
            .field("rx_crc_data_en_addr", &self.rx_crc_data_en_addr())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`rx_crc_data_en_addr::R`](R) reader structure
impl crate::Readable for RX_CRC_DATA_EN_ADDR_SPEC {}
///`write(|w| ..)` method takes [`rx_crc_data_en_addr::W`](W) writer structure
impl crate::Writable for RX_CRC_DATA_EN_ADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RX_CRC_DATA_EN_ADDR to value 0
