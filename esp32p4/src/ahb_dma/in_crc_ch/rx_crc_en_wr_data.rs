    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_CRC_EN_WR_DATA")
            .field(
                ...
                &format_args!("{}", self.rx_crc_en_wr_data_ch().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RX_CRC_EN_WR_DATA_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_crc_en_wr_data_ch(&mut self) -> RX_CRC_EN_WR_DATA_CH_W<RX_CRC_EN_WR_DATA_SPEC> {
