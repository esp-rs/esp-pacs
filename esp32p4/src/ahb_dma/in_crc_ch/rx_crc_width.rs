...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RX_CRC_WIDTH_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_crc_width_ch(&mut self) -> RX_CRC_WIDTH_CH_W<RX_CRC_WIDTH_SPEC> {
        RX_CRC_WIDTH_CH_W::new(self, 0)
    }
    #[doc = "Bit 2 - reserved"]
    #[inline(always)]
    #[must_use]
    pub fn rx_crc_lautch_flga_ch(&mut self) -> RX_CRC_LAUTCH_FLGA_CH_W<RX_CRC_WIDTH_SPEC> {
