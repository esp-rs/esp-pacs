///Register `RX_ARB_WEIGH_OPT_DIR` reader
pub type R = crate::R<RX_ARB_WEIGH_OPT_DIR_SPEC>;
///Register `RX_ARB_WEIGH_OPT_DIR` writer
pub type W = crate::W<RX_ARB_WEIGH_OPT_DIR_SPEC>;
///Field `RX_ARB_WEIGH_OPT_DIR` reader - reserved
pub type RX_ARB_WEIGH_OPT_DIR_R = crate::BitReader;
///Field `RX_ARB_WEIGH_OPT_DIR` writer - reserved
...
///`read()` method returns [`rx_arb_weigh_opt_dir::R`](R) reader structure
impl crate::Readable for RX_ARB_WEIGH_OPT_DIR_SPEC {}
///`write(|w| ..)` method takes [`rx_arb_weigh_opt_dir::W`](W) writer structure
impl crate::Writable for RX_ARB_WEIGH_OPT_DIR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RX_ARB_WEIGH_OPT_DIR to value 0
