...
#[doc = "Field `OUTFIFO_WDATA_CH` reader - This register stores the data that need to be pushed into AHB_DMA FIFO."]
pub type OUTFIFO_WDATA_CH_R = crate::FieldReader<u16>;
#[doc = "Field `OUTFIFO_WDATA_CH` writer - This register stores the data that need to be pushed into AHB_DMA FIFO."]
pub type OUTFIFO_WDATA_CH_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
#[doc = "Field `OUTFIFO_PUSH_CH` writer - Set this bit to push data into AHB_DMA FIFO."]
pub type OUTFIFO_PUSH_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:8 - This register stores the data that need to be pushed into AHB_DMA FIFO."]
    #[inline(always)]
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<OUT_PUSH_SPEC> {
...
impl W {
    ...
    #[doc = "Bit 9 - Set this bit to push data into AHB_DMA FIFO."]
    #[inline(always)]
    #[must_use]
