...
#[doc = "Field `OUTFIFO_WDATA` reader - This register stores the data that need to be pushed into AHB_DMA FIFO."]
pub type OUTFIFO_WDATA_R = crate::FieldReader<u16>;
#[doc = "Field `OUTFIFO_WDATA` writer - This register stores the data that need to be pushed into AHB_DMA FIFO."]
pub type OUTFIFO_WDATA_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
#[doc = "Field `OUTFIFO_PUSH` writer - Set this bit to push data into AHB_DMA FIFO."]
