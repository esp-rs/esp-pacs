...
pub type R = crate::R<IN_PERI_SPEC>;
#[doc = "Register `IN_PERI` writer"]
pub type W = crate::W<IN_PERI_SPEC>;
...
impl W {
    #[doc = "Bits 0:3 - Configures the priority of RX channel 0.The larger of the value, the higher of the priority.."]
    #[inline(always)]
    pub fn rx_pri_ch0(&mut self) -> RX_PRI_CH0_W<'_, IN_PERI_SPEC> {
...
pub struct IN_PERI_SPEC;
impl crate::RegisterSpec for IN_PERI_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`in_peri::R`](R) reader structure"]
impl crate::Readable for IN_PERI_SPEC {}
#[doc = "`write(|w| ..)` method takes [`in_peri::W`](W) writer structure"]
impl crate::Writable for IN_PERI_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IN_PERI to value 0"]
impl crate::Resettable for IN_PERI_SPEC {}
