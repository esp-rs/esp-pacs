...
///Field `OUT_RST` reader - This bit is used to reset AHB_DMA channel 1 Tx FSM and Tx FIFO pointer.
pub type OUT_RST_R = crate::BitReader;
///Field `OUT_RST` writer - This bit is used to reset AHB_DMA channel 1 Tx FSM and Tx FIFO pointer.
...
///Field `OUT_EOF_MODE` reader - EOF flag generation mode when transmitting data. 1: EOF flag for Tx channel 1 is generated when data need to transmit has been popped from FIFO in AHB_DMA
pub type OUT_EOF_MODE_R = crate::BitReader;
///Field `OUT_EOF_MODE` writer - EOF flag generation mode when transmitting data. 1: EOF flag for Tx channel 1 is generated when data need to transmit has been popped from FIFO in AHB_DMA
...
impl R {
    ///Bit 0 - This bit is used to reset AHB_DMA channel 1 Tx FSM and Tx FIFO pointer.
    #[inline(always)]
    ...
    ///Bit 3 - EOF flag generation mode when transmitting data. 1: EOF flag for Tx channel 1 is generated when data need to transmit has been popped from FIFO in AHB_DMA
    #[inline(always)]
    ...
    ///Bit 6 - Set this bit to 1 to enable etm control mode, dma Tx channel 1 is triggered by etm task.
    #[inline(always)]
