...
///Field `IN_RST` reader - This bit is used to reset AHB_DMA channel 0 Rx FSM and Rx FIFO pointer.
pub type IN_RST_R = crate::BitReader;
///Field `IN_RST` writer - This bit is used to reset AHB_DMA channel 0 Rx FSM and Rx FIFO pointer.
...
///Field `MEM_TRANS_EN` reader - Set this bit 1 to enable automatic transmitting data from memory to memory via AHB_DMA.
pub type MEM_TRANS_EN_R = crate::BitReader;
///Field `MEM_TRANS_EN` writer - Set this bit 1 to enable automatic transmitting data from memory to memory via AHB_DMA.
...
impl R {
    ///Bit 0 - This bit is used to reset AHB_DMA channel 0 Rx FSM and Rx FIFO pointer.
    #[inline(always)]
    ...
    ///Bit 4 - Set this bit 1 to enable automatic transmitting data from memory to memory via AHB_DMA.
    #[inline(always)]
