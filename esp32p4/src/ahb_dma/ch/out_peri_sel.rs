///Register `OUT_PERI_SEL` reader
pub type R = crate::R<OUT_PERI_SEL_SPEC>;
///Register `OUT_PERI_SEL` writer
pub type W = crate::W<OUT_PERI_SEL_SPEC>;
///Field `PERI_OUT_SEL` reader - This register is used to select peripheral for Tx channel 0. I3C. 1: Dummy. 2: UHCI0. 3: I2S0. 4: I2S1. 5: I2S2. 6: Dummy. 7: Dummy. 8: ADC_DAC. 9: Dummy. 10: RMT,11~15: Dummy
pub type PERI_OUT_SEL_R = crate::FieldReader;
///Field `PERI_OUT_SEL` writer - This register is used to select peripheral for Tx channel 0. I3C. 1: Dummy. 2: UHCI0. 3: I2S0. 4: I2S1. 5: I2S2. 6: Dummy. 7: Dummy. 8: ADC_DAC. 9: Dummy. 10: RMT,11~15: Dummy
pub type PERI_OUT_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - This register is used to select peripheral for Tx channel 0. I3C. 1: Dummy. 2: UHCI0. 3: I2S0. 4: I2S1. 5: I2S2. 6: Dummy. 7: Dummy. 8: ADC_DAC. 9: Dummy. 10: RMT,11~15: Dummy
    #[inline(always)]
...
///`read()` method returns [`out_peri_sel::R`](R) reader structure
impl crate::Readable for OUT_PERI_SEL_SPEC {}
///`write(|w| ..)` method takes [`out_peri_sel::W`](W) writer structure
