...
#[doc = "Field `INLINK_STOP` writer - Configures whether to stop AHB_DMA's RX channel 0 from receiving data.\\\\0: Invalid. No effect\\\\1: Stop\\\\"]
pub type INLINK_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INLINK_START` writer - Configures whether to enable AHB_DMA's RX channel 0 for data transfer.\\\\0: Disable\\\\1: Enable\\\\"]
pub type INLINK_START_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INLINK_RESTART` writer - Configures whether to restart RX channel 0 for AHB_DMA transfer.\\\\0: Invalid. No effect\\\\1: Restart\\\\"]
