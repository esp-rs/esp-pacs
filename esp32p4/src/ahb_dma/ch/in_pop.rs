...
#[doc = "Field `INFIFO_RDATA_CH` reader - This register stores the data popping from AHB_DMA FIFO."]
pub type INFIFO_RDATA_CH_R = crate::FieldReader<u16>;
#[doc = "Field `INFIFO_POP_CH` writer - Set this bit to pop data from AHB_DMA FIFO."]
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<IN_POP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn infifo_pop_ch(&mut self) -> INFIFO_POP_CH_W<IN_POP_SPEC> {
