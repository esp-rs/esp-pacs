...
///Field `INFIFO_RDATA` reader - This register stores the data popping from AHB_DMA FIFO.
pub type INFIFO_RDATA_R = crate::FieldReader<u16>;
///Field `INFIFO_POP` writer - Set this bit to pop data from AHB_DMA FIFO.
pub type INFIFO_POP_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:11 - This register stores the data popping from AHB_DMA FIFO.
    #[inline(always)]
...
impl W {
    ///Bit 12 - Set this bit to pop data from AHB_DMA FIFO.
    #[inline(always)]
    #[must_use]
