...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn outlink_stop_ch(&mut self) -> OUTLINK_STOP_CH_W<OUT_LINK_SPEC> {
        OUTLINK_STOP_CH_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set this bit to start dealing with the outlink descriptors."]
    #[inline(always)]
    #[must_use]
    pub fn outlink_start_ch(&mut self) -> OUTLINK_START_CH_W<OUT_LINK_SPEC> {
        OUTLINK_START_CH_W::new(self, 1)
    }
    #[doc = "Bit 2 - Set this bit to restart a new outlink from the last address."]
    #[inline(always)]
    #[must_use]
    pub fn outlink_restart_ch(&mut self) -> OUTLINK_RESTART_CH_W<OUT_LINK_SPEC> {
