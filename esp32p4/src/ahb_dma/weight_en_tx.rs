///Register `WEIGHT_EN_TX` reader
pub type R = crate::R<WEIGHT_EN_TX_SPEC>;
///Register `WEIGHT_EN_TX` writer
pub type W = crate::W<WEIGHT_EN_TX_SPEC>;
///Field `WEIGHT_EN_TX` reader - This register is used to config arbiter weight function off/on
pub type WEIGHT_EN_TX_R = crate::BitReader;
///Field `WEIGHT_EN_TX` writer - This register is used to config arbiter weight function off/on
...
///`read()` method returns [`weight_en_tx::R`](R) reader structure
impl crate::Readable for WEIGHT_EN_TX_SPEC {}
///`write(|w| ..)` method takes [`weight_en_tx::W`](W) writer structure
