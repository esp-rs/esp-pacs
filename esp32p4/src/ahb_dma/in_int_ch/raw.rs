...
#[doc = "Field `IN_AHBINF_RESP_ERR` reader - The raw interrupt status of AHB_DMA_IN_RESP_ERR_CH0_INT"]
pub type IN_AHBINF_RESP_ERR_R = crate::BitReader;
#[doc = "Field `IN_AHBINF_RESP_ERR` writer - The raw interrupt status of AHB_DMA_IN_RESP_ERR_CH0_INT"]
