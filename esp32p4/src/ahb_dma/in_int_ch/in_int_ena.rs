...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn infifo_ovf_ch_int_ena(&mut self) -> INFIFO_OVF_CH_INT_ENA_W<IN_INT_ENA_SPEC> {
        INFIFO_OVF_CH_INT_ENA_W::new(self, 5)
    }
    #[doc = "Bit 6 - The interrupt enable bit for the INFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_udf_ch_int_ena(&mut self) -> INFIFO_UDF_CH_INT_ENA_W<IN_INT_ENA_SPEC> {
