...
#[doc = "Field `IN_DONE` reader - The masked interrupt status of AHB_DMA_IN_DONE_CH0_INT"]
pub type IN_DONE_R = crate::BitReader;
#[doc = "Field `IN_SUC_EOF` reader - The masked interrupt status of AHB_DMA_IN_SUC_EOF_CH0_INT"]
pub type IN_SUC_EOF_R = crate::BitReader;
#[doc = "Field `IN_ERR_EOF` reader - The masked interrupt status of AHB_DMA_IN_ERR_EOF_CH0_INT"]
pub type IN_ERR_EOF_R = crate::BitReader;
#[doc = "Field `IN_DSCR_ERR` reader - The masked interrupt status of AHB_DMA_IN_DSCR_ERR_CH0_INT"]
pub type IN_DSCR_ERR_R = crate::BitReader;
#[doc = "Field `IN_DSCR_EMPTY` reader - The masked interrupt status of AHB_DMA_IN_DSCR_EMPTY_CH0_INT"]
pub type IN_DSCR_EMPTY_R = crate::BitReader;
#[doc = "Field `INFIFO_OVF` reader - The masked interrupt status of AHB_DMA_INFIFO_OVF_CH0_INT"]
pub type INFIFO_OVF_R = crate::BitReader;
#[doc = "Field `INFIFO_UDF` reader - The masked interrupt status of AHB_DMA_INFIFO_UDF_CH0_INT"]
pub type INFIFO_UDF_R = crate::BitReader;
#[doc = "Field `IN_AHBINF_RESP_ERR` reader - The masked interrupt status of AHB_DMA_IN_RESP_ERR_CH0_INT"]
