...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn infifo_ovf_ch_int_raw(&mut self) -> INFIFO_OVF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
        INFIFO_OVF_CH_INT_RAW_W::new(self, 5)
    }
    #[doc = "Bit 6 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_udf_ch_int_raw(&mut self) -> INFIFO_UDF_CH_INT_RAW_W<IN_INT_RAW_SPEC> {
