...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn infifo_ovf_ch_int_clr(&mut self) -> INFIFO_OVF_CH_INT_CLR_W<IN_INT_CLR_SPEC> {
        INFIFO_OVF_CH_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Set this bit to clear the INFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_udf_ch_int_clr(&mut self) -> INFIFO_UDF_CH_INT_CLR_W<IN_INT_CLR_SPEC> {
