...
pub type R = crate::R<RX_ARB_WEIGHT_OPT_DIR_CH0_SPEC>;
#[doc = "Register `RX_ARB_WEIGHT_OPT_DIR_CH0` writer"]
pub type W = crate::W<RX_ARB_WEIGHT_OPT_DIR_CH0_SPEC>;
#[doc = "Field `RX_ARB_WEIGHT_OPT_DIS_CH0` reader - reserved"]
pub type RX_ARB_WEIGHT_OPT_DIS_CH0_R = crate::BitReader;
#[doc = "Field `RX_ARB_WEIGHT_OPT_DIS_CH0` writer - reserved"]
pub type RX_ARB_WEIGHT_OPT_DIS_CH0_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - reserved"]
    #[inline(always)]
    pub fn rx_arb_weight_opt_dis_ch0(&self) -> RX_ARB_WEIGHT_OPT_DIS_CH0_R {
        RX_ARB_WEIGHT_OPT_DIS_CH0_R::new((self.bits & 1) != 0)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_ARB_WEIGHT_OPT_DIR_CH0")
            .field(
                "rx_arb_weight_opt_dis_ch0",
                &self.rx_arb_weight_opt_dis_ch0(),
            )
            .finish()
    }
}
...
pub struct RX_ARB_WEIGHT_OPT_DIR_CH0_SPEC;
impl crate::RegisterSpec for RX_ARB_WEIGHT_OPT_DIR_CH0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_arb_weight_opt_dir_ch0::R`](R) reader structure"]
impl crate::Readable for RX_ARB_WEIGHT_OPT_DIR_CH0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`rx_arb_weight_opt_dir_ch0::W`](W) writer structure"]
impl crate::Writable for RX_ARB_WEIGHT_OPT_DIR_CH0_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RX_ARB_WEIGHT_OPT_DIR_CH0 to value 0"]
impl crate::Resettable for RX_ARB_WEIGHT_OPT_DIR_CH0_SPEC {}
