...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TX_CRC_EN_ADDR_CH")
            .field(
                "tx_crc_en_addr_ch",
                &format_args!("{}", self.tx_crc_en_addr_ch().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TX_CRC_EN_ADDR_CH_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_crc_en_addr_ch(&mut self) -> TX_CRC_EN_ADDR_CH_W<TX_CRC_EN_ADDR_CH_SPEC> {
