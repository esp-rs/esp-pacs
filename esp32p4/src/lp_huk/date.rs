...
///Field `DATE` reader - HUK Generator version control register.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - HUK Generator version control register.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - HUK Generator version control register.
    #[inline(always)]
