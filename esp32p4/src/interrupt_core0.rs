...
pub struct RegisterBlock {
    _reserved_0_core_0_intr: [u8; 0x0210],
    clock_gate: CLOCK_GATE,
    _reserved2: [u8; 0x0c],
    core_0_intr_status4: CORE_0_INTR_STATUS4,
    _reserved3: [u8; 0x04],
...
impl RegisterBlock {
    ...
    #[doc = "0x220 - NA"]
    #[inline(always)]
    pub const fn core_0_intr_status4(&self) -> &CORE_0_INTR_STATUS4 {
        &self.core_0_intr_status4
    }
    #[doc = "0x228 - NA"]
    #[inline(always)]
...
#[doc = "NA"]
pub mod clock_gate;
#[doc = "CORE_0_INTR_STATUS4 (r) register accessor: NA\n\nYou can [`read`](crate::Reg::read) this register and get [`core_0_intr_status4::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@core_0_intr_status4`] module"]
pub type CORE_0_INTR_STATUS4 = crate::Reg<core_0_intr_status4::CORE_0_INTR_STATUS4_SPEC>;
#[doc = "NA"]
pub mod core_0_intr_status4;
