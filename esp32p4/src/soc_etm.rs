...
impl RegisterBlock {
    ///0x00 - Channel enable status register
    #[inline(always)]
    ...
    ///0x0c - Channel enable status register
    #[inline(always)]
    ...
    ///0x1a8 - Events trigger status register
    #[inline(always)]
    pub const fn evt_st0(&self) -> &EVT_ST0 {
        &self.evt_st0
    }
    ///0x1ac - Events trigger status clear register
    #[inline(always)]
    pub const fn evt_st0_clr(&self) -> &EVT_ST0_CLR {
        &self.evt_st0_clr
    }
    ///0x1b0 - Events trigger status register
    #[inline(always)]
    pub const fn evt_st1(&self) -> &EVT_ST1 {
        &self.evt_st1
    }
    ///0x1b4 - Events trigger status clear register
    #[inline(always)]
    pub const fn evt_st1_clr(&self) -> &EVT_ST1_CLR {
        &self.evt_st1_clr
    }
    ///0x1b8 - Events trigger status register
    #[inline(always)]
    pub const fn evt_st2(&self) -> &EVT_ST2 {
        &self.evt_st2
    }
    ///0x1bc - Events trigger status clear register
    #[inline(always)]
    pub const fn evt_st2_clr(&self) -> &EVT_ST2_CLR {
        &self.evt_st2_clr
    }
    ///0x1c0 - Events trigger status register
    #[inline(always)]
    pub const fn evt_st3(&self) -> &EVT_ST3 {
        &self.evt_st3
    }
    ///0x1c4 - Events trigger status clear register
    #[inline(always)]
    pub const fn evt_st3_clr(&self) -> &EVT_ST3_CLR {
        &self.evt_st3_clr
    }
    ///0x1c8 - Events trigger status register
    #[inline(always)]
    pub const fn evt_st4(&self) -> &EVT_ST4 {
        &self.evt_st4
    }
    ///0x1cc - Events trigger status clear register
    #[inline(always)]
    pub const fn evt_st4_clr(&self) -> &EVT_ST4_CLR {
        &self.evt_st4_clr
    }
    ///0x1d0 - Events trigger status register
    #[inline(always)]
    pub const fn evt_st5(&self) -> &EVT_ST5 {
        &self.evt_st5
    }
    ///0x1d4 - Events trigger status clear register
    #[inline(always)]
    pub const fn evt_st5_clr(&self) -> &EVT_ST5_CLR {
        &self.evt_st5_clr
    }
    ///0x1d8 - Events trigger status register
    #[inline(always)]
    pub const fn evt_st6(&self) -> &EVT_ST6 {
        &self.evt_st6
    }
    ///0x1dc - Events trigger status clear register
    #[inline(always)]
    pub const fn evt_st6_clr(&self) -> &EVT_ST6_CLR {
        &self.evt_st6_clr
    }
    ///0x1e0 - Events trigger status register
    #[inline(always)]
    pub const fn evt_st7(&self) -> &EVT_ST7 {
        &self.evt_st7
    }
    ///0x1e4 - Events trigger status clear register
    #[inline(always)]
    pub const fn evt_st7_clr(&self) -> &EVT_ST7_CLR {
        &self.evt_st7_clr
    }
    ///0x1e8 - Tasks trigger status register
    #[inline(always)]
    pub const fn task_st0(&self) -> &TASK_ST0 {
        &self.task_st0
    }
    ///0x1ec - Tasks trigger status clear register
    #[inline(always)]
    pub const fn task_st0_clr(&self) -> &TASK_ST0_CLR {
        &self.task_st0_clr
    }
    ///0x1f0 - Tasks trigger status register
    #[inline(always)]
    pub const fn task_st1(&self) -> &TASK_ST1 {
        &self.task_st1
    }
    ///0x1f4 - Tasks trigger status clear register
    #[inline(always)]
    pub const fn task_st1_clr(&self) -> &TASK_ST1_CLR {
        &self.task_st1_clr
    }
    ///0x1f8 - Tasks trigger status register
    #[inline(always)]
    pub const fn task_st2(&self) -> &TASK_ST2 {
        &self.task_st2
    }
    ///0x1fc - Tasks trigger status clear register
    #[inline(always)]
    pub const fn task_st2_clr(&self) -> &TASK_ST2_CLR {
        &self.task_st2_clr
    }
    ///0x200 - Tasks trigger status register
    #[inline(always)]
    pub const fn task_st3(&self) -> &TASK_ST3 {
        &self.task_st3
    }
    ///0x204 - Tasks trigger status clear register
    #[inline(always)]
    pub const fn task_st3_clr(&self) -> &TASK_ST3_CLR {
        &self.task_st3_clr
    }
    ///0x208 - Tasks trigger status register
    #[inline(always)]
    pub const fn task_st4(&self) -> &TASK_ST4 {
        &self.task_st4
    }
    ///0x20c - Tasks trigger status clear register
    #[inline(always)]
    pub const fn task_st4_clr(&self) -> &TASK_ST4_CLR {
        &self.task_st4_clr
    }
    ///0x210 - Tasks trigger status register
    #[inline(always)]
    pub const fn task_st5(&self) -> &TASK_ST5 {
        &self.task_st5
    }
    ///0x214 - Tasks trigger status clear register
    #[inline(always)]
    pub const fn task_st5_clr(&self) -> &TASK_ST5_CLR {
        &self.task_st5_clr
    }
    ///0x218 - Tasks trigger status register
    #[inline(always)]
    pub const fn task_st6(&self) -> &TASK_ST6 {
        &self.task_st6
    }
    ///0x21c - Tasks trigger status clear register
    #[inline(always)]
    pub const fn task_st6_clr(&self) -> &TASK_ST6_CLR {
        &self.task_st6_clr
    }
    ///0x220 - ETM clock enable register
    #[inline(always)]
    pub const fn clk_en(&self) -> &CLK_EN {
        &self.clk_en
    }
    ///0x224 - ETM date register
    #[inline(always)]
    pub const fn date(&self) -> &DATE {
        &self.date
    }
}
/**CH_ENA_AD0 (rw) register accessor: Channel enable status register
...
/**CH_ENA_AD1 (rw) register accessor: Channel enable status register
...
///Cluster CH%s, containing CH*_EVT_ID, CH*_TASK_ID
pub mod ch;
/**EVT_ST0 (rw) register accessor: Events trigger status register
...
pub mod evt_st0;
/**EVT_ST0_CLR (w) register accessor: Events trigger status clear register
...
pub mod evt_st0_clr;
/**EVT_ST1 (rw) register accessor: Events trigger status register
...
///Events trigger status register
pub mod evt_st1;
/**EVT_ST1_CLR (w) register accessor: Events trigger status clear register
...
///Events trigger status clear register
pub mod evt_st1_clr;
/**EVT_ST2 (rw) register accessor: Events trigger status register
...
///Events trigger status register
pub mod evt_st2;
/**EVT_ST2_CLR (w) register accessor: Events trigger status clear register
...
///Events trigger status clear register
pub mod evt_st2_clr;
/**EVT_ST3 (rw) register accessor: Events trigger status register
...
///Events trigger status register
pub mod evt_st3;
/**EVT_ST3_CLR (w) register accessor: Events trigger status clear register
...
///Events trigger status clear register
pub mod evt_st3_clr;
/**EVT_ST4 (rw) register accessor: Events trigger status register
...
///Events trigger status register
pub mod evt_st4;
/**EVT_ST4_CLR (w) register accessor: Events trigger status clear register
...
///Events trigger status clear register
pub mod evt_st4_clr;
/**EVT_ST5 (rw) register accessor: Events trigger status register
...
///Events trigger status register
pub mod evt_st5;
/**EVT_ST5_CLR (w) register accessor: Events trigger status clear register
...
///Events trigger status clear register
pub mod evt_st5_clr;
/**EVT_ST6 (rw) register accessor: Events trigger status register
...
///Events trigger status register
pub mod evt_st6;
/**EVT_ST6_CLR (w) register accessor: Events trigger status clear register
...
///Events trigger status clear register
pub mod evt_st6_clr;
/**EVT_ST7 (rw) register accessor: Events trigger status register
...
///Events trigger status register
pub mod evt_st7;
/**EVT_ST7_CLR (w) register accessor: Events trigger status clear register
...
///Events trigger status clear register
pub mod evt_st7_clr;
/**TASK_ST0 (rw) register accessor: Tasks trigger status register
...
pub mod task_st0;
/**TASK_ST0_CLR (w) register accessor: Tasks trigger status clear register
...
/**TASK_ST1 (rw) register accessor: Tasks trigger status register
...
///Tasks trigger status register
pub mod task_st1;
/**TASK_ST1_CLR (w) register accessor: Tasks trigger status clear register
...
/**TASK_ST2 (rw) register accessor: Tasks trigger status register
...
///Tasks trigger status register
pub mod task_st2;
/**TASK_ST2_CLR (w) register accessor: Tasks trigger status clear register
...
/**TASK_ST3 (rw) register accessor: Tasks trigger status register
...
///Tasks trigger status register
pub mod task_st3;
/**TASK_ST3_CLR (w) register accessor: Tasks trigger status clear register
...
/**TASK_ST4 (rw) register accessor: Tasks trigger status register
...
///Tasks trigger status register
pub mod task_st4;
/**TASK_ST4_CLR (w) register accessor: Tasks trigger status clear register
...
/**TASK_ST5 (rw) register accessor: Tasks trigger status register
...
///Tasks trigger status register
pub mod task_st5;
/**TASK_ST5_CLR (w) register accessor: Tasks trigger status clear register
...
/**TASK_ST6 (rw) register accessor: Tasks trigger status register
...
///Tasks trigger status register
pub mod task_st6;
/**TASK_ST6_CLR (w) register accessor: Tasks trigger status clear register
