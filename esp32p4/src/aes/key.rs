...
///Register `KEY%s` writer
pub type W = crate::W<KEY_SPEC>;
///Field `KEY` reader - This bits stores key_0 that is a part of key material.
pub type KEY_R = crate::FieldReader<u32>;
///Field `KEY` writer - This bits stores key_0 that is a part of key material.
pub type KEY_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
    ///Bits 0:31 - This bits stores key_0 that is a part of key material.
    #[inline(always)]
