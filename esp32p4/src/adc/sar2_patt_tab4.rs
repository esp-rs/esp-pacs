...
///Register `SAR2_PATT_TAB4` writer
pub type W = crate::W<SAR2_PATT_TAB4_SPEC>;
///Field `SAR2_PATT_TAB4` reader - Item 12 ~ 15 for pattern table 2 (each item one byte)
pub type SAR2_PATT_TAB4_R = crate::FieldReader<u32>;
///Field `SAR2_PATT_TAB4` writer - Item 12 ~ 15 for pattern table 2 (each item one byte)
pub type SAR2_PATT_TAB4_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    ///Bits 0:23 - Item 12 ~ 15 for pattern table 2 (each item one byte)
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR2_PATT_TAB4")
            .field("sar2_patt_tab4", &self.sar2_patt_tab4())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`sar2_patt_tab4::R`](R) reader structure
impl crate::Readable for SAR2_PATT_TAB4_SPEC {}
///`write(|w| ..)` method takes [`sar2_patt_tab4::W`](W) writer structure
