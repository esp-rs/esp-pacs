...
#[doc = "Field `FILTER_FACTOR1` reader - need_des"]
pub type FILTER_FACTOR1_R = crate::FieldReader;
#[doc = "Field `FILTER_FACTOR1` writer - need_des"]
pub type FILTER_FACTOR1_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `FILTER_FACTOR0` reader - need_des"]
pub type FILTER_FACTOR0_R = crate::FieldReader;
#[doc = "Field `FILTER_FACTOR0` writer - need_des"]
