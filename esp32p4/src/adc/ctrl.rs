...
///Field `START_FORCE` reader - need_des
pub type START_FORCE_R = crate::BitReader;
///Field `START_FORCE` writer - need_des
pub type START_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `START` reader - need_des
pub type START_R = crate::BitReader;
///Field `START` writer - need_des
pub type START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WORK_MODE` reader - 0: single mode, 1: double mode, 2: alternate mode
pub type WORK_MODE_R = crate::FieldReader;
///Field `WORK_MODE` writer - 0: single mode, 1: double mode, 2: alternate mode
pub type WORK_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SAR_SEL` reader - 0: SAR1, 1: SAR2, only work for single SAR mode
pub type SAR_SEL_R = crate::BitReader;
///Field `SAR_SEL` writer - 0: SAR1, 1: SAR2, only work for single SAR mode
pub type SAR_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_CLK_GATED` reader - need_des
pub type SAR_CLK_GATED_R = crate::BitReader;
///Field `SAR_CLK_GATED` writer - need_des
...
///Field `SAR1_PATT_LEN` reader - 0 ~ 15 means length 1 ~ 16
pub type SAR1_PATT_LEN_R = crate::FieldReader;
///Field `SAR1_PATT_LEN` writer - 0 ~ 15 means length 1 ~ 16
pub type SAR1_PATT_LEN_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SAR2_PATT_LEN` reader - 0 ~ 15 means length 1 ~ 16
pub type SAR2_PATT_LEN_R = crate::FieldReader;
///Field `SAR2_PATT_LEN` writer - 0 ~ 15 means length 1 ~ 16
pub type SAR2_PATT_LEN_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SAR1_PATT_P_CLEAR` reader - clear the pointer of pattern table for DIG ADC1 CTRL
pub type SAR1_PATT_P_CLEAR_R = crate::BitReader;
///Field `SAR1_PATT_P_CLEAR` writer - clear the pointer of pattern table for DIG ADC1 CTRL
pub type SAR1_PATT_P_CLEAR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR2_PATT_P_CLEAR` reader - clear the pointer of pattern table for DIG ADC2 CTRL
pub type SAR2_PATT_P_CLEAR_R = crate::BitReader;
///Field `SAR2_PATT_P_CLEAR` writer - clear the pointer of pattern table for DIG ADC2 CTRL
pub type SAR2_PATT_P_CLEAR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DATA_SAR_SEL` reader - 1: sar_sel will be coded by the MSB of the 16-bit output data, in this case the resolution should not be larger than 11 bits.
pub type DATA_SAR_SEL_R = crate::BitReader;
///Field `DATA_SAR_SEL` writer - 1: sar_sel will be coded by the MSB of the 16-bit output data, in this case the resolution should not be larger than 11 bits.
pub type DATA_SAR_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DATA_TO_I2S` reader - 1: I2S input data is from SAR ADC (for DMA), 0: I2S input data is from GPIO matrix
pub type DATA_TO_I2S_R = crate::BitReader;
///Field `DATA_TO_I2S` writer - 1: I2S input data is from SAR ADC (for DMA), 0: I2S input data is from GPIO matrix
...
///Field `XPD_SAR1_FORCE` writer - force option to xpd sar1 blocks
pub type XPD_SAR1_FORCE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `XPD_SAR2_FORCE` reader - force option to xpd sar2 blocks
pub type XPD_SAR2_FORCE_R = crate::FieldReader;
///Field `XPD_SAR2_FORCE` writer - force option to xpd sar2 blocks
...
impl R {
    ...
    ///Bits 2:3 - 0: single mode, 1: double mode, 2: alternate mode
    #[inline(always)]
    pub fn work_mode(&self) -> WORK_MODE_R {
        WORK_MODE_R::new(((self.bits >> 2) & 3) as u8)
    }
    ///Bit 4 - 0: SAR1, 1: SAR2, only work for single SAR mode
    #[inline(always)]
    pub fn sar_sel(&self) -> SAR_SEL_R {
        SAR_SEL_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - need_des
    #[inline(always)]
    pub fn sar_clk_gated(&self) -> SAR_CLK_GATED_R {
        SAR_CLK_GATED_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bits 6:13 - SAR clock divider
    #[inline(always)]
    pub fn sar_clk_div(&self) -> SAR_CLK_DIV_R {
        SAR_CLK_DIV_R::new(((self.bits >> 6) & 0xff) as u8)
    }
    ///Bits 14:17 - 0 ~ 15 means length 1 ~ 16
    #[inline(always)]
    pub fn sar1_patt_len(&self) -> SAR1_PATT_LEN_R {
        SAR1_PATT_LEN_R::new(((self.bits >> 14) & 0x0f) as u8)
    }
    ///Bits 18:21 - 0 ~ 15 means length 1 ~ 16
    #[inline(always)]
    pub fn sar2_patt_len(&self) -> SAR2_PATT_LEN_R {
        SAR2_PATT_LEN_R::new(((self.bits >> 18) & 0x0f) as u8)
    }
    ///Bit 22 - clear the pointer of pattern table for DIG ADC1 CTRL
    #[inline(always)]
    pub fn sar1_patt_p_clear(&self) -> SAR1_PATT_P_CLEAR_R {
        SAR1_PATT_P_CLEAR_R::new(((self.bits >> 22) & 1) != 0)
    }
    ///Bit 23 - clear the pointer of pattern table for DIG ADC2 CTRL
    #[inline(always)]
    pub fn sar2_patt_p_clear(&self) -> SAR2_PATT_P_CLEAR_R {
        SAR2_PATT_P_CLEAR_R::new(((self.bits >> 23) & 1) != 0)
    }
    ///Bit 24 - 1: sar_sel will be coded by the MSB of the 16-bit output data, in this case the resolution should not be larger than 11 bits.
    #[inline(always)]
    pub fn data_sar_sel(&self) -> DATA_SAR_SEL_R {
        DATA_SAR_SEL_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - 1: I2S input data is from SAR ADC (for DMA), 0: I2S input data is from GPIO matrix
    #[inline(always)]
    pub fn data_to_i2s(&self) -> DATA_TO_I2S_R {
        DATA_TO_I2S_R::new(((self.bits >> 25) & 1) != 0)
    }
    ///Bits 26:27 - force option to xpd sar1 blocks
    #[inline(always)]
    pub fn xpd_sar1_force(&self) -> XPD_SAR1_FORCE_R {
        XPD_SAR1_FORCE_R::new(((self.bits >> 26) & 3) as u8)
    }
    ///Bits 28:29 - force option to xpd sar2 blocks
    #[inline(always)]
    pub fn xpd_sar2_force(&self) -> XPD_SAR2_FORCE_R {
        XPD_SAR2_FORCE_R::new(((self.bits >> 28) & 3) as u8)
    }
