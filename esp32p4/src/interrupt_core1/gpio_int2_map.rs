///Register `GPIO_INT2_MAP` reader
pub type R = crate::R<GPIO_INT2_MAP_SPEC>;
///Register `GPIO_INT2_MAP` writer
pub type W = crate::W<GPIO_INT2_MAP_SPEC>;
///Field `CORE1_GPIO_INT2_MAP` reader - NA
pub type CORE1_GPIO_INT2_MAP_R = crate::FieldReader;
///Field `CORE1_GPIO_INT2_MAP` writer - NA
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core1_gpio_int2_map(&mut self) -> CORE1_GPIO_INT2_MAP_W<GPIO_INT2_MAP_SPEC> {
...
///`read()` method returns [`gpio_int2_map::R`](R) reader structure
impl crate::Readable for GPIO_INT2_MAP_SPEC {}
///`write(|w| ..)` method takes [`gpio_int2_map::W`](W) writer structure
