...
#[doc = "Field `CORE1_I2S0_INT_MAP` reader - NA"]
pub type CORE1_I2S0_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE1_I2S0_INT_MAP` writer - NA"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2S0_INT_MAP")
            .field("core1_i2s0_int_map", &self.core1_i2s0_int_map().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core1_i2s0_int_map(&mut self) -> CORE1_I2S0_INT_MAP_W<I2S0_INT_MAP_SPEC> {
