...
///Field `CORE1_LP_I2C_INT_MAP` reader - NA
pub type CORE1_LP_I2C_INT_MAP_R = crate::FieldReader;
///Field `CORE1_LP_I2C_INT_MAP` writer - NA
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core1_lp_i2c_int_map(&mut self) -> CORE1_LP_I2C_INT_MAP_W<LP_I2C_INT_MAP_SPEC> {
