///Register `USB_OTG_ENDP_MULTI_PROC_INT_MAP` reader
pub type R = crate::R<USB_OTG_ENDP_MULTI_PROC_INT_MAP_SPEC>;
///Register `USB_OTG_ENDP_MULTI_PROC_INT_MAP` writer
...
impl W {
    ...
    pub fn core1_usb_otg_endp_multi_proc_int_map(
        &mut self,
    ) -> CORE1_USB_OTG_ENDP_MULTI_PROC_INT_MAP_W<USB_OTG_ENDP_MULTI_PROC_INT_MAP_SPEC> {
...
///`read()` method returns [`usb_otg_endp_multi_proc_int_map::R`](R) reader structure
impl crate::Readable for USB_OTG_ENDP_MULTI_PROC_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`usb_otg_endp_multi_proc_int_map::W`](W) writer structure
