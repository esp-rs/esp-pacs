...
#[doc = "Field `CORE1_ASSIST_DEBUG_INT_MAP` reader - NA"]
pub type CORE1_ASSIST_DEBUG_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE1_ASSIST_DEBUG_INT_MAP` writer - NA"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ASSIST_DEBUG_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.core1_assist_debug_int_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<ASSIST_DEBUG_INT_MAP_SPEC> {
