...
#[doc = "Field `CORE1_TIMERGRP0_WDT_INT_MAP` reader - NA"]
pub type CORE1_TIMERGRP0_WDT_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE1_TIMERGRP0_WDT_INT_MAP` writer - NA"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMERGRP0_WDT_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.core1_timergrp0_wdt_int_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TIMERGRP0_WDT_INT_MAP_SPEC> {
