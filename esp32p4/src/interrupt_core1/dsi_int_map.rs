///Register `DSI_INT_MAP` reader
pub type R = crate::R<DSI_INT_MAP_SPEC>;
///Register `DSI_INT_MAP` writer
pub type W = crate::W<DSI_INT_MAP_SPEC>;
///Field `CORE1_DSI_INT_MAP` reader - NA
pub type CORE1_DSI_INT_MAP_R = crate::FieldReader;
///Field `CORE1_DSI_INT_MAP` writer - NA
...
///`read()` method returns [`dsi_int_map::R`](R) reader structure
impl crate::Readable for DSI_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`dsi_int_map::W`](W) writer structure
