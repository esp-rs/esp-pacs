...
#[doc = "Field `CORE1_INTR_SRC_PASS_IN_SEC_STATUS_1` reader - NA"]
pub type CORE1_INTR_SRC_PASS_IN_SEC_STATUS_1_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - NA"]
    #[inline(always)]
    pub fn core1_intr_src_pass_in_sec_status_1(&self) -> CORE1_INTR_SRC_PASS_IN_SEC_STATUS_1_R {
        CORE1_INTR_SRC_PASS_IN_SEC_STATUS_1_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INTR_SRC_PASS_IN_SEC_STATUS_1")
            .field(
                "core1_intr_src_pass_in_sec_status_1",
                &self.core1_intr_src_pass_in_sec_status_1(),
            )
            .finish()
    }
}
