...
#[doc = "Field `CORE1_AXI_PDMA_OUT_CH2_INT_MAP` reader - NA"]
pub type CORE1_AXI_PDMA_OUT_CH2_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE1_AXI_PDMA_OUT_CH2_INT_MAP` writer - NA"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AXI_PDMA_OUT_CH2_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.core1_axi_pdma_out_ch2_int_map().bits()),
            )
            .finish()
    }
}
