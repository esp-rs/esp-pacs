...
///Field `CORE1_AXI_PDMA_OUT_CH2_INT_MAP` reader - NA
pub type CORE1_AXI_PDMA_OUT_CH2_INT_MAP_R = crate::FieldReader;
///Field `CORE1_AXI_PDMA_OUT_CH2_INT_MAP` writer - NA
...
impl W {
    ...
    pub fn core1_axi_pdma_out_ch2_int_map(
        &mut self,
    ) -> CORE1_AXI_PDMA_OUT_CH2_INT_MAP_W<AXI_PDMA_OUT_CH2_INT_MAP_SPEC> {
