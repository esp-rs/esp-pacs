...
#[doc = "Field `CORE1_PSRAM_MSPI_INT_MAP` reader - NA"]
pub type CORE1_PSRAM_MSPI_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE1_PSRAM_MSPI_INT_MAP` writer - NA"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PSRAM_MSPI_INT_MAP")
            .field(
                "core1_psram_mspi_int_map",
                &format_args!("{}", self.core1_psram_mspi_int_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PSRAM_MSPI_INT_MAP_SPEC> {
