...
#[doc = "Field `CORE1_UART3_INT_MAP` reader - NA"]
pub type CORE1_UART3_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE1_UART3_INT_MAP` writer - NA"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UART3_INT_MAP")
            .field("core1_uart3_int_map", &self.core1_uart3_int_map().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<UART3_INT_MAP_SPEC> {
