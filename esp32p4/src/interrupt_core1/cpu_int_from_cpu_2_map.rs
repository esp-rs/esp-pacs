///Register `CPU_INT_FROM_CPU_2_MAP` reader
pub type R = crate::R<CPU_INT_FROM_CPU_2_MAP_SPEC>;
///Register `CPU_INT_FROM_CPU_2_MAP` writer
pub type W = crate::W<CPU_INT_FROM_CPU_2_MAP_SPEC>;
///Field `CORE1_CPU_INT_FROM_CPU_2_MAP` reader - NA
pub type CORE1_CPU_INT_FROM_CPU_2_MAP_R = crate::FieldReader;
///Field `CORE1_CPU_INT_FROM_CPU_2_MAP` writer - NA
...
impl W {
    ...
    pub fn core1_cpu_int_from_cpu_2_map(
        &mut self,
    ) -> CORE1_CPU_INT_FROM_CPU_2_MAP_W<CPU_INT_FROM_CPU_2_MAP_SPEC> {
...
///`read()` method returns [`cpu_int_from_cpu_2_map::R`](R) reader structure
impl crate::Readable for CPU_INT_FROM_CPU_2_MAP_SPEC {}
///`write(|w| ..)` method takes [`cpu_int_from_cpu_2_map::W`](W) writer structure
