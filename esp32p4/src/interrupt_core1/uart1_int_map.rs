///Register `UART1_INT_MAP` reader
pub type R = crate::R<UART1_INT_MAP_SPEC>;
///Register `UART1_INT_MAP` writer
pub type W = crate::W<UART1_INT_MAP_SPEC>;
///Field `CORE1_UART1_INT_MAP` reader - NA
pub type CORE1_UART1_INT_MAP_R = crate::FieldReader;
///Field `CORE1_UART1_INT_MAP` writer - NA
...
///`read()` method returns [`uart1_int_map::R`](R) reader structure
impl crate::Readable for UART1_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`uart1_int_map::W`](W) writer structure
