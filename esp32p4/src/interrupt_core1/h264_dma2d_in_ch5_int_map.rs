...
#[doc = "Field `CORE1_H264_DMA2D_IN_CH5_INT_MAP` reader - NA"]
pub type CORE1_H264_DMA2D_IN_CH5_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CORE1_H264_DMA2D_IN_CH5_INT_MAP` writer - NA"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("H264_DMA2D_IN_CH5_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.core1_h264_dma2d_in_ch5_int_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<H264_DMA2D_IN_CH5_INT_MAP_SPEC> {
