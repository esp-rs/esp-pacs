...
///Field `LOAD_LO` reader - Low 32 bits of the value that a reload will load onto timer %s time-base Counter.
pub type LOAD_LO_R = crate::FieldReader<u32>;
///Field `LOAD_LO` writer - Low 32 bits of the value that a reload will load onto timer %s time-base Counter.
