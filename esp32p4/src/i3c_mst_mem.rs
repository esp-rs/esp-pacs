...
impl RegisterBlock {
    ...
    ///0x18 - In-Band Interrupt Buffer Status/Data Register. When receiving an IBI, IBI_PORT is used to both: Read the IBI Status Read the IBI Data(which is raw/opaque data)
    #[inline(always)]
...
/**COMMAND_BUF_PORT (rw) register accessor: NA
...
/**RESPONSE_BUF_PORT (r) register accessor: NA
...
/**RX_DATA_PORT (r) register accessor: NA
...
/**TX_DATA_PORT (rw) register accessor: NA
...
/**IBI_STATUS_BUF (r) register accessor: In-Band Interrupt Buffer Status/Data Register. When receiving an IBI, IBI_PORT is used to both: Read the IBI Status Read the IBI Data(which is raw/opaque data)
...
/**IBI_DATA_BUF (r) register accessor: NA
...
/**DEV_ADDR_TABLE1_LOC (rw) register accessor: NA
...
/**DEV_ADDR_TABLE2_LOC (rw) register accessor: NA
...
/**DEV_ADDR_TABLE3_LOC (rw) register accessor: NA
...
/**DEV_ADDR_TABLE4_LOC (rw) register accessor: NA
...
/**DEV_ADDR_TABLE5_LOC (rw) register accessor: NA
...
/**DEV_ADDR_TABLE6_LOC (rw) register accessor: NA
...
/**DEV_ADDR_TABLE7_LOC (rw) register accessor: NA
...
/**DEV_ADDR_TABLE8_LOC (rw) register accessor: NA
...
/**DEV_ADDR_TABLE9_LOC (rw) register accessor: NA
...
/**DEV_ADDR_TABLE10_LOC (rw) register accessor: NA
