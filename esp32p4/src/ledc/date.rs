...
#[doc = "Field `LEDC_DATE` reader - Configures the version."]
pub type LEDC_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `LEDC_DATE` writer - Configures the version."]
pub type LEDC_DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
...
impl W {
    #[doc = "Bits 0:27 - Configures the version."]
    #[inline(always)]
    pub fn ledc_date(&mut self) -> LEDC_DATE_W<'_, DATE_SPEC> {
...
#[doc = "`reset()` method sets DATE to value 0x0230_3070"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0230_3070;
}
