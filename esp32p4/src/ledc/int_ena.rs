...
///Field `DUTY_CHNG_END_CH(0-7)` reader - The interrupt enable bit for the DUTY_CHNG_END_CH%s interrupt.
pub type DUTY_CHNG_END_CH_R = crate::BitReader;
///Field `DUTY_CHNG_END_CH(0-7)` writer - The interrupt enable bit for the DUTY_CHNG_END_CH%s interrupt.
pub type DUTY_CHNG_END_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OVF_CNT_CH(0-7)` reader - The interrupt enable bit for the OVF_CNT_CH%s interrupt.
pub type OVF_CNT_CH_R = crate::BitReader;
///Field `OVF_CNT_CH(0-7)` writer - The interrupt enable bit for the OVF_CNT_CH%s interrupt.
...
impl R {
    ...
    ///The interrupt enable bit for the DUTY_CHNG_END_CH(0-7) interrupt.
    ///
    ...
    ///Bit 10 - The interrupt enable bit for the DUTY_CHNG_END_CH6 interrupt.
    #[inline(always)]
    pub fn duty_chng_end_ch6(&self) -> DUTY_CHNG_END_CH_R {
        DUTY_CHNG_END_CH_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - The interrupt enable bit for the DUTY_CHNG_END_CH7 interrupt.
    #[inline(always)]
    pub fn duty_chng_end_ch7(&self) -> DUTY_CHNG_END_CH_R {
        DUTY_CHNG_END_CH_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///The interrupt enable bit for the OVF_CNT_CH(0-7) interrupt.
    ///
    ...
    ///Bit 18 - The interrupt enable bit for the OVF_CNT_CH6 interrupt.
    #[inline(always)]
    pub fn ovf_cnt_ch6(&self) -> OVF_CNT_CH_R {
        OVF_CNT_CH_R::new(((self.bits >> 18) & 1) != 0)
    }
    ///Bit 19 - The interrupt enable bit for the OVF_CNT_CH7 interrupt.
    #[inline(always)]
