///Register `TIMER%s_CNT_CAP` reader
pub type R = crate::R<TIMER_CNT_CAP_SPEC>;
///Field `TIMER_CNT_CAP` reader - Represents the captured LEDC timer%s count value.
pub type TIMER_CNT_CAP_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:19 - Represents the captured LEDC timer%s count value.
    #[inline(always)]
...
///`read()` method returns [`timer_cnt_cap::R`](R) reader structure
