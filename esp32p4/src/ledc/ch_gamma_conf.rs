///Register `CH%s_GAMMA_CONF` reader
pub type R = crate::R<CH_GAMMA_CONF_SPEC>;
///Register `CH%s_GAMMA_CONF` writer
pub type W = crate::W<CH_GAMMA_CONF_SPEC>;
///Field `CH_GAMMA_ENTRY_NUM` reader - Configures the number of duty cycle fading rages for LEDC ch%s.
pub type CH_GAMMA_ENTRY_NUM_R = crate::FieldReader;
///Field `CH_GAMMA_ENTRY_NUM` writer - Configures the number of duty cycle fading rages for LEDC ch%s.
pub type CH_GAMMA_ENTRY_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `CH_GAMMA_PAUSE` writer - Configures whether or not to pause duty cycle fading of LEDC ch%s.\\0: Invalid. No effect\\1: Pause
pub type CH_GAMMA_PAUSE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_GAMMA_RESUME` writer - Configures whether or nor to resume duty cycle fading of LEDC ch%s.\\0: Invalid. No effect\\1: Resume
pub type CH_GAMMA_RESUME_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:4 - Configures the number of duty cycle fading rages for LEDC ch%s.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 5 - Configures whether or not to pause duty cycle fading of LEDC ch%s.\\0: Invalid. No effect\\1: Pause
    #[inline(always)]
    #[must_use]
    pub fn ch_gamma_pause(&mut self) -> CH_GAMMA_PAUSE_W<CH_GAMMA_CONF_SPEC> {
        CH_GAMMA_PAUSE_W::new(self, 5)
    }
    ///Bit 6 - Configures whether or nor to resume duty cycle fading of LEDC ch%s.\\0: Invalid. No effect\\1: Resume
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`ch_gamma_conf::R`](R) reader structure
impl crate::Readable for CH_GAMMA_CONF_SPEC {}
///`write(|w| ..)` method takes [`ch_gamma_conf::W`](W) writer structure
