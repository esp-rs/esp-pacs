...
impl TIMER {
    ...
    ///0x04 - Timer 0 current counter value register
    #[inline(always)]
    pub const fn value(&self) -> &VALUE {
        &self.value
    }
}
/**CONF (rw) register accessor: Timer 0 configuration register
...
pub mod conf;
/**VALUE (r) register accessor: Timer 0 current counter value register
