...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF")
            .field("apb_clk_sel", &self.apb_clk_sel().bits())
            .field("gamma_ram_clk_en_ch0", &self.gamma_ram_clk_en_ch0().bit())
            .field("gamma_ram_clk_en_ch1", &self.gamma_ram_clk_en_ch1().bit())
            .field("gamma_ram_clk_en_ch2", &self.gamma_ram_clk_en_ch2().bit())
            .field("gamma_ram_clk_en_ch3", &self.gamma_ram_clk_en_ch3().bit())
            .field("gamma_ram_clk_en_ch4", &self.gamma_ram_clk_en_ch4().bit())
            .field("gamma_ram_clk_en_ch5", &self.gamma_ram_clk_en_ch5().bit())
            .field("gamma_ram_clk_en_ch6", &self.gamma_ram_clk_en_ch6().bit())
            .field("gamma_ram_clk_en_ch7", &self.gamma_ram_clk_en_ch7().bit())
