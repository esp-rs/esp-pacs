...
///Field `DUTY_START` reader - Configures whether the duty cycle fading configurations take effect.\\0: Not take effect\\1: Take effect
pub type DUTY_START_R = crate::BitReader;
///Field `DUTY_START` writer - Configures whether the duty cycle fading configurations take effect.\\0: Not take effect\\1: Take effect
pub type DUTY_START_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 31 - Configures whether the duty cycle fading configurations take effect.\\0: Not take effect\\1: Take effect
    #[inline(always)]
