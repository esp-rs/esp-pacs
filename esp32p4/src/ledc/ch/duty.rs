...
///Field `DUTY` reader - Configures the duty of signal output on channel %s.
pub type DUTY_R = crate::FieldReader<u32>;
///Field `DUTY` writer - Configures the duty of signal output on channel %s.
pub type DUTY_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
    ///Bits 0:24 - Configures the duty of signal output on channel %s.
    #[inline(always)]
