...
///`read()` method returns [`config1::R`](R) reader structure
impl crate::Readable for CONFIG1_SPEC {}
///`write(|w| ..)` method takes [`config1::W`](W) writer structure
