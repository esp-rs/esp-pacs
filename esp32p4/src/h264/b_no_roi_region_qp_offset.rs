///Register `B_NO_ROI_REGION_QP_OFFSET` reader
pub type R = crate::R<B_NO_ROI_REGION_QP_OFFSET_SPEC>;
///Register `B_NO_ROI_REGION_QP_OFFSET` writer
pub type W = crate::W<B_NO_ROI_REGION_QP_OFFSET_SPEC>;
///Field `B_NO_ROI_REGION_QP` reader - Configure H264 no region qp in video B, delta qp.
pub type B_NO_ROI_REGION_QP_R = crate::FieldReader;
///Field `B_NO_ROI_REGION_QP` writer - Configure H264 no region qp in video B, delta qp.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("B_NO_ROI_REGION_QP_OFFSET")
            .field("b_no_roi_region_qp", &self.b_no_roi_region_qp())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`b_no_roi_region_qp_offset::R`](R) reader structure
impl crate::Readable for B_NO_ROI_REGION_QP_OFFSET_SPEC {}
///`write(|w| ..)` method takes [`b_no_roi_region_qp_offset::W`](W) writer structure
