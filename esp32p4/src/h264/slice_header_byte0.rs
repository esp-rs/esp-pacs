///Register `SLICE_HEADER_BYTE0` reader
pub type R = crate::R<SLICE_HEADER_BYTE0_SPEC>;
///Register `SLICE_HEADER_BYTE0` writer
pub type W = crate::W<SLICE_HEADER_BYTE0_SPEC>;
///Field `SLICE_BYTE_LSB` reader - Configures Slice Header low 32 bit
pub type SLICE_BYTE_LSB_R = crate::FieldReader<u32>;
///Field `SLICE_BYTE_LSB` writer - Configures Slice Header low 32 bit
pub type SLICE_BYTE_LSB_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures Slice Header low 32 bit
    #[inline(always)]
...
///`read()` method returns [`slice_header_byte0::R`](R) reader structure
impl crate::Readable for SLICE_HEADER_BYTE0_SPEC {}
///`write(|w| ..)` method takes [`slice_header_byte0::W`](W) writer structure
