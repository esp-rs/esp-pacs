...
pub type R = crate::R<DB_RD_TEMP_DEBUG_CONG_SPEC>;
#[doc = "Register `DB_RD_TEMP_DEBUG_CONG` writer"]
pub type W = crate::W<DB_RD_TEMP_DEBUG_CONG_SPEC>;
...
pub type DBG_REPLACE_RD_DB_TEMP_DATA_EN_R = crate::BitReader;
...
pub type DBG_REPLACE_RD_DB_TEMP_DATA_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DBG_REPLACE_RD_DB_TEMP_DATA` reader - Configure deblocking filter read temp data to be replaced.byte0~2 is VUY"]
pub type DBG_REPLACE_RD_DB_TEMP_DATA_R = crate::FieldReader<u32>;
#[doc = "Field `DBG_REPLACE_RD_DB_TEMP_DATA` writer - Configure deblocking filter read temp data to be replaced.byte0~2 is VUY"]
pub type DBG_REPLACE_RD_DB_TEMP_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bit 0 - Configure deblocking fliter whether or not to replace read temp data.\\\\0: not replace\\\\1: replace"]
    #[inline(always)]
    pub fn dbg_replace_rd_db_temp_data_en(&self) -> DBG_REPLACE_RD_DB_TEMP_DATA_EN_R {
        DBG_REPLACE_RD_DB_TEMP_DATA_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:24 - Configure deblocking filter read temp data to be replaced.byte0~2 is VUY"]
    #[inline(always)]
    pub fn dbg_replace_rd_db_temp_data(&self) -> DBG_REPLACE_RD_DB_TEMP_DATA_R {
        DBG_REPLACE_RD_DB_TEMP_DATA_R::new((self.bits >> 1) & 0x00ff_ffff)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DB_RD_TEMP_DEBUG_CONG")
            .field(
                "dbg_replace_rd_db_temp_data_en",
                &self.dbg_replace_rd_db_temp_data_en(),
            )
            .field(
                "dbg_replace_rd_db_temp_data",
                &self.dbg_replace_rd_db_temp_data(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn dbg_replace_rd_db_temp_data_en(
        &mut self,
    ) -> DBG_REPLACE_RD_DB_TEMP_DATA_EN_W<'_, DB_RD_TEMP_DEBUG_CONG_SPEC> {
        DBG_REPLACE_RD_DB_TEMP_DATA_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:24 - Configure deblocking filter read temp data to be replaced.byte0~2 is VUY"]
    #[inline(always)]
    pub fn dbg_replace_rd_db_temp_data(
        &mut self,
    ) -> DBG_REPLACE_RD_DB_TEMP_DATA_W<'_, DB_RD_TEMP_DEBUG_CONG_SPEC> {
        DBG_REPLACE_RD_DB_TEMP_DATA_W::new(self, 1)
    }
}
...
pub struct DB_RD_TEMP_DEBUG_CONG_SPEC;
impl crate::RegisterSpec for DB_RD_TEMP_DEBUG_CONG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`db_rd_temp_debug_cong::R`](R) reader structure"]
impl crate::Readable for DB_RD_TEMP_DEBUG_CONG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`db_rd_temp_debug_cong::W`](W) writer structure"]
impl crate::Writable for DB_RD_TEMP_DEBUG_CONG_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DB_RD_TEMP_DEBUG_CONG to value 0"]
impl crate::Resettable for DB_RD_TEMP_DEBUG_CONG_SPEC {}
