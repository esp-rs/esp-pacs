///Register `A_SYS_CONF` reader
pub type R = crate::R<A_SYS_CONF_SPEC>;
///Register `A_SYS_CONF` writer
pub type W = crate::W<A_SYS_CONF_SPEC>;
///Field `A_DB_TMP_READY_TRIGGER_MB_NUM` reader - Configures when to trigger video A H264_DB_TMP_READY_INT. When the (MB number of written db temp+1) is greater than this filed in first MB line, trigger H264_DB_TMP_READY_INT. Min is 3.
pub type A_DB_TMP_READY_TRIGGER_MB_NUM_R = crate::FieldReader;
///Field `A_DB_TMP_READY_TRIGGER_MB_NUM` writer - Configures when to trigger video A H264_DB_TMP_READY_INT. When the (MB number of written db temp+1) is greater than this filed in first MB line, trigger H264_DB_TMP_READY_INT. Min is 3.
pub type A_DB_TMP_READY_TRIGGER_MB_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `A_REC_READY_TRIGGER_MB_LINES` reader - Configures when to trigger video A H264_REC_READY_INT. When the MB line number of generated reconstruct pixel is greater than this filed, trigger H264_REC_READY_INT. Min is 4.
pub type A_REC_READY_TRIGGER_MB_LINES_R = crate::FieldReader;
///Field `A_REC_READY_TRIGGER_MB_LINES` writer - Configures when to trigger video A H264_REC_READY_INT. When the MB line number of generated reconstruct pixel is greater than this filed, trigger H264_REC_READY_INT. Min is 4.
pub type A_REC_READY_TRIGGER_MB_LINES_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `A_INTRA_COST_CMP_OFFSET` reader - Configures video A intra cost offset when I MB compared with P MB.
pub type A_INTRA_COST_CMP_OFFSET_R = crate::FieldReader<u16>;
///Field `A_INTRA_COST_CMP_OFFSET` writer - Configures video A intra cost offset when I MB compared with P MB.
pub type A_INTRA_COST_CMP_OFFSET_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:6 - Configures when to trigger video A H264_DB_TMP_READY_INT. When the (MB number of written db temp+1) is greater than this filed in first MB line, trigger H264_DB_TMP_READY_INT. Min is 3.
    #[inline(always)]
    ...
    ///Bits 7:13 - Configures when to trigger video A H264_REC_READY_INT. When the MB line number of generated reconstruct pixel is greater than this filed, trigger H264_REC_READY_INT. Min is 4.
    #[inline(always)]
...
///`read()` method returns [`a_sys_conf::R`](R) reader structure
impl crate::Readable for A_SYS_CONF_SPEC {}
///`write(|w| ..)` method takes [`a_sys_conf::W`](W) writer structure
