///Register `A_ROI_CONFIG` reader
pub type R = crate::R<A_ROI_CONFIG_SPEC>;
///Register `A_ROI_CONFIG` writer
pub type W = crate::W<A_ROI_CONFIG_SPEC>;
///Field `A_ROI_EN` reader - Configure whether or not to enable ROI in video A.\\0:not enable ROI\\1:enable ROI.
pub type A_ROI_EN_R = crate::BitReader;
///Field `A_ROI_EN` writer - Configure whether or not to enable ROI in video A.\\0:not enable ROI\\1:enable ROI.
pub type A_ROI_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `A_ROI_MODE` reader - Configure the mode of ROI in video A.\\0:fixed qp\\1:delta qp.
pub type A_ROI_MODE_R = crate::BitReader;
///Field `A_ROI_MODE` writer - Configure the mode of ROI in video A.\\0:fixed qp\\1:delta qp.
pub type A_ROI_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Configure whether or not to enable ROI in video A.\\0:not enable ROI\\1:enable ROI.
    #[inline(always)]
    pub fn a_roi_en(&self) -> A_ROI_EN_R {
        A_ROI_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Configure the mode of ROI in video A.\\0:fixed qp\\1:delta qp.
    #[inline(always)]
...
///`read()` method returns [`a_roi_config::R`](R) reader structure
impl crate::Readable for A_ROI_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`a_roi_config::W`](W) writer structure
