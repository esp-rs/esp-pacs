...
///Field `DB_TMP_READY` reader - Write 1 to enable H264_DB_TMP_READY_INT.
pub type DB_TMP_READY_R = crate::BitReader;
///Field `DB_TMP_READY` writer - Write 1 to enable H264_DB_TMP_READY_INT.
pub type DB_TMP_READY_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REC_READY` reader - Write 1 to enable H264_REC_READY_INT.
pub type REC_READY_R = crate::BitReader;
///Field `REC_READY` writer - Write 1 to enable H264_REC_READY_INT.
pub type REC_READY_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FRAME_DONE` reader - Write 1 to enable H264_FRAME_DONE_INT.
pub type FRAME_DONE_R = crate::BitReader;
///Field `FRAME_DONE` writer - Write 1 to enable H264_FRAME_DONE_INT.
pub type FRAME_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_MOVE_2MB_LINE_DONE` reader - Enable bit: Write 1 to enable H264_DMA_MOVE_2MB_LINE_DONE_INT.
pub type DMA_MOVE_2MB_LINE_DONE_R = crate::BitReader;
///Field `DMA_MOVE_2MB_LINE_DONE` writer - Enable bit: Write 1 to enable H264_DMA_MOVE_2MB_LINE_DONE_INT.
pub type DMA_MOVE_2MB_LINE_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Write 1 to enable H264_DB_TMP_READY_INT.
    #[inline(always)]
    pub fn db_tmp_ready(&self) -> DB_TMP_READY_R {
        DB_TMP_READY_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Write 1 to enable H264_REC_READY_INT.
    #[inline(always)]
    pub fn rec_ready(&self) -> REC_READY_R {
        REC_READY_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Write 1 to enable H264_FRAME_DONE_INT.
    #[inline(always)]
    pub fn frame_done(&self) -> FRAME_DONE_R {
        FRAME_DONE_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Enable bit: Write 1 to enable H264_DMA_MOVE_2MB_LINE_DONE_INT.
    #[inline(always)]
