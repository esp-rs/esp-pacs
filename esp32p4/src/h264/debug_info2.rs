///Register `DEBUG_INFO2` reader
pub type R = crate::R<DEBUG_INFO2_SPEC>;
///Field `P_RC_DONE_DEBUG_FLAG` reader - Represents p rate ctrl done status.\\0: not done\\1: done.
pub type P_RC_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_P_I_CMP_DONE_DEBUG_FLAG` reader - Represents p p_i_cmp done status.\\0: not done\\1: done.
pub type P_P_I_CMP_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_MV_MERGE_DONE_DEBUG_FLAG` reader - Represents p mv merge done status.\\0: not done\\1: done.
pub type P_MV_MERGE_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_MOVE_ORI_DONE_DEBUG_FLAG` reader - Represents p move origin done status.\\0: not done\\1: done.
pub type P_MOVE_ORI_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_MC_DONE_DEBUG_FLAG` reader - Represents p mc done status.\\0: not done\\1: done.
pub type P_MC_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_IME_DONE_DEBUG_FLAG` reader - Represents p ime done status.\\0: not done\\1: done.
pub type P_IME_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_GET_ORI_DONE_DEBUG_FLAG` reader - Represents p get origin done status.\\0: not done\\1: done.
pub type P_GET_ORI_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_FME_DONE_DEBUG_FLAG` reader - Represents p fme done status.\\0: not done\\1: done.
pub type P_FME_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_FETCH_DONE_DEBUG_FLAG` reader - Represents p fetch done status.\\0: not done\\1: done.
pub type P_FETCH_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_DB_DONE_DEBUG_FLAG` reader - Represents p deblocking done status.\\0: not done\\1: done.
pub type P_DB_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `P_BS_BUF_DONE_DEBUG_FLAG` reader - Represents p bitstream buffer done status.\\0: not done\\1: done.
pub type P_BS_BUF_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `REF_MOVE_2MB_LINE_DONE_DEBUG_FLAG` reader - Represents dma move 2 ref mb line done status.\\0: not done\\1: done.
pub type REF_MOVE_2MB_LINE_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `I_P_I_CMP_DONE_DEBUG_FLAG` reader - Represents I p_i_cmp done status.\\0: not done\\1: done.
pub type I_P_I_CMP_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `I_MOVE_ORI_DONE_DEBUG_FLAG` reader - Represents I move origin done status.\\0: not done\\1: done.
pub type I_MOVE_ORI_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `I_GET_ORI_DONE_DEBUG_FLAG` reader - Represents I get origin done status.\\0: not done\\1: done.
pub type I_GET_ORI_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `I_EC_DONE_DEBUG_FLAG` reader - Represents I encoder done status.\\0: not done\\1: done.
pub type I_EC_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `I_DB_DONE_DEBUG_FLAG` reader - Represents I deblocking done status.\\0: not done\\1: done.
pub type I_DB_DONE_DEBUG_FLAG_R = crate::BitReader;
///Field `I_BS_BUF_DONE_DEBUG_FLAG` reader - Represents I bitstream buffer done status.\\0: not done\\1: done.
pub type I_BS_BUF_DONE_DEBUG_FLAG_R = crate::BitReader;
impl R {
    ///Bit 0 - Represents p rate ctrl done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_rc_done_debug_flag(&self) -> P_RC_DONE_DEBUG_FLAG_R {
        P_RC_DONE_DEBUG_FLAG_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Represents p p_i_cmp done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_p_i_cmp_done_debug_flag(&self) -> P_P_I_CMP_DONE_DEBUG_FLAG_R {
        P_P_I_CMP_DONE_DEBUG_FLAG_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Represents p mv merge done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_mv_merge_done_debug_flag(&self) -> P_MV_MERGE_DONE_DEBUG_FLAG_R {
        P_MV_MERGE_DONE_DEBUG_FLAG_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Represents p move origin done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_move_ori_done_debug_flag(&self) -> P_MOVE_ORI_DONE_DEBUG_FLAG_R {
        P_MOVE_ORI_DONE_DEBUG_FLAG_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Represents p mc done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_mc_done_debug_flag(&self) -> P_MC_DONE_DEBUG_FLAG_R {
        P_MC_DONE_DEBUG_FLAG_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Represents p ime done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_ime_done_debug_flag(&self) -> P_IME_DONE_DEBUG_FLAG_R {
        P_IME_DONE_DEBUG_FLAG_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Represents p get origin done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_get_ori_done_debug_flag(&self) -> P_GET_ORI_DONE_DEBUG_FLAG_R {
        P_GET_ORI_DONE_DEBUG_FLAG_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Represents p fme done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_fme_done_debug_flag(&self) -> P_FME_DONE_DEBUG_FLAG_R {
        P_FME_DONE_DEBUG_FLAG_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - Represents p fetch done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_fetch_done_debug_flag(&self) -> P_FETCH_DONE_DEBUG_FLAG_R {
        P_FETCH_DONE_DEBUG_FLAG_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Represents p deblocking done status.\\0: not done\\1: done.
    #[inline(always)]
    pub fn p_db_done_debug_flag(&self) -> P_DB_DONE_DEBUG_FLAG_R {
        P_DB_DONE_DEBUG_FLAG_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Represents p bitstream buffer done status.\\0: not done\\1: done.
    #[inline(always)]
...
///`read()` method returns [`debug_info2::R`](R) reader structure
