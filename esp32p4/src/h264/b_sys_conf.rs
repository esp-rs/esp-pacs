///Register `B_SYS_CONF` reader
pub type R = crate::R<B_SYS_CONF_SPEC>;
///Register `B_SYS_CONF` writer
pub type W = crate::W<B_SYS_CONF_SPEC>;
///Field `B_DB_TMP_READY_TRIGGER_MB_NUM` reader - Configures when to trigger video B H264_DB_TMP_READY_INT. When the (MB number of written db temp+1) is greater than this filed in first MB line, trigger H264_DB_TMP_READY_INT. Min is 3.
pub type B_DB_TMP_READY_TRIGGER_MB_NUM_R = crate::FieldReader;
///Field `B_DB_TMP_READY_TRIGGER_MB_NUM` writer - Configures when to trigger video B H264_DB_TMP_READY_INT. When the (MB number of written db temp+1) is greater than this filed in first MB line, trigger H264_DB_TMP_READY_INT. Min is 3.
pub type B_DB_TMP_READY_TRIGGER_MB_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `B_REC_READY_TRIGGER_MB_LINES` reader - Configures when to trigger video B H264_REC_READY_INT. When the MB line number of generated reconstruct pixel is greater than this filed, trigger H264_REC_READY_INT. Min is 4.
pub type B_REC_READY_TRIGGER_MB_LINES_R = crate::FieldReader;
///Field `B_REC_READY_TRIGGER_MB_LINES` writer - Configures when to trigger video B H264_REC_READY_INT. When the MB line number of generated reconstruct pixel is greater than this filed, trigger H264_REC_READY_INT. Min is 4.
pub type B_REC_READY_TRIGGER_MB_LINES_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `B_INTRA_COST_CMP_OFFSET` reader - Configures video B intra cost offset when I MB compared with P MB.
pub type B_INTRA_COST_CMP_OFFSET_R = crate::FieldReader<u16>;
///Field `B_INTRA_COST_CMP_OFFSET` writer - Configures video B intra cost offset when I MB compared with P MB.
pub type B_INTRA_COST_CMP_OFFSET_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:6 - Configures when to trigger video B H264_DB_TMP_READY_INT. When the (MB number of written db temp+1) is greater than this filed in first MB line, trigger H264_DB_TMP_READY_INT. Min is 3.
    #[inline(always)]
    ...
    ///Bits 7:13 - Configures when to trigger video B H264_REC_READY_INT. When the MB line number of generated reconstruct pixel is greater than this filed, trigger H264_REC_READY_INT. Min is 4.
    #[inline(always)]
    ...
    ///Bits 14:29 - Configures video B intra cost offset when I MB compared with P MB.
    #[inline(always)]
...
///`read()` method returns [`b_sys_conf::R`](R) reader structure
impl crate::Readable for B_SYS_CONF_SPEC {}
///`write(|w| ..)` method takes [`b_sys_conf::W`](W) writer structure
