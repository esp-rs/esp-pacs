///Register `GOP_CONF` reader
pub type R = crate::R<GOP_CONF_SPEC>;
///Register `GOP_CONF` writer
pub type W = crate::W<GOP_CONF_SPEC>;
///Field `DUAL_STREAM_MODE` reader - Configures whether or not to enable dual stream mode. When this field is set to 1, H264_FRAME_MODE field must be set to 1 too.\\0: Normal mode\\1: Dual stream mode
pub type DUAL_STREAM_MODE_R = crate::BitReader;
///Field `DUAL_STREAM_MODE` writer - Configures whether or not to enable dual stream mode. When this field is set to 1, H264_FRAME_MODE field must be set to 1 too.\\0: Normal mode\\1: Dual stream mode
pub type DUAL_STREAM_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GOP_NUM` reader - Configures the frame number of one GOP.\\0: The frame number of one GOP is infinite\\Others: Actual frame number of one GOP
pub type GOP_NUM_R = crate::FieldReader;
///Field `GOP_NUM` writer - Configures the frame number of one GOP.\\0: The frame number of one GOP is infinite\\Others: Actual frame number of one GOP
pub type GOP_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bit 0 - Configures whether or not to enable dual stream mode. When this field is set to 1, H264_FRAME_MODE field must be set to 1 too.\\0: Normal mode\\1: Dual stream mode
    #[inline(always)]
    pub fn dual_stream_mode(&self) -> DUAL_STREAM_MODE_R {
        DUAL_STREAM_MODE_R::new((self.bits & 1) != 0)
    }
    ///Bits 1:8 - Configures the frame number of one GOP.\\0: The frame number of one GOP is infinite\\Others: Actual frame number of one GOP
    #[inline(always)]
...
///`read()` method returns [`gop_conf::R`](R) reader structure
impl crate::Readable for GOP_CONF_SPEC {}
///`write(|w| ..)` method takes [`gop_conf::W`](W) writer structure
