///Register `RC_STATUS0` reader
pub type R = crate::R<RC_STATUS0_SPEC>;
///Field `FRAME_MAD_SUM` reader - Represents all MB actual MAD sum value of one frame.
pub type FRAME_MAD_SUM_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:20 - Represents all MB actual MAD sum value of one frame.
    #[inline(always)]
...
///`read()` method returns [`rc_status0::R`](R) reader structure
