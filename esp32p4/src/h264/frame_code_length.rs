///Register `FRAME_CODE_LENGTH` reader
pub type R = crate::R<FRAME_CODE_LENGTH_SPEC>;
///Field `FRAME_CODE_LENGTH` reader - Represents current frame code byte length.
pub type FRAME_CODE_LENGTH_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:23 - Represents current frame code byte length.
    #[inline(always)]
...
///`read()` method returns [`frame_code_length::R`](R) reader structure
