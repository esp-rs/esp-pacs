///Register `B_DB_BYPASS` reader
pub type R = crate::R<B_DB_BYPASS_SPEC>;
///Register `B_DB_BYPASS` writer
pub type W = crate::W<B_DB_BYPASS_SPEC>;
///Field `B_BYPASS_DB_FILTER` reader - Configures whether or not to bypass video B deblcoking filter. \\0: Open the deblock filter\\1: Close the deblock filter
pub type B_BYPASS_DB_FILTER_R = crate::BitReader;
///Field `B_BYPASS_DB_FILTER` writer - Configures whether or not to bypass video B deblcoking filter. \\0: Open the deblock filter\\1: Close the deblock filter
pub type B_BYPASS_DB_FILTER_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Configures whether or not to bypass video B deblcoking filter. \\0: Open the deblock filter\\1: Close the deblock filter
    #[inline(always)]
...
///`read()` method returns [`b_db_bypass::R`](R) reader structure
impl crate::Readable for B_DB_BYPASS_SPEC {}
///`write(|w| ..)` method takes [`b_db_bypass::W`](W) writer structure
