///Register `SYS_STATUS` reader
pub type R = crate::R<SYS_STATUS_SPEC>;
///Field `FRAME_NUM` reader - Represents current frame number.
pub type FRAME_NUM_R = crate::FieldReader<u16>;
///Field `DUAL_STREAM_SEL` reader - Represents which register group is used for cur frame.\\0: Register group A is used\\1: Register group B is used.
pub type DUAL_STREAM_SEL_R = crate::BitReader;
///Field `INTRA_FLAG` reader - Represents the type of current encoding frame.\\0: P frame\\1: I frame.
pub type INTRA_FLAG_R = crate::BitReader;
impl R {
    ///Bits 0:8 - Represents current frame number.
    #[inline(always)]
    pub fn frame_num(&self) -> FRAME_NUM_R {
        FRAME_NUM_R::new((self.bits & 0x01ff) as u16)
    }
    ///Bit 9 - Represents which register group is used for cur frame.\\0: Register group A is used\\1: Register group B is used.
    #[inline(always)]
    pub fn dual_stream_sel(&self) -> DUAL_STREAM_SEL_R {
        DUAL_STREAM_SEL_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Represents the type of current encoding frame.\\0: P frame\\1: I frame.
    #[inline(always)]
...
///`read()` method returns [`sys_status::R`](R) reader structure
