///Register `A_DECI_SCORE_OFFSET` reader
pub type R = crate::R<A_DECI_SCORE_OFFSET_SPEC>;
///Register `A_DECI_SCORE_OFFSET` writer
pub type W = crate::W<A_DECI_SCORE_OFFSET_SPEC>;
///Field `A_I16X16_DECI_SCORE_OFFSET` reader - Configures video A i16x16 MB decimate score offset. This offset will be added to i16x16 MB score.
pub type A_I16X16_DECI_SCORE_OFFSET_R = crate::FieldReader;
///Field `A_I16X16_DECI_SCORE_OFFSET` writer - Configures video A i16x16 MB decimate score offset. This offset will be added to i16x16 MB score.
pub type A_I16X16_DECI_SCORE_OFFSET_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `A_I_CHROMA_DECI_SCORE_OFFSET` reader - Configures video A I chroma MB decimate score offset. This offset will be added to I chroma MB score.
pub type A_I_CHROMA_DECI_SCORE_OFFSET_R = crate::FieldReader;
///Field `A_I_CHROMA_DECI_SCORE_OFFSET` writer - Configures video A I chroma MB decimate score offset. This offset will be added to I chroma MB score.
pub type A_I_CHROMA_DECI_SCORE_OFFSET_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `A_P16X16_DECI_SCORE_OFFSET` reader - Configures video A p16x16 MB decimate score offset. This offset will be added to p16x16 MB score.
pub type A_P16X16_DECI_SCORE_OFFSET_R = crate::FieldReader;
///Field `A_P16X16_DECI_SCORE_OFFSET` writer - Configures video A p16x16 MB decimate score offset. This offset will be added to p16x16 MB score.
pub type A_P16X16_DECI_SCORE_OFFSET_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `A_P_CHROMA_DECI_SCORE_OFFSET` reader - Configures video A p chroma MB decimate score offset. This offset will be added to p chroma MB score.
pub type A_P_CHROMA_DECI_SCORE_OFFSET_R = crate::FieldReader;
///Field `A_P_CHROMA_DECI_SCORE_OFFSET` writer - Configures video A p chroma MB decimate score offset. This offset will be added to p chroma MB score.
pub type A_P_CHROMA_DECI_SCORE_OFFSET_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - Configures video A i16x16 MB decimate score offset. This offset will be added to i16x16 MB score.
    #[inline(always)]
    pub fn a_i16x16_deci_score_offset(&self) -> A_I16X16_DECI_SCORE_OFFSET_R {
        A_I16X16_DECI_SCORE_OFFSET_R::new((self.bits & 0x3f) as u8)
    }
    ///Bits 6:11 - Configures video A I chroma MB decimate score offset. This offset will be added to I chroma MB score.
    #[inline(always)]
    ...
    ///Bits 12:17 - Configures video A p16x16 MB decimate score offset. This offset will be added to p16x16 MB score.
    #[inline(always)]
    ...
    ///Bits 18:23 - Configures video A p chroma MB decimate score offset. This offset will be added to p chroma MB score.
    #[inline(always)]
...
///`read()` method returns [`a_deci_score_offset::R`](R) reader structure
impl crate::Readable for A_DECI_SCORE_OFFSET_SPEC {}
///`write(|w| ..)` method takes [`a_deci_score_offset::W`](W) writer structure
