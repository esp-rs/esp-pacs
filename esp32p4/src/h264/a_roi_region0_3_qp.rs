#[doc = "Register `A_ROI_REGION0_3_QP` reader"]
pub type R = crate::R<A_ROI_REGION0_3_QP_SPEC>;
#[doc = "Register `A_ROI_REGION0_3_QP` writer"]
pub type W = crate::W<A_ROI_REGION0_3_QP_SPEC>;
#[doc = "Field `A_ROI_REGION0_QP` reader - Configure H264 ROI region0 qp in video A,fixed qp or delta qp."]
pub type A_ROI_REGION0_QP_R = crate::FieldReader;
#[doc = "Field `A_ROI_REGION0_QP` writer - Configure H264 ROI region0 qp in video A,fixed qp or delta qp."]
pub type A_ROI_REGION0_QP_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
#[doc = "Field `A_ROI_REGION1_QP` reader - Configure H264 ROI region1 qp in video A,fixed qp or delta qp."]
pub type A_ROI_REGION1_QP_R = crate::FieldReader;
#[doc = "Field `A_ROI_REGION1_QP` writer - Configure H264 ROI region1 qp in video A,fixed qp or delta qp."]
pub type A_ROI_REGION1_QP_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
#[doc = "Field `A_ROI_REGION2_QP` reader - Configure H264 ROI region2 qp in video A,fixed qp or delta qp."]
pub type A_ROI_REGION2_QP_R = crate::FieldReader;
#[doc = "Field `A_ROI_REGION2_QP` writer - Configure H264 ROI region2 qp in video A,fixed qp or delta qp."]
pub type A_ROI_REGION2_QP_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
#[doc = "Field `A_ROI_REGION3_QP` reader - Configure H264 ROI region3 qp in video A,fixed qp or delta qp."]
pub type A_ROI_REGION3_QP_R = crate::FieldReader;
#[doc = "Field `A_ROI_REGION3_QP` writer - Configure H264 ROI region3 qp in video A,fixed qp or delta qp."]
