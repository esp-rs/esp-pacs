///Register `A_RC_CONF1` reader
pub type R = crate::R<A_RC_CONF1_SPEC>;
///Register `A_RC_CONF1` writer
pub type W = crate::W<A_RC_CONF1_SPEC>;
///Field `A_CHROMA_DC_QP_DELTA` reader - Configures video A chroma DC QP offset based on Chroma QP. Chroma DC QP = Chroma QP(after map) + reg_chroma_dc_qp_delta.
pub type A_CHROMA_DC_QP_DELTA_R = crate::FieldReader;
///Field `A_CHROMA_DC_QP_DELTA` writer - Configures video A chroma DC QP offset based on Chroma QP. Chroma DC QP = Chroma QP(after map) + reg_chroma_dc_qp_delta.
pub type A_CHROMA_DC_QP_DELTA_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `A_CHROMA_QP_DELTA` reader - Configures video A chroma QP offset based on luma QP. Chroma QP(before map) = Luma QP + reg_chroma_qp_delta.
pub type A_CHROMA_QP_DELTA_R = crate::FieldReader;
///Field `A_CHROMA_QP_DELTA` writer - Configures video A chroma QP offset based on luma QP. Chroma QP(before map) = Luma QP + reg_chroma_qp_delta.
pub type A_CHROMA_QP_DELTA_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `A_QP_MIN` reader - Configures video A allowed luma QP min value.
pub type A_QP_MIN_R = crate::FieldReader;
///Field `A_QP_MIN` writer - Configures video A allowed luma QP min value.
pub type A_QP_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `A_QP_MAX` reader - Configures video A allowed luma QP max value.
pub type A_QP_MAX_R = crate::FieldReader;
///Field `A_QP_MAX` writer - Configures video A allowed luma QP max value.
pub type A_QP_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `A_MAD_FRAME_PRED` reader - Configures vdieo A frame level predicted MB MAD value.
pub type A_MAD_FRAME_PRED_R = crate::FieldReader<u16>;
///Field `A_MAD_FRAME_PRED` writer - Configures vdieo A frame level predicted MB MAD value.
pub type A_MAD_FRAME_PRED_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:2 - Configures video A chroma DC QP offset based on Chroma QP. Chroma DC QP = Chroma QP(after map) + reg_chroma_dc_qp_delta.
    #[inline(always)]
    pub fn a_chroma_dc_qp_delta(&self) -> A_CHROMA_DC_QP_DELTA_R {
        A_CHROMA_DC_QP_DELTA_R::new((self.bits & 7) as u8)
    }
    ///Bits 3:6 - Configures video A chroma QP offset based on luma QP. Chroma QP(before map) = Luma QP + reg_chroma_qp_delta.
    #[inline(always)]
    pub fn a_chroma_qp_delta(&self) -> A_CHROMA_QP_DELTA_R {
        A_CHROMA_QP_DELTA_R::new(((self.bits >> 3) & 0x0f) as u8)
    }
    ///Bits 7:12 - Configures video A allowed luma QP min value.
    #[inline(always)]
    pub fn a_qp_min(&self) -> A_QP_MIN_R {
        A_QP_MIN_R::new(((self.bits >> 7) & 0x3f) as u8)
    }
    ///Bits 13:18 - Configures video A allowed luma QP max value.
    #[inline(always)]
    pub fn a_qp_max(&self) -> A_QP_MAX_R {
        A_QP_MAX_R::new(((self.bits >> 13) & 0x3f) as u8)
    }
    ///Bits 19:30 - Configures vdieo A frame level predicted MB MAD value.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("A_RC_CONF1")
            .field("a_chroma_dc_qp_delta", &self.a_chroma_dc_qp_delta())
            .field("a_chroma_qp_delta", &self.a_chroma_qp_delta())
            .field("a_qp_min", &self.a_qp_min())
...
///`read()` method returns [`a_rc_conf1::R`](R) reader structure
impl crate::Readable for A_RC_CONF1_SPEC {}
///`write(|w| ..)` method takes [`a_rc_conf1::W`](W) writer structure
