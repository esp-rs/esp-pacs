///Register `BS_THRESHOLD` reader
pub type R = crate::R<BS_THRESHOLD_SPEC>;
///Register `BS_THRESHOLD` writer
pub type W = crate::W<BS_THRESHOLD_SPEC>;
///Field `BS_BUFFER_THRESHOLD` reader - Configures bitstream buffer overflow threshold. This value should be bigger than the encode bytes of one 4x4 submb.
pub type BS_BUFFER_THRESHOLD_R = crate::FieldReader;
///Field `BS_BUFFER_THRESHOLD` writer - Configures bitstream buffer overflow threshold. This value should be bigger than the encode bytes of one 4x4 submb.
pub type BS_BUFFER_THRESHOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    ///Bits 0:6 - Configures bitstream buffer overflow threshold. This value should be bigger than the encode bytes of one 4x4 submb.
    #[inline(always)]
...
///`read()` method returns [`bs_threshold::R`](R) reader structure
impl crate::Readable for BS_THRESHOLD_SPEC {}
///`write(|w| ..)` method takes [`bs_threshold::W`](W) writer structure
