///Register `A_RC_CONF0` reader
pub type R = crate::R<A_RC_CONF0_SPEC>;
///Register `A_RC_CONF0` writer
pub type W = crate::W<A_RC_CONF0_SPEC>;
///Field `A_QP` reader - Configures video A frame level initial luma QP value.
pub type A_QP_R = crate::FieldReader;
///Field `A_QP` writer - Configures video A frame level initial luma QP value.
pub type A_QP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `A_RATE_CTRL_U` reader - Configures video A parameter U value. U = int((float) u &lt;&lt; 8).
pub type A_RATE_CTRL_U_R = crate::FieldReader<u16>;
///Field `A_RATE_CTRL_U` writer - Configures video A parameter U value. U = int((float) u &lt;&lt; 8).
pub type A_RATE_CTRL_U_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `A_MB_RATE_CTRL_EN` reader - Configures video A whether or not to open macro block rate ctrl.\\1:Open the macro block rate ctrl\\1:Close the macro block rate ctrl.
pub type A_MB_RATE_CTRL_EN_R = crate::BitReader;
///Field `A_MB_RATE_CTRL_EN` writer - Configures video A whether or not to open macro block rate ctrl.\\1:Open the macro block rate ctrl\\1:Close the macro block rate ctrl.
pub type A_MB_RATE_CTRL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:5 - Configures video A frame level initial luma QP value.
    #[inline(always)]
    pub fn a_qp(&self) -> A_QP_R {
        A_QP_R::new((self.bits & 0x3f) as u8)
    }
    ///Bits 6:21 - Configures video A parameter U value. U = int((float) u &lt;&lt; 8).
    #[inline(always)]
    pub fn a_rate_ctrl_u(&self) -> A_RATE_CTRL_U_R {
        A_RATE_CTRL_U_R::new(((self.bits >> 6) & 0xffff) as u16)
    }
    ///Bit 22 - Configures video A whether or not to open macro block rate ctrl.\\1:Open the macro block rate ctrl\\1:Close the macro block rate ctrl.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("A_RC_CONF0")
            .field("a_qp", &self.a_qp())
            .field("a_rate_ctrl_u", &self.a_rate_ctrl_u())
            .field("a_mb_rate_ctrl_en", &self.a_mb_rate_ctrl_en())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`a_rc_conf0::R`](R) reader structure
impl crate::Readable for A_RC_CONF0_SPEC {}
///`write(|w| ..)` method takes [`a_rc_conf0::W`](W) writer structure
