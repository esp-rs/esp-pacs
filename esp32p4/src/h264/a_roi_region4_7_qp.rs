///Register `A_ROI_REGION4_7_QP` reader
pub type R = crate::R<A_ROI_REGION4_7_QP_SPEC>;
///Register `A_ROI_REGION4_7_QP` writer
pub type W = crate::W<A_ROI_REGION4_7_QP_SPEC>;
///Field `A_ROI_REGION4_QP` reader - Configure H264 ROI region4 qp in video A,fixed qp or delta qp.
pub type A_ROI_REGION4_QP_R = crate::FieldReader;
///Field `A_ROI_REGION4_QP` writer - Configure H264 ROI region4 qp in video A,fixed qp or delta qp.
pub type A_ROI_REGION4_QP_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `A_ROI_REGION5_QP` reader - Configure H264 ROI region5 qp in video A,fixed qp or delta qp.
pub type A_ROI_REGION5_QP_R = crate::FieldReader;
///Field `A_ROI_REGION5_QP` writer - Configure H264 ROI region5 qp in video A,fixed qp or delta qp.
pub type A_ROI_REGION5_QP_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `A_ROI_REGION6_QP` reader - Configure H264 ROI region6 qp in video A,fixed qp or delta qp.
pub type A_ROI_REGION6_QP_R = crate::FieldReader;
///Field `A_ROI_REGION6_QP` writer - Configure H264 ROI region6 qp in video A,fixed qp or delta qp.
pub type A_ROI_REGION6_QP_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `A_ROI_REGION7_QP` reader - Configure H264 ROI region7 qp in video A,fixed qp or delta qp.
pub type A_ROI_REGION7_QP_R = crate::FieldReader;
///Field `A_ROI_REGION7_QP` writer - Configure H264 ROI region7 qp in video A,fixed qp or delta qp.
pub type A_ROI_REGION7_QP_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    ///Bits 0:6 - Configure H264 ROI region4 qp in video A,fixed qp or delta qp.
    #[inline(always)]
    pub fn a_roi_region4_qp(&self) -> A_ROI_REGION4_QP_R {
        A_ROI_REGION4_QP_R::new((self.bits & 0x7f) as u8)
    }
    ///Bits 7:13 - Configure H264 ROI region5 qp in video A,fixed qp or delta qp.
    #[inline(always)]
    pub fn a_roi_region5_qp(&self) -> A_ROI_REGION5_QP_R {
        A_ROI_REGION5_QP_R::new(((self.bits >> 7) & 0x7f) as u8)
    }
    ///Bits 14:20 - Configure H264 ROI region6 qp in video A,fixed qp or delta qp.
    #[inline(always)]
    pub fn a_roi_region6_qp(&self) -> A_ROI_REGION6_QP_R {
        A_ROI_REGION6_QP_R::new(((self.bits >> 14) & 0x7f) as u8)
    }
    ///Bits 21:27 - Configure H264 ROI region7 qp in video A,fixed qp or delta qp.
    #[inline(always)]
...
///`read()` method returns [`a_roi_region4_7_qp::R`](R) reader structure
impl crate::Readable for A_ROI_REGION4_7_QP_SPEC {}
///`write(|w| ..)` method takes [`a_roi_region4_7_qp::W`](W) writer structure
