///Register `B_ROI_CONFIG` reader
pub type R = crate::R<B_ROI_CONFIG_SPEC>;
///Register `B_ROI_CONFIG` writer
pub type W = crate::W<B_ROI_CONFIG_SPEC>;
///Field `B_ROI_EN` reader - Configure whether or not to enable ROI in video B.\\0:not enable ROI\\1:enable ROI.
pub type B_ROI_EN_R = crate::BitReader;
///Field `B_ROI_EN` writer - Configure whether or not to enable ROI in video B.\\0:not enable ROI\\1:enable ROI.
pub type B_ROI_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `B_ROI_MODE` reader - Configure the mode of ROI in video B.\\0:fixed qp\\1:delta qp.
pub type B_ROI_MODE_R = crate::BitReader;
///Field `B_ROI_MODE` writer - Configure the mode of ROI in video B.\\0:fixed qp\\1:delta qp.
pub type B_ROI_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Configure whether or not to enable ROI in video B.\\0:not enable ROI\\1:enable ROI.
    #[inline(always)]
    pub fn b_roi_en(&self) -> B_ROI_EN_R {
        B_ROI_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Configure the mode of ROI in video B.\\0:fixed qp\\1:delta qp.
    #[inline(always)]
...
///`read()` method returns [`b_roi_config::R`](R) reader structure
impl crate::Readable for B_ROI_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`b_roi_config::W`](W) writer structure
