///Register `RC_STATUS1` reader
pub type R = crate::R<RC_STATUS1_SPEC>;
///Field `FRAME_ENC_BITS` reader - Represents all MB actual encoding bits sum value of one frame.
pub type FRAME_ENC_BITS_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:26 - Represents all MB actual encoding bits sum value of one frame.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RC_STATUS1")
            .field("frame_enc_bits", &self.frame_enc_bits())
            .finish()
    }
}
...
///`read()` method returns [`rc_status1::R`](R) reader structure
