...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("B_ROI_REGION0_3_QP")
            .field("b_roi_region0_qp", &self.b_roi_region0_qp().bits())
            .field("b_roi_region1_qp", &self.b_roi_region1_qp().bits())
            .field("b_roi_region2_qp", &self.b_roi_region2_qp().bits())
            .field("b_roi_region3_qp", &self.b_roi_region3_qp().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
