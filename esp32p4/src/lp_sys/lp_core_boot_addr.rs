///Register `LP_CORE_BOOT_ADDR` reader
pub type R = crate::R<LP_CORE_BOOT_ADDR_SPEC>;
///Register `LP_CORE_BOOT_ADDR` writer
pub type W = crate::W<LP_CORE_BOOT_ADDR_SPEC>;
///Field `LP_CPU_BOOT_ADDR` reader - need_des
pub type LP_CPU_BOOT_ADDR_R = crate::FieldReader<u32>;
///Field `LP_CPU_BOOT_ADDR` writer - need_des
...
///`read()` method returns [`lp_core_boot_addr::R`](R) reader structure
impl crate::Readable for LP_CORE_BOOT_ADDR_SPEC {}
///`write(|w| ..)` method takes [`lp_core_boot_addr::W`](W) writer structure
