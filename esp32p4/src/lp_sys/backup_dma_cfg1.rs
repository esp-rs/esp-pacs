///Register `BACKUP_DMA_CFG1` reader
pub type R = crate::R<BACKUP_DMA_CFG1_SPEC>;
///Register `BACKUP_DMA_CFG1` writer
pub type W = crate::W<BACKUP_DMA_CFG1_SPEC>;
///Field `AON_BYPASS` reader - need_des
pub type AON_BYPASS_R = crate::BitReader;
///Field `AON_BYPASS` writer - need_des
...
///`read()` method returns [`backup_dma_cfg1::R`](R) reader structure
impl crate::Readable for BACKUP_DMA_CFG1_SPEC {}
///`write(|w| ..)` method takes [`backup_dma_cfg1::W`](W) writer structure
