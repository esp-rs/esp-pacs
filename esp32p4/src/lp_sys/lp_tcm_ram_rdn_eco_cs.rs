///Register `LP_TCM_RAM_RDN_ECO_CS` reader
pub type R = crate::R<LP_TCM_RAM_RDN_ECO_CS_SPEC>;
///Register `LP_TCM_RAM_RDN_ECO_CS` writer
pub type W = crate::W<LP_TCM_RAM_RDN_ECO_CS_SPEC>;
///Field `LP_TCM_RAM_RDN_ECO_EN` reader - need_des
pub type LP_TCM_RAM_RDN_ECO_EN_R = crate::BitReader;
///Field `LP_TCM_RAM_RDN_ECO_EN` writer - need_des
pub type LP_TCM_RAM_RDN_ECO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_TCM_RAM_RDN_ECO_RESULT` reader - need_des
...
///`read()` method returns [`lp_tcm_ram_rdn_eco_cs::R`](R) reader structure
impl crate::Readable for LP_TCM_RAM_RDN_ECO_CS_SPEC {}
///`write(|w| ..)` method takes [`lp_tcm_ram_rdn_eco_cs::W`](W) writer structure
