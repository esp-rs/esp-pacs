///Register `LP_STORE7` reader
pub type R = crate::R<LP_STORE7_SPEC>;
///Register `LP_STORE7` writer
pub type W = crate::W<LP_STORE7_SPEC>;
///Field `LP_SCRATCH7` reader - need_des
pub type LP_SCRATCH7_R = crate::FieldReader<u32>;
///Field `LP_SCRATCH7` writer - need_des
...
///`read()` method returns [`lp_store7::R`](R) reader structure
impl crate::Readable for LP_STORE7_SPEC {}
///`write(|w| ..)` method takes [`lp_store7::W`](W) writer structure
