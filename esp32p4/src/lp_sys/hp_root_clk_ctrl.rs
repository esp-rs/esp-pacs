///Register `HP_ROOT_CLK_CTRL` reader
pub type R = crate::R<HP_ROOT_CLK_CTRL_SPEC>;
///Register `HP_ROOT_CLK_CTRL` writer
pub type W = crate::W<HP_ROOT_CLK_CTRL_SPEC>;
///Field `CPU_CLK_EN` reader - clock gate enable for hp cpu root 400M clk
pub type CPU_CLK_EN_R = crate::BitReader;
///Field `CPU_CLK_EN` writer - clock gate enable for hp cpu root 400M clk
pub type CPU_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYS_CLK_EN` reader - clock gate enable for hp sys root 480M clk
pub type SYS_CLK_EN_R = crate::BitReader;
///Field `SYS_CLK_EN` writer - clock gate enable for hp sys root 480M clk
pub type SYS_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - clock gate enable for hp cpu root 400M clk
    #[inline(always)]
    pub fn cpu_clk_en(&self) -> CPU_CLK_EN_R {
        CPU_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - clock gate enable for hp sys root 480M clk
    #[inline(always)]
...
///`read()` method returns [`hp_root_clk_ctrl::R`](R) reader structure
impl crate::Readable for HP_ROOT_CLK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`hp_root_clk_ctrl::W`](W) writer structure
