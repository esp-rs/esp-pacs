...
impl W {
    #[doc = "Bit 0 - set this field to 1 to enable lp core ahb timeout handle"]
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, LP_CORE_AHB_TIMEOUT_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bits 1:16 - This field used to set lp core ahb bus timeout threshold"]
    #[inline(always)]
    pub fn thres(&mut self) -> THRES_W<'_, LP_CORE_AHB_TIMEOUT_SPEC> {
        THRES_W::new(self, 1)
    }
    #[doc = "Bit 17 - set this field to 1 to enable lp2hp ahb timeout handle"]
    #[inline(always)]
    pub fn lp2hp_ahb_timeout_en(&mut self) -> LP2HP_AHB_TIMEOUT_EN_W<'_, LP_CORE_AHB_TIMEOUT_SPEC> {
    ...
    pub fn lp2hp_ahb_timeout_thres(
        &mut self,
    ) -> LP2HP_AHB_TIMEOUT_THRES_W<'_, LP_CORE_AHB_TIMEOUT_SPEC> {
