///Register `LP_CORE_AHB_TIMEOUT` reader
pub type R = crate::R<LP_CORE_AHB_TIMEOUT_SPEC>;
///Register `LP_CORE_AHB_TIMEOUT` writer
pub type W = crate::W<LP_CORE_AHB_TIMEOUT_SPEC>;
///Field `EN` reader - set this field to 1 to enable lp core ahb timeout handle
pub type EN_R = crate::BitReader;
///Field `EN` writer - set this field to 1 to enable lp core ahb timeout handle
pub type EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES` reader - This field used to set lp core ahb bus timeout threshold
pub type THRES_R = crate::FieldReader<u16>;
///Field `THRES` writer - This field used to set lp core ahb bus timeout threshold
pub type THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `LP2HP_AHB_TIMEOUT_EN` reader - set this field to 1 to enable lp2hp ahb timeout handle
pub type LP2HP_AHB_TIMEOUT_EN_R = crate::BitReader;
///Field `LP2HP_AHB_TIMEOUT_EN` writer - set this field to 1 to enable lp2hp ahb timeout handle
pub type LP2HP_AHB_TIMEOUT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP2HP_AHB_TIMEOUT_THRES` reader - This field used to set lp2hp ahb bus timeout threshold
pub type LP2HP_AHB_TIMEOUT_THRES_R = crate::FieldReader;
///Field `LP2HP_AHB_TIMEOUT_THRES` writer - This field used to set lp2hp ahb bus timeout threshold
pub type LP2HP_AHB_TIMEOUT_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bit 0 - set this field to 1 to enable lp core ahb timeout handle
    #[inline(always)]
    pub fn en(&self) -> EN_R {
        EN_R::new((self.bits & 1) != 0)
    }
    ///Bits 1:16 - This field used to set lp core ahb bus timeout threshold
    #[inline(always)]
...
///`read()` method returns [`lp_core_ahb_timeout::R`](R) reader structure
impl crate::Readable for LP_CORE_AHB_TIMEOUT_SPEC {}
///`write(|w| ..)` method takes [`lp_core_ahb_timeout::W`](W) writer structure
