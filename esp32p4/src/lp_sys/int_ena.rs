...
///Field `LP_ADDRHOLE_INT_ENA` reader - Write 1 to enable lp addrhole int
pub type LP_ADDRHOLE_INT_ENA_R = crate::BitReader;
///Field `LP_ADDRHOLE_INT_ENA` writer - Write 1 to enable lp addrhole int
pub type LP_ADDRHOLE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IDBUS_ADDRHOLE_INT_ENA` reader - Write 1 to enable idbus addrhole int
pub type IDBUS_ADDRHOLE_INT_ENA_R = crate::BitReader;
///Field `IDBUS_ADDRHOLE_INT_ENA` writer - Write 1 to enable idbus addrhole int
pub type IDBUS_ADDRHOLE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_CORE_AHB_TIMEOUT_INT_ENA` reader - Write 1 to enable lp_core_ahb_timeout int
pub type LP_CORE_AHB_TIMEOUT_INT_ENA_R = crate::BitReader;
///Field `LP_CORE_AHB_TIMEOUT_INT_ENA` writer - Write 1 to enable lp_core_ahb_timeout int
pub type LP_CORE_AHB_TIMEOUT_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_CORE_IBUS_TIMEOUT_INT_ENA` reader - Write 1 to enable lp_core_ibus_timeout int
pub type LP_CORE_IBUS_TIMEOUT_INT_ENA_R = crate::BitReader;
///Field `LP_CORE_IBUS_TIMEOUT_INT_ENA` writer - Write 1 to enable lp_core_ibus_timeout int
pub type LP_CORE_IBUS_TIMEOUT_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_CORE_DBUS_TIMEOUT_INT_ENA` reader - Write 1 to enable lp_core_dbus_timeout int
pub type LP_CORE_DBUS_TIMEOUT_INT_ENA_R = crate::BitReader;
///Field `LP_CORE_DBUS_TIMEOUT_INT_ENA` writer - Write 1 to enable lp_core_dbus_timeout int
pub type LP_CORE_DBUS_TIMEOUT_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ETM_TASK_ULP_INT_ENA` reader - Write 1 to enable etm task ulp int
pub type ETM_TASK_ULP_INT_ENA_R = crate::BitReader;
///Field `ETM_TASK_ULP_INT_ENA` writer - Write 1 to enable etm task ulp int
pub type ETM_TASK_ULP_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLOW_CLK_TICK_INT_ENA` reader - Write 1 to enable slow_clk_tick int
pub type SLOW_CLK_TICK_INT_ENA_R = crate::BitReader;
///Field `SLOW_CLK_TICK_INT_ENA` writer - Write 1 to enable slow_clk_tick int
pub type SLOW_CLK_TICK_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Write 1 to enable lp addrhole int
    #[inline(always)]
    pub fn lp_addrhole_int_ena(&self) -> LP_ADDRHOLE_INT_ENA_R {
        LP_ADDRHOLE_INT_ENA_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Write 1 to enable idbus addrhole int
    #[inline(always)]
    ...
    ///Bit 6 - Write 1 to enable slow_clk_tick int
    #[inline(always)]
