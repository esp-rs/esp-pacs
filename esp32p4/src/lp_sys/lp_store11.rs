///Register `LP_STORE11` reader
pub type R = crate::R<LP_STORE11_SPEC>;
///Register `LP_STORE11` writer
pub type W = crate::W<LP_STORE11_SPEC>;
///Field `LP_SCRATCH11` reader - need_des
pub type LP_SCRATCH11_R = crate::FieldReader<u32>;
///Field `LP_SCRATCH11` writer - need_des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_STORE11")
            .field("lp_scratch11", &self.lp_scratch11())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`lp_store11::R`](R) reader structure
impl crate::Readable for LP_STORE11_SPEC {}
///`write(|w| ..)` method takes [`lp_store11::W`](W) writer structure
