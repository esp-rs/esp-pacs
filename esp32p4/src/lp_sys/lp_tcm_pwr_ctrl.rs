///Register `LP_TCM_PWR_CTRL` reader
pub type R = crate::R<LP_TCM_PWR_CTRL_SPEC>;
///Register `LP_TCM_PWR_CTRL` writer
pub type W = crate::W<LP_TCM_PWR_CTRL_SPEC>;
///Field `LP_TCM_ROM_CLK_FORCE_ON` reader - need_des
pub type LP_TCM_ROM_CLK_FORCE_ON_R = crate::BitReader;
///Field `LP_TCM_ROM_CLK_FORCE_ON` writer - need_des
pub type LP_TCM_ROM_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_TCM_RAM_CLK_FORCE_ON` reader - need_des
pub type LP_TCM_RAM_CLK_FORCE_ON_R = crate::BitReader;
///Field `LP_TCM_RAM_CLK_FORCE_ON` writer - need_des
...
///`read()` method returns [`lp_tcm_pwr_ctrl::R`](R) reader structure
impl crate::Readable for LP_TCM_PWR_CTRL_SPEC {}
///`write(|w| ..)` method takes [`lp_tcm_pwr_ctrl::W`](W) writer structure
