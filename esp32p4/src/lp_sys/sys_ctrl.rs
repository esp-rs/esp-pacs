...
///Field `LP_CORE_DISABLE` reader - lp cpu disable
pub type LP_CORE_DISABLE_R = crate::BitReader;
///Field `LP_CORE_DISABLE` writer - lp cpu disable
pub type LP_CORE_DISABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYS_SW_RST` writer - digital system software reset bit
...
///Field `DIG_FIB` reader - need_des
pub type DIG_FIB_R = crate::FieldReader;
///Field `DIG_FIB` writer - need_des
pub type DIG_FIB_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `IO_MUX_RESET_DISABLE` reader - reset disable bit for LP IOMUX
pub type IO_MUX_RESET_DISABLE_R = crate::BitReader;
///Field `IO_MUX_RESET_DISABLE` writer - reset disable bit for LP IOMUX
pub type IO_MUX_RESET_DISABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ANA_FIB` reader - need_des
pub type ANA_FIB_R = crate::FieldReader;
///Field `LP_FIB_SEL` reader - need_des
pub type LP_FIB_SEL_R = crate::FieldReader;
///Field `LP_FIB_SEL` writer - need_des
pub type LP_FIB_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `LP_CORE_ETM_WAKEUP_FLAG_CLR` writer - need_des
pub type LP_CORE_ETM_WAKEUP_FLAG_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LP_CORE_ETM_WAKEUP_FLAG` reader - need_des
pub type LP_CORE_ETM_WAKEUP_FLAG_R = crate::BitReader;
///Field `LP_CORE_ETM_WAKEUP_FLAG` writer - need_des
pub type LP_CORE_ETM_WAKEUP_FLAG_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYSTIMER_STALL_SEL` reader - 0: use systimer_stall signal from hp_core0, 1: use systimer_stall signal from hp_core1
pub type SYSTIMER_STALL_SEL_R = crate::BitReader;
///Field `SYSTIMER_STALL_SEL` writer - 0: use systimer_stall signal from hp_core0, 1: use systimer_stall signal from hp_core1
pub type SYSTIMER_STALL_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - lp cpu disable
    #[inline(always)]
    ...
    ///Bit 11 - reset disable bit for LP IOMUX
    #[inline(always)]
...
impl W {
    ...
    ///Bit 1 - digital system software reset bit
    #[inline(always)]
    #[must_use]
