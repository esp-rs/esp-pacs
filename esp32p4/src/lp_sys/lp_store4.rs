///Register `LP_STORE4` reader
pub type R = crate::R<LP_STORE4_SPEC>;
///Register `LP_STORE4` writer
pub type W = crate::W<LP_STORE4_SPEC>;
///Field `LP_SCRATCH4` reader - need_des
pub type LP_SCRATCH4_R = crate::FieldReader<u32>;
///Field `LP_SCRATCH4` writer - need_des
...
///`read()` method returns [`lp_store4::R`](R) reader structure
impl crate::Readable for LP_STORE4_SPEC {}
///`write(|w| ..)` method takes [`lp_store4::W`](W) writer structure
