///Register `LP_TCM_RAM_RDN_ECO_HIGH` reader
pub type R = crate::R<LP_TCM_RAM_RDN_ECO_HIGH_SPEC>;
///Register `LP_TCM_RAM_RDN_ECO_HIGH` writer
pub type W = crate::W<LP_TCM_RAM_RDN_ECO_HIGH_SPEC>;
///Field `LP_TCM_RAM_RDN_ECO_HIGH` reader - need_des
pub type LP_TCM_RAM_RDN_ECO_HIGH_R = crate::FieldReader<u32>;
///Field `LP_TCM_RAM_RDN_ECO_HIGH` writer - need_des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_TCM_RAM_RDN_ECO_HIGH")
            .field("lp_tcm_ram_rdn_eco_high", &self.lp_tcm_ram_rdn_eco_high())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`lp_tcm_ram_rdn_eco_high::R`](R) reader structure
impl crate::Readable for LP_TCM_RAM_RDN_ECO_HIGH_SPEC {}
///`write(|w| ..)` method takes [`lp_tcm_ram_rdn_eco_high::W`](W) writer structure
