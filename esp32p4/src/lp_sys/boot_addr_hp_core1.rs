///Register `BOOT_ADDR_HP_CORE1` reader
pub type R = crate::R<BOOT_ADDR_HP_CORE1_SPEC>;
///Register `BOOT_ADDR_HP_CORE1` writer
pub type W = crate::W<BOOT_ADDR_HP_CORE1_SPEC>;
///Field `BOOT_ADDR_HP_CORE1` reader - need_des
pub type BOOT_ADDR_HP_CORE1_R = crate::FieldReader<u32>;
///Field `BOOT_ADDR_HP_CORE1` writer - need_des
...
///`read()` method returns [`boot_addr_hp_core1::R`](R) reader structure
impl crate::Readable for BOOT_ADDR_HP_CORE1_SPEC {}
///`write(|w| ..)` method takes [`boot_addr_hp_core1::W`](W) writer structure
