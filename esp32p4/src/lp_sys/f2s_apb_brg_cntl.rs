///Register `F2S_APB_BRG_CNTL` reader
pub type R = crate::R<F2S_APB_BRG_CNTL_SPEC>;
///Register `F2S_APB_BRG_CNTL` writer
pub type W = crate::W<F2S_APB_BRG_CNTL_SPEC>;
///Field `F2S_APB_POSTW_EN` reader - reserved
pub type F2S_APB_POSTW_EN_R = crate::BitReader;
///Field `F2S_APB_POSTW_EN` writer - reserved
...
///`read()` method returns [`f2s_apb_brg_cntl::R`](R) reader structure
impl crate::Readable for F2S_APB_BRG_CNTL_SPEC {}
///`write(|w| ..)` method takes [`f2s_apb_brg_cntl::W`](W) writer structure
