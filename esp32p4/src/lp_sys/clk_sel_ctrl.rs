...
///`read()` method returns [`clk_sel_ctrl::R`](R) reader structure
impl crate::Readable for CLK_SEL_CTRL_SPEC {}
///`write(|w| ..)` method takes [`clk_sel_ctrl::W`](W) writer structure
