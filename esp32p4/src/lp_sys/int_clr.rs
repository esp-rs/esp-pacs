...
impl W {
    ...
    #[inline(always)]
    pub fn lp_addrhole_int_clr(&mut self) -> LP_ADDRHOLE_INT_CLR_W<'_, INT_CLR_SPEC> {
        LP_ADDRHOLE_INT_CLR_W::new(self, 0)
    }
    #[doc = "Bit 1 - write 1 to clear idbus addrhole int"]
    #[inline(always)]
    pub fn idbus_addrhole_int_clr(&mut self) -> IDBUS_ADDRHOLE_INT_CLR_W<'_, INT_CLR_SPEC> {
        IDBUS_ADDRHOLE_INT_CLR_W::new(self, 1)
    }
    #[doc = "Bit 2 - Write 1 to clear lp_core_ahb_timeout int"]
    #[inline(always)]
    pub fn lp_core_ahb_timeout_int_clr(
        &mut self,
    ) -> LP_CORE_AHB_TIMEOUT_INT_CLR_W<'_, INT_CLR_SPEC> {
