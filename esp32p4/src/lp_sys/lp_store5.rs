///Register `LP_STORE5` reader
pub type R = crate::R<LP_STORE5_SPEC>;
///Register `LP_STORE5` writer
pub type W = crate::W<LP_STORE5_SPEC>;
///Field `LP_SCRATCH5` reader - need_des
pub type LP_SCRATCH5_R = crate::FieldReader<u32>;
///Field `LP_SCRATCH5` writer - need_des
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_scratch5(&mut self) -> LP_SCRATCH5_W<LP_STORE5_SPEC> {
...
///`read()` method returns [`lp_store5::R`](R) reader structure
impl crate::Readable for LP_STORE5_SPEC {}
///`write(|w| ..)` method takes [`lp_store5::W`](W) writer structure
