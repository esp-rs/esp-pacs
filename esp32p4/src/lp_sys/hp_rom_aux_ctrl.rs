///Register `HP_ROM_AUX_CTRL` reader
pub type R = crate::R<HP_ROM_AUX_CTRL_SPEC>;
///Register `HP_ROM_AUX_CTRL` writer
pub type W = crate::W<HP_ROM_AUX_CTRL_SPEC>;
///Field `HP_ROM_AUX_CTRL` reader - need_des
pub type HP_ROM_AUX_CTRL_R = crate::FieldReader<u32>;
///Field `HP_ROM_AUX_CTRL` writer - need_des
...
///`read()` method returns [`hp_rom_aux_ctrl::R`](R) reader structure
impl crate::Readable for HP_ROM_AUX_CTRL_SPEC {}
///`write(|w| ..)` method takes [`hp_rom_aux_ctrl::W`](W) writer structure
