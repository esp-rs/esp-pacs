///Register `LP_PMU_RDN_ECO_LOW` reader
pub type R = crate::R<LP_PMU_RDN_ECO_LOW_SPEC>;
///Register `LP_PMU_RDN_ECO_LOW` writer
pub type W = crate::W<LP_PMU_RDN_ECO_LOW_SPEC>;
///Field `PMU_RDN_ECO_LOW` reader - need_des
pub type PMU_RDN_ECO_LOW_R = crate::FieldReader<u32>;
///Field `PMU_RDN_ECO_LOW` writer - need_des
...
///`read()` method returns [`lp_pmu_rdn_eco_low::R`](R) reader structure
impl crate::Readable for LP_PMU_RDN_ECO_LOW_SPEC {}
///`write(|w| ..)` method takes [`lp_pmu_rdn_eco_low::W`](W) writer structure
