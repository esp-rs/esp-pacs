///Register `LP_TCM_ROM_RDN_ECO_LOW` reader
pub type R = crate::R<LP_TCM_ROM_RDN_ECO_LOW_SPEC>;
///Register `LP_TCM_ROM_RDN_ECO_LOW` writer
pub type W = crate::W<LP_TCM_ROM_RDN_ECO_LOW_SPEC>;
///Field `LP_TCM_ROM_RDN_ECO_LOW` reader - need_des
pub type LP_TCM_ROM_RDN_ECO_LOW_R = crate::FieldReader<u32>;
///Field `LP_TCM_ROM_RDN_ECO_LOW` writer - need_des
...
impl W {
    ...
    pub fn lp_tcm_rom_rdn_eco_low(
        &mut self,
    ) -> LP_TCM_ROM_RDN_ECO_LOW_W<LP_TCM_ROM_RDN_ECO_LOW_SPEC> {
...
///`read()` method returns [`lp_tcm_rom_rdn_eco_low::R`](R) reader structure
impl crate::Readable for LP_TCM_ROM_RDN_ECO_LOW_SPEC {}
///`write(|w| ..)` method takes [`lp_tcm_rom_rdn_eco_low::W`](W) writer structure
