///Register `BOOT_ADDR_HP_LP` reader
pub type R = crate::R<BOOT_ADDR_HP_LP_SPEC>;
///Register `BOOT_ADDR_HP_LP` writer
pub type W = crate::W<BOOT_ADDR_HP_LP_SPEC>;
///Field `BOOT_ADDR_HP_LP` reader - need_des
pub type BOOT_ADDR_HP_LP_R = crate::FieldReader<u32>;
///Field `BOOT_ADDR_HP_LP` writer - need_des
...
///`read()` method returns [`boot_addr_hp_lp::R`](R) reader structure
impl crate::Readable for BOOT_ADDR_HP_LP_SPEC {}
///`write(|w| ..)` method takes [`boot_addr_hp_lp::W`](W) writer structure
