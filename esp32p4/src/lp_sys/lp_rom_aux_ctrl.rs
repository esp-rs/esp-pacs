///Register `LP_ROM_AUX_CTRL` reader
pub type R = crate::R<LP_ROM_AUX_CTRL_SPEC>;
///Register `LP_ROM_AUX_CTRL` writer
pub type W = crate::W<LP_ROM_AUX_CTRL_SPEC>;
///Field `LP_ROM_AUX_CTRL` reader - need_des
pub type LP_ROM_AUX_CTRL_R = crate::FieldReader<u32>;
///Field `LP_ROM_AUX_CTRL` writer - need_des
...
///`read()` method returns [`lp_rom_aux_ctrl::R`](R) reader structure
impl crate::Readable for LP_ROM_AUX_CTRL_SPEC {}
///`write(|w| ..)` method takes [`lp_rom_aux_ctrl::W`](W) writer structure
