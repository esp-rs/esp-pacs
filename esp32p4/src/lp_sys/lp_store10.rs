///Register `LP_STORE10` reader
pub type R = crate::R<LP_STORE10_SPEC>;
///Register `LP_STORE10` writer
pub type W = crate::W<LP_STORE10_SPEC>;
///Field `LP_SCRATCH10` reader - need_des
pub type LP_SCRATCH10_R = crate::FieldReader<u32>;
///Field `LP_SCRATCH10` writer - need_des
...
///`read()` method returns [`lp_store10::R`](R) reader structure
impl crate::Readable for LP_STORE10_SPEC {}
///`write(|w| ..)` method takes [`lp_store10::W`](W) writer structure
