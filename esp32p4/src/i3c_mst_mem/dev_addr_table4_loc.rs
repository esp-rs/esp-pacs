...
impl W {
    ...
    pub fn reg_dat_dev4_static_addr(
        &mut self,
    ) -> REG_DAT_DEV4_STATIC_ADDR_W<'_, DEV_ADDR_TABLE4_LOC_SPEC> {
    ...
    pub fn reg_dat_dev4_dynamic_addr(
        &mut self,
    ) -> REG_DAT_DEV4_DYNAMIC_ADDR_W<'_, DEV_ADDR_TABLE4_LOC_SPEC> {
    ...
    pub fn reg_dat_dev4_nack_retry_cnt(
        &mut self,
    ) -> REG_DAT_DEV4_NACK_RETRY_CNT_W<'_, DEV_ADDR_TABLE4_LOC_SPEC> {
        REG_DAT_DEV4_NACK_RETRY_CNT_W::new(self, 29)
    }
    #[doc = "Bit 31 - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device."]
    #[inline(always)]
    pub fn reg_dat_dev4_i2c(&mut self) -> REG_DAT_DEV4_I2C_W<'_, DEV_ADDR_TABLE4_LOC_SPEC> {
