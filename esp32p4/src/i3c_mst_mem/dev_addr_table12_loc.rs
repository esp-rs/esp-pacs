...
impl W {
    ...
    pub fn reg_dat_dev12_static_addr(
        &mut self,
    ) -> REG_DAT_DEV12_STATIC_ADDR_W<'_, DEV_ADDR_TABLE12_LOC_SPEC> {
    ...
    pub fn reg_dat_dev12_dynamic_addr(
        &mut self,
    ) -> REG_DAT_DEV12_DYNAMIC_ADDR_W<'_, DEV_ADDR_TABLE12_LOC_SPEC> {
    ...
    pub fn reg_dat_dev12_nack_retry_cnt(
        &mut self,
    ) -> REG_DAT_DEV12_NACK_RETRY_CNT_W<'_, DEV_ADDR_TABLE12_LOC_SPEC> {
        REG_DAT_DEV12_NACK_RETRY_CNT_W::new(self, 29)
    }
    #[doc = "Bit 31 - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device."]
    #[inline(always)]
    pub fn reg_dat_dev12_i2c(&mut self) -> REG_DAT_DEV12_I2C_W<'_, DEV_ADDR_TABLE12_LOC_SPEC> {
        REG_DAT_DEV12_I2C_W::new(self, 31)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`dev_addr_table12_loc::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dev_addr_table12_loc::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
