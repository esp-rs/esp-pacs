///Register `DEV_ADDR_TABLE12_LOC` reader
pub type R = crate::R<DEV_ADDR_TABLE12_LOC_SPEC>;
///Register `DEV_ADDR_TABLE12_LOC` writer
pub type W = crate::W<DEV_ADDR_TABLE12_LOC_SPEC>;
///Field `REG_DAT_DEV12_STATIC_ADDR` reader - NA
pub type REG_DAT_DEV12_STATIC_ADDR_R = crate::FieldReader;
///Field `REG_DAT_DEV12_STATIC_ADDR` writer - NA
pub type REG_DAT_DEV12_STATIC_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `REG_DAT_DEV12_DYNAMIC_ADDR` reader - Device Dynamic Address with parity, The MSB,bit\[23\], should be programmed with parity of dynamic address.
pub type REG_DAT_DEV12_DYNAMIC_ADDR_R = crate::FieldReader;
///Field `REG_DAT_DEV12_DYNAMIC_ADDR` writer - Device Dynamic Address with parity, The MSB,bit\[23\], should be programmed with parity of dynamic address.
pub type REG_DAT_DEV12_DYNAMIC_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `REG_DAT_DEV12_NACK_RETRY_CNT` reader - This field is used to set the Device NACK Retry count for the particular device. If the Device NACK's for the device address, the controller automatically retries the same device until this count expires. If the Slave does not ACK for the mentioned number of retries, then controller generates an error response and move to the Halt state.
pub type REG_DAT_DEV12_NACK_RETRY_CNT_R = crate::FieldReader;
///Field `REG_DAT_DEV12_NACK_RETRY_CNT` writer - This field is used to set the Device NACK Retry count for the particular device. If the Device NACK's for the device address, the controller automatically retries the same device until this count expires. If the Slave does not ACK for the mentioned number of retries, then controller generates an error response and move to the Halt state.
pub type REG_DAT_DEV12_NACK_RETRY_CNT_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `REG_DAT_DEV12_I2C` reader - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device.
pub type REG_DAT_DEV12_I2C_R = crate::BitReader;
///Field `REG_DAT_DEV12_I2C` writer - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device.
...
///`read()` method returns [`dev_addr_table12_loc::R`](R) reader structure
impl crate::Readable for DEV_ADDR_TABLE12_LOC_SPEC {}
///`write(|w| ..)` method takes [`dev_addr_table12_loc::W`](W) writer structure
