///Register `DEV_CHAR_TABLE12_LOC1` reader
pub type R = crate::R<DEV_CHAR_TABLE12_LOC1_SPEC>;
///Field `DCT_DEV12_LOC1` reader - NA
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DEV_CHAR_TABLE12_LOC1")
            .field("dct_dev12_loc1", &self.dct_dev12_loc1())
            .finish()
    }
}
/**NA
...
///`read()` method returns [`dev_char_table12_loc1::R`](R) reader structure
