...
///Field `REG_DAT_DEV6_I2C` reader - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device.
pub type REG_DAT_DEV6_I2C_R = crate::BitReader;
///Field `REG_DAT_DEV6_I2C` writer - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device.
...
///`read()` method returns [`dev_addr_table6_loc::R`](R) reader structure
impl crate::Readable for DEV_ADDR_TABLE6_LOC_SPEC {}
///`write(|w| ..)` method takes [`dev_addr_table6_loc::W`](W) writer structure
