///Register `DEV_CHAR_TABLE1_LOC2` reader
pub type R = crate::R<DEV_CHAR_TABLE1_LOC2_SPEC>;
///Field `DCT_DEV1_LOC2` reader - NA
...
You can [`read`](crate::generic::Reg::read) this register and get [`dev_char_table1_loc2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DEV_CHAR_TABLE1_LOC2_SPEC;
impl crate::RegisterSpec for DEV_CHAR_TABLE1_LOC2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dev_char_table1_loc2::R`](R) reader structure
