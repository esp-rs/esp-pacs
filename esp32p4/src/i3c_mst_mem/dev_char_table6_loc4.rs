///Register `DEV_CHAR_TABLE6_LOC4` reader
pub type R = crate::R<DEV_CHAR_TABLE6_LOC4_SPEC>;
///Field `DCT_DEV6_LOC4` reader - NA
...
You can [`read`](crate::generic::Reg::read) this register and get [`dev_char_table6_loc4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DEV_CHAR_TABLE6_LOC4_SPEC;
impl crate::RegisterSpec for DEV_CHAR_TABLE6_LOC4_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dev_char_table6_loc4::R`](R) reader structure
