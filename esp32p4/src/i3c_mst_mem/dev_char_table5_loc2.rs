#[doc = "Register `DEV_CHAR_TABLE5_LOC2` reader"]
pub type R = crate::R<DEV_CHAR_TABLE5_LOC2_SPEC>;
#[doc = "Field `DCT_DEV5_LOC2` reader - NA"]
...
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`dev_char_table5_loc2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEV_CHAR_TABLE5_LOC2_SPEC;
impl crate::RegisterSpec for DEV_CHAR_TABLE5_LOC2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dev_char_table5_loc2::R`](R) reader structure"]
impl crate::Readable for DEV_CHAR_TABLE5_LOC2_SPEC {}
#[doc = "`reset()` method sets DEV_CHAR_TABLE5_LOC2 to value 0"]
