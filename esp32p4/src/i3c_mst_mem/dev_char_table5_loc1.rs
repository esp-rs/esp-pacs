///Register `DEV_CHAR_TABLE5_LOC1` reader
pub type R = crate::R<DEV_CHAR_TABLE5_LOC1_SPEC>;
///Field `DCT_DEV5_LOC1` reader - NA
...
You can [`read`](crate::generic::Reg::read) this register and get [`dev_char_table5_loc1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DEV_CHAR_TABLE5_LOC1_SPEC;
impl crate::RegisterSpec for DEV_CHAR_TABLE5_LOC1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dev_char_table5_loc1::R`](R) reader structure
