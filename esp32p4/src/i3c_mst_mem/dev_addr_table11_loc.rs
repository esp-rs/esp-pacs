...
#[doc = "Field `REG_DAT_DEV11_I2C` reader - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device."]
pub type REG_DAT_DEV11_I2C_R = crate::BitReader;
#[doc = "Field `REG_DAT_DEV11_I2C` writer - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device."]
...
impl W {
    ...
    pub fn reg_dat_dev11_static_addr(
        &mut self,
    ) -> REG_DAT_DEV11_STATIC_ADDR_W<'_, DEV_ADDR_TABLE11_LOC_SPEC> {
    ...
    pub fn reg_dat_dev11_dynamic_addr(
        &mut self,
    ) -> REG_DAT_DEV11_DYNAMIC_ADDR_W<'_, DEV_ADDR_TABLE11_LOC_SPEC> {
    ...
    pub fn reg_dat_dev11_nack_retry_cnt(
        &mut self,
    ) -> REG_DAT_DEV11_NACK_RETRY_CNT_W<'_, DEV_ADDR_TABLE11_LOC_SPEC> {
        REG_DAT_DEV11_NACK_RETRY_CNT_W::new(self, 29)
    }
    #[doc = "Bit 31 - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device."]
    #[inline(always)]
    pub fn reg_dat_dev11_i2c(&mut self) -> REG_DAT_DEV11_I2C_W<'_, DEV_ADDR_TABLE11_LOC_SPEC> {
        REG_DAT_DEV11_I2C_W::new(self, 31)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`dev_addr_table11_loc::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dev_addr_table11_loc::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEV_ADDR_TABLE11_LOC_SPEC;
impl crate::RegisterSpec for DEV_ADDR_TABLE11_LOC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dev_addr_table11_loc::R`](R) reader structure"]
impl crate::Readable for DEV_ADDR_TABLE11_LOC_SPEC {}
#[doc = "`write(|w| ..)` method takes [`dev_addr_table11_loc::W`](W) writer structure"]
impl crate::Writable for DEV_ADDR_TABLE11_LOC_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DEV_ADDR_TABLE11_LOC to value 0"]
