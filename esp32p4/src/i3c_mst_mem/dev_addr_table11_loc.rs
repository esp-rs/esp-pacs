    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DEV_ADDR_TABLE11_LOC")
            .field(
                ...
                &self.reg_dat_dev11_static_addr().bits(),
            )
            .field(
                "reg_dat_dev11_dynamic_addr",
                &self.reg_dat_dev11_dynamic_addr().bits(),
            )
            .field(
                "reg_dat_dev11_nack_retry_cnt",
                &self.reg_dat_dev11_nack_retry_cnt().bits(),
            )
            .field("reg_dat_dev11_i2c", &self.reg_dat_dev11_i2c().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
