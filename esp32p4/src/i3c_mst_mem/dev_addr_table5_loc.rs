...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DEV_ADDR_TABLE5_LOC")
            .field(
                "reg_dat_dev5_static_addr",
                &format_args!("{}", self.reg_dat_dev5_static_addr().bits()),
            )
            .field(
                "reg_dat_dev5_dynamic_addr",
                &format_args!("{}", self.reg_dat_dev5_dynamic_addr().bits()),
            )
            .field(
                "reg_dat_dev5_nack_retry_cnt",
                &format_args!("{}", self.reg_dat_dev5_nack_retry_cnt().bits()),
            )
            .field(
                "reg_dat_dev5_i2c",
                &format_args!("{}", self.reg_dat_dev5_i2c().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DEV_ADDR_TABLE5_LOC_SPEC> {
