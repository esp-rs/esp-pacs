    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DEV_ADDR_TABLE8_LOC")
            .field(
                ...
                &format_args!("{}", self.reg_dat_dev8_static_addr().bits()),
            )
            .field(
                "reg_dat_dev8_dynamic_addr",
                &format_args!("{}", self.reg_dat_dev8_dynamic_addr().bits()),
            )
            .field(
                "reg_dat_dev8_nack_retry_cnt",
                &format_args!("{}", self.reg_dat_dev8_nack_retry_cnt().bits()),
            )
            .field(
                "reg_dat_dev8_i2c",
                &format_args!("{}", self.reg_dat_dev8_i2c().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DEV_ADDR_TABLE8_LOC_SPEC> {
