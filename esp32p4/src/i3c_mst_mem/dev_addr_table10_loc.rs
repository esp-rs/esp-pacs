    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DEV_ADDR_TABLE10_LOC")
            .field(
                ...
                &self.reg_dat_dev10_static_addr().bits(),
            )
            .field(
                "reg_dat_dev10_dynamic_addr",
                &self.reg_dat_dev10_dynamic_addr().bits(),
            )
            .field(
                "reg_dat_dev10_nack_retry_cnt",
                &self.reg_dat_dev10_nack_retry_cnt().bits(),
            )
            .field("reg_dat_dev10_i2c", &self.reg_dat_dev10_i2c().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
