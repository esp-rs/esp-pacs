...
impl W {
    ...
    pub fn reg_dat_dev10_static_addr(
        &mut self,
    ) -> REG_DAT_DEV10_STATIC_ADDR_W<'_, DEV_ADDR_TABLE10_LOC_SPEC> {
    ...
    pub fn reg_dat_dev10_dynamic_addr(
        &mut self,
    ) -> REG_DAT_DEV10_DYNAMIC_ADDR_W<'_, DEV_ADDR_TABLE10_LOC_SPEC> {
    ...
    pub fn reg_dat_dev10_nack_retry_cnt(
        &mut self,
    ) -> REG_DAT_DEV10_NACK_RETRY_CNT_W<'_, DEV_ADDR_TABLE10_LOC_SPEC> {
        REG_DAT_DEV10_NACK_RETRY_CNT_W::new(self, 29)
    }
    #[doc = "Bit 31 - Legacy I2C device or not. This bit should be set to 1 if the device is a legacy I2C device."]
    #[inline(always)]
    pub fn reg_dat_dev10_i2c(&mut self) -> REG_DAT_DEV10_I2C_W<'_, DEV_ADDR_TABLE10_LOC_SPEC> {
