...
impl R {
    ...
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO52_EN` field"]
    #[inline(always)]
    ...
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO52_SEL` field"]
    #[inline(always)]
