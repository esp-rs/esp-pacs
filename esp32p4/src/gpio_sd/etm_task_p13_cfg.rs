///Register `ETM_TASK_P13_CFG` reader
pub type R = crate::R<ETM_TASK_P13_CFG_SPEC>;
///Register `ETM_TASK_P13_CFG` writer
pub type W = crate::W<ETM_TASK_P13_CFG_SPEC>;
///Field `GPIO_EN(52-54)` reader - Enable bit of GPIO response etm task.
pub type GPIO_EN_R = crate::BitReader;
///Field `GPIO_EN(52-54)` writer - Enable bit of GPIO response etm task.
pub type GPIO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPIO_SEL(52-54)` reader - GPIO choose a etm task channel.
pub type GPIO_SEL_R = crate::FieldReader;
///Field `GPIO_SEL(52-54)` writer - GPIO choose a etm task channel.
pub type GPIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Enable bit of GPIO response etm task.
    ///
    ///NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO52_EN` field
    #[inline(always)]
    ...
    ///
    ///NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO52_SEL` field
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_en(&mut self, n: u8) -> GPIO_EN_W<ETM_TASK_P13_CFG_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 3][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio52_en(&mut self) -> GPIO_EN_W<ETM_TASK_P13_CFG_SPEC> {
        GPIO_EN_W::new(self, 0)
    }
    ///Bit 8 - Enable bit of GPIO response etm task.
    #[inline(always)]
    #[must_use]
    pub fn gpio53_en(&mut self) -> GPIO_EN_W<ETM_TASK_P13_CFG_SPEC> {
        GPIO_EN_W::new(self, 8)
    }
    ///Bit 16 - Enable bit of GPIO response etm task.
    #[inline(always)]
    #[must_use]
    pub fn gpio54_en(&mut self) -> GPIO_EN_W<ETM_TASK_P13_CFG_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_sel(&mut self, n: u8) -> GPIO_SEL_W<ETM_TASK_P13_CFG_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 3][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio52_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P13_CFG_SPEC> {
        GPIO_SEL_W::new(self, 1)
    }
    ///Bits 9:11 - GPIO choose a etm task channel.
    #[inline(always)]
    #[must_use]
    pub fn gpio53_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P13_CFG_SPEC> {
        GPIO_SEL_W::new(self, 9)
    }
    ///Bits 17:19 - GPIO choose a etm task channel.
    #[inline(always)]
    #[must_use]
    pub fn gpio54_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P13_CFG_SPEC> {
...
///`read()` method returns [`etm_task_p13_cfg::R`](R) reader structure
impl crate::Readable for ETM_TASK_P13_CFG_SPEC {}
///`write(|w| ..)` method takes [`etm_task_p13_cfg::W`](W) writer structure
