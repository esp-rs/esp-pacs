...
impl W {
    ...
    #[doc = "Bit 0 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio32_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P8_CFG_SPEC> {
        GPIO_EN_W::new(self, 0)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio33_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P8_CFG_SPEC> {
        GPIO_EN_W::new(self, 8)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio34_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P8_CFG_SPEC> {
        GPIO_EN_W::new(self, 16)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio35_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P8_CFG_SPEC> {
    ...
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio32_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P8_CFG_SPEC> {
        GPIO_SEL_W::new(self, 1)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio33_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P8_CFG_SPEC> {
        GPIO_SEL_W::new(self, 9)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio34_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P8_CFG_SPEC> {
        GPIO_SEL_W::new(self, 17)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio35_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P8_CFG_SPEC> {
