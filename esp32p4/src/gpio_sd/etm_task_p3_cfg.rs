...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio12_en(&mut self) -> ETM_TASK_GPIO12_EN_W<ETM_TASK_P3_CFG_SPEC> {
        ETM_TASK_GPIO12_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio12_sel(&mut self) -> ETM_TASK_GPIO12_SEL_W<ETM_TASK_P3_CFG_SPEC> {
        ETM_TASK_GPIO12_SEL_W::new(self, 1)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio13_en(&mut self) -> ETM_TASK_GPIO13_EN_W<ETM_TASK_P3_CFG_SPEC> {
        ETM_TASK_GPIO13_EN_W::new(self, 8)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio13_sel(&mut self) -> ETM_TASK_GPIO13_SEL_W<ETM_TASK_P3_CFG_SPEC> {
        ETM_TASK_GPIO13_SEL_W::new(self, 9)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio14_en(&mut self) -> ETM_TASK_GPIO14_EN_W<ETM_TASK_P3_CFG_SPEC> {
        ETM_TASK_GPIO14_EN_W::new(self, 16)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio14_sel(&mut self) -> ETM_TASK_GPIO14_SEL_W<ETM_TASK_P3_CFG_SPEC> {
        ETM_TASK_GPIO14_SEL_W::new(self, 17)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio15_en(&mut self) -> ETM_TASK_GPIO15_EN_W<ETM_TASK_P3_CFG_SPEC> {
        ETM_TASK_GPIO15_EN_W::new(self, 24)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio15_sel(&mut self) -> ETM_TASK_GPIO15_SEL_W<ETM_TASK_P3_CFG_SPEC> {
        ETM_TASK_GPIO15_SEL_W::new(self, 25)
    }
}
