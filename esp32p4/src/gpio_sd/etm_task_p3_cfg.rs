///Register `ETM_TASK_P3_CFG` reader
pub type R = crate::R<ETM_TASK_P3_CFG_SPEC>;
///Register `ETM_TASK_P3_CFG` writer
pub type W = crate::W<ETM_TASK_P3_CFG_SPEC>;
///Field `GPIO_EN(12-15)` reader - Enable bit of GPIO response etm task.
pub type GPIO_EN_R = crate::BitReader;
///Field `GPIO_EN(12-15)` writer - Enable bit of GPIO response etm task.
pub type GPIO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPIO_SEL(12-15)` reader - GPIO choose a etm task channel.
pub type GPIO_SEL_R = crate::FieldReader;
///Field `GPIO_SEL(12-15)` writer - GPIO choose a etm task channel.
...
///`read()` method returns [`etm_task_p3_cfg::R`](R) reader structure
impl crate::Readable for ETM_TASK_P3_CFG_SPEC {}
///`write(|w| ..)` method takes [`etm_task_p3_cfg::W`](W) writer structure
