...
impl W {
    ...
    #[doc = "Bit 0 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio44_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_EN_W::new(self, 0)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio45_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_EN_W::new(self, 8)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio46_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_EN_W::new(self, 16)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    pub fn gpio47_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
    ...
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio44_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_SEL_W::new(self, 1)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio45_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_SEL_W::new(self, 9)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio46_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_SEL_W::new(self, 17)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    pub fn gpio47_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
