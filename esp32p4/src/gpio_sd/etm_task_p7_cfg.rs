...
#[doc = "Field `ETM_TASK_GPIO31_EN` reader - Enable bit of GPIO response etm task."]
pub type ETM_TASK_GPIO31_EN_R = crate::BitReader;
#[doc = "Field `ETM_TASK_GPIO31_EN` writer - Enable bit of GPIO response etm task."]
pub type ETM_TASK_GPIO31_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ETM_TASK_GPIO31_SEL` reader - GPIO choose a etm task channel."]
pub type ETM_TASK_GPIO31_SEL_R = crate::FieldReader;
#[doc = "Field `ETM_TASK_GPIO31_SEL` writer - GPIO choose a etm task channel."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETM_TASK_P7_CFG")
            ...
            .field(
                "etm_task_gpio31_en",
                &format_args!("{}", self.etm_task_gpio31_en().bit()),
            )
            .field(
                "etm_task_gpio31_sel",
                &format_args!("{}", self.etm_task_gpio31_sel().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio31_en(&mut self) -> ETM_TASK_GPIO31_EN_W<ETM_TASK_P7_CFG_SPEC> {
        ETM_TASK_GPIO31_EN_W::new(self, 24)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio31_sel(&mut self) -> ETM_TASK_GPIO31_SEL_W<ETM_TASK_P7_CFG_SPEC> {
        ETM_TASK_GPIO31_SEL_W::new(self, 25)
    }
}
