///Register `ETM_TASK_P12_CFG` reader
pub type R = crate::R<ETM_TASK_P12_CFG_SPEC>;
///Register `ETM_TASK_P12_CFG` writer
pub type W = crate::W<ETM_TASK_P12_CFG_SPEC>;
///Field `GPIO_EN(48-51)` reader - Enable bit of GPIO response etm task.
pub type GPIO_EN_R = crate::BitReader;
///Field `GPIO_EN(48-51)` writer - Enable bit of GPIO response etm task.
pub type GPIO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPIO_SEL(48-51)` reader - GPIO choose a etm task channel.
pub type GPIO_SEL_R = crate::FieldReader;
///Field `GPIO_SEL(48-51)` writer - GPIO choose a etm task channel.
pub type GPIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Enable bit of GPIO response etm task.
    ///
    ///NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO48_EN` field
    #[inline(always)]
    ...
    ///
    ///NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO48_SEL` field
    #[inline(always)]
...
///`read()` method returns [`etm_task_p12_cfg::R`](R) reader structure
impl crate::Readable for ETM_TASK_P12_CFG_SPEC {}
///`write(|w| ..)` method takes [`etm_task_p12_cfg::W`](W) writer structure
