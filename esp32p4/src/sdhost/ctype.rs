///Register `CTYPE` reader
pub type R = crate::R<CTYPE_SPEC>;
///Register `CTYPE` writer
pub type W = crate::W<CTYPE_SPEC>;
///Field `CARD_WIDTH4` reader - One bit per card indicates if card is 1-bit or 4-bit mode. 0: 1-bit mode; 1: 4-bit mode. Bit\[1:0\] correspond to card\[1:0\] respectively.
pub type CARD_WIDTH4_R = crate::FieldReader;
///Field `CARD_WIDTH4` writer - One bit per card indicates if card is 1-bit or 4-bit mode. 0: 1-bit mode; 1: 4-bit mode. Bit\[1:0\] correspond to card\[1:0\] respectively.
pub type CARD_WIDTH4_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CARD_WIDTH8` reader - One bit per card indicates if card is in 8-bit mode. 0: Non 8-bit mode; 1: 8-bit mode. Bit\[17:16\] correspond to card\[1:0\] respectively.
pub type CARD_WIDTH8_R = crate::FieldReader;
///Field `CARD_WIDTH8` writer - One bit per card indicates if card is in 8-bit mode. 0: Non 8-bit mode; 1: 8-bit mode. Bit\[17:16\] correspond to card\[1:0\] respectively.
...
///`read()` method returns [`ctype::R`](R) reader structure
impl crate::Readable for CTYPE_SPEC {}
///`write(|w| ..)` method takes [`ctype::W`](W) writer structure
