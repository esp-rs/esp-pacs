...
///Field `CAM_CONV_8BITS_DATA_INV` reader - 1:invert every two 8bits input data. 2. disabled.
pub type CAM_CONV_8BITS_DATA_INV_R = crate::BitReader;
///Field `CAM_CONV_8BITS_DATA_INV` writer - 1:invert every two 8bits input data. 2. disabled.
pub type CAM_CONV_8BITS_DATA_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_CONV_YUV2YUV_MODE` reader - 0: to yuv422. 1: to yuv420. 2: to yuv411. 3: disabled. To enable yuv2yuv mode, trans_mode must be set to 1.
pub type CAM_CONV_YUV2YUV_MODE_R = crate::FieldReader;
///Field `CAM_CONV_YUV2YUV_MODE` writer - 0: to yuv422. 1: to yuv420. 2: to yuv411. 3: disabled. To enable yuv2yuv mode, trans_mode must be set to 1.
pub type CAM_CONV_YUV2YUV_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CAM_CONV_YUV_MODE` reader - 0: yuv422. 1: yuv420. 2: yuv411. When in yuv2yuv mode, yuv_mode decides the yuv mode of Data_in
pub type CAM_CONV_YUV_MODE_R = crate::FieldReader;
///Field `CAM_CONV_YUV_MODE` writer - 0: yuv422. 1: yuv420. 2: yuv411. When in yuv2yuv mode, yuv_mode decides the yuv mode of Data_in
...
///Field `CAM_CONV_DATA_OUT_MODE` reader - LIMIT or FULL mode of Data out. 0: limit. 1: full
pub type CAM_CONV_DATA_OUT_MODE_R = crate::BitReader;
///Field `CAM_CONV_DATA_OUT_MODE` writer - LIMIT or FULL mode of Data out. 0: limit. 1: full
pub type CAM_CONV_DATA_OUT_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_CONV_DATA_IN_MODE` reader - LIMIT or FULL mode of Data in. 0: limit. 1: full
pub type CAM_CONV_DATA_IN_MODE_R = crate::BitReader;
///Field `CAM_CONV_DATA_IN_MODE` writer - LIMIT or FULL mode of Data in. 0: limit. 1: full
pub type CAM_CONV_DATA_IN_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_CONV_MODE_8BITS_ON` reader - 0: 16bits mode. 1: 8bits mode.
pub type CAM_CONV_MODE_8BITS_ON_R = crate::BitReader;
///Field `CAM_CONV_MODE_8BITS_ON` writer - 0: 16bits mode. 1: 8bits mode.
pub type CAM_CONV_MODE_8BITS_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_CONV_TRANS_MODE` reader - 0: YUV to RGB. 1: RGB to YUV.
pub type CAM_CONV_TRANS_MODE_R = crate::BitReader;
///Field `CAM_CONV_TRANS_MODE` writer - 0: YUV to RGB. 1: RGB to YUV.
pub type CAM_CONV_TRANS_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_CONV_ENABLE` reader - 0: Bypass converter. 1: Enable converter.
pub type CAM_CONV_ENABLE_R = crate::BitReader;
///Field `CAM_CONV_ENABLE` writer - 0: Bypass converter. 1: Enable converter.
pub type CAM_CONV_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 21 - 1:invert every two 8bits input data. 2. disabled.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CAM_RGB_YUV")
            ...
            .field("cam_conv_enable", &self.cam_conv_enable())
            .finish()
    }
}
impl W {
