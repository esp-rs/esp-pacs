...
///Field `LCD_WIRE_MODE` reader - The wire width of LCD output. 0: 8bit. 1: 16bit 2: 24bit
pub type LCD_WIRE_MODE_R = crate::FieldReader;
///Field `LCD_WIRE_MODE` writer - The wire width of LCD output. 0: 8bit. 1: 16bit 2: 24bit
...
impl R {
    ///Bits 4:5 - The wire width of LCD output. 0: 8bit. 1: 16bit 2: 24bit
    #[inline(always)]
