...
///Field `LCD_VSYNC_INT_CLR` writer - The clear bit for LCD frame end interrupt.
pub type LCD_VSYNC_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_TRANS_DONE_INT_CLR` writer - The clear bit for lcd transfer end interrupt.
pub type LCD_TRANS_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_VSYNC_INT_CLR` writer - The clear bit for Camera frame end interrupt.
pub type CAM_VSYNC_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_HS_INT_CLR` writer - The clear bit for Camera line interrupt.
