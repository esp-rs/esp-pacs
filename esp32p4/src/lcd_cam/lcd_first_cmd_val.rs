///Register `LCD_FIRST_CMD_VAL` reader
pub type R = crate::R<LCD_FIRST_CMD_VAL_SPEC>;
///Register `LCD_FIRST_CMD_VAL` writer
pub type W = crate::W<LCD_FIRST_CMD_VAL_SPEC>;
///Field `LCD_FIRST_CMD_VALUE` reader - The LCD write command value of first cmd cycle.
pub type LCD_FIRST_CMD_VALUE_R = crate::FieldReader<u32>;
///Field `LCD_FIRST_CMD_VALUE` writer - The LCD write command value of first cmd cycle.
...
///`read()` method returns [`lcd_first_cmd_val::R`](R) reader structure
impl crate::Readable for LCD_FIRST_CMD_VAL_SPEC {}
///`write(|w| ..)` method takes [`lcd_first_cmd_val::W`](W) writer structure
