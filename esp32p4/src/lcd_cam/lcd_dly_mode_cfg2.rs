///Register `LCD_DLY_MODE_CFG2` reader
...
impl R {
    ...
    ///Bits 2:3 - The output data bit 1 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout1_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 2) & 3) as u8)
    }
    ///Bits 4:5 - The output data bit 2 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout2_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 4) & 3) as u8)
    }
    ///Bits 6:7 - The output data bit 3 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout3_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 6) & 3) as u8)
    }
    ///Bits 8:9 - The output data bit 4 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout4_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 8) & 3) as u8)
    }
    ///Bits 10:11 - The output data bit 5 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout5_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 10) & 3) as u8)
    }
    ///Bits 12:13 - The output data bit 6 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout6_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 12) & 3) as u8)
    }
    ///Bits 14:15 - The output data bit 7 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout7_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 14) & 3) as u8)
    }
    ///Bits 16:17 - The output data bit 8 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout8_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 16) & 3) as u8)
    }
    ///Bits 18:19 - The output data bit 9 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout9_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 18) & 3) as u8)
    }
    ///Bits 20:21 - The output data bit 10 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout10_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 20) & 3) as u8)
    }
    ///Bits 22:23 - The output data bit 11 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout11_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 22) & 3) as u8)
    }
    ///Bits 24:25 - The output data bit 12 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout12_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 24) & 3) as u8)
    }
    ///Bits 26:27 - The output data bit 13 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout13_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 26) & 3) as u8)
    }
    ///Bits 28:29 - The output data bit 14 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout14_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 28) & 3) as u8)
    }
    ///Bits 30:31 - The output data bit 15 is delayed by module clock LCD_CLK
    #[inline(always)]
...
///`read()` method returns [`lcd_dly_mode_cfg2::R`](R) reader structure
impl crate::Readable for LCD_DLY_MODE_CFG2_SPEC {}
///`write(|w| ..)` method takes [`lcd_dly_mode_cfg2::W`](W) writer structure
