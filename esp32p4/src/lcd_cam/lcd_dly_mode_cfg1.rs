///Register `LCD_DLY_MODE_CFG1` reader
pub type R = crate::R<LCD_DLY_MODE_CFG1_SPEC>;
///Register `LCD_DLY_MODE_CFG1` writer
...
///Field `DOUT_MODE(16-23)` reader - The output data bit %s is delayed by module clock LCD_CLK
...
///Field `DOUT_MODE(16-23)` writer - The output data bit %s is delayed by module clock LCD_CLK
...
///Field `LCD_CD_MODE` reader - The output LCD_CD is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
pub type LCD_CD_MODE_R = crate::FieldReader;
///Field `LCD_CD_MODE` writer - The output LCD_CD is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
pub type LCD_CD_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `LCD_DE_MODE` reader - The output LCD_DE is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
pub type LCD_DE_MODE_R = crate::FieldReader;
///Field `LCD_DE_MODE` writer - The output LCD_DE is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
pub type LCD_DE_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `LCD_HSYNC_MODE` reader - The output LCD_HSYNC is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
pub type LCD_HSYNC_MODE_R = crate::FieldReader;
///Field `LCD_HSYNC_MODE` writer - The output LCD_HSYNC is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
pub type LCD_HSYNC_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `LCD_VSYNC_MODE` reader - The output LCD_VSYNC is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
pub type LCD_VSYNC_MODE_R = crate::FieldReader;
///Field `LCD_VSYNC_MODE` writer - The output LCD_VSYNC is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
pub type LCD_VSYNC_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///The output data bit (16-23) is delayed by module clock LCD_CLK
    ///
    ...
    ///Bits 2:3 - The output data bit 17 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout17_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 2) & 3) as u8)
    }
    ///Bits 4:5 - The output data bit 18 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout18_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 4) & 3) as u8)
    }
    ///Bits 6:7 - The output data bit 19 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout19_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 6) & 3) as u8)
    }
    ///Bits 8:9 - The output data bit 20 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout20_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 8) & 3) as u8)
    }
    ///Bits 10:11 - The output data bit 21 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout21_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 10) & 3) as u8)
    }
    ///Bits 12:13 - The output data bit 22 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout22_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 12) & 3) as u8)
    }
    ///Bits 14:15 - The output data bit 23 is delayed by module clock LCD_CLK
    #[inline(always)]
    pub fn dout23_mode(&self) -> DOUT_MODE_R {
        DOUT_MODE_R::new(((self.bits >> 14) & 3) as u8)
    }
    ///Bits 16:17 - The output LCD_CD is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
    #[inline(always)]
    pub fn lcd_cd_mode(&self) -> LCD_CD_MODE_R {
        LCD_CD_MODE_R::new(((self.bits >> 16) & 3) as u8)
    }
    ///Bits 18:19 - The output LCD_DE is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
    #[inline(always)]
    pub fn lcd_de_mode(&self) -> LCD_DE_MODE_R {
        LCD_DE_MODE_R::new(((self.bits >> 18) & 3) as u8)
    }
    ///Bits 20:21 - The output LCD_HSYNC is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
    #[inline(always)]
    pub fn lcd_hsync_mode(&self) -> LCD_HSYNC_MODE_R {
        LCD_HSYNC_MODE_R::new(((self.bits >> 20) & 3) as u8)
    }
    ///Bits 22:23 - The output LCD_VSYNC is delayed by module clock LCD_CLK. 0: output without delayed. 1: delay by the positive edge of LCD_CLK. 2: delay by the negative edge of LCD_CLK.
    #[inline(always)]
...
///`read()` method returns [`lcd_dly_mode_cfg1::R`](R) reader structure
impl crate::Readable for LCD_DLY_MODE_CFG1_SPEC {}
///`write(|w| ..)` method takes [`lcd_dly_mode_cfg1::W`](W) writer structure
