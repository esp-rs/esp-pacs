...
///Field `LCD_CK_OUT_EDGE` reader - 1: LCD_PCLK line is high in the first half data cycle. 0: LCD_PCLK line is low in the second half data cycle.
pub type LCD_CK_OUT_EDGE_R = crate::BitReader;
///Field `LCD_CK_OUT_EDGE` writer - 1: LCD_PCLK line is high in the first half data cycle. 0: LCD_PCLK line is low in the second half data cycle.
...
impl R {
    ...
    ///Bit 8 - 1: LCD_PCLK line is high in the first half data cycle. 0: LCD_PCLK line is low in the second half data cycle.
    #[inline(always)]
...
///`read()` method returns [`lcd_clock::R`](R) reader structure
impl crate::Readable for LCD_CLOCK_SPEC {}
///`write(|w| ..)` method takes [`lcd_clock::W`](W) writer structure
