...
///Field `LCD_DOUT_CYCLELEN` reader - The output data cycles minus 1 of LCD module.
pub type LCD_DOUT_CYCLELEN_R = crate::FieldReader<u16>;
///Field `LCD_DOUT_CYCLELEN` writer - The output data cycles minus 1 of LCD module.
pub type LCD_DOUT_CYCLELEN_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `LCD_ALWAYS_OUT_EN` reader - LCD always output when LCD is in LCD_DOUT state, unless reg_lcd_start is cleared or reg_lcd_reset is set.
pub type LCD_ALWAYS_OUT_EN_R = crate::BitReader;
///Field `LCD_ALWAYS_OUT_EN` writer - LCD always output when LCD is in LCD_DOUT state, unless reg_lcd_start is cleared or reg_lcd_reset is set.
pub type LCD_ALWAYS_OUT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_DOUT_BYTE_SWIZZLE_MODE` reader - 0: ABAB->BABA. 1: ABC->ACB. 2: ABC->BAC. 3: ABC->BCA. 4:ABC->CAB. 5:ABC->CBA
pub type LCD_DOUT_BYTE_SWIZZLE_MODE_R = crate::FieldReader;
///Field `LCD_DOUT_BYTE_SWIZZLE_MODE` writer - 0: ABAB->BABA. 1: ABC->ACB. 2: ABC->BAC. 3: ABC->BCA. 4:ABC->CAB. 5:ABC->CBA
pub type LCD_DOUT_BYTE_SWIZZLE_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `LCD_DOUT_BYTE_SWIZZLE_ENABLE` reader - 1: enable byte swizzle 0: disable
pub type LCD_DOUT_BYTE_SWIZZLE_ENABLE_R = crate::BitReader;
///Field `LCD_DOUT_BYTE_SWIZZLE_ENABLE` writer - 1: enable byte swizzle 0: disable
pub type LCD_DOUT_BYTE_SWIZZLE_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_DOUT_BIT_ORDER` reader - 1: change bit order in every byte. 0: Not change.
pub type LCD_DOUT_BIT_ORDER_R = crate::BitReader;
///Field `LCD_DOUT_BIT_ORDER` writer - 1: change bit order in every byte. 0: Not change.
pub type LCD_DOUT_BIT_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_BYTE_MODE` reader - 2: 24bit mode. 1: 16bit mode. 0: 8bit mode
pub type LCD_BYTE_MODE_R = crate::FieldReader;
///Field `LCD_BYTE_MODE` writer - 2: 24bit mode. 1: 16bit mode. 0: 8bit mode
pub type LCD_BYTE_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `LCD_UPDATE` reader - 1: Update LCD registers, will be cleared by hardware. 0 : Not care.
pub type LCD_UPDATE_R = crate::BitReader;
///Field `LCD_UPDATE` writer - 1: Update LCD registers, will be cleared by hardware. 0 : Not care.
pub type LCD_UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_BIT_ORDER` reader - 1: Change data bit order, change LCD_DATA_out\[7:0\] to LCD_DATA_out\[0:7\] in one byte mode, and bits\[15:0\] to bits\[0:15\] in two byte mode. 0: Not change.
pub type LCD_BIT_ORDER_R = crate::BitReader;
///Field `LCD_BIT_ORDER` writer - 1: Change data bit order, change LCD_DATA_out\[7:0\] to LCD_DATA_out\[0:7\] in one byte mode, and bits\[15:0\] to bits\[0:15\] in two byte mode. 0: Not change.
pub type LCD_BIT_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_BYTE_ORDER` reader - 1: invert data byte order, only valid in 2 byte mode. 0: Not change.
pub type LCD_BYTE_ORDER_R = crate::BitReader;
///Field `LCD_BYTE_ORDER` writer - 1: invert data byte order, only valid in 2 byte mode. 0: Not change.
...
///Field `LCD_START` reader - LCD start sending data enable signal, valid in high level.
pub type LCD_START_R = crate::BitReader;
///Field `LCD_START` writer - LCD start sending data enable signal, valid in high level.
pub type LCD_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_RESET` writer - The value of command.
pub type LCD_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_DUMMY_CYCLELEN` reader - The dummy cycle length minus 1.
pub type LCD_DUMMY_CYCLELEN_R = crate::FieldReader;
///Field `LCD_DUMMY_CYCLELEN` writer - The dummy cycle length minus 1.
...
impl R {
    ...
    ///Bit 18 - 1: change bit order in every byte. 0: Not change.
    #[inline(always)]
    pub fn lcd_dout_bit_order(&self) -> LCD_DOUT_BIT_ORDER_R {
        LCD_DOUT_BIT_ORDER_R::new(((self.bits >> 18) & 1) != 0)
    }
    ///Bits 19:20 - 2: 24bit mode. 1: 16bit mode. 0: 8bit mode
    #[inline(always)]
    pub fn lcd_byte_mode(&self) -> LCD_BYTE_MODE_R {
        LCD_BYTE_MODE_R::new(((self.bits >> 19) & 3) as u8)
    }
    ///Bit 21 - 1: Update LCD registers, will be cleared by hardware. 0 : Not care.
    #[inline(always)]
    pub fn lcd_update(&self) -> LCD_UPDATE_R {
        LCD_UPDATE_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Bit 22 - 1: Change data bit order, change LCD_DATA_out\[7:0\] to LCD_DATA_out\[0:7\] in one byte mode, and bits\[15:0\] to bits\[0:15\] in two byte mode. 0: Not change.
    #[inline(always)]
    pub fn lcd_bit_order(&self) -> LCD_BIT_ORDER_R {
        LCD_BIT_ORDER_R::new(((self.bits >> 22) & 1) != 0)
    }
    ///Bit 23 - 1: invert data byte order, only valid in 2 byte mode. 0: Not change.
    #[inline(always)]
