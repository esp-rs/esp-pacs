...
///Field `LCD_VSYNC_INT_ST` reader - The status bit for LCD frame end interrupt.
pub type LCD_VSYNC_INT_ST_R = crate::BitReader;
///Field `LCD_TRANS_DONE_INT_ST` reader - The status bit for lcd transfer end interrupt.
pub type LCD_TRANS_DONE_INT_ST_R = crate::BitReader;
///Field `CAM_VSYNC_INT_ST` reader - The status bit for Camera frame end interrupt.
pub type CAM_VSYNC_INT_ST_R = crate::BitReader;
///Field `CAM_HS_INT_ST` reader - The status bit for Camera transfer end interrupt.
