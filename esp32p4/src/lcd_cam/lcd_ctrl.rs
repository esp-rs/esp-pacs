...
///Field `LCD_HB_FRONT` reader - It is the horizontal blank front porch of a frame.
pub type LCD_HB_FRONT_R = crate::FieldReader<u16>;
///Field `LCD_HB_FRONT` writer - It is the horizontal blank front porch of a frame.
pub type LCD_HB_FRONT_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `LCD_VA_HEIGHT` reader - It is the vertical active height of a frame.
pub type LCD_VA_HEIGHT_R = crate::FieldReader<u16>;
///Field `LCD_VA_HEIGHT` writer - It is the vertical active height of a frame.
pub type LCD_VA_HEIGHT_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `LCD_VT_HEIGHT` reader - It is the vertical total height of a frame.
pub type LCD_VT_HEIGHT_R = crate::FieldReader<u16>;
///Field `LCD_VT_HEIGHT` writer - It is the vertical total height of a frame.
pub type LCD_VT_HEIGHT_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `LCD_RGB_MODE_EN` reader - 1: Enable LCD RGB mode. 0: Disable LCD RGB mode.
pub type LCD_RGB_MODE_EN_R = crate::BitReader;
///Field `LCD_RGB_MODE_EN` writer - 1: Enable LCD RGB mode. 0: Disable LCD RGB mode.
...
impl R {
    ...
    ///Bit 31 - 1: Enable LCD RGB mode. 0: Disable LCD RGB mode.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LCD_CTRL")
            ...
            .field("lcd_rgb_mode_en", &self.lcd_rgb_mode_en())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`lcd_ctrl::R`](R) reader structure
impl crate::Readable for LCD_CTRL_SPEC {}
///`write(|w| ..)` method takes [`lcd_ctrl::W`](W) writer structure
