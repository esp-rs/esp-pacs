...
#[doc = "Field `IN_CHECK_OWNER` reader - Configures whether to enable owner bit check for RX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
pub type IN_CHECK_OWNER_R = crate::BitReader;
#[doc = "Field `IN_CHECK_OWNER` writer - Configures whether to enable owner bit check for RX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
...
impl W {
    #[doc = "Bit 12 - Configures whether to enable owner bit check for RX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn in_check_owner(&mut self) -> IN_CHECK_OWNER_W<'_, IN_CONF1_CH_SPEC> {
