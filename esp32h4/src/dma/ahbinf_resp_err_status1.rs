...
impl R {
    ...
    #[doc = "Bits 5:8 - Represents the AHB response error request channel id.bit\\[3\\]=1:TX channel.\\\\bit\\[3\\]=0:RX channel.\\\\"]
    #[inline(always)]
    pub fn ahbinf_resp_err_ch_id(&self) -> AHBINF_RESP_ERR_CH_ID_R {
        AHBINF_RESP_ERR_CH_ID_R::new(((self.bits >> 5) & 0x0f) as u8)
    }
}
...
#[doc = "`reset()` method sets AHBINF_RESP_ERR_STATUS1 to value 0x1e"]
