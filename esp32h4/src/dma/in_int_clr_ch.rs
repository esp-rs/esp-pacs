...
#[doc = "Field `IN_AHBINF_RESP_ERR` writer - Write 1 to clear AHB_DMA_IN_RESP_ERR_CH%s_INT."]
...
impl W {
    ...
    #[inline(always)]
    pub fn infifo_ovf(&mut self) -> INFIFO_OVF_W<'_, IN_INT_CLR_CH_SPEC> {
        INFIFO_OVF_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to clear AHB_DMA_INFIFO_UDF_CH%s_INT."]
    #[inline(always)]
    pub fn infifo_udf(&mut self) -> INFIFO_UDF_W<'_, IN_INT_CLR_CH_SPEC> {
        INFIFO_UDF_W::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to clear AHB_DMA_IN_RESP_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn in_ahbinf_resp_err(&mut self) -> IN_AHBINF_RESP_ERR_W<'_, IN_INT_CLR_CH_SPEC> {
