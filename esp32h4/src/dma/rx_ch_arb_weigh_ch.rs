...
#[doc = "Field `RX_CH_ARB_WEIGH` reader - Configures the weight(i.e the number of tokens) of RX channel%s"]
pub type RX_CH_ARB_WEIGH_R = crate::FieldReader;
#[doc = "Field `RX_CH_ARB_WEIGH` writer - Configures the weight(i.e the number of tokens) of RX channel%s"]
...
impl W {
    #[doc = "Bits 0:3 - Configures the weight(i.e the number of tokens) of RX channel%s"]
    #[inline(always)]
    pub fn rx_ch_arb_weigh(&mut self) -> RX_CH_ARB_WEIGH_W<'_, RX_CH_ARB_WEIGH_CH_SPEC> {
