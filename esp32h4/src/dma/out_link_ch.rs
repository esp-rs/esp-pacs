...
#[doc = "Field `OUTLINK_STOP` writer - Configures whether to stop AHB_DMA's TX channel %s from transmitting data.\\\\0: Invalid. No effect\\\\1: Stop\\\\"]
pub type OUTLINK_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTLINK_START` writer - Configures whether to enable AHB_DMA's TX channel %s for data transfer.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUTLINK_START_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTLINK_RESTART` writer - Configures whether to restart TX channel %s for AHB_DMA transfer.\\\\0: Invalid. No effect\\\\1: Restart\\\\"]
...
impl W {
    ...
    #[inline(always)]
    pub fn outlink_stop(&mut self) -> OUTLINK_STOP_W<'_, OUT_LINK_CH_SPEC> {
    ...
    #[inline(always)]
    pub fn outlink_start(&mut self) -> OUTLINK_START_W<'_, OUT_LINK_CH_SPEC> {
    ...
    #[inline(always)]
    pub fn outlink_restart(&mut self) -> OUTLINK_RESTART_W<'_, OUT_LINK_CH_SPEC> {
