...
#[doc = "Field `IN_AHBINF_RESP_ERR` reader - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH%s_INT."]
pub type IN_AHBINF_RESP_ERR_R = crate::BitReader;
#[doc = "Field `IN_AHBINF_RESP_ERR` writer - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH%s_INT."]
...
impl W {
    #[doc = "Bit 0 - Write 1 to enable AHB_DMA_IN_DONE_CH%s_INT."]
    #[inline(always)]
    pub fn in_done(&mut self) -> IN_DONE_W<'_, IN_INT_ENA_CH_SPEC> {
        IN_DONE_W::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 to enable AHB_DMA_IN_SUC_EOF_CH%s_INT."]
    #[inline(always)]
    pub fn in_suc_eof(&mut self) -> IN_SUC_EOF_W<'_, IN_INT_ENA_CH_SPEC> {
        IN_SUC_EOF_W::new(self, 1)
    }
    #[doc = "Bit 2 - Write 1 to enable AHB_DMA_IN_ERR_EOF_CH%s_INT."]
    #[inline(always)]
    pub fn in_err_eof(&mut self) -> IN_ERR_EOF_W<'_, IN_INT_ENA_CH_SPEC> {
        IN_ERR_EOF_W::new(self, 2)
    }
    #[doc = "Bit 3 - Write 1 to enable AHB_DMA_IN_DSCR_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn in_dscr_err(&mut self) -> IN_DSCR_ERR_W<'_, IN_INT_ENA_CH_SPEC> {
        IN_DSCR_ERR_W::new(self, 3)
    }
    #[doc = "Bit 4 - Write 1 to enable AHB_DMA_IN_DSCR_EMPTY_CH%s_INT."]
    #[inline(always)]
    pub fn in_dscr_empty(&mut self) -> IN_DSCR_EMPTY_W<'_, IN_INT_ENA_CH_SPEC> {
        IN_DSCR_EMPTY_W::new(self, 4)
    }
    #[doc = "Bit 5 - Write 1 to enable AHB_DMA_INFIFO_OVF_CH%s_INT."]
    #[inline(always)]
    pub fn infifo_ovf(&mut self) -> INFIFO_OVF_W<'_, IN_INT_ENA_CH_SPEC> {
        INFIFO_OVF_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to enable AHB_DMA_INFIFO_UDF_CH%s_INT."]
    #[inline(always)]
    pub fn infifo_udf(&mut self) -> INFIFO_UDF_W<'_, IN_INT_ENA_CH_SPEC> {
        INFIFO_UDF_W::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn in_ahbinf_resp_err(&mut self) -> IN_AHBINF_RESP_ERR_W<'_, IN_INT_ENA_CH_SPEC> {
