...
#[doc = "Field `INDSCR_BURST_EN` reader - Configures whether to enable INCR burst transfer for RX channel %s to read descriptors.\\\\0: Disable\\\\1: Enable\\\\"]
pub type INDSCR_BURST_EN_R = crate::BitReader;
#[doc = "Field `INDSCR_BURST_EN` writer - Configures whether to enable INCR burst transfer for RX channel %s to read descriptors.\\\\0: Disable\\\\1: Enable\\\\"]
...
#[doc = "Field `IN_ETM_EN` reader - Configures whether to enable ETM control for RX channel%s.\\\\0: Disable\\\\1: Enable\\\\"]
pub type IN_ETM_EN_R = crate::BitReader;
#[doc = "Field `IN_ETM_EN` writer - Configures whether to enable ETM control for RX channel%s.\\\\0: Disable\\\\1: Enable\\\\"]
