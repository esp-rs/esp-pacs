...
pub type R = crate::R<IN_LINK_ADDR_SPEC>;
#[doc = "Register `IN_LINK_ADDR` writer"]
pub type W = crate::W<IN_LINK_ADDR_SPEC>;
#[doc = "Field `INLINK_ADDR` reader - Configures the 32 bits of the first receive descriptor's address."]
pub type INLINK_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `INLINK_ADDR` writer - Configures the 32 bits of the first receive descriptor's address."]
...
impl W {
    #[doc = "Bits 0:31 - Configures the 32 bits of the first receive descriptor's address."]
    #[inline(always)]
    pub fn inlink_addr(&mut self) -> INLINK_ADDR_W<'_, IN_LINK_ADDR_SPEC> {
...
pub struct IN_LINK_ADDR_SPEC;
impl crate::RegisterSpec for IN_LINK_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`in_link_addr::R`](R) reader structure"]
impl crate::Readable for IN_LINK_ADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`in_link_addr::W`](W) writer structure"]
impl crate::Writable for IN_LINK_ADDR_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets IN_LINK_ADDR to value 0"]
impl crate::Resettable for IN_LINK_ADDR_SPEC {}
