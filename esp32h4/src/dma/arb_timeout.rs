...
#[doc = "Field `ARB_TIMEOUT` reader - Configures the time slot. Measurement unit: AHB bus clock cycle."]
pub type ARB_TIMEOUT_R = crate::FieldReader<u16>;
#[doc = "Field `ARB_TIMEOUT` writer - Configures the time slot. Measurement unit: AHB bus clock cycle."]
pub type ARB_TIMEOUT_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Configures the time slot. Measurement unit: AHB bus clock cycle."]
    #[inline(always)]
    pub fn arb_timeout(&self) -> ARB_TIMEOUT_R {
        ARB_TIMEOUT_R::new((self.bits & 0xffff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ARB_TIMEOUT")
            .field("arb_timeout", &self.arb_timeout())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:15 - Configures the time slot. Measurement unit: AHB bus clock cycle."]
    #[inline(always)]
    pub fn arb_timeout(&mut self) -> ARB_TIMEOUT_W<'_, ARB_TIMEOUT_SPEC> {
        ARB_TIMEOUT_W::new(self, 0)
    }
}
