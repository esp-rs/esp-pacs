...
#[doc = "Cluster CH%s, containing IN_CONF0_CH?, IN_CONF1_CH?, INFIFO_STATUS_CH?, IN_POP_CH?, IN_LINK_CH?, IN_LINK_ADDR_CH?, IN_STATE_CH?, IN_SUC_EOF_DES_ADDR_CH?, IN_ERR_EOF_DES_ADDR_CH?, IN_DSCR_CH?, IN_DSCR_BF0_CH?, IN_DSCR_BF1_CH?, IN_PRI_CH?, IN_PERI_SEL_CH?, OUT_CONF0_CH?, OUT_CONF1_CH?, OUTFIFO_STATUS_CH?, OUT_PUSH_CH?, OUT_LINK_CH?, OUT_LINK_ADDR_CH?, OUT_STATE_CH?, OUT_EOF_DES_ADDR_CH?, OUT_EOF_BFR_DES_ADDR_CH?, OUT_DSCR_CH?, OUT_DSCR_BF0_CH?, OUT_DSCR_BF1_CH?, OUT_PRI_CH?, OUT_PERI_SEL_CH?, IN_DONE_DES_ADDR_CH?, RX_CH_ARB_WEIGH_CH?, RX_ARB_WEIGH_OPT_DIR_CH?, OUT_DONE_DES_ADDR_CH?, TX_CH_ARB_WEIGH_CH?, TX_ARB_WEIGH_OPT_DIR_CH?"]
pub struct CH {
    in_conf0: IN_CONF0,
    in_conf1: IN_CONF1,
    ...
    in_done_des_addr: IN_DONE_DES_ADDR,
    in_dscr: IN_DSCR,
    ...
    out_done_des_addr: OUT_DONE_DES_ADDR,
    out_dscr: OUT_DSCR,
...
impl CH {
    ...
    #[doc = "0x10 - Linked list descriptor configuration and control register of RX channel 0"]
    #[inline(always)]
    pub const fn in_link(&self) -> &IN_LINK {
        &self.in_link
    }
    #[doc = "0x14 - Link list descriptor address configuration of RX channel 0"]
    #[inline(always)]
    pub const fn in_link_addr(&self) -> &IN_LINK_ADDR {
        &self.in_link_addr
    }
    #[doc = "0x18 - Receive status of RX channel 0"]
    #[inline(always)]
    pub const fn in_state(&self) -> &IN_STATE {
        &self.in_state
    }
    #[doc = "0x1c - Receive descriptor address when EOF occurs on RX channel 0"]
    #[inline(always)]
    pub const fn in_suc_eof_des_addr(&self) -> &IN_SUC_EOF_DES_ADDR {
        &self.in_suc_eof_des_addr
    }
    #[doc = "0x20 - Receive descriptor address when errors occur of RX channel 0"]
    #[inline(always)]
    pub const fn in_err_eof_des_addr(&self) -> &IN_ERR_EOF_DES_ADDR {
        &self.in_err_eof_des_addr
    }
    #[doc = "0x24 - RX_done Inlink descriptor address of RX channel 0"]
    #[inline(always)]
    pub const fn in_done_des_addr(&self) -> &IN_DONE_DES_ADDR {
        &self.in_done_des_addr
    }
    #[doc = "0x28 - Current receive descriptor address of RX channel 0"]
    #[inline(always)]
    pub const fn in_dscr(&self) -> &IN_DSCR {
        &self.in_dscr
    }
    #[doc = "0x2c - The last receive descriptor address of RX channel 0"]
    #[inline(always)]
    pub const fn in_dscr_bf0(&self) -> &IN_DSCR_BF0 {
        &self.in_dscr_bf0
    }
    #[doc = "0x30 - The second-to-last receive descriptor address of RX channel 0"]
    #[inline(always)]
    pub const fn in_dscr_bf1(&self) -> &IN_DSCR_BF1 {
        &self.in_dscr_bf1
    }
    #[doc = "0x34 - Priority register of RX channel 0"]
    #[inline(always)]
    pub const fn in_pri(&self) -> &IN_PRI {
        &self.in_pri
    }
    #[doc = "0x38 - Peripheral selection register of RX channel 0"]
    #[inline(always)]
    pub const fn in_peri_sel(&self) -> &IN_PERI_SEL {
        &self.in_peri_sel
    }
    #[doc = "0x3c - RX channel 0 arbitration weight configuration register"]
    #[inline(always)]
    pub const fn rx_ch_arb_weigh(&self) -> &RX_CH_ARB_WEIGH {
        &self.rx_ch_arb_weigh
    }
    #[doc = "0x40 - RX channel 0 weight arbitration optimization enable register"]
    #[inline(always)]
    pub const fn rx_arb_weigh_opt_dir(&self) -> &RX_ARB_WEIGH_OPT_DIR {
        &self.rx_arb_weigh_opt_dir
    }
    #[doc = "0x80 - Configuration register 0 of TX channel 0"]
    #[inline(always)]
    pub const fn out_conf0(&self) -> &OUT_CONF0 {
        &self.out_conf0
    }
    #[doc = "0x84 - Configuration register 1 of TX channel 0"]
    #[inline(always)]
    pub const fn out_conf1(&self) -> &OUT_CONF1 {
        &self.out_conf1
    }
    #[doc = "0x88 - Transmit FIFO status of TX channel 0"]
    #[inline(always)]
    pub const fn outfifo_status(&self) -> &OUTFIFO_STATUS {
        &self.outfifo_status
    }
    #[doc = "0x8c - Push control register of TX channel 0"]
    #[inline(always)]
    pub const fn out_push(&self) -> &OUT_PUSH {
        &self.out_push
    }
    #[doc = "0x90 - Linked list descriptor configuration and control register of TX channel 0"]
    #[inline(always)]
    pub const fn out_link(&self) -> &OUT_LINK {
        &self.out_link
    }
    #[doc = "0x94 - Link list descriptor address configuration of TX channel 0"]
    #[inline(always)]
    pub const fn out_link_addr(&self) -> &OUT_LINK_ADDR {
        &self.out_link_addr
    }
    #[doc = "0x98 - Transmit status of TX channel 0"]
    #[inline(always)]
    pub const fn out_state(&self) -> &OUT_STATE {
        &self.out_state
    }
    #[doc = "0x9c - Transmit descriptor address when EOF occurs on TX channel 0"]
    #[inline(always)]
    pub const fn out_eof_des_addr(&self) -> &OUT_EOF_DES_ADDR {
        &self.out_eof_des_addr
    }
    #[doc = "0xa0 - The last transmit descriptor address when EOF occurs on TX channel 0"]
    #[inline(always)]
    pub const fn out_eof_bfr_des_addr(&self) -> &OUT_EOF_BFR_DES_ADDR {
        &self.out_eof_bfr_des_addr
    }
    #[doc = "0xa4 - TX done outlink descriptor address of TX channel 0"]
    #[inline(always)]
    pub const fn out_done_des_addr(&self) -> &OUT_DONE_DES_ADDR {
        &self.out_done_des_addr
    }
    #[doc = "0xa8 - Current transmit descriptor address of TX channel 0"]
    #[inline(always)]
    pub const fn out_dscr(&self) -> &OUT_DSCR {
        &self.out_dscr
    }
    #[doc = "0xac - The last transmit descriptor address of TX channel 0"]
    #[inline(always)]
    pub const fn out_dscr_bf0(&self) -> &OUT_DSCR_BF0 {
        &self.out_dscr_bf0
    }
    #[doc = "0xb0 - The second-to-last transmit descriptor address of TX channel 0"]
    #[inline(always)]
    pub const fn out_dscr_bf1(&self) -> &OUT_DSCR_BF1 {
        &self.out_dscr_bf1
    }
    #[doc = "0xb4 - Priority register of TX channel 0"]
    #[inline(always)]
    pub const fn out_pri(&self) -> &OUT_PRI {
        &self.out_pri
    }
    #[doc = "0xb8 - Peripheral selection register of TX channel 0"]
    #[inline(always)]
    pub const fn out_peri_sel(&self) -> &OUT_PERI_SEL {
        &self.out_peri_sel
    }
    #[doc = "0xbc - TX channel 0 arbitration weight configuration register"]
    #[inline(always)]
    pub const fn tx_ch_arb_weigh(&self) -> &TX_CH_ARB_WEIGH {
        &self.tx_ch_arb_weigh
    }
    #[doc = "0xc0 - TX channel 0 weight arbitration optimization enable register"]
    #[inline(always)]
...
#[doc = "IN_DONE_DES_ADDR (r) register accessor: RX_done Inlink descriptor address of RX channel 0\n\nYou can [`read`](crate::Reg::read) this register and get [`in_done_des_addr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@in_done_des_addr`] module"]
pub type IN_DONE_DES_ADDR = crate::Reg<in_done_des_addr::IN_DONE_DES_ADDR_SPEC>;
#[doc = "RX_done Inlink descriptor address of RX channel 0"]
pub mod in_done_des_addr;
#[doc = "RX_CH_ARB_WEIGH (rw) register accessor: RX channel 0 arbitration weight configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_ch_arb_weigh::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_ch_arb_weigh::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rx_ch_arb_weigh`] module"]
...
#[doc = "OUT_DONE_DES_ADDR (r) register accessor: TX done outlink descriptor address of TX channel 0\n\nYou can [`read`](crate::Reg::read) this register and get [`out_done_des_addr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@out_done_des_addr`] module"]
pub type OUT_DONE_DES_ADDR = crate::Reg<out_done_des_addr::OUT_DONE_DES_ADDR_SPEC>;
#[doc = "TX done outlink descriptor address of TX channel 0"]
pub mod out_done_des_addr;
#[doc = "TX_CH_ARB_WEIGH (rw) register accessor: TX channel 0 arbitration weight configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`tx_ch_arb_weigh::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tx_ch_arb_weigh::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tx_ch_arb_weigh`] module"]
