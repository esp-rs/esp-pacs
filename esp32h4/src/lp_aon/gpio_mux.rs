...
#[doc = "Field `SEL` reader - select the lp io 0~5 controlled by hp iomux or lp iomux 1: controlled by lp iomux 0: controlled by hp iomux"]
pub type SEL_R = crate::FieldReader;
#[doc = "Field `SEL` writer - select the lp io 0~5 controlled by hp iomux or lp iomux 1: controlled by lp iomux 0: controlled by hp iomux"]
pub type SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - select the lp io 0~5 controlled by hp iomux or lp iomux 1: controlled by lp iomux 0: controlled by hp iomux"]
    #[inline(always)]
    pub fn sel(&self) -> SEL_R {
        SEL_R::new((self.bits & 0x3f) as u8)
    }
}
