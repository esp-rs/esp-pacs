...
#[doc = "Field `LP_AON_STORE1` reader - store the software massege1 in always-on field"]
pub type LP_AON_STORE1_R = crate::FieldReader<u32>;
#[doc = "Field `LP_AON_STORE1` writer - store the software massege1 in always-on field"]
pub type LP_AON_STORE1_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - store the software massege1 in always-on field"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STORE1")
            .field("lp_aon_store1", &self.lp_aon_store1())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - store the software massege1 in always-on field"]
    #[inline(always)]
    pub fn lp_aon_store1(&mut self) -> LP_AON_STORE1_W<'_, STORE1_SPEC> {
