...
#[doc = "Field `LP_AON_STORE2` reader - store the software massege2 in always-on field"]
pub type LP_AON_STORE2_R = crate::FieldReader<u32>;
#[doc = "Field `LP_AON_STORE2` writer - store the software massege2 in always-on field"]
pub type LP_AON_STORE2_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - store the software massege2 in always-on field"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - store the software massege2 in always-on field"]
    #[inline(always)]
    pub fn lp_aon_store2(&mut self) -> LP_AON_STORE2_W<'_, STORE2_SPEC> {
