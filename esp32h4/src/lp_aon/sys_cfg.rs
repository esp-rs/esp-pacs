...
#[doc = "Field `FIB` reader - get fib reg information"]
pub type FIB_R = crate::FieldReader;
...
impl R {
    #[doc = "Bits 0:7 - get fib reg information"]
    #[inline(always)]
    pub fn fib(&self) -> FIB_R {
        FIB_R::new((self.bits & 0xff) as u8)
    }
...
#[doc = "`reset()` method sets SYS_CFG to value 0xff"]
