...
#[doc = "Field `LP_AON_STORE5` reader - store the software massege5 in always-on field"]
pub type LP_AON_STORE5_R = crate::FieldReader<u32>;
#[doc = "Field `LP_AON_STORE5` writer - store the software massege5 in always-on field"]
pub type LP_AON_STORE5_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - store the software massege5 in always-on field"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - store the software massege5 in always-on field"]
    #[inline(always)]
    pub fn lp_aon_store5(&mut self) -> LP_AON_STORE5_W<'_, STORE5_SPEC> {
