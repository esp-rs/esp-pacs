...
impl RegisterBlock {
    ...
    #[doc = "0xd4..0x174 - GPIO%s configuration register"]
    #[inline(always)]
    ...
    #[doc = "0xad4..0xb74 - GPIO output function configuration register"]
    #[inline(always)]
