...
#[doc = "Field `PREP_DONE` reader - The raw interrupt status bit for the ecdsa_prep_done_int interrupt"]
pub type PREP_DONE_R = crate::BitReader;
#[doc = "Field `PROC_DONE` reader - The raw interrupt status bit for the ecdsa_proc_done_int interrupt"]
pub type PROC_DONE_R = crate::BitReader;
#[doc = "Field `POST_DONE` reader - The raw interrupt status bit for the ecdsa_post_done_int interrupt"]
