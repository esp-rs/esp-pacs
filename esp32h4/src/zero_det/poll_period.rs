...
#[doc = "Field `COMP_POLL_PERIOD` reader - poll period time for each cahnnel"]
pub type COMP_POLL_PERIOD_R = crate::FieldReader<u16>;
#[doc = "Field `COMP_POLL_PERIOD` writer - poll period time for each cahnnel"]
pub type COMP_POLL_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - poll period time for each cahnnel"]
    #[inline(always)]
