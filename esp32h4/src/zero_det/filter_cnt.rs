...
#[doc = "Field `FILTER_CNT` reader - protect time after det the frist zero det int"]
pub type FILTER_CNT_R = crate::FieldReader<u32>;
#[doc = "Field `FILTER_CNT` writer - protect time after det the frist zero det int"]
pub type FILTER_CNT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - protect time after det the frist zero det int"]
    #[inline(always)]
