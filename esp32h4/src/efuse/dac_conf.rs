...
#[doc = "Field `DAC_CLK_DIV` reader - Configures the division factor of the rising clock of the programming voltage."]
pub type DAC_CLK_DIV_R = crate::FieldReader;
#[doc = "Field `DAC_CLK_DIV` writer - Configures the division factor of the rising clock of the programming voltage."]
...
#[doc = "Field `DAC_NUM` reader - Configures clock cycles for programming voltage to rise. Measurement unit: a clock cycle divided by EFUSE_DAC_CLK_DIV."]
pub type DAC_NUM_R = crate::FieldReader;
#[doc = "Field `DAC_NUM` writer - Configures clock cycles for programming voltage to rise. Measurement unit: a clock cycle divided by EFUSE_DAC_CLK_DIV."]
...
impl R {
    #[doc = "Bits 0:7 - Configures the division factor of the rising clock of the programming voltage."]
    #[inline(always)]
    ...
    #[doc = "Bits 9:16 - Configures clock cycles for programming voltage to rise. Measurement unit: a clock cycle divided by EFUSE_DAC_CLK_DIV."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DAC_CONF to value 0x0001_fe13"]
impl crate::Resettable for DAC_CONF_SPEC {
    const RESET_VALUE: u32 = 0x0001_fe13;
}
