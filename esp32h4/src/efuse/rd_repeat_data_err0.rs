...
#[doc = "Field `DIS_CORE1_ERR` reader - Represents the programming error of EFUSE_DIS_CORE1"]
pub type DIS_CORE1_ERR_R = crate::BitReader;
...
impl R {
    ...
    #[doc = "Bit 7 - Represents the programming error of EFUSE_DIS_USB_JTAG"]
    #[inline(always)]
    pub fn dis_usb_jtag_err(&self) -> DIS_USB_JTAG_ERR_R {
        DIS_USB_JTAG_ERR_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - Represents the programming error of EFUSE_DIS_USB_SERIAL_JTAG"]
    #[inline(always)]
    pub fn dis_usb_serial_jtag_err(&self) -> DIS_USB_SERIAL_JTAG_ERR_R {
        DIS_USB_SERIAL_JTAG_ERR_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Represents the programming error of EFUSE_DIS_FORCE_DOWNLOAD"]
    #[inline(always)]
    pub fn dis_force_download_err(&self) -> DIS_FORCE_DOWNLOAD_ERR_R {
        DIS_FORCE_DOWNLOAD_ERR_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Represents the programming error of EFUSE_SPI_DOWNLOAD_MSPI_DIS"]
    #[inline(always)]
    pub fn spi_download_mspi_dis_err(&self) -> SPI_DOWNLOAD_MSPI_DIS_ERR_R {
        SPI_DOWNLOAD_MSPI_DIS_ERR_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Represents the programming error of EFUSE_DIS_TWAI"]
    #[inline(always)]
    pub fn dis_twai_err(&self) -> DIS_TWAI_ERR_R {
        DIS_TWAI_ERR_R::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    #[doc = "Bit 18 - Represents the programming error of EFUSE_PVT_GLITCH_EN"]
    #[inline(always)]
    pub fn pvt_glitch_en_err(&self) -> PVT_GLITCH_EN_ERR_R {
        PVT_GLITCH_EN_ERR_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bits 20:21 - Represents the programming error of EFUSE_PVT_GLITCH_MODE"]
    #[inline(always)]
    pub fn pvt_glitch_mode_err(&self) -> PVT_GLITCH_MODE_ERR_R {
        PVT_GLITCH_MODE_ERR_R::new(((self.bits >> 20) & 3) as u8)
    }
    #[doc = "Bit 22 - Represents the programming error of EFUSE_DIS_CORE1"]
    #[inline(always)]
    pub fn dis_core1_err(&self) -> DIS_CORE1_ERR_R {
        DIS_CORE1_ERR_R::new(((self.bits >> 22) & 1) != 0)
    }
    ...
    #[doc = "Bit 26 - Represents the programming error of EFUSE_SECURE_BOOT_KEY_REVOKE0"]
    #[inline(always)]
    pub fn secure_boot_key_revoke0_err(&self) -> SECURE_BOOT_KEY_REVOKE0_ERR_R {
        SECURE_BOOT_KEY_REVOKE0_ERR_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - Represents the programming error of EFUSE_SECURE_BOOT_KEY_REVOKE1"]
    #[inline(always)]
    pub fn secure_boot_key_revoke1_err(&self) -> SECURE_BOOT_KEY_REVOKE1_ERR_R {
        SECURE_BOOT_KEY_REVOKE1_ERR_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - Represents the programming error of EFUSE_SECURE_BOOT_KEY_REVOKE2"]
    #[inline(always)]
    pub fn secure_boot_key_revoke2_err(&self) -> SECURE_BOOT_KEY_REVOKE2_ERR_R {
        SECURE_BOOT_KEY_REVOKE2_ERR_R::new(((self.bits >> 28) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA_ERR0")
            ...
            .field("dis_core1_err", &self.dis_core1_err())
