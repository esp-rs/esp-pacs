...
pub struct RegisterBlock {
    ...
    task_en: TASK_EN,
    evt_en2: EVT_EN2,
    op0_tstmp_e1: OP0_TSTMP_E1,
    op0_tstmp_e2: OP0_TSTMP_E2,
    op1_tstmp_e1: OP1_TSTMP_E1,
    op1_tstmp_e2: OP1_TSTMP_E2,
    op2_tstmp_e1: OP2_TSTMP_E1,
    op2_tstmp_e2: OP2_TSTMP_E2,
    clk: CLK,
    version: VERSION,
}
impl RegisterBlock {
    #[doc = "0x00..0x30 - Cluster TIMER%s, containing TIMER?_CFG0, TIMER?_CFG1, TIMER?_SYNC, TIMER?_STATUS"]
    #[inline(always)]
    ...
    #[doc = "0x38..0xe0 - Cluster CH%s, containing GEN?_STMP_CFG, GEN?_TSTMP_A, GEN?_TSTMP_B, GEN?_CFG0, GEN?_FORCE, GEN?_A, GEN?_B, DT?_CFG, DT?_FED_CFG, DT?_RED_CFG, CARRIER?_CFG, FH?_CFG0, FH?_CFG1, FH?_STATUS"]
    #[inline(always)]
    ...
    #[doc = "0xec..0xf8 - Capture channel %s configuration and enable"]
    #[inline(always)]
    ...
    #[doc = "0xec - Capture channel 0 configuration and enable"]
    #[inline(always)]
    pub const fn cap_ch0_cfg(&self) -> &CAP_CH_CFG {
        self.cap_ch_cfg(0)
    }
    #[doc = "0xf0 - Capture channel 1 configuration and enable"]
    #[inline(always)]
    pub const fn cap_ch1_cfg(&self) -> &CAP_CH_CFG {
        self.cap_ch_cfg(1)
    }
    #[doc = "0xf4 - Capture channel 2 configuration and enable"]
    #[inline(always)]
    pub const fn cap_ch2_cfg(&self) -> &CAP_CH_CFG {
        self.cap_ch_cfg(2)
    }
    #[doc = "0xf8..0x104 - Value of last capture on channel %s"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn op0_tstmp_e1(&self) -> &OP0_TSTMP_E1 {
        &self.op0_tstmp_e1
    }
    #[doc = "0x12c - Generator0 timer stamp E2 value register"]
    #[inline(always)]
    pub const fn op0_tstmp_e2(&self) -> &OP0_TSTMP_E2 {
        &self.op0_tstmp_e2
    }
    #[doc = "0x130 - Generator1 timer stamp E1 value register"]
    #[inline(always)]
    pub const fn op1_tstmp_e1(&self) -> &OP1_TSTMP_E1 {
        &self.op1_tstmp_e1
    }
    #[doc = "0x134 - Generator1 timer stamp E2 value register"]
    #[inline(always)]
    pub const fn op1_tstmp_e2(&self) -> &OP1_TSTMP_E2 {
        &self.op1_tstmp_e2
    }
    #[doc = "0x138 - Generator2 timer stamp E1 value register"]
    #[inline(always)]
    pub const fn op2_tstmp_e1(&self) -> &OP2_TSTMP_E1 {
        &self.op2_tstmp_e1
    }
    #[doc = "0x13c - Generator2 timer stamp E2 value register"]
    #[inline(always)]
    pub const fn op2_tstmp_e2(&self) -> &OP2_TSTMP_E2 {
        &self.op2_tstmp_e2
    }
...
pub mod evt_en2;
#[doc = "OP0_TSTMP_E1 (rw) register accessor: Generator0 timer stamp E1 value register\n\nYou can [`read`](crate::Reg::read) this register and get [`op0_tstmp_e1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`op0_tstmp_e1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@op0_tstmp_e1`] module"]
pub type OP0_TSTMP_E1 = crate::Reg<op0_tstmp_e1::OP0_TSTMP_E1_SPEC>;
#[doc = "Generator0 timer stamp E1 value register"]
pub mod op0_tstmp_e1;
#[doc = "OP1_TSTMP_E1 (rw) register accessor: Generator1 timer stamp E1 value register\n\nYou can [`read`](crate::Reg::read) this register and get [`op1_tstmp_e1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`op1_tstmp_e1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@op1_tstmp_e1`] module"]
pub type OP1_TSTMP_E1 = crate::Reg<op1_tstmp_e1::OP1_TSTMP_E1_SPEC>;
#[doc = "Generator1 timer stamp E1 value register"]
pub mod op1_tstmp_e1;
#[doc = "OP2_TSTMP_E1 (rw) register accessor: Generator2 timer stamp E1 value register\n\nYou can [`read`](crate::Reg::read) this register and get [`op2_tstmp_e1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`op2_tstmp_e1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@op2_tstmp_e1`] module"]
pub type OP2_TSTMP_E1 = crate::Reg<op2_tstmp_e1::OP2_TSTMP_E1_SPEC>;
#[doc = "Generator2 timer stamp E1 value register"]
pub mod op2_tstmp_e1;
#[doc = "OP0_TSTMP_E2 (rw) register accessor: Generator0 timer stamp E2 value register\n\nYou can [`read`](crate::Reg::read) this register and get [`op0_tstmp_e2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`op0_tstmp_e2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@op0_tstmp_e2`] module"]
pub type OP0_TSTMP_E2 = crate::Reg<op0_tstmp_e2::OP0_TSTMP_E2_SPEC>;
#[doc = "Generator0 timer stamp E2 value register"]
pub mod op0_tstmp_e2;
#[doc = "OP1_TSTMP_E2 (rw) register accessor: Generator1 timer stamp E2 value register\n\nYou can [`read`](crate::Reg::read) this register and get [`op1_tstmp_e2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`op1_tstmp_e2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@op1_tstmp_e2`] module"]
pub type OP1_TSTMP_E2 = crate::Reg<op1_tstmp_e2::OP1_TSTMP_E2_SPEC>;
#[doc = "Generator1 timer stamp E2 value register"]
pub mod op1_tstmp_e2;
#[doc = "OP2_TSTMP_E2 (rw) register accessor: Generator2 timer stamp E2 value register\n\nYou can [`read`](crate::Reg::read) this register and get [`op2_tstmp_e2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`op2_tstmp_e2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@op2_tstmp_e2`] module"]
pub type OP2_TSTMP_E2 = crate::Reg<op2_tstmp_e2::OP2_TSTMP_E2_SPEC>;
#[doc = "Generator2 timer stamp E2 value register"]
pub mod op2_tstmp_e2;
