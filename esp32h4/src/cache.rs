...
impl RegisterBlock {
    ...
    #[doc = "0x34 - Cache data memory access configure register"]
    #[inline(always)]
    pub const fn l1_cache_data_mem_acs_conf(&self) -> &L1_CACHE_DATA_MEM_ACS_CONF {
        &self.l1_cache_data_mem_acs_conf
    }
    #[doc = "0x38 - Cache tag memory access configure register"]
    #[inline(always)]
    ...
    #[doc = "0x254 - Cache Preload Reset control register"]
    #[inline(always)]
    pub const fn l1_cache_preload_rst_ctrl(&self) -> &L1_CACHE_PRELOAD_RST_CTRL {
        &self.l1_cache_preload_rst_ctrl
    }
    #[doc = "0x258 - Cache Autoload buffer clear control register"]
    #[inline(always)]
    ...
    #[doc = "0x26c - Cache Tag/data memory content register"]
    #[inline(always)]
