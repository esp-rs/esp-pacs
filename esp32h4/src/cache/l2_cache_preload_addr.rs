...
#[doc = "Field `L2_CACHE_PRELOAD_ADDR` reader - Those bits are used to configure the start address of preload on L2-Cache, which should be used together with L2_CACHE_PRELOAD_SIZE_REG"]
