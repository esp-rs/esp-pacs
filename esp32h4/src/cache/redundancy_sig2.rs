...
#[doc = "Field `REDCY_SIG2` reader - Those bits are prepared for ECO."]
pub type REDCY_SIG2_R = crate::FieldReader<u32>;
#[doc = "Field `REDCY_SIG2` writer - Those bits are prepared for ECO."]
...
impl W {
    #[doc = "Bits 0:31 - Those bits are prepared for ECO."]
    #[inline(always)]
    pub fn redcy_sig2(&mut self) -> REDCY_SIG2_W<'_, REDUNDANCY_SIG2_SPEC> {
