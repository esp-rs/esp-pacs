...
#[doc = "Field `L1_CACHE_TRACE_ENA` reader - The bit is used to enable L1-Cache trace for the performance counter and fail tracer"]
pub type L1_CACHE_TRACE_ENA_R = crate::BitReader;
#[doc = "Field `L1_CACHE_TRACE_ENA` writer - The bit is used to enable L1-Cache trace for the performance counter and fail tracer"]
