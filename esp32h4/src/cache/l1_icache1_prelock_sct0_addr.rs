...
#[doc = "Field `L1_ICACHE1_PRELOCK_SCT0_ADDR` reader - Those bits are used to configure the start address of the first section of prelock on L1-ICache1, which should be used together with L1_ICACHE1_PRELOCK_SCT0_SIZE_REG"]
pub type L1_ICACHE1_PRELOCK_SCT0_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `L1_ICACHE1_PRELOCK_SCT0_ADDR` writer - Those bits are used to configure the start address of the first section of prelock on L1-ICache1, which should be used together with L1_ICACHE1_PRELOCK_SCT0_SIZE_REG"]
...
impl W {
    ...
    pub fn l1_icache1_prelock_sct0_addr(
        &mut self,
    ) -> L1_ICACHE1_PRELOCK_SCT0_ADDR_W<'_, L1_ICACHE1_PRELOCK_SCT0_ADDR_SPEC> {
