...
#[doc = "Field `L1_DCACHE_FREEZE_MODE` reader - The bit is used to configure mode of freeze operation L1-DCache. 0: a miss-access will stuck. 1: a miss-access will not stuck."]
pub type L1_DCACHE_FREEZE_MODE_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_FREEZE_MODE` writer - The bit is used to configure mode of freeze operation L1-DCache. 0: a miss-access will stuck. 1: a miss-access will not stuck."]
...
impl R {
    ...
    #[doc = "Bit 17 - The bit is used to configure mode of freeze operation L1-DCache. 0: a miss-access will stuck. 1: a miss-access will not stuck."]
    #[inline(always)]
