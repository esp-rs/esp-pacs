...
#[doc = "Field `L1_ICACHE0_PRELOAD_ADDR` reader - Those bits are used to configure the start address of preload on L1-ICache0, which should be used together with L1_ICACHE0_PRELOAD_SIZE_REG"]
pub type L1_ICACHE0_PRELOAD_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `L1_ICACHE0_PRELOAD_ADDR` writer - Those bits are used to configure the start address of preload on L1-ICache0, which should be used together with L1_ICACHE0_PRELOAD_SIZE_REG"]
