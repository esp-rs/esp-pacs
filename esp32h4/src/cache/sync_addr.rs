...
#[doc = "Field `SYNC_ADDR` reader - Those bits are used to configure the start address of the sync operation, which should be used together with CACHE_SYNC_SIZE_REG"]
pub type SYNC_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `SYNC_ADDR` writer - Those bits are used to configure the start address of the sync operation, which should be used together with CACHE_SYNC_SIZE_REG"]
