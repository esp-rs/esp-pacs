...
pub struct RegisterBlock {
    ...
    btmac_clk_cfg: BTMAC_CLK_CFG,
    clk_conf_force_on_2: CLK_CONF_FORCE_ON_2,
    apb_timeout_conf: APB_TIMEOUT_CONF,
    apb_timeout_exception_addr: APB_TIMEOUT_EXCEPTION_ADDR,
    date: DATE,
}
impl RegisterBlock {
    #[doc = "0x00 - TEST_CONF"]
    ...
    #[doc = "0x28 - BTMAC_CLK_CFG"]
    #[inline(always)]
    pub const fn btmac_clk_cfg(&self) -> &BTMAC_CLK_CFG {
        &self.btmac_clk_cfg
    }
    #[doc = "0x2c - CLK_CONF_FORCE_ON_2"]
    #[inline(always)]
    pub const fn clk_conf_force_on_2(&self) -> &CLK_CONF_FORCE_ON_2 {
        &self.clk_conf_force_on_2
    }
    #[doc = "0x30 - APB_TIMEOUT_CONF"]
    #[inline(always)]
    pub const fn apb_timeout_conf(&self) -> &APB_TIMEOUT_CONF {
        &self.apb_timeout_conf
    }
    #[doc = "0x34 - APB_TIMEOUT_EXCEPTION_ADDR"]
    #[inline(always)]
    pub const fn apb_timeout_exception_addr(&self) -> &APB_TIMEOUT_EXCEPTION_ADDR {
        &self.apb_timeout_exception_addr
    }
    #[doc = "0x38 - DATE"]
    #[inline(always)]
...
#[doc = "BTMAC_CLK_CFG (rw) register accessor: BTMAC_CLK_CFG\n\nYou can [`read`](crate::Reg::read) this register and get [`btmac_clk_cfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`btmac_clk_cfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@btmac_clk_cfg`] module"]
pub type BTMAC_CLK_CFG = crate::Reg<btmac_clk_cfg::BTMAC_CLK_CFG_SPEC>;
#[doc = "BTMAC_CLK_CFG"]
pub mod btmac_clk_cfg;
#[doc = "CLK_CONF_FORCE_ON_2 (rw) register accessor: CLK_CONF_FORCE_ON_2\n\nYou can [`read`](crate::Reg::read) this register and get [`clk_conf_force_on_2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`clk_conf_force_on_2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@clk_conf_force_on_2`] module"]
pub type CLK_CONF_FORCE_ON_2 = crate::Reg<clk_conf_force_on_2::CLK_CONF_FORCE_ON_2_SPEC>;
#[doc = "CLK_CONF_FORCE_ON_2"]
pub mod clk_conf_force_on_2;
#[doc = "APB_TIMEOUT_CONF (rw) register accessor: APB_TIMEOUT_CONF\n\nYou can [`read`](crate::Reg::read) this register and get [`apb_timeout_conf::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`apb_timeout_conf::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@apb_timeout_conf`] module"]
pub type APB_TIMEOUT_CONF = crate::Reg<apb_timeout_conf::APB_TIMEOUT_CONF_SPEC>;
#[doc = "APB_TIMEOUT_CONF"]
pub mod apb_timeout_conf;
#[doc = "APB_TIMEOUT_EXCEPTION_ADDR (r) register accessor: APB_TIMEOUT_EXCEPTION_ADDR\n\nYou can [`read`](crate::Reg::read) this register and get [`apb_timeout_exception_addr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@apb_timeout_exception_addr`] module"]
pub type APB_TIMEOUT_EXCEPTION_ADDR =
    crate::Reg<apb_timeout_exception_addr::APB_TIMEOUT_EXCEPTION_ADDR_SPEC>;
#[doc = "APB_TIMEOUT_EXCEPTION_ADDR"]
pub mod apb_timeout_exception_addr;
