...
pub struct RegisterBlock {
    ...
    _reserved51: [u8; 0xfc],
    in_done_des_addr_ch3: IN_DONE_DES_ADDR_CH3,
    _reserved52: [u8; 0xfc],
    in_done_des_addr_ch4: IN_DONE_DES_ADDR_CH4,
    _reserved53: [u8; 0xd8],
...
impl RegisterBlock {
    ...
    #[doc = "0x30 - Raw interrupt status interrupt of RX channel 3"]
    #[inline(always)]
    pub const fn in_int_raw_ch3(&self) -> &IN_INT_RAW_CH3 {
        &self.in_int_raw_ch3
    }
    #[doc = "0x40 - Raw interrupt status interrupt of RX channel 4"]
    #[inline(always)]
    ...
    #[doc = "0x124 - RX_done Inlink descriptor address of RX channel 0"]
    #[inline(always)]
    ...
    #[doc = "0x180..0x194 - Configuration register 0 of TX channel %s"]
    #[inline(always)]
    ...
    #[doc = "0x224 - RX_done inlink descriptor address of RX channel 1"]
    #[inline(always)]
    pub const fn in_done_des_addr_ch1(&self) -> &IN_DONE_DES_ADDR_CH1 {
        &self.in_done_des_addr_ch1
    }
    #[doc = "0x324 - RX_done inlink descriptor address of RX channel 2"]
    #[inline(always)]
    pub const fn in_done_des_addr_ch2(&self) -> &IN_DONE_DES_ADDR_CH2 {
        &self.in_done_des_addr_ch2
    }
    #[doc = "0x424 - RX_done inlink descriptor address of RX channel 3"]
    #[inline(always)]
    pub const fn in_done_des_addr_ch3(&self) -> &IN_DONE_DES_ADDR_CH3 {
        &self.in_done_des_addr_ch3
    }
    #[doc = "0x524 - RX_done inlink descriptor address of RX channel 4"]
    #[inline(always)]
    pub const fn in_done_des_addr_ch4(&self) -> &IN_DONE_DES_ADDR_CH4 {
        &self.in_done_des_addr_ch4
    }
...
#[doc = "IN_INT_RAW_CH3 (rw) register accessor: Raw interrupt status interrupt of RX channel 3\n\nYou can [`read`](crate::Reg::read) this register and get [`in_int_raw_ch3::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`in_int_raw_ch3::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@in_int_raw_ch3`] module"]
...
#[doc = "IN_INT_RAW_CH4 (rw) register accessor: Raw interrupt status interrupt of RX channel 4\n\nYou can [`read`](crate::Reg::read) this register and get [`in_int_raw_ch4::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`in_int_raw_ch4::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@in_int_raw_ch4`] module"]
...
#[doc = "IN_DONE_DES_ADDR_CH3 (r) register accessor: RX_done inlink descriptor address of RX channel 3\n\nYou can [`read`](crate::Reg::read) this register and get [`in_done_des_addr_ch3::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@in_done_des_addr_ch3`] module"]
pub type IN_DONE_DES_ADDR_CH3 = crate::Reg<in_done_des_addr_ch3::IN_DONE_DES_ADDR_CH3_SPEC>;
#[doc = "RX_done inlink descriptor address of RX channel 3"]
pub mod in_done_des_addr_ch3;
#[doc = "IN_DONE_DES_ADDR_CH4 (r) register accessor: RX_done inlink descriptor address of RX channel 4\n\nYou can [`read`](crate::Reg::read) this register and get [`in_done_des_addr_ch4::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@in_done_des_addr_ch4`] module"]
pub type IN_DONE_DES_ADDR_CH4 = crate::Reg<in_done_des_addr_ch4::IN_DONE_DES_ADDR_CH4_SPEC>;
#[doc = "RX_done inlink descriptor address of RX channel 4"]
pub mod in_done_des_addr_ch4;
