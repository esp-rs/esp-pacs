...
#[doc = "Field `GPIO_EXT_SIGMADELTA_CLK_EN` reader - Configures whether or not to enable the clock for sigma delta modulation.\\\\ 0: Not enable\\\\ 1: Enable\\\\%\\label{fielddesc:GPIOSDSPISWAP}- \\[GPIOSD_SPI_SWAP\\] Reserved."]
pub type GPIO_EXT_SIGMADELTA_CLK_EN_R = crate::BitReader;
#[doc = "Field `GPIO_EXT_SIGMADELTA_CLK_EN` writer - Configures whether or not to enable the clock for sigma delta modulation.\\\\ 0: Not enable\\\\ 1: Enable\\\\%\\label{fielddesc:GPIOSDSPISWAP}- \\[GPIOSD_SPI_SWAP\\] Reserved."]
