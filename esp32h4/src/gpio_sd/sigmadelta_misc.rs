...
#[doc = "Field `FUNCTION_CLK_EN` reader - Configures whether or not to enable the clock for sigma delta modulation.\\\\ 0: Not enable\\\\ 1: Enable\\\\%\\label{fielddesc:GPIOSDSPISWAP}- \\[GPIOSD_SPI_SWAP\\] Reserved."]
pub type FUNCTION_CLK_EN_R = crate::BitReader;
#[doc = "Field `FUNCTION_CLK_EN` writer - Configures whether or not to enable the clock for sigma delta modulation.\\\\ 0: Not enable\\\\ 1: Enable\\\\%\\label{fielddesc:GPIOSDSPISWAP}- \\[GPIOSD_SPI_SWAP\\] Reserved."]
...
impl R {
    ...
    pub fn function_clk_en(&self) -> FUNCTION_CLK_EN_R {
        FUNCTION_CLK_EN_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SIGMADELTA_MISC")
            .field("function_clk_en", &self.function_clk_en())
            .finish()
    }
}
impl W {
