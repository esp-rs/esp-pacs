...
#[doc = "Field `GPIO_SEL(15-19)` reader - Select GPIO%s for ETM task"]
pub type GPIO_SEL_R = crate::FieldReader;
#[doc = "Field `GPIO_SEL(15-19)` writer - Select GPIO%s for ETM task"]
pub type GPIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `GPIO_EN(15-19)` reader - Enable GPIO%s for ETM task"]
pub type GPIO_EN_R = crate::BitReader;
#[doc = "Field `GPIO_EN(15-19)` writer - Enable GPIO%s for ETM task"]
pub type GPIO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Select GPIO(15-19) for ETM task"]
    #[doc = ""]
