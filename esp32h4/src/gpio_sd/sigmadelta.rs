...
#[doc = "Field `GPIO_EXT_SD_IN` reader - Configures the duty cycle of sigma delta modulation output. \\\\"]
pub type GPIO_EXT_SD_IN_R = crate::FieldReader;
#[doc = "Field `GPIO_EXT_SD_IN` writer - Configures the duty cycle of sigma delta modulation output. \\\\"]
pub type GPIO_EXT_SD_IN_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `GPIO_EXT_SD_PRESCALE` reader - Configures the divider value to divide IO MUX operating clock. \\\\"]
pub type GPIO_EXT_SD_PRESCALE_R = crate::FieldReader;
#[doc = "Field `GPIO_EXT_SD_PRESCALE` writer - Configures the divider value to divide IO MUX operating clock. \\\\"]
