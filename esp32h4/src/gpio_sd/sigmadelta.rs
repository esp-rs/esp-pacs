...
#[doc = "Field `IN` reader - Configures the duty cycle of sigma delta modulation output. \\\\"]
pub type IN_R = crate::FieldReader;
#[doc = "Field `IN` writer - Configures the duty cycle of sigma delta modulation output. \\\\"]
pub type IN_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `PRESCALE` reader - Configures the divider value to divide IO MUX operating clock. \\\\"]
pub type PRESCALE_R = crate::FieldReader;
#[doc = "Field `PRESCALE` writer - Configures the divider value to divide IO MUX operating clock. \\\\"]
