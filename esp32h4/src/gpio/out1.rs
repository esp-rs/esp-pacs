...
#[doc = "Field `DATA_ORIG` reader - Configures the output value of GPIO32 ~ 43 output in simple GPIO output mode.\\\\ 0: Low level\\\\ 1: High level\\\\ The value of bit32 ~ bit43 correspond to the output value of GPIO32 ~ GPIO43 respectively. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_ORIG_R = crate::FieldReader<u16>;
#[doc = "Field `DATA_ORIG` writer - Configures the output value of GPIO32 ~ 43 output in simple GPIO output mode.\\\\ 0: Low level\\\\ 1: High level\\\\ The value of bit32 ~ bit43 correspond to the output value of GPIO32 ~ GPIO43 respectively. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    #[doc = "Bits 0:11 - Configures the output value of GPIO32 ~ 43 output in simple GPIO output mode.\\\\ 0: Low level\\\\ 1: High level\\\\ The value of bit32 ~ bit43 correspond to the output value of GPIO32 ~ GPIO43 respectively. Bitxx ~ bitxx is invalid.\\\\"]
    #[inline(always)]
    pub fn data_orig(&self) -> DATA_ORIG_R {
        DATA_ORIG_R::new((self.bits & 0x0fff) as u16)
    }
}
