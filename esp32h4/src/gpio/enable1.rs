...
#[doc = "Field `DATA` reader - Configures whether or not to enable the output of GPIO32 ~ GPIO43.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit32 ~ bit43 are corresponding to GPIO32 ~ GPIO43. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_R = crate::FieldReader<u16>;
#[doc = "Field `DATA` writer - Configures whether or not to enable the output of GPIO32 ~ GPIO43.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit32 ~ bit43 are corresponding to GPIO32 ~ GPIO43. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    #[doc = "Bits 0:11 - Configures whether or not to enable the output of GPIO32 ~ GPIO43.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit32 ~ bit43 are corresponding to GPIO32 ~ GPIO43. Bitxx ~ bitxx is invalid.\\\\"]
    #[inline(always)]
