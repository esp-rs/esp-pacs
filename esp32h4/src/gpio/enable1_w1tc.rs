...
#[doc = "Field `ENABLE1_W1TC` writer - Configures whether or not to clear the output enable register GPIO_ENABLE1_REG of GPIO32 ~ GPIO43. \\\\ 0: Not clear\\\\ 1: The corresponding bit in GPIO_ENABLE1_REG will be cleared\\\\ Bit32 ~ bit43 are corresponding to GPIO32 ~ GPIO43. Bitxx ~ bitxx is invalid. \\\\ Recommended operation: use this register to clear GPIO_ENABLE1_REG.\\\\"]
pub type ENABLE1_W1TC_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
