...
#[doc = "Field `ENABLE1_W1TS` writer - Configures whether or not to set the output enable register GPIO_ENABLE1_REG of GPIO32 ~ GPIO43.\\\\ 0: Not set\\\\ 1: The corresponding bit in GPIO_ENABLE1_REG will be set to 1\\\\ Bit32 ~ bit43 are corresponding to GPIO32 ~ GPIO43. Bitxx ~ bitxx is invalid. \\\\ Recommended operation: use this register to set GPIO_ENABLE1_REG.\\\\"]
pub type ENABLE1_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
