...
pub type STATUS_INTERRUPT_NEXT1_R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:11 - Represents the interrupt source signal of GPIO32 ~ GPIO43.\\\\ Bit0 ~ bit24 are corresponding to GPIO32 ~ GPIO43. Bitxx ~ bitxx is invalid. Each bit represents:\\\\ 0: The GPIO does not generate the interrupt configured by GPIO_PIN0_INT_TYPE.\\\\ 1: The GPIO generates an interrupt configured by GPIO_PIN0_INT_TYPE.\\\\ The interrupt could be rising edge interrupt, falling edge interrupt, level sensitive interrupt and any edge interrupt.\\\\"]
    #[inline(always)]
    pub fn status_interrupt_next1(&self) -> STATUS_INTERRUPT_NEXT1_R {
        STATUS_INTERRUPT_NEXT1_R::new((self.bits & 0x0fff) as u16)
    }
}
