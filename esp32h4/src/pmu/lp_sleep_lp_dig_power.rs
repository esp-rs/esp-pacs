...
#[doc = "Field `LP_SLEEP_VDD_IO_MODE` reader - need_des"]
pub type LP_SLEEP_VDD_IO_MODE_R = crate::FieldReader;
#[doc = "Field `LP_SLEEP_VDD_IO_MODE` writer - need_des"]
pub type LP_SLEEP_VDD_IO_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
impl R {
    ...
    #[inline(always)]
    pub fn lp_sleep_vdd_io_mode(&self) -> LP_SLEEP_VDD_IO_MODE_R {
        LP_SLEEP_VDD_IO_MODE_R::new(((self.bits >> 23) & 0x0f) as u8)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_SLEEP_LP_DIG_POWER")
            .field("lp_sleep_vdd_io_mode", &self.lp_sleep_vdd_io_mode())
...
impl W {
    #[doc = "Bits 23:26 - need_des"]
    #[inline(always)]
    pub fn lp_sleep_vdd_io_mode(
        &mut self,
    ) -> LP_SLEEP_VDD_IO_MODE_W<'_, LP_SLEEP_LP_DIG_POWER_SPEC> {
        LP_SLEEP_VDD_IO_MODE_W::new(self, 23)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
