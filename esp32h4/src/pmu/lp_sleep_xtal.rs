...
#[doc = "Field `LP_SLEEP_XPD_XTALX2` reader - need_des"]
pub type LP_SLEEP_XPD_XTALX2_R = crate::BitReader;
#[doc = "Field `LP_SLEEP_XPD_XTALX2` writer - need_des"]
pub type LP_SLEEP_XPD_XTALX2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn lp_sleep_xpd_xtalx2(&self) -> LP_SLEEP_XPD_XTALX2_R {
        LP_SLEEP_XPD_XTALX2_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_SLEEP_XTAL")
            .field("lp_sleep_xpd_xtalx2", &self.lp_sleep_xpd_xtalx2())
...
impl W {
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn lp_sleep_xpd_xtalx2(&mut self) -> LP_SLEEP_XPD_XTALX2_W<'_, LP_SLEEP_XTAL_SPEC> {
        LP_SLEEP_XPD_XTALX2_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
#[doc = "`reset()` method sets LP_SLEEP_XTAL to value 0xc000_0000"]
