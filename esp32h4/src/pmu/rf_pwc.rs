...
#[doc = "Field `XPD_FORCE_RFTX` reader - need_des"]
pub type XPD_FORCE_RFTX_R = crate::BitReader;
#[doc = "Field `XPD_FORCE_RFTX` writer - need_des"]
pub type XPD_FORCE_RFTX_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn xpd_force_rftx(&self) -> XPD_FORCE_RFTX_R {
        XPD_FORCE_RFTX_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RF_PWC")
            .field("xpd_force_rftx", &self.xpd_force_rftx())
...
impl W {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn xpd_force_rftx(&mut self) -> XPD_FORCE_RFTX_W<'_, RF_PWC_SPEC> {
        XPD_FORCE_RFTX_W::new(self, 26)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
