...
#[doc = "Field `PTXQSPCAVAIL` reader - Periodic Transmit Request Queue Space Available (PTxQSpcAvail) Indicates the number of free locations available to be written in the Periodic Transmit Request Queue. This queue holds both IN and OUT requests. - 8'h0: Periodic Transmit Request Queue is full - 8'h1: 1 location available - 8'h2: 2 locations available - n: n locations available (0 <= n <= 16) - Others: Reserved"]
pub type PTXQSPCAVAIL_R = crate::FieldReader;
#[doc = "Field `PTXQTOP` reader - Top of the Periodic Transmit Request Queue (PTxQTop) This indicates the Entry in the Periodic Tx Request Queue that is currently being processes by the MAC. This register is used for debugging. - Bit \\[31\\]: Odd/Even (micro)Frame -- 1'b0: send in even (micro)Frame -- 1'b1: send in odd (micro)Frame - Bits \\[30:27\\]: Channel/endpoint number - Bits \\[26:25\\]: Type -- 2'b00: IN/OUT -- 2'b01: Zero-length packet -- 2'b10: CSPLIT -- 2'b11: Disable channel command - Bit \\[24\\]: Terminate (last Entry for the selected channel/endpoint)"]
...
impl R {
    ...
    #[doc = "Bits 16:23 - Periodic Transmit Request Queue Space Available (PTxQSpcAvail) Indicates the number of free locations available to be written in the Periodic Transmit Request Queue. This queue holds both IN and OUT requests. - 8'h0: Periodic Transmit Request Queue is full - 8'h1: 1 location available - 8'h2: 2 locations available - n: n locations available (0 <= n <= 16) - Others: Reserved"]
    #[inline(always)]
    pub fn ptxqspcavail(&self) -> PTXQSPCAVAIL_R {
        PTXQSPCAVAIL_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Top of the Periodic Transmit Request Queue (PTxQTop) This indicates the Entry in the Periodic Tx Request Queue that is currently being processes by the MAC. This register is used for debugging. - Bit \\[31\\]: Odd/Even (micro)Frame -- 1'b0: send in even (micro)Frame -- 1'b1: send in odd (micro)Frame - Bits \\[30:27\\]: Channel/endpoint number - Bits \\[26:25\\]: Type -- 2'b00: IN/OUT -- 2'b01: Zero-length packet -- 2'b10: CSPLIT -- 2'b11: Disable channel command - Bit \\[24\\]: Terminate (last Entry for the selected channel/endpoint)"]
    #[inline(always)]
