...
#[doc = "Field `AHBERRMSK` reader - AHB Error Mask (AHBErrMsk) In scatter/gather DMA mode for host, interrupts will not be generated due to the corresponding bits set in HCINTn."]
pub type AHBERRMSK_R = crate::BitReader;
#[doc = "Field `AHBERRMSK` writer - AHB Error Mask (AHBErrMsk) In scatter/gather DMA mode for host, interrupts will not be generated due to the corresponding bits set in HCINTn."]
...
impl R {
    ...
    #[doc = "Bit 2 - AHB Error Mask (AHBErrMsk) In scatter/gather DMA mode for host, interrupts will not be generated due to the corresponding bits set in HCINTn."]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Transfer Completed Mask (XferComplMsk)"]
    #[inline(always)]
    pub fn xfercomplmsk(&mut self) -> XFERCOMPLMSK_W<'_, HCINTMSK5_SPEC> {
        XFERCOMPLMSK_W::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Halted Mask (ChHltdMsk)"]
    #[inline(always)]
    pub fn chhltdmsk(&mut self) -> CHHLTDMSK_W<'_, HCINTMSK5_SPEC> {
        CHHLTDMSK_W::new(self, 1)
    }
    #[doc = "Bit 2 - AHB Error Mask (AHBErrMsk) In scatter/gather DMA mode for host, interrupts will not be generated due to the corresponding bits set in HCINTn."]
    #[inline(always)]
    pub fn ahberrmsk(&mut self) -> AHBERRMSK_W<'_, HCINTMSK5_SPEC> {
        AHBERRMSK_W::new(self, 2)
    }
    #[doc = "Bit 11 - BNA (Buffer Not Available) Interrupt mask register (BNAIntrMsk) This bit is valid only when Scatter/Gather DMA mode is enabled."]
    #[inline(always)]
    pub fn bnaintrmsk(&mut self) -> BNAINTRMSK_W<'_, HCINTMSK5_SPEC> {
        BNAINTRMSK_W::new(self, 11)
    }
    #[doc = "Bit 13 - Descriptor List rollover interrupt Mask register(DESC_LST_ROLLIntrMsk) This bit is valid only when Scatter/Gather DMA mode is enabled."]
    #[inline(always)]
    pub fn desc_lst_rollintrmsk(&mut self) -> DESC_LST_ROLLINTRMSK_W<'_, HCINTMSK5_SPEC> {
        DESC_LST_ROLLINTRMSK_W::new(self, 13)
    }
}
#[doc = "Host Channel $i Interrupt Mask Register This register reflects the mask for each channel status described in the previous section.\n\nYou can [`read`](crate::Reg::read) this register and get [`hcintmsk5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hcintmsk5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
