...
#[doc = "Field `HSTNEGSCS` reader - Mode: HNP-capable Device Host Negotiation Success (HstNegScs) The controller sets this bit when host negotiation is successful. The controller clears this bit when the HNP Request (HNPReq) bit in this register is set. - 1'b0: Host negotiation failure - 1'b1: Host negotiation success"]
pub type HSTNEGSCS_R = crate::BitReader;
#[doc = "Field `HNPREQ` reader - Mode: HNP Capable OTG Device HNP Request (HNPReq) The application sets this bit to initiate an HNP request to the connected USB host. The application can clear this bit by writing a 0 when the Host Negotiation Success Status Change bit in the OTG Interrupt register (GOTGINT.HstNegSucStsChng) is SET. The controller clears this bit when the HstNegSucStsChng bit is cleared. - 1'b0: No HNP request - 1'b1: HNP request"]
pub type HNPREQ_R = crate::BitReader;
#[doc = "Field `HNPREQ` writer - Mode: HNP Capable OTG Device HNP Request (HNPReq) The application sets this bit to initiate an HNP request to the connected USB host. The application can clear this bit by writing a 0 when the Host Negotiation Success Status Change bit in the OTG Interrupt register (GOTGINT.HstNegSucStsChng) is SET. The controller clears this bit when the HstNegSucStsChng bit is cleared. - 1'b0: No HNP request - 1'b1: HNP request"]
pub type HNPREQ_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HSTSETHNPEN` reader - Mode: HNP Capable OTG Host Host Set HNP Enable (HstSetHNPEn) The application sets this bit when it has successfully enabled HNP (using the SetFeature.SetHNPEnable command) on the connected device. - 1'b0: Host Set HNP is not enabled - 1'b1: Host Set HNP is enabled"]
pub type HSTSETHNPEN_R = crate::BitReader;
#[doc = "Field `HSTSETHNPEN` writer - Mode: HNP Capable OTG Host Host Set HNP Enable (HstSetHNPEn) The application sets this bit when it has successfully enabled HNP (using the SetFeature.SetHNPEnable command) on the connected device. - 1'b0: Host Set HNP is not enabled - 1'b1: Host Set HNP is enabled"]
pub type HSTSETHNPEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DEVHNPEN` reader - Mode: HNP Capable OTG Device Device HNP Enabled (DevHNPEn) The application sets this bit when it successfully receives a SetFeature.SetHNPEnable command from the connected USB host. - 1'b0: HNP is not enabled in the application - 1'b1: HNP is enabled in the application"]
pub type DEVHNPEN_R = crate::BitReader;
#[doc = "Field `DEVHNPEN` writer - Mode: HNP Capable OTG Device Device HNP Enabled (DevHNPEn) The application sets this bit when it successfully receives a SetFeature.SetHNPEnable command from the connected USB host. - 1'b0: HNP is not enabled in the application - 1'b1: HNP is enabled in the application"]
pub type DEVHNPEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EHEN` reader - Mode: SRP Capable Host Embedded Host Enable (EHEn) It is used to select between OTG A Device state Machine and Embedded Host state machine. - 1'b0: OTG A Device state machine is selected - 1'b1: Embedded Host State Machine is selected Note: This field is valid only in SRP-Capable OTG Mode (OTG_MODE=0,1)."]
pub type EHEN_R = crate::BitReader;
#[doc = "Field `EHEN` writer - Mode: SRP Capable Host Embedded Host Enable (EHEn) It is used to select between OTG A Device state Machine and Embedded Host state machine. - 1'b0: OTG A Device state machine is selected - 1'b1: Embedded Host State Machine is selected Note: This field is valid only in SRP-Capable OTG Mode (OTG_MODE=0,1)."]
...
impl R {
    #[doc = "Bit 0 - Mode: Device only Session Request Success (SesReqScs) The core sets this bit when a session request initiation is successful. - 1'b0: Session request failure - 1'b1: Session request success"]
    #[inline(always)]
    pub fn sesreqscs(&self) -> SESREQSCS_R {
        SESREQSCS_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Mode: Device only Session Request (SesReq) The application sets this bit to initiate a session request on the USB. The application can clear this bit by writing a 0 when the Host Negotiation Success Status Change bit in the OTG Interrupt register (GOTGINT.HstNegSucStsChng) is SET. The core clears this bit when the HstNegSucStsChng bit is cleared. If you use the USB 1.1 Full-Speed Serial Transceiver interface to initiate the session request, the application must wait until the VBUS discharges to 0.2 V, after the B-Session Valid bit in this register (GOTGCTL.BSesVld) is cleared. This discharge time varies between different PHYs and can be obtained from the PHY vendor. - 1'b0: No session request - 1'b1: Session request"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Mode: HNP-capable Device Host Negotiation Success (HstNegScs) The controller sets this bit when host negotiation is successful. The controller clears this bit when the HNP Request (HNPReq) bit in this register is set. - 1'b0: Host negotiation failure - 1'b1: Host negotiation success"]
    #[inline(always)]
    pub fn hstnegscs(&self) -> HSTNEGSCS_R {
        HSTNEGSCS_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Mode: HNP Capable OTG Device HNP Request (HNPReq) The application sets this bit to initiate an HNP request to the connected USB host. The application can clear this bit by writing a 0 when the Host Negotiation Success Status Change bit in the OTG Interrupt register (GOTGINT.HstNegSucStsChng) is SET. The controller clears this bit when the HstNegSucStsChng bit is cleared. - 1'b0: No HNP request - 1'b1: HNP request"]
    #[inline(always)]
    pub fn hnpreq(&self) -> HNPREQ_R {
        HNPREQ_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Mode: HNP Capable OTG Host Host Set HNP Enable (HstSetHNPEn) The application sets this bit when it has successfully enabled HNP (using the SetFeature.SetHNPEnable command) on the connected device. - 1'b0: Host Set HNP is not enabled - 1'b1: Host Set HNP is enabled"]
    #[inline(always)]
    pub fn hstsethnpen(&self) -> HSTSETHNPEN_R {
        HSTSETHNPEN_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Mode: HNP Capable OTG Device Device HNP Enabled (DevHNPEn) The application sets this bit when it successfully receives a SetFeature.SetHNPEnable command from the connected USB host. - 1'b0: HNP is not enabled in the application - 1'b1: HNP is enabled in the application"]
    #[inline(always)]
