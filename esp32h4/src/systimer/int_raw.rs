...
#[doc = "Field `TARGET(0-2)` reader - The raw interrupt status of SYSTIMER_TARGET%s_INT."]
pub type TARGET_R = crate::BitReader;
#[doc = "Field `TARGET(0-2)` writer - The raw interrupt status of SYSTIMER_TARGET%s_INT."]
pub type TARGET_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "The raw interrupt status of SYSTIMER_TARGET(0-2)_INT."]
    #[doc = ""]
