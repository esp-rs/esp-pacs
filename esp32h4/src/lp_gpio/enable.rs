...
#[doc = "Field `DATA` reader - Configures whether or not to enable the output of LP_GPIO0 ~ LP_GPIO5.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit0 ~ bit5 are corresponding to LP_GPIO0 ~ LP_GPIO5. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_R = crate::FieldReader;
#[doc = "Field `DATA` writer - Configures whether or not to enable the output of LP_GPIO0 ~ LP_GPIO5.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit0 ~ bit5 are corresponding to LP_GPIO0 ~ LP_GPIO5. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - Configures whether or not to enable the output of LP_GPIO0 ~ LP_GPIO5.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit0 ~ bit5 are corresponding to LP_GPIO0 ~ LP_GPIO5. Bitxx ~ bitxx is invalid.\\\\"]
    #[inline(always)]
