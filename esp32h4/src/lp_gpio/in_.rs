...
#[doc = "Field `DATA_NEXT` reader - Represents the input value of LP_GPIO0 ~ LP_GPIO5. Each bit represents a pin input value:\\\\ 0: Low level\\\\ 1: High level\\\\ Bit0 ~ bit5 are corresponding to LP_GPIO0 ~ LP_GPIO5. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_NEXT_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:5 - Represents the input value of LP_GPIO0 ~ LP_GPIO5. Each bit represents a pin input value:\\\\ 0: Low level\\\\ 1: High level\\\\ Bit0 ~ bit5 are corresponding to LP_GPIO0 ~ LP_GPIO5. Bitxx ~ bitxx is invalid.\\\\"]
    #[inline(always)]
    pub fn data_next(&self) -> DATA_NEXT_R {
        DATA_NEXT_R::new((self.bits & 0x3f) as u8)
    }
}
