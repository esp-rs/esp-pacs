...
#[doc = "Field `STATUS_INTERRUPT_NEXT` reader - Represents the interrupt source signal of LP_GPIO0 ~ LP_GPIO5.\\\\ Bit0 ~ bit24 are corresponding to LP_GPIO0 ~ LP_GPIO5. Bitxx ~ bitxx is invalid. Each bit represents:\\\\ 0: The LP_GPIO does not generate the interrupt configured by LP_GPIO_PIN0_INT_TYPE.\\\\ 1: The LP_GPIO generates an interrupt configured by LP_GPIO_PIN0_INT_TYPE.\\\\ The interrupt could be rising edge interrupt, falling edge interrupt, level sensitive interrupt and any edge interrupt.\\\\"]
pub type STATUS_INTERRUPT_NEXT_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:5 - Represents the interrupt source signal of LP_GPIO0 ~ LP_GPIO5.\\\\ Bit0 ~ bit24 are corresponding to LP_GPIO0 ~ LP_GPIO5. Bitxx ~ bitxx is invalid. Each bit represents:\\\\ 0: The LP_GPIO does not generate the interrupt configured by LP_GPIO_PIN0_INT_TYPE.\\\\ 1: The LP_GPIO generates an interrupt configured by LP_GPIO_PIN0_INT_TYPE.\\\\ The interrupt could be rising edge interrupt, falling edge interrupt, level sensitive interrupt and any edge interrupt.\\\\"]
    #[inline(always)]
    pub fn status_interrupt_next(&self) -> STATUS_INTERRUPT_NEXT_R {
        STATUS_INTERRUPT_NEXT_R::new((self.bits & 0x3f) as u8)
    }
}
