...
#[doc = "Field `ENABLE_W1TS` writer - Configures whether or not to set the output enable register LP_GPIO_ENABLE_REG of LP_GPIO0 ~ LP_GPIO5.\\\\ 0: Not set\\\\ 1: The corresponding bit in LP_GPIO_ENABLE_REG will be set to 1\\\\ Bit0 ~ bit5 are corresponding to LP_GPIO0 ~ LP_GPIO5. Bitxx ~ bitxx is invalid. \\\\ Recommended operation: use this register to set LP_GPIO_ENABLE_REG.\\\\"]
pub type ENABLE_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
