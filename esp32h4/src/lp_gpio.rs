...
pub struct RegisterBlock {
    ...
    pin: [PIN; 6],
    _reserved12: [u8; 0x0268],
    func_out_sel_cfg: [FUNC_OUT_SEL_CFG; 6],
    _reserved13: [u8; 0x0130],
...
impl RegisterBlock {
    ...
    #[doc = "0x30..0x48 - LP_GPIO%s configuration register"]
    #[inline(always)]
    ...
    #[doc = "0x2b0..0x2c8 - Configuration register for LP_GPIO%s output"]
    #[inline(always)]
