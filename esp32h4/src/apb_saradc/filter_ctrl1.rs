    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FILTER_CTRL1")
            .field(
                ...
                &self.apb_saradc_filter_factor1(),
            )
            .field(
                "apb_saradc_filter_factor0",
                &self.apb_saradc_filter_factor0(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn apb_saradc_filter_factor1(
        &mut self,
    ) -> APB_SARADC_FILTER_FACTOR1_W<'_, FILTER_CTRL1_SPEC> {
    ...
    pub fn apb_saradc_filter_factor0(
        &mut self,
    ) -> APB_SARADC_FILTER_FACTOR0_W<'_, FILTER_CTRL1_SPEC> {
