...
impl W {
    #[doc = "Bits 0:7 - reg_wakeup_th_low"]
    #[inline(always)]
    pub fn wakeup_th_low(&mut self) -> WAKEUP_TH_LOW_W<'_, APB_TSENS_WAKE_SPEC> {
        WAKEUP_TH_LOW_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - reg_wakeup_th_high"]
    #[inline(always)]
    pub fn wakeup_th_high(&mut self) -> WAKEUP_TH_HIGH_W<'_, APB_TSENS_WAKE_SPEC> {
        WAKEUP_TH_HIGH_W::new(self, 8)
    }
    #[doc = "Bit 17 - reg_wakeup_mode"]
    #[inline(always)]
    pub fn wakeup_mode(&mut self) -> WAKEUP_MODE_W<'_, APB_TSENS_WAKE_SPEC> {
        WAKEUP_MODE_W::new(self, 17)
    }
    #[doc = "Bit 18 - reg_wakeup_en"]
    #[inline(always)]
    pub fn wakeup_en(&mut self) -> WAKEUP_EN_W<'_, APB_TSENS_WAKE_SPEC> {
        WAKEUP_EN_W::new(self, 18)
    }
}
#[doc = "digital tsens configure register\n\nYou can [`read`](crate::Reg::read) this register and get [`apb_tsens_wake::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`apb_tsens_wake::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
