...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FSM_WAIT")
            .field("saradc_xpd_wait", &self.saradc_xpd_wait())
...
impl W {
    #[doc = "Bits 0:7 - saradc_xpd_wait"]
    #[inline(always)]
    pub fn saradc_xpd_wait(&mut self) -> SARADC_XPD_WAIT_W<'_, FSM_WAIT_SPEC> {
        SARADC_XPD_WAIT_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - saradc_rstb_wait"]
    #[inline(always)]
    pub fn saradc_rstb_wait(&mut self) -> SARADC_RSTB_WAIT_W<'_, FSM_WAIT_SPEC> {
        SARADC_RSTB_WAIT_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - saradc_standby_wait"]
    #[inline(always)]
    pub fn saradc_standby_wait(&mut self) -> SARADC_STANDBY_WAIT_W<'_, FSM_WAIT_SPEC> {
