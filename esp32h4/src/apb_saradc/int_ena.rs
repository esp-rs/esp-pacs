...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            .field("apb_saradc_tsens_int_ena", &self.apb_saradc_tsens_int_ena())
            .field(
                "apb_saradc_thres1_low_int_ena",
                &self.apb_saradc_thres1_low_int_ena(),
            )
            .field(
                "apb_saradc_thres0_low_int_ena",
                &self.apb_saradc_thres0_low_int_ena(),
            )
            .field(
                "apb_saradc_thres1_high_int_ena",
                &self.apb_saradc_thres1_high_int_ena(),
            )
            .field(
                "apb_saradc_thres0_high_int_ena",
                &self.apb_saradc_thres0_high_int_ena(),
            )
            .field("apb_saradc2_done_int_ena", &self.apb_saradc2_done_int_ena())
            .field("apb_saradc1_done_int_ena", &self.apb_saradc1_done_int_ena())
            .finish()
    }
}
impl W {
    ...
    pub fn apb_saradc_thres1_low_int_ena(
        &mut self,
    ) -> APB_SARADC_THRES1_LOW_INT_ENA_W<'_, INT_ENA_SPEC> {
    ...
    pub fn apb_saradc_thres0_low_int_ena(
        &mut self,
    ) -> APB_SARADC_THRES0_LOW_INT_ENA_W<'_, INT_ENA_SPEC> {
    ...
    pub fn apb_saradc_thres1_high_int_ena(
        &mut self,
    ) -> APB_SARADC_THRES1_HIGH_INT_ENA_W<'_, INT_ENA_SPEC> {
    ...
    pub fn apb_saradc_thres0_high_int_ena(
        &mut self,
    ) -> APB_SARADC_THRES0_HIGH_INT_ENA_W<'_, INT_ENA_SPEC> {
