...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW")
            .field("apb_saradc_tsens_int_raw", &self.apb_saradc_tsens_int_raw())
            .field(
                "apb_saradc_thres1_low_int_raw",
                &self.apb_saradc_thres1_low_int_raw(),
            )
            .field(
                "apb_saradc_thres0_low_int_raw",
                &self.apb_saradc_thres0_low_int_raw(),
            )
            .field(
                "apb_saradc_thres1_high_int_raw",
                &self.apb_saradc_thres1_high_int_raw(),
            )
            .field(
                "apb_saradc_thres0_high_int_raw",
                &self.apb_saradc_thres0_high_int_raw(),
            )
            .field("apb_saradc2_done_int_raw", &self.apb_saradc2_done_int_raw())
            .field("apb_saradc1_done_int_raw", &self.apb_saradc1_done_int_raw())
            .finish()
    }
}
impl W {
    #[doc = "Bit 25 - saradc tsens interrupt raw"]
    #[inline(always)]
    pub fn apb_saradc_tsens_int_raw(&mut self) -> APB_SARADC_TSENS_INT_RAW_W<'_, INT_RAW_SPEC> {
    ...
    pub fn apb_saradc_thres1_low_int_raw(
        &mut self,
    ) -> APB_SARADC_THRES1_LOW_INT_RAW_W<'_, INT_RAW_SPEC> {
    ...
    pub fn apb_saradc_thres0_low_int_raw(
        &mut self,
    ) -> APB_SARADC_THRES0_LOW_INT_RAW_W<'_, INT_RAW_SPEC> {
    ...
    pub fn apb_saradc_thres1_high_int_raw(
        &mut self,
    ) -> APB_SARADC_THRES1_HIGH_INT_RAW_W<'_, INT_RAW_SPEC> {
    ...
    pub fn apb_saradc_thres0_high_int_raw(
        &mut self,
    ) -> APB_SARADC_THRES0_HIGH_INT_RAW_W<'_, INT_RAW_SPEC> {
        APB_SARADC_THRES0_HIGH_INT_RAW_W::new(self, 29)
    }
    #[doc = "Bit 30 - saradc2 done interrupt raw"]
    #[inline(always)]
    pub fn apb_saradc2_done_int_raw(&mut self) -> APB_SARADC2_DONE_INT_RAW_W<'_, INT_RAW_SPEC> {
        APB_SARADC2_DONE_INT_RAW_W::new(self, 30)
    }
    #[doc = "Bit 31 - saradc1 done interrupt raw"]
    #[inline(always)]
    pub fn apb_saradc1_done_int_raw(&mut self) -> APB_SARADC1_DONE_INT_RAW_W<'_, INT_RAW_SPEC> {
