...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ONETIME_SAMPLE")
            .field("saradc_onetime_atten", &self.saradc_onetime_atten())
            .field("saradc_onetime_channel", &self.saradc_onetime_channel())
            .field("saradc_onetime_start", &self.saradc_onetime_start())
...
impl W {
    #[doc = "Bits 23:24 - configure onetime atten"]
    #[inline(always)]
    pub fn saradc_onetime_atten(&mut self) -> SARADC_ONETIME_ATTEN_W<'_, ONETIME_SAMPLE_SPEC> {
        SARADC_ONETIME_ATTEN_W::new(self, 23)
    }
    #[doc = "Bits 25:28 - configure onetime channel"]
    #[inline(always)]
    pub fn saradc_onetime_channel(&mut self) -> SARADC_ONETIME_CHANNEL_W<'_, ONETIME_SAMPLE_SPEC> {
        SARADC_ONETIME_CHANNEL_W::new(self, 25)
    }
    #[doc = "Bit 29 - trigger adc onetime sample"]
    #[inline(always)]
    pub fn saradc_onetime_start(&mut self) -> SARADC_ONETIME_START_W<'_, ONETIME_SAMPLE_SPEC> {
