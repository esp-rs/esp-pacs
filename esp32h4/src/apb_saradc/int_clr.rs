...
#[doc = "Field `APB_SARADC_TSENS_INT_CLR` writer - saradc tsens interrupt clear"]
pub type APB_SARADC_TSENS_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn apb_saradc_tsens_int_clr(&mut self) -> APB_SARADC_TSENS_INT_CLR_W<'_, INT_CLR_SPEC> {
        APB_SARADC_TSENS_INT_CLR_W::new(self, 25)
    }
    #[doc = "Bit 26 - saradc thres1 low interrupt clear"]
    #[inline(always)]
    pub fn apb_saradc_thres1_low_int_clr(
        &mut self,
    ) -> APB_SARADC_THRES1_LOW_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    pub fn apb_saradc_thres0_low_int_clr(
        &mut self,
    ) -> APB_SARADC_THRES0_LOW_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    pub fn apb_saradc_thres1_high_int_clr(
        &mut self,
    ) -> APB_SARADC_THRES1_HIGH_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    pub fn apb_saradc_thres0_high_int_clr(
        &mut self,
    ) -> APB_SARADC_THRES0_HIGH_INT_CLR_W<'_, INT_CLR_SPEC> {
        APB_SARADC_THRES0_HIGH_INT_CLR_W::new(self, 29)
    }
    #[doc = "Bit 30 - saradc2 done interrupt clear"]
    #[inline(always)]
    pub fn apb_saradc2_done_int_clr(&mut self) -> APB_SARADC2_DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
        APB_SARADC2_DONE_INT_CLR_W::new(self, 30)
    }
    #[doc = "Bit 31 - saradc1 done interrupt clear"]
    #[inline(always)]
    pub fn apb_saradc1_done_int_clr(&mut self) -> APB_SARADC1_DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
