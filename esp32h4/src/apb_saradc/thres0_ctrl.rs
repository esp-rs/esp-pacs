    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("THRES0_CTRL")
            .field(
                ...
                &self.apb_saradc_thres0_channel(),
            )
            .field("apb_saradc_thres0_high", &self.apb_saradc_thres0_high())
            .field("apb_saradc_thres0_low", &self.apb_saradc_thres0_low())
            .finish()
    }
}
impl W {
    ...
    pub fn apb_saradc_thres0_channel(
        &mut self,
    ) -> APB_SARADC_THRES0_CHANNEL_W<'_, THRES0_CTRL_SPEC> {
        APB_SARADC_THRES0_CHANNEL_W::new(self, 0)
    }
    #[doc = "Bits 5:17 - saradc thres0 monitor thres"]
    #[inline(always)]
    pub fn apb_saradc_thres0_high(&mut self) -> APB_SARADC_THRES0_HIGH_W<'_, THRES0_CTRL_SPEC> {
        APB_SARADC_THRES0_HIGH_W::new(self, 5)
    }
    #[doc = "Bits 18:30 - saradc thres0 monitor thres"]
    #[inline(always)]
    pub fn apb_saradc_thres0_low(&mut self) -> APB_SARADC_THRES0_LOW_W<'_, THRES0_CTRL_SPEC> {
