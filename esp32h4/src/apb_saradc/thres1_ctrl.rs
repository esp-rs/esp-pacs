    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("THRES1_CTRL")
            .field(
                ...
                &self.apb_saradc_thres1_channel(),
            )
            .field("apb_saradc_thres1_high", &self.apb_saradc_thres1_high())
            .field("apb_saradc_thres1_low", &self.apb_saradc_thres1_low())
            .finish()
    }
}
impl W {
    ...
    pub fn apb_saradc_thres1_channel(
        &mut self,
    ) -> APB_SARADC_THRES1_CHANNEL_W<'_, THRES1_CTRL_SPEC> {
        APB_SARADC_THRES1_CHANNEL_W::new(self, 0)
    }
    #[doc = "Bits 5:17 - saradc thres1 monitor thres"]
    #[inline(always)]
    pub fn apb_saradc_thres1_high(&mut self) -> APB_SARADC_THRES1_HIGH_W<'_, THRES1_CTRL_SPEC> {
        APB_SARADC_THRES1_HIGH_W::new(self, 5)
    }
    #[doc = "Bits 18:30 - saradc thres1 monitor thres"]
    #[inline(always)]
    pub fn apb_saradc_thres1_low(&mut self) -> APB_SARADC_THRES1_LOW_W<'_, THRES1_CTRL_SPEC> {
