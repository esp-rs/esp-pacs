...
#[doc = "Field `REG_CG_FORCE_ON` reader - Write 1 to force on register clock gate."]
pub type REG_CG_FORCE_ON_R = crate::BitReader;
#[doc = "Field `REG_CG_FORCE_ON` writer - Write 1 to force on register clock gate."]
pub type REG_CG_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn reg_cg_force_on(&self) -> REG_CG_FORCE_ON_R {
        REG_CG_FORCE_ON_R::new((self.bits & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLK")
            .field("reg_cg_force_on", &self.reg_cg_force_on())
...
impl W {
    #[doc = "Bit 0 - Write 1 to force on register clock gate."]
    #[inline(always)]
    pub fn reg_cg_force_on(&mut self) -> REG_CG_FORCE_ON_W<'_, CLK_SPEC> {
        REG_CG_FORCE_ON_W::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 to force on memory clock gate."]
    #[inline(always)]
    pub fn mem_cg_force_on(&mut self) -> MEM_CG_FORCE_ON_W<'_, CLK_SPEC> {
