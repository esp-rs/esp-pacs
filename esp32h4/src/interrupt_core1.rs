...
pub struct RegisterBlock {
    core_1_intr_map: [CORE_1_INTR_MAP; 98],
    core_1_intr_status: [CORE_1_INTR_STATUS; 3],
    core_1_intr_status3: CORE_1_INTR_STATUS3,
    core_1_src_pass_in_sec_status: [CORE_1_SRC_PASS_IN_SEC_STATUS; 3],
    core_1_src_pass_in_sec_status3: CORE_1_SRC_PASS_IN_SEC_STATUS3,
...
impl RegisterBlock {
    #[doc = "0x00..0x188 - Interrupt-matrix destination and PASS_IN_SEC routing for source %s"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn core_1_intr_status3(&self) -> &CORE_1_INTR_STATUS3 {
        &self.core_1_intr_status3
    }
    #[doc = "0x198..0x1a4 - PASS_IN_SEC status for interrupt sources"]
    #[inline(always)]
    pub const fn core_1_src_pass_in_sec_status(&self, n: usize) -> &CORE_1_SRC_PASS_IN_SEC_STATUS {
        &self.core_1_src_pass_in_sec_status[n]
    }
    #[doc = "Iterator for array of:"]
    #[doc = "0x198..0x1a4 - PASS_IN_SEC status for interrupt sources"]
    #[inline(always)]
    pub fn core_1_src_pass_in_sec_status_iter(
        &self,
    ) -> impl Iterator<Item = &CORE_1_SRC_PASS_IN_SEC_STATUS> {
        self.core_1_src_pass_in_sec_status.iter()
    }
    #[doc = "0x1a4 - PASS_IN_SEC status register for interrupt sources 96 ~ 97"]
    #[inline(always)]
    pub const fn core_1_src_pass_in_sec_status3(&self) -> &CORE_1_SRC_PASS_IN_SEC_STATUS3 {
        &self.core_1_src_pass_in_sec_status3
    }
    #[doc = "0x1a8 - reserved"]
    #[inline(always)]
...
#[doc = "CORE_1_INTR_STATUS3 (r) register accessor: Status register for interrupt sources 96 ~ 97\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_intr_status3::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@core_1_intr_status3`] module"]
pub type CORE_1_INTR_STATUS3 = crate::Reg<core_1_intr_status3::CORE_1_INTR_STATUS3_SPEC>;
#[doc = "Status register for interrupt sources 96 ~ 97"]
pub mod core_1_intr_status3;
#[doc = "CORE_1_SRC_PASS_IN_SEC_STATUS (r) register accessor: PASS_IN_SEC status for interrupt sources\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_src_pass_in_sec_status::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@core_1_src_pass_in_sec_status`] module"]
pub type CORE_1_SRC_PASS_IN_SEC_STATUS =
    crate::Reg<core_1_src_pass_in_sec_status::CORE_1_SRC_PASS_IN_SEC_STATUS_SPEC>;
#[doc = "PASS_IN_SEC status for interrupt sources"]
pub mod core_1_src_pass_in_sec_status;
#[doc = "CORE_1_SRC_PASS_IN_SEC_STATUS3 (r) register accessor: PASS_IN_SEC status register for interrupt sources 96 ~ 97\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_src_pass_in_sec_status3::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@core_1_src_pass_in_sec_status3`] module"]
pub type CORE_1_SRC_PASS_IN_SEC_STATUS3 =
    crate::Reg<core_1_src_pass_in_sec_status3::CORE_1_SRC_PASS_IN_SEC_STATUS3_SPEC>;
#[doc = "PASS_IN_SEC status register for interrupt sources 96 ~ 97"]
pub mod core_1_src_pass_in_sec_status3;
