...
pub type SPI_SMEM_PMS2_ECC_R = crate::BitReader;
...
pub type SPI_SMEM_PMS2_ECC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_SMEM_PMS2_NONSECURE_RD_ATTR_R = crate::BitReader;
...
pub type SPI_SMEM_PMS2_NONSECURE_RD_ATTR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_SMEM_PMS2_NONSECURE_WR_ATTR_R = crate::BitReader;
...
pub type SPI_SMEM_PMS2_NONSECURE_WR_ATTR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_SMEM_PMS2_NONSECURE_ECC_R = crate::BitReader;
...
pub type SPI_SMEM_PMS2_NONSECURE_ECC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - 1: SPI1 external RAM PMS section 2 read accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms2_rd_attr(&self) -> SPI_SMEM_PMS2_RD_ATTR_R {
        SPI_SMEM_PMS2_RD_ATTR_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - 1: SPI1 external RAM PMS section 2 write accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms2_wr_attr(&self) -> SPI_SMEM_PMS2_WR_ATTR_R {
        SPI_SMEM_PMS2_WR_ATTR_R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_pms2_ecc(&self) -> SPI_SMEM_PMS2_ECC_R {
        SPI_SMEM_PMS2_ECC_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - 1: SPI1 external RAM non-secure PMS section 2 read accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms2_nonsecure_rd_attr(&self) -> SPI_SMEM_PMS2_NONSECURE_RD_ATTR_R {
        SPI_SMEM_PMS2_NONSECURE_RD_ATTR_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - 1: SPI1 external RAM non-secure PMS section 2 write accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms2_nonsecure_wr_attr(&self) -> SPI_SMEM_PMS2_NONSECURE_WR_ATTR_R {
        SPI_SMEM_PMS2_NONSECURE_WR_ATTR_R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_pms2_nonsecure_ecc(&self) -> SPI_SMEM_PMS2_NONSECURE_ECC_R {
        SPI_SMEM_PMS2_NONSECURE_ECC_R::new(((self.bits >> 5) & 1) != 0)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_SMEM_PMS2_ATTR")
            .field("spi_smem_pms2_rd_attr", &self.spi_smem_pms2_rd_attr())
            .field("spi_smem_pms2_wr_attr", &self.spi_smem_pms2_wr_attr())
            .field("spi_smem_pms2_ecc", &self.spi_smem_pms2_ecc())
            .field(
                "spi_smem_pms2_nonsecure_rd_attr",
                &self.spi_smem_pms2_nonsecure_rd_attr(),
            )
            .field(
                "spi_smem_pms2_nonsecure_wr_attr",
                &self.spi_smem_pms2_nonsecure_wr_attr(),
            )
            .field(
                "spi_smem_pms2_nonsecure_ecc",
                &self.spi_smem_pms2_nonsecure_ecc(),
            )
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - 1: SPI1 external RAM PMS section 2 read accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms2_rd_attr(
        &mut self,
    ) -> SPI_SMEM_PMS2_RD_ATTR_W<'_, SPI_SMEM_PMS2_ATTR_SPEC> {
        SPI_SMEM_PMS2_RD_ATTR_W::new(self, 0)
    }
    #[doc = "Bit 1 - 1: SPI1 external RAM PMS section 2 write accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms2_wr_attr(
        &mut self,
    ) -> SPI_SMEM_PMS2_WR_ATTR_W<'_, SPI_SMEM_PMS2_ATTR_SPEC> {
        SPI_SMEM_PMS2_WR_ATTR_W::new(self, 1)
    }
    #[doc = "Bit 2 - SPI1 external RAM PMS section 2 ECC mode, 1: enable ECC mode. 0: Disable it. The external RAM PMS section 2 is configured by registers SPI_SMEM_PMS2_ADDR_REG and SPI_SMEM_PMS2_SIZE_REG."]
    #[inline(always)]
    pub fn spi_smem_pms2_ecc(&mut self) -> SPI_SMEM_PMS2_ECC_W<'_, SPI_SMEM_PMS2_ATTR_SPEC> {
        SPI_SMEM_PMS2_ECC_W::new(self, 2)
    }
    #[doc = "Bit 3 - 1: SPI1 external RAM non-secure PMS section 2 read accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms2_nonsecure_rd_attr(
        &mut self,
    ) -> SPI_SMEM_PMS2_NONSECURE_RD_ATTR_W<'_, SPI_SMEM_PMS2_ATTR_SPEC> {
        SPI_SMEM_PMS2_NONSECURE_RD_ATTR_W::new(self, 3)
    }
    #[doc = "Bit 4 - 1: SPI1 external RAM non-secure PMS section 2 write accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms2_nonsecure_wr_attr(
        &mut self,
    ) -> SPI_SMEM_PMS2_NONSECURE_WR_ATTR_W<'_, SPI_SMEM_PMS2_ATTR_SPEC> {
        SPI_SMEM_PMS2_NONSECURE_WR_ATTR_W::new(self, 4)
    }
    #[doc = "Bit 5 - SPI1 external RAM non-secure PMS section 2 ECC mode, 1: enable ECC mode. 0: Disable it. The external RAM PMS section 2 is configured by registers SPI_SMEM_PMS2_ADDR_REG and SPI_SMEM_PMS2_SIZE_REG."]
    #[inline(always)]
    pub fn spi_smem_pms2_nonsecure_ecc(
        &mut self,
    ) -> SPI_SMEM_PMS2_NONSECURE_ECC_W<'_, SPI_SMEM_PMS2_ATTR_SPEC> {
        SPI_SMEM_PMS2_NONSECURE_ECC_W::new(self, 5)
    }
}
...
pub struct SPI_SMEM_PMS2_ATTR_SPEC;
impl crate::RegisterSpec for SPI_SMEM_PMS2_ATTR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi_smem_pms2_attr::R`](R) reader structure"]
impl crate::Readable for SPI_SMEM_PMS2_ATTR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`spi_smem_pms2_attr::W`](W) writer structure"]
impl crate::Writable for SPI_SMEM_PMS2_ATTR_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI_SMEM_PMS2_ATTR to value 0x1b"]
impl crate::Resettable for SPI_SMEM_PMS2_ATTR_SPEC {
