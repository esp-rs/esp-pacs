...
#[doc = "Field `REGDMA_RST_EN` reader - Set 1 to reset regdma module"]
pub type REGDMA_RST_EN_R = crate::BitReader;
#[doc = "Field `REGDMA_RST_EN` writer - Set 1 to reset regdma module"]
pub type REGDMA_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REGDMA_MAC_CLK_EN` reader - Set 1 to enable modem control regdma clock relate logic clock"]
pub type REGDMA_MAC_CLK_EN_R = crate::BitReader;
#[doc = "Field `REGDMA_MAC_CLK_EN` writer - Set 1 to enable modem control regdma clock relate logic clock"]
pub type REGDMA_MAC_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 2 - Set 1 to enable modem control regdma clock relate logic clock"]
    #[inline(always)]
    pub fn regdma_mac_clk_en(&self) -> REGDMA_MAC_CLK_EN_R {
        REGDMA_MAC_CLK_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGDMA_CONF")
            ...
            .field("regdma_mac_clk_en", &self.regdma_mac_clk_en())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 2 - Set 1 to enable modem control regdma clock relate logic clock"]
    #[inline(always)]
    pub fn regdma_mac_clk_en(&mut self) -> REGDMA_MAC_CLK_EN_W<'_, REGDMA_CONF_SPEC> {
        REGDMA_MAC_CLK_EN_W::new(self, 2)
    }
}
...
#[doc = "`reset()` method sets REGDMA_CONF to value 0x04"]
