...
#[doc = "Field `I2C0_CLK_EN` reader - Set 1 to enable i2c0 apb clock"]
pub type I2C0_CLK_EN_R = crate::BitReader;
#[doc = "Field `I2C0_CLK_EN` writer - Set 1 to enable i2c0 apb clock"]
pub type I2C0_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `I2C0_RST_EN` reader - Set 1 to reset i2c0 module"]
pub type I2C0_RST_EN_R = crate::BitReader;
#[doc = "Field `I2C0_RST_EN` writer - Set 1 to reset i2c0 module"]
pub type I2C0_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Set 1 to enable i2c0 apb clock"]
    #[inline(always)]
    pub fn i2c0_clk_en(&self) -> I2C0_CLK_EN_R {
        I2C0_CLK_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set 1 to reset i2c0 module"]
    #[inline(always)]
