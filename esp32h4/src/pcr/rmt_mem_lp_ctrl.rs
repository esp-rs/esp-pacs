...
#[doc = "Field `RMT_MEM_FORCE_CTRL` reader - Set this bit to force software control rmt memory, disbale hardware control."]
pub type RMT_MEM_FORCE_CTRL_R = crate::BitReader;
#[doc = "Field `RMT_MEM_FORCE_CTRL` writer - Set this bit to force software control rmt memory, disbale hardware control."]
pub type RMT_MEM_FORCE_CTRL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn rmt_mem_force_ctrl(&self) -> RMT_MEM_FORCE_CTRL_R {
        RMT_MEM_FORCE_CTRL_R::new(((self.bits >> 3) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RMT_MEM_LP_CTRL")
            ...
            .field("rmt_mem_force_ctrl", &self.rmt_mem_force_ctrl())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 3 - Set this bit to force software control rmt memory, disbale hardware control."]
    #[inline(always)]
    pub fn rmt_mem_force_ctrl(&mut self) -> RMT_MEM_FORCE_CTRL_W<'_, RMT_MEM_LP_CTRL_SPEC> {
        RMT_MEM_FORCE_CTRL_W::new(self, 3)
    }
}
...
#[doc = "`reset()` method sets RMT_MEM_LP_CTRL to value 0x04"]
