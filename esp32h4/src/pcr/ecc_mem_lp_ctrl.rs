...
#[doc = "Field `ECC_MEM_FORCE_CTRL` reader - Set this bit to force software control ecc memory, disbale hardware control."]
pub type ECC_MEM_FORCE_CTRL_R = crate::BitReader;
#[doc = "Field `ECC_MEM_FORCE_CTRL` writer - Set this bit to force software control ecc memory, disbale hardware control."]
pub type ECC_MEM_FORCE_CTRL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn ecc_mem_force_ctrl(&self) -> ECC_MEM_FORCE_CTRL_R {
        ECC_MEM_FORCE_CTRL_R::new(((self.bits >> 3) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ECC_MEM_LP_CTRL")
            ...
            .field("ecc_mem_force_ctrl", &self.ecc_mem_force_ctrl())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 3 - Set this bit to force software control ecc memory, disbale hardware control."]
    #[inline(always)]
    pub fn ecc_mem_force_ctrl(&mut self) -> ECC_MEM_FORCE_CTRL_W<'_, ECC_MEM_LP_CTRL_SPEC> {
        ECC_MEM_FORCE_CTRL_W::new(self, 3)
    }
}
