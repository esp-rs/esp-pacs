...
#[doc = "Field `KM_MEM_LP_MODE` reader - Configures km memory low power mode in low power stage.\\\\ 0: deep sleep\\\\ 1: light sleep\\\\ 2(default): shut down\\\\ 3: disable low power stage\\\\"]
pub type KM_MEM_LP_MODE_R = crate::FieldReader;
#[doc = "Field `KM_MEM_LP_MODE` writer - Configures km memory low power mode in low power stage.\\\\ 0: deep sleep\\\\ 1: light sleep\\\\ 2(default): shut down\\\\ 3: disable low power stage\\\\"]
...
#[doc = "Field `KM_MEM_FORCE_CTRL` reader - Set this bit to force software control km memory, disbale hardware control."]
pub type KM_MEM_FORCE_CTRL_R = crate::BitReader;
#[doc = "Field `KM_MEM_FORCE_CTRL` writer - Set this bit to force software control km memory, disbale hardware control."]
pub type KM_MEM_FORCE_CTRL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:1 - Configures km memory low power mode in low power stage.\\\\ 0: deep sleep\\\\ 1: light sleep\\\\ 2(default): shut down\\\\ 3: disable low power stage\\\\"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn km_mem_force_ctrl(&self) -> KM_MEM_FORCE_CTRL_R {
        KM_MEM_FORCE_CTRL_R::new(((self.bits >> 3) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("KM_MEM_LP_CTRL")
            ...
            .field("km_mem_force_ctrl", &self.km_mem_force_ctrl())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 3 - Set this bit to force software control km memory, disbale hardware control."]
    #[inline(always)]
    pub fn km_mem_force_ctrl(&mut self) -> KM_MEM_FORCE_CTRL_W<'_, KM_MEM_LP_CTRL_SPEC> {
        KM_MEM_FORCE_CTRL_W::new(self, 3)
    }
}
...
#[doc = "`reset()` method sets KM_MEM_LP_CTRL to value 0x06"]
