...
#[doc = "Field `TG1_RST_EN` reader - Set 1 to reset timer_group1 module"]
pub type TG1_RST_EN_R = crate::BitReader;
#[doc = "Field `TG1_RST_EN` writer - Set 1 to reset timer_group1 module"]
...
#[doc = "Field `TG1_TIMER1_READY` reader - Query this field after reset timer_group1 timer1 module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset timer_group1 module"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Query this field after reset timer_group1 timer1 module"]
    #[inline(always)]
