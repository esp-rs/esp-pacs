...
#[doc = "Field `DS_RST_EN` reader - Set 1 to reset ds module"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DS_CONF")
            ...
            .field("ds_ready", &self.ds_ready())
            .finish()
    }
}
#[doc = "DS configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`ds_conf::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets DS_CONF to value 0x04"]
