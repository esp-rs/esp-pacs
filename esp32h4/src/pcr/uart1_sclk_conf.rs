...
#[doc = "Field `UART1_SCLK_SEL` reader - Configures the clock source of UART1.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
pub type UART1_SCLK_SEL_R = crate::FieldReader;
#[doc = "Field `UART1_SCLK_SEL` writer - Configures the clock source of UART1.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
...
impl R {
    ...
    #[doc = "Bits 20:21 - Configures the clock source of UART1.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - The denominator of the frequency divider factor of the uart1 function clock."]
    #[inline(always)]
    pub fn uart1_sclk_div_a(&mut self) -> UART1_SCLK_DIV_A_W<'_, UART1_SCLK_CONF_SPEC> {
        UART1_SCLK_DIV_A_W::new(self, 0)
    }
    #[doc = "Bits 6:11 - The numerator of the frequency divider factor of the uart1 function clock."]
    #[inline(always)]
    pub fn uart1_sclk_div_b(&mut self) -> UART1_SCLK_DIV_B_W<'_, UART1_SCLK_CONF_SPEC> {
        UART1_SCLK_DIV_B_W::new(self, 6)
    }
    #[doc = "Bits 12:19 - The integral part of the frequency divider factor of the uart1 function clock."]
    #[inline(always)]
    pub fn uart1_sclk_div_num(&mut self) -> UART1_SCLK_DIV_NUM_W<'_, UART1_SCLK_CONF_SPEC> {
        UART1_SCLK_DIV_NUM_W::new(self, 12)
    }
    #[doc = "Bits 20:21 - Configures the clock source of UART1.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
    #[inline(always)]
    pub fn uart1_sclk_sel(&mut self) -> UART1_SCLK_SEL_W<'_, UART1_SCLK_CONF_SPEC> {
        UART1_SCLK_SEL_W::new(self, 20)
    }
    #[doc = "Bit 22 - Set 1 to enable uart0 function clock"]
    #[inline(always)]
    pub fn uart1_sclk_en(&mut self) -> UART1_SCLK_EN_W<'_, UART1_SCLK_CONF_SPEC> {
...
#[doc = "`reset()` method sets UART1_SCLK_CONF to value 0x0040_0000"]
