...
impl W {
    #[doc = "Bit 0 - Set 1 to enable 8m clock"]
    #[inline(always)]
    pub fn clk8_oen(&mut self) -> CLK8_OEN_W<'_, CTRL_CLK_OUT_EN_SPEC> {
        CLK8_OEN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set 1 to enable 16m clock"]
    #[inline(always)]
    pub fn clk16_oen(&mut self) -> CLK16_OEN_W<'_, CTRL_CLK_OUT_EN_SPEC> {
        CLK16_OEN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Set 1 to enable 32m clock"]
    #[inline(always)]
    pub fn clk32_oen(&mut self) -> CLK32_OEN_W<'_, CTRL_CLK_OUT_EN_SPEC> {
    ...
    #[doc = "Bit 4 - Reserved"]
    #[inline(always)]
    pub fn clk_dfm_inf_oen(&mut self) -> CLK_DFM_INF_OEN_W<'_, CTRL_CLK_OUT_EN_SPEC> {
        CLK_DFM_INF_OEN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Reserved"]
    #[inline(always)]
    pub fn clk_sdm_mod_oen(&mut self) -> CLK_SDM_MOD_OEN_W<'_, CTRL_CLK_OUT_EN_SPEC> {
