...
#[doc = "Field `I2S_RST_EN` reader - Set 1 to reset i2s module"]
pub type I2S_RST_EN_R = crate::BitReader;
#[doc = "Field `I2S_RST_EN` writer - Set 1 to reset i2s module"]
...
#[doc = "`reset()` method sets I2S_CONF to value 0x0c"]
