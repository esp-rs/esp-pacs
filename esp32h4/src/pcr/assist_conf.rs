...
#[doc = "Field `ASSIST_CLK_EN` reader - Set 1 to enable core0 assist clock"]
pub type ASSIST_CLK_EN_R = crate::BitReader;
#[doc = "Field `ASSIST_CLK_EN` writer - Set 1 to enable core0 assist clock"]
pub type ASSIST_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ASSIST_RST_EN` reader - Set 1 to reset core0 assist module"]
pub type ASSIST_RST_EN_R = crate::BitReader;
#[doc = "Field `ASSIST_RST_EN` writer - Set 1 to reset core0 assist module"]
pub type ASSIST_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ASSIST1_CLK_EN` reader - Set 1 to enable core1 assist clock"]
pub type ASSIST1_CLK_EN_R = crate::BitReader;
#[doc = "Field `ASSIST1_CLK_EN` writer - Set 1 to enable core1 assist clock"]
pub type ASSIST1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ASSIST1_RST_EN` reader - Set 1 to reset core1 assist module"]
pub type ASSIST1_RST_EN_R = crate::BitReader;
#[doc = "Field `ASSIST1_RST_EN` writer - Set 1 to reset core1 assist module"]
pub type ASSIST1_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Set 1 to enable core0 assist clock"]
    #[inline(always)]
    pub fn assist_clk_en(&self) -> ASSIST_CLK_EN_R {
        ASSIST_CLK_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set 1 to reset core0 assist module"]
    #[inline(always)]
    pub fn assist_rst_en(&self) -> ASSIST_RST_EN_R {
        ASSIST_RST_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Set 1 to enable core1 assist clock"]
    #[inline(always)]
    pub fn assist1_clk_en(&self) -> ASSIST1_CLK_EN_R {
        ASSIST1_CLK_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Set 1 to reset core1 assist module"]
    #[inline(always)]
    pub fn assist1_rst_en(&self) -> ASSIST1_RST_EN_R {
        ASSIST1_RST_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ASSIST_CONF")
            ...
            .field("assist1_clk_en", &self.assist1_clk_en())
            .field("assist1_rst_en", &self.assist1_rst_en())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 2 - Set 1 to enable core1 assist clock"]
    #[inline(always)]
    pub fn assist1_clk_en(&mut self) -> ASSIST1_CLK_EN_W<'_, ASSIST_CONF_SPEC> {
        ASSIST1_CLK_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Set 1 to reset core1 assist module"]
    #[inline(always)]
    pub fn assist1_rst_en(&mut self) -> ASSIST1_RST_EN_W<'_, ASSIST_CONF_SPEC> {
        ASSIST1_RST_EN_W::new(self, 3)
    }
}
...
#[doc = "`reset()` method sets ASSIST_CONF to value 0x09"]
