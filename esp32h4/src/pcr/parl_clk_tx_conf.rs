...
#[doc = "Field `PARL_TX_RST_EN` reader - Set 1 to reset parl tx module"]
pub type PARL_TX_RST_EN_R = crate::BitReader;
#[doc = "Field `PARL_TX_RST_EN` writer - Set 1 to reset parl tx module"]
...
impl R {
    ...
    #[doc = "Bit 19 - Set 1 to reset parl tx module"]
    #[inline(always)]
