...
#[doc = "Field `TG0_WDT_CLK_SEL` reader - Configures the clock source of WDT in Timer Group 0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
pub type TG0_WDT_CLK_SEL_R = crate::FieldReader;
#[doc = "Field `TG0_WDT_CLK_SEL` writer - Configures the clock source of WDT in Timer Group 0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
...
impl R {
    #[doc = "Bits 20:21 - Configures the clock source of WDT in Timer Group 0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 20:21 - Configures the clock source of WDT in Timer Group 0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
    #[inline(always)]
    pub fn tg0_wdt_clk_sel(&mut self) -> TG0_WDT_CLK_SEL_W<'_, TIMERGROUP0_WDT_CLK_CONF_SPEC> {
        TG0_WDT_CLK_SEL_W::new(self, 20)
    }
    #[doc = "Bit 22 - Set 1 to enable timer_group0 wdt clock"]
    #[inline(always)]
    pub fn tg0_wdt_clk_en(&mut self) -> TG0_WDT_CLK_EN_W<'_, TIMERGROUP0_WDT_CLK_CONF_SPEC> {
