...
#[doc = "Field `I2C1_CLK_EN` reader - Set 1 to enable i2c1 apb clock"]
pub type I2C1_CLK_EN_R = crate::BitReader;
#[doc = "Field `I2C1_CLK_EN` writer - Set 1 to enable i2c1 apb clock"]
pub type I2C1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `I2C1_RST_EN` reader - Set 1 to reset i2c1 module"]
pub type I2C1_RST_EN_R = crate::BitReader;
#[doc = "Field `I2C1_RST_EN` writer - Set 1 to reset i2c1 module"]
pub type I2C1_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Set 1 to enable i2c1 apb clock"]
    #[inline(always)]
    pub fn i2c1_clk_en(&self) -> I2C1_CLK_EN_R {
        I2C1_CLK_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set 1 to reset i2c1 module"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Set 1 to enable i2c1 apb clock"]
    #[inline(always)]
    pub fn i2c1_clk_en(&mut self) -> I2C1_CLK_EN_W<'_, I2C1_CONF_SPEC> {
        I2C1_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set 1 to reset i2c1 module"]
    #[inline(always)]
    pub fn i2c1_rst_en(&mut self) -> I2C1_RST_EN_W<'_, I2C1_CONF_SPEC> {
        I2C1_RST_EN_W::new(self, 1)
    }
}
#[doc = "I2C configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c1_conf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c1_conf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
