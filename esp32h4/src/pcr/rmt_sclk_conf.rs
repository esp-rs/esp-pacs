...
#[doc = "Field `SCLK_SEL` reader - Configures the clock source of RMT.\\\\ 0: XTAL_CLK\\\\ 1 (default): RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
pub type SCLK_SEL_R = crate::BitReader;
#[doc = "Field `SCLK_SEL` writer - Configures the clock source of RMT.\\\\ 0: XTAL_CLK\\\\ 1 (default): RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
...
impl R {
    ...
    #[doc = "Bit 20 - Configures the clock source of RMT.\\\\ 0: XTAL_CLK\\\\ 1 (default): RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - The denominator of the frequency divider factor of the rmt function clock."]
    #[inline(always)]
    pub fn sclk_div_a(&mut self) -> SCLK_DIV_A_W<'_, RMT_SCLK_CONF_SPEC> {
        SCLK_DIV_A_W::new(self, 0)
    }
    #[doc = "Bits 6:11 - The numerator of the frequency divider factor of the rmt function clock."]
    #[inline(always)]
    pub fn sclk_div_b(&mut self) -> SCLK_DIV_B_W<'_, RMT_SCLK_CONF_SPEC> {
        SCLK_DIV_B_W::new(self, 6)
    }
    #[doc = "Bits 12:19 - The integral part of the frequency divider factor of the rmt function clock."]
    #[inline(always)]
    pub fn sclk_div_num(&mut self) -> SCLK_DIV_NUM_W<'_, RMT_SCLK_CONF_SPEC> {
        SCLK_DIV_NUM_W::new(self, 12)
    }
    #[doc = "Bit 20 - Configures the clock source of RMT.\\\\ 0: XTAL_CLK\\\\ 1 (default): RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
    #[inline(always)]
    pub fn sclk_sel(&mut self) -> SCLK_SEL_W<'_, RMT_SCLK_CONF_SPEC> {
        SCLK_SEL_W::new(self, 20)
    }
    #[doc = "Bit 21 - Set 1 to enable rmt function clock"]
    #[inline(always)]
    pub fn sclk_en(&mut self) -> SCLK_EN_W<'_, RMT_SCLK_CONF_SPEC> {
