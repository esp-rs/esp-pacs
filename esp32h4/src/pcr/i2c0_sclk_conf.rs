...
#[doc = "Field `I2C0_SCLK_DIV_A` reader - The denominator of the frequency divider factor of the i2c0 function clock."]
pub type I2C0_SCLK_DIV_A_R = crate::FieldReader;
#[doc = "Field `I2C0_SCLK_DIV_A` writer - The denominator of the frequency divider factor of the i2c0 function clock."]
pub type I2C0_SCLK_DIV_A_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `I2C0_SCLK_DIV_B` reader - The numerator of the frequency divider factor of the i2c0 function clock."]
pub type I2C0_SCLK_DIV_B_R = crate::FieldReader;
#[doc = "Field `I2C0_SCLK_DIV_B` writer - The numerator of the frequency divider factor of the i2c0 function clock."]
pub type I2C0_SCLK_DIV_B_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
#[doc = "Field `I2C0_SCLK_DIV_NUM` reader - The integral part of the frequency divider factor of the i2c0 function clock."]
pub type I2C0_SCLK_DIV_NUM_R = crate::FieldReader;
#[doc = "Field `I2C0_SCLK_DIV_NUM` writer - The integral part of the frequency divider factor of the i2c0 function clock."]
pub type I2C0_SCLK_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `I2C0_SCLK_SEL` reader - Configures the clock source of I2C.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
pub type I2C0_SCLK_SEL_R = crate::BitReader;
#[doc = "Field `I2C0_SCLK_SEL` writer - Configures the clock source of I2C.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
...
impl R {
    #[doc = "Bits 0:5 - The denominator of the frequency divider factor of the i2c0 function clock."]
    #[inline(always)]
    pub fn i2c0_sclk_div_a(&self) -> I2C0_SCLK_DIV_A_R {
        I2C0_SCLK_DIV_A_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 6:11 - The numerator of the frequency divider factor of the i2c0 function clock."]
    #[inline(always)]
    pub fn i2c0_sclk_div_b(&self) -> I2C0_SCLK_DIV_B_R {
        I2C0_SCLK_DIV_B_R::new(((self.bits >> 6) & 0x3f) as u8)
    }
    #[doc = "Bits 12:19 - The integral part of the frequency divider factor of the i2c0 function clock."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - The denominator of the frequency divider factor of the i2c0 function clock."]
    #[inline(always)]
    pub fn i2c0_sclk_div_a(&mut self) -> I2C0_SCLK_DIV_A_W<'_, I2C0_SCLK_CONF_SPEC> {
        I2C0_SCLK_DIV_A_W::new(self, 0)
    }
    #[doc = "Bits 6:11 - The numerator of the frequency divider factor of the i2c0 function clock."]
    #[inline(always)]
    pub fn i2c0_sclk_div_b(&mut self) -> I2C0_SCLK_DIV_B_W<'_, I2C0_SCLK_CONF_SPEC> {
        I2C0_SCLK_DIV_B_W::new(self, 6)
    }
    #[doc = "Bits 12:19 - The integral part of the frequency divider factor of the i2c0 function clock."]
    #[inline(always)]
    pub fn i2c0_sclk_div_num(&mut self) -> I2C0_SCLK_DIV_NUM_W<'_, I2C0_SCLK_CONF_SPEC> {
        I2C0_SCLK_DIV_NUM_W::new(self, 12)
    }
    #[doc = "Bit 20 - Configures the clock source of I2C.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
    #[inline(always)]
    pub fn i2c0_sclk_sel(&mut self) -> I2C0_SCLK_SEL_W<'_, I2C0_SCLK_CONF_SPEC> {
        I2C0_SCLK_SEL_W::new(self, 20)
    }
    #[doc = "Bit 22 - Set 1 to enable i2c function clock"]
    #[inline(always)]
    pub fn i2c0_sclk_en(&mut self) -> I2C0_SCLK_EN_W<'_, I2C0_SCLK_CONF_SPEC> {
...
#[doc = "`reset()` method sets I2C0_SCLK_CONF to value 0"]
