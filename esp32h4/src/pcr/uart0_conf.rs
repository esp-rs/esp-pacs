...
#[doc = "Field `UART0_RST_EN` reader - Set 1 to reset uart0 module"]
pub type UART0_RST_EN_R = crate::BitReader;
#[doc = "Field `UART0_RST_EN` writer - Set 1 to reset uart0 module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset uart0 module"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Set 1 to enable uart0 apb clock"]
    #[inline(always)]
    pub fn uart0_clk_en(&mut self) -> UART0_CLK_EN_W<'_, UART0_CONF_SPEC> {
        UART0_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set 1 to reset uart0 module"]
    #[inline(always)]
    pub fn uart0_rst_en(&mut self) -> UART0_RST_EN_W<'_, UART0_CONF_SPEC> {
