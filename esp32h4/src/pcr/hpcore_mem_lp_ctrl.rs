...
#[doc = "Field `HPCORE_MEM_LP_MODE` reader - Configures memory low power mode in low power stage.\\\\ 0(default): deep sleep\\\\ 1: light sleep\\\\ 2: shut down\\\\ 3: disable low power stage\\\\"]
pub type HPCORE_MEM_LP_MODE_R = crate::FieldReader;
#[doc = "Field `HPCORE_MEM_LP_MODE` writer - Configures memory low power mode in low power stage.\\\\ 0(default): deep sleep\\\\ 1: light sleep\\\\ 2: shut down\\\\ 3: disable low power stage\\\\"]
pub type HPCORE_MEM_LP_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `HPCORE_MEM_LP_EN` reader - Set this bit to power down HP CORE0 & HP CORE1 memory."]
pub type HPCORE_MEM_LP_EN_R = crate::BitReader;
#[doc = "Field `HPCORE_MEM_LP_EN` writer - Set this bit to power down HP CORE0 & HP CORE1 memory."]
pub type HPCORE_MEM_LP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HPCORE_MEM_FORCE_CTRL` reader - Set this bit to force software control HP CORE0 & HP CORE1 memory, disbale hardware control."]
pub type HPCORE_MEM_FORCE_CTRL_R = crate::BitReader;
#[doc = "Field `HPCORE_MEM_FORCE_CTRL` writer - Set this bit to force software control HP CORE0 & HP CORE1 memory, disbale hardware control."]
pub type HPCORE_MEM_FORCE_CTRL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:1 - Configures memory low power mode in low power stage.\\\\ 0(default): deep sleep\\\\ 1: light sleep\\\\ 2: shut down\\\\ 3: disable low power stage\\\\"]
    #[inline(always)]
    pub fn hpcore_mem_lp_mode(&self) -> HPCORE_MEM_LP_MODE_R {
        HPCORE_MEM_LP_MODE_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 2 - Set this bit to power down HP CORE0 & HP CORE1 memory."]
    #[inline(always)]
    pub fn hpcore_mem_lp_en(&self) -> HPCORE_MEM_LP_EN_R {
        HPCORE_MEM_LP_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Set this bit to force software control HP CORE0 & HP CORE1 memory, disbale hardware control."]
    #[inline(always)]
    pub fn hpcore_mem_force_ctrl(&self) -> HPCORE_MEM_FORCE_CTRL_R {
        HPCORE_MEM_FORCE_CTRL_R::new(((self.bits >> 3) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HPCORE_MEM_LP_CTRL")
            ...
            .field("hpcore_mem_force_ctrl", &self.hpcore_mem_force_ctrl())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 3 - Set this bit to force software control HP CORE0 & HP CORE1 memory, disbale hardware control."]
    #[inline(always)]
    pub fn hpcore_mem_force_ctrl(
        &mut self,
    ) -> HPCORE_MEM_FORCE_CTRL_W<'_, HPCORE_MEM_LP_CTRL_SPEC> {
        HPCORE_MEM_FORCE_CTRL_W::new(self, 3)
    }
}
