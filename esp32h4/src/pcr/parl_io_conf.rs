...
#[doc = "Field `PARL_RST_EN` reader - Set 1 to reset parl apb reg"]
pub type PARL_RST_EN_R = crate::BitReader;
#[doc = "Field `PARL_RST_EN` writer - Set 1 to reset parl apb reg"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset parl apb reg"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Set 1 to enable parl apb clock"]
    #[inline(always)]
    pub fn parl_clk_en(&mut self) -> PARL_CLK_EN_W<'_, PARL_IO_CONF_SPEC> {
        PARL_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set 1 to reset parl apb reg"]
    #[inline(always)]
    pub fn parl_rst_en(&mut self) -> PARL_RST_EN_W<'_, PARL_IO_CONF_SPEC> {
...
#[doc = "`reset()` method sets PARL_IO_CONF to value 0x04"]
