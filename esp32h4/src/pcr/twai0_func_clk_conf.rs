...
#[doc = "Field `TWAI0_FUNC_CLK_SEL` reader - Configures the clock source of TWAI0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F96M_CLK\\\\"]
pub type TWAI0_FUNC_CLK_SEL_R = crate::FieldReader;
#[doc = "Field `TWAI0_FUNC_CLK_SEL` writer - Configures the clock source of TWAI0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F96M_CLK\\\\"]
pub type TWAI0_FUNC_CLK_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl R {
    #[doc = "Bits 20:21 - Configures the clock source of TWAI0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F96M_CLK\\\\"]
    #[inline(always)]
    pub fn twai0_func_clk_sel(&self) -> TWAI0_FUNC_CLK_SEL_R {
        TWAI0_FUNC_CLK_SEL_R::new(((self.bits >> 20) & 3) as u8)
    }
