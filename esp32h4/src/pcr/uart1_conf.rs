...
#[doc = "Field `UART1_RST_EN` reader - Set 1 to reset uart1 module"]
pub type UART1_RST_EN_R = crate::BitReader;
#[doc = "Field `UART1_RST_EN` writer - Set 1 to reset uart1 module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset uart1 module"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Set 1 to enable uart1 apb clock"]
    #[inline(always)]
    pub fn uart1_clk_en(&mut self) -> UART1_CLK_EN_W<'_, UART1_CONF_SPEC> {
        UART1_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set 1 to reset uart1 module"]
    #[inline(always)]
    pub fn uart1_rst_en(&mut self) -> UART1_RST_EN_W<'_, UART1_CONF_SPEC> {
