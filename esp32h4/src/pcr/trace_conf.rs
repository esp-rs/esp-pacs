...
#[doc = "Field `TRACE_CLK_EN` reader - Set 1 to enable core0 trace clock"]
pub type TRACE_CLK_EN_R = crate::BitReader;
#[doc = "Field `TRACE_CLK_EN` writer - Set 1 to enable core0 trace clock"]
pub type TRACE_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRACE_RST_EN` reader - Set 1 to reset core0 trace module"]
pub type TRACE_RST_EN_R = crate::BitReader;
#[doc = "Field `TRACE_RST_EN` writer - Set 1 to reset core0 trace module"]
pub type TRACE_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRACE1_CLK_EN` reader - Set 1 to enable core1 trace clock"]
pub type TRACE1_CLK_EN_R = crate::BitReader;
#[doc = "Field `TRACE1_CLK_EN` writer - Set 1 to enable core1 trace clock"]
pub type TRACE1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TRACE1_RST_EN` reader - Set 1 to reset core1 trace module"]
pub type TRACE1_RST_EN_R = crate::BitReader;
#[doc = "Field `TRACE1_RST_EN` writer - Set 1 to reset core1 trace module"]
pub type TRACE1_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Set 1 to enable core0 trace clock"]
    #[inline(always)]
    pub fn trace_clk_en(&self) -> TRACE_CLK_EN_R {
        TRACE_CLK_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set 1 to reset core0 trace module"]
    #[inline(always)]
    pub fn trace_rst_en(&self) -> TRACE_RST_EN_R {
        TRACE_RST_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Set 1 to enable core1 trace clock"]
    #[inline(always)]
    pub fn trace1_clk_en(&self) -> TRACE1_CLK_EN_R {
        TRACE1_CLK_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Set 1 to reset core1 trace module"]
    #[inline(always)]
    pub fn trace1_rst_en(&self) -> TRACE1_RST_EN_R {
        TRACE1_RST_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TRACE_CONF")
            ...
            .field("trace1_clk_en", &self.trace1_clk_en())
...
impl W {
    #[doc = "Bit 0 - Set 1 to enable core0 trace clock"]
    #[inline(always)]
    pub fn trace_clk_en(&mut self) -> TRACE_CLK_EN_W<'_, TRACE_CONF_SPEC> {
        TRACE_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set 1 to reset core0 trace module"]
    #[inline(always)]
    pub fn trace_rst_en(&mut self) -> TRACE_RST_EN_W<'_, TRACE_CONF_SPEC> {
        TRACE_RST_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Set 1 to enable core1 trace clock"]
    #[inline(always)]
    pub fn trace1_clk_en(&mut self) -> TRACE1_CLK_EN_W<'_, TRACE_CONF_SPEC> {
        TRACE1_CLK_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Set 1 to reset core1 trace module"]
    #[inline(always)]
    pub fn trace1_rst_en(&mut self) -> TRACE1_RST_EN_W<'_, TRACE_CONF_SPEC> {
        TRACE1_RST_EN_W::new(self, 3)
    }
}
...
#[doc = "`reset()` method sets TRACE_CONF to value 0x0a"]
