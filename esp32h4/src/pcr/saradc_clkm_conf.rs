...
#[doc = "Field `SARADC_CLKM_SEL` reader - Configures the clock source of SAR ADC.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
pub type SARADC_CLKM_SEL_R = crate::BitReader;
#[doc = "Field `SARADC_CLKM_SEL` writer - Configures the clock source of SAR ADC.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
pub type SARADC_CLKM_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 20 - Configures the clock source of SAR ADC.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
    #[inline(always)]
    pub fn saradc_clkm_sel(&self) -> SARADC_CLKM_SEL_R {
        SARADC_CLKM_SEL_R::new(((self.bits >> 20) & 1) != 0)
    }
...
#[doc = "`reset()` method sets SARADC_CLKM_CONF to value 0"]
