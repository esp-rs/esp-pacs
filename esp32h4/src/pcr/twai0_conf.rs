...
#[doc = "Field `TWAI0_RST_EN` reader - Set 1 to reset twai0 module"]
pub type TWAI0_RST_EN_R = crate::BitReader;
#[doc = "Field `TWAI0_RST_EN` writer - Set 1 to reset twai0 module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset twai0 module"]
    #[inline(always)]
...
#[doc = "`reset()` method sets TWAI0_CONF to value 0x04"]
