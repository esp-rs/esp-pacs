...
#[doc = "Field `SHA_RST_EN` reader - Set 1 to reset sha module"]
pub type SHA_RST_EN_R = crate::BitReader;
#[doc = "Field `SHA_RST_EN` writer - Set 1 to reset sha module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset sha module"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SHA_CONF")
            ...
            .field("sha_ready", &self.sha_ready())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - Set 1 to enable sha clock"]
    #[inline(always)]
    pub fn sha_clk_en(&mut self) -> SHA_CLK_EN_W<'_, SHA_CONF_SPEC> {
        SHA_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set 1 to reset sha module"]
    #[inline(always)]
    pub fn sha_rst_en(&mut self) -> SHA_RST_EN_W<'_, SHA_CONF_SPEC> {
...
#[doc = "`reset()` method sets SHA_CONF to value 0x04"]
