...
#[doc = "Field `PVT_MONITOR_FUNC_CLK_SEL` reader - Configures the clock source of PVT MONITER.\\\\ 0: XTAL_CLK\\\\ 1(default): PLL_F160M_CLK\\\\"]
pub type PVT_MONITOR_FUNC_CLK_SEL_R = crate::BitReader;
#[doc = "Field `PVT_MONITOR_FUNC_CLK_SEL` writer - Configures the clock source of PVT MONITER.\\\\ 0: XTAL_CLK\\\\ 1(default): PLL_F160M_CLK\\\\"]
...
impl R {
    ...
    #[doc = "Bit 20 - Configures the clock source of PVT MONITER.\\\\ 0: XTAL_CLK\\\\ 1(default): PLL_F160M_CLK\\\\"]
    #[inline(always)]
...
#[doc = "`reset()` method sets PVT_MONITOR_FUNC_CLK_CONF to value 0x0010_0000"]
