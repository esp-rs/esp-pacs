...
#[doc = "Field `RMT_RST_EN` reader - Set 1 to reset rmt module"]
pub type RMT_RST_EN_R = crate::BitReader;
#[doc = "Field `RMT_RST_EN` writer - Set 1 to reset rmt module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset rmt module"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Set 1 to enable rmt apb clock"]
    #[inline(always)]
    pub fn rmt_clk_en(&mut self) -> RMT_CLK_EN_W<'_, RMT_CONF_SPEC> {
        RMT_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set 1 to reset rmt module"]
    #[inline(always)]
    pub fn rmt_rst_en(&mut self) -> RMT_RST_EN_W<'_, RMT_CONF_SPEC> {
...
#[doc = "`reset()` method sets RMT_CONF to value 0"]
