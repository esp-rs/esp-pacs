...
#[doc = "Field `AES_RST_EN` reader - Set 1 to reset aes module"]
pub type AES_RST_EN_R = crate::BitReader;
#[doc = "Field `AES_RST_EN` writer - Set 1 to reset aes module"]
...
impl R {
    ...
    #[doc = "Bit 1 - Set 1 to reset aes module"]
    #[inline(always)]
...
#[doc = "`reset()` method sets AES_CONF to value 0x04"]
