...
impl RegisterBlock {
    ...
    #[doc = "0x00 - The read and write data register for channel 0 by APB FIFO access."]
    #[inline(always)]
    pub const fn ch0data(&self) -> &CHDATA {
        self.chdata(0)
    }
    #[doc = "0x04 - The read and write data register for channel 1 by APB FIFO access."]
    #[inline(always)]
    pub const fn ch1data(&self) -> &CHDATA {
        self.chdata(1)
    }
    #[doc = "0x08 - The read and write data register for channel 2 by APB FIFO access."]
    #[inline(always)]
    pub const fn ch2data(&self) -> &CHDATA {
        self.chdata(2)
    }
    #[doc = "0x0c - The read and write data register for channel 3 by APB FIFO access."]
    #[inline(always)]
    pub const fn ch3data(&self) -> &CHDATA {
        self.chdata(3)
    }
    #[doc = "0x10..0x18 - Configuration register 0 for channel %s"]
    #[inline(always)]
    ...
    #[doc = "0x10 - Configuration register 0 for channel 0"]
    #[inline(always)]
    ...
    #[doc = "0x18..0x20 - Configuration register 0 for channel %s"]
    #[doc = ""]
    ...
    #[doc = "0x18 - Configuration register 0 for channel 2"]
    #[inline(always)]
    pub const fn ch2_rx_conf0(&self) -> &CH_RX_CONF0 {
        self.ch_rx_conf0(0)
    }
    #[doc = "0x20 - Configuration register 0 for channel 3"]
    #[inline(always)]
    pub const fn ch3_rx_conf0(&self) -> &CH_RX_CONF0 {
        self.ch_rx_conf0(1)
    }
    #[doc = "0x1c..0x24 - Configuration register 1 for channel %s"]
    #[doc = ""]
    ...
    #[doc = "0x1c - Configuration register 1 for channel 2"]
    #[inline(always)]
    pub const fn ch2_rx_conf1(&self) -> &CH_RX_CONF1 {
        self.ch_rx_conf1(0)
    }
    #[doc = "0x24 - Configuration register 1 for channel 3"]
    #[inline(always)]
    ...
    #[doc = "0x28 - Channel 0 status register"]
    #[inline(always)]
    pub const fn ch0_tx_status(&self) -> &CH_TX_STATUS {
        self.ch_tx_status(0)
    }
    #[doc = "0x2c - Channel 1 status register"]
    #[inline(always)]
    ...
    #[doc = "0x30 - Channel 2 status register"]
    #[inline(always)]
    pub const fn ch2_rx_status(&self) -> &CH_RX_STATUS {
        self.ch_rx_status(0)
    }
    #[doc = "0x34 - Channel 3 status register"]
    #[inline(always)]
    ...
    #[doc = "0x48..0x50 - Duty cycle configuration register for channel %s"]
    #[inline(always)]
    ...
    #[doc = "0x48 - Duty cycle configuration register for channel 0"]
    #[inline(always)]
    pub const fn ch0carrier_duty(&self) -> &CHCARRIER_DUTY {
        self.chcarrier_duty(0)
    }
    #[doc = "0x4c - Duty cycle configuration register for channel 1"]
    #[inline(always)]
    pub const fn ch1carrier_duty(&self) -> &CHCARRIER_DUTY {
        self.chcarrier_duty(1)
    }
    #[doc = "0x50..0x58 - Carrier remove register for channel %s"]
    #[doc = ""]
    ...
    #[doc = "0x50 - Carrier remove register for channel 2"]
    #[inline(always)]
    pub const fn ch2_rx_carrier_rm(&self) -> &CH_RX_CARRIER_RM {
        self.ch_rx_carrier_rm(0)
    }
    #[doc = "0x54 - Carrier remove register for channel 3"]
    #[inline(always)]
    pub const fn ch3_rx_carrier_rm(&self) -> &CH_RX_CARRIER_RM {
        self.ch_rx_carrier_rm(1)
    }
    #[doc = "0x58..0x60 - Configuration register for channel %s TX event"]
    #[inline(always)]
    ...
    #[doc = "0x58 - Configuration register for channel 0 TX event"]
    #[inline(always)]
    pub const fn ch0_tx_lim(&self) -> &CH_TX_LIM {
        self.ch_tx_lim(0)
    }
    #[doc = "0x5c - Configuration register for channel 1 TX event"]
    #[inline(always)]
    pub const fn ch1_tx_lim(&self) -> &CH_TX_LIM {
        self.ch_tx_lim(1)
    }
    #[doc = "0x60..0x68 - Configuration register for channel %s RX event"]
    #[doc = ""]
    ...
    #[doc = "0x60 - Configuration register for channel 2 RX event"]
    #[inline(always)]
    pub const fn ch2_rx_lim(&self) -> &CH_RX_LIM {
        self.ch_rx_lim(0)
    }
    #[doc = "0x64 - Configuration register for channel 3 RX event"]
    #[inline(always)]
    pub const fn ch3_rx_lim(&self) -> &CH_RX_LIM {
        self.ch_rx_lim(1)
    }
    #[doc = "0x68 - Configuration register for RMT APB"]
    #[inline(always)]
    ...
    #[doc = "0xcc - Version control register"]
    #[inline(always)]
