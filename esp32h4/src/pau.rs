...
pub struct RegisterBlock {
    ...
    int_clr: INT_CLR,
    int_st: INT_ST,
    regdma_grant_result: REGDMA_GRANT_RESULT,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn regdma_grant_result(&self) -> &REGDMA_GRANT_RESULT {
        &self.regdma_grant_result
    }
...
#[doc = "Read only register for error and done"]
pub mod int_st;
#[doc = "REGDMA_GRANT_RESULT (rw) register accessor: Read only register for error and done\n\nYou can [`read`](crate::Reg::read) this register and get [`regdma_grant_result::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`regdma_grant_result::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@regdma_grant_result`] module"]
pub type REGDMA_GRANT_RESULT = crate::Reg<regdma_grant_result::REGDMA_GRANT_RESULT_SPEC>;
#[doc = "Read only register for error and done"]
pub mod regdma_grant_result;
