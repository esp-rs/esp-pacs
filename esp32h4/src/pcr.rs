...
pub struct RegisterBlock {
    ...
    _reserved101: [u8; 0x0e38],
    clock_gate: CLOCK_GATE,
    date: DATE,
}
impl RegisterBlock {
    #[doc = "0x00..0x18 - Cluster UART%s, containing UART?_CONF, UART?_SCLK_CONF, UART?_MEM_LP_CTRL"]
    #[inline(always)]
    ...
    #[doc = "0x28..0x30 - I2C_SCLK configuration register"]
    #[inline(always)]
