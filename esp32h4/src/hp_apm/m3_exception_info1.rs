...
#[doc = "Field `M3_EXCEPTION_ADDR` reader - Represents exception addr."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("M3_EXCEPTION_INFO1")
            .field("m3_exception_addr", &self.m3_exception_addr())
            .finish()
    }
}
#[doc = "M3 exception_info1 register\n\nYou can [`read`](crate::Reg::read) this register and get [`m3_exception_info1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
