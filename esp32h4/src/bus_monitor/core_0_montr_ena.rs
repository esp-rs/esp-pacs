...
#[doc = "Field `CORE_0_TRACE_LOCKUP_ENA` reader - trace lockup monitor enbale"]
pub type CORE_0_TRACE_LOCKUP_ENA_R = crate::BitReader;
#[doc = "Field `CORE_0_TRACE_LOCKUP_ENA` writer - trace lockup monitor enbale"]
pub type CORE_0_TRACE_LOCKUP_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn core_0_trace_lockup_ena(&self) -> CORE_0_TRACE_LOCKUP_ENA_R {
        CORE_0_TRACE_LOCKUP_ENA_R::new(((self.bits >> 12) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_MONTR_ENA")
            ...
            .field("core_0_trace_lockup_ena", &self.core_0_trace_lockup_ena())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 12 - trace lockup monitor enbale"]
    #[inline(always)]
    pub fn core_0_trace_lockup_ena(
        &mut self,
    ) -> CORE_0_TRACE_LOCKUP_ENA_W<'_, CORE_0_MONTR_ENA_SPEC> {
        CORE_0_TRACE_LOCKUP_ENA_W::new(self, 12)
    }
}
