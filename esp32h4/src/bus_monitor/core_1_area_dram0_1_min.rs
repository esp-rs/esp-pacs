...
#[doc = "Field `CORE_1_AREA_DRAM0_1_MIN` reader - Configures the lower bound address of Data bus region 1."]
pub type CORE_1_AREA_DRAM0_1_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_DRAM0_1_MIN` writer - Configures the lower bound address of Data bus region 1."]
pub type CORE_1_AREA_DRAM0_1_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the lower bound address of Data bus region 1."]
    #[inline(always)]
...
impl W {
    ...
    pub fn core_1_area_dram0_1_min(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_1_MIN_W<'_, CORE_1_AREA_DRAM0_1_MIN_SPEC> {
