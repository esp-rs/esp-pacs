...
pub type CORE_1_DRAM0_RECORDING_BYTEEN_0_R = crate::FieldReader;
impl R {
    ...
    #[doc = "Bits 1:4 - reg_core_1_dram0_recording_byteen_0"]
    #[inline(always)]
    pub fn core_1_dram0_recording_byteen_0(&self) -> CORE_1_DRAM0_RECORDING_BYTEEN_0_R {
        CORE_1_DRAM0_RECORDING_BYTEEN_0_R::new(((self.bits >> 1) & 0x0f) as u8)
    }
}
...
#[doc = "exception monitor status register2\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_dram0_exception_monitor_0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
