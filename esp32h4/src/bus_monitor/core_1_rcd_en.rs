...
#[doc = "Field `CORE_1_RCD_RECORDEN` reader - Configures whether to enable PC logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_1_RCD_PDEBUGPC_REG starts to record PC in real time\\\\"]
pub type CORE_1_RCD_RECORDEN_R = crate::BitReader;
#[doc = "Field `CORE_1_RCD_RECORDEN` writer - Configures whether to enable PC logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_1_RCD_PDEBUGPC_REG starts to record PC in real time\\\\"]
...
impl R {
    #[doc = "Bit 0 - Configures whether to enable PC logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_1_RCD_PDEBUGPC_REG starts to record PC in real time\\\\"]
    #[inline(always)]
