...
pub struct RegisterBlock {
    ...
    appcpu_boot_addr: APPCPU_BOOT_ADDR,
    axi_mst_pri: AXI_MST_PRI,
    _reserved21: [u8; 0x04],
    cpu_peri_pms_conf: CPU_PERI_PMS_CONF,
    cpu_peri_pms_exception_info: CPU_PERI_PMS_EXCEPTION_INFO,
    hp_peri_pms_conf: HP_PERI_PMS_CONF,
    hp_peri_pms_exception_info: HP_PERI_PMS_EXCEPTION_INFO,
    modem_peri_pms_conf: MODEM_PERI_PMS_CONF,
    modem_peri_pms_exception_info: MODEM_PERI_PMS_EXCEPTION_INFO,
    ...
    mem_clk_force_on: MEM_CLK_FORCE_ON,
    _reserved33: [u8; 0x0314],
    id: ID,
    rnd_eco: RND_ECO,
...
impl RegisterBlock {
    ...
    #[doc = "0x84 - reserved"]
    #[inline(always)]
    pub const fn appcpu_boot_addr(&self) -> &APPCPU_BOOT_ADDR {
        &self.appcpu_boot_addr
    }
    #[doc = "0x88 - AXI mst priority configuration register"]
    #[inline(always)]
    pub const fn axi_mst_pri(&self) -> &AXI_MST_PRI {
        &self.axi_mst_pri
    }
    #[doc = "0x90 - CPU Peripherals PMS configuration register"]
    #[inline(always)]
    pub const fn cpu_peri_pms_conf(&self) -> &CPU_PERI_PMS_CONF {
        &self.cpu_peri_pms_conf
    }
    #[doc = "0x94 - CPU Peripherals PMS exception info record register"]
    #[inline(always)]
    pub const fn cpu_peri_pms_exception_info(&self) -> &CPU_PERI_PMS_EXCEPTION_INFO {
        &self.cpu_peri_pms_exception_info
    }
    #[doc = "0x98 - HP Peripherals PMS configuration register"]
    #[inline(always)]
    pub const fn hp_peri_pms_conf(&self) -> &HP_PERI_PMS_CONF {
        &self.hp_peri_pms_conf
    }
    #[doc = "0x9c - HP Peripherals PMS exception info record register"]
    #[inline(always)]
    pub const fn hp_peri_pms_exception_info(&self) -> &HP_PERI_PMS_EXCEPTION_INFO {
        &self.hp_peri_pms_exception_info
    }
    #[doc = "0xa0 - MODEM Peripherals PMS configuration register"]
    #[inline(always)]
    pub const fn modem_peri_pms_conf(&self) -> &MODEM_PERI_PMS_CONF {
        &self.modem_peri_pms_conf
    }
    #[doc = "0xa4 - MODEM Peripherals PMS exception info record register"]
    #[inline(always)]
    pub const fn modem_peri_pms_exception_info(&self) -> &MODEM_PERI_PMS_EXCEPTION_INFO {
        &self.modem_peri_pms_exception_info
    }
    #[doc = "0xa8 - APM interrupt enable register"]
    #[inline(always)]
    ...
    #[doc = "0xc4 - NA"]
    #[inline(always)]
    pub const fn mem_clk_force_on(&self) -> &MEM_CLK_FORCE_ON {
        &self.mem_clk_force_on
    }
    #[doc = "0x3dc - ID register"]
    #[inline(always)]
    ...
    #[doc = "0x3f0 - PCR clock gating configure register"]
    #[inline(always)]
...
#[doc = "SEC_DPA_CONF (r) register accessor: HP anti-DPA security configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`sec_dpa_conf::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sec_dpa_conf`] module"]
...
#[doc = "reserved"]
pub mod sprf_ctrl;
#[doc = "SDPRF_CTRL (r) register accessor: reserved\n\nYou can [`read`](crate::Reg::read) this register and get [`sdprf_ctrl::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sdprf_ctrl`] module"]
...
#[doc = "APPCPU_BOOT_ADDR (rw) register accessor: reserved\n\nYou can [`read`](crate::Reg::read) this register and get [`appcpu_boot_addr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`appcpu_boot_addr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@appcpu_boot_addr`] module"]
pub type APPCPU_BOOT_ADDR = crate::Reg<appcpu_boot_addr::APPCPU_BOOT_ADDR_SPEC>;
#[doc = "reserved"]
pub mod appcpu_boot_addr;
#[doc = "AXI_MST_PRI (rw) register accessor: AXI mst priority configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`axi_mst_pri::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`axi_mst_pri::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@axi_mst_pri`] module"]
pub type AXI_MST_PRI = crate::Reg<axi_mst_pri::AXI_MST_PRI_SPEC>;
#[doc = "AXI mst priority configuration register"]
pub mod axi_mst_pri;
#[doc = "CPU_PERI_PMS_CONF (w) register accessor: CPU Peripherals PMS configuration register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpu_peri_pms_conf::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cpu_peri_pms_conf`] module"]
pub type CPU_PERI_PMS_CONF = crate::Reg<cpu_peri_pms_conf::CPU_PERI_PMS_CONF_SPEC>;
#[doc = "CPU Peripherals PMS configuration register"]
pub mod cpu_peri_pms_conf;
#[doc = "CPU_PERI_PMS_EXCEPTION_INFO (r) register accessor: CPU Peripherals PMS exception info record register\n\nYou can [`read`](crate::Reg::read) this register and get [`cpu_peri_pms_exception_info::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cpu_peri_pms_exception_info`] module"]
pub type CPU_PERI_PMS_EXCEPTION_INFO =
    crate::Reg<cpu_peri_pms_exception_info::CPU_PERI_PMS_EXCEPTION_INFO_SPEC>;
#[doc = "CPU Peripherals PMS exception info record register"]
pub mod cpu_peri_pms_exception_info;
#[doc = "HP_PERI_PMS_CONF (w) register accessor: HP Peripherals PMS configuration register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_peri_pms_conf::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@hp_peri_pms_conf`] module"]
pub type HP_PERI_PMS_CONF = crate::Reg<hp_peri_pms_conf::HP_PERI_PMS_CONF_SPEC>;
#[doc = "HP Peripherals PMS configuration register"]
pub mod hp_peri_pms_conf;
#[doc = "HP_PERI_PMS_EXCEPTION_INFO (r) register accessor: HP Peripherals PMS exception info record register\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_peri_pms_exception_info::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@hp_peri_pms_exception_info`] module"]
pub type HP_PERI_PMS_EXCEPTION_INFO =
    crate::Reg<hp_peri_pms_exception_info::HP_PERI_PMS_EXCEPTION_INFO_SPEC>;
#[doc = "HP Peripherals PMS exception info record register"]
pub mod hp_peri_pms_exception_info;
#[doc = "MODEM_PERI_PMS_CONF (w) register accessor: MODEM Peripherals PMS configuration register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`modem_peri_pms_conf::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@modem_peri_pms_conf`] module"]
pub type MODEM_PERI_PMS_CONF = crate::Reg<modem_peri_pms_conf::MODEM_PERI_PMS_CONF_SPEC>;
#[doc = "MODEM Peripherals PMS configuration register"]
pub mod modem_peri_pms_conf;
#[doc = "MODEM_PERI_PMS_EXCEPTION_INFO (r) register accessor: MODEM Peripherals PMS exception info record register\n\nYou can [`read`](crate::Reg::read) this register and get [`modem_peri_pms_exception_info::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@modem_peri_pms_exception_info`] module"]
pub type MODEM_PERI_PMS_EXCEPTION_INFO =
    crate::Reg<modem_peri_pms_exception_info::MODEM_PERI_PMS_EXCEPTION_INFO_SPEC>;
#[doc = "MODEM Peripherals PMS exception info record register"]
pub mod modem_peri_pms_exception_info;
