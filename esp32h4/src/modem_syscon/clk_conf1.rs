...
#[doc = "Field `CLK_FE_TXLOGAIN_EN` reader - "]
pub type CLK_FE_TXLOGAIN_EN_R = crate::BitReader;
#[doc = "Field `CLK_FE_TXLOGAIN_EN` writer - "]
pub type CLK_FE_TXLOGAIN_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn clk_fe_sdm_en(&self) -> CLK_FE_SDM_EN_R {
        CLK_FE_SDM_EN_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    pub fn clk_fe_txlogain_en(&self) -> CLK_FE_TXLOGAIN_EN_R {
        CLK_FE_TXLOGAIN_EN_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn clk_fe_32m_en(&self) -> CLK_FE_32M_EN_R {
        CLK_FE_32M_EN_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn clk_fe_16m_en(&self) -> CLK_FE_16M_EN_R {
        CLK_FE_16M_EN_R::new(((self.bits >> 25) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLK_CONF1")
            ...
            .field("clk_fe_txlogain_en", &self.clk_fe_txlogain_en())
...
impl W {
    ...
    pub fn clk_fe_sdm_en(&mut self) -> CLK_FE_SDM_EN_W<'_, CLK_CONF1_SPEC> {
        CLK_FE_SDM_EN_W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    pub fn clk_fe_txlogain_en(&mut self) -> CLK_FE_TXLOGAIN_EN_W<'_, CLK_CONF1_SPEC> {
        CLK_FE_TXLOGAIN_EN_W::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn clk_fe_32m_en(&mut self) -> CLK_FE_32M_EN_W<'_, CLK_CONF1_SPEC> {
        CLK_FE_32M_EN_W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn clk_fe_16m_en(&mut self) -> CLK_FE_16M_EN_W<'_, CLK_CONF1_SPEC> {
        CLK_FE_16M_EN_W::new(self, 25)
    }
}
