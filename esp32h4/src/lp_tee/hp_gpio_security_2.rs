...
#[doc = "Field `HP_GPIO_LOCK_P2` reader - This field decides whether hp_gpio_config of PIN32~39 can be locked, or not. 0 (default): unlocked. 1: locked."]
pub type HP_GPIO_LOCK_P2_R = crate::FieldReader;
#[doc = "Field `HP_GPIO_LOCK_P2` writer - This field decides whether hp_gpio_config of PIN32~39 can be locked, or not. 0 (default): unlocked. 1: locked."]
pub type HP_GPIO_LOCK_P2_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - This field decides whether hp_gpio_config of PIN32~39 can be locked, or not. 0 (default): unlocked. 1: locked."]
    #[inline(always)]
    pub fn hp_gpio_lock_p2(&self) -> HP_GPIO_LOCK_P2_R {
        HP_GPIO_LOCK_P2_R::new((self.bits & 0xff) as u8)
    }
}
