...
pub type LP_GPIO_LOCK_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - This field decides whether lp_gpio_config can be locked, or not. 0 (default): unlocked. 1: locked."]
    #[inline(always)]
    pub fn lp_gpio_lock(&self) -> LP_GPIO_LOCK_R {
        LP_GPIO_LOCK_R::new((self.bits & 0x3f) as u8)
    }
}
