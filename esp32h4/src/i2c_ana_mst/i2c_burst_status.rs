...
#[doc = "Field `I2C_MST_BURST_DONE` reader - "]
pub type I2C_MST_BURST_DONE_R = crate::BitReader;
#[doc = "Field `I2C_MST_BURST_DONE` writer - "]
pub type I2C_MST_BURST_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `I2C_MST0_BURST_ERR_FLAG` reader - "]
pub type I2C_MST0_BURST_ERR_FLAG_R = crate::BitReader;
#[doc = "Field `I2C_MST0_BURST_ERR_FLAG` writer - "]
pub type I2C_MST0_BURST_ERR_FLAG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `I2C_MST1_BURST_ERR_FLAG` reader - "]
pub type I2C_MST1_BURST_ERR_FLAG_R = crate::BitReader;
#[doc = "Field `I2C_MST1_BURST_ERR_FLAG` writer - "]
pub type I2C_MST1_BURST_ERR_FLAG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `I2C_MST_BURST_TIMEOUT_CNT` reader - "]
pub type I2C_MST_BURST_TIMEOUT_CNT_R = crate::FieldReader<u16>;
#[doc = "Field `I2C_MST_BURST_TIMEOUT_CNT` writer - "]
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn i2c_mst_burst_done(&mut self) -> I2C_MST_BURST_DONE_W<'_, I2C_BURST_STATUS_SPEC> {
        I2C_MST_BURST_DONE_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn i2c_mst0_burst_err_flag(
        &mut self,
    ) -> I2C_MST0_BURST_ERR_FLAG_W<'_, I2C_BURST_STATUS_SPEC> {
        I2C_MST0_BURST_ERR_FLAG_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn i2c_mst1_burst_err_flag(
        &mut self,
    ) -> I2C_MST1_BURST_ERR_FLAG_W<'_, I2C_BURST_STATUS_SPEC> {
        I2C_MST1_BURST_ERR_FLAG_W::new(self, 2)
    }
    #[doc = "Bits 20:31"]
    #[inline(always)]
