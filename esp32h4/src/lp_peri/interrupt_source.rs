...
#[doc = "Field `LP_INTERRUPT_SOURCE` reader - BIT4~BIT0: pmu_lp_int, modem_lp_int, lp_timer_lp_int, lp_analog_peri_int, lp_io_int"]
pub type LP_INTERRUPT_SOURCE_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:4 - BIT4~BIT0: pmu_lp_int, modem_lp_int, lp_timer_lp_int, lp_analog_peri_int, lp_io_int"]
    #[inline(always)]
    pub fn lp_interrupt_source(&self) -> LP_INTERRUPT_SOURCE_R {
        LP_INTERRUPT_SOURCE_R::new((self.bits & 0x1f) as u8)
    }
}
