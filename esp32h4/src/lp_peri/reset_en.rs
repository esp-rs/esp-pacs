...
#[doc = "Field `LP_RNG_APB_RESET_EN` reader - lp rng apb reset enable 1: enable reset 0: disable reset"]
pub type LP_RNG_APB_RESET_EN_R = crate::BitReader;
#[doc = "Field `LP_RNG_APB_RESET_EN` writer - lp rng apb reset enable 1: enable reset 0: disable reset"]
pub type LP_RNG_APB_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `LP_TOUCH_RESET_EN` reader - lp touch reset enable 1: enable reset 0: disable reset"]
pub type LP_TOUCH_RESET_EN_R = crate::BitReader;
#[doc = "Field `LP_TOUCH_RESET_EN` writer - lp touch reset enable 1: enable reset 0: disable reset"]
...
impl R {
    #[doc = "Bit 24 - lp rng apb reset enable 1: enable reset 0: disable reset"]
    #[inline(always)]
    pub fn lp_rng_apb_reset_en(&self) -> LP_RNG_APB_RESET_EN_R {
        LP_RNG_APB_RESET_EN_R::new(((self.bits >> 24) & 1) != 0)
    }
    ...
    #[doc = "Bit 26 - lp touch reset enable 1: enable reset 0: disable reset"]
    #[inline(always)]
    pub fn lp_touch_reset_en(&self) -> LP_TOUCH_RESET_EN_R {
        LP_TOUCH_RESET_EN_R::new(((self.bits >> 26) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RESET_EN")
            .field("lp_rng_apb_reset_en", &self.lp_rng_apb_reset_en())
...
impl W {
    ...
    #[doc = "Bit 24 - lp rng apb reset enable 1: enable reset 0: disable reset"]
    #[inline(always)]
    pub fn lp_rng_apb_reset_en(&mut self) -> LP_RNG_APB_RESET_EN_W<'_, RESET_EN_SPEC> {
        LP_RNG_APB_RESET_EN_W::new(self, 24)
    }
    #[doc = "Bit 25 - lp optdebug reset enable 1: enable reset 0: disable reset"]
    #[inline(always)]
    ...
    pub fn lp_touch_reset_en(&mut self) -> LP_TOUCH_RESET_EN_W<'_, RESET_EN_SPEC> {
        LP_TOUCH_RESET_EN_W::new(self, 26)
    }
    #[doc = "Bit 27 - lp io reset enable 1: enable reset 0: disable reset"]
    #[inline(always)]
