...
#[doc = "Field `RNG_APB_CK_EN` reader - lp rng apb clk enable 1: enable clock 0: disable clock"]
pub type RNG_APB_CK_EN_R = crate::BitReader;
#[doc = "Field `RNG_APB_CK_EN` writer - lp rng apb clk enable 1: enable clock 0: disable clock"]
pub type RNG_APB_CK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `LP_TOUCH_CK_EN` reader - lp touch clk enable 1: enable clock 0: disable clock"]
pub type LP_TOUCH_CK_EN_R = crate::BitReader;
#[doc = "Field `LP_TOUCH_CK_EN` writer - lp touch clk enable 1: enable clock 0: disable clock"]
...
impl R {
    #[doc = "Bit 23 - lp rng apb clk enable 1: enable clock 0: disable clock"]
    #[inline(always)]
    pub fn rng_apb_ck_en(&self) -> RNG_APB_CK_EN_R {
        RNG_APB_CK_EN_R::new(((self.bits >> 23) & 1) != 0)
    }
    ...
    #[doc = "Bit 26 - lp touch clk enable 1: enable clock 0: disable clock"]
    #[inline(always)]
    pub fn lp_touch_ck_en(&self) -> LP_TOUCH_CK_EN_R {
        LP_TOUCH_CK_EN_R::new(((self.bits >> 26) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLK_EN")
            .field("rng_apb_ck_en", &self.rng_apb_ck_en())
...
impl W {
    #[doc = "Bit 23 - lp rng apb clk enable 1: enable clock 0: disable clock"]
    #[inline(always)]
    pub fn rng_apb_ck_en(&mut self) -> RNG_APB_CK_EN_W<'_, CLK_EN_SPEC> {
        RNG_APB_CK_EN_W::new(self, 23)
    }
    #[doc = "Bit 24 - lp rng clk enable 1: enable clock 0: disable clock"]
    #[inline(always)]
    ...
    #[doc = "Bit 26 - lp touch clk enable 1: enable clock 0: disable clock"]
    #[inline(always)]
    pub fn lp_touch_ck_en(&mut self) -> LP_TOUCH_CK_EN_W<'_, CLK_EN_SPEC> {
        LP_TOUCH_CK_EN_W::new(self, 26)
    }
    #[doc = "Bit 27 - lp io clk enable 1: enable clock 0: disable clock"]
    #[inline(always)]
...
#[doc = "`reset()` method sets CLK_EN to value 0x4f80_0000"]
impl crate::Resettable for CLK_EN_SPEC {
    const RESET_VALUE: u32 = 0x4f80_0000;
}
