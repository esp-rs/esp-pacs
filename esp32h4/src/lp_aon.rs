...
pub struct RegisterBlock {
    ...
    sys_cfg: SYS_CFG,
    cpucore_cfg: CPUCORE_CFG,
    io_mux: IO_MUX,
    ext_wakeup_cntl: EXT_WAKEUP_CNTL,
    ext_wakeup_cntl1: EXT_WAKEUP_CNTL1,
    usb: USB,
    lpbus: LPBUS,
    ...
    mem_ctrl: MEM_CTRL,
    hp_mem_ctrl: HP_MEM_CTRL,
    io_ldo_cfg: IO_LDO_CFG,
    usb_phy_sel: USB_PHY_SEL,
    _reserved34: [u8; 0x0c],
    sram_usage_conf: SRAM_USAGE_CONF,
    _reserved35: [u8; 0x0100],
    puf_conf: PUF_CONF,
    _reserved36: [u8; 0x025c],
    date: DATE,
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn cpucore_cfg(&self) -> &CPUCORE_CFG {
        &self.cpucore_cfg
    }
    ...
    #[doc = "0x44 - configure alwayson external io wakeup"]
    #[inline(always)]
    pub const fn ext_wakeup_cntl1(&self) -> &EXT_WAKEUP_CNTL1 {
        &self.ext_wakeup_cntl1
    }
    #[doc = "0x48 - configure usb reset bypass"]
    #[inline(always)]
    pub const fn usb(&self) -> &USB {
        &self.usb
    }
    #[doc = "0x4c - Select lp memory bus"]
    #[inline(always)]
    pub const fn lpbus(&self) -> &LPBUS {
        &self.lpbus
    }
    #[doc = "0x50 - configure sdio act dnum"]
    #[inline(always)]
    ...
    #[doc = "0x80 - configure rmemory power in lp system register"]
    #[inline(always)]
    pub const fn hp_mem_ctrl(&self) -> &HP_MEM_CTRL {
        &self.hp_mem_ctrl
    }
    #[doc = "0x84 - need_des"]
    #[inline(always)]
    pub const fn io_ldo_cfg(&self) -> &IO_LDO_CFG {
        &self.io_ldo_cfg
    }
    #[doc = "0x88 - need des"]
    #[inline(always)]
    pub const fn usb_phy_sel(&self) -> &USB_PHY_SEL {
        &self.usb_phy_sel
    }
    #[doc = "0x98 - HP memory usage configuration register"]
    #[inline(always)]
    pub const fn sram_usage_conf(&self) -> &SRAM_USAGE_CONF {
        &self.sram_usage_conf
    }
    #[doc = "0x19c - PUF mem control config register"]
    #[inline(always)]
    pub const fn puf_conf(&self) -> &PUF_CONF {
        &self.puf_conf
    }
    #[doc = "0x3fc - reserved"]
    #[inline(always)]
...
pub mod sys_cfg;
#[doc = "CPUCORE_CFG (rw) register accessor: configure core reset register\n\nYou can [`read`](crate::Reg::read) this register and get [`cpucore_cfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cpucore_cfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cpucore_cfg`] module"]
pub type CPUCORE_CFG = crate::Reg<cpucore_cfg::CPUCORE_CFG_SPEC>;
...
#[doc = "EXT_WAKEUP_CNTL1 (rw) register accessor: configure alwayson external io wakeup\n\nYou can [`read`](crate::Reg::read) this register and get [`ext_wakeup_cntl1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ext_wakeup_cntl1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ext_wakeup_cntl1`] module"]
pub type EXT_WAKEUP_CNTL1 = crate::Reg<ext_wakeup_cntl1::EXT_WAKEUP_CNTL1_SPEC>;
#[doc = "configure alwayson external io wakeup"]
pub mod ext_wakeup_cntl1;
...
pub mod mem_ctrl;
#[doc = "HP_MEM_CTRL (rw) register accessor: configure rmemory power in lp system register\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_mem_ctrl::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_mem_ctrl::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@hp_mem_ctrl`] module"]
pub type HP_MEM_CTRL = crate::Reg<hp_mem_ctrl::HP_MEM_CTRL_SPEC>;
#[doc = "configure rmemory power in lp system register"]
pub mod hp_mem_ctrl;
#[doc = "IO_LDO_CFG (rw) register accessor: need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`io_ldo_cfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`io_ldo_cfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@io_ldo_cfg`] module"]
pub type IO_LDO_CFG = crate::Reg<io_ldo_cfg::IO_LDO_CFG_SPEC>;
#[doc = "need_des"]
pub mod io_ldo_cfg;
#[doc = "USB_PHY_SEL (rw) register accessor: need des\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_phy_sel::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb_phy_sel::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@usb_phy_sel`] module"]
pub type USB_PHY_SEL = crate::Reg<usb_phy_sel::USB_PHY_SEL_SPEC>;
#[doc = "need des"]
pub mod usb_phy_sel;
...
#[doc = "PUF_CONF (rw) register accessor: PUF mem control config register\n\nYou can [`read`](crate::Reg::read) this register and get [`puf_conf::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`puf_conf::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@puf_conf`] module"]
pub type PUF_CONF = crate::Reg<puf_conf::PUF_CONF_SPEC>;
