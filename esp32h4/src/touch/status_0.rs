...
#[doc = "Field `PAD0_NN_CNT` reader - need_des"]
pub type PAD0_NN_CNT_R = crate::FieldReader;
impl R {
    ...
    #[inline(always)]
    pub fn pad0_nn_cnt(&self) -> PAD0_NN_CNT_R {
        PAD0_NN_CNT_R::new(((self.bits >> 19) & 0x0f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS_0")
            ...
            .field("pad0_nn_cnt", &self.pad0_nn_cnt())
            .finish()
    }
}
