...
#[doc = "Field `PAD6_NN_CNT` reader - need_des"]
pub type PAD6_NN_CNT_R = crate::FieldReader;
impl R {
    ...
    #[inline(always)]
    pub fn pad6_nn_cnt(&self) -> PAD6_NN_CNT_R {
        PAD6_NN_CNT_R::new(((self.bits >> 19) & 0x0f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS_6")
            ...
            .field("pad6_nn_cnt", &self.pad6_nn_cnt())
            .finish()
    }
}
