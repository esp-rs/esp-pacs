...
pub type R = crate::R<WORK_SPEC>;
#[doc = "Register `WORK` writer"]
pub type W = crate::W<WORK_SPEC>;
...
impl W {
    #[doc = "Bits 16:18 - need_des"]
    #[inline(always)]
    pub fn div_num2(&mut self) -> DIV_NUM2_W<'_, WORK_SPEC> {
        DIV_NUM2_W::new(self, 16)
    }
    #[doc = "Bits 19:21 - need_des"]
    #[inline(always)]
    pub fn div_num1(&mut self) -> DIV_NUM1_W<'_, WORK_SPEC> {
        DIV_NUM1_W::new(self, 19)
    }
    #[doc = "Bits 22:24 - need_des"]
    #[inline(always)]
    pub fn div_num0(&mut self) -> DIV_NUM0_W<'_, WORK_SPEC> {
        DIV_NUM0_W::new(self, 22)
    }
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
    pub fn touch_out_sel(&mut self) -> TOUCH_OUT_SEL_W<'_, WORK_SPEC> {
        TOUCH_OUT_SEL_W::new(self, 25)
    }
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn touch_out_reset(&mut self) -> TOUCH_OUT_RESET_W<'_, WORK_SPEC> {
        TOUCH_OUT_RESET_W::new(self, 26)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn touch_out_gate(&mut self) -> TOUCH_OUT_GATE_W<'_, WORK_SPEC> {
        TOUCH_OUT_GATE_W::new(self, 27)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`work::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`work::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`work::W`](W) writer structure"]
impl crate::Writable for WORK_SPEC {
