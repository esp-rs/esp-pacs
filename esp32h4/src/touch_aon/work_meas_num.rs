#[doc = "Register `WORK_MEAS_NUM` reader"]
pub type R = crate::R<WORK_MEAS_NUM_SPEC>;
#[doc = "Register `WORK_MEAS_NUM` writer"]
pub type W = crate::W<WORK_MEAS_NUM_SPEC>;
...
impl W {
    #[doc = "Bits 0:9 - need_des"]
    #[inline(always)]
    pub fn touch_meas_num2(&mut self) -> TOUCH_MEAS_NUM2_W<'_, WORK_MEAS_NUM_SPEC> {
        TOUCH_MEAS_NUM2_W::new(self, 0)
    }
    #[doc = "Bits 10:19 - need_des"]
    #[inline(always)]
    pub fn touch_meas_num1(&mut self) -> TOUCH_MEAS_NUM1_W<'_, WORK_MEAS_NUM_SPEC> {
        TOUCH_MEAS_NUM1_W::new(self, 10)
    }
    #[doc = "Bits 20:29 - need_des"]
    #[inline(always)]
    pub fn touch_meas_num0(&mut self) -> TOUCH_MEAS_NUM0_W<'_, WORK_MEAS_NUM_SPEC> {
        TOUCH_MEAS_NUM0_W::new(self, 20)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`work_meas_num::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`work_meas_num::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct WORK_MEAS_NUM_SPEC;
impl crate::RegisterSpec for WORK_MEAS_NUM_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`work_meas_num::R`](R) reader structure"]
impl crate::Readable for WORK_MEAS_NUM_SPEC {}
#[doc = "`write(|w| ..)` method takes [`work_meas_num::W`](W) writer structure"]
impl crate::Writable for WORK_MEAS_NUM_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORK_MEAS_NUM to value 0x0641_9064"]
impl crate::Resettable for WORK_MEAS_NUM_SPEC {
