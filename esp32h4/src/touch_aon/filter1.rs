...
pub type R = crate::R<FILTER1_SPEC>;
#[doc = "Register `FILTER1` writer"]
pub type W = crate::W<FILTER1_SPEC>;
#[doc = "Field `TOUCH_NN_DISUPDATE_BENCHMARK_EN` reader - Reserved"]
pub type TOUCH_NN_DISUPDATE_BENCHMARK_EN_R = crate::BitReader;
#[doc = "Field `TOUCH_NN_DISUPDATE_BENCHMARK_EN` writer - Reserved"]
pub type TOUCH_NN_DISUPDATE_BENCHMARK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `TOUCH_NN_THRES` reader - need_des"]
pub type TOUCH_NN_THRES_R = crate::FieldReader;
#[doc = "Field `TOUCH_NN_THRES` writer - need_des"]
pub type TOUCH_NN_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
#[doc = "Field `TOUCH_NN_LIMIT` reader - need_des"]
pub type TOUCH_NN_LIMIT_R = crate::FieldReader;
#[doc = "Field `TOUCH_NN_LIMIT` writer - need_des"]
pub type TOUCH_NN_LIMIT_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
impl R {
    #[doc = "Bit 0 - Reserved"]
    #[inline(always)]
    pub fn touch_nn_disupdate_benchmark_en(&self) -> TOUCH_NN_DISUPDATE_BENCHMARK_EN_R {
        TOUCH_NN_DISUPDATE_BENCHMARK_EN_R::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn touch_nn_thres(&self) -> TOUCH_NN_THRES_R {
        TOUCH_NN_THRES_R::new(((self.bits >> 3) & 3) as u8)
    }
    ...
    #[inline(always)]
    pub fn touch_nn_limit(&self) -> TOUCH_NN_LIMIT_R {
        TOUCH_NN_LIMIT_R::new(((self.bits >> 17) & 0x0f) as u8)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FILTER1")
            .field(
                "touch_nn_disupdate_benchmark_en",
                &self.touch_nn_disupdate_benchmark_en(),
            )
            .field("touch_hysteresis", &self.touch_hysteresis())
            .field("touch_nn_thres", &self.touch_nn_thres())
            ...
            .field("touch_nn_limit", &self.touch_nn_limit())
...
impl W {
    #[doc = "Bit 0 - Reserved"]
    #[inline(always)]
    pub fn touch_nn_disupdate_benchmark_en(
        &mut self,
    ) -> TOUCH_NN_DISUPDATE_BENCHMARK_EN_W<'_, FILTER1_SPEC> {
        TOUCH_NN_DISUPDATE_BENCHMARK_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - need_des"]
    #[inline(always)]
    pub fn touch_hysteresis(&mut self) -> TOUCH_HYSTERESIS_W<'_, FILTER1_SPEC> {
        TOUCH_HYSTERESIS_W::new(self, 1)
    }
    #[doc = "Bits 3:4 - need_des"]
    #[inline(always)]
    pub fn touch_nn_thres(&mut self) -> TOUCH_NN_THRES_W<'_, FILTER1_SPEC> {
        TOUCH_NN_THRES_W::new(self, 3)
    }
    #[doc = "Bits 5:6 - need_des"]
    #[inline(always)]
    pub fn touch_noise_thres(&mut self) -> TOUCH_NOISE_THRES_W<'_, FILTER1_SPEC> {
        TOUCH_NOISE_THRES_W::new(self, 5)
    }
    #[doc = "Bits 7:8 - need_des"]
    #[inline(always)]
    pub fn touch_smooth_lvl(&mut self) -> TOUCH_SMOOTH_LVL_W<'_, FILTER1_SPEC> {
        TOUCH_SMOOTH_LVL_W::new(self, 7)
    }
    #[doc = "Bits 9:12 - need_des"]
    #[inline(always)]
    pub fn touch_jitter_step(&mut self) -> TOUCH_JITTER_STEP_W<'_, FILTER1_SPEC> {
        TOUCH_JITTER_STEP_W::new(self, 9)
    }
    #[doc = "Bits 13:15 - need_des"]
    #[inline(always)]
    pub fn touch_filter_mode(&mut self) -> TOUCH_FILTER_MODE_W<'_, FILTER1_SPEC> {
        TOUCH_FILTER_MODE_W::new(self, 13)
    }
    #[doc = "Bit 16 - need_des"]
    #[inline(always)]
    pub fn touch_filter_en(&mut self) -> TOUCH_FILTER_EN_W<'_, FILTER1_SPEC> {
        TOUCH_FILTER_EN_W::new(self, 16)
    }
    #[doc = "Bits 17:20 - need_des"]
    #[inline(always)]
    pub fn touch_nn_limit(&mut self) -> TOUCH_NN_LIMIT_W<'_, FILTER1_SPEC> {
        TOUCH_NN_LIMIT_W::new(self, 17)
    }
    #[doc = "Bits 21:28 - need_des"]
    #[inline(always)]
    pub fn touch_approach_limit(&mut self) -> TOUCH_APPROACH_LIMIT_W<'_, FILTER1_SPEC> {
        TOUCH_APPROACH_LIMIT_W::new(self, 21)
    }
    #[doc = "Bits 29:31 - need_des"]
    #[inline(always)]
    pub fn touch_debounce_limit(&mut self) -> TOUCH_DEBOUNCE_LIMIT_W<'_, FILTER1_SPEC> {
        TOUCH_DEBOUNCE_LIMIT_W::new(self, 29)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`filter1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`filter1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FILTER1_SPEC;
impl crate::RegisterSpec for FILTER1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`filter1::R`](R) reader structure"]
impl crate::Readable for FILTER1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`filter1::W`](W) writer structure"]
impl crate::Writable for FILTER1_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FILTER1 to value 0x6a0a_0200"]
impl crate::Resettable for FILTER1_SPEC {
