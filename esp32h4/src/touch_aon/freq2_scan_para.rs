#[doc = "Register `FREQ2_SCAN_PARA` reader"]
pub type R = crate::R<FREQ2_SCAN_PARA_SPEC>;
#[doc = "Register `FREQ2_SCAN_PARA` writer"]
pub type W = crate::W<FREQ2_SCAN_PARA_SPEC>;
...
#[doc = "Field `TOUCH_FREQ2_BUF_SEL_EN` reader - need_des"]
pub type TOUCH_FREQ2_BUF_SEL_EN_R = crate::BitReader;
#[doc = "Field `TOUCH_FREQ2_BUF_SEL_EN` writer - need_des"]
pub type TOUCH_FREQ2_BUF_SEL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_buf_sel_en(&self) -> TOUCH_FREQ2_BUF_SEL_EN_R {
        TOUCH_FREQ2_BUF_SEL_EN_R::new(((self.bits >> 23) & 1) != 0)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FREQ2_SCAN_PARA")
            ...
            .field("touch_freq2_buf_sel_en", &self.touch_freq2_buf_sel_en())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:6 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_dcap_lpf(&mut self) -> TOUCH_FREQ2_DCAP_LPF_W<'_, FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_DCAP_LPF_W::new(self, 0)
    }
    #[doc = "Bits 7:8 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_dres_lpf(&mut self) -> TOUCH_FREQ2_DRES_LPF_W<'_, FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_DRES_LPF_W::new(self, 7)
    }
    #[doc = "Bits 9:12 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_drv_ls(&mut self) -> TOUCH_FREQ2_DRV_LS_W<'_, FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_DRV_LS_W::new(self, 9)
    }
    #[doc = "Bits 13:17 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_drv_hs(&mut self) -> TOUCH_FREQ2_DRV_HS_W<'_, FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_DRV_HS_W::new(self, 13)
    }
    #[doc = "Bits 18:22 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_dbias(&mut self) -> TOUCH_FREQ2_DBIAS_W<'_, FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_DBIAS_W::new(self, 18)
    }
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_buf_sel_en(&mut self) -> TOUCH_FREQ2_BUF_SEL_EN_W<'_, FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_BUF_SEL_EN_W::new(self, 23)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`freq2_scan_para::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`freq2_scan_para::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FREQ2_SCAN_PARA_SPEC;
impl crate::RegisterSpec for FREQ2_SCAN_PARA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`freq2_scan_para::R`](R) reader structure"]
impl crate::Readable for FREQ2_SCAN_PARA_SPEC {}
#[doc = "`write(|w| ..)` method takes [`freq2_scan_para::W`](W) writer structure"]
impl crate::Writable for FREQ2_SCAN_PARA_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FREQ2_SCAN_PARA to value 0x0080_0000"]
impl crate::Resettable for FREQ2_SCAN_PARA_SPEC {
