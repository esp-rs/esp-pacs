#[doc = "Register `SCAN_CTRL1` reader"]
pub type R = crate::R<SCAN_CTRL1_SPEC>;
#[doc = "Register `SCAN_CTRL1` writer"]
pub type W = crate::W<SCAN_CTRL1_SPEC>;
...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn touch_shield_pad_en(&mut self) -> TOUCH_SHIELD_PAD_EN_W<'_, SCAN_CTRL1_SPEC> {
    ...
    pub fn touch_inactive_connection(
        &mut self,
    ) -> TOUCH_INACTIVE_CONNECTION_W<'_, SCAN_CTRL1_SPEC> {
        TOUCH_INACTIVE_CONNECTION_W::new(self, 1)
    }
    #[doc = "Bits 2:16 - need_des"]
    #[inline(always)]
    pub fn touch_scan_pad_map(&mut self) -> TOUCH_SCAN_PAD_MAP_W<'_, SCAN_CTRL1_SPEC> {
        TOUCH_SCAN_PAD_MAP_W::new(self, 2)
    }
    #[doc = "Bits 17:31 - need_des"]
    #[inline(always)]
    pub fn touch_xpd_wait(&mut self) -> TOUCH_XPD_WAIT_W<'_, SCAN_CTRL1_SPEC> {
        TOUCH_XPD_WAIT_W::new(self, 17)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`scan_ctrl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scan_ctrl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SCAN_CTRL1_SPEC;
impl crate::RegisterSpec for SCAN_CTRL1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scan_ctrl1::R`](R) reader structure"]
impl crate::Readable for SCAN_CTRL1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`scan_ctrl1::W`](W) writer structure"]
impl crate::Writable for SCAN_CTRL1_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SCAN_CTRL1 to value 0x0008_0000"]
impl crate::Resettable for SCAN_CTRL1_SPEC {
