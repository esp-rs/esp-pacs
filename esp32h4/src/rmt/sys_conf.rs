...
#[doc = "Field `APB_FIFO_MASK` reader - Configures the memory access mode. \\\\ 0: Access memory by FIFO\\\\ 1: Access memory directly\\\\"]
pub type APB_FIFO_MASK_R = crate::BitReader;
#[doc = "Field `APB_FIFO_MASK` writer - Configures the memory access mode. \\\\ 0: Access memory by FIFO\\\\ 1: Access memory directly\\\\"]
pub type APB_FIFO_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MEM_CLK_FORCE_ON` reader - Configures whether to enable the clock for RMT memory. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type MEM_CLK_FORCE_ON_R = crate::BitReader;
#[doc = "Field `MEM_CLK_FORCE_ON` writer - Configures whether to enable the clock for RMT memory. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
...
#[doc = "Field `CLK_EN` reader - Configures whether to enable signal of RMT register clock gate. \\\\ 0: Power down the drive clock of registers\\\\ 1: Power up the drive clock of registers\\\\"]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Configures whether to enable signal of RMT register clock gate. \\\\ 0: Power down the drive clock of registers\\\\ 1: Power up the drive clock of registers\\\\"]
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures the memory access mode. \\\\ 0: Access memory by FIFO\\\\ 1: Access memory directly\\\\"]
    #[inline(always)]
    pub fn apb_fifo_mask(&self) -> APB_FIFO_MASK_R {
        APB_FIFO_MASK_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures whether to enable the clock for RMT memory. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - Configures whether to enable signal of RMT register clock gate. \\\\ 0: Power down the drive clock of registers\\\\ 1: Power up the drive clock of registers\\\\"]
    #[inline(always)]
