...
#[doc = "Field `MEM_RADDR_EX` reader - Represents the memory address offset when transmitter of channel %s is using the RAM."]
...
#[doc = "Field `APB_MEM_WADDR` reader - Represents the memory address offset when writes RAM over APB bus."]
pub type APB_MEM_WADDR_R = crate::FieldReader<u16>;
#[doc = "Field `APB_MEM_RD_ERR` reader - Represents whether the offset address exceeds memory size when reading via APB bus. \\\\ 0: Not exceed\\\\ 1: Exceed\\\\"]
pub type APB_MEM_RD_ERR_R = crate::BitReader;
#[doc = "Field `MEM_EMPTY` reader - Represents whether the TX data size exceeds the memory size and the wrap TX mode is disabled. \\\\ 0: Not exceed\\\\ 1: Exceed\\\\"]
pub type MEM_EMPTY_R = crate::BitReader;
#[doc = "Field `APB_MEM_WR_ERR` reader - Represents whether the offset address exceeds memory size (overflows) when writes via APB bus. \\\\ 0: Not exceed\\\\ 1: Exceed\\\\"]
pub type APB_MEM_WR_ERR_R = crate::BitReader;
#[doc = "Field `APB_MEM_RADDR` reader - Represents the memory address offset when reading RAM over APB bus."]
