...
#[doc = "Field `RX_LIM_CH` reader - This register is used to configure the maximum entries that CHANNEL%s can receive."]
pub type RX_LIM_CH_R = crate::FieldReader<u16>;
#[doc = "Field `RX_LIM_CH` writer - This register is used to configure the maximum entries that CHANNEL%s can receive."]
pub type RX_LIM_CH_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    #[doc = "Bits 0:8 - This register is used to configure the maximum entries that CHANNEL%s can receive."]
    #[inline(always)]
    pub fn rx_lim_ch(&self) -> RX_LIM_CH_R {
        RX_LIM_CH_R::new((self.bits & 0x01ff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH_RX_LIM")
            .field("rx_lim_ch", &self.rx_lim_ch())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:8 - This register is used to configure the maximum entries that CHANNEL%s can receive."]
    #[inline(always)]
    pub fn rx_lim_ch(&mut self) -> RX_LIM_CH_W<'_, CH_RX_LIM_SPEC> {
        RX_LIM_CH_W::new(self, 0)
    }
}
