...
#[doc = "Field `DIV_CNT` reader - Configures the clock divider of channel %s. \\\\ Measurement unit: rmt_sclk\\\\"]
pub type DIV_CNT_R = crate::FieldReader;
#[doc = "Field `DIV_CNT` writer - Configures the clock divider of channel %s. \\\\ Measurement unit: rmt_sclk\\\\"]
pub type DIV_CNT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `IDLE_THRES` reader - Configures RX threshold. \\\\ When no edge is detected on the input signal for continuous clock cycles longer than this field value, the receiver stops receiving data.\\\\ Measurement unit: clk_div\\\\"]
pub type IDLE_THRES_R = crate::FieldReader<u16>;
#[doc = "Field `IDLE_THRES` writer - Configures RX threshold. \\\\ When no edge is detected on the input signal for continuous clock cycles longer than this field value, the receiver stops receiving data.\\\\ Measurement unit: clk_div\\\\"]
...
#[doc = "Field `CARRIER_EN` reader - Configures whether to enable carrier modulation on output signal for channel %s. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type CARRIER_EN_R = crate::BitReader;
#[doc = "Field `CARRIER_EN` writer - Configures whether to enable carrier modulation on output signal for channel %s. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
