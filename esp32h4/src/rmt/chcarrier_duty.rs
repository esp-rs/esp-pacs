...
#[doc = "Field `CARRIER_LOW` reader - Configures carrier wave's low level clock period for channel %s. \\\\ Measurement unit: rmt_sclk\\\\"]
pub type CARRIER_LOW_R = crate::FieldReader<u16>;
#[doc = "Field `CARRIER_LOW` writer - Configures carrier wave's low level clock period for channel %s. \\\\ Measurement unit: rmt_sclk\\\\"]
pub type CARRIER_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `CARRIER_HIGH` reader - Configures carrier wave's high level clock period for channel %s. \\\\ Measurement unit: rmt_sclk\\\\"]
pub type CARRIER_HIGH_R = crate::FieldReader<u16>;
#[doc = "Field `CARRIER_HIGH` writer - Configures carrier wave's high level clock period for channel %s. \\\\ Measurement unit: rmt_sclk\\\\"]
pub type CARRIER_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Configures carrier wave's low level clock period for channel %s. \\\\ Measurement unit: rmt_sclk\\\\"]
    #[inline(always)]
    pub fn carrier_low(&self) -> CARRIER_LOW_R {
        CARRIER_LOW_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Configures carrier wave's high level clock period for channel %s. \\\\ Measurement unit: rmt_sclk\\\\"]
    #[inline(always)]
