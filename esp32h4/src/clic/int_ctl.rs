...
#[doc = "Field `CTL` reader - Configures the level and priority of the interrupt."]
pub type CTL_R = crate::FieldReader;
#[doc = "Field `CTL` writer - Configures the level and priority of the interrupt."]
pub type CTL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 5:7 - Configures the level and priority of the interrupt."]
    #[inline(always)]
