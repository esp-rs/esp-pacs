#[doc = "Register `COMB_PD_SITE1_UNIT1_VT2_CONF1` reader"]
pub type R = crate::R<COMB_PD_SITE1_UNIT1_VT2_CONF1_SPEC>;
#[doc = "Register `COMB_PD_SITE1_UNIT1_VT2_CONF1` writer"]
pub type W = crate::W<COMB_PD_SITE1_UNIT1_VT2_CONF1_SPEC>;
#[doc = "Field `MONITOR_EN_VT2_PD_SITE1_UNIT1` reader - needs field desc"]
pub type MONITOR_EN_VT2_PD_SITE1_UNIT1_R = crate::BitReader;
#[doc = "Field `MONITOR_EN_VT2_PD_SITE1_UNIT1` writer - needs field desc"]
pub type MONITOR_EN_VT2_PD_SITE1_UNIT1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT1` writer - needs field desc"]
pub type TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DELAY_LIMIT_VT2_PD_SITE1_UNIT1` reader - needs field desc"]
pub type DELAY_LIMIT_VT2_PD_SITE1_UNIT1_R = crate::FieldReader;
#[doc = "Field `DELAY_LIMIT_VT2_PD_SITE1_UNIT1` writer - needs field desc"]
pub type DELAY_LIMIT_VT2_PD_SITE1_UNIT1_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `DELAY_NUM_O_VT2_PD_SITE1_UNIT1` reader - needs field desc"]
pub type DELAY_NUM_O_VT2_PD_SITE1_UNIT1_R = crate::FieldReader;
#[doc = "Field `TIMING_ERR_VT2_PD_SITE1_UNIT1` reader - needs field desc"]
...
impl W {
    ...
    pub fn monitor_en_vt2_pd_site1_unit1(
        &mut self,
    ) -> MONITOR_EN_VT2_PD_SITE1_UNIT1_W<'_, COMB_PD_SITE1_UNIT1_VT2_CONF1_SPEC> {
    ...
    pub fn timing_err_cnt_clr_vt2_pd_site1_unit1(
        &mut self,
    ) -> TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT1_W<'_, COMB_PD_SITE1_UNIT1_VT2_CONF1_SPEC> {
    ...
    pub fn delay_limit_vt2_pd_site1_unit1(
        &mut self,
    ) -> DELAY_LIMIT_VT2_PD_SITE1_UNIT1_W<'_, COMB_PD_SITE1_UNIT1_VT2_CONF1_SPEC> {
        DELAY_LIMIT_VT2_PD_SITE1_UNIT1_W::new(self, 2)
    }
}
#[doc = "needs desc\n\nYou can [`read`](crate::Reg::read) this register and get [`comb_pd_site1_unit1_vt2_conf1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comb_pd_site1_unit1_vt2_conf1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct COMB_PD_SITE1_UNIT1_VT2_CONF1_SPEC;
impl crate::RegisterSpec for COMB_PD_SITE1_UNIT1_VT2_CONF1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`comb_pd_site1_unit1_vt2_conf1::R`](R) reader structure"]
impl crate::Readable for COMB_PD_SITE1_UNIT1_VT2_CONF1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`comb_pd_site1_unit1_vt2_conf1::W`](W) writer structure"]
impl crate::Writable for COMB_PD_SITE1_UNIT1_VT2_CONF1_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets COMB_PD_SITE1_UNIT1_VT2_CONF1 to value 0x50"]
