...
#[doc = "Field `CMPR_A_UP_EN(0-2)` reader - Configures whether or not to enable PWM generator%s timer stamp A's shadow register update task receive.\\\\0: Disable\\\\1: Enable"]
pub type CMPR_A_UP_EN_R = crate::BitReader;
#[doc = "Field `CMPR_A_UP_EN(0-2)` writer - Configures whether or not to enable PWM generator%s timer stamp A's shadow register update task receive.\\\\0: Disable\\\\1: Enable"]
pub type CMPR_A_UP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CMPR_B_UP_EN(0-2)` reader - Configures whether or not to enable PWM generator%s timer stamp B's shadow register update task receive.\\\\0: Disable\\\\1: Enable"]
pub type CMPR_B_UP_EN_R = crate::BitReader;
#[doc = "Field `CMPR_B_UP_EN(0-2)` writer - Configures whether or not to enable PWM generator%s timer stamp B's shadow register update task receive.\\\\0: Disable\\\\1: Enable"]
pub type CMPR_B_UP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `GEN_STOP_EN` reader - Configures whether or not to enable all PWM generate stop task receive.\\\\0: Disable\\\\1: Enable"]
pub type GEN_STOP_EN_R = crate::BitReader;
#[doc = "Field `GEN_STOP_EN` writer - Configures whether or not to enable all PWM generate stop task receive.\\\\0: Disable\\\\1: Enable"]
pub type GEN_STOP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIMER_SYNC_EN(0-2)` reader - Configures whether or not to enable timer%s sync task receive.\\\\0: Disable\\\\1: Enable"]
pub type TIMER_SYNC_EN_R = crate::BitReader;
#[doc = "Field `TIMER_SYNC_EN(0-2)` writer - Configures whether or not to enable timer%s sync task receive.\\\\0: Disable\\\\1: Enable"]
pub type TIMER_SYNC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIMER_PERIOD_UP_EN(0-2)` reader - Configures whether or not to enable timer%s period update task receive.\\\\0: Disable\\\\1: Enable"]
pub type TIMER_PERIOD_UP_EN_R = crate::BitReader;
#[doc = "Field `TIMER_PERIOD_UP_EN(0-2)` writer - Configures whether or not to enable timer%s period update task receive.\\\\0: Disable\\\\1: Enable"]
pub type TIMER_PERIOD_UP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TZ_OST_EN(0-2)` reader - Configures whether or not to enable one shot trip%s task receive.\\\\0: Disable\\\\1: Enable"]
pub type TZ_OST_EN_R = crate::BitReader;
#[doc = "Field `TZ_OST_EN(0-2)` writer - Configures whether or not to enable one shot trip%s task receive.\\\\0: Disable\\\\1: Enable"]
pub type TZ_OST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CLR_OST_EN(0-2)` reader - Configures whether or not to enable one shot trip%s clear task receive.\\\\0: Disable\\\\1: Enable"]
pub type CLR_OST_EN_R = crate::BitReader;
#[doc = "Field `CLR_OST_EN(0-2)` writer - Configures whether or not to enable one shot trip%s clear task receive.\\\\0: Disable\\\\1: Enable"]
pub type CLR_OST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CAP_EN(0-2)` reader - Configures whether or not to enable capture%s task receive.\\\\0: Disable\\\\1: Enable"]
pub type CAP_EN_R = crate::BitReader;
#[doc = "Field `CAP_EN(0-2)` writer - Configures whether or not to enable capture%s task receive.\\\\0: Disable\\\\1: Enable"]
pub type CAP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Configures whether or not to enable PWM generator(0-2) timer stamp A's shadow register update task receive.\\\\0: Disable\\\\1: Enable"]
    #[doc = ""]
    ...
    #[doc = "Configures whether or not to enable PWM generator(0-2) timer stamp B's shadow register update task receive.\\\\0: Disable\\\\1: Enable"]
    #[doc = ""]
    ...
    #[doc = "Configures whether or not to enable timer(0-2) sync task receive.\\\\0: Disable\\\\1: Enable"]
    #[doc = ""]
    ...
    #[doc = "Configures whether or not to enable timer(0-2) period update task receive.\\\\0: Disable\\\\1: Enable"]
    #[doc = ""]
    ...
    #[doc = "Configures whether or not to enable one shot trip(0-2) task receive.\\\\0: Disable\\\\1: Enable"]
    #[doc = ""]
    ...
    #[doc = "Configures whether or not to enable one shot trip(0-2) clear task receive.\\\\0: Disable\\\\1: Enable"]
    #[doc = ""]
    ...
    #[doc = "Configures whether or not to enable capture(0-2) task receive.\\\\0: Disable\\\\1: Enable"]
    #[doc = ""]
