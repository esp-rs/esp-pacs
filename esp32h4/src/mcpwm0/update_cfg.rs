...
#[doc = "Field `OP_UP_EN(0-2)` reader - Configures whether or not to enable update of active registers in PWM operator%s. Valid only when PWM_GLOBAL_UP_EN is set to 1.\\\\0: Disable\\\\1: Enable"]
pub type OP_UP_EN_R = crate::BitReader;
#[doc = "Field `OP_UP_EN(0-2)` writer - Configures whether or not to enable update of active registers in PWM operator%s. Valid only when PWM_GLOBAL_UP_EN is set to 1.\\\\0: Disable\\\\1: Enable"]
...
impl R {
    ...
    #[doc = "Configures whether or not to enable update of active registers in PWM operator(0-2). Valid only when PWM_GLOBAL_UP_EN is set to 1.\\\\0: Disable\\\\1: Enable"]
    #[doc = ""]
