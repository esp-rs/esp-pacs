...
#[doc = "Field `TIMER_SYNCISEL(0-2)` reader - Configures the selection of sync input for PWM timer%s.\\\\1: PWM timer0 sync_out\\\\2: PWM timer1 sync_out\\\\3: PWM timer2 sync_out\\\\4: SYNC0 from GPIO matrix\\\\5: SYNC1 from GPIO matrix\\\\6: SYNC2 from GPIO matrix\\\\Other values: No sync input selected"]
pub type TIMER_SYNCISEL_R = crate::FieldReader;
#[doc = "Field `TIMER_SYNCISEL(0-2)` writer - Configures the selection of sync input for PWM timer%s.\\\\1: PWM timer0 sync_out\\\\2: PWM timer1 sync_out\\\\3: PWM timer2 sync_out\\\\4: SYNC0 from GPIO matrix\\\\5: SYNC1 from GPIO matrix\\\\6: SYNC2 from GPIO matrix\\\\Other values: No sync input selected"]
pub type TIMER_SYNCISEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `EXTERNAL_SYNCI_INVERT(0-2)` reader - Configures whether or not to invert SYNC%s from GPIO matrix.\\\\0: Not invert\\\\1: Invert"]
pub type EXTERNAL_SYNCI_INVERT_R = crate::BitReader;
#[doc = "Field `EXTERNAL_SYNCI_INVERT(0-2)` writer - Configures whether or not to invert SYNC%s from GPIO matrix.\\\\0: Not invert\\\\1: Invert"]
pub type EXTERNAL_SYNCI_INVERT_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Configures the selection of sync input for PWM timer(0-2).\\\\1: PWM timer0 sync_out\\\\2: PWM timer1 sync_out\\\\3: PWM timer2 sync_out\\\\4: SYNC0 from GPIO matrix\\\\5: SYNC1 from GPIO matrix\\\\6: SYNC2 from GPIO matrix\\\\Other values: No sync input selected"]
    #[doc = ""]
    ...
    #[doc = "Configures whether or not to invert SYNC(0-2) from GPIO matrix.\\\\0: Not invert\\\\1: Invert"]
    #[doc = ""]
