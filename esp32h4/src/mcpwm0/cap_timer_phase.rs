...
#[doc = "Field `PHASE` reader - Configures phase value for capture timer sync operation."]
pub type PHASE_R = crate::FieldReader<u32>;
#[doc = "Field `PHASE` writer - Configures phase value for capture timer sync operation."]
pub type PHASE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures phase value for capture timer sync operation."]
    #[inline(always)]
    pub fn phase(&self) -> PHASE_R {
        PHASE_R::new(self.bits)
    }
}
...
impl W {
    #[doc = "Bits 0:31 - Configures phase value for capture timer sync operation."]
    #[inline(always)]
    pub fn phase(&mut self) -> PHASE_W<'_, CAP_TIMER_PHASE_SPEC> {
        PHASE_W::new(self, 0)
    }
}
