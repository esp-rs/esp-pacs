...
#[doc = "Field `PROBE_B_MOD_SEL` reader - Tihs field is used to selec probe_group from probe_group0 to probe_group15 for module's probe_out\\[31:0\\] in b mode."]
pub type PROBE_B_MOD_SEL_R = crate::FieldReader<u16>;
#[doc = "Field `PROBE_B_MOD_SEL` writer - Tihs field is used to selec probe_group from probe_group0 to probe_group15 for module's probe_out\\[31:0\\] in b mode."]
pub type PROBE_B_MOD_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `PROBE_B_TOP_SEL` reader - Tihs field is used to select module's probe_out\\[31:0\\] as probe_out in b mode"]
pub type PROBE_B_TOP_SEL_R = crate::FieldReader;
#[doc = "Field `PROBE_B_TOP_SEL` writer - Tihs field is used to select module's probe_out\\[31:0\\] as probe_out in b mode"]
pub type PROBE_B_TOP_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `PROBE_B_EN` reader - Set this bit to enable b mode for debug probe. 1: b mode, 0: a mode."]
pub type PROBE_B_EN_R = crate::BitReader;
#[doc = "Field `PROBE_B_EN` writer - Set this bit to enable b mode for debug probe. 1: b mode, 0: a mode."]
...
impl W {
    #[doc = "Bits 0:15 - Tihs field is used to selec probe_group from probe_group0 to probe_group15 for module's probe_out\\[31:0\\] in b mode."]
    #[inline(always)]
    pub fn probe_b_mod_sel(&mut self) -> PROBE_B_MOD_SEL_W<'_, PROBEB_CTRL_SPEC> {
        PROBE_B_MOD_SEL_W::new(self, 0)
    }
    #[doc = "Bits 16:23 - Tihs field is used to select module's probe_out\\[31:0\\] as probe_out in b mode"]
    #[inline(always)]
    pub fn probe_b_top_sel(&mut self) -> PROBE_B_TOP_SEL_W<'_, PROBEB_CTRL_SPEC> {
        PROBE_B_TOP_SEL_W::new(self, 16)
    }
    #[doc = "Bit 24 - Set this bit to enable b mode for debug probe. 1: b mode, 0: a mode."]
    #[inline(always)]
    pub fn probe_b_en(&mut self) -> PROBE_B_EN_W<'_, PROBEB_CTRL_SPEC> {
