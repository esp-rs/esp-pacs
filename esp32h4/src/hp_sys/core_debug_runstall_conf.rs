...
#[doc = "Field `CORE0_RUNSTALLED` reader - Software can read this field to get the runstall status of hp-core0. 1: stalled, 0: not stalled."]
pub type CORE0_RUNSTALLED_R = crate::BitReader;
#[doc = "Field `CORE1_RUNSTALLED` reader - Software can read this field to get the runstall status of hp-core1. 1: stalled, 0: not stalled."]
pub type CORE1_RUNSTALLED_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 1 - Software can read this field to get the runstall status of hp-core0. 1: stalled, 0: not stalled."]
    #[inline(always)]
    pub fn core0_runstalled(&self) -> CORE0_RUNSTALLED_R {
        CORE0_RUNSTALLED_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Software can read this field to get the runstall status of hp-core1. 1: stalled, 0: not stalled."]
    #[inline(always)]
    pub fn core1_runstalled(&self) -> CORE1_RUNSTALLED_R {
        CORE1_RUNSTALLED_R::new(((self.bits >> 2) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_DEBUG_RUNSTALL_CONF")
            ...
            .field("core0_runstalled", &self.core0_runstalled())
            .field("core1_runstalled", &self.core1_runstalled())
            .finish()
    }
}
impl W {
