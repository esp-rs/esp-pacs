...
#[doc = "Field `HPSYSREG_RST_EN` reader - Set 0 to reset hp_system_reg module"]
pub type HPSYSREG_RST_EN_R = crate::BitReader;
#[doc = "Field `HPSYSREG_RST_EN` writer - Set 0 to reset hp_system_reg module"]
pub type HPSYSREG_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Set 0 to reset hp_system_reg module"]
    #[inline(always)]
    pub fn hpsysreg_rst_en(&self) -> HPSYSREG_RST_EN_R {
        HPSYSREG_RST_EN_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RST_EN")
            .field("hpsysreg_rst_en", &self.hpsysreg_rst_en())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - Set 0 to reset hp_system_reg module"]
    #[inline(always)]
    pub fn hpsysreg_rst_en(&mut self) -> HPSYSREG_RST_EN_W<'_, RST_EN_SPEC> {
        HPSYSREG_RST_EN_W::new(self, 0)
    }
}
