...
#[doc = "Field `PROBE_A_MOD_SEL` reader - Tihs field is used to selec probe_group from probe_group0 to probe_group15 for module's probe_out\\[31:0\\] in a mode"]
pub type PROBE_A_MOD_SEL_R = crate::FieldReader<u16>;
#[doc = "Field `PROBE_A_MOD_SEL` writer - Tihs field is used to selec probe_group from probe_group0 to probe_group15 for module's probe_out\\[31:0\\] in a mode"]
pub type PROBE_A_MOD_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `PROBE_A_TOP_SEL` reader - Tihs field is used to selec module's probe_out\\[31:0\\] as probe out in a mode"]
pub type PROBE_A_TOP_SEL_R = crate::FieldReader;
#[doc = "Field `PROBE_A_TOP_SEL` writer - Tihs field is used to selec module's probe_out\\[31:0\\] as probe out in a mode"]
pub type PROBE_A_TOP_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `PROBE_L_SEL` reader - Tihs field is used to selec probe_out\\[31:16\\]"]
pub type PROBE_L_SEL_R = crate::FieldReader;
#[doc = "Field `PROBE_L_SEL` writer - Tihs field is used to selec probe_out\\[31:16\\]"]
pub type PROBE_L_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `PROBE_H_SEL` reader - Tihs field is used to selec probe_out\\[31:16\\]"]
pub type PROBE_H_SEL_R = crate::FieldReader;
#[doc = "Field `PROBE_H_SEL` writer - Tihs field is used to selec probe_out\\[31:16\\]"]
pub type PROBE_H_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `PROBE_GLOBAL_EN` reader - Set this bit to enable global debug probe in hp system."]
pub type PROBE_GLOBAL_EN_R = crate::BitReader;
#[doc = "Field `PROBE_GLOBAL_EN` writer - Set this bit to enable global debug probe in hp system."]
...
impl W {
    #[doc = "Bits 0:15 - Tihs field is used to selec probe_group from probe_group0 to probe_group15 for module's probe_out\\[31:0\\] in a mode"]
    #[inline(always)]
    pub fn probe_a_mod_sel(&mut self) -> PROBE_A_MOD_SEL_W<'_, PROBEA_CTRL_SPEC> {
        PROBE_A_MOD_SEL_W::new(self, 0)
    }
    #[doc = "Bits 16:23 - Tihs field is used to selec module's probe_out\\[31:0\\] as probe out in a mode"]
    #[inline(always)]
    pub fn probe_a_top_sel(&mut self) -> PROBE_A_TOP_SEL_W<'_, PROBEA_CTRL_SPEC> {
        PROBE_A_TOP_SEL_W::new(self, 16)
    }
    #[doc = "Bits 24:25 - Tihs field is used to selec probe_out\\[31:16\\]"]
    #[inline(always)]
    pub fn probe_l_sel(&mut self) -> PROBE_L_SEL_W<'_, PROBEA_CTRL_SPEC> {
        PROBE_L_SEL_W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Tihs field is used to selec probe_out\\[31:16\\]"]
    #[inline(always)]
    pub fn probe_h_sel(&mut self) -> PROBE_H_SEL_W<'_, PROBEA_CTRL_SPEC> {
        PROBE_H_SEL_W::new(self, 26)
    }
    #[doc = "Bit 28 - Set this bit to enable global debug probe in hp system."]
    #[inline(always)]
    pub fn probe_global_en(&mut self) -> PROBE_GLOBAL_EN_W<'_, PROBEA_CTRL_SPEC> {
