...
#[doc = "Field `SPRAM_MEM_AUX_CTRL` reader - reserved"]
pub type SPRAM_MEM_AUX_CTRL_R = crate::FieldReader<u32>;
#[doc = "Field `SPRAM_MEM_AUX_CTRL` writer - reserved"]
...
#[doc = "`reset()` method sets SPRAM_CTRL to value 0x2850"]
impl crate::Resettable for SPRAM_CTRL_SPEC {
    const RESET_VALUE: u32 = 0x2850;
}
