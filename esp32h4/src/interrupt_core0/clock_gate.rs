...
#[doc = "Field `REG_CLK_EN` reader - Interrupt clock gating configure register"]
pub type REG_CLK_EN_R = crate::BitReader;
#[doc = "Field `REG_CLK_EN` writer - Interrupt clock gating configure register"]
pub type REG_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Interrupt clock gating configure register"]
    #[inline(always)]
