...
#[doc = "Field `RTC_SEL_POWER_XTAL32K` reader - need_des"]
pub type RTC_SEL_POWER_XTAL32K_R = crate::BitReader;
#[doc = "Field `RTC_SEL_POWER_XTAL32K` writer - need_des"]
pub type RTC_SEL_POWER_XTAL32K_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DRES_XTAL32K` reader - Configures DRES"]
pub type DRES_XTAL32K_R = crate::FieldReader;
#[doc = "Field `DRES_XTAL32K` writer - Configures DRES"]
pub type DRES_XTAL32K_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `DGM_XTAL32K` reader - Configures DGM"]
pub type DGM_XTAL32K_R = crate::FieldReader;
#[doc = "Field `DGM_XTAL32K` writer - Configures DGM"]
pub type DGM_XTAL32K_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `DBUF_XTAL32K` reader - Configures DBUF"]
pub type DBUF_XTAL32K_R = crate::BitReader;
#[doc = "Field `DBUF_XTAL32K` writer - Configures DBUF"]
pub type DBUF_XTAL32K_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DAC_XTAL32K` reader - Configures DAC"]
pub type DAC_XTAL32K_R = crate::FieldReader;
#[doc = "Field `DAC_XTAL32K` writer - Configures DAC"]
pub type DAC_XTAL32K_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bit 21 - need_des"]
    #[inline(always)]
    pub fn rtc_sel_power_xtal32k(&self) -> RTC_SEL_POWER_XTAL32K_R {
        RTC_SEL_POWER_XTAL32K_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bits 22:24 - Configures DRES"]
    #[inline(always)]
    pub fn dres_xtal32k(&self) -> DRES_XTAL32K_R {
        DRES_XTAL32K_R::new(((self.bits >> 22) & 7) as u8)
    }
    #[doc = "Bits 25:27 - Configures DGM"]
    #[inline(always)]
    pub fn dgm_xtal32k(&self) -> DGM_XTAL32K_R {
        DGM_XTAL32K_R::new(((self.bits >> 25) & 7) as u8)
    }
    #[doc = "Bit 28 - Configures DBUF"]
    #[inline(always)]
    pub fn dbuf_xtal32k(&self) -> DBUF_XTAL32K_R {
        DBUF_XTAL32K_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bits 29:31 - Configures DAC"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("XTAL32K")
            .field("rtc_sel_power_xtal32k", &self.rtc_sel_power_xtal32k())
...
impl W {
    #[doc = "Bit 21 - need_des"]
    #[inline(always)]
    pub fn rtc_sel_power_xtal32k(&mut self) -> RTC_SEL_POWER_XTAL32K_W<'_, XTAL32K_SPEC> {
        RTC_SEL_POWER_XTAL32K_W::new(self, 21)
    }
    #[doc = "Bits 22:24 - Configures DRES"]
    #[inline(always)]
    pub fn dres_xtal32k(&mut self) -> DRES_XTAL32K_W<'_, XTAL32K_SPEC> {
        DRES_XTAL32K_W::new(self, 22)
    }
    #[doc = "Bits 25:27 - Configures DGM"]
    #[inline(always)]
    pub fn dgm_xtal32k(&mut self) -> DGM_XTAL32K_W<'_, XTAL32K_SPEC> {
        DGM_XTAL32K_W::new(self, 25)
    }
    #[doc = "Bit 28 - Configures DBUF"]
    #[inline(always)]
    pub fn dbuf_xtal32k(&mut self) -> DBUF_XTAL32K_W<'_, XTAL32K_SPEC> {
        DBUF_XTAL32K_W::new(self, 28)
    }
    #[doc = "Bits 29:31 - Configures DAC"]
    #[inline(always)]
    pub fn dac_xtal32k(&mut self) -> DAC_XTAL32K_W<'_, XTAL32K_SPEC> {
