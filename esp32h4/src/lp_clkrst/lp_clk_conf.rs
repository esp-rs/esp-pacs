...
#[doc = "Field `FAST_CLK_SEL` reader - configures the source of LP_FAST_CLK. 0: RC_FAST_CLK 1: XTAL_D2_CLK"]
pub type FAST_CLK_SEL_R = crate::BitReader;
#[doc = "Field `FAST_CLK_SEL` writer - configures the source of LP_FAST_CLK. 0: RC_FAST_CLK 1: XTAL_D2_CLK"]
...
impl R {
    ...
    #[doc = "Bit 2 - configures the source of LP_FAST_CLK. 0: RC_FAST_CLK 1: XTAL_D2_CLK"]
    #[inline(always)]
