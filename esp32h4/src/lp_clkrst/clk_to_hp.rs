...
#[doc = "Field `CLK_PWR_FOSC_EN` reader - Configures the clock gate to modem of the fosc clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type CLK_PWR_FOSC_EN_R = crate::BitReader;
#[doc = "Field `CLK_PWR_FOSC_EN` writer - Configures the clock gate to modem of the fosc clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type CLK_PWR_FOSC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CLK_PWR_XTAL_EN` reader - Configures the clock gate to modem of the xtal clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type CLK_PWR_XTAL_EN_R = crate::BitReader;
#[doc = "Field `CLK_PWR_XTAL_EN` writer - Configures the clock gate to modem of the xtal clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type CLK_PWR_XTAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 25 - Configures the clock gate to modem of the fosc clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
    #[inline(always)]
    pub fn clk_pwr_fosc_en(&self) -> CLK_PWR_FOSC_EN_R {
        CLK_PWR_FOSC_EN_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - Configures the clock gate to modem of the xtal clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
    #[inline(always)]
    pub fn clk_pwr_xtal_en(&self) -> CLK_PWR_XTAL_EN_R {
        CLK_PWR_XTAL_EN_R::new(((self.bits >> 26) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLK_TO_HP")
            .field("clk_pwr_fosc_en", &self.clk_pwr_fosc_en())
            .field("clk_pwr_xtal_en", &self.clk_pwr_xtal_en())
...
impl W {
    #[doc = "Bit 25 - Configures the clock gate to modem of the fosc clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
    #[inline(always)]
    pub fn clk_pwr_fosc_en(&mut self) -> CLK_PWR_FOSC_EN_W<'_, CLK_TO_HP_SPEC> {
        CLK_PWR_FOSC_EN_W::new(self, 25)
    }
    #[doc = "Bit 26 - Configures the clock gate to modem of the xtal clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
    #[inline(always)]
    pub fn clk_pwr_xtal_en(&mut self) -> CLK_PWR_XTAL_EN_W<'_, CLK_TO_HP_SPEC> {
        CLK_PWR_XTAL_EN_W::new(self, 26)
    }
    #[doc = "Bit 28 - Configures the clk gate of XTAL32K_CLK to HP system 0: The clk could not pass to HP system 1: The clk could pass to HP system"]
    #[inline(always)]
...
#[doc = "`reset()` method sets CLK_TO_HP to value 0xf600_0000"]
impl crate::Resettable for CLK_TO_HP_SPEC {
    const RESET_VALUE: u32 = 0xf600_0000;
}
