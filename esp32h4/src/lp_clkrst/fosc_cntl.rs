...
#[doc = "Field `FOSC_DFREQ` reader - Configures the RC_FAST_CLK frequency,the clock frequency will increase with this field"]
pub type FOSC_DFREQ_R = crate::FieldReader<u16>;
#[doc = "Field `FOSC_DFREQ` writer - Configures the RC_FAST_CLK frequency,the clock frequency will increase with this field"]
...
#[doc = "`reset()` method sets FOSC_CNTL to value 0x88c0_0000"]
impl crate::Resettable for FOSC_CNTL_SPEC {
    const RESET_VALUE: u32 = 0x88c0_0000;
}
