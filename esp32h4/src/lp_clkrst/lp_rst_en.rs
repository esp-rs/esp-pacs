...
#[doc = "Field `AON_BLETIMER_RESET_EN` reader - Configures whether or not to reset bletimer part 0: Invalid.No effect 1: Reset"]
pub type AON_BLETIMER_RESET_EN_R = crate::BitReader;
#[doc = "Field `AON_BLETIMER_RESET_EN` writer - Configures whether or not to reset bletimer part 0: Invalid.No effect 1: Reset"]
pub type AON_BLETIMER_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `AON_TOUCH_RESET_EN` reader - Configures whether or not to reset TOUCH part 0: Invalid.No effect 1: Reset"]
pub type AON_TOUCH_RESET_EN_R = crate::BitReader;
#[doc = "Field `AON_TOUCH_RESET_EN` writer - Configures whether or not to reset TOUCH part 0: Invalid.No effect 1: Reset"]
pub type AON_TOUCH_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 25 - Configures whether or not to reset HUK 0: Invalid.No effect 1: Reset"]
    #[inline(always)]
    pub fn huk_reset_en(&self) -> HUK_RESET_EN_R {
        HUK_RESET_EN_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - Configures whether or not to reset bletimer part 0: Invalid.No effect 1: Reset"]
    #[inline(always)]
    pub fn aon_bletimer_reset_en(&self) -> AON_BLETIMER_RESET_EN_R {
        AON_BLETIMER_RESET_EN_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - Configures whether or not to reset TOUCH part 0: Invalid.No effect 1: Reset"]
    #[inline(always)]
    pub fn aon_touch_reset_en(&self) -> AON_TOUCH_RESET_EN_R {
        AON_TOUCH_RESET_EN_R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_RST_EN")
            ...
            .field("aon_bletimer_reset_en", &self.aon_bletimer_reset_en())
            .field("aon_touch_reset_en", &self.aon_touch_reset_en())
...
impl W {
    ...
    pub fn huk_reset_en(&mut self) -> HUK_RESET_EN_W<'_, LP_RST_EN_SPEC> {
        HUK_RESET_EN_W::new(self, 25)
    }
    #[doc = "Bit 26 - Configures whether or not to reset bletimer part 0: Invalid.No effect 1: Reset"]
    #[inline(always)]
    pub fn aon_bletimer_reset_en(&mut self) -> AON_BLETIMER_RESET_EN_W<'_, LP_RST_EN_SPEC> {
        AON_BLETIMER_RESET_EN_W::new(self, 26)
    }
    #[doc = "Bit 27 - Configures whether or not to reset TOUCH part 0: Invalid.No effect 1: Reset"]
    #[inline(always)]
    pub fn aon_touch_reset_en(&mut self) -> AON_TOUCH_RESET_EN_W<'_, LP_RST_EN_SPEC> {
        AON_TOUCH_RESET_EN_W::new(self, 27)
    }
    #[doc = "Bit 28 - Configures whether or not to reset EFUSE_CTRL always-on part 0: Invalid.No effect 1: Reset"]
    #[inline(always)]
