...
impl R {
    #[doc = "Bit 11 - Configures the source clk of HUK 0: 0: RC_FAST_CLK 1: XTAL_D2_CLK"]
    #[inline(always)]
    pub fn huk_clk_sel(&self) -> HUK_CLK_SEL_R {
        HUK_CLK_SEL_R::new(((self.bits >> 11) & 1) != 0)
    }
...
impl W {
    ...
    pub fn huk_clk_sel(&mut self) -> HUK_CLK_SEL_W<'_, LPPERI_SPEC> {
        HUK_CLK_SEL_W::new(self, 11)
    }
    #[doc = "Bits 12:23 - need_des"]
    #[inline(always)]
    pub fn lp_bletimer_div_num(&mut self) -> LP_BLETIMER_DIV_NUM_W<'_, LPPERI_SPEC> {
        LP_BLETIMER_DIV_NUM_W::new(self, 12)
    }
    #[doc = "Bits 24:25 - need_des"]
    #[inline(always)]
    pub fn lp_bletimer_32k_sel(&mut self) -> LP_BLETIMER_32K_SEL_W<'_, LPPERI_SPEC> {
        LP_BLETIMER_32K_SEL_W::new(self, 24)
    }
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn lp_sel_osc_slow(&mut self) -> LP_SEL_OSC_SLOW_W<'_, LPPERI_SPEC> {
        LP_SEL_OSC_SLOW_W::new(self, 26)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn lp_sel_osc_fast(&mut self) -> LP_SEL_OSC_FAST_W<'_, LPPERI_SPEC> {
        LP_SEL_OSC_FAST_W::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn lp_sel_xtal(&mut self) -> LP_SEL_XTAL_W<'_, LPPERI_SPEC> {
        LP_SEL_XTAL_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn lp_sel_xtal32k(&mut self) -> LP_SEL_XTAL32K_W<'_, LPPERI_SPEC> {
...
#[doc = "`reset()` method sets LPPERI to value 0x0800"]
