...
pub type ETM_LINK_SEL_0_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type ETM_LINK_SEL_1_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type ETM_LINK_SEL_2_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type ETM_LINK_SEL_3_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `ETM_RETRY_EN_0` reader - etm_retry"]
pub type ETM_RETRY_EN_0_R = crate::BitReader;
#[doc = "Field `ETM_RETRY_EN_0` writer - etm_retry"]
pub type ETM_RETRY_EN_0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ETM_RETRY_EN_1` reader - etm_retry"]
pub type ETM_RETRY_EN_1_R = crate::BitReader;
#[doc = "Field `ETM_RETRY_EN_1` writer - etm_retry"]
pub type ETM_RETRY_EN_1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ETM_RETRY_EN_2` reader - etm_retry"]
pub type ETM_RETRY_EN_2_R = crate::BitReader;
#[doc = "Field `ETM_RETRY_EN_2` writer - etm_retry"]
pub type ETM_RETRY_EN_2_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ETM_RETRY_EN_3` reader - etm_retry"]
pub type ETM_RETRY_EN_3_R = crate::BitReader;
#[doc = "Field `ETM_RETRY_EN_3` writer - etm_retry"]
pub type ETM_RETRY_EN_3_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 4:8 - etm_link sel"]
    #[inline(always)]
    pub fn etm_link_sel_0(&self) -> ETM_LINK_SEL_0_R {
        ETM_LINK_SEL_0_R::new(((self.bits >> 4) & 0x1f) as u8)
    }
    #[doc = "Bits 9:13 - etm_link sel"]
    #[inline(always)]
    pub fn etm_link_sel_1(&self) -> ETM_LINK_SEL_1_R {
        ETM_LINK_SEL_1_R::new(((self.bits >> 9) & 0x1f) as u8)
    }
    #[doc = "Bits 14:18 - etm_link sel"]
    #[inline(always)]
    pub fn etm_link_sel_2(&self) -> ETM_LINK_SEL_2_R {
        ETM_LINK_SEL_2_R::new(((self.bits >> 14) & 0x1f) as u8)
    }
    #[doc = "Bits 19:23 - etm_link sel"]
    #[inline(always)]
    pub fn etm_link_sel_3(&self) -> ETM_LINK_SEL_3_R {
        ETM_LINK_SEL_3_R::new(((self.bits >> 19) & 0x1f) as u8)
    }
    #[doc = "Bit 24 - etm_retry"]
    #[inline(always)]
    pub fn etm_retry_en_0(&self) -> ETM_RETRY_EN_0_R {
        ETM_RETRY_EN_0_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - etm_retry"]
    #[inline(always)]
    pub fn etm_retry_en_1(&self) -> ETM_RETRY_EN_1_R {
        ETM_RETRY_EN_1_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - etm_retry"]
    #[inline(always)]
    pub fn etm_retry_en_2(&self) -> ETM_RETRY_EN_2_R {
        ETM_RETRY_EN_2_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - etm_retry"]
    #[inline(always)]
    pub fn etm_retry_en_3(&self) -> ETM_RETRY_EN_3_R {
        ETM_RETRY_EN_3_R::new(((self.bits >> 27) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGDMA_ETM_CTRL")
            ...
            .field("etm_retry_en_0", &self.etm_retry_en_0())
            .field("etm_retry_en_1", &self.etm_retry_en_1())
            .field("etm_retry_en_2", &self.etm_retry_en_2())
            .field("etm_retry_en_3", &self.etm_retry_en_3())
            .finish()
    }
}
impl W {
    ...
    pub fn etm_link_sel_1(&mut self) -> ETM_LINK_SEL_1_W<'_, REGDMA_ETM_CTRL_SPEC> {
        ETM_LINK_SEL_1_W::new(self, 9)
    }
    #[doc = "Bits 14:18 - etm_link sel"]
    #[inline(always)]
    pub fn etm_link_sel_2(&mut self) -> ETM_LINK_SEL_2_W<'_, REGDMA_ETM_CTRL_SPEC> {
        ETM_LINK_SEL_2_W::new(self, 14)
    }
    #[doc = "Bits 19:23 - etm_link sel"]
    #[inline(always)]
    pub fn etm_link_sel_3(&mut self) -> ETM_LINK_SEL_3_W<'_, REGDMA_ETM_CTRL_SPEC> {
        ETM_LINK_SEL_3_W::new(self, 19)
    }
    #[doc = "Bit 24 - etm_retry"]
    #[inline(always)]
    pub fn etm_retry_en_0(&mut self) -> ETM_RETRY_EN_0_W<'_, REGDMA_ETM_CTRL_SPEC> {
        ETM_RETRY_EN_0_W::new(self, 24)
    }
    #[doc = "Bit 25 - etm_retry"]
    #[inline(always)]
    pub fn etm_retry_en_1(&mut self) -> ETM_RETRY_EN_1_W<'_, REGDMA_ETM_CTRL_SPEC> {
        ETM_RETRY_EN_1_W::new(self, 25)
    }
    #[doc = "Bit 26 - etm_retry"]
    #[inline(always)]
    pub fn etm_retry_en_2(&mut self) -> ETM_RETRY_EN_2_W<'_, REGDMA_ETM_CTRL_SPEC> {
        ETM_RETRY_EN_2_W::new(self, 26)
    }
    #[doc = "Bit 27 - etm_retry"]
    #[inline(always)]
    pub fn etm_retry_en_3(&mut self) -> ETM_RETRY_EN_3_W<'_, REGDMA_ETM_CTRL_SPEC> {
        ETM_RETRY_EN_3_W::new(self, 27)
    }
}
