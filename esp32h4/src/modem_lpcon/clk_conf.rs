...
#[doc = "Field `CLK_ANA_XTAL_EN` reader - "]
pub type CLK_ANA_XTAL_EN_R = crate::BitReader;
#[doc = "Field `CLK_ANA_XTAL_EN` writer - "]
pub type CLK_ANA_XTAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    ...
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn clk_ana_xtal_en(&self) -> CLK_ANA_XTAL_EN_R {
        CLK_ANA_XTAL_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLK_CONF")
            ...
            .field("clk_ana_xtal_en", &self.clk_ana_xtal_en())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn clk_wifipwr_en(&mut self) -> CLK_WIFIPWR_EN_W<'_, CLK_CONF_SPEC> {
        CLK_WIFIPWR_EN_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn clk_coex_en(&mut self) -> CLK_COEX_EN_W<'_, CLK_CONF_SPEC> {
        CLK_COEX_EN_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn clk_i2c_mst_en(&mut self) -> CLK_I2C_MST_EN_W<'_, CLK_CONF_SPEC> {
        CLK_I2C_MST_EN_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn clk_lp_timer_en(&mut self) -> CLK_LP_TIMER_EN_W<'_, CLK_CONF_SPEC> {
        CLK_LP_TIMER_EN_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn clk_ana_xtal_en(&mut self) -> CLK_ANA_XTAL_EN_W<'_, CLK_CONF_SPEC> {
        CLK_ANA_XTAL_EN_W::new(self, 4)
    }
}
...
#[doc = "`reset()` method sets CLK_CONF to value 0x10"]
