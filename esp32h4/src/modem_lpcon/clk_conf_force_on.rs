...
#[doc = "Field `CLK_AGC_DCMEM_FO` reader - "]
pub type CLK_AGC_DCMEM_FO_R = crate::BitReader;
#[doc = "Field `CLK_AGC_DCMEM_FO` writer - "]
pub type CLK_AGC_DCMEM_FO_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn clk_agc_mem_fo(&self) -> CLK_AGC_MEM_FO_R {
        CLK_AGC_MEM_FO_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn clk_pbus_mem_fo(&self) -> CLK_PBUS_MEM_FO_R {
        CLK_PBUS_MEM_FO_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    ...
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn clk_agc_dcmem_fo(&self) -> CLK_AGC_DCMEM_FO_R {
        CLK_AGC_DCMEM_FO_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn clk_bcmem_fo(&self) -> CLK_BCMEM_FO_R {
        CLK_BCMEM_FO_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn clk_i2c_mst_mem_fo(&self) -> CLK_I2C_MST_MEM_FO_R {
        CLK_I2C_MST_MEM_FO_R::new(((self.bits >> 9) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLK_CONF_FORCE_ON")
            ...
            .field("clk_agc_dcmem_fo", &self.clk_agc_dcmem_fo())
...
impl W {
    ...
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn clk_agc_dcmem_fo(&mut self) -> CLK_AGC_DCMEM_FO_W<'_, CLK_CONF_FORCE_ON_SPEC> {
        CLK_AGC_DCMEM_FO_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn clk_bcmem_fo(&mut self) -> CLK_BCMEM_FO_W<'_, CLK_CONF_FORCE_ON_SPEC> {
        CLK_BCMEM_FO_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn clk_i2c_mst_mem_fo(&mut self) -> CLK_I2C_MST_MEM_FO_W<'_, CLK_CONF_FORCE_ON_SPEC> {
        CLK_I2C_MST_MEM_FO_W::new(self, 9)
    }
}
