...
#[doc = "Field `RST_MODEM_POWER_CTRL` writer - "]
pub type RST_MODEM_POWER_CTRL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn rst_modem_power_ctrl(&mut self) -> RST_MODEM_POWER_CTRL_W<'_, RST_CONF_SPEC> {
        RST_MODEM_POWER_CTRL_W::new(self, 5)
    }
}
