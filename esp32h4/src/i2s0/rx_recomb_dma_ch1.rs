#[doc = "Register `RX_RECOMB_DMA_CH1` reader"]
pub type R = crate::R<RX_RECOMB_DMA_CH1_SPEC>;
#[doc = "Register `RX_RECOMB_DMA_CH1` writer"]
pub type W = crate::W<RX_RECOMB_DMA_CH1_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_RECOMB_DMA_CH1")
...
impl W {
    #[doc = "Bit 0 - Set this bit to enable the adc-dma-channel."]
    #[inline(always)]
    pub fn valid(&mut self) -> VALID_W<'_, RX_RECOMB_DMA_CH1_SPEC> {
        VALID_W::new(self, 0)
    }
    #[doc = "Bits 1:4 - Set this field to set the recombined-dma-channel style. If choose to use i2s extracted ch 1&3 in 4 channels, the style should be: 6'b1010."]
    #[inline(always)]
    pub fn style(&mut self) -> STYLE_W<'_, RX_RECOMB_DMA_CH1_SPEC> {
        STYLE_W::new(self, 1)
    }
    #[doc = "Bits 5:12 - Set this field to set the recombined-dma-channel order. If choose to use the order ch3 -> ch1, the order should be: 8'd7 = {2'd0,2'd0,2'd1,2'd3}."]
    #[inline(always)]
    pub fn order(&mut self) -> ORDER_W<'_, RX_RECOMB_DMA_CH1_SPEC> {
        ORDER_W::new(self, 5)
    }
    #[doc = "Bits 13:28 - Set this field to set the receive eof byte length of the recombined-dma-channel."]
    #[inline(always)]
    pub fn eof_num(&mut self) -> EOF_NUM_W<'_, RX_RECOMB_DMA_CH1_SPEC> {
        EOF_NUM_W::new(self, 13)
    }
}
#[doc = "I2S RX recombined-dma-channel configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_recomb_dma_ch1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_recomb_dma_ch1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RX_RECOMB_DMA_CH1_SPEC;
impl crate::RegisterSpec for RX_RECOMB_DMA_CH1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_recomb_dma_ch1::R`](R) reader structure"]
impl crate::Readable for RX_RECOMB_DMA_CH1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`rx_recomb_dma_ch1::W`](W) writer structure"]
impl crate::Writable for RX_RECOMB_DMA_CH1_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RX_RECOMB_DMA_CH1 to value 0"]
impl crate::Resettable for RX_RECOMB_DMA_CH1_SPEC {}
