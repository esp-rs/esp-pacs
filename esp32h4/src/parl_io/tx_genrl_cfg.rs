...
#[doc = "Field `TX_GATING_EN` reader - Write 1 to enable the clock gating of output tx clock."]
pub type TX_GATING_EN_R = crate::BitReader;
#[doc = "Field `TX_GATING_EN` writer - Write 1 to enable the clock gating of output tx clock."]
pub type TX_GATING_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_VALID_OUTPUT_EN` reader - Write 1 to enable the output of tx data valid signal."]
pub type TX_VALID_OUTPUT_EN_R = crate::BitReader;
#[doc = "Field `TX_VALID_OUTPUT_EN` writer - Write 1 to enable the output of tx data valid signal."]
...
impl R {
    ...
    #[doc = "Bit 30 - Write 1 to enable the clock gating of output tx clock."]
    #[inline(always)]
    pub fn tx_gating_en(&self) -> TX_GATING_EN_R {
        TX_GATING_EN_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Write 1 to enable the output of tx data valid signal."]
    #[inline(always)]
