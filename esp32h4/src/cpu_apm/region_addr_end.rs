...
impl R {
    ...
    #[doc = "Bits 13:24 - Configures end address of region %s."]
    #[inline(always)]
    pub fn region_addr_end(&self) -> REGION_ADDR_END_R {
        REGION_ADDR_END_R::new(((self.bits >> 13) & 0x0fff) as u16)
    }
    #[doc = "Bits 25:31 - High 13 bit, end address of region %s."]
    #[inline(always)]
    pub fn h(&self) -> H_R {
...
#[doc = "`reset()` method sets REGION%s_ADDR_END to value 0x03ff_ffff"]
