...
impl R {
    ...
    #[doc = "Bits 13:24 - Configures start address of region %s."]
    #[inline(always)]
    pub fn region_addr_start(&self) -> REGION_ADDR_START_R {
        REGION_ADDR_START_R::new(((self.bits >> 13) & 0x0fff) as u16)
    }
    #[doc = "Bits 25:31 - High 13 bit, start address of region %s."]
    #[inline(always)]
    pub fn h(&self) -> H_R {
        H_R::new(((self.bits >> 25) & 0x7f) as u8)
    }
}
...
#[doc = "`reset()` method sets REGION%s_ADDR_START to value 0x0200_0000"]
