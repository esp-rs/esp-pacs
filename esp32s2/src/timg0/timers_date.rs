///Register `TIMERS_DATE` reader
pub type R = crate::R<TIMERS_DATE_SPEC>;
///Register `TIMERS_DATE` writer
pub type W = crate::W<TIMERS_DATE_SPEC>;
///Field `TIMERS_DATE` reader - Version control register.
pub type TIMERS_DATE_R = crate::FieldReader<u32>;
///Field `TIMERS_DATE` writer - Version control register.
...
///`read()` method returns [`timers_date::R`](R) reader structure
impl crate::Readable for TIMERS_DATE_SPEC {}
///`write(|w| ..)` method takes [`timers_date::W`](W) writer structure
impl crate::Writable for TIMERS_DATE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMERS_DATE to value 0x0190_7261
