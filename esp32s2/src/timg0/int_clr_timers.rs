...
///Field `T(0-1)` writer - Set this bit to clear the TIMG_T%s_INT interrupt.
pub type T_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `WDT` writer - Set this bit to clear the TIMG_WDT_INT interrupt.
pub type WDT_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `LACT` writer - Set this bit to clear the TIMG_LACT_INT interrupt.
...
impl W {
    ...
    ///Bit 3 - Set this bit to clear the TIMG_LACT_INT interrupt.
    #[inline(always)]
    #[must_use]
