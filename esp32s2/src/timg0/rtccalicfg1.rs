...
///Field `RTC_CALI_CYCLING_DATA_VLD` reader - Periodic calibration valid signal.
pub type RTC_CALI_CYCLING_DATA_VLD_R = crate::BitReader;
///Field `RTC_CALI_VALUE` reader - Calibration value when cycles of clock to be calibrated reach TIMG_RTC_CALI_MAX, in unit of XTAL_CLK clock cycles.
pub type RTC_CALI_VALUE_R = crate::FieldReader<u32>;
impl R {
    ///Bit 0 - Periodic calibration valid signal.
    #[inline(always)]
    pub fn rtc_cali_cycling_data_vld(&self) -> RTC_CALI_CYCLING_DATA_VLD_R {
        RTC_CALI_CYCLING_DATA_VLD_R::new((self.bits & 1) != 0)
    }
    ///Bits 7:31 - Calibration value when cycles of clock to be calibrated reach TIMG_RTC_CALI_MAX, in unit of XTAL_CLK clock cycles.
    #[inline(always)]
