///Register `LACTLOADHI` reader
pub type R = crate::R<LACTLOADHI_SPEC>;
///Register `LACTLOADHI` writer
pub type W = crate::W<LACTLOADHI_SPEC>;
///Field `LOAD_HI` reader - Reserved.
pub type LOAD_HI_R = crate::FieldReader<u32>;
///Field `LOAD_HI` writer - Reserved.
...
///`read()` method returns [`lactloadhi::R`](R) reader structure
impl crate::Readable for LACTLOADHI_SPEC {}
///`write(|w| ..)` method takes [`lactloadhi::W`](W) writer structure
