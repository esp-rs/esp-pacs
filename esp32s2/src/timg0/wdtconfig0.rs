...
///Field `WDT_APPCPU_RESET_EN` reader - Reserved.
pub type WDT_APPCPU_RESET_EN_R = crate::BitReader;
///Field `WDT_APPCPU_RESET_EN` writer - Reserved.
...
///Field `WDT_LEVEL_INT_EN` reader - When set, a level type interrupt will occur at the timeout of a stage configured to generate an interrupt.
pub type WDT_LEVEL_INT_EN_R = crate::BitReader;
///Field `WDT_LEVEL_INT_EN` writer - When set, a level type interrupt will occur at the timeout of a stage configured to generate an interrupt.
pub type WDT_LEVEL_INT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_EDGE_INT_EN` reader - When set, an edge type interrupt will occur at the timeout of a stage configured to generate an interrupt.
pub type WDT_EDGE_INT_EN_R = crate::BitReader;
///Field `WDT_EDGE_INT_EN` writer - When set, an edge type interrupt will occur at the timeout of a stage configured to generate an interrupt.
...
impl R {
    ...
    ///Bit 31 - When set, MWDT is enabled.
    #[inline(always)]
