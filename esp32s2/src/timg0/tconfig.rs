...
pub type LEVEL_INT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TCONFIG_SPEC, bool, O>;
...
pub type EDGE_INT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TCONFIG_SPEC, bool, O>;
