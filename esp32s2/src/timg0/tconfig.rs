...
pub type USE_XTAL_W<'a> = crate::BitWriter<'a, u32, TCONFIG_SPEC, bool, 9>;
...
pub type ALARM_EN_W<'a> = crate::BitWriter<'a, u32, TCONFIG_SPEC, bool, 10>;
...
pub type LEVEL_INT_EN_W<'a> = crate::BitWriter<'a, u32, TCONFIG_SPEC, bool, 11>;
...
pub type EDGE_INT_EN_W<'a> = crate::BitWriter<'a, u32, TCONFIG_SPEC, bool, 12>;
...
pub type DIVIDER_W<'a> = crate::FieldWriter<'a, u32, TCONFIG_SPEC, u16, u16, 16, 13>;
...
pub type AUTORELOAD_W<'a> = crate::BitWriter<'a, u32, TCONFIG_SPEC, bool, 29>;
...
pub type INCREASE_W<'a> = crate::BitWriter<'a, u32, TCONFIG_SPEC, bool, 30>;
...
pub type EN_W<'a> = crate::BitWriter<'a, u32, TCONFIG_SPEC, bool, 31>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 11 - When set, an alarm will generate a level type interrupt."]
    #[inline(always)]
    pub fn level_int_en(&mut self) -> LEVEL_INT_EN_W {
        LEVEL_INT_EN_W::new(self)
    }
    #[doc = "Bit 12 - When set, an alarm will generate an edge type interrupt."]
    #[inline(always)]
    pub fn edge_int_en(&mut self) -> EDGE_INT_EN_W {
