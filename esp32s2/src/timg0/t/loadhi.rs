...
///Field `LOAD_HI` reader - High 32 bits of the value that a reload will load onto timer %s time-base counter.
pub type LOAD_HI_R = crate::FieldReader<u32>;
///Field `LOAD_HI` writer - High 32 bits of the value that a reload will load onto timer %s time-base counter.
pub type LOAD_HI_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - High 32 bits of the value that a reload will load onto timer %s time-base counter.
    #[inline(always)]
