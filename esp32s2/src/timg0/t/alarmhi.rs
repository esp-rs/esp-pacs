...
///Field `ALARM_HI` reader - Timer %s alarm trigger time-base counter value, high 32 bits.
pub type ALARM_HI_R = crate::FieldReader<u32>;
///Field `ALARM_HI` writer - Timer %s alarm trigger time-base counter value, high 32 bits.
pub type ALARM_HI_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Timer %s alarm trigger time-base counter value, high 32 bits.
    #[inline(always)]
