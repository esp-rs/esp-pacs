...
///Field `UPDATE` reader - After writing 0 or 1 to TIMG_T%sUPDATE_REG, the counter value is latched.
pub type UPDATE_R = crate::BitReader;
///Field `UPDATE` writer - After writing 0 or 1 to TIMG_T%sUPDATE_REG, the counter value is latched.
pub type UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 31 - After writing 0 or 1 to TIMG_T%sUPDATE_REG, the counter value is latched.
    #[inline(always)]
