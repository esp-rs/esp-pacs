...
#[doc = "Field `PULSE_CNT` reader - This register stores the current pulse count value for unit %s."]
pub type PULSE_CNT_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:15 - This register stores the current pulse count value for unit %s."]
    #[inline(always)]
    pub fn pulse_cnt(&self) -> PULSE_CNT_R {
        PULSE_CNT_R::new((self.bits & 0xffff) as u16)
    }
}
