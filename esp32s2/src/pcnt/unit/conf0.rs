...
///Field `THR_H_LIM_EN` reader - This is the enable bit for unit %s's thr_h_lim comparator.
pub type THR_H_LIM_EN_R = crate::BitReader;
///Field `THR_H_LIM_EN` writer - This is the enable bit for unit %s's thr_h_lim comparator.
pub type THR_H_LIM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THR_L_LIM_EN` reader - This is the enable bit for unit %s's thr_l_lim comparator.
pub type THR_L_LIM_EN_R = crate::BitReader;
///Field `THR_L_LIM_EN` writer - This is the enable bit for unit %s's thr_l_lim comparator.
