...
///Field `CNT_THR_EVENT_U(0-3)` reader - The interrupt enable bit for the PCNT_CNT_THR_EVENT_U%s_INT interrupt.
pub type CNT_THR_EVENT_U_R = crate::BitReader;
///Field `CNT_THR_EVENT_U(0-3)` writer - The interrupt enable bit for the PCNT_CNT_THR_EVENT_U%s_INT interrupt.
pub type CNT_THR_EVENT_U_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///The interrupt enable bit for the PCNT_CNT_THR_EVENT_U(0-3)_INT interrupt.
    ///
