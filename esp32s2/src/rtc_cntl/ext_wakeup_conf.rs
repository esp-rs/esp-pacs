///Register `EXT_WAKEUP_CONF` reader
pub type R = crate::R<EXT_WAKEUP_CONF_SPEC>;
///Register `EXT_WAKEUP_CONF` writer
pub type W = crate::W<EXT_WAKEUP_CONF_SPEC>;
///Field `GPIO_WAKEUP_FILTER` reader - Set this bit to enable the GPIO wakeup event filter.
pub type GPIO_WAKEUP_FILTER_R = crate::BitReader;
///Field `GPIO_WAKEUP_FILTER` writer - Set this bit to enable the GPIO wakeup event filter.
pub type GPIO_WAKEUP_FILTER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXT_WAKEUP0_LV` reader - 0: external wakeup 0 at low level 1: external wakeup 0 at high level
pub type EXT_WAKEUP0_LV_R = crate::BitReader;
///Field `EXT_WAKEUP0_LV` writer - 0: external wakeup 0 at low level 1: external wakeup 0 at high level
pub type EXT_WAKEUP0_LV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXT_WAKEUP1_LV` reader - 0: external wakeup 1 at low level 1: external wakeup 1 at high level
pub type EXT_WAKEUP1_LV_R = crate::BitReader;
///Field `EXT_WAKEUP1_LV` writer - 0: external wakeup 1 at low level 1: external wakeup 1 at high level
pub type EXT_WAKEUP1_LV_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 29 - Set this bit to enable the GPIO wakeup event filter.
    #[inline(always)]
    pub fn gpio_wakeup_filter(&self) -> GPIO_WAKEUP_FILTER_R {
        GPIO_WAKEUP_FILTER_R::new(((self.bits >> 29) & 1) != 0)
    }
    ///Bit 30 - 0: external wakeup 0 at low level 1: external wakeup 0 at high level
    #[inline(always)]
    pub fn ext_wakeup0_lv(&self) -> EXT_WAKEUP0_LV_R {
        EXT_WAKEUP0_LV_R::new(((self.bits >> 30) & 1) != 0)
    }
    ///Bit 31 - 0: external wakeup 1 at low level 1: external wakeup 1 at high level
    #[inline(always)]
...
///`read()` method returns [`ext_wakeup_conf::R`](R) reader structure
impl crate::Readable for EXT_WAKEUP_CONF_SPEC {}
///`write(|w| ..)` method takes [`ext_wakeup_conf::W`](W) writer structure
