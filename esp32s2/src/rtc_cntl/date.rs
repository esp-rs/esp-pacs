...
///Field `CNTL_DATE` reader -
pub type CNTL_DATE_R = crate::FieldReader<u32>;
///Field `CNTL_DATE` writer -
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cntl_date(&mut self) -> CNTL_DATE_W<DATE_SPEC> {
...
///`reset()` method sets DATE to value 0x0190_6191
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0190_6191;
}
