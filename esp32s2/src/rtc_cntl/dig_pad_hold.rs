///Register `DIG_PAD_HOLD` reader
pub type R = crate::R<DIG_PAD_HOLD_SPEC>;
///Register `DIG_PAD_HOLD` writer
pub type W = crate::W<DIG_PAD_HOLD_SPEC>;
///Field `DIG_PAD_HOLD` reader - Set GPIO 21 to GPIO 45 to hold. (See bitmap to locate any GPIO).
pub type DIG_PAD_HOLD_R = crate::FieldReader<u32>;
///Field `DIG_PAD_HOLD` writer - Set GPIO 21 to GPIO 45 to hold. (See bitmap to locate any GPIO).
pub type DIG_PAD_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Set GPIO 21 to GPIO 45 to hold. (See bitmap to locate any GPIO).
    #[inline(always)]
...
///`read()` method returns [`dig_pad_hold::R`](R) reader structure
impl crate::Readable for DIG_PAD_HOLD_SPEC {}
///`write(|w| ..)` method takes [`dig_pad_hold::W`](W) writer structure
