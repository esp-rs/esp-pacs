...
///Field `CK8M_DIV_SEL_VLD` reader - Synchronizes the reg_ck8m_div_sel. Not that you have to invalidate the bus before switching clock, and validate the new clock.
pub type CK8M_DIV_SEL_VLD_R = crate::BitReader;
///Field `CK8M_DIV_SEL_VLD` writer - Synchronizes the reg_ck8m_div_sel. Not that you have to invalidate the bus before switching clock, and validate the new clock.
pub type CK8M_DIV_SEL_VLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CK8M_DIV` reader - Set the CK8M_D256_OUT divider. 00: divided by 128 01: divided by 256 10: divided by 512 11: divided by 1024.
pub type CK8M_DIV_R = crate::FieldReader;
///Field `CK8M_DIV` writer - Set the CK8M_D256_OUT divider. 00: divided by 128 01: divided by 256 10: divided by 512 11: divided by 1024.
pub type CK8M_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `ENB_CK8M` reader - Set this bit to disable CK8M and CK8M_D256_OUT.
pub type ENB_CK8M_R = crate::BitReader;
///Field `ENB_CK8M` writer - Set this bit to disable CK8M and CK8M_D256_OUT.
pub type ENB_CK8M_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENB_CK8M_DIV` reader - Selects the CK8M_D256_OUT. 1: CK8M 0: CK8M divided by 256.
pub type ENB_CK8M_DIV_R = crate::BitReader;
///Field `ENB_CK8M_DIV` writer - Selects the CK8M_D256_OUT. 1: CK8M 0: CK8M divided by 256.
pub type ENB_CK8M_DIV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DIG_XTAL32K_EN` reader - Set this bit to enable CK_XTAL_32K clock for the digital core.
pub type DIG_XTAL32K_EN_R = crate::BitReader;
///Field `DIG_XTAL32K_EN` writer - Set this bit to enable CK_XTAL_32K clock for the digital core.
pub type DIG_XTAL32K_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DIG_CLK8M_D256_EN` reader - Set this bit to enable CK8M_D256_OUT clock for the digital core.
pub type DIG_CLK8M_D256_EN_R = crate::BitReader;
///Field `DIG_CLK8M_D256_EN` writer - Set this bit to enable CK8M_D256_OUT clock for the digital core.
pub type DIG_CLK8M_D256_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DIG_CLK8M_EN` reader - Set this bit to enable 8 MHz clock for the digital core.
pub type DIG_CLK8M_EN_R = crate::BitReader;
///Field `DIG_CLK8M_EN` writer - Set this bit to enable 8 MHz clock for the digital core.
pub type DIG_CLK8M_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CK8M_DIV_SEL` reader - Stores the 8 MHz divider, which is reg_ck8m_div_sel + 1
pub type CK8M_DIV_SEL_R = crate::FieldReader;
///Field `CK8M_DIV_SEL` writer - Stores the 8 MHz divider, which is reg_ck8m_div_sel + 1
pub type CK8M_DIV_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `XTAL_FORCE_NOGATING` reader - Set this bit to force no gating to crystal during sleep
pub type XTAL_FORCE_NOGATING_R = crate::BitReader;
///Field `XTAL_FORCE_NOGATING` writer - Set this bit to force no gating to crystal during sleep
pub type XTAL_FORCE_NOGATING_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CK8M_FORCE_NOGATING` reader - Set this bit to disable force gating to 8 MHz crystal during sleep.
pub type CK8M_FORCE_NOGATING_R = crate::BitReader;
///Field `CK8M_FORCE_NOGATING` writer - Set this bit to disable force gating to 8 MHz crystal during sleep.
pub type CK8M_FORCE_NOGATING_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CK8M_DFREQ` reader - CK8M_DFREQ
pub type CK8M_DFREQ_R = crate::FieldReader;
///Field `CK8M_DFREQ` writer - CK8M_DFREQ
pub type CK8M_DFREQ_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `CK8M_FORCE_PD` reader - Set this bit to FPD the 8 MHz clock.
pub type CK8M_FORCE_PD_R = crate::BitReader;
///Field `CK8M_FORCE_PD` writer - Set this bit to FPD the 8 MHz clock.
pub type CK8M_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CK8M_FORCE_PU` reader - Set this bit to FPU the 8 MHz clock.
pub type CK8M_FORCE_PU_R = crate::BitReader;
///Field `CK8M_FORCE_PU` writer - Set this bit to FPU the 8 MHz clock.
pub type CK8M_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FAST_CLK_RTC_SEL` reader - Set this bit to select the RTC fast clock. 0: XTAL div 4, 1: CK8M.
pub type FAST_CLK_RTC_SEL_R = crate::BitReader;
///Field `FAST_CLK_RTC_SEL` writer - Set this bit to select the RTC fast clock. 0: XTAL div 4, 1: CK8M.
pub type FAST_CLK_RTC_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ANA_CLK_RTC_SEL` reader - Set this bit to select the RTC slow clock. 0: 90K rtc_clk 1: 32k XTAL 2: 8md256.
pub type ANA_CLK_RTC_SEL_R = crate::FieldReader;
///Field `ANA_CLK_RTC_SEL` writer - Set this bit to select the RTC slow clock. 0: 90K rtc_clk 1: 32k XTAL 2: 8md256.
pub type ANA_CLK_RTC_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bit 3 - Synchronizes the reg_ck8m_div_sel. Not that you have to invalidate the bus before switching clock, and validate the new clock.
    #[inline(always)]
    pub fn ck8m_div_sel_vld(&self) -> CK8M_DIV_SEL_VLD_R {
        CK8M_DIV_SEL_VLD_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bits 4:5 - Set the CK8M_D256_OUT divider. 00: divided by 128 01: divided by 256 10: divided by 512 11: divided by 1024.
    #[inline(always)]
    pub fn ck8m_div(&self) -> CK8M_DIV_R {
        CK8M_DIV_R::new(((self.bits >> 4) & 3) as u8)
    }
    ///Bit 6 - Set this bit to disable CK8M and CK8M_D256_OUT.
    #[inline(always)]
    pub fn enb_ck8m(&self) -> ENB_CK8M_R {
        ENB_CK8M_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Selects the CK8M_D256_OUT. 1: CK8M 0: CK8M divided by 256.
    #[inline(always)]
    pub fn enb_ck8m_div(&self) -> ENB_CK8M_DIV_R {
        ENB_CK8M_DIV_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - Set this bit to enable CK_XTAL_32K clock for the digital core.
    #[inline(always)]
    pub fn dig_xtal32k_en(&self) -> DIG_XTAL32K_EN_R {
        DIG_XTAL32K_EN_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Set this bit to enable CK8M_D256_OUT clock for the digital core.
    #[inline(always)]
    pub fn dig_clk8m_d256_en(&self) -> DIG_CLK8M_D256_EN_R {
        DIG_CLK8M_D256_EN_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - Set this bit to enable 8 MHz clock for the digital core.
    #[inline(always)]
    pub fn dig_clk8m_en(&self) -> DIG_CLK8M_EN_R {
        DIG_CLK8M_EN_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bits 12:14 - Stores the 8 MHz divider, which is reg_ck8m_div_sel + 1
    #[inline(always)]
    pub fn ck8m_div_sel(&self) -> CK8M_DIV_SEL_R {
        CK8M_DIV_SEL_R::new(((self.bits >> 12) & 7) as u8)
    }
    ///Bit 15 - Set this bit to force no gating to crystal during sleep
    #[inline(always)]
    pub fn xtal_force_nogating(&self) -> XTAL_FORCE_NOGATING_R {
        XTAL_FORCE_NOGATING_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bit 16 - Set this bit to disable force gating to 8 MHz crystal during sleep.
    #[inline(always)]
...
///`reset()` method sets CLK_CONF to value 0x0158_3218
