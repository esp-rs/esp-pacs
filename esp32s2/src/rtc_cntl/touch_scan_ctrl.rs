...
pub type TOUCH_DENOISE_RES_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type TOUCH_DENOISE_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TOUCH_INACTIVE_CONNECTION_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TOUCH_SHIELD_PAD_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TOUCH_SCAN_PAD_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 15, O, u16>;
...
pub type TOUCH_BUFDRV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type TOUCH_OUT_RING_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn touch_denoise_res(&mut self) -> TOUCH_DENOISE_RES_W<TOUCH_SCAN_CTRL_SPEC, 0> {
        TOUCH_DENOISE_RES_W::new(self)
    }
    #[doc = "Bit 2 - Touch pad 0 will be used to denoise."]
    #[inline(always)]
    #[must_use]
    pub fn touch_denoise_en(&mut self) -> TOUCH_DENOISE_EN_W<TOUCH_SCAN_CTRL_SPEC, 2> {
    ...
    pub fn touch_inactive_connection(
        &mut self,
    ) -> TOUCH_INACTIVE_CONNECTION_W<TOUCH_SCAN_CTRL_SPEC, 8> {
        TOUCH_INACTIVE_CONNECTION_W::new(self)
    }
    #[doc = "Bit 9 - Touch pad 14 will be used as shield_pad."]
    #[inline(always)]
    #[must_use]
    pub fn touch_shield_pad_en(&mut self) -> TOUCH_SHIELD_PAD_EN_W<TOUCH_SCAN_CTRL_SPEC, 9> {
        TOUCH_SHIELD_PAD_EN_W::new(self)
    }
    #[doc = "Bits 10:24 - Pad enable map for touch scan mode."]
    #[inline(always)]
    #[must_use]
    pub fn touch_scan_pad_map(&mut self) -> TOUCH_SCAN_PAD_MAP_W<TOUCH_SCAN_CTRL_SPEC, 10> {
        TOUCH_SCAN_PAD_MAP_W::new(self)
    }
    #[doc = "Bits 25:27 - Touch 14 buffer driver strength."]
    #[inline(always)]
    #[must_use]
    pub fn touch_bufdrv(&mut self) -> TOUCH_BUFDRV_W<TOUCH_SCAN_CTRL_SPEC, 25> {
        TOUCH_BUFDRV_W::new(self)
    }
    #[doc = "Bits 28:31 - Select out one pad as guard_ring."]
    #[inline(always)]
    #[must_use]
    pub fn touch_out_ring(&mut self) -> TOUCH_OUT_RING_W<TOUCH_SCAN_CTRL_SPEC, 28> {
