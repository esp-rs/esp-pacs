...
///Field `XPD_ROM0` reader - rom0 power down
pub type XPD_ROM0_R = crate::BitReader;
///Field `XPD_DIG_DCDC` reader - External DCDC power down
pub type XPD_DIG_DCDC_R = crate::BitReader;
///Field `PERI_ISO` reader - rtc peripheral iso
pub type PERI_ISO_R = crate::BitReader;
///Field `XPD_RTC_PERI` reader - rtc peripheral power down
pub type XPD_RTC_PERI_R = crate::BitReader;
///Field `WIFI_ISO` reader - wifi iso
pub type WIFI_ISO_R = crate::BitReader;
///Field `XPD_WIFI` reader - wifi wrap power down
pub type XPD_WIFI_R = crate::BitReader;
///Field `DIG_ISO` reader - digital wrap iso
...
///Field `RDY_FOR_WAKEUP` reader - Indicates the RTC is ready to be triggered by any wakeup source.
...
impl R {
    ...
    ///Bit 19 - Indicates the RTC is ready to be triggered by any wakeup source.
    #[inline(always)]
