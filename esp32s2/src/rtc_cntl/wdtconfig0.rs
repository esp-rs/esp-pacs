...
///Field `WDT_CHIP_RESET_WIDTH` reader - chip reset siginal pulse width
pub type WDT_CHIP_RESET_WIDTH_R = crate::FieldReader;
///Field `WDT_CHIP_RESET_WIDTH` writer - chip reset siginal pulse width
pub type WDT_CHIP_RESET_WIDTH_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `WDT_CHIP_RESET_EN` reader - wdt reset whole chip enable
pub type WDT_CHIP_RESET_EN_R = crate::BitReader;
///Field `WDT_CHIP_RESET_EN` writer - wdt reset whole chip enable
pub type WDT_CHIP_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_PAUSE_IN_SLP` reader - Set this bit to pause the watchdog in sleep.
pub type WDT_PAUSE_IN_SLP_R = crate::BitReader;
///Field `WDT_PAUSE_IN_SLP` writer - Set this bit to pause the watchdog in sleep.
pub type WDT_PAUSE_IN_SLP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_APPCPU_RESET_EN` reader - enable WDT reset APP CPU
pub type WDT_APPCPU_RESET_EN_R = crate::BitReader;
///Field `WDT_APPCPU_RESET_EN` writer - enable WDT reset APP CPU
pub type WDT_APPCPU_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_PROCPU_RESET_EN` reader - Set this bit to allow the watchdog to be able to reset CPU.
pub type WDT_PROCPU_RESET_EN_R = crate::BitReader;
///Field `WDT_PROCPU_RESET_EN` writer - Set this bit to allow the watchdog to be able to reset CPU.
pub type WDT_PROCPU_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_FLASHBOOT_MOD_EN` reader - Set this bit to enable watchdog when the chip boots from flash.
pub type WDT_FLASHBOOT_MOD_EN_R = crate::BitReader;
///Field `WDT_FLASHBOOT_MOD_EN` writer - Set this bit to enable watchdog when the chip boots from flash.
pub type WDT_FLASHBOOT_MOD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_SYS_RESET_LENGTH` reader - Sets the length of the system reset counter.
pub type WDT_SYS_RESET_LENGTH_R = crate::FieldReader;
///Field `WDT_SYS_RESET_LENGTH` writer - Sets the length of the system reset counter.
pub type WDT_SYS_RESET_LENGTH_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_CPU_RESET_LENGTH` reader - Sets the length of the CPU reset counter.
pub type WDT_CPU_RESET_LENGTH_R = crate::FieldReader;
///Field `WDT_CPU_RESET_LENGTH` writer - Sets the length of the CPU reset counter.
pub type WDT_CPU_RESET_LENGTH_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG3` reader - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
pub type WDT_STG3_R = crate::FieldReader;
///Field `WDT_STG3` writer - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
pub type WDT_STG3_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG2` reader - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
pub type WDT_STG2_R = crate::FieldReader;
///Field `WDT_STG2` writer - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
pub type WDT_STG2_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG1` reader - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
pub type WDT_STG1_R = crate::FieldReader;
///Field `WDT_STG1` writer - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
pub type WDT_STG1_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG0` reader - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
pub type WDT_STG0_R = crate::FieldReader;
///Field `WDT_STG0` writer - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
pub type WDT_STG0_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_EN` reader - Set this bit to enable the RTC watchdog.
pub type WDT_EN_R = crate::BitReader;
///Field `WDT_EN` writer - Set this bit to enable the RTC watchdog.
...
impl R {
    ...
    ///Bit 9 - Set this bit to pause the watchdog in sleep.
    #[inline(always)]
    ...
    ///Bit 11 - Set this bit to allow the watchdog to be able to reset CPU.
    #[inline(always)]
    pub fn wdt_procpu_reset_en(&self) -> WDT_PROCPU_RESET_EN_R {
        WDT_PROCPU_RESET_EN_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - Set this bit to enable watchdog when the chip boots from flash.
    #[inline(always)]
    pub fn wdt_flashboot_mod_en(&self) -> WDT_FLASHBOOT_MOD_EN_R {
        WDT_FLASHBOOT_MOD_EN_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bits 13:15 - Sets the length of the system reset counter.
    #[inline(always)]
    pub fn wdt_sys_reset_length(&self) -> WDT_SYS_RESET_LENGTH_R {
        WDT_SYS_RESET_LENGTH_R::new(((self.bits >> 13) & 7) as u8)
    }
    ///Bits 16:18 - Sets the length of the CPU reset counter.
    #[inline(always)]
    pub fn wdt_cpu_reset_length(&self) -> WDT_CPU_RESET_LENGTH_R {
        WDT_CPU_RESET_LENGTH_R::new(((self.bits >> 16) & 7) as u8)
    }
    ///Bits 19:21 - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
    #[inline(always)]
    pub fn wdt_stg3(&self) -> WDT_STG3_R {
        WDT_STG3_R::new(((self.bits >> 19) & 7) as u8)
    }
    ///Bits 22:24 - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
    #[inline(always)]
    pub fn wdt_stg2(&self) -> WDT_STG2_R {
        WDT_STG2_R::new(((self.bits >> 22) & 7) as u8)
    }
    ///Bits 25:27 - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
    #[inline(always)]
    pub fn wdt_stg1(&self) -> WDT_STG1_R {
        WDT_STG1_R::new(((self.bits >> 25) & 7) as u8)
    }
    ///Bits 28:30 - 1: enable at the interrupt stage 2: enable at the CPU stage 3: enable at the system stage 4: enable at the system and RTC stage.
    #[inline(always)]
    pub fn wdt_stg0(&self) -> WDT_STG0_R {
        WDT_STG0_R::new(((self.bits >> 28) & 7) as u8)
    }
    ///Bit 31 - Set this bit to enable the RTC watchdog.
    #[inline(always)]
