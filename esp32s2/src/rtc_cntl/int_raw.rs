...
#[doc = "Field `SLP_WAKEUP` reader - Stores the raw interrupt triggered when the chip wakes up from sleep."]
pub type SLP_WAKEUP_R = crate::BitReader;
#[doc = "Field `SLP_REJECT` reader - Stores the raw interrupt triggered when the chip rejects to go to sleep."]
pub type SLP_REJECT_R = crate::BitReader;
#[doc = "Field `SDIO_IDLE` reader - Stores the raw interrupt triggered when the SDIO idles."]
pub type SDIO_IDLE_R = crate::BitReader;
#[doc = "Field `WDT` reader - Stores the raw RTC watchdog interrupt."]
pub type WDT_R = crate::BitReader;
#[doc = "Field `TOUCH_SCAN_DONE` reader - Stores the raw interrupt triggered upon the completion of a touch scanning."]
pub type TOUCH_SCAN_DONE_R = crate::BitReader;
#[doc = "Field `ULP_CP` reader - Stores the raw ULP co-processor interrupt."]
pub type ULP_CP_R = crate::BitReader;
#[doc = "Field `TOUCH_DONE` reader - Stores the raw interrupt triggered upon the completion of a single touch."]
pub type TOUCH_DONE_R = crate::BitReader;
#[doc = "Field `TOUCH_ACTIVE` reader - Stores the raw interrupt triggered when a touch is detected."]
pub type TOUCH_ACTIVE_R = crate::BitReader;
#[doc = "Field `TOUCH_INACTIVE` reader - Stores the raw interrupt triggered when a touch is released."]
pub type TOUCH_INACTIVE_R = crate::BitReader;
#[doc = "Field `BROWN_OUT` reader - Stores the raw brown out interrupt."]
pub type BROWN_OUT_R = crate::BitReader;
#[doc = "Field `MAIN_TIMER` reader - Stores the raw RTC main timer interrupt."]
pub type MAIN_TIMER_R = crate::BitReader;
#[doc = "Field `SARADC1` reader - Stores the raw SAR ADC 1 interrupt."]
pub type SARADC1_R = crate::BitReader;
#[doc = "Field `TSENS` reader - Stores the raw touch sensor interrupt."]
pub type TSENS_R = crate::BitReader;
#[doc = "Field `COCPU` reader - Stores the raw ULP-RISCV interrupt."]
pub type COCPU_R = crate::BitReader;
#[doc = "Field `SARADC2` reader - Stores the raw SAR ADC 2 interrupt."]
pub type SARADC2_R = crate::BitReader;
#[doc = "Field `SWD` reader - Stores the raw super watchdog interrupt."]
pub type SWD_R = crate::BitReader;
#[doc = "Field `XTAL32K_DEAD` reader - Stores the raw interrupt triggered when the 32 kHz crystal is dead."]
pub type XTAL32K_DEAD_R = crate::BitReader;
#[doc = "Field `COCPU_TRAP` reader - Stores the raw interrupt triggered when the ULP-RISCV is trapped."]
pub type COCPU_TRAP_R = crate::BitReader;
#[doc = "Field `TOUCH_TIMEOUT` reader - Stores the raw interrupt triggered when touch sensor times out."]
pub type TOUCH_TIMEOUT_R = crate::BitReader;
#[doc = "Field `GLITCH_DET` reader - Stores the raw interrupt triggered when a glitch is detected."]
