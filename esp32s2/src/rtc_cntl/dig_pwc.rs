...
pub type DG_DCDC_FORCE_PD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DG_DCDC_FORCE_PU_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DG_DCDC_PD_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dg_dcdc_force_pd(&mut self) -> DG_DCDC_FORCE_PD_W<DIG_PWC_SPEC, 21> {
        DG_DCDC_FORCE_PD_W::new(self)
    }
    #[doc = "Bit 22 - Set this bit to FPU the DC-DC convertor in the digital system."]
    #[inline(always)]
    #[must_use]
    pub fn dg_dcdc_force_pu(&mut self) -> DG_DCDC_FORCE_PU_W<DIG_PWC_SPEC, 22> {
        DG_DCDC_FORCE_PU_W::new(self)
    }
    #[doc = "Bit 23 - Set this bit to enable PD for the DC-DC convertor in the digital system."]
    #[inline(always)]
    #[must_use]
    pub fn dg_dcdc_pd_en(&mut self) -> DG_DCDC_PD_EN_W<DIG_PWC_SPEC, 23> {
