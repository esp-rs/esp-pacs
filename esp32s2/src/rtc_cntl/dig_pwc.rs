...
impl R {
    ///Bit 3 - Set this bit to FPD the memories in the digital system in sleep.
    #[inline(always)]
    pub fn lslp_mem_force_pd(&self) -> LSLP_MEM_FORCE_PD_R {
        LSLP_MEM_FORCE_PD_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Set this bit to FPU the memories in the digital system.
    #[inline(always)]
    ...
    ///Bit 30 - Set this bit to enable PD for the Wi-Fi circuit in sleep.
    #[inline(always)]
    pub fn wifi_pd_en(&self) -> WIFI_PD_EN_R {
        WIFI_PD_EN_R::new(((self.bits >> 30) & 1) != 0)
    }
    ///Bit 31 - Set this bit to enable PD for the digital system in sleep.
    #[inline(always)]
...
///`reset()` method sets DIG_PWC to value 0x0055_5550
