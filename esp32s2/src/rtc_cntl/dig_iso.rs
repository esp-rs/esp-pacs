...
///Field `FORCE_OFF` reader -
pub type FORCE_OFF_R = crate::BitReader;
///Field `FORCE_OFF` writer -
pub type FORCE_OFF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FORCE_ON` reader -
pub type FORCE_ON_R = crate::BitReader;
///Field `FORCE_ON` writer -
pub type FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_PAD_AUTOHOLD` reader - Indicates the auto-hold status of the digital GPIOs.
pub type DG_PAD_AUTOHOLD_R = crate::BitReader;
///Field `CLR_DG_PAD_AUTOHOLD` writer - Se this bit to clear the auto-hold enabler for the digital GPIOs.
pub type CLR_DG_PAD_AUTOHOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_PAD_AUTOHOLD_EN` reader - Se this bit to allow the digital GPIOs to enter the autohold status.
pub type DG_PAD_AUTOHOLD_EN_R = crate::BitReader;
///Field `DG_PAD_AUTOHOLD_EN` writer - Se this bit to allow the digital GPIOs to enter the autohold status.
pub type DG_PAD_AUTOHOLD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_PAD_FORCE_NOISO` reader - Set this bit to disable the force isolation to the digital GPIOs.
...
///Field `DG_PAD_FORCE_ISO` reader - Set this bit to force isolate the digital GPIOs.
pub type DG_PAD_FORCE_ISO_R = crate::BitReader;
///Field `DG_PAD_FORCE_ISO` writer - Set this bit to force isolate the digital GPIOs.
pub type DG_PAD_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_PAD_FORCE_UNHOLD` reader - Set this bit the force unhold the digital GPIOs.
pub type DG_PAD_FORCE_UNHOLD_R = crate::BitReader;
///Field `DG_PAD_FORCE_UNHOLD` writer - Set this bit the force unhold the digital GPIOs.
pub type DG_PAD_FORCE_UNHOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_PAD_FORCE_HOLD` reader - Set this bit the force hold the digital GPIOs.
pub type DG_PAD_FORCE_HOLD_R = crate::BitReader;
///Field `DG_PAD_FORCE_HOLD` writer - Set this bit the force hold the digital GPIOs.
pub type DG_PAD_FORCE_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ROM0_FORCE_ISO` reader - ROM force ISO
pub type ROM0_FORCE_ISO_R = crate::BitReader;
///Field `ROM0_FORCE_ISO` writer - ROM force ISO
pub type ROM0_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ROM0_FORCE_NOISO` reader - ROM force no ISO
pub type ROM0_FORCE_NOISO_R = crate::BitReader;
///Field `ROM0_FORCE_NOISO` writer - ROM force no ISO
pub type ROM0_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM0_FORCE_ISO` reader - internal SRAM 0 force ISO
pub type INTER_RAM0_FORCE_ISO_R = crate::BitReader;
///Field `INTER_RAM0_FORCE_ISO` writer - internal SRAM 0 force ISO
pub type INTER_RAM0_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM0_FORCE_NOISO` reader - internal SRAM 0 force no ISO
pub type INTER_RAM0_FORCE_NOISO_R = crate::BitReader;
///Field `INTER_RAM0_FORCE_NOISO` writer - internal SRAM 0 force no ISO
pub type INTER_RAM0_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM1_FORCE_ISO` reader - internal SRAM 1 force ISO
pub type INTER_RAM1_FORCE_ISO_R = crate::BitReader;
///Field `INTER_RAM1_FORCE_ISO` writer - internal SRAM 1 force ISO
pub type INTER_RAM1_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM1_FORCE_NOISO` reader - internal SRAM 1 force no ISO
pub type INTER_RAM1_FORCE_NOISO_R = crate::BitReader;
///Field `INTER_RAM1_FORCE_NOISO` writer - internal SRAM 1 force no ISO
pub type INTER_RAM1_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM2_FORCE_ISO` reader - internal SRAM 2 force ISO
pub type INTER_RAM2_FORCE_ISO_R = crate::BitReader;
///Field `INTER_RAM2_FORCE_ISO` writer - internal SRAM 2 force ISO
pub type INTER_RAM2_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM2_FORCE_NOISO` reader - internal SRAM 2 force no ISO
pub type INTER_RAM2_FORCE_NOISO_R = crate::BitReader;
///Field `INTER_RAM2_FORCE_NOISO` writer - internal SRAM 2 force no ISO
pub type INTER_RAM2_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM3_FORCE_ISO` reader - internal SRAM 3 force ISO
pub type INTER_RAM3_FORCE_ISO_R = crate::BitReader;
///Field `INTER_RAM3_FORCE_ISO` writer - internal SRAM 3 force ISO
pub type INTER_RAM3_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM3_FORCE_NOISO` reader - internal SRAM 3 force no ISO
pub type INTER_RAM3_FORCE_NOISO_R = crate::BitReader;
///Field `INTER_RAM3_FORCE_NOISO` writer - internal SRAM 3 force no ISO
pub type INTER_RAM3_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM4_FORCE_ISO` reader - internal SRAM 4 force ISO
pub type INTER_RAM4_FORCE_ISO_R = crate::BitReader;
///Field `INTER_RAM4_FORCE_ISO` writer - internal SRAM 4 force ISO
pub type INTER_RAM4_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_RAM4_FORCE_NOISO` reader - internal SRAM 4 force no ISO
pub type INTER_RAM4_FORCE_NOISO_R = crate::BitReader;
///Field `INTER_RAM4_FORCE_NOISO` writer - internal SRAM 4 force no ISO
pub type INTER_RAM4_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WIFI_FORCE_ISO` reader - Set this bit to force isolate the Wi-Fi circuits.
pub type WIFI_FORCE_ISO_R = crate::BitReader;
///Field `WIFI_FORCE_ISO` writer - Set this bit to force isolate the Wi-Fi circuits.
pub type WIFI_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WIFI_FORCE_NOISO` reader - Set this bit to disable the force isolation to the Wi-Fi circuits.
pub type WIFI_FORCE_NOISO_R = crate::BitReader;
///Field `WIFI_FORCE_NOISO` writer - Set this bit to disable the force isolation to the Wi-Fi circuits.
pub type WIFI_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_WRAP_FORCE_ISO` reader - Set this bit to force isolate the digital system.
pub type DG_WRAP_FORCE_ISO_R = crate::BitReader;
///Field `DG_WRAP_FORCE_ISO` writer - Set this bit to force isolate the digital system.
pub type DG_WRAP_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_WRAP_FORCE_NOISO` reader - Set this bit to disable the force isolation to the digital system.
pub type DG_WRAP_FORCE_NOISO_R = crate::BitReader;
///Field `DG_WRAP_FORCE_NOISO` writer - Set this bit to disable the force isolation to the digital system.
...
///`reset()` method sets DIG_ISO to value 0xaaaa_5000
