...
///Field `SWD_RESET_FLAG` reader - Indicates the super watchdog reset flag.
pub type SWD_RESET_FLAG_R = crate::BitReader;
///Field `SWD_FEED_INT` reader - Receiving this interrupt leads to feeding the super watchdog via SW.
pub type SWD_FEED_INT_R = crate::BitReader;
///Field `SWD_SIGNAL_WIDTH` reader - Adjusts the signal width sent to the super watchdog.
pub type SWD_SIGNAL_WIDTH_R = crate::FieldReader<u16>;
///Field `SWD_SIGNAL_WIDTH` writer - Adjusts the signal width sent to the super watchdog.
pub type SWD_SIGNAL_WIDTH_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `SWD_RST_FLAG_CLR` writer - Set to reset the super watchdog reset flag.
pub type SWD_RST_FLAG_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD_FEED` writer - Set to feed the super watchdog via SW.
pub type SWD_FEED_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD_DISABLE` reader - Set this bit to disable super watchdog.
pub type SWD_DISABLE_R = crate::BitReader;
///Field `SWD_DISABLE` writer - Set this bit to disable super watchdog.
pub type SWD_DISABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD_AUTO_FEED_EN` reader - Set this bit to enable automatic watchdog feeding upon interrupts.
pub type SWD_AUTO_FEED_EN_R = crate::BitReader;
///Field `SWD_AUTO_FEED_EN` writer - Set this bit to enable automatic watchdog feeding upon interrupts.
...
///`read()` method returns [`swd_conf::R`](R) reader structure
impl crate::Readable for SWD_CONF_SPEC {}
///`write(|w| ..)` method takes [`swd_conf::W`](W) writer structure
