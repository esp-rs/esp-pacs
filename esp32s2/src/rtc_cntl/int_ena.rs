...
///Field `SLP_WAKEUP` reader - Enables interruption when the chip wakes up from sleep.
pub type SLP_WAKEUP_R = crate::BitReader;
///Field `SLP_WAKEUP` writer - Enables interruption when the chip wakes up from sleep.
pub type SLP_WAKEUP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLP_REJECT` reader - Enables interruption when the chip rejects to go to sleep.
pub type SLP_REJECT_R = crate::BitReader;
///Field `SLP_REJECT` writer - Enables interruption when the chip rejects to go to sleep.
pub type SLP_REJECT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDIO_IDLE` reader - Enables interruption when the SDIO idles.
pub type SDIO_IDLE_R = crate::BitReader;
///Field `SDIO_IDLE` writer - Enables interruption when the SDIO idles.
pub type SDIO_IDLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT` reader - Enables the RTC watchdog interrupt.
pub type WDT_R = crate::BitReader;
///Field `WDT` writer - Enables the RTC watchdog interrupt.
pub type WDT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_SCAN_DONE` reader - Enables interruption upon the completion of a touch scanning.
pub type TOUCH_SCAN_DONE_R = crate::BitReader;
///Field `TOUCH_SCAN_DONE` writer - Enables interruption upon the completion of a touch scanning.
pub type TOUCH_SCAN_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ULP_CP` reader - Enables the ULP co-processor interrupt.
...
///Field `TOUCH_DONE` reader - Enables interruption upon the completion of a single touch.
pub type TOUCH_DONE_R = crate::BitReader;
///Field `TOUCH_DONE` writer - Enables interruption upon the completion of a single touch.
pub type TOUCH_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_ACTIVE` reader - Enables interruption when a touch is detected.
pub type TOUCH_ACTIVE_R = crate::BitReader;
///Field `TOUCH_ACTIVE` writer - Enables interruption when a touch is detected.
pub type TOUCH_ACTIVE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_INACTIVE` reader - Enables interruption when a touch is released.
pub type TOUCH_INACTIVE_R = crate::BitReader;
///Field `TOUCH_INACTIVE` writer - Enables interruption when a touch is released.
pub type TOUCH_INACTIVE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BROWN_OUT` reader - Enables the brown out interrupt.
pub type BROWN_OUT_R = crate::BitReader;
///Field `BROWN_OUT` writer - Enables the brown out interrupt.
pub type BROWN_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAIN_TIMER` reader - Enables the RTC main timer interrupt.
pub type MAIN_TIMER_R = crate::BitReader;
///Field `MAIN_TIMER` writer - Enables the RTC main timer interrupt.
pub type MAIN_TIMER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC1` reader - Enables the SAR ADC 1 interrupt.
pub type SARADC1_R = crate::BitReader;
///Field `SARADC1` writer - Enables the SAR ADC 1 interrupt.
pub type SARADC1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TSENS` reader - Enables the touch sensor interrupt.
pub type TSENS_R = crate::BitReader;
///Field `TSENS` writer - Enables the touch sensor interrupt.
pub type TSENS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU` reader - Enables the ULP-RISCV interrupt.
pub type COCPU_R = crate::BitReader;
///Field `COCPU` writer - Enables the ULP-RISCV interrupt.
pub type COCPU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC2` reader - Enables the SAR ADC 2 interrupt.
pub type SARADC2_R = crate::BitReader;
///Field `SARADC2` writer - Enables the SAR ADC 2 interrupt.
pub type SARADC2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SWD` reader - Enables the super watchdog interrupt.
pub type SWD_R = crate::BitReader;
///Field `SWD` writer - Enables the super watchdog interrupt.
pub type SWD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTAL32K_DEAD` reader - Enables interruption when the 32 kHz crystal is dead.
pub type XTAL32K_DEAD_R = crate::BitReader;
///Field `XTAL32K_DEAD` writer - Enables interruption when the 32 kHz crystal is dead.
pub type XTAL32K_DEAD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_TRAP` reader - Enables interruption when the ULP-RISCV is trapped.
pub type COCPU_TRAP_R = crate::BitReader;
///Field `COCPU_TRAP` writer - Enables interruption when the ULP-RISCV is trapped.
pub type COCPU_TRAP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_TIMEOUT` reader - Enables interruption when touch sensor times out.
pub type TOUCH_TIMEOUT_R = crate::BitReader;
///Field `TOUCH_TIMEOUT` writer - Enables interruption when touch sensor times out.
pub type TOUCH_TIMEOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GLITCH_DET` reader - Enables interruption when a glitch is detected.
pub type GLITCH_DET_R = crate::BitReader;
///Field `GLITCH_DET` writer - Enables interruption when a glitch is detected.
