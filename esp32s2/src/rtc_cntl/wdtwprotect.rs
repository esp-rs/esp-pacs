...
///Field `WDT_WKEY` reader - Sets the write protection key of the watchdog.
pub type WDT_WKEY_R = crate::FieldReader<u32>;
///Field `WDT_WKEY` writer - Sets the write protection key of the watchdog.
pub type WDT_WKEY_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Sets the write protection key of the watchdog.
    #[inline(always)]
