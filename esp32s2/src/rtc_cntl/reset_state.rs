...
///Field `RESET_CAUSE_PROCPU` reader - Stores the CPU reset cause.
...
///Field `PROCPU_STAT_VECTOR_SEL` reader - Selects the CPU state vector.
pub type PROCPU_STAT_VECTOR_SEL_R = crate::BitReader;
///Field `PROCPU_STAT_VECTOR_SEL` writer - Selects the CPU state vector.
pub type PROCPU_STAT_VECTOR_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:5 - Stores the CPU reset cause.
    #[inline(always)]
