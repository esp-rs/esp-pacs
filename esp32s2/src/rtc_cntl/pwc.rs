...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PWC")
            ...
            .field("fastmem_force_pd", &self.fastmem_force_pd().bit())
            .field("fastmem_force_pu", &self.fastmem_force_pu().bit())
            .field("fastmem_pd_en", &self.fastmem_pd_en().bit())
            .field("slowmem_force_pd", &self.slowmem_force_pd().bit())
            .field("slowmem_force_pu", &self.slowmem_force_pu().bit())
            .field("slowmem_pd_en", &self.slowmem_pd_en().bit())
