...
#[doc = "Field `WDT_STG3_HOLD` reader - Configures the hold time of RTC watchdog at level 4."]
pub type WDT_STG3_HOLD_R = crate::FieldReader<u32, u32>;
#[doc = "Field `WDT_STG3_HOLD` writer - Configures the hold time of RTC watchdog at level 4."]
