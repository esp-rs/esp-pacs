///Register `WDTCONFIG4` reader
pub type R = crate::R<WDTCONFIG4_SPEC>;
///Register `WDTCONFIG4` writer
pub type W = crate::W<WDTCONFIG4_SPEC>;
///Field `WDT_STG3_HOLD` reader - Configures the hold time of RTC watchdog at level 4.
pub type WDT_STG3_HOLD_R = crate::FieldReader<u32>;
///Field `WDT_STG3_HOLD` writer - Configures the hold time of RTC watchdog at level 4.
pub type WDT_STG3_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures the hold time of RTC watchdog at level 4.
    #[inline(always)]
...
///`read()` method returns [`wdtconfig4::R`](R) reader structure
impl crate::Readable for WDTCONFIG4_SPEC {}
///`write(|w| ..)` method takes [`wdtconfig4::W`](W) writer structure
