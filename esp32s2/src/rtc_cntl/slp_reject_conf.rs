...
///Field `SLEEP_REJECT_ENA` reader - Set this bit to enable reject-to-sleep.
pub type SLEEP_REJECT_ENA_R = crate::FieldReader<u32>;
///Field `SLEEP_REJECT_ENA` writer - Set this bit to enable reject-to-sleep.
pub type SLEEP_REJECT_ENA_W<'a, REG> = crate::FieldWriter<'a, REG, 17, u32>;
///Field `LIGHT_SLP_REJECT_EN` reader - Set this bit to enable reject-to-light-sleep.
pub type LIGHT_SLP_REJECT_EN_R = crate::BitReader;
///Field `LIGHT_SLP_REJECT_EN` writer - Set this bit to enable reject-to-light-sleep.
pub type LIGHT_SLP_REJECT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DEEP_SLP_REJECT_EN` reader - Set this bit to enable reject-to-deep-sleep.
pub type DEEP_SLP_REJECT_EN_R = crate::BitReader;
///Field `DEEP_SLP_REJECT_EN` writer - Set this bit to enable reject-to-deep-sleep.
...
impl R {
    ...
    pub fn sleep_reject_ena(&self) -> SLEEP_REJECT_ENA_R {
        SLEEP_REJECT_ENA_R::new((self.bits >> 13) & 0x0001_ffff)
    }
