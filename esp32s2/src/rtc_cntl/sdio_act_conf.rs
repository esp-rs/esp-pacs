///Register `SDIO_ACT_CONF` reader
pub type R = crate::R<SDIO_ACT_CONF_SPEC>;
///Register `SDIO_ACT_CONF` writer
pub type W = crate::W<SDIO_ACT_CONF_SPEC>;
///Field `SDIO_ACT_DNUM` reader - configure sdio act dnum
pub type SDIO_ACT_DNUM_R = crate::FieldReader<u16>;
///Field `SDIO_ACT_DNUM` writer - configure sdio act dnum
pub type SDIO_ACT_DNUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    ///Bits 22:31 - configure sdio act dnum
    #[inline(always)]
...
///`read()` method returns [`sdio_act_conf::R`](R) reader structure
impl crate::Readable for SDIO_ACT_CONF_SPEC {}
///`write(|w| ..)` method takes [`sdio_act_conf::W`](W) writer structure
