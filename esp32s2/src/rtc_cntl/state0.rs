...
///Field `SW_CPU_INT` writer - Sends a SW RTC interrupt to CPU.
pub type SW_CPU_INT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLP_REJECT_CAUSE_CLR` writer - Clears the RTC reject-to-sleep cause.
...
///Field `SDIO_ACTIVE_IND` reader - Indicates the SDIO is active.
...
///Field `SLEEP_EN` reader - Sends the chip to sleep.
pub type SLEEP_EN_R = crate::BitReader;
///Field `SLEEP_EN` writer - Sends the chip to sleep.
