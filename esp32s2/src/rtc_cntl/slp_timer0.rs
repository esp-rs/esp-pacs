...
///Field `SLP_VAL_LO` reader - Sets the lower 32 bits of the trigger threshold for the RTC timer.
pub type SLP_VAL_LO_R = crate::FieldReader<u32>;
///Field `SLP_VAL_LO` writer - Sets the lower 32 bits of the trigger threshold for the RTC timer.
pub type SLP_VAL_LO_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Sets the lower 32 bits of the trigger threshold for the RTC timer.
    #[inline(always)]
