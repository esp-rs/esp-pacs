...
///`read()` method returns [`touch_timeout_ctrl::R`](R) reader structure
impl crate::Readable for TOUCH_TIMEOUT_CTRL_SPEC {}
///`write(|w| ..)` method takes [`touch_timeout_ctrl::W`](W) writer structure
