...
///Register `ULP_CP_TIMER_1` writer
pub type W = crate::W<ULP_CP_TIMER_1_SPEC>;
///Field `ULP_CP_TIMER_SLP_CYCLE` reader - Set sleep cycles for ULP coprocessor timer
pub type ULP_CP_TIMER_SLP_CYCLE_R = crate::FieldReader<u32>;
///Field `ULP_CP_TIMER_SLP_CYCLE` writer - Set sleep cycles for ULP coprocessor timer
...
///`read()` method returns [`ulp_cp_timer_1::R`](R) reader structure
impl crate::Readable for ULP_CP_TIMER_1_SPEC {}
///`write(|w| ..)` method takes [`ulp_cp_timer_1::W`](W) writer structure
