...
///Field `SW_STALL_PROCPU_C0` reader - When RTC_CNTL_REG_SW_STALL_PROCPU_C1 is configured to 0x21, setting this bit to 0x2 stalls the CPU by SW.
pub type SW_STALL_PROCPU_C0_R = crate::FieldReader;
///Field `SW_STALL_PROCPU_C0` writer - When RTC_CNTL_REG_SW_STALL_PROCPU_C1 is configured to 0x21, setting this bit to 0x2 stalls the CPU by SW.
pub type SW_STALL_PROCPU_C0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SW_APPCPU_RST` writer - APP CPU SW reset. (Note, we don’t have APP CPU for ESP32-S2)
pub type SW_APPCPU_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SW_PROCPU_RST` writer - Set this bit to reset the CPU by SW.
pub type SW_PROCPU_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BB_I2C_FORCE_PD` reader - Set this bit to FPD BB_I2C.
pub type BB_I2C_FORCE_PD_R = crate::BitReader;
///Field `BB_I2C_FORCE_PD` writer - Set this bit to FPD BB_I2C.
pub type BB_I2C_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BB_I2C_FORCE_PU` reader - Set this bit to FPU BB_I2C.
pub type BB_I2C_FORCE_PU_R = crate::BitReader;
///Field `BB_I2C_FORCE_PU` writer - Set this bit to FPU BB_I2C.
pub type BB_I2C_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BBPLL_I2C_FORCE_PD` reader - Set this bit to FPD BB_PLL _I2C.
pub type BBPLL_I2C_FORCE_PD_R = crate::BitReader;
///Field `BBPLL_I2C_FORCE_PD` writer - Set this bit to FPD BB_PLL _I2C.
pub type BBPLL_I2C_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BBPLL_I2C_FORCE_PU` reader - Set this bit to FPU BB_PLL _I2C.
pub type BBPLL_I2C_FORCE_PU_R = crate::BitReader;
///Field `BBPLL_I2C_FORCE_PU` writer - Set this bit to FPU BB_PLL _I2C.
pub type BBPLL_I2C_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BBPLL_FORCE_PD` reader - Set this bit to FPD BB_PLL.
pub type BBPLL_FORCE_PD_R = crate::BitReader;
///Field `BBPLL_FORCE_PD` writer - Set this bit to FPD BB_PLL.
pub type BBPLL_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BBPLL_FORCE_PU` reader - Set this bit to FPU BB_PLL.
pub type BBPLL_FORCE_PU_R = crate::BitReader;
///Field `BBPLL_FORCE_PU` writer - Set this bit to FPU BB_PLL.
pub type BBPLL_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTL_FORCE_PD` reader - Set this bit to FPD the crystal oscillator.
pub type XTL_FORCE_PD_R = crate::BitReader;
///Field `XTL_FORCE_PD` writer - Set this bit to FPD the crystal oscillator.
pub type XTL_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTL_FORCE_PU` reader - Set this bit to FPU the crystal oscillator.
pub type XTL_FORCE_PU_R = crate::BitReader;
///Field `XTL_FORCE_PU` writer - Set this bit to FPU the crystal oscillator.
pub type XTL_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTL_FORCE_ISO` reader -
pub type XTL_FORCE_ISO_R = crate::BitReader;
///Field `XTL_FORCE_ISO` writer -
pub type XTL_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PLL_FORCE_ISO` reader -
pub type PLL_FORCE_ISO_R = crate::BitReader;
///Field `PLL_FORCE_ISO` writer -
pub type PLL_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ANALOG_FORCE_ISO` reader -
pub type ANALOG_FORCE_ISO_R = crate::BitReader;
///Field `ANALOG_FORCE_ISO` writer -
pub type ANALOG_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTL_FORCE_NOISO` reader -
pub type XTL_FORCE_NOISO_R = crate::BitReader;
///Field `XTL_FORCE_NOISO` writer -
pub type XTL_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PLL_FORCE_NOISO` reader -
pub type PLL_FORCE_NOISO_R = crate::BitReader;
///Field `PLL_FORCE_NOISO` writer -
pub type PLL_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ANALOG_FORCE_NOISO` reader -
pub type ANALOG_FORCE_NOISO_R = crate::BitReader;
///Field `ANALOG_FORCE_NOISO` writer -
pub type ANALOG_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_WRAP_FORCE_RST` reader - Set this bit to force reset the digital system in deep-sleep.
pub type DG_WRAP_FORCE_RST_R = crate::BitReader;
///Field `DG_WRAP_FORCE_RST` writer - Set this bit to force reset the digital system in deep-sleep.
pub type DG_WRAP_FORCE_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_WRAP_FORCE_NORST` reader - Set this bit to disable force reset to digital system in deep-sleep.
pub type DG_WRAP_FORCE_NORST_R = crate::BitReader;
///Field `DG_WRAP_FORCE_NORST` writer - Set this bit to disable force reset to digital system in deep-sleep.
pub type DG_WRAP_FORCE_NORST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SW_SYS_RST` writer - Set this bit to reset the system via SW.
...
impl R {
    ...
    ///Bit 29 - Set this bit to force reset the digital system in deep-sleep.
    #[inline(always)]
    pub fn dg_wrap_force_rst(&self) -> DG_WRAP_FORCE_RST_R {
        DG_WRAP_FORCE_RST_R::new(((self.bits >> 29) & 1) != 0)
    }
    ///Bit 30 - Set this bit to disable force reset to digital system in deep-sleep.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 4 - APP CPU SW reset. (Note, we don’t have APP CPU for ESP32-S2)
    #[inline(always)]
    #[must_use]
    pub fn sw_appcpu_rst(&mut self) -> SW_APPCPU_RST_W<OPTIONS0_SPEC> {
        SW_APPCPU_RST_W::new(self, 4)
    }
    ///Bit 5 - Set this bit to reset the CPU by SW.
    #[inline(always)]
    #[must_use]
    ...
    ///Bit 31 - Set this bit to reset the system via SW.
    #[inline(always)]
    #[must_use]
...
///`reset()` method sets OPTIONS0 to value 0x1c00_2000
