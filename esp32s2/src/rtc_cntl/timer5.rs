...
///Field `MIN_SLP_VAL` reader - Sets the minimal sleep cycles (using the RTC slow clock).
pub type MIN_SLP_VAL_R = crate::FieldReader;
///Field `MIN_SLP_VAL` writer - Sets the minimal sleep cycles (using the RTC slow clock).
pub type MIN_SLP_VAL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `RTCMEM_WAIT_TIMER` reader -
pub type RTCMEM_WAIT_TIMER_R = crate::FieldReader<u16>;
///Field `RTCMEM_WAIT_TIMER` writer -
pub type RTCMEM_WAIT_TIMER_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `RTCMEM_POWERUP_TIMER` reader -
pub type RTCMEM_POWERUP_TIMER_R = crate::FieldReader;
///Field `RTCMEM_POWERUP_TIMER` writer -
pub type RTCMEM_POWERUP_TIMER_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    ///Bits 8:15 - Sets the minimal sleep cycles (using the RTC slow clock).
    #[inline(always)]
...
///`reset()` method sets TIMER5 to value 0x1214_8000
