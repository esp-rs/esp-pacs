...
///Field `COCPU_CLK_FO` reader - ULP-RISCV clock force on
pub type COCPU_CLK_FO_R = crate::BitReader;
///Field `COCPU_CLK_FO` writer - ULP-RISCV clock force on
pub type COCPU_CLK_FO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_START_2_RESET_DIS` reader - Time from ULP-RISCV startup to pull down reset
pub type COCPU_START_2_RESET_DIS_R = crate::FieldReader;
///Field `COCPU_START_2_RESET_DIS` writer - Time from ULP-RISCV startup to pull down reset
pub type COCPU_START_2_RESET_DIS_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `COCPU_START_2_INTR_EN` reader - Time from ULP-RISCV startup to send out RISCV_START_INT interrupt
pub type COCPU_START_2_INTR_EN_R = crate::FieldReader;
///Field `COCPU_START_2_INTR_EN` writer - Time from ULP-RISCV startup to send out RISCV_START_INT interrupt
pub type COCPU_START_2_INTR_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `COCPU_SHUT` reader - Shut down ULP-RISCV
pub type COCPU_SHUT_R = crate::BitReader;
///Field `COCPU_SHUT` writer - Shut down ULP-RISCV
pub type COCPU_SHUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SHUT_2_CLK_DIS` reader - Time from shut down ULP-RISCV to disable clock
pub type COCPU_SHUT_2_CLK_DIS_R = crate::FieldReader;
///Field `COCPU_SHUT_2_CLK_DIS` writer - Time from shut down ULP-RISCV to disable clock
pub type COCPU_SHUT_2_CLK_DIS_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `COCPU_SHUT_RESET_EN` reader - This bit is used to reset ULP-RISCV
pub type COCPU_SHUT_RESET_EN_R = crate::BitReader;
///Field `COCPU_SHUT_RESET_EN` writer - This bit is used to reset ULP-RISCV
pub type COCPU_SHUT_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SEL` reader - 0: select ULP-RISCV. 1: select ULP-FSM
pub type COCPU_SEL_R = crate::BitReader;
///Field `COCPU_SEL` writer - 0: select ULP-RISCV. 1: select ULP-FSM
pub type COCPU_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_DONE_FORCE` reader - 0: select ULP-FSM DONE signal. 1: select ULP-RISCV DONE signal
pub type COCPU_DONE_FORCE_R = crate::BitReader;
///Field `COCPU_DONE_FORCE` writer - 0: select ULP-FSM DONE signal. 1: select ULP-RISCV DONE signal
pub type COCPU_DONE_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_DONE` reader - DONE signal. Write 1 to this bit, ULP-RISCV will go to HALT and the timer starts counting
pub type COCPU_DONE_R = crate::BitReader;
///Field `COCPU_DONE` writer - DONE signal. Write 1 to this bit, ULP-RISCV will go to HALT and the timer starts counting
pub type COCPU_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SW_INT_TRIGGER` writer - Trigger ULP-RISCV register interrupt
...
///`read()` method returns [`cocpu_ctrl::R`](R) reader structure
impl crate::Readable for COCPU_CTRL_SPEC {}
///`write(|w| ..)` method takes [`cocpu_ctrl::W`](W) writer structure
