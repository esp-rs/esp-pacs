...
///Field `SDIO_TIMER_TARGET` reader - timer count to apply reg_sdio_dcap after sdio power on
pub type SDIO_TIMER_TARGET_R = crate::FieldReader;
///Field `SDIO_TIMER_TARGET` writer - timer count to apply reg_sdio_dcap after sdio power on
pub type SDIO_TIMER_TARGET_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SDIO_DTHDRV` reader - Tieh = 1 mode drive ability. Initially set to 0 to limit charge current set to 3 after several us.
pub type SDIO_DTHDRV_R = crate::FieldReader;
///Field `SDIO_DTHDRV` writer - Tieh = 1 mode drive ability. Initially set to 0 to limit charge current set to 3 after several us.
pub type SDIO_DTHDRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SDIO_DCAP` reader - ability to prevent LDO from overshoot
pub type SDIO_DCAP_R = crate::FieldReader;
///Field `SDIO_DCAP` writer - ability to prevent LDO from overshoot
pub type SDIO_DCAP_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SDIO_INITI` reader - add resistor from ldo output to ground. 0: no res 1: 6k 2: 4k 3: 2k
pub type SDIO_INITI_R = crate::FieldReader;
///Field `SDIO_INITI` writer - add resistor from ldo output to ground. 0: no res 1: 6k 2: 4k 3: 2k
pub type SDIO_INITI_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SDIO_EN_INITI` reader - 0 to set init\[1:0\]=0
pub type SDIO_EN_INITI_R = crate::BitReader;
///Field `SDIO_EN_INITI` writer - 0 to set init\[1:0\]=0
pub type SDIO_EN_INITI_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDIO_DCURLIM` reader - tune current limit threshold when tieh = 0. About 800mA/(8+d)
pub type SDIO_DCURLIM_R = crate::FieldReader;
///Field `SDIO_DCURLIM` writer - tune current limit threshold when tieh = 0. About 800mA/(8+d)
pub type SDIO_DCURLIM_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `SDIO_MODECURLIM` reader - select current limit mode
pub type SDIO_MODECURLIM_R = crate::BitReader;
///Field `SDIO_MODECURLIM` writer - select current limit mode
pub type SDIO_MODECURLIM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDIO_ENCURLIM` reader - enable current limit
pub type SDIO_ENCURLIM_R = crate::BitReader;
///Field `SDIO_ENCURLIM` writer - enable current limit
pub type SDIO_ENCURLIM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDIO_REG_PD_EN` reader - power down SDIO_REG in sleep. Only active when reg_sdio_force = 0
...
///Field `SDIO_FORCE` reader - 1: use SW option to control SDIO_REG 0: use state machine
pub type SDIO_FORCE_R = crate::BitReader;
///Field `SDIO_FORCE` writer - 1: use SW option to control SDIO_REG 0: use state machine
pub type SDIO_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDIO_TIEH` reader - SW option for SDIO_TIEH. Only active when reg_sdio_force = 1
pub type SDIO_TIEH_R = crate::BitReader;
///Field `SDIO_TIEH` writer - SW option for SDIO_TIEH. Only active when reg_sdio_force = 1
pub type SDIO_TIEH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REG1P8_READY` reader - read only register for REG1P8_READY
pub type REG1P8_READY_R = crate::BitReader;
///Field `DREFL_SDIO` reader - SW option for DREFL_SDIO. Only active when reg_sdio_force = 1
pub type DREFL_SDIO_R = crate::FieldReader;
///Field `DREFL_SDIO` writer - SW option for DREFL_SDIO. Only active when reg_sdio_force = 1
pub type DREFL_SDIO_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DREFM_SDIO` reader - SW option for DREFM_SDIO. Only active when reg_sdio_force = 1
pub type DREFM_SDIO_R = crate::FieldReader;
///Field `DREFM_SDIO` writer - SW option for DREFM_SDIO. Only active when reg_sdio_force = 1
pub type DREFM_SDIO_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DREFH_SDIO` reader - SW option for DREFH_SDIO. Only active when reg_sdio_force = 1
pub type DREFH_SDIO_R = crate::FieldReader;
///Field `DREFH_SDIO` writer - SW option for DREFH_SDIO. Only active when reg_sdio_force = 1
pub type DREFH_SDIO_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `XPD_SDIO` reader - SW option for XPD_VOOSDIO. Only active when reg_sdio_force = 1
pub type XPD_SDIO_R = crate::BitReader;
///Field `XPD_SDIO` writer - SW option for XPD_VOOSDIO. Only active when reg_sdio_force = 1
...
impl R {
    ...
    ///Bit 31 - SW option for XPD_VOOSDIO. Only active when reg_sdio_force = 1
    #[inline(always)]
...
///`read()` method returns [`sdio_conf::R`](R) reader structure
impl crate::Readable for SDIO_CONF_SPEC {}
///`write(|w| ..)` method takes [`sdio_conf::W`](W) writer structure
impl crate::Writable for SDIO_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDIO_CONF to value 0x02b0_be0a
impl crate::Resettable for SDIO_CONF_SPEC {
    const RESET_VALUE: u32 = 0x02b0_be0a;
}
