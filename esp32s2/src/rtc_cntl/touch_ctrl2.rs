...
///Field `TOUCH_DRANGE` reader - TOUCH attenuation.
pub type TOUCH_DRANGE_R = crate::FieldReader;
///Field `TOUCH_DRANGE` writer - TOUCH attenuation.
pub type TOUCH_DRANGE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_DREFL` reader - TOUCH reference voltage low. 0: 0.5 V 1: 0.6 V 2: 0.7 V 3: 0.8 V.
pub type TOUCH_DREFL_R = crate::FieldReader;
///Field `TOUCH_DREFL` writer - TOUCH reference voltage low. 0: 0.5 V 1: 0.6 V 2: 0.7 V 3: 0.8 V.
pub type TOUCH_DREFL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_DREFH` reader - TOUCH reference voltage high. 0: 2.4 V 1: 2.5 V 2: 2.6 V 3: 2.7 V.
pub type TOUCH_DREFH_R = crate::FieldReader;
///Field `TOUCH_DREFH` writer - TOUCH reference voltage high. 0: 2.4 V 1: 2.5 V 2: 2.6 V 3: 2.7 V.
pub type TOUCH_DREFH_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_XPD_BIAS` reader - TOUCH BIAS power switch.
pub type TOUCH_XPD_BIAS_R = crate::BitReader;
///Field `TOUCH_XPD_BIAS` writer - TOUCH BIAS power switch.
pub type TOUCH_XPD_BIAS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_REFC` reader - Touch pad 0 reference capacitance.
pub type TOUCH_REFC_R = crate::FieldReader;
///Field `TOUCH_REFC` writer - Touch pad 0 reference capacitance.
pub type TOUCH_REFC_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `TOUCH_DBIAS` reader - 0: Use bandgap bias. 1: Use self bias.
pub type TOUCH_DBIAS_R = crate::BitReader;
///Field `TOUCH_DBIAS` writer - 0: Use bandgap bias. 1: Use self bias.
pub type TOUCH_DBIAS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_SLP_TIMER_EN` reader - Touch timer enable bit.
pub type TOUCH_SLP_TIMER_EN_R = crate::BitReader;
///Field `TOUCH_SLP_TIMER_EN` writer - Touch timer enable bit.
pub type TOUCH_SLP_TIMER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_START_FSM_EN` reader - 0: TOUCH_START and TOUCH_XPD are controlled by soft- ware. 1: TOUCH_START and TOUCH_XPD are controlled by the Touch FSM.
pub type TOUCH_START_FSM_EN_R = crate::BitReader;
///Field `TOUCH_START_FSM_EN` writer - 0: TOUCH_START and TOUCH_XPD are controlled by soft- ware. 1: TOUCH_START and TOUCH_XPD are controlled by the Touch FSM.
pub type TOUCH_START_FSM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_START_EN` reader - 1: Start the Touch FSM, only valid when RTC_CNTL_TOUCH_START_FORCE = 1.
pub type TOUCH_START_EN_R = crate::BitReader;
///Field `TOUCH_START_EN` writer - 1: Start the Touch FSM, only valid when RTC_CNTL_TOUCH_START_FORCE = 1.
pub type TOUCH_START_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_START_FORCE` reader - 0: Start the Touch FSM by timer. 1: Start Touch FSM by software.
pub type TOUCH_START_FORCE_R = crate::BitReader;
///Field `TOUCH_START_FORCE` writer - 0: Start the Touch FSM by timer. 1: Start Touch FSM by software.
...
///Field `TOUCH_SLP_CYC_DIV` reader - When a touch pad is active, sleep cycle could be divided by this number.
pub type TOUCH_SLP_CYC_DIV_R = crate::FieldReader;
///Field `TOUCH_SLP_CYC_DIV` writer - When a touch pad is active, sleep cycle could be divided by this number.
pub type TOUCH_SLP_CYC_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_TIMER_FORCE_DONE` reader - Force touch timer done.
pub type TOUCH_TIMER_FORCE_DONE_R = crate::FieldReader;
///Field `TOUCH_TIMER_FORCE_DONE` writer - Force touch timer done.
pub type TOUCH_TIMER_FORCE_DONE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_RESET` reader - Reset TOUCH FSM via software.
pub type TOUCH_RESET_R = crate::BitReader;
///Field `TOUCH_RESET` writer - Reset TOUCH FSM via software.
pub type TOUCH_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_CLK_FO` reader - Touch clock force on.
pub type TOUCH_CLK_FO_R = crate::BitReader;
///Field `TOUCH_CLK_FO` writer - Touch clock force on.
pub type TOUCH_CLK_FO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_CLKGATE_EN` reader - Touch clock enable bit.
pub type TOUCH_CLKGATE_EN_R = crate::BitReader;
///Field `TOUCH_CLKGATE_EN` writer - Touch clock enable bit.
...
///`read()` method returns [`touch_ctrl2::R`](R) reader structure
impl crate::Readable for TOUCH_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`touch_ctrl2::W`](W) writer structure
