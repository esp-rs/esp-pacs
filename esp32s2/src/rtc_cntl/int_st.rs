...
///Field `SLP_WAKEUP` reader - Stores the status of the interrupt triggered when the chip wakes up from sleep.
pub type SLP_WAKEUP_R = crate::BitReader;
///Field `SLP_REJECT` reader - Stores the status of the interrupt triggered when the chip rejects to go to sleep.
pub type SLP_REJECT_R = crate::BitReader;
///Field `SDIO_IDLE` reader - Stores the status of the interrupt triggered when the SDIO idles.
pub type SDIO_IDLE_R = crate::BitReader;
///Field `WDT` reader - Stores the status of the RTC watchdog interrupt.
pub type WDT_R = crate::BitReader;
///Field `TOUCH_SCAN_DONE` reader - Stores the status of the interrupt triggered upon the completion of a touch scanning.
pub type TOUCH_SCAN_DONE_R = crate::BitReader;
///Field `ULP_CP` reader - Stores the status of the ULP co-processor interrupt.
pub type ULP_CP_R = crate::BitReader;
///Field `TOUCH_DONE` reader - Stores the status of the interrupt triggered upon the completion of a single touch.
pub type TOUCH_DONE_R = crate::BitReader;
///Field `TOUCH_ACTIVE` reader - Stores the status of the interrupt triggered when a touch is detected.
pub type TOUCH_ACTIVE_R = crate::BitReader;
///Field `TOUCH_INACTIVE` reader - Stores the status of the interrupt triggered when a touch is released.
pub type TOUCH_INACTIVE_R = crate::BitReader;
///Field `BROWN_OUT` reader - Stores the status of the brown out interrupt.
pub type BROWN_OUT_R = crate::BitReader;
///Field `MAIN_TIMER` reader - Stores the status of the RTC main timer interrupt.
pub type MAIN_TIMER_R = crate::BitReader;
///Field `SARADC1` reader - Stores the status of the SAR ADC 1 interrupt.
pub type SARADC1_R = crate::BitReader;
///Field `TSENS` reader - Stores the status of the touch sensor interrupt.
pub type TSENS_R = crate::BitReader;
///Field `COCPU` reader - Stores the status of the ULP-RISCV interrupt.
pub type COCPU_R = crate::BitReader;
///Field `SARADC2` reader - Stores the status of the SAR ADC 2 interrupt.
pub type SARADC2_R = crate::BitReader;
///Field `SWD` reader - Stores the status of the super watchdog interrupt.
pub type SWD_R = crate::BitReader;
///Field `XTAL32K_DEAD` reader - Stores the status of the interrupt triggered when the 32 kHz crystal is dead.
pub type XTAL32K_DEAD_R = crate::BitReader;
///Field `COCPU_TRAP` reader - Stores the status of the interrupt triggered when the ULP-RISCV is trapped.
pub type COCPU_TRAP_R = crate::BitReader;
///Field `TOUCH_TIMEOUT` reader - Stores the status of the interrupt triggered when touch sensor times out.
pub type TOUCH_TIMEOUT_R = crate::BitReader;
///Field `GLITCH_DET` reader - Stores the status of the interrupt triggered when a glitch is detected.
