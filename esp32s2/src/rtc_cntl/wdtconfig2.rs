...
///Field `WDT_STG1_HOLD` reader - Configures the hold time of RTC watchdog at level 2.
pub type WDT_STG1_HOLD_R = crate::FieldReader<u32>;
///Field `WDT_STG1_HOLD` writer - Configures the hold time of RTC watchdog at level 2.
pub type WDT_STG1_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures the hold time of RTC watchdog at level 2.
    #[inline(always)]
