///Register `TOUCH_CTRL1` reader
pub type R = crate::R<TOUCH_CTRL1_SPEC>;
///Register `TOUCH_CTRL1` writer
pub type W = crate::W<TOUCH_CTRL1_SPEC>;
///Field `TOUCH_SLEEP_CYCLES` reader - Set sleep cycles for touch timer.
pub type TOUCH_SLEEP_CYCLES_R = crate::FieldReader<u16>;
///Field `TOUCH_SLEEP_CYCLES` writer - Set sleep cycles for touch timer.
pub type TOUCH_SLEEP_CYCLES_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `TOUCH_MEAS_NUM` reader - Configure measurement length (in 8 MHz), i.e., charge/discharge times.
pub type TOUCH_MEAS_NUM_R = crate::FieldReader<u16>;
///Field `TOUCH_MEAS_NUM` writer - Configure measurement length (in 8 MHz), i.e., charge/discharge times.
pub type TOUCH_MEAS_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - Set sleep cycles for touch timer.
    #[inline(always)]
    pub fn touch_sleep_cycles(&self) -> TOUCH_SLEEP_CYCLES_R {
        TOUCH_SLEEP_CYCLES_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - Configure measurement length (in 8 MHz), i.e., charge/discharge times.
    #[inline(always)]
...
///`read()` method returns [`touch_ctrl1::R`](R) reader structure
impl crate::Readable for TOUCH_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`touch_ctrl1::W`](W) writer structure
