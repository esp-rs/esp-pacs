...
///Field `WDT_STG0_HOLD` reader - Configures the hold time of RTC watchdog at level 1.
pub type WDT_STG0_HOLD_R = crate::FieldReader<u32>;
///Field `WDT_STG0_HOLD` writer - Configures the hold time of RTC watchdog at level 1.
pub type WDT_STG0_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures the hold time of RTC watchdog at level 1.
    #[inline(always)]
