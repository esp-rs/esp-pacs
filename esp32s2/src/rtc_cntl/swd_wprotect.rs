...
///Field `SWD_WKEY` reader - Sets the write protection key of the super watchdog.
pub type SWD_WKEY_R = crate::FieldReader<u32>;
///Field `SWD_WKEY` writer - Sets the write protection key of the super watchdog.
pub type SWD_WKEY_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Sets the write protection key of the super watchdog.
    #[inline(always)]
