///Register `SW_CPU_STALL` reader
pub type R = crate::R<SW_CPU_STALL_SPEC>;
///Register `SW_CPU_STALL` writer
pub type W = crate::W<SW_CPU_STALL_SPEC>;
///Field `SW_STALL_APPCPU_C1` reader - {reg_sw_stall_appcpu_c1\[5:0\] reg_sw_stall_appcpu_c0\[1:0\]} == 0x86 will stall APP CPU
pub type SW_STALL_APPCPU_C1_R = crate::FieldReader;
///Field `SW_STALL_APPCPU_C1` writer - {reg_sw_stall_appcpu_c1\[5:0\] reg_sw_stall_appcpu_c0\[1:0\]} == 0x86 will stall APP CPU
pub type SW_STALL_APPCPU_C1_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `SW_STALL_PROCPU_C1` reader - Set this bit to allow the SW to be able to send the CPU into stalling.
pub type SW_STALL_PROCPU_C1_R = crate::FieldReader;
///Field `SW_STALL_PROCPU_C1` writer - Set this bit to allow the SW to be able to send the CPU into stalling.
...
impl R {
    ...
    ///Bits 26:31 - Set this bit to allow the SW to be able to send the CPU into stalling.
    #[inline(always)]
...
///`read()` method returns [`sw_cpu_stall::R`](R) reader structure
impl crate::Readable for SW_CPU_STALL_SPEC {}
///`write(|w| ..)` method takes [`sw_cpu_stall::W`](W) writer structure
