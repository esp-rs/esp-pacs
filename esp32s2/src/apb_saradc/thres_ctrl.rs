...
///Field `CLK_EN` reader - Clock gate enable.
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - Clock gate enable.
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC2_THRES_MODE` reader - 1: ADC_DATA > = threshold, generate interrupt. 0: ADC_DATA &lt; threshold, generate interrupt.
pub type ADC2_THRES_MODE_R = crate::BitReader;
///Field `ADC2_THRES_MODE` writer - 1: ADC_DATA > = threshold, generate interrupt. 0: ADC_DATA &lt; threshold, generate interrupt.
pub type ADC2_THRES_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC1_THRES_MODE` reader - 1: ADC_DATA > = threshold, generate interrupt. 0: ADC_DATA &lt; threshold, generate interrupt.
pub type ADC1_THRES_MODE_R = crate::BitReader;
///Field `ADC1_THRES_MODE` writer - 1: ADC_DATA > = threshold, generate interrupt. 0: ADC_DATA &lt; threshold, generate interrupt.
pub type ADC1_THRES_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC2_THRES` reader - ADC2 threshold.
pub type ADC2_THRES_R = crate::FieldReader<u16>;
///Field `ADC2_THRES` writer - ADC2 threshold.
pub type ADC2_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `ADC1_THRES` reader - ADC1 threshold.
pub type ADC1_THRES_R = crate::FieldReader<u16>;
///Field `ADC1_THRES` writer - ADC1 threshold.
pub type ADC1_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `ADC2_THRES_EN` reader - Enable ADC2 threshold monitor.
pub type ADC2_THRES_EN_R = crate::BitReader;
///Field `ADC2_THRES_EN` writer - Enable ADC2 threshold monitor.
pub type ADC2_THRES_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC1_THRES_EN` reader - Enable ADC1 threshold monitor.
pub type ADC1_THRES_EN_R = crate::BitReader;
///Field `ADC1_THRES_EN` writer - Enable ADC1 threshold monitor.
pub type ADC1_THRES_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Clock gate enable.
    #[inline(always)]
