...
///Field `ADC2_THRES` reader - Status of APB_SARADC_ADC2_THRES_INT interrupt.
pub type ADC2_THRES_R = crate::BitReader;
///Field `ADC1_THRES` reader - Status of APB_SARADC_ADC1_THRES_INT interrupt.
pub type ADC1_THRES_R = crate::BitReader;
///Field `ADC2_DONE` reader - Status of APB_SARADC_ADC2_DONE_INT interrupt.
pub type ADC2_DONE_R = crate::BitReader;
///Field `ADC1_DONE` reader - Status of APB_SARADC_ADC1_DONE_INT interrupt.
pub type ADC1_DONE_R = crate::BitReader;
impl R {
    ///Bit 28 - Status of APB_SARADC_ADC2_THRES_INT interrupt.
    #[inline(always)]
    pub fn adc2_thres(&self) -> ADC2_THRES_R {
        ADC2_THRES_R::new(((self.bits >> 28) & 1) != 0)
    }
    ///Bit 29 - Status of APB_SARADC_ADC1_THRES_INT interrupt.
    #[inline(always)]
    pub fn adc1_thres(&self) -> ADC1_THRES_R {
        ADC1_THRES_R::new(((self.bits >> 29) & 1) != 0)
    }
    ///Bit 30 - Status of APB_SARADC_ADC2_DONE_INT interrupt.
    #[inline(always)]
    pub fn adc2_done(&self) -> ADC2_DONE_R {
        ADC2_DONE_R::new(((self.bits >> 30) & 1) != 0)
    }
    ///Bit 31 - Status of APB_SARADC_ADC1_DONE_INT interrupt.
    #[inline(always)]
