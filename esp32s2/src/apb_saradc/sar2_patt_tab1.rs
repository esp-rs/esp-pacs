...
pub type SAR2_PATT_TAB1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SAR2_PATT_TAB1` writer - item 0 ~ 3 for pattern table 2 (each item one byte)"]
pub type SAR2_PATT_TAB1_W<'a, const O: u8> =
    crate::FieldWriter<'a, SAR2_PATT_TAB1_SPEC, 32, O, u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR2_PATT_TAB1")
            .field(
                "sar2_patt_tab1",
                &format_args!("{}", self.sar2_patt_tab1().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar2_patt_tab1(&mut self) -> SAR2_PATT_TAB1_W<0> {
