...
///Field `APB_FORCE` reader - ADC2 arbiter forces to enable DIG ADC2 CTRL.
pub type APB_FORCE_R = crate::BitReader;
///Field `APB_FORCE` writer - ADC2 arbiter forces to enable DIG ADC2 CTRL.
pub type APB_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RTC_FORCE` reader - ADC2 arbiter forces to enable RTC ADC2 CTRL.
pub type RTC_FORCE_R = crate::BitReader;
///Field `RTC_FORCE` writer - ADC2 arbiter forces to enable RTC ADC2 CTRL.
pub type RTC_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WIFI_FORCE` reader - ADC2 arbiter forces to enable PWDET/PKDET CTRL.
pub type WIFI_FORCE_R = crate::BitReader;
///Field `WIFI_FORCE` writer - ADC2 arbiter forces to enable PWDET/PKDET CTRL.
pub type WIFI_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GRANT_FORCE` reader - ADC2 arbiter force grant.
pub type GRANT_FORCE_R = crate::BitReader;
///Field `GRANT_FORCE` writer - ADC2 arbiter force grant.
pub type GRANT_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APB_PRIORITY` reader - Set DIG ADC2 CTRL priority.
pub type APB_PRIORITY_R = crate::FieldReader;
///Field `APB_PRIORITY` writer - Set DIG ADC2 CTRL priority.
pub type APB_PRIORITY_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `RTC_PRIORITY` reader - Set RTC ADC2 CTRL priority.
pub type RTC_PRIORITY_R = crate::FieldReader;
///Field `RTC_PRIORITY` writer - Set RTC ADC2 CTRL priority.
pub type RTC_PRIORITY_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `WIFI_PRIORITY` reader - Set PWDET/PKDET CTRL priority.
pub type WIFI_PRIORITY_R = crate::FieldReader;
///Field `WIFI_PRIORITY` writer - Set PWDET/PKDET CTRL priority.
pub type WIFI_PRIORITY_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `FIX_PRIORITY` reader - ADC2 arbiter uses fixed priority.
pub type FIX_PRIORITY_R = crate::BitReader;
///Field `FIX_PRIORITY` writer - ADC2 arbiter uses fixed priority.
...
///`read()` method returns [`arb_ctrl::R`](R) reader structure
impl crate::Readable for ARB_CTRL_SPEC {}
///`write(|w| ..)` method takes [`arb_ctrl::W`](W) writer structure
