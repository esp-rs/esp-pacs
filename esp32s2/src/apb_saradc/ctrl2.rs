...
///Field `MEAS_NUM_LIMIT` reader - Enable limit times of SAR ADC sample.
pub type MEAS_NUM_LIMIT_R = crate::BitReader;
///Field `MEAS_NUM_LIMIT` writer - Enable limit times of SAR ADC sample.
pub type MEAS_NUM_LIMIT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MAX_MEAS_NUM` reader - Set maximum conversion number.
pub type MAX_MEAS_NUM_R = crate::FieldReader;
///Field `MAX_MEAS_NUM` writer - Set maximum conversion number.
...
///Field `TIMER_TARGET` reader - Set SAR ADC timer target.
pub type TIMER_TARGET_R = crate::FieldReader<u16>;
///Field `TIMER_TARGET` writer - Set SAR ADC timer target.
pub type TIMER_TARGET_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `TIMER_EN` reader - Enable SAR ADC timer trigger.
pub type TIMER_EN_R = crate::BitReader;
///Field `TIMER_EN` writer - Enable SAR ADC timer trigger.
