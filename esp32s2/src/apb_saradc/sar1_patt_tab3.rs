...
pub type SAR1_PATT_TAB3_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Item 8 ~ 11 for pattern table 1 (each item one byte)
    #[inline(always)]
...
///`reset()` method sets SAR1_PATT_TAB3 to value 0x0f0f_0f0f
