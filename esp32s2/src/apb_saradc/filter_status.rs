...
///`read()` method returns [`filter_status::R`](R) reader structure
impl crate::Readable for FILTER_STATUS_SPEC {}
///`reset()` method sets FILTER_STATUS to value 0
