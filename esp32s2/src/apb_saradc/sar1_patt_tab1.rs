...
///Register `SAR1_PATT_TAB1` writer
pub type W = crate::W<SAR1_PATT_TAB1_SPEC>;
///Field `SAR1_PATT_TAB1` reader - item 0 ~ 3 for pattern table 1 (each item one byte)
pub type SAR1_PATT_TAB1_R = crate::FieldReader<u32>;
///Field `SAR1_PATT_TAB1` writer - item 0 ~ 3 for pattern table 1 (each item one byte)
...
///`read()` method returns [`sar1_patt_tab1::R`](R) reader structure
impl crate::Readable for SAR1_PATT_TAB1_SPEC {}
///`write(|w| ..)` method takes [`sar1_patt_tab1::W`](W) writer structure
impl crate::Writable for SAR1_PATT_TAB1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAR1_PATT_TAB1 to value 0x0f0f_0f0f
