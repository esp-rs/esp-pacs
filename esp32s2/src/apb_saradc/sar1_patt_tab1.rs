...
pub struct R(crate::R<SAR1_PATT_TAB1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SAR1_PATT_TAB1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SAR1_PATT_TAB1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SAR1_PATT_TAB1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SAR1_PATT_TAB1` writer"]
pub struct W(crate::W<SAR1_PATT_TAB1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SAR1_PATT_TAB1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SAR1_PATT_TAB1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SAR1_PATT_TAB1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SAR1_PATT_TAB1` reader - item 0 ~ 3 for pattern table 1 (each item one byte)"]
pub type SAR1_PATT_TAB1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SAR1_PATT_TAB1` writer - item 0 ~ 3 for pattern table 1 (each item one byte)"]
pub type SAR1_PATT_TAB1_W<'a, const O: u8> =
    crate::FieldWriter<'a, SAR1_PATT_TAB1_SPEC, 32, O, u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR1_PATT_TAB1")
            .field(
                "sar1_patt_tab1",
                &format_args!("{}", self.sar1_patt_tab1().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar1_patt_tab1(&mut self) -> SAR1_PATT_TAB1_W<0> {
        SAR1_PATT_TAB1_W::new(self)
    }
