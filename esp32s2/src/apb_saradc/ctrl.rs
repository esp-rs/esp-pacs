...
///Field `START_FORCE` reader - 0: select FSM to start SAR ADC. 1: select software to start SAR ADC.
pub type START_FORCE_R = crate::BitReader;
///Field `START_FORCE` writer - 0: select FSM to start SAR ADC. 1: select software to start SAR ADC.
pub type START_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `START` reader - Start SAR ADC by software.
pub type START_R = crate::BitReader;
///Field `START` writer - Start SAR ADC by software.
pub type START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WORK_MODE` reader - 0: single-channel scan mode. 1: double-channel scan mode. 2: alternate-channel scan mode.
pub type WORK_MODE_R = crate::FieldReader;
///Field `WORK_MODE` writer - 0: single-channel scan mode. 1: double-channel scan mode. 2: alternate-channel scan mode.
pub type WORK_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SAR_SEL` reader - 0: select SAR ADC1. 1: select SAR ADC2, only work for single-channel scan mode.
pub type SAR_SEL_R = crate::BitReader;
///Field `SAR_SEL` writer - 0: select SAR ADC1. 1: select SAR ADC2, only work for single-channel scan mode.
pub type SAR_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_CLK_GATED` reader - SAR clock gate enable bit.
pub type SAR_CLK_GATED_R = crate::BitReader;
///Field `SAR_CLK_GATED` writer - SAR clock gate enable bit.
...
///Field `DATA_SAR_SEL` reader - 1: sar_sel will be coded to the MSB of the 16-bit output data, in this case the resolution should not be larger than 11 bits.
pub type DATA_SAR_SEL_R = crate::BitReader;
///Field `DATA_SAR_SEL` writer - 1: sar_sel will be coded to the MSB of the 16-bit output data, in this case the resolution should not be larger than 11 bits.
