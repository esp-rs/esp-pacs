...
///Register `FILTER_CTRL` writer
pub type W = crate::W<FILTER_CTRL_SPEC>;
///Field `ADC2_FILTER_RESET` reader - Reset ADC2 filter.
pub type ADC2_FILTER_RESET_R = crate::BitReader;
///Field `ADC2_FILTER_RESET` writer - Reset ADC2 filter.
pub type ADC2_FILTER_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC1_FILTER_RESET` reader - Reset ADC1 filter.
pub type ADC1_FILTER_RESET_R = crate::BitReader;
///Field `ADC1_FILTER_RESET` writer - Reset ADC1 filter.
pub type ADC1_FILTER_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC2_FILTER_FACTOR` reader - Set filter factor for DIG ADC2 CRTL.
pub type ADC2_FILTER_FACTOR_R = crate::FieldReader;
///Field `ADC2_FILTER_FACTOR` writer - Set filter factor for DIG ADC2 CRTL.
pub type ADC2_FILTER_FACTOR_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `ADC1_FILTER_FACTOR` reader - Set filter factor for DIG ADC1 CRTL.
pub type ADC1_FILTER_FACTOR_R = crate::FieldReader;
///Field `ADC1_FILTER_FACTOR` writer - Set filter factor for DIG ADC1 CRTL.
pub type ADC1_FILTER_FACTOR_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `ADC2_FILTER_EN` reader - Enable DIG ADC2 CRTL filter.
pub type ADC2_FILTER_EN_R = crate::BitReader;
///Field `ADC2_FILTER_EN` writer - Enable DIG ADC2 CRTL filter.
pub type ADC2_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC1_FILTER_EN` reader - Enable DIG ADC1 CRTL filter.
pub type ADC1_FILTER_EN_R = crate::BitReader;
///Field `ADC1_FILTER_EN` writer - Enable DIG ADC1 CRTL filter.
...
///`read()` method returns [`filter_ctrl::R`](R) reader structure
impl crate::Readable for FILTER_CTRL_SPEC {}
///`write(|w| ..)` method takes [`filter_ctrl::W`](W) writer structure
impl crate::Writable for FILTER_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FILTER_CTRL to value 0x2040_0000
