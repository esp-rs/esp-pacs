...
pub struct RegisterBlock {
    ...
    pub touch_pad: [crate::Reg<touch_pad::TOUCH_PAD_SPEC>; 15],
    ...
    pub rtc_io_touch_ctrl: crate::Reg<rtc_io_touch_ctrl::RTC_IO_TOUCH_CTRL_SPEC>,
    _reserved24: [u8; 0x0110],
    #[doc = "0x1fc - Version control register"]
    pub rtc_io_date: crate::Reg<rtc_io_date::RTC_IO_DATE_SPEC>,
}
...
#[doc = "TOUCH_PAD register accessor: an alias for `Reg<TOUCH_PAD_SPEC>`"]
...
pub mod sar_i2c_io;
#[doc = "RTC_IO_TOUCH_CTRL register accessor: an alias for `Reg<RTC_IO_TOUCH_CTRL_SPEC>`"]
...
#[doc = "RTC_IO_DATE register accessor: an alias for `Reg<RTC_IO_DATE_SPEC>`"]
