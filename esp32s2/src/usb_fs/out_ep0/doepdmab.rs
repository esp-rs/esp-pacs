...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn dmabufferaddr(&mut self) -> DMABUFFERADDR_W<'_, DOEPDMAB_SPEC> {
        DMABUFFERADDR_W::new(self, 0)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`doepdmab::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`doepdmab::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
