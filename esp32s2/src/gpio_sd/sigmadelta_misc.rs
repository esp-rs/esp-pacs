...
///Field `FUNCTION_CLK_EN` reader - Clock enable bit of sigma delta modulation.
pub type FUNCTION_CLK_EN_R = crate::BitReader;
///Field `FUNCTION_CLK_EN` writer - Clock enable bit of sigma delta modulation.
pub type FUNCTION_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SWAP` reader - Reserved.
pub type SPI_SWAP_R = crate::BitReader;
///Field `SPI_SWAP` writer - Reserved.
