...
impl RegisterBlock {
    ...
    #[doc = "0x08..0x28 - Initial duty cycle for channel %s"]
    #[inline(always)]
    ...
    #[doc = "0x80 - Initial duty cycle for channel 6"]
    #[inline(always)]
    pub const fn ch6_duty(&self) -> &CH_DUTY {
        self.ch_duty(6)
    }
    #[doc = "0x94 - Initial duty cycle for channel 7"]
    #[inline(always)]
    ...
    #[doc = "0x10..0x30 - Current duty cycle for channel %s"]
    #[inline(always)]
    ...
    #[doc = "0x88 - Current duty cycle for channel 6"]
    #[inline(always)]
    pub const fn ch6_duty_r(&self) -> &CH_DUTY_R {
        self.ch_duty_r(6)
    }
    #[doc = "0x9c - Current duty cycle for channel 7"]
    #[inline(always)]
