...
///Field `PRO_TG1_T0_LEVEL_INT_MAP` reader - This register is used to map TG1_T0_LEVEL_INT interrupt signal to one of the CPU interrupts.
pub type PRO_TG1_T0_LEVEL_INT_MAP_R = crate::FieldReader;
///Field `PRO_TG1_T0_LEVEL_INT_MAP` writer - This register is used to map TG1_T0_LEVEL_INT interrupt signal to one of the CPU interrupts.
pub type PRO_TG1_T0_LEVEL_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - This register is used to map TG1_T0_LEVEL_INT interrupt signal to one of the CPU interrupts.
    #[inline(always)]
