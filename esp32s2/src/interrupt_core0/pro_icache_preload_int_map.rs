...
pub struct R(crate::R<PRO_ICACHE_PRELOAD_INT_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_ICACHE_PRELOAD_INT_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_ICACHE_PRELOAD_INT_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_ICACHE_PRELOAD_INT_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_ICACHE_PRELOAD_INT_MAP` writer"]
pub struct W(crate::W<PRO_ICACHE_PRELOAD_INT_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_ICACHE_PRELOAD_INT_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_ICACHE_PRELOAD_INT_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_ICACHE_PRELOAD_INT_MAP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_ICACHE_PRELOAD_INT_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, PRO_ICACHE_PRELOAD_INT_MAP_SPEC, 5, O>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_ICACHE_PRELOAD_INT_MAP")
            .field(
                ...
                &format_args!("{}", self.pro_icache_preload_int_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PRO_ICACHE_PRELOAD_INT_MAP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_icache_preload_int_map(&mut self) -> PRO_ICACHE_PRELOAD_INT_MAP_W<0> {
        PRO_ICACHE_PRELOAD_INT_MAP_W::new(self)
    }
