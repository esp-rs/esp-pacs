...
pub type PRO_SPI_INTR_3_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_SPI_INTR_3_MAP")
            .field(
                "pro_spi_intr_3_map",
                &format_args!("{}", self.pro_spi_intr_3_map().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_spi_intr_3_map(&mut self) -> PRO_SPI_INTR_3_MAP_W<PRO_SPI_INTR_3_MAP_SPEC, 0> {
