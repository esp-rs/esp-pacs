///Register `PRO_SPI_INTR_3_MAP` reader
pub type R = crate::R<PRO_SPI_INTR_3_MAP_SPEC>;
///Register `PRO_SPI_INTR_3_MAP` writer
pub type W = crate::W<PRO_SPI_INTR_3_MAP_SPEC>;
///Field `PRO_SPI_INTR_3_MAP` reader - This register is used to map SPI_INTR_3 interrupt signal to one of the CPU interrupts.
pub type PRO_SPI_INTR_3_MAP_R = crate::FieldReader;
///Field `PRO_SPI_INTR_3_MAP` writer - This register is used to map SPI_INTR_3 interrupt signal to one of the CPU interrupts.
pub type PRO_SPI_INTR_3_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - This register is used to map SPI_INTR_3 interrupt signal to one of the CPU interrupts.
    #[inline(always)]
...
///`read()` method returns [`pro_spi_intr_3_map::R`](R) reader structure
impl crate::Readable for PRO_SPI_INTR_3_MAP_SPEC {}
///`write(|w| ..)` method takes [`pro_spi_intr_3_map::W`](W) writer structure
impl crate::Writable for PRO_SPI_INTR_3_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_SPI_INTR_3_MAP to value 0x10
