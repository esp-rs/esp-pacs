...
///Field `PRO_INTR_STATUS_2` reader - This register stores the status of the last 31 input interrupt sources.
pub type PRO_INTR_STATUS_2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the status of the last 31 input interrupt sources.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_INTR_STATUS_2")
            .field("pro_intr_status_2", &self.pro_intr_status_2())
            .finish()
    }
}
