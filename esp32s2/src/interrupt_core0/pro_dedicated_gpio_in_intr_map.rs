...
pub type PRO_DEDICATED_GPIO_IN_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    pub fn pro_dedicated_gpio_in_intr_map(
        &mut self,
    ) -> PRO_DEDICATED_GPIO_IN_INTR_MAP_W<PRO_DEDICATED_GPIO_IN_INTR_MAP_SPEC, 0> {
