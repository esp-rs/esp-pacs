///Register `PRO_SPI_INTR_2_MAP` reader
pub type R = crate::R<PRO_SPI_INTR_2_MAP_SPEC>;
///Register `PRO_SPI_INTR_2_MAP` writer
pub type W = crate::W<PRO_SPI_INTR_2_MAP_SPEC>;
///Field `PRO_SPI_INTR_2_MAP` reader - This register is used to map SPI_INTR_2 interrupt signal to one of the CPU interrupts.
pub type PRO_SPI_INTR_2_MAP_R = crate::FieldReader;
///Field `PRO_SPI_INTR_2_MAP` writer - This register is used to map SPI_INTR_2 interrupt signal to one of the CPU interrupts.
pub type PRO_SPI_INTR_2_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - This register is used to map SPI_INTR_2 interrupt signal to one of the CPU interrupts.
    #[inline(always)]
