///Register `PRO_INTR_STATUS_1` reader
pub type R = crate::R<PRO_INTR_STATUS_1_SPEC>;
///Field `PRO_INTR_STATUS_1` reader - This register stores the status of the second 32 input interrupt sources.
pub type PRO_INTR_STATUS_1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the status of the second 32 input interrupt sources.
    #[inline(always)]
...
///`read()` method returns [`pro_intr_status_1::R`](R) reader structure
