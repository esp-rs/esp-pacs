...
pub type PRO_SYSTIMER_TARGET2_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    pub fn pro_systimer_target2_int_map(
        &mut self,
    ) -> PRO_SYSTIMER_TARGET2_INT_MAP_W<PRO_SYSTIMER_TARGET2_INT_MAP_SPEC, 0> {
