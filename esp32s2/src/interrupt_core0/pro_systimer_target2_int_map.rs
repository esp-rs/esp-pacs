#[doc = "Register `PRO_SYSTIMER_TARGET2_INT_MAP` reader"]
pub struct R(crate::R<PRO_SYSTIMER_TARGET2_INT_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_SYSTIMER_TARGET2_INT_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_SYSTIMER_TARGET2_INT_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_SYSTIMER_TARGET2_INT_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_SYSTIMER_TARGET2_INT_MAP` writer"]
pub struct W(crate::W<PRO_SYSTIMER_TARGET2_INT_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_SYSTIMER_TARGET2_INT_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_SYSTIMER_TARGET2_INT_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_SYSTIMER_TARGET2_INT_MAP_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_systimer_target2_int_map(&mut self) -> PRO_SYSTIMER_TARGET2_INT_MAP_W<0> {
        PRO_SYSTIMER_TARGET2_INT_MAP_W::new(self)
    }
