///Register `PRO_EFUSE_INT_MAP` reader
pub type R = crate::R<PRO_EFUSE_INT_MAP_SPEC>;
///Register `PRO_EFUSE_INT_MAP` writer
pub type W = crate::W<PRO_EFUSE_INT_MAP_SPEC>;
///Field `PRO_EFUSE_INT_MAP` reader - This register is used to map EFUSE_INT interrupt signal to one of the CPU interrupts.
pub type PRO_EFUSE_INT_MAP_R = crate::FieldReader;
///Field `PRO_EFUSE_INT_MAP` writer - This register is used to map EFUSE_INT interrupt signal to one of the CPU interrupts.
...
You can [`read`](crate::generic::Reg::read) this register and get [`pro_efuse_int_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pro_efuse_int_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PRO_EFUSE_INT_MAP_SPEC;
impl crate::RegisterSpec for PRO_EFUSE_INT_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pro_efuse_int_map::R`](R) reader structure
impl crate::Readable for PRO_EFUSE_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`pro_efuse_int_map::W`](W) writer structure
impl crate::Writable for PRO_EFUSE_INT_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_EFUSE_INT_MAP to value 0x10
