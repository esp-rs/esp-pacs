///Register `PRO_TIMER_INT1_MAP` reader
pub type R = crate::R<PRO_TIMER_INT1_MAP_SPEC>;
///Register `PRO_TIMER_INT1_MAP` writer
pub type W = crate::W<PRO_TIMER_INT1_MAP_SPEC>;
///Field `PRO_TIMER_INT1_MAP` reader - This register is used to map TIMER_INT1 interrupt signal to one of the CPU interrupts.
pub type PRO_TIMER_INT1_MAP_R = crate::FieldReader;
///Field `PRO_TIMER_INT1_MAP` writer - This register is used to map TIMER_INT1 interrupt signal to one of the CPU interrupts.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_TIMER_INT1_MAP")
            .field("pro_timer_int1_map", &self.pro_timer_int1_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pro_timer_int1_map::R`](R) reader structure
impl crate::Readable for PRO_TIMER_INT1_MAP_SPEC {}
///`write(|w| ..)` method takes [`pro_timer_int1_map::W`](W) writer structure
impl crate::Writable for PRO_TIMER_INT1_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_TIMER_INT1_MAP to value 0x10
