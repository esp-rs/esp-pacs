///Register `PRO_TG_WDT_EDGE_INT_MAP` reader
pub type R = crate::R<PRO_TG_WDT_EDGE_INT_MAP_SPEC>;
///Register `PRO_TG_WDT_EDGE_INT_MAP` writer
pub type W = crate::W<PRO_TG_WDT_EDGE_INT_MAP_SPEC>;
///Field `PRO_TG_WDT_EDGE_INT_MAP` reader - This register is used to map TG_WDT_EDGE_INT interrupt signal to one of the CPU interrupts.
pub type PRO_TG_WDT_EDGE_INT_MAP_R = crate::FieldReader;
///Field `PRO_TG_WDT_EDGE_INT_MAP` writer - This register is used to map TG_WDT_EDGE_INT interrupt signal to one of the CPU interrupts.
pub type PRO_TG_WDT_EDGE_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - This register is used to map TG_WDT_EDGE_INT interrupt signal to one of the CPU interrupts.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_TG_WDT_EDGE_INT_MAP")
            .field("pro_tg_wdt_edge_int_map", &self.pro_tg_wdt_edge_int_map())
            .finish()
    }
}
impl W {
    ...
    pub fn pro_tg_wdt_edge_int_map(
        &mut self,
    ) -> PRO_TG_WDT_EDGE_INT_MAP_W<PRO_TG_WDT_EDGE_INT_MAP_SPEC> {
        PRO_TG_WDT_EDGE_INT_MAP_W::new(self, 0)
    }
}
...
///`read()` method returns [`pro_tg_wdt_edge_int_map::R`](R) reader structure
impl crate::Readable for PRO_TG_WDT_EDGE_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`pro_tg_wdt_edge_int_map::W`](W) writer structure
impl crate::Writable for PRO_TG_WDT_EDGE_INT_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_TG_WDT_EDGE_INT_MAP to value 0x10
