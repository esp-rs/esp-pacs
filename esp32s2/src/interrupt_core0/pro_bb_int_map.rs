...
pub type PRO_BB_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_bb_int_map(&mut self) -> PRO_BB_INT_MAP_W<PRO_BB_INT_MAP_SPEC, 0> {
