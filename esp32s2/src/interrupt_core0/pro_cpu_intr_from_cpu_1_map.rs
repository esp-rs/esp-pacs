///Register `PRO_CPU_INTR_FROM_CPU_1_MAP` reader
pub type R = crate::R<PRO_CPU_INTR_FROM_CPU_1_MAP_SPEC>;
///Register `PRO_CPU_INTR_FROM_CPU_1_MAP` writer
pub type W = crate::W<PRO_CPU_INTR_FROM_CPU_1_MAP_SPEC>;
///Field `PRO_CPU_INTR_FROM_CPU_1_MAP` reader - This register is used to map CPU_INTR_FROM_CPU_1 interrupt signal to one of the CPU interrupts.
pub type PRO_CPU_INTR_FROM_CPU_1_MAP_R = crate::FieldReader;
///Field `PRO_CPU_INTR_FROM_CPU_1_MAP` writer - This register is used to map CPU_INTR_FROM_CPU_1 interrupt signal to one of the CPU interrupts.
pub type PRO_CPU_INTR_FROM_CPU_1_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - This register is used to map CPU_INTR_FROM_CPU_1 interrupt signal to one of the CPU interrupts.
    #[inline(always)]
...
///`read()` method returns [`pro_cpu_intr_from_cpu_1_map::R`](R) reader structure
impl crate::Readable for PRO_CPU_INTR_FROM_CPU_1_MAP_SPEC {}
///`write(|w| ..)` method takes [`pro_cpu_intr_from_cpu_1_map::W`](W) writer structure
impl crate::Writable for PRO_CPU_INTR_FROM_CPU_1_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_CPU_INTR_FROM_CPU_1_MAP to value 0x10
