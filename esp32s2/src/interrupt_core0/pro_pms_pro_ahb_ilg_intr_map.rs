///Register `PRO_PMS_PRO_AHB_ILG_INTR_MAP` reader
pub type R = crate::R<PRO_PMS_PRO_AHB_ILG_INTR_MAP_SPEC>;
///Register `PRO_PMS_PRO_AHB_ILG_INTR_MAP` writer
pub type W = crate::W<PRO_PMS_PRO_AHB_ILG_INTR_MAP_SPEC>;
///Field `PRO_PMS_PRO_AHB_ILG_INTR_MAP` reader - This register is used to map PMS_PRO_AHB_ILG interrupt signal to one of the CPU interrupts.
pub type PRO_PMS_PRO_AHB_ILG_INTR_MAP_R = crate::FieldReader;
///Field `PRO_PMS_PRO_AHB_ILG_INTR_MAP` writer - This register is used to map PMS_PRO_AHB_ILG interrupt signal to one of the CPU interrupts.
pub type PRO_PMS_PRO_AHB_ILG_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - This register is used to map PMS_PRO_AHB_ILG interrupt signal to one of the CPU interrupts.
    #[inline(always)]
...
///`read()` method returns [`pro_pms_pro_ahb_ilg_intr_map::R`](R) reader structure
impl crate::Readable for PRO_PMS_PRO_AHB_ILG_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`pro_pms_pro_ahb_ilg_intr_map::W`](W) writer structure
impl crate::Writable for PRO_PMS_PRO_AHB_ILG_INTR_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_PMS_PRO_AHB_ILG_INTR_MAP to value 0x10
