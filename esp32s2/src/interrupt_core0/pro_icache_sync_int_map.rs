...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_ICACHE_SYNC_INT_MAP")
            .field("pro_icache_sync_int_map", &self.pro_icache_sync_int_map())
            .finish()
    }
}
impl W {
    ...
    pub fn pro_icache_sync_int_map(
        &mut self,
    ) -> PRO_ICACHE_SYNC_INT_MAP_W<PRO_ICACHE_SYNC_INT_MAP_SPEC> {
        PRO_ICACHE_SYNC_INT_MAP_W::new(self, 0)
    }
}
#[doc = "ICACHE_SYNC_INT interrupt configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`pro_icache_sync_int_map::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pro_icache_sync_int_map::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
