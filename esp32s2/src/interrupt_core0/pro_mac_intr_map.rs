///Register `PRO_MAC_INTR_MAP` reader
pub type R = crate::R<PRO_MAC_INTR_MAP_SPEC>;
///Register `PRO_MAC_INTR_MAP` writer
pub type W = crate::W<PRO_MAC_INTR_MAP_SPEC>;
///Field `PRO_MAC_INTR_MAP` reader - This register is used to map MAC_INTR interrupt signal to one of the CPU interrupts.
pub type PRO_MAC_INTR_MAP_R = crate::FieldReader;
///Field `PRO_MAC_INTR_MAP` writer - This register is used to map MAC_INTR interrupt signal to one of the CPU interrupts.
pub type PRO_MAC_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - This register is used to map MAC_INTR interrupt signal to one of the CPU interrupts.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_MAC_INTR_MAP")
            .field("pro_mac_intr_map", &self.pro_mac_intr_map())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_mac_intr_map(&mut self) -> PRO_MAC_INTR_MAP_W<PRO_MAC_INTR_MAP_SPEC> {
        PRO_MAC_INTR_MAP_W::new(self, 0)
    }
}
...
///`read()` method returns [`pro_mac_intr_map::R`](R) reader structure
impl crate::Readable for PRO_MAC_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`pro_mac_intr_map::W`](W) writer structure
