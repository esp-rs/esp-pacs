...
pub struct R(crate::R<PRO_CPU_INTR_FROM_CPU_0_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_CPU_INTR_FROM_CPU_0_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_CPU_INTR_FROM_CPU_0_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_CPU_INTR_FROM_CPU_0_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_CPU_INTR_FROM_CPU_0_MAP` writer"]
pub struct W(crate::W<PRO_CPU_INTR_FROM_CPU_0_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_CPU_INTR_FROM_CPU_0_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_CPU_INTR_FROM_CPU_0_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_CPU_INTR_FROM_CPU_0_MAP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_CPU_INTR_FROM_CPU_0_MAP_R = crate::FieldReader<u8, u8>;
...
pub type PRO_CPU_INTR_FROM_CPU_0_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRO_CPU_INTR_FROM_CPU_0_MAP_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_cpu_intr_from_cpu_0_map(&mut self) -> PRO_CPU_INTR_FROM_CPU_0_MAP_W<0> {
