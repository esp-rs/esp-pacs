///Register `PRO_GPIO_INTERRUPT_APP_MAP` reader
pub type R = crate::R<PRO_GPIO_INTERRUPT_APP_MAP_SPEC>;
///Register `PRO_GPIO_INTERRUPT_APP_MAP` writer
pub type W = crate::W<PRO_GPIO_INTERRUPT_APP_MAP_SPEC>;
///Field `PRO_GPIO_INTERRUPT_APP_MAP` reader - This register is used to map GPIO_INTERRUPT_APP interrupt signal to one of the CPU interrupts.
pub type PRO_GPIO_INTERRUPT_APP_MAP_R = crate::FieldReader;
///Field `PRO_GPIO_INTERRUPT_APP_MAP` writer - This register is used to map GPIO_INTERRUPT_APP interrupt signal to one of the CPU interrupts.
pub type PRO_GPIO_INTERRUPT_APP_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - This register is used to map GPIO_INTERRUPT_APP interrupt signal to one of the CPU interrupts.
    #[inline(always)]
...
impl W {
    ...
    pub fn pro_gpio_interrupt_app_map(
        &mut self,
    ) -> PRO_GPIO_INTERRUPT_APP_MAP_W<PRO_GPIO_INTERRUPT_APP_MAP_SPEC> {
        PRO_GPIO_INTERRUPT_APP_MAP_W::new(self, 0)
    }
}
...
///`read()` method returns [`pro_gpio_interrupt_app_map::R`](R) reader structure
impl crate::Readable for PRO_GPIO_INTERRUPT_APP_MAP_SPEC {}
///`write(|w| ..)` method takes [`pro_gpio_interrupt_app_map::W`](W) writer structure
impl crate::Writable for PRO_GPIO_INTERRUPT_APP_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_GPIO_INTERRUPT_APP_MAP to value 0x10
