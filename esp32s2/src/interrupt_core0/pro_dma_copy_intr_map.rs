///Register `PRO_DMA_COPY_INTR_MAP` reader
pub type R = crate::R<PRO_DMA_COPY_INTR_MAP_SPEC>;
///Register `PRO_DMA_COPY_INTR_MAP` writer
pub type W = crate::W<PRO_DMA_COPY_INTR_MAP_SPEC>;
///Field `PRO_DMA_COPY_INTR_MAP` reader - This register is used to map DMA_COPY_INTR interrupt signal to one of the CPU interrupts.
pub type PRO_DMA_COPY_INTR_MAP_R = crate::FieldReader;
///Field `PRO_DMA_COPY_INTR_MAP` writer - This register is used to map DMA_COPY_INTR interrupt signal to one of the CPU interrupts.
pub type PRO_DMA_COPY_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - This register is used to map DMA_COPY_INTR interrupt signal to one of the CPU interrupts.
    #[inline(always)]
