...
pub type PRO_DMA_COPY_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_dma_copy_intr_map(
        &mut self,
    ) -> PRO_DMA_COPY_INTR_MAP_W<PRO_DMA_COPY_INTR_MAP_SPEC, 0> {
