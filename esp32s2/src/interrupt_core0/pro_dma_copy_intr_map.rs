...
pub struct R(crate::R<PRO_DMA_COPY_INTR_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_DMA_COPY_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_DMA_COPY_INTR_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_DMA_COPY_INTR_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_DMA_COPY_INTR_MAP` writer"]
pub struct W(crate::W<PRO_DMA_COPY_INTR_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_DMA_COPY_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_DMA_COPY_INTR_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_DMA_COPY_INTR_MAP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_DMA_COPY_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, PRO_DMA_COPY_INTR_MAP_SPEC, 5, O>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_DMA_COPY_INTR_MAP")
            .field(
                ...
                &format_args!("{}", self.pro_dma_copy_intr_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PRO_DMA_COPY_INTR_MAP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_dma_copy_intr_map(&mut self) -> PRO_DMA_COPY_INTR_MAP_W<0> {
        PRO_DMA_COPY_INTR_MAP_W::new(self)
    }
