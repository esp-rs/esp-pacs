...
pub type PRO_PMS_DMA_TX_I_ILG_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    pub fn pro_pms_dma_tx_i_ilg_intr_map(
        &mut self,
    ) -> PRO_PMS_DMA_TX_I_ILG_INTR_MAP_W<PRO_PMS_DMA_TX_I_ILG_INTR_MAP_SPEC, 0> {
