...
#[doc = "Field `PLAIN` reader - This register stores %sth 32-bit piece of plaintext."]
pub type PLAIN_R = crate::FieldReader<u32>;
#[doc = "Field `PLAIN` writer - This register stores %sth 32-bit piece of plaintext."]
pub type PLAIN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn plain(&mut self) -> PLAIN_W<PLAIN__SPEC, 0> {
        PLAIN_W::new(self)
    }
