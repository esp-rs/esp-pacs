...
#[doc = "Field `DESTROY` writer - Set to destroy encrypted result."]
pub type DESTROY_W<'a, const O: u8> = crate::BitWriter<'a, u32, DESTROY_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - Set to destroy encrypted result."]
    #[inline(always)]
