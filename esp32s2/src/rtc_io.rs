...
/**RTC_GPIO_OUT (rw) register accessor: RTC GPIO output register
...
/**RTC_GPIO_OUT_W1TS (w) register accessor: RTC GPIO output bit set register
...
/**RTC_GPIO_OUT_W1TC (w) register accessor: RTC GPIO output bit clear register
...
/**RTC_GPIO_ENABLE_W1TS (w) register accessor: RTC GPIO output enable bit set register
...
pub mod enable_w1tc;
/**RTC_GPIO_STATUS (rw) register accessor: RTC GPIO interrupt status register
...
/**RTC_GPIO_STATUS_W1TS (w) register accessor: RTC GPIO interrupt status bit set register
...
/**RTC_GPIO_STATUS_W1TC (w) register accessor: RTC GPIO interrupt status bit clear register
...
/**RTC_GPIO_IN (r) register accessor: RTC GPIO input register
