...
///
pub mod tick_conf;
/**CLK_OUT_EN (rw) register accessor:
...
/**EXT_MEM_PMS_LOCK (rw) register accessor:
...
/**FLASH_ACE0_ATTR (rw) register accessor:
...
/**FLASH_ACE1_ATTR (rw) register accessor:
...
/**FLASH_ACE2_ATTR (rw) register accessor:
...
/**FLASH_ACE3_ATTR (rw) register accessor:
...
/**FLASH_ACE0_ADDR (rw) register accessor:
...
/**FLASH_ACE1_ADDR (rw) register accessor:
...
/**FLASH_ACE2_ADDR (rw) register accessor:
...
/**FLASH_ACE3_ADDR (rw) register accessor:
...
/**FLASH_ACE0_SIZE (rw) register accessor:
...
/**FLASH_ACE1_SIZE (rw) register accessor:
...
/**FLASH_ACE2_SIZE (rw) register accessor:
...
/**FLASH_ACE3_SIZE (rw) register accessor:
...
/**SRAM_ACE0_ATTR (rw) register accessor:
...
/**SRAM_ACE1_ATTR (rw) register accessor:
...
/**SRAM_ACE2_ATTR (rw) register accessor:
...
/**SRAM_ACE3_ATTR (rw) register accessor:
...
/**SRAM_ACE0_ADDR (rw) register accessor:
...
/**SRAM_ACE1_ADDR (rw) register accessor:
...
/**SRAM_ACE2_ADDR (rw) register accessor:
...
/**SRAM_ACE3_ADDR (rw) register accessor:
...
/**SRAM_ACE0_SIZE (rw) register accessor:
...
/**SRAM_ACE1_SIZE (rw) register accessor:
...
/**SRAM_ACE2_SIZE (rw) register accessor:
...
/**SRAM_ACE3_SIZE (rw) register accessor:
...
/**SPI_MEM_PMS_CTRL (rw) register accessor:
...
/**SPI_MEM_REJECT_ADDR (r) register accessor:
...
/**SDIO_CTRL (rw) register accessor:
...
///
pub mod sdio_ctrl;
/**REDCY_SIG0 (rw) register accessor:
...
///
pub mod redcy_sig0;
/**REDCY_SIG1 (rw) register accessor:
...
///
pub mod wifi_clk_en;
/**WIFI_RST_EN (rw) register accessor:
