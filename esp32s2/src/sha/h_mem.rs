...
///Register `H_MEM%s` writer
pub type W = crate::W<H_MEM_SPEC>;
///Field `H` reader - Stores the %sth 32-bit piece of the Hash value.
pub type H_R = crate::FieldReader<u32>;
///Field `H` writer - Stores the %sth 32-bit piece of the Hash value.
...
///`write(|w| ..)` method takes [`h_mem::W`](W) writer structure
