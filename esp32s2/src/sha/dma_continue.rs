///Register `DMA_CONTINUE` writer
pub type W = crate::W<DMA_CONTINUE_SPEC>;
///Field `DMA_CONTINUE` writer - Write 1 to continue DMA-SHA calculation.
...
impl W {
    ///Bit 0 - Write 1 to continue DMA-SHA calculation.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`dma_continue::W`](W) writer structure
