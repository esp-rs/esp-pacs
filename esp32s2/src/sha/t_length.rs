///Register `T_LENGTH` reader
pub type R = crate::R<T_LENGTH_SPEC>;
///Register `T_LENGTH` writer
pub type W = crate::W<T_LENGTH_SPEC>;
///Field `T_LENGTH` reader - Defines t_length for calculating the initial Hash value for SHA-512/t.
pub type T_LENGTH_R = crate::FieldReader;
///Field `T_LENGTH` writer - Defines t_length for calculating the initial Hash value for SHA-512/t.
pub type T_LENGTH_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5 - Defines t_length for calculating the initial Hash value for SHA-512/t.
    #[inline(always)]
...
///`read()` method returns [`t_length::R`](R) reader structure
impl crate::Readable for T_LENGTH_SPEC {}
///`write(|w| ..)` method takes [`t_length::W`](W) writer structure
