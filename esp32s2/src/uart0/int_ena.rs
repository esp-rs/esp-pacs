...
///Field `RXFIFO_FULL` reader - This is the enable bit for UART_RXFIFO_FULL_INT.
pub type RXFIFO_FULL_R = crate::BitReader;
///Field `RXFIFO_FULL` writer - This is the enable bit for UART_RXFIFO_FULL_INT.
pub type RXFIFO_FULL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_EMPTY` reader - This is the enable bit for UART_TXFIFO_EMPTY_INT.
pub type TXFIFO_EMPTY_R = crate::BitReader;
///Field `TXFIFO_EMPTY` writer - This is the enable bit for UART_TXFIFO_EMPTY_INT.
pub type TXFIFO_EMPTY_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PARITY_ERR` reader - This is the enable bit for UART_PARITY_ERR_INT.
pub type PARITY_ERR_R = crate::BitReader;
///Field `PARITY_ERR` writer - This is the enable bit for UART_PARITY_ERR_INT.
pub type PARITY_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FRM_ERR` reader - This is the enable bit for UART_FRM_ERR_INT.
pub type FRM_ERR_R = crate::BitReader;
///Field `FRM_ERR` writer - This is the enable bit for UART_FRM_ERR_INT.
pub type FRM_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_OVF` reader - This is the enable bit for UART_RXFIFO_OVF_INT.
pub type RXFIFO_OVF_R = crate::BitReader;
///Field `RXFIFO_OVF` writer - This is the enable bit for UART_RXFIFO_OVF_INT.
pub type RXFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DSR_CHG` reader - This is the enable bit for UART_DSR_CHG_INT.
pub type DSR_CHG_R = crate::BitReader;
///Field `DSR_CHG` writer - This is the enable bit for UART_DSR_CHG_INT.
pub type DSR_CHG_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CTS_CHG` reader - This is the enable bit for UART_CTS_CHG_INT.
pub type CTS_CHG_R = crate::BitReader;
///Field `CTS_CHG` writer - This is the enable bit for UART_CTS_CHG_INT.
pub type CTS_CHG_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BRK_DET` reader - This is the enable bit for UART_BRK_DET_INT.
pub type BRK_DET_R = crate::BitReader;
///Field `BRK_DET` writer - This is the enable bit for UART_BRK_DET_INT.
pub type BRK_DET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_TOUT` reader - This is the enable bit for UART_RXFIFO_TOUT_INT.
pub type RXFIFO_TOUT_R = crate::BitReader;
///Field `RXFIFO_TOUT` writer - This is the enable bit for UART_RXFIFO_TOUT_INT.
pub type RXFIFO_TOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SW_XON` reader - This is the enable bit for UART_SW_XON_INT.
pub type SW_XON_R = crate::BitReader;
///Field `SW_XON` writer - This is the enable bit for UART_SW_XON_INT.
pub type SW_XON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SW_XOFF` reader - This is the enable bit for UART_SW_XOFF_INT.
pub type SW_XOFF_R = crate::BitReader;
///Field `SW_XOFF` writer - This is the enable bit for UART_SW_XOFF_INT.
pub type SW_XOFF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GLITCH_DET` reader - This is the enable bit for UART_GLITCH_DET_INT.
pub type GLITCH_DET_R = crate::BitReader;
///Field `GLITCH_DET` writer - This is the enable bit for UART_GLITCH_DET_INT.
pub type GLITCH_DET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_BRK_DONE` reader - This is the enable bit for UART_TX_BRK_DONE_INT.
pub type TX_BRK_DONE_R = crate::BitReader;
///Field `TX_BRK_DONE` writer - This is the enable bit for UART_TX_BRK_DONE_INT.
pub type TX_BRK_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_BRK_IDLE_DONE` reader - This is the enable bit for UART_TX_BRK_IDLE_DONE_INT.
pub type TX_BRK_IDLE_DONE_R = crate::BitReader;
///Field `TX_BRK_IDLE_DONE` writer - This is the enable bit for UART_TX_BRK_IDLE_DONE_INT.
pub type TX_BRK_IDLE_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_DONE` reader - This is the enable bit for UART_TX_DONE_INT.
pub type TX_DONE_R = crate::BitReader;
///Field `TX_DONE` writer - This is the enable bit for UART_TX_DONE_INT.
pub type TX_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RS485_PARITY_ERR` reader - This is the enable bit for UART_RS485_PARITY_ERR_INT.
pub type RS485_PARITY_ERR_R = crate::BitReader;
///Field `RS485_PARITY_ERR` writer - This is the enable bit for UART_RS485_PARITY_ERR_INT.
pub type RS485_PARITY_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RS485_FRM_ERR` reader - This is the enable bit for UART_RS485_PARITY_ERR_INT.
pub type RS485_FRM_ERR_R = crate::BitReader;
///Field `RS485_FRM_ERR` writer - This is the enable bit for UART_RS485_PARITY_ERR_INT.
pub type RS485_FRM_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RS485_CLASH` reader - This is the enable bit for UART_RS485_CLASH_INT.
pub type RS485_CLASH_R = crate::BitReader;
///Field `RS485_CLASH` writer - This is the enable bit for UART_RS485_CLASH_INT.
pub type RS485_CLASH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AT_CMD_CHAR_DET` reader - This is the enable bit for UART_AT_CMD_CHAR_DET_INT.
pub type AT_CMD_CHAR_DET_R = crate::BitReader;
///Field `AT_CMD_CHAR_DET` writer - This is the enable bit for UART_AT_CMD_CHAR_DET_INT.
pub type AT_CMD_CHAR_DET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WAKEUP` reader - This is the enable bit for UART_WAKEUP_INT.
pub type WAKEUP_R = crate::BitReader;
///Field `WAKEUP` writer - This is the enable bit for UART_WAKEUP_INT.
