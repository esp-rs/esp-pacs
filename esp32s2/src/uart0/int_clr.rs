...
pub type RS485_PARITY_ERR_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RS485_FRM_ERR_INT_CLR` writer - Set this bit to clear UART_RS485_FRM_ERR_INT interrupt."]
pub type RS485_FRM_ERR_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RS485_CLASH_INT_CLR` writer - Set this bit to clear UART_RS485_CLASH_INT interrupt."]
pub type RS485_CLASH_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rs485_parity_err_int_clr(&mut self) -> RS485_PARITY_ERR_INT_CLR_W<INT_CLR_SPEC, 15> {
        RS485_PARITY_ERR_INT_CLR_W::new(self)
    }
    #[doc = "Bit 16 - Set this bit to clear UART_RS485_FRM_ERR_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn rs485_frm_err_int_clr(&mut self) -> RS485_FRM_ERR_INT_CLR_W<INT_CLR_SPEC, 16> {
        RS485_FRM_ERR_INT_CLR_W::new(self)
    }
    #[doc = "Bit 17 - Set this bit to clear UART_RS485_CLASH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn rs485_clash_int_clr(&mut self) -> RS485_CLASH_INT_CLR_W<INT_CLR_SPEC, 17> {
