...
///Field `RXFIFO_FULL` writer - Set this bit to clear UART_THE RXFIFO_FULL_INT interrupt.
pub type RXFIFO_FULL_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TXFIFO_EMPTY` writer - Set this bit to clear UART_TXFIFO_EMPTY_INT interrupt.
pub type TXFIFO_EMPTY_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `PARITY_ERR` writer - Set this bit to clear UART_PARITY_ERR_INT interrupt.
pub type PARITY_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `FRM_ERR` writer - Set this bit to clear UART_FRM_ERR_INT interrupt.
pub type FRM_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `RXFIFO_OVF` writer - Set this bit to clear UART_UART_RXFIFO_OVF_INT interrupt.
pub type RXFIFO_OVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `DSR_CHG` writer - Set this bit to clear UART_DSR_CHG_INT interrupt.
pub type DSR_CHG_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `CTS_CHG` writer - Set this bit to clear UART_CTS_CHG_INT interrupt.
pub type CTS_CHG_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `BRK_DET` writer - Set this bit to clear UART_BRK_DET_INT interrupt.
pub type BRK_DET_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `RXFIFO_TOUT` writer - Set this bit to clear UART_RXFIFO_TOUT_INT interrupt.
pub type RXFIFO_TOUT_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `SW_XON` writer - Set this bit to clear UART_SW_XON_INT interrupt.
...
///Field `GLITCH_DET` writer - Set this bit to clear UART_GLITCH_DET_INT interrupt.
pub type GLITCH_DET_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TX_BRK_DONE` writer - Set this bit to clear UART_TX_BRK_DONE_INT interrupt.
pub type TX_BRK_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TX_BRK_IDLE_DONE` writer - Set this bit to clear UART_TX_BRK_IDLE_DONE_INT interrupt.
pub type TX_BRK_IDLE_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TX_DONE` writer - Set this bit to clear UART_TX_DONE_INT interrupt.
pub type TX_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `RS485_PARITY_ERR` writer - Set this bit to clear UART_RS485_PARITY_ERR_INT interrupt.
pub type RS485_PARITY_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `RS485_FRM_ERR` writer - Set this bit to clear UART_RS485_FRM_ERR_INT interrupt.
pub type RS485_FRM_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `RS485_CLASH` writer - Set this bit to clear UART_RS485_CLASH_INT interrupt.
pub type RS485_CLASH_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `AT_CMD_CHAR_DET` writer - Set this bit to clear UART_AT_CMD_CHAR_DET_INT interrupt.
pub type AT_CMD_CHAR_DET_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `WAKEUP` writer - Set this bit to clear UART_WAKEUP_INT interrupt.
