...
///Field `APB_RX_RADDR` reader - This register stores the offset address in RX_FIFO when software reads data from RX FIFO via APB.
pub type APB_RX_RADDR_R = crate::FieldReader<u16>;
///Field `RX_WADDR` reader - This register stores the offset address in RX FIFO when Rx_FIFO_Ctrl writes RX FIFO.
