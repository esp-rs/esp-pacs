...
///Field `RXFIFO_FULL_THRHD` reader - An UART_RXFIFO_FULL_INT interrupt is generated when the receiver receives more data than this register’s value.
pub type RXFIFO_FULL_THRHD_R = crate::FieldReader<u16>;
///Field `RXFIFO_FULL_THRHD` writer - An UART_RXFIFO_FULL_INT interrupt is generated when the receiver receives more data than this register’s value.
pub type RXFIFO_FULL_THRHD_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `TXFIFO_EMPTY_THRHD` reader - An UART_TXFIFO_EMPTY_INT interrupt is generated when the number of data bytes in TX FIFO is less than this register's value.
pub type TXFIFO_EMPTY_THRHD_R = crate::FieldReader<u16>;
///Field `TXFIFO_EMPTY_THRHD` writer - An UART_TXFIFO_EMPTY_INT interrupt is generated when the number of data bytes in TX FIFO is less than this register's value.
...
///Field `RX_FLOW_EN` reader - This is the flow enable bit for UART receiver. 1: Choose software flow control with configuring sw_rts signal. 0: Disable software flow control.
pub type RX_FLOW_EN_R = crate::BitReader;
///Field `RX_FLOW_EN` writer - This is the flow enable bit for UART receiver. 1: Choose software flow control with configuring sw_rts signal. 0: Disable software flow control.
pub type RX_FLOW_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_TOUT_EN` reader - This is the enable bit for UART receiver's timeout function.
pub type RX_TOUT_EN_R = crate::BitReader;
///Field `RX_TOUT_EN` writer - This is the enable bit for UART receiver's timeout function.
...
///`reset()` method sets CONF1 to value 0xc060
