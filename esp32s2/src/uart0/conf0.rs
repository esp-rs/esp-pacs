...
///Field `PARITY` reader - This register is used to configure the parity check mode. 0: even. 1: odd.
pub type PARITY_R = crate::BitReader;
///Field `PARITY` writer - This register is used to configure the parity check mode. 0: even. 1: odd.
...
///Field `BIT_NUM` reader - This register is used to set the length of data. 0: 5 bits. 1: 6 bits. 2: 7 bits. 3: 8 bits.
pub type BIT_NUM_R = crate::FieldReader;
///Field `BIT_NUM` writer - This register is used to set the length of data. 0: 5 bits. 1: 6 bits. 2: 7 bits. 3: 8 bits.
pub type BIT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `STOP_BIT_NUM` reader - This register is used to set the length of stop bit. 1: 1 bit. 2: 1.5 bits. 3: 2 bits.
pub type STOP_BIT_NUM_R = crate::FieldReader;
///Field `STOP_BIT_NUM` writer - This register is used to set the length of stop bit. 1: 1 bit. 2: 1.5 bits. 3: 2 bits.
...
///Field `TXD_BRK` reader - Set this bit to enable the transmitter to send NULL characters when the process of sending data is done.
pub type TXD_BRK_R = crate::BitReader;
///Field `TXD_BRK` writer - Set this bit to enable the transmitter to send NULL characters when the process of sending data is done.
...
///Field `IRDA_WCTL` reader - 1: The IrDA transmitter's 11th bit is the same as 10th bit. 0: Set IrDA transmitter's 11th bit to 0.
pub type IRDA_WCTL_R = crate::BitReader;
///Field `IRDA_WCTL` writer - 1: The IrDA transmitter's 11th bit is the same as 10th bit. 0: Set IrDA transmitter's 11th bit to 0.
...
///Field `TX_FLOW_EN` reader - Set this bit to enable flow control function for the transmitter.
pub type TX_FLOW_EN_R = crate::BitReader;
///Field `TX_FLOW_EN` writer - Set this bit to enable flow control function for the transmitter.
...
///Field `RXFIFO_RST` reader - Set this bit to reset the UART RX FIFO.
pub type RXFIFO_RST_R = crate::BitReader;
///Field `RXFIFO_RST` writer - Set this bit to reset the UART RX FIFO.
pub type RXFIFO_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_RST` reader - Set this bit to reset the UART TX FIFO.
pub type TXFIFO_RST_R = crate::BitReader;
///Field `TXFIFO_RST` writer - Set this bit to reset the UART TX FIFO.
pub type TXFIFO_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXD_INV` reader - Set this bit to invert the level of UART RXD signal.
pub type RXD_INV_R = crate::BitReader;
///Field `RXD_INV` writer - Set this bit to invert the level of UART RXD signal.
pub type RXD_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CTS_INV` reader - Set this bit to invert the level of UART CTS signal.
pub type CTS_INV_R = crate::BitReader;
///Field `CTS_INV` writer - Set this bit to invert the level of UART CTS signal.
pub type CTS_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DSR_INV` reader - Set this bit to invert the level of UART DSR signal.
pub type DSR_INV_R = crate::BitReader;
///Field `DSR_INV` writer - Set this bit to invert the level of UART DSR signal.
pub type DSR_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXD_INV` reader - Set this bit to invert the level of UART TXD signal.
pub type TXD_INV_R = crate::BitReader;
///Field `TXD_INV` writer - Set this bit to invert the level of UART TXD signal.
pub type TXD_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RTS_INV` reader - Set this bit to invert the level of UART RTS signal.
pub type RTS_INV_R = crate::BitReader;
///Field `RTS_INV` writer - Set this bit to invert the level of UART RTS signal.
pub type RTS_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DTR_INV` reader - Set this bit to invert the level of UART DTR signal.
pub type DTR_INV_R = crate::BitReader;
///Field `DTR_INV` writer - Set this bit to invert the level of UART DTR signal.
pub type DTR_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_EN` reader - 1: Force clock on for registers. 0: Support clock only when application writes registers.
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - 1: Force clock on for registers. 0: Support clock only when application writes registers.
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ERR_WR_MASK` reader - 1: The receiver stops storing data into FIFO when data is wrong. 0: The receiver stores the data even if the received data is wrong.
pub type ERR_WR_MASK_R = crate::BitReader;
///Field `ERR_WR_MASK` writer - 1: The receiver stops storing data into FIFO when data is wrong. 0: The receiver stores the data even if the received data is wrong.
pub type ERR_WR_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TICK_REF_ALWAYS_ON` reader - This register is used to select the clock. 1: APB_CLK. 0: REF_TICK.
pub type TICK_REF_ALWAYS_ON_R = crate::BitReader;
///Field `TICK_REF_ALWAYS_ON` writer - This register is used to select the clock. 1: APB_CLK. 0: REF_TICK.
pub type TICK_REF_ALWAYS_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_CLK_EN` reader - The signal to enable UART RAM clock gating. 1: UART RAM powers on, the data of which can be read and written. 0: UART RAM powers down.
pub type MEM_CLK_EN_R = crate::BitReader;
///Field `MEM_CLK_EN` writer - The signal to enable UART RAM clock gating. 1: UART RAM powers on, the data of which can be read and written. 0: UART RAM powers down.
...
///`reset()` method sets CONF0 to value 0x1800_001c
