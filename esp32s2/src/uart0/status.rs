...
///Field `RXFIFO_CNT` reader - Stores the number of valid data bytes in RX FIFO.
pub type RXFIFO_CNT_R = crate::FieldReader<u16>;
///Field `DSRN` reader - This register represents the level of the internal UART DSR signal.
pub type DSRN_R = crate::BitReader;
///Field `CTSN` reader - This register represents the level of the internal UART CTS signal.
pub type CTSN_R = crate::BitReader;
///Field `RXD` reader - This register represents the level of the internal UART RXD signal.
pub type RXD_R = crate::BitReader;
///Field `TXFIFO_CNT` reader - Stores the number of data bytes in TX FIFO.
