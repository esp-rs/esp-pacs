...
///Field `CLKDIV` reader - The integral part of the frequency divisor.
...
///Field `FRAG` reader - The fractional part of the frequency divisor.
pub type FRAG_R = crate::FieldReader;
///Field `FRAG` writer - The fractional part of the frequency divisor.
pub type FRAG_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bits 0:19 - The integral part of the frequency divisor.
    #[inline(always)]
