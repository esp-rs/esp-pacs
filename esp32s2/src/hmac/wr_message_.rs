///Register `WR_MESSAGE_%s` writer
pub type W = crate::W<WR_MESSAGE__SPEC>;
///Field `WDATA` writer - Store the %sth 32-bit of message.
...
impl W {
    ///Bits 0:31 - Store the %sth 32-bit of message.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`wr_message_::W`](W) writer structure
impl crate::Writable for WR_MESSAGE__SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets WR_MESSAGE_%s to value 0
