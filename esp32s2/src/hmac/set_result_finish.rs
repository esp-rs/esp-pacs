///Register `SET_RESULT_FINISH` writer
pub type W = crate::W<SET_RESULT_FINISH_SPEC>;
///Field `SET_RESULT_END` writer - Set this bit to end upstream and clear the calculation result.
...
impl W {
    ///Bit 0 - Set this bit to end upstream and clear the calculation result.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`set_result_finish::W`](W) writer structure
