///Register `SET_MESSAGE_ING` writer
pub type W = crate::W<SET_MESSAGE_ING_SPEC>;
///Field `SET_TEXT_ING` writer - Set this bit to show there are still some message blocks to be processed.
...
///`write(|w| ..)` method takes [`set_message_ing::W`](W) writer structure
