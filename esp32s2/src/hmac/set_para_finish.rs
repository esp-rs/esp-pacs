///Register `SET_PARA_FINISH` writer
pub type W = crate::W<SET_PARA_FINISH_SPEC>;
///Field `SET_PARA_END` writer - Set this bit to finish HMAC configuration.
...
impl W {
    ///Bit 0 - Set this bit to finish HMAC configuration.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`set_para_finish::W`](W) writer structure
