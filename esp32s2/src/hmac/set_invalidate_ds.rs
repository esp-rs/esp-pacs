///Register `SET_INVALIDATE_DS` writer
pub type W = crate::W<SET_INVALIDATE_DS_SPEC>;
///Field `SET_INVALIDATE_DS` writer - Set this bit to clear calculation results in DS function under downstream mode.
...
impl W {
    ///Bit 0 - Set this bit to clear calculation results in DS function under downstream mode.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`set_invalidate_ds::W`](W) writer structure
