///Register `SET_MESSAGE_PAD` writer
pub type W = crate::W<SET_MESSAGE_PAD_SPEC>;
///Field `SET_TEXT_PAD` writer - Set this bit to let software do padding job.
...
impl W {
    ///Bit 0 - Set this bit to let software do padding job.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`set_message_pad::W`](W) writer structure
