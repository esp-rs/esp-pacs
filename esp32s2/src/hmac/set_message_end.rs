...
///Field `SET_TEXT_END` writer - Set this bit to start hardware padding.
...
impl W {
    ///Bit 0 - Set this bit to start hardware padding.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`set_message_end::W`](W) writer structure
