///Register `SET_PARA_PURPOSE` writer
pub type W = crate::W<SET_PARA_PURPOSE_SPEC>;
///Field `PURPOSE_SET` writer - Set hmac purpose.
...
///`write(|w| ..)` method takes [`set_para_purpose::W`](W) writer structure
