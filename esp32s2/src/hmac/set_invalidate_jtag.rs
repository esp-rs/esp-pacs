///Register `SET_INVALIDATE_JTAG` writer
pub type W = crate::W<SET_INVALIDATE_JTAG_SPEC>;
///Field `SET_INVALIDATE_JTAG` writer - Set this bit to clear calculation results in JTAG re-enable function under downstream mode.
...
///`write(|w| ..)` method takes [`set_invalidate_jtag::W`](W) writer structure
