...
///`read()` method returns [`sram_ace1_attr::R`](R) reader structure
impl crate::Readable for SRAM_ACE1_ATTR_SPEC {}
///`write(|w| ..)` method takes [`sram_ace1_attr::W`](W) writer structure
impl crate::Writable for SRAM_ACE1_ATTR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SRAM_ACE1_ATTR to value 0x07
