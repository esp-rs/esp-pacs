...
#[doc = "Field `FLASH_ACE1_ATTR` reader - "]
pub type FLASH_ACE1_ATTR_R = crate::FieldReader;
#[doc = "Field `FLASH_ACE1_ATTR` writer - "]
pub type FLASH_ACE1_ATTR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
impl R {
    #[doc = "Bits 0:2"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flash_ace1_attr(&mut self) -> FLASH_ACE1_ATTR_W<FLASH_ACE1_ATTR_SPEC, 0> {
...
#[doc = "`reset()` method sets FLASH_ACE1_ATTR to value 0x07"]
