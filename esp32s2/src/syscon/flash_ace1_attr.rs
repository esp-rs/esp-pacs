///Register `FLASH_ACE1_ATTR` reader
pub type R = crate::R<FLASH_ACE1_ATTR_SPEC>;
///Register `FLASH_ACE1_ATTR` writer
pub type W = crate::W<FLASH_ACE1_ATTR_SPEC>;
///Field `FLASH_ACE1_ATTR` reader -
pub type FLASH_ACE1_ATTR_R = crate::FieldReader;
///Field `FLASH_ACE1_ATTR` writer -
pub type FLASH_ACE1_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2
    #[inline(always)]
    pub fn flash_ace1_attr(&self) -> FLASH_ACE1_ATTR_R {
        FLASH_ACE1_ATTR_R::new((self.bits & 7) as u8)
    }
}
...
///`read()` method returns [`flash_ace1_attr::R`](R) reader structure
impl crate::Readable for FLASH_ACE1_ATTR_SPEC {}
///`write(|w| ..)` method takes [`flash_ace1_attr::W`](W) writer structure
impl crate::Writable for FLASH_ACE1_ATTR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets FLASH_ACE1_ATTR to value 0x07
