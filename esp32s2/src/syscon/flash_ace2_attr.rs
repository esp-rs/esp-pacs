...
///Field `FLASH_ACE2_ATTR` reader -
pub type FLASH_ACE2_ATTR_R = crate::FieldReader;
///Field `FLASH_ACE2_ATTR` writer -
pub type FLASH_ACE2_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2
    #[inline(always)]
    pub fn flash_ace2_attr(&self) -> FLASH_ACE2_ATTR_R {
        FLASH_ACE2_ATTR_R::new((self.bits & 7) as u8)
    }
}
...
///`reset()` method sets FLASH_ACE2_ATTR to value 0x07
