...
#[doc = "Field `FLASH_ACE3_SIZE` reader - "]
pub type FLASH_ACE3_SIZE_R = crate::FieldReader<u16>;
#[doc = "Field `FLASH_ACE3_SIZE` writer - "]
pub type FLASH_ACE3_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`flash_ace3_size::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flash_ace3_size::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
