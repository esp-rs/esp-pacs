...
///`read()` method returns [`wifi_rst_en::R`](R) reader structure
impl crate::Readable for WIFI_RST_EN_SPEC {}
///`write(|w| ..)` method takes [`wifi_rst_en::W`](W) writer structure
impl crate::Writable for WIFI_RST_EN_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets WIFI_RST_EN to value 0xfffc_e030
