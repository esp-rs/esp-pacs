...
#[doc = "Field `WIFI_RST` reader - "]
pub type WIFI_RST_R = crate::FieldReader<u32>;
#[doc = "Field `WIFI_RST` writer - "]
pub type WIFI_RST_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wifi_rst(&mut self) -> WIFI_RST_W<WIFI_RST_EN_SPEC, 0> {
        WIFI_RST_W::new(self)
    }
...
#[doc = "`reset()` method sets WIFI_RST_EN to value 0xfffc_e030"]
