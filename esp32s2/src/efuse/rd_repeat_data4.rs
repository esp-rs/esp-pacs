...
///Field `RPT4_RESERVED4` reader - Reserved (used for four backups method).
pub type RPT4_RESERVED4_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:23 - Reserved (used for four backups method).
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA4")
            .field("rpt4_reserved4", &self.rpt4_reserved4())
            .finish()
    }
}
