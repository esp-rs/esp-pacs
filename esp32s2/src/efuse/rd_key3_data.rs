...
///Field `KEY3_DATA` reader - Stores the %sth 32 bits of KEY3.
pub type KEY3_DATA_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the %sth 32 bits of KEY3.
    #[inline(always)]
...
///`read()` method returns [`rd_key3_data::R`](R) reader structure
impl crate::Readable for RD_KEY3_DATA_SPEC {}
///`reset()` method sets RD_KEY3_DATA%s to value 0
