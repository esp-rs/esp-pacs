...
pub type PGM_DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PGM_DATA_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pgm_data(&mut self) -> PGM_DATA_W<PGM_DATA_SPEC, 0> {
        PGM_DATA_W::new(self)
    }
