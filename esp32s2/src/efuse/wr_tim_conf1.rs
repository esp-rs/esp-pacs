...
///Field `TSUP_A` reader - Configures the setup time of programming operation.
pub type TSUP_A_R = crate::FieldReader;
///Field `TSUP_A` writer - Configures the setup time of programming operation.
...
impl R {
    ///Bits 0:7 - Configures the setup time of programming operation.
    #[inline(always)]
...
///`reset()` method sets WR_TIM_CONF1 to value 0x0028_8001
