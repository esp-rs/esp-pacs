...
///Field `SYS_DATA_PART0_0` reader - Stores the zeroth part of the zeroth part of system data.
...
impl R {
    ...
    ///Bits 18:31 - Stores the zeroth part of the zeroth part of system data.
    #[inline(always)]
