...
///Field `RD_DIS` reader - Disables software reading from individual eFuse blocks (BLOCK4-10).
pub type RD_DIS_R = crate::FieldReader;
///Field `DIS_RTC_RAM_BOOT` reader - Reserved.
...
///Field `DIS_DCACHE` reader - Set this bit to disable Dcache.
pub type DIS_DCACHE_R = crate::BitReader;
///Field `DIS_DOWNLOAD_ICACHE` reader - Disables Icache when SoC is in Download mode.
pub type DIS_DOWNLOAD_ICACHE_R = crate::BitReader;
///Field `DIS_DOWNLOAD_DCACHE` reader - Disables Dcache when SoC is in Download mode.
...
///Field `DIS_USB` reader - Set this bit to disable USB OTG function.
pub type DIS_USB_R = crate::BitReader;
///Field `DIS_CAN` reader - Set this bit to disable the TWAI Controller function.
pub type DIS_CAN_R = crate::BitReader;
///Field `DIS_BOOT_REMAP` reader - Disables capability to Remap RAM to ROM address space.
pub type DIS_BOOT_REMAP_R = crate::BitReader;
///Field `RPT4_RESERVED5` reader - Reserved (used for four backups method).
pub type RPT4_RESERVED5_R = crate::BitReader;
///Field `SOFT_DIS_JTAG` reader - Software disables JTAG. When software disabled, JTAG can be activated temporarily by HMAC peripheral.
pub type SOFT_DIS_JTAG_R = crate::BitReader;
///Field `HARD_DIS_JTAG` reader - Hardware disables JTAG permanently.
pub type HARD_DIS_JTAG_R = crate::BitReader;
///Field `DIS_DOWNLOAD_MANUAL_ENCRYPT` reader - Disables flash encryption when in download boot modes.
...
///Field `EXT_PHY_ENABLE` reader - Set this bit to enable external USB PHY.
pub type EXT_PHY_ENABLE_R = crate::BitReader;
///Field `USB_FORCE_NOPERSIST` reader - If set, forces USB BVALID to 1.
pub type USB_FORCE_NOPERSIST_R = crate::BitReader;
///Field `RPT4_RESERVED0` reader - Reserved (used for four backups method).
pub type RPT4_RESERVED0_R = crate::FieldReader;
///Field `VDD_SPI_MODECURLIM` reader - SPI regulator switches current limit mode.
pub type VDD_SPI_MODECURLIM_R = crate::BitReader;
///Field `VDD_SPI_DREFH` reader - SPI regulator high voltage reference.
