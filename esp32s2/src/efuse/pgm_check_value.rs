...
///Register `PGM_CHECK_VALUE%s` writer
pub type W = crate::W<PGM_CHECK_VALUE_SPEC>;
///Field `PGM_RS_DATA` reader - The content of the %sth 32-bit RS code to be programmed.
pub type PGM_RS_DATA_R = crate::FieldReader<u32>;
///Field `PGM_RS_DATA` writer - The content of the %sth 32-bit RS code to be programmed.
...
///`read()` method returns [`pgm_check_value::R`](R) reader structure
impl crate::Readable for PGM_CHECK_VALUE_SPEC {}
///`write(|w| ..)` method takes [`pgm_check_value::W`](W) writer structure
impl crate::Writable for PGM_CHECK_VALUE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PGM_CHECK_VALUE%s to value 0
