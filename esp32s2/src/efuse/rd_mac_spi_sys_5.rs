...
///Field `SYS_DATA_PART0_2` reader - Stores the second part of the zeroth part of system data.
pub type SYS_DATA_PART0_2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the second part of the zeroth part of system data.
    #[inline(always)]
