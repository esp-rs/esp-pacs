...
///Field `DIS_DOWNLOAD_MODE_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_DOWNLOAD_MODE.
pub type DIS_DOWNLOAD_MODE_ERR_R = crate::BitReader;
///Field `DIS_LEGACY_SPI_BOOT_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_LEGACY_SPI_BOOT.
pub type DIS_LEGACY_SPI_BOOT_ERR_R = crate::BitReader;
///Field `UART_PRINT_CHANNEL_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_UART_PRINT_CHANNEL.
pub type UART_PRINT_CHANNEL_ERR_R = crate::BitReader;
///Field `RPT4_RESERVED3_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_RPT4_RESERVED3.
pub type RPT4_RESERVED3_ERR_R = crate::BitReader;
///Field `DIS_USB_DOWNLOAD_MODE_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_USB_DOWNLOAD_MODE.
pub type DIS_USB_DOWNLOAD_MODE_ERR_R = crate::BitReader;
///Field `ENABLE_SECURITY_DOWNLOAD_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_ENABLE_SECURITY_DOWNLOAD.
pub type ENABLE_SECURITY_DOWNLOAD_ERR_R = crate::BitReader;
///Field `UART_PRINT_CONTROL_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_UART_PRINT_CONTROL.
pub type UART_PRINT_CONTROL_ERR_R = crate::FieldReader;
///Field `PIN_POWER_SELECTION_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_PIN_POWER_SELECTION.
pub type PIN_POWER_SELECTION_ERR_R = crate::BitReader;
///Field `FLASH_TYPE_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_FLASH_TYPE.
pub type FLASH_TYPE_ERR_R = crate::BitReader;
///Field `FORCE_SEND_RESUME_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_FORCE_SEND_RESUME.
pub type FORCE_SEND_RESUME_ERR_R = crate::BitReader;
///Field `SECURE_VERSION_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_SECURE_VERSION.
pub type SECURE_VERSION_ERR_R = crate::FieldReader<u16>;
///Field `RPT4_RESERVED2_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_RPT4_RESERVED2.
pub type RPT4_RESERVED2_ERR_R = crate::FieldReader;
impl R {
    ///Bit 0 - Any bit equal to 1 denotes a programming error in EFUSE_DIS_DOWNLOAD_MODE.
    #[inline(always)]
    pub fn dis_download_mode_err(&self) -> DIS_DOWNLOAD_MODE_ERR_R {
        DIS_DOWNLOAD_MODE_ERR_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Any bit equal to 1 denotes a programming error in EFUSE_DIS_LEGACY_SPI_BOOT.
    #[inline(always)]
    pub fn dis_legacy_spi_boot_err(&self) -> DIS_LEGACY_SPI_BOOT_ERR_R {
        DIS_LEGACY_SPI_BOOT_ERR_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Any bit equal to 1 denotes a programming error in EFUSE_UART_PRINT_CHANNEL.
    #[inline(always)]
    pub fn uart_print_channel_err(&self) -> UART_PRINT_CHANNEL_ERR_R {
        UART_PRINT_CHANNEL_ERR_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Any bit equal to 1 denotes a programming error in EFUSE_RPT4_RESERVED3.
    #[inline(always)]
    pub fn rpt4_reserved3_err(&self) -> RPT4_RESERVED3_ERR_R {
        RPT4_RESERVED3_ERR_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Any bit equal to 1 denotes a programming error in EFUSE_DIS_USB_DOWNLOAD_MODE.
    #[inline(always)]
    pub fn dis_usb_download_mode_err(&self) -> DIS_USB_DOWNLOAD_MODE_ERR_R {
        DIS_USB_DOWNLOAD_MODE_ERR_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Any bit equal to 1 denotes a programming error in EFUSE_ENABLE_SECURITY_DOWNLOAD.
    #[inline(always)]
