...
///Field `SPI_PAD_CONF_0` reader - Stores the zeroth part of SPI_PAD_CONF.
...
impl R {
    ...
    ///Bits 16:31 - Stores the zeroth part of SPI_PAD_CONF.
    #[inline(always)]
...
///`read()` method returns [`rd_mac_spi_sys_1::R`](R) reader structure
