...
///Field `KEY2_DATA` reader - Stores the %sth 32 bits of KEY2.
pub type KEY2_DATA_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the %sth 32 bits of KEY2.
    #[inline(always)]
...
///`read()` method returns [`rd_key2_data::R`](R) reader structure
impl crate::Readable for RD_KEY2_DATA_SPEC {}
///`reset()` method sets RD_KEY2_DATA%s to value 0
