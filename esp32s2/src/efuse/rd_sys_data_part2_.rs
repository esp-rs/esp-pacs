...
///Field `SYS_DATA_PART2` reader - Stores the %sth 32 bits of the 2nd part of system data.
pub type SYS_DATA_PART2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the %sth 32 bits of the 2nd part of system data.
    #[inline(always)]
...
///`read()` method returns [`rd_sys_data_part2_::R`](R) reader structure
impl crate::Readable for RD_SYS_DATA_PART2__SPEC {}
///`reset()` method sets RD_SYS_DATA_PART2_%s to value 0
