...
///Field `RD_DIS_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_RD_DIS.
pub type RD_DIS_ERR_R = crate::FieldReader;
///Field `DIS_RTC_RAM_BOOT_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_RTC_RAM_BOOT.
pub type DIS_RTC_RAM_BOOT_ERR_R = crate::BitReader;
///Field `DIS_ICACHE_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_ICACHE.
pub type DIS_ICACHE_ERR_R = crate::BitReader;
///Field `DIS_DCACHE_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_DCACHE.
pub type DIS_DCACHE_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_ICACHE_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_DOWNLOAD_ICACHE.
pub type DIS_DOWNLOAD_ICACHE_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_DCACHE_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_DOWNLOAD_DCACHE.
pub type DIS_DOWNLOAD_DCACHE_ERR_R = crate::BitReader;
///Field `DIS_FORCE_DOWNLOAD_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_FORCE_DOWNLOAD.
pub type DIS_FORCE_DOWNLOAD_ERR_R = crate::BitReader;
///Field `DIS_USB_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_USB.
pub type DIS_USB_ERR_R = crate::BitReader;
///Field `DIS_CAN_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_CAN.
pub type DIS_CAN_ERR_R = crate::BitReader;
///Field `DIS_BOOT_REMAP_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_BOOT_REMAP.
pub type DIS_BOOT_REMAP_ERR_R = crate::BitReader;
///Field `RPT4_RESERVED5_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_RPT4_RESERVED5.
pub type RPT4_RESERVED5_ERR_R = crate::BitReader;
///Field `SOFT_DIS_JTAG_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_SOFT_DIS_JTAG.
pub type SOFT_DIS_JTAG_ERR_R = crate::BitReader;
///Field `HARD_DIS_JTAG_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_HARD_DIS_JTAG.
pub type HARD_DIS_JTAG_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_MANUAL_ENCRYPT_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_DIS_DOWNLOAD_MANUAL_ENCRYPT.
pub type DIS_DOWNLOAD_MANUAL_ENCRYPT_ERR_R = crate::BitReader;
///Field `USB_DREFH_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_USB_DREFH.
pub type USB_DREFH_ERR_R = crate::FieldReader;
///Field `USB_DREFL_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_USB_DREFL.
pub type USB_DREFL_ERR_R = crate::FieldReader;
///Field `USB_EXCHG_PINS_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_USB_EXCHG_PINS.
pub type USB_EXCHG_PINS_ERR_R = crate::BitReader;
///Field `EXT_PHY_ENABLE_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_EXT_PHY_ENABLE.
pub type EXT_PHY_ENABLE_ERR_R = crate::BitReader;
///Field `USB_FORCE_NOPERSIST_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_USB_FORCE_NOPERSIST.
pub type USB_FORCE_NOPERSIST_ERR_R = crate::BitReader;
///Field `RPT4_RESERVED0_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_RPT4_RESERVED0.
pub type RPT4_RESERVED0_ERR_R = crate::FieldReader;
///Field `VDD_SPI_MODECURLIM_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_VDD_SPI_MODECURLIM.
pub type VDD_SPI_MODECURLIM_ERR_R = crate::BitReader;
///Field `VDD_SPI_DREFH_ERR` reader - Any bit equal to 1 denotes a programming error in EFUSE_VDD_SPI_DREFH.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_ERR0")
            ...
            .field("dis_boot_remap_err", &self.dis_boot_remap_err())
            .field("rpt4_reserved5_err", &self.rpt4_reserved5_err())
            .field("soft_dis_jtag_err", &self.soft_dis_jtag_err())
            .field("hard_dis_jtag_err", &self.hard_dis_jtag_err())
            .field(
            ...
            .field("usb_force_nopersist_err", &self.usb_force_nopersist_err())
