...
///Field `KEY5_DATA` reader - Stores the %sth 32 bits of KEY5.
pub type KEY5_DATA_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the %sth 32 bits of KEY5.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_key5_data::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_KEY5_DATA_SPEC;
impl crate::RegisterSpec for RD_KEY5_DATA_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_key5_data::R`](R) reader structure
impl crate::Readable for RD_KEY5_DATA_SPEC {}
///`reset()` method sets RD_KEY5_DATA%s to value 0
