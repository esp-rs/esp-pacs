...
///Field `EFUSE_MEM_FORCE_PD` reader - If set, forces eFuse SRAM into power-saving mode.
pub type EFUSE_MEM_FORCE_PD_R = crate::BitReader;
///Field `EFUSE_MEM_FORCE_PD` writer - If set, forces eFuse SRAM into power-saving mode.
pub type EFUSE_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_CLK_FORCE_ON` reader - If set, forces to activate clock signal of eFuse SRAM.
pub type MEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `MEM_CLK_FORCE_ON` writer - If set, forces to activate clock signal of eFuse SRAM.
pub type MEM_CLK_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EFUSE_MEM_FORCE_PU` reader - If set, forces eFuse SRAM into working mode.
pub type EFUSE_MEM_FORCE_PU_R = crate::BitReader;
///Field `EFUSE_MEM_FORCE_PU` writer - If set, forces eFuse SRAM into working mode.
pub type EFUSE_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EN` reader - If set, forces to enable clock signal of eFuse memory.
pub type EN_R = crate::BitReader;
///Field `EN` writer - If set, forces to enable clock signal of eFuse memory.
...
impl R {
    ...
    ///Bit 16 - If set, forces to enable clock signal of eFuse memory.
    #[inline(always)]
    pub fn en(&self) -> EN_R {
