...
pub type DAC_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DAC_CONF_SPEC, u8, u8, 8, O>;
...
pub type OE_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DAC_CONF_SPEC, bool, O>;
impl R {
