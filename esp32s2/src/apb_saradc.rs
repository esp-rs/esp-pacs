...
/**CTRL (rw) register accessor: DIG ADC common configuration
...
pub mod ctrl;
/**CTRL2 (rw) register accessor: DIG ADC common configuration
...
///DIG ADC common configuration
pub mod ctrl2;
/**FSM (rw) register accessor: digital adc control register
...
pub mod fsm;
/**FSM_WAIT (rw) register accessor: configure saradc fsm internal parameter base on test
...
///configure saradc fsm internal parameter base on test
pub mod fsm_wait;
/**SAR1_STATUS (r) register accessor: digital adc1 status
...
///digital adc1 status
pub mod sar1_status;
/**SAR2_STATUS (r) register accessor: digital adc2 status
...
///digital adc2 status
pub mod sar2_status;
/**SAR1_PATT_TAB1 (rw) register accessor: item 0 ~ 3 for pattern table 1 (each item one byte)
...
/**SAR1_PATT_TAB2 (rw) register accessor: Item 4 ~ 7 for pattern table 1 (each item one byte)
...
/**SAR1_PATT_TAB3 (rw) register accessor: Item 8 ~ 11 for pattern table 1 (each item one byte)
...
/**SAR1_PATT_TAB4 (rw) register accessor: Item 12 ~ 15 for pattern table 1 (each item one byte)
...
/**SAR2_PATT_TAB1 (rw) register accessor: item 0 ~ 3 for pattern table 2 (each item one byte)
...
/**SAR2_PATT_TAB2 (rw) register accessor: Item 4 ~ 7 for pattern table 2 (each item one byte)
...
/**SAR2_PATT_TAB3 (rw) register accessor: Item 8 ~ 11 for pattern table 2 (each item one byte)
...
/**SAR2_PATT_TAB4 (rw) register accessor: Item 12 ~ 15 for pattern table 2 (each item one byte)
...
/**ARB_CTRL (rw) register accessor: Configure the settings of DIG ADC2 arbiter
...
///Configure the settings of DIG ADC2 arbiter
pub mod arb_ctrl;
/**FILTER_CTRL (rw) register accessor: Configure the settings of DIG ADC2 filter
...
pub mod filter_ctrl;
/**FILTER_STATUS (r) register accessor: Data status of DIG ADC2 filter
...
/**THRES_CTRL (rw) register accessor: Configure monitor threshold for DIG ADC2
...
pub mod thres_ctrl;
/**INT_ENA (rw) register accessor: Enable DIG ADC interrupts
...
pub mod int_ena;
/**INT_RAW (r) register accessor: DIG ADC interrupt raw bits
...
pub mod int_raw;
/**INT_ST (r) register accessor: DIG ADC interrupt status

You can [`read`](crate::generic::Reg::read) this register and get [`int_st::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).

For information about available fields see [`mod@int_st`] module*/
pub type INT_ST = crate::Reg<int_st::INT_ST_SPEC>;
///DIG ADC interrupt status
pub mod int_st;
/**INT_CLR (w) register accessor: Clear DIG ADC interrupts
...
pub mod int_clr;
/**DMA_CONF (rw) register accessor: Configure digital ADC DMA path
...
///Configure digital ADC DMA path
pub mod dma_conf;
/**CLKM_CONF (rw) register accessor: Configure DIG ADC clock
...
pub mod clkm_conf;
/**APB_DAC_CTRL (rw) register accessor: Configure DAC settings
...
/**CTRL_DATE (rw) register accessor: Version control register
