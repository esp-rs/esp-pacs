...
pub type PRO_ICACHE_PRELOAD_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `PRO_ICACHE_PRELOAD_INT_CLR` writer - The bit is used to clear the interrupt by icache pre-load done."]
pub type PRO_ICACHE_PRELOAD_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_DCACHE_PRELOAD_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `PRO_DCACHE_PRELOAD_INT_CLR` writer - The bit is used to clear the interrupt by dcache pre-load done."]
pub type PRO_DCACHE_PRELOAD_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn pro_icache_preload_int_ena(
        &mut self,
    ) -> PRO_ICACHE_PRELOAD_INT_ENA_W<CACHE_PRELOAD_INT_CTRL_SPEC, 1> {
    ...
    pub fn pro_icache_preload_int_clr(
        &mut self,
    ) -> PRO_ICACHE_PRELOAD_INT_CLR_W<CACHE_PRELOAD_INT_CTRL_SPEC, 2> {
    ...
    pub fn pro_dcache_preload_int_ena(
        &mut self,
    ) -> PRO_DCACHE_PRELOAD_INT_ENA_W<CACHE_PRELOAD_INT_CTRL_SPEC, 4> {
    ...
    pub fn pro_dcache_preload_int_clr(
        &mut self,
    ) -> PRO_DCACHE_PRELOAD_INT_CLR_W<CACHE_PRELOAD_INT_CTRL_SPEC, 5> {
