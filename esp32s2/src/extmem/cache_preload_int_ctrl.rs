...
///Field `PRO_ICACHE_PRELOAD_INT_ST` reader - The bit is used to indicate the interrupt by icache pre-load done.
pub type PRO_ICACHE_PRELOAD_INT_ST_R = crate::BitReader;
///Field `PRO_ICACHE_PRELOAD_INT_ENA` reader - The bit is used to enable the interrupt by icache pre-load done.
pub type PRO_ICACHE_PRELOAD_INT_ENA_R = crate::BitReader;
///Field `PRO_ICACHE_PRELOAD_INT_ENA` writer - The bit is used to enable the interrupt by icache pre-load done.
pub type PRO_ICACHE_PRELOAD_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_PRELOAD_INT_CLR` writer - The bit is used to clear the interrupt by icache pre-load done.
pub type PRO_ICACHE_PRELOAD_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DCACHE_PRELOAD_INT_ST` reader - The bit is used to indicate the interrupt by dcache pre-load done.
pub type PRO_DCACHE_PRELOAD_INT_ST_R = crate::BitReader;
///Field `PRO_DCACHE_PRELOAD_INT_ENA` reader - The bit is used to enable the interrupt by dcache pre-load done.
pub type PRO_DCACHE_PRELOAD_INT_ENA_R = crate::BitReader;
///Field `PRO_DCACHE_PRELOAD_INT_ENA` writer - The bit is used to enable the interrupt by dcache pre-load done.
pub type PRO_DCACHE_PRELOAD_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DCACHE_PRELOAD_INT_CLR` writer - The bit is used to clear the interrupt by dcache pre-load done.
