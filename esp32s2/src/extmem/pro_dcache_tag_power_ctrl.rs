...
impl W {
    ...
    pub fn pro_dcache_tag_mem_force_on(
        &mut self,
    ) -> PRO_DCACHE_TAG_MEM_FORCE_ON_W<'_, PRO_DCACHE_TAG_POWER_CTRL_SPEC> {
    ...
    pub fn pro_dcache_tag_mem_force_pd(
        &mut self,
    ) -> PRO_DCACHE_TAG_MEM_FORCE_PD_W<'_, PRO_DCACHE_TAG_POWER_CTRL_SPEC> {
    ...
    pub fn pro_dcache_tag_mem_force_pu(
        &mut self,
    ) -> PRO_DCACHE_TAG_MEM_FORCE_PU_W<'_, PRO_DCACHE_TAG_POWER_CTRL_SPEC> {
        PRO_DCACHE_TAG_MEM_FORCE_PU_W::new(self, 2)
    }
}
#[doc = "register description\n\nYou can [`read`](crate::Reg::read) this register and get [`pro_dcache_tag_power_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pro_dcache_tag_power_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
