...
///Register `PRO_DCACHE_TAG_POWER_CTRL` writer
pub type W = crate::W<PRO_DCACHE_TAG_POWER_CTRL_SPEC>;
///Field `PRO_DCACHE_TAG_MEM_FORCE_ON` reader - The bit is used to close clock gating of dcache tag memory. 1: close gating, 0: open clock gating.
pub type PRO_DCACHE_TAG_MEM_FORCE_ON_R = crate::BitReader;
///Field `PRO_DCACHE_TAG_MEM_FORCE_ON` writer - The bit is used to close clock gating of dcache tag memory. 1: close gating, 0: open clock gating.
pub type PRO_DCACHE_TAG_MEM_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DCACHE_TAG_MEM_FORCE_PD` reader - The bit is used to power dcache tag memory down, 0: follow rtc_lslp_pd, 1: power down
pub type PRO_DCACHE_TAG_MEM_FORCE_PD_R = crate::BitReader;
///Field `PRO_DCACHE_TAG_MEM_FORCE_PD` writer - The bit is used to power dcache tag memory down, 0: follow rtc_lslp_pd, 1: power down
pub type PRO_DCACHE_TAG_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DCACHE_TAG_MEM_FORCE_PU` reader - The bit is used to power dcache tag memory down, 0: follow rtc_lslp_pd, 1: power up
pub type PRO_DCACHE_TAG_MEM_FORCE_PU_R = crate::BitReader;
///Field `PRO_DCACHE_TAG_MEM_FORCE_PU` writer - The bit is used to power dcache tag memory down, 0: follow rtc_lslp_pd, 1: power up
...
impl R {
    ...
    ///Bit 2 - The bit is used to power dcache tag memory down, 0: follow rtc_lslp_pd, 1: power up
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_DCACHE_TAG_POWER_CTRL")
            .field(
                ...
                &self.pro_dcache_tag_mem_force_on(),
            )
            .field(
                "pro_dcache_tag_mem_force_pd",
                &self.pro_dcache_tag_mem_force_pd(),
            )
            .field(
                "pro_dcache_tag_mem_force_pu",
                &self.pro_dcache_tag_mem_force_pu(),
            )
            .finish()
    }
}
...
///`read()` method returns [`pro_dcache_tag_power_ctrl::R`](R) reader structure
impl crate::Readable for PRO_DCACHE_TAG_POWER_CTRL_SPEC {}
///`write(|w| ..)` method takes [`pro_dcache_tag_power_ctrl::W`](W) writer structure
impl crate::Writable for PRO_DCACHE_TAG_POWER_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_DCACHE_TAG_POWER_CTRL to value 0x05
