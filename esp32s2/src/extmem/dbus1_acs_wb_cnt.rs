...
///Field `DBUS1_ACS_WB_CNT` reader - The bits are used to count the number of cache evictions by dbus1 access cache.
pub type DBUS1_ACS_WB_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:19 - The bits are used to count the number of cache evictions by dbus1 access cache.
    #[inline(always)]
...
///`read()` method returns [`dbus1_acs_wb_cnt::R`](R) reader structure
impl crate::Readable for DBUS1_ACS_WB_CNT_SPEC {}
///`reset()` method sets DBUS1_ACS_WB_CNT to value 0
