...
///Field `CACHE_DBG_EN` reader - The bit is used to activate the cache track function. 1: enable, 0: disable.
pub type CACHE_DBG_EN_R = crate::BitReader;
///Field `CACHE_DBG_EN` writer - The bit is used to activate the cache track function. 1: enable, 0: disable.
pub type CACHE_DBG_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IBUS_ACS_MSK_IC_INT_ENA` reader - The bit is used to enable interrupt by cpu access icache while the corresponding ibus is disabled which include speculative access.
pub type IBUS_ACS_MSK_IC_INT_ENA_R = crate::BitReader;
///Field `IBUS_ACS_MSK_IC_INT_ENA` writer - The bit is used to enable interrupt by cpu access icache while the corresponding ibus is disabled which include speculative access.
pub type IBUS_ACS_MSK_IC_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IBUS_CNT_OVF_INT_ENA` reader - The bit is used to enable interrupt by ibus counter overflow.
pub type IBUS_CNT_OVF_INT_ENA_R = crate::BitReader;
///Field `IBUS_CNT_OVF_INT_ENA` writer - The bit is used to enable interrupt by ibus counter overflow.
pub type IBUS_CNT_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IC_SYNC_SIZE_FAULT_INT_ENA` reader - The bit is used to enable interrupt by manual sync configurations fault.
pub type IC_SYNC_SIZE_FAULT_INT_ENA_R = crate::BitReader;
///Field `IC_SYNC_SIZE_FAULT_INT_ENA` writer - The bit is used to enable interrupt by manual sync configurations fault.
pub type IC_SYNC_SIZE_FAULT_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IC_PRELOAD_SIZE_FAULT_INT_ENA` reader - The bit is used to enable interrupt by manual pre-load configurations fault.
pub type IC_PRELOAD_SIZE_FAULT_INT_ENA_R = crate::BitReader;
///Field `IC_PRELOAD_SIZE_FAULT_INT_ENA` writer - The bit is used to enable interrupt by manual pre-load configurations fault.
pub type IC_PRELOAD_SIZE_FAULT_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ICACHE_REJECT_INT_ENA` reader - The bit is used to enable interrupt by authentication fail.
pub type ICACHE_REJECT_INT_ENA_R = crate::BitReader;
///Field `ICACHE_REJECT_INT_ENA` writer - The bit is used to enable interrupt by authentication fail.
pub type ICACHE_REJECT_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ICACHE_SET_PRELOAD_ILG_INT_ENA` reader - The bit is used to enable interrupt by illegal writing preload registers of icache while icache is busy to issue lock,sync and pre-load operations.
pub type ICACHE_SET_PRELOAD_ILG_INT_ENA_R = crate::BitReader;
///Field `ICACHE_SET_PRELOAD_ILG_INT_ENA` writer - The bit is used to enable interrupt by illegal writing preload registers of icache while icache is busy to issue lock,sync and pre-load operations.
pub type ICACHE_SET_PRELOAD_ILG_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ICACHE_SET_SYNC_ILG_INT_ENA` reader - The bit is used to enable interrupt by illegal writing sync registers of icache while icache is busy to issue lock,sync and pre-load operations.
pub type ICACHE_SET_SYNC_ILG_INT_ENA_R = crate::BitReader;
///Field `ICACHE_SET_SYNC_ILG_INT_ENA` writer - The bit is used to enable interrupt by illegal writing sync registers of icache while icache is busy to issue lock,sync and pre-load operations.
pub type ICACHE_SET_SYNC_ILG_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ICACHE_SET_LOCK_ILG_INT_ENA` reader - The bit is used to enable interrupt by illegal writing lock registers of icache while icache is busy to issue lock,sync or pre-load operations.
pub type ICACHE_SET_LOCK_ILG_INT_ENA_R = crate::BitReader;
///Field `ICACHE_SET_LOCK_ILG_INT_ENA` writer - The bit is used to enable interrupt by illegal writing lock registers of icache while icache is busy to issue lock,sync or pre-load operations.
pub type ICACHE_SET_LOCK_ILG_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DBUS_ACS_MSK_DC_INT_ENA` reader - The bit is used to enable interrupt by cpu access dcache while the corresponding dbus is disabled which include speculative access.
pub type DBUS_ACS_MSK_DC_INT_ENA_R = crate::BitReader;
///Field `DBUS_ACS_MSK_DC_INT_ENA` writer - The bit is used to enable interrupt by cpu access dcache while the corresponding dbus is disabled which include speculative access.
pub type DBUS_ACS_MSK_DC_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DBUS_CNT_OVF_INT_ENA` reader - The bit is used to enable interrupt by dbus counter overflow.
pub type DBUS_CNT_OVF_INT_ENA_R = crate::BitReader;
///Field `DBUS_CNT_OVF_INT_ENA` writer - The bit is used to enable interrupt by dbus counter overflow.
pub type DBUS_CNT_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DC_SYNC_SIZE_FAULT_INT_ENA` reader - The bit is used to enable interrupt by manual sync configurations fault.
pub type DC_SYNC_SIZE_FAULT_INT_ENA_R = crate::BitReader;
///Field `DC_SYNC_SIZE_FAULT_INT_ENA` writer - The bit is used to enable interrupt by manual sync configurations fault.
pub type DC_SYNC_SIZE_FAULT_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DC_PRELOAD_SIZE_FAULT_INT_ENA` reader - The bit is used to enable interrupt by manual pre-load configurations fault.
pub type DC_PRELOAD_SIZE_FAULT_INT_ENA_R = crate::BitReader;
///Field `DC_PRELOAD_SIZE_FAULT_INT_ENA` writer - The bit is used to enable interrupt by manual pre-load configurations fault.
pub type DC_PRELOAD_SIZE_FAULT_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_WRITE_FLASH_INT_ENA` reader - The bit is used to enable interrupt by dcache trying to write flash.
pub type DCACHE_WRITE_FLASH_INT_ENA_R = crate::BitReader;
///Field `DCACHE_WRITE_FLASH_INT_ENA` writer - The bit is used to enable interrupt by dcache trying to write flash.
pub type DCACHE_WRITE_FLASH_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_REJECT_INT_ENA` reader - The bit is used to enable interrupt by authentication fail.
pub type DCACHE_REJECT_INT_ENA_R = crate::BitReader;
///Field `DCACHE_REJECT_INT_ENA` writer - The bit is used to enable interrupt by authentication fail.
pub type DCACHE_REJECT_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_SET_PRELOAD_ILG_INT_ENA` reader - The bit is used to enable interrupt by illegal writing preload registers of dcache while dcache is busy to issue lock,sync and pre-load operations.
pub type DCACHE_SET_PRELOAD_ILG_INT_ENA_R = crate::BitReader;
///Field `DCACHE_SET_PRELOAD_ILG_INT_ENA` writer - The bit is used to enable interrupt by illegal writing preload registers of dcache while dcache is busy to issue lock,sync and pre-load operations.
pub type DCACHE_SET_PRELOAD_ILG_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_SET_SYNC_ILG_INT_ENA` reader - The bit is used to enable interrupt by illegal writing sync registers of dcache while dcache is busy to issue lock,sync and pre-load operations.
pub type DCACHE_SET_SYNC_ILG_INT_ENA_R = crate::BitReader;
///Field `DCACHE_SET_SYNC_ILG_INT_ENA` writer - The bit is used to enable interrupt by illegal writing sync registers of dcache while dcache is busy to issue lock,sync and pre-load operations.
pub type DCACHE_SET_SYNC_ILG_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_SET_LOCK_ILG_INT_ENA` reader - The bit is used to enable interrupt by illegal writing lock registers of dcache while dcache is busy to issue lock,sync or pre-load operations.
pub type DCACHE_SET_LOCK_ILG_INT_ENA_R = crate::BitReader;
///Field `DCACHE_SET_LOCK_ILG_INT_ENA` writer - The bit is used to enable interrupt by illegal writing lock registers of dcache while dcache is busy to issue lock,sync or pre-load operations.
pub type DCACHE_SET_LOCK_ILG_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MMU_ENTRY_FAULT_INT_ENA` reader - The bit is used to enable interrupt by mmu entry fault.
pub type MMU_ENTRY_FAULT_INT_ENA_R = crate::BitReader;
///Field `MMU_ENTRY_FAULT_INT_ENA` writer - The bit is used to enable interrupt by mmu entry fault.
...
///`read()` method returns [`cache_dbg_int_ena::R`](R) reader structure
impl crate::Readable for CACHE_DBG_INT_ENA_SPEC {}
///`write(|w| ..)` method takes [`cache_dbg_int_ena::W`](W) writer structure
impl crate::Writable for CACHE_DBG_INT_ENA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CACHE_DBG_INT_ENA to value 0x01
