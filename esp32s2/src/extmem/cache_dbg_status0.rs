...
pub type R = crate::R<CACHE_DBG_STATUS0_SPEC>;
///Field `IBUS0_ACS_MSK_ICACHE_ST` reader - The bit is used to indicate interrupt by cpu access icache while the ibus0 is disabled or icache is disabled which include speculative access.
pub type IBUS0_ACS_MSK_ICACHE_ST_R = crate::BitReader;
///Field `IBUS1_ACS_MSK_ICACHE_ST` reader - The bit is used to indicate interrupt by cpu access icache while the ibus1 is disabled or icache is disabled which include speculative access.
pub type IBUS1_ACS_MSK_ICACHE_ST_R = crate::BitReader;
///Field `IBUS2_ACS_MSK_ICACHE_ST` reader - The bit is used to indicate interrupt by cpu access icache while the ibus2 is disabled or icache is disabled which include speculative access.
pub type IBUS2_ACS_MSK_ICACHE_ST_R = crate::BitReader;
///Field `IBUS0_ACS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by ibus0 counter overflow.
pub type IBUS0_ACS_CNT_OVF_ST_R = crate::BitReader;
///Field `IBUS1_ACS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by ibus1 counter overflow.
pub type IBUS1_ACS_CNT_OVF_ST_R = crate::BitReader;
///Field `IBUS2_ACS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by ibus2 counter overflow.
pub type IBUS2_ACS_CNT_OVF_ST_R = crate::BitReader;
///Field `IBUS0_ACS_MISS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by ibus0 miss counter overflow.
pub type IBUS0_ACS_MISS_CNT_OVF_ST_R = crate::BitReader;
///Field `IBUS1_ACS_MISS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by ibus1 miss counter overflow.
pub type IBUS1_ACS_MISS_CNT_OVF_ST_R = crate::BitReader;
///Field `IBUS2_ACS_MISS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by ibus2 miss counter overflow.
pub type IBUS2_ACS_MISS_CNT_OVF_ST_R = crate::BitReader;
///Field `IBUS0_ABANDON_CNT_OVF_ST` reader - The bit is used to indicate interrupt by ibus0 abandon counter overflow.
pub type IBUS0_ABANDON_CNT_OVF_ST_R = crate::BitReader;
///Field `IBUS1_ABANDON_CNT_OVF_ST` reader - The bit is used to indicate interrupt by ibus1 abandon counter overflow.
pub type IBUS1_ABANDON_CNT_OVF_ST_R = crate::BitReader;
///Field `IBUS2_ABANDON_CNT_OVF_ST` reader - The bit is used to indicate interrupt by ibus2 abandon counter overflow.
pub type IBUS2_ABANDON_CNT_OVF_ST_R = crate::BitReader;
///Field `IC_PRELOAD_MISS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by pre-load miss counter overflow.
pub type IC_PRELOAD_MISS_CNT_OVF_ST_R = crate::BitReader;
///Field `IC_PRELOAD_CNT_OVF_ST` reader - The bit is used to indicate interrupt by pre-load counter overflow.
pub type IC_PRELOAD_CNT_OVF_ST_R = crate::BitReader;
///Field `IC_SYNC_SIZE_FAULT_ST` reader - The bit is used to indicate interrupt by manual sync configurations fault.
pub type IC_SYNC_SIZE_FAULT_ST_R = crate::BitReader;
///Field `IC_PRELOAD_SIZE_FAULT_ST` reader - The bit is used to indicate interrupt by manual pre-load configurations fault.
pub type IC_PRELOAD_SIZE_FAULT_ST_R = crate::BitReader;
///Field `ICACHE_REJECT_ST` reader - The bit is used to indicate interrupt by authentication fail.
pub type ICACHE_REJECT_ST_R = crate::BitReader;
///Field `ICACHE_SET_PRELOAD_ILG_ST` reader - The bit is used to indicate interrupt by illegal writing preload registers of icache while icache is busy to issue lock,sync and pre-load operations.
pub type ICACHE_SET_PRELOAD_ILG_ST_R = crate::BitReader;
///Field `ICACHE_SET_SYNC_ILG_ST` reader - The bit is used to indicate interrupt by illegal writing sync registers of icache while icache is busy to issue lock,sync and pre-load operations.
pub type ICACHE_SET_SYNC_ILG_ST_R = crate::BitReader;
///Field `ICACHE_SET_LOCK_ILG_ST` reader - The bit is used to indicate interrupt by illegal writing lock registers of icache while icache is busy to issue lock,sync or pre-load operations.
...
///`read()` method returns [`cache_dbg_status0::R`](R) reader structure
impl crate::Readable for CACHE_DBG_STATUS0_SPEC {}
///`reset()` method sets CACHE_DBG_STATUS0 to value 0
