...
pub struct R(crate::R<PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_DCACHE_AUTOLOAD_SECTION0_ADDR` writer"]
pub struct W(crate::W<PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_DCACHE_AUTOLOAD_SCT0_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type PRO_DCACHE_AUTOLOAD_SCT0_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC, 32, O, u32, u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_DCACHE_AUTOLOAD_SECTION0_ADDR")
            .field(
                ...
                &format_args!("{}", self.pro_dcache_autoload_sct0_addr().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PRO_DCACHE_AUTOLOAD_SECTION0_ADDR_SPEC> {
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_autoload_section0_addr](index.html) module"]
