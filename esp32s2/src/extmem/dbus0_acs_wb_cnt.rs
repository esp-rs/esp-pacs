...
///Field `DBUS0_ACS_WB_CNT` reader - The bits are used to count the number of cache evictions by dbus0 access cache.
pub type DBUS0_ACS_WB_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:19 - The bits are used to count the number of cache evictions by dbus0 access cache.
    #[inline(always)]
...
///`read()` method returns [`dbus0_acs_wb_cnt::R`](R) reader structure
impl crate::Readable for DBUS0_ACS_WB_CNT_SPEC {}
///`reset()` method sets DBUS0_ACS_WB_CNT to value 0
