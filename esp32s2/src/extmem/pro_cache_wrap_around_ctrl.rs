...
///Register `PRO_CACHE_WRAP_AROUND_CTRL` writer
pub type W = crate::W<PRO_CACHE_WRAP_AROUND_CTRL_SPEC>;
///Field `PRO_CACHE_FLASH_WRAP_AROUND` reader - The bit is used to enable wrap around mode when read data from flash.
pub type PRO_CACHE_FLASH_WRAP_AROUND_R = crate::BitReader;
///Field `PRO_CACHE_FLASH_WRAP_AROUND` writer - The bit is used to enable wrap around mode when read data from flash.
pub type PRO_CACHE_FLASH_WRAP_AROUND_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_CACHE_SRAM_RD_WRAP_AROUND` reader - The bit is used to enable wrap around mode when read data from spiram.
pub type PRO_CACHE_SRAM_RD_WRAP_AROUND_R = crate::BitReader;
///Field `PRO_CACHE_SRAM_RD_WRAP_AROUND` writer - The bit is used to enable wrap around mode when read data from spiram.
...
///`read()` method returns [`pro_cache_wrap_around_ctrl::R`](R) reader structure
impl crate::Readable for PRO_CACHE_WRAP_AROUND_CTRL_SPEC {}
///`write(|w| ..)` method takes [`pro_cache_wrap_around_ctrl::W`](W) writer structure
impl crate::Writable for PRO_CACHE_WRAP_AROUND_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_CACHE_WRAP_AROUND_CTRL to value 0
