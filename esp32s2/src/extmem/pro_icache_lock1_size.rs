...
pub struct R(crate::R<PRO_ICACHE_LOCK1_SIZE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_ICACHE_LOCK1_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_ICACHE_LOCK1_SIZE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_ICACHE_LOCK1_SIZE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_ICACHE_LOCK1_SIZE` writer"]
pub struct W(crate::W<PRO_ICACHE_LOCK1_SIZE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_ICACHE_LOCK1_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_ICACHE_LOCK1_SIZE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_ICACHE_LOCK1_SIZE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_ICACHE_LOCK1_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, PRO_ICACHE_LOCK1_SIZE_SPEC, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_icache_lock1_size(&mut self) -> PRO_ICACHE_LOCK1_SIZE_W<0> {
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_icache_lock1_size](index.html) module"]
