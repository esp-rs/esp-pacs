...
pub type PRO_ICACHE_LOCK1_SIZE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_icache_lock1_size(
        &mut self,
    ) -> PRO_ICACHE_LOCK1_SIZE_W<PRO_ICACHE_LOCK1_SIZE_SPEC, 0> {
