...
///Field `DBUS0_ACS_MISS_CNT` reader - The bits are used to count the number of the cache miss caused by dbus0 access.
pub type DBUS0_ACS_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The bits are used to count the number of the cache miss caused by dbus0 access.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`dbus0_acs_miss_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DBUS0_ACS_MISS_CNT_SPEC;
impl crate::RegisterSpec for DBUS0_ACS_MISS_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dbus0_acs_miss_cnt::R`](R) reader structure
impl crate::Readable for DBUS0_ACS_MISS_CNT_SPEC {}
///`reset()` method sets DBUS0_ACS_MISS_CNT to value 0
