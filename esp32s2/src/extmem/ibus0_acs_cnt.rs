...
///Field `IBUS0_ACS_CNT` reader - The bits are used to count the number of ibus0 access icache.
pub type IBUS0_ACS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The bits are used to count the number of ibus0 access icache.
    #[inline(always)]
...
///`read()` method returns [`ibus0_acs_cnt::R`](R) reader structure
impl crate::Readable for IBUS0_ACS_CNT_SPEC {}
///`reset()` method sets IBUS0_ACS_CNT to value 0
