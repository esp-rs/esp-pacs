///Register `PRO_ICACHE_AUTOLOAD_SECTION1_SIZE` reader
pub type R = crate::R<PRO_ICACHE_AUTOLOAD_SECTION1_SIZE_SPEC>;
///Register `PRO_ICACHE_AUTOLOAD_SECTION1_SIZE` writer
pub type W = crate::W<PRO_ICACHE_AUTOLOAD_SECTION1_SIZE_SPEC>;
///Field `PRO_ICACHE_AUTOLOAD_SCT1_SIZE` reader - The bits are used to configure the length of the second section for conditional pre-load operation. It should be combined with pro_icache_autoload_sct1_ena.
pub type PRO_ICACHE_AUTOLOAD_SCT1_SIZE_R = crate::FieldReader<u32>;
///Field `PRO_ICACHE_AUTOLOAD_SCT1_SIZE` writer - The bits are used to configure the length of the second section for conditional pre-load operation. It should be combined with pro_icache_autoload_sct1_ena.
...
You can [`read`](crate::generic::Reg::read) this register and get [`pro_icache_autoload_section1_size::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pro_icache_autoload_section1_size::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PRO_ICACHE_AUTOLOAD_SECTION1_SIZE_SPEC;
impl crate::RegisterSpec for PRO_ICACHE_AUTOLOAD_SECTION1_SIZE_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pro_icache_autoload_section1_size::R`](R) reader structure
impl crate::Readable for PRO_ICACHE_AUTOLOAD_SECTION1_SIZE_SPEC {}
///`write(|w| ..)` method takes [`pro_icache_autoload_section1_size::W`](W) writer structure
impl crate::Writable for PRO_ICACHE_AUTOLOAD_SECTION1_SIZE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_ICACHE_AUTOLOAD_SECTION1_SIZE to value 0x8000
