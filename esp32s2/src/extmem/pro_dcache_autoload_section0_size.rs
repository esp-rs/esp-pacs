...
impl W {
    ...
    pub fn pro_dcache_autoload_sct0_size(
        &mut self,
    ) -> PRO_DCACHE_AUTOLOAD_SCT0_SIZE_W<'_, PRO_DCACHE_AUTOLOAD_SECTION0_SIZE_SPEC> {
        PRO_DCACHE_AUTOLOAD_SCT0_SIZE_W::new(self, 0)
    }
}
#[doc = "register description\n\nYou can [`read`](crate::Reg::read) this register and get [`pro_dcache_autoload_section0_size::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pro_dcache_autoload_section0_size::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
