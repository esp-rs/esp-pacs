...
///Field `IBUS2_ACS_CNT` reader - The bits are used to count the number of ibus2 access icache.
pub type IBUS2_ACS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The bits are used to count the number of ibus2 access icache.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`ibus2_acs_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IBUS2_ACS_CNT_SPEC;
impl crate::RegisterSpec for IBUS2_ACS_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`ibus2_acs_cnt::R`](R) reader structure
impl crate::Readable for IBUS2_ACS_CNT_SPEC {}
///`reset()` method sets IBUS2_ACS_CNT to value 0
