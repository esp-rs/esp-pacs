...
///Field `PRO_CACHE_MMU_FAULT_CONTENT` reader - The bits are used to indicate the content of mmu entry which cause mmu fault..
pub type PRO_CACHE_MMU_FAULT_CONTENT_R = crate::FieldReader<u32>;
///Field `PRO_CACHE_MMU_FAULT_CODE` reader - The bits are used to indicate the operations which cause mmu fault occurrence. 0: default, 1: cpu miss, 2: preload miss, 3: flush, 4: cpu miss evict recovery address, 5: load miss evict recovery address, 6: external dma tx, 7: external dma rx
...
You can [`read`](crate::generic::Reg::read) this register and get [`pro_cache_mmu_fault_content::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PRO_CACHE_MMU_FAULT_CONTENT_SPEC;
impl crate::RegisterSpec for PRO_CACHE_MMU_FAULT_CONTENT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pro_cache_mmu_fault_content::R`](R) reader structure
impl crate::Readable for PRO_CACHE_MMU_FAULT_CONTENT_SPEC {}
///`reset()` method sets PRO_CACHE_MMU_FAULT_CONTENT to value 0
