///Register `PRO_ICACHE_CTRL` reader
pub type R = crate::R<PRO_ICACHE_CTRL_SPEC>;
///Register `PRO_ICACHE_CTRL` writer
pub type W = crate::W<PRO_ICACHE_CTRL_SPEC>;
///Field `PRO_ICACHE_ENABLE` reader - The bit is used to activate the data cache. 0: disable, 1: enable
pub type PRO_ICACHE_ENABLE_R = crate::BitReader;
///Field `PRO_ICACHE_ENABLE` writer - The bit is used to activate the data cache. 0: disable, 1: enable
pub type PRO_ICACHE_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_SETSIZE_MODE` reader - The bit is used to configure cache memory size.0: 8KB, 1: 16KB
pub type PRO_ICACHE_SETSIZE_MODE_R = crate::BitReader;
///Field `PRO_ICACHE_SETSIZE_MODE` writer - The bit is used to configure cache memory size.0: 8KB, 1: 16KB
pub type PRO_ICACHE_SETSIZE_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_BLOCKSIZE_MODE` reader - The bit is used to configure cache block size.0: 16 bytes, 1: 32 bytes
pub type PRO_ICACHE_BLOCKSIZE_MODE_R = crate::BitReader;
///Field `PRO_ICACHE_BLOCKSIZE_MODE` writer - The bit is used to configure cache block size.0: 16 bytes, 1: 32 bytes
pub type PRO_ICACHE_BLOCKSIZE_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_INVALIDATE_ENA` reader - The bit is used to enable invalidate operation. It will be cleared by hardware after invalidate operation done.
pub type PRO_ICACHE_INVALIDATE_ENA_R = crate::BitReader;
///Field `PRO_ICACHE_INVALIDATE_ENA` writer - The bit is used to enable invalidate operation. It will be cleared by hardware after invalidate operation done.
pub type PRO_ICACHE_INVALIDATE_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_INVALIDATE_DONE` reader - The bit is used to indicate invalidate operation is finished.
pub type PRO_ICACHE_INVALIDATE_DONE_R = crate::BitReader;
///Field `PRO_ICACHE_LOCK0_EN` reader - The bit is used to enable pre-lock operation which is combined with PRO_ICACHE_LOCK0_ADDR_REG and PRO_ICACHE_LOCK0_SIZE_REG.
pub type PRO_ICACHE_LOCK0_EN_R = crate::BitReader;
///Field `PRO_ICACHE_LOCK0_EN` writer - The bit is used to enable pre-lock operation which is combined with PRO_ICACHE_LOCK0_ADDR_REG and PRO_ICACHE_LOCK0_SIZE_REG.
pub type PRO_ICACHE_LOCK0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_LOCK1_EN` reader - The bit is used to enable pre-lock operation which is combined with PRO_ICACHE_LOCK1_ADDR_REG and PRO_ICACHE_LOCK1_SIZE_REG.
pub type PRO_ICACHE_LOCK1_EN_R = crate::BitReader;
///Field `PRO_ICACHE_LOCK1_EN` writer - The bit is used to enable pre-lock operation which is combined with PRO_ICACHE_LOCK1_ADDR_REG and PRO_ICACHE_LOCK1_SIZE_REG.
pub type PRO_ICACHE_LOCK1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_AUTOLOAD_ENA` reader - The bit is used to enable and disable conditional-preload operation. It is combined with pre_dcache_autoload_done. 1: enable, 0: disable.
pub type PRO_ICACHE_AUTOLOAD_ENA_R = crate::BitReader;
///Field `PRO_ICACHE_AUTOLOAD_ENA` writer - The bit is used to enable and disable conditional-preload operation. It is combined with pre_dcache_autoload_done. 1: enable, 0: disable.
pub type PRO_ICACHE_AUTOLOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_AUTOLOAD_DONE` reader - The bit is used to indicate conditional-preload operation is finished.
pub type PRO_ICACHE_AUTOLOAD_DONE_R = crate::BitReader;
///Field `PRO_ICACHE_PRELOAD_ENA` reader - The bit is used to enable preload operation. It will be cleared by hardware after preload operation done.
pub type PRO_ICACHE_PRELOAD_ENA_R = crate::BitReader;
///Field `PRO_ICACHE_PRELOAD_ENA` writer - The bit is used to enable preload operation. It will be cleared by hardware after preload operation done.
pub type PRO_ICACHE_PRELOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_PRELOAD_DONE` reader - The bit is used to indicate preload operation is finished.
pub type PRO_ICACHE_PRELOAD_DONE_R = crate::BitReader;
///Field `PRO_ICACHE_UNLOCK_ENA` reader - The bit is used to enable unlock operation. It will be cleared by hardware after unlock operation done.
pub type PRO_ICACHE_UNLOCK_ENA_R = crate::BitReader;
///Field `PRO_ICACHE_UNLOCK_ENA` writer - The bit is used to enable unlock operation. It will be cleared by hardware after unlock operation done.
pub type PRO_ICACHE_UNLOCK_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_UNLOCK_DONE` reader - The bit is used to indicate unlock operation is finished.
pub type PRO_ICACHE_UNLOCK_DONE_R = crate::BitReader;
///Field `PRO_ICACHE_LOCK_ENA` reader - The bit is used to enable lock operation. It will be cleared by hardware after lock operation done.
pub type PRO_ICACHE_LOCK_ENA_R = crate::BitReader;
///Field `PRO_ICACHE_LOCK_ENA` writer - The bit is used to enable lock operation. It will be cleared by hardware after lock operation done.
pub type PRO_ICACHE_LOCK_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_LOCK_DONE` reader - The bit is used to indicate lock operation is finished.
...
You can [`read`](crate::generic::Reg::read) this register and get [`pro_icache_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pro_icache_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PRO_ICACHE_CTRL_SPEC;
impl crate::RegisterSpec for PRO_ICACHE_CTRL_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pro_icache_ctrl::R`](R) reader structure
impl crate::Readable for PRO_ICACHE_CTRL_SPEC {}
///`write(|w| ..)` method takes [`pro_icache_ctrl::W`](W) writer structure
impl crate::Writable for PRO_ICACHE_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_ICACHE_CTRL to value 0x0100
