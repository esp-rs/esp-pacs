...
pub struct R(crate::R<PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_DCACHE_AUTOLOAD_SECTION1_SIZE` writer"]
pub struct W(crate::W<PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_DCACHE_AUTOLOAD_SCT1_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRO_DCACHE_AUTOLOAD_SECTION1_SIZE_SPEC, u32, u32, 24, O>;
impl R {
    ...
    pub fn pro_dcache_autoload_sct1_size(&self) -> PRO_DCACHE_AUTOLOAD_SCT1_SIZE_R {
        PRO_DCACHE_AUTOLOAD_SCT1_SIZE_R::new((self.bits & 0x00ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:23 - The bits are used to configure the length of the second section for conditional pre-load operation. It should be combined with pro_dcache_autoload_sct1_ena."]
    #[inline(always)]
    pub fn pro_dcache_autoload_sct1_size(&mut self) -> PRO_DCACHE_AUTOLOAD_SCT1_SIZE_W<0> {
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_autoload_section1_size](index.html) module"]
