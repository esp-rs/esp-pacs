...
///Field `DBUS1_ACS_CNT` reader - The bits are used to count the number of dbus1 access dcache.
pub type DBUS1_ACS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The bits are used to count the number of dbus1 access dcache.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DBUS1_ACS_CNT")
            .field("dbus1_acs_cnt", &self.dbus1_acs_cnt())
            .finish()
    }
}
...
///`read()` method returns [`dbus1_acs_cnt::R`](R) reader structure
impl crate::Readable for DBUS1_ACS_CNT_SPEC {}
///`reset()` method sets DBUS1_ACS_CNT to value 0
