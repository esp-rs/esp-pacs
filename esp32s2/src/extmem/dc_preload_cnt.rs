...
pub struct R(crate::R<DC_PRELOAD_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DC_PRELOAD_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DC_PRELOAD_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DC_PRELOAD_CNT_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type DC_PRELOAD_CNT_R = crate::FieldReader<u16, u16>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DC_PRELOAD_CNT_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dc_preload_cnt](index.html) module"]
