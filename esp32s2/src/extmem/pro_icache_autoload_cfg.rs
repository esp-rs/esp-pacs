...
impl W {
    ...
    pub fn pro_icache_autoload_mode(
        &mut self,
    ) -> PRO_ICACHE_AUTOLOAD_MODE_W<'_, PRO_ICACHE_AUTOLOAD_CFG_SPEC> {
    ...
    pub fn pro_icache_autoload_step(
        &mut self,
    ) -> PRO_ICACHE_AUTOLOAD_STEP_W<'_, PRO_ICACHE_AUTOLOAD_CFG_SPEC> {
    ...
    pub fn pro_icache_autoload_rqst(
        &mut self,
    ) -> PRO_ICACHE_AUTOLOAD_RQST_W<'_, PRO_ICACHE_AUTOLOAD_CFG_SPEC> {
    ...
    pub fn pro_icache_autoload_size(
        &mut self,
    ) -> PRO_ICACHE_AUTOLOAD_SIZE_W<'_, PRO_ICACHE_AUTOLOAD_CFG_SPEC> {
    ...
    pub fn pro_icache_autoload_sct0_ena(
        &mut self,
    ) -> PRO_ICACHE_AUTOLOAD_SCT0_ENA_W<'_, PRO_ICACHE_AUTOLOAD_CFG_SPEC> {
    ...
    pub fn pro_icache_autoload_sct1_ena(
        &mut self,
    ) -> PRO_ICACHE_AUTOLOAD_SCT1_ENA_W<'_, PRO_ICACHE_AUTOLOAD_CFG_SPEC> {
