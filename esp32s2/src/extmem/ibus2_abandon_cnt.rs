...
///Field `IBUS2_ABANDON_CNT` reader - The bits are used to count the number of the abandoned ibus2 access.
...
///`read()` method returns [`ibus2_abandon_cnt::R`](R) reader structure
impl crate::Readable for IBUS2_ABANDON_CNT_SPEC {}
///`reset()` method sets IBUS2_ABANDON_CNT to value 0
