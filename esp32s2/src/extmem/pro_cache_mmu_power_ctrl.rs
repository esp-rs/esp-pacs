...
///Field `PRO_CACHE_MMU_MEM_FORCE_ON` reader - The bit is used to enable clock gating to save power when access mmu memory, 0: enable, 1: disable
pub type PRO_CACHE_MMU_MEM_FORCE_ON_R = crate::BitReader;
///Field `PRO_CACHE_MMU_MEM_FORCE_ON` writer - The bit is used to enable clock gating to save power when access mmu memory, 0: enable, 1: disable
pub type PRO_CACHE_MMU_MEM_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_CACHE_MMU_MEM_FORCE_PD` reader - The bit is used to power mmu memory down, 0: follow_rtc_lslp_pd, 1: power down
pub type PRO_CACHE_MMU_MEM_FORCE_PD_R = crate::BitReader;
///Field `PRO_CACHE_MMU_MEM_FORCE_PD` writer - The bit is used to power mmu memory down, 0: follow_rtc_lslp_pd, 1: power down
pub type PRO_CACHE_MMU_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_CACHE_MMU_MEM_FORCE_PU` reader - The bit is used to power mmu memory down, 0: follow_rtc_lslp_pd, 1: power up
pub type PRO_CACHE_MMU_MEM_FORCE_PU_R = crate::BitReader;
///Field `PRO_CACHE_MMU_MEM_FORCE_PU` writer - The bit is used to power mmu memory down, 0: follow_rtc_lslp_pd, 1: power up
...
///`read()` method returns [`pro_cache_mmu_power_ctrl::R`](R) reader structure
impl crate::Readable for PRO_CACHE_MMU_POWER_CTRL_SPEC {}
///`write(|w| ..)` method takes [`pro_cache_mmu_power_ctrl::W`](W) writer structure
impl crate::Writable for PRO_CACHE_MMU_POWER_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_CACHE_MMU_POWER_CTRL to value 0x05
