...
///Field `CLK_FORCE_ON_DB_ENCRYPT` reader - The bit is used to close clock gating of encrypt clock. 1: close gating, 0: open clock gating.
pub type CLK_FORCE_ON_DB_ENCRYPT_R = crate::BitReader;
///Field `CLK_FORCE_ON_DB_ENCRYPT` writer - The bit is used to close clock gating of encrypt clock. 1: close gating, 0: open clock gating.
pub type CLK_FORCE_ON_DB_ENCRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_FORCE_ON_G0CB_DECRYPT` reader - The bit is used to close clock gating of decrypt clock. 1: close gating, 0: open clock gating.
pub type CLK_FORCE_ON_G0CB_DECRYPT_R = crate::BitReader;
///Field `CLK_FORCE_ON_G0CB_DECRYPT` writer - The bit is used to close clock gating of decrypt clock. 1: close gating, 0: open clock gating.
pub type CLK_FORCE_ON_G0CB_DECRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_FORCE_ON_AUTOMATIC_ENCRYPT_DECRYPT` reader - The bit is used to close clock gating of encrypt and decrypt clock. 1: close gating, 0: open clock gating.
pub type CLK_FORCE_ON_AUTOMATIC_ENCRYPT_DECRYPT_R = crate::BitReader;
///Field `CLK_FORCE_ON_AUTOMATIC_ENCRYPT_DECRYPT` writer - The bit is used to close clock gating of encrypt and decrypt clock. 1: close gating, 0: open clock gating.
