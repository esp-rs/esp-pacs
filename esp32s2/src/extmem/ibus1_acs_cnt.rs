...
pub struct R(crate::R<IBUS1_ACS_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IBUS1_ACS_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IBUS1_ACS_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IBUS1_ACS_CNT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `IBUS1_ACS_CNT` reader - The bits are used to count the number of ibus1 access icache."]
pub type IBUS1_ACS_CNT_R = crate::FieldReader<u32, u32>;
impl R {
