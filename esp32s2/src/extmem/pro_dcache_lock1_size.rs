...
///Register `PRO_DCACHE_LOCK1_SIZE` writer
pub type W = crate::W<PRO_DCACHE_LOCK1_SIZE_SPEC>;
///Field `PRO_DCACHE_LOCK1_SIZE` reader - The bits are used to configure the second length of data locking, which is combined with PRO_DCACHE_LOCK1_ADDR_REG
pub type PRO_DCACHE_LOCK1_SIZE_R = crate::FieldReader<u16>;
///Field `PRO_DCACHE_LOCK1_SIZE` writer - The bits are used to configure the second length of data locking, which is combined with PRO_DCACHE_LOCK1_ADDR_REG
