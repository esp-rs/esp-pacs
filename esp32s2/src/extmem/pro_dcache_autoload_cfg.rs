...
///Register `PRO_DCACHE_AUTOLOAD_CFG` writer
pub type W = crate::W<PRO_DCACHE_AUTOLOAD_CFG_SPEC>;
///Field `PRO_DCACHE_AUTOLOAD_MODE` reader - Reserved.
pub type PRO_DCACHE_AUTOLOAD_MODE_R = crate::BitReader;
///Field `PRO_DCACHE_AUTOLOAD_MODE` writer - Reserved.
pub type PRO_DCACHE_AUTOLOAD_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DCACHE_AUTOLOAD_STEP` reader - Reserved.
pub type PRO_DCACHE_AUTOLOAD_STEP_R = crate::FieldReader;
///Field `PRO_DCACHE_AUTOLOAD_STEP` writer - Reserved.
pub type PRO_DCACHE_AUTOLOAD_STEP_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `PRO_DCACHE_AUTOLOAD_ORDER` reader - The bits are used to configure the direction of conditional pre-load operation. 1: descending, 0: ascending.
pub type PRO_DCACHE_AUTOLOAD_ORDER_R = crate::BitReader;
///Field `PRO_DCACHE_AUTOLOAD_ORDER` writer - The bits are used to configure the direction of conditional pre-load operation. 1: descending, 0: ascending.
pub type PRO_DCACHE_AUTOLOAD_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DCACHE_AUTOLOAD_RQST` reader - The bits are used to configure trigger conditions for conditional pre-load. 0/3: cache miss, 1: cache hit, 2: both cache miss and hit.
pub type PRO_DCACHE_AUTOLOAD_RQST_R = crate::FieldReader;
///Field `PRO_DCACHE_AUTOLOAD_RQST` writer - The bits are used to configure trigger conditions for conditional pre-load. 0/3: cache miss, 1: cache hit, 2: both cache miss and hit.
pub type PRO_DCACHE_AUTOLOAD_RQST_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `PRO_DCACHE_AUTOLOAD_SIZE` reader - The bits are used to configure the numbers of the cache block for the issuing conditional pre-load operation.
pub type PRO_DCACHE_AUTOLOAD_SIZE_R = crate::FieldReader;
///Field `PRO_DCACHE_AUTOLOAD_SIZE` writer - The bits are used to configure the numbers of the cache block for the issuing conditional pre-load operation.
pub type PRO_DCACHE_AUTOLOAD_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `PRO_DCACHE_AUTOLOAD_SCT0_ENA` reader - The bits are used to enable the second section for conditional pre-load operation.
pub type PRO_DCACHE_AUTOLOAD_SCT0_ENA_R = crate::BitReader;
///Field `PRO_DCACHE_AUTOLOAD_SCT0_ENA` writer - The bits are used to enable the second section for conditional pre-load operation.
pub type PRO_DCACHE_AUTOLOAD_SCT0_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DCACHE_AUTOLOAD_SCT1_ENA` reader - The bits are used to enable the first section for conditional pre-load operation.
pub type PRO_DCACHE_AUTOLOAD_SCT1_ENA_R = crate::BitReader;
///Field `PRO_DCACHE_AUTOLOAD_SCT1_ENA` writer - The bits are used to enable the first section for conditional pre-load operation.
...
///`read()` method returns [`pro_dcache_autoload_cfg::R`](R) reader structure
impl crate::Readable for PRO_DCACHE_AUTOLOAD_CFG_SPEC {}
///`write(|w| ..)` method takes [`pro_dcache_autoload_cfg::W`](W) writer structure
impl crate::Writable for PRO_DCACHE_AUTOLOAD_CFG_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_DCACHE_AUTOLOAD_CFG to value 0
