...
///Field `IBUS2_ACS_MISS_CNT` reader - The bits are used to count the number of the cache miss caused by ibus2 access.
pub type IBUS2_ACS_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The bits are used to count the number of the cache miss caused by ibus2 access.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IBUS2_ACS_MISS_CNT")
            .field("ibus2_acs_miss_cnt", &self.ibus2_acs_miss_cnt())
            .finish()
    }
}
...
///`read()` method returns [`ibus2_acs_miss_cnt::R`](R) reader structure
impl crate::Readable for IBUS2_ACS_MISS_CNT_SPEC {}
///`reset()` method sets IBUS2_ACS_MISS_CNT to value 0
