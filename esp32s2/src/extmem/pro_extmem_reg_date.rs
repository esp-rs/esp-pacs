///Register `PRO_EXTMEM_REG_DATE` reader
pub type R = crate::R<PRO_EXTMEM_REG_DATE_SPEC>;
///Register `PRO_EXTMEM_REG_DATE` writer
pub type W = crate::W<PRO_EXTMEM_REG_DATE_SPEC>;
///Field `PRO_EXTMEM_REG_DATE` reader - Reserved.
pub type PRO_EXTMEM_REG_DATE_R = crate::FieldReader<u32>;
///Field `PRO_EXTMEM_REG_DATE` writer - Reserved.
...
///`read()` method returns [`pro_extmem_reg_date::R`](R) reader structure
impl crate::Readable for PRO_EXTMEM_REG_DATE_SPEC {}
///`write(|w| ..)` method takes [`pro_extmem_reg_date::W`](W) writer structure
impl crate::Writable for PRO_EXTMEM_REG_DATE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_EXTMEM_REG_DATE to value 0x0190_4180
