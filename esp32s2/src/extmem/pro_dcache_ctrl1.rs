...
///Register `PRO_DCACHE_CTRL1` writer
pub type W = crate::W<PRO_DCACHE_CTRL1_SPEC>;
///Field `PRO_DCACHE_MASK_BUS0` reader - The bit is used to disable dbus0, 0: enable, 1: disable
pub type PRO_DCACHE_MASK_BUS0_R = crate::BitReader;
///Field `PRO_DCACHE_MASK_BUS0` writer - The bit is used to disable dbus0, 0: enable, 1: disable
pub type PRO_DCACHE_MASK_BUS0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DCACHE_MASK_BUS1` reader - The bit is used to disable dbus1, 0: enable, 1: disable
pub type PRO_DCACHE_MASK_BUS1_R = crate::BitReader;
///Field `PRO_DCACHE_MASK_BUS1` writer - The bit is used to disable dbus1, 0: enable, 1: disable
pub type PRO_DCACHE_MASK_BUS1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DCACHE_MASK_BUS2` reader - The bit is used to disable dbus2, 0: enable, 1: disable
pub type PRO_DCACHE_MASK_BUS2_R = crate::BitReader;
///Field `PRO_DCACHE_MASK_BUS2` writer - The bit is used to disable dbus2, 0: enable, 1: disable
...
///`read()` method returns [`pro_dcache_ctrl1::R`](R) reader structure
impl crate::Readable for PRO_DCACHE_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`pro_dcache_ctrl1::W`](W) writer structure
impl crate::Writable for PRO_DCACHE_CTRL1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_DCACHE_CTRL1 to value 0x07
