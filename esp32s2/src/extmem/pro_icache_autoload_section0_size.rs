///Register `PRO_ICACHE_AUTOLOAD_SECTION0_SIZE` reader
pub type R = crate::R<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>;
///Register `PRO_ICACHE_AUTOLOAD_SECTION0_SIZE` writer
pub type W = crate::W<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>;
///Field `PRO_ICACHE_AUTOLOAD_SCT0_SIZE` reader - The bits are used to configure the length of the first section for conditional pre-load operation. It should be combined with pro_icache_autoload_sct0_ena.
pub type PRO_ICACHE_AUTOLOAD_SCT0_SIZE_R = crate::FieldReader<u32>;
///Field `PRO_ICACHE_AUTOLOAD_SCT0_SIZE` writer - The bits are used to configure the length of the first section for conditional pre-load operation. It should be combined with pro_icache_autoload_sct0_ena.
pub type PRO_ICACHE_AUTOLOAD_SCT0_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    ///Bits 0:23 - The bits are used to configure the length of the first section for conditional pre-load operation. It should be combined with pro_icache_autoload_sct0_ena.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_ICACHE_AUTOLOAD_SECTION0_SIZE")
            .field(
                ...
                &self.pro_icache_autoload_sct0_size(),
            )
            .finish()
    }
}
...
///`read()` method returns [`pro_icache_autoload_section0_size::R`](R) reader structure
impl crate::Readable for PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC {}
///`write(|w| ..)` method takes [`pro_icache_autoload_section0_size::W`](W) writer structure
impl crate::Writable for PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_ICACHE_AUTOLOAD_SECTION0_SIZE to value 0x8000
