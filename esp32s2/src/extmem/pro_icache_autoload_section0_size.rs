...
pub struct R(crate::R<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_ICACHE_AUTOLOAD_SECTION0_SIZE` writer"]
pub struct W(crate::W<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_ICACHE_AUTOLOAD_SCT0_SIZE_R = crate::FieldReader<u32, u32>;
...
pub type PRO_ICACHE_AUTOLOAD_SCT0_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRO_ICACHE_AUTOLOAD_SECTION0_SIZE_SPEC, u32, u32, 24, O>;
impl R {
    ...
    pub fn pro_icache_autoload_sct0_size(&self) -> PRO_ICACHE_AUTOLOAD_SCT0_SIZE_R {
        PRO_ICACHE_AUTOLOAD_SCT0_SIZE_R::new((self.bits & 0x00ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:23 - The bits are used to configure the length of the first section for conditional pre-load operation. It should be combined with pro_icache_autoload_sct0_ena."]
    #[inline(always)]
    pub fn pro_icache_autoload_sct0_size(&mut self) -> PRO_ICACHE_AUTOLOAD_SCT0_SIZE_W<0> {
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_icache_autoload_section0_size](index.html) module"]
