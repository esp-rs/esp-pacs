...
pub type IBUS_ACS_MSK_IC_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IC_SYNC_SIZE_FAULT_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IC_PRELOAD_SIZE_FAULT_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ICACHE_REJECT_INT_CLR` writer - The bit is used to clear interrupt by authentication fail."]
pub type ICACHE_REJECT_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ICACHE_SET_ILG_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DBUS_ACS_MSK_DC_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DC_SYNC_SIZE_FAULT_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DC_PRELOAD_SIZE_FAULT_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `DCACHE_WRITE_FLASH_INT_CLR` writer - The bit is used to clear interrupt by dcache trying to write flash."]
pub type DCACHE_WRITE_FLASH_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `DCACHE_REJECT_INT_CLR` writer - The bit is used to clear interrupt by authentication fail."]
pub type DCACHE_REJECT_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_SET_ILG_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    pub fn ibus_acs_msk_ic_int_clr(
        &mut self,
    ) -> IBUS_ACS_MSK_IC_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 0> {
        IBUS_ACS_MSK_IC_INT_CLR_W::new(self)
    }
    #[doc = "Bit 1 - The bit is used to clear interrupt by ibus counter overflow."]
    #[inline(always)]
    #[must_use]
    pub fn ibus_cnt_ovf_int_clr(&mut self) -> IBUS_CNT_OVF_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 1> {
    ...
    pub fn ic_sync_size_fault_int_clr(
        &mut self,
    ) -> IC_SYNC_SIZE_FAULT_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 2> {
    ...
    pub fn ic_preload_size_fault_int_clr(
        &mut self,
    ) -> IC_PRELOAD_SIZE_FAULT_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 3> {
        IC_PRELOAD_SIZE_FAULT_INT_CLR_W::new(self)
    }
    #[doc = "Bit 4 - The bit is used to clear interrupt by authentication fail."]
    #[inline(always)]
    #[must_use]
    pub fn icache_reject_int_clr(&mut self) -> ICACHE_REJECT_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 4> {
    ...
    pub fn icache_set_ilg_int_clr(
        &mut self,
    ) -> ICACHE_SET_ILG_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 5> {
    ...
    pub fn dbus_acs_msk_dc_int_clr(
        &mut self,
    ) -> DBUS_ACS_MSK_DC_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 6> {
        DBUS_ACS_MSK_DC_INT_CLR_W::new(self)
    }
    #[doc = "Bit 7 - The bit is used to clear interrupt by dbus counter overflow."]
    #[inline(always)]
    #[must_use]
    pub fn dbus_cnt_ovf_int_clr(&mut self) -> DBUS_CNT_OVF_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 7> {
    ...
    pub fn dc_sync_size_fault_int_clr(
        &mut self,
    ) -> DC_SYNC_SIZE_FAULT_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 8> {
    ...
    pub fn dc_preload_size_fault_int_clr(
        &mut self,
    ) -> DC_PRELOAD_SIZE_FAULT_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 9> {
    ...
    pub fn dcache_write_flash_int_clr(
        &mut self,
    ) -> DCACHE_WRITE_FLASH_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 10> {
        DCACHE_WRITE_FLASH_INT_CLR_W::new(self)
    }
    #[doc = "Bit 11 - The bit is used to clear interrupt by authentication fail."]
    #[inline(always)]
    #[must_use]
    pub fn dcache_reject_int_clr(&mut self) -> DCACHE_REJECT_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 11> {
    ...
    pub fn dcache_set_ilg_int_clr(
        &mut self,
    ) -> DCACHE_SET_ILG_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 12> {
    ...
    pub fn mmu_entry_fault_int_clr(
        &mut self,
    ) -> MMU_ENTRY_FAULT_INT_CLR_W<CACHE_DBG_INT_CLR_SPEC, 13> {
