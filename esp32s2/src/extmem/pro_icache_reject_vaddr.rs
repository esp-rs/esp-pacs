///Register `PRO_ICACHE_REJECT_VADDR` reader
pub type R = crate::R<PRO_ICACHE_REJECT_VADDR_SPEC>;
///Field `PRO_ICACHE_CPU_VADDR` reader - The bits are used to indicate the virtual address of CPU access icache when authentication fail.
pub type PRO_ICACHE_CPU_VADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The bits are used to indicate the virtual address of CPU access icache when authentication fail.
    #[inline(always)]
...
///`read()` method returns [`pro_icache_reject_vaddr::R`](R) reader structure
impl crate::Readable for PRO_ICACHE_REJECT_VADDR_SPEC {}
///`reset()` method sets PRO_ICACHE_REJECT_VADDR to value 0
