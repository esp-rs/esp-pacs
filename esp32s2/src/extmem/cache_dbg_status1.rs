...
///Field `DBUS0_ACS_MSK_DCACHE_ST` reader - The bit is used to indicate interrupt by cpu access dcache while the dbus0 is disabled or dcache is disabled which include speculative access.
pub type DBUS0_ACS_MSK_DCACHE_ST_R = crate::BitReader;
///Field `DBUS1_ACS_MSK_DCACHE_ST` reader - The bit is used to indicate interrupt by cpu access dcache while the dbus1 is disabled or dcache is disabled which include speculative access.
pub type DBUS1_ACS_MSK_DCACHE_ST_R = crate::BitReader;
///Field `DBUS2_ACS_MSK_DCACHE_ST` reader - The bit is used to indicate interrupt by cpu access dcache while the dbus2 is disabled or dcache is disabled which include speculative access.
pub type DBUS2_ACS_MSK_DCACHE_ST_R = crate::BitReader;
///Field `DBUS0_ACS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus0 counter overflow.
pub type DBUS0_ACS_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS1_ACS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus1 counter overflow.
pub type DBUS1_ACS_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS2_ACS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus2 counter overflow.
pub type DBUS2_ACS_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS0_ACS_MISS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus0 miss counter overflow.
pub type DBUS0_ACS_MISS_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS1_ACS_MISS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus1 miss counter overflow.
pub type DBUS1_ACS_MISS_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS2_ACS_MISS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus2 miss counter overflow.
pub type DBUS2_ACS_MISS_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS0_ACS_WB_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus0 eviction counter overflow.
pub type DBUS0_ACS_WB_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS1_ACS_WB_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus1 eviction counter overflow.
pub type DBUS1_ACS_WB_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS2_ACS_WB_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus2 eviction counter overflow.
pub type DBUS2_ACS_WB_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS0_ABANDON_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus0 abandon counter overflow.
pub type DBUS0_ABANDON_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS1_ABANDON_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus1 abandon counter overflow.
pub type DBUS1_ABANDON_CNT_OVF_ST_R = crate::BitReader;
///Field `DBUS2_ABANDON_CNT_OVF_ST` reader - The bit is used to indicate interrupt by dbus2 abandon counter overflow.
pub type DBUS2_ABANDON_CNT_OVF_ST_R = crate::BitReader;
///Field `DC_PRELOAD_MISS_CNT_OVF_ST` reader - The bit is used to indicate interrupt by pre-load miss counter overflow.
pub type DC_PRELOAD_MISS_CNT_OVF_ST_R = crate::BitReader;
///Field `DC_PRELOAD_EVICT_CNT_OVF_ST` reader - The bit is used to indicate interrupt by pre-load eviction counter overflow.
pub type DC_PRELOAD_EVICT_CNT_OVF_ST_R = crate::BitReader;
///Field `DC_PRELOAD_CNT_OVF_ST` reader - The bit is used to indicate interrupt by pre-load counter overflow.
pub type DC_PRELOAD_CNT_OVF_ST_R = crate::BitReader;
///Field `DC_SYNC_SIZE_FAULT_ST` reader - The bit is used to indicate interrupt by manual sync configurations fault.
pub type DC_SYNC_SIZE_FAULT_ST_R = crate::BitReader;
///Field `DC_PRELOAD_SIZE_FAULT_ST` reader - The bit is used to indicate interrupt by manual pre-load configurations fault.
pub type DC_PRELOAD_SIZE_FAULT_ST_R = crate::BitReader;
///Field `DCACHE_WRITE_FLASH_ST` reader - The bit is used to indicate interrupt by dcache trying to write flash.
pub type DCACHE_WRITE_FLASH_ST_R = crate::BitReader;
///Field `DCACHE_REJECT_ST` reader - The bit is used to indicate interrupt by authentication fail.
pub type DCACHE_REJECT_ST_R = crate::BitReader;
///Field `DCACHE_SET_PRELOAD_ILG_ST` reader - The bit is used to indicate interrupt by illegal writing preload registers of icache while icache is busy to issue lock,sync and pre-load operations.
pub type DCACHE_SET_PRELOAD_ILG_ST_R = crate::BitReader;
///Field `DCACHE_SET_SYNC_ILG_ST` reader - The bit is used to indicate interrupt by illegal writing sync registers of icache while icache is busy to issue lock,sync and pre-load operations.
pub type DCACHE_SET_SYNC_ILG_ST_R = crate::BitReader;
///Field `DCACHE_SET_LOCK_ILG_ST` reader - The bit is used to indicate interrupt by illegal writing lock registers of icache while icache is busy to issue lock,sync or pre-load operations.
pub type DCACHE_SET_LOCK_ILG_ST_R = crate::BitReader;
///Field `MMU_ENTRY_FAULT_ST` reader - The bit is used to indicate interrupt by mmu entry fault.
...
///`read()` method returns [`cache_dbg_status1::R`](R) reader structure
impl crate::Readable for CACHE_DBG_STATUS1_SPEC {}
///`reset()` method sets CACHE_DBG_STATUS1 to value 0
