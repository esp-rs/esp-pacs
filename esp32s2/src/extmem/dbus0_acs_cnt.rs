...
///Field `DBUS0_ACS_CNT` reader - The bits are used to count the number of dbus0 access dcache.
pub type DBUS0_ACS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The bits are used to count the number of dbus0 access dcache.
    #[inline(always)]
...
///`read()` method returns [`dbus0_acs_cnt::R`](R) reader structure
impl crate::Readable for DBUS0_ACS_CNT_SPEC {}
///`reset()` method sets DBUS0_ACS_CNT to value 0
