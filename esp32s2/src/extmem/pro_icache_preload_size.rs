...
pub struct R(crate::R<PRO_ICACHE_PRELOAD_SIZE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_ICACHE_PRELOAD_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_ICACHE_PRELOAD_SIZE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_ICACHE_PRELOAD_SIZE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_ICACHE_PRELOAD_SIZE` writer"]
pub struct W(crate::W<PRO_ICACHE_PRELOAD_SIZE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_ICACHE_PRELOAD_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_ICACHE_PRELOAD_SIZE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_ICACHE_PRELOAD_SIZE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_ICACHE_PRELOAD_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRO_ICACHE_PRELOAD_SIZE_SPEC, u16, u16, 10, O>;
...
pub type PRO_ICACHE_PRELOAD_ORDER_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRO_ICACHE_PRELOAD_SIZE_SPEC, bool, O>;
impl R {
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_icache_preload_size](index.html) module"]
