///Register `PRO_ICACHE_CTRL1` reader
pub type R = crate::R<PRO_ICACHE_CTRL1_SPEC>;
///Register `PRO_ICACHE_CTRL1` writer
pub type W = crate::W<PRO_ICACHE_CTRL1_SPEC>;
///Field `PRO_ICACHE_MASK_BUS0` reader - The bit is used to disable ibus0, 0: enable, 1: disable
pub type PRO_ICACHE_MASK_BUS0_R = crate::BitReader;
///Field `PRO_ICACHE_MASK_BUS0` writer - The bit is used to disable ibus0, 0: enable, 1: disable
pub type PRO_ICACHE_MASK_BUS0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_MASK_BUS1` reader - The bit is used to disable ibus1, 0: enable, 1: disable
pub type PRO_ICACHE_MASK_BUS1_R = crate::BitReader;
///Field `PRO_ICACHE_MASK_BUS1` writer - The bit is used to disable ibus1, 0: enable, 1: disable
pub type PRO_ICACHE_MASK_BUS1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_ICACHE_MASK_BUS2` reader - The bit is used to disable ibus2, 0: enable, 1: disable
pub type PRO_ICACHE_MASK_BUS2_R = crate::BitReader;
///Field `PRO_ICACHE_MASK_BUS2` writer - The bit is used to disable ibus2, 0: enable, 1: disable
pub type PRO_ICACHE_MASK_BUS2_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - The bit is used to disable ibus0, 0: enable, 1: disable
    #[inline(always)]
    pub fn pro_icache_mask_bus0(&self) -> PRO_ICACHE_MASK_BUS0_R {
        PRO_ICACHE_MASK_BUS0_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit is used to disable ibus1, 0: enable, 1: disable
    #[inline(always)]
    pub fn pro_icache_mask_bus1(&self) -> PRO_ICACHE_MASK_BUS1_R {
        PRO_ICACHE_MASK_BUS1_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - The bit is used to disable ibus2, 0: enable, 1: disable
    #[inline(always)]
...
///`read()` method returns [`pro_icache_ctrl1::R`](R) reader structure
impl crate::Readable for PRO_ICACHE_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`pro_icache_ctrl1::W`](W) writer structure
impl crate::Writable for PRO_ICACHE_CTRL1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_ICACHE_CTRL1 to value 0x07
