...
pub struct R(crate::R<PRO_ICACHE_LOCK0_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_ICACHE_LOCK0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_ICACHE_LOCK0_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_ICACHE_LOCK0_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_ICACHE_LOCK0_ADDR` writer"]
pub struct W(crate::W<PRO_ICACHE_LOCK0_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_ICACHE_LOCK0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_ICACHE_LOCK0_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_ICACHE_LOCK0_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_ICACHE_LOCK0_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type PRO_ICACHE_LOCK0_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, PRO_ICACHE_LOCK0_ADDR_SPEC, 32, O, u32, u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_ICACHE_LOCK0_ADDR")
            .field(
                ...
                &format_args!("{}", self.pro_icache_lock0_addr().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_icache_lock0_addr(&mut self) -> PRO_ICACHE_LOCK0_ADDR_W<0> {
        PRO_ICACHE_LOCK0_ADDR_W::new(self)
    }
