///Register `PRO_ICACHE_LOCK0_ADDR` reader
pub type R = crate::R<PRO_ICACHE_LOCK0_ADDR_SPEC>;
///Register `PRO_ICACHE_LOCK0_ADDR` writer
pub type W = crate::W<PRO_ICACHE_LOCK0_ADDR_SPEC>;
///Field `PRO_ICACHE_LOCK0_ADDR` reader - The bits are used to configure the first start virtual address of data locking, which is combined with PRO_ICACHE_LOCK0_SIZE_REG
pub type PRO_ICACHE_LOCK0_ADDR_R = crate::FieldReader<u32>;
///Field `PRO_ICACHE_LOCK0_ADDR` writer - The bits are used to configure the first start virtual address of data locking, which is combined with PRO_ICACHE_LOCK0_SIZE_REG
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_ICACHE_LOCK0_ADDR")
            .field("pro_icache_lock0_addr", &self.pro_icache_lock0_addr())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pro_icache_lock0_addr::R`](R) reader structure
impl crate::Readable for PRO_ICACHE_LOCK0_ADDR_SPEC {}
///`write(|w| ..)` method takes [`pro_icache_lock0_addr::W`](W) writer structure
impl crate::Writable for PRO_ICACHE_LOCK0_ADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_ICACHE_LOCK0_ADDR to value 0
