...
///Field `DBUS1_ABANDON_CNT` reader - The bits are used to count the number of the abandoned dbus1 access.
pub type DBUS1_ABANDON_CNT_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - The bits are used to count the number of the abandoned dbus1 access.
    #[inline(always)]
...
///`read()` method returns [`dbus1_abandon_cnt::R`](R) reader structure
impl crate::Readable for DBUS1_ABANDON_CNT_SPEC {}
///`reset()` method sets DBUS1_ABANDON_CNT to value 0
