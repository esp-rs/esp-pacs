...
pub type PRO_DCACHE_AUTOLOAD_SCT1_ADDR_W<'a, REG, const O: u8> =
...
impl W {
    ...
    pub fn pro_dcache_autoload_sct1_addr(
        &mut self,
    ) -> PRO_DCACHE_AUTOLOAD_SCT1_ADDR_W<PRO_DCACHE_AUTOLOAD_SECTION1_ADDR_SPEC, 0> {
        PRO_DCACHE_AUTOLOAD_SCT1_ADDR_W::new(self)
    }
