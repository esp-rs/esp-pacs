...
pub type PRO_DCACHE_AUTOLOAD_SCT1_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type PRO_DCACHE_AUTOLOAD_SCT1_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, PRO_DCACHE_AUTOLOAD_SECTION1_ADDR_SPEC, 32, O, u32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_dcache_autoload_sct1_addr(&mut self) -> PRO_DCACHE_AUTOLOAD_SCT1_ADDR_W<0> {
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_autoload_section1_addr](index.html) module"]
