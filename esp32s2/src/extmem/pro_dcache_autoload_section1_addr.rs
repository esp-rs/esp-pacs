    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_DCACHE_AUTOLOAD_SECTION1_ADDR")
            .field(
                ...
                &format_args!("{}", self.pro_dcache_autoload_sct1_addr().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<PRO_DCACHE_AUTOLOAD_SECTION1_ADDR_SPEC> {
...
#[doc = "`read()` method returns [`pro_dcache_autoload_section1_addr::R`](R) reader structure"]
impl crate::Readable for PRO_DCACHE_AUTOLOAD_SECTION1_ADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`pro_dcache_autoload_section1_addr::W`](W) writer structure"]
