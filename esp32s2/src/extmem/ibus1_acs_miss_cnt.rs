...
///Field `IBUS1_ACS_MISS_CNT` reader - The bits are used to count the number of the cache miss caused by ibus1 access.
pub type IBUS1_ACS_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The bits are used to count the number of the cache miss caused by ibus1 access.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`ibus1_acs_miss_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct IBUS1_ACS_MISS_CNT_SPEC;
impl crate::RegisterSpec for IBUS1_ACS_MISS_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`ibus1_acs_miss_cnt::R`](R) reader structure
impl crate::Readable for IBUS1_ACS_MISS_CNT_SPEC {}
///`reset()` method sets IBUS1_ACS_MISS_CNT to value 0
