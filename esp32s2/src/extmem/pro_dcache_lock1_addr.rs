...
pub type PRO_DCACHE_LOCK1_ADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_dcache_lock1_addr(
        &mut self,
    ) -> PRO_DCACHE_LOCK1_ADDR_W<PRO_DCACHE_LOCK1_ADDR_SPEC, 0> {
