...
///Register `PRO_DCACHE_LOCK1_ADDR` writer
pub type W = crate::W<PRO_DCACHE_LOCK1_ADDR_SPEC>;
///Field `PRO_DCACHE_LOCK1_ADDR` reader - The bits are used to configure the second start virtual address of data locking, which is combined with PRO_DCACHE_LOCK1_SIZE_REG
pub type PRO_DCACHE_LOCK1_ADDR_R = crate::FieldReader<u32>;
///Field `PRO_DCACHE_LOCK1_ADDR` writer - The bits are used to configure the second start virtual address of data locking, which is combined with PRO_DCACHE_LOCK1_SIZE_REG
pub type PRO_DCACHE_LOCK1_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - The bits are used to configure the second start virtual address of data locking, which is combined with PRO_DCACHE_LOCK1_SIZE_REG
    #[inline(always)]
