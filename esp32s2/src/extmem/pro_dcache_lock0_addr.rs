...
pub struct R(crate::R<PRO_DCACHE_LOCK0_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_DCACHE_LOCK0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_DCACHE_LOCK0_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_DCACHE_LOCK0_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_DCACHE_LOCK0_ADDR` writer"]
pub struct W(crate::W<PRO_DCACHE_LOCK0_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_DCACHE_LOCK0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_DCACHE_LOCK0_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_DCACHE_LOCK0_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_DCACHE_LOCK0_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type PRO_DCACHE_LOCK0_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRO_DCACHE_LOCK0_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the first start virtual address of data locking, which is combined with PRO_DCACHE_LOCK0_SIZE_REG"]
    #[inline(always)]
    pub fn pro_dcache_lock0_addr(&mut self) -> PRO_DCACHE_LOCK0_ADDR_W<0> {
        PRO_DCACHE_LOCK0_ADDR_W::new(self)
    }
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pro_dcache_lock0_addr](index.html) module"]
