...
#[doc = "Field `DUTY_CHNG_END_CH6` reader - This is the masked interrupt status bit for the LEDC_DUTY_CHNG_END_CH6_INT interrupt when LEDC_DUTY_CHNG_END_CH6_INT_ENAIS set to 1."]
pub type DUTY_CHNG_END_CH6_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_CH7` reader - This is the masked interrupt status bit for the LEDC_DUTY_CHNG_END_CH7_INT interrupt when LEDC_DUTY_CHNG_END_CH7_INT_ENAIS set to 1."]
...
#[doc = "Field `OVF_CNT_CH6` reader - This is the masked interrupt status bit for the LEDC_OVF_CNT_CH6_INT interrupt when LEDC_OVF_CNT_CH6_INT_ENA is set to 1."]
pub type OVF_CNT_CH6_R = crate::BitReader;
#[doc = "Field `OVF_CNT_CH7` reader - This is the masked interrupt status bit for the LEDC_OVF_CNT_CH7_INT interrupt when LEDC_OVF_CNT_CH7_INT_ENA is set to 1."]
