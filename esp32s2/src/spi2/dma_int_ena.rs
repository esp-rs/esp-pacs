...
impl W {
    ...
    #[doc = "Bit 9 - The enable bit for infifo full error interrupt."]
    #[inline(always)]
    pub fn infifo_full_err(&mut self) -> INFIFO_FULL_ERR_W<'_, DMA_INT_ENA_SPEC> {
        INFIFO_FULL_ERR_W::new(self, 9)
    }
    #[doc = "Bit 10 - The enable bit for outfifo empty error interrupt."]
    #[inline(always)]
    pub fn outfifo_empty_err(&mut self) -> OUTFIFO_EMPTY_ERR_W<'_, DMA_INT_ENA_SPEC> {
        OUTFIFO_EMPTY_ERR_W::new(self, 10)
    }
    #[doc = "Bit 11 - The enable bit for SPI slave CMD6 interrupt."]
    #[inline(always)]
    pub fn slv_cmd6(&mut self) -> SLV_CMD6_W<'_, DMA_INT_ENA_SPEC> {
