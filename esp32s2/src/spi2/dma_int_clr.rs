...
#[doc = "Field `INLINK_DSCR_EMPTY` reader - The clear bit for lack of enough inlink descriptors. Can be configured in CONF state."]
pub type INLINK_DSCR_EMPTY_R = crate::BitReader;
#[doc = "Field `INLINK_DSCR_EMPTY` writer - The clear bit for lack of enough inlink descriptors. Can be configured in CONF state."]
pub type INLINK_DSCR_EMPTY_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUTLINK_DSCR_ERROR` reader - The clear bit for outlink descriptor error. Can be configured in CONF state."]
pub type OUTLINK_DSCR_ERROR_R = crate::BitReader;
#[doc = "Field `OUTLINK_DSCR_ERROR` writer - The clear bit for outlink descriptor error. Can be configured in CONF state."]
pub type OUTLINK_DSCR_ERROR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `INLINK_DSCR_ERROR` reader - The clear bit for inlink descriptor error. Can be configured in CONF state."]
pub type INLINK_DSCR_ERROR_R = crate::BitReader;
#[doc = "Field `INLINK_DSCR_ERROR` writer - The clear bit for inlink descriptor error. Can be configured in CONF state."]
pub type INLINK_DSCR_ERROR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_DONE` reader - The clear bit for completing usage of a inlink descriptor. Can be configured in CONF state."]
pub type IN_DONE_R = crate::BitReader;
#[doc = "Field `IN_DONE` writer - The clear bit for completing usage of a inlink descriptor. Can be configured in CONF state."]
pub type IN_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_ERR_EOF` reader - The clear bit for receiving error. Can be configured in CONF state."]
pub type IN_ERR_EOF_R = crate::BitReader;
#[doc = "Field `IN_ERR_EOF` writer - The clear bit for receiving error. Can be configured in CONF state."]
pub type IN_ERR_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_SUC_EOF` reader - The clear bit for completing receiving all the packets from host. Can be configured in CONF state."]
pub type IN_SUC_EOF_R = crate::BitReader;
#[doc = "Field `IN_SUC_EOF` writer - The clear bit for completing receiving all the packets from host. Can be configured in CONF state."]
pub type IN_SUC_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_DONE` reader - The clear bit for completing usage of a outlink descriptor. Can be configured in CONF state."]
pub type OUT_DONE_R = crate::BitReader;
#[doc = "Field `OUT_DONE` writer - The clear bit for completing usage of a outlink descriptor. Can be configured in CONF state."]
pub type OUT_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_EOF` reader - The clear bit for sending a packet to host done. Can be configured in CONF state."]
pub type OUT_EOF_R = crate::BitReader;
#[doc = "Field `OUT_EOF` writer - The clear bit for sending a packet to host done. Can be configured in CONF state."]
pub type OUT_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_TOTAL_EOF` reader - The clear bit for sending all the packets to host done. Can be configured in CONF state."]
pub type OUT_TOTAL_EOF_R = crate::BitReader;
#[doc = "Field `OUT_TOTAL_EOF` writer - The clear bit for sending all the packets to host done. Can be configured in CONF state."]
pub type OUT_TOTAL_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `INFIFO_FULL_ERR` reader - 1: Clear SPI_INFIFO_FULL_ERR_INT_RAW. 0: not valid. Can be changed by CONF_buf."]
pub type INFIFO_FULL_ERR_R = crate::BitReader;
#[doc = "Field `INFIFO_FULL_ERR` writer - 1: Clear SPI_INFIFO_FULL_ERR_INT_RAW. 0: not valid. Can be changed by CONF_buf."]
pub type INFIFO_FULL_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUTFIFO_EMPTY_ERR` reader - 1: Clear SPI_OUTFIFO_EMPTY_ERR_INT_RAW signal. 0: not valid. Can be changed by CONF_buf."]
pub type OUTFIFO_EMPTY_ERR_R = crate::BitReader;
#[doc = "Field `OUTFIFO_EMPTY_ERR` writer - 1: Clear SPI_OUTFIFO_EMPTY_ERR_INT_RAW signal. 0: not valid. Can be changed by CONF_buf."]
pub type OUTFIFO_EMPTY_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_CMD6` reader - The clear bit for SPI slave CMD6 interrupt."]
pub type SLV_CMD6_R = crate::BitReader;
#[doc = "Field `SLV_CMD6` writer - The clear bit for SPI slave CMD6 interrupt."]
pub type SLV_CMD6_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_CMD7` reader - The clear bit for SPI slave CMD7 interrupt."]
...
#[doc = "Field `SLV_CMD8` reader - The clear bit for SPI slave CMD8 interrupt."]
...
#[doc = "Field `SLV_CMD9` reader - The clear bit for SPI slave CMD9 interrupt."]
...
#[doc = "Field `SLV_CMDA` reader - The clear bit for SPI slave CMDA interrupt."]
...
impl W {
    ...
    #[doc = "Bit 9 - 1: Clear SPI_INFIFO_FULL_ERR_INT_RAW. 0: not valid. Can be changed by CONF_buf."]
    #[inline(always)]
    pub fn infifo_full_err(&mut self) -> INFIFO_FULL_ERR_W<'_, DMA_INT_CLR_SPEC> {
        INFIFO_FULL_ERR_W::new(self, 9)
    }
    #[doc = "Bit 10 - 1: Clear SPI_OUTFIFO_EMPTY_ERR_INT_RAW signal. 0: not valid. Can be changed by CONF_buf."]
    #[inline(always)]
    pub fn outfifo_empty_err(&mut self) -> OUTFIFO_EMPTY_ERR_W<'_, DMA_INT_CLR_SPEC> {
        OUTFIFO_EMPTY_ERR_W::new(self, 10)
    }
    #[doc = "Bit 11 - The clear bit for SPI slave CMD6 interrupt."]
    #[inline(always)]
    pub fn slv_cmd6(&mut self) -> SLV_CMD6_W<'_, DMA_INT_CLR_SPEC> {
        SLV_CMD6_W::new(self, 11)
    }
    #[doc = "Bit 12 - The clear bit for SPI slave CMD7 interrupt."]
    #[inline(always)]
    pub fn slv_cmd7(&mut self) -> SLV_CMD7_W<'_, DMA_INT_CLR_SPEC> {
        SLV_CMD7_W::new(self, 12)
    }
    #[doc = "Bit 13 - The clear bit for SPI slave CMD8 interrupt."]
    #[inline(always)]
    pub fn slv_cmd8(&mut self) -> SLV_CMD8_W<'_, DMA_INT_CLR_SPEC> {
        SLV_CMD8_W::new(self, 13)
    }
    #[doc = "Bit 14 - The clear bit for SPI slave CMD9 interrupt."]
    #[inline(always)]
    pub fn slv_cmd9(&mut self) -> SLV_CMD9_W<'_, DMA_INT_CLR_SPEC> {
        SLV_CMD9_W::new(self, 14)
    }
    #[doc = "Bit 15 - The clear bit for SPI slave CMDA interrupt."]
    #[inline(always)]
    pub fn slv_cmda(&mut self) -> SLV_CMDA_W<'_, DMA_INT_CLR_SPEC> {
        SLV_CMDA_W::new(self, 15)
    }
}
#[doc = "SPI DMA interrupt clear register\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_int_clr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_int_clr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
