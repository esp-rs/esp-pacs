...
///Field `CLEAR_INTERRUPT` writer - Set this bit to 1 to clear the RSA interrupts.
...
///`write(|w| ..)` method takes [`clear_interrupt::W`](W) writer structure
impl crate::Writable for CLEAR_INTERRUPT_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CLEAR_INTERRUPT to value 0
