///Register `MODMULT_START` writer
pub type W = crate::W<MODMULT_START_SPEC>;
///Field `MODMULT_START` writer - Set this bit to 1 to start the modular multiplication.
...
impl W {
    ///Bit 0 - Set this bit to 1 to start the modular multiplication.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`modmult_start::W`](W) writer structure
