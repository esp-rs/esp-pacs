...
///Register `CONSTANT_TIME` writer
pub type W = crate::W<CONSTANT_TIME_SPEC>;
///Field `CONSTANT_TIME` reader - Set this bit to 0 to enable the acceleration option of constant_time for modular exponentiation. Set to 1 to disable the acceleration (by default).
pub type CONSTANT_TIME_R = crate::BitReader;
///Field `CONSTANT_TIME` writer - Set this bit to 0 to enable the acceleration option of constant_time for modular exponentiation. Set to 1 to disable the acceleration (by default).
...
///`read()` method returns [`constant_time::R`](R) reader structure
impl crate::Readable for CONSTANT_TIME_SPEC {}
///`write(|w| ..)` method takes [`constant_time::W`](W) writer structure
