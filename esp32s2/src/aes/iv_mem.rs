...
///Field `IV` reader - This register stores the %sth 32-bit piece of 128-bit initialization vector
pub type IV_R = crate::FieldReader<u32>;
///Field `IV` writer - This register stores the %sth 32-bit piece of 128-bit initialization vector
pub type IV_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This register stores the %sth 32-bit piece of 128-bit initialization vector
    #[inline(always)]
    pub fn iv(&self) -> IV_R {
        IV_R::new(self.bits)
    }
