...
///Field `J0` reader - This register stores the %sth 32-bit piece of 128-bit J0
pub type J0_R = crate::FieldReader<u32>;
///Field `J0` writer - This register stores the %sth 32-bit piece of 128-bit J0
pub type J0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This register stores the %sth 32-bit piece of 128-bit J0
    #[inline(always)]
    pub fn j0(&self) -> J0_R {
        J0_R::new(self.bits)
    }
