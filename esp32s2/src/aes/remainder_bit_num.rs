...
///Register `REMAINDER_BIT_NUM` writer
pub type W = crate::W<REMAINDER_BIT_NUM_SPEC>;
///Field `REMAINDER_BIT_NUM` reader - Stores the Remainder Bit Number for the GCM operation.
pub type REMAINDER_BIT_NUM_R = crate::FieldReader;
///Field `REMAINDER_BIT_NUM` writer - Stores the Remainder Bit Number for the GCM operation.
pub type REMAINDER_BIT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    ///Bits 0:6 - Stores the Remainder Bit Number for the GCM operation.
    #[inline(always)]
...
///`read()` method returns [`remainder_bit_num::R`](R) reader structure
impl crate::Readable for REMAINDER_BIT_NUM_SPEC {}
///`write(|w| ..)` method takes [`remainder_bit_num::W`](W) writer structure
