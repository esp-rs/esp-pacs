...
///Register `AAD_BLOCK_NUM` writer
pub type W = crate::W<AAD_BLOCK_NUM_SPEC>;
///Field `AAD_BLOCK_NUM` reader - Stores the ADD Block Number for the GCM operation.
pub type AAD_BLOCK_NUM_R = crate::FieldReader<u32>;
///Field `AAD_BLOCK_NUM` writer - Stores the ADD Block Number for the GCM operation.
pub type AAD_BLOCK_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Stores the ADD Block Number for the GCM operation.
    #[inline(always)]
...
///`read()` method returns [`aad_block_num::R`](R) reader structure
impl crate::Readable for AAD_BLOCK_NUM_SPEC {}
///`write(|w| ..)` method takes [`aad_block_num::W`](W) writer structure
