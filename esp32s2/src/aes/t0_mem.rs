...
///Field `T0` reader - This register stores the %sth 32-bit piece of 128-bit T0
pub type T0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the %sth 32-bit piece of 128-bit T0
    #[inline(always)]
    pub fn t0(&self) -> T0_R {
        T0_R::new(self.bits)
    }
...
///`read()` method returns [`t0_mem::R`](R) reader structure
