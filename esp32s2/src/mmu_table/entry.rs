...
#[doc = "Field `ACCESS_FLASH` reader - Map to flash when set"]
pub type ACCESS_FLASH_R = crate::BitReader;
#[doc = "Field `ACCESS_FLASH` writer - Map to flash when set"]
pub type ACCESS_FLASH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ACCESS_SPIRAM` reader - Map to SPIRAM/PSRAM when set"]
pub type ACCESS_SPIRAM_R = crate::BitReader;
#[doc = "Field `ACCESS_SPIRAM` writer - Map to SPIRAM/PSRAM when set"]
...
impl R {
    ...
    #[doc = "Bit 15 - Map to flash when set"]
    #[inline(always)]
    pub fn access_flash(&self) -> ACCESS_FLASH_R {
        ACCESS_FLASH_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - Map to SPIRAM/PSRAM when set"]
    #[inline(always)]
    pub fn access_spiram(&self) -> ACCESS_SPIRAM_R {
        ACCESS_SPIRAM_R::new(((self.bits >> 16) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ENTRY")
            ...
            .field("access_flash", &self.access_flash())
...
impl W {
    ...
    #[doc = "Bit 15 - Map to flash when set"]
    #[inline(always)]
    pub fn access_flash(&mut self) -> ACCESS_FLASH_W<'_, ENTRY_SPEC> {
        ACCESS_FLASH_W::new(self, 15)
    }
    #[doc = "Bit 16 - Map to SPIRAM/PSRAM when set"]
    #[inline(always)]
    pub fn access_spiram(&mut self) -> ACCESS_SPIRAM_W<'_, ENTRY_SPEC> {
        ACCESS_SPIRAM_W::new(self, 16)
    }
}
