///Register `CMD%s` reader
pub type R = crate::R<CMD_SPEC>;
///Register `CMD%s` writer
pub type W = crate::W<CMD_SPEC>;
///Field `COMMAND` reader - Content of command 0. For more information, please refer to the register I2C_COMD0_REG in Chapter I²C Controller
pub type COMMAND_R = crate::FieldReader<u16>;
///Field `COMMAND` writer - Content of command 0. For more information, please refer to the register I2C_COMD0_REG in Chapter I²C Controller
pub type COMMAND_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
///Field `COMMAND_DONE` reader - When command 0 is done, this bit changes to 1.
