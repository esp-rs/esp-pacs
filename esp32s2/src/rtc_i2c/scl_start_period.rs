...
///Field `SCL_START_PERIOD` reader - Number of clock cycles to wait after generating a start condition.
pub type SCL_START_PERIOD_R = crate::FieldReader<u32>;
///Field `SCL_START_PERIOD` writer - Number of clock cycles to wait after generating a start condition.
