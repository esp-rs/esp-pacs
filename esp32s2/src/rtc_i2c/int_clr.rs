...
///Field `SLAVE_TRAN_COMP` writer - RTC_I2C_SLAVE_TRAN_COMP_INT interrupt clear bit
pub type SLAVE_TRAN_COMP_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `ARBITRATION_LOST` writer - RTC_I2C_ARBITRATION_LOST_INT interrupt clear bit
pub type ARBITRATION_LOST_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `MASTER_TRAN_COMP` writer - RTC_I2C_MASTER_TRAN_COMP_INT interrupt clear bit
pub type MASTER_TRAN_COMP_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TRANS_COMPLETE` writer - RTC_I2C_TRANS_COMPLETE_INT interrupt clear bit
pub type TRANS_COMPLETE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TIME_OUT` writer - RTC_I2C_TIME_OUT_INT interrupt clear bit
pub type TIME_OUT_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `ACK_ERR` writer - RTC_I2C_ACK_ERR_INT interrupt clear bit
pub type ACK_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `RX_DATA` writer - RTC_I2C_RX_DATA_INT interrupt clear bit
pub type RX_DATA_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TX_DATA` writer - RTC_I2C_TX_DATA_INT interrupt clear bit
pub type TX_DATA_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `DETECT_START` writer - RTC_I2C_DETECT_START_INT interrupt clear bit
