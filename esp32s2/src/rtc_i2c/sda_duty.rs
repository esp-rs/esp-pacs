...
///Field `NUM` reader - The number of clock cycles between the SDA switch and the falling edge of SCL.
pub type NUM_R = crate::FieldReader<u32>;
///Field `NUM` writer - The number of clock cycles between the SDA switch and the falling edge of SCL.
pub type NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19 - The number of clock cycles between the SDA switch and the falling edge of SCL.
    #[inline(always)]
