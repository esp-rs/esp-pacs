...
///Field `SLAVE_TRAN_COMP` reader - RTC_I2C_SLAVE_TRAN_COMP_INT interrupt status bit
pub type SLAVE_TRAN_COMP_R = crate::BitReader;
///Field `ARBITRATION_LOST` reader - RTC_I2C_ARBITRATION_LOST_INT interrupt status bit
pub type ARBITRATION_LOST_R = crate::BitReader;
///Field `MASTER_TRAN_COMP` reader - RTC_I2C_MASTER_TRAN_COMP_INT interrupt status bit
pub type MASTER_TRAN_COMP_R = crate::BitReader;
///Field `TRANS_COMPLETE` reader - RTC_I2C_TRANS_COMPLETE_INT interrupt status bit
pub type TRANS_COMPLETE_R = crate::BitReader;
///Field `TIME_OUT` reader - RTC_I2C_TIME_OUT_INT interrupt status bit
pub type TIME_OUT_R = crate::BitReader;
///Field `ACK_ERR` reader - RTC_I2C_ACK_ERR_INT interrupt status bit
pub type ACK_ERR_R = crate::BitReader;
///Field `RX_DATA` reader - RTC_I2C_RX_DATA_INT interrupt status bit
pub type RX_DATA_R = crate::BitReader;
///Field `TX_DATA` reader - RTC_I2C_TX_DATA_INT interrupt status bit
pub type TX_DATA_R = crate::BitReader;
///Field `DETECT_START` reader - RTC_I2C_DETECT_START_INT interrupt status bit
pub type DETECT_START_R = crate::BitReader;
impl R {
    ///Bit 0 - RTC_I2C_SLAVE_TRAN_COMP_INT interrupt status bit
    #[inline(always)]
    pub fn slave_tran_comp(&self) -> SLAVE_TRAN_COMP_R {
        SLAVE_TRAN_COMP_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - RTC_I2C_ARBITRATION_LOST_INT interrupt status bit
    #[inline(always)]
    pub fn arbitration_lost(&self) -> ARBITRATION_LOST_R {
        ARBITRATION_LOST_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - RTC_I2C_MASTER_TRAN_COMP_INT interrupt status bit
    #[inline(always)]
    pub fn master_tran_comp(&self) -> MASTER_TRAN_COMP_R {
        MASTER_TRAN_COMP_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - RTC_I2C_TRANS_COMPLETE_INT interrupt status bit
    #[inline(always)]
    pub fn trans_complete(&self) -> TRANS_COMPLETE_R {
        TRANS_COMPLETE_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - RTC_I2C_TIME_OUT_INT interrupt status bit
    #[inline(always)]
    pub fn time_out(&self) -> TIME_OUT_R {
        TIME_OUT_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - RTC_I2C_ACK_ERR_INT interrupt status bit
    #[inline(always)]
    pub fn ack_err(&self) -> ACK_ERR_R {
        ACK_ERR_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - RTC_I2C_RX_DATA_INT interrupt status bit
    #[inline(always)]
    pub fn rx_data(&self) -> RX_DATA_R {
        RX_DATA_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - RTC_I2C_TX_DATA_INT interrupt status bit
    #[inline(always)]
    pub fn tx_data(&self) -> TX_DATA_R {
        TX_DATA_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - RTC_I2C_DETECT_START_INT interrupt status bit
    #[inline(always)]
