...
pub type D_XFERSIZE3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
#[doc = "Field `D_PKTCNT3` reader - "]
pub type D_PKTCNT3_R = crate::FieldReader;
#[doc = "Field `D_PKTCNT3` writer - "]
pub type D_PKTCNT3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn d_xfersize3(&mut self) -> D_XFERSIZE3_W<DIEPTSIZ3_SPEC, 0> {
        D_XFERSIZE3_W::new(self)
    }
    #[doc = "Bits 19:20"]
    #[inline(always)]
    #[must_use]
    pub fn d_pktcnt3(&mut self) -> D_PKTCNT3_W<DIEPTSIZ3_SPEC, 19> {
