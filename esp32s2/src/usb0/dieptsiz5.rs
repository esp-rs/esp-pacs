...
pub type D_XFERSIZE5_R = crate::FieldReader<u8, u8>;
#[doc = "Field `D_XFERSIZE5` writer - "]
pub type D_XFERSIZE5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTSIZ5_SPEC, u8, u8, 7, O>;
#[doc = "Field `D_PKTCNT5` reader - "]
pub type D_PKTCNT5_R = crate::FieldReader<u8, u8>;
#[doc = "Field `D_PKTCNT5` writer - "]
pub type D_PKTCNT5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTSIZ5_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
