...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn h_mps0(&mut self) -> H_MPS0_W<HCCHAR0_SPEC, 0> {
        H_MPS0_W::new(self)
    }
    #[doc = "Bits 11:14"]
    #[inline(always)]
    #[must_use]
    pub fn h_epnum0(&mut self) -> H_EPNUM0_W<HCCHAR0_SPEC, 11> {
        H_EPNUM0_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn h_epdir0(&mut self) -> H_EPDIR0_W<HCCHAR0_SPEC, 15> {
        H_EPDIR0_W::new(self)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn h_lspddev0(&mut self) -> H_LSPDDEV0_W<HCCHAR0_SPEC, 17> {
        H_LSPDDEV0_W::new(self)
    }
    #[doc = "Bits 18:19"]
    #[inline(always)]
    #[must_use]
    pub fn h_eptype0(&mut self) -> H_EPTYPE0_W<HCCHAR0_SPEC, 18> {
        H_EPTYPE0_W::new(self)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn h_ec0(&mut self) -> H_EC0_W<HCCHAR0_SPEC, 21> {
        H_EC0_W::new(self)
    }
    #[doc = "Bits 22:28"]
    #[inline(always)]
    #[must_use]
    pub fn h_devaddr0(&mut self) -> H_DEVADDR0_W<HCCHAR0_SPEC, 22> {
        H_DEVADDR0_W::new(self)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn h_oddfrm0(&mut self) -> H_ODDFRM0_W<HCCHAR0_SPEC, 29> {
        H_ODDFRM0_W::new(self)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    #[must_use]
    pub fn h_chdis0(&mut self) -> H_CHDIS0_W<HCCHAR0_SPEC, 30> {
        H_CHDIS0_W::new(self)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn h_chena0(&mut self) -> H_CHENA0_W<HCCHAR0_SPEC, 31> {
        H_CHENA0_W::new(self)
    }
