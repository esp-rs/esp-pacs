...
pub type D_XFERSIZE6_R = crate::FieldReader<u8, u8>;
#[doc = "Field `D_XFERSIZE6` writer - "]
pub type D_XFERSIZE6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTSIZ6_SPEC, u8, u8, 7, O>;
#[doc = "Field `D_PKTCNT6` reader - "]
pub type D_PKTCNT6_R = crate::FieldReader<u8, u8>;
#[doc = "Field `D_PKTCNT6` writer - "]
pub type D_PKTCNT6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTSIZ6_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
