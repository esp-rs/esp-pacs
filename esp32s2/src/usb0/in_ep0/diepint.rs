...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn d_xfercompl0(&mut self) -> D_XFERCOMPL0_W<DIEPINT_SPEC> {
        D_XFERCOMPL0_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn d_epdisbld0(&mut self) -> D_EPDISBLD0_W<DIEPINT_SPEC> {
        D_EPDISBLD0_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn d_ahberr0(&mut self) -> D_AHBERR0_W<DIEPINT_SPEC> {
        D_AHBERR0_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn d_timeout0(&mut self) -> D_TIMEOUT0_W<DIEPINT_SPEC> {
        D_TIMEOUT0_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn d_intkntxfemp0(&mut self) -> D_INTKNTXFEMP0_W<DIEPINT_SPEC> {
        D_INTKNTXFEMP0_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn d_intknepmis0(&mut self) -> D_INTKNEPMIS0_W<DIEPINT_SPEC> {
        D_INTKNEPMIS0_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn d_inepnakeff0(&mut self) -> D_INEPNAKEFF0_W<DIEPINT_SPEC> {
        D_INEPNAKEFF0_W::new(self, 6)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn d_txfifoundrn0(&mut self) -> D_TXFIFOUNDRN0_W<DIEPINT_SPEC> {
        D_TXFIFOUNDRN0_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn d_bnaintr0(&mut self) -> D_BNAINTR0_W<DIEPINT_SPEC> {
        D_BNAINTR0_W::new(self, 9)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn d_pktdrpsts0(&mut self) -> D_PKTDRPSTS0_W<DIEPINT_SPEC> {
        D_PKTDRPSTS0_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn d_bbleerr0(&mut self) -> D_BBLEERR0_W<DIEPINT_SPEC> {
        D_BBLEERR0_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn d_nakintrpt0(&mut self) -> D_NAKINTRPT0_W<DIEPINT_SPEC> {
        D_NAKINTRPT0_W::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn d_nyetintrpt0(&mut self) -> D_NYETINTRPT0_W<DIEPINT_SPEC> {
