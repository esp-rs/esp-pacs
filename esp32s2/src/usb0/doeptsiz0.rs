...
pub type XFERSIZE0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
#[doc = "Field `PKTCNT0` reader - "]
pub type PKTCNT0_R = crate::BitReader;
#[doc = "Field `PKTCNT0` writer - "]
pub type PKTCNT0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SUPCNT0` reader - "]
pub type SUPCNT0_R = crate::FieldReader;
#[doc = "Field `SUPCNT0` writer - "]
pub type SUPCNT0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize0(&mut self) -> XFERSIZE0_W<DOEPTSIZ0_SPEC, 0> {
        XFERSIZE0_W::new(self)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt0(&mut self) -> PKTCNT0_W<DOEPTSIZ0_SPEC, 19> {
        PKTCNT0_W::new(self)
    }
    #[doc = "Bits 29:30"]
    #[inline(always)]
    #[must_use]
    pub fn supcnt0(&mut self) -> SUPCNT0_W<DOEPTSIZ0_SPEC, 29> {
        SUPCNT0_W::new(self)
    }
