...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfercompl0(&mut self) -> XFERCOMPL0_W<DOEPINT_SPEC> {
        XFERCOMPL0_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn epdisbld0(&mut self) -> EPDISBLD0_W<DOEPINT_SPEC> {
        EPDISBLD0_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn ahberr0(&mut self) -> AHBERR0_W<DOEPINT_SPEC> {
        AHBERR0_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn setup0(&mut self) -> SETUP0_W<DOEPINT_SPEC> {
        SETUP0_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn outtknepdis0(&mut self) -> OUTTKNEPDIS0_W<DOEPINT_SPEC> {
        OUTTKNEPDIS0_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn stsphsercvd0(&mut self) -> STSPHSERCVD0_W<DOEPINT_SPEC> {
        STSPHSERCVD0_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn back2backsetup0(&mut self) -> BACK2BACKSETUP0_W<DOEPINT_SPEC> {
        BACK2BACKSETUP0_W::new(self, 6)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn outpkterr0(&mut self) -> OUTPKTERR0_W<DOEPINT_SPEC> {
        OUTPKTERR0_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn bnaintr0(&mut self) -> BNAINTR0_W<DOEPINT_SPEC> {
        BNAINTR0_W::new(self, 9)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn pktdrpsts0(&mut self) -> PKTDRPSTS0_W<DOEPINT_SPEC> {
        PKTDRPSTS0_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn bbleerr0(&mut self) -> BBLEERR0_W<DOEPINT_SPEC> {
        BBLEERR0_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn nakintrpt0(&mut self) -> NAKINTRPT0_W<DOEPINT_SPEC> {
        NAKINTRPT0_W::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn nyepintrpt0(&mut self) -> NYEPINTRPT0_W<DOEPINT_SPEC> {
        NYEPINTRPT0_W::new(self, 14)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn stuppktrcvd0(&mut self) -> STUPPKTRCVD0_W<DOEPINT_SPEC> {
