...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn snp0(&mut self) -> SNP0_W<DOEPCTL_SPEC> {
        SNP0_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn stall0(&mut self) -> STALL0_W<DOEPCTL_SPEC> {
        STALL0_W::new(self, 21)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn cnak0(&mut self) -> CNAK0_W<DOEPCTL_SPEC> {
        CNAK0_W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn do_snak0(&mut self) -> DO_SNAK0_W<DOEPCTL_SPEC> {
        DO_SNAK0_W::new(self, 27)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn epena0(&mut self) -> EPENA0_W<DOEPCTL_SPEC> {
