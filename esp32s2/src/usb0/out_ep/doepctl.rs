...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn snp1(&mut self) -> SNP1_W<DOEPCTL_SPEC> {
        SNP1_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn stall1(&mut self) -> STALL1_W<DOEPCTL_SPEC> {
        STALL1_W::new(self, 21)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn cnak1(&mut self) -> CNAK1_W<DOEPCTL_SPEC> {
        CNAK1_W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn do_snak1(&mut self) -> DO_SNAK1_W<DOEPCTL_SPEC> {
        DO_SNAK1_W::new(self, 27)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    #[must_use]
    pub fn do_setd0pid1(&mut self) -> DO_SETD0PID1_W<DOEPCTL_SPEC> {
        DO_SETD0PID1_W::new(self, 28)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn do_setd1pid1(&mut self) -> DO_SETD1PID1_W<DOEPCTL_SPEC> {
        DO_SETD1PID1_W::new(self, 29)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn epena1(&mut self) -> EPENA1_W<DOEPCTL_SPEC> {
