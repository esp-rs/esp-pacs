...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn h_xfersize0(&mut self) -> H_XFERSIZE0_W<HCTSIZ0_SPEC> {
        H_XFERSIZE0_W::new(self, 0)
    }
    #[doc = "Bits 19:28"]
    #[inline(always)]
    #[must_use]
    pub fn h_pktcnt0(&mut self) -> H_PKTCNT0_W<HCTSIZ0_SPEC> {
        H_PKTCNT0_W::new(self, 19)
    }
    #[doc = "Bits 29:30"]
    #[inline(always)]
    #[must_use]
    pub fn h_pid0(&mut self) -> H_PID0_W<HCTSIZ0_SPEC> {
        H_PID0_W::new(self, 29)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn h_dopng0(&mut self) -> H_DOPNG0_W<HCTSIZ0_SPEC> {
        H_DOPNG0_W::new(self, 31)
    }
