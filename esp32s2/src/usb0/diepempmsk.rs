...
pub type D_INEPTXFEMPMSK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn d_ineptxfempmsk(&mut self) -> D_INEPTXFEMPMSK_W<DIEPEMPMSK_SPEC, 0> {
        D_INEPTXFEMPMSK_W::new(self)
    }
