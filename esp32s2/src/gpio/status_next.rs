...
///Field `STATUS_INTERRUPT_NEXT` reader - Interrupt source signal of GPIO0 ~ 31, could be rising edge interrupt, falling edge interrupt, level sensitive interrupt and any edge interrupt.
pub type STATUS_INTERRUPT_NEXT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Interrupt source signal of GPIO0 ~ 31, could be rising edge interrupt, falling edge interrupt, level sensitive interrupt and any edge interrupt.
    #[inline(always)]
