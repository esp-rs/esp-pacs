...
///Field `DATA_NEXT` reader - GPIO0 ~ 31 input value. Each bit represents a pad input value, 1 for high level and 0 for low level.
pub type DATA_NEXT_R = crate::FieldReader<u32>;
///Field `DATA_NEXT` writer - GPIO0 ~ 31 input value. Each bit represents a pad input value, 1 for high level and 0 for low level.
...
///`write(|w| ..)` method takes [`in_::W`](W) writer structure
