...
///Field `INTERRUPT` reader - GPIO32 ~ 53 interrupt status register.
pub type INTERRUPT_R = crate::FieldReader<u32>;
///Field `INTERRUPT` writer - GPIO32 ~ 53 interrupt status register.
pub type INTERRUPT_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - GPIO32 ~ 53 interrupt status register.
    #[inline(always)]
