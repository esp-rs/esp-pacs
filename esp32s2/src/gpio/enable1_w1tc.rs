///Register `ENABLE1_W1TC` writer
pub type W = crate::W<ENABLE1_W1TC_SPEC>;
///Field `ENABLE1_W1TC` writer - GPIO32 ~ 53 output enable clear register. If the value 1 is written to a bit here, the corresponding bit in GPIO_ENABLE1_REG will be cleared. Recommended operation: use this register to clear GPIO_ENABLE1_REG.
...
impl W {
    ///Bits 0:21 - GPIO32 ~ 53 output enable clear register. If the value 1 is written to a bit here, the corresponding bit in GPIO_ENABLE1_REG will be cleared. Recommended operation: use this register to clear GPIO_ENABLE1_REG.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`enable1_w1tc::W`](W) writer structure
