...
#[doc = "Field `CLK_EN` reader - Clock gating enable bit. If set to 1, the clock is free running."]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Clock gating enable bit. If set to 1, the clock is free running."]
pub type CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, CLOCK_GATE_SPEC, O>;
impl R {
    #[doc = "Bit 0 - Clock gating enable bit. If set to 1, the clock is free running."]
    #[inline(always)]
