///Register `STATUS1_W1TC` writer
pub type W = crate::W<STATUS1_W1TC_SPEC>;
///Field `STATUS1_W1TC` writer - GPIO32 ~ 53 interrupt status clear register. If the value 1 is written to a bit here, the corresponding bit in GPIO_STATUS1_REG will be cleared. Recommended operation: use this register to clear GPIO_STATUS1_REG.
...
impl W {
    ///Bits 0:21 - GPIO32 ~ 53 interrupt status clear register. If the value 1 is written to a bit here, the corresponding bit in GPIO_STATUS1_REG will be cleared. Recommended operation: use this register to clear GPIO_STATUS1_REG.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`status1_w1tc::W`](W) writer structure
