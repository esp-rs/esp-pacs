...
///Field `OUT_SEL` writer - Selection control for GPIO output n. If a value s (0&lt;=s&lt;256) is written to this field, the peripheral output signal s will be connected to GPIO output n. If a value 256 is written to this field, bit n of GPIO_OUT_REG/GPIO_OUT1_REG and GPIO_ENABLE_REG/GPIO_ENABLE1_REG will be selected as the output value and output enable.
pub type OUT_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `INV_SEL` reader - 0: Do not invert the output value; 1: Invert the output value.
pub type INV_SEL_R = crate::BitReader;
///Field `INV_SEL` writer - 0: Do not invert the output value; 1: Invert the output value.
pub type INV_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OEN_SEL` reader - 0: Use output enable signal from peripheral; 1: Force the output enable signal to be sourced from bit n of GPIO_ENABLE_REG.
pub type OEN_SEL_R = crate::BitReader;
///Field `OEN_SEL` writer - 0: Use output enable signal from peripheral; 1: Force the output enable signal to be sourced from bit n of GPIO_ENABLE_REG.
pub type OEN_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OEN_INV_SEL` reader - 0: Do not invert the output enable signal; 1: Invert the output enable signal.
pub type OEN_INV_SEL_R = crate::BitReader;
///Field `OEN_INV_SEL` writer - 0: Do not invert the output enable signal; 1: Invert the output enable signal.
