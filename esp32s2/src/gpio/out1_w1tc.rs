///Register `OUT1_W1TC` writer
pub type W = crate::W<OUT1_W1TC_SPEC>;
///Field `OUT1_W1TC` writer - GPIO32 ~ 53 output value clear register. If the value 1 is written to a bit here, the corresponding bit in GPIO_OUT1_REG will be cleared. Recommended operation: use this register to clear GPIO_OUT1_REG.
...
impl W {
    ///Bits 0:21 - GPIO32 ~ 53 output value clear register. If the value 1 is written to a bit here, the corresponding bit in GPIO_OUT1_REG will be cleared. Recommended operation: use this register to clear GPIO_OUT1_REG.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`out1_w1tc::W`](W) writer structure
