...
///Field `INTERRUPT` reader - GPIO0 ~ 31 interrupt status register.
pub type INTERRUPT_R = crate::FieldReader<u32>;
///Field `INTERRUPT` writer - GPIO0 ~ 31 interrupt status register.
pub type INTERRUPT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - GPIO0 ~ 31 interrupt status register.
    #[inline(always)]
