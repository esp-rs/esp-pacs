///Register `OUT1` reader
pub type R = crate::R<OUT1_SPEC>;
///Register `OUT1` writer
pub type W = crate::W<OUT1_SPEC>;
///Field `DATA_ORIG` reader - GPIO32 ~ 53 output value in simple GPIO output mode. The values of bit0 ~ bit13 correspond to GPIO32 ~ GPIO45. Bit14 ~ bit21 are invalid.
pub type DATA_ORIG_R = crate::FieldReader<u32>;
///Field `DATA_ORIG` writer - GPIO32 ~ 53 output value in simple GPIO output mode. The values of bit0 ~ bit13 correspond to GPIO32 ~ GPIO45. Bit14 ~ bit21 are invalid.
...
///`read()` method returns [`out1::R`](R) reader structure
impl crate::Readable for OUT1_SPEC {}
///`write(|w| ..)` method takes [`out1::W`](W) writer structure
