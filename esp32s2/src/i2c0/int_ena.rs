...
///Field `RXFIFO_WM` reader - The raw interrupt bit for I2C_RXFIFO_WM_INT interrupt.
pub type RXFIFO_WM_R = crate::BitReader;
///Field `RXFIFO_WM` writer - The raw interrupt bit for I2C_RXFIFO_WM_INT interrupt.
pub type RXFIFO_WM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_WM` reader - The raw interrupt bit for I2C_TXFIFO_WM_INT interrupt.
pub type TXFIFO_WM_R = crate::BitReader;
///Field `TXFIFO_WM` writer - The raw interrupt bit for I2C_TXFIFO_WM_INT interrupt.
pub type TXFIFO_WM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_OVF` reader - The raw interrupt bit for I2C_RXFIFO_OVF_INT interrupt.
pub type RXFIFO_OVF_R = crate::BitReader;
///Field `RXFIFO_OVF` writer - The raw interrupt bit for I2C_RXFIFO_OVF_INT interrupt.
pub type RXFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `END_DETECT` reader - The raw interrupt bit for the I2C_END_DETECT_INT interrupt.
pub type END_DETECT_R = crate::BitReader;
///Field `END_DETECT` writer - The raw interrupt bit for the I2C_END_DETECT_INT interrupt.
pub type END_DETECT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BYTE_TRANS_DONE` reader - The raw interrupt bit for the I2C_END_DETECT_INT interrupt.
pub type BYTE_TRANS_DONE_R = crate::BitReader;
///Field `BYTE_TRANS_DONE` writer - The raw interrupt bit for the I2C_END_DETECT_INT interrupt.
pub type BYTE_TRANS_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ARBITRATION_LOST` reader - The raw interrupt bit for the I2C_ARBITRATION_LOST_INT interrupt.
pub type ARBITRATION_LOST_R = crate::BitReader;
///Field `ARBITRATION_LOST` writer - The raw interrupt bit for the I2C_ARBITRATION_LOST_INT interrupt.
pub type ARBITRATION_LOST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MST_TXFIFO_UDF` reader - The raw interrupt bit for I2C_TRANS_COMPLETE_INT interrupt.
pub type MST_TXFIFO_UDF_R = crate::BitReader;
///Field `MST_TXFIFO_UDF` writer - The raw interrupt bit for I2C_TRANS_COMPLETE_INT interrupt.
pub type MST_TXFIFO_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_COMPLETE` reader - The raw interrupt bit for the I2C_TRANS_COMPLETE_INT interrupt.
pub type TRANS_COMPLETE_R = crate::BitReader;
///Field `TRANS_COMPLETE` writer - The raw interrupt bit for the I2C_TRANS_COMPLETE_INT interrupt.
pub type TRANS_COMPLETE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIME_OUT` reader - The raw interrupt bit for the I2C_TIME_OUT_INT interrupt.
pub type TIME_OUT_R = crate::BitReader;
///Field `TIME_OUT` writer - The raw interrupt bit for the I2C_TIME_OUT_INT interrupt.
pub type TIME_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_START` reader - The raw interrupt bit for the I2C_TRANS_START_INT interrupt.
pub type TRANS_START_R = crate::BitReader;
///Field `TRANS_START` writer - The raw interrupt bit for the I2C_TRANS_START_INT interrupt.
pub type TRANS_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `NACK` reader - The raw interrupt bit for I2C_SLAVE_STRETCH_INT interrupt.
pub type NACK_R = crate::BitReader;
///Field `NACK` writer - The raw interrupt bit for I2C_SLAVE_STRETCH_INT interrupt.
pub type NACK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_OVF` reader - The raw interrupt bit for I2C_TXFIFO_OVF_INT interrupt.
pub type TXFIFO_OVF_R = crate::BitReader;
///Field `TXFIFO_OVF` writer - The raw interrupt bit for I2C_TXFIFO_OVF_INT interrupt.
pub type TXFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_UDF` reader - The raw interrupt bit for I2C_RXFIFO_UDF_INT interrupt.
pub type RXFIFO_UDF_R = crate::BitReader;
///Field `RXFIFO_UDF` writer - The raw interrupt bit for I2C_RXFIFO_UDF_INT interrupt.
pub type RXFIFO_UDF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCL_ST_TO` reader - The raw interrupt bit for I2C_SCL_ST_TO_INT interrupt.
pub type SCL_ST_TO_R = crate::BitReader;
///Field `SCL_ST_TO` writer - The raw interrupt bit for I2C_SCL_ST_TO_INT interrupt.
pub type SCL_ST_TO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SCL_MAIN_ST_TO` reader - The raw interrupt bit for I2C_SCL_MAIN_ST_TO_INT interrupt.
pub type SCL_MAIN_ST_TO_R = crate::BitReader;
///Field `SCL_MAIN_ST_TO` writer - The raw interrupt bit for I2C_SCL_MAIN_ST_TO_INT interrupt.
pub type SCL_MAIN_ST_TO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DET_START` reader - The raw interrupt bit for I2C_DET_START_INT interrupt.
pub type DET_START_R = crate::BitReader;
///Field `DET_START` writer - The raw interrupt bit for I2C_DET_START_INT interrupt.
pub type DET_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLAVE_STRETCH` reader - The raw interrupt bit for I2C_SLAVE_STRETCH_INT interrupt.
pub type SLAVE_STRETCH_R = crate::BitReader;
///Field `SLAVE_STRETCH` writer - The raw interrupt bit for I2C_SLAVE_STRETCH_INT interrupt.
...
impl R {
    ...
    ///Bit 16 - The raw interrupt bit for I2C_SLAVE_STRETCH_INT interrupt.
    #[inline(always)]
