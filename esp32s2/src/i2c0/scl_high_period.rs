...
pub type SCL_HIGH_PERIOD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
pub type SCL_WAIT_HIGH_PERIOD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scl_wait_high_period(&mut self) -> SCL_WAIT_HIGH_PERIOD_W<SCL_HIGH_PERIOD_SPEC, 14> {
