...
///Field `DATE` reader - This is the the version control register.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - This is the the version control register.
...
///`reset()` method sets DATE to value 0x1905_2000
