...
///Field `IN_SUC_EOF_DES_ADDR` reader - This register stores the address of the receive descriptor when received successful EOF.
pub type IN_SUC_EOF_DES_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the address of the receive descriptor when received successful EOF.
    #[inline(always)]
