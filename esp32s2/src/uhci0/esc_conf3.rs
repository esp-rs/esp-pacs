...
#[doc = "Field `ESC_SEQ2` reader - This register is used to define a character that need to be decoded. The default value is 0x13 that used as a flow control character."]
pub type ESC_SEQ2_R = crate::FieldReader;
#[doc = "Field `ESC_SEQ2` writer - This register is used to define a character that need to be decoded. The default value is 0x13 that used as a flow control character."]
pub type ESC_SEQ2_W<'a, const O: u8> = crate::FieldWriter<'a, ESC_CONF3_SPEC, 8, O>;
#[doc = "Field `ESC_SEQ2_CHAR0` reader - This register is used to define the first character of SLIP escape sequence. The default value is 0xDB."]
pub type ESC_SEQ2_CHAR0_R = crate::FieldReader;
#[doc = "Field `ESC_SEQ2_CHAR0` writer - This register is used to define the first character of SLIP escape sequence. The default value is 0xDB."]
pub type ESC_SEQ2_CHAR0_W<'a, const O: u8> = crate::FieldWriter<'a, ESC_CONF3_SPEC, 8, O>;
#[doc = "Field `ESC_SEQ2_CHAR1` reader - This register is used to define the second character of SLIP escape sequence. The default value is 0xDF."]
pub type ESC_SEQ2_CHAR1_R = crate::FieldReader;
#[doc = "Field `ESC_SEQ2_CHAR1` writer - This register is used to define the second character of SLIP escape sequence. The default value is 0xDF."]
