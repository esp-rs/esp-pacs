...
///Field `RX_START` reader - This is the interrupt raw bit for UHCI_RX_START_INT interrupt. The interrupt is triggered when a separator has been sent.
pub type RX_START_R = crate::BitReader;
///Field `TX_START` reader - This is the interrupt raw bit for UHCI_TX_START_INT interrupt. The interrupt is triggered when DMA detects a separator.
pub type TX_START_R = crate::BitReader;
///Field `RX_HUNG` reader - This is the interrupt raw bit for UHCI_RX_HUNG_INT interrupt. The interrupt is triggered when DMA takes more time to receive data than the configure value.
pub type RX_HUNG_R = crate::BitReader;
///Field `TX_HUNG` reader - This is the interrupt raw bit for UHCI_TX_HUNG_INT interrupt. The interrupt is triggered when DMA takes more time to read data from RAM than the configured value.
pub type TX_HUNG_R = crate::BitReader;
///Field `IN_DONE` reader - This is the interrupt raw bit for UHCI_IN_DONE_INT interrupt. The interrupt is triggered when an receive descriptor is completed.
pub type IN_DONE_R = crate::BitReader;
///Field `IN_SUC_EOF` reader - This is the interrupt raw bit for UHCI_IN_SUC_EOF_INT interrupt. The interrupt is triggered when a data packet has been received successfully.
pub type IN_SUC_EOF_R = crate::BitReader;
///Field `IN_ERR_EOF` reader - This is the interrupt raw bit for UHCI_IN_ERR_EOF_INT interrupt. The interrupt is triggered when there are some errors in EOF in the receive descriptor.
pub type IN_ERR_EOF_R = crate::BitReader;
///Field `OUT_DONE` reader - This is the interrupt raw bit for UHCI_OUT_DONE_INT interrupt. The interrupt is triggered when an transmit descriptor is completed.
pub type OUT_DONE_R = crate::BitReader;
///Field `OUT_EOF` reader - This is the interrupt raw bit for UHCI_OUT_EOF_INT interrupt. The interrupt is triggered when the current descriptor's EOF bit is 1.
pub type OUT_EOF_R = crate::BitReader;
///Field `IN_DSCR_ERR` reader - This is the interrupt raw bit for UHCI_IN_DSCR_ERR_INT interrupt. The interrupt is triggered when there are some errors in the receive descriptor.
pub type IN_DSCR_ERR_R = crate::BitReader;
///Field `OUT_DSCR_ERR` reader - This is the interrupt raw bit for UHCI_OUT_DSCR_ERR_INT interrupt. The interrupt is triggered when there are some errors in the transmit descriptor.
pub type OUT_DSCR_ERR_R = crate::BitReader;
///Field `IN_DSCR_EMPTY` reader - This is the interrupt raw bit for UHCI_IN_DSCR_EMPTY_INT interrupt. The interrupt is triggered when there are not enough inlinks for DMA.
pub type IN_DSCR_EMPTY_R = crate::BitReader;
///Field `OUTLINK_EOF_ERR` reader - This is the interrupt raw bit for UHCI_OUTLINK_EOF_ERR_INT interrupt. The interrupt is triggered when there are some errors in EOF in the transmit descriptor.
pub type OUTLINK_EOF_ERR_R = crate::BitReader;
///Field `OUT_TOTAL_EOF` reader - This is the interrupt raw bit for UHCI_OUT_TOTAL_EOF_INT interrupt. The interrupt is triggered when all data in the last buffer address has been sent out.
pub type OUT_TOTAL_EOF_R = crate::BitReader;
///Field `SEND_S_REG_Q` reader - This is the interrupt raw bit for UHCI_SEND_S_REG_Q_INT interrupt. The interrupt is triggered when DMA has sent out a short packet using single_send mode.
pub type SEND_S_REG_Q_R = crate::BitReader;
///Field `SEND_A_REG_Q` reader - This is the interrupt raw bit for UHCI_SEND_A_REG_Q_INT interrupt. The interrupt is triggered when DMA has sent out a short packet using always_send mode.
pub type SEND_A_REG_Q_R = crate::BitReader;
///Field `DMA_INFIFO_FULL_WM` reader - This is the interrupt raw bit for UHCI_DMA_INFIFO_FULL_WM_INT interrupt. The interrupt is triggered when the number of data bytes in DMA RX FIFO has reached the configured threshold value.
