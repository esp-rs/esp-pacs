...
///Field `OUTLINK_ADDR` reader - This register is used to specify the least significant 20 bits of the first transmit descriptor's address.
pub type OUTLINK_ADDR_R = crate::FieldReader<u32>;
///Field `OUTLINK_ADDR` writer - This register is used to specify the least significant 20 bits of the first transmit descriptor's address.
pub type OUTLINK_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
///Field `OUTLINK_STOP` reader - Set this bit to stop dealing with the transmit descriptor.
pub type OUTLINK_STOP_R = crate::BitReader;
///Field `OUTLINK_STOP` writer - Set this bit to stop dealing with the transmit descriptor.
pub type OUTLINK_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTLINK_START` reader - Set this bit to start a new transmit descriptor.
pub type OUTLINK_START_R = crate::BitReader;
///Field `OUTLINK_START` writer - Set this bit to start a new transmit descriptor.
pub type OUTLINK_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTLINK_RESTART` reader - Set this bit to restart the transmit descriptor from the last address.
pub type OUTLINK_RESTART_R = crate::BitReader;
///Field `OUTLINK_RESTART` writer - Set this bit to restart the transmit descriptor from the last address.
pub type OUTLINK_RESTART_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTLINK_PARK` reader - 1: the transmit descriptor's FSM is in idle state. 0: the transmit descriptor's FSM is working.
pub type OUTLINK_PARK_R = crate::BitReader;
impl R {
    ///Bits 0:19 - This register is used to specify the least significant 20 bits of the first transmit descriptor's address.
    #[inline(always)]
    pub fn outlink_addr(&self) -> OUTLINK_ADDR_R {
        OUTLINK_ADDR_R::new(self.bits & 0x000f_ffff)
    }
    ///Bit 28 - Set this bit to stop dealing with the transmit descriptor.
    #[inline(always)]
    pub fn outlink_stop(&self) -> OUTLINK_STOP_R {
        OUTLINK_STOP_R::new(((self.bits >> 28) & 1) != 0)
    }
    ///Bit 29 - Set this bit to start a new transmit descriptor.
    #[inline(always)]
    pub fn outlink_start(&self) -> OUTLINK_START_R {
        OUTLINK_START_R::new(((self.bits >> 29) & 1) != 0)
    }
    ///Bit 30 - Set this bit to restart the transmit descriptor from the last address.
    #[inline(always)]
    pub fn outlink_restart(&self) -> OUTLINK_RESTART_R {
        OUTLINK_RESTART_R::new(((self.bits >> 30) & 1) != 0)
    }
    ///Bit 31 - 1: the transmit descriptor's FSM is in idle state. 0: the transmit descriptor's FSM is working.
    #[inline(always)]
