...
///Field `PKT_THRS` reader - This register is used to configure the maximum value of the packet length when UHCI_HEAD_EN is 0.
pub type PKT_THRS_R = crate::FieldReader<u16>;
///Field `PKT_THRS` writer - This register is used to configure the maximum value of the packet length when UHCI_HEAD_EN is 0.
pub type PKT_THRS_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
impl R {
    ///Bits 0:12 - This register is used to configure the maximum value of the packet length when UHCI_HEAD_EN is 0.
    #[inline(always)]
