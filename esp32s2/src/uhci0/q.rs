...
impl Q {
    ///0x00 - Q0_WORD0 quick_sent register
    #[inline(always)]
    pub const fn word0(&self) -> &WORD0 {
        &self.word0
    }
    ///0x04 - Q0_WORD1 quick_sent register
    #[inline(always)]
    pub const fn word1(&self) -> &WORD1 {
        &self.word1
    }
}
/**WORD0 (rw) register accessor: Q0_WORD0 quick_sent register
...
pub mod word0;
/**WORD1 (rw) register accessor: Q0_WORD1 quick_sent register
