...
///Field `OUT_EOF_BFR_DES_ADDR` reader - This register stores the address of the transmit descriptor before the last transmit descriptor.
pub type OUT_EOF_BFR_DES_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the address of the transmit descriptor before the last transmit descriptor.
    #[inline(always)]
