...
///Field `OUTFIFO_WDATA` reader - This is the data that need to be pushed into TX FIFO.
pub type OUTFIFO_WDATA_R = crate::FieldReader<u16>;
///Field `OUTFIFO_WDATA` writer - This is the data that need to be pushed into TX FIFO.
pub type OUTFIFO_WDATA_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
///Field `OUTFIFO_PUSH` reader - Set this bit to push data into TX FIFO.
pub type OUTFIFO_PUSH_R = crate::BitReader;
///Field `OUTFIFO_PUSH` writer - Set this bit to push data into TX FIFO.
pub type OUTFIFO_PUSH_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:8 - This is the data that need to be pushed into TX FIFO.
    #[inline(always)]
    pub fn outfifo_wdata(&self) -> OUTFIFO_WDATA_R {
        OUTFIFO_WDATA_R::new((self.bits & 0x01ff) as u16)
    }
    ///Bit 16 - Set this bit to push data into TX FIFO.
    #[inline(always)]
