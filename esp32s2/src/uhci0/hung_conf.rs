...
///Field `TXFIFO_TIMEOUT` reader - This register stores the timeout value. UHCI produce the UHCI_TX_HUNG_INT interrupt when DMA takes more time to receive data.
pub type TXFIFO_TIMEOUT_R = crate::FieldReader;
///Field `TXFIFO_TIMEOUT` writer - This register stores the timeout value. UHCI produce the UHCI_TX_HUNG_INT interrupt when DMA takes more time to receive data.
pub type TXFIFO_TIMEOUT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `TXFIFO_TIMEOUT_SHIFT` reader - This register is used to configure the maximum tick count.
pub type TXFIFO_TIMEOUT_SHIFT_R = crate::FieldReader;
///Field `TXFIFO_TIMEOUT_SHIFT` writer - This register is used to configure the maximum tick count.
pub type TXFIFO_TIMEOUT_SHIFT_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `TXFIFO_TIMEOUT_ENA` reader - This is the enable bit for TX FIFO receive timeout.
pub type TXFIFO_TIMEOUT_ENA_R = crate::BitReader;
///Field `TXFIFO_TIMEOUT_ENA` writer - This is the enable bit for TX FIFO receive timeout.
pub type TXFIFO_TIMEOUT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_TIMEOUT` reader - This register stores the timeout value. UHCI produce the UHCI_RX_HUNG_INT interrupt when DMA takes more time to read data from RAM.
pub type RXFIFO_TIMEOUT_R = crate::FieldReader;
///Field `RXFIFO_TIMEOUT` writer - This register stores the timeout value. UHCI produce the UHCI_RX_HUNG_INT interrupt when DMA takes more time to read data from RAM.
pub type RXFIFO_TIMEOUT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `RXFIFO_TIMEOUT_SHIFT` reader - This register is used to configure the maximum tick count.
pub type RXFIFO_TIMEOUT_SHIFT_R = crate::FieldReader;
///Field `RXFIFO_TIMEOUT_SHIFT` writer - This register is used to configure the maximum tick count.
pub type RXFIFO_TIMEOUT_SHIFT_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `RXFIFO_TIMEOUT_ENA` reader - This is the enable bit for DMA send timeout.
pub type RXFIFO_TIMEOUT_ENA_R = crate::BitReader;
///Field `RXFIFO_TIMEOUT_ENA` writer - This is the enable bit for DMA send timeout.
