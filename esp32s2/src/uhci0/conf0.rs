...
///Field `IN_RST` reader - Set this bit to reset in DMA FSM.
pub type IN_RST_R = crate::BitReader;
///Field `IN_RST` writer - Set this bit to reset in DMA FSM.
pub type IN_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_RST` reader - Set this bit to reset out DMA FSM.
pub type OUT_RST_R = crate::BitReader;
///Field `OUT_RST` writer - Set this bit to reset out DMA FSM.
pub type OUT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AHBM_FIFO_RST` reader - Set this bit to reset AHB interface cmdFIFO of DMA.
pub type AHBM_FIFO_RST_R = crate::BitReader;
///Field `AHBM_FIFO_RST` writer - Set this bit to reset AHB interface cmdFIFO of DMA.
pub type AHBM_FIFO_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AHBM_RST` reader - Set this bit to reset AHB interface of DMA.
pub type AHBM_RST_R = crate::BitReader;
///Field `AHBM_RST` writer - Set this bit to reset AHB interface of DMA.
...
///Field `OUT_AUTO_WRBACK` reader - Set this bit to enable automatic outlink writeback when all the data in TX FIFO has been transmitted.
pub type OUT_AUTO_WRBACK_R = crate::BitReader;
///Field `OUT_AUTO_WRBACK` writer - Set this bit to enable automatic outlink writeback when all the data in TX FIFO has been transmitted.
...
///Field `OUT_EOF_MODE` reader - This register is used to specify the generation mode of UHCI_OUT_EOF_INT interrupt. 1: When DMA has popped all data from FIFO. 0: When AHB has pushed all data to FIFO.
pub type OUT_EOF_MODE_R = crate::BitReader;
///Field `OUT_EOF_MODE` writer - This register is used to specify the generation mode of UHCI_OUT_EOF_INT interrupt. 1: When DMA has popped all data from FIFO. 0: When AHB has pushed all data to FIFO.
pub type OUT_EOF_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART0_CE` reader - Set this bit to link up UHCI and UART0.
pub type UART0_CE_R = crate::BitReader;
///Field `UART0_CE` writer - Set this bit to link up UHCI and UART0.
pub type UART0_CE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART1_CE` reader - Set this bit to link up UHCI and UART1.
pub type UART1_CE_R = crate::BitReader;
///Field `UART1_CE` writer - Set this bit to link up UHCI and UART1.
pub type UART1_CE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTDSCR_BURST_EN` reader - This register is used to specify DMA transmit descriptor transfer mode. 1: burst mode. 0: byte mode.
pub type OUTDSCR_BURST_EN_R = crate::BitReader;
///Field `OUTDSCR_BURST_EN` writer - This register is used to specify DMA transmit descriptor transfer mode. 1: burst mode. 0: byte mode.
pub type OUTDSCR_BURST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INDSCR_BURST_EN` reader - This register is used to specify DMA receive descriptor transfer mode. 1: burst mode. 0: byte mode.
pub type INDSCR_BURST_EN_R = crate::BitReader;
///Field `INDSCR_BURST_EN` writer - This register is used to specify DMA receive descriptor transfer mode. 1: burst mode. 0: byte mode.
pub type INDSCR_BURST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_TRANS_EN` reader - 1: UHCI transmitted data would be write back into DMA INFIFO.
pub type MEM_TRANS_EN_R = crate::BitReader;
///Field `MEM_TRANS_EN` writer - 1: UHCI transmitted data would be write back into DMA INFIFO.
pub type MEM_TRANS_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEPER_EN` reader - Set this bit to separate the data frame using a special character.
pub type SEPER_EN_R = crate::BitReader;
///Field `SEPER_EN` writer - Set this bit to separate the data frame using a special character.
...
///Field `LEN_EOF_EN` reader - If this bit is set to 1, UHCI decoder stops receiving payload data when the number of received data bytes has reached the specified value. The value is payload length indicated by UCHI packet header when UHCI_HEAD_EN is 1 or the value is a configuration value when UHCI_HEAD_EN is 0. If this bit is set to 0, UHCI decoder stops receiving payload data upon receiving 0xC0.
...
///Field `ENCODE_CRC_EN` reader - Set this bit to enable data integrity checking by appending a 16 bit CCITT-CRC to the end of the payload.
pub type ENCODE_CRC_EN_R = crate::BitReader;
///Field `ENCODE_CRC_EN` writer - Set this bit to enable data integrity checking by appending a 16 bit CCITT-CRC to the end of the payload.
...
///Field `UART_RX_BRK_EOF_EN` reader - If this bit is set to 1, UHCI stops receiving payload data when a NULL frame is received by UART.
pub type UART_RX_BRK_EOF_EN_R = crate::BitReader;
///Field `UART_RX_BRK_EOF_EN` writer - If this bit is set to 1, UHCI stops receiving payload data when a NULL frame is received by UART.
pub type UART_RX_BRK_EOF_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit to reset in DMA FSM.
    #[inline(always)]
    pub fn in_rst(&self) -> IN_RST_R {
        IN_RST_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set this bit to reset out DMA FSM.
    #[inline(always)]
