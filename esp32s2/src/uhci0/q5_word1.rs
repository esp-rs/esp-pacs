...
pub struct R(crate::R<Q5_WORD1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<Q5_WORD1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<Q5_WORD1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<Q5_WORD1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Q5_WORD1` writer"]
pub struct W(crate::W<Q5_WORD1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<Q5_WORD1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<Q5_WORD1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<Q5_WORD1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SEND_Q5_WORD1` reader - This register is used as a quick_sent register when mode is specified by UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM."]
pub type SEND_Q5_WORD1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SEND_Q5_WORD1` writer - This register is used as a quick_sent register when mode is specified by UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM."]
pub type SEND_Q5_WORD1_W<'a, const O: u8> = crate::FieldWriter<'a, Q5_WORD1_SPEC, 32, O, u32, u32>;
impl R {
