///Register `DMA_IN_POP` reader
pub type R = crate::R<DMA_IN_POP_SPEC>;
///Register `DMA_IN_POP` writer
pub type W = crate::W<DMA_IN_POP_SPEC>;
///Field `INFIFO_RDATA` reader - This register stores the data popping from RX FIFO.
pub type INFIFO_RDATA_R = crate::FieldReader<u16>;
///Field `INFIFO_POP` reader - Set this bit to pop data from RX FIFO.
pub type INFIFO_POP_R = crate::BitReader;
///Field `INFIFO_POP` writer - Set this bit to pop data from RX FIFO.
pub type INFIFO_POP_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:11 - This register stores the data popping from RX FIFO.
    #[inline(always)]
    pub fn infifo_rdata(&self) -> INFIFO_RDATA_R {
        INFIFO_RDATA_R::new((self.bits & 0x0fff) as u16)
    }
    ///Bit 16 - Set this bit to pop data from RX FIFO.
    #[inline(always)]
...
///`read()` method returns [`dma_in_pop::R`](R) reader structure
impl crate::Readable for DMA_IN_POP_SPEC {}
///`write(|w| ..)` method takes [`dma_in_pop::W`](W) writer structure
