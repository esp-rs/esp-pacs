...
///Field `DATE` reader - This is the version control register.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - This is the version control register.
...
///`reset()` method sets DATE to value 0x1807_3001
