...
#[doc = "Field `DATE` reader - This is the version control register."]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - This is the version control register."]
...
#[doc = "`reset()` method sets DATE to value 0x1807_3001"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x1807_3001;
}
