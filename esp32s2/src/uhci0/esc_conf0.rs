...
#[doc = "Field `SEPER_CHAR` reader - This register is used to define separators to encode data packets. The default value is 0xC0."]
pub type SEPER_CHAR_R = crate::FieldReader;
#[doc = "Field `SEPER_CHAR` writer - This register is used to define separators to encode data packets. The default value is 0xC0."]
pub type SEPER_CHAR_W<'a, const O: u8> = crate::FieldWriter<'a, ESC_CONF0_SPEC, 8, O>;
#[doc = "Field `SEPER_ESC_CHAR0` reader - This register is used to define the first character of SLIP escape sequence. The default value is 0xDB."]
pub type SEPER_ESC_CHAR0_R = crate::FieldReader;
#[doc = "Field `SEPER_ESC_CHAR0` writer - This register is used to define the first character of SLIP escape sequence. The default value is 0xDB."]
pub type SEPER_ESC_CHAR0_W<'a, const O: u8> = crate::FieldWriter<'a, ESC_CONF0_SPEC, 8, O>;
#[doc = "Field `SEPER_ESC_CHAR1` reader - This register is used to define the second character of SLIP escape sequence. The default value is 0xDC."]
pub type SEPER_ESC_CHAR1_R = crate::FieldReader;
#[doc = "Field `SEPER_ESC_CHAR1` writer - This register is used to define the second character of SLIP escape sequence. The default value is 0xDC."]
pub type SEPER_ESC_CHAR1_W<'a, const O: u8> = crate::FieldWriter<'a, ESC_CONF0_SPEC, 8, O>;
impl R {
    #[doc = "Bits 0:7 - This register is used to define separators to encode data packets. The default value is 0xC0."]
    #[inline(always)]
    ...
    #[doc = "Bits 16:23 - This register is used to define the second character of SLIP escape sequence. The default value is 0xDC."]
    #[inline(always)]
