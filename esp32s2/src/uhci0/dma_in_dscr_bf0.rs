...
///Field `INLINK_DSCR_BF0` reader - This register stores the third word of the current receive descriptor.
pub type INLINK_DSCR_BF0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the third word of the current receive descriptor.
    #[inline(always)]
...
///`read()` method returns [`dma_in_dscr_bf0::R`](R) reader structure
