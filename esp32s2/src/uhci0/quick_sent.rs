...
///Field `SINGLE_SEND_NUM` reader - This register is used to specify the single_send mode.
pub type SINGLE_SEND_NUM_R = crate::FieldReader;
///Field `SINGLE_SEND_NUM` writer - This register is used to specify the single_send mode.
pub type SINGLE_SEND_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `SINGLE_SEND_EN` reader - Set this bit to enable single_send mode to send short packets.
pub type SINGLE_SEND_EN_R = crate::BitReader;
///Field `SINGLE_SEND_EN` writer - Set this bit to enable single_send mode to send short packets.
pub type SINGLE_SEND_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ALWAYS_SEND_NUM` reader - This register is used to specify the always_send mode.
pub type ALWAYS_SEND_NUM_R = crate::FieldReader;
///Field `ALWAYS_SEND_NUM` writer - This register is used to specify the always_send mode.
pub type ALWAYS_SEND_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `ALWAYS_SEND_EN` reader - Set this bit to enable always_send mode to send short packets.
pub type ALWAYS_SEND_EN_R = crate::BitReader;
///Field `ALWAYS_SEND_EN` writer - Set this bit to enable always_send mode to send short packets.
