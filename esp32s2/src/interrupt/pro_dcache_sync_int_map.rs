...
pub struct R(crate::R<PRO_DCACHE_SYNC_INT_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_DCACHE_SYNC_INT_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_DCACHE_SYNC_INT_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_DCACHE_SYNC_INT_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_DCACHE_SYNC_INT_MAP` writer"]
pub struct W(crate::W<PRO_DCACHE_SYNC_INT_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_DCACHE_SYNC_INT_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_DCACHE_SYNC_INT_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_DCACHE_SYNC_INT_MAP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_DCACHE_SYNC_INT_MAP_R = crate::FieldReader<u8, u8>;
...
pub type PRO_DCACHE_SYNC_INT_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRO_DCACHE_SYNC_INT_MAP_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - This register is used to map DCACHE_SYNC_INT interrupt signal to one of the CPU interrupts."]
    #[inline(always)]
    pub fn pro_dcache_sync_int_map(&mut self) -> PRO_DCACHE_SYNC_INT_MAP_W<0> {
