...
/**PRO_DCACHE_CTRL (rw) register accessor: register description
...
/**PRO_DCACHE_CTRL1 (rw) register accessor: register description
...
/**PRO_DCACHE_TAG_POWER_CTRL (rw) register accessor: register description
...
/**PRO_ICACHE_CTRL1 (rw) register accessor: register description
...
/**PRO_ICACHE_TAG_POWER_CTRL (rw) register accessor: register description
...
/**IC_PRELOAD_MISS_CNT (r) register accessor: register description
...
/**IBUS2_ABANDON_CNT (r) register accessor: register description
...
/**IBUS1_ABANDON_CNT (r) register accessor: register description
...
/**IBUS0_ABANDON_CNT (r) register accessor: register description
...
/**IBUS2_ACS_MISS_CNT (r) register accessor: register description
...
/**IBUS1_ACS_MISS_CNT (r) register accessor: register description
...
/**IBUS0_ACS_MISS_CNT (r) register accessor: register description
...
/**IBUS2_ACS_CNT (r) register accessor: register description
...
/**IBUS1_ACS_CNT (r) register accessor: register description
...
/**IBUS0_ACS_CNT (r) register accessor: register description
...
/**DC_PRELOAD_CNT (r) register accessor: register description
...
/**DC_PRELOAD_EVICT_CNT (r) register accessor: register description
...
/**DBUS2_ABANDON_CNT (r) register accessor: register description
...
/**DBUS1_ABANDON_CNT (r) register accessor: register description
...
/**DBUS0_ABANDON_CNT (r) register accessor: register description
...
/**DBUS2_ACS_WB_CNT (r) register accessor: register description
...
/**DBUS1_ACS_WB_CNT (r) register accessor: register description
...
/**DBUS0_ACS_WB_CNT (r) register accessor: register description
...
/**DBUS2_ACS_MISS_CNT (r) register accessor: register description
...
/**DBUS1_ACS_MISS_CNT (r) register accessor: register description
...
/**DBUS0_ACS_MISS_CNT (r) register accessor: register description
...
/**DBUS2_ACS_CNT (r) register accessor: register description
...
/**DBUS1_ACS_CNT (r) register accessor: register description
...
/**DBUS0_ACS_CNT (r) register accessor: register description
...
/**CACHE_DBG_INT_ENA (rw) register accessor: register description
...
/**CACHE_DBG_INT_CLR (w) register accessor: register description
...
/**CACHE_DBG_STATUS0 (r) register accessor: register description
...
/**CACHE_DBG_STATUS1 (r) register accessor: register description
...
/**PRO_CACHE_ACS_CNT_CLR (w) register accessor: register description
...
/**CACHE_ENCRYPT_DECRYPT_RECORD_DISABLE (rw) register accessor: register description
...
/**CACHE_CONF_MISC (rw) register accessor: register description
...
///register description
pub mod clock_gate;
/**PRO_EXTMEM_REG_DATE (rw) register accessor: register description
