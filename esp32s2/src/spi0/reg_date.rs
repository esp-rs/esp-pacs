...
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, REG_DATE_SPEC, u32, u32, 28, O>;
impl R {
...
#[doc = "`reset()` method sets REG_DATE to value 0x0190_7240"]
impl crate::Resettable for REG_DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0190_7240;
}
