...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MISC")
            ...
            .field("cs3_dis", &self.cs3_dis().bit())
            .field("cs4_dis", &self.cs4_dis().bit())
            .field("cs5_dis", &self.cs5_dis().bit())
            .field("ck_dis", &self.ck_dis().bit())
            .field("master_cs_pol", &self.master_cs_pol().bits())
            .field("clk_data_dtr_en", &self.clk_data_dtr_en().bit())
            .field("data_dtr_en", &self.data_dtr_en().bit())
            .field("addr_dtr_en", &self.addr_dtr_en().bit())
            .field("cmd_dtr_en", &self.cmd_dtr_en().bit())
            .field("cd_data_set", &self.cd_data_set().bit())
            .field("cd_dummy_set", &self.cd_dummy_set().bit())
            .field("cd_addr_set", &self.cd_addr_set().bit())
            .field("slave_cs_pol", &self.slave_cs_pol().bit())
            .field("dqs_idle_edge", &self.dqs_idle_edge().bit())
            .field("cd_cmd_set", &self.cd_cmd_set().bit())
            .field("cd_idle_edge", &self.cd_idle_edge().bit())
            .field("ck_idle_edge", &self.ck_idle_edge().bit())
            .field("cs_keep_active", &self.cs_keep_active().bit())
            .field("quad_din_pin_swap", &self.quad_din_pin_swap().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
