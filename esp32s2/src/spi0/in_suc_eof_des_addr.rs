...
///Field `DMA_IN_SUC_EOF_DES_ADDR` reader - The last inlink descriptor address when spi dma produce from_suc_eof.
pub type DMA_IN_SUC_EOF_DES_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The last inlink descriptor address when spi dma produce from_suc_eof.
    #[inline(always)]
