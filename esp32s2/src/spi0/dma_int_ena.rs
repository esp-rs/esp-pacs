...
pub type INLINK_DSCR_EMPTY_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OUTLINK_DSCR_ERROR_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INLINK_DSCR_ERROR_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INFIFO_FULL_ERR_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OUTFIFO_EMPTY_ERR_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLV_CMD6_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inlink_dscr_empty_int_ena(
        &mut self,
    ) -> INLINK_DSCR_EMPTY_INT_ENA_W<DMA_INT_ENA_SPEC, 0> {
        INLINK_DSCR_EMPTY_INT_ENA_W::new(self)
    }
    #[doc = "Bit 1 - The enable bit for outlink descriptor error. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn outlink_dscr_error_int_ena(
        &mut self,
    ) -> OUTLINK_DSCR_ERROR_INT_ENA_W<DMA_INT_ENA_SPEC, 1> {
        OUTLINK_DSCR_ERROR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 2 - The enable bit for inlink descriptor error. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn inlink_dscr_error_int_ena(
        &mut self,
    ) -> INLINK_DSCR_ERROR_INT_ENA_W<DMA_INT_ENA_SPEC, 2> {
        INLINK_DSCR_ERROR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 3 - The enable bit for completing usage of a inlink descriptor. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn in_done_int_ena(&mut self) -> IN_DONE_INT_ENA_W<DMA_INT_ENA_SPEC, 3> {
        IN_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 4 - The enable bit for receiving error. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn in_err_eof_int_ena(&mut self) -> IN_ERR_EOF_INT_ENA_W<DMA_INT_ENA_SPEC, 4> {
        IN_ERR_EOF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 5 - The enable bit for completing receiving all the packets from host. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn in_suc_eof_int_ena(&mut self) -> IN_SUC_EOF_INT_ENA_W<DMA_INT_ENA_SPEC, 5> {
        IN_SUC_EOF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 6 - The enable bit for completing usage of a outlink descriptor . Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn out_done_int_ena(&mut self) -> OUT_DONE_INT_ENA_W<DMA_INT_ENA_SPEC, 6> {
        OUT_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 7 - The enable bit for sending a packet to host done. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn out_eof_int_ena(&mut self) -> OUT_EOF_INT_ENA_W<DMA_INT_ENA_SPEC, 7> {
        OUT_EOF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 8 - The enable bit for sending all the packets to host done. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn out_total_eof_int_ena(&mut self) -> OUT_TOTAL_EOF_INT_ENA_W<DMA_INT_ENA_SPEC, 8> {
        OUT_TOTAL_EOF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 9 - The enable bit for infifo full error interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn infifo_full_err_int_ena(&mut self) -> INFIFO_FULL_ERR_INT_ENA_W<DMA_INT_ENA_SPEC, 9> {
        INFIFO_FULL_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 10 - The enable bit for outfifo empty error interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn outfifo_empty_err_int_ena(
        &mut self,
    ) -> OUTFIFO_EMPTY_ERR_INT_ENA_W<DMA_INT_ENA_SPEC, 10> {
        OUTFIFO_EMPTY_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 11 - The enable bit for SPI slave CMD6 interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmd6_int_ena(&mut self) -> SLV_CMD6_INT_ENA_W<DMA_INT_ENA_SPEC, 11> {
        SLV_CMD6_INT_ENA_W::new(self)
    }
    #[doc = "Bit 12 - The enable bit for SPI slave CMD7 interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmd7_int_ena(&mut self) -> SLV_CMD7_INT_ENA_W<DMA_INT_ENA_SPEC, 12> {
        SLV_CMD7_INT_ENA_W::new(self)
    }
    #[doc = "Bit 13 - The enable bit for SPI slave CMD8 interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmd8_int_ena(&mut self) -> SLV_CMD8_INT_ENA_W<DMA_INT_ENA_SPEC, 13> {
        SLV_CMD8_INT_ENA_W::new(self)
    }
    #[doc = "Bit 14 - The enable bit for SPI slave CMD9 interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmd9_int_ena(&mut self) -> SLV_CMD9_INT_ENA_W<DMA_INT_ENA_SPEC, 14> {
        SLV_CMD9_INT_ENA_W::new(self)
    }
    #[doc = "Bit 15 - The enable bit for SPI slave CMDA interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmda_int_ena(&mut self) -> SLV_CMDA_INT_ENA_W<DMA_INT_ENA_SPEC, 15> {
