...
///Field `INLINK_DSCR_EMPTY` reader - The enable bit for lack of enough inlink descriptors. Can be configured in CONF state.
pub type INLINK_DSCR_EMPTY_R = crate::BitReader;
///Field `INLINK_DSCR_EMPTY` writer - The enable bit for lack of enough inlink descriptors. Can be configured in CONF state.
pub type INLINK_DSCR_EMPTY_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTLINK_DSCR_ERROR` reader - The enable bit for outlink descriptor error. Can be configured in CONF state.
pub type OUTLINK_DSCR_ERROR_R = crate::BitReader;
///Field `OUTLINK_DSCR_ERROR` writer - The enable bit for outlink descriptor error. Can be configured in CONF state.
pub type OUTLINK_DSCR_ERROR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INLINK_DSCR_ERROR` reader - The enable bit for inlink descriptor error. Can be configured in CONF state.
pub type INLINK_DSCR_ERROR_R = crate::BitReader;
///Field `INLINK_DSCR_ERROR` writer - The enable bit for inlink descriptor error. Can be configured in CONF state.
pub type INLINK_DSCR_ERROR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_DONE` reader - The enable bit for completing usage of a inlink descriptor. Can be configured in CONF state.
pub type IN_DONE_R = crate::BitReader;
///Field `IN_DONE` writer - The enable bit for completing usage of a inlink descriptor. Can be configured in CONF state.
pub type IN_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_ERR_EOF` reader - The enable bit for receiving error. Can be configured in CONF state.
pub type IN_ERR_EOF_R = crate::BitReader;
///Field `IN_ERR_EOF` writer - The enable bit for receiving error. Can be configured in CONF state.
pub type IN_ERR_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_SUC_EOF` reader - The enable bit for completing receiving all the packets from host. Can be configured in CONF state.
pub type IN_SUC_EOF_R = crate::BitReader;
///Field `IN_SUC_EOF` writer - The enable bit for completing receiving all the packets from host. Can be configured in CONF state.
pub type IN_SUC_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_DONE` reader - The enable bit for completing usage of a outlink descriptor . Can be configured in CONF state.
pub type OUT_DONE_R = crate::BitReader;
///Field `OUT_DONE` writer - The enable bit for completing usage of a outlink descriptor . Can be configured in CONF state.
pub type OUT_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_EOF` reader - The enable bit for sending a packet to host done. Can be configured in CONF state.
pub type OUT_EOF_R = crate::BitReader;
///Field `OUT_EOF` writer - The enable bit for sending a packet to host done. Can be configured in CONF state.
pub type OUT_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_TOTAL_EOF` reader - The enable bit for sending all the packets to host done. Can be configured in CONF state.
pub type OUT_TOTAL_EOF_R = crate::BitReader;
///Field `OUT_TOTAL_EOF` writer - The enable bit for sending all the packets to host done. Can be configured in CONF state.
pub type OUT_TOTAL_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_FULL_ERR` reader - The enable bit for infifo full error interrupt.
pub type INFIFO_FULL_ERR_R = crate::BitReader;
///Field `INFIFO_FULL_ERR` writer - The enable bit for infifo full error interrupt.
pub type INFIFO_FULL_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTFIFO_EMPTY_ERR` reader - The enable bit for outfifo empty error interrupt.
pub type OUTFIFO_EMPTY_ERR_R = crate::BitReader;
///Field `OUTFIFO_EMPTY_ERR` writer - The enable bit for outfifo empty error interrupt.
pub type OUTFIFO_EMPTY_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMD6` reader - The enable bit for SPI slave CMD6 interrupt.
pub type SLV_CMD6_R = crate::BitReader;
///Field `SLV_CMD6` writer - The enable bit for SPI slave CMD6 interrupt.
...
impl R {
    ///Bit 0 - The enable bit for lack of enough inlink descriptors. Can be configured in CONF state.
    #[inline(always)]
    pub fn inlink_dscr_empty(&self) -> INLINK_DSCR_EMPTY_R {
        INLINK_DSCR_EMPTY_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The enable bit for outlink descriptor error. Can be configured in CONF state.
    #[inline(always)]
    pub fn outlink_dscr_error(&self) -> OUTLINK_DSCR_ERROR_R {
        OUTLINK_DSCR_ERROR_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - The enable bit for inlink descriptor error. Can be configured in CONF state.
    #[inline(always)]
    pub fn inlink_dscr_error(&self) -> INLINK_DSCR_ERROR_R {
        INLINK_DSCR_ERROR_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - The enable bit for completing usage of a inlink descriptor. Can be configured in CONF state.
    #[inline(always)]
    pub fn in_done(&self) -> IN_DONE_R {
        IN_DONE_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - The enable bit for receiving error. Can be configured in CONF state.
    #[inline(always)]
    pub fn in_err_eof(&self) -> IN_ERR_EOF_R {
        IN_ERR_EOF_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - The enable bit for completing receiving all the packets from host. Can be configured in CONF state.
    #[inline(always)]
    pub fn in_suc_eof(&self) -> IN_SUC_EOF_R {
        IN_SUC_EOF_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - The enable bit for completing usage of a outlink descriptor . Can be configured in CONF state.
    #[inline(always)]
    pub fn out_done(&self) -> OUT_DONE_R {
        OUT_DONE_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - The enable bit for sending a packet to host done. Can be configured in CONF state.
    #[inline(always)]
    pub fn out_eof(&self) -> OUT_EOF_R {
        OUT_EOF_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - The enable bit for sending all the packets to host done. Can be configured in CONF state.
    #[inline(always)]
    pub fn out_total_eof(&self) -> OUT_TOTAL_EOF_R {
        OUT_TOTAL_EOF_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - The enable bit for infifo full error interrupt.
    #[inline(always)]
    pub fn infifo_full_err(&self) -> INFIFO_FULL_ERR_R {
        INFIFO_FULL_ERR_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - The enable bit for outfifo empty error interrupt.
    #[inline(always)]
    pub fn outfifo_empty_err(&self) -> OUTFIFO_EMPTY_ERR_R {
        OUTFIFO_EMPTY_ERR_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - The enable bit for SPI slave CMD6 interrupt.
    #[inline(always)]
    pub fn slv_cmd6(&self) -> SLV_CMD6_R {
        SLV_CMD6_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - The enable bit for SPI slave CMD7 interrupt.
    #[inline(always)]
    pub fn slv_cmd7(&self) -> SLV_CMD7_R {
        SLV_CMD7_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - The enable bit for SPI slave CMD8 interrupt.
    #[inline(always)]
    pub fn slv_cmd8(&self) -> SLV_CMD8_R {
        SLV_CMD8_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - The enable bit for SPI slave CMD9 interrupt.
    #[inline(always)]
    pub fn slv_cmd9(&self) -> SLV_CMD9_R {
        SLV_CMD9_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - The enable bit for SPI slave CMDA interrupt.
    #[inline(always)]
