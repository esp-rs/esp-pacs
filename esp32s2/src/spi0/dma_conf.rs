...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_CONF")
            ...
            .field("ahbm_fifo_rst", &self.ahbm_fifo_rst().bit())
            .field("ahbm_rst", &self.ahbm_rst().bit())
            ...
            .field("dma_rx_stop", &self.dma_rx_stop().bit())
            .field("dma_tx_stop", &self.dma_tx_stop().bit())
            .field("dma_continue", &self.dma_continue().bit())
            .field("slv_last_seg_pop_clr", &self.slv_last_seg_pop_clr().bit())
            ...
            .field("dma_infifo_full_clr", &self.dma_infifo_full_clr().bit())
            .field("dma_outfifo_empty_clr", &self.dma_outfifo_empty_clr().bit())
            .field("ext_mem_bk_size", &self.ext_mem_bk_size().bits())
            .field("dma_seg_trans_clr", &self.dma_seg_trans_clr().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
