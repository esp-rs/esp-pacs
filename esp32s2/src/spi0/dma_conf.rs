...
///Field `IN_RST` reader - The bit is used to reset in dma fsm and in data fifo pointer.
pub type IN_RST_R = crate::BitReader;
///Field `IN_RST` writer - The bit is used to reset in dma fsm and in data fifo pointer.
pub type IN_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_RST` reader - The bit is used to reset out dma fsm and out data fifo pointer.
pub type OUT_RST_R = crate::BitReader;
///Field `OUT_RST` writer - The bit is used to reset out dma fsm and out data fifo pointer.
pub type OUT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AHBM_FIFO_RST` reader - Reset spi dma ahb master fifo pointer.
pub type AHBM_FIFO_RST_R = crate::BitReader;
///Field `AHBM_FIFO_RST` writer - Reset spi dma ahb master fifo pointer.
pub type AHBM_FIFO_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `AHBM_RST` reader - Reset spi dma ahb master.
pub type AHBM_RST_R = crate::BitReader;
///Field `AHBM_RST` writer - Reset spi dma ahb master.
pub type AHBM_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IN_LOOP_TEST` reader - Set bit to test in link.
pub type IN_LOOP_TEST_R = crate::BitReader;
///Field `IN_LOOP_TEST` writer - Set bit to test in link.
pub type IN_LOOP_TEST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_LOOP_TEST` reader - Set bit to test out link.
pub type OUT_LOOP_TEST_R = crate::BitReader;
///Field `OUT_LOOP_TEST` writer - Set bit to test out link.
pub type OUT_LOOP_TEST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_AUTO_WRBACK` reader - when the bit is set, DMA continue to use the next inlink node when the length of inlink is 0.
pub type OUT_AUTO_WRBACK_R = crate::BitReader;
///Field `OUT_AUTO_WRBACK` writer - when the bit is set, DMA continue to use the next inlink node when the length of inlink is 0.
pub type OUT_AUTO_WRBACK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_EOF_MODE` reader - out eof flag generation mode . 1: when dma pop all data from fifo 0:when ahb push all data to fifo.
pub type OUT_EOF_MODE_R = crate::BitReader;
///Field `OUT_EOF_MODE` writer - out eof flag generation mode . 1: when dma pop all data from fifo 0:when ahb push all data to fifo.
pub type OUT_EOF_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTDSCR_BURST_EN` reader - read descriptor use burst mode when read data for memory.
pub type OUTDSCR_BURST_EN_R = crate::BitReader;
///Field `OUTDSCR_BURST_EN` writer - read descriptor use burst mode when read data for memory.
pub type OUTDSCR_BURST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INDSCR_BURST_EN` reader - read descriptor use burst mode when write data to memory.
pub type INDSCR_BURST_EN_R = crate::BitReader;
///Field `INDSCR_BURST_EN` writer - read descriptor use burst mode when write data to memory.
pub type INDSCR_BURST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_DATA_BURST_EN` reader - spi dma read data from memory in burst mode.
pub type OUT_DATA_BURST_EN_R = crate::BitReader;
///Field `OUT_DATA_BURST_EN` writer - spi dma read data from memory in burst mode.
pub type OUT_DATA_BURST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_TRANS_EN` reader - 1: Internal memory data transfer enable bit. Send SPI DMA RX buffer data to SPI DMA TX buffer. 0: Disable this function.
pub type MEM_TRANS_EN_R = crate::BitReader;
///Field `MEM_TRANS_EN` writer - 1: Internal memory data transfer enable bit. Send SPI DMA RX buffer data to SPI DMA TX buffer. 0: Disable this function.
pub type MEM_TRANS_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_RX_STOP` reader - spi dma read data stop when in continue tx/rx mode.
pub type DMA_RX_STOP_R = crate::BitReader;
///Field `DMA_RX_STOP` writer - spi dma read data stop when in continue tx/rx mode.
pub type DMA_RX_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_TX_STOP` reader - spi dma write data stop when in continue tx/rx mode.
pub type DMA_TX_STOP_R = crate::BitReader;
///Field `DMA_TX_STOP` writer - spi dma write data stop when in continue tx/rx mode.
pub type DMA_TX_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_CONTINUE` reader - spi dma continue tx/rx data.
pub type DMA_CONTINUE_R = crate::BitReader;
///Field `DMA_CONTINUE` writer - spi dma continue tx/rx data.
pub type DMA_CONTINUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_LAST_SEG_POP_CLR` reader - 1: Clear spi_slv_seg_frt_pop_mask. 0 : others
pub type SLV_LAST_SEG_POP_CLR_R = crate::BitReader;
///Field `SLV_LAST_SEG_POP_CLR` writer - 1: Clear spi_slv_seg_frt_pop_mask. 0 : others
...
///Field `SLV_RX_SEG_TRANS_CLR_EN` reader - 1: spi_dma_infifo_full_vld is cleared by spi slave CMD5. 0: spi_dma_infifo_full_vld is cleared by SPI_TRANS_DONE.
pub type SLV_RX_SEG_TRANS_CLR_EN_R = crate::BitReader;
///Field `SLV_RX_SEG_TRANS_CLR_EN` writer - 1: spi_dma_infifo_full_vld is cleared by spi slave CMD5. 0: spi_dma_infifo_full_vld is cleared by SPI_TRANS_DONE.
pub type SLV_RX_SEG_TRANS_CLR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_TX_SEG_TRANS_CLR_EN` reader - 1: spi_dma_outfifo_empty_vld is cleared by spi slave CMD6. 0: spi_dma_outfifo_empty_vld is cleared by SPI_TRANS_DONE.
pub type SLV_TX_SEG_TRANS_CLR_EN_R = crate::BitReader;
///Field `SLV_TX_SEG_TRANS_CLR_EN` writer - 1: spi_dma_outfifo_empty_vld is cleared by spi slave CMD6. 0: spi_dma_outfifo_empty_vld is cleared by SPI_TRANS_DONE.
pub type SLV_TX_SEG_TRANS_CLR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_EOF_EN` reader - 1: SPI_IN_SUC_EOF_INT_RAW is set when the number of dma pushed data bytes is equal to the value of SPI_SLV_DMA_RD_BYTELEN\[19:0\]/ SPI_MST_DMA_RD_BYTELEN\[19:0\] in spi dma transition. 0: SPI_IN_SUC_EOF_INT_RAW is set by SPI_TRANS_DONE in non-seg-trans or SPI_DMA_SEG_TRANS_DONE in seg-trans.
pub type RX_EOF_EN_R = crate::BitReader;
///Field `RX_EOF_EN` writer - 1: SPI_IN_SUC_EOF_INT_RAW is set when the number of dma pushed data bytes is equal to the value of SPI_SLV_DMA_RD_BYTELEN\[19:0\]/ SPI_MST_DMA_RD_BYTELEN\[19:0\] in spi dma transition. 0: SPI_IN_SUC_EOF_INT_RAW is set by SPI_TRANS_DONE in non-seg-trans or SPI_DMA_SEG_TRANS_DONE in seg-trans.
pub type RX_EOF_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_INFIFO_FULL_CLR` reader - 1:Clear spi_dma_infifo_full_vld. 0: Do not control it.
pub type DMA_INFIFO_FULL_CLR_R = crate::BitReader;
///Field `DMA_INFIFO_FULL_CLR` writer - 1:Clear spi_dma_infifo_full_vld. 0: Do not control it.
pub type DMA_INFIFO_FULL_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_OUTFIFO_EMPTY_CLR` reader - 1:Clear spi_dma_outfifo_empty_vld. 0: Do not control it.
pub type DMA_OUTFIFO_EMPTY_CLR_R = crate::BitReader;
///Field `DMA_OUTFIFO_EMPTY_CLR` writer - 1:Clear spi_dma_outfifo_empty_vld. 0: Do not control it.
pub type DMA_OUTFIFO_EMPTY_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXT_MEM_BK_SIZE` reader - Select the external memory block size.
pub type EXT_MEM_BK_SIZE_R = crate::FieldReader;
///Field `EXT_MEM_BK_SIZE` writer - Select the external memory block size.
pub type EXT_MEM_BK_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_SEG_TRANS_CLR` reader - 1: End slave seg-trans, which acts as 0x05 command. 2 or more end seg-trans signals will induce error in DMA RX. 0: others. Will be cleared in 1 APB CLK cycles by hardware..
pub type DMA_SEG_TRANS_CLR_R = crate::BitReader;
///Field `DMA_SEG_TRANS_CLR` writer - 1: End slave seg-trans, which acts as 0x05 command. 2 or more end seg-trans signals will induce error in DMA RX. 0: others. Will be cleared in 1 APB CLK cycles by hardware..
...
///`reset()` method sets DMA_CONF to value 0x0200
