...
pub type SLV_LAST_SEG_POP_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_INFIFO_FULL_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_OUTFIFO_EMPTY_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_SEG_TRANS_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mem_trans_en(&mut self) -> MEM_TRANS_EN_W<DMA_CONF_SPEC, 13> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slv_last_seg_pop_clr(&mut self) -> SLV_LAST_SEG_POP_CLR_W<DMA_CONF_SPEC, 17> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_infifo_full_clr(&mut self) -> DMA_INFIFO_FULL_CLR_W<DMA_CONF_SPEC, 22> {
        DMA_INFIFO_FULL_CLR_W::new(self)
    }
    #[doc = "Bit 23 - 1:Clear spi_dma_outfifo_empty_vld. 0: Do not control it."]
    #[inline(always)]
    #[must_use]
    pub fn dma_outfifo_empty_clr(&mut self) -> DMA_OUTFIFO_EMPTY_CLR_W<DMA_CONF_SPEC, 23> {
        DMA_OUTFIFO_EMPTY_CLR_W::new(self)
    }
    #[doc = "Bits 26:27 - Select the external memory block size."]
    #[inline(always)]
    #[must_use]
    pub fn ext_mem_bk_size(&mut self) -> EXT_MEM_BK_SIZE_W<DMA_CONF_SPEC, 26> {
        EXT_MEM_BK_SIZE_W::new(self)
    }
    #[doc = "Bit 28 - 1: End slave seg-trans, which acts as 0x05 command. 2 or more end seg-trans signals will induce error in DMA RX. 0: others. Will be cleared in 1 APB CLK cycles by hardware.."]
    #[inline(always)]
    #[must_use]
    pub fn dma_seg_trans_clr(&mut self) -> DMA_SEG_TRANS_CLR_W<DMA_CONF_SPEC, 28> {
