///Register `LCD_D_MODE` reader
pub type R = crate::R<LCD_D_MODE_SPEC>;
///Register `LCD_D_MODE` writer
pub type W = crate::W<LCD_D_MODE_SPEC>;
///Field `D_DQS_MODE` reader - the output spi_dqs is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_DQS_MODE_R = crate::FieldReader;
///Field `D_DQS_MODE` writer - the output spi_dqs is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_DQS_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `D_CD_MODE` reader - the output spi_cd is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_CD_MODE_R = crate::FieldReader;
///Field `D_CD_MODE` writer - the output spi_cd is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_CD_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `D_DE_MODE` reader - the output spi_de is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_DE_MODE_R = crate::FieldReader;
///Field `D_DE_MODE` writer - the output spi_de is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_DE_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `D_HSYNC_MODE` reader - the output spi_hsync is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_HSYNC_MODE_R = crate::FieldReader;
///Field `D_HSYNC_MODE` writer - the output spi_hsync is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_HSYNC_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `D_VSYNC_MODE` reader - the output spi_vsync is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_VSYNC_MODE_R = crate::FieldReader;
///Field `D_VSYNC_MODE` writer - the output spi_vsync is delayed by system clock cycles, 0: output without delayed, 1: output with the posedge of clk_apb,2 output with the negedge of clk_apb, 3: output with the spi_clk. Can be configured in CONF state.
pub type D_VSYNC_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `DE_IDLE_POL` reader - It is the idle value of spi_de.
pub type DE_IDLE_POL_R = crate::BitReader;
///Field `DE_IDLE_POL` writer - It is the idle value of spi_de.
pub type DE_IDLE_POL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HS_BLANK_EN` reader - 1: The pulse of spi_hsync is out in vertical blanking lines in seg-trans or one trans. 0: spi_hsync pulse is valid only in active region lines in seg-trans.
pub type HS_BLANK_EN_R = crate::BitReader;
///Field `HS_BLANK_EN` writer - 1: The pulse of spi_hsync is out in vertical blanking lines in seg-trans or one trans. 0: spi_hsync pulse is valid only in active region lines in seg-trans.
...
You can [`read`](crate::generic::Reg::read) this register and get [`lcd_d_mode::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lcd_d_mode::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct LCD_D_MODE_SPEC;
impl crate::RegisterSpec for LCD_D_MODE_SPEC {
    type Ux = u32;
}
///`read()` method returns [`lcd_d_mode::R`](R) reader structure
impl crate::Readable for LCD_D_MODE_SPEC {}
///`write(|w| ..)` method takes [`lcd_d_mode::W`](W) writer structure
impl crate::Writable for LCD_D_MODE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LCD_D_MODE to value 0
