...
pub type INFIFO_FULL_ERR_INT_ST_R = crate::BitReader<bool>;
#[doc = "Field `OUTFIFO_EMPTY_ERR_INT_ST` reader - The status bit for outfifo empty error."]
pub type OUTFIFO_EMPTY_ERR_INT_ST_R = crate::BitReader<bool>;
#[doc = "Field `SLV_CMD6_INT_ST` reader - The status bit for SPI slave CMD6 interrupt."]
pub type SLV_CMD6_INT_ST_R = crate::BitReader<bool>;
#[doc = "Field `SLV_CMD6_INT_ST` writer - The status bit for SPI slave CMD6 interrupt."]
pub type SLV_CMD6_INT_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_INT_ST_SPEC, bool, O>;
...
pub type SLV_CMD7_INT_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_INT_ST_SPEC, bool, O>;
...
pub type SLV_CMD8_INT_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_INT_ST_SPEC, bool, O>;
...
pub type SLV_CMD9_INT_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_INT_ST_SPEC, bool, O>;
...
pub type SLV_CMDA_INT_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_INT_ST_SPEC, bool, O>;
impl R {
