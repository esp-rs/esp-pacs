...
///Register `DMA_INT_ST` writer
pub type W = crate::W<DMA_INT_ST_SPEC>;
///Field `INLINK_DSCR_EMPTY` reader - The status bit for lack of enough inlink descriptors.
pub type INLINK_DSCR_EMPTY_R = crate::BitReader;
///Field `OUTLINK_DSCR_ERROR` reader - The status bit for outlink descriptor error.
pub type OUTLINK_DSCR_ERROR_R = crate::BitReader;
///Field `INLINK_DSCR_ERROR` reader - The status bit for inlink descriptor error.
pub type INLINK_DSCR_ERROR_R = crate::BitReader;
///Field `IN_DONE` reader - The status bit for completing usage of a inlink descriptor.
pub type IN_DONE_R = crate::BitReader;
///Field `IN_ERR_EOF` reader - The status bit for receiving error.
pub type IN_ERR_EOF_R = crate::BitReader;
///Field `IN_SUC_EOF` reader - The status bit for completing receiving all the packets from host.
pub type IN_SUC_EOF_R = crate::BitReader;
///Field `OUT_DONE` reader - The status bit for completing usage of a outlink descriptor.
pub type OUT_DONE_R = crate::BitReader;
///Field `OUT_EOF` reader - The status bit for sending a packet to host done.
pub type OUT_EOF_R = crate::BitReader;
///Field `OUT_TOTAL_EOF` reader - The status bit for sending all the packets to host done.
pub type OUT_TOTAL_EOF_R = crate::BitReader;
///Field `INFIFO_FULL_ERR` reader - The status bit for infifo full error.
pub type INFIFO_FULL_ERR_R = crate::BitReader;
///Field `OUTFIFO_EMPTY_ERR` reader - The status bit for outfifo empty error.
pub type OUTFIFO_EMPTY_ERR_R = crate::BitReader;
///Field `SLV_CMD6` reader - The status bit for SPI slave CMD6 interrupt.
pub type SLV_CMD6_R = crate::BitReader;
///Field `SLV_CMD6` writer - The status bit for SPI slave CMD6 interrupt.
...
///Field `SLV_CMD7` writer - The status bit for SPI slave CMD7 interrupt.
...
///Field `SLV_CMD8` writer - The status bit for SPI slave CMD8 interrupt.
...
///Field `SLV_CMD9` writer - The status bit for SPI slave CMD9 interrupt.
...
///Field `SLV_CMDA` writer - The status bit for SPI slave CMDA interrupt.
...
impl R {
    ...
    ///Bit 9 - The status bit for infifo full error.
    #[inline(always)]
    pub fn infifo_full_err(&self) -> INFIFO_FULL_ERR_R {
        INFIFO_FULL_ERR_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - The status bit for outfifo empty error.
    #[inline(always)]
...
///`write(|w| ..)` method takes [`dma_int_st::W`](W) writer structure
