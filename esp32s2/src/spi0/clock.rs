...
pub type CLKDIV_PRE_W<'a, const O: u8> = crate::FieldWriter<'a, CLOCK_SPEC, 13, O, u16>;
...
impl R {
    ...
    #[doc = "Bits 18:30 - In the master mode it is pre-divider of spi_clk. Can be configured in CONF state."]
    #[inline(always)]
