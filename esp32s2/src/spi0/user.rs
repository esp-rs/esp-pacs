...
pub type QPI_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OPI_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TSCK_I_EDGE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RSCK_I_EDGE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FWRITE_OCT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type USR_CONF_NXT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn qpi_mode(&mut self) -> QPI_MODE_W<USER_SPEC, 3> {
        QPI_MODE_W::new(self)
    }
    #[doc = "Bit 4 - Just for master mode. 1: spi controller is in OPI mode (all in 8-bit mode). 0: others. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn opi_mode(&mut self) -> OPI_MODE_W<USER_SPEC, 4> {
        OPI_MODE_W::new(self)
    }
    #[doc = "Bit 5 - In the slave mode, this bit can be used to change the polarity of tsck. 0: tsck = spi_ck_i. 1:tsck = !spi_ck_i."]
    #[inline(always)]
    #[must_use]
    pub fn tsck_i_edge(&mut self) -> TSCK_I_EDGE_W<USER_SPEC, 5> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rsck_i_edge(&mut self) -> RSCK_I_EDGE_W<USER_SPEC, 8> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fwrite_oct(&mut self) -> FWRITE_OCT_W<USER_SPEC, 14> {
        FWRITE_OCT_W::new(self)
    }
    #[doc = "Bit 15 - 1: Enable the DMA CONF phase of next seg-trans operation, which means seg-trans will continue. 0: The seg-trans will end after the current SPI seg-trans or this is not seg-trans mode. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn usr_conf_nxt(&mut self) -> USR_CONF_NXT_W<USER_SPEC, 15> {
