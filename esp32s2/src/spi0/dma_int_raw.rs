...
#[doc = "Field `INLINK_DSCR_EMPTY` reader - The raw bit for lack of enough inlink descriptors. Can be configured in CONF state."]
pub type INLINK_DSCR_EMPTY_R = crate::BitReader;
#[doc = "Field `OUTLINK_DSCR_ERROR` reader - The raw bit for outlink descriptor error. Can be configured in CONF state."]
pub type OUTLINK_DSCR_ERROR_R = crate::BitReader;
#[doc = "Field `INLINK_DSCR_ERROR` reader - The raw bit for inlink descriptor error. Can be configured in CONF state."]
pub type INLINK_DSCR_ERROR_R = crate::BitReader;
#[doc = "Field `IN_DONE` reader - The raw bit for completing usage of a inlink descriptor. Can be configured in CONF state."]
pub type IN_DONE_R = crate::BitReader;
#[doc = "Field `IN_ERR_EOF` reader - The raw bit for receiving error. Can be configured in CONF state."]
pub type IN_ERR_EOF_R = crate::BitReader;
#[doc = "Field `IN_SUC_EOF` reader - The raw bit for completing receiving all the packets from host. Can be configured in CONF state."]
pub type IN_SUC_EOF_R = crate::BitReader;
#[doc = "Field `OUT_DONE` reader - The raw bit for completing usage of a outlink descriptor. Can be configured in CONF state."]
pub type OUT_DONE_R = crate::BitReader;
#[doc = "Field `OUT_EOF` reader - The raw bit for sending a packet to host done. Can be configured in CONF state."]
pub type OUT_EOF_R = crate::BitReader;
#[doc = "Field `OUT_TOTAL_EOF` reader - The raw bit for sending all the packets to host done. Can be configured in CONF state."]
pub type OUT_TOTAL_EOF_R = crate::BitReader;
#[doc = "Field `INFIFO_FULL_ERR` reader - 1:SPI_DMA_INFIFO_FULL and spi_push_data_prep are valid, which means that DMA Rx buffer is full but push is valid. 0: Others. Can not be changed by CONF_buf."]
pub type INFIFO_FULL_ERR_R = crate::BitReader;
#[doc = "Field `OUTFIFO_EMPTY_ERR` reader - 1:SPI_DMA_OUTFIFO_EMPTY and spi_pop_data_prep are valid, which means that there is no data to pop but pop is valid. 0: Others. Can not be changed by CONF_buf."]
pub type OUTFIFO_EMPTY_ERR_R = crate::BitReader;
#[doc = "Field `SLV_CMD6` reader - The raw bit for SPI slave CMD6 interrupt."]
pub type SLV_CMD6_R = crate::BitReader;
#[doc = "Field `SLV_CMD6` writer - The raw bit for SPI slave CMD6 interrupt."]
pub type SLV_CMD6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLV_CMD7` reader - The raw bit for SPI slave CMD7 interrupt."]
pub type SLV_CMD7_R = crate::BitReader;
#[doc = "Field `SLV_CMD7` writer - The raw bit for SPI slave CMD7 interrupt."]
pub type SLV_CMD7_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLV_CMD8` reader - The raw bit for SPI slave CMD8 interrupt."]
pub type SLV_CMD8_R = crate::BitReader;
#[doc = "Field `SLV_CMD8` writer - The raw bit for SPI slave CMD8 interrupt."]
pub type SLV_CMD8_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLV_CMD9` reader - The raw bit for SPI slave CMD9 interrupt."]
pub type SLV_CMD9_R = crate::BitReader;
#[doc = "Field `SLV_CMD9` writer - The raw bit for SPI slave CMD9 interrupt."]
pub type SLV_CMD9_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLV_CMDA` reader - The raw bit for SPI slave CMDA interrupt."]
pub type SLV_CMDA_R = crate::BitReader;
#[doc = "Field `SLV_CMDA` writer - The raw bit for SPI slave CMDA interrupt."]
