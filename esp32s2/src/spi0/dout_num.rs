...
impl R {
    ...
    #[doc = "Bits 16:17"]
    #[inline(always)]
    pub fn douts_num(&self) -> DOUTS_NUM_R {
        DOUTS_NUM_R::new(((self.bits >> 16) & 3) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DOUT_NUM")
            .field("douts_num", &self.douts_num())
