///Register `SLV_WRBUF_DLEN` reader
pub type R = crate::R<SLV_WRBUF_DLEN_SPEC>;
///Register `SLV_WRBUF_DLEN` writer
pub type W = crate::W<SLV_WRBUF_DLEN_SPEC>;
///Field `SLV_WR_BUF_DONE` reader - The interrupt raw bit for the completion of write-buffer operation in the slave mode. Can not be changed by CONF_buf.
pub type SLV_WR_BUF_DONE_R = crate::BitReader;
///Field `SLV_WR_BUF_DONE` writer - The interrupt raw bit for the completion of write-buffer operation in the slave mode. Can not be changed by CONF_buf.
pub type SLV_WR_BUF_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CONF_BASE_BITLEN` reader - The basic spi_clk cycles of CONF state. The real cycle length of CONF state, if SPI_USR_CONF is enabled, is SPI_CONF_BASE_BITLEN\[6:0\] + SPI_CONF_BITLEN\[23:0\].
pub type CONF_BASE_BITLEN_R = crate::FieldReader;
///Field `CONF_BASE_BITLEN` writer - The basic spi_clk cycles of CONF state. The real cycle length of CONF state, if SPI_USR_CONF is enabled, is SPI_CONF_BASE_BITLEN\[6:0\] + SPI_CONF_BITLEN\[23:0\].
pub type CONF_BASE_BITLEN_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    ///Bit 24 - The interrupt raw bit for the completion of write-buffer operation in the slave mode. Can not be changed by CONF_buf.
    #[inline(always)]
    pub fn slv_wr_buf_done(&self) -> SLV_WR_BUF_DONE_R {
        SLV_WR_BUF_DONE_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bits 25:31 - The basic spi_clk cycles of CONF state. The real cycle length of CONF state, if SPI_USR_CONF is enabled, is SPI_CONF_BASE_BITLEN\[6:0\] + SPI_CONF_BITLEN\[23:0\].
    #[inline(always)]
...
///`read()` method returns [`slv_wrbuf_dlen::R`](R) reader structure
impl crate::Readable for SLV_WRBUF_DLEN_SPEC {}
///`write(|w| ..)` method takes [`slv_wrbuf_dlen::W`](W) writer structure
impl crate::Writable for SLV_WRBUF_DLEN_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SLV_WRBUF_DLEN to value 0xd800_0000
