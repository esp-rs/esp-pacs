...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_INSTATUS")
            .field("dma_indscr_addr", &self.dma_indscr_addr())
            .field("dma_indscr_state", &self.dma_indscr_state())
            .field("dma_in_state", &self.dma_in_state())
            .field("dma_infifo_cnt", &self.dma_infifo_cnt())
            .field("dma_infifo_full", &self.dma_infifo_full())
            .field("dma_infifo_empty", &self.dma_infifo_empty())
            .finish()
    }
}
/**SPI DMA RX status
...
///`read()` method returns [`dma_instatus::R`](R) reader structure
impl crate::Readable for DMA_INSTATUS_SPEC {}
///`reset()` method sets DMA_INSTATUS to value 0x8000_0000
