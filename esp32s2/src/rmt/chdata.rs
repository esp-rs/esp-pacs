...
///Field `DATA` reader - The read and write data register for CHANNEL%s by apb fifo access.
pub type DATA_R = crate::FieldReader<u32>;
///Field `DATA` writer - The read and write data register for CHANNEL%s by apb fifo access.
