...
///Field `CH_TX_END(0-3)` reader - The masked interrupt status bit for CH%s_TX_END_INT.
pub type CH_TX_END_R = crate::BitReader;
///Field `CH_RX_END(0-3)` reader - The masked interrupt status bit for CH%s_RX_END_INT.
pub type CH_RX_END_R = crate::BitReader;
///Field `CH_ERR(0-3)` reader - The masked interrupt status bit for CH%s_ERR_INT.
pub type CH_ERR_R = crate::BitReader;
///Field `CH_TX_THR_EVENT(0-3)` reader - The masked interrupt status bit for CH%s_TX_THR_EVENT_INT.
pub type CH_TX_THR_EVENT_R = crate::BitReader;
///Field `CH_TX_LOOP(0-3)` reader - The masked interrupt status bit for CH%s_TX_LOOP_INT.
...
impl R {
    ...
    ///Bit 3 - The masked interrupt status bit for CH1_TX_END_INT.
    #[inline(always)]
    pub fn ch1_tx_end(&self) -> CH_TX_END_R {
        CH_TX_END_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 6 - The masked interrupt status bit for CH2_TX_END_INT.
    #[inline(always)]
    pub fn ch2_tx_end(&self) -> CH_TX_END_R {
        CH_TX_END_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 9 - The masked interrupt status bit for CH3_TX_END_INT.
    #[inline(always)]
    pub fn ch3_tx_end(&self) -> CH_TX_END_R {
        CH_TX_END_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///The masked interrupt status bit for CH(0-3)_RX_END_INT.
    ///
    ...
    ///Bit 1 - The masked interrupt status bit for CH0_RX_END_INT.
    #[inline(always)]
    pub fn ch0_rx_end(&self) -> CH_RX_END_R {
        CH_RX_END_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 4 - The masked interrupt status bit for CH1_RX_END_INT.
    #[inline(always)]
    pub fn ch1_rx_end(&self) -> CH_RX_END_R {
        CH_RX_END_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 7 - The masked interrupt status bit for CH2_RX_END_INT.
    #[inline(always)]
    pub fn ch2_rx_end(&self) -> CH_RX_END_R {
        CH_RX_END_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 10 - The masked interrupt status bit for CH3_RX_END_INT.
    #[inline(always)]
    ...
    ///Bit 2 - The masked interrupt status bit for CH0_ERR_INT.
    #[inline(always)]
    ...
    ///Bit 8 - The masked interrupt status bit for CH2_ERR_INT.
    #[inline(always)]
    pub fn ch2_err(&self) -> CH_ERR_R {
        CH_ERR_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 11 - The masked interrupt status bit for CH3_ERR_INT.
    #[inline(always)]
    ...
    ///Bit 12 - The masked interrupt status bit for CH0_TX_THR_EVENT_INT.
    #[inline(always)]
    pub fn ch0_tx_thr_event(&self) -> CH_TX_THR_EVENT_R {
        CH_TX_THR_EVENT_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - The masked interrupt status bit for CH1_TX_THR_EVENT_INT.
    #[inline(always)]
    pub fn ch1_tx_thr_event(&self) -> CH_TX_THR_EVENT_R {
        CH_TX_THR_EVENT_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - The masked interrupt status bit for CH2_TX_THR_EVENT_INT.
    #[inline(always)]
    pub fn ch2_tx_thr_event(&self) -> CH_TX_THR_EVENT_R {
        CH_TX_THR_EVENT_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - The masked interrupt status bit for CH3_TX_THR_EVENT_INT.
    #[inline(always)]
    ...
    ///Bit 16 - The masked interrupt status bit for CH0_TX_LOOP_INT.
    #[inline(always)]
    pub fn ch0_tx_loop(&self) -> CH_TX_LOOP_R {
        CH_TX_LOOP_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - The masked interrupt status bit for CH1_TX_LOOP_INT.
    #[inline(always)]
    pub fn ch1_tx_loop(&self) -> CH_TX_LOOP_R {
        CH_TX_LOOP_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - The masked interrupt status bit for CH2_TX_LOOP_INT.
    #[inline(always)]
    pub fn ch2_tx_loop(&self) -> CH_TX_LOOP_R {
        CH_TX_LOOP_R::new(((self.bits >> 18) & 1) != 0)
    }
    ///Bit 19 - The masked interrupt status bit for CH3_TX_LOOP_INT.
    #[inline(always)]
