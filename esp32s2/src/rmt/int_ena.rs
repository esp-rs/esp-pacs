...
///Field `CH_TX_END(0-3)` reader - The interrupt enabled bit for CH%s_TX_END_INT.
pub type CH_TX_END_R = crate::BitReader;
///Field `CH_TX_END(0-3)` writer - The interrupt enabled bit for CH%s_TX_END_INT.
pub type CH_TX_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_RX_END(0-3)` reader - The interrupt enabled bit for CH%s_RX_END_INT.
pub type CH_RX_END_R = crate::BitReader;
///Field `CH_RX_END(0-3)` writer - The interrupt enabled bit for CH%s_RX_END_INT.
pub type CH_RX_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_ERR(0-3)` reader - The interrupt enabled bit for CH%s_ERR_INT.
pub type CH_ERR_R = crate::BitReader;
///Field `CH_ERR(0-3)` writer - The interrupt enabled bit for CH%s_ERR_INT.
pub type CH_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_TX_THR_EVENT(0-3)` reader - The interrupt enabled bit for CH%s_TX_THR_EVENT_INT.
pub type CH_TX_THR_EVENT_R = crate::BitReader;
///Field `CH_TX_THR_EVENT(0-3)` writer - The interrupt enabled bit for CH%s_TX_THR_EVENT_INT.
pub type CH_TX_THR_EVENT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_TX_LOOP(0-3)` reader - The interrupt enabled bit for CH%s_TX_LOOP_INT.
pub type CH_TX_LOOP_R = crate::BitReader;
///Field `CH_TX_LOOP(0-3)` writer - The interrupt enabled bit for CH%s_TX_LOOP_INT.
