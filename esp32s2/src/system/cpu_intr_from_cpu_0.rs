...
///Field `CPU_INTR_FROM_CPU_0` reader - Set this bit to generate CPU interrupt 0. This bit needs to be reset by software in the ISR process.
pub type CPU_INTR_FROM_CPU_0_R = crate::BitReader;
///Field `CPU_INTR_FROM_CPU_0` writer - Set this bit to generate CPU interrupt 0. This bit needs to be reset by software in the ISR process.
pub type CPU_INTR_FROM_CPU_0_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit to generate CPU interrupt 0. This bit needs to be reset by software in the ISR process.
    #[inline(always)]
