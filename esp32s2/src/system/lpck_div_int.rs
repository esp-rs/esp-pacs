...
impl W {
    #[doc = "Bits 0:11 - This field is used to set the integer number of the divider value."]
    #[inline(always)]
    pub fn lpck_div_num(&mut self) -> LPCK_DIV_NUM_W<'_, LPCK_DIV_INT_SPEC> {
        LPCK_DIV_NUM_W::new(self, 0)
    }
}
#[doc = "Low power clock divider integer register\n\nYou can [`read`](crate::Reg::read) this register and get [`lpck_div_int::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpck_div_int::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
