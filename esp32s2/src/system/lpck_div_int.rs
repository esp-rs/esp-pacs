///Register `LPCK_DIV_INT` reader
pub type R = crate::R<LPCK_DIV_INT_SPEC>;
///Register `LPCK_DIV_INT` writer
pub type W = crate::W<LPCK_DIV_INT_SPEC>;
///Field `LPCK_DIV_NUM` reader - This field is used to set the integer number of the divider value.
pub type LPCK_DIV_NUM_R = crate::FieldReader<u16>;
///Field `LPCK_DIV_NUM` writer - This field is used to set the integer number of the divider value.
pub type LPCK_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - This field is used to set the integer number of the divider value.
    #[inline(always)]
...
///`read()` method returns [`lpck_div_int::R`](R) reader structure
impl crate::Readable for LPCK_DIV_INT_SPEC {}
///`write(|w| ..)` method takes [`lpck_div_int::W`](W) writer structure
impl crate::Writable for LPCK_DIV_INT_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LPCK_DIV_INT to value 0xff
