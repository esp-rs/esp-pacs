...
///Field `CRYPTO_AES_RST` reader - Set this bit to reset cryptography AES.
pub type CRYPTO_AES_RST_R = crate::BitReader;
///Field `CRYPTO_AES_RST` writer - Set this bit to reset cryptography AES.
pub type CRYPTO_AES_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_SHA_RST` reader - Set this bit to reset cryptography SHA.
pub type CRYPTO_SHA_RST_R = crate::BitReader;
///Field `CRYPTO_SHA_RST` writer - Set this bit to reset cryptography SHA.
pub type CRYPTO_SHA_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_RSA_RST` reader - Set this bit to reset cryptography RSA.
pub type CRYPTO_RSA_RST_R = crate::BitReader;
///Field `CRYPTO_RSA_RST` writer - Set this bit to reset cryptography RSA.
pub type CRYPTO_RSA_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_DS_RST` reader - Set this bit to reset cryptography digital signature.
pub type CRYPTO_DS_RST_R = crate::BitReader;
///Field `CRYPTO_DS_RST` writer - Set this bit to reset cryptography digital signature.
pub type CRYPTO_DS_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_HMAC_RST` reader - Set this bit to reset cryptography HMAC.
pub type CRYPTO_HMAC_RST_R = crate::BitReader;
///Field `CRYPTO_HMAC_RST` writer - Set this bit to reset cryptography HMAC.
pub type CRYPTO_HMAC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_DMA_RST` reader - Set this bit to reset cryptography DMA.
pub type CRYPTO_DMA_RST_R = crate::BitReader;
///Field `CRYPTO_DMA_RST` writer - Set this bit to reset cryptography DMA.
pub type CRYPTO_DMA_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 1 - Set this bit to reset cryptography AES.
    #[inline(always)]
    pub fn crypto_aes_rst(&self) -> CRYPTO_AES_RST_R {
        CRYPTO_AES_RST_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Set this bit to reset cryptography SHA.
    #[inline(always)]
    pub fn crypto_sha_rst(&self) -> CRYPTO_SHA_RST_R {
        CRYPTO_SHA_RST_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Set this bit to reset cryptography RSA.
    #[inline(always)]
    pub fn crypto_rsa_rst(&self) -> CRYPTO_RSA_RST_R {
        CRYPTO_RSA_RST_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Set this bit to reset cryptography digital signature.
    #[inline(always)]
    pub fn crypto_ds_rst(&self) -> CRYPTO_DS_RST_R {
        CRYPTO_DS_RST_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Set this bit to reset cryptography HMAC.
    #[inline(always)]
    pub fn crypto_hmac_rst(&self) -> CRYPTO_HMAC_RST_R {
        CRYPTO_HMAC_RST_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Set this bit to reset cryptography DMA.
    #[inline(always)]
...
///`reset()` method sets PERIP_RST_EN1 to value 0x7e
