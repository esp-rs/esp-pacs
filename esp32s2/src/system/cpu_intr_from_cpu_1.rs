///Register `CPU_INTR_FROM_CPU_1` reader
pub type R = crate::R<CPU_INTR_FROM_CPU_1_SPEC>;
///Register `CPU_INTR_FROM_CPU_1` writer
pub type W = crate::W<CPU_INTR_FROM_CPU_1_SPEC>;
///Field `CPU_INTR_FROM_CPU_1` reader - Set this bit to generate CPU interrupt 1. This bit needs to be reset by software in the ISR process.
pub type CPU_INTR_FROM_CPU_1_R = crate::BitReader;
///Field `CPU_INTR_FROM_CPU_1` writer - Set this bit to generate CPU interrupt 1. This bit needs to be reset by software in the ISR process.
pub type CPU_INTR_FROM_CPU_1_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit to generate CPU interrupt 1. This bit needs to be reset by software in the ISR process.
    #[inline(always)]
...
///`read()` method returns [`cpu_intr_from_cpu_1::R`](R) reader structure
impl crate::Readable for CPU_INTR_FROM_CPU_1_SPEC {}
///`write(|w| ..)` method takes [`cpu_intr_from_cpu_1::W`](W) writer structure
