///Register `RTC_FASTMEM_CONFIG` reader
pub type R = crate::R<RTC_FASTMEM_CONFIG_SPEC>;
///Register `RTC_FASTMEM_CONFIG` writer
pub type W = crate::W<RTC_FASTMEM_CONFIG_SPEC>;
///Field `RTC_MEM_CRC_START` reader - Set this bit to start the CRC of RTC memory.
pub type RTC_MEM_CRC_START_R = crate::BitReader;
///Field `RTC_MEM_CRC_START` writer - Set this bit to start the CRC of RTC memory.
pub type RTC_MEM_CRC_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RTC_MEM_CRC_ADDR` reader - This field is used to set address of RTC memory for CRC.
pub type RTC_MEM_CRC_ADDR_R = crate::FieldReader<u16>;
///Field `RTC_MEM_CRC_ADDR` writer - This field is used to set address of RTC memory for CRC.
pub type RTC_MEM_CRC_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `RTC_MEM_CRC_LEN` reader - This field is used to set length of RTC memory for CRC based on start address.
pub type RTC_MEM_CRC_LEN_R = crate::FieldReader<u16>;
///Field `RTC_MEM_CRC_LEN` writer - This field is used to set length of RTC memory for CRC based on start address.
pub type RTC_MEM_CRC_LEN_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `RTC_MEM_CRC_FINISH` reader - This bit stores the status of RTC memory CRC. High level means finished while low level means not finished.
pub type RTC_MEM_CRC_FINISH_R = crate::BitReader;
impl R {
    ///Bit 8 - Set this bit to start the CRC of RTC memory.
    #[inline(always)]
    ...
    ///Bit 31 - This bit stores the status of RTC memory CRC. High level means finished while low level means not finished.
    #[inline(always)]
...
///`read()` method returns [`rtc_fastmem_config::R`](R) reader structure
impl crate::Readable for RTC_FASTMEM_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`rtc_fastmem_config::W`](W) writer structure
