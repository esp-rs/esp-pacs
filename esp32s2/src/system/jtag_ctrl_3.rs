///Register `JTAG_CTRL_3` writer
pub type W = crate::W<JTAG_CTRL_3_SPEC>;
///Field `CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_3` writer - Stores the 96 to 127 bits of the 256 bits register used to cancel the temporary disable of eFuse to JTAG.
...
impl W {
    ///Bits 0:31 - Stores the 96 to 127 bits of the 256 bits register used to cancel the temporary disable of eFuse to JTAG.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`jtag_ctrl_3::W`](W) writer structure
impl crate::Writable for JTAG_CTRL_3_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets JTAG_CTRL_3 to value 0
