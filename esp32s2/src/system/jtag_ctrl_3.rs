...
impl W {
    ...
    pub fn cancel_efuse_disable_jtag_temporary_3(
        &mut self,
    ) -> CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_3_W<'_, JTAG_CTRL_3_SPEC> {
        CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_3_W::new(self, 0)
    }
}
#[doc = "JTAG configuration register 3\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`jtag_ctrl_3::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
