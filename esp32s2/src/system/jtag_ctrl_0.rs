///Register `JTAG_CTRL_0` writer
pub type W = crate::W<JTAG_CTRL_0_SPEC>;
///Field `CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_0` writer - Stores the 0 to 31 bits of the 256 bits register used to cancel the temporary disable of eFuse to JTAG.
pub type CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
...
impl W {
    ...
    pub fn cancel_efuse_disable_jtag_temporary_0(
        &mut self,
    ) -> CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_0_W<JTAG_CTRL_0_SPEC> {
        CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_0_W::new(self, 0)
    }
}
...
///`write(|w| ..)` method takes [`jtag_ctrl_0::W`](W) writer structure
impl crate::Writable for JTAG_CTRL_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets JTAG_CTRL_0 to value 0
