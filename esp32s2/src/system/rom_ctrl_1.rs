///Register `ROM_CTRL_1` reader
pub type R = crate::R<ROM_CTRL_1_SPEC>;
///Register `ROM_CTRL_1` writer
pub type W = crate::W<ROM_CTRL_1_SPEC>;
///Field `ROM_FORCE_PD` reader - This field is used to power down internal ROM.
pub type ROM_FORCE_PD_R = crate::FieldReader;
///Field `ROM_FORCE_PD` writer - This field is used to power down internal ROM.
pub type ROM_FORCE_PD_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `ROM_FORCE_PU` reader - This field is used to power up internal ROM.
pub type ROM_FORCE_PU_R = crate::FieldReader;
///Field `ROM_FORCE_PU` writer - This field is used to power up internal ROM.
...
///`read()` method returns [`rom_ctrl_1::R`](R) reader structure
impl crate::Readable for ROM_CTRL_1_SPEC {}
///`write(|w| ..)` method takes [`rom_ctrl_1::W`](W) writer structure
impl crate::Writable for ROM_CTRL_1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ROM_CTRL_1 to value 0x0c
