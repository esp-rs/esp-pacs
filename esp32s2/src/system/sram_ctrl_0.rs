///Register `SRAM_CTRL_0` reader
pub type R = crate::R<SRAM_CTRL_0_SPEC>;
///Register `SRAM_CTRL_0` writer
pub type W = crate::W<SRAM_CTRL_0_SPEC>;
///Field `SRAM_FO` reader - This field is used to force on clock gate of internal SRAM.
pub type SRAM_FO_R = crate::FieldReader<u32>;
///Field `SRAM_FO` writer - This field is used to force on clock gate of internal SRAM.
pub type SRAM_FO_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - This field is used to force on clock gate of internal SRAM.
    #[inline(always)]
...
///`read()` method returns [`sram_ctrl_0::R`](R) reader structure
impl crate::Readable for SRAM_CTRL_0_SPEC {}
///`write(|w| ..)` method takes [`sram_ctrl_0::W`](W) writer structure
impl crate::Writable for SRAM_CTRL_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SRAM_CTRL_0 to value 0x003f_ffff
