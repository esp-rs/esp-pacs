///Register `ROM_CTRL_0` reader
pub type R = crate::R<ROM_CTRL_0_SPEC>;
///Register `ROM_CTRL_0` writer
pub type W = crate::W<ROM_CTRL_0_SPEC>;
///Field `ROM_FO` reader - This field is used to force on clock gate of internal ROM.
pub type ROM_FO_R = crate::FieldReader;
///Field `ROM_FO` writer - This field is used to force on clock gate of internal ROM.
pub type ROM_FO_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - This field is used to force on clock gate of internal ROM.
    #[inline(always)]
