...
///Field `CPU_INTR_FROM_CPU_2` reader - Set this bit to generate CPU interrupt 2. This bit needs to be reset by software in the ISR process.
pub type CPU_INTR_FROM_CPU_2_R = crate::BitReader;
///Field `CPU_INTR_FROM_CPU_2` writer - Set this bit to generate CPU interrupt 2. This bit needs to be reset by software in the ISR process.
pub type CPU_INTR_FROM_CPU_2_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit to generate CPU interrupt 2. This bit needs to be reset by software in the ISR process.
    #[inline(always)]
