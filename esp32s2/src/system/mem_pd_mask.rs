///Register `MEM_PD_MASK` reader
pub type R = crate::R<MEM_PD_MASK_SPEC>;
///Register `MEM_PD_MASK` writer
pub type W = crate::W<MEM_PD_MASK_SPEC>;
///Field `LSLP_MEM_PD_MASK` reader - Set this bit to allow the memory to work as usual when the chip enters the light-sleep state.
pub type LSLP_MEM_PD_MASK_R = crate::BitReader;
///Field `LSLP_MEM_PD_MASK` writer - Set this bit to allow the memory to work as usual when the chip enters the light-sleep state.
pub type LSLP_MEM_PD_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit to allow the memory to work as usual when the chip enters the light-sleep state.
    #[inline(always)]
...
///`read()` method returns [`mem_pd_mask::R`](R) reader structure
impl crate::Readable for MEM_PD_MASK_SPEC {}
///`write(|w| ..)` method takes [`mem_pd_mask::W`](W) writer structure
