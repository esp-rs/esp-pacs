...
///Field `REDUNDANT_ECO_DRIVE` reader - The redundant ECO drive bit to avoid optimization in circuits.
pub type REDUNDANT_ECO_DRIVE_R = crate::BitReader;
///Field `REDUNDANT_ECO_DRIVE` writer - The redundant ECO drive bit to avoid optimization in circuits.
pub type REDUNDANT_ECO_DRIVE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REDUNDANT_ECO_RESULT` reader - The redundant ECO result bit to avoid optimization in circuits.
