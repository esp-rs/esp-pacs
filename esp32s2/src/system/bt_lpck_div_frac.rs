...
///Field `LPCLK_SEL_RTC_SLOW` reader - Set this bit to select RTC slow clock as the low power clock.
pub type LPCLK_SEL_RTC_SLOW_R = crate::BitReader;
///Field `LPCLK_SEL_RTC_SLOW` writer - Set this bit to select RTC slow clock as the low power clock.
pub type LPCLK_SEL_RTC_SLOW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPCLK_SEL_8M` reader - Set this bit to select 8m clock as the low power clock.
pub type LPCLK_SEL_8M_R = crate::BitReader;
///Field `LPCLK_SEL_8M` writer - Set this bit to select 8m clock as the low power clock.
pub type LPCLK_SEL_8M_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPCLK_SEL_XTAL` reader - Set this bit to select xtal clock as the low power clock.
pub type LPCLK_SEL_XTAL_R = crate::BitReader;
///Field `LPCLK_SEL_XTAL` writer - Set this bit to select xtal clock as the low power clock.
pub type LPCLK_SEL_XTAL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPCLK_SEL_XTAL32K` reader - Set this bit to select xtal32k clock as the low power clock.
pub type LPCLK_SEL_XTAL32K_R = crate::BitReader;
///Field `LPCLK_SEL_XTAL32K` writer - Set this bit to select xtal32k clock as the low power clock.
pub type LPCLK_SEL_XTAL32K_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPCLK_RTC_EN` reader - Set this bit to enable the RTC low power clock.
pub type LPCLK_RTC_EN_R = crate::BitReader;
///Field `LPCLK_RTC_EN` writer - Set this bit to enable the RTC low power clock.
...
///`reset()` method sets BT_LPCK_DIV_FRAC to value 0x0200_0000
