...
///Field `CPU_INTR_FROM_CPU_3` reader - Set this bit to generate CPU interrupt 3. This bit needs to be reset by software in the ISR process.
pub type CPU_INTR_FROM_CPU_3_R = crate::BitReader;
///Field `CPU_INTR_FROM_CPU_3` writer - Set this bit to generate CPU interrupt 3. This bit needs to be reset by software in the ISR process.
