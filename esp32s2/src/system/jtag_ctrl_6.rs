...
impl W {
    ...
    pub fn cancel_efuse_disable_jtag_temporary_6(
        &mut self,
    ) -> CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_6_W<'_, JTAG_CTRL_6_SPEC> {
        CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_6_W::new(self, 0)
    }
}
#[doc = "JTAG configuration register 6\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`jtag_ctrl_6::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
