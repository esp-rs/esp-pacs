...
///Field `TIMERS_RST` reader - Set this bit to reset timers.
pub type TIMERS_RST_R = crate::BitReader;
///Field `TIMERS_RST` writer - Set this bit to reset timers.
pub type TIMERS_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI01_RST` reader - Set this bit to reset SPI0 and SPI1.
pub type SPI01_RST_R = crate::BitReader;
///Field `SPI01_RST` writer - Set this bit to reset SPI0 and SPI1.
pub type SPI01_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART_RST` reader - Set this bit to reset UART0.
pub type UART_RST_R = crate::BitReader;
///Field `UART_RST` writer - Set this bit to reset UART0.
pub type UART_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDG_RST` reader - Set this bit to reset WDG.
pub type WDG_RST_R = crate::BitReader;
///Field `WDG_RST` writer - Set this bit to reset WDG.
pub type WDG_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2S0_RST` reader - Set this bit to reset I2S0.
pub type I2S0_RST_R = crate::BitReader;
///Field `I2S0_RST` writer - Set this bit to reset I2S0.
pub type I2S0_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART1_RST` reader - Set this bit to reset UART1.
pub type UART1_RST_R = crate::BitReader;
///Field `UART1_RST` writer - Set this bit to reset UART1.
pub type UART1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI2_RST` reader - Set this bit to reset SPI2.
pub type SPI2_RST_R = crate::BitReader;
///Field `SPI2_RST` writer - Set this bit to reset SPI2.
pub type SPI2_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C_EXT0_RST` reader - Set this bit to reset I2C EXT0.
pub type I2C_EXT0_RST_R = crate::BitReader;
///Field `I2C_EXT0_RST` writer - Set this bit to reset I2C EXT0.
pub type I2C_EXT0_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UHCI0_RST` reader - Set this bit to reset UHCI0.
pub type UHCI0_RST_R = crate::BitReader;
///Field `UHCI0_RST` writer - Set this bit to reset UHCI0.
pub type UHCI0_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RMT_RST` reader - Set this bit to reset remote controller.
pub type RMT_RST_R = crate::BitReader;
///Field `RMT_RST` writer - Set this bit to reset remote controller.
pub type RMT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PCNT_RST` reader - Set this bit to reset pulse count.
pub type PCNT_RST_R = crate::BitReader;
///Field `PCNT_RST` writer - Set this bit to reset pulse count.
pub type PCNT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LEDC_RST` reader - Set this bit to reset LED PWM.
pub type LEDC_RST_R = crate::BitReader;
///Field `LEDC_RST` writer - Set this bit to reset LED PWM.
pub type LEDC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UHCI1_RST` reader - Set this bit to reset UHCI1.
pub type UHCI1_RST_R = crate::BitReader;
///Field `UHCI1_RST` writer - Set this bit to reset UHCI1.
pub type UHCI1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMERGROUP_RST` reader - Set this bit to reset timer group0.
pub type TIMERGROUP_RST_R = crate::BitReader;
///Field `TIMERGROUP_RST` writer - Set this bit to reset timer group0.
pub type TIMERGROUP_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EFUSE_RST` reader - Set this bit to reset eFuse.
pub type EFUSE_RST_R = crate::BitReader;
///Field `EFUSE_RST` writer - Set this bit to reset eFuse.
pub type EFUSE_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMERGROUP1_RST` reader - Set this bit to reset timer group1.
pub type TIMERGROUP1_RST_R = crate::BitReader;
///Field `TIMERGROUP1_RST` writer - Set this bit to reset timer group1.
pub type TIMERGROUP1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI3_RST` reader - Set this bit to reset SPI3.
pub type SPI3_RST_R = crate::BitReader;
///Field `SPI3_RST` writer - Set this bit to reset SPI3.
pub type SPI3_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM0_RST` reader - Set this bit to reset PWM0.
pub type PWM0_RST_R = crate::BitReader;
///Field `PWM0_RST` writer - Set this bit to reset PWM0.
pub type PWM0_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C_EXT1_RST` reader - Set this bit to reset I2C EXT1.
pub type I2C_EXT1_RST_R = crate::BitReader;
///Field `I2C_EXT1_RST` writer - Set this bit to reset I2C EXT1.
pub type I2C_EXT1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TWAI_RST` reader - Set this bit to reset CAN.
pub type TWAI_RST_R = crate::BitReader;
///Field `TWAI_RST` writer - Set this bit to reset CAN.
pub type TWAI_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM1_RST` reader - Set this bit to reset PWM1.
pub type PWM1_RST_R = crate::BitReader;
///Field `PWM1_RST` writer - Set this bit to reset PWM1.
pub type PWM1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2S1_RST` reader - Set this bit to reset I2S1.
pub type I2S1_RST_R = crate::BitReader;
///Field `I2S1_RST` writer - Set this bit to reset I2S1.
pub type I2S1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI2_DMA_RST` reader - Set this bit to reset SPI2 DMA.
pub type SPI2_DMA_RST_R = crate::BitReader;
///Field `SPI2_DMA_RST` writer - Set this bit to reset SPI2 DMA.
pub type SPI2_DMA_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USB_RST` reader - Set this bit to reset USB.
pub type USB_RST_R = crate::BitReader;
///Field `USB_RST` writer - Set this bit to reset USB.
pub type USB_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART_MEM_RST` reader - Set this bit to reset UART memory.
pub type UART_MEM_RST_R = crate::BitReader;
///Field `UART_MEM_RST` writer - Set this bit to reset UART memory.
pub type UART_MEM_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM2_RST` reader - Set this bit to reset PWM2.
pub type PWM2_RST_R = crate::BitReader;
///Field `PWM2_RST` writer - Set this bit to reset PWM2.
pub type PWM2_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM3_RST` reader - Set this bit to reset PWM3.
pub type PWM3_RST_R = crate::BitReader;
///Field `PWM3_RST` writer - Set this bit to reset PWM3.
pub type PWM3_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI3_DMA_RST` reader - Set this bit to reset SPI3 DMA.
pub type SPI3_DMA_RST_R = crate::BitReader;
///Field `SPI3_DMA_RST` writer - Set this bit to reset SPI3 DMA.
pub type SPI3_DMA_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APB_SARADC_RST` reader - Set this bit to reset SAR ADC.
pub type APB_SARADC_RST_R = crate::BitReader;
///Field `APB_SARADC_RST` writer - Set this bit to reset SAR ADC.
pub type APB_SARADC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYSTIMER_RST` reader - Set this bit to reset system timer.
pub type SYSTIMER_RST_R = crate::BitReader;
///Field `SYSTIMER_RST` writer - Set this bit to reset system timer.
pub type SYSTIMER_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC2_ARB_RST` reader - Set this bit to reset aribiter of ADC2.
pub type ADC2_ARB_RST_R = crate::BitReader;
///Field `ADC2_ARB_RST` writer - Set this bit to reset aribiter of ADC2.
pub type ADC2_ARB_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI4_RST` reader - Set this bit to reset SPI4.
pub type SPI4_RST_R = crate::BitReader;
///Field `SPI4_RST` writer - Set this bit to reset SPI4.
...
///`read()` method returns [`perip_rst_en0::R`](R) reader structure
impl crate::Readable for PERIP_RST_EN0_SPEC {}
///`write(|w| ..)` method takes [`perip_rst_en0::W`](W) writer structure
