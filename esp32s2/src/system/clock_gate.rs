...
#[doc = "Field `CLK_EN` reader - Set this bit to enable clock of this module."]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Set this bit to enable clock of this module."]
pub type CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, CLOCK_GATE_SPEC, O>;
impl R {
    #[doc = "Bit 0 - Set this bit to enable clock of this module."]
    #[inline(always)]
