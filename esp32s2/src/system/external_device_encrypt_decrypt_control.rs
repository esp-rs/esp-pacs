...
///Field `ENABLE_SPI_MANUAL_ENCRYPT` reader - Set this bit to enable Manual Encryption under SPI Boot mode.
pub type ENABLE_SPI_MANUAL_ENCRYPT_R = crate::BitReader;
///Field `ENABLE_SPI_MANUAL_ENCRYPT` writer - Set this bit to enable Manual Encryption under SPI Boot mode.
pub type ENABLE_SPI_MANUAL_ENCRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENABLE_DOWNLOAD_DB_ENCRYPT` reader - Set this bit to enable Auto Encryption under Download Boot mode.
pub type ENABLE_DOWNLOAD_DB_ENCRYPT_R = crate::BitReader;
///Field `ENABLE_DOWNLOAD_DB_ENCRYPT` writer - Set this bit to enable Auto Encryption under Download Boot mode.
pub type ENABLE_DOWNLOAD_DB_ENCRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENABLE_DOWNLOAD_G0CB_DECRYPT` reader - Set this bit to enable Auto Decryption under Download Boot mode.
pub type ENABLE_DOWNLOAD_G0CB_DECRYPT_R = crate::BitReader;
///Field `ENABLE_DOWNLOAD_G0CB_DECRYPT` writer - Set this bit to enable Auto Decryption under Download Boot mode.
pub type ENABLE_DOWNLOAD_G0CB_DECRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENABLE_DOWNLOAD_MANUAL_ENCRYPT` reader - Set this bit to enable Manual Encryption under Download Boot mode.
pub type ENABLE_DOWNLOAD_MANUAL_ENCRYPT_R = crate::BitReader;
///Field `ENABLE_DOWNLOAD_MANUAL_ENCRYPT` writer - Set this bit to enable Manual Encryption under Download Boot mode.
