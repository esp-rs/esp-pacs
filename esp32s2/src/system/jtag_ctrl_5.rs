...
pub type CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, JTAG_CTRL_5_SPEC, u32, u32, 32, O>;
impl W {
    ...
    pub fn cancel_efuse_disable_jtag_temporary_5(
        &mut self,
    ) -> CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_5_W<0> {
...
#[doc = "JTAG configuration register 5\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [jtag_ctrl_5](index.html) module"]
