///Register `JTAG_CTRL_5` writer
pub type W = crate::W<JTAG_CTRL_5_SPEC>;
///Field `CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_5` writer - Stores the 160 to 191 bits of the 256 bits register used to cancel the temporary disable of eFuse to JTAG.
...
impl W {
    ///Bits 0:31 - Stores the 160 to 191 bits of the 256 bits register used to cancel the temporary disable of eFuse to JTAG.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`jtag_ctrl_5::W`](W) writer structure
impl crate::Writable for JTAG_CTRL_5_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets JTAG_CTRL_5 to value 0
