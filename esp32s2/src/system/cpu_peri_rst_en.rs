...
///Field `RST_EN_DEDICATED_GPIO` reader - Set this bit to reset DEDICATED GPIO module.
pub type RST_EN_DEDICATED_GPIO_R = crate::BitReader;
///Field `RST_EN_DEDICATED_GPIO` writer - Set this bit to reset DEDICATED GPIO module.
...
///`reset()` method sets CPU_PERI_RST_EN to value 0x80
