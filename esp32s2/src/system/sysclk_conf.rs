...
///Field `PRE_DIV_CNT` reader - This field is used to set the count of prescaler of XTAL\_CLK.
pub type PRE_DIV_CNT_R = crate::FieldReader<u16>;
///Field `PRE_DIV_CNT` writer - This field is used to set the count of prescaler of XTAL\_CLK.
...
impl R {
    ///Bits 0:9 - This field is used to set the count of prescaler of XTAL\_CLK.
    #[inline(always)]
    ...
    ///Bit 19 - Not used, extends from ESP32.
    #[inline(always)]
