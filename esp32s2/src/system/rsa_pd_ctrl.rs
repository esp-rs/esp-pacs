...
impl R {
    ///Bit 0 - Set this bit to power down RSA memory. This bit has the lowest priority. When Digital Signature occupies the RSA, this bit is invalid.
    #[inline(always)]
    pub fn rsa_mem_pd(&self) -> RSA_MEM_PD_R {
        RSA_MEM_PD_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set this bit to force power up RSA memory. This bit has the second highest priority.
    #[inline(always)]
    pub fn rsa_mem_force_pu(&self) -> RSA_MEM_FORCE_PU_R {
        RSA_MEM_FORCE_PU_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Set this bit to force power down RSA memory. This bit has the highest priority.
    #[inline(always)]
