///Register `BUSTOEXTMEM_ENA` reader
pub type R = crate::R<BUSTOEXTMEM_ENA_SPEC>;
///Register `BUSTOEXTMEM_ENA` writer
pub type W = crate::W<BUSTOEXTMEM_ENA_SPEC>;
///Field `BUSTOEXTMEM_ENA` reader - Set this bit to enable bus to EDMA.
pub type BUSTOEXTMEM_ENA_R = crate::BitReader;
///Field `BUSTOEXTMEM_ENA` writer - Set this bit to enable bus to EDMA.
pub type BUSTOEXTMEM_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit to enable bus to EDMA.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BUSTOEXTMEM_ENA")
            .field("bustoextmem_ena", &self.bustoextmem_ena())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`bustoextmem_ena::R`](R) reader structure
impl crate::Readable for BUSTOEXTMEM_ENA_SPEC {}
///`write(|w| ..)` method takes [`bustoextmem_ena::W`](W) writer structure
impl crate::Writable for BUSTOEXTMEM_ENA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets BUSTOEXTMEM_ENA to value 0x01
