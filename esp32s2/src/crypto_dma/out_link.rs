...
#[doc = "Field `OUTLINK_ADDR` reader - This register stores the 20 least significant bits of the first transmit descriptor’s address."]
pub type OUTLINK_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `OUTLINK_ADDR` writer - This register stores the 20 least significant bits of the first transmit descriptor’s address."]
...
#[doc = "Field `OUTLINK_START` reader - Set this bit to enable DMA to read transmit descriptors."]
pub type OUTLINK_START_R = crate::BitReader;
#[doc = "Field `OUTLINK_START` writer - Set this bit to enable DMA to read transmit descriptors."]
