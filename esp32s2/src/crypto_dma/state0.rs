...
#[doc = "Field `INFIFO_CNT_DEBUG` reader - This register stores the byte number of the data in the receive descriptor’s FIFO."]
...
impl R {
    ...
    #[doc = "Bits 23:26 - This register stores the byte number of the data in the receive descriptor’s FIFO."]
    #[inline(always)]
