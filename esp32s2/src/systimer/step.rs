...
///Field `XTAL_STEP` reader - Set system timer increment step when using XTAL_CLK.
pub type XTAL_STEP_R = crate::FieldReader<u16>;
///Field `XTAL_STEP` writer - Set system timer increment step when using XTAL_CLK.
pub type XTAL_STEP_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `PLL_STEP` reader - Set system timer increment step when using PLL_CLK
pub type PLL_STEP_R = crate::FieldReader<u16>;
///Field `PLL_STEP` writer - Set system timer increment step when using PLL_CLK
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STEP")
            .field("xtal_step", &self.xtal_step())
            .field("pll_step", &self.pll_step())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`step::R`](R) reader structure
impl crate::Readable for STEP_SPEC {}
///`write(|w| ..)` method takes [`step::W`](W) writer structure
impl crate::Writable for STEP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets STEP to value 0x0450
