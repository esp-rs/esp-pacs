...
///Field `TARGET(0-2)` reader - Interrupt raw bit of system timer target %s.
pub type TARGET_R = crate::BitReader;
impl R {
    ///Interrupt raw bit of system timer target (0-2).
    ///
    ...
    ///Bit 0 - Interrupt raw bit of system timer target 0.
    #[inline(always)]
    pub fn target0(&self) -> TARGET_R {
        TARGET_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Interrupt raw bit of system timer target 1.
    #[inline(always)]
    pub fn target1(&self) -> TARGET_R {
        TARGET_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Interrupt raw bit of system timer target 2.
    #[inline(always)]
