...
/**SDIO_0 (rw) register accessor: SDIO permission control register 0.
...
///SDIO permission control register 0.
pub mod sdio_0;
/**SDIO_1 (rw) register accessor: SDIO permission control register 1.
...
///SDIO permission control register 1.
pub mod sdio_1;
/**MAC_DUMP_0 (rw) register accessor: MAC dump permission control register 0.
...
///MAC dump permission control register 0.
pub mod mac_dump_0;
/**MAC_DUMP_1 (rw) register accessor: MAC dump permission control register 1.
...
pub mod mac_dump_1;
/**PRO_IRAM0_0 (rw) register accessor: IBUS permission control register 0.
...
pub mod pro_iram0_0;
/**PRO_IRAM0_1 (rw) register accessor: IBUS permission control register 1.
...
///IBUS permission control register 1.
pub mod pro_iram0_1;
/**PRO_IRAM0_2 (rw) register accessor: IBUS permission control register 2.
...
pub mod pro_iram0_2;
/**PRO_IRAM0_3 (rw) register accessor: IBUS permission control register 3.
...
///IBUS permission control register 3.
pub mod pro_iram0_3;
/**PRO_IRAM0_4 (rw) register accessor: IBUS permission control register 4.
...
///IBUS permission control register 4.
pub mod pro_iram0_4;
/**PRO_IRAM0_5 (r) register accessor: IBUS status register.
...
pub mod pro_iram0_5;
/**PRO_DRAM0_0 (rw) register accessor: DBUS permission control register 0.
...
pub mod pro_dram0_0;
/**PRO_DRAM0_1 (rw) register accessor: DBUS permission control register 1.
...
pub mod pro_dram0_1;
/**PRO_DRAM0_2 (rw) register accessor: DBUS permission control register 2.
...
pub mod pro_dram0_2;
/**PRO_DRAM0_3 (rw) register accessor: DBUS permission control register 3.
...
pub mod pro_dram0_3;
/**PRO_DRAM0_4 (r) register accessor: DBUS status register.
...
pub mod pro_dram0_4;
/**PRO_DPORT_0 (rw) register accessor: PeriBus1 permission control register 0.
...
///PeriBus1 permission control register 0.
pub mod pro_dport_0;
/**PRO_DPORT_1 (rw) register accessor: PeriBus1 permission control register 1.
...
pub mod pro_dport_1;
/**PRO_DPORT_2 (rw) register accessor: PeriBus1 permission control register 2.
...
pub mod pro_dport_2;
/**PRO_DPORT_3 (rw) register accessor: PeriBus1 permission control register 3.
...
pub mod pro_dport_3;
/**PRO_DPORT_4 (rw) register accessor: PeriBus1 permission control register 4.
...
pub mod pro_dport_4;
/**PRO_DPORT_5 (rw) register accessor: PeriBus1 permission control register 5.
...
///PeriBus1 permission control register 5.
pub mod pro_dport_5;
/**PRO_DPORT_6 (rw) register accessor: PeriBus1 permission control register 6.
...
///PeriBus1 permission control register 6.
pub mod pro_dport_6;
/**PRO_DPORT_7 (r) register accessor: PeriBus1 status register.
...
pub mod pro_dport_7;
/**PRO_AHB_0 (rw) register accessor: PeriBus2 permission control register 0.
...
///PeriBus2 permission control register 0.
pub mod pro_ahb_0;
/**PRO_AHB_1 (rw) register accessor: PeriBus2 permission control register 1.
...
///PeriBus2 permission control register 1.
pub mod pro_ahb_1;
/**PRO_AHB_2 (rw) register accessor: PeriBus2 permission control register 2.
...
///PeriBus2 permission control register 2.
pub mod pro_ahb_2;
/**PRO_AHB_3 (rw) register accessor: PeriBus2 permission control register 3.
...
pub mod pro_ahb_3;
/**PRO_AHB_4 (r) register accessor: PeriBus2 status register.
...
///PeriBus2 status register.
pub mod pro_ahb_4;
/**PRO_TRACE_0 (rw) register accessor: Trace memory permission control register 0.
...
pub mod pro_trace_0;
/**PRO_TRACE_1 (rw) register accessor: Trace memory permission control register 1.
...
///Trace memory permission control register 1.
pub mod pro_trace_1;
/**PRO_CACHE_0 (rw) register accessor: Cache permission control register 0.
...
pub mod pro_cache_0;
/**PRO_CACHE_1 (rw) register accessor: Cache permission control register 1.
...
pub mod pro_cache_1;
/**PRO_CACHE_2 (rw) register accessor: Cache permission control register 2.
...
pub mod pro_cache_2;
/**PRO_CACHE_3 (r) register accessor: Icache status register.
...
pub mod pro_cache_3;
/**PRO_CACHE_4 (r) register accessor: Dcache status register.
...
pub mod pro_cache_4;
/**DMA_APB_I_0 (rw) register accessor: Internal DMA permission control register 0.
...
///Internal DMA permission control register 0.
pub mod dma_apb_i_0;
/**DMA_APB_I_1 (rw) register accessor: Internal DMA permission control register 1.
...
pub mod dma_apb_i_1;
/**DMA_APB_I_2 (rw) register accessor: Internal DMA permission control register 2.
...
///Internal DMA permission control register 2.
pub mod dma_apb_i_2;
/**DMA_APB_I_3 (r) register accessor: Internal DMA status register.
...
pub mod dma_apb_i_3;
/**DMA_RX_I_0 (rw) register accessor: RX Copy DMA permission control register 0.
...
///RX Copy DMA permission control register 0.
pub mod dma_rx_i_0;
/**DMA_RX_I_1 (rw) register accessor: RX Copy DMA permission control register 1.
...
///RX Copy DMA permission control register 1.
pub mod dma_rx_i_1;
/**DMA_RX_I_2 (rw) register accessor: RX Copy DMA permission control register 2.
...
///RX Copy DMA permission control register 2.
pub mod dma_rx_i_2;
/**DMA_RX_I_3 (r) register accessor: RX Copy DMA status register.
...
///RX Copy DMA status register.
pub mod dma_rx_i_3;
/**DMA_TX_I_0 (rw) register accessor: TX Copy DMA permission control register 0.
...
///TX Copy DMA permission control register 0.
pub mod dma_tx_i_0;
/**DMA_TX_I_1 (rw) register accessor: TX Copy DMA permission control register 1.
...
pub mod dma_tx_i_1;
/**DMA_TX_I_2 (rw) register accessor: TX Copy DMA permission control register 2.
...
pub mod dma_tx_i_2;
/**DMA_TX_I_3 (r) register accessor: TX Copy DMA status register.
...
///TX Copy DMA status register.
pub mod dma_tx_i_3;
/**PRO_BOOT_LOCATION_0 (rw) register accessor: Boot permission control register 0.
...
///Boot permission control register 0.
pub mod pro_boot_location_0;
/**PRO_BOOT_LOCATION_1 (rw) register accessor: Boot permission control register 1.
...
/**CACHE_SOURCE_0 (rw) register accessor: Cache access permission control register 0.
...
/**CACHE_SOURCE_1 (rw) register accessor: Cache access permission control register 1.
...
/**APB_PERIPHERAL_0 (rw) register accessor: Peripheral access permission control register 0.
...
///Peripheral access permission control register 0.
pub mod apb_peripheral_0;
/**APB_PERIPHERAL_1 (rw) register accessor: Peripheral access permission control register 1.
...
/**OCCUPY_0 (rw) register accessor: Occupy permission control register 0.
...
///Occupy permission control register 0.
pub mod occupy_0;
/**OCCUPY_1 (rw) register accessor: Occupy permission control register 1.
...
pub mod occupy_1;
/**OCCUPY_2 (rw) register accessor: Occupy permission control register 2.
...
///Occupy permission control register 2.
pub mod occupy_2;
/**OCCUPY_3 (rw) register accessor: Occupy permission control register 3.
...
pub mod occupy_3;
/**CACHE_TAG_ACCESS_0 (rw) register accessor: Cache tag permission control register 0.
...
///Cache tag permission control register 0.
pub mod cache_tag_access_0;
/**CACHE_TAG_ACCESS_1 (rw) register accessor: Cache tag permission control register 1.
...
/**CACHE_MMU_ACCESS_0 (rw) register accessor: Cache MMU permission control register 0.
...
/**CACHE_MMU_ACCESS_1 (rw) register accessor: Cache MMU permission control register 1.
...
/**APB_PERIPHERAL_INTR (rw) register accessor: PeribBus2 permission control register.
...
/**APB_PERIPHERAL_STATUS (r) register accessor: PeribBus2 peripheral access status register.
...
/**CPU_PERIPHERAL_STATUS (r) register accessor: PeribBus1 peripheral access status register.
...
///Clock gate register of permission control.
pub mod clock_gate;
