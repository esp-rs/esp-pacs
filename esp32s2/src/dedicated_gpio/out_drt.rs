...
pub struct W(crate::W<OUT_DRT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OUT_DRT_SPEC>;
    #[inline(always)]
...
impl From<crate::W<OUT_DRT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OUT_DRT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `VLAUE` writer - This register is used to configure directive output value of 8-channel dedicated GPIO."]
pub type VLAUE_W<'a, const O: u8> = crate::FieldWriter<'a, OUT_DRT_SPEC, 8, O>;
