///Register `OUT_DRT` writer
pub type W = crate::W<OUT_DRT_SPEC>;
///Field `VALUE` writer - This register is used to configure directive output value of 8-channel dedicated GPIO.
...
impl W {
    ///Bits 0:7 - This register is used to configure directive output value of 8-channel dedicated GPIO.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`out_drt::W`](W) writer structure
impl crate::Writable for OUT_DRT_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OUT_DRT to value 0
