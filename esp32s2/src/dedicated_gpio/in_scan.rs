...
///Field `IN_STATUS` reader - GPIO input value after configured by DEDIC_GPIO_IN_DLY_REG.
pub type IN_STATUS_R = crate::FieldReader;
impl R {
    ///Bits 0:7 - GPIO input value after configured by DEDIC_GPIO_IN_DLY_REG.
    #[inline(always)]
...
///`read()` method returns [`in_scan::R`](R) reader structure
impl crate::Readable for IN_SCAN_SPEC {}
///`reset()` method sets IN_SCAN to value 0
