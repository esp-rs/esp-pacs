...
pub type OUT_VALUE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type OUT_MSK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn out_value(&mut self) -> OUT_VALUE_W<OUT_MSK_SPEC, 0> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn out_msk(&mut self) -> OUT_MSK_W<OUT_MSK_SPEC, 8> {
        OUT_MSK_W::new(self)
    }
