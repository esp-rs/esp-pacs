///Register `OUT_MSK` writer
pub type W = crate::W<OUT_MSK_SPEC>;
///Field `OUT_VALUE` writer - This register is used to configure updated output value of 8-channel dedicated GPIO.
pub type OUT_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `OUT_MSK` writer - This register is used to configure channels which would be updated. 1: corresponding channel's output would be updated.
...
impl W {
    ///Bits 0:7 - This register is used to configure updated output value of 8-channel dedicated GPIO.
    #[inline(always)]
    #[must_use]
    pub fn out_value(&mut self) -> OUT_VALUE_W<OUT_MSK_SPEC> {
        OUT_VALUE_W::new(self, 0)
    }
    ///Bits 8:15 - This register is used to configure channels which would be updated. 1: corresponding channel's output would be updated.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`out_msk::W`](W) writer structure
impl crate::Writable for OUT_MSK_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OUT_MSK to value 0
