...
pub type GPIO0_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_CLR_SPEC, bool, O>;
#[doc = "Field `GPIO1_INT_CLR` writer - Set this bit to clear the DEDIC_GPIO1_INT_RAW interrupt."]
pub type GPIO1_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_CLR_SPEC, bool, O>;
#[doc = "Field `GPIO2_INT_CLR` writer - Set this bit to clear the DEDIC_GPIO2_INT_RAW interrupt."]
pub type GPIO2_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_CLR_SPEC, bool, O>;
#[doc = "Field `GPIO3_INT_CLR` writer - Set this bit to clear the DEDIC_GPIO3_INT_RAW interrupt."]
pub type GPIO3_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_CLR_SPEC, bool, O>;
#[doc = "Field `GPIO4_INT_CLR` writer - Set this bit to clear the DEDIC_GPIO4_INT_RAW interrupt."]
pub type GPIO4_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_CLR_SPEC, bool, O>;
#[doc = "Field `GPIO5_INT_CLR` writer - Set this bit to clear the DEDIC_GPIO5_INT_RAW interrupt."]
pub type GPIO5_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_CLR_SPEC, bool, O>;
