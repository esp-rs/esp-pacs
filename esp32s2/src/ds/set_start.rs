...
///Field `SET_START` writer - Write 1 to this register to activate the DS peripheral.
...
impl W {
    ///Bit 0 - Write 1 to this register to activate the DS peripheral.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`set_start::W`](W) writer structure
