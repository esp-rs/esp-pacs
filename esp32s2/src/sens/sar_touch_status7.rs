...
///Field `TOUCH_PAD7_DATA` reader - The data of touch pad 7, depending on the setting of SENS_TOUCH_DATA_SEL.
pub type TOUCH_PAD7_DATA_R = crate::FieldReader<u32>;
///Field `TOUCH_PAD7_DEBOUNCE` reader - Touch pad 7 debounce value.
pub type TOUCH_PAD7_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - The data of touch pad 7, depending on the setting of SENS_TOUCH_DATA_SEL.
    #[inline(always)]
    pub fn touch_pad7_data(&self) -> TOUCH_PAD7_DATA_R {
        TOUCH_PAD7_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - Touch pad 7 debounce value.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_STATUS7")
            .field("touch_pad7_data", &self.touch_pad7_data())
            .field("touch_pad7_debounce", &self.touch_pad7_debounce())
            .finish()
    }
}
/**Touch pad 7 status
