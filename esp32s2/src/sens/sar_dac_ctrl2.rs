...
#[doc = "Field `DAC_SCALE(1-2)` reader - DAC%s scaling. 00: no scale. 01: scale to 1/2. 10: scale to 1/4. 11: scale to 1/8."]
pub type DAC_SCALE_R = crate::FieldReader;
#[doc = "Field `DAC_SCALE(1-2)` writer - DAC%s scaling. 00: no scale. 01: scale to 1/2. 10: scale to 1/4. 11: scale to 1/8."]
pub type DAC_SCALE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `DAC_INV(1-2)` reader - Invert DAC%s. 00: do not invert any bits. 01: invert all bits. 10: invert MSB. 11: invert all bits except MSB."]
pub type DAC_INV_R = crate::FieldReader;
#[doc = "Field `DAC_INV(1-2)` writer - Invert DAC%s. 00: do not invert any bits. 01: invert all bits. 10: invert MSB. 11: invert all bits except MSB."]
