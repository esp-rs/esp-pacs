...
///Field `TOUCH_OUT_TH10` reader - Finger threshold for touch pad 10
pub type TOUCH_OUT_TH10_R = crate::FieldReader<u32>;
///Field `TOUCH_OUT_TH10` writer - Finger threshold for touch pad 10
pub type TOUCH_OUT_TH10_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_THRES10")
            .field("touch_out_th10", &self.touch_out_th10())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn touch_out_th10(&mut self) -> TOUCH_OUT_TH10_W<SAR_TOUCH_THRES10_SPEC> {
        TOUCH_OUT_TH10_W::new(self, 0)
    }
}
