...
///Field `SAR2_ATTEN` reader - 2-bit attenuation for each pad. \[1:0\] is used for channel 0, \[3:2\] is used for channel 1, etc.
pub type SAR2_ATTEN_R = crate::FieldReader<u32>;
///Field `SAR2_ATTEN` writer - 2-bit attenuation for each pad. \[1:0\] is used for channel 0, \[3:2\] is used for channel 1, etc.
