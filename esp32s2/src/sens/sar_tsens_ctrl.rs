...
pub type TSENS_READY_R = crate::BitReader<bool>;
#[doc = "Field `TSENS_INT_EN` reader - Enable temperature sensor to send out interrupt."]
pub type TSENS_INT_EN_R = crate::BitReader<bool>;
#[doc = "Field `TSENS_INT_EN` writer - Enable temperature sensor to send out interrupt."]
pub type TSENS_INT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAR_TSENS_CTRL_SPEC, bool, O>;
