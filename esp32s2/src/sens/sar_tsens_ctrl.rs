...
///Field `TSENS_OUT` reader - Temperature sensor data out.
pub type TSENS_OUT_R = crate::FieldReader;
///Field `TSENS_READY` reader - Indicate temperature sensor out ready.
pub type TSENS_READY_R = crate::BitReader;
///Field `TSENS_INT_EN` reader - Enable temperature sensor to send out interrupt.
pub type TSENS_INT_EN_R = crate::BitReader;
///Field `TSENS_INT_EN` writer - Enable temperature sensor to send out interrupt.
...
///Field `TSENS_POWER_UP_FORCE` reader - 1: dump out and power up controlled by software. 0: by FSM.
pub type TSENS_POWER_UP_FORCE_R = crate::BitReader;
///Field `TSENS_POWER_UP_FORCE` writer - 1: dump out and power up controlled by software. 0: by FSM.
pub type TSENS_POWER_UP_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TSENS_DUMP_OUT` reader - Temperature sensor dump out only active when SENS_TSENS_POWER_UP_FORCE = 1.
pub type TSENS_DUMP_OUT_R = crate::BitReader;
///Field `TSENS_DUMP_OUT` writer - Temperature sensor dump out only active when SENS_TSENS_POWER_UP_FORCE = 1.
