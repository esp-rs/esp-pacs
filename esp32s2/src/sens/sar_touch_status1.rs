...
///Field `TOUCH_PAD1_DATA` reader - The data of touch pad 1, depending on the setting of SENS_TOUCH_DATA_SEL.
pub type TOUCH_PAD1_DATA_R = crate::FieldReader<u32>;
///Field `TOUCH_PAD1_DEBOUNCE` reader - Touch pad 1 debounce value.
pub type TOUCH_PAD1_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - The data of touch pad 1, depending on the setting of SENS_TOUCH_DATA_SEL.
    #[inline(always)]
    pub fn touch_pad1_data(&self) -> TOUCH_PAD1_DATA_R {
        TOUCH_PAD1_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - Touch pad 1 debounce value.
    #[inline(always)]
