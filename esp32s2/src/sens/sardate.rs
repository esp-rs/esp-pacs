///Register `SARDATE` reader
pub type R = crate::R<SARDATE_SPEC>;
///Register `SARDATE` writer
pub type W = crate::W<SARDATE_SPEC>;
///Field `SAR_DATE` reader - Version Control Register
pub type SAR_DATE_R = crate::FieldReader<u32>;
///Field `SAR_DATE` writer - Version Control Register
...
///`read()` method returns [`sardate::R`](R) reader structure
impl crate::Readable for SARDATE_SPEC {}
///`write(|w| ..)` method takes [`sardate::W`](W) writer structure
impl crate::Writable for SARDATE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SARDATE to value 0x0190_6140
