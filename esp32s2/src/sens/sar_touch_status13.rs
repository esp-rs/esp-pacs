...
///Field `TOUCH_PAD13_DATA` reader - The data of touch pad 13, depending on the setting of SENS_TOUCH_DATA_SEL.
pub type TOUCH_PAD13_DATA_R = crate::FieldReader<u32>;
///Field `TOUCH_PAD13_DEBOUNCE` reader - Touch pad 13 debounce value.
