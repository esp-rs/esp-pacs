...
pub type TOUCH_PAD13_DATA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `TOUCH_PAD13_DEBOUNCE` reader - Touch pad 13 debounce value."]
pub type TOUCH_PAD13_DEBOUNCE_R = crate::FieldReader<u8, u8>;
impl R {
    ...
    pub fn touch_pad13_data(&self) -> TOUCH_PAD13_DATA_R {
        TOUCH_PAD13_DATA_R::new((self.bits & 0x003f_ffff) as u32)
    }
