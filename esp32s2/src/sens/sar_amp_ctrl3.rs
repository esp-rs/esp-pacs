...
///`read()` method returns [`sar_amp_ctrl3::R`](R) reader structure
impl crate::Readable for SAR_AMP_CTRL3_SPEC {}
///`write(|w| ..)` method takes [`sar_amp_ctrl3::W`](W) writer structure
