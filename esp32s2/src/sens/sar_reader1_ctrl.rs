...
///Register `SAR_READER1_CTRL` writer
...
///Field `SAR1_INT_EN` reader - Enable SAR ADC1 to send out interrupt.
pub type SAR1_INT_EN_R = crate::BitReader;
///Field `SAR1_INT_EN` writer - Enable SAR ADC1 to send out interrupt.
...
///`read()` method returns [`sar_reader1_ctrl::R`](R) reader structure
impl crate::Readable for SAR_READER1_CTRL_SPEC {}
///`write(|w| ..)` method takes [`sar_reader1_ctrl::W`](W) writer structure
