...
///Field `TOUCH_PAD_ACTIVE` reader - Touch active status
pub type TOUCH_PAD_ACTIVE_R = crate::FieldReader<u16>;
///Field `TOUCH_CHANNEL_CLR` writer - Clear touch channel
pub type TOUCH_CHANNEL_CLR_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `TOUCH_MEAS_DONE` reader - Signal flag that indicates one touch pad is done.
...
impl R {
    ...
    ///Bit 31 - Signal flag that indicates one touch pad is done.
    #[inline(always)]
