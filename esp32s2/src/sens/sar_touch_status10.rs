///Register `SAR_TOUCH_STATUS10` reader
pub type R = crate::R<SAR_TOUCH_STATUS10_SPEC>;
///Field `TOUCH_PAD10_DATA` reader - The data of touch pad 10, depending on the setting of SENS_TOUCH_DATA_SEL.
pub type TOUCH_PAD10_DATA_R = crate::FieldReader<u32>;
///Field `TOUCH_PAD10_DEBOUNCE` reader - Touch pad 10 debounce value.
pub type TOUCH_PAD10_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - The data of touch pad 10, depending on the setting of SENS_TOUCH_DATA_SEL.
    #[inline(always)]
    pub fn touch_pad10_data(&self) -> TOUCH_PAD10_DATA_R {
        TOUCH_PAD10_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - Touch pad 10 debounce value.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_STATUS10")
            .field("touch_pad10_data", &self.touch_pad10_data())
            .field("touch_pad10_debounce", &self.touch_pad10_debounce())
            .finish()
    }
}
/**Touch pad 10 status
...
///`read()` method returns [`sar_touch_status10::R`](R) reader structure
