...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_STATUS10")
            .field("touch_pad10_data", &self.touch_pad10_data().bits())
            .field("touch_pad10_debounce", &self.touch_pad10_debounce().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SAR_TOUCH_STATUS10_SPEC> {
