...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TSENS_CTRL2")
            ...
            .field("tsens_clkgate_en", &self.tsens_clkgate_en())
            .field("tsens_reset", &self.tsens_reset())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:11"]
    #[inline(always)]
    pub fn tsens_xpd_wait(&mut self) -> TSENS_XPD_WAIT_W<'_, SAR_TSENS_CTRL2_SPEC> {
        TSENS_XPD_WAIT_W::new(self, 0)
    }
    #[doc = "Bits 12:13"]
    #[inline(always)]
    pub fn tsens_xpd_force(&mut self) -> TSENS_XPD_FORCE_W<'_, SAR_TSENS_CTRL2_SPEC> {
        TSENS_XPD_FORCE_W::new(self, 12)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn tsens_clk_inv(&mut self) -> TSENS_CLK_INV_W<'_, SAR_TSENS_CTRL2_SPEC> {
        TSENS_CLK_INV_W::new(self, 14)
    }
    #[doc = "Bit 15 - Enable temperature sensor clock."]
    #[inline(always)]
    pub fn tsens_clkgate_en(&mut self) -> TSENS_CLKGATE_EN_W<'_, SAR_TSENS_CTRL2_SPEC> {
        TSENS_CLKGATE_EN_W::new(self, 15)
    }
    #[doc = "Bit 16 - Reset temperature sensor."]
    #[inline(always)]
    pub fn tsens_reset(&mut self) -> TSENS_RESET_W<'_, SAR_TSENS_CTRL2_SPEC> {
