...
///Field `TSENS_CLKGATE_EN` reader - Enable temperature sensor clock.
pub type TSENS_CLKGATE_EN_R = crate::BitReader;
///Field `TSENS_CLKGATE_EN` writer - Enable temperature sensor clock.
pub type TSENS_CLKGATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TSENS_RESET` reader - Reset temperature sensor.
pub type TSENS_RESET_R = crate::BitReader;
///Field `TSENS_RESET` writer - Reset temperature sensor.
