///Register `SAR_HALL_CTRL` reader
pub type R = crate::R<SAR_HALL_CTRL_SPEC>;
///Register `SAR_HALL_CTRL` writer
pub type W = crate::W<SAR_HALL_CTRL_SPEC>;
///Field `XPD_HALL` reader - Power on hall sensor and connect to VP and VN
pub type XPD_HALL_R = crate::BitReader;
///Field `XPD_HALL` writer - Power on hall sensor and connect to VP and VN
...
///Field `HALL_PHASE` reader - Reverse phase of hall sensor
pub type HALL_PHASE_R = crate::BitReader;
///Field `HALL_PHASE` writer - Reverse phase of hall sensor
...
///`read()` method returns [`sar_hall_ctrl::R`](R) reader structure
impl crate::Readable for SAR_HALL_CTRL_SPEC {}
///`write(|w| ..)` method takes [`sar_hall_ctrl::W`](W) writer structure
