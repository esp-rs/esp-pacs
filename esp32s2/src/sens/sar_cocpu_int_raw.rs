...
///Field `COCPU_TOUCH_DONE_INT_RAW` reader - TOUCH_DONE_INT interrupt raw bit
pub type COCPU_TOUCH_DONE_INT_RAW_R = crate::BitReader;
///Field `COCPU_TOUCH_INACTIVE_INT_RAW` reader - TOUCH_INACTIVE_INT interrupt raw bit
pub type COCPU_TOUCH_INACTIVE_INT_RAW_R = crate::BitReader;
///Field `COCPU_TOUCH_ACTIVE_INT_RAW` reader - TOUCH_ACTIVE_INT interrupt raw bit
pub type COCPU_TOUCH_ACTIVE_INT_RAW_R = crate::BitReader;
///Field `COCPU_SARADC1_INT_RAW` reader - SARADC1_DONE_INT interrupt raw bit
pub type COCPU_SARADC1_INT_RAW_R = crate::BitReader;
///Field `COCPU_SARADC2_INT_RAW` reader - SARADC2_DONE_INT interrupt raw bit
pub type COCPU_SARADC2_INT_RAW_R = crate::BitReader;
///Field `COCPU_TSENS_INT_RAW` reader - TSENS_DONE_INT interrupt raw bit
pub type COCPU_TSENS_INT_RAW_R = crate::BitReader;
///Field `COCPU_START_INT_RAW` reader - RISCV_START_INT interrupt raw bit
pub type COCPU_START_INT_RAW_R = crate::BitReader;
///Field `COCPU_SW_INT_RAW` reader - SW_INT interrupt raw bit
pub type COCPU_SW_INT_RAW_R = crate::BitReader;
///Field `COCPU_SWD_INT_RAW` reader - SWD_INT interrupt raw bit
pub type COCPU_SWD_INT_RAW_R = crate::BitReader;
impl R {
    ///Bit 0 - TOUCH_DONE_INT interrupt raw bit
    #[inline(always)]
    pub fn cocpu_touch_done_int_raw(&self) -> COCPU_TOUCH_DONE_INT_RAW_R {
        COCPU_TOUCH_DONE_INT_RAW_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - TOUCH_INACTIVE_INT interrupt raw bit
    #[inline(always)]
