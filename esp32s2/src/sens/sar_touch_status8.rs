...
///Field `TOUCH_PAD8_DATA` reader - The data of touch pad 8, depending on the setting of SENS_TOUCH_DATA_SEL.
pub type TOUCH_PAD8_DATA_R = crate::FieldReader<u32>;
///Field `TOUCH_PAD8_DEBOUNCE` reader - Touch pad 8 debounce value.
pub type TOUCH_PAD8_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - The data of touch pad 8, depending on the setting of SENS_TOUCH_DATA_SEL.
    #[inline(always)]
    pub fn touch_pad8_data(&self) -> TOUCH_PAD8_DATA_R {
        TOUCH_PAD8_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - Touch pad 8 debounce value.
    #[inline(always)]
