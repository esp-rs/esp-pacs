...
///Field `TOUCH_OUTEN` reader - Enable touch controller output.
pub type TOUCH_OUTEN_R = crate::FieldReader<u16>;
///Field `TOUCH_OUTEN` writer - Enable touch controller output.
pub type TOUCH_OUTEN_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `TOUCH_STATUS_CLR` writer - Clear all touch active status.
pub type TOUCH_STATUS_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_DATA_SEL` reader - 0 and 1: touch_raw_data; 2: base_line; 3: touch_smooth_data.
pub type TOUCH_DATA_SEL_R = crate::FieldReader;
///Field `TOUCH_DATA_SEL` writer - 0 and 1: touch_raw_data; 2: base_line; 3: touch_smooth_data.
pub type TOUCH_DATA_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_DENOISE_END` reader - Touch denoise done.
pub type TOUCH_DENOISE_END_R = crate::BitReader;
///Field `TOUCH_UNIT_END` reader - Indicate the completion of sampling.
pub type TOUCH_UNIT_END_R = crate::BitReader;
///Field `TOUCH_APPROACH_PAD2` reader - Indicate which pad is selected as proximity pad2
pub type TOUCH_APPROACH_PAD2_R = crate::FieldReader;
///Field `TOUCH_APPROACH_PAD2` writer - Indicate which pad is selected as proximity pad2
pub type TOUCH_APPROACH_PAD2_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TOUCH_APPROACH_PAD1` reader - Indicate which pad is selected as proximity pad1
pub type TOUCH_APPROACH_PAD1_R = crate::FieldReader;
///Field `TOUCH_APPROACH_PAD1` writer - Indicate which pad is selected as proximity pad1
pub type TOUCH_APPROACH_PAD1_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TOUCH_APPROACH_PAD0` reader - Indicate which pad is selected as proximity pad0
pub type TOUCH_APPROACH_PAD0_R = crate::FieldReader;
///Field `TOUCH_APPROACH_PAD0` writer - Indicate which pad is selected as proximity pad0
pub type TOUCH_APPROACH_PAD0_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bits 0:14 - Enable touch controller output.
    #[inline(always)]
    pub fn touch_outen(&self) -> TOUCH_OUTEN_R {
        TOUCH_OUTEN_R::new((self.bits & 0x7fff) as u16)
    }
    ///Bits 16:17 - 0 and 1: touch_raw_data; 2: base_line; 3: touch_smooth_data.
    #[inline(always)]
    pub fn touch_data_sel(&self) -> TOUCH_DATA_SEL_R {
        TOUCH_DATA_SEL_R::new(((self.bits >> 16) & 3) as u8)
    }
    ///Bit 18 - Touch denoise done.
    #[inline(always)]
    pub fn touch_denoise_end(&self) -> TOUCH_DENOISE_END_R {
        TOUCH_DENOISE_END_R::new(((self.bits >> 18) & 1) != 0)
    }
    ///Bit 19 - Indicate the completion of sampling.
    #[inline(always)]
    pub fn touch_unit_end(&self) -> TOUCH_UNIT_END_R {
        TOUCH_UNIT_END_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bits 20:23 - Indicate which pad is selected as proximity pad2
    #[inline(always)]
    pub fn touch_approach_pad2(&self) -> TOUCH_APPROACH_PAD2_R {
        TOUCH_APPROACH_PAD2_R::new(((self.bits >> 20) & 0x0f) as u8)
    }
    ///Bits 24:27 - Indicate which pad is selected as proximity pad1
    #[inline(always)]
    pub fn touch_approach_pad1(&self) -> TOUCH_APPROACH_PAD1_R {
        TOUCH_APPROACH_PAD1_R::new(((self.bits >> 24) & 0x0f) as u8)
    }
    ///Bits 28:31 - Indicate which pad is selected as proximity pad0
    #[inline(always)]
