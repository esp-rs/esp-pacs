...
///Field `MEAS2_DONE_SAR` reader - Indicate SAR ADC2 conversion is done.
pub type MEAS2_DONE_SAR_R = crate::BitReader;
///Field `MEAS2_START_SAR` reader - SAR ADC2 controller (in RTC) starts conversion, active only when SENS_MEAS2_START_FORCE = 1.
pub type MEAS2_START_SAR_R = crate::BitReader;
///Field `MEAS2_START_SAR` writer - SAR ADC2 controller (in RTC) starts conversion, active only when SENS_MEAS2_START_FORCE = 1.
pub type MEAS2_START_SAR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEAS2_START_FORCE` reader - 1: SAR ADC2 controller (in RTC) is started by software. 0: SAR ADC2 controller is started by ULP coprocessor.
pub type MEAS2_START_FORCE_R = crate::BitReader;
///Field `MEAS2_START_FORCE` writer - 1: SAR ADC2 controller (in RTC) is started by software. 0: SAR ADC2 controller is started by ULP coprocessor.
pub type MEAS2_START_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR2_EN_PAD` reader - SAR ADC2 pad enable bitmap, active only whenSENS_SAR2_EN_PAD_FORCE = 1.
pub type SAR2_EN_PAD_R = crate::FieldReader<u16>;
///Field `SAR2_EN_PAD` writer - SAR ADC2 pad enable bitmap, active only whenSENS_SAR2_EN_PAD_FORCE = 1.
pub type SAR2_EN_PAD_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `SAR2_EN_PAD_FORCE` reader - 1: SAR ADC2 pad enable bitmap is controlled by software. 0: SAR ADC2 pad enable bitmap is controlled by ULP coprocessor.
pub type SAR2_EN_PAD_FORCE_R = crate::BitReader;
///Field `SAR2_EN_PAD_FORCE` writer - 1: SAR ADC2 pad enable bitmap is controlled by software. 0: SAR ADC2 pad enable bitmap is controlled by ULP coprocessor.
...
impl R {
    ...
    ///Bit 16 - Indicate SAR ADC2 conversion is done.
    #[inline(always)]
