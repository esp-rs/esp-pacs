...
pub type TOUCH_PAD4_DATA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `TOUCH_PAD4_DEBOUNCE` reader - Touch pad 4 debounce value."]
pub type TOUCH_PAD4_DEBOUNCE_R = crate::FieldReader<u8, u8>;
impl R {
    ...
    pub fn touch_pad4_data(&self) -> TOUCH_PAD4_DATA_R {
        TOUCH_PAD4_DATA_R::new((self.bits & 0x003f_ffff) as u32)
    }
