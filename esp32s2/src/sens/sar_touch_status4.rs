...
///Field `TOUCH_PAD4_DATA` reader - The data of touch pad 4, depending on the setting of SENS_TOUCH_DATA_SEL.
pub type TOUCH_PAD4_DATA_R = crate::FieldReader<u32>;
///Field `TOUCH_PAD4_DEBOUNCE` reader - Touch pad 4 debounce value.
pub type TOUCH_PAD4_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - The data of touch pad 4, depending on the setting of SENS_TOUCH_DATA_SEL.
    #[inline(always)]
    pub fn touch_pad4_data(&self) -> TOUCH_PAD4_DATA_R {
        TOUCH_PAD4_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - Touch pad 4 debounce value.
    #[inline(always)]
