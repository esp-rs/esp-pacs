...
///Field `TOUCH_PAD2_DATA` reader - The data of touch pad 2, depending on the setting of SENS_TOUCH_DATA_SEL.
pub type TOUCH_PAD2_DATA_R = crate::FieldReader<u32>;
///Field `TOUCH_PAD2_DEBOUNCE` reader - Touch pad 2 debounce value.
pub type TOUCH_PAD2_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - The data of touch pad 2, depending on the setting of SENS_TOUCH_DATA_SEL.
    #[inline(always)]
    pub fn touch_pad2_data(&self) -> TOUCH_PAD2_DATA_R {
        TOUCH_PAD2_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - Touch pad 2 debounce value.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_STATUS2")
            .field("touch_pad2_data", &self.touch_pad2_data())
            .field("touch_pad2_debounce", &self.touch_pad2_debounce())
            .finish()
    }
}
/**Touch pad 2 status
