///Register `SAR_TOUCH_STATUS11` reader
pub type R = crate::R<SAR_TOUCH_STATUS11_SPEC>;
///Field `TOUCH_PAD11_DATA` reader - The data of touch pad 11, depending on the setting of SENS_TOUCH_DATA_SEL.
pub type TOUCH_PAD11_DATA_R = crate::FieldReader<u32>;
///Field `TOUCH_PAD11_DEBOUNCE` reader - Touch pad 11 debounce value.
pub type TOUCH_PAD11_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - The data of touch pad 11, depending on the setting of SENS_TOUCH_DATA_SEL.
    #[inline(always)]
    pub fn touch_pad11_data(&self) -> TOUCH_PAD11_DATA_R {
        TOUCH_PAD11_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - Touch pad 11 debounce value.
    #[inline(always)]
...
///`read()` method returns [`sar_touch_status11::R`](R) reader structure
