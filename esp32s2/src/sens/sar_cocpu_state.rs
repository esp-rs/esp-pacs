///Register `SAR_COCPU_STATE` reader
pub type R = crate::R<SAR_COCPU_STATE_SPEC>;
///Register `SAR_COCPU_STATE` writer
pub type W = crate::W<SAR_COCPU_STATE_SPEC>;
///Field `COCPU_DBG_TRIGGER` writer - Trigger ULP-RISCV debug registers
pub type COCPU_DBG_TRIGGER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_CLK_EN` reader - Check ULP-RISCV whether clk on
pub type COCPU_CLK_EN_R = crate::BitReader;
///Field `COCPU_RESET_N` reader - Check ULP-RISCV whether in reset state
pub type COCPU_RESET_N_R = crate::BitReader;
///Field `COCPU_EOI` reader - Check ULP-RISCV whether in interrupt state
pub type COCPU_EOI_R = crate::BitReader;
///Field `COCPU_TRAP` reader - Check ULP-RISCV whether in trap state
pub type COCPU_TRAP_R = crate::BitReader;
///Field `COCPU_EBREAK` reader - Check ULP-RISCV whether in ebreak
pub type COCPU_EBREAK_R = crate::BitReader;
impl R {
    ///Bit 26 - Check ULP-RISCV whether clk on
    #[inline(always)]
    pub fn cocpu_clk_en(&self) -> COCPU_CLK_EN_R {
        COCPU_CLK_EN_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bit 27 - Check ULP-RISCV whether in reset state
    #[inline(always)]
    pub fn cocpu_reset_n(&self) -> COCPU_RESET_N_R {
        COCPU_RESET_N_R::new(((self.bits >> 27) & 1) != 0)
    }
    ///Bit 28 - Check ULP-RISCV whether in interrupt state
    #[inline(always)]
    pub fn cocpu_eoi(&self) -> COCPU_EOI_R {
        COCPU_EOI_R::new(((self.bits >> 28) & 1) != 0)
    }
    ///Bit 29 - Check ULP-RISCV whether in trap state
    #[inline(always)]
    pub fn cocpu_trap(&self) -> COCPU_TRAP_R {
        COCPU_TRAP_R::new(((self.bits >> 29) & 1) != 0)
    }
    ///Bit 30 - Check ULP-RISCV whether in ebreak
    #[inline(always)]
...
impl W {
    ///Bit 25 - Trigger ULP-RISCV debug registers
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`sar_cocpu_state::R`](R) reader structure
impl crate::Readable for SAR_COCPU_STATE_SPEC {}
///`write(|w| ..)` method takes [`sar_cocpu_state::W`](W) writer structure
