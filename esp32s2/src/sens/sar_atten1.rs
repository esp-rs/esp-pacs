///Register `SAR_ATTEN1` reader
pub type R = crate::R<SAR_ATTEN1_SPEC>;
///Register `SAR_ATTEN1` writer
pub type W = crate::W<SAR_ATTEN1_SPEC>;
///Field `SAR1_ATTEN` reader - 2-bit attenuation for each pad. \[1:0\] is used for channel 0, \[3:2\] is used for channel 1, etc.
pub type SAR1_ATTEN_R = crate::FieldReader<u32>;
///Field `SAR1_ATTEN` writer - 2-bit attenuation for each pad. \[1:0\] is used for channel 0, \[3:2\] is used for channel 1, etc.
pub type SAR1_ATTEN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - 2-bit attenuation for each pad. \[1:0\] is used for channel 0, \[3:2\] is used for channel 1, etc.
    #[inline(always)]
...
///`read()` method returns [`sar_atten1::R`](R) reader structure
impl crate::Readable for SAR_ATTEN1_SPEC {}
///`write(|w| ..)` method takes [`sar_atten1::W`](W) writer structure
