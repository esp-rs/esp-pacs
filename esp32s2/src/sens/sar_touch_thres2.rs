...
pub type TOUCH_OUT_TH2_R = crate::FieldReader<u32>;
#[doc = "Field `TOUCH_OUT_TH2` writer - Finger threshold for touch pad 2"]
pub type TOUCH_OUT_TH2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 22, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn touch_out_th2(&mut self) -> TOUCH_OUT_TH2_W<SAR_TOUCH_THRES2_SPEC, 0> {
