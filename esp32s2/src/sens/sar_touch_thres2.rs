...
///Field `TOUCH_OUT_TH2` reader - Finger threshold for touch pad 2
pub type TOUCH_OUT_TH2_R = crate::FieldReader<u32>;
///Field `TOUCH_OUT_TH2` writer - Finger threshold for touch pad 2
pub type TOUCH_OUT_TH2_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - Finger threshold for touch pad 2
    #[inline(always)]
