///Register `SAR_TOUCH_THRES13` reader
pub type R = crate::R<SAR_TOUCH_THRES13_SPEC>;
///Register `SAR_TOUCH_THRES13` writer
pub type W = crate::W<SAR_TOUCH_THRES13_SPEC>;
///Field `TOUCH_OUT_TH13` reader - Finger threshold for touch pad 13
pub type TOUCH_OUT_TH13_R = crate::FieldReader<u32>;
///Field `TOUCH_OUT_TH13` writer - Finger threshold for touch pad 13
pub type TOUCH_OUT_TH13_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - Finger threshold for touch pad 13
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_THRES13")
            .field("touch_out_th13", &self.touch_out_th13())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`sar_touch_thres13::R`](R) reader structure
impl crate::Readable for SAR_TOUCH_THRES13_SPEC {}
///`write(|w| ..)` method takes [`sar_touch_thres13::W`](W) writer structure
