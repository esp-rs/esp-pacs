...
pub struct R(crate::R<DMA_TX_I_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_TX_I_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_TX_I_2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_TX_I_2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_TX_I_2` writer"]
pub struct W(crate::W<DMA_TX_I_2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_TX_I_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_TX_I_2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_TX_I_2_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_ilg_clr(&mut self) -> DMA_TX_I_ILG_CLR_W<0> {
        DMA_TX_I_ILG_CLR_W::new(self)
    }
    #[doc = "Bit 1 - The enable signal for TX Copy DMA access interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_ilg_en(&mut self) -> DMA_TX_I_ILG_EN_W<1> {
