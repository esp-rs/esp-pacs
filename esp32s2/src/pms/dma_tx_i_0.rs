///Register `DMA_TX_I_0` reader
pub type R = crate::R<DMA_TX_I_0_SPEC>;
///Register `DMA_TX_I_0` writer
pub type W = crate::W<DMA_TX_I_0_SPEC>;
///Field `DMA_TX_I_LOCK` reader - Lock register. Setting to 1 locks TX Copy DMA permission control registers.
pub type DMA_TX_I_LOCK_R = crate::BitReader;
///Field `DMA_TX_I_LOCK` writer - Lock register. Setting to 1 locks TX Copy DMA permission control registers.
...
///`read()` method returns [`dma_tx_i_0::R`](R) reader structure
impl crate::Readable for DMA_TX_I_0_SPEC {}
///`write(|w| ..)` method takes [`dma_tx_i_0::W`](W) writer structure
impl crate::Writable for DMA_TX_I_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMA_TX_I_0 to value 0
