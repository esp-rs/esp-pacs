...
pub type DMA_APB_I_ILG_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DMA_APB_I_2_SPEC, bool, O>;
...
pub type DMA_APB_I_ILG_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_APB_I_2_SPEC, bool, O>;
