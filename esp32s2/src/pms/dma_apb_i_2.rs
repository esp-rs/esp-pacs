///Register `DMA_APB_I_2` reader
pub type R = crate::R<DMA_APB_I_2_SPEC>;
///Register `DMA_APB_I_2` writer
pub type W = crate::W<DMA_APB_I_2_SPEC>;
///Field `DMA_APB_I_ILG_CLR` reader - The clear signal for internal DMA access interrupt.
pub type DMA_APB_I_ILG_CLR_R = crate::BitReader;
///Field `DMA_APB_I_ILG_CLR` writer - The clear signal for internal DMA access interrupt.
pub type DMA_APB_I_ILG_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_APB_I_ILG_EN` reader - The enable signal for internal DMA access interrupt.
pub type DMA_APB_I_ILG_EN_R = crate::BitReader;
///Field `DMA_APB_I_ILG_EN` writer - The enable signal for internal DMA access interrupt.
pub type DMA_APB_I_ILG_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_APB_I_ILG_INTR` reader - Internal DMA access interrupt signal.
pub type DMA_APB_I_ILG_INTR_R = crate::BitReader;
impl R {
    ///Bit 0 - The clear signal for internal DMA access interrupt.
    #[inline(always)]
    pub fn dma_apb_i_ilg_clr(&self) -> DMA_APB_I_ILG_CLR_R {
        DMA_APB_I_ILG_CLR_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The enable signal for internal DMA access interrupt.
    #[inline(always)]
    pub fn dma_apb_i_ilg_en(&self) -> DMA_APB_I_ILG_EN_R {
        DMA_APB_I_ILG_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Internal DMA access interrupt signal.
    #[inline(always)]
...
///`read()` method returns [`dma_apb_i_2::R`](R) reader structure
impl crate::Readable for DMA_APB_I_2_SPEC {}
///`write(|w| ..)` method takes [`dma_apb_i_2::W`](W) writer structure
impl crate::Writable for DMA_APB_I_2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMA_APB_I_2 to value 0
