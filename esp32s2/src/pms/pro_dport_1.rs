...
pub type PRO_DPORT_APB_PERIPHERAL_FORBID_R = crate::BitReader<bool>;
...
pub type PRO_DPORT_APB_PERIPHERAL_FORBID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRO_DPORT_1_SPEC, bool, O>;
...
pub type PRO_DPORT_RESERVE_FIFO_VALID_R = crate::FieldReader<u8, u8>;
...
pub type PRO_DPORT_RESERVE_FIFO_VALID_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRO_DPORT_1_SPEC, u8, u8, 4, O>;
impl R {
