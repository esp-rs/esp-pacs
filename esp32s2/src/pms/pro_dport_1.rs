...
pub type PRO_DPORT_APB_PERIPHERAL_FORBID_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_DPORT_RTCSLOW_SPLTADDR_W<'a, REG, const O: u8> =
...
pub type PRO_DPORT_RTCSLOW_L_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_DPORT_RTCSLOW_L_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_DPORT_RTCSLOW_H_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_DPORT_RTCSLOW_H_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_DPORT_RESERVE_FIFO_VALID_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
...
impl W {
    ...
    pub fn pro_dport_apb_peripheral_forbid(
        &mut self,
    ) -> PRO_DPORT_APB_PERIPHERAL_FORBID_W<PRO_DPORT_1_SPEC, 0> {
        PRO_DPORT_APB_PERIPHERAL_FORBID_W::new(self)
    }
    #[doc = "Bits 1:11 - Configure the split address of RTC FAST for PeriBus1 access."]
    #[inline(always)]
    #[must_use]
    pub fn pro_dport_rtcslow_spltaddr(
        &mut self,
    ) -> PRO_DPORT_RTCSLOW_SPLTADDR_W<PRO_DPORT_1_SPEC, 1> {
        PRO_DPORT_RTCSLOW_SPLTADDR_W::new(self)
    }
    #[doc = "Bit 12 - Setting to 1 grants PeriBus1 permission to read RTC FAST low address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_dport_rtcslow_l_r(&mut self) -> PRO_DPORT_RTCSLOW_L_R_W<PRO_DPORT_1_SPEC, 12> {
        PRO_DPORT_RTCSLOW_L_R_W::new(self)
    }
    #[doc = "Bit 13 - Setting to 1 grants PeriBus1 permission to write RTC FAST low address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_dport_rtcslow_l_w(&mut self) -> PRO_DPORT_RTCSLOW_L_W_W<PRO_DPORT_1_SPEC, 13> {
        PRO_DPORT_RTCSLOW_L_W_W::new(self)
    }
    #[doc = "Bit 14 - Setting to 1 grants PeriBus1 permission to read RTC FAST high address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_dport_rtcslow_h_r(&mut self) -> PRO_DPORT_RTCSLOW_H_R_W<PRO_DPORT_1_SPEC, 14> {
        PRO_DPORT_RTCSLOW_H_R_W::new(self)
    }
    #[doc = "Bit 15 - Setting to 1 grants PeriBus1 permission to write RTC FAST high address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_dport_rtcslow_h_w(&mut self) -> PRO_DPORT_RTCSLOW_H_W_W<PRO_DPORT_1_SPEC, 15> {
    ...
    pub fn pro_dport_reserve_fifo_valid(
        &mut self,
    ) -> PRO_DPORT_RESERVE_FIFO_VALID_W<PRO_DPORT_1_SPEC, 16> {
