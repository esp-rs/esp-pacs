...
impl W {
    ...
    pub fn pro_dport_apb_peripheral_forbid(
        &mut self,
    ) -> PRO_DPORT_APB_PERIPHERAL_FORBID_W<'_, PRO_DPORT_1_SPEC> {
    ...
    pub fn pro_dport_rtcslow_spltaddr(
        &mut self,
    ) -> PRO_DPORT_RTCSLOW_SPLTADDR_W<'_, PRO_DPORT_1_SPEC> {
        PRO_DPORT_RTCSLOW_SPLTADDR_W::new(self, 1)
    }
    #[doc = "Bit 12 - Setting to 1 grants PeriBus1 permission to read RTC FAST low address region."]
    #[inline(always)]
    pub fn pro_dport_rtcslow_l_r(&mut self) -> PRO_DPORT_RTCSLOW_L_R_W<'_, PRO_DPORT_1_SPEC> {
        PRO_DPORT_RTCSLOW_L_R_W::new(self, 12)
    }
    #[doc = "Bit 13 - Setting to 1 grants PeriBus1 permission to write RTC FAST low address region."]
    #[inline(always)]
    pub fn pro_dport_rtcslow_l_w(&mut self) -> PRO_DPORT_RTCSLOW_L_W_W<'_, PRO_DPORT_1_SPEC> {
        PRO_DPORT_RTCSLOW_L_W_W::new(self, 13)
    }
    #[doc = "Bit 14 - Setting to 1 grants PeriBus1 permission to read RTC FAST high address region."]
    #[inline(always)]
    pub fn pro_dport_rtcslow_h_r(&mut self) -> PRO_DPORT_RTCSLOW_H_R_W<'_, PRO_DPORT_1_SPEC> {
        PRO_DPORT_RTCSLOW_H_R_W::new(self, 14)
    }
    #[doc = "Bit 15 - Setting to 1 grants PeriBus1 permission to write RTC FAST high address region."]
    #[inline(always)]
    pub fn pro_dport_rtcslow_h_w(&mut self) -> PRO_DPORT_RTCSLOW_H_W_W<'_, PRO_DPORT_1_SPEC> {
    ...
    pub fn pro_dport_reserve_fifo_valid(
        &mut self,
    ) -> PRO_DPORT_RESERVE_FIFO_VALID_W<'_, PRO_DPORT_1_SPEC> {
