...
pub type DMA_TX_I_SRAM_0_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_0_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_1_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_1_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_2_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_2_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_3_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_3_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_4_SPLTADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 17, O, u32>;
...
pub type DMA_TX_I_SRAM_4_L_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_4_L_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_4_H_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_TX_I_SRAM_4_H_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_0_r(&mut self) -> DMA_TX_I_SRAM_0_R_W<DMA_TX_I_1_SPEC, 0> {
        DMA_TX_I_SRAM_0_R_W::new(self)
    }
    #[doc = "Bit 1 - Setting to 1 grants TX Copy DMA permission to write SRAM Block 0."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_0_w(&mut self) -> DMA_TX_I_SRAM_0_W_W<DMA_TX_I_1_SPEC, 1> {
        DMA_TX_I_SRAM_0_W_W::new(self)
    }
    #[doc = "Bit 2 - Setting to 1 grants TX Copy DMA permission to read SRAM Block 1."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_1_r(&mut self) -> DMA_TX_I_SRAM_1_R_W<DMA_TX_I_1_SPEC, 2> {
        DMA_TX_I_SRAM_1_R_W::new(self)
    }
    #[doc = "Bit 3 - Setting to 1 grants TX Copy DMA permission to write SRAM Block 1."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_1_w(&mut self) -> DMA_TX_I_SRAM_1_W_W<DMA_TX_I_1_SPEC, 3> {
        DMA_TX_I_SRAM_1_W_W::new(self)
    }
    #[doc = "Bit 4 - Setting to 1 grants TX Copy DMA permission to read SRAM Block 2."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_2_r(&mut self) -> DMA_TX_I_SRAM_2_R_W<DMA_TX_I_1_SPEC, 4> {
        DMA_TX_I_SRAM_2_R_W::new(self)
    }
    #[doc = "Bit 5 - Setting to 1 grants TX Copy DMA permission to write SRAM Block 2."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_2_w(&mut self) -> DMA_TX_I_SRAM_2_W_W<DMA_TX_I_1_SPEC, 5> {
        DMA_TX_I_SRAM_2_W_W::new(self)
    }
    #[doc = "Bit 6 - Setting to 1 grants TX Copy DMA permission to read SRAM Block 3."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_3_r(&mut self) -> DMA_TX_I_SRAM_3_R_W<DMA_TX_I_1_SPEC, 6> {
        DMA_TX_I_SRAM_3_R_W::new(self)
    }
    #[doc = "Bit 7 - Setting to 1 grants TX Copy DMA permission to write SRAM Block 3."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_3_w(&mut self) -> DMA_TX_I_SRAM_3_W_W<DMA_TX_I_1_SPEC, 7> {
        DMA_TX_I_SRAM_3_W_W::new(self)
    }
    #[doc = "Bits 8:24 - Configure the split address of SRAM Block 4-21 for TX Copy DMA access."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_4_spltaddr(&mut self) -> DMA_TX_I_SRAM_4_SPLTADDR_W<DMA_TX_I_1_SPEC, 8> {
        DMA_TX_I_SRAM_4_SPLTADDR_W::new(self)
    }
    #[doc = "Bit 25 - Setting to 1 grants TX Copy DMA permission to read SRAM Block 4-21 low address region."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_4_l_r(&mut self) -> DMA_TX_I_SRAM_4_L_R_W<DMA_TX_I_1_SPEC, 25> {
        DMA_TX_I_SRAM_4_L_R_W::new(self)
    }
    #[doc = "Bit 26 - Setting to 1 grants TX Copy DMA permission to write SRAM Block 4-21 low address region."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_4_l_w(&mut self) -> DMA_TX_I_SRAM_4_L_W_W<DMA_TX_I_1_SPEC, 26> {
        DMA_TX_I_SRAM_4_L_W_W::new(self)
    }
    #[doc = "Bit 27 - Setting to 1 grants TX Copy DMA permission to read SRAM Block 4-21 high address region."]
    #[inline(always)]
    #[must_use]
    pub fn dma_tx_i_sram_4_h_r(&mut self) -> DMA_TX_I_SRAM_4_H_R_W<DMA_TX_I_1_SPEC, 27> {
