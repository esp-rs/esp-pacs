///Register `PRO_DPORT_0` reader
pub type R = crate::R<PRO_DPORT_0_SPEC>;
///Register `PRO_DPORT_0` writer
pub type W = crate::W<PRO_DPORT_0_SPEC>;
///Field `PRO_DPORT_LOCK` reader - Lock register. Setting to 1 locks PeriBus1 permission control registers.
pub type PRO_DPORT_LOCK_R = crate::BitReader;
///Field `PRO_DPORT_LOCK` writer - Lock register. Setting to 1 locks PeriBus1 permission control registers.
pub type PRO_DPORT_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Lock register. Setting to 1 locks PeriBus1 permission control registers.
    #[inline(always)]
...
///`read()` method returns [`pro_dport_0::R`](R) reader structure
impl crate::Readable for PRO_DPORT_0_SPEC {}
///`write(|w| ..)` method takes [`pro_dport_0::W`](W) writer structure
impl crate::Writable for PRO_DPORT_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_DPORT_0 to value 0
