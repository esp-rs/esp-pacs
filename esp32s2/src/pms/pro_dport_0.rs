...
pub struct R(crate::R<PRO_DPORT_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_DPORT_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_DPORT_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_DPORT_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_DPORT_0` writer"]
pub struct W(crate::W<PRO_DPORT_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_DPORT_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_DPORT_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_DPORT_0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PRO_DPORT_LOCK` reader - Lock register. Setting to 1 locks PeriBus1 permission control registers."]
pub type PRO_DPORT_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `PRO_DPORT_LOCK` writer - Lock register. Setting to 1 locks PeriBus1 permission control registers."]
pub type PRO_DPORT_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRO_DPORT_0_SPEC, bool, O>;
impl R {
