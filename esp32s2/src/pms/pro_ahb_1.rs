...
pub type PRO_AHB_RTCSLOW_0_SPLTADDR_W<'a, REG, const O: u8> =
...
pub type PRO_AHB_RTCSLOW_0_L_F_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_AHB_RTCSLOW_0_L_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_AHB_RTCSLOW_0_L_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_AHB_RTCSLOW_0_H_F_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_AHB_RTCSLOW_0_H_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_AHB_RTCSLOW_0_H_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn pro_ahb_rtcslow_0_spltaddr(
        &mut self,
    ) -> PRO_AHB_RTCSLOW_0_SPLTADDR_W<PRO_AHB_1_SPEC, 0> {
        PRO_AHB_RTCSLOW_0_SPLTADDR_W::new(self)
    }
    #[doc = "Bit 11 - Setting to 1 grants PeriBus2 permission to fetch RTCSlow_0 low address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_0_l_f(&mut self) -> PRO_AHB_RTCSLOW_0_L_F_W<PRO_AHB_1_SPEC, 11> {
        PRO_AHB_RTCSLOW_0_L_F_W::new(self)
    }
    #[doc = "Bit 12 - Setting to 1 grants PeriBus2 permission to read RTCSlow_0 low address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_0_l_r(&mut self) -> PRO_AHB_RTCSLOW_0_L_R_W<PRO_AHB_1_SPEC, 12> {
        PRO_AHB_RTCSLOW_0_L_R_W::new(self)
    }
    #[doc = "Bit 13 - Setting to 1 grants PeriBus2 permission to write RTCSlow_0 low address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_0_l_w(&mut self) -> PRO_AHB_RTCSLOW_0_L_W_W<PRO_AHB_1_SPEC, 13> {
        PRO_AHB_RTCSLOW_0_L_W_W::new(self)
    }
    #[doc = "Bit 14 - Setting to 1 grants PeriBus2 permission to fetch RTCSlow_0 high address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_0_h_f(&mut self) -> PRO_AHB_RTCSLOW_0_H_F_W<PRO_AHB_1_SPEC, 14> {
        PRO_AHB_RTCSLOW_0_H_F_W::new(self)
    }
    #[doc = "Bit 15 - Setting to 1 grants PeriBus2 permission to read RTCSlow_0 high address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_0_h_r(&mut self) -> PRO_AHB_RTCSLOW_0_H_R_W<PRO_AHB_1_SPEC, 15> {
        PRO_AHB_RTCSLOW_0_H_R_W::new(self)
    }
    #[doc = "Bit 16 - Setting to 1 grants PeriBus2 permission to write RTCSlow_0 high address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_0_h_w(&mut self) -> PRO_AHB_RTCSLOW_0_H_W_W<PRO_AHB_1_SPEC, 16> {
