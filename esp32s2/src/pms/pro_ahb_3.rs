...
pub type PRO_AHB_ILG_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_AHB_ILG_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_ilg_clr(&mut self) -> PRO_AHB_ILG_CLR_W<PRO_AHB_3_SPEC, 0> {
        PRO_AHB_ILG_CLR_W::new(self)
    }
    #[doc = "Bit 1 - The enable signal for PeriBus2 access interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_ilg_en(&mut self) -> PRO_AHB_ILG_EN_W<PRO_AHB_3_SPEC, 1> {
