...
pub type DMA_RX_I_ILG_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_RX_I_ILG_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_rx_i_ilg_clr(&mut self) -> DMA_RX_I_ILG_CLR_W<DMA_RX_I_2_SPEC, 0> {
        DMA_RX_I_ILG_CLR_W::new(self)
    }
    #[doc = "Bit 1 - The enable signal for RX Copy DMA access interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn dma_rx_i_ilg_en(&mut self) -> DMA_RX_I_ILG_EN_W<DMA_RX_I_2_SPEC, 1> {
