...
pub type DMA_RX_I_ILG_CLR_W<'a, const O: u8> = crate::BitWriter<'a, DMA_RX_I_2_SPEC, O>;
...
pub type DMA_RX_I_ILG_EN_W<'a, const O: u8> = crate::BitWriter<'a, DMA_RX_I_2_SPEC, O>;
