///Register `OCCUPY_0` reader
pub type R = crate::R<OCCUPY_0_SPEC>;
///Register `OCCUPY_0` writer
pub type W = crate::W<OCCUPY_0_SPEC>;
///Field `OCCUPY_LOCK` reader - Lock register. Setting to 1 locks occupy permission control registers.
pub type OCCUPY_LOCK_R = crate::BitReader;
///Field `OCCUPY_LOCK` writer - Lock register. Setting to 1 locks occupy permission control registers.
pub type OCCUPY_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Lock register. Setting to 1 locks occupy permission control registers.
    #[inline(always)]
...
///`read()` method returns [`occupy_0::R`](R) reader structure
impl crate::Readable for OCCUPY_0_SPEC {}
///`write(|w| ..)` method takes [`occupy_0::W`](W) writer structure
impl crate::Writable for OCCUPY_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OCCUPY_0 to value 0
