///Register `DMA_RX_I_0` reader
pub type R = crate::R<DMA_RX_I_0_SPEC>;
///Register `DMA_RX_I_0` writer
pub type W = crate::W<DMA_RX_I_0_SPEC>;
///Field `DMA_RX_I_LOCK` reader - Lock register. Setting to 1 locks RX Copy DMA permission control registers.
pub type DMA_RX_I_LOCK_R = crate::BitReader;
///Field `DMA_RX_I_LOCK` writer - Lock register. Setting to 1 locks RX Copy DMA permission control registers.
pub type DMA_RX_I_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Lock register. Setting to 1 locks RX Copy DMA permission control registers.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_RX_I_0")
            .field("dma_rx_i_lock", &self.dma_rx_i_lock())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`dma_rx_i_0::R`](R) reader structure
impl crate::Readable for DMA_RX_I_0_SPEC {}
///`write(|w| ..)` method takes [`dma_rx_i_0::W`](W) writer structure
impl crate::Writable for DMA_RX_I_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMA_RX_I_0 to value 0
