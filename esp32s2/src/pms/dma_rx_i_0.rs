...
impl W {
    #[doc = "Bit 0 - Lock register. Setting to 1 locks RX Copy DMA permission control registers."]
    #[inline(always)]
    pub fn dma_rx_i_lock(&mut self) -> DMA_RX_I_LOCK_W<'_, DMA_RX_I_0_SPEC> {
        DMA_RX_I_LOCK_W::new(self, 0)
    }
}
#[doc = "RX Copy DMA permission control register 0.\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_rx_i_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_rx_i_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
