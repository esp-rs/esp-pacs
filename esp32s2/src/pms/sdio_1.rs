///Register `SDIO_1` reader
pub type R = crate::R<SDIO_1_SPEC>;
///Register `SDIO_1` writer
pub type W = crate::W<SDIO_1_SPEC>;
///Field `SDIO_DISABLE` reader - Setting to 1 disables the SDIO function.
pub type SDIO_DISABLE_R = crate::BitReader;
///Field `SDIO_DISABLE` writer - Setting to 1 disables the SDIO function.
pub type SDIO_DISABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Setting to 1 disables the SDIO function.
    #[inline(always)]
...
///`read()` method returns [`sdio_1::R`](R) reader structure
impl crate::Readable for SDIO_1_SPEC {}
///`write(|w| ..)` method takes [`sdio_1::W`](W) writer structure
impl crate::Writable for SDIO_1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDIO_1 to value 0
