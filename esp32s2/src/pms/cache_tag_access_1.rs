...
///Field `PRO_I_TAG_RD_ACS` reader - Setting to 1 permits read access to Icache tag memory.
pub type PRO_I_TAG_RD_ACS_R = crate::BitReader;
///Field `PRO_I_TAG_RD_ACS` writer - Setting to 1 permits read access to Icache tag memory.
pub type PRO_I_TAG_RD_ACS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_I_TAG_WR_ACS` reader - Setting to 1 permits write access to Icache tag memory.
pub type PRO_I_TAG_WR_ACS_R = crate::BitReader;
///Field `PRO_I_TAG_WR_ACS` writer - Setting to 1 permits write access to Icache tag memory.
pub type PRO_I_TAG_WR_ACS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_D_TAG_RD_ACS` reader - Setting to 1 permits read access to Dcache tag memory.
pub type PRO_D_TAG_RD_ACS_R = crate::BitReader;
///Field `PRO_D_TAG_RD_ACS` writer - Setting to 1 permits read access to Dcache tag memory.
pub type PRO_D_TAG_RD_ACS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_D_TAG_WR_ACS` reader - Setting to 1 permits write access to Dcache tag memory.
pub type PRO_D_TAG_WR_ACS_R = crate::BitReader;
///Field `PRO_D_TAG_WR_ACS` writer - Setting to 1 permits write access to Dcache tag memory.
pub type PRO_D_TAG_WR_ACS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Setting to 1 permits read access to Icache tag memory.
    #[inline(always)]
    pub fn pro_i_tag_rd_acs(&self) -> PRO_I_TAG_RD_ACS_R {
        PRO_I_TAG_RD_ACS_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Setting to 1 permits write access to Icache tag memory.
    #[inline(always)]
    pub fn pro_i_tag_wr_acs(&self) -> PRO_I_TAG_WR_ACS_R {
        PRO_I_TAG_WR_ACS_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Setting to 1 permits read access to Dcache tag memory.
    #[inline(always)]
    pub fn pro_d_tag_rd_acs(&self) -> PRO_D_TAG_RD_ACS_R {
        PRO_D_TAG_RD_ACS_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Setting to 1 permits write access to Dcache tag memory.
    #[inline(always)]
...
///`reset()` method sets CACHE_TAG_ACCESS_1 to value 0
