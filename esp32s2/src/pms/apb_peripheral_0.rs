///Register `APB_PERIPHERAL_0` reader
pub type R = crate::R<APB_PERIPHERAL_0_SPEC>;
///Register `APB_PERIPHERAL_0` writer
pub type W = crate::W<APB_PERIPHERAL_0_SPEC>;
///Field `APB_PERIPHERAL_LOCK` reader - Lock register. Setting to 1 locks TX Copy DMA permission control registers.
pub type APB_PERIPHERAL_LOCK_R = crate::BitReader;
///Field `APB_PERIPHERAL_LOCK` writer - Lock register. Setting to 1 locks TX Copy DMA permission control registers.
...
///`read()` method returns [`apb_peripheral_0::R`](R) reader structure
impl crate::Readable for APB_PERIPHERAL_0_SPEC {}
///`write(|w| ..)` method takes [`apb_peripheral_0::W`](W) writer structure
impl crate::Writable for APB_PERIPHERAL_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APB_PERIPHERAL_0 to value 0
