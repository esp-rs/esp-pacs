///Register `PRO_DRAM0_2` reader
pub type R = crate::R<PRO_DRAM0_2_SPEC>;
///Register `PRO_DRAM0_2` writer
pub type W = crate::W<PRO_DRAM0_2_SPEC>;
///Field `PRO_DRAM0_RTCFAST_SPLTADDR` reader - Configure the split address of RTC FAST for DBUS0 access.
pub type PRO_DRAM0_RTCFAST_SPLTADDR_R = crate::FieldReader<u16>;
///Field `PRO_DRAM0_RTCFAST_SPLTADDR` writer - Configure the split address of RTC FAST for DBUS0 access.
pub type PRO_DRAM0_RTCFAST_SPLTADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `PRO_DRAM0_RTCFAST_L_R` reader - Setting to 1 grants DBUS0 permission to read RTC FAST low address region.
pub type PRO_DRAM0_RTCFAST_L_R_R = crate::BitReader;
///Field `PRO_DRAM0_RTCFAST_L_R` writer - Setting to 1 grants DBUS0 permission to read RTC FAST low address region.
pub type PRO_DRAM0_RTCFAST_L_R_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DRAM0_RTCFAST_L_W` reader - Setting to 1 grants DBUS0 permission to write RTC FAST low address region.
pub type PRO_DRAM0_RTCFAST_L_W_R = crate::BitReader;
///Field `PRO_DRAM0_RTCFAST_L_W` writer - Setting to 1 grants DBUS0 permission to write RTC FAST low address region.
pub type PRO_DRAM0_RTCFAST_L_W_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DRAM0_RTCFAST_H_R` reader - Setting to 1 grants DBUS0 permission to read RTC FAST high address region.
pub type PRO_DRAM0_RTCFAST_H_R_R = crate::BitReader;
///Field `PRO_DRAM0_RTCFAST_H_R` writer - Setting to 1 grants DBUS0 permission to read RTC FAST high address region.
pub type PRO_DRAM0_RTCFAST_H_R_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DRAM0_RTCFAST_H_W` reader - Setting to 1 grants DBUS0 permission to write RTC FAST high address region.
pub type PRO_DRAM0_RTCFAST_H_W_R = crate::BitReader;
///Field `PRO_DRAM0_RTCFAST_H_W` writer - Setting to 1 grants DBUS0 permission to write RTC FAST high address region.
pub type PRO_DRAM0_RTCFAST_H_W_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:10 - Configure the split address of RTC FAST for DBUS0 access.
    #[inline(always)]
    ...
    ///Bit 11 - Setting to 1 grants DBUS0 permission to read RTC FAST low address region.
    #[inline(always)]
    pub fn pro_dram0_rtcfast_l_r(&self) -> PRO_DRAM0_RTCFAST_L_R_R {
        PRO_DRAM0_RTCFAST_L_R_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - Setting to 1 grants DBUS0 permission to write RTC FAST low address region.
    #[inline(always)]
    pub fn pro_dram0_rtcfast_l_w(&self) -> PRO_DRAM0_RTCFAST_L_W_R {
        PRO_DRAM0_RTCFAST_L_W_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - Setting to 1 grants DBUS0 permission to read RTC FAST high address region.
    #[inline(always)]
    pub fn pro_dram0_rtcfast_h_r(&self) -> PRO_DRAM0_RTCFAST_H_R_R {
        PRO_DRAM0_RTCFAST_H_R_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - Setting to 1 grants DBUS0 permission to write RTC FAST high address region.
    #[inline(always)]
...
///`read()` method returns [`pro_dram0_2::R`](R) reader structure
impl crate::Readable for PRO_DRAM0_2_SPEC {}
///`write(|w| ..)` method takes [`pro_dram0_2::W`](W) writer structure
impl crate::Writable for PRO_DRAM0_2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_DRAM0_2 to value 0x7800
