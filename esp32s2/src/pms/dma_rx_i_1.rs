...
pub type DMA_RX_I_SRAM_4_SPLTADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_RX_I_1_SPEC, u32, u32, 17, O>;
...
pub type DMA_RX_I_SRAM_4_L_R_R = crate::BitReader<bool>;
...
pub type DMA_RX_I_SRAM_4_L_R_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DMA_RX_I_1_SPEC, bool, O>;
...
pub type DMA_RX_I_SRAM_4_L_W_R = crate::BitReader<bool>;
...
pub type DMA_RX_I_SRAM_4_L_W_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DMA_RX_I_1_SPEC, bool, O>;
...
pub type DMA_RX_I_SRAM_4_H_R_R = crate::BitReader<bool>;
...
pub type DMA_RX_I_SRAM_4_H_R_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DMA_RX_I_1_SPEC, bool, O>;
...
pub type DMA_RX_I_SRAM_4_H_W_R = crate::BitReader<bool>;
...
pub type DMA_RX_I_SRAM_4_H_W_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DMA_RX_I_1_SPEC, bool, O>;
impl R {
    ...
    pub fn dma_rx_i_sram_4_spltaddr(&self) -> DMA_RX_I_SRAM_4_SPLTADDR_R {
        DMA_RX_I_SRAM_4_SPLTADDR_R::new(((self.bits >> 8) & 0x0001_ffff) as u32)
    }
