...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_RX_I_1")
            .field("dma_rx_i_sram_0_r", &self.dma_rx_i_sram_0_r().bit())
            .field("dma_rx_i_sram_0_w", &self.dma_rx_i_sram_0_w().bit())
            .field("dma_rx_i_sram_1_r", &self.dma_rx_i_sram_1_r().bit())
            .field("dma_rx_i_sram_1_w", &self.dma_rx_i_sram_1_w().bit())
            .field("dma_rx_i_sram_2_r", &self.dma_rx_i_sram_2_r().bit())
            .field("dma_rx_i_sram_2_w", &self.dma_rx_i_sram_2_w().bit())
            .field("dma_rx_i_sram_3_r", &self.dma_rx_i_sram_3_r().bit())
            .field("dma_rx_i_sram_3_w", &self.dma_rx_i_sram_3_w().bit())
            .field(
                "dma_rx_i_sram_4_spltaddr",
                &self.dma_rx_i_sram_4_spltaddr().bits(),
            )
            .field("dma_rx_i_sram_4_l_r", &self.dma_rx_i_sram_4_l_r().bit())
            .field("dma_rx_i_sram_4_l_w", &self.dma_rx_i_sram_4_l_w().bit())
            .field("dma_rx_i_sram_4_h_r", &self.dma_rx_i_sram_4_h_r().bit())
            .field("dma_rx_i_sram_4_h_w", &self.dma_rx_i_sram_4_h_w().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
