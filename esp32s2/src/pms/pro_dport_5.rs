...
impl W {
    #[doc = "Bits 0:17 - Configure read-protection address 3."]
    #[inline(always)]
    pub fn pro_dport_reserve_fifo_3(&mut self) -> PRO_DPORT_RESERVE_FIFO_3_W<'_, PRO_DPORT_5_SPEC> {
        PRO_DPORT_RESERVE_FIFO_3_W::new(self, 0)
    }
}
#[doc = "PeriBus1 permission control register 5.\n\nYou can [`read`](crate::Reg::read) this register and get [`pro_dport_5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pro_dport_5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
