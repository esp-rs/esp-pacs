///Register `PRO_DPORT_5` reader
pub type R = crate::R<PRO_DPORT_5_SPEC>;
///Register `PRO_DPORT_5` writer
pub type W = crate::W<PRO_DPORT_5_SPEC>;
///Field `PRO_DPORT_RESERVE_FIFO_3` reader - Configure read-protection address 3.
pub type PRO_DPORT_RESERVE_FIFO_3_R = crate::FieldReader<u32>;
///Field `PRO_DPORT_RESERVE_FIFO_3` writer - Configure read-protection address 3.
pub type PRO_DPORT_RESERVE_FIFO_3_W<'a, REG> = crate::FieldWriter<'a, REG, 18, u32>;
impl R {
    ///Bits 0:17 - Configure read-protection address 3.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_DPORT_5")
            .field("pro_dport_reserve_fifo_3", &self.pro_dport_reserve_fifo_3())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pro_dport_5::R`](R) reader structure
impl crate::Readable for PRO_DPORT_5_SPEC {}
///`write(|w| ..)` method takes [`pro_dport_5::W`](W) writer structure
impl crate::Writable for PRO_DPORT_5_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_DPORT_5 to value 0
