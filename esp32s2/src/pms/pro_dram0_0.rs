...
pub struct R(crate::R<PRO_DRAM0_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_DRAM0_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_DRAM0_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_DRAM0_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_DRAM0_0` writer"]
pub struct W(crate::W<PRO_DRAM0_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_DRAM0_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_DRAM0_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_DRAM0_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRO_DRAM0_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, PRO_DRAM0_0_SPEC, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_DRAM0_0")
            .field(
                "pro_dram0_lock",
                &format_args!("{}", self.pro_dram0_lock().bit()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_dram0_lock(&mut self) -> PRO_DRAM0_LOCK_W<0> {
