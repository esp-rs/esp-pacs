///Register `APB_PERIPHERAL_INTR` reader
pub type R = crate::R<APB_PERIPHERAL_INTR_SPEC>;
///Register `APB_PERIPHERAL_INTR` writer
pub type W = crate::W<APB_PERIPHERAL_INTR_SPEC>;
///Field `APB_PERI_BYTE_ERROR_CLR` reader - The clear signal for APB peripheral interrupt.
pub type APB_PERI_BYTE_ERROR_CLR_R = crate::BitReader;
///Field `APB_PERI_BYTE_ERROR_CLR` writer - The clear signal for APB peripheral interrupt.
pub type APB_PERI_BYTE_ERROR_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APB_PERI_BYTE_ERROR_EN` reader - The enable signal for APB peripheral access interrupt.
pub type APB_PERI_BYTE_ERROR_EN_R = crate::BitReader;
///Field `APB_PERI_BYTE_ERROR_EN` writer - The enable signal for APB peripheral access interrupt.
pub type APB_PERI_BYTE_ERROR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APB_PERI_BYTE_ERROR_INTR` reader - APB peripheral access interrupt signal.
pub type APB_PERI_BYTE_ERROR_INTR_R = crate::BitReader;
impl R {
    ///Bit 0 - The clear signal for APB peripheral interrupt.
    #[inline(always)]
    ...
    ///Bit 2 - APB peripheral access interrupt signal.
    #[inline(always)]
...
///`read()` method returns [`apb_peripheral_intr::R`](R) reader structure
impl crate::Readable for APB_PERIPHERAL_INTR_SPEC {}
///`write(|w| ..)` method takes [`apb_peripheral_intr::W`](W) writer structure
impl crate::Writable for APB_PERIPHERAL_INTR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APB_PERIPHERAL_INTR to value 0
