///Register `PRO_TRACE_1` reader
pub type R = crate::R<PRO_TRACE_1_SPEC>;
///Register `PRO_TRACE_1` writer
pub type W = crate::W<PRO_TRACE_1_SPEC>;
///Field `PRO_TRACE_DISABLE` reader - Setting to 1 disables the trace memory function.
pub type PRO_TRACE_DISABLE_R = crate::BitReader;
///Field `PRO_TRACE_DISABLE` writer - Setting to 1 disables the trace memory function.
pub type PRO_TRACE_DISABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Setting to 1 disables the trace memory function.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_TRACE_1")
            .field("pro_trace_disable", &self.pro_trace_disable())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pro_trace_1::R`](R) reader structure
impl crate::Readable for PRO_TRACE_1_SPEC {}
///`write(|w| ..)` method takes [`pro_trace_1::W`](W) writer structure
impl crate::Writable for PRO_TRACE_1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_TRACE_1 to value 0
