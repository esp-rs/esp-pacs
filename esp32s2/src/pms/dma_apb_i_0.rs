...
pub struct R(crate::R<DMA_APB_I_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_APB_I_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_APB_I_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_APB_I_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_APB_I_0` writer"]
pub struct W(crate::W<DMA_APB_I_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_APB_I_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_APB_I_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_APB_I_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DMA_APB_I_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, DMA_APB_I_0_SPEC, O>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DMA_APB_I_0_SPEC> {
