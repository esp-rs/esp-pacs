...
///Register `PRO_CACHE_2` writer
pub type W = crate::W<PRO_CACHE_2_SPEC>;
///Field `PRO_CACHE_ILG_CLR` reader - The clear signal for cache access interrupt.
pub type PRO_CACHE_ILG_CLR_R = crate::BitReader;
///Field `PRO_CACHE_ILG_CLR` writer - The clear signal for cache access interrupt.
pub type PRO_CACHE_ILG_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_CACHE_ILG_EN` reader - The enable signal for cache access interrupt.
pub type PRO_CACHE_ILG_EN_R = crate::BitReader;
///Field `PRO_CACHE_ILG_EN` writer - The enable signal for cache access interrupt.
pub type PRO_CACHE_ILG_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_CACHE_ILG_INTR` reader - Cache access interrupt signal.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_CACHE_2")
            .field("pro_cache_ilg_clr", &self.pro_cache_ilg_clr())
            .field("pro_cache_ilg_en", &self.pro_cache_ilg_en())
            .field("pro_cache_ilg_intr", &self.pro_cache_ilg_intr())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pro_cache_2::R`](R) reader structure
impl crate::Readable for PRO_CACHE_2_SPEC {}
///`write(|w| ..)` method takes [`pro_cache_2::W`](W) writer structure
impl crate::Writable for PRO_CACHE_2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_CACHE_2 to value 0
