...
pub type PRO_CACHE_ILG_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_CACHE_ILG_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_cache_ilg_clr(&mut self) -> PRO_CACHE_ILG_CLR_W<PRO_CACHE_2_SPEC, 0> {
        PRO_CACHE_ILG_CLR_W::new(self)
    }
    #[doc = "Bit 1 - The enable signal for cache access interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn pro_cache_ilg_en(&mut self) -> PRO_CACHE_ILG_EN_W<PRO_CACHE_2_SPEC, 1> {
