///Register `OCCUPY_2` reader
pub type R = crate::R<OCCUPY_2_SPEC>;
///Register `OCCUPY_2` writer
pub type W = crate::W<OCCUPY_2_SPEC>;
///Field `OCCUPY_MAC_DUMP` reader - Configure whether SRAM Block 18-21 is used as mac dump.
pub type OCCUPY_MAC_DUMP_R = crate::FieldReader;
///Field `OCCUPY_MAC_DUMP` writer - Configure whether SRAM Block 18-21 is used as mac dump.
pub type OCCUPY_MAC_DUMP_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bits 0:3 - Configure whether SRAM Block 18-21 is used as mac dump.
    #[inline(always)]
...
///`read()` method returns [`occupy_2::R`](R) reader structure
impl crate::Readable for OCCUPY_2_SPEC {}
///`write(|w| ..)` method takes [`occupy_2::W`](W) writer structure
impl crate::Writable for OCCUPY_2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OCCUPY_2 to value 0
