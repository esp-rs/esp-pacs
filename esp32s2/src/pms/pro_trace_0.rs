...
pub struct R(crate::R<PRO_TRACE_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_TRACE_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_TRACE_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_TRACE_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_TRACE_0` writer"]
pub struct W(crate::W<PRO_TRACE_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_TRACE_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_TRACE_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_TRACE_0_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_trace_lock(&mut self) -> PRO_TRACE_LOCK_W<0> {
