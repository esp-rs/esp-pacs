    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_IRAM0_2")
            .field(
                ...
                &self.pro_iram0_sram_4_spltaddr().bits(),
            )
            .field("pro_iram0_sram_4_l_f", &self.pro_iram0_sram_4_l_f().bit())
            .field("pro_iram0_sram_4_l_r", &self.pro_iram0_sram_4_l_r().bit())
            .field("pro_iram0_sram_4_l_w", &self.pro_iram0_sram_4_l_w().bit())
            .field("pro_iram0_sram_4_h_f", &self.pro_iram0_sram_4_h_f().bit())
            .field("pro_iram0_sram_4_h_r", &self.pro_iram0_sram_4_h_r().bit())
            .field("pro_iram0_sram_4_h_w", &self.pro_iram0_sram_4_h_w().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
