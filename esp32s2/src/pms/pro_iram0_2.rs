///Register `PRO_IRAM0_2` reader
pub type R = crate::R<PRO_IRAM0_2_SPEC>;
///Register `PRO_IRAM0_2` writer
pub type W = crate::W<PRO_IRAM0_2_SPEC>;
///Field `PRO_IRAM0_SRAM_4_SPLTADDR` reader - Configure the split address of SRAM Block 4-21 for IBUS access.
pub type PRO_IRAM0_SRAM_4_SPLTADDR_R = crate::FieldReader<u32>;
///Field `PRO_IRAM0_SRAM_4_SPLTADDR` writer - Configure the split address of SRAM Block 4-21 for IBUS access.
pub type PRO_IRAM0_SRAM_4_SPLTADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 17, u32>;
///Field `PRO_IRAM0_SRAM_4_L_F` reader - Setting to 1 grants IBUS permission to fetch SRAM Block 4-21 low address region.
pub type PRO_IRAM0_SRAM_4_L_F_R = crate::BitReader;
///Field `PRO_IRAM0_SRAM_4_L_F` writer - Setting to 1 grants IBUS permission to fetch SRAM Block 4-21 low address region.
pub type PRO_IRAM0_SRAM_4_L_F_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_SRAM_4_L_R` reader - Setting to 1 grants IBUS permission to read SRAM Block 4-21 low address region.
pub type PRO_IRAM0_SRAM_4_L_R_R = crate::BitReader;
///Field `PRO_IRAM0_SRAM_4_L_R` writer - Setting to 1 grants IBUS permission to read SRAM Block 4-21 low address region.
pub type PRO_IRAM0_SRAM_4_L_R_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_SRAM_4_L_W` reader - Setting to 1 grants IBUS permission to write SRAM Block 4-21 low address region.
pub type PRO_IRAM0_SRAM_4_L_W_R = crate::BitReader;
///Field `PRO_IRAM0_SRAM_4_L_W` writer - Setting to 1 grants IBUS permission to write SRAM Block 4-21 low address region.
pub type PRO_IRAM0_SRAM_4_L_W_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_SRAM_4_H_F` reader - Setting to 1 grants IBUS permission to fetch SRAM Block 4-21 high address region.
pub type PRO_IRAM0_SRAM_4_H_F_R = crate::BitReader;
///Field `PRO_IRAM0_SRAM_4_H_F` writer - Setting to 1 grants IBUS permission to fetch SRAM Block 4-21 high address region.
pub type PRO_IRAM0_SRAM_4_H_F_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_SRAM_4_H_R` reader - Setting to 1 grants IBUS permission to read SRAM Block 4-21 high address region.
pub type PRO_IRAM0_SRAM_4_H_R_R = crate::BitReader;
///Field `PRO_IRAM0_SRAM_4_H_R` writer - Setting to 1 grants IBUS permission to read SRAM Block 4-21 high address region.
pub type PRO_IRAM0_SRAM_4_H_R_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_SRAM_4_H_W` reader - Setting to 1 grants IBUS permission to write SRAM Block 4-21 high address region.
pub type PRO_IRAM0_SRAM_4_H_W_R = crate::BitReader;
///Field `PRO_IRAM0_SRAM_4_H_W` writer - Setting to 1 grants IBUS permission to write SRAM Block 4-21 high address region.
...
impl R {
    ...
    ///Bit 18 - Setting to 1 grants IBUS permission to read SRAM Block 4-21 low address region.
    #[inline(always)]
    pub fn pro_iram0_sram_4_l_r(&self) -> PRO_IRAM0_SRAM_4_L_R_R {
        PRO_IRAM0_SRAM_4_L_R_R::new(((self.bits >> 18) & 1) != 0)
    }
    ///Bit 19 - Setting to 1 grants IBUS permission to write SRAM Block 4-21 low address region.
    #[inline(always)]
    pub fn pro_iram0_sram_4_l_w(&self) -> PRO_IRAM0_SRAM_4_L_W_R {
        PRO_IRAM0_SRAM_4_L_W_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 20 - Setting to 1 grants IBUS permission to fetch SRAM Block 4-21 high address region.
    #[inline(always)]
    pub fn pro_iram0_sram_4_h_f(&self) -> PRO_IRAM0_SRAM_4_H_F_R {
        PRO_IRAM0_SRAM_4_H_F_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - Setting to 1 grants IBUS permission to read SRAM Block 4-21 high address region.
    #[inline(always)]
    pub fn pro_iram0_sram_4_h_r(&self) -> PRO_IRAM0_SRAM_4_H_R_R {
        PRO_IRAM0_SRAM_4_H_R_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Bit 22 - Setting to 1 grants IBUS permission to write SRAM Block 4-21 high address region.
    #[inline(always)]
...
///`read()` method returns [`pro_iram0_2::R`](R) reader structure
impl crate::Readable for PRO_IRAM0_2_SPEC {}
///`write(|w| ..)` method takes [`pro_iram0_2::W`](W) writer structure
impl crate::Writable for PRO_IRAM0_2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_IRAM0_2 to value 0x007e_0000
