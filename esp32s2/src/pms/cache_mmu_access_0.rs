///Register `CACHE_MMU_ACCESS_0` reader
pub type R = crate::R<CACHE_MMU_ACCESS_0_SPEC>;
///Register `CACHE_MMU_ACCESS_0` writer
pub type W = crate::W<CACHE_MMU_ACCESS_0_SPEC>;
///Field `CACHE_MMU_ACCESS_LOCK` reader - Lock register. Setting to 1 locks cache MMU permission control registers.
pub type CACHE_MMU_ACCESS_LOCK_R = crate::BitReader;
///Field `CACHE_MMU_ACCESS_LOCK` writer - Lock register. Setting to 1 locks cache MMU permission control registers.
pub type CACHE_MMU_ACCESS_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Lock register. Setting to 1 locks cache MMU permission control registers.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`cache_mmu_access_0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cache_mmu_access_0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CACHE_MMU_ACCESS_0_SPEC;
impl crate::RegisterSpec for CACHE_MMU_ACCESS_0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`cache_mmu_access_0::R`](R) reader structure
impl crate::Readable for CACHE_MMU_ACCESS_0_SPEC {}
///`write(|w| ..)` method takes [`cache_mmu_access_0::W`](W) writer structure
