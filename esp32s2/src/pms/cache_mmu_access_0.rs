...
#[doc = "Field `CACHE_MMU_ACCESS_LOCK` reader - Lock register. Setting to 1 locks cache MMU permission control registers."]
pub type CACHE_MMU_ACCESS_LOCK_R = crate::BitReader;
#[doc = "Field `CACHE_MMU_ACCESS_LOCK` writer - Lock register. Setting to 1 locks cache MMU permission control registers."]
pub type CACHE_MMU_ACCESS_LOCK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cache_mmu_access_lock(&mut self) -> CACHE_MMU_ACCESS_LOCK_W<CACHE_MMU_ACCESS_0_SPEC, 0> {
