...
pub type PRO_IRAM0_ILG_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_IRAM0_ILG_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_iram0_ilg_clr(&mut self) -> PRO_IRAM0_ILG_CLR_W<PRO_IRAM0_4_SPEC, 0> {
        PRO_IRAM0_ILG_CLR_W::new(self)
    }
    #[doc = "Bit 1 - The enable signal for IBUS access interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn pro_iram0_ilg_en(&mut self) -> PRO_IRAM0_ILG_EN_W<PRO_IRAM0_4_SPEC, 1> {
