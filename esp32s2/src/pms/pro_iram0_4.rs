///Register `PRO_IRAM0_4` reader
pub type R = crate::R<PRO_IRAM0_4_SPEC>;
///Register `PRO_IRAM0_4` writer
pub type W = crate::W<PRO_IRAM0_4_SPEC>;
///Field `PRO_IRAM0_ILG_CLR` reader - The clear signal for IBUS access interrupt.
pub type PRO_IRAM0_ILG_CLR_R = crate::BitReader;
///Field `PRO_IRAM0_ILG_CLR` writer - The clear signal for IBUS access interrupt.
pub type PRO_IRAM0_ILG_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_ILG_EN` reader - The enable signal for IBUS access interrupt.
pub type PRO_IRAM0_ILG_EN_R = crate::BitReader;
///Field `PRO_IRAM0_ILG_EN` writer - The enable signal for IBUS access interrupt.
pub type PRO_IRAM0_ILG_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_ILG_INTR` reader - IBUS access interrupt signal.
...
///`read()` method returns [`pro_iram0_4::R`](R) reader structure
impl crate::Readable for PRO_IRAM0_4_SPEC {}
///`write(|w| ..)` method takes [`pro_iram0_4::W`](W) writer structure
impl crate::Writable for PRO_IRAM0_4_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_IRAM0_4 to value 0
