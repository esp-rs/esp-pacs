///Register `PRO_IRAM0_3` reader
pub type R = crate::R<PRO_IRAM0_3_SPEC>;
///Register `PRO_IRAM0_3` writer
pub type W = crate::W<PRO_IRAM0_3_SPEC>;
///Field `PRO_IRAM0_RTCFAST_SPLTADDR` reader - Configure the split address of RTC FAST for IBUS access.
pub type PRO_IRAM0_RTCFAST_SPLTADDR_R = crate::FieldReader<u16>;
///Field `PRO_IRAM0_RTCFAST_SPLTADDR` writer - Configure the split address of RTC FAST for IBUS access.
pub type PRO_IRAM0_RTCFAST_SPLTADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `PRO_IRAM0_RTCFAST_L_F` reader - Setting to 1 grants IBUS permission to fetch RTC FAST low address region.
pub type PRO_IRAM0_RTCFAST_L_F_R = crate::BitReader;
///Field `PRO_IRAM0_RTCFAST_L_F` writer - Setting to 1 grants IBUS permission to fetch RTC FAST low address region.
pub type PRO_IRAM0_RTCFAST_L_F_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_RTCFAST_L_R` reader - Setting to 1 grants IBUS permission to read RTC FAST low address region.
pub type PRO_IRAM0_RTCFAST_L_R_R = crate::BitReader;
///Field `PRO_IRAM0_RTCFAST_L_R` writer - Setting to 1 grants IBUS permission to read RTC FAST low address region.
pub type PRO_IRAM0_RTCFAST_L_R_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_RTCFAST_L_W` reader - Setting to 1 grants IBUS permission to write RTC FAST low address region.
pub type PRO_IRAM0_RTCFAST_L_W_R = crate::BitReader;
///Field `PRO_IRAM0_RTCFAST_L_W` writer - Setting to 1 grants IBUS permission to write RTC FAST low address region.
pub type PRO_IRAM0_RTCFAST_L_W_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_RTCFAST_H_F` reader - Setting to 1 grants IBUS permission to fetch RTC FAST high address region.
pub type PRO_IRAM0_RTCFAST_H_F_R = crate::BitReader;
///Field `PRO_IRAM0_RTCFAST_H_F` writer - Setting to 1 grants IBUS permission to fetch RTC FAST high address region.
pub type PRO_IRAM0_RTCFAST_H_F_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_RTCFAST_H_R` reader - Setting to 1 grants IBUS permission to read RTC FAST high address region.
pub type PRO_IRAM0_RTCFAST_H_R_R = crate::BitReader;
///Field `PRO_IRAM0_RTCFAST_H_R` writer - Setting to 1 grants IBUS permission to read RTC FAST high address region.
pub type PRO_IRAM0_RTCFAST_H_R_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_IRAM0_RTCFAST_H_W` reader - Setting to 1 grants IBUS permission to write RTC FAST high address region.
pub type PRO_IRAM0_RTCFAST_H_W_R = crate::BitReader;
///Field `PRO_IRAM0_RTCFAST_H_W` writer - Setting to 1 grants IBUS permission to write RTC FAST high address region.
pub type PRO_IRAM0_RTCFAST_H_W_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:10 - Configure the split address of RTC FAST for IBUS access.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`pro_iram0_3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pro_iram0_3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PRO_IRAM0_3_SPEC;
impl crate::RegisterSpec for PRO_IRAM0_3_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pro_iram0_3::R`](R) reader structure
impl crate::Readable for PRO_IRAM0_3_SPEC {}
///`write(|w| ..)` method takes [`pro_iram0_3::W`](W) writer structure
impl crate::Writable for PRO_IRAM0_3_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_IRAM0_3 to value 0x0001_f800
