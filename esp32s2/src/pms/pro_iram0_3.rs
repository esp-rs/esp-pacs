...
pub type PRO_IRAM0_RTCFAST_SPLTADDR_W<'a, REG, const O: u8> =
...
pub type PRO_IRAM0_RTCFAST_L_F_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_IRAM0_RTCFAST_L_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_IRAM0_RTCFAST_L_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_IRAM0_RTCFAST_H_F_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_IRAM0_RTCFAST_H_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PRO_IRAM0_RTCFAST_H_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_iram0_rtcfast_spltaddr(
        &mut self,
    ) -> PRO_IRAM0_RTCFAST_SPLTADDR_W<PRO_IRAM0_3_SPEC, 0> {
        PRO_IRAM0_RTCFAST_SPLTADDR_W::new(self)
    }
    #[doc = "Bit 11 - Setting to 1 grants IBUS permission to fetch RTC FAST low address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_iram0_rtcfast_l_f(&mut self) -> PRO_IRAM0_RTCFAST_L_F_W<PRO_IRAM0_3_SPEC, 11> {
        PRO_IRAM0_RTCFAST_L_F_W::new(self)
    }
    #[doc = "Bit 12 - Setting to 1 grants IBUS permission to read RTC FAST low address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_iram0_rtcfast_l_r(&mut self) -> PRO_IRAM0_RTCFAST_L_R_W<PRO_IRAM0_3_SPEC, 12> {
        PRO_IRAM0_RTCFAST_L_R_W::new(self)
    }
    #[doc = "Bit 13 - Setting to 1 grants IBUS permission to write RTC FAST low address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_iram0_rtcfast_l_w(&mut self) -> PRO_IRAM0_RTCFAST_L_W_W<PRO_IRAM0_3_SPEC, 13> {
        PRO_IRAM0_RTCFAST_L_W_W::new(self)
    }
    #[doc = "Bit 14 - Setting to 1 grants IBUS permission to fetch RTC FAST high address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_iram0_rtcfast_h_f(&mut self) -> PRO_IRAM0_RTCFAST_H_F_W<PRO_IRAM0_3_SPEC, 14> {
        PRO_IRAM0_RTCFAST_H_F_W::new(self)
    }
    #[doc = "Bit 15 - Setting to 1 grants IBUS permission to read RTC FAST high address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_iram0_rtcfast_h_r(&mut self) -> PRO_IRAM0_RTCFAST_H_R_W<PRO_IRAM0_3_SPEC, 15> {
        PRO_IRAM0_RTCFAST_H_R_W::new(self)
    }
    #[doc = "Bit 16 - Setting to 1 grants IBUS permission to write RTC FAST high address region."]
    #[inline(always)]
    #[must_use]
    pub fn pro_iram0_rtcfast_h_w(&mut self) -> PRO_IRAM0_RTCFAST_H_W_W<PRO_IRAM0_3_SPEC, 16> {
