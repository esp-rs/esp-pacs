///Register `PRO_IRAM0_0` reader
pub type R = crate::R<PRO_IRAM0_0_SPEC>;
///Register `PRO_IRAM0_0` writer
pub type W = crate::W<PRO_IRAM0_0_SPEC>;
///Field `PRO_IRAM0_LOCK` reader - Lock register. Setting to 1 locks IBUS permission control registers.
pub type PRO_IRAM0_LOCK_R = crate::BitReader;
///Field `PRO_IRAM0_LOCK` writer - Lock register. Setting to 1 locks IBUS permission control registers.
pub type PRO_IRAM0_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Lock register. Setting to 1 locks IBUS permission control registers.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_IRAM0_0")
            .field("pro_iram0_lock", &self.pro_iram0_lock())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pro_iram0_0::R`](R) reader structure
impl crate::Readable for PRO_IRAM0_0_SPEC {}
///`write(|w| ..)` method takes [`pro_iram0_0::W`](W) writer structure
impl crate::Writable for PRO_IRAM0_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_IRAM0_0 to value 0
