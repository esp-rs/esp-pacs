///Register `SDIO_0` reader
pub type R = crate::R<SDIO_0_SPEC>;
///Register `SDIO_0` writer
pub type W = crate::W<SDIO_0_SPEC>;
///Field `SDIO_LOCK` reader - Lock register. Setting to 1 locks SDIO permission control registers.
pub type SDIO_LOCK_R = crate::BitReader;
///Field `SDIO_LOCK` writer - Lock register. Setting to 1 locks SDIO permission control registers.
pub type SDIO_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Lock register. Setting to 1 locks SDIO permission control registers.
    #[inline(always)]
...
///`read()` method returns [`sdio_0::R`](R) reader structure
impl crate::Readable for SDIO_0_SPEC {}
///`write(|w| ..)` method takes [`sdio_0::W`](W) writer structure
impl crate::Writable for SDIO_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDIO_0 to value 0
