///Register `PRO_CACHE_1` reader
pub type R = crate::R<PRO_CACHE_1_SPEC>;
///Register `PRO_CACHE_1` writer
pub type W = crate::W<PRO_CACHE_1_SPEC>;
///Field `PRO_CACHE_CONNECT` reader - Configure which SRAM Block will be occupied by Icache or Dcache.
pub type PRO_CACHE_CONNECT_R = crate::FieldReader<u16>;
///Field `PRO_CACHE_CONNECT` writer - Configure which SRAM Block will be occupied by Icache or Dcache.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_CACHE_1")
            .field("pro_cache_connect", &self.pro_cache_connect())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pro_cache_1::R`](R) reader structure
impl crate::Readable for PRO_CACHE_1_SPEC {}
///`write(|w| ..)` method takes [`pro_cache_1::W`](W) writer structure
impl crate::Writable for PRO_CACHE_1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_CACHE_1 to value 0
