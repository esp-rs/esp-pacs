...
impl W {
    #[doc = "Bits 0:15 - Configure which SRAM Block will be occupied by Icache or Dcache."]
    #[inline(always)]
    pub fn pro_cache_connect(&mut self) -> PRO_CACHE_CONNECT_W<'_, PRO_CACHE_1_SPEC> {
        PRO_CACHE_CONNECT_W::new(self, 0)
    }
}
#[doc = "Cache permission control register 1.\n\nYou can [`read`](crate::Reg::read) this register and get [`pro_cache_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pro_cache_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
