...
pub struct R(crate::R<PRO_DRAM0_3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRO_DRAM0_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRO_DRAM0_3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRO_DRAM0_3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRO_DRAM0_3` writer"]
pub struct W(crate::W<PRO_DRAM0_3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRO_DRAM0_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRO_DRAM0_3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRO_DRAM0_3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PRO_DRAM0_ILG_CLR` reader - The clear signal for DBUS0 access interrupt."]
pub type PRO_DRAM0_ILG_CLR_R = crate::BitReader<bool>;
#[doc = "Field `PRO_DRAM0_ILG_CLR` writer - The clear signal for DBUS0 access interrupt."]
pub type PRO_DRAM0_ILG_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PRO_DRAM0_3_SPEC, bool, O>;
#[doc = "Field `PRO_DRAM0_ILG_EN` reader - The enable signal for DBUS0 access interrupt."]
pub type PRO_DRAM0_ILG_EN_R = crate::BitReader<bool>;
#[doc = "Field `PRO_DRAM0_ILG_EN` writer - The enable signal for DBUS0 access interrupt."]
pub type PRO_DRAM0_ILG_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PRO_DRAM0_3_SPEC, bool, O>;
#[doc = "Field `PRO_DRAM0_ILG_INTR` reader - DBUS0 access interrupt signal."]
pub type PRO_DRAM0_ILG_INTR_R = crate::BitReader<bool>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_dram0_ilg_clr(&mut self) -> PRO_DRAM0_ILG_CLR_W<0> {
        PRO_DRAM0_ILG_CLR_W::new(self)
    }
    #[doc = "Bit 1 - The enable signal for DBUS0 access interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn pro_dram0_ilg_en(&mut self) -> PRO_DRAM0_ILG_EN_W<1> {
