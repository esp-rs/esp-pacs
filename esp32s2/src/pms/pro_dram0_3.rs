...
pub type PRO_DRAM0_ILG_CLR_W<'a, const O: u8> = crate::BitWriter<'a, PRO_DRAM0_3_SPEC, O>;
...
pub type PRO_DRAM0_ILG_EN_W<'a, const O: u8> = crate::BitWriter<'a, PRO_DRAM0_3_SPEC, O>;
