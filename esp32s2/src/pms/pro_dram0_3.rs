///Register `PRO_DRAM0_3` reader
pub type R = crate::R<PRO_DRAM0_3_SPEC>;
///Register `PRO_DRAM0_3` writer
pub type W = crate::W<PRO_DRAM0_3_SPEC>;
///Field `PRO_DRAM0_ILG_CLR` reader - The clear signal for DBUS0 access interrupt.
pub type PRO_DRAM0_ILG_CLR_R = crate::BitReader;
///Field `PRO_DRAM0_ILG_CLR` writer - The clear signal for DBUS0 access interrupt.
pub type PRO_DRAM0_ILG_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DRAM0_ILG_EN` reader - The enable signal for DBUS0 access interrupt.
pub type PRO_DRAM0_ILG_EN_R = crate::BitReader;
///Field `PRO_DRAM0_ILG_EN` writer - The enable signal for DBUS0 access interrupt.
pub type PRO_DRAM0_ILG_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DRAM0_ILG_INTR` reader - DBUS0 access interrupt signal.
pub type PRO_DRAM0_ILG_INTR_R = crate::BitReader;
impl R {
    ///Bit 0 - The clear signal for DBUS0 access interrupt.
    #[inline(always)]
    pub fn pro_dram0_ilg_clr(&self) -> PRO_DRAM0_ILG_CLR_R {
        PRO_DRAM0_ILG_CLR_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The enable signal for DBUS0 access interrupt.
    #[inline(always)]
    pub fn pro_dram0_ilg_en(&self) -> PRO_DRAM0_ILG_EN_R {
        PRO_DRAM0_ILG_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - DBUS0 access interrupt signal.
    #[inline(always)]
...
///`read()` method returns [`pro_dram0_3::R`](R) reader structure
impl crate::Readable for PRO_DRAM0_3_SPEC {}
///`write(|w| ..)` method takes [`pro_dram0_3::W`](W) writer structure
impl crate::Writable for PRO_DRAM0_3_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_DRAM0_3 to value 0
