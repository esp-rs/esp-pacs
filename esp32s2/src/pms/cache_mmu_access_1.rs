...
///Field `PRO_MMU_RD_ACS` reader - Setting to 1 permits read access to MMU memory.
pub type PRO_MMU_RD_ACS_R = crate::BitReader;
///Field `PRO_MMU_RD_ACS` writer - Setting to 1 permits read access to MMU memory.
pub type PRO_MMU_RD_ACS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_MMU_WR_ACS` reader - Setting to 1 permits write access to MMU memory.
pub type PRO_MMU_WR_ACS_R = crate::BitReader;
///Field `PRO_MMU_WR_ACS` writer - Setting to 1 permits write access to MMU memory.
