///Register `PRO_AHB_2` reader
pub type R = crate::R<PRO_AHB_2_SPEC>;
///Register `PRO_AHB_2` writer
pub type W = crate::W<PRO_AHB_2_SPEC>;
///Field `PRO_AHB_RTCSLOW_1_SPLTADDR` reader - Configure the split address of RTCSlow_1 for PeriBus2 access.
pub type PRO_AHB_RTCSLOW_1_SPLTADDR_R = crate::FieldReader<u16>;
///Field `PRO_AHB_RTCSLOW_1_SPLTADDR` writer - Configure the split address of RTCSlow_1 for PeriBus2 access.
pub type PRO_AHB_RTCSLOW_1_SPLTADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `PRO_AHB_RTCSLOW_1_L_F` reader - Setting to 1 grants PeriBus2 permission to fetch RTCSlow_1 low address region.
pub type PRO_AHB_RTCSLOW_1_L_F_R = crate::BitReader;
///Field `PRO_AHB_RTCSLOW_1_L_F` writer - Setting to 1 grants PeriBus2 permission to fetch RTCSlow_1 low address region.
pub type PRO_AHB_RTCSLOW_1_L_F_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_AHB_RTCSLOW_1_L_R` reader - Setting to 1 grants PeriBus2 permission to read RTCSlow_1 low address region.
pub type PRO_AHB_RTCSLOW_1_L_R_R = crate::BitReader;
///Field `PRO_AHB_RTCSLOW_1_L_R` writer - Setting to 1 grants PeriBus2 permission to read RTCSlow_1 low address region.
pub type PRO_AHB_RTCSLOW_1_L_R_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_AHB_RTCSLOW_1_L_W` reader - Setting to 1 grants PeriBus2 permission to write RTCSlow_1 low address region.
pub type PRO_AHB_RTCSLOW_1_L_W_R = crate::BitReader;
///Field `PRO_AHB_RTCSLOW_1_L_W` writer - Setting to 1 grants PeriBus2 permission to write RTCSlow_1 low address region.
pub type PRO_AHB_RTCSLOW_1_L_W_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_AHB_RTCSLOW_1_H_F` reader - Setting to 1 grants PeriBus2 permission to fetch RTCSlow_1 high address region.
pub type PRO_AHB_RTCSLOW_1_H_F_R = crate::BitReader;
///Field `PRO_AHB_RTCSLOW_1_H_F` writer - Setting to 1 grants PeriBus2 permission to fetch RTCSlow_1 high address region.
pub type PRO_AHB_RTCSLOW_1_H_F_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_AHB_RTCSLOW_1_H_R` reader - Setting to 1 grants PeriBus2 permission to read RTCSlow_1 high address region.
pub type PRO_AHB_RTCSLOW_1_H_R_R = crate::BitReader;
///Field `PRO_AHB_RTCSLOW_1_H_R` writer - Setting to 1 grants PeriBus2 permission to read RTCSlow_1 high address region.
pub type PRO_AHB_RTCSLOW_1_H_R_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_AHB_RTCSLOW_1_H_W` reader - Setting to 1 grants PeriBus2 permission to write RTCSlow_1 high address region.
pub type PRO_AHB_RTCSLOW_1_H_W_R = crate::BitReader;
///Field `PRO_AHB_RTCSLOW_1_H_W` writer - Setting to 1 grants PeriBus2 permission to write RTCSlow_1 high address region.
...
impl R {
    ...
    ///Bit 12 - Setting to 1 grants PeriBus2 permission to read RTCSlow_1 low address region.
    #[inline(always)]
    pub fn pro_ahb_rtcslow_1_l_r(&self) -> PRO_AHB_RTCSLOW_1_L_R_R {
        PRO_AHB_RTCSLOW_1_L_R_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - Setting to 1 grants PeriBus2 permission to write RTCSlow_1 low address region.
    #[inline(always)]
    pub fn pro_ahb_rtcslow_1_l_w(&self) -> PRO_AHB_RTCSLOW_1_L_W_R {
        PRO_AHB_RTCSLOW_1_L_W_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - Setting to 1 grants PeriBus2 permission to fetch RTCSlow_1 high address region.
    #[inline(always)]
    pub fn pro_ahb_rtcslow_1_h_f(&self) -> PRO_AHB_RTCSLOW_1_H_F_R {
        PRO_AHB_RTCSLOW_1_H_F_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - Setting to 1 grants PeriBus2 permission to read RTCSlow_1 high address region.
    #[inline(always)]
    pub fn pro_ahb_rtcslow_1_h_r(&self) -> PRO_AHB_RTCSLOW_1_H_R_R {
        PRO_AHB_RTCSLOW_1_H_R_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bit 16 - Setting to 1 grants PeriBus2 permission to write RTCSlow_1 high address region.
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_1_l_f(&mut self) -> PRO_AHB_RTCSLOW_1_L_F_W<PRO_AHB_2_SPEC> {
        PRO_AHB_RTCSLOW_1_L_F_W::new(self, 11)
    }
    ///Bit 12 - Setting to 1 grants PeriBus2 permission to read RTCSlow_1 low address region.
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_1_l_r(&mut self) -> PRO_AHB_RTCSLOW_1_L_R_W<PRO_AHB_2_SPEC> {
        PRO_AHB_RTCSLOW_1_L_R_W::new(self, 12)
    }
    ///Bit 13 - Setting to 1 grants PeriBus2 permission to write RTCSlow_1 low address region.
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_1_l_w(&mut self) -> PRO_AHB_RTCSLOW_1_L_W_W<PRO_AHB_2_SPEC> {
        PRO_AHB_RTCSLOW_1_L_W_W::new(self, 13)
    }
    ///Bit 14 - Setting to 1 grants PeriBus2 permission to fetch RTCSlow_1 high address region.
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_1_h_f(&mut self) -> PRO_AHB_RTCSLOW_1_H_F_W<PRO_AHB_2_SPEC> {
        PRO_AHB_RTCSLOW_1_H_F_W::new(self, 14)
    }
    ///Bit 15 - Setting to 1 grants PeriBus2 permission to read RTCSlow_1 high address region.
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_1_h_r(&mut self) -> PRO_AHB_RTCSLOW_1_H_R_W<PRO_AHB_2_SPEC> {
        PRO_AHB_RTCSLOW_1_H_R_W::new(self, 15)
    }
    ///Bit 16 - Setting to 1 grants PeriBus2 permission to write RTCSlow_1 high address region.
    #[inline(always)]
    #[must_use]
    pub fn pro_ahb_rtcslow_1_h_w(&mut self) -> PRO_AHB_RTCSLOW_1_H_W_W<PRO_AHB_2_SPEC> {
...
///`read()` method returns [`pro_ahb_2::R`](R) reader structure
impl crate::Readable for PRO_AHB_2_SPEC {}
///`write(|w| ..)` method takes [`pro_ahb_2::W`](W) writer structure
impl crate::Writable for PRO_AHB_2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_AHB_2 to value 0x0001_f800
