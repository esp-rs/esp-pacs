///Register `PRO_AHB_0` reader
pub type R = crate::R<PRO_AHB_0_SPEC>;
///Register `PRO_AHB_0` writer
pub type W = crate::W<PRO_AHB_0_SPEC>;
///Field `PRO_AHB_LOCK` reader - Lock register. Setting to 1 locks PeriBus2 permission control registers.
pub type PRO_AHB_LOCK_R = crate::BitReader;
///Field `PRO_AHB_LOCK` writer - Lock register. Setting to 1 locks PeriBus2 permission control registers.
pub type PRO_AHB_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Lock register. Setting to 1 locks PeriBus2 permission control registers.
    #[inline(always)]
...
///`read()` method returns [`pro_ahb_0::R`](R) reader structure
impl crate::Readable for PRO_AHB_0_SPEC {}
///`write(|w| ..)` method takes [`pro_ahb_0::W`](W) writer structure
impl crate::Writable for PRO_AHB_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_AHB_0 to value 0
