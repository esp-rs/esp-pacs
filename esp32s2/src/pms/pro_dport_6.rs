...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_DPORT_6")
            .field("pro_dport_ilg_clr", &self.pro_dport_ilg_clr().bit())
            .field("pro_dport_ilg_en", &self.pro_dport_ilg_en().bit())
            .field("pro_dport_ilg_intr", &self.pro_dport_ilg_intr().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
