///Register `PRO_DPORT_6` reader
pub type R = crate::R<PRO_DPORT_6_SPEC>;
///Register `PRO_DPORT_6` writer
pub type W = crate::W<PRO_DPORT_6_SPEC>;
///Field `PRO_DPORT_ILG_CLR` reader - The clear signal for PeriBus1 access interrupt.
pub type PRO_DPORT_ILG_CLR_R = crate::BitReader;
///Field `PRO_DPORT_ILG_CLR` writer - The clear signal for PeriBus1 access interrupt.
pub type PRO_DPORT_ILG_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DPORT_ILG_EN` reader - The enable signal for PeriBus1 access interrupt.
pub type PRO_DPORT_ILG_EN_R = crate::BitReader;
///Field `PRO_DPORT_ILG_EN` writer - The enable signal for PeriBus1 access interrupt.
pub type PRO_DPORT_ILG_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_DPORT_ILG_INTR` reader - PeriBus1 access interrupt signal.
pub type PRO_DPORT_ILG_INTR_R = crate::BitReader;
impl R {
    ///Bit 0 - The clear signal for PeriBus1 access interrupt.
    #[inline(always)]
    pub fn pro_dport_ilg_clr(&self) -> PRO_DPORT_ILG_CLR_R {
        PRO_DPORT_ILG_CLR_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The enable signal for PeriBus1 access interrupt.
    #[inline(always)]
    pub fn pro_dport_ilg_en(&self) -> PRO_DPORT_ILG_EN_R {
        PRO_DPORT_ILG_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - PeriBus1 access interrupt signal.
    #[inline(always)]
...
///`read()` method returns [`pro_dport_6::R`](R) reader structure
impl crate::Readable for PRO_DPORT_6_SPEC {}
///`write(|w| ..)` method takes [`pro_dport_6::W`](W) writer structure
impl crate::Writable for PRO_DPORT_6_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_DPORT_6 to value 0
