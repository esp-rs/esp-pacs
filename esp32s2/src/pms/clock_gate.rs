...
///Field `CLK_EN` reader - Enable the clock of permission control module when set to 1.
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - Enable the clock of permission control module when set to 1.
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Enable the clock of permission control module when set to 1.
    #[inline(always)]
