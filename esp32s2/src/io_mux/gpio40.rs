///Register `GPIO40` reader
pub type R = crate::R<GPIO40_SPEC>;
///Register `GPIO40` writer
...
///`read()` method returns [`gpio40::R`](R) reader structure
impl crate::Readable for GPIO40_SPEC {}
///`write(|w| ..)` method takes [`gpio40::W`](W) writer structure
impl crate::Writable for GPIO40_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO40 to value 0x0b00
