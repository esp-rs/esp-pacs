...
#[doc = "Field `VERSION` reader - Version control register"]
pub type VERSION_R = crate::FieldReader<u32>;
#[doc = "Field `VERSION` writer - Version control register"]
pub type VERSION_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 28, O, u32>;
impl R {
    #[doc = "Bits 0:27 - Version control register"]
    #[inline(always)]
    pub fn version(&self) -> VERSION_R {
        VERSION_R::new(self.bits & 0x0fff_ffff)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DATE")
            .field("version", &format_args!("{}", self.version().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn version(&mut self) -> VERSION_W<DATE_SPEC, 0> {
        VERSION_W::new(self)
    }
...
#[doc = "`reset()` method sets DATE to value 0x0190_7160"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0190_7160;
}
