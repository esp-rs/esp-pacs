///Register `GPIO46` reader
pub type R = crate::R<GPIO46_SPEC>;
///Register `GPIO46` writer
...
///`read()` method returns [`gpio46::R`](R) reader structure
impl crate::Readable for GPIO46_SPEC {}
///`write(|w| ..)` method takes [`gpio46::W`](W) writer structure
impl crate::Writable for GPIO46_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO46 to value 0x0b00
