...
pub struct R(crate::R<GPIO46_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO46_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO46_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO46_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO46` writer"]
pub struct W(crate::W<GPIO46_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO46_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIO46_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO46_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MCU_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO46_SPEC, bool, O>;
...
pub type SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO46_SPEC, bool, O>;
...
pub type MCU_WPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO46_SPEC, bool, O>;
...
pub type MCU_WPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO46_SPEC, bool, O>;
...
pub type MCU_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO46_SPEC, bool, O>;
...
pub type FUN_WPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO46_SPEC, bool, O>;
...
pub type FUN_WPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO46_SPEC, bool, O>;
...
pub type FUN_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO46_SPEC, bool, O>;
...
pub type FUN_DRV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPIO46_SPEC, u8, u8, 2, O>;
...
pub type MCU_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPIO46_SPEC, u8, u8, 3, O>;
...
pub type FILTER_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO46_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets GPIO46 to value 0x0b00"]
