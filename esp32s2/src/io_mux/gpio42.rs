///Register `GPIO42` reader
pub type R = crate::R<GPIO42_SPEC>;
///Register `GPIO42` writer
...
///`read()` method returns [`gpio42::R`](R) reader structure
impl crate::Readable for GPIO42_SPEC {}
///`write(|w| ..)` method takes [`gpio42::W`](W) writer structure
impl crate::Writable for GPIO42_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO42 to value 0x0b00
