///Register `GPIO30` reader
pub type R = crate::R<GPIO30_SPEC>;
///Register `GPIO30` writer
...
///`read()` method returns [`gpio30::R`](R) reader structure
impl crate::Readable for GPIO30_SPEC {}
///`write(|w| ..)` method takes [`gpio30::W`](W) writer structure
impl crate::Writable for GPIO30_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO30 to value 0x0b00
