///Register `GPIO45` reader
pub type R = crate::R<GPIO45_SPEC>;
///Register `GPIO45` writer
...
///`read()` method returns [`gpio45::R`](R) reader structure
impl crate::Readable for GPIO45_SPEC {}
///`write(|w| ..)` method takes [`gpio45::W`](W) writer structure
impl crate::Writable for GPIO45_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO45 to value 0x0b00
