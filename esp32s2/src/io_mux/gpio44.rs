///Register `GPIO44` reader
pub type R = crate::R<GPIO44_SPEC>;
///Register `GPIO44` writer
...
///`read()` method returns [`gpio44::R`](R) reader structure
impl crate::Readable for GPIO44_SPEC {}
///`write(|w| ..)` method takes [`gpio44::W`](W) writer structure
impl crate::Writable for GPIO44_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO44 to value 0x0b00
