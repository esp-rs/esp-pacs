///Register `GPIO31` reader
pub type R = crate::R<GPIO31_SPEC>;
///Register `GPIO31` writer
...
///`read()` method returns [`gpio31::R`](R) reader structure
impl crate::Readable for GPIO31_SPEC {}
///`write(|w| ..)` method takes [`gpio31::W`](W) writer structure
impl crate::Writable for GPIO31_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO31 to value 0x0b00
