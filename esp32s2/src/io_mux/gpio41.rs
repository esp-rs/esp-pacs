///Register `GPIO41` reader
pub type R = crate::R<GPIO41_SPEC>;
///Register `GPIO41` writer
...
///`read()` method returns [`gpio41::R`](R) reader structure
impl crate::Readable for GPIO41_SPEC {}
///`write(|w| ..)` method takes [`gpio41::W`](W) writer structure
impl crate::Writable for GPIO41_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO41 to value 0x0b00
