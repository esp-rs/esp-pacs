...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn filter_en(&mut self) -> FILTER_EN_W<GPIO38_SPEC> {
        FILTER_EN_W::new(self, 15)
    }
}
#[doc = "Configuration register for pin GPIO38\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio38::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio38::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
