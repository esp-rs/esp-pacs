///Register `GPIO28` reader
pub type R = crate::R<GPIO28_SPEC>;
///Register `GPIO28` writer
...
///`read()` method returns [`gpio28::R`](R) reader structure
impl crate::Readable for GPIO28_SPEC {}
///`write(|w| ..)` method takes [`gpio28::W`](W) writer structure
impl crate::Writable for GPIO28_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO28 to value 0x0b00
