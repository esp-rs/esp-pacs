...
pub type PIN_CLK_OUT1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIN_CTRL_SPEC, u8, u8, 4, O>;
...
pub type PIN_CLK_OUT2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIN_CTRL_SPEC, u8, u8, 4, O>;
...
pub type PIN_CLK_OUT3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIN_CTRL_SPEC, u8, u8, 4, O>;
...
pub type SWITCH_PRT_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PIN_CTRL_SPEC, u8, u8, 3, O>;
...
pub type PAD_POWER_CTRL_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIN_CTRL_SPEC, bool, O>;
impl R {
