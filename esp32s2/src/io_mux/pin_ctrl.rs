...
///Field `PIN_CLK_OUT1` reader - Configure I2S0 clock output. 0: output I2S0 clock to CLK_OUT1. 15: disabled.
pub type PIN_CLK_OUT1_R = crate::FieldReader;
///Field `PIN_CLK_OUT1` writer - Configure I2S0 clock output. 0: output I2S0 clock to CLK_OUT1. 15: disabled.
pub type PIN_CLK_OUT1_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `PIN_CLK_OUT2` reader - Configure I2S0 clock output. 0: output I2S0 clock to CLK_OUT2. 15: disabled.
pub type PIN_CLK_OUT2_R = crate::FieldReader;
///Field `PIN_CLK_OUT2` writer - Configure I2S0 clock output. 0: output I2S0 clock to CLK_OUT2. 15: disabled.
pub type PIN_CLK_OUT2_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `PIN_CLK_OUT3` reader - Configure I2S0 clock output. 0: output I2S0 clock to CLK_OUT3. 15: disabled.
pub type PIN_CLK_OUT3_R = crate::FieldReader;
///Field `PIN_CLK_OUT3` writer - Configure I2S0 clock output. 0: output I2S0 clock to CLK_OUT3. 15: disabled.
pub type PIN_CLK_OUT3_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SWITCH_PRT_NUM` reader - IO pin power switch delay, delay unit is one APB clock.
pub type SWITCH_PRT_NUM_R = crate::FieldReader;
///Field `SWITCH_PRT_NUM` writer - IO pin power switch delay, delay unit is one APB clock.
pub type SWITCH_PRT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `PAD_POWER_CTRL` reader - Select power voltage for GPIO33 ~ GPIO37. 1: select VDD_SPI 1.8 V. 0: select VDD3P3_CPU 3.3 V.
pub type PAD_POWER_CTRL_R = crate::BitReader;
///Field `PAD_POWER_CTRL` writer - Select power voltage for GPIO33 ~ GPIO37. 1: select VDD_SPI 1.8 V. 0: select VDD3P3_CPU 3.3 V.
...
///`reset()` method sets PIN_CTRL to value 0x27ff
