...
pub type MCU_OE_W<'a, const O: u8> = crate::BitWriter<'a, GPIO5_SPEC, O>;
...
pub type SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, GPIO5_SPEC, O>;
...
pub type MCU_WPD_W<'a, const O: u8> = crate::BitWriter<'a, GPIO5_SPEC, O>;
...
pub type MCU_WPU_W<'a, const O: u8> = crate::BitWriter<'a, GPIO5_SPEC, O>;
...
pub type MCU_IE_W<'a, const O: u8> = crate::BitWriter<'a, GPIO5_SPEC, O>;
...
pub type FUN_WPD_W<'a, const O: u8> = crate::BitWriter<'a, GPIO5_SPEC, O>;
...
pub type FUN_WPU_W<'a, const O: u8> = crate::BitWriter<'a, GPIO5_SPEC, O>;
...
pub type FUN_IE_W<'a, const O: u8> = crate::BitWriter<'a, GPIO5_SPEC, O>;
...
pub type FUN_DRV_W<'a, const O: u8> = crate::FieldWriter<'a, GPIO5_SPEC, 2, O>;
...
pub type MCU_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, GPIO5_SPEC, 3, O>;
...
pub type FILTER_EN_W<'a, const O: u8> = crate::BitWriter<'a, GPIO5_SPEC, O>;
impl R {
