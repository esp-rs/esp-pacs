///Register `GPIO43` reader
pub type R = crate::R<GPIO43_SPEC>;
///Register `GPIO43` writer
...
///`read()` method returns [`gpio43::R`](R) reader structure
impl crate::Readable for GPIO43_SPEC {}
///`write(|w| ..)` method takes [`gpio43::W`](W) writer structure
impl crate::Writable for GPIO43_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO43 to value 0x0b00
