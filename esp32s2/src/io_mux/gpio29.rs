///Register `GPIO29` reader
pub type R = crate::R<GPIO29_SPEC>;
///Register `GPIO29` writer
...
///`read()` method returns [`gpio29::R`](R) reader structure
impl crate::Readable for GPIO29_SPEC {}
///`write(|w| ..)` method takes [`gpio29::W`](W) writer structure
impl crate::Writable for GPIO29_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO29 to value 0x0b00
