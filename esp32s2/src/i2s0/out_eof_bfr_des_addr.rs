...
///Field `OUT_EOF_BFR_DES_ADDR` reader - The address of buffer relative to the outlink descriptor that produces EOF.
pub type OUT_EOF_BFR_DES_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The address of buffer relative to the outlink descriptor that produces EOF.
    #[inline(always)]
