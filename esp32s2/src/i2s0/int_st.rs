...
#[doc = "Field `RX_TAKE_DATA` reader - The masked interrupt status bit for I2S_RX_TAKE_DATA_INT interrupt."]
pub type RX_TAKE_DATA_R = crate::BitReader;
#[doc = "Field `TX_PUT_DATA` reader - The masked interrupt status bit for I2S_TX_PUT_DATA_INT interrupt."]
pub type TX_PUT_DATA_R = crate::BitReader;
#[doc = "Field `RX_WFULL` reader - The masked interrupt status bit for I2S_RX_WFULL_INT interrupt."]
pub type RX_WFULL_R = crate::BitReader;
#[doc = "Field `RX_REMPTY` reader - The masked interrupt status bit for I2S_RX_REMPTY_INT interrupt."]
pub type RX_REMPTY_R = crate::BitReader;
#[doc = "Field `TX_WFULL` reader - The masked interrupt status bit for I2S_TX_WFULL_INT interrupt."]
pub type TX_WFULL_R = crate::BitReader;
#[doc = "Field `TX_REMPTY` reader - The masked interrupt status bit for I2S_TX_REMPTY_INT interrupt."]
pub type TX_REMPTY_R = crate::BitReader;
#[doc = "Field `RX_HUNG` reader - The masked interrupt status bit for I2S_RX_HUNG_INT interrupt."]
pub type RX_HUNG_R = crate::BitReader;
#[doc = "Field `TX_HUNG` reader - The masked interrupt status bit for I2S_TX_HUNG_INT interrupt."]
pub type TX_HUNG_R = crate::BitReader;
#[doc = "Field `IN_DONE` reader - The masked interrupt status bit for I2S_IN_DONE_INT interrupt."]
pub type IN_DONE_R = crate::BitReader;
#[doc = "Field `IN_SUC_EOF` reader - The masked interrupt status bit for I2S_IN_SUC_EOF_INT interrupt."]
pub type IN_SUC_EOF_R = crate::BitReader;
#[doc = "Field `IN_ERR_EOF` reader - Reserved."]
pub type IN_ERR_EOF_R = crate::BitReader;
#[doc = "Field `OUT_DONE` reader - The masked interrupt status bit for I2S_OUT_DONE_INT interrupt."]
pub type OUT_DONE_R = crate::BitReader;
#[doc = "Field `OUT_EOF` reader - The masked interrupt status bit for I2S_OUT_EOF_INT interrupt."]
pub type OUT_EOF_R = crate::BitReader;
#[doc = "Field `IN_DSCR_ERR` reader - The masked interrupt status bit for I2S_IN_DSCR_ERR_INT interrupt."]
pub type IN_DSCR_ERR_R = crate::BitReader;
#[doc = "Field `OUT_DSCR_ERR` reader - The masked interrupt status bit for I2S_OUT_DSCR_ERR_INT interrupt."]
pub type OUT_DSCR_ERR_R = crate::BitReader;
#[doc = "Field `IN_DSCR_EMPTY` reader - The masked interrupt status bit for I2S_IN_DSCR_EMPTY_INT interrupt."]
pub type IN_DSCR_EMPTY_R = crate::BitReader;
#[doc = "Field `OUT_TOTAL_EOF` reader - The masked interrupt status bit for I2S_OUT_TOTAL_EOF_INT interrupt."]
pub type OUT_TOTAL_EOF_R = crate::BitReader;
#[doc = "Field `V_SYNC` reader - The masked interrupt status bit for I2S_V_SYNC_INT interrupt."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            .field("rx_take_data", &self.rx_take_data().bit())
            .field("tx_put_data", &self.tx_put_data().bit())
            .field("rx_wfull", &self.rx_wfull().bit())
            .field("rx_rempty", &self.rx_rempty().bit())
            .field("tx_wfull", &self.tx_wfull().bit())
            .field("tx_rempty", &self.tx_rempty().bit())
