...
pub type RX_FIFO_SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RX_24MSB_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TX_24MSB_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_fifo_sync(&mut self) -> RX_FIFO_SYNC_W<FIFO_CONF_SPEC, 21> {
        RX_FIFO_SYNC_W::new(self)
    }
    #[doc = "Bit 22 - Only useful in rx 24bit mode. 1: the high 24 bits are effective in i2s fifo 0: the low 24 bits are effective in i2s fifo"]
    #[inline(always)]
    #[must_use]
    pub fn rx_24msb_en(&mut self) -> RX_24MSB_EN_W<FIFO_CONF_SPEC, 22> {
        RX_24MSB_EN_W::new(self)
    }
    #[doc = "Bit 23 - Only useful in tx 24bit mode. 1: the high 24 bits are effective in i2s fifo 0: the low 24 bits are effective in i2s fifo"]
    #[inline(always)]
    #[must_use]
    pub fn tx_24msb_en(&mut self) -> TX_24MSB_EN_W<FIFO_CONF_SPEC, 23> {
