...
///Field `CLKM_DIV_NUM` reader - Integral I2S clock divider value.
pub type CLKM_DIV_NUM_R = crate::FieldReader;
///Field `CLKM_DIV_NUM` writer - Integral I2S clock divider value.
...
///Field `CLK_SEL` reader - Set this bit to select I2S module clock source. 0: No clock. 1: APLL_CLK. 2: PLL_160M_CLK. 3: No clock.
pub type CLK_SEL_R = crate::FieldReader;
///Field `CLK_SEL` writer - Set this bit to select I2S module clock source. 0: No clock. 1: APLL_CLK. 2: PLL_160M_CLK. 3: No clock.
...
impl R {
    ...
    ///Bits 21:22 - Set this bit to select I2S module clock source. 0: No clock. 1: APLL_CLK. 2: PLL_160M_CLK. 3: No clock.
    #[inline(always)]
