...
///`read()` method returns [`outfifo_push::R`](R) reader structure
impl crate::Readable for OUTFIFO_PUSH_SPEC {}
///`write(|w| ..)` method takes [`outfifo_push::W`](W) writer structure
