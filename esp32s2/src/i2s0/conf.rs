...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF")
            ...
            .field("tx_lsb_first_dma", &self.tx_lsb_first_dma())
            .field("rx_lsb_first_dma", &self.rx_lsb_first_dma())
            .field("sig_loopback", &self.sig_loopback())
            .field("tx_fifo_reset_st", &self.tx_fifo_reset_st())
            .field("rx_fifo_reset_st", &self.rx_fifo_reset_st())
            .field("tx_reset_st", &self.tx_reset_st())
            .field("tx_dma_equal", &self.tx_dma_equal())
            .field("rx_dma_equal", &self.rx_dma_equal())
            .field("pre_req_en", &self.pre_req_en())
            .field("tx_big_endian", &self.tx_big_endian())
            .field("rx_big_endian", &self.rx_big_endian())
            .field("rx_reset_st", &self.rx_reset_st())
            .finish()
    }
}
impl W {
...
///`reset()` method sets CONF to value 0x000c_0300
