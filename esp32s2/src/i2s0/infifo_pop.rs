///Register `INFIFO_POP` reader
pub type R = crate::R<INFIFO_POP_SPEC>;
///Register `INFIFO_POP` writer
pub type W = crate::W<INFIFO_POP_SPEC>;
///Field `INFIFO_RDATA` reader - APB in FIFO read data.
pub type INFIFO_RDATA_R = crate::FieldReader<u16>;
///Field `INFIFO_POP` reader - APB in FIFO pop.
pub type INFIFO_POP_R = crate::BitReader;
///Field `INFIFO_POP` writer - APB in FIFO pop.
pub type INFIFO_POP_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:11 - APB in FIFO read data.
    #[inline(always)]
...
///`read()` method returns [`infifo_pop::R`](R) reader structure
impl crate::Readable for INFIFO_POP_SPEC {}
///`write(|w| ..)` method takes [`infifo_pop::W`](W) writer structure
