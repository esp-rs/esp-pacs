...
///Field `CAMERA_EN` reader - Set this bit to enable camera mode.
pub type CAMERA_EN_R = crate::BitReader;
///Field `CAMERA_EN` writer - Set this bit to enable camera mode.
pub type CAMERA_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_TX_WRX2_EN` reader - LCD WR double for one datum.
pub type LCD_TX_WRX2_EN_R = crate::BitReader;
///Field `LCD_TX_WRX2_EN` writer - LCD WR double for one datum.
pub type LCD_TX_WRX2_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_TX_SDX2_EN` reader - Set this bit to duplicate data pairs (Frame Form 2) in LCD mode.
pub type LCD_TX_SDX2_EN_R = crate::BitReader;
///Field `LCD_TX_SDX2_EN` writer - Set this bit to duplicate data pairs (Frame Form 2) in LCD mode.
pub type LCD_TX_SDX2_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DATA_ENABLE_TEST_EN` reader - for debug camera mode enable
pub type DATA_ENABLE_TEST_EN_R = crate::BitReader;
///Field `DATA_ENABLE_TEST_EN` writer - for debug camera mode enable
pub type DATA_ENABLE_TEST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DATA_ENABLE` reader - for debug camera mode enable
pub type DATA_ENABLE_R = crate::BitReader;
///Field `DATA_ENABLE` writer - for debug camera mode enable
pub type DATA_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_EN` reader - Set this bit to enable LCD mode.
pub type LCD_EN_R = crate::BitReader;
///Field `LCD_EN` writer - Set this bit to enable LCD mode.
pub type LCD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXT_ADC_START_EN` reader - Set this bit to enable the function that ADC mode is triggered by external signal.
pub type EXT_ADC_START_EN_R = crate::BitReader;
///Field `EXT_ADC_START_EN` writer - Set this bit to enable the function that ADC mode is triggered by external signal.
pub type EXT_ADC_START_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INTER_VALID_EN` reader - Set this bit to enable camera VGA reducing-resolution mode: only receive two consecutive cycle data in four consecutive clocks.
pub type INTER_VALID_EN_R = crate::BitReader;
///Field `INTER_VALID_EN` writer - Set this bit to enable camera VGA reducing-resolution mode: only receive two consecutive cycle data in four consecutive clocks.
pub type INTER_VALID_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_SYNC_FIFO_RESET` reader - Set this bit to reset FIFO in camera mode.
pub type CAM_SYNC_FIFO_RESET_R = crate::BitReader;
///Field `CAM_SYNC_FIFO_RESET` writer - Set this bit to reset FIFO in camera mode.
pub type CAM_SYNC_FIFO_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_CLK_LOOPBACK` reader - Set this bit to loopback PCLK from I2S0I_WS_out.
pub type CAM_CLK_LOOPBACK_R = crate::BitReader;
///Field `CAM_CLK_LOOPBACK` writer - Set this bit to loopback PCLK from I2S0I_WS_out.
pub type CAM_CLK_LOOPBACK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `VSYNC_FILTER_EN` reader - Set this bit to enable I2S VSYNC filter function.
pub type VSYNC_FILTER_EN_R = crate::BitReader;
///Field `VSYNC_FILTER_EN` writer - Set this bit to enable I2S VSYNC filter function.
pub type VSYNC_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `VSYNC_FILTER_THRES` reader - Configure the I2S VSYNC filter threshold value.
pub type VSYNC_FILTER_THRES_R = crate::FieldReader;
///Field `VSYNC_FILTER_THRES` writer - Configure the I2S VSYNC filter threshold value.
