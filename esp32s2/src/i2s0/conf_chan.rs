///Register `CONF_CHAN` reader
pub type R = crate::R<CONF_CHAN_SPEC>;
///Register `CONF_CHAN` writer
...
///Field `RX_CHAN_MOD` reader - I2S receiver channel mode configuration bits.
pub type RX_CHAN_MOD_R = crate::FieldReader;
///Field `RX_CHAN_MOD` writer - I2S receiver channel mode configuration bits.
...
///`read()` method returns [`conf_chan::R`](R) reader structure
impl crate::Readable for CONF_CHAN_SPEC {}
///`write(|w| ..)` method takes [`conf_chan::W`](W) writer structure
