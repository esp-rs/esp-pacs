...
pub type SPI_DMA_INFIFO_FULL_ERR_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_DMA_OUTFIFO_EMPTY_ERR_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_EX_QPI_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_EN_QPI_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_CMD7_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_CMD8_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_CMD9_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_CMDA_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_RD_DMA_DONE_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_WR_DMA_DONE_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_RD_BUF_DONE_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_WR_BUF_DONE_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_TRANS_DONE_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_DMA_SEG_TRANS_DONE_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SEG_MAGIC_ERR_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_BUF_ADDR_ERR_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_SLV_CMD_ERR_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_MST_RX_AFIFO_WFULL_ERR_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_MST_TX_AFIFO_REMPTY_ERR_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_APP2_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
...
pub type SPI_APP1_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_ENA_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_infifo_full_err_int_ena(&mut self) -> SPI_DMA_INFIFO_FULL_ERR_INT_ENA_W<0> {
        SPI_DMA_INFIFO_FULL_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 1 - The enable bit for SPI_DMA_OUTFIFO_EMPTY_ERR_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_outfifo_empty_err_int_ena(&mut self) -> SPI_DMA_OUTFIFO_EMPTY_ERR_INT_ENA_W<1> {
        SPI_DMA_OUTFIFO_EMPTY_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 2 - The enable bit for SPI slave Ex_QPI interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_ex_qpi_int_ena(&mut self) -> SPI_SLV_EX_QPI_INT_ENA_W<2> {
        SPI_SLV_EX_QPI_INT_ENA_W::new(self)
    }
    #[doc = "Bit 3 - The enable bit for SPI slave En_QPI interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_en_qpi_int_ena(&mut self) -> SPI_SLV_EN_QPI_INT_ENA_W<3> {
        SPI_SLV_EN_QPI_INT_ENA_W::new(self)
    }
    #[doc = "Bit 4 - The enable bit for SPI slave CMD7 interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmd7_int_ena(&mut self) -> SPI_SLV_CMD7_INT_ENA_W<4> {
        SPI_SLV_CMD7_INT_ENA_W::new(self)
    }
    #[doc = "Bit 5 - The enable bit for SPI slave CMD8 interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmd8_int_ena(&mut self) -> SPI_SLV_CMD8_INT_ENA_W<5> {
        SPI_SLV_CMD8_INT_ENA_W::new(self)
    }
    #[doc = "Bit 6 - The enable bit for SPI slave CMD9 interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmd9_int_ena(&mut self) -> SPI_SLV_CMD9_INT_ENA_W<6> {
        SPI_SLV_CMD9_INT_ENA_W::new(self)
    }
    #[doc = "Bit 7 - The enable bit for SPI slave CMDA interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmda_int_ena(&mut self) -> SPI_SLV_CMDA_INT_ENA_W<7> {
        SPI_SLV_CMDA_INT_ENA_W::new(self)
    }
    #[doc = "Bit 8 - The enable bit for SPI_SLV_RD_DMA_DONE_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_rd_dma_done_int_ena(&mut self) -> SPI_SLV_RD_DMA_DONE_INT_ENA_W<8> {
        SPI_SLV_RD_DMA_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 9 - The enable bit for SPI_SLV_WR_DMA_DONE_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_wr_dma_done_int_ena(&mut self) -> SPI_SLV_WR_DMA_DONE_INT_ENA_W<9> {
        SPI_SLV_WR_DMA_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 10 - The enable bit for SPI_SLV_RD_BUF_DONE_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_rd_buf_done_int_ena(&mut self) -> SPI_SLV_RD_BUF_DONE_INT_ENA_W<10> {
        SPI_SLV_RD_BUF_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 11 - The enable bit for SPI_SLV_WR_BUF_DONE_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_wr_buf_done_int_ena(&mut self) -> SPI_SLV_WR_BUF_DONE_INT_ENA_W<11> {
        SPI_SLV_WR_BUF_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 12 - The enable bit for SPI_TRANS_DONE_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_trans_done_int_ena(&mut self) -> SPI_TRANS_DONE_INT_ENA_W<12> {
        SPI_TRANS_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 13 - The enable bit for SPI_DMA_SEG_TRANS_DONE_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_seg_trans_done_int_ena(&mut self) -> SPI_DMA_SEG_TRANS_DONE_INT_ENA_W<13> {
        SPI_DMA_SEG_TRANS_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 14 - The enable bit for SPI_SEG_MAGIC_ERR_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_seg_magic_err_int_ena(&mut self) -> SPI_SEG_MAGIC_ERR_INT_ENA_W<14> {
        SPI_SEG_MAGIC_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 15 - The enable bit for SPI_SLV_BUF_ADDR_ERR_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_buf_addr_err_int_ena(&mut self) -> SPI_SLV_BUF_ADDR_ERR_INT_ENA_W<15> {
        SPI_SLV_BUF_ADDR_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 16 - The enable bit for SPI_SLV_CMD_ERR_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmd_err_int_ena(&mut self) -> SPI_SLV_CMD_ERR_INT_ENA_W<16> {
    ...
    pub fn spi_mst_rx_afifo_wfull_err_int_ena(
        &mut self,
    ) -> SPI_MST_RX_AFIFO_WFULL_ERR_INT_ENA_W<17> {
    ...
    pub fn spi_mst_tx_afifo_rempty_err_int_ena(
        &mut self,
    ) -> SPI_MST_TX_AFIFO_REMPTY_ERR_INT_ENA_W<18> {
        SPI_MST_TX_AFIFO_REMPTY_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 19 - The enable bit for SPI_APP2_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_app2_int_ena(&mut self) -> SPI_APP2_INT_ENA_W<19> {
        SPI_APP2_INT_ENA_W::new(self)
    }
    #[doc = "Bit 20 - The enable bit for SPI_APP1_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn spi_app1_int_ena(&mut self) -> SPI_APP1_INT_ENA_W<20> {
