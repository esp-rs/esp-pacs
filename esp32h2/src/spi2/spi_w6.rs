...
#[doc = "Field `SPI_BUF6` reader - data buffer"]
pub type SPI_BUF6_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_BUF6` writer - data buffer"]
pub type SPI_BUF6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI_W6_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_buf6(&mut self) -> SPI_BUF6_W<0> {
        SPI_BUF6_W::new(self)
    }
