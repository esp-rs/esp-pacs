...
pub type SPI_DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI_DATE_SPEC, u32, u32, 28, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_date(&mut self) -> SPI_DATE_W<0> {
        SPI_DATE_W::new(self)
    }
...
#[doc = "`reset()` method sets SPI_DATE to value 0x0220_1300"]
impl crate::Resettable for SPI_DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_1300;
}
