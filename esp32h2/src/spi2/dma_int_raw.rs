...
pub type DMA_INFIFO_FULL_ERR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_OUTFIFO_EMPTY_ERR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLV_EX_QPI_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLV_EN_QPI_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLV_RD_DMA_DONE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLV_WR_DMA_DONE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLV_RD_BUF_DONE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLV_WR_BUF_DONE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TRANS_DONE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMA_SEG_TRANS_DONE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SEG_MAGIC_ERR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLV_BUF_ADDR_ERR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLV_CMD_ERR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MST_RX_AFIFO_WFULL_ERR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MST_TX_AFIFO_REMPTY_ERR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `APP2_INT_RAW` writer - The raw bit for SPI_APP2_INT interrupt. The value is only controlled by software."]
pub type APP2_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `APP1_INT_RAW` writer - The raw bit for SPI_APP1_INT interrupt. The value is only controlled by software."]
pub type APP1_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn dma_infifo_full_err_int_raw(
        &mut self,
    ) -> DMA_INFIFO_FULL_ERR_INT_RAW_W<DMA_INT_RAW_SPEC, 0> {
    ...
    pub fn dma_outfifo_empty_err_int_raw(
        &mut self,
    ) -> DMA_OUTFIFO_EMPTY_ERR_INT_RAW_W<DMA_INT_RAW_SPEC, 1> {
        DMA_OUTFIFO_EMPTY_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 2 - The raw bit for SPI slave Ex_QPI interrupt. 1: SPI slave mode Ex_QPI transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_ex_qpi_int_raw(&mut self) -> SLV_EX_QPI_INT_RAW_W<DMA_INT_RAW_SPEC, 2> {
        SLV_EX_QPI_INT_RAW_W::new(self)
    }
    #[doc = "Bit 3 - The raw bit for SPI slave En_QPI interrupt. 1: SPI slave mode En_QPI transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_en_qpi_int_raw(&mut self) -> SLV_EN_QPI_INT_RAW_W<DMA_INT_RAW_SPEC, 3> {
        SLV_EN_QPI_INT_RAW_W::new(self)
    }
    #[doc = "Bit 4 - The raw bit for SPI slave CMD7 interrupt. 1: SPI slave mode CMD7 transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmd7_int_raw(&mut self) -> SLV_CMD7_INT_RAW_W<DMA_INT_RAW_SPEC, 4> {
        SLV_CMD7_INT_RAW_W::new(self)
    }
    #[doc = "Bit 5 - The raw bit for SPI slave CMD8 interrupt. 1: SPI slave mode CMD8 transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmd8_int_raw(&mut self) -> SLV_CMD8_INT_RAW_W<DMA_INT_RAW_SPEC, 5> {
        SLV_CMD8_INT_RAW_W::new(self)
    }
    #[doc = "Bit 6 - The raw bit for SPI slave CMD9 interrupt. 1: SPI slave mode CMD9 transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmd9_int_raw(&mut self) -> SLV_CMD9_INT_RAW_W<DMA_INT_RAW_SPEC, 6> {
        SLV_CMD9_INT_RAW_W::new(self)
    }
    #[doc = "Bit 7 - The raw bit for SPI slave CMDA interrupt. 1: SPI slave mode CMDA transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmda_int_raw(&mut self) -> SLV_CMDA_INT_RAW_W<DMA_INT_RAW_SPEC, 7> {
        SLV_CMDA_INT_RAW_W::new(self)
    }
    #[doc = "Bit 8 - The raw bit for SPI_SLV_RD_DMA_DONE_INT interrupt. 1: SPI slave mode Rd_DMA transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_rd_dma_done_int_raw(&mut self) -> SLV_RD_DMA_DONE_INT_RAW_W<DMA_INT_RAW_SPEC, 8> {
        SLV_RD_DMA_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 9 - The raw bit for SPI_SLV_WR_DMA_DONE_INT interrupt. 1: SPI slave mode Wr_DMA transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_wr_dma_done_int_raw(&mut self) -> SLV_WR_DMA_DONE_INT_RAW_W<DMA_INT_RAW_SPEC, 9> {
        SLV_WR_DMA_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 10 - The raw bit for SPI_SLV_RD_BUF_DONE_INT interrupt. 1: SPI slave mode Rd_BUF transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_rd_buf_done_int_raw(&mut self) -> SLV_RD_BUF_DONE_INT_RAW_W<DMA_INT_RAW_SPEC, 10> {
        SLV_RD_BUF_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 11 - The raw bit for SPI_SLV_WR_BUF_DONE_INT interrupt. 1: SPI slave mode Wr_BUF transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_wr_buf_done_int_raw(&mut self) -> SLV_WR_BUF_DONE_INT_RAW_W<DMA_INT_RAW_SPEC, 11> {
        SLV_WR_BUF_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 12 - The raw bit for SPI_TRANS_DONE_INT interrupt. 1: SPI master mode transmission is ended. 0: others."]
    #[inline(always)]
    #[must_use]
    pub fn trans_done_int_raw(&mut self) -> TRANS_DONE_INT_RAW_W<DMA_INT_RAW_SPEC, 12> {
    ...
    pub fn dma_seg_trans_done_int_raw(
        &mut self,
    ) -> DMA_SEG_TRANS_DONE_INT_RAW_W<DMA_INT_RAW_SPEC, 13> {
        DMA_SEG_TRANS_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 14 - The raw bit for SPI_SEG_MAGIC_ERR_INT interrupt. 1: The magic value in CONF buffer is error in the DMA seg-conf-trans. 0: others."]
    #[inline(always)]
    #[must_use]
    pub fn seg_magic_err_int_raw(&mut self) -> SEG_MAGIC_ERR_INT_RAW_W<DMA_INT_RAW_SPEC, 14> {
        SEG_MAGIC_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 15 - The raw bit for SPI_SLV_BUF_ADDR_ERR_INT interrupt. 1: The accessing data address of the current SPI slave mode CPU controlled FD, Wr_BUF or Rd_BUF transmission is bigger than 63. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_buf_addr_err_int_raw(&mut self) -> SLV_BUF_ADDR_ERR_INT_RAW_W<DMA_INT_RAW_SPEC, 15> {
        SLV_BUF_ADDR_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 16 - The raw bit for SPI_SLV_CMD_ERR_INT interrupt. 1: The slave command value in the current SPI slave HD mode transmission is not supported. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn slv_cmd_err_int_raw(&mut self) -> SLV_CMD_ERR_INT_RAW_W<DMA_INT_RAW_SPEC, 16> {
    ...
    pub fn mst_rx_afifo_wfull_err_int_raw(
        &mut self,
    ) -> MST_RX_AFIFO_WFULL_ERR_INT_RAW_W<DMA_INT_RAW_SPEC, 17> {
    ...
    pub fn mst_tx_afifo_rempty_err_int_raw(
        &mut self,
    ) -> MST_TX_AFIFO_REMPTY_ERR_INT_RAW_W<DMA_INT_RAW_SPEC, 18> {
        MST_TX_AFIFO_REMPTY_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 19 - The raw bit for SPI_APP2_INT interrupt. The value is only controlled by software."]
    #[inline(always)]
    #[must_use]
    pub fn app2_int_raw(&mut self) -> APP2_INT_RAW_W<DMA_INT_RAW_SPEC, 19> {
        APP2_INT_RAW_W::new(self)
    }
    #[doc = "Bit 20 - The raw bit for SPI_APP1_INT interrupt. The value is only controlled by software."]
    #[inline(always)]
    #[must_use]
    pub fn app1_int_raw(&mut self) -> APP1_INT_RAW_W<DMA_INT_RAW_SPEC, 20> {
