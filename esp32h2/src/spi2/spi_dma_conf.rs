...
pub type SPI_DMA_SLV_SEG_TRANS_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_CONF_SPEC, bool, O>;
...
pub type SPI_SLV_RX_SEG_TRANS_CLR_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_CONF_SPEC, bool, O>;
...
pub type SPI_SLV_TX_SEG_TRANS_CLR_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_CONF_SPEC, bool, O>;
...
pub type SPI_RX_EOF_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_DMA_CONF_SPEC, bool, O>;
...
pub type SPI_DMA_RX_ENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_DMA_CONF_SPEC, bool, O>;
...
pub type SPI_DMA_TX_ENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_DMA_CONF_SPEC, bool, O>;
...
pub type SPI_RX_AFIFO_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_CONF_SPEC, bool, O>;
...
pub type SPI_BUF_AFIFO_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_CONF_SPEC, bool, O>;
...
pub type SPI_DMA_AFIFO_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_CONF_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_slv_seg_trans_en(&mut self) -> SPI_DMA_SLV_SEG_TRANS_EN_W<18> {
        SPI_DMA_SLV_SEG_TRANS_EN_W::new(self)
    }
    #[doc = "Bit 19 - 1: spi_dma_infifo_full_vld is cleared by spi slave cmd 5. 0: spi_dma_infifo_full_vld is cleared by spi_trans_done."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_rx_seg_trans_clr_en(&mut self) -> SPI_SLV_RX_SEG_TRANS_CLR_EN_W<19> {
        SPI_SLV_RX_SEG_TRANS_CLR_EN_W::new(self)
    }
    #[doc = "Bit 20 - 1: spi_dma_outfifo_empty_vld is cleared by spi slave cmd 6. 0: spi_dma_outfifo_empty_vld is cleared by spi_trans_done."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_tx_seg_trans_clr_en(&mut self) -> SPI_SLV_TX_SEG_TRANS_CLR_EN_W<20> {
        SPI_SLV_TX_SEG_TRANS_CLR_EN_W::new(self)
    }
    #[doc = "Bit 21 - 1: spi_dma_inlink_eof is set when the number of dma pushed data bytes is equal to the value of spi_slv/mst_dma_rd_bytelen\\[19:0\\] in spi dma transition. 0: spi_dma_inlink_eof is set by spi_trans_done in non-seg-trans or spi_dma_seg_trans_done in seg-trans."]
    #[inline(always)]
    #[must_use]
    pub fn spi_rx_eof_en(&mut self) -> SPI_RX_EOF_EN_W<21> {
        SPI_RX_EOF_EN_W::new(self)
    }
    #[doc = "Bit 27 - Set this bit to enable SPI DMA controlled receive data mode."]
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_rx_ena(&mut self) -> SPI_DMA_RX_ENA_W<27> {
        SPI_DMA_RX_ENA_W::new(self)
    }
    #[doc = "Bit 28 - Set this bit to enable SPI DMA controlled send data mode."]
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_tx_ena(&mut self) -> SPI_DMA_TX_ENA_W<28> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_rx_afifo_rst(&mut self) -> SPI_RX_AFIFO_RST_W<29> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_buf_afifo_rst(&mut self) -> SPI_BUF_AFIFO_RST_W<30> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_afifo_rst(&mut self) -> SPI_DMA_AFIFO_RST_W<31> {
