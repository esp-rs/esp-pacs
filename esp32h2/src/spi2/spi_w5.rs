...
pub type SPI_BUF5_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_BUF5` writer - data buffer"]
pub type SPI_BUF5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI_W5_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_buf5(&mut self) -> SPI_BUF5_W<0> {
        SPI_BUF5_W::new(self)
    }
