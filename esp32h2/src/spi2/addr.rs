...
///Field `USR_ADDR_VALUE` reader - Address to slave. Can be configured in CONF state.
pub type USR_ADDR_VALUE_R = crate::FieldReader<u32>;
///Field `USR_ADDR_VALUE` writer - Address to slave. Can be configured in CONF state.
