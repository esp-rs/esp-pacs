...
pub type SPI_BUF10_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_BUF10` writer - data buffer"]
pub type SPI_BUF10_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI_W10_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_buf10(&mut self) -> SPI_BUF10_W<0> {
        SPI_BUF10_W::new(self)
    }
