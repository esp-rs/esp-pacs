...
pub struct W(crate::W<SPI_DMA_INT_RAW_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI_DMA_INT_RAW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI_DMA_INT_RAW_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI_DMA_INT_RAW_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SPI_DMA_INFIFO_FULL_ERR_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_DMA_OUTFIFO_EMPTY_ERR_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_EX_QPI_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_EN_QPI_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_CMD7_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_CMD8_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_CMD9_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_CMDA_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_RD_DMA_DONE_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_WR_DMA_DONE_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_RD_BUF_DONE_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_WR_BUF_DONE_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_TRANS_DONE_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_DMA_SEG_TRANS_DONE_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
#[doc = "Field `SPI_SEG_MAGIC_ERR_INT_RAW` writer - The raw bit for SPI_SEG_MAGIC_ERR_INT interrupt. 1: The magic value in CONF buffer is error in the DMA seg-conf-trans. 0: others."]
pub type SPI_SEG_MAGIC_ERR_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_BUF_ADDR_ERR_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_SLV_CMD_ERR_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_MST_RX_AFIFO_WFULL_ERR_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_MST_TX_AFIFO_REMPTY_ERR_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_APP2_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
...
pub type SPI_APP1_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_DMA_INT_RAW_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_infifo_full_err_int_raw(&mut self) -> SPI_DMA_INFIFO_FULL_ERR_INT_RAW_W<0> {
        SPI_DMA_INFIFO_FULL_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 1 - 1: The current data rate of DMA TX is smaller than that of SPI. SPI will stop in master mode and send out all 0 in slave mode. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_outfifo_empty_err_int_raw(&mut self) -> SPI_DMA_OUTFIFO_EMPTY_ERR_INT_RAW_W<1> {
        SPI_DMA_OUTFIFO_EMPTY_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 2 - The raw bit for SPI slave Ex_QPI interrupt. 1: SPI slave mode Ex_QPI transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_ex_qpi_int_raw(&mut self) -> SPI_SLV_EX_QPI_INT_RAW_W<2> {
        SPI_SLV_EX_QPI_INT_RAW_W::new(self)
    }
    #[doc = "Bit 3 - The raw bit for SPI slave En_QPI interrupt. 1: SPI slave mode En_QPI transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_en_qpi_int_raw(&mut self) -> SPI_SLV_EN_QPI_INT_RAW_W<3> {
        SPI_SLV_EN_QPI_INT_RAW_W::new(self)
    }
    #[doc = "Bit 4 - The raw bit for SPI slave CMD7 interrupt. 1: SPI slave mode CMD7 transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmd7_int_raw(&mut self) -> SPI_SLV_CMD7_INT_RAW_W<4> {
        SPI_SLV_CMD7_INT_RAW_W::new(self)
    }
    #[doc = "Bit 5 - The raw bit for SPI slave CMD8 interrupt. 1: SPI slave mode CMD8 transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmd8_int_raw(&mut self) -> SPI_SLV_CMD8_INT_RAW_W<5> {
        SPI_SLV_CMD8_INT_RAW_W::new(self)
    }
    #[doc = "Bit 6 - The raw bit for SPI slave CMD9 interrupt. 1: SPI slave mode CMD9 transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmd9_int_raw(&mut self) -> SPI_SLV_CMD9_INT_RAW_W<6> {
        SPI_SLV_CMD9_INT_RAW_W::new(self)
    }
    #[doc = "Bit 7 - The raw bit for SPI slave CMDA interrupt. 1: SPI slave mode CMDA transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmda_int_raw(&mut self) -> SPI_SLV_CMDA_INT_RAW_W<7> {
        SPI_SLV_CMDA_INT_RAW_W::new(self)
    }
    #[doc = "Bit 8 - The raw bit for SPI_SLV_RD_DMA_DONE_INT interrupt. 1: SPI slave mode Rd_DMA transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_rd_dma_done_int_raw(&mut self) -> SPI_SLV_RD_DMA_DONE_INT_RAW_W<8> {
        SPI_SLV_RD_DMA_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 9 - The raw bit for SPI_SLV_WR_DMA_DONE_INT interrupt. 1: SPI slave mode Wr_DMA transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_wr_dma_done_int_raw(&mut self) -> SPI_SLV_WR_DMA_DONE_INT_RAW_W<9> {
        SPI_SLV_WR_DMA_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 10 - The raw bit for SPI_SLV_RD_BUF_DONE_INT interrupt. 1: SPI slave mode Rd_BUF transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_rd_buf_done_int_raw(&mut self) -> SPI_SLV_RD_BUF_DONE_INT_RAW_W<10> {
        SPI_SLV_RD_BUF_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 11 - The raw bit for SPI_SLV_WR_BUF_DONE_INT interrupt. 1: SPI slave mode Wr_BUF transmission is ended. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_wr_buf_done_int_raw(&mut self) -> SPI_SLV_WR_BUF_DONE_INT_RAW_W<11> {
        SPI_SLV_WR_BUF_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 12 - The raw bit for SPI_TRANS_DONE_INT interrupt. 1: SPI master mode transmission is ended. 0: others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_trans_done_int_raw(&mut self) -> SPI_TRANS_DONE_INT_RAW_W<12> {
        SPI_TRANS_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 13 - The raw bit for SPI_DMA_SEG_TRANS_DONE_INT interrupt. 1: spi master DMA full-duplex/half-duplex seg-conf-trans ends or slave half-duplex seg-trans ends. And data has been pushed to corresponding memory. 0: seg-conf-trans or seg-trans is not ended or not occurred."]
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_seg_trans_done_int_raw(&mut self) -> SPI_DMA_SEG_TRANS_DONE_INT_RAW_W<13> {
        SPI_DMA_SEG_TRANS_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 14 - The raw bit for SPI_SEG_MAGIC_ERR_INT interrupt. 1: The magic value in CONF buffer is error in the DMA seg-conf-trans. 0: others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_seg_magic_err_int_raw(&mut self) -> SPI_SEG_MAGIC_ERR_INT_RAW_W<14> {
        SPI_SEG_MAGIC_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 15 - The raw bit for SPI_SLV_BUF_ADDR_ERR_INT interrupt. 1: The accessing data address of the current SPI slave mode CPU controlled FD, Wr_BUF or Rd_BUF transmission is bigger than 63. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_buf_addr_err_int_raw(&mut self) -> SPI_SLV_BUF_ADDR_ERR_INT_RAW_W<15> {
        SPI_SLV_BUF_ADDR_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 16 - The raw bit for SPI_SLV_CMD_ERR_INT interrupt. 1: The slave command value in the current SPI slave HD mode transmission is not supported. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_cmd_err_int_raw(&mut self) -> SPI_SLV_CMD_ERR_INT_RAW_W<16> {
        SPI_SLV_CMD_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 17 - The raw bit for SPI_MST_RX_AFIFO_WFULL_ERR_INT interrupt. 1: There is a RX AFIFO write-full error when SPI inputs data in master mode. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mst_rx_afifo_wfull_err_int_raw(
        &mut self,
    ) -> SPI_MST_RX_AFIFO_WFULL_ERR_INT_RAW_W<17> {
        SPI_MST_RX_AFIFO_WFULL_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 18 - The raw bit for SPI_MST_TX_AFIFO_REMPTY_ERR_INT interrupt. 1: There is a TX BUF AFIFO read-empty error when SPI outputs data in master mode. 0: Others."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mst_tx_afifo_rempty_err_int_raw(
        &mut self,
    ) -> SPI_MST_TX_AFIFO_REMPTY_ERR_INT_RAW_W<18> {
        SPI_MST_TX_AFIFO_REMPTY_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 19 - The raw bit for SPI_APP2_INT interrupt. The value is only controlled by software."]
    #[inline(always)]
    #[must_use]
    pub fn spi_app2_int_raw(&mut self) -> SPI_APP2_INT_RAW_W<19> {
        SPI_APP2_INT_RAW_W::new(self)
    }
    #[doc = "Bit 20 - The raw bit for SPI_APP1_INT interrupt. The value is only controlled by software."]
    #[inline(always)]
    #[must_use]
    pub fn spi_app1_int_raw(&mut self) -> SPI_APP1_INT_RAW_W<20> {
        SPI_APP1_INT_RAW_W::new(self)
    }
