...
pub type SPI_CS0_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_CS1_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_CS2_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_CS3_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_CS4_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_CS5_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_CK_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_MASTER_CS_POL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_MISC_SPEC, u8, u8, 6, O>;
...
pub type SPI_SLAVE_CS_POL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_CK_IDLE_EDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_CS_KEEP_ACTIVE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
...
pub type SPI_QUAD_DIN_PIN_SWAP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_MISC_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_cs3_dis(&mut self) -> SPI_CS3_DIS_W<3> {
        SPI_CS3_DIS_W::new(self)
    }
    #[doc = "Bit 4 - SPI CS4 pin enable, 1: disable CS4, 0: spi_cs4 signal is from/to CS4 pin. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_cs4_dis(&mut self) -> SPI_CS4_DIS_W<4> {
        SPI_CS4_DIS_W::new(self)
    }
    #[doc = "Bit 5 - SPI CS5 pin enable, 1: disable CS5, 0: spi_cs5 signal is from/to CS5 pin. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_cs5_dis(&mut self) -> SPI_CS5_DIS_W<5> {
        SPI_CS5_DIS_W::new(self)
    }
    #[doc = "Bit 6 - 1: spi clk out disable, 0: spi clk out enable. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_ck_dis(&mut self) -> SPI_CK_DIS_W<6> {
        SPI_CK_DIS_W::new(self)
    }
    #[doc = "Bits 7:12 - In the master mode the bits are the polarity of spi cs line, the value is equivalent to spi_cs ^ spi_master_cs_pol. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_master_cs_pol(&mut self) -> SPI_MASTER_CS_POL_W<7> {
        SPI_MASTER_CS_POL_W::new(self)
    }
    #[doc = "Bit 23 - spi slave input cs polarity select. 1: inv 0: not change. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slave_cs_pol(&mut self) -> SPI_SLAVE_CS_POL_W<23> {
        SPI_SLAVE_CS_POL_W::new(self)
    }
    #[doc = "Bit 29 - 1: spi clk line is high when idle 0: spi clk line is low when idle. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_ck_idle_edge(&mut self) -> SPI_CK_IDLE_EDGE_W<29> {
        SPI_CK_IDLE_EDGE_W::new(self)
    }
    #[doc = "Bit 30 - spi cs line keep low when the bit is set. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_cs_keep_active(&mut self) -> SPI_CS_KEEP_ACTIVE_W<30> {
        SPI_CS_KEEP_ACTIVE_W::new(self)
    }
    #[doc = "Bit 31 - 1: SPI quad input swap enable, swap FSPID with FSPIQ, swap FSPIWP with FSPIHD. 0: spi quad input swap disable. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_quad_din_pin_swap(&mut self) -> SPI_QUAD_DIN_PIN_SWAP_W<31> {
