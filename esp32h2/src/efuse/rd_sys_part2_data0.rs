///Register `RD_SYS_PART2_DATA0` reader
pub type R = crate::R<RD_SYS_PART2_DATA0_SPEC>;
///Field `SYS_DATA_PART2_0` reader - Stores the 0th 32 bits of the 2nd part of system data.
...
///`read()` method returns [`rd_sys_part2_data0::R`](R) reader structure
