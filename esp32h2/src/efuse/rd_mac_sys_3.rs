///Register `RD_MAC_SYS_3` reader
pub type R = crate::R<RD_MAC_SYS_3_SPEC>;
///Field `DBIAS_VOL_GAP_VALUE2` reader - Stores the high 3 bits of dbias_vol_gap.
pub type DBIAS_VOL_GAP_VALUE2_R = crate::FieldReader;
///Field `DBIAS_VOL_GAP_SIGN` reader - Stores the sign bit of dbias_vol_gap.
pub type DBIAS_VOL_GAP_SIGN_R = crate::BitReader;
///Field `MAC_RESERVED_2` reader - Reserved.
pub type MAC_RESERVED_2_R = crate::FieldReader<u16>;
///Field `WAFER_VERSION_MINOR` reader - Stores the wafer version minor.
pub type WAFER_VERSION_MINOR_R = crate::FieldReader;
///Field `WAFER_VERSION_MAJOR` reader - Stores the wafer version major.
pub type WAFER_VERSION_MAJOR_R = crate::FieldReader;
///Field `DISABLE_WAFER_VERSION_MAJOR` reader - Disables check of wafer version major.
pub type DISABLE_WAFER_VERSION_MAJOR_R = crate::BitReader;
///Field `FLASH_CAP` reader - Stores the flash cap.
pub type FLASH_CAP_R = crate::FieldReader;
///Field `FLASH_TEMP` reader - Stores the flash temp.
pub type FLASH_TEMP_R = crate::FieldReader;
///Field `FLASH_VENDOR` reader - Stores the flash vendor.
pub type FLASH_VENDOR_R = crate::FieldReader;
impl R {
    ///Bits 0:2 - Stores the high 3 bits of dbias_vol_gap.
    #[inline(always)]
    pub fn dbias_vol_gap_value2(&self) -> DBIAS_VOL_GAP_VALUE2_R {
        DBIAS_VOL_GAP_VALUE2_R::new((self.bits & 7) as u8)
    }
    ///Bit 3 - Stores the sign bit of dbias_vol_gap.
    #[inline(always)]
...
///`read()` method returns [`rd_mac_sys_3::R`](R) reader structure
