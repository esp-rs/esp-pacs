///Register `RD_KEY0_DATA4` reader
pub type R = crate::R<RD_KEY0_DATA4_SPEC>;
///Field `KEY0_DATA4` reader - Stores the fourth 32 bits of KEY0.
pub type KEY0_DATA4_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the fourth 32 bits of KEY0.
    #[inline(always)]
...
///`read()` method returns [`rd_key0_data4::R`](R) reader structure
