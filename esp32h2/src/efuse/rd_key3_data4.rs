...
pub struct R(crate::R<RD_KEY3_DATA4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RD_KEY3_DATA4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RD_KEY3_DATA4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RD_KEY3_DATA4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `KEY3_DATA4` reader - Stores the fourth 32 bits of KEY3."]
pub type KEY3_DATA4_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "Register $n of BLOCK7 (KEY3).\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rd_key3_data4](index.html) module"]
