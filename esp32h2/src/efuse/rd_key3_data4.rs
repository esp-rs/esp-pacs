///Register `RD_KEY3_DATA4` reader
pub type R = crate::R<RD_KEY3_DATA4_SPEC>;
///Field `KEY3_DATA4` reader - Stores the fourth 32 bits of KEY3.
pub type KEY3_DATA4_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the fourth 32 bits of KEY3.
    #[inline(always)]
...
///`read()` method returns [`rd_key3_data4::R`](R) reader structure
