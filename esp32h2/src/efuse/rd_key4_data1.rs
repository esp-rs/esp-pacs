///Register `RD_KEY4_DATA1` reader
pub type R = crate::R<RD_KEY4_DATA1_SPEC>;
///Field `KEY4_DATA1` reader - Stores the first 32 bits of KEY4.
pub type KEY4_DATA1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the first 32 bits of KEY4.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_KEY4_DATA1")
            .field("key4_data1", &self.key4_data1())
            .finish()
    }
}
...
///`read()` method returns [`rd_key4_data1::R`](R) reader structure
