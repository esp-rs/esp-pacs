...
pub struct R(crate::R<RD_MAC_SYS_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RD_MAC_SYS_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RD_MAC_SYS_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RD_MAC_SYS_1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RD_MAC_SYS_1_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "BLOCK1 data register $n.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rd_mac_sys_1](index.html) module"]
