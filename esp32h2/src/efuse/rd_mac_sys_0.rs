#[doc = "Register `RD_MAC_SYS_0` reader"]
pub struct R(crate::R<RD_MAC_SYS_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RD_MAC_SYS_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RD_MAC_SYS_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RD_MAC_SYS_0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RD_MAC_SYS_0_SPEC> {
...
#[doc = "`read()` method returns [rd_mac_sys_0::R](R) reader structure"]
impl crate::Readable for RD_MAC_SYS_0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RD_MAC_SYS_0 to value 0"]
