...
#[doc = "Field `PGM_DATA_2` reader - Configures the 2nd 32-bit data to be programmed."]
pub type PGM_DATA_2_R = crate::FieldReader<u32>;
#[doc = "Field `PGM_DATA_2` writer - Configures the 2nd 32-bit data to be programmed."]
pub type PGM_DATA_2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the 2nd 32-bit data to be programmed."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pgm_data_2(&mut self) -> PGM_DATA_2_W<PGM_DATA2_SPEC, 0> {
