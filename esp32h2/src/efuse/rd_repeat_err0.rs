...
///Field `RD_DIS_ERR` reader - Indicates a programming error of RD_DIS.
pub type RD_DIS_ERR_R = crate::FieldReader;
///Field `RPT4_RESERVED0_ERR_4` reader - Reserved.
pub type RPT4_RESERVED0_ERR_4_R = crate::BitReader;
///Field `DIS_ICACHE_ERR` reader - Indicates a programming error of DIS_ICACHE.
pub type DIS_ICACHE_ERR_R = crate::BitReader;
///Field `DIS_USB_JTAG_ERR` reader - Indicates a programming error of DIS_USB_JTAG.
pub type DIS_USB_JTAG_ERR_R = crate::BitReader;
///Field `POWERGLITCH_EN_ERR` reader - Indicates a programming error of POWERGLITCH_EN.
pub type POWERGLITCH_EN_ERR_R = crate::BitReader;
///Field `DIS_USB_SERIAL_JTAG_ERR` reader - Indicates a programming error of DIS_USB_DEVICE.
pub type DIS_USB_SERIAL_JTAG_ERR_R = crate::BitReader;
///Field `DIS_FORCE_DOWNLOAD_ERR` reader - Indicates a programming error of DIS_FORCE_DOWNLOAD.
pub type DIS_FORCE_DOWNLOAD_ERR_R = crate::BitReader;
///Field `SPI_DOWNLOAD_MSPI_DIS_ERR` reader - Indicates a programming error of SPI_DOWNLOAD_MSPI_DIS.
pub type SPI_DOWNLOAD_MSPI_DIS_ERR_R = crate::BitReader;
///Field `DIS_TWAI_ERR` reader - Indicates a programming error of DIS_CAN.
pub type DIS_TWAI_ERR_R = crate::BitReader;
///Field `JTAG_SEL_ENABLE_ERR` reader - Indicates a programming error of JTAG_SEL_ENABLE.
pub type JTAG_SEL_ENABLE_ERR_R = crate::BitReader;
///Field `SOFT_DIS_JTAG_ERR` reader - Indicates a programming error of SOFT_DIS_JTAG.
pub type SOFT_DIS_JTAG_ERR_R = crate::FieldReader;
///Field `DIS_PAD_JTAG_ERR` reader - Indicates a programming error of DIS_PAD_JTAG.
pub type DIS_PAD_JTAG_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_MANUAL_ENCRYPT_ERR` reader - Indicates a programming error of DIS_DOWNLOAD_MANUAL_ENCRYPT.
pub type DIS_DOWNLOAD_MANUAL_ENCRYPT_ERR_R = crate::BitReader;
///Field `USB_DREFH_ERR` reader - Indicates a programming error of USB_DREFH.
pub type USB_DREFH_ERR_R = crate::FieldReader;
///Field `USB_DREFL_ERR` reader - Indicates a programming error of USB_DREFL.
pub type USB_DREFL_ERR_R = crate::FieldReader;
///Field `USB_EXCHG_PINS_ERR` reader - Indicates a programming error of USB_EXCHG_PINS.
pub type USB_EXCHG_PINS_ERR_R = crate::BitReader;
///Field `VDD_SPI_AS_GPIO_ERR` reader - Indicates a programming error of VDD_SPI_AS_GPIO.
pub type VDD_SPI_AS_GPIO_ERR_R = crate::BitReader;
///Field `RPT4_RESERVED0_ERR_2` reader - Reserved.
pub type RPT4_RESERVED0_ERR_2_R = crate::FieldReader;
///Field `RPT4_RESERVED0_ERR_1` reader - Reserved.
pub type RPT4_RESERVED0_ERR_1_R = crate::BitReader;
///Field `RPT4_RESERVED0_ERR_0` reader - Reserved.
pub type RPT4_RESERVED0_ERR_0_R = crate::FieldReader;
impl R {
    ///Bits 0:6 - Indicates a programming error of RD_DIS.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_ERR0")
            ...
            .field("rpt4_reserved0_err_4", &self.rpt4_reserved0_err_4())
...
///`read()` method returns [`rd_repeat_err0::R`](R) reader structure
