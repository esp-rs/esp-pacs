...
#[doc = "Field `RPT4_RESERVED0_ERR_4` reader - Reserved."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_ERR0")
            ...
            .field("rpt4_reserved0_err_4", &self.rpt4_reserved0_err_4().bit())
            ...
            .field("vdd_spi_as_gpio_err", &self.vdd_spi_as_gpio_err().bit())
            .field("rpt4_reserved0_err_2", &self.rpt4_reserved0_err_2().bits())
            .field("rpt4_reserved0_err_1", &self.rpt4_reserved0_err_1().bit())
            .field("rpt4_reserved0_err_0", &self.rpt4_reserved0_err_0().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
