...
///Field `CFG_ECDSA_BLK` reader - Configures which block to use for ECDSA key output.
pub type CFG_ECDSA_BLK_R = crate::FieldReader;
///Field `CFG_ECDSA_BLK` writer - Configures which block to use for ECDSA key output.
