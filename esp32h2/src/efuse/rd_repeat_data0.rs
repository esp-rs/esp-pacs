...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA0")
            ...
            .field("rpt4_reserved0_4", &self.rpt4_reserved0_4().bit())
            ...
            .field("vdd_spi_as_gpio", &self.vdd_spi_as_gpio().bit())
            .field("rpt4_reserved0_2", &self.rpt4_reserved0_2().bits())
            .field("rpt4_reserved0_1", &self.rpt4_reserved0_1().bit())
            .field("rpt4_reserved0_0", &self.rpt4_reserved0_0().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
