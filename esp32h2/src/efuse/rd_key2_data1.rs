///Register `RD_KEY2_DATA1` reader
pub type R = crate::R<RD_KEY2_DATA1_SPEC>;
///Field `KEY2_DATA1` reader - Stores the first 32 bits of KEY2.
pub type KEY2_DATA1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the first 32 bits of KEY2.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_KEY2_DATA1")
            .field("key2_data1", &self.key2_data1())
            .finish()
    }
}
...
///`read()` method returns [`rd_key2_data1::R`](R) reader structure
