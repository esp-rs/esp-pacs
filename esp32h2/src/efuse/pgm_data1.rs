...
///Field `PGM_DATA_1` reader - Configures the 1st 32-bit data to be programmed.
pub type PGM_DATA_1_R = crate::FieldReader<u32>;
///Field `PGM_DATA_1` writer - Configures the 1st 32-bit data to be programmed.
pub type PGM_DATA_1_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures the 1st 32-bit data to be programmed.
    #[inline(always)]
