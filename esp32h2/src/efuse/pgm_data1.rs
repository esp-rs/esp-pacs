...
pub type PGM_DATA_1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PGM_DATA_1` writer - Configures the 1st 32-bit data to be programmed."]
pub type PGM_DATA_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PGM_DATA1_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pgm_data_1(&mut self) -> PGM_DATA_1_W<0> {
        PGM_DATA_1_W::new(self)
    }
