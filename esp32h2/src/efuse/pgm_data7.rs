///Register `PGM_DATA7` reader
pub type R = crate::R<PGM_DATA7_SPEC>;
///Register `PGM_DATA7` writer
pub type W = crate::W<PGM_DATA7_SPEC>;
///Field `PGM_DATA_7` reader - Configures the 7th 32-bit data to be programmed.
pub type PGM_DATA_7_R = crate::FieldReader<u32>;
///Field `PGM_DATA_7` writer - Configures the 7th 32-bit data to be programmed.
pub type PGM_DATA_7_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures the 7th 32-bit data to be programmed.
    #[inline(always)]
...
///`read()` method returns [`pgm_data7::R`](R) reader structure
impl crate::Readable for PGM_DATA7_SPEC {}
///`write(|w| ..)` method takes [`pgm_data7::W`](W) writer structure
