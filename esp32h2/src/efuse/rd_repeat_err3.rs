...
///Field `HYS_EN_PAD0_ERR` reader - Indicates a programming error of HYS_EN_PAD0.
...
impl R {
    ...
    ///Bits 26:31 - Indicates a programming error of HYS_EN_PAD0.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_ERR3")
            ...
            .field("hys_en_pad0_err", &self.hys_en_pad0_err())
            .finish()
    }
}
