...
pub struct RegisterBlock {
    ...
    pub rd_mac_sys_0: RD_MAC_SYS_0,
    #[doc = "0x48 - BLOCK1 data register $n."]
    pub rd_mac_sys_1: RD_MAC_SYS_1,
    #[doc = "0x4c - BLOCK1 data register $n."]
    pub rd_mac_sys_2: RD_MAC_SYS_2,
    #[doc = "0x50 - BLOCK1 data register $n."]
    pub rd_mac_sys_3: RD_MAC_SYS_3,
    #[doc = "0x54 - BLOCK1 data register $n."]
    pub rd_mac_sys_4: RD_MAC_SYS_4,
    #[doc = "0x58 - BLOCK1 data register $n."]
    pub rd_mac_sys_5: RD_MAC_SYS_5,
    ...
    pub wr_tim_conf0_rs_bypass: WR_TIM_CONF0_RS_BYPASS,
