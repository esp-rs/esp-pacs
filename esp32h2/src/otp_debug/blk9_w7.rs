...
pub struct R(crate::R<BLK9_W7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK9_W7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK9_W7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK9_W7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK9_W7` reader - Otp block9 word7 data."]
pub type BLOCK9_W7_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK9_W7")
            .field("block9_w7", &format_args!("{}", self.block9_w7().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<BLK9_W7_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "Otp debuger block9 data register7.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk9_w7](index.html) module"]
