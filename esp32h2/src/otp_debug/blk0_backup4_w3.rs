///Register `BLK0_BACKUP4_W3` reader
pub type R = crate::R<BLK0_BACKUP4_W3_SPEC>;
///Field `OTP_BEBUG_BLOCK0_BACKUP4_W3` reader - Otp block0 backup4 word3 data.
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK0_BACKUP4_W3")
            .field(
                ...
                &self.otp_bebug_block0_backup4_w3(),
            )
            .finish()
    }
}
...
///`read()` method returns [`blk0_backup4_w3::R`](R) reader structure
