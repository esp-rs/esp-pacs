...
#[doc = "Field `DATE` reader - Stores otp_debug version."]
pub type DATE_R = crate::FieldReader<u32>;
#[doc = "Field `DATE` writer - Stores otp_debug version."]
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, DATE_SPEC, 28, O, u32>;
impl R {
    #[doc = "Bits 0:27 - Stores otp_debug version."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x2021_1028"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x2021_1028;
}
