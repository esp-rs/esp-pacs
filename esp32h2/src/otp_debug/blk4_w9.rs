...
pub struct R(crate::R<BLK4_W9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK4_W9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK4_W9_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK4_W9_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK4_W9` reader - Otp block4 word9 data."]
pub type BLOCK4_W9_R = crate::FieldReader<u32, u32>;
impl R {
