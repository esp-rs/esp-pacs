...
pub struct R(crate::R<BLK0_BACKUP2_W1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK0_BACKUP2_W1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK0_BACKUP2_W1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK0_BACKUP2_W1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `OTP_BEBUG_BLOCK0_BACKUP2_W1` reader - Otp block0 backup2 word1 data."]
pub type OTP_BEBUG_BLOCK0_BACKUP2_W1_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "Otp debuger block0 data register7.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk0_backup2_w1](index.html) module"]
