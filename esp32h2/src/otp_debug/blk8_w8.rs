...
pub struct R(crate::R<BLK8_W8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK8_W8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK8_W8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK8_W8_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK8_W8` reader - Otp block8 word8 data."]
pub type BLOCK8_W8_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "Otp debuger block8 data register8.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk8_w8](index.html) module"]
