...
pub struct R(crate::R<BLK9_W10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK9_W10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK9_W10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK9_W10_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK9_W10` reader - Otp block9 word10 data."]
pub type BLOCK9_W10_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "Otp debuger block9 data register10.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk9_w10](index.html) module"]
