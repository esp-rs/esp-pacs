///Register `BLK0_BACKUP2_W4` reader
pub type R = crate::R<BLK0_BACKUP2_W4_SPEC>;
///Field `OTP_BEBUG_BLOCK0_BACKUP2_W4` reader - Otp block0 backup2 word4 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk0_backup2_w4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK0_BACKUP2_W4_SPEC;
impl crate::RegisterSpec for BLK0_BACKUP2_W4_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk0_backup2_w4::R`](R) reader structure
