///Register `BLK5_W11` reader
pub type R = crate::R<BLK5_W11_SPEC>;
///Field `BLOCK5_W11` reader - Otp block5 word11 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk5_w11::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK5_W11_SPEC;
impl crate::RegisterSpec for BLK5_W11_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk5_w11::R`](R) reader structure
