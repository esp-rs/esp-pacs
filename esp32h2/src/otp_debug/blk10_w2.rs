///Register `BLK10_W2` reader
pub type R = crate::R<BLK10_W2_SPEC>;
///Field `BLOCK10_W2` reader - Otp block10 word2 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk10_w2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK10_W2_SPEC;
impl crate::RegisterSpec for BLK10_W2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk10_w2::R`](R) reader structure
