///Register `BLK0_BACKUP1_W5` reader
pub type R = crate::R<BLK0_BACKUP1_W5_SPEC>;
///Field `OTP_BEBUG_BLOCK0_BACKUP1_W5` reader - Otp block0 backup1 word5 data.
...
///`read()` method returns [`blk0_backup1_w5::R`](R) reader structure
