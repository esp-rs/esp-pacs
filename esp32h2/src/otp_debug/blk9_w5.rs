///Register `BLK9_W5` reader
pub type R = crate::R<BLK9_W5_SPEC>;
///Field `BLOCK9_W5` reader - Otp block9 word5 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk9_w5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK9_W5_SPEC;
impl crate::RegisterSpec for BLK9_W5_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk9_w5::R`](R) reader structure
