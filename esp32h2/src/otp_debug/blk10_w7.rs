///Register `BLK10_W7` reader
pub type R = crate::R<BLK10_W7_SPEC>;
///Field `BLOCK10_W7` reader - Otp block10 word7 data.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK10_W7")
            .field("block10_w7", &self.block10_w7())
            .finish()
    }
}
...
///`read()` method returns [`blk10_w7::R`](R) reader structure
