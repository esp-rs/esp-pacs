///Register `BLK0_BACKUP3_W4` reader
pub type R = crate::R<BLK0_BACKUP3_W4_SPEC>;
///Field `OTP_BEBUG_BLOCK0_BACKUP3_W4` reader - Otp block0 backup3 word4 data.
pub type OTP_BEBUG_BLOCK0_BACKUP3_W4_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block0 backup3 word4 data.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK0_BACKUP3_W4")
            .field(
                ...
                &self.otp_bebug_block0_backup3_w4(),
            )
            .finish()
    }
}
...
///`read()` method returns [`blk0_backup3_w4::R`](R) reader structure
