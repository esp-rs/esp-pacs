///Register `BLK2_W6` reader
pub type R = crate::R<BLK2_W6_SPEC>;
///Field `BLOCK2_W6` reader - Otp block2 word6 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk2_w6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK2_W6_SPEC;
impl crate::RegisterSpec for BLK2_W6_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk2_w6::R`](R) reader structure
