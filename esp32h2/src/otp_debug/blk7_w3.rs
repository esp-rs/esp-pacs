...
pub struct R(crate::R<BLK7_W3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK7_W3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK7_W3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK7_W3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK7_W3` reader - Otp block7 word3 data."]
pub type BLOCK7_W3_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "Otp debuger block7 data register3.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk7_w3](index.html) module"]
