///Register `BLK2_W1` reader
pub type R = crate::R<BLK2_W1_SPEC>;
///Field `BLOCK2_W1` reader - Otp block2 word1 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk2_w1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK2_W1_SPEC;
impl crate::RegisterSpec for BLK2_W1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk2_w1::R`](R) reader structure
