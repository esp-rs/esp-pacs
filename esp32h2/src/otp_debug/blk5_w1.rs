///Register `BLK5_W1` reader
pub type R = crate::R<BLK5_W1_SPEC>;
///Field `BLOCK5_W1` reader - Otp block5 word1 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk5_w1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK5_W1_SPEC;
impl crate::RegisterSpec for BLK5_W1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk5_w1::R`](R) reader structure
