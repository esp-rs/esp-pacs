///Register `BLK4_W6` reader
pub type R = crate::R<BLK4_W6_SPEC>;
///Field `BLOCK4_W6` reader - Otp block4 word6 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk4_w6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK4_W6_SPEC;
impl crate::RegisterSpec for BLK4_W6_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk4_w6::R`](R) reader structure
