///Register `BLK4_W4` reader
pub type R = crate::R<BLK4_W4_SPEC>;
///Field `BLOCK4_W4` reader - Otp block4 word4 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk4_w4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK4_W4_SPEC;
impl crate::RegisterSpec for BLK4_W4_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk4_w4::R`](R) reader structure
