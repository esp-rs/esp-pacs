...
pub struct R(crate::R<REGION1_PMS_ATTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REGION1_PMS_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REGION1_PMS_ATTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REGION1_PMS_ATTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REGION1_PMS_ATTR` writer"]
pub struct W(crate::W<REGION1_PMS_ATTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REGION1_PMS_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region1_r0_pms_x(&mut self) -> REGION1_R0_PMS_X_W<0> {
        REGION1_R0_PMS_X_W::new(self)
    }
    #[doc = "Bit 1 - Region write authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region1_r0_pms_w(&mut self) -> REGION1_R0_PMS_W_W<1> {
        REGION1_R0_PMS_W_W::new(self)
    }
    #[doc = "Bit 2 - Region read authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region1_r0_pms_r(&mut self) -> REGION1_R0_PMS_R_W<2> {
        REGION1_R0_PMS_R_W::new(self)
    }
    #[doc = "Bit 4 - Region execute authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region1_r1_pms_x(&mut self) -> REGION1_R1_PMS_X_W<4> {
        REGION1_R1_PMS_X_W::new(self)
    }
    #[doc = "Bit 5 - Region write authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region1_r1_pms_w(&mut self) -> REGION1_R1_PMS_W_W<5> {
        REGION1_R1_PMS_W_W::new(self)
    }
    #[doc = "Bit 6 - Region read authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region1_r1_pms_r(&mut self) -> REGION1_R1_PMS_R_W<6> {
        REGION1_R1_PMS_R_W::new(self)
    }
    #[doc = "Bit 8 - Region execute authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region1_r2_pms_x(&mut self) -> REGION1_R2_PMS_X_W<8> {
        REGION1_R2_PMS_X_W::new(self)
    }
    #[doc = "Bit 9 - Region write authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region1_r2_pms_w(&mut self) -> REGION1_R2_PMS_W_W<9> {
        REGION1_R2_PMS_W_W::new(self)
    }
    #[doc = "Bit 10 - Region read authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region1_r2_pms_r(&mut self) -> REGION1_R2_PMS_R_W<10> {
