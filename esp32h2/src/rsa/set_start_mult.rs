///Register `SET_START_MULT` writer
pub type W = crate::W<SET_START_MULT_SPEC>;
///Field `SET_START_MULT` writer - Configure whether or not to start the multiplication. 0: No effect 1: Start
...
impl W {
    ///Bit 0 - Configure whether or not to start the multiplication. 0: No effect 1: Start
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`set_start_mult::W`](W) writer structure
