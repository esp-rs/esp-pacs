...
///Field `INT_ENA` reader - Write 1 to enable the RSA interrupt.
pub type INT_ENA_R = crate::BitReader;
///Field `INT_ENA` writer - Write 1 to enable the RSA interrupt.
pub type INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Write 1 to enable the RSA interrupt.
    #[inline(always)]
