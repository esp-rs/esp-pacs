...
///Field `IN_EP3_STATE` reader - State of IN Endpoint 3.
pub type IN_EP3_STATE_R = crate::FieldReader;
///Field `IN_EP3_WR_ADDR` reader - Write data address of IN endpoint 3.
pub type IN_EP3_WR_ADDR_R = crate::FieldReader;
///Field `IN_EP3_RD_ADDR` reader - Read data address of IN endpoint 3.
...
///`read()` method returns [`in_ep3_st::R`](R) reader structure
