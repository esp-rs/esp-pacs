...
///Field `GET_BDATA_BITS` reader - The value of bCharFormat set by software which is requested by GET_LINE_CODING command.
pub type GET_BDATA_BITS_R = crate::FieldReader;
///Field `GET_BDATA_BITS` writer - The value of bCharFormat set by software which is requested by GET_LINE_CODING command.
pub type GET_BDATA_BITS_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GET_BPARITY_TYPE` reader - The value of bParityTpye set by software which is requested by GET_LINE_CODING command.
pub type GET_BPARITY_TYPE_R = crate::FieldReader;
///Field `GET_BPARITY_TYPE` writer - The value of bParityTpye set by software which is requested by GET_LINE_CODING command.
pub type GET_BPARITY_TYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `GET_BCHAR_FORMAT` reader - The value of bDataBits set by software which is requested by GET_LINE_CODING command.
pub type GET_BCHAR_FORMAT_R = crate::FieldReader;
///Field `GET_BCHAR_FORMAT` writer - The value of bDataBits set by software which is requested by GET_LINE_CODING command.
...
///`read()` method returns [`get_line_code_w1::R`](R) reader structure
impl crate::Readable for GET_LINE_CODE_W1_SPEC {}
///`write(|w| ..)` method takes [`get_line_code_w1::W`](W) writer structure
