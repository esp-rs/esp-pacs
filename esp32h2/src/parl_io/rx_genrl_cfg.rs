...
pub type RX_GATING_EN_R = crate::BitReader<bool>;
#[doc = "Field `RX_GATING_EN` writer - Set this bit to enable the clock gating of output rx clock."]
pub type RX_GATING_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_GENRL_CFG_SPEC, bool, O>;
...
pub type RX_TIMEOUT_THRES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RX_GENRL_CFG_SPEC, u16, u16, 16, O>;
...
pub type RX_TIMEOUT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_GENRL_CFG_SPEC, bool, O>;
...
pub type RX_EOF_GEN_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_GENRL_CFG_SPEC, bool, O>;
impl R {
