...
///Field `TX_FIFO_REMPTY` writer - Set this bit to clear TX_FIFO_REMPTY_INT.
pub type TX_FIFO_REMPTY_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `RX_FIFO_WOVF` writer - Set this bit to clear RX_FIFO_WOVF_INT.
pub type RX_FIFO_WOVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TX_EOF` writer - Set this bit to clear TX_EOF_INT.
