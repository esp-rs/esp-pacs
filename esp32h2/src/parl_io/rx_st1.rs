///Register `RX_ST1` reader
pub type R = crate::R<RX_ST1_SPEC>;
///Field `RX_FIFO_RD_BIT_CNT` reader - Indicates the current read bit number from Rx FIFO.
...
///`read()` method returns [`rx_st1::R`](R) reader structure
