...
pub type RX_FIFO_WOVF_INT_ENA_R = crate::BitReader<bool>;
#[doc = "Field `RX_FIFO_WOVF_INT_ENA` writer - Set this bit to enable RX_FIFO_WOVF_INT."]
pub type RX_FIFO_WOVF_INT_ENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_ENA_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_fifo_wovf_int_ena(&mut self) -> RX_FIFO_WOVF_INT_ENA_W<1> {
