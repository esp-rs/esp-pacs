///Register `RX_MODE_CFG` reader
pub type R = crate::R<RX_MODE_CFG_SPEC>;
///Register `RX_MODE_CFG` writer
pub type W = crate::W<RX_MODE_CFG_SPEC>;
///Field `RX_EXT_EN_SEL` reader - Configures rx external enable signal selection from IO PAD.
pub type RX_EXT_EN_SEL_R = crate::FieldReader;
///Field `RX_EXT_EN_SEL` writer - Configures rx external enable signal selection from IO PAD.
pub type RX_EXT_EN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `RX_SW_EN` reader - Set this bit to enable data sampling by software.
pub type RX_SW_EN_R = crate::BitReader;
///Field `RX_SW_EN` writer - Set this bit to enable data sampling by software.
pub type RX_SW_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_EXT_EN_INV` reader - Set this bit to invert the external enable signal.
pub type RX_EXT_EN_INV_R = crate::BitReader;
///Field `RX_EXT_EN_INV` writer - Set this bit to invert the external enable signal.
...
///Field `RX_PULSE_SUBMODE_SEL` writer - Configures the rxd pulse sampling submode. 4'd0: positive pulse start(data bit included) &amp;&amp; positive pulse end(data bit included) 4'd1: positive pulse start(data bit included) &amp;&amp; positive pulse end (data bit excluded) 4'd2: positive pulse start(data bit excluded) &amp;&amp; positive pulse end (data bit included) 4'd3: positive pulse start(data bit excluded) &amp;&amp; positive pulse end (data bit excluded) 4'd4: positive pulse start(data bit included) &amp;&amp; length end 4'd5: positive pulse start(data bit excluded) &amp;&amp; length end
pub type RX_PULSE_SUBMODE_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `RX_SMP_MODE_SEL` reader - Configures the rxd sampling mode. 2'b00: external level enable mode 2'b01: external pulse enable mode 2'b10: internal software enable mode
pub type RX_SMP_MODE_SEL_R = crate::FieldReader;
///Field `RX_SMP_MODE_SEL` writer - Configures the rxd sampling mode. 2'b00: external level enable mode 2'b01: external pulse enable mode 2'b10: internal software enable mode
pub type RX_SMP_MODE_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 21:24 - Configures rx external enable signal selection from IO PAD.
    #[inline(always)]
    pub fn rx_ext_en_sel(&self) -> RX_EXT_EN_SEL_R {
        RX_EXT_EN_SEL_R::new(((self.bits >> 21) & 0x0f) as u8)
    }
    ///Bit 25 - Set this bit to enable data sampling by software.
    #[inline(always)]
    pub fn rx_sw_en(&self) -> RX_SW_EN_R {
        RX_SW_EN_R::new(((self.bits >> 25) & 1) != 0)
    }
    ///Bit 26 - Set this bit to invert the external enable signal.
    #[inline(always)]
    pub fn rx_ext_en_inv(&self) -> RX_EXT_EN_INV_R {
        RX_EXT_EN_INV_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bits 27:29 - Configures the rxd pulse sampling submode. 4'd0: positive pulse start(data bit included) &amp;&amp; positive pulse end(data bit included) 4'd1: positive pulse start(data bit included) &amp;&amp; positive pulse end (data bit excluded) 4'd2: positive pulse start(data bit excluded) &amp;&amp; positive pulse end (data bit included) 4'd3: positive pulse start(data bit excluded) &amp;&amp; positive pulse end (data bit excluded) 4'd4: positive pulse start(data bit included) &amp;&amp; length end 4'd5: positive pulse start(data bit excluded) &amp;&amp; length end
    #[inline(always)]
    pub fn rx_pulse_submode_sel(&self) -> RX_PULSE_SUBMODE_SEL_R {
        RX_PULSE_SUBMODE_SEL_R::new(((self.bits >> 27) & 7) as u8)
    }
    ///Bits 30:31 - Configures the rxd sampling mode. 2'b00: external level enable mode 2'b01: external pulse enable mode 2'b10: internal software enable mode
    #[inline(always)]
...
///`read()` method returns [`rx_mode_cfg::R`](R) reader structure
impl crate::Readable for RX_MODE_CFG_SPEC {}
///`write(|w| ..)` method takes [`rx_mode_cfg::W`](W) writer structure
