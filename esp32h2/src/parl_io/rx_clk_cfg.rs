///Register `RX_CLK_CFG` reader
pub type R = crate::R<RX_CLK_CFG_SPEC>;
///Register `RX_CLK_CFG` writer
pub type W = crate::W<RX_CLK_CFG_SPEC>;
///Field `RX_CLK_I_INV` reader - Set this bit to invert the input Rx core clock.
pub type RX_CLK_I_INV_R = crate::BitReader;
///Field `RX_CLK_I_INV` writer - Set this bit to invert the input Rx core clock.
pub type RX_CLK_I_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_CLK_O_INV` reader - Set this bit to invert the output Rx core clock.
pub type RX_CLK_O_INV_R = crate::BitReader;
///Field `RX_CLK_O_INV` writer - Set this bit to invert the output Rx core clock.
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_clk_i_inv(&mut self) -> RX_CLK_I_INV_W<RX_CLK_CFG_SPEC> {
        RX_CLK_I_INV_W::new(self, 30)
    }
    ///Bit 31 - Set this bit to invert the output Rx core clock.
    #[inline(always)]
    #[must_use]
    pub fn rx_clk_o_inv(&mut self) -> RX_CLK_O_INV_W<RX_CLK_CFG_SPEC> {
...
///`read()` method returns [`rx_clk_cfg::R`](R) reader structure
impl crate::Readable for RX_CLK_CFG_SPEC {}
///`write(|w| ..)` method takes [`rx_clk_cfg::W`](W) writer structure
