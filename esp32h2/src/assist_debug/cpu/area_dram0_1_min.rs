...
#[doc = "Field `AREA_DRAM0_1_MIN` reader - Core0 dram0 region1 start addr"]
pub type AREA_DRAM0_1_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_DRAM0_1_MIN` writer - Core0 dram0 region1 start addr"]
...
impl W {
    #[doc = "Bits 0:31 - Core0 dram0 region1 start addr"]
    #[inline(always)]
    pub fn area_dram0_1_min(&mut self) -> AREA_DRAM0_1_MIN_W<AREA_DRAM0_1_MIN_SPEC> {
