...
///Field `CORE_0_AREA_DRAM0_0_RD_INTR_ENA` reader - Core0 dram0 area0 read monitor interrupt enable
pub type CORE_0_AREA_DRAM0_0_RD_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_AREA_DRAM0_0_RD_INTR_ENA` writer - Core0 dram0 area0 read monitor interrupt enable
pub type CORE_0_AREA_DRAM0_0_RD_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_AREA_DRAM0_0_WR_INTR_ENA` reader - Core0 dram0 area0 write monitor interrupt enable
pub type CORE_0_AREA_DRAM0_0_WR_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_AREA_DRAM0_0_WR_INTR_ENA` writer - Core0 dram0 area0 write monitor interrupt enable
pub type CORE_0_AREA_DRAM0_0_WR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_AREA_DRAM0_1_RD_INTR_ENA` reader - Core0 dram0 area1 read monitor interrupt enable
pub type CORE_0_AREA_DRAM0_1_RD_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_AREA_DRAM0_1_RD_INTR_ENA` writer - Core0 dram0 area1 read monitor interrupt enable
pub type CORE_0_AREA_DRAM0_1_RD_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_AREA_DRAM0_1_WR_INTR_ENA` reader - Core0 dram0 area1 write monitor interrupt enable
pub type CORE_0_AREA_DRAM0_1_WR_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_AREA_DRAM0_1_WR_INTR_ENA` writer - Core0 dram0 area1 write monitor interrupt enable
pub type CORE_0_AREA_DRAM0_1_WR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_AREA_PIF_0_RD_INTR_ENA` reader - Core0 PIF area0 read monitor interrupt enable
pub type CORE_0_AREA_PIF_0_RD_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_AREA_PIF_0_RD_INTR_ENA` writer - Core0 PIF area0 read monitor interrupt enable
pub type CORE_0_AREA_PIF_0_RD_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_AREA_PIF_0_WR_INTR_ENA` reader - Core0 PIF area0 write monitor interrupt enable
pub type CORE_0_AREA_PIF_0_WR_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_AREA_PIF_0_WR_INTR_ENA` writer - Core0 PIF area0 write monitor interrupt enable
pub type CORE_0_AREA_PIF_0_WR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_AREA_PIF_1_RD_INTR_ENA` reader - Core0 PIF area1 read monitor interrupt enable
pub type CORE_0_AREA_PIF_1_RD_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_AREA_PIF_1_RD_INTR_ENA` writer - Core0 PIF area1 read monitor interrupt enable
pub type CORE_0_AREA_PIF_1_RD_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_AREA_PIF_1_WR_INTR_ENA` reader - Core0 PIF area1 write monitor interrupt enable
pub type CORE_0_AREA_PIF_1_WR_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_AREA_PIF_1_WR_INTR_ENA` writer - Core0 PIF area1 write monitor interrupt enable
pub type CORE_0_AREA_PIF_1_WR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_SP_SPILL_MIN_INTR_ENA` reader - Core0 stackpoint underflow monitor interrupt enable
pub type CORE_0_SP_SPILL_MIN_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_SP_SPILL_MIN_INTR_ENA` writer - Core0 stackpoint underflow monitor interrupt enable
pub type CORE_0_SP_SPILL_MIN_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_SP_SPILL_MAX_INTR_ENA` reader - Core0 stackpoint overflow monitor interrupt enable
pub type CORE_0_SP_SPILL_MAX_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_SP_SPILL_MAX_INTR_ENA` writer - Core0 stackpoint overflow monitor interrupt enable
pub type CORE_0_SP_SPILL_MAX_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_IRAM0_EXCEPTION_MONITOR_INTR_ENA` reader - IBUS busy monitor interrupt enable
pub type CORE_0_IRAM0_EXCEPTION_MONITOR_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_IRAM0_EXCEPTION_MONITOR_INTR_ENA` writer - IBUS busy monitor interrupt enable
pub type CORE_0_IRAM0_EXCEPTION_MONITOR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_DRAM0_EXCEPTION_MONITOR_INTR_ENA` reader - DBUS busy monitor interrupt enbale
pub type CORE_0_DRAM0_EXCEPTION_MONITOR_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_DRAM0_EXCEPTION_MONITOR_INTR_ENA` writer - DBUS busy monitor interrupt enbale
