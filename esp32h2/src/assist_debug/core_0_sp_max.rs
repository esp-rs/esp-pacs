...
pub type CORE_0_SP_MAX_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_0_SP_MAX_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_sp_max(&mut self) -> CORE_0_SP_MAX_W<CORE_0_SP_MAX_SPEC, 0> {
