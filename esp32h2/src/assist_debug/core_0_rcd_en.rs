///Register `CORE_0_RCD_EN` reader
pub type R = crate::R<CORE_0_RCD_EN_SPEC>;
///Register `CORE_0_RCD_EN` writer
pub type W = crate::W<CORE_0_RCD_EN_SPEC>;
///Field `CORE_0_RCD_RECORDEN` reader - Set 1 to enable record PC
pub type CORE_0_RCD_RECORDEN_R = crate::BitReader;
///Field `CORE_0_RCD_RECORDEN` writer - Set 1 to enable record PC
pub type CORE_0_RCD_RECORDEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_RCD_PDEBUGEN` reader - Set 1 to enable cpu pdebug function, must set this bit can get cpu PC
pub type CORE_0_RCD_PDEBUGEN_R = crate::BitReader;
///Field `CORE_0_RCD_PDEBUGEN` writer - Set 1 to enable cpu pdebug function, must set this bit can get cpu PC
...
///`read()` method returns [`core_0_rcd_en::R`](R) reader structure
impl crate::Readable for CORE_0_RCD_EN_SPEC {}
///`write(|w| ..)` method takes [`core_0_rcd_en::W`](W) writer structure
