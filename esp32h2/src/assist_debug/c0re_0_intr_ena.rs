#[doc = "Register `C0RE_0_INTR_ENA` reader"]
pub struct R(crate::R<C0RE_0_INTR_ENA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C0RE_0_INTR_ENA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C0RE_0_INTR_ENA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C0RE_0_INTR_ENA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C0RE_0_INTR_ENA` writer"]
pub struct W(crate::W<C0RE_0_INTR_ENA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C0RE_0_INTR_ENA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C0RE_0_INTR_ENA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C0RE_0_INTR_ENA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CORE_0_AREA_DRAM0_0_RD_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, C0RE_0_INTR_ENA_SPEC, bool, O>;
...
#[doc = "core0 monitor enable configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c0re_0_intr_ena](index.html) module"]
pub struct C0RE_0_INTR_ENA_SPEC;
impl crate::RegisterSpec for C0RE_0_INTR_ENA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c0re_0_intr_ena::R](R) reader structure"]
impl crate::Readable for C0RE_0_INTR_ENA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c0re_0_intr_ena::W](W) writer structure"]
impl crate::Writable for C0RE_0_INTR_ENA_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C0RE_0_INTR_ENA to value 0"]
impl crate::Resettable for C0RE_0_INTR_ENA_SPEC {
