...
pub type OVERFLOW_RAW_R = crate::BitReader<bool>;
#[doc = "Field `OVERFLOW_RAW` writer - need_des"]
pub type OVERFLOW_RAW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_RAW_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn overflow_raw(&mut self) -> OVERFLOW_RAW_W<30> {
