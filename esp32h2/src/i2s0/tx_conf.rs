...
pub type TX_MSB_SHIFT_W<'a, const O: u8> = crate::BitWriter<'a, TX_CONF_SPEC, O>;
...
pub type TX_BCK_NO_DLY_W<'a, const O: u8> = crate::BitWriter<'a, TX_CONF_SPEC, O>;
...
pub type TX_BCK_DIV_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, TX_CONF_SPEC, 6, O>;
