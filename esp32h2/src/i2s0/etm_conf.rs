...
///Field `ETM_TX_SEND_WORD_NUM` reader - I2S ETM send x words event. When sending word number of reg_etm_tx_send_word_num\[9:0\], i2s will trigger an etm event.
pub type ETM_TX_SEND_WORD_NUM_R = crate::FieldReader<u16>;
///Field `ETM_TX_SEND_WORD_NUM` writer - I2S ETM send x words event. When sending word number of reg_etm_tx_send_word_num\[9:0\], i2s will trigger an etm event.
pub type ETM_TX_SEND_WORD_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `ETM_RX_RECEIVE_WORD_NUM` reader - I2S ETM receive x words event. When receiving word number of reg_etm_rx_receive_word_num\[9:0\], i2s will trigger an etm event.
pub type ETM_RX_RECEIVE_WORD_NUM_R = crate::FieldReader<u16>;
///Field `ETM_RX_RECEIVE_WORD_NUM` writer - I2S ETM receive x words event. When receiving word number of reg_etm_rx_receive_word_num\[9:0\], i2s will trigger an etm event.
pub type ETM_RX_RECEIVE_WORD_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    ///Bits 0:9 - I2S ETM send x words event. When sending word number of reg_etm_tx_send_word_num\[9:0\], i2s will trigger an etm event.
    #[inline(always)]
