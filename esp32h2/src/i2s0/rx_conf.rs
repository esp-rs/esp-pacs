...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_stop_mode(&mut self) -> RX_STOP_MODE_W<RX_CONF_SPEC, 4> {
        RX_STOP_MODE_W::new(self)
    }
    #[doc = "Bit 6 - Set this bit to enable receiver in mono mode"]
    #[inline(always)]
    #[must_use]
    pub fn rx_mono(&mut self) -> RX_MONO_W<RX_CONF_SPEC, 6> {
        RX_MONO_W::new(self)
    }
    #[doc = "Bit 7 - I2S Rx byte endian, 1: low addr value to high addr. 0: low addr with low addr value."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_msb_shift(&mut self) -> RX_MSB_SHIFT_W<RX_CONF_SPEC, 13> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_bck_div_num(&mut self) -> RX_BCK_DIV_NUM_W<RX_CONF_SPEC, 21> {
