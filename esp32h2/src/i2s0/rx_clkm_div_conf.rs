...
pub type RX_CLKM_DIV_Z_R = crate::FieldReader<u16, u16>;
...
pub type RX_CLKM_DIV_Z_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RX_CLKM_DIV_CONF_SPEC, u16, u16, 9, O>;
...
pub type RX_CLKM_DIV_Y_R = crate::FieldReader<u16, u16>;
...
pub type RX_CLKM_DIV_X_R = crate::FieldReader<u16, u16>;
...
pub type RX_CLKM_DIV_YN1_R = crate::BitReader<bool>;
...
pub type RX_CLKM_DIV_YN1_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RX_CLKM_DIV_CONF_SPEC, bool, O>;
impl R {
