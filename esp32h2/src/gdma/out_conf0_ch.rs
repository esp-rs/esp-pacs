...
pub type OUT_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, OUT_CONF0_CH_SPEC, bool, O>;
...
pub type OUT_LOOP_TEST_W<'a, const O: u8> = crate::BitWriter<'a, u32, OUT_CONF0_CH_SPEC, bool, O>;
...
pub type OUT_AUTO_WRBACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OUT_CONF0_CH_SPEC, bool, O>;
...
pub type OUT_EOF_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, OUT_CONF0_CH_SPEC, bool, O>;
...
pub type OUT_ETM_EN_R = crate::BitReader<bool>;
#[doc = "Field `OUT_ETM_EN` writer - Set this bit to 1 to enable etm control mode, dma Tx channel 1 is triggered by etm task."]
pub type OUT_ETM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OUT_CONF0_CH_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn out_etm_en(&mut self) -> OUT_ETM_EN_W<6> {
