...
pub struct RegisterBlock {
    ...
    lp_ble_timer_intr_map: LP_BLE_TIMER_INTR_MAP,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn lp_ble_timer_intr_map(&self) -> &LP_BLE_TIMER_INTR_MAP {
...
/**LP_BLE_TIMER_INTR_MAP (rw) register accessor: register description
...
For information about available fields see [`mod@lp_ble_timer_intr_map`] module*/
...
/**I2C_EXT1_INTR_MAP (rw) register accessor: register description
...
/**PARL_IO_TX_INTR_MAP (rw) register accessor: register description
...
/**PARL_IO_RX_INTR_MAP (rw) register accessor: register description
...
/**ECDSA_INTR_MAP (rw) register accessor: register description
