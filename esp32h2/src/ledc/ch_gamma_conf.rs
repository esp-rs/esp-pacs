...
///Field `CH_GAMMA_ENTRY_NUM` reader - Ledc ch%s gamma entry num.
pub type CH_GAMMA_ENTRY_NUM_R = crate::FieldReader;
///Field `CH_GAMMA_ENTRY_NUM` writer - Ledc ch%s gamma entry num.
pub type CH_GAMMA_ENTRY_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `CH_GAMMA_PAUSE` writer - Ledc ch%s gamma pause, write 1 to pause.
pub type CH_GAMMA_PAUSE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_GAMMA_RESUME` writer - Ledc ch%s gamma resume, write 1 to resume.
pub type CH_GAMMA_RESUME_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:4 - Ledc ch%s gamma entry num.
    #[inline(always)]
