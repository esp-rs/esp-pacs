...
///Field `LEDC_DATE` reader - This is the version control register.
pub type LEDC_DATE_R = crate::FieldReader<u32>;
///Field `LEDC_DATE` writer - This is the version control register.
pub type LEDC_DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - This is the version control register.
    #[inline(always)]
...
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0211_1150;
}
