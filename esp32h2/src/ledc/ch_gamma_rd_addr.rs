...
impl W {
    #[doc = "Bits 0:3 - Ledc ch%s gamma ram read address."]
    #[inline(always)]
    pub fn ch_gamma_rd_addr(&mut self) -> CH_GAMMA_RD_ADDR_W<'_, CH_GAMMA_RD_ADDR_SPEC> {
        CH_GAMMA_RD_ADDR_W::new(self, 0)
    }
}
#[doc = "Ledc ch%s gamma ram read address register.\n\nYou can [`read`](crate::Reg::read) this register and get [`ch_gamma_rd_addr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch_gamma_rd_addr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
