...
///Field `TASK_TIMER0_RES_UPDATE_EN` reader - Ledc timer0 res update task enable register, write 1 to enable this task.
pub type TASK_TIMER0_RES_UPDATE_EN_R = crate::BitReader;
///Field `TASK_TIMER0_RES_UPDATE_EN` writer - Ledc timer0 res update task enable register, write 1 to enable this task.
pub type TASK_TIMER0_RES_UPDATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER1_RES_UPDATE_EN` reader - Ledc timer1 res update task enable register, write 1 to enable this task.
pub type TASK_TIMER1_RES_UPDATE_EN_R = crate::BitReader;
///Field `TASK_TIMER1_RES_UPDATE_EN` writer - Ledc timer1 res update task enable register, write 1 to enable this task.
pub type TASK_TIMER1_RES_UPDATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER2_RES_UPDATE_EN` reader - Ledc timer2 res update task enable register, write 1 to enable this task.
pub type TASK_TIMER2_RES_UPDATE_EN_R = crate::BitReader;
///Field `TASK_TIMER2_RES_UPDATE_EN` writer - Ledc timer2 res update task enable register, write 1 to enable this task.
pub type TASK_TIMER2_RES_UPDATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER3_RES_UPDATE_EN` reader - Ledc timer3 res update task enable register, write 1 to enable this task.
pub type TASK_TIMER3_RES_UPDATE_EN_R = crate::BitReader;
///Field `TASK_TIMER3_RES_UPDATE_EN` writer - Ledc timer3 res update task enable register, write 1 to enable this task.
pub type TASK_TIMER3_RES_UPDATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER0_CAP_EN` reader - Ledc timer0 capture task enable register, write 1 to enable this task.
pub type TASK_TIMER0_CAP_EN_R = crate::BitReader;
///Field `TASK_TIMER0_CAP_EN` writer - Ledc timer0 capture task enable register, write 1 to enable this task.
pub type TASK_TIMER0_CAP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER1_CAP_EN` reader - Ledc timer1 capture task enable register, write 1 to enable this task.
pub type TASK_TIMER1_CAP_EN_R = crate::BitReader;
///Field `TASK_TIMER1_CAP_EN` writer - Ledc timer1 capture task enable register, write 1 to enable this task.
pub type TASK_TIMER1_CAP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER2_CAP_EN` reader - Ledc timer2 capture task enable register, write 1 to enable this task.
pub type TASK_TIMER2_CAP_EN_R = crate::BitReader;
///Field `TASK_TIMER2_CAP_EN` writer - Ledc timer2 capture task enable register, write 1 to enable this task.
pub type TASK_TIMER2_CAP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER3_CAP_EN` reader - Ledc timer3 capture task enable register, write 1 to enable this task.
pub type TASK_TIMER3_CAP_EN_R = crate::BitReader;
///Field `TASK_TIMER3_CAP_EN` writer - Ledc timer3 capture task enable register, write 1 to enable this task.
pub type TASK_TIMER3_CAP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_SIG_OUT_DIS_CH0_EN` reader - Ledc ch0 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH0_EN_R = crate::BitReader;
///Field `TASK_SIG_OUT_DIS_CH0_EN` writer - Ledc ch0 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_SIG_OUT_DIS_CH1_EN` reader - Ledc ch1 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH1_EN_R = crate::BitReader;
///Field `TASK_SIG_OUT_DIS_CH1_EN` writer - Ledc ch1 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_SIG_OUT_DIS_CH2_EN` reader - Ledc ch2 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH2_EN_R = crate::BitReader;
///Field `TASK_SIG_OUT_DIS_CH2_EN` writer - Ledc ch2 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH2_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_SIG_OUT_DIS_CH3_EN` reader - Ledc ch3 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH3_EN_R = crate::BitReader;
///Field `TASK_SIG_OUT_DIS_CH3_EN` writer - Ledc ch3 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH3_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_SIG_OUT_DIS_CH4_EN` reader - Ledc ch4 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH4_EN_R = crate::BitReader;
///Field `TASK_SIG_OUT_DIS_CH4_EN` writer - Ledc ch4 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH4_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_SIG_OUT_DIS_CH5_EN` reader - Ledc ch5 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH5_EN_R = crate::BitReader;
///Field `TASK_SIG_OUT_DIS_CH5_EN` writer - Ledc ch5 signal out disable task enable register, write 1 to enable this task.
pub type TASK_SIG_OUT_DIS_CH5_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_OVF_CNT_RST_CH0_EN` reader - Ledc ch0 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH0_EN_R = crate::BitReader;
///Field `TASK_OVF_CNT_RST_CH0_EN` writer - Ledc ch0 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_OVF_CNT_RST_CH1_EN` reader - Ledc ch1 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH1_EN_R = crate::BitReader;
///Field `TASK_OVF_CNT_RST_CH1_EN` writer - Ledc ch1 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_OVF_CNT_RST_CH2_EN` reader - Ledc ch2 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH2_EN_R = crate::BitReader;
///Field `TASK_OVF_CNT_RST_CH2_EN` writer - Ledc ch2 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH2_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_OVF_CNT_RST_CH3_EN` reader - Ledc ch3 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH3_EN_R = crate::BitReader;
///Field `TASK_OVF_CNT_RST_CH3_EN` writer - Ledc ch3 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH3_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_OVF_CNT_RST_CH4_EN` reader - Ledc ch4 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH4_EN_R = crate::BitReader;
///Field `TASK_OVF_CNT_RST_CH4_EN` writer - Ledc ch4 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH4_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_OVF_CNT_RST_CH5_EN` reader - Ledc ch5 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH5_EN_R = crate::BitReader;
///Field `TASK_OVF_CNT_RST_CH5_EN` writer - Ledc ch5 overflow count reset task enable register, write 1 to enable this task.
pub type TASK_OVF_CNT_RST_CH5_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER0_RST_EN` reader - Ledc timer0 reset task enable register, write 1 to enable this task.
pub type TASK_TIMER0_RST_EN_R = crate::BitReader;
///Field `TASK_TIMER0_RST_EN` writer - Ledc timer0 reset task enable register, write 1 to enable this task.
pub type TASK_TIMER0_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER1_RST_EN` reader - Ledc timer1 reset task enable register, write 1 to enable this task.
pub type TASK_TIMER1_RST_EN_R = crate::BitReader;
///Field `TASK_TIMER1_RST_EN` writer - Ledc timer1 reset task enable register, write 1 to enable this task.
pub type TASK_TIMER1_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER2_RST_EN` reader - Ledc timer2 reset task enable register, write 1 to enable this task.
pub type TASK_TIMER2_RST_EN_R = crate::BitReader;
///Field `TASK_TIMER2_RST_EN` writer - Ledc timer2 reset task enable register, write 1 to enable this task.
pub type TASK_TIMER2_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER3_RST_EN` reader - Ledc timer3 reset task enable register, write 1 to enable this task.
pub type TASK_TIMER3_RST_EN_R = crate::BitReader;
///Field `TASK_TIMER3_RST_EN` writer - Ledc timer3 reset task enable register, write 1 to enable this task.
pub type TASK_TIMER3_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER0_PAUSE_RESUME_EN` reader - Ledc timer0 pause resume task enable register, write 1 to enable this task.
pub type TASK_TIMER0_PAUSE_RESUME_EN_R = crate::BitReader;
///Field `TASK_TIMER0_PAUSE_RESUME_EN` writer - Ledc timer0 pause resume task enable register, write 1 to enable this task.
pub type TASK_TIMER0_PAUSE_RESUME_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER1_PAUSE_RESUME_EN` reader - Ledc timer1 pause resume task enable register, write 1 to enable this task.
pub type TASK_TIMER1_PAUSE_RESUME_EN_R = crate::BitReader;
///Field `TASK_TIMER1_PAUSE_RESUME_EN` writer - Ledc timer1 pause resume task enable register, write 1 to enable this task.
pub type TASK_TIMER1_PAUSE_RESUME_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER2_PAUSE_RESUME_EN` reader - Ledc timer2 pause resume task enable register, write 1 to enable this task.
pub type TASK_TIMER2_PAUSE_RESUME_EN_R = crate::BitReader;
///Field `TASK_TIMER2_PAUSE_RESUME_EN` writer - Ledc timer2 pause resume task enable register, write 1 to enable this task.
pub type TASK_TIMER2_PAUSE_RESUME_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TASK_TIMER3_PAUSE_RESUME_EN` reader - Ledc timer3 pause resume task enable register, write 1 to enable this task.
pub type TASK_TIMER3_PAUSE_RESUME_EN_R = crate::BitReader;
///Field `TASK_TIMER3_PAUSE_RESUME_EN` writer - Ledc timer3 pause resume task enable register, write 1 to enable this task.
