...
/**STORE0 (rw) register accessor: need_des
...
///need_des
pub mod store0;
/**STORE1 (rw) register accessor: need_des
...
///need_des
pub mod store1;
/**STORE2 (rw) register accessor: need_des
...
///need_des
pub mod store2;
/**STORE3 (rw) register accessor: need_des
...
///need_des
pub mod store3;
/**STORE4 (rw) register accessor: need_des
...
///need_des
pub mod store4;
/**STORE5 (rw) register accessor: need_des
...
///need_des
pub mod store5;
/**STORE6 (rw) register accessor: need_des
...
///need_des
pub mod store6;
/**STORE7 (rw) register accessor: need_des
...
///need_des
pub mod store8;
/**STORE9 (rw) register accessor: need_des
...
///need_des
pub mod gpio_mux;
/**GPIO_HOLD0 (rw) register accessor: need_des
...
///need_des
pub mod gpio_hold0;
/**GPIO_HOLD1 (rw) register accessor: need_des
...
///need_des
pub mod sys_cfg;
/**CPUCORE0_CFG (rw) register accessor: need_des
...
/**IO_MUX (rw) register accessor: need_des
...
///need_des
pub mod usb;
/**LPBUS (rw) register accessor: need_des
...
///need_des
pub mod lpbus;
/**SDIO_ACTIVE (rw) register accessor: need_des
...
///need_des
pub mod sdio_active;
/**LPCORE (rw) register accessor: need_des
...
///need_des
pub mod lpcore;
/**SAR_CCT (rw) register accessor: need_des
...
///need_des
pub mod sar_cct;
/**JTAG_SEL (rw) register accessor: need_des
