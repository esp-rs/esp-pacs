...
///Field `TX_REF_CNT_RST` writer - This register is used to reset the clock divider of CHANNEL0.
...
///Field `RX_REF_CNT_RST_CH2` writer - This register is used to reset the clock divider of CHANNEL2.
pub type RX_REF_CNT_RST_CH2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_REF_CNT_RST_CH3` writer - This register is used to reset the clock divider of CHANNEL3.
