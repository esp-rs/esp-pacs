...
pub type DIV_CNT_CH2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DIV_CNT_CH2` writer - This register is used to configure the divider for clock of CHANNEL%s."]
pub type DIV_CNT_CH2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RX_CHCONF0_SPEC, u8, u8, 8, O>;
...
pub type CARRIER_EN_CH2_R = crate::BitReader<bool>;
...
pub type CARRIER_EN_CH2_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_CHCONF0_SPEC, bool, O>;
...
pub type CARRIER_OUT_LV_CH2_R = crate::BitReader<bool>;
...
pub type CARRIER_OUT_LV_CH2_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RX_CHCONF0_SPEC, bool, O>;
impl R {
