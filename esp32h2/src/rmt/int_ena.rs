...
///Field `CH_TX_END(0-1)` reader - The interrupt enable bit for CH%s_TX_END_INT.
pub type CH_TX_END_R = crate::BitReader;
///Field `CH_TX_END(0-1)` writer - The interrupt enable bit for CH%s_TX_END_INT.
pub type CH_TX_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_RX_END(2-3)` reader - The interrupt enable bit for CH2_RX_END_INT.
pub type CH_RX_END_R = crate::BitReader;
///Field `CH_RX_END(2-3)` writer - The interrupt enable bit for CH2_RX_END_INT.
pub type CH_RX_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_TX_ERR(0-1)` reader - The interrupt enable bit for CH4_ERR_INT.
pub type CH_TX_ERR_R = crate::BitReader;
///Field `CH_TX_ERR(0-1)` writer - The interrupt enable bit for CH4_ERR_INT.
pub type CH_TX_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_RX_ERR(2-3)` reader - The interrupt enable bit for CH6_ERR_INT.
pub type CH_RX_ERR_R = crate::BitReader;
///Field `CH_RX_ERR(2-3)` writer - The interrupt enable bit for CH6_ERR_INT.
pub type CH_RX_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_TX_THR_EVENT(0-1)` reader - The interrupt enable bit for CH%s_TX_THR_EVENT_INT.
pub type CH_TX_THR_EVENT_R = crate::BitReader;
///Field `CH_TX_THR_EVENT(0-1)` writer - The interrupt enable bit for CH%s_TX_THR_EVENT_INT.
pub type CH_TX_THR_EVENT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_RX_THR_EVENT(2-3)` reader - The interrupt enable bit for CH2_RX_THR_EVENT_INT.
pub type CH_RX_THR_EVENT_R = crate::BitReader;
///Field `CH_RX_THR_EVENT(2-3)` writer - The interrupt enable bit for CH2_RX_THR_EVENT_INT.
pub type CH_RX_THR_EVENT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_X_LOOP(0-1)` reader - The interrupt enable bit for CH%s_TX_LOOP_INT.
pub type CH_X_LOOP_R = crate::BitReader;
///Field `CH_X_LOOP(0-1)` writer - The interrupt enable bit for CH%s_TX_LOOP_INT.
