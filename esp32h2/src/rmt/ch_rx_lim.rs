...
///Field `RMT_RX_LIM` reader - This register is used to configure the maximum entries that CHANNEL%s can receive.
pub type RMT_RX_LIM_R = crate::FieldReader<u16>;
///Field `RMT_RX_LIM` writer - This register is used to configure the maximum entries that CHANNEL%s can receive.
