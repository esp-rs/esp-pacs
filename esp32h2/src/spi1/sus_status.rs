...
///Field `FLASH_PESR_CMD_2B` reader - 1: The bit length of Program/Erase Suspend/Resume command is 16. 0: The bit length of Program/Erase Suspend/Resume command is 8.
pub type FLASH_PESR_CMD_2B_R = crate::BitReader;
///Field `FLASH_PESR_CMD_2B` writer - 1: The bit length of Program/Erase Suspend/Resume command is 16. 0: The bit length of Program/Erase Suspend/Resume command is 8.
pub type FLASH_PESR_CMD_2B_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FLASH_PER_COMMAND` reader - Program/Erase resume command.
pub type FLASH_PER_COMMAND_R = crate::FieldReader<u16>;
///Field `FLASH_PER_COMMAND` writer - Program/Erase resume command.
...
impl R {
    ...
    ///Bit 15 - 1: The bit length of Program/Erase Suspend/Resume command is 16. 0: The bit length of Program/Erase Suspend/Resume command is 8.
    #[inline(always)]
    pub fn flash_pesr_cmd_2b(&self) -> FLASH_PESR_CMD_2B_R {
        FLASH_PESR_CMD_2B_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bits 16:31 - Program/Erase resume command.
    #[inline(always)]
