...
impl RegisterBlock {
    ...
    ///0x04..0x74 - IO MUX Configure Register for pad GPIO0
    #[inline(always)]
...
pub mod pin_ctrl;
/**GPIO (rw) register accessor: IO MUX Configure Register for pad GPIO0
...
pub mod gpio;
/**MODEM_DIAG_EN (rw) register accessor: GPIO MATRIX Configure Register for modem diag
