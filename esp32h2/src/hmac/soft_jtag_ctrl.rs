///Register `SOFT_JTAG_CTRL` writer
pub type W = crate::W<SOFT_JTAG_CTRL_SPEC>;
///Field `SOFT_JTAG_CTRL` writer - Turn on JTAG verification.
...
impl W {
    ///Bit 0 - Turn on JTAG verification.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`soft_jtag_ctrl::W`](W) writer structure
