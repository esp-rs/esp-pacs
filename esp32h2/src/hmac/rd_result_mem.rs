///Register `RD_RESULT_MEM[%s]` reader
pub type R = crate::R<RD_RESULT_MEM_SPEC>;
///Register `RD_RESULT_MEM[%s]` writer
...
///`read()` method returns [`rd_result_mem::R`](R) reader structure
impl crate::Readable for RD_RESULT_MEM_SPEC {}
///`write(|w| ..)` method takes [`rd_result_mem::W`](W) writer structure
