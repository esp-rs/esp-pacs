...
pub type VDDBAT_CHARGE_UPVOLTAGE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type VDDBAT_CHARGE_UNDERVOLTAGE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type VDDBAT_UPVOLTAGE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type VDDBAT_UNDERVOLTAGE_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BOD_MODE0_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    pub fn vddbat_charge_upvoltage_int_raw(
        &mut self,
    ) -> VDDBAT_CHARGE_UPVOLTAGE_INT_RAW_W<INT_RAW_SPEC, 27> {
    ...
    pub fn vddbat_charge_undervoltage_int_raw(
        &mut self,
    ) -> VDDBAT_CHARGE_UNDERVOLTAGE_INT_RAW_W<INT_RAW_SPEC, 28> {
        VDDBAT_CHARGE_UNDERVOLTAGE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn vddbat_upvoltage_int_raw(&mut self) -> VDDBAT_UPVOLTAGE_INT_RAW_W<INT_RAW_SPEC, 29> {
    ...
    pub fn vddbat_undervoltage_int_raw(
        &mut self,
    ) -> VDDBAT_UNDERVOLTAGE_INT_RAW_W<INT_RAW_SPEC, 30> {
        VDDBAT_UNDERVOLTAGE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn bod_mode0_int_raw(&mut self) -> BOD_MODE0_INT_RAW_W<INT_RAW_SPEC, 31> {
