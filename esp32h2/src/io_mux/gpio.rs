...
pub type HYS_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HYS_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn filter_en(&mut self) -> FILTER_EN_W<GPIO_SPEC, 15> {
        FILTER_EN_W::new(self)
    }
    #[doc = "Bit 16 - Software enables hysteresis function for the pad. 1: Hysteresis enabled. 0: Hysteresis disabled."]
    #[inline(always)]
    #[must_use]
    pub fn hys_en(&mut self) -> HYS_EN_W<GPIO_SPEC, 16> {
        HYS_EN_W::new(self)
    }
    #[doc = "Bit 17 - Select enabling signals of the pad from software and efuse hardware. 1: Select enabling siganl from slftware. 0: Select enabling signal from efuse hardware."]
    #[inline(always)]
    #[must_use]
    pub fn hys_sel(&mut self) -> HYS_SEL_W<GPIO_SPEC, 17> {
        HYS_SEL_W::new(self)
    }
