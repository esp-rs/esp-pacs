///Register `HP_PERI_TIMEOUT_UID` reader
pub type R = crate::R<HP_PERI_TIMEOUT_UID_SPEC>;
///Field `HP_PERI_TIMEOUT_UID` reader - Record master id\[4:0\] &amp; master permission\[6:5\] when trigger timeout. This register will be cleared after the interrupt is cleared.
...
///`read()` method returns [`hp_peri_timeout_uid::R`](R) reader structure
