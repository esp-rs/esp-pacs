///Register `CPU_PERI_TIMEOUT_UID` reader
pub type R = crate::R<CPU_PERI_TIMEOUT_UID_SPEC>;
///Field `CPU_PERI_TIMEOUT_UID` reader - Record master id\[4:0\] &amp; master permission\[6:5\] when trigger timeout. This register will be cleared after the interrupt is cleared.
...
///`read()` method returns [`cpu_peri_timeout_uid::R`](R) reader structure
