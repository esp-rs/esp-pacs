...
pub type IN_INV_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, FUNC72_IN_SEL_CFG_SPEC, bool, O>;
...
pub type SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, FUNC72_IN_SEL_CFG_SPEC, bool, O>;
impl R {
