...
///Field `DATA` reader - GPIO output enable register for GPIO0-31
pub type DATA_R = crate::FieldReader<u32>;
///Field `DATA` writer - GPIO output enable register for GPIO0-31
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - GPIO output enable register for GPIO0-31
    #[inline(always)]
