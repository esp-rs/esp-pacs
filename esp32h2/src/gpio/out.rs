...
#[doc = "Field `DATA_ORIG` reader - GPIO output register for GPIO0-31"]
pub type DATA_ORIG_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATA_ORIG` writer - GPIO output register for GPIO0-31"]
pub type DATA_ORIG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OUT_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - GPIO output register for GPIO0-31"]
    #[inline(always)]
