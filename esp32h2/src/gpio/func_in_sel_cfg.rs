...
///Field `IN_SEL` reader - set this value: s=0-34: connect GPIO\[s\] to this port. s=0x38: set this port always high level. s=0x3C: set this port always low level.
pub type IN_SEL_R = crate::FieldReader;
///Field `IN_SEL` writer - set this value: s=0-34: connect GPIO\[s\] to this port. s=0x38: set this port always high level. s=0x3C: set this port always low level.
