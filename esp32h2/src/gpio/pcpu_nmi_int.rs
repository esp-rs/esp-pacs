...
///Field `PROCPU_NMI_INT` reader - GPIO PRO_CPU(not shielded) interrupt status register for GPIO0-31
pub type PROCPU_NMI_INT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - GPIO PRO_CPU(not shielded) interrupt status register for GPIO0-31
    #[inline(always)]
