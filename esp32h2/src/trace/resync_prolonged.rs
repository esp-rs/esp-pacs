...
///Field `RESYNC_MODE` reader - resyc mode sel: 0: default, cycle count 1: package num count
pub type RESYNC_MODE_R = crate::BitReader;
///Field `RESYNC_MODE` writer - resyc mode sel: 0: default, cycle count 1: package num count
