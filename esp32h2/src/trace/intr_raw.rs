...
///Field `FIFO_OVERFLOW_INTR_RAW` reader - fifo_overflow interrupt status
pub type FIFO_OVERFLOW_INTR_RAW_R = crate::BitReader;
///Field `MEM_FULL_INTR_RAW` reader - mem_full interrupt status
pub type MEM_FULL_INTR_RAW_R = crate::BitReader;
impl R {
    ///Bit 0 - fifo_overflow interrupt status
    #[inline(always)]
