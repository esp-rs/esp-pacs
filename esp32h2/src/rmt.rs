...
pub mod chdata;
/**CH_TX_CONF0 (rw) register accessor: Channel %s configure register 0
...
pub mod ch_tx_conf0;
/**CH_RX_CONF0 (rw) register accessor: Channel %s configure register 0
...
///Channel %s configure register 0
pub mod ch_rx_conf0;
/**CH_RX_CONF1 (rw) register accessor: Channel %s configure register 1
...
pub mod ch_rx_conf1;
/**CH_TX_STATUS (r) register accessor: Channel %s status register
...
/**CH_RX_STATUS (r) register accessor: Channel %s status register
