...
pub type CLKRST_DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATE_SPEC, u32, u32, 31, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clkrst_date(&mut self) -> CLKRST_DATE_W<0> {
...
#[doc = "`reset()` method sets DATE to value 0x0220_7280"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_7280;
}
