...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_CLK_PO_EN")
            .field("aon_slow_oen", &self.aon_slow_oen().bit())
            .field("aon_fast_oen", &self.aon_fast_oen().bit())
            .field("sosc_oen", &self.sosc_oen().bit())
            .field("fosc_oen", &self.fosc_oen().bit())
            .field("osc32k_oen", &self.osc32k_oen().bit())
            .field("xtal32k_oen", &self.xtal32k_oen().bit())
            .field("core_efuse_oen", &self.core_efuse_oen().bit())
            .field("slow_oen", &self.slow_oen().bit())
            .field("fast_oen", &self.fast_oen().bit())
            .field("rng_oen", &self.rng_oen().bit())
            .field("lpbus_oen", &self.lpbus_oen().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
