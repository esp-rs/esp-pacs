///Register `FOSC_CNTL` reader
pub type R = crate::R<FOSC_CNTL_SPEC>;
///Register `FOSC_CNTL` writer
pub type W = crate::W<FOSC_CNTL_SPEC>;
///Field `FOSC_DFREQ` reader - need_des
pub type FOSC_DFREQ_R = crate::FieldReader<u16>;
///Field `FOSC_DFREQ` writer - need_des
...
///`read()` method returns [`fosc_cntl::R`](R) reader structure
impl crate::Readable for FOSC_CNTL_SPEC {}
///`write(|w| ..)` method takes [`fosc_cntl::W`](W) writer structure
...
impl crate::Resettable for FOSC_CNTL_SPEC {
    const RESET_VALUE: u32 = 0x9600_0000;
}
