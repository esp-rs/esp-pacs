...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio20_en(&mut self) -> ETM_TASK_GPIO20_EN_W<ETM_TASK_P5_CFG_SPEC> {
        ETM_TASK_GPIO20_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio20_sel(&mut self) -> ETM_TASK_GPIO20_SEL_W<ETM_TASK_P5_CFG_SPEC> {
        ETM_TASK_GPIO20_SEL_W::new(self, 1)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio21_en(&mut self) -> ETM_TASK_GPIO21_EN_W<ETM_TASK_P5_CFG_SPEC> {
        ETM_TASK_GPIO21_EN_W::new(self, 8)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio21_sel(&mut self) -> ETM_TASK_GPIO21_SEL_W<ETM_TASK_P5_CFG_SPEC> {
        ETM_TASK_GPIO21_SEL_W::new(self, 9)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio22_en(&mut self) -> ETM_TASK_GPIO22_EN_W<ETM_TASK_P5_CFG_SPEC> {
        ETM_TASK_GPIO22_EN_W::new(self, 16)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio22_sel(&mut self) -> ETM_TASK_GPIO22_SEL_W<ETM_TASK_P5_CFG_SPEC> {
        ETM_TASK_GPIO22_SEL_W::new(self, 17)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio23_en(&mut self) -> ETM_TASK_GPIO23_EN_W<ETM_TASK_P5_CFG_SPEC> {
        ETM_TASK_GPIO23_EN_W::new(self, 24)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio23_sel(&mut self) -> ETM_TASK_GPIO23_SEL_W<ETM_TASK_P5_CFG_SPEC> {
        ETM_TASK_GPIO23_SEL_W::new(self, 25)
    }
