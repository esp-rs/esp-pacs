...
pub type ETM_TASK_GPIO20_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO20_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ETM_TASK_GPIO21_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO21_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ETM_TASK_GPIO22_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO22_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ETM_TASK_GPIO23_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO23_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETM_TASK_P5_CFG")
            .field(
                "etm_task_gpio20_en",
                &format_args!("{}", self.etm_task_gpio20_en().bit()),
            )
            .field(
                "etm_task_gpio20_sel",
                &format_args!("{}", self.etm_task_gpio20_sel().bits()),
            )
            .field(
                "etm_task_gpio21_en",
                &format_args!("{}", self.etm_task_gpio21_en().bit()),
            )
            .field(
                "etm_task_gpio21_sel",
                &format_args!("{}", self.etm_task_gpio21_sel().bits()),
            )
            .field(
                "etm_task_gpio22_en",
                &format_args!("{}", self.etm_task_gpio22_en().bit()),
            )
            .field(
                "etm_task_gpio22_sel",
                &format_args!("{}", self.etm_task_gpio22_sel().bits()),
            )
            .field(
                "etm_task_gpio23_en",
                &format_args!("{}", self.etm_task_gpio23_en().bit()),
            )
            .field(
                "etm_task_gpio23_sel",
                &format_args!("{}", self.etm_task_gpio23_sel().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<ETM_TASK_P5_CFG_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio20_en(&mut self) -> ETM_TASK_GPIO20_EN_W<ETM_TASK_P5_CFG_SPEC, 0> {
        ETM_TASK_GPIO20_EN_W::new(self)
    }
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio20_sel(&mut self) -> ETM_TASK_GPIO20_SEL_W<ETM_TASK_P5_CFG_SPEC, 1> {
        ETM_TASK_GPIO20_SEL_W::new(self)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio21_en(&mut self) -> ETM_TASK_GPIO21_EN_W<ETM_TASK_P5_CFG_SPEC, 8> {
        ETM_TASK_GPIO21_EN_W::new(self)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio21_sel(&mut self) -> ETM_TASK_GPIO21_SEL_W<ETM_TASK_P5_CFG_SPEC, 9> {
        ETM_TASK_GPIO21_SEL_W::new(self)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio22_en(&mut self) -> ETM_TASK_GPIO22_EN_W<ETM_TASK_P5_CFG_SPEC, 16> {
        ETM_TASK_GPIO22_EN_W::new(self)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio22_sel(&mut self) -> ETM_TASK_GPIO22_SEL_W<ETM_TASK_P5_CFG_SPEC, 17> {
        ETM_TASK_GPIO22_SEL_W::new(self)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio23_en(&mut self) -> ETM_TASK_GPIO23_EN_W<ETM_TASK_P5_CFG_SPEC, 24> {
        ETM_TASK_GPIO23_EN_W::new(self)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio23_sel(&mut self) -> ETM_TASK_GPIO23_SEL_W<ETM_TASK_P5_CFG_SPEC, 25> {
