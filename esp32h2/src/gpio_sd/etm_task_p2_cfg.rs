///Register `ETM_TASK_P2_CFG` reader
pub type R = crate::R<ETM_TASK_P2_CFG_SPEC>;
///Register `ETM_TASK_P2_CFG` writer
pub type W = crate::W<ETM_TASK_P2_CFG_SPEC>;
///Field `GPIO_EN(8-11)` reader - Enable bit of GPIO response etm task.
pub type GPIO_EN_R = crate::BitReader;
///Field `GPIO_EN(8-11)` writer - Enable bit of GPIO response etm task.
pub type GPIO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPIO_SEL(8-11)` reader - GPIO choose a etm task channel.
pub type GPIO_SEL_R = crate::FieldReader;
///Field `GPIO_SEL(8-11)` writer - GPIO choose a etm task channel.
pub type GPIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Enable bit of GPIO response etm task.
    ///
    ///NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO8_EN` field
    #[inline(always)]
    ...
    ///
    ///NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO8_SEL` field
    #[inline(always)]
...
///`read()` method returns [`etm_task_p2_cfg::R`](R) reader structure
impl crate::Readable for ETM_TASK_P2_CFG_SPEC {}
///`write(|w| ..)` method takes [`etm_task_p2_cfg::W`](W) writer structure
