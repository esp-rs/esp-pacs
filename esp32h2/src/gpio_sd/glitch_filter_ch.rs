///Register `GLITCH_FILTER_CH%s` reader
pub type R = crate::R<GLITCH_FILTER_CH_SPEC>;
///Register `GLITCH_FILTER_CH%s` writer
pub type W = crate::W<GLITCH_FILTER_CH_SPEC>;
///Field `EN` reader - Glitch Filter channel enable bit.
pub type EN_R = crate::BitReader;
///Field `EN` writer - Glitch Filter channel enable bit.
pub type EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INPUT_IO_NUM` reader - Glitch Filter input io number.
pub type INPUT_IO_NUM_R = crate::FieldReader;
///Field `INPUT_IO_NUM` writer - Glitch Filter input io number.
pub type INPUT_IO_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `WINDOW_THRES` reader - Glitch Filter window threshold.
pub type WINDOW_THRES_R = crate::FieldReader;
///Field `WINDOW_THRES` writer - Glitch Filter window threshold.
pub type WINDOW_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `WINDOW_WIDTH` reader - Glitch Filter window width.
pub type WINDOW_WIDTH_R = crate::FieldReader;
///Field `WINDOW_WIDTH` writer - Glitch Filter window width.
pub type WINDOW_WIDTH_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bit 0 - Glitch Filter channel enable bit.
    #[inline(always)]
    pub fn en(&self) -> EN_R {
        EN_R::new((self.bits & 1) != 0)
    }
    ///Bits 1:6 - Glitch Filter input io number.
    #[inline(always)]
    pub fn input_io_num(&self) -> INPUT_IO_NUM_R {
        INPUT_IO_NUM_R::new(((self.bits >> 1) & 0x3f) as u8)
    }
    ///Bits 7:12 - Glitch Filter window threshold.
    #[inline(always)]
    pub fn window_thres(&self) -> WINDOW_THRES_R {
        WINDOW_THRES_R::new(((self.bits >> 7) & 0x3f) as u8)
    }
    ///Bits 13:18 - Glitch Filter window width.
    #[inline(always)]
...
///`read()` method returns [`glitch_filter_ch::R`](R) reader structure
impl crate::Readable for GLITCH_FILTER_CH_SPEC {}
///`write(|w| ..)` method takes [`glitch_filter_ch::W`](W) writer structure
