...
pub type OUTLINK_START_W<'a, const O: u8> = crate::BitWriter<'a, OUT_LINK_CH_SPEC, O>;
#[doc = "Field `OUTLINK_RESTART` writer - Set this bit to restart a new outlink from the last address."]
pub type OUTLINK_RESTART_W<'a, const O: u8> = crate::BitWriter<'a, OUT_LINK_CH_SPEC, O>;
