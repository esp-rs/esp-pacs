...
pub type MOD_BASE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type WORK_MODE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mod_base(&mut self) -> MOD_BASE_W<MULT_CONF_SPEC, 3> {
        MOD_BASE_W::new(self)
    }
    #[doc = "Bits 4:7 - The work mode bits of ECC Accelerator. 0: Point Mult Mode. 1: Reserved. 2: Point verification mode. 3: Point Verif+mult mode. 4: Jacobian Point Mult Mode. 5: Point Add Mode. 6: Jacobian Point Verification Mode. 7: Point Verif + Jacobian Mult Mode. 8: mod addition. 9. mod substraction. 10: mod multiplication. 11: mod division."]
    #[inline(always)]
    #[must_use]
    pub fn work_mode(&mut self) -> WORK_MODE_W<MULT_CONF_SPEC, 4> {
        WORK_MODE_W::new(self)
    }
    #[doc = "Bit 8 - Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn security_mode(&mut self) -> SECURITY_MODE_W<MULT_CONF_SPEC, 8> {
        SECURITY_MODE_W::new(self)
    }
    #[doc = "Bit 30 - Write 1 to force on register clock gate."]
    #[inline(always)]
    #[must_use]
    pub fn clk_en(&mut self) -> CLK_EN_W<MULT_CONF_SPEC, 30> {
        CLK_EN_W::new(self)
    }
    #[doc = "Bit 31 - ECC memory clock gate force on register"]
    #[inline(always)]
