...
///Field `MOD_BASE` reader - The mod base of mod operation, only valid in work_mode 8-11. 0: n(order of curve). 1: p(mod base of curve)
pub type MOD_BASE_R = crate::BitReader;
///Field `MOD_BASE` writer - The mod base of mod operation, only valid in work_mode 8-11. 0: n(order of curve). 1: p(mod base of curve)
pub type MOD_BASE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WORK_MODE` reader - The work mode bits of ECC Accelerator. 0: Point Mult Mode. 1: Reserved. 2: Point verification mode. 3: Point Verif+mult mode. 4: Jacobian Point Mult Mode. 5: Point Add Mode. 6: Jacobian Point Verification Mode. 7: Point Verif + Jacobian Mult Mode. 8: mod addition. 9. mod substraction. 10: mod multiplication. 11: mod division.
pub type WORK_MODE_R = crate::FieldReader;
///Field `WORK_MODE` writer - The work mode bits of ECC Accelerator. 0: Point Mult Mode. 1: Reserved. 2: Point verification mode. 3: Point Verif+mult mode. 4: Jacobian Point Mult Mode. 5: Point Add Mode. 6: Jacobian Point Verification Mode. 7: Point Verif + Jacobian Mult Mode. 8: mod addition. 9. mod substraction. 10: mod multiplication. 11: mod division.
...
impl R {
    ...
    ///Bit 30 - Write 1 to force on register clock gate.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 1 - Write 1 to reset ECC Accelerator.
    #[inline(always)]
    #[must_use]
