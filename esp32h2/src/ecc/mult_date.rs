...
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MULT_DATE_SPEC, u32, u32, 28, O>;
impl R {
...
#[doc = "`reset()` method sets MULT_DATE to value 0x0220_7180"]
impl crate::Resettable for MULT_DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_7180;
}
