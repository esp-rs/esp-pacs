...
///Field `REMAINDER_BIT_NUM` reader - Those bits stores the number of remainder bit.
pub type REMAINDER_BIT_NUM_R = crate::FieldReader;
///Field `REMAINDER_BIT_NUM` writer - Those bits stores the number of remainder bit.
pub type REMAINDER_BIT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    ///Bits 0:6 - Those bits stores the number of remainder bit.
    #[inline(always)]
