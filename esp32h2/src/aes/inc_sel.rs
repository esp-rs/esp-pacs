...
///Field `INC_SEL` reader - This bit decides the standard incrementing function. 0: INC32. 1: INC128.
...
impl R {
    ///Bit 0 - This bit decides the standard incrementing function. 0: INC32. 1: INC128.
    #[inline(always)]
