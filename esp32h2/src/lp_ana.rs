...
#[doc = "VDD_SOURCE_CNTL (rw) register accessor: an alias for `Reg<VDD_SOURCE_CNTL_SPEC>`"]
pub type VDD_SOURCE_CNTL = crate::Reg<vdd_source_cntl::VDD_SOURCE_CNTL_SPEC>;
#[doc = "need_des"]
pub mod vdd_source_cntl;
#[doc = "VDDBAT_BOD_CNTL (rw) register accessor: an alias for `Reg<VDDBAT_BOD_CNTL_SPEC>`"]
pub type VDDBAT_BOD_CNTL = crate::Reg<vddbat_bod_cntl::VDDBAT_BOD_CNTL_SPEC>;
#[doc = "need_des"]
pub mod vddbat_bod_cntl;
#[doc = "VDDBAT_CHARGE_CNTL (rw) register accessor: an alias for `Reg<VDDBAT_CHARGE_CNTL_SPEC>`"]
...
#[doc = "PG_GLITCH_CNTL (rw) register accessor: an alias for `Reg<PG_GLITCH_CNTL_SPEC>`"]
