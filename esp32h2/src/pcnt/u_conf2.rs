...
#[doc = "Field `CNT_H_LIM_U` reader - This register is used to configure the thr_h_lim value for unit %s. When pluse_cnt reaches this value, the counter will be cleared to 0."]
pub type CNT_H_LIM_U_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CNT_H_LIM_U` writer - This register is used to configure the thr_h_lim value for unit %s. When pluse_cnt reaches this value, the counter will be cleared to 0."]
pub type CNT_H_LIM_U_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, U_CONF2_SPEC, u16, u16, 16, O>;
#[doc = "Field `CNT_L_LIM_U` reader - This register is used to configure the thr_l_lim value for unit %s. When pluse_cnt reaches this value, the counter will be cleared to 0."]
pub type CNT_L_LIM_U_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CNT_L_LIM_U` writer - This register is used to configure the thr_l_lim value for unit %s. When pluse_cnt reaches this value, the counter will be cleared to 0."]
...
impl R {
    ...
    #[doc = "Bits 16:31 - This register is used to configure the thr_l_lim value for unit %s. When pluse_cnt reaches this value, the counter will be cleared to 0."]
    #[inline(always)]
