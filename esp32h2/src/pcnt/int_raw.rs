...
///Field `CNT_THR_EVENT_U(0-3)` reader - The raw interrupt status bit for the PCNT_CNT_THR_EVENT_U%s_INT interrupt.
pub type CNT_THR_EVENT_U_R = crate::BitReader;
///Field `CNT_THR_EVENT_U(0-3)` writer - The raw interrupt status bit for the PCNT_CNT_THR_EVENT_U%s_INT interrupt.
