...
pub struct R(crate::R<GEN1_B_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GEN1_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GEN1_B_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GEN1_B_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GEN1_B` writer"]
pub struct W(crate::W<GEN1_B_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GEN1_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GEN1_B_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GEN1_B_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Field `UTEZ` writer - Action on PWM1B triggered by event TEZ when timer increasing"]
pub type UTEZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `UTEP` writer - Action on PWM1B triggered by event TEP when timer increasing"]
pub type UTEP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `UTEA` writer - Action on PWM1B triggered by event TEA when timer increasing"]
pub type UTEA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `UTEB` writer - Action on PWM1B triggered by event TEB when timer increasing"]
pub type UTEB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
#[doc = "Field `UT0` reader - Action on PWM1B triggered by event_t0 when timer increasing"]
pub type UT0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `UT0` writer - Action on PWM1B triggered by event_t0 when timer increasing"]
pub type UT0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
#[doc = "Field `UT1` reader - Action on PWM1B triggered by event_t1 when timer increasing"]
pub type UT1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `UT1` writer - Action on PWM1B triggered by event_t1 when timer increasing"]
pub type UT1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `DTEZ` writer - Action on PWM1B triggered by event TEZ when timer decreasing"]
pub type DTEZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `DTEP` writer - Action on PWM1B triggered by event TEP when timer decreasing"]
pub type DTEP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `DTEA` writer - Action on PWM1B triggered by event TEA when timer decreasing"]
pub type DTEA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `DTEB` writer - Action on PWM1B triggered by event TEB when timer decreasing"]
pub type DTEB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
#[doc = "Field `DT0` reader - Action on PWM1B triggered by event_t0 when timer decreasing"]
pub type DT0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DT0` writer - Action on PWM1B triggered by event_t0 when timer decreasing"]
pub type DT0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `DT1` writer - Action on PWM1B triggered by event_t1 when timer decreasing. 0: no change, 1: low, 2: high, 3: toggle"]
pub type DT1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GEN1_B_SPEC, u8, u8, 2, O>;
impl R {
