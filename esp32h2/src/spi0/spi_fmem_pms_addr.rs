...
///Field `S` reader - SPI1 flash ACE section %s start address value
pub type S_R = crate::FieldReader<u32>;
///Field `S` writer - SPI1 flash ACE section %s start address value
pub type S_W<'a, REG> = crate::FieldWriter<'a, REG, 26, u32>;
impl R {
    ///Bits 0:25 - SPI1 flash ACE section %s start address value
    #[inline(always)]
    pub fn s(&self) -> S_R {
