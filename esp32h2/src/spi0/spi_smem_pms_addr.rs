...
pub struct R(crate::R<SPI_SMEM_PMS_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPI_SMEM_PMS_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPI_SMEM_PMS_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPI_SMEM_PMS_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPI_SMEM_PMS%s_ADDR` writer"]
pub struct W(crate::W<SPI_SMEM_PMS_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI_SMEM_PMS_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI_SMEM_PMS_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI_SMEM_PMS_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
