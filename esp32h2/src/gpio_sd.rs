...
/**PAD_COMP_CONFIG (rw) register accessor: PAD Compare configure Register
...
/**PAD_COMP_FILTER (rw) register accessor: Zero Detect filter Register
...
/**INT_RAW (r) register accessor: GPIOSD interrupt raw register
...
pub mod int_raw;
/**INT_ST (r) register accessor: GPIOSD interrupt masked register
...
pub mod int_st;
/**INT_ENA (rw) register accessor: GPIOSD interrupt enable register
...
pub mod int_ena;
/**INT_CLR (w) register accessor: GPIOSD interrupt clear register
