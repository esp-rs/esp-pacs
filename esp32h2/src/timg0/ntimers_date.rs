...
pub type NTIMGS_DATE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 28, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ntimgs_date(&mut self) -> NTIMGS_DATE_W<NTIMERS_DATE_SPEC, 0> {
...
#[doc = "`reset()` method sets NTIMERS_DATE to value 0x0220_6072"]
impl crate::Resettable for NTIMERS_DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_6072;
}
