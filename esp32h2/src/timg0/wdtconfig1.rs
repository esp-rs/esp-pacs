///Register `WDTCONFIG1` reader
pub type R = crate::R<WDTCONFIG1_SPEC>;
///Register `WDTCONFIG1` writer
pub type W = crate::W<WDTCONFIG1_SPEC>;
///Field `WDT_DIVCNT_RST` writer - When set, WDT 's clock divider counter will be reset.
pub type WDT_DIVCNT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_CLK_PRESCALE` reader - MWDT clock prescaler value. MWDT clock period = 12.5 ns * TIMG_WDT_CLK_PRESCALE.
pub type WDT_CLK_PRESCALE_R = crate::FieldReader<u16>;
///Field `WDT_CLK_PRESCALE` writer - MWDT clock prescaler value. MWDT clock period = 12.5 ns * TIMG_WDT_CLK_PRESCALE.
pub type WDT_CLK_PRESCALE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 16:31 - MWDT clock prescaler value. MWDT clock period = 12.5 ns * TIMG_WDT_CLK_PRESCALE.
    #[inline(always)]
...
impl W {
    ///Bit 0 - When set, WDT 's clock divider counter will be reset.
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`wdtconfig1::R`](R) reader structure
impl crate::Readable for WDTCONFIG1_SPEC {}
///`write(|w| ..)` method takes [`wdtconfig1::W`](W) writer structure
