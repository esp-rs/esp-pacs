...
///Field `RTC_CALI_START_CYCLING` reader - 0: one-shot frequency calculation,1: periodic frequency calculation,
pub type RTC_CALI_START_CYCLING_R = crate::BitReader;
///Field `RTC_CALI_START_CYCLING` writer - 0: one-shot frequency calculation,1: periodic frequency calculation,
pub type RTC_CALI_START_CYCLING_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RTC_CALI_CLK_SEL` reader - 0:rtc slow clock. 1:clk_8m, 2:xtal_32k.
pub type RTC_CALI_CLK_SEL_R = crate::FieldReader;
///Field `RTC_CALI_CLK_SEL` writer - 0:rtc slow clock. 1:clk_8m, 2:xtal_32k.
pub type RTC_CALI_CLK_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `RTC_CALI_RDY` reader - indicate one-shot frequency calculation is done.
pub type RTC_CALI_RDY_R = crate::BitReader;
///Field `RTC_CALI_MAX` reader - Configure the time to calculate RTC slow clock's frequency.
pub type RTC_CALI_MAX_R = crate::FieldReader<u16>;
///Field `RTC_CALI_MAX` writer - Configure the time to calculate RTC slow clock's frequency.
pub type RTC_CALI_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `RTC_CALI_START` reader - Set this bit to start one-shot frequency calculation.
pub type RTC_CALI_START_R = crate::BitReader;
///Field `RTC_CALI_START` writer - Set this bit to start one-shot frequency calculation.
pub type RTC_CALI_START_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 12 - 0: one-shot frequency calculation,1: periodic frequency calculation,
    #[inline(always)]
    ...
    ///Bit 15 - indicate one-shot frequency calculation is done.
    #[inline(always)]
    pub fn rtc_cali_rdy(&self) -> RTC_CALI_RDY_R {
        RTC_CALI_RDY_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bits 16:30 - Configure the time to calculate RTC slow clock's frequency.
    #[inline(always)]
    pub fn rtc_cali_max(&self) -> RTC_CALI_MAX_R {
        RTC_CALI_MAX_R::new(((self.bits >> 16) & 0x7fff) as u16)
    }
    ///Bit 31 - Set this bit to start one-shot frequency calculation.
    #[inline(always)]
