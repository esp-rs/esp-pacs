...
#[doc = "Field `T_ALARM_HI` reader - Timer %s alarm trigger time-base counter value, high 22 bits."]
pub type T_ALARM_HI_R = crate::FieldReader<u32, u32>;
#[doc = "Field `T_ALARM_HI` writer - Timer %s alarm trigger time-base counter value, high 22 bits."]
pub type T_ALARM_HI_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, T0ALARMHI_SPEC, u32, u32, 22, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn t_alarm_hi(&mut self) -> T_ALARM_HI_W<0> {
        T_ALARM_HI_W::new(self)
    }
