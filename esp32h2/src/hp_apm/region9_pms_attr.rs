...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION9_PMS_ATTR")
            .field(
                "region9_r0_pms_x",
                &format_args!("{}", self.region9_r0_pms_x().bit()),
            )
            .field(
                "region9_r0_pms_w",
                &format_args!("{}", self.region9_r0_pms_w().bit()),
            )
            .field(
                "region9_r0_pms_r",
                &format_args!("{}", self.region9_r0_pms_r().bit()),
            )
            .field(
                "region9_r1_pms_x",
                &format_args!("{}", self.region9_r1_pms_x().bit()),
            )
            .field(
                "region9_r1_pms_w",
                &format_args!("{}", self.region9_r1_pms_w().bit()),
            )
            .field(
                "region9_r1_pms_r",
                &format_args!("{}", self.region9_r1_pms_r().bit()),
            )
            .field(
                "region9_r2_pms_x",
                &format_args!("{}", self.region9_r2_pms_x().bit()),
            )
            .field(
                "region9_r2_pms_w",
                &format_args!("{}", self.region9_r2_pms_w().bit()),
            )
            .field(
                "region9_r2_pms_r",
                &format_args!("{}", self.region9_r2_pms_r().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<REGION9_PMS_ATTR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region9_r0_pms_x(&mut self) -> REGION9_R0_PMS_X_W<REGION9_PMS_ATTR_SPEC> {
        REGION9_R0_PMS_X_W::new(self, 0)
    }
    #[doc = "Bit 1 - Region write authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r0_pms_w(&mut self) -> REGION9_R0_PMS_W_W<REGION9_PMS_ATTR_SPEC> {
        REGION9_R0_PMS_W_W::new(self, 1)
    }
    #[doc = "Bit 2 - Region read authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r0_pms_r(&mut self) -> REGION9_R0_PMS_R_W<REGION9_PMS_ATTR_SPEC> {
        REGION9_R0_PMS_R_W::new(self, 2)
    }
    #[doc = "Bit 4 - Region execute authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r1_pms_x(&mut self) -> REGION9_R1_PMS_X_W<REGION9_PMS_ATTR_SPEC> {
        REGION9_R1_PMS_X_W::new(self, 4)
    }
    #[doc = "Bit 5 - Region write authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r1_pms_w(&mut self) -> REGION9_R1_PMS_W_W<REGION9_PMS_ATTR_SPEC> {
        REGION9_R1_PMS_W_W::new(self, 5)
    }
    #[doc = "Bit 6 - Region read authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r1_pms_r(&mut self) -> REGION9_R1_PMS_R_W<REGION9_PMS_ATTR_SPEC> {
        REGION9_R1_PMS_R_W::new(self, 6)
    }
    #[doc = "Bit 8 - Region execute authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r2_pms_x(&mut self) -> REGION9_R2_PMS_X_W<REGION9_PMS_ATTR_SPEC> {
        REGION9_R2_PMS_X_W::new(self, 8)
    }
    #[doc = "Bit 9 - Region write authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r2_pms_w(&mut self) -> REGION9_R2_PMS_W_W<REGION9_PMS_ATTR_SPEC> {
        REGION9_R2_PMS_W_W::new(self, 9)
    }
    #[doc = "Bit 10 - Region read authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r2_pms_r(&mut self) -> REGION9_R2_PMS_R_W<REGION9_PMS_ATTR_SPEC> {
...
#[doc = "Region access authority attribute register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`region9_pms_attr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`region9_pms_attr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
