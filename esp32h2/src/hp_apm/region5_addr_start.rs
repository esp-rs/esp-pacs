...
pub type REGION5_ADDR_START_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region5_addr_start(&mut self) -> REGION5_ADDR_START_W<REGION5_ADDR_START_SPEC, 0> {
