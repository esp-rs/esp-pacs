...
pub type REGION0_ADDR_END_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION0_ADDR_END")
            .field(
                "region0_addr_end",
                &format_args!("{}", self.region0_addr_end().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<REGION0_ADDR_END_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region0_addr_end(&mut self) -> REGION0_ADDR_END_W<REGION0_ADDR_END_SPEC, 0> {
...
#[doc = "Region address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`region0_addr_end::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`region0_addr_end::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
