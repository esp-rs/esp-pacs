///Register `ADDR_START` reader
pub type R = crate::R<ADDR_START_SPEC>;
///Register `ADDR_START` writer
pub type W = crate::W<ADDR_START_SPEC>;
///Field `ADDR_START` reader - Start address of region0
pub type ADDR_START_R = crate::FieldReader<u32>;
///Field `ADDR_START` writer - Start address of region0
pub type ADDR_START_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Start address of region0
    #[inline(always)]
...
///`read()` method returns [`addr_start::R`](R) reader structure
impl crate::Readable for ADDR_START_SPEC {}
///`write(|w| ..)` method takes [`addr_start::W`](W) writer structure
