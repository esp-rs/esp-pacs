...
pub type REGION11_ADDR_START_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region11_addr_start(&mut self) -> REGION11_ADDR_START_W<REGION11_ADDR_START_SPEC, 0> {
