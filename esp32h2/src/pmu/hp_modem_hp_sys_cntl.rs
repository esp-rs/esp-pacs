///Register `HP_MODEM_HP_SYS_CNTL` reader
...
///Field `HP_MODEM_UART_WAKEUP_EN` reader - need_des
...
///Field `HP_MODEM_LP_PAD_HOLD_ALL` reader - need_des
...
///Field `HP_MODEM_HP_PAD_HOLD_ALL` reader - need_des
...
///Field `HP_MODEM_DIG_PAD_SLP_SEL` reader - need_des
...
///Field `HP_MODEM_DIG_PAUSE_WDT` reader - need_des
...
///Field `HP_MODEM_DIG_CPU_STALL` reader - need_des
...
///`read()` method returns [`hp_modem_hp_sys_cntl::R`](R) reader structure
