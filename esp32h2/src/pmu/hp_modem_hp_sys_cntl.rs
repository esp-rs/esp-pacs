...
pub struct R(crate::R<HP_MODEM_HP_SYS_CNTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HP_MODEM_HP_SYS_CNTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HP_MODEM_HP_SYS_CNTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HP_MODEM_HP_SYS_CNTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HP_MODEM_HP_SYS_CNTL` writer"]
pub struct W(crate::W<HP_MODEM_HP_SYS_CNTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HP_MODEM_HP_SYS_CNTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HP_MODEM_HP_SYS_CNTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HP_MODEM_HP_SYS_CNTL_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_uart_wakeup_en(&mut self) -> HP_MODEM_UART_WAKEUP_EN_W<24> {
        HP_MODEM_UART_WAKEUP_EN_W::new(self)
    }
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_lp_pad_hold_all(&mut self) -> HP_MODEM_LP_PAD_HOLD_ALL_W<25> {
        HP_MODEM_LP_PAD_HOLD_ALL_W::new(self)
    }
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_hp_pad_hold_all(&mut self) -> HP_MODEM_HP_PAD_HOLD_ALL_W<26> {
        HP_MODEM_HP_PAD_HOLD_ALL_W::new(self)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_dig_pad_slp_sel(&mut self) -> HP_MODEM_DIG_PAD_SLP_SEL_W<27> {
        HP_MODEM_DIG_PAD_SLP_SEL_W::new(self)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_dig_pause_wdt(&mut self) -> HP_MODEM_DIG_PAUSE_WDT_W<28> {
        HP_MODEM_DIG_PAUSE_WDT_W::new(self)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_dig_cpu_stall(&mut self) -> HP_MODEM_DIG_CPU_STALL_W<29> {
...
#[doc = "need_des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hp_modem_hp_sys_cntl](index.html) module"]
