...
pub struct R(crate::R<HP_MODEM_BACKUP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HP_MODEM_BACKUP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HP_MODEM_BACKUP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HP_MODEM_BACKUP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HP_MODEM_BACKUP` writer"]
pub struct W(crate::W<HP_MODEM_BACKUP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HP_MODEM_BACKUP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HP_MODEM_BACKUP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HP_MODEM_BACKUP_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    pub fn hp_sleep2modem_backup_modem_clk_code(
        &mut self,
    ) -> HP_SLEEP2MODEM_BACKUP_MODEM_CLK_CODE_W<4> {
        HP_SLEEP2MODEM_BACKUP_MODEM_CLK_CODE_W::new(self)
    }
    #[doc = "Bit 10 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_retention_mode(&mut self) -> HP_MODEM_RETENTION_MODE_W<10> {
        HP_MODEM_RETENTION_MODE_W::new(self)
    }
    #[doc = "Bit 11 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep2modem_retention_en(&mut self) -> HP_SLEEP2MODEM_RETENTION_EN_W<11> {
        HP_SLEEP2MODEM_RETENTION_EN_W::new(self)
    }
    #[doc = "Bits 14:15 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep2modem_backup_clk_sel(&mut self) -> HP_SLEEP2MODEM_BACKUP_CLK_SEL_W<14> {
        HP_SLEEP2MODEM_BACKUP_CLK_SEL_W::new(self)
    }
    #[doc = "Bits 20:22 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep2modem_backup_mode(&mut self) -> HP_SLEEP2MODEM_BACKUP_MODE_W<20> {
        HP_SLEEP2MODEM_BACKUP_MODE_W::new(self)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep2modem_backup_en(&mut self) -> HP_SLEEP2MODEM_BACKUP_EN_W<29> {
...
#[doc = "need_des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hp_modem_backup](index.html) module"]
