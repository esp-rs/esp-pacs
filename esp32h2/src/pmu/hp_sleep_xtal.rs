///Register `HP_SLEEP_XTAL` reader
pub type R = crate::R<HP_SLEEP_XTAL_SPEC>;
///Register `HP_SLEEP_XTAL` writer
pub type W = crate::W<HP_SLEEP_XTAL_SPEC>;
///Field `HP_SLEEP_XPD_XTAL` reader - need_des
pub type HP_SLEEP_XPD_XTAL_R = crate::BitReader;
///Field `HP_SLEEP_XPD_XTAL` writer - need_des
...
///`read()` method returns [`hp_sleep_xtal::R`](R) reader structure
impl crate::Readable for HP_SLEEP_XTAL_SPEC {}
///`write(|w| ..)` method takes [`hp_sleep_xtal::W`](W) writer structure
