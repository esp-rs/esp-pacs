///Register `HP_SLEEP_HP_REGULATOR1` reader
pub type R = crate::R<HP_SLEEP_HP_REGULATOR1_SPEC>;
///Register `HP_SLEEP_HP_REGULATOR1` writer
pub type W = crate::W<HP_SLEEP_HP_REGULATOR1_SPEC>;
///Field `HP_SLEEP_HP_REGULATOR_DRV_B` reader - need_des
pub type HP_SLEEP_HP_REGULATOR_DRV_B_R = crate::FieldReader<u32>;
///Field `HP_SLEEP_HP_REGULATOR_DRV_B` writer - need_des
...
///`read()` method returns [`hp_sleep_hp_regulator1::R`](R) reader structure
impl crate::Readable for HP_SLEEP_HP_REGULATOR1_SPEC {}
///`write(|w| ..)` method takes [`hp_sleep_hp_regulator1::W`](W) writer structure
