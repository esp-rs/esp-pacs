...
pub type HP_MODEM_XPD_TRX_R = crate::BitReader<bool>;
#[doc = "Field `HP_MODEM_XPD_TRX` writer - need_des"]
pub type HP_MODEM_XPD_TRX_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_MODEM_BIAS_SPEC, bool, O>;
#[doc = "Field `HP_MODEM_XPD_BIAS` reader - need_des"]
pub type HP_MODEM_XPD_BIAS_R = crate::BitReader<bool>;
#[doc = "Field `HP_MODEM_XPD_BIAS` writer - need_des"]
pub type HP_MODEM_XPD_BIAS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_MODEM_BIAS_SPEC, bool, O>;
#[doc = "Field `HP_MODEM_PD_CUR` reader - need_des"]
pub type HP_MODEM_PD_CUR_R = crate::BitReader<bool>;
#[doc = "Field `HP_MODEM_PD_CUR` writer - need_des"]
pub type HP_MODEM_PD_CUR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_MODEM_BIAS_SPEC, bool, O>;
#[doc = "Field `SLEEP` reader - need_des"]
pub type SLEEP_R = crate::BitReader<bool>;
#[doc = "Field `SLEEP` writer - need_des"]
pub type SLEEP_W<'a, const O: u8> = crate::BitWriter<'a, u32, HP_MODEM_BIAS_SPEC, bool, O>;
impl R {
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_xpd_trx(&mut self) -> HP_MODEM_XPD_TRX_W<24> {
        HP_MODEM_XPD_TRX_W::new(self)
    }
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
    #[must_use]
