...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("POWER_PD_TOP_CNTL")
            ...
            .field("pd_top_pd_mask", &self.pd_top_pd_mask())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`power_pd_top_cntl::R`](R) reader structure
impl crate::Readable for POWER_PD_TOP_CNTL_SPEC {}
///`write(|w| ..)` method takes [`power_pd_top_cntl::W`](W) writer structure
