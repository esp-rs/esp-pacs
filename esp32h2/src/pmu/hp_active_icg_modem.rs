...
pub struct R(crate::R<HP_ACTIVE_ICG_MODEM_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HP_ACTIVE_ICG_MODEM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HP_ACTIVE_ICG_MODEM_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HP_ACTIVE_ICG_MODEM_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HP_ACTIVE_ICG_MODEM` writer"]
pub struct W(crate::W<HP_ACTIVE_ICG_MODEM_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HP_ACTIVE_ICG_MODEM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HP_ACTIVE_ICG_MODEM_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HP_ACTIVE_ICG_MODEM_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_active_dig_icg_modem_code(&mut self) -> HP_ACTIVE_DIG_ICG_MODEM_CODE_W<30> {
...
#[doc = "need_des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hp_active_icg_modem](index.html) module"]
