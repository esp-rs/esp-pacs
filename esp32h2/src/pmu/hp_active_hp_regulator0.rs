...
impl W {
    ...
    pub fn hp_active_hp_power_det_bypass(
        &mut self,
    ) -> HP_ACTIVE_HP_POWER_DET_BYPASS_W<HP_ACTIVE_HP_REGULATOR0_SPEC> {
        HP_ACTIVE_HP_POWER_DET_BYPASS_W::new(self, 0)
    }
    ///Bit 14 - need_des
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`hp_active_hp_regulator0::R`](R) reader structure
impl crate::Readable for HP_ACTIVE_HP_REGULATOR0_SPEC {}
///`write(|w| ..)` method takes [`hp_active_hp_regulator0::W`](W) writer structure
...
impl crate::Resettable for HP_ACTIVE_HP_REGULATOR0_SPEC {
    const RESET_VALUE: u32 = 0x8447_6110;
}
