...
pub type FORCE_HP_CPU_RESET_W<'a, const O: u8> = crate::BitWriter<'a, POWER_PD_HPCPU_CNTL_SPEC, O>;
...
pub type FORCE_HP_CPU_ISO_W<'a, const O: u8> = crate::BitWriter<'a, POWER_PD_HPCPU_CNTL_SPEC, O>;
...
pub type FORCE_HP_CPU_PU_W<'a, const O: u8> = crate::BitWriter<'a, POWER_PD_HPCPU_CNTL_SPEC, O>;
...
pub type FORCE_HP_CPU_NO_RESET_W<'a, const O: u8> =
    crate::BitWriter<'a, POWER_PD_HPCPU_CNTL_SPEC, O>;
...
pub type FORCE_HP_CPU_NO_ISO_W<'a, const O: u8> = crate::BitWriter<'a, POWER_PD_HPCPU_CNTL_SPEC, O>;
...
pub type FORCE_HP_CPU_PD_W<'a, const O: u8> = crate::BitWriter<'a, POWER_PD_HPCPU_CNTL_SPEC, O>;
...
pub type PD_HP_CPU_MASK_W<'a, const O: u8> = crate::FieldWriter<'a, POWER_PD_HPCPU_CNTL_SPEC, 5, O>;
...
pub type PD_HP_CPU_PD_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, POWER_PD_HPCPU_CNTL_SPEC, 5, O>;
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
