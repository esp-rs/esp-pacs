...
pub type HP_MODEM_DIG_SYS_CLK_NO_DIV_W<'a, const O: u8> =
    crate::BitWriter<'a, HP_MODEM_SYSCLK_SPEC, O>;
...
pub type HP_MODEM_ICG_SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, HP_MODEM_SYSCLK_SPEC, O>;
...
pub type HP_MODEM_DIG_SYS_CLK_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, HP_MODEM_SYSCLK_SPEC, 2, O>;
impl R {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
