...
pub type HP_MODEM_DIG_SYS_CLK_NO_DIV_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_ICG_SYS_CLOCK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_SYS_CLK_SLP_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_ICG_SLP_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_DIG_SYS_CLK_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_modem_dig_sys_clk_no_div(
        &mut self,
    ) -> HP_MODEM_DIG_SYS_CLK_NO_DIV_W<HP_MODEM_SYSCLK_SPEC, 26> {
    ...
    pub fn hp_modem_icg_sys_clock_en(
        &mut self,
    ) -> HP_MODEM_ICG_SYS_CLOCK_EN_W<HP_MODEM_SYSCLK_SPEC, 27> {
    ...
    pub fn hp_modem_sys_clk_slp_sel(
        &mut self,
    ) -> HP_MODEM_SYS_CLK_SLP_SEL_W<HP_MODEM_SYSCLK_SPEC, 28> {
        HP_MODEM_SYS_CLK_SLP_SEL_W::new(self)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_icg_slp_sel(&mut self) -> HP_MODEM_ICG_SLP_SEL_W<HP_MODEM_SYSCLK_SPEC, 29> {
    ...
    pub fn hp_modem_dig_sys_clk_sel(
        &mut self,
    ) -> HP_MODEM_DIG_SYS_CLK_SEL_W<HP_MODEM_SYSCLK_SPEC, 30> {
