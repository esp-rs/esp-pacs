///Register `HP_SLEEP_HP_REGULATOR0` reader
pub type R = crate::R<HP_SLEEP_HP_REGULATOR0_SPEC>;
///Register `HP_SLEEP_HP_REGULATOR0` writer
...
impl W {
    ...
    pub fn hp_sleep_hp_power_det_bypass(
        &mut self,
    ) -> HP_SLEEP_HP_POWER_DET_BYPASS_W<HP_SLEEP_HP_REGULATOR0_SPEC> {
        HP_SLEEP_HP_POWER_DET_BYPASS_W::new(self, 0)
    }
    ///Bit 16 - need_des
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`hp_sleep_hp_regulator0::R`](R) reader structure
impl crate::Readable for HP_SLEEP_HP_REGULATOR0_SPEC {}
///`write(|w| ..)` method takes [`hp_sleep_hp_regulator0::W`](W) writer structure
