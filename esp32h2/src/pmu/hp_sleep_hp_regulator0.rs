...
pub type HP_SLEEP_HP_POWER_DET_BYPASS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_SLEEP_HP_REGULATOR_SLP_MEM_XPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_SLEEP_HP_REGULATOR_SLP_LOGIC_XPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_SLEEP_HP_REGULATOR_XPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_SLEEP_HP_REGULATOR_SLP_MEM_DBIAS_W<'a, REG, const O: u8> =
...
pub type HP_SLEEP_HP_REGULATOR_SLP_LOGIC_DBIAS_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 4, O>;
...
pub type HP_SLEEP_HP_REGULATOR_DBIAS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_sleep_hp_power_det_bypass(
        &mut self,
    ) -> HP_SLEEP_HP_POWER_DET_BYPASS_W<HP_SLEEP_HP_REGULATOR0_SPEC, 0> {
    ...
    pub fn hp_sleep_hp_regulator_slp_mem_xpd(
        &mut self,
    ) -> HP_SLEEP_HP_REGULATOR_SLP_MEM_XPD_W<HP_SLEEP_HP_REGULATOR0_SPEC, 16> {
    ...
    pub fn hp_sleep_hp_regulator_slp_logic_xpd(
        &mut self,
    ) -> HP_SLEEP_HP_REGULATOR_SLP_LOGIC_XPD_W<HP_SLEEP_HP_REGULATOR0_SPEC, 17> {
    ...
    pub fn hp_sleep_hp_regulator_xpd(
        &mut self,
    ) -> HP_SLEEP_HP_REGULATOR_XPD_W<HP_SLEEP_HP_REGULATOR0_SPEC, 18> {
    ...
    pub fn hp_sleep_hp_regulator_slp_mem_dbias(
        &mut self,
    ) -> HP_SLEEP_HP_REGULATOR_SLP_MEM_DBIAS_W<HP_SLEEP_HP_REGULATOR0_SPEC, 19> {
    ...
    pub fn hp_sleep_hp_regulator_slp_logic_dbias(
        &mut self,
    ) -> HP_SLEEP_HP_REGULATOR_SLP_LOGIC_DBIAS_W<HP_SLEEP_HP_REGULATOR0_SPEC, 23> {
