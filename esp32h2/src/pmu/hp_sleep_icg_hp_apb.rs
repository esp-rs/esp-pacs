///Register `HP_SLEEP_ICG_HP_APB` reader
pub type R = crate::R<HP_SLEEP_ICG_HP_APB_SPEC>;
///Register `HP_SLEEP_ICG_HP_APB` writer
pub type W = crate::W<HP_SLEEP_ICG_HP_APB_SPEC>;
///Field `HP_SLEEP_DIG_ICG_APB_EN` reader - need_des
pub type HP_SLEEP_DIG_ICG_APB_EN_R = crate::FieldReader<u32>;
///Field `HP_SLEEP_DIG_ICG_APB_EN` writer - need_des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_SLEEP_ICG_HP_APB")
            .field("hp_sleep_dig_icg_apb_en", &self.hp_sleep_dig_icg_apb_en())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`hp_sleep_icg_hp_apb::R`](R) reader structure
impl crate::Readable for HP_SLEEP_ICG_HP_APB_SPEC {}
///`write(|w| ..)` method takes [`hp_sleep_icg_hp_apb::W`](W) writer structure
