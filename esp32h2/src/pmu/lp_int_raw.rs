    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_INT_RAW")
            ...
            .field(
                ...
                &self.modem_switch_active_end().bit(),
            )
            .field(
            ...
            .field(
                ...
                &self.sleep_switch_modem_end().bit(),
            )
            .field(
                "modem_switch_sleep_end",
                &self.modem_switch_sleep_end().bit(),
            )
            .field(
            ...
            .field(
                ...
                &self.modem_switch_active_start().bit(),
            )
            .field(
            ...
            .field(
                ...
                &self.sleep_switch_modem_start().bit(),
            )
            .field(
                "modem_switch_sleep_start",
                &self.modem_switch_sleep_start().bit(),
            )
            .field(
