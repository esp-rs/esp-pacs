...
pub type FORCE_HP_WIFI_RESET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FORCE_HP_WIFI_ISO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FORCE_HP_WIFI_PU_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FORCE_HP_WIFI_NO_RESET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FORCE_HP_WIFI_NO_ISO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FORCE_HP_WIFI_PD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PD_HP_WIFI_MASK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type PD_HP_WIFI_PD_MASK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn force_hp_wifi_reset(&mut self) -> FORCE_HP_WIFI_RESET_W<POWER_PD_HPWIFI_CNTL_SPEC, 0> {
        FORCE_HP_WIFI_RESET_W::new(self)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn force_hp_wifi_iso(&mut self) -> FORCE_HP_WIFI_ISO_W<POWER_PD_HPWIFI_CNTL_SPEC, 1> {
        FORCE_HP_WIFI_ISO_W::new(self)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn force_hp_wifi_pu(&mut self) -> FORCE_HP_WIFI_PU_W<POWER_PD_HPWIFI_CNTL_SPEC, 2> {
    ...
    pub fn force_hp_wifi_no_reset(
        &mut self,
    ) -> FORCE_HP_WIFI_NO_RESET_W<POWER_PD_HPWIFI_CNTL_SPEC, 3> {
        FORCE_HP_WIFI_NO_RESET_W::new(self)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn force_hp_wifi_no_iso(&mut self) -> FORCE_HP_WIFI_NO_ISO_W<POWER_PD_HPWIFI_CNTL_SPEC, 4> {
        FORCE_HP_WIFI_NO_ISO_W::new(self)
    }
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn force_hp_wifi_pd(&mut self) -> FORCE_HP_WIFI_PD_W<POWER_PD_HPWIFI_CNTL_SPEC, 5> {
        FORCE_HP_WIFI_PD_W::new(self)
    }
    #[doc = "Bits 6:10 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn pd_hp_wifi_mask(&mut self) -> PD_HP_WIFI_MASK_W<POWER_PD_HPWIFI_CNTL_SPEC, 6> {
        PD_HP_WIFI_MASK_W::new(self)
    }
    #[doc = "Bits 27:31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn pd_hp_wifi_pd_mask(&mut self) -> PD_HP_WIFI_PD_MASK_W<POWER_PD_HPWIFI_CNTL_SPEC, 27> {
