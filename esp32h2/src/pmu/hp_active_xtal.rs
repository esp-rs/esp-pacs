///Register `HP_ACTIVE_XTAL` reader
pub type R = crate::R<HP_ACTIVE_XTAL_SPEC>;
///Register `HP_ACTIVE_XTAL` writer
pub type W = crate::W<HP_ACTIVE_XTAL_SPEC>;
///Field `HP_ACTIVE_XPD_XTAL` reader - need_des
pub type HP_ACTIVE_XPD_XTAL_R = crate::BitReader;
///Field `HP_ACTIVE_XPD_XTAL` writer - need_des
...
///`read()` method returns [`hp_active_xtal::R`](R) reader structure
impl crate::Readable for HP_ACTIVE_XTAL_SPEC {}
///`write(|w| ..)` method takes [`hp_active_xtal::W`](W) writer structure
