...
pub struct R(crate::R<HP_ACTIVE_XTAL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HP_ACTIVE_XTAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HP_ACTIVE_XTAL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HP_ACTIVE_XTAL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HP_ACTIVE_XTAL` writer"]
pub struct W(crate::W<HP_ACTIVE_XTAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HP_ACTIVE_XTAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HP_ACTIVE_XTAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HP_ACTIVE_XTAL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `HP_ACTIVE_XPD_XTAL` reader - need_des"]
pub type HP_ACTIVE_XPD_XTAL_R = crate::BitReader<bool>;
#[doc = "Field `HP_ACTIVE_XPD_XTAL` writer - need_des"]
pub type HP_ACTIVE_XPD_XTAL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_ACTIVE_XTAL_SPEC, bool, O>;
impl R {
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_active_xpd_xtal(&mut self) -> HP_ACTIVE_XPD_XTAL_W<31> {
...
#[doc = "need_des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hp_active_xtal](index.html) module"]
