...
///`read()` method returns [`power_wait_timer0::R`](R) reader structure
impl crate::Readable for POWER_WAIT_TIMER0_SPEC {}
///`write(|w| ..)` method takes [`power_wait_timer0::W`](W) writer structure
