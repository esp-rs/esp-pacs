...
///`read()` method returns [`power_vdd_spi_cntl::R`](R) reader structure
impl crate::Readable for POWER_VDD_SPI_CNTL_SPEC {}
///`write(|w| ..)` method takes [`power_vdd_spi_cntl::W`](W) writer structure
