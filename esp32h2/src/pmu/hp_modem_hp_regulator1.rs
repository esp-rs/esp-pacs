///Register `HP_MODEM_HP_REGULATOR1` reader
pub type R = crate::R<HP_MODEM_HP_REGULATOR1_SPEC>;
///Register `HP_MODEM_HP_REGULATOR1` writer
pub type W = crate::W<HP_MODEM_HP_REGULATOR1_SPEC>;
///Field `HP_MODEM_HP_REGULATOR_DRV_B` reader - need_des
...
///`read()` method returns [`hp_modem_hp_regulator1::R`](R) reader structure
impl crate::Readable for HP_MODEM_HP_REGULATOR1_SPEC {}
///`write(|w| ..)` method takes [`hp_modem_hp_regulator1::W`](W) writer structure
