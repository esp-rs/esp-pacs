...
pub type HP_ACTIVE_DIG_SYS_CLK_NO_DIV_R = crate::BitReader<bool>;
#[doc = "Field `HP_ACTIVE_DIG_SYS_CLK_NO_DIV` writer - need_des"]
pub type HP_ACTIVE_DIG_SYS_CLK_NO_DIV_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_ACTIVE_SYSCLK_SPEC, bool, O>;
#[doc = "Field `HP_ACTIVE_ICG_SYS_CLOCK_EN` reader - need_des"]
pub type HP_ACTIVE_ICG_SYS_CLOCK_EN_R = crate::BitReader<bool>;
...
pub type HP_ACTIVE_SYS_CLK_SLP_SEL_R = crate::BitReader<bool>;
...
pub type HP_ACTIVE_ICG_SLP_SEL_R = crate::BitReader<bool>;
#[doc = "Field `HP_ACTIVE_ICG_SLP_SEL` writer - need_des"]
pub type HP_ACTIVE_ICG_SLP_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_ACTIVE_SYSCLK_SPEC, bool, O>;
#[doc = "Field `HP_ACTIVE_DIG_SYS_CLK_SEL` reader - need_des"]
pub type HP_ACTIVE_DIG_SYS_CLK_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `HP_ACTIVE_DIG_SYS_CLK_SEL` writer - need_des"]
pub type HP_ACTIVE_DIG_SYS_CLK_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HP_ACTIVE_SYSCLK_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
