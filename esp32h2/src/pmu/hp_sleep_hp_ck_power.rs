...
///`read()` method returns [`hp_sleep_hp_ck_power::R`](R) reader structure
impl crate::Readable for HP_SLEEP_HP_CK_POWER_SPEC {}
///`write(|w| ..)` method takes [`hp_sleep_hp_ck_power::W`](W) writer structure
