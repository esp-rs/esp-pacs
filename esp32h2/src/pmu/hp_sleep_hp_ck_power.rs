...
pub struct R(crate::R<HP_SLEEP_HP_CK_POWER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HP_SLEEP_HP_CK_POWER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HP_SLEEP_HP_CK_POWER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HP_SLEEP_HP_CK_POWER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HP_SLEEP_HP_CK_POWER` writer"]
pub struct W(crate::W<HP_SLEEP_HP_CK_POWER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HP_SLEEP_HP_CK_POWER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HP_SLEEP_HP_CK_POWER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HP_SLEEP_HP_CK_POWER_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `HP_SLEEP_I2C_ISO_EN` reader - need_des"]
pub type HP_SLEEP_I2C_ISO_EN_R = crate::BitReader<bool>;
#[doc = "Field `HP_SLEEP_I2C_ISO_EN` writer - need_des"]
pub type HP_SLEEP_I2C_ISO_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_SLEEP_HP_CK_POWER_SPEC, bool, O>;
#[doc = "Field `HP_SLEEP_I2C_RETENTION` reader - need_des"]
pub type HP_SLEEP_I2C_RETENTION_R = crate::BitReader<bool>;
#[doc = "Field `HP_SLEEP_I2C_RETENTION` writer - need_des"]
pub type HP_SLEEP_I2C_RETENTION_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_SLEEP_HP_CK_POWER_SPEC, bool, O>;
#[doc = "Field `HP_SLEEP_XPD_BB_I2C` reader - need_des"]
pub type HP_SLEEP_XPD_BB_I2C_R = crate::BitReader<bool>;
#[doc = "Field `HP_SLEEP_XPD_BB_I2C` writer - need_des"]
pub type HP_SLEEP_XPD_BB_I2C_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_SLEEP_HP_CK_POWER_SPEC, bool, O>;
#[doc = "Field `HP_SLEEP_XPD_BBPLL_I2C` reader - need_des"]
pub type HP_SLEEP_XPD_BBPLL_I2C_R = crate::BitReader<bool>;
#[doc = "Field `HP_SLEEP_XPD_BBPLL_I2C` writer - need_des"]
pub type HP_SLEEP_XPD_BBPLL_I2C_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_SLEEP_HP_CK_POWER_SPEC, bool, O>;
#[doc = "Field `HP_SLEEP_XPD_BBPLL` reader - need_des"]
pub type HP_SLEEP_XPD_BBPLL_R = crate::BitReader<bool>;
#[doc = "Field `HP_SLEEP_XPD_BBPLL` writer - need_des"]
pub type HP_SLEEP_XPD_BBPLL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_SLEEP_HP_CK_POWER_SPEC, bool, O>;
impl R {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_i2c_iso_en(&mut self) -> HP_SLEEP_I2C_ISO_EN_W<26> {
        HP_SLEEP_I2C_ISO_EN_W::new(self)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_i2c_retention(&mut self) -> HP_SLEEP_I2C_RETENTION_W<27> {
        HP_SLEEP_I2C_RETENTION_W::new(self)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_xpd_bb_i2c(&mut self) -> HP_SLEEP_XPD_BB_I2C_W<28> {
        HP_SLEEP_XPD_BB_I2C_W::new(self)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_xpd_bbpll_i2c(&mut self) -> HP_SLEEP_XPD_BBPLL_I2C_W<29> {
        HP_SLEEP_XPD_BBPLL_I2C_W::new(self)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_xpd_bbpll(&mut self) -> HP_SLEEP_XPD_BBPLL_W<30> {
...
#[doc = "need_des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hp_sleep_hp_ck_power](index.html) module"]
