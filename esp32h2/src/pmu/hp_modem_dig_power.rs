...
pub type HP_MODEM_VDD_SPI_PD_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_HP_MEM_DSLP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_PD_HP_MEM_PD_EN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type HP_MODEM_PD_HP_WIFI_PD_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_PD_HP_CPU_PD_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_PD_HP_AON_PD_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_PD_TOP_PD_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 21 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_modem_vdd_spi_pd_en(
        &mut self,
    ) -> HP_MODEM_VDD_SPI_PD_EN_W<HP_MODEM_DIG_POWER_SPEC, 21> {
        HP_MODEM_VDD_SPI_PD_EN_W::new(self)
    }
    #[doc = "Bit 22 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_hp_mem_dslp(&mut self) -> HP_MODEM_HP_MEM_DSLP_W<HP_MODEM_DIG_POWER_SPEC, 22> {
        HP_MODEM_HP_MEM_DSLP_W::new(self)
    }
    #[doc = "Bits 23:26 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_hp_mem_pd_en(
        &mut self,
    ) -> HP_MODEM_PD_HP_MEM_PD_EN_W<HP_MODEM_DIG_POWER_SPEC, 23> {
        HP_MODEM_PD_HP_MEM_PD_EN_W::new(self)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_hp_wifi_pd_en(
        &mut self,
    ) -> HP_MODEM_PD_HP_WIFI_PD_EN_W<HP_MODEM_DIG_POWER_SPEC, 27> {
        HP_MODEM_PD_HP_WIFI_PD_EN_W::new(self)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_hp_cpu_pd_en(
        &mut self,
    ) -> HP_MODEM_PD_HP_CPU_PD_EN_W<HP_MODEM_DIG_POWER_SPEC, 29> {
        HP_MODEM_PD_HP_CPU_PD_EN_W::new(self)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_hp_aon_pd_en(
        &mut self,
    ) -> HP_MODEM_PD_HP_AON_PD_EN_W<HP_MODEM_DIG_POWER_SPEC, 30> {
        HP_MODEM_PD_HP_AON_PD_EN_W::new(self)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_top_pd_en(
        &mut self,
    ) -> HP_MODEM_PD_TOP_PD_EN_W<HP_MODEM_DIG_POWER_SPEC, 31> {
        HP_MODEM_PD_TOP_PD_EN_W::new(self)
    }
