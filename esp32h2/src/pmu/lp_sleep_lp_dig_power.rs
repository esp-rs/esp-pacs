...
pub type LP_SLEEP_BOD_SOURCE_SEL_R = crate::BitReader<bool>;
...
pub type LP_SLEEP_VDDBAT_MODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LP_SLEEP_VDDBAT_MODE` writer - need_des"]
pub type LP_SLEEP_VDDBAT_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LP_SLEEP_LP_DIG_POWER_SPEC, u8, u8, 2, O>;
