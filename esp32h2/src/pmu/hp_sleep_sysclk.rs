...
pub struct R(crate::R<HP_SLEEP_SYSCLK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HP_SLEEP_SYSCLK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HP_SLEEP_SYSCLK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HP_SLEEP_SYSCLK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HP_SLEEP_SYSCLK` writer"]
pub struct W(crate::W<HP_SLEEP_SYSCLK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HP_SLEEP_SYSCLK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HP_SLEEP_SYSCLK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HP_SLEEP_SYSCLK_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_dig_sys_clk_no_div(&mut self) -> HP_SLEEP_DIG_SYS_CLK_NO_DIV_W<26> {
        HP_SLEEP_DIG_SYS_CLK_NO_DIV_W::new(self)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_icg_sys_clock_en(&mut self) -> HP_SLEEP_ICG_SYS_CLOCK_EN_W<27> {
        HP_SLEEP_ICG_SYS_CLOCK_EN_W::new(self)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_sys_clk_slp_sel(&mut self) -> HP_SLEEP_SYS_CLK_SLP_SEL_W<28> {
        HP_SLEEP_SYS_CLK_SLP_SEL_W::new(self)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_icg_slp_sel(&mut self) -> HP_SLEEP_ICG_SLP_SEL_W<29> {
        HP_SLEEP_ICG_SLP_SEL_W::new(self)
    }
    #[doc = "Bits 30:31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_dig_sys_clk_sel(&mut self) -> HP_SLEEP_DIG_SYS_CLK_SEL_W<30> {
...
#[doc = "need_des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hp_sleep_sysclk](index.html) module"]
