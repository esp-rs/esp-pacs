...
pub struct R(crate::R<POWER_PD_HPAON_CNTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<POWER_PD_HPAON_CNTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<POWER_PD_HPAON_CNTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<POWER_PD_HPAON_CNTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `POWER_PD_HPAON_CNTL` writer"]
pub struct W(crate::W<POWER_PD_HPAON_CNTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<POWER_PD_HPAON_CNTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<POWER_PD_HPAON_CNTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<POWER_PD_HPAON_CNTL_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn force_hp_aon_reset(&mut self) -> FORCE_HP_AON_RESET_W<0> {
        FORCE_HP_AON_RESET_W::new(self)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn force_hp_aon_iso(&mut self) -> FORCE_HP_AON_ISO_W<1> {
        FORCE_HP_AON_ISO_W::new(self)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn force_hp_aon_pu(&mut self) -> FORCE_HP_AON_PU_W<2> {
        FORCE_HP_AON_PU_W::new(self)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn force_hp_aon_no_reset(&mut self) -> FORCE_HP_AON_NO_RESET_W<3> {
        FORCE_HP_AON_NO_RESET_W::new(self)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn force_hp_aon_no_iso(&mut self) -> FORCE_HP_AON_NO_ISO_W<4> {
        FORCE_HP_AON_NO_ISO_W::new(self)
    }
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn force_hp_aon_pd(&mut self) -> FORCE_HP_AON_PD_W<5> {
        FORCE_HP_AON_PD_W::new(self)
    }
    #[doc = "Bits 6:10 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn pd_hp_aon_mask(&mut self) -> PD_HP_AON_MASK_W<6> {
        PD_HP_AON_MASK_W::new(self)
    }
    #[doc = "Bits 27:31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn pd_hp_aon_pd_mask(&mut self) -> PD_HP_AON_PD_MASK_W<27> {
...
#[doc = "need_des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [power_pd_hpaon_cntl](index.html) module"]
