...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_xpd_lppll(&mut self) -> HP_SLEEP_XPD_LPPLL_W<HP_SLEEP_LP_CK_POWER_SPEC> {
...
///`read()` method returns [`hp_sleep_lp_ck_power::R`](R) reader structure
impl crate::Readable for HP_SLEEP_LP_CK_POWER_SPEC {}
///`write(|w| ..)` method takes [`hp_sleep_lp_ck_power::W`](W) writer structure
