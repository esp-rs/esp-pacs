...
pub type HP_SLEEP_XPD_LPPLL_R = crate::BitReader<bool>;
#[doc = "Field `HP_SLEEP_XPD_LPPLL` writer - need_des"]
pub type HP_SLEEP_XPD_LPPLL_W<'a, const O: u8> =
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_sleep_xpd_lppll(&mut self) -> HP_SLEEP_XPD_LPPLL_W<27> {
