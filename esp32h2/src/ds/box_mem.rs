...
pub struct R(crate::R<BOX_MEM_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BOX_MEM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BOX_MEM_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BOX_MEM_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BOX_MEM[%s]` writer"]
pub struct W(crate::W<BOX_MEM_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BOX_MEM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BOX_MEM_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BOX_MEM_SPEC>) -> Self {
        W(writer)
    }
}
