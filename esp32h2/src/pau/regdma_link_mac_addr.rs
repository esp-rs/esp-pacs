...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGDMA_LINK_MAC_ADDR")
            .field("link_addr_mac", &self.link_addr_mac())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`regdma_link_mac_addr::R`](R) reader structure
impl crate::Readable for REGDMA_LINK_MAC_ADDR_SPEC {}
///`write(|w| ..)` method takes [`regdma_link_mac_addr::W`](W) writer structure
