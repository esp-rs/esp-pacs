...
pub struct R(crate::R<REGDMA_LINK_MAC_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REGDMA_LINK_MAC_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REGDMA_LINK_MAC_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REGDMA_LINK_MAC_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REGDMA_LINK_MAC_ADDR` writer"]
pub struct W(crate::W<REGDMA_LINK_MAC_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REGDMA_LINK_MAC_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REGDMA_LINK_MAC_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REGDMA_LINK_MAC_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `LINK_ADDR_MAC` reader - Link_mac_addr reg"]
pub type LINK_ADDR_MAC_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LINK_ADDR_MAC` writer - Link_mac_addr reg"]
pub type LINK_ADDR_MAC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, REGDMA_LINK_MAC_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn link_addr_mac(&mut self) -> LINK_ADDR_MAC_W<0> {
...
#[doc = "Link_mac_addr\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [regdma_link_mac_addr](index.html) module"]
