...
pub mod tx_conf1;
/**RX_CLKM_CONF (rw) register accessor: I2S RX clock configure register
...
/**TX_CLKM_CONF (rw) register accessor: I2S TX clock configure register
...
/**RX_CLKM_DIV_CONF (rw) register accessor: I2S RX module clock divider configure register
...
/**TX_CLKM_DIV_CONF (rw) register accessor: I2S TX module clock divider configure register
