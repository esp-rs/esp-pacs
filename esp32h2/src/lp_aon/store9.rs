///Register `STORE9` reader
pub type R = crate::R<STORE9_SPEC>;
///Register `STORE9` writer
pub type W = crate::W<STORE9_SPEC>;
///Field `LP_AON_STORE9` reader - need_des
pub type LP_AON_STORE9_R = crate::FieldReader<u32>;
///Field `LP_AON_STORE9` writer - need_des
...
You can [`read`](crate::generic::Reg::read) this register and get [`store9::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`store9::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct STORE9_SPEC;
impl crate::RegisterSpec for STORE9_SPEC {
    type Ux = u32;
}
///`read()` method returns [`store9::R`](R) reader structure
impl crate::Readable for STORE9_SPEC {}
///`write(|w| ..)` method takes [`store9::W`](W) writer structure
