...
pub type LP_AON_STORE7_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LP_AON_STORE7` writer - need_des"]
pub type LP_AON_STORE7_W<'a, const O: u8> = crate::FieldWriter<'a, STORE7_SPEC, 32, O, u32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_aon_store7(&mut self) -> LP_AON_STORE7_W<0> {
        LP_AON_STORE7_W::new(self)
    }
