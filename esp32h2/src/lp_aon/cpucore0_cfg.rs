...
///`read()` method returns [`cpucore0_cfg::R`](R) reader structure
impl crate::Readable for CPUCORE0_CFG_SPEC {}
///`write(|w| ..)` method takes [`cpucore0_cfg::W`](W) writer structure
