...
pub type FAST_MEM_WPULSE_R = crate::FieldReader<u8, u8>;
...
pub type FAST_MEM_WPULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPBUS_SPEC, u8, u8, 3, O>;
...
pub type FAST_MEM_WA_R = crate::FieldReader<u8, u8>;
...
pub type FAST_MEM_WA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPBUS_SPEC, u8, u8, 3, O>;
...
pub type FAST_MEM_RA_R = crate::FieldReader<u8, u8>;
...
pub type FAST_MEM_RA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPBUS_SPEC, u8, u8, 2, O>;
...
pub type FAST_MEM_RM_R = crate::FieldReader<u8, u8>;
...
pub type FAST_MEM_RM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPBUS_SPEC, u8, u8, 4, O>;
#[doc = "Field `FAST_MEM_MUX_FSM_IDLE` reader - reserved"]
pub type FAST_MEM_MUX_FSM_IDLE_R = crate::BitReader<bool>;
#[doc = "Field `FAST_MEM_MUX_SEL_STATUS` reader - reserved"]
pub type FAST_MEM_MUX_SEL_STATUS_R = crate::BitReader<bool>;
#[doc = "Field `FAST_MEM_MUX_SEL_UPDATE` reader - reserved"]
pub type FAST_MEM_MUX_SEL_UPDATE_R = crate::BitReader<bool>;
#[doc = "Field `FAST_MEM_MUX_SEL` reader - reserved"]
pub type FAST_MEM_MUX_SEL_R = crate::BitReader<bool>;
impl R {
