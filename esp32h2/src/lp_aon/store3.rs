...
pub type LP_AON_STORE3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STORE3")
            .field(
                "lp_aon_store3",
                &format_args!("{}", self.lp_aon_store3().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_aon_store3(&mut self) -> LP_AON_STORE3_W<STORE3_SPEC, 0> {
