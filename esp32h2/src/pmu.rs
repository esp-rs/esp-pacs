...
/**HP_MODEM_ICG_HP_FUNC (rw) register accessor: need_des
...
/**HP_MODEM_ICG_MODEM (rw) register accessor: need_des
...
/**HP_MODEM_HP_SYS_CNTL (rw) register accessor: need_des
...
/**HP_MODEM_BACKUP (rw) register accessor: need_des
...
/**HP_MODEM_BACKUP_CLK (rw) register accessor: need_des
...
/**HP_MODEM_SYSCLK (rw) register accessor: need_des
...
/**HP_MODEM_HP_REGULATOR0 (rw) register accessor: need_des
...
///need_des
pub mod imm_lp_icg;
/**IMM_PAD_HOLD_ALL (w) register accessor: need_des
...
/**POWER_PD_HPAON_CNTL (rw) register accessor: need_des
...
/**POWER_PD_HPCPU_CNTL (rw) register accessor: need_des
...
/**POWER_PD_HPPERI_RESERVE (w) register accessor: need_des
...
/**POWER_PD_MEM_MASK (rw) register accessor: need_des
...
/**POWER_VDD_SPI_CNTL (rw) register accessor: need_des
...
///need_des
pub mod lp_cpu_pwr0;
/**LP_CPU_PWR1 (rw) register accessor: need_des
...
///need_des
pub mod clk_state2;
/**VDD_SPI_STATUS (r) register accessor: need_des
