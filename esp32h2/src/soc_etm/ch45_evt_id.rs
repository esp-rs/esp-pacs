...
pub struct R(crate::R<CH45_EVT_ID_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH45_EVT_ID_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH45_EVT_ID_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH45_EVT_ID_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH45_EVT_ID` writer"]
pub struct W(crate::W<CH45_EVT_ID_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH45_EVT_ID_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH45_EVT_ID_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH45_EVT_ID_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CH45_EVT_ID` reader - ch45_evt_id"]
pub type CH45_EVT_ID_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CH45_EVT_ID` writer - ch45_evt_id"]
pub type CH45_EVT_ID_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH45_EVT_ID_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch45_evt_id(&mut self) -> CH45_EVT_ID_W<0> {
        CH45_EVT_ID_W::new(self)
    }
