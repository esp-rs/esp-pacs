...
impl R {
    #[doc = "ch(0-31) enable"]
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `CH_ENA0` field"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH_ENA_AD0")
            .field("ch_ena0", &self.ch_ena0().bit())
            .field("ch_ena1", &self.ch_ena1().bit())
            .field("ch_ena2", &self.ch_ena2().bit())
            .field("ch_ena3", &self.ch_ena3().bit())
            .field("ch_ena4", &self.ch_ena4().bit())
            .field("ch_ena5", &self.ch_ena5().bit())
            .field("ch_ena6", &self.ch_ena6().bit())
            .field("ch_ena7", &self.ch_ena7().bit())
            .field("ch_ena8", &self.ch_ena8().bit())
            .field("ch_ena9", &self.ch_ena9().bit())
            .field("ch_ena10", &self.ch_ena10().bit())
            .field("ch_ena11", &self.ch_ena11().bit())
            .field("ch_ena12", &self.ch_ena12().bit())
            .field("ch_ena13", &self.ch_ena13().bit())
            .field("ch_ena14", &self.ch_ena14().bit())
            .field("ch_ena15", &self.ch_ena15().bit())
            .field("ch_ena16", &self.ch_ena16().bit())
            .field("ch_ena17", &self.ch_ena17().bit())
            .field("ch_ena18", &self.ch_ena18().bit())
            .field("ch_ena19", &self.ch_ena19().bit())
            .field("ch_ena20", &self.ch_ena20().bit())
            .field("ch_ena21", &self.ch_ena21().bit())
            .field("ch_ena22", &self.ch_ena22().bit())
            .field("ch_ena23", &self.ch_ena23().bit())
            .field("ch_ena24", &self.ch_ena24().bit())
            .field("ch_ena25", &self.ch_ena25().bit())
            .field("ch_ena26", &self.ch_ena26().bit())
            .field("ch_ena27", &self.ch_ena27().bit())
            .field("ch_ena28", &self.ch_ena28().bit())
            .field("ch_ena29", &self.ch_ena29().bit())
            .field("ch_ena30", &self.ch_ena30().bit())
            .field("ch_ena31", &self.ch_ena31().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
