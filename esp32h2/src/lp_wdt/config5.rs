...
///`read()` method returns [`config5::R`](R) reader structure
impl crate::Readable for CONFIG5_SPEC {}
///`write(|w| ..)` method takes [`config5::W`](W) writer structure
