///Register `COEX_INTR_MAP` reader
pub type R = crate::R<COEX_INTR_MAP_SPEC>;
///Register `COEX_INTR_MAP` writer
pub type W = crate::W<COEX_INTR_MAP_SPEC>;
///Field `COEX_INTR_MAP` reader - CORE0_COEX_INTR mapping register
pub type COEX_INTR_MAP_R = crate::FieldReader;
///Field `COEX_INTR_MAP` writer - CORE0_COEX_INTR mapping register
pub type COEX_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_COEX_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`coex_intr_map::R`](R) reader structure
impl crate::Readable for COEX_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`coex_intr_map::W`](W) writer structure
