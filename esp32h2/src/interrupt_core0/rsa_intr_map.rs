///Register `RSA_INTR_MAP` reader
pub type R = crate::R<RSA_INTR_MAP_SPEC>;
///Register `RSA_INTR_MAP` writer
pub type W = crate::W<RSA_INTR_MAP_SPEC>;
///Field `RSA_INTR_MAP` reader - CORE0_RSA_INTR mapping register
pub type RSA_INTR_MAP_R = crate::FieldReader;
///Field `RSA_INTR_MAP` writer - CORE0_RSA_INTR mapping register
pub type RSA_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_RSA_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`rsa_intr_map::R`](R) reader structure
impl crate::Readable for RSA_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`rsa_intr_map::W`](W) writer structure
