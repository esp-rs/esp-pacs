///Register `SYSTIMER_TARGET2_INTR_MAP` reader
pub type R = crate::R<SYSTIMER_TARGET2_INTR_MAP_SPEC>;
///Register `SYSTIMER_TARGET2_INTR_MAP` writer
pub type W = crate::W<SYSTIMER_TARGET2_INTR_MAP_SPEC>;
///Field `SYSTIMER_TARGET2_INTR_MAP` reader - CORE0_SYSTIMER_TARGET2_INTR mapping register
pub type SYSTIMER_TARGET2_INTR_MAP_R = crate::FieldReader;
///Field `SYSTIMER_TARGET2_INTR_MAP` writer - CORE0_SYSTIMER_TARGET2_INTR mapping register
pub type SYSTIMER_TARGET2_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_SYSTIMER_TARGET2_INTR mapping register
    #[inline(always)]
    pub fn systimer_target2_intr_map(&self) -> SYSTIMER_TARGET2_INTR_MAP_R {
        SYSTIMER_TARGET2_INTR_MAP_R::new((self.bits & 0x1f) as u8)
    }
}
...
///`read()` method returns [`systimer_target2_intr_map::R`](R) reader structure
impl crate::Readable for SYSTIMER_TARGET2_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`systimer_target2_intr_map::W`](W) writer structure
