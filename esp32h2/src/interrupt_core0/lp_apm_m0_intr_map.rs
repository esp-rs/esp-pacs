///Register `LP_APM_M0_INTR_MAP` reader
pub type R = crate::R<LP_APM_M0_INTR_MAP_SPEC>;
///Register `LP_APM_M0_INTR_MAP` writer
pub type W = crate::W<LP_APM_M0_INTR_MAP_SPEC>;
///Field `LP_APM_M0_INTR_MAP` reader - CORE0_LP_APM_M0_INTR mapping register
pub type LP_APM_M0_INTR_MAP_R = crate::FieldReader;
///Field `LP_APM_M0_INTR_MAP` writer - CORE0_LP_APM_M0_INTR mapping register
pub type LP_APM_M0_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_LP_APM_M0_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`lp_apm_m0_intr_map::R`](R) reader structure
impl crate::Readable for LP_APM_M0_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`lp_apm_m0_intr_map::W`](W) writer structure
