///Register `BT_MAC_INTR_MAP` reader
pub type R = crate::R<BT_MAC_INTR_MAP_SPEC>;
///Register `BT_MAC_INTR_MAP` writer
pub type W = crate::W<BT_MAC_INTR_MAP_SPEC>;
///Field `BT_MAC_INTR_MAP` reader - CORE0_BT_MAC_INTR mapping register
pub type BT_MAC_INTR_MAP_R = crate::FieldReader;
///Field `BT_MAC_INTR_MAP` writer - CORE0_BT_MAC_INTR mapping register
pub type BT_MAC_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_BT_MAC_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`bt_mac_intr_map::R`](R) reader structure
impl crate::Readable for BT_MAC_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`bt_mac_intr_map::W`](W) writer structure
