...
///Field `APB_ADC_INTR_MAP` reader - CORE0_APB_ADC_INTR mapping register
pub type APB_ADC_INTR_MAP_R = crate::FieldReader;
///Field `APB_ADC_INTR_MAP` writer - CORE0_APB_ADC_INTR mapping register
pub type APB_ADC_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_APB_ADC_INTR mapping register
    #[inline(always)]
