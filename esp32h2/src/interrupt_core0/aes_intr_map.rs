...
///Field `AES_INTR_MAP` reader - CORE0_AES_INTR mapping register
pub type AES_INTR_MAP_R = crate::FieldReader;
///Field `AES_INTR_MAP` writer - CORE0_AES_INTR mapping register
pub type AES_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_AES_INTR mapping register
    #[inline(always)]
