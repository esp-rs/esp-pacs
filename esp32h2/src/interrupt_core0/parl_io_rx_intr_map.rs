...
pub type PARL_IO_RX_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn parl_io_rx_intr_map(&mut self) -> PARL_IO_RX_INTR_MAP_W<PARL_IO_RX_INTR_MAP_SPEC, 0> {
