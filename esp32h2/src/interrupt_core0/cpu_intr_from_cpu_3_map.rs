...
///Field `CPU_INTR_FROM_CPU_3_MAP` reader - CORE0_CPU_INTR_FROM_CPU_3 mapping register
pub type CPU_INTR_FROM_CPU_3_MAP_R = crate::FieldReader;
///Field `CPU_INTR_FROM_CPU_3_MAP` writer - CORE0_CPU_INTR_FROM_CPU_3 mapping register
pub type CPU_INTR_FROM_CPU_3_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_CPU_INTR_FROM_CPU_3 mapping register
    #[inline(always)]
