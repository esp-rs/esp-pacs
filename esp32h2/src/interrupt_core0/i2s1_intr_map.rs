///Register `I2S1_INTR_MAP` reader
pub type R = crate::R<I2S1_INTR_MAP_SPEC>;
///Register `I2S1_INTR_MAP` writer
pub type W = crate::W<I2S1_INTR_MAP_SPEC>;
///Field `I2S1_INTR_MAP` reader - CORE0_I2S1_INTR mapping register
pub type I2S1_INTR_MAP_R = crate::FieldReader;
///Field `I2S1_INTR_MAP` writer - CORE0_I2S1_INTR mapping register
pub type I2S1_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_I2S1_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`i2s1_intr_map::R`](R) reader structure
impl crate::Readable for I2S1_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`i2s1_intr_map::W`](W) writer structure
