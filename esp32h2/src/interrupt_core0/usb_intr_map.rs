...
///Field `USB_INTR_MAP` reader - CORE0_USB_INTR mapping register
pub type USB_INTR_MAP_R = crate::FieldReader;
///Field `USB_INTR_MAP` writer - CORE0_USB_INTR mapping register
pub type USB_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_USB_INTR mapping register
    #[inline(always)]
