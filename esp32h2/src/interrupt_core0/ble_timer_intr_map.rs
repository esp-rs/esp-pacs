...
///Field `BLE_TIMER_INTR_MAP` reader - CORE0_BLE_TIMER_INTR mapping register
pub type BLE_TIMER_INTR_MAP_R = crate::FieldReader;
///Field `BLE_TIMER_INTR_MAP` writer - CORE0_BLE_TIMER_INTR mapping register
pub type BLE_TIMER_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_BLE_TIMER_INTR mapping register
    #[inline(always)]
