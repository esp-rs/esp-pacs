...
///Field `I2C_EXT1_INTR_MAP` reader - CORE0_I2C_EXT1_INTR mapping register
pub type I2C_EXT1_INTR_MAP_R = crate::FieldReader;
///Field `I2C_EXT1_INTR_MAP` writer - CORE0_I2C_EXT1_INTR mapping register
pub type I2C_EXT1_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_I2C_EXT1_INTR mapping register
    #[inline(always)]
