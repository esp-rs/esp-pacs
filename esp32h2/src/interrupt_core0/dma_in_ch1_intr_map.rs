...
///Field `DMA_IN_CH1_INTR_MAP` reader - CORE0_DMA_IN_CH1_INTR mapping register
pub type DMA_IN_CH1_INTR_MAP_R = crate::FieldReader;
///Field `DMA_IN_CH1_INTR_MAP` writer - CORE0_DMA_IN_CH1_INTR mapping register
pub type DMA_IN_CH1_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_DMA_IN_CH1_INTR mapping register
    #[inline(always)]
