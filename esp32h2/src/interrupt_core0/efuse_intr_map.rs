...
///Field `EFUSE_INTR_MAP` reader - CORE0_EFUSE_INTR mapping register
pub type EFUSE_INTR_MAP_R = crate::FieldReader;
///Field `EFUSE_INTR_MAP` writer - CORE0_EFUSE_INTR mapping register
pub type EFUSE_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_EFUSE_INTR mapping register
    #[inline(always)]
