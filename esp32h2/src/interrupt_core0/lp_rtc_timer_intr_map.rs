///Register `LP_RTC_TIMER_INTR_MAP` reader
pub type R = crate::R<LP_RTC_TIMER_INTR_MAP_SPEC>;
///Register `LP_RTC_TIMER_INTR_MAP` writer
pub type W = crate::W<LP_RTC_TIMER_INTR_MAP_SPEC>;
///Field `LP_RTC_TIMER_INTR_MAP` reader - CORE0_LP_RTC_TIMER_INTR mapping register
pub type LP_RTC_TIMER_INTR_MAP_R = crate::FieldReader;
///Field `LP_RTC_TIMER_INTR_MAP` writer - CORE0_LP_RTC_TIMER_INTR mapping register
pub type LP_RTC_TIMER_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_LP_RTC_TIMER_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`lp_rtc_timer_intr_map::R`](R) reader structure
impl crate::Readable for LP_RTC_TIMER_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`lp_rtc_timer_intr_map::W`](W) writer structure
