...
///Field `SHA_INTR_MAP` reader - CORE0_SHA_INTR mapping register
pub type SHA_INTR_MAP_R = crate::FieldReader;
///Field `SHA_INTR_MAP` writer - CORE0_SHA_INTR mapping register
pub type SHA_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_SHA_INTR mapping register
    #[inline(always)]
