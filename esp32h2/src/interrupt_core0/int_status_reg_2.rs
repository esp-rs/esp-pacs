///Register `INT_STATUS_REG_2` reader
pub type R = crate::R<INT_STATUS_REG_2_SPEC>;
///Field `INT_STATUS_2` reader - Status register for interrupt sources 64~95 mapping register
pub type INT_STATUS_2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Status register for interrupt sources 64~95 mapping register
    #[inline(always)]
...
///`read()` method returns [`int_status_reg_2::R`](R) reader structure
