///Register `PARL_IO_TX_INTR_MAP` reader
pub type R = crate::R<PARL_IO_TX_INTR_MAP_SPEC>;
///Register `PARL_IO_TX_INTR_MAP` writer
pub type W = crate::W<PARL_IO_TX_INTR_MAP_SPEC>;
///Field `PARL_IO_TX_INTR_MAP` reader - CORE0_PARL_IO_TX_INTR mapping register
pub type PARL_IO_TX_INTR_MAP_R = crate::FieldReader;
///Field `PARL_IO_TX_INTR_MAP` writer - CORE0_PARL_IO_TX_INTR mapping register
pub type PARL_IO_TX_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_PARL_IO_TX_INTR mapping register
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`parl_io_tx_intr_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`parl_io_tx_intr_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PARL_IO_TX_INTR_MAP_SPEC;
impl crate::RegisterSpec for PARL_IO_TX_INTR_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`parl_io_tx_intr_map::R`](R) reader structure
impl crate::Readable for PARL_IO_TX_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`parl_io_tx_intr_map::W`](W) writer structure
