///Register `ECC_INTR_MAP` reader
pub type R = crate::R<ECC_INTR_MAP_SPEC>;
///Register `ECC_INTR_MAP` writer
pub type W = crate::W<ECC_INTR_MAP_SPEC>;
///Field `ECC_INTR_MAP` reader - CORE0_ECC_INTR mapping register
pub type ECC_INTR_MAP_R = crate::FieldReader;
///Field `ECC_INTR_MAP` writer - CORE0_ECC_INTR mapping register
pub type ECC_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_ECC_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`ecc_intr_map::R`](R) reader structure
impl crate::Readable for ECC_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`ecc_intr_map::W`](W) writer structure
