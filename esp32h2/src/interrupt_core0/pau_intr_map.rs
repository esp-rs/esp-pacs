///Register `PAU_INTR_MAP` reader
pub type R = crate::R<PAU_INTR_MAP_SPEC>;
///Register `PAU_INTR_MAP` writer
pub type W = crate::W<PAU_INTR_MAP_SPEC>;
///Field `PAU_INTR_MAP` reader - CORE0_PAU_INTR mapping register
pub type PAU_INTR_MAP_R = crate::FieldReader;
///Field `PAU_INTR_MAP` writer - CORE0_PAU_INTR mapping register
pub type PAU_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_PAU_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`pau_intr_map::R`](R) reader structure
impl crate::Readable for PAU_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`pau_intr_map::W`](W) writer structure
