///Register `DMA_IN_CH2_INTR_MAP` reader
pub type R = crate::R<DMA_IN_CH2_INTR_MAP_SPEC>;
///Register `DMA_IN_CH2_INTR_MAP` writer
pub type W = crate::W<DMA_IN_CH2_INTR_MAP_SPEC>;
///Field `DMA_IN_CH2_INTR_MAP` reader - CORE0_DMA_IN_CH2_INTR mapping register
pub type DMA_IN_CH2_INTR_MAP_R = crate::FieldReader;
///Field `DMA_IN_CH2_INTR_MAP` writer - CORE0_DMA_IN_CH2_INTR mapping register
...
///`read()` method returns [`dma_in_ch2_intr_map::R`](R) reader structure
impl crate::Readable for DMA_IN_CH2_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`dma_in_ch2_intr_map::W`](W) writer structure
