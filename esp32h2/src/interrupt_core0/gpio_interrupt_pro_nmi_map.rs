...
///Field `GPIO_INTERRUPT_PRO_NMI_MAP` reader - CORE0_GPIO_INTERRUPT_PRO_NMI mapping register
pub type GPIO_INTERRUPT_PRO_NMI_MAP_R = crate::FieldReader;
///Field `GPIO_INTERRUPT_PRO_NMI_MAP` writer - CORE0_GPIO_INTERRUPT_PRO_NMI mapping register
pub type GPIO_INTERRUPT_PRO_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_GPIO_INTERRUPT_PRO_NMI mapping register
    #[inline(always)]
