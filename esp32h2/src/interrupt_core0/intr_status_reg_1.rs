...
///Field `INTR_STATUS_1` reader - Status register for interrupt sources 32~63 mapping register
pub type INTR_STATUS_1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Status register for interrupt sources 32~63 mapping register
    #[inline(always)]
