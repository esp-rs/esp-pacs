///Register `DMA_IN_CH0_INTR_MAP` reader
pub type R = crate::R<DMA_IN_CH0_INTR_MAP_SPEC>;
///Register `DMA_IN_CH0_INTR_MAP` writer
pub type W = crate::W<DMA_IN_CH0_INTR_MAP_SPEC>;
///Field `DMA_IN_CH0_INTR_MAP` reader - CORE0_DMA_IN_CH0_INTR mapping register
pub type DMA_IN_CH0_INTR_MAP_R = crate::FieldReader;
///Field `DMA_IN_CH0_INTR_MAP` writer - CORE0_DMA_IN_CH0_INTR mapping register
pub type DMA_IN_CH0_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_DMA_IN_CH0_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`dma_in_ch0_intr_map::R`](R) reader structure
impl crate::Readable for DMA_IN_CH0_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`dma_in_ch0_intr_map::W`](W) writer structure
