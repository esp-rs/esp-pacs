...
///Field `HP_APM_M0_INTR_MAP` reader - CORE0_HP_APM_M0_INTR mapping register
pub type HP_APM_M0_INTR_MAP_R = crate::FieldReader;
///Field `HP_APM_M0_INTR_MAP` writer - CORE0_HP_APM_M0_INTR mapping register
pub type HP_APM_M0_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_HP_APM_M0_INTR mapping register
    #[inline(always)]
