...
#[doc = "Field `CPU_INTR_FROM_CPU_0_MAP` reader - CORE0_CPU_INTR_FROM_CPU_0 mapping register"]
pub type CPU_INTR_FROM_CPU_0_MAP_R = crate::FieldReader;
#[doc = "Field `CPU_INTR_FROM_CPU_0_MAP` writer - CORE0_CPU_INTR_FROM_CPU_0 mapping register"]
pub type CPU_INTR_FROM_CPU_0_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - CORE0_CPU_INTR_FROM_CPU_0 mapping register"]
    #[inline(always)]
...
impl W {
    ...
    pub fn cpu_intr_from_cpu_0_map(
        &mut self,
    ) -> CPU_INTR_FROM_CPU_0_MAP_W<CPU_INTR_FROM_CPU_0_MAP_SPEC, 0> {
