///Register `HP_APM_M3_INTR_MAP` reader
pub type R = crate::R<HP_APM_M3_INTR_MAP_SPEC>;
///Register `HP_APM_M3_INTR_MAP` writer
pub type W = crate::W<HP_APM_M3_INTR_MAP_SPEC>;
///Field `HP_APM_M3_INTR_MAP` reader - CORE0_HP_APM_M3_INTR mapping register
pub type HP_APM_M3_INTR_MAP_R = crate::FieldReader;
///Field `HP_APM_M3_INTR_MAP` writer - CORE0_HP_APM_M3_INTR mapping register
pub type HP_APM_M3_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_HP_APM_M3_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`hp_apm_m3_intr_map::R`](R) reader structure
impl crate::Readable for HP_APM_M3_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`hp_apm_m3_intr_map::W`](W) writer structure
