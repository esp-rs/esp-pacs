///Register `PMU_INTR_MAP` reader
pub type R = crate::R<PMU_INTR_MAP_SPEC>;
///Register `PMU_INTR_MAP` writer
pub type W = crate::W<PMU_INTR_MAP_SPEC>;
///Field `PMU_INTR_MAP` reader - CORE0_PMU_INTR mapping register
pub type PMU_INTR_MAP_R = crate::FieldReader;
///Field `PMU_INTR_MAP` writer - CORE0_PMU_INTR mapping register
pub type PMU_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_PMU_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`pmu_intr_map::R`](R) reader structure
impl crate::Readable for PMU_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`pmu_intr_map::W`](W) writer structure
