///Register `GPSPI2_INTR_MAP` reader
pub type R = crate::R<GPSPI2_INTR_MAP_SPEC>;
///Register `GPSPI2_INTR_MAP` writer
pub type W = crate::W<GPSPI2_INTR_MAP_SPEC>;
///Field `GPSPI2_INTR_MAP` reader - CORE0_GPSPI2_INTR mapping register
pub type GPSPI2_INTR_MAP_R = crate::FieldReader;
///Field `GPSPI2_INTR_MAP` writer - CORE0_GPSPI2_INTR mapping register
pub type GPSPI2_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_GPSPI2_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`gpspi2_intr_map::R`](R) reader structure
impl crate::Readable for GPSPI2_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`gpspi2_intr_map::W`](W) writer structure
