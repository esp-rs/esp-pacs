...
#[doc = "Field `UHCI0_INTR_MAP` reader - CORE0_UHCI0_INTR mapping register"]
pub type UHCI0_INTR_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `UHCI0_INTR_MAP` writer - CORE0_UHCI0_INTR mapping register"]
pub type UHCI0_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UHCI0_INTR_MAP_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - CORE0_UHCI0_INTR mapping register"]
    #[inline(always)]
