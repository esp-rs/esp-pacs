...
pub struct R(crate::R<ECDSA_INTR_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ECDSA_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ECDSA_INTR_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ECDSA_INTR_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ECDSA_INTR_MAP` writer"]
pub struct W(crate::W<ECDSA_INTR_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ECDSA_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ECDSA_INTR_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ECDSA_INTR_MAP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ECDSA_INTR_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, ECDSA_INTR_MAP_SPEC, 5, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ECDSA_INTR_MAP")
            .field(
                "ecdsa_intr_map",
                &format_args!("{}", self.ecdsa_intr_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<ECDSA_INTR_MAP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ecdsa_intr_map(&mut self) -> ECDSA_INTR_MAP_W<0> {
        ECDSA_INTR_MAP_W::new(self)
    }
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ecdsa_intr_map](index.html) module"]
