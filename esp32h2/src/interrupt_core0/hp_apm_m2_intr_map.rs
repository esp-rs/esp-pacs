///Register `HP_APM_M2_INTR_MAP` reader
pub type R = crate::R<HP_APM_M2_INTR_MAP_SPEC>;
///Register `HP_APM_M2_INTR_MAP` writer
pub type W = crate::W<HP_APM_M2_INTR_MAP_SPEC>;
///Field `HP_APM_M2_INTR_MAP` reader - CORE0_HP_APM_M2_INTR mapping register
pub type HP_APM_M2_INTR_MAP_R = crate::FieldReader;
///Field `HP_APM_M2_INTR_MAP` writer - CORE0_HP_APM_M2_INTR mapping register
pub type HP_APM_M2_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_HP_APM_M2_INTR mapping register
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`hp_apm_m2_intr_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hp_apm_m2_intr_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct HP_APM_M2_INTR_MAP_SPEC;
impl crate::RegisterSpec for HP_APM_M2_INTR_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`hp_apm_m2_intr_map::R`](R) reader structure
impl crate::Readable for HP_APM_M2_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`hp_apm_m2_intr_map::W`](W) writer structure
