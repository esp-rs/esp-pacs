...
#[doc = "Field `TRACE_INTR_MAP` reader - CORE0_TRACE_INTR mapping register"]
pub type TRACE_INTR_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TRACE_INTR_MAP` writer - CORE0_TRACE_INTR mapping register"]
pub type TRACE_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRACE_INTR_MAP_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - CORE0_TRACE_INTR mapping register"]
    #[inline(always)]
