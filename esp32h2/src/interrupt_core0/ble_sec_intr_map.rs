///Register `BLE_SEC_INTR_MAP` reader
pub type R = crate::R<BLE_SEC_INTR_MAP_SPEC>;
///Register `BLE_SEC_INTR_MAP` writer
pub type W = crate::W<BLE_SEC_INTR_MAP_SPEC>;
///Field `BLE_SEC_INTR_MAP` reader - CORE0_BLE_SEC_INTR mapping register
pub type BLE_SEC_INTR_MAP_R = crate::FieldReader;
///Field `BLE_SEC_INTR_MAP` writer - CORE0_BLE_SEC_INTR mapping register
pub type BLE_SEC_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_BLE_SEC_INTR mapping register
    #[inline(always)]
...
///`read()` method returns [`ble_sec_intr_map::R`](R) reader structure
impl crate::Readable for BLE_SEC_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`ble_sec_intr_map::W`](W) writer structure
