///Register `SYSTIMER_TARGET1_INTR_MAP` reader
pub type R = crate::R<SYSTIMER_TARGET1_INTR_MAP_SPEC>;
///Register `SYSTIMER_TARGET1_INTR_MAP` writer
pub type W = crate::W<SYSTIMER_TARGET1_INTR_MAP_SPEC>;
///Field `SYSTIMER_TARGET1_INTR_MAP` reader - CORE0_SYSTIMER_TARGET1_INTR mapping register
pub type SYSTIMER_TARGET1_INTR_MAP_R = crate::FieldReader;
///Field `SYSTIMER_TARGET1_INTR_MAP` writer - CORE0_SYSTIMER_TARGET1_INTR mapping register
pub type SYSTIMER_TARGET1_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_SYSTIMER_TARGET1_INTR mapping register
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`systimer_target1_intr_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`systimer_target1_intr_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct SYSTIMER_TARGET1_INTR_MAP_SPEC;
impl crate::RegisterSpec for SYSTIMER_TARGET1_INTR_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`systimer_target1_intr_map::R`](R) reader structure
impl crate::Readable for SYSTIMER_TARGET1_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`systimer_target1_intr_map::W`](W) writer structure
