...
///Field `BT_BB_NMI_MAP` reader - CORE0_BT_BB_NMI mapping register
pub type BT_BB_NMI_MAP_R = crate::FieldReader;
///Field `BT_BB_NMI_MAP` writer - CORE0_BT_BB_NMI mapping register
pub type BT_BB_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_BT_BB_NMI mapping register
    #[inline(always)]
