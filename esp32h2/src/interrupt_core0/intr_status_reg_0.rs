...
///Field `INTR_STATUS_0` reader - Status register for interrupt sources 0~31 mapping register
pub type INTR_STATUS_0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Status register for interrupt sources 0~31 mapping register
    #[inline(always)]
