///Register `MSPI_INTR_MAP` reader
pub type R = crate::R<MSPI_INTR_MAP_SPEC>;
///Register `MSPI_INTR_MAP` writer
pub type W = crate::W<MSPI_INTR_MAP_SPEC>;
///Field `MSPI_INTR_MAP` reader - CORE0_MSPI_INTR mapping register
pub type MSPI_INTR_MAP_R = crate::FieldReader;
///Field `MSPI_INTR_MAP` writer - CORE0_MSPI_INTR mapping register
pub type MSPI_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_MSPI_INTR mapping register
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`mspi_intr_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mspi_intr_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct MSPI_INTR_MAP_SPEC;
impl crate::RegisterSpec for MSPI_INTR_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`mspi_intr_map::R`](R) reader structure
impl crate::Readable for MSPI_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`mspi_intr_map::W`](W) writer structure
