...
///Field `CPU_INTR_FROM_CPU_2_MAP` reader - CORE0_CPU_INTR_FROM_CPU_2 mapping register
pub type CPU_INTR_FROM_CPU_2_MAP_R = crate::FieldReader;
///Field `CPU_INTR_FROM_CPU_2_MAP` writer - CORE0_CPU_INTR_FROM_CPU_2 mapping register
pub type CPU_INTR_FROM_CPU_2_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - CORE0_CPU_INTR_FROM_CPU_2 mapping register
    #[inline(always)]
