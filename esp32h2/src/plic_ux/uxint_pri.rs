...
#[doc = "Field `CPU_UXINT0_PRI` reader - "]
pub type CPU_UXINT0_PRI_R = crate::FieldReader;
#[doc = "Field `CPU_UXINT0_PRI` writer - "]
pub type CPU_UXINT0_PRI_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bits 0:3"]
    #[inline(always)]
    pub fn cpu_uxint0_pri(&self) -> CPU_UXINT0_PRI_R {
        CPU_UXINT0_PRI_R::new((self.bits & 0x0f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UXINT_PRI")
            .field("cpu_uxint0_pri", &self.cpu_uxint0_pri())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_uxint0_pri(&mut self) -> CPU_UXINT0_PRI_W<UXINT_PRI_SPEC> {
        CPU_UXINT0_PRI_W::new(self, 0)
    }
}
