...
///Field `LOAD` writer - timer comp0 sync enable signal
...
impl W {
    ///Bit 0 - timer comp0 sync enable signal
    #[inline(always)]
    #[must_use]
...
You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`comp_load::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct COMP_LOAD_SPEC;
impl crate::RegisterSpec for COMP_LOAD_SPEC {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`comp_load::W`](W) writer structure
