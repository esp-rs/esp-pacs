...
///Field `TX_AFIFO_FULL` reader - Full signal of APB TX AFIFO.
pub type TX_AFIFO_FULL_R = crate::BitReader;
///Field `TX_AFIFO_EMPTY` reader - Empty signal of APB TX AFIFO.
pub type TX_AFIFO_EMPTY_R = crate::BitReader;
///Field `RX_AFIFO_FULL` reader - Full signal of APB RX AFIFO.
pub type RX_AFIFO_FULL_R = crate::BitReader;
///Field `RX_AFIFO_EMPTY` reader - Empty signal of APB RX AFIFO.
...
///`read()` method returns [`afifo_status::R`](R) reader structure
