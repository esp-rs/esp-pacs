...
pub struct R(crate::R<M23_MODE_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<M23_MODE_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<M23_MODE_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<M23_MODE_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `M23_MODE_CTRL` writer"]
pub struct W(crate::W<M23_MODE_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<M23_MODE_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m23_mode(&mut self) -> M23_MODE_W<0> {
        M23_MODE_W::new(self)
    }
...
#[doc = "Tee mode control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [m23_mode_ctrl](index.html) module"]
