...
/**CPU_INTR_FROM_CPU_0 (rw) register accessor: register description
...
/**CPU_INTR_FROM_CPU_1 (rw) register accessor: register description
...
/**CPU_INTR_FROM_CPU_2 (rw) register accessor: register description
...
/**CPU_INTR_FROM_CPU_3 (rw) register accessor: register description
...
/**DATE (rw) register accessor: register description
