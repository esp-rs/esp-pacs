...
///Field `LOG_MEM_END` reader - the end address of writing logging message
pub type LOG_MEM_END_R = crate::FieldReader<u32>;
///Field `LOG_MEM_END` writer - the end address of writing logging message
pub type LOG_MEM_END_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - the end address of writing logging message
    #[inline(always)]
