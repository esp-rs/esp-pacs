...
#[doc = "Field `LOG_MEM_START` reader - the start address of writing logging message"]
pub type LOG_MEM_START_R = crate::FieldReader<u32>;
#[doc = "Field `LOG_MEM_START` writer - the start address of writing logging message"]
