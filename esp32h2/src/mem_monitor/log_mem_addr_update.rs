///Register `LOG_MEM_ADDR_UPDATE` writer
pub type W = crate::W<LOG_MEM_ADDR_UPDATE_SPEC>;
///Field `LOG_MEM_ADDR_UPDATE` writer - Set 1 to updata MEM_MONITOR_LOG_MEM_CURRENT_ADDR, when set 1, MEM_MONITOR_LOG_MEM_CURRENT_ADDR will update to MEM_MONITOR_LOG_MEM_START
...
///`write(|w| ..)` method takes [`log_mem_addr_update::W`](W) writer structure
