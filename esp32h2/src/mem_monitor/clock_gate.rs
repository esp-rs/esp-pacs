...
#[doc = "Field `CLK_EN` reader - Set 1 to force on the clk of mem_monitor register"]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Set 1 to force on the clk of mem_monitor register"]
pub type CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, CLOCK_GATE_SPEC, O>;
impl R {
    #[doc = "Bit 0 - Set 1 to force on the clk of mem_monitor register"]
    #[inline(always)]
