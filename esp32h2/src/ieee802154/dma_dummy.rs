///Register `DMA_DUMMY` reader
pub type R = crate::R<DMA_DUMMY_SPEC>;
///Register `DMA_DUMMY` writer
...
You can [`read`](crate::generic::Reg::read) this register and get [`dma_dummy::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dma_dummy::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DMA_DUMMY_SPEC;
impl crate::RegisterSpec for DMA_DUMMY_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dma_dummy::R`](R) reader structure
impl crate::Readable for DMA_DUMMY_SPEC {}
///`write(|w| ..)` method takes [`dma_dummy::W`](W) writer structure
