...
///`read()` method returns [`debug_sel_cfg1::R`](R) reader structure
impl crate::Readable for DEBUG_SEL_CFG1_SPEC {}
///`write(|w| ..)` method takes [`debug_sel_cfg1::W`](W) writer structure
