...
You can [`read`](crate::generic::Reg::read) this register and get [`inf0_short_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`inf0_short_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct INF0_SHORT_ADDR_SPEC;
impl crate::RegisterSpec for INF0_SHORT_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`inf0_short_addr::R`](R) reader structure
impl crate::Readable for INF0_SHORT_ADDR_SPEC {}
///`write(|w| ..)` method takes [`inf0_short_addr::W`](W) writer structure
