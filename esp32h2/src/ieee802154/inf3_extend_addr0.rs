...
You can [`read`](crate::generic::Reg::read) this register and get [`inf3_extend_addr0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`inf3_extend_addr0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct INF3_EXTEND_ADDR0_SPEC;
impl crate::RegisterSpec for INF3_EXTEND_ADDR0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`inf3_extend_addr0::R`](R) reader structure
impl crate::Readable for INF3_EXTEND_ADDR0_SPEC {}
///`write(|w| ..)` method takes [`inf3_extend_addr0::W`](W) writer structure
