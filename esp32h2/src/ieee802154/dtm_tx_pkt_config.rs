...
///`read()` method returns [`dtm_tx_pkt_config::R`](R) reader structure
impl crate::Readable for DTM_TX_PKT_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`dtm_tx_pkt_config::W`](W) writer structure
