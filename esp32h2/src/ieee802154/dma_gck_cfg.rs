...
///`read()` method returns [`dma_gck_cfg::R`](R) reader structure
impl crate::Readable for DMA_GCK_CFG_SPEC {}
///`write(|w| ..)` method takes [`dma_gck_cfg::W`](W) writer structure
