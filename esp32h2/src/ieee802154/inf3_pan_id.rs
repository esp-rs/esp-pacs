...
///`read()` method returns [`inf3_pan_id::R`](R) reader structure
impl crate::Readable for INF3_PAN_ID_SPEC {}
///`write(|w| ..)` method takes [`inf3_pan_id::W`](W) writer structure
