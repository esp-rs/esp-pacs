...
///`read()` method returns [`coex_pti::R`](R) reader structure
impl crate::Readable for COEX_PTI_SPEC {}
///`write(|w| ..)` method takes [`coex_pti::W`](W) writer structure
