...
///`read()` method returns [`bb_clk::R`](R) reader structure
impl crate::Readable for BB_CLK_SPEC {}
///`write(|w| ..)` method takes [`bb_clk::W`](W) writer structure
