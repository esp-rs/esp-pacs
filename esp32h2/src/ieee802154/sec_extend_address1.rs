...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SEC_EXTEND_ADDRESS1")
            .field("sec_extend_address1", &self.sec_extend_address1())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`sec_extend_address1::R`](R) reader structure
impl crate::Readable for SEC_EXTEND_ADDRESS1_SPEC {}
///`write(|w| ..)` method takes [`sec_extend_address1::W`](W) writer structure
