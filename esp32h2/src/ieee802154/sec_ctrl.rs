...
///`read()` method returns [`sec_ctrl::R`](R) reader structure
impl crate::Readable for SEC_CTRL_SPEC {}
///`write(|w| ..)` method takes [`sec_ctrl::W`](W) writer structure
