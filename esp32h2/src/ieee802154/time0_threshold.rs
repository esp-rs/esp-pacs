...
You can [`read`](crate::generic::Reg::read) this register and get [`time0_threshold::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`time0_threshold::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct TIME0_THRESHOLD_SPEC;
impl crate::RegisterSpec for TIME0_THRESHOLD_SPEC {
    type Ux = u32;
}
///`read()` method returns [`time0_threshold::R`](R) reader structure
impl crate::Readable for TIME0_THRESHOLD_SPEC {}
///`write(|w| ..)` method takes [`time0_threshold::W`](W) writer structure
