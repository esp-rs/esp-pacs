...
///`read()` method returns [`time1_value::R`](R) reader structure
impl crate::Readable for TIME1_VALUE_SPEC {}
///`write(|w| ..)` method takes [`time1_value::W`](W) writer structure
