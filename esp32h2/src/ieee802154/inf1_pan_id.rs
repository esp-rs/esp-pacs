...
You can [`read`](crate::generic::Reg::read) this register and get [`inf1_pan_id::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`inf1_pan_id::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct INF1_PAN_ID_SPEC;
impl crate::RegisterSpec for INF1_PAN_ID_SPEC {
    type Ux = u32;
}
///`read()` method returns [`inf1_pan_id::R`](R) reader structure
impl crate::Readable for INF1_PAN_ID_SPEC {}
///`write(|w| ..)` method takes [`inf1_pan_id::W`](W) writer structure
