...
You can [`read`](crate::generic::Reg::read) this register and get [`txrx_switch_delay::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`txrx_switch_delay::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct TXRX_SWITCH_DELAY_SPEC;
impl crate::RegisterSpec for TXRX_SWITCH_DELAY_SPEC {
    type Ux = u32;
}
///`read()` method returns [`txrx_switch_delay::R`](R) reader structure
impl crate::Readable for TXRX_SWITCH_DELAY_SPEC {}
///`write(|w| ..)` method takes [`txrx_switch_delay::W`](W) writer structure
