...
///`read()` method returns [`txrx_path_delay::R`](R) reader structure
impl crate::Readable for TXRX_PATH_DELAY_SPEC {}
///`write(|w| ..)` method takes [`txrx_path_delay::W`](W) writer structure
