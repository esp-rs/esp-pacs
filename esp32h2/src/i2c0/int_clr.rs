...
pub type GENERAL_CALL_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SLAVE_ADDR_UNMATCH_INT_CLR` writer - Set this bit to clear I2C_SLAVE_ADDR_UNMATCH_INT_RAW interrupt."]
pub type SLAVE_ADDR_UNMATCH_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn general_call_int_clr(&mut self) -> GENERAL_CALL_INT_CLR_W<INT_CLR_SPEC, 17> {
        GENERAL_CALL_INT_CLR_W::new(self)
    }
    #[doc = "Bit 18 - Set this bit to clear I2C_SLAVE_ADDR_UNMATCH_INT_RAW interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn slave_addr_unmatch_int_clr(&mut self) -> SLAVE_ADDR_UNMATCH_INT_CLR_W<INT_CLR_SPEC, 18> {
