...
pub type GENERAL_CALL_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SLAVE_ADDR_UNMATCH_INT_ENA` reader - The interrupt enable bit for I2C_SLAVE_ADDR_UNMATCH_INT interrupt."]
pub type SLAVE_ADDR_UNMATCH_INT_ENA_R = crate::BitReader;
#[doc = "Field `SLAVE_ADDR_UNMATCH_INT_ENA` writer - The interrupt enable bit for I2C_SLAVE_ADDR_UNMATCH_INT interrupt."]
pub type SLAVE_ADDR_UNMATCH_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            ...
            .field(
                ...
                &format_args!("{}", self.slave_addr_unmatch_int_ena().bit()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn general_call_int_ena(&mut self) -> GENERAL_CALL_INT_ENA_W<INT_ENA_SPEC, 17> {
        GENERAL_CALL_INT_ENA_W::new(self)
    }
    #[doc = "Bit 18 - The interrupt enable bit for I2C_SLAVE_ADDR_UNMATCH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn slave_addr_unmatch_int_ena(&mut self) -> SLAVE_ADDR_UNMATCH_INT_ENA_W<INT_ENA_SPEC, 18> {
        SLAVE_ADDR_UNMATCH_INT_ENA_W::new(self)
    }
