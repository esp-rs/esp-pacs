...
///Field `GENERAL_CALL` reader - The masked interrupt status bit for I2C_GENARAL_CALL_INT interrupt.
pub type GENERAL_CALL_R = crate::BitReader;
///Field `SLAVE_ADDR_UNMATCH` reader - The masked interrupt status bit for I2C_SLAVE_ADDR_UNMATCH_INT interrupt.
...
impl R {
    ...
    ///Bit 17 - The masked interrupt status bit for I2C_GENARAL_CALL_INT interrupt.
    #[inline(always)]
    pub fn general_call(&self) -> GENERAL_CALL_R {
        GENERAL_CALL_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - The masked interrupt status bit for I2C_SLAVE_ADDR_UNMATCH_INT interrupt.
    #[inline(always)]
