...
#[doc = "Field `GENERAL_CALL_INT_RAW` reader - The raw interrupt bit for I2C_GENARAL_CALL_INT interrupt."]
pub type GENERAL_CALL_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `SLAVE_ADDR_UNMATCH_INT_RAW` reader - The raw interrupt bit for I2C_SLAVE_ADDR_UNMATCH_INT_RAW interrupt."]
pub type SLAVE_ADDR_UNMATCH_INT_RAW_R = crate::BitReader<bool>;
impl R {
