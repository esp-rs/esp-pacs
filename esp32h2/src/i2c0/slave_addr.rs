...
///Field `SLAVE_ADDR` reader - When configured as an I2C Slave, this field is used to configure the slave address.
pub type SLAVE_ADDR_R = crate::FieldReader<u16>;
///Field `SLAVE_ADDR` writer - When configured as an I2C Slave, this field is used to configure the slave address.
pub type SLAVE_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `ADDR_10BIT_EN` reader - This field is used to enable the slave 10-bit addressing mode in master mode.
pub type ADDR_10BIT_EN_R = crate::BitReader;
///Field `ADDR_10BIT_EN` writer - This field is used to enable the slave 10-bit addressing mode in master mode.
