...
pub type TX_REQUEST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RELEASE_BUFFER_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_request(&mut self) -> TX_REQUEST_W<CMD_SPEC, 0> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn release_buffer(&mut self) -> RELEASE_BUFFER_W<CMD_SPEC, 2> {
