...
///`read()` method returns [`eco_cfg::R`](R) reader structure
impl crate::Readable for ECO_CFG_SPEC {}
///`write(|w| ..)` method takes [`eco_cfg::W`](W) writer structure
