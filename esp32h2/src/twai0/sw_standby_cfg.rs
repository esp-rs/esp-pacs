...
pub type SW_STANDBY_EN_R = crate::BitReader<bool>;
#[doc = "Field `SW_STANDBY_EN` writer - Enable standby pin."]
pub type SW_STANDBY_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SW_STANDBY_CFG_SPEC, bool, O>;
#[doc = "Field `SW_STANDBY_CLR` reader - Clear standby pin."]
pub type SW_STANDBY_CLR_R = crate::BitReader<bool>;
#[doc = "Field `SW_STANDBY_CLR` writer - Clear standby pin."]
pub type SW_STANDBY_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SW_STANDBY_CFG_SPEC, bool, O>;
impl R {
