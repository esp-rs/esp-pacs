...
#[doc = "Field `CMPR_TEA(PR0,PR1,PR2)` writer - The interrupt clear bit for the operator%s compare A event."]
pub type CMPR_TEA_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `CMPR_TEB(PR0,PR1,PR2)` writer - The interrupt clear bit for the operator%s compare B event."]
...
impl W {
    ...
    #[doc = "The interrupt clear bit for the operator(PR0,PR1,PR2) compare A event."]
    #[doc = ""]
    ...
    #[doc = "Bit 15 - The interrupt clear bit for the operatorPR0 compare A event."]
    #[inline(always)]
    pub fn cmprpr0_tea(&mut self) -> CMPR_TEA_W<'_, INT_CLR_SPEC> {
        CMPR_TEA_W::new(self, 15)
    }
    #[doc = "Bit 16 - The interrupt clear bit for the operatorPR1 compare A event."]
    #[inline(always)]
    pub fn cmprpr1_tea(&mut self) -> CMPR_TEA_W<'_, INT_CLR_SPEC> {
        CMPR_TEA_W::new(self, 16)
    }
    #[doc = "Bit 17 - The interrupt clear bit for the operatorPR2 compare A event."]
    #[inline(always)]
    pub fn cmprpr2_tea(&mut self) -> CMPR_TEA_W<'_, INT_CLR_SPEC> {
        CMPR_TEA_W::new(self, 17)
    }
    #[doc = "The interrupt clear bit for the operator(PR0,PR1,PR2) compare B event."]
    #[doc = ""]
    ...
    #[doc = "Bit 18 - The interrupt clear bit for the operatorPR0 compare B event."]
    #[inline(always)]
    pub fn cmprpr0_teb(&mut self) -> CMPR_TEB_W<'_, INT_CLR_SPEC> {
        CMPR_TEB_W::new(self, 18)
    }
    #[doc = "Bit 19 - The interrupt clear bit for the operatorPR1 compare B event."]
    #[inline(always)]
    pub fn cmprpr1_teb(&mut self) -> CMPR_TEB_W<'_, INT_CLR_SPEC> {
        CMPR_TEB_W::new(self, 19)
    }
    #[doc = "Bit 20 - The interrupt clear bit for the operatorPR2 compare B event."]
    #[inline(always)]
    pub fn cmprpr2_teb(&mut self) -> CMPR_TEB_W<'_, INT_CLR_SPEC> {
