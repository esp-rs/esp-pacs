...
///Field `TIMER0_STOP` writer - Set this bit to clear the interrupt triggered when the timer 0 stops.
pub type TIMER0_STOP_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TIMER1_STOP` writer - Set this bit to clear the interrupt triggered when the timer 1 stops.
pub type TIMER1_STOP_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TIMER2_STOP` writer - Set this bit to clear the interrupt triggered when the timer 2 stops.
pub type TIMER2_STOP_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TIMER0_TEZ` writer - Set this bit to clear the interrupt triggered by a PWM timer 0 TEZ event.
pub type TIMER0_TEZ_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TIMER1_TEZ` writer - Set this bit to clear the interrupt triggered by a PWM timer 1 TEZ event.
pub type TIMER1_TEZ_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TIMER2_TEZ` writer - Set this bit to clear the interrupt triggered by a PWM timer 2 TEZ event.
pub type TIMER2_TEZ_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TIMER0_TEP` writer - Set this bit to clear the interrupt triggered by a PWM timer 0 TEP event.
pub type TIMER0_TEP_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TIMER1_TEP` writer - Set this bit to clear the interrupt triggered by a PWM timer 1 TEP event.
pub type TIMER1_TEP_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TIMER2_TEP` writer - Set this bit to clear the interrupt triggered by a PWM timer 2 TEP event.
...
///Field `FAULT1` writer - Set this bit to clear the interrupt triggered when event_f1 starts.
pub type FAULT1_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `FAULT2` writer - Set this bit to clear the interrupt triggered when event_f2 starts.
pub type FAULT2_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `FAULT0_CLR` writer - Set this bit to clear the interrupt triggered when event_f0 ends.
pub type FAULT0_CLR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `FAULT1_CLR` writer - Set this bit to clear the interrupt triggered when event_f1 ends.
pub type FAULT1_CLR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `FAULT2_CLR` writer - Set this bit to clear the interrupt triggered when event_f2 ends.
pub type FAULT2_CLR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `CMPR0_TEA` writer - Set this bit to clear the interrupt triggered by a PWM operator 0 TEA event
pub type CMPR0_TEA_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `CMPR1_TEA` writer - Set this bit to clear the interrupt triggered by a PWM operator 1 TEA event
pub type CMPR1_TEA_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `CMPR2_TEA` writer - Set this bit to clear the interrupt triggered by a PWM operator 2 TEA event
pub type CMPR2_TEA_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `CMPR0_TEB` writer - Set this bit to clear the interrupt triggered by a PWM operator 0 TEB event
pub type CMPR0_TEB_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `CMPR1_TEB` writer - Set this bit to clear the interrupt triggered by a PWM operator 1 TEB event
pub type CMPR1_TEB_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `CMPR2_TEB` writer - Set this bit to clear the interrupt triggered by a PWM operator 2 TEB event
pub type CMPR2_TEB_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TZ0_CBC` writer - Set this bit to clear the interrupt triggered by a cycle-by-cycle mode action on PWM0.
pub type TZ0_CBC_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TZ1_CBC` writer - Set this bit to clear the interrupt triggered by a cycle-by-cycle mode action on PWM1.
pub type TZ1_CBC_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TZ2_CBC` writer - Set this bit to clear the interrupt triggered by a cycle-by-cycle mode action on PWM2.
pub type TZ2_CBC_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TZ0_OST` writer - Set this bit to clear the interrupt triggered by a one-shot mode action on PWM0.
pub type TZ0_OST_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TZ1_OST` writer - Set this bit to clear the interrupt triggered by a one-shot mode action on PWM1.
pub type TZ1_OST_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TZ2_OST` writer - Set this bit to clear the interrupt triggered by a one-shot mode action on PWM2.
pub type TZ2_OST_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `CAP0` writer - Set this bit to clear the interrupt triggered by capture on channel 0.
...
///Field `CAP2` writer - Set this bit to clear the interrupt triggered by capture on channel 2.
