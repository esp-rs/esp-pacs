...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tz0_cbc_int_clr(&mut self) -> TZ0_CBC_INT_CLR_W<INT_CLR_SPEC, 21> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tz1_cbc_int_clr(&mut self) -> TZ1_CBC_INT_CLR_W<INT_CLR_SPEC, 22> {
