...
///Field `EVT_TIMER0_STOP_EN` reader - set this bit high to enable timer0 stop event generate
pub type EVT_TIMER0_STOP_EN_R = crate::BitReader;
///Field `EVT_TIMER0_STOP_EN` writer - set this bit high to enable timer0 stop event generate
pub type EVT_TIMER0_STOP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TIMER1_STOP_EN` reader - set this bit high to enable timer1 stop event generate
pub type EVT_TIMER1_STOP_EN_R = crate::BitReader;
///Field `EVT_TIMER1_STOP_EN` writer - set this bit high to enable timer1 stop event generate
pub type EVT_TIMER1_STOP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TIMER2_STOP_EN` reader - set this bit high to enable timer2 stop event generate
pub type EVT_TIMER2_STOP_EN_R = crate::BitReader;
///Field `EVT_TIMER2_STOP_EN` writer - set this bit high to enable timer2 stop event generate
pub type EVT_TIMER2_STOP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TIMER0_TEZ_EN` reader - set this bit high to enable timer0 equal zero event generate
pub type EVT_TIMER0_TEZ_EN_R = crate::BitReader;
///Field `EVT_TIMER0_TEZ_EN` writer - set this bit high to enable timer0 equal zero event generate
pub type EVT_TIMER0_TEZ_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TIMER1_TEZ_EN` reader - set this bit high to enable timer1 equal zero event generate
pub type EVT_TIMER1_TEZ_EN_R = crate::BitReader;
///Field `EVT_TIMER1_TEZ_EN` writer - set this bit high to enable timer1 equal zero event generate
pub type EVT_TIMER1_TEZ_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TIMER2_TEZ_EN` reader - set this bit high to enable timer2 equal zero event generate
pub type EVT_TIMER2_TEZ_EN_R = crate::BitReader;
///Field `EVT_TIMER2_TEZ_EN` writer - set this bit high to enable timer2 equal zero event generate
pub type EVT_TIMER2_TEZ_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TIMER0_TEP_EN` reader - set this bit high to enable timer0 equal period event generate
pub type EVT_TIMER0_TEP_EN_R = crate::BitReader;
///Field `EVT_TIMER0_TEP_EN` writer - set this bit high to enable timer0 equal period event generate
pub type EVT_TIMER0_TEP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TIMER1_TEP_EN` reader - set this bit high to enable timer1 equal period event generate
pub type EVT_TIMER1_TEP_EN_R = crate::BitReader;
///Field `EVT_TIMER1_TEP_EN` writer - set this bit high to enable timer1 equal period event generate
pub type EVT_TIMER1_TEP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TIMER2_TEP_EN` reader - set this bit high to enable timer2 equal period event generate
pub type EVT_TIMER2_TEP_EN_R = crate::BitReader;
///Field `EVT_TIMER2_TEP_EN` writer - set this bit high to enable timer2 equal period event generate
pub type EVT_TIMER2_TEP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_OP0_TEA_EN` reader - set this bit high to enable PWM generator0 timer equal a event generate
pub type EVT_OP0_TEA_EN_R = crate::BitReader;
///Field `EVT_OP0_TEA_EN` writer - set this bit high to enable PWM generator0 timer equal a event generate
pub type EVT_OP0_TEA_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_OP1_TEA_EN` reader - set this bit high to enable PWM generator1 timer equal a event generate
pub type EVT_OP1_TEA_EN_R = crate::BitReader;
///Field `EVT_OP1_TEA_EN` writer - set this bit high to enable PWM generator1 timer equal a event generate
pub type EVT_OP1_TEA_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_OP2_TEA_EN` reader - set this bit high to enable PWM generator2 timer equal a event generate
pub type EVT_OP2_TEA_EN_R = crate::BitReader;
///Field `EVT_OP2_TEA_EN` writer - set this bit high to enable PWM generator2 timer equal a event generate
pub type EVT_OP2_TEA_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_OP0_TEB_EN` reader - set this bit high to enable PWM generator0 timer equal b event generate
pub type EVT_OP0_TEB_EN_R = crate::BitReader;
///Field `EVT_OP0_TEB_EN` writer - set this bit high to enable PWM generator0 timer equal b event generate
pub type EVT_OP0_TEB_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_OP1_TEB_EN` reader - set this bit high to enable PWM generator1 timer equal b event generate
pub type EVT_OP1_TEB_EN_R = crate::BitReader;
///Field `EVT_OP1_TEB_EN` writer - set this bit high to enable PWM generator1 timer equal b event generate
pub type EVT_OP1_TEB_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_OP2_TEB_EN` reader - set this bit high to enable PWM generator2 timer equal b event generate
pub type EVT_OP2_TEB_EN_R = crate::BitReader;
///Field `EVT_OP2_TEB_EN` writer - set this bit high to enable PWM generator2 timer equal b event generate
pub type EVT_OP2_TEB_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_F0_EN` reader - set this bit high to enable fault0 event generate
pub type EVT_F0_EN_R = crate::BitReader;
///Field `EVT_F0_EN` writer - set this bit high to enable fault0 event generate
pub type EVT_F0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_F1_EN` reader - set this bit high to enable fault1 event generate
pub type EVT_F1_EN_R = crate::BitReader;
///Field `EVT_F1_EN` writer - set this bit high to enable fault1 event generate
pub type EVT_F1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_F2_EN` reader - set this bit high to enable fault2 event generate
pub type EVT_F2_EN_R = crate::BitReader;
///Field `EVT_F2_EN` writer - set this bit high to enable fault2 event generate
pub type EVT_F2_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_F0_CLR_EN` reader - set this bit high to enable fault0 clear event generate
pub type EVT_F0_CLR_EN_R = crate::BitReader;
///Field `EVT_F0_CLR_EN` writer - set this bit high to enable fault0 clear event generate
pub type EVT_F0_CLR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_F1_CLR_EN` reader - set this bit high to enable fault1 clear event generate
pub type EVT_F1_CLR_EN_R = crate::BitReader;
///Field `EVT_F1_CLR_EN` writer - set this bit high to enable fault1 clear event generate
pub type EVT_F1_CLR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_F2_CLR_EN` reader - set this bit high to enable fault2 clear event generate
pub type EVT_F2_CLR_EN_R = crate::BitReader;
///Field `EVT_F2_CLR_EN` writer - set this bit high to enable fault2 clear event generate
pub type EVT_F2_CLR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TZ0_CBC_EN` reader - set this bit high to enable cycle by cycle trip0 event generate
pub type EVT_TZ0_CBC_EN_R = crate::BitReader;
///Field `EVT_TZ0_CBC_EN` writer - set this bit high to enable cycle by cycle trip0 event generate
pub type EVT_TZ0_CBC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TZ1_CBC_EN` reader - set this bit high to enable cycle by cycle trip1 event generate
pub type EVT_TZ1_CBC_EN_R = crate::BitReader;
///Field `EVT_TZ1_CBC_EN` writer - set this bit high to enable cycle by cycle trip1 event generate
pub type EVT_TZ1_CBC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TZ2_CBC_EN` reader - set this bit high to enable cycle by cycle trip2 event generate
pub type EVT_TZ2_CBC_EN_R = crate::BitReader;
///Field `EVT_TZ2_CBC_EN` writer - set this bit high to enable cycle by cycle trip2 event generate
pub type EVT_TZ2_CBC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TZ0_OST_EN` reader - set this bit high to enable one shot trip0 event generate
pub type EVT_TZ0_OST_EN_R = crate::BitReader;
///Field `EVT_TZ0_OST_EN` writer - set this bit high to enable one shot trip0 event generate
pub type EVT_TZ0_OST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TZ1_OST_EN` reader - set this bit high to enable one shot trip1 event generate
pub type EVT_TZ1_OST_EN_R = crate::BitReader;
///Field `EVT_TZ1_OST_EN` writer - set this bit high to enable one shot trip1 event generate
pub type EVT_TZ1_OST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_TZ2_OST_EN` reader - set this bit high to enable one shot trip2 event generate
pub type EVT_TZ2_OST_EN_R = crate::BitReader;
///Field `EVT_TZ2_OST_EN` writer - set this bit high to enable one shot trip2 event generate
pub type EVT_TZ2_OST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_CAP0_EN` reader - set this bit high to enable capture0 event generate
pub type EVT_CAP0_EN_R = crate::BitReader;
///Field `EVT_CAP0_EN` writer - set this bit high to enable capture0 event generate
pub type EVT_CAP0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_CAP1_EN` reader - set this bit high to enable capture1 event generate
pub type EVT_CAP1_EN_R = crate::BitReader;
///Field `EVT_CAP1_EN` writer - set this bit high to enable capture1 event generate
pub type EVT_CAP1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EVT_CAP2_EN` reader - set this bit high to enable capture2 event generate
pub type EVT_CAP2_EN_R = crate::BitReader;
///Field `EVT_CAP2_EN` writer - set this bit high to enable capture2 event generate
pub type EVT_CAP2_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - set this bit high to enable timer0 stop event generate
    #[inline(always)]
    pub fn evt_timer0_stop_en(&self) -> EVT_TIMER0_STOP_EN_R {
        EVT_TIMER0_STOP_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - set this bit high to enable timer1 stop event generate
    #[inline(always)]
    pub fn evt_timer1_stop_en(&self) -> EVT_TIMER1_STOP_EN_R {
        EVT_TIMER1_STOP_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - set this bit high to enable timer2 stop event generate
    #[inline(always)]
    pub fn evt_timer2_stop_en(&self) -> EVT_TIMER2_STOP_EN_R {
        EVT_TIMER2_STOP_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - set this bit high to enable timer0 equal zero event generate
    #[inline(always)]
    pub fn evt_timer0_tez_en(&self) -> EVT_TIMER0_TEZ_EN_R {
        EVT_TIMER0_TEZ_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - set this bit high to enable timer1 equal zero event generate
    #[inline(always)]
    pub fn evt_timer1_tez_en(&self) -> EVT_TIMER1_TEZ_EN_R {
        EVT_TIMER1_TEZ_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - set this bit high to enable timer2 equal zero event generate
    #[inline(always)]
    pub fn evt_timer2_tez_en(&self) -> EVT_TIMER2_TEZ_EN_R {
        EVT_TIMER2_TEZ_EN_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - set this bit high to enable timer0 equal period event generate
    #[inline(always)]
    pub fn evt_timer0_tep_en(&self) -> EVT_TIMER0_TEP_EN_R {
        EVT_TIMER0_TEP_EN_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - set this bit high to enable timer1 equal period event generate
    #[inline(always)]
    pub fn evt_timer1_tep_en(&self) -> EVT_TIMER1_TEP_EN_R {
        EVT_TIMER1_TEP_EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - set this bit high to enable timer2 equal period event generate
    #[inline(always)]
    pub fn evt_timer2_tep_en(&self) -> EVT_TIMER2_TEP_EN_R {
        EVT_TIMER2_TEP_EN_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - set this bit high to enable PWM generator0 timer equal a event generate
    #[inline(always)]
    pub fn evt_op0_tea_en(&self) -> EVT_OP0_TEA_EN_R {
        EVT_OP0_TEA_EN_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - set this bit high to enable PWM generator1 timer equal a event generate
    #[inline(always)]
    pub fn evt_op1_tea_en(&self) -> EVT_OP1_TEA_EN_R {
        EVT_OP1_TEA_EN_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - set this bit high to enable PWM generator2 timer equal a event generate
    #[inline(always)]
    pub fn evt_op2_tea_en(&self) -> EVT_OP2_TEA_EN_R {
        EVT_OP2_TEA_EN_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - set this bit high to enable PWM generator0 timer equal b event generate
    #[inline(always)]
    pub fn evt_op0_teb_en(&self) -> EVT_OP0_TEB_EN_R {
        EVT_OP0_TEB_EN_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - set this bit high to enable PWM generator1 timer equal b event generate
    #[inline(always)]
    pub fn evt_op1_teb_en(&self) -> EVT_OP1_TEB_EN_R {
        EVT_OP1_TEB_EN_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 14 - set this bit high to enable PWM generator2 timer equal b event generate
    #[inline(always)]
    pub fn evt_op2_teb_en(&self) -> EVT_OP2_TEB_EN_R {
        EVT_OP2_TEB_EN_R::new(((self.bits >> 14) & 1) != 0)
    }
    ///Bit 15 - set this bit high to enable fault0 event generate
    #[inline(always)]
    pub fn evt_f0_en(&self) -> EVT_F0_EN_R {
        EVT_F0_EN_R::new(((self.bits >> 15) & 1) != 0)
    }
    ///Bit 16 - set this bit high to enable fault1 event generate
    #[inline(always)]
    pub fn evt_f1_en(&self) -> EVT_F1_EN_R {
        EVT_F1_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - set this bit high to enable fault2 event generate
    #[inline(always)]
    pub fn evt_f2_en(&self) -> EVT_F2_EN_R {
        EVT_F2_EN_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 18 - set this bit high to enable fault0 clear event generate
    #[inline(always)]
    pub fn evt_f0_clr_en(&self) -> EVT_F0_CLR_EN_R {
        EVT_F0_CLR_EN_R::new(((self.bits >> 18) & 1) != 0)
    }
    ///Bit 19 - set this bit high to enable fault1 clear event generate
    #[inline(always)]
    pub fn evt_f1_clr_en(&self) -> EVT_F1_CLR_EN_R {
        EVT_F1_CLR_EN_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 20 - set this bit high to enable fault2 clear event generate
    #[inline(always)]
    pub fn evt_f2_clr_en(&self) -> EVT_F2_CLR_EN_R {
        EVT_F2_CLR_EN_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - set this bit high to enable cycle by cycle trip0 event generate
    #[inline(always)]
    pub fn evt_tz0_cbc_en(&self) -> EVT_TZ0_CBC_EN_R {
        EVT_TZ0_CBC_EN_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Bit 22 - set this bit high to enable cycle by cycle trip1 event generate
    #[inline(always)]
    pub fn evt_tz1_cbc_en(&self) -> EVT_TZ1_CBC_EN_R {
        EVT_TZ1_CBC_EN_R::new(((self.bits >> 22) & 1) != 0)
    }
    ///Bit 23 - set this bit high to enable cycle by cycle trip2 event generate
    #[inline(always)]
    pub fn evt_tz2_cbc_en(&self) -> EVT_TZ2_CBC_EN_R {
        EVT_TZ2_CBC_EN_R::new(((self.bits >> 23) & 1) != 0)
    }
    ///Bit 24 - set this bit high to enable one shot trip0 event generate
    #[inline(always)]
    pub fn evt_tz0_ost_en(&self) -> EVT_TZ0_OST_EN_R {
        EVT_TZ0_OST_EN_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - set this bit high to enable one shot trip1 event generate
    #[inline(always)]
    pub fn evt_tz1_ost_en(&self) -> EVT_TZ1_OST_EN_R {
        EVT_TZ1_OST_EN_R::new(((self.bits >> 25) & 1) != 0)
    }
    ///Bit 26 - set this bit high to enable one shot trip2 event generate
    #[inline(always)]
    pub fn evt_tz2_ost_en(&self) -> EVT_TZ2_OST_EN_R {
        EVT_TZ2_OST_EN_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bit 27 - set this bit high to enable capture0 event generate
    #[inline(always)]
    pub fn evt_cap0_en(&self) -> EVT_CAP0_EN_R {
        EVT_CAP0_EN_R::new(((self.bits >> 27) & 1) != 0)
    }
    ///Bit 28 - set this bit high to enable capture1 event generate
    #[inline(always)]
    pub fn evt_cap1_en(&self) -> EVT_CAP1_EN_R {
        EVT_CAP1_EN_R::new(((self.bits >> 28) & 1) != 0)
    }
    ///Bit 29 - set this bit high to enable capture2 event generate
    #[inline(always)]
