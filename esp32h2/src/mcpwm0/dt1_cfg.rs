...
pub type DB1_FED_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, DT1_CFG_SPEC, 4, O>;
...
pub type DB1_RED_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, DT1_CFG_SPEC, 4, O>;
...
pub type DB1_DEB_MODE_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
...
pub type DB1_A_OUTSWAP_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
...
pub type DB1_B_OUTSWAP_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
...
pub type DB1_RED_INSEL_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
...
pub type DB1_FED_INSEL_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
...
pub type DB1_RED_OUTINVERT_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
...
pub type DB1_FED_OUTINVERT_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
...
pub type DB1_A_OUTBYPASS_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
...
pub type DB1_B_OUTBYPASS_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
...
pub type DB1_CLK_SEL_W<'a, const O: u8> = crate::BitWriter<'a, DT1_CFG_SPEC, O>;
impl R {
