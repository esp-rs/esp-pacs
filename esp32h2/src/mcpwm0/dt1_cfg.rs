...
pub type DB1_FED_UPMETHOD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type DB1_RED_UPMETHOD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type DB1_DEB_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DB1_A_OUTSWAP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DB1_B_OUTSWAP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DB1_RED_INSEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DB1_FED_INSEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DB1_RED_OUTINVERT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DB1_FED_OUTINVERT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DB1_A_OUTBYPASS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DB1_B_OUTBYPASS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DB1_CLK_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn db1_fed_upmethod(&mut self) -> DB1_FED_UPMETHOD_W<DT1_CFG_SPEC, 0> {
        DB1_FED_UPMETHOD_W::new(self)
    }
    #[doc = "Bits 4:7 - Update method for RED (rising edge delay) active register. 0: immediate,when bit0 is set to 1: tez, when bit1 is set to 1:tep, when bit2 is set to 1: sync, when bit3 is set to 1: disable the update"]
    #[inline(always)]
    #[must_use]
    pub fn db1_red_upmethod(&mut self) -> DB1_RED_UPMETHOD_W<DT1_CFG_SPEC, 4> {
        DB1_RED_UPMETHOD_W::new(self)
    }
    #[doc = "Bit 8 - S8 in table, dual-edge B mode, 0: fed/red take effect on different path separately, 1: fed/red take effect on B path, A out is in bypass or dulpB mode"]
    #[inline(always)]
    #[must_use]
    pub fn db1_deb_mode(&mut self) -> DB1_DEB_MODE_W<DT1_CFG_SPEC, 8> {
        DB1_DEB_MODE_W::new(self)
    }
    #[doc = "Bit 9 - S6 in table"]
    #[inline(always)]
    #[must_use]
    pub fn db1_a_outswap(&mut self) -> DB1_A_OUTSWAP_W<DT1_CFG_SPEC, 9> {
        DB1_A_OUTSWAP_W::new(self)
    }
    #[doc = "Bit 10 - S7 in table"]
    #[inline(always)]
    #[must_use]
    pub fn db1_b_outswap(&mut self) -> DB1_B_OUTSWAP_W<DT1_CFG_SPEC, 10> {
        DB1_B_OUTSWAP_W::new(self)
    }
    #[doc = "Bit 11 - S4 in table"]
    #[inline(always)]
    #[must_use]
    pub fn db1_red_insel(&mut self) -> DB1_RED_INSEL_W<DT1_CFG_SPEC, 11> {
        DB1_RED_INSEL_W::new(self)
    }
    #[doc = "Bit 12 - S5 in table"]
    #[inline(always)]
    #[must_use]
    pub fn db1_fed_insel(&mut self) -> DB1_FED_INSEL_W<DT1_CFG_SPEC, 12> {
        DB1_FED_INSEL_W::new(self)
    }
    #[doc = "Bit 13 - S2 in table"]
    #[inline(always)]
    #[must_use]
    pub fn db1_red_outinvert(&mut self) -> DB1_RED_OUTINVERT_W<DT1_CFG_SPEC, 13> {
        DB1_RED_OUTINVERT_W::new(self)
    }
    #[doc = "Bit 14 - S3 in table"]
    #[inline(always)]
    #[must_use]
    pub fn db1_fed_outinvert(&mut self) -> DB1_FED_OUTINVERT_W<DT1_CFG_SPEC, 14> {
        DB1_FED_OUTINVERT_W::new(self)
    }
    #[doc = "Bit 15 - S1 in table"]
    #[inline(always)]
    #[must_use]
    pub fn db1_a_outbypass(&mut self) -> DB1_A_OUTBYPASS_W<DT1_CFG_SPEC, 15> {
        DB1_A_OUTBYPASS_W::new(self)
    }
    #[doc = "Bit 16 - S0 in table"]
    #[inline(always)]
    #[must_use]
    pub fn db1_b_outbypass(&mut self) -> DB1_B_OUTBYPASS_W<DT1_CFG_SPEC, 16> {
        DB1_B_OUTBYPASS_W::new(self)
    }
    #[doc = "Bit 17 - Dead time generator 1 clock selection. 0: PWM_clk, 1: PT_clk"]
    #[inline(always)]
    #[must_use]
    pub fn db1_clk_sel(&mut self) -> DB1_CLK_SEL_W<DT1_CFG_SPEC, 17> {
