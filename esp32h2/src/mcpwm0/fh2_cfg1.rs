...
pub type TZ2_CLR_OST_W<'a, const O: u8> = crate::BitWriter<'a, FH2_CFG1_SPEC, O>;
...
pub type TZ2_CBCPULSE_W<'a, const O: u8> = crate::FieldWriter<'a, FH2_CFG1_SPEC, 2, O>;
...
pub type TZ2_FORCE_CBC_W<'a, const O: u8> = crate::BitWriter<'a, FH2_CFG1_SPEC, O>;
...
pub type TZ2_FORCE_OST_W<'a, const O: u8> = crate::BitWriter<'a, FH2_CFG1_SPEC, O>;
impl R {
