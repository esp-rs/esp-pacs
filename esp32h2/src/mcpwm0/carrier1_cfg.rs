...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chopper1_en(&mut self) -> CHOPPER1_EN_W<CARRIER1_CFG_SPEC> {
        CHOPPER1_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:4 - PWM carrier1 clock (PC_clk) prescale value. Period of PC_clk = period of PWM_clk * (PWM_CARRIER0_PRESCALE + 1)"]
    #[inline(always)]
    #[must_use]
    pub fn chopper1_prescale(&mut self) -> CHOPPER1_PRESCALE_W<CARRIER1_CFG_SPEC> {
        CHOPPER1_PRESCALE_W::new(self, 1)
    }
    #[doc = "Bits 5:7 - carrier duty selection. Duty = PWM_CARRIER0_DUTY / 8"]
    #[inline(always)]
    #[must_use]
    pub fn chopper1_duty(&mut self) -> CHOPPER1_DUTY_W<CARRIER1_CFG_SPEC> {
        CHOPPER1_DUTY_W::new(self, 5)
    }
    #[doc = "Bits 8:11 - width of the first pulse in number of periods of the carrier"]
    #[inline(always)]
    #[must_use]
    pub fn chopper1_oshtwth(&mut self) -> CHOPPER1_OSHTWTH_W<CARRIER1_CFG_SPEC> {
        CHOPPER1_OSHTWTH_W::new(self, 8)
    }
    #[doc = "Bit 12 - when set, invert the output of PWM1A and PWM1B for this submodule"]
    #[inline(always)]
    #[must_use]
    pub fn chopper1_out_invert(&mut self) -> CHOPPER1_OUT_INVERT_W<CARRIER1_CFG_SPEC> {
        CHOPPER1_OUT_INVERT_W::new(self, 12)
    }
    #[doc = "Bit 13 - when set, invert the input of PWM1A and PWM1B for this submodule"]
    #[inline(always)]
    #[must_use]
    pub fn chopper1_in_invert(&mut self) -> CHOPPER1_IN_INVERT_W<CARRIER1_CFG_SPEC> {
