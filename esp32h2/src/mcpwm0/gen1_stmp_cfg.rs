...
pub type CMPR1_A_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, GEN1_STMP_CFG_SPEC, 4, O>;
...
pub type CMPR1_B_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, GEN1_STMP_CFG_SPEC, 4, O>;
...
pub type CMPR1_A_SHDW_FULL_W<'a, const O: u8> = crate::BitWriter<'a, GEN1_STMP_CFG_SPEC, O>;
...
pub type CMPR1_B_SHDW_FULL_W<'a, const O: u8> = crate::BitWriter<'a, GEN1_STMP_CFG_SPEC, O>;
impl R {
