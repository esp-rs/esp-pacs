///Register `PVT_MONITOR_CONF` reader
pub type R = crate::R<PVT_MONITOR_CONF_SPEC>;
///Register `PVT_MONITOR_CONF` writer
pub type W = crate::W<PVT_MONITOR_CONF_SPEC>;
///Field `PVT_MONITOR_CLK_EN` reader - Set 1 to enable apb clock of pvt module
pub type PVT_MONITOR_CLK_EN_R = crate::BitReader;
///Field `PVT_MONITOR_CLK_EN` writer - Set 1 to enable apb clock of pvt module
pub type PVT_MONITOR_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PVT_MONITOR_RST_EN` reader - Set 0 to reset all pvt monitor module
pub type PVT_MONITOR_RST_EN_R = crate::BitReader;
///Field `PVT_MONITOR_RST_EN` writer - Set 0 to reset all pvt monitor module
pub type PVT_MONITOR_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PVT_MONITOR_SITE1_CLK_EN` reader - Set 1 to enable function clock of modem pvt module
pub type PVT_MONITOR_SITE1_CLK_EN_R = crate::BitReader;
///Field `PVT_MONITOR_SITE1_CLK_EN` writer - Set 1 to enable function clock of modem pvt module
pub type PVT_MONITOR_SITE1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PVT_MONITOR_SITE2_CLK_EN` reader - Set 1 to enable function clock of cpu pvt module
pub type PVT_MONITOR_SITE2_CLK_EN_R = crate::BitReader;
///Field `PVT_MONITOR_SITE2_CLK_EN` writer - Set 1 to enable function clock of cpu pvt module
pub type PVT_MONITOR_SITE2_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PVT_MONITOR_SITE3_CLK_EN` reader - Set 1 to enable function clock of hp_peri pvt module
pub type PVT_MONITOR_SITE3_CLK_EN_R = crate::BitReader;
///Field `PVT_MONITOR_SITE3_CLK_EN` writer - Set 1 to enable function clock of hp_peri pvt module
...
///`read()` method returns [`pvt_monitor_conf::R`](R) reader structure
impl crate::Readable for PVT_MONITOR_CONF_SPEC {}
///`write(|w| ..)` method takes [`pvt_monitor_conf::W`](W) writer structure
