...
///`read()` method returns [`modem_conf::R`](R) reader structure
impl crate::Readable for MODEM_CONF_SPEC {}
///`write(|w| ..)` method takes [`modem_conf::W`](W) writer structure
