///Register `UART0_PD_CTRL` reader
pub type R = crate::R<UART0_PD_CTRL_SPEC>;
///Register `UART0_PD_CTRL` writer
pub type W = crate::W<UART0_PD_CTRL_SPEC>;
///Field `UART0_MEM_FORCE_PU` reader - Set this bit to force power down UART0 memory.
pub type UART0_MEM_FORCE_PU_R = crate::BitReader;
///Field `UART0_MEM_FORCE_PU` writer - Set this bit to force power down UART0 memory.
pub type UART0_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART0_MEM_FORCE_PD` reader - Set this bit to force power up UART0 memory.
pub type UART0_MEM_FORCE_PD_R = crate::BitReader;
///Field `UART0_MEM_FORCE_PD` writer - Set this bit to force power up UART0 memory.
...
///`read()` method returns [`uart0_pd_ctrl::R`](R) reader structure
impl crate::Readable for UART0_PD_CTRL_SPEC {}
///`write(|w| ..)` method takes [`uart0_pd_ctrl::W`](W) writer structure
impl crate::Writable for UART0_PD_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets UART0_PD_CTRL to value 0x02
