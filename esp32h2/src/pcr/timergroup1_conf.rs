///Register `TIMERGROUP1_CONF` reader
pub type R = crate::R<TIMERGROUP1_CONF_SPEC>;
///Register `TIMERGROUP1_CONF` writer
pub type W = crate::W<TIMERGROUP1_CONF_SPEC>;
///Field `TG1_CLK_EN` reader - Set 1 to enable timer_group1 apb clock
pub type TG1_CLK_EN_R = crate::BitReader;
///Field `TG1_CLK_EN` writer - Set 1 to enable timer_group1 apb clock
pub type TG1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TG1_RST_EN` reader - Set 0 to reset timer_group1 module
pub type TG1_RST_EN_R = crate::BitReader;
///Field `TG1_RST_EN` writer - Set 0 to reset timer_group1 module
pub type TG1_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TG1_WDT_READY` reader - Query this field after reset timer_group1 wdt module
pub type TG1_WDT_READY_R = crate::BitReader;
///Field `TG1_TIMER0_READY` reader - Query this field after reset timer_group1 timer0 module
pub type TG1_TIMER0_READY_R = crate::BitReader;
///Field `TG1_TIMER1_READY` reader - reserved
pub type TG1_TIMER1_READY_R = crate::BitReader;
impl R {
    ///Bit 0 - Set 1 to enable timer_group1 apb clock
    #[inline(always)]
    pub fn tg1_clk_en(&self) -> TG1_CLK_EN_R {
        TG1_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 0 to reset timer_group1 module
    #[inline(always)]
    pub fn tg1_rst_en(&self) -> TG1_RST_EN_R {
        TG1_RST_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Query this field after reset timer_group1 wdt module
    #[inline(always)]
    pub fn tg1_wdt_ready(&self) -> TG1_WDT_READY_R {
        TG1_WDT_READY_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Query this field after reset timer_group1 timer0 module
    #[inline(always)]
...
///`read()` method returns [`timergroup1_conf::R`](R) reader structure
impl crate::Readable for TIMERGROUP1_CONF_SPEC {}
///`write(|w| ..)` method takes [`timergroup1_conf::W`](W) writer structure
