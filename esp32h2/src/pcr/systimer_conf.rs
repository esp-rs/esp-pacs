///Register `SYSTIMER_CONF` reader
pub type R = crate::R<SYSTIMER_CONF_SPEC>;
///Register `SYSTIMER_CONF` writer
pub type W = crate::W<SYSTIMER_CONF_SPEC>;
///Field `SYSTIMER_CLK_EN` reader - Set 1 to enable systimer apb clock
pub type SYSTIMER_CLK_EN_R = crate::BitReader;
///Field `SYSTIMER_CLK_EN` writer - Set 1 to enable systimer apb clock
pub type SYSTIMER_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYSTIMER_RST_EN` reader - Set 0 to reset systimer module
pub type SYSTIMER_RST_EN_R = crate::BitReader;
///Field `SYSTIMER_RST_EN` writer - Set 0 to reset systimer module
pub type SYSTIMER_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYSTIMER_READY` reader - Query this field after reset systimer module
...
///`read()` method returns [`systimer_conf::R`](R) reader structure
impl crate::Readable for SYSTIMER_CONF_SPEC {}
///`write(|w| ..)` method takes [`systimer_conf::W`](W) writer structure
