...
///Register `PARL_CLK_TX_CONF` writer
pub type W = crate::W<PARL_CLK_TX_CONF_SPEC>;
///Field `PARL_CLK_TX_DIV_NUM` reader - The integral part of the frequency divider factor of the parl tx clock.
pub type PARL_CLK_TX_DIV_NUM_R = crate::FieldReader<u16>;
///Field `PARL_CLK_TX_DIV_NUM` writer - The integral part of the frequency divider factor of the parl tx clock.
pub type PARL_CLK_TX_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `PARL_CLK_TX_SEL` reader - set this field to select clock-source. 0(default): XTAL, 1: 240MHz, 2: FOSC, 3: user clock from pad.
pub type PARL_CLK_TX_SEL_R = crate::FieldReader;
///Field `PARL_CLK_TX_SEL` writer - set this field to select clock-source. 0(default): XTAL, 1: 240MHz, 2: FOSC, 3: user clock from pad.
pub type PARL_CLK_TX_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `PARL_CLK_TX_EN` reader - Set 1 to enable parl tx clock
pub type PARL_CLK_TX_EN_R = crate::BitReader;
///Field `PARL_CLK_TX_EN` writer - Set 1 to enable parl tx clock
pub type PARL_CLK_TX_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PARL_TX_RST_EN` reader - Set 0 to reset parl tx module
pub type PARL_TX_RST_EN_R = crate::BitReader;
///Field `PARL_TX_RST_EN` writer - Set 0 to reset parl tx module
...
You can [`read`](crate::generic::Reg::read) this register and get [`parl_clk_tx_conf::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`parl_clk_tx_conf::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PARL_CLK_TX_CONF_SPEC;
impl crate::RegisterSpec for PARL_CLK_TX_CONF_SPEC {
    type Ux = u32;
}
///`read()` method returns [`parl_clk_tx_conf::R`](R) reader structure
impl crate::Readable for PARL_CLK_TX_CONF_SPEC {}
///`write(|w| ..)` method takes [`parl_clk_tx_conf::W`](W) writer structure
