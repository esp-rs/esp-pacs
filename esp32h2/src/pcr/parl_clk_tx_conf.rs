...
pub type PARL_CLK_TX_DIV_NUM_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
...
pub type PARL_CLK_TX_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type PARL_CLK_TX_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PARL_TX_RST_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn parl_clk_tx_div_num(&mut self) -> PARL_CLK_TX_DIV_NUM_W<PARL_CLK_TX_CONF_SPEC, 0> {
        PARL_CLK_TX_DIV_NUM_W::new(self)
    }
    #[doc = "Bits 16:17 - set this field to select clock-source. 0(default): XTAL, 1: 240MHz, 2: FOSC, 3: user clock from pad."]
    #[inline(always)]
    #[must_use]
    pub fn parl_clk_tx_sel(&mut self) -> PARL_CLK_TX_SEL_W<PARL_CLK_TX_CONF_SPEC, 16> {
        PARL_CLK_TX_SEL_W::new(self)
    }
    #[doc = "Bit 18 - Set 1 to enable parl tx clock"]
    #[inline(always)]
    #[must_use]
    pub fn parl_clk_tx_en(&mut self) -> PARL_CLK_TX_EN_W<PARL_CLK_TX_CONF_SPEC, 18> {
