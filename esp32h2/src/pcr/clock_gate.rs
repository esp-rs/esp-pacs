...
///Field `CLK_EN` reader - Set this bit as 1 to force on clock gating.
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - Set this bit as 1 to force on clock gating.
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit as 1 to force on clock gating.
    #[inline(always)]
