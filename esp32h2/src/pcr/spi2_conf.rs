...
pub type SPI2_RST_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi2_clk_en(&mut self) -> SPI2_CLK_EN_W<SPI2_CONF_SPEC, 0> {
        SPI2_CLK_EN_W::new(self)
    }
    #[doc = "Bit 1 - Set 0 to reset spi2 module"]
    #[inline(always)]
    #[must_use]
    pub fn spi2_rst_en(&mut self) -> SPI2_RST_EN_W<SPI2_CONF_SPEC, 1> {
