///Register `ECDSA_CONF` reader
pub type R = crate::R<ECDSA_CONF_SPEC>;
///Register `ECDSA_CONF` writer
pub type W = crate::W<ECDSA_CONF_SPEC>;
///Field `ECDSA_CLK_EN` reader - Set 1 to enable ecdsa clock
pub type ECDSA_CLK_EN_R = crate::BitReader;
///Field `ECDSA_CLK_EN` writer - Set 1 to enable ecdsa clock
pub type ECDSA_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ECDSA_RST_EN` reader - Set 0 to reset ecdsa module
pub type ECDSA_RST_EN_R = crate::BitReader;
///Field `ECDSA_RST_EN` writer - Set 0 to reset ecdsa module
pub type ECDSA_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ECDSA_READY` reader - Query this field after reset ecdsa module
pub type ECDSA_READY_R = crate::BitReader;
impl R {
    ///Bit 0 - Set 1 to enable ecdsa clock
    #[inline(always)]
    pub fn ecdsa_clk_en(&self) -> ECDSA_CLK_EN_R {
        ECDSA_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 0 to reset ecdsa module
    #[inline(always)]
    pub fn ecdsa_rst_en(&self) -> ECDSA_RST_EN_R {
        ECDSA_RST_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Query this field after reset ecdsa module
    #[inline(always)]
...
///`read()` method returns [`ecdsa_conf::R`](R) reader structure
impl crate::Readable for ECDSA_CONF_SPEC {}
///`write(|w| ..)` method takes [`ecdsa_conf::W`](W) writer structure
