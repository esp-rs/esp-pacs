///Register `SRAM_POWER_CONF_0` reader
pub type R = crate::R<SRAM_POWER_CONF_0_SPEC>;
///Register `SRAM_POWER_CONF_0` writer
...
impl R {
    ///Bits 13:14 - Set this bit to force power up ROM
    #[inline(always)]
    pub fn rom_force_pu(&self) -> ROM_FORCE_PU_R {
        ROM_FORCE_PU_R::new(((self.bits >> 13) & 3) as u8)
    }
    ///Bits 15:16 - Set this bit to force power down ROM.
    #[inline(always)]
    pub fn rom_force_pd(&self) -> ROM_FORCE_PD_R {
        ROM_FORCE_PD_R::new(((self.bits >> 15) & 3) as u8)
    }
    ///Bits 17:18 - 1: Force to open the clock and bypass the gate-clock when accessing the ROM. 0: A gate-clock will be used when accessing the ROM.
    #[inline(always)]
...
///`read()` method returns [`sram_power_conf_0::R`](R) reader structure
impl crate::Readable for SRAM_POWER_CONF_0_SPEC {}
///`write(|w| ..)` method takes [`sram_power_conf_0::W`](W) writer structure
