...
///Field `CPUPERIOD_SEL` reader - Reserved. This filed has been replaced by PCR_CPU_DIV_NUM
pub type CPUPERIOD_SEL_R = crate::FieldReader;
///Field `PLL_FREQ_SEL` reader - Reserved. This filed has been replaced by PCR_CPU_DIV_NUM
...
impl R {
    ///Bits 0:1 - Reserved. This filed has been replaced by PCR_CPU_DIV_NUM
    #[inline(always)]
    pub fn cpuperiod_sel(&self) -> CPUPERIOD_SEL_R {
        CPUPERIOD_SEL_R::new((self.bits & 3) as u8)
    }
    ///Bit 2 - Reserved. This filed has been replaced by PCR_CPU_DIV_NUM
    #[inline(always)]
