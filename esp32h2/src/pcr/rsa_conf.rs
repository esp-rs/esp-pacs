...
pub struct R(crate::R<RSA_CONF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RSA_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RSA_CONF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RSA_CONF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RSA_CONF` writer"]
pub struct W(crate::W<RSA_CONF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RSA_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RSA_CONF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RSA_CONF_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `RSA_CLK_EN` reader - Set 1 to enable rsa clock"]
pub type RSA_CLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `RSA_CLK_EN` writer - Set 1 to enable rsa clock"]
pub type RSA_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RSA_CONF_SPEC, bool, O>;
#[doc = "Field `RSA_RST_EN` reader - Set 0 to reset rsa module"]
pub type RSA_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `RSA_RST_EN` writer - Set 0 to reset rsa module"]
pub type RSA_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RSA_CONF_SPEC, bool, O>;
#[doc = "Field `RSA_READY` reader - Query this field after reset rsa module"]
pub type RSA_READY_R = crate::BitReader<bool>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rsa_clk_en(&mut self) -> RSA_CLK_EN_W<0> {
        RSA_CLK_EN_W::new(self)
    }
    #[doc = "Bit 1 - Set 0 to reset rsa module"]
    #[inline(always)]
    #[must_use]
    pub fn rsa_rst_en(&mut self) -> RSA_RST_EN_W<1> {
