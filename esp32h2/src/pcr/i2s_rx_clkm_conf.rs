...
pub type I2S_RX_CLKM_EN_R = crate::BitReader<bool>;
#[doc = "Field `I2S_RX_CLKM_EN` writer - Set 1 to enable i2s_rx function clock"]
pub type I2S_RX_CLKM_EN_W<'a, const O: u8> =
