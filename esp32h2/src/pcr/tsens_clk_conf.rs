...
pub type TSENS_CLK_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TSENS_CLK_CONF_SPEC, bool, O>;
...
pub type TSENS_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TSENS_CLK_CONF_SPEC, bool, O>;
#[doc = "Field `TSENS_RST_EN` reader - Set 0 to reset tsens module"]
pub type TSENS_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `TSENS_RST_EN` writer - Set 0 to reset tsens module"]
pub type TSENS_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TSENS_CLK_CONF_SPEC, bool, O>;
impl R {
