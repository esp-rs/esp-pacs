...
pub struct R(crate::R<TIMERGROUP1_TIMER_CLK_CONF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMERGROUP1_TIMER_CLK_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMERGROUP1_TIMER_CLK_CONF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMERGROUP1_TIMER_CLK_CONF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMERGROUP1_TIMER_CLK_CONF` writer"]
pub struct W(crate::W<TIMERGROUP1_TIMER_CLK_CONF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMERGROUP1_TIMER_CLK_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMERGROUP1_TIMER_CLK_CONF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMERGROUP1_TIMER_CLK_CONF_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tg1_timer_clk_sel(&mut self) -> TG1_TIMER_CLK_SEL_W<20> {
        TG1_TIMER_CLK_SEL_W::new(self)
    }
    #[doc = "Bit 22 - Set 1 to enable timer_group1 timer clock"]
    #[inline(always)]
    #[must_use]
    pub fn tg1_timer_clk_en(&mut self) -> TG1_TIMER_CLK_EN_W<22> {
