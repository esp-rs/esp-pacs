///Register `CTRL_32K_CONF` reader
pub type R = crate::R<CTRL_32K_CONF_SPEC>;
///Register `CTRL_32K_CONF` writer
pub type W = crate::W<CTRL_32K_CONF_SPEC>;
///Field `CLK_32K_SEL` reader - This field indicates which one 32KHz clock will be used by timergroup. 0: OSC32K(default), 1: XTAL32K, 2/3: 32KHz from pad GPIO0.
pub type CLK_32K_SEL_R = crate::FieldReader;
///Field `CLK_32K_SEL` writer - This field indicates which one 32KHz clock will be used by timergroup. 0: OSC32K(default), 1: XTAL32K, 2/3: 32KHz from pad GPIO0.
pub type CLK_32K_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `_32K_MODEM_SEL` reader - This field indicates which one 32KHz clock will be used by MODEM_SYSTEM. 0: OSC32K(default), 1: XTAL32K, 2/3: 32KHz from pad GPIO0.
pub type _32K_MODEM_SEL_R = crate::FieldReader;
///Field `_32K_MODEM_SEL` writer - This field indicates which one 32KHz clock will be used by MODEM_SYSTEM. 0: OSC32K(default), 1: XTAL32K, 2/3: 32KHz from pad GPIO0.
pub type _32K_MODEM_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - This field indicates which one 32KHz clock will be used by timergroup. 0: OSC32K(default), 1: XTAL32K, 2/3: 32KHz from pad GPIO0.
    #[inline(always)]
    pub fn clk_32k_sel(&self) -> CLK_32K_SEL_R {
        CLK_32K_SEL_R::new((self.bits & 3) as u8)
    }
    ///Bits 2:3 - This field indicates which one 32KHz clock will be used by MODEM_SYSTEM. 0: OSC32K(default), 1: XTAL32K, 2/3: 32KHz from pad GPIO0.
    #[inline(always)]
...
///`read()` method returns [`ctrl_32k_conf::R`](R) reader structure
impl crate::Readable for CTRL_32K_CONF_SPEC {}
///`write(|w| ..)` method takes [`ctrl_32k_conf::W`](W) writer structure
