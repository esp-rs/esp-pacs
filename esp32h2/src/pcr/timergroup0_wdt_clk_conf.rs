...
pub type TG0_WDT_CLK_SEL_R = crate::FieldReader<u8, u8>;
...
pub type TG0_WDT_CLK_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIMERGROUP0_WDT_CLK_CONF_SPEC, u8, u8, 2, O>;
#[doc = "Field `TG0_WDT_CLK_EN` reader - Set 1 to enable timer_group0 wdt clock"]
pub type TG0_WDT_CLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `TG0_WDT_CLK_EN` writer - Set 1 to enable timer_group0 wdt clock"]
pub type TG0_WDT_CLK_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TIMERGROUP0_WDT_CLK_CONF_SPEC, bool, O>;
impl R {
