...
pub type UART0_SCLK_SEL_R = crate::FieldReader<u8, u8>;
...
pub type UART0_SCLK_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UART0_SCLK_CONF_SPEC, u8, u8, 2, O>;
#[doc = "Field `UART0_SCLK_EN` reader - Set 1 to enable uart0 function clock"]
pub type UART0_SCLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `UART0_SCLK_EN` writer - Set 1 to enable uart0 function clock"]
pub type UART0_SCLK_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, UART0_SCLK_CONF_SPEC, bool, O>;
impl R {
