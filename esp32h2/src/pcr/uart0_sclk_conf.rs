...
pub type UART0_SCLK_DIV_A_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
pub type UART0_SCLK_DIV_B_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
pub type UART0_SCLK_DIV_NUM_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type UART0_SCLK_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type UART0_SCLK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uart0_sclk_div_a(&mut self) -> UART0_SCLK_DIV_A_W<UART0_SCLK_CONF_SPEC, 0> {
        UART0_SCLK_DIV_A_W::new(self)
    }
    #[doc = "Bits 6:11 - The numerator of the frequency divider factor of the uart0 function clock."]
    #[inline(always)]
    #[must_use]
    pub fn uart0_sclk_div_b(&mut self) -> UART0_SCLK_DIV_B_W<UART0_SCLK_CONF_SPEC, 6> {
        UART0_SCLK_DIV_B_W::new(self)
    }
    #[doc = "Bits 12:19 - The integral part of the frequency divider factor of the uart0 function clock."]
    #[inline(always)]
    #[must_use]
    pub fn uart0_sclk_div_num(&mut self) -> UART0_SCLK_DIV_NUM_W<UART0_SCLK_CONF_SPEC, 12> {
        UART0_SCLK_DIV_NUM_W::new(self)
    }
    #[doc = "Bits 20:21 - set this field to select clock-source. 0: do not select anyone clock, 1: 80MHz, 2: FOSC, 3(default): XTAL."]
    #[inline(always)]
    #[must_use]
    pub fn uart0_sclk_sel(&mut self) -> UART0_SCLK_SEL_W<UART0_SCLK_CONF_SPEC, 20> {
        UART0_SCLK_SEL_W::new(self)
    }
    #[doc = "Bit 22 - Set 1 to enable uart0 function clock"]
    #[inline(always)]
    #[must_use]
    pub fn uart0_sclk_en(&mut self) -> UART0_SCLK_EN_W<UART0_SCLK_CONF_SPEC, 22> {
