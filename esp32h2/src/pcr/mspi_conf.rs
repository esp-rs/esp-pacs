...
///Field `MSPI_CLK_SEL` reader - set this field to select clock-source.
pub type MSPI_CLK_SEL_R = crate::FieldReader;
///Field `MSPI_CLK_SEL` writer - set this field to select clock-source.
pub type MSPI_CLK_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `MSPI_READY` reader - Query this field after reset mspi module
...
impl R {
    ...
    ///Bits 3:4 - set this field to select clock-source.
    #[inline(always)]
    pub fn mspi_clk_sel(&self) -> MSPI_CLK_SEL_R {
        MSPI_CLK_SEL_R::new(((self.bits >> 3) & 3) as u8)
    }
    ///Bit 5 - Query this field after reset mspi module
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MSPI_CONF")
            ...
            .field("mspi_clk_sel", &self.mspi_clk_sel())
