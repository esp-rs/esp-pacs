...
///Field `UART0_READY` reader - Query this field after reset uart0 module
...
impl R {
    ...
    ///Bit 2 - Query this field after reset uart0 module
    #[inline(always)]
...
///`reset()` method sets UART0_CONF to value 0x05
