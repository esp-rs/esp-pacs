...
///Field `I2S_TX_CLKM_DIV_NUM` reader - Integral I2S TX clock divider value. f_I2S_CLK = f_I2S_CLK_S/(N+b/a). There will be (a-b) * n-div and b * (n+1)-div. So the average combination will be: for b &lt;= a/2, z * \[x * n-div + (n+1)-div\] + y * n-div. For b > a/2, z * \[n-div + x * (n+1)-div\] + y * (n+1)-div.
pub type I2S_TX_CLKM_DIV_NUM_R = crate::FieldReader;
///Field `I2S_TX_CLKM_DIV_NUM` writer - Integral I2S TX clock divider value. f_I2S_CLK = f_I2S_CLK_S/(N+b/a). There will be (a-b) * n-div and b * (n+1)-div. So the average combination will be: for b &lt;= a/2, z * \[x * n-div + (n+1)-div\] + y * n-div. For b > a/2, z * \[n-div + x * (n+1)-div\] + y * (n+1)-div.
pub type I2S_TX_CLKM_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `I2S_TX_CLKM_SEL` reader - Select I2S Tx module source clock. 0: XTAL clock. 1: APLL. 2: CLK160. 3: I2S_MCLK_in.
pub type I2S_TX_CLKM_SEL_R = crate::FieldReader;
///Field `I2S_TX_CLKM_SEL` writer - Select I2S Tx module source clock. 0: XTAL clock. 1: APLL. 2: CLK160. 3: I2S_MCLK_in.
pub type I2S_TX_CLKM_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `I2S_TX_CLKM_EN` reader - Set 1 to enable i2s_tx function clock
pub type I2S_TX_CLKM_EN_R = crate::BitReader;
///Field `I2S_TX_CLKM_EN` writer - Set 1 to enable i2s_tx function clock
...
///`read()` method returns [`i2s_tx_clkm_conf::R`](R) reader structure
impl crate::Readable for I2S_TX_CLKM_CONF_SPEC {}
///`write(|w| ..)` method takes [`i2s_tx_clkm_conf::W`](W) writer structure
...
impl crate::Resettable for I2S_TX_CLKM_CONF_SPEC {
    const RESET_VALUE: u32 = 0x0040_2000;
}
