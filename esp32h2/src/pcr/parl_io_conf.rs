...
pub type PARL_CLK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PARL_RST_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn parl_clk_en(&mut self) -> PARL_CLK_EN_W<PARL_IO_CONF_SPEC, 0> {
        PARL_CLK_EN_W::new(self)
    }
    #[doc = "Bit 1 - Set 0 to reset parl apb reg"]
    #[inline(always)]
    #[must_use]
    pub fn parl_rst_en(&mut self) -> PARL_RST_EN_W<PARL_IO_CONF_SPEC, 1> {
