///Register `UHCI_CONF` reader
pub type R = crate::R<UHCI_CONF_SPEC>;
///Register `UHCI_CONF` writer
pub type W = crate::W<UHCI_CONF_SPEC>;
///Field `UHCI_CLK_EN` reader - Set 1 to enable uhci clock
pub type UHCI_CLK_EN_R = crate::BitReader;
///Field `UHCI_CLK_EN` writer - Set 1 to enable uhci clock
pub type UHCI_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UHCI_RST_EN` reader - Set 0 to reset uhci module
pub type UHCI_RST_EN_R = crate::BitReader;
///Field `UHCI_RST_EN` writer - Set 0 to reset uhci module
pub type UHCI_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UHCI_READY` reader - Query this field after reset uhci module
pub type UHCI_READY_R = crate::BitReader;
impl R {
    ///Bit 0 - Set 1 to enable uhci clock
    #[inline(always)]
    pub fn uhci_clk_en(&self) -> UHCI_CLK_EN_R {
        UHCI_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 0 to reset uhci module
    #[inline(always)]
    pub fn uhci_rst_en(&self) -> UHCI_RST_EN_R {
        UHCI_RST_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Query this field after reset uhci module
    #[inline(always)]
...
///`read()` method returns [`uhci_conf::R`](R) reader structure
impl crate::Readable for UHCI_CONF_SPEC {}
///`write(|w| ..)` method takes [`uhci_conf::W`](W) writer structure
