///Register `ADC_INV_PHASE_CONF` reader
pub type R = crate::R<ADC_INV_PHASE_CONF_SPEC>;
///Register `ADC_INV_PHASE_CONF` writer
pub type W = crate::W<ADC_INV_PHASE_CONF_SPEC>;
///Field `CLK_ADC_INV_PHASE_ENA` reader - xxxx
pub type CLK_ADC_INV_PHASE_ENA_R = crate::BitReader;
///Field `CLK_ADC_INV_PHASE_ENA` writer - xxxx
...
///`read()` method returns [`adc_inv_phase_conf::R`](R) reader structure
impl crate::Readable for ADC_INV_PHASE_CONF_SPEC {}
///`write(|w| ..)` method takes [`adc_inv_phase_conf::W`](W) writer structure
