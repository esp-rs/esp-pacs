...
///Field `UART1_MEM_FORCE_PU` reader - Set this bit to force power down UART1 memory.
pub type UART1_MEM_FORCE_PU_R = crate::BitReader;
///Field `UART1_MEM_FORCE_PU` writer - Set this bit to force power down UART1 memory.
pub type UART1_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART1_MEM_FORCE_PD` reader - Set this bit to force power up UART1 memory.
pub type UART1_MEM_FORCE_PD_R = crate::BitReader;
///Field `UART1_MEM_FORCE_PD` writer - Set this bit to force power up UART1 memory.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UART1_PD_CTRL")
            .field("uart1_mem_force_pu", &self.uart1_mem_force_pu())
            .field("uart1_mem_force_pd", &self.uart1_mem_force_pd())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`uart1_pd_ctrl::R`](R) reader structure
impl crate::Readable for UART1_PD_CTRL_SPEC {}
///`write(|w| ..)` method takes [`uart1_pd_ctrl::W`](W) writer structure
impl crate::Writable for UART1_PD_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets UART1_PD_CTRL to value 0x02
