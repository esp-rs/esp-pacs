///Register `BUS_CLK_UPDATE` reader
pub type R = crate::R<BUS_CLK_UPDATE_SPEC>;
///Register `BUS_CLK_UPDATE` writer
pub type W = crate::W<BUS_CLK_UPDATE_SPEC>;
///Field `BUS_CLOCK_UPDATE` reader - xxxx
pub type BUS_CLOCK_UPDATE_R = crate::BitReader;
///Field `BUS_CLOCK_UPDATE` writer - xxxx
...
///`read()` method returns [`bus_clk_update::R`](R) reader structure
impl crate::Readable for BUS_CLK_UPDATE_SPEC {}
///`write(|w| ..)` method takes [`bus_clk_update::W`](W) writer structure
