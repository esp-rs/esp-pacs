///Register `PWM_CONF` reader
pub type R = crate::R<PWM_CONF_SPEC>;
///Register `PWM_CONF` writer
pub type W = crate::W<PWM_CONF_SPEC>;
///Field `PWM_CLK_EN` reader - Set 1 to enable pwm clock
pub type PWM_CLK_EN_R = crate::BitReader;
///Field `PWM_CLK_EN` writer - Set 1 to enable pwm clock
pub type PWM_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM_RST_EN` reader - Set 0 to reset pwm module
pub type PWM_RST_EN_R = crate::BitReader;
///Field `PWM_RST_EN` writer - Set 0 to reset pwm module
pub type PWM_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM_READY` reader - Query this field after reset pwm module
...
impl R {
    ...
    ///Bit 2 - Query this field after reset pwm module
    #[inline(always)]
...
///`read()` method returns [`pwm_conf::R`](R) reader structure
impl crate::Readable for PWM_CONF_SPEC {}
///`write(|w| ..)` method takes [`pwm_conf::W`](W) writer structure
