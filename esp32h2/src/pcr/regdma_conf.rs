...
///Field `REGDMA_CLK_EN` reader - Set 1 to enable regdma clock
pub type REGDMA_CLK_EN_R = crate::BitReader;
///Field `REGDMA_CLK_EN` writer - Set 1 to enable regdma clock
pub type REGDMA_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REGDMA_RST_EN` reader - Set 0 to reset regdma module
pub type REGDMA_RST_EN_R = crate::BitReader;
///Field `REGDMA_RST_EN` writer - Set 0 to reset regdma module
pub type REGDMA_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to enable regdma clock
    #[inline(always)]
    pub fn regdma_clk_en(&self) -> REGDMA_CLK_EN_R {
        REGDMA_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 0 to reset regdma module
    #[inline(always)]
