///Register `TIMERGROUP0_TIMER_CLK_CONF` reader
pub type R = crate::R<TIMERGROUP0_TIMER_CLK_CONF_SPEC>;
///Register `TIMERGROUP0_TIMER_CLK_CONF` writer
pub type W = crate::W<TIMERGROUP0_TIMER_CLK_CONF_SPEC>;
///Field `TG0_TIMER_CLK_SEL` reader - set this field to select clock-source. 0(default): XTAL, 1: 80MHz, 2: FOSC, 3: reserved.
pub type TG0_TIMER_CLK_SEL_R = crate::FieldReader;
///Field `TG0_TIMER_CLK_SEL` writer - set this field to select clock-source. 0(default): XTAL, 1: 80MHz, 2: FOSC, 3: reserved.
pub type TG0_TIMER_CLK_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TG0_TIMER_CLK_EN` reader - Set 1 to enable timer_group0 timer clock
pub type TG0_TIMER_CLK_EN_R = crate::BitReader;
///Field `TG0_TIMER_CLK_EN` writer - Set 1 to enable timer_group0 timer clock
...
impl R {
    ...
    ///Bit 22 - Set 1 to enable timer_group0 timer clock
    #[inline(always)]
