...
pub type TG0_TIMER_CLK_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type TG0_TIMER_CLK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn tg0_timer_clk_sel(
        &mut self,
    ) -> TG0_TIMER_CLK_SEL_W<TIMERGROUP0_TIMER_CLK_CONF_SPEC, 20> {
        TG0_TIMER_CLK_SEL_W::new(self)
    }
    #[doc = "Bit 22 - Set 1 to enable timer_group0 timer clock"]
    #[inline(always)]
    #[must_use]
    pub fn tg0_timer_clk_en(&mut self) -> TG0_TIMER_CLK_EN_W<TIMERGROUP0_TIMER_CLK_CONF_SPEC, 22> {
