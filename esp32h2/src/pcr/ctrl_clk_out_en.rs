...
///Field `CLK8_OEN` reader - Set 1 to enable 8m clock
pub type CLK8_OEN_R = crate::BitReader;
///Field `CLK8_OEN` writer - Set 1 to enable 8m clock
pub type CLK8_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK16_OEN` reader - Set 1 to enable 16m clock
pub type CLK16_OEN_R = crate::BitReader;
///Field `CLK16_OEN` writer - Set 1 to enable 16m clock
pub type CLK16_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK32_OEN` reader - Set 1 to enable 32m clock
pub type CLK32_OEN_R = crate::BitReader;
///Field `CLK32_OEN` writer - Set 1 to enable 32m clock
...
///Field `CLK_DFM_INF_OEN` reader - Reserved
pub type CLK_DFM_INF_OEN_R = crate::BitReader;
///Field `CLK_DFM_INF_OEN` writer - Reserved
pub type CLK_DFM_INF_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_SDM_MOD_OEN` reader - Reserved
pub type CLK_SDM_MOD_OEN_R = crate::BitReader;
///Field `CLK_SDM_MOD_OEN` writer - Reserved
...
impl R {
    ...
    ///Bit 6 - Set 1 to enable xtal clock
    #[inline(always)]
