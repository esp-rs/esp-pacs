///Register `MEM_MONITOR_CONF` reader
pub type R = crate::R<MEM_MONITOR_CONF_SPEC>;
///Register `MEM_MONITOR_CONF` writer
pub type W = crate::W<MEM_MONITOR_CONF_SPEC>;
///Field `MEM_MONITOR_CLK_EN` reader - Set 1 to enable mem_monitor clock
pub type MEM_MONITOR_CLK_EN_R = crate::BitReader;
///Field `MEM_MONITOR_CLK_EN` writer - Set 1 to enable mem_monitor clock
pub type MEM_MONITOR_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_MONITOR_RST_EN` reader - Set 0 to reset mem_monitor module
pub type MEM_MONITOR_RST_EN_R = crate::BitReader;
///Field `MEM_MONITOR_RST_EN` writer - Set 0 to reset mem_monitor module
pub type MEM_MONITOR_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_MONITOR_READY` reader - Query this field after reset mem_monitor module
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MEM_MONITOR_CONF")
            ...
            .field("mem_monitor_ready", &self.mem_monitor_ready())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`mem_monitor_conf::R`](R) reader structure
impl crate::Readable for MEM_MONITOR_CONF_SPEC {}
///`write(|w| ..)` method takes [`mem_monitor_conf::W`](W) writer structure
