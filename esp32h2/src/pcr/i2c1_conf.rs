...
pub type I2C1_CLK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C1_RST_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c1_clk_en(&mut self) -> I2C1_CLK_EN_W<I2C1_CONF_SPEC, 0> {
        I2C1_CLK_EN_W::new(self)
    }
    #[doc = "Bit 1 - Set 0 to reset i2c module"]
    #[inline(always)]
    #[must_use]
    pub fn i2c1_rst_en(&mut self) -> I2C1_RST_EN_W<I2C1_CONF_SPEC, 1> {
