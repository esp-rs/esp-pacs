///Register `ECC_CONF` reader
pub type R = crate::R<ECC_CONF_SPEC>;
///Register `ECC_CONF` writer
pub type W = crate::W<ECC_CONF_SPEC>;
///Field `ECC_CLK_EN` reader - Set 1 to enable ecc clock
pub type ECC_CLK_EN_R = crate::BitReader;
///Field `ECC_CLK_EN` writer - Set 1 to enable ecc clock
pub type ECC_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ECC_RST_EN` reader - Set 0 to reset ecc module
pub type ECC_RST_EN_R = crate::BitReader;
///Field `ECC_RST_EN` writer - Set 0 to reset ecc module
pub type ECC_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ECC_READY` reader - Query this field after reset ecc module
pub type ECC_READY_R = crate::BitReader;
impl R {
    ///Bit 0 - Set 1 to enable ecc clock
    #[inline(always)]
    pub fn ecc_clk_en(&self) -> ECC_CLK_EN_R {
        ECC_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 0 to reset ecc module
    #[inline(always)]
    pub fn ecc_rst_en(&self) -> ECC_RST_EN_R {
        ECC_RST_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Query this field after reset ecc module
    #[inline(always)]
...
///`read()` method returns [`ecc_conf::R`](R) reader structure
impl crate::Readable for ECC_CONF_SPEC {}
///`write(|w| ..)` method takes [`ecc_conf::W`](W) writer structure
