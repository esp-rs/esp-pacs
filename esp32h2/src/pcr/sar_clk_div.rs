...
///`read()` method returns [`sar_clk_div::R`](R) reader structure
impl crate::Readable for SAR_CLK_DIV_SPEC {}
///`write(|w| ..)` method takes [`sar_clk_div::W`](W) writer structure
