///Register `TIMERGROUP0_CONF` reader
pub type R = crate::R<TIMERGROUP0_CONF_SPEC>;
///Register `TIMERGROUP0_CONF` writer
pub type W = crate::W<TIMERGROUP0_CONF_SPEC>;
///Field `TG0_CLK_EN` reader - Set 1 to enable timer_group0 apb clock
pub type TG0_CLK_EN_R = crate::BitReader;
///Field `TG0_CLK_EN` writer - Set 1 to enable timer_group0 apb clock
pub type TG0_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TG0_RST_EN` reader - Set 0 to reset timer_group0 module
pub type TG0_RST_EN_R = crate::BitReader;
///Field `TG0_RST_EN` writer - Set 0 to reset timer_group0 module
pub type TG0_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TG0_WDT_READY` reader - Query this field after reset timer_group0 wdt module
pub type TG0_WDT_READY_R = crate::BitReader;
///Field `TG0_TIMER0_READY` reader - Query this field after reset timer_group0 timer0 module
pub type TG0_TIMER0_READY_R = crate::BitReader;
///Field `TG0_TIMER1_READY` reader - reserved
pub type TG0_TIMER1_READY_R = crate::BitReader;
impl R {
    ///Bit 0 - Set 1 to enable timer_group0 apb clock
    #[inline(always)]
    pub fn tg0_clk_en(&self) -> TG0_CLK_EN_R {
        TG0_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 0 to reset timer_group0 module
    #[inline(always)]
    pub fn tg0_rst_en(&self) -> TG0_RST_EN_R {
        TG0_RST_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Query this field after reset timer_group0 wdt module
    #[inline(always)]
    pub fn tg0_wdt_ready(&self) -> TG0_WDT_READY_R {
        TG0_WDT_READY_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Query this field after reset timer_group0 timer0 module
    #[inline(always)]
...
///`read()` method returns [`timergroup0_conf::R`](R) reader structure
impl crate::Readable for TIMERGROUP0_CONF_SPEC {}
///`write(|w| ..)` method takes [`timergroup0_conf::W`](W) writer structure
