///Register `SRAM_POWER_CONF_1` reader
pub type R = crate::R<SRAM_POWER_CONF_1_SPEC>;
///Register `SRAM_POWER_CONF_1` writer
...
///`read()` method returns [`sram_power_conf_1::R`](R) reader structure
impl crate::Readable for SRAM_POWER_CONF_1_SPEC {}
///`write(|w| ..)` method takes [`sram_power_conf_1::W`](W) writer structure
