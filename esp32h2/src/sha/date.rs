...
#[doc = "Field `DATE` reader - Sha date information/ sha version information."]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - Sha date information/ sha version information."]
...
#[doc = "`reset()` method sets DATE to value 0x2020_1229"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x2020_1229;
}
