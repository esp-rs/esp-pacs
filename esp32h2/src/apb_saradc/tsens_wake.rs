...
///`read()` method returns [`tsens_wake::R`](R) reader structure
impl crate::Readable for TSENS_WAKE_SPEC {}
///`write(|w| ..)` method takes [`tsens_wake::W`](W) writer structure
