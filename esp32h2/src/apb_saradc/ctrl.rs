...
///Field `SARADC2_PWDET_DRV` reader - enable saradc2 power detect driven func.
pub type SARADC2_PWDET_DRV_R = crate::BitReader;
///Field `SARADC2_PWDET_DRV` writer - enable saradc2 power detect driven func.
...
impl R {
    ...
    ///Bit 29 - enable saradc2 power detect driven func.
    #[inline(always)]
