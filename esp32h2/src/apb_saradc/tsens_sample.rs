///Register `TSENS_SAMPLE` reader
pub type R = crate::R<TSENS_SAMPLE_SPEC>;
///Register `TSENS_SAMPLE` writer
pub type W = crate::W<TSENS_SAMPLE_SPEC>;
///Field `RATE` reader - HW sample rate
pub type RATE_R = crate::FieldReader<u16>;
///Field `RATE` writer - HW sample rate
pub type RATE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `EN` reader - HW sample en
pub type EN_R = crate::BitReader;
///Field `EN` writer - HW sample en
...
///`read()` method returns [`tsens_sample::R`](R) reader structure
impl crate::Readable for TSENS_SAMPLE_SPEC {}
///`write(|w| ..)` method takes [`tsens_sample::W`](W) writer structure
