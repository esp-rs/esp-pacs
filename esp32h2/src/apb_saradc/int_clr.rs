...
pub type APB_SARADC_TSENS_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn apb_saradc_tsens_int_clr(&mut self) -> APB_SARADC_TSENS_INT_CLR_W<INT_CLR_SPEC, 25> {
        APB_SARADC_TSENS_INT_CLR_W::new(self)
    }
