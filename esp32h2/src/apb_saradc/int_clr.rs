...
///Field `TSENS` writer - saradc tsens interrupt clear
pub type TSENS_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `THRES1_LOW` writer - saradc thres1 low interrupt clear
pub type THRES1_LOW_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `THRES0_LOW` writer - saradc thres0 low interrupt clear
pub type THRES0_LOW_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `THRES1_HIGH` writer - saradc thres1 high interrupt clear
pub type THRES1_HIGH_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `THRES0_HIGH` writer - saradc thres0 high interrupt clear
pub type THRES0_HIGH_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `ADC2_DONE` writer - saradc2 done interrupt clear
pub type ADC2_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `ADC1_DONE` writer - saradc1 done interrupt clear
...
impl W {
    ///Bit 25 - saradc tsens interrupt clear
    #[inline(always)]
    #[must_use]
