...
pub type APB_SARADC_THRES1_CHANNEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type APB_SARADC_THRES1_HIGH_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 13, O, u16>;
...
pub type APB_SARADC_THRES1_LOW_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 13, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn apb_saradc_thres1_channel(
        &mut self,
    ) -> APB_SARADC_THRES1_CHANNEL_W<THRES1_CTRL_SPEC, 0> {
        APB_SARADC_THRES1_CHANNEL_W::new(self)
    }
    #[doc = "Bits 5:17 - saradc thres1 monitor thres"]
    #[inline(always)]
    #[must_use]
    pub fn apb_saradc_thres1_high(&mut self) -> APB_SARADC_THRES1_HIGH_W<THRES1_CTRL_SPEC, 5> {
        APB_SARADC_THRES1_HIGH_W::new(self)
    }
    #[doc = "Bits 18:30 - saradc thres1 monitor thres"]
    #[inline(always)]
    #[must_use]
    pub fn apb_saradc_thres1_low(&mut self) -> APB_SARADC_THRES1_LOW_W<THRES1_CTRL_SPEC, 18> {
