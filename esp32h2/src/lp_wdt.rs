...
/**WDTCONFIG0 (rw) register accessor: need_des
...
///need_des
pub mod wdtconfig0;
/**CONFIG1 (rw) register accessor: need_des
...
///need_des
pub mod config1;
/**CONFIG2 (rw) register accessor: need_des
...
///need_des
pub mod config2;
/**CONFIG3 (rw) register accessor: need_des
...
///need_des
pub mod config3;
/**CONFIG4 (rw) register accessor: need_des
...
///need_des
pub mod config4;
/**CONFIG5 (rw) register accessor: need_des

You can [`read`](crate::generic::Reg::read) this register and get [`config5::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`config5::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).

For information about available fields see [`mod@config5`] module*/
pub type CONFIG5 = crate::Reg<config5::CONFIG5_SPEC>;
///need_des
pub mod config5;
/**WDTFEED (w) register accessor: need_des
...
///need_des
pub mod wdtfeed;
/**WDTWPROTECT (rw) register accessor: need_des
...
///need_des
pub mod wdtwprotect;
/**SWD_CONF (rw) register accessor: need_des
...
///need_des
pub mod swd_conf;
/**SWD_WPROTECT (rw) register accessor: need_des
