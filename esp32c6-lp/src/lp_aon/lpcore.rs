...
///`read()` method returns [`lpcore::R`](R) reader structure
impl crate::Readable for LPCORE_SPEC {}
///`write(|w| ..)` method takes [`lpcore::W`](W) writer structure
