///Register `SDIO_ACTIVE` reader
pub type R = crate::R<SDIO_ACTIVE_SPEC>;
///Register `SDIO_ACTIVE` writer
...
///`read()` method returns [`sdio_active::R`](R) reader structure
impl crate::Readable for SDIO_ACTIVE_SPEC {}
///`write(|w| ..)` method takes [`sdio_active::W`](W) writer structure
