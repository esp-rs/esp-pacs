///Register `FIB_ENABLE` reader
pub type R = crate::R<FIB_ENABLE_SPEC>;
///Register `FIB_ENABLE` writer
pub type W = crate::W<FIB_ENABLE_SPEC>;
///Field `ANA_FIB_ENA` reader - need_des
pub type ANA_FIB_ENA_R = crate::FieldReader<u32>;
///Field `ANA_FIB_ENA` writer - need_des
...
///`read()` method returns [`fib_enable::R`](R) reader structure
impl crate::Readable for FIB_ENABLE_SPEC {}
///`write(|w| ..)` method takes [`fib_enable::W`](W) writer structure
