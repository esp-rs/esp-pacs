...
pub struct R(crate::R<GPIO5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO5` writer"]
pub struct W(crate::W<GPIO5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIO5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO5_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_mcu_oe(&mut self) -> LP_GPIO5_MCU_OE_W<0> {
        LP_GPIO5_MCU_OE_W::new(self)
    }
    #[doc = "Bit 1 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_slp_sel(&mut self) -> LP_GPIO5_SLP_SEL_W<1> {
        LP_GPIO5_SLP_SEL_W::new(self)
    }
    #[doc = "Bit 2 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_mcu_wpd(&mut self) -> LP_GPIO5_MCU_WPD_W<2> {
        LP_GPIO5_MCU_WPD_W::new(self)
    }
    #[doc = "Bit 3 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_mcu_wpu(&mut self) -> LP_GPIO5_MCU_WPU_W<3> {
        LP_GPIO5_MCU_WPU_W::new(self)
    }
    #[doc = "Bit 4 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_mcu_ie(&mut self) -> LP_GPIO5_MCU_IE_W<4> {
        LP_GPIO5_MCU_IE_W::new(self)
    }
    #[doc = "Bits 5:6 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_mcu_drv(&mut self) -> LP_GPIO5_MCU_DRV_W<5> {
        LP_GPIO5_MCU_DRV_W::new(self)
    }
    #[doc = "Bit 7 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_fun_wpd(&mut self) -> LP_GPIO5_FUN_WPD_W<7> {
        LP_GPIO5_FUN_WPD_W::new(self)
    }
    #[doc = "Bit 8 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_fun_wpu(&mut self) -> LP_GPIO5_FUN_WPU_W<8> {
        LP_GPIO5_FUN_WPU_W::new(self)
    }
    #[doc = "Bit 9 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_fun_ie(&mut self) -> LP_GPIO5_FUN_IE_W<9> {
        LP_GPIO5_FUN_IE_W::new(self)
    }
    #[doc = "Bits 10:11 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_fun_drv(&mut self) -> LP_GPIO5_FUN_DRV_W<10> {
        LP_GPIO5_FUN_DRV_W::new(self)
    }
    #[doc = "Bits 12:14 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio5_mcu_sel(&mut self) -> LP_GPIO5_MCU_SEL_W<12> {
...
#[doc = "need des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio5](index.html) module"]
