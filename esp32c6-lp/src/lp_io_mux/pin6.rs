...
pub type LP_GPIO6_SYNC_BYPASS_W<'a, const O: u8> = crate::FieldWriter<'a, PIN6_SPEC, 2, O>;
...
pub type LP_GPIO6_PAD_DRIVER_W<'a, const O: u8> = crate::BitWriter<'a, PIN6_SPEC, O>;
#[doc = "Field `LP_GPIO6_EDGE_WAKEUP_CLR` writer - need des"]
pub type LP_GPIO6_EDGE_WAKEUP_CLR_W<'a, const O: u8> = crate::BitWriter<'a, PIN6_SPEC, O>;
...
pub type LP_GPIO6_INT_TYPE_W<'a, const O: u8> = crate::FieldWriter<'a, PIN6_SPEC, 3, O>;
...
pub type LP_GPIO6_WAKEUP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, PIN6_SPEC, O>;
...
pub type LP_GPIO6_FILTER_EN_W<'a, const O: u8> = crate::BitWriter<'a, PIN6_SPEC, O>;
impl R {
