...
pub type LP_GPIO1_SYNC_BYPASS_W<'a, const O: u8> = crate::FieldWriter<'a, PIN1_SPEC, 2, O>;
...
pub type LP_GPIO1_PAD_DRIVER_W<'a, const O: u8> = crate::BitWriter<'a, PIN1_SPEC, O>;
#[doc = "Field `LP_GPIO1_EDGE_WAKEUP_CLR` writer - need des"]
pub type LP_GPIO1_EDGE_WAKEUP_CLR_W<'a, const O: u8> = crate::BitWriter<'a, PIN1_SPEC, O>;
...
pub type LP_GPIO1_INT_TYPE_W<'a, const O: u8> = crate::FieldWriter<'a, PIN1_SPEC, 3, O>;
...
pub type LP_GPIO1_WAKEUP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, PIN1_SPEC, O>;
...
pub type LP_GPIO1_FILTER_EN_W<'a, const O: u8> = crate::BitWriter<'a, PIN1_SPEC, O>;
impl R {
