...
///`read()` method returns [`cpu_reset::R`](R) reader structure
impl crate::Readable for CPU_RESET_SPEC {}
///`write(|w| ..)` method takes [`cpu_reset::W`](W) writer structure
