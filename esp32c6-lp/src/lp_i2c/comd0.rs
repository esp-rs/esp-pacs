...
pub type COMMAND0_DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn command0(&mut self) -> COMMAND0_W<COMD0_SPEC, 0> {
        COMMAND0_W::new(self)
    }
    #[doc = "Bit 31 - When command 0 is done in I2C Master mode, this bit changes to high level."]
    #[inline(always)]
    #[must_use]
    pub fn command0_done(&mut self) -> COMMAND0_DONE_W<COMD0_SPEC, 31> {
