...
pub type COMMAND3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
pub type COMMAND3_DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn command3(&mut self) -> COMMAND3_W<COMD3_SPEC, 0> {
        COMMAND3_W::new(self)
    }
    #[doc = "Bit 31 - When command 3 is done in I2C Master mode, this bit changes to high level."]
    #[inline(always)]
    #[must_use]
    pub fn command3_done(&mut self) -> COMMAND3_DONE_W<COMD3_SPEC, 31> {
