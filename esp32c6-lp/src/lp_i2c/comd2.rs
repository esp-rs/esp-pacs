...
pub type COMMAND2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
pub type COMMAND2_DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn command2(&mut self) -> COMMAND2_W<COMD2_SPEC, 0> {
        COMMAND2_W::new(self)
    }
    #[doc = "Bit 31 - When command 2 is done in I2C Master mode, this bit changes to high Level."]
    #[inline(always)]
    #[must_use]
    pub fn command2_done(&mut self) -> COMMAND2_DONE_W<COMD2_SPEC, 31> {
