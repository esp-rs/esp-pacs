...
pub type COMMAND6_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
pub type COMMAND6_DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn command6(&mut self) -> COMMAND6_W<COMD6_SPEC, 0> {
        COMMAND6_W::new(self)
    }
    #[doc = "Bit 31 - When command 6 is done in I2C Master mode, this bit changes to high level."]
    #[inline(always)]
    #[must_use]
    pub fn command6_done(&mut self) -> COMMAND6_DONE_W<COMD6_SPEC, 31> {
