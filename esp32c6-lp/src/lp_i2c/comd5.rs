...
pub type COMMAND5_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
pub type COMMAND5_DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn command5(&mut self) -> COMMAND5_W<COMD5_SPEC, 0> {
        COMMAND5_W::new(self)
    }
    #[doc = "Bit 31 - When command 5 is done in I2C Master mode, this bit changes to high level."]
    #[inline(always)]
    #[must_use]
    pub fn command5_done(&mut self) -> COMMAND5_DONE_W<COMD5_SPEC, 31> {
