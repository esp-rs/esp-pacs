...
pub type MAIN_TIMER_OVERFLOW_LP_INT_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, LP_INT_CLR_SPEC, O>;
#[doc = "Field `MAIN_TIMER_LP_INT_CLR` writer - need_des"]
pub type MAIN_TIMER_LP_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, LP_INT_CLR_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn main_timer_overflow_lp_int_clr(&mut self) -> MAIN_TIMER_OVERFLOW_LP_INT_CLR_W<30> {
        MAIN_TIMER_OVERFLOW_LP_INT_CLR_W::new(self)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn main_timer_lp_int_clr(&mut self) -> MAIN_TIMER_LP_INT_CLR_W<31> {
