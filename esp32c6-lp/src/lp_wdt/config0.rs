...
pub type WDT_CHIP_RESET_WIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, CONFIG0_SPEC, 8, O>;
...
pub type WDT_CHIP_RESET_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG0_SPEC, O>;
...
pub type WDT_PAUSE_IN_SLP_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG0_SPEC, O>;
...
pub type WDT_APPCPU_RESET_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG0_SPEC, O>;
...
pub type WDT_PROCPU_RESET_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG0_SPEC, O>;
...
pub type WDT_FLASHBOOT_MOD_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG0_SPEC, O>;
...
pub type WDT_SYS_RESET_LENGTH_W<'a, const O: u8> = crate::FieldWriter<'a, CONFIG0_SPEC, 3, O>;
