...
pub type SUPER_WDT_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `LP_WDT_INT_ENA` reader - need_des"]
pub type LP_WDT_INT_ENA_R = crate::BitReader;
#[doc = "Field `LP_WDT_INT_ENA` writer - need_des"]
pub type LP_WDT_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            ...
            .field(
                "lp_wdt_int_ena",
                &format_args!("{}", self.lp_wdt_int_ena().bit()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn super_wdt_int_ena(&mut self) -> SUPER_WDT_INT_ENA_W<INT_ENA_SPEC, 30> {
        SUPER_WDT_INT_ENA_W::new(self)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_wdt_int_ena(&mut self) -> LP_WDT_INT_ENA_W<INT_ENA_SPEC, 31> {
        LP_WDT_INT_ENA_W::new(self)
    }
