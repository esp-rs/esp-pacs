///Register `SWD_CONFIG` reader
pub type R = crate::R<SWD_CONFIG_SPEC>;
///Register `SWD_CONFIG` writer
pub type W = crate::W<SWD_CONFIG_SPEC>;
///Field `SWD_RESET_FLAG` reader - need_des
pub type SWD_RESET_FLAG_R = crate::BitReader;
///Field `SWD_AUTO_FEED_EN` reader - need_des
pub type SWD_AUTO_FEED_EN_R = crate::BitReader;
///Field `SWD_AUTO_FEED_EN` writer - need_des
...
///`read()` method returns [`swd_config::R`](R) reader structure
impl crate::Readable for SWD_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`swd_config::W`](W) writer structure
