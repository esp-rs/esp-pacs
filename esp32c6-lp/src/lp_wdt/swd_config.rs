...
pub type SWD_AUTO_FEED_EN_W<'a, const O: u8> = crate::BitWriter<'a, SWD_CONFIG_SPEC, O>;
#[doc = "Field `SWD_RST_FLAG_CLR` writer - need_des"]
pub type SWD_RST_FLAG_CLR_W<'a, const O: u8> = crate::BitWriter<'a, SWD_CONFIG_SPEC, O>;
...
pub type SWD_SIGNAL_WIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, SWD_CONFIG_SPEC, 10, O, u16>;
#[doc = "Field `SWD_DISABLE` reader - need_des"]
pub type SWD_DISABLE_R = crate::BitReader;
#[doc = "Field `SWD_DISABLE` writer - need_des"]
pub type SWD_DISABLE_W<'a, const O: u8> = crate::BitWriter<'a, SWD_CONFIG_SPEC, O>;
#[doc = "Field `SWD_FEED` writer - need_des"]
pub type SWD_FEED_W<'a, const O: u8> = crate::BitWriter<'a, SWD_CONFIG_SPEC, O>;
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
