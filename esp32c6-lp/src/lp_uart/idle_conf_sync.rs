...
pub type RX_IDLE_THRHD_W<'a, const O: u8> = crate::FieldWriter<'a, IDLE_CONF_SYNC_SPEC, 10, O, u16>;
...
pub type TX_IDLE_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, IDLE_CONF_SYNC_SPEC, 10, O, u16>;
impl R {
