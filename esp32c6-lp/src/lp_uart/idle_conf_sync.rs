///Register `IDLE_CONF_SYNC` reader
pub type R = crate::R<IDLE_CONF_SYNC_SPEC>;
///Register `IDLE_CONF_SYNC` writer
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_idle_thrhd(&mut self) -> RX_IDLE_THRHD_W<IDLE_CONF_SYNC_SPEC> {
        RX_IDLE_THRHD_W::new(self, 0)
    }
    ///Bits 10:19 - This register is used to configure the duration time between transfers.
    #[inline(always)]
    #[must_use]
    pub fn tx_idle_num(&mut self) -> TX_IDLE_NUM_W<IDLE_CONF_SYNC_SPEC> {
...
///`read()` method returns [`idle_conf_sync::R`](R) reader structure
impl crate::Readable for IDLE_CONF_SYNC_SPEC {}
///`write(|w| ..)` method takes [`idle_conf_sync::W`](W) writer structure
