///Register `TXBRK_CONF_SYNC` reader
pub type R = crate::R<TXBRK_CONF_SYNC_SPEC>;
///Register `TXBRK_CONF_SYNC` writer
pub type W = crate::W<TXBRK_CONF_SYNC_SPEC>;
///Field `TX_BRK_NUM` reader - This register is used to configure the number of 0 to be sent after the process of sending data is done. It is active when txd_brk is set to 1.
pub type TX_BRK_NUM_R = crate::FieldReader;
///Field `TX_BRK_NUM` writer - This register is used to configure the number of 0 to be sent after the process of sending data is done. It is active when txd_brk is set to 1.
...
///`read()` method returns [`txbrk_conf_sync::R`](R) reader structure
impl crate::Readable for TXBRK_CONF_SYNC_SPEC {}
///`write(|w| ..)` method takes [`txbrk_conf_sync::W`](W) writer structure
