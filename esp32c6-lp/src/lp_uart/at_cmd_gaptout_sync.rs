///Register `AT_CMD_GAPTOUT_SYNC` reader
pub type R = crate::R<AT_CMD_GAPTOUT_SYNC_SPEC>;
///Register `AT_CMD_GAPTOUT_SYNC` writer
...
///`read()` method returns [`at_cmd_gaptout_sync::R`](R) reader structure
impl crate::Readable for AT_CMD_GAPTOUT_SYNC_SPEC {}
///`write(|w| ..)` method takes [`at_cmd_gaptout_sync::W`](W) writer structure
