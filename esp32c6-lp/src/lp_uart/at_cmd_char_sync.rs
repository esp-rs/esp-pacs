///Register `AT_CMD_CHAR_SYNC` reader
pub type R = crate::R<AT_CMD_CHAR_SYNC_SPEC>;
///Register `AT_CMD_CHAR_SYNC` writer
pub type W = crate::W<AT_CMD_CHAR_SYNC_SPEC>;
///Field `AT_CMD_CHAR` reader - This register is used to configure the content of at_cmd char.
...
///Field `CHAR_NUM` reader - This register is used to configure the num of continuous at_cmd chars received by receiver.
...
///`read()` method returns [`at_cmd_char_sync::R`](R) reader structure
impl crate::Readable for AT_CMD_CHAR_SYNC_SPEC {}
///`write(|w| ..)` method takes [`at_cmd_char_sync::W`](W) writer structure
