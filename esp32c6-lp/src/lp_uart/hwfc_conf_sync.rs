...
pub type RX_FLOW_THRHD_W<'a, const O: u8> = crate::FieldWriter<'a, HWFC_CONF_SYNC_SPEC, 5, O>;
...
pub type RX_FLOW_EN_W<'a, const O: u8> = crate::BitWriter<'a, HWFC_CONF_SYNC_SPEC, O>;
impl R {
