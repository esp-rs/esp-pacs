///Register `HWFC_CONF_SYNC` reader
pub type R = crate::R<HWFC_CONF_SYNC_SPEC>;
///Register `HWFC_CONF_SYNC` writer
...
impl R {
    ///Bits 3:7 - This register is used to configure the maximum amount of data that can be received when hardware flow control works.
    #[inline(always)]
...
///`read()` method returns [`hwfc_conf_sync::R`](R) reader structure
impl crate::Readable for HWFC_CONF_SYNC_SPEC {}
///`write(|w| ..)` method takes [`hwfc_conf_sync::W`](W) writer structure
