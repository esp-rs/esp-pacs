...
#[doc = "Field `TASK_ID` reader - Configures the task ID of channel%s."]
pub type TASK_ID_R = crate::FieldReader;
#[doc = "Field `TASK_ID` writer - Configures the task ID of channel%s."]
pub type TASK_ID_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures the task ID of channel%s."]
    #[inline(always)]
