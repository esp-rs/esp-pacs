...
#[doc = "Field `EVT_ID` reader - Configures the event ID of channel%s."]
pub type EVT_ID_R = crate::FieldReader;
#[doc = "Field `EVT_ID` writer - Configures the event ID of channel%s."]
pub type EVT_ID_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures the event ID of channel%s."]
    #[inline(always)]
