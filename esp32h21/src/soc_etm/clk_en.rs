...
#[doc = "Field `CLK_EN` reader - Configures resister clock gating.\\\\ 0: Support clock only when application writes registers\\\\ 1: Force on clock gating for registers\\\\"]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Configures resister clock gating.\\\\ 0: Support clock only when application writes registers\\\\ 1: Force on clock gating for registers\\\\"]
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures resister clock gating.\\\\ 0: Support clock only when application writes registers\\\\ 1: Force on clock gating for registers\\\\"]
    #[inline(always)]
