...
pub struct RegisterBlock {
    ...
    _reserved5: [u8; 0xdc],
    mult_date: MULT_DATE,
    mult_k_mem: [MULT_K_MEM; 32],
    mult_px_mem: [MULT_PX_MEM; 32],
    mult_py_mem: [MULT_PY_MEM; 32],
    mult_qx_mem: [MULT_QX_MEM; 32],
    mult_qy_mem: [MULT_QY_MEM; 32],
    mult_qz_mem: [MULT_QZ_MEM; 32],
}
impl RegisterBlock {
