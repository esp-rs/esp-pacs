...
impl W {
    ...
    #[inline(always)]
    pub fn value_update(&mut self) -> VALUE_UPDATE_W<'_, VALUE_UPDATE_SPEC> {
        VALUE_UPDATE_W::new(self, 0)
    }
    #[doc = "Bit 1 - needs field desc"]
    #[inline(always)]
    pub fn bypass(&mut self) -> BYPASS_W<'_, VALUE_UPDATE_SPEC> {
        BYPASS_W::new(self, 1)
    }
}
#[doc = "needs field desc\n\nYou can [`read`](crate::Reg::read) this register and get [`value_update::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`value_update::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
