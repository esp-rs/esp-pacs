...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FH2_STATUS")
            .field("tz2_cbc_on", &self.tz2_cbc_on())
            .field("tz2_ost_on", &self.tz2_ost_on())
            .finish()
    }
}
#[doc = "Status of fault events.\n\nYou can [`read`](crate::Reg::read) this register and get [`fh2_status::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
