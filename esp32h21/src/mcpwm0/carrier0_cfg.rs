...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CARRIER0_CFG")
            .field("chopper0_en", &self.chopper0_en())
            .field("chopper0_prescale", &self.chopper0_prescale())
            .field("chopper0_duty", &self.chopper0_duty())
            .field("chopper0_oshtwth", &self.chopper0_oshtwth())
            .field("chopper0_out_invert", &self.chopper0_out_invert())
            .field("chopper0_in_invert", &self.chopper0_in_invert())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - When set, carrier0 function is enabled. When cleared, carrier0 is bypassed"]
    #[inline(always)]
    pub fn chopper0_en(&mut self) -> CHOPPER0_EN_W<'_, CARRIER0_CFG_SPEC> {
        CHOPPER0_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:4 - PWM carrier0 clock (PC_clk) prescale value. Period of PC_clk = period of PWM_clk * (PWM_CARRIER0_PRESCALE + 1)"]
    #[inline(always)]
    pub fn chopper0_prescale(&mut self) -> CHOPPER0_PRESCALE_W<'_, CARRIER0_CFG_SPEC> {
        CHOPPER0_PRESCALE_W::new(self, 1)
    }
    #[doc = "Bits 5:7 - carrier duty selection. Duty = PWM_CARRIER0_DUTY / 8"]
    #[inline(always)]
    pub fn chopper0_duty(&mut self) -> CHOPPER0_DUTY_W<'_, CARRIER0_CFG_SPEC> {
        CHOPPER0_DUTY_W::new(self, 5)
    }
    #[doc = "Bits 8:11 - width of the first pulse in number of periods of the carrier"]
    #[inline(always)]
    pub fn chopper0_oshtwth(&mut self) -> CHOPPER0_OSHTWTH_W<'_, CARRIER0_CFG_SPEC> {
        CHOPPER0_OSHTWTH_W::new(self, 8)
    }
    #[doc = "Bit 12 - when set, invert the output of PWM0A and PWM0B for this submodule"]
    #[inline(always)]
    pub fn chopper0_out_invert(&mut self) -> CHOPPER0_OUT_INVERT_W<'_, CARRIER0_CFG_SPEC> {
        CHOPPER0_OUT_INVERT_W::new(self, 12)
    }
    #[doc = "Bit 13 - when set, invert the input of PWM0A and PWM0B for this submodule"]
    #[inline(always)]
    pub fn chopper0_in_invert(&mut self) -> CHOPPER0_IN_INVERT_W<'_, CARRIER0_CFG_SPEC> {
        CHOPPER0_IN_INVERT_W::new(self, 13)
    }
}
#[doc = "Carrier enable and configuratoin\n\nYou can [`read`](crate::Reg::read) this register and get [`carrier0_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`carrier0_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
