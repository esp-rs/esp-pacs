...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GEN2_FORCE")
            .field("gen2_cntuforce_upmethod", &self.gen2_cntuforce_upmethod())
            .field("gen2_a_cntuforce_mode", &self.gen2_a_cntuforce_mode())
            .field("gen2_b_cntuforce_mode", &self.gen2_b_cntuforce_mode())
            .field("gen2_a_nciforce", &self.gen2_a_nciforce())
            .field("gen2_a_nciforce_mode", &self.gen2_a_nciforce_mode())
            .field("gen2_b_nciforce", &self.gen2_b_nciforce())
            .field("gen2_b_nciforce_mode", &self.gen2_b_nciforce_mode())
            .finish()
    }
}
impl W {
...
#[doc = "Permissives to force PWM2A and PWM2B outputs by software\n\nYou can [`read`](crate::Reg::read) this register and get [`gen2_force::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gen2_force::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
