...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GEN0_FORCE")
            .field("gen0_cntuforce_upmethod", &self.gen0_cntuforce_upmethod())
            .field("gen0_a_cntuforce_mode", &self.gen0_a_cntuforce_mode())
            .field("gen0_b_cntuforce_mode", &self.gen0_b_cntuforce_mode())
            .field("gen0_a_nciforce", &self.gen0_a_nciforce())
            .field("gen0_a_nciforce_mode", &self.gen0_a_nciforce_mode())
            .field("gen0_b_nciforce", &self.gen0_b_nciforce())
            .field("gen0_b_nciforce_mode", &self.gen0_b_nciforce_mode())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5 - Updating method for continuous software force of PWM generator0. When all bits are set to 0: immediately, when bit0 is set to 1: TEZ,,when bit1 is set to 1: TEP, when bit2 is set to 1: TEA, when bit3 is set to 1: TEB, when bit4 is set to 1: sync, when bit5 is set to 1: disable update. (TEA/B here and below means an event generated when the timer's value equals to that of register A/B.)"]
    #[inline(always)]
    pub fn gen0_cntuforce_upmethod(&mut self) -> GEN0_CNTUFORCE_UPMETHOD_W<'_, GEN0_FORCE_SPEC> {
        GEN0_CNTUFORCE_UPMETHOD_W::new(self, 0)
    }
    #[doc = "Bits 6:7 - Continuous software force mode for PWM0A. 0: disabled, 1: low, 2: high, 3: disabled"]
    #[inline(always)]
    pub fn gen0_a_cntuforce_mode(&mut self) -> GEN0_A_CNTUFORCE_MODE_W<'_, GEN0_FORCE_SPEC> {
        GEN0_A_CNTUFORCE_MODE_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Continuous software force mode for PWM0B. 0: disabled, 1: low, 2: high, 3: disabled"]
    #[inline(always)]
    pub fn gen0_b_cntuforce_mode(&mut self) -> GEN0_B_CNTUFORCE_MODE_W<'_, GEN0_FORCE_SPEC> {
        GEN0_B_CNTUFORCE_MODE_W::new(self, 8)
    }
    #[doc = "Bit 10 - Trigger of non-continuous immediate software-force event for PWM0A, a toggle will trigger a force event."]
    #[inline(always)]
    pub fn gen0_a_nciforce(&mut self) -> GEN0_A_NCIFORCE_W<'_, GEN0_FORCE_SPEC> {
        GEN0_A_NCIFORCE_W::new(self, 10)
    }
    #[doc = "Bits 11:12 - non-continuous immediate software force mode for PWM0A, 0: disabled, 1: low, 2: high, 3: disabled"]
    #[inline(always)]
    pub fn gen0_a_nciforce_mode(&mut self) -> GEN0_A_NCIFORCE_MODE_W<'_, GEN0_FORCE_SPEC> {
        GEN0_A_NCIFORCE_MODE_W::new(self, 11)
    }
    #[doc = "Bit 13 - Trigger of non-continuous immediate software-force event for PWM0B, a toggle will trigger a force event."]
    #[inline(always)]
    pub fn gen0_b_nciforce(&mut self) -> GEN0_B_NCIFORCE_W<'_, GEN0_FORCE_SPEC> {
        GEN0_B_NCIFORCE_W::new(self, 13)
    }
    #[doc = "Bits 14:15 - non-continuous immediate software force mode for PWM0B, 0: disabled, 1: low, 2: high, 3: disabled"]
    #[inline(always)]
    pub fn gen0_b_nciforce_mode(&mut self) -> GEN0_B_NCIFORCE_MODE_W<'_, GEN0_FORCE_SPEC> {
        GEN0_B_NCIFORCE_MODE_W::new(self, 14)
    }
}
#[doc = "Permissives to force PWM0A and PWM0B outputs by software\n\nYou can [`read`](crate::Reg::read) this register and get [`gen0_force::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gen0_force::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
