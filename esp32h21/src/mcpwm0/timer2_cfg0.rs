...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMER2_CFG0")
            .field("timer2_prescale", &self.timer2_prescale())
            .field("timer2_period", &self.timer2_period())
            .field("timer2_period_upmethod", &self.timer2_period_upmethod())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:7 - period of PT0_clk = Period of PWM_clk * (PWM_timer2_PRESCALE + 1)"]
    #[inline(always)]
    pub fn timer2_prescale(&mut self) -> TIMER2_PRESCALE_W<'_, TIMER2_CFG0_SPEC> {
        TIMER2_PRESCALE_W::new(self, 0)
    }
    #[doc = "Bits 8:23 - period shadow register of PWM timer2"]
    #[inline(always)]
    pub fn timer2_period(&mut self) -> TIMER2_PERIOD_W<'_, TIMER2_CFG0_SPEC> {
        TIMER2_PERIOD_W::new(self, 8)
    }
    #[doc = "Bits 24:25 - Update method for active register of PWM timer2 period, 0: immediate, 1: TEZ, 2: sync, 3: TEZ | sync. TEZ here and below means timer equal zero event"]
    #[inline(always)]
    pub fn timer2_period_upmethod(&mut self) -> TIMER2_PERIOD_UPMETHOD_W<'_, TIMER2_CFG0_SPEC> {
        TIMER2_PERIOD_UPMETHOD_W::new(self, 24)
    }
}
#[doc = "PWM timer2 period and update method configuration register.\n\nYou can [`read`](crate::Reg::read) this register and get [`timer2_cfg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer2_cfg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
