...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMER0_SYNC")
            .field("timer0_synci_en", &self.timer0_synci_en())
            .field("sw", &self.sw())
            .field("timer0_synco_sel", &self.timer0_synco_sel())
            .field("timer0_phase", &self.timer0_phase())
            .field("timer0_phase_direction", &self.timer0_phase_direction())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - When set, timer reloading with phase on sync input event is enabled."]
    #[inline(always)]
    pub fn timer0_synci_en(&mut self) -> TIMER0_SYNCI_EN_W<'_, TIMER0_SYNC_SPEC> {
        TIMER0_SYNCI_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Toggling this bit will trigger a software sync."]
    #[inline(always)]
    pub fn sw(&mut self) -> SW_W<'_, TIMER0_SYNC_SPEC> {
        SW_W::new(self, 1)
    }
    #[doc = "Bits 2:3 - PWM timer0 sync_out selection, 0: sync_in, 1: TEZ, 2: TEP, and sync out will always generate when toggling the reg_timer0_sync_sw bit"]
    #[inline(always)]
    pub fn timer0_synco_sel(&mut self) -> TIMER0_SYNCO_SEL_W<'_, TIMER0_SYNC_SPEC> {
        TIMER0_SYNCO_SEL_W::new(self, 2)
    }
    #[doc = "Bits 4:19 - phase for timer reload on sync event"]
    #[inline(always)]
    pub fn timer0_phase(&mut self) -> TIMER0_PHASE_W<'_, TIMER0_SYNC_SPEC> {
        TIMER0_PHASE_W::new(self, 4)
    }
    #[doc = "Bit 20 - Configure the PWM timer0's direction when timer0 mode is up-down mode: 0-increase,1-decrease"]
    #[inline(always)]
    pub fn timer0_phase_direction(&mut self) -> TIMER0_PHASE_DIRECTION_W<'_, TIMER0_SYNC_SPEC> {
        TIMER0_PHASE_DIRECTION_W::new(self, 20)
    }
}
#[doc = "PWM timer0 sync function configuration register.\n\nYou can [`read`](crate::Reg::read) this register and get [`timer0_sync::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer0_sync::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
