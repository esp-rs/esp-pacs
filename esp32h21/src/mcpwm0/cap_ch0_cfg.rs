...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CAP_CH0_CFG")
            ...
            .field("cap0_mode", &self.cap0_mode())
            .field("cap0_prescale", &self.cap0_prescale())
            .field("cap0_in_invert", &self.cap0_in_invert())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - When set, capture on channel 0 is enabled"]
    #[inline(always)]
    pub fn cap0_en(&mut self) -> CAP0_EN_W<'_, CAP_CH0_CFG_SPEC> {
        CAP0_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - Edge of capture on channel 0 after prescaling. When bit0 is set to 1: enable capture on the negative edge, When bit1 is set to 1: enable capture on the positive edge."]
    #[inline(always)]
    pub fn cap0_mode(&mut self) -> CAP0_MODE_W<'_, CAP_CH0_CFG_SPEC> {
        CAP0_MODE_W::new(self, 1)
    }
    #[doc = "Bits 3:10 - Value of prescaling on possitive edge of CAP0. Prescale value = PWM_CAP0_PRESCALE + 1"]
    #[inline(always)]
    pub fn cap0_prescale(&mut self) -> CAP0_PRESCALE_W<'_, CAP_CH0_CFG_SPEC> {
        CAP0_PRESCALE_W::new(self, 3)
    }
    #[doc = "Bit 11 - when set, CAP0 form GPIO matrix is inverted before prescale"]
    #[inline(always)]
    pub fn cap0_in_invert(&mut self) -> CAP0_IN_INVERT_W<'_, CAP_CH0_CFG_SPEC> {
        CAP0_IN_INVERT_W::new(self, 11)
    }
    #[doc = "Bit 12 - Write 1 will trigger a software forced capture on channel 0"]
    #[inline(always)]
    pub fn cap0_sw(&mut self) -> CAP0_SW_W<'_, CAP_CH0_CFG_SPEC> {
        CAP0_SW_W::new(self, 12)
    }
}
#[doc = "Capture channel 0 configuration and enable\n\nYou can [`read`](crate::Reg::read) this register and get [`cap_ch0_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cap_ch0_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
