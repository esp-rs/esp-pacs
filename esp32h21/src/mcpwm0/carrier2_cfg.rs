...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CARRIER2_CFG")
            .field("chopper2_en", &self.chopper2_en())
            .field("chopper2_prescale", &self.chopper2_prescale())
            .field("chopper2_duty", &self.chopper2_duty())
            .field("chopper2_oshtwth", &self.chopper2_oshtwth())
            .field("chopper2_out_invert", &self.chopper2_out_invert())
            .field("chopper2_in_invert", &self.chopper2_in_invert())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - When set, carrier2 function is enabled. When cleared, carrier2 is bypassed"]
    #[inline(always)]
    pub fn chopper2_en(&mut self) -> CHOPPER2_EN_W<'_, CARRIER2_CFG_SPEC> {
        CHOPPER2_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:4 - PWM carrier2 clock (PC_clk) prescale value. Period of PC_clk = period of PWM_clk * (PWM_CARRIER0_PRESCALE + 1)"]
    #[inline(always)]
    pub fn chopper2_prescale(&mut self) -> CHOPPER2_PRESCALE_W<'_, CARRIER2_CFG_SPEC> {
        CHOPPER2_PRESCALE_W::new(self, 1)
    }
    #[doc = "Bits 5:7 - carrier duty selection. Duty = PWM_CARRIER0_DUTY / 8"]
    #[inline(always)]
    pub fn chopper2_duty(&mut self) -> CHOPPER2_DUTY_W<'_, CARRIER2_CFG_SPEC> {
        CHOPPER2_DUTY_W::new(self, 5)
    }
    #[doc = "Bits 8:11 - width of the first pulse in number of periods of the carrier"]
    #[inline(always)]
    pub fn chopper2_oshtwth(&mut self) -> CHOPPER2_OSHTWTH_W<'_, CARRIER2_CFG_SPEC> {
        CHOPPER2_OSHTWTH_W::new(self, 8)
    }
    #[doc = "Bit 12 - when set, invert the output of PWM2A and PWM2B for this submodule"]
    #[inline(always)]
    pub fn chopper2_out_invert(&mut self) -> CHOPPER2_OUT_INVERT_W<'_, CARRIER2_CFG_SPEC> {
        CHOPPER2_OUT_INVERT_W::new(self, 12)
    }
    #[doc = "Bit 13 - when set, invert the input of PWM2A and PWM2B for this submodule"]
    #[inline(always)]
    pub fn chopper2_in_invert(&mut self) -> CHOPPER2_IN_INVERT_W<'_, CARRIER2_CFG_SPEC> {
        CHOPPER2_IN_INVERT_W::new(self, 13)
    }
}
#[doc = "Carrier enable and configuratoin\n\nYou can [`read`](crate::Reg::read) this register and get [`carrier2_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`carrier2_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
