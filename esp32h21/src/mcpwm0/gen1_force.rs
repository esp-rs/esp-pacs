...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GEN1_FORCE")
            .field("gen1_cntuforce_upmethod", &self.gen1_cntuforce_upmethod())
            .field("gen1_a_cntuforce_mode", &self.gen1_a_cntuforce_mode())
            .field("gen1_b_cntuforce_mode", &self.gen1_b_cntuforce_mode())
            .field("gen1_a_nciforce", &self.gen1_a_nciforce())
            .field("gen1_a_nciforce_mode", &self.gen1_a_nciforce_mode())
            .field("gen1_b_nciforce", &self.gen1_b_nciforce())
            .field("gen1_b_nciforce_mode", &self.gen1_b_nciforce_mode())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5 - Updating method for continuous software force of PWM generator 1. When all bits are set to 0: immediately, when bit0 is set to 1: TEZ,,when bit1 is set to 1: TEP, when bit2 is set to 1: TEA, when bit3 is set to 1: TEB, when bit4 is set to 1: sync, when bit5 is set to 1: disable update. (TEA/B here and below means an event generated when the timer's value equals to that of register A/B.)"]
    #[inline(always)]
    pub fn gen1_cntuforce_upmethod(&mut self) -> GEN1_CNTUFORCE_UPMETHOD_W<'_, GEN1_FORCE_SPEC> {
        GEN1_CNTUFORCE_UPMETHOD_W::new(self, 0)
    }
    #[doc = "Bits 6:7 - Continuous software force mode for PWM1A. 0: disabled, 1: low, 2: high, 3: disabled"]
    #[inline(always)]
    pub fn gen1_a_cntuforce_mode(&mut self) -> GEN1_A_CNTUFORCE_MODE_W<'_, GEN1_FORCE_SPEC> {
        GEN1_A_CNTUFORCE_MODE_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Continuous software force mode for PWM1B. 0: disabled, 1: low, 2: high, 3: disabled"]
    #[inline(always)]
    pub fn gen1_b_cntuforce_mode(&mut self) -> GEN1_B_CNTUFORCE_MODE_W<'_, GEN1_FORCE_SPEC> {
        GEN1_B_CNTUFORCE_MODE_W::new(self, 8)
    }
    #[doc = "Bit 10 - Trigger of non-continuous immediate software-force event for PWM1A, a toggle will trigger a force event."]
    #[inline(always)]
    pub fn gen1_a_nciforce(&mut self) -> GEN1_A_NCIFORCE_W<'_, GEN1_FORCE_SPEC> {
        GEN1_A_NCIFORCE_W::new(self, 10)
    }
    #[doc = "Bits 11:12 - non-continuous immediate software force mode for PWM1A, 0: disabled, 1: low, 2: high, 3: disabled"]
    #[inline(always)]
    pub fn gen1_a_nciforce_mode(&mut self) -> GEN1_A_NCIFORCE_MODE_W<'_, GEN1_FORCE_SPEC> {
        GEN1_A_NCIFORCE_MODE_W::new(self, 11)
    }
    #[doc = "Bit 13 - Trigger of non-continuous immediate software-force event for PWM1B, a toggle will trigger a force event."]
    #[inline(always)]
    pub fn gen1_b_nciforce(&mut self) -> GEN1_B_NCIFORCE_W<'_, GEN1_FORCE_SPEC> {
        GEN1_B_NCIFORCE_W::new(self, 13)
    }
    #[doc = "Bits 14:15 - non-continuous immediate software force mode for PWM1B, 0: disabled, 1: low, 2: high, 3: disabled"]
    #[inline(always)]
    pub fn gen1_b_nciforce_mode(&mut self) -> GEN1_B_NCIFORCE_MODE_W<'_, GEN1_FORCE_SPEC> {
        GEN1_B_NCIFORCE_MODE_W::new(self, 14)
    }
}
#[doc = "Permissives to force PWM1A and PWM1B outputs by software\n\nYou can [`read`](crate::Reg::read) this register and get [`gen1_force::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gen1_force::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
