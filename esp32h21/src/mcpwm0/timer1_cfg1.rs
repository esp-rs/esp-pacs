...
pub type TIMER1_START_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type TIMER1_MOD_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMER1_CFG1")
            .field("timer1_start", &self.timer1_start())
            .field("timer1_mod", &self.timer1_mod())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:2 - PWM timer1 start and stop control. 0: if PWM timer1 starts, then stops at TEZ, 1: if timer1 starts, then stops at TEP, 2: PWM timer1 starts and runs on, 3: timer1 starts and stops at the next TEZ, 4: timer1 starts and stops at the next TEP. TEP here and below means the event that happens when the timer equals to period"]
    #[inline(always)]
    pub fn timer1_start(&mut self) -> TIMER1_START_W<'_, TIMER1_CFG1_SPEC> {
        TIMER1_START_W::new(self, 0)
    }
    #[doc = "Bits 3:4 - PWM timer1 working mode, 0: freeze, 1: increase mode, 2: decrease mode, 3: up-down mode"]
    #[inline(always)]
    pub fn timer1_mod(&mut self) -> TIMER1_MOD_W<'_, TIMER1_CFG1_SPEC> {
        TIMER1_MOD_W::new(self, 3)
    }
}
#[doc = "PWM timer1 working mode and start/stop control configuration register.\n\nYou can [`read`](crate::Reg::read) this register and get [`timer1_cfg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer1_cfg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
