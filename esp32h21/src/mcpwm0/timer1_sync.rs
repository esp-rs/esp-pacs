...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMER1_SYNC")
            .field("timer1_synci_en", &self.timer1_synci_en())
            .field("sw", &self.sw())
            .field("timer1_synco_sel", &self.timer1_synco_sel())
            .field("timer1_phase", &self.timer1_phase())
            .field("timer1_phase_direction", &self.timer1_phase_direction())
            .finish()
    }
}
impl W {
...
#[doc = "PWM timer1 sync function configuration register.\n\nYou can [`read`](crate::Reg::read) this register and get [`timer1_sync::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer1_sync::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
