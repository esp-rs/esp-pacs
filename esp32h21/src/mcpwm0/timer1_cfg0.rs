...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMER1_CFG0")
            .field("timer1_prescale", &self.timer1_prescale())
            .field("timer1_period", &self.timer1_period())
            .field("timer1_period_upmethod", &self.timer1_period_upmethod())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:7 - period of PT0_clk = Period of PWM_clk * (PWM_timer1_PRESCALE + 1)"]
    #[inline(always)]
    pub fn timer1_prescale(&mut self) -> TIMER1_PRESCALE_W<'_, TIMER1_CFG0_SPEC> {
        TIMER1_PRESCALE_W::new(self, 0)
    }
    #[doc = "Bits 8:23 - period shadow register of PWM timer1"]
    #[inline(always)]
    pub fn timer1_period(&mut self) -> TIMER1_PERIOD_W<'_, TIMER1_CFG0_SPEC> {
        TIMER1_PERIOD_W::new(self, 8)
    }
    #[doc = "Bits 24:25 - Update method for active register of PWM timer1 period, 0: immediate, 1: TEZ, 2: sync, 3: TEZ | sync. TEZ here and below means timer equal zero event"]
    #[inline(always)]
    pub fn timer1_period_upmethod(&mut self) -> TIMER1_PERIOD_UPMETHOD_W<'_, TIMER1_CFG0_SPEC> {
        TIMER1_PERIOD_UPMETHOD_W::new(self, 24)
    }
}
#[doc = "PWM timer1 period and update method configuration register.\n\nYou can [`read`](crate::Reg::read) this register and get [`timer1_cfg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer1_cfg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
