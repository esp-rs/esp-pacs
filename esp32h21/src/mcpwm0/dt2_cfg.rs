...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DT2_CFG")
            .field("db2_fed_upmethod", &self.db2_fed_upmethod())
            .field("db2_red_upmethod", &self.db2_red_upmethod())
            .field("db2_deb_mode", &self.db2_deb_mode())
            .field("db2_a_outswap", &self.db2_a_outswap())
            .field("db2_b_outswap", &self.db2_b_outswap())
            .field("db2_red_insel", &self.db2_red_insel())
            .field("db2_fed_insel", &self.db2_fed_insel())
            .field("db2_red_outinvert", &self.db2_red_outinvert())
            .field("db2_fed_outinvert", &self.db2_fed_outinvert())
            .field("db2_a_outbypass", &self.db2_a_outbypass())
            .field("db2_b_outbypass", &self.db2_b_outbypass())
            .field("db2_clk_sel", &self.db2_clk_sel())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:3 - Update method for FED (falling edge delay) active register. 0: immediate,when bit0 is set to 1: tez, when bit1 is set to 1:tep, when bit2 is set to 1: sync, when bit3 is set to 1: disable the update"]
    #[inline(always)]
    pub fn db2_fed_upmethod(&mut self) -> DB2_FED_UPMETHOD_W<'_, DT2_CFG_SPEC> {
        DB2_FED_UPMETHOD_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Update method for RED (rising edge delay) active register. 0: immediate,when bit0 is set to 1: tez, when bit1 is set to 1:tep, when bit2 is set to 1: sync, when bit3 is set to 1: disable the update"]
    #[inline(always)]
    pub fn db2_red_upmethod(&mut self) -> DB2_RED_UPMETHOD_W<'_, DT2_CFG_SPEC> {
        DB2_RED_UPMETHOD_W::new(self, 4)
    }
    #[doc = "Bit 8 - S8 in table, dual-edge B mode, 0: fed/red take effect on different path separately, 1: fed/red take effect on B path, A out is in bypass or dulpB mode"]
    #[inline(always)]
    pub fn db2_deb_mode(&mut self) -> DB2_DEB_MODE_W<'_, DT2_CFG_SPEC> {
        DB2_DEB_MODE_W::new(self, 8)
    }
    #[doc = "Bit 9 - S6 in table"]
    #[inline(always)]
    pub fn db2_a_outswap(&mut self) -> DB2_A_OUTSWAP_W<'_, DT2_CFG_SPEC> {
        DB2_A_OUTSWAP_W::new(self, 9)
    }
    #[doc = "Bit 10 - S7 in table"]
    #[inline(always)]
    pub fn db2_b_outswap(&mut self) -> DB2_B_OUTSWAP_W<'_, DT2_CFG_SPEC> {
        DB2_B_OUTSWAP_W::new(self, 10)
    }
    #[doc = "Bit 11 - S4 in table"]
    #[inline(always)]
    pub fn db2_red_insel(&mut self) -> DB2_RED_INSEL_W<'_, DT2_CFG_SPEC> {
        DB2_RED_INSEL_W::new(self, 11)
    }
    #[doc = "Bit 12 - S5 in table"]
    #[inline(always)]
    pub fn db2_fed_insel(&mut self) -> DB2_FED_INSEL_W<'_, DT2_CFG_SPEC> {
        DB2_FED_INSEL_W::new(self, 12)
    }
    #[doc = "Bit 13 - S2 in table"]
    #[inline(always)]
    pub fn db2_red_outinvert(&mut self) -> DB2_RED_OUTINVERT_W<'_, DT2_CFG_SPEC> {
        DB2_RED_OUTINVERT_W::new(self, 13)
    }
    #[doc = "Bit 14 - S3 in table"]
    #[inline(always)]
    pub fn db2_fed_outinvert(&mut self) -> DB2_FED_OUTINVERT_W<'_, DT2_CFG_SPEC> {
        DB2_FED_OUTINVERT_W::new(self, 14)
    }
    #[doc = "Bit 15 - S1 in table"]
    #[inline(always)]
    pub fn db2_a_outbypass(&mut self) -> DB2_A_OUTBYPASS_W<'_, DT2_CFG_SPEC> {
        DB2_A_OUTBYPASS_W::new(self, 15)
    }
    #[doc = "Bit 16 - S0 in table"]
    #[inline(always)]
    pub fn db2_b_outbypass(&mut self) -> DB2_B_OUTBYPASS_W<'_, DT2_CFG_SPEC> {
        DB2_B_OUTBYPASS_W::new(self, 16)
    }
    #[doc = "Bit 17 - Dead time generator 2 clock selection. 0: PWM_clk, 1: PT_clk"]
    #[inline(always)]
    pub fn db2_clk_sel(&mut self) -> DB2_CLK_SEL_W<'_, DT2_CFG_SPEC> {
        DB2_CLK_SEL_W::new(self, 17)
    }
}
#[doc = "dead time type selection and configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`dt2_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dt2_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
