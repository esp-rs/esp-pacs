...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CAP_CH2_CFG")
            ...
            .field("cap2_mode", &self.cap2_mode())
            .field("cap2_prescale", &self.cap2_prescale())
            .field("cap2_in_invert", &self.cap2_in_invert())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - When set, capture on channel 2 is enabled"]
    #[inline(always)]
    pub fn cap2_en(&mut self) -> CAP2_EN_W<'_, CAP_CH2_CFG_SPEC> {
        CAP2_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - Edge of capture on channel 2 after prescaling. When bit0 is set to 1: enable capture on the negative edge, When bit1 is set to 1: enable capture on the positive edge."]
    #[inline(always)]
    pub fn cap2_mode(&mut self) -> CAP2_MODE_W<'_, CAP_CH2_CFG_SPEC> {
        CAP2_MODE_W::new(self, 1)
    }
    #[doc = "Bits 3:10 - Value of prescaling on possitive edge of CAP2. Prescale value = PWM_CAP2_PRESCALE + 1"]
    #[inline(always)]
    pub fn cap2_prescale(&mut self) -> CAP2_PRESCALE_W<'_, CAP_CH2_CFG_SPEC> {
        CAP2_PRESCALE_W::new(self, 3)
    }
    #[doc = "Bit 11 - when set, CAP2 form GPIO matrix is inverted before prescale"]
    #[inline(always)]
    pub fn cap2_in_invert(&mut self) -> CAP2_IN_INVERT_W<'_, CAP_CH2_CFG_SPEC> {
        CAP2_IN_INVERT_W::new(self, 11)
    }
    #[doc = "Bit 12 - Write 1 will trigger a software forced capture on channel 2"]
    #[inline(always)]
    pub fn cap2_sw(&mut self) -> CAP2_SW_W<'_, CAP_CH2_CFG_SPEC> {
        CAP2_SW_W::new(self, 12)
    }
}
#[doc = "Capture channel 2 configuration and enable\n\nYou can [`read`](crate::Reg::read) this register and get [`cap_ch2_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cap_ch2_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
