...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FH1_CFG1")
            .field("tz1_clr_ost", &self.tz1_clr_ost())
            .field("tz1_cbcpulse", &self.tz1_cbcpulse())
            .field("tz1_force_cbc", &self.tz1_force_cbc())
            .field("tz1_force_ost", &self.tz1_force_ost())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - a rising edge will clear on going one-shot mode action"]
    #[inline(always)]
    pub fn tz1_clr_ost(&mut self) -> TZ1_CLR_OST_W<'_, FH1_CFG1_SPEC> {
        TZ1_CLR_OST_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - cycle-by-cycle mode action refresh moment selection. When bit0 is set to 1: TEZ, when bit1 is set to 1:TEP"]
    #[inline(always)]
    pub fn tz1_cbcpulse(&mut self) -> TZ1_CBCPULSE_W<'_, FH1_CFG1_SPEC> {
        TZ1_CBCPULSE_W::new(self, 1)
    }
    #[doc = "Bit 3 - a toggle trigger a cycle-by-cycle mode action"]
    #[inline(always)]
    pub fn tz1_force_cbc(&mut self) -> TZ1_FORCE_CBC_W<'_, FH1_CFG1_SPEC> {
        TZ1_FORCE_CBC_W::new(self, 3)
    }
    #[doc = "Bit 4 - a toggle (software negate its value) triggers a one-shot mode action"]
    #[inline(always)]
    pub fn tz1_force_ost(&mut self) -> TZ1_FORCE_OST_W<'_, FH1_CFG1_SPEC> {
        TZ1_FORCE_OST_W::new(self, 4)
    }
}
#[doc = "Software triggers for fault handler actions\n\nYou can [`read`](crate::Reg::read) this register and get [`fh1_cfg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fh1_cfg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
