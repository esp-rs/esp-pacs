...
#[doc = "Field `FUNC33_IN_SEL` reader - set this value: s=0-29: connect GPIO\\[s\\] to this port. s=0x20: set this port always high level. s=0x30: set this port always low level."]
pub type FUNC33_IN_SEL_R = crate::FieldReader;
#[doc = "Field `FUNC33_IN_SEL` writer - set this value: s=0-29: connect GPIO\\[s\\] to this port. s=0x20: set this port always high level. s=0x30: set this port always low level."]
...
#[doc = "`reset()` method sets FUNC33_IN_SEL_CFG to value 0x30"]
