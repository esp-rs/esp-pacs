...
#[doc = "Field `INT_ENA` reader - set bit 13 to enable gpio_procpu_int. set bit 14 to enable gpio_procpu_nmi_int."]
pub type INT_ENA_R = crate::FieldReader;
#[doc = "Field `INT_ENA` writer - set bit 13 to enable gpio_procpu_int. set bit 14 to enable gpio_procpu_nmi_int."]
...
impl R {
    ...
    #[doc = "Bits 13:17 - set bit 13 to enable gpio_procpu_int. set bit 14 to enable gpio_procpu_nmi_int."]
    #[inline(always)]
