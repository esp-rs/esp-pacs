...
#[doc = "Field `STATUS_W1TS` writer - GPIO interrupt status set register for GPIO0-29"]
pub type STATUS_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
...
impl W {
    #[doc = "Bits 0:29 - GPIO interrupt status set register for GPIO0-29"]
    #[inline(always)]
