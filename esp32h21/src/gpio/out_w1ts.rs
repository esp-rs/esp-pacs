...
#[doc = "Field `OUT_W1TS` writer - GPIO output set register for GPIO0-29"]
pub type OUT_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
...
impl W {
    #[doc = "Bits 0:29 - GPIO output set register for GPIO0-29"]
    #[inline(always)]
