...
#[doc = "Field `DATA_ORIG` reader - GPIO output register for GPIO0-29"]
pub type DATA_ORIG_R = crate::FieldReader<u32>;
#[doc = "Field `DATA_ORIG` writer - GPIO output register for GPIO0-29"]
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    #[doc = "Bits 0:29 - GPIO output register for GPIO0-29"]
    #[inline(always)]
    pub fn data_orig(&self) -> DATA_ORIG_R {
        DATA_ORIG_R::new(self.bits & 0x3fff_ffff)
    }
}
