...
#[doc = "Field `DATA` reader - GPIO output enable register for GPIO0-29"]
pub type DATA_R = crate::FieldReader<u32>;
#[doc = "Field `DATA` writer - GPIO output enable register for GPIO0-29"]
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    #[doc = "Bits 0:29 - GPIO output enable register for GPIO0-29"]
    #[inline(always)]
    pub fn data(&self) -> DATA_R {
        DATA_R::new(self.bits & 0x3fff_ffff)
    }
}
