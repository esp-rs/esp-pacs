...
#[doc = "Field `FUNC55_IN_SEL` reader - set this value: s=0-29: connect GPIO\\[s\\] to this port. s=0x20: set this port always high level. s=0x30: set this port always low level."]
pub type FUNC55_IN_SEL_R = crate::FieldReader;
#[doc = "Field `FUNC55_IN_SEL` writer - set this value: s=0-29: connect GPIO\\[s\\] to this port. s=0x20: set this port always high level. s=0x30: set this port always low level."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC55_IN_SEL_CFG")
            .field("func55_in_sel", &self.func55_in_sel())
            .field("func55_in_inv_sel", &self.func55_in_inv_sel())
            .field("sig55_in_sel", &self.sig55_in_sel())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5 - set this value: s=0-29: connect GPIO\\[s\\] to this port. s=0x20: set this port always high level. s=0x30: set this port always low level."]
    #[inline(always)]
    pub fn func55_in_sel(&mut self) -> FUNC55_IN_SEL_W<'_, FUNC55_IN_SEL_CFG_SPEC> {
        FUNC55_IN_SEL_W::new(self, 0)
    }
    #[doc = "Bit 6 - set this bit to invert input signal. 1:invert. 0:not invert."]
    #[inline(always)]
    pub fn func55_in_inv_sel(&mut self) -> FUNC55_IN_INV_SEL_W<'_, FUNC55_IN_SEL_CFG_SPEC> {
        FUNC55_IN_INV_SEL_W::new(self, 6)
    }
    #[doc = "Bit 7 - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
    #[inline(always)]
    pub fn sig55_in_sel(&mut self) -> SIG55_IN_SEL_W<'_, FUNC55_IN_SEL_CFG_SPEC> {
        SIG55_IN_SEL_W::new(self, 7)
    }
}
#[doc = "GPIO input function configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`func55_in_sel_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`func55_in_sel_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets FUNC55_IN_SEL_CFG to value 0x20"]
