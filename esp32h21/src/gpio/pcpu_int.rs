...
#[doc = "Field `PROCPU_INT` reader - GPIO_PROCPU_INT interrupt status register for GPIO0-29"]
pub type PROCPU_INT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:29 - GPIO_PROCPU_INT interrupt status register for GPIO0-29"]
    #[inline(always)]
    pub fn procpu_int(&self) -> PROCPU_INT_R {
        PROCPU_INT_R::new(self.bits & 0x3fff_ffff)
    }
}
