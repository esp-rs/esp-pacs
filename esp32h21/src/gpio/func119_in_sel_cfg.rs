...
#[doc = "Field `FUNC119_IN_SEL` reader - set this value: s=0-29: connect GPIO\\[s\\] to this port. s=0x20: set this port always high level. s=0x30: set this port always low level."]
pub type FUNC119_IN_SEL_R = crate::FieldReader;
#[doc = "Field `FUNC119_IN_SEL` writer - set this value: s=0-29: connect GPIO\\[s\\] to this port. s=0x20: set this port always high level. s=0x30: set this port always low level."]
pub type FUNC119_IN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
impl W {
    #[doc = "Bits 0:5 - set this value: s=0-29: connect GPIO\\[s\\] to this port. s=0x20: set this port always high level. s=0x30: set this port always low level."]
    #[inline(always)]
    pub fn func119_in_sel(&mut self) -> FUNC119_IN_SEL_W<'_, FUNC119_IN_SEL_CFG_SPEC> {
        FUNC119_IN_SEL_W::new(self, 0)
    }
    #[doc = "Bit 6 - set this bit to invert input signal. 1:invert. 0:not invert."]
    #[inline(always)]
    pub fn func119_in_inv_sel(&mut self) -> FUNC119_IN_INV_SEL_W<'_, FUNC119_IN_SEL_CFG_SPEC> {
        FUNC119_IN_INV_SEL_W::new(self, 6)
    }
    #[doc = "Bit 7 - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
    #[inline(always)]
    pub fn sig119_in_sel(&mut self) -> SIG119_IN_SEL_W<'_, FUNC119_IN_SEL_CFG_SPEC> {
        SIG119_IN_SEL_W::new(self, 7)
    }
}
...
#[doc = "`reset()` method sets FUNC119_IN_SEL_CFG to value 0x30"]
