...
impl RegisterBlock {
    ...
    #[doc = "0x14 - Channel 1 configure register 0"]
    #[inline(always)]
    ...
    #[doc = "0x20 - Channel 3 configure register 0"]
    #[inline(always)]
    ...
    #[doc = "0x24 - Channel 3 configure register 1"]
    #[inline(always)]
    ...
    #[doc = "0x48 - Channel 0 duty cycle configuration register"]
    #[inline(always)]
    pub const fn ch0carrier_duty(&self) -> &CHCARRIER_DUTY {
        self.chcarrier_duty(0)
    }
    #[doc = "0x4c - Channel 1 duty cycle configuration register"]
    #[inline(always)]
    ...
    #[doc = "0x50 - Channel 2 carrier remove register"]
    #[inline(always)]
    pub const fn ch2_rx_carrier_rm(&self) -> &CH_RX_CARRIER_RM {
        self.ch_rx_carrier_rm(0)
    }
    #[doc = "0x54 - Channel 3 carrier remove register"]
    #[inline(always)]
    ...
    #[doc = "0x58 - Channel 0 Tx event configuration register"]
    #[inline(always)]
    pub const fn ch0_tx_lim(&self) -> &CH_TX_LIM {
        self.ch_tx_lim(0)
    }
    #[doc = "0x5c - Channel 1 Tx event configuration register"]
    #[inline(always)]
    ...
    #[doc = "0x60 - Channel 2 Rx event configuration register"]
    #[inline(always)]
    pub const fn ch2_rx_lim(&self) -> &CH_RX_LIM {
        self.ch_rx_lim(0)
    }
    #[doc = "0x64 - Channel 3 Rx event configuration register"]
    #[inline(always)]
