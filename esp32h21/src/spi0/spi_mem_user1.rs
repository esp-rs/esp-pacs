...
impl R {
    ...
    pub fn spi_mem_usr_dbytelen(&self) -> SPI_MEM_USR_DBYTELEN_R {
        SPI_MEM_USR_DBYTELEN_R::new(((self.bits >> 6) & 0x3f) as u8)
    }
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_USER1")
            .field(
                ...
                &self.spi_mem_usr_dummy_cyclelen(),
            )
            .field("spi_mem_usr_dbytelen", &self.spi_mem_usr_dbytelen())
            .field("spi_mem_usr_addr_bitlen", &self.spi_mem_usr_addr_bitlen())
            .finish()
    }
}
impl W {
    ...
    pub fn spi_mem_usr_dummy_cyclelen(
        &mut self,
    ) -> SPI_MEM_USR_DUMMY_CYCLELEN_W<'_, SPI_MEM_USER1_SPEC> {
        SPI_MEM_USR_DUMMY_CYCLELEN_W::new(self, 0)
    }
    #[doc = "Bits 26:31 - The length in bits of address phase. The register value shall be (bit_num-1)."]
    #[inline(always)]
    pub fn spi_mem_usr_addr_bitlen(&mut self) -> SPI_MEM_USR_ADDR_BITLEN_W<'_, SPI_MEM_USER1_SPEC> {
        SPI_MEM_USR_ADDR_BITLEN_W::new(self, 26)
    }
}
#[doc = "SPI0 user1 register.\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_user1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_user1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
