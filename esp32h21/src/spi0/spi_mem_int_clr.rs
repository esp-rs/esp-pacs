...
#[doc = "Field `SPI_MEM_NANDFLASH_PE_FAIL_INT_CLR` reader - The clear bit for SPI_MEM_NANDFLASH_PE_FAIL_INT interrupt."]
pub type SPI_MEM_NANDFLASH_PE_FAIL_INT_CLR_R = crate::BitReader;
#[doc = "Field `SPI_MEM_NANDFLASH_ECC_ERR_INT_CLR` reader - The clear bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt."]
pub type SPI_MEM_NANDFLASH_ECC_ERR_INT_CLR_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 11 - The clear bit for SPI_MEM_NANDFLASH_PE_FAIL_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_nandflash_pe_fail_int_clr(&self) -> SPI_MEM_NANDFLASH_PE_FAIL_INT_CLR_R {
        SPI_MEM_NANDFLASH_PE_FAIL_INT_CLR_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - The clear bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_nandflash_ecc_err_int_clr(&self) -> SPI_MEM_NANDFLASH_ECC_ERR_INT_CLR_R {
        SPI_MEM_NANDFLASH_ECC_ERR_INT_CLR_R::new(((self.bits >> 12) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_INT_CLR")
            .field("spi_mem_ecc_err_int_clr", &self.spi_mem_ecc_err_int_clr())
            .field(
                "spi_mem_axi_wr_flash_err_int_clr",
                &self.spi_mem_axi_wr_flash_err_int_clr(),
            )
            .field(
                "spi_mem_axi_waddr_err_int_clr",
                &self.spi_mem_axi_waddr_err_int_clr(),
            )
            .field(
                "spi_mem_nandflash_pe_fail_int_clr",
                &self.spi_mem_nandflash_pe_fail_int_clr(),
            )
            .field(
                "spi_mem_nandflash_ecc_err_int_clr",
                &self.spi_mem_nandflash_ecc_err_int_clr(),
            )
            .finish()
    }
}
...
#[doc = "SPI0 interrupt clear register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_int_clr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_int_clr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
