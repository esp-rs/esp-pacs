...
#[doc = "Field `SPI_FMEM_PAGE_SIZE` reader - Set the page size of the flash accessed by MSPI. 0: 256 bytes. 1: 512 bytes. 2: 1024 bytes. 3: 2048 bytes. 4: 4096 bytes."]
pub type SPI_FMEM_PAGE_SIZE_R = crate::FieldReader;
#[doc = "Field `SPI_FMEM_PAGE_SIZE` writer - Set the page size of the flash accessed by MSPI. 0: 256 bytes. 1: 512 bytes. 2: 1024 bytes. 3: 2048 bytes. 4: 4096 bytes."]
pub type SPI_FMEM_PAGE_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
impl R {
    ...
    #[doc = "Bits 18:20 - Set the page size of the flash accessed by MSPI. 0: 256 bytes. 1: 512 bytes. 2: 1024 bytes. 3: 2048 bytes. 4: 4096 bytes."]
    #[inline(always)]
    pub fn spi_fmem_page_size(&self) -> SPI_FMEM_PAGE_SIZE_R {
        SPI_FMEM_PAGE_SIZE_R::new(((self.bits >> 18) & 7) as u8)
    }
    ...
    pub fn spi_fmem_ecc_addr_en(&self) -> SPI_FMEM_ECC_ADDR_EN_R {
        SPI_FMEM_ECC_ADDR_EN_R::new(((self.bits >> 21) & 1) != 0)
    }
    ...
    pub fn spi_mem_usr_ecc_addr_en(&self) -> SPI_MEM_USR_ECC_ADDR_EN_R {
        SPI_MEM_USR_ECC_ADDR_EN_R::new(((self.bits >> 22) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_ECC_CTRL")
            .field("spi_mem_ecc_err_cnt", &self.spi_mem_ecc_err_cnt())
            ...
            .field("spi_mem_usr_ecc_addr_en", &self.spi_mem_usr_ecc_addr_en())
            .field(
                "spi_mem_ecc_continue_record_err_en",
                &self.spi_mem_ecc_continue_record_err_en(),
            )
            .field("spi_mem_ecc_err_bits", &self.spi_mem_ecc_err_bits())
            .finish()
    }
}
impl W {
    #[doc = "Bits 18:20 - Set the page size of the flash accessed by MSPI. 0: 256 bytes. 1: 512 bytes. 2: 1024 bytes. 3: 2048 bytes. 4: 4096 bytes."]
    #[inline(always)]
    pub fn spi_fmem_page_size(&mut self) -> SPI_FMEM_PAGE_SIZE_W<'_, SPI_MEM_ECC_CTRL_SPEC> {
