...
#[doc = "Field `NANDFLASH_PE_FAIL` reader - The clear bit for SPI_MEM_NANDFLASH_PE_FAIL_INT interrupt."]
pub type NANDFLASH_PE_FAIL_R = crate::BitReader;
#[doc = "Field `NANDFLASH_ECC_ERR` reader - The clear bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt."]
