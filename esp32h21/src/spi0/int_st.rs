...
#[doc = "Field `AXI_RADDR_ERR` reader - The status bit for SPI_MEM_AXI_RADDR_ERR_INT interrupt."]
pub type AXI_RADDR_ERR_R = crate::BitReader;
#[doc = "Field `AXI_WR_FLASH_ERR` reader - The status bit for SPI_MEM_AXI_WR_FALSH_ERR_INT interrupt."]
pub type AXI_WR_FLASH_ERR_R = crate::BitReader;
#[doc = "Field `AXI_WADDR_ERR` reader - The status bit for SPI_MEM_AXI_WADDR_ERR_INT interrupt."]
pub type AXI_WADDR_ERR_R = crate::BitReader;
#[doc = "Field `NANDFLASH_PE_FAIL` reader - The status bit for SPI_MEM_NANDFLASH_PE_FAIL_INT interrupt."]
pub type NANDFLASH_PE_FAIL_R = crate::BitReader;
#[doc = "Field `NANDFLASH_ECC_ERR` reader - The status bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt."]
pub type NANDFLASH_ECC_ERR_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn nandflash_pe_fail(&self) -> NANDFLASH_PE_FAIL_R {
        NANDFLASH_PE_FAIL_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - The status bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt."]
    #[inline(always)]
    pub fn nandflash_ecc_err(&self) -> NANDFLASH_ECC_ERR_R {
        NANDFLASH_ECC_ERR_R::new(((self.bits >> 12) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            ...
            .field("nandflash_pe_fail", &self.nandflash_pe_fail())
            .field("nandflash_ecc_err", &self.nandflash_ecc_err())
            .finish()
    }
}
