...
#[doc = "Field `SPI_MEM_NANDFLASH_PE_FAIL_INT_ENA` reader - The enable bit for SPI_MEM_NANDFLASH_PE_FAIL_INT interrupt."]
pub type SPI_MEM_NANDFLASH_PE_FAIL_INT_ENA_R = crate::BitReader;
#[doc = "Field `SPI_MEM_NANDFLASH_ECC_ERR_INT_ENA` reader - The enable bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt."]
pub type SPI_MEM_NANDFLASH_ECC_ERR_INT_ENA_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 11 - The enable bit for SPI_MEM_NANDFLASH_PE_FAIL_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_nandflash_pe_fail_int_ena(&self) -> SPI_MEM_NANDFLASH_PE_FAIL_INT_ENA_R {
        SPI_MEM_NANDFLASH_PE_FAIL_INT_ENA_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - The enable bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_nandflash_ecc_err_int_ena(&self) -> SPI_MEM_NANDFLASH_ECC_ERR_INT_ENA_R {
        SPI_MEM_NANDFLASH_ECC_ERR_INT_ENA_R::new(((self.bits >> 12) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_INT_ENA")
            ...
            .field(
                "spi_mem_nandflash_pe_fail_int_ena",
                &self.spi_mem_nandflash_pe_fail_int_ena(),
            )
            .field(
                "spi_mem_nandflash_ecc_err_int_ena",
                &self.spi_mem_nandflash_ecc_err_int_ena(),
            )
            .finish()
    }
}
