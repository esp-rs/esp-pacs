    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_AXI_ERR_RESP_EN")
            .field(
                ...
                &self.spi_mem_aw_resp_en_mmu_vld(),
            )
            .field(
                "spi_mem_aw_resp_en_mmu_gid",
                &self.spi_mem_aw_resp_en_mmu_gid(),
            )
            .field(
                "spi_mem_aw_resp_en_axi_size",
                &self.spi_mem_aw_resp_en_axi_size(),
            )
            .field(
                "spi_mem_aw_resp_en_axi_flash",
                &self.spi_mem_aw_resp_en_axi_flash(),
            )
            .field(
                "spi_mem_aw_resp_en_mmu_ecc",
                &self.spi_mem_aw_resp_en_mmu_ecc(),
            )
            .field(
                "spi_mem_aw_resp_en_mmu_sens",
                &self.spi_mem_aw_resp_en_mmu_sens(),
            )
            .field(
                "spi_mem_aw_resp_en_axi_wstrb",
                &self.spi_mem_aw_resp_en_axi_wstrb(),
            )
            .field(
                "spi_mem_ar_resp_en_mmu_vld",
                &self.spi_mem_ar_resp_en_mmu_vld(),
            )
            .field(
                "spi_mem_ar_resp_en_mmu_gid",
                &self.spi_mem_ar_resp_en_mmu_gid(),
            )
            .field(
                "spi_mem_ar_resp_en_mmu_ecc",
                &self.spi_mem_ar_resp_en_mmu_ecc(),
            )
            .field(
                "spi_mem_ar_resp_en_mmu_sens",
                &self.spi_mem_ar_resp_en_mmu_sens(),
            )
            .field(
                "spi_mem_ar_resp_en_axi_size",
                &self.spi_mem_ar_resp_en_axi_size(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn spi_mem_aw_resp_en_mmu_vld(
        &mut self,
    ) -> SPI_MEM_AW_RESP_EN_MMU_VLD_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_aw_resp_en_mmu_gid(
        &mut self,
    ) -> SPI_MEM_AW_RESP_EN_MMU_GID_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_aw_resp_en_axi_size(
        &mut self,
    ) -> SPI_MEM_AW_RESP_EN_AXI_SIZE_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_aw_resp_en_axi_flash(
        &mut self,
    ) -> SPI_MEM_AW_RESP_EN_AXI_FLASH_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_aw_resp_en_mmu_ecc(
        &mut self,
    ) -> SPI_MEM_AW_RESP_EN_MMU_ECC_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_aw_resp_en_mmu_sens(
        &mut self,
    ) -> SPI_MEM_AW_RESP_EN_MMU_SENS_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_aw_resp_en_axi_wstrb(
        &mut self,
    ) -> SPI_MEM_AW_RESP_EN_AXI_WSTRB_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_ar_resp_en_mmu_vld(
        &mut self,
    ) -> SPI_MEM_AR_RESP_EN_MMU_VLD_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_ar_resp_en_mmu_gid(
        &mut self,
    ) -> SPI_MEM_AR_RESP_EN_MMU_GID_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_ar_resp_en_mmu_ecc(
        &mut self,
    ) -> SPI_MEM_AR_RESP_EN_MMU_ECC_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_ar_resp_en_mmu_sens(
        &mut self,
    ) -> SPI_MEM_AR_RESP_EN_MMU_SENS_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
    ...
    pub fn spi_mem_ar_resp_en_axi_size(
        &mut self,
    ) -> SPI_MEM_AR_RESP_EN_AXI_SIZE_W<'_, SPI_MEM_AXI_ERR_RESP_EN_SPEC> {
        SPI_MEM_AR_RESP_EN_AXI_SIZE_W::new(self, 11)
    }
}
#[doc = "SPI0 AXI error response enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_axi_err_resp_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_axi_err_resp_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
