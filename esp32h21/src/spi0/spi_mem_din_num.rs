...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_DIN_NUM")
            .field("spi_mem_din0_num", &self.spi_mem_din0_num())
            .field("spi_mem_din1_num", &self.spi_mem_din1_num())
            .field("spi_mem_din2_num", &self.spi_mem_din2_num())
            .field("spi_mem_din3_num", &self.spi_mem_din3_num())
            .field("spi_mem_din4_num", &self.spi_mem_din4_num())
            .field("spi_mem_din5_num", &self.spi_mem_din5_num())
            .field("spi_mem_din6_num", &self.spi_mem_din6_num())
            .field("spi_mem_din7_num", &self.spi_mem_din7_num())
            .field("spi_mem_dins_num", &self.spi_mem_dins_num())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:1 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn spi_mem_din0_num(&mut self) -> SPI_MEM_DIN0_NUM_W<'_, SPI_MEM_DIN_NUM_SPEC> {
        SPI_MEM_DIN0_NUM_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn spi_mem_din1_num(&mut self) -> SPI_MEM_DIN1_NUM_W<'_, SPI_MEM_DIN_NUM_SPEC> {
        SPI_MEM_DIN1_NUM_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn spi_mem_din2_num(&mut self) -> SPI_MEM_DIN2_NUM_W<'_, SPI_MEM_DIN_NUM_SPEC> {
        SPI_MEM_DIN2_NUM_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn spi_mem_din3_num(&mut self) -> SPI_MEM_DIN3_NUM_W<'_, SPI_MEM_DIN_NUM_SPEC> {
        SPI_MEM_DIN3_NUM_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn spi_mem_din4_num(&mut self) -> SPI_MEM_DIN4_NUM_W<'_, SPI_MEM_DIN_NUM_SPEC> {
        SPI_MEM_DIN4_NUM_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn spi_mem_din5_num(&mut self) -> SPI_MEM_DIN5_NUM_W<'_, SPI_MEM_DIN_NUM_SPEC> {
        SPI_MEM_DIN5_NUM_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn spi_mem_din6_num(&mut self) -> SPI_MEM_DIN6_NUM_W<'_, SPI_MEM_DIN_NUM_SPEC> {
        SPI_MEM_DIN6_NUM_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn spi_mem_din7_num(&mut self) -> SPI_MEM_DIN7_NUM_W<'_, SPI_MEM_DIN_NUM_SPEC> {
        SPI_MEM_DIN7_NUM_W::new(self, 14)
    }
    #[doc = "Bits 16:17 - the input signals are delayed by system clock cycles, 0: delayed by 1 cycle, 1: delayed by 2 cycles,..."]
    #[inline(always)]
    pub fn spi_mem_dins_num(&mut self) -> SPI_MEM_DINS_NUM_W<'_, SPI_MEM_DIN_NUM_SPEC> {
        SPI_MEM_DINS_NUM_W::new(self, 16)
    }
}
#[doc = "MSPI flash input timing delay number control register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_din_num::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_din_num::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
