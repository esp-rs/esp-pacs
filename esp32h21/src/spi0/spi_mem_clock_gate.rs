...
impl W {
    #[doc = "Bit 0 - Register clock gate enable signal. 1: Enable. 0: Disable."]
    #[inline(always)]
    pub fn spi_clk_en(&mut self) -> SPI_CLK_EN_W<'_, SPI_MEM_CLOCK_GATE_SPEC> {
        SPI_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - MSPI lowpower function clock gate force on signal. 1: Enable. 0: Disable."]
    #[inline(always)]
    pub fn spi_mspi_clk_force_on(
        &mut self,
    ) -> SPI_MSPI_CLK_FORCE_ON_W<'_, SPI_MEM_CLOCK_GATE_SPEC> {
        SPI_MSPI_CLK_FORCE_ON_W::new(self, 1)
    }
}
#[doc = "SPI0 clock gate register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_clock_gate::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_clock_gate::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets SPI_MEM_CLOCK_GATE to value 0x03"]
