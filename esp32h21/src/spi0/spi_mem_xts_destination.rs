...
impl W {
    ...
    pub fn spi_xts_destination(
        &mut self,
    ) -> SPI_XTS_DESTINATION_W<'_, SPI_MEM_XTS_DESTINATION_SPEC> {
        SPI_XTS_DESTINATION_W::new(self, 0)
    }
}
#[doc = "Manual Encryption destination register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_xts_destination::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_xts_destination::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
