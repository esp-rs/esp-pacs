...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_USER")
            .field("spi_mem_cs_hold", &self.spi_mem_cs_hold())
            .field("spi_mem_cs_setup", &self.spi_mem_cs_setup())
...
impl W {
    #[doc = "Bit 6 - spi cs keep low when spi is in done phase. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_cs_hold(&mut self) -> SPI_MEM_CS_HOLD_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_CS_HOLD_W::new(self, 6)
    }
    #[doc = "Bit 7 - spi cs is enable when spi is in prepare phase. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_cs_setup(&mut self) -> SPI_MEM_CS_SETUP_W<'_, SPI_MEM_USER_SPEC> {
