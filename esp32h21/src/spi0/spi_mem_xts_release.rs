...
impl W {
    ...
    #[inline(always)]
    pub fn spi_xts_release(&mut self) -> SPI_XTS_RELEASE_W<'_, SPI_MEM_XTS_RELEASE_SPEC> {
        SPI_XTS_RELEASE_W::new(self, 0)
    }
}
#[doc = "Manual Encryption physical address register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_xts_release::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
