...
#[doc = "Field `NANDFLASH_PE_FAIL` reader - The raw bit for SPI_MEM_NANDFLASH_PE_FAIL_INT interrupt. 1: Triggered when NAND FLASH SPI SEQ found P/E_FAIL bits is err when RDSR. 0: Others."]
pub type NANDFLASH_PE_FAIL_R = crate::BitReader;
#[doc = "Field `NANDFLASH_ECC_ERR` reader - The raw bit for SPI_MEM_NANDFLASH_ECC_ERR_INT interrupt. 1: Triggered when NAND FLASH SPI SEQ found ECCS bits is err when RDSR. 0: Others."]
