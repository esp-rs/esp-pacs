#[doc = "Register `GPIO_EXT_SIGMADELTA%s` reader"]
pub type R = crate::R<GPIO_EXT_SIGMADELTA_SPEC>;
#[doc = "Register `GPIO_EXT_SIGMADELTA%s` writer"]
pub type W = crate::W<GPIO_EXT_SIGMADELTA_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPIO_EXT_SIGMADELTA")
...
impl W {
    #[doc = "Bits 0:7 - This field is used to configure the duty cycle of sigma delta modulation output."]
    #[inline(always)]
    pub fn gpio_ext_sd_in(&mut self) -> GPIO_EXT_SD_IN_W<'_, GPIO_EXT_SIGMADELTA_SPEC> {
        GPIO_EXT_SD_IN_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - This field is used to set a divider value to divide APB clock."]
    #[inline(always)]
    pub fn gpio_ext_sd_prescale(&mut self) -> GPIO_EXT_SD_PRESCALE_W<'_, GPIO_EXT_SIGMADELTA_SPEC> {
        GPIO_EXT_SD_PRESCALE_W::new(self, 8)
    }
}
#[doc = "Duty Cycle Configure Register of SDM%s\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio_ext_sigmadelta::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio_ext_sigmadelta::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPIO_EXT_SIGMADELTA_SPEC;
impl crate::RegisterSpec for GPIO_EXT_SIGMADELTA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio_ext_sigmadelta::R`](R) reader structure"]
impl crate::Readable for GPIO_EXT_SIGMADELTA_SPEC {}
#[doc = "`write(|w| ..)` method takes [`gpio_ext_sigmadelta::W`](W) writer structure"]
impl crate::Writable for GPIO_EXT_SIGMADELTA_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO_EXT_SIGMADELTA%s to value 0xff00"]
impl crate::Resettable for GPIO_EXT_SIGMADELTA_SPEC {
