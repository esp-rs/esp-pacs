...
#[doc = "Field `GPIO_SEL(_EXT_ETM_TASK_GPIO20,_EXT_ETM_TASK_GPIO21,_EXT_ETM_TASK_GPIO22,_EXT_ETM_TASK_GPIO23,_EXT_ETM_TASK_GPIO24)` reader - GPIO choose a etm task channel."]
pub type GPIO_SEL_R = crate::FieldReader;
#[doc = "Field `GPIO_SEL(_EXT_ETM_TASK_GPIO20,_EXT_ETM_TASK_GPIO21,_EXT_ETM_TASK_GPIO22,_EXT_ETM_TASK_GPIO23,_EXT_ETM_TASK_GPIO24)` writer - GPIO choose a etm task channel."]
pub type GPIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `GPIO_EN(_EXT_ETM_TASK_GPIO20,_EXT_ETM_TASK_GPIO21,_EXT_ETM_TASK_GPIO22,_EXT_ETM_TASK_GPIO23,_EXT_ETM_TASK_GPIO24)` reader - Enable bit of GPIO response etm task."]
pub type GPIO_EN_R = crate::BitReader;
#[doc = "Field `GPIO_EN(_EXT_ETM_TASK_GPIO20,_EXT_ETM_TASK_GPIO21,_EXT_ETM_TASK_GPIO22,_EXT_ETM_TASK_GPIO23,_EXT_ETM_TASK_GPIO24)` writer - Enable bit of GPIO response etm task."]
