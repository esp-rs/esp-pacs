...
#[doc = "Field `GPIO_SEL(_EXT_ETM_TASK_GPIO5,_EXT_ETM_TASK_GPIO6,_EXT_ETM_TASK_GPIO7,_EXT_ETM_TASK_GPIO8,_EXT_ETM_TASK_GPIO9)` reader - GPIO choose a etm task channel."]
pub type GPIO_SEL_R = crate::FieldReader;
#[doc = "Field `GPIO_SEL(_EXT_ETM_TASK_GPIO5,_EXT_ETM_TASK_GPIO6,_EXT_ETM_TASK_GPIO7,_EXT_ETM_TASK_GPIO8,_EXT_ETM_TASK_GPIO9)` writer - GPIO choose a etm task channel."]
pub type GPIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `GPIO_EN(_EXT_ETM_TASK_GPIO5,_EXT_ETM_TASK_GPIO6,_EXT_ETM_TASK_GPIO7,_EXT_ETM_TASK_GPIO8,_EXT_ETM_TASK_GPIO9)` reader - Enable bit of GPIO response etm task."]
pub type GPIO_EN_R = crate::BitReader;
#[doc = "Field `GPIO_EN(_EXT_ETM_TASK_GPIO5,_EXT_ETM_TASK_GPIO6,_EXT_ETM_TASK_GPIO7,_EXT_ETM_TASK_GPIO8,_EXT_ETM_TASK_GPIO9)` writer - Enable bit of GPIO response etm task."]
