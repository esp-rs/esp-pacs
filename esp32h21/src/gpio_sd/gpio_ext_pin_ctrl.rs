#[doc = "Register `GPIO_EXT_PIN_CTRL` reader"]
pub type R = crate::R<GPIO_EXT_PIN_CTRL_SPEC>;
#[doc = "Register `GPIO_EXT_PIN_CTRL` writer"]
pub type W = crate::W<GPIO_EXT_PIN_CTRL_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPIO_EXT_PIN_CTRL")
...
impl W {
    #[doc = "Bits 0:4 - If you want to output clock for I2S to CLK_OUT_out1, set this register to 0x0. CLK_OUT_out1 can be found in peripheral output signals."]
    #[inline(always)]
    pub fn gpio_ext_clk_out1(&mut self) -> GPIO_EXT_CLK_OUT1_W<'_, GPIO_EXT_PIN_CTRL_SPEC> {
        GPIO_EXT_CLK_OUT1_W::new(self, 0)
    }
    #[doc = "Bits 5:9 - If you want to output clock for I2S to CLK_OUT_out2, set this register to 0x0. CLK_OUT_out2 can be found in peripheral output signals."]
    #[inline(always)]
    pub fn gpio_ext_clk_out2(&mut self) -> GPIO_EXT_CLK_OUT2_W<'_, GPIO_EXT_PIN_CTRL_SPEC> {
        GPIO_EXT_CLK_OUT2_W::new(self, 5)
    }
    #[doc = "Bits 10:14 - If you want to output clock for I2S to CLK_OUT_out3, set this register to 0x0. CLK_OUT_out3 can be found in peripheral output signals."]
    #[inline(always)]
    pub fn gpio_ext_clk_out3(&mut self) -> GPIO_EXT_CLK_OUT3_W<'_, GPIO_EXT_PIN_CTRL_SPEC> {
        GPIO_EXT_CLK_OUT3_W::new(self, 10)
    }
}
#[doc = "Clock Output Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio_ext_pin_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio_ext_pin_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GPIO_EXT_PIN_CTRL_SPEC;
impl crate::RegisterSpec for GPIO_EXT_PIN_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpio_ext_pin_ctrl::R`](R) reader structure"]
impl crate::Readable for GPIO_EXT_PIN_CTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`gpio_ext_pin_ctrl::W`](W) writer structure"]
impl crate::Writable for GPIO_EXT_PIN_CTRL_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets GPIO_EXT_PIN_CTRL to value 0x1def"]
impl crate::Resettable for GPIO_EXT_PIN_CTRL_SPEC {
