...
#[doc = "Field `SPI_DATE` reader - Version control register."]
pub type SPI_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `SPI_DATE` writer - Version control register."]
...
impl W {
    #[doc = "Bits 0:27 - Version control register."]
    #[inline(always)]
    pub fn spi_date(&mut self) -> SPI_DATE_W<'_, SPI_DATE_SPEC> {
        SPI_DATE_W::new(self, 0)
    }
}
#[doc = "Version control\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_date::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_date::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets SPI_DATE to value 0x0240_3190"]
impl crate::Resettable for SPI_DATE_SPEC {
    const RESET_VALUE: u32 = 0x0240_3190;
}
