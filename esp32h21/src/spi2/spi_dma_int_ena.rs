...
impl W {
    ...
    pub fn spi_dma_infifo_full_err_int_ena(
        &mut self,
    ) -> SPI_DMA_INFIFO_FULL_ERR_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_dma_outfifo_empty_err_int_ena(
        &mut self,
    ) -> SPI_DMA_OUTFIFO_EMPTY_ERR_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_DMA_OUTFIFO_EMPTY_ERR_INT_ENA_W::new(self, 1)
    }
    #[doc = "Bit 2 - Write 1 to enable SPI_SLV_EX_QPI_INT interrupt."]
    #[inline(always)]
    pub fn spi_slv_ex_qpi_int_ena(&mut self) -> SPI_SLV_EX_QPI_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_SLV_EX_QPI_INT_ENA_W::new(self, 2)
    }
    #[doc = "Bit 3 - Write 1 to enable SPI_SLV_EN_QPI_INT interrupt."]
    #[inline(always)]
    pub fn spi_slv_en_qpi_int_ena(&mut self) -> SPI_SLV_EN_QPI_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_SLV_EN_QPI_INT_ENA_W::new(self, 3)
    }
    #[doc = "Bit 4 - Write 1 to enable SPI_SLV_CMD7_INT interrupt."]
    #[inline(always)]
    pub fn spi_slv_cmd7_int_ena(&mut self) -> SPI_SLV_CMD7_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_SLV_CMD7_INT_ENA_W::new(self, 4)
    }
    #[doc = "Bit 5 - Write 1 to enable SPI_SLV_CMD8_INT interrupt."]
    #[inline(always)]
    pub fn spi_slv_cmd8_int_ena(&mut self) -> SPI_SLV_CMD8_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_SLV_CMD8_INT_ENA_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to enable SPI_SLV_CMD9_INT interrupt."]
    #[inline(always)]
    pub fn spi_slv_cmd9_int_ena(&mut self) -> SPI_SLV_CMD9_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_SLV_CMD9_INT_ENA_W::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to enable SPI_SLV_CMDA_INT interrupt."]
    #[inline(always)]
    pub fn spi_slv_cmda_int_ena(&mut self) -> SPI_SLV_CMDA_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_slv_rd_dma_done_int_ena(
        &mut self,
    ) -> SPI_SLV_RD_DMA_DONE_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_slv_wr_dma_done_int_ena(
        &mut self,
    ) -> SPI_SLV_WR_DMA_DONE_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_slv_rd_buf_done_int_ena(
        &mut self,
    ) -> SPI_SLV_RD_BUF_DONE_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_slv_wr_buf_done_int_ena(
        &mut self,
    ) -> SPI_SLV_WR_BUF_DONE_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_SLV_WR_BUF_DONE_INT_ENA_W::new(self, 11)
    }
    #[doc = "Bit 12 - Write 1 to enable SPI_TRANS_DONE_INT interrupt."]
    #[inline(always)]
    pub fn spi_trans_done_int_ena(&mut self) -> SPI_TRANS_DONE_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_dma_seg_trans_done_int_ena(
        &mut self,
    ) -> SPI_DMA_SEG_TRANS_DONE_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_seg_magic_err_int_ena(
        &mut self,
    ) -> SPI_SEG_MAGIC_ERR_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_slv_buf_addr_err_int_ena(
        &mut self,
    ) -> SPI_SLV_BUF_ADDR_ERR_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_SLV_BUF_ADDR_ERR_INT_ENA_W::new(self, 15)
    }
    #[doc = "Bit 16 - Write 1 to enable SPI_SLV_CMD_ERR_INT interrupt."]
    #[inline(always)]
    pub fn spi_slv_cmd_err_int_ena(
        &mut self,
    ) -> SPI_SLV_CMD_ERR_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_mst_rx_afifo_wfull_err_int_ena(
        &mut self,
    ) -> SPI_MST_RX_AFIFO_WFULL_ERR_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
    ...
    pub fn spi_mst_tx_afifo_rempty_err_int_ena(
        &mut self,
    ) -> SPI_MST_TX_AFIFO_REMPTY_ERR_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_MST_TX_AFIFO_REMPTY_ERR_INT_ENA_W::new(self, 18)
    }
    #[doc = "Bit 19 - Write 1 to enable SPI_APP2_INT interrupt."]
    #[inline(always)]
    pub fn spi_app2_int_ena(&mut self) -> SPI_APP2_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
        SPI_APP2_INT_ENA_W::new(self, 19)
    }
    #[doc = "Bit 20 - Write 1 to enable SPI_APP1_INT interrupt."]
    #[inline(always)]
    pub fn spi_app1_int_ena(&mut self) -> SPI_APP1_INT_ENA_W<'_, SPI_DMA_INT_ENA_SPEC> {
