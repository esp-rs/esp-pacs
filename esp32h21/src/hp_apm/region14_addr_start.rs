...
pub type REGION14_ADDR_START_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION14_ADDR_START")
            .field("region14_addr_start", &self.region14_addr_start())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Start address of region14"]
    #[inline(always)]
    pub fn region14_addr_start(&mut self) -> REGION14_ADDR_START_W<'_, REGION14_ADDR_START_SPEC> {
        REGION14_ADDR_START_W::new(self, 0)
    }
}
#[doc = "Region address register\n\nYou can [`read`](crate::Reg::read) this register and get [`region14_addr_start::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`region14_addr_start::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
