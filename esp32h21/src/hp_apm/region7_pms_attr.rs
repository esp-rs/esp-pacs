...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION7_PMS_ATTR")
            .field("region7_r0_pms_x", &self.region7_r0_pms_x())
            .field("region7_r0_pms_w", &self.region7_r0_pms_w())
            .field("region7_r0_pms_r", &self.region7_r0_pms_r())
            .field("region7_r1_pms_x", &self.region7_r1_pms_x())
            .field("region7_r1_pms_w", &self.region7_r1_pms_w())
            .field("region7_r1_pms_r", &self.region7_r1_pms_r())
            .field("region7_r2_pms_x", &self.region7_r2_pms_x())
            .field("region7_r2_pms_w", &self.region7_r2_pms_w())
            .field("region7_r2_pms_r", &self.region7_r2_pms_r())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - Region execute authority in REE_MODE0"]
    #[inline(always)]
    pub fn region7_r0_pms_x(&mut self) -> REGION7_R0_PMS_X_W<'_, REGION7_PMS_ATTR_SPEC> {
        REGION7_R0_PMS_X_W::new(self, 0)
    }
    #[doc = "Bit 1 - Region write authority in REE_MODE0"]
    #[inline(always)]
    pub fn region7_r0_pms_w(&mut self) -> REGION7_R0_PMS_W_W<'_, REGION7_PMS_ATTR_SPEC> {
        REGION7_R0_PMS_W_W::new(self, 1)
    }
    #[doc = "Bit 2 - Region read authority in REE_MODE0"]
    #[inline(always)]
    pub fn region7_r0_pms_r(&mut self) -> REGION7_R0_PMS_R_W<'_, REGION7_PMS_ATTR_SPEC> {
        REGION7_R0_PMS_R_W::new(self, 2)
    }
    #[doc = "Bit 4 - Region execute authority in REE_MODE1"]
    #[inline(always)]
    pub fn region7_r1_pms_x(&mut self) -> REGION7_R1_PMS_X_W<'_, REGION7_PMS_ATTR_SPEC> {
        REGION7_R1_PMS_X_W::new(self, 4)
    }
    #[doc = "Bit 5 - Region write authority in REE_MODE1"]
    #[inline(always)]
    pub fn region7_r1_pms_w(&mut self) -> REGION7_R1_PMS_W_W<'_, REGION7_PMS_ATTR_SPEC> {
        REGION7_R1_PMS_W_W::new(self, 5)
    }
    #[doc = "Bit 6 - Region read authority in REE_MODE1"]
    #[inline(always)]
    pub fn region7_r1_pms_r(&mut self) -> REGION7_R1_PMS_R_W<'_, REGION7_PMS_ATTR_SPEC> {
        REGION7_R1_PMS_R_W::new(self, 6)
    }
    #[doc = "Bit 8 - Region execute authority in REE_MODE2"]
    #[inline(always)]
    pub fn region7_r2_pms_x(&mut self) -> REGION7_R2_PMS_X_W<'_, REGION7_PMS_ATTR_SPEC> {
        REGION7_R2_PMS_X_W::new(self, 8)
    }
    #[doc = "Bit 9 - Region write authority in REE_MODE2"]
    #[inline(always)]
    pub fn region7_r2_pms_w(&mut self) -> REGION7_R2_PMS_W_W<'_, REGION7_PMS_ATTR_SPEC> {
        REGION7_R2_PMS_W_W::new(self, 9)
    }
    #[doc = "Bit 10 - Region read authority in REE_MODE2"]
    #[inline(always)]
    pub fn region7_r2_pms_r(&mut self) -> REGION7_R2_PMS_R_W<'_, REGION7_PMS_ATTR_SPEC> {
        REGION7_R2_PMS_R_W::new(self, 10)
    }
}
#[doc = "Region access authority attribute register\n\nYou can [`read`](crate::Reg::read) this register and get [`region7_pms_attr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`region7_pms_attr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
