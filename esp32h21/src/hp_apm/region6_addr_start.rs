...
pub type REGION6_ADDR_START_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION6_ADDR_START")
            .field("region6_addr_start", &self.region6_addr_start())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Start address of region6"]
    #[inline(always)]
    pub fn region6_addr_start(&mut self) -> REGION6_ADDR_START_W<'_, REGION6_ADDR_START_SPEC> {
        REGION6_ADDR_START_W::new(self, 0)
    }
}
