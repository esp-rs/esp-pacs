...
pub type M2_REGION_STATUS_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn m2_region_status_clr(&mut self) -> M2_REGION_STATUS_CLR_W<'_, M2_STATUS_CLR_SPEC> {
        M2_REGION_STATUS_CLR_W::new(self, 0)
    }
}
