...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION8_ADDR_START")
            .field("region8_addr_start", &self.region8_addr_start())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Start address of region8"]
    #[inline(always)]
    pub fn region8_addr_start(&mut self) -> REGION8_ADDR_START_W<'_, REGION8_ADDR_START_SPEC> {
        REGION8_ADDR_START_W::new(self, 0)
    }
}
#[doc = "Region address register\n\nYou can [`read`](crate::Reg::read) this register and get [`region8_addr_start::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`region8_addr_start::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
