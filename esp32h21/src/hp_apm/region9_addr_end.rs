...
pub type REGION9_ADDR_END_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION9_ADDR_END")
            .field("region9_addr_end", &self.region9_addr_end())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - End address of region9"]
    #[inline(always)]
    pub fn region9_addr_end(&mut self) -> REGION9_ADDR_END_W<'_, REGION9_ADDR_END_SPEC> {
        REGION9_ADDR_END_W::new(self, 0)
    }
}
#[doc = "Region address register\n\nYou can [`read`](crate::Reg::read) this register and get [`region9_addr_end::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`region9_addr_end::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
