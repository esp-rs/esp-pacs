...
pub type M1_REGION_STATUS_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn m1_region_status_clr(&mut self) -> M1_REGION_STATUS_CLR_W<'_, M1_STATUS_CLR_SPEC> {
        M1_REGION_STATUS_CLR_W::new(self, 0)
    }
}
