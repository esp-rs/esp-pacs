...
pub type ANA_FIB_ENA_R = crate::FieldReader;
#[doc = "Field `ANA_FIB_ENA` writer - need_des"]
pub type ANA_FIB_ENA_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 24:31 - need_des"]
    #[inline(always)]
    pub fn ana_fib_ena(&self) -> ANA_FIB_ENA_R {
        ANA_FIB_ENA_R::new(((self.bits >> 24) & 0xff) as u8)
    }
}
...
#[doc = "`reset()` method sets FIB_ENABLE to value 0xff00_0000"]
