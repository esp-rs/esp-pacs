    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            .field(
                ...
                &self.vddbat_charge_upvoltage_int_ena(),
            )
            .field(
                "vddbat_charge_undervoltage_int_ena",
                &self.vddbat_charge_undervoltage_int_ena(),
            )
            .field("vddbat_upvoltage_int_ena", &self.vddbat_upvoltage_int_ena())
            .field(
                "vddbat_undervoltage_int_ena",
                &self.vddbat_undervoltage_int_ena(),
            )
...
impl W {
    ...
    pub fn vddbat_charge_upvoltage_int_ena(
        &mut self,
    ) -> VDDBAT_CHARGE_UPVOLTAGE_INT_ENA_W<'_, INT_ENA_SPEC> {
    ...
    pub fn vddbat_charge_undervoltage_int_ena(
        &mut self,
    ) -> VDDBAT_CHARGE_UNDERVOLTAGE_INT_ENA_W<'_, INT_ENA_SPEC> {
        VDDBAT_CHARGE_UNDERVOLTAGE_INT_ENA_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn vddbat_upvoltage_int_ena(&mut self) -> VDDBAT_UPVOLTAGE_INT_ENA_W<'_, INT_ENA_SPEC> {
    ...
    pub fn vddbat_undervoltage_int_ena(
        &mut self,
    ) -> VDDBAT_UNDERVOLTAGE_INT_ENA_W<'_, INT_ENA_SPEC> {
        VDDBAT_UNDERVOLTAGE_INT_ENA_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn bod_mode0_int_ena(&mut self) -> BOD_MODE0_INT_ENA_W<'_, INT_ENA_SPEC> {
