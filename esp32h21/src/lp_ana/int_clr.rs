...
impl W {
    ...
    pub fn vddbat_charge_upvoltage_int_clr(
        &mut self,
    ) -> VDDBAT_CHARGE_UPVOLTAGE_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    pub fn vddbat_charge_undervoltage_int_clr(
        &mut self,
    ) -> VDDBAT_CHARGE_UNDERVOLTAGE_INT_CLR_W<'_, INT_CLR_SPEC> {
        VDDBAT_CHARGE_UNDERVOLTAGE_INT_CLR_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn vddbat_upvoltage_int_clr(&mut self) -> VDDBAT_UPVOLTAGE_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    pub fn vddbat_undervoltage_int_clr(
        &mut self,
    ) -> VDDBAT_UNDERVOLTAGE_INT_CLR_W<'_, INT_CLR_SPEC> {
        VDDBAT_UNDERVOLTAGE_INT_CLR_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn bod_mode0_int_clr(&mut self) -> BOD_MODE0_INT_CLR_W<'_, INT_CLR_SPEC> {
