...
pub type POWER_GLITCH_RESET_ENA_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 26:31 - need_des"]
    #[inline(always)]
    pub fn power_glitch_reset_ena(&self) -> POWER_GLITCH_RESET_ENA_R {
        POWER_GLITCH_RESET_ENA_R::new(((self.bits >> 26) & 0x3f) as u8)
    }
}
...
impl W {
    ...
    pub fn power_glitch_reset_ena(&mut self) -> POWER_GLITCH_RESET_ENA_W<'_, PG_GLITCH_CNTL_SPEC> {
        POWER_GLITCH_RESET_ENA_W::new(self, 26)
    }
}
