...
pub struct RegisterBlock {
    ...
    ch_conf1: (),
    _reserved4: [u8; 0x04],
    ch0_duty_r: CH0_DUTY_R,
    _reserved5: [u8; 0x10],
    ch1_duty_r: CH1_DUTY_R,
    _reserved6: [u8; 0x10],
    ch2_duty_r: CH2_DUTY_R,
    _reserved7: [u8; 0x10],
    ch3_duty_r: CH3_DUTY_R,
    _reserved8: [u8; 0x10],
    ch4_duty_r: CH4_DUTY_R,
    _reserved9: [u8; 0x10],
    ch5_duty_r: CH5_DUTY_R,
    _reserved10: [u8; 0x28],
    timer_conf: (),
    _reserved11: [u8; 0x04],
    timer_value: (),
...
impl RegisterBlock {
    ...
    #[doc = "0x10 - Current duty cycle for channel $n"]
    #[inline(always)]
    pub const fn ch0_duty_r(&self) -> &CH0_DUTY_R {
        &self.ch0_duty_r
    }
    #[doc = "0x24 - Current duty cycle for channel $n"]
    #[inline(always)]
    pub const fn ch1_duty_r(&self) -> &CH1_DUTY_R {
        &self.ch1_duty_r
    }
    #[doc = "0x38 - Current duty cycle for channel $n"]
    #[inline(always)]
    pub const fn ch2_duty_r(&self) -> &CH2_DUTY_R {
        &self.ch2_duty_r
    }
    #[doc = "0x4c - Initial duty cycle for channel $n"]
    #[inline(always)]
    pub const fn ch3_duty_r(&self) -> &CH3_DUTY_R {
        &self.ch3_duty_r
    }
    #[doc = "0x60 - Current duty cycle for channel $n"]
    #[inline(always)]
    pub const fn ch4_duty_r(&self) -> &CH4_DUTY_R {
        &self.ch4_duty_r
    }
    #[doc = "0x74 - Current duty cycle for channel $n"]
    #[inline(always)]
    pub const fn ch5_duty_r(&self) -> &CH5_DUTY_R {
        &self.ch5_duty_r
    }
...
pub mod ch_conf1;
#[doc = "CH0_DUTY_R (r) register accessor: Current duty cycle for channel $n\n\nYou can [`read`](crate::Reg::read) this register and get [`ch0_duty_r::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch0_duty_r`] module"]
pub type CH0_DUTY_R = crate::Reg<ch0_duty_r::CH0_DUTY_R_SPEC>;
#[doc = "Current duty cycle for channel $n"]
pub mod ch0_duty_r;
#[doc = "CH1_DUTY_R (r) register accessor: Current duty cycle for channel $n\n\nYou can [`read`](crate::Reg::read) this register and get [`ch1_duty_r::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch1_duty_r`] module"]
pub type CH1_DUTY_R = crate::Reg<ch1_duty_r::CH1_DUTY_R_SPEC>;
#[doc = "Current duty cycle for channel $n"]
pub mod ch1_duty_r;
#[doc = "CH2_DUTY_R (r) register accessor: Current duty cycle for channel $n\n\nYou can [`read`](crate::Reg::read) this register and get [`ch2_duty_r::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch2_duty_r`] module"]
pub type CH2_DUTY_R = crate::Reg<ch2_duty_r::CH2_DUTY_R_SPEC>;
#[doc = "Current duty cycle for channel $n"]
pub mod ch2_duty_r;
#[doc = "CH3_DUTY_R (r) register accessor: Initial duty cycle for channel $n\n\nYou can [`read`](crate::Reg::read) this register and get [`ch3_duty_r::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch3_duty_r`] module"]
pub type CH3_DUTY_R = crate::Reg<ch3_duty_r::CH3_DUTY_R_SPEC>;
#[doc = "Initial duty cycle for channel $n"]
pub mod ch3_duty_r;
#[doc = "CH4_DUTY_R (r) register accessor: Current duty cycle for channel $n\n\nYou can [`read`](crate::Reg::read) this register and get [`ch4_duty_r::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch4_duty_r`] module"]
pub type CH4_DUTY_R = crate::Reg<ch4_duty_r::CH4_DUTY_R_SPEC>;
#[doc = "Current duty cycle for channel $n"]
pub mod ch4_duty_r;
#[doc = "CH5_DUTY_R (r) register accessor: Current duty cycle for channel $n\n\nYou can [`read`](crate::Reg::read) this register and get [`ch5_duty_r::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ch5_duty_r`] module"]
pub type CH5_DUTY_R = crate::Reg<ch5_duty_r::CH5_DUTY_R_SPEC>;
#[doc = "Current duty cycle for channel $n"]
pub mod ch5_duty_r;
