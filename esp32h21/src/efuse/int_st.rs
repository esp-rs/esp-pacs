...
#[doc = "Field `READ_DONE_INT_ST` reader - The masked interrupt status of EFUSE_READ_DONE_INT."]
pub type READ_DONE_INT_ST_R = crate::BitReader;
#[doc = "Field `PGM_DONE_INT_ST` reader - The masked interrupt status of EFUSE_PGM_DONE_INT."]
pub type PGM_DONE_INT_ST_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - The masked interrupt status of EFUSE_READ_DONE_INT."]
    #[inline(always)]
    pub fn read_done_int_st(&self) -> READ_DONE_INT_ST_R {
        READ_DONE_INT_ST_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The masked interrupt status of EFUSE_PGM_DONE_INT."]
    #[inline(always)]
