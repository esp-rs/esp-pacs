...
pub type MAC_RESERVED_2_R = crate::FieldReader;
#[doc = "Field `PVT_CELL_SELECT` reader - Represents the selection of Power glitch monitor PVT cell.\\\\"]
pub type PVT_CELL_SELECT_R = crate::FieldReader;
#[doc = "Field `MAC_RESERVED_3` reader - Reserved."]
pub type MAC_RESERVED_3_R = crate::FieldReader;
...
impl R {
    ...
    pub fn mac_reserved_2(&self) -> MAC_RESERVED_2_R {
        MAC_RESERVED_2_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 4:10 - Represents the selection of Power glitch monitor PVT cell.\\\\"]
    #[inline(always)]
    pub fn pvt_cell_select(&self) -> PVT_CELL_SELECT_R {
        PVT_CELL_SELECT_R::new(((self.bits >> 4) & 0x7f) as u8)
    }
    #[doc = "Bits 11:17 - Reserved."]
    #[inline(always)]
    pub fn mac_reserved_3(&self) -> MAC_RESERVED_3_R {
        MAC_RESERVED_3_R::new(((self.bits >> 11) & 0x7f) as u8)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_MAC_SYS3")
            ...
            .field("mac_reserved_3", &self.mac_reserved_3())
