...
#[doc = "Field `POWERGLITCH_EN_ERR` reader - Represents the programming error of EFUSE_POWERGLITCH_EN"]
...
#[doc = "Field `ECDSA_CURVE_MODE_ERR` reader - Represents the programming error of EFUSE_ECDSA_CURVE_MODE"]
pub type ECDSA_CURVE_MODE_ERR_R = crate::FieldReader;
...
impl R {
    ...
    #[doc = "Bit 7 - Represents the programming error of EFUSE_PVT_GLITCH_EN"]
    #[inline(always)]
    pub fn pvt_glitch_en_err(&self) -> PVT_GLITCH_EN_ERR_R {
        PVT_GLITCH_EN_ERR_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[doc = "Bit 10 - Represents the programming error of EFUSE_POWERGLITCH_EN"]
    #[inline(always)]
    ...
    #[doc = "Bits 27:28 - Represents the programming error of EFUSE_ECDSA_CURVE_MODE"]
    #[inline(always)]
    pub fn ecdsa_curve_mode_err(&self) -> ECDSA_CURVE_MODE_ERR_R {
        ECDSA_CURVE_MODE_ERR_R::new(((self.bits >> 27) & 3) as u8)
    }
    #[doc = "Bit 29 - Represents the programming error of EFUSE_ECC_FORCE_CONST_TIME"]
    #[inline(always)]
    pub fn ecc_force_const_time_err(&self) -> ECC_FORCE_CONST_TIME_ERR_R {
        ECC_FORCE_CONST_TIME_ERR_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bits 30:31 - Represents the programming error of EFUSE_XTS_DPA_PSEUDO_LEVEL"]
    #[inline(always)]
    pub fn xts_dpa_pseudo_level_err(&self) -> XTS_DPA_PSEUDO_LEVEL_ERR_R {
        XTS_DPA_PSEUDO_LEVEL_ERR_R::new(((self.bits >> 30) & 3) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA_ERR0")
            ...
            .field("ecdsa_curve_mode_err", &self.ecdsa_curve_mode_err())
