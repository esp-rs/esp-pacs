...
#[doc = "Field `CUR_ECDSA_L_BLK` reader - Represents which block is used for ECDSA key low part output."]
pub type CUR_ECDSA_L_BLK_R = crate::FieldReader;
#[doc = "Field `CUR_ECDSA_H_BLK` reader - Represents which block is used for ECDSA key high part output."]
pub type CUR_ECDSA_H_BLK_R = crate::FieldReader;
impl R {
    ...
    #[doc = "Bits 20:23 - Represents which block is used for ECDSA key low part output."]
    #[inline(always)]
    pub fn cur_ecdsa_l_blk(&self) -> CUR_ECDSA_L_BLK_R {
        CUR_ECDSA_L_BLK_R::new(((self.bits >> 20) & 0x0f) as u8)
    }
    #[doc = "Bits 24:27 - Represents which block is used for ECDSA key high part output."]
    #[inline(always)]
    pub fn cur_ecdsa_h_blk(&self) -> CUR_ECDSA_H_BLK_R {
        CUR_ECDSA_H_BLK_R::new(((self.bits >> 24) & 0x0f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS")
            ...
            .field("cur_ecdsa_l_blk", &self.cur_ecdsa_l_blk())
            .field("cur_ecdsa_h_blk", &self.cur_ecdsa_h_blk())
            .finish()
    }
}
