...
#[doc = "Field `TSUP_A` reader - Configures the programming setup time. Measurement unit: One cycle of the eFuse core clock."]
pub type TSUP_A_R = crate::FieldReader;
#[doc = "Field `TSUP_A` writer - Configures the programming setup time. Measurement unit: One cycle of the eFuse core clock."]
pub type TSUP_A_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `PWR_ON_NUM` reader - Configures the power up time for VDDQ. Measurement unit: One cycle of the eFuse core clock."]
pub type PWR_ON_NUM_R = crate::FieldReader<u16>;
#[doc = "Field `PWR_ON_NUM` writer - Configures the power up time for VDDQ. Measurement unit: One cycle of the eFuse core clock."]
pub type PWR_ON_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `THP_A` reader - Configures the programming hold time. Measurement unit: One cycle of the eFuse core clock."]
pub type THP_A_R = crate::FieldReader;
#[doc = "Field `THP_A` writer - Configures the programming hold time. Measurement unit: One cycle of the eFuse core clock."]
pub type THP_A_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures the programming setup time. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
    pub fn tsup_a(&self) -> TSUP_A_R {
        TSUP_A_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:23 - Configures the power up time for VDDQ. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
    pub fn pwr_on_num(&self) -> PWR_ON_NUM_R {
        PWR_ON_NUM_R::new(((self.bits >> 8) & 0xffff) as u16)
    }
    #[doc = "Bits 24:31 - Configures the programming hold time. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
...
impl crate::Resettable for WR_TIM_CONF1_SPEC {
    const RESET_VALUE: u32 = 0x0126_6701;
}
