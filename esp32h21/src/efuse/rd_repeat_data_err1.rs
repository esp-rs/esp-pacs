...
#[doc = "Field `VDD_SPI_LDO_ADJUST_ERR` reader - Represents the programming error of EFUSE_VDD_SPI_LDO_ADJUST"]
pub type VDD_SPI_LDO_ADJUST_ERR_R = crate::FieldReader;
...
impl R {
    #[doc = "Bits 0:7 - Represents the programming error of EFUSE_IO_LDO_ADJUST"]
    #[inline(always)]
    pub fn io_ldo_adjust_err(&self) -> IO_LDO_ADJUST_ERR_R {
        IO_LDO_ADJUST_ERR_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Represents the programming error of EFUSE_VDD_SPI_LDO_ADJUST"]
    #[inline(always)]
    pub fn vdd_spi_ldo_adjust_err(&self) -> VDD_SPI_LDO_ADJUST_ERR_R {
        VDD_SPI_LDO_ADJUST_ERR_R::new(((self.bits >> 8) & 0xff) as u8)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA_ERR1")
            ...
            .field("vdd_spi_ldo_adjust_err", &self.vdd_spi_ldo_adjust_err())
