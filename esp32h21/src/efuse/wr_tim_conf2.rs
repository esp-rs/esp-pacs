...
#[doc = "Field `TPGM` reader - Configures the active programming time. Measurement unit: One cycle of the eFuse core clock."]
pub type TPGM_R = crate::FieldReader<u16>;
#[doc = "Field `TPGM` writer - Configures the active programming time. Measurement unit: One cycle of the eFuse core clock."]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Configures the active programming time. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
