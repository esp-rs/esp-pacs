...
#[doc = "Field `HYS_EN_PAD0_ERR` reader - Represents the programming error of EFUSE_HYS_EN_PAD0"]
...
impl R {
    ...
    #[doc = "Bits 26:31 - Represents the programming error of EFUSE_HYS_EN_PAD0"]
    #[inline(always)]
