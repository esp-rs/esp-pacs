...
#[doc = "Field `READ_CMD` reader - Configures whether to send read commands.\\\\ 1: Send\\\\ 0: No effect\\\\"]
pub type READ_CMD_R = crate::BitReader;
#[doc = "Field `READ_CMD` writer - Configures whether to send read commands.\\\\ 1: Send\\\\ 0: No effect\\\\"]
pub type READ_CMD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PGM_CMD` reader - Configures whether to send programing commands.\\\\ 1: Send\\\\ 0: No effect\\\\"]
pub type PGM_CMD_R = crate::BitReader;
#[doc = "Field `PGM_CMD` writer - Configures whether to send programing commands.\\\\ 1: Send\\\\ 0: No effect\\\\"]
pub type PGM_CMD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BLK_NUM` reader - Configures the serial number of the block to be programmed. Value 0-10 corresponds to block number 0-10, respectively."]
pub type BLK_NUM_R = crate::FieldReader;
#[doc = "Field `BLK_NUM` writer - Configures the serial number of the block to be programmed. Value 0-10 corresponds to block number 0-10, respectively."]
pub type BLK_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bit 0 - Configures whether to send read commands.\\\\ 1: Send\\\\ 0: No effect\\\\"]
    #[inline(always)]
    pub fn read_cmd(&self) -> READ_CMD_R {
        READ_CMD_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures whether to send programing commands.\\\\ 1: Send\\\\ 0: No effect\\\\"]
    #[inline(always)]
    pub fn pgm_cmd(&self) -> PGM_CMD_R {
        PGM_CMD_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:5 - Configures the serial number of the block to be programmed. Value 0-10 corresponds to block number 0-10, respectively."]
    #[inline(always)]
