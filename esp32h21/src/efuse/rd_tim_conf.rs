...
#[doc = "Field `THR_A` reader - Configures the read hold time. Measurement unit: One cycle of the eFuse core clock."]
pub type THR_A_R = crate::FieldReader;
#[doc = "Field `THR_A` writer - Configures the read hold time. Measurement unit: One cycle of the eFuse core clock."]
pub type THR_A_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `TRD` reader - Configures the read time. Measurement unit: One cycle of the eFuse core clock."]
pub type TRD_R = crate::FieldReader;
#[doc = "Field `TRD` writer - Configures the read time. Measurement unit: One cycle of the eFuse core clock."]
pub type TRD_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `TSUR_A` reader - Configures the read setup time. Measurement unit: One cycle of the eFuse core clock."]
pub type TSUR_A_R = crate::FieldReader;
#[doc = "Field `TSUR_A` writer - Configures the read setup time. Measurement unit: One cycle of the eFuse core clock."]
...
impl R {
    #[doc = "Bits 0:7 - Configures the read hold time. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
    pub fn thr_a(&self) -> THR_A_R {
        THR_A_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Configures the read time. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
    pub fn trd(&self) -> TRD_R {
        TRD_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Configures the read setup time. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
