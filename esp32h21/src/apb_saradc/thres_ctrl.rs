...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("THRES_CTRL")
            .field("apb_saradc_thres_all_en", &self.apb_saradc_thres_all_en())
            .field("apb_saradc_thres1_en", &self.apb_saradc_thres1_en())
            .field("apb_saradc_thres0_en", &self.apb_saradc_thres0_en())
            .finish()
    }
}
impl W {
    #[doc = "Bit 27 - enable thres to all channel"]
    #[inline(always)]
    pub fn apb_saradc_thres_all_en(&mut self) -> APB_SARADC_THRES_ALL_EN_W<'_, THRES_CTRL_SPEC> {
        APB_SARADC_THRES_ALL_EN_W::new(self, 27)
    }
    #[doc = "Bit 30 - enable thres1"]
    #[inline(always)]
    pub fn apb_saradc_thres1_en(&mut self) -> APB_SARADC_THRES1_EN_W<'_, THRES_CTRL_SPEC> {
        APB_SARADC_THRES1_EN_W::new(self, 30)
    }
    #[doc = "Bit 31 - enable thres0"]
    #[inline(always)]
    pub fn apb_saradc_thres0_en(&mut self) -> APB_SARADC_THRES0_EN_W<'_, THRES_CTRL_SPEC> {
