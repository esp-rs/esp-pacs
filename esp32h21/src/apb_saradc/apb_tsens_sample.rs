...
pub type TSENS_SAMPLE_RATE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
pub type TSENS_SAMPLE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB_TSENS_SAMPLE")
            .field("tsens_sample_rate", &self.tsens_sample_rate())
            .field("tsens_sample_en", &self.tsens_sample_en())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:15 - HW sample rate"]
    #[inline(always)]
    pub fn tsens_sample_rate(&mut self) -> TSENS_SAMPLE_RATE_W<'_, APB_TSENS_SAMPLE_SPEC> {
        TSENS_SAMPLE_RATE_W::new(self, 0)
    }
    #[doc = "Bit 16 - HW sample en"]
    #[inline(always)]
    pub fn tsens_sample_en(&mut self) -> TSENS_SAMPLE_EN_W<'_, APB_TSENS_SAMPLE_SPEC> {
        TSENS_SAMPLE_EN_W::new(self, 16)
    }
}
#[doc = "digital tsens configure register\n\nYou can [`read`](crate::Reg::read) this register and get [`apb_tsens_sample::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`apb_tsens_sample::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
