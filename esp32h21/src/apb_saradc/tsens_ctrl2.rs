...
impl W {
    #[doc = "Bits 0:11 - the time that power up tsens need wait"]
    #[inline(always)]
    pub fn tsens_xpd_wait(&mut self) -> TSENS_XPD_WAIT_W<'_, TSENS_CTRL2_SPEC> {
        TSENS_XPD_WAIT_W::new(self, 0)
    }
    #[doc = "Bits 12:13 - force power up tsens"]
    #[inline(always)]
    pub fn tsens_xpd_force(&mut self) -> TSENS_XPD_FORCE_W<'_, TSENS_CTRL2_SPEC> {
        TSENS_XPD_FORCE_W::new(self, 12)
    }
    #[doc = "Bit 14 - inv tsens clk"]
    #[inline(always)]
    pub fn tsens_clk_inv(&mut self) -> TSENS_CLK_INV_W<'_, TSENS_CTRL2_SPEC> {
        TSENS_CLK_INV_W::new(self, 14)
    }
    #[doc = "Bit 15 - tsens clk select"]
    #[inline(always)]
    pub fn tsens_clk_sel(&mut self) -> TSENS_CLK_SEL_W<'_, TSENS_CTRL2_SPEC> {
