...
#[doc = "Field `GATE_FORCE_ON` reader - Configures whether to force on ECDSA memory clock gate. \\\\ 0: No effect\\\\ 1: Force on\\\\"]
pub type GATE_FORCE_ON_R = crate::BitReader;
#[doc = "Field `GATE_FORCE_ON` writer - Configures whether to force on ECDSA memory clock gate. \\\\ 0: No effect\\\\ 1: Force on\\\\"]
pub type GATE_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether to force on ECDSA memory clock gate. \\\\ 0: No effect\\\\ 1: Force on\\\\"]
    #[inline(always)]
