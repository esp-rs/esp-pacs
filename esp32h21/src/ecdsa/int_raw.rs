...
#[doc = "Field `PREP_DONE_INT_RAW` reader - The raw interrupt status of the ECDSA_PREP_DONE_INT interrupt."]
pub type PREP_DONE_INT_RAW_R = crate::BitReader;
#[doc = "Field `PROC_DONE_INT_RAW` reader - The raw interrupt status of the ECDSA_PROC_DONE_INT interrupt."]
pub type PROC_DONE_INT_RAW_R = crate::BitReader;
#[doc = "Field `POST_DONE_INT_RAW` reader - The raw interrupt status of the ECDSA_POST_DONE_INT interrupt."]
pub type POST_DONE_INT_RAW_R = crate::BitReader;
#[doc = "Field `SHA_RELEASE_INT_RAW` reader - The raw interrupt status of the ECDSA_SHA_RELEASE_INT interrupt."]
pub type SHA_RELEASE_INT_RAW_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - The raw interrupt status of the ECDSA_PREP_DONE_INT interrupt."]
    #[inline(always)]
    pub fn prep_done_int_raw(&self) -> PREP_DONE_INT_RAW_R {
        PREP_DONE_INT_RAW_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The raw interrupt status of the ECDSA_PROC_DONE_INT interrupt."]
    #[inline(always)]
    pub fn proc_done_int_raw(&self) -> PROC_DONE_INT_RAW_R {
        PROC_DONE_INT_RAW_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The raw interrupt status of the ECDSA_POST_DONE_INT interrupt."]
    #[inline(always)]
    pub fn post_done_int_raw(&self) -> POST_DONE_INT_RAW_R {
        POST_DONE_INT_RAW_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - The raw interrupt status of the ECDSA_SHA_RELEASE_INT interrupt."]
    #[inline(always)]
