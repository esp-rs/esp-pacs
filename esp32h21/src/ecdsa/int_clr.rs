...
#[doc = "Field `PREP_DONE` writer - Write 1 to clear the ECDSA_PREP_DONE_INT interrupt."]
pub type PREP_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `PROC_DONE` writer - Write 1 to clear the ECDSA_PROC_DONE_INT interrupt."]
pub type PROC_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `POST_DONE` writer - Write 1 to clear the ECDSA_POST_DONE_INT interrupt."]
pub type POST_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SHA_RELEASE` writer - Write 1 to clear the ECDSA_SHA_RELEASE_INT interrupt."]
