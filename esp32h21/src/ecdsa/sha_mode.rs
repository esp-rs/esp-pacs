...
#[doc = "Field `SHA_MODE` reader - Configures SHA algorithms for message hash. \\\\ 1: SHA-224\\\\ 2: SHA-256\\\\ Others: invalid\\\\"]
pub type SHA_MODE_R = crate::FieldReader;
#[doc = "Field `SHA_MODE` writer - Configures SHA algorithms for message hash. \\\\ 1: SHA-224\\\\ 2: SHA-256\\\\ Others: invalid\\\\"]
pub type SHA_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:2 - Configures SHA algorithms for message hash. \\\\ 1: SHA-224\\\\ 2: SHA-256\\\\ Others: invalid\\\\"]
    #[inline(always)]
