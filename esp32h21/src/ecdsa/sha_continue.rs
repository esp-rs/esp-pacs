...
#[doc = "Field `SHA_CONTINUE` writer - Write 1 to start the latter SHA operation in the ECDSA process. This bit will be self-cleared after configuration."]
...
impl W {
    #[doc = "Bit 0 - Write 1 to start the latter SHA operation in the ECDSA process. This bit will be self-cleared after configuration."]
    #[inline(always)]
    pub fn sha_continue(&mut self) -> SHA_CONTINUE_W<'_, SHA_CONTINUE_SPEC> {
