...
#[doc = "Field `PREP_DONE` reader - Write 1 to enable the ECDSA_PREP_DONE_INT interrupt."]
pub type PREP_DONE_R = crate::BitReader;
#[doc = "Field `PREP_DONE` writer - Write 1 to enable the ECDSA_PREP_DONE_INT interrupt."]
pub type PREP_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PROC_DONE` reader - Write 1 to enable the ECDSA_PROC_DONE_INT interrupt."]
pub type PROC_DONE_R = crate::BitReader;
#[doc = "Field `PROC_DONE` writer - Write 1 to enable the ECDSA_PROC_DONE_INT interrupt."]
pub type PROC_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `POST_DONE` reader - Write 1 to enable the ECDSA_POST_DONE_INT interrupt."]
pub type POST_DONE_R = crate::BitReader;
#[doc = "Field `POST_DONE` writer - Write 1 to enable the ECDSA_POST_DONE_INT interrupt."]
pub type POST_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SHA_RELEASE` reader - Write 1 to enable the ECDSA_SHA_RELEASE_INT interrupt."]
pub type SHA_RELEASE_R = crate::BitReader;
#[doc = "Field `SHA_RELEASE` writer - Write 1 to enable the ECDSA_SHA_RELEASE_INT interrupt."]
