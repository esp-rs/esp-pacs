#[doc = "Register `USB_SERIAL_JTAG_INT_RAW` reader"]
pub type R = crate::R<USB_SERIAL_JTAG_INT_RAW_SPEC>;
#[doc = "Register `USB_SERIAL_JTAG_INT_RAW` writer"]
pub type W = crate::W<USB_SERIAL_JTAG_INT_RAW_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB_SERIAL_JTAG_INT_RAW")
            .field(
                "usb_serial_jtag_jtag_in_flush_int_raw",
                &self.usb_serial_jtag_jtag_in_flush_int_raw(),
            )
            .field(
                "usb_serial_jtag_sof_int_raw",
                &self.usb_serial_jtag_sof_int_raw(),
            )
            .field(
                "usb_serial_jtag_serial_out_recv_pkt_int_raw",
                &self.usb_serial_jtag_serial_out_recv_pkt_int_raw(),
            )
            .field(
                "usb_serial_jtag_serial_in_empty_int_raw",
                &self.usb_serial_jtag_serial_in_empty_int_raw(),
            )
            .field(
                "usb_serial_jtag_pid_err_int_raw",
                &self.usb_serial_jtag_pid_err_int_raw(),
            )
            .field(
                "usb_serial_jtag_crc5_err_int_raw",
                &self.usb_serial_jtag_crc5_err_int_raw(),
            )
            .field(
                "usb_serial_jtag_crc16_err_int_raw",
                &self.usb_serial_jtag_crc16_err_int_raw(),
            )
            .field(
                "usb_serial_jtag_stuff_err_int_raw",
                &self.usb_serial_jtag_stuff_err_int_raw(),
            )
            .field(
                "usb_serial_jtag_in_token_rec_in_ep1_int_raw",
                &self.usb_serial_jtag_in_token_rec_in_ep1_int_raw(),
            )
            .field(
                "usb_serial_jtag_usb_bus_reset_int_raw",
                &self.usb_serial_jtag_usb_bus_reset_int_raw(),
            )
            .field(
                "usb_serial_jtag_out_ep1_zero_payload_int_raw",
                &self.usb_serial_jtag_out_ep1_zero_payload_int_raw(),
            )
            .field(
                "usb_serial_jtag_out_ep2_zero_payload_int_raw",
                &self.usb_serial_jtag_out_ep2_zero_payload_int_raw(),
            )
            .field(
                "usb_serial_jtag_rts_chg_int_raw",
                &self.usb_serial_jtag_rts_chg_int_raw(),
            )
            .field(
                "usb_serial_jtag_dtr_chg_int_raw",
                &self.usb_serial_jtag_dtr_chg_int_raw(),
            )
            .field(
                "usb_serial_jtag_get_line_code_int_raw",
                &self.usb_serial_jtag_get_line_code_int_raw(),
            )
            .field(
                "usb_serial_jtag_set_line_code_int_raw",
                &self.usb_serial_jtag_set_line_code_int_raw(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn usb_serial_jtag_jtag_in_flush_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
        USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT_RAW_W::new(self, 0)
    }
    #[doc = "Bit 1 - The raw interrupt bit turns to high level when SOF frame is received."]
    #[inline(always)]
    pub fn usb_serial_jtag_sof_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_SOF_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_serial_out_recv_pkt_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_serial_in_empty_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_pid_err_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_PID_ERR_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_crc5_err_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_CRC5_ERR_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_crc16_err_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_CRC16_ERR_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_stuff_err_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_STUFF_ERR_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_in_token_rec_in_ep1_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_usb_bus_reset_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_USB_BUS_RESET_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_out_ep1_zero_payload_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_OUT_EP1_ZERO_PAYLOAD_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_out_ep2_zero_payload_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_OUT_EP2_ZERO_PAYLOAD_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_rts_chg_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_RTS_CHG_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_dtr_chg_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_DTR_CHG_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_get_line_code_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_GET_LINE_CODE_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
    ...
    pub fn usb_serial_jtag_set_line_code_int_raw(
        &mut self,
    ) -> USB_SERIAL_JTAG_SET_LINE_CODE_INT_RAW_W<'_, USB_SERIAL_JTAG_INT_RAW_SPEC> {
        USB_SERIAL_JTAG_SET_LINE_CODE_INT_RAW_W::new(self, 15)
    }
}
#[doc = "Interrupt raw status register.\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_serial_jtag_int_raw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb_serial_jtag_int_raw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USB_SERIAL_JTAG_INT_RAW_SPEC;
impl crate::RegisterSpec for USB_SERIAL_JTAG_INT_RAW_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_serial_jtag_int_raw::R`](R) reader structure"]
impl crate::Readable for USB_SERIAL_JTAG_INT_RAW_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usb_serial_jtag_int_raw::W`](W) writer structure"]
impl crate::Writable for USB_SERIAL_JTAG_INT_RAW_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets USB_SERIAL_JTAG_INT_RAW to value 0x08"]
impl crate::Resettable for USB_SERIAL_JTAG_INT_RAW_SPEC {
