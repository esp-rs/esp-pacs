#[doc = "Register `USB_SERIAL_JTAG_TEST` reader"]
pub type R = crate::R<USB_SERIAL_JTAG_TEST_SPEC>;
#[doc = "Register `USB_SERIAL_JTAG_TEST` writer"]
pub type W = crate::W<USB_SERIAL_JTAG_TEST_SPEC>;
...
#[doc = "Field `RX_RCV` reader - USB RCV value in test"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB_SERIAL_JTAG_TEST")
...
impl W {
    #[doc = "Bit 0 - Enable test of the USB pad"]
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<'_, USB_SERIAL_JTAG_TEST_SPEC> {
        ENABLE_W::new(self, 0)
    }
    #[doc = "Bit 1 - USB pad oen in test"]
    #[inline(always)]
    pub fn usb_oe(&mut self) -> USB_OE_W<'_, USB_SERIAL_JTAG_TEST_SPEC> {
        USB_OE_W::new(self, 1)
    }
    #[doc = "Bit 2 - USB D+ tx value in test"]
    #[inline(always)]
    pub fn tx_dp(&mut self) -> TX_DP_W<'_, USB_SERIAL_JTAG_TEST_SPEC> {
        TX_DP_W::new(self, 2)
    }
    #[doc = "Bit 3 - USB D- tx value in test"]
    #[inline(always)]
    pub fn tx_dm(&mut self) -> TX_DM_W<'_, USB_SERIAL_JTAG_TEST_SPEC> {
        TX_DM_W::new(self, 3)
    }
}
#[doc = "Registers used for debugging the PHY.\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_serial_jtag_test::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb_serial_jtag_test::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USB_SERIAL_JTAG_TEST_SPEC;
impl crate::RegisterSpec for USB_SERIAL_JTAG_TEST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_serial_jtag_test::R`](R) reader structure"]
impl crate::Readable for USB_SERIAL_JTAG_TEST_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usb_serial_jtag_test::W`](W) writer structure"]
impl crate::Writable for USB_SERIAL_JTAG_TEST_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets USB_SERIAL_JTAG_TEST to value 0x30"]
impl crate::Resettable for USB_SERIAL_JTAG_TEST_SPEC {
