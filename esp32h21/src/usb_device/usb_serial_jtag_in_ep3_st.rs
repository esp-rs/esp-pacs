#[doc = "Register `USB_SERIAL_JTAG_IN_EP3_ST` reader"]
pub type R = crate::R<USB_SERIAL_JTAG_IN_EP3_ST_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB_SERIAL_JTAG_IN_EP3_ST")
            .field(
                "usb_serial_jtag_in_ep3_state",
                &self.usb_serial_jtag_in_ep3_state(),
            )
            .field(
                "usb_serial_jtag_in_ep3_wr_addr",
                &self.usb_serial_jtag_in_ep3_wr_addr(),
            )
            .field(
                "usb_serial_jtag_in_ep3_rd_addr",
                &self.usb_serial_jtag_in_ep3_rd_addr(),
            )
            .finish()
    }
}
#[doc = "JTAG IN endpoint status information.\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_serial_jtag_in_ep3_st::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USB_SERIAL_JTAG_IN_EP3_ST_SPEC;
impl crate::RegisterSpec for USB_SERIAL_JTAG_IN_EP3_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_serial_jtag_in_ep3_st::R`](R) reader structure"]
impl crate::Readable for USB_SERIAL_JTAG_IN_EP3_ST_SPEC {}
#[doc = "`reset()` method sets USB_SERIAL_JTAG_IN_EP3_ST to value 0x01"]
impl crate::Resettable for USB_SERIAL_JTAG_IN_EP3_ST_SPEC {
