...
impl W {
    #[doc = "Bit 0 - Select internal/external PHY"]
    #[inline(always)]
    pub fn usb_serial_jtag_phy_sel(&mut self) -> USB_SERIAL_JTAG_PHY_SEL_W<'_, CONF0_SPEC> {
    ...
    pub fn usb_serial_jtag_exchg_pins_override(
        &mut self,
    ) -> USB_SERIAL_JTAG_EXCHG_PINS_OVERRIDE_W<'_, CONF0_SPEC> {
        USB_SERIAL_JTAG_EXCHG_PINS_OVERRIDE_W::new(self, 1)
    }
    #[doc = "Bit 2 - USB D+ D- exchange"]
    #[inline(always)]
    pub fn usb_serial_jtag_exchg_pins(&mut self) -> USB_SERIAL_JTAG_EXCHG_PINS_W<'_, CONF0_SPEC> {
        USB_SERIAL_JTAG_EXCHG_PINS_W::new(self, 2)
    }
    #[doc = "Bits 3:4 - Control single-end input high threshold,1.76V to 2V, step 80mV"]
    #[inline(always)]
    pub fn usb_serial_jtag_vrefh(&mut self) -> USB_SERIAL_JTAG_VREFH_W<'_, CONF0_SPEC> {
        USB_SERIAL_JTAG_VREFH_W::new(self, 3)
    }
    #[doc = "Bits 5:6 - Control single-end input low threshold,0.8V to 1.04V, step 80mV"]
    #[inline(always)]
    pub fn usb_serial_jtag_vrefl(&mut self) -> USB_SERIAL_JTAG_VREFL_W<'_, CONF0_SPEC> {
    ...
    pub fn usb_serial_jtag_vref_override(
        &mut self,
    ) -> USB_SERIAL_JTAG_VREF_OVERRIDE_W<'_, CONF0_SPEC> {
    ...
    pub fn usb_serial_jtag_pad_pull_override(
        &mut self,
    ) -> USB_SERIAL_JTAG_PAD_PULL_OVERRIDE_W<'_, CONF0_SPEC> {
        USB_SERIAL_JTAG_PAD_PULL_OVERRIDE_W::new(self, 8)
    }
    #[doc = "Bit 9 - Control USB D+ pull up."]
    #[inline(always)]
    pub fn usb_serial_jtag_dp_pullup(&mut self) -> USB_SERIAL_JTAG_DP_PULLUP_W<'_, CONF0_SPEC> {
        USB_SERIAL_JTAG_DP_PULLUP_W::new(self, 9)
    }
    #[doc = "Bit 10 - Control USB D+ pull down."]
    #[inline(always)]
    pub fn usb_serial_jtag_dp_pulldown(&mut self) -> USB_SERIAL_JTAG_DP_PULLDOWN_W<'_, CONF0_SPEC> {
        USB_SERIAL_JTAG_DP_PULLDOWN_W::new(self, 10)
    }
    #[doc = "Bit 11 - Control USB D- pull up."]
    #[inline(always)]
    pub fn usb_serial_jtag_dm_pullup(&mut self) -> USB_SERIAL_JTAG_DM_PULLUP_W<'_, CONF0_SPEC> {
        USB_SERIAL_JTAG_DM_PULLUP_W::new(self, 11)
    }
    #[doc = "Bit 12 - Control USB D- pull down."]
    #[inline(always)]
    pub fn usb_serial_jtag_dm_pulldown(&mut self) -> USB_SERIAL_JTAG_DM_PULLDOWN_W<'_, CONF0_SPEC> {
    ...
    pub fn usb_serial_jtag_pullup_value(
        &mut self,
    ) -> USB_SERIAL_JTAG_PULLUP_VALUE_W<'_, CONF0_SPEC> {
    ...
    pub fn usb_serial_jtag_usb_pad_enable(
        &mut self,
    ) -> USB_SERIAL_JTAG_USB_PAD_ENABLE_W<'_, CONF0_SPEC> {
    ...
    pub fn usb_serial_jtag_usb_jtag_bridge_en(
        &mut self,
    ) -> USB_SERIAL_JTAG_USB_JTAG_BRIDGE_EN_W<'_, CONF0_SPEC> {
    ...
    pub fn usb_serial_jtag_usb_phy_tx_edge_sel(
        &mut self,
    ) -> USB_SERIAL_JTAG_USB_PHY_TX_EDGE_SEL_W<'_, CONF0_SPEC> {
