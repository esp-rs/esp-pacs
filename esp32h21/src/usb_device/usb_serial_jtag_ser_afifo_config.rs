#[doc = "Register `USB_SERIAL_JTAG_SER_AFIFO_CONFIG` reader"]
pub type R = crate::R<USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC>;
#[doc = "Register `USB_SERIAL_JTAG_SER_AFIFO_CONFIG` writer"]
pub type W = crate::W<USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB_SERIAL_JTAG_SER_AFIFO_CONFIG")
            .field(
...
impl W {
    ...
    pub fn usb_serial_jtag_serial_in_afifo_reset_wr(
        &mut self,
    ) -> USB_SERIAL_JTAG_SERIAL_IN_AFIFO_RESET_WR_W<'_, USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC> {
    ...
    pub fn usb_serial_jtag_serial_in_afifo_reset_rd(
        &mut self,
    ) -> USB_SERIAL_JTAG_SERIAL_IN_AFIFO_RESET_RD_W<'_, USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC> {
    ...
    pub fn usb_serial_jtag_serial_out_afifo_reset_wr(
        &mut self,
    ) -> USB_SERIAL_JTAG_SERIAL_OUT_AFIFO_RESET_WR_W<'_, USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC>
    {
    ...
    pub fn usb_serial_jtag_serial_out_afifo_reset_rd(
        &mut self,
    ) -> USB_SERIAL_JTAG_SERIAL_OUT_AFIFO_RESET_RD_W<'_, USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC>
    {
        USB_SERIAL_JTAG_SERIAL_OUT_AFIFO_RESET_RD_W::new(self, 3)
    }
}
#[doc = "Serial AFIFO configure register\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_serial_jtag_ser_afifo_config::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb_serial_jtag_ser_afifo_config::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC;
impl crate::RegisterSpec for USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_serial_jtag_ser_afifo_config::R`](R) reader structure"]
impl crate::Readable for USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usb_serial_jtag_ser_afifo_config::W`](W) writer structure"]
impl crate::Writable for USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets USB_SERIAL_JTAG_SER_AFIFO_CONFIG to value 0x10"]
impl crate::Resettable for USB_SERIAL_JTAG_SER_AFIFO_CONFIG_SPEC {
