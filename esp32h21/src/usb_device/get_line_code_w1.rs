...
impl W {
    ...
    pub fn usb_serial_jtag_get_bdata_bits(
        &mut self,
    ) -> USB_SERIAL_JTAG_GET_BDATA_BITS_W<'_, GET_LINE_CODE_W1_SPEC> {
    ...
    pub fn usb_serial_jtag_get_bparity_type(
        &mut self,
    ) -> USB_SERIAL_JTAG_GET_BPARITY_TYPE_W<'_, GET_LINE_CODE_W1_SPEC> {
    ...
    pub fn usb_serial_jtag_get_bchar_format(
        &mut self,
    ) -> USB_SERIAL_JTAG_GET_BCHAR_FORMAT_W<'_, GET_LINE_CODE_W1_SPEC> {
