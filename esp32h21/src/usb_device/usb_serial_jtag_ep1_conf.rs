#[doc = "Register `USB_SERIAL_JTAG_EP1_CONF` reader"]
pub type R = crate::R<USB_SERIAL_JTAG_EP1_CONF_SPEC>;
#[doc = "Register `USB_SERIAL_JTAG_EP1_CONF` writer"]
pub type W = crate::W<USB_SERIAL_JTAG_EP1_CONF_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB_SERIAL_JTAG_EP1_CONF")
            .field(
...
impl W {
    ...
    #[inline(always)]
    pub fn usb_serial_jtag_wr_done(
        &mut self,
    ) -> USB_SERIAL_JTAG_WR_DONE_W<'_, USB_SERIAL_JTAG_EP1_CONF_SPEC> {
        USB_SERIAL_JTAG_WR_DONE_W::new(self, 0)
    }
}
#[doc = "Configuration and control registers for the CDC-ACM FIFOs.\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_serial_jtag_ep1_conf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb_serial_jtag_ep1_conf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USB_SERIAL_JTAG_EP1_CONF_SPEC;
impl crate::RegisterSpec for USB_SERIAL_JTAG_EP1_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_serial_jtag_ep1_conf::R`](R) reader structure"]
impl crate::Readable for USB_SERIAL_JTAG_EP1_CONF_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usb_serial_jtag_ep1_conf::W`](W) writer structure"]
impl crate::Writable for USB_SERIAL_JTAG_EP1_CONF_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets USB_SERIAL_JTAG_EP1_CONF to value 0x02"]
impl crate::Resettable for USB_SERIAL_JTAG_EP1_CONF_SPEC {
