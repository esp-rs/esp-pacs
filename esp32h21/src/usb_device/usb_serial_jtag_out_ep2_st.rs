#[doc = "Register `USB_SERIAL_JTAG_OUT_EP2_ST` reader"]
pub type R = crate::R<USB_SERIAL_JTAG_OUT_EP2_ST_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB_SERIAL_JTAG_OUT_EP2_ST")
            .field(
...
#[doc = "JTAG OUT endpoint status information.\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_serial_jtag_out_ep2_st::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USB_SERIAL_JTAG_OUT_EP2_ST_SPEC;
impl crate::RegisterSpec for USB_SERIAL_JTAG_OUT_EP2_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_serial_jtag_out_ep2_st::R`](R) reader structure"]
impl crate::Readable for USB_SERIAL_JTAG_OUT_EP2_ST_SPEC {}
#[doc = "`reset()` method sets USB_SERIAL_JTAG_OUT_EP2_ST to value 0"]
impl crate::Resettable for USB_SERIAL_JTAG_OUT_EP2_ST_SPEC {}
