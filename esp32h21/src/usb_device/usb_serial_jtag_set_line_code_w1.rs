#[doc = "Register `USB_SERIAL_JTAG_SET_LINE_CODE_W1` reader"]
pub type R = crate::R<USB_SERIAL_JTAG_SET_LINE_CODE_W1_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB_SERIAL_JTAG_SET_LINE_CODE_W1")
            .field(
                "usb_serial_jtag_bchar_format",
                &self.usb_serial_jtag_bchar_format(),
            )
            .field(
                "usb_serial_jtag_bparity_type",
                &self.usb_serial_jtag_bparity_type(),
            )
            .field(
                "usb_serial_jtag_bdata_bits",
                &self.usb_serial_jtag_bdata_bits(),
            )
            .finish()
    }
}
#[doc = "W1 of SET_LINE_CODING command.\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_serial_jtag_set_line_code_w1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USB_SERIAL_JTAG_SET_LINE_CODE_W1_SPEC;
impl crate::RegisterSpec for USB_SERIAL_JTAG_SET_LINE_CODE_W1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_serial_jtag_set_line_code_w1::R`](R) reader structure"]
impl crate::Readable for USB_SERIAL_JTAG_SET_LINE_CODE_W1_SPEC {}
#[doc = "`reset()` method sets USB_SERIAL_JTAG_SET_LINE_CODE_W1 to value 0"]
impl crate::Resettable for USB_SERIAL_JTAG_SET_LINE_CODE_W1_SPEC {}
