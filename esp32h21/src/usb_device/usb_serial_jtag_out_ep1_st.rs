#[doc = "Register `USB_SERIAL_JTAG_OUT_EP1_ST` reader"]
pub type R = crate::R<USB_SERIAL_JTAG_OUT_EP1_ST_SPEC>;
...
#[doc = "Field `USB_SERIAL_JTAG_OUT_EP1_WR_ADDR` reader - Write data address of OUT endpoint 1. When USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT is detected, there are USB_SERIAL_JTAG_OUT_EP1_WR_ADDR-2 bytes data in OUT EP1."]
...
impl R {
    ...
    #[doc = "Bits 2:8 - Write data address of OUT endpoint 1. When USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT is detected, there are USB_SERIAL_JTAG_OUT_EP1_WR_ADDR-2 bytes data in OUT EP1."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB_SERIAL_JTAG_OUT_EP1_ST")
            .field(
                "usb_serial_jtag_out_ep1_state",
                &self.usb_serial_jtag_out_ep1_state(),
            )
            .field(
                "usb_serial_jtag_out_ep1_wr_addr",
                &self.usb_serial_jtag_out_ep1_wr_addr(),
            )
            .field(
                "usb_serial_jtag_out_ep1_rd_addr",
                &self.usb_serial_jtag_out_ep1_rd_addr(),
            )
            .field(
                "usb_serial_jtag_out_ep1_rec_data_cnt",
                &self.usb_serial_jtag_out_ep1_rec_data_cnt(),
            )
            .finish()
    }
}
#[doc = "CDC-ACM OUT endpoint status information.\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_serial_jtag_out_ep1_st::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USB_SERIAL_JTAG_OUT_EP1_ST_SPEC;
impl crate::RegisterSpec for USB_SERIAL_JTAG_OUT_EP1_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_serial_jtag_out_ep1_st::R`](R) reader structure"]
impl crate::Readable for USB_SERIAL_JTAG_OUT_EP1_ST_SPEC {}
#[doc = "`reset()` method sets USB_SERIAL_JTAG_OUT_EP1_ST to value 0"]
impl crate::Resettable for USB_SERIAL_JTAG_OUT_EP1_ST_SPEC {}
