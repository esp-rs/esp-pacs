#[doc = "Register `USB_SERIAL_JTAG_INT_ST` reader"]
pub type R = crate::R<USB_SERIAL_JTAG_INT_ST_SPEC>;
#[doc = "Field `USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT interrupt."]
pub type USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_SOF_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_SOF_INT interrupt."]
pub type USB_SERIAL_JTAG_SOF_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT interrupt."]
pub type USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT interrupt."]
pub type USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_PID_ERR_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_PID_ERR_INT interrupt."]
pub type USB_SERIAL_JTAG_PID_ERR_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_CRC5_ERR_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_CRC5_ERR_INT interrupt."]
pub type USB_SERIAL_JTAG_CRC5_ERR_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_CRC16_ERR_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_CRC16_ERR_INT interrupt."]
pub type USB_SERIAL_JTAG_CRC16_ERR_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_STUFF_ERR_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_STUFF_ERR_INT interrupt."]
pub type USB_SERIAL_JTAG_STUFF_ERR_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT interrupt."]
pub type USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_USB_BUS_RESET_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_USB_BUS_RESET_INT interrupt."]
pub type USB_SERIAL_JTAG_USB_BUS_RESET_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_OUT_EP1_ZERO_PAYLOAD_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_OUT_EP1_ZERO_PAYLOAD_INT interrupt."]
pub type USB_SERIAL_JTAG_OUT_EP1_ZERO_PAYLOAD_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_OUT_EP2_ZERO_PAYLOAD_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_OUT_EP2_ZERO_PAYLOAD_INT interrupt."]
pub type USB_SERIAL_JTAG_OUT_EP2_ZERO_PAYLOAD_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_RTS_CHG_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_RTS_CHG_INT interrupt."]
pub type USB_SERIAL_JTAG_RTS_CHG_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_DTR_CHG_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_DTR_CHG_INT interrupt."]
pub type USB_SERIAL_JTAG_DTR_CHG_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_GET_LINE_CODE_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_GET_LINE_CODE_INT interrupt."]
pub type USB_SERIAL_JTAG_GET_LINE_CODE_INT_ST_R = crate::BitReader;
#[doc = "Field `USB_SERIAL_JTAG_SET_LINE_CODE_INT_ST` reader - The raw interrupt status bit for the USB_SERIAL_JTAG_SET_LINE_CODE_INT interrupt."]
pub type USB_SERIAL_JTAG_SET_LINE_CODE_INT_ST_R = crate::BitReader;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("USB_SERIAL_JTAG_INT_ST")
            .field(
                "usb_serial_jtag_jtag_in_flush_int_st",
                &self.usb_serial_jtag_jtag_in_flush_int_st(),
            )
            .field(
                "usb_serial_jtag_sof_int_st",
                &self.usb_serial_jtag_sof_int_st(),
            )
            .field(
                "usb_serial_jtag_serial_out_recv_pkt_int_st",
                &self.usb_serial_jtag_serial_out_recv_pkt_int_st(),
            )
            .field(
                "usb_serial_jtag_serial_in_empty_int_st",
                &self.usb_serial_jtag_serial_in_empty_int_st(),
            )
            .field(
                "usb_serial_jtag_pid_err_int_st",
                &self.usb_serial_jtag_pid_err_int_st(),
            )
            .field(
                "usb_serial_jtag_crc5_err_int_st",
                &self.usb_serial_jtag_crc5_err_int_st(),
            )
            .field(
                "usb_serial_jtag_crc16_err_int_st",
                &self.usb_serial_jtag_crc16_err_int_st(),
            )
            .field(
                "usb_serial_jtag_stuff_err_int_st",
                &self.usb_serial_jtag_stuff_err_int_st(),
            )
            .field(
                "usb_serial_jtag_in_token_rec_in_ep1_int_st",
                &self.usb_serial_jtag_in_token_rec_in_ep1_int_st(),
            )
            .field(
                "usb_serial_jtag_usb_bus_reset_int_st",
                &self.usb_serial_jtag_usb_bus_reset_int_st(),
            )
            .field(
                "usb_serial_jtag_out_ep1_zero_payload_int_st",
                &self.usb_serial_jtag_out_ep1_zero_payload_int_st(),
            )
            .field(
                "usb_serial_jtag_out_ep2_zero_payload_int_st",
                &self.usb_serial_jtag_out_ep2_zero_payload_int_st(),
            )
            .field(
                "usb_serial_jtag_rts_chg_int_st",
                &self.usb_serial_jtag_rts_chg_int_st(),
            )
            .field(
                "usb_serial_jtag_dtr_chg_int_st",
                &self.usb_serial_jtag_dtr_chg_int_st(),
            )
            .field(
                "usb_serial_jtag_get_line_code_int_st",
                &self.usb_serial_jtag_get_line_code_int_st(),
            )
            .field(
                "usb_serial_jtag_set_line_code_int_st",
                &self.usb_serial_jtag_set_line_code_int_st(),
            )
            .finish()
    }
}
#[doc = "Interrupt status register.\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_serial_jtag_int_st::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USB_SERIAL_JTAG_INT_ST_SPEC;
impl crate::RegisterSpec for USB_SERIAL_JTAG_INT_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_serial_jtag_int_st::R`](R) reader structure"]
impl crate::Readable for USB_SERIAL_JTAG_INT_ST_SPEC {}
#[doc = "`reset()` method sets USB_SERIAL_JTAG_INT_ST to value 0"]
impl crate::Resettable for USB_SERIAL_JTAG_INT_ST_SPEC {}
