...
pub struct RegisterBlock {
    core_0_intr_map: [CORE_0_INTR_MAP; 65],
    core_0_intr_status: [CORE_0_INTR_STATUS; 3],
    clock_gate: CLOCK_GATE,
    _reserved3: [u8; 0x06e8],
...
impl RegisterBlock {
    ...
    #[doc = "0x104..0x110 - register description"]
    #[inline(always)]
...
#[doc = "register description"]
pub mod clock_gate;
pub use crate::dma::{date as interrupt_reg_date, DATE as INTERRUPT_REG_DATE};
