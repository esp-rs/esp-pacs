...
#[doc = "Field `RXFIFO_WM_INT_RAW` reader - The raw interrupt status of I2C_RXFIFO_WM_INT."]
pub type RXFIFO_WM_INT_RAW_R = crate::BitReader;
#[doc = "Field `TXFIFO_WM_INT_RAW` reader - The raw interrupt status of I2C_TXFIFO_WM_INT."]
pub type TXFIFO_WM_INT_RAW_R = crate::BitReader;
#[doc = "Field `RXFIFO_OVF_INT_RAW` reader - The raw interrupt status of I2C_RXFIFO_OVF_INT."]
pub type RXFIFO_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `END_DETECT_INT_RAW` reader - The raw interrupt status of I2C_END_DETECT_INT."]
pub type END_DETECT_INT_RAW_R = crate::BitReader;
#[doc = "Field `BYTE_TRANS_DONE_INT_RAW` reader - The raw interrupt status of I2C_BYTE_TRANS_DONE_INT."]
pub type BYTE_TRANS_DONE_INT_RAW_R = crate::BitReader;
#[doc = "Field `ARBITRATION_LOST_INT_RAW` reader - The raw interrupt status of I2C_ARBITRATION_LOST_INT."]
pub type ARBITRATION_LOST_INT_RAW_R = crate::BitReader;
#[doc = "Field `MST_TXFIFO_UDF_INT_RAW` reader - The raw interrupt status of I2C_MST_TXFIFO_UDF_INT."]
pub type MST_TXFIFO_UDF_INT_RAW_R = crate::BitReader;
#[doc = "Field `TRANS_COMPLETE_INT_RAW` reader - The raw interrupt status of the I2C_TRANS_COMPLETE_INT."]
pub type TRANS_COMPLETE_INT_RAW_R = crate::BitReader;
#[doc = "Field `TIME_OUT_INT_RAW` reader - The raw interrupt status of I2C_TIME_OUT_INT."]
pub type TIME_OUT_INT_RAW_R = crate::BitReader;
#[doc = "Field `TRANS_START_INT_RAW` reader - The raw interrupt status of I2C_TRANS_START_INT."]
pub type TRANS_START_INT_RAW_R = crate::BitReader;
#[doc = "Field `NACK_INT_RAW` reader - The raw interrupt status of I2C_NACK_INT."]
pub type NACK_INT_RAW_R = crate::BitReader;
#[doc = "Field `TXFIFO_OVF_INT_RAW` reader - The raw interrupt status of I2C_TXFIFO_OVF_INT."]
...
#[doc = "Field `SCL_ST_TO_INT_RAW` reader - The raw interrupt status of I2C_SCL_ST_TO_INT."]
pub type SCL_ST_TO_INT_RAW_R = crate::BitReader;
#[doc = "Field `SCL_MAIN_ST_TO_INT_RAW` reader - The raw interrupt status of I2C_SCL_MAIN_ST_TO_INT."]
