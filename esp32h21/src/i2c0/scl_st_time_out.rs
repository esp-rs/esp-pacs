...
#[doc = "Field `SCL_ST_TO` reader - Configures the threshold value of SCL_FSM state unchanged period. It should be no more than 23, more than 1.\\\\ \\[ \\text{Threshold} = 2^{\\text{I2C_SCL_ST_TO_I2C} - 1} \\] Measurement unit: I2C_SCLK \\\\"]
pub type SCL_ST_TO_R = crate::FieldReader;
#[doc = "Field `SCL_ST_TO` writer - Configures the threshold value of SCL_FSM state unchanged period. It should be no more than 23, more than 1.\\\\ \\[ \\text{Threshold} = 2^{\\text{I2C_SCL_ST_TO_I2C} - 1} \\] Measurement unit: I2C_SCLK \\\\"]
...
impl W {
    #[doc = "Bits 0:4 - Configures the threshold value of SCL_FSM state unchanged period. It should be no more than 23, more than 1.\\\\ \\[ \\text{Threshold} = 2^{\\text{I2C_SCL_ST_TO_I2C} - 1} \\] Measurement unit: I2C_SCLK \\\\"]
    #[inline(always)]
    pub fn scl_st_to(&mut self) -> SCL_ST_TO_W<'_, SCL_ST_TIME_OUT_SPEC> {
