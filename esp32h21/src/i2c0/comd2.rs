...
#[doc = "Field `COMMAND2` reader - Configures command 2. See details in I2C_COMD0_REG \\[13:0\\]."]
pub type COMMAND2_R = crate::FieldReader<u16>;
#[doc = "Field `COMMAND2` writer - Configures command 2. See details in I2C_COMD0_REG \\[13:0\\]."]
...
impl R {
    #[doc = "Bits 0:13 - Configures command 2. See details in I2C_COMD0_REG \\[13:0\\]."]
    #[inline(always)]
