...
#[doc = "Field `FIFO_RDATA` reader - Represents the value of RX FIFO read data."]
pub type FIFO_RDATA_R = crate::FieldReader;
#[doc = "Field `FIFO_RDATA` writer - Represents the value of RX FIFO read data."]
pub type FIFO_RDATA_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Represents the value of RX FIFO read data."]
    #[inline(always)]
