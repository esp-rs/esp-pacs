...
#[doc = "Field `COMMAND3` reader - Configures command 3. See details in I2C_COMD0_REG \\[13:0\\]."]
pub type COMMAND3_R = crate::FieldReader<u16>;
#[doc = "Field `COMMAND3` writer - Configures command 3. See details in I2C_COMD0_REG \\[13:0\\]."]
...
impl R {
    #[doc = "Bits 0:13 - Configures command 3. See details in I2C_COMD0_REG \\[13:0\\]."]
    #[inline(always)]
