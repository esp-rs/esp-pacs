...
#[doc = "Field `SLAVE_SCL_STRETCH_EN` reader - Configures whether to enable slave SCL stretch function. The SCL output line will be stretched low when I2C_SLAVE_SCL_STRETCH_EN is 1 and stretch event happens. The stretch cause can be seen in I2C_STRETCH_CAUSE.\\\\ 0: Disable \\\\ 1: Enable \\\\"]
pub type SLAVE_SCL_STRETCH_EN_R = crate::BitReader;
#[doc = "Field `SLAVE_SCL_STRETCH_EN` writer - Configures whether to enable slave SCL stretch function. The SCL output line will be stretched low when I2C_SLAVE_SCL_STRETCH_EN is 1 and stretch event happens. The stretch cause can be seen in I2C_STRETCH_CAUSE.\\\\ 0: Disable \\\\ 1: Enable \\\\"]
pub type SLAVE_SCL_STRETCH_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLAVE_SCL_STRETCH_CLR` writer - Configures whether or not to clear the I2C slave SCL stretch function.\\\\ 0: No effect \\\\ 1: Clear\\\\"]
pub type SLAVE_SCL_STRETCH_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLAVE_BYTE_ACK_CTL_EN` reader - Configures whether to enable the function for slave to control ACK level.\\\\ 0: Disable \\\\ 1: Enable \\\\"]
pub type SLAVE_BYTE_ACK_CTL_EN_R = crate::BitReader;
#[doc = "Field `SLAVE_BYTE_ACK_CTL_EN` writer - Configures whether to enable the function for slave to control ACK level.\\\\ 0: Disable \\\\ 1: Enable \\\\"]
pub type SLAVE_BYTE_ACK_CTL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLAVE_BYTE_ACK_LVL` reader - Configures the ACK level when slave controlling ACK level function enables.\\\\ 0: Low level\\\\ 1: High level \\\\"]
pub type SLAVE_BYTE_ACK_LVL_R = crate::BitReader;
#[doc = "Field `SLAVE_BYTE_ACK_LVL` writer - Configures the ACK level when slave controlling ACK level function enables.\\\\ 0: Low level\\\\ 1: High level \\\\"]
...
impl R {
    ...
    #[doc = "Bit 10 - Configures whether to enable slave SCL stretch function. The SCL output line will be stretched low when I2C_SLAVE_SCL_STRETCH_EN is 1 and stretch event happens. The stretch cause can be seen in I2C_STRETCH_CAUSE.\\\\ 0: Disable \\\\ 1: Enable \\\\"]
    #[inline(always)]
    pub fn slave_scl_stretch_en(&self) -> SLAVE_SCL_STRETCH_EN_R {
        SLAVE_SCL_STRETCH_EN_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 12 - Configures whether to enable the function for slave to control ACK level.\\\\ 0: Disable \\\\ 1: Enable \\\\"]
    #[inline(always)]
    pub fn slave_byte_ack_ctl_en(&self) -> SLAVE_BYTE_ACK_CTL_EN_R {
        SLAVE_BYTE_ACK_CTL_EN_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Configures the ACK level when slave controlling ACK level function enables.\\\\ 0: Low level\\\\ 1: High level \\\\"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 11 - Configures whether or not to clear the I2C slave SCL stretch function.\\\\ 0: No effect \\\\ 1: Clear\\\\"]
    #[inline(always)]
