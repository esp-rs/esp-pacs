...
#[doc = "Field `SCL_MAIN_ST_TO_I2C` reader - Configures the threshold value of SCL_MAIN_FSM state unchanged period. It should be no more than 23.\\\\ Measurement unit: I2C_SCLK \\\\"]
pub type SCL_MAIN_ST_TO_I2C_R = crate::FieldReader;
#[doc = "Field `SCL_MAIN_ST_TO_I2C` writer - Configures the threshold value of SCL_MAIN_FSM state unchanged period. It should be no more than 23.\\\\ Measurement unit: I2C_SCLK \\\\"]
...
impl W {
    #[doc = "Bits 0:4 - Configures the threshold value of SCL_MAIN_FSM state unchanged period. It should be no more than 23.\\\\ Measurement unit: I2C_SCLK \\\\"]
    #[inline(always)]
    pub fn scl_main_st_to_i2c(&mut self) -> SCL_MAIN_ST_TO_I2C_W<'_, SCL_MAIN_ST_TIME_OUT_SPEC> {
