...
#[doc = "Field `COMMAND4` reader - Configures command 4. See details in I2C_COMD0_REG \\[13:0\\]."]
pub type COMMAND4_R = crate::FieldReader<u16>;
#[doc = "Field `COMMAND4` writer - Configures command 4. See details in I2C_COMD0_REG \\[13:0\\]."]
...
impl R {
    #[doc = "Bits 0:13 - Configures command 4. See details in I2C_COMD0_REG \\[13:0\\]."]
    #[inline(always)]
