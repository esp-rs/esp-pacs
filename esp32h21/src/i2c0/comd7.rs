...
#[doc = "Field `COMMAND7` reader - Configures command 7. See details in I2C_COMD0_REG \\[13:0\\]."]
pub type COMMAND7_R = crate::FieldReader<u16>;
#[doc = "Field `COMMAND7` writer - Configures command 7. See details in I2C_COMD0_REG \\[13:0\\]."]
...
impl R {
    #[doc = "Bits 0:13 - Configures command 7. See details in I2C_COMD0_REG \\[13:0\\]."]
    #[inline(always)]
