...
#[doc = "Field `COMMAND0` reader - Configures command 0. \\\\ It consists of three parts:\\\\ op_code is the command\\\\ 0: RSTART\\\\ 1: WRITE\\\\ 2: READ\\\\ 3: STOP\\\\ 4: END.\\\\ Byte_num represents the number of bytes that need to be sent or received.\\\\ ack_check_en, ack_exp, and ack are used to control the ACK bit. See I2C cmd structure <a href=fig:i2c-cmd-structure\">link</a> for more information. \\\\\""]
pub type COMMAND0_R = crate::FieldReader<u16>;
#[doc = "Field `COMMAND0` writer - Configures command 0. \\\\ It consists of three parts:\\\\ op_code is the command\\\\ 0: RSTART\\\\ 1: WRITE\\\\ 2: READ\\\\ 3: STOP\\\\ 4: END.\\\\ Byte_num represents the number of bytes that need to be sent or received.\\\\ ack_check_en, ack_exp, and ack are used to control the ACK bit. See I2C cmd structure <a href=fig:i2c-cmd-structure\">link</a> for more information. \\\\\""]
...
impl R {
    #[doc = "Bits 0:13 - Configures command 0. \\\\ It consists of three parts:\\\\ op_code is the command\\\\ 0: RSTART\\\\ 1: WRITE\\\\ 2: READ\\\\ 3: STOP\\\\ 4: END.\\\\ Byte_num represents the number of bytes that need to be sent or received.\\\\ ack_check_en, ack_exp, and ack are used to control the ACK bit. See I2C cmd structure <a href=fig:i2c-cmd-structure\">link</a> for more information. \\\\\""]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:13 - Configures command 0. \\\\ It consists of three parts:\\\\ op_code is the command\\\\ 0: RSTART\\\\ 1: WRITE\\\\ 2: READ\\\\ 3: STOP\\\\ 4: END.\\\\ Byte_num represents the number of bytes that need to be sent or received.\\\\ ack_check_en, ack_exp, and ack are used to control the ACK bit. See I2C cmd structure <a href=fig:i2c-cmd-structure\">link</a> for more information. \\\\\""]
    #[inline(always)]
    pub fn command0(&mut self) -> COMMAND0_W<'_, COMD0_SPEC> {
        COMMAND0_W::new(self, 0)
    }
    #[doc = "Bit 31 - Represents whether command 0 is done in I2C Master mode.\\\\ 0: Not done \\\\ 1: Done \\\\"]
    #[inline(always)]
    pub fn command0_done(&mut self) -> COMMAND0_DONE_W<'_, COMD0_SPEC> {
