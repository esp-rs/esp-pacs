...
#[doc = "Field `COMMAND1` reader - Configures command 1. See details in I2C_COMD0_REG \\[13:0\\]."]
pub type COMMAND1_R = crate::FieldReader<u16>;
#[doc = "Field `COMMAND1` writer - Configures command 1. See details in I2C_COMD0_REG \\[13:0\\]."]
...
impl R {
    #[doc = "Bits 0:13 - Configures command 1. See details in I2C_COMD0_REG \\[13:0\\]."]
    #[inline(always)]
