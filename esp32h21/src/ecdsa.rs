...
impl RegisterBlock {
    ...
    #[doc = "0x0c - ECDSA interrupt raw register"]
    #[inline(always)]
    ...
    #[doc = "0x200 - ECDSA SHA-control register (Hash algrithm)"]
    #[inline(always)]
    pub const fn sha_mode(&self) -> &SHA_MODE {
        &self.sha_mode
    }
    #[doc = "0x210 - ECDSA SHA-control register (operation)"]
    #[inline(always)]
    pub const fn sha_start(&self) -> &SHA_START {
        &self.sha_start
    }
    #[doc = "0x214 - ECDSA SHA-control register (operation)"]
    #[inline(always)]
    pub const fn sha_continue(&self) -> &SHA_CONTINUE {
        &self.sha_continue
    }
    #[doc = "0x218 - ECDSA SHA-control status register"]
    #[inline(always)]
    ...
    #[doc = "0x340..0x360 - The memory that stores r."]
    #[inline(always)]
    ...
    #[doc = "0x360..0x380 - The memory that stores s."]
    #[inline(always)]
    ...
    #[doc = "0x380..0x3a0 - The memory that stores software written z."]
    #[inline(always)]
    ...
    #[doc = "0x3a0..0x3c0 - The memory that stores x coordinates of QA or software written k."]
    #[inline(always)]
    ...
    #[doc = "0x3c0..0x3e0 - The memory that stores y coordinates of QA."]
    #[inline(always)]
...
pub mod clk;
#[doc = "INT_RAW (r) register accessor: ECDSA interrupt raw register\n\nYou can [`read`](crate::Reg::read) this register and get [`int_raw::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@int_raw`] module"]
pub type INT_RAW = crate::Reg<int_raw::INT_RAW_SPEC>;
#[doc = "ECDSA interrupt raw register"]
pub mod int_raw;
