...
impl R {
    ...
    pub fn hp_active_xpd_xtalx2(&self) -> HP_ACTIVE_XPD_XTALX2_R {
        HP_ACTIVE_XPD_XTALX2_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn hp_active_xpd_xtalx2(&mut self) -> HP_ACTIVE_XPD_XTALX2_W<'_, HP_ACTIVE_XTAL_SPEC> {
        HP_ACTIVE_XPD_XTALX2_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn hp_active_xpd_xtal(&mut self) -> HP_ACTIVE_XPD_XTAL_W<'_, HP_ACTIVE_XTAL_SPEC> {
...
#[doc = "`reset()` method sets HP_ACTIVE_XTAL to value 0xc000_0000"]
