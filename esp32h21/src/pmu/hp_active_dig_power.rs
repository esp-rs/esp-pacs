...
#[doc = "Field `HP_ACTIVE_VDD_FLASH_MODE` reader - need_des"]
pub type HP_ACTIVE_VDD_FLASH_MODE_R = crate::FieldReader;
#[doc = "Field `HP_ACTIVE_VDD_FLASH_MODE` writer - need_des"]
pub type HP_ACTIVE_VDD_FLASH_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
#[doc = "Field `HP_ACTIVE_PD_HP_PERI_PD_EN` reader - need_des"]
pub type HP_ACTIVE_PD_HP_PERI_PD_EN_R = crate::BitReader;
#[doc = "Field `HP_ACTIVE_PD_HP_PERI_PD_EN` writer - need_des"]
pub type HP_ACTIVE_PD_HP_PERI_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn hp_active_vdd_flash_mode(&self) -> HP_ACTIVE_VDD_FLASH_MODE_R {
        HP_ACTIVE_VDD_FLASH_MODE_R::new(((self.bits >> 18) & 0x0f) as u8)
    }
    #[doc = "Bit 22 - need_des"]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn hp_active_pd_hp_peri_pd_en(&self) -> HP_ACTIVE_PD_HP_PERI_PD_EN_R {
        HP_ACTIVE_PD_HP_PERI_PD_EN_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_ACTIVE_DIG_POWER")
            .field("hp_active_vdd_flash_mode", &self.hp_active_vdd_flash_mode())
            ...
            .field(
                "hp_active_pd_hp_peri_pd_en",
                &self.hp_active_pd_hp_peri_pd_en(),
            )
            .field(
...
impl W {
    #[doc = "Bits 18:21 - need_des"]
    #[inline(always)]
    pub fn hp_active_vdd_flash_mode(
        &mut self,
    ) -> HP_ACTIVE_VDD_FLASH_MODE_W<'_, HP_ACTIVE_DIG_POWER_SPEC> {
        HP_ACTIVE_VDD_FLASH_MODE_W::new(self, 18)
    }
    #[doc = "Bit 22 - need_des"]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn hp_active_pd_hp_peri_pd_en(
        &mut self,
    ) -> HP_ACTIVE_PD_HP_PERI_PD_EN_W<'_, HP_ACTIVE_DIG_POWER_SPEC> {
        HP_ACTIVE_PD_HP_PERI_PD_EN_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
