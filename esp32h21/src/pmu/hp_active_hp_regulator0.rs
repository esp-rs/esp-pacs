...
impl W {
    ...
    pub fn hp_active_hp_power_det_bypass(
        &mut self,
    ) -> HP_ACTIVE_HP_POWER_DET_BYPASS_W<'_, HP_ACTIVE_HP_REGULATOR0_SPEC> {
...
#[doc = "`reset()` method sets HP_ACTIVE_HP_REGULATOR0 to value 0x8447_7180"]
impl crate::Resettable for HP_ACTIVE_HP_REGULATOR0_SPEC {
    const RESET_VALUE: u32 = 0x8447_7180;
}
