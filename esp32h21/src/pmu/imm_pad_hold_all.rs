...
#[doc = "Field `TIE_HIGH_DIG_PAD_SLP_SEL` writer - need_des"]
pub type TIE_HIGH_DIG_PAD_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIE_LOW_DIG_PAD_SLP_SEL` writer - need_des"]
pub type TIE_LOW_DIG_PAD_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn tie_high_dig_pad_slp_sel(
        &mut self,
    ) -> TIE_HIGH_DIG_PAD_SLP_SEL_W<'_, IMM_PAD_HOLD_ALL_SPEC> {
        TIE_HIGH_DIG_PAD_SLP_SEL_W::new(self, 26)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn tie_low_dig_pad_slp_sel(
        &mut self,
    ) -> TIE_LOW_DIG_PAD_SLP_SEL_W<'_, IMM_PAD_HOLD_ALL_SPEC> {
        TIE_LOW_DIG_PAD_SLP_SEL_W::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
