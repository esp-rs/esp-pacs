...
#[doc = "Field `ANA_WAIT_CLK_SEL` reader - need_des"]
pub type ANA_WAIT_CLK_SEL_R = crate::BitReader;
#[doc = "Field `ANA_WAIT_CLK_SEL` writer - need_des"]
pub type ANA_WAIT_CLK_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 15 - need_des"]
    #[inline(always)]
    pub fn ana_wait_clk_sel(&self) -> ANA_WAIT_CLK_SEL_R {
        ANA_WAIT_CLK_SEL_R::new(((self.bits >> 15) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SLP_WAKEUP_CNTL7")
            .field("ana_wait_clk_sel", &self.ana_wait_clk_sel())
...
impl W {
    #[doc = "Bit 15 - need_des"]
    #[inline(always)]
    pub fn ana_wait_clk_sel(&mut self) -> ANA_WAIT_CLK_SEL_W<'_, SLP_WAKEUP_CNTL7_SPEC> {
        ANA_WAIT_CLK_SEL_W::new(self, 15)
    }
    #[doc = "Bits 16:31 - need_des"]
    #[inline(always)]
