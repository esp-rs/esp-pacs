...
#[doc = "Field `TIE_HIGH_XTALX2` writer - need_des"]
pub type TIE_HIGH_XTALX2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    pub fn tie_low_global_xtalx2_icg(
        &mut self,
    ) -> TIE_LOW_GLOBAL_XTALX2_ICG_W<'_, IMM_HP_CK_POWER_SPEC> {
        TIE_LOW_GLOBAL_XTALX2_ICG_W::new(self, 7)
    }
    #[doc = "Bit 8 - need_des"]
    #[inline(always)]
    pub fn tie_low_xpd_xtalx2(&mut self) -> TIE_LOW_XPD_XTALX2_W<'_, IMM_HP_CK_POWER_SPEC> {
        TIE_LOW_XPD_XTALX2_W::new(self, 8)
    }
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn tie_high_xtalx2(&mut self) -> TIE_HIGH_XTALX2_W<'_, IMM_HP_CK_POWER_SPEC> {
        TIE_HIGH_XTALX2_W::new(self, 23)
    }
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
    pub fn tie_high_global_xtalx2_icg(
        &mut self,
    ) -> TIE_HIGH_GLOBAL_XTALX2_ICG_W<'_, IMM_HP_CK_POWER_SPEC> {
        TIE_HIGH_GLOBAL_XTALX2_ICG_W::new(self, 24)
    }
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
