...
pub struct RegisterBlock {
    ...
    rng_loop: RNG_LOOP,
    cache_mem_clk_fo: CACHE_MEM_CLK_FO,
    _reserved14: [u8; 0x03a8],
    rnd_eco: RND_ECO,
...
impl RegisterBlock {
    ...
    #[doc = "0x30 - configure rng_ring"]
    #[inline(always)]
    pub const fn rng_loop(&self) -> &RNG_LOOP {
        &self.rng_loop
    }
    #[doc = "0x34 - debug"]
    #[inline(always)]
    pub const fn cache_mem_clk_fo(&self) -> &CACHE_MEM_CLK_FO {
        &self.cache_mem_clk_fo
    }
...
#[doc = "RNG_LOOP (rw) register accessor: configure rng_ring\n\nYou can [`read`](crate::Reg::read) this register and get [`rng_loop::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rng_loop::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rng_loop`] module"]
pub type RNG_LOOP = crate::Reg<rng_loop::RNG_LOOP_SPEC>;
#[doc = "configure rng_ring"]
pub mod rng_loop;
#[doc = "CACHE_MEM_CLK_FO (rw) register accessor: debug\n\nYou can [`read`](crate::Reg::read) this register and get [`cache_mem_clk_fo::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cache_mem_clk_fo::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cache_mem_clk_fo`] module"]
pub type CACHE_MEM_CLK_FO = crate::Reg<cache_mem_clk_fo::CACHE_MEM_CLK_FO_SPEC>;
#[doc = "debug"]
pub mod cache_mem_clk_fo;
