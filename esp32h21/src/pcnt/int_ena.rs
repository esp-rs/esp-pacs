...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            .field("cnt_thr_event_u0_int_ena", &self.cnt_thr_event_u0_int_ena())
            .field("cnt_thr_event_u1_int_ena", &self.cnt_thr_event_u1_int_ena())
            .field("cnt_thr_event_u2_int_ena", &self.cnt_thr_event_u2_int_ena())
            .field("cnt_thr_event_u3_int_ena", &self.cnt_thr_event_u3_int_ena())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - The interrupt enable bit for the PCNT_CNT_THR_EVENT_U0_INT interrupt."]
    #[inline(always)]
    pub fn cnt_thr_event_u0_int_ena(&mut self) -> CNT_THR_EVENT_U0_INT_ENA_W<'_, INT_ENA_SPEC> {
        CNT_THR_EVENT_U0_INT_ENA_W::new(self, 0)
    }
    #[doc = "Bit 1 - The interrupt enable bit for the PCNT_CNT_THR_EVENT_U1_INT interrupt."]
    #[inline(always)]
    pub fn cnt_thr_event_u1_int_ena(&mut self) -> CNT_THR_EVENT_U1_INT_ENA_W<'_, INT_ENA_SPEC> {
        CNT_THR_EVENT_U1_INT_ENA_W::new(self, 1)
    }
    #[doc = "Bit 2 - The interrupt enable bit for the PCNT_CNT_THR_EVENT_U2_INT interrupt."]
    #[inline(always)]
    pub fn cnt_thr_event_u2_int_ena(&mut self) -> CNT_THR_EVENT_U2_INT_ENA_W<'_, INT_ENA_SPEC> {
        CNT_THR_EVENT_U2_INT_ENA_W::new(self, 2)
    }
    #[doc = "Bit 3 - The interrupt enable bit for the PCNT_CNT_THR_EVENT_U3_INT interrupt."]
    #[inline(always)]
    pub fn cnt_thr_event_u3_int_ena(&mut self) -> CNT_THR_EVENT_U3_INT_ENA_W<'_, INT_ENA_SPEC> {
        CNT_THR_EVENT_U3_INT_ENA_W::new(self, 3)
    }
}
