...
#[doc = "Field `L1_CACHE_SHUT_BUS0` reader - Configures whether to disable BUS0 to access the L1 cache.\\\\ 0: Enable\\\\ 1: Disable\\\\"]
pub type L1_CACHE_SHUT_BUS0_R = crate::BitReader;
#[doc = "Field `L1_CACHE_SHUT_BUS0` writer - Configures whether to disable BUS0 to access the L1 cache.\\\\ 0: Enable\\\\ 1: Disable\\\\"]
pub type L1_CACHE_SHUT_BUS0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_SHUT_BUS1` reader - Configures whether to disable BUS1 to access the L1 cache.\\\\ 0: Enable\\\\ 1: Disable\\\\"]
pub type L1_CACHE_SHUT_BUS1_R = crate::BitReader;
#[doc = "Field `L1_CACHE_SHUT_BUS1` writer - Configures whether to disable BUS1 to access the L1 cache.\\\\ 0: Enable\\\\ 1: Disable\\\\"]
pub type L1_CACHE_SHUT_BUS1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_SHUT_BUS2` reader - Reserved"]
pub type L1_CACHE_SHUT_BUS2_R = crate::BitReader;
#[doc = "Field `L1_CACHE_SHUT_BUS2` writer - Reserved"]
pub type L1_CACHE_SHUT_BUS2_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_SHUT_BUS3` reader - Reserved"]
pub type L1_CACHE_SHUT_BUS3_R = crate::BitReader;
#[doc = "Field `L1_CACHE_SHUT_BUS3` writer - Reserved"]
pub type L1_CACHE_SHUT_BUS3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `L1_CACHE_SHUT_DMA` writer - The bit is used to disable DMA access L1-Cache, 0: enable, 1: disable"]
pub type L1_CACHE_SHUT_DMA_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type L1_CACHE_UNDEF_OP_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bit 0 - Configures whether to disable BUS0 to access the L1 cache.\\\\ 0: Enable\\\\ 1: Disable\\\\"]
    #[inline(always)]
    pub fn l1_cache_shut_bus0(&self) -> L1_CACHE_SHUT_BUS0_R {
        L1_CACHE_SHUT_BUS0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures whether to disable BUS1 to access the L1 cache.\\\\ 0: Enable\\\\ 1: Disable\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn l1_cache_shut_bus2(&self) -> L1_CACHE_SHUT_BUS2_R {
        L1_CACHE_SHUT_BUS2_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Reserved"]
    #[inline(always)]
    pub fn l1_cache_shut_bus3(&self) -> L1_CACHE_SHUT_BUS3_R {
        L1_CACHE_SHUT_BUS3_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn l1_cache_undef_op(&self) -> L1_CACHE_UNDEF_OP_R {
        L1_CACHE_UNDEF_OP_R::new(((self.bits >> 8) & 0xff) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_CTRL")
            ...
            .field("l1_cache_shut_bus2", &self.l1_cache_shut_bus2())
            .field("l1_cache_shut_bus3", &self.l1_cache_shut_bus3())
...
impl W {
    ...
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn l1_cache_shut_bus2(&mut self) -> L1_CACHE_SHUT_BUS2_W<'_, L1_CACHE_CTRL_SPEC> {
        L1_CACHE_SHUT_BUS2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Reserved"]
    #[inline(always)]
    pub fn l1_cache_shut_bus3(&mut self) -> L1_CACHE_SHUT_BUS3_W<'_, L1_CACHE_CTRL_SPEC> {
        L1_CACHE_SHUT_BUS3_W::new(self, 3)
    }
    #[doc = "Bit 4 - The bit is used to disable DMA access L1-Cache, 0: enable, 1: disable"]
    #[inline(always)]
    pub fn l1_cache_shut_dma(&mut self) -> L1_CACHE_SHUT_DMA_W<'_, L1_CACHE_CTRL_SPEC> {
        L1_CACHE_SHUT_DMA_W::new(self, 4)
    }
    #[doc = "Bits 8:15 - Reserved"]
    #[inline(always)]
