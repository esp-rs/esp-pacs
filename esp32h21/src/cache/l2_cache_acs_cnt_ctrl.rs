...
#[doc = "Field `L2_BUS0_CNT_ENA` reader - The bit is used to enable dbus0 counter in L2-Cache."]
pub type L2_BUS0_CNT_ENA_R = crate::BitReader;
#[doc = "Field `L2_BUS1_CNT_ENA` reader - The bit is used to enable dbus1 counter in L2-Cache."]
pub type L2_BUS1_CNT_ENA_R = crate::BitReader;
#[doc = "Field `L2_BUS2_CNT_ENA` reader - Reserved"]
pub type L2_BUS2_CNT_ENA_R = crate::BitReader;
#[doc = "Field `L2_BUS3_CNT_ENA` reader - Reserved"]
pub type L2_BUS3_CNT_ENA_R = crate::BitReader;
...
#[doc = "Field `L2_BUS0_CNT_CLR` writer - The bit is used to clear dbus0 counter in L2-Cache."]
pub type L2_BUS0_CNT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_BUS1_CNT_CLR` writer - The bit is used to clear dbus1 counter in L2-Cache."]
pub type L2_BUS1_CNT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_BUS2_CNT_CLR` reader - Reserved"]
pub type L2_BUS2_CNT_CLR_R = crate::BitReader;
#[doc = "Field `L2_BUS3_CNT_CLR` reader - Reserved"]
pub type L2_BUS3_CNT_CLR_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn l2_bus0_cnt_ena(&self) -> L2_BUS0_CNT_ENA_R {
        L2_BUS0_CNT_ENA_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - The bit is used to enable dbus1 counter in L2-Cache."]
    #[inline(always)]
    pub fn l2_bus1_cnt_ena(&self) -> L2_BUS1_CNT_ENA_R {
        L2_BUS1_CNT_ENA_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Reserved"]
    #[inline(always)]
    pub fn l2_bus2_cnt_ena(&self) -> L2_BUS2_CNT_ENA_R {
        L2_BUS2_CNT_ENA_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Reserved"]
    #[inline(always)]
    pub fn l2_bus3_cnt_ena(&self) -> L2_BUS3_CNT_ENA_R {
        L2_BUS3_CNT_ENA_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 26 - Reserved"]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - Reserved"]
    #[inline(always)]
    pub fn l2_bus2_cnt_clr(&self) -> L2_BUS2_CNT_CLR_R {
        L2_BUS2_CNT_CLR_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Reserved"]
    #[inline(always)]
    pub fn l2_bus3_cnt_clr(&self) -> L2_BUS3_CNT_CLR_R {
        L2_BUS3_CNT_CLR_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_CACHE_ACS_CNT_CTRL")
            ...
            .field("l2_bus0_cnt_ena", &self.l2_bus0_cnt_ena())
            .field("l2_bus1_cnt_ena", &self.l2_bus1_cnt_ena())
            .field("l2_bus2_cnt_ena", &self.l2_bus2_cnt_ena())
            .field("l2_bus3_cnt_ena", &self.l2_bus3_cnt_ena())
            .field("l2_ibus2_cnt_clr", &self.l2_ibus2_cnt_clr())
            .field("l2_ibus3_cnt_clr", &self.l2_ibus3_cnt_clr())
            .field("l2_bus2_cnt_clr", &self.l2_bus2_cnt_clr())
            .field("l2_bus3_cnt_clr", &self.l2_bus3_cnt_clr())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    pub fn l2_bus0_cnt_clr(&mut self) -> L2_BUS0_CNT_CLR_W<'_, L2_CACHE_ACS_CNT_CTRL_SPEC> {
        L2_BUS0_CNT_CLR_W::new(self, 28)
    }
    #[doc = "Bit 29 - The bit is used to clear dbus1 counter in L2-Cache."]
    #[inline(always)]
    pub fn l2_bus1_cnt_clr(&mut self) -> L2_BUS1_CNT_CLR_W<'_, L2_CACHE_ACS_CNT_CTRL_SPEC> {
        L2_BUS1_CNT_CLR_W::new(self, 29)
    }
}
#[doc = "Cache Access Counter enable and clear register\n\nYou can [`read`](crate::Reg::read) this register and get [`l2_cache_acs_cnt_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l2_cache_acs_cnt_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
