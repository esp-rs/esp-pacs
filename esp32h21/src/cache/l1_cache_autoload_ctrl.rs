...
#[doc = "Field `L1_CACHE_AUTOLOAD_ENA` reader - Configures whether to enable the autoloading operation in the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_AUTOLOAD_ENA_R = crate::BitReader;
#[doc = "Field `L1_CACHE_AUTOLOAD_ENA` writer - Configures whether to enable the autoloading operation in the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_AUTOLOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_AUTOLOAD_DONE` reader - Represents whether the autoloading operation in the L1 cache is finished.\\\\ 0: Not finished\\\\ 1: Finished\\\\"]
pub type L1_CACHE_AUTOLOAD_DONE_R = crate::BitReader;
#[doc = "Field `L1_CACHE_AUTOLOAD_ORDER` reader - Configures the direction of the autoloading operation in the L1 cache.\\\\ 0: Ascending\\\\ 1: Descending\\\\"]
pub type L1_CACHE_AUTOLOAD_ORDER_R = crate::BitReader;
#[doc = "Field `L1_CACHE_AUTOLOAD_ORDER` writer - Configures the direction of the autoloading operation in the L1 cache.\\\\ 0: Ascending\\\\ 1: Descending\\\\"]
pub type L1_CACHE_AUTOLOAD_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_AUTOLOAD_TRIGGER_MODE` reader - Configures the trigger mode of the autoloading operation in the L1 cache.\\\\ 0/3: Triggered by misses\\\\ 1: Triggered by hits\\\\ 2: Triggered by misses or hits\\\\"]
pub type L1_CACHE_AUTOLOAD_TRIGGER_MODE_R = crate::FieldReader;
#[doc = "Field `L1_CACHE_AUTOLOAD_TRIGGER_MODE` writer - Configures the trigger mode of the autoloading operation in the L1 cache.\\\\ 0/3: Triggered by misses\\\\ 1: Triggered by hits\\\\ 2: Triggered by misses or hits\\\\"]
pub type L1_CACHE_AUTOLOAD_TRIGGER_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT0_ENA` reader - Configures whether to enable Section 0 for the autoloading operation in the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_AUTOLOAD_SCT0_ENA_R = crate::BitReader;
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT0_ENA` writer - Configures whether to enable Section 0 for the autoloading operation in the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_AUTOLOAD_SCT0_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT1_ENA` reader - Configures whether to enable Section 1 for the autoloading operation in the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_AUTOLOAD_SCT1_ENA_R = crate::BitReader;
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT1_ENA` writer - Configures whether to enable Section 1 for the autoloading operation in the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
...
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT2_ENA` writer - The bit is used to enable the third section for autoload operation on L1-Cache."]
pub type L1_CACHE_AUTOLOAD_SCT2_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT3_ENA` writer - The bit is used to enable the fourth section for autoload operation on L1-Cache."]
pub type L1_CACHE_AUTOLOAD_SCT3_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `L1_CACHE_AUTOLOAD_RGID` writer - The bit is used to set the gid of l1 Cache autoload."]
pub type L1_CACHE_AUTOLOAD_RGID_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bit 0 - Configures whether to enable the autoloading operation in the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_cache_autoload_ena(&self) -> L1_CACHE_AUTOLOAD_ENA_R {
        L1_CACHE_AUTOLOAD_ENA_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Represents whether the autoloading operation in the L1 cache is finished.\\\\ 0: Not finished\\\\ 1: Finished\\\\"]
    #[inline(always)]
    pub fn l1_cache_autoload_done(&self) -> L1_CACHE_AUTOLOAD_DONE_R {
        L1_CACHE_AUTOLOAD_DONE_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Configures the direction of the autoloading operation in the L1 cache.\\\\ 0: Ascending\\\\ 1: Descending\\\\"]
    #[inline(always)]
    pub fn l1_cache_autoload_order(&self) -> L1_CACHE_AUTOLOAD_ORDER_R {
        L1_CACHE_AUTOLOAD_ORDER_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bits 3:4 - Configures the trigger mode of the autoloading operation in the L1 cache.\\\\ 0/3: Triggered by misses\\\\ 1: Triggered by hits\\\\ 2: Triggered by misses or hits\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Configures whether to enable Section 0 for the autoloading operation in the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_cache_autoload_sct0_ena(&self) -> L1_CACHE_AUTOLOAD_SCT0_ENA_R {
        L1_CACHE_AUTOLOAD_SCT0_ENA_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Configures whether to enable Section 1 for the autoloading operation in the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 10 - The bit is used to enable the third section for autoload operation on L1-Cache."]
    #[inline(always)]
    pub fn l1_cache_autoload_sct2_ena(
        &mut self,
    ) -> L1_CACHE_AUTOLOAD_SCT2_ENA_W<'_, L1_CACHE_AUTOLOAD_CTRL_SPEC> {
        L1_CACHE_AUTOLOAD_SCT2_ENA_W::new(self, 10)
    }
    #[doc = "Bit 11 - The bit is used to enable the fourth section for autoload operation on L1-Cache."]
    #[inline(always)]
    pub fn l1_cache_autoload_sct3_ena(
        &mut self,
    ) -> L1_CACHE_AUTOLOAD_SCT3_ENA_W<'_, L1_CACHE_AUTOLOAD_CTRL_SPEC> {
        L1_CACHE_AUTOLOAD_SCT3_ENA_W::new(self, 11)
    }
    #[doc = "Bits 12:15 - The bit is used to set the gid of l1 Cache autoload."]
    #[inline(always)]
    pub fn l1_cache_autoload_rgid(
        &mut self,
    ) -> L1_CACHE_AUTOLOAD_RGID_W<'_, L1_CACHE_AUTOLOAD_CTRL_SPEC> {
        L1_CACHE_AUTOLOAD_RGID_W::new(self, 12)
    }
}
