...
#[doc = "Field `L1_CACHE_DATA_MEM_RD_EN` reader - Configures whether to enable the configuration bus to read the L1 cache data memory.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_DATA_MEM_RD_EN_R = crate::BitReader;
#[doc = "Field `L1_CACHE_DATA_MEM_RD_EN` writer - Configures whether to enable the configuration bus to read the L1 cache data memory.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_DATA_MEM_RD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_DATA_MEM_WR_EN` reader - Configures whether to enable the configuration bus to write the L1 cache data memory.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_DATA_MEM_WR_EN_R = crate::BitReader;
#[doc = "Field `L1_CACHE_DATA_MEM_WR_EN` writer - Configures whether to enable the configuration bus to write the L1 cache data memory.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
...
impl R {
    ...
    #[doc = "Bit 16 - Configures whether to enable the configuration bus to read the L1 cache data memory.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_cache_data_mem_rd_en(&self) -> L1_CACHE_DATA_MEM_RD_EN_R {
        L1_CACHE_DATA_MEM_RD_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Configures whether to enable the configuration bus to write the L1 cache data memory.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
