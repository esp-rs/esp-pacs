...
#[doc = "Field `L1_BUS0_OVF_INT_ENA` reader - Write 1 to enable L1_BUS0_OVF_INT."]
pub type L1_BUS0_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_BUS0_OVF_INT_ENA` writer - Write 1 to enable L1_BUS0_OVF_INT."]
pub type L1_BUS0_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_BUS1_OVF_INT_ENA` reader - Write 1 to enable L1_BUS1_OVF_INT."]
pub type L1_BUS1_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_BUS1_OVF_INT_ENA` writer - Write 1 to enable L1_BUS1_OVF_INT."]
pub type L1_BUS1_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_BUS2_OVF_INT_ENA` reader - Reserved"]
pub type L1_BUS2_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_BUS3_OVF_INT_ENA` reader - Reserved"]
pub type L1_BUS3_OVF_INT_ENA_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 6 - Reserved"]
    #[inline(always)]
    pub fn l1_bus2_ovf_int_ena(&self) -> L1_BUS2_OVF_INT_ENA_R {
        L1_BUS2_OVF_INT_ENA_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Reserved"]
    #[inline(always)]
    pub fn l1_bus3_ovf_int_ena(&self) -> L1_BUS3_OVF_INT_ENA_R {
        L1_BUS3_OVF_INT_ENA_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_ACS_CNT_INT_ENA")
            ...
            .field("l1_bus2_ovf_int_ena", &self.l1_bus2_ovf_int_ena())
            .field("l1_bus3_ovf_int_ena", &self.l1_bus3_ovf_int_ena())
            .finish()
    }
}
impl W {
