...
#[doc = "Field `SYNC_ADDR` reader - Configures the starting virtual address for the synchronization operation. This field should be configured together with CACHE_SYNC_SIZE_REG."]
pub type SYNC_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `SYNC_ADDR` writer - Configures the starting virtual address for the synchronization operation. This field should be configured together with CACHE_SYNC_SIZE_REG."]
pub type SYNC_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the starting virtual address for the synchronization operation. This field should be configured together with CACHE_SYNC_SIZE_REG."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Configures the starting virtual address for the synchronization operation. This field should be configured together with CACHE_SYNC_SIZE_REG."]
    #[inline(always)]
    pub fn sync_addr(&mut self) -> SYNC_ADDR_W<'_, SYNC_ADDR_SPEC> {
