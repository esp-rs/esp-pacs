...
#[doc = "Field `L1_CACHE_TAG_OBJECT` reader - Configures whether to set the L1 cache tag memory as an object.\\\\ 0: Not set\\\\ 1: Set\\\\ This field should be one-hot with the other fields inside this register.\\\\"]
pub type L1_CACHE_TAG_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_CACHE_TAG_OBJECT` writer - Configures whether to set the L1 cache tag memory as an object.\\\\ 0: Not set\\\\ 1: Set\\\\ This field should be one-hot with the other fields inside this register.\\\\"]
...
#[doc = "Field `L1_CACHE_MEM_OBJECT` reader - Configures whether to set the L1 cache data memory as an object. \\\\ 0: Not set\\\\ 1: Set\\\\ This field should be one-hot with the other fields inside this register. \\\\"]
pub type L1_CACHE_MEM_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_CACHE_MEM_OBJECT` writer - Configures whether to set the L1 cache data memory as an object. \\\\ 0: Not set\\\\ 1: Set\\\\ This field should be one-hot with the other fields inside this register. \\\\"]
...
impl R {
    ...
    #[doc = "Bit 4 - Configures whether to set the L1 cache tag memory as an object.\\\\ 0: Not set\\\\ 1: Set\\\\ This field should be one-hot with the other fields inside this register.\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - Configures whether to set the L1 cache data memory as an object. \\\\ 0: Not set\\\\ 1: Set\\\\ This field should be one-hot with the other fields inside this register. \\\\"]
    #[inline(always)]
