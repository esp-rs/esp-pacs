...
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT0_SIZE` reader - Configures the size of Section 0 for the autoloading operation in the L1 cache. Note that it should be used together with CACHE_L1_CACHE_AUTOLOAD_SCT0_ADDR and CACHE_L1_CACHE_AUTOLOAD_SCT0_ENA."]
pub type L1_CACHE_AUTOLOAD_SCT0_SIZE_R = crate::FieldReader<u32>;
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT0_SIZE` writer - Configures the size of Section 0 for the autoloading operation in the L1 cache. Note that it should be used together with CACHE_L1_CACHE_AUTOLOAD_SCT0_ADDR and CACHE_L1_CACHE_AUTOLOAD_SCT0_ENA."]
pub type L1_CACHE_AUTOLOAD_SCT0_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bits 0:23 - Configures the size of Section 0 for the autoloading operation in the L1 cache. Note that it should be used together with CACHE_L1_CACHE_AUTOLOAD_SCT0_ADDR and CACHE_L1_CACHE_AUTOLOAD_SCT0_ENA."]
    #[inline(always)]
    pub fn l1_cache_autoload_sct0_size(&self) -> L1_CACHE_AUTOLOAD_SCT0_SIZE_R {
        L1_CACHE_AUTOLOAD_SCT0_SIZE_R::new(self.bits & 0x00ff_ffff)
    }
}
