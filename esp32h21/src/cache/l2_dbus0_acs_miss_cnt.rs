...
#[doc = "Field `L2_BUS0_MISS_CNT` reader - The register records the number of missing when L1-Cache accesses L2-Cache due to bus0 accessing L1-Cache."]
pub type L2_BUS0_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of missing when L1-Cache accesses L2-Cache due to bus0 accessing L1-Cache."]
    #[inline(always)]
    pub fn l2_bus0_miss_cnt(&self) -> L2_BUS0_MISS_CNT_R {
        L2_BUS0_MISS_CNT_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_DBUS0_ACS_MISS_CNT")
            .field("l2_bus0_miss_cnt", &self.l2_bus0_miss_cnt())
            .finish()
    }
}
