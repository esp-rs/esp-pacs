...
pub type L1_ICACHE0_PRELOAD_SIZE_R = crate::FieldReader<u32>;
...
pub type L1_ICACHE0_PRELOAD_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bits 0:23 - Those bits are used to configure the size of the first section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOAD_ADDR_REG"]
    #[inline(always)]
    pub fn l1_icache0_preload_size(&self) -> L1_ICACHE0_PRELOAD_SIZE_R {
        L1_ICACHE0_PRELOAD_SIZE_R::new(self.bits & 0x00ff_ffff)
    }
}
