...
#[doc = "Field `L1_CACHE_BLOCKSIZE_8` reader - The field is used to configureblocksize of L1-Cache as 8 bytes. This field and all other fields within this register is onehot."]
pub type L1_CACHE_BLOCKSIZE_8_R = crate::BitReader;
#[doc = "Field `L1_CACHE_BLOCKSIZE_16` reader - The field is used to configureblocksize of L1-Cache as 16 bytes. This field and all other fields within this register is onehot."]
pub type L1_CACHE_BLOCKSIZE_16_R = crate::BitReader;
#[doc = "Field `L1_CACHE_BLOCKSIZE_32` reader - Represents the cache block size is 32 bytes."]
pub type L1_CACHE_BLOCKSIZE_32_R = crate::BitReader;
#[doc = "Field `L1_CACHE_BLOCKSIZE_64` reader - The field is used to configureblocksize of L1-Cache as 64 bytes. This field and all other fields within this register is onehot."]
pub type L1_CACHE_BLOCKSIZE_64_R = crate::BitReader;
#[doc = "Field `L1_CACHE_BLOCKSIZE_128` reader - The field is used to configureblocksize of L1-Cache as 128 bytes. This field and all other fields within this register is onehot."]
pub type L1_CACHE_BLOCKSIZE_128_R = crate::BitReader;
#[doc = "Field `L1_CACHE_BLOCKSIZE_256` reader - The field is used to configureblocksize of L1-Cache as 256 bytes. This field and all other fields within this register is onehot."]
pub type L1_CACHE_BLOCKSIZE_256_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - The field is used to configureblocksize of L1-Cache as 8 bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_blocksize_8(&self) -> L1_CACHE_BLOCKSIZE_8_R {
        L1_CACHE_BLOCKSIZE_8_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The field is used to configureblocksize of L1-Cache as 16 bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_blocksize_16(&self) -> L1_CACHE_BLOCKSIZE_16_R {
        L1_CACHE_BLOCKSIZE_16_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Represents the cache block size is 32 bytes."]
    #[inline(always)]
    pub fn l1_cache_blocksize_32(&self) -> L1_CACHE_BLOCKSIZE_32_R {
        L1_CACHE_BLOCKSIZE_32_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - The field is used to configureblocksize of L1-Cache as 64 bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_blocksize_64(&self) -> L1_CACHE_BLOCKSIZE_64_R {
        L1_CACHE_BLOCKSIZE_64_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - The field is used to configureblocksize of L1-Cache as 128 bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_blocksize_128(&self) -> L1_CACHE_BLOCKSIZE_128_R {
        L1_CACHE_BLOCKSIZE_128_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - The field is used to configureblocksize of L1-Cache as 256 bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
