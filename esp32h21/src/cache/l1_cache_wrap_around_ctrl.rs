...
#[doc = "Field `L1_CACHE_WRAP` reader - Configures whether to enable the critical word first mode for the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_WRAP_R = crate::BitReader;
#[doc = "Field `L1_CACHE_WRAP` writer - Configures whether to enable the critical word first mode for the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
...
impl R {
    ...
    #[doc = "Bit 4 - Configures whether to enable the critical word first mode for the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
