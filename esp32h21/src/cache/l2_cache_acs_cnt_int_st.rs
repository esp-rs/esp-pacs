...
#[doc = "Field `L2_BUS0_OVF_INT_ST` reader - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
pub type L2_BUS0_OVF_INT_ST_R = crate::BitReader;
#[doc = "Field `L2_BUS1_OVF_INT_ST` reader - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
pub type L2_BUS1_OVF_INT_ST_R = crate::BitReader;
#[doc = "Field `L2_BUS2_OVF_INT_ST` reader - Reserved"]
pub type L2_BUS2_OVF_INT_ST_R = crate::BitReader;
#[doc = "Field `L2_BUS3_OVF_INT_ST` reader - Reserved"]
pub type L2_BUS3_OVF_INT_ST_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn l2_bus0_ovf_int_st(&self) -> L2_BUS0_OVF_INT_ST_R {
        L2_BUS0_OVF_INT_ST_R::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_bus1_ovf_int_st(&self) -> L2_BUS1_OVF_INT_ST_R {
        L2_BUS1_OVF_INT_ST_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Reserved"]
    #[inline(always)]
    pub fn l2_bus2_ovf_int_st(&self) -> L2_BUS2_OVF_INT_ST_R {
        L2_BUS2_OVF_INT_ST_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Reserved"]
    #[inline(always)]
    pub fn l2_bus3_ovf_int_st(&self) -> L2_BUS3_OVF_INT_ST_R {
        L2_BUS3_OVF_INT_ST_R::new(((self.bits >> 15) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_CACHE_ACS_CNT_INT_ST")
            ...
            .field("l2_bus0_ovf_int_st", &self.l2_bus0_ovf_int_st())
            .field("l2_bus1_ovf_int_st", &self.l2_bus1_ovf_int_st())
            .field("l2_bus2_ovf_int_st", &self.l2_bus2_ovf_int_st())
            .field("l2_bus3_ovf_int_st", &self.l2_bus3_ovf_int_st())
            .finish()
    }
}
