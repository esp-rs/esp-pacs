...
#[doc = "Field `L1_CACHE_CACHESIZE_256` reader - The field is used to configure cachesize of L1-Cache as 256 bytes. This field and all other fields within this register is onehot."]
pub type L1_CACHE_CACHESIZE_256_R = crate::BitReader;
#[doc = "Field `L1_CACHE_CACHESIZE_512` reader - The field is used to configure cachesize of L1-Cache as 512 bytes. This field and all other fields within this register is onehot."]
pub type L1_CACHE_CACHESIZE_512_R = crate::BitReader;
...
#[doc = "Field `L1_CACHE_CACHESIZE_16K` reader - Represents the cache size is 16 KB."]
...
impl R {
    #[doc = "Bit 0 - The field is used to configure cachesize of L1-Cache as 256 bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_256(&self) -> L1_CACHE_CACHESIZE_256_R {
        L1_CACHE_CACHESIZE_256_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The field is used to configure cachesize of L1-Cache as 512 bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_512(&self) -> L1_CACHE_CACHESIZE_512_R {
        L1_CACHE_CACHESIZE_512_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The field is used to configure cachesize of L1-Cache as 1k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_1k(&self) -> L1_CACHE_CACHESIZE_1K_R {
        L1_CACHE_CACHESIZE_1K_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - The field is used to configure cachesize of L1-Cache as 2k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_2k(&self) -> L1_CACHE_CACHESIZE_2K_R {
        L1_CACHE_CACHESIZE_2K_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - The field is used to configure cachesize of L1-Cache as 4k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_4k(&self) -> L1_CACHE_CACHESIZE_4K_R {
        L1_CACHE_CACHESIZE_4K_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - The field is used to configure cachesize of L1-Cache as 8k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_8k(&self) -> L1_CACHE_CACHESIZE_8K_R {
        L1_CACHE_CACHESIZE_8K_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Represents the cache size is 16 KB."]
    #[inline(always)]
    pub fn l1_cache_cachesize_16k(&self) -> L1_CACHE_CACHESIZE_16K_R {
        L1_CACHE_CACHESIZE_16K_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - The field is used to configure cachesize of L1-Cache as 32k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_32k(&self) -> L1_CACHE_CACHESIZE_32K_R {
        L1_CACHE_CACHESIZE_32K_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - The field is used to configure cachesize of L1-Cache as 64k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_64k(&self) -> L1_CACHE_CACHESIZE_64K_R {
        L1_CACHE_CACHESIZE_64K_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - The field is used to configure cachesize of L1-Cache as 128k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_128k(&self) -> L1_CACHE_CACHESIZE_128K_R {
        L1_CACHE_CACHESIZE_128K_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - The field is used to configure cachesize of L1-Cache as 256k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_256k(&self) -> L1_CACHE_CACHESIZE_256K_R {
        L1_CACHE_CACHESIZE_256K_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - The field is used to configure cachesize of L1-Cache as 512k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_512k(&self) -> L1_CACHE_CACHESIZE_512K_R {
        L1_CACHE_CACHESIZE_512K_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - The field is used to configure cachesize of L1-Cache as 1024k bytes. This field and all other fields within this register is onehot."]
    #[inline(always)]
    pub fn l1_cache_cachesize_1024k(&self) -> L1_CACHE_CACHESIZE_1024K_R {
        L1_CACHE_CACHESIZE_1024K_R::new(((self.bits >> 12) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_CACHESIZE_CONF")
            .field("l1_cache_cachesize_256", &self.l1_cache_cachesize_256())
            .field("l1_cache_cachesize_512", &self.l1_cache_cachesize_512())
...
#[doc = "`reset()` method sets L1_CACHE_CACHESIZE_CONF to value 0x40"]
