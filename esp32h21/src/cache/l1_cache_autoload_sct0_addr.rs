...
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT0_ADDR` reader - Configures the starting virtual address of Section 0 for the autoloading operation in the L1 cache. Note that it should be used together with CACHE_L1_CACHE_AUTOLOAD_SCT0_SIZE and CACHE_L1_CACHE_AUTOLOAD_SCT0_ENA."]
pub type L1_CACHE_AUTOLOAD_SCT0_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `L1_CACHE_AUTOLOAD_SCT0_ADDR` writer - Configures the starting virtual address of Section 0 for the autoloading operation in the L1 cache. Note that it should be used together with CACHE_L1_CACHE_AUTOLOAD_SCT0_SIZE and CACHE_L1_CACHE_AUTOLOAD_SCT0_ENA."]
pub type L1_CACHE_AUTOLOAD_SCT0_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the starting virtual address of Section 0 for the autoloading operation in the L1 cache. Note that it should be used together with CACHE_L1_CACHE_AUTOLOAD_SCT0_SIZE and CACHE_L1_CACHE_AUTOLOAD_SCT0_ENA."]
    #[inline(always)]
