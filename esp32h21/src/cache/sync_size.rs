...
#[doc = "Field `SYNC_SIZE` reader - Configures the size for the synchronization operation. This field should be configured together with CACHE_SYNC_ADDR_REG."]
pub type SYNC_SIZE_R = crate::FieldReader<u32>;
#[doc = "Field `SYNC_SIZE` writer - Configures the size for the synchronization operation. This field should be configured together with CACHE_SYNC_ADDR_REG."]
pub type SYNC_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bits 0:23 - Configures the size for the synchronization operation. This field should be configured together with CACHE_SYNC_ADDR_REG."]
    #[inline(always)]
    pub fn sync_size(&self) -> SYNC_SIZE_R {
        SYNC_SIZE_R::new(self.bits & 0x00ff_ffff)
    }
}
...
impl W {
    #[doc = "Bits 0:23 - Configures the size for the synchronization operation. This field should be configured together with CACHE_SYNC_ADDR_REG."]
    #[inline(always)]
    pub fn sync_size(&mut self) -> SYNC_SIZE_W<'_, SYNC_SIZE_SPEC> {
