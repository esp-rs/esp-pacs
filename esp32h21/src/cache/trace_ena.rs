...
#[doc = "Field `L1_CACHE_TRACE_ENA` reader - Configures whether to enable the L1 cache trace for the performance counter and failure tracer.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_TRACE_ENA_R = crate::BitReader;
#[doc = "Field `L1_CACHE_TRACE_ENA` writer - Configures whether to enable the L1 cache trace for the performance counter and failure tracer.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_TRACE_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_CACHE_TRACE_ENA` reader - The bit is used to enable L2-Cache trace for the performance counter and fail tracer"]
pub type L2_CACHE_TRACE_ENA_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Configures whether to enable the L1 cache trace for the performance counter and failure tracer.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
