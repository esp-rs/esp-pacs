...
#[doc = "Field `L1_CACHE_ATOMIC_EN` writer - The bit is used to enable atomic feature on L1-Cache when multiple cores access L1-Cache. 1: disable, 1: enable."]
pub type L1_CACHE_ATOMIC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    #[doc = "Bit 0 - The bit is used to enable atomic feature on L1-Cache when multiple cores access L1-Cache. 1: disable, 1: enable."]
    #[inline(always)]
    pub fn l1_cache_atomic_en(&mut self) -> L1_CACHE_ATOMIC_EN_W<'_, L1_CACHE_ATOMIC_CONF_SPEC> {
        L1_CACHE_ATOMIC_EN_W::new(self, 0)
    }
}
