...
impl R {
    #[doc = "Bits 0:23 - Those bits are used to configure the size of the first section for autoload operation on L1-ICache3. Note that it should be used together with L1_ICACHE3_AUTOLOAD_SCT0_ADDR and L1_ICACHE_AUTOLOAD_SCT0_ENA."]
    #[inline(always)]
    pub fn l1_icache3_autoload_sct0_size(&self) -> L1_ICACHE3_AUTOLOAD_SCT0_SIZE_R {
        L1_ICACHE3_AUTOLOAD_SCT0_SIZE_R::new(self.bits & 0x00ff_ffff)
    }
}
