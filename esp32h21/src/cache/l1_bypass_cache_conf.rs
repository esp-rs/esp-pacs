...
#[doc = "Field `BYPASS_L1_ICACHE2_EN` writer - Reserved"]
pub type BYPASS_L1_ICACHE2_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BYPASS_L1_ICACHE3_EN` reader - Reserved"]
pub type BYPASS_L1_ICACHE3_EN_R = crate::BitReader;
#[doc = "Field `BYPASS_L1_ICACHE3_EN` writer - Reserved"]
pub type BYPASS_L1_ICACHE3_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BYPASS_L1_CACHE_EN` reader - The bit is used to enable bypass L1-Cache. 0: disable bypass, 1: enable bypass."]
pub type BYPASS_L1_CACHE_EN_R = crate::BitReader;
#[doc = "Field `BYPASS_L1_CACHE_EN` writer - The bit is used to enable bypass L1-Cache. 0: disable bypass, 1: enable bypass."]
pub type BYPASS_L1_CACHE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 4 - The bit is used to enable bypass L1-Cache. 0: disable bypass, 1: enable bypass."]
    #[inline(always)]
    pub fn bypass_l1_cache_en(&self) -> BYPASS_L1_CACHE_EN_R {
        BYPASS_L1_CACHE_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_BYPASS_CACHE_CONF")
            ...
            .field("bypass_l1_cache_en", &self.bypass_l1_cache_en())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn bypass_l1_icache2_en(
        &mut self,
    ) -> BYPASS_L1_ICACHE2_EN_W<'_, L1_BYPASS_CACHE_CONF_SPEC> {
        BYPASS_L1_ICACHE2_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Reserved"]
    #[inline(always)]
    pub fn bypass_l1_icache3_en(
        &mut self,
    ) -> BYPASS_L1_ICACHE3_EN_W<'_, L1_BYPASS_CACHE_CONF_SPEC> {
        BYPASS_L1_ICACHE3_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - The bit is used to enable bypass L1-Cache. 0: disable bypass, 1: enable bypass."]
    #[inline(always)]
    pub fn bypass_l1_cache_en(&mut self) -> BYPASS_L1_CACHE_EN_W<'_, L1_BYPASS_CACHE_CONF_SPEC> {
        BYPASS_L1_CACHE_EN_W::new(self, 4)
    }
}
