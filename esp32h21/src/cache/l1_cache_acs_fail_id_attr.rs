...
#[doc = "Field `L1_CACHE_FAIL_ID` reader - Represents the ID of the failed access to the L1 cache.\\\\ Bit 4: BUS0\\\\ Bit 5: BUS1\\\\ Others: reserved\\\\"]
pub type L1_CACHE_FAIL_ID_R = crate::FieldReader<u16>;
#[doc = "Field `L1_CACHE_FAIL_ATTR` reader - Represents the attribute of the failed access to the L1 cache.\\\\ Bit 0: Fetching instructions\\\\ Bit 1: Reading data\\\\ Bit 7: non-cacheable\\\\ Others: reserved\\\\"]
pub type L1_CACHE_FAIL_ATTR_R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:15 - Represents the ID of the failed access to the L1 cache.\\\\ Bit 4: BUS0\\\\ Bit 5: BUS1\\\\ Others: reserved\\\\"]
    #[inline(always)]
    pub fn l1_cache_fail_id(&self) -> L1_CACHE_FAIL_ID_R {
        L1_CACHE_FAIL_ID_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Represents the attribute of the failed access to the L1 cache.\\\\ Bit 0: Fetching instructions\\\\ Bit 1: Reading data\\\\ Bit 7: non-cacheable\\\\ Others: reserved\\\\"]
    #[inline(always)]
