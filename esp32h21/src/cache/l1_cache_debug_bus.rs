...
#[doc = "Field `L1_CACHE_DEBUG_BUS` reader - Configures the data to write to or the data to read from the tag memory or the data memory."]
pub type L1_CACHE_DEBUG_BUS_R = crate::FieldReader<u32>;
#[doc = "Field `L1_CACHE_DEBUG_BUS` writer - Configures the data to write to or the data to read from the tag memory or the data memory."]
pub type L1_CACHE_DEBUG_BUS_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the data to write to or the data to read from the tag memory or the data memory."]
    #[inline(always)]
...
#[doc = "`reset()` method sets L1_CACHE_DEBUG_BUS to value 0x026c"]
