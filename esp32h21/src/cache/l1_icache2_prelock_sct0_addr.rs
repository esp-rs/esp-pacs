...
#[doc = "Field `L1_ICACHE2_PRELOCK_SCT0_ADDR` reader - Those bits are used to configure the start address of the first section of prelock on L1-ICache2, which should be used together with L1_ICACHE2_PRELOCK_SCT0_SIZE_REG"]
