...
#[doc = "Field `L1_CACHE_FAIL_INT_RAW` reader - The raw interrupt status of L1_CACHE_FAIL_INT."]
pub type L1_CACHE_FAIL_INT_RAW_R = crate::BitReader;
#[doc = "Field `L1_CACHE_FAIL_INT_RAW` writer - The raw interrupt status of L1_CACHE_FAIL_INT."]
...
impl R {
    ...
    #[doc = "Bit 4 - The raw interrupt status of L1_CACHE_FAIL_INT."]
    #[inline(always)]
