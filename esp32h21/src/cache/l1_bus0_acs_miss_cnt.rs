...
#[doc = "Field `L1_BUS0_MISS_CNT` reader - Represents the number of misses when BUS0 accesses the L1 cache."]
pub type L1_BUS0_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the number of misses when BUS0 accesses the L1 cache."]
    #[inline(always)]
