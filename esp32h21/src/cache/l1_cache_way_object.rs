...
#[doc = "Field `L1_CACHE_WAY_OBJECT` reader - Configures which way in the tag memory or the data memory to access.\\\\ 0: Way 0\\\\ 1: Way 1\\\\"]
pub type L1_CACHE_WAY_OBJECT_R = crate::FieldReader;
#[doc = "Field `L1_CACHE_WAY_OBJECT` writer - Configures which way in the tag memory or the data memory to access.\\\\ 0: Way 0\\\\ 1: Way 1\\\\"]
pub type L1_CACHE_WAY_OBJECT_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:2 - Configures which way in the tag memory or the data memory to access.\\\\ 0: Way 0\\\\ 1: Way 1\\\\"]
    #[inline(always)]
