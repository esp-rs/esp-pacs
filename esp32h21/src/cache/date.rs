...
#[doc = "Field `DATE` reader - Version control register. Note that the default value is the latest date when the hardware logic was updated."]
pub type DATE_R = crate::FieldReader<u32>;
#[doc = "Field `DATE` writer - Version control register. Note that the default value is the latest date when the hardware logic was updated."]
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    #[doc = "Bits 0:27 - Version control register. Note that the default value is the latest date when the hardware logic was updated."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x0240_8200"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0240_8200;
}
