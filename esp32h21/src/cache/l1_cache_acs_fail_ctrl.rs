...
#[doc = "Field `L1_CACHE_ACS_FAIL_CHECK_MODE` reader - Configures whether to propagate the error that occurs during access to lower-level memory to higher-level access. \\\\ 0: Not propagate\\\\ 1: Propagate\\\\"]
pub type L1_CACHE_ACS_FAIL_CHECK_MODE_R = crate::BitReader;
#[doc = "Field `L1_CACHE_ACS_FAIL_CHECK_MODE` writer - Configures whether to propagate the error that occurs during access to lower-level memory to higher-level access. \\\\ 0: Not propagate\\\\ 1: Propagate\\\\"]
pub type L1_CACHE_ACS_FAIL_CHECK_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 4 - Configures whether to propagate the error that occurs during access to lower-level memory to higher-level access. \\\\ 0: Not propagate\\\\ 1: Propagate\\\\"]
    #[inline(always)]
    pub fn l1_cache_acs_fail_check_mode(&self) -> L1_CACHE_ACS_FAIL_CHECK_MODE_R {
        L1_CACHE_ACS_FAIL_CHECK_MODE_R::new(((self.bits >> 4) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_ACS_FAIL_CTRL")
            ...
            .field(
                "l1_cache_acs_fail_check_mode",
                &self.l1_cache_acs_fail_check_mode(),
            )
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 4 - Configures whether to propagate the error that occurs during access to lower-level memory to higher-level access. \\\\ 0: Not propagate\\\\ 1: Propagate\\\\"]
    #[inline(always)]
    pub fn l1_cache_acs_fail_check_mode(
        &mut self,
    ) -> L1_CACHE_ACS_FAIL_CHECK_MODE_W<'_, L1_CACHE_ACS_FAIL_CTRL_SPEC> {
        L1_CACHE_ACS_FAIL_CHECK_MODE_W::new(self, 4)
    }
}
