...
#[doc = "Field `L1_CACHE_PRELOAD_ENA` reader - Configures whether to enable the preloading operation in the L1 cache. It will be cleared by hardware automatically after the preloading operation is done.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_PRELOAD_ENA_R = crate::BitReader;
#[doc = "Field `L1_CACHE_PRELOAD_ENA` writer - Configures whether to enable the preloading operation in the L1 cache. It will be cleared by hardware automatically after the preloading operation is done.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_PRELOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_PRELOAD_DONE` reader - Represents whether the preloading operation is finished.\\\\ 0: Not finished\\\\ 1: Finished\\\\"]
pub type L1_CACHE_PRELOAD_DONE_R = crate::BitReader;
#[doc = "Field `L1_CACHE_PRELOAD_ORDER` reader - Configures the direction of the preloading operation.\\\\ 0: Ascending\\\\ 1: Descending\\\\"]
pub type L1_CACHE_PRELOAD_ORDER_R = crate::BitReader;
#[doc = "Field `L1_CACHE_PRELOAD_ORDER` writer - Configures the direction of the preloading operation.\\\\ 0: Ascending\\\\ 1: Descending\\\\"]
...
#[doc = "Field `L1_CACHE_PRELOAD_RGID` writer - The bit is used to set the gid of l1 Cache preload."]
pub type L1_CACHE_PRELOAD_RGID_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bit 0 - Configures whether to enable the preloading operation in the L1 cache. It will be cleared by hardware automatically after the preloading operation is done.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_cache_preload_ena(&self) -> L1_CACHE_PRELOAD_ENA_R {
        L1_CACHE_PRELOAD_ENA_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Represents whether the preloading operation is finished.\\\\ 0: Not finished\\\\ 1: Finished\\\\"]
    #[inline(always)]
    pub fn l1_cache_preload_done(&self) -> L1_CACHE_PRELOAD_DONE_R {
        L1_CACHE_PRELOAD_DONE_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Configures the direction of the preloading operation.\\\\ 0: Ascending\\\\ 1: Descending\\\\"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 3:6 - The bit is used to set the gid of l1 Cache preload."]
    #[inline(always)]
    pub fn l1_cache_preload_rgid(
        &mut self,
    ) -> L1_CACHE_PRELOAD_RGID_W<'_, L1_CACHE_PRELOAD_CTRL_SPEC> {
        L1_CACHE_PRELOAD_RGID_W::new(self, 3)
    }
}
