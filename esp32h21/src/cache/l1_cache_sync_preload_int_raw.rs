...
#[doc = "Field `L1_CACHE_PLD_DONE_INT_RAW` reader - The raw interrupt status of L1_CACHE_PLD_DONE_INT."]
pub type L1_CACHE_PLD_DONE_INT_RAW_R = crate::BitReader;
#[doc = "Field `L1_CACHE_PLD_DONE_INT_RAW` writer - The raw interrupt status of L1_CACHE_PLD_DONE_INT."]
pub type L1_CACHE_PLD_DONE_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SYNC_DONE_INT_RAW` reader - The raw interrupt status of CACHE_SYNC_DONE_INT."]
pub type SYNC_DONE_INT_RAW_R = crate::BitReader;
#[doc = "Field `SYNC_DONE_INT_RAW` writer - The raw interrupt status of CACHE_SYNC_DONE_INT."]
...
#[doc = "Field `L1_CACHE_PLD_ERR_INT_RAW` reader - The raw interrupt status of L1_CACHE_PLD_ERR_INT."]
pub type L1_CACHE_PLD_ERR_INT_RAW_R = crate::BitReader;
#[doc = "Field `L1_CACHE_PLD_ERR_INT_RAW` writer - The raw interrupt status of L1_CACHE_PLD_ERR_INT."]
pub type L1_CACHE_PLD_ERR_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SYNC_ERR_INT_RAW` reader - The raw interrupt status of CACHE_SYNC_ERR_INT."]
pub type SYNC_ERR_INT_RAW_R = crate::BitReader;
#[doc = "Field `SYNC_ERR_INT_RAW` writer - The raw interrupt status of CACHE_SYNC_ERR_INT."]
...
impl R {
    ...
    #[doc = "Bit 4 - The raw interrupt status of L1_CACHE_PLD_DONE_INT."]
    #[inline(always)]
    pub fn l1_cache_pld_done_int_raw(&self) -> L1_CACHE_PLD_DONE_INT_RAW_R {
        L1_CACHE_PLD_DONE_INT_RAW_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 6 - The raw interrupt status of CACHE_SYNC_DONE_INT."]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - The raw interrupt status of L1_CACHE_PLD_ERR_INT."]
    #[inline(always)]
    pub fn l1_cache_pld_err_int_raw(&self) -> L1_CACHE_PLD_ERR_INT_RAW_R {
        L1_CACHE_PLD_ERR_INT_RAW_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 13 - The raw interrupt status of CACHE_SYNC_ERR_INT."]
    #[inline(always)]
...
impl W {
    ...
    pub fn sync_done_int_raw(
        &mut self,
    ) -> SYNC_DONE_INT_RAW_W<'_, L1_CACHE_SYNC_PRELOAD_INT_RAW_SPEC> {
    ...
    pub fn sync_err_int_raw(
        &mut self,
    ) -> SYNC_ERR_INT_RAW_W<'_, L1_CACHE_SYNC_PRELOAD_INT_RAW_SPEC> {
