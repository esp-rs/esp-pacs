...
#[doc = "Field `L2_BUS0_OVF_INT_CLR` writer - The bit is used to clear counters overflow interrupt and counters in L2-Cache due to bus0 accesses L2-Cache."]
pub type L2_BUS0_OVF_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_BUS1_OVF_INT_CLR` writer - The bit is used to clear counters overflow interrupt and counters in L2-Cache due to bus1 accesses L2-Cache."]
pub type L2_BUS1_OVF_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_BUS2_OVF_INT_CLR` reader - Reserved"]
pub type L2_BUS2_OVF_INT_CLR_R = crate::BitReader;
#[doc = "Field `L2_BUS3_OVF_INT_CLR` reader - Reserved"]
pub type L2_BUS3_OVF_INT_CLR_R = crate::BitReader;
impl R {
    #[doc = "Bit 10 - Reserved"]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - Reserved"]
    #[inline(always)]
    pub fn l2_bus2_ovf_int_clr(&self) -> L2_BUS2_OVF_INT_CLR_R {
        L2_BUS2_OVF_INT_CLR_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Reserved"]
    #[inline(always)]
    pub fn l2_bus3_ovf_int_clr(&self) -> L2_BUS3_OVF_INT_CLR_R {
        L2_BUS3_OVF_INT_CLR_R::new(((self.bits >> 15) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_CACHE_ACS_CNT_INT_CLR")
            ...
            .field("l2_bus2_ovf_int_clr", &self.l2_bus2_ovf_int_clr())
            .field("l2_bus3_ovf_int_clr", &self.l2_bus3_ovf_int_clr())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    pub fn l2_bus0_ovf_int_clr(
        &mut self,
    ) -> L2_BUS0_OVF_INT_CLR_W<'_, L2_CACHE_ACS_CNT_INT_CLR_SPEC> {
        L2_BUS0_OVF_INT_CLR_W::new(self, 12)
    }
    #[doc = "Bit 13 - The bit is used to clear counters overflow interrupt and counters in L2-Cache due to bus1 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_bus1_ovf_int_clr(
        &mut self,
    ) -> L2_BUS1_OVF_INT_CLR_W<'_, L2_CACHE_ACS_CNT_INT_CLR_SPEC> {
        L2_BUS1_OVF_INT_CLR_W::new(self, 13)
    }
}
