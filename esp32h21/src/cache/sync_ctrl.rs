...
#[doc = "Field `INVALIDATE_ENA` reader - Configures whether to enable the invalidatation operation. It will be cleared by hardware after the operation is done.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type INVALIDATE_ENA_R = crate::BitReader;
#[doc = "Field `INVALIDATE_ENA` writer - Configures whether to enable the invalidatation operation. It will be cleared by hardware after the operation is done.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
...
#[doc = "Field `SYNC_DONE` reader - Represents whether the synchronization operation is finished.\\\\ 0: Not finished\\\\ 1: Finished\\\\"]
...
impl R {
    #[doc = "Bit 0 - Configures whether to enable the invalidatation operation. It will be cleared by hardware after the operation is done.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Represents whether the synchronization operation is finished.\\\\ 0: Not finished\\\\ 1: Finished\\\\"]
    #[inline(always)]
