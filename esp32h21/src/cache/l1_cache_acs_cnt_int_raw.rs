...
#[doc = "Field `L1_BUS0_OVF_INT_RAW` reader - The raw interrupt status of L1_BUS0_OVF_INT."]
pub type L1_BUS0_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `L1_BUS0_OVF_INT_RAW` writer - The raw interrupt status of L1_BUS0_OVF_INT."]
pub type L1_BUS0_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_BUS1_OVF_INT_RAW` reader - The raw interrupt status of L1_BUS1_OVF_INT."]
pub type L1_BUS1_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `L1_BUS1_OVF_INT_RAW` writer - The raw interrupt status of L1_BUS1_OVF_INT."]
pub type L1_BUS1_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_BUS2_OVF_INT_RAW` reader - The raw bit of the interrupt of one of counters overflow that occurs in L1-Cache due to bus2 accesses L1-Cache."]
pub type L1_BUS2_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `L1_BUS2_OVF_INT_RAW` writer - The raw bit of the interrupt of one of counters overflow that occurs in L1-Cache due to bus2 accesses L1-Cache."]
pub type L1_BUS2_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_BUS3_OVF_INT_RAW` reader - The raw bit of the interrupt of one of counters overflow that occurs in L1-Cache due to bus3 accesses L1-Cache."]
pub type L1_BUS3_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `L1_BUS3_OVF_INT_RAW` writer - The raw bit of the interrupt of one of counters overflow that occurs in L1-Cache due to bus3 accesses L1-Cache."]
pub type L1_BUS3_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 4 - The raw interrupt status of L1_BUS0_OVF_INT."]
    #[inline(always)]
    pub fn l1_bus0_ovf_int_raw(&self) -> L1_BUS0_OVF_INT_RAW_R {
        L1_BUS0_OVF_INT_RAW_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - The raw interrupt status of L1_BUS1_OVF_INT."]
    #[inline(always)]
    pub fn l1_bus1_ovf_int_raw(&self) -> L1_BUS1_OVF_INT_RAW_R {
        L1_BUS1_OVF_INT_RAW_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - The raw bit of the interrupt of one of counters overflow that occurs in L1-Cache due to bus2 accesses L1-Cache."]
    #[inline(always)]
    pub fn l1_bus2_ovf_int_raw(&self) -> L1_BUS2_OVF_INT_RAW_R {
        L1_BUS2_OVF_INT_RAW_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - The raw bit of the interrupt of one of counters overflow that occurs in L1-Cache due to bus3 accesses L1-Cache."]
    #[inline(always)]
    pub fn l1_bus3_ovf_int_raw(&self) -> L1_BUS3_OVF_INT_RAW_R {
        L1_BUS3_OVF_INT_RAW_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_ACS_CNT_INT_RAW")
            ...
            .field("l1_bus2_ovf_int_raw", &self.l1_bus2_ovf_int_raw())
            .field("l1_bus3_ovf_int_raw", &self.l1_bus3_ovf_int_raw())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 6 - The raw bit of the interrupt of one of counters overflow that occurs in L1-Cache due to bus2 accesses L1-Cache."]
    #[inline(always)]
    pub fn l1_bus2_ovf_int_raw(
        &mut self,
    ) -> L1_BUS2_OVF_INT_RAW_W<'_, L1_CACHE_ACS_CNT_INT_RAW_SPEC> {
        L1_BUS2_OVF_INT_RAW_W::new(self, 6)
    }
    #[doc = "Bit 7 - The raw bit of the interrupt of one of counters overflow that occurs in L1-Cache due to bus3 accesses L1-Cache."]
    #[inline(always)]
    pub fn l1_bus3_ovf_int_raw(
        &mut self,
    ) -> L1_BUS3_OVF_INT_RAW_W<'_, L1_CACHE_ACS_CNT_INT_RAW_SPEC> {
        L1_BUS3_OVF_INT_RAW_W::new(self, 7)
    }
}
