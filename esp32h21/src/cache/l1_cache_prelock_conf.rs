...
#[doc = "Field `L1_CACHE_PRELOCK_SCT0_EN` reader - Configures whether to enable the prelocking function in Section 0 of the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_PRELOCK_SCT0_EN_R = crate::BitReader;
#[doc = "Field `L1_CACHE_PRELOCK_SCT0_EN` writer - Configures whether to enable the prelocking function in Section 0 of the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_PRELOCK_SCT0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_PRELOCK_SCT1_EN` reader - Configures whether to enable the prelocking function in Section 1 of the L1 cache. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_PRELOCK_SCT1_EN_R = crate::BitReader;
#[doc = "Field `L1_CACHE_PRELOCK_SCT1_EN` writer - Configures whether to enable the prelocking function in Section 1 of the L1 cache. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
...
#[doc = "Field `L1_CACHE_PRELOCK_RGID` writer - The bit is used to set the gid of l1 Cache prelock."]
pub type L1_CACHE_PRELOCK_RGID_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bit 0 - Configures whether to enable the prelocking function in Section 0 of the L1 cache.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_cache_prelock_sct0_en(&self) -> L1_CACHE_PRELOCK_SCT0_EN_R {
        L1_CACHE_PRELOCK_SCT0_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures whether to enable the prelocking function in Section 1 of the L1 cache. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 2:5 - The bit is used to set the gid of l1 Cache prelock."]
    #[inline(always)]
    pub fn l1_cache_prelock_rgid(
        &mut self,
    ) -> L1_CACHE_PRELOCK_RGID_W<'_, L1_CACHE_PRELOCK_CONF_SPEC> {
        L1_CACHE_PRELOCK_RGID_W::new(self, 2)
    }
}
