...
#[doc = "Field `L1_CACHE_PLD_DONE_INT_ST` reader - The masked interrupt status of L1_CACHE_PLD_DONE_INT."]
pub type L1_CACHE_PLD_DONE_INT_ST_R = crate::BitReader;
#[doc = "Field `SYNC_DONE_INT_ST` reader - The masked interrupt status of CACHE_SYNC_DONE_INT."]
...
#[doc = "Field `L1_CACHE_PLD_ERR_INT_ST` reader - The masked interrupt status of L1_CACHE_PLD_ERR_INT."]
pub type L1_CACHE_PLD_ERR_INT_ST_R = crate::BitReader;
#[doc = "Field `SYNC_ERR_INT_ST` reader - The masked interrupt status of CACHE_SYNC_ERR_INT."]
...
impl R {
    ...
    #[doc = "Bit 4 - The masked interrupt status of L1_CACHE_PLD_DONE_INT."]
    #[inline(always)]
    pub fn l1_cache_pld_done_int_st(&self) -> L1_CACHE_PLD_DONE_INT_ST_R {
        L1_CACHE_PLD_DONE_INT_ST_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 6 - The masked interrupt status of CACHE_SYNC_DONE_INT."]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - The masked interrupt status of L1_CACHE_PLD_ERR_INT."]
    #[inline(always)]
    pub fn l1_cache_pld_err_int_st(&self) -> L1_CACHE_PLD_ERR_INT_ST_R {
        L1_CACHE_PLD_ERR_INT_ST_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 13 - The masked interrupt status of CACHE_SYNC_ERR_INT."]
    #[inline(always)]
