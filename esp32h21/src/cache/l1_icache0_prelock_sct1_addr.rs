...
#[doc = "Field `L1_ICACHE0_PRELOCK_SCT1_ADDR` reader - Those bits are used to configure the start address of the second section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT1_SIZE_REG"]
pub type L1_ICACHE0_PRELOCK_SCT1_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `L1_ICACHE0_PRELOCK_SCT1_ADDR` writer - Those bits are used to configure the start address of the second section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT1_SIZE_REG"]
