...
#[doc = "Field `L1_CACHE_FAIL_INT_ENA` reader - Write 1 to enable L1_CACHE_FAIL_INT."]
pub type L1_CACHE_FAIL_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_CACHE_FAIL_INT_ENA` writer - Write 1 to enable L1_CACHE_FAIL_INT."]
...
impl R {
    ...
    #[doc = "Bit 4 - Write 1 to enable L1_CACHE_FAIL_INT."]
    #[inline(always)]
