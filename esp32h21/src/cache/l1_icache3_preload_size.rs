...
pub type L1_ICACHE3_PRELOAD_SIZE_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:23 - Those bits are used to configure the size of the first section of prelock on L1-ICache3, which should be used together with L1_ICACHE3_PRELOAD_ADDR_REG"]
    #[inline(always)]
    pub fn l1_icache3_preload_size(&self) -> L1_ICACHE3_PRELOAD_SIZE_R {
        L1_ICACHE3_PRELOAD_SIZE_R::new(self.bits & 0x00ff_ffff)
    }
}
