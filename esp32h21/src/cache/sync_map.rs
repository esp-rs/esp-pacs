...
#[doc = "Field `SYNC_MAP` reader - Configures which caches in the two-level cache structure will apply the sync operation. \\\\ Bit 4: Write 1 to this bit to select the L1 cache\\\\ Other bits: Reserved\\\\"]
pub type SYNC_MAP_R = crate::FieldReader;
#[doc = "Field `SYNC_MAP` writer - Configures which caches in the two-level cache structure will apply the sync operation. \\\\ Bit 4: Write 1 to this bit to select the L1 cache\\\\ Other bits: Reserved\\\\"]
pub type SYNC_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - Configures which caches in the two-level cache structure will apply the sync operation. \\\\ Bit 4: Write 1 to this bit to select the L1 cache\\\\ Other bits: Reserved\\\\"]
    #[inline(always)]
