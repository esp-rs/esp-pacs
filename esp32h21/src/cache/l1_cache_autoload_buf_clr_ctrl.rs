...
#[doc = "Field `L1_CACHE_ALD_BUF_CLR` reader - Configures whether to clear the autoloading buffer inside the L1 cache. \\\\ 0: Not clear the buffer. Recommended when autoloading of L1 cache is used.\\\\ 1: Clear the buffer. Once set, autoloading of L1 cache will stop working. \\\\"]
pub type L1_CACHE_ALD_BUF_CLR_R = crate::BitReader;
#[doc = "Field `L1_CACHE_ALD_BUF_CLR` writer - Configures whether to clear the autoloading buffer inside the L1 cache. \\\\ 0: Not clear the buffer. Recommended when autoloading of L1 cache is used.\\\\ 1: Clear the buffer. Once set, autoloading of L1 cache will stop working. \\\\"]
...
impl R {
    ...
    #[doc = "Bit 4 - Configures whether to clear the autoloading buffer inside the L1 cache. \\\\ 0: Not clear the buffer. Recommended when autoloading of L1 cache is used.\\\\ 1: Clear the buffer. Once set, autoloading of L1 cache will stop working. \\\\"]
    #[inline(always)]
