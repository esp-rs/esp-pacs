...
#[doc = "Field `L2_BUS0_OVF_INT_RAW` reader - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
pub type L2_BUS0_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `L2_BUS0_OVF_INT_RAW` writer - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
pub type L2_BUS0_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_BUS1_OVF_INT_RAW` reader - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
pub type L2_BUS1_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `L2_BUS1_OVF_INT_RAW` writer - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
pub type L2_BUS1_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_BUS2_OVF_INT_RAW` reader - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus2 accesses L2-Cache."]
pub type L2_BUS2_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `L2_BUS2_OVF_INT_RAW` writer - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus2 accesses L2-Cache."]
pub type L2_BUS2_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L2_BUS3_OVF_INT_RAW` reader - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus3 accesses L2-Cache."]
pub type L2_BUS3_OVF_INT_RAW_R = crate::BitReader;
#[doc = "Field `L2_BUS3_OVF_INT_RAW` writer - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus3 accesses L2-Cache."]
pub type L2_BUS3_OVF_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 12 - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_bus0_ovf_int_raw(&self) -> L2_BUS0_OVF_INT_RAW_R {
        L2_BUS0_OVF_INT_RAW_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_bus1_ovf_int_raw(&self) -> L2_BUS1_OVF_INT_RAW_R {
        L2_BUS1_OVF_INT_RAW_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus2 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_bus2_ovf_int_raw(&self) -> L2_BUS2_OVF_INT_RAW_R {
        L2_BUS2_OVF_INT_RAW_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus3 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_bus3_ovf_int_raw(&self) -> L2_BUS3_OVF_INT_RAW_R {
        L2_BUS3_OVF_INT_RAW_R::new(((self.bits >> 15) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_CACHE_ACS_CNT_INT_RAW")
            ...
            .field("l2_bus0_ovf_int_raw", &self.l2_bus0_ovf_int_raw())
            .field("l2_bus1_ovf_int_raw", &self.l2_bus1_ovf_int_raw())
            .field("l2_bus2_ovf_int_raw", &self.l2_bus2_ovf_int_raw())
            .field("l2_bus3_ovf_int_raw", &self.l2_bus3_ovf_int_raw())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 12 - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_bus0_ovf_int_raw(
        &mut self,
    ) -> L2_BUS0_OVF_INT_RAW_W<'_, L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
        L2_BUS0_OVF_INT_RAW_W::new(self, 12)
    }
    #[doc = "Bit 13 - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_bus1_ovf_int_raw(
        &mut self,
    ) -> L2_BUS1_OVF_INT_RAW_W<'_, L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
        L2_BUS1_OVF_INT_RAW_W::new(self, 13)
    }
    #[doc = "Bit 14 - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus2 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_bus2_ovf_int_raw(
        &mut self,
    ) -> L2_BUS2_OVF_INT_RAW_W<'_, L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
        L2_BUS2_OVF_INT_RAW_W::new(self, 14)
    }
    #[doc = "Bit 15 - The raw bit of the interrupt of one of counters overflow that occurs in L2-Cache due to bus3 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_bus3_ovf_int_raw(
        &mut self,
    ) -> L2_BUS3_OVF_INT_RAW_W<'_, L2_CACHE_ACS_CNT_INT_RAW_SPEC> {
        L2_BUS3_OVF_INT_RAW_W::new(self, 15)
    }
}
