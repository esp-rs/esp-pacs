...
#[doc = "Field `L1_CACHE_FREEZE_EN` reader - Configures whether to enable freeze operation in the L1 cache. It can be cleared by software.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_FREEZE_EN_R = crate::BitReader;
#[doc = "Field `L1_CACHE_FREEZE_EN` writer - Configures whether to enable freeze operation in the L1 cache. It can be cleared by software.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type L1_CACHE_FREEZE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_FREEZE_MODE` reader - Configures the freeze mode in the L1 cache.\\\\ 0: If a read hits, the data is returned; if a write hits, the cache is updated; if a miss occurs, the access is not responded to.\\\\ 1: All accesses are responded to directly; for reads, zero is returned, and for writes, the cache is not updated.\\\\"]
pub type L1_CACHE_FREEZE_MODE_R = crate::BitReader;
#[doc = "Field `L1_CACHE_FREEZE_MODE` writer - Configures the freeze mode in the L1 cache.\\\\ 0: If a read hits, the data is returned; if a write hits, the cache is updated; if a miss occurs, the access is not responded to.\\\\ 1: All accesses are responded to directly; for reads, zero is returned, and for writes, the cache is not updated.\\\\"]
pub type L1_CACHE_FREEZE_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_CACHE_FREEZE_DONE` reader - Represents whether the freeze operation in L1 cache is finished.\\\\ 0: Not finished\\\\ 1: Finished\\\\"]
...
impl R {
    ...
    #[doc = "Bit 16 - Configures whether to enable freeze operation in the L1 cache. It can be cleared by software.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_cache_freeze_en(&self) -> L1_CACHE_FREEZE_EN_R {
        L1_CACHE_FREEZE_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Configures the freeze mode in the L1 cache.\\\\ 0: If a read hits, the data is returned; if a write hits, the cache is updated; if a miss occurs, the access is not responded to.\\\\ 1: All accesses are responded to directly; for reads, zero is returned, and for writes, the cache is not updated.\\\\"]
    #[inline(always)]
    pub fn l1_cache_freeze_mode(&self) -> L1_CACHE_FREEZE_MODE_R {
        L1_CACHE_FREEZE_MODE_R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - Represents whether the freeze operation in L1 cache is finished.\\\\ 0: Not finished\\\\ 1: Finished\\\\"]
    #[inline(always)]
