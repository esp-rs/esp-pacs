...
#[doc = "Field `L2_BUS0_OVF_INT_ENA` reader - The bit is used to enable interrupt of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
pub type L2_BUS0_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L2_BUS1_OVF_INT_ENA` reader - The bit is used to enable interrupt of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
pub type L2_BUS1_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L2_BUS2_OVF_INT_ENA` reader - Reserved"]
pub type L2_BUS2_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L2_BUS3_OVF_INT_ENA` reader - Reserved"]
pub type L2_BUS3_OVF_INT_ENA_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn l2_bus0_ovf_int_ena(&self) -> L2_BUS0_OVF_INT_ENA_R {
        L2_BUS0_OVF_INT_ENA_R::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn l2_bus1_ovf_int_ena(&self) -> L2_BUS1_OVF_INT_ENA_R {
        L2_BUS1_OVF_INT_ENA_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Reserved"]
    #[inline(always)]
    pub fn l2_bus2_ovf_int_ena(&self) -> L2_BUS2_OVF_INT_ENA_R {
        L2_BUS2_OVF_INT_ENA_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Reserved"]
    #[inline(always)]
    pub fn l2_bus3_ovf_int_ena(&self) -> L2_BUS3_OVF_INT_ENA_R {
        L2_BUS3_OVF_INT_ENA_R::new(((self.bits >> 15) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_CACHE_ACS_CNT_INT_ENA")
            ...
            .field("l2_bus0_ovf_int_ena", &self.l2_bus0_ovf_int_ena())
            .field("l2_bus1_ovf_int_ena", &self.l2_bus1_ovf_int_ena())
            .field("l2_bus2_ovf_int_ena", &self.l2_bus2_ovf_int_ena())
            .field("l2_bus3_ovf_int_ena", &self.l2_bus3_ovf_int_ena())
            .finish()
    }
}
impl W {
    ...
    pub fn l2_ibus0_ovf_int_ena(
        &mut self,
    ) -> L2_IBUS0_OVF_INT_ENA_W<'_, L2_CACHE_ACS_CNT_INT_ENA_SPEC> {
    ...
    pub fn l2_ibus1_ovf_int_ena(
        &mut self,
    ) -> L2_IBUS1_OVF_INT_ENA_W<'_, L2_CACHE_ACS_CNT_INT_ENA_SPEC> {
        L2_IBUS1_OVF_INT_ENA_W::new(self, 9)
    }
}
#[doc = "Cache Access Counter Interrupt enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`l2_cache_acs_cnt_int_ena::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l2_cache_acs_cnt_int_ena::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
