...
#[doc = "Field `L1_CACHE_PLD_ERR_CODE` reader - Represents the error code for the failed preloading operation.\\\\ 2: The preloading size in the L1 cache is wrong\\\\ Other values: reserved\\\\"]
pub type L1_CACHE_PLD_ERR_CODE_R = crate::FieldReader;
#[doc = "Field `SYNC_ERR_CODE` reader - Represents the error code for the failed synchronization operation.\\\\ 0: Incorrect synchronization map\\\\ 1: Synchronization command conflict\\\\ 2: Incorrect synchronization size\\\\ 3: Reserved\\\\"]
...
impl R {
    ...
    #[doc = "Bits 8:9 - Represents the error code for the failed preloading operation.\\\\ 2: The preloading size in the L1 cache is wrong\\\\ Other values: reserved\\\\"]
    #[inline(always)]
    pub fn l1_cache_pld_err_code(&self) -> L1_CACHE_PLD_ERR_CODE_R {
        L1_CACHE_PLD_ERR_CODE_R::new(((self.bits >> 8) & 3) as u8)
    }
    #[doc = "Bits 12:13 - Represents the error code for the failed synchronization operation.\\\\ 0: Incorrect synchronization map\\\\ 1: Synchronization command conflict\\\\ 2: Incorrect synchronization size\\\\ 3: Reserved\\\\"]
    #[inline(always)]
