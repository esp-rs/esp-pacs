...
#[doc = "Field `L1_CACHE_SYNC_RST` reader - Configures whether to reset the synchronization logic inside the L1 cache.\\\\ 0: Not reset\\\\ 1: Reset\\\\ It is recommended that this field should only be used when a fatal error of the synchronization logic occurs. \\\\"]
pub type L1_CACHE_SYNC_RST_R = crate::BitReader;
#[doc = "Field `L1_CACHE_SYNC_RST` writer - Configures whether to reset the synchronization logic inside the L1 cache.\\\\ 0: Not reset\\\\ 1: Reset\\\\ It is recommended that this field should only be used when a fatal error of the synchronization logic occurs. \\\\"]
...
impl R {
    ...
    #[doc = "Bit 4 - Configures whether to reset the synchronization logic inside the L1 cache.\\\\ 0: Not reset\\\\ 1: Reset\\\\ It is recommended that this field should only be used when a fatal error of the synchronization logic occurs. \\\\"]
    #[inline(always)]
