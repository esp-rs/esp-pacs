...
#[doc = "Field `T(0-0)` reader - The interrupt enable bit for the TIMG_T%s_INT interrupt."]
pub type T_R = crate::BitReader;
#[doc = "Field `T(0-0)` writer - The interrupt enable bit for the TIMG_T%s_INT interrupt."]
...
impl R {
    #[doc = "The interrupt enable bit for the TIMG_T(0-0)_INT interrupt."]
    #[doc = ""]
