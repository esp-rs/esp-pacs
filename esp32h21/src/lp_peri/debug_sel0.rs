...
impl W {
    #[doc = "Bits 0:6 - need des"]
    #[inline(always)]
    pub fn debug_sel0(&mut self) -> DEBUG_SEL0_W<'_, DEBUG_SEL0_SPEC> {
        DEBUG_SEL0_W::new(self, 0)
    }
    #[doc = "Bits 7:13 - need des"]
    #[inline(always)]
    pub fn debug_sel1(&mut self) -> DEBUG_SEL1_W<'_, DEBUG_SEL0_SPEC> {
        DEBUG_SEL1_W::new(self, 7)
    }
    #[doc = "Bits 14:20 - need des"]
    #[inline(always)]
    pub fn debug_sel2(&mut self) -> DEBUG_SEL2_W<'_, DEBUG_SEL0_SPEC> {
        DEBUG_SEL2_W::new(self, 14)
    }
    #[doc = "Bits 21:27 - need des"]
    #[inline(always)]
    pub fn debug_sel3(&mut self) -> DEBUG_SEL3_W<'_, DEBUG_SEL0_SPEC> {
