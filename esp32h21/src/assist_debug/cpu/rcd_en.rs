...
#[doc = "Field `RCD_RECORDEN` reader - Set 1 to enable record PC"]
pub type RCD_RECORDEN_R = crate::BitReader;
#[doc = "Field `RCD_RECORDEN` writer - Set 1 to enable record PC"]
pub type RCD_RECORDEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RCD_PDEBUGEN` reader - Set 1 to enable cpu pdebug function, must set this bit can get cpu PC"]
pub type RCD_PDEBUGEN_R = crate::BitReader;
#[doc = "Field `RCD_PDEBUGEN` writer - Set 1 to enable cpu pdebug function, must set this bit can get cpu PC"]
