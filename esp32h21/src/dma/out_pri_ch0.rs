...
pub type R = crate::R<OUT_PRI_CH0_SPEC>;
#[doc = "Register `OUT_PRI_CH0` writer"]
pub type W = crate::W<OUT_PRI_CH0_SPEC>;
...
impl W {
    #[doc = "Bits 0:3 - The priority of Tx channel 0. The larger of the value the higher of the priority."]
    #[inline(always)]
    pub fn tx_pri_ch0(&mut self) -> TX_PRI_CH0_W<'_, OUT_PRI_CH0_SPEC> {
        TX_PRI_CH0_W::new(self, 0)
    }
}
#[doc = "Priority register of Tx channel 0.\n\nYou can [`read`](crate::Reg::read) this register and get [`out_pri_ch0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`out_pri_ch0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
