...
impl W {
    ...
    #[doc = "Bit 4 - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is overflow."]
    #[inline(always)]
    pub fn outfifo_ovf_ch_int_raw(&mut self) -> OUTFIFO_OVF_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
        OUTFIFO_OVF_CH_INT_RAW_W::new(self, 4)
    }
    #[doc = "Bit 5 - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is underflow."]
    #[inline(always)]
    pub fn outfifo_udf_ch_int_raw(&mut self) -> OUTFIFO_UDF_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
