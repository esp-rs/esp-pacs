...
pub type INLINK_ADDR_CH_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_LINK_CH")
            .field("inlink_addr_ch", &self.inlink_addr_ch())
...
impl W {
    #[doc = "Bits 0:19 - This register stores the 20 least significant bits of the first inlink descriptor's address."]
    #[inline(always)]
    pub fn inlink_addr_ch(&mut self) -> INLINK_ADDR_CH_W<'_, IN_LINK_CH_SPEC> {
