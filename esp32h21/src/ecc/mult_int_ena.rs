...
#[doc = "Field `MULT_CALC_DONE_INT_ENA` reader - Write 1 to enable the ECC_CALC_DONE_INT interrupt."]
pub type MULT_CALC_DONE_INT_ENA_R = crate::BitReader;
#[doc = "Field `MULT_CALC_DONE_INT_ENA` writer - Write 1 to enable the ECC_CALC_DONE_INT interrupt."]
pub type MULT_CALC_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Write 1 to enable the ECC_CALC_DONE_INT interrupt."]
    #[inline(always)]
    pub fn mult_calc_done_int_ena(&self) -> MULT_CALC_DONE_INT_ENA_R {
        MULT_CALC_DONE_INT_ENA_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MULT_INT_ENA")
            .field("mult_calc_done_int_ena", &self.mult_calc_done_int_ena())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - Write 1 to enable the ECC_CALC_DONE_INT interrupt."]
    #[inline(always)]
    pub fn mult_calc_done_int_ena(&mut self) -> MULT_CALC_DONE_INT_ENA_W<'_, MULT_INT_ENA_SPEC> {
        MULT_CALC_DONE_INT_ENA_W::new(self, 0)
    }
}
