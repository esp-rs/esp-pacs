...
#[doc = "Field `MULT_KEY_LENGTH` reader - Configures the key length mode bit of ECC Accelerator. \\\\ 0: P-192\\\\ 1: P-256\\\\"]
pub type MULT_KEY_LENGTH_R = crate::BitReader;
#[doc = "Field `MULT_KEY_LENGTH` writer - Configures the key length mode bit of ECC Accelerator. \\\\ 0: P-192\\\\ 1: P-256\\\\"]
pub type MULT_KEY_LENGTH_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn mult_key_length(&self) -> MULT_KEY_LENGTH_R {
        MULT_KEY_LENGTH_R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    pub fn mult_mod_base(&self) -> MULT_MOD_BASE_R {
        MULT_MOD_BASE_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn mult_work_mode(&self) -> MULT_WORK_MODE_R {
        MULT_WORK_MODE_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
    ...
    pub fn mult_security_mode(&self) -> MULT_SECURITY_MODE_R {
        MULT_SECURITY_MODE_R::new(((self.bits >> 8) & 1) != 0)
    }
