...
#[doc = "Field `MULT_CALC_DONE_INT_ST` reader - The masked interrupt status of the ECC_CALC_DONE_INT interrupt."]
pub type MULT_CALC_DONE_INT_ST_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - The masked interrupt status of the ECC_CALC_DONE_INT interrupt."]
    #[inline(always)]
    pub fn mult_calc_done_int_st(&self) -> MULT_CALC_DONE_INT_ST_R {
        MULT_CALC_DONE_INT_ST_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MULT_INT_ST")
            .field("mult_calc_done_int_st", &self.mult_calc_done_int_st())
            .finish()
    }
}
