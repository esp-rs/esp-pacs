...
#[doc = "Field `_32K_SEL` reader - This field indicates which one 32KHz clock will be used by timergroup. 1: XTAL32K (default), 2/3: 32KHz from pad GPIO0."]
pub type _32K_SEL_R = crate::FieldReader;
#[doc = "Field `_32K_SEL` writer - This field indicates which one 32KHz clock will be used by timergroup. 1: XTAL32K (default), 2/3: 32KHz from pad GPIO0."]
pub type _32K_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `_32K_MODEM_SEL` reader - This field indicates which one 32KHz clock will be used by MODEM_SYSTEM. 1: XTAL32K(default), 2/3: 32KHz from pad GPIO0."]
pub type _32K_MODEM_SEL_R = crate::FieldReader;
#[doc = "Field `_32K_MODEM_SEL` writer - This field indicates which one 32KHz clock will be used by MODEM_SYSTEM. 1: XTAL32K(default), 2/3: 32KHz from pad GPIO0."]
pub type _32K_MODEM_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 0:1 - This field indicates which one 32KHz clock will be used by timergroup. 1: XTAL32K (default), 2/3: 32KHz from pad GPIO0."]
    #[inline(always)]
    pub fn _32k_sel(&self) -> _32K_SEL_R {
        _32K_SEL_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 2:3 - This field indicates which one 32KHz clock will be used by MODEM_SYSTEM. 1: XTAL32K(default), 2/3: 32KHz from pad GPIO0."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:1 - This field indicates which one 32KHz clock will be used by timergroup. 1: XTAL32K (default), 2/3: 32KHz from pad GPIO0."]
    #[inline(always)]
    pub fn _32k_sel(&mut self) -> _32K_SEL_W<'_, CTRL_32K_CONF_SPEC> {
        _32K_SEL_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - This field indicates which one 32KHz clock will be used by MODEM_SYSTEM. 1: XTAL32K(default), 2/3: 32KHz from pad GPIO0."]
    #[inline(always)]
    pub fn _32k_modem_sel(&mut self) -> _32K_MODEM_SEL_W<'_, CTRL_32K_CONF_SPEC> {
...
#[doc = "`reset()` method sets CTRL_32K_CONF to value 0x05"]
