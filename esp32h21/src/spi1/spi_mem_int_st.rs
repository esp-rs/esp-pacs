...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_INT_ST")
            .field("spi_mem_per_end_int_st", &self.spi_mem_per_end_int_st())
            .field("spi_mem_pes_end_int_st", &self.spi_mem_pes_end_int_st())
            .field("spi_mem_wpe_end_int_st", &self.spi_mem_wpe_end_int_st())
            .field(
            ...
            .field("spi_mem_brown_out_int_st", &self.spi_mem_brown_out_int_st())
            .finish()
    }
}
