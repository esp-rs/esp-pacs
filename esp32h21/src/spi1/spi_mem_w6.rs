...
pub type R = crate::R<SPI_MEM_W6_SPEC>;
#[doc = "Register `SPI_MEM_W6` writer"]
pub type W = crate::W<SPI_MEM_W6_SPEC>;
...
pub type SPI_MEM_BUF6_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_W6")
            .field("spi_mem_buf6", &self.spi_mem_buf6())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn spi_mem_buf6(&mut self) -> SPI_MEM_BUF6_W<'_, SPI_MEM_W6_SPEC> {
        SPI_MEM_BUF6_W::new(self, 0)
    }
}
#[doc = "SPI1 memory data buffer6\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_w6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_w6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
