...
impl W {
    ...
    pub fn spi_mem_per_end_int_clr(
        &mut self,
    ) -> SPI_MEM_PER_END_INT_CLR_W<'_, SPI_MEM_INT_CLR_SPEC> {
    ...
    pub fn spi_mem_pes_end_int_clr(
        &mut self,
    ) -> SPI_MEM_PES_END_INT_CLR_W<'_, SPI_MEM_INT_CLR_SPEC> {
    ...
    pub fn spi_mem_wpe_end_int_clr(
        &mut self,
    ) -> SPI_MEM_WPE_END_INT_CLR_W<'_, SPI_MEM_INT_CLR_SPEC> {
    ...
    pub fn spi_mem_brown_out_int_clr(
        &mut self,
    ) -> SPI_MEM_BROWN_OUT_INT_CLR_W<'_, SPI_MEM_INT_CLR_SPEC> {
