#[doc = "Register `IO_MUX_GPIO4` reader"]
pub type R = crate::R<IO_MUX_GPIO4_SPEC>;
#[doc = "Register `IO_MUX_GPIO4` writer"]
pub type W = crate::W<IO_MUX_GPIO4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn register(&mut self) -> REGISTER_W<IO_MUX_GPIO4_SPEC, 0> {
        REGISTER_W::new(self)
    }
    #[doc = "Bit 0 - configures output enable during sleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn sleep_enable(&mut self) -> SLEEP_ENABLE_W<IO_MUX_GPIO4_SPEC, 0> {
        SLEEP_ENABLE_W::new(self)
    }
    #[doc = "Bit 3 - configures pull up during sleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn sleep_pullup(&mut self) -> SLEEP_PULLUP_W<IO_MUX_GPIO4_SPEC, 3> {
        SLEEP_PULLUP_W::new(self)
    }
    #[doc = "Bits 4:5 - configures IO_MUX function, bottom 2 bits"]
    #[inline(always)]
    #[must_use]
    pub fn function_select_low_bits(&mut self) -> FUNCTION_SELECT_LOW_BITS_W<IO_MUX_GPIO4_SPEC, 4> {
        FUNCTION_SELECT_LOW_BITS_W::new(self)
    }
    #[doc = "Bit 7 - configures pull up"]
    #[inline(always)]
    #[must_use]
    pub fn pullup(&mut self) -> PULLUP_W<IO_MUX_GPIO4_SPEC, 7> {
        PULLUP_W::new(self)
    }
    #[doc = "Bit 8 - configures IO_MUX function, upper bit"]
    #[inline(always)]
    #[must_use]
    pub fn function_select_high_bit(&mut self) -> FUNCTION_SELECT_HIGH_BIT_W<IO_MUX_GPIO4_SPEC, 8> {
...
pub struct IO_MUX_GPIO4_SPEC;
impl crate::RegisterSpec for IO_MUX_GPIO4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`io_mux_gpio4::R`](R) reader structure"]
impl crate::Readable for IO_MUX_GPIO4_SPEC {}
#[doc = "`write(|w| ..)` method takes [`io_mux_gpio4::W`](W) writer structure"]
impl crate::Writable for IO_MUX_GPIO4_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IO_MUX_GPIO4 to value 0"]
impl crate::Resettable for IO_MUX_GPIO4_SPEC {
