...
pub type REGISTER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IO_MUX_MTMS_SPEC, u32, u32, 32, O>;
...
pub type SLEEP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IO_MUX_MTMS_SPEC, bool, O>;
...
pub type SLEEP_PULLUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, IO_MUX_MTMS_SPEC, bool, O>;
...
pub type FUNCTION_SELECT_LOW_BITS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IO_MUX_MTMS_SPEC, u8, u8, 2, O>;
...
pub type PULLUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, IO_MUX_MTMS_SPEC, bool, O>;
...
pub type FUNCTION_SELECT_HIGH_BIT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, IO_MUX_MTMS_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
