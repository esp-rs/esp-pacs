...
pub type REGISTER_W<'a, const O: u8> = crate::FieldWriter<'a, IO_MUX_SD_CMD_SPEC, 32, O, u32, u32>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<IO_MUX_SD_CMD_SPEC> {
