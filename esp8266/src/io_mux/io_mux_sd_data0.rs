...
pub struct R(crate::R<IO_MUX_SD_DATA0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IO_MUX_SD_DATA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IO_MUX_SD_DATA0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IO_MUX_SD_DATA0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IO_MUX_SD_DATA0` writer"]
pub struct W(crate::W<IO_MUX_SD_DATA0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IO_MUX_SD_DATA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IO_MUX_SD_DATA0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IO_MUX_SD_DATA0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type REGISTER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IO_MUX_SD_DATA0_SPEC, u32, u32, 32, O>;
...
pub type SLEEP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IO_MUX_SD_DATA0_SPEC, bool, O>;
...
pub type SLEEP_PULLUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, IO_MUX_SD_DATA0_SPEC, bool, O>;
...
pub type FUNCTION_SELECT_LOW_BITS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IO_MUX_SD_DATA0_SPEC, u8, u8, 2, O>;
...
pub type PULLUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, IO_MUX_SD_DATA0_SPEC, bool, O>;
...
pub type FUNCTION_SELECT_HIGH_BIT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, IO_MUX_SD_DATA0_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
#[doc = "IO_MUX_SD_DATA0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [io_mux_sd_data0](index.html) module"]
