...
pub type REGISTER_W<'a, const O: u8> = crate::FieldWriter<'a, IO_MUX_SD_DATA0_SPEC, 32, O, u32>;
...
pub type SLEEP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, IO_MUX_SD_DATA0_SPEC, O>;
...
pub type SLEEP_PULLUP_W<'a, const O: u8> = crate::BitWriter<'a, IO_MUX_SD_DATA0_SPEC, O>;
...
pub type FUNCTION_SELECT_HIGH_BIT_W<'a, const O: u8> =
    crate::BitWriter<'a, IO_MUX_SD_DATA0_SPEC, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
