#[doc = "Register `IO_MUX_MTDO` reader"]
pub struct R(crate::R<IO_MUX_MTDO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IO_MUX_MTDO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IO_MUX_MTDO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IO_MUX_MTDO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IO_MUX_MTDO` writer"]
pub struct W(crate::W<IO_MUX_MTDO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IO_MUX_MTDO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IO_MUX_MTDO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IO_MUX_MTDO_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type REGISTER_W<'a, const O: u8> = crate::FieldWriter<'a, IO_MUX_MTDO_SPEC, 32, O, u32, u32>;
...
pub type SLEEP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, IO_MUX_MTDO_SPEC, O>;
...
pub type SLEEP_PULLUP_W<'a, const O: u8> = crate::BitWriter<'a, IO_MUX_MTDO_SPEC, O>;
...
pub type FUNCTION_SELECT_HIGH_BIT_W<'a, const O: u8> = crate::BitWriter<'a, IO_MUX_MTDO_SPEC, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<IO_MUX_MTDO_SPEC> {
...
#[doc = "IO_MUX_MTDO\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [io_mux_mtdo](index.html) module"]
pub struct IO_MUX_MTDO_SPEC;
impl crate::RegisterSpec for IO_MUX_MTDO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [io_mux_mtdo::R](R) reader structure"]
impl crate::Readable for IO_MUX_MTDO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [io_mux_mtdo::W](W) writer structure"]
impl crate::Writable for IO_MUX_MTDO_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IO_MUX_MTDO to value 0"]
impl crate::Resettable for IO_MUX_MTDO_SPEC {
