...
pub type R = crate::R<FRC2_CTRL_SPEC>;
#[doc = "Register `FRC2_CTRL` writer"]
pub type W = crate::W<FRC2_CTRL_SPEC>;
...
pub type FRC2_CTRL_R = crate::FieldReader;
...
pub type FRC2_CTRL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type FRC2_INT_R = crate::BitReader;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FRC2_CTRL")
            .field("frc2_int", &format_args!("{}", self.frc2_int().bit()))
            .field("frc2_ctrl", &format_args!("{}", self.frc2_ctrl().bits()))
            .field(
                "timer_enable",
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<FRC2_CTRL_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frc2_ctrl(&mut self) -> FRC2_CTRL_W<FRC2_CTRL_SPEC, 0> {
        FRC2_CTRL_W::new(self)
    }
    #[doc = "Bit 0 - Configure the interrupt type"]
    #[inline(always)]
    #[must_use]
    pub fn interrupt_type(&mut self) -> INTERRUPT_TYPE_W<FRC2_CTRL_SPEC, 0> {
        INTERRUPT_TYPE_W::new(self)
    }
    #[doc = "Bits 2:3 - Pre-scale divider for the timer"]
    #[inline(always)]
    #[must_use]
    pub fn prescale_divider(&mut self) -> PRESCALE_DIVIDER_W<FRC2_CTRL_SPEC, 2> {
        PRESCALE_DIVIDER_W::new(self)
    }
    #[doc = "Bit 6 - Automatically reload when the counter hits zero"]
    #[inline(always)]
    #[must_use]
    pub fn rollover(&mut self) -> ROLLOVER_W<FRC2_CTRL_SPEC, 6> {
        ROLLOVER_W::new(self)
    }
    #[doc = "Bit 7 - Enable or disable the timer"]
    #[inline(always)]
    #[must_use]
    pub fn timer_enable(&mut self) -> TIMER_ENABLE_W<FRC2_CTRL_SPEC, 7> {
