...
pub type R = crate::R<SLC_INT_ENA_SPEC>;
#[doc = "Register `SLC_INT_ENA` writer"]
pub type W = crate::W<SLC_INT_ENA_SPEC>;
...
pub type SLC_FRHOST_BIT0_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_FRHOST_BIT1_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_FRHOST_BIT2_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_FRHOST_BIT3_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_FRHOST_BIT4_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_FRHOST_BIT5_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_FRHOST_BIT6_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_FRHOST_BIT7_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_RX_START_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_TOKEN0_1TO0_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_TX_DSCR_ERR_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_RX_DSCR_ERR_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC_TX_DSCR_EMPTY_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slc_frhost_bit0_int_ena(&mut self) -> SLC_FRHOST_BIT0_INT_ENA_W<SLC_INT_ENA_SPEC, 0> {
        SLC_FRHOST_BIT0_INT_ENA_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn slc_frhost_bit1_int_ena(&mut self) -> SLC_FRHOST_BIT1_INT_ENA_W<SLC_INT_ENA_SPEC, 1> {
        SLC_FRHOST_BIT1_INT_ENA_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn slc_frhost_bit2_int_ena(&mut self) -> SLC_FRHOST_BIT2_INT_ENA_W<SLC_INT_ENA_SPEC, 2> {
        SLC_FRHOST_BIT2_INT_ENA_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn slc_frhost_bit3_int_ena(&mut self) -> SLC_FRHOST_BIT3_INT_ENA_W<SLC_INT_ENA_SPEC, 3> {
        SLC_FRHOST_BIT3_INT_ENA_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn slc_frhost_bit4_int_ena(&mut self) -> SLC_FRHOST_BIT4_INT_ENA_W<SLC_INT_ENA_SPEC, 4> {
        SLC_FRHOST_BIT4_INT_ENA_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn slc_frhost_bit5_int_ena(&mut self) -> SLC_FRHOST_BIT5_INT_ENA_W<SLC_INT_ENA_SPEC, 5> {
        SLC_FRHOST_BIT5_INT_ENA_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn slc_frhost_bit6_int_ena(&mut self) -> SLC_FRHOST_BIT6_INT_ENA_W<SLC_INT_ENA_SPEC, 6> {
        SLC_FRHOST_BIT6_INT_ENA_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn slc_frhost_bit7_int_ena(&mut self) -> SLC_FRHOST_BIT7_INT_ENA_W<SLC_INT_ENA_SPEC, 7> {
        SLC_FRHOST_BIT7_INT_ENA_W::new(self)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn slc_rx_start_int_ena(&mut self) -> SLC_RX_START_INT_ENA_W<SLC_INT_ENA_SPEC, 8> {
        SLC_RX_START_INT_ENA_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn slc_tx_start_int_ena(&mut self) -> SLC_TX_START_INT_ENA_W<SLC_INT_ENA_SPEC, 9> {
        SLC_TX_START_INT_ENA_W::new(self)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn slc_rx_udf_int_ena(&mut self) -> SLC_RX_UDF_INT_ENA_W<SLC_INT_ENA_SPEC, 10> {
        SLC_RX_UDF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn slc_tx_ovf_int_ena(&mut self) -> SLC_TX_OVF_INT_ENA_W<SLC_INT_ENA_SPEC, 11> {
        SLC_TX_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn slc_token0_1to0_int_ena(&mut self) -> SLC_TOKEN0_1TO0_INT_ENA_W<SLC_INT_ENA_SPEC, 12> {
        SLC_TOKEN0_1TO0_INT_ENA_W::new(self)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn slc_token1_1to0_int_ena(&mut self) -> SLC_TOKEN1_1TO0_INT_ENA_W<SLC_INT_ENA_SPEC, 13> {
        SLC_TOKEN1_1TO0_INT_ENA_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn slc_tx_done_int_ena(&mut self) -> SLC_TX_DONE_INT_ENA_W<SLC_INT_ENA_SPEC, 14> {
        SLC_TX_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn slc_tx_eof_int_ena(&mut self) -> SLC_TX_EOF_INT_ENA_W<SLC_INT_ENA_SPEC, 15> {
        SLC_TX_EOF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn slc_rx_done_int_ena(&mut self) -> SLC_RX_DONE_INT_ENA_W<SLC_INT_ENA_SPEC, 16> {
        SLC_RX_DONE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn slc_rx_eof_int_ena(&mut self) -> SLC_RX_EOF_INT_ENA_W<SLC_INT_ENA_SPEC, 17> {
        SLC_RX_EOF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn slc_tohost_int_ena(&mut self) -> SLC_TOHOST_INT_ENA_W<SLC_INT_ENA_SPEC, 18> {
        SLC_TOHOST_INT_ENA_W::new(self)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn slc_tx_dscr_err_int_ena(&mut self) -> SLC_TX_DSCR_ERR_INT_ENA_W<SLC_INT_ENA_SPEC, 19> {
        SLC_TX_DSCR_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn slc_rx_dscr_err_int_ena(&mut self) -> SLC_RX_DSCR_ERR_INT_ENA_W<SLC_INT_ENA_SPEC, 20> {
        SLC_RX_DSCR_ERR_INT_ENA_W::new(self)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn slc_tx_dscr_empty_int_ena(
        &mut self,
    ) -> SLC_TX_DSCR_EMPTY_INT_ENA_W<SLC_INT_ENA_SPEC, 21> {
