...
pub type GPIO_IN_DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
...
pub type GPIO_STRAPPING_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_in_data(&mut self) -> GPIO_IN_DATA_W<GPIO_IN_SPEC, 0> {
        GPIO_IN_DATA_W::new(self)
    }
    #[doc = "Bits 16:31 - The values of the strapping pins."]
    #[inline(always)]
    #[must_use]
    pub fn gpio_strapping(&mut self) -> GPIO_STRAPPING_W<GPIO_IN_SPEC, 16> {
