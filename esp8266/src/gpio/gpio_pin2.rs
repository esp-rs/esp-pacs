...
pub type GPIO_PIN2_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, GPIO_PIN2_SPEC, 3, O, u8, GPIO_PIN2_INT_TYPE_A>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPIO_PIN2")
            ...
            .field(
                "gpio_pin2_driver",
                &format_args!("{}", self.gpio_pin2_driver().bit()),
            )
            .field(
                "gpio_pin2_source",
                &format_args!("{}", self.gpio_pin2_source().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<GPIO_PIN2_SPEC> {
