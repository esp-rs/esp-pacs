...
pub enum GPIO_PIN2_SOURCE_A {
    #[doc = "0: sigma-delta"]
    SIGMA_DELTA = 0,
    #[doc = "1: gpio data"]
    GPIO_DATA = 1,
}
impl From<GPIO_PIN2_SOURCE_A> for bool {
    #[inline(always)]
    fn from(variant: GPIO_PIN2_SOURCE_A) -> Self {
        variant as u8 != 0
    }
}
impl GPIO_PIN2_SOURCE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> GPIO_PIN2_SOURCE_A {
        match self.bits {
            false => GPIO_PIN2_SOURCE_A::SIGMA_DELTA,
...
pub type GPIO_PIN2_SOURCE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPIO_PIN2_SPEC, GPIO_PIN2_SOURCE_A, O>;
...
#[doc = "Field `GPIO_PIN2_DRIVER` reader - 1: open drain; 0: normal"]
pub type GPIO_PIN2_DRIVER_R = crate::BitReader<GPIO_PIN2_DRIVER_A>;
#[doc = "1: open drain; 0: normal\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum GPIO_PIN2_DRIVER_A {
    #[doc = "0: open drain"]
    OPEN_DRAIN = 0,
    #[doc = "1: normal"]
    NORMAL = 1,
}
impl From<GPIO_PIN2_DRIVER_A> for bool {
    #[inline(always)]
    fn from(variant: GPIO_PIN2_DRIVER_A) -> Self {
        variant as u8 != 0
    }
}
impl GPIO_PIN2_DRIVER_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> GPIO_PIN2_DRIVER_A {
        match self.bits {
            false => GPIO_PIN2_DRIVER_A::OPEN_DRAIN,
...
pub type GPIO_PIN2_DRIVER_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPIO_PIN2_SPEC, GPIO_PIN2_DRIVER_A, O>;
...
#[doc = "Field `GPIO_PIN2_INT_TYPE` reader - 0: disable; 1: positive edge; 2: negative edge; 3: both types of edge; 4: low-level; 5: high-level"]
pub type GPIO_PIN2_INT_TYPE_R = crate::FieldReader<u8, GPIO_PIN2_INT_TYPE_A>;
#[doc = "0: disable; 1: positive edge; 2: negative edge; 3: both types of edge; 4: low-level; 5: high-level\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum GPIO_PIN2_INT_TYPE_A {
...
impl From<GPIO_PIN2_INT_TYPE_A> for u8 {
    #[inline(always)]
    fn from(variant: GPIO_PIN2_INT_TYPE_A) -> Self {
        variant as _
    }
}
impl GPIO_PIN2_INT_TYPE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<GPIO_PIN2_INT_TYPE_A> {
        match self.bits {
            0 => Some(GPIO_PIN2_INT_TYPE_A::DISABLED),
            1 => Some(GPIO_PIN2_INT_TYPE_A::POSITIVE_EDGE),
            2 => Some(GPIO_PIN2_INT_TYPE_A::NEGATIVE_EDGE),
            3 => Some(GPIO_PIN2_INT_TYPE_A::BOTH_EDGES),
            4 => Some(GPIO_PIN2_INT_TYPE_A::LOW_LEVEL),
            5 => Some(GPIO_PIN2_INT_TYPE_A::HIGH_LEVEL),
            _ => None,
        }
    }
...
pub type GPIO_PIN2_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_PIN2_SPEC, u8, GPIO_PIN2_INT_TYPE_A, 3, O>;
...
pub type GPIO_PIN2_WAKEUP_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPIO_PIN2_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - 1: sigma-delta; 0: GPIO_DATA"]
    #[inline(always)]
    pub fn gpio_pin2_source(&self) -> GPIO_PIN2_SOURCE_R {
        GPIO_PIN2_SOURCE_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 2 - 1: open drain; 0: normal"]
    #[inline(always)]
    pub fn gpio_pin2_driver(&self) -> GPIO_PIN2_DRIVER_R {
        GPIO_PIN2_DRIVER_R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    pub fn gpio_pin2_int_type(&self) -> GPIO_PIN2_INT_TYPE_R {
        GPIO_PIN2_INT_TYPE_R::new(((self.bits >> 7) & 7) as u8)
    }
    ...
    pub fn gpio_pin2_wakeup_enable(&self) -> GPIO_PIN2_WAKEUP_ENABLE_R {
        GPIO_PIN2_WAKEUP_ENABLE_R::new(((self.bits >> 10) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - 1: sigma-delta; 0: GPIO_DATA"]
...
#[doc = "`reset()` method sets GPIO_PIN2 to value 0"]
impl crate::Resettable for GPIO_PIN2_SPEC {
    #[inline(always)]
