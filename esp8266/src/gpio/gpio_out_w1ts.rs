...
pub type W = crate::W<GPIO_OUT_W1TS_SPEC>;
#[doc = "Field `GPIO_OUT_DATA_W1TS` writer - Writing 1 into a bit in this register will set the related bit in GPIO_OUT_DATA"]
pub type GPIO_OUT_DATA_W1TS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<GPIO_OUT_W1TS_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_out_data_w1ts(&mut self) -> GPIO_OUT_DATA_W1TS_W<GPIO_OUT_W1TS_SPEC, 0> {
...
#[doc = "GPIO_OUT_W1TS\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio_out_w1ts::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
