...
pub type R = crate::R<GPIO_PIN11_SPEC>;
#[doc = "Register `GPIO_PIN11` writer"]
pub type W = crate::W<GPIO_PIN11_SPEC>;
#[doc = "Field `GPIO_PIN11_SOURCE` reader - 1: sigma-delta; 0: GPIO_DATA"]
pub type GPIO_PIN11_SOURCE_R = crate::BitReader<GPIO_PIN11_SOURCE_A>;
...
pub type GPIO_PIN11_SOURCE_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O, GPIO_PIN11_SOURCE_A>;
impl<'a, REG, const O: u8> GPIO_PIN11_SOURCE_W<'a, REG, O>
where
...
pub type GPIO_PIN11_DRIVER_R = crate::BitReader<GPIO_PIN11_DRIVER_A>;
...
pub type GPIO_PIN11_DRIVER_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O, GPIO_PIN11_DRIVER_A>;
impl<'a, REG, const O: u8> GPIO_PIN11_DRIVER_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "open drain"]
...
pub type GPIO_PIN11_INT_TYPE_R = crate::FieldReader<GPIO_PIN11_INT_TYPE_A>;
...
impl crate::FieldSpec for GPIO_PIN11_INT_TYPE_A {
    type Ux = u8;
}
impl GPIO_PIN11_INT_TYPE_R {
    ...
    pub fn variant(&self) -> Option<GPIO_PIN11_INT_TYPE_A> {
        match self.bits {
            0 => Some(GPIO_PIN11_INT_TYPE_A::DISABLED),
            1 => Some(GPIO_PIN11_INT_TYPE_A::POSITIVE_EDGE),
            2 => Some(GPIO_PIN11_INT_TYPE_A::NEGATIVE_EDGE),
            3 => Some(GPIO_PIN11_INT_TYPE_A::BOTH_EDGES),
            4 => Some(GPIO_PIN11_INT_TYPE_A::LOW_LEVEL),
            5 => Some(GPIO_PIN11_INT_TYPE_A::HIGH_LEVEL),
            _ => None,
        }
    }
...
pub type GPIO_PIN11_INT_TYPE_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 3, O, GPIO_PIN11_INT_TYPE_A>;
impl<'a, REG, const O: u8> GPIO_PIN11_INT_TYPE_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl R {
    ...
    pub fn gpio_pin11_int_type(&self) -> GPIO_PIN11_INT_TYPE_R {
        GPIO_PIN11_INT_TYPE_R::new(((self.bits >> 7) & 7) as u8)
    }
    ...
    pub fn gpio_pin11_wakeup_enable(&self) -> GPIO_PIN11_WAKEUP_ENABLE_R {
        GPIO_PIN11_WAKEUP_ENABLE_R::new(((self.bits >> 10) & 1) != 0)
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPIO_PIN11")
            .field(
                "gpio_pin11_wakeup_enable",
                &format_args!("{}", self.gpio_pin11_wakeup_enable().bit()),
            )
            .field(
                "gpio_pin11_int_type",
                &format_args!("{}", self.gpio_pin11_int_type().bits()),
            )
            .field(
                "gpio_pin11_driver",
                &format_args!("{}", self.gpio_pin11_driver().bit()),
            )
            .field(
                "gpio_pin11_source",
                &format_args!("{}", self.gpio_pin11_source().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<GPIO_PIN11_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_source(&mut self) -> GPIO_PIN11_SOURCE_W<GPIO_PIN11_SPEC, 0> {
        GPIO_PIN11_SOURCE_W::new(self)
    }
    #[doc = "Bit 2 - 1: open drain; 0: normal"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_driver(&mut self) -> GPIO_PIN11_DRIVER_W<GPIO_PIN11_SPEC, 2> {
        GPIO_PIN11_DRIVER_W::new(self)
    }
    #[doc = "Bits 7:9 - 0: disable; 1: positive edge; 2: negative edge; 3: both types of edge; 4: low-level; 5: high-level"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_int_type(&mut self) -> GPIO_PIN11_INT_TYPE_W<GPIO_PIN11_SPEC, 7> {
        GPIO_PIN11_INT_TYPE_W::new(self)
    }
    #[doc = "Bit 10 - 0: disable; 1: enable GPIO wakeup CPU, only when GPIO_PIN0_INT_TYPE is 0x4 or 0x5"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_wakeup_enable(&mut self) -> GPIO_PIN11_WAKEUP_ENABLE_W<GPIO_PIN11_SPEC, 10> {
        GPIO_PIN11_WAKEUP_ENABLE_W::new(self)
    }
