...
impl From<crate::R<GPIO_PIN11_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<GPIO_PIN11_SPEC>> for W {
    #[inline(always)]
...
pub type GPIO_PIN11_SOURCE_W<'a, const O: u8> =
    crate::BitWriter<'a, GPIO_PIN11_SPEC, O, GPIO_PIN11_SOURCE_A>;
impl<'a, const O: u8> GPIO_PIN11_SOURCE_W<'a, O> {
    #[doc = "sigma-delta"]
    #[inline(always)]
...
pub type GPIO_PIN11_DRIVER_W<'a, const O: u8> =
    crate::BitWriter<'a, GPIO_PIN11_SPEC, O, GPIO_PIN11_DRIVER_A>;
impl<'a, const O: u8> GPIO_PIN11_DRIVER_W<'a, O> {
    #[doc = "open drain"]
    #[inline(always)]
...
pub type GPIO_PIN11_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, GPIO_PIN11_SPEC, 3, O, GPIO_PIN11_INT_TYPE_A>;
impl<'a, const O: u8> GPIO_PIN11_INT_TYPE_W<'a, O> {
...
pub type GPIO_PIN11_WAKEUP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, GPIO_PIN11_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_source(&mut self) -> GPIO_PIN11_SOURCE_W<0> {
        GPIO_PIN11_SOURCE_W::new(self)
    }
    #[doc = "Bit 2 - 1: open drain; 0: normal"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_driver(&mut self) -> GPIO_PIN11_DRIVER_W<2> {
        GPIO_PIN11_DRIVER_W::new(self)
    }
    #[doc = "Bits 7:9 - 0: disable; 1: positive edge; 2: negative edge; 3: both types of edge; 4: low-level; 5: high-level"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_int_type(&mut self) -> GPIO_PIN11_INT_TYPE_W<7> {
        GPIO_PIN11_INT_TYPE_W::new(self)
    }
    #[doc = "Bit 10 - 0: disable; 1: enable GPIO wakeup CPU, only when GPIO_PIN0_INT_TYPE is 0x4 or 0x5"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin11_wakeup_enable(&mut self) -> GPIO_PIN11_WAKEUP_ENABLE_W<10> {
