...
pub type GPIO_PIN12_SOURCE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPIO_PIN12_SPEC, GPIO_PIN12_SOURCE_A, O>;
...
pub type GPIO_PIN12_DRIVER_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPIO_PIN12_SPEC, GPIO_PIN12_DRIVER_A, O>;
...
pub type GPIO_PIN12_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_PIN12_SPEC, u8, GPIO_PIN12_INT_TYPE_A, 3, O>;
...
pub type GPIO_PIN12_WAKEUP_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `GPIO_PIN12_WAKEUP_ENABLE` writer - 0: disable; 1: enable GPIO wakeup CPU, only when GPIO_PIN0_INT_TYPE is 0x4 or 0x5"]
pub type GPIO_PIN12_WAKEUP_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GPIO_PIN12_SPEC, bool, O>;
impl R {
