...
pub struct W(crate::W<GPIO_ENABLE_W1TC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_ENABLE_W1TC_SPEC>;
    #[inline(always)]
...
impl From<crate::W<GPIO_ENABLE_W1TC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO_ENABLE_W1TC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GPIO_ENABLE_DATA_W1TC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_ENABLE_W1TC_SPEC, u16, u16, 16, O>;
impl W {
    #[doc = "Bits 0:15 - Writing 1 into a bit in this register will clear the related bit in GPIO_ENABLE_DATA"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_enable_data_w1tc(&mut self) -> GPIO_ENABLE_DATA_W1TC_W<0> {
...
#[doc = "GPIO_ENABLE_W1TC\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_enable_w1tc](index.html) module"]
