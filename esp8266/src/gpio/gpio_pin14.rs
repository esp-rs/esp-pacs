...
pub type R = crate::R<GPIO_PIN14_SPEC>;
#[doc = "Register `GPIO_PIN14` writer"]
pub type W = crate::W<GPIO_PIN14_SPEC>;
...
pub type GPIO_PIN14_SOURCE_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O, GPIO_PIN14_SOURCE_A>;
impl<'a, REG, const O: u8> GPIO_PIN14_SOURCE_W<'a, REG, O>
where
...
pub type GPIO_PIN14_DRIVER_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O, GPIO_PIN14_DRIVER_A>;
impl<'a, REG, const O: u8> GPIO_PIN14_DRIVER_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "open drain"]
...
pub type GPIO_PIN14_INT_TYPE_R = crate::FieldReader<GPIO_PIN14_INT_TYPE_A>;
...
impl crate::FieldSpec for GPIO_PIN14_INT_TYPE_A {
    type Ux = u8;
}
...
pub type GPIO_PIN14_INT_TYPE_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 3, O, GPIO_PIN14_INT_TYPE_A>;
impl<'a, REG, const O: u8> GPIO_PIN14_INT_TYPE_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type GPIO_PIN14_WAKEUP_ENABLE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin14_source(&mut self) -> GPIO_PIN14_SOURCE_W<GPIO_PIN14_SPEC, 0> {
        GPIO_PIN14_SOURCE_W::new(self)
    }
    #[doc = "Bit 2 - 1: open drain; 0: normal"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin14_driver(&mut self) -> GPIO_PIN14_DRIVER_W<GPIO_PIN14_SPEC, 2> {
        GPIO_PIN14_DRIVER_W::new(self)
    }
    #[doc = "Bits 7:9 - 0: disable; 1: positive edge; 2: negative edge; 3: both types of edge; 4: low-level; 5: high-level"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin14_int_type(&mut self) -> GPIO_PIN14_INT_TYPE_W<GPIO_PIN14_SPEC, 7> {
        GPIO_PIN14_INT_TYPE_W::new(self)
    }
    #[doc = "Bit 10 - 0: disable; 1: enable GPIO wakeup CPU, only when GPIO_PIN0_INT_TYPE is 0x4 or 0x5"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin14_wakeup_enable(&mut self) -> GPIO_PIN14_WAKEUP_ENABLE_W<GPIO_PIN14_SPEC, 10> {
