...
pub struct R(crate::R<GPIO_PIN6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_PIN6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO_PIN6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO_PIN6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_PIN6` writer"]
pub struct W(crate::W<GPIO_PIN6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_PIN6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIO_PIN6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO_PIN6_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GPIO_PIN6_INT_TYPE_R = crate::FieldReader<u8, GPIO_PIN6_INT_TYPE_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin6_source(&mut self) -> GPIO_PIN6_SOURCE_W<0> {
        GPIO_PIN6_SOURCE_W::new(self)
    }
    #[doc = "Bit 2 - 1: open drain; 0: normal"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin6_driver(&mut self) -> GPIO_PIN6_DRIVER_W<2> {
        GPIO_PIN6_DRIVER_W::new(self)
    }
    #[doc = "Bits 7:9 - 0: disable; 1: positive edge; 2: negative edge; 3: both types of edge; 4: low-level; 5: high-level"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin6_int_type(&mut self) -> GPIO_PIN6_INT_TYPE_W<7> {
        GPIO_PIN6_INT_TYPE_W::new(self)
    }
    #[doc = "Bit 10 - 0: disable; 1: enable GPIO wakeup CPU, only when GPIO_PIN0_INT_TYPE is 0x4 or 0x5"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_pin6_wakeup_enable(&mut self) -> GPIO_PIN6_WAKEUP_ENABLE_W<10> {
...
#[doc = "GPIO_PIN6\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_pin6](index.html) module"]
