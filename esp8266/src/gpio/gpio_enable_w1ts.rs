...
pub type GPIO_ENABLE_DATA_W1TS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_enable_data_w1ts(&mut self) -> GPIO_ENABLE_DATA_W1TS_W<GPIO_ENABLE_W1TS_SPEC, 0> {
