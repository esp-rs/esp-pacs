...
pub struct W(crate::W<GPIO_STATUS_W1TS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_STATUS_W1TS_SPEC>;
    #[inline(always)]
...
impl From<crate::W<GPIO_STATUS_W1TS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO_STATUS_W1TS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GPIO_STATUS_INTERRUPT_W1TS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_STATUS_W1TS_SPEC, u16, u16, 16, O>;
impl W {
...
#[doc = "GPIO_STATUS_W1TS\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_status_w1ts](index.html) module"]
