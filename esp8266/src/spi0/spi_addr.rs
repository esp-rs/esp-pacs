...
pub type IODATA_START_ADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
#[doc = "Field `address` reader - "]
pub type ADDRESS_R = crate::FieldReader<u32>;
#[doc = "Field `address` writer - "]
pub type ADDRESS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 24, O, u32>;
#[doc = "Field `size` reader - "]
pub type SIZE_R = crate::FieldReader;
#[doc = "Field `size` writer - "]
pub type SIZE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iodata_start_addr(&mut self) -> IODATA_START_ADDR_W<SPI_ADDR_SPEC, 0> {
        IODATA_START_ADDR_W::new(self)
    }
    #[doc = "Bits 0:23"]
    #[inline(always)]
    #[must_use]
    pub fn address(&mut self) -> ADDRESS_W<SPI_ADDR_SPEC, 0> {
        ADDRESS_W::new(self)
    }
    #[doc = "Bits 24:31"]
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SIZE_W<SPI_ADDR_SPEC, 24> {
        SIZE_W::new(self)
    }
