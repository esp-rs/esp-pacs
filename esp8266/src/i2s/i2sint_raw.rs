...
pub type I2S_I2S_RX_TAKE_DATA_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_TX_PUT_DATA_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_RX_WFULL_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_RX_REMPTY_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_TX_WFULL_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_TX_REMPTY_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    pub fn i2s_i2s_rx_take_data_int_raw(
        &mut self,
    ) -> I2S_I2S_RX_TAKE_DATA_INT_RAW_W<I2SINT_RAW_SPEC, 0> {
    ...
    pub fn i2s_i2s_tx_put_data_int_raw(
        &mut self,
    ) -> I2S_I2S_TX_PUT_DATA_INT_RAW_W<I2SINT_RAW_SPEC, 1> {
        I2S_I2S_TX_PUT_DATA_INT_RAW_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_rx_wfull_int_raw(&mut self) -> I2S_I2S_RX_WFULL_INT_RAW_W<I2SINT_RAW_SPEC, 2> {
        I2S_I2S_RX_WFULL_INT_RAW_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_rx_rempty_int_raw(&mut self) -> I2S_I2S_RX_REMPTY_INT_RAW_W<I2SINT_RAW_SPEC, 3> {
        I2S_I2S_RX_REMPTY_INT_RAW_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_tx_wfull_int_raw(&mut self) -> I2S_I2S_TX_WFULL_INT_RAW_W<I2SINT_RAW_SPEC, 4> {
        I2S_I2S_TX_WFULL_INT_RAW_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_tx_rempty_int_raw(&mut self) -> I2S_I2S_TX_REMPTY_INT_RAW_W<I2SINT_RAW_SPEC, 5> {
