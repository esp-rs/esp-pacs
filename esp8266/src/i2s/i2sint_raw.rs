...
pub type I2S_I2S_RX_TAKE_DATA_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `I2S_I2S_RX_TAKE_DATA_INT_RAW` writer - "]
pub type I2S_I2S_RX_TAKE_DATA_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2SINT_RAW_SPEC, bool, O>;
#[doc = "Field `I2S_I2S_TX_PUT_DATA_INT_RAW` reader - "]
pub type I2S_I2S_TX_PUT_DATA_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `I2S_I2S_TX_PUT_DATA_INT_RAW` writer - "]
pub type I2S_I2S_TX_PUT_DATA_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2SINT_RAW_SPEC, bool, O>;
#[doc = "Field `I2S_I2S_RX_WFULL_INT_RAW` reader - "]
pub type I2S_I2S_RX_WFULL_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `I2S_I2S_RX_WFULL_INT_RAW` writer - "]
pub type I2S_I2S_RX_WFULL_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2SINT_RAW_SPEC, bool, O>;
#[doc = "Field `I2S_I2S_RX_REMPTY_INT_RAW` reader - "]
pub type I2S_I2S_RX_REMPTY_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `I2S_I2S_RX_REMPTY_INT_RAW` writer - "]
pub type I2S_I2S_RX_REMPTY_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2SINT_RAW_SPEC, bool, O>;
#[doc = "Field `I2S_I2S_TX_WFULL_INT_RAW` reader - "]
pub type I2S_I2S_TX_WFULL_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `I2S_I2S_TX_WFULL_INT_RAW` writer - "]
pub type I2S_I2S_TX_WFULL_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2SINT_RAW_SPEC, bool, O>;
#[doc = "Field `I2S_I2S_TX_REMPTY_INT_RAW` reader - "]
pub type I2S_I2S_TX_REMPTY_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `I2S_I2S_TX_REMPTY_INT_RAW` writer - "]
pub type I2S_I2S_TX_REMPTY_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2SINT_RAW_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
