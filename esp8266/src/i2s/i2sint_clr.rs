...
pub struct R(crate::R<I2SINT_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2SINT_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2SINT_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2SINT_CLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2SINT_CLR` writer"]
pub struct W(crate::W<I2SINT_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2SINT_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2SINT_CLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2SINT_CLR_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_take_data_int_clr(&mut self) -> I2S_I2S_TAKE_DATA_INT_CLR_W<0> {
        I2S_I2S_TAKE_DATA_INT_CLR_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_put_data_int_clr(&mut self) -> I2S_I2S_PUT_DATA_INT_CLR_W<1> {
        I2S_I2S_PUT_DATA_INT_CLR_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_rx_wfull_int_clr(&mut self) -> I2S_I2S_RX_WFULL_INT_CLR_W<2> {
        I2S_I2S_RX_WFULL_INT_CLR_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_rx_rempty_int_clr(&mut self) -> I2S_I2S_RX_REMPTY_INT_CLR_W<3> {
        I2S_I2S_RX_REMPTY_INT_CLR_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_tx_wfull_int_clr(&mut self) -> I2S_I2S_TX_WFULL_INT_CLR_W<4> {
        I2S_I2S_TX_WFULL_INT_CLR_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_tx_rempty_int_clr(&mut self) -> I2S_I2S_TX_REMPTY_INT_CLR_W<5> {
...
#[doc = "I2SINT_CLR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2sint_clr](index.html) module"]
