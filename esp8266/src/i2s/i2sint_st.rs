...
pub type I2S_I2S_RX_TAKE_DATA_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_TX_PUT_DATA_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_RX_WFULL_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_RX_REMPTY_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_TX_WFULL_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2S_I2S_TX_REMPTY_INT_ST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_rx_take_data_int_st(
        &mut self,
    ) -> I2S_I2S_RX_TAKE_DATA_INT_ST_W<I2SINT_ST_SPEC, 0> {
        I2S_I2S_RX_TAKE_DATA_INT_ST_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_tx_put_data_int_st(
        &mut self,
    ) -> I2S_I2S_TX_PUT_DATA_INT_ST_W<I2SINT_ST_SPEC, 1> {
        I2S_I2S_TX_PUT_DATA_INT_ST_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_rx_wfull_int_st(&mut self) -> I2S_I2S_RX_WFULL_INT_ST_W<I2SINT_ST_SPEC, 2> {
        I2S_I2S_RX_WFULL_INT_ST_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_rx_rempty_int_st(&mut self) -> I2S_I2S_RX_REMPTY_INT_ST_W<I2SINT_ST_SPEC, 3> {
        I2S_I2S_RX_REMPTY_INT_ST_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_tx_wfull_int_st(&mut self) -> I2S_I2S_TX_WFULL_INT_ST_W<I2SINT_ST_SPEC, 4> {
        I2S_I2S_TX_WFULL_INT_ST_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_tx_rempty_int_st(&mut self) -> I2S_I2S_TX_REMPTY_INT_ST_W<I2SINT_ST_SPEC, 5> {
