...
pub type I2S_I2S_SIGLE_DATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2s_i2s_sigle_data(&mut self) -> I2S_I2S_SIGLE_DATA_W<I2SCONF_SIGLE_DATA_SPEC, 0> {
