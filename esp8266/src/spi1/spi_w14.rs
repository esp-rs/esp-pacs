...
pub type SPI_W14_R = crate::FieldReader<u32>;
#[doc = "Field `spi_w14` writer - the data inside the buffer of the SPI module, word 14"]
pub type SPI_W14_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_w14(&mut self) -> SPI_W14_W<SPI_W14_SPEC, 0> {
        SPI_W14_W::new(self)
    }
