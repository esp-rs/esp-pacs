...
pub type SPI_W13_R = crate::FieldReader<u32, u32>;
#[doc = "Field `spi_w13` writer - the data inside the buffer of the SPI module, word 13"]
pub type SPI_W13_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI_W13_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - the data inside the buffer of the SPI module, word 13"]
    #[inline(always)]
    pub fn spi_w13(&mut self) -> SPI_W13_W<0> {
        SPI_W13_W::new(self)
    }
