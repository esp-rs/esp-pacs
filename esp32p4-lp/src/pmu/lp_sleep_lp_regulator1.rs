...
#[doc = "Field `LP_SLEEP_LP_REGULATOR_DRV_B` reader - PMU_LP_SLEEP_LP_REGULATOR_DRV_B"]
pub type LP_SLEEP_LP_REGULATOR_DRV_B_R = crate::FieldReader;
#[doc = "Field `LP_SLEEP_LP_REGULATOR_DRV_B` writer - PMU_LP_SLEEP_LP_REGULATOR_DRV_B"]
pub type LP_SLEEP_LP_REGULATOR_DRV_B_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 26:31 - PMU_LP_SLEEP_LP_REGULATOR_DRV_B"]
    #[inline(always)]
...
impl W {
    ...
    pub fn lp_sleep_lp_regulator_drv_b(
        &mut self,
    ) -> LP_SLEEP_LP_REGULATOR_DRV_B_W<'_, LP_SLEEP_LP_REGULATOR1_SPEC> {
