...
#[doc = "Field `HP_ACTIVE_DIG_ICG_FUNC_EN` reader - PMU_HP_ACTIVE_DIG_ICG_FUNC_EN"]
pub type HP_ACTIVE_DIG_ICG_FUNC_EN_R = crate::FieldReader<u32>;
#[doc = "Field `HP_ACTIVE_DIG_ICG_FUNC_EN` writer - PMU_HP_ACTIVE_DIG_ICG_FUNC_EN"]
pub type HP_ACTIVE_DIG_ICG_FUNC_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - PMU_HP_ACTIVE_DIG_ICG_FUNC_EN"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_active_dig_icg_func_en(
        &mut self,
    ) -> HP_ACTIVE_DIG_ICG_FUNC_EN_W<'_, HP_ACTIVE_ICG_HP_FUNC_SPEC> {
        HP_ACTIVE_DIG_ICG_FUNC_EN_W::new(self, 0)
    }
}
#[doc = "PMU_HP_ACTIVE_ICG_HP_FUNC\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_active_icg_hp_func::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_active_icg_hp_func::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets HP_ACTIVE_ICG_HP_FUNC to value 0"]
