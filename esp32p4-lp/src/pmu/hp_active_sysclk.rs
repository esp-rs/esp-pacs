...
#[doc = "Field `HP_ACTIVE_DIG_SYS_CLK_NO_DIV` reader - PMU_HP_ACTIVE_DIG_SYS_CLK_NO_DIV"]
pub type HP_ACTIVE_DIG_SYS_CLK_NO_DIV_R = crate::BitReader;
#[doc = "Field `HP_ACTIVE_DIG_SYS_CLK_NO_DIV` writer - PMU_HP_ACTIVE_DIG_SYS_CLK_NO_DIV"]
pub type HP_ACTIVE_DIG_SYS_CLK_NO_DIV_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_ACTIVE_ICG_SYS_CLOCK_EN` reader - PMU_HP_ACTIVE_ICG_SYS_CLOCK_EN"]
pub type HP_ACTIVE_ICG_SYS_CLOCK_EN_R = crate::BitReader;
#[doc = "Field `HP_ACTIVE_ICG_SYS_CLOCK_EN` writer - PMU_HP_ACTIVE_ICG_SYS_CLOCK_EN"]
pub type HP_ACTIVE_ICG_SYS_CLOCK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_ACTIVE_SYS_CLK_SLP_SEL` reader - PMU_HP_ACTIVE_SYS_CLK_SLP_SEL"]
pub type HP_ACTIVE_SYS_CLK_SLP_SEL_R = crate::BitReader;
#[doc = "Field `HP_ACTIVE_SYS_CLK_SLP_SEL` writer - PMU_HP_ACTIVE_SYS_CLK_SLP_SEL"]
pub type HP_ACTIVE_SYS_CLK_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_ACTIVE_ICG_SLP_SEL` reader - PMU_HP_ACTIVE_ICG_SLP_SEL"]
pub type HP_ACTIVE_ICG_SLP_SEL_R = crate::BitReader;
#[doc = "Field `HP_ACTIVE_ICG_SLP_SEL` writer - PMU_HP_ACTIVE_ICG_SLP_SEL"]
pub type HP_ACTIVE_ICG_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_ACTIVE_DIG_SYS_CLK_SEL` reader - PMU_HP_ACTIVE_DIG_SYS_CLK_SEL"]
pub type HP_ACTIVE_DIG_SYS_CLK_SEL_R = crate::FieldReader;
#[doc = "Field `HP_ACTIVE_DIG_SYS_CLK_SEL` writer - PMU_HP_ACTIVE_DIG_SYS_CLK_SEL"]
pub type HP_ACTIVE_DIG_SYS_CLK_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bit 26 - PMU_HP_ACTIVE_DIG_SYS_CLK_NO_DIV"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_active_dig_sys_clk_no_div(
        &mut self,
    ) -> HP_ACTIVE_DIG_SYS_CLK_NO_DIV_W<'_, HP_ACTIVE_SYSCLK_SPEC> {
    ...
    pub fn hp_active_icg_sys_clock_en(
        &mut self,
    ) -> HP_ACTIVE_ICG_SYS_CLOCK_EN_W<'_, HP_ACTIVE_SYSCLK_SPEC> {
    ...
    pub fn hp_active_sys_clk_slp_sel(
        &mut self,
    ) -> HP_ACTIVE_SYS_CLK_SLP_SEL_W<'_, HP_ACTIVE_SYSCLK_SPEC> {
        HP_ACTIVE_SYS_CLK_SLP_SEL_W::new(self, 28)
    }
    #[doc = "Bit 29 - PMU_HP_ACTIVE_ICG_SLP_SEL"]
    #[inline(always)]
    pub fn hp_active_icg_slp_sel(&mut self) -> HP_ACTIVE_ICG_SLP_SEL_W<'_, HP_ACTIVE_SYSCLK_SPEC> {
    ...
    pub fn hp_active_dig_sys_clk_sel(
        &mut self,
    ) -> HP_ACTIVE_DIG_SYS_CLK_SEL_W<'_, HP_ACTIVE_SYSCLK_SPEC> {
