...
impl W {
    #[doc = "Bit 6 - PMU_0P1A_CNT_CLR_1"]
    #[inline(always)]
    pub fn _0p1a_cnt_clr_1(&mut self) -> _0P1A_CNT_CLR_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
        _0P1A_CNT_CLR_1_W::new(self, 6)
    }
    #[doc = "Bit 7 - PMU_0P1A_FORCE_TIEH_SEL_1"]
    #[inline(always)]
    pub fn _0p1a_force_tieh_sel_1(&mut self) -> _0P1A_FORCE_TIEH_SEL_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
        _0P1A_FORCE_TIEH_SEL_1_W::new(self, 7)
    }
    #[doc = "Bit 8 - PMU_0P1A_XPD_1"]
    #[inline(always)]
    pub fn _0p1a_xpd_1(&mut self) -> _0P1A_XPD_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
        _0P1A_XPD_1_W::new(self, 8)
    }
    #[doc = "Bits 9:11 - PMU_0P1A_TIEH_SEL_1"]
    #[inline(always)]
    pub fn _0p1a_tieh_sel_1(&mut self) -> _0P1A_TIEH_SEL_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
        _0P1A_TIEH_SEL_1_W::new(self, 9)
    }
    #[doc = "Bit 12 - PMU_0P1A_TIEH_POS_EN_1"]
    #[inline(always)]
    pub fn _0p1a_tieh_pos_en_1(&mut self) -> _0P1A_TIEH_POS_EN_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
        _0P1A_TIEH_POS_EN_1_W::new(self, 12)
    }
    #[doc = "Bit 13 - PMU_0P1A_TIEH_NEG_EN_1"]
    #[inline(always)]
    pub fn _0p1a_tieh_neg_en_1(&mut self) -> _0P1A_TIEH_NEG_EN_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
        _0P1A_TIEH_NEG_EN_1_W::new(self, 13)
    }
    #[doc = "Bit 14 - PMU_0P1A_TIEH_1"]
    #[inline(always)]
    pub fn _0p1a_tieh_1(&mut self) -> _0P1A_TIEH_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
        _0P1A_TIEH_1_W::new(self, 14)
    }
    #[doc = "Bits 15:22 - PMU_0P1A_TARGET1_1"]
    #[inline(always)]
    pub fn _0p1a_target1_1(&mut self) -> _0P1A_TARGET1_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
        _0P1A_TARGET1_1_W::new(self, 15)
    }
    #[doc = "Bits 23:30 - PMU_0P1A_TARGET0_1"]
    #[inline(always)]
    pub fn _0p1a_target0_1(&mut self) -> _0P1A_TARGET0_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
    ...
    pub fn _0p1a_ldo_cnt_prescaler_sel_1(
        &mut self,
    ) -> _0P1A_LDO_CNT_PRESCALER_SEL_1_W<'_, EXT_LDO_P1_0P1A_SPEC> {
...
#[doc = "`reset()` method sets EXT_LDO_P1_0P1A to value 0"]
