...
#[doc = "Field `UPDATE_DIG_ICG_MODEM_EN` writer - PMU_UPDATE_DIG_ICG_MODEM_EN"]
...
impl W {
    #[doc = "Bit 31 - PMU_UPDATE_DIG_ICG_MODEM_EN"]
    #[inline(always)]
    pub fn update_dig_icg_modem_en(&mut self) -> UPDATE_DIG_ICG_MODEM_EN_W<'_, IMM_MODEM_ICG_SPEC> {
