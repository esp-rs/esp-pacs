...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EXT_LDO_P0_0P1A_ANA")
            .field("ana_0p1a_mul_0", &self.ana_0p1a_mul_0())
            .field("ana_0p1a_en_vdet_0", &self.ana_0p1a_en_vdet_0())
            .field("ana_0p1a_en_cur_lim_0", &self.ana_0p1a_en_cur_lim_0())
            .field("ana_0p1a_dref_0", &self.ana_0p1a_dref_0())
            .finish()
    }
}
impl W {
    #[doc = "Bits 23:25 - PMU_ANA_0P1A_MUL_0"]
    #[inline(always)]
    pub fn ana_0p1a_mul_0(&mut self) -> ANA_0P1A_MUL_0_W<'_, EXT_LDO_P0_0P1A_ANA_SPEC> {
        ANA_0P1A_MUL_0_W::new(self, 23)
    }
    #[doc = "Bit 26 - PMU_ANA_0P1A_EN_VDET_0"]
    #[inline(always)]
    pub fn ana_0p1a_en_vdet_0(&mut self) -> ANA_0P1A_EN_VDET_0_W<'_, EXT_LDO_P0_0P1A_ANA_SPEC> {
        ANA_0P1A_EN_VDET_0_W::new(self, 26)
    }
    #[doc = "Bit 27 - PMU_ANA_0P1A_EN_CUR_LIM_0"]
    #[inline(always)]
    pub fn ana_0p1a_en_cur_lim_0(
        &mut self,
    ) -> ANA_0P1A_EN_CUR_LIM_0_W<'_, EXT_LDO_P0_0P1A_ANA_SPEC> {
        ANA_0P1A_EN_CUR_LIM_0_W::new(self, 27)
    }
    #[doc = "Bits 28:31 - PMU_ANA_0P1A_DREF_0"]
    #[inline(always)]
    pub fn ana_0p1a_dref_0(&mut self) -> ANA_0P1A_DREF_0_W<'_, EXT_LDO_P0_0P1A_ANA_SPEC> {
        ANA_0P1A_DREF_0_W::new(self, 28)
    }
}
#[doc = "PMU_EXT_LDO_P0_0P1A_ANA\n\nYou can [`read`](crate::Reg::read) this register and get [`ext_ldo_p0_0p1a_ana::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ext_ldo_p0_0p1a_ana::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets EXT_LDO_P0_0P1A_ANA to value 0"]
