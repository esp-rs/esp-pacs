...
#[doc = "Field `UPDATE_DIG_ICG_APB_EN` writer - PMU_UPDATE_DIG_ICG_APB_EN"]
...
impl W {
    #[doc = "Bit 31 - PMU_UPDATE_DIG_ICG_APB_EN"]
    #[inline(always)]
    pub fn update_dig_icg_apb_en(&mut self) -> UPDATE_DIG_ICG_APB_EN_W<'_, IMM_HP_APB_ICG_SPEC> {
