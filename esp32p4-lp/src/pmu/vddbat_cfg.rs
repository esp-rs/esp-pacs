...
#[doc = "Field `ANA_VDDBAT_MODE` reader - PMU_ANA_VDDBAT_MODE"]
pub type ANA_VDDBAT_MODE_R = crate::FieldReader;
#[doc = "Field `VDDBAT_SW_UPDATE` writer - PMU_VDDBAT_SW_UPDATE"]
pub type VDDBAT_SW_UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:1 - PMU_ANA_VDDBAT_MODE"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 31 - PMU_VDDBAT_SW_UPDATE"]
    #[inline(always)]
    pub fn vddbat_sw_update(&mut self) -> VDDBAT_SW_UPDATE_W<'_, VDDBAT_CFG_SPEC> {
