...
#[doc = "Field `LP_SLEEP_XPD_BIAS` reader - PMU_LP_SLEEP_XPD_BIAS"]
pub type LP_SLEEP_XPD_BIAS_R = crate::BitReader;
#[doc = "Field `LP_SLEEP_XPD_BIAS` writer - PMU_LP_SLEEP_XPD_BIAS"]
pub type LP_SLEEP_XPD_BIAS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_SLEEP_DBG_ATTEN` reader - PMU_LP_SLEEP_DBG_ATTEN"]
pub type LP_SLEEP_DBG_ATTEN_R = crate::FieldReader;
#[doc = "Field `LP_SLEEP_DBG_ATTEN` writer - PMU_LP_SLEEP_DBG_ATTEN"]
pub type LP_SLEEP_DBG_ATTEN_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `LP_SLEEP_PD_CUR` reader - PMU_LP_SLEEP_PD_CUR"]
pub type LP_SLEEP_PD_CUR_R = crate::BitReader;
#[doc = "Field `LP_SLEEP_PD_CUR` writer - PMU_LP_SLEEP_PD_CUR"]
pub type LP_SLEEP_PD_CUR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_SLEEP_BIAS_SLEEP` reader - PMU_LP_SLEEP_BIAS_SLEEP"]
pub type LP_SLEEP_BIAS_SLEEP_R = crate::BitReader;
#[doc = "Field `LP_SLEEP_BIAS_SLEEP` writer - PMU_LP_SLEEP_BIAS_SLEEP"]
pub type LP_SLEEP_BIAS_SLEEP_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 25 - PMU_LP_SLEEP_XPD_BIAS"]
    #[inline(always)]
    pub fn lp_sleep_xpd_bias(&self) -> LP_SLEEP_XPD_BIAS_R {
        LP_SLEEP_XPD_BIAS_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bits 26:29 - PMU_LP_SLEEP_DBG_ATTEN"]
    #[inline(always)]
    pub fn lp_sleep_dbg_atten(&self) -> LP_SLEEP_DBG_ATTEN_R {
        LP_SLEEP_DBG_ATTEN_R::new(((self.bits >> 26) & 0x0f) as u8)
    }
    #[doc = "Bit 30 - PMU_LP_SLEEP_PD_CUR"]
    #[inline(always)]
    pub fn lp_sleep_pd_cur(&self) -> LP_SLEEP_PD_CUR_R {
        LP_SLEEP_PD_CUR_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - PMU_LP_SLEEP_BIAS_SLEEP"]
    #[inline(always)]
    pub fn lp_sleep_bias_sleep(&self) -> LP_SLEEP_BIAS_SLEEP_R {
        LP_SLEEP_BIAS_SLEEP_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_SLEEP_BIAS")
            ...
            .field("lp_sleep_bias_sleep", &self.lp_sleep_bias_sleep())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 31 - PMU_LP_SLEEP_BIAS_SLEEP"]
    #[inline(always)]
    pub fn lp_sleep_bias_sleep(&mut self) -> LP_SLEEP_BIAS_SLEEP_W<'_, LP_SLEEP_BIAS_SPEC> {
        LP_SLEEP_BIAS_SLEEP_W::new(self, 31)
    }
}
