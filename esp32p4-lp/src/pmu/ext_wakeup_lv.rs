...
#[doc = "Field `EXT_WAKEUP_LV` reader - PMU_EXT_WAKEUP_LV"]
pub type EXT_WAKEUP_LV_R = crate::FieldReader<u32>;
#[doc = "Field `EXT_WAKEUP_LV` writer - PMU_EXT_WAKEUP_LV"]
pub type EXT_WAKEUP_LV_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - PMU_EXT_WAKEUP_LV"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - PMU_EXT_WAKEUP_LV"]
    #[inline(always)]
    pub fn ext_wakeup_lv(&mut self) -> EXT_WAKEUP_LV_W<'_, EXT_WAKEUP_LV_SPEC> {
