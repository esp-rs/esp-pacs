...
#[doc = "Field `LP_CPU_SLEEP_REJECT_LP` writer - PMU_LP_CPU_SLEEP_REJECT_LP_INT_CLR"]
...
#[doc = "Field `LP_CPU_WAKEUP` writer - PMU_LP_CPU_WAKEUP_INT_CLR"]
pub type LP_CPU_WAKEUP_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLEEP_SWITCH_ACTIVE_END` writer - PMU_SLEEP_SWITCH_ACTIVE_END_INT_CLR"]
pub type SLEEP_SWITCH_ACTIVE_END_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ACTIVE_SWITCH_SLEEP_END` writer - PMU_ACTIVE_SWITCH_SLEEP_END_INT_CLR"]
pub type ACTIVE_SWITCH_SLEEP_END_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLEEP_SWITCH_ACTIVE_START` writer - PMU_SLEEP_SWITCH_ACTIVE_START_INT_CLR"]
pub type SLEEP_SWITCH_ACTIVE_START_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `ACTIVE_SWITCH_SLEEP_START` writer - PMU_ACTIVE_SWITCH_SLEEP_START_INT_CLR"]
pub type ACTIVE_SWITCH_SLEEP_START_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `HP_SW_TRIGGER` writer - PMU_HP_SW_TRIGGER_INT_CLR"]
...
impl W {
    #[doc = "Bit 13 - PMU_LP_CPU_SLEEP_REJECT_LP_INT_CLR"]
    #[inline(always)]
    pub fn lp_cpu_sleep_reject_lp(&mut self) -> LP_CPU_SLEEP_REJECT_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p1a_cnt_target0_reach_0_lp(
        &mut self,
    ) -> _0P1A_CNT_TARGET0_REACH_0_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p1a_cnt_target1_reach_0_lp(
        &mut self,
    ) -> _0P1A_CNT_TARGET1_REACH_0_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p1a_cnt_target0_reach_1_lp(
        &mut self,
    ) -> _0P1A_CNT_TARGET0_REACH_1_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p1a_cnt_target1_reach_1_lp(
        &mut self,
    ) -> _0P1A_CNT_TARGET1_REACH_1_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p2a_cnt_target0_reach_0_lp(
        &mut self,
    ) -> _0P2A_CNT_TARGET0_REACH_0_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p2a_cnt_target1_reach_0_lp(
        &mut self,
    ) -> _0P2A_CNT_TARGET1_REACH_0_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p2a_cnt_target0_reach_1_lp(
        &mut self,
    ) -> _0P2A_CNT_TARGET0_REACH_1_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p2a_cnt_target1_reach_1_lp(
        &mut self,
    ) -> _0P2A_CNT_TARGET1_REACH_1_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p3a_cnt_target0_reach_0_lp(
        &mut self,
    ) -> _0P3A_CNT_TARGET0_REACH_0_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p3a_cnt_target1_reach_0_lp(
        &mut self,
    ) -> _0P3A_CNT_TARGET1_REACH_0_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn _0p3a_cnt_target0_reach_1_lp(
        &mut self,
    ) -> _0P3A_CNT_TARGET0_REACH_1_LP_W<'_, LP_INT_CLR_SPEC> {
    ...
    #[doc = "Bit 30 - PMU_ACTIVE_SWITCH_SLEEP_START_INT_CLR"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - PMU_HP_SW_TRIGGER_INT_CLR"]
    #[inline(always)]
