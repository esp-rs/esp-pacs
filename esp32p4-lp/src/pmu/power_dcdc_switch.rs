...
#[doc = "Field `FORCE_DCDC_SWITCH_PU` reader - PMU_FORCE_DCDC_SWITCH_PU"]
pub type FORCE_DCDC_SWITCH_PU_R = crate::BitReader;
#[doc = "Field `FORCE_DCDC_SWITCH_PU` writer - PMU_FORCE_DCDC_SWITCH_PU"]
pub type FORCE_DCDC_SWITCH_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FORCE_DCDC_SWITCH_PD` reader - PMU_FORCE_DCDC_SWITCH_PD"]
pub type FORCE_DCDC_SWITCH_PD_R = crate::BitReader;
#[doc = "Field `FORCE_DCDC_SWITCH_PD` writer - PMU_FORCE_DCDC_SWITCH_PD"]
pub type FORCE_DCDC_SWITCH_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - PMU_FORCE_DCDC_SWITCH_PU"]
    #[inline(always)]
    pub fn force_dcdc_switch_pu(&self) -> FORCE_DCDC_SWITCH_PU_R {
        FORCE_DCDC_SWITCH_PU_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - PMU_FORCE_DCDC_SWITCH_PD"]
    #[inline(always)]
...
#[doc = "`reset()` method sets POWER_DCDC_SWITCH to value 0"]
