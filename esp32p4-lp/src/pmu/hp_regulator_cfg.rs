...
#[doc = "Field `DIG_REGULATOR_EN_CAL` reader - PMU_DIG_REGULATOR_EN_CAL"]
pub type DIG_REGULATOR_EN_CAL_R = crate::BitReader;
#[doc = "Field `DIG_REGULATOR_EN_CAL` writer - PMU_DIG_REGULATOR_EN_CAL"]
pub type DIG_REGULATOR_EN_CAL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 31 - PMU_DIG_REGULATOR_EN_CAL"]
    #[inline(always)]
