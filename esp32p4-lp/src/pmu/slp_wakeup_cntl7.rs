...
#[doc = "Field `ANA_WAIT_TARGET` reader - PMU_ANA_WAIT_TARGET"]
pub type ANA_WAIT_TARGET_R = crate::FieldReader<u16>;
#[doc = "Field `ANA_WAIT_TARGET` writer - PMU_ANA_WAIT_TARGET"]
pub type ANA_WAIT_TARGET_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 16:31 - PMU_ANA_WAIT_TARGET"]
    #[inline(always)]
...
#[doc = "`reset()` method sets SLP_WAKEUP_CNTL7 to value 0"]
