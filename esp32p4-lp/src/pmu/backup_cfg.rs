...
#[doc = "Field `BACKUP_SYS_CLK_NO_DIV` reader - PMU_BACKUP_SYS_CLK_NO_DIV"]
pub type BACKUP_SYS_CLK_NO_DIV_R = crate::BitReader;
#[doc = "Field `BACKUP_SYS_CLK_NO_DIV` writer - PMU_BACKUP_SYS_CLK_NO_DIV"]
pub type BACKUP_SYS_CLK_NO_DIV_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 31 - PMU_BACKUP_SYS_CLK_NO_DIV"]
    #[inline(always)]
...
#[doc = "`reset()` method sets BACKUP_CFG to value 0"]
