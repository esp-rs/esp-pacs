...
impl W {
    #[doc = "Bit 0 - PMU_FORCE_HP_MEM_RESET"]
    #[inline(always)]
    pub fn force_hp_mem_reset(&mut self) -> FORCE_HP_MEM_RESET_W<'_, POWER_PD_HPMEM_CNTL_SPEC> {
        FORCE_HP_MEM_RESET_W::new(self, 0)
    }
    #[doc = "Bit 1 - PMU_FORCE_HP_MEM_ISO"]
    #[inline(always)]
    pub fn force_hp_mem_iso(&mut self) -> FORCE_HP_MEM_ISO_W<'_, POWER_PD_HPMEM_CNTL_SPEC> {
        FORCE_HP_MEM_ISO_W::new(self, 1)
    }
    #[doc = "Bit 2 - PMU_FORCE_HP_MEM_PU"]
    #[inline(always)]
    pub fn force_hp_mem_pu(&mut self) -> FORCE_HP_MEM_PU_W<'_, POWER_PD_HPMEM_CNTL_SPEC> {
    ...
    pub fn force_hp_mem_no_reset(
        &mut self,
    ) -> FORCE_HP_MEM_NO_RESET_W<'_, POWER_PD_HPMEM_CNTL_SPEC> {
        FORCE_HP_MEM_NO_RESET_W::new(self, 3)
    }
    #[doc = "Bit 4 - PMU_FORCE_HP_MEM_NO_ISO"]
    #[inline(always)]
    pub fn force_hp_mem_no_iso(&mut self) -> FORCE_HP_MEM_NO_ISO_W<'_, POWER_PD_HPMEM_CNTL_SPEC> {
        FORCE_HP_MEM_NO_ISO_W::new(self, 4)
    }
    #[doc = "Bit 5 - PMU_FORCE_HP_MEM_PD"]
    #[inline(always)]
    pub fn force_hp_mem_pd(&mut self) -> FORCE_HP_MEM_PD_W<'_, POWER_PD_HPMEM_CNTL_SPEC> {
        FORCE_HP_MEM_PD_W::new(self, 5)
    }
}
#[doc = "PMU_POWER_PD_HPMEM_CNTL\n\nYou can [`read`](crate::Reg::read) this register and get [`power_pd_hpmem_cntl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`power_pd_hpmem_cntl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets POWER_PD_HPMEM_CNTL to value 0"]
