...
#[doc = "Field `HP_ACTIVE_DIG_ICG_MODEM_CODE` reader - PMU_HP_ACTIVE_DIG_ICG_MODEM_CODE"]
pub type HP_ACTIVE_DIG_ICG_MODEM_CODE_R = crate::FieldReader;
#[doc = "Field `HP_ACTIVE_DIG_ICG_MODEM_CODE` writer - PMU_HP_ACTIVE_DIG_ICG_MODEM_CODE"]
pub type HP_ACTIVE_DIG_ICG_MODEM_CODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 30:31 - PMU_HP_ACTIVE_DIG_ICG_MODEM_CODE"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_active_dig_icg_modem_code(
        &mut self,
    ) -> HP_ACTIVE_DIG_ICG_MODEM_CODE_W<'_, HP_ACTIVE_ICG_MODEM_SPEC> {
