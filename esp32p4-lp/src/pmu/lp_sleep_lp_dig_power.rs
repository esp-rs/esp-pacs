...
#[doc = "Field `LP_SLEEP_LP_PAD_SLP_SEL` reader - PMU_LP_SLEEP_LP_PAD_SLP_SEL"]
pub type LP_SLEEP_LP_PAD_SLP_SEL_R = crate::BitReader;
#[doc = "Field `LP_SLEEP_LP_PAD_SLP_SEL` writer - PMU_LP_SLEEP_LP_PAD_SLP_SEL"]
pub type LP_SLEEP_LP_PAD_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_SLEEP_BOD_SOURCE_SEL` reader - PMU_LP_SLEEP_BOD_SOURCE_SEL"]
pub type LP_SLEEP_BOD_SOURCE_SEL_R = crate::BitReader;
#[doc = "Field `LP_SLEEP_BOD_SOURCE_SEL` writer - PMU_LP_SLEEP_BOD_SOURCE_SEL"]
pub type LP_SLEEP_BOD_SOURCE_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_SLEEP_VDDBAT_MODE` reader - PMU_LP_SLEEP_VDDBAT_MODE"]
pub type LP_SLEEP_VDDBAT_MODE_R = crate::FieldReader;
#[doc = "Field `LP_SLEEP_VDDBAT_MODE` writer - PMU_LP_SLEEP_VDDBAT_MODE"]
pub type LP_SLEEP_VDDBAT_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `LP_SLEEP_LP_MEM_DSLP` reader - PMU_LP_SLEEP_LP_MEM_DSLP"]
pub type LP_SLEEP_LP_MEM_DSLP_R = crate::BitReader;
#[doc = "Field `LP_SLEEP_LP_MEM_DSLP` writer - PMU_LP_SLEEP_LP_MEM_DSLP"]
pub type LP_SLEEP_LP_MEM_DSLP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_SLEEP_PD_LP_PERI_PD_EN` reader - PMU_LP_SLEEP_PD_LP_PERI_PD_EN"]
pub type LP_SLEEP_PD_LP_PERI_PD_EN_R = crate::BitReader;
#[doc = "Field `LP_SLEEP_PD_LP_PERI_PD_EN` writer - PMU_LP_SLEEP_PD_LP_PERI_PD_EN"]
pub type LP_SLEEP_PD_LP_PERI_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 26 - PMU_LP_SLEEP_LP_PAD_SLP_SEL"]
    #[inline(always)]
    pub fn lp_sleep_lp_pad_slp_sel(&self) -> LP_SLEEP_LP_PAD_SLP_SEL_R {
        LP_SLEEP_LP_PAD_SLP_SEL_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - PMU_LP_SLEEP_BOD_SOURCE_SEL"]
    #[inline(always)]
    pub fn lp_sleep_bod_source_sel(&self) -> LP_SLEEP_BOD_SOURCE_SEL_R {
        LP_SLEEP_BOD_SOURCE_SEL_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bits 28:29 - PMU_LP_SLEEP_VDDBAT_MODE"]
    #[inline(always)]
    pub fn lp_sleep_vddbat_mode(&self) -> LP_SLEEP_VDDBAT_MODE_R {
        LP_SLEEP_VDDBAT_MODE_R::new(((self.bits >> 28) & 3) as u8)
    }
    #[doc = "Bit 30 - PMU_LP_SLEEP_LP_MEM_DSLP"]
    #[inline(always)]
    pub fn lp_sleep_lp_mem_dslp(&self) -> LP_SLEEP_LP_MEM_DSLP_R {
        LP_SLEEP_LP_MEM_DSLP_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - PMU_LP_SLEEP_PD_LP_PERI_PD_EN"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 26 - PMU_LP_SLEEP_LP_PAD_SLP_SEL"]
    #[inline(always)]
    pub fn lp_sleep_lp_pad_slp_sel(
        &mut self,
    ) -> LP_SLEEP_LP_PAD_SLP_SEL_W<'_, LP_SLEEP_LP_DIG_POWER_SPEC> {
        LP_SLEEP_LP_PAD_SLP_SEL_W::new(self, 26)
    }
    #[doc = "Bit 27 - PMU_LP_SLEEP_BOD_SOURCE_SEL"]
    #[inline(always)]
