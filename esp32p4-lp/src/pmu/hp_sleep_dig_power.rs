...
impl W {
    ...
    pub fn hp_sleep_dcdc_switch_pd_en(
        &mut self,
    ) -> HP_SLEEP_DCDC_SWITCH_PD_EN_W<'_, HP_SLEEP_DIG_POWER_SPEC> {
    ...
    pub fn hp_sleep_pd_cnnt_pd_en(
        &mut self,
    ) -> HP_SLEEP_PD_CNNT_PD_EN_W<'_, HP_SLEEP_DIG_POWER_SPEC> {
