...
#[doc = "Field `I2C_POR_WAIT_TARGET` reader - PMU_I2C_POR_WAIT_TARGET"]
pub type I2C_POR_WAIT_TARGET_R = crate::FieldReader;
#[doc = "Field `I2C_POR_WAIT_TARGET` writer - PMU_I2C_POR_WAIT_TARGET"]
pub type I2C_POR_WAIT_TARGET_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - PMU_I2C_POR_WAIT_TARGET"]
    #[inline(always)]
...
#[doc = "`reset()` method sets HP_CK_POWERON to value 0"]
