...
#[doc = "Field `HP_SLEEP_DIG_ICG_APB_EN` reader - PMU_HP_SLEEP_DIG_ICG_APB_EN"]
pub type HP_SLEEP_DIG_ICG_APB_EN_R = crate::FieldReader<u32>;
#[doc = "Field `HP_SLEEP_DIG_ICG_APB_EN` writer - PMU_HP_SLEEP_DIG_ICG_APB_EN"]
pub type HP_SLEEP_DIG_ICG_APB_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - PMU_HP_SLEEP_DIG_ICG_APB_EN"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_sleep_dig_icg_apb_en(
        &mut self,
    ) -> HP_SLEEP_DIG_ICG_APB_EN_W<'_, HP_SLEEP_ICG_HP_APB_SPEC> {
...
#[doc = "`reset()` method sets HP_SLEEP_ICG_HP_APB to value 0"]
