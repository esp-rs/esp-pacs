...
#[doc = "Field `UPDATE_DIG_ICG_FUNC_EN` writer - PMU_UPDATE_DIG_ICG_FUNC_EN"]
...
impl W {
    #[doc = "Bit 31 - PMU_UPDATE_DIG_ICG_FUNC_EN"]
    #[inline(always)]
    pub fn update_dig_icg_func_en(&mut self) -> UPDATE_DIG_ICG_FUNC_EN_W<'_, IMM_HP_FUNC_ICG_SPEC> {
        UPDATE_DIG_ICG_FUNC_EN_W::new(self, 31)
    }
}
#[doc = "PMU_IMM_HP_FUNC_ICG\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`imm_hp_func_icg::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
