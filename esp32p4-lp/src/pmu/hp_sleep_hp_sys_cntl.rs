...
#[doc = "Field `HP_SLEEP_HP_POWER_DET_BYPASS` reader - PMU_HP_SLEEP_HP_POWER_DET_BYPASS"]
pub type HP_SLEEP_HP_POWER_DET_BYPASS_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_HP_POWER_DET_BYPASS` writer - PMU_HP_SLEEP_HP_POWER_DET_BYPASS"]
pub type HP_SLEEP_HP_POWER_DET_BYPASS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_SLEEP_UART_WAKEUP_EN` reader - PMU_HP_SLEEP_UART_WAKEUP_EN"]
pub type HP_SLEEP_UART_WAKEUP_EN_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_UART_WAKEUP_EN` writer - PMU_HP_SLEEP_UART_WAKEUP_EN"]
pub type HP_SLEEP_UART_WAKEUP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_SLEEP_LP_PAD_HOLD_ALL` reader - PMU_HP_SLEEP_LP_PAD_HOLD_ALL"]
pub type HP_SLEEP_LP_PAD_HOLD_ALL_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_LP_PAD_HOLD_ALL` writer - PMU_HP_SLEEP_LP_PAD_HOLD_ALL"]
pub type HP_SLEEP_LP_PAD_HOLD_ALL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_SLEEP_HP_PAD_HOLD_ALL` reader - PMU_HP_SLEEP_HP_PAD_HOLD_ALL"]
pub type HP_SLEEP_HP_PAD_HOLD_ALL_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_HP_PAD_HOLD_ALL` writer - PMU_HP_SLEEP_HP_PAD_HOLD_ALL"]
pub type HP_SLEEP_HP_PAD_HOLD_ALL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_SLEEP_DIG_PAD_SLP_SEL` reader - PMU_HP_SLEEP_DIG_PAD_SLP_SEL"]
pub type HP_SLEEP_DIG_PAD_SLP_SEL_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_DIG_PAD_SLP_SEL` writer - PMU_HP_SLEEP_DIG_PAD_SLP_SEL"]
pub type HP_SLEEP_DIG_PAD_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_SLEEP_DIG_PAUSE_WDT` reader - PMU_HP_SLEEP_DIG_PAUSE_WDT"]
pub type HP_SLEEP_DIG_PAUSE_WDT_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_DIG_PAUSE_WDT` writer - PMU_HP_SLEEP_DIG_PAUSE_WDT"]
pub type HP_SLEEP_DIG_PAUSE_WDT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_SLEEP_DIG_CPU_STALL` reader - PMU_HP_SLEEP_DIG_CPU_STALL"]
pub type HP_SLEEP_DIG_CPU_STALL_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_DIG_CPU_STALL` writer - PMU_HP_SLEEP_DIG_CPU_STALL"]
pub type HP_SLEEP_DIG_CPU_STALL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 23 - PMU_HP_SLEEP_HP_POWER_DET_BYPASS"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_sleep_hp_power_det_bypass(
        &mut self,
    ) -> HP_SLEEP_HP_POWER_DET_BYPASS_W<'_, HP_SLEEP_HP_SYS_CNTL_SPEC> {
    ...
    pub fn hp_sleep_uart_wakeup_en(
        &mut self,
    ) -> HP_SLEEP_UART_WAKEUP_EN_W<'_, HP_SLEEP_HP_SYS_CNTL_SPEC> {
    ...
    pub fn hp_sleep_lp_pad_hold_all(
        &mut self,
    ) -> HP_SLEEP_LP_PAD_HOLD_ALL_W<'_, HP_SLEEP_HP_SYS_CNTL_SPEC> {
    ...
    pub fn hp_sleep_hp_pad_hold_all(
        &mut self,
    ) -> HP_SLEEP_HP_PAD_HOLD_ALL_W<'_, HP_SLEEP_HP_SYS_CNTL_SPEC> {
    ...
    pub fn hp_sleep_dig_pad_slp_sel(
        &mut self,
    ) -> HP_SLEEP_DIG_PAD_SLP_SEL_W<'_, HP_SLEEP_HP_SYS_CNTL_SPEC> {
    ...
    pub fn hp_sleep_dig_pause_wdt(
        &mut self,
    ) -> HP_SLEEP_DIG_PAUSE_WDT_W<'_, HP_SLEEP_HP_SYS_CNTL_SPEC> {
    ...
    pub fn hp_sleep_dig_cpu_stall(
        &mut self,
    ) -> HP_SLEEP_DIG_CPU_STALL_W<'_, HP_SLEEP_HP_SYS_CNTL_SPEC> {
