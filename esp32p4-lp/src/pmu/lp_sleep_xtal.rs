...
#[doc = "Field `LP_SLEEP_XPD_XTAL` reader - PMU_LP_SLEEP_XPD_XTAL"]
pub type LP_SLEEP_XPD_XTAL_R = crate::BitReader;
#[doc = "Field `LP_SLEEP_XPD_XTAL` writer - PMU_LP_SLEEP_XPD_XTAL"]
pub type LP_SLEEP_XPD_XTAL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 31 - PMU_LP_SLEEP_XPD_XTAL"]
    #[inline(always)]
...
#[doc = "`reset()` method sets LP_SLEEP_XTAL to value 0"]
