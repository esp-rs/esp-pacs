...
#[doc = "Field `LP_CPU_REJECT_CAUSE` reader - PMU_LP_CPU_REJECT_CAUSE"]
pub type LP_CPU_REJECT_CAUSE_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:30 - PMU_LP_CPU_REJECT_CAUSE"]
    #[inline(always)]
...
#[doc = "PMU_LP_CPU_PWR5\n\nYou can [`read`](crate::Reg::read) this register and get [`lp_cpu_pwr5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
