...
impl W {
    #[doc = "Bits 23:25 - PMU_ANA_0P2A_MUL_1"]
    #[inline(always)]
    pub fn ana_0p2a_mul_1(&mut self) -> ANA_0P2A_MUL_1_W<'_, EXT_LDO_P1_0P2A_ANA_SPEC> {
        ANA_0P2A_MUL_1_W::new(self, 23)
    }
    #[doc = "Bit 26 - PMU_ANA_0P2A_EN_VDET_1"]
    #[inline(always)]
    pub fn ana_0p2a_en_vdet_1(&mut self) -> ANA_0P2A_EN_VDET_1_W<'_, EXT_LDO_P1_0P2A_ANA_SPEC> {
        ANA_0P2A_EN_VDET_1_W::new(self, 26)
    }
    #[doc = "Bit 27 - PMU_ANA_0P2A_EN_CUR_LIM_1"]
    #[inline(always)]
    pub fn ana_0p2a_en_cur_lim_1(
        &mut self,
    ) -> ANA_0P2A_EN_CUR_LIM_1_W<'_, EXT_LDO_P1_0P2A_ANA_SPEC> {
        ANA_0P2A_EN_CUR_LIM_1_W::new(self, 27)
    }
    #[doc = "Bits 28:31 - PMU_ANA_0P2A_DREF_1"]
    #[inline(always)]
    pub fn ana_0p2a_dref_1(&mut self) -> ANA_0P2A_DREF_1_W<'_, EXT_LDO_P1_0P2A_ANA_SPEC> {
        ANA_0P2A_DREF_1_W::new(self, 28)
    }
}
#[doc = "PMU_EXT_LDO_P1_0P2A_ANA\n\nYou can [`read`](crate::Reg::read) this register and get [`ext_ldo_p1_0p2a_ana::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ext_ldo_p1_0p2a_ana::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EXT_LDO_P1_0P2A_ANA_SPEC;
impl crate::RegisterSpec for EXT_LDO_P1_0P2A_ANA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ext_ldo_p1_0p2a_ana::R`](R) reader structure"]
impl crate::Readable for EXT_LDO_P1_0P2A_ANA_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ext_ldo_p1_0p2a_ana::W`](W) writer structure"]
impl crate::Writable for EXT_LDO_P1_0P2A_ANA_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EXT_LDO_P1_0P2A_ANA to value 0"]
