...
#[doc = "Field `XTAL_SLP_CNT_TARGET` reader - PMU_XTAL_SLP_CNT_TARGET"]
pub type XTAL_SLP_CNT_TARGET_R = crate::FieldReader<u16>;
#[doc = "Field `XTAL_SLP_CNT_TARGET` writer - PMU_XTAL_SLP_CNT_TARGET"]
pub type XTAL_SLP_CNT_TARGET_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 16:31 - PMU_XTAL_SLP_CNT_TARGET"]
    #[inline(always)]
    pub fn xtal_slp_cnt_target(&self) -> XTAL_SLP_CNT_TARGET_R {
        XTAL_SLP_CNT_TARGET_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("XTAL_SLP")
            .field("xtal_slp_cnt_target", &self.xtal_slp_cnt_target())
            .finish()
    }
}
impl W {
    #[doc = "Bits 16:31 - PMU_XTAL_SLP_CNT_TARGET"]
    #[inline(always)]
    pub fn xtal_slp_cnt_target(&mut self) -> XTAL_SLP_CNT_TARGET_W<'_, XTAL_SLP_SPEC> {
        XTAL_SLP_CNT_TARGET_W::new(self, 16)
    }
}
...
#[doc = "`reset()` method sets XTAL_SLP to value 0"]
