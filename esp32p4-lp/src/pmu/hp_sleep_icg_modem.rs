...
#[doc = "Field `HP_SLEEP_DIG_ICG_MODEM_CODE` reader - PMU_HP_SLEEP_DIG_ICG_MODEM_CODE"]
pub type HP_SLEEP_DIG_ICG_MODEM_CODE_R = crate::FieldReader;
#[doc = "Field `HP_SLEEP_DIG_ICG_MODEM_CODE` writer - PMU_HP_SLEEP_DIG_ICG_MODEM_CODE"]
pub type HP_SLEEP_DIG_ICG_MODEM_CODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 30:31 - PMU_HP_SLEEP_DIG_ICG_MODEM_CODE"]
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_SLEEP_ICG_MODEM")
            .field(
                ...
                &self.hp_sleep_dig_icg_modem_code(),
            )
            .finish()
    }
}
...
#[doc = "PMU_HP_SLEEP_ICG_MODEM\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_sleep_icg_modem::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_sleep_icg_modem::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
