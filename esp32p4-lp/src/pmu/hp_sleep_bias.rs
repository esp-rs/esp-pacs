...
#[doc = "Field `HP_SLEEP_DCM_VSET` reader - PMU_HP_SLEEP_DCM_VSET"]
pub type HP_SLEEP_DCM_VSET_R = crate::FieldReader;
#[doc = "Field `HP_SLEEP_DCM_VSET` writer - PMU_HP_SLEEP_DCM_VSET"]
pub type HP_SLEEP_DCM_VSET_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `HP_SLEEP_DCM_MODE` reader - PMU_HP_SLEEP_DCM_MODE"]
pub type HP_SLEEP_DCM_MODE_R = crate::FieldReader;
#[doc = "Field `HP_SLEEP_DCM_MODE` writer - PMU_HP_SLEEP_DCM_MODE"]
pub type HP_SLEEP_DCM_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `HP_SLEEP_XPD_BIAS` reader - PMU_HP_SLEEP_XPD_BIAS"]
pub type HP_SLEEP_XPD_BIAS_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_XPD_BIAS` writer - PMU_HP_SLEEP_XPD_BIAS"]
pub type HP_SLEEP_XPD_BIAS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_SLEEP_DBG_ATTEN` reader - PMU_HP_SLEEP_DBG_ATTEN"]
pub type HP_SLEEP_DBG_ATTEN_R = crate::FieldReader;
#[doc = "Field `HP_SLEEP_DBG_ATTEN` writer - PMU_HP_SLEEP_DBG_ATTEN"]
pub type HP_SLEEP_DBG_ATTEN_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `HP_SLEEP_PD_CUR` reader - PMU_HP_SLEEP_PD_CUR"]
pub type HP_SLEEP_PD_CUR_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_PD_CUR` writer - PMU_HP_SLEEP_PD_CUR"]
pub type HP_SLEEP_PD_CUR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_SLEEP_BIAS_SLEEP` reader - PMU_HP_SLEEP_BIAS_SLEEP"]
pub type HP_SLEEP_BIAS_SLEEP_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_BIAS_SLEEP` writer - PMU_HP_SLEEP_BIAS_SLEEP"]
pub type HP_SLEEP_BIAS_SLEEP_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 18:22 - PMU_HP_SLEEP_DCM_VSET"]
    #[inline(always)]
    pub fn hp_sleep_dcm_vset(&self) -> HP_SLEEP_DCM_VSET_R {
        HP_SLEEP_DCM_VSET_R::new(((self.bits >> 18) & 0x1f) as u8)
    }
    #[doc = "Bits 23:24 - PMU_HP_SLEEP_DCM_MODE"]
    #[inline(always)]
    pub fn hp_sleep_dcm_mode(&self) -> HP_SLEEP_DCM_MODE_R {
        HP_SLEEP_DCM_MODE_R::new(((self.bits >> 23) & 3) as u8)
    }
    #[doc = "Bit 25 - PMU_HP_SLEEP_XPD_BIAS"]
    #[inline(always)]
    pub fn hp_sleep_xpd_bias(&self) -> HP_SLEEP_XPD_BIAS_R {
        HP_SLEEP_XPD_BIAS_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bits 26:29 - PMU_HP_SLEEP_DBG_ATTEN"]
    #[inline(always)]
    pub fn hp_sleep_dbg_atten(&self) -> HP_SLEEP_DBG_ATTEN_R {
        HP_SLEEP_DBG_ATTEN_R::new(((self.bits >> 26) & 0x0f) as u8)
    }
    #[doc = "Bit 30 - PMU_HP_SLEEP_PD_CUR"]
    #[inline(always)]
    pub fn hp_sleep_pd_cur(&self) -> HP_SLEEP_PD_CUR_R {
        HP_SLEEP_PD_CUR_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - PMU_HP_SLEEP_BIAS_SLEEP"]
    #[inline(always)]
    pub fn hp_sleep_bias_sleep(&self) -> HP_SLEEP_BIAS_SLEEP_R {
        HP_SLEEP_BIAS_SLEEP_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_SLEEP_BIAS")
            ...
            .field("hp_sleep_bias_sleep", &self.hp_sleep_bias_sleep())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bits 26:29 - PMU_HP_SLEEP_DBG_ATTEN"]
    #[inline(always)]
    pub fn hp_sleep_dbg_atten(&mut self) -> HP_SLEEP_DBG_ATTEN_W<'_, HP_SLEEP_BIAS_SPEC> {
    ...
    #[doc = "Bit 31 - PMU_HP_SLEEP_BIAS_SLEEP"]
    #[inline(always)]
    pub fn hp_sleep_bias_sleep(&mut self) -> HP_SLEEP_BIAS_SLEEP_W<'_, HP_SLEEP_BIAS_SPEC> {
        HP_SLEEP_BIAS_SLEEP_W::new(self, 31)
    }
}
