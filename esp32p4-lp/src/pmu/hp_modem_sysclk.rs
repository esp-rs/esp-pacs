...
#[doc = "Field `HP_MODEM_DIG_SYS_CLK_NO_DIV` writer - PMU_HP_MODEM_DIG_SYS_CLK_NO_DIV"]
pub type HP_MODEM_DIG_SYS_CLK_NO_DIV_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_MODEM_ICG_SYS_CLOCK_EN` writer - PMU_HP_MODEM_ICG_SYS_CLOCK_EN"]
pub type HP_MODEM_ICG_SYS_CLOCK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_MODEM_SYS_CLK_SLP_SEL` writer - PMU_HP_MODEM_SYS_CLK_SLP_SEL"]
pub type HP_MODEM_SYS_CLK_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_MODEM_ICG_SLP_SEL` writer - PMU_HP_MODEM_ICG_SLP_SEL"]
pub type HP_MODEM_ICG_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_MODEM_DIG_SYS_CLK_SEL` writer - PMU_HP_MODEM_DIG_SYS_CLK_SEL"]
...
impl W {
    #[doc = "Bit 26 - PMU_HP_MODEM_DIG_SYS_CLK_NO_DIV"]
    #[inline(always)]
    ...
    #[doc = "Bit 27 - PMU_HP_MODEM_ICG_SYS_CLOCK_EN"]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - PMU_HP_MODEM_SYS_CLK_SLP_SEL"]
    #[inline(always)]
