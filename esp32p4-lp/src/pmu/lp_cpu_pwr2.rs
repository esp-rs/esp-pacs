...
#[doc = "Field `LP_CPU_WAKEUP_EN` reader - PMU_LP_CPU_WAKEUP_EN"]
pub type LP_CPU_WAKEUP_EN_R = crate::FieldReader<u32>;
#[doc = "Field `LP_CPU_WAKEUP_EN` writer - PMU_LP_CPU_WAKEUP_EN"]
pub type LP_CPU_WAKEUP_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 31, u32>;
impl R {
    #[doc = "Bits 0:30 - PMU_LP_CPU_WAKEUP_EN"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:30 - PMU_LP_CPU_WAKEUP_EN"]
    #[inline(always)]
    pub fn lp_cpu_wakeup_en(&mut self) -> LP_CPU_WAKEUP_EN_W<'_, LP_CPU_PWR2_SPEC> {
