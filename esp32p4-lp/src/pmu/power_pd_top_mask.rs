...
impl W {
    #[doc = "Bits 0:4 - PMU_XPD_TOP_MASK"]
    #[inline(always)]
    pub fn xpd_top_mask(&mut self) -> XPD_TOP_MASK_W<'_, POWER_PD_TOP_MASK_SPEC> {
        XPD_TOP_MASK_W::new(self, 0)
    }
    #[doc = "Bits 27:31 - PMU_PD_TOP_MASK"]
    #[inline(always)]
    pub fn pd_top_mask(&mut self) -> PD_TOP_MASK_W<'_, POWER_PD_TOP_MASK_SPEC> {
