...
impl W {
    #[doc = "Bits 0:4 - PMU_XPD_LP_PERI_MASK"]
    #[inline(always)]
    pub fn xpd_lp_peri_mask(&mut self) -> XPD_LP_PERI_MASK_W<'_, POWER_PD_LPPERI_MASK_SPEC> {
        XPD_LP_PERI_MASK_W::new(self, 0)
    }
    #[doc = "Bits 27:31 - PMU_PD_LP_PERI_MASK"]
    #[inline(always)]
    pub fn pd_lp_peri_mask(&mut self) -> PD_LP_PERI_MASK_W<'_, POWER_PD_LPPERI_MASK_SPEC> {
