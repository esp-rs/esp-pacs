...
#[doc = "Field `LP_TRIGGER_HP` writer - PMU_LP_TRIGGER_HP"]
pub type LP_TRIGGER_HP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_TRIGGER_LP` writer - PMU_HP_TRIGGER_LP"]
