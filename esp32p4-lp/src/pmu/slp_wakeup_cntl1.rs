...
impl W {
    ...
    #[doc = "Bit 31 - PMU_SLP_REJECT_EN"]
    #[inline(always)]
    pub fn slp_reject_en(&mut self) -> SLP_REJECT_EN_W<'_, SLP_WAKEUP_CNTL1_SPEC> {
