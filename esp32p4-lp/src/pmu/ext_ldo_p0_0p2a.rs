...
impl W {
    #[doc = "Bit 6 - PMU_0P2A_CNT_CLR_0"]
    #[inline(always)]
    pub fn _0p2a_cnt_clr_0(&mut self) -> _0P2A_CNT_CLR_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
        _0P2A_CNT_CLR_0_W::new(self, 6)
    }
    #[doc = "Bit 7 - PMU_0P2A_FORCE_TIEH_SEL_0"]
    #[inline(always)]
    pub fn _0p2a_force_tieh_sel_0(&mut self) -> _0P2A_FORCE_TIEH_SEL_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
        _0P2A_FORCE_TIEH_SEL_0_W::new(self, 7)
    }
    #[doc = "Bit 8 - PMU_0P2A_XPD_0"]
    #[inline(always)]
    pub fn _0p2a_xpd_0(&mut self) -> _0P2A_XPD_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
        _0P2A_XPD_0_W::new(self, 8)
    }
    #[doc = "Bits 9:11 - PMU_0P2A_TIEH_SEL_0"]
    #[inline(always)]
    pub fn _0p2a_tieh_sel_0(&mut self) -> _0P2A_TIEH_SEL_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
        _0P2A_TIEH_SEL_0_W::new(self, 9)
    }
    #[doc = "Bit 12 - PMU_0P2A_TIEH_POS_EN_0"]
    #[inline(always)]
    pub fn _0p2a_tieh_pos_en_0(&mut self) -> _0P2A_TIEH_POS_EN_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
        _0P2A_TIEH_POS_EN_0_W::new(self, 12)
    }
    #[doc = "Bit 13 - PMU_0P2A_TIEH_NEG_EN_0"]
    #[inline(always)]
    pub fn _0p2a_tieh_neg_en_0(&mut self) -> _0P2A_TIEH_NEG_EN_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
        _0P2A_TIEH_NEG_EN_0_W::new(self, 13)
    }
    #[doc = "Bit 14 - PMU_0P2A_TIEH_0"]
    #[inline(always)]
    pub fn _0p2a_tieh_0(&mut self) -> _0P2A_TIEH_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
        _0P2A_TIEH_0_W::new(self, 14)
    }
    #[doc = "Bits 15:22 - PMU_0P2A_TARGET1_0"]
    #[inline(always)]
    pub fn _0p2a_target1_0(&mut self) -> _0P2A_TARGET1_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
        _0P2A_TARGET1_0_W::new(self, 15)
    }
    #[doc = "Bits 23:30 - PMU_0P2A_TARGET0_0"]
    #[inline(always)]
    pub fn _0p2a_target0_0(&mut self) -> _0P2A_TARGET0_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
    ...
    pub fn _0p2a_ldo_cnt_prescaler_sel_0(
        &mut self,
    ) -> _0P2A_LDO_CNT_PRESCALER_SEL_0_W<'_, EXT_LDO_P0_0P2A_SPEC> {
...
#[doc = "`reset()` method sets EXT_LDO_P0_0P2A to value 0"]
