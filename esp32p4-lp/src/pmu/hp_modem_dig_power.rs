...
#[doc = "Field `HP_MODEM_DCDC_SWITCH_PD_EN` reader - PMU_HP_MODEM_DCDC_SWITCH_PD_EN"]
pub type HP_MODEM_DCDC_SWITCH_PD_EN_R = crate::BitReader;
#[doc = "Field `HP_MODEM_DCDC_SWITCH_PD_EN` writer - PMU_HP_MODEM_DCDC_SWITCH_PD_EN"]
pub type HP_MODEM_DCDC_SWITCH_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_MODEM_HP_MEM_DSLP` writer - PMU_HP_MODEM_HP_MEM_DSLP"]
pub type HP_MODEM_HP_MEM_DSLP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_MODEM_PD_HP_MEM_PD_EN` writer - PMU_HP_MODEM_PD_HP_MEM_PD_EN"]
pub type HP_MODEM_PD_HP_MEM_PD_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `HP_MODEM_PD_HP_WIFI_PD_EN` writer - PMU_HP_MODEM_PD_HP_WIFI_PD_EN"]
pub type HP_MODEM_PD_HP_WIFI_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_MODEM_PD_HP_CPU_PD_EN` writer - PMU_HP_MODEM_PD_HP_CPU_PD_EN"]
pub type HP_MODEM_PD_HP_CPU_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_MODEM_PD_CNNT_PD_EN` writer - PMU_HP_MODEM_PD_CNNT_PD_EN"]
pub type HP_MODEM_PD_CNNT_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_MODEM_PD_TOP_PD_EN` writer - PMU_HP_MODEM_PD_TOP_PD_EN"]
pub type HP_MODEM_PD_TOP_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 21 - PMU_HP_MODEM_DCDC_SWITCH_PD_EN"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 27 - PMU_HP_MODEM_PD_HP_WIFI_PD_EN"]
    #[inline(always)]
    ...
    #[doc = "Bit 29 - PMU_HP_MODEM_PD_HP_CPU_PD_EN"]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - PMU_HP_MODEM_PD_CNNT_PD_EN"]
    #[inline(always)]
    pub fn hp_modem_pd_cnnt_pd_en(
        &mut self,
    ) -> HP_MODEM_PD_CNNT_PD_EN_W<'_, HP_MODEM_DIG_POWER_SPEC> {
        HP_MODEM_PD_CNNT_PD_EN_W::new(self, 30)
    }
    #[doc = "Bit 31 - PMU_HP_MODEM_PD_TOP_PD_EN"]
    #[inline(always)]
