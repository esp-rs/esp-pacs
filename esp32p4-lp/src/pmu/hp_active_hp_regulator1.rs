...
#[doc = "Field `HP_ACTIVE_HP_REGULATOR_DRV_B` reader - PMU_HP_ACTIVE_HP_REGULATOR_DRV_B"]
pub type HP_ACTIVE_HP_REGULATOR_DRV_B_R = crate::FieldReader;
#[doc = "Field `HP_ACTIVE_HP_REGULATOR_DRV_B` writer - PMU_HP_ACTIVE_HP_REGULATOR_DRV_B"]
pub type HP_ACTIVE_HP_REGULATOR_DRV_B_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 26:31 - PMU_HP_ACTIVE_HP_REGULATOR_DRV_B"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_active_hp_regulator_drv_b(
        &mut self,
    ) -> HP_ACTIVE_HP_REGULATOR_DRV_B_W<'_, HP_ACTIVE_HP_REGULATOR1_SPEC> {
