...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EXT_LDO_P1_0P3A_ANA")
            .field("ana_0p3a_mul_1", &self.ana_0p3a_mul_1())
            .field("ana_0p3a_en_vdet_1", &self.ana_0p3a_en_vdet_1())
            .field("ana_0p3a_en_cur_lim_1", &self.ana_0p3a_en_cur_lim_1())
            .field("ana_0p3a_dref_1", &self.ana_0p3a_dref_1())
            .finish()
    }
}
impl W {
    #[doc = "Bits 23:25 - PMU_ANA_0P3A_MUL_1"]
    #[inline(always)]
    pub fn ana_0p3a_mul_1(&mut self) -> ANA_0P3A_MUL_1_W<'_, EXT_LDO_P1_0P3A_ANA_SPEC> {
        ANA_0P3A_MUL_1_W::new(self, 23)
    }
    #[doc = "Bit 26 - PMU_ANA_0P3A_EN_VDET_1"]
    #[inline(always)]
    pub fn ana_0p3a_en_vdet_1(&mut self) -> ANA_0P3A_EN_VDET_1_W<'_, EXT_LDO_P1_0P3A_ANA_SPEC> {
    ...
    pub fn ana_0p3a_en_cur_lim_1(
        &mut self,
    ) -> ANA_0P3A_EN_CUR_LIM_1_W<'_, EXT_LDO_P1_0P3A_ANA_SPEC> {
        ANA_0P3A_EN_CUR_LIM_1_W::new(self, 27)
    }
    #[doc = "Bits 28:31 - PMU_ANA_0P3A_DREF_1"]
    #[inline(always)]
    pub fn ana_0p3a_dref_1(&mut self) -> ANA_0P3A_DREF_1_W<'_, EXT_LDO_P1_0P3A_ANA_SPEC> {
...
#[doc = "`reset()` method sets EXT_LDO_P1_0P3A_ANA to value 0"]
