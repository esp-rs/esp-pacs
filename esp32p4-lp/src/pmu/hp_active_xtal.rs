...
#[doc = "Field `HP_ACTIVE_XPD_XTAL` reader - PMU_HP_ACTIVE_XPD_XTAL"]
pub type HP_ACTIVE_XPD_XTAL_R = crate::BitReader;
#[doc = "Field `HP_ACTIVE_XPD_XTAL` writer - PMU_HP_ACTIVE_XPD_XTAL"]
pub type HP_ACTIVE_XPD_XTAL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 31 - PMU_HP_ACTIVE_XPD_XTAL"]
    #[inline(always)]
...
#[doc = "`reset()` method sets HP_ACTIVE_XTAL to value 0"]
