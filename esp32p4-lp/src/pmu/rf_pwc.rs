...
impl W {
    #[doc = "Bit 24 - PMU_MSPI_PHY_XPD"]
    #[inline(always)]
    pub fn mspi_phy_xpd(&mut self) -> MSPI_PHY_XPD_W<'_, RF_PWC_SPEC> {
        MSPI_PHY_XPD_W::new(self, 24)
    }
    #[doc = "Bit 25 - PMU_SDIO_PLL_XPD"]
    #[inline(always)]
    pub fn sdio_pll_xpd(&mut self) -> SDIO_PLL_XPD_W<'_, RF_PWC_SPEC> {
