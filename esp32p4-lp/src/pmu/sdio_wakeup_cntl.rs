...
#[doc = "Field `SDIO_ACT_DNUM` reader - PMU_SDIO_ACT_DNUM"]
pub type SDIO_ACT_DNUM_R = crate::FieldReader<u16>;
#[doc = "Field `SDIO_ACT_DNUM` writer - PMU_SDIO_ACT_DNUM"]
pub type SDIO_ACT_DNUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    #[doc = "Bits 0:9 - PMU_SDIO_ACT_DNUM"]
    #[inline(always)]
...
#[doc = "`reset()` method sets SDIO_WAKEUP_CNTL to value 0"]
