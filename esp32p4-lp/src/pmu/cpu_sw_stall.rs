...
#[doc = "Field `HPCORE1_SW_STALL_CODE` reader - PMU_HPCORE1_SW_STALL_CODE"]
pub type HPCORE1_SW_STALL_CODE_R = crate::FieldReader;
#[doc = "Field `HPCORE1_SW_STALL_CODE` writer - PMU_HPCORE1_SW_STALL_CODE"]
pub type HPCORE1_SW_STALL_CODE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `HPCORE0_SW_STALL_CODE` reader - PMU_HPCORE0_SW_STALL_CODE"]
pub type HPCORE0_SW_STALL_CODE_R = crate::FieldReader;
#[doc = "Field `HPCORE0_SW_STALL_CODE` writer - PMU_HPCORE0_SW_STALL_CODE"]
pub type HPCORE0_SW_STALL_CODE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 16:23 - PMU_HPCORE1_SW_STALL_CODE"]
    #[inline(always)]
    pub fn hpcore1_sw_stall_code(&self) -> HPCORE1_SW_STALL_CODE_R {
        HPCORE1_SW_STALL_CODE_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - PMU_HPCORE0_SW_STALL_CODE"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 16:23 - PMU_HPCORE1_SW_STALL_CODE"]
    #[inline(always)]
    pub fn hpcore1_sw_stall_code(&mut self) -> HPCORE1_SW_STALL_CODE_W<'_, CPU_SW_STALL_SPEC> {
        HPCORE1_SW_STALL_CODE_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - PMU_HPCORE0_SW_STALL_CODE"]
    #[inline(always)]
    pub fn hpcore0_sw_stall_code(&mut self) -> HPCORE0_SW_STALL_CODE_W<'_, CPU_SW_STALL_SPEC> {
