...
#[doc = "Field `TIE_LOW_CALI_XTAL_ICG` reader - PMU_TIE_LOW_CALI_XTAL_ICG"]
pub type TIE_LOW_CALI_XTAL_ICG_R = crate::BitReader;
#[doc = "Field `TIE_LOW_CALI_XTAL_ICG` writer - PMU_TIE_LOW_CALI_XTAL_ICG"]
pub type TIE_LOW_CALI_XTAL_ICG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIE_LOW_GLOBAL_PLL_ICG` writer - PMU_TIE_LOW_GLOBAL_PLL_ICG"]
pub type TIE_LOW_GLOBAL_PLL_ICG_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TIE_LOW_GLOBAL_XTAL_ICG` writer - PMU_TIE_LOW_GLOBAL_XTAL_ICG"]
pub type TIE_LOW_GLOBAL_XTAL_ICG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIE_LOW_I2C_RETENTION` writer - PMU_TIE_LOW_I2C_RETENTION"]
pub type TIE_LOW_I2C_RETENTION_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIE_LOW_XPD_PLL_I2C` writer - PMU_TIE_LOW_XPD_PLL_I2C"]
pub type TIE_LOW_XPD_PLL_I2C_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TIE_LOW_XPD_PLL` writer - PMU_TIE_LOW_XPD_PLL"]
pub type TIE_LOW_XPD_PLL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TIE_LOW_XPD_XTAL` writer - PMU_TIE_LOW_XPD_XTAL"]
pub type TIE_LOW_XPD_XTAL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIE_HIGH_CALI_XTAL_ICG` reader - PMU_TIE_HIGH_CALI_XTAL_ICG"]
pub type TIE_HIGH_CALI_XTAL_ICG_R = crate::BitReader;
#[doc = "Field `TIE_HIGH_CALI_XTAL_ICG` writer - PMU_TIE_HIGH_CALI_XTAL_ICG"]
pub type TIE_HIGH_CALI_XTAL_ICG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIE_HIGH_GLOBAL_PLL_ICG` writer - PMU_TIE_HIGH_GLOBAL_PLL_ICG"]
pub type TIE_HIGH_GLOBAL_PLL_ICG_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TIE_HIGH_GLOBAL_XTAL_ICG` writer - PMU_TIE_HIGH_GLOBAL_XTAL_ICG"]
pub type TIE_HIGH_GLOBAL_XTAL_ICG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIE_HIGH_I2C_RETENTION` writer - PMU_TIE_HIGH_I2C_RETENTION"]
pub type TIE_HIGH_I2C_RETENTION_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIE_HIGH_XPD_PLL_I2C` writer - PMU_TIE_HIGH_XPD_PLL_I2C"]
pub type TIE_HIGH_XPD_PLL_I2C_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TIE_HIGH_XPD_PLL` writer - PMU_TIE_HIGH_XPD_PLL"]
pub type TIE_HIGH_XPD_PLL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TIE_HIGH_XPD_XTAL` writer - PMU_TIE_HIGH_XPD_XTAL"]
pub type TIE_HIGH_XPD_XTAL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - PMU_TIE_LOW_CALI_XTAL_ICG"]
    #[inline(always)]
    pub fn tie_low_cali_xtal_icg(&self) -> TIE_LOW_CALI_XTAL_ICG_R {
        TIE_LOW_CALI_XTAL_ICG_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 16 - PMU_TIE_HIGH_CALI_XTAL_ICG"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 1:4 - PMU_TIE_LOW_GLOBAL_PLL_ICG"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - PMU_TIE_LOW_GLOBAL_XTAL_ICG"]
    #[inline(always)]
    ...
    #[doc = "Bits 17:20 - PMU_TIE_HIGH_GLOBAL_PLL_ICG"]
    #[inline(always)]
    ...
    #[doc = "Bit 21 - PMU_TIE_HIGH_GLOBAL_XTAL_ICG"]
    #[inline(always)]
    ...
    #[doc = "Bit 22 - PMU_TIE_HIGH_I2C_RETENTION"]
    #[inline(always)]
