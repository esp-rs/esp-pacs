...
impl W {
    #[doc = "Bit 0 - PMU_FORCE_TOP_RESET"]
    #[inline(always)]
    pub fn force_top_reset(&mut self) -> FORCE_TOP_RESET_W<'_, POWER_PD_TOP_CNTL_SPEC> {
        FORCE_TOP_RESET_W::new(self, 0)
    }
    #[doc = "Bit 1 - PMU_FORCE_TOP_ISO"]
    #[inline(always)]
    pub fn force_top_iso(&mut self) -> FORCE_TOP_ISO_W<'_, POWER_PD_TOP_CNTL_SPEC> {
        FORCE_TOP_ISO_W::new(self, 1)
    }
    #[doc = "Bit 2 - PMU_FORCE_TOP_PU"]
    #[inline(always)]
    pub fn force_top_pu(&mut self) -> FORCE_TOP_PU_W<'_, POWER_PD_TOP_CNTL_SPEC> {
        FORCE_TOP_PU_W::new(self, 2)
    }
    #[doc = "Bit 3 - PMU_FORCE_TOP_NO_RESET"]
    #[inline(always)]
    pub fn force_top_no_reset(&mut self) -> FORCE_TOP_NO_RESET_W<'_, POWER_PD_TOP_CNTL_SPEC> {
        FORCE_TOP_NO_RESET_W::new(self, 3)
    }
    #[doc = "Bit 4 - PMU_FORCE_TOP_NO_ISO"]
    #[inline(always)]
    pub fn force_top_no_iso(&mut self) -> FORCE_TOP_NO_ISO_W<'_, POWER_PD_TOP_CNTL_SPEC> {
        FORCE_TOP_NO_ISO_W::new(self, 4)
    }
    #[doc = "Bit 5 - PMU_FORCE_TOP_PD"]
    #[inline(always)]
    pub fn force_top_pd(&mut self) -> FORCE_TOP_PD_W<'_, POWER_PD_TOP_CNTL_SPEC> {
...
#[doc = "`reset()` method sets POWER_PD_TOP_CNTL to value 0"]
