...
#[doc = "Field `TIE_LOW_LP_ROOTCLK_SEL` writer - PMU_TIE_LOW_LP_ROOTCLK_SEL"]
pub type TIE_LOW_LP_ROOTCLK_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIE_HIGH_LP_ROOTCLK_SEL` writer - PMU_TIE_HIGH_LP_ROOTCLK_SEL"]
