...
#[doc = "Field `HP_MODEM_DIG_ICG_APB_EN` writer - PMU_HP_MODEM_DIG_ICG_APB_EN"]
...
impl W {
    #[doc = "Bits 0:31 - PMU_HP_MODEM_DIG_ICG_APB_EN"]
    #[inline(always)]
...
#[doc = "PMU_HP_MODEM_ICG_HP_APB\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_modem_icg_hp_apb::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets HP_MODEM_ICG_HP_APB to value 0"]
