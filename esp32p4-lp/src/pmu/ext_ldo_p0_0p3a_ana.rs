...
impl W {
    #[doc = "Bits 23:25 - PMU_ANA_0P3A_MUL_0"]
    #[inline(always)]
    pub fn ana_0p3a_mul_0(&mut self) -> ANA_0P3A_MUL_0_W<'_, EXT_LDO_P0_0P3A_ANA_SPEC> {
        ANA_0P3A_MUL_0_W::new(self, 23)
    }
    #[doc = "Bit 26 - PMU_ANA_0P3A_EN_VDET_0"]
    #[inline(always)]
    pub fn ana_0p3a_en_vdet_0(&mut self) -> ANA_0P3A_EN_VDET_0_W<'_, EXT_LDO_P0_0P3A_ANA_SPEC> {
        ANA_0P3A_EN_VDET_0_W::new(self, 26)
    }
    #[doc = "Bit 27 - PMU_ANA_0P3A_EN_CUR_LIM_0"]
    #[inline(always)]
    pub fn ana_0p3a_en_cur_lim_0(
        &mut self,
    ) -> ANA_0P3A_EN_CUR_LIM_0_W<'_, EXT_LDO_P0_0P3A_ANA_SPEC> {
        ANA_0P3A_EN_CUR_LIM_0_W::new(self, 27)
    }
    #[doc = "Bits 28:31 - PMU_ANA_0P3A_DREF_0"]
    #[inline(always)]
    pub fn ana_0p3a_dref_0(&mut self) -> ANA_0P3A_DREF_0_W<'_, EXT_LDO_P0_0P3A_ANA_SPEC> {
...
#[doc = "`reset()` method sets EXT_LDO_P0_0P3A_ANA to value 0"]
