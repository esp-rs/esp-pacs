...
#[doc = "Field `HP_ACTIVE_BACKUP_ICG_FUNC_EN` reader - PMU_HP_ACTIVE_BACKUP_ICG_FUNC_EN"]
pub type HP_ACTIVE_BACKUP_ICG_FUNC_EN_R = crate::FieldReader<u32>;
#[doc = "Field `HP_ACTIVE_BACKUP_ICG_FUNC_EN` writer - PMU_HP_ACTIVE_BACKUP_ICG_FUNC_EN"]
pub type HP_ACTIVE_BACKUP_ICG_FUNC_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - PMU_HP_ACTIVE_BACKUP_ICG_FUNC_EN"]
    #[inline(always)]
