...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("POWER_PD_HP_CPU_CNTL")
...
impl W {
    #[doc = "Bit 0 - PMU_FORCE_HP_CPU_RESET"]
    #[inline(always)]
    pub fn force_hp_cpu_reset(&mut self) -> FORCE_HP_CPU_RESET_W<'_, POWER_PD_HP_CPU_CNTL_SPEC> {
        FORCE_HP_CPU_RESET_W::new(self, 0)
    }
    #[doc = "Bit 1 - PMU_FORCE_HP_CPU_ISO"]
    #[inline(always)]
    pub fn force_hp_cpu_iso(&mut self) -> FORCE_HP_CPU_ISO_W<'_, POWER_PD_HP_CPU_CNTL_SPEC> {
        FORCE_HP_CPU_ISO_W::new(self, 1)
    }
    #[doc = "Bit 2 - PMU_FORCE_HP_CPU_PU"]
    #[inline(always)]
    pub fn force_hp_cpu_pu(&mut self) -> FORCE_HP_CPU_PU_W<'_, POWER_PD_HP_CPU_CNTL_SPEC> {
    ...
    pub fn force_hp_cpu_no_reset(
        &mut self,
    ) -> FORCE_HP_CPU_NO_RESET_W<'_, POWER_PD_HP_CPU_CNTL_SPEC> {
        FORCE_HP_CPU_NO_RESET_W::new(self, 3)
    }
    #[doc = "Bit 4 - PMU_FORCE_HP_CPU_NO_ISO"]
    #[inline(always)]
    pub fn force_hp_cpu_no_iso(&mut self) -> FORCE_HP_CPU_NO_ISO_W<'_, POWER_PD_HP_CPU_CNTL_SPEC> {
        FORCE_HP_CPU_NO_ISO_W::new(self, 4)
    }
    #[doc = "Bit 5 - PMU_FORCE_HP_CPU_PD"]
    #[inline(always)]
    pub fn force_hp_cpu_pd(&mut self) -> FORCE_HP_CPU_PD_W<'_, POWER_PD_HP_CPU_CNTL_SPEC> {
...
pub struct POWER_PD_HP_CPU_CNTL_SPEC;
impl crate::RegisterSpec for POWER_PD_HP_CPU_CNTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`power_pd_hp_cpu_cntl::R`](R) reader structure"]
impl crate::Readable for POWER_PD_HP_CPU_CNTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`power_pd_hp_cpu_cntl::W`](W) writer structure"]
impl crate::Writable for POWER_PD_HP_CPU_CNTL_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets POWER_PD_HP_CPU_CNTL to value 0"]
impl crate::Resettable for POWER_PD_HP_CPU_CNTL_SPEC {}
