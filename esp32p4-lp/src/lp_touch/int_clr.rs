...
#[doc = "Field `BASELINE_UPDATE_INT_CLR` writer - need_des"]
pub type BASELINE_UPDATE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn scan_done_int_clr(&mut self) -> SCAN_DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn active_int_clr(&mut self) -> ACTIVE_INT_CLR_W<'_, INT_CLR_SPEC> {
        ACTIVE_INT_CLR_W::new(self, 2)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    pub fn inactive_int_clr(&mut self) -> INACTIVE_INT_CLR_W<'_, INT_CLR_SPEC> {
        INACTIVE_INT_CLR_W::new(self, 3)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    pub fn timeout_int_clr(&mut self) -> TIMEOUT_INT_CLR_W<'_, INT_CLR_SPEC> {
        TIMEOUT_INT_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    pub fn approach_loop_done_int_clr(&mut self) -> APPROACH_LOOP_DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
        APPROACH_LOOP_DONE_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - need_des"]
    #[inline(always)]
    pub fn baseline_update_int_clr(&mut self) -> BASELINE_UPDATE_INT_CLR_W<'_, INT_CLR_SPEC> {
        BASELINE_UPDATE_INT_CLR_W::new(self, 6)
    }
}
