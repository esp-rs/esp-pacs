...
#[doc = "Field `BASELINE_UPDATE_INT_ENA` reader - need_des"]
pub type BASELINE_UPDATE_INT_ENA_R = crate::BitReader;
#[doc = "Field `BASELINE_UPDATE_INT_ENA` writer - need_des"]
pub type BASELINE_UPDATE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - need_des"]
    #[inline(always)]
    pub fn baseline_update_int_ena(&self) -> BASELINE_UPDATE_INT_ENA_R {
        BASELINE_UPDATE_INT_ENA_R::new(((self.bits >> 6) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            .field("scan_done_int_ena", &self.scan_done_int_ena())
            .field("done_int_ena", &self.done_int_ena())
            .field("active_int_ena", &self.active_int_ena())
            .field("inactive_int_ena", &self.inactive_int_ena())
            .field("timeout_int_ena", &self.timeout_int_ena())
            .field(
                "approach_loop_done_int_ena",
                &self.approach_loop_done_int_ena(),
            )
            .field("baseline_update_int_ena", &self.baseline_update_int_ena())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn scan_done_int_ena(&mut self) -> SCAN_DONE_INT_ENA_W<'_, INT_ENA_SPEC> {
    ...
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn active_int_ena(&mut self) -> ACTIVE_INT_ENA_W<'_, INT_ENA_SPEC> {
        ACTIVE_INT_ENA_W::new(self, 2)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    pub fn inactive_int_ena(&mut self) -> INACTIVE_INT_ENA_W<'_, INT_ENA_SPEC> {
        INACTIVE_INT_ENA_W::new(self, 3)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    pub fn timeout_int_ena(&mut self) -> TIMEOUT_INT_ENA_W<'_, INT_ENA_SPEC> {
        TIMEOUT_INT_ENA_W::new(self, 4)
    }
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    pub fn approach_loop_done_int_ena(&mut self) -> APPROACH_LOOP_DONE_INT_ENA_W<'_, INT_ENA_SPEC> {
        APPROACH_LOOP_DONE_INT_ENA_W::new(self, 5)
    }
    #[doc = "Bit 6 - need_des"]
    #[inline(always)]
    pub fn baseline_update_int_ena(&mut self) -> BASELINE_UPDATE_INT_ENA_W<'_, INT_ENA_SPEC> {
        BASELINE_UPDATE_INT_ENA_W::new(self, 6)
    }
}
