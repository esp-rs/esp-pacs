...
impl W {
    #[doc = "Bits 0:14 - need_des"]
    #[inline(always)]
    pub fn touch_start(&mut self) -> TOUCH_START_W<'_, TOUCH_MUX1_SPEC> {
        TOUCH_START_W::new(self, 0)
    }
    #[doc = "Bits 15:29 - need_des"]
    #[inline(always)]
    pub fn touch_xpd(&mut self) -> TOUCH_XPD_W<'_, TOUCH_MUX1_SPEC> {
        TOUCH_XPD_W::new(self, 15)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`touch_mux1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`touch_mux1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
