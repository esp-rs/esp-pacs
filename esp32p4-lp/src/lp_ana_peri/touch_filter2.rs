...
impl W {
    #[doc = "Bits 15:29 - need_des"]
    #[inline(always)]
    pub fn touch_outen(&mut self) -> TOUCH_OUTEN_W<'_, TOUCH_FILTER2_SPEC> {
    ...
    pub fn touch_bypass_noise_thres(
        &mut self,
    ) -> TOUCH_BYPASS_NOISE_THRES_W<'_, TOUCH_FILTER2_SPEC> {
    ...
    pub fn touch_bypass_neg_noise_thres(
        &mut self,
    ) -> TOUCH_BYPASS_NEG_NOISE_THRES_W<'_, TOUCH_FILTER2_SPEC> {
