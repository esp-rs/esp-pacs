...
impl W {
    #[doc = "Bits 0:6 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_dcap_lpf(
        &mut self,
    ) -> TOUCH_FREQ2_DCAP_LPF_W<'_, TOUCH_FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_DCAP_LPF_W::new(self, 0)
    }
    #[doc = "Bits 7:8 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_dres_lpf(
        &mut self,
    ) -> TOUCH_FREQ2_DRES_LPF_W<'_, TOUCH_FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_DRES_LPF_W::new(self, 7)
    }
    #[doc = "Bits 9:12 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_drv_ls(&mut self) -> TOUCH_FREQ2_DRV_LS_W<'_, TOUCH_FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_DRV_LS_W::new(self, 9)
    }
    #[doc = "Bits 13:17 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_drv_hs(&mut self) -> TOUCH_FREQ2_DRV_HS_W<'_, TOUCH_FREQ2_SCAN_PARA_SPEC> {
        TOUCH_FREQ2_DRV_HS_W::new(self, 13)
    }
    #[doc = "Bits 18:22 - need_des"]
    #[inline(always)]
    pub fn touch_freq2_dbias(&mut self) -> TOUCH_FREQ2_DBIAS_W<'_, TOUCH_FREQ2_SCAN_PARA_SPEC> {
