...
#[doc = "Field `SCL_STOP_SETUP_TIME` reader - This register is used to configure the time between the positive edgeof SCL and the positive edge of SDA, in I2C module clock cycles."]
pub type SCL_STOP_SETUP_TIME_R = crate::FieldReader<u16>;
#[doc = "Field `SCL_STOP_SETUP_TIME` writer - This register is used to configure the time between the positive edgeof SCL and the positive edge of SDA, in I2C module clock cycles."]
pub type SCL_STOP_SETUP_TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ...
    pub fn scl_stop_setup_time(&self) -> SCL_STOP_SETUP_TIME_R {
        SCL_STOP_SETUP_TIME_R::new((self.bits & 0x01ff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SCL_STOP_SETUP")
            .field("scl_stop_setup_time", &self.scl_stop_setup_time())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:8 - This register is used to configure the time between the positive edgeof SCL and the positive edge of SDA, in I2C module clock cycles."]
    #[inline(always)]
    pub fn scl_stop_setup_time(&mut self) -> SCL_STOP_SETUP_TIME_W<'_, SCL_STOP_SETUP_SPEC> {
        SCL_STOP_SETUP_TIME_W::new(self, 0)
    }
}
