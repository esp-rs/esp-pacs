...
#[doc = "Field `SCL_STOP_HOLD_TIME` reader - This register is used to configure the delay after the STOP condition,in I2C module clock cycles."]
pub type SCL_STOP_HOLD_TIME_R = crate::FieldReader<u16>;
#[doc = "Field `SCL_STOP_HOLD_TIME` writer - This register is used to configure the delay after the STOP condition,in I2C module clock cycles."]
pub type SCL_STOP_HOLD_TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ...
    pub fn scl_stop_hold_time(&self) -> SCL_STOP_HOLD_TIME_R {
        SCL_STOP_HOLD_TIME_R::new((self.bits & 0x01ff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SCL_STOP_HOLD")
            .field("scl_stop_hold_time", &self.scl_stop_hold_time())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:8 - This register is used to configure the delay after the STOP condition,in I2C module clock cycles."]
    #[inline(always)]
    pub fn scl_stop_hold_time(&mut self) -> SCL_STOP_HOLD_TIME_W<'_, SCL_STOP_HOLD_SPEC> {
        SCL_STOP_HOLD_TIME_W::new(self, 0)
    }
}
