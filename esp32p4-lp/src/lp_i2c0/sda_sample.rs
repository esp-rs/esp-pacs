...
#[doc = "Field `SDA_SAMPLE_TIME` reader - This register is used to configure for how long SDA is sampled, in I2C module clock cycles."]
pub type SDA_SAMPLE_TIME_R = crate::FieldReader<u16>;
#[doc = "Field `SDA_SAMPLE_TIME` writer - This register is used to configure for how long SDA is sampled, in I2C module clock cycles."]
