...
impl W {
    ...
    pub fn reg_gpio_func9_in_inv_sel(
        &mut self,
    ) -> REG_GPIO_FUNC9_IN_INV_SEL_W<'_, FUNC9_IN_SEL_CFG_SPEC> {
        REG_GPIO_FUNC9_IN_INV_SEL_W::new(self, 0)
    }
    #[doc = "Bit 1 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_sig9_in_sel(&mut self) -> REG_GPIO_SIG9_IN_SEL_W<'_, FUNC9_IN_SEL_CFG_SPEC> {
        REG_GPIO_SIG9_IN_SEL_W::new(self, 1)
    }
    #[doc = "Bits 2:7 - Reserved"]
    #[inline(always)]
    pub fn reg_gpio_func9_in_sel(&mut self) -> REG_GPIO_FUNC9_IN_SEL_W<'_, FUNC9_IN_SEL_CFG_SPEC> {
