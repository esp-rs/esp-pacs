...
impl W {
    #[doc = "Bits 0:2 - pad comp dref"]
    #[inline(always)]
    pub fn dref_comp0(&mut self) -> DREF_COMP0_W<'_, PAD_COMP0_SPEC> {
        DREF_COMP0_W::new(self, 0)
    }
    #[doc = "Bit 3 - pad comp mode"]
    #[inline(always)]
    pub fn mode_comp0(&mut self) -> MODE_COMP0_W<'_, PAD_COMP0_SPEC> {
        MODE_COMP0_W::new(self, 3)
    }
    #[doc = "Bit 4 - pad comp xpd"]
    #[inline(always)]
    pub fn xpd_comp0(&mut self) -> XPD_COMP0_W<'_, PAD_COMP0_SPEC> {
        XPD_COMP0_W::new(self, 4)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`pad_comp0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pad_comp0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
