...
impl W {
    #[doc = "Bit 0 - Write 1 to enable lp addrhole int"]
    #[inline(always)]
    pub fn lp_addrhole_int_ena(&mut self) -> LP_ADDRHOLE_INT_ENA_W<'_, INT_ENA_SPEC> {
        LP_ADDRHOLE_INT_ENA_W::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 to enable idbus addrhole int"]
    #[inline(always)]
    pub fn idbus_addrhole_int_ena(&mut self) -> IDBUS_ADDRHOLE_INT_ENA_W<'_, INT_ENA_SPEC> {
    ...
    pub fn lp_core_ahb_timeout_int_ena(
        &mut self,
    ) -> LP_CORE_AHB_TIMEOUT_INT_ENA_W<'_, INT_ENA_SPEC> {
