...
pub type RX_FIFOMEM_UDF_INT_RAW_R = crate::BitReader;
...
#[doc = "Field `RX_MEM_THRESHOLD_INT_RAW` reader - The raw interrupt status bit for the rx_mem_threshold_int interrupt"]
pub type RX_MEM_THRESHOLD_INT_RAW_R = crate::BitReader;
impl R {
    ...
    pub fn rx_hung_int_raw(&self) -> RX_HUNG_INT_RAW_R {
        RX_HUNG_INT_RAW_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The raw interrupt status bit for the i2s_rx_fifomem_udf_int interrupt"]
    #[inline(always)]
    pub fn rx_fifomem_udf_int_raw(&self) -> RX_FIFOMEM_UDF_INT_RAW_R {
        RX_FIFOMEM_UDF_INT_RAW_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - The raw interrupt status bit for the vad_done_int interrupt"]
    #[inline(always)]
    pub fn vad_done_int_raw(&self) -> VAD_DONE_INT_RAW_R {
        VAD_DONE_INT_RAW_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - The raw interrupt status bit for the vad_reset_done_int interrupt"]
    #[inline(always)]
    pub fn vad_reset_done_int_raw(&self) -> VAD_RESET_DONE_INT_RAW_R {
        VAD_RESET_DONE_INT_RAW_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - The raw interrupt status bit for the rx_mem_threshold_int interrupt"]
    #[inline(always)]
    pub fn rx_mem_threshold_int_raw(&self) -> RX_MEM_THRESHOLD_INT_RAW_R {
        RX_MEM_THRESHOLD_INT_RAW_R::new(((self.bits >> 5) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW")
            .field("rx_done_int_raw", &self.rx_done_int_raw())
            .field("rx_hung_int_raw", &self.rx_hung_int_raw())
            .field("rx_fifomem_udf_int_raw", &self.rx_fifomem_udf_int_raw())
            .field("vad_done_int_raw", &self.vad_done_int_raw())
            .field("vad_reset_done_int_raw", &self.vad_reset_done_int_raw())
            .field("rx_mem_threshold_int_raw", &self.rx_mem_threshold_int_raw())
            .finish()
    }
}
