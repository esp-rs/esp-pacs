...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            ...
            .field("rx_fifomem_udf_int_ena", &self.rx_fifomem_udf_int_ena())
            .field("lp_vad_done_int_ena", &self.lp_vad_done_int_ena())
            .field(
                "lp_vad_reset_done_int_ena",
                &self.lp_vad_reset_done_int_ena(),
            )
            .field("rx_mem_threshold_int_ena", &self.rx_mem_threshold_int_ena())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 2 - The interrupt enable bit for the i2s_rx_fifomem_udf_int interrupt"]
    #[inline(always)]
    pub fn rx_fifomem_udf_int_ena(&mut self) -> RX_FIFOMEM_UDF_INT_ENA_W<'_, INT_ENA_SPEC> {
        RX_FIFOMEM_UDF_INT_ENA_W::new(self, 2)
    }
    #[doc = "Bit 3 - The interrupt enable bit for the vad_done_int interrupt"]
    #[inline(always)]
    pub fn lp_vad_done_int_ena(&mut self) -> LP_VAD_DONE_INT_ENA_W<'_, INT_ENA_SPEC> {
        LP_VAD_DONE_INT_ENA_W::new(self, 3)
    }
    #[doc = "Bit 4 - The interrupt enable bit for the vad_reset_done_int interrupt"]
    #[inline(always)]
    pub fn lp_vad_reset_done_int_ena(&mut self) -> LP_VAD_RESET_DONE_INT_ENA_W<'_, INT_ENA_SPEC> {
        LP_VAD_RESET_DONE_INT_ENA_W::new(self, 4)
    }
    #[doc = "Bit 5 - The interrupt enable bit for the rx_mem_threshold_int interrupt"]
    #[inline(always)]
    pub fn rx_mem_threshold_int_ena(&mut self) -> RX_MEM_THRESHOLD_INT_ENA_W<'_, INT_ENA_SPEC> {
