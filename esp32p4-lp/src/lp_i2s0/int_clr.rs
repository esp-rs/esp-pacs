...
impl W {
    ...
    #[inline(always)]
    pub fn rx_fifomem_udf_int_clr(&mut self) -> RX_FIFOMEM_UDF_INT_CLR_W<'_, INT_CLR_SPEC> {
        RX_FIFOMEM_UDF_INT_CLR_W::new(self, 2)
    }
    #[doc = "Bit 3 - Set this bit to clear the vad_done_int interrupt"]
    #[inline(always)]
    pub fn lp_vad_done_int_clr(&mut self) -> LP_VAD_DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
        LP_VAD_DONE_INT_CLR_W::new(self, 3)
    }
    #[doc = "Bit 4 - Set this bit to clear the vad_reset_done_int interrupt"]
    #[inline(always)]
    pub fn lp_vad_reset_done_int_clr(&mut self) -> LP_VAD_RESET_DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
        LP_VAD_RESET_DONE_INT_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - Set this bit to clear the rx_mem_threshold_int interrupt"]
    #[inline(always)]
    pub fn rx_mem_threshold_int_clr(&mut self) -> RX_MEM_THRESHOLD_INT_CLR_W<'_, INT_CLR_SPEC> {
