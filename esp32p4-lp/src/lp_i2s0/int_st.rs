...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            ...
            .field("rx_fifomem_udf_int_st", &self.rx_fifomem_udf_int_st())
            .field("lp_vad_done_int_st", &self.lp_vad_done_int_st())
            .field("lp_vad_reset_done_int_st", &self.lp_vad_reset_done_int_st())
            .field("rx_mem_threshold_int_st", &self.rx_mem_threshold_int_st())
            .finish()
    }
}
