...
impl W {
    ...
    pub fn cocpu_saradc1_int_ena_w1ts(
        &mut self,
    ) -> COCPU_SARADC1_INT_ENA_W1TS_W<'_, INT_ENA_W1TS_SPEC> {
    ...
    pub fn cocpu_saradc2_int_ena_w1ts(
        &mut self,
    ) -> COCPU_SARADC2_INT_ENA_W1TS_W<'_, INT_ENA_W1TS_SPEC> {
    ...
    pub fn cocpu_saradc1_error_int_ena_w1ts(
        &mut self,
    ) -> COCPU_SARADC1_ERROR_INT_ENA_W1TS_W<'_, INT_ENA_W1TS_SPEC> {
    ...
    pub fn cocpu_saradc2_error_int_ena_w1ts(
        &mut self,
    ) -> COCPU_SARADC2_ERROR_INT_ENA_W1TS_W<'_, INT_ENA_W1TS_SPEC> {
    ...
    pub fn cocpu_saradc1_wake_int_ena_w1ts(
        &mut self,
    ) -> COCPU_SARADC1_WAKE_INT_ENA_W1TS_W<'_, INT_ENA_W1TS_SPEC> {
    ...
    pub fn cocpu_saradc2_wake_int_ena_w1ts(
        &mut self,
    ) -> COCPU_SARADC2_WAKE_INT_ENA_W1TS_W<'_, INT_ENA_W1TS_SPEC> {
