...
#[doc = "Field `LP_REG_BUF3` reader - data buffer"]
pub type LP_REG_BUF3_R = crate::FieldReader<u32>;
#[doc = "Field `LP_REG_BUF3` writer - data buffer"]
pub type LP_REG_BUF3_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf3(&self) -> LP_REG_BUF3_R {
        LP_REG_BUF3_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("W3")
            .field("lp_reg_buf3", &self.lp_reg_buf3())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf3(&mut self) -> LP_REG_BUF3_W<'_, W3_SPEC> {
        LP_REG_BUF3_W::new(self, 0)
    }
}
