...
#[doc = "Field `LP_REG_BUF1` reader - data buffer"]
pub type LP_REG_BUF1_R = crate::FieldReader<u32>;
#[doc = "Field `LP_REG_BUF1` writer - data buffer"]
pub type LP_REG_BUF1_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf1(&self) -> LP_REG_BUF1_R {
        LP_REG_BUF1_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("W1")
            .field("lp_reg_buf1", &self.lp_reg_buf1())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf1(&mut self) -> LP_REG_BUF1_W<'_, W1_SPEC> {
        LP_REG_BUF1_W::new(self, 0)
    }
}
