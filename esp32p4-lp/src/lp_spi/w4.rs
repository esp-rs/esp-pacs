...
#[doc = "Field `LP_REG_BUF4` reader - data buffer"]
pub type LP_REG_BUF4_R = crate::FieldReader<u32>;
#[doc = "Field `LP_REG_BUF4` writer - data buffer"]
pub type LP_REG_BUF4_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf4(&self) -> LP_REG_BUF4_R {
        LP_REG_BUF4_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("W4")
            .field("lp_reg_buf4", &self.lp_reg_buf4())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf4(&mut self) -> LP_REG_BUF4_W<'_, W4_SPEC> {
        LP_REG_BUF4_W::new(self, 0)
    }
}
