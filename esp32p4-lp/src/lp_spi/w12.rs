...
#[doc = "Field `LP_REG_BUF12` reader - data buffer"]
pub type LP_REG_BUF12_R = crate::FieldReader<u32>;
#[doc = "Field `LP_REG_BUF12` writer - data buffer"]
pub type LP_REG_BUF12_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf12(&self) -> LP_REG_BUF12_R {
        LP_REG_BUF12_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("W12")
            .field("lp_reg_buf12", &self.lp_reg_buf12())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf12(&mut self) -> LP_REG_BUF12_W<'_, W12_SPEC> {
        LP_REG_BUF12_W::new(self, 0)
    }
}
