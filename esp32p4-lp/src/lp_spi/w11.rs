...
#[doc = "Field `LP_REG_BUF11` reader - data buffer"]
pub type LP_REG_BUF11_R = crate::FieldReader<u32>;
#[doc = "Field `LP_REG_BUF11` writer - data buffer"]
pub type LP_REG_BUF11_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf11(&self) -> LP_REG_BUF11_R {
        LP_REG_BUF11_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("W11")
            .field("lp_reg_buf11", &self.lp_reg_buf11())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf11(&mut self) -> LP_REG_BUF11_W<'_, W11_SPEC> {
        LP_REG_BUF11_W::new(self, 0)
    }
}
