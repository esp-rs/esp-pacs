...
#[doc = "Field `LP_REG_BUF15` reader - data buffer"]
pub type LP_REG_BUF15_R = crate::FieldReader<u32>;
#[doc = "Field `LP_REG_BUF15` writer - data buffer"]
pub type LP_REG_BUF15_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf15(&self) -> LP_REG_BUF15_R {
        LP_REG_BUF15_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("W15")
            .field("lp_reg_buf15", &self.lp_reg_buf15())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf15(&mut self) -> LP_REG_BUF15_W<'_, W15_SPEC> {
        LP_REG_BUF15_W::new(self, 0)
    }
}
