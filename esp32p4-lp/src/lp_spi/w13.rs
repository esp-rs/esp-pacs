...
#[doc = "Field `LP_REG_BUF13` reader - data buffer"]
pub type LP_REG_BUF13_R = crate::FieldReader<u32>;
#[doc = "Field `LP_REG_BUF13` writer - data buffer"]
pub type LP_REG_BUF13_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf13(&self) -> LP_REG_BUF13_R {
        LP_REG_BUF13_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("W13")
            .field("lp_reg_buf13", &self.lp_reg_buf13())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - data buffer"]
    #[inline(always)]
    pub fn lp_reg_buf13(&mut self) -> LP_REG_BUF13_W<'_, W13_SPEC> {
        LP_REG_BUF13_W::new(self, 0)
    }
}
