///Register `RESP0` reader
pub type R = crate::R<RESP0_SPEC>;
///Field `RESPONSE0` reader - Bit\[31:0\] of response.
pub type RESPONSE0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Bit\[31:0\] of response.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RESP0")
            .field("response0", &self.response0())
            .finish()
    }
}
...
///`read()` method returns [`resp0::R`](R) reader structure
