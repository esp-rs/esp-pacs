///Register `USRID` reader
pub type R = crate::R<USRID_SPEC>;
///Register `USRID` writer
pub type W = crate::W<USRID_SPEC>;
///Field `USRID` reader - User identification register, value set by user. Can also be used as a scratchpad register by user.
pub type USRID_R = crate::FieldReader<u32>;
///Field `USRID` writer - User identification register, value set by user. Can also be used as a scratchpad register by user.
pub type USRID_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - User identification register, value set by user. Can also be used as a scratchpad register by user.
    #[inline(always)]
...
///`read()` method returns [`usrid::R`](R) reader structure
impl crate::Readable for USRID_SPEC {}
///`write(|w| ..)` method takes [`usrid::W`](W) writer structure
