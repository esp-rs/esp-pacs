///Register `FIFOTH` reader
pub type R = crate::R<FIFOTH_SPEC>;
///Register `FIFOTH` writer
...
///`read()` method returns [`fifoth::R`](R) reader structure
impl crate::Readable for FIFOTH_SPEC {}
///`write(|w| ..)` method takes [`fifoth::W`](W) writer structure
