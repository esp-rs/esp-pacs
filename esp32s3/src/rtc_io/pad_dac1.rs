...
///Field `PDAC1_DAC` reader - PDAC1_DAC
pub type PDAC1_DAC_R = crate::FieldReader;
///Field `PDAC1_DAC` writer - PDAC1_DAC
pub type PDAC1_DAC_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PDAC1_XPD_DAC` reader - PDAC1_XPD_DAC
pub type PDAC1_XPD_DAC_R = crate::BitReader;
///Field `PDAC1_XPD_DAC` writer - PDAC1_XPD_DAC
pub type PDAC1_XPD_DAC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC1_DAC_XPD_FORCE` reader - 1: use reg_pdac1_xpd_dac to control PDAC1_XPD_DAC,0: use SAR ADC FSM to control PDAC1_XPD_DAC
pub type PDAC1_DAC_XPD_FORCE_R = crate::BitReader;
///Field `PDAC1_DAC_XPD_FORCE` writer - 1: use reg_pdac1_xpd_dac to control PDAC1_XPD_DAC,0: use SAR ADC FSM to control PDAC1_XPD_DAC
pub type PDAC1_DAC_XPD_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC1_FUN_IE` reader - input enable in work mode
pub type PDAC1_FUN_IE_R = crate::BitReader;
///Field `PDAC1_FUN_IE` writer - input enable in work mode
...
///Field `PDAC1_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type PDAC1_SLP_SEL_R = crate::BitReader;
///Field `PDAC1_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type PDAC1_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC1_FUN_SEL` reader - PDAC1 function sel
pub type PDAC1_FUN_SEL_R = crate::FieldReader;
///Field `PDAC1_FUN_SEL` writer - PDAC1 function sel
