...
///Field `SAR_DEBUG_BIT_SEL` reader - ******* Description configure***
pub type SAR_DEBUG_BIT_SEL_R = crate::FieldReader;
///Field `SAR_DEBUG_BIT_SEL` writer - ******* Description configure***
pub type SAR_DEBUG_BIT_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `SAR_I2C_SCL_SEL` reader - ******* Description configure***
pub type SAR_I2C_SCL_SEL_R = crate::FieldReader;
///Field `SAR_I2C_SCL_SEL` writer - ******* Description configure***
pub type SAR_I2C_SCL_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SAR_I2C_SDA_SEL` reader - ******* Description configure***
pub type SAR_I2C_SDA_SEL_R = crate::FieldReader;
///Field `SAR_I2C_SDA_SEL` writer - ******* Description configure***
