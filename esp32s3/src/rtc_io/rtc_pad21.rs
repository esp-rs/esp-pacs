...
pub type FUN_IE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_PAD21_SPEC, O>;
...
pub type SLP_OE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_PAD21_SPEC, O>;
...
pub type SLP_IE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_PAD21_SPEC, O>;
...
pub type SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, RTC_PAD21_SPEC, O>;
#[doc = "Field `FUN_SEL` reader - function sel"]
pub type FUN_SEL_R = crate::FieldReader;
#[doc = "Field `FUN_SEL` writer - function sel"]
pub type FUN_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_PAD21_SPEC, 2, O>;
...
pub type MUX_SEL_W<'a, const O: u8> = crate::BitWriter<'a, RTC_PAD21_SPEC, O>;
#[doc = "Field `RUE` reader - RUE"]
pub type RUE_R = crate::BitReader;
#[doc = "Field `RUE` writer - RUE"]
pub type RUE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_PAD21_SPEC, O>;
#[doc = "Field `RDE` reader - RDE"]
pub type RDE_R = crate::BitReader;
#[doc = "Field `RDE` writer - RDE"]
pub type RDE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_PAD21_SPEC, O>;
#[doc = "Field `DRV` reader - DRV"]
pub type DRV_R = crate::FieldReader;
#[doc = "Field `DRV` writer - DRV"]
pub type DRV_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_PAD21_SPEC, 2, O>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RTC_PAD21_SPEC> {
