...
///Field `PDAC2_DAC` reader - PDAC2_DAC
pub type PDAC2_DAC_R = crate::FieldReader;
///Field `PDAC2_DAC` writer - PDAC2_DAC
pub type PDAC2_DAC_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PDAC2_XPD_DAC` reader - PDAC2_XPD_DAC
pub type PDAC2_XPD_DAC_R = crate::BitReader;
///Field `PDAC2_XPD_DAC` writer - PDAC2_XPD_DAC
pub type PDAC2_XPD_DAC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_DAC_XPD_FORCE` reader - 1: use reg_pdac2_xpd_dac to control PDAC2_XPD_DAC,0: use SAR ADC FSM to control PDAC2_XPD_DAC
pub type PDAC2_DAC_XPD_FORCE_R = crate::BitReader;
///Field `PDAC2_DAC_XPD_FORCE` writer - 1: use reg_pdac2_xpd_dac to control PDAC2_XPD_DAC,0: use SAR ADC FSM to control PDAC2_XPD_DAC
pub type PDAC2_DAC_XPD_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_FUN_IE` reader - input enable in work mode
pub type PDAC2_FUN_IE_R = crate::BitReader;
///Field `PDAC2_FUN_IE` writer - input enable in work mode
...
///Field `PDAC2_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type PDAC2_SLP_SEL_R = crate::BitReader;
///Field `PDAC2_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type PDAC2_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_FUN_SEL` reader - PDAC1 function sel
pub type PDAC2_FUN_SEL_R = crate::FieldReader;
///Field `PDAC2_FUN_SEL` writer - PDAC1 function sel
...
impl R {
    ...
    ///Bit 11 - PDAC2_XPD_DAC
    #[inline(always)]
    pub fn pdac2_xpd_dac(&self) -> PDAC2_XPD_DAC_R {
        PDAC2_XPD_DAC_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 12 - 1: use reg_pdac2_xpd_dac to control PDAC2_XPD_DAC,0: use SAR ADC FSM to control PDAC2_XPD_DAC
    #[inline(always)]
