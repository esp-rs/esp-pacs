...
#[doc = "Field `DAC` reader - PDAC2_DAC"]
pub type DAC_R = crate::FieldReader;
#[doc = "Field `DAC` writer - PDAC2_DAC"]
pub type DAC_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `XPD_DAC` reader - PDAC2_XPD_DAC"]
pub type XPD_DAC_R = crate::BitReader;
#[doc = "Field `XPD_DAC` writer - PDAC2_XPD_DAC"]
pub type XPD_DAC_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DAC_XPD_FORCE` reader - 1: use reg_pdac2_xpd_dac to control PDAC2_XPD_DAC,0: use SAR ADC FSM to control PDAC2_XPD_DAC"]
pub type DAC_XPD_FORCE_R = crate::BitReader;
#[doc = "Field `DAC_XPD_FORCE` writer - 1: use reg_pdac2_xpd_dac to control PDAC2_XPD_DAC,0: use SAR ADC FSM to control PDAC2_XPD_DAC"]
...
#[doc = "Field `RUE` reader - PDAC2_RUE"]
pub type RUE_R = crate::BitReader;
#[doc = "Field `RUE` writer - PDAC2_RUE"]
pub type RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RDE` reader - PDAC2_RDE"]
pub type RDE_R = crate::BitReader;
#[doc = "Field `RDE` writer - PDAC2_RDE"]
pub type RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DRV` reader - PDAC2_DRV"]
pub type DRV_R = crate::FieldReader;
#[doc = "Field `DRV` writer - PDAC2_DRV"]
...
impl W {
    #[doc = "Bits 3:10 - PDAC2_DAC"]
    #[inline(always)]
    pub fn dac(&mut self) -> DAC_W<PAD_DAC2_SPEC> {
        DAC_W::new(self, 3)
    }
    #[doc = "Bit 11 - PDAC2_XPD_DAC"]
    #[inline(always)]
    pub fn xpd_dac(&mut self) -> XPD_DAC_W<PAD_DAC2_SPEC> {
        XPD_DAC_W::new(self, 11)
    }
    #[doc = "Bit 12 - 1: use reg_pdac2_xpd_dac to control PDAC2_XPD_DAC,0: use SAR ADC FSM to control PDAC2_XPD_DAC"]
    #[inline(always)]
    pub fn dac_xpd_force(&mut self) -> DAC_XPD_FORCE_W<PAD_DAC2_SPEC> {
        DAC_XPD_FORCE_W::new(self, 12)
    }
    #[doc = "Bit 13 - input enable in work mode"]
    #[inline(always)]
    pub fn fun_ie(&mut self) -> FUN_IE_W<PAD_DAC2_SPEC> {
        FUN_IE_W::new(self, 13)
    }
    #[doc = "Bit 14 - output enable in sleep mode"]
    #[inline(always)]
    pub fn slp_oe(&mut self) -> SLP_OE_W<PAD_DAC2_SPEC> {
        SLP_OE_W::new(self, 14)
    }
    #[doc = "Bit 15 - input enable in sleep mode"]
    #[inline(always)]
    pub fn slp_ie(&mut self) -> SLP_IE_W<PAD_DAC2_SPEC> {
        SLP_IE_W::new(self, 15)
    }
    #[doc = "Bit 16 - 1: enable sleep mode during sleep,0: no sleep mode"]
    #[inline(always)]
    pub fn slp_sel(&mut self) -> SLP_SEL_W<PAD_DAC2_SPEC> {
        SLP_SEL_W::new(self, 16)
    }
    #[doc = "Bits 17:18 - PDAC1 function sel"]
    #[inline(always)]
    pub fn fun_sel(&mut self) -> FUN_SEL_W<PAD_DAC2_SPEC> {
        FUN_SEL_W::new(self, 17)
    }
    #[doc = "Bit 19 - 1: use RTC GPIO,0: use digital GPIO"]
    #[inline(always)]
    pub fn mux_sel(&mut self) -> MUX_SEL_W<PAD_DAC2_SPEC> {
        MUX_SEL_W::new(self, 19)
    }
    #[doc = "Bit 27 - PDAC2_RUE"]
    #[inline(always)]
    pub fn rue(&mut self) -> RUE_W<PAD_DAC2_SPEC> {
        RUE_W::new(self, 27)
    }
    #[doc = "Bit 28 - PDAC2_RDE"]
    #[inline(always)]
    pub fn rde(&mut self) -> RDE_W<PAD_DAC2_SPEC> {
        RDE_W::new(self, 28)
    }
    #[doc = "Bits 29:30 - PDAC2_DRV"]
    #[inline(always)]
    pub fn drv(&mut self) -> DRV_W<PAD_DAC2_SPEC> {
        DRV_W::new(self, 29)
    }
}
