...
impl W {
    ...
    pub fn rtc_gpio_out_data_w1ts(
        &mut self,
    ) -> RTC_GPIO_OUT_DATA_W1TS_W<'_, RTC_GPIO_OUT_W1TS_SPEC> {
        RTC_GPIO_OUT_DATA_W1TS_W::new(self, 10)
    }
}
#[doc = "one set RTC GPIO output data\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rtc_gpio_out_w1ts::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
