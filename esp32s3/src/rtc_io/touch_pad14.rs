#[doc = "Register `TOUCH_PAD14` reader"]
pub struct R(crate::R<TOUCH_PAD14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TOUCH_PAD14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TOUCH_PAD14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TOUCH_PAD14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TOUCH_PAD14` writer"]
pub struct W(crate::W<TOUCH_PAD14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TOUCH_PAD14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TOUCH_PAD14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TOUCH_PAD14_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FUN_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD14_SPEC, bool, O>;
...
pub type SLP_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD14_SPEC, bool, O>;
...
pub type SLP_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD14_SPEC, bool, O>;
...
pub type SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD14_SPEC, bool, O>;
#[doc = "Field `FUN_SEL` reader - function sel"]
pub type FUN_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FUN_SEL` writer - function sel"]
pub type FUN_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TOUCH_PAD14_SPEC, u8, u8, 2, O>;
...
#[doc = "configure RTC PAD14\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [touch_pad14](index.html) module"]
pub struct TOUCH_PAD14_SPEC;
impl crate::RegisterSpec for TOUCH_PAD14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [touch_pad14::R](R) reader structure"]
impl crate::Readable for TOUCH_PAD14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [touch_pad14::W](W) writer structure"]
impl crate::Writable for TOUCH_PAD14_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TOUCH_PAD14 to value 0x4000_0000"]
impl crate::Resettable for TOUCH_PAD14_SPEC {
