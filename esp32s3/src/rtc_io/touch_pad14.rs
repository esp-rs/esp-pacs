...
pub type FUN_IE_W<'a, const O: u8> = crate::BitWriter<'a, TOUCH_PAD14_SPEC, O>;
...
pub type SLP_OE_W<'a, const O: u8> = crate::BitWriter<'a, TOUCH_PAD14_SPEC, O>;
...
pub type SLP_IE_W<'a, const O: u8> = crate::BitWriter<'a, TOUCH_PAD14_SPEC, O>;
...
pub type SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, TOUCH_PAD14_SPEC, O>;
#[doc = "Field `FUN_SEL` reader - function sel"]
pub type FUN_SEL_R = crate::FieldReader;
#[doc = "Field `FUN_SEL` writer - function sel"]
pub type FUN_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TOUCH_PAD14_SPEC, 2, O>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TOUCH_PAD14_SPEC> {
