///Register `TOUCH_PAD8` reader
pub type R = crate::R<TOUCH_PAD8_SPEC>;
///Register `TOUCH_PAD8` writer
...
///`read()` method returns [`touch_pad8::R`](R) reader structure
impl crate::Readable for TOUCH_PAD8_SPEC {}
///`write(|w| ..)` method takes [`touch_pad8::W`](W) writer structure
