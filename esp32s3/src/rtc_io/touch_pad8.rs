...
pub type FUN_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, O>;
...
pub type SLP_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, O>;
...
pub type SLP_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, O>;
...
pub type SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, O>;
#[doc = "Field `FUN_SEL` reader - function sel"]
pub type FUN_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FUN_SEL` writer - function sel"]
pub type FUN_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TOUCH_PAD8_SPEC, u8, u8, 2, O>;
...
pub type MUX_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, O>;
...
pub type RUE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, O>;
#[doc = "Field `RDE` reader - RDE"]
pub type RDE_R = crate::BitReader<bool>;
#[doc = "Field `RDE` writer - RDE"]
pub type RDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, O>;
#[doc = "Field `DRV` reader - DRV"]
pub type DRV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DRV` writer - DRV"]
pub type DRV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TOUCH_PAD8_SPEC, u8, u8, 2, O>;
impl R {
