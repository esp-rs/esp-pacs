...
///Field `WDT_STG0_HOLD` reader - Stage 0 timeout value, in MWDT clock cycles.
pub type WDT_STG0_HOLD_R = crate::FieldReader<u32>;
///Field `WDT_STG0_HOLD` writer - Stage 0 timeout value, in MWDT clock cycles.
pub type WDT_STG0_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Stage 0 timeout value, in MWDT clock cycles.
    #[inline(always)]
