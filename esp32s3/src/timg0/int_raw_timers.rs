...
///Register `INT_RAW_TIMERS` writer
...
///Field `T(0-1)` writer - The raw interrupt status bit for the TIMG_T%s_INT interrupt.
...
///Field `WDT` writer - The raw interrupt status bit for the TIMG_WDT_INT interrupt.
...
///`write(|w| ..)` method takes [`int_raw_timers::W`](W) writer structure
