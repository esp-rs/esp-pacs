...
///Field `DMA_OUT_CH0_INT_MAP` reader - this register used to map dma_out_ch0 interrupt to one of core1's external interrupt
pub type DMA_OUT_CH0_INT_MAP_R = crate::FieldReader;
///Field `DMA_OUT_CH0_INT_MAP` writer - this register used to map dma_out_ch0 interrupt to one of core1's external interrupt
