...
#[doc = "Field `BT_MAC_INT_MAP` reader - this register used to map bb_mac interrupt to one of core1's external interrupt"]
pub type BT_MAC_INT_MAP_R = crate::FieldReader;
#[doc = "Field `BT_MAC_INT_MAP` writer - this register used to map bb_mac interrupt to one of core1's external interrupt"]
pub type BT_MAC_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    #[doc = "Bits 0:4 - this register used to map bb_mac interrupt to one of core1's external interrupt"]
    #[inline(always)]
