...
///Field `BB_INT_MAP` reader - this register used to map bb interrupt to one of core1's external interrupt
pub type BB_INT_MAP_R = crate::FieldReader;
///Field `BB_INT_MAP` writer - this register used to map bb interrupt to one of core1's external interrupt
