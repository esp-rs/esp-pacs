...
#[doc = "Field `GPIO_INTERRUPT_PRO_NMI_MAP` reader - this register used to map gpio_interrupt_pro_nmi interrupt to one of core1's external interrupt"]
pub type GPIO_INTERRUPT_PRO_NMI_MAP_R = crate::FieldReader;
#[doc = "Field `GPIO_INTERRUPT_PRO_NMI_MAP` writer - this register used to map gpio_interrupt_pro_nmi interrupt to one of core1's external interrupt"]
pub type GPIO_INTERRUPT_PRO_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    #[doc = "Bits 0:4 - this register used to map gpio_interrupt_pro_nmi interrupt to one of core1's external interrupt"]
    #[inline(always)]
...
#[doc = "gpio_interrupt_pro_nmi interrupt configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`gpio_interrupt_pro_nmi_map::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gpio_interrupt_pro_nmi_map::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets GPIO_INTERRUPT_PRO_NMI_MAP to value 0x10"]
