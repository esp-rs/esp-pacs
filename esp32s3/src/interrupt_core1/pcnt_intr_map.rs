///Register `PCNT_INTR_MAP` reader
pub type R = crate::R<PCNT_INTR_MAP_SPEC>;
///Register `PCNT_INTR_MAP` writer
pub type W = crate::W<PCNT_INTR_MAP_SPEC>;
///Field `PCNT_INTR_MAP` reader - this register used to map pcnt interrupt to one of core1's external interrupt
pub type PCNT_INTR_MAP_R = crate::FieldReader;
///Field `PCNT_INTR_MAP` writer - this register used to map pcnt interrupt to one of core1's external interrupt
pub type PCNT_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map pcnt interrupt to one of core1's external interrupt
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`pcnt_intr_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcnt_intr_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PCNT_INTR_MAP_SPEC;
impl crate::RegisterSpec for PCNT_INTR_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pcnt_intr_map::R`](R) reader structure
impl crate::Readable for PCNT_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`pcnt_intr_map::W`](W) writer structure
