...
///Field `SYSTIMER_TARGET1_INT_MAP` reader - this register used to map systimer_target1 interrupt to one of core1's external interrupt
pub type SYSTIMER_TARGET1_INT_MAP_R = crate::FieldReader;
///Field `SYSTIMER_TARGET1_INT_MAP` writer - this register used to map systimer_target1 interrupt to one of core1's external interrupt
