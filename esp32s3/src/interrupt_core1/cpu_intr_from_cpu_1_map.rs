...
///Field `CPU_INTR_FROM_CPU_1_MAP` reader - this register used to map cpu_intr_from_cpu_1 interrupt to one of core1's external interrupt
pub type CPU_INTR_FROM_CPU_1_MAP_R = crate::FieldReader;
///Field `CPU_INTR_FROM_CPU_1_MAP` writer - this register used to map cpu_intr_from_cpu_1 interrupt to one of core1's external interrupt
pub type CPU_INTR_FROM_CPU_1_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map cpu_intr_from_cpu_1 interrupt to one of core1's external interrupt
    #[inline(always)]
