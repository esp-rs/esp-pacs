...
pub type TG_WDT_INT_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TG_WDT_INT_MAP` writer - this register used to map rg_wdt interrupt to one of core1's external interrupt"]
pub type TG_WDT_INT_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TG_WDT_INT_MAP_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tg_wdt_int_map(&mut self) -> TG_WDT_INT_MAP_W<0> {
