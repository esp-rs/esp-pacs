...
#[doc = "Field `RTC_CORE_INTR_MAP` reader - this register used to map rtc_core interrupt to one of core1's external interrupt"]
pub type RTC_CORE_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `RTC_CORE_INTR_MAP` writer - this register used to map rtc_core interrupt to one of core1's external interrupt"]
pub type RTC_CORE_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    #[doc = "Bits 0:4 - this register used to map rtc_core interrupt to one of core1's external interrupt"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RTC_CORE_INTR_MAP")
            .field("rtc_core_intr_map", &self.rtc_core_intr_map().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
...
#[doc = "`reset()` method sets RTC_CORE_INTR_MAP to value 0x10"]
