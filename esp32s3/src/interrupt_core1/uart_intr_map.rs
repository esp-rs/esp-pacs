...
#[doc = "Field `UART_INTR_MAP` reader - this register used to map uart interrupt to one of core1's external interrupt"]
pub type UART_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `UART_INTR_MAP` writer - this register used to map uart interrupt to one of core1's external interrupt"]
pub type UART_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    #[doc = "Bits 0:4 - this register used to map uart interrupt to one of core1's external interrupt"]
    #[inline(always)]
...
#[doc = "uart interrupt configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`uart_intr_map::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart_intr_map::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
