...
///Field `USB_INTR_MAP` reader - this register used to map usb interrupt to one of core1's external interrupt
pub type USB_INTR_MAP_R = crate::FieldReader;
///Field `USB_INTR_MAP` writer - this register used to map usb interrupt to one of core1's external interrupt
pub type USB_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map usb interrupt to one of core1's external interrupt
    #[inline(always)]
