...
///Field `I2C_EXT1_INTR_MAP` reader - this register used to map i2c_ext1 interrupt to one of core1's external interrupt
pub type I2C_EXT1_INTR_MAP_R = crate::FieldReader;
///Field `I2C_EXT1_INTR_MAP` writer - this register used to map i2c_ext1 interrupt to one of core1's external interrupt
pub type I2C_EXT1_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map i2c_ext1 interrupt to one of core1's external interrupt
    #[inline(always)]
