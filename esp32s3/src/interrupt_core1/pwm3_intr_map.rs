...
///Field `PWM3_INTR_MAP` reader - this register used to map pwm3 interrupt to one of core1's external interrupt
pub type PWM3_INTR_MAP_R = crate::FieldReader;
///Field `PWM3_INTR_MAP` writer - this register used to map pwm3 interrupt to one of core1's external interrupt
pub type PWM3_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map pwm3 interrupt to one of core1's external interrupt
    #[inline(always)]
