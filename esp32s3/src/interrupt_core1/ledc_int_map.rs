///Register `LEDC_INT_MAP` reader
pub type R = crate::R<LEDC_INT_MAP_SPEC>;
///Register `LEDC_INT_MAP` writer
pub type W = crate::W<LEDC_INT_MAP_SPEC>;
///Field `LEDC_INT_MAP` reader - this register used to map ledc interrupt to one of core1's external interrupt
pub type LEDC_INT_MAP_R = crate::FieldReader;
///Field `LEDC_INT_MAP` writer - this register used to map ledc interrupt to one of core1's external interrupt
pub type LEDC_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map ledc interrupt to one of core1's external interrupt
    #[inline(always)]
...
///`read()` method returns [`ledc_int_map::R`](R) reader structure
impl crate::Readable for LEDC_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`ledc_int_map::W`](W) writer structure
