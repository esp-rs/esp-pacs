...
pub type UART2_INTR_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `UART2_INTR_MAP` writer - this register used to map uart2 interrupt to one of core1's external interrupt"]
pub type UART2_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UART2_INTR_MAP_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - this register used to map uart2 interrupt to one of core1's external interrupt"]
    #[inline(always)]
    pub fn uart2_intr_map(&mut self) -> UART2_INTR_MAP_W<0> {
