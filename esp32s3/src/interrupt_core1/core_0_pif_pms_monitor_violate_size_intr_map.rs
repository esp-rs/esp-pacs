///Register `CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP` reader
pub type R = crate::R<CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP_SPEC>;
///Register `CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP` writer
pub type W = crate::W<CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP_SPEC>;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP` reader - this register used to map core0_PIF_pms_monitor_violatile_size interrupt to one of core1's external interrupt
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP_R = crate::FieldReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP` writer - this register used to map core0_PIF_pms_monitor_violatile_size interrupt to one of core1's external interrupt
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map core0_PIF_pms_monitor_violatile_size interrupt to one of core1's external interrupt
    #[inline(always)]
...
///`read()` method returns [`core_0_pif_pms_monitor_violate_size_intr_map::R`](R) reader structure
impl crate::Readable for CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`core_0_pif_pms_monitor_violate_size_intr_map::W`](W) writer structure
