...
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP` reader - this register used to map core0_IRam0_pms_monitor_violatile interrupt to one of core1's external interrupt
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_R = crate::FieldReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP` writer - this register used to map core0_IRam0_pms_monitor_violatile interrupt to one of core1's external interrupt
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map core0_IRam0_pms_monitor_violatile interrupt to one of core1's external interrupt
    #[inline(always)]
