///Register `BACKUP_PMS_VIOLATE_INTR_MAP` reader
pub type R = crate::R<BACKUP_PMS_VIOLATE_INTR_MAP_SPEC>;
///Register `BACKUP_PMS_VIOLATE_INTR_MAP` writer
pub type W = crate::W<BACKUP_PMS_VIOLATE_INTR_MAP_SPEC>;
///Field `BACKUP_PMS_VIOLATE_INTR_MAP` reader - this register used to map backup_pms_monitor_violatile interrupt to one of core1's external interrupt
pub type BACKUP_PMS_VIOLATE_INTR_MAP_R = crate::FieldReader;
///Field `BACKUP_PMS_VIOLATE_INTR_MAP` writer - this register used to map backup_pms_monitor_violatile interrupt to one of core1's external interrupt
pub type BACKUP_PMS_VIOLATE_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map backup_pms_monitor_violatile interrupt to one of core1's external interrupt
    #[inline(always)]
...
///`read()` method returns [`backup_pms_violate_intr_map::R`](R) reader structure
impl crate::Readable for BACKUP_PMS_VIOLATE_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`backup_pms_violate_intr_map::W`](W) writer structure
