...
#[doc = "Field `UART1_INTR_MAP` reader - this register used to map uart1 interrupt to one of core1's external interrupt"]
pub type UART1_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `UART1_INTR_MAP` writer - this register used to map uart1 interrupt to one of core1's external interrupt"]
pub type UART1_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    #[doc = "Bits 0:4 - this register used to map uart1 interrupt to one of core1's external interrupt"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UART1_INTR_MAP")
            .field("uart1_intr_map", &self.uart1_intr_map().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
