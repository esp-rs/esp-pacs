...
#[doc = "Field `RWBT_IRQ_MAP` reader - this register used to map rwbt_irq interrupt to one of core1's external interrupt"]
pub type RWBT_IRQ_MAP_R = crate::FieldReader;
#[doc = "Field `RWBT_IRQ_MAP` writer - this register used to map rwbt_irq interrupt to one of core1's external interrupt"]
...
#[doc = "rwbt_irq interrupt configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`rwbt_irq_map::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rwbt_irq_map::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
