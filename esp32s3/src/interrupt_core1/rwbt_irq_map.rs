...
///Field `RWBT_IRQ_MAP` reader - this register used to map rwbt_irq interrupt to one of core1's external interrupt
pub type RWBT_IRQ_MAP_R = crate::FieldReader;
///Field `RWBT_IRQ_MAP` writer - this register used to map rwbt_irq interrupt to one of core1's external interrupt
pub type RWBT_IRQ_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map rwbt_irq interrupt to one of core1's external interrupt
    #[inline(always)]
