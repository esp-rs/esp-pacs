...
pub type CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_SPEC, 5, O>;
impl R {
...
impl W {
    ...
    pub fn core_0_dram0_pms_monitor_violate_intr_map(
        &mut self,
    ) -> CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_W<0> {
