...
///Field `SPI3_DMA_INT_MAP` reader - this register used to map spi3_dma interrupt to one of core1's external interrupt
pub type SPI3_DMA_INT_MAP_R = crate::FieldReader;
///Field `SPI3_DMA_INT_MAP` writer - this register used to map spi3_dma interrupt to one of core1's external interrupt
pub type SPI3_DMA_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map spi3_dma interrupt to one of core1's external interrupt
    #[inline(always)]
