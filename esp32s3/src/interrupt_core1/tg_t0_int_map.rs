///Register `TG_T0_INT_MAP` reader
pub type R = crate::R<TG_T0_INT_MAP_SPEC>;
///Register `TG_T0_INT_MAP` writer
pub type W = crate::W<TG_T0_INT_MAP_SPEC>;
///Field `TG_T0_INT_MAP` reader - this register used to map tg_t0 interrupt to one of core1's external interrupt
pub type TG_T0_INT_MAP_R = crate::FieldReader;
///Field `TG_T0_INT_MAP` writer - this register used to map tg_t0 interrupt to one of core1's external interrupt
pub type TG_T0_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map tg_t0 interrupt to one of core1's external interrupt
    #[inline(always)]
...
///`read()` method returns [`tg_t0_int_map::R`](R) reader structure
impl crate::Readable for TG_T0_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`tg_t0_int_map::W`](W) writer structure
