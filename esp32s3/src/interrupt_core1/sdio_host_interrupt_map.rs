///Register `SDIO_HOST_INTERRUPT_MAP` reader
pub type R = crate::R<SDIO_HOST_INTERRUPT_MAP_SPEC>;
///Register `SDIO_HOST_INTERRUPT_MAP` writer
pub type W = crate::W<SDIO_HOST_INTERRUPT_MAP_SPEC>;
///Field `SDIO_HOST_INTERRUPT_MAP` reader - this register used to map sdio_host interrupt to one of core1's external interrupt
pub type SDIO_HOST_INTERRUPT_MAP_R = crate::FieldReader;
///Field `SDIO_HOST_INTERRUPT_MAP` writer - this register used to map sdio_host interrupt to one of core1's external interrupt
pub type SDIO_HOST_INTERRUPT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map sdio_host interrupt to one of core1's external interrupt
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SDIO_HOST_INTERRUPT_MAP")
            .field("sdio_host_interrupt_map", &self.sdio_host_interrupt_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`sdio_host_interrupt_map::R`](R) reader structure
impl crate::Readable for SDIO_HOST_INTERRUPT_MAP_SPEC {}
///`write(|w| ..)` method takes [`sdio_host_interrupt_map::W`](W) writer structure
