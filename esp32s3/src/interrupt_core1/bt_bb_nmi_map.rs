...
///Field `BT_BB_NMI_MAP` reader - this register used to map bb_bt_nmi interrupt to one of core1's external interrupt
pub type BT_BB_NMI_MAP_R = crate::FieldReader;
///Field `BT_BB_NMI_MAP` writer - this register used to map bb_bt_nmi interrupt to one of core1's external interrupt
pub type BT_BB_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map bb_bt_nmi interrupt to one of core1's external interrupt
    #[inline(always)]
