...
#[doc = "Field `UHCI0_INTR_MAP` reader - this register used to map uhci0 interrupt to one of core1's external interrupt"]
pub type UHCI0_INTR_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `UHCI0_INTR_MAP` writer - this register used to map uhci0 interrupt to one of core1's external interrupt"]
pub type UHCI0_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UHCI0_INTR_MAP_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map uhci0 interrupt to one of core1's external interrupt"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:4 - this register used to map uhci0 interrupt to one of core1's external interrupt"]
    #[inline(always)]
    pub fn uhci0_intr_map(&mut self) -> UHCI0_INTR_MAP_W<0> {
