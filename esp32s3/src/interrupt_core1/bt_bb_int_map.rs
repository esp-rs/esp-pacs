...
#[doc = "Field `BT_BB_INT_MAP` reader - this register used to map bt_bb interrupt to one of core1's external interrupt"]
pub type BT_BB_INT_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BT_BB_INT_MAP` writer - this register used to map bt_bb interrupt to one of core1's external interrupt"]
pub type BT_BB_INT_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BT_BB_INT_MAP_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map bt_bb interrupt to one of core1's external interrupt"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:4 - this register used to map bt_bb interrupt to one of core1's external interrupt"]
    #[inline(always)]
    pub fn bt_bb_int_map(&mut self) -> BT_BB_INT_MAP_W<0> {
...
#[doc = "`reset()` method sets BT_BB_INT_MAP to value 0x10"]
