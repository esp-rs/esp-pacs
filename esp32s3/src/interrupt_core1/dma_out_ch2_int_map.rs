...
pub type DMA_OUT_CH2_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_out_ch2_int_map(&mut self) -> DMA_OUT_CH2_INT_MAP_W<DMA_OUT_CH2_INT_MAP_SPEC, 0> {
