...
///Field `DMA_OUT_CH2_INT_MAP` reader - this register used to map dma_out_ch2 interrupt to one of core1's external interrupt
pub type DMA_OUT_CH2_INT_MAP_R = crate::FieldReader;
///Field `DMA_OUT_CH2_INT_MAP` writer - this register used to map dma_out_ch2 interrupt to one of core1's external interrupt
pub type DMA_OUT_CH2_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map dma_out_ch2 interrupt to one of core1's external interrupt
    #[inline(always)]
