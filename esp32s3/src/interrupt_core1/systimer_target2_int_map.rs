...
#[doc = "Field `SYSTIMER_TARGET2_INT_MAP` reader - this register used to map systimer_target2 interrupt to one of core1's external interrupt"]
pub type SYSTIMER_TARGET2_INT_MAP_R = crate::FieldReader;
#[doc = "Field `SYSTIMER_TARGET2_INT_MAP` writer - this register used to map systimer_target2 interrupt to one of core1's external interrupt"]
pub type SYSTIMER_TARGET2_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map systimer_target2 interrupt to one of core1's external interrupt"]
    #[inline(always)]
