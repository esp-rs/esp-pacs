...
#[doc = "Field `GPIO_INTERRUPT_APP_NMI_MAP` reader - this register used to map gpio_interrupt_app_nmi interrupt to one of core1's external interrupt"]
pub type GPIO_INTERRUPT_APP_NMI_MAP_R = crate::FieldReader;
#[doc = "Field `GPIO_INTERRUPT_APP_NMI_MAP` writer - this register used to map gpio_interrupt_app_nmi interrupt to one of core1's external interrupt"]
pub type GPIO_INTERRUPT_APP_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    #[doc = "Bits 0:4 - this register used to map gpio_interrupt_app_nmi interrupt to one of core1's external interrupt"]
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPIO_INTERRUPT_APP_NMI_MAP")
            .field(
                ...
                &self.gpio_interrupt_app_nmi_map().bits(),
            )
            .finish()
    }
}
