...
#[doc = "Field `INTERRUPT_DATE` reader - version register"]
pub type INTERRUPT_DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `INTERRUPT_DATE` writer - version register"]
pub type INTERRUPT_DATE_W<'a, const O: u8> = crate::FieldWriter<'a, DATE_SPEC, 28, O, u32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn interrupt_date(&mut self) -> INTERRUPT_DATE_W<0> {
        INTERRUPT_DATE_W::new(self)
    }
