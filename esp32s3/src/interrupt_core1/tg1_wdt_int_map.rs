...
///Field `TG1_WDT_INT_MAP` reader - this register used to map tg1_wdt interrupt to one of core1's external interrupt
pub type TG1_WDT_INT_MAP_R = crate::FieldReader;
///Field `TG1_WDT_INT_MAP` writer - this register used to map tg1_wdt interrupt to one of core1's external interrupt
pub type TG1_WDT_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map tg1_wdt interrupt to one of core1's external interrupt
    #[inline(always)]
