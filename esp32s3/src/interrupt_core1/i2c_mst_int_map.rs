...
///Field `I2C_MST_INT_MAP` reader - this register used to map i2c_mst interrupt to one of core1's external interrupt
pub type I2C_MST_INT_MAP_R = crate::FieldReader;
///Field `I2C_MST_INT_MAP` writer - this register used to map i2c_mst interrupt to one of core1's external interrupt
