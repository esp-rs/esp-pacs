///Register `CPU_INTR_FROM_CPU_2_MAP` reader
pub type R = crate::R<CPU_INTR_FROM_CPU_2_MAP_SPEC>;
///Register `CPU_INTR_FROM_CPU_2_MAP` writer
pub type W = crate::W<CPU_INTR_FROM_CPU_2_MAP_SPEC>;
///Field `CPU_INTR_FROM_CPU_2_MAP` reader - this register used to map cpu_intr_from_cpu_2 interrupt to one of core1's external interrupt
pub type CPU_INTR_FROM_CPU_2_MAP_R = crate::FieldReader;
///Field `CPU_INTR_FROM_CPU_2_MAP` writer - this register used to map cpu_intr_from_cpu_2 interrupt to one of core1's external interrupt
pub type CPU_INTR_FROM_CPU_2_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map cpu_intr_from_cpu_2 interrupt to one of core1's external interrupt
    #[inline(always)]
...
///`read()` method returns [`cpu_intr_from_cpu_2_map::R`](R) reader structure
impl crate::Readable for CPU_INTR_FROM_CPU_2_MAP_SPEC {}
///`write(|w| ..)` method takes [`cpu_intr_from_cpu_2_map::W`](W) writer structure
