///Register `SPI_INTR_3_MAP` reader
pub type R = crate::R<SPI_INTR_3_MAP_SPEC>;
///Register `SPI_INTR_3_MAP` writer
pub type W = crate::W<SPI_INTR_3_MAP_SPEC>;
///Field `SPI_INTR_3_MAP` reader - this register used to map spi_intr_3 interrupt to one of core1's external interrupt
pub type SPI_INTR_3_MAP_R = crate::FieldReader;
///Field `SPI_INTR_3_MAP` writer - this register used to map spi_intr_3 interrupt to one of core1's external interrupt
pub type SPI_INTR_3_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map spi_intr_3 interrupt to one of core1's external interrupt
    #[inline(always)]
...
///`read()` method returns [`spi_intr_3_map::R`](R) reader structure
impl crate::Readable for SPI_INTR_3_MAP_SPEC {}
///`write(|w| ..)` method takes [`spi_intr_3_map::W`](W) writer structure
