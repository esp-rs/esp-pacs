...
pub type SPI_INTR_3_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_intr_3_map(&mut self) -> SPI_INTR_3_MAP_W<SPI_INTR_3_MAP_SPEC, 0> {
