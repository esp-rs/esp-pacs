///Register `PERI_BACKUP_INT_MAP` reader
pub type R = crate::R<PERI_BACKUP_INT_MAP_SPEC>;
///Register `PERI_BACKUP_INT_MAP` writer
pub type W = crate::W<PERI_BACKUP_INT_MAP_SPEC>;
///Field `PERI_BACKUP_INT_MAP` reader - this register used to map peri_backup interrupt to one of core1's external interrupt
pub type PERI_BACKUP_INT_MAP_R = crate::FieldReader;
///Field `PERI_BACKUP_INT_MAP` writer - this register used to map peri_backup interrupt to one of core1's external interrupt
pub type PERI_BACKUP_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map peri_backup interrupt to one of core1's external interrupt
    #[inline(always)]
...
///`read()` method returns [`peri_backup_int_map::R`](R) reader structure
impl crate::Readable for PERI_BACKUP_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`peri_backup_int_map::W`](W) writer structure
