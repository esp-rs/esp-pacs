///Register `PWM2_INTR_MAP` reader
pub type R = crate::R<PWM2_INTR_MAP_SPEC>;
///Register `PWM2_INTR_MAP` writer
pub type W = crate::W<PWM2_INTR_MAP_SPEC>;
///Field `PWM2_INTR_MAP` reader - this register used to map pwm2 interrupt to one of core1's external interrupt
pub type PWM2_INTR_MAP_R = crate::FieldReader;
///Field `PWM2_INTR_MAP` writer - this register used to map pwm2 interrupt to one of core1's external interrupt
pub type PWM2_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map pwm2 interrupt to one of core1's external interrupt
    #[inline(always)]
...
///`read()` method returns [`pwm2_intr_map::R`](R) reader structure
impl crate::Readable for PWM2_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`pwm2_intr_map::W`](W) writer structure
