...
#[doc = "Field `PWM2_INTR_MAP` reader - this register used to map pwm2 interrupt to one of core1's external interrupt"]
pub type PWM2_INTR_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PWM2_INTR_MAP` writer - this register used to map pwm2 interrupt to one of core1's external interrupt"]
pub type PWM2_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PWM2_INTR_MAP_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map pwm2 interrupt to one of core1's external interrupt"]
    #[inline(always)]
