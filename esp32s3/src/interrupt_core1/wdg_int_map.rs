///Register `WDG_INT_MAP` reader
pub type R = crate::R<WDG_INT_MAP_SPEC>;
///Register `WDG_INT_MAP` writer
pub type W = crate::W<WDG_INT_MAP_SPEC>;
///Field `WDG_INT_MAP` reader - this register used to map wdg interrupt to one of core1's external interrupt
pub type WDG_INT_MAP_R = crate::FieldReader;
///Field `WDG_INT_MAP` writer - this register used to map wdg interrupt to one of core1's external interrupt
pub type WDG_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map wdg interrupt to one of core1's external interrupt
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`wdg_int_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wdg_int_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct WDG_INT_MAP_SPEC;
impl crate::RegisterSpec for WDG_INT_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`wdg_int_map::R`](R) reader structure
impl crate::Readable for WDG_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`wdg_int_map::W`](W) writer structure
