///Register `APB_ADC_INT_MAP` reader
pub type R = crate::R<APB_ADC_INT_MAP_SPEC>;
///Register `APB_ADC_INT_MAP` writer
pub type W = crate::W<APB_ADC_INT_MAP_SPEC>;
///Field `APB_ADC_INT_MAP` reader - this register used to map apb_adc interrupt to one of core1's external interrupt
pub type APB_ADC_INT_MAP_R = crate::FieldReader;
///Field `APB_ADC_INT_MAP` writer - this register used to map apb_adc interrupt to one of core1's external interrupt
pub type APB_ADC_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map apb_adc interrupt to one of core1's external interrupt
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB_ADC_INT_MAP")
            .field("apb_adc_int_map", &self.apb_adc_int_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`apb_adc_int_map::R`](R) reader structure
impl crate::Readable for APB_ADC_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`apb_adc_int_map::W`](W) writer structure
