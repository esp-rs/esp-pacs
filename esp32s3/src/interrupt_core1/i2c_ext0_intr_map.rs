...
#[doc = "Field `I2C_EXT0_INTR_MAP` reader - this register used to map i2c_ext0 interrupt to one of core1's external interrupt"]
pub type I2C_EXT0_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `I2C_EXT0_INTR_MAP` writer - this register used to map i2c_ext0 interrupt to one of core1's external interrupt"]
pub type I2C_EXT0_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map i2c_ext0 interrupt to one of core1's external interrupt"]
    #[inline(always)]
