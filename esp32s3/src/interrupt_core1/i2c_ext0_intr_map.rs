///Register `I2C_EXT0_INTR_MAP` reader
pub type R = crate::R<I2C_EXT0_INTR_MAP_SPEC>;
///Register `I2C_EXT0_INTR_MAP` writer
pub type W = crate::W<I2C_EXT0_INTR_MAP_SPEC>;
///Field `I2C_EXT0_INTR_MAP` reader - this register used to map i2c_ext0 interrupt to one of core1's external interrupt
pub type I2C_EXT0_INTR_MAP_R = crate::FieldReader;
///Field `I2C_EXT0_INTR_MAP` writer - this register used to map i2c_ext0 interrupt to one of core1's external interrupt
pub type I2C_EXT0_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map i2c_ext0 interrupt to one of core1's external interrupt
    #[inline(always)]
...
///`read()` method returns [`i2c_ext0_intr_map::R`](R) reader structure
impl crate::Readable for I2C_EXT0_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`i2c_ext0_intr_map::W`](W) writer structure
