...
#[doc = "Field `RSA_INT_MAP` reader - this register used to map rsa interrupt to one of core1's external interrupt"]
pub type RSA_INT_MAP_R = crate::FieldReader;
#[doc = "Field `RSA_INT_MAP` writer - this register used to map rsa interrupt to one of core1's external interrupt"]
pub type RSA_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map rsa interrupt to one of core1's external interrupt"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rsa_int_map(&mut self) -> RSA_INT_MAP_W<RSA_INT_MAP_SPEC, 0> {
