///Register `DMA_IN_CH0_INT_MAP` reader
pub type R = crate::R<DMA_IN_CH0_INT_MAP_SPEC>;
///Register `DMA_IN_CH0_INT_MAP` writer
pub type W = crate::W<DMA_IN_CH0_INT_MAP_SPEC>;
///Field `DMA_IN_CH0_INT_MAP` reader - this register used to map dma_in_ch0 interrupt to one of core1's external interrupt
pub type DMA_IN_CH0_INT_MAP_R = crate::FieldReader;
///Field `DMA_IN_CH0_INT_MAP` writer - this register used to map dma_in_ch0 interrupt to one of core1's external interrupt
pub type DMA_IN_CH0_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map dma_in_ch0 interrupt to one of core1's external interrupt
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_IN_CH0_INT_MAP")
            .field("dma_in_ch0_int_map", &self.dma_in_ch0_int_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`dma_in_ch0_int_map::R`](R) reader structure
impl crate::Readable for DMA_IN_CH0_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`dma_in_ch0_int_map::W`](W) writer structure
