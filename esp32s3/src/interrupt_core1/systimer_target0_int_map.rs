...
pub type SYSTIMER_TARGET0_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    pub fn systimer_target0_int_map(
        &mut self,
    ) -> SYSTIMER_TARGET0_INT_MAP_W<SYSTIMER_TARGET0_INT_MAP_SPEC, 0> {
        SYSTIMER_TARGET0_INT_MAP_W::new(self)
    }
