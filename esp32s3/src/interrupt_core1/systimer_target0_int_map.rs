...
pub type SYSTIMER_TARGET0_INT_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, SYSTIMER_TARGET0_INT_MAP_SPEC, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn systimer_target0_int_map(&mut self) -> SYSTIMER_TARGET0_INT_MAP_W<0> {
