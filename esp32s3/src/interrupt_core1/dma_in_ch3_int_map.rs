...
pub type DMA_IN_CH3_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_IN_CH3_INT_MAP")
            .field("dma_in_ch3_int_map", &self.dma_in_ch3_int_map())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_in_ch3_int_map(&mut self) -> DMA_IN_CH3_INT_MAP_W<DMA_IN_CH3_INT_MAP_SPEC> {
        DMA_IN_CH3_INT_MAP_W::new(self, 0)
    }
}
#[doc = "dma_in_ch3 interrupt configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_in_ch3_int_map::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_in_ch3_int_map::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
