///Register `DCACHE_PRELOAD_INT_MAP` reader
pub type R = crate::R<DCACHE_PRELOAD_INT_MAP_SPEC>;
///Register `DCACHE_PRELOAD_INT_MAP` writer
pub type W = crate::W<DCACHE_PRELOAD_INT_MAP_SPEC>;
///Field `DCACHE_PRELOAD_INT_MAP` reader - this register used to map dcache_prelaod interrupt to one of core1's external interrupt
pub type DCACHE_PRELOAD_INT_MAP_R = crate::FieldReader;
///Field `DCACHE_PRELOAD_INT_MAP` writer - this register used to map dcache_prelaod interrupt to one of core1's external interrupt
pub type DCACHE_PRELOAD_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map dcache_prelaod interrupt to one of core1's external interrupt
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`dcache_preload_int_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dcache_preload_int_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DCACHE_PRELOAD_INT_MAP_SPEC;
impl crate::RegisterSpec for DCACHE_PRELOAD_INT_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dcache_preload_int_map::R`](R) reader structure
impl crate::Readable for DCACHE_PRELOAD_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`dcache_preload_int_map::W`](W) writer structure
