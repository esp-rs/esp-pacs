...
///x
pub mod config;
/**APB_ADDR (rw) register accessor: x
...
///x
pub mod mem_addr;
/**REG_MAP0 (rw) register accessor: x
...
///x
pub mod reg_map0;
/**REG_MAP1 (rw) register accessor: x
...
///x
pub mod reg_map1;
/**REG_MAP2 (rw) register accessor: x
...
///x
pub mod reg_map2;
/**REG_MAP3 (rw) register accessor: x
...
///x
pub mod int_st;
/**INT_ENA (rw) register accessor: x
