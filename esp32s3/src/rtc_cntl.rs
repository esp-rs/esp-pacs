...
/**OPTIONS0 (rw) register accessor: RTC common configure register
...
pub mod options0;
/**SLP_TIMER0 (rw) register accessor: configure min sleep time
...
pub mod slp_timer0;
/**SLP_TIMER1 (rw) register accessor: configure sleep time hi
...
pub mod slp_timer1;
/**TIME_UPDATE (rw) register accessor: update rtc main timer
...
pub mod time_update;
/**TIME_LOW0 (r) register accessor: read rtc_main timer low bits
...
pub mod time_low0;
/**TIME_HIGH0 (r) register accessor: read rtc_main timer high bits
...
pub mod time_high0;
/**STATE0 (rw) register accessor: configure chip sleep
...
pub mod state0;
/**TIMER1 (rw) register accessor: rtc state wait time
...
///rtc state wait time
pub mod timer1;
/**TIMER2 (rw) register accessor: rtc monitor state delay time
...
pub mod timer2;
/**TIMER3 (rw) register accessor: No public
...
///No public
pub mod timer3;
/**TIMER4 (rw) register accessor: No public
...
///No public
pub mod timer4;
/**TIMER5 (rw) register accessor: configure min sleep time
...
///configure min sleep time
pub mod timer5;
/**TIMER6 (rw) register accessor: No public
...
///No public
pub mod timer6;
/**ANA_CONF (rw) register accessor: analog configure register
...
pub mod ana_conf;
/**RESET_STATE (rw) register accessor: get reset state
...
///get reset state
pub mod reset_state;
/**WAKEUP_STATE (rw) register accessor: configure wakeup state
...
/**INT_ENA (rw) register accessor: configure rtc interrupt register
...
pub mod int_ena;
/**INT_RAW (rw) register accessor: rtc interrupt register
...
pub mod int_raw;
/**INT_ST (r) register accessor: rtc interrupt register
...
///rtc interrupt register
pub mod int_st;
/**INT_CLR (w) register accessor: rtc interrupt register
...
///rtc interrupt register
pub mod int_clr;
/**STORE0 (rw) register accessor: Reserved register
...
///Reserved register
pub mod store0;
/**STORE1 (rw) register accessor: Reserved register
...
///Reserved register
pub mod store1;
/**STORE2 (rw) register accessor: Reserved register
...
///Reserved register
pub mod store2;
/**STORE3 (rw) register accessor: Reserved register
...
///Reserved register
pub mod store3;
/**EXT_XTL_CONF (rw) register accessor: Reserved register
...
/**EXT_WAKEUP_CONF (rw) register accessor: ext wakeup configure
...
/**SLP_REJECT_CONF (rw) register accessor: reject sleep register
...
/**CPU_PERIOD_CONF (rw) register accessor: conigure cpu freq
...
/**SDIO_ACT_CONF (rw) register accessor: No public
...
/**CLK_CONF (rw) register accessor: configure clock register
...
pub mod clk_conf;
/**SLOW_CLK_CONF (rw) register accessor: configure slow clk
...
/**SDIO_CONF (rw) register accessor: configure flash power
...
pub mod sdio_conf;
/**BIAS_CONF (rw) register accessor: No public
...
///No public
pub mod bias_conf;
/**RTC (rw) register accessor: configure rtc regulator
...
pub mod rtc;
/**PWC (rw) register accessor: configure rtc power
...
///configure rtc power
pub mod pwc;
/**REGULATOR_DRV_CTRL (rw) register accessor: No public
...
/**DIG_PWC (rw) register accessor: configure digital power
...
pub mod dig_pwc;
/**DIG_ISO (rw) register accessor: congigure digital power isolation
...
pub mod dig_iso;
/**WDTCONFIG0 (rw) register accessor: configure rtc watch dog
...
pub mod wdtconfig0;
/**WDTCONFIG1 (rw) register accessor: stage0 hold time
...
///stage0 hold time
pub mod wdtconfig1;
/**WDTCONFIG2 (rw) register accessor: stage1 hold time
...
///stage1 hold time
pub mod wdtconfig2;
/**WDTCONFIG3 (rw) register accessor: stage2 hold time
...
///stage2 hold time
pub mod wdtconfig3;
/**WDTCONFIG4 (rw) register accessor: stage3 hold time
...
///stage3 hold time
pub mod wdtconfig4;
/**WDTFEED (w) register accessor: rtc wdt feed
...
///rtc wdt feed
pub mod wdtfeed;
/**WDTWPROTECT (rw) register accessor: configure rtc watch dog
...
///configure rtc watch dog
pub mod wdtwprotect;
/**SWD_CONF (rw) register accessor: congfigure super watch dog
...
pub mod swd_conf;
/**SWD_WPROTECT (rw) register accessor: super watch dog key
...
/**SW_CPU_STALL (rw) register accessor: configure cpu stall by sw
...
/**STORE4 (rw) register accessor: reserved register
...
///reserved register
pub mod store4;
/**STORE5 (rw) register accessor: reserved register
...
///reserved register
pub mod store5;
/**STORE6 (rw) register accessor: reserved register
...
///reserved register
pub mod store6;
/**STORE7 (rw) register accessor: reserved register
...
///reserved register
pub mod store7;
/**LOW_POWER_ST (r) register accessor: reserved register
...
/**DIAG0 (r) register accessor: No public
...
///No public
pub mod diag0;
/**PAD_HOLD (rw) register accessor: rtc pad hold configure
...
pub mod pad_hold;
/**DIG_PAD_HOLD (rw) register accessor: configure digtal pad hold
...
/**EXT_WAKEUP1 (rw) register accessor: configure ext1 wakeup
...
pub mod ext_wakeup1;
/**EXT_WAKEUP1_STATUS (r) register accessor: check ext wakeup1 status
...
/**BROWN_OUT (rw) register accessor: congfigure brownout
...
///congfigure brownout
pub mod brown_out;
/**TIME_LOW1 (r) register accessor: RTC timer low 32 bits
...
pub mod time_low1;
/**TIME_HIGH1 (r) register accessor: RTC timer high 16 bits
...
pub mod time_high1;
/**XTAL32K_CLK_FACTOR (rw) register accessor: xtal 32k watch dog backup clock factor
...
/**XTAL32K_CONF (rw) register accessor: configure xtal32k
...
/**ULP_CP_TIMER (rw) register accessor: configure ulp
...
/**ULP_CP_CTRL (rw) register accessor: configure ulp
...
///configure ulp
pub mod ulp_cp_ctrl;
/**COCPU_CTRL (rw) register accessor: configure ulp-riscv
...
///configure ulp-riscv
pub mod cocpu_ctrl;
/**TOUCH_CTRL1 (rw) register accessor: configure touch controller
...
pub mod touch_ctrl1;
/**TOUCH_CTRL2 (rw) register accessor: configure touch controller
...
///configure touch controller
pub mod touch_ctrl2;
/**TOUCH_SCAN_CTRL (rw) register accessor: configure touch controller
...
/**TOUCH_SLP_THRES (rw) register accessor: configure touch controller
...
/**TOUCH_APPROACH (rw) register accessor: configure touch controller
...
/**TOUCH_FILTER_CTRL (rw) register accessor: configure touch controller
...
/**USB_CONF (rw) register accessor: usb configure
...
///usb configure
pub mod usb_conf;
/**TOUCH_TIMEOUT_CTRL (rw) register accessor: configure touch controller
...
/**SLP_REJECT_CAUSE (r) register accessor: get reject casue
...
/**OPTION1 (rw) register accessor: rtc common configure
...
pub mod option1;
/**SLP_WAKEUP_CAUSE (r) register accessor: get wakeup cause
...
/**ULP_CP_TIMER_1 (rw) register accessor: configure ulp sleep time
...
/**INT_ENA_RTC_W1TS (w) register accessor: oneset rtc interrupt
...
/**INT_ENA_RTC_W1TC (w) register accessor: oneset clr rtc interrupt enable
...
/**RETENTION_CTRL (rw) register accessor: configure retention
...
/**PG_CTRL (rw) register accessor: configure power glitch
...
pub mod pg_ctrl;
/**FIB_SEL (rw) register accessor: No public
...
///No public
pub mod fib_sel;
/**TOUCH_DAC (rw) register accessor: configure touch dac
...
///configure touch dac
pub mod touch_dac;
/**TOUCH_DAC1 (rw) register accessor: configure touch dac
...
///configure touch dac
pub mod touch_dac1;
/**COCPU_DISABLE (rw) register accessor: configure ulp diable
