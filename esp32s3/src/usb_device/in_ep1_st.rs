///Register `IN_EP1_ST` reader
pub type R = crate::R<IN_EP1_ST_SPEC>;
///Field `IN_EP1_STATE` reader - State of IN Endpoint 1.
pub type IN_EP1_STATE_R = crate::FieldReader;
///Field `IN_EP1_WR_ADDR` reader - Write data address of IN endpoint 1.
pub type IN_EP1_WR_ADDR_R = crate::FieldReader;
///Field `IN_EP1_RD_ADDR` reader - Read data address of IN endpoint 1.
...
///`read()` method returns [`in_ep1_st::R`](R) reader structure
