...
///Field `NUM` reader - time period for SDA to toggle after SCL goes low
pub type NUM_R = crate::FieldReader<u32>;
///Field `NUM` writer - time period for SDA to toggle after SCL goes low
pub type NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19 - time period for SDA to toggle after SCL goes low
    #[inline(always)]
