...
///Field `I2C_RDATA` reader - data received
pub type I2C_RDATA_R = crate::FieldReader;
///Field `SLAVE_TX_DATA` reader - data sent by slave
pub type SLAVE_TX_DATA_R = crate::FieldReader;
///Field `SLAVE_TX_DATA` writer - data sent by slave
pub type SLAVE_TX_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `I2C_DONE` reader - i2c done
