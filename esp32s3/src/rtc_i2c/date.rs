...
pub type I2C_DATE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 28, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_date(&mut self) -> I2C_DATE_W<DATE_SPEC, 0> {
        I2C_DATE_W::new(self)
    }
...
#[doc = "`reset()` method sets DATE to value 0x0190_5310"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0190_5310;
}
