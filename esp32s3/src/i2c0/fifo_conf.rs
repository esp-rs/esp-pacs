...
///Field `RXFIFO_WM_THRHD` reader - The water mark threshold of rx FIFO in nonfifo access mode. When reg_reg_fifo_prt_en is 1 and rx FIFO counter is bigger than reg_rxfifo_wm_thrhd\[4:0\], reg_rxfifo_wm_int_raw bit will be valid.
pub type RXFIFO_WM_THRHD_R = crate::FieldReader;
///Field `RXFIFO_WM_THRHD` writer - The water mark threshold of rx FIFO in nonfifo access mode. When reg_reg_fifo_prt_en is 1 and rx FIFO counter is bigger than reg_rxfifo_wm_thrhd\[4:0\], reg_rxfifo_wm_int_raw bit will be valid.
pub type RXFIFO_WM_THRHD_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `TXFIFO_WM_THRHD` reader - The water mark threshold of tx FIFO in nonfifo access mode. When reg_reg_fifo_prt_en is 1 and tx FIFO counter is smaller than reg_txfifo_wm_thrhd\[4:0\], reg_txfifo_wm_int_raw bit will be valid.
pub type TXFIFO_WM_THRHD_R = crate::FieldReader;
///Field `TXFIFO_WM_THRHD` writer - The water mark threshold of tx FIFO in nonfifo access mode. When reg_reg_fifo_prt_en is 1 and tx FIFO counter is smaller than reg_txfifo_wm_thrhd\[4:0\], reg_txfifo_wm_int_raw bit will be valid.
