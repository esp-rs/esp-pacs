...
#[doc = "Field `DATE` reader - This is the the version register."]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - This is the the version register."]
...
#[doc = "`reset()` method sets DATE to value 0x2007_0201"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x2007_0201;
}
