...
///SPI1 user2 register.
pub mod user2;
/**MOSI_DLEN (rw) register accessor: SPI1 write-data bit length register.
...
pub mod mosi_dlen;
/**MISO_DLEN (rw) register accessor: SPI1 read-data bit length register.
...
pub mod miso_dlen;
/**RD_STATUS (rw) register accessor: SPI1 read control register.
...
/**FLASH_SUS_CMD (rw) register accessor: SPI1 flash suspend control register
...
/**FLASH_SUS_CTRL (rw) register accessor: SPI1 flash suspend command register
...
pub mod sus_status;
/**TIMING_CALI (rw) register accessor: SPI1 timing compensation register when accesses to flash or Ext_RAM.
