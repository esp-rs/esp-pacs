...
/**M_MEM (w) register accessor: Memory M
...
///Memory Z
pub mod z_mem;
/**Y_MEM (w) register accessor: Memory Y
...
///Memory X
pub mod x_mem;
/**M_PRIME (rw) register accessor: RSA M' register
...
///RSA M' register
pub mod m_prime;
/**MODE (rw) register accessor: RSA length mode register
...
///RSA clean register
pub mod clean;
/**MODEXP_START (w) register accessor: Modular exponentiation trigger register.
...
/**MODMULT_START (w) register accessor: Modular multiplication trigger register.
...
/**MULT_START (w) register accessor: Normal multiplication trigger register.
...
///RSA idle register
pub mod idle;
/**CLEAR_INTERRUPT (w) register accessor: RSA interrupt clear register
...
/**CONSTANT_TIME (rw) register accessor: CONSTANT_TIME option control register
...
/**SEARCH_ENABLE (rw) register accessor: SEARCH option enable register
