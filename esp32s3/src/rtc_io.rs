...
/**RTC_GPIO_OUT_W1TS (w) register accessor: one set RTC GPIO output data
...
/**RTC_GPIO_OUT_W1TC (w) register accessor: one clear RTC GPIO output data
...
/**RTC_GPIO_ENABLE (rw) register accessor: Configure RTC GPIO output enable
...
/**RTC_GPIO_ENABLE_W1TS (w) register accessor: one set RTC GPIO output enable
...
/**RTC_GPIO_STATUS_W1TS (w) register accessor: One set RTC GPIO 0 ~ 21 interrupt status
...
///RTC GPIO input data
pub mod rtc_gpio_in;
/**PIN (rw) register accessor: configure RTC GPIO%s
