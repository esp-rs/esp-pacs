///Register `RELEASE` writer
pub type W = crate::W<RELEASE_SPEC>;
///Field `RELEASE` writer - Write 1 to grant SPI1 access to encrypted result.
...
impl W {
    ///Bit 0 - Write 1 to grant SPI1 access to encrypted result.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`release::W`](W) writer structure
