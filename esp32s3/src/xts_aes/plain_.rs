...
///Field `PLAIN` reader - Stores the nth 32-bit piece of plaintext.
pub type PLAIN_R = crate::FieldReader<u32>;
///Field `PLAIN` writer - Stores the nth 32-bit piece of plaintext.
pub type PLAIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Stores the nth 32-bit piece of plaintext.
    #[inline(always)]
