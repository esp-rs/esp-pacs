...
///Field `DATE` reader - Manual Encryption block version information.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - Manual Encryption block version information.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Manual Encryption block version information.
    #[inline(always)]
