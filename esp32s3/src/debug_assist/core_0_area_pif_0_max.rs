...
pub struct R(crate::R<CORE_0_AREA_PIF_0_MAX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_0_AREA_PIF_0_MAX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_0_AREA_PIF_0_MAX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_0_AREA_PIF_0_MAX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_0_AREA_PIF_0_MAX` writer"]
pub struct W(crate::W<CORE_0_AREA_PIF_0_MAX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_0_AREA_PIF_0_MAX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_0_AREA_PIF_0_MAX_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_0_AREA_PIF_0_MAX_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CORE_0_AREA_PIF_0_MAX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_0_AREA_PIF_0_MAX_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Core0 PIF region0 end addr"]
    #[inline(always)]
    pub fn core_0_area_pif_0_max(&mut self) -> CORE_0_AREA_PIF_0_MAX_W<0> {
