...
pub struct R(crate::R<CORE_1_AREA_DRAM0_1_MIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_AREA_DRAM0_1_MIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_AREA_DRAM0_1_MIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_AREA_DRAM0_1_MIN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_1_AREA_DRAM0_1_MIN` writer"]
pub struct W(crate::W<CORE_1_AREA_DRAM0_1_MIN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_AREA_DRAM0_1_MIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_AREA_DRAM0_1_MIN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_AREA_DRAM0_1_MIN_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CORE_1_AREA_DRAM0_1_MIN` reader - Core1 dram0 region1 start addr"]
pub type CORE_1_AREA_DRAM0_1_MIN_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_1_AREA_DRAM0_1_MIN` writer - Core1 dram0 region1 start addr"]
pub type CORE_1_AREA_DRAM0_1_MIN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_AREA_DRAM0_1_MIN_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_area_dram0_1_min(&mut self) -> CORE_1_AREA_DRAM0_1_MIN_W<0> {
        CORE_1_AREA_DRAM0_1_MIN_W::new(self)
    }
