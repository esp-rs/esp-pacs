...
#[doc = "Field `CORE_0_IRAM0_RECORDING_ADDR_0` reader - The first iram0's addr\\[25:2\\] status when trigger IRAM busy interrupt"]
pub type CORE_0_IRAM0_RECORDING_ADDR_0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_0_IRAM0_RECORDING_WR_0` reader - The first iram0's wr status when trigger IRAM busy interrupt"]
pub type CORE_0_IRAM0_RECORDING_WR_0_R = crate::BitReader<bool>;
#[doc = "Field `CORE_0_IRAM0_RECORDING_LOADSTORE_0` reader - The first iram0's loadstore status when trigger IRAM busy interrupt"]
...
impl R {
    ...
    pub fn core_0_iram0_recording_addr_0(&self) -> CORE_0_IRAM0_RECORDING_ADDR_0_R {
        CORE_0_IRAM0_RECORDING_ADDR_0_R::new((self.bits & 0x00ff_ffff) as u32)
    }
