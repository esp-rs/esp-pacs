...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GINTSTS")
            .field("curmod_int", &self.curmod_int().bit())
            .field("modemis", &self.modemis().bit())
            .field("otgint", &self.otgint().bit())
            .field("sof", &self.sof().bit())
            .field("rxflvi", &self.rxflvi().bit())
            .field("nptxfemp", &self.nptxfemp().bit())
            .field("ginnakeff", &self.ginnakeff().bit())
            .field("goutnakeff", &self.goutnakeff().bit())
            .field("erlysusp", &self.erlysusp().bit())
            .field("usbsusp", &self.usbsusp().bit())
            .field("usbrst", &self.usbrst().bit())
            .field("enumdone", &self.enumdone().bit())
            .field("isooutdrop", &self.isooutdrop().bit())
            .field("eopf", &self.eopf().bit())
            .field("epmis", &self.epmis().bit())
            .field("iepint", &self.iepint().bit())
            .field("oepint", &self.oepint().bit())
            .field("incompisoin", &self.incompisoin().bit())
            .field("incompip", &self.incompip().bit())
            .field("fetsusp", &self.fetsusp().bit())
            .field("resetdet", &self.resetdet().bit())
            .field("prtlnt", &self.prtlnt().bit())
            .field("hchlnt", &self.hchlnt().bit())
            .field("ptxfemp", &self.ptxfemp().bit())
            .field("conidstschng", &self.conidstschng().bit())
            .field("disconnint", &self.disconnint().bit())
            .field("sessreqint", &self.sessreqint().bit())
            .field("wkupint", &self.wkupint().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
