...
///`read()` method returns [`doepdmab::R`](R) reader structure
impl crate::Readable for DOEPDMAB_SPEC {}
///`write(|w| ..)` method takes [`doepdmab::W`](W) writer structure
