...
pub type DMABUFFERADDR0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DOEPDMAB_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmabufferaddr0(&mut self) -> DMABUFFERADDR0_W<DOEPDMAB_SPEC> {
        DMABUFFERADDR0_W::new(self, 0)
    }
}
