...
pub type H_MPS1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HCCHAR1_SPEC, u16, u16, 11, O>;
#[doc = "Field `H_EPNUM1` reader - "]
pub type H_EPNUM1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `H_EPNUM1` writer - "]
pub type H_EPNUM1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HCCHAR1_SPEC, u8, u8, 4, O>;
#[doc = "Field `H_EPDIR1` reader - "]
pub type H_EPDIR1_R = crate::BitReader<bool>;
#[doc = "Field `H_EPDIR1` writer - "]
pub type H_EPDIR1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCCHAR1_SPEC, bool, O>;
#[doc = "Field `H_LSPDDEV1` reader - "]
pub type H_LSPDDEV1_R = crate::BitReader<bool>;
#[doc = "Field `H_LSPDDEV1` writer - "]
pub type H_LSPDDEV1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCCHAR1_SPEC, bool, O>;
#[doc = "Field `H_EPTYPE1` reader - "]
pub type H_EPTYPE1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `H_EPTYPE1` writer - "]
pub type H_EPTYPE1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HCCHAR1_SPEC, u8, u8, 2, O>;
#[doc = "Field `H_EC1` reader - "]
pub type H_EC1_R = crate::BitReader<bool>;
#[doc = "Field `H_EC1` writer - "]
pub type H_EC1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCCHAR1_SPEC, bool, O>;
#[doc = "Field `H_DEVADDR1` reader - "]
pub type H_DEVADDR1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `H_DEVADDR1` writer - "]
pub type H_DEVADDR1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HCCHAR1_SPEC, u8, u8, 7, O>;
#[doc = "Field `H_ODDFRM1` reader - "]
pub type H_ODDFRM1_R = crate::BitReader<bool>;
#[doc = "Field `H_ODDFRM1` writer - "]
pub type H_ODDFRM1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCCHAR1_SPEC, bool, O>;
#[doc = "Field `H_CHDIS1` reader - "]
pub type H_CHDIS1_R = crate::BitReader<bool>;
#[doc = "Field `H_CHDIS1` writer - "]
pub type H_CHDIS1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCCHAR1_SPEC, bool, O>;
#[doc = "Field `H_CHENA1` reader - "]
pub type H_CHENA1_R = crate::BitReader<bool>;
#[doc = "Field `H_CHENA1` writer - "]
pub type H_CHENA1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HCCHAR1_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:10"]
    #[inline(always)]
