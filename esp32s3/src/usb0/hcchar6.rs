...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn h_mps6(&mut self) -> H_MPS6_W<HCCHAR6_SPEC> {
        H_MPS6_W::new(self, 0)
    }
    #[doc = "Bits 11:14"]
    #[inline(always)]
    #[must_use]
    pub fn h_epnum6(&mut self) -> H_EPNUM6_W<HCCHAR6_SPEC> {
        H_EPNUM6_W::new(self, 11)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn h_epdir6(&mut self) -> H_EPDIR6_W<HCCHAR6_SPEC> {
        H_EPDIR6_W::new(self, 15)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn h_lspddev6(&mut self) -> H_LSPDDEV6_W<HCCHAR6_SPEC> {
        H_LSPDDEV6_W::new(self, 17)
    }
    #[doc = "Bits 18:19"]
    #[inline(always)]
    #[must_use]
    pub fn h_eptype6(&mut self) -> H_EPTYPE6_W<HCCHAR6_SPEC> {
        H_EPTYPE6_W::new(self, 18)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn h_ec6(&mut self) -> H_EC6_W<HCCHAR6_SPEC> {
        H_EC6_W::new(self, 21)
    }
    #[doc = "Bits 22:28"]
    #[inline(always)]
    #[must_use]
    pub fn h_devaddr6(&mut self) -> H_DEVADDR6_W<HCCHAR6_SPEC> {
        H_DEVADDR6_W::new(self, 22)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn h_oddfrm6(&mut self) -> H_ODDFRM6_W<HCCHAR6_SPEC> {
        H_ODDFRM6_W::new(self, 29)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    #[must_use]
    pub fn h_chdis6(&mut self) -> H_CHDIS6_W<HCCHAR6_SPEC> {
        H_CHDIS6_W::new(self, 30)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn h_chena6(&mut self) -> H_CHENA6_W<HCCHAR6_SPEC> {
        H_CHENA6_W::new(self, 31)
    }
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hcchar6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hcchar6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
