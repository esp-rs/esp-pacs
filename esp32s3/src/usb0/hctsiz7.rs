...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn h_xfersize7(&mut self) -> H_XFERSIZE7_W<HCTSIZ7_SPEC> {
        H_XFERSIZE7_W::new(self, 0)
    }
    #[doc = "Bits 19:28"]
    #[inline(always)]
    #[must_use]
    pub fn h_pktcnt7(&mut self) -> H_PKTCNT7_W<HCTSIZ7_SPEC> {
        H_PKTCNT7_W::new(self, 19)
    }
    #[doc = "Bits 29:30"]
    #[inline(always)]
    #[must_use]
    pub fn h_pid7(&mut self) -> H_PID7_W<HCTSIZ7_SPEC> {
        H_PID7_W::new(self, 29)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn h_dopng7(&mut self) -> H_DOPNG7_W<HCTSIZ7_SPEC> {
        H_DOPNG7_W::new(self, 31)
    }
