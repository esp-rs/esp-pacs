...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DAINTMSK")
            .field("inepmsk0", &self.inepmsk0().bit())
            .field("inepmsk1", &self.inepmsk1().bit())
            .field("inepmsk2", &self.inepmsk2().bit())
            .field("inepmsk3", &self.inepmsk3().bit())
            .field("inepmsk4", &self.inepmsk4().bit())
            .field("inepmsk5", &self.inepmsk5().bit())
            .field("inepmsk6", &self.inepmsk6().bit())
            .field("outepmsk0", &self.outepmsk0().bit())
            .field("outepmsk1", &self.outepmsk1().bit())
            .field("outepmsk2", &self.outepmsk2().bit())
            .field("outepmsk3", &self.outepmsk3().bit())
            .field("outepmsk4", &self.outepmsk4().bit())
            .field("outepmsk5", &self.outepmsk5().bit())
            .field("outepmsk6", &self.outepmsk6().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
