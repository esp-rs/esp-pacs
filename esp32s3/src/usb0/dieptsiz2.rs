...
pub type D_XFERSIZE2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `D_XFERSIZE2` writer - "]
pub type D_XFERSIZE2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTSIZ2_SPEC, u8, u8, 7, O>;
#[doc = "Field `D_PKTCNT2` reader - "]
pub type D_PKTCNT2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `D_PKTCNT2` writer - "]
pub type D_PKTCNT2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIEPTSIZ2_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
