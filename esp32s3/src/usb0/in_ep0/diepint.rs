...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DIEPINT")
            ...
            .field("intkntxfemp", &self.intkntxfemp().bit())
            .field("intknepmis", &self.intknepmis().bit())
            .field("inepnakeff", &self.inepnakeff().bit())
            .field("txfemp", &self.txfemp().bit())
            .field("txfifoundrn", &self.txfifoundrn().bit())
            ...
            .field("nyetintrpt", &self.nyetintrpt().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
