...
///Field `NYETINTRPT` reader -
pub type NYETINTRPT_R = crate::BitReader;
///Field `NYETINTRPT` writer -
...
///`read()` method returns [`diepint::R`](R) reader structure
impl crate::Readable for DIEPINT_SPEC {}
///`write(|w| ..)` method takes [`diepint::W`](W) writer structure
