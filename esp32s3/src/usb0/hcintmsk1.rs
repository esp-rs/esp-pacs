...
pub type H_DESC_LST_ROLLINTRMSK1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn h_xfercomplmsk1(&mut self) -> H_XFERCOMPLMSK1_W<HCINTMSK1_SPEC, 0> {
        H_XFERCOMPLMSK1_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn h_chhltdmsk1(&mut self) -> H_CHHLTDMSK1_W<HCINTMSK1_SPEC, 1> {
        H_CHHLTDMSK1_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn h_ahberrmsk1(&mut self) -> H_AHBERRMSK1_W<HCINTMSK1_SPEC, 2> {
        H_AHBERRMSK1_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn h_stallmsk1(&mut self) -> H_STALLMSK1_W<HCINTMSK1_SPEC, 3> {
        H_STALLMSK1_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn h_nakmsk1(&mut self) -> H_NAKMSK1_W<HCINTMSK1_SPEC, 4> {
        H_NAKMSK1_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn h_ackmsk1(&mut self) -> H_ACKMSK1_W<HCINTMSK1_SPEC, 5> {
        H_ACKMSK1_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn h_nyetmsk1(&mut self) -> H_NYETMSK1_W<HCINTMSK1_SPEC, 6> {
        H_NYETMSK1_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn h_xacterrmsk1(&mut self) -> H_XACTERRMSK1_W<HCINTMSK1_SPEC, 7> {
        H_XACTERRMSK1_W::new(self)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn h_bblerrmsk1(&mut self) -> H_BBLERRMSK1_W<HCINTMSK1_SPEC, 8> {
        H_BBLERRMSK1_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn h_frmovrunmsk1(&mut self) -> H_FRMOVRUNMSK1_W<HCINTMSK1_SPEC, 9> {
        H_FRMOVRUNMSK1_W::new(self)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn h_datatglerrmsk1(&mut self) -> H_DATATGLERRMSK1_W<HCINTMSK1_SPEC, 10> {
        H_DATATGLERRMSK1_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn h_bnaintrmsk1(&mut self) -> H_BNAINTRMSK1_W<HCINTMSK1_SPEC, 11> {
