...
pub type R = crate::R<DOEPCTL6_SPEC>;
#[doc = "Register `DOEPCTL6` writer"]
pub type W = crate::W<DOEPCTL6_SPEC>;
...
pub type SNP6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `STALL6` reader - "]
pub type STALL6_R = crate::BitReader;
#[doc = "Field `STALL6` writer - "]
pub type STALL6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CNAK6` writer - "]
pub type CNAK6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DO_SNAK6` writer - "]
pub type DO_SNAK6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DO_SETD0PID6` writer - "]
pub type DO_SETD0PID6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DO_SETD1PID6` writer - "]
pub type DO_SETD1PID6_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EPENA6_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:10"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn snp6(&mut self) -> SNP6_W<DOEPCTL6_SPEC> {
        SNP6_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn stall6(&mut self) -> STALL6_W<DOEPCTL6_SPEC> {
        STALL6_W::new(self, 21)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn cnak6(&mut self) -> CNAK6_W<DOEPCTL6_SPEC> {
        CNAK6_W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn do_snak6(&mut self) -> DO_SNAK6_W<DOEPCTL6_SPEC> {
        DO_SNAK6_W::new(self, 27)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    #[must_use]
    pub fn do_setd0pid6(&mut self) -> DO_SETD0PID6_W<DOEPCTL6_SPEC> {
        DO_SETD0PID6_W::new(self, 28)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn do_setd1pid6(&mut self) -> DO_SETD1PID6_W<DOEPCTL6_SPEC> {
        DO_SETD1PID6_W::new(self, 29)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn epena6(&mut self) -> EPENA6_W<DOEPCTL6_SPEC> {
        EPENA6_W::new(self, 31)
    }
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`doepctl6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`doepctl6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
