...
pub struct W(crate::W<DOEPDMAB0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DOEPDMAB0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DOEPDMAB0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DOEPDMAB0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DMABUFFERADDR0` reader - "]
pub type DMABUFFERADDR0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DMABUFFERADDR0` writer - "]
pub type DMABUFFERADDR0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DOEPDMAB0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn dmabufferaddr0(&mut self) -> DMABUFFERADDR0_W<0> {
