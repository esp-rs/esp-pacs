...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn d_xfercompl1(&mut self) -> D_XFERCOMPL1_W<DIEPINT_SPEC> {
        D_XFERCOMPL1_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn d_epdisbld1(&mut self) -> D_EPDISBLD1_W<DIEPINT_SPEC> {
        D_EPDISBLD1_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn d_ahberr1(&mut self) -> D_AHBERR1_W<DIEPINT_SPEC> {
        D_AHBERR1_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn d_timeout1(&mut self) -> D_TIMEOUT1_W<DIEPINT_SPEC> {
        D_TIMEOUT1_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn d_intkntxfemp1(&mut self) -> D_INTKNTXFEMP1_W<DIEPINT_SPEC> {
        D_INTKNTXFEMP1_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn d_intknepmis1(&mut self) -> D_INTKNEPMIS1_W<DIEPINT_SPEC> {
        D_INTKNEPMIS1_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn d_inepnakeff1(&mut self) -> D_INEPNAKEFF1_W<DIEPINT_SPEC> {
        D_INEPNAKEFF1_W::new(self, 6)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn d_txfifoundrn1(&mut self) -> D_TXFIFOUNDRN1_W<DIEPINT_SPEC> {
        D_TXFIFOUNDRN1_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn d_bnaintr1(&mut self) -> D_BNAINTR1_W<DIEPINT_SPEC> {
        D_BNAINTR1_W::new(self, 9)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn d_pktdrpsts1(&mut self) -> D_PKTDRPSTS1_W<DIEPINT_SPEC> {
        D_PKTDRPSTS1_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn d_bbleerr1(&mut self) -> D_BBLEERR1_W<DIEPINT_SPEC> {
        D_BBLEERR1_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn d_nakintrpt1(&mut self) -> D_NAKINTRPT1_W<DIEPINT_SPEC> {
        D_NAKINTRPT1_W::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn d_nyetintrpt1(&mut self) -> D_NYETINTRPT1_W<DIEPINT_SPEC> {
