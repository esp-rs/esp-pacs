...
///Field `CORE_0_IRAM0_RECORDING_ADDR_0` reader - The first iram0's addr\[25:2\] status when trigger IRAM busy interrupt
pub type CORE_0_IRAM0_RECORDING_ADDR_0_R = crate::FieldReader<u32>;
///Field `CORE_0_IRAM0_RECORDING_WR_0` reader - The first iram0's wr status when trigger IRAM busy interrupt
pub type CORE_0_IRAM0_RECORDING_WR_0_R = crate::BitReader;
///Field `CORE_0_IRAM0_RECORDING_LOADSTORE_0` reader - The first iram0's loadstore status when trigger IRAM busy interrupt
