...
pub struct R(crate::R<CORE_1_SP_MAX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_SP_MAX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_SP_MAX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_SP_MAX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_1_SP_MAX` writer"]
pub struct W(crate::W<CORE_1_SP_MAX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_SP_MAX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_SP_MAX_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_SP_MAX_SPEC>) -> Self {
        W(writer)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_SP_MAX")
            .field(
                "core_1_sp_max",
                &format_args!("{}", self.core_1_sp_max().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_1_SP_MAX_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_sp_max(&mut self) -> CORE_1_SP_MAX_W<0> {
