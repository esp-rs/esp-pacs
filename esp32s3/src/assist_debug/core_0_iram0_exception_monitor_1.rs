///Register `CORE_0_IRAM0_EXCEPTION_MONITOR_1` reader
pub type R = crate::R<CORE_0_IRAM0_EXCEPTION_MONITOR_1_SPEC>;
///Field `CORE_0_IRAM0_RECORDING_ADDR_1` reader - The second iram0's addr\[25:2\] status when trigger IRAM busy interrupt
pub type CORE_0_IRAM0_RECORDING_ADDR_1_R = crate::FieldReader<u32>;
///Field `CORE_0_IRAM0_RECORDING_WR_1` reader - The second iram0's wr status when trigger IRAM busy interrupt
pub type CORE_0_IRAM0_RECORDING_WR_1_R = crate::BitReader;
///Field `CORE_0_IRAM0_RECORDING_LOADSTORE_1` reader - The second iram0's loadstore status when trigger IRAM busy interrupt
pub type CORE_0_IRAM0_RECORDING_LOADSTORE_1_R = crate::BitReader;
impl R {
    ///Bits 0:23 - The second iram0's addr\[25:2\] status when trigger IRAM busy interrupt
    #[inline(always)]
    ...
    ///Bit 24 - The second iram0's wr status when trigger IRAM busy interrupt
    #[inline(always)]
    pub fn core_0_iram0_recording_wr_1(&self) -> CORE_0_IRAM0_RECORDING_WR_1_R {
        CORE_0_IRAM0_RECORDING_WR_1_R::new(((self.bits >> 24) & 1) != 0)
    }
    ///Bit 25 - The second iram0's loadstore status when trigger IRAM busy interrupt
    #[inline(always)]
...
///`read()` method returns [`core_0_iram0_exception_monitor_1::R`](R) reader structure
