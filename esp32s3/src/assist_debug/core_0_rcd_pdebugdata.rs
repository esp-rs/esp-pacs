///Register `CORE_0_RCD_PDEBUGDATA` reader
pub type R = crate::R<CORE_0_RCD_PDEBUGDATA_SPEC>;
///Field `CORE_0_RCD_PDEBUGDATA` reader - core0_pdebugdata
pub type CORE_0_RCD_PDEBUGDATA_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - core0_pdebugdata
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_0_rcd_pdebugdata::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_RCD_PDEBUGDATA_SPEC;
impl crate::RegisterSpec for CORE_0_RCD_PDEBUGDATA_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_0_rcd_pdebugdata::R`](R) reader structure
