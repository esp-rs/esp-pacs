...
pub type CORE_1_AREA_DRAM0_0_RD_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_AREA_DRAM0_0_WR_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_AREA_DRAM0_1_RD_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_AREA_DRAM0_1_WR_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_AREA_PIF_0_RD_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_AREA_PIF_0_WR_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_AREA_PIF_1_RD_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_AREA_PIF_1_WR_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_SP_SPILL_MIN_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_SP_SPILL_MAX_INTR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_IRAM0_EXCEPTION_MONITOR_INTR_ENA_W<'a, REG, const O: u8> =
...
pub type CORE_1_DRAM0_EXCEPTION_MONITOR_INTR_ENA_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn core_1_area_dram0_0_rd_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_0_RD_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 0> {
    ...
    pub fn core_1_area_dram0_0_wr_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_0_WR_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 1> {
    ...
    pub fn core_1_area_dram0_1_rd_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_1_RD_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 2> {
    ...
    pub fn core_1_area_dram0_1_wr_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_1_WR_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 3> {
    ...
    pub fn core_1_area_pif_0_rd_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_PIF_0_RD_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 4> {
    ...
    pub fn core_1_area_pif_0_wr_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_PIF_0_WR_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 5> {
    ...
    pub fn core_1_area_pif_1_rd_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_PIF_1_RD_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 6> {
    ...
    pub fn core_1_area_pif_1_wr_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_PIF_1_WR_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 7> {
    ...
    pub fn core_1_sp_spill_min_intr_ena(
        &mut self,
    ) -> CORE_1_SP_SPILL_MIN_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 8> {
    ...
    pub fn core_1_sp_spill_max_intr_ena(
        &mut self,
    ) -> CORE_1_SP_SPILL_MAX_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 9> {
    ...
    pub fn core_1_iram0_exception_monitor_intr_ena(
        &mut self,
    ) -> CORE_1_IRAM0_EXCEPTION_MONITOR_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 10> {
    ...
    pub fn core_1_dram0_exception_monitor_intr_ena(
        &mut self,
    ) -> CORE_1_DRAM0_EXCEPTION_MONITOR_INTR_ENA_W<CORE_1_INTR_ENA_SPEC, 11> {
