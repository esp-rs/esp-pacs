...
///Register `CORE_1_INTR_ENA` writer
pub type W = crate::W<CORE_1_INTR_ENA_SPEC>;
///Field `CORE_1_AREA_DRAM0_0_RD_INTR_ENA` reader - Core1 dram0 area0 read monitor interrupt enable
pub type CORE_1_AREA_DRAM0_0_RD_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_AREA_DRAM0_0_RD_INTR_ENA` writer - Core1 dram0 area0 read monitor interrupt enable
pub type CORE_1_AREA_DRAM0_0_RD_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_DRAM0_0_WR_INTR_ENA` reader - Core1 dram0 area0 write monitor interrupt enable
pub type CORE_1_AREA_DRAM0_0_WR_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_AREA_DRAM0_0_WR_INTR_ENA` writer - Core1 dram0 area0 write monitor interrupt enable
pub type CORE_1_AREA_DRAM0_0_WR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_DRAM0_1_RD_INTR_ENA` reader - Core1 dram0 area1 read monitor interrupt enable
pub type CORE_1_AREA_DRAM0_1_RD_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_AREA_DRAM0_1_RD_INTR_ENA` writer - Core1 dram0 area1 read monitor interrupt enable
pub type CORE_1_AREA_DRAM0_1_RD_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_DRAM0_1_WR_INTR_ENA` reader - Core1 dram0 area1 write monitor interrupt enable
pub type CORE_1_AREA_DRAM0_1_WR_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_AREA_DRAM0_1_WR_INTR_ENA` writer - Core1 dram0 area1 write monitor interrupt enable
pub type CORE_1_AREA_DRAM0_1_WR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_PIF_0_RD_INTR_ENA` reader - Core1 PIF area0 read monitor interrupt enable
pub type CORE_1_AREA_PIF_0_RD_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_AREA_PIF_0_RD_INTR_ENA` writer - Core1 PIF area0 read monitor interrupt enable
pub type CORE_1_AREA_PIF_0_RD_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_PIF_0_WR_INTR_ENA` reader - Core1 PIF area0 write monitor interrupt enable
pub type CORE_1_AREA_PIF_0_WR_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_AREA_PIF_0_WR_INTR_ENA` writer - Core1 PIF area0 write monitor interrupt enable
pub type CORE_1_AREA_PIF_0_WR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_PIF_1_RD_INTR_ENA` reader - Core1 PIF area1 read monitor interrupt enable
pub type CORE_1_AREA_PIF_1_RD_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_AREA_PIF_1_RD_INTR_ENA` writer - Core1 PIF area1 read monitor interrupt enable
pub type CORE_1_AREA_PIF_1_RD_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_AREA_PIF_1_WR_INTR_ENA` reader - Core1 PIF area1 write monitor interrupt enable
pub type CORE_1_AREA_PIF_1_WR_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_AREA_PIF_1_WR_INTR_ENA` writer - Core1 PIF area1 write monitor interrupt enable
pub type CORE_1_AREA_PIF_1_WR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_SP_SPILL_MIN_INTR_ENA` reader - Core1 stackpoint overflow monitor interrupt enable
pub type CORE_1_SP_SPILL_MIN_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_SP_SPILL_MIN_INTR_ENA` writer - Core1 stackpoint overflow monitor interrupt enable
pub type CORE_1_SP_SPILL_MIN_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_SP_SPILL_MAX_INTR_ENA` reader - Core1 stackpoint underflow monitor interrupt enable
pub type CORE_1_SP_SPILL_MAX_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_SP_SPILL_MAX_INTR_ENA` writer - Core1 stackpoint underflow monitor interrupt enable
pub type CORE_1_SP_SPILL_MAX_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_IRAM0_EXCEPTION_MONITOR_INTR_ENA` reader - IBUS busy monitor interrupt enable
pub type CORE_1_IRAM0_EXCEPTION_MONITOR_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_IRAM0_EXCEPTION_MONITOR_INTR_ENA` writer - IBUS busy monitor interrupt enable
pub type CORE_1_IRAM0_EXCEPTION_MONITOR_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_DRAM0_EXCEPTION_MONITOR_INTR_ENA` reader - DBUS busy monitor interrupt enbale
pub type CORE_1_DRAM0_EXCEPTION_MONITOR_INTR_ENA_R = crate::BitReader;
///Field `CORE_1_DRAM0_EXCEPTION_MONITOR_INTR_ENA` writer - DBUS busy monitor interrupt enbale
...
///`read()` method returns [`core_1_intr_ena::R`](R) reader structure
impl crate::Readable for CORE_1_INTR_ENA_SPEC {}
///`write(|w| ..)` method takes [`core_1_intr_ena::W`](W) writer structure
