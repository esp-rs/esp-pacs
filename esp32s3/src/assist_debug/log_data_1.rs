...
///`read()` method returns [`log_data_1::R`](R) reader structure
impl crate::Readable for LOG_DATA_1_SPEC {}
///`write(|w| ..)` method takes [`log_data_1::W`](W) writer structure
