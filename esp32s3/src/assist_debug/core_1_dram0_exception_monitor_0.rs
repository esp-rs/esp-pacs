///Register `CORE_1_DRAM0_EXCEPTION_MONITOR_0` reader
pub type R = crate::R<CORE_1_DRAM0_EXCEPTION_MONITOR_0_SPEC>;
///Field `CORE_1_DRAM0_RECORDING_ADDR_0` reader - The first dram0's addr\[25:4\] status when trigger DRAM busy interrupt
pub type CORE_1_DRAM0_RECORDING_ADDR_0_R = crate::FieldReader<u32>;
///Field `CORE_1_DRAM0_RECORDING_WR_0` reader - The first dram0's wr status when trigger DRAM busy interrupt
pub type CORE_1_DRAM0_RECORDING_WR_0_R = crate::BitReader;
impl R {
    ///Bits 0:21 - The first dram0's addr\[25:4\] status when trigger DRAM busy interrupt
    #[inline(always)]
    ...
    ///Bit 22 - The first dram0's wr status when trigger DRAM busy interrupt
    #[inline(always)]
...
///`read()` method returns [`core_1_dram0_exception_monitor_0::R`](R) reader structure
