///Register `CORE_1_DRAM0_EXCEPTION_MONITOR_4` reader
pub type R = crate::R<CORE_1_DRAM0_EXCEPTION_MONITOR_4_SPEC>;
///Field `CORE_1_DRAM0_RECORDING_BYTEEN_1` reader - The second dram0's byteen status when trigger DRAM busy interrupt
pub type CORE_1_DRAM0_RECORDING_BYTEEN_1_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - The second dram0's byteen status when trigger DRAM busy interrupt
    #[inline(always)]
...
///`read()` method returns [`core_1_dram0_exception_monitor_4::R`](R) reader structure
