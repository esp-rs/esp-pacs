///Register `CORE_0_RCD_PDEBUGLS0STAT` reader
pub type R = crate::R<CORE_0_RCD_PDEBUGLS0STAT_SPEC>;
///Field `CORE_0_RCD_PDEBUGLS0STAT` reader - core0_pdebug_s0stat
pub type CORE_0_RCD_PDEBUGLS0STAT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - core0_pdebug_s0stat
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_0_rcd_pdebugls0stat::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_RCD_PDEBUGLS0STAT_SPEC;
impl crate::RegisterSpec for CORE_0_RCD_PDEBUGLS0STAT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_0_rcd_pdebugls0stat::R`](R) reader structure
