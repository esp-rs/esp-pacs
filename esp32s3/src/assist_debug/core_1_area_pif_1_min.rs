///Register `CORE_1_AREA_PIF_1_MIN` reader
pub type R = crate::R<CORE_1_AREA_PIF_1_MIN_SPEC>;
///Register `CORE_1_AREA_PIF_1_MIN` writer
pub type W = crate::W<CORE_1_AREA_PIF_1_MIN_SPEC>;
///Field `CORE_1_AREA_PIF_1_MIN` reader - Core1 PIF region1 start addr
pub type CORE_1_AREA_PIF_1_MIN_R = crate::FieldReader<u32>;
///Field `CORE_1_AREA_PIF_1_MIN` writer - Core1 PIF region1 start addr
pub type CORE_1_AREA_PIF_1_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core1 PIF region1 start addr
    #[inline(always)]
...
///`read()` method returns [`core_1_area_pif_1_min::R`](R) reader structure
impl crate::Readable for CORE_1_AREA_PIF_1_MIN_SPEC {}
///`write(|w| ..)` method takes [`core_1_area_pif_1_min::W`](W) writer structure
