///Register `CORE_0_AREA_DRAM0_0_MIN` reader
pub type R = crate::R<CORE_0_AREA_DRAM0_0_MIN_SPEC>;
///Register `CORE_0_AREA_DRAM0_0_MIN` writer
pub type W = crate::W<CORE_0_AREA_DRAM0_0_MIN_SPEC>;
///Field `CORE_0_AREA_DRAM0_0_MIN` reader - Core0 dram0 region0 start addr
pub type CORE_0_AREA_DRAM0_0_MIN_R = crate::FieldReader<u32>;
///Field `CORE_0_AREA_DRAM0_0_MIN` writer - Core0 dram0 region0 start addr
pub type CORE_0_AREA_DRAM0_0_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core0 dram0 region0 start addr
    #[inline(always)]
...
///`read()` method returns [`core_0_area_dram0_0_min::R`](R) reader structure
impl crate::Readable for CORE_0_AREA_DRAM0_0_MIN_SPEC {}
///`write(|w| ..)` method takes [`core_0_area_dram0_0_min::W`](W) writer structure
