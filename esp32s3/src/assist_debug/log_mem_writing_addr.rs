///Register `LOG_MEM_WRITING_ADDR` reader
pub type R = crate::R<LOG_MEM_WRITING_ADDR_SPEC>;
///Field `LOG_MEM_WRITING_ADDR` reader - mem current addr, it means next writing addr
pub type LOG_MEM_WRITING_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - mem current addr, it means next writing addr
    #[inline(always)]
...
///`read()` method returns [`log_mem_writing_addr::R`](R) reader structure
