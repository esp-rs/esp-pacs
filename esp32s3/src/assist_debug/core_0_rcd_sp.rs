///Register `CORE_0_RCD_SP` reader
pub type R = crate::R<CORE_0_RCD_SP_SPEC>;
///Field `CORE_0_RCD_SP` reader - core0_stack pointer
pub type CORE_0_RCD_SP_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - core0_stack pointer
    #[inline(always)]
...
///`read()` method returns [`core_0_rcd_sp::R`](R) reader structure
