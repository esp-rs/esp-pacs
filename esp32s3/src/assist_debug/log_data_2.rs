...
///`read()` method returns [`log_data_2::R`](R) reader structure
impl crate::Readable for LOG_DATA_2_SPEC {}
///`write(|w| ..)` method takes [`log_data_2::W`](W) writer structure
