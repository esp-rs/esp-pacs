    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_IRAM0_EXCEPTION_MONITOR_1")
            .field(
                ...
                &format_args!("{}", self.core_1_iram0_recording_addr_1().bits()),
            )
            .field(
                "core_1_iram0_recording_wr_1",
                &format_args!("{}", self.core_1_iram0_recording_wr_1().bit()),
            )
            .field(
                "core_1_iram0_recording_loadstore_1",
                &format_args!("{}", self.core_1_iram0_recording_loadstore_1().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_1_IRAM0_EXCEPTION_MONITOR_1_SPEC> {
