...
///Field `CORE_1_IRAM0_RECORDING_ADDR_1` reader - The second iram0's addr\[25:2\] status when trigger IRAM busy interrupt
pub type CORE_1_IRAM0_RECORDING_ADDR_1_R = crate::FieldReader<u32>;
///Field `CORE_1_IRAM0_RECORDING_WR_1` reader - The second iram0's wr status when trigger IRAM busy interrupt
pub type CORE_1_IRAM0_RECORDING_WR_1_R = crate::BitReader;
///Field `CORE_1_IRAM0_RECORDING_LOADSTORE_1` reader - The second iram0's loadstore status when trigger IRAM busy interrupt
