...
///Field `CORE_1_SP_SPILL_MIN_RAW` reader - Core1 stackpoint overflow monitor interrupt status
pub type CORE_1_SP_SPILL_MIN_RAW_R = crate::BitReader;
///Field `CORE_1_SP_SPILL_MAX_RAW` reader - Core1 stackpoint underflow monitor interrupt status
...
impl R {
    ...
    ///Bit 8 - Core1 stackpoint overflow monitor interrupt status
    #[inline(always)]
    pub fn core_1_sp_spill_min_raw(&self) -> CORE_1_SP_SPILL_MIN_RAW_R {
        CORE_1_SP_SPILL_MIN_RAW_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Core1 stackpoint underflow monitor interrupt status
    #[inline(always)]
