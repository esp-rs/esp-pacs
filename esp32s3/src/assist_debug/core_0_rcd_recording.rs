///Register `CORE_0_RCD_RECORDING` reader
pub type R = crate::R<CORE_0_RCD_RECORDING_SPEC>;
///Register `CORE_0_RCD_RECORDING` writer
pub type W = crate::W<CORE_0_RCD_RECORDING_SPEC>;
///Field `CORE_0_RCD_RECORDING` reader - Pdebug record enable,set 1 to record core0 pdebug interface signal
pub type CORE_0_RCD_RECORDING_R = crate::BitReader;
///Field `CORE_0_RCD_RECORDING` writer - Pdebug record enable,set 1 to record core0 pdebug interface signal
pub type CORE_0_RCD_RECORDING_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Pdebug record enable,set 1 to record core0 pdebug interface signal
    #[inline(always)]
...
///`read()` method returns [`core_0_rcd_recording::R`](R) reader structure
impl crate::Readable for CORE_0_RCD_RECORDING_SPEC {}
///`write(|w| ..)` method takes [`core_0_rcd_recording::W`](W) writer structure
