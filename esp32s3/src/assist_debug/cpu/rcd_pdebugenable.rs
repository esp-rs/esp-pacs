...
#[doc = "Field `RCD_PDEBUGENABLE` reader - Core0 Pdebugenable,set 1 to open core0 Pdebug interface,then can get core0 PC"]
pub type RCD_PDEBUGENABLE_R = crate::BitReader;
#[doc = "Field `RCD_PDEBUGENABLE` writer - Core0 Pdebugenable,set 1 to open core0 Pdebug interface,then can get core0 PC"]
pub type RCD_PDEBUGENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Core0 Pdebugenable,set 1 to open core0 Pdebug interface,then can get core0 PC"]
    #[inline(always)]
    pub fn rcd_pdebugenable(&self) -> RCD_PDEBUGENABLE_R {
        RCD_PDEBUGENABLE_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RCD_PDEBUGENABLE")
            .field("rcd_pdebugenable", &self.rcd_pdebugenable())
            .finish()
    }
}
impl W {
