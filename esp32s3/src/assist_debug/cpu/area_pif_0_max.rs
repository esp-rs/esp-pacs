...
#[doc = "Field `AREA_PIF_0_MAX` reader - Core0 PIF region0 end addr"]
pub type AREA_PIF_0_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_PIF_0_MAX` writer - Core0 PIF region0 end addr"]
...
impl W {
    #[doc = "Bits 0:31 - Core0 PIF region0 end addr"]
    #[inline(always)]
    pub fn area_pif_0_max(&mut self) -> AREA_PIF_0_MAX_W<AREA_PIF_0_MAX_SPEC> {
