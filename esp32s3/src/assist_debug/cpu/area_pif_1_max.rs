...
#[doc = "Field `AREA_PIF_1_MAX` reader - Core0 PIF region1 end addr"]
pub type AREA_PIF_1_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_PIF_1_MAX` writer - Core0 PIF region1 end addr"]
...
impl W {
    #[doc = "Bits 0:31 - Core0 PIF region1 end addr"]
    #[inline(always)]
    pub fn area_pif_1_max(&mut self) -> AREA_PIF_1_MAX_W<AREA_PIF_1_MAX_SPEC> {
