...
#[doc = "Field `SP_SPILL_MIN_RAW` reader - Core0 stackpoint overflow monitor interrupt status"]
pub type SP_SPILL_MIN_RAW_R = crate::BitReader;
#[doc = "Field `SP_SPILL_MAX_RAW` reader - Core0 stackpoint underflow monitor interrupt status"]
