///Register `CORE_1_RCD_PDEBUGSTATUS` reader
pub type R = crate::R<CORE_1_RCD_PDEBUGSTATUS_SPEC>;
///Field `CORE_1_RCD_PDEBUGSTATUS` reader - Core1 pdebugstatus
pub type CORE_1_RCD_PDEBUGSTATUS_R = crate::FieldReader;
impl R {
    ///Bits 0:7 - Core1 pdebugstatus
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_RCD_PDEBUGSTATUS")
            .field("core_1_rcd_pdebugstatus", &self.core_1_rcd_pdebugstatus())
            .finish()
    }
}
...
///`read()` method returns [`core_1_rcd_pdebugstatus::R`](R) reader structure
