///Register `CORE_0_DRAM0_EXCEPTION_MONITOR_4` reader
pub type R = crate::R<CORE_0_DRAM0_EXCEPTION_MONITOR_4_SPEC>;
///Field `CORE_0_DRAM0_RECORDING_BYTEEN_1` reader - The second dram0's byteen status when trigger DRAM busy interrupt
...
///`read()` method returns [`core_0_dram0_exception_monitor_4::R`](R) reader structure
