...
///Field `CORE_0_DRAM0_RECORDING_PC_0` reader - The first dram0's PC status when trigger DRAM busy interrupt
pub type CORE_0_DRAM0_RECORDING_PC_0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The first dram0's PC status when trigger DRAM busy interrupt
    #[inline(always)]
