    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_INTR_CLR")
            .field(
                ...
                &self.core_1_area_dram0_0_rd_clr().bit(),
            )
            .field(
                "core_1_area_dram0_0_wr_clr",
                &self.core_1_area_dram0_0_wr_clr().bit(),
            )
            .field(
                "core_1_area_dram0_1_rd_clr",
                &self.core_1_area_dram0_1_rd_clr().bit(),
            )
            .field(
                "core_1_area_dram0_1_wr_clr",
                &self.core_1_area_dram0_1_wr_clr().bit(),
            )
            .field(
                "core_1_area_pif_0_rd_clr",
                &self.core_1_area_pif_0_rd_clr().bit(),
            )
            .field(
                "core_1_area_pif_0_wr_clr",
                &self.core_1_area_pif_0_wr_clr().bit(),
            )
            .field(
                "core_1_area_pif_1_rd_clr",
                &self.core_1_area_pif_1_rd_clr().bit(),
            )
            .field(
                "core_1_area_pif_1_wr_clr",
                &self.core_1_area_pif_1_wr_clr().bit(),
            )
            .field(
                "core_1_sp_spill_min_clr",
                &self.core_1_sp_spill_min_clr().bit(),
            )
            .field(
                "core_1_sp_spill_max_clr",
                &self.core_1_sp_spill_max_clr().bit(),
            )
            .field(
                "core_1_iram0_exception_monitor_clr",
                &self.core_1_iram0_exception_monitor_clr().bit(),
            )
            .field(
                "core_1_dram0_exception_monitor_clr",
                &self.core_1_dram0_exception_monitor_clr().bit(),
            )
            .finish()
    }
}
