///Register `CORE_0_RCD_PDEBUGLS0DATA` reader
pub type R = crate::R<CORE_0_RCD_PDEBUGLS0DATA_SPEC>;
///Field `CORE_0_RCD_PDEBUGLS0DATA` reader - core0_pdebug_s0data
pub type CORE_0_RCD_PDEBUGLS0DATA_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - core0_pdebug_s0data
    #[inline(always)]
...
///`read()` method returns [`core_0_rcd_pdebugls0data::R`](R) reader structure
