...
///Field `CORE_0_SP_SPILL_MIN_RAW` reader - Core0 stackpoint overflow monitor interrupt status
pub type CORE_0_SP_SPILL_MIN_RAW_R = crate::BitReader;
///Field `CORE_0_SP_SPILL_MAX_RAW` reader - Core0 stackpoint underflow monitor interrupt status
...
impl R {
    ...
    ///Bit 8 - Core0 stackpoint overflow monitor interrupt status
    #[inline(always)]
    pub fn core_0_sp_spill_min_raw(&self) -> CORE_0_SP_SPILL_MIN_RAW_R {
        CORE_0_SP_SPILL_MIN_RAW_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - Core0 stackpoint underflow monitor interrupt status
    #[inline(always)]
