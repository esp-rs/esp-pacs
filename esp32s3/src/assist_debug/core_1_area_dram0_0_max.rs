...
pub struct R(crate::R<CORE_1_AREA_DRAM0_0_MAX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_AREA_DRAM0_0_MAX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_AREA_DRAM0_0_MAX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_AREA_DRAM0_0_MAX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_1_AREA_DRAM0_0_MAX` writer"]
pub struct W(crate::W<CORE_1_AREA_DRAM0_0_MAX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_AREA_DRAM0_0_MAX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_AREA_DRAM0_0_MAX_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_AREA_DRAM0_0_MAX_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CORE_1_AREA_DRAM0_0_MAX` reader - Core1 dram0 region0 end addr"]
pub type CORE_1_AREA_DRAM0_0_MAX_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_1_AREA_DRAM0_0_MAX` writer - Core1 dram0 region0 end addr"]
pub type CORE_1_AREA_DRAM0_0_MAX_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_1_AREA_DRAM0_0_MAX_SPEC, 32, O, u32, u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_AREA_DRAM0_0_MAX")
            .field(
                ...
                &format_args!("{}", self.core_1_area_dram0_0_max().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_1_AREA_DRAM0_0_MAX_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_area_dram0_0_max(&mut self) -> CORE_1_AREA_DRAM0_0_MAX_W<0> {
        CORE_1_AREA_DRAM0_0_MAX_W::new(self)
    }
