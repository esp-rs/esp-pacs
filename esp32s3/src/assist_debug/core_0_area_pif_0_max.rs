///Register `CORE_0_AREA_PIF_0_MAX` reader
pub type R = crate::R<CORE_0_AREA_PIF_0_MAX_SPEC>;
///Register `CORE_0_AREA_PIF_0_MAX` writer
pub type W = crate::W<CORE_0_AREA_PIF_0_MAX_SPEC>;
///Field `CORE_0_AREA_PIF_0_MAX` reader - Core0 PIF region0 end addr
pub type CORE_0_AREA_PIF_0_MAX_R = crate::FieldReader<u32>;
///Field `CORE_0_AREA_PIF_0_MAX` writer - Core0 PIF region0 end addr
pub type CORE_0_AREA_PIF_0_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core0 PIF region0 end addr
    #[inline(always)]
...
///`read()` method returns [`core_0_area_pif_0_max::R`](R) reader structure
impl crate::Readable for CORE_0_AREA_PIF_0_MAX_SPEC {}
///`write(|w| ..)` method takes [`core_0_area_pif_0_max::W`](W) writer structure
