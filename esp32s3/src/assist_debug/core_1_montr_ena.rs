///Register `CORE_1_MONTR_ENA` reader
pub type R = crate::R<CORE_1_MONTR_ENA_SPEC>;
///Register `CORE_1_MONTR_ENA` writer
...
///`read()` method returns [`core_1_montr_ena::R`](R) reader structure
impl crate::Readable for CORE_1_MONTR_ENA_SPEC {}
///`write(|w| ..)` method takes [`core_1_montr_ena::W`](W) writer structure
