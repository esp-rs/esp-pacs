...
pub struct R(crate::R<CORE_1_SP_MIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_SP_MIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_SP_MIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_SP_MIN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_1_SP_MIN` writer"]
pub struct W(crate::W<CORE_1_SP_MIN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_SP_MIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_SP_MIN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_SP_MIN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CORE_1_SP_MIN_W<'a, const O: u8> = crate::FieldWriter<'a, CORE_1_SP_MIN_SPEC, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_sp_min(&mut self) -> CORE_1_SP_MIN_W<0> {
