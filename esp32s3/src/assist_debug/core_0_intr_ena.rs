...
///Field `CORE_0_SP_SPILL_MIN_INTR_ENA` reader - Core0 stackpoint overflow monitor interrupt enable
pub type CORE_0_SP_SPILL_MIN_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_SP_SPILL_MIN_INTR_ENA` writer - Core0 stackpoint overflow monitor interrupt enable
pub type CORE_0_SP_SPILL_MIN_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_SP_SPILL_MAX_INTR_ENA` reader - Core0 stackpoint underflow monitor interrupt enable
pub type CORE_0_SP_SPILL_MAX_INTR_ENA_R = crate::BitReader;
///Field `CORE_0_SP_SPILL_MAX_INTR_ENA` writer - Core0 stackpoint underflow monitor interrupt enable
