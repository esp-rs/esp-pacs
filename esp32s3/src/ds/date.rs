...
#[doc = "Field `DATE` reader - ds version information"]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - ds version information"]
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATE_SPEC, u32, u32, 30, O>;
impl R {
    #[doc = "Bits 0:29 - ds version information"]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x2019_1217"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x2019_1217;
}
