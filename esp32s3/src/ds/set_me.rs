///Register `SET_ME` writer
pub type W = crate::W<SET_ME_SPEC>;
///Field `SET_ME` writer - Write 1 to this register to start DS operation.
...
impl W {
    ///Bit 0 - Write 1 to this register to start DS operation.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`set_me::W`](W) writer structure
