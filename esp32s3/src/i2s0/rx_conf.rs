...
pub type RX_PDM2PCM_EN_R = crate::BitReader<bool>;
#[doc = "Field `RX_PDM2PCM_EN` writer - 1: Enable PDM2PCM RX mode. 0: DIsable."]
pub type RX_PDM2PCM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, O>;
...
pub type RX_PDM_SINC_DSR_16_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RX_CONF_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 21 - 1: Enable PDM2PCM RX mode. 0: DIsable."]
    #[inline(always)]
    pub fn rx_pdm2pcm_en(&mut self) -> RX_PDM2PCM_EN_W<21> {
        RX_PDM2PCM_EN_W::new(self)
    }
    #[doc = "Bit 22 - Configure the down sampling rate of PDM RX filter group1 module. 1: The down sampling rate is 128. 0: down sampling rate is 64."]
    #[inline(always)]
    pub fn rx_pdm_sinc_dsr_16_en(&mut self) -> RX_PDM_SINC_DSR_16_EN_W<22> {
