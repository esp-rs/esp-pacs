...
pub type RX_PDM2PCM_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_pdm2pcm_en(&mut self) -> RX_PDM2PCM_EN_W<RX_CONF_SPEC, 21> {
        RX_PDM2PCM_EN_W::new(self)
    }
    #[doc = "Bit 22 - Configure the down sampling rate of PDM RX filter group1 module. 1: The down sampling rate is 128. 0: down sampling rate is 64."]
    #[inline(always)]
    #[must_use]
    pub fn rx_pdm_sinc_dsr_16_en(&mut self) -> RX_PDM_SINC_DSR_16_EN_W<RX_CONF_SPEC, 22> {
