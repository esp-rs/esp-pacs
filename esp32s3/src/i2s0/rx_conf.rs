...
///Field `RX_BIG_ENDIAN` reader - I2S Rx byte endian, 1: low addr value to high addr. 0: low addr with low addr value.
...
///Field `RX_UPDATE` reader - Set 1 to update I2S RX registers from APB clock domain to I2S RX clock domain. This bit will be cleared by hardware after update register done.
...
///Field `RX_MONO_FST_VLD` reader - 1: The first channel data value is valid in I2S RX mono mode. 0: The second channel data value is valid in I2S RX mono mode.
pub type RX_MONO_FST_VLD_R = crate::BitReader;
///Field `RX_MONO_FST_VLD` writer - 1: The first channel data value is valid in I2S RX mono mode. 0: The second channel data value is valid in I2S RX mono mode.
pub type RX_MONO_FST_VLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_PCM_CONF` reader - I2S RX compress/decompress configuration bit. &amp; 0 (atol): A-Law decompress, 1 (ltoa) : A-Law compress, 2 (utol) : u-Law decompress, 3 (ltou) : u-Law compress. &amp;
pub type RX_PCM_CONF_R = crate::FieldReader;
///Field `RX_PCM_CONF` writer - I2S RX compress/decompress configuration bit. &amp; 0 (atol): A-Law decompress, 1 (ltoa) : A-Law compress, 2 (utol) : u-Law decompress, 3 (ltou) : u-Law compress. &amp;
...
///Field `RX_STOP_MODE` reader - 0 : I2S Rx only stop when reg_rx_start is cleared. 1: Stop when reg_rx_start is 0 or in_suc_eof is 1. 2: Stop I2S RX when reg_rx_start is 0 or RX FIFO is full.
...
///Field `RX_LEFT_ALIGN` reader - 1: I2S RX left alignment mode. 0: I2S RX right alignment mode.
pub type RX_LEFT_ALIGN_R = crate::BitReader;
///Field `RX_LEFT_ALIGN` writer - 1: I2S RX left alignment mode. 0: I2S RX right alignment mode.
pub type RX_LEFT_ALIGN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_24_FILL_EN` reader - 1: store 24 channel bits to 32 bits. 0:store 24 channel bits to 24 bits.
pub type RX_24_FILL_EN_R = crate::BitReader;
///Field `RX_24_FILL_EN` writer - 1: store 24 channel bits to 32 bits. 0:store 24 channel bits to 24 bits.
...
///Field `RX_WS_IDLE_POL` writer - 0: WS should be 0 when receiving left channel data, and WS is 1in right channel. 1: WS should be 1 when receiving left channel data, and WS is 0in right channel.
pub type RX_WS_IDLE_POL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_BIT_ORDER` reader - I2S Rx bit endian. 1:small endian, the LSB is received first. 0:big endian, the MSB is received first.
pub type RX_BIT_ORDER_R = crate::BitReader;
///Field `RX_BIT_ORDER` writer - I2S Rx bit endian. 1:small endian, the LSB is received first. 0:big endian, the MSB is received first.
pub type RX_BIT_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_TDM_EN` reader - 1: Enable I2S TDM Rx mode . 0: Disable.
pub type RX_TDM_EN_R = crate::BitReader;
///Field `RX_TDM_EN` writer - 1: Enable I2S TDM Rx mode . 0: Disable.
pub type RX_TDM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_PDM_EN` reader - 1: Enable I2S PDM Rx mode . 0: Disable.
pub type RX_PDM_EN_R = crate::BitReader;
///Field `RX_PDM_EN` writer - 1: Enable I2S PDM Rx mode . 0: Disable.
pub type RX_PDM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_PDM2PCM_EN` reader - 1: Enable PDM2PCM RX mode. 0: DIsable.
pub type RX_PDM2PCM_EN_R = crate::BitReader;
///Field `RX_PDM2PCM_EN` writer - 1: Enable PDM2PCM RX mode. 0: DIsable.
pub type RX_PDM2PCM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_PDM_SINC_DSR_16_EN` reader - Configure the down sampling rate of PDM RX filter group1 module. 1: The down sampling rate is 128. 0: down sampling rate is 64.
pub type RX_PDM_SINC_DSR_16_EN_R = crate::BitReader;
///Field `RX_PDM_SINC_DSR_16_EN` writer - Configure the down sampling rate of PDM RX filter group1 module. 1: The down sampling rate is 128. 0: down sampling rate is 64.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_CONF")
            ...
            .field("rx_big_endian", &self.rx_big_endian())
            .field("rx_update", &self.rx_update())
            .field("rx_mono_fst_vld", &self.rx_mono_fst_vld())
            .field("rx_pcm_conf", &self.rx_pcm_conf())
            .field("rx_pcm_bypass", &self.rx_pcm_bypass())
            .field("rx_stop_mode", &self.rx_stop_mode())
            .field("rx_left_align", &self.rx_left_align())
            .field("rx_24_fill_en", &self.rx_24_fill_en())
            .field("rx_ws_idle_pol", &self.rx_ws_idle_pol())
            .field("rx_bit_order", &self.rx_bit_order())
            .field("rx_tdm_en", &self.rx_tdm_en())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_pdm2pcm_en(&mut self) -> RX_PDM2PCM_EN_W<RX_CONF_SPEC> {
        RX_PDM2PCM_EN_W::new(self, 21)
    }
    ///Bit 22 - Configure the down sampling rate of PDM RX filter group1 module. 1: The down sampling rate is 128. 0: down sampling rate is 64.
    #[inline(always)]
    #[must_use]
    pub fn rx_pdm_sinc_dsr_16_en(&mut self) -> RX_PDM_SINC_DSR_16_EN_W<RX_CONF_SPEC> {
        RX_PDM_SINC_DSR_16_EN_W::new(self, 22)
    }
}
...
///`read()` method returns [`rx_conf::R`](R) reader structure
impl crate::Readable for RX_CONF_SPEC {}
///`write(|w| ..)` method takes [`rx_conf::W`](W) writer structure
