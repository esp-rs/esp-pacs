...
pub type RX_SD1_IN_DM_W<'a, const O: u8> = crate::FieldWriter<'a, RX_TIMING_SPEC, 2, O>;
...
pub type RX_SD2_IN_DM_W<'a, const O: u8> = crate::FieldWriter<'a, RX_TIMING_SPEC, 2, O>;
...
pub type RX_SD3_IN_DM_W<'a, const O: u8> = crate::FieldWriter<'a, RX_TIMING_SPEC, 2, O>;
