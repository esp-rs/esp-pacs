...
///Field `DATE` reader - systimer register version
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - systimer register version
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - systimer register version
    #[inline(always)]
...
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0201_2251;
}
