...
pub type EFUSE_CLK_FORCE_GATING_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EFUSE_CLK_FORCE_NOGATING_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type XTAL_GLOBAL_FORCE_GATING_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type XTAL_GLOBAL_FORCE_NOGATING_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn efuse_clk_force_gating(&mut self) -> EFUSE_CLK_FORCE_GATING_W<CLK_CONF_SPEC, 1> {
        EFUSE_CLK_FORCE_GATING_W::new(self)
    }
    #[doc = "Bit 2 - force efuse clk nogating"]
    #[inline(always)]
    #[must_use]
    pub fn efuse_clk_force_nogating(&mut self) -> EFUSE_CLK_FORCE_NOGATING_W<CLK_CONF_SPEC, 2> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xtal_global_force_gating(&mut self) -> XTAL_GLOBAL_FORCE_GATING_W<CLK_CONF_SPEC, 27> {
    ...
    pub fn xtal_global_force_nogating(
        &mut self,
    ) -> XTAL_GLOBAL_FORCE_NOGATING_W<CLK_CONF_SPEC, 28> {
...
impl crate::Resettable for CLK_CONF_SPEC {
    const RESET_VALUE: Self::Ux = 0x1158_321c;
}
