...
///Field `SLP_WAKEUP` reader - sleep wakeup interrupt raw
pub type SLP_WAKEUP_R = crate::BitReader;
///Field `SLP_REJECT` reader - sleep reject interrupt raw
pub type SLP_REJECT_R = crate::BitReader;
///Field `SDIO_IDLE` reader - SDIO idle interrupt raw
pub type SDIO_IDLE_R = crate::BitReader;
///Field `WDT` reader - RTC WDT interrupt raw
pub type WDT_R = crate::BitReader;
///Field `TOUCH_SCAN_DONE` reader - enable touch scan done interrupt raw
pub type TOUCH_SCAN_DONE_R = crate::BitReader;
///Field `ULP_CP` reader - ULP-coprocessor interrupt raw
pub type ULP_CP_R = crate::BitReader;
///Field `TOUCH_DONE` reader - touch interrupt raw
pub type TOUCH_DONE_R = crate::BitReader;
///Field `TOUCH_ACTIVE` reader - touch active interrupt raw
pub type TOUCH_ACTIVE_R = crate::BitReader;
///Field `TOUCH_INACTIVE` reader - touch inactive interrupt raw
pub type TOUCH_INACTIVE_R = crate::BitReader;
///Field `BROWN_OUT` reader - brown out interrupt raw
pub type BROWN_OUT_R = crate::BitReader;
///Field `MAIN_TIMER` reader - RTC main timer interrupt raw
pub type MAIN_TIMER_R = crate::BitReader;
///Field `SARADC1` reader - saradc1 interrupt raw
pub type SARADC1_R = crate::BitReader;
///Field `TSENS` reader - tsens interrupt raw
pub type TSENS_R = crate::BitReader;
///Field `COCPU` reader - riscV cocpu interrupt raw
pub type COCPU_R = crate::BitReader;
///Field `SARADC2` reader - saradc2 interrupt raw
pub type SARADC2_R = crate::BitReader;
///Field `SWD` reader - super watch dog interrupt raw
pub type SWD_R = crate::BitReader;
///Field `XTAL32K_DEAD` reader - xtal32k dead detection interrupt raw
pub type XTAL32K_DEAD_R = crate::BitReader;
///Field `COCPU_TRAP` reader - cocpu trap interrupt raw
pub type COCPU_TRAP_R = crate::BitReader;
///Field `TOUCH_TIMEOUT` reader - touch timeout interrupt raw
pub type TOUCH_TIMEOUT_R = crate::BitReader;
///Field `GLITCH_DET` reader - glitch_det_interrupt_raw
pub type GLITCH_DET_R = crate::BitReader;
///Field `TOUCH_APPROACH_LOOP_DONE` reader - touch approach mode loop interrupt raw
pub type TOUCH_APPROACH_LOOP_DONE_R = crate::BitReader;
///Field `TOUCH_APPROACH_LOOP_DONE` writer - touch approach mode loop interrupt raw
