...
impl W {
    ...
    #[inline(always)]
    pub fn sdio_idle(&mut self) -> SDIO_IDLE_W<'_, INT_ENA_RTC_W1TC_SPEC> {
    ...
    #[inline(always)]
    pub fn touch_scan_done(&mut self) -> TOUCH_SCAN_DONE_W<'_, INT_ENA_RTC_W1TC_SPEC> {
        TOUCH_SCAN_DONE_W::new(self, 4)
    }
    #[doc = "Bit 5 - enable ULP-coprocessor interrupt"]
    #[inline(always)]
    pub fn ulp_cp(&mut self) -> ULP_CP_W<'_, INT_ENA_RTC_W1TC_SPEC> {
        ULP_CP_W::new(self, 5)
    }
    #[doc = "Bit 6 - enable touch done interrupt"]
    #[inline(always)]
    pub fn touch_done(&mut self) -> TOUCH_DONE_W<'_, INT_ENA_RTC_W1TC_SPEC> {
        TOUCH_DONE_W::new(self, 6)
    }
    #[doc = "Bit 7 - enable touch active interrupt"]
    #[inline(always)]
    pub fn touch_active(&mut self) -> TOUCH_ACTIVE_W<'_, INT_ENA_RTC_W1TC_SPEC> {
        TOUCH_ACTIVE_W::new(self, 7)
    }
    #[doc = "Bit 8 - enable touch inactive interrupt"]
    #[inline(always)]
    pub fn touch_inactive(&mut self) -> TOUCH_INACTIVE_W<'_, INT_ENA_RTC_W1TC_SPEC> {
    ...
    #[inline(always)]
    pub fn saradc1(&mut self) -> SARADC1_W<'_, INT_ENA_RTC_W1TC_SPEC> {
        SARADC1_W::new(self, 11)
    }
    #[doc = "Bit 12 - enable tsens interrupt"]
    #[inline(always)]
    pub fn tsens(&mut self) -> TSENS_W<'_, INT_ENA_RTC_W1TC_SPEC> {
        TSENS_W::new(self, 12)
    }
    #[doc = "Bit 13 - enable riscV cocpu interrupt"]
    #[inline(always)]
    pub fn cocpu(&mut self) -> COCPU_W<'_, INT_ENA_RTC_W1TC_SPEC> {
        COCPU_W::new(self, 13)
    }
    #[doc = "Bit 14 - enable saradc2 interrupt"]
    #[inline(always)]
    pub fn saradc2(&mut self) -> SARADC2_W<'_, INT_ENA_RTC_W1TC_SPEC> {
    ...
    #[inline(always)]
    pub fn cocpu_trap(&mut self) -> COCPU_TRAP_W<'_, INT_ENA_RTC_W1TC_SPEC> {
        COCPU_TRAP_W::new(self, 17)
    }
    #[doc = "Bit 18 - enable touch timeout interrupt"]
    #[inline(always)]
    pub fn touch_timeout(&mut self) -> TOUCH_TIMEOUT_W<'_, INT_ENA_RTC_W1TC_SPEC> {
    ...
    pub fn touch_approach_loop_done(
        &mut self,
    ) -> TOUCH_APPROACH_LOOP_DONE_W<'_, INT_ENA_RTC_W1TC_SPEC> {
