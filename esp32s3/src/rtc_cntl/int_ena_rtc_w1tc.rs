...
pub type SDIO_IDLE_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TOUCH_SCAN_DONE_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ULP_CP_INT_ENA_W1TC` writer - enable ULP-coprocessor interrupt"]
pub type ULP_CP_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `TOUCH_DONE_INT_ENA_W1TC` writer - enable touch done interrupt"]
pub type TOUCH_DONE_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `TOUCH_ACTIVE_INT_ENA_W1TC` writer - enable touch active interrupt"]
pub type TOUCH_ACTIVE_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `TOUCH_INACTIVE_INT_ENA_W1TC` writer - enable touch inactive interrupt"]
pub type TOUCH_INACTIVE_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SARADC1_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `TSENS_INT_ENA_W1TC` writer - enable tsens interrupt"]
pub type TSENS_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `COCPU_INT_ENA_W1TC` writer - enable riscV cocpu interrupt"]
pub type COCPU_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SARADC2_INT_ENA_W1TC` writer - enable saradc2 interrupt"]
pub type SARADC2_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type COCPU_TRAP_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `TOUCH_TIMEOUT_INT_ENA_W1TC` writer - enable touch timeout interrupt"]
pub type TOUCH_TIMEOUT_INT_ENA_W1TC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TC_W<'a, REG, const O: u8> =
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdio_idle_int_ena_w1tc(&mut self) -> SDIO_IDLE_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 2> {
    ...
    pub fn touch_scan_done_int_ena_w1tc(
        &mut self,
    ) -> TOUCH_SCAN_DONE_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 4> {
        TOUCH_SCAN_DONE_INT_ENA_W1TC_W::new(self)
    }
    #[doc = "Bit 5 - enable ULP-coprocessor interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ulp_cp_int_ena_w1tc(&mut self) -> ULP_CP_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 5> {
        ULP_CP_INT_ENA_W1TC_W::new(self)
    }
    #[doc = "Bit 6 - enable touch done interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn touch_done_int_ena_w1tc(
        &mut self,
    ) -> TOUCH_DONE_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 6> {
    ...
    pub fn touch_active_int_ena_w1tc(
        &mut self,
    ) -> TOUCH_ACTIVE_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 7> {
    ...
    pub fn touch_inactive_int_ena_w1tc(
        &mut self,
    ) -> TOUCH_INACTIVE_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 8> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc1_int_ena_w1tc(&mut self) -> SARADC1_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 11> {
        SARADC1_INT_ENA_W1TC_W::new(self)
    }
    #[doc = "Bit 12 - enable tsens interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn tsens_int_ena_w1tc(&mut self) -> TSENS_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 12> {
        TSENS_INT_ENA_W1TC_W::new(self)
    }
    #[doc = "Bit 13 - enable riscV cocpu interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn cocpu_int_ena_w1tc(&mut self) -> COCPU_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 13> {
        COCPU_INT_ENA_W1TC_W::new(self)
    }
    #[doc = "Bit 14 - enable saradc2 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn saradc2_int_ena_w1tc(&mut self) -> SARADC2_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 14> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cocpu_trap_int_ena_w1tc(
        &mut self,
    ) -> COCPU_TRAP_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 17> {
    ...
    pub fn touch_timeout_int_ena_w1tc(
        &mut self,
    ) -> TOUCH_TIMEOUT_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 18> {
    ...
    pub fn touch_approach_loop_done_int_ena_w1tc(
        &mut self,
    ) -> TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TC_W<INT_ENA_RTC_W1TC_SPEC, 20> {
