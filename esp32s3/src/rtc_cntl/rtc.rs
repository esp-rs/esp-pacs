...
pub type DIG_REG_CAL_EN_W<'a, const O: u8> = crate::BitWriter<'a, RTC_SPEC, O>;
#[doc = "Field `SCK_DCAP` reader - SCK_DCAP"]
pub type SCK_DCAP_R = crate::FieldReader;
#[doc = "Field `SCK_DCAP` writer - SCK_DCAP"]
pub type SCK_DCAP_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_SPEC, 8, O>;
...
pub type DBOOST_FORCE_PD_W<'a, const O: u8> = crate::BitWriter<'a, RTC_SPEC, O>;
...
pub type DBOOST_FORCE_PU_W<'a, const O: u8> = crate::BitWriter<'a, RTC_SPEC, O>;
...
pub type REGULATOR_FORCE_PD_W<'a, const O: u8> = crate::BitWriter<'a, RTC_SPEC, O>;
...
pub type REGULATOR_FORCE_PU_W<'a, const O: u8> = crate::BitWriter<'a, RTC_SPEC, O>;
impl R {
