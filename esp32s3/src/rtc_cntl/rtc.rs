...
pub type DIG_REG_CAL_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RTC_SPEC, bool, O>;
#[doc = "Field `SCK_DCAP` reader - SCK_DCAP"]
pub type SCK_DCAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SCK_DCAP` writer - SCK_DCAP"]
pub type SCK_DCAP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RTC_SPEC, u8, u8, 8, O>;
...
pub type DBOOST_FORCE_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, RTC_SPEC, bool, O>;
...
pub type DBOOST_FORCE_PU_W<'a, const O: u8> = crate::BitWriter<'a, u32, RTC_SPEC, bool, O>;
...
pub type REGULATOR_FORCE_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, RTC_SPEC, bool, O>;
...
pub type REGULATOR_FORCE_PU_W<'a, const O: u8> = crate::BitWriter<'a, u32, RTC_SPEC, bool, O>;
impl R {
