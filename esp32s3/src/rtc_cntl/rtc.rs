...
///Field `DIG_REG_CAL_EN` reader - enable dig regulator cali
pub type DIG_REG_CAL_EN_R = crate::BitReader;
///Field `DIG_REG_CAL_EN` writer - enable dig regulator cali
...
///Field `REGULATOR_FORCE_PD` reader - RTC_REG force power down (for RTC_REG power down means decrease the voltage to 0.8v or lower )
pub type REGULATOR_FORCE_PD_R = crate::BitReader;
///Field `REGULATOR_FORCE_PD` writer - RTC_REG force power down (for RTC_REG power down means decrease the voltage to 0.8v or lower )
pub type REGULATOR_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `REGULATOR_FORCE_PU` reader - RTC_REG force power on (for RTC_REG power down means decrease the voltage to 0.8v or lower )
pub type REGULATOR_FORCE_PU_R = crate::BitReader;
///Field `REGULATOR_FORCE_PU` writer - RTC_REG force power on (for RTC_REG power down means decrease the voltage to 0.8v or lower )
...
///`read()` method returns [`rtc::R`](R) reader structure
impl crate::Readable for RTC_SPEC {}
///`write(|w| ..)` method takes [`rtc::W`](W) writer structure
