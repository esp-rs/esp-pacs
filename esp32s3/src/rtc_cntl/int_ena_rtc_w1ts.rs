...
pub type SDIO_IDLE_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TOUCH_SCAN_DONE_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ULP_CP_INT_ENA_W1TS` writer - enable ULP-coprocessor interrupt"]
pub type ULP_CP_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TOUCH_DONE_INT_ENA_W1TS` writer - enable touch done interrupt"]
pub type TOUCH_DONE_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TOUCH_ACTIVE_INT_ENA_W1TS` writer - enable touch active interrupt"]
pub type TOUCH_ACTIVE_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TOUCH_INACTIVE_INT_ENA_W1TS` writer - enable touch inactive interrupt"]
pub type TOUCH_INACTIVE_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SARADC1_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TSENS_INT_ENA_W1TS` writer - enable tsens interrupt"]
pub type TSENS_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `COCPU_INT_ENA_W1TS` writer - enable riscV cocpu interrupt"]
pub type COCPU_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SARADC2_INT_ENA_W1TS` writer - enable saradc2 interrupt"]
pub type SARADC2_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type COCPU_TRAP_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TOUCH_TIMEOUT_INT_ENA_W1TS` writer - enable touch timeout interrupt"]
pub type TOUCH_TIMEOUT_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdio_idle_int_ena_w1ts(&mut self) -> SDIO_IDLE_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        SDIO_IDLE_INT_ENA_W1TS_W::new(self, 2)
    }
    ...
    pub fn touch_scan_done_int_ena_w1ts(
        &mut self,
    ) -> TOUCH_SCAN_DONE_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        TOUCH_SCAN_DONE_INT_ENA_W1TS_W::new(self, 4)
    }
    #[doc = "Bit 5 - enable ULP-coprocessor interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ulp_cp_int_ena_w1ts(&mut self) -> ULP_CP_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        ULP_CP_INT_ENA_W1TS_W::new(self, 5)
    }
    #[doc = "Bit 6 - enable touch done interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn touch_done_int_ena_w1ts(&mut self) -> TOUCH_DONE_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        TOUCH_DONE_INT_ENA_W1TS_W::new(self, 6)
    }
    ...
    pub fn touch_active_int_ena_w1ts(
        &mut self,
    ) -> TOUCH_ACTIVE_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        TOUCH_ACTIVE_INT_ENA_W1TS_W::new(self, 7)
    }
    ...
    pub fn touch_inactive_int_ena_w1ts(
        &mut self,
    ) -> TOUCH_INACTIVE_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        TOUCH_INACTIVE_INT_ENA_W1TS_W::new(self, 8)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc1_int_ena_w1ts(&mut self) -> SARADC1_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        SARADC1_INT_ENA_W1TS_W::new(self, 11)
    }
    #[doc = "Bit 12 - enable tsens interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn tsens_int_ena_w1ts(&mut self) -> TSENS_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        TSENS_INT_ENA_W1TS_W::new(self, 12)
    }
    #[doc = "Bit 13 - enable riscV cocpu interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn cocpu_int_ena_w1ts(&mut self) -> COCPU_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        COCPU_INT_ENA_W1TS_W::new(self, 13)
    }
    #[doc = "Bit 14 - enable saradc2 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn saradc2_int_ena_w1ts(&mut self) -> SARADC2_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        SARADC2_INT_ENA_W1TS_W::new(self, 14)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cocpu_trap_int_ena_w1ts(&mut self) -> COCPU_TRAP_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        COCPU_TRAP_INT_ENA_W1TS_W::new(self, 17)
    }
    ...
    pub fn touch_timeout_int_ena_w1ts(
        &mut self,
    ) -> TOUCH_TIMEOUT_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        TOUCH_TIMEOUT_INT_ENA_W1TS_W::new(self, 18)
    }
    ...
    pub fn touch_approach_loop_done_int_ena_w1ts(
        &mut self,
    ) -> TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TS_W<INT_ENA_RTC_W1TS_SPEC> {
        TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TS_W::new(self, 20)
    }
