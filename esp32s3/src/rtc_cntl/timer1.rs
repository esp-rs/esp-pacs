...
///Field `CPU_STALL_EN` reader - CPU stall enable bit
pub type CPU_STALL_EN_R = crate::BitReader;
///Field `CPU_STALL_EN` writer - CPU stall enable bit
pub type CPU_STALL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CPU_STALL_WAIT` reader - CPU stall wait cycles in fast_clk_rtc
pub type CPU_STALL_WAIT_R = crate::FieldReader;
///Field `CPU_STALL_WAIT` writer - CPU stall wait cycles in fast_clk_rtc
pub type CPU_STALL_WAIT_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `CK8M_WAIT` reader - CK8M wait cycles in slow_clk_rtc
...
///Field `XTL_BUF_WAIT` reader - XTAL wait cycles in slow_clk_rtc
pub type XTL_BUF_WAIT_R = crate::FieldReader<u16>;
///Field `XTL_BUF_WAIT` writer - XTAL wait cycles in slow_clk_rtc
pub type XTL_BUF_WAIT_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `PLL_BUF_WAIT` reader - PLL wait cycles in slow_clk_rtc
