...
pub type RTC_FASTMEM_FORCE_NOISO_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_FASTMEM_FORCE_ISO_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_SLOWMEM_FORCE_NOISO_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_SLOWMEM_FORCE_ISO_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_FORCE_ISO_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_FORCE_NOISO_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_FASTMEM_FOLW_CPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_FASTMEM_FORCE_LPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_FASTMEM_FORCE_LPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_SLOWMEM_FOLW_CPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_SLOWMEM_FORCE_LPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_SLOWMEM_FORCE_LPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_FORCE_PD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_FORCE_PU_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
pub type RTC_PD_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWC_SPEC, bool, O>;
...
impl W {
    #[doc = "Bit 0 - Fast RTC memory force no ISO"]
    #[inline(always)]
    pub fn rtc_fastmem_force_noiso(&mut self) -> RTC_FASTMEM_FORCE_NOISO_W<0> {
        RTC_FASTMEM_FORCE_NOISO_W::new(self)
    }
    #[doc = "Bit 1 - Fast RTC memory force ISO"]
    #[inline(always)]
    pub fn rtc_fastmem_force_iso(&mut self) -> RTC_FASTMEM_FORCE_ISO_W<1> {
        RTC_FASTMEM_FORCE_ISO_W::new(self)
    }
    #[doc = "Bit 2 - RTC memory force no ISO"]
    #[inline(always)]
    pub fn rtc_slowmem_force_noiso(&mut self) -> RTC_SLOWMEM_FORCE_NOISO_W<2> {
        RTC_SLOWMEM_FORCE_NOISO_W::new(self)
    }
    #[doc = "Bit 3 - RTC memory force ISO"]
    #[inline(always)]
    pub fn rtc_slowmem_force_iso(&mut self) -> RTC_SLOWMEM_FORCE_ISO_W<3> {
        RTC_SLOWMEM_FORCE_ISO_W::new(self)
    }
    #[doc = "Bit 4 - rtc_peri force ISO"]
    #[inline(always)]
    pub fn rtc_force_iso(&mut self) -> RTC_FORCE_ISO_W<4> {
        RTC_FORCE_ISO_W::new(self)
    }
    #[doc = "Bit 5 - rtc_peri force no ISO"]
    #[inline(always)]
    pub fn rtc_force_noiso(&mut self) -> RTC_FORCE_NOISO_W<5> {
        RTC_FORCE_NOISO_W::new(self)
    }
    #[doc = "Bit 6 - 1: Fast RTC memory PD following CPU, 0: fast RTC memory PD following RTC state machine"]
    #[inline(always)]
    pub fn rtc_fastmem_folw_cpu(&mut self) -> RTC_FASTMEM_FOLW_CPU_W<6> {
        RTC_FASTMEM_FOLW_CPU_W::new(self)
    }
    #[doc = "Bit 7 - Fast RTC memory force PD"]
    #[inline(always)]
    pub fn rtc_fastmem_force_lpd(&mut self) -> RTC_FASTMEM_FORCE_LPD_W<7> {
        RTC_FASTMEM_FORCE_LPD_W::new(self)
    }
    #[doc = "Bit 8 - Fast RTC memory force no PD"]
    #[inline(always)]
    pub fn rtc_fastmem_force_lpu(&mut self) -> RTC_FASTMEM_FORCE_LPU_W<8> {
        RTC_FASTMEM_FORCE_LPU_W::new(self)
    }
    #[doc = "Bit 9 - 1: RTC memory PD following CPU, 0: RTC memory PD following RTC state machine"]
    #[inline(always)]
    pub fn rtc_slowmem_folw_cpu(&mut self) -> RTC_SLOWMEM_FOLW_CPU_W<9> {
        RTC_SLOWMEM_FOLW_CPU_W::new(self)
    }
    #[doc = "Bit 10 - RTC memory force PD"]
    #[inline(always)]
    pub fn rtc_slowmem_force_lpd(&mut self) -> RTC_SLOWMEM_FORCE_LPD_W<10> {
        RTC_SLOWMEM_FORCE_LPD_W::new(self)
    }
    #[doc = "Bit 11 - RTC memory force no PD"]
    #[inline(always)]
    pub fn rtc_slowmem_force_lpu(&mut self) -> RTC_SLOWMEM_FORCE_LPU_W<11> {
        RTC_SLOWMEM_FORCE_LPU_W::new(self)
    }
    #[doc = "Bit 18 - rtc_peri force power down"]
    #[inline(always)]
    pub fn rtc_force_pd(&mut self) -> RTC_FORCE_PD_W<18> {
        RTC_FORCE_PD_W::new(self)
    }
    #[doc = "Bit 19 - rtc_peri force power up"]
    #[inline(always)]
    pub fn rtc_force_pu(&mut self) -> RTC_FORCE_PU_W<19> {
        RTC_FORCE_PU_W::new(self)
    }
    #[doc = "Bit 20 - enable power down rtc_peri in sleep"]
    #[inline(always)]
    pub fn rtc_pd_en(&mut self) -> RTC_PD_EN_W<20> {
