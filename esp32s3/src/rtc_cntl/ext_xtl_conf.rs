...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EXT_XTL_CONF")
            .field("xtal32k_wdt_en", &self.xtal32k_wdt_en().bit())
            .field("xtal32k_wdt_clk_fo", &self.xtal32k_wdt_clk_fo().bit())
            .field("xtal32k_wdt_reset", &self.xtal32k_wdt_reset().bit())
            .field("xtal32k_ext_clk_fo", &self.xtal32k_ext_clk_fo().bit())
            .field("xtal32k_auto_backup", &self.xtal32k_auto_backup().bit())
            .field("xtal32k_auto_restart", &self.xtal32k_auto_restart().bit())
            .field("xtal32k_auto_return", &self.xtal32k_auto_return().bit())
            .field("xtal32k_xpd_force", &self.xtal32k_xpd_force().bit())
            .field("enckinit_xtal_32k", &self.enckinit_xtal_32k().bit())
            .field("dbuf_xtal_32k", &self.dbuf_xtal_32k().bit())
            .field("dgm_xtal_32k", &self.dgm_xtal_32k().bits())
            .field("dres_xtal_32k", &self.dres_xtal_32k().bits())
            .field("xpd_xtal_32k", &self.xpd_xtal_32k().bit())
            .field("dac_xtal_32k", &self.dac_xtal_32k().bits())
            .field("wdt_state", &self.wdt_state().bits())
            .field("xtal32k_gpio_sel", &self.xtal32k_gpio_sel().bit())
