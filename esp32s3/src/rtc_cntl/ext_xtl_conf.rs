...
///Field `XTAL32K_WDT_EN` reader - xtal 32k watch dog enable
pub type XTAL32K_WDT_EN_R = crate::BitReader;
///Field `XTAL32K_WDT_EN` writer - xtal 32k watch dog enable
pub type XTAL32K_WDT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTAL32K_WDT_CLK_FO` reader - xtal 32k watch dog clock force on
pub type XTAL32K_WDT_CLK_FO_R = crate::BitReader;
///Field `XTAL32K_WDT_CLK_FO` writer - xtal 32k watch dog clock force on
pub type XTAL32K_WDT_CLK_FO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTAL32K_WDT_RESET` reader - xtal 32k watch dog sw reset
pub type XTAL32K_WDT_RESET_R = crate::BitReader;
///Field `XTAL32K_WDT_RESET` writer - xtal 32k watch dog sw reset
pub type XTAL32K_WDT_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTAL32K_EXT_CLK_FO` reader - xtal 32k external xtal clock force on
pub type XTAL32K_EXT_CLK_FO_R = crate::BitReader;
///Field `XTAL32K_EXT_CLK_FO` writer - xtal 32k external xtal clock force on
pub type XTAL32K_EXT_CLK_FO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTAL32K_AUTO_BACKUP` reader - xtal 32k switch to back up clock when xtal is dead
pub type XTAL32K_AUTO_BACKUP_R = crate::BitReader;
///Field `XTAL32K_AUTO_BACKUP` writer - xtal 32k switch to back up clock when xtal is dead
pub type XTAL32K_AUTO_BACKUP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTAL32K_AUTO_RESTART` reader - xtal 32k restart xtal when xtal is dead
pub type XTAL32K_AUTO_RESTART_R = crate::BitReader;
///Field `XTAL32K_AUTO_RESTART` writer - xtal 32k restart xtal when xtal is dead
pub type XTAL32K_AUTO_RESTART_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTAL32K_AUTO_RETURN` reader - xtal 32k switch back xtal when xtal is restarted
pub type XTAL32K_AUTO_RETURN_R = crate::BitReader;
///Field `XTAL32K_AUTO_RETURN` writer - xtal 32k switch back xtal when xtal is restarted
pub type XTAL32K_AUTO_RETURN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTAL32K_XPD_FORCE` reader - Xtal 32k xpd control by sw or fsm
pub type XTAL32K_XPD_FORCE_R = crate::BitReader;
///Field `XTAL32K_XPD_FORCE` writer - Xtal 32k xpd control by sw or fsm
pub type XTAL32K_XPD_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENCKINIT_XTAL_32K` reader - apply an internal clock to help xtal 32k to start
pub type ENCKINIT_XTAL_32K_R = crate::BitReader;
///Field `ENCKINIT_XTAL_32K` writer - apply an internal clock to help xtal 32k to start
...
///Field `WDT_STATE` reader - state of 32k_wdt
pub type WDT_STATE_R = crate::FieldReader;
///Field `XTAL32K_GPIO_SEL` reader - XTAL_32K sel. 0: external XTAL_32K, 1: CLK from RTC pad X32P_C
pub type XTAL32K_GPIO_SEL_R = crate::BitReader;
///Field `XTAL32K_GPIO_SEL` writer - XTAL_32K sel. 0: external XTAL_32K, 1: CLK from RTC pad X32P_C
pub type XTAL32K_GPIO_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTL_EXT_CTR_LV` reader - 0: power down XTAL at high level, 1: power down XTAL at low level
pub type XTL_EXT_CTR_LV_R = crate::BitReader;
///Field `XTL_EXT_CTR_LV` writer - 0: power down XTAL at high level, 1: power down XTAL at low level
pub type XTL_EXT_CTR_LV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XTL_EXT_CTR_EN` reader - Reserved register
pub type XTL_EXT_CTR_EN_R = crate::BitReader;
///Field `XTL_EXT_CTR_EN` writer - Reserved register
