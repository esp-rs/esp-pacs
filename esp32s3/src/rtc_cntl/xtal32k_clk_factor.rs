...
///Field `XTAL32K_CLK_FACTOR` reader - xtal 32k watch dog backup clock factor
pub type XTAL32K_CLK_FACTOR_R = crate::FieldReader<u32>;
///Field `XTAL32K_CLK_FACTOR` writer - xtal 32k watch dog backup clock factor
pub type XTAL32K_CLK_FACTOR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - xtal 32k watch dog backup clock factor
    #[inline(always)]
