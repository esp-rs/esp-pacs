...
///Field `COCPU_CLK_FO` reader - cocpu clk force on
pub type COCPU_CLK_FO_R = crate::BitReader;
///Field `COCPU_CLK_FO` writer - cocpu clk force on
pub type COCPU_CLK_FO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_START_2_RESET_DIS` reader - time from start cocpu to pull down reset
pub type COCPU_START_2_RESET_DIS_R = crate::FieldReader;
///Field `COCPU_START_2_RESET_DIS` writer - time from start cocpu to pull down reset
pub type COCPU_START_2_RESET_DIS_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `COCPU_START_2_INTR_EN` reader - time from start cocpu to give start interrupt
pub type COCPU_START_2_INTR_EN_R = crate::FieldReader;
///Field `COCPU_START_2_INTR_EN` writer - time from start cocpu to give start interrupt
pub type COCPU_START_2_INTR_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `COCPU_SHUT` reader - to shut cocpu
pub type COCPU_SHUT_R = crate::BitReader;
///Field `COCPU_SHUT` writer - to shut cocpu
pub type COCPU_SHUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SHUT_2_CLK_DIS` reader - time from shut cocpu to disable clk
pub type COCPU_SHUT_2_CLK_DIS_R = crate::FieldReader;
///Field `COCPU_SHUT_2_CLK_DIS` writer - time from shut cocpu to disable clk
pub type COCPU_SHUT_2_CLK_DIS_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `COCPU_SHUT_RESET_EN` reader - to reset cocpu
pub type COCPU_SHUT_RESET_EN_R = crate::BitReader;
///Field `COCPU_SHUT_RESET_EN` writer - to reset cocpu
pub type COCPU_SHUT_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SEL` reader - 1: old ULP 0: new riscV
pub type COCPU_SEL_R = crate::BitReader;
///Field `COCPU_SEL` writer - 1: old ULP 0: new riscV
pub type COCPU_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_DONE_FORCE` reader - 1: select riscv done 0: select ulp done
pub type COCPU_DONE_FORCE_R = crate::BitReader;
///Field `COCPU_DONE_FORCE` writer - 1: select riscv done 0: select ulp done
pub type COCPU_DONE_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_DONE` reader - done signal used by riscv to control timer.
pub type COCPU_DONE_R = crate::BitReader;
///Field `COCPU_DONE` writer - done signal used by riscv to control timer.
pub type COCPU_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_SW_INT_TRIGGER` writer - trigger cocpu register interrupt
pub type COCPU_SW_INT_TRIGGER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COCPU_CLKGATE_EN` reader - open ulp-riscv clk gate
pub type COCPU_CLKGATE_EN_R = crate::BitReader;
///Field `COCPU_CLKGATE_EN` writer - open ulp-riscv clk gate
