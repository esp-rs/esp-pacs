...
///Field `SLP_WAKEUP` reader - sleep wakeup interrupt state
pub type SLP_WAKEUP_R = crate::BitReader;
///Field `SLP_REJECT` reader - sleep reject interrupt state
pub type SLP_REJECT_R = crate::BitReader;
///Field `SDIO_IDLE` reader - SDIO idle interrupt state
pub type SDIO_IDLE_R = crate::BitReader;
///Field `WDT` reader - RTC WDT interrupt state
pub type WDT_R = crate::BitReader;
///Field `TOUCH_SCAN_DONE` reader - enable touch scan done interrupt raw
pub type TOUCH_SCAN_DONE_R = crate::BitReader;
///Field `ULP_CP` reader - ULP-coprocessor interrupt state
pub type ULP_CP_R = crate::BitReader;
///Field `TOUCH_DONE` reader - touch done interrupt state
pub type TOUCH_DONE_R = crate::BitReader;
///Field `TOUCH_ACTIVE` reader - touch active interrupt state
pub type TOUCH_ACTIVE_R = crate::BitReader;
///Field `TOUCH_INACTIVE` reader - touch inactive interrupt state
pub type TOUCH_INACTIVE_R = crate::BitReader;
///Field `BROWN_OUT` reader - brown out interrupt state
pub type BROWN_OUT_R = crate::BitReader;
///Field `MAIN_TIMER` reader - RTC main timer interrupt state
pub type MAIN_TIMER_R = crate::BitReader;
///Field `SARADC1` reader - saradc1 interrupt state
pub type SARADC1_R = crate::BitReader;
///Field `TSENS` reader - tsens interrupt state
pub type TSENS_R = crate::BitReader;
///Field `COCPU` reader - riscV cocpu interrupt state
pub type COCPU_R = crate::BitReader;
///Field `SARADC2` reader - saradc2 interrupt state
pub type SARADC2_R = crate::BitReader;
///Field `SWD` reader - super watch dog interrupt state
pub type SWD_R = crate::BitReader;
///Field `XTAL32K_DEAD` reader - xtal32k dead detection interrupt state
pub type XTAL32K_DEAD_R = crate::BitReader;
///Field `COCPU_TRAP` reader - cocpu trap interrupt state
pub type COCPU_TRAP_R = crate::BitReader;
///Field `TOUCH_TIMEOUT` reader - Touch timeout interrupt state
pub type TOUCH_TIMEOUT_R = crate::BitReader;
///Field `GLITCH_DET` reader - glitch_det_interrupt state
pub type GLITCH_DET_R = crate::BitReader;
///Field `TOUCH_APPROACH_LOOP_DONE` reader - touch approach mode loop interrupt state
