...
///Field `ANA_CLK_DIV_VLD` reader - used to sync div bus. clear vld before set reg_rtc_ana_clk_div, then set vld to actually switch the clk
pub type ANA_CLK_DIV_VLD_R = crate::BitReader;
///Field `ANA_CLK_DIV_VLD` writer - used to sync div bus. clear vld before set reg_rtc_ana_clk_div, then set vld to actually switch the clk
pub type ANA_CLK_DIV_VLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ANA_CLK_DIV` reader - rtc clk div
pub type ANA_CLK_DIV_R = crate::FieldReader;
///Field `ANA_CLK_DIV` writer - rtc clk div
pub type ANA_CLK_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SLOW_CLK_NEXT_EDGE` reader - No public
pub type SLOW_CLK_NEXT_EDGE_R = crate::BitReader;
///Field `SLOW_CLK_NEXT_EDGE` writer - No public
