...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TOUCH_CTRL2")
            ...
            .field("touch_refc", &self.touch_refc().bits())
            .field("touch_dbias", &self.touch_dbias().bit())
            ...
            .field("touch_slp_cyc_div", &self.touch_slp_cyc_div().bits())
            .field(
                "touch_timer_force_done",
                &self.touch_timer_force_done().bits(),
            )
            .field("touch_reset", &self.touch_reset().bit())
            .field("touch_clk_fo", &self.touch_clk_fo().bit())
            .field("touch_clkgate_en", &self.touch_clkgate_en().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
