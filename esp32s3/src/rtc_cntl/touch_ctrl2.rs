...
///Field `TOUCH_DRANGE` reader - TOUCH_DRANGE
pub type TOUCH_DRANGE_R = crate::FieldReader;
///Field `TOUCH_DRANGE` writer - TOUCH_DRANGE
pub type TOUCH_DRANGE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_DREFL` reader - TOUCH_DREFL
pub type TOUCH_DREFL_R = crate::FieldReader;
///Field `TOUCH_DREFL` writer - TOUCH_DREFL
pub type TOUCH_DREFL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_DREFH` reader - TOUCH_DREFH
pub type TOUCH_DREFH_R = crate::FieldReader;
///Field `TOUCH_DREFH` writer - TOUCH_DREFH
pub type TOUCH_DREFH_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_XPD_BIAS` reader - TOUCH_XPD_BIAS
pub type TOUCH_XPD_BIAS_R = crate::BitReader;
///Field `TOUCH_XPD_BIAS` writer - TOUCH_XPD_BIAS
pub type TOUCH_XPD_BIAS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_REFC` reader - TOUCH pad0 reference cap
pub type TOUCH_REFC_R = crate::FieldReader;
///Field `TOUCH_REFC` writer - TOUCH pad0 reference cap
pub type TOUCH_REFC_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `TOUCH_DBIAS` reader - 1:use self bias 0:use bandgap bias
pub type TOUCH_DBIAS_R = crate::BitReader;
///Field `TOUCH_DBIAS` writer - 1:use self bias 0:use bandgap bias
...
///Field `TOUCH_START_FSM_EN` reader - 1: TOUCH_START &amp; TOUCH_XPD is controlled by touch fsm
pub type TOUCH_START_FSM_EN_R = crate::BitReader;
///Field `TOUCH_START_FSM_EN` writer - 1: TOUCH_START &amp; TOUCH_XPD is controlled by touch fsm
pub type TOUCH_START_FSM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_START_EN` reader - 1: start touch fsm
pub type TOUCH_START_EN_R = crate::BitReader;
///Field `TOUCH_START_EN` writer - 1: start touch fsm
pub type TOUCH_START_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_START_FORCE` reader - 1: to start touch fsm by SW
pub type TOUCH_START_FORCE_R = crate::BitReader;
///Field `TOUCH_START_FORCE` writer - 1: to start touch fsm by SW
...
///Field `TOUCH_RESET` reader - reset upgrade touch
pub type TOUCH_RESET_R = crate::BitReader;
///Field `TOUCH_RESET` writer - reset upgrade touch
...
///Field `TOUCH_CLKGATE_EN` reader - touch clock enable
pub type TOUCH_CLKGATE_EN_R = crate::BitReader;
///Field `TOUCH_CLKGATE_EN` writer - touch clock enable
