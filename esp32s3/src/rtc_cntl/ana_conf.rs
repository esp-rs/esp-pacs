...
///Field `I2C_RESET_POR_FORCE_PD` reader - force down I2C_RESET_POR
pub type I2C_RESET_POR_FORCE_PD_R = crate::BitReader;
///Field `I2C_RESET_POR_FORCE_PD` writer - force down I2C_RESET_POR
pub type I2C_RESET_POR_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C_RESET_POR_FORCE_PU` reader - force on I2C_RESET_POR
pub type I2C_RESET_POR_FORCE_PU_R = crate::BitReader;
///Field `I2C_RESET_POR_FORCE_PU` writer - force on I2C_RESET_POR
pub type I2C_RESET_POR_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GLITCH_RST_EN` reader - enable clk glitch
pub type GLITCH_RST_EN_R = crate::BitReader;
///Field `GLITCH_RST_EN` writer - enable clk glitch
...
///Field `ANALOG_TOP_ISO_SLEEP` reader - PLLA force power down
pub type ANALOG_TOP_ISO_SLEEP_R = crate::BitReader;
///Field `ANALOG_TOP_ISO_SLEEP` writer - PLLA force power down
pub type ANALOG_TOP_ISO_SLEEP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ANALOG_TOP_ISO_MONITOR` reader - PLLA force power up
pub type ANALOG_TOP_ISO_MONITOR_R = crate::BitReader;
///Field `ANALOG_TOP_ISO_MONITOR` writer - PLLA force power up
...
///Field `PLL_I2C_PU` reader - power on pll i2c
pub type PLL_I2C_PU_R = crate::BitReader;
///Field `PLL_I2C_PU` writer - power on pll i2c
