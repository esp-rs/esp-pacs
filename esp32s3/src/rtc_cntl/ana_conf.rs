...
pub type SAR_I2C_PU_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ANALOG_TOP_ISO_SLEEP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ANALOG_TOP_ISO_MONITOR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar_i2c_pu(&mut self) -> SAR_I2C_PU_W<ANA_CONF_SPEC, 22> {
        SAR_I2C_PU_W::new(self)
    }
    #[doc = "Bit 23 - PLLA force power down"]
    #[inline(always)]
    #[must_use]
    pub fn analog_top_iso_sleep(&mut self) -> ANALOG_TOP_ISO_SLEEP_W<ANA_CONF_SPEC, 23> {
        ANALOG_TOP_ISO_SLEEP_W::new(self)
    }
    #[doc = "Bit 24 - PLLA force power up"]
    #[inline(always)]
    #[must_use]
    pub fn analog_top_iso_monitor(&mut self) -> ANALOG_TOP_ISO_MONITOR_W<ANA_CONF_SPEC, 24> {
