...
///Field `TOUCH_BYPASS_NEG_NOISE_THRES` reader - bypass neg noise thres
pub type TOUCH_BYPASS_NEG_NOISE_THRES_R = crate::BitReader;
///Field `TOUCH_BYPASS_NEG_NOISE_THRES` writer - bypass neg noise thres
pub type TOUCH_BYPASS_NEG_NOISE_THRES_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_BYPASS_NOISE_THRES` reader - bypaas noise thres
pub type TOUCH_BYPASS_NOISE_THRES_R = crate::BitReader;
///Field `TOUCH_BYPASS_NOISE_THRES` writer - bypaas noise thres
pub type TOUCH_BYPASS_NOISE_THRES_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_SMOOTH_LVL` reader - smooth filter factor
pub type TOUCH_SMOOTH_LVL_R = crate::FieldReader;
///Field `TOUCH_SMOOTH_LVL` writer - smooth filter factor
pub type TOUCH_SMOOTH_LVL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_JITTER_STEP` reader - touch jitter step
pub type TOUCH_JITTER_STEP_R = crate::FieldReader;
///Field `TOUCH_JITTER_STEP` writer - touch jitter step
...
///Field `TOUCH_FILTER_MODE` reader - 0: IIR ? 1: IIR ? 2: IIR 1/8 3: Jitter
pub type TOUCH_FILTER_MODE_R = crate::FieldReader;
///Field `TOUCH_FILTER_MODE` writer - 0: IIR ? 1: IIR ? 2: IIR 1/8 3: Jitter
pub type TOUCH_FILTER_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `TOUCH_FILTER_EN` reader - touch filter enable
pub type TOUCH_FILTER_EN_R = crate::BitReader;
///Field `TOUCH_FILTER_EN` writer - touch filter enable
pub type TOUCH_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 7 - bypass neg noise thres
    #[inline(always)]
