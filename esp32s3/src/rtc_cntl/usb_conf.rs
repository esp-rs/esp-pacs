...
pub type SW_USB_PHY_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SW_HW_USB_PHY_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sw_usb_phy_sel(&mut self) -> SW_USB_PHY_SEL_W<USB_CONF_SPEC, 19> {
        SW_USB_PHY_SEL_W::new(self)
    }
    #[doc = "Bit 20 - reg_sw_hw_usb_phy_sel"]
    #[inline(always)]
    #[must_use]
    pub fn sw_hw_usb_phy_sel(&mut self) -> SW_HW_USB_PHY_SEL_W<USB_CONF_SPEC, 20> {
