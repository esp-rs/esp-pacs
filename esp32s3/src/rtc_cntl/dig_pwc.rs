...
///Field `BT_FORCE_PD` reader - internal SRAM 2 force power down
pub type BT_FORCE_PD_R = crate::BitReader;
///Field `BT_FORCE_PD` writer - internal SRAM 2 force power down
pub type BT_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BT_FORCE_PU` reader - internal SRAM 2 force power up
pub type BT_FORCE_PU_R = crate::BitReader;
///Field `BT_FORCE_PU` writer - internal SRAM 2 force power up
pub type BT_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_PERI_FORCE_PD` reader - internal SRAM 3 force power down
pub type DG_PERI_FORCE_PD_R = crate::BitReader;
///Field `DG_PERI_FORCE_PD` writer - internal SRAM 3 force power down
pub type DG_PERI_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_PERI_FORCE_PU` reader - internal SRAM 3 force power up
pub type DG_PERI_FORCE_PU_R = crate::BitReader;
///Field `DG_PERI_FORCE_PU` writer - internal SRAM 3 force power up
...
///Field `CPU_TOP_FORCE_PD` reader - digital dcdc force power down
pub type CPU_TOP_FORCE_PD_R = crate::BitReader;
///Field `CPU_TOP_FORCE_PD` writer - digital dcdc force power down
pub type CPU_TOP_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CPU_TOP_FORCE_PU` reader - digital dcdc force power up
pub type CPU_TOP_FORCE_PU_R = crate::BitReader;
///Field `CPU_TOP_FORCE_PU` writer - digital dcdc force power up
pub type CPU_TOP_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BT_PD_EN` reader - enable power down internal SRAM 2 in sleep
pub type BT_PD_EN_R = crate::BitReader;
///Field `BT_PD_EN` writer - enable power down internal SRAM 2 in sleep
pub type BT_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DG_PERI_PD_EN` reader - enable power down internal SRAM 3 in sleep
pub type DG_PERI_PD_EN_R = crate::BitReader;
///Field `DG_PERI_PD_EN` writer - enable power down internal SRAM 3 in sleep
pub type DG_PERI_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CPU_TOP_PD_EN` reader - enable power down internal SRAM 4 in sleep
pub type CPU_TOP_PD_EN_R = crate::BitReader;
///Field `CPU_TOP_PD_EN` writer - enable power down internal SRAM 4 in sleep
...
///Field `DG_WRAP_PD_EN` reader - enable power down all digital logic
pub type DG_WRAP_PD_EN_R = crate::BitReader;
///Field `DG_WRAP_PD_EN` writer - enable power down all digital logic
