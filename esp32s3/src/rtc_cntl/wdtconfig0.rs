...
///Field `WDT_PAUSE_IN_SLP` reader - pause WDT in sleep
pub type WDT_PAUSE_IN_SLP_R = crate::BitReader;
///Field `WDT_PAUSE_IN_SLP` writer - pause WDT in sleep
...
///Field `WDT_PROCPU_RESET_EN` reader - enable WDT reset PRO CPU
pub type WDT_PROCPU_RESET_EN_R = crate::BitReader;
///Field `WDT_PROCPU_RESET_EN` writer - enable WDT reset PRO CPU
pub type WDT_PROCPU_RESET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_FLASHBOOT_MOD_EN` reader - enable WDT in flash boot
pub type WDT_FLASHBOOT_MOD_EN_R = crate::BitReader;
///Field `WDT_FLASHBOOT_MOD_EN` writer - enable WDT in flash boot
pub type WDT_FLASHBOOT_MOD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDT_SYS_RESET_LENGTH` reader - system reset counter length
pub type WDT_SYS_RESET_LENGTH_R = crate::FieldReader;
///Field `WDT_SYS_RESET_LENGTH` writer - system reset counter length
pub type WDT_SYS_RESET_LENGTH_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_CPU_RESET_LENGTH` reader - CPU reset counter length
pub type WDT_CPU_RESET_LENGTH_R = crate::FieldReader;
///Field `WDT_CPU_RESET_LENGTH` writer - CPU reset counter length
pub type WDT_CPU_RESET_LENGTH_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG3` reader - 1: interrupt stage en 2: CPU reset stage en 3: system reset stage en 4: RTC reset stage en
pub type WDT_STG3_R = crate::FieldReader;
///Field `WDT_STG3` writer - 1: interrupt stage en 2: CPU reset stage en 3: system reset stage en 4: RTC reset stage en
pub type WDT_STG3_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG2` reader - 1: interrupt stage en 2: CPU reset stage en 3: system reset stage en 4: RTC reset stage en
pub type WDT_STG2_R = crate::FieldReader;
///Field `WDT_STG2` writer - 1: interrupt stage en 2: CPU reset stage en 3: system reset stage en 4: RTC reset stage en
pub type WDT_STG2_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG1` reader - 1: interrupt stage en 2: CPU reset stage en 3: system reset stage en 4: RTC reset stage en
pub type WDT_STG1_R = crate::FieldReader;
///Field `WDT_STG1` writer - 1: interrupt stage en 2: CPU reset stage en 3: system reset stage en 4: RTC reset stage en
pub type WDT_STG1_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_STG0` reader - 1: interrupt stage en 2: CPU reset stage en 3: system reset stage en 4: RTC reset stage en
pub type WDT_STG0_R = crate::FieldReader;
///Field `WDT_STG0` writer - 1: interrupt stage en 2: CPU reset stage en 3: system reset stage en 4: RTC reset stage en
pub type WDT_STG0_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `WDT_EN` reader - enable rtc watch dog
pub type WDT_EN_R = crate::BitReader;
///Field `WDT_EN` writer - enable rtc watch dog
