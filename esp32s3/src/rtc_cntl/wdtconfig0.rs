...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("WDTCONFIG0")
            .field("wdt_chip_reset_width", &self.wdt_chip_reset_width().bits())
            .field("wdt_chip_reset_en", &self.wdt_chip_reset_en().bit())
            .field("wdt_pause_in_slp", &self.wdt_pause_in_slp().bit())
