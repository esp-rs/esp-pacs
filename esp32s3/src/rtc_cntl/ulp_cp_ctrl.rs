///Register `ULP_CP_CTRL` reader
pub type R = crate::R<ULP_CP_CTRL_SPEC>;
///Register `ULP_CP_CTRL` writer
...
///`read()` method returns [`ulp_cp_ctrl::R`](R) reader structure
impl crate::Readable for ULP_CP_CTRL_SPEC {}
///`write(|w| ..)` method takes [`ulp_cp_ctrl::W`](W) writer structure
