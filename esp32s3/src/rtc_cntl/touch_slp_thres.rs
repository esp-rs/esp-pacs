...
///Field `TOUCH_SLP_TH` reader - the threshold for sleep touch pad
pub type TOUCH_SLP_TH_R = crate::FieldReader<u32>;
///Field `TOUCH_SLP_TH` writer - the threshold for sleep touch pad
pub type TOUCH_SLP_TH_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
///Field `TOUCH_SLP_APPROACH_EN` reader - sleep pad approach function enable
pub type TOUCH_SLP_APPROACH_EN_R = crate::BitReader;
///Field `TOUCH_SLP_APPROACH_EN` writer - sleep pad approach function enable
pub type TOUCH_SLP_APPROACH_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TOUCH_SLP_PAD` reader - configure which pad as slp pad
pub type TOUCH_SLP_PAD_R = crate::FieldReader;
///Field `TOUCH_SLP_PAD` writer - configure which pad as slp pad
pub type TOUCH_SLP_PAD_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:21 - the threshold for sleep touch pad
    #[inline(always)]
    pub fn touch_slp_th(&self) -> TOUCH_SLP_TH_R {
        TOUCH_SLP_TH_R::new(self.bits & 0x003f_ffff)
    }
    ///Bit 26 - sleep pad approach function enable
    #[inline(always)]
    pub fn touch_slp_approach_en(&self) -> TOUCH_SLP_APPROACH_EN_R {
        TOUCH_SLP_APPROACH_EN_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bits 27:31 - configure which pad as slp pad
    #[inline(always)]
