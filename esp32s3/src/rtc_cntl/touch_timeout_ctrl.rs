...
///Field `TOUCH_TIMEOUT_NUM` reader - configure touch timerout time
pub type TOUCH_TIMEOUT_NUM_R = crate::FieldReader<u32>;
///Field `TOUCH_TIMEOUT_NUM` writer - configure touch timerout time
pub type TOUCH_TIMEOUT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
///Field `TOUCH_TIMEOUT_EN` reader - enable touch timerout
pub type TOUCH_TIMEOUT_EN_R = crate::BitReader;
///Field `TOUCH_TIMEOUT_EN` writer - enable touch timerout
