...
impl W {
    ...
    #[inline(always)]
    pub fn reset_flag_procpu_clr(&mut self) -> RESET_FLAG_PROCPU_CLR_W<'_, RESET_STATE_SPEC> {
        RESET_FLAG_PROCPU_CLR_W::new(self, 16)
    }
    #[doc = "Bit 17 - clear APP CPU reset flag"]
    #[inline(always)]
    pub fn reset_flag_appcpu_clr(&mut self) -> RESET_FLAG_APPCPU_CLR_W<'_, RESET_STATE_SPEC> {
        RESET_FLAG_APPCPU_CLR_W::new(self, 17)
    }
    #[doc = "Bit 18 - APPCPU OcdHaltOnReset"]
    #[inline(always)]
    pub fn appcpu_ocd_halt_on_reset(&mut self) -> APPCPU_OCD_HALT_ON_RESET_W<'_, RESET_STATE_SPEC> {
        APPCPU_OCD_HALT_ON_RESET_W::new(self, 18)
    }
    #[doc = "Bit 19 - PROCPU OcdHaltOnReset"]
    #[inline(always)]
    pub fn procpu_ocd_halt_on_reset(&mut self) -> PROCPU_OCD_HALT_ON_RESET_W<'_, RESET_STATE_SPEC> {
    ...
    pub fn reset_flag_jtag_procpu_clr(
        &mut self,
    ) -> RESET_FLAG_JTAG_PROCPU_CLR_W<'_, RESET_STATE_SPEC> {
    ...
    pub fn reset_flag_jtag_appcpu_clr(
        &mut self,
    ) -> RESET_FLAG_JTAG_APPCPU_CLR_W<'_, RESET_STATE_SPEC> {
        RESET_FLAG_JTAG_APPCPU_CLR_W::new(self, 23)
    }
    #[doc = "Bit 24 - bypass cpu1 dreset"]
    #[inline(always)]
    pub fn app_dreset_mask(&mut self) -> APP_DRESET_MASK_W<'_, RESET_STATE_SPEC> {
        APP_DRESET_MASK_W::new(self, 24)
    }
    #[doc = "Bit 25 - bypass cpu0 dreset"]
    #[inline(always)]
    pub fn pro_dreset_mask(&mut self) -> PRO_DRESET_MASK_W<'_, RESET_STATE_SPEC> {
