...
impl W {
    #[doc = "Bits 10:13 - No public"]
    #[inline(always)]
    pub fn retention_tag_mode(&mut self) -> RETENTION_TAG_MODE_W<'_, RETENTION_CTRL_SPEC> {
        RETENTION_TAG_MODE_W::new(self, 10)
    }
    #[doc = "Bits 14:15 - congfigure retention target cpu and/or tag"]
    #[inline(always)]
    pub fn retention_target(&mut self) -> RETENTION_TARGET_W<'_, RETENTION_CTRL_SPEC> {
