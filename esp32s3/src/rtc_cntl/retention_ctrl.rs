...
///Field `RETENTION_TAG_MODE` reader - No public
pub type RETENTION_TAG_MODE_R = crate::FieldReader;
///Field `RETENTION_TAG_MODE` writer - No public
pub type RETENTION_TAG_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `RETENTION_TARGET` reader - congfigure retention target cpu and/or tag
pub type RETENTION_TARGET_R = crate::FieldReader;
///Field `RETENTION_TARGET` writer - congfigure retention target cpu and/or tag
pub type RETENTION_TARGET_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `RETENTION_CLK_SEL` reader - No public
pub type RETENTION_CLK_SEL_R = crate::BitReader;
///Field `RETENTION_CLK_SEL` writer - No public
pub type RETENTION_CLK_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RETENTION_DONE_WAIT` reader - wait retention done cycle
pub type RETENTION_DONE_WAIT_R = crate::FieldReader;
///Field `RETENTION_DONE_WAIT` writer - wait retention done cycle
pub type RETENTION_DONE_WAIT_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `RETENTION_CLKOFF_WAIT` reader - wait clk off cycle
pub type RETENTION_CLKOFF_WAIT_R = crate::FieldReader;
///Field `RETENTION_CLKOFF_WAIT` writer - wait clk off cycle
pub type RETENTION_CLKOFF_WAIT_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `RETENTION_EN` reader - enable retention
pub type RETENTION_EN_R = crate::BitReader;
///Field `RETENTION_EN` writer - enable retention
