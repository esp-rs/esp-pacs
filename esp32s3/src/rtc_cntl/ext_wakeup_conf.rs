...
///Field `GPIO_WAKEUP_FILTER` reader - enable filter for gpio wakeup event
pub type GPIO_WAKEUP_FILTER_R = crate::BitReader;
///Field `GPIO_WAKEUP_FILTER` writer - enable filter for gpio wakeup event
pub type GPIO_WAKEUP_FILTER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXT_WAKEUP0_LV` reader - 0: external wakeup at low level, 1: external wakeup at high level
pub type EXT_WAKEUP0_LV_R = crate::BitReader;
///Field `EXT_WAKEUP0_LV` writer - 0: external wakeup at low level, 1: external wakeup at high level
pub type EXT_WAKEUP0_LV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EXT_WAKEUP1_LV` reader - 0: external wakeup at low level, 1: external wakeup at high level
pub type EXT_WAKEUP1_LV_R = crate::BitReader;
///Field `EXT_WAKEUP1_LV` writer - 0: external wakeup at low level, 1: external wakeup at high level
