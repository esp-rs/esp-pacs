...
///Field `TIMER_INT1_MAP` reader - this register used to map timer_int1 interrupt to one of core0's external interrupt
pub type TIMER_INT1_MAP_R = crate::FieldReader;
///Field `TIMER_INT1_MAP` writer - this register used to map timer_int1 interrupt to one of core0's external interrupt
pub type TIMER_INT1_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map timer_int1 interrupt to one of core0's external interrupt
    #[inline(always)]
