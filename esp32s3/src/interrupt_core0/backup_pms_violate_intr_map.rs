...
///Field `BACKUP_PMS_VIOLATE_INTR_MAP` reader - this register used to map backup_pms_monitor_violatile interrupt to one of core0's external interrupt
pub type BACKUP_PMS_VIOLATE_INTR_MAP_R = crate::FieldReader;
///Field `BACKUP_PMS_VIOLATE_INTR_MAP` writer - this register used to map backup_pms_monitor_violatile interrupt to one of core0's external interrupt
pub type BACKUP_PMS_VIOLATE_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map backup_pms_monitor_violatile interrupt to one of core0's external interrupt
    #[inline(always)]
