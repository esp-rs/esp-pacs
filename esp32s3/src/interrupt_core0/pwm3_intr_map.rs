///Register `PWM3_INTR_MAP` reader
pub type R = crate::R<PWM3_INTR_MAP_SPEC>;
///Register `PWM3_INTR_MAP` writer
pub type W = crate::W<PWM3_INTR_MAP_SPEC>;
///Field `PWM3_INTR_MAP` reader - this register used to map pwm3 interrupt to one of core0's external interrupt
pub type PWM3_INTR_MAP_R = crate::FieldReader;
///Field `PWM3_INTR_MAP` writer - this register used to map pwm3 interrupt to one of core0's external interrupt
pub type PWM3_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map pwm3 interrupt to one of core0's external interrupt
    #[inline(always)]
...
///`read()` method returns [`pwm3_intr_map::R`](R) reader structure
impl crate::Readable for PWM3_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`pwm3_intr_map::W`](W) writer structure
