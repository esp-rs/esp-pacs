...
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP_SPEC, u8, u8, 5, O>;
impl R {
