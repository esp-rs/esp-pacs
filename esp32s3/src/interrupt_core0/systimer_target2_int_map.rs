...
#[doc = "Field `SYSTIMER_TARGET2_INT_MAP` reader - this register used to map systimer_target2 interrupt to one of core0's external interrupt"]
pub type SYSTIMER_TARGET2_INT_MAP_R = crate::FieldReader;
#[doc = "Field `SYSTIMER_TARGET2_INT_MAP` writer - this register used to map systimer_target2 interrupt to one of core0's external interrupt"]
pub type SYSTIMER_TARGET2_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map systimer_target2 interrupt to one of core0's external interrupt"]
    #[inline(always)]
...
impl W {
    ...
    pub fn systimer_target2_int_map(
        &mut self,
    ) -> SYSTIMER_TARGET2_INT_MAP_W<SYSTIMER_TARGET2_INT_MAP_SPEC, 0> {
...
#[doc = "`reset()` method sets SYSTIMER_TARGET2_INT_MAP to value 0x10"]
