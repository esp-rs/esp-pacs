...
#[doc = "Field `CACHE_IA_INT_MAP` reader - this register used to map cache_ia interrupt to one of core0's external interrupt"]
pub type CACHE_IA_INT_MAP_R = crate::FieldReader;
#[doc = "Field `CACHE_IA_INT_MAP` writer - this register used to map cache_ia interrupt to one of core0's external interrupt"]
pub type CACHE_IA_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map cache_ia interrupt to one of core0's external interrupt"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cache_ia_int_map(&mut self) -> CACHE_IA_INT_MAP_W<CACHE_IA_INT_MAP_SPEC, 0> {
