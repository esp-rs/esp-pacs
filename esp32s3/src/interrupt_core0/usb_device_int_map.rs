...
///Field `USB_DEVICE_INT_MAP` reader - this register used to map usb_device interrupt to one of core0's external interrupt
pub type USB_DEVICE_INT_MAP_R = crate::FieldReader;
///Field `USB_DEVICE_INT_MAP` writer - this register used to map usb_device interrupt to one of core0's external interrupt
