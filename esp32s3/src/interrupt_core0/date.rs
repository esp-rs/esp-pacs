...
#[doc = "Field `INTERRUPT_REG_DATE` reader - version register"]
pub type INTERRUPT_REG_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `INTERRUPT_REG_DATE` writer - version register"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DATE")
            .field("interrupt_reg_date", &self.interrupt_reg_date().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn interrupt_reg_date(&mut self) -> INTERRUPT_REG_DATE_W<DATE_SPEC> {
