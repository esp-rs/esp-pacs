...
#[doc = "Field `RWBLE_NMI_MAP` reader - this register used to map rwble_nmi interrupt to one of core0's external interrupt"]
pub type RWBLE_NMI_MAP_R = crate::FieldReader;
#[doc = "Field `RWBLE_NMI_MAP` writer - this register used to map rwble_nmi interrupt to one of core0's external interrupt"]
pub type RWBLE_NMI_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map rwble_nmi interrupt to one of core0's external interrupt"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RWBLE_NMI_MAP")
            .field(
                "rwble_nmi_map",
                &format_args!("{}", self.rwble_nmi_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RWBLE_NMI_MAP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rwble_nmi_map(&mut self) -> RWBLE_NMI_MAP_W<RWBLE_NMI_MAP_SPEC, 0> {
        RWBLE_NMI_MAP_W::new(self)
    }
...
#[doc = "`reset()` method sets RWBLE_NMI_MAP to value 0x10"]
