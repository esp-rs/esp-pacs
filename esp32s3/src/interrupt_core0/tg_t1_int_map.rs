...
#[doc = "Field `TG_T1_INT_MAP` reader - this register used to map tg_t1 interrupt to one of core0's external interrupt"]
pub type TG_T1_INT_MAP_R = crate::FieldReader;
#[doc = "Field `TG_T1_INT_MAP` writer - this register used to map tg_t1 interrupt to one of core0's external interrupt"]
pub type TG_T1_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map tg_t1 interrupt to one of core0's external interrupt"]
    #[inline(always)]
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TG_T1_INT_MAP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tg_t1_int_map(&mut self) -> TG_T1_INT_MAP_W<TG_T1_INT_MAP_SPEC, 0> {
