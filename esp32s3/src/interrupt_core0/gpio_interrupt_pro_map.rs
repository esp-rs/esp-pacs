...
#[doc = "Field `GPIO_INTERRUPT_PRO_MAP` reader - this register used to map gpio_interrupt_pro interrupt to one of core0's external interrupt"]
pub type GPIO_INTERRUPT_PRO_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GPIO_INTERRUPT_PRO_MAP` writer - this register used to map gpio_interrupt_pro interrupt to one of core0's external interrupt"]
pub type GPIO_INTERRUPT_PRO_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO_INTERRUPT_PRO_MAP_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map gpio_interrupt_pro interrupt to one of core0's external interrupt"]
    #[inline(always)]
