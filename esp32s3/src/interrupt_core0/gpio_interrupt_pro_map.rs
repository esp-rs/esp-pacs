...
///Field `GPIO_INTERRUPT_PRO_MAP` reader - this register used to map gpio_interrupt_pro interrupt to one of core0's external interrupt
pub type GPIO_INTERRUPT_PRO_MAP_R = crate::FieldReader;
///Field `GPIO_INTERRUPT_PRO_MAP` writer - this register used to map gpio_interrupt_pro interrupt to one of core0's external interrupt
pub type GPIO_INTERRUPT_PRO_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map gpio_interrupt_pro interrupt to one of core0's external interrupt
    #[inline(always)]
