///Register `CPU_INTR_FROM_CPU_1_MAP` reader
pub type R = crate::R<CPU_INTR_FROM_CPU_1_MAP_SPEC>;
///Register `CPU_INTR_FROM_CPU_1_MAP` writer
pub type W = crate::W<CPU_INTR_FROM_CPU_1_MAP_SPEC>;
///Field `CPU_INTR_FROM_CPU_1_MAP` reader - this register used to map cpu_intr_from_cpu_1 interrupt to one of core0's external interrupt
pub type CPU_INTR_FROM_CPU_1_MAP_R = crate::FieldReader;
///Field `CPU_INTR_FROM_CPU_1_MAP` writer - this register used to map cpu_intr_from_cpu_1 interrupt to one of core0's external interrupt
pub type CPU_INTR_FROM_CPU_1_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map cpu_intr_from_cpu_1 interrupt to one of core0's external interrupt
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`cpu_intr_from_cpu_1_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cpu_intr_from_cpu_1_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CPU_INTR_FROM_CPU_1_MAP_SPEC;
impl crate::RegisterSpec for CPU_INTR_FROM_CPU_1_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`cpu_intr_from_cpu_1_map::R`](R) reader structure
impl crate::Readable for CPU_INTR_FROM_CPU_1_MAP_SPEC {}
///`write(|w| ..)` method takes [`cpu_intr_from_cpu_1_map::W`](W) writer structure
