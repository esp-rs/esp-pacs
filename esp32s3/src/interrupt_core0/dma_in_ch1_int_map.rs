...
///Field `DMA_IN_CH1_INT_MAP` reader - this register used to map dma_in_ch1 interrupt to one of core0's external interrupt
pub type DMA_IN_CH1_INT_MAP_R = crate::FieldReader;
///Field `DMA_IN_CH1_INT_MAP` writer - this register used to map dma_in_ch1 interrupt to one of core0's external interrupt
pub type DMA_IN_CH1_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map dma_in_ch1 interrupt to one of core0's external interrupt
    #[inline(always)]
