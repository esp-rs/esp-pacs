///Register `SPI_MEM_REJECT_INTR_MAP` reader
pub type R = crate::R<SPI_MEM_REJECT_INTR_MAP_SPEC>;
///Register `SPI_MEM_REJECT_INTR_MAP` writer
pub type W = crate::W<SPI_MEM_REJECT_INTR_MAP_SPEC>;
///Field `SPI_MEM_REJECT_INTR_MAP` reader - this register used to map spi_mem_reject interrupt to one of core0's external interrupt
pub type SPI_MEM_REJECT_INTR_MAP_R = crate::FieldReader;
///Field `SPI_MEM_REJECT_INTR_MAP` writer - this register used to map spi_mem_reject interrupt to one of core0's external interrupt
pub type SPI_MEM_REJECT_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map spi_mem_reject interrupt to one of core0's external interrupt
    #[inline(always)]
...
///`read()` method returns [`spi_mem_reject_intr_map::R`](R) reader structure
impl crate::Readable for SPI_MEM_REJECT_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`spi_mem_reject_intr_map::W`](W) writer structure
