///Register `GPIO_INTERRUPT_PRO_NMI_MAP` reader
pub type R = crate::R<GPIO_INTERRUPT_PRO_NMI_MAP_SPEC>;
///Register `GPIO_INTERRUPT_PRO_NMI_MAP` writer
pub type W = crate::W<GPIO_INTERRUPT_PRO_NMI_MAP_SPEC>;
///Field `GPIO_INTERRUPT_PRO_NMI_MAP` reader - this register used to map gpio_interrupt_pro_nmi interrupt to one of core0's external interrupt
pub type GPIO_INTERRUPT_PRO_NMI_MAP_R = crate::FieldReader;
///Field `GPIO_INTERRUPT_PRO_NMI_MAP` writer - this register used to map gpio_interrupt_pro_nmi interrupt to one of core0's external interrupt
pub type GPIO_INTERRUPT_PRO_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map gpio_interrupt_pro_nmi interrupt to one of core0's external interrupt
    #[inline(always)]
...
///`read()` method returns [`gpio_interrupt_pro_nmi_map::R`](R) reader structure
impl crate::Readable for GPIO_INTERRUPT_PRO_NMI_MAP_SPEC {}
///`write(|w| ..)` method takes [`gpio_interrupt_pro_nmi_map::W`](W) writer structure
