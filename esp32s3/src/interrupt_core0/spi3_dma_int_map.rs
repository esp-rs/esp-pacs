///Register `SPI3_DMA_INT_MAP` reader
pub type R = crate::R<SPI3_DMA_INT_MAP_SPEC>;
///Register `SPI3_DMA_INT_MAP` writer
pub type W = crate::W<SPI3_DMA_INT_MAP_SPEC>;
///Field `SPI3_DMA_INT_MAP` reader - this register used to map spi3_dma interrupt to one of core0's external interrupt
pub type SPI3_DMA_INT_MAP_R = crate::FieldReader;
///Field `SPI3_DMA_INT_MAP` writer - this register used to map spi3_dma interrupt to one of core0's external interrupt
pub type SPI3_DMA_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map spi3_dma interrupt to one of core0's external interrupt
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI3_DMA_INT_MAP")
            .field("spi3_dma_int_map", &self.spi3_dma_int_map())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi3_dma_int_map(&mut self) -> SPI3_DMA_INT_MAP_W<SPI3_DMA_INT_MAP_SPEC> {
        SPI3_DMA_INT_MAP_W::new(self, 0)
    }
}
...
///`read()` method returns [`spi3_dma_int_map::R`](R) reader structure
impl crate::Readable for SPI3_DMA_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`spi3_dma_int_map::W`](W) writer structure
