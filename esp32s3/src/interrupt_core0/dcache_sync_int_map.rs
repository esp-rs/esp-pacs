...
pub type DCACHE_SYNC_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcache_sync_int_map(&mut self) -> DCACHE_SYNC_INT_MAP_W<DCACHE_SYNC_INT_MAP_SPEC, 0> {
