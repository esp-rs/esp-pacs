...
///Field `SPI_INTR_3_MAP` reader - this register used to map spi_intr_3 interrupt to one of core0's external interrupt
pub type SPI_INTR_3_MAP_R = crate::FieldReader;
///Field `SPI_INTR_3_MAP` writer - this register used to map spi_intr_3 interrupt to one of core0's external interrupt
pub type SPI_INTR_3_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map spi_intr_3 interrupt to one of core0's external interrupt
    #[inline(always)]
