...
///Field `PERI_BACKUP_INT_MAP` reader - this register used to map peri_backup interrupt to one of core0's external interrupt
pub type PERI_BACKUP_INT_MAP_R = crate::FieldReader;
///Field `PERI_BACKUP_INT_MAP` writer - this register used to map peri_backup interrupt to one of core0's external interrupt
