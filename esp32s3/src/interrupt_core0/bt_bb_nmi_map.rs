///Register `BT_BB_NMI_MAP` reader
pub type R = crate::R<BT_BB_NMI_MAP_SPEC>;
///Register `BT_BB_NMI_MAP` writer
pub type W = crate::W<BT_BB_NMI_MAP_SPEC>;
///Field `BT_BB_NMI_MAP` reader - this register used to map bb_bt_nmi interrupt to one of core0's external interrupt
pub type BT_BB_NMI_MAP_R = crate::FieldReader;
///Field `BT_BB_NMI_MAP` writer - this register used to map bb_bt_nmi interrupt to one of core0's external interrupt
pub type BT_BB_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map bb_bt_nmi interrupt to one of core0's external interrupt
    #[inline(always)]
...
///`read()` method returns [`bt_bb_nmi_map::R`](R) reader structure
impl crate::Readable for BT_BB_NMI_MAP_SPEC {}
///`write(|w| ..)` method takes [`bt_bb_nmi_map::W`](W) writer structure
