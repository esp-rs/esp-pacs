...
///Field `REG_CLK_EN` reader - this register uesd to control clock-gating interupt martrix
pub type REG_CLK_EN_R = crate::BitReader;
///Field `REG_CLK_EN` writer - this register uesd to control clock-gating interupt martrix
pub type REG_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - this register uesd to control clock-gating interupt martrix
    #[inline(always)]
