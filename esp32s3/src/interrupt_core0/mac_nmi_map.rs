///Register `MAC_NMI_MAP` reader
pub type R = crate::R<MAC_NMI_MAP_SPEC>;
///Register `MAC_NMI_MAP` writer
pub type W = crate::W<MAC_NMI_MAP_SPEC>;
///Field `MAC_NMI_MAP` reader - this register used to map_nmi interrupt to one of core0's external interrupt
pub type MAC_NMI_MAP_R = crate::FieldReader;
///Field `MAC_NMI_MAP` writer - this register used to map_nmi interrupt to one of core0's external interrupt
pub type MAC_NMI_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map_nmi interrupt to one of core0's external interrupt
    #[inline(always)]
...
///`read()` method returns [`mac_nmi_map::R`](R) reader structure
impl crate::Readable for MAC_NMI_MAP_SPEC {}
///`write(|w| ..)` method takes [`mac_nmi_map::W`](W) writer structure
