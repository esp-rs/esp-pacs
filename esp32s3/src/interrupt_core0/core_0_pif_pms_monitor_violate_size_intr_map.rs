...
#[doc = "Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP` reader - this register used to map core0_PIF_pms_monitor_violatile_size interrupt to one of core0's external interrupt"]
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP` writer - this register used to map core0_PIF_pms_monitor_violatile_size interrupt to one of core0's external interrupt"]
...
impl R {
    #[doc = "Bits 0:4 - this register used to map core0_PIF_pms_monitor_violatile_size interrupt to one of core0's external interrupt"]
    #[inline(always)]
