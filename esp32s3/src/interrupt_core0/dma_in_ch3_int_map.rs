///Register `DMA_IN_CH3_INT_MAP` reader
pub type R = crate::R<DMA_IN_CH3_INT_MAP_SPEC>;
///Register `DMA_IN_CH3_INT_MAP` writer
pub type W = crate::W<DMA_IN_CH3_INT_MAP_SPEC>;
///Field `DMA_IN_CH3_INT_MAP` reader - this register used to map dma_in_ch3 interrupt to one of core0's external interrupt
pub type DMA_IN_CH3_INT_MAP_R = crate::FieldReader;
///Field `DMA_IN_CH3_INT_MAP` writer - this register used to map dma_in_ch3 interrupt to one of core0's external interrupt
pub type DMA_IN_CH3_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map dma_in_ch3 interrupt to one of core0's external interrupt
    #[inline(always)]
...
///`read()` method returns [`dma_in_ch3_int_map::R`](R) reader structure
impl crate::Readable for DMA_IN_CH3_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`dma_in_ch3_int_map::W`](W) writer structure
