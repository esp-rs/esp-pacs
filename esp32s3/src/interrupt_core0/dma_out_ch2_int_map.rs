///Register `DMA_OUT_CH2_INT_MAP` reader
pub type R = crate::R<DMA_OUT_CH2_INT_MAP_SPEC>;
///Register `DMA_OUT_CH2_INT_MAP` writer
pub type W = crate::W<DMA_OUT_CH2_INT_MAP_SPEC>;
///Field `DMA_OUT_CH2_INT_MAP` reader - this register used to map dma_out_ch2 interrupt to one of core0's external interrupt
pub type DMA_OUT_CH2_INT_MAP_R = crate::FieldReader;
///Field `DMA_OUT_CH2_INT_MAP` writer - this register used to map dma_out_ch2 interrupt to one of core0's external interrupt
pub type DMA_OUT_CH2_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map dma_out_ch2 interrupt to one of core0's external interrupt
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`dma_out_ch2_int_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dma_out_ch2_int_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DMA_OUT_CH2_INT_MAP_SPEC;
impl crate::RegisterSpec for DMA_OUT_CH2_INT_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dma_out_ch2_int_map::R`](R) reader structure
impl crate::Readable for DMA_OUT_CH2_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`dma_out_ch2_int_map::W`](W) writer structure
