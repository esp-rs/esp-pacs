...
#[doc = "Field `SDIO_HOST_INTERRUPT_MAP` reader - this register used to map sdio_host interrupt to one of core0's external interrupt"]
pub type SDIO_HOST_INTERRUPT_MAP_R = crate::FieldReader;
#[doc = "Field `SDIO_HOST_INTERRUPT_MAP` writer - this register used to map sdio_host interrupt to one of core0's external interrupt"]
