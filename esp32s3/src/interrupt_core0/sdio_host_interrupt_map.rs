...
///Field `SDIO_HOST_INTERRUPT_MAP` reader - this register used to map sdio_host interrupt to one of core0's external interrupt
pub type SDIO_HOST_INTERRUPT_MAP_R = crate::FieldReader;
///Field `SDIO_HOST_INTERRUPT_MAP` writer - this register used to map sdio_host interrupt to one of core0's external interrupt
pub type SDIO_HOST_INTERRUPT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map sdio_host interrupt to one of core0's external interrupt
    #[inline(always)]
