///Register `BT_MAC_INT_MAP` reader
pub type R = crate::R<BT_MAC_INT_MAP_SPEC>;
///Register `BT_MAC_INT_MAP` writer
pub type W = crate::W<BT_MAC_INT_MAP_SPEC>;
///Field `BT_MAC_INT_MAP` reader - this register used to map bb_mac interrupt to one of core0's external interrupt
pub type BT_MAC_INT_MAP_R = crate::FieldReader;
///Field `BT_MAC_INT_MAP` writer - this register used to map bb_mac interrupt to one of core0's external interrupt
pub type BT_MAC_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map bb_mac interrupt to one of core0's external interrupt
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BT_MAC_INT_MAP")
            .field("bt_mac_int_map", &self.bt_mac_int_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`bt_mac_int_map::R`](R) reader structure
impl crate::Readable for BT_MAC_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`bt_mac_int_map::W`](W) writer structure
