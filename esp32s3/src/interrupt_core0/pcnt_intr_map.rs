...
#[doc = "Field `PCNT_INTR_MAP` reader - this register used to map pcnt interrupt to one of core0's external interrupt"]
pub type PCNT_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `PCNT_INTR_MAP` writer - this register used to map pcnt interrupt to one of core0's external interrupt"]
pub type PCNT_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcnt_intr_map(&mut self) -> PCNT_INTR_MAP_W<PCNT_INTR_MAP_SPEC, 0> {
