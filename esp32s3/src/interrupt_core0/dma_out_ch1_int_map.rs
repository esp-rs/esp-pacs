...
pub type DMA_OUT_CH1_INT_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, DMA_OUT_CH1_INT_MAP_SPEC, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_out_ch1_int_map(&mut self) -> DMA_OUT_CH1_INT_MAP_W<0> {
