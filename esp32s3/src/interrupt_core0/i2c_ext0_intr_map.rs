...
#[doc = "Field `I2C_EXT0_INTR_MAP` reader - this register used to map i2c_ext0 interrupt to one of core0's external interrupt"]
pub type I2C_EXT0_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `I2C_EXT0_INTR_MAP` writer - this register used to map i2c_ext0 interrupt to one of core0's external interrupt"]
pub type I2C_EXT0_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map i2c_ext0 interrupt to one of core0's external interrupt"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C_EXT0_INTR_MAP")
            .field(
                "i2c_ext0_intr_map",
                &format_args!("{}", self.i2c_ext0_intr_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<I2C_EXT0_INTR_MAP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_ext0_intr_map(&mut self) -> I2C_EXT0_INTR_MAP_W<I2C_EXT0_INTR_MAP_SPEC, 0> {
...
#[doc = "`reset()` method sets I2C_EXT0_INTR_MAP to value 0x10"]
