...
///Field `RWBLE_IRQ_MAP` reader - this register used to map rwble_irq interrupt to one of core0's external interrupt
pub type RWBLE_IRQ_MAP_R = crate::FieldReader;
///Field `RWBLE_IRQ_MAP` writer - this register used to map rwble_irq interrupt to one of core0's external interrupt
pub type RWBLE_IRQ_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map rwble_irq interrupt to one of core0's external interrupt
    #[inline(always)]
