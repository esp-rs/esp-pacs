///Register `CACHE_CORE0_ACS_INT_MAP` reader
pub type R = crate::R<CACHE_CORE0_ACS_INT_MAP_SPEC>;
///Register `CACHE_CORE0_ACS_INT_MAP` writer
pub type W = crate::W<CACHE_CORE0_ACS_INT_MAP_SPEC>;
///Field `CACHE_CORE0_ACS_INT_MAP` reader - this register used to map cache_core0_acs interrupt to one of core0's external interrupt
pub type CACHE_CORE0_ACS_INT_MAP_R = crate::FieldReader;
///Field `CACHE_CORE0_ACS_INT_MAP` writer - this register used to map cache_core0_acs interrupt to one of core0's external interrupt
pub type CACHE_CORE0_ACS_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map cache_core0_acs interrupt to one of core0's external interrupt
    #[inline(always)]
...
///`read()` method returns [`cache_core0_acs_int_map::R`](R) reader structure
impl crate::Readable for CACHE_CORE0_ACS_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`cache_core0_acs_int_map::W`](W) writer structure
