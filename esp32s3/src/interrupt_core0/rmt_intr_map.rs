...
#[doc = "Field `RMT_INTR_MAP` reader - this register used to map rmt interrupt to one of core0's external interrupt"]
pub type RMT_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `RMT_INTR_MAP` writer - this register used to map rmt interrupt to one of core0's external interrupt"]
pub type RMT_INTR_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, RMT_INTR_MAP_SPEC, 5, O>;
impl R {
    #[doc = "Bits 0:4 - this register used to map rmt interrupt to one of core0's external interrupt"]
    #[inline(always)]
