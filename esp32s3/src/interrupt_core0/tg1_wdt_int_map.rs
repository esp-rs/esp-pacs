///Register `TG1_WDT_INT_MAP` reader
pub type R = crate::R<TG1_WDT_INT_MAP_SPEC>;
///Register `TG1_WDT_INT_MAP` writer
pub type W = crate::W<TG1_WDT_INT_MAP_SPEC>;
///Field `TG1_WDT_INT_MAP` reader - this register used to map tg1_wdt interrupt to one of core0's external interrupt
pub type TG1_WDT_INT_MAP_R = crate::FieldReader;
///Field `TG1_WDT_INT_MAP` writer - this register used to map tg1_wdt interrupt to one of core0's external interrupt
pub type TG1_WDT_INT_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4 - this register used to map tg1_wdt interrupt to one of core0's external interrupt
    #[inline(always)]
...
///`read()` method returns [`tg1_wdt_int_map::R`](R) reader structure
impl crate::Readable for TG1_WDT_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`tg1_wdt_int_map::W`](W) writer structure
