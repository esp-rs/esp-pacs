///Register `Core_1_NMI_MASK_ENABLE` writer
pub type W = crate::W<CORE_1_NMI_MASK_ENABLE_SPEC>;
///Field `CORE_1_NMI_MASK_ENABLE` writer - this field is used to set NMI mask, it can write any value, when write this register,the hardware start masking NMI interrupt
...
///`write(|w| ..)` method takes [`core_1_nmi_mask_enable::W`](W) writer structure
