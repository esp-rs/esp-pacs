...
pub type CORE_0_FROM_WORLD_7_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE7_SPEC, O>;
...
pub type CORE_0_FROM_ENTRY_7_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_STATUSTABLE7_SPEC, 4, O>;
...
pub type CORE_0_CURRENT_7_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE7_SPEC, O>;
impl R {
