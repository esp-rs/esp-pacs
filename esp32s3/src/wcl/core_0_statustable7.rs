///Register `Core_0_STATUSTABLE7` reader
pub type R = crate::R<CORE_0_STATUSTABLE7_SPEC>;
///Register `Core_0_STATUSTABLE7` writer
pub type W = crate::W<CORE_0_STATUSTABLE7_SPEC>;
///Field `CORE_0_FROM_WORLD_7` reader - This bit is used to confirm world before enter entry 7
pub type CORE_0_FROM_WORLD_7_R = crate::BitReader;
///Field `CORE_0_FROM_WORLD_7` writer - This bit is used to confirm world before enter entry 7
pub type CORE_0_FROM_WORLD_7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_FROM_ENTRY_7` reader - This filed is used to confirm in which entry before enter entry 7
pub type CORE_0_FROM_ENTRY_7_R = crate::FieldReader;
///Field `CORE_0_FROM_ENTRY_7` writer - This filed is used to confirm in which entry before enter entry 7
pub type CORE_0_FROM_ENTRY_7_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_0_CURRENT_7` reader - This bit is used to confirm whether the current state is in entry 7
pub type CORE_0_CURRENT_7_R = crate::BitReader;
///Field `CORE_0_CURRENT_7` writer - This bit is used to confirm whether the current state is in entry 7
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE7")
            .field("core_0_from_world_7", &self.core_0_from_world_7())
            .field("core_0_from_entry_7", &self.core_0_from_entry_7())
            .field("core_0_current_7", &self.core_0_current_7())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_0_statustable7::R`](R) reader structure
impl crate::Readable for CORE_0_STATUSTABLE7_SPEC {}
///`write(|w| ..)` method takes [`core_0_statustable7::W`](W) writer structure
