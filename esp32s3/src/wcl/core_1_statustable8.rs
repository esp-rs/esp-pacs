...
pub type CORE_1_FROM_WORLD_8_W<'a, const O: u8> = crate::BitWriter<'a, CORE_1_STATUSTABLE8_SPEC, O>;
...
pub type CORE_1_FROM_ENTRY_8_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_1_STATUSTABLE8_SPEC, 4, O>;
...
pub type CORE_1_CURRENT_8_W<'a, const O: u8> = crate::BitWriter<'a, CORE_1_STATUSTABLE8_SPEC, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE8")
            .field(
                "core_1_from_world_8",
                &format_args!("{}", self.core_1_from_world_8().bit()),
            )
            .field(
                "core_1_from_entry_8",
                &format_args!("{}", self.core_1_from_entry_8().bits()),
            )
            .field(
                "core_1_current_8",
                &format_args!("{}", self.core_1_current_8().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_1_STATUSTABLE8_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_world_8(&mut self) -> CORE_1_FROM_WORLD_8_W<0> {
        CORE_1_FROM_WORLD_8_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 8"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_entry_8(&mut self) -> CORE_1_FROM_ENTRY_8_W<1> {
        CORE_1_FROM_ENTRY_8_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 8"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_current_8(&mut self) -> CORE_1_CURRENT_8_W<5> {
        CORE_1_CURRENT_8_W::new(self)
    }
