...
pub type CORE_1_FROM_WORLD_8_R = crate::BitReader<bool>;
#[doc = "Field `CORE_1_FROM_WORLD_8` writer - This bit is used to confirm world before enter entry 8"]
pub type CORE_1_FROM_WORLD_8_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE_1_STATUSTABLE8_SPEC, bool, O>;
#[doc = "Field `CORE_1_FROM_ENTRY_8` reader - This filed is used to confirm in which entry before enter entry 8"]
pub type CORE_1_FROM_ENTRY_8_R = crate::FieldReader<u8, u8>;
