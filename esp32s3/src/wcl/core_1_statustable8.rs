...
pub type CORE_1_FROM_WORLD_8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_FROM_ENTRY_8_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type CORE_1_CURRENT_8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_world_8(&mut self) -> CORE_1_FROM_WORLD_8_W<CORE_1_STATUSTABLE8_SPEC, 0> {
        CORE_1_FROM_WORLD_8_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 8"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_entry_8(&mut self) -> CORE_1_FROM_ENTRY_8_W<CORE_1_STATUSTABLE8_SPEC, 1> {
        CORE_1_FROM_ENTRY_8_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 8"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_current_8(&mut self) -> CORE_1_CURRENT_8_W<CORE_1_STATUSTABLE8_SPEC, 5> {
