...
pub type CORE_1_FROM_WORLD_2_W<'a, const O: u8> = crate::BitWriter<'a, CORE_1_STATUSTABLE2_SPEC, O>;
...
pub type CORE_1_FROM_ENTRY_2_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_1_STATUSTABLE2_SPEC, 4, O>;
...
pub type CORE_1_CURRENT_2_W<'a, const O: u8> = crate::BitWriter<'a, CORE_1_STATUSTABLE2_SPEC, O>;
impl R {
