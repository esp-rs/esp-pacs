...
pub struct R(crate::R<CORE_1_STATUSTABLE2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_STATUSTABLE2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_STATUSTABLE2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_STATUSTABLE2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Core_1_STATUSTABLE2` writer"]
pub struct W(crate::W<CORE_1_STATUSTABLE2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_STATUSTABLE2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    #[doc = "Bit 0 - This bit is used to confirm world before enter entry 2"]
    #[inline(always)]
    pub fn core_1_from_world_2(&mut self) -> CORE_1_FROM_WORLD_2_W<0> {
        CORE_1_FROM_WORLD_2_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 2"]
    #[inline(always)]
    pub fn core_1_from_entry_2(&mut self) -> CORE_1_FROM_ENTRY_2_W<1> {
        CORE_1_FROM_ENTRY_2_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 2"]
    #[inline(always)]
    pub fn core_1_current_2(&mut self) -> CORE_1_CURRENT_2_W<5> {
        CORE_1_CURRENT_2_W::new(self)
    }
