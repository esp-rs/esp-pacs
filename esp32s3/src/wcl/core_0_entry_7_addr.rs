///Register `Core_0_ENTRY_7_ADDR` reader
pub type R = crate::R<CORE_0_ENTRY_7_ADDR_SPEC>;
///Register `Core_0_ENTRY_7_ADDR` writer
pub type W = crate::W<CORE_0_ENTRY_7_ADDR_SPEC>;
///Field `CORE_0_ENTRY_7_ADDR` reader - Core_0 Entry 7 address from WORLD1 to WORLD0
pub type CORE_0_ENTRY_7_ADDR_R = crate::FieldReader<u32>;
///Field `CORE_0_ENTRY_7_ADDR` writer - Core_0 Entry 7 address from WORLD1 to WORLD0
pub type CORE_0_ENTRY_7_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core_0 Entry 7 address from WORLD1 to WORLD0
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_ENTRY_7_ADDR")
            .field("core_0_entry_7_addr", &self.core_0_entry_7_addr())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_0_entry_7_addr::R`](R) reader structure
impl crate::Readable for CORE_0_ENTRY_7_ADDR_SPEC {}
///`write(|w| ..)` method takes [`core_0_entry_7_addr::W`](W) writer structure
