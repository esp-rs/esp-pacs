...
pub struct R(crate::R<CORE_0_ENTRY_7_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_0_ENTRY_7_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_0_ENTRY_7_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_0_ENTRY_7_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Core_0_ENTRY_7_ADDR` writer"]
pub struct W(crate::W<CORE_0_ENTRY_7_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_0_ENTRY_7_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_0_ENTRY_7_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_0_ENTRY_7_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CORE_0_ENTRY_7_ADDR` reader - Core_0 Entry 7 address from WORLD1 to WORLD0"]
pub type CORE_0_ENTRY_7_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_0_ENTRY_7_ADDR` writer - Core_0 Entry 7 address from WORLD1 to WORLD0"]
pub type CORE_0_ENTRY_7_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_0_ENTRY_7_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Core_0 Entry 7 address from WORLD1 to WORLD0"]
    #[inline(always)]
    pub fn core_0_entry_7_addr(&mut self) -> CORE_0_ENTRY_7_ADDR_W<0> {
        CORE_0_ENTRY_7_ADDR_W::new(self)
    }
