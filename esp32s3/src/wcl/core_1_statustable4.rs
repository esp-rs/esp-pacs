...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE4")
            .field("core_1_from_world_4", &self.core_1_from_world_4().bit())
            .field("core_1_from_entry_4", &self.core_1_from_entry_4().bits())
            .field("core_1_current_4", &self.core_1_current_4().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
