...
pub type CORE_1_FROM_WORLD_9_R = crate::BitReader<bool>;
#[doc = "Field `CORE_1_FROM_WORLD_9` writer - This bit is used to confirm world before enter entry 9"]
pub type CORE_1_FROM_WORLD_9_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE_1_STATUSTABLE9_SPEC, bool, O>;
#[doc = "Field `CORE_1_FROM_ENTRY_9` reader - This filed is used to confirm in which entry before enter entry 9"]
pub type CORE_1_FROM_ENTRY_9_R = crate::FieldReader<u8, u8>;
