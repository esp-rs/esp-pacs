///Register `Core_1_STATUSTABLE9` reader
pub type R = crate::R<CORE_1_STATUSTABLE9_SPEC>;
///Register `Core_1_STATUSTABLE9` writer
pub type W = crate::W<CORE_1_STATUSTABLE9_SPEC>;
///Field `CORE_1_FROM_WORLD_9` reader - This bit is used to confirm world before enter entry 9
pub type CORE_1_FROM_WORLD_9_R = crate::BitReader;
///Field `CORE_1_FROM_WORLD_9` writer - This bit is used to confirm world before enter entry 9
pub type CORE_1_FROM_WORLD_9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_FROM_ENTRY_9` reader - This filed is used to confirm in which entry before enter entry 9
pub type CORE_1_FROM_ENTRY_9_R = crate::FieldReader;
///Field `CORE_1_FROM_ENTRY_9` writer - This filed is used to confirm in which entry before enter entry 9
pub type CORE_1_FROM_ENTRY_9_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_1_CURRENT_9` reader - This bit is used to confirm whether the current state is in entry 9
pub type CORE_1_CURRENT_9_R = crate::BitReader;
///Field `CORE_1_CURRENT_9` writer - This bit is used to confirm whether the current state is in entry 9
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE9")
            .field("core_1_from_world_9", &self.core_1_from_world_9())
            .field("core_1_from_entry_9", &self.core_1_from_entry_9())
...
///`read()` method returns [`core_1_statustable9::R`](R) reader structure
impl crate::Readable for CORE_1_STATUSTABLE9_SPEC {}
///`write(|w| ..)` method takes [`core_1_statustable9::W`](W) writer structure
