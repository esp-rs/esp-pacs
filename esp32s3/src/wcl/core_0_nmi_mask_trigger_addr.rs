///Register `Core_0_NMI_MASK_TRIGGER_ADDR` reader
pub type R = crate::R<CORE_0_NMI_MASK_TRIGGER_ADDR_SPEC>;
///Register `Core_0_NMI_MASK_TRIGGER_ADDR` writer
pub type W = crate::W<CORE_0_NMI_MASK_TRIGGER_ADDR_SPEC>;
///Field `CORE_0_NMI_MASK_TRIGGER_ADDR` reader - this field to used to set trigger address, when CPU executes to this address,NMI mask automatically fails
pub type CORE_0_NMI_MASK_TRIGGER_ADDR_R = crate::FieldReader<u32>;
///Field `CORE_0_NMI_MASK_TRIGGER_ADDR` writer - this field to used to set trigger address, when CPU executes to this address,NMI mask automatically fails
pub type CORE_0_NMI_MASK_TRIGGER_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - this field to used to set trigger address, when CPU executes to this address,NMI mask automatically fails
    #[inline(always)]
...
///`read()` method returns [`core_0_nmi_mask_trigger_addr::R`](R) reader structure
impl crate::Readable for CORE_0_NMI_MASK_TRIGGER_ADDR_SPEC {}
///`write(|w| ..)` method takes [`core_0_nmi_mask_trigger_addr::W`](W) writer structure
