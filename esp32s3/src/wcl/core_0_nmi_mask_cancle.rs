///Register `Core_0_NMI_MASK_CANCLE` writer
pub type W = crate::W<CORE_0_NMI_MASK_CANCLE_SPEC>;
///Field `CORE_0_NMI_MASK_CANCEL` writer - this field is used to cancel NMI mask disable function.
...
impl W {
    ///Bits 0:31 - this field is used to cancel NMI mask disable function.
    #[inline(always)]
    #[must_use]
...
You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_0_nmi_mask_cancle::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_NMI_MASK_CANCLE_SPEC;
impl crate::RegisterSpec for CORE_0_NMI_MASK_CANCLE_SPEC {
    type Ux = u32;
}
///`write(|w| ..)` method takes [`core_0_nmi_mask_cancle::W`](W) writer structure
