...
pub struct R(crate::R<CORE_1_NMI_MASK_TRIGGER_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_NMI_MASK_TRIGGER_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_NMI_MASK_TRIGGER_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_NMI_MASK_TRIGGER_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Core_1_NMI_MASK_TRIGGER_ADDR` writer"]
pub struct W(crate::W<CORE_1_NMI_MASK_TRIGGER_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_NMI_MASK_TRIGGER_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_NMI_MASK_TRIGGER_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_NMI_MASK_TRIGGER_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CORE_1_NMI_MASK_TRIGGER_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_NMI_MASK_TRIGGER_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_nmi_mask_trigger_addr(&mut self) -> CORE_1_NMI_MASK_TRIGGER_ADDR_W<0> {
        CORE_1_NMI_MASK_TRIGGER_ADDR_W::new(self)
    }
...
#[doc = "Core_1 NMI mask trigger addr register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_nmi_mask_trigger_addr](index.html) module"]
