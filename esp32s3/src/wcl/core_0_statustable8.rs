...
pub type CORE_0_FROM_WORLD_8_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE8_SPEC, O>;
...
pub type CORE_0_FROM_ENTRY_8_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_STATUSTABLE8_SPEC, 4, O>;
...
pub type CORE_0_CURRENT_8_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE8_SPEC, O>;
impl R {
