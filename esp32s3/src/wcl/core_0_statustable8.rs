///Register `Core_0_STATUSTABLE8` reader
pub type R = crate::R<CORE_0_STATUSTABLE8_SPEC>;
///Register `Core_0_STATUSTABLE8` writer
pub type W = crate::W<CORE_0_STATUSTABLE8_SPEC>;
///Field `CORE_0_FROM_WORLD_8` reader - This bit is used to confirm world before enter entry 8
pub type CORE_0_FROM_WORLD_8_R = crate::BitReader;
///Field `CORE_0_FROM_WORLD_8` writer - This bit is used to confirm world before enter entry 8
pub type CORE_0_FROM_WORLD_8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_FROM_ENTRY_8` reader - This filed is used to confirm in which entry before enter entry 8
pub type CORE_0_FROM_ENTRY_8_R = crate::FieldReader;
///Field `CORE_0_FROM_ENTRY_8` writer - This filed is used to confirm in which entry before enter entry 8
pub type CORE_0_FROM_ENTRY_8_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_0_CURRENT_8` reader - This bit is used to confirm whether the current state is in entry 8
pub type CORE_0_CURRENT_8_R = crate::BitReader;
///Field `CORE_0_CURRENT_8` writer - This bit is used to confirm whether the current state is in entry 8
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE8")
            .field("core_0_from_world_8", &self.core_0_from_world_8())
            .field("core_0_from_entry_8", &self.core_0_from_entry_8())
            .field("core_0_current_8", &self.core_0_current_8())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_0_statustable8::R`](R) reader structure
impl crate::Readable for CORE_0_STATUSTABLE8_SPEC {}
///`write(|w| ..)` method takes [`core_0_statustable8::W`](W) writer structure
