...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE8")
            .field("core_0_from_world_8", &self.core_0_from_world_8().bit())
            .field("core_0_from_entry_8", &self.core_0_from_entry_8().bits())
            .field("core_0_current_8", &self.core_0_current_8().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
