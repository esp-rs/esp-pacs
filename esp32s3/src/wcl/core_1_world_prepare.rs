///Register `Core_1_World_PREPARE` reader
pub type R = crate::R<CORE_1_WORLD_PREPARE_SPEC>;
///Register `Core_1_World_PREPARE` writer
pub type W = crate::W<CORE_1_WORLD_PREPARE_SPEC>;
///Field `CORE_1_WORLD_PREPARE` reader - This field to used to set world to enter,2'b01 means WORLD0, 2'b10 means WORLD1
pub type CORE_1_WORLD_PREPARE_R = crate::FieldReader;
///Field `CORE_1_WORLD_PREPARE` writer - This field to used to set world to enter,2'b01 means WORLD0, 2'b10 means WORLD1
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_World_PREPARE")
            .field("core_1_world_prepare", &self.core_1_world_prepare())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_1_world_prepare::R`](R) reader structure
impl crate::Readable for CORE_1_WORLD_PREPARE_SPEC {}
///`write(|w| ..)` method takes [`core_1_world_prepare::W`](W) writer structure
