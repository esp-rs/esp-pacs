...
pub type CORE_1_WORLD_IRAM0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_WORLD_IRAM0_SPEC, u8, u8, 2, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:1 - this field is used to read current world of Iram0 bus"]
    #[inline(always)]
    pub fn core_1_world_iram0(&mut self) -> CORE_1_WORLD_IRAM0_W<0> {
