...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE3")
            .field("core_0_from_world_3", &self.core_0_from_world_3().bit())
            .field("core_0_from_entry_3", &self.core_0_from_entry_3().bits())
            .field("core_0_current_3", &self.core_0_current_3().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
