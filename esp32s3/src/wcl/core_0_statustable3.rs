///Register `Core_0_STATUSTABLE3` reader
pub type R = crate::R<CORE_0_STATUSTABLE3_SPEC>;
///Register `Core_0_STATUSTABLE3` writer
pub type W = crate::W<CORE_0_STATUSTABLE3_SPEC>;
///Field `CORE_0_FROM_WORLD_3` reader - This bit is used to confirm world before enter entry 3
pub type CORE_0_FROM_WORLD_3_R = crate::BitReader;
///Field `CORE_0_FROM_WORLD_3` writer - This bit is used to confirm world before enter entry 3
pub type CORE_0_FROM_WORLD_3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_FROM_ENTRY_3` reader - This filed is used to confirm in which entry before enter entry 3
pub type CORE_0_FROM_ENTRY_3_R = crate::FieldReader;
///Field `CORE_0_FROM_ENTRY_3` writer - This filed is used to confirm in which entry before enter entry 3
pub type CORE_0_FROM_ENTRY_3_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_0_CURRENT_3` reader - This bit is used to confirm whether the current state is in entry 3
pub type CORE_0_CURRENT_3_R = crate::BitReader;
///Field `CORE_0_CURRENT_3` writer - This bit is used to confirm whether the current state is in entry 3
...
///`read()` method returns [`core_0_statustable3::R`](R) reader structure
impl crate::Readable for CORE_0_STATUSTABLE3_SPEC {}
///`write(|w| ..)` method takes [`core_0_statustable3::W`](W) writer structure
