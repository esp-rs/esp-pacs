...
pub type CORE_0_WORLD_CANCEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_world_cancel(&mut self) -> CORE_0_WORLD_CANCEL_W<CORE_0_WORLD_CANCEL_SPEC, 0> {
