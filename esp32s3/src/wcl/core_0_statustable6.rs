...
pub type CORE_0_FROM_WORLD_6_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE6_SPEC, O>;
...
pub type CORE_0_FROM_ENTRY_6_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_STATUSTABLE6_SPEC, 4, O>;
...
pub type CORE_0_CURRENT_6_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE6_SPEC, O>;
impl R {
