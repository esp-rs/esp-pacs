...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE6")
            .field("core_0_from_world_6", &self.core_0_from_world_6().bit())
            .field("core_0_from_entry_6", &self.core_0_from_entry_6().bits())
            .field("core_0_current_6", &self.core_0_current_6().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
