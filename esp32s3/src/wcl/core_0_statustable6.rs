///Register `Core_0_STATUSTABLE6` reader
pub type R = crate::R<CORE_0_STATUSTABLE6_SPEC>;
///Register `Core_0_STATUSTABLE6` writer
pub type W = crate::W<CORE_0_STATUSTABLE6_SPEC>;
///Field `CORE_0_FROM_WORLD_6` reader - This bit is used to confirm world before enter entry 6
pub type CORE_0_FROM_WORLD_6_R = crate::BitReader;
///Field `CORE_0_FROM_WORLD_6` writer - This bit is used to confirm world before enter entry 6
pub type CORE_0_FROM_WORLD_6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_FROM_ENTRY_6` reader - This filed is used to confirm in which entry before enter entry 6
pub type CORE_0_FROM_ENTRY_6_R = crate::FieldReader;
///Field `CORE_0_FROM_ENTRY_6` writer - This filed is used to confirm in which entry before enter entry 6
pub type CORE_0_FROM_ENTRY_6_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_0_CURRENT_6` reader - This bit is used to confirm whether the current state is in entry 6
pub type CORE_0_CURRENT_6_R = crate::BitReader;
///Field `CORE_0_CURRENT_6` writer - This bit is used to confirm whether the current state is in entry 6
...
///`read()` method returns [`core_0_statustable6::R`](R) reader structure
impl crate::Readable for CORE_0_STATUSTABLE6_SPEC {}
///`write(|w| ..)` method takes [`core_0_statustable6::W`](W) writer structure
