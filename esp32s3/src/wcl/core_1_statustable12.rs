///Register `Core_1_STATUSTABLE12` reader
pub type R = crate::R<CORE_1_STATUSTABLE12_SPEC>;
///Register `Core_1_STATUSTABLE12` writer
pub type W = crate::W<CORE_1_STATUSTABLE12_SPEC>;
///Field `CORE_1_FROM_WORLD_12` reader - This bit is used to confirm world before enter entry 12
pub type CORE_1_FROM_WORLD_12_R = crate::BitReader;
///Field `CORE_1_FROM_WORLD_12` writer - This bit is used to confirm world before enter entry 12
pub type CORE_1_FROM_WORLD_12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_FROM_ENTRY_12` reader - This filed is used to confirm in which entry before enter entry 12
pub type CORE_1_FROM_ENTRY_12_R = crate::FieldReader;
///Field `CORE_1_FROM_ENTRY_12` writer - This filed is used to confirm in which entry before enter entry 12
pub type CORE_1_FROM_ENTRY_12_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_1_CURRENT_12` reader - This bit is used to confirm whether the current state is in entry 12
pub type CORE_1_CURRENT_12_R = crate::BitReader;
///Field `CORE_1_CURRENT_12` writer - This bit is used to confirm whether the current state is in entry 12
...
///`read()` method returns [`core_1_statustable12::R`](R) reader structure
impl crate::Readable for CORE_1_STATUSTABLE12_SPEC {}
///`write(|w| ..)` method takes [`core_1_statustable12::W`](W) writer structure
