///Register `Core_1_MESSAGE_ADDR` reader
pub type R = crate::R<CORE_1_MESSAGE_ADDR_SPEC>;
///Register `Core_1_MESSAGE_ADDR` writer
pub type W = crate::W<CORE_1_MESSAGE_ADDR_SPEC>;
///Field `CORE_1_MESSAGE_ADDR` reader - This field is used to set address that need to write when enter WORLD0
pub type CORE_1_MESSAGE_ADDR_R = crate::FieldReader<u32>;
///Field `CORE_1_MESSAGE_ADDR` writer - This field is used to set address that need to write when enter WORLD0
...
///`read()` method returns [`core_1_message_addr::R`](R) reader structure
impl crate::Readable for CORE_1_MESSAGE_ADDR_SPEC {}
///`write(|w| ..)` method takes [`core_1_message_addr::W`](W) writer structure
