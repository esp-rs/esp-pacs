...
pub type CORE_1_MESSAGE_ADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_MESSAGE_ADDR")
            .field(
                "core_1_message_addr",
                &format_args!("{}", self.core_1_message_addr().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_message_addr(&mut self) -> CORE_1_MESSAGE_ADDR_W<CORE_1_MESSAGE_ADDR_SPEC, 0> {
        CORE_1_MESSAGE_ADDR_W::new(self)
    }
