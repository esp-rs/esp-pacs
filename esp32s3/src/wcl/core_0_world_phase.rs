...
pub struct R(crate::R<CORE_0_WORLD_PHASE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_0_WORLD_PHASE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_0_WORLD_PHASE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_0_WORLD_PHASE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `CORE_0_WORLD_PHASE` reader - This bit indicates whether is preparing to switch to WORLD1, 1 means value."]
pub type CORE_0_WORLD_PHASE_R = crate::BitReader<bool>;
impl R {
