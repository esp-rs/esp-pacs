///Register `Core_0_World_Phase` reader
pub type R = crate::R<CORE_0_WORLD_PHASE_SPEC>;
///Field `CORE_0_WORLD_PHASE` reader - This bit indicates whether is preparing to switch to WORLD1, 1 means value.
...
///`read()` method returns [`core_0_world_phase::R`](R) reader structure
