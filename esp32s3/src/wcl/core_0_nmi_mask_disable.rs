///Register `Core_0_NMI_MASK_DISABLE` writer
pub type W = crate::W<CORE_0_NMI_MASK_DISABLE_SPEC>;
///Field `CORE_0_NMI_MASK_DISABLE` writer - this field is used to disable NMI mask,it will not take effect immediately,only when the CPU executes to the trigger address will it start to cancel NMI mask
...
///`write(|w| ..)` method takes [`core_0_nmi_mask_disable::W`](W) writer structure
