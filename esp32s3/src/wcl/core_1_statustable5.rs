///Register `Core_1_STATUSTABLE5` reader
pub type R = crate::R<CORE_1_STATUSTABLE5_SPEC>;
///Register `Core_1_STATUSTABLE5` writer
pub type W = crate::W<CORE_1_STATUSTABLE5_SPEC>;
///Field `CORE_1_FROM_WORLD_5` reader - This bit is used to confirm world before enter entry 5
pub type CORE_1_FROM_WORLD_5_R = crate::BitReader;
///Field `CORE_1_FROM_WORLD_5` writer - This bit is used to confirm world before enter entry 5
pub type CORE_1_FROM_WORLD_5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_FROM_ENTRY_5` reader - This filed is used to confirm in which entry before enter entry 5
pub type CORE_1_FROM_ENTRY_5_R = crate::FieldReader;
///Field `CORE_1_FROM_ENTRY_5` writer - This filed is used to confirm in which entry before enter entry 5
pub type CORE_1_FROM_ENTRY_5_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_1_CURRENT_5` reader - This bit is used to confirm whether the current state is in entry 5
pub type CORE_1_CURRENT_5_R = crate::BitReader;
///Field `CORE_1_CURRENT_5` writer - This bit is used to confirm whether the current state is in entry 5
...
///`read()` method returns [`core_1_statustable5::R`](R) reader structure
impl crate::Readable for CORE_1_STATUSTABLE5_SPEC {}
///`write(|w| ..)` method takes [`core_1_statustable5::W`](W) writer structure
