...
pub type CORE_0_FROM_WORLD_4_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE4_SPEC, O>;
...
pub type CORE_0_FROM_ENTRY_4_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_STATUSTABLE4_SPEC, 4, O>;
...
pub type CORE_0_CURRENT_4_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE4_SPEC, O>;
impl R {
