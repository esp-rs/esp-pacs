...
pub type CORE_0_FROM_WORLD_4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_0_FROM_ENTRY_4_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type CORE_0_CURRENT_4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE4")
            .field(
                "core_0_from_world_4",
                &format_args!("{}", self.core_0_from_world_4().bit()),
            )
            .field(
                "core_0_from_entry_4",
                &format_args!("{}", self.core_0_from_entry_4().bits()),
            )
            .field(
                "core_0_current_4",
                &format_args!("{}", self.core_0_current_4().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_0_STATUSTABLE4_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_world_4(&mut self) -> CORE_0_FROM_WORLD_4_W<CORE_0_STATUSTABLE4_SPEC, 0> {
        CORE_0_FROM_WORLD_4_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 4"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_entry_4(&mut self) -> CORE_0_FROM_ENTRY_4_W<CORE_0_STATUSTABLE4_SPEC, 1> {
        CORE_0_FROM_ENTRY_4_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 4"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_current_4(&mut self) -> CORE_0_CURRENT_4_W<CORE_0_STATUSTABLE4_SPEC, 5> {
