///Register `Core_0_STATUSTABLE4` reader
pub type R = crate::R<CORE_0_STATUSTABLE4_SPEC>;
///Register `Core_0_STATUSTABLE4` writer
pub type W = crate::W<CORE_0_STATUSTABLE4_SPEC>;
///Field `CORE_0_FROM_WORLD_4` reader - This bit is used to confirm world before enter entry 4
pub type CORE_0_FROM_WORLD_4_R = crate::BitReader;
///Field `CORE_0_FROM_WORLD_4` writer - This bit is used to confirm world before enter entry 4
pub type CORE_0_FROM_WORLD_4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_FROM_ENTRY_4` reader - This filed is used to confirm in which entry before enter entry 4
pub type CORE_0_FROM_ENTRY_4_R = crate::FieldReader;
///Field `CORE_0_FROM_ENTRY_4` writer - This filed is used to confirm in which entry before enter entry 4
pub type CORE_0_FROM_ENTRY_4_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_0_CURRENT_4` reader - This bit is used to confirm whether the current state is in entry 4
pub type CORE_0_CURRENT_4_R = crate::BitReader;
///Field `CORE_0_CURRENT_4` writer - This bit is used to confirm whether the current state is in entry 4
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_0_statustable4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_0_statustable4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_STATUSTABLE4_SPEC;
impl crate::RegisterSpec for CORE_0_STATUSTABLE4_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_0_statustable4::R`](R) reader structure
impl crate::Readable for CORE_0_STATUSTABLE4_SPEC {}
///`write(|w| ..)` method takes [`core_0_statustable4::W`](W) writer structure
