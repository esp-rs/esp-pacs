...
pub type CORE_1_ENTRY_CHECK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_ENTRY_CHECK_SPEC, u16, u16, 13, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_entry_check(&mut self) -> CORE_1_ENTRY_CHECK_W<1> {
