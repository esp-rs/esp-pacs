...
pub type CORE_1_MESSAGE_MAX_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_MESSAGE_MAX")
            .field(
                "core_1_message_max",
                &format_args!("{}", self.core_1_message_max().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_1_MESSAGE_MAX_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_message_max(&mut self) -> CORE_1_MESSAGE_MAX_W<CORE_1_MESSAGE_MAX_SPEC, 0> {
