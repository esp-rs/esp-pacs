///Register `Core_1_NMI_MASK_CANCLE` writer
pub type W = crate::W<CORE_1_NMI_MASK_CANCLE_SPEC>;
///Field `CORE_1_NMI_MASK_CANCEL` writer - this field is used to cancel NMI mask disable function.
...
///`write(|w| ..)` method takes [`core_1_nmi_mask_cancle::W`](W) writer structure
