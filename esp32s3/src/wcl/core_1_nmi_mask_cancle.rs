...
pub struct W(crate::W<CORE_1_NMI_MASK_CANCLE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_NMI_MASK_CANCLE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<CORE_1_NMI_MASK_CANCLE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_NMI_MASK_CANCLE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CORE_1_NMI_MASK_CANCEL` writer - this field is used to cancel NMI mask disable function."]
pub type CORE_1_NMI_MASK_CANCEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_NMI_MASK_CANCLE_SPEC, u32, u32, 32, O>;
impl W {
    #[doc = "Bits 0:31 - this field is used to cancel NMI mask disable function."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_nmi_mask_cancel(&mut self) -> CORE_1_NMI_MASK_CANCEL_W<0> {
...
#[doc = "Core_1 NMI mask disable register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_1_nmi_mask_cancle](index.html) module"]
