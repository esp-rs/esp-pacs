...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE2")
            .field("core_0_from_world_2", &self.core_0_from_world_2().bit())
            .field("core_0_from_entry_2", &self.core_0_from_entry_2().bits())
            .field("core_0_current_2", &self.core_0_current_2().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
