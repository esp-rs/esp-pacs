///Register `Core_0_STATUSTABLE2` reader
pub type R = crate::R<CORE_0_STATUSTABLE2_SPEC>;
///Register `Core_0_STATUSTABLE2` writer
pub type W = crate::W<CORE_0_STATUSTABLE2_SPEC>;
///Field `CORE_0_FROM_WORLD_2` reader - This bit is used to confirm world before enter entry 2
pub type CORE_0_FROM_WORLD_2_R = crate::BitReader;
///Field `CORE_0_FROM_WORLD_2` writer - This bit is used to confirm world before enter entry 2
pub type CORE_0_FROM_WORLD_2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_FROM_ENTRY_2` reader - This filed is used to confirm in which entry before enter entry 2
pub type CORE_0_FROM_ENTRY_2_R = crate::FieldReader;
///Field `CORE_0_FROM_ENTRY_2` writer - This filed is used to confirm in which entry before enter entry 2
pub type CORE_0_FROM_ENTRY_2_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_0_CURRENT_2` reader - This bit is used to confirm whether the current state is in entry 2
pub type CORE_0_CURRENT_2_R = crate::BitReader;
///Field `CORE_0_CURRENT_2` writer - This bit is used to confirm whether the current state is in entry 2
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE2")
            .field("core_0_from_world_2", &self.core_0_from_world_2())
            .field("core_0_from_entry_2", &self.core_0_from_entry_2())
            .field("core_0_current_2", &self.core_0_current_2())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_0_statustable2::R`](R) reader structure
impl crate::Readable for CORE_0_STATUSTABLE2_SPEC {}
///`write(|w| ..)` method takes [`core_0_statustable2::W`](W) writer structure
