...
pub type CORE_0_ENTRY_9_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_0_ENTRY_9_ADDR` writer - Core_0 Entry 9 address from WORLD1 to WORLD0"]
pub type CORE_0_ENTRY_9_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_ENTRY_9_ADDR_SPEC, 32, O, u32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_entry_9_addr(&mut self) -> CORE_0_ENTRY_9_ADDR_W<0> {
