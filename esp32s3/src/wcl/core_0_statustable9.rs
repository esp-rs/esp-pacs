...
pub struct R(crate::R<CORE_0_STATUSTABLE9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_0_STATUSTABLE9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_0_STATUSTABLE9_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_0_STATUSTABLE9_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Core_0_STATUSTABLE9` writer"]
pub struct W(crate::W<CORE_0_STATUSTABLE9_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_0_STATUSTABLE9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_world_9(&mut self) -> CORE_0_FROM_WORLD_9_W<0> {
        CORE_0_FROM_WORLD_9_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 9"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_entry_9(&mut self) -> CORE_0_FROM_ENTRY_9_W<1> {
        CORE_0_FROM_ENTRY_9_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 9"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_current_9(&mut self) -> CORE_0_CURRENT_9_W<5> {
        CORE_0_CURRENT_9_W::new(self)
    }
