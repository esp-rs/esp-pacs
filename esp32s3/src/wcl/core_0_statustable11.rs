...
pub type CORE_0_FROM_WORLD_11_R = crate::BitReader<bool>;
...
pub type CORE_0_FROM_WORLD_11_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE_0_STATUSTABLE11_SPEC, bool, O>;
#[doc = "Field `CORE_0_FROM_ENTRY_11` reader - This filed is used to confirm in which entry before enter entry 11"]
pub type CORE_0_FROM_ENTRY_11_R = crate::FieldReader<u8, u8>;
