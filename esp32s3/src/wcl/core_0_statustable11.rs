...
pub type CORE_0_FROM_WORLD_11_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_0_FROM_ENTRY_11_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type CORE_0_CURRENT_11_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_world_11(&mut self) -> CORE_0_FROM_WORLD_11_W<CORE_0_STATUSTABLE11_SPEC, 0> {
        CORE_0_FROM_WORLD_11_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 11"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_entry_11(&mut self) -> CORE_0_FROM_ENTRY_11_W<CORE_0_STATUSTABLE11_SPEC, 1> {
        CORE_0_FROM_ENTRY_11_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 11"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_current_11(&mut self) -> CORE_0_CURRENT_11_W<CORE_0_STATUSTABLE11_SPEC, 5> {
