...
pub type CORE_1_FROM_WORLD_13_R = crate::BitReader<bool>;
...
pub type CORE_1_FROM_WORLD_13_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE_1_STATUSTABLE13_SPEC, bool, O>;
#[doc = "Field `CORE_1_FROM_ENTRY_13` reader - This filed is used to confirm in which entry before enter entry 13"]
pub type CORE_1_FROM_ENTRY_13_R = crate::FieldReader<u8, u8>;
