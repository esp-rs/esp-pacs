...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE13")
            .field("core_1_from_world_13", &self.core_1_from_world_13().bit())
            .field("core_1_from_entry_13", &self.core_1_from_entry_13().bits())
            .field("core_1_current_13", &self.core_1_current_13().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
