///Register `Core_0_World_TRIGGER_ADDR` reader
pub type R = crate::R<CORE_0_WORLD_TRIGGER_ADDR_SPEC>;
///Register `Core_0_World_TRIGGER_ADDR` writer
pub type W = crate::W<CORE_0_WORLD_TRIGGER_ADDR_SPEC>;
///Field `CORE_0_WORLD_TRIGGER_ADDR` reader - This field is used to configure the entry address from WORLD0 to WORLD1,when the CPU executes to this address,switch to WORLD1
pub type CORE_0_WORLD_TRIGGER_ADDR_R = crate::FieldReader<u32>;
///Field `CORE_0_WORLD_TRIGGER_ADDR` writer - This field is used to configure the entry address from WORLD0 to WORLD1,when the CPU executes to this address,switch to WORLD1
...
///`read()` method returns [`core_0_world_trigger_addr::R`](R) reader structure
impl crate::Readable for CORE_0_WORLD_TRIGGER_ADDR_SPEC {}
///`write(|w| ..)` method takes [`core_0_world_trigger_addr::W`](W) writer structure
