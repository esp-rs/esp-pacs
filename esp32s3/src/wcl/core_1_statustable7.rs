...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE7")
            .field("core_1_from_world_7", &self.core_1_from_world_7().bit())
            .field("core_1_from_entry_7", &self.core_1_from_entry_7().bits())
            .field("core_1_current_7", &self.core_1_current_7().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
