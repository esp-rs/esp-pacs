...
pub struct R(crate::R<CORE_1_STATUSTABLE7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_STATUSTABLE7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_STATUSTABLE7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_STATUSTABLE7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Core_1_STATUSTABLE7` writer"]
pub struct W(crate::W<CORE_1_STATUSTABLE7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_STATUSTABLE7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_STATUSTABLE7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_STATUSTABLE7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CORE_1_FROM_WORLD_7_W<'a, const O: u8> = crate::BitWriter<'a, CORE_1_STATUSTABLE7_SPEC, O>;
...
pub type CORE_1_FROM_ENTRY_7_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_1_STATUSTABLE7_SPEC, 4, O>;
...
pub type CORE_1_CURRENT_7_W<'a, const O: u8> = crate::BitWriter<'a, CORE_1_STATUSTABLE7_SPEC, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE7")
            .field(
                "core_1_from_world_7",
                &format_args!("{}", self.core_1_from_world_7().bit()),
            )
            .field(
                "core_1_from_entry_7",
                &format_args!("{}", self.core_1_from_entry_7().bits()),
            )
            .field(
                "core_1_current_7",
                &format_args!("{}", self.core_1_current_7().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_1_STATUSTABLE7_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_world_7(&mut self) -> CORE_1_FROM_WORLD_7_W<0> {
        CORE_1_FROM_WORLD_7_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 7"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_entry_7(&mut self) -> CORE_1_FROM_ENTRY_7_W<1> {
        CORE_1_FROM_ENTRY_7_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 7"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_current_7(&mut self) -> CORE_1_CURRENT_7_W<5> {
        CORE_1_CURRENT_7_W::new(self)
    }
