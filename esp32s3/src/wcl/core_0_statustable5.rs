...
pub type CORE_0_FROM_WORLD_5_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE5_SPEC, O>;
...
pub type CORE_0_FROM_ENTRY_5_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_STATUSTABLE5_SPEC, 4, O>;
...
pub type CORE_0_CURRENT_5_W<'a, const O: u8> = crate::BitWriter<'a, CORE_0_STATUSTABLE5_SPEC, O>;
impl R {
