///Register `Core_0_STATUSTABLE12` reader
pub type R = crate::R<CORE_0_STATUSTABLE12_SPEC>;
///Register `Core_0_STATUSTABLE12` writer
pub type W = crate::W<CORE_0_STATUSTABLE12_SPEC>;
///Field `CORE_0_FROM_WORLD_12` reader - This bit is used to confirm world before enter entry 12
pub type CORE_0_FROM_WORLD_12_R = crate::BitReader;
///Field `CORE_0_FROM_WORLD_12` writer - This bit is used to confirm world before enter entry 12
pub type CORE_0_FROM_WORLD_12_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_FROM_ENTRY_12` reader - This filed is used to confirm in which entry before enter entry 12
pub type CORE_0_FROM_ENTRY_12_R = crate::FieldReader;
///Field `CORE_0_FROM_ENTRY_12` writer - This filed is used to confirm in which entry before enter entry 12
pub type CORE_0_FROM_ENTRY_12_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_0_CURRENT_12` reader - This bit is used to confirm whether the current state is in entry 12
pub type CORE_0_CURRENT_12_R = crate::BitReader;
///Field `CORE_0_CURRENT_12` writer - This bit is used to confirm whether the current state is in entry 12
pub type CORE_0_CURRENT_12_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - This bit is used to confirm world before enter entry 12
    #[inline(always)]
    pub fn core_0_from_world_12(&self) -> CORE_0_FROM_WORLD_12_R {
        CORE_0_FROM_WORLD_12_R::new((self.bits & 1) != 0)
    }
    ///Bits 1:4 - This filed is used to confirm in which entry before enter entry 12
    #[inline(always)]
    pub fn core_0_from_entry_12(&self) -> CORE_0_FROM_ENTRY_12_R {
        CORE_0_FROM_ENTRY_12_R::new(((self.bits >> 1) & 0x0f) as u8)
    }
    ///Bit 5 - This bit is used to confirm whether the current state is in entry 12
    #[inline(always)]
...
///`read()` method returns [`core_0_statustable12::R`](R) reader structure
impl crate::Readable for CORE_0_STATUSTABLE12_SPEC {}
///`write(|w| ..)` method takes [`core_0_statustable12::W`](W) writer structure
