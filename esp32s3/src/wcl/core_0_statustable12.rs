...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE12")
            .field("core_0_from_world_12", &self.core_0_from_world_12().bit())
            .field("core_0_from_entry_12", &self.core_0_from_entry_12().bits())
            .field("core_0_current_12", &self.core_0_current_12().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
