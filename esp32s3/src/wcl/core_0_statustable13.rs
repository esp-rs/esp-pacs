...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE13")
            .field("core_0_from_world_13", &self.core_0_from_world_13().bit())
            .field("core_0_from_entry_13", &self.core_0_from_entry_13().bits())
            .field("core_0_current_13", &self.core_0_current_13().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
