///Register `Core_0_ENTRY_CHECK` reader
pub type R = crate::R<CORE_0_ENTRY_CHECK_SPEC>;
///Register `Core_0_ENTRY_CHECK` writer
pub type W = crate::W<CORE_0_ENTRY_CHECK_SPEC>;
///Field `CORE_0_ENTRY_CHECK` reader - This filed is used to enable entry address check
pub type CORE_0_ENTRY_CHECK_R = crate::FieldReader<u16>;
///Field `CORE_0_ENTRY_CHECK` writer - This filed is used to enable entry address check
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_ENTRY_CHECK")
            .field("core_0_entry_check", &self.core_0_entry_check())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_0_entry_check::R`](R) reader structure
impl crate::Readable for CORE_0_ENTRY_CHECK_SPEC {}
///`write(|w| ..)` method takes [`core_0_entry_check::W`](W) writer structure
