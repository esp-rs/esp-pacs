...
pub type CORE_0_ENTRY_CHECK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 13, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_entry_check(&mut self) -> CORE_0_ENTRY_CHECK_W<CORE_0_ENTRY_CHECK_SPEC, 1> {
