///Register `Core_1_STATUSTABLE1` reader
pub type R = crate::R<CORE_1_STATUSTABLE1_SPEC>;
///Register `Core_1_STATUSTABLE1` writer
pub type W = crate::W<CORE_1_STATUSTABLE1_SPEC>;
///Field `CORE_1_FROM_WORLD_1` reader - This bit is used to confirm world before enter entry 1
pub type CORE_1_FROM_WORLD_1_R = crate::BitReader;
///Field `CORE_1_FROM_WORLD_1` writer - This bit is used to confirm world before enter entry 1
pub type CORE_1_FROM_WORLD_1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_FROM_ENTRY_1` reader - This filed is used to confirm in which entry before enter entry 1
pub type CORE_1_FROM_ENTRY_1_R = crate::FieldReader;
///Field `CORE_1_FROM_ENTRY_1` writer - This filed is used to confirm in which entry before enter entry 1
pub type CORE_1_FROM_ENTRY_1_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_1_CURRENT_1` reader - This bit is used to confirm whether the current state is in entry 1
pub type CORE_1_CURRENT_1_R = crate::BitReader;
///Field `CORE_1_CURRENT_1` writer - This bit is used to confirm whether the current state is in entry 1
...
///`read()` method returns [`core_1_statustable1::R`](R) reader structure
impl crate::Readable for CORE_1_STATUSTABLE1_SPEC {}
///`write(|w| ..)` method takes [`core_1_statustable1::W`](W) writer structure
