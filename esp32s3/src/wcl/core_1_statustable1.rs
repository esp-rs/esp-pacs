...
pub struct R(crate::R<CORE_1_STATUSTABLE1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_STATUSTABLE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_STATUSTABLE1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_STATUSTABLE1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Core_1_STATUSTABLE1` writer"]
pub struct W(crate::W<CORE_1_STATUSTABLE1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_STATUSTABLE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_STATUSTABLE1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_STATUSTABLE1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CORE_1_FROM_WORLD_1_W<'a, const O: u8> = crate::BitWriter<'a, CORE_1_STATUSTABLE1_SPEC, O>;
...
pub type CORE_1_FROM_ENTRY_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_1_STATUSTABLE1_SPEC, 4, O>;
...
pub type CORE_1_CURRENT_1_W<'a, const O: u8> = crate::BitWriter<'a, CORE_1_STATUSTABLE1_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_world_1(&mut self) -> CORE_1_FROM_WORLD_1_W<0> {
        CORE_1_FROM_WORLD_1_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 1"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_entry_1(&mut self) -> CORE_1_FROM_ENTRY_1_W<1> {
        CORE_1_FROM_ENTRY_1_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 1"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_current_1(&mut self) -> CORE_1_CURRENT_1_W<5> {
