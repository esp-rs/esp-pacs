...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE1")
            .field("core_1_from_world_1", &self.core_1_from_world_1().bit())
            .field("core_1_from_entry_1", &self.core_1_from_entry_1().bits())
            .field("core_1_current_1", &self.core_1_current_1().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
