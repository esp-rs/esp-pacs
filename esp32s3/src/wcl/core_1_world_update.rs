///Register `Core_1_World_UPDATE` writer
pub type W = crate::W<CORE_1_WORLD_UPDATE_SPEC>;
///Field `CORE_1_UPDATE` writer - This field is used to update configuration completed, can write any value,the hardware only checks the write operation of this register and does not case about its value
...
impl W {
    ///Bits 0:31 - This field is used to update configuration completed, can write any value,the hardware only checks the write operation of this register and does not case about its value
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`core_1_world_update::W`](W) writer structure
