...
pub type CORE_1_WORLD_TRIGGER_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_WORLD_TRIGGER_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_world_trigger_addr(&mut self) -> CORE_1_WORLD_TRIGGER_ADDR_W<0> {
