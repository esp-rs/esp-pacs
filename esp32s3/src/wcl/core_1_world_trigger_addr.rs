///Register `Core_1_World_TRIGGER_ADDR` reader
pub type R = crate::R<CORE_1_WORLD_TRIGGER_ADDR_SPEC>;
///Register `Core_1_World_TRIGGER_ADDR` writer
pub type W = crate::W<CORE_1_WORLD_TRIGGER_ADDR_SPEC>;
///Field `CORE_1_WORLD_TRIGGER_ADDR` reader - This field is used to configure the entry address from WORLD0 to WORLD1,when the CPU executes to this address,switch to WORLD1
pub type CORE_1_WORLD_TRIGGER_ADDR_R = crate::FieldReader<u32>;
///Field `CORE_1_WORLD_TRIGGER_ADDR` writer - This field is used to configure the entry address from WORLD0 to WORLD1,when the CPU executes to this address,switch to WORLD1
pub type CORE_1_WORLD_TRIGGER_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This field is used to configure the entry address from WORLD0 to WORLD1,when the CPU executes to this address,switch to WORLD1
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_1_world_trigger_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_1_world_trigger_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_1_WORLD_TRIGGER_ADDR_SPEC;
impl crate::RegisterSpec for CORE_1_WORLD_TRIGGER_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_1_world_trigger_addr::R`](R) reader structure
impl crate::Readable for CORE_1_WORLD_TRIGGER_ADDR_SPEC {}
///`write(|w| ..)` method takes [`core_1_world_trigger_addr::W`](W) writer structure
