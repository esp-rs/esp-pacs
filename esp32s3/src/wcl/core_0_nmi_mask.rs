///Register `Core_0_NMI_MASK` reader
pub type R = crate::R<CORE_0_NMI_MASK_SPEC>;
///Register `Core_0_NMI_MASK` writer
pub type W = crate::W<CORE_0_NMI_MASK_SPEC>;
///Field `CORE_0_NMI_MASK` reader - this bit is used to mask NMI interrupt,it can directly mask NMI interrupt
pub type CORE_0_NMI_MASK_R = crate::BitReader;
///Field `CORE_0_NMI_MASK` writer - this bit is used to mask NMI interrupt,it can directly mask NMI interrupt
...
///`read()` method returns [`core_0_nmi_mask::R`](R) reader structure
impl crate::Readable for CORE_0_NMI_MASK_SPEC {}
///`write(|w| ..)` method takes [`core_0_nmi_mask::W`](W) writer structure
