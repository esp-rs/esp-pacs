///Register `Core_0_World_UPDATE` writer
pub type W = crate::W<CORE_0_WORLD_UPDATE_SPEC>;
///Field `CORE_0_UPDATE` writer - This field is used to update configuration completed, can write any value,the hardware only checks the write operation of this register and does not case about its value
...
///`write(|w| ..)` method takes [`core_0_world_update::W`](W) writer structure
