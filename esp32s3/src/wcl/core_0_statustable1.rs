...
pub type CORE_0_FROM_WORLD_1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_0_FROM_ENTRY_1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type CORE_0_CURRENT_1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_0_STATUSTABLE1_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_world_1(&mut self) -> CORE_0_FROM_WORLD_1_W<CORE_0_STATUSTABLE1_SPEC, 0> {
        CORE_0_FROM_WORLD_1_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 1"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_entry_1(&mut self) -> CORE_0_FROM_ENTRY_1_W<CORE_0_STATUSTABLE1_SPEC, 1> {
        CORE_0_FROM_ENTRY_1_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 1"]
    #[inline(always)]
    #[must_use]
    pub fn core_0_current_1(&mut self) -> CORE_0_CURRENT_1_W<CORE_0_STATUSTABLE1_SPEC, 5> {
