...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_STATUSTABLE1")
            .field("core_0_from_world_1", &self.core_0_from_world_1().bit())
            .field("core_0_from_entry_1", &self.core_0_from_entry_1().bits())
            .field("core_0_current_1", &self.core_0_current_1().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
