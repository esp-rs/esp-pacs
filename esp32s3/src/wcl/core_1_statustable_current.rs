///Register `Core_1_STATUSTABLE_CURRENT` reader
pub type R = crate::R<CORE_1_STATUSTABLE_CURRENT_SPEC>;
///Register `Core_1_STATUSTABLE_CURRENT` writer
pub type W = crate::W<CORE_1_STATUSTABLE_CURRENT_SPEC>;
///Field `CORE_1_STATUSTABLE_CURRENT` reader - This field is used to quickly read and rewrite the current field of all STATUSTABLE registers,for example,bit 1 represents the current field of STATUSTABLE1
pub type CORE_1_STATUSTABLE_CURRENT_R = crate::FieldReader<u16>;
///Field `CORE_1_STATUSTABLE_CURRENT` writer - This field is used to quickly read and rewrite the current field of all STATUSTABLE registers,for example,bit 1 represents the current field of STATUSTABLE1
...
///`read()` method returns [`core_1_statustable_current::R`](R) reader structure
impl crate::Readable for CORE_1_STATUSTABLE_CURRENT_SPEC {}
///`write(|w| ..)` method takes [`core_1_statustable_current::W`](W) writer structure
