...
pub struct R(crate::R<CORE_1_STATUSTABLE11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_STATUSTABLE11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_STATUSTABLE11_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_STATUSTABLE11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Core_1_STATUSTABLE11` writer"]
pub struct W(crate::W<CORE_1_STATUSTABLE11_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_STATUSTABLE11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_STATUSTABLE11_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_STATUSTABLE11_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_world_11(&mut self) -> CORE_1_FROM_WORLD_11_W<0> {
        CORE_1_FROM_WORLD_11_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 11"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_entry_11(&mut self) -> CORE_1_FROM_ENTRY_11_W<1> {
        CORE_1_FROM_ENTRY_11_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 11"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_current_11(&mut self) -> CORE_1_CURRENT_11_W<5> {
