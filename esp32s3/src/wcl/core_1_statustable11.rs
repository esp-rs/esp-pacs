///Register `Core_1_STATUSTABLE11` reader
pub type R = crate::R<CORE_1_STATUSTABLE11_SPEC>;
///Register `Core_1_STATUSTABLE11` writer
pub type W = crate::W<CORE_1_STATUSTABLE11_SPEC>;
///Field `CORE_1_FROM_WORLD_11` reader - This bit is used to confirm world before enter entry 11
pub type CORE_1_FROM_WORLD_11_R = crate::BitReader;
///Field `CORE_1_FROM_WORLD_11` writer - This bit is used to confirm world before enter entry 11
pub type CORE_1_FROM_WORLD_11_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_FROM_ENTRY_11` reader - This filed is used to confirm in which entry before enter entry 11
pub type CORE_1_FROM_ENTRY_11_R = crate::FieldReader;
///Field `CORE_1_FROM_ENTRY_11` writer - This filed is used to confirm in which entry before enter entry 11
pub type CORE_1_FROM_ENTRY_11_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_1_CURRENT_11` reader - This bit is used to confirm whether the current state is in entry 11
pub type CORE_1_CURRENT_11_R = crate::BitReader;
///Field `CORE_1_CURRENT_11` writer - This bit is used to confirm whether the current state is in entry 11
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE11")
            .field("core_1_from_world_11", &self.core_1_from_world_11())
            .field("core_1_from_entry_11", &self.core_1_from_entry_11())
            .field("core_1_current_11", &self.core_1_current_11())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_1_statustable11::R`](R) reader structure
impl crate::Readable for CORE_1_STATUSTABLE11_SPEC {}
///`write(|w| ..)` method takes [`core_1_statustable11::W`](W) writer structure
