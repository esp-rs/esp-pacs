///Register `Core_1_STATUSTABLE6` reader
pub type R = crate::R<CORE_1_STATUSTABLE6_SPEC>;
///Register `Core_1_STATUSTABLE6` writer
pub type W = crate::W<CORE_1_STATUSTABLE6_SPEC>;
///Field `CORE_1_FROM_WORLD_6` reader - This bit is used to confirm world before enter entry 6
pub type CORE_1_FROM_WORLD_6_R = crate::BitReader;
///Field `CORE_1_FROM_WORLD_6` writer - This bit is used to confirm world before enter entry 6
pub type CORE_1_FROM_WORLD_6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_FROM_ENTRY_6` reader - This filed is used to confirm in which entry before enter entry 6
pub type CORE_1_FROM_ENTRY_6_R = crate::FieldReader;
///Field `CORE_1_FROM_ENTRY_6` writer - This filed is used to confirm in which entry before enter entry 6
pub type CORE_1_FROM_ENTRY_6_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_1_CURRENT_6` reader - This bit is used to confirm whether the current state is in entry 6
pub type CORE_1_CURRENT_6_R = crate::BitReader;
///Field `CORE_1_CURRENT_6` writer - This bit is used to confirm whether the current state is in entry 6
pub type CORE_1_CURRENT_6_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - This bit is used to confirm world before enter entry 6
    #[inline(always)]
    pub fn core_1_from_world_6(&self) -> CORE_1_FROM_WORLD_6_R {
        CORE_1_FROM_WORLD_6_R::new((self.bits & 1) != 0)
    }
    ///Bits 1:4 - This filed is used to confirm in which entry before enter entry 6
    #[inline(always)]
    pub fn core_1_from_entry_6(&self) -> CORE_1_FROM_ENTRY_6_R {
        CORE_1_FROM_ENTRY_6_R::new(((self.bits >> 1) & 0x0f) as u8)
    }
    ///Bit 5 - This bit is used to confirm whether the current state is in entry 6
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE6")
            .field("core_1_from_world_6", &self.core_1_from_world_6())
            .field("core_1_from_entry_6", &self.core_1_from_entry_6())
            .field("core_1_current_6", &self.core_1_current_6())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_1_statustable6::R`](R) reader structure
impl crate::Readable for CORE_1_STATUSTABLE6_SPEC {}
///`write(|w| ..)` method takes [`core_1_statustable6::W`](W) writer structure
