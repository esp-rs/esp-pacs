///Register `Core_1_ENTRY_1_ADDR` reader
pub type R = crate::R<CORE_1_ENTRY_1_ADDR_SPEC>;
///Register `Core_1_ENTRY_1_ADDR` writer
pub type W = crate::W<CORE_1_ENTRY_1_ADDR_SPEC>;
///Field `CORE_1_ENTRY_1_ADDR` reader - Core_1 Entry 1 address from WORLD1 to WORLD0
pub type CORE_1_ENTRY_1_ADDR_R = crate::FieldReader<u32>;
///Field `CORE_1_ENTRY_1_ADDR` writer - Core_1 Entry 1 address from WORLD1 to WORLD0
pub type CORE_1_ENTRY_1_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core_1 Entry 1 address from WORLD1 to WORLD0
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_ENTRY_1_ADDR")
            .field("core_1_entry_1_addr", &self.core_1_entry_1_addr())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_1_entry_1_addr::R`](R) reader structure
impl crate::Readable for CORE_1_ENTRY_1_ADDR_SPEC {}
///`write(|w| ..)` method takes [`core_1_entry_1_addr::W`](W) writer structure
