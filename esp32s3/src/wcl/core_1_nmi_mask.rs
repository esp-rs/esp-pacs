///Register `Core_1_NMI_MASK` reader
pub type R = crate::R<CORE_1_NMI_MASK_SPEC>;
///Register `Core_1_NMI_MASK` writer
pub type W = crate::W<CORE_1_NMI_MASK_SPEC>;
///Field `CORE_1_NMI_MASK` reader - this bit is used to mask NMI interrupt,it can directly mask NMI interrupt
pub type CORE_1_NMI_MASK_R = crate::BitReader;
///Field `CORE_1_NMI_MASK` writer - this bit is used to mask NMI interrupt,it can directly mask NMI interrupt
pub type CORE_1_NMI_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - this bit is used to mask NMI interrupt,it can directly mask NMI interrupt
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_NMI_MASK")
            .field("core_1_nmi_mask", &self.core_1_nmi_mask())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_1_nmi_mask::R`](R) reader structure
impl crate::Readable for CORE_1_NMI_MASK_SPEC {}
///`write(|w| ..)` method takes [`core_1_nmi_mask::W`](W) writer structure
