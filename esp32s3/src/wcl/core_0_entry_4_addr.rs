///Register `Core_0_ENTRY_4_ADDR` reader
pub type R = crate::R<CORE_0_ENTRY_4_ADDR_SPEC>;
///Register `Core_0_ENTRY_4_ADDR` writer
pub type W = crate::W<CORE_0_ENTRY_4_ADDR_SPEC>;
///Field `CORE_0_ENTRY_4_ADDR` reader - Core_0 Entry 4 address from WORLD1 to WORLD0
pub type CORE_0_ENTRY_4_ADDR_R = crate::FieldReader<u32>;
///Field `CORE_0_ENTRY_4_ADDR` writer - Core_0 Entry 4 address from WORLD1 to WORLD0
pub type CORE_0_ENTRY_4_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core_0 Entry 4 address from WORLD1 to WORLD0
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_0_entry_4_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_0_entry_4_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_ENTRY_4_ADDR_SPEC;
impl crate::RegisterSpec for CORE_0_ENTRY_4_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_0_entry_4_addr::R`](R) reader structure
impl crate::Readable for CORE_0_ENTRY_4_ADDR_SPEC {}
///`write(|w| ..)` method takes [`core_0_entry_4_addr::W`](W) writer structure
