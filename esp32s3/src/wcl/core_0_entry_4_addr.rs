...
pub struct R(crate::R<CORE_0_ENTRY_4_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_0_ENTRY_4_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_0_ENTRY_4_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_0_ENTRY_4_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Core_0_ENTRY_4_ADDR` writer"]
pub struct W(crate::W<CORE_0_ENTRY_4_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_0_ENTRY_4_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_0_ENTRY_4_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_0_ENTRY_4_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CORE_0_ENTRY_4_ADDR` reader - Core_0 Entry 4 address from WORLD1 to WORLD0"]
pub type CORE_0_ENTRY_4_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_0_ENTRY_4_ADDR` writer - Core_0 Entry 4 address from WORLD1 to WORLD0"]
pub type CORE_0_ENTRY_4_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_ENTRY_4_ADDR_SPEC, 32, O, u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_0_ENTRY_4_ADDR")
            .field(
                "core_0_entry_4_addr",
                &format_args!("{}", self.core_0_entry_4_addr().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_0_ENTRY_4_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_entry_4_addr(&mut self) -> CORE_0_ENTRY_4_ADDR_W<0> {
        CORE_0_ENTRY_4_ADDR_W::new(self)
    }
