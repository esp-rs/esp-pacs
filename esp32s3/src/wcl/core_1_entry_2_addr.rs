///Register `Core_1_ENTRY_2_ADDR` reader
pub type R = crate::R<CORE_1_ENTRY_2_ADDR_SPEC>;
///Register `Core_1_ENTRY_2_ADDR` writer
pub type W = crate::W<CORE_1_ENTRY_2_ADDR_SPEC>;
///Field `CORE_1_ENTRY_2_ADDR` reader - Core_1 Entry 2 address from WORLD1 to WORLD0
pub type CORE_1_ENTRY_2_ADDR_R = crate::FieldReader<u32>;
///Field `CORE_1_ENTRY_2_ADDR` writer - Core_1 Entry 2 address from WORLD1 to WORLD0
pub type CORE_1_ENTRY_2_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core_1 Entry 2 address from WORLD1 to WORLD0
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_ENTRY_2_ADDR")
            .field("core_1_entry_2_addr", &self.core_1_entry_2_addr())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_1_entry_2_addr::R`](R) reader structure
impl crate::Readable for CORE_1_ENTRY_2_ADDR_SPEC {}
///`write(|w| ..)` method takes [`core_1_entry_2_addr::W`](W) writer structure
