...
pub type CORE_1_ENTRY_2_ADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_entry_2_addr(&mut self) -> CORE_1_ENTRY_2_ADDR_W<CORE_1_ENTRY_2_ADDR_SPEC, 0> {
