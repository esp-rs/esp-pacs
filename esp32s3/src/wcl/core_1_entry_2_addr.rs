...
pub struct R(crate::R<CORE_1_ENTRY_2_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_ENTRY_2_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_ENTRY_2_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_ENTRY_2_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Core_1_ENTRY_2_ADDR` writer"]
pub struct W(crate::W<CORE_1_ENTRY_2_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_ENTRY_2_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_ENTRY_2_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_ENTRY_2_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CORE_1_ENTRY_2_ADDR` reader - Core_1 Entry 2 address from WORLD1 to WORLD0"]
pub type CORE_1_ENTRY_2_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_1_ENTRY_2_ADDR` writer - Core_1 Entry 2 address from WORLD1 to WORLD0"]
pub type CORE_1_ENTRY_2_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_ENTRY_2_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_entry_2_addr(&mut self) -> CORE_1_ENTRY_2_ADDR_W<0> {
        CORE_1_ENTRY_2_ADDR_W::new(self)
    }
