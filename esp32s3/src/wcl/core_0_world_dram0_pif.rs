///Register `Core_0_World_DRam0_PIF` reader
pub type R = crate::R<CORE_0_WORLD_DRAM0_PIF_SPEC>;
///Register `Core_0_World_DRam0_PIF` writer
pub type W = crate::W<CORE_0_WORLD_DRAM0_PIF_SPEC>;
///Field `CORE_0_WORLD_DRAM0_PIF` reader - this field is used to read current world of Dram0 bus and PIF bus
pub type CORE_0_WORLD_DRAM0_PIF_R = crate::FieldReader;
///Field `CORE_0_WORLD_DRAM0_PIF` writer - this field is used to read current world of Dram0 bus and PIF bus
...
///`read()` method returns [`core_0_world_dram0_pif::R`](R) reader structure
impl crate::Readable for CORE_0_WORLD_DRAM0_PIF_SPEC {}
///`write(|w| ..)` method takes [`core_0_world_dram0_pif::W`](W) writer structure
