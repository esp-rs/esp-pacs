...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Core_1_STATUSTABLE10")
            .field("core_1_from_world_10", &self.core_1_from_world_10().bit())
            .field("core_1_from_entry_10", &self.core_1_from_entry_10().bits())
            .field("core_1_current_10", &self.core_1_current_10().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
