///Register `Core_1_STATUSTABLE10` reader
pub type R = crate::R<CORE_1_STATUSTABLE10_SPEC>;
///Register `Core_1_STATUSTABLE10` writer
pub type W = crate::W<CORE_1_STATUSTABLE10_SPEC>;
///Field `CORE_1_FROM_WORLD_10` reader - This bit is used to confirm world before enter entry 10
pub type CORE_1_FROM_WORLD_10_R = crate::BitReader;
///Field `CORE_1_FROM_WORLD_10` writer - This bit is used to confirm world before enter entry 10
pub type CORE_1_FROM_WORLD_10_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_1_FROM_ENTRY_10` reader - This filed is used to confirm in which entry before enter entry 10
pub type CORE_1_FROM_ENTRY_10_R = crate::FieldReader;
///Field `CORE_1_FROM_ENTRY_10` writer - This filed is used to confirm in which entry before enter entry 10
pub type CORE_1_FROM_ENTRY_10_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CORE_1_CURRENT_10` reader - This bit is used to confirm whether the current state is in entry 10
pub type CORE_1_CURRENT_10_R = crate::BitReader;
///Field `CORE_1_CURRENT_10` writer - This bit is used to confirm whether the current state is in entry 10
...
///`read()` method returns [`core_1_statustable10::R`](R) reader structure
impl crate::Readable for CORE_1_STATUSTABLE10_SPEC {}
///`write(|w| ..)` method takes [`core_1_statustable10::W`](W) writer structure
