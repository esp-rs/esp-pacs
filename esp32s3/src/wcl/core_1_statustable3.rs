...
pub type CORE_1_FROM_WORLD_3_R = crate::BitReader<bool>;
#[doc = "Field `CORE_1_FROM_WORLD_3` writer - This bit is used to confirm world before enter entry 3"]
pub type CORE_1_FROM_WORLD_3_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE_1_STATUSTABLE3_SPEC, bool, O>;
#[doc = "Field `CORE_1_FROM_ENTRY_3` reader - This filed is used to confirm in which entry before enter entry 3"]
pub type CORE_1_FROM_ENTRY_3_R = crate::FieldReader<u8, u8>;
