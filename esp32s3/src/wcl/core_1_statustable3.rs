...
pub type CORE_1_FROM_WORLD_3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_FROM_ENTRY_3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type CORE_1_CURRENT_3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_world_3(&mut self) -> CORE_1_FROM_WORLD_3_W<CORE_1_STATUSTABLE3_SPEC, 0> {
        CORE_1_FROM_WORLD_3_W::new(self)
    }
    #[doc = "Bits 1:4 - This filed is used to confirm in which entry before enter entry 3"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_from_entry_3(&mut self) -> CORE_1_FROM_ENTRY_3_W<CORE_1_STATUSTABLE3_SPEC, 1> {
        CORE_1_FROM_ENTRY_3_W::new(self)
    }
    #[doc = "Bit 5 - This bit is used to confirm whether the current state is in entry 3"]
    #[inline(always)]
    #[must_use]
    pub fn core_1_current_3(&mut self) -> CORE_1_CURRENT_3_W<CORE_1_STATUSTABLE3_SPEC, 5> {
