#[doc = "Register `TZ1_STATUS` reader"]
pub struct R(crate::R<TZ1_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TZ1_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TZ1_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TZ1_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TZ1_STATUS_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "Status of fault events.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tz1_status](index.html) module"]
pub struct TZ1_STATUS_SPEC;
impl crate::RegisterSpec for TZ1_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tz1_status::R](R) reader structure"]
impl crate::Readable for TZ1_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TZ1_STATUS to value 0"]
impl crate::Resettable for TZ1_STATUS_SPEC {
