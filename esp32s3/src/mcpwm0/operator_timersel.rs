...
#[doc = "Field `OPERATOR_TIMERSEL(0-2)` reader - Select which PWM timer's is the timing reference for PWM operator%s, 0: timer0, 1: timer1, 2: timer2"]
pub type OPERATOR_TIMERSEL_R = crate::FieldReader;
#[doc = "Field `OPERATOR_TIMERSEL(0-2)` writer - Select which PWM timer's is the timing reference for PWM operator%s, 0: timer0, 1: timer1, 2: timer2"]
pub type OPERATOR_TIMERSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Select which PWM timer's is the timing reference for PWM operator(0-2), 0: timer0, 1: timer1, 2: timer2"]
    #[doc = ""]
