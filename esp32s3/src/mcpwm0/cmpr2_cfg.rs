...
pub type CMPR2_A_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, CMPR2_CFG_SPEC, 4, O>;
...
pub type CMPR2_B_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, CMPR2_CFG_SPEC, 4, O>;
...
pub type CMPR2_A_SHDW_FULL_W<'a, const O: u8> = crate::BitWriter<'a, CMPR2_CFG_SPEC, O>;
...
pub type CMPR2_B_SHDW_FULL_W<'a, const O: u8> = crate::BitWriter<'a, CMPR2_CFG_SPEC, O>;
impl R {
