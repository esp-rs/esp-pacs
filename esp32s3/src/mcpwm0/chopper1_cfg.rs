...
pub type CHOPPER1_EN_W<'a, const O: u8> = crate::BitWriter<'a, CHOPPER1_CFG_SPEC, O>;
...
pub type CHOPPER1_PRESCALE_W<'a, const O: u8> = crate::FieldWriter<'a, CHOPPER1_CFG_SPEC, 4, O>;
...
pub type CHOPPER1_DUTY_W<'a, const O: u8> = crate::FieldWriter<'a, CHOPPER1_CFG_SPEC, 3, O>;
...
pub type CHOPPER1_OSHTWTH_W<'a, const O: u8> = crate::FieldWriter<'a, CHOPPER1_CFG_SPEC, 4, O>;
...
pub type CHOPPER1_OUT_INVERT_W<'a, const O: u8> = crate::BitWriter<'a, CHOPPER1_CFG_SPEC, O>;
...
pub type CHOPPER1_IN_INVERT_W<'a, const O: u8> = crate::BitWriter<'a, CHOPPER1_CFG_SPEC, O>;
impl R {
