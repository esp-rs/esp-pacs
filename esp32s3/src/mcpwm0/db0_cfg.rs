...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn db0_fed_upmethod(&mut self) -> DB0_FED_UPMETHOD_W<DB0_CFG_SPEC, 0> {
        DB0_FED_UPMETHOD_W::new(self)
    }
    #[doc = "Bits 4:7 - Update method for RED (rising edge delay) active register. 0: immediate, bit0: tez, bit1: tep, bit2: sync, bit3: freeze"]
    #[inline(always)]
    #[must_use]
    pub fn db0_red_upmethod(&mut self) -> DB0_RED_UPMETHOD_W<DB0_CFG_SPEC, 4> {
        DB0_RED_UPMETHOD_W::new(self)
    }
    #[doc = "Bit 8 - S8 in documentation, dual-edge B mode, 0: fed/red take effect on different path separately, 1: fed/red take effect on B path, A out is in bypass or dulpB mode"]
    #[inline(always)]
    #[must_use]
    pub fn db0_deb_mode(&mut self) -> DB0_DEB_MODE_W<DB0_CFG_SPEC, 8> {
        DB0_DEB_MODE_W::new(self)
    }
    #[doc = "Bit 9 - S6 in documentation"]
    #[inline(always)]
    #[must_use]
    pub fn db0_a_outswap(&mut self) -> DB0_A_OUTSWAP_W<DB0_CFG_SPEC, 9> {
        DB0_A_OUTSWAP_W::new(self)
    }
    #[doc = "Bit 10 - S7 in documentation"]
    #[inline(always)]
    #[must_use]
    pub fn db0_b_outswap(&mut self) -> DB0_B_OUTSWAP_W<DB0_CFG_SPEC, 10> {
        DB0_B_OUTSWAP_W::new(self)
    }
    #[doc = "Bit 11 - S4 in documentation"]
    #[inline(always)]
    #[must_use]
    pub fn db0_red_insel(&mut self) -> DB0_RED_INSEL_W<DB0_CFG_SPEC, 11> {
        DB0_RED_INSEL_W::new(self)
    }
    #[doc = "Bit 12 - S5 in documentation"]
    #[inline(always)]
    #[must_use]
    pub fn db0_fed_insel(&mut self) -> DB0_FED_INSEL_W<DB0_CFG_SPEC, 12> {
        DB0_FED_INSEL_W::new(self)
    }
    #[doc = "Bit 13 - S2 in documentation"]
    #[inline(always)]
    #[must_use]
    pub fn db0_red_outinvert(&mut self) -> DB0_RED_OUTINVERT_W<DB0_CFG_SPEC, 13> {
        DB0_RED_OUTINVERT_W::new(self)
    }
    #[doc = "Bit 14 - S3 in documentation"]
    #[inline(always)]
    #[must_use]
    pub fn db0_fed_outinvert(&mut self) -> DB0_FED_OUTINVERT_W<DB0_CFG_SPEC, 14> {
        DB0_FED_OUTINVERT_W::new(self)
    }
    #[doc = "Bit 15 - S1 in documentation"]
    #[inline(always)]
    #[must_use]
    pub fn db0_a_outbypass(&mut self) -> DB0_A_OUTBYPASS_W<DB0_CFG_SPEC, 15> {
        DB0_A_OUTBYPASS_W::new(self)
    }
    #[doc = "Bit 16 - S0 in documentation"]
    #[inline(always)]
    #[must_use]
    pub fn db0_b_outbypass(&mut self) -> DB0_B_OUTBYPASS_W<DB0_CFG_SPEC, 16> {
        DB0_B_OUTBYPASS_W::new(self)
    }
    #[doc = "Bit 17 - Dead time generator 0 clock selection. 0: PWM_clk, 1: PT_clk"]
    #[inline(always)]
    #[must_use]
    pub fn db0_clk_sel(&mut self) -> DB0_CLK_SEL_W<DB0_CFG_SPEC, 17> {
