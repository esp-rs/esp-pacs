...
pub type R = crate::R<DB0_RED_CFG_SPEC>;
#[doc = "Register `DB0_RED_CFG` writer"]
pub type W = crate::W<DB0_RED_CFG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn db0_red(&mut self) -> DB0_RED_W<DB0_RED_CFG_SPEC> {
...
#[doc = "Shadow register for rising edge delay (RED).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`db0_red_cfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`db0_red_cfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
