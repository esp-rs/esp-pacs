///Register `DB_CFG` reader
pub type R = crate::R<DB_CFG_SPEC>;
///Register `DB_CFG` writer
pub type W = crate::W<DB_CFG_SPEC>;
///Field `FED_UPMETHOD` reader - Update method for FED (falling edge delay) active register. 0: immediate, bit0: tez, bit1: tep, bit2: sync, bit3: freeze
pub type FED_UPMETHOD_R = crate::FieldReader;
///Field `FED_UPMETHOD` writer - Update method for FED (falling edge delay) active register. 0: immediate, bit0: tez, bit1: tep, bit2: sync, bit3: freeze
pub type FED_UPMETHOD_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `RED_UPMETHOD` reader - Update method for RED (rising edge delay) active register. 0: immediate, bit0: tez, bit1: tep, bit2: sync, bit3: freeze
pub type RED_UPMETHOD_R = crate::FieldReader;
///Field `RED_UPMETHOD` writer - Update method for RED (rising edge delay) active register. 0: immediate, bit0: tez, bit1: tep, bit2: sync, bit3: freeze
pub type RED_UPMETHOD_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `DEB_MODE` reader - S8 in documentation, dual-edge B mode, 0: fed/red take effect on different path separately, 1: fed/red take effect on B path, A out is in bypass or dulpB mode
pub type DEB_MODE_R = crate::BitReader;
///Field `DEB_MODE` writer - S8 in documentation, dual-edge B mode, 0: fed/red take effect on different path separately, 1: fed/red take effect on B path, A out is in bypass or dulpB mode
pub type DEB_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `A_OUTSWAP` reader - S6 in documentation
pub type A_OUTSWAP_R = crate::BitReader;
///Field `A_OUTSWAP` writer - S6 in documentation
pub type A_OUTSWAP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `B_OUTSWAP` reader - S7 in documentation
pub type B_OUTSWAP_R = crate::BitReader;
///Field `B_OUTSWAP` writer - S7 in documentation
pub type B_OUTSWAP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RED_INSEL` reader - S4 in documentation
pub type RED_INSEL_R = crate::BitReader;
///Field `RED_INSEL` writer - S4 in documentation
pub type RED_INSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FED_INSEL` reader - S5 in documentation
pub type FED_INSEL_R = crate::BitReader;
///Field `FED_INSEL` writer - S5 in documentation
pub type FED_INSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RED_OUTINVERT` reader - S2 in documentation
pub type RED_OUTINVERT_R = crate::BitReader;
///Field `RED_OUTINVERT` writer - S2 in documentation
pub type RED_OUTINVERT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FED_OUTINVERT` reader - S3 in documentation
pub type FED_OUTINVERT_R = crate::BitReader;
///Field `FED_OUTINVERT` writer - S3 in documentation
pub type FED_OUTINVERT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `A_OUTBYPASS` reader - S1 in documentation
pub type A_OUTBYPASS_R = crate::BitReader;
///Field `A_OUTBYPASS` writer - S1 in documentation
pub type A_OUTBYPASS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `B_OUTBYPASS` reader - S0 in documentation
pub type B_OUTBYPASS_R = crate::BitReader;
///Field `B_OUTBYPASS` writer - S0 in documentation
...
You can [`read`](crate::generic::Reg::read) this register and get [`db_cfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`db_cfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DB_CFG_SPEC;
impl crate::RegisterSpec for DB_CFG_SPEC {
    type Ux = u32;
}
///`read()` method returns [`db_cfg::R`](R) reader structure
impl crate::Readable for DB_CFG_SPEC {}
///`write(|w| ..)` method takes [`db_cfg::W`](W) writer structure
