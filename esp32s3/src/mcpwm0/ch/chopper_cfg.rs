///Register `CHOPPER_CFG` reader
pub type R = crate::R<CHOPPER_CFG_SPEC>;
///Register `CHOPPER_CFG` writer
...
///Field `OSHTWTH` reader - width of the fist pulse in number of periods of the carrier
pub type OSHTWTH_R = crate::FieldReader;
///Field `OSHTWTH` writer - width of the fist pulse in number of periods of the carrier
...
You can [`read`](crate::generic::Reg::read) this register and get [`chopper_cfg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`chopper_cfg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CHOPPER_CFG_SPEC;
impl crate::RegisterSpec for CHOPPER_CFG_SPEC {
    type Ux = u32;
}
///`read()` method returns [`chopper_cfg::R`](R) reader structure
impl crate::Readable for CHOPPER_CFG_SPEC {}
///`write(|w| ..)` method takes [`chopper_cfg::W`](W) writer structure
