///Register `TZ_CFG1` reader
pub type R = crate::R<TZ_CFG1_SPEC>;
///Register `TZ_CFG1` writer
...
///Field `CBCPULSE` reader - cycle-by-cycle mode action refresh moment selection. Bit0: TEZ, bit1:TEP
pub type CBCPULSE_R = crate::FieldReader;
///Field `CBCPULSE` writer - cycle-by-cycle mode action refresh moment selection. Bit0: TEZ, bit1:TEP
...
///`read()` method returns [`tz_cfg1::R`](R) reader structure
impl crate::Readable for TZ_CFG1_SPEC {}
///`write(|w| ..)` method takes [`tz_cfg1::W`](W) writer structure
