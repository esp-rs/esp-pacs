...
pub type TZ0_CLR_OST_W<'a, const O: u8> = crate::BitWriter<'a, TZ0_CFG1_SPEC, O>;
...
pub type TZ0_CBCPULSE_W<'a, const O: u8> = crate::FieldWriter<'a, TZ0_CFG1_SPEC, 2, O>;
...
pub type TZ0_FORCE_CBC_W<'a, const O: u8> = crate::BitWriter<'a, TZ0_CFG1_SPEC, O>;
...
pub type TZ0_FORCE_OST_W<'a, const O: u8> = crate::BitWriter<'a, TZ0_CFG1_SPEC, O>;
impl R {
