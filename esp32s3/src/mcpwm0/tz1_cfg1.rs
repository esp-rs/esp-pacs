...
pub type R = crate::R<TZ1_CFG1_SPEC>;
#[doc = "Register `TZ1_CFG1` writer"]
pub type W = crate::W<TZ1_CFG1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tz1_clr_ost(&mut self) -> TZ1_CLR_OST_W<TZ1_CFG1_SPEC> {
        TZ1_CLR_OST_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - cycle-by-cycle mode action refresh moment selection. Bit0: TEZ, bit1:TEP"]
    #[inline(always)]
    #[must_use]
    pub fn tz1_cbcpulse(&mut self) -> TZ1_CBCPULSE_W<TZ1_CFG1_SPEC> {
        TZ1_CBCPULSE_W::new(self, 1)
    }
    #[doc = "Bit 3 - a toggle trigger a cycle-by-cycle mode action"]
    #[inline(always)]
    #[must_use]
    pub fn tz1_force_cbc(&mut self) -> TZ1_FORCE_CBC_W<TZ1_CFG1_SPEC> {
        TZ1_FORCE_CBC_W::new(self, 3)
    }
    #[doc = "Bit 4 - a toggle (software negate its value) triggers a one-shot mode action"]
    #[inline(always)]
    #[must_use]
    pub fn tz1_force_ost(&mut self) -> TZ1_FORCE_OST_W<TZ1_CFG1_SPEC> {
        TZ1_FORCE_OST_W::new(self, 4)
    }
}
#[doc = "Software triggers for fault handler actions\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tz1_cfg1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tz1_cfg1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
