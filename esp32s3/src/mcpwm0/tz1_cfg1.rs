...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tz1_clr_ost(&mut self) -> TZ1_CLR_OST_W<TZ1_CFG1_SPEC, 0> {
        TZ1_CLR_OST_W::new(self)
    }
    #[doc = "Bits 1:2 - cycle-by-cycle mode action refresh moment selection. Bit0: TEZ, bit1:TEP"]
    #[inline(always)]
    #[must_use]
    pub fn tz1_cbcpulse(&mut self) -> TZ1_CBCPULSE_W<TZ1_CFG1_SPEC, 1> {
        TZ1_CBCPULSE_W::new(self)
    }
    #[doc = "Bit 3 - a toggle trigger a cycle-by-cycle mode action"]
    #[inline(always)]
    #[must_use]
    pub fn tz1_force_cbc(&mut self) -> TZ1_FORCE_CBC_W<TZ1_CFG1_SPEC, 3> {
