...
pub type CMPR0_A_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, CMPR0_CFG_SPEC, 4, O>;
...
pub type CMPR0_B_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, CMPR0_CFG_SPEC, 4, O>;
...
pub type CMPR0_A_SHDW_FULL_W<'a, const O: u8> = crate::BitWriter<'a, CMPR0_CFG_SPEC, O>;
...
pub type CMPR0_B_SHDW_FULL_W<'a, const O: u8> = crate::BitWriter<'a, CMPR0_CFG_SPEC, O>;
impl R {
