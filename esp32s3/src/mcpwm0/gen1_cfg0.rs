...
#[doc = "Field `GEN1_CFG_UPMETHOD` reader - Update method for PWM generator 1's active register of configuration. When all bits are set to 0: immediately, when bit0 is set to 1: TEZ, when bit1 is set to 1:"]
pub type GEN1_CFG_UPMETHOD_R = crate::FieldReader;
#[doc = "Field `GEN1_CFG_UPMETHOD` writer - Update method for PWM generator 1's active register of configuration. When all bits are set to 0: immediately, when bit0 is set to 1: TEZ, when bit1 is set to 1:"]
pub type GEN1_CFG_UPMETHOD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type GEN1_T0_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type GEN1_T1_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
impl R {
    #[doc = "Bits 0:3 - Update method for PWM generator 1's active register of configuration. When all bits are set to 0: immediately, when bit0 is set to 1: TEZ, when bit1 is set to 1:"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gen1_cfg_upmethod(&mut self) -> GEN1_CFG_UPMETHOD_W<GEN1_CFG0_SPEC, 0> {
        GEN1_CFG_UPMETHOD_W::new(self)
    }
    #[doc = "Bits 4:6 - Source selection for PWM generator 1 event_t0, take effect immediately, 0: fault_event0, 1: fault_event1, 2: fault_event2, 3: sync_taken, 4: none"]
    #[inline(always)]
    #[must_use]
    pub fn gen1_t0_sel(&mut self) -> GEN1_T0_SEL_W<GEN1_CFG0_SPEC, 4> {
