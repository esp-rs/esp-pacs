...
pub type CHOPPER0_EN_W<'a, const O: u8> = crate::BitWriter<'a, CHOPPER0_CFG_SPEC, O>;
...
pub type CHOPPER0_PRESCALE_W<'a, const O: u8> = crate::FieldWriter<'a, CHOPPER0_CFG_SPEC, 4, O>;
...
pub type CHOPPER0_DUTY_W<'a, const O: u8> = crate::FieldWriter<'a, CHOPPER0_CFG_SPEC, 3, O>;
...
pub type CHOPPER0_OSHTWTH_W<'a, const O: u8> = crate::FieldWriter<'a, CHOPPER0_CFG_SPEC, 4, O>;
...
pub type CHOPPER0_OUT_INVERT_W<'a, const O: u8> = crate::BitWriter<'a, CHOPPER0_CFG_SPEC, O>;
...
pub type CHOPPER0_IN_INVERT_W<'a, const O: u8> = crate::BitWriter<'a, CHOPPER0_CFG_SPEC, O>;
impl R {
