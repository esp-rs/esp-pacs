...
pub type XOFF_THRESHOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
...
impl R {
    ///Bits 0:9 - When the data amount in Rx-FIFO is more than this register value with uart_sw_flow_con_en set to 1, it will send a Xoff char.
    #[inline(always)]
    pub fn xoff_threshold(&self) -> XOFF_THRESHOLD_R {
        XOFF_THRESHOLD_R::new((self.bits & 0x03ff) as u16)
    }
    ///Bits 10:17 - This register stores the Xoff flow control char.
    #[inline(always)]
