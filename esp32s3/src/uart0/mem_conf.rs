...
pub type RX_FLOW_THRHD_W<'a, const O: u8> = crate::FieldWriter<'a, MEM_CONF_SPEC, 10, O, u16>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_tout_thrhd(&mut self) -> RX_TOUT_THRHD_W<17> {
        RX_TOUT_THRHD_W::new(self)
    }
    #[doc = "Bit 27 - Set this bit to force power down UART memory."]
    #[inline(always)]
    #[must_use]
    pub fn mem_force_pd(&mut self) -> MEM_FORCE_PD_W<27> {
        MEM_FORCE_PD_W::new(self)
    }
    #[doc = "Bit 28 - Set this bit to force power up UART memory."]
    #[inline(always)]
    #[must_use]
    pub fn mem_force_pu(&mut self) -> MEM_FORCE_PU_W<28> {
