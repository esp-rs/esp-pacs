...
pub type RS485_PARITY_ERR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS485_FRM_ERR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS485_CLASH_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rs485_parity_err_int_raw(&mut self) -> RS485_PARITY_ERR_INT_RAW_W<INT_RAW_SPEC, 15> {
        RS485_PARITY_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 16 - This interrupt raw bit turns to high level when receiver detects a data frame error from the echo of transmitter in rs485 mode."]
    #[inline(always)]
    #[must_use]
    pub fn rs485_frm_err_int_raw(&mut self) -> RS485_FRM_ERR_INT_RAW_W<INT_RAW_SPEC, 16> {
        RS485_FRM_ERR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 17 - This interrupt raw bit turns to high level when detects a clash between transmitter and receiver in rs485 mode."]
    #[inline(always)]
    #[must_use]
    pub fn rs485_clash_int_raw(&mut self) -> RS485_CLASH_INT_RAW_W<INT_RAW_SPEC, 17> {
