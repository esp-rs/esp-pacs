///Register `DMA_INT_RAW` reader
pub type R = crate::R<DMA_INT_RAW_SPEC>;
///Register `DMA_INT_RAW` writer
...
///Field `DMA_INFIFO_FULL_ERR` writer - 1: The current data rate of DMA Rx is smaller than that of SPI, which will lose the receive data. 0: Others.
...
///Field `DMA_OUTFIFO_EMPTY_ERR` writer - 1: The current data rate of DMA TX is smaller than that of SPI. SPI will stop in master mode and send out all 0 in slave mode. 0: Others.
...
///Field `SLV_EX_QPI` writer - The raw bit for SPI slave Ex_QPI interrupt. 1: SPI slave mode Ex_QPI transmission is ended. 0: Others.
pub type SLV_EX_QPI_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_EN_QPI` reader - The raw bit for SPI slave En_QPI interrupt. 1: SPI slave mode En_QPI transmission is ended. 0: Others.
pub type SLV_EN_QPI_R = crate::BitReader;
///Field `SLV_EN_QPI` writer - The raw bit for SPI slave En_QPI interrupt. 1: SPI slave mode En_QPI transmission is ended. 0: Others.
pub type SLV_EN_QPI_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMD7` reader - The raw bit for SPI slave CMD7 interrupt. 1: SPI slave mode CMD7 transmission is ended. 0: Others.
pub type SLV_CMD7_R = crate::BitReader;
///Field `SLV_CMD7` writer - The raw bit for SPI slave CMD7 interrupt. 1: SPI slave mode CMD7 transmission is ended. 0: Others.
pub type SLV_CMD7_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMD8` reader - The raw bit for SPI slave CMD8 interrupt. 1: SPI slave mode CMD8 transmission is ended. 0: Others.
pub type SLV_CMD8_R = crate::BitReader;
///Field `SLV_CMD8` writer - The raw bit for SPI slave CMD8 interrupt. 1: SPI slave mode CMD8 transmission is ended. 0: Others.
pub type SLV_CMD8_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMD9` reader - The raw bit for SPI slave CMD9 interrupt. 1: SPI slave mode CMD9 transmission is ended. 0: Others.
pub type SLV_CMD9_R = crate::BitReader;
///Field `SLV_CMD9` writer - The raw bit for SPI slave CMD9 interrupt. 1: SPI slave mode CMD9 transmission is ended. 0: Others.
pub type SLV_CMD9_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_CMDA` reader - The raw bit for SPI slave CMDA interrupt. 1: SPI slave mode CMDA transmission is ended. 0: Others.
pub type SLV_CMDA_R = crate::BitReader;
///Field `SLV_CMDA` writer - The raw bit for SPI slave CMDA interrupt. 1: SPI slave mode CMDA transmission is ended. 0: Others.
pub type SLV_CMDA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_RD_DMA_DONE` reader - The raw bit for SPI_SLV_RD_DMA_DONE_INT interrupt. 1: SPI slave mode Rd_DMA transmission is ended. 0: Others.
pub type SLV_RD_DMA_DONE_R = crate::BitReader;
///Field `SLV_RD_DMA_DONE` writer - The raw bit for SPI_SLV_RD_DMA_DONE_INT interrupt. 1: SPI slave mode Rd_DMA transmission is ended. 0: Others.
pub type SLV_RD_DMA_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_WR_DMA_DONE` reader - The raw bit for SPI_SLV_WR_DMA_DONE_INT interrupt. 1: SPI slave mode Wr_DMA transmission is ended. 0: Others.
pub type SLV_WR_DMA_DONE_R = crate::BitReader;
///Field `SLV_WR_DMA_DONE` writer - The raw bit for SPI_SLV_WR_DMA_DONE_INT interrupt. 1: SPI slave mode Wr_DMA transmission is ended. 0: Others.
pub type SLV_WR_DMA_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_RD_BUF_DONE` reader - The raw bit for SPI_SLV_RD_BUF_DONE_INT interrupt. 1: SPI slave mode Rd_BUF transmission is ended. 0: Others.
pub type SLV_RD_BUF_DONE_R = crate::BitReader;
///Field `SLV_RD_BUF_DONE` writer - The raw bit for SPI_SLV_RD_BUF_DONE_INT interrupt. 1: SPI slave mode Rd_BUF transmission is ended. 0: Others.
...
///Field `SLV_WR_BUF_DONE` writer - The raw bit for SPI_SLV_WR_BUF_DONE_INT interrupt. 1: SPI slave mode Wr_BUF transmission is ended. 0: Others.
pub type SLV_WR_BUF_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_DONE` reader - The raw bit for SPI_TRANS_DONE_INT interrupt. 1: SPI master mode transmission is ended. 0: others.
pub type TRANS_DONE_R = crate::BitReader;
///Field `TRANS_DONE` writer - The raw bit for SPI_TRANS_DONE_INT interrupt. 1: SPI master mode transmission is ended. 0: others.
pub type TRANS_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_SEG_TRANS_DONE` reader - The raw bit for SPI_DMA_SEG_TRANS_DONE_INT interrupt. 1: spi master DMA full-duplex/half-duplex seg-conf-trans ends or slave half-duplex seg-trans ends. And data has been pushed to corresponding memory. 0: seg-conf-trans or seg-trans is not ended or not occurred.
pub type DMA_SEG_TRANS_DONE_R = crate::BitReader;
///Field `DMA_SEG_TRANS_DONE` writer - The raw bit for SPI_DMA_SEG_TRANS_DONE_INT interrupt. 1: spi master DMA full-duplex/half-duplex seg-conf-trans ends or slave half-duplex seg-trans ends. And data has been pushed to corresponding memory. 0: seg-conf-trans or seg-trans is not ended or not occurred.
...
///Field `SEG_MAGIC_ERR` writer - The raw bit for SPI_SEG_MAGIC_ERR_INT interrupt. 1: The magic value in CONF buffer is error in the DMA seg-conf-trans. 0: others.
pub type SEG_MAGIC_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLV_BUF_ADDR_ERR` reader - The raw bit for SPI_SLV_BUF_ADDR_ERR_INT interrupt. 1: The accessing data address of the current SPI slave mode CPU controlled FD, Wr_BUF or Rd_BUF transmission is bigger than 63. 0: Others.
...
///Field `SLV_CMD_ERR` writer - The raw bit for SPI_SLV_CMD_ERR_INT interrupt. 1: The slave command value in the current SPI slave HD mode transmission is not supported. 0: Others.
pub type SLV_CMD_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MST_RX_AFIFO_WFULL_ERR` reader - The raw bit for SPI_MST_RX_AFIFO_WFULL_ERR_INT interrupt. 1: There is a RX AFIFO write-full error when SPI inputs data in master mode. 0: Others.
pub type MST_RX_AFIFO_WFULL_ERR_R = crate::BitReader;
///Field `MST_RX_AFIFO_WFULL_ERR` writer - The raw bit for SPI_MST_RX_AFIFO_WFULL_ERR_INT interrupt. 1: There is a RX AFIFO write-full error when SPI inputs data in master mode. 0: Others.
pub type MST_RX_AFIFO_WFULL_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MST_TX_AFIFO_REMPTY_ERR` reader - The raw bit for SPI_MST_TX_AFIFO_REMPTY_ERR_INT interrupt. 1: There is a TX BUF AFIFO read-empty error when SPI outputs data in master mode. 0: Others.
...
///Field `APP2` reader - The raw bit for SPI_APP2_INT interrupt. The value is only controlled by software.
pub type APP2_R = crate::BitReader;
///Field `APP2` writer - The raw bit for SPI_APP2_INT interrupt. The value is only controlled by software.
pub type APP2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APP1` reader - The raw bit for SPI_APP1_INT interrupt. The value is only controlled by software.
pub type APP1_R = crate::BitReader;
///Field `APP1` writer - The raw bit for SPI_APP1_INT interrupt. The value is only controlled by software.
...
impl R {
    ...
    ///Bit 20 - The raw bit for SPI_APP1_INT interrupt. The value is only controlled by software.
    #[inline(always)]
...
///`read()` method returns [`dma_int_raw::R`](R) reader structure
impl crate::Readable for DMA_INT_RAW_SPEC {}
///`write(|w| ..)` method takes [`dma_int_raw::W`](W) writer structure
