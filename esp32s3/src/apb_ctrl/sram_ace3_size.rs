///Register `SRAM_ACE3_SIZE` reader
pub type R = crate::R<SRAM_ACE3_SIZE_SPEC>;
///Register `SRAM_ACE3_SIZE` writer
pub type W = crate::W<SRAM_ACE3_SIZE_SPEC>;
///Field `SRAM_ACE3_SIZE` reader - ******* Description ***********
pub type SRAM_ACE3_SIZE_R = crate::FieldReader<u16>;
///Field `SRAM_ACE3_SIZE` writer - ******* Description ***********
...
///`read()` method returns [`sram_ace3_size::R`](R) reader structure
impl crate::Readable for SRAM_ACE3_SIZE_SPEC {}
///`write(|w| ..)` method takes [`sram_ace3_size::W`](W) writer structure
