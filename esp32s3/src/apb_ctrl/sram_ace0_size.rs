///Register `SRAM_ACE0_SIZE` reader
pub type R = crate::R<SRAM_ACE0_SIZE_SPEC>;
///Register `SRAM_ACE0_SIZE` writer
pub type W = crate::W<SRAM_ACE0_SIZE_SPEC>;
///Field `SRAM_ACE0_SIZE` reader - ******* Description ***********
pub type SRAM_ACE0_SIZE_R = crate::FieldReader<u16>;
///Field `SRAM_ACE0_SIZE` writer - ******* Description ***********
...
#[doc = "******* Description ***********\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sram_ace0_size::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sram_ace0_size::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SRAM_ACE0_SIZE_SPEC;
impl crate::RegisterSpec for SRAM_ACE0_SIZE_SPEC {
    type Ux = u32;
}
///`read()` method returns [`sram_ace0_size::R`](R) reader structure
impl crate::Readable for SRAM_ACE0_SIZE_SPEC {}
///`write(|w| ..)` method takes [`sram_ace0_size::W`](W) writer structure
