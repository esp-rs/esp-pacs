...
///Field `RETENTION_CPU_LINK_ADDR` reader - ******* Description ***********
pub type RETENTION_CPU_LINK_ADDR_R = crate::FieldReader<u32>;
///Field `RETENTION_CPU_LINK_ADDR` writer - ******* Description ***********
pub type RETENTION_CPU_LINK_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 27, u32>;
///Field `NOBYPASS_CPU_ISO_RST` reader - ******* Description ***********
pub type NOBYPASS_CPU_ISO_RST_R = crate::BitReader;
///Field `NOBYPASS_CPU_ISO_RST` writer - ******* Description ***********
