...
///Field `ROM_CLKGATE_FORCE_ON` reader - ******* Description ***********
pub type ROM_CLKGATE_FORCE_ON_R = crate::FieldReader;
///Field `ROM_CLKGATE_FORCE_ON` writer - ******* Description ***********
pub type ROM_CLKGATE_FORCE_ON_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `SRAM_CLKGATE_FORCE_ON` reader - ******* Description ***********
pub type SRAM_CLKGATE_FORCE_ON_R = crate::FieldReader<u16>;
///Field `SRAM_CLKGATE_FORCE_ON` writer - ******* Description ***********
