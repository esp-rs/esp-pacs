...
///`read()` method returns [`retention_ctrl2::R`](R) reader structure
impl crate::Readable for RETENTION_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`retention_ctrl2::W`](W) writer structure
