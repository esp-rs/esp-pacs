///Register `RETENTION_CTRL4` reader
pub type R = crate::R<RETENTION_CTRL4_SPEC>;
///Register `RETENTION_CTRL4` writer
pub type W = crate::W<RETENTION_CTRL4_SPEC>;
///Field `RETENTION_INV_CFG` reader - ******* Description ***********
pub type RETENTION_INV_CFG_R = crate::FieldReader<u32>;
///Field `RETENTION_INV_CFG` writer - ******* Description ***********
...
///`read()` method returns [`retention_ctrl4::R`](R) reader structure
impl crate::Readable for RETENTION_CTRL4_SPEC {}
///`write(|w| ..)` method takes [`retention_ctrl4::W`](W) writer structure
