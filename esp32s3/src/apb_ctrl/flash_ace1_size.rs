...
#[doc = "Field `FLASH_ACE1_SIZE` reader - ******* Description ***********"]
pub type FLASH_ACE1_SIZE_R = crate::FieldReader<u16>;
#[doc = "Field `FLASH_ACE1_SIZE` writer - ******* Description ***********"]
...
#[doc = "******* Description ***********\n\nYou can [`read`](crate::Reg::read) this register and get [`flash_ace1_size::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flash_ace1_size::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets FLASH_ACE1_SIZE to value 0x1000"]
