///Register `SRAM_ACE3_ADDR` reader
pub type R = crate::R<SRAM_ACE3_ADDR_SPEC>;
///Register `SRAM_ACE3_ADDR` writer
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn s(&mut self) -> S_W<SRAM_ACE3_ADDR_SPEC> {
        S_W::new(self, 0)
    }
}
#[doc = "******* Description ***********\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sram_ace3_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sram_ace3_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SRAM_ACE3_ADDR_SPEC;
impl crate::RegisterSpec for SRAM_ACE3_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`sram_ace3_addr::R`](R) reader structure
impl crate::Readable for SRAM_ACE3_ADDR_SPEC {}
///`write(|w| ..)` method takes [`sram_ace3_addr::W`](W) writer structure
