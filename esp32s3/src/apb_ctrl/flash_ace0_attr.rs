...
///Field `FLASH_ACE0_ATTR` reader - ******* Description ***********
pub type FLASH_ACE0_ATTR_R = crate::FieldReader<u16>;
///Field `FLASH_ACE0_ATTR` writer - ******* Description ***********
pub type FLASH_ACE0_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
