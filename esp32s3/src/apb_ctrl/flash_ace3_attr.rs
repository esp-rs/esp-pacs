///Register `FLASH_ACE3_ATTR` reader
pub type R = crate::R<FLASH_ACE3_ATTR_SPEC>;
///Register `FLASH_ACE3_ATTR` writer
pub type W = crate::W<FLASH_ACE3_ATTR_SPEC>;
///Field `FLASH_ACE3_ATTR` reader - ******* Description ***********
pub type FLASH_ACE3_ATTR_R = crate::FieldReader<u16>;
///Field `FLASH_ACE3_ATTR` writer - ******* Description ***********
pub type FLASH_ACE3_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ///Bits 0:8 - ******* Description ***********
    #[inline(always)]
    pub fn flash_ace3_attr(&self) -> FLASH_ACE3_ATTR_R {
        FLASH_ACE3_ATTR_R::new((self.bits & 0x01ff) as u16)
    }
}
...
///`read()` method returns [`flash_ace3_attr::R`](R) reader structure
impl crate::Readable for FLASH_ACE3_ATTR_SPEC {}
///`write(|w| ..)` method takes [`flash_ace3_attr::W`](W) writer structure
