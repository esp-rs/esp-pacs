///Register `SRAM_ACE2_SIZE` reader
pub type R = crate::R<SRAM_ACE2_SIZE_SPEC>;
///Register `SRAM_ACE2_SIZE` writer
pub type W = crate::W<SRAM_ACE2_SIZE_SPEC>;
///Field `SRAM_ACE2_SIZE` reader - ******* Description ***********
pub type SRAM_ACE2_SIZE_R = crate::FieldReader<u16>;
///Field `SRAM_ACE2_SIZE` writer - ******* Description ***********
...
///`read()` method returns [`sram_ace2_size::R`](R) reader structure
impl crate::Readable for SRAM_ACE2_SIZE_SPEC {}
///`write(|w| ..)` method takes [`sram_ace2_size::W`](W) writer structure
