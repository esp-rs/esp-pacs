...
#[doc = "Field `SRAM_ACE2_SIZE` reader - ******* Description ***********"]
pub type SRAM_ACE2_SIZE_R = crate::FieldReader<u16>;
#[doc = "Field `SRAM_ACE2_SIZE` writer - ******* Description ***********"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SRAM_ACE2_SIZE")
            .field("sram_ace2_size", &self.sram_ace2_size())
            .finish()
    }
}
impl W {
...
#[doc = "******* Description ***********\n\nYou can [`read`](crate::Reg::read) this register and get [`sram_ace2_size::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sram_ace2_size::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
