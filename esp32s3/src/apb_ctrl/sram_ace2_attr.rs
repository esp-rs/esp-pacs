///Register `SRAM_ACE2_ATTR` reader
pub type R = crate::R<SRAM_ACE2_ATTR_SPEC>;
///Register `SRAM_ACE2_ATTR` writer
pub type W = crate::W<SRAM_ACE2_ATTR_SPEC>;
///Field `SRAM_ACE2_ATTR` reader - ******* Description ***********
pub type SRAM_ACE2_ATTR_R = crate::FieldReader<u16>;
///Field `SRAM_ACE2_ATTR` writer - ******* Description ***********
pub type SRAM_ACE2_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
...
///`read()` method returns [`sram_ace2_attr::R`](R) reader structure
impl crate::Readable for SRAM_ACE2_ATTR_SPEC {}
///`write(|w| ..)` method takes [`sram_ace2_attr::W`](W) writer structure
