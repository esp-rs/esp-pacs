...
///Field `ROM_POWER_DOWN` reader - ******* Description ***********
pub type ROM_POWER_DOWN_R = crate::FieldReader;
///Field `ROM_POWER_DOWN` writer - ******* Description ***********
pub type ROM_POWER_DOWN_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `SRAM_POWER_DOWN` reader - ******* Description ***********
pub type SRAM_POWER_DOWN_R = crate::FieldReader<u16>;
///Field `SRAM_POWER_DOWN` writer - ******* Description ***********
