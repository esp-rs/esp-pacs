...
///Field `ROM_POWER_UP` reader - ******* Description ***********
pub type ROM_POWER_UP_R = crate::FieldReader;
///Field `ROM_POWER_UP` writer - ******* Description ***********
pub type ROM_POWER_UP_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `SRAM_POWER_UP` reader - ******* Description ***********
pub type SRAM_POWER_UP_R = crate::FieldReader<u16>;
///Field `SRAM_POWER_UP` writer - ******* Description ***********
