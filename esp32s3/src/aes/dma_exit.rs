...
///Field `DMA_EXIT` writer - Set this bit to 1 to exit AES operation. This field is only effective for DMA-AES operation.
...
impl W {
    ///Bit 0 - Set this bit to 1 to exit AES operation. This field is only effective for DMA-AES operation.
    #[inline(always)]
    #[must_use]
