...
#[doc = "Field `MODE` reader - Defines the key length and the encryption/decryption of the AES accelerator."]
pub type MODE_R = crate::FieldReader;
#[doc = "Field `MODE` writer - Defines the key length and the encryption/decryption of the AES accelerator."]
