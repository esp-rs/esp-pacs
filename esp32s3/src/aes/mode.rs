...
///Field `MODE` reader - Defines the key length and the encryption/decryption of the AES accelerator.
pub type MODE_R = crate::FieldReader;
///Field `MODE` writer - Defines the key length and the encryption/decryption of the AES accelerator.
pub type MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2 - Defines the key length and the encryption/decryption of the AES accelerator.
    #[inline(always)]
