...
///Field `DMA_ENABLE` reader - Defines the working mode of the AES accelerator. 1'b0: typical AES working mode, 1'b1: DMA-AES working mode.
pub type DMA_ENABLE_R = crate::BitReader;
///Field `DMA_ENABLE` writer - Defines the working mode of the AES accelerator. 1'b0: typical AES working mode, 1'b1: DMA-AES working mode.
