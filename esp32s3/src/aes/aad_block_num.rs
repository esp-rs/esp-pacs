...
///Field `AAD_BLOCK_NUM` reader - Those bits stores the number of AAD block.
pub type AAD_BLOCK_NUM_R = crate::FieldReader<u32>;
///Field `AAD_BLOCK_NUM` writer - Those bits stores the number of AAD block.
pub type AAD_BLOCK_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Those bits stores the number of AAD block.
    #[inline(always)]
