...
///Field `DATE` reader - Hmac date information/ hmac version information.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - Hmac date information/ hmac version information.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - Hmac date information/ hmac version information.
    #[inline(always)]
