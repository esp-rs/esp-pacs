///Register `CORE1_IBUS_REJECT_ST` reader
pub type R = crate::R<CORE1_IBUS_REJECT_ST_SPEC>;
///Field `CORE1_IBUS_TAG_ATTR` reader - The bits are used to indicate the attribute of data from external memory when authentication fail. 0: invalidate, 1: execute-able, 2: read-able, 4: write-able.
pub type CORE1_IBUS_TAG_ATTR_R = crate::FieldReader;
///Field `CORE1_IBUS_ATTR` reader - The bits are used to indicate the attribute of CPU access ibus when authentication fail. 0: invalidate, 1: execute-able, 2: read-able
pub type CORE1_IBUS_ATTR_R = crate::FieldReader;
///Field `CORE1_IBUS_WORLD` reader - The bit is used to indicate the world of CPU access ibus when authentication fail. 0: WORLD0, 1: WORLD1
...
#[doc = "******* Description ***********\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`core1_ibus_reject_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CORE1_IBUS_REJECT_ST_SPEC;
impl crate::RegisterSpec for CORE1_IBUS_REJECT_ST_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core1_ibus_reject_st::R`](R) reader structure
