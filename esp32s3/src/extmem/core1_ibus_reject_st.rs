...
pub struct R(crate::R<CORE1_IBUS_REJECT_ST_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE1_IBUS_REJECT_ST_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE1_IBUS_REJECT_ST_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE1_IBUS_REJECT_ST_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type CORE1_IBUS_TAG_ATTR_R = crate::FieldReader<u8, u8>;
...
pub type CORE1_IBUS_ATTR_R = crate::FieldReader<u8, u8>;
...
pub type CORE1_IBUS_WORLD_R = crate::BitReader<bool>;
impl R {
