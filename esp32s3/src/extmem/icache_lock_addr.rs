///Register `ICACHE_LOCK_ADDR` reader
pub type R = crate::R<ICACHE_LOCK_ADDR_SPEC>;
///Register `ICACHE_LOCK_ADDR` writer
...
///Field `ICACHE_LOCK_ADDR` writer - The bits are used to configure the start virtual address for lock operations. It should be combined with ICACHE_LOCK_SIZE_REG.
pub type ICACHE_LOCK_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - The bits are used to configure the start virtual address for lock operations. It should be combined with ICACHE_LOCK_SIZE_REG.
    #[inline(always)]
...
///`read()` method returns [`icache_lock_addr::R`](R) reader structure
impl crate::Readable for ICACHE_LOCK_ADDR_SPEC {}
///`write(|w| ..)` method takes [`icache_lock_addr::W`](W) writer structure
