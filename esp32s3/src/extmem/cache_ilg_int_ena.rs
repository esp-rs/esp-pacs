...
impl W {
    ...
    #[doc = "Bit 2 - The bit is used to enable interrupt by sync configurations fault."]
    #[inline(always)]
    pub fn dcache_sync_op_fault(&mut self) -> DCACHE_SYNC_OP_FAULT_W<'_, CACHE_ILG_INT_ENA_SPEC> {
    ...
    pub fn dcache_preload_op_fault(
        &mut self,
    ) -> DCACHE_PRELOAD_OP_FAULT_W<'_, CACHE_ILG_INT_ENA_SPEC> {
        DCACHE_PRELOAD_OP_FAULT_W::new(self, 3)
    }
    #[doc = "Bit 4 - The bit is used to enable interrupt by dcache trying to write flash."]
    #[inline(always)]
    pub fn dcache_write_flash(&mut self) -> DCACHE_WRITE_FLASH_W<'_, CACHE_ILG_INT_ENA_SPEC> {
    ...
    #[doc = "Bit 6 - The bit is used to enable interrupt by dcache trying to replace a line whose blocks all have been occupied by occupy-mode."]
    #[inline(always)]
    pub fn dcache_occupy_exc(&mut self) -> DCACHE_OCCUPY_EXC_W<'_, CACHE_ILG_INT_ENA_SPEC> {
