///Register `DCACHE_AUTOLOAD_SCT1_ADDR` reader
pub type R = crate::R<DCACHE_AUTOLOAD_SCT1_ADDR_SPEC>;
///Register `DCACHE_AUTOLOAD_SCT1_ADDR` writer
pub type W = crate::W<DCACHE_AUTOLOAD_SCT1_ADDR_SPEC>;
///Field `DCACHE_AUTOLOAD_SCT1_ADDR` reader - The bits are used to configure the start virtual address of the second section for autoload operation. It should be combined with dcache_autoload_sct1_ena.
pub type DCACHE_AUTOLOAD_SCT1_ADDR_R = crate::FieldReader<u32>;
///Field `DCACHE_AUTOLOAD_SCT1_ADDR` writer - The bits are used to configure the start virtual address of the second section for autoload operation. It should be combined with dcache_autoload_sct1_ena.
pub type DCACHE_AUTOLOAD_SCT1_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - The bits are used to configure the start virtual address of the second section for autoload operation. It should be combined with dcache_autoload_sct1_ena.
    #[inline(always)]
...
///`read()` method returns [`dcache_autoload_sct1_addr::R`](R) reader structure
impl crate::Readable for DCACHE_AUTOLOAD_SCT1_ADDR_SPEC {}
///`write(|w| ..)` method takes [`dcache_autoload_sct1_addr::W`](W) writer structure
