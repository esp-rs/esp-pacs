...
impl W {
    ...
    pub fn core1_ibus_acs_msk_ic_int_ena(
        &mut self,
    ) -> CORE1_IBUS_ACS_MSK_IC_INT_ENA_W<'_, CORE1_ACS_CACHE_INT_ENA_SPEC> {
    ...
    pub fn core1_ibus_wr_ic_int_ena(
        &mut self,
    ) -> CORE1_IBUS_WR_IC_INT_ENA_W<'_, CORE1_ACS_CACHE_INT_ENA_SPEC> {
    ...
    pub fn core1_ibus_reject_int_ena(
        &mut self,
    ) -> CORE1_IBUS_REJECT_INT_ENA_W<'_, CORE1_ACS_CACHE_INT_ENA_SPEC> {
    ...
    pub fn core1_dbus_acs_msk_dc_int_ena(
        &mut self,
    ) -> CORE1_DBUS_ACS_MSK_DC_INT_ENA_W<'_, CORE1_ACS_CACHE_INT_ENA_SPEC> {
    ...
    pub fn core1_dbus_reject_int_ena(
        &mut self,
    ) -> CORE1_DBUS_REJECT_INT_ENA_W<'_, CORE1_ACS_CACHE_INT_ENA_SPEC> {
