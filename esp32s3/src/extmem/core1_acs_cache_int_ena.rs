...
pub type CORE1_IBUS_ACS_MSK_IC_INT_ENA_R = crate::BitReader<bool>;
...
pub type CORE1_IBUS_ACS_MSK_IC_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE1_ACS_CACHE_INT_ENA_SPEC, bool, O>;
#[doc = "Field `CORE1_IBUS_WR_IC_INT_ENA` reader - The bit is used to enable interrupt by ibus trying to write icache"]
pub type CORE1_IBUS_WR_IC_INT_ENA_R = crate::BitReader<bool>;
...
pub type CORE1_IBUS_REJECT_INT_ENA_R = crate::BitReader<bool>;
...
pub type CORE1_DBUS_ACS_MSK_DC_INT_ENA_R = crate::BitReader<bool>;
...
pub type CORE1_DBUS_REJECT_INT_ENA_R = crate::BitReader<bool>;
