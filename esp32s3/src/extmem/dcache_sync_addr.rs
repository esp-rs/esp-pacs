///Register `DCACHE_SYNC_ADDR` reader
pub type R = crate::R<DCACHE_SYNC_ADDR_SPEC>;
///Register `DCACHE_SYNC_ADDR` writer
pub type W = crate::W<DCACHE_SYNC_ADDR_SPEC>;
///Field `DCACHE_SYNC_ADDR` reader - The bits are used to configure the start virtual address for clean operations. It should be combined with DCACHE_SYNC_SIZE_REG.
pub type DCACHE_SYNC_ADDR_R = crate::FieldReader<u32>;
///Field `DCACHE_SYNC_ADDR` writer - The bits are used to configure the start virtual address for clean operations. It should be combined with DCACHE_SYNC_SIZE_REG.
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcache_sync_addr(&mut self) -> DCACHE_SYNC_ADDR_W<DCACHE_SYNC_ADDR_SPEC> {
...
///`read()` method returns [`dcache_sync_addr::R`](R) reader structure
impl crate::Readable for DCACHE_SYNC_ADDR_SPEC {}
///`write(|w| ..)` method takes [`dcache_sync_addr::W`](W) writer structure
