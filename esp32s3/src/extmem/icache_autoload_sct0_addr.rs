///Register `ICACHE_AUTOLOAD_SCT0_ADDR` reader
pub type R = crate::R<ICACHE_AUTOLOAD_SCT0_ADDR_SPEC>;
///Register `ICACHE_AUTOLOAD_SCT0_ADDR` writer
pub type W = crate::W<ICACHE_AUTOLOAD_SCT0_ADDR_SPEC>;
///Field `ICACHE_AUTOLOAD_SCT0_ADDR` reader - The bits are used to configure the start virtual address of the first section for autoload operation. It should be combined with icache_autoload_sct0_ena.
pub type ICACHE_AUTOLOAD_SCT0_ADDR_R = crate::FieldReader<u32>;
///Field `ICACHE_AUTOLOAD_SCT0_ADDR` writer - The bits are used to configure the start virtual address of the first section for autoload operation. It should be combined with icache_autoload_sct0_ena.
pub type ICACHE_AUTOLOAD_SCT0_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - The bits are used to configure the start virtual address of the first section for autoload operation. It should be combined with icache_autoload_sct0_ena.
    #[inline(always)]
...
///`read()` method returns [`icache_autoload_sct0_addr::R`](R) reader structure
impl crate::Readable for ICACHE_AUTOLOAD_SCT0_ADDR_SPEC {}
///`write(|w| ..)` method takes [`icache_autoload_sct0_addr::W`](W) writer structure
