///Register `CACHE_TAG_WAY_OBJECT` reader
pub type R = crate::R<CACHE_TAG_WAY_OBJECT_SPEC>;
///Register `CACHE_TAG_WAY_OBJECT` writer
pub type W = crate::W<CACHE_TAG_WAY_OBJECT_SPEC>;
///Field `CACHE_TAG_WAY_OBJECT` reader - Set this bits to select which way of the tag-object will be accessed. 0: way0, 1: way1, 2: way2, 3: way3, .., 7: way7.
pub type CACHE_TAG_WAY_OBJECT_R = crate::FieldReader;
///Field `CACHE_TAG_WAY_OBJECT` writer - Set this bits to select which way of the tag-object will be accessed. 0: way0, 1: way1, 2: way2, 3: way3, .., 7: way7.
...
#[doc = "******* Description ***********\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cache_tag_way_object::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cache_tag_way_object::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CACHE_TAG_WAY_OBJECT_SPEC;
impl crate::RegisterSpec for CACHE_TAG_WAY_OBJECT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`cache_tag_way_object::R`](R) reader structure
impl crate::Readable for CACHE_TAG_WAY_OBJECT_SPEC {}
///`write(|w| ..)` method takes [`cache_tag_way_object::W`](W) writer structure
