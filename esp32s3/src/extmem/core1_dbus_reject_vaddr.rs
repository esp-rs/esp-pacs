///Register `CORE1_DBUS_REJECT_VADDR` reader
pub type R = crate::R<CORE1_DBUS_REJECT_VADDR_SPEC>;
///Field `CORE1_DBUS_VADDR` reader - The bits are used to indicate the virtual address of CPU access dbus when authentication fail.
...
///`read()` method returns [`core1_dbus_reject_vaddr::R`](R) reader structure
