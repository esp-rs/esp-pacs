///Register `DCACHE_AUTOLOAD_SCT1_SIZE` reader
pub type R = crate::R<DCACHE_AUTOLOAD_SCT1_SIZE_SPEC>;
///Register `DCACHE_AUTOLOAD_SCT1_SIZE` writer
pub type W = crate::W<DCACHE_AUTOLOAD_SCT1_SIZE_SPEC>;
///Field `DCACHE_AUTOLOAD_SCT1_SIZE` reader - The bits are used to configure the length of the second section for autoload operation. It should be combined with dcache_autoload_sct1_ena.
pub type DCACHE_AUTOLOAD_SCT1_SIZE_R = crate::FieldReader<u32>;
///Field `DCACHE_AUTOLOAD_SCT1_SIZE` writer - The bits are used to configure the length of the second section for autoload operation. It should be combined with dcache_autoload_sct1_ena.
pub type DCACHE_AUTOLOAD_SCT1_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 27, u32>;
impl R {
    ///Bits 0:26 - The bits are used to configure the length of the second section for autoload operation. It should be combined with dcache_autoload_sct1_ena.
    #[inline(always)]
...
///`read()` method returns [`dcache_autoload_sct1_size::R`](R) reader structure
impl crate::Readable for DCACHE_AUTOLOAD_SCT1_SIZE_SPEC {}
///`write(|w| ..)` method takes [`dcache_autoload_sct1_size::W`](W) writer structure
