...
///Field `DCACHE_SHUT_CORE0_BUS` reader - The bit is used to disable core0 dbus, 0: enable, 1: disable
pub type DCACHE_SHUT_CORE0_BUS_R = crate::BitReader;
///Field `DCACHE_SHUT_CORE0_BUS` writer - The bit is used to disable core0 dbus, 0: enable, 1: disable
pub type DCACHE_SHUT_CORE0_BUS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_SHUT_CORE1_BUS` reader - The bit is used to disable core1 dbus, 0: enable, 1: disable
pub type DCACHE_SHUT_CORE1_BUS_R = crate::BitReader;
///Field `DCACHE_SHUT_CORE1_BUS` writer - The bit is used to disable core1 dbus, 0: enable, 1: disable
...
///`read()` method returns [`dcache_ctrl1::R`](R) reader structure
impl crate::Readable for DCACHE_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`dcache_ctrl1::W`](W) writer structure
