...
pub type DCACHE_TAG_MEM_FORCE_ON_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_TAG_MEM_FORCE_PD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_TAG_MEM_FORCE_PU_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn dcache_tag_mem_force_on(
        &mut self,
    ) -> DCACHE_TAG_MEM_FORCE_ON_W<DCACHE_TAG_POWER_CTRL_SPEC, 0> {
    ...
    pub fn dcache_tag_mem_force_pd(
        &mut self,
    ) -> DCACHE_TAG_MEM_FORCE_PD_W<DCACHE_TAG_POWER_CTRL_SPEC, 1> {
    ...
    pub fn dcache_tag_mem_force_pu(
        &mut self,
    ) -> DCACHE_TAG_MEM_FORCE_PU_W<DCACHE_TAG_POWER_CTRL_SPEC, 2> {
