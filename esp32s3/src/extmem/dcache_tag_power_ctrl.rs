...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DCACHE_TAG_POWER_CTRL")
            .field("dcache_tag_mem_force_on", &self.dcache_tag_mem_force_on())
            .field("dcache_tag_mem_force_pd", &self.dcache_tag_mem_force_pd())
            .field("dcache_tag_mem_force_pu", &self.dcache_tag_mem_force_pu())
            .finish()
    }
}
impl W {
...
#[doc = "******* Description ***********\n\nYou can [`read`](crate::Reg::read) this register and get [`dcache_tag_power_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dcache_tag_power_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
