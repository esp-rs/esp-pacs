///Register `CORE1_DBUS_REJECT_ST` reader
pub type R = crate::R<CORE1_DBUS_REJECT_ST_SPEC>;
///Field `CORE1_DBUS_TAG_ATTR` reader - The bits are used to indicate the attribute of data from external memory when authentication fail. 0: invalidate, 1: execute-able, 2: read-able, 4: write-able.
pub type CORE1_DBUS_TAG_ATTR_R = crate::FieldReader;
///Field `CORE1_DBUS_ATTR` reader - The bits are used to indicate the attribute of CPU access dbus when authentication fail. 0: invalidate, 1: execute-able, 2: read-able, 4: write-able.
pub type CORE1_DBUS_ATTR_R = crate::FieldReader;
///Field `CORE1_DBUS_WORLD` reader - The bit is used to indicate the world of CPU access dbus when authentication fail. 0: WORLD0, 1: WORLD1
...
///`read()` method returns [`core1_dbus_reject_st::R`](R) reader structure
