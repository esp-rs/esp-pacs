...
pub type DCACHE_ENABLE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_SIZE_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_BLOCKSIZE_MODE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcache_enable(&mut self) -> DCACHE_ENABLE_W<DCACHE_CTRL_SPEC, 0> {
        DCACHE_ENABLE_W::new(self)
    }
    #[doc = "Bit 2 - The bit is used to configure cache memory size.0: 32KB, 1: 64KB"]
    #[inline(always)]
    #[must_use]
    pub fn dcache_size_mode(&mut self) -> DCACHE_SIZE_MODE_W<DCACHE_CTRL_SPEC, 2> {
        DCACHE_SIZE_MODE_W::new(self)
    }
    #[doc = "Bits 3:4 - The bit is used to configure cache block size.0: 16 bytes, 1: 32 bytes,2: 64 bytes"]
    #[inline(always)]
    #[must_use]
    pub fn dcache_blocksize_mode(&mut self) -> DCACHE_BLOCKSIZE_MODE_W<DCACHE_CTRL_SPEC, 3> {
