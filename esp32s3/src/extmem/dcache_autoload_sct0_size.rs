...
pub struct R(crate::R<DCACHE_AUTOLOAD_SCT0_SIZE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCACHE_AUTOLOAD_SCT0_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCACHE_AUTOLOAD_SCT0_SIZE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCACHE_AUTOLOAD_SCT0_SIZE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCACHE_AUTOLOAD_SCT0_SIZE` writer"]
pub struct W(crate::W<DCACHE_AUTOLOAD_SCT0_SIZE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCACHE_AUTOLOAD_SCT0_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCACHE_AUTOLOAD_SCT0_SIZE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCACHE_AUTOLOAD_SCT0_SIZE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCACHE_AUTOLOAD_SCT0_SIZE_R = crate::FieldReader<u32, u32>;
...
pub type DCACHE_AUTOLOAD_SCT0_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DCACHE_AUTOLOAD_SCT0_SIZE_SPEC, u32, u32, 27, O>;
impl R {
    ...
    pub fn dcache_autoload_sct0_size(&self) -> DCACHE_AUTOLOAD_SCT0_SIZE_R {
        DCACHE_AUTOLOAD_SCT0_SIZE_R::new((self.bits & 0x07ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:26 - The bits are used to configure the length of the first section for autoload operation. It should be combined with dcache_autoload_sct0_ena."]
    #[inline(always)]
    pub fn dcache_autoload_sct0_size(&mut self) -> DCACHE_AUTOLOAD_SCT0_SIZE_W<0> {
        DCACHE_AUTOLOAD_SCT0_SIZE_W::new(self)
    }
...
#[doc = "******* Description ***********\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_autoload_sct0_size](index.html) module"]
