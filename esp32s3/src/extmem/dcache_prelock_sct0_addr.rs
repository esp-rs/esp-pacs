...
pub struct R(crate::R<DCACHE_PRELOCK_SCT0_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCACHE_PRELOCK_SCT0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCACHE_PRELOCK_SCT0_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCACHE_PRELOCK_SCT0_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCACHE_PRELOCK_SCT0_ADDR` writer"]
pub struct W(crate::W<DCACHE_PRELOCK_SCT0_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCACHE_PRELOCK_SCT0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCACHE_PRELOCK_SCT0_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCACHE_PRELOCK_SCT0_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCACHE_PRELOCK_SCT0_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type DCACHE_PRELOCK_SCT0_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, DCACHE_PRELOCK_SCT0_ADDR_SPEC, 32, O, u32, u32>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DCACHE_PRELOCK_SCT0_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcache_prelock_sct0_addr(&mut self) -> DCACHE_PRELOCK_SCT0_ADDR_W<0> {
        DCACHE_PRELOCK_SCT0_ADDR_W::new(self)
    }
...
#[doc = "******* Description ***********\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_prelock_sct0_addr](index.html) module"]
pub struct DCACHE_PRELOCK_SCT0_ADDR_SPEC;
