...
pub type DCACHE_LOCK_ADDR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DCACHE_LOCK_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcache_lock_addr(&mut self) -> DCACHE_LOCK_ADDR_W<DCACHE_LOCK_ADDR_SPEC, 0> {
