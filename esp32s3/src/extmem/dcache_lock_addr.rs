///Register `DCACHE_LOCK_ADDR` reader
pub type R = crate::R<DCACHE_LOCK_ADDR_SPEC>;
///Register `DCACHE_LOCK_ADDR` writer
pub type W = crate::W<DCACHE_LOCK_ADDR_SPEC>;
///Field `DCACHE_LOCK_ADDR` reader - The bits are used to configure the start virtual address for lock operations. It should be combined with DCACHE_LOCK_SIZE_REG.
pub type DCACHE_LOCK_ADDR_R = crate::FieldReader<u32>;
///Field `DCACHE_LOCK_ADDR` writer - The bits are used to configure the start virtual address for lock operations. It should be combined with DCACHE_LOCK_SIZE_REG.
...
#[doc = "******* Description ***********\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dcache_lock_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dcache_lock_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DCACHE_LOCK_ADDR_SPEC;
impl crate::RegisterSpec for DCACHE_LOCK_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dcache_lock_addr::R`](R) reader structure
impl crate::Readable for DCACHE_LOCK_ADDR_SPEC {}
///`write(|w| ..)` method takes [`dcache_lock_addr::W`](W) writer structure
