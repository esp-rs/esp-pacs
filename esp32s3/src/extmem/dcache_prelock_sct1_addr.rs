...
pub struct R(crate::R<DCACHE_PRELOCK_SCT1_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCACHE_PRELOCK_SCT1_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCACHE_PRELOCK_SCT1_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCACHE_PRELOCK_SCT1_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCACHE_PRELOCK_SCT1_ADDR` writer"]
pub struct W(crate::W<DCACHE_PRELOCK_SCT1_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCACHE_PRELOCK_SCT1_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCACHE_PRELOCK_SCT1_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCACHE_PRELOCK_SCT1_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCACHE_PRELOCK_SCT1_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DCACHE_PRELOCK_SCT1_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - The bits are used to configure the second start virtual address of data prelock, which is combined with DCACHE_PRELOCK_SCT1_SIZE_REG"]
    #[inline(always)]
    pub fn dcache_prelock_sct1_addr(&mut self) -> DCACHE_PRELOCK_SCT1_ADDR_W<0> {
        DCACHE_PRELOCK_SCT1_ADDR_W::new(self)
    }
...
#[doc = "******* Description ***********\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_prelock_sct1_addr](index.html) module"]
