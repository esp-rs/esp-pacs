...
///Field `CORE0_DBUS_TAG_ATTR` reader - The bits are used to indicate the attribute of data from external memory when authentication fail. 0: invalidate, 1: execute-able, 2: read-able, 4: write-able.
pub type CORE0_DBUS_TAG_ATTR_R = crate::FieldReader;
///Field `CORE0_DBUS_ATTR` reader - The bits are used to indicate the attribute of CPU access dbus when authentication fail. 0: invalidate, 1: execute-able, 2: read-able, 4: write-able.
pub type CORE0_DBUS_ATTR_R = crate::FieldReader;
///Field `CORE0_DBUS_WORLD` reader - The bit is used to indicate the world of CPU access dbus when authentication fail. 0: WORLD0, 1: WORLD1
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE0_DBUS_REJECT_ST")
            .field("core0_dbus_tag_attr", &self.core0_dbus_tag_attr())
...
///`read()` method returns [`core0_dbus_reject_st::R`](R) reader structure
