///Register `DCACHE_PRELOCK_CTRL` reader
...
///Field `DCACHE_PRELOCK_SCT0_EN` reader - The bit is used to enable the first section of prelock function.
pub type DCACHE_PRELOCK_SCT0_EN_R = crate::BitReader;
///Field `DCACHE_PRELOCK_SCT0_EN` writer - The bit is used to enable the first section of prelock function.
pub type DCACHE_PRELOCK_SCT0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_PRELOCK_SCT1_EN` reader - The bit is used to enable the second section of prelock function.
pub type DCACHE_PRELOCK_SCT1_EN_R = crate::BitReader;
///Field `DCACHE_PRELOCK_SCT1_EN` writer - The bit is used to enable the second section of prelock function.
...
///`read()` method returns [`dcache_prelock_ctrl::R`](R) reader structure
impl crate::Readable for DCACHE_PRELOCK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dcache_prelock_ctrl::W`](W) writer structure
