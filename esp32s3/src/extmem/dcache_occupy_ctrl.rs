///Register `DCACHE_OCCUPY_CTRL` reader
pub type R = crate::R<DCACHE_OCCUPY_CTRL_SPEC>;
///Register `DCACHE_OCCUPY_CTRL` writer
pub type W = crate::W<DCACHE_OCCUPY_CTRL_SPEC>;
///Field `DCACHE_OCCUPY_ENA` reader - The bit is used to enable occupy operation. It will be cleared by hardware after issuing Auot-Invalidate Operation.
pub type DCACHE_OCCUPY_ENA_R = crate::BitReader;
///Field `DCACHE_OCCUPY_ENA` writer - The bit is used to enable occupy operation. It will be cleared by hardware after issuing Auot-Invalidate Operation.
pub type DCACHE_OCCUPY_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_OCCUPY_DONE` reader - The bit is used to indicate occupy operation is finished.
...
impl R {
    ...
    ///Bit 1 - The bit is used to indicate occupy operation is finished.
    #[inline(always)]
...
///`read()` method returns [`dcache_occupy_ctrl::R`](R) reader structure
impl crate::Readable for DCACHE_OCCUPY_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dcache_occupy_ctrl::W`](W) writer structure
