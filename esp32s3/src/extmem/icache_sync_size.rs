...
pub type ICACHE_SYNC_SIZE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 23, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icache_sync_size(&mut self) -> ICACHE_SYNC_SIZE_W<ICACHE_SYNC_SIZE_SPEC, 0> {
