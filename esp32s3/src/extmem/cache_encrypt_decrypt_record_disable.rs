...
///Register `CACHE_ENCRYPT_DECRYPT_RECORD_DISABLE` writer
pub type W = crate::W<CACHE_ENCRYPT_DECRYPT_RECORD_DISABLE_SPEC>;
///Field `RECORD_DISABLE_DB_ENCRYPT` reader - Reserved
pub type RECORD_DISABLE_DB_ENCRYPT_R = crate::BitReader;
///Field `RECORD_DISABLE_DB_ENCRYPT` writer - Reserved
pub type RECORD_DISABLE_DB_ENCRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RECORD_DISABLE_G0CB_DECRYPT` reader - Reserved
pub type RECORD_DISABLE_G0CB_DECRYPT_R = crate::BitReader;
///Field `RECORD_DISABLE_G0CB_DECRYPT` writer - Reserved
...
///`read()` method returns [`cache_encrypt_decrypt_record_disable::R`](R) reader structure
impl crate::Readable for CACHE_ENCRYPT_DECRYPT_RECORD_DISABLE_SPEC {}
///`write(|w| ..)` method takes [`cache_encrypt_decrypt_record_disable::W`](W) writer structure
