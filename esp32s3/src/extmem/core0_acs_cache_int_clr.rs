...
#[doc = "Field `CORE0_DBUS_ACS_MSK_DC` writer - The bit is used to clear interrupt by cpu access dcache while the corresponding dbus is disabled or dcache is disabled which include speculative access."]
pub type CORE0_DBUS_ACS_MSK_DC_W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    pub fn core0_dbus_acs_msk_dc(
        &mut self,
    ) -> CORE0_DBUS_ACS_MSK_DC_W<'_, CORE0_ACS_CACHE_INT_CLR_SPEC> {
