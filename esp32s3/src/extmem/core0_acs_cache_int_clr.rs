...
pub type CORE0_DBUS_ACS_MSK_DC_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core0_dbus_acs_msk_dc_int_clr(
        &mut self,
    ) -> CORE0_DBUS_ACS_MSK_DC_INT_CLR_W<CORE0_ACS_CACHE_INT_CLR_SPEC> {
        CORE0_DBUS_ACS_MSK_DC_INT_CLR_W::new(self, 3)
    }
