...
pub type ICACHE_SYNC_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ICACHE_SYNC_INT_CLR` writer - The bit is used to clear the interrupt by icache sync done."]
pub type ICACHE_SYNC_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_SYNC_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `DCACHE_SYNC_INT_CLR` writer - The bit is used to clear the interrupt by dcache sync done."]
pub type DCACHE_SYNC_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icache_sync_int_ena(&mut self) -> ICACHE_SYNC_INT_ENA_W<CACHE_SYNC_INT_CTRL_SPEC, 1> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcache_sync_int_ena(&mut self) -> DCACHE_SYNC_INT_ENA_W<CACHE_SYNC_INT_CTRL_SPEC, 4> {
        DCACHE_SYNC_INT_ENA_W::new(self)
    }
    #[doc = "Bit 5 - The bit is used to clear the interrupt by dcache sync done."]
    #[inline(always)]
    #[must_use]
    pub fn dcache_sync_int_clr(&mut self) -> DCACHE_SYNC_INT_CLR_W<CACHE_SYNC_INT_CTRL_SPEC, 5> {
        DCACHE_SYNC_INT_CLR_W::new(self)
    }
