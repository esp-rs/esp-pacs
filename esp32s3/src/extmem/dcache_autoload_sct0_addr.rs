...
pub type DCACHE_AUTOLOAD_SCT0_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type DCACHE_AUTOLOAD_SCT0_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DCACHE_AUTOLOAD_SCT0_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcache_autoload_sct0_addr(&mut self) -> DCACHE_AUTOLOAD_SCT0_ADDR_W<0> {
...
#[doc = "******* Description ***********\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_autoload_sct0_addr](index.html) module"]
