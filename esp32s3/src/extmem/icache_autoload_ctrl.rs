...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ICACHE_AUTOLOAD_CTRL")
            ...
            .field("icache_autoload_size", &self.icache_autoload_size())
            .field(
                "icache_autoload_buffer_clear",
                &self.icache_autoload_buffer_clear(),
            )
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bits 7:8 - The bits are used to configure the numbers of the cache block for the issuing autoload operation."]
    #[inline(always)]
    pub fn icache_autoload_size(
        &mut self,
    ) -> ICACHE_AUTOLOAD_SIZE_W<'_, ICACHE_AUTOLOAD_CTRL_SPEC> {
    ...
    pub fn icache_autoload_buffer_clear(
        &mut self,
    ) -> ICACHE_AUTOLOAD_BUFFER_CLEAR_W<'_, ICACHE_AUTOLOAD_CTRL_SPEC> {
        ICACHE_AUTOLOAD_BUFFER_CLEAR_W::new(self, 9)
    }
}
#[doc = "******* Description ***********\n\nYou can [`read`](crate::Reg::read) this register and get [`icache_autoload_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`icache_autoload_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
