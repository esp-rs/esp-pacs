...
pub type ICACHE_AUTOLOAD_SIZE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type ICACHE_AUTOLOAD_BUFFER_CLEAR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icache_autoload_size(&mut self) -> ICACHE_AUTOLOAD_SIZE_W<ICACHE_AUTOLOAD_CTRL_SPEC, 7> {
    ...
    pub fn icache_autoload_buffer_clear(
        &mut self,
    ) -> ICACHE_AUTOLOAD_BUFFER_CLEAR_W<ICACHE_AUTOLOAD_CTRL_SPEC, 9> {
