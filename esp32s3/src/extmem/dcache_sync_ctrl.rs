///Register `DCACHE_SYNC_CTRL` reader
pub type R = crate::R<DCACHE_SYNC_CTRL_SPEC>;
///Register `DCACHE_SYNC_CTRL` writer
pub type W = crate::W<DCACHE_SYNC_CTRL_SPEC>;
///Field `DCACHE_INVALIDATE_ENA` reader - The bit is used to enable invalidate operation. It will be cleared by hardware after invalidate operation done.
pub type DCACHE_INVALIDATE_ENA_R = crate::BitReader;
///Field `DCACHE_INVALIDATE_ENA` writer - The bit is used to enable invalidate operation. It will be cleared by hardware after invalidate operation done.
pub type DCACHE_INVALIDATE_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_WRITEBACK_ENA` reader - The bit is used to enable writeback operation. It will be cleared by hardware after writeback operation done.
pub type DCACHE_WRITEBACK_ENA_R = crate::BitReader;
///Field `DCACHE_WRITEBACK_ENA` writer - The bit is used to enable writeback operation. It will be cleared by hardware after writeback operation done.
pub type DCACHE_WRITEBACK_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_CLEAN_ENA` reader - The bit is used to enable clean operation. It will be cleared by hardware after clean operation done.
pub type DCACHE_CLEAN_ENA_R = crate::BitReader;
///Field `DCACHE_CLEAN_ENA` writer - The bit is used to enable clean operation. It will be cleared by hardware after clean operation done.
pub type DCACHE_CLEAN_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_SYNC_DONE` reader - The bit is used to indicate clean/writeback/invalidate operation is finished.
...
///`read()` method returns [`dcache_sync_ctrl::R`](R) reader structure
impl crate::Readable for DCACHE_SYNC_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dcache_sync_ctrl::W`](W) writer structure
