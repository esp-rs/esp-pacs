...
///Field `DCACHE_SYNC_OP_FAULT` reader - The bit is used to indicate interrupt by sync configurations fault.
pub type DCACHE_SYNC_OP_FAULT_R = crate::BitReader;
///Field `DCACHE_PRELOAD_OP_FAULT` reader - The bit is used to indicate interrupt by preload configurations fault.
pub type DCACHE_PRELOAD_OP_FAULT_R = crate::BitReader;
///Field `DCACHE_WRITE_FLASH` reader - The bit is used to indicate interrupt by dcache trying to write flash.
...
///Field `DCACHE_OCCUPY_EXC` reader - The bit is used to indicate interrupt by dcache trying to replace a line whose blocks all have been occupied by occupy-mode.
...
///Field `DBUS_ACS_SPIRAM_MISS_CNT_OVF` reader - The bit is used to indicate interrupt by dbus access spiram miss counter overflow.
