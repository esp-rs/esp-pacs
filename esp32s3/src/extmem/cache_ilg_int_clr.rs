...
pub type DCACHE_SYNC_OP_FAULT_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `DCACHE_PRELOAD_OP_FAULT_INT_CLR` writer - The bit is used to clear interrupt by preload configurations fault."]
pub type DCACHE_PRELOAD_OP_FAULT_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_OCCUPY_EXC_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    pub fn dcache_sync_op_fault_int_clr(
        &mut self,
    ) -> DCACHE_SYNC_OP_FAULT_INT_CLR_W<CACHE_ILG_INT_CLR_SPEC, 2> {
    ...
    pub fn dcache_preload_op_fault_int_clr(
        &mut self,
    ) -> DCACHE_PRELOAD_OP_FAULT_INT_CLR_W<CACHE_ILG_INT_CLR_SPEC, 3> {
    ...
    pub fn dcache_write_flash_int_clr(
        &mut self,
    ) -> DCACHE_WRITE_FLASH_INT_CLR_W<CACHE_ILG_INT_CLR_SPEC, 4> {
    ...
    pub fn dcache_occupy_exc_int_clr(
        &mut self,
    ) -> DCACHE_OCCUPY_EXC_INT_CLR_W<CACHE_ILG_INT_CLR_SPEC, 6> {
