...
pub struct R(crate::R<DBUS_ACS_FLASH_MISS_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DBUS_ACS_FLASH_MISS_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DBUS_ACS_FLASH_MISS_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DBUS_ACS_FLASH_MISS_CNT_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type DBUS_ACS_FLASH_MISS_CNT_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "******* Description ***********\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dbus_acs_flash_miss_cnt](index.html) module"]
