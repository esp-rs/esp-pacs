///Register `DCACHE_PRELOAD_CTRL` reader
pub type R = crate::R<DCACHE_PRELOAD_CTRL_SPEC>;
///Register `DCACHE_PRELOAD_CTRL` writer
pub type W = crate::W<DCACHE_PRELOAD_CTRL_SPEC>;
///Field `DCACHE_PRELOAD_ENA` reader - The bit is used to enable preload operation. It will be cleared by hardware after preload operation done.
pub type DCACHE_PRELOAD_ENA_R = crate::BitReader;
///Field `DCACHE_PRELOAD_ENA` writer - The bit is used to enable preload operation. It will be cleared by hardware after preload operation done.
pub type DCACHE_PRELOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_PRELOAD_DONE` reader - The bit is used to indicate preload operation is finished.
pub type DCACHE_PRELOAD_DONE_R = crate::BitReader;
///Field `DCACHE_PRELOAD_ORDER` reader - The bit is used to configure the direction of preload operation. 1: descending, 0: ascending.
pub type DCACHE_PRELOAD_ORDER_R = crate::BitReader;
///Field `DCACHE_PRELOAD_ORDER` writer - The bit is used to configure the direction of preload operation. 1: descending, 0: ascending.
...
///`read()` method returns [`dcache_preload_ctrl::R`](R) reader structure
impl crate::Readable for DCACHE_PRELOAD_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dcache_preload_ctrl::W`](W) writer structure
