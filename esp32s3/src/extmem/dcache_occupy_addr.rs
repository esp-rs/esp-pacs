...
pub struct R(crate::R<DCACHE_OCCUPY_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCACHE_OCCUPY_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCACHE_OCCUPY_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCACHE_OCCUPY_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCACHE_OCCUPY_ADDR` writer"]
pub struct W(crate::W<DCACHE_OCCUPY_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCACHE_OCCUPY_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCACHE_OCCUPY_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCACHE_OCCUPY_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCACHE_OCCUPY_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type DCACHE_OCCUPY_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, DCACHE_OCCUPY_ADDR_SPEC, 32, O, u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DCACHE_OCCUPY_ADDR")
            .field(
                "dcache_occupy_addr",
                &format_args!("{}", self.dcache_occupy_addr().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DCACHE_OCCUPY_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcache_occupy_addr(&mut self) -> DCACHE_OCCUPY_ADDR_W<0> {
        DCACHE_OCCUPY_ADDR_W::new(self)
    }
...
#[doc = "******* Description ***********\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dcache_occupy_addr](index.html) module"]
