///Register `CACHE_TAG_CONTENT` reader
pub type R = crate::R<CACHE_TAG_CONTENT_SPEC>;
///Register `CACHE_TAG_CONTENT` writer
pub type W = crate::W<CACHE_TAG_CONTENT_SPEC>;
///Field `CACHE_TAG_CONTENT` reader - This is a constant place where we can write data to or read data from the tag memory on the specified cache.
pub type CACHE_TAG_CONTENT_R = crate::FieldReader<u32>;
///Field `CACHE_TAG_CONTENT` writer - This is a constant place where we can write data to or read data from the tag memory on the specified cache.
pub type CACHE_TAG_CONTENT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This is a constant place where we can write data to or read data from the tag memory on the specified cache.
    #[inline(always)]
...
///`read()` method returns [`cache_tag_content::R`](R) reader structure
impl crate::Readable for CACHE_TAG_CONTENT_SPEC {}
///`write(|w| ..)` method takes [`cache_tag_content::W`](W) writer structure
