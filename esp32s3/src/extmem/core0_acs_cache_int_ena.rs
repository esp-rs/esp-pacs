...
pub type CORE0_DBUS_ACS_MSK_DC_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    pub fn core0_dbus_acs_msk_dc_int_ena(
        &mut self,
    ) -> CORE0_DBUS_ACS_MSK_DC_INT_ENA_W<CORE0_ACS_CACHE_INT_ENA_SPEC, 3> {
        CORE0_DBUS_ACS_MSK_DC_INT_ENA_W::new(self)
    }
    #[doc = "Bit 4 - The bit is used to enable interrupt by authentication fail."]
    #[inline(always)]
    #[must_use]
