...
pub type CORE0_IBUS_ACS_MSK_IC_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE0_ACS_CACHE_INT_ENA_SPEC, bool, O>;
...
pub type CORE0_DBUS_ACS_MSK_DC_INT_ENA_R = crate::BitReader<bool>;
...
pub type CORE0_DBUS_ACS_MSK_DC_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE0_ACS_CACHE_INT_ENA_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bit 3 - The bit is used to enable interrupt by cpu access dcache while the corresponding dbus is disabled which include speculative access."]
    #[inline(always)]
    pub fn core0_dbus_acs_msk_dc_int_ena(&mut self) -> CORE0_DBUS_ACS_MSK_DC_INT_ENA_W<3> {
