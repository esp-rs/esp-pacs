...
pub struct R(crate::R<IBUS_ACS_MISS_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IBUS_ACS_MISS_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IBUS_ACS_MISS_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IBUS_ACS_MISS_CNT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `IBUS_ACS_MISS_CNT` reader - The bits are used to count the number of the cache miss caused by ibus access flash/spiram."]
pub type IBUS_ACS_MISS_CNT_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31 - The bits are used to count the number of the cache miss caused by ibus access flash/spiram."]
    #[inline(always)]
...
#[doc = "******* Description ***********\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ibus_acs_miss_cnt](index.html) module"]
