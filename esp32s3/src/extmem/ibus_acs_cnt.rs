...
///Field `IBUS_ACS_CNT` reader - The bits are used to count the number of ibus access flash/spiram through icache.
pub type IBUS_ACS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The bits are used to count the number of ibus access flash/spiram through icache.
    #[inline(always)]
