///Register `DCACHE_LOCK_CTRL` reader
pub type R = crate::R<DCACHE_LOCK_CTRL_SPEC>;
///Register `DCACHE_LOCK_CTRL` writer
pub type W = crate::W<DCACHE_LOCK_CTRL_SPEC>;
///Field `DCACHE_LOCK_ENA` reader - The bit is used to enable lock operation. It will be cleared by hardware after lock operation done.
pub type DCACHE_LOCK_ENA_R = crate::BitReader;
///Field `DCACHE_LOCK_ENA` writer - The bit is used to enable lock operation. It will be cleared by hardware after lock operation done.
pub type DCACHE_LOCK_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_UNLOCK_ENA` reader - The bit is used to enable unlock operation. It will be cleared by hardware after unlock operation done.
pub type DCACHE_UNLOCK_ENA_R = crate::BitReader;
///Field `DCACHE_UNLOCK_ENA` writer - The bit is used to enable unlock operation. It will be cleared by hardware after unlock operation done.
pub type DCACHE_UNLOCK_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DCACHE_LOCK_DONE` reader - The bit is used to indicate unlock/lock operation is finished.
...
///`read()` method returns [`dcache_lock_ctrl::R`](R) reader structure
impl crate::Readable for DCACHE_LOCK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`dcache_lock_ctrl::W`](W) writer structure
