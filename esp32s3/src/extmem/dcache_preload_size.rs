///Register `DCACHE_PRELOAD_SIZE` reader
pub type R = crate::R<DCACHE_PRELOAD_SIZE_SPEC>;
///Register `DCACHE_PRELOAD_SIZE` writer
pub type W = crate::W<DCACHE_PRELOAD_SIZE_SPEC>;
///Field `DCACHE_PRELOAD_SIZE` reader - The bits are used to configure the length for preload operation. The bits are the counts of cache block. It should be combined with DCACHE_PRELOAD_ADDR_REG..
pub type DCACHE_PRELOAD_SIZE_R = crate::FieldReader<u16>;
///Field `DCACHE_PRELOAD_SIZE` writer - The bits are used to configure the length for preload operation. The bits are the counts of cache block. It should be combined with DCACHE_PRELOAD_ADDR_REG..
...
#[doc = "******* Description ***********\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dcache_preload_size::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dcache_preload_size::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DCACHE_PRELOAD_SIZE_SPEC;
impl crate::RegisterSpec for DCACHE_PRELOAD_SIZE_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dcache_preload_size::R`](R) reader structure
impl crate::Readable for DCACHE_PRELOAD_SIZE_SPEC {}
///`write(|w| ..)` method takes [`dcache_preload_size::W`](W) writer structure
