...
pub type DCACHE_AUTOLOAD_SCT0_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_AUTOLOAD_SCT1_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_AUTOLOAD_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_AUTOLOAD_ORDER_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DCACHE_AUTOLOAD_RQST_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type DCACHE_AUTOLOAD_SIZE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type DCACHE_AUTOLOAD_BUFFER_CLEAR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn dcache_autoload_sct0_ena(
        &mut self,
    ) -> DCACHE_AUTOLOAD_SCT0_ENA_W<DCACHE_AUTOLOAD_CTRL_SPEC, 0> {
    ...
    pub fn dcache_autoload_sct1_ena(
        &mut self,
    ) -> DCACHE_AUTOLOAD_SCT1_ENA_W<DCACHE_AUTOLOAD_CTRL_SPEC, 1> {
        DCACHE_AUTOLOAD_SCT1_ENA_W::new(self)
    }
    #[doc = "Bit 2 - The bit is used to enable and disable autoload operation. It is combined with dcache_autoload_done. 1: enable, 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn dcache_autoload_ena(&mut self) -> DCACHE_AUTOLOAD_ENA_W<DCACHE_AUTOLOAD_CTRL_SPEC, 2> {
    ...
    pub fn dcache_autoload_order(
        &mut self,
    ) -> DCACHE_AUTOLOAD_ORDER_W<DCACHE_AUTOLOAD_CTRL_SPEC, 4> {
        DCACHE_AUTOLOAD_ORDER_W::new(self)
    }
    #[doc = "Bits 5:6 - The bits are used to configure trigger conditions for autoload. 0/3: cache miss, 1: cache hit, 2: both cache miss and hit."]
    #[inline(always)]
    #[must_use]
    pub fn dcache_autoload_rqst(&mut self) -> DCACHE_AUTOLOAD_RQST_W<DCACHE_AUTOLOAD_CTRL_SPEC, 5> {
        DCACHE_AUTOLOAD_RQST_W::new(self)
    }
    #[doc = "Bits 7:8 - The bits are used to configure the numbers of the cache block for the issuing autoload operation."]
    #[inline(always)]
    #[must_use]
    pub fn dcache_autoload_size(&mut self) -> DCACHE_AUTOLOAD_SIZE_W<DCACHE_AUTOLOAD_CTRL_SPEC, 7> {
    ...
    pub fn dcache_autoload_buffer_clear(
        &mut self,
    ) -> DCACHE_AUTOLOAD_BUFFER_CLEAR_W<DCACHE_AUTOLOAD_CTRL_SPEC, 9> {
