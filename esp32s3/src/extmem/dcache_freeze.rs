...
///Register `DCACHE_FREEZE` writer
pub type W = crate::W<DCACHE_FREEZE_SPEC>;
///Field `ENA` reader - The bit is used to enable dcache freeze mode
pub type ENA_R = crate::BitReader;
///Field `ENA` writer - The bit is used to enable dcache freeze mode
...
///Field `DONE` reader - The bit is used to indicate dcache freeze success
...
///`read()` method returns [`dcache_freeze::R`](R) reader structure
impl crate::Readable for DCACHE_FREEZE_SPEC {}
///`write(|w| ..)` method takes [`dcache_freeze::W`](W) writer structure
