...
#[doc = "Field `T_LENGTH` reader - sha t_length(used if and only if mode == sha_256/t)"]
pub type T_LENGTH_R = crate::FieldReader;
#[doc = "Field `T_LENGTH` writer - sha t_length(used if and only if mode == sha_256/t)"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("T_LENGTH")
            .field("t_length", &self.t_length().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
