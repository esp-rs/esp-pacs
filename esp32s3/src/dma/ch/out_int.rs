...
impl OUT_INT {
    ///0x00 - Raw status interrupt of Tx channel 0
    #[inline(always)]
    pub const fn raw(&self) -> &RAW {
        &self.raw
    }
    ///0x04 - Masked interrupt of Tx channel 0
    #[inline(always)]
    pub const fn st(&self) -> &ST {
        &self.st
    }
    ///0x08 - Interrupt enable bits of Tx channel 0
    #[inline(always)]
    pub const fn ena(&self) -> &ENA {
        &self.ena
    }
    ///0x0c - Interrupt clear bits of Tx channel 0
    #[inline(always)]
    pub const fn clr(&self) -> &CLR {
        &self.clr
    }
}
/**RAW (rw) register accessor: Raw status interrupt of Tx channel 0
...
pub mod raw;
/**ST (r) register accessor: Masked interrupt of Tx channel 0
...
pub mod st;
/**ENA (rw) register accessor: Interrupt enable bits of Tx channel 0
...
pub mod ena;
/**CLR (w) register accessor: Interrupt clear bits of Tx channel 0
