...
///Field `OUTFIFO_OVF_L1` reader - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is overflow.
pub type OUTFIFO_OVF_L1_R = crate::BitReader;
///Field `OUTFIFO_OVF_L1` writer - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is overflow.
pub type OUTFIFO_OVF_L1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTFIFO_UDF_L1` reader - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is underflow.
pub type OUTFIFO_UDF_L1_R = crate::BitReader;
///Field `OUTFIFO_UDF_L1` writer - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is underflow.
pub type OUTFIFO_UDF_L1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTFIFO_OVF_L3` reader - This raw interrupt bit turns to high level when level 3 fifo of Tx channel 0 is overflow.
pub type OUTFIFO_OVF_L3_R = crate::BitReader;
///Field `OUTFIFO_OVF_L3` writer - This raw interrupt bit turns to high level when level 3 fifo of Tx channel 0 is overflow.
pub type OUTFIFO_OVF_L3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTFIFO_UDF_L3` reader - This raw interrupt bit turns to high level when level 3 fifo of Tx channel 0 is underflow.
pub type OUTFIFO_UDF_L3_R = crate::BitReader;
///Field `OUTFIFO_UDF_L3` writer - This raw interrupt bit turns to high level when level 3 fifo of Tx channel 0 is underflow.
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn outfifo_ovf_l1(&mut self) -> OUTFIFO_OVF_L1_W<RAW_SPEC> {
        OUTFIFO_OVF_L1_W::new(self, 4)
    }
    ///Bit 5 - This raw interrupt bit turns to high level when level 1 fifo of Tx channel 0 is underflow.
    #[inline(always)]
    #[must_use]
    pub fn outfifo_udf_l1(&mut self) -> OUTFIFO_UDF_L1_W<RAW_SPEC> {
        OUTFIFO_UDF_L1_W::new(self, 5)
    }
    ///Bit 6 - This raw interrupt bit turns to high level when level 3 fifo of Tx channel 0 is overflow.
    #[inline(always)]
    #[must_use]
    pub fn outfifo_ovf_l3(&mut self) -> OUTFIFO_OVF_L3_W<RAW_SPEC> {
        OUTFIFO_OVF_L3_W::new(self, 6)
    }
    ///Bit 7 - This raw interrupt bit turns to high level when level 3 fifo of Tx channel 0 is underflow.
    #[inline(always)]
    #[must_use]
    pub fn outfifo_udf_l3(&mut self) -> OUTFIFO_UDF_L3_W<RAW_SPEC> {
