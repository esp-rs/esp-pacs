...
///Field `OUTFIFO_OVF_L3` reader - The interrupt enable bit for the OUTFIFO_OVF_L3_CH_INT interrupt.
pub type OUTFIFO_OVF_L3_R = crate::BitReader;
///Field `OUTFIFO_OVF_L3` writer - The interrupt enable bit for the OUTFIFO_OVF_L3_CH_INT interrupt.
pub type OUTFIFO_OVF_L3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTFIFO_UDF_L3` reader - The interrupt enable bit for the OUTFIFO_UDF_L3_CH_INT interrupt.
pub type OUTFIFO_UDF_L3_R = crate::BitReader;
///Field `OUTFIFO_UDF_L3` writer - The interrupt enable bit for the OUTFIFO_UDF_L3_CH_INT interrupt.
