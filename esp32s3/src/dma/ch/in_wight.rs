///Register `IN_WIGHT` reader
pub type R = crate::R<IN_WIGHT_SPEC>;
///Register `IN_WIGHT` writer
pub type W = crate::W<IN_WIGHT_SPEC>;
///Field `RX_WEIGHT` reader - The weight of Rx channel 0.
pub type RX_WEIGHT_R = crate::FieldReader;
///Field `RX_WEIGHT` writer - The weight of Rx channel 0.
pub type RX_WEIGHT_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bits 8:11 - The weight of Rx channel 0.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_WIGHT")
            .field("rx_weight", &self.rx_weight())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`in_wight::R`](R) reader structure
impl crate::Readable for IN_WIGHT_SPEC {}
///`write(|w| ..)` method takes [`in_wight::W`](W) writer structure
