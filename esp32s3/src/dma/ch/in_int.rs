...
impl IN_INT {
    #[doc = "0x00 - Raw status interrupt of Rx channel 0"]
    #[inline(always)]
    pub const fn raw(&self) -> &RAW {
        &self.raw
    }
    #[doc = "0x04 - Masked interrupt of Rx channel 0"]
    #[inline(always)]
