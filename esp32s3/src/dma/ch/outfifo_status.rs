    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUTFIFO_STATUS")
            ...
            .field(
                ...
                &self.out_remain_under_1b_l3().bit(),
            )
            .field(
                "out_remain_under_2b_l3",
                &self.out_remain_under_2b_l3().bit(),
            )
            .field(
                "out_remain_under_3b_l3",
                &self.out_remain_under_3b_l3().bit(),
            )
            .field(
                "out_remain_under_4b_l3",
                &self.out_remain_under_4b_l3().bit(),
            )
            .finish()
    }
}
...
#[doc = "`reset()` method sets OUTFIFO_STATUS to value 0x0780_002a"]
