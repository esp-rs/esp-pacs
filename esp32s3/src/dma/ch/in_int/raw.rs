...
///Field `INFIFO_FULL_WM` reader - The raw interrupt bit turns to high level when received data byte number is up to threshold configured by REG_DMA_INFIFO_FULL_THRS_CH0 in Rx FIFO of channel 0.
pub type INFIFO_FULL_WM_R = crate::BitReader;
///Field `INFIFO_FULL_WM` writer - The raw interrupt bit turns to high level when received data byte number is up to threshold configured by REG_DMA_INFIFO_FULL_THRS_CH0 in Rx FIFO of channel 0.
pub type INFIFO_FULL_WM_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_OVF_L1` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow.
pub type INFIFO_OVF_L1_R = crate::BitReader;
///Field `INFIFO_OVF_L1` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow.
pub type INFIFO_OVF_L1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_UDF_L1` reader - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow.
pub type INFIFO_UDF_L1_R = crate::BitReader;
///Field `INFIFO_UDF_L1` writer - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow.
pub type INFIFO_UDF_L1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_OVF_L3` reader - This raw interrupt bit turns to high level when level 3 fifo of Rx channel 0 is overflow.
pub type INFIFO_OVF_L3_R = crate::BitReader;
///Field `INFIFO_OVF_L3` writer - This raw interrupt bit turns to high level when level 3 fifo of Rx channel 0 is overflow.
pub type INFIFO_OVF_L3_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `INFIFO_UDF_L3` reader - This raw interrupt bit turns to high level when level 3 fifo of Rx channel 0 is underflow.
pub type INFIFO_UDF_L3_R = crate::BitReader;
///Field `INFIFO_UDF_L3` writer - This raw interrupt bit turns to high level when level 3 fifo of Rx channel 0 is underflow.
