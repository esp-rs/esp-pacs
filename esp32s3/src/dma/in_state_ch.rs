...
pub type INLINK_DSCR_ADDR_CH_R = crate::FieldReader<u32, u32>;
#[doc = "Field `IN_DSCR_STATE_CH` reader - reserved"]
pub type IN_DSCR_STATE_CH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IN_STATE_CH` reader - reserved"]
pub type IN_STATE_CH_R = crate::FieldReader<u8, u8>;
impl R {
