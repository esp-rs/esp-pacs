...
pub type AHBM_RST_EXTER_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MISC_CONF")
            ...
            .field(
                "ahbm_rst_exter",
                &format_args!("{}", self.ahbm_rst_exter().bit()),
            )
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahbm_rst_exter(&mut self) -> AHBM_RST_EXTER_W<MISC_CONF_SPEC, 1> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_en(&mut self) -> CLK_EN_W<MISC_CONF_SPEC, 4> {
        CLK_EN_W::new(self)
    }
