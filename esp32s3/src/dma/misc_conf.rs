...
pub type AHBM_RST_EXTER_R = crate::BitReader;
///Field `AHBM_RST_EXTER` writer - Set this bit, then clear this bit to reset the external ahb FSM.
pub type AHBM_RST_EXTER_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    ///Bit 1 - Set this bit, then clear this bit to reset the external ahb FSM.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MISC_CONF")
            ...
            .field("ahbm_rst_exter", &self.ahbm_rst_exter())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahbm_rst_exter(&mut self) -> AHBM_RST_EXTER_W<MISC_CONF_SPEC> {
        AHBM_RST_EXTER_W::new(self, 1)
    }
    ///Bit 2 - Set this bit to disable priority arbitration function.
    #[inline(always)]
    #[must_use]
