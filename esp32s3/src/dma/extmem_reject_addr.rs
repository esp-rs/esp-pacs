///Register `EXTMEM_REJECT_ADDR` reader
pub type R = crate::R<EXTMEM_REJECT_ADDR_SPEC>;
///Field `EXTMEM_REJECT_ADDR` reader - This register store the first address rejected by permission control when accessing external RAM.
pub type EXTMEM_REJECT_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register store the first address rejected by permission control when accessing external RAM.
    #[inline(always)]
...
///`read()` method returns [`extmem_reject_addr::R`](R) reader structure
