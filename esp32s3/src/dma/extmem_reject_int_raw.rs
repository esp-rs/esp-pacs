///Register `EXTMEM_REJECT_INT_RAW` reader
pub type R = crate::R<EXTMEM_REJECT_INT_RAW_SPEC>;
///Register `EXTMEM_REJECT_INT_RAW` writer
pub type W = crate::W<EXTMEM_REJECT_INT_RAW_SPEC>;
///Field `EXTMEM_REJECT_INT_RAW` reader - The raw interrupt bit turns to high level when accessing external RAM is rejected by permission control.
pub type EXTMEM_REJECT_INT_RAW_R = crate::BitReader;
///Field `EXTMEM_REJECT_INT_RAW` writer - The raw interrupt bit turns to high level when accessing external RAM is rejected by permission control.
pub type EXTMEM_REJECT_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - The raw interrupt bit turns to high level when accessing external RAM is rejected by permission control.
    #[inline(always)]
...
///`read()` method returns [`extmem_reject_int_raw::R`](R) reader structure
impl crate::Readable for EXTMEM_REJECT_INT_RAW_SPEC {}
///`write(|w| ..)` method takes [`extmem_reject_int_raw::W`](W) writer structure
