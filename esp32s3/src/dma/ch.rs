...
pub mod in_dscr_bf1;
/**IN_WIGHT (rw) register accessor: Weight register of Rx channel 0
...
pub mod in_peri_sel;
/**OUT_CONF0 (rw) register accessor: Configure 0 register of Tx channel 0
...
/**OUT_WIGHT (rw) register accessor: Weight register of Rx channel 0
