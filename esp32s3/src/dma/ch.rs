...
pub mod in_dscr_bf1;
#[doc = "IN_WIGHT (rw) register accessor: Weight register of Rx channel 0\n\nYou can [`read`](crate::Reg::read) this register and get [`in_wight::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`in_wight::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@in_wight`] module"]
pub type IN_WIGHT = crate::Reg<in_wight::IN_WIGHT_SPEC>;
...
#[doc = "OUT_WIGHT (rw) register accessor: Weight register of Rx channel 0\n\nYou can [`read`](crate::Reg::read) this register and get [`out_wight::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`out_wight::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@out_wight`] module"]
pub type OUT_WIGHT = crate::Reg<out_wight::OUT_WIGHT_SPEC>;
#[doc = "Weight register of Rx channel 0"]
pub mod out_wight;
