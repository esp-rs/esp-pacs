...
impl W {
    ...
    #[doc = "Bit 4 - The interrupt enable bit for the OUTFIFO_OVF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_ovf_l1_ch_int_ena(&mut self) -> OUTFIFO_OVF_L1_CH_INT_ENA_W<4> {
        OUTFIFO_OVF_L1_CH_INT_ENA_W::new(self)
    }
    #[doc = "Bit 5 - The interrupt enable bit for the OUTFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_udf_l1_ch_int_ena(&mut self) -> OUTFIFO_UDF_L1_CH_INT_ENA_W<5> {
        OUTFIFO_UDF_L1_CH_INT_ENA_W::new(self)
    }
    #[doc = "Bit 6 - The interrupt enable bit for the OUTFIFO_OVF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_ovf_l3_ch_int_ena(&mut self) -> OUTFIFO_OVF_L3_CH_INT_ENA_W<6> {
        OUTFIFO_OVF_L3_CH_INT_ENA_W::new(self)
    }
    #[doc = "Bit 7 - The interrupt enable bit for the OUTFIFO_UDF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_udf_l3_ch_int_ena(&mut self) -> OUTFIFO_UDF_L3_CH_INT_ENA_W<7> {
        OUTFIFO_UDF_L3_CH_INT_ENA_W::new(self)
    }
