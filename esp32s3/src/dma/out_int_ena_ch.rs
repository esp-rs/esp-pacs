...
pub type OUTFIFO_OVF_L1_W<'a, const O: u8> = crate::BitWriter<'a, OUT_INT_ENA_CH_SPEC, O>;
...
pub type OUTFIFO_UDF_L1_W<'a, const O: u8> = crate::BitWriter<'a, OUT_INT_ENA_CH_SPEC, O>;
...
pub type OUTFIFO_OVF_L3_W<'a, const O: u8> = crate::BitWriter<'a, OUT_INT_ENA_CH_SPEC, O>;
...
pub type OUTFIFO_UDF_L3_W<'a, const O: u8> = crate::BitWriter<'a, OUT_INT_ENA_CH_SPEC, O>;
impl R {
