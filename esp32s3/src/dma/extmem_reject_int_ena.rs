///Register `EXTMEM_REJECT_INT_ENA` reader
pub type R = crate::R<EXTMEM_REJECT_INT_ENA_SPEC>;
///Register `EXTMEM_REJECT_INT_ENA` writer
pub type W = crate::W<EXTMEM_REJECT_INT_ENA_SPEC>;
///Field `EXTMEM_REJECT_INT_ENA` reader - The interrupt enable bit for the EXTMEM_REJECT_INT interrupt.
pub type EXTMEM_REJECT_INT_ENA_R = crate::BitReader;
///Field `EXTMEM_REJECT_INT_ENA` writer - The interrupt enable bit for the EXTMEM_REJECT_INT interrupt.
...
///`read()` method returns [`extmem_reject_int_ena::R`](R) reader structure
impl crate::Readable for EXTMEM_REJECT_INT_ENA_SPEC {}
///`write(|w| ..)` method takes [`extmem_reject_int_ena::W`](W) writer structure
