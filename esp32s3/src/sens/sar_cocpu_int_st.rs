...
///Field `SAR_COCPU_TOUCH_DONE_INT_ST` reader - int state of touch done
pub type SAR_COCPU_TOUCH_DONE_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_TOUCH_INACTIVE_INT_ST` reader - int state of from touch inactive
pub type SAR_COCPU_TOUCH_INACTIVE_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_TOUCH_ACTIVE_INT_ST` reader - int state of touch active
pub type SAR_COCPU_TOUCH_ACTIVE_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_SARADC1_INT_ST` reader - int state of from saradc1
pub type SAR_COCPU_SARADC1_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_SARADC2_INT_ST` reader - int state of from saradc2
pub type SAR_COCPU_SARADC2_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_TSENS_INT_ST` reader - int state of tsens
pub type SAR_COCPU_TSENS_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_START_INT_ST` reader - int state of start
pub type SAR_COCPU_START_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_SW_INT_ST` reader - int state of software
pub type SAR_COCPU_SW_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_SWD_INT_ST` reader - int state of super watch dog
pub type SAR_COCPU_SWD_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_TOUCH_TIMEOUT_INT_ST` reader - int state of timeout done
pub type SAR_COCPU_TOUCH_TIMEOUT_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ST` reader - int state of approach loop done
pub type SAR_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ST_R = crate::BitReader;
///Field `SAR_COCPU_TOUCH_SCAN_DONE_INT_ST` reader - int state of touch scan done
pub type SAR_COCPU_TOUCH_SCAN_DONE_INT_ST_R = crate::BitReader;
impl R {
    ///Bit 0 - int state of touch done
    #[inline(always)]
    pub fn sar_cocpu_touch_done_int_st(&self) -> SAR_COCPU_TOUCH_DONE_INT_ST_R {
        SAR_COCPU_TOUCH_DONE_INT_ST_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - int state of from touch inactive
    #[inline(always)]
    ...
    ///Bit 2 - int state of touch active
    #[inline(always)]
    ...
    ///Bit 10 - int state of approach loop done
    #[inline(always)]
...
///`read()` method returns [`sar_cocpu_int_st::R`](R) reader structure
