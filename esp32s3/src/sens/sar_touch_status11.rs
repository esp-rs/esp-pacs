...
pub struct R(crate::R<SAR_TOUCH_STATUS11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SAR_TOUCH_STATUS11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SAR_TOUCH_STATUS11_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SAR_TOUCH_STATUS11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `SAR_TOUCH_PAD11_DATA` reader - touch data debounce of touch pad 11"]
pub type SAR_TOUCH_PAD11_DATA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SAR_TOUCH_PAD11_DEBOUNCE` reader - touch current debounce of touch pad 11"]
pub type SAR_TOUCH_PAD11_DEBOUNCE_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bits 0:21 - touch data debounce of touch pad 11"]
    #[inline(always)]
    pub fn sar_touch_pad11_data(&self) -> SAR_TOUCH_PAD11_DATA_R {
        SAR_TOUCH_PAD11_DATA_R::new((self.bits & 0x003f_ffff) as u32)
    }
...
#[doc = "touch channel status of touch pad 11\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sar_touch_status11](index.html) module"]
