...
///Field `SAR_TOUCH_PAD11_DATA` reader - touch data debounce of touch pad 11
pub type SAR_TOUCH_PAD11_DATA_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_PAD11_DEBOUNCE` reader - touch current debounce of touch pad 11
pub type SAR_TOUCH_PAD11_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - touch data debounce of touch pad 11
    #[inline(always)]
    pub fn sar_touch_pad11_data(&self) -> SAR_TOUCH_PAD11_DATA_R {
        SAR_TOUCH_PAD11_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - touch current debounce of touch pad 11
    #[inline(always)]
