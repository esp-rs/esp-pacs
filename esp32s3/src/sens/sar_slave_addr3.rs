...
///Field `SAR_I2C_SLAVE_ADDR5` reader - configure i2c slave address5
pub type SAR_I2C_SLAVE_ADDR5_R = crate::FieldReader<u16>;
///Field `SAR_I2C_SLAVE_ADDR5` writer - configure i2c slave address5
pub type SAR_I2C_SLAVE_ADDR5_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `SAR_I2C_SLAVE_ADDR4` reader - configure i2c slave address4
pub type SAR_I2C_SLAVE_ADDR4_R = crate::FieldReader<u16>;
///Field `SAR_I2C_SLAVE_ADDR4` writer - configure i2c slave address4
