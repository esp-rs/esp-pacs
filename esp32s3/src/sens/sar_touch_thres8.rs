...
pub type SAR_TOUCH_OUT_TH8_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SAR_TOUCH_OUT_TH8` writer - Finger threshold for touch pad 8"]
pub type SAR_TOUCH_OUT_TH8_W<'a, const O: u8> =
    crate::FieldWriter<'a, SAR_TOUCH_THRES8_SPEC, 22, O, u32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar_touch_out_th8(&mut self) -> SAR_TOUCH_OUT_TH8_W<0> {
