...
pub type SAR_TOUCH_OUT_TH8_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 22, O, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_THRES8")
            .field(
                "sar_touch_out_th8",
                &format_args!("{}", self.sar_touch_out_th8().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar_touch_out_th8(&mut self) -> SAR_TOUCH_OUT_TH8_W<SAR_TOUCH_THRES8_SPEC, 0> {
        SAR_TOUCH_OUT_TH8_W::new(self)
    }
