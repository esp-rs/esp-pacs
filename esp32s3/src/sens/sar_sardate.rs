...
impl W {
    #[doc = "Bits 0:27 - version"]
    #[inline(always)]
    pub fn sar_date(&mut self) -> SAR_DATE_W<'_, SAR_SARDATE_SPEC> {
        SAR_DATE_W::new(self, 0)
    }
}
#[doc = "version\n\nYou can [`read`](crate::Reg::read) this register and get [`sar_sardate::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sar_sardate::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
