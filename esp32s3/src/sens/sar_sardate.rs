///Register `SAR_SARDATE` reader
pub type R = crate::R<SAR_SARDATE_SPEC>;
///Register `SAR_SARDATE` writer
pub type W = crate::W<SAR_SARDATE_SPEC>;
///Field `SAR_DATE` reader - version
pub type SAR_DATE_R = crate::FieldReader<u32>;
///Field `SAR_DATE` writer - version
...
///`read()` method returns [`sar_sardate::R`](R) reader structure
impl crate::Readable for SAR_SARDATE_SPEC {}
///`write(|w| ..)` method takes [`sar_sardate::W`](W) writer structure
