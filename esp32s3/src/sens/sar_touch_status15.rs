...
///Field `SAR_TOUCH_SLP_DATA` reader - touch data debounce of sleep pad
pub type SAR_TOUCH_SLP_DATA_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_SLP_DEBOUNCE` reader - touch current debounce of sleep pad
pub type SAR_TOUCH_SLP_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - touch data debounce of sleep pad
    #[inline(always)]
    pub fn sar_touch_slp_data(&self) -> SAR_TOUCH_SLP_DATA_R {
        SAR_TOUCH_SLP_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - touch current debounce of sleep pad
    #[inline(always)]
