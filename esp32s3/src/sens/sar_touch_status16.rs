...
///Field `SAR_TOUCH_APPROACH_PAD2_CNT` reader - touch current approach count of approach pad2
pub type SAR_TOUCH_APPROACH_PAD2_CNT_R = crate::FieldReader;
///Field `SAR_TOUCH_APPROACH_PAD1_CNT` reader - touch current approach count of approach pad1
pub type SAR_TOUCH_APPROACH_PAD1_CNT_R = crate::FieldReader;
///Field `SAR_TOUCH_APPROACH_PAD0_CNT` reader - touch current approach count of approach pad0
pub type SAR_TOUCH_APPROACH_PAD0_CNT_R = crate::FieldReader;
///Field `SAR_TOUCH_SLP_APPROACH_CNT` reader - touch current approach count of slp pad
