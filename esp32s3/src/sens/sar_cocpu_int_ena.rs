...
pub type SAR_COCPU_TOUCH_DONE_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_TOUCH_INACTIVE_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_TOUCH_ACTIVE_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_SARADC1_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_SARADC2_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_TSENS_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_START_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_SW_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_SWD_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_TOUCH_TIMEOUT_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SAR_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W<'a, REG, const O: u8> =
...
pub type SAR_COCPU_TOUCH_SCAN_DONE_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn sar_cocpu_touch_done_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_DONE_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 0> {
    ...
    pub fn sar_cocpu_touch_inactive_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_INACTIVE_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 1> {
    ...
    pub fn sar_cocpu_touch_active_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_ACTIVE_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 2> {
    ...
    pub fn sar_cocpu_saradc1_int_ena(
        &mut self,
    ) -> SAR_COCPU_SARADC1_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 3> {
    ...
    pub fn sar_cocpu_saradc2_int_ena(
        &mut self,
    ) -> SAR_COCPU_SARADC2_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 4> {
    ...
    pub fn sar_cocpu_tsens_int_ena(
        &mut self,
    ) -> SAR_COCPU_TSENS_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 5> {
    ...
    pub fn sar_cocpu_start_int_ena(
        &mut self,
    ) -> SAR_COCPU_START_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 6> {
        SAR_COCPU_START_INT_ENA_W::new(self)
    }
    #[doc = "Bit 7 - int enable of software"]
    #[inline(always)]
    #[must_use]
    pub fn sar_cocpu_sw_int_ena(&mut self) -> SAR_COCPU_SW_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 7> {
        SAR_COCPU_SW_INT_ENA_W::new(self)
    }
    #[doc = "Bit 8 - int enable of super watch dog"]
    #[inline(always)]
    #[must_use]
    pub fn sar_cocpu_swd_int_ena(&mut self) -> SAR_COCPU_SWD_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 8> {
    ...
    pub fn sar_cocpu_touch_timeout_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_TIMEOUT_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 9> {
    ...
    pub fn sar_cocpu_touch_approach_loop_done_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 10> {
    ...
    pub fn sar_cocpu_touch_scan_done_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_SCAN_DONE_INT_ENA_W<SAR_COCPU_INT_ENA_SPEC, 11> {
