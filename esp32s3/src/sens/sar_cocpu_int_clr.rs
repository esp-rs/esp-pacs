...
impl W {
    ...
    pub fn sar_cocpu_touch_done_int_clr(
        &mut self,
    ) -> SAR_COCPU_TOUCH_DONE_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
    ...
    pub fn sar_cocpu_touch_inactive_int_clr(
        &mut self,
    ) -> SAR_COCPU_TOUCH_INACTIVE_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
    ...
    pub fn sar_cocpu_touch_active_int_clr(
        &mut self,
    ) -> SAR_COCPU_TOUCH_ACTIVE_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
    ...
    pub fn sar_cocpu_saradc1_int_clr(
        &mut self,
    ) -> SAR_COCPU_SARADC1_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
    ...
    pub fn sar_cocpu_saradc2_int_clr(
        &mut self,
    ) -> SAR_COCPU_SARADC2_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
    ...
    pub fn sar_cocpu_tsens_int_clr(
        &mut self,
    ) -> SAR_COCPU_TSENS_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
    ...
    pub fn sar_cocpu_start_int_clr(
        &mut self,
    ) -> SAR_COCPU_START_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
    ...
    pub fn sar_cocpu_touch_timeout_int_clr(
        &mut self,
    ) -> SAR_COCPU_TOUCH_TIMEOUT_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
    ...
    pub fn sar_cocpu_touch_approach_loop_done_int_clr(
        &mut self,
    ) -> SAR_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
    ...
    pub fn sar_cocpu_touch_scan_done_int_clr(
        &mut self,
    ) -> SAR_COCPU_TOUCH_SCAN_DONE_INT_CLR_W<'_, SAR_COCPU_INT_CLR_SPEC> {
