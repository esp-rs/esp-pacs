...
///Field `SAR_TOUCH_OUT_TH4` reader - Finger threshold for touch pad 4
pub type SAR_TOUCH_OUT_TH4_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_OUT_TH4` writer - Finger threshold for touch pad 4
pub type SAR_TOUCH_OUT_TH4_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - Finger threshold for touch pad 4
    #[inline(always)]
