...
///Field `FORCE_XPD_SAR` reader - force power on/off saradc
pub type FORCE_XPD_SAR_R = crate::FieldReader;
///Field `FORCE_XPD_SAR` writer - force power on/off saradc
pub type FORCE_XPD_SAR_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SARCLK_EN` reader - no public
pub type SARCLK_EN_R = crate::BitReader;
///Field `SARCLK_EN` writer - no public
