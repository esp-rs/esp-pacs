...
///Field `SAR_TOUCH_PAD3_DATA` reader - touch data debounce of touch pad 3
pub type SAR_TOUCH_PAD3_DATA_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_PAD3_DEBOUNCE` reader - touch current debounce of touch pad 3
pub type SAR_TOUCH_PAD3_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - touch data debounce of touch pad 3
    #[inline(always)]
    pub fn sar_touch_pad3_data(&self) -> SAR_TOUCH_PAD3_DATA_R {
        SAR_TOUCH_PAD3_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - touch current debounce of touch pad 3
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_STATUS3")
            .field("sar_touch_pad3_data", &self.sar_touch_pad3_data())
            .field("sar_touch_pad3_debounce", &self.sar_touch_pad3_debounce())
            .finish()
    }
}
