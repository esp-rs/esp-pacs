///Register `SAR_TOUCH_THRES12` reader
pub type R = crate::R<SAR_TOUCH_THRES12_SPEC>;
///Register `SAR_TOUCH_THRES12` writer
pub type W = crate::W<SAR_TOUCH_THRES12_SPEC>;
///Field `SAR_TOUCH_OUT_TH12` reader - Finger threshold for touch pad 12
pub type SAR_TOUCH_OUT_TH12_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_OUT_TH12` writer - Finger threshold for touch pad 12
pub type SAR_TOUCH_OUT_TH12_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - Finger threshold for touch pad 12
    #[inline(always)]
...
///`read()` method returns [`sar_touch_thres12::R`](R) reader structure
impl crate::Readable for SAR_TOUCH_THRES12_SPEC {}
///`write(|w| ..)` method takes [`sar_touch_thres12::W`](W) writer structure
