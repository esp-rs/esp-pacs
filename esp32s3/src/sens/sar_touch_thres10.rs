///Register `SAR_TOUCH_THRES10` reader
pub type R = crate::R<SAR_TOUCH_THRES10_SPEC>;
///Register `SAR_TOUCH_THRES10` writer
pub type W = crate::W<SAR_TOUCH_THRES10_SPEC>;
///Field `SAR_TOUCH_OUT_TH10` reader - Finger threshold for touch pad 10
pub type SAR_TOUCH_OUT_TH10_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_OUT_TH10` writer - Finger threshold for touch pad 10
pub type SAR_TOUCH_OUT_TH10_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - Finger threshold for touch pad 10
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_THRES10")
            .field("sar_touch_out_th10", &self.sar_touch_out_th10())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar_touch_out_th10(&mut self) -> SAR_TOUCH_OUT_TH10_W<SAR_TOUCH_THRES10_SPEC> {
        SAR_TOUCH_OUT_TH10_W::new(self, 0)
    }
}
...
///`read()` method returns [`sar_touch_thres10::R`](R) reader structure
impl crate::Readable for SAR_TOUCH_THRES10_SPEC {}
///`write(|w| ..)` method takes [`sar_touch_thres10::W`](W) writer structure
