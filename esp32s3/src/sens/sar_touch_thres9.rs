...
pub type SAR_TOUCH_OUT_TH9_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 22, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar_touch_out_th9(&mut self) -> SAR_TOUCH_OUT_TH9_W<SAR_TOUCH_THRES9_SPEC, 0> {
