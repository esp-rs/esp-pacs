...
pub type SAR_SAR2_CLK_DIV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SAR_SAR2_CLK_DIV` writer - clock divider"]
pub type SAR_SAR2_CLK_DIV_W<'a, const O: u8> =
...
pub type SAR_SAR2_WAIT_ARB_CYCLE_R = crate::FieldReader<u8, u8>;
...
pub type SAR_SAR2_CLK_GATED_R = crate::BitReader<bool>;
#[doc = "Field `SAR_SAR2_CLK_GATED` writer - ******* Description ***********"]
pub type SAR_SAR2_CLK_GATED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SAR_READER2_CTRL_SPEC, bool, O>;
#[doc = "Field `SAR_SAR2_SAMPLE_NUM` reader - ******* Description ***********"]
pub type SAR_SAR2_SAMPLE_NUM_R = crate::FieldReader<u8, u8>;
