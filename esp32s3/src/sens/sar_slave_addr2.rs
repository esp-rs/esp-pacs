...
///`read()` method returns [`sar_slave_addr2::R`](R) reader structure
impl crate::Readable for SAR_SLAVE_ADDR2_SPEC {}
///`write(|w| ..)` method takes [`sar_slave_addr2::W`](W) writer structure
