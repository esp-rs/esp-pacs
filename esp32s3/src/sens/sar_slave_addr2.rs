...
impl W {
    #[doc = "Bits 0:10 - configure i2c slave address3"]
    #[inline(always)]
    pub fn sar_i2c_slave_addr3(&mut self) -> SAR_I2C_SLAVE_ADDR3_W<'_, SAR_SLAVE_ADDR2_SPEC> {
        SAR_I2C_SLAVE_ADDR3_W::new(self, 0)
    }
    #[doc = "Bits 11:21 - configure i2c slave address2"]
    #[inline(always)]
    pub fn sar_i2c_slave_addr2(&mut self) -> SAR_I2C_SLAVE_ADDR2_W<'_, SAR_SLAVE_ADDR2_SPEC> {
