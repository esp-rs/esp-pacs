///Register `SAR_READER2_STATUS` reader
pub type R = crate::R<SAR_READER2_STATUS_SPEC>;
///Field `SAR_SAR2_READER_STATUS` reader - get saradc1 reader controller status
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_READER2_STATUS")
            .field("sar_sar2_reader_status", &self.sar_sar2_reader_status())
            .finish()
    }
}
...
///`read()` method returns [`sar_reader2_status::R`](R) reader structure
