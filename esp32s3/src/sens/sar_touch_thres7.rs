...
pub type SAR_TOUCH_OUT_TH7_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SAR_TOUCH_OUT_TH7` writer - Finger threshold for touch pad 7"]
pub type SAR_TOUCH_OUT_TH7_W<'a, const O: u8> =
    crate::FieldWriter<'a, SAR_TOUCH_THRES7_SPEC, 22, O, u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_THRES7")
            .field(
                "sar_touch_out_th7",
                &format_args!("{}", self.sar_touch_out_th7().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SAR_TOUCH_THRES7_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar_touch_out_th7(&mut self) -> SAR_TOUCH_OUT_TH7_W<0> {
        SAR_TOUCH_OUT_TH7_W::new(self)
    }
