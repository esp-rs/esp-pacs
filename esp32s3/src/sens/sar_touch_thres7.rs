///Register `SAR_TOUCH_THRES7` reader
pub type R = crate::R<SAR_TOUCH_THRES7_SPEC>;
///Register `SAR_TOUCH_THRES7` writer
pub type W = crate::W<SAR_TOUCH_THRES7_SPEC>;
///Field `SAR_TOUCH_OUT_TH7` reader - Finger threshold for touch pad 7
pub type SAR_TOUCH_OUT_TH7_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_OUT_TH7` writer - Finger threshold for touch pad 7
pub type SAR_TOUCH_OUT_TH7_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - Finger threshold for touch pad 7
    #[inline(always)]
...
///`read()` method returns [`sar_touch_thres7::R`](R) reader structure
impl crate::Readable for SAR_TOUCH_THRES7_SPEC {}
///`write(|w| ..)` method takes [`sar_touch_thres7::W`](W) writer structure
