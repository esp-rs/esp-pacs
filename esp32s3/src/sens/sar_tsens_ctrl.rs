...
///Field `SAR_TSENS_OUT` reader - temperature sensor data out
pub type SAR_TSENS_OUT_R = crate::FieldReader;
///Field `SAR_TSENS_READY` reader - indicate temperature sensor out ready
pub type SAR_TSENS_READY_R = crate::BitReader;
///Field `SAR_TSENS_INT_EN` reader - enable temperature sensor to send out interrupt
pub type SAR_TSENS_INT_EN_R = crate::BitReader;
///Field `SAR_TSENS_INT_EN` writer - enable temperature sensor to send out interrupt
pub type SAR_TSENS_INT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_TSENS_IN_INV` reader - invert temperature sensor data
pub type SAR_TSENS_IN_INV_R = crate::BitReader;
///Field `SAR_TSENS_IN_INV` writer - invert temperature sensor data
pub type SAR_TSENS_IN_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_TSENS_CLK_DIV` reader - temperature sensor clock divider
pub type SAR_TSENS_CLK_DIV_R = crate::FieldReader;
///Field `SAR_TSENS_CLK_DIV` writer - temperature sensor clock divider
pub type SAR_TSENS_CLK_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SAR_TSENS_POWER_UP` reader - temperature sensor power up
pub type SAR_TSENS_POWER_UP_R = crate::BitReader;
///Field `SAR_TSENS_POWER_UP` writer - temperature sensor power up
pub type SAR_TSENS_POWER_UP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_TSENS_POWER_UP_FORCE` reader - 1: dump out &amp; power up controlled by SW 0: by FSM
pub type SAR_TSENS_POWER_UP_FORCE_R = crate::BitReader;
///Field `SAR_TSENS_POWER_UP_FORCE` writer - 1: dump out &amp; power up controlled by SW 0: by FSM
pub type SAR_TSENS_POWER_UP_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_TSENS_DUMP_OUT` reader - temperature sensor dump out only active when reg_tsens_power_up_force = 1
pub type SAR_TSENS_DUMP_OUT_R = crate::BitReader;
///Field `SAR_TSENS_DUMP_OUT` writer - temperature sensor dump out only active when reg_tsens_power_up_force = 1
