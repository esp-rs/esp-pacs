///Register `SAR_NOUSE` reader
pub type R = crate::R<SAR_NOUSE_SPEC>;
///Register `SAR_NOUSE` writer
pub type W = crate::W<SAR_NOUSE_SPEC>;
///Field `SAR_NOUSE` reader - no public
pub type SAR_NOUSE_R = crate::FieldReader<u32>;
///Field `SAR_NOUSE` writer - no public
...
///`read()` method returns [`sar_nouse::R`](R) reader structure
impl crate::Readable for SAR_NOUSE_SPEC {}
///`write(|w| ..)` method takes [`sar_nouse::W`](W) writer structure
