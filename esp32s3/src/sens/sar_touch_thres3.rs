///Register `SAR_TOUCH_THRES3` reader
pub type R = crate::R<SAR_TOUCH_THRES3_SPEC>;
///Register `SAR_TOUCH_THRES3` writer
pub type W = crate::W<SAR_TOUCH_THRES3_SPEC>;
///Field `SAR_TOUCH_OUT_TH3` reader - Finger threshold for touch pad 3
pub type SAR_TOUCH_OUT_TH3_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_OUT_TH3` writer - Finger threshold for touch pad 3
pub type SAR_TOUCH_OUT_TH3_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - Finger threshold for touch pad 3
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_THRES3")
            .field("sar_touch_out_th3", &self.sar_touch_out_th3())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sar_touch_out_th3(&mut self) -> SAR_TOUCH_OUT_TH3_W<SAR_TOUCH_THRES3_SPEC> {
        SAR_TOUCH_OUT_TH3_W::new(self, 0)
    }
}
...
///`read()` method returns [`sar_touch_thres3::R`](R) reader structure
impl crate::Readable for SAR_TOUCH_THRES3_SPEC {}
///`write(|w| ..)` method takes [`sar_touch_thres3::W`](W) writer structure
