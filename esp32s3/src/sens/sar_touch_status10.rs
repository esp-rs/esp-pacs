...
///Field `SAR_TOUCH_PAD10_DATA` reader - touch data debounce of touch pad 10
pub type SAR_TOUCH_PAD10_DATA_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_PAD10_DEBOUNCE` reader - touch current debounce of touch pad 10
pub type SAR_TOUCH_PAD10_DEBOUNCE_R = crate::FieldReader;
impl R {
    ///Bits 0:21 - touch data debounce of touch pad 10
    #[inline(always)]
    pub fn sar_touch_pad10_data(&self) -> SAR_TOUCH_PAD10_DATA_R {
        SAR_TOUCH_PAD10_DATA_R::new(self.bits & 0x003f_ffff)
    }
    ///Bits 29:31 - touch current debounce of touch pad 10
    #[inline(always)]
