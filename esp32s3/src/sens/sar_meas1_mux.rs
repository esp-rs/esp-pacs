///Register `SAR_MEAS1_MUX` reader
pub type R = crate::R<SAR_MEAS1_MUX_SPEC>;
///Register `SAR_MEAS1_MUX` writer
pub type W = crate::W<SAR_MEAS1_MUX_SPEC>;
///Field `SAR1_DIG_FORCE` reader - 1: SAR ADC1 controlled by DIG ADC1 CTRL
pub type SAR1_DIG_FORCE_R = crate::BitReader;
///Field `SAR1_DIG_FORCE` writer - 1: SAR ADC1 controlled by DIG ADC1 CTRL
...
///`read()` method returns [`sar_meas1_mux::R`](R) reader structure
impl crate::Readable for SAR_MEAS1_MUX_SPEC {}
///`write(|w| ..)` method takes [`sar_meas1_mux::W`](W) writer structure
