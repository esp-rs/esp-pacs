#[doc = "Register `SAR_TOUCH_APPR_STATUS` reader"]
pub type R = crate::R<SAR_TOUCH_APPR_STATUS_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_APPR_STATUS")
            .field(
...
#[doc = "touch channel status of approach mode\n\nYou can [`read`](crate::Reg::read) this register and get [`sar_touch_appr_status::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SAR_TOUCH_APPR_STATUS_SPEC;
impl crate::RegisterSpec for SAR_TOUCH_APPR_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sar_touch_appr_status::R`](R) reader structure"]
impl crate::Readable for SAR_TOUCH_APPR_STATUS_SPEC {}
#[doc = "`reset()` method sets SAR_TOUCH_APPR_STATUS to value 0"]
impl crate::Resettable for SAR_TOUCH_APPR_STATUS_SPEC {}
