...
impl W {
    #[doc = "Bit 3 - rtc control pwdet enable"]
    #[inline(always)]
    pub fn sar_sar2_pwdet_cal_en(&mut self) -> SAR_SAR2_PWDET_CAL_EN_W<3> {
        SAR_SAR2_PWDET_CAL_EN_W::new(self)
    }
    #[doc = "Bit 4 - rtc control pkdet enable"]
    #[inline(always)]
    pub fn sar_sar2_pkdet_cal_en(&mut self) -> SAR_SAR2_PKDET_CAL_EN_W<4> {
        SAR_SAR2_PKDET_CAL_EN_W::new(self)
    }
    #[doc = "Bit 5 - SAR2_EN_TEST"]
    #[inline(always)]
    pub fn sar_sar2_en_test(&mut self) -> SAR_SAR2_EN_TEST_W<5> {
        SAR_SAR2_EN_TEST_W::new(self)
    }
    #[doc = "Bits 6:7 - no public"]
    #[inline(always)]
    pub fn sar_sar2_rstb_force(&mut self) -> SAR_SAR2_RSTB_FORCE_W<6> {
        SAR_SAR2_RSTB_FORCE_W::new(self)
    }
    #[doc = "Bits 8:15 - no public"]
    #[inline(always)]
    pub fn sar_sar2_standby_wait(&mut self) -> SAR_SAR2_STANDBY_WAIT_W<8> {
        SAR_SAR2_STANDBY_WAIT_W::new(self)
    }
    #[doc = "Bits 16:23 - no public"]
    #[inline(always)]
    pub fn sar_sar2_rstb_wait(&mut self) -> SAR_SAR2_RSTB_WAIT_W<16> {
        SAR_SAR2_RSTB_WAIT_W::new(self)
    }
    #[doc = "Bits 24:31 - no public"]
    #[inline(always)]
    pub fn sar_sar2_xpd_wait(&mut self) -> SAR_SAR2_XPD_WAIT_W<24> {
