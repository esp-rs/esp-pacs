...
///Field `SAR_SAR2_PWDET_CAL_EN` reader - rtc control pwdet enable
pub type SAR_SAR2_PWDET_CAL_EN_R = crate::BitReader;
///Field `SAR_SAR2_PWDET_CAL_EN` writer - rtc control pwdet enable
pub type SAR_SAR2_PWDET_CAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_SAR2_PKDET_CAL_EN` reader - rtc control pkdet enable
pub type SAR_SAR2_PKDET_CAL_EN_R = crate::BitReader;
///Field `SAR_SAR2_PKDET_CAL_EN` writer - rtc control pkdet enable
