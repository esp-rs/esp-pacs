...
///Field `SAR_TOUCH_OUT_TH1` reader - Finger threshold for touch pad 1
pub type SAR_TOUCH_OUT_TH1_R = crate::FieldReader<u32>;
///Field `SAR_TOUCH_OUT_TH1` writer - Finger threshold for touch pad 1
pub type SAR_TOUCH_OUT_TH1_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - Finger threshold for touch pad 1
    #[inline(always)]
