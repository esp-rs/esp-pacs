...
///Field `MEAS1_START_SAR` reader - SAR ADC1 controller (in RTC) starts conversion
pub type MEAS1_START_SAR_R = crate::BitReader;
///Field `MEAS1_START_SAR` writer - SAR ADC1 controller (in RTC) starts conversion
pub type MEAS1_START_SAR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEAS1_START_FORCE` reader - 1: SAR ADC1 controller (in RTC) is started by SW
pub type MEAS1_START_FORCE_R = crate::BitReader;
///Field `MEAS1_START_FORCE` writer - 1: SAR ADC1 controller (in RTC) is started by SW
pub type MEAS1_START_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR1_EN_PAD` reader - SAR ADC1 pad enable bitmap
pub type SAR1_EN_PAD_R = crate::FieldReader<u16>;
///Field `SAR1_EN_PAD` writer - SAR ADC1 pad enable bitmap
pub type SAR1_EN_PAD_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `SAR1_EN_PAD_FORCE` reader - 1: SAR ADC1 pad enable bitmap is controlled by SW
pub type SAR1_EN_PAD_FORCE_R = crate::BitReader;
///Field `SAR1_EN_PAD_FORCE` writer - 1: SAR ADC1 pad enable bitmap is controlled by SW
