...
///Field `SYS_DATA_PART0_1` reader - Stores the fist 32 bits of the zeroth part of system data.
pub type SYS_DATA_PART0_1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the fist 32 bits of the zeroth part of system data.
    #[inline(always)]
