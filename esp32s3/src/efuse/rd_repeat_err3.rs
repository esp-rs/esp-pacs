...
///Field `DIS_DOWNLOAD_MODE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_DOWNLOAD_MODE_ERR_R = crate::BitReader;
///Field `DIS_LEGACY_SPI_BOOT_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_LEGACY_SPI_BOOT_ERR_R = crate::BitReader;
///Field `UART_PRINT_CHANNEL_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type UART_PRINT_CHANNEL_ERR_R = crate::BitReader;
///Field `FLASH_ECC_MODE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type FLASH_ECC_MODE_ERR_R = crate::BitReader;
///Field `DIS_USB_DOWNLOAD_MODE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_USB_DOWNLOAD_MODE_ERR_R = crate::BitReader;
///Field `ENABLE_SECURITY_DOWNLOAD_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type ENABLE_SECURITY_DOWNLOAD_ERR_R = crate::BitReader;
///Field `UART_PRINT_CONTROL_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type UART_PRINT_CONTROL_ERR_R = crate::FieldReader;
///Field `PIN_POWER_SELECTION_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type PIN_POWER_SELECTION_ERR_R = crate::BitReader;
///Field `FLASH_TYPE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type FLASH_TYPE_ERR_R = crate::BitReader;
///Field `FLASH_PAGE_SIZE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type FLASH_PAGE_SIZE_ERR_R = crate::FieldReader;
///Field `FLASH_ECC_EN_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type FLASH_ECC_EN_ERR_R = crate::BitReader;
///Field `FORCE_SEND_RESUME_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type FORCE_SEND_RESUME_ERR_R = crate::BitReader;
///Field `SECURE_VERSION_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type SECURE_VERSION_ERR_R = crate::FieldReader<u16>;
///Field `POWERGLITCH_EN_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type POWERGLITCH_EN_ERR_R = crate::BitReader;
///Field `RPT4_RESERVED1_ERR` reader - Reserved.
pub type RPT4_RESERVED1_ERR_R = crate::BitReader;
impl R {
    ///Bit 0 - If any bits in this filed are 1, then it indicates a programming error.
    #[inline(always)]
    pub fn dis_download_mode_err(&self) -> DIS_DOWNLOAD_MODE_ERR_R {
        DIS_DOWNLOAD_MODE_ERR_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - If any bits in this filed are 1, then it indicates a programming error.
    #[inline(always)]
    pub fn dis_legacy_spi_boot_err(&self) -> DIS_LEGACY_SPI_BOOT_ERR_R {
        DIS_LEGACY_SPI_BOOT_ERR_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - If any bits in this filed are 1, then it indicates a programming error.
    #[inline(always)]
    pub fn uart_print_channel_err(&self) -> UART_PRINT_CHANNEL_ERR_R {
        UART_PRINT_CHANNEL_ERR_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - If any bits in this filed are 1, then it indicates a programming error.
    #[inline(always)]
    ...
    ///Bits 6:7 - If any bits in this filed are 1, then it indicates a programming error.
    #[inline(always)]
    ...
    ///Bits 10:11 - If any bits in this filed are 1, then it indicates a programming error.
    #[inline(always)]
    ...
    ///Bits 14:29 - If any bits in this filed are 1, then it indicates a programming error.
    #[inline(always)]
    pub fn secure_version_err(&self) -> SECURE_VERSION_ERR_R {
        SECURE_VERSION_ERR_R::new(((self.bits >> 14) & 0xffff) as u16)
    }
    ///Bit 30 - If any bits in this filed are 1, then it indicates a programming error.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_ERR3")
            ...
            .field("flash_ecc_mode_err", &self.flash_ecc_mode_err())
            .field(
            ...
            .field("flash_page_size_err", &self.flash_page_size_err())
