///Register `RD_SYS_PART1_DATA4` reader
pub type R = crate::R<RD_SYS_PART1_DATA4_SPEC>;
///Field `SYS_DATA_PART1_4` reader - Stores the fourth 32 bits of the first part of system data.
pub type SYS_DATA_PART1_4_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the fourth 32 bits of the first part of system data.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_sys_part1_data4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_SYS_PART1_DATA4_SPEC;
impl crate::RegisterSpec for RD_SYS_PART1_DATA4_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_sys_part1_data4::R`](R) reader structure
