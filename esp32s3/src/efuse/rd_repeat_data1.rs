...
///Field `VDD_SPI_XPD` reader - SPI regulator power up signal.
pub type VDD_SPI_XPD_R = crate::BitReader;
///Field `VDD_SPI_TIEH` reader - SPI regulator output is short connected to VDD3P3_RTC_IO.
pub type VDD_SPI_TIEH_R = crate::BitReader;
///Field `VDD_SPI_FORCE` reader - Set this bit and force to use the configuration of eFuse to configure VDD_SPI.
...
///Field `WDT_DELAY_SEL` reader - Selects RTC watchdog timeout threshold, in unit of slow clock cycle. 0: 40000. 1: 80000. 2: 160000. 3:320000.
pub type WDT_DELAY_SEL_R = crate::FieldReader;
///Field `SPI_BOOT_CRYPT_CNT` reader - Set this bit to enable SPI boot encrypt/decrypt. Odd number of 1: enable. even number of 1: disable.
pub type SPI_BOOT_CRYPT_CNT_R = crate::FieldReader;
///Field `SECURE_BOOT_KEY_REVOKE0` reader - Set this bit to enable revoking first secure boot key.
pub type SECURE_BOOT_KEY_REVOKE0_R = crate::BitReader;
///Field `SECURE_BOOT_KEY_REVOKE1` reader - Set this bit to enable revoking second secure boot key.
pub type SECURE_BOOT_KEY_REVOKE1_R = crate::BitReader;
///Field `SECURE_BOOT_KEY_REVOKE2` reader - Set this bit to enable revoking third secure boot key.
pub type SECURE_BOOT_KEY_REVOKE2_R = crate::BitReader;
///Field `KEY_PURPOSE_0` reader - Purpose of Key0.
pub type KEY_PURPOSE_0_R = crate::FieldReader;
///Field `KEY_PURPOSE_1` reader - Purpose of Key1.
