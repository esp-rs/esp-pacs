...
///Field `KEY_PURPOSE_2_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type KEY_PURPOSE_2_ERR_R = crate::FieldReader;
///Field `KEY_PURPOSE_3_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type KEY_PURPOSE_3_ERR_R = crate::FieldReader;
///Field `KEY_PURPOSE_4_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type KEY_PURPOSE_4_ERR_R = crate::FieldReader;
///Field `KEY_PURPOSE_5_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type KEY_PURPOSE_5_ERR_R = crate::FieldReader;
///Field `RPT4_RESERVED0_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type RPT4_RESERVED0_ERR_R = crate::FieldReader;
///Field `SECURE_BOOT_EN_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type SECURE_BOOT_EN_ERR_R = crate::BitReader;
///Field `SECURE_BOOT_AGGRESSIVE_REVOKE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type SECURE_BOOT_AGGRESSIVE_REVOKE_ERR_R = crate::BitReader;
///Field `DIS_USB_JTAG_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_USB_JTAG_ERR_R = crate::BitReader;
///Field `DIS_USB_DEVICE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_USB_DEVICE_ERR_R = crate::BitReader;
///Field `STRAP_JTAG_SEL_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type STRAP_JTAG_SEL_ERR_R = crate::BitReader;
///Field `USB_PHY_SEL_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type USB_PHY_SEL_ERR_R = crate::BitReader;
///Field `POWER_GLITCH_DSENSE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type POWER_GLITCH_DSENSE_ERR_R = crate::FieldReader;
///Field `FLASH_TPUW_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
