///Register `RD_KEY1_DATA6` reader
pub type R = crate::R<RD_KEY1_DATA6_SPEC>;
///Field `KEY1_DATA6` reader - Stores the sixth 32 bits of KEY1.
pub type KEY1_DATA6_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the sixth 32 bits of KEY1.
    #[inline(always)]
...
///`read()` method returns [`rd_key1_data6::R`](R) reader structure
