///Register `RD_SYS_PART2_DATA7` reader
pub type R = crate::R<RD_SYS_PART2_DATA7_SPEC>;
///Field `SYS_DATA_PART2_7` reader - Stores the 7th 32 bits of the 2nd part of system data.
pub type SYS_DATA_PART2_7_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the 7th 32 bits of the 2nd part of system data.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_SYS_PART2_DATA7")
            .field("sys_data_part2_7", &self.sys_data_part2_7())
            .finish()
    }
}
...
///`read()` method returns [`rd_sys_part2_data7::R`](R) reader structure
