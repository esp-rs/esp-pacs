...
///Field `KEY_PURPOSE_2` reader - Purpose of Key2.
pub type KEY_PURPOSE_2_R = crate::FieldReader;
///Field `KEY_PURPOSE_3` reader - Purpose of Key3.
pub type KEY_PURPOSE_3_R = crate::FieldReader;
///Field `KEY_PURPOSE_4` reader - Purpose of Key4.
pub type KEY_PURPOSE_4_R = crate::FieldReader;
///Field `KEY_PURPOSE_5` reader - Purpose of Key5.
...
///Field `SECURE_BOOT_AGGRESSIVE_REVOKE` reader - Set this bit to enable revoking aggressive secure boot.
...
///Field `STRAP_JTAG_SEL` reader - Set this bit to enable selection between usb_to_jtag and pad_to_jtag through strapping gpio10 when both reg_dis_usb_jtag and reg_dis_pad_jtag are equal to 0.
pub type STRAP_JTAG_SEL_R = crate::BitReader;
///Field `USB_PHY_SEL` reader - This bit is used to switch internal PHY and external PHY for USB OTG and USB Device. 0: internal PHY is assigned to USB Device while external PHY is assigned to USB OTG. 1: internal PHY is assigned to USB OTG while external PHY is assigned to USB Device.
