///Register `RD_KEY1_DATA4` reader
pub type R = crate::R<RD_KEY1_DATA4_SPEC>;
///Field `KEY1_DATA4` reader - Stores the fourth 32 bits of KEY1.
pub type KEY1_DATA4_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the fourth 32 bits of KEY1.
    #[inline(always)]
...
///`read()` method returns [`rd_key1_data4::R`](R) reader structure
