///Register `RD_SYS_PART2_DATA1` reader
pub type R = crate::R<RD_SYS_PART2_DATA1_SPEC>;
///Field `SYS_DATA_PART2_1` reader - Stores the 1st 32 bits of the 2nd part of system data.
pub type SYS_DATA_PART2_1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the 1st 32 bits of the 2nd part of system data.
    #[inline(always)]
...
///`read()` method returns [`rd_sys_part2_data1::R`](R) reader structure
