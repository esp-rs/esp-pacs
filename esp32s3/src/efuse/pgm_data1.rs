///Register `PGM_DATA1` reader
pub type R = crate::R<PGM_DATA1_SPEC>;
///Register `PGM_DATA1` writer
pub type W = crate::W<PGM_DATA1_SPEC>;
///Field `PGM_DATA_1` reader - The content of the 1st 32-bit data to be programmed.
pub type PGM_DATA_1_R = crate::FieldReader<u32>;
///Field `PGM_DATA_1` writer - The content of the 1st 32-bit data to be programmed.
pub type PGM_DATA_1_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - The content of the 1st 32-bit data to be programmed.
    #[inline(always)]
...
///`read()` method returns [`pgm_data1::R`](R) reader structure
impl crate::Readable for PGM_DATA1_SPEC {}
///`write(|w| ..)` method takes [`pgm_data1::W`](W) writer structure
