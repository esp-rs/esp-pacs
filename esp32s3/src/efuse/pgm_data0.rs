...
///Register `PGM_DATA0` writer
pub type W = crate::W<PGM_DATA0_SPEC>;
///Field `PGM_DATA_0` reader - The content of the 0th 32-bit data to be programmed.
pub type PGM_DATA_0_R = crate::FieldReader<u32>;
///Field `PGM_DATA_0` writer - The content of the 0th 32-bit data to be programmed.
pub type PGM_DATA_0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - The content of the 0th 32-bit data to be programmed.
    #[inline(always)]
...
///`read()` method returns [`pgm_data0::R`](R) reader structure
impl crate::Readable for PGM_DATA0_SPEC {}
///`write(|w| ..)` method takes [`pgm_data0::W`](W) writer structure
