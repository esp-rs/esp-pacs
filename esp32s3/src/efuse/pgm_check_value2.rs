///Register `PGM_CHECK_VALUE2` reader
pub type R = crate::R<PGM_CHECK_VALUE2_SPEC>;
///Register `PGM_CHECK_VALUE2` writer
pub type W = crate::W<PGM_CHECK_VALUE2_SPEC>;
///Field `PGM_RS_DATA_2` reader - The content of the 2nd 32-bit RS code to be programmed.
pub type PGM_RS_DATA_2_R = crate::FieldReader<u32>;
///Field `PGM_RS_DATA_2` writer - The content of the 2nd 32-bit RS code to be programmed.
pub type PGM_RS_DATA_2_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - The content of the 2nd 32-bit RS code to be programmed.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PGM_CHECK_VALUE2")
            .field("pgm_rs_data_2", &self.pgm_rs_data_2())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`pgm_check_value2::R`](R) reader structure
impl crate::Readable for PGM_CHECK_VALUE2_SPEC {}
///`write(|w| ..)` method takes [`pgm_check_value2::W`](W) writer structure
