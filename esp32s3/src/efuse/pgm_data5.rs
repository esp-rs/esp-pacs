...
///Field `PGM_DATA_5` reader - The content of the 5th 32-bit data to be programmed.
pub type PGM_DATA_5_R = crate::FieldReader<u32>;
///Field `PGM_DATA_5` writer - The content of the 5th 32-bit data to be programmed.
