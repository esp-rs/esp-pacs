...
///Field `VDD_SPI_DREFM_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_DREFM_ERR_R = crate::FieldReader;
///Field `VDD_SPI_DREFL_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_DREFL_ERR_R = crate::FieldReader;
///Field `VDD_SPI_XPD_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_XPD_ERR_R = crate::BitReader;
///Field `VDD_SPI_TIEH_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_TIEH_ERR_R = crate::BitReader;
///Field `VDD_SPI_FORCE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_FORCE_ERR_R = crate::BitReader;
///Field `VDD_SPI_EN_INIT_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_EN_INIT_ERR_R = crate::BitReader;
///Field `VDD_SPI_ENCURLIM_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_ENCURLIM_ERR_R = crate::BitReader;
///Field `VDD_SPI_DCURLIM_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_DCURLIM_ERR_R = crate::FieldReader;
///Field `VDD_SPI_INIT_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_INIT_ERR_R = crate::FieldReader;
///Field `VDD_SPI_DCAP_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_DCAP_ERR_R = crate::FieldReader;
///Field `WDT_DELAY_SEL_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type WDT_DELAY_SEL_ERR_R = crate::FieldReader;
///Field `SPI_BOOT_CRYPT_CNT_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type SPI_BOOT_CRYPT_CNT_ERR_R = crate::FieldReader;
///Field `SECURE_BOOT_KEY_REVOKE0_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type SECURE_BOOT_KEY_REVOKE0_ERR_R = crate::BitReader;
///Field `SECURE_BOOT_KEY_REVOKE1_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type SECURE_BOOT_KEY_REVOKE1_ERR_R = crate::BitReader;
///Field `SECURE_BOOT_KEY_REVOKE2_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type SECURE_BOOT_KEY_REVOKE2_ERR_R = crate::BitReader;
///Field `KEY_PURPOSE_0_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type KEY_PURPOSE_0_ERR_R = crate::FieldReader;
///Field `KEY_PURPOSE_1_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
