...
///Field `DIS_DOWNLOAD_DCACHE` reader - Set this bit to disable Dcache in download mode ( boot_mode\[3:0\] is 0, 1, 2, 3, 6, 7).
...
///Field `DIS_USB` reader - Set this bit to disable USB function.
...
///Field `DIS_APP_CPU` reader - Disable app cpu.
...
///Field `EXT_PHY_ENABLE` reader - Set this bit to enable external PHY.
pub type EXT_PHY_ENABLE_R = crate::BitReader;
///Field `BTLC_GPIO_ENABLE` reader - Bluetooth GPIO signal output security level control.
