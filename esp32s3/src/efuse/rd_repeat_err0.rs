...
///Field `RD_DIS_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type RD_DIS_ERR_R = crate::FieldReader;
///Field `DIS_RTC_RAM_BOOT_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_RTC_RAM_BOOT_ERR_R = crate::BitReader;
///Field `DIS_ICACHE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_ICACHE_ERR_R = crate::BitReader;
///Field `DIS_DCACHE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_DCACHE_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_ICACHE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_DOWNLOAD_ICACHE_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_DCACHE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_DOWNLOAD_DCACHE_ERR_R = crate::BitReader;
///Field `DIS_FORCE_DOWNLOAD_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_FORCE_DOWNLOAD_ERR_R = crate::BitReader;
///Field `DIS_USB_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_USB_ERR_R = crate::BitReader;
///Field `DIS_CAN_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_CAN_ERR_R = crate::BitReader;
///Field `DIS_APP_CPU_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_APP_CPU_ERR_R = crate::BitReader;
///Field `SOFT_DIS_JTAG_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type SOFT_DIS_JTAG_ERR_R = crate::FieldReader;
///Field `DIS_PAD_JTAG_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_PAD_JTAG_ERR_R = crate::BitReader;
///Field `DIS_DOWNLOAD_MANUAL_ENCRYPT_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type DIS_DOWNLOAD_MANUAL_ENCRYPT_ERR_R = crate::BitReader;
///Field `USB_DREFH_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type USB_DREFH_ERR_R = crate::FieldReader;
///Field `USB_DREFL_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type USB_DREFL_ERR_R = crate::FieldReader;
///Field `USB_EXCHG_PINS_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type USB_EXCHG_PINS_ERR_R = crate::BitReader;
///Field `EXT_PHY_ENABLE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type EXT_PHY_ENABLE_ERR_R = crate::BitReader;
///Field `BTLC_GPIO_ENABLE_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type BTLC_GPIO_ENABLE_ERR_R = crate::FieldReader;
///Field `VDD_SPI_MODECURLIM_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
pub type VDD_SPI_MODECURLIM_ERR_R = crate::BitReader;
///Field `VDD_SPI_DREFH_ERR` reader - If any bits in this filed are 1, then it indicates a programming error.
