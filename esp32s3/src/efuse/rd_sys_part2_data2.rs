///Register `RD_SYS_PART2_DATA2` reader
pub type R = crate::R<RD_SYS_PART2_DATA2_SPEC>;
///Field `SYS_DATA_PART2_2` reader - Stores the 2nd 32 bits of the 2nd part of system data.
pub type SYS_DATA_PART2_2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the 2nd 32 bits of the 2nd part of system data.
    #[inline(always)]
...
///`read()` method returns [`rd_sys_part2_data2::R`](R) reader structure
