...
///Field `SEARCH_POS` reader - This field is used to configure the starting search position when the acceleration option of SEARCH is used.
pub type SEARCH_POS_R = crate::FieldReader<u16>;
///Field `SEARCH_POS` writer - This field is used to configure the starting search position when the acceleration option of SEARCH is used.
pub type SEARCH_POS_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    ///Bits 0:11 - This field is used to configure the starting search position when the acceleration option of SEARCH is used.
    #[inline(always)]
