...
///Field `SEARCH_ENABLE` reader - Controls the SEARCH option. 0: no acceleration(by default). 1: acceleration.
pub type SEARCH_ENABLE_R = crate::BitReader;
///Field `SEARCH_ENABLE` writer - Controls the SEARCH option. 0: no acceleration(by default). 1: acceleration.
