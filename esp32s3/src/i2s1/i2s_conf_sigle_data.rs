...
pub type I2S_SINGLE_DATA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `I2S_SINGLE_DATA` writer - The configured constant channel data to be sent out."]
pub type I2S_SINGLE_DATA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2S_CONF_SIGLE_DATA_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2s_single_data(&mut self) -> I2S_SINGLE_DATA_W<0> {
        I2S_SINGLE_DATA_W::new(self)
    }
