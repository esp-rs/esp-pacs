#[doc = "Register `I2S_TX_TDM_CTRL` reader"]
pub struct R(crate::R<I2S_TX_TDM_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2S_TX_TDM_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2S_TX_TDM_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2S_TX_TDM_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2S_TX_TDM_CTRL` writer"]
pub struct W(crate::W<I2S_TX_TDM_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2S_TX_TDM_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2S_TX_TDM_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2S_TX_TDM_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type I2S_TX_TDM_CHAN0_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN1_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN2_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN3_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN4_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN5_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN6_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN7_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN8_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN9_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN10_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN11_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN12_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN13_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN14_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_CHAN15_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
...
pub type I2S_TX_TDM_TOT_CHAN_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, u8, u8, 4, O>;
...
pub type I2S_TX_TDM_SKIP_MSK_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2S_TX_TDM_CTRL_SPEC, bool, O>;
impl R {
    ...
    pub fn i2s_tx_tdm_chan0_en(&self) -> I2S_TX_TDM_CHAN0_EN_R {
        I2S_TX_TDM_CHAN0_EN_R::new((self.bits & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan1_en(&self) -> I2S_TX_TDM_CHAN1_EN_R {
        I2S_TX_TDM_CHAN1_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan2_en(&self) -> I2S_TX_TDM_CHAN2_EN_R {
        I2S_TX_TDM_CHAN2_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan3_en(&self) -> I2S_TX_TDM_CHAN3_EN_R {
        I2S_TX_TDM_CHAN3_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan4_en(&self) -> I2S_TX_TDM_CHAN4_EN_R {
        I2S_TX_TDM_CHAN4_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan5_en(&self) -> I2S_TX_TDM_CHAN5_EN_R {
        I2S_TX_TDM_CHAN5_EN_R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan6_en(&self) -> I2S_TX_TDM_CHAN6_EN_R {
        I2S_TX_TDM_CHAN6_EN_R::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan7_en(&self) -> I2S_TX_TDM_CHAN7_EN_R {
        I2S_TX_TDM_CHAN7_EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan8_en(&self) -> I2S_TX_TDM_CHAN8_EN_R {
        I2S_TX_TDM_CHAN8_EN_R::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan9_en(&self) -> I2S_TX_TDM_CHAN9_EN_R {
        I2S_TX_TDM_CHAN9_EN_R::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan10_en(&self) -> I2S_TX_TDM_CHAN10_EN_R {
        I2S_TX_TDM_CHAN10_EN_R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan11_en(&self) -> I2S_TX_TDM_CHAN11_EN_R {
        I2S_TX_TDM_CHAN11_EN_R::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan12_en(&self) -> I2S_TX_TDM_CHAN12_EN_R {
        I2S_TX_TDM_CHAN12_EN_R::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan13_en(&self) -> I2S_TX_TDM_CHAN13_EN_R {
        I2S_TX_TDM_CHAN13_EN_R::new(((self.bits >> 13) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan14_en(&self) -> I2S_TX_TDM_CHAN14_EN_R {
        I2S_TX_TDM_CHAN14_EN_R::new(((self.bits >> 14) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_chan15_en(&self) -> I2S_TX_TDM_CHAN15_EN_R {
        I2S_TX_TDM_CHAN15_EN_R::new(((self.bits >> 15) & 1) != 0)
    }
    ...
    pub fn i2s_tx_tdm_skip_msk_en(&self) -> I2S_TX_TDM_SKIP_MSK_EN_R {
        I2S_TX_TDM_SKIP_MSK_EN_R::new(((self.bits >> 20) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - 1: Enable the valid data output of I2S TX TDM channel 0. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan0_en(&mut self) -> I2S_TX_TDM_CHAN0_EN_W<0> {
        I2S_TX_TDM_CHAN0_EN_W::new(self)
    }
    #[doc = "Bit 1 - 1: Enable the valid data output of I2S TX TDM channel 1. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan1_en(&mut self) -> I2S_TX_TDM_CHAN1_EN_W<1> {
        I2S_TX_TDM_CHAN1_EN_W::new(self)
    }
    #[doc = "Bit 2 - 1: Enable the valid data output of I2S TX TDM channel 2. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan2_en(&mut self) -> I2S_TX_TDM_CHAN2_EN_W<2> {
        I2S_TX_TDM_CHAN2_EN_W::new(self)
    }
    #[doc = "Bit 3 - 1: Enable the valid data output of I2S TX TDM channel 3. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan3_en(&mut self) -> I2S_TX_TDM_CHAN3_EN_W<3> {
        I2S_TX_TDM_CHAN3_EN_W::new(self)
    }
    #[doc = "Bit 4 - 1: Enable the valid data output of I2S TX TDM channel 4. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan4_en(&mut self) -> I2S_TX_TDM_CHAN4_EN_W<4> {
        I2S_TX_TDM_CHAN4_EN_W::new(self)
    }
    #[doc = "Bit 5 - 1: Enable the valid data output of I2S TX TDM channel 5. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan5_en(&mut self) -> I2S_TX_TDM_CHAN5_EN_W<5> {
        I2S_TX_TDM_CHAN5_EN_W::new(self)
    }
    #[doc = "Bit 6 - 1: Enable the valid data output of I2S TX TDM channel 6. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan6_en(&mut self) -> I2S_TX_TDM_CHAN6_EN_W<6> {
        I2S_TX_TDM_CHAN6_EN_W::new(self)
    }
    #[doc = "Bit 7 - 1: Enable the valid data output of I2S TX TDM channel 7. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan7_en(&mut self) -> I2S_TX_TDM_CHAN7_EN_W<7> {
        I2S_TX_TDM_CHAN7_EN_W::new(self)
    }
    #[doc = "Bit 8 - 1: Enable the valid data output of I2S TX TDM channel 8. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan8_en(&mut self) -> I2S_TX_TDM_CHAN8_EN_W<8> {
        I2S_TX_TDM_CHAN8_EN_W::new(self)
    }
    #[doc = "Bit 9 - 1: Enable the valid data output of I2S TX TDM channel 9. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan9_en(&mut self) -> I2S_TX_TDM_CHAN9_EN_W<9> {
        I2S_TX_TDM_CHAN9_EN_W::new(self)
    }
    #[doc = "Bit 10 - 1: Enable the valid data output of I2S TX TDM channel 10. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan10_en(&mut self) -> I2S_TX_TDM_CHAN10_EN_W<10> {
        I2S_TX_TDM_CHAN10_EN_W::new(self)
    }
    #[doc = "Bit 11 - 1: Enable the valid data output of I2S TX TDM channel 11. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan11_en(&mut self) -> I2S_TX_TDM_CHAN11_EN_W<11> {
        I2S_TX_TDM_CHAN11_EN_W::new(self)
    }
    #[doc = "Bit 12 - 1: Enable the valid data output of I2S TX TDM channel 12. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan12_en(&mut self) -> I2S_TX_TDM_CHAN12_EN_W<12> {
        I2S_TX_TDM_CHAN12_EN_W::new(self)
    }
    #[doc = "Bit 13 - 1: Enable the valid data output of I2S TX TDM channel 13. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan13_en(&mut self) -> I2S_TX_TDM_CHAN13_EN_W<13> {
        I2S_TX_TDM_CHAN13_EN_W::new(self)
    }
    #[doc = "Bit 14 - 1: Enable the valid data output of I2S TX TDM channel 14. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan14_en(&mut self) -> I2S_TX_TDM_CHAN14_EN_W<14> {
        I2S_TX_TDM_CHAN14_EN_W::new(self)
    }
    #[doc = "Bit 15 - 1: Enable the valid data output of I2S TX TDM channel 15. 0: Disable, just output 0 in this channel."]
    #[inline(always)]
    pub fn i2s_tx_tdm_chan15_en(&mut self) -> I2S_TX_TDM_CHAN15_EN_W<15> {
        I2S_TX_TDM_CHAN15_EN_W::new(self)
    }
    #[doc = "Bits 16:19 - The total channel number of I2S TX TDM mode."]
    #[inline(always)]
    pub fn i2s_tx_tdm_tot_chan_num(&mut self) -> I2S_TX_TDM_TOT_CHAN_NUM_W<16> {
        I2S_TX_TDM_TOT_CHAN_NUM_W::new(self)
    }
    #[doc = "Bit 20 - When DMA TX buffer stores the data of (REG_TX_TDM_TOT_CHAN_NUM + 1) channels, and only the data of the enabled channels is sent, then this bit should be set. Clear it when all the data stored in DMA TX buffer is for enabled channels."]
    #[inline(always)]
    pub fn i2s_tx_tdm_skip_msk_en(&mut self) -> I2S_TX_TDM_SKIP_MSK_EN_W<20> {
...
#[doc = "I2S TX TDM mode control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2s_tx_tdm_ctrl](index.html) module"]
pub struct I2S_TX_TDM_CTRL_SPEC;
impl crate::RegisterSpec for I2S_TX_TDM_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2s_tx_tdm_ctrl::R](R) reader structure"]
impl crate::Readable for I2S_TX_TDM_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2s_tx_tdm_ctrl::W](W) writer structure"]
impl crate::Writable for I2S_TX_TDM_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets I2S_TX_TDM_CTRL to value 0xffff"]
impl crate::Resettable for I2S_TX_TDM_CTRL_SPEC {
    #[inline(always)]
