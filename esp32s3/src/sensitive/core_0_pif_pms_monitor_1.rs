...
///Register `CORE_0_PIF_PMS_MONITOR_1` writer
pub type W = crate::W<CORE_0_PIF_PMS_MONITOR_1_SPEC>;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_CLR` reader - Set 1 to clear interrupt that core0 initiate illegal PIF bus access.
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_CLR_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_CLR` writer - Set 1 to clear interrupt that core0 initiate illegal PIF bus access.
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_EN` reader - Set 1 to enable interrupt that core0 initiate illegal PIF bus access.
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_EN_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_EN` writer - Set 1 to enable interrupt that core0 initiate illegal PIF bus access.
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_PIF_PMS_MONITOR_1")
            .field(
                ...
                &self.core_0_pif_pms_monitor_violate_clr(),
            )
            .field(
                "core_0_pif_pms_monitor_violate_en",
                &self.core_0_pif_pms_monitor_violate_en(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_0_pif_pms_monitor_1::R`](R) reader structure
impl crate::Readable for CORE_0_PIF_PMS_MONITOR_1_SPEC {}
///`write(|w| ..)` method takes [`core_0_pif_pms_monitor_1::W`](W) writer structure
