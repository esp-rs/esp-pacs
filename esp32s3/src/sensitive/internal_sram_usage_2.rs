///Register `INTERNAL_SRAM_USAGE_2` reader
pub type R = crate::R<INTERNAL_SRAM_USAGE_2_SPEC>;
///Register `INTERNAL_SRAM_USAGE_2` writer
pub type W = crate::W<INTERNAL_SRAM_USAGE_2_SPEC>;
///Field `INTERNAL_SRAM_CORE0_TRACE_USAGE` reader - Set 1 to someone bit means corresponding internal SRAM level can be accessed by core0 trace bus.
pub type INTERNAL_SRAM_CORE0_TRACE_USAGE_R = crate::FieldReader;
///Field `INTERNAL_SRAM_CORE0_TRACE_USAGE` writer - Set 1 to someone bit means corresponding internal SRAM level can be accessed by core0 trace bus.
pub type INTERNAL_SRAM_CORE0_TRACE_USAGE_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `INTERNAL_SRAM_CORE1_TRACE_USAGE` reader - Set 1 to someone bit means corresponding internal SRAM level can be accessed by core1 trace bus.
pub type INTERNAL_SRAM_CORE1_TRACE_USAGE_R = crate::FieldReader;
///Field `INTERNAL_SRAM_CORE1_TRACE_USAGE` writer - Set 1 to someone bit means corresponding internal SRAM level can be accessed by core1 trace bus.
pub type INTERNAL_SRAM_CORE1_TRACE_USAGE_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `INTERNAL_SRAM_CORE0_TRACE_ALLOC` reader - Which internal SRAM bank (16KB) of 64KB can be accessed by core0 trace bus.
pub type INTERNAL_SRAM_CORE0_TRACE_ALLOC_R = crate::FieldReader;
///Field `INTERNAL_SRAM_CORE0_TRACE_ALLOC` writer - Which internal SRAM bank (16KB) of 64KB can be accessed by core0 trace bus.
pub type INTERNAL_SRAM_CORE0_TRACE_ALLOC_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `INTERNAL_SRAM_CORE1_TRACE_ALLOC` reader - Which internal SRAM bank (16KB) of 64KB can be accessed by core1 trace bus.
pub type INTERNAL_SRAM_CORE1_TRACE_ALLOC_R = crate::FieldReader;
///Field `INTERNAL_SRAM_CORE1_TRACE_ALLOC` writer - Which internal SRAM bank (16KB) of 64KB can be accessed by core1 trace bus.
...
///`read()` method returns [`internal_sram_usage_2::R`](R) reader structure
impl crate::Readable for INTERNAL_SRAM_USAGE_2_SPEC {}
///`write(|w| ..)` method takes [`internal_sram_usage_2::W`](W) writer structure
