///Register `CORE_0_VECBASE_OVERRIDE_2` reader
pub type R = crate::R<CORE_0_VECBASE_OVERRIDE_2_SPEC>;
///Register `CORE_0_VECBASE_OVERRIDE_2` writer
pub type W = crate::W<CORE_0_VECBASE_OVERRIDE_2_SPEC>;
///Field `CORE_0_VECBASE_OVERRIDE_WORLD1_VALUE` reader - world1 vecbase_override register, when core0 in world1 use this register to override vecbase register.
pub type CORE_0_VECBASE_OVERRIDE_WORLD1_VALUE_R = crate::FieldReader<u32>;
///Field `CORE_0_VECBASE_OVERRIDE_WORLD1_VALUE` writer - world1 vecbase_override register, when core0 in world1 use this register to override vecbase register.
pub type CORE_0_VECBASE_OVERRIDE_WORLD1_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - world1 vecbase_override register, when core0 in world1 use this register to override vecbase register.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_VECBASE_OVERRIDE_2")
            .field(
                ...
                &self.core_0_vecbase_override_world1_value(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_0_vecbase_override_2::R`](R) reader structure
impl crate::Readable for CORE_0_VECBASE_OVERRIDE_2_SPEC {}
///`write(|w| ..)` method takes [`core_0_vecbase_override_2::W`](W) writer structure
