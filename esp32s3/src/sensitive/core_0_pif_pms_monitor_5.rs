...
///Field `CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_INTR` reader - Record core0 unsupported access type interrupt state.
pub type CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_INTR_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HSIZE` reader - Record access type when core0 initiate unsupported access type.
pub type CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HSIZE_R = crate::FieldReader;
///Field `CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HWORLD` reader - Record world information when core0 initiate unsupported access type.
pub type CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HWORLD_R = crate::FieldReader;
impl R {
    ///Bit 0 - Record core0 unsupported access type interrupt state.
    #[inline(always)]
    ...
    ///Bits 1:2 - Record access type when core0 initiate unsupported access type.
    #[inline(always)]
    ...
    ///Bits 3:4 - Record world information when core0 initiate unsupported access type.
    #[inline(always)]
