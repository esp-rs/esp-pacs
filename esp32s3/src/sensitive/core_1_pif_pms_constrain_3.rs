...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_SPI_2_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_SPI_2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_PIF_PMS_CONSTRAIN_3_SPEC, u8, u8, 2, O>;
#[doc = "Field `CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3` reader - Core1 access spi_3 permission in world0."]
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_SPI_3_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_APB_CTRL_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_I2C_EXT1_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_SDIO_HOST_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_CAN_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_PWM1_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_I2S1_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_UART2_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_RWBT_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_WIFIMAC_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_PWR_R = crate::FieldReader<u8, u8>;
