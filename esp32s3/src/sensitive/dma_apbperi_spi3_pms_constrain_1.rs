...
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_0_W<'a, const O: u8> =
    crate::FieldWriter<'a, DMA_APBPERI_SPI3_PMS_CONSTRAIN_1_SPEC, 2, O>;
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_APBPERI_SPI3_PMS_CONSTRAIN_1")
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_spi3_pms_constrain_sram_pms_0().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_spi3_pms_constrain_sram_pms_1().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_spi3_pms_constrain_sram_pms_2().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_spi3_pms_constrain_sram_pms_3().bits()
                ),
            )
            .field(
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DMA_APBPERI_SPI3_PMS_CONSTRAIN_1_SPEC> {
