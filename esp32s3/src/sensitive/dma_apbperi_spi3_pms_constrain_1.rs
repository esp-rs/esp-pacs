///Register `DMA_APBPERI_SPI3_PMS_CONSTRAIN_1` reader
pub type R = crate::R<DMA_APBPERI_SPI3_PMS_CONSTRAIN_1_SPEC>;
///Register `DMA_APBPERI_SPI3_PMS_CONSTRAIN_1` writer
pub type W = crate::W<DMA_APBPERI_SPI3_PMS_CONSTRAIN_1_SPEC>;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_0` reader - spi3's permission(store,load) in data region0 of SRAM
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_0_R = crate::FieldReader;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_0` writer - spi3's permission(store,load) in data region0 of SRAM
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_1` reader - spi3's permission(store,load) in data region1 of SRAM
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_1_R = crate::FieldReader;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_1` writer - spi3's permission(store,load) in data region1 of SRAM
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_2` reader - spi3's permission(store,load) in data region2 of SRAM
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_2_R = crate::FieldReader;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_2` writer - spi3's permission(store,load) in data region2 of SRAM
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_3` reader - spi3's permission(store,load) in data region3 of SRAM
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_3_R = crate::FieldReader;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_3` writer - spi3's permission(store,load) in data region3 of SRAM
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_PMS_3_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0` reader - spi3's permission(store,load) in dcache data sram block0
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_R = crate::FieldReader;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0` writer - spi3's permission(store,load) in dcache data sram block0
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W<'a, REG> =
    crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1` reader - spi3's permission(store,load) in dcache data sram block1
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_R = crate::FieldReader;
///Field `DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1` writer - spi3's permission(store,load) in dcache data sram block1
pub type DMA_APBPERI_SPI3_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W<'a, REG> =
    crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - spi3's permission(store,load) in data region0 of SRAM
    #[inline(always)]
    ...
    ///Bits 2:3 - spi3's permission(store,load) in data region1 of SRAM
    #[inline(always)]
    ...
    ///Bits 4:5 - spi3's permission(store,load) in data region2 of SRAM
    #[inline(always)]
    ...
    ///Bits 6:7 - spi3's permission(store,load) in data region3 of SRAM
    #[inline(always)]
    ...
    ///Bits 8:9 - spi3's permission(store,load) in dcache data sram block0
    #[inline(always)]
    ...
    ///Bits 10:11 - spi3's permission(store,load) in dcache data sram block1
    #[inline(always)]
...
///`read()` method returns [`dma_apbperi_spi3_pms_constrain_1::R`](R) reader structure
impl crate::Readable for DMA_APBPERI_SPI3_PMS_CONSTRAIN_1_SPEC {}
///`write(|w| ..)` method takes [`dma_apbperi_spi3_pms_constrain_1::W`](W) writer structure
