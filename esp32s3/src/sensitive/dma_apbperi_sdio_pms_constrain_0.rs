...
pub struct R(crate::R<DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_APBPERI_SDIO_PMS_CONSTRAIN_0` writer"]
pub struct W(crate::W<DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DMA_APBPERI_SDIO_PMS_CONSTRAIN_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_APBPERI_SDIO_PMS_CONSTRAIN_0")
            .field(
                "dma_apbperi_sdio_pms_constrain_lock",
                &format_args!("{}", self.dma_apbperi_sdio_pms_constrain_lock().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DMA_APBPERI_SDIO_PMS_CONSTRAIN_0_SPEC> {
...
impl W {
    ...
    pub fn dma_apbperi_sdio_pms_constrain_lock(
        &mut self,
    ) -> DMA_APBPERI_SDIO_PMS_CONSTRAIN_LOCK_W<0> {
        DMA_APBPERI_SDIO_PMS_CONSTRAIN_LOCK_W::new(self)
    }
