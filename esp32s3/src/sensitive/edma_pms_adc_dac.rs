...
pub struct R(crate::R<EDMA_PMS_ADC_DAC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EDMA_PMS_ADC_DAC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EDMA_PMS_ADC_DAC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EDMA_PMS_ADC_DAC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EDMA_PMS_ADC_DAC` writer"]
pub struct W(crate::W<EDMA_PMS_ADC_DAC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EDMA_PMS_ADC_DAC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EDMA_PMS_ADC_DAC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EDMA_PMS_ADC_DAC_SPEC>) -> Self {
        W(writer)
    }
}
