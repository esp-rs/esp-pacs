...
pub struct R(crate::R<CORE_0_PIF_PMS_CONSTRAIN_14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_0_PIF_PMS_CONSTRAIN_14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_0_PIF_PMS_CONSTRAIN_14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_0_PIF_PMS_CONSTRAIN_14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_0_PIF_PMS_CONSTRAIN_14` writer"]
pub struct W(crate::W<CORE_0_PIF_PMS_CONSTRAIN_14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_0_PIF_PMS_CONSTRAIN_14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_0_PIF_PMS_CONSTRAIN_14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_0_PIF_PMS_CONSTRAIN_14_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_R = crate::FieldReader<u8, u8>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_0_PIF_PMS_CONSTRAIN_14_SPEC, u8, u8, 3, O>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_R = crate::FieldReader<u8, u8>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_0_PIF_PMS_CONSTRAIN_14_SPEC, u8, u8, 3, O>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_R = crate::FieldReader<u8, u8>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_0_PIF_PMS_CONSTRAIN_14_SPEC, u8, u8, 3, O>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_R = crate::FieldReader<u8, u8>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_0_PIF_PMS_CONSTRAIN_14_SPEC, u8, u8, 3, O>;
impl R {
...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_rtcslow_1_world_0_l(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_W<0> {
        CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_W::new(self)
    }
    #[doc = "Bits 3:5 - RTCSlow_1 memory high region permission in world 0 for core0."]
    #[inline(always)]
    #[must_use]
    pub fn core_0_pif_pms_constrain_rtcslow_1_world_0_h(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_W<3> {
        CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_W::new(self)
    }
    #[doc = "Bits 6:8 - RTCSlow_1 memory low region permission in world 1 for core0."]
    #[inline(always)]
    #[must_use]
    pub fn core_0_pif_pms_constrain_rtcslow_1_world_1_l(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_W<6> {
        CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_W::new(self)
    }
    #[doc = "Bits 9:11 - RTCSlow_1 memory high region permission in world 1 for core0."]
    #[inline(always)]
    #[must_use]
    pub fn core_0_pif_pms_constrain_rtcslow_1_world_1_h(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_W<9> {
        CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_W::new(self)
    }
