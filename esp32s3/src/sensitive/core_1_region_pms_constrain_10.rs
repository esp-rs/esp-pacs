...
impl W {
    ...
    pub fn core_1_region_pms_constrain_addr_7(
        &mut self,
    ) -> CORE_1_REGION_PMS_CONSTRAIN_ADDR_7_W<'_, CORE_1_REGION_PMS_CONSTRAIN_10_SPEC> {
        CORE_1_REGION_PMS_CONSTRAIN_ADDR_7_W::new(self, 0)
    }
}
#[doc = "core1 region permission register 10.\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_region_pms_constrain_10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_1_region_pms_constrain_10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
