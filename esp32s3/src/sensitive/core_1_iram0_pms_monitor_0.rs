///Register `CORE_1_IRAM0_PMS_MONITOR_0` reader
pub type R = crate::R<CORE_1_IRAM0_PMS_MONITOR_0_SPEC>;
///Register `CORE_1_IRAM0_PMS_MONITOR_0` writer
pub type W = crate::W<CORE_1_IRAM0_PMS_MONITOR_0_SPEC>;
///Field `CORE_1_IRAM0_PMS_MONITOR_LOCK` reader - Set 1 to lock core1 iram0 permission monitor register
pub type CORE_1_IRAM0_PMS_MONITOR_LOCK_R = crate::BitReader;
///Field `CORE_1_IRAM0_PMS_MONITOR_LOCK` writer - Set 1 to lock core1 iram0 permission monitor register
pub type CORE_1_IRAM0_PMS_MONITOR_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock core1 iram0 permission monitor register
    #[inline(always)]
...
///`read()` method returns [`core_1_iram0_pms_monitor_0::R`](R) reader structure
impl crate::Readable for CORE_1_IRAM0_PMS_MONITOR_0_SPEC {}
///`write(|w| ..)` method takes [`core_1_iram0_pms_monitor_0::W`](W) writer structure
