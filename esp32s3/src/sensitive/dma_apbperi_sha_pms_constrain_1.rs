...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0` writer - sha's permission(store,load) in data region0 of SRAM"]
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0_W<'a, const O: u8> =
...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_R = crate::FieldReader<u8, u8>;
...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_APBPERI_SHA_PMS_CONSTRAIN_1_SPEC, u8, u8, 2, O>;
...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_R = crate::FieldReader<u8, u8>;
...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_APBPERI_SHA_PMS_CONSTRAIN_1_SPEC, u8, u8, 2, O>;
impl R {
...
impl W {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_pms_0(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0_W<0> {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_pms_1(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_1_W<2> {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_pms_2(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_2_W<4> {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_pms_3(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_3_W<6> {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_cachedataarray_pms_0(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W<8> {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_cachedataarray_pms_1(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W<10> {
