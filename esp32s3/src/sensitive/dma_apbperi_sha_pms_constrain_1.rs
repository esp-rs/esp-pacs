...
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0` reader - sha's permission(store,load) in data region0 of SRAM
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0_R = crate::FieldReader;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0` writer - sha's permission(store,load) in data region0 of SRAM
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_1` reader - sha's permission(store,load) in data region1 of SRAM
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_1_R = crate::FieldReader;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_1` writer - sha's permission(store,load) in data region1 of SRAM
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_2` reader - sha's permission(store,load) in data region2 of SRAM
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_2_R = crate::FieldReader;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_2` writer - sha's permission(store,load) in data region2 of SRAM
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_3` reader - sha's permission(store,load) in data region3 of SRAM
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_3_R = crate::FieldReader;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_3` writer - sha's permission(store,load) in data region3 of SRAM
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_3_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0` reader - sha's permission(store,load) in dcache data sram block0
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_R = crate::FieldReader;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0` writer - sha's permission(store,load) in dcache data sram block0
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W<'a, REG> =
    crate::FieldWriter<'a, REG, 2>;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1` reader - sha's permission(store,load) in dcache data sram block1
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_R = crate::FieldReader;
///Field `DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1` writer - sha's permission(store,load) in dcache data sram block1
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W<'a, REG> =
    crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - sha's permission(store,load) in data region0 of SRAM
    #[inline(always)]
    ...
    ///Bits 2:3 - sha's permission(store,load) in data region1 of SRAM
    #[inline(always)]
    ...
    ///Bits 4:5 - sha's permission(store,load) in data region2 of SRAM
    #[inline(always)]
    ...
    ///Bits 6:7 - sha's permission(store,load) in data region3 of SRAM
    #[inline(always)]
    ...
    ///Bits 8:9 - sha's permission(store,load) in dcache data sram block0
    #[inline(always)]
    ...
    ///Bits 10:11 - sha's permission(store,load) in dcache data sram block1
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_APBPERI_SHA_PMS_CONSTRAIN_1")
            .field(
                ...
                &self.dma_apbperi_sha_pms_constrain_sram_pms_0(),
            )
            .field(
                "dma_apbperi_sha_pms_constrain_sram_pms_1",
                &self.dma_apbperi_sha_pms_constrain_sram_pms_1(),
            )
            .field(
                "dma_apbperi_sha_pms_constrain_sram_pms_2",
                &self.dma_apbperi_sha_pms_constrain_sram_pms_2(),
            )
            .field(
                "dma_apbperi_sha_pms_constrain_sram_pms_3",
                &self.dma_apbperi_sha_pms_constrain_sram_pms_3(),
            )
            .field(
