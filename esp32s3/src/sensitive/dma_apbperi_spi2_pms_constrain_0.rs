...
///Field `DMA_APBPERI_SPI2_PMS_CONSTRAIN_LOCK` reader - Set 1 to lock spi2 dma permission Configuration Register.
pub type DMA_APBPERI_SPI2_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
///Field `DMA_APBPERI_SPI2_PMS_CONSTRAIN_LOCK` writer - Set 1 to lock spi2 dma permission Configuration Register.
pub type DMA_APBPERI_SPI2_PMS_CONSTRAIN_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock spi2 dma permission Configuration Register.
    #[inline(always)]
