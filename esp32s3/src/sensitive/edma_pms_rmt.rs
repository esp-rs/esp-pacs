...
pub type ATTR1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EDMA_PMS_RMT_SPEC, u8, u8, 2, O>;
...
pub type ATTR2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EDMA_PMS_RMT_SPEC, u8, u8, 2, O>;
impl R {
