///Register `CORE_1_REGION_PMS_CONSTRAIN_9` reader
pub type R = crate::R<CORE_1_REGION_PMS_CONSTRAIN_9_SPEC>;
///Register `CORE_1_REGION_PMS_CONSTRAIN_9` writer
pub type W = crate::W<CORE_1_REGION_PMS_CONSTRAIN_9_SPEC>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_6` reader - Region 5 end address and Region 6 start address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_6_R = crate::FieldReader<u32>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_6` writer - Region 5 end address and Region 6 start address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_6_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Region 5 end address and Region 6 start address for core1.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_REGION_PMS_CONSTRAIN_9")
            .field(
                ...
                &self.core_1_region_pms_constrain_addr_6(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_1_region_pms_constrain_9::R`](R) reader structure
impl crate::Readable for CORE_1_REGION_PMS_CONSTRAIN_9_SPEC {}
///`write(|w| ..)` method takes [`core_1_region_pms_constrain_9::W`](W) writer structure
