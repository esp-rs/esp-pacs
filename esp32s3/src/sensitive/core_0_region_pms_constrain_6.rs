///Register `CORE_0_REGION_PMS_CONSTRAIN_6` reader
pub type R = crate::R<CORE_0_REGION_PMS_CONSTRAIN_6_SPEC>;
///Register `CORE_0_REGION_PMS_CONSTRAIN_6` writer
pub type W = crate::W<CORE_0_REGION_PMS_CONSTRAIN_6_SPEC>;
///Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_3` reader - Region 2 end address and Region 3 start address for core0.
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_3_R = crate::FieldReader<u32>;
///Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_3` writer - Region 2 end address and Region 3 start address for core0.
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_3_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Region 2 end address and Region 3 start address for core0.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_0_region_pms_constrain_6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_0_region_pms_constrain_6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_REGION_PMS_CONSTRAIN_6_SPEC;
impl crate::RegisterSpec for CORE_0_REGION_PMS_CONSTRAIN_6_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_0_region_pms_constrain_6::R`](R) reader structure
impl crate::Readable for CORE_0_REGION_PMS_CONSTRAIN_6_SPEC {}
///`write(|w| ..)` method takes [`core_0_region_pms_constrain_6::W`](W) writer structure
