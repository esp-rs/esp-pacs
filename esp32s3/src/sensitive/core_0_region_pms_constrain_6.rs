...
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_3_W<'a, REG, const O: u8> =
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_REGION_PMS_CONSTRAIN_6")
            .field(
                ...
                &format_args!("{}", self.core_0_region_pms_constrain_addr_3().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_0_REGION_PMS_CONSTRAIN_6_SPEC> {
...
impl W {
    ...
    pub fn core_0_region_pms_constrain_addr_3(
        &mut self,
    ) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_3_W<CORE_0_REGION_PMS_CONSTRAIN_6_SPEC, 0> {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_3_W::new(self)
    }
