...
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_3` writer - Region 2 end address and Region 3 start address for core0."]
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_3_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_REGION_PMS_CONSTRAIN_6_SPEC, 30, O, u32, u32>;
impl R {
...
impl W {
    ...
    pub fn core_0_region_pms_constrain_addr_3(
        &mut self,
    ) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_3_W<0> {
...
#[doc = "Core0 region permission register 6.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_region_pms_constrain_6](index.html) module"]
