...
///Field `CORE_0_IRAM0_PMS_MONITOR_LOCK` reader - Set 1 to lock core0 iram0 permission monitor register
pub type CORE_0_IRAM0_PMS_MONITOR_LOCK_R = crate::BitReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_LOCK` writer - Set 1 to lock core0 iram0 permission monitor register
pub type CORE_0_IRAM0_PMS_MONITOR_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock core0 iram0 permission monitor register
    #[inline(always)]
