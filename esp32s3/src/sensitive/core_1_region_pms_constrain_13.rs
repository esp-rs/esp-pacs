///Register `CORE_1_REGION_PMS_CONSTRAIN_13` reader
pub type R = crate::R<CORE_1_REGION_PMS_CONSTRAIN_13_SPEC>;
///Register `CORE_1_REGION_PMS_CONSTRAIN_13` writer
pub type W = crate::W<CORE_1_REGION_PMS_CONSTRAIN_13_SPEC>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_10` reader - Region 9 end address and Region 10 start address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_10_R = crate::FieldReader<u32>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_10` writer - Region 9 end address and Region 10 start address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_10_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Region 9 end address and Region 10 start address for core1.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_REGION_PMS_CONSTRAIN_13")
            .field(
                ...
                &self.core_1_region_pms_constrain_addr_10(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_1_region_pms_constrain_13::R`](R) reader structure
impl crate::Readable for CORE_1_REGION_PMS_CONSTRAIN_13_SPEC {}
///`write(|w| ..)` method takes [`core_1_region_pms_constrain_13::W`](W) writer structure
