    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_APBPERI_RMT_PMS_CONSTRAIN_1")
            .field(
                ...
                &self.dma_apbperi_rmt_pms_constrain_sram_pms_0().bits(),
            )
            .field(
                "dma_apbperi_rmt_pms_constrain_sram_pms_1",
                &self.dma_apbperi_rmt_pms_constrain_sram_pms_1().bits(),
            )
            .field(
                "dma_apbperi_rmt_pms_constrain_sram_pms_2",
                &self.dma_apbperi_rmt_pms_constrain_sram_pms_2().bits(),
            )
            .field(
                "dma_apbperi_rmt_pms_constrain_sram_pms_3",
                &self.dma_apbperi_rmt_pms_constrain_sram_pms_3().bits(),
            )
            .field(
