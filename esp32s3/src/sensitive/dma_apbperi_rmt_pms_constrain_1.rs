#[doc = "Register `DMA_APBPERI_RMT_PMS_CONSTRAIN_1` reader"]
pub struct R(crate::R<DMA_APBPERI_RMT_PMS_CONSTRAIN_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_APBPERI_RMT_PMS_CONSTRAIN_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_APBPERI_RMT_PMS_CONSTRAIN_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_APBPERI_RMT_PMS_CONSTRAIN_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_APBPERI_RMT_PMS_CONSTRAIN_1` writer"]
pub struct W(crate::W<DMA_APBPERI_RMT_PMS_CONSTRAIN_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_APBPERI_RMT_PMS_CONSTRAIN_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_APBPERI_RMT_PMS_CONSTRAIN_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_APBPERI_RMT_PMS_CONSTRAIN_1_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    pub fn dma_apbperi_rmt_pms_constrain_sram_pms_0(
        &mut self,
    ) -> DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_PMS_0_W<0> {
        DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_PMS_0_W::new(self)
    }
    #[doc = "Bits 2:3 - rmt's permission(store,load) in data region1 of SRAM"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_rmt_pms_constrain_sram_pms_1(
        &mut self,
    ) -> DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_PMS_1_W<2> {
        DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_PMS_1_W::new(self)
    }
    #[doc = "Bits 4:5 - rmt's permission(store,load) in data region2 of SRAM"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_rmt_pms_constrain_sram_pms_2(
        &mut self,
    ) -> DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_PMS_2_W<4> {
        DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_PMS_2_W::new(self)
    }
    #[doc = "Bits 6:7 - rmt's permission(store,load) in data region3 of SRAM"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_rmt_pms_constrain_sram_pms_3(
        &mut self,
    ) -> DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_PMS_3_W<6> {
        DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_PMS_3_W::new(self)
    }
    #[doc = "Bits 8:9 - rmt's permission(store,load) in dcache data sram block0"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_rmt_pms_constrain_sram_cachedataarray_pms_0(
        &mut self,
    ) -> DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W<8> {
        DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W::new(self)
    }
    #[doc = "Bits 10:11 - rmt's permission(store,load) in dcache data sram block1"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_rmt_pms_constrain_sram_cachedataarray_pms_1(
        &mut self,
    ) -> DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W<10> {
        DMA_APBPERI_RMT_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W::new(self)
    }
