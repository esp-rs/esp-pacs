...
pub struct R(crate::R<EDMA_PMS_LCD_CAM_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EDMA_PMS_LCD_CAM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EDMA_PMS_LCD_CAM_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EDMA_PMS_LCD_CAM_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EDMA_PMS_LCD_CAM` writer"]
pub struct W(crate::W<EDMA_PMS_LCD_CAM_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EDMA_PMS_LCD_CAM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EDMA_PMS_LCD_CAM_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EDMA_PMS_LCD_CAM_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ATTR1_W<'a, const O: u8> = crate::FieldWriter<'a, EDMA_PMS_LCD_CAM_SPEC, 2, O>;
...
pub type ATTR2_W<'a, const O: u8> = crate::FieldWriter<'a, EDMA_PMS_LCD_CAM_SPEC, 2, O>;
impl R {
