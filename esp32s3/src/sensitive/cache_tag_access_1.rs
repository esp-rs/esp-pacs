...
///Field `PRO_I_TAG_RD_ACS` reader - Set 1 to enable Icache read access tag memory.
pub type PRO_I_TAG_RD_ACS_R = crate::BitReader;
///Field `PRO_I_TAG_RD_ACS` writer - Set 1 to enable Icache read access tag memory.
pub type PRO_I_TAG_RD_ACS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_I_TAG_WR_ACS` reader - Set 1 to enable Icache wrtie access tag memory.
pub type PRO_I_TAG_WR_ACS_R = crate::BitReader;
///Field `PRO_I_TAG_WR_ACS` writer - Set 1 to enable Icache wrtie access tag memory.
pub type PRO_I_TAG_WR_ACS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_D_TAG_RD_ACS` reader - Set 1 to enable Dcache read access tag memory.
pub type PRO_D_TAG_RD_ACS_R = crate::BitReader;
///Field `PRO_D_TAG_RD_ACS` writer - Set 1 to enable Dcache read access tag memory.
pub type PRO_D_TAG_RD_ACS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_D_TAG_WR_ACS` reader - Set 1 to enable Dcache wrtie access tag memory.
pub type PRO_D_TAG_WR_ACS_R = crate::BitReader;
///Field `PRO_D_TAG_WR_ACS` writer - Set 1 to enable Dcache wrtie access tag memory.
