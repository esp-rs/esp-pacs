...
pub type CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR_W<'a, REG, const O: u8> =
...
pub type CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_EN_W<'a, REG, const O: u8> =
    crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn core_0_pif_pms_monitor_nonword_violate_clr(
        &mut self,
    ) -> CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR_W<CORE_0_PIF_PMS_MONITOR_4_SPEC, 0> {
    ...
    pub fn core_0_pif_pms_monitor_nonword_violate_en(
        &mut self,
    ) -> CORE_0_PIF_PMS_MONITOR_NONWORD_VIOLATE_EN_W<CORE_0_PIF_PMS_MONITOR_4_SPEC, 1> {
