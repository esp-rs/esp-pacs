///Register `CORE_1_IRAM0_PMS_MONITOR_2` reader
pub type R = crate::R<CORE_1_IRAM0_PMS_MONITOR_2_SPEC>;
///Field `CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR` reader - recorded core1 iram0 pms monitor interrupt status.
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_R = crate::BitReader;
///Field `CORE_1_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WR` reader - recorded core1 iram0 wr status, only if loadstore is 1 have meaning, 1(store), 0(load).
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WR_R = crate::BitReader;
///Field `CORE_1_IRAM0_PMS_MONITOR_VIOLATE_STATUS_LOADSTORE` reader - recorded core1 iram0 loadstore status, indicated the type of operation, 0(fetch), 1(load/store).
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_STATUS_LOADSTORE_R = crate::BitReader;
///Field `CORE_1_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD` reader - recorded core1 iram0 world status, 0x01 means world0, 0x10 means world1.
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD_R = crate::FieldReader;
///Field `CORE_1_IRAM0_PMS_MONITOR_VIOLATE_STATUS_ADDR` reader - recorded core1 iram0 address \[25:2\] status when core1 iram0 violated permission, the real address is 0x40000000+addr*4
...
impl R {
    ...
    ///Bit 2 - recorded core1 iram0 loadstore status, indicated the type of operation, 0(fetch), 1(load/store).
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_1_iram0_pms_monitor_2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_1_IRAM0_PMS_MONITOR_2_SPEC;
impl crate::RegisterSpec for CORE_1_IRAM0_PMS_MONITOR_2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_1_iram0_pms_monitor_2::R`](R) reader structure
