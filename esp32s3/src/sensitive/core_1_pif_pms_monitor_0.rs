///Register `CORE_1_PIF_PMS_MONITOR_0` reader
pub type R = crate::R<CORE_1_PIF_PMS_MONITOR_0_SPEC>;
///Register `CORE_1_PIF_PMS_MONITOR_0` writer
pub type W = crate::W<CORE_1_PIF_PMS_MONITOR_0_SPEC>;
///Field `CORE_1_PIF_PMS_MONITOR_LOCK` reader - Set 1 to lock core1 permission report registers.
pub type CORE_1_PIF_PMS_MONITOR_LOCK_R = crate::BitReader;
///Field `CORE_1_PIF_PMS_MONITOR_LOCK` writer - Set 1 to lock core1 permission report registers.
pub type CORE_1_PIF_PMS_MONITOR_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock core1 permission report registers.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_PIF_PMS_MONITOR_0")
            .field(
                ...
                &self.core_1_pif_pms_monitor_lock(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_1_pif_pms_monitor_0::R`](R) reader structure
impl crate::Readable for CORE_1_PIF_PMS_MONITOR_0_SPEC {}
///`write(|w| ..)` method takes [`core_1_pif_pms_monitor_0::W`](W) writer structure
