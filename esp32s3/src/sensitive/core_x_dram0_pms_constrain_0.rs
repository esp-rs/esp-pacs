///Register `CORE_X_DRAM0_PMS_CONSTRAIN_0` reader
pub type R = crate::R<CORE_X_DRAM0_PMS_CONSTRAIN_0_SPEC>;
///Register `CORE_X_DRAM0_PMS_CONSTRAIN_0` writer
pub type W = crate::W<CORE_X_DRAM0_PMS_CONSTRAIN_0_SPEC>;
///Field `CORE_X_DRAM0_PMS_CONSTRAIN_LOCK` reader - Set 1 to lock corex dram0 permission configuration register
pub type CORE_X_DRAM0_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
///Field `CORE_X_DRAM0_PMS_CONSTRAIN_LOCK` writer - Set 1 to lock corex dram0 permission configuration register
pub type CORE_X_DRAM0_PMS_CONSTRAIN_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock corex dram0 permission configuration register
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_X_DRAM0_PMS_CONSTRAIN_0")
            .field(
                ...
                &self.core_x_dram0_pms_constrain_lock(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_x_dram0_pms_constrain_0::R`](R) reader structure
impl crate::Readable for CORE_X_DRAM0_PMS_CONSTRAIN_0_SPEC {}
///`write(|w| ..)` method takes [`core_x_dram0_pms_constrain_0::W`](W) writer structure
