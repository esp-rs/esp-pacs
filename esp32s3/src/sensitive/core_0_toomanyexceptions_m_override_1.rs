///Register `CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_1` reader
pub type R = crate::R<CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_1_SPEC>;
///Register `CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_1` writer
pub type W = crate::W<CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_1_SPEC>;
///Field `CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE` reader - Set 1 to mask toomanyexception.
pub type CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_R = crate::BitReader;
///Field `CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE` writer - Set 1 to mask toomanyexception.
...
///`read()` method returns [`core_0_toomanyexceptions_m_override_1::R`](R) reader structure
impl crate::Readable for CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_1_SPEC {}
///`write(|w| ..)` method takes [`core_0_toomanyexceptions_m_override_1::W`](W) writer structure
