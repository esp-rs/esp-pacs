///Register `CORE_0_REGION_PMS_CONSTRAIN_11` reader
pub type R = crate::R<CORE_0_REGION_PMS_CONSTRAIN_11_SPEC>;
///Register `CORE_0_REGION_PMS_CONSTRAIN_11` writer
pub type W = crate::W<CORE_0_REGION_PMS_CONSTRAIN_11_SPEC>;
///Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_8` reader - Region 7 end address and Region 8 start address for core0.
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_R = crate::FieldReader<u32>;
///Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_8` writer - Region 7 end address and Region 8 start address for core0.
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_8_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Region 7 end address and Region 8 start address for core0.
    #[inline(always)]
...
///`read()` method returns [`core_0_region_pms_constrain_11::R`](R) reader structure
impl crate::Readable for CORE_0_REGION_PMS_CONSTRAIN_11_SPEC {}
///`write(|w| ..)` method takes [`core_0_region_pms_constrain_11::W`](W) writer structure
