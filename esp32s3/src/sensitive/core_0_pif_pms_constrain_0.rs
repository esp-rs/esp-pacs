///Register `CORE_0_PIF_PMS_CONSTRAIN_0` reader
pub type R = crate::R<CORE_0_PIF_PMS_CONSTRAIN_0_SPEC>;
///Register `CORE_0_PIF_PMS_CONSTRAIN_0` writer
pub type W = crate::W<CORE_0_PIF_PMS_CONSTRAIN_0_SPEC>;
///Field `CORE_0_PIF_PMS_CONSTRAIN_LOCK` reader - Set 1 to lock core0 access peripherals permission Configuration Register.
pub type CORE_0_PIF_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_CONSTRAIN_LOCK` writer - Set 1 to lock core0 access peripherals permission Configuration Register.
pub type CORE_0_PIF_PMS_CONSTRAIN_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_PIF_PMS_CONSTRAIN_0")
            .field(
                ...
                &self.core_0_pif_pms_constrain_lock(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn core_0_pif_pms_constrain_lock(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_LOCK_W<CORE_0_PIF_PMS_CONSTRAIN_0_SPEC> {
        CORE_0_PIF_PMS_CONSTRAIN_LOCK_W::new(self, 0)
    }
}
...
///`read()` method returns [`core_0_pif_pms_constrain_0::R`](R) reader structure
impl crate::Readable for CORE_0_PIF_PMS_CONSTRAIN_0_SPEC {}
///`write(|w| ..)` method takes [`core_0_pif_pms_constrain_0::W`](W) writer structure
