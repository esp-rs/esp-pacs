///Register `APB_PERIPHERAL_ACCESS_1` reader
pub type R = crate::R<APB_PERIPHERAL_ACCESS_1_SPEC>;
///Register `APB_PERIPHERAL_ACCESS_1` writer
pub type W = crate::W<APB_PERIPHERAL_ACCESS_1_SPEC>;
///Field `APB_PERIPHERAL_ACCESS_SPLIT_BURST` reader - Set 1 to support split function for AHB access to APB peripherals.
pub type APB_PERIPHERAL_ACCESS_SPLIT_BURST_R = crate::BitReader;
///Field `APB_PERIPHERAL_ACCESS_SPLIT_BURST` writer - Set 1 to support split function for AHB access to APB peripherals.
...
///`read()` method returns [`apb_peripheral_access_1::R`](R) reader structure
impl crate::Readable for APB_PERIPHERAL_ACCESS_1_SPEC {}
///`write(|w| ..)` method takes [`apb_peripheral_access_1::W`](W) writer structure
