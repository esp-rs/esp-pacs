///Register `CORE_1_REGION_PMS_CONSTRAIN_7` reader
pub type R = crate::R<CORE_1_REGION_PMS_CONSTRAIN_7_SPEC>;
///Register `CORE_1_REGION_PMS_CONSTRAIN_7` writer
...
///`read()` method returns [`core_1_region_pms_constrain_7::R`](R) reader structure
impl crate::Readable for CORE_1_REGION_PMS_CONSTRAIN_7_SPEC {}
///`write(|w| ..)` method takes [`core_1_region_pms_constrain_7::W`](W) writer structure
