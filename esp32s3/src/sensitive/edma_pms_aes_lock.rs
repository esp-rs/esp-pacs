///Register `EDMA_PMS_AES_LOCK` reader
pub type R = crate::R<EDMA_PMS_AES_LOCK_SPEC>;
///Register `EDMA_PMS_AES_LOCK` writer
pub type W = crate::W<EDMA_PMS_AES_LOCK_SPEC>;
///Field `EDMA_PMS_AES_LOCK` reader - Set 1 to lock EDMA-AES permission control registers.
pub type EDMA_PMS_AES_LOCK_R = crate::BitReader;
///Field `EDMA_PMS_AES_LOCK` writer - Set 1 to lock EDMA-AES permission control registers.
pub type EDMA_PMS_AES_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock EDMA-AES permission control registers.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`edma_pms_aes_lock::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`edma_pms_aes_lock::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct EDMA_PMS_AES_LOCK_SPEC;
impl crate::RegisterSpec for EDMA_PMS_AES_LOCK_SPEC {
    type Ux = u32;
}
///`read()` method returns [`edma_pms_aes_lock::R`](R) reader structure
impl crate::Readable for EDMA_PMS_AES_LOCK_SPEC {}
///`write(|w| ..)` method takes [`edma_pms_aes_lock::W`](W) writer structure
