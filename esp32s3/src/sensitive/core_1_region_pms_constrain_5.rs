///Register `CORE_1_REGION_PMS_CONSTRAIN_5` reader
pub type R = crate::R<CORE_1_REGION_PMS_CONSTRAIN_5_SPEC>;
///Register `CORE_1_REGION_PMS_CONSTRAIN_5` writer
pub type W = crate::W<CORE_1_REGION_PMS_CONSTRAIN_5_SPEC>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_2` reader - Region 1 end address and Region 2 start address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_2_R = crate::FieldReader<u32>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_2` writer - Region 1 end address and Region 2 start address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_2_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Region 1 end address and Region 2 start address for core1.
    #[inline(always)]
...
///`read()` method returns [`core_1_region_pms_constrain_5::R`](R) reader structure
impl crate::Readable for CORE_1_REGION_PMS_CONSTRAIN_5_SPEC {}
///`write(|w| ..)` method takes [`core_1_region_pms_constrain_5::W`](W) writer structure
