    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_APBPERI_I2S0_PMS_CONSTRAIN_1")
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_i2s0_pms_constrain_sram_pms_0().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_i2s0_pms_constrain_sram_pms_1().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_i2s0_pms_constrain_sram_pms_2().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_i2s0_pms_constrain_sram_pms_3().bits()
                ),
            )
            .field(
