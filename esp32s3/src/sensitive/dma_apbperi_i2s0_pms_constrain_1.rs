...
pub type DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_0_W<'a, REG, const O: u8> =
...
pub type DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_1_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_2_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_3_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    pub fn dma_apbperi_i2s0_pms_constrain_sram_pms_0(
        &mut self,
    ) -> DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_0_W<DMA_APBPERI_I2S0_PMS_CONSTRAIN_1_SPEC, 0> {
        DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_0_W::new(self)
    }
    #[doc = "Bits 2:3 - i2s0's permission(store,load) in data region1 of SRAM"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_i2s0_pms_constrain_sram_pms_1(
        &mut self,
    ) -> DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_1_W<DMA_APBPERI_I2S0_PMS_CONSTRAIN_1_SPEC, 2> {
        DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_1_W::new(self)
    }
    #[doc = "Bits 4:5 - i2s0's permission(store,load) in data region2 of SRAM"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_i2s0_pms_constrain_sram_pms_2(
        &mut self,
    ) -> DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_2_W<DMA_APBPERI_I2S0_PMS_CONSTRAIN_1_SPEC, 4> {
        DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_2_W::new(self)
    }
    #[doc = "Bits 6:7 - i2s0's permission(store,load) in data region3 of SRAM"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_i2s0_pms_constrain_sram_pms_3(
        &mut self,
    ) -> DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_3_W<DMA_APBPERI_I2S0_PMS_CONSTRAIN_1_SPEC, 6> {
        DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_PMS_3_W::new(self)
    }
    #[doc = "Bits 8:9 - i2s0's permission(store,load) in dcache data sram block0"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_i2s0_pms_constrain_sram_cachedataarray_pms_0(
        ...
        8,
    > {
        DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W::new(self)
    }
    #[doc = "Bits 10:11 - i2s0's permission(store,load) in dcache data sram block1"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_i2s0_pms_constrain_sram_cachedataarray_pms_1(
        ...
        10,
    > {
        DMA_APBPERI_I2S0_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W::new(self)
    }
