...
#[doc = "Field `CORE_0_DRAM0_PMS_MONITOR_LOCK` reader - Set 1 to lock core0 dram0 permission monitor configuration register."]
pub type CORE_0_DRAM0_PMS_MONITOR_LOCK_R = crate::BitReader;
#[doc = "Field `CORE_0_DRAM0_PMS_MONITOR_LOCK` writer - Set 1 to lock core0 dram0 permission monitor configuration register."]
...
impl W {
    ...
    pub fn core_0_dram0_pms_monitor_lock(
        &mut self,
    ) -> CORE_0_DRAM0_PMS_MONITOR_LOCK_W<'_, CORE_0_DRAM0_PMS_MONITOR_0_SPEC> {
        CORE_0_DRAM0_PMS_MONITOR_LOCK_W::new(self, 0)
    }
}
#[doc = "core0 dram0 permission monitor configuration register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`core_0_dram0_pms_monitor_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_0_dram0_pms_monitor_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
