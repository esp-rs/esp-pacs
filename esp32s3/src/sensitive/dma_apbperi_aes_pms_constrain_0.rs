///Register `DMA_APBPERI_AES_PMS_CONSTRAIN_0` reader
pub type R = crate::R<DMA_APBPERI_AES_PMS_CONSTRAIN_0_SPEC>;
///Register `DMA_APBPERI_AES_PMS_CONSTRAIN_0` writer
pub type W = crate::W<DMA_APBPERI_AES_PMS_CONSTRAIN_0_SPEC>;
///Field `DMA_APBPERI_AES_PMS_CONSTRAIN_LOCK` reader - Set 1 to lock aes dma permission Configuration Register.
pub type DMA_APBPERI_AES_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
///Field `DMA_APBPERI_AES_PMS_CONSTRAIN_LOCK` writer - Set 1 to lock aes dma permission Configuration Register.
pub type DMA_APBPERI_AES_PMS_CONSTRAIN_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock aes dma permission Configuration Register.
    #[inline(always)]
...
///`read()` method returns [`dma_apbperi_aes_pms_constrain_0::R`](R) reader structure
impl crate::Readable for DMA_APBPERI_AES_PMS_CONSTRAIN_0_SPEC {}
///`write(|w| ..)` method takes [`dma_apbperi_aes_pms_constrain_0::W`](W) writer structure
