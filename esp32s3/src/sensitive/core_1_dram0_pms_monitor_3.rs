///Register `CORE_1_DRAM0_PMS_MONITOR_3` reader
pub type R = crate::R<CORE_1_DRAM0_PMS_MONITOR_3_SPEC>;
///Field `CORE_1_DRAM0_PMS_MONITOR_VIOLATE_STATUS_WR` reader - recorded core1 dram0 wr status, 1 means store, 0 means load.
pub type CORE_1_DRAM0_PMS_MONITOR_VIOLATE_STATUS_WR_R = crate::BitReader;
///Field `CORE_1_DRAM0_PMS_MONITOR_VIOLATE_STATUS_BYTEEN` reader - recorded core1 dram0 byteen status.
pub type CORE_1_DRAM0_PMS_MONITOR_VIOLATE_STATUS_BYTEEN_R = crate::FieldReader<u16>;
impl R {
    ///Bit 0 - recorded core1 dram0 wr status, 1 means store, 0 means load.
    #[inline(always)]
    ...
    ///Bits 1:16 - recorded core1 dram0 byteen status.
    #[inline(always)]
...
///`read()` method returns [`core_1_dram0_pms_monitor_3::R`](R) reader structure
