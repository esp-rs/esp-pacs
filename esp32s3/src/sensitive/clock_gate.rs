...
///Field `REG_CLK_EN` reader - Set 1 to enable clock gate function.
pub type REG_CLK_EN_R = crate::BitReader;
///Field `REG_CLK_EN` writer - Set 1 to enable clock gate function.
pub type REG_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to enable clock gate function.
    #[inline(always)]
