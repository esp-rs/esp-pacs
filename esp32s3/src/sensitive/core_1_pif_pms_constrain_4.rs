    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_PIF_PMS_CONSTRAIN_4")
            ...
            .field(
                ...
                &self.core_1_pif_pms_constrain_world_0_apb_adc().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_0_lcd_cam",
                &self.core_1_pif_pms_constrain_world_0_lcd_cam().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_0_bt_pwr",
                &self.core_1_pif_pms_constrain_world_0_bt_pwr().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_0_usb",
                &self.core_1_pif_pms_constrain_world_0_usb().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_0_system",
                &self.core_1_pif_pms_constrain_world_0_system().bits(),
            )
            .field(
            ...
            .field(
                ...
                &self.core_1_pif_pms_constrain_world_0_ad().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_0_dio",
                &self.core_1_pif_pms_constrain_world_0_dio().bits(),
            )
            .field(
