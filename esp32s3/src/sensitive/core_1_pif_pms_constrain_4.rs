...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_USB_DEVICE_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_USB_DEVICE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_1_PIF_PMS_CONSTRAIN_4_SPEC, u8, u8, 2, O>;
#[doc = "Field `CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_USB_WRAP` reader - Core1 access usb_wrap permission in world0."]
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_USB_WRAP_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_CRYPTO_PERI_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_CRYPTO_DMA_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_APB_ADC_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_LCD_CAM_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_BT_PWR_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_USB_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_SYSTEM_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_SENSITIVE_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_INTERRUPT_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_DMA_COPY_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_CACHE_CONFIG_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_AD_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_DIO_R = crate::FieldReader<u8, u8>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_0_WORLD_CONTROLLER_R = crate::FieldReader<u8, u8>;
