    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_DRAM0_PMS_MONITOR_1")
            .field(
                ...
                &self.core_1_dram0_pms_monitor_violate_clr(),
            )
            .field(
                "core_1_dram0_pms_monitor_violate_en",
                &self.core_1_dram0_pms_monitor_violate_en(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn core_1_dram0_pms_monitor_violate_clr(
        &mut self,
    ) -> CORE_1_DRAM0_PMS_MONITOR_VIOLATE_CLR_W<'_, CORE_1_DRAM0_PMS_MONITOR_1_SPEC> {
    ...
    pub fn core_1_dram0_pms_monitor_violate_en(
        &mut self,
    ) -> CORE_1_DRAM0_PMS_MONITOR_VIOLATE_EN_W<'_, CORE_1_DRAM0_PMS_MONITOR_1_SPEC> {
