...
pub struct R(crate::R<CORE_1_DRAM0_PMS_MONITOR_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_DRAM0_PMS_MONITOR_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_DRAM0_PMS_MONITOR_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_DRAM0_PMS_MONITOR_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_1_DRAM0_PMS_MONITOR_1` writer"]
pub struct W(crate::W<CORE_1_DRAM0_PMS_MONITOR_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_DRAM0_PMS_MONITOR_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_DRAM0_PMS_MONITOR_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_DRAM0_PMS_MONITOR_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CORE_1_DRAM0_PMS_MONITOR_VIOLATE_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, CORE_1_DRAM0_PMS_MONITOR_1_SPEC, O>;
...
pub type CORE_1_DRAM0_PMS_MONITOR_VIOLATE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, CORE_1_DRAM0_PMS_MONITOR_1_SPEC, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_DRAM0_PMS_MONITOR_1")
            .field(
                "core_1_dram0_pms_monitor_violate_clr",
                &format_args!("{}", self.core_1_dram0_pms_monitor_violate_clr().bit()),
            )
            .field(
                "core_1_dram0_pms_monitor_violate_en",
                &format_args!("{}", self.core_1_dram0_pms_monitor_violate_en().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_1_DRAM0_PMS_MONITOR_1_SPEC> {
...
impl W {
    ...
    pub fn core_1_dram0_pms_monitor_violate_clr(
        &mut self,
    ) -> CORE_1_DRAM0_PMS_MONITOR_VIOLATE_CLR_W<0> {
        CORE_1_DRAM0_PMS_MONITOR_VIOLATE_CLR_W::new(self)
    }
    #[doc = "Bit 1 - Set 1 to enable core1 dram0 permission monitor interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_dram0_pms_monitor_violate_en(
        &mut self,
    ) -> CORE_1_DRAM0_PMS_MONITOR_VIOLATE_EN_W<1> {
        CORE_1_DRAM0_PMS_MONITOR_VIOLATE_EN_W::new(self)
    }
