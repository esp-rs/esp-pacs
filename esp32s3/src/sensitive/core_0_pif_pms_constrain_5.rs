...
pub type CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_world_1_hinf(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_HINF_W<CORE_0_PIF_PMS_CONSTRAIN_5_SPEC, 20> {
    ...
    pub fn core_0_pif_pms_constrain_world_1_i2s0(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2S0_W<CORE_0_PIF_PMS_CONSTRAIN_5_SPEC, 28> {
