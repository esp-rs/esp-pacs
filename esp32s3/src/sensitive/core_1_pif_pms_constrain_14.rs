///Register `CORE_1_PIF_PMS_CONSTRAIN_14` reader
pub type R = crate::R<CORE_1_PIF_PMS_CONSTRAIN_14_SPEC>;
///Register `CORE_1_PIF_PMS_CONSTRAIN_14` writer
pub type W = crate::W<CORE_1_PIF_PMS_CONSTRAIN_14_SPEC>;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L` reader - RTCSlow_1 memory low region permission in world 0 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_R = crate::FieldReader;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L` writer - RTCSlow_1 memory low region permission in world 0 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_L_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H` reader - RTCSlow_1 memory high region permission in world 0 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_R = crate::FieldReader;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H` writer - RTCSlow_1 memory high region permission in world 0 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_0_H_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L` reader - RTCSlow_1 memory low region permission in world 1 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_R = crate::FieldReader;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L` writer - RTCSlow_1 memory low region permission in world 1 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_L_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H` reader - RTCSlow_1 memory high region permission in world 1 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_R = crate::FieldReader;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H` writer - RTCSlow_1 memory high region permission in world 1 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_WORLD_1_H_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2 - RTCSlow_1 memory low region permission in world 0 for core1.
    #[inline(always)]
    ...
    ///Bits 3:5 - RTCSlow_1 memory high region permission in world 0 for core1.
    #[inline(always)]
    ...
    ///Bits 6:8 - RTCSlow_1 memory low region permission in world 1 for core1.
    #[inline(always)]
    ...
    ///Bits 9:11 - RTCSlow_1 memory high region permission in world 1 for core1.
    #[inline(always)]
...
///`read()` method returns [`core_1_pif_pms_constrain_14::R`](R) reader structure
impl crate::Readable for CORE_1_PIF_PMS_CONSTRAIN_14_SPEC {}
///`write(|w| ..)` method takes [`core_1_pif_pms_constrain_14::W`](W) writer structure
