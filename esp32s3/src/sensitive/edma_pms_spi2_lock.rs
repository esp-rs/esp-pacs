...
pub type EDMA_PMS_SPI2_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, EDMA_PMS_SPI2_LOCK_SPEC, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EDMA_PMS_SPI2_LOCK")
            .field(
                "edma_pms_spi2_lock",
                &format_args!("{}", self.edma_pms_spi2_lock().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<EDMA_PMS_SPI2_LOCK_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn edma_pms_spi2_lock(&mut self) -> EDMA_PMS_SPI2_LOCK_W<0> {
