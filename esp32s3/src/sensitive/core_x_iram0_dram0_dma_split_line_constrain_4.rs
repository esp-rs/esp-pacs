    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_4")
            ...
            .field(
                ...
                &self.core_x_dram0_dma_sram_line_0_category_3().bits(),
            )
            .field(
                "core_x_dram0_dma_sram_line_0_category_4",
                &self.core_x_dram0_dma_sram_line_0_category_4().bits(),
            )
            .field(
                "core_x_dram0_dma_sram_line_0_category_5",
                &self.core_x_dram0_dma_sram_line_0_category_5().bits(),
            )
            .field(
                "core_x_dram0_dma_sram_line_0_category_6",
                &self.core_x_dram0_dma_sram_line_0_category_6().bits(),
            )
            .field(
