...
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_SPLTADDR_WORLD_0_W<'a, REG, const O: u8> =
...
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_SPLTADDR_WORLD_1_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 11, O, u16>;
impl R {
...
impl W {
    ...
    pub fn core_1_pif_pms_constrain_rtcfast_spltaddr_world_0(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_SPLTADDR_WORLD_0_W<CORE_1_PIF_PMS_CONSTRAIN_9_SPEC, 0>
    {
    ...
    pub fn core_1_pif_pms_constrain_rtcfast_spltaddr_world_1(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_SPLTADDR_WORLD_1_W<CORE_1_PIF_PMS_CONSTRAIN_9_SPEC, 11>
    {
