...
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCFAST_SPLTADDR_WORLD_1_W<'a, REG> =
    crate::FieldWriter<'a, REG, 11, u16>;
impl R {
    ///Bits 0:10 - RTCFast memory split address in world 0 for core1.
    #[inline(always)]
    ...
    ///Bits 11:21 - RTCFast memory split address in world 1 for core1.
    #[inline(always)]
...
///`read()` method returns [`core_1_pif_pms_constrain_9::R`](R) reader structure
impl crate::Readable for CORE_1_PIF_PMS_CONSTRAIN_9_SPEC {}
///`write(|w| ..)` method takes [`core_1_pif_pms_constrain_9::W`](W) writer structure
