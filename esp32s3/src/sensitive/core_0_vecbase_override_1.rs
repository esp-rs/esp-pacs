...
pub type CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_W<'a, REG, const O: u8> =
...
pub type CORE_0_VECBASE_OVERRIDE_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_VECBASE_OVERRIDE_1")
            .field(
                ...
                &format_args!("{}", self.core_0_vecbase_override_world0_value().bits()),
            )
            .field(
                "core_0_vecbase_override_sel",
                &format_args!("{}", self.core_0_vecbase_override_sel().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_0_VECBASE_OVERRIDE_1_SPEC> {
...
impl W {
    ...
    pub fn core_0_vecbase_override_world0_value(
        &mut self,
    ) -> CORE_0_VECBASE_OVERRIDE_WORLD0_VALUE_W<CORE_0_VECBASE_OVERRIDE_1_SPEC, 0> {
    ...
    pub fn core_0_vecbase_override_sel(
        &mut self,
    ) -> CORE_0_VECBASE_OVERRIDE_SEL_W<CORE_0_VECBASE_OVERRIDE_1_SPEC, 22> {
