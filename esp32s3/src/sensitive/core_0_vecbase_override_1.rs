///Register `CORE_0_VECBASE_OVERRIDE_1` reader
pub type R = crate::R<CORE_0_VECBASE_OVERRIDE_1_SPEC>;
///Register `CORE_0_VECBASE_OVERRIDE_1` writer
...
///`read()` method returns [`core_0_vecbase_override_1::R`](R) reader structure
impl crate::Readable for CORE_0_VECBASE_OVERRIDE_1_SPEC {}
///`write(|w| ..)` method takes [`core_0_vecbase_override_1::W`](W) writer structure
