///Register `CORE_1_REGION_PMS_CONSTRAIN_14` reader
pub type R = crate::R<CORE_1_REGION_PMS_CONSTRAIN_14_SPEC>;
///Register `CORE_1_REGION_PMS_CONSTRAIN_14` writer
pub type W = crate::W<CORE_1_REGION_PMS_CONSTRAIN_14_SPEC>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_11` reader - Region 10 end address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_11_R = crate::FieldReader<u32>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_11` writer - Region 10 end address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_11_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Region 10 end address for core1.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_REGION_PMS_CONSTRAIN_14")
            .field(
                ...
                &self.core_1_region_pms_constrain_addr_11(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_1_region_pms_constrain_14::R`](R) reader structure
impl crate::Readable for CORE_1_REGION_PMS_CONSTRAIN_14_SPEC {}
///`write(|w| ..)` method takes [`core_1_region_pms_constrain_14::W`](W) writer structure
