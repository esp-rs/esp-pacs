...
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_WORLD_0_L_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_1_PIF_PMS_CONSTRAIN_12_SPEC, 3, O>;
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_PIF_PMS_CONSTRAIN_12")
            .field(
                ...
                &format_args!(
                    "{}",
                    self.core_1_pif_pms_constrain_rtcslow_0_world_0_l().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.core_1_pif_pms_constrain_rtcslow_0_world_0_h().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.core_1_pif_pms_constrain_rtcslow_0_world_1_l().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.core_1_pif_pms_constrain_rtcslow_0_world_1_h().bits()
                ),
            )
            .finish()
    }
