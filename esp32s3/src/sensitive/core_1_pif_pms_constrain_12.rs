...
impl W {
    ...
    pub fn core_1_pif_pms_constrain_rtcslow_0_world_0_l(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_WORLD_0_L_W<'_, CORE_1_PIF_PMS_CONSTRAIN_12_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_rtcslow_0_world_0_h(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_WORLD_0_H_W<'_, CORE_1_PIF_PMS_CONSTRAIN_12_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_rtcslow_0_world_1_l(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_WORLD_1_L_W<'_, CORE_1_PIF_PMS_CONSTRAIN_12_SPEC> {
