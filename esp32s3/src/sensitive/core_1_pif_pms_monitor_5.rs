///Register `CORE_1_PIF_PMS_MONITOR_5` reader
pub type R = crate::R<CORE_1_PIF_PMS_MONITOR_5_SPEC>;
///Field `CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_INTR` reader - Record core1 unsupported access type interrupt state.
pub type CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_INTR_R = crate::BitReader;
///Field `CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HSIZE` reader - Record access type when core1 initiate unsupported access type.
pub type CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HSIZE_R = crate::FieldReader;
///Field `CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HWORLD` reader - Record world information when core1 initiate unsupported access type.
pub type CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HWORLD_R = crate::FieldReader;
impl R {
    ///Bit 0 - Record core1 unsupported access type interrupt state.
    #[inline(always)]
    ...
    ///Bits 1:2 - Record access type when core1 initiate unsupported access type.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_1_pif_pms_monitor_5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_1_PIF_PMS_MONITOR_5_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_MONITOR_5_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_1_pif_pms_monitor_5::R`](R) reader structure
