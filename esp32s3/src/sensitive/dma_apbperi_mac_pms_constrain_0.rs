...
pub type DMA_APBPERI_MAC_PMS_CONSTRAIN_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, DMA_APBPERI_MAC_PMS_CONSTRAIN_0_SPEC, O>;
impl R {
...
impl W {
    ...
    pub fn dma_apbperi_mac_pms_constrain_lock(
        &mut self,
    ) -> DMA_APBPERI_MAC_PMS_CONSTRAIN_LOCK_W<0> {
