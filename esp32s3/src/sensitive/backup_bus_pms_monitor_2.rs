...
///Field `BACKUP_BUS_PMS_MONITOR_VIOLATE_INTR` reader - Record BackUp illegal access interrupt state.
pub type BACKUP_BUS_PMS_MONITOR_VIOLATE_INTR_R = crate::BitReader;
///Field `BACKUP_BUS_PMS_MONITOR_VIOLATE_STATUS_HTRANS` reader - Record htrans when BackUp initate illegal access.
pub type BACKUP_BUS_PMS_MONITOR_VIOLATE_STATUS_HTRANS_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_MONITOR_VIOLATE_STATUS_HSIZE` reader - Record access type when BackUp initate illegal access.
pub type BACKUP_BUS_PMS_MONITOR_VIOLATE_STATUS_HSIZE_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_MONITOR_VIOLATE_STATUS_HWRITE` reader - Record access direction when BackUp initiate illegal access.
