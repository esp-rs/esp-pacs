...
pub type CORE_X_IRAM0_PMS_CONSTRAIN_LOCK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn core_x_iram0_pms_constrain_lock(
        &mut self,
    ) -> CORE_X_IRAM0_PMS_CONSTRAIN_LOCK_W<CORE_X_IRAM0_PMS_CONSTRAIN_0_SPEC, 0> {
