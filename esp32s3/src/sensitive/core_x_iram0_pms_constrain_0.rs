...
#[doc = "Field `CORE_X_IRAM0_PMS_CONSTRAIN_LOCK` reader - Set 1 to lock corex iram0 permission configuration register"]
pub type CORE_X_IRAM0_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
#[doc = "Field `CORE_X_IRAM0_PMS_CONSTRAIN_LOCK` writer - Set 1 to lock corex iram0 permission configuration register"]
pub type CORE_X_IRAM0_PMS_CONSTRAIN_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, CORE_X_IRAM0_PMS_CONSTRAIN_0_SPEC, O>;
impl R {
    #[doc = "Bit 0 - Set 1 to lock corex iram0 permission configuration register"]
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_X_IRAM0_PMS_CONSTRAIN_0")
            .field(
                ...
                &format_args!("{}", self.core_x_iram0_pms_constrain_lock().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_X_IRAM0_PMS_CONSTRAIN_0_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_x_iram0_pms_constrain_lock(&mut self) -> CORE_X_IRAM0_PMS_CONSTRAIN_LOCK_W<0> {
