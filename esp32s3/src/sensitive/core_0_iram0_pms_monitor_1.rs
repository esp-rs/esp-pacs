///Register `CORE_0_IRAM0_PMS_MONITOR_1` reader
pub type R = crate::R<CORE_0_IRAM0_PMS_MONITOR_1_SPEC>;
///Register `CORE_0_IRAM0_PMS_MONITOR_1` writer
pub type W = crate::W<CORE_0_IRAM0_PMS_MONITOR_1_SPEC>;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_CLR` reader - Set 1 to clear core0 iram0 permission violated interrupt
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_CLR_R = crate::BitReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_CLR` writer - Set 1 to clear core0 iram0 permission violated interrupt
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_EN` reader - Set 1 to enable core0 iram0 permission monitor, when core0_iram violated permission, will trigger interrupt
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_EN_R = crate::BitReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_EN` writer - Set 1 to enable core0 iram0 permission monitor, when core0_iram violated permission, will trigger interrupt
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to clear core0 iram0 permission violated interrupt
    #[inline(always)]
    ...
    ///Bit 1 - Set 1 to enable core0 iram0 permission monitor, when core0_iram violated permission, will trigger interrupt
    #[inline(always)]
...
///`read()` method returns [`core_0_iram0_pms_monitor_1::R`](R) reader structure
impl crate::Readable for CORE_0_IRAM0_PMS_MONITOR_1_SPEC {}
///`write(|w| ..)` method takes [`core_0_iram0_pms_monitor_1::W`](W) writer structure
