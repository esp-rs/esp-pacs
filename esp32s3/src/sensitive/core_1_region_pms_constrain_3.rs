///Register `CORE_1_REGION_PMS_CONSTRAIN_3` reader
pub type R = crate::R<CORE_1_REGION_PMS_CONSTRAIN_3_SPEC>;
///Register `CORE_1_REGION_PMS_CONSTRAIN_3` writer
pub type W = crate::W<CORE_1_REGION_PMS_CONSTRAIN_3_SPEC>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_0` reader - Region 0 start address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_0_R = crate::FieldReader<u32>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_ADDR_0` writer - Region 0 start address for core1.
pub type CORE_1_REGION_PMS_CONSTRAIN_ADDR_0_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Region 0 start address for core1.
    #[inline(always)]
...
///`read()` method returns [`core_1_region_pms_constrain_3::R`](R) reader structure
impl crate::Readable for CORE_1_REGION_PMS_CONSTRAIN_3_SPEC {}
///`write(|w| ..)` method takes [`core_1_region_pms_constrain_3::W`](W) writer structure
