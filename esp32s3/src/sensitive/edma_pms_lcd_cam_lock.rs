...
pub struct R(crate::R<EDMA_PMS_LCD_CAM_LOCK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EDMA_PMS_LCD_CAM_LOCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EDMA_PMS_LCD_CAM_LOCK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EDMA_PMS_LCD_CAM_LOCK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EDMA_PMS_LCD_CAM_LOCK` writer"]
pub struct W(crate::W<EDMA_PMS_LCD_CAM_LOCK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EDMA_PMS_LCD_CAM_LOCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EDMA_PMS_LCD_CAM_LOCK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EDMA_PMS_LCD_CAM_LOCK_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EDMA_PMS_LCD_CAM_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, EDMA_PMS_LCD_CAM_LOCK_SPEC, O>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EDMA_PMS_LCD_CAM_LOCK")
            .field(
                ...
                &format_args!("{}", self.edma_pms_lcd_cam_lock().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<EDMA_PMS_LCD_CAM_LOCK_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn edma_pms_lcd_cam_lock(&mut self) -> EDMA_PMS_LCD_CAM_LOCK_W<0> {
        EDMA_PMS_LCD_CAM_LOCK_W::new(self)
    }
