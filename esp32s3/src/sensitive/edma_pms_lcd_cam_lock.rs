...
#[doc = "EDMA-LCD/CAM permission lock register.\n\nYou can [`read`](crate::Reg::read) this register and get [`edma_pms_lcd_cam_lock::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`edma_pms_lcd_cam_lock::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
