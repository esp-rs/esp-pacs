///Register `EDMA_PMS_LCD_CAM_LOCK` reader
pub type R = crate::R<EDMA_PMS_LCD_CAM_LOCK_SPEC>;
///Register `EDMA_PMS_LCD_CAM_LOCK` writer
pub type W = crate::W<EDMA_PMS_LCD_CAM_LOCK_SPEC>;
///Field `EDMA_PMS_LCD_CAM_LOCK` reader - Set 1 to lock EDMA-LCD/CAM permission control registers.
pub type EDMA_PMS_LCD_CAM_LOCK_R = crate::BitReader;
///Field `EDMA_PMS_LCD_CAM_LOCK` writer - Set 1 to lock EDMA-LCD/CAM permission control registers.
pub type EDMA_PMS_LCD_CAM_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock EDMA-LCD/CAM permission control registers.
    #[inline(always)]
...
///`read()` method returns [`edma_pms_lcd_cam_lock::R`](R) reader structure
impl crate::Readable for EDMA_PMS_LCD_CAM_LOCK_SPEC {}
///`write(|w| ..)` method takes [`edma_pms_lcd_cam_lock::W`](W) writer structure
