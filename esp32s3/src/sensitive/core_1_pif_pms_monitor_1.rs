...
pub type CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn core_1_pif_pms_monitor_violate_clr(
        &mut self,
    ) -> CORE_1_PIF_PMS_MONITOR_VIOLATE_CLR_W<CORE_1_PIF_PMS_MONITOR_1_SPEC, 0> {
    ...
    pub fn core_1_pif_pms_monitor_violate_en(
        &mut self,
    ) -> CORE_1_PIF_PMS_MONITOR_VIOLATE_EN_W<CORE_1_PIF_PMS_MONITOR_1_SPEC, 1> {
