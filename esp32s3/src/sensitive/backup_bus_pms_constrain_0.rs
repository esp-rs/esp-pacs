///Register `BACKUP_BUS_PMS_CONSTRAIN_0` reader
pub type R = crate::R<BACKUP_BUS_PMS_CONSTRAIN_0_SPEC>;
///Register `BACKUP_BUS_PMS_CONSTRAIN_0` writer
pub type W = crate::W<BACKUP_BUS_PMS_CONSTRAIN_0_SPEC>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_LOCK` reader - Set 1 to lock BackUp permission configuration registers.
pub type BACKUP_BUS_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_LOCK` writer - Set 1 to lock BackUp permission configuration registers.
pub type BACKUP_BUS_PMS_CONSTRAIN_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock BackUp permission configuration registers.
    #[inline(always)]
...
///`read()` method returns [`backup_bus_pms_constrain_0::R`](R) reader structure
impl crate::Readable for BACKUP_BUS_PMS_CONSTRAIN_0_SPEC {}
///`write(|w| ..)` method takes [`backup_bus_pms_constrain_0::W`](W) writer structure
