...
impl W {
    ...
    pub fn core_1_pif_pms_constrain_lock(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_LOCK_W<'_, CORE_1_PIF_PMS_CONSTRAIN_0_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_LOCK_W::new(self, 0)
    }
}
#[doc = "Core1 access peripherals permission configuration register 0.\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_pif_pms_constrain_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_1_pif_pms_constrain_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
