///Register `CORE_1_PIF_PMS_CONSTRAIN_11` reader
pub type R = crate::R<CORE_1_PIF_PMS_CONSTRAIN_11_SPEC>;
///Register `CORE_1_PIF_PMS_CONSTRAIN_11` writer
pub type W = crate::W<CORE_1_PIF_PMS_CONSTRAIN_11_SPEC>;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0` reader - RTCSlow_0 memory split address in world 0 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0_R = crate::FieldReader<u16>;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0` writer - RTCSlow_0 memory split address in world 0 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0_W<'a, REG> =
    crate::FieldWriter<'a, REG, 11, u16>;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1` reader - RTCSlow_0 memory split address in world 1 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1_R = crate::FieldReader<u16>;
///Field `CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1` writer - RTCSlow_0 memory split address in world 1 for core1.
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1_W<'a, REG> =
    crate::FieldWriter<'a, REG, 11, u16>;
impl R {
    ///Bits 0:10 - RTCSlow_0 memory split address in world 0 for core1.
    #[inline(always)]
    ...
    ///Bits 11:21 - RTCSlow_0 memory split address in world 1 for core1.
    #[inline(always)]
...
impl W {
    ...
    {
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0_W::new(self, 0)
    }
    ///Bits 11:21 - RTCSlow_0 memory split address in world 1 for core1.
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`core_1_pif_pms_constrain_11::R`](R) reader structure
impl crate::Readable for CORE_1_PIF_PMS_CONSTRAIN_11_SPEC {}
///`write(|w| ..)` method takes [`core_1_pif_pms_constrain_11::W`](W) writer structure
