...
pub type EDMA_PMS_SPI3_LOCK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn edma_pms_spi3_lock(&mut self) -> EDMA_PMS_SPI3_LOCK_W<EDMA_PMS_SPI3_LOCK_SPEC, 0> {
