...
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_10_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_10` writer - Region 9 end address and Region 10 start address for core0."]
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_10_W<'a, const O: u8> =
    crate::FieldWriter<'a, CORE_0_REGION_PMS_CONSTRAIN_13_SPEC, 30, O, u32, u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_REGION_PMS_CONSTRAIN_13")
            .field(
                ...
                &format_args!("{}", self.core_0_region_pms_constrain_addr_10().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_0_REGION_PMS_CONSTRAIN_13_SPEC> {
...
impl W {
    ...
    pub fn core_0_region_pms_constrain_addr_10(
        &mut self,
    ) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_10_W<0> {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_10_W::new(self)
    }
