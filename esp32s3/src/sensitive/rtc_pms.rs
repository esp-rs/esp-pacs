///Register `RTC_PMS` reader
pub type R = crate::R<RTC_PMS_SPEC>;
///Register `RTC_PMS` writer
pub type W = crate::W<RTC_PMS_SPEC>;
///Field `DIS_RTC_CPU` reader - Set 1 to disable rtc coprocessor.
pub type DIS_RTC_CPU_R = crate::BitReader;
///Field `DIS_RTC_CPU` writer - Set 1 to disable rtc coprocessor.
pub type DIS_RTC_CPU_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to disable rtc coprocessor.
    #[inline(always)]
...
///`read()` method returns [`rtc_pms::R`](R) reader structure
impl crate::Readable for RTC_PMS_SPEC {}
///`write(|w| ..)` method takes [`rtc_pms::W`](W) writer structure
