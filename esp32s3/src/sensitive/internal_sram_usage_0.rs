///Register `INTERNAL_SRAM_USAGE_0` reader
pub type R = crate::R<INTERNAL_SRAM_USAGE_0_SPEC>;
///Register `INTERNAL_SRAM_USAGE_0` writer
pub type W = crate::W<INTERNAL_SRAM_USAGE_0_SPEC>;
///Field `INTERNAL_SRAM_USAGE_LOCK` reader - Set 1 to lock internal SRAM Configuration Register.
pub type INTERNAL_SRAM_USAGE_LOCK_R = crate::BitReader;
///Field `INTERNAL_SRAM_USAGE_LOCK` writer - Set 1 to lock internal SRAM Configuration Register.
...
///`read()` method returns [`internal_sram_usage_0::R`](R) reader structure
impl crate::Readable for INTERNAL_SRAM_USAGE_0_SPEC {}
///`write(|w| ..)` method takes [`internal_sram_usage_0::W`](W) writer structure
