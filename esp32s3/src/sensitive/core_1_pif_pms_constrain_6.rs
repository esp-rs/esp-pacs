///Register `CORE_1_PIF_PMS_CONSTRAIN_6` reader
pub type R = crate::R<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC>;
///Register `CORE_1_PIF_PMS_CONSTRAIN_6` writer
pub type W = crate::W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC>;
///Field `CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BT` reader - Core1 access bt permission in world1.
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BT_R = crate::FieldReader;
///Field `CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BT` writer - Core1 access bt permission in world1.
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BT_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BB_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl R {
    ...
    ///Bits 6:7 - Core1 access uhci0 permission in world1.
    #[inline(always)]
    ...
    ///Bits 8:9 - Core1 access slchost permission in world1.
    #[inline(always)]
    ...
    ///Bits 28:29 - Core1 access timergroup1 permission in world1.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_PIF_PMS_CONSTRAIN_6")
            .field(
                ...
                &self.core_1_pif_pms_constrain_world_1_bt(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_i2c_ext0",
                &self.core_1_pif_pms_constrain_world_1_i2c_ext0(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_uhci0",
                &self.core_1_pif_pms_constrain_world_1_uhci0(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_slchost",
                &self.core_1_pif_pms_constrain_world_1_slchost(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_rmt",
                &self.core_1_pif_pms_constrain_world_1_rmt(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_pcnt",
                &self.core_1_pif_pms_constrain_world_1_pcnt(),
            )
            .field(
            ...
            .field(
                ...
                &self.core_1_pif_pms_constrain_world_1_ledc(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_backup",
                &self.core_1_pif_pms_constrain_world_1_backup(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_bb",
                &self.core_1_pif_pms_constrain_world_1_bb(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_pwm0",
                &self.core_1_pif_pms_constrain_world_1_pwm0(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_timergroup",
                &self.core_1_pif_pms_constrain_world_1_timergroup(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_timergroup1",
                &self.core_1_pif_pms_constrain_world_1_timergroup1(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_systimer",
                &self.core_1_pif_pms_constrain_world_1_systimer(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn core_1_pif_pms_constrain_world_1_bt(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BT_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BT_W::new(self, 0)
    }
    ///Bits 4:5 - Core1 access i2c_ext0 permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_i2c_ext0(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_I2C_EXT0_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_I2C_EXT0_W::new(self, 4)
    }
    ///Bits 6:7 - Core1 access uhci0 permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_uhci0(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_UHCI0_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_UHCI0_W::new(self, 6)
    }
    ///Bits 8:9 - Core1 access slchost permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_slchost(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SLCHOST_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SLCHOST_W::new(self, 8)
    }
    ///Bits 10:11 - Core1 access rmt permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_rmt(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_RMT_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_RMT_W::new(self, 10)
    }
    ///Bits 12:13 - Core1 access pcnt permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_pcnt(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_PCNT_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_PCNT_W::new(self, 12)
    }
    ///Bits 14:15 - Core1 access slc permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_slc(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SLC_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SLC_W::new(self, 14)
    }
    ///Bits 16:17 - Core1 access ledc permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_ledc(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_LEDC_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_LEDC_W::new(self, 16)
    }
    ///Bits 18:19 - Core1 access backup permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_backup(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BACKUP_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BACKUP_W::new(self, 18)
    }
    ///Bits 22:23 - Core1 access bb permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_bb(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BB_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BB_W::new(self, 22)
    }
    ///Bits 24:25 - Core1 access pwm0 permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_pwm0(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_PWM0_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_PWM0_W::new(self, 24)
    }
    ///Bits 26:27 - Core1 access timergroup permission in world1.
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_timergroup(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_TIMERGROUP_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_TIMERGROUP_W::new(self, 26)
    }
    ///Bits 28:29 - Core1 access timergroup1 permission in world1.
    #[inline(always)]
    #[must_use]
    ...
    pub fn core_1_pif_pms_constrain_world_1_systimer(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SYSTIMER_W<CORE_1_PIF_PMS_CONSTRAIN_6_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SYSTIMER_W::new(self, 30)
    }
}
/**Core1 access peripherals permission configuration register 6.

You can [`read`](crate::generic::Reg::read) this register and get [`core_1_pif_pms_constrain_6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_1_pif_pms_constrain_6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_1_PIF_PMS_CONSTRAIN_6_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_CONSTRAIN_6_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_1_pif_pms_constrain_6::R`](R) reader structure
impl crate::Readable for CORE_1_PIF_PMS_CONSTRAIN_6_SPEC {}
///`write(|w| ..)` method takes [`core_1_pif_pms_constrain_6::W`](W) writer structure
