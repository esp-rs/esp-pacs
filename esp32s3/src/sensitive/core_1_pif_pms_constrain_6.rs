    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_PIF_PMS_CONSTRAIN_6")
            .field(
                ...
                &self.core_1_pif_pms_constrain_world_1_bt().bits(),
            )
            .field(
            ...
            .field(
                ...
                &self.core_1_pif_pms_constrain_world_1_uhci0().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_slchost",
                &self.core_1_pif_pms_constrain_world_1_slchost().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_rmt",
                &self.core_1_pif_pms_constrain_world_1_rmt().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_pcnt",
                &self.core_1_pif_pms_constrain_world_1_pcnt().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_slc",
                &self.core_1_pif_pms_constrain_world_1_slc().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_ledc",
                &self.core_1_pif_pms_constrain_world_1_ledc().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_backup",
                &self.core_1_pif_pms_constrain_world_1_backup().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_bb",
                &self.core_1_pif_pms_constrain_world_1_bb().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_pwm0",
                &self.core_1_pif_pms_constrain_world_1_pwm0().bits(),
            )
            .field(
