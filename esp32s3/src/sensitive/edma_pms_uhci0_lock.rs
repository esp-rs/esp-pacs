...
pub struct R(crate::R<EDMA_PMS_UHCI0_LOCK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EDMA_PMS_UHCI0_LOCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EDMA_PMS_UHCI0_LOCK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EDMA_PMS_UHCI0_LOCK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EDMA_PMS_UHCI0_LOCK` writer"]
pub struct W(crate::W<EDMA_PMS_UHCI0_LOCK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EDMA_PMS_UHCI0_LOCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EDMA_PMS_UHCI0_LOCK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EDMA_PMS_UHCI0_LOCK_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `EDMA_PMS_UHCI0_LOCK` reader - Set 1 to lock EDMA-UHCI0 permission control registers."]
pub type EDMA_PMS_UHCI0_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `EDMA_PMS_UHCI0_LOCK` writer - Set 1 to lock EDMA-UHCI0 permission control registers."]
pub type EDMA_PMS_UHCI0_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, EDMA_PMS_UHCI0_LOCK_SPEC, bool, O>;
impl R {
...
impl W {
    #[doc = "Bit 0 - Set 1 to lock EDMA-UHCI0 permission control registers."]
    #[inline(always)]
    pub fn edma_pms_uhci0_lock(&mut self) -> EDMA_PMS_UHCI0_LOCK_W<0> {
        EDMA_PMS_UHCI0_LOCK_W::new(self)
    }
