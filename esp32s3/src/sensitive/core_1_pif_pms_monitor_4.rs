...
pub struct R(crate::R<CORE_1_PIF_PMS_MONITOR_4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_PIF_PMS_MONITOR_4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_PIF_PMS_MONITOR_4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_PIF_PMS_MONITOR_4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_1_PIF_PMS_MONITOR_4` writer"]
pub struct W(crate::W<CORE_1_PIF_PMS_MONITOR_4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_PIF_PMS_MONITOR_4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_PIF_PMS_MONITOR_4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_PIF_PMS_MONITOR_4_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    pub fn core_1_pif_pms_monitor_nonword_violate_clr(
        &mut self,
    ) -> CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_CLR_W<0> {
    ...
    pub fn core_1_pif_pms_monitor_nonword_violate_en(
        &mut self,
    ) -> CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_EN_W<1> {
