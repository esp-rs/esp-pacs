///Register `CORE_X_IRAM0_PMS_CONSTRAIN_1` reader
pub type R = crate::R<CORE_X_IRAM0_PMS_CONSTRAIN_1_SPEC>;
///Register `CORE_X_IRAM0_PMS_CONSTRAIN_1` writer
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_X_IRAM0_PMS_CONSTRAIN_1")
            .field(
                ...
                &self.core_x_iram0_pms_constrain_sram_world_1_pms_0(),
            )
            .field(
                "core_x_iram0_pms_constrain_sram_world_1_pms_1",
                &self.core_x_iram0_pms_constrain_sram_world_1_pms_1(),
            )
            .field(
                "core_x_iram0_pms_constrain_sram_world_1_pms_2",
                &self.core_x_iram0_pms_constrain_sram_world_1_pms_2(),
            )
            .field(
                "core_x_iram0_pms_constrain_sram_world_1_pms_3",
                &self.core_x_iram0_pms_constrain_sram_world_1_pms_3(),
            )
            .field(
            ...
            .field(
                ...
                &self.core_x_iram0_pms_constrain_rom_world_1_pms(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn core_x_iram0_pms_constrain_sram_world_1_cachedataarray_pms_1(
        ...
        CORE_X_IRAM0_PMS_CONSTRAIN_1_SPEC,
    > {
        CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_1_CACHEDATAARRAY_PMS_1_W::new(self, 15)
    }
    ///Bits 18:20 - core0/core1's permission of rom in world1
    #[inline(always)]
    #[must_use]
...
///`read()` method returns [`core_x_iram0_pms_constrain_1::R`](R) reader structure
impl crate::Readable for CORE_X_IRAM0_PMS_CONSTRAIN_1_SPEC {}
///`write(|w| ..)` method takes [`core_x_iram0_pms_constrain_1::W`](W) writer structure
