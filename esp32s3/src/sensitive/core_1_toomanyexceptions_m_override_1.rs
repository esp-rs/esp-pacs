...
pub type CORE_1_TOOMANYEXCEPTIONS_M_OVERRIDE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn core_1_toomanyexceptions_m_override(
        &mut self,
    ) -> CORE_1_TOOMANYEXCEPTIONS_M_OVERRIDE_W<CORE_1_TOOMANYEXCEPTIONS_M_OVERRIDE_1_SPEC, 0> {
