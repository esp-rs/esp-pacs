...
pub struct R(crate::R<CORE_0_REGION_PMS_CONSTRAIN_8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_0_REGION_PMS_CONSTRAIN_8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_0_REGION_PMS_CONSTRAIN_8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_0_REGION_PMS_CONSTRAIN_8_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_0_REGION_PMS_CONSTRAIN_8` writer"]
pub struct W(crate::W<CORE_0_REGION_PMS_CONSTRAIN_8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_0_REGION_PMS_CONSTRAIN_8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_0_REGION_PMS_CONSTRAIN_8_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_0_REGION_PMS_CONSTRAIN_8_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_5` reader - Region 4 end address and Region 5 start address for core0."]
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_5_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_5` writer - Region 4 end address and Region 5 start address for core0."]
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_0_REGION_PMS_CONSTRAIN_8_SPEC, u32, u32, 30, O>;
impl R {
    ...
    pub fn core_0_region_pms_constrain_addr_5(&self) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_5_R {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_5_R::new((self.bits & 0x3fff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:29 - Region 4 end address and Region 5 start address for core0."]
    ...
    pub fn core_0_region_pms_constrain_addr_5(
        &mut self,
    ) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_5_W<0> {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_5_W::new(self)
    }
...
#[doc = "Core0 region permission register 8.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [core_0_region_pms_constrain_8](index.html) module"]
