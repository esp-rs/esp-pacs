///Register `RETENTION_DISABLE` reader
pub type R = crate::R<RETENTION_DISABLE_SPEC>;
///Register `RETENTION_DISABLE` writer
pub type W = crate::W<RETENTION_DISABLE_SPEC>;
///Field `RETENTION_DISABLE` reader - Set 1 to disable retention function and lock disable state.
pub type RETENTION_DISABLE_R = crate::BitReader;
///Field `RETENTION_DISABLE` writer - Set 1 to disable retention function and lock disable state.
...
///`read()` method returns [`retention_disable::R`](R) reader structure
impl crate::Readable for RETENTION_DISABLE_SPEC {}
///`write(|w| ..)` method takes [`retention_disable::W`](W) writer structure
