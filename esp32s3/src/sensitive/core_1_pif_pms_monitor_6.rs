...
///Field `CORE_1_PIF_PMS_MONITOR_NONWORD_VIOLATE_STATUS_HADDR` reader - Record address information when core1 initiate unsupported access type.
...
///`read()` method returns [`core_1_pif_pms_monitor_6::R`](R) reader structure
