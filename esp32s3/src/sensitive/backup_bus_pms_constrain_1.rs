...
pub type BACKUP_BUS_PMS_CONSTRAIN_HINF_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_I2S0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
impl W {
    ...
    pub fn backup_bus_pms_constrain_hinf(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_HINF_W<BACKUP_BUS_PMS_CONSTRAIN_1_SPEC, 20> {
    ...
    pub fn backup_bus_pms_constrain_i2s0(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_I2S0_W<BACKUP_BUS_PMS_CONSTRAIN_1_SPEC, 28> {
