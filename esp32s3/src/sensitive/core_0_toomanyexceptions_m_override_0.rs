///Register `CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_0` reader
pub type R = crate::R<CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_0_SPEC>;
///Register `CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_0` writer
pub type W = crate::W<CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_0_SPEC>;
///Field `CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_LOCK` reader - Set 1 to lock core0 toomanyexception override configuration register
pub type CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_LOCK_R = crate::BitReader;
///Field `CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_LOCK` writer - Set 1 to lock core0 toomanyexception override configuration register
pub type CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock core0 toomanyexception override configuration register
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_0")
            .field(
                ...
                &self.core_0_toomanyexceptions_m_override_lock(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn core_0_toomanyexceptions_m_override_lock(
        &mut self,
    ) -> CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_LOCK_W<CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_0_SPEC>
    {
        CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_LOCK_W::new(self, 0)
    }
}
...
///`read()` method returns [`core_0_toomanyexceptions_m_override_0::R`](R) reader structure
impl crate::Readable for CORE_0_TOOMANYEXCEPTIONS_M_OVERRIDE_0_SPEC {}
///`write(|w| ..)` method takes [`core_0_toomanyexceptions_m_override_0::W`](W) writer structure
