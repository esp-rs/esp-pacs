    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_PIF_PMS_CONSTRAIN_2")
            .field(
                ...
                &self.core_0_pif_pms_constrain_world_0_bt().bits(),
            )
            .field(
            ...
            .field(
                ...
                &self.core_0_pif_pms_constrain_world_0_uhci0().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_slchost",
                &self.core_0_pif_pms_constrain_world_0_slchost().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_rmt",
                &self.core_0_pif_pms_constrain_world_0_rmt().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_pcnt",
                &self.core_0_pif_pms_constrain_world_0_pcnt().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_slc",
                &self.core_0_pif_pms_constrain_world_0_slc().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_ledc",
                &self.core_0_pif_pms_constrain_world_0_ledc().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_backup",
                &self.core_0_pif_pms_constrain_world_0_backup().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_bb",
                &self.core_0_pif_pms_constrain_world_0_bb().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_pwm0",
                &self.core_0_pif_pms_constrain_world_0_pwm0().bits(),
            )
            .field(
