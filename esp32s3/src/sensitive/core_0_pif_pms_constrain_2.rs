...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_world_0_slchost(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SLCHOST_W<'_, CORE_0_PIF_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn core_0_pif_pms_constrain_world_0_pcnt(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PCNT_W<'_, CORE_0_PIF_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn core_0_pif_pms_constrain_world_0_slc(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_SLC_W<'_, CORE_0_PIF_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn core_0_pif_pms_constrain_world_0_backup(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_BACKUP_W<'_, CORE_0_PIF_PMS_CONSTRAIN_2_SPEC> {
    ...
    pub fn core_0_pif_pms_constrain_world_0_pwm0(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_PWM0_W<'_, CORE_0_PIF_PMS_CONSTRAIN_2_SPEC> {
