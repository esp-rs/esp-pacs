...
impl W {
    ...
    pub fn core_1_pif_pms_constrain_world_1_usb_device(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_USB_DEVICE_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_usb_wrap(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_USB_WRAP_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_crypto_peri(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_CRYPTO_PERI_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_crypto_dma(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_CRYPTO_DMA_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_apb_adc(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_APB_ADC_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_lcd_cam(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_LCD_CAM_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_bt_pwr(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_BT_PWR_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_usb(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_USB_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_system(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SYSTEM_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_sensitive(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SENSITIVE_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_interrupt(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_INTERRUPT_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_dma_copy(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_DMA_COPY_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_cache_config(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_CACHE_CONFIG_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_ad(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_AD_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_dio(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_DIO_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC> {
    ...
    pub fn core_1_pif_pms_constrain_world_1_world_controller(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_WORLD_CONTROLLER_W<'_, CORE_1_PIF_PMS_CONSTRAIN_8_SPEC>
    {
