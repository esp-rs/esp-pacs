...
pub struct R(crate::R<EDMA_PMS_I2S1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EDMA_PMS_I2S1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EDMA_PMS_I2S1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EDMA_PMS_I2S1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EDMA_PMS_I2S1` writer"]
pub struct W(crate::W<EDMA_PMS_I2S1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EDMA_PMS_I2S1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EDMA_PMS_I2S1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EDMA_PMS_I2S1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ATTR1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EDMA_PMS_I2S1_SPEC, u8, u8, 2, O>;
...
pub type ATTR2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EDMA_PMS_I2S1_SPEC, u8, u8, 2, O>;
impl R {
