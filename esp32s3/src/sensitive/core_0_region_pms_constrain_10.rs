///Register `CORE_0_REGION_PMS_CONSTRAIN_10` reader
pub type R = crate::R<CORE_0_REGION_PMS_CONSTRAIN_10_SPEC>;
///Register `CORE_0_REGION_PMS_CONSTRAIN_10` writer
pub type W = crate::W<CORE_0_REGION_PMS_CONSTRAIN_10_SPEC>;
///Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_7` reader - Region 6 end address and Region 7 start address for core0.
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_7_R = crate::FieldReader<u32>;
///Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_7` writer - Region 6 end address and Region 7 start address for core0.
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_7_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Region 6 end address and Region 7 start address for core0.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_REGION_PMS_CONSTRAIN_10")
            .field(
                ...
                &self.core_0_region_pms_constrain_addr_7(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn core_0_region_pms_constrain_addr_7(
        &mut self,
    ) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_7_W<CORE_0_REGION_PMS_CONSTRAIN_10_SPEC> {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_7_W::new(self, 0)
    }
}
...
///`read()` method returns [`core_0_region_pms_constrain_10::R`](R) reader structure
impl crate::Readable for CORE_0_REGION_PMS_CONSTRAIN_10_SPEC {}
///`write(|w| ..)` method takes [`core_0_region_pms_constrain_10::W`](W) writer structure
