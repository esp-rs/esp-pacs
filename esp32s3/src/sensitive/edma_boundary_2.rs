///Register `EDMA_BOUNDARY_2` reader
pub type R = crate::R<EDMA_BOUNDARY_2_SPEC>;
///Register `EDMA_BOUNDARY_2` writer
pub type W = crate::W<EDMA_BOUNDARY_2_SPEC>;
///Field `EDMA_BOUNDARY_2` reader - This field is used to configure the boundary 2 of external RAM. The unit is 4K. For example, set this field to 0x80, then the address boundary 0 would be 0x3C080000 (0x3C000000 + 0x80 * 4K).
pub type EDMA_BOUNDARY_2_R = crate::FieldReader<u16>;
///Field `EDMA_BOUNDARY_2` writer - This field is used to configure the boundary 2 of external RAM. The unit is 4K. For example, set this field to 0x80, then the address boundary 0 would be 0x3C080000 (0x3C000000 + 0x80 * 4K).
pub type EDMA_BOUNDARY_2_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    ///Bits 0:13 - This field is used to configure the boundary 2 of external RAM. The unit is 4K. For example, set this field to 0x80, then the address boundary 0 would be 0x3C080000 (0x3C000000 + 0x80 * 4K).
    #[inline(always)]
...
///`read()` method returns [`edma_boundary_2::R`](R) reader structure
impl crate::Readable for EDMA_BOUNDARY_2_SPEC {}
///`write(|w| ..)` method takes [`edma_boundary_2::W`](W) writer structure
