///Register `DMA_APBPERI_I2S1_PMS_CONSTRAIN_1` reader
pub type R = crate::R<DMA_APBPERI_I2S1_PMS_CONSTRAIN_1_SPEC>;
///Register `DMA_APBPERI_I2S1_PMS_CONSTRAIN_1` writer
...
impl R {
    ...
    ///Bits 10:11 - i2s1's permission(store,load) in dcache data sram block1
    #[inline(always)]
...
///`read()` method returns [`dma_apbperi_i2s1_pms_constrain_1::R`](R) reader structure
impl crate::Readable for DMA_APBPERI_I2S1_PMS_CONSTRAIN_1_SPEC {}
///`write(|w| ..)` method takes [`dma_apbperi_i2s1_pms_constrain_1::W`](W) writer structure
