...
pub struct R(crate::R<DMA_APBPERI_PMS_MONITOR_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_APBPERI_PMS_MONITOR_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_APBPERI_PMS_MONITOR_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_APBPERI_PMS_MONITOR_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_APBPERI_PMS_MONITOR_0` writer"]
pub struct W(crate::W<DMA_APBPERI_PMS_MONITOR_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_APBPERI_PMS_MONITOR_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_APBPERI_PMS_MONITOR_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_APBPERI_PMS_MONITOR_0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DMA_APBPERI_PMS_MONITOR_LOCK` reader - Set 1 to lock dma permission monitor Configuration Register."]
pub type DMA_APBPERI_PMS_MONITOR_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `DMA_APBPERI_PMS_MONITOR_LOCK` writer - Set 1 to lock dma permission monitor Configuration Register."]
pub type DMA_APBPERI_PMS_MONITOR_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DMA_APBPERI_PMS_MONITOR_0_SPEC, bool, O>;
impl R {
...
impl W {
    #[doc = "Bit 0 - Set 1 to lock dma permission monitor Configuration Register."]
    #[inline(always)]
    pub fn dma_apbperi_pms_monitor_lock(&mut self) -> DMA_APBPERI_PMS_MONITOR_LOCK_W<0> {
