///Register `DMA_APBPERI_PMS_MONITOR_0` reader
pub type R = crate::R<DMA_APBPERI_PMS_MONITOR_0_SPEC>;
///Register `DMA_APBPERI_PMS_MONITOR_0` writer
pub type W = crate::W<DMA_APBPERI_PMS_MONITOR_0_SPEC>;
///Field `DMA_APBPERI_PMS_MONITOR_LOCK` reader - Set 1 to lock dma permission monitor Configuration Register.
pub type DMA_APBPERI_PMS_MONITOR_LOCK_R = crate::BitReader;
///Field `DMA_APBPERI_PMS_MONITOR_LOCK` writer - Set 1 to lock dma permission monitor Configuration Register.
pub type DMA_APBPERI_PMS_MONITOR_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock dma permission monitor Configuration Register.
    #[inline(always)]
...
///`read()` method returns [`dma_apbperi_pms_monitor_0::R`](R) reader structure
impl crate::Readable for DMA_APBPERI_PMS_MONITOR_0_SPEC {}
///`write(|w| ..)` method takes [`dma_apbperi_pms_monitor_0::W`](W) writer structure
