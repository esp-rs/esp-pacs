///Register `CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1` reader
pub type R = crate::R<CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1_SPEC>;
///Register `CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1` writer
pub type W = crate::W<CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1_SPEC>;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_0` reader - category0 of core_x_iram0_dram_dma_line, if the splitaddress in block0 of SRAM, configured as 0x10, else if the splitaddress below block0 of SRAM, configured as 0x11, else if splitaddress higher than block0 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_0_R = crate::FieldReader;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_0` writer - category0 of core_x_iram0_dram_dma_line, if the splitaddress in block0 of SRAM, configured as 0x10, else if the splitaddress below block0 of SRAM, configured as 0x11, else if splitaddress higher than block0 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_1` reader - category1 of core_x_iram0_dram_dma_line, if the splitaddress in block1 of SRAM, configured as 0x10, else if the splitaddress below block1 of SRAM, configured as 0x11, else if splitaddress higher than block1 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_1_R = crate::FieldReader;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_1` writer - category1 of core_x_iram0_dram_dma_line, if the splitaddress in block1 of SRAM, configured as 0x10, else if the splitaddress below block1 of SRAM, configured as 0x11, else if splitaddress higher than block1 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_2` reader - category2 of core_x_iram0_dram_dma_line, if the splitaddress in block2 of SRAM, configured as 0x10, else if the splitaddress below block2 of SRAM, configured as 0x11, else if splitaddress higher than block2 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_2_R = crate::FieldReader;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_2` writer - category2 of core_x_iram0_dram_dma_line, if the splitaddress in block2 of SRAM, configured as 0x10, else if the splitaddress below block2 of SRAM, configured as 0x11, else if splitaddress higher than block2 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3` reader - category3 of core_x_iram0_dram_dma_line, if the splitaddress in block3 of SRAM, configured as 0x10, else if the splitaddress below block3 of SRAM, configured as 0x11, else if splitaddress higher than block3 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3_R = crate::FieldReader;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3` writer - category3 of core_x_iram0_dram_dma_line, if the splitaddress in block3 of SRAM, configured as 0x10, else if the splitaddress below block3 of SRAM, configured as 0x11, else if splitaddress higher than block3 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4` reader - category4 of core_x_iram0_dram_dma_line, if the splitaddress in block4 of SRAM, configured as 0x10, else if the splitaddress below block4 of SRAM, configured as 0x11, else if splitaddress higher than block4 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4_R = crate::FieldReader;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4` writer - category4 of core_x_iram0_dram_dma_line, if the splitaddress in block4 of SRAM, configured as 0x10, else if the splitaddress below block4 of SRAM, configured as 0x11, else if splitaddress higher than block4 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5` reader - category5 of core_x_iram0_dram_dma_line, if the splitaddress in block5 of SRAM, configured as 0x10, else if the splitaddress below block5 of SRAM, configured as 0x11, else if splitaddress higher than block5 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5_R = crate::FieldReader;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5` writer - category5 of core_x_iram0_dram_dma_line, if the splitaddress in block5 of SRAM, configured as 0x10, else if the splitaddress below block5 of SRAM, configured as 0x11, else if splitaddress higher than block5 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6` reader - category6 of core_x_iram0_dram_dma_line, if the splitaddress in block6 of SRAM, configured as 0x10, else if the splitaddress below block6 of SRAM, configured as 0x11, else if splitaddress higher than block6 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6_R = crate::FieldReader;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6` writer - category6 of core_x_iram0_dram_dma_line, if the splitaddress in block6 of SRAM, configured as 0x10, else if the splitaddress below block6 of SRAM, configured as 0x11, else if splitaddress higher than block6 of SRAM, configured as 0x00
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_SPLITADDR` reader - splitaddr of core_x_iram0_dram_dma_line, configured as \[15:8\]bit of actual address
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_SPLITADDR_R = crate::FieldReader;
///Field `CORE_X_IRAM0_DRAM0_DMA_SRAM_SPLITADDR` writer - splitaddr of core_x_iram0_dram_dma_line, configured as \[15:8\]bit of actual address
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1")
            .field(
                ...
                &self.core_x_iram0_dram0_dma_sram_category_0(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_1",
                &self.core_x_iram0_dram0_dma_sram_category_1(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_2",
                &self.core_x_iram0_dram0_dma_sram_category_2(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_3",
                &self.core_x_iram0_dram0_dma_sram_category_3(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_4",
                &self.core_x_iram0_dram0_dma_sram_category_4(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_5",
                &self.core_x_iram0_dram0_dma_sram_category_5(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_6",
                &self.core_x_iram0_dram0_dma_sram_category_6(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_splitaddr",
                &self.core_x_iram0_dram0_dma_sram_splitaddr(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_x_iram0_dram0_dma_split_line_constrain_1::R`](R) reader structure
impl crate::Readable for CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1_SPEC {}
///`write(|w| ..)` method takes [`core_x_iram0_dram0_dma_split_line_constrain_1::W`](W) writer structure
