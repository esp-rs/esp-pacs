...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_0_R = crate::FieldReader<u8, u8>;
...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1_SPEC, u8, u8, 2, O>;
...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_1_R = crate::FieldReader<u8, u8>;
...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_2_R = crate::FieldReader<u8, u8>;
...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_3_R = crate::FieldReader<u8, u8>;
...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_4_R = crate::FieldReader<u8, u8>;
...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_5_R = crate::FieldReader<u8, u8>;
...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_CATEGORY_6_R = crate::FieldReader<u8, u8>;
...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_SPLITADDR_R = crate::FieldReader<u8, u8>;
...
pub type CORE_X_IRAM0_DRAM0_DMA_SRAM_SPLITADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1_SPEC, u8, u8, 8, O>;
impl R {
