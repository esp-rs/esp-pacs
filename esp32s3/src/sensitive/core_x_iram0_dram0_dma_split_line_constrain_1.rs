    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_X_IRAM0_DRAM0_DMA_SPLIT_LINE_CONSTRAIN_1")
            .field(
                ...
                &self.core_x_iram0_dram0_dma_sram_category_0().bits(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_1",
                &self.core_x_iram0_dram0_dma_sram_category_1().bits(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_2",
                &self.core_x_iram0_dram0_dma_sram_category_2().bits(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_3",
                &self.core_x_iram0_dram0_dma_sram_category_3().bits(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_4",
                &self.core_x_iram0_dram0_dma_sram_category_4().bits(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_5",
                &self.core_x_iram0_dram0_dma_sram_category_5().bits(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_category_6",
                &self.core_x_iram0_dram0_dma_sram_category_6().bits(),
            )
            .field(
                "core_x_iram0_dram0_dma_sram_splitaddr",
                &self.core_x_iram0_dram0_dma_sram_splitaddr().bits(),
            )
            .finish()
    }
}
