...
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_11_R = crate::FieldReader<u32, u32>;
...
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_11_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CORE_0_REGION_PMS_CONSTRAIN_14_SPEC, u32, u32, 30, O>;
impl R {
    ...
    pub fn core_0_region_pms_constrain_addr_11(&self) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_11_R {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_11_R::new((self.bits & 0x3fff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:29 - Region 10 end address for core0."]
