///Register `CORE_0_REGION_PMS_CONSTRAIN_14` reader
pub type R = crate::R<CORE_0_REGION_PMS_CONSTRAIN_14_SPEC>;
///Register `CORE_0_REGION_PMS_CONSTRAIN_14` writer
pub type W = crate::W<CORE_0_REGION_PMS_CONSTRAIN_14_SPEC>;
///Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_11` reader - Region 10 end address for core0.
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_11_R = crate::FieldReader<u32>;
///Field `CORE_0_REGION_PMS_CONSTRAIN_ADDR_11` writer - Region 10 end address for core0.
pub type CORE_0_REGION_PMS_CONSTRAIN_ADDR_11_W<'a, REG> = crate::FieldWriter<'a, REG, 30, u32>;
impl R {
    ///Bits 0:29 - Region 10 end address for core0.
    #[inline(always)]
...
///`read()` method returns [`core_0_region_pms_constrain_14::R`](R) reader structure
impl crate::Readable for CORE_0_REGION_PMS_CONSTRAIN_14_SPEC {}
///`write(|w| ..)` method takes [`core_0_region_pms_constrain_14::W`](W) writer structure
