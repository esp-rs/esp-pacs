...
pub type R = crate::R<DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC>;
#[doc = "Register `DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1` writer"]
pub type W = crate::W<DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC>;
...
pub type DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_PMS_0_W<'a, REG, const O: u8> =
...
pub type DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_PMS_1_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_PMS_2_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_PMS_3_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1")
            .field(
                "dma_apbperi_lcd_cam_pms_constrain_sram_pms_0",
                &format_args!(
                    "{}",
                    self.dma_apbperi_lcd_cam_pms_constrain_sram_pms_0().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_lcd_cam_pms_constrain_sram_pms_1().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_lcd_cam_pms_constrain_sram_pms_2().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_lcd_cam_pms_constrain_sram_pms_3().bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_lcd_cam_pms_constrain_sram_cachedataarray_pms_0()
                        .bits()
                ),
            )
            .field(
                ...
                &format_args!(
                    "{}",
                    self.dma_apbperi_lcd_cam_pms_constrain_sram_cachedataarray_pms_1()
                        .bits()
                ),
            )
            .finish()
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC> {
...
impl W {
    ...
    pub fn dma_apbperi_lcd_cam_pms_constrain_sram_pms_0(
        &mut self,
    ) -> DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_PMS_0_W<DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC, 0>
    {
    ...
    pub fn dma_apbperi_lcd_cam_pms_constrain_sram_pms_1(
        &mut self,
    ) -> DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_PMS_1_W<DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC, 2>
    {
    ...
    pub fn dma_apbperi_lcd_cam_pms_constrain_sram_pms_2(
        &mut self,
    ) -> DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_PMS_2_W<DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC, 4>
    {
    ...
    pub fn dma_apbperi_lcd_cam_pms_constrain_sram_pms_3(
        &mut self,
    ) -> DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_PMS_3_W<DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC, 6>
    {
    ...
    pub fn dma_apbperi_lcd_cam_pms_constrain_sram_cachedataarray_pms_0(
        &mut self,
    ) -> DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W<
    ...
    pub fn dma_apbperi_lcd_cam_pms_constrain_sram_cachedataarray_pms_1(
        &mut self,
    ) -> DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W<
        DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC,
        10,
    > {
