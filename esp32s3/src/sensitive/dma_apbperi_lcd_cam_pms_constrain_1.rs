///Register `DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1` reader
pub type R = crate::R<DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC>;
///Register `DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1` writer
...
impl R {
    ...
    ///Bits 10:11 - lcd_cam's permission(store,load) in dcache data sram block1
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1")
            .field(
                ...
                &self.dma_apbperi_lcd_cam_pms_constrain_sram_pms_0(),
            )
            .field(
                "dma_apbperi_lcd_cam_pms_constrain_sram_pms_1",
                &self.dma_apbperi_lcd_cam_pms_constrain_sram_pms_1(),
            )
            .field(
                "dma_apbperi_lcd_cam_pms_constrain_sram_pms_2",
                &self.dma_apbperi_lcd_cam_pms_constrain_sram_pms_2(),
            )
            .field(
                "dma_apbperi_lcd_cam_pms_constrain_sram_pms_3",
                &self.dma_apbperi_lcd_cam_pms_constrain_sram_pms_3(),
            )
            .field(
...
impl W {
    ...
    > {
        DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W::new(self, 8)
    }
    ///Bits 10:11 - lcd_cam's permission(store,load) in dcache data sram block1
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_lcd_cam_pms_constrain_sram_cachedataarray_pms_1(
        ...
        DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC,
    > {
        DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W::new(self, 10)
    }
}
...
///`read()` method returns [`dma_apbperi_lcd_cam_pms_constrain_1::R`](R) reader structure
impl crate::Readable for DMA_APBPERI_LCD_CAM_PMS_CONSTRAIN_1_SPEC {}
///`write(|w| ..)` method takes [`dma_apbperi_lcd_cam_pms_constrain_1::W`](W) writer structure
