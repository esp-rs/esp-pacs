///Register `CORE_1_REGION_PMS_CONSTRAIN_0` reader
pub type R = crate::R<CORE_1_REGION_PMS_CONSTRAIN_0_SPEC>;
///Register `CORE_1_REGION_PMS_CONSTRAIN_0` writer
pub type W = crate::W<CORE_1_REGION_PMS_CONSTRAIN_0_SPEC>;
///Field `CORE_1_REGION_PMS_CONSTRAIN_LOCK` reader - Set 1 to lock core1 region permission registers.
pub type CORE_1_REGION_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
///Field `CORE_1_REGION_PMS_CONSTRAIN_LOCK` writer - Set 1 to lock core1 region permission registers.
pub type CORE_1_REGION_PMS_CONSTRAIN_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock core1 region permission registers.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_1_region_pms_constrain_0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_1_region_pms_constrain_0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_1_REGION_PMS_CONSTRAIN_0_SPEC;
impl crate::RegisterSpec for CORE_1_REGION_PMS_CONSTRAIN_0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_1_region_pms_constrain_0::R`](R) reader structure
impl crate::Readable for CORE_1_REGION_PMS_CONSTRAIN_0_SPEC {}
///`write(|w| ..)` method takes [`core_1_region_pms_constrain_0::W`](W) writer structure
