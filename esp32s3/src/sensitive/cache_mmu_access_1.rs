...
///Field `PRO_MMU_RD_ACS` reader - Set 1 to enable read access MMU memory.
pub type PRO_MMU_RD_ACS_R = crate::BitReader;
///Field `PRO_MMU_RD_ACS` writer - Set 1 to enable read access MMU memory.
pub type PRO_MMU_RD_ACS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PRO_MMU_WR_ACS` reader - Set 1 to enable write access MMU memory.
pub type PRO_MMU_WR_ACS_R = crate::BitReader;
///Field `PRO_MMU_WR_ACS` writer - Set 1 to enable write access MMU memory.
