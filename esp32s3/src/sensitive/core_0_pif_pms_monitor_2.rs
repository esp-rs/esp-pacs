...
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR` reader - Record core0 illegal access interrupt state.
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HPORT_0` reader - Record hport information when core0 initiate illegal access.
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HPORT_0_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HSIZE` reader - Record access type when core0 initate illegal access.
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HSIZE_R = crate::FieldReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HWRITE` reader - Record access direction when core0 initiate illegal access.
pub type CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HWRITE_R = crate::BitReader;
///Field `CORE_0_PIF_PMS_MONITOR_VIOLATE_STATUS_HWORLD` reader - Record world information when core0 initiate illegal access.
