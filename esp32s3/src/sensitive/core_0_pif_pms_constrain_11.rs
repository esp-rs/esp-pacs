///Register `CORE_0_PIF_PMS_CONSTRAIN_11` reader
pub type R = crate::R<CORE_0_PIF_PMS_CONSTRAIN_11_SPEC>;
///Register `CORE_0_PIF_PMS_CONSTRAIN_11` writer
pub type W = crate::W<CORE_0_PIF_PMS_CONSTRAIN_11_SPEC>;
///Field `CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0` reader - RTCSlow_0 memory split address in world 0 for core0.
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0_R = crate::FieldReader<u16>;
///Field `CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0` writer - RTCSlow_0 memory split address in world 0 for core0.
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0_W<'a, REG> =
    crate::FieldWriter<'a, REG, 11, u16>;
///Field `CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1` reader - RTCSlow_0 memory split address in world 1 for core0.
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1_R = crate::FieldReader<u16>;
///Field `CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1` writer - RTCSlow_0 memory split address in world 1 for core0.
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1_W<'a, REG> =
    crate::FieldWriter<'a, REG, 11, u16>;
impl R {
    ///Bits 0:10 - RTCSlow_0 memory split address in world 0 for core0.
    #[inline(always)]
    ...
    ///Bits 11:21 - RTCSlow_0 memory split address in world 1 for core0.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_0_pif_pms_constrain_11::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_0_pif_pms_constrain_11::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_PIF_PMS_CONSTRAIN_11_SPEC;
impl crate::RegisterSpec for CORE_0_PIF_PMS_CONSTRAIN_11_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_0_pif_pms_constrain_11::R`](R) reader structure
impl crate::Readable for CORE_0_PIF_PMS_CONSTRAIN_11_SPEC {}
///`write(|w| ..)` method takes [`core_0_pif_pms_constrain_11::W`](W) writer structure
