    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_PIF_PMS_CONSTRAIN_7")
            .field(
                ...
                &self.core_1_pif_pms_constrain_world_1_spi_2().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_spi_3",
                &self.core_1_pif_pms_constrain_world_1_spi_3().bits(),
            )
            .field(
            ...
            .field(
                ...
                &self.core_1_pif_pms_constrain_world_1_can().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_pwm1",
                &self.core_1_pif_pms_constrain_world_1_pwm1().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_i2s1",
                &self.core_1_pif_pms_constrain_world_1_i2s1().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_uart2",
                &self.core_1_pif_pms_constrain_world_1_uart2().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_rwbt",
                &self.core_1_pif_pms_constrain_world_1_rwbt().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_wifimac",
                &self.core_1_pif_pms_constrain_world_1_wifimac().bits(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_pwr",
                &self.core_1_pif_pms_constrain_world_1_pwr().bits(),
            )
            .finish()
    }
}
