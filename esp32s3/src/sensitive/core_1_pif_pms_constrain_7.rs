...
impl W {
    ...
    pub fn core_1_pif_pms_constrain_world_1_spi_2(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SPI_2_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SPI_2_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Core1 access spi_3 permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_spi_3(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SPI_3_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SPI_3_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Core1 access apb_ctrl permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_apb_ctrl(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_APB_CTRL_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_APB_CTRL_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Core1 access i2c_ext1 permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_i2c_ext1(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_I2C_EXT1_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_I2C_EXT1_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Core1 access sdio_host permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_sdio_host(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SDIO_HOST_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_SDIO_HOST_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Core1 access can permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_can(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_CAN_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_CAN_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Core1 access pwm1 permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_pwm1(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_PWM1_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_PWM1_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Core1 access i2s1 permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_i2s1(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_I2S1_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_I2S1_W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Core1 access uart2 permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_uart2(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_UART2_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_UART2_W::new(self, 16)
    }
    #[doc = "Bits 22:23 - Core1 access rwbt permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_rwbt(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_RWBT_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_RWBT_W::new(self, 22)
    }
    #[doc = "Bits 26:27 - Core1 access wifimac permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_wifimac(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_WIFIMAC_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_WIFIMAC_W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Core1 access pwr permission in world1."]
    #[inline(always)]
    #[must_use]
    pub fn core_1_pif_pms_constrain_world_1_pwr(
        &mut self,
    ) -> CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_PWR_W<CORE_1_PIF_PMS_CONSTRAIN_7_SPEC> {
        CORE_1_PIF_PMS_CONSTRAIN_WORLD_1_PWR_W::new(self, 28)
    }
