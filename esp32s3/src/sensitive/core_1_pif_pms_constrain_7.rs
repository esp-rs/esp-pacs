///Register `CORE_1_PIF_PMS_CONSTRAIN_7` reader
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_PIF_PMS_CONSTRAIN_7")
            .field(
                ...
                &self.core_1_pif_pms_constrain_world_1_spi_2(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_spi_3",
                &self.core_1_pif_pms_constrain_world_1_spi_3(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_apb_ctrl",
                &self.core_1_pif_pms_constrain_world_1_apb_ctrl(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_i2c_ext1",
                &self.core_1_pif_pms_constrain_world_1_i2c_ext1(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_sdio_host",
                &self.core_1_pif_pms_constrain_world_1_sdio_host(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_can",
                &self.core_1_pif_pms_constrain_world_1_can(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_pwm1",
                &self.core_1_pif_pms_constrain_world_1_pwm1(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_i2s1",
                &self.core_1_pif_pms_constrain_world_1_i2s1(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_uart2",
                &self.core_1_pif_pms_constrain_world_1_uart2(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_rwbt",
                &self.core_1_pif_pms_constrain_world_1_rwbt(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_wifimac",
                &self.core_1_pif_pms_constrain_world_1_wifimac(),
            )
            .field(
                "core_1_pif_pms_constrain_world_1_pwr",
                &self.core_1_pif_pms_constrain_world_1_pwr(),
            )
            .finish()
    }
}
...
///`read()` method returns [`core_1_pif_pms_constrain_7::R`](R) reader structure
impl crate::Readable for CORE_1_PIF_PMS_CONSTRAIN_7_SPEC {}
///`write(|w| ..)` method takes [`core_1_pif_pms_constrain_7::W`](W) writer structure
