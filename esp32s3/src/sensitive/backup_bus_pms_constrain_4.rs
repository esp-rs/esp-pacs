...
pub type BACKUP_BUS_PMS_CONSTRAIN_USB_DEVICE_W<'a, REG, const O: u8> =
...
pub type BACKUP_BUS_PMS_CONSTRAIN_USB_WRAP_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_CRYPTO_PERI_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_CRYPTO_DMA_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_APB_ADC_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_LCD_CAM_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_BT_PWR_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_USB_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_SYSTEM_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_SENSITIVE_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_INTERRUPT_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_DMA_COPY_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_CACHE_CONFIG_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_AD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_DIO_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_WORLD_CONTROLLER_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    pub fn backup_bus_pms_constrain_usb_device(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_USB_DEVICE_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 0> {
    ...
    pub fn backup_bus_pms_constrain_usb_wrap(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_USB_WRAP_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 2> {
    ...
    pub fn backup_bus_pms_constrain_crypto_peri(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_CRYPTO_PERI_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 4> {
    ...
    pub fn backup_bus_pms_constrain_crypto_dma(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_CRYPTO_DMA_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 6> {
    ...
    pub fn backup_bus_pms_constrain_apb_adc(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_APB_ADC_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 8> {
    ...
    pub fn backup_bus_pms_constrain_lcd_cam(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_LCD_CAM_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 10> {
    ...
    pub fn backup_bus_pms_constrain_bt_pwr(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_BT_PWR_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 12> {
    ...
    pub fn backup_bus_pms_constrain_usb(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_USB_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 14> {
    ...
    pub fn backup_bus_pms_constrain_system(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_SYSTEM_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 16> {
    ...
    pub fn backup_bus_pms_constrain_sensitive(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_SENSITIVE_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 18> {
    ...
    pub fn backup_bus_pms_constrain_interrupt(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_INTERRUPT_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 20> {
    ...
    pub fn backup_bus_pms_constrain_dma_copy(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_DMA_COPY_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 22> {
    ...
    pub fn backup_bus_pms_constrain_cache_config(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_CACHE_CONFIG_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 24> {
    ...
    pub fn backup_bus_pms_constrain_ad(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_AD_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 26> {
    ...
    pub fn backup_bus_pms_constrain_dio(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_DIO_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 28> {
    ...
    pub fn backup_bus_pms_constrain_world_controller(
        &mut self,
    ) -> BACKUP_BUS_PMS_CONSTRAIN_WORLD_CONTROLLER_W<BACKUP_BUS_PMS_CONSTRAIN_4_SPEC, 30> {
