///Register `BACKUP_BUS_PMS_CONSTRAIN_4` reader
...
///Field `BACKUP_BUS_PMS_CONSTRAIN_USB_DEVICE` reader - BackUp access usb_device permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_USB_DEVICE_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_USB_DEVICE` writer - BackUp access usb_device permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_USB_DEVICE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_USB_WRAP` reader - BackUp access usb_wrap permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_USB_WRAP_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_USB_WRAP` writer - BackUp access usb_wrap permission.
...
///Field `BACKUP_BUS_PMS_CONSTRAIN_APB_ADC` reader - BackUp access apb_adc permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_APB_ADC_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_APB_ADC` writer - BackUp access apb_adc permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_APB_ADC_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_LCD_CAM` reader - BackUp access lcd_cam permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_LCD_CAM_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_LCD_CAM` writer - BackUp access lcd_cam permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_LCD_CAM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_BT_PWR` reader - BackUp access bt_pwr permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_BT_PWR_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_BT_PWR` writer - BackUp access bt_pwr permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_BT_PWR_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_USB` reader - BackUp access usb permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_USB_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_USB` writer - BackUp access usb permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_USB_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SYSTEM` reader - BackUp access system permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SYSTEM_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SYSTEM` writer - BackUp access system permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SYSTEM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SENSITIVE` reader - BackUp access sensitive permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SENSITIVE_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SENSITIVE` writer - BackUp access sensitive permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SENSITIVE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_INTERRUPT` reader - BackUp access interrupt permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_INTERRUPT_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_INTERRUPT` writer - BackUp access interrupt permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_INTERRUPT_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_DMA_COPY` reader - BackUp access dma_copy permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_DMA_COPY_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_DMA_COPY` writer - BackUp access dma_copy permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_DMA_COPY_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type BACKUP_BUS_PMS_CONSTRAIN_AD_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_DIO` reader - BackUp access dio permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_DIO_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_DIO` writer - BackUp access dio permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_DIO_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl W {
    ...
    pub fn backup_bus_pms_constrain_usb_device(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_USB_DEVICE_W::new(self, 0)
    }
    ///Bits 2:3 - BackUp access usb_wrap permission.
    #[inline(always)]
    #[must_use]
    ...
    pub fn backup_bus_pms_constrain_lcd_cam(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_LCD_CAM_W::new(self, 10)
    }
    ///Bits 12:13 - BackUp access bt_pwr permission.
    #[inline(always)]
    #[must_use]
    ...
    pub fn backup_bus_pms_constrain_usb(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_USB_W::new(self, 14)
    }
    ///Bits 16:17 - BackUp access system permission.
    #[inline(always)]
    #[must_use]
    pub fn backup_bus_pms_constrain_system(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_SYSTEM_W::new(self, 16)
    }
    ///Bits 18:19 - BackUp access sensitive permission.
    #[inline(always)]
    #[must_use]
    pub fn backup_bus_pms_constrain_sensitive(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_SENSITIVE_W::new(self, 18)
    }
    ///Bits 20:21 - BackUp access interrupt permission.
    #[inline(always)]
    #[must_use]
    pub fn backup_bus_pms_constrain_interrupt(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_INTERRUPT_W::new(self, 20)
    }
    ///Bits 22:23 - BackUp access dma_copy permission.
    #[inline(always)]
    #[must_use]
    pub fn backup_bus_pms_constrain_dma_copy(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_DMA_COPY_W::new(self, 22)
    }
    ///Bits 24:25 - BackUp access cache_config permission.
    #[inline(always)]
    #[must_use]
    pub fn backup_bus_pms_constrain_cache_config(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_CACHE_CONFIG_W::new(self, 24)
    }
    ///Bits 26:27 - BackUp access ad permission.
    #[inline(always)]
    #[must_use]
    pub fn backup_bus_pms_constrain_ad(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_AD_W::new(self, 26)
    }
    ///Bits 28:29 - BackUp access dio permission.
    #[inline(always)]
    #[must_use]
    pub fn backup_bus_pms_constrain_dio(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_DIO_W::new(self, 28)
    }
    ///Bits 30:31 - BackUp access world_controller permission.
    #[inline(always)]
    #[must_use]
    pub fn backup_bus_pms_constrain_world_controller(
        ...
        BACKUP_BUS_PMS_CONSTRAIN_WORLD_CONTROLLER_W::new(self, 30)
    }
}
...
///`read()` method returns [`backup_bus_pms_constrain_4::R`](R) reader structure
impl crate::Readable for BACKUP_BUS_PMS_CONSTRAIN_4_SPEC {}
///`write(|w| ..)` method takes [`backup_bus_pms_constrain_4::W`](W) writer structure
