    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_PIF_PMS_CONSTRAIN_4")
            ...
            .field(
                ...
                &self.core_0_pif_pms_constrain_world_0_apb_adc().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_lcd_cam",
                &self.core_0_pif_pms_constrain_world_0_lcd_cam().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_bt_pwr",
                &self.core_0_pif_pms_constrain_world_0_bt_pwr().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_usb",
                &self.core_0_pif_pms_constrain_world_0_usb().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_system",
                &self.core_0_pif_pms_constrain_world_0_system().bits(),
            )
            .field(
            ...
            .field(
                ...
                &self.core_0_pif_pms_constrain_world_0_ad().bits(),
            )
            .field(
                "core_0_pif_pms_constrain_world_0_dio",
                &self.core_0_pif_pms_constrain_world_0_dio().bits(),
            )
            .field(
...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_world_0_usb_device(
        ...
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_USB_DEVICE_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Core0 access usb_wrap permission in world0."]
    #[inline(always)]
    #[must_use]
    ...
    pub fn core_0_pif_pms_constrain_world_0_lcd_cam(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_LCD_CAM_W<CORE_0_PIF_PMS_CONSTRAIN_4_SPEC> {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_LCD_CAM_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Core0 access bt_pwr permission in world0."]
    #[inline(always)]
    #[must_use]
    ...
    pub fn core_0_pif_pms_constrain_world_0_usb(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_USB_W<CORE_0_PIF_PMS_CONSTRAIN_4_SPEC> {
        CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_USB_W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Core0 access system permission in world0."]
    #[inline(always)]
    #[must_use]
