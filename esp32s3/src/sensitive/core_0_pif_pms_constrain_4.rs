...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_world_0_lcd_cam(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_LCD_CAM_W<'_, CORE_0_PIF_PMS_CONSTRAIN_4_SPEC> {
    ...
    pub fn core_0_pif_pms_constrain_world_0_usb(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_USB_W<'_, CORE_0_PIF_PMS_CONSTRAIN_4_SPEC> {
...
#[doc = "Core0 access peripherals permission configuration register 4.\n\nYou can [`read`](crate::Reg::read) this register and get [`core_0_pif_pms_constrain_4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_0_pif_pms_constrain_4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
