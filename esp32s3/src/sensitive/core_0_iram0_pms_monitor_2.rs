...
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR` reader - recorded core0 iram0 pms monitor interrupt status.
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_R = crate::BitReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WR` reader - recorded core0 iram0 wr status, only if loadstore is 1 have meaning, 1(store), 0(load).
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WR_R = crate::BitReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_LOADSTORE` reader - recorded core0 iram0 loadstore status, indicated the type of operation, 0(fetch), 1(load/store).
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_LOADSTORE_R = crate::BitReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD` reader - recorded core0 iram0 world status, 0x01 means world0, 0x10 means world1.
pub type CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD_R = crate::FieldReader;
///Field `CORE_0_IRAM0_PMS_MONITOR_VIOLATE_STATUS_ADDR` reader - recorded core0 iram0 address \[25:2\] status when core0 iram0 violated permission, the real address is 0x40000000+addr*4
