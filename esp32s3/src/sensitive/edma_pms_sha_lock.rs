...
impl W {
    #[doc = "Bit 0 - Set 1 to lock EDMA-SHA permission control registers."]
    #[inline(always)]
    pub fn edma_pms_sha_lock(&mut self) -> EDMA_PMS_SHA_LOCK_W<'_, EDMA_PMS_SHA_LOCK_SPEC> {
        EDMA_PMS_SHA_LOCK_W::new(self, 0)
    }
}
#[doc = "EDMA-SHA permission lock register.\n\nYou can [`read`](crate::Reg::read) this register and get [`edma_pms_sha_lock::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`edma_pms_sha_lock::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
