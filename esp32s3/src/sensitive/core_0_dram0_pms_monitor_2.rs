///Register `CORE_0_DRAM0_PMS_MONITOR_2` reader
pub type R = crate::R<CORE_0_DRAM0_PMS_MONITOR_2_SPEC>;
///Field `CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR` reader - recorded core0 dram0 permission monitor interrupt status.
pub type CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_R = crate::BitReader;
///Field `CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_LOCK` reader - recorded core0 dram0 lock status, 1 means s32c1i access.
pub type CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_LOCK_R = crate::BitReader;
///Field `CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD` reader - recorded core0 dram0 world status, 0x1 means world0, 0x2 means world1.
pub type CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD_R = crate::FieldReader;
///Field `CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_ADDR` reader - recorded core0 dram0 address\[25:4\] status when core0 dram0 violated permission,the real address is 0x3c000000+addr*16
pub type CORE_0_DRAM0_PMS_MONITOR_VIOLATE_STATUS_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bit 0 - recorded core0 dram0 permission monitor interrupt status.
    #[inline(always)]
    ...
    ///Bit 1 - recorded core0 dram0 lock status, 1 means s32c1i access.
    #[inline(always)]
    ...
    ///Bits 2:3 - recorded core0 dram0 world status, 0x1 means world0, 0x2 means world1.
    #[inline(always)]
    ...
    ///Bits 4:25 - recorded core0 dram0 address\[25:4\] status when core0 dram0 violated permission,the real address is 0x3c000000+addr*16
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_0_dram0_pms_monitor_2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_0_DRAM0_PMS_MONITOR_2_SPEC;
impl crate::RegisterSpec for CORE_0_DRAM0_PMS_MONITOR_2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_0_dram0_pms_monitor_2::R`](R) reader structure
