///Register `CORE_1_PIF_PMS_MONITOR_3` reader
pub type R = crate::R<CORE_1_PIF_PMS_MONITOR_3_SPEC>;
///Field `CORE_1_PIF_PMS_MONITOR_VIOLATE_STATUS_HADDR` reader - Record address information when core1 initiate illegal access.
pub type CORE_1_PIF_PMS_MONITOR_VIOLATE_STATUS_HADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Record address information when core1 initiate illegal access.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`core_1_pif_pms_monitor_3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CORE_1_PIF_PMS_MONITOR_3_SPEC;
impl crate::RegisterSpec for CORE_1_PIF_PMS_MONITOR_3_SPEC {
    type Ux = u32;
}
///`read()` method returns [`core_1_pif_pms_monitor_3::R`](R) reader structure
