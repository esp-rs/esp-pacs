...
impl R {
    ...
    ///Bits 2:3 - lc's permission(store,load) in data region1 of SRAM
    #[inline(always)]
    ...
    ///Bits 4:5 - lc's permission(store,load) in data region2 of SRAM
    #[inline(always)]
    ...
    ///Bits 6:7 - lc's permission(store,load) in data region3 of SRAM
    #[inline(always)]
    ...
    ///Bits 8:9 - lc's permission(store,load) in dcache data sram block0
    #[inline(always)]
