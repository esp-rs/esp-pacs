    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_APBPERI_LC_PMS_CONSTRAIN_1")
            .field(
                ...
                &self.dma_apbperi_lc_pms_constrain_sram_pms_0().bits(),
            )
            .field(
                "dma_apbperi_lc_pms_constrain_sram_pms_1",
                &self.dma_apbperi_lc_pms_constrain_sram_pms_1().bits(),
            )
            .field(
                "dma_apbperi_lc_pms_constrain_sram_pms_2",
                &self.dma_apbperi_lc_pms_constrain_sram_pms_2().bits(),
            )
            .field(
                "dma_apbperi_lc_pms_constrain_sram_pms_3",
                &self.dma_apbperi_lc_pms_constrain_sram_pms_3().bits(),
            )
            .field(
...
impl W {
    ...
    pub fn dma_apbperi_lc_pms_constrain_sram_pms_0(
        ...
        DMA_APBPERI_LC_PMS_CONSTRAIN_SRAM_PMS_0_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - lc's permission(store,load) in data region1 of SRAM"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_lc_pms_constrain_sram_pms_1(
        ...
        DMA_APBPERI_LC_PMS_CONSTRAIN_SRAM_PMS_1_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - lc's permission(store,load) in data region2 of SRAM"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_lc_pms_constrain_sram_pms_2(
        ...
        DMA_APBPERI_LC_PMS_CONSTRAIN_SRAM_PMS_2_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - lc's permission(store,load) in data region3 of SRAM"]
    #[inline(always)]
    #[must_use]
    pub fn dma_apbperi_lc_pms_constrain_sram_pms_3(
        ...
        DMA_APBPERI_LC_PMS_CONSTRAIN_SRAM_PMS_3_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - lc's permission(store,load) in dcache data sram block0"]
    #[inline(always)]
    #[must_use]
