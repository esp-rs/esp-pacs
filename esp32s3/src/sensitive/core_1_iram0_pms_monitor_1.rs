...
pub struct R(crate::R<CORE_1_IRAM0_PMS_MONITOR_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_IRAM0_PMS_MONITOR_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_IRAM0_PMS_MONITOR_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_IRAM0_PMS_MONITOR_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_1_IRAM0_PMS_MONITOR_1` writer"]
pub struct W(crate::W<CORE_1_IRAM0_PMS_MONITOR_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_IRAM0_PMS_MONITOR_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_IRAM0_PMS_MONITOR_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_IRAM0_PMS_MONITOR_1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CORE_1_IRAM0_PMS_MONITOR_VIOLATE_CLR` reader - Set 1 to clear core1 iram0 permission violated interrupt"]
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_CLR_R = crate::BitReader<bool>;
#[doc = "Field `CORE_1_IRAM0_PMS_MONITOR_VIOLATE_CLR` writer - Set 1 to clear core1 iram0 permission violated interrupt"]
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE_1_IRAM0_PMS_MONITOR_1_SPEC, bool, O>;
...
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_EN_R = crate::BitReader<bool>;
...
pub type CORE_1_IRAM0_PMS_MONITOR_VIOLATE_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CORE_1_IRAM0_PMS_MONITOR_1_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    pub fn core_1_iram0_pms_monitor_violate_clr(
        &mut self,
    ) -> CORE_1_IRAM0_PMS_MONITOR_VIOLATE_CLR_W<0> {
    ...
    pub fn core_1_iram0_pms_monitor_violate_en(
        &mut self,
    ) -> CORE_1_IRAM0_PMS_MONITOR_VIOLATE_EN_W<1> {
