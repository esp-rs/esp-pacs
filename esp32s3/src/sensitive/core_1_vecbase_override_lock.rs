///Register `CORE_1_VECBASE_OVERRIDE_LOCK` reader
pub type R = crate::R<CORE_1_VECBASE_OVERRIDE_LOCK_SPEC>;
///Register `CORE_1_VECBASE_OVERRIDE_LOCK` writer
pub type W = crate::W<CORE_1_VECBASE_OVERRIDE_LOCK_SPEC>;
///Field `CORE_1_VECBASE_OVERRIDE_LOCK` reader - Set 1 to lock core1 vecbase configuration register
pub type CORE_1_VECBASE_OVERRIDE_LOCK_R = crate::BitReader;
///Field `CORE_1_VECBASE_OVERRIDE_LOCK` writer - Set 1 to lock core1 vecbase configuration register
pub type CORE_1_VECBASE_OVERRIDE_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock core1 vecbase configuration register
    #[inline(always)]
...
///`read()` method returns [`core_1_vecbase_override_lock::R`](R) reader structure
impl crate::Readable for CORE_1_VECBASE_OVERRIDE_LOCK_SPEC {}
///`write(|w| ..)` method takes [`core_1_vecbase_override_lock::W`](W) writer structure
