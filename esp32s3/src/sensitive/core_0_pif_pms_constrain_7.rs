...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_world_1_spi_3(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_SPI_3_W<'_, CORE_0_PIF_PMS_CONSTRAIN_7_SPEC> {
    ...
    pub fn core_0_pif_pms_constrain_world_1_i2c_ext1(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_I2C_EXT1_W<'_, CORE_0_PIF_PMS_CONSTRAIN_7_SPEC> {
    ...
    pub fn core_0_pif_pms_constrain_world_1_sdio_host(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_SDIO_HOST_W<'_, CORE_0_PIF_PMS_CONSTRAIN_7_SPEC> {
    ...
    pub fn core_0_pif_pms_constrain_world_1_pwm1(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_PWM1_W<'_, CORE_0_PIF_PMS_CONSTRAIN_7_SPEC> {
    ...
    pub fn core_0_pif_pms_constrain_world_1_uart2(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_1_UART2_W<'_, CORE_0_PIF_PMS_CONSTRAIN_7_SPEC> {
