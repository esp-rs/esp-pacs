...
pub struct R(crate::R<DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0` writer"]
pub struct W(crate::W<DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_LOCK` reader - Set 1 to lock adc_dac dma permission Configuration Register."]
pub type DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_LOCK_R = crate::BitReader;
#[doc = "Field `DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_LOCK` writer - Set 1 to lock adc_dac dma permission Configuration Register."]
...
impl R {
    #[doc = "Bit 0 - Set 1 to lock adc_dac dma permission Configuration Register."]
    #[inline(always)]
...
impl W {
    ...
    pub fn dma_apbperi_adc_dac_pms_constrain_lock(
        ...
        DMA_APBPERI_ADC_DAC_PMS_CONSTRAIN_LOCK_W::new(self)
    }
