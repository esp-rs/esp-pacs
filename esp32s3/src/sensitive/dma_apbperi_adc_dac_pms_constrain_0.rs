...
#[doc = "adc_dac dma permission configuration register 0.\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_apbperi_adc_dac_pms_constrain_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_apbperi_adc_dac_pms_constrain_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
