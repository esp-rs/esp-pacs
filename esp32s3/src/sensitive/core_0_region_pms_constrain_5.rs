...
impl W {
    ...
    pub fn core_0_region_pms_constrain_addr_2(
        &mut self,
    ) -> CORE_0_REGION_PMS_CONSTRAIN_ADDR_2_W<'_, CORE_0_REGION_PMS_CONSTRAIN_5_SPEC> {
        CORE_0_REGION_PMS_CONSTRAIN_ADDR_2_W::new(self, 0)
    }
}
#[doc = "Core0 region permission register 5.\n\nYou can [`read`](crate::Reg::read) this register and get [`core_0_region_pms_constrain_5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_0_region_pms_constrain_5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
