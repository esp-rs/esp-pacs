///Register `BACKUP_BUS_PMS_CONSTRAIN_6` reader
pub type R = crate::R<BACKUP_BUS_PMS_CONSTRAIN_6_SPEC>;
///Register `BACKUP_BUS_PMS_CONSTRAIN_6` writer
pub type W = crate::W<BACKUP_BUS_PMS_CONSTRAIN_6_SPEC>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_RTCFAST_L` reader - BackUp access rtcfast_l permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_RTCFAST_L_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_RTCFAST_L` writer - BackUp access rtcfast_l permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_RTCFAST_L_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_RTCFAST_H` reader - BackUp access rtcfast_h permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_RTCFAST_H_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_RTCFAST_H` writer - BackUp access rtcfast_h permission.
...
///`read()` method returns [`backup_bus_pms_constrain_6::R`](R) reader structure
impl crate::Readable for BACKUP_BUS_PMS_CONSTRAIN_6_SPEC {}
///`write(|w| ..)` method takes [`backup_bus_pms_constrain_6::W`](W) writer structure
