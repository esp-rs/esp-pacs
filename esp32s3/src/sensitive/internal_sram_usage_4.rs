///Register `INTERNAL_SRAM_USAGE_4` reader
pub type R = crate::R<INTERNAL_SRAM_USAGE_4_SPEC>;
///Register `INTERNAL_SRAM_USAGE_4` writer
pub type W = crate::W<INTERNAL_SRAM_USAGE_4_SPEC>;
///Field `INTERNAL_SRAM_LOG_USAGE` reader - Set 1 to someone bit means corresponding internal SRAM level can be accessed by log bus.
pub type INTERNAL_SRAM_LOG_USAGE_R = crate::FieldReader;
///Field `INTERNAL_SRAM_LOG_USAGE` writer - Set 1 to someone bit means corresponding internal SRAM level can be accessed by log bus.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INTERNAL_SRAM_USAGE_4")
            .field("internal_sram_log_usage", &self.internal_sram_log_usage())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`internal_sram_usage_4::R`](R) reader structure
impl crate::Readable for INTERNAL_SRAM_USAGE_4_SPEC {}
///`write(|w| ..)` method takes [`internal_sram_usage_4::W`](W) writer structure
