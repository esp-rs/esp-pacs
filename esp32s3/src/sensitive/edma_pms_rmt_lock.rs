///Register `EDMA_PMS_RMT_LOCK` reader
pub type R = crate::R<EDMA_PMS_RMT_LOCK_SPEC>;
///Register `EDMA_PMS_RMT_LOCK` writer
pub type W = crate::W<EDMA_PMS_RMT_LOCK_SPEC>;
///Field `EDMA_PMS_RMT_LOCK` reader - Set 1 to lock EDMA-RMT permission control registers.
pub type EDMA_PMS_RMT_LOCK_R = crate::BitReader;
///Field `EDMA_PMS_RMT_LOCK` writer - Set 1 to lock EDMA-RMT permission control registers.
pub type EDMA_PMS_RMT_LOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to lock EDMA-RMT permission control registers.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EDMA_PMS_RMT_LOCK")
            .field("edma_pms_rmt_lock", &self.edma_pms_rmt_lock())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn edma_pms_rmt_lock(&mut self) -> EDMA_PMS_RMT_LOCK_W<EDMA_PMS_RMT_LOCK_SPEC> {
        EDMA_PMS_RMT_LOCK_W::new(self, 0)
    }
}
...
///`read()` method returns [`edma_pms_rmt_lock::R`](R) reader structure
impl crate::Readable for EDMA_PMS_RMT_LOCK_SPEC {}
///`write(|w| ..)` method takes [`edma_pms_rmt_lock::W`](W) writer structure
