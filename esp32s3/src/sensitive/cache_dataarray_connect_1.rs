///Register `CACHE_DATAARRAY_CONNECT_1` reader
pub type R = crate::R<CACHE_DATAARRAY_CONNECT_1_SPEC>;
///Register `CACHE_DATAARRAY_CONNECT_1` writer
pub type W = crate::W<CACHE_DATAARRAY_CONNECT_1_SPEC>;
///Field `CACHE_DATAARRAY_CONNECT_FLATTEN` reader - Cache data array connection configuration.
pub type CACHE_DATAARRAY_CONNECT_FLATTEN_R = crate::FieldReader;
///Field `CACHE_DATAARRAY_CONNECT_FLATTEN` writer - Cache data array connection configuration.
...
///`read()` method returns [`cache_dataarray_connect_1::R`](R) reader structure
impl crate::Readable for CACHE_DATAARRAY_CONNECT_1_SPEC {}
///`write(|w| ..)` method takes [`cache_dataarray_connect_1::W`](W) writer structure
