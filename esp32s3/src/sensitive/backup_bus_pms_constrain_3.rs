///Register `BACKUP_BUS_PMS_CONSTRAIN_3` reader
pub type R = crate::R<BACKUP_BUS_PMS_CONSTRAIN_3_SPEC>;
///Register `BACKUP_BUS_PMS_CONSTRAIN_3` writer
pub type W = crate::W<BACKUP_BUS_PMS_CONSTRAIN_3_SPEC>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SPI_2` reader - BackUp access spi_2 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SPI_2_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SPI_2` writer - BackUp access spi_2 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SPI_2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SPI_3` reader - BackUp access spi_3 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SPI_3_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SPI_3` writer - BackUp access spi_3 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SPI_3_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_APB_CTRL` reader - BackUp access apb_ctrl permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_APB_CTRL_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_APB_CTRL` writer - BackUp access apb_ctrl permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_APB_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_I2C_EXT1` reader - BackUp access i2c_ext1 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_I2C_EXT1_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_I2C_EXT1` writer - BackUp access i2c_ext1 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_I2C_EXT1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SDIO_HOST` reader - BackUp access sdio_host permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SDIO_HOST_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_SDIO_HOST` writer - BackUp access sdio_host permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_SDIO_HOST_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_CAN` reader - BackUp access can permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_CAN_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_CAN` writer - BackUp access can permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_CAN_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_PWM1` reader - BackUp access pwm1 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_PWM1_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_PWM1` writer - BackUp access pwm1 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_PWM1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_I2S1` reader - BackUp access i2s1 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_I2S1_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_I2S1` writer - BackUp access i2s1 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_I2S1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_UART2` reader - BackUp access uart2 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_UART2_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_UART2` writer - BackUp access uart2 permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_UART2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_RWBT` reader - BackUp access rwbt permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_RWBT_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_RWBT` writer - BackUp access rwbt permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_RWBT_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_WIFIMAC` reader - BackUp access wifimac permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_WIFIMAC_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_WIFIMAC` writer - BackUp access wifimac permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_WIFIMAC_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `BACKUP_BUS_PMS_CONSTRAIN_PWR` reader - BackUp access pwr permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_PWR_R = crate::FieldReader;
///Field `BACKUP_BUS_PMS_CONSTRAIN_PWR` writer - BackUp access pwr permission.
pub type BACKUP_BUS_PMS_CONSTRAIN_PWR_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - BackUp access spi_2 permission.
    #[inline(always)]
    ...
    ///Bits 2:3 - BackUp access spi_3 permission.
    #[inline(always)]
    ...
    ///Bits 12:13 - BackUp access pwm1 permission.
    #[inline(always)]
    ...
    ///Bits 14:15 - BackUp access i2s1 permission.
    #[inline(always)]
    ...
    ///Bits 16:17 - BackUp access uart2 permission.
    #[inline(always)]
    ...
    ///Bits 22:23 - BackUp access rwbt permission.
    #[inline(always)]
...
///`read()` method returns [`backup_bus_pms_constrain_3::R`](R) reader structure
impl crate::Readable for BACKUP_BUS_PMS_CONSTRAIN_3_SPEC {}
///`write(|w| ..)` method takes [`backup_bus_pms_constrain_3::W`](W) writer structure
