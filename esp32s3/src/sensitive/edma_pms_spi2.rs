...
pub type ATTR1_W<'a, const O: u8> = crate::FieldWriter<'a, EDMA_PMS_SPI2_SPEC, 2, O>;
...
pub type ATTR2_W<'a, const O: u8> = crate::FieldWriter<'a, EDMA_PMS_SPI2_SPEC, 2, O>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<EDMA_PMS_SPI2_SPEC> {
