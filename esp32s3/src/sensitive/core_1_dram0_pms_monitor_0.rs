...
pub struct R(crate::R<CORE_1_DRAM0_PMS_MONITOR_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CORE_1_DRAM0_PMS_MONITOR_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CORE_1_DRAM0_PMS_MONITOR_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CORE_1_DRAM0_PMS_MONITOR_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CORE_1_DRAM0_PMS_MONITOR_0` writer"]
pub struct W(crate::W<CORE_1_DRAM0_PMS_MONITOR_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CORE_1_DRAM0_PMS_MONITOR_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CORE_1_DRAM0_PMS_MONITOR_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CORE_1_DRAM0_PMS_MONITOR_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CORE_1_DRAM0_PMS_MONITOR_LOCK_W<'a, const O: u8> =
    crate::BitWriter<'a, CORE_1_DRAM0_PMS_MONITOR_0_SPEC, O>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CORE_1_DRAM0_PMS_MONITOR_0_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_1_dram0_pms_monitor_lock(&mut self) -> CORE_1_DRAM0_PMS_MONITOR_LOCK_W<0> {
        CORE_1_DRAM0_PMS_MONITOR_LOCK_W::new(self)
    }
