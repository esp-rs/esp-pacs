...
pub type TX_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONF0_SPEC, bool, O>;
...
pub type RX_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONF0_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bit 4 - Set this bit to link up HCI and UART2."]
    #[inline(always)]
    pub fn uart2_ce(&mut self) -> UART2_CE_W<4> {
        UART2_CE_W::new(self)
    }
    #[doc = "Bit 5 - Set this bit to separate the data frame using a special char."]
    #[inline(always)]
