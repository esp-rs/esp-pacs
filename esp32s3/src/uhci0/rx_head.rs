...
///Field `RX_HEAD` reader - This register stores the header of the current received packet.
pub type RX_HEAD_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the header of the current received packet.
    #[inline(always)]
