...
///Field `SEND_S_REG_Q` writer - Set this bit to clear UHCI_SEND_S_REQ_Q_INT interrupt.
pub type SEND_S_REG_Q_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `SEND_A_REG_Q` writer - Set this bit to clear UHCI_SEND_A_REQ_Q_INT interrupt.
...
///Field `APP_CTRL0` writer - Set this bit to clear UHCI_APP_CTRL0_INT interrupt.
pub type APP_CTRL0_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `APP_CTRL1` writer - Set this bit to clear UHCI_APP_CTRL1_INT interrupt.
