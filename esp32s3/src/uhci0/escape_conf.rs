...
///Field `TX_C0_ESC_EN` reader - Set this bit to enable decoding char 0xc0 when DMA receives data.
pub type TX_C0_ESC_EN_R = crate::BitReader;
///Field `TX_C0_ESC_EN` writer - Set this bit to enable decoding char 0xc0 when DMA receives data.
pub type TX_C0_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_DB_ESC_EN` reader - Set this bit to enable decoding char 0xdb when DMA receives data.
pub type TX_DB_ESC_EN_R = crate::BitReader;
///Field `TX_DB_ESC_EN` writer - Set this bit to enable decoding char 0xdb when DMA receives data.
pub type TX_DB_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_11_ESC_EN` reader - Set this bit to enable decoding flow control char 0x11 when DMA receives data.
pub type TX_11_ESC_EN_R = crate::BitReader;
///Field `TX_11_ESC_EN` writer - Set this bit to enable decoding flow control char 0x11 when DMA receives data.
pub type TX_11_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_13_ESC_EN` reader - Set this bit to enable decoding flow control char 0x13 when DMA receives data.
pub type TX_13_ESC_EN_R = crate::BitReader;
///Field `TX_13_ESC_EN` writer - Set this bit to enable decoding flow control char 0x13 when DMA receives data.
pub type TX_13_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_C0_ESC_EN` reader - Set this bit to enable replacing 0xc0 by special char when DMA sends data.
pub type RX_C0_ESC_EN_R = crate::BitReader;
///Field `RX_C0_ESC_EN` writer - Set this bit to enable replacing 0xc0 by special char when DMA sends data.
pub type RX_C0_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_DB_ESC_EN` reader - Set this bit to enable replacing 0xdb by special char when DMA sends data.
pub type RX_DB_ESC_EN_R = crate::BitReader;
///Field `RX_DB_ESC_EN` writer - Set this bit to enable replacing 0xdb by special char when DMA sends data.
pub type RX_DB_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_11_ESC_EN` reader - Set this bit to enable replacing flow control char 0x11 by special char when DMA sends data.
pub type RX_11_ESC_EN_R = crate::BitReader;
///Field `RX_11_ESC_EN` writer - Set this bit to enable replacing flow control char 0x11 by special char when DMA sends data.
pub type RX_11_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_13_ESC_EN` reader - Set this bit to enable replacing flow control char 0x13 by special char when DMA sends data.
pub type RX_13_ESC_EN_R = crate::BitReader;
///Field `RX_13_ESC_EN` writer - Set this bit to enable replacing flow control char 0x13 by special char when DMA sends data.
