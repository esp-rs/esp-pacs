...
///Field `SEND_S_REG_Q` reader - This is the interrupt enable bit for UHCI_SEND_S_REQ_Q_INT interrupt.
pub type SEND_S_REG_Q_R = crate::BitReader;
///Field `SEND_S_REG_Q` writer - This is the interrupt enable bit for UHCI_SEND_S_REQ_Q_INT interrupt.
pub type SEND_S_REG_Q_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SEND_A_REG_Q` reader - This is the interrupt enable bit for UHCI_SEND_A_REQ_Q_INT interrupt.
pub type SEND_A_REG_Q_R = crate::BitReader;
///Field `SEND_A_REG_Q` writer - This is the interrupt enable bit for UHCI_SEND_A_REQ_Q_INT interrupt.
...
///Field `APP_CTRL0` reader - This is the interrupt enable bit for UHCI_APP_CTRL0_INT interrupt.
pub type APP_CTRL0_R = crate::BitReader;
///Field `APP_CTRL0` writer - This is the interrupt enable bit for UHCI_APP_CTRL0_INT interrupt.
pub type APP_CTRL0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APP_CTRL1` reader - This is the interrupt enable bit for UHCI_APP_CTRL1_INT interrupt.
pub type APP_CTRL1_R = crate::BitReader;
///Field `APP_CTRL1` writer - This is the interrupt enable bit for UHCI_APP_CTRL1_INT interrupt.
