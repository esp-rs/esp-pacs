...
#[doc = "Field `SEND_Q1_WORD1` reader - This register is used as a quick_sent register when specified by UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM."]
pub type SEND_Q1_WORD1_R = crate::FieldReader<u32>;
#[doc = "Field `SEND_Q1_WORD1` writer - This register is used as a quick_sent register when specified by UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM."]
pub type SEND_Q1_WORD1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn send_q1_word1(&mut self) -> SEND_Q1_WORD1_W<REG_Q1_WORD1_SPEC, 0> {
