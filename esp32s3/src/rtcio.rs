...
pub struct RegisterBlock {
    ...
    pub rtc_gpio_out: crate::Reg<rtc_gpio_out::RTC_GPIO_OUT_SPEC>,
    #[doc = "0x04 - one set RTC GPIO output data"]
    pub rtc_gpio_out_w1ts: crate::Reg<rtc_gpio_out_w1ts::RTC_GPIO_OUT_W1TS_SPEC>,
    #[doc = "0x08 - one clear RTC GPIO output data"]
    pub rtc_gpio_out_w1tc: crate::Reg<rtc_gpio_out_w1tc::RTC_GPIO_OUT_W1TC_SPEC>,
    #[doc = "0x0c - Configure RTC GPIO output enable"]
    pub rtc_gpio_enable: crate::Reg<rtc_gpio_enable::RTC_GPIO_ENABLE_SPEC>,
    ...
    pub rtc_gpio_status_w1ts: crate::Reg<rtc_gpio_status_w1ts::RTC_GPIO_STATUS_W1TS_SPEC>,
    ...
    pub touch_pad10: crate::Reg<touch_pad10::TOUCH_PAD10_SPEC>,
    #[doc = "0xb0 - configure RTC PAD11"]
    pub touch_pad11: crate::Reg<touch_pad11::TOUCH_PAD11_SPEC>,
    #[doc = "0xb4 - configure RTC PAD12"]
    pub touch_pad12: crate::Reg<touch_pad12::TOUCH_PAD12_SPEC>,
    #[doc = "0xb8 - configure RTC PAD13"]
    pub touch_pad13: crate::Reg<touch_pad13::TOUCH_PAD13_SPEC>,
    #[doc = "0xbc - configure RTC PAD14"]
    pub touch_pad14: crate::Reg<touch_pad14::TOUCH_PAD14_SPEC>,
    #[doc = "0xc0 - configure RTC PAD15"]
    pub xtal_32p_pad: crate::Reg<xtal_32p_pad::XTAL_32P_PAD_SPEC>,
    #[doc = "0xc4 - configure RTC PAD16"]
    pub xtal_32n_pad: crate::Reg<xtal_32n_pad::XTAL_32N_PAD_SPEC>,
    ...
    pub rtc_pad19: crate::Reg<rtc_pad19::RTC_PAD19_SPEC>,
    #[doc = "0xd4 - configure RTC PAD20"]
    pub rtc_pad20: crate::Reg<rtc_pad20::RTC_PAD20_SPEC>,
    #[doc = "0xd8 - configure RTC PAD21"]
    pub rtc_pad21: crate::Reg<rtc_pad21::RTC_PAD21_SPEC>,
...
#[doc = "RTC_GPIO_OUT register accessor: an alias for `Reg<RTC_GPIO_OUT_SPEC>`"]
pub type RTC_GPIO_OUT = crate::Reg<rtc_gpio_out::RTC_GPIO_OUT_SPEC>;
#[doc = "RTC GPIO 0 ~ 21 output data register"]
pub mod rtc_gpio_out;
#[doc = "RTC_GPIO_OUT_W1TS register accessor: an alias for `Reg<RTC_GPIO_OUT_W1TS_SPEC>`"]
...
#[doc = "RTC_GPIO_OUT_W1TC register accessor: an alias for `Reg<RTC_GPIO_OUT_W1TC_SPEC>`"]
...
#[doc = "RTC_GPIO_ENABLE register accessor: an alias for `Reg<RTC_GPIO_ENABLE_SPEC>`"]
...
#[doc = "RTC_GPIO_ENABLE_W1TS register accessor: an alias for `Reg<RTC_GPIO_ENABLE_W1TS_SPEC>`"]
...
#[doc = "RTC_GPIO_STATUS_W1TS register accessor: an alias for `Reg<RTC_GPIO_STATUS_W1TS_SPEC>`"]
...
#[doc = "RTC_GPIO_STATUS_W1TC register accessor: an alias for `Reg<RTC_GPIO_STATUS_W1TC_SPEC>`"]
...
#[doc = "RTC_GPIO_IN register accessor: an alias for `Reg<RTC_GPIO_IN_SPEC>`"]
...
pub mod pad_dac2;
#[doc = "RTC_PAD19 register accessor: an alias for `Reg<RTC_PAD19_SPEC>`"]
pub type RTC_PAD19 = crate::Reg<rtc_pad19::RTC_PAD19_SPEC>;
#[doc = "configure RTC PAD19"]
pub mod rtc_pad19;
#[doc = "RTC_PAD20 register accessor: an alias for `Reg<RTC_PAD20_SPEC>`"]
pub type RTC_PAD20 = crate::Reg<rtc_pad20::RTC_PAD20_SPEC>;
#[doc = "configure RTC PAD20"]
pub mod rtc_pad20;
#[doc = "RTC_PAD21 register accessor: an alias for `Reg<RTC_PAD21_SPEC>`"]
...
pub mod sar_i2c_io;
#[doc = "TOUCH_CTRL register accessor: an alias for `Reg<TOUCH_CTRL_SPEC>`"]
