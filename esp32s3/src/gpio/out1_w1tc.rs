...
#[doc = "Field `OUT1_W1TC` writer - GPIO output clear register for GPIO32-53"]
pub type OUT1_W1TC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OUT1_W1TC_SPEC, u32, u32, 22, O>;
impl W {
