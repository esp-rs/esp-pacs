...
///Field `DATA_ORIG` reader - GPIO output register for GPIO0-31
pub type DATA_ORIG_R = crate::FieldReader<u32>;
///Field `DATA_ORIG` writer - GPIO output register for GPIO0-31
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - GPIO output register for GPIO0-31
    #[inline(always)]
