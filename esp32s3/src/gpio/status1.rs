...
///Field `INTERRUPT` reader - GPIO interrupt status register for GPIO32-53
pub type INTERRUPT_R = crate::FieldReader<u32>;
///Field `INTERRUPT` writer - GPIO interrupt status register for GPIO32-53
pub type INTERRUPT_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - GPIO interrupt status register for GPIO32-53
    #[inline(always)]
