...
///Field `DATA_ORIG` reader - GPIO output register for GPIO32-53
pub type DATA_ORIG_R = crate::FieldReader<u32>;
///Field `DATA_ORIG` writer - GPIO output register for GPIO32-53
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
impl R {
    ///Bits 0:21 - GPIO output register for GPIO32-53
    #[inline(always)]
