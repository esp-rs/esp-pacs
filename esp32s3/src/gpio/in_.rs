...
///Field `DATA_NEXT` reader - GPIO input register for GPIO0-31
pub type DATA_NEXT_R = crate::FieldReader<u32>;
///Field `DATA_NEXT` writer - GPIO input register for GPIO0-31
pub type DATA_NEXT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - GPIO input register for GPIO0-31
    #[inline(always)]
