...
pub type CNT_H_LIM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONF2_SPEC, u16, u16, 16, O>;
...
pub type CNT_L_LIM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONF2_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "`reset()` method sets CONF2%s to value 0"]
