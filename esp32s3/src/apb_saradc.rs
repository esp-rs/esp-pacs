...
/**CTRL (rw) register accessor: configure apb saradc controller
...
pub mod ctrl;
/**CTRL2 (rw) register accessor: configure apb saradc controller
...
///configure apb saradc controller
pub mod ctrl2;
/**FILTER_CTRL1 (rw) register accessor: configure saradc filter
...
/**FSM_WAIT (rw) register accessor: configure apb saradc fsm
...
pub mod fsm_wait;
/**SAR1_STATUS (r) register accessor: saradc1 status for debug
...
pub mod sar1_status;
/**SAR2_STATUS (r) register accessor: saradc2 status for debug
...
pub mod sar2_status;
/**SAR1_PATT_TAB1 (rw) register accessor: configure apb saradc pattern table
...
/**SAR1_PATT_TAB2 (rw) register accessor: configure apb saradc pattern table
...
/**SAR1_PATT_TAB3 (rw) register accessor: configure apb saradc pattern table
...
/**SAR1_PATT_TAB4 (rw) register accessor: configure apb saradc pattern table
...
/**SAR2_PATT_TAB1 (rw) register accessor: configure apb saradc pattern table
...
/**SAR2_PATT_TAB2 (rw) register accessor: configure apb saradc pattern table
...
/**SAR2_PATT_TAB3 (rw) register accessor: configure apb saradc pattern table
...
/**SAR2_PATT_TAB4 (rw) register accessor: configure apb saradc pattern table
...
/**ARB_CTRL (rw) register accessor: configure apb saradc arbit
...
pub mod arb_ctrl;
/**FILTER_CTRL0 (rw) register accessor: configure apb saradc arbit
...
/**APB_SARADC1_DATA_STATUS (r) register accessor: get apb saradc sample data
...
pub mod thres0_ctrl;
/**THRES1_CTRL (rw) register accessor: configure apb saradc thres monitor
...
///configure apb saradc thres monitor
pub mod thres1_ctrl;
/**THRES_CTRL (rw) register accessor: configure thres monitor enable
...
pub mod thres_ctrl;
/**INT_ENA (rw) register accessor: enable interrupt
...
///enable interrupt
pub mod int_ena;
/**INT_RAW (r) register accessor: raw of interrupt
...
///raw of interrupt
pub mod int_raw;
/**INT_ST (r) register accessor: state of interrupt
...
///state of interrupt
pub mod int_st;
/**INT_CLR (w) register accessor: clear interrupt
...
///clear interrupt
pub mod int_clr;
/**DMA_CONF (rw) register accessor: configure apb saradc dma
...
pub mod dma_conf;
/**CLKM_CONF (rw) register accessor: configure apb saradc clock
...
pub mod clkm_conf;
/**APB_SARADC2_DATA_STATUS (r) register accessor: get apb saradc2 sample data
