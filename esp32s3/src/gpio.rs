...
pub mod out_w1tc;
/**OUT1 (rw) register accessor: GPIO output register for GPIO32-53
...
pub mod out1;
/**OUT1_W1TS (w) register accessor: GPIO output set register for GPIO32-53
...
pub mod out1_w1ts;
/**OUT1_W1TC (w) register accessor: GPIO output clear register for GPIO32-53
...
pub mod enable_w1tc;
/**ENABLE1 (rw) register accessor: GPIO output enable register for GPIO32-53
...
pub mod enable1;
/**ENABLE1_W1TS (w) register accessor: GPIO output enable set register for GPIO32-53
...
/**ENABLE1_W1TC (w) register accessor: GPIO output enable clear register for GPIO32-53
...
pub mod in_;
/**IN1 (rw) register accessor: GPIO input register for GPIO32-53
...
pub mod status_w1tc;
/**STATUS1 (rw) register accessor: GPIO interrupt status register for GPIO32-53
...
pub mod status1;
/**STATUS1_W1TS (w) register accessor: GPIO interrupt status set register for GPIO32-53
...
/**STATUS1_W1TC (w) register accessor: GPIO interrupt status clear register for GPIO32-53
...
pub mod cpusdio_int;
/**PCPU_INT1 (r) register accessor: GPIO PRO_CPU interrupt status register for GPIO32-53
...
pub mod pcpu_int1;
/**PCPU_NMI_INT1 (r) register accessor: GPIO PRO_CPU(not shielded) interrupt status register for GPIO32-53
...
/**CPUSDIO_INT1 (r) register accessor: GPIO CPUSDIO interrupt status register for GPIO32-53
...
pub mod status_next;
/**STATUS_NEXT1 (r) register accessor: GPIO interrupt source register for GPIO32-53
