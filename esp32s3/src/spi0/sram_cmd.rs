...
pub type SCLK_MODE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type SWB_MODE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SDIN_DUAL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SDOUT_DUAL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SADDR_DUAL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SCMD_DUAL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SDIN_QUAD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SDOUT_QUAD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SADDR_QUAD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SCMD_QUAD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SDIN_OCT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SDOUT_OCT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SADDR_OCT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SCMD_OCT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SDUMMY_OUT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sclk_mode(&mut self) -> SCLK_MODE_W<SRAM_CMD_SPEC, 0> {
        SCLK_MODE_W::new(self)
    }
    #[doc = "Bits 2:9 - Mode bits when SPI0 accesses to Ext_RAM."]
    #[inline(always)]
    #[must_use]
    pub fn swb_mode(&mut self) -> SWB_MODE_W<SRAM_CMD_SPEC, 2> {
        SWB_MODE_W::new(self)
    }
    #[doc = "Bit 10 - When SPI0 accesses to Ext_RAM, set this bit to enable 2-bm in DIN phase."]
    #[inline(always)]
    #[must_use]
    pub fn sdin_dual(&mut self) -> SDIN_DUAL_W<SRAM_CMD_SPEC, 10> {
        SDIN_DUAL_W::new(self)
    }
    #[doc = "Bit 11 - When SPI0 accesses to Ext_RAM, set this bit to enable 2-bm in DOUT phase."]
    #[inline(always)]
    #[must_use]
    pub fn sdout_dual(&mut self) -> SDOUT_DUAL_W<SRAM_CMD_SPEC, 11> {
        SDOUT_DUAL_W::new(self)
    }
    #[doc = "Bit 12 - When SPI0 accesses to Ext_RAM, set this bit to enable 2-bm in ADDR phase."]
    #[inline(always)]
    #[must_use]
    pub fn saddr_dual(&mut self) -> SADDR_DUAL_W<SRAM_CMD_SPEC, 12> {
        SADDR_DUAL_W::new(self)
    }
    #[doc = "Bit 13 - When SPI0 accesses to Ext_RAM, set this bit to enable 2-bm in CMD phase."]
    #[inline(always)]
    #[must_use]
    pub fn scmd_dual(&mut self) -> SCMD_DUAL_W<SRAM_CMD_SPEC, 13> {
        SCMD_DUAL_W::new(self)
    }
    #[doc = "Bit 14 - When SPI0 accesses to Ext_RAM, set this bit to enable 4-bm in DIN phase."]
    #[inline(always)]
    #[must_use]
    pub fn sdin_quad(&mut self) -> SDIN_QUAD_W<SRAM_CMD_SPEC, 14> {
        SDIN_QUAD_W::new(self)
    }
    #[doc = "Bit 15 - When SPI0 accesses to Ext_RAM, set this bit to enable 4-bm in DOUT phase."]
    #[inline(always)]
    #[must_use]
    pub fn sdout_quad(&mut self) -> SDOUT_QUAD_W<SRAM_CMD_SPEC, 15> {
        SDOUT_QUAD_W::new(self)
    }
    #[doc = "Bit 16 - When SPI0 accesses to Ext_RAM, set this bit to enable 4-bm in ADDR phase."]
    #[inline(always)]
    #[must_use]
    pub fn saddr_quad(&mut self) -> SADDR_QUAD_W<SRAM_CMD_SPEC, 16> {
        SADDR_QUAD_W::new(self)
    }
    #[doc = "Bit 17 - When SPI0 accesses to Ext_RAM, set this bit to enable 4-bm in CMD phase."]
    #[inline(always)]
    #[must_use]
    pub fn scmd_quad(&mut self) -> SCMD_QUAD_W<SRAM_CMD_SPEC, 17> {
        SCMD_QUAD_W::new(self)
    }
    #[doc = "Bit 18 - When SPI0 accesses to Ext_RAM, set this bit to enable 8-bm in DIN phase."]
    #[inline(always)]
    #[must_use]
    pub fn sdin_oct(&mut self) -> SDIN_OCT_W<SRAM_CMD_SPEC, 18> {
        SDIN_OCT_W::new(self)
    }
    #[doc = "Bit 19 - When SPI0 accesses to Ext_RAM, set this bit to enable 8-bm in DOUT phase."]
    #[inline(always)]
    #[must_use]
    pub fn sdout_oct(&mut self) -> SDOUT_OCT_W<SRAM_CMD_SPEC, 19> {
        SDOUT_OCT_W::new(self)
    }
    #[doc = "Bit 20 - When SPI0 accesses to Ext_RAM, set this bit to enable 8-bm in ADDR phase."]
    #[inline(always)]
    #[must_use]
    pub fn saddr_oct(&mut self) -> SADDR_OCT_W<SRAM_CMD_SPEC, 20> {
        SADDR_OCT_W::new(self)
    }
    #[doc = "Bit 21 - When SPI0 accesses to Ext_RAM, set this bit to enable 8-bm in CMD phase."]
    #[inline(always)]
    #[must_use]
    pub fn scmd_oct(&mut self) -> SCMD_OCT_W<SRAM_CMD_SPEC, 21> {
        SCMD_OCT_W::new(self)
    }
    #[doc = "Bit 22 - When SPI0 accesses to Ext_RAM, in the DUMMY phase the signal level of SPI bus is output by the SPI0 controller."]
    #[inline(always)]
    #[must_use]
    pub fn sdummy_out(&mut self) -> SDUMMY_OUT_W<SRAM_CMD_SPEC, 22> {
