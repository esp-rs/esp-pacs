...
///Field `DOUT0_MODE` reader - SPI_D output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT0_MODE_R = crate::BitReader;
///Field `DOUT0_MODE` writer - SPI_D output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT0_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOUT1_MODE` reader - SPI_Q output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT1_MODE_R = crate::BitReader;
///Field `DOUT1_MODE` writer - SPI_Q output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT1_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOUT2_MODE` reader - SPI_WP output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT2_MODE_R = crate::BitReader;
///Field `DOUT2_MODE` writer - SPI_WP output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT2_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOUT3_MODE` reader - SPI_HD output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT3_MODE_R = crate::BitReader;
///Field `DOUT3_MODE` writer - SPI_HD output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT3_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOUT4_MODE` reader - SPI_IO4 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT4_MODE_R = crate::BitReader;
///Field `DOUT4_MODE` writer - SPI_IO4 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT4_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOUT5_MODE` reader - SPI_IO5 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT5_MODE_R = crate::BitReader;
///Field `DOUT5_MODE` writer - SPI_IO5 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT5_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOUT6_MODE` reader - SPI_IO6 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT6_MODE_R = crate::BitReader;
///Field `DOUT6_MODE` writer - SPI_IO6 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT6_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOUT7_MODE` reader - SPI_IO7 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT7_MODE_R = crate::BitReader;
///Field `DOUT7_MODE` writer - SPI_IO7 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUT7_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DOUTS_MODE` reader - SPI_DQS output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type DOUTS_MODE_R = crate::BitReader;
///Field `DOUTS_MODE` writer - SPI_DQS output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
