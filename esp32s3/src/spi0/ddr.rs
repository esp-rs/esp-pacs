...
pub type SPI_FMEM_TX_DDR_MSK_EN_W<'a, const O: u8> = crate::BitWriter<'a, DDR_SPEC, O>;
...
pub type SPI_FMEM_RX_DDR_MSK_EN_W<'a, const O: u8> = crate::BitWriter<'a, DDR_SPEC, O>;
