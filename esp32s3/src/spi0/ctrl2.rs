...
pub type ECC_CS_HOLD_TIME_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ECC_SKIP_PAGE_CORNER_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ECC_16TO18_BYTE_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ecc_cs_hold_time(&mut self) -> ECC_CS_HOLD_TIME_W<CTRL2_SPEC, 10> {
        ECC_CS_HOLD_TIME_W::new(self)
    }
    #[doc = "Bit 13 - 1: MSPI skips page corner when accesses flash. 0: Not skip page corner when accesses flash."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_skip_page_corner(&mut self) -> ECC_SKIP_PAGE_CORNER_W<CTRL2_SPEC, 13> {
        ECC_SKIP_PAGE_CORNER_W::new(self)
    }
    #[doc = "Bit 14 - Set this bit to enable MSPI ECC 16 bytes data with 2 ECC bytes mode when accesses flash."]
    #[inline(always)]
    #[must_use]
    pub fn ecc_16to18_byte_en(&mut self) -> ECC_16TO18_BYTE_EN_W<CTRL2_SPEC, 14> {
