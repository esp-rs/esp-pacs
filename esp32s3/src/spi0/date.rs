...
///Field `SPI_SMEM_SPICLK_FUN_DRV` reader - The driver of SPI_CLK PAD is controlled by the bits SPI_SMEM_SPICLK_FUN_DRV\[1:0\] when the bit SPI_SPICLK_PAD_DRV_CTL_EN is set and MSPI accesses to external RAM.
pub type SPI_SMEM_SPICLK_FUN_DRV_R = crate::FieldReader;
///Field `SPI_SMEM_SPICLK_FUN_DRV` writer - The driver of SPI_CLK PAD is controlled by the bits SPI_SMEM_SPICLK_FUN_DRV\[1:0\] when the bit SPI_SPICLK_PAD_DRV_CTL_EN is set and MSPI accesses to external RAM.
pub type SPI_SMEM_SPICLK_FUN_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_FMEM_SPICLK_FUN_DRV` reader - The driver of SPI_CLK PAD is controlled by the bits SPI_FMEM_SPICLK_FUN_DRV\[1:0\] when the bit SPI_SPICLK_PAD_DRV_CTL_EN is set and MSPI accesses to flash.
pub type SPI_FMEM_SPICLK_FUN_DRV_R = crate::FieldReader;
///Field `SPI_FMEM_SPICLK_FUN_DRV` writer - The driver of SPI_CLK PAD is controlled by the bits SPI_FMEM_SPICLK_FUN_DRV\[1:0\] when the bit SPI_SPICLK_PAD_DRV_CTL_EN is set and MSPI accesses to flash.
pub type SPI_FMEM_SPICLK_FUN_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SPICLK_PAD_DRV_CTL_EN` reader - SPI_CLK PAD driver control signal. 1: The driver of SPI_CLK PAD is controlled by the bits SPI_FMEM_SPICLK_FUN_DRV\[1:0\] and SPI_SMEM_SPICLK_FUN_DRV\[1:0\]. 0: The driver of SPI_CLK PAD is controlled by the bits IO_MUX_FUNC_DRV\[1:0\] of SPICLK PAD.
pub type SPI_SPICLK_PAD_DRV_CTL_EN_R = crate::BitReader;
///Field `SPI_SPICLK_PAD_DRV_CTL_EN` writer - SPI_CLK PAD driver control signal. 1: The driver of SPI_CLK PAD is controlled by the bits SPI_FMEM_SPICLK_FUN_DRV\[1:0\] and SPI_SMEM_SPICLK_FUN_DRV\[1:0\]. 0: The driver of SPI_CLK PAD is controlled by the bits IO_MUX_FUNC_DRV\[1:0\] of SPICLK PAD.
