...
pub type SPI_SMEM_SPICLK_FUN_DRV_R = crate::FieldReader<u8, u8>;
...
pub type SPI_SMEM_SPICLK_FUN_DRV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DATE_SPEC, u8, u8, 2, O>;
...
pub type SPI_FMEM_SPICLK_FUN_DRV_R = crate::FieldReader<u8, u8>;
...
pub type SPI_FMEM_SPICLK_FUN_DRV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DATE_SPEC, u8, u8, 2, O>;
...
pub type SPI_SPICLK_PAD_DRV_CTL_EN_R = crate::BitReader<bool>;
...
pub type SPI_SPICLK_PAD_DRV_CTL_EN_W<'a, const O: u8> =
...
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATE_SPEC, u32, u32, 23, O>;
impl R {
