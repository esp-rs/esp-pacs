...
pub type SPI_SMEM_VAR_DUMMY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RDAT_SWP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type WDAT_SWP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMD_DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_OUTMINBYTELEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type SPI_SMEM_TX_DDR_MSK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_RX_DDR_MSK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_USR_DDR_DQS_THD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type DQS_LOOP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DQS_LOOP_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_CLK_DIFF_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_HYPERBUS_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_DQS_CA_IN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_HYPERBUS_DUMMY_2X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_CLK_DIFF_INV_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_OCTA_RAM_ADDR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_HYPERBUS_CA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<SPI_SMEM_DDR_SPEC, 0> {
        EN_W::new(self)
    }
    #[doc = "Bit 1 - Set the bit to enable variable dummy cycle in spi ddr mode."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_var_dummy(&mut self) -> SPI_SMEM_VAR_DUMMY_W<SPI_SMEM_DDR_SPEC, 1> {
        SPI_SMEM_VAR_DUMMY_W::new(self)
    }
    #[doc = "Bit 2 - Set the bit to reorder rx data of the word in spi ddr mode."]
    #[inline(always)]
    #[must_use]
    pub fn rdat_swp(&mut self) -> RDAT_SWP_W<SPI_SMEM_DDR_SPEC, 2> {
        RDAT_SWP_W::new(self)
    }
    #[doc = "Bit 3 - Set the bit to reorder tx data of the word in spi ddr mode."]
    #[inline(always)]
    #[must_use]
    pub fn wdat_swp(&mut self) -> WDAT_SWP_W<SPI_SMEM_DDR_SPEC, 3> {
        WDAT_SWP_W::new(self)
    }
    #[doc = "Bit 4 - the bit is used to disable dual edge in CMD phase when ddr mode."]
    #[inline(always)]
    #[must_use]
    pub fn cmd_dis(&mut self) -> CMD_DIS_W<SPI_SMEM_DDR_SPEC, 4> {
        CMD_DIS_W::new(self)
    }
    #[doc = "Bits 5:11 - It is the minimum output data length in the ddr psram."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_outminbytelen(&mut self) -> SPI_SMEM_OUTMINBYTELEN_W<SPI_SMEM_DDR_SPEC, 5> {
        SPI_SMEM_OUTMINBYTELEN_W::new(self)
    }
    #[doc = "Bit 12 - Set this bit to mask the first or the last byte in MSPI ECC DDR write mode, when accesses to external RAM."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_tx_ddr_msk_en(&mut self) -> SPI_SMEM_TX_DDR_MSK_EN_W<SPI_SMEM_DDR_SPEC, 12> {
        SPI_SMEM_TX_DDR_MSK_EN_W::new(self)
    }
    #[doc = "Bit 13 - Set this bit to mask the first or the last byte in MSPI ECC DDR read mode, when accesses to external RAM."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_rx_ddr_msk_en(&mut self) -> SPI_SMEM_RX_DDR_MSK_EN_W<SPI_SMEM_DDR_SPEC, 13> {
    ...
    pub fn spi_smem_usr_ddr_dqs_thd(
        &mut self,
    ) -> SPI_SMEM_USR_DDR_DQS_THD_W<SPI_SMEM_DDR_SPEC, 14> {
        SPI_SMEM_USR_DDR_DQS_THD_W::new(self)
    }
    #[doc = "Bit 21 - 1: Use internal signal as data strobe, the strobe can not be delayed by input timing module. 0: Use input SPI_DQS signal from PAD as data strobe, the strobe can be delayed by input timing module"]
    #[inline(always)]
    #[must_use]
    pub fn dqs_loop(&mut self) -> DQS_LOOP_W<SPI_SMEM_DDR_SPEC, 21> {
        DQS_LOOP_W::new(self)
    }
    #[doc = "Bit 22 - When SPI_SMEM_DDR_DQS_LOOP and SPI_SMEM_DDR_EN are set, 1: Use internal SPI_CLK as data strobe. 0: Use internal ~SPI_CLK as data strobe. Otherwise this bit is not active."]
    #[inline(always)]
    #[must_use]
    pub fn dqs_loop_mode(&mut self) -> DQS_LOOP_MODE_W<SPI_SMEM_DDR_SPEC, 22> {
        DQS_LOOP_MODE_W::new(self)
    }
    #[doc = "Bit 24 - Set this bit to enable the differential SPI_CLK#."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_clk_diff_en(&mut self) -> SPI_SMEM_CLK_DIFF_EN_W<SPI_SMEM_DDR_SPEC, 24> {
        SPI_SMEM_CLK_DIFF_EN_W::new(self)
    }
    #[doc = "Bit 25 - Set this bit to enable the SPI HyperBus mode."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_hyperbus_mode(&mut self) -> SPI_SMEM_HYPERBUS_MODE_W<SPI_SMEM_DDR_SPEC, 25> {
        SPI_SMEM_HYPERBUS_MODE_W::new(self)
    }
    #[doc = "Bit 26 - Set this bit to enable the input of SPI_DQS signal in SPI phases of CMD and ADDR."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_dqs_ca_in(&mut self) -> SPI_SMEM_DQS_CA_IN_W<SPI_SMEM_DDR_SPEC, 26> {
    ...
    pub fn spi_smem_hyperbus_dummy_2x(
        &mut self,
    ) -> SPI_SMEM_HYPERBUS_DUMMY_2X_W<SPI_SMEM_DDR_SPEC, 27> {
        SPI_SMEM_HYPERBUS_DUMMY_2X_W::new(self)
    }
    #[doc = "Bit 28 - Set this bit to invert SPI_DIFF when accesses to external RAM. ."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_clk_diff_inv(&mut self) -> SPI_SMEM_CLK_DIFF_INV_W<SPI_SMEM_DDR_SPEC, 28> {
        SPI_SMEM_CLK_DIFF_INV_W::new(self)
    }
    #[doc = "Bit 29 - Set this bit to enable octa_ram address out when accesses to external RAM, which means ADDR_OUT\\[31:0\\] = {spi_usr_addr_value\\[25:4\\], 6'd0, spi_usr_addr_value\\[3:1\\], 1'b0}."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_octa_ram_addr(&mut self) -> SPI_SMEM_OCTA_RAM_ADDR_W<SPI_SMEM_DDR_SPEC, 29> {
        SPI_SMEM_OCTA_RAM_ADDR_W::new(self)
    }
    #[doc = "Bit 30 - Set this bit to enable HyperRAM address out when accesses to external RAM, which means ADDR_OUT\\[31:0\\] = {spi_usr_addr_value\\[19:4\\], 13'd0, spi_usr_addr_value\\[3:1\\]}."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_hyperbus_ca(&mut self) -> SPI_SMEM_HYPERBUS_CA_W<SPI_SMEM_DDR_SPEC, 30> {
