...
///Register `SPI_SMEM_DOUT_MODE` writer
pub type W = crate::W<SPI_SMEM_DOUT_MODE_SPEC>;
///Field `SPI_SMEM_DOUT0_MODE` reader - SPI_D output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT0_MODE_R = crate::BitReader;
///Field `SPI_SMEM_DOUT0_MODE` writer - SPI_D output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT0_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_DOUT1_MODE` reader - SPI_Q output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT1_MODE_R = crate::BitReader;
///Field `SPI_SMEM_DOUT1_MODE` writer - SPI_Q output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT1_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_DOUT2_MODE` reader - SPI_WP output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT2_MODE_R = crate::BitReader;
///Field `SPI_SMEM_DOUT2_MODE` writer - SPI_WP output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT2_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_DOUT3_MODE` reader - SPI_HD output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT3_MODE_R = crate::BitReader;
///Field `SPI_SMEM_DOUT3_MODE` writer - SPI_HD output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT3_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_DOUT4_MODE` reader - SPI_IO4 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT4_MODE_R = crate::BitReader;
///Field `SPI_SMEM_DOUT4_MODE` writer - SPI_IO4 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT4_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_DOUT5_MODE` reader - SPI_IO5 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT5_MODE_R = crate::BitReader;
///Field `SPI_SMEM_DOUT5_MODE` writer - SPI_IO5 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT5_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_DOUT6_MODE` reader - SPI_IO6 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT6_MODE_R = crate::BitReader;
///Field `SPI_SMEM_DOUT6_MODE` writer - SPI_IO6 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT6_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_DOUT7_MODE` reader - SPI_IO7 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT7_MODE_R = crate::BitReader;
///Field `SPI_SMEM_DOUT7_MODE` writer - SPI_IO7 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUT7_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI_SMEM_DOUTS_MODE` reader - SPI_DQS output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
pub type SPI_SMEM_DOUTS_MODE_R = crate::BitReader;
///Field `SPI_SMEM_DOUTS_MODE` writer - SPI_DQS output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge.
...
///`write(|w| ..)` method takes [`spi_smem_dout_mode::W`](W) writer structure
