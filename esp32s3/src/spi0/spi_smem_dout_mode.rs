...
pub type SPI_SMEM_DOUT0_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_DOUT1_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_DOUT2_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_DOUT3_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_DOUT4_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_DOUT5_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_DOUT6_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_DOUT7_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_SMEM_DOUTS_MODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_dout0_mode(&mut self) -> SPI_SMEM_DOUT0_MODE_W<SPI_SMEM_DOUT_MODE_SPEC, 0> {
        SPI_SMEM_DOUT0_MODE_W::new(self)
    }
    #[doc = "Bit 1 - SPI_Q output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_dout1_mode(&mut self) -> SPI_SMEM_DOUT1_MODE_W<SPI_SMEM_DOUT_MODE_SPEC, 1> {
        SPI_SMEM_DOUT1_MODE_W::new(self)
    }
    #[doc = "Bit 2 - SPI_WP output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_dout2_mode(&mut self) -> SPI_SMEM_DOUT2_MODE_W<SPI_SMEM_DOUT_MODE_SPEC, 2> {
        SPI_SMEM_DOUT2_MODE_W::new(self)
    }
    #[doc = "Bit 3 - SPI_HD output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_dout3_mode(&mut self) -> SPI_SMEM_DOUT3_MODE_W<SPI_SMEM_DOUT_MODE_SPEC, 3> {
        SPI_SMEM_DOUT3_MODE_W::new(self)
    }
    #[doc = "Bit 4 - SPI_IO4 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_dout4_mode(&mut self) -> SPI_SMEM_DOUT4_MODE_W<SPI_SMEM_DOUT_MODE_SPEC, 4> {
        SPI_SMEM_DOUT4_MODE_W::new(self)
    }
    #[doc = "Bit 5 - SPI_IO5 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_dout5_mode(&mut self) -> SPI_SMEM_DOUT5_MODE_W<SPI_SMEM_DOUT_MODE_SPEC, 5> {
        SPI_SMEM_DOUT5_MODE_W::new(self)
    }
    #[doc = "Bit 6 - SPI_IO6 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_dout6_mode(&mut self) -> SPI_SMEM_DOUT6_MODE_W<SPI_SMEM_DOUT_MODE_SPEC, 6> {
        SPI_SMEM_DOUT6_MODE_W::new(self)
    }
    #[doc = "Bit 7 - SPI_IO7 output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_dout7_mode(&mut self) -> SPI_SMEM_DOUT7_MODE_W<SPI_SMEM_DOUT_MODE_SPEC, 7> {
        SPI_SMEM_DOUT7_MODE_W::new(self)
    }
    #[doc = "Bit 8 - SPI_DQS output delay mode. 0: No delay. 1: Delay one cycle at MSPI_CORE_CLK negative edge."]
    #[inline(always)]
    #[must_use]
    pub fn spi_smem_douts_mode(&mut self) -> SPI_SMEM_DOUTS_MODE_W<SPI_SMEM_DOUT_MODE_SPEC, 8> {
