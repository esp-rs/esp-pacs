...
///Field `SPI_SMEM_DIN0_NUM` reader - SPI_D input delay number.
pub type SPI_SMEM_DIN0_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN0_NUM` writer - SPI_D input delay number.
pub type SPI_SMEM_DIN0_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN1_NUM` reader - SPI_Q input delay number.
pub type SPI_SMEM_DIN1_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN1_NUM` writer - SPI_Q input delay number.
pub type SPI_SMEM_DIN1_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN2_NUM` reader - SPI_WP input delay number.
pub type SPI_SMEM_DIN2_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN2_NUM` writer - SPI_WP input delay number.
pub type SPI_SMEM_DIN2_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN3_NUM` reader - SPI_HD input delay number.
pub type SPI_SMEM_DIN3_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN3_NUM` writer - SPI_HD input delay number.
pub type SPI_SMEM_DIN3_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN4_NUM` reader - SPI_IO4 input delay number.
pub type SPI_SMEM_DIN4_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN4_NUM` writer - SPI_IO4 input delay number.
pub type SPI_SMEM_DIN4_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN5_NUM` reader - SPI_IO5 input delay number.
pub type SPI_SMEM_DIN5_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN5_NUM` writer - SPI_IO5 input delay number.
pub type SPI_SMEM_DIN5_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN6_NUM` reader - SPI_IO6 input delay number.
pub type SPI_SMEM_DIN6_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN6_NUM` writer - SPI_IO6 input delay number.
pub type SPI_SMEM_DIN6_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DIN7_NUM` reader - SPI_IO7 input delay number.
pub type SPI_SMEM_DIN7_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DIN7_NUM` writer - SPI_IO7 input delay number.
pub type SPI_SMEM_DIN7_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI_SMEM_DINS_NUM` reader - SPI_DQS input delay number.
pub type SPI_SMEM_DINS_NUM_R = crate::FieldReader;
///Field `SPI_SMEM_DINS_NUM` writer - SPI_DQS input delay number.
