...
/**APP_MAC_INTR_MAP (rw) register accessor: mac interrupt configuration register
...
/**APP_INTR_STATUS_0 (r) register accessor: interrupt status register
...
/**APP_INTR_STATUS_1 (r) register accessor: interrupt status register
...
/**APP_INTR_STATUS_2 (r) register accessor: interrupt status register
...
/**APP_INTR_STATUS_3 (r) register accessor: interrupt status register
