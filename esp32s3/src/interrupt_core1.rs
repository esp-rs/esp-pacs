...
pub struct RegisterBlock {
    ...
    app_intr_status_3: APP_INTR_STATUS_3,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn app_intr_status_3(&self) -> &APP_INTR_STATUS_3 {
        &self.app_intr_status_3
    }
...
#[doc = "APP_INTR_STATUS_3 (r) register accessor: interrupt status register\n\nYou can [`read`](crate::Reg::read) this register and get [`app_intr_status_3::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@app_intr_status_3`] module"]
