...
#[doc = "Field `CH_RX_ERR_INT_RAW[0-3]` reader - The interrupt raw bit for CHANNEL%s. Triggered when error occurs."]
pub type CH_RX_ERR_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `CH0_RX_THR_EVENT_INT_RAW` reader - The interrupt raw bit for CHANNEL0. Triggered when receiver receive more data than configured value."]
pub type CH0_RX_THR_EVENT_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `CH1_RX_THR_EVENT_INT_RAW` reader - The interrupt raw bit for CHANNEL1. Triggered when receiver receive more data than configured value."]
pub type CH1_RX_THR_EVENT_INT_RAW_R = crate::BitReader<bool>;
...
#[doc = "Field `TX_CH0_DMA_ACCESS_FAIL_INT_RAW` reader - The interrupt raw bit for CHANNEL0. Triggered when dma accessing CHANNEL0 fails."]
pub type TX_CH0_DMA_ACCESS_FAIL_INT_RAW_R = crate::BitReader<bool>;
#[doc = "Field `RX_CH0_DMA_ACCESS_FAIL_INT_RAW` reader - The interrupt raw bit for CHANNEL0. Triggered when dma accessing CHANNEL0 fails."]
pub type RX_CH0_DMA_ACCESS_FAIL_INT_RAW_R = crate::BitReader<bool>;
impl R {
    ...
    pub unsafe fn ch_rx_end_int_raw(&self, n: u8) -> CH_RX_END_INT_RAW_R {
        CH_RX_END_INT_RAW_R::new(((self.bits >> (n + 16)) & 1) != 0)
    }
    #[doc = "Bit 16 - The interrupt raw bit for CHANNEL0. Triggered when reception done."]
    #[inline(always)]
    pub fn ch0_rx_end_int_raw(&self) -> CH_RX_END_INT_RAW_R {
        CH_RX_END_INT_RAW_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - The interrupt raw bit for CHANNEL1. Triggered when reception done."]
    #[inline(always)]
    pub fn ch1_rx_end_int_raw(&self) -> CH_RX_END_INT_RAW_R {
        CH_RX_END_INT_RAW_R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - The interrupt raw bit for CHANNEL2. Triggered when reception done."]
    #[inline(always)]
    pub fn ch2_rx_end_int_raw(&self) -> CH_RX_END_INT_RAW_R {
        CH_RX_END_INT_RAW_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - The interrupt raw bit for CHANNEL3. Triggered when reception done."]
    #[inline(always)]
    ...
    pub unsafe fn ch_rx_err_int_raw(&self, n: u8) -> CH_RX_ERR_INT_RAW_R {
        CH_RX_ERR_INT_RAW_R::new(((self.bits >> (n + 20)) & 1) != 0)
    }
    #[doc = "Bit 20 - The interrupt raw bit for CHANNEL0. Triggered when error occurs."]
    #[inline(always)]
    pub fn ch0_rx_err_int_raw(&self) -> CH_RX_ERR_INT_RAW_R {
        CH_RX_ERR_INT_RAW_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - The interrupt raw bit for CHANNEL1. Triggered when error occurs."]
    #[inline(always)]
    pub fn ch1_rx_err_int_raw(&self) -> CH_RX_ERR_INT_RAW_R {
        CH_RX_ERR_INT_RAW_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - The interrupt raw bit for CHANNEL2. Triggered when error occurs."]
    #[inline(always)]
    pub fn ch2_rx_err_int_raw(&self) -> CH_RX_ERR_INT_RAW_R {
        CH_RX_ERR_INT_RAW_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - The interrupt raw bit for CHANNEL3. Triggered when error occurs."]
    #[inline(always)]
    pub fn ch3_rx_err_int_raw(&self) -> CH_RX_ERR_INT_RAW_R {
        CH_RX_ERR_INT_RAW_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - The interrupt raw bit for CHANNEL0. Triggered when receiver receive more data than configured value."]
    #[inline(always)]
    pub fn ch0_rx_thr_event_int_raw(&self) -> CH0_RX_THR_EVENT_INT_RAW_R {
        CH0_RX_THR_EVENT_INT_RAW_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - The interrupt raw bit for CHANNEL1. Triggered when receiver receive more data than configured value."]
    #[inline(always)]
    pub fn ch1_rx_thr_event_int_raw(&self) -> CH1_RX_THR_EVENT_INT_RAW_R {
        CH1_RX_THR_EVENT_INT_RAW_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - The interrupt raw bit for CHANNEL2. Triggered when receiver receive more data than configured value."]
    #[inline(always)]
    pub fn ch2_rx_thr_event_int_raw(&self) -> CH2_RX_THR_EVENT_INT_RAW_R {
        CH2_RX_THR_EVENT_INT_RAW_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - The interrupt raw bit for CHANNEL3. Triggered when receiver receive more data than configured value."]
    #[inline(always)]
    pub fn ch3_rx_thr_event_int_raw(&self) -> CH3_RX_THR_EVENT_INT_RAW_R {
        CH3_RX_THR_EVENT_INT_RAW_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - The interrupt raw bit for CHANNEL0. Triggered when dma accessing CHANNEL0 fails."]
    #[inline(always)]
    pub fn tx_ch0_dma_access_fail_int_raw(&self) -> TX_CH0_DMA_ACCESS_FAIL_INT_RAW_R {
        TX_CH0_DMA_ACCESS_FAIL_INT_RAW_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - The interrupt raw bit for CHANNEL0. Triggered when dma accessing CHANNEL0 fails."]
    #[inline(always)]
    pub fn rx_ch0_dma_access_fail_int_raw(&self) -> RX_CH0_DMA_ACCESS_FAIL_INT_RAW_R {
        RX_CH0_DMA_ACCESS_FAIL_INT_RAW_R::new(((self.bits >> 29) & 1) != 0)
    }
}
