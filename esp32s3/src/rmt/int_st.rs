...
///Field `CH_TX_ERR(0-3)` reader - The masked interrupt status bit for CH%s_ERR_INT.
...
///Field `CH_RX_END(4-7)` reader - The masked interrupt status bit for CH4_RX_END_INT.
pub type CH_RX_END_R = crate::BitReader;
///Field `CH_RX_ERR(4-7)` reader - The masked interrupt status bit for CH4_ERR_INT.
pub type CH_RX_ERR_R = crate::BitReader;
///Field `CH_RX_THR_EVENT(4-7)` reader - The masked interrupt status bit for CH4_RX_THR_EVENT_INT.
...
impl R {
    ...
    ///Bit 25 - The masked interrupt status bit for CH4_RX_THR_EVENT_INT.
    #[inline(always)]
    pub fn ch5_rx_thr_event(&self) -> CH_RX_THR_EVENT_R {
        CH_RX_THR_EVENT_R::new(((self.bits >> 25) & 1) != 0)
    }
    ///Bit 26 - The masked interrupt status bit for CH4_RX_THR_EVENT_INT.
    #[inline(always)]
    pub fn ch6_rx_thr_event(&self) -> CH_RX_THR_EVENT_R {
        CH_RX_THR_EVENT_R::new(((self.bits >> 26) & 1) != 0)
    }
    ///Bit 27 - The masked interrupt status bit for CH4_RX_THR_EVENT_INT.
    #[inline(always)]
