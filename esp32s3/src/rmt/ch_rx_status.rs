...
///Field `APB_MEM_RADDR` reader - This register records the memory address offset when reads RAM over APB bus.
...
///`read()` method returns [`ch_rx_status::R`](R) reader structure
