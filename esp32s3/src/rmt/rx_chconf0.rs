...
pub type DIV_CNT_CH4_W<'a, const O: u8> = crate::FieldWriter<'a, RX_CHCONF0_SPEC, 8, O>;
...
pub type IDLE_THRES_CH4_W<'a, const O: u8> = crate::FieldWriter<'a, RX_CHCONF0_SPEC, 15, O, u16>;
...
pub type MEM_SIZE_CH4_W<'a, const O: u8> = crate::FieldWriter<'a, RX_CHCONF0_SPEC, 4, O>;
...
pub type CARRIER_EN_CH4_W<'a, const O: u8> = crate::BitWriter<'a, RX_CHCONF0_SPEC, O>;
...
pub type CARRIER_OUT_LV_CH4_W<'a, const O: u8> = crate::BitWriter<'a, RX_CHCONF0_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn div_cnt_ch4(&mut self) -> DIV_CNT_CH4_W<0> {
        DIV_CNT_CH4_W::new(self)
    }
    #[doc = "Bits 8:22 - When no edge is detected on the input signal and continuous clock cycles is longer than this register value, received process is finished."]
    #[inline(always)]
    #[must_use]
    pub fn idle_thres_ch4(&mut self) -> IDLE_THRES_CH4_W<8> {
        IDLE_THRES_CH4_W::new(self)
    }
    #[doc = "Bits 24:27 - This register is used to configure the maximum size of memory allocated to CHANNEL%s."]
    #[inline(always)]
    #[must_use]
    pub fn mem_size_ch4(&mut self) -> MEM_SIZE_CH4_W<24> {
        MEM_SIZE_CH4_W::new(self)
    }
    #[doc = "Bit 28 - This is the carrier modulation enable-control bit for CHANNEL%s. 1: Add carrier modulation in the output signal. 0: No carrier modulation in sig_out."]
    #[inline(always)]
    #[must_use]
    pub fn carrier_en_ch4(&mut self) -> CARRIER_EN_CH4_W<28> {
        CARRIER_EN_CH4_W::new(self)
    }
    #[doc = "Bit 29 - This bit is used to configure the position of carrier wave for CHANNEL%s. 1'h0: add carrier wave on low level. 1'h1: add carrier wave on high level."]
    #[inline(always)]
    #[must_use]
    pub fn carrier_out_lv_ch4(&mut self) -> CARRIER_OUT_LV_CH4_W<29> {
        CARRIER_OUT_LV_CH4_W::new(self)
    }
