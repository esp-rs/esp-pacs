...
///Field `CPU_INTR_FROM_CPU_1` reader - Set 1 to generate cpu interrupt 1
pub type CPU_INTR_FROM_CPU_1_R = crate::BitReader;
///Field `CPU_INTR_FROM_CPU_1` writer - Set 1 to generate cpu interrupt 1
pub type CPU_INTR_FROM_CPU_1_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to generate cpu interrupt 1
    #[inline(always)]
