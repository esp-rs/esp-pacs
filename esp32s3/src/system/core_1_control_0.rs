///Register `CORE_1_CONTROL_0` reader
pub type R = crate::R<CORE_1_CONTROL_0_SPEC>;
///Register `CORE_1_CONTROL_0` writer
pub type W = crate::W<CORE_1_CONTROL_0_SPEC>;
///Field `CONTROL_CORE_1_RUNSTALL` reader - Set 1 to stall core1
pub type CONTROL_CORE_1_RUNSTALL_R = crate::BitReader;
///Field `CONTROL_CORE_1_RUNSTALL` writer - Set 1 to stall core1
pub type CONTROL_CORE_1_RUNSTALL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CONTROL_CORE_1_CLKGATE_EN` reader - Set 1 to open core1 clock
pub type CONTROL_CORE_1_CLKGATE_EN_R = crate::BitReader;
///Field `CONTROL_CORE_1_CLKGATE_EN` writer - Set 1 to open core1 clock
pub type CONTROL_CORE_1_CLKGATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CONTROL_CORE_1_RESETING` reader - Set 1 to let core1 reset
pub type CONTROL_CORE_1_RESETING_R = crate::BitReader;
///Field `CONTROL_CORE_1_RESETING` writer - Set 1 to let core1 reset
...
///`read()` method returns [`core_1_control_0::R`](R) reader structure
impl crate::Readable for CORE_1_CONTROL_0_SPEC {}
///`write(|w| ..)` method takes [`core_1_control_0::W`](W) writer structure
