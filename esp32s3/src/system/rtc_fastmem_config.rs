...
///Field `RTC_MEM_CRC_START` reader - Set 1 to start the CRC of RTC memory
pub type RTC_MEM_CRC_START_R = crate::BitReader;
///Field `RTC_MEM_CRC_START` writer - Set 1 to start the CRC of RTC memory
...
///Field `RTC_MEM_CRC_FINISH` reader - This bit stores the status of RTC memory CRC.1 means finished.
