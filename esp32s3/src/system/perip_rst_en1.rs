...
impl W {
    #[doc = "Bit 0 - Set 1 to let BACKUP reset"]
    #[inline(always)]
    pub fn peri_backup_rst(&mut self) -> PERI_BACKUP_RST_W<'_, PERIP_RST_EN1_SPEC> {
    ...
    #[doc = "Bit 9 - Set 1 to let UART2 reset"]
    #[inline(always)]
    pub fn uart2_rst(&mut self) -> UART2_RST_W<'_, PERIP_RST_EN1_SPEC> {
        UART2_RST_W::new(self, 9)
    }
    #[doc = "Bit 10 - Set 1 to let USB_DEVICE reset"]
    #[inline(always)]
    pub fn usb_device_rst(&mut self) -> USB_DEVICE_RST_W<'_, PERIP_RST_EN1_SPEC> {
