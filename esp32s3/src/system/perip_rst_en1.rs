///Register `PERIP_RST_EN1` reader
pub type R = crate::R<PERIP_RST_EN1_SPEC>;
///Register `PERIP_RST_EN1` writer
pub type W = crate::W<PERIP_RST_EN1_SPEC>;
///Field `PERI_BACKUP_RST` reader - Set 1 to let BACKUP reset
pub type PERI_BACKUP_RST_R = crate::BitReader;
///Field `PERI_BACKUP_RST` writer - Set 1 to let BACKUP reset
pub type PERI_BACKUP_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_AES_RST` reader - Set 1 to let CRYPTO_AES reset
pub type CRYPTO_AES_RST_R = crate::BitReader;
///Field `CRYPTO_AES_RST` writer - Set 1 to let CRYPTO_AES reset
pub type CRYPTO_AES_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_SHA_RST` reader - Set 1 to let CRYPTO_SHA reset
pub type CRYPTO_SHA_RST_R = crate::BitReader;
///Field `CRYPTO_SHA_RST` writer - Set 1 to let CRYPTO_SHA reset
...
///Field `CRYPTO_DS_RST` reader - Set 1 to let CRYPTO_DS reset
pub type CRYPTO_DS_RST_R = crate::BitReader;
///Field `CRYPTO_DS_RST` writer - Set 1 to let CRYPTO_DS reset
pub type CRYPTO_DS_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CRYPTO_HMAC_RST` reader - Set 1 to let CRYPTO_HMAC reset
pub type CRYPTO_HMAC_RST_R = crate::BitReader;
///Field `CRYPTO_HMAC_RST` writer - Set 1 to let CRYPTO_HMAC reset
pub type CRYPTO_HMAC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DMA_RST` reader - Set 1 to let DMA reset
pub type DMA_RST_R = crate::BitReader;
///Field `DMA_RST` writer - Set 1 to let DMA reset
pub type DMA_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDIO_HOST_RST` reader - Set 1 to let SDIO_HOST reset
pub type SDIO_HOST_RST_R = crate::BitReader;
///Field `SDIO_HOST_RST` writer - Set 1 to let SDIO_HOST reset
pub type SDIO_HOST_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_CAM_RST` reader - Set 1 to let LCD_CAM reset
pub type LCD_CAM_RST_R = crate::BitReader;
///Field `LCD_CAM_RST` writer - Set 1 to let LCD_CAM reset
pub type LCD_CAM_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART2_RST` reader - Set 1 to let UART2 reset
pub type UART2_RST_R = crate::BitReader;
///Field `UART2_RST` writer - Set 1 to let UART2 reset
pub type UART2_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USB_DEVICE_RST` reader - Set 1 to let USB_DEVICE reset
pub type USB_DEVICE_RST_R = crate::BitReader;
///Field `USB_DEVICE_RST` writer - Set 1 to let USB_DEVICE reset
pub type USB_DEVICE_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to let BACKUP reset
    #[inline(always)]
    pub fn peri_backup_rst(&self) -> PERI_BACKUP_RST_R {
        PERI_BACKUP_RST_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 1 to let CRYPTO_AES reset
    #[inline(always)]
...
///`read()` method returns [`perip_rst_en1::R`](R) reader structure
impl crate::Readable for PERIP_RST_EN1_SPEC {}
///`write(|w| ..)` method takes [`perip_rst_en1::W`](W) writer structure
