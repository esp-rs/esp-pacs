...
///Field `COMB_PATH_LEN_HVT` reader - ******* Description ***********
pub type COMB_PATH_LEN_HVT_R = crate::FieldReader;
///Field `COMB_PATH_LEN_HVT` writer - ******* Description ***********
pub type COMB_PATH_LEN_HVT_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `COMB_ERR_CNT_CLR_HVT` writer - ******* Description ***********
pub type COMB_ERR_CNT_CLR_HVT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COMB_PVT_MONITOR_EN_HVT` reader - ******* Description ***********
pub type COMB_PVT_MONITOR_EN_HVT_R = crate::BitReader;
///Field `COMB_PVT_MONITOR_EN_HVT` writer - ******* Description ***********
