...
///Field `TIMERS_CLK_EN` reader - Set 1 to enable TIMERS clock
pub type TIMERS_CLK_EN_R = crate::BitReader;
///Field `TIMERS_CLK_EN` writer - Set 1 to enable TIMERS clock
...
///Field `WDG_CLK_EN` reader - Set 1 to enable WDG clock
pub type WDG_CLK_EN_R = crate::BitReader;
///Field `WDG_CLK_EN` writer - Set 1 to enable WDG clock
pub type WDG_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2S0_CLK_EN` reader - Set 1 to enable I2S0 clock
pub type I2S0_CLK_EN_R = crate::BitReader;
///Field `I2S0_CLK_EN` writer - Set 1 to enable I2S0 clock
...
///Field `UHCI0_CLK_EN` reader - Set 1 to enable UHCI0 clock
pub type UHCI0_CLK_EN_R = crate::BitReader;
///Field `UHCI0_CLK_EN` writer - Set 1 to enable UHCI0 clock
pub type UHCI0_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RMT_CLK_EN` reader - Set 1 to enable RMT clock
pub type RMT_CLK_EN_R = crate::BitReader;
///Field `RMT_CLK_EN` writer - Set 1 to enable RMT clock
...
///Field `UHCI1_CLK_EN` reader - Set 1 to enable UHCI1 clock
pub type UHCI1_CLK_EN_R = crate::BitReader;
///Field `UHCI1_CLK_EN` writer - Set 1 to enable UHCI1 clock
...
///Field `EFUSE_CLK_EN` reader - Set 1 to enable EFUSE clock
pub type EFUSE_CLK_EN_R = crate::BitReader;
///Field `EFUSE_CLK_EN` writer - Set 1 to enable EFUSE clock
pub type EFUSE_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMERGROUP1_CLK_EN` reader - Set 1 to enable TIMERGROUP1 clock
pub type TIMERGROUP1_CLK_EN_R = crate::BitReader;
///Field `TIMERGROUP1_CLK_EN` writer - Set 1 to enable TIMERGROUP1 clock
pub type TIMERGROUP1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI3_CLK_EN` reader - Set 1 to enable SPI3 clock
pub type SPI3_CLK_EN_R = crate::BitReader;
///Field `SPI3_CLK_EN` writer - Set 1 to enable SPI3 clock
pub type SPI3_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM0_CLK_EN` reader - Set 1 to enable PWM0 clock
pub type PWM0_CLK_EN_R = crate::BitReader;
///Field `PWM0_CLK_EN` writer - Set 1 to enable PWM0 clock
pub type PWM0_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C_EXT1_CLK_EN` reader - Set 1 to enable I2C_EXT1 clock
pub type I2C_EXT1_CLK_EN_R = crate::BitReader;
///Field `I2C_EXT1_CLK_EN` writer - Set 1 to enable I2C_EXT1 clock
pub type I2C_EXT1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TWAI_CLK_EN` reader - Set 1 to enable CAN clock
pub type TWAI_CLK_EN_R = crate::BitReader;
///Field `TWAI_CLK_EN` writer - Set 1 to enable CAN clock
pub type TWAI_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM1_CLK_EN` reader - Set 1 to enable PWM1 clock
pub type PWM1_CLK_EN_R = crate::BitReader;
///Field `PWM1_CLK_EN` writer - Set 1 to enable PWM1 clock
pub type PWM1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2S1_CLK_EN` reader - Set 1 to enable I2S1 clock
pub type I2S1_CLK_EN_R = crate::BitReader;
///Field `I2S1_CLK_EN` writer - Set 1 to enable I2S1 clock
pub type I2S1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI2_DMA_CLK_EN` reader - Set 1 to enable SPI2_DMA clock
pub type SPI2_DMA_CLK_EN_R = crate::BitReader;
///Field `SPI2_DMA_CLK_EN` writer - Set 1 to enable SPI2_DMA clock
pub type SPI2_DMA_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USB_CLK_EN` reader - Set 1 to enable USB clock
pub type USB_CLK_EN_R = crate::BitReader;
///Field `USB_CLK_EN` writer - Set 1 to enable USB clock
...
///Field `PWM2_CLK_EN` reader - Set 1 to enable PWM2 clock
pub type PWM2_CLK_EN_R = crate::BitReader;
///Field `PWM2_CLK_EN` writer - Set 1 to enable PWM2 clock
pub type PWM2_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM3_CLK_EN` reader - Set 1 to enable PWM3 clock
pub type PWM3_CLK_EN_R = crate::BitReader;
///Field `PWM3_CLK_EN` writer - Set 1 to enable PWM3 clock
pub type PWM3_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI3_DMA_CLK_EN` reader - Set 1 to enable SPI4 clock
pub type SPI3_DMA_CLK_EN_R = crate::BitReader;
///Field `SPI3_DMA_CLK_EN` writer - Set 1 to enable SPI4 clock
...
///Field `SPI4_CLK_EN` reader - Set 1 to enable SPI4 clock
pub type SPI4_CLK_EN_R = crate::BitReader;
///Field `SPI4_CLK_EN` writer - Set 1 to enable SPI4 clock
