    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PVT_ERR_NVT_SITE3")
            .field(
                ...
                &self.comb_timing_err_cnt_nvt_site3(),
            )
            .finish()
    }
}
#[doc = "******* Description ***********\n\nYou can [`read`](crate::Reg::read) this register and get [`comb_pvt_err_nvt_site3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
