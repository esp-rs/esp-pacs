...
#[doc = "Field `COMB_TIMING_ERR_CNT_NVT_SITE1` reader - ******* Description ***********"]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PVT_ERR_NVT_SITE1")
            .field(
                ...
                &format_args!("{}", self.comb_timing_err_cnt_nvt_site1().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<COMB_PVT_ERR_NVT_SITE1_SPEC> {
