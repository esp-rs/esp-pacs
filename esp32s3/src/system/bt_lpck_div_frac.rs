...
///Field `BT_LPCK_DIV_B` reader - This field is lower power clock frequent division factor b
pub type BT_LPCK_DIV_B_R = crate::FieldReader<u16>;
///Field `BT_LPCK_DIV_B` writer - This field is lower power clock frequent division factor b
pub type BT_LPCK_DIV_B_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `BT_LPCK_DIV_A` reader - This field is lower power clock frequent division factor a
pub type BT_LPCK_DIV_A_R = crate::FieldReader<u16>;
///Field `BT_LPCK_DIV_A` writer - This field is lower power clock frequent division factor a
pub type BT_LPCK_DIV_A_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `LPCLK_SEL_RTC_SLOW` reader - Set 1 to select rtc-slow clock as rtc low power clock
pub type LPCLK_SEL_RTC_SLOW_R = crate::BitReader;
///Field `LPCLK_SEL_RTC_SLOW` writer - Set 1 to select rtc-slow clock as rtc low power clock
pub type LPCLK_SEL_RTC_SLOW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPCLK_SEL_8M` reader - Set 1 to select 8m clock as rtc low power clock
pub type LPCLK_SEL_8M_R = crate::BitReader;
///Field `LPCLK_SEL_8M` writer - Set 1 to select 8m clock as rtc low power clock
pub type LPCLK_SEL_8M_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPCLK_SEL_XTAL` reader - Set 1 to select xtal clock as rtc low power clock
pub type LPCLK_SEL_XTAL_R = crate::BitReader;
///Field `LPCLK_SEL_XTAL` writer - Set 1 to select xtal clock as rtc low power clock
pub type LPCLK_SEL_XTAL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPCLK_SEL_XTAL32K` reader - Set 1 to select xtal32k clock as low power clock
pub type LPCLK_SEL_XTAL32K_R = crate::BitReader;
///Field `LPCLK_SEL_XTAL32K` writer - Set 1 to select xtal32k clock as low power clock
pub type LPCLK_SEL_XTAL32K_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LPCLK_RTC_EN` reader - Set 1 to enable RTC low power clock
pub type LPCLK_RTC_EN_R = crate::BitReader;
///Field `LPCLK_RTC_EN` writer - Set 1 to enable RTC low power clock
