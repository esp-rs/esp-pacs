...
#[doc = "Field `COMB_TIMING_ERR_CNT_HVT_SITE3` reader - ******* Description ***********"]
...
#[doc = "******* Description ***********\n\nYou can [`read`](crate::Reg::read) this register and get [`comb_pvt_err_hvt_site3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
