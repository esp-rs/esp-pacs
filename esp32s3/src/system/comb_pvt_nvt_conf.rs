...
///Field `COMB_PATH_LEN_NVT` reader - ******* Description ***********
pub type COMB_PATH_LEN_NVT_R = crate::FieldReader;
///Field `COMB_PATH_LEN_NVT` writer - ******* Description ***********
pub type COMB_PATH_LEN_NVT_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `COMB_ERR_CNT_CLR_NVT` writer - ******* Description ***********
pub type COMB_ERR_CNT_CLR_NVT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `COMB_PVT_MONITOR_EN_NVT` reader - ******* Description ***********
pub type COMB_PVT_MONITOR_EN_NVT_R = crate::BitReader;
///Field `COMB_PVT_MONITOR_EN_NVT` writer - ******* Description ***********
