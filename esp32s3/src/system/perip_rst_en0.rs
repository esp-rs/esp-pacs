...
///Field `TIMERS_RST` reader - Set 1 to let TIMERS reset
pub type TIMERS_RST_R = crate::BitReader;
///Field `TIMERS_RST` writer - Set 1 to let TIMERS reset
pub type TIMERS_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI01_RST` reader - Set 1 to let SPI01 reset
pub type SPI01_RST_R = crate::BitReader;
///Field `SPI01_RST` writer - Set 1 to let SPI01 reset
pub type SPI01_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART_RST` reader - Set 1 to let UART reset
pub type UART_RST_R = crate::BitReader;
///Field `UART_RST` writer - Set 1 to let UART reset
pub type UART_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WDG_RST` reader - Set 1 to let WDG reset
pub type WDG_RST_R = crate::BitReader;
///Field `WDG_RST` writer - Set 1 to let WDG reset
pub type WDG_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2S0_RST` reader - Set 1 to let I2S0 reset
pub type I2S0_RST_R = crate::BitReader;
///Field `I2S0_RST` writer - Set 1 to let I2S0 reset
pub type I2S0_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART1_RST` reader - Set 1 to let UART1 reset
pub type UART1_RST_R = crate::BitReader;
///Field `UART1_RST` writer - Set 1 to let UART1 reset
pub type UART1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI2_RST` reader - Set 1 to let SPI2 reset
pub type SPI2_RST_R = crate::BitReader;
///Field `SPI2_RST` writer - Set 1 to let SPI2 reset
pub type SPI2_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C_EXT0_RST` reader - Set 1 to let I2C_EXT0 reset
pub type I2C_EXT0_RST_R = crate::BitReader;
///Field `I2C_EXT0_RST` writer - Set 1 to let I2C_EXT0 reset
pub type I2C_EXT0_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UHCI0_RST` reader - Set 1 to let UHCI0 reset
pub type UHCI0_RST_R = crate::BitReader;
///Field `UHCI0_RST` writer - Set 1 to let UHCI0 reset
pub type UHCI0_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RMT_RST` reader - Set 1 to let RMT reset
pub type RMT_RST_R = crate::BitReader;
///Field `RMT_RST` writer - Set 1 to let RMT reset
pub type RMT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PCNT_RST` reader - Set 1 to let PCNT reset
pub type PCNT_RST_R = crate::BitReader;
///Field `PCNT_RST` writer - Set 1 to let PCNT reset
pub type PCNT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LEDC_RST` reader - Set 1 to let LEDC reset
pub type LEDC_RST_R = crate::BitReader;
///Field `LEDC_RST` writer - Set 1 to let LEDC reset
pub type LEDC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UHCI1_RST` reader - Set 1 to let UHCI1 reset
pub type UHCI1_RST_R = crate::BitReader;
///Field `UHCI1_RST` writer - Set 1 to let UHCI1 reset
pub type UHCI1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMERGROUP_RST` reader - Set 1 to let TIMERGROUP reset
pub type TIMERGROUP_RST_R = crate::BitReader;
///Field `TIMERGROUP_RST` writer - Set 1 to let TIMERGROUP reset
pub type TIMERGROUP_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `EFUSE_RST` reader - Set 1 to let EFUSE reset
pub type EFUSE_RST_R = crate::BitReader;
///Field `EFUSE_RST` writer - Set 1 to let EFUSE reset
pub type EFUSE_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMERGROUP1_RST` reader - Set 1 to let TIMERGROUP1 reset
pub type TIMERGROUP1_RST_R = crate::BitReader;
///Field `TIMERGROUP1_RST` writer - Set 1 to let TIMERGROUP1 reset
pub type TIMERGROUP1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI3_RST` reader - Set 1 to let SPI3 reset
pub type SPI3_RST_R = crate::BitReader;
///Field `SPI3_RST` writer - Set 1 to let SPI3 reset
pub type SPI3_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM0_RST` reader - Set 1 to let PWM0 reset
pub type PWM0_RST_R = crate::BitReader;
///Field `PWM0_RST` writer - Set 1 to let PWM0 reset
pub type PWM0_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C_EXT1_RST` reader - Set 1 to let I2C_EXT1 reset
pub type I2C_EXT1_RST_R = crate::BitReader;
///Field `I2C_EXT1_RST` writer - Set 1 to let I2C_EXT1 reset
pub type I2C_EXT1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TWAI_RST` reader - Set 1 to let CAN reset
pub type TWAI_RST_R = crate::BitReader;
///Field `TWAI_RST` writer - Set 1 to let CAN reset
pub type TWAI_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM1_RST` reader - Set 1 to let PWM1 reset
pub type PWM1_RST_R = crate::BitReader;
///Field `PWM1_RST` writer - Set 1 to let PWM1 reset
pub type PWM1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2S1_RST` reader - Set 1 to let I2S1 reset
pub type I2S1_RST_R = crate::BitReader;
///Field `I2S1_RST` writer - Set 1 to let I2S1 reset
pub type I2S1_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI2_DMA_RST` reader - Set 1 to let SPI2 reset
pub type SPI2_DMA_RST_R = crate::BitReader;
///Field `SPI2_DMA_RST` writer - Set 1 to let SPI2 reset
pub type SPI2_DMA_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USB_RST` reader - Set 1 to let USB reset
pub type USB_RST_R = crate::BitReader;
///Field `USB_RST` writer - Set 1 to let USB reset
pub type USB_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `UART_MEM_RST` reader - Set 1 to let UART_MEM reset
pub type UART_MEM_RST_R = crate::BitReader;
///Field `UART_MEM_RST` writer - Set 1 to let UART_MEM reset
pub type UART_MEM_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM2_RST` reader - Set 1 to let PWM2 reset
pub type PWM2_RST_R = crate::BitReader;
///Field `PWM2_RST` writer - Set 1 to let PWM2 reset
pub type PWM2_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PWM3_RST` reader - Set 1 to let PWM3 reset
pub type PWM3_RST_R = crate::BitReader;
///Field `PWM3_RST` writer - Set 1 to let PWM3 reset
pub type PWM3_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI3_DMA_RST` reader - Set 1 to let SPI3 reset
pub type SPI3_DMA_RST_R = crate::BitReader;
///Field `SPI3_DMA_RST` writer - Set 1 to let SPI3 reset
pub type SPI3_DMA_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `APB_SARADC_RST` reader - Set 1 to let APB_SARADC reset
pub type APB_SARADC_RST_R = crate::BitReader;
///Field `APB_SARADC_RST` writer - Set 1 to let APB_SARADC reset
pub type APB_SARADC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SYSTIMER_RST` reader - Set 1 to let SYSTIMER reset
pub type SYSTIMER_RST_R = crate::BitReader;
///Field `SYSTIMER_RST` writer - Set 1 to let SYSTIMER reset
pub type SYSTIMER_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC2_ARB_RST` reader - Set 1 to let ADC2_ARB reset
pub type ADC2_ARB_RST_R = crate::BitReader;
///Field `ADC2_ARB_RST` writer - Set 1 to let ADC2_ARB reset
pub type ADC2_ARB_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SPI4_RST` reader - Set 1 to let SPI4 reset
pub type SPI4_RST_R = crate::BitReader;
///Field `SPI4_RST` writer - Set 1 to let SPI4 reset
