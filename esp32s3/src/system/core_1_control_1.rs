///Register `CORE_1_CONTROL_1` reader
pub type R = crate::R<CORE_1_CONTROL_1_SPEC>;
///Register `CORE_1_CONTROL_1` writer
pub type W = crate::W<CORE_1_CONTROL_1_SPEC>;
///Field `CONTROL_CORE_1_MESSAGE` reader - it's only a R/W register, no function, software can write any value
pub type CONTROL_CORE_1_MESSAGE_R = crate::FieldReader<u32>;
///Field `CONTROL_CORE_1_MESSAGE` writer - it's only a R/W register, no function, software can write any value
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_CONTROL_1")
            .field("control_core_1_message", &self.control_core_1_message())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_1_control_1::R`](R) reader structure
impl crate::Readable for CORE_1_CONTROL_1_SPEC {}
///`write(|w| ..)` method takes [`core_1_control_1::W`](W) writer structure
