...
///Field `LSLP_MEM_PD_MASK` reader - Set 1 to mask memory power down.
pub type LSLP_MEM_PD_MASK_R = crate::BitReader;
///Field `LSLP_MEM_PD_MASK` writer - Set 1 to mask memory power down.
pub type LSLP_MEM_PD_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to mask memory power down.
    #[inline(always)]
