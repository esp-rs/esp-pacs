...
pub struct R(crate::R<COMB_PVT_ERR_LVT_SITE2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<COMB_PVT_ERR_LVT_SITE2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<COMB_PVT_ERR_LVT_SITE2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<COMB_PVT_ERR_LVT_SITE2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `COMB_TIMING_ERR_CNT_LVT_SITE2` reader - ******* Description ***********"]
pub type COMB_TIMING_ERR_CNT_LVT_SITE2_R = crate::FieldReader<u16, u16>;
impl R {
...
#[doc = "******* Description ***********\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [comb_pvt_err_lvt_site2](index.html) module"]
