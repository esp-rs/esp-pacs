...
pub type CLK_OUT1_W<'a, const O: u8> = crate::FieldWriter<'a, PIN_CTRL_SPEC, 4, O>;
...
pub type CLK_OUT2_W<'a, const O: u8> = crate::FieldWriter<'a, PIN_CTRL_SPEC, 4, O>;
...
pub type CLK_OUT3_W<'a, const O: u8> = crate::FieldWriter<'a, PIN_CTRL_SPEC, 4, O>;
impl R {
