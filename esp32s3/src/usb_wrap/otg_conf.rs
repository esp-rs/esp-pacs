...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OTG_CONF")
            .field("srp_sessend_override", &self.srp_sessend_override().bit())
            .field("srp_sessend_value", &self.srp_sessend_value().bit())
            .field("phy_sel", &self.phy_sel().bit())
            .field("dfifo_force_pd", &self.dfifo_force_pd().bit())
            .field("dbnce_fltr_bypass", &self.dbnce_fltr_bypass().bit())
            ...
            .field("ahb_clk_force_on", &self.ahb_clk_force_on().bit())
            .field("phy_clk_force_on", &self.phy_clk_force_on().bit())
            .field("phy_tx_edge_sel", &self.phy_tx_edge_sel().bit())
            .field("dfifo_force_pu", &self.dfifo_force_pu().bit())
