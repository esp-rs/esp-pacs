...
#[doc = "Field `DUTY_CHNG_END_CH6` reader - The interrupt enable bit for the LEDC_DUTY_CHNG_END_CH6_INT interrupt."]
pub type DUTY_CHNG_END_CH6_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_CH6` writer - The interrupt enable bit for the LEDC_DUTY_CHNG_END_CH6_INT interrupt."]
pub type DUTY_CHNG_END_CH6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DUTY_CHNG_END_CH7` reader - The interrupt enable bit for the LEDC_DUTY_CHNG_END_CH7_INT interrupt."]
pub type DUTY_CHNG_END_CH7_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_CH7` writer - The interrupt enable bit for the LEDC_DUTY_CHNG_END_CH7_INT interrupt."]
...
#[doc = "Field `OVF_CNT_CH6` reader - The interrupt enable bit for the LEDC_OVF_CNT_CH6_INT interrupt."]
pub type OVF_CNT_CH6_R = crate::BitReader;
#[doc = "Field `OVF_CNT_CH6` writer - The interrupt enable bit for the LEDC_OVF_CNT_CH6_INT interrupt."]
pub type OVF_CNT_CH6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OVF_CNT_CH7` reader - The interrupt enable bit for the LEDC_OVF_CNT_CH7_INT interrupt."]
pub type OVF_CNT_CH7_R = crate::BitReader;
#[doc = "Field `OVF_CNT_CH7` writer - The interrupt enable bit for the LEDC_OVF_CNT_CH7_INT interrupt."]
