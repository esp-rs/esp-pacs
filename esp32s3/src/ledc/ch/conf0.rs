...
///Field `OVF_CNT_RESET_ST` writer - This is the status bit of LEDC_OVF_CNT_RESET_CH%s.
pub type OVF_CNT_RESET_ST_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_reset_st(&mut self) -> OVF_CNT_RESET_ST_W<CONF0_SPEC> {
        OVF_CNT_RESET_ST_W::new(self, 17)
    }
}
