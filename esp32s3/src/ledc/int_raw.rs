...
pub type TIMER0_OVF_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_CH6_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_CH7_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OVF_CNT_CH6_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OVF_CNT_CH7_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer0_ovf_int_raw(&mut self) -> TIMER0_OVF_INT_RAW_W<INT_RAW_SPEC, 0> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_ch6_int_raw(&mut self) -> DUTY_CHNG_END_CH6_INT_RAW_W<INT_RAW_SPEC, 10> {
        DUTY_CHNG_END_CH6_INT_RAW_W::new(self)
    }
    #[doc = "Bit 11 - Interrupt raw bit for channel 7. Triggered when the gradual change of duty has finished."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_ch7_int_raw(&mut self) -> DUTY_CHNG_END_CH7_INT_RAW_W<INT_RAW_SPEC, 11> {
        DUTY_CHNG_END_CH7_INT_RAW_W::new(self)
    }
    #[doc = "Bit 12 - Interrupt raw bit for channel 0. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH0."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch0_int_raw(&mut self) -> OVF_CNT_CH0_INT_RAW_W<INT_RAW_SPEC, 12> {
        OVF_CNT_CH0_INT_RAW_W::new(self)
    }
    #[doc = "Bit 13 - Interrupt raw bit for channel 1. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH1."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch1_int_raw(&mut self) -> OVF_CNT_CH1_INT_RAW_W<INT_RAW_SPEC, 13> {
        OVF_CNT_CH1_INT_RAW_W::new(self)
    }
    #[doc = "Bit 14 - Interrupt raw bit for channel 2. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH2."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch2_int_raw(&mut self) -> OVF_CNT_CH2_INT_RAW_W<INT_RAW_SPEC, 14> {
        OVF_CNT_CH2_INT_RAW_W::new(self)
    }
    #[doc = "Bit 15 - Interrupt raw bit for channel 3. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH3."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch3_int_raw(&mut self) -> OVF_CNT_CH3_INT_RAW_W<INT_RAW_SPEC, 15> {
        OVF_CNT_CH3_INT_RAW_W::new(self)
    }
    #[doc = "Bit 16 - Interrupt raw bit for channel 4. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH4."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch4_int_raw(&mut self) -> OVF_CNT_CH4_INT_RAW_W<INT_RAW_SPEC, 16> {
        OVF_CNT_CH4_INT_RAW_W::new(self)
    }
    #[doc = "Bit 17 - Interrupt raw bit for channel 5. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH5."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch5_int_raw(&mut self) -> OVF_CNT_CH5_INT_RAW_W<INT_RAW_SPEC, 17> {
        OVF_CNT_CH5_INT_RAW_W::new(self)
    }
    #[doc = "Bit 18 - Interrupt raw bit for channel 6. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH6."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch6_int_raw(&mut self) -> OVF_CNT_CH6_INT_RAW_W<INT_RAW_SPEC, 18> {
        OVF_CNT_CH6_INT_RAW_W::new(self)
    }
    #[doc = "Bit 19 - Interrupt raw bit for channel 7. Triggered when the ovf_cnt has reached the value specified by LEDC_OVF_NUM_CH7."]
    #[inline(always)]
    #[must_use]
    pub fn ovf_cnt_ch7_int_raw(&mut self) -> OVF_CNT_CH7_INT_RAW_W<INT_RAW_SPEC, 19> {
