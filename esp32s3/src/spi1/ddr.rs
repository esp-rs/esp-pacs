...
///Field `SPI_FMEM_VAR_DUMMY` reader - Set the bit to enable variable dummy cycle in DDRmode.
pub type SPI_FMEM_VAR_DUMMY_R = crate::BitReader;
///Field `SPI_FMEM_VAR_DUMMY` writer - Set the bit to enable variable dummy cycle in DDRmode.
...
///Field `SPI_FMEM_DDR_WDAT_SWP` reader - Set the bit to reorder TX data of the word in DDR mode.
pub type SPI_FMEM_DDR_WDAT_SWP_R = crate::BitReader;
///Field `SPI_FMEM_DDR_WDAT_SWP` writer - Set the bit to reorder TX data of the word in DDR mode.
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_fmem_hyperbus_mode(&mut self) -> SPI_FMEM_HYPERBUS_MODE_W<DDR_SPEC> {
