...
///Register `EXT_ADDR` writer
pub type W = crate::W<EXT_ADDR_SPEC>;
///Field `EXT_ADDR` reader - The register are the higher 32bits in the 64 bits address mode.
pub type EXT_ADDR_R = crate::FieldReader<u32>;
///Field `EXT_ADDR` writer - The register are the higher 32bits in the 64 bits address mode.
...
///`read()` method returns [`ext_addr::R`](R) reader structure
impl crate::Readable for EXT_ADDR_SPEC {}
///`write(|w| ..)` method takes [`ext_addr::W`](W) writer structure
