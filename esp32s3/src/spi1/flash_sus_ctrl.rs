...
///Field `FLASH_PES_EN` reader - Set this bit to enable auto-suspend function.
pub type FLASH_PES_EN_R = crate::BitReader;
///Field `FLASH_PES_EN` writer - Set this bit to enable auto-suspend function.
pub type FLASH_PES_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FLASH_PER_COMMAND` reader - Program/Erase resume command value.
pub type FLASH_PER_COMMAND_R = crate::FieldReader;
///Field `FLASH_PER_COMMAND` writer - Program/Erase resume command value.
pub type FLASH_PER_COMMAND_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `FLASH_PES_COMMAND` reader - Program/Erase suspend command value.
pub type FLASH_PES_COMMAND_R = crate::FieldReader;
///Field `FLASH_PES_COMMAND` writer - Program/Erase suspend command value.
