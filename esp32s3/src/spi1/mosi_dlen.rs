...
///Field `USR_MOSI_DBITLEN` reader - The length in bits of DOUT phase. The register value shall be (bit_num-1).
pub type USR_MOSI_DBITLEN_R = crate::FieldReader<u16>;
///Field `USR_MOSI_DBITLEN` writer - The length in bits of DOUT phase. The register value shall be (bit_num-1).
pub type USR_MOSI_DBITLEN_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    ///Bits 0:9 - The length in bits of DOUT phase. The register value shall be (bit_num-1).
    #[inline(always)]
