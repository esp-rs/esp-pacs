...
pub type FLASH_PER_W<'a, const O: u8> = crate::BitWriter<'a, u32, FLASH_SUS_CMD_SPEC, bool, O>;
...
pub type FLASH_PES_W<'a, const O: u8> = crate::BitWriter<'a, u32, FLASH_SUS_CMD_SPEC, bool, O>;
...
pub type FLASH_PER_WAIT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FLASH_SUS_CMD_SPEC, bool, O>;
...
pub type PES_PER_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, FLASH_SUS_CMD_SPEC, bool, O>;
...
pub type PESR_IDLE_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, FLASH_SUS_CMD_SPEC, bool, O>;
impl R {
