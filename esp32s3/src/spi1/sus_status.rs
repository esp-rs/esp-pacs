...
///Field `FLASH_SUS` reader - The status of flash suspend. This bit is set when PES command is sent, and cleared when PER is sent. Only used in SPI1.
pub type FLASH_SUS_R = crate::BitReader;
///Field `FLASH_SUS` writer - The status of flash suspend. This bit is set when PES command is sent, and cleared when PER is sent. Only used in SPI1.
pub type FLASH_SUS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FLASH_HPM_DLY_256` reader - 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after HPM command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after HPM command is sent.
pub type FLASH_HPM_DLY_256_R = crate::BitReader;
///Field `FLASH_HPM_DLY_256` writer - 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after HPM command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after HPM command is sent.
pub type FLASH_HPM_DLY_256_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FLASH_RES_DLY_256` reader - 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after RES command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after RES command is sent.
pub type FLASH_RES_DLY_256_R = crate::BitReader;
///Field `FLASH_RES_DLY_256` writer - 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after RES command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after RES command is sent.
pub type FLASH_RES_DLY_256_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FLASH_DP_DLY_256` reader - 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after DP command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after DP command is sent.
pub type FLASH_DP_DLY_256_R = crate::BitReader;
///Field `FLASH_DP_DLY_256` writer - 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after DP command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after DP command is sent.
pub type FLASH_DP_DLY_256_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FLASH_PER_DLY_256` reader - Valid when SPI_MEM_FLASH_PER_WAIT_EN is 1. 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after PER command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after PER command is sent.
pub type FLASH_PER_DLY_256_R = crate::BitReader;
///Field `FLASH_PER_DLY_256` writer - Valid when SPI_MEM_FLASH_PER_WAIT_EN is 1. 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after PER command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after PER command is sent.
pub type FLASH_PER_DLY_256_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FLASH_PES_DLY_256` reader - Valid when SPI_MEM_FLASH_PES_WAIT_EN is 1. 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after PES command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after PES command is sent.
pub type FLASH_PES_DLY_256_R = crate::BitReader;
///Field `FLASH_PES_DLY_256` writer - Valid when SPI_MEM_FLASH_PES_WAIT_EN is 1. 1: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 256) SPI_CLK cycles after PES command is sent. 0: SPI1 waits (SPI_MEM_CS_HOLD_DELAY_RES\[9:0\] * 4) SPI_CLK cycles after PES command is sent.
