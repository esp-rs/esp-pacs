...
pub type SARADC_SAR2_PATT_TAB4_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 24, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc_sar2_patt_tab4(&mut self) -> SARADC_SAR2_PATT_TAB4_W<SAR2_PATT_TAB4_SPEC, 0> {
