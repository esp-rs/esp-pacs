...
///Field `SAR2_PATT_TAB4` reader - Item 12 ~ 15 for pattern table 2 (each item 6bit)
pub type SAR2_PATT_TAB4_R = crate::FieldReader<u32>;
///Field `SAR2_PATT_TAB4` writer - Item 12 ~ 15 for pattern table 2 (each item 6bit)
pub type SAR2_PATT_TAB4_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    ///Bits 0:23 - Item 12 ~ 15 for pattern table 2 (each item 6bit)
    #[inline(always)]
