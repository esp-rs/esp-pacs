...
#[doc = "Field `SARADC_SAR2_PATT_TAB4` reader - Item 12 ~ 15 for pattern table 2 (each item 6bit)"]
pub type SARADC_SAR2_PATT_TAB4_R = crate::FieldReader<u32>;
#[doc = "Field `SARADC_SAR2_PATT_TAB4` writer - Item 12 ~ 15 for pattern table 2 (each item 6bit)"]
pub type SARADC_SAR2_PATT_TAB4_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc_sar2_patt_tab4(&mut self) -> SARADC_SAR2_PATT_TAB4_W<SAR2_PATT_TAB4_SPEC> {
        SARADC_SAR2_PATT_TAB4_W::new(self, 0)
    }
