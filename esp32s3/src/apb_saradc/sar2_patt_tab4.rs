...
#[doc = "Field `SAR2_PATT_TAB4` reader - Item 12 ~ 15 for pattern table 2 (each item 6bit)"]
pub type SAR2_PATT_TAB4_R = crate::FieldReader<u32>;
#[doc = "Field `SAR2_PATT_TAB4` writer - Item 12 ~ 15 for pattern table 2 (each item 6bit)"]
...
impl W {
    #[doc = "Bits 0:23 - Item 12 ~ 15 for pattern table 2 (each item 6bit)"]
    #[inline(always)]
    pub fn sar2_patt_tab4(&mut self) -> SAR2_PATT_TAB4_W<'_, SAR2_PATT_TAB4_SPEC> {
