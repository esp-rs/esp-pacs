...
///Field `SAR2_PATT_TAB2` reader - Item 4 ~ 7 for pattern table 2 (each item 6bit)
pub type SAR2_PATT_TAB2_R = crate::FieldReader<u32>;
///Field `SAR2_PATT_TAB2` writer - Item 4 ~ 7 for pattern table 2 (each item 6bit)
pub type SAR2_PATT_TAB2_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    ///Bits 0:23 - Item 4 ~ 7 for pattern table 2 (each item 6bit)
    #[inline(always)]
