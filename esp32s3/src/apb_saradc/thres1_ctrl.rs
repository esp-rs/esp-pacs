...
///Field `THRES1_CHANNEL` reader - configure which channel thres0 monitor
pub type THRES1_CHANNEL_R = crate::FieldReader;
///Field `THRES1_CHANNEL` writer - configure which channel thres0 monitor
pub type THRES1_CHANNEL_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `THRES1_HIGH` reader - thres1 monitor high thres
pub type THRES1_HIGH_R = crate::FieldReader<u16>;
///Field `THRES1_HIGH` writer - thres1 monitor high thres
pub type THRES1_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `THRES1_LOW` reader - thres1 monitor low thres
pub type THRES1_LOW_R = crate::FieldReader<u16>;
///Field `THRES1_LOW` writer - thres1 monitor low thres
