...
///Field `SAR1_PATT_TAB1` reader - item 0 ~ 3 for pattern table 1 (each item 6bit)
pub type SAR1_PATT_TAB1_R = crate::FieldReader<u32>;
///Field `SAR1_PATT_TAB1` writer - item 0 ~ 3 for pattern table 1 (each item 6bit)
pub type SAR1_PATT_TAB1_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    ///Bits 0:23 - item 0 ~ 3 for pattern table 1 (each item 6bit)
    #[inline(always)]
