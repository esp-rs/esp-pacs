...
pub type SARADC_SAR1_PATT_TAB1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 24, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc_sar1_patt_tab1(&mut self) -> SARADC_SAR1_PATT_TAB1_W<SAR1_PATT_TAB1_SPEC, 0> {
