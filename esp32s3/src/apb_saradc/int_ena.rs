...
///Field `THRES1_LOW` reader - interrupt of thres1 low
pub type THRES1_LOW_R = crate::BitReader;
///Field `THRES1_LOW` writer - interrupt of thres1 low
pub type THRES1_LOW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES0_LOW` reader - interrupt of thres0 low
pub type THRES0_LOW_R = crate::BitReader;
///Field `THRES0_LOW` writer - interrupt of thres0 low
pub type THRES0_LOW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES1_HIGH` reader - interrupt of thres1 high
pub type THRES1_HIGH_R = crate::BitReader;
///Field `THRES1_HIGH` writer - interrupt of thres1 high
pub type THRES1_HIGH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES0_HIGH` reader - interrupt of thres0 high
pub type THRES0_HIGH_R = crate::BitReader;
///Field `THRES0_HIGH` writer - interrupt of thres0 high
pub type THRES0_HIGH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC2_DONE` reader - interrupt of sar2 done
pub type ADC2_DONE_R = crate::BitReader;
///Field `ADC2_DONE` writer - interrupt of sar2 done
pub type ADC2_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC1_DONE` reader - interrupt of sar1 done
pub type ADC1_DONE_R = crate::BitReader;
///Field `ADC1_DONE` writer - interrupt of sar1 done
