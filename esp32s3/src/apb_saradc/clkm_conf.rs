...
///Field `CLKM_DIV_NUM` reader - Integral clock divider value
pub type CLKM_DIV_NUM_R = crate::FieldReader;
///Field `CLKM_DIV_NUM` writer - Integral clock divider value
...
///Field `CLK_EN` reader - no public
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - no public
