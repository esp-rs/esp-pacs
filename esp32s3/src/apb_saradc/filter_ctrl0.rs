...
pub type FILTER_CHANNEL1_W<'a, const O: u8> = crate::FieldWriter<'a, FILTER_CTRL0_SPEC, 5, O>;
...
pub type FILTER_CHANNEL0_W<'a, const O: u8> = crate::FieldWriter<'a, FILTER_CTRL0_SPEC, 5, O>;
