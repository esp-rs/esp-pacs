...
pub type SARADC_TIMER_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc_timer_sel(&mut self) -> SARADC_TIMER_SEL_W<CTRL2_SPEC, 11> {
        SARADC_TIMER_SEL_W::new(self)
    }
    #[doc = "Bits 12:23 - to set saradc timer target"]
    #[inline(always)]
    #[must_use]
