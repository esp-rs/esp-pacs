...
#[doc = "Field `SAR2_PATT_TAB1` reader - item 0 ~ 3 for pattern table 2 (each item 6bit)"]
pub type SAR2_PATT_TAB1_R = crate::FieldReader<u32>;
#[doc = "Field `SAR2_PATT_TAB1` writer - item 0 ~ 3 for pattern table 2 (each item 6bit)"]
...
impl W {
    #[doc = "Bits 0:23 - item 0 ~ 3 for pattern table 2 (each item 6bit)"]
    #[inline(always)]
    pub fn sar2_patt_tab1(&mut self) -> SAR2_PATT_TAB1_W<'_, SAR2_PATT_TAB1_SPEC> {
