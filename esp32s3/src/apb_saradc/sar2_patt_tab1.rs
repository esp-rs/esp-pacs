...
pub type SARADC_SAR2_PATT_TAB1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 24, O, u32>;
impl R {
    #[doc = "Bits 0:23 - item 0 ~ 3 for pattern table 2 (each item 6bit)"]
    #[inline(always)]
    pub fn saradc_sar2_patt_tab1(&self) -> SARADC_SAR2_PATT_TAB1_R {
        SARADC_SAR2_PATT_TAB1_R::new(self.bits & 0x00ff_ffff)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc_sar2_patt_tab1(&mut self) -> SARADC_SAR2_PATT_TAB1_W<SAR2_PATT_TAB1_SPEC, 0> {
