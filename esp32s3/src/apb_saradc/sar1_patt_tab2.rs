...
#[doc = "Field `SARADC_SAR1_PATT_TAB2` reader - Item 4 ~ 7 for pattern table 1 (each item 6bit)"]
pub type SARADC_SAR1_PATT_TAB2_R = crate::FieldReader<u32>;
#[doc = "Field `SARADC_SAR1_PATT_TAB2` writer - Item 4 ~ 7 for pattern table 1 (each item 6bit)"]
pub type SARADC_SAR1_PATT_TAB2_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    #[doc = "Bits 0:23 - Item 4 ~ 7 for pattern table 1 (each item 6bit)"]
    #[inline(always)]
    pub fn saradc_sar1_patt_tab2(&self) -> SARADC_SAR1_PATT_TAB2_R {
        SARADC_SAR1_PATT_TAB2_R::new(self.bits & 0x00ff_ffff)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc_sar1_patt_tab2(&mut self) -> SARADC_SAR1_PATT_TAB2_W<SAR1_PATT_TAB2_SPEC> {
        SARADC_SAR1_PATT_TAB2_W::new(self, 0)
    }
