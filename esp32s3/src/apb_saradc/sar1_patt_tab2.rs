...
#[doc = "Field `SAR1_PATT_TAB2` reader - Item 4 ~ 7 for pattern table 1 (each item 6bit)"]
pub type SAR1_PATT_TAB2_R = crate::FieldReader<u32>;
#[doc = "Field `SAR1_PATT_TAB2` writer - Item 4 ~ 7 for pattern table 1 (each item 6bit)"]
...
impl W {
    #[doc = "Bits 0:23 - Item 4 ~ 7 for pattern table 1 (each item 6bit)"]
    #[inline(always)]
    pub fn sar1_patt_tab2(&mut self) -> SAR1_PATT_TAB2_W<'_, SAR1_PATT_TAB2_SPEC> {
