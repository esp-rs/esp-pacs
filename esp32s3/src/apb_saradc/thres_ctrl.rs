...
///Field `THRES_ALL_EN` reader - enable thres0 to monitor all channel
pub type THRES_ALL_EN_R = crate::BitReader;
///Field `THRES_ALL_EN` writer - enable thres0 to monitor all channel
pub type THRES_ALL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES3_EN` reader - no public
pub type THRES3_EN_R = crate::BitReader;
///Field `THRES3_EN` writer - no public
pub type THRES3_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES2_EN` reader - no public
pub type THRES2_EN_R = crate::BitReader;
///Field `THRES2_EN` writer - no public
