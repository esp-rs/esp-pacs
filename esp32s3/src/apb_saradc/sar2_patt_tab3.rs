...
///Field `SAR2_PATT_TAB3` reader - Item 8 ~ 11 for pattern table 2 (each item 6bit)
pub type SAR2_PATT_TAB3_R = crate::FieldReader<u32>;
///Field `SAR2_PATT_TAB3` writer - Item 8 ~ 11 for pattern table 2 (each item 6bit)
pub type SAR2_PATT_TAB3_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    ///Bits 0:23 - Item 8 ~ 11 for pattern table 2 (each item 6bit)
    #[inline(always)]
