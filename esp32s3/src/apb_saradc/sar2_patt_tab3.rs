...
#[doc = "Field `SAR2_PATT_TAB3` reader - Item 8 ~ 11 for pattern table 2 (each item 6bit)"]
pub type SAR2_PATT_TAB3_R = crate::FieldReader<u32>;
#[doc = "Field `SAR2_PATT_TAB3` writer - Item 8 ~ 11 for pattern table 2 (each item 6bit)"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR2_PATT_TAB3")
            .field("sar2_patt_tab3", &self.sar2_patt_tab3().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
