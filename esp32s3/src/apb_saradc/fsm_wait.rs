...
#[doc = "Field `XPD_WAIT` reader - the cycle which saradc controller in xpd state"]
pub type XPD_WAIT_R = crate::FieldReader;
#[doc = "Field `XPD_WAIT` writer - the cycle which saradc controller in xpd state"]
pub type XPD_WAIT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `RSTB_WAIT` reader - the cycle which saradc controller in rst state"]
pub type RSTB_WAIT_R = crate::FieldReader;
#[doc = "Field `RSTB_WAIT` writer - the cycle which saradc controller in rst state"]
pub type RSTB_WAIT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `STANDBY_WAIT` reader - the cycle which saradc controller in standby state"]
pub type STANDBY_WAIT_R = crate::FieldReader;
#[doc = "Field `STANDBY_WAIT` writer - the cycle which saradc controller in standby state"]
