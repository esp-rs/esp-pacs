...
///Field `START_FORCE` reader - enable start saradc by sw
pub type START_FORCE_R = crate::BitReader;
///Field `START_FORCE` writer - enable start saradc by sw
pub type START_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `START` reader - start saradc by sw
...
///Field `SAR_CLK_GATED` reader - enable SAR CLK gate when saradc idle
pub type SAR_CLK_GATED_R = crate::BitReader;
///Field `SAR_CLK_GATED` writer - enable SAR CLK gate when saradc idle
