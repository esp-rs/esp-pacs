///Register `APB_SARADC1_DATA_STATUS` reader
pub type R = crate::R<APB_SARADC1_DATA_STATUS_SPEC>;
///Field `SARADC1_DATA` reader - apbsaradc sample data
...
///`read()` method returns [`apb_saradc1_data_status::R`](R) reader structure
