...
pub type SARADC_SAR1_PATT_TAB3_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc_sar1_patt_tab3(&mut self) -> SARADC_SAR1_PATT_TAB3_W<SAR1_PATT_TAB3_SPEC> {
        SARADC_SAR1_PATT_TAB3_W::new(self, 0)
    }
