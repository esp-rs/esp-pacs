///Register `LC_DMA_INT_RAW` reader
pub type R = crate::R<LC_DMA_INT_RAW_SPEC>;
///Field `LCD_VSYNC_INT_RAW` reader - The raw bit for LCD_CAM_LCD_VSYNC_INT interrupt.
pub type LCD_VSYNC_INT_RAW_R = crate::BitReader;
///Field `LCD_TRANS_DONE_INT_RAW` reader - The raw bit for LCD_CAM_LCD_TRANS_DONE_INT interrupt.
pub type LCD_TRANS_DONE_INT_RAW_R = crate::BitReader;
///Field `CAM_VSYNC_INT_RAW` reader - The raw bit for LCD_CAM_CAM_VSYNC_INT interrupt.
pub type CAM_VSYNC_INT_RAW_R = crate::BitReader;
///Field `CAM_HS_INT_RAW` reader - The raw bit for LCD_CAM_CAM_HS_INT interrupt.
pub type CAM_HS_INT_RAW_R = crate::BitReader;
impl R {
    ///Bit 0 - The raw bit for LCD_CAM_LCD_VSYNC_INT interrupt.
    #[inline(always)]
    pub fn lcd_vsync_int_raw(&self) -> LCD_VSYNC_INT_RAW_R {
        LCD_VSYNC_INT_RAW_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The raw bit for LCD_CAM_LCD_TRANS_DONE_INT interrupt.
    #[inline(always)]
    pub fn lcd_trans_done_int_raw(&self) -> LCD_TRANS_DONE_INT_RAW_R {
        LCD_TRANS_DONE_INT_RAW_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - The raw bit for LCD_CAM_CAM_VSYNC_INT interrupt.
    #[inline(always)]
    pub fn cam_vsync_int_raw(&self) -> CAM_VSYNC_INT_RAW_R {
        CAM_VSYNC_INT_RAW_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - The raw bit for LCD_CAM_CAM_HS_INT interrupt.
    #[inline(always)]
...
///`read()` method returns [`lc_dma_int_raw::R`](R) reader structure
