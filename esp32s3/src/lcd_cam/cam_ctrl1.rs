...
///Field `CAM_REC_DATA_BYTELEN` reader - Configure camera received data byte length. When the length of received data reaches this value + 1, GDMA in_suc_eof_int is triggered.
pub type CAM_REC_DATA_BYTELEN_R = crate::FieldReader<u16>;
///Field `CAM_REC_DATA_BYTELEN` writer - Configure camera received data byte length. When the length of received data reaches this value + 1, GDMA in_suc_eof_int is triggered.
pub type CAM_REC_DATA_BYTELEN_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `CAM_LINE_INT_NUM` reader - Configure line number. When the number of received lines reaches this value + 1, LCD_CAM_CAM_HS_INT is triggered.
pub type CAM_LINE_INT_NUM_R = crate::FieldReader;
///Field `CAM_LINE_INT_NUM` writer - Configure line number. When the number of received lines reaches this value + 1, LCD_CAM_CAM_HS_INT is triggered.
pub type CAM_LINE_INT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `CAM_CLK_INV` reader - 1: Invert the input signal CAM_PCLK. 0: Do not invert.
pub type CAM_CLK_INV_R = crate::BitReader;
///Field `CAM_CLK_INV` writer - 1: Invert the input signal CAM_PCLK. 0: Do not invert.
...
///Field `CAM_2BYTE_EN` reader - 1: The width of input data is 16 bits. 0: The width of input data is 8 bits.
pub type CAM_2BYTE_EN_R = crate::BitReader;
///Field `CAM_2BYTE_EN` writer - 1: The width of input data is 16 bits. 0: The width of input data is 8 bits.
...
///Field `CAM_VH_DE_MODE_EN` reader - 1: Input control signals are CAM_DE and CAM_HSYNC. CAM_VSYNC is 1. 0: Input control signals are CAM_DE and CAM_VSYNC. CAM_HSYNC and CAM_DE are all 1 at the the same time.
pub type CAM_VH_DE_MODE_EN_R = crate::BitReader;
///Field `CAM_VH_DE_MODE_EN` writer - 1: Input control signals are CAM_DE and CAM_HSYNC. CAM_VSYNC is 1. 0: Input control signals are CAM_DE and CAM_VSYNC. CAM_HSYNC and CAM_DE are all 1 at the the same time.
...
///Field `CAM_AFIFO_RESET` writer - Camera Async Rx FIFO reset signal.
pub type CAM_AFIFO_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:15 - Configure camera received data byte length. When the length of received data reaches this value + 1, GDMA in_suc_eof_int is triggered.
    #[inline(always)]
    pub fn cam_rec_data_bytelen(&self) -> CAM_REC_DATA_BYTELEN_R {
        CAM_REC_DATA_BYTELEN_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:21 - Configure line number. When the number of received lines reaches this value + 1, LCD_CAM_CAM_HS_INT is triggered.
    #[inline(always)]
    pub fn cam_line_int_num(&self) -> CAM_LINE_INT_NUM_R {
        CAM_LINE_INT_NUM_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
    ///Bit 22 - 1: Invert the input signal CAM_PCLK. 0: Do not invert.
    #[inline(always)]
    ...
    ///Bit 24 - 1: The width of input data is 16 bits. 0: The width of input data is 8 bits.
    #[inline(always)]
    ...
    ///Bit 28 - 1: Input control signals are CAM_DE and CAM_HSYNC. CAM_VSYNC is 1. 0: Input control signals are CAM_DE and CAM_VSYNC. CAM_HSYNC and CAM_DE are all 1 at the the same time.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 31 - Camera Async Rx FIFO reset signal.
    #[inline(always)]
    #[must_use]
