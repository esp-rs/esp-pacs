...
///Field `LCD_VSYNC_WIDTH` reader - It is the width of LCD_VSYNC active pulse in a line.
pub type LCD_VSYNC_WIDTH_R = crate::FieldReader;
///Field `LCD_VSYNC_WIDTH` writer - It is the width of LCD_VSYNC active pulse in a line.
...
///Field `LCD_HS_BLANK_EN` reader - 1: The pulse of LCD_HSYNC is out in vertical blanking lines in RGB mode. 0: LCD_HSYNC pulse is valid only in active region lines in RGB mode.
pub type LCD_HS_BLANK_EN_R = crate::BitReader;
///Field `LCD_HS_BLANK_EN` writer - 1: The pulse of LCD_HSYNC is out in vertical blanking lines in RGB mode. 0: LCD_HSYNC pulse is valid only in active region lines in RGB mode.
pub type LCD_HS_BLANK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_HSYNC_WIDTH` reader - It is the width of LCD_HSYNC active pulse in a line.
pub type LCD_HSYNC_WIDTH_R = crate::FieldReader;
///Field `LCD_HSYNC_WIDTH` writer - It is the width of LCD_HSYNC active pulse in a line.
...
impl R {
    ///Bits 0:6 - It is the width of LCD_VSYNC active pulse in a line.
    #[inline(always)]
    ...
    ///Bit 9 - 1: The pulse of LCD_HSYNC is out in vertical blanking lines in RGB mode. 0: LCD_HSYNC pulse is valid only in active region lines in RGB mode.
    #[inline(always)]
    pub fn lcd_hs_blank_en(&self) -> LCD_HS_BLANK_EN_R {
        LCD_HS_BLANK_EN_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bits 16:22 - It is the width of LCD_HSYNC active pulse in a line.
    #[inline(always)]
