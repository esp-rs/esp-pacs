///Register `LC_DMA_INT_CLR` writer
pub type W = crate::W<LC_DMA_INT_CLR_SPEC>;
///Field `LCD_VSYNC_INT_CLR` writer - The clear bit for LCD_CAM_LCD_VSYNC_INT interrupt.
pub type LCD_VSYNC_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_TRANS_DONE_INT_CLR` writer - The clear bit for LCD_CAM_LCD_TRANS_DONE_INT interrupt.
pub type LCD_TRANS_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_VSYNC_INT_CLR` writer - The clear bit for LCD_CAM_CAM_VSYNC_INT interrupt.
pub type CAM_VSYNC_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_HS_INT_CLR` writer - The clear bit for LCD_CAM_CAM_HS_INT interrupt.
...
impl W {
    ...
    ///Bit 3 - The clear bit for LCD_CAM_CAM_HS_INT interrupt.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`lc_dma_int_clr::W`](W) writer structure
