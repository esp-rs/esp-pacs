///Register `LCD_RGB_YUV` reader
pub type R = crate::R<LCD_RGB_YUV_SPEC>;
///Register `LCD_RGB_YUV` writer
pub type W = crate::W<LCD_RGB_YUV_SPEC>;
///Field `LCD_CONV_8BITS_DATA_INV` reader - Swap every two 8-bit input data. 1: Enabled. 0: Disabled.
pub type LCD_CONV_8BITS_DATA_INV_R = crate::BitReader;
///Field `LCD_CONV_8BITS_DATA_INV` writer - Swap every two 8-bit input data. 1: Enabled. 0: Disabled.
pub type LCD_CONV_8BITS_DATA_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_CONV_YUV2YUV_MODE` reader - In YUV-to-YUV mode, 0: data is converted to YUV422 format. 1: data is converted to YUV420 format. 2: data is converted to YUV411 format. 3: disabled. To enable YUV-to-YUV mode, LCD_CAM_LCD_CONV_TRANS_MODE must be set to 1.
pub type LCD_CONV_YUV2YUV_MODE_R = crate::FieldReader;
///Field `LCD_CONV_YUV2YUV_MODE` writer - In YUV-to-YUV mode, 0: data is converted to YUV422 format. 1: data is converted to YUV420 format. 2: data is converted to YUV411 format. 3: disabled. To enable YUV-to-YUV mode, LCD_CAM_LCD_CONV_TRANS_MODE must be set to 1.
pub type LCD_CONV_YUV2YUV_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `LCD_CONV_YUV_MODE` reader - In YUV-to-YUV mode and YUV-to-RGB mode, LCD_CAM_LCD_CONV_YUV_MODE decides the YUV mode of input data. 0: input data is in YUV422 format. 1: input data is in YUV420 format. 2: input data is in YUV411 format. In RGB-to-YUV mode, 0: data is converted to YUV422 format. 1: data is converted to YUV420 format. 2: data is converted to YUV411 format.
pub type LCD_CONV_YUV_MODE_R = crate::FieldReader;
///Field `LCD_CONV_YUV_MODE` writer - In YUV-to-YUV mode and YUV-to-RGB mode, LCD_CAM_LCD_CONV_YUV_MODE decides the YUV mode of input data. 0: input data is in YUV422 format. 1: input data is in YUV420 format. 2: input data is in YUV411 format. In RGB-to-YUV mode, 0: data is converted to YUV422 format. 1: data is converted to YUV420 format. 2: data is converted to YUV411 format.
pub type LCD_CONV_YUV_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `LCD_CONV_PROTOCOL_MODE` reader - 0: BT601. 1: BT709.
pub type LCD_CONV_PROTOCOL_MODE_R = crate::BitReader;
///Field `LCD_CONV_PROTOCOL_MODE` writer - 0: BT601. 1: BT709.
pub type LCD_CONV_PROTOCOL_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_CONV_DATA_OUT_MODE` reader - Configure color range for output data. 0: limited color range. 1: full color range.
pub type LCD_CONV_DATA_OUT_MODE_R = crate::BitReader;
///Field `LCD_CONV_DATA_OUT_MODE` writer - Configure color range for output data. 0: limited color range. 1: full color range.
pub type LCD_CONV_DATA_OUT_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_CONV_DATA_IN_MODE` reader - Configure color range for input data. 0: limited color range. 1: full color range.
pub type LCD_CONV_DATA_IN_MODE_R = crate::BitReader;
///Field `LCD_CONV_DATA_IN_MODE` writer - Configure color range for input data. 0: limited color range. 1: full color range.
pub type LCD_CONV_DATA_IN_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_CONV_MODE_8BITS_ON` reader - 0: 16-bit mode. 1: 8-bit mode.
pub type LCD_CONV_MODE_8BITS_ON_R = crate::BitReader;
///Field `LCD_CONV_MODE_8BITS_ON` writer - 0: 16-bit mode. 1: 8-bit mode.
pub type LCD_CONV_MODE_8BITS_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_CONV_TRANS_MODE` reader - 0: converted to RGB format. 1: converted to YUV format.
pub type LCD_CONV_TRANS_MODE_R = crate::BitReader;
///Field `LCD_CONV_TRANS_MODE` writer - 0: converted to RGB format. 1: converted to YUV format.
pub type LCD_CONV_TRANS_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_CONV_BYPASS` reader - 0: Bypass converter. 1: Enable converter.
pub type LCD_CONV_BYPASS_R = crate::BitReader;
///Field `LCD_CONV_BYPASS` writer - 0: Bypass converter. 1: Enable converter.
pub type LCD_CONV_BYPASS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 20 - Swap every two 8-bit input data. 1: Enabled. 0: Disabled.
    #[inline(always)]
    pub fn lcd_conv_8bits_data_inv(&self) -> LCD_CONV_8BITS_DATA_INV_R {
        LCD_CONV_8BITS_DATA_INV_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bits 22:23 - In YUV-to-YUV mode, 0: data is converted to YUV422 format. 1: data is converted to YUV420 format. 2: data is converted to YUV411 format. 3: disabled. To enable YUV-to-YUV mode, LCD_CAM_LCD_CONV_TRANS_MODE must be set to 1.
    #[inline(always)]
    pub fn lcd_conv_yuv2yuv_mode(&self) -> LCD_CONV_YUV2YUV_MODE_R {
        LCD_CONV_YUV2YUV_MODE_R::new(((self.bits >> 22) & 3) as u8)
    }
    ///Bits 24:25 - In YUV-to-YUV mode and YUV-to-RGB mode, LCD_CAM_LCD_CONV_YUV_MODE decides the YUV mode of input data. 0: input data is in YUV422 format. 1: input data is in YUV420 format. 2: input data is in YUV411 format. In RGB-to-YUV mode, 0: data is converted to YUV422 format. 1: data is converted to YUV420 format. 2: data is converted to YUV411 format.
    #[inline(always)]
...
///`read()` method returns [`lcd_rgb_yuv::R`](R) reader structure
impl crate::Readable for LCD_RGB_YUV_SPEC {}
///`write(|w| ..)` method takes [`lcd_rgb_yuv::W`](W) writer structure
