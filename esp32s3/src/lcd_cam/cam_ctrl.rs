...
///Field `CAM_STOP_EN` reader - Camera stop enable signal, 1: camera stops when GDMA Rx FIFO is full. 0: Do not stop.
pub type CAM_STOP_EN_R = crate::BitReader;
///Field `CAM_STOP_EN` writer - Camera stop enable signal, 1: camera stops when GDMA Rx FIFO is full. 0: Do not stop.
...
///Field `CAM_UPDATE` reader - 1: Update camera registers. This bit is cleared by hardware. 0: Do not care.
pub type CAM_UPDATE_R = crate::BitReader;
///Field `CAM_UPDATE` writer - 1: Update camera registers. This bit is cleared by hardware. 0: Do not care.
pub type CAM_UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_BYTE_ORDER` reader - 1: Invert data byte order, only valid in 16-bit mode. 0: Do not change.
pub type CAM_BYTE_ORDER_R = crate::BitReader;
///Field `CAM_BYTE_ORDER` writer - 1: Invert data byte order, only valid in 16-bit mode. 0: Do not change.
pub type CAM_BYTE_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_BIT_ORDER` reader - 1: Change data bit order, change CAM_DATA_in\[7:0\] to CAM_DATA_in\[0:7\] in 8-bit mode, and bits\[15:0\] to bits\[0:15\] in 16-bit mode. 0: Do not change.
pub type CAM_BIT_ORDER_R = crate::BitReader;
///Field `CAM_BIT_ORDER` writer - 1: Change data bit order, change CAM_DATA_in\[7:0\] to CAM_DATA_in\[0:7\] in 8-bit mode, and bits\[15:0\] to bits\[0:15\] in 16-bit mode. 0: Do not change.
pub type CAM_BIT_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_LINE_INT_EN` reader - 1: Enable to generate LCD_CAM_CAM_HS_INT. 0: Disable.
pub type CAM_LINE_INT_EN_R = crate::BitReader;
///Field `CAM_LINE_INT_EN` writer - 1: Enable to generate LCD_CAM_CAM_HS_INT. 0: Disable.
pub type CAM_LINE_INT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_VS_EOF_EN` reader - 1: Enable CAM_VSYNC to generate in_suc_eof. 0: in_suc_eof is controlled by LCD_CAM_CAM_REC_DATA_BYTELEN.
pub type CAM_VS_EOF_EN_R = crate::BitReader;
///Field `CAM_VS_EOF_EN` writer - 1: Enable CAM_VSYNC to generate in_suc_eof. 0: in_suc_eof is controlled by LCD_CAM_CAM_REC_DATA_BYTELEN.
...
///Field `CAM_CLK_SEL` reader - Select camera module source clock. 0: Clock source is disabled. 1: XTAL_CLK. 2: PLL_D2_CLK. 3: PLL_F160M_CLK.
pub type CAM_CLK_SEL_R = crate::FieldReader;
///Field `CAM_CLK_SEL` writer - Select camera module source clock. 0: Clock source is disabled. 1: XTAL_CLK. 2: PLL_D2_CLK. 3: PLL_F160M_CLK.
pub type CAM_CLK_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bit 0 - Camera stop enable signal, 1: camera stops when GDMA Rx FIFO is full. 0: Do not stop.
    #[inline(always)]
    ...
    ///Bit 4 - 1: Update camera registers. This bit is cleared by hardware. 0: Do not care.
    #[inline(always)]
    pub fn cam_update(&self) -> CAM_UPDATE_R {
        CAM_UPDATE_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - 1: Invert data byte order, only valid in 16-bit mode. 0: Do not change.
    #[inline(always)]
    pub fn cam_byte_order(&self) -> CAM_BYTE_ORDER_R {
        CAM_BYTE_ORDER_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - 1: Change data bit order, change CAM_DATA_in\[7:0\] to CAM_DATA_in\[0:7\] in 8-bit mode, and bits\[15:0\] to bits\[0:15\] in 16-bit mode. 0: Do not change.
    #[inline(always)]
    pub fn cam_bit_order(&self) -> CAM_BIT_ORDER_R {
        CAM_BIT_ORDER_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - 1: Enable to generate LCD_CAM_CAM_HS_INT. 0: Disable.
    #[inline(always)]
    pub fn cam_line_int_en(&self) -> CAM_LINE_INT_EN_R {
        CAM_LINE_INT_EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - 1: Enable CAM_VSYNC to generate in_suc_eof. 0: in_suc_eof is controlled by LCD_CAM_CAM_REC_DATA_BYTELEN.
    #[inline(always)]
    ...
    ///Bits 29:30 - Select camera module source clock. 0: Clock source is disabled. 1: XTAL_CLK. 2: PLL_D2_CLK. 3: PLL_F160M_CLK.
    #[inline(always)]
...
///`read()` method returns [`cam_ctrl::R`](R) reader structure
impl crate::Readable for CAM_CTRL_SPEC {}
///`write(|w| ..)` method takes [`cam_ctrl::W`](W) writer structure
