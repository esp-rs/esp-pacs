...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CAM_CTRL")
            .field("cam_stop_en", &self.cam_stop_en().bit())
            .field(
                "cam_vsync_filter_thres",
                &self.cam_vsync_filter_thres().bits(),
            )
            .field("cam_update", &self.cam_update().bit())
            .field("cam_byte_order", &self.cam_byte_order().bit())
            .field("cam_bit_order", &self.cam_bit_order().bit())
            .field("cam_line_int_en", &self.cam_line_int_en().bit())
            .field("cam_vs_eof_en", &self.cam_vs_eof_en().bit())
            .field("cam_clkm_div_num", &self.cam_clkm_div_num().bits())
            .field("cam_clkm_div_b", &self.cam_clkm_div_b().bits())
            .field("cam_clkm_div_a", &self.cam_clkm_div_a().bits())
            .field("cam_clk_sel", &self.cam_clk_sel().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
