///Register `LCD_CMD_VAL` reader
pub type R = crate::R<LCD_CMD_VAL_SPEC>;
///Register `LCD_CMD_VAL` writer
pub type W = crate::W<LCD_CMD_VAL_SPEC>;
///Field `LCD_CMD_VALUE` reader - The LCD write command value.
pub type LCD_CMD_VALUE_R = crate::FieldReader<u32>;
///Field `LCD_CMD_VALUE` writer - The LCD write command value.
pub type LCD_CMD_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - The LCD write command value.
    #[inline(always)]
...
///`read()` method returns [`lcd_cmd_val::R`](R) reader structure
impl crate::Readable for LCD_CMD_VAL_SPEC {}
///`write(|w| ..)` method takes [`lcd_cmd_val::W`](W) writer structure
