...
///Field `LCD_VB_FRONT` reader - It is the vertical blank front porch of a frame.
pub type LCD_VB_FRONT_R = crate::FieldReader;
///Field `LCD_VB_FRONT` writer - It is the vertical blank front porch of a frame.
pub type LCD_VB_FRONT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `LCD_HA_WIDTH` reader - It is the horizontal active width of a frame.
pub type LCD_HA_WIDTH_R = crate::FieldReader<u16>;
///Field `LCD_HA_WIDTH` writer - It is the horizontal active width of a frame.
pub type LCD_HA_WIDTH_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `LCD_HT_WIDTH` reader - It is the horizontal total width of a frame.
pub type LCD_HT_WIDTH_R = crate::FieldReader<u16>;
///Field `LCD_HT_WIDTH` writer - It is the horizontal total width of a frame.
...
///`read()` method returns [`lcd_ctrl1::R`](R) reader structure
impl crate::Readable for LCD_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`lcd_ctrl1::W`](W) writer structure
