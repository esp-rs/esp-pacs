...
///Field `LCD_VSYNC_INT_ENA` reader - The enable bit for LCD_CAM_LCD_VSYNC_INT interrupt.
pub type LCD_VSYNC_INT_ENA_R = crate::BitReader;
///Field `LCD_VSYNC_INT_ENA` writer - The enable bit for LCD_CAM_LCD_VSYNC_INT interrupt.
pub type LCD_VSYNC_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_TRANS_DONE_INT_ENA` reader - The enable bit for LCD_CAM_LCD_TRANS_DONE_INT interrupt.
pub type LCD_TRANS_DONE_INT_ENA_R = crate::BitReader;
///Field `LCD_TRANS_DONE_INT_ENA` writer - The enable bit for LCD_CAM_LCD_TRANS_DONE_INT interrupt.
pub type LCD_TRANS_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_VSYNC_INT_ENA` reader - The enable bit for LCD_CAM_CAM_VSYNC_INT interrupt.
pub type CAM_VSYNC_INT_ENA_R = crate::BitReader;
///Field `CAM_VSYNC_INT_ENA` writer - The enable bit for LCD_CAM_CAM_VSYNC_INT interrupt.
pub type CAM_VSYNC_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAM_HS_INT_ENA` reader - The enable bit for LCD_CAM_CAM_HS_INT interrupt.
pub type CAM_HS_INT_ENA_R = crate::BitReader;
///Field `CAM_HS_INT_ENA` writer - The enable bit for LCD_CAM_CAM_HS_INT interrupt.
