...
pub type LCD_AFIFO_THRESHOLD_NUM_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type LCD_VFK_CYCLELEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
pub type LCD_VBK_CYCLELEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 13, O, u16>;
...
pub type LCD_NEXT_FRAME_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LCD_BK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `LCD_AFIFO_RESET` writer - LCD AFIFO reset signal."]
pub type LCD_AFIFO_RESET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LCD_CD_DATA_SET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LCD_CD_DUMMY_SET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LCD_CD_CMD_SET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LCD_CD_IDLE_EDGE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lcd_afifo_threshold_num(&mut self) -> LCD_AFIFO_THRESHOLD_NUM_W<LCD_MISC_SPEC, 1> {
        LCD_AFIFO_THRESHOLD_NUM_W::new(self)
    }
    #[doc = "Bits 6:11 - The setup cycle length minus 1 in LCD non-RGB mode."]
    #[inline(always)]
    #[must_use]
    pub fn lcd_vfk_cyclelen(&mut self) -> LCD_VFK_CYCLELEN_W<LCD_MISC_SPEC, 6> {
        LCD_VFK_CYCLELEN_W::new(self)
    }
    #[doc = "Bits 12:24 - The vertical back blank region cycle length minus 1 in LCD RGB mode, or the hold time cycle length in LCD non-RGB mode."]
    #[inline(always)]
    #[must_use]
    pub fn lcd_vbk_cyclelen(&mut self) -> LCD_VBK_CYCLELEN_W<LCD_MISC_SPEC, 12> {
        LCD_VBK_CYCLELEN_W::new(self)
    }
    #[doc = "Bit 25 - 1: Send the next frame data when the current frame is sent out. 0: LCD stops when the current frame is sent out."]
    #[inline(always)]
    #[must_use]
    pub fn lcd_next_frame_en(&mut self) -> LCD_NEXT_FRAME_EN_W<LCD_MISC_SPEC, 25> {
        LCD_NEXT_FRAME_EN_W::new(self)
    }
    #[doc = "Bit 26 - 1: Enable blank region when LCD sends data out. 0: No blank region."]
    #[inline(always)]
    #[must_use]
    pub fn lcd_bk_en(&mut self) -> LCD_BK_EN_W<LCD_MISC_SPEC, 26> {
        LCD_BK_EN_W::new(self)
    }
    #[doc = "Bit 27 - LCD AFIFO reset signal."]
    #[inline(always)]
    #[must_use]
    pub fn lcd_afifo_reset(&mut self) -> LCD_AFIFO_RESET_W<LCD_MISC_SPEC, 27> {
        LCD_AFIFO_RESET_W::new(self)
    }
    #[doc = "Bit 28 - 1: LCD_CD = !reg_cd_idle_edge when lcd_st\\[2:0\\] is in LCD_DOUT state. 0: LCD_CD = reg_cd_idle_edge."]
    #[inline(always)]
    #[must_use]
    pub fn lcd_cd_data_set(&mut self) -> LCD_CD_DATA_SET_W<LCD_MISC_SPEC, 28> {
        LCD_CD_DATA_SET_W::new(self)
    }
    #[doc = "Bit 29 - 1: LCD_CD = !reg_cd_idle_edge when lcd_st\\[2:0\\] is in LCD_DUMMY state. 0: LCD_CD = reg_cd_idle_edge."]
    #[inline(always)]
    #[must_use]
    pub fn lcd_cd_dummy_set(&mut self) -> LCD_CD_DUMMY_SET_W<LCD_MISC_SPEC, 29> {
        LCD_CD_DUMMY_SET_W::new(self)
    }
    #[doc = "Bit 30 - 1: LCD_CD = !reg_cd_idle_edge when lcd_st\\[2:0\\] is in LCD_CMD state. 0: LCD_CD = reg_cd_idle_edge."]
    #[inline(always)]
    #[must_use]
    pub fn lcd_cd_cmd_set(&mut self) -> LCD_CD_CMD_SET_W<LCD_MISC_SPEC, 30> {
        LCD_CD_CMD_SET_W::new(self)
    }
    #[doc = "Bit 31 - The default value of LCD_CD."]
    #[inline(always)]
    #[must_use]
    pub fn lcd_cd_idle_edge(&mut self) -> LCD_CD_IDLE_EDGE_W<LCD_MISC_SPEC, 31> {
