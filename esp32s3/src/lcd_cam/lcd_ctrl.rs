...
#[doc = "Field `LCD_RGB_MODE_EN` reader - 1: Enable RGB mode, and input VSYNC, HSYNC, and DE signals. 0: Disable."]
pub type LCD_RGB_MODE_EN_R = crate::BitReader;
#[doc = "Field `LCD_RGB_MODE_EN` writer - 1: Enable RGB mode, and input VSYNC, HSYNC, and DE signals. 0: Disable."]
...
impl R {
    ...
    #[doc = "Bit 31 - 1: Enable RGB mode, and input VSYNC, HSYNC, and DE signals. 0: Disable."]
    #[inline(always)]
