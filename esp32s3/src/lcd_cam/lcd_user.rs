///Register `LCD_USER` reader
pub type R = crate::R<LCD_USER_SPEC>;
///Register `LCD_USER` writer
pub type W = crate::W<LCD_USER_SPEC>;
///Field `LCD_DOUT_CYCLELEN` reader - Configure the cycles for DOUT phase of LCD module. The cycles = this value + 1.
pub type LCD_DOUT_CYCLELEN_R = crate::FieldReader<u16>;
///Field `LCD_DOUT_CYCLELEN` writer - Configure the cycles for DOUT phase of LCD module. The cycles = this value + 1.
pub type LCD_DOUT_CYCLELEN_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
///Field `LCD_ALWAYS_OUT_EN` reader - LCD continues outputting data when LCD is in DOUT phase, till LCD_CAM_LCD_START is cleared or LCD_CAM_LCD_RESET is set.
pub type LCD_ALWAYS_OUT_EN_R = crate::BitReader;
///Field `LCD_ALWAYS_OUT_EN` writer - LCD continues outputting data when LCD is in DOUT phase, till LCD_CAM_LCD_START is cleared or LCD_CAM_LCD_RESET is set.
pub type LCD_ALWAYS_OUT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_8BITS_ORDER` reader - 1: Swap every two data bytes, valid in 8-bit mode. 0: Do not swap.
pub type LCD_8BITS_ORDER_R = crate::BitReader;
///Field `LCD_8BITS_ORDER` writer - 1: Swap every two data bytes, valid in 8-bit mode. 0: Do not swap.
pub type LCD_8BITS_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_UPDATE` reader - 1: Update LCD registers. This bit is cleared by hardware. 0: Do not care.
pub type LCD_UPDATE_R = crate::BitReader;
///Field `LCD_UPDATE` writer - 1: Update LCD registers. This bit is cleared by hardware. 0: Do not care.
pub type LCD_UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_BIT_ORDER` reader - 1: Change data bit order. Change LCD_DATA_out\[7:0\] to LCD_DATA_out\[0:7\] in 8-bit mode, and bits\[15:0\] to bits\[0:15\] in 16-bit mode. 0: Do not change.
pub type LCD_BIT_ORDER_R = crate::BitReader;
///Field `LCD_BIT_ORDER` writer - 1: Change data bit order. Change LCD_DATA_out\[7:0\] to LCD_DATA_out\[0:7\] in 8-bit mode, and bits\[15:0\] to bits\[0:15\] in 16-bit mode. 0: Do not change.
pub type LCD_BIT_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_BYTE_ORDER` reader - 1: Invert data byte order, only valid in 16-bit mode. 0: Do not invert.
pub type LCD_BYTE_ORDER_R = crate::BitReader;
///Field `LCD_BYTE_ORDER` writer - 1: Invert data byte order, only valid in 16-bit mode. 0: Do not invert.
pub type LCD_BYTE_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_2BYTE_EN` reader - 1: The width of output LCD data is 16 bits. 0: The width of output LCD data is 8 bits.
pub type LCD_2BYTE_EN_R = crate::BitReader;
///Field `LCD_2BYTE_EN` writer - 1: The width of output LCD data is 16 bits. 0: The width of output LCD data is 8 bits.
pub type LCD_2BYTE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_DOUT` reader - 1: Be able to send data out in LCD sequence when LCD starts. 0: Disable.
pub type LCD_DOUT_R = crate::BitReader;
///Field `LCD_DOUT` writer - 1: Be able to send data out in LCD sequence when LCD starts. 0: Disable.
pub type LCD_DOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_DUMMY` reader - 1: Enable DUMMY phase in LCD sequence when LCD starts. 0: Disable.
pub type LCD_DUMMY_R = crate::BitReader;
///Field `LCD_DUMMY` writer - 1: Enable DUMMY phase in LCD sequence when LCD starts. 0: Disable.
pub type LCD_DUMMY_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_CMD` reader - 1: Be able to send command in LCD sequence when LCD starts. 0: Disable.
pub type LCD_CMD_R = crate::BitReader;
///Field `LCD_CMD` writer - 1: Be able to send command in LCD sequence when LCD starts. 0: Disable.
pub type LCD_CMD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_START` reader - LCD starts sending data enable signal, valid in high level.
pub type LCD_START_R = crate::BitReader;
///Field `LCD_START` writer - LCD starts sending data enable signal, valid in high level.
pub type LCD_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_RESET` writer - Reset LCD module.
pub type LCD_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LCD_DUMMY_CYCLELEN` reader - Configure DUMMY cycles. DUMMY cycles = this value + 1.
pub type LCD_DUMMY_CYCLELEN_R = crate::FieldReader;
///Field `LCD_DUMMY_CYCLELEN` writer - Configure DUMMY cycles. DUMMY cycles = this value + 1.
pub type LCD_DUMMY_CYCLELEN_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `LCD_CMD_2_CYCLE_EN` reader - The cycle length of command phase. 1: 2 cycles. 0: 1 cycle.
pub type LCD_CMD_2_CYCLE_EN_R = crate::BitReader;
///Field `LCD_CMD_2_CYCLE_EN` writer - The cycle length of command phase. 1: 2 cycles. 0: 1 cycle.
pub type LCD_CMD_2_CYCLE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:12 - Configure the cycles for DOUT phase of LCD module. The cycles = this value + 1.
    #[inline(always)]
    pub fn lcd_dout_cyclelen(&self) -> LCD_DOUT_CYCLELEN_R {
        LCD_DOUT_CYCLELEN_R::new((self.bits & 0x1fff) as u16)
    }
    ///Bit 13 - LCD continues outputting data when LCD is in DOUT phase, till LCD_CAM_LCD_START is cleared or LCD_CAM_LCD_RESET is set.
    #[inline(always)]
    pub fn lcd_always_out_en(&self) -> LCD_ALWAYS_OUT_EN_R {
        LCD_ALWAYS_OUT_EN_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bit 19 - 1: Swap every two data bytes, valid in 8-bit mode. 0: Do not swap.
    #[inline(always)]
    pub fn lcd_8bits_order(&self) -> LCD_8BITS_ORDER_R {
        LCD_8BITS_ORDER_R::new(((self.bits >> 19) & 1) != 0)
    }
    ///Bit 20 - 1: Update LCD registers. This bit is cleared by hardware. 0: Do not care.
    #[inline(always)]
    pub fn lcd_update(&self) -> LCD_UPDATE_R {
        LCD_UPDATE_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 21 - 1: Change data bit order. Change LCD_DATA_out\[7:0\] to LCD_DATA_out\[0:7\] in 8-bit mode, and bits\[15:0\] to bits\[0:15\] in 16-bit mode. 0: Do not change.
    #[inline(always)]
    pub fn lcd_bit_order(&self) -> LCD_BIT_ORDER_R {
        LCD_BIT_ORDER_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Bit 22 - 1: Invert data byte order, only valid in 16-bit mode. 0: Do not invert.
    #[inline(always)]
    pub fn lcd_byte_order(&self) -> LCD_BYTE_ORDER_R {
        LCD_BYTE_ORDER_R::new(((self.bits >> 22) & 1) != 0)
    }
    ///Bit 23 - 1: The width of output LCD data is 16 bits. 0: The width of output LCD data is 8 bits.
    #[inline(always)]
    ...
    ///Bit 27 - LCD starts sending data enable signal, valid in high level.
    #[inline(always)]
    pub fn lcd_start(&self) -> LCD_START_R {
        LCD_START_R::new(((self.bits >> 27) & 1) != 0)
    }
    ///Bits 29:30 - Configure DUMMY cycles. DUMMY cycles = this value + 1.
    #[inline(always)]
...
///`read()` method returns [`lcd_user::R`](R) reader structure
impl crate::Readable for LCD_USER_SPEC {}
///`write(|w| ..)` method takes [`lcd_user::W`](W) writer structure
