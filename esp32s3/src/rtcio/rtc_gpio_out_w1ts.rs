...
pub type RTC_GPIO_OUT_DATA_W1TS_W<'a> =
    crate::FieldWriter<'a, u32, RTC_GPIO_OUT_W1TS_SPEC, u32, u32, 22, 10>;
impl W {
    #[doc = "Bits 10:31 - RTC GPIO 0 ~ 21 output data write 1 to set"]
    #[inline(always)]
    pub fn rtc_gpio_out_data_w1ts(&mut self) -> RTC_GPIO_OUT_DATA_W1TS_W {
        RTC_GPIO_OUT_DATA_W1TS_W::new(self)
    }
