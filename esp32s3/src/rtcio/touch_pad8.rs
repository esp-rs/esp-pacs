...
pub type FUN_IE_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, 13>;
...
pub type SLP_OE_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, 14>;
...
pub type SLP_IE_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, 15>;
...
pub type SLP_SEL_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, 16>;
#[doc = "Field `FUN_SEL` reader - function sel"]
pub type FUN_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FUN_SEL` writer - function sel"]
pub type FUN_SEL_W<'a> = crate::FieldWriter<'a, u32, TOUCH_PAD8_SPEC, u8, u8, 2, 17>;
...
pub type MUX_SEL_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, 19>;
...
pub type RUE_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, 27>;
#[doc = "Field `RDE` reader - RDE"]
pub type RDE_R = crate::BitReader<bool>;
#[doc = "Field `RDE` writer - RDE"]
pub type RDE_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD8_SPEC, bool, 28>;
#[doc = "Field `DRV` reader - DRV"]
pub type DRV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DRV` writer - DRV"]
pub type DRV_W<'a> = crate::FieldWriter<'a, u32, TOUCH_PAD8_SPEC, u8, u8, 2, 29>;
impl R {
