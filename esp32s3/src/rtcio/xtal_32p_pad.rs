...
pub type X32P_FUN_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, XTAL_32P_PAD_SPEC, bool, O>;
...
pub type X32P_SLP_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, XTAL_32P_PAD_SPEC, bool, O>;
...
pub type X32P_SLP_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, XTAL_32P_PAD_SPEC, bool, O>;
...
pub type X32P_SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, XTAL_32P_PAD_SPEC, bool, O>;
...
pub type X32P_FUN_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, XTAL_32P_PAD_SPEC, u8, u8, 2, O>;
...
pub type X32P_MUX_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, XTAL_32P_PAD_SPEC, bool, O>;
#[doc = "Field `X32P_RUE` reader - RUE"]
pub type X32P_RUE_R = crate::BitReader<bool>;
#[doc = "Field `X32P_RUE` writer - RUE"]
pub type X32P_RUE_W<'a, const O: u8> = crate::BitWriter<'a, u32, XTAL_32P_PAD_SPEC, bool, O>;
#[doc = "Field `X32P_RDE` reader - RDE"]
pub type X32P_RDE_R = crate::BitReader<bool>;
#[doc = "Field `X32P_RDE` writer - RDE"]
pub type X32P_RDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, XTAL_32P_PAD_SPEC, bool, O>;
#[doc = "Field `X32P_DRV` reader - DRV"]
pub type X32P_DRV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `X32P_DRV` writer - DRV"]
pub type X32P_DRV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, XTAL_32P_PAD_SPEC, u8, u8, 2, O>;
impl R {
