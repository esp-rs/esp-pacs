...
pub type FUN_IE_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD7_SPEC, bool, 13>;
...
pub type SLP_OE_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD7_SPEC, bool, 14>;
...
pub type SLP_IE_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD7_SPEC, bool, 15>;
...
pub type SLP_SEL_W<'a> = crate::BitWriter<'a, u32, TOUCH_PAD7_SPEC, bool, 16>;
#[doc = "Field `FUN_SEL` reader - function sel"]
pub type FUN_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FUN_SEL` writer - function sel"]
pub type FUN_SEL_W<'a> = crate::FieldWriter<'a, u32, TOUCH_PAD7_SPEC, u8, u8, 2, 17>;
