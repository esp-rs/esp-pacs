...
pub mod i2c0_conf;
/**I2C_SCLK_CONF (rw) register accessor: I2C_SCLK configuration register
...
/**TWAI1_CONF (rw) register accessor: TWAI1 configuration register
...
pub mod twai1_conf;
/**TWAI1_FUNC_CLK_CONF (rw) register accessor: TWAI1_FUNC_CLK configuration register
...
/**SDIO_SLAVE_CONF (rw) register accessor: SDIO_SLAVE configuration register
...
pub mod cache_conf;
/**MODEM_APB_CONF (rw) register accessor: MODEM_APB configuration register
...
/**SRAM_POWER_CONF (rw) register accessor: HP SRAM/ROM configuration register
