...
pub type CLKDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLKDIV_SYNC_SPEC, u16, u16, 12, O>;
#[doc = "Field `CLKDIV_FRAG` reader - The decimal part of the frequency divider factor."]
pub type CLKDIV_FRAG_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CLKDIV_FRAG` writer - The decimal part of the frequency divider factor."]
pub type CLKDIV_FRAG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLKDIV_SYNC_SPEC, u8, u8, 4, O>;
impl R {
