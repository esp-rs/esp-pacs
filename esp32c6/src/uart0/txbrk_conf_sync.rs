...
pub struct R(crate::R<TXBRK_CONF_SYNC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXBRK_CONF_SYNC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXBRK_CONF_SYNC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXBRK_CONF_SYNC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXBRK_CONF_SYNC` writer"]
pub struct W(crate::W<TXBRK_CONF_SYNC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXBRK_CONF_SYNC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXBRK_CONF_SYNC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXBRK_CONF_SYNC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TX_BRK_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TXBRK_CONF_SYNC_SPEC, u8, u8, 8, O>;
impl R {
