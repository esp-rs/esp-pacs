...
impl RegisterBlock {
    ...
    ///0x554..0x5d0 - GPIO output function select register
    #[inline(always)]
...
pub mod out_w1tc;
/**OUT1 (rw) register accessor: GPIO output register for GPIO32-34
...
pub mod out1;
/**OUT1_W1TS (w) register accessor: GPIO output set register for GPIO32-34
...
pub mod enable_w1tc;
/**ENABLE1 (rw) register accessor: GPIO output enable register for GPIO32-34
...
pub mod enable1;
/**ENABLE1_W1TS (w) register accessor: GPIO output enable set register for GPIO32-34
...
/**ENABLE1_W1TC (w) register accessor: GPIO output enable clear register for GPIO32-34
...
pub mod status_w1tc;
/**STATUS1 (rw) register accessor: GPIO interrupt status register for GPIO32-34
...
pub mod status1;
/**STATUS1_W1TS (w) register accessor: GPIO interrupt status set register for GPIO32-34
...
/**STATUS1_W1TC (w) register accessor: GPIO interrupt status clear register for GPIO32-34
...
pub mod pcpu_int1;
/**PCPU_NMI_INT1 (r) register accessor: GPIO PRO_CPU(not shielded) interrupt status register for GPIO32-34
...
/**CPUSDIO_INT1 (r) register accessor: GPIO CPUSDIO interrupt status register for GPIO32-34
...
pub mod status_next;
/**STATUS_NEXT1 (r) register accessor: GPIO interrupt source register for GPIO32-34
