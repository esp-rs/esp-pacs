...
///Field `T(0-0)` writer - Set this bit to clear the TIMG_T%s_INT interrupt.
...
impl W {
    ///Set this bit to clear the TIMG_T(0-0)_INT interrupt.
    ///
    ...
    ///Bit 1 - Set this bit to clear the TIMG_WDT_INT interrupt.
    #[inline(always)]
    #[must_use]
