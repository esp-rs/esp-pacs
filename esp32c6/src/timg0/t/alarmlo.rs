...
///Field `ALARM_LO` reader - Timer %s alarm trigger time-base counter value, low 32 bits.
pub type ALARM_LO_R = crate::FieldReader<u32>;
///Field `ALARM_LO` writer - Timer %s alarm trigger time-base counter value, low 32 bits.
pub type ALARM_LO_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Timer %s alarm trigger time-base counter value, low 32 bits.
    #[inline(always)]
