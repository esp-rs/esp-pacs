...
pub type SLC0_TOHOST_BIT0_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SLC0HOST_INT_RAW_SPEC, bool, O>;
...
pub type SLC0_RX_UDF_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SLC0HOST_INT_RAW_SPEC, bool, O>;
...
pub type SLC0_TX_OVF_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SLC0HOST_INT_RAW_SPEC, bool, O>;
...
pub type SLC0_EXT_BIT0_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SLC0HOST_INT_RAW_SPEC, bool, O>;
...
pub type SLC0_EXT_BIT1_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SLC0HOST_INT_RAW_SPEC, bool, O>;
...
pub type SLC0_EXT_BIT2_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SLC0HOST_INT_RAW_SPEC, bool, O>;
...
pub type SLC0_EXT_BIT3_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SLC0HOST_INT_RAW_SPEC, bool, O>;
...
pub type GPIO_SDIO_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SLC0HOST_INT_RAW_SPEC, bool, O>;
impl R {
