...
pub struct R(crate::R<SLC0HOST_RX_INFOR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SLC0HOST_RX_INFOR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SLC0HOST_RX_INFOR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SLC0HOST_RX_INFOR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SLC0HOST_RX_INFOR` writer"]
pub struct W(crate::W<SLC0HOST_RX_INFOR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SLC0HOST_RX_INFOR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SLC0HOST_RX_INFOR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SLC0HOST_RX_INFOR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SLC0HOST_RX_INFOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, SLC0HOST_RX_INFOR_SPEC, 20, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slc0host_rx_infor(&mut self) -> SLC0HOST_RX_INFOR_W<0> {
...
#[doc = "*******Description***********\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [slc0host_rx_infor](index.html) module"]
