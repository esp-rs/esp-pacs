...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF_W4")
            .field("slchost_conf16", &self.slchost_conf16().bits())
            .field("slchost_conf17", &self.slchost_conf17().bits())
            .field("slchost_conf18", &self.slchost_conf18().bits())
            .field("slchost_conf19", &self.slchost_conf19().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
