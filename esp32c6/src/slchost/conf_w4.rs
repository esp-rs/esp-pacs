...
///`read()` method returns [`conf_w4::R`](R) reader structure
impl crate::Readable for CONF_W4_SPEC {}
///`write(|w| ..)` method takes [`conf_w4::W`](W) writer structure
impl crate::Writable for CONF_W4_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CONF_W4 to value 0x01ff
