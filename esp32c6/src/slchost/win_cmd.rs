///Register `WIN_CMD` reader
pub type R = crate::R<WIN_CMD_SPEC>;
///Register `WIN_CMD` writer
pub type W = crate::W<WIN_CMD_SPEC>;
///Field `SLCHOST_WIN_CMD` reader - *******Description***********
pub type SLCHOST_WIN_CMD_R = crate::FieldReader<u16>;
///Field `SLCHOST_WIN_CMD` writer - *******Description***********
...
///`read()` method returns [`win_cmd::R`](R) reader structure
impl crate::Readable for WIN_CMD_SPEC {}
///`write(|w| ..)` method takes [`win_cmd::W`](W) writer structure
impl crate::Writable for WIN_CMD_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets WIN_CMD to value 0
