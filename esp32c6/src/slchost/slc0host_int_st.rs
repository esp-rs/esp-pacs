    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SLC0HOST_INT_ST")
            .field(
                ...
                &self.slc0_tohost_bit0_int_st().bit(),
            )
            .field(
                "slc0_tohost_bit1_int_st",
                &self.slc0_tohost_bit1_int_st().bit(),
            )
            .field(
                "slc0_tohost_bit2_int_st",
                &self.slc0_tohost_bit2_int_st().bit(),
            )
            .field(
                "slc0_tohost_bit3_int_st",
                &self.slc0_tohost_bit3_int_st().bit(),
            )
            .field(
                "slc0_tohost_bit4_int_st",
                &self.slc0_tohost_bit4_int_st().bit(),
            )
            .field(
                "slc0_tohost_bit5_int_st",
                &self.slc0_tohost_bit5_int_st().bit(),
            )
            .field(
                "slc0_tohost_bit6_int_st",
                &self.slc0_tohost_bit6_int_st().bit(),
            )
            .field(
                "slc0_tohost_bit7_int_st",
                &self.slc0_tohost_bit7_int_st().bit(),
            )
            .field(
            ...
            .field(
                ...
                &self.slc0_token0_0to1_int_st().bit(),
            )
            .field(
                "slc0_token1_0to1_int_st",
                &self.slc0_token1_0to1_int_st().bit(),
            )
            .field(
                "slc0host_rx_sof_int_st",
                &self.slc0host_rx_sof_int_st().bit(),
            )
            .field(
                "slc0host_rx_eof_int_st",
                &self.slc0host_rx_eof_int_st().bit(),
            )
            .field(
                "slc0host_rx_start_int_st",
                &self.slc0host_rx_start_int_st().bit(),
            )
            .field(
                "slc0host_tx_start_int_st",
                &self.slc0host_tx_start_int_st().bit(),
            )
            ...
            .field(
                ...
                &self.slc0_rx_pf_valid_int_st().bit(),
            )
            .field("slc0_ext_bit0_int_st", &self.slc0_ext_bit0_int_st().bit())
            .field("slc0_ext_bit1_int_st", &self.slc0_ext_bit1_int_st().bit())
            .field("slc0_ext_bit2_int_st", &self.slc0_ext_bit2_int_st().bit())
            .field("slc0_ext_bit3_int_st", &self.slc0_ext_bit3_int_st().bit())
            .field(
                "slc0_rx_new_packet_int_st",
                &self.slc0_rx_new_packet_int_st().bit(),
            )
            .field(
                "slc0_host_rd_retry_int_st",
                &self.slc0_host_rd_retry_int_st().bit(),
            )
            .field("gpio_sdio_int_st", &self.gpio_sdio_int_st().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
