...
///`read()` method returns [`slc0host_int_st::R`](R) reader structure
impl crate::Readable for SLC0HOST_INT_ST_SPEC {}
///`reset()` method sets SLC0HOST_INT_ST to value 0
