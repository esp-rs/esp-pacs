///Register `PKT_LEN0` reader
pub type R = crate::R<PKT_LEN0_SPEC>;
///Field `HOSTSLCHOST_SLC0_LEN0` reader - *******Description***********
pub type HOSTSLCHOST_SLC0_LEN0_R = crate::FieldReader<u32>;
///Field `HOSTSLCHOST_SLC0_LEN0_CHECK` reader - *******Description***********
...
///`read()` method returns [`pkt_len0::R`](R) reader structure
impl crate::Readable for PKT_LEN0_SPEC {}
///`reset()` method sets PKT_LEN0 to value 0
