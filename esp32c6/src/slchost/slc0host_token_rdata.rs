...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SLC0HOST_TOKEN_RDATA")
            .field("slc0_token0", &self.slc0_token0().bits())
            .field("slc0_rx_pf_valid", &self.slc0_rx_pf_valid().bit())
            .field(
                "hostslchost_slc0_token1",
                &self.hostslchost_slc0_token1().bits(),
            )
            .field("slc0_rx_pf_eof", &self.slc0_rx_pf_eof().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
