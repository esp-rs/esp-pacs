///Register `SLC1HOST_TOKEN_RDATA` reader
pub type R = crate::R<SLC1HOST_TOKEN_RDATA_SPEC>;
///Field `SLC1_TOKEN0` reader - *******Description***********
pub type SLC1_TOKEN0_R = crate::FieldReader<u16>;
///Field `SLC1_RX_PF_VALID` reader - *******Description***********
pub type SLC1_RX_PF_VALID_R = crate::BitReader;
///Field `HOSTSLCHOST_SLC1_TOKEN1` reader - *******Description***********
pub type HOSTSLCHOST_SLC1_TOKEN1_R = crate::FieldReader<u16>;
///Field `SLC1_RX_PF_EOF` reader - *******Description***********
...
///`read()` method returns [`slc1host_token_rdata::R`](R) reader structure
impl crate::Readable for SLC1HOST_TOKEN_RDATA_SPEC {}
///`reset()` method sets SLC1HOST_TOKEN_RDATA to value 0
