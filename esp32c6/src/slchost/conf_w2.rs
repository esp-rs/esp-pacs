...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF_W2")
            .field("slchost_conf8", &self.slchost_conf8())
            .field("slchost_conf9", &self.slchost_conf9())
            .field("slchost_conf10", &self.slchost_conf10())
            .field("slchost_conf11", &self.slchost_conf11())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:7 - *******Description***********"]
    #[inline(always)]
    pub fn slchost_conf8(&mut self) -> SLCHOST_CONF8_W<'_, CONF_W2_SPEC> {
        SLCHOST_CONF8_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - *******Description***********"]
    #[inline(always)]
    pub fn slchost_conf9(&mut self) -> SLCHOST_CONF9_W<'_, CONF_W2_SPEC> {
        SLCHOST_CONF9_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - *******Description***********"]
    #[inline(always)]
    pub fn slchost_conf10(&mut self) -> SLCHOST_CONF10_W<'_, CONF_W2_SPEC> {
        SLCHOST_CONF10_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - *******Description***********"]
    #[inline(always)]
    pub fn slchost_conf11(&mut self) -> SLCHOST_CONF11_W<'_, CONF_W2_SPEC> {
        SLCHOST_CONF11_W::new(self, 24)
    }
}
#[doc = "*******Description***********\n\nYou can [`read`](crate::Reg::read) this register and get [`conf_w2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`conf_w2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
