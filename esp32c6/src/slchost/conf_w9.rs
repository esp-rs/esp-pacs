...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf36(&mut self) -> SLCHOST_CONF36_W<CONF_W9_SPEC> {
        SLCHOST_CONF36_W::new(self, 0)
    }
    ///Bits 8:15 - *******Description***********
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf37(&mut self) -> SLCHOST_CONF37_W<CONF_W9_SPEC> {
        SLCHOST_CONF37_W::new(self, 8)
    }
    ///Bits 16:23 - *******Description***********
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf38(&mut self) -> SLCHOST_CONF38_W<CONF_W9_SPEC> {
        SLCHOST_CONF38_W::new(self, 16)
    }
    ///Bits 24:31 - *******Description***********
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf39(&mut self) -> SLCHOST_CONF39_W<CONF_W9_SPEC> {
...
///`read()` method returns [`conf_w9::R`](R) reader structure
impl crate::Readable for CONF_W9_SPEC {}
///`write(|w| ..)` method takes [`conf_w9::W`](W) writer structure
impl crate::Writable for CONF_W9_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CONF_W9 to value 0
