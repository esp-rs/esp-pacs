...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF_W15")
            .field("slchost_conf60", &self.slchost_conf60().bits())
            .field("slchost_conf61", &self.slchost_conf61().bits())
            .field("slchost_conf62", &self.slchost_conf62().bits())
            .field("slchost_conf63", &self.slchost_conf63().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
