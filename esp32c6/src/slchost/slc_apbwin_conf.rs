...
///`read()` method returns [`slc_apbwin_conf::R`](R) reader structure
impl crate::Readable for SLC_APBWIN_CONF_SPEC {}
///`write(|w| ..)` method takes [`slc_apbwin_conf::W`](W) writer structure
impl crate::Writable for SLC_APBWIN_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SLC_APBWIN_CONF to value 0
