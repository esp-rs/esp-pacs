///Register `SLCHOSTID` reader
pub type R = crate::R<SLCHOSTID_SPEC>;
///Register `SLCHOSTID` writer
pub type W = crate::W<SLCHOSTID_SPEC>;
///Field `SLCHOST_ID` reader - *******Description***********
pub type SLCHOST_ID_R = crate::FieldReader<u32>;
///Field `SLCHOST_ID` writer - *******Description***********
...
///`read()` method returns [`slchostid::R`](R) reader structure
impl crate::Readable for SLCHOSTID_SPEC {}
///`write(|w| ..)` method takes [`slchostid::W`](W) writer structure
impl crate::Writable for SLCHOSTID_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SLCHOSTID to value 0x0600
