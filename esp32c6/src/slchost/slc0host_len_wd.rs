///Register `SLC0HOST_LEN_WD` reader
pub type R = crate::R<SLC0HOST_LEN_WD_SPEC>;
///Register `SLC0HOST_LEN_WD` writer
pub type W = crate::W<SLC0HOST_LEN_WD_SPEC>;
///Field `SLC0HOST_LEN_WD` reader - *******Description***********
pub type SLC0HOST_LEN_WD_R = crate::FieldReader<u32>;
///Field `SLC0HOST_LEN_WD` writer - *******Description***********
...
///`read()` method returns [`slc0host_len_wd::R`](R) reader structure
impl crate::Readable for SLC0HOST_LEN_WD_SPEC {}
///`write(|w| ..)` method takes [`slc0host_len_wd::W`](W) writer structure
impl crate::Writable for SLC0HOST_LEN_WD_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SLC0HOST_LEN_WD to value 0
