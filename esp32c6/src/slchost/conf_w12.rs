...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF_W12")
            .field("slchost_conf48", &self.slchost_conf48().bits())
            .field("slchost_conf49", &self.slchost_conf49().bits())
            .field("slchost_conf50", &self.slchost_conf50().bits())
            .field("slchost_conf51", &self.slchost_conf51().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
