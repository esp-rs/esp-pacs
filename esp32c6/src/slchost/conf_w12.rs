...
///`read()` method returns [`conf_w12::R`](R) reader structure
impl crate::Readable for CONF_W12_SPEC {}
///`write(|w| ..)` method takes [`conf_w12::W`](W) writer structure
impl crate::Writable for CONF_W12_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CONF_W12 to value 0
