...
///`read()` method returns [`rdclr1::R`](R) reader structure
impl crate::Readable for RDCLR1_SPEC {}
///`write(|w| ..)` method takes [`rdclr1::W`](W) writer structure
impl crate::Writable for RDCLR1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RDCLR1 to value 0x0003_c1e0
