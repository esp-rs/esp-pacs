///Register `PKT_LEN1` reader
pub type R = crate::R<PKT_LEN1_SPEC>;
///Field `HOSTSLCHOST_SLC0_LEN1` reader - *******Description***********
pub type HOSTSLCHOST_SLC0_LEN1_R = crate::FieldReader<u32>;
///Field `HOSTSLCHOST_SLC0_LEN1_CHECK` reader - *******Description***********
...
///`read()` method returns [`pkt_len1::R`](R) reader structure
impl crate::Readable for PKT_LEN1_SPEC {}
///`reset()` method sets PKT_LEN1 to value 0
