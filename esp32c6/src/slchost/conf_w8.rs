...
pub type SLCHOST_CONF32_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SLCHOST_CONF33_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SLCHOST_CONF34_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SLCHOST_CONF35_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf32(&mut self) -> SLCHOST_CONF32_W<CONF_W8_SPEC, 0> {
        SLCHOST_CONF32_W::new(self)
    }
    #[doc = "Bits 8:15 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf33(&mut self) -> SLCHOST_CONF33_W<CONF_W8_SPEC, 8> {
        SLCHOST_CONF33_W::new(self)
    }
    #[doc = "Bits 16:23 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf34(&mut self) -> SLCHOST_CONF34_W<CONF_W8_SPEC, 16> {
        SLCHOST_CONF34_W::new(self)
    }
    #[doc = "Bits 24:31 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf35(&mut self) -> SLCHOST_CONF35_W<CONF_W8_SPEC, 24> {
