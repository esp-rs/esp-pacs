///Register `CHECK_SUM1` reader
pub type R = crate::R<CHECK_SUM1_SPEC>;
///Field `SLCHOST_CHECK_SUM1` reader - *******Description***********
...
///`read()` method returns [`check_sum1::R`](R) reader structure
impl crate::Readable for CHECK_SUM1_SPEC {}
///`reset()` method sets CHECK_SUM1 to value 0x013f
