...
pub type SLCHOST_CONF4_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SLCHOST_CONF5_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SLCHOST_CONF6_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SLCHOST_CONF7_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf4(&mut self) -> SLCHOST_CONF4_W<CONF_W1_SPEC, 0> {
        SLCHOST_CONF4_W::new(self)
    }
    #[doc = "Bits 8:15 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf5(&mut self) -> SLCHOST_CONF5_W<CONF_W1_SPEC, 8> {
        SLCHOST_CONF5_W::new(self)
    }
    #[doc = "Bits 16:23 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf6(&mut self) -> SLCHOST_CONF6_W<CONF_W1_SPEC, 16> {
        SLCHOST_CONF6_W::new(self)
    }
    #[doc = "Bits 24:31 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf7(&mut self) -> SLCHOST_CONF7_W<CONF_W1_SPEC, 24> {
