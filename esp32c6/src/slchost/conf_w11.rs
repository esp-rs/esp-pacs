...
pub type SLCHOST_CONF44_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SLCHOST_CONF45_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SLCHOST_CONF46_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SLCHOST_CONF47_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf44(&mut self) -> SLCHOST_CONF44_W<CONF_W11_SPEC, 0> {
        SLCHOST_CONF44_W::new(self)
    }
    #[doc = "Bits 8:15 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf45(&mut self) -> SLCHOST_CONF45_W<CONF_W11_SPEC, 8> {
        SLCHOST_CONF45_W::new(self)
    }
    #[doc = "Bits 16:23 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf46(&mut self) -> SLCHOST_CONF46_W<CONF_W11_SPEC, 16> {
        SLCHOST_CONF46_W::new(self)
    }
    #[doc = "Bits 24:31 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slchost_conf47(&mut self) -> SLCHOST_CONF47_W<CONF_W11_SPEC, 24> {
