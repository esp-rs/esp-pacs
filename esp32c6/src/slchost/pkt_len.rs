///Register `PKT_LEN` reader
pub type R = crate::R<PKT_LEN_SPEC>;
///Field `HOSTSLCHOST_SLC0_LEN` reader - *******Description***********
pub type HOSTSLCHOST_SLC0_LEN_R = crate::FieldReader<u32>;
///Field `HOSTSLCHOST_SLC0_LEN_CHECK` reader - *******Description***********
...
///`read()` method returns [`pkt_len::R`](R) reader structure
impl crate::Readable for PKT_LEN_SPEC {}
///`reset()` method sets PKT_LEN to value 0
