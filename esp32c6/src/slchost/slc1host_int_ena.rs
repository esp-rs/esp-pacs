...
impl W {
    ...
    pub fn slc1_tohost_bit0_int_ena(
        &mut self,
    ) -> SLC1_TOHOST_BIT0_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_tohost_bit1_int_ena(
        &mut self,
    ) -> SLC1_TOHOST_BIT1_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_tohost_bit2_int_ena(
        &mut self,
    ) -> SLC1_TOHOST_BIT2_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_tohost_bit3_int_ena(
        &mut self,
    ) -> SLC1_TOHOST_BIT3_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_tohost_bit4_int_ena(
        &mut self,
    ) -> SLC1_TOHOST_BIT4_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_tohost_bit5_int_ena(
        &mut self,
    ) -> SLC1_TOHOST_BIT5_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_tohost_bit6_int_ena(
        &mut self,
    ) -> SLC1_TOHOST_BIT6_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_tohost_bit7_int_ena(
        &mut self,
    ) -> SLC1_TOHOST_BIT7_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_token0_1to0_int_ena(
        &mut self,
    ) -> SLC1_TOKEN0_1TO0_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_token1_1to0_int_ena(
        &mut self,
    ) -> SLC1_TOKEN1_1TO0_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_token0_0to1_int_ena(
        &mut self,
    ) -> SLC1_TOKEN0_0TO1_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_token1_0to1_int_ena(
        &mut self,
    ) -> SLC1_TOKEN1_0TO1_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
        SLC1_TOKEN1_0TO1_INT_ENA_W::new(self, 11)
    }
    #[doc = "Bit 12 - *******Description***********"]
    #[inline(always)]
    pub fn slc1host_rx_sof_int_ena(
        &mut self,
    ) -> SLC1HOST_RX_SOF_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
        SLC1HOST_RX_SOF_INT_ENA_W::new(self, 12)
    }
    #[doc = "Bit 13 - *******Description***********"]
    #[inline(always)]
    pub fn slc1host_rx_eof_int_ena(
        &mut self,
    ) -> SLC1HOST_RX_EOF_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1host_rx_start_int_ena(
        &mut self,
    ) -> SLC1HOST_RX_START_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1host_tx_start_int_ena(
        &mut self,
    ) -> SLC1HOST_TX_START_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
        SLC1HOST_TX_START_INT_ENA_W::new(self, 15)
    }
    #[doc = "Bit 16 - *******Description***********"]
    #[inline(always)]
    pub fn slc1_rx_udf_int_ena(&mut self) -> SLC1_RX_UDF_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
        SLC1_RX_UDF_INT_ENA_W::new(self, 16)
    }
    #[doc = "Bit 17 - *******Description***********"]
    #[inline(always)]
    pub fn slc1_tx_ovf_int_ena(&mut self) -> SLC1_TX_OVF_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_rx_pf_valid_int_ena(
        &mut self,
    ) -> SLC1_RX_PF_VALID_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
        SLC1_RX_PF_VALID_INT_ENA_W::new(self, 18)
    }
    #[doc = "Bit 19 - *******Description***********"]
    #[inline(always)]
    pub fn slc1_ext_bit0_int_ena(&mut self) -> SLC1_EXT_BIT0_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
        SLC1_EXT_BIT0_INT_ENA_W::new(self, 19)
    }
    #[doc = "Bit 20 - *******Description***********"]
    #[inline(always)]
    pub fn slc1_ext_bit1_int_ena(&mut self) -> SLC1_EXT_BIT1_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
        SLC1_EXT_BIT1_INT_ENA_W::new(self, 20)
    }
    #[doc = "Bit 21 - *******Description***********"]
    #[inline(always)]
    pub fn slc1_ext_bit2_int_ena(&mut self) -> SLC1_EXT_BIT2_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
        SLC1_EXT_BIT2_INT_ENA_W::new(self, 21)
    }
    #[doc = "Bit 22 - *******Description***********"]
    #[inline(always)]
    pub fn slc1_ext_bit3_int_ena(&mut self) -> SLC1_EXT_BIT3_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_wifi_rx_new_packet_int_ena(
        &mut self,
    ) -> SLC1_WIFI_RX_NEW_PACKET_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_host_rd_retry_int_ena(
        &mut self,
    ) -> SLC1_HOST_RD_RETRY_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
    ...
    pub fn slc1_bt_rx_new_packet_int_ena(
        &mut self,
    ) -> SLC1_BT_RX_NEW_PACKET_INT_ENA_W<'_, SLC1HOST_INT_ENA_SPEC> {
        SLC1_BT_RX_NEW_PACKET_INT_ENA_W::new(self, 25)
    }
}
#[doc = "*******Description***********\n\nYou can [`read`](crate::Reg::read) this register and get [`slc1host_int_ena::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`slc1host_int_ena::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
