///Register `STATE_W1` reader
pub type R = crate::R<STATE_W1_SPEC>;
///Field `SLCHOST_STATE4` reader - *******Description***********
pub type SLCHOST_STATE4_R = crate::FieldReader;
///Field `SLCHOST_STATE5` reader - *******Description***********
pub type SLCHOST_STATE5_R = crate::FieldReader;
///Field `SLCHOST_STATE6` reader - *******Description***********
pub type SLCHOST_STATE6_R = crate::FieldReader;
///Field `SLCHOST_STATE7` reader - *******Description***********
...
///`read()` method returns [`state_w1::R`](R) reader structure
impl crate::Readable for STATE_W1_SPEC {}
///`reset()` method sets STATE_W1 to value 0
