...
///`read()` method returns [`slc1host_token_wdata::R`](R) reader structure
impl crate::Readable for SLC1HOST_TOKEN_WDATA_SPEC {}
///`write(|w| ..)` method takes [`slc1host_token_wdata::W`](W) writer structure
impl crate::Writable for SLC1HOST_TOKEN_WDATA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SLC1HOST_TOKEN_WDATA to value 0
