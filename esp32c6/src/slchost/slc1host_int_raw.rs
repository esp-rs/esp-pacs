...
pub type SLC1_TOHOST_BIT0_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOHOST_BIT1_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOHOST_BIT2_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOHOST_BIT3_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOHOST_BIT4_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOHOST_BIT5_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOHOST_BIT6_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOHOST_BIT7_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOKEN0_1TO0_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOKEN1_1TO0_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOKEN0_0TO1_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOKEN1_0TO1_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1HOST_RX_SOF_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1HOST_RX_EOF_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1HOST_RX_START_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1HOST_TX_START_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_RX_UDF_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TX_OVF_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_RX_PF_VALID_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_EXT_BIT0_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_EXT_BIT1_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_EXT_BIT2_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_EXT_BIT3_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_WIFI_RX_NEW_PACKET_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_HOST_RD_RETRY_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_BT_RX_NEW_PACKET_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn slc1_tohost_bit0_int_raw(
        &mut self,
    ) -> SLC1_TOHOST_BIT0_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 0> {
    ...
    pub fn slc1_tohost_bit1_int_raw(
        &mut self,
    ) -> SLC1_TOHOST_BIT1_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 1> {
    ...
    pub fn slc1_tohost_bit2_int_raw(
        &mut self,
    ) -> SLC1_TOHOST_BIT2_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 2> {
    ...
    pub fn slc1_tohost_bit3_int_raw(
        &mut self,
    ) -> SLC1_TOHOST_BIT3_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 3> {
    ...
    pub fn slc1_tohost_bit4_int_raw(
        &mut self,
    ) -> SLC1_TOHOST_BIT4_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 4> {
    ...
    pub fn slc1_tohost_bit5_int_raw(
        &mut self,
    ) -> SLC1_TOHOST_BIT5_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 5> {
    ...
    pub fn slc1_tohost_bit6_int_raw(
        &mut self,
    ) -> SLC1_TOHOST_BIT6_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 6> {
    ...
    pub fn slc1_tohost_bit7_int_raw(
        &mut self,
    ) -> SLC1_TOHOST_BIT7_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 7> {
    ...
    pub fn slc1_token0_1to0_int_raw(
        &mut self,
    ) -> SLC1_TOKEN0_1TO0_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 8> {
    ...
    pub fn slc1_token1_1to0_int_raw(
        &mut self,
    ) -> SLC1_TOKEN1_1TO0_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 9> {
    ...
    pub fn slc1_token0_0to1_int_raw(
        &mut self,
    ) -> SLC1_TOKEN0_0TO1_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 10> {
    ...
    pub fn slc1_token1_0to1_int_raw(
        &mut self,
    ) -> SLC1_TOKEN1_0TO1_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 11> {
    ...
    pub fn slc1host_rx_sof_int_raw(
        &mut self,
    ) -> SLC1HOST_RX_SOF_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 12> {
    ...
    pub fn slc1host_rx_eof_int_raw(
        &mut self,
    ) -> SLC1HOST_RX_EOF_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 13> {
    ...
    pub fn slc1host_rx_start_int_raw(
        &mut self,
    ) -> SLC1HOST_RX_START_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 14> {
    ...
    pub fn slc1host_tx_start_int_raw(
        &mut self,
    ) -> SLC1HOST_TX_START_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 15> {
        SLC1HOST_TX_START_INT_RAW_W::new(self)
    }
    #[doc = "Bit 16 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_rx_udf_int_raw(&mut self) -> SLC1_RX_UDF_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 16> {
        SLC1_RX_UDF_INT_RAW_W::new(self)
    }
    #[doc = "Bit 17 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_tx_ovf_int_raw(&mut self) -> SLC1_TX_OVF_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 17> {
    ...
    pub fn slc1_rx_pf_valid_int_raw(
        &mut self,
    ) -> SLC1_RX_PF_VALID_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 18> {
        SLC1_RX_PF_VALID_INT_RAW_W::new(self)
    }
    #[doc = "Bit 19 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_ext_bit0_int_raw(&mut self) -> SLC1_EXT_BIT0_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 19> {
        SLC1_EXT_BIT0_INT_RAW_W::new(self)
    }
    #[doc = "Bit 20 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_ext_bit1_int_raw(&mut self) -> SLC1_EXT_BIT1_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 20> {
        SLC1_EXT_BIT1_INT_RAW_W::new(self)
    }
    #[doc = "Bit 21 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_ext_bit2_int_raw(&mut self) -> SLC1_EXT_BIT2_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 21> {
        SLC1_EXT_BIT2_INT_RAW_W::new(self)
    }
    #[doc = "Bit 22 - *******Description***********"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_ext_bit3_int_raw(&mut self) -> SLC1_EXT_BIT3_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 22> {
    ...
    pub fn slc1_wifi_rx_new_packet_int_raw(
        &mut self,
    ) -> SLC1_WIFI_RX_NEW_PACKET_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 23> {
    ...
    pub fn slc1_host_rd_retry_int_raw(
        &mut self,
    ) -> SLC1_HOST_RD_RETRY_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 24> {
    ...
    pub fn slc1_bt_rx_new_packet_int_raw(
        &mut self,
    ) -> SLC1_BT_RX_NEW_PACKET_INT_RAW_W<SLC1HOST_INT_RAW_SPEC, 25> {
