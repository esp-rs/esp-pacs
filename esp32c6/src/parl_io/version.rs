...
///Field `DATE` reader - Version of this register file
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - Version of this register file
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - Version of this register file
    #[inline(always)]
...
///`reset()` method sets VERSION to value 0x0220_2240
impl crate::Resettable for VERSION_SPEC {
    const RESET_VALUE: u32 = 0x0220_2240;
}
