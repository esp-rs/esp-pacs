...
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, VERSION_SPEC, u32, u32, 28, O>;
impl R {
...
#[doc = "`reset()` method sets VERSION to value 0x0220_2240"]
impl crate::Resettable for VERSION_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_2240;
}
