///Register `RX_CFG1` reader
pub type R = crate::R<RX_CFG1_SPEC>;
///Register `RX_CFG1` writer
pub type W = crate::W<RX_CFG1_SPEC>;
///Field `RX_REG_UPDATE` writer - Write 1 to update rx register configuration signals.
pub type RX_REG_UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_TIMEOUT_EN` reader - Write 1 to enable timeout count to generate error eof.
pub type RX_TIMEOUT_EN_R = crate::BitReader;
///Field `RX_TIMEOUT_EN` writer - Write 1 to enable timeout count to generate error eof.
pub type RX_TIMEOUT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_EXT_EN_SEL` reader - Configures rx external enable signal selection from 16 data lines.
pub type RX_EXT_EN_SEL_R = crate::FieldReader;
///Field `RX_EXT_EN_SEL` writer - Configures rx external enable signal selection from 16 data lines.
pub type RX_EXT_EN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `RX_TIMEOUT_THRESHOLD` reader - Configures rx threshold of timeout counter.
pub type RX_TIMEOUT_THRESHOLD_R = crate::FieldReader<u16>;
///Field `RX_TIMEOUT_THRESHOLD` writer - Configures rx threshold of timeout counter.
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_CFG1")
            ...
            .field("rx_timeout_threshold", &self.rx_timeout_threshold())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`rx_cfg1::R`](R) reader structure
impl crate::Readable for RX_CFG1_SPEC {}
///`write(|w| ..)` method takes [`rx_cfg1::W`](W) writer structure
impl crate::Writable for RX_CFG1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RX_CFG1 to value 0x0fff_f008
