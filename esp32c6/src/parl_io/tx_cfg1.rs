///Register `TX_CFG1` reader
pub type R = crate::R<TX_CFG1_SPEC>;
///Register `TX_CFG1` writer
pub type W = crate::W<TX_CFG1_SPEC>;
///Field `TX_IDLE_VALUE` reader - Configures data value on tx bus when IDLE state.
pub type TX_IDLE_VALUE_R = crate::FieldReader<u16>;
///Field `TX_IDLE_VALUE` writer - Configures data value on tx bus when IDLE state.
pub type TX_IDLE_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 16:31 - Configures data value on tx bus when IDLE state.
    #[inline(always)]
...
///`read()` method returns [`tx_cfg1::R`](R) reader structure
impl crate::Readable for TX_CFG1_SPEC {}
///`write(|w| ..)` method takes [`tx_cfg1::W`](W) writer structure
impl crate::Writable for TX_CFG1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TX_CFG1 to value 0
