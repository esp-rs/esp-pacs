...
///Field `TX_FIFO_REMPTY` reader - Write 1 to enable TX_FIFO_REMPTY_INTR.
pub type TX_FIFO_REMPTY_R = crate::BitReader;
///Field `TX_FIFO_REMPTY` writer - Write 1 to enable TX_FIFO_REMPTY_INTR.
pub type TX_FIFO_REMPTY_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_FIFO_WOVF` reader - Write 1 to enable RX_FIFO_WOVF_INTR.
pub type RX_FIFO_WOVF_R = crate::BitReader;
///Field `RX_FIFO_WOVF` writer - Write 1 to enable RX_FIFO_WOVF_INTR.
pub type RX_FIFO_WOVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_EOF` reader - Write 1 to enable TX_EOF_INTR.
pub type TX_EOF_R = crate::BitReader;
///Field `TX_EOF` writer - Write 1 to enable TX_EOF_INTR.
