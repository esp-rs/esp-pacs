///Register `RD_KEY5_DATA7` reader
pub type R = crate::R<RD_KEY5_DATA7_SPEC>;
///Field `KEY5_DATA7` reader - Stores the seventh 32 bits of KEY5.
pub type KEY5_DATA7_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the seventh 32 bits of KEY5.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_KEY5_DATA7")
            .field("key5_data7", &self.key5_data7())
            .finish()
    }
}
...
///`read()` method returns [`rd_key5_data7::R`](R) reader structure
