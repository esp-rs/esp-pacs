...
pub struct R(crate::R<RD_KEY5_DATA7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RD_KEY5_DATA7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RD_KEY5_DATA7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RD_KEY5_DATA7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `KEY5_DATA7` reader - Stores the seventh 32 bits of KEY5."]
pub type KEY5_DATA7_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "Register $n of BLOCK9 (KEY5).\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rd_key5_data7](index.html) module"]
