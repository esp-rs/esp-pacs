...
#[doc = "Field `DATE` reader - Stores eFuse version."]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - Stores eFuse version."]
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, DATE_SPEC, 28, O, u32, u32>;
impl R {
    #[doc = "Bits 0:27 - Stores eFuse version."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x0220_6300"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_6300;
}
