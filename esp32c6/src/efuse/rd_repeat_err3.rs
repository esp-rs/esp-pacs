...
///Field `USB_PRINT_ERR` reader - Indicates a programming error of UART_PRINT_CHANNEL.
pub type USB_PRINT_ERR_R = crate::BitReader;
///Field `RPT4_RESERVED3_ERR_5` reader - Reserved.
...
///Field `RPT4_RESERVED3_ERR_4` reader - Reserved.
pub type RPT4_RESERVED3_ERR_4_R = crate::BitReader;
///Field `RPT4_RESERVED3_ERR_3` reader - Reserved.
pub type RPT4_RESERVED3_ERR_3_R = crate::BitReader;
///Field `RPT4_RESERVED3_ERR_2` reader - Reserved.
pub type RPT4_RESERVED3_ERR_2_R = crate::FieldReader;
///Field `RPT4_RESERVED3_ERR_1` reader - Reserved.
...
///Field `SECURE_VERSION_ERR` reader - Indicates a programming error of SECURE_VERSION.
pub type SECURE_VERSION_ERR_R = crate::FieldReader<u16>;
///Field `RPT4_RESERVED3_ERR_0` reader - Reserved.
...
impl R {
    ...
    ///Bit 2 - Indicates a programming error of UART_PRINT_CHANNEL.
    #[inline(always)]
    ...
    ///Bit 13 - Indicates a programming error of FORCE_SEND_RESUME.
    #[inline(always)]
    pub fn force_send_resume_err(&self) -> FORCE_SEND_RESUME_ERR_R {
        FORCE_SEND_RESUME_ERR_R::new(((self.bits >> 13) & 1) != 0)
    }
    ///Bits 14:29 - Indicates a programming error of SECURE_VERSION.
    #[inline(always)]
