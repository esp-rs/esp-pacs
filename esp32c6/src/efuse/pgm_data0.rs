...
///Field `PGM_DATA_0` reader - Configures the 0th 32-bit data to be programmed.
pub type PGM_DATA_0_R = crate::FieldReader<u32>;
///Field `PGM_DATA_0` writer - Configures the 0th 32-bit data to be programmed.
pub type PGM_DATA_0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configures the 0th 32-bit data to be programmed.
    #[inline(always)]
