///Register `RD_SYS_PART1_DATA0` reader
pub type R = crate::R<RD_SYS_PART1_DATA0_SPEC>;
///Field `SYS_DATA_PART1_0` reader - Stores the zeroth 32 bits of the first part of system data.
pub type SYS_DATA_PART1_0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the zeroth 32 bits of the first part of system data.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_SYS_PART1_DATA0")
            .field("sys_data_part1_0", &self.sys_data_part1_0())
            .finish()
    }
}
...
///`read()` method returns [`rd_sys_part1_data0::R`](R) reader structure
