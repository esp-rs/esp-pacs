...
#[doc = "Field `DATA` reader - Stores the zeroth 32 bits of the first part of system data."]
...
#[doc = "Register %s of BLOCK2 (system).\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rd_sys_part1_data::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
