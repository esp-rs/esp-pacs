...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_KEY3_DATA3")
            .field("key3_data3", &self.key3_data3())
            .finish()
    }
}
#[doc = "Register $n of BLOCK7 (KEY3).\n\nYou can [`read`](crate::Reg::read) this register and get [`rd_key3_data3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
