...
///Field `SWAP_UART_SDIO_EN_ERR` reader - Indicates a programming error of SWAP_UART_SDIO_EN.
...
///Field `DIS_DOWNLOAD_ICACHE_ERR` reader - Indicates a programming error of DIS_DOWNLOAD_ICACHE.
...
impl R {
    ...
    ///Bit 7 - Indicates a programming error of SWAP_UART_SDIO_EN.
    #[inline(always)]
    ...
    ///Bit 10 - Indicates a programming error of DIS_DOWNLOAD_ICACHE.
    #[inline(always)]
