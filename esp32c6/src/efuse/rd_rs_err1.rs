...
///Field `KEY5_ERR_NUM` reader - The value of this signal means the number of error bytes.
pub type KEY5_ERR_NUM_R = crate::FieldReader;
///Field `KEY5_FAIL` reader - 0: Means no failure and that the data of key5 is reliable 1: Means that programming key5 failed and the number of error bytes is over 6.
pub type KEY5_FAIL_R = crate::BitReader;
///Field `SYS_PART2_ERR_NUM` reader - The value of this signal means the number of error bytes.
pub type SYS_PART2_ERR_NUM_R = crate::FieldReader;
///Field `SYS_PART2_FAIL` reader - 0: Means no failure and that the data of system part2 is reliable 1: Means that programming user data failed and the number of error bytes is over 6.
