...
impl R {
    ...
    ///Bit 7 - Represents whether pad of uart and sdio is swapped or not. 1: swapped. 0: not swapped.
    #[inline(always)]
    ...
    ///Bit 10 - Represents whether icache is disabled or enabled in Download mode. 1: disabled. 0: enabled.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA0")
            ...
            .field("swap_uart_sdio_en", &self.swap_uart_sdio_en())
