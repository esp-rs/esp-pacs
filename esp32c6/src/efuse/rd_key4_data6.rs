///Register `RD_KEY4_DATA6` reader
pub type R = crate::R<RD_KEY4_DATA6_SPEC>;
///Field `KEY4_DATA6` reader - Stores the sixth 32 bits of KEY4.
pub type KEY4_DATA6_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the sixth 32 bits of KEY4.
    #[inline(always)]
...
///`read()` method returns [`rd_key4_data6::R`](R) reader structure
