...
///Register `WR_TIM_CONF1` writer
pub type W = crate::W<WR_TIM_CONF1_SPEC>;
///Field `TSUP_A` reader - Configures the programming setup time.
pub type TSUP_A_R = crate::FieldReader;
///Field `TSUP_A` writer - Configures the programming setup time.
pub type TSUP_A_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PWR_ON_NUM` reader - Configures the power up time for VDDQ.
...
///Field `THP_A` reader - Configures the programming hold time.
pub type THP_A_R = crate::FieldReader;
///Field `THP_A` writer - Configures the programming hold time.
pub type THP_A_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - Configures the programming setup time.
    #[inline(always)]
    pub fn tsup_a(&self) -> TSUP_A_R {
        TSUP_A_R::new((self.bits & 0xff) as u8)
    }
    ///Bits 8:23 - Configures the power up time for VDDQ.
    #[inline(always)]
    pub fn pwr_on_num(&self) -> PWR_ON_NUM_R {
        PWR_ON_NUM_R::new(((self.bits >> 8) & 0xffff) as u16)
    }
    ///Bits 24:31 - Configures the programming hold time.
    #[inline(always)]
...
///`read()` method returns [`wr_tim_conf1::R`](R) reader structure
impl crate::Readable for WR_TIM_CONF1_SPEC {}
///`write(|w| ..)` method takes [`wr_tim_conf1::W`](W) writer structure
impl crate::Writable for WR_TIM_CONF1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets WR_TIM_CONF1 to value 0x0130_0001
impl crate::Resettable for WR_TIM_CONF1_SPEC {
    const RESET_VALUE: u32 = 0x0130_0001;
}
