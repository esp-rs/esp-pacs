///Register `RD_KEY4_DATA7` reader
pub type R = crate::R<RD_KEY4_DATA7_SPEC>;
///Field `KEY4_DATA7` reader - Stores the seventh 32 bits of KEY4.
pub type KEY4_DATA7_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Stores the seventh 32 bits of KEY4.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`rd_key4_data7::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RD_KEY4_DATA7_SPEC;
impl crate::RegisterSpec for RD_KEY4_DATA7_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rd_key4_data7::R`](R) reader structure
