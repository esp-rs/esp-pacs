...
pub type SEC_DPA_LEVEL_ERR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RPT4_RESERVED2_ERR_1` reader - Reserved."]
pub type RPT4_RESERVED2_ERR_1_R = crate::BitReader<bool>;
#[doc = "Field `CRYPT_DPA_ENABLE_ERR` reader - Indicates a programming error of CRYPT_DPA_ENABLE."]
pub type CRYPT_DPA_ENABLE_ERR_R = crate::BitReader<bool>;
...
pub type RPT4_RESERVED2_ERR_0_R = crate::FieldReader<u8, u8>;
