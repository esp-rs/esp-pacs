///Register `ARB_LOST_CAP` reader
pub type R = crate::R<ARB_LOST_CAP_SPEC>;
///Field `ARBITRATION_LOST_CAPTURE` reader - This register contains information about the bit position of losing arbitration.
pub type ARBITRATION_LOST_CAPTURE_R = crate::FieldReader;
impl R {
    ///Bits 0:4 - This register contains information about the bit position of losing arbitration.
    #[inline(always)]
...
///`read()` method returns [`arb_lost_cap::R`](R) reader structure
