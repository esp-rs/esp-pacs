...
pub type STANDBY_WAIT_CNT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn standby_wait_cnt(&mut self) -> STANDBY_WAIT_CNT_W<HW_STANDBY_CNT_SPEC, 0> {
