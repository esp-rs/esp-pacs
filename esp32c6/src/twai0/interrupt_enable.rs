...
pub type EXT_RECEIVE_INT_ENA_R = crate::BitReader<bool>;
...
pub type EXT_RECEIVE_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTERRUPT_ENABLE_SPEC, bool, O>;
...
pub type EXT_TRANSMIT_INT_ENA_R = crate::BitReader<bool>;
...
pub type EXT_TRANSMIT_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTERRUPT_ENABLE_SPEC, bool, O>;
...
pub type EXT_ERR_WARNING_INT_ENA_R = crate::BitReader<bool>;
...
pub type EXT_DATA_OVERRUN_INT_ENA_R = crate::BitReader<bool>;
...
pub type ERR_PASSIVE_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTERRUPT_ENABLE_SPEC, bool, O>;
...
pub type BUS_ERR_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTERRUPT_ENABLE_SPEC, bool, O>;
...
pub type IDLE_INT_ENA_R = crate::BitReader<bool>;
impl R {
