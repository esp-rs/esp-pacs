...
///Field `TIME_SEG1` reader - The number of clock cycles in TSEG1 per bit timing. Software has R/W permission in reset mode and RO in operation mode.
pub type TIME_SEG1_R = crate::FieldReader;
///Field `TIME_SEG1` writer - The number of clock cycles in TSEG1 per bit timing. Software has R/W permission in reset mode and RO in operation mode.
pub type TIME_SEG1_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `TIME_SEG2` reader - The number of clock cycles in TSEG2 per bit timing. Software has R/W permission in reset mode and RO in operation mode.
pub type TIME_SEG2_R = crate::FieldReader;
///Field `TIME_SEG2` writer - The number of clock cycles in TSEG2 per bit timing. Software has R/W permission in reset mode and RO in operation mode.
pub type TIME_SEG2_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `TIME_SAMP` reader - 1: triple, the bus is sampled three times. 0: single, the bus is sampled once. Software has R/W permission in reset mode and RO in operation mode.
pub type TIME_SAMP_R = crate::BitReader;
///Field `TIME_SAMP` writer - 1: triple, the bus is sampled three times. 0: single, the bus is sampled once. Software has R/W permission in reset mode and RO in operation mode.
