...
pub type DATA_2_R = crate::FieldReader<u8, u8>;
...
pub type DATA_2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATA_2_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data_2(&mut self) -> DATA_2_W<0> {
        DATA_2_W::new(self)
    }
