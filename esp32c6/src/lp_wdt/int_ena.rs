...
pub type SUPER_WDT_INT_ENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_ENA_SPEC, bool, O>;
#[doc = "Field `LP_WDT_INT_ENA` reader - need_des"]
pub type LP_WDT_INT_ENA_R = crate::BitReader<bool>;
#[doc = "Field `LP_WDT_INT_ENA` writer - need_des"]
pub type LP_WDT_INT_ENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_ENA_SPEC, bool, O>;
impl R {
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_wdt_int_ena(&mut self) -> LP_WDT_INT_ENA_W<31> {
