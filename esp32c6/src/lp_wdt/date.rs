...
pub type LP_WDT_DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LP_WDT_DATE` writer - need_des"]
pub type LP_WDT_DATE_W<'a, const O: u8> = crate::FieldWriter<'a, DATE_SPEC, 31, O, u32, u32>;
...
impl R {
    ...
    #[inline(always)]
    pub fn lp_wdt_date(&self) -> LP_WDT_DATE_R {
        LP_WDT_DATE_R::new(self.bits & 0x7fff_ffff)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DATE")
            .field(
                "lp_wdt_date",
                &format_args!("{}", self.lp_wdt_date().bits()),
            )
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_wdt_date(&mut self) -> LP_WDT_DATE_W<0> {
...
#[doc = "`reset()` method sets DATE to value 0x0211_2080"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0211_2080;
}
