...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_i2c_ana_mast_i2c_mat_date(&mut self) -> LP_I2C_ANA_MAST_I2C_MAT_DATE_W<0> {
        LP_I2C_ANA_MAST_I2C_MAT_DATE_W::new(self)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_i2c_ana_mast_i2c_mat_clk_en(&mut self) -> LP_I2C_ANA_MAST_I2C_MAT_CLK_EN_W<28> {
