...
pub struct R(crate::R<REGION1_ADDR_END_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REGION1_ADDR_END_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REGION1_ADDR_END_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REGION1_ADDR_END_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REGION1_ADDR_END` writer"]
pub struct W(crate::W<REGION1_ADDR_END_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REGION1_ADDR_END_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REGION1_ADDR_END_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REGION1_ADDR_END_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `REGION1_ADDR_END` reader - End address of region1"]
pub type REGION1_ADDR_END_R = crate::FieldReader<u32, u32>;
#[doc = "Field `REGION1_ADDR_END` writer - End address of region1"]
pub type REGION1_ADDR_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, REGION1_ADDR_END_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region1_addr_end(&mut self) -> REGION1_ADDR_END_W<0> {
...
#[doc = "Region address register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [region1_addr_end](index.html) module"]
