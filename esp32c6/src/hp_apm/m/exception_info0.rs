///Register `EXCEPTION_INFO0` reader
pub type R = crate::R<EXCEPTION_INFO0_SPEC>;
///Field `EXCEPTION_REGION` reader - Exception region
pub type EXCEPTION_REGION_R = crate::FieldReader<u16>;
///Field `EXCEPTION_MODE` reader - Exception mode
pub type EXCEPTION_MODE_R = crate::FieldReader;
///Field `EXCEPTION_ID` reader - Exception id information
pub type EXCEPTION_ID_R = crate::FieldReader;
impl R {
    ///Bits 0:15 - Exception region
    #[inline(always)]
    pub fn exception_region(&self) -> EXCEPTION_REGION_R {
        EXCEPTION_REGION_R::new((self.bits & 0xffff) as u16)
    }
...
///`read()` method returns [`exception_info0::R`](R) reader structure
