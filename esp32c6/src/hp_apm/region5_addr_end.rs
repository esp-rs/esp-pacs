...
pub type REGION5_ADDR_END_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region5_addr_end(&mut self) -> REGION5_ADDR_END_W<REGION5_ADDR_END_SPEC, 0> {
