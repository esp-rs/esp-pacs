...
pub type REGION11_R0_PMS_X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION11_R0_PMS_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION11_R0_PMS_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION11_R1_PMS_X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION11_R1_PMS_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION11_R1_PMS_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION11_R2_PMS_X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION11_R2_PMS_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION11_R2_PMS_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region11_r0_pms_x(&mut self) -> REGION11_R0_PMS_X_W<REGION11_PMS_ATTR_SPEC, 0> {
        REGION11_R0_PMS_X_W::new(self)
    }
    #[doc = "Bit 1 - Region write authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region11_r0_pms_w(&mut self) -> REGION11_R0_PMS_W_W<REGION11_PMS_ATTR_SPEC, 1> {
        REGION11_R0_PMS_W_W::new(self)
    }
    #[doc = "Bit 2 - Region read authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region11_r0_pms_r(&mut self) -> REGION11_R0_PMS_R_W<REGION11_PMS_ATTR_SPEC, 2> {
        REGION11_R0_PMS_R_W::new(self)
    }
    #[doc = "Bit 4 - Region execute authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region11_r1_pms_x(&mut self) -> REGION11_R1_PMS_X_W<REGION11_PMS_ATTR_SPEC, 4> {
        REGION11_R1_PMS_X_W::new(self)
    }
    #[doc = "Bit 5 - Region write authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region11_r1_pms_w(&mut self) -> REGION11_R1_PMS_W_W<REGION11_PMS_ATTR_SPEC, 5> {
        REGION11_R1_PMS_W_W::new(self)
    }
    #[doc = "Bit 6 - Region read authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region11_r1_pms_r(&mut self) -> REGION11_R1_PMS_R_W<REGION11_PMS_ATTR_SPEC, 6> {
        REGION11_R1_PMS_R_W::new(self)
    }
    #[doc = "Bit 8 - Region execute authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region11_r2_pms_x(&mut self) -> REGION11_R2_PMS_X_W<REGION11_PMS_ATTR_SPEC, 8> {
        REGION11_R2_PMS_X_W::new(self)
    }
    #[doc = "Bit 9 - Region write authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region11_r2_pms_w(&mut self) -> REGION11_R2_PMS_W_W<REGION11_PMS_ATTR_SPEC, 9> {
        REGION11_R2_PMS_W_W::new(self)
    }
    #[doc = "Bit 10 - Region read authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region11_r2_pms_r(&mut self) -> REGION11_R2_PMS_R_W<REGION11_PMS_ATTR_SPEC, 10> {
