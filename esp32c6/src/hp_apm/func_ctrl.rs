///Register `FUNC_CTRL` reader
pub type R = crate::R<FUNC_CTRL_SPEC>;
///Register `FUNC_CTRL` writer
pub type W = crate::W<FUNC_CTRL_SPEC>;
///Field `M_PMS_FUNC_EN(0-3)` reader - PMS M%s function enable
pub type M_PMS_FUNC_EN_R = crate::BitReader;
///Field `M_PMS_FUNC_EN(0-3)` writer - PMS M%s function enable
...
impl R {
    ...
    pub fn m_pms_func_en_iter(&self) -> impl Iterator<Item = M_PMS_FUNC_EN_R> + '_ {
        (0..4).map(move |n| M_PMS_FUNC_EN_R::new(((self.bits >> n) & 1) != 0))
    }
    ...
    #[inline(always)]
    pub fn m2_pms_func_en(&self) -> M_PMS_FUNC_EN_R {
        M_PMS_FUNC_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - PMS M3 function enable
    #[inline(always)]
    pub fn m3_pms_func_en(&self) -> M_PMS_FUNC_EN_R {
        M_PMS_FUNC_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
}
...
///`read()` method returns [`func_ctrl::R`](R) reader structure
impl crate::Readable for FUNC_CTRL_SPEC {}
///`write(|w| ..)` method takes [`func_ctrl::W`](W) writer structure
