...
pub type REGION9_R0_PMS_X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION9_R0_PMS_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION9_R0_PMS_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION9_R1_PMS_X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION9_R1_PMS_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION9_R1_PMS_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION9_R2_PMS_X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION9_R2_PMS_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION9_R2_PMS_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region9_r0_pms_x(&mut self) -> REGION9_R0_PMS_X_W<REGION9_PMS_ATTR_SPEC, 0> {
        REGION9_R0_PMS_X_W::new(self)
    }
    #[doc = "Bit 1 - Region write authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r0_pms_w(&mut self) -> REGION9_R0_PMS_W_W<REGION9_PMS_ATTR_SPEC, 1> {
        REGION9_R0_PMS_W_W::new(self)
    }
    #[doc = "Bit 2 - Region read authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r0_pms_r(&mut self) -> REGION9_R0_PMS_R_W<REGION9_PMS_ATTR_SPEC, 2> {
        REGION9_R0_PMS_R_W::new(self)
    }
    #[doc = "Bit 4 - Region execute authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r1_pms_x(&mut self) -> REGION9_R1_PMS_X_W<REGION9_PMS_ATTR_SPEC, 4> {
        REGION9_R1_PMS_X_W::new(self)
    }
    #[doc = "Bit 5 - Region write authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r1_pms_w(&mut self) -> REGION9_R1_PMS_W_W<REGION9_PMS_ATTR_SPEC, 5> {
        REGION9_R1_PMS_W_W::new(self)
    }
    #[doc = "Bit 6 - Region read authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r1_pms_r(&mut self) -> REGION9_R1_PMS_R_W<REGION9_PMS_ATTR_SPEC, 6> {
        REGION9_R1_PMS_R_W::new(self)
    }
    #[doc = "Bit 8 - Region execute authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r2_pms_x(&mut self) -> REGION9_R2_PMS_X_W<REGION9_PMS_ATTR_SPEC, 8> {
        REGION9_R2_PMS_X_W::new(self)
    }
    #[doc = "Bit 9 - Region write authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r2_pms_w(&mut self) -> REGION9_R2_PMS_W_W<REGION9_PMS_ATTR_SPEC, 9> {
        REGION9_R2_PMS_W_W::new(self)
    }
    #[doc = "Bit 10 - Region read authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region9_r2_pms_r(&mut self) -> REGION9_R2_PMS_R_W<REGION9_PMS_ATTR_SPEC, 10> {
