...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsens_xpd_wait(&mut self) -> TSENS_XPD_WAIT_W<TSENS_CTRL2_SPEC, 0> {
        TSENS_XPD_WAIT_W::new(self)
    }
    #[doc = "Bits 12:13 - force power up tsens"]
    #[inline(always)]
    #[must_use]
    pub fn tsens_xpd_force(&mut self) -> TSENS_XPD_FORCE_W<TSENS_CTRL2_SPEC, 12> {
        TSENS_XPD_FORCE_W::new(self)
    }
    #[doc = "Bit 14 - inv tsens clk"]
    #[inline(always)]
    #[must_use]
    pub fn tsens_clk_inv(&mut self) -> TSENS_CLK_INV_W<TSENS_CTRL2_SPEC, 14> {
        TSENS_CLK_INV_W::new(self)
    }
    #[doc = "Bit 15 - tsens clk select"]
    #[inline(always)]
    #[must_use]
    pub fn tsens_clk_sel(&mut self) -> TSENS_CLK_SEL_W<TSENS_CTRL2_SPEC, 15> {
