...
///Field `APB_FORCE` reader - adc2 arbiter force to enableapb controller
pub type APB_FORCE_R = crate::BitReader;
///Field `APB_FORCE` writer - adc2 arbiter force to enableapb controller
pub type APB_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RTC_FORCE` reader - adc2 arbiter force to enable rtc controller
...
///Field `WIFI_FORCE` reader - adc2 arbiter force to enable wifi controller
pub type WIFI_FORCE_R = crate::BitReader;
///Field `WIFI_FORCE` writer - adc2 arbiter force to enable wifi controller
...
///Field `APB_PRIORITY` reader - Set adc2 arbiterapb priority
pub type APB_PRIORITY_R = crate::FieldReader;
///Field `APB_PRIORITY` writer - Set adc2 arbiterapb priority
pub type APB_PRIORITY_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `RTC_PRIORITY` reader - Set adc2 arbiter rtc priority
pub type RTC_PRIORITY_R = crate::FieldReader;
///Field `RTC_PRIORITY` writer - Set adc2 arbiter rtc priority
pub type RTC_PRIORITY_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `WIFI_PRIORITY` reader - Set adc2 arbiter wifi priority
pub type WIFI_PRIORITY_R = crate::FieldReader;
///Field `WIFI_PRIORITY` writer - Set adc2 arbiter wifi priority
