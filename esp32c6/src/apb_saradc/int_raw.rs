...
#[doc = "Field `SARADC2_DONE` reader - saradc2 done interrupt raw"]
pub type SARADC2_DONE_R = crate::BitReader;
#[doc = "Field `SARADC2_DONE` writer - saradc2 done interrupt raw"]
pub type SARADC2_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SARADC1_DONE` reader - saradc1 done interrupt raw"]
pub type SARADC1_DONE_R = crate::BitReader;
#[doc = "Field `SARADC1_DONE` writer - saradc1 done interrupt raw"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc2_done(&mut self) -> SARADC2_DONE_W<INT_RAW_SPEC> {
        SARADC2_DONE_W::new(self, 30)
    }
    #[doc = "Bit 31 - saradc1 done interrupt raw"]
    #[inline(always)]
    #[must_use]
    pub fn saradc1_done(&mut self) -> SARADC1_DONE_W<INT_RAW_SPEC> {
