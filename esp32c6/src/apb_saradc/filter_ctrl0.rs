...
///Field `FILTER_CHANNEL1` reader - configure filter1 to adc channel
pub type FILTER_CHANNEL1_R = crate::FieldReader;
///Field `FILTER_CHANNEL1` writer - configure filter1 to adc channel
pub type FILTER_CHANNEL1_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `FILTER_CHANNEL0` reader - configure filter0 to adc channel
pub type FILTER_CHANNEL0_R = crate::FieldReader;
///Field `FILTER_CHANNEL0` writer - configure filter0 to adc channel
