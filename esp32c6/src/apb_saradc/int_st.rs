...
#[doc = "Field `TSENS` reader - saradc tsens interrupt state"]
...
#[doc = "Field `SARADC2_DONE` reader - saradc2 done interrupt state"]
pub type SARADC2_DONE_R = crate::BitReader;
#[doc = "Field `SARADC1_DONE` reader - saradc1 done interrupt state"]
