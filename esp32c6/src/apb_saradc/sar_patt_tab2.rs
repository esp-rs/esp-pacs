...
pub type SARADC_SAR_PATT_TAB2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 24, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc_sar_patt_tab2(&mut self) -> SARADC_SAR_PATT_TAB2_W<SAR_PATT_TAB2_SPEC, 0> {
