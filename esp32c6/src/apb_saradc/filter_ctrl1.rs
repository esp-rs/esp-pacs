...
///Field `FILTER_FACTOR1` reader - Factor of saradc filter1
pub type FILTER_FACTOR1_R = crate::FieldReader;
///Field `FILTER_FACTOR1` writer - Factor of saradc filter1
pub type FILTER_FACTOR1_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `FILTER_FACTOR0` reader - Factor of saradc filter0
pub type FILTER_FACTOR0_R = crate::FieldReader;
///Field `FILTER_FACTOR0` writer - Factor of saradc filter0
