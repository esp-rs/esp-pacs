...
pub type APB_SARADC_TSENS_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, INT_CLR_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn apb_saradc_tsens_int_clr(&mut self) -> APB_SARADC_TSENS_INT_CLR_W<25> {
