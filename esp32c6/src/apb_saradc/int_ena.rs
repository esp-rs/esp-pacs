...
///Field `TSENS` reader - tsens low interrupt enable
pub type TSENS_R = crate::BitReader;
///Field `TSENS` writer - tsens low interrupt enable
pub type TSENS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES1_LOW` reader - saradc thres1 low interrupt enable
pub type THRES1_LOW_R = crate::BitReader;
///Field `THRES1_LOW` writer - saradc thres1 low interrupt enable
pub type THRES1_LOW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES0_LOW` reader - saradc thres0 low interrupt enable
pub type THRES0_LOW_R = crate::BitReader;
///Field `THRES0_LOW` writer - saradc thres0 low interrupt enable
pub type THRES0_LOW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES1_HIGH` reader - saradc thres1 high interrupt enable
pub type THRES1_HIGH_R = crate::BitReader;
///Field `THRES1_HIGH` writer - saradc thres1 high interrupt enable
pub type THRES1_HIGH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `THRES0_HIGH` reader - saradc thres0 high interrupt enable
pub type THRES0_HIGH_R = crate::BitReader;
///Field `THRES0_HIGH` writer - saradc thres0 high interrupt enable
pub type THRES0_HIGH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC2_DONE` reader - saradc2 done interrupt enable
pub type ADC2_DONE_R = crate::BitReader;
///Field `ADC2_DONE` writer - saradc2 done interrupt enable
pub type ADC2_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADC1_DONE` reader - saradc1 done interrupt enable
pub type ADC1_DONE_R = crate::BitReader;
///Field `ADC1_DONE` writer - saradc1 done interrupt enable
