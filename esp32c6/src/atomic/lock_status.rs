///Register `LOCK_STATUS` reader
pub type R = crate::R<LOCK_STATUS_SPEC>;
///Field `LOCK_STATUS` reader - read hareware lock status for debug
pub type LOCK_STATUS_R = crate::FieldReader;
impl R {
    ///Bits 0:1 - read hareware lock status for debug
    #[inline(always)]
...
///`read()` method returns [`lock_status::R`](R) reader structure
impl crate::Readable for LOCK_STATUS_SPEC {}
///`reset()` method sets LOCK_STATUS to value 0
