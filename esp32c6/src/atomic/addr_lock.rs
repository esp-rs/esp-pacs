///Register `ADDR_LOCK` reader
pub type R = crate::R<ADDR_LOCK_SPEC>;
///Register `ADDR_LOCK` writer
pub type W = crate::W<ADDR_LOCK_SPEC>;
///Field `LOCK` reader - read to acquire hardware lock, write to release hardware lock
pub type LOCK_R = crate::FieldReader;
///Field `LOCK` writer - read to acquire hardware lock, write to release hardware lock
pub type LOCK_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - read to acquire hardware lock, write to release hardware lock
    #[inline(always)]
...
///`read()` method returns [`addr_lock::R`](R) reader structure
impl crate::Readable for ADDR_LOCK_SPEC {}
///`write(|w| ..)` method takes [`addr_lock::W`](W) writer structure
impl crate::Writable for ADDR_LOCK_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ADDR_LOCK to value 0
