...
pub struct R(crate::R<BLK10_W5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK10_W5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK10_W5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK10_W5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK10_W5` reader - Otp block10 word5 data."]
pub type BLOCK10_W5_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "Otp debuger block10 data register5.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk10_w5](index.html) module"]
