...
pub struct R(crate::R<BLK5_W5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK5_W5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK5_W5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK5_W5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK5_W5` reader - Otp block5 word5 data."]
pub type BLOCK5_W5_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK5_W5")
            .field("block5_w5", &format_args!("{}", self.block5_w5().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<BLK5_W5_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "Otp debuger block5 data register5.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk5_w5](index.html) module"]
