...
pub struct R(crate::R<BLK2_W5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK2_W5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK2_W5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK2_W5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK2_W5` reader - Otp block2 word5 data."]
pub type BLOCK2_W5_R = crate::FieldReader<u32, u32>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<BLK2_W5_SPEC> {
