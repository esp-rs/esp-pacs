///Register `BLK0_BACKUP2_W2` reader
pub type R = crate::R<BLK0_BACKUP2_W2_SPEC>;
///Field `OTP_BEBUG_BLOCK0_BACKUP2_W2` reader - Otp block0 backup2 word2 data.
pub type OTP_BEBUG_BLOCK0_BACKUP2_W2_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Otp block0 backup2 word2 data.
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK0_BACKUP2_W2")
            .field(
                ...
                &self.otp_bebug_block0_backup2_w2(),
            )
            .finish()
    }
}
...
///`read()` method returns [`blk0_backup2_w2::R`](R) reader structure
