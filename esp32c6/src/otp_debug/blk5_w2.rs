...
pub struct R(crate::R<BLK5_W2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK5_W2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK5_W2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK5_W2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK5_W2` reader - Otp block5 word2 data."]
pub type BLOCK5_W2_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "Otp debuger block5 data register2.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk5_w2](index.html) module"]
