///Register `BLK7_W11` reader
pub type R = crate::R<BLK7_W11_SPEC>;
///Field `BLOCK7_W11` reader - Otp block7 word11 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk7_w11::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK7_W11_SPEC;
impl crate::RegisterSpec for BLK7_W11_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk7_w11::R`](R) reader structure
