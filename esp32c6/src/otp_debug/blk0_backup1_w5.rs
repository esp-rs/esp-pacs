...
pub struct R(crate::R<BLK0_BACKUP1_W5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK0_BACKUP1_W5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK0_BACKUP1_W5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK0_BACKUP1_W5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `OTP_BEBUG_BLOCK0_BACKUP1_W5` reader - Otp block0 backup1 word5 data."]
pub type OTP_BEBUG_BLOCK0_BACKUP1_W5_R = crate::FieldReader<u32, u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK0_BACKUP1_W5")
            .field(
                ...
                &format_args!("{}", self.otp_bebug_block0_backup1_w5().bits()),
            )
            .finish()
    }
}
...
#[doc = "Otp debuger block0 data register6.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk0_backup1_w5](index.html) module"]
