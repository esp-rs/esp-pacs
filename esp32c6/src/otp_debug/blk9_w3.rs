///Register `BLK9_W3` reader
pub type R = crate::R<BLK9_W3_SPEC>;
///Field `BLOCK9_W3` reader - Otp block9 word3 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk9_w3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK9_W3_SPEC;
impl crate::RegisterSpec for BLK9_W3_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk9_w3::R`](R) reader structure
