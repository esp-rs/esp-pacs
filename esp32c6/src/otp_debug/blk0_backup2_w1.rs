///Register `BLK0_BACKUP2_W1` reader
pub type R = crate::R<BLK0_BACKUP2_W1_SPEC>;
///Field `OTP_BEBUG_BLOCK0_BACKUP2_W1` reader - Otp block0 backup2 word1 data.
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK0_BACKUP2_W1")
            .field(
                ...
                &self.otp_bebug_block0_backup2_w1(),
            )
            .finish()
    }
}
...
///`read()` method returns [`blk0_backup2_w1::R`](R) reader structure
