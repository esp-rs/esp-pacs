///Register `BLK0_BACKUP1_W2` reader
pub type R = crate::R<BLK0_BACKUP1_W2_SPEC>;
///Field `OTP_BEBUG_BLOCK0_BACKUP1_W2` reader - Otp block0 backup1 word2 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk0_backup1_w2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK0_BACKUP1_W2_SPEC;
impl crate::RegisterSpec for BLK0_BACKUP1_W2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk0_backup1_w2::R`](R) reader structure
