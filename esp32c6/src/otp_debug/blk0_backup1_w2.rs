...
pub struct R(crate::R<BLK0_BACKUP1_W2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK0_BACKUP1_W2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK0_BACKUP1_W2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK0_BACKUP1_W2_SPEC>) -> Self {
        R(reader)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK0_BACKUP1_W2")
            .field(
                ...
                &format_args!("{}", self.otp_bebug_block0_backup1_w2().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<BLK0_BACKUP1_W2_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "Otp debuger block0 data register3.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk0_backup1_w2](index.html) module"]
