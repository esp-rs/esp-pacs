...
pub struct R(crate::R<BLK3_W11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK3_W11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK3_W11_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK3_W11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK3_W11` reader - Otp block3 word11 data."]
pub type BLOCK3_W11_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK3_W11")
            .field("block3_w11", &format_args!("{}", self.block3_w11().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<BLK3_W11_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "Otp debuger block3 data register11.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk3_w11](index.html) module"]
