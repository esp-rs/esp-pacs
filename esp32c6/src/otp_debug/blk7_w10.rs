...
pub struct R(crate::R<BLK7_W10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK7_W10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK7_W10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK7_W10_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK7_W10` reader - Otp block7 word10 data."]
pub type BLOCK7_W10_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK7_W10")
            .field("block7_w10", &format_args!("{}", self.block7_w10().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<BLK7_W10_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "Otp debuger block7 data register10.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk7_w10](index.html) module"]
