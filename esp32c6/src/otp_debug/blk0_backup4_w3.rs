...
pub struct R(crate::R<BLK0_BACKUP4_W3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK0_BACKUP4_W3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK0_BACKUP4_W3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK0_BACKUP4_W3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `OTP_BEBUG_BLOCK0_BACKUP4_W3` reader - Otp block0 backup4 word3 data."]
pub type OTP_BEBUG_BLOCK0_BACKUP4_W3_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "Otp debuger block0 data register19.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk0_backup4_w3](index.html) module"]
