...
pub struct R(crate::R<BLK4_W11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK4_W11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK4_W11_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK4_W11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK4_W11` reader - Otp block4 word11 data."]
pub type BLOCK4_W11_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK4_W11")
            .field("block4_w11", &format_args!("{}", self.block4_w11().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<BLK4_W11_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "Otp debuger block4 data register11.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk4_w11](index.html) module"]
