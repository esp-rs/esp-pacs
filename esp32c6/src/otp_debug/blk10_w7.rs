...
pub struct R(crate::R<BLK10_W7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK10_W7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK10_W7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK10_W7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK10_W7` reader - Otp block10 word7 data."]
pub type BLOCK10_W7_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK10_W7")
            .field("block10_w7", &format_args!("{}", self.block10_w7().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
...
#[doc = "Otp debuger block10 data register7.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk10_w7](index.html) module"]
