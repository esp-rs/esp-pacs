...
pub struct R(crate::R<BLK2_W11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK2_W11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK2_W11_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK2_W11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK2_W11` reader - Otp block2 word11 data."]
pub type BLOCK2_W11_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK2_W11")
            .field("block2_w11", &format_args!("{}", self.block2_w11().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
...
#[doc = "Otp debuger block2 data register11.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk2_w11](index.html) module"]
