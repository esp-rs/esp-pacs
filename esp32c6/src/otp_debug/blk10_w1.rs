...
pub struct R(crate::R<BLK10_W1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK10_W1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK10_W1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK10_W1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `BLOCK10_W1` reader - Otp block10 word1 data."]
pub type BLOCK10_W1_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK10_W1")
            .field("block10_w1", &format_args!("{}", self.block10_w1().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<BLK10_W1_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "Otp debuger block10 data register1.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk10_w1](index.html) module"]
