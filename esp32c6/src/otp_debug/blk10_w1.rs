///Register `BLK10_W1` reader
pub type R = crate::R<BLK10_W1_SPEC>;
///Field `BLOCK10_W1` reader - Otp block10 word1 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk10_w1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK10_W1_SPEC;
impl crate::RegisterSpec for BLK10_W1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk10_w1::R`](R) reader structure
