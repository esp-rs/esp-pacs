///Register `BLK10_W11` reader
pub type R = crate::R<BLK10_W11_SPEC>;
///Field `BLOCK10_W11` reader - Otp block10 word11 data.
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk10_w11::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK10_W11_SPEC;
impl crate::RegisterSpec for BLK10_W11_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk10_w11::R`](R) reader structure
