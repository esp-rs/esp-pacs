...
///Field `OUT1_W1TC` writer - GPIO output clear register for GPIO32-34
pub type OUT1_W1TC_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
impl W {
    ///Bits 0:2 - GPIO output clear register for GPIO32-34
    #[inline(always)]
    #[must_use]
