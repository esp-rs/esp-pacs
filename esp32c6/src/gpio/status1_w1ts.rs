...
#[doc = "Field `STATUS1_W1TS` writer - GPIO interrupt status set register for GPIO32-34"]
pub type STATUS1_W1TS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
impl W {
    #[doc = "Bits 0:2 - GPIO interrupt status set register for GPIO32-34"]
    #[inline(always)]
    #[must_use]
