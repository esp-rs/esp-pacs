...
///Field `ENABLE1_W1TS` writer - GPIO output enable set register for GPIO32-34
pub type ENABLE1_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
impl W {
    ///Bits 0:2 - GPIO output enable set register for GPIO32-34
    #[inline(always)]
    #[must_use]
