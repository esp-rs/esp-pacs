...
///Field `DATA` reader - GPIO output enable register for GPIO32-34
pub type DATA_R = crate::FieldReader;
///Field `DATA` writer - GPIO output enable register for GPIO32-34
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2 - GPIO output enable register for GPIO32-34
    #[inline(always)]
