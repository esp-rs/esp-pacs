...
///Field `DATA_ORIG` reader - GPIO output register for GPIO32-34
pub type DATA_ORIG_R = crate::FieldReader;
///Field `DATA_ORIG` writer - GPIO output register for GPIO32-34
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2 - GPIO output register for GPIO32-34
    #[inline(always)]
