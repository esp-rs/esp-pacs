...
#[doc = "Field `FUNC40_IN_SEL` reader - set this value: s=0-34: connect GPIO\\[s\\] to this port. s=0x38: set this port always high level. s=0x3C: set this port always low level."]
pub type FUNC40_IN_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FUNC40_IN_SEL` writer - set this value: s=0-34: connect GPIO\\[s\\] to this port. s=0x38: set this port always high level. s=0x3C: set this port always low level."]
pub type FUNC40_IN_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FUNC40_IN_SEL_CFG_SPEC, u8, u8, 6, O>;
...
pub type FUNC40_IN_INV_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FUNC40_IN_SEL_CFG_SPEC, bool, O>;
...
pub type SIG40_IN_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FUNC40_IN_SEL_CFG_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func40_in_sel(&mut self) -> FUNC40_IN_SEL_W<0> {
        FUNC40_IN_SEL_W::new(self)
    }
    #[doc = "Bit 6 - set this bit to invert input signal. 1:invert. 0:not invert."]
    #[inline(always)]
    #[must_use]
    pub fn func40_in_inv_sel(&mut self) -> FUNC40_IN_INV_SEL_W<6> {
        FUNC40_IN_INV_SEL_W::new(self)
    }
    #[doc = "Bit 7 - set this bit to bypass GPIO. 1:do not bypass GPIO. 0:bypass GPIO."]
    #[inline(always)]
    #[must_use]
    pub fn sig40_in_sel(&mut self) -> SIG40_IN_SEL_W<7> {
...
#[doc = "`reset()` method sets FUNC40_IN_SEL_CFG to value 0x3c"]
