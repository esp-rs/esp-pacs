...
pub type SPI_MEM_USR_MOSI_DBITLEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_MEM_MOSI_DLEN_SPEC, u16, u16, 10, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_mosi_dbitlen(&mut self) -> SPI_MEM_USR_MOSI_DBITLEN_W<0> {
