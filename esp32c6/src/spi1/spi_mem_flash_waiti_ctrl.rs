...
pub type SPI_MEM_WAITI_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_WAITI_DUMMY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_WAITI_ADDR_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_WAITI_ADDR_CYCLELEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type SPI_MEM_WAITI_CMD_2B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_WAITI_DUMMY_CYCLELEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
pub type SPI_MEM_WAITI_CMD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_waiti_en(&mut self) -> SPI_MEM_WAITI_EN_W<SPI_MEM_FLASH_WAITI_CTRL_SPEC, 0> {
    ...
    pub fn spi_mem_waiti_dummy(
        &mut self,
    ) -> SPI_MEM_WAITI_DUMMY_W<SPI_MEM_FLASH_WAITI_CTRL_SPEC, 1> {
    ...
    pub fn spi_mem_waiti_addr_en(
        &mut self,
    ) -> SPI_MEM_WAITI_ADDR_EN_W<SPI_MEM_FLASH_WAITI_CTRL_SPEC, 2> {
    ...
    pub fn spi_mem_waiti_addr_cyclelen(
        &mut self,
    ) -> SPI_MEM_WAITI_ADDR_CYCLELEN_W<SPI_MEM_FLASH_WAITI_CTRL_SPEC, 3> {
    ...
    pub fn spi_mem_waiti_cmd_2b(
        &mut self,
    ) -> SPI_MEM_WAITI_CMD_2B_W<SPI_MEM_FLASH_WAITI_CTRL_SPEC, 9> {
    ...
    pub fn spi_mem_waiti_dummy_cyclelen(
        &mut self,
    ) -> SPI_MEM_WAITI_DUMMY_CYCLELEN_W<SPI_MEM_FLASH_WAITI_CTRL_SPEC, 10> {
