...
pub type SPI_MEM_FWRITE_DUAL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_FWRITE_QUAD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_FWRITE_DIO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_FWRITE_QIO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_USR_MOSI_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_USR_MISO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_USR_ADDR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_USR_COMMAND_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_fwrite_dual(&mut self) -> SPI_MEM_FWRITE_DUAL_W<SPI_MEM_USER_SPEC, 12> {
        SPI_MEM_FWRITE_DUAL_W::new(self)
    }
    #[doc = "Bit 13 - In the write operations read-data phase apply 4 signals"]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_fwrite_quad(&mut self) -> SPI_MEM_FWRITE_QUAD_W<SPI_MEM_USER_SPEC, 13> {
        SPI_MEM_FWRITE_QUAD_W::new(self)
    }
    #[doc = "Bit 14 - In the write operations address phase and read-data phase apply 2 signals."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_fwrite_dio(&mut self) -> SPI_MEM_FWRITE_DIO_W<SPI_MEM_USER_SPEC, 14> {
        SPI_MEM_FWRITE_DIO_W::new(self)
    }
    #[doc = "Bit 15 - In the write operations address phase and read-data phase apply 4 signals."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_fwrite_qio(&mut self) -> SPI_MEM_FWRITE_QIO_W<SPI_MEM_USER_SPEC, 15> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_mosi(&mut self) -> SPI_MEM_USR_MOSI_W<SPI_MEM_USER_SPEC, 27> {
        SPI_MEM_USR_MOSI_W::new(self)
    }
    #[doc = "Bit 28 - This bit enable the read-data phase of an operation."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_miso(&mut self) -> SPI_MEM_USR_MISO_W<SPI_MEM_USER_SPEC, 28> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_addr(&mut self) -> SPI_MEM_USR_ADDR_W<SPI_MEM_USER_SPEC, 30> {
        SPI_MEM_USR_ADDR_W::new(self)
    }
    #[doc = "Bit 31 - This bit enable the command phase of an operation."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_command(&mut self) -> SPI_MEM_USR_COMMAND_W<SPI_MEM_USER_SPEC, 31> {
