...
pub type SPI_MEM_FLASH_PER_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_FLASH_PES_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_FLASH_PER_WAIT_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_FLASH_PES_WAIT_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_PES_PER_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_FLASH_PES_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_PESR_END_MSK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
...
pub type SPI_FMEM_RD_SUS_2B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_PER_END_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_PES_END_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_SUS_TIMEOUT_CNT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_flash_per(&mut self) -> SPI_MEM_FLASH_PER_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 0> {
        SPI_MEM_FLASH_PER_W::new(self)
    }
    #[doc = "Bit 1 - program erase suspend bit, program erase suspend operation will be triggered when the bit is set. The bit will be cleared once the operation done.1: enable 0: disable."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_flash_pes(&mut self) -> SPI_MEM_FLASH_PES_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 1> {
    ...
    pub fn spi_mem_flash_per_wait_en(
        &mut self,
    ) -> SPI_MEM_FLASH_PER_WAIT_EN_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 2> {
    ...
    pub fn spi_mem_flash_pes_wait_en(
        &mut self,
    ) -> SPI_MEM_FLASH_PES_WAIT_EN_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 3> {
        SPI_MEM_FLASH_PES_WAIT_EN_W::new(self)
    }
    #[doc = "Bit 4 - Set this bit to enable PES end triggers PER transfer option. If this bit is 0, application should send PER after PES is done."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_pes_per_en(&mut self) -> SPI_MEM_PES_PER_EN_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 4> {
        SPI_MEM_PES_PER_EN_W::new(self)
    }
    #[doc = "Bit 5 - Set this bit to enable Auto-suspending function."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_flash_pes_en(
        &mut self,
    ) -> SPI_MEM_FLASH_PES_EN_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 5> {
        SPI_MEM_FLASH_PES_EN_W::new(self)
    }
    #[doc = "Bits 6:21 - The mask value when check SUS/SUS1/SUS2 status bit. If the read status value is status_in\\[15:0\\](only status_in\\[7:0\\] is valid when only one byte of data is read out, status_in\\[15:0\\] is valid when two bytes of data are read out), SUS/SUS1/SUS2 = status_in\\[15:0\\]^ SPI_MEM_PESR_END_MSK\\[15:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_pesr_end_msk(
        &mut self,
    ) -> SPI_MEM_PESR_END_MSK_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 6> {
        SPI_MEM_PESR_END_MSK_W::new(self)
    }
    #[doc = "Bit 22 - 1: Read two bytes when check flash SUS/SUS1/SUS2 status bit. 0: Read one byte when check flash SUS/SUS1/SUS2 status bit"]
    #[inline(always)]
    #[must_use]
    pub fn spi_fmem_rd_sus_2b(&mut self) -> SPI_FMEM_RD_SUS_2B_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 22> {
        SPI_FMEM_RD_SUS_2B_W::new(self)
    }
    #[doc = "Bit 23 - 1: Both WIP and SUS/SUS1/SUS2 bits should be checked to insure the resume status of flash. 0: Only need to check WIP is 0."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_per_end_en(&mut self) -> SPI_MEM_PER_END_EN_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 23> {
        SPI_MEM_PER_END_EN_W::new(self)
    }
    #[doc = "Bit 24 - 1: Both WIP and SUS/SUS1/SUS2 bits should be checked to insure the suspend status of flash. 0: Only need to check WIP is 0."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_pes_end_en(&mut self) -> SPI_MEM_PES_END_EN_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 24> {
    ...
    pub fn spi_mem_sus_timeout_cnt(
        &mut self,
    ) -> SPI_MEM_SUS_TIMEOUT_CNT_W<SPI_MEM_FLASH_SUS_CTRL_SPEC, 25> {
