...
pub struct R(crate::R<SPI_MEM_W13_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPI_MEM_W13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPI_MEM_W13_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPI_MEM_W13_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPI_MEM_W13` writer"]
pub struct W(crate::W<SPI_MEM_W13_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI_MEM_W13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI_MEM_W13_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI_MEM_W13_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SPI_MEM_BUF13` reader - data buffer"]
pub type SPI_MEM_BUF13_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_MEM_BUF13` writer - data buffer"]
pub type SPI_MEM_BUF13_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_MEM_W13_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_buf13(&mut self) -> SPI_MEM_BUF13_W<0> {
