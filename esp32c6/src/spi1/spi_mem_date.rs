...
#[doc = "Field `SPI_MEM_DATE` reader - Version control register"]
pub type SPI_MEM_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `SPI_MEM_DATE` writer - Version control register"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_date(&mut self) -> SPI_MEM_DATE_W<0> {
...
#[doc = "`reset()` method sets SPI_MEM_DATE to value 0x0220_2160"]
impl crate::Resettable for SPI_MEM_DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_2160;
}
