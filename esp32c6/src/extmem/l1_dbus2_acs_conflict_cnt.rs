///Register `L1_DBUS2_ACS_CONFLICT_CNT` reader
pub type R = crate::R<L1_DBUS2_ACS_CONFLICT_CNT_SPEC>;
///Field `L1_DBUS2_CONFLICT_CNT` reader - The register records the number of access-conflicts when bus2 accesses L1-DCache.
pub type L1_DBUS2_CONFLICT_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of access-conflicts when bus2 accesses L1-DCache.
    #[inline(always)]
...
///`read()` method returns [`l1_dbus2_acs_conflict_cnt::R`](R) reader structure
