    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_ICACHE3_AUTOLOAD_CTRL")
            .field(
                ...
                &self.l1_icache3_autoload_ena().bit(),
            )
            .field(
                "l1_icache3_autoload_done",
                &self.l1_icache3_autoload_done().bit(),
            )
            .field(
                "l1_icache3_autoload_order",
                &self.l1_icache3_autoload_order().bit(),
            )
            .field(
                "l1_icache3_autoload_trigger_mode",
                &self.l1_icache3_autoload_trigger_mode().bits(),
            )
            .field(
                "l1_icache3_autoload_sct0_ena",
                &self.l1_icache3_autoload_sct0_ena().bit(),
            )
            .field(
                "l1_icache3_autoload_sct1_ena",
                &self.l1_icache3_autoload_sct1_ena().bit(),
            )
            .field(
                "l1_icache3_autoload_rgid",
                &self.l1_icache3_autoload_rgid().bits(),
            )
            .finish()
    }
}
