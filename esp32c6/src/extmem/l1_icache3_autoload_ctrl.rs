...
pub struct R(crate::R<L1_ICACHE3_AUTOLOAD_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_ICACHE3_AUTOLOAD_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_ICACHE3_AUTOLOAD_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_ICACHE3_AUTOLOAD_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L1_ICACHE3_AUTOLOAD_ENA_R = crate::BitReader<bool>;
...
pub type L1_ICACHE3_AUTOLOAD_DONE_R = crate::BitReader<bool>;
...
pub type L1_ICACHE3_AUTOLOAD_ORDER_R = crate::BitReader<bool>;
...
pub type L1_ICACHE3_AUTOLOAD_TRIGGER_MODE_R = crate::FieldReader<u8, u8>;
...
pub type L1_ICACHE3_AUTOLOAD_SCT0_ENA_R = crate::BitReader<bool>;
...
pub type L1_ICACHE3_AUTOLOAD_SCT1_ENA_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE3_AUTOLOAD_RGID` reader - The bit is used to set the gid of l1 icache3 autoload."]
pub type L1_ICACHE3_AUTOLOAD_RGID_R = crate::FieldReader<u8, u8>;
impl R {
