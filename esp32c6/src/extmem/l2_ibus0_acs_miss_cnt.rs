...
pub struct R(crate::R<L2_IBUS0_ACS_MISS_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L2_IBUS0_ACS_MISS_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L2_IBUS0_ACS_MISS_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L2_IBUS0_ACS_MISS_CNT_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L2_IBUS0_MISS_CNT_R = crate::FieldReader<u32, u32>;
impl R {
