...
pub struct R(crate::R<L1_ICACHE1_PRELOCK_CONF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_ICACHE1_PRELOCK_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_ICACHE1_PRELOCK_CONF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_ICACHE1_PRELOCK_CONF_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "L1 instruction Cache 1 prelock configure register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l1_icache1_prelock_conf](index.html) module"]
