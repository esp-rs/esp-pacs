...
///Field `L1_CACHE_CACHESIZE_1K` reader - The field is used to configure cachesize of L1-Cache as 1k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_1K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_2K` reader - The field is used to configure cachesize of L1-Cache as 2k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_2K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_4K` reader - The field is used to configure cachesize of L1-Cache as 4k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_4K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_8K` reader - The field is used to configure cachesize of L1-Cache as 8k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_8K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_16K` reader - The field is used to configure cachesize of L1-Cache as 16k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_16K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_32K` reader - The field is used to configure cachesize of L1-Cache as 32k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_32K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_64K` reader - The field is used to configure cachesize of L1-Cache as 64k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_64K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_128K` reader - The field is used to configure cachesize of L1-Cache as 128k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_128K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_256K` reader - The field is used to configure cachesize of L1-Cache as 256k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_256K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_512K` reader - The field is used to configure cachesize of L1-Cache as 512k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_512K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_1024K` reader - The field is used to configure cachesize of L1-Cache as 1024k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_1024K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_2048K` reader - The field is used to configure cachesize of L1-Cache as 2048k bytes. This field and all other fields within this register is onehot.
pub type L1_CACHE_CACHESIZE_2048K_R = crate::BitReader;
///Field `L1_CACHE_CACHESIZE_4096K` reader - The field is used to configure cachesize of L1-Cache as 4096k bytes. This field and all other fields within this register is onehot.
...
///`read()` method returns [`l1_cache_cachesize_conf::R`](R) reader structure
impl crate::Readable for L1_CACHE_CACHESIZE_CONF_SPEC {}
///`reset()` method sets L1_CACHE_CACHESIZE_CONF to value 0x20
