...
///Register `CACHE_LOCK_CTRL` writer
pub type W = crate::W<CACHE_LOCK_CTRL_SPEC>;
///Field `CACHE_LOCK_ENA` reader - The bit is used to enable lock operation. It will be cleared by hardware after lock operation done
pub type CACHE_LOCK_ENA_R = crate::BitReader;
///Field `CACHE_LOCK_ENA` writer - The bit is used to enable lock operation. It will be cleared by hardware after lock operation done
pub type CACHE_LOCK_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CACHE_UNLOCK_ENA` reader - The bit is used to enable unlock operation. It will be cleared by hardware after unlock operation done
pub type CACHE_UNLOCK_ENA_R = crate::BitReader;
///Field `CACHE_UNLOCK_ENA` writer - The bit is used to enable unlock operation. It will be cleared by hardware after unlock operation done
pub type CACHE_UNLOCK_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CACHE_LOCK_DONE` reader - The bit is used to indicate whether unlock/lock operation is finished or not. 0: not finished. 1: finished.
pub type CACHE_LOCK_DONE_R = crate::BitReader;
///Field `CACHE_LOCK_RGID` reader - The bit is used to set the gid of cache lock/unlock.
...
///`read()` method returns [`cache_lock_ctrl::R`](R) reader structure
impl crate::Readable for CACHE_LOCK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`cache_lock_ctrl::W`](W) writer structure
impl crate::Writable for CACHE_LOCK_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CACHE_LOCK_CTRL to value 0x04
