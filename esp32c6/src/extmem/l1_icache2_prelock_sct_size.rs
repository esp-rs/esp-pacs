...
pub struct R(crate::R<L1_ICACHE2_PRELOCK_SCT_SIZE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_ICACHE2_PRELOCK_SCT_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_ICACHE2_PRELOCK_SCT_SIZE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_ICACHE2_PRELOCK_SCT_SIZE_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L1_ICACHE2_PRELOCK_SCT0_SIZE_R = crate::FieldReader<u16, u16>;
...
pub type L1_ICACHE2_PRELOCK_SCT1_SIZE_R = crate::FieldReader<u16, u16>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_ICACHE2_PRELOCK_SCT_SIZE")
            .field(
                ...
                &format_args!("{}", self.l1_icache2_prelock_sct0_size().bits()),
            )
            .field(
                "l1_icache2_prelock_sct1_size",
                &format_args!("{}", self.l1_icache2_prelock_sct1_size().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<L1_ICACHE2_PRELOCK_SCT_SIZE_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "L1 instruction Cache 2 prelock section size configure register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l1_icache2_prelock_sct_size](index.html) module"]
