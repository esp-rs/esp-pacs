...
pub struct R(crate::R<L2_IBUS1_ACS_HIT_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L2_IBUS1_ACS_HIT_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L2_IBUS1_ACS_HIT_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L2_IBUS1_ACS_HIT_CNT_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L2_IBUS1_HIT_CNT_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_IBUS1_ACS_HIT_CNT")
            .field(
                "l2_ibus1_hit_cnt",
                &format_args!("{}", self.l2_ibus1_hit_cnt().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<L2_IBUS1_ACS_HIT_CNT_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "L2-Cache bus1 Hit-Access Counter register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l2_ibus1_acs_hit_cnt](index.html) module"]
