...
pub struct R(crate::R<L2_IBUS3_ACS_MISS_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L2_IBUS3_ACS_MISS_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L2_IBUS3_ACS_MISS_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L2_IBUS3_ACS_MISS_CNT_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L2_IBUS3_MISS_CNT_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "L2-Cache bus3 Miss-Access Counter register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l2_ibus3_acs_miss_cnt](index.html) module"]
