...
///Field `L1_CACHE_DATA_MEM_RD_EN` reader - The bit is used to enable config-bus read L1-Cache data memoryory. 0: disable, 1: enable.
pub type L1_CACHE_DATA_MEM_RD_EN_R = crate::BitReader;
///Field `L1_CACHE_DATA_MEM_RD_EN` writer - The bit is used to enable config-bus read L1-Cache data memoryory. 0: disable, 1: enable.
pub type L1_CACHE_DATA_MEM_RD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_CACHE_DATA_MEM_WR_EN` reader - The bit is used to enable config-bus write L1-Cache data memoryory. 0: disable, 1: enable.
pub type L1_CACHE_DATA_MEM_WR_EN_R = crate::BitReader;
///Field `L1_CACHE_DATA_MEM_WR_EN` writer - The bit is used to enable config-bus write L1-Cache data memoryory. 0: disable, 1: enable.
...
impl R {
    ...
    ///Bit 16 - The bit is used to enable config-bus read L1-Cache data memoryory. 0: disable, 1: enable.
    #[inline(always)]
    pub fn l1_cache_data_mem_rd_en(&self) -> L1_CACHE_DATA_MEM_RD_EN_R {
        L1_CACHE_DATA_MEM_RD_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    ///Bit 17 - The bit is used to enable config-bus write L1-Cache data memoryory. 0: disable, 1: enable.
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_cache_data_mem_rd_en(
        &mut self,
    ) -> L1_CACHE_DATA_MEM_RD_EN_W<L1_CACHE_DATA_MEM_ACS_CONF_SPEC> {
    ...
    pub fn l1_cache_data_mem_wr_en(
        &mut self,
    ) -> L1_CACHE_DATA_MEM_WR_EN_W<L1_CACHE_DATA_MEM_ACS_CONF_SPEC> {
