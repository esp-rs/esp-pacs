...
pub struct R(crate::R<L2_CACHE_ACS_CNT_INT_ENA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L2_CACHE_ACS_CNT_INT_ENA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L2_CACHE_ACS_CNT_INT_ENA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L2_CACHE_ACS_CNT_INT_ENA_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L2_IBUS0_OVF_INT_ENA_R = crate::BitReader<bool>;
...
pub type L2_IBUS1_OVF_INT_ENA_R = crate::BitReader<bool>;
#[doc = "Field `L2_IBUS2_OVF_INT_ENA` reader - Reserved"]
pub type L2_IBUS2_OVF_INT_ENA_R = crate::BitReader<bool>;
#[doc = "Field `L2_IBUS3_OVF_INT_ENA` reader - Reserved"]
pub type L2_IBUS3_OVF_INT_ENA_R = crate::BitReader<bool>;
...
pub type L2_DBUS0_OVF_INT_ENA_R = crate::BitReader<bool>;
...
pub type L2_DBUS1_OVF_INT_ENA_R = crate::BitReader<bool>;
#[doc = "Field `L2_DBUS2_OVF_INT_ENA` reader - Reserved"]
pub type L2_DBUS2_OVF_INT_ENA_R = crate::BitReader<bool>;
#[doc = "Field `L2_DBUS3_OVF_INT_ENA` reader - Reserved"]
pub type L2_DBUS3_OVF_INT_ENA_R = crate::BitReader<bool>;
impl R {
