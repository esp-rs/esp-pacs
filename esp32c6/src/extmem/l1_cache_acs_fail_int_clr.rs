...
pub struct R(crate::R<L1_CACHE_ACS_FAIL_INT_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_CACHE_ACS_FAIL_INT_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_CACHE_ACS_FAIL_INT_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_CACHE_ACS_FAIL_INT_CLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1_CACHE_ACS_FAIL_INT_CLR` writer"]
pub struct W(crate::W<L1_CACHE_ACS_FAIL_INT_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1_CACHE_ACS_FAIL_INT_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1_CACHE_ACS_FAIL_INT_CLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1_CACHE_ACS_FAIL_INT_CLR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type L1_ICACHE0_FAIL_INT_CLR_R = crate::BitReader<bool>;
...
pub type L1_ICACHE1_FAIL_INT_CLR_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE2_FAIL_INT_CLR` reader - Reserved"]
pub type L1_ICACHE2_FAIL_INT_CLR_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE3_FAIL_INT_CLR` reader - Reserved"]
pub type L1_ICACHE3_FAIL_INT_CLR_R = crate::BitReader<bool>;
...
pub type L1_CACHE_FAIL_INT_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, L1_CACHE_ACS_FAIL_INT_CLR_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_fail_int_clr(&mut self) -> L1_CACHE_FAIL_INT_CLR_W<4> {
        L1_CACHE_FAIL_INT_CLR_W::new(self)
    }
