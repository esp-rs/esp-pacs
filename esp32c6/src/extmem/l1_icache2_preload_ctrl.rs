...
pub struct R(crate::R<L1_ICACHE2_PRELOAD_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_ICACHE2_PRELOAD_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_ICACHE2_PRELOAD_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_ICACHE2_PRELOAD_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1_ICACHE2_PRELOAD_CTRL` writer"]
pub struct W(crate::W<L1_ICACHE2_PRELOAD_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1_ICACHE2_PRELOAD_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1_ICACHE2_PRELOAD_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1_ICACHE2_PRELOAD_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type L1_ICACHE2_PRELOAD_ENA_R = crate::BitReader<bool>;
...
pub type L1_ICACHE2_PRELOAD_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, L1_ICACHE2_PRELOAD_CTRL_SPEC, bool, O>;
...
pub type L1_ICACHE2_PRELOAD_DONE_R = crate::BitReader<bool>;
...
pub type L1_ICACHE2_PRELOAD_ORDER_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE2_PRELOAD_RGID` reader - The bit is used to set the gid of l1 icache2 preload."]
pub type L1_ICACHE2_PRELOAD_RGID_R = crate::FieldReader<u8, u8>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_icache2_preload_ena(&mut self) -> L1_ICACHE2_PRELOAD_ENA_W<0> {
        L1_ICACHE2_PRELOAD_ENA_W::new(self)
    }
