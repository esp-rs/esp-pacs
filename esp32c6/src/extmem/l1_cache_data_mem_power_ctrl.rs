...
pub struct R(crate::R<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1_CACHE_DATA_MEM_POWER_CTRL` writer"]
pub struct W(crate::W<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1_CACHE_DATA_MEM_POWER_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type L1_ICACHE0_DATA_MEM_FORCE_ON_R = crate::BitReader<bool>;
...
pub type L1_ICACHE0_DATA_MEM_FORCE_PD_R = crate::BitReader<bool>;
...
pub type L1_ICACHE0_DATA_MEM_FORCE_PU_R = crate::BitReader<bool>;
...
pub type L1_ICACHE1_DATA_MEM_FORCE_ON_R = crate::BitReader<bool>;
...
pub type L1_ICACHE1_DATA_MEM_FORCE_PD_R = crate::BitReader<bool>;
...
pub type L1_ICACHE1_DATA_MEM_FORCE_PU_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE2_DATA_MEM_FORCE_ON` reader - Reserved"]
pub type L1_ICACHE2_DATA_MEM_FORCE_ON_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE2_DATA_MEM_FORCE_PD` reader - Reserved"]
pub type L1_ICACHE2_DATA_MEM_FORCE_PD_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE2_DATA_MEM_FORCE_PU` reader - Reserved"]
pub type L1_ICACHE2_DATA_MEM_FORCE_PU_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE3_DATA_MEM_FORCE_ON` reader - Reserved"]
pub type L1_ICACHE3_DATA_MEM_FORCE_ON_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE3_DATA_MEM_FORCE_PD` reader - Reserved"]
pub type L1_ICACHE3_DATA_MEM_FORCE_PD_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE3_DATA_MEM_FORCE_PU` reader - Reserved"]
pub type L1_ICACHE3_DATA_MEM_FORCE_PU_R = crate::BitReader<bool>;
...
pub type L1_CACHE_DATA_MEM_FORCE_ON_R = crate::BitReader<bool>;
...
pub type L1_CACHE_DATA_MEM_FORCE_ON_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, L1_CACHE_DATA_MEM_POWER_CTRL_SPEC, bool, O>;
...
pub type L1_CACHE_DATA_MEM_FORCE_PD_R = crate::BitReader<bool>;
...
pub type L1_CACHE_DATA_MEM_FORCE_PD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, L1_CACHE_DATA_MEM_POWER_CTRL_SPEC, bool, O>;
...
pub type L1_CACHE_DATA_MEM_FORCE_PU_R = crate::BitReader<bool>;
...
pub type L1_CACHE_DATA_MEM_FORCE_PU_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, L1_CACHE_DATA_MEM_POWER_CTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_data_mem_force_on(&mut self) -> L1_CACHE_DATA_MEM_FORCE_ON_W<16> {
        L1_CACHE_DATA_MEM_FORCE_ON_W::new(self)
    }
    #[doc = "Bit 17 - The bit is used to power L1-Cache data memory down. 0: follow rtc_lslp, 1: power down"]
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_data_mem_force_pd(&mut self) -> L1_CACHE_DATA_MEM_FORCE_PD_W<17> {
        L1_CACHE_DATA_MEM_FORCE_PD_W::new(self)
    }
    #[doc = "Bit 18 - The bit is used to power L1-Cache data memory up. 0: follow rtc_lslp, 1: power up"]
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_data_mem_force_pu(&mut self) -> L1_CACHE_DATA_MEM_FORCE_PU_W<18> {
