///Register `L2_IBUS2_ACS_NXTLVL_CNT` reader
pub type R = crate::R<L2_IBUS2_ACS_NXTLVL_CNT_SPEC>;
///Field `L2_IBUS2_NXTLVL_CNT` reader - The register records the number of times that L2-Cache accesses external memory due to L1-ICache2 accessing L2-Cache due to bus2 accessing L1-ICache2.
...
///`read()` method returns [`l2_ibus2_acs_nxtlvl_cnt::R`](R) reader structure
impl crate::Readable for L2_IBUS2_ACS_NXTLVL_CNT_SPEC {}
///`reset()` method sets L2_IBUS2_ACS_NXTLVL_CNT to value 0
