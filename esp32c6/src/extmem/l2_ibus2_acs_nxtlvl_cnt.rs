...
pub struct R(crate::R<L2_IBUS2_ACS_NXTLVL_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L2_IBUS2_ACS_NXTLVL_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L2_IBUS2_ACS_NXTLVL_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L2_IBUS2_ACS_NXTLVL_CNT_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L2_IBUS2_NXTLVL_CNT_R = crate::FieldReader<u32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L2_IBUS2_ACS_NXTLVL_CNT")
            .field(
                "l2_ibus2_nxtlvl_cnt",
                &format_args!("{}", self.l2_ibus2_nxtlvl_cnt().bits()),
            )
            .finish()
    }
}
...
#[doc = "L2-Cache bus2 Next-Level-Access Counter register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l2_ibus2_acs_nxtlvl_cnt](index.html) module"]
