...
///Register `L1_ICACHE3_PRELOAD_CTRL` writer
...
///Field `L1_ICACHE3_PRELOAD_ENA` writer - The bit is used to enable preload operation on L1-ICache3. It will be cleared by hardware automatically after preload operation is done.
...
You can [`read`](crate::generic::Reg::read) this register and get [`l1_icache3_preload_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`l1_icache3_preload_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
...
///`write(|w| ..)` method takes [`l1_icache3_preload_ctrl::W`](W) writer structure
