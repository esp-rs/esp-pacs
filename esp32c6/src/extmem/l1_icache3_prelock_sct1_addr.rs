///Register `L1_ICACHE3_PRELOCK_SCT1_ADDR` reader
pub type R = crate::R<L1_ICACHE3_PRELOCK_SCT1_ADDR_SPEC>;
///Field `L1_ICACHE3_PRELOCK_SCT1_ADDR` reader - Those bits are used to configure the start virtual address of the second section of prelock on L1-ICache3, which should be used together with L1_ICACHE3_PRELOCK_SCT1_SIZE_REG
pub type L1_ICACHE3_PRELOCK_SCT1_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Those bits are used to configure the start virtual address of the second section of prelock on L1-ICache3, which should be used together with L1_ICACHE3_PRELOCK_SCT1_SIZE_REG
    #[inline(always)]
...
///`read()` method returns [`l1_icache3_prelock_sct1_addr::R`](R) reader structure
