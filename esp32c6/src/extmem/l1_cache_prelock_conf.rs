///Register `L1_CACHE_PRELOCK_CONF` reader
pub type R = crate::R<L1_CACHE_PRELOCK_CONF_SPEC>;
///Register `L1_CACHE_PRELOCK_CONF` writer
pub type W = crate::W<L1_CACHE_PRELOCK_CONF_SPEC>;
///Field `L1_CACHE_PRELOCK_SCT0_EN` reader - The bit is used to enable the first section of prelock function on L1-Cache.
pub type L1_CACHE_PRELOCK_SCT0_EN_R = crate::BitReader;
///Field `L1_CACHE_PRELOCK_SCT0_EN` writer - The bit is used to enable the first section of prelock function on L1-Cache.
pub type L1_CACHE_PRELOCK_SCT0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_CACHE_PRELOCK_SCT1_EN` reader - The bit is used to enable the second section of prelock function on L1-Cache.
pub type L1_CACHE_PRELOCK_SCT1_EN_R = crate::BitReader;
///Field `L1_CACHE_PRELOCK_SCT1_EN` writer - The bit is used to enable the second section of prelock function on L1-Cache.
pub type L1_CACHE_PRELOCK_SCT1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L1_CACHE_PRELOCK_RGID` reader - The bit is used to set the gid of l1 cache prelock.
...
///`read()` method returns [`l1_cache_prelock_conf::R`](R) reader structure
impl crate::Readable for L1_CACHE_PRELOCK_CONF_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_prelock_conf::W`](W) writer structure
impl crate::Writable for L1_CACHE_PRELOCK_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L1_CACHE_PRELOCK_CONF to value 0
