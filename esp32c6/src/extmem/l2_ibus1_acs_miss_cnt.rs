///Register `L2_IBUS1_ACS_MISS_CNT` reader
pub type R = crate::R<L2_IBUS1_ACS_MISS_CNT_SPEC>;
///Field `L2_IBUS1_MISS_CNT` reader - The register records the number of missing when L1-ICache1 accesses L2-Cache due to bus1 accessing L1-ICache1.
pub type L2_IBUS1_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of missing when L1-ICache1 accesses L2-Cache due to bus1 accessing L1-ICache1.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`l2_ibus1_acs_miss_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L2_IBUS1_ACS_MISS_CNT_SPEC;
impl crate::RegisterSpec for L2_IBUS1_ACS_MISS_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l2_ibus1_acs_miss_cnt::R`](R) reader structure
