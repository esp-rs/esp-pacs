///Register `L1_ICACHE3_PRELOCK_SCT_SIZE` reader
pub type R = crate::R<L1_ICACHE3_PRELOCK_SCT_SIZE_SPEC>;
///Field `L1_ICACHE3_PRELOCK_SCT0_SIZE` reader - Those bits are used to configure the size of the first section of prelock on L1-ICache3, which should be used together with L1_ICACHE3_PRELOCK_SCT0_ADDR_REG
pub type L1_ICACHE3_PRELOCK_SCT0_SIZE_R = crate::FieldReader<u16>;
///Field `L1_ICACHE3_PRELOCK_SCT1_SIZE` reader - Those bits are used to configure the size of the second section of prelock on L1-ICache3, which should be used together with L1_ICACHE3_PRELOCK_SCT1_ADDR_REG
pub type L1_ICACHE3_PRELOCK_SCT1_SIZE_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:13 - Those bits are used to configure the size of the first section of prelock on L1-ICache3, which should be used together with L1_ICACHE3_PRELOCK_SCT0_ADDR_REG
    #[inline(always)]
    ...
    ///Bits 16:29 - Those bits are used to configure the size of the second section of prelock on L1-ICache3, which should be used together with L1_ICACHE3_PRELOCK_SCT1_ADDR_REG
    #[inline(always)]
...
///`read()` method returns [`l1_icache3_prelock_sct_size::R`](R) reader structure
