///Register `L1_ICACHE3_PRELOAD_ADDR` reader
pub type R = crate::R<L1_ICACHE3_PRELOAD_ADDR_SPEC>;
///Field `L1_ICACHE3_PRELOAD_ADDR` reader - Those bits are used to configure the start virtual address of preload on L1-ICache3, which should be used together with L1_ICACHE3_PRELOAD_SIZE_REG
pub type L1_ICACHE3_PRELOAD_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Those bits are used to configure the start virtual address of preload on L1-ICache3, which should be used together with L1_ICACHE3_PRELOAD_SIZE_REG
    #[inline(always)]
...
///`read()` method returns [`l1_icache3_preload_addr::R`](R) reader structure
