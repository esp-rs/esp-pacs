///Register `L2_DBUS0_ACS_NXTLVL_CNT` reader
pub type R = crate::R<L2_DBUS0_ACS_NXTLVL_CNT_SPEC>;
///Field `L2_DBUS0_NXTLVL_CNT` reader - The register records the number of times that L2-Cache accesses external memory due to L1-DCache accessing L2-Cache due to bus0 accessing L1-DCache.
...
///`read()` method returns [`l2_dbus0_acs_nxtlvl_cnt::R`](R) reader structure
impl crate::Readable for L2_DBUS0_ACS_NXTLVL_CNT_SPEC {}
///`reset()` method sets L2_DBUS0_ACS_NXTLVL_CNT to value 0
