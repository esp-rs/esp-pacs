///Register `L1_CACHE_ACS_FAIL_ID_ATTR` reader
pub type R = crate::R<L1_CACHE_ACS_FAIL_ID_ATTR_SPEC>;
///Field `L1_CACHE_FAIL_ID` reader - The register records the ID of fail-access when cache accesses L1-Cache.
pub type L1_CACHE_FAIL_ID_R = crate::FieldReader<u16>;
///Field `L1_CACHE_FAIL_ATTR` reader - The register records the attribution of fail-access when cache accesses L1-Cache.
pub type L1_CACHE_FAIL_ATTR_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:15 - The register records the ID of fail-access when cache accesses L1-Cache.
    #[inline(always)]
    pub fn l1_cache_fail_id(&self) -> L1_CACHE_FAIL_ID_R {
        L1_CACHE_FAIL_ID_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - The register records the attribution of fail-access when cache accesses L1-Cache.
    #[inline(always)]
...
///`read()` method returns [`l1_cache_acs_fail_id_attr::R`](R) reader structure
impl crate::Readable for L1_CACHE_ACS_FAIL_ID_ATTR_SPEC {}
///`reset()` method sets L1_CACHE_ACS_FAIL_ID_ATTR to value 0
