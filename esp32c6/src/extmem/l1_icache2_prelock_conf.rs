///Register `L1_ICACHE2_PRELOCK_CONF` reader
pub type R = crate::R<L1_ICACHE2_PRELOCK_CONF_SPEC>;
///Field `L1_ICACHE2_PRELOCK_SCT0_EN` reader - The bit is used to enable the first section of prelock function on L1-ICache2.
pub type L1_ICACHE2_PRELOCK_SCT0_EN_R = crate::BitReader;
///Field `L1_ICACHE2_PRELOCK_SCT1_EN` reader - The bit is used to enable the second section of prelock function on L1-ICache2.
pub type L1_ICACHE2_PRELOCK_SCT1_EN_R = crate::BitReader;
///Field `L1_ICACHE2_PRELOCK_RGID` reader - The bit is used to set the gid of l1 icache2 prelock.
pub type L1_ICACHE2_PRELOCK_RGID_R = crate::FieldReader;
impl R {
    ///Bit 0 - The bit is used to enable the first section of prelock function on L1-ICache2.
    #[inline(always)]
    pub fn l1_icache2_prelock_sct0_en(&self) -> L1_ICACHE2_PRELOCK_SCT0_EN_R {
        L1_ICACHE2_PRELOCK_SCT0_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit is used to enable the second section of prelock function on L1-ICache2.
    #[inline(always)]
    pub fn l1_icache2_prelock_sct1_en(&self) -> L1_ICACHE2_PRELOCK_SCT1_EN_R {
        L1_ICACHE2_PRELOCK_SCT1_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:5 - The bit is used to set the gid of l1 icache2 prelock.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`l1_icache2_prelock_conf::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L1_ICACHE2_PRELOCK_CONF_SPEC;
impl crate::RegisterSpec for L1_ICACHE2_PRELOCK_CONF_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l1_icache2_prelock_conf::R`](R) reader structure
