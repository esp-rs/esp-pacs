...
pub type L1_ICACHE2_PRELOCK_SCT0_EN_R = crate::BitReader<bool>;
...
pub type L1_ICACHE2_PRELOCK_SCT1_EN_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE2_PRELOCK_RGID` reader - The bit is used to set the gid of l1 icache2 prelock."]
pub type L1_ICACHE2_PRELOCK_RGID_R = crate::FieldReader<u8, u8>;
impl R {
