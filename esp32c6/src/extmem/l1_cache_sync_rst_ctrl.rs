...
pub struct R(crate::R<L1_CACHE_SYNC_RST_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_CACHE_SYNC_RST_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_CACHE_SYNC_RST_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_CACHE_SYNC_RST_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1_CACHE_SYNC_RST_CTRL` writer"]
pub struct W(crate::W<L1_CACHE_SYNC_RST_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1_CACHE_SYNC_RST_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1_CACHE_SYNC_RST_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1_CACHE_SYNC_RST_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type L1_ICACHE0_SYNC_RST_R = crate::BitReader<bool>;
...
pub type L1_ICACHE1_SYNC_RST_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE2_SYNC_RST` reader - Reserved"]
pub type L1_ICACHE2_SYNC_RST_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE3_SYNC_RST` reader - Reserved"]
pub type L1_ICACHE3_SYNC_RST_R = crate::BitReader<bool>;
...
pub type L1_CACHE_SYNC_RST_R = crate::BitReader<bool>;
...
pub type L1_CACHE_SYNC_RST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, L1_CACHE_SYNC_RST_CTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_sync_rst(&mut self) -> L1_CACHE_SYNC_RST_W<4> {
        L1_CACHE_SYNC_RST_W::new(self)
    }
