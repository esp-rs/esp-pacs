...
pub type L1_CACHE_SYNC_RST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_sync_rst(&mut self) -> L1_CACHE_SYNC_RST_W<L1_CACHE_SYNC_RST_CTRL_SPEC, 4> {
