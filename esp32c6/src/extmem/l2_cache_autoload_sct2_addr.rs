...
pub struct R(crate::R<L2_CACHE_AUTOLOAD_SCT2_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L2_CACHE_AUTOLOAD_SCT2_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L2_CACHE_AUTOLOAD_SCT2_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L2_CACHE_AUTOLOAD_SCT2_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L2_CACHE_AUTOLOAD_SCT2_ADDR_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "L2 Cache autoload section 2 address configure register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l2_cache_autoload_sct2_addr](index.html) module"]
