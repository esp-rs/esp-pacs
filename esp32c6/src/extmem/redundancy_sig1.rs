///Register `REDUNDANCY_SIG1` reader
pub type R = crate::R<REDUNDANCY_SIG1_SPEC>;
///Register `REDUNDANCY_SIG1` writer
pub type W = crate::W<REDUNDANCY_SIG1_SPEC>;
///Field `CACHE_REDCY_SIG1` reader - Those bits are prepared for ECO.
pub type CACHE_REDCY_SIG1_R = crate::FieldReader<u32>;
///Field `CACHE_REDCY_SIG1` writer - Those bits are prepared for ECO.
...
///`read()` method returns [`redundancy_sig1::R`](R) reader structure
impl crate::Readable for REDUNDANCY_SIG1_SPEC {}
///`write(|w| ..)` method takes [`redundancy_sig1::W`](W) writer structure
