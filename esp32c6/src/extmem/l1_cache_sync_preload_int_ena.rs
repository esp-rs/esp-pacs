///Register `L1_CACHE_SYNC_PRELOAD_INT_ENA` reader
pub type R = crate::R<L1_CACHE_SYNC_PRELOAD_INT_ENA_SPEC>;
///Register `L1_CACHE_SYNC_PRELOAD_INT_ENA` writer
...
///Field `L1_CACHE_PLD_DONE_INT_ENA` reader - The bit is used to enable interrupt of L1-Cache preload-operation. If preload operation is done, interrupt occurs.
pub type L1_CACHE_PLD_DONE_INT_ENA_R = crate::BitReader;
///Field `L1_CACHE_PLD_DONE_INT_ENA` writer - The bit is used to enable interrupt of L1-Cache preload-operation. If preload operation is done, interrupt occurs.
pub type L1_CACHE_PLD_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CACHE_SYNC_DONE_INT_ENA` reader - The bit is used to enable interrupt of Cache sync-operation done.
pub type CACHE_SYNC_DONE_INT_ENA_R = crate::BitReader;
///Field `CACHE_SYNC_DONE_INT_ENA` writer - The bit is used to enable interrupt of Cache sync-operation done.
...
///Field `L1_CACHE_PLD_ERR_INT_ENA` reader - The bit is used to enable interrupt of L1-Cache preload-operation error.
pub type L1_CACHE_PLD_ERR_INT_ENA_R = crate::BitReader;
///Field `L1_CACHE_PLD_ERR_INT_ENA` writer - The bit is used to enable interrupt of L1-Cache preload-operation error.
pub type L1_CACHE_PLD_ERR_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CACHE_SYNC_ERR_INT_ENA` reader - The bit is used to enable interrupt of Cache sync-operation error.
pub type CACHE_SYNC_ERR_INT_ENA_R = crate::BitReader;
///Field `CACHE_SYNC_ERR_INT_ENA` writer - The bit is used to enable interrupt of Cache sync-operation error.
...
impl R {
    ...
    ///Bit 4 - The bit is used to enable interrupt of L1-Cache preload-operation. If preload operation is done, interrupt occurs.
    #[inline(always)]
    ...
    ///Bit 11 - The bit is used to enable interrupt of L1-Cache preload-operation error.
    #[inline(always)]
...
///`read()` method returns [`l1_cache_sync_preload_int_ena::R`](R) reader structure
impl crate::Readable for L1_CACHE_SYNC_PRELOAD_INT_ENA_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_sync_preload_int_ena::W`](W) writer structure
impl crate::Writable for L1_CACHE_SYNC_PRELOAD_INT_ENA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L1_CACHE_SYNC_PRELOAD_INT_ENA to value 0
