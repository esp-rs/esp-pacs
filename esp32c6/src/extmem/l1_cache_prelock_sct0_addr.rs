...
pub struct R(crate::R<L1_CACHE_PRELOCK_SCT0_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_CACHE_PRELOCK_SCT0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_CACHE_PRELOCK_SCT0_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_CACHE_PRELOCK_SCT0_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1_CACHE_PRELOCK_SCT0_ADDR` writer"]
pub struct W(crate::W<L1_CACHE_PRELOCK_SCT0_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1_CACHE_PRELOCK_SCT0_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1_CACHE_PRELOCK_SCT0_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1_CACHE_PRELOCK_SCT0_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type L1_CACHE_PRELOCK_SCT0_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type L1_CACHE_PRELOCK_SCT0_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, L1_CACHE_PRELOCK_SCT0_ADDR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_prelock_sct0_addr(&mut self) -> L1_CACHE_PRELOCK_SCT0_ADDR_W<0> {
