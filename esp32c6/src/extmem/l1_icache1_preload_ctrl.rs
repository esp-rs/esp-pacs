...
pub type L1_ICACHE1_PRELOAD_ENA_R = crate::BitReader<bool>;
...
pub type L1_ICACHE1_PRELOAD_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, L1_ICACHE1_PRELOAD_CTRL_SPEC, bool, O>;
...
pub type L1_ICACHE1_PRELOAD_DONE_R = crate::BitReader<bool>;
...
pub type L1_ICACHE1_PRELOAD_ORDER_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE1_PRELOAD_RGID` reader - The bit is used to set the gid of l1 icache1 preload."]
pub type L1_ICACHE1_PRELOAD_RGID_R = crate::FieldReader<u8, u8>;
impl R {
