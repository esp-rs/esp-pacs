///Register `LEVEL_SPLIT0` reader
pub type R = crate::R<LEVEL_SPLIT0_SPEC>;
///Field `LEVEL_SPLIT0` reader - Reserved
...
///`read()` method returns [`level_split0::R`](R) reader structure
impl crate::Readable for LEVEL_SPLIT0_SPEC {}
///`reset()` method sets LEVEL_SPLIT0 to value 0x0258
