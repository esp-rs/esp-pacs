///Register `L1_ICACHE3_PRELOAD_SIZE` reader
pub type R = crate::R<L1_ICACHE3_PRELOAD_SIZE_SPEC>;
///Field `L1_ICACHE3_PRELOAD_SIZE` reader - Those bits are used to configure the size of the first section of prelock on L1-ICache3, which should be used together with L1_ICACHE3_PRELOAD_ADDR_REG
pub type L1_ICACHE3_PRELOAD_SIZE_R = crate::FieldReader<u16>;
impl R {
    ///Bits 0:13 - Those bits are used to configure the size of the first section of prelock on L1-ICache3, which should be used together with L1_ICACHE3_PRELOAD_ADDR_REG
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`l1_icache3_preload_size::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L1_ICACHE3_PRELOAD_SIZE_SPEC;
impl crate::RegisterSpec for L1_ICACHE3_PRELOAD_SIZE_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l1_icache3_preload_size::R`](R) reader structure
