///Register `L1_IBUS2_ACS_NXTLVL_CNT` reader
pub type R = crate::R<L1_IBUS2_ACS_NXTLVL_CNT_SPEC>;
///Field `L1_IBUS2_NXTLVL_CNT` reader - The register records the number of times that L1-ICache accesses L2-Cache due to bus2 accessing L1-ICache2.
...
///`read()` method returns [`l1_ibus2_acs_nxtlvl_cnt::R`](R) reader structure
impl crate::Readable for L1_IBUS2_ACS_NXTLVL_CNT_SPEC {}
///`reset()` method sets L1_IBUS2_ACS_NXTLVL_CNT to value 0
