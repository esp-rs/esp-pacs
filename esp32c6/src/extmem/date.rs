...
#[doc = "Field `DATE` reader - version control register. Note that this default value stored is the latest date when the hardware logic was updated."]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - version control register. Note that this default value stored is the latest date when the hardware logic was updated."]
...
#[doc = "`reset()` method sets DATE to value 0x0220_2080"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_2080;
}
