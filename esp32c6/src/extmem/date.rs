...
///Field `DATE` reader - version control register. Note that this default value stored is the latest date when the hardware logic was updated.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - version control register. Note that this default value stored is the latest date when the hardware logic was updated.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - version control register. Note that this default value stored is the latest date when the hardware logic was updated.
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x0220_2080
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0220_2080;
}
