///Register `L1_CACHE_AUTOLOAD_SCT0_ADDR` reader
pub type R = crate::R<L1_CACHE_AUTOLOAD_SCT0_ADDR_SPEC>;
///Register `L1_CACHE_AUTOLOAD_SCT0_ADDR` writer
pub type W = crate::W<L1_CACHE_AUTOLOAD_SCT0_ADDR_SPEC>;
///Field `L1_CACHE_AUTOLOAD_SCT0_ADDR` reader - Those bits are used to configure the start virtual address of the first section for autoload operation on L1-Cache. Note that it should be used together with L1_CACHE_AUTOLOAD_SCT0_SIZE and L1_CACHE_AUTOLOAD_SCT0_ENA.
pub type L1_CACHE_AUTOLOAD_SCT0_ADDR_R = crate::FieldReader<u32>;
///Field `L1_CACHE_AUTOLOAD_SCT0_ADDR` writer - Those bits are used to configure the start virtual address of the first section for autoload operation on L1-Cache. Note that it should be used together with L1_CACHE_AUTOLOAD_SCT0_SIZE and L1_CACHE_AUTOLOAD_SCT0_ENA.
pub type L1_CACHE_AUTOLOAD_SCT0_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Those bits are used to configure the start virtual address of the first section for autoload operation on L1-Cache. Note that it should be used together with L1_CACHE_AUTOLOAD_SCT0_SIZE and L1_CACHE_AUTOLOAD_SCT0_ENA.
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_cache_autoload_sct0_addr(
        &mut self,
    ) -> L1_CACHE_AUTOLOAD_SCT0_ADDR_W<L1_CACHE_AUTOLOAD_SCT0_ADDR_SPEC> {
...
///`read()` method returns [`l1_cache_autoload_sct0_addr::R`](R) reader structure
impl crate::Readable for L1_CACHE_AUTOLOAD_SCT0_ADDR_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_autoload_sct0_addr::W`](W) writer structure
impl crate::Writable for L1_CACHE_AUTOLOAD_SCT0_ADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L1_CACHE_AUTOLOAD_SCT0_ADDR to value 0
