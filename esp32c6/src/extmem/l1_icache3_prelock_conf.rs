...
pub struct R(crate::R<L1_ICACHE3_PRELOCK_CONF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_ICACHE3_PRELOCK_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_ICACHE3_PRELOCK_CONF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_ICACHE3_PRELOCK_CONF_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L1_ICACHE3_PRELOCK_SCT0_EN_R = crate::BitReader<bool>;
...
pub type L1_ICACHE3_PRELOCK_SCT1_EN_R = crate::BitReader<bool>;
#[doc = "Field `L1_ICACHE3_PRELOCK_RGID` reader - The bit is used to set the gid of l1 icache3 prelock."]
pub type L1_ICACHE3_PRELOCK_RGID_R = crate::FieldReader<u8, u8>;
impl R {
...
#[doc = "L1 instruction Cache 3 prelock configure register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l1_icache3_prelock_conf](index.html) module"]
