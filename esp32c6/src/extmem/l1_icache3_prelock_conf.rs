///Register `L1_ICACHE3_PRELOCK_CONF` reader
pub type R = crate::R<L1_ICACHE3_PRELOCK_CONF_SPEC>;
///Field `L1_ICACHE3_PRELOCK_SCT0_EN` reader - The bit is used to enable the first section of prelock function on L1-ICache3.
pub type L1_ICACHE3_PRELOCK_SCT0_EN_R = crate::BitReader;
///Field `L1_ICACHE3_PRELOCK_SCT1_EN` reader - The bit is used to enable the second section of prelock function on L1-ICache3.
pub type L1_ICACHE3_PRELOCK_SCT1_EN_R = crate::BitReader;
///Field `L1_ICACHE3_PRELOCK_RGID` reader - The bit is used to set the gid of l1 icache3 prelock.
pub type L1_ICACHE3_PRELOCK_RGID_R = crate::FieldReader;
impl R {
    ///Bit 0 - The bit is used to enable the first section of prelock function on L1-ICache3.
    #[inline(always)]
    pub fn l1_icache3_prelock_sct0_en(&self) -> L1_ICACHE3_PRELOCK_SCT0_EN_R {
        L1_ICACHE3_PRELOCK_SCT0_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit is used to enable the second section of prelock function on L1-ICache3.
    #[inline(always)]
    pub fn l1_icache3_prelock_sct1_en(&self) -> L1_ICACHE3_PRELOCK_SCT1_EN_R {
        L1_ICACHE3_PRELOCK_SCT1_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:5 - The bit is used to set the gid of l1 icache3 prelock.
    #[inline(always)]
...
///`read()` method returns [`l1_icache3_prelock_conf::R`](R) reader structure
