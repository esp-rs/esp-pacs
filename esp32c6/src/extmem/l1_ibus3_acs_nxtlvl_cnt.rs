///Register `L1_IBUS3_ACS_NXTLVL_CNT` reader
pub type R = crate::R<L1_IBUS3_ACS_NXTLVL_CNT_SPEC>;
///Field `L1_IBUS3_NXTLVL_CNT` reader - The register records the number of times that L1-ICache accesses L2-Cache due to bus3 accessing L1-ICache3.
...
You can [`read`](crate::generic::Reg::read) this register and get [`l1_ibus3_acs_nxtlvl_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L1_IBUS3_ACS_NXTLVL_CNT_SPEC;
impl crate::RegisterSpec for L1_IBUS3_ACS_NXTLVL_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l1_ibus3_acs_nxtlvl_cnt::R`](R) reader structure
impl crate::Readable for L1_IBUS3_ACS_NXTLVL_CNT_SPEC {}
///`reset()` method sets L1_IBUS3_ACS_NXTLVL_CNT to value 0
