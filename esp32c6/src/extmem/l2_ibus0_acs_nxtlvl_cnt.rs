///Register `L2_IBUS0_ACS_NXTLVL_CNT` reader
pub type R = crate::R<L2_IBUS0_ACS_NXTLVL_CNT_SPEC>;
///Field `L2_IBUS0_NXTLVL_CNT` reader - The register records the number of times that L2-Cache accesses external memory due to L1-ICache0 accessing L2-Cache due to bus0 accessing L1-ICache0.
...
You can [`read`](crate::generic::Reg::read) this register and get [`l2_ibus0_acs_nxtlvl_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L2_IBUS0_ACS_NXTLVL_CNT_SPEC;
impl crate::RegisterSpec for L2_IBUS0_ACS_NXTLVL_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l2_ibus0_acs_nxtlvl_cnt::R`](R) reader structure
impl crate::Readable for L2_IBUS0_ACS_NXTLVL_CNT_SPEC {}
///`reset()` method sets L2_IBUS0_ACS_NXTLVL_CNT to value 0
