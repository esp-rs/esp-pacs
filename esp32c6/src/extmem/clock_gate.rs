...
///Field `CLK_EN` reader - The bit is used to enable clock gate when access all registers in this module.
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - The bit is used to enable clock gate when access all registers in this module.
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - The bit is used to enable clock gate when access all registers in this module.
    #[inline(always)]
