///Register `L2_CACHE_ACS_CNT_INT_ST` reader
pub type R = crate::R<L2_CACHE_ACS_CNT_INT_ST_SPEC>;
///Field `L2_IBUS0_OVF_INT_ST` reader - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache.
pub type L2_IBUS0_OVF_INT_ST_R = crate::BitReader;
///Field `L2_IBUS1_OVF_INT_ST` reader - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache.
pub type L2_IBUS1_OVF_INT_ST_R = crate::BitReader;
///Field `L2_IBUS2_OVF_INT_ST` reader - Reserved
pub type L2_IBUS2_OVF_INT_ST_R = crate::BitReader;
///Field `L2_IBUS3_OVF_INT_ST` reader - Reserved
pub type L2_IBUS3_OVF_INT_ST_R = crate::BitReader;
///Field `L2_DBUS0_OVF_INT_ST` reader - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache.
pub type L2_DBUS0_OVF_INT_ST_R = crate::BitReader;
///Field `L2_DBUS1_OVF_INT_ST` reader - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache.
pub type L2_DBUS1_OVF_INT_ST_R = crate::BitReader;
///Field `L2_DBUS2_OVF_INT_ST` reader - Reserved
pub type L2_DBUS2_OVF_INT_ST_R = crate::BitReader;
///Field `L2_DBUS3_OVF_INT_ST` reader - Reserved
pub type L2_DBUS3_OVF_INT_ST_R = crate::BitReader;
impl R {
    ///Bit 8 - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache.
    #[inline(always)]
    pub fn l2_ibus0_ovf_int_st(&self) -> L2_IBUS0_OVF_INT_ST_R {
        L2_IBUS0_OVF_INT_ST_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache.
    #[inline(always)]
    ...
    ///Bit 12 - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache.
    #[inline(always)]
    pub fn l2_dbus0_ovf_int_st(&self) -> L2_DBUS0_OVF_INT_ST_R {
        L2_DBUS0_OVF_INT_ST_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 13 - The bit indicates the interrupt status of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache.
    #[inline(always)]
...
///`read()` method returns [`l2_cache_acs_cnt_int_st::R`](R) reader structure
