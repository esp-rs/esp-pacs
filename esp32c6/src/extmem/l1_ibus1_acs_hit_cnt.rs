...
pub struct R(crate::R<L1_IBUS1_ACS_HIT_CNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_IBUS1_ACS_HIT_CNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_IBUS1_ACS_HIT_CNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_IBUS1_ACS_HIT_CNT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "L1-ICache bus1 Hit-Access Counter register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l1_ibus1_acs_hit_cnt](index.html) module"]
