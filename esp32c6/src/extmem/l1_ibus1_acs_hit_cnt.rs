///Register `L1_IBUS1_ACS_HIT_CNT` reader
pub type R = crate::R<L1_IBUS1_ACS_HIT_CNT_SPEC>;
///Field `L1_IBUS1_HIT_CNT` reader - The register records the number of hits when bus1 accesses L1-ICache1.
pub type L1_IBUS1_HIT_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of hits when bus1 accesses L1-ICache1.
    #[inline(always)]
...
///`read()` method returns [`l1_ibus1_acs_hit_cnt::R`](R) reader structure
