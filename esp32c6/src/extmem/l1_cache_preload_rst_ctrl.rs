...
///Field `L1_CACHE_PLD_RST` reader - set this bit to reset preload-logic inside L1-Cache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
pub type L1_CACHE_PLD_RST_R = crate::BitReader;
///Field `L1_CACHE_PLD_RST` writer - set this bit to reset preload-logic inside L1-Cache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs.
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_pld_rst(&mut self) -> L1_CACHE_PLD_RST_W<L1_CACHE_PRELOAD_RST_CTRL_SPEC> {
