///Register `L2_IBUS1_ACS_NXTLVL_CNT` reader
pub type R = crate::R<L2_IBUS1_ACS_NXTLVL_CNT_SPEC>;
///Field `L2_IBUS1_NXTLVL_CNT` reader - The register records the number of times that L2-Cache accesses external memory due to L1-ICache1 accessing L2-Cache due to bus1 accessing L1-ICache1.
...
///`read()` method returns [`l2_ibus1_acs_nxtlvl_cnt::R`](R) reader structure
impl crate::Readable for L2_IBUS1_ACS_NXTLVL_CNT_SPEC {}
///`reset()` method sets L2_IBUS1_ACS_NXTLVL_CNT to value 0
