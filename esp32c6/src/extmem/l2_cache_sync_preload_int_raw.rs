...
///Field `L2_CACHE_PLD_DONE_INT_RAW` reader - The raw bit of the interrupt that occurs only when L2-Cache preload-operation is done.
pub type L2_CACHE_PLD_DONE_INT_RAW_R = crate::BitReader;
///Field `L2_CACHE_PLD_DONE_INT_RAW` writer - The raw bit of the interrupt that occurs only when L2-Cache preload-operation is done.
pub type L2_CACHE_PLD_DONE_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `L2_CACHE_PLD_ERR_INT_RAW` reader - The raw bit of the interrupt that occurs only when L2-Cache preload-operation error occurs.
pub type L2_CACHE_PLD_ERR_INT_RAW_R = crate::BitReader;
///Field `L2_CACHE_PLD_ERR_INT_RAW` writer - The raw bit of the interrupt that occurs only when L2-Cache preload-operation error occurs.
...
///`read()` method returns [`l2_cache_sync_preload_int_raw::R`](R) reader structure
impl crate::Readable for L2_CACHE_SYNC_PRELOAD_INT_RAW_SPEC {}
///`write(|w| ..)` method takes [`l2_cache_sync_preload_int_raw::W`](W) writer structure
