...
pub struct W(crate::W<L2_CACHE_SYNC_PRELOAD_INT_RAW_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L2_CACHE_SYNC_PRELOAD_INT_RAW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L2_CACHE_SYNC_PRELOAD_INT_RAW_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L2_CACHE_SYNC_PRELOAD_INT_RAW_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type L2_CACHE_PLD_DONE_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, L2_CACHE_SYNC_PRELOAD_INT_RAW_SPEC, bool, O>;
...
pub type L2_CACHE_PLD_ERR_INT_RAW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, L2_CACHE_SYNC_PRELOAD_INT_RAW_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l2_cache_pld_done_int_raw(&mut self) -> L2_CACHE_PLD_DONE_INT_RAW_W<5> {
        L2_CACHE_PLD_DONE_INT_RAW_W::new(self)
    }
    #[doc = "Bit 12 - The raw bit of the interrupt that occurs only when L2-Cache preload-operation error occurs."]
    #[inline(always)]
    #[must_use]
    pub fn l2_cache_pld_err_int_raw(&mut self) -> L2_CACHE_PLD_ERR_INT_RAW_W<12> {
