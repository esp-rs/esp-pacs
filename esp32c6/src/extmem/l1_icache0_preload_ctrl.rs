...
pub type L1_ICACHE0_PRELOAD_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, L1_ICACHE0_PRELOAD_CTRL_SPEC, O>;
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_ICACHE0_PRELOAD_CTRL")
            .field(
                ...
                &format_args!("{}", self.l1_icache0_preload_ena().bit()),
            )
            .field(
                "l1_icache0_preload_done",
                &format_args!("{}", self.l1_icache0_preload_done().bit()),
            )
            .field(
                "l1_icache0_preload_order",
                &format_args!("{}", self.l1_icache0_preload_order().bit()),
            )
            .field(
                "l1_icache0_preload_rgid",
                &format_args!("{}", self.l1_icache0_preload_rgid().bits()),
            )
            .finish()
    }
}
