///Register `L1_CACHE_SYNC_PRELOAD_INT_ST` reader
pub type R = crate::R<L1_CACHE_SYNC_PRELOAD_INT_ST_SPEC>;
///Field `L1_ICACHE0_PLD_DONE_INT_ST` reader - The bit indicates the status of the interrupt that occurs only when L1-ICache0 preload-operation is done.
pub type L1_ICACHE0_PLD_DONE_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE1_PLD_DONE_INT_ST` reader - The bit indicates the status of the interrupt that occurs only when L1-ICache1 preload-operation is done.
pub type L1_ICACHE1_PLD_DONE_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE2_PLD_DONE_INT_ST` reader - Reserved
pub type L1_ICACHE2_PLD_DONE_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE3_PLD_DONE_INT_ST` reader - Reserved
pub type L1_ICACHE3_PLD_DONE_INT_ST_R = crate::BitReader;
///Field `L1_CACHE_PLD_DONE_INT_ST` reader - The bit indicates the status of the interrupt that occurs only when L1-Cache preload-operation is done.
pub type L1_CACHE_PLD_DONE_INT_ST_R = crate::BitReader;
///Field `CACHE_SYNC_DONE_INT_ST` reader - The bit indicates the status of the interrupt that occurs only when Cache sync-operation is done.
pub type CACHE_SYNC_DONE_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE0_PLD_ERR_INT_ST` reader - The bit indicates the status of the interrupt of L1-ICache0 preload-operation error.
pub type L1_ICACHE0_PLD_ERR_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE1_PLD_ERR_INT_ST` reader - The bit indicates the status of the interrupt of L1-ICache1 preload-operation error.
pub type L1_ICACHE1_PLD_ERR_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE2_PLD_ERR_INT_ST` reader - Reserved
pub type L1_ICACHE2_PLD_ERR_INT_ST_R = crate::BitReader;
///Field `L1_ICACHE3_PLD_ERR_INT_ST` reader - Reserved
pub type L1_ICACHE3_PLD_ERR_INT_ST_R = crate::BitReader;
///Field `L1_CACHE_PLD_ERR_INT_ST` reader - The bit indicates the status of the interrupt of L1-Cache preload-operation error.
pub type L1_CACHE_PLD_ERR_INT_ST_R = crate::BitReader;
///Field `CACHE_SYNC_ERR_INT_ST` reader - The bit indicates the status of the interrupt of Cache sync-operation error.
pub type CACHE_SYNC_ERR_INT_ST_R = crate::BitReader;
impl R {
    ///Bit 0 - The bit indicates the status of the interrupt that occurs only when L1-ICache0 preload-operation is done.
    #[inline(always)]
    pub fn l1_icache0_pld_done_int_st(&self) -> L1_ICACHE0_PLD_DONE_INT_ST_R {
        L1_ICACHE0_PLD_DONE_INT_ST_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - The bit indicates the status of the interrupt that occurs only when L1-ICache1 preload-operation is done.
    #[inline(always)]
    ...
    ///Bit 4 - The bit indicates the status of the interrupt that occurs only when L1-Cache preload-operation is done.
    #[inline(always)]
    pub fn l1_cache_pld_done_int_st(&self) -> L1_CACHE_PLD_DONE_INT_ST_R {
        L1_CACHE_PLD_DONE_INT_ST_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 6 - The bit indicates the status of the interrupt that occurs only when Cache sync-operation is done.
    #[inline(always)]
    pub fn cache_sync_done_int_st(&self) -> CACHE_SYNC_DONE_INT_ST_R {
        CACHE_SYNC_DONE_INT_ST_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - The bit indicates the status of the interrupt of L1-ICache0 preload-operation error.
    #[inline(always)]
    pub fn l1_icache0_pld_err_int_st(&self) -> L1_ICACHE0_PLD_ERR_INT_ST_R {
        L1_ICACHE0_PLD_ERR_INT_ST_R::new(((self.bits >> 7) & 1) != 0)
    }
    ///Bit 8 - The bit indicates the status of the interrupt of L1-ICache1 preload-operation error.
    #[inline(always)]
    ...
    ///Bit 11 - The bit indicates the status of the interrupt of L1-Cache preload-operation error.
    #[inline(always)]
    pub fn l1_cache_pld_err_int_st(&self) -> L1_CACHE_PLD_ERR_INT_ST_R {
        L1_CACHE_PLD_ERR_INT_ST_R::new(((self.bits >> 11) & 1) != 0)
    }
    ///Bit 13 - The bit indicates the status of the interrupt of Cache sync-operation error.
    #[inline(always)]
...
///`read()` method returns [`l1_cache_sync_preload_int_st::R`](R) reader structure
impl crate::Readable for L1_CACHE_SYNC_PRELOAD_INT_ST_SPEC {}
///`reset()` method sets L1_CACHE_SYNC_PRELOAD_INT_ST to value 0
