...
///`read()` method returns [`l1_cache_ctrl::R`](R) reader structure
impl crate::Readable for L1_CACHE_CTRL_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_ctrl::W`](W) writer structure
impl crate::Writable for L1_CACHE_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L1_CACHE_CTRL to value 0
