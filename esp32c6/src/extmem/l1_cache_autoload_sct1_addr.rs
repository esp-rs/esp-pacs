///Register `L1_CACHE_AUTOLOAD_SCT1_ADDR` reader
pub type R = crate::R<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>;
///Register `L1_CACHE_AUTOLOAD_SCT1_ADDR` writer
pub type W = crate::W<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>;
///Field `L1_CACHE_AUTOLOAD_SCT1_ADDR` reader - Those bits are used to configure the start virtual address of the second section for autoload operation on L1-Cache. Note that it should be used together with L1_CACHE_AUTOLOAD_SCT1_SIZE and L1_CACHE_AUTOLOAD_SCT1_ENA.
pub type L1_CACHE_AUTOLOAD_SCT1_ADDR_R = crate::FieldReader<u32>;
///Field `L1_CACHE_AUTOLOAD_SCT1_ADDR` writer - Those bits are used to configure the start virtual address of the second section for autoload operation on L1-Cache. Note that it should be used together with L1_CACHE_AUTOLOAD_SCT1_SIZE and L1_CACHE_AUTOLOAD_SCT1_ENA.
...
You can [`read`](crate::generic::Reg::read) this register and get [`l1_cache_autoload_sct1_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`l1_cache_autoload_sct1_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC;
impl crate::RegisterSpec for L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l1_cache_autoload_sct1_addr::R`](R) reader structure
impl crate::Readable for L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC {}
///`write(|w| ..)` method takes [`l1_cache_autoload_sct1_addr::W`](W) writer structure
impl crate::Writable for L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets L1_CACHE_AUTOLOAD_SCT1_ADDR to value 0
