...
pub struct R(crate::R<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1_CACHE_AUTOLOAD_SCT1_ADDR` writer"]
pub struct W(crate::W<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type L1_CACHE_AUTOLOAD_SCT1_ADDR_R = crate::FieldReader<u32, u32>;
...
pub type L1_CACHE_AUTOLOAD_SCT1_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC, 32, O, u32, u32>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_AUTOLOAD_SCT1_ADDR")
            .field(
                ...
                &format_args!("{}", self.l1_cache_autoload_sct1_addr().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<L1_CACHE_AUTOLOAD_SCT1_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_autoload_sct1_addr(&mut self) -> L1_CACHE_AUTOLOAD_SCT1_ADDR_W<0> {
        L1_CACHE_AUTOLOAD_SCT1_ADDR_W::new(self)
    }
