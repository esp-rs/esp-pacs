...
///Field `L1_CACHE_FAIL_ADDR` reader - The register records the address of fail-access when cache accesses L1-Cache.
pub type L1_CACHE_FAIL_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the address of fail-access when cache accesses L1-Cache.
    #[inline(always)]
