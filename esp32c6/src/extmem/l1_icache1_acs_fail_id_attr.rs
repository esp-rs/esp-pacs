...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_ICACHE1_ACS_FAIL_ID_ATTR")
            .field(
                "l1_icache1_fail_id",
                &format_args!("{}", self.l1_icache1_fail_id().bits()),
            )
            .field(
                "l1_icache1_fail_attr",
                &format_args!("{}", self.l1_icache1_fail_attr().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<L1_ICACHE1_ACS_FAIL_ID_ATTR_SPEC> {
