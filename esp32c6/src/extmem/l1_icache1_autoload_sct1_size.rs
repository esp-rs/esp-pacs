...
pub struct R(crate::R<L1_ICACHE1_AUTOLOAD_SCT1_SIZE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_ICACHE1_AUTOLOAD_SCT1_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_ICACHE1_AUTOLOAD_SCT1_SIZE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_ICACHE1_AUTOLOAD_SCT1_SIZE_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L1_ICACHE1_AUTOLOAD_SCT1_SIZE_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "L1 instruction Cache 1 autoload section 1 size configure register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l1_icache1_autoload_sct1_size](index.html) module"]
