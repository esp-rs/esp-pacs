...
pub struct R(crate::R<L1_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1_CACHE_AUTOLOAD_SCT0_SIZE` writer"]
pub struct W(crate::W<L1_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1_CACHE_AUTOLOAD_SCT0_SIZE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<L1_CACHE_AUTOLOAD_SCT0_SIZE_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_cache_autoload_sct0_size(&mut self) -> L1_CACHE_AUTOLOAD_SCT0_SIZE_W<0> {
        L1_CACHE_AUTOLOAD_SCT0_SIZE_W::new(self)
    }
