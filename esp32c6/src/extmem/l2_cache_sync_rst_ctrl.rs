...
pub struct R(crate::R<L2_CACHE_SYNC_RST_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L2_CACHE_SYNC_RST_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L2_CACHE_SYNC_RST_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L2_CACHE_SYNC_RST_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L2_CACHE_SYNC_RST_R = crate::BitReader<bool>;
impl R {
