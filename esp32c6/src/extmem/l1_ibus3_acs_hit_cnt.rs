///Register `L1_IBUS3_ACS_HIT_CNT` reader
pub type R = crate::R<L1_IBUS3_ACS_HIT_CNT_SPEC>;
///Field `L1_IBUS3_HIT_CNT` reader - The register records the number of hits when bus3 accesses L1-ICache3.
pub type L1_IBUS3_HIT_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of hits when bus3 accesses L1-ICache3.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`l1_ibus3_acs_hit_cnt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct L1_IBUS3_ACS_HIT_CNT_SPEC;
impl crate::RegisterSpec for L1_IBUS3_ACS_HIT_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`l1_ibus3_acs_hit_cnt::R`](R) reader structure
