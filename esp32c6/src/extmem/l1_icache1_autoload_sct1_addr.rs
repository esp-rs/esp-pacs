...
pub struct R(crate::R<L1_ICACHE1_AUTOLOAD_SCT1_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1_ICACHE1_AUTOLOAD_SCT1_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1_ICACHE1_AUTOLOAD_SCT1_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1_ICACHE1_AUTOLOAD_SCT1_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type L1_ICACHE1_AUTOLOAD_SCT1_ADDR_R = crate::FieldReader<u32, u32>;
impl R {
