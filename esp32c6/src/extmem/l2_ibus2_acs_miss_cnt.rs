///Register `L2_IBUS2_ACS_MISS_CNT` reader
pub type R = crate::R<L2_IBUS2_ACS_MISS_CNT_SPEC>;
///Field `L2_IBUS2_MISS_CNT` reader - The register records the number of missing when L1-ICache2 accesses L2-Cache due to bus2 accessing L1-ICache2.
pub type L2_IBUS2_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The register records the number of missing when L1-ICache2 accesses L2-Cache due to bus2 accessing L1-ICache2.
    #[inline(always)]
...
///`read()` method returns [`l2_ibus2_acs_miss_cnt::R`](R) reader structure
