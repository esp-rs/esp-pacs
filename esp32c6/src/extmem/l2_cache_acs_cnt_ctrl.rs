...
///Field `L2_IBUS0_CNT_CLR` reader - The bit is used to clear ibus0 counter in L2-Cache.
pub type L2_IBUS0_CNT_CLR_R = crate::BitReader;
///Field `L2_IBUS1_CNT_CLR` reader - The bit is used to clear ibus1 counter in L2-Cache.
...
///Field `L2_DBUS0_CNT_CLR` reader - The bit is used to clear dbus0 counter in L2-Cache.
pub type L2_DBUS0_CNT_CLR_R = crate::BitReader;
///Field `L2_DBUS1_CNT_CLR` reader - The bit is used to clear dbus1 counter in L2-Cache.
