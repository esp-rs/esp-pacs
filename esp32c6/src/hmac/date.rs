...
#[doc = "Field `DATE` reader - Hmac date information/ hmac version information."]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - Hmac date information/ hmac version information."]
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATE_SPEC, u32, u32, 30, O>;
impl R {
    #[doc = "Bits 0:29 - Hmac date information/ hmac version information."]
    #[inline(always)]
...
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x2020_0618;
}
