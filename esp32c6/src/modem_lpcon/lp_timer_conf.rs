...
pub type CLK_LP_TIMER_SEL_OSC_SLOW_R = crate::BitReader<bool>;
#[doc = "Field `CLK_LP_TIMER_SEL_OSC_SLOW` writer - "]
pub type CLK_LP_TIMER_SEL_OSC_SLOW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LP_TIMER_CONF_SPEC, bool, O>;
#[doc = "Field `CLK_LP_TIMER_SEL_OSC_FAST` reader - "]
pub type CLK_LP_TIMER_SEL_OSC_FAST_R = crate::BitReader<bool>;
#[doc = "Field `CLK_LP_TIMER_SEL_OSC_FAST` writer - "]
pub type CLK_LP_TIMER_SEL_OSC_FAST_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LP_TIMER_CONF_SPEC, bool, O>;
#[doc = "Field `CLK_LP_TIMER_SEL_XTAL` reader - "]
pub type CLK_LP_TIMER_SEL_XTAL_R = crate::BitReader<bool>;
#[doc = "Field `CLK_LP_TIMER_SEL_XTAL` writer - "]
pub type CLK_LP_TIMER_SEL_XTAL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LP_TIMER_CONF_SPEC, bool, O>;
#[doc = "Field `CLK_LP_TIMER_SEL_XTAL32K` reader - "]
pub type CLK_LP_TIMER_SEL_XTAL32K_R = crate::BitReader<bool>;
#[doc = "Field `CLK_LP_TIMER_SEL_XTAL32K` writer - "]
pub type CLK_LP_TIMER_SEL_XTAL32K_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LP_TIMER_CONF_SPEC, bool, O>;
...
pub type CLK_LP_TIMER_DIV_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LP_TIMER_CONF_SPEC, u16, u16, 12, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
