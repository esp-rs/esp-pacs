...
pub type REGION3_R0_PMS_X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION3_R0_PMS_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION3_R0_PMS_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION3_R1_PMS_X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION3_R1_PMS_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION3_R1_PMS_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION3_R2_PMS_X_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION3_R2_PMS_W_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REGION3_R2_PMS_R_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region3_r0_pms_x(&mut self) -> REGION3_R0_PMS_X_W<REGION3_PMS_ATTR_SPEC, 0> {
        REGION3_R0_PMS_X_W::new(self)
    }
    #[doc = "Bit 1 - Region write authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region3_r0_pms_w(&mut self) -> REGION3_R0_PMS_W_W<REGION3_PMS_ATTR_SPEC, 1> {
        REGION3_R0_PMS_W_W::new(self)
    }
    #[doc = "Bit 2 - Region read authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region3_r0_pms_r(&mut self) -> REGION3_R0_PMS_R_W<REGION3_PMS_ATTR_SPEC, 2> {
        REGION3_R0_PMS_R_W::new(self)
    }
    #[doc = "Bit 4 - Region execute authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region3_r1_pms_x(&mut self) -> REGION3_R1_PMS_X_W<REGION3_PMS_ATTR_SPEC, 4> {
        REGION3_R1_PMS_X_W::new(self)
    }
    #[doc = "Bit 5 - Region write authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region3_r1_pms_w(&mut self) -> REGION3_R1_PMS_W_W<REGION3_PMS_ATTR_SPEC, 5> {
        REGION3_R1_PMS_W_W::new(self)
    }
    #[doc = "Bit 6 - Region read authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region3_r1_pms_r(&mut self) -> REGION3_R1_PMS_R_W<REGION3_PMS_ATTR_SPEC, 6> {
        REGION3_R1_PMS_R_W::new(self)
    }
    #[doc = "Bit 8 - Region execute authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region3_r2_pms_x(&mut self) -> REGION3_R2_PMS_X_W<REGION3_PMS_ATTR_SPEC, 8> {
        REGION3_R2_PMS_X_W::new(self)
    }
    #[doc = "Bit 9 - Region write authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region3_r2_pms_w(&mut self) -> REGION3_R2_PMS_W_W<REGION3_PMS_ATTR_SPEC, 9> {
        REGION3_R2_PMS_W_W::new(self)
    }
    #[doc = "Bit 10 - Region read authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region3_r2_pms_r(&mut self) -> REGION3_R2_PMS_R_W<REGION3_PMS_ATTR_SPEC, 10> {
...
#[doc = "Region access authority attribute register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`region3_pms_attr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`region3_pms_attr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
