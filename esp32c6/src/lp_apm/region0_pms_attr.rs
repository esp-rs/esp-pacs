...
pub struct R(crate::R<REGION0_PMS_ATTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REGION0_PMS_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REGION0_PMS_ATTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REGION0_PMS_ATTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REGION0_PMS_ATTR` writer"]
pub struct W(crate::W<REGION0_PMS_ATTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REGION0_PMS_ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REGION0_PMS_ATTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REGION0_PMS_ATTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type REGION0_R0_PMS_X_W<'a, const O: u8> = crate::BitWriter<'a, REGION0_PMS_ATTR_SPEC, O>;
...
pub type REGION0_R0_PMS_W_W<'a, const O: u8> = crate::BitWriter<'a, REGION0_PMS_ATTR_SPEC, O>;
...
pub type REGION0_R0_PMS_R_W<'a, const O: u8> = crate::BitWriter<'a, REGION0_PMS_ATTR_SPEC, O>;
...
pub type REGION0_R1_PMS_X_W<'a, const O: u8> = crate::BitWriter<'a, REGION0_PMS_ATTR_SPEC, O>;
...
pub type REGION0_R1_PMS_W_W<'a, const O: u8> = crate::BitWriter<'a, REGION0_PMS_ATTR_SPEC, O>;
...
pub type REGION0_R1_PMS_R_W<'a, const O: u8> = crate::BitWriter<'a, REGION0_PMS_ATTR_SPEC, O>;
...
pub type REGION0_R2_PMS_X_W<'a, const O: u8> = crate::BitWriter<'a, REGION0_PMS_ATTR_SPEC, O>;
...
pub type REGION0_R2_PMS_W_W<'a, const O: u8> = crate::BitWriter<'a, REGION0_PMS_ATTR_SPEC, O>;
...
pub type REGION0_R2_PMS_R_W<'a, const O: u8> = crate::BitWriter<'a, REGION0_PMS_ATTR_SPEC, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION0_PMS_ATTR")
            .field(
                "region0_r0_pms_x",
                &format_args!("{}", self.region0_r0_pms_x().bit()),
            )
            .field(
                "region0_r0_pms_w",
                &format_args!("{}", self.region0_r0_pms_w().bit()),
            )
            .field(
                "region0_r0_pms_r",
                &format_args!("{}", self.region0_r0_pms_r().bit()),
            )
            .field(
                "region0_r1_pms_x",
                &format_args!("{}", self.region0_r1_pms_x().bit()),
            )
            .field(
                "region0_r1_pms_w",
                &format_args!("{}", self.region0_r1_pms_w().bit()),
            )
            .field(
                "region0_r1_pms_r",
                &format_args!("{}", self.region0_r1_pms_r().bit()),
            )
            .field(
                "region0_r2_pms_x",
                &format_args!("{}", self.region0_r2_pms_x().bit()),
            )
            .field(
                "region0_r2_pms_w",
                &format_args!("{}", self.region0_r2_pms_w().bit()),
            )
            .field(
                "region0_r2_pms_r",
                &format_args!("{}", self.region0_r2_pms_r().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<REGION0_PMS_ATTR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region0_r0_pms_x(&mut self) -> REGION0_R0_PMS_X_W<0> {
        REGION0_R0_PMS_X_W::new(self)
    }
    #[doc = "Bit 1 - Region write authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region0_r0_pms_w(&mut self) -> REGION0_R0_PMS_W_W<1> {
        REGION0_R0_PMS_W_W::new(self)
    }
    #[doc = "Bit 2 - Region read authority in REE_MODE0"]
    #[inline(always)]
    #[must_use]
    pub fn region0_r0_pms_r(&mut self) -> REGION0_R0_PMS_R_W<2> {
        REGION0_R0_PMS_R_W::new(self)
    }
    #[doc = "Bit 4 - Region execute authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region0_r1_pms_x(&mut self) -> REGION0_R1_PMS_X_W<4> {
        REGION0_R1_PMS_X_W::new(self)
    }
    #[doc = "Bit 5 - Region write authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region0_r1_pms_w(&mut self) -> REGION0_R1_PMS_W_W<5> {
        REGION0_R1_PMS_W_W::new(self)
    }
    #[doc = "Bit 6 - Region read authority in REE_MODE1"]
    #[inline(always)]
    #[must_use]
    pub fn region0_r1_pms_r(&mut self) -> REGION0_R1_PMS_R_W<6> {
        REGION0_R1_PMS_R_W::new(self)
    }
    #[doc = "Bit 8 - Region execute authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region0_r2_pms_x(&mut self) -> REGION0_R2_PMS_X_W<8> {
        REGION0_R2_PMS_X_W::new(self)
    }
    #[doc = "Bit 9 - Region write authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region0_r2_pms_w(&mut self) -> REGION0_R2_PMS_W_W<9> {
        REGION0_R2_PMS_W_W::new(self)
    }
    #[doc = "Bit 10 - Region read authority in REE_MODE2"]
    #[inline(always)]
    #[must_use]
    pub fn region0_r2_pms_r(&mut self) -> REGION0_R2_PMS_R_W<10> {
        REGION0_R2_PMS_R_W::new(self)
    }
