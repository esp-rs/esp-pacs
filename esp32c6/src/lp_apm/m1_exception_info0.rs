...
pub type M1_EXCEPTION_REGION_R = crate::FieldReader<u8, u8>;
#[doc = "Field `M1_EXCEPTION_MODE` reader - Exception mode"]
pub type M1_EXCEPTION_MODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `M1_EXCEPTION_ID` reader - Exception id information"]
pub type M1_EXCEPTION_ID_R = crate::FieldReader<u8, u8>;
impl R {
