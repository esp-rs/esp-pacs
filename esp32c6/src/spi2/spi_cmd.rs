...
pub type SPI_CONF_BITLEN_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_CONF_BITLEN` writer - Define the APB cycles of SPI_CONF state. Can be configured in CONF state."]
pub type SPI_CONF_BITLEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_CMD_SPEC, u32, u32, 18, O>;
...
pub type SPI_UPDATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_CMD_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_conf_bitlen(&mut self) -> SPI_CONF_BITLEN_W<0> {
        SPI_CONF_BITLEN_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_update(&mut self) -> SPI_UPDATE_W<23> {
        SPI_UPDATE_W::new(self)
    }
    #[doc = "Bit 24 - User define command enable. An operation will be triggered when the bit is set. The bit will be cleared once the operation done.1: enable 0: disable. Can not be changed by CONF_buf."]
    #[inline(always)]
    #[must_use]
    pub fn spi_usr(&mut self) -> SPI_USR_W<24> {
        SPI_USR_W::new(self)
    }
