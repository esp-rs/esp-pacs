...
pub type SPI_DOUTDIN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_USER_SPEC, bool, O>;
...
pub type SPI_QPI_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_USER_SPEC, bool, O>;
...
pub type SPI_TSCK_I_EDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_USER_SPEC, bool, O>;
...
pub type SPI_RSCK_I_EDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_USER_SPEC, bool, O>;
...
pub type SPI_CK_OUT_EDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_USER_SPEC, bool, O>;
...
pub type SPI_USR_CONF_NXT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_USER_SPEC, bool, O>;
...
pub type SPI_USR_MISO_HIGHPART_W<'a, const O: u8> =
...
pub type SPI_USR_MOSI_HIGHPART_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_USER_SPEC, bool, O>;
...
pub type SPI_USR_DUMMY_IDLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_USER_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_doutdin(&mut self) -> SPI_DOUTDIN_W<0> {
        SPI_DOUTDIN_W::new(self)
    }
    #[doc = "Bit 3 - Both for master mode and slave mode. 1: spi controller is in QPI mode. 0: others. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_qpi_mode(&mut self) -> SPI_QPI_MODE_W<3> {
        SPI_QPI_MODE_W::new(self)
    }
    #[doc = "Bit 5 - In the slave mode, this bit can be used to change the polarity of tsck. 0: tsck = spi_ck_i. 1:tsck = !spi_ck_i."]
    #[inline(always)]
    #[must_use]
    pub fn spi_tsck_i_edge(&mut self) -> SPI_TSCK_I_EDGE_W<5> {
        SPI_TSCK_I_EDGE_W::new(self)
    }
    #[doc = "Bit 6 - spi cs keep low when spi is in done phase. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_cs_hold(&mut self) -> SPI_CS_HOLD_W<6> {
        SPI_CS_HOLD_W::new(self)
    }
    #[doc = "Bit 7 - spi cs is enable when spi is in prepare phase. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_cs_setup(&mut self) -> SPI_CS_SETUP_W<7> {
        SPI_CS_SETUP_W::new(self)
    }
    #[doc = "Bit 8 - In the slave mode, this bit can be used to change the polarity of rsck. 0: rsck = !spi_ck_i. 1:rsck = spi_ck_i."]
    #[inline(always)]
    #[must_use]
    pub fn spi_rsck_i_edge(&mut self) -> SPI_RSCK_I_EDGE_W<8> {
        SPI_RSCK_I_EDGE_W::new(self)
    }
    #[doc = "Bit 9 - the bit combined with spi_mosi_delay_mode bits to set mosi signal delay mode. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_ck_out_edge(&mut self) -> SPI_CK_OUT_EDGE_W<9> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_usr_conf_nxt(&mut self) -> SPI_USR_CONF_NXT_W<15> {
        SPI_USR_CONF_NXT_W::new(self)
    }
    #[doc = "Bit 17 - Set the bit to enable 3-line half duplex communication mosi and miso signals share the same pin. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_sio(&mut self) -> SPI_SIO_W<17> {
        SPI_SIO_W::new(self)
    }
    #[doc = "Bit 24 - read-data phase only access to high-part of the buffer spi_w8~spi_w15. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_usr_miso_highpart(&mut self) -> SPI_USR_MISO_HIGHPART_W<24> {
        SPI_USR_MISO_HIGHPART_W::new(self)
    }
    #[doc = "Bit 25 - write-data phase only access to high-part of the buffer spi_w8~spi_w15. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_usr_mosi_highpart(&mut self) -> SPI_USR_MOSI_HIGHPART_W<25> {
        SPI_USR_MOSI_HIGHPART_W::new(self)
    }
    #[doc = "Bit 26 - spi clock is disable in dummy phase when the bit is enable. Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_usr_dummy_idle(&mut self) -> SPI_USR_DUMMY_IDLE_W<26> {
