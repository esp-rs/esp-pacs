...
#[doc = "Field `SPI_BUF2` reader - data buffer"]
pub type SPI_BUF2_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_BUF2` writer - data buffer"]
pub type SPI_BUF2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI_W2_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_buf2(&mut self) -> SPI_BUF2_W<0> {
        SPI_BUF2_W::new(self)
    }
