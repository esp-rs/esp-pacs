...
pub type SPI_SLV_DATA_BITLEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_SLAVE1_SPEC, u32, u32, 18, O>;
...
pub type SPI_SLV_LAST_COMMAND_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_SLAVE1_SPEC, u8, u8, 8, O>;
...
pub type SPI_SLV_LAST_ADDR_W<'a, const O: u8> =
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_data_bitlen(&mut self) -> SPI_SLV_DATA_BITLEN_W<0> {
        SPI_SLV_DATA_BITLEN_W::new(self)
    }
    #[doc = "Bits 18:25 - In the slave mode it is the value of command."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_last_command(&mut self) -> SPI_SLV_LAST_COMMAND_W<18> {
        SPI_SLV_LAST_COMMAND_W::new(self)
    }
    #[doc = "Bits 26:31 - In the slave mode it is the value of address."]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_last_addr(&mut self) -> SPI_SLV_LAST_ADDR_W<26> {
