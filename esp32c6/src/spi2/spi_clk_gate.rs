...
pub type SPI_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_CLK_GATE_SPEC, bool, O>;
...
pub type SPI_MST_CLK_ACTIVE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_CLK_GATE_SPEC, bool, O>;
...
pub type SPI_MST_CLK_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_CLK_GATE_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mst_clk_active(&mut self) -> SPI_MST_CLK_ACTIVE_W<1> {
        SPI_MST_CLK_ACTIVE_W::new(self)
    }
    #[doc = "Bit 2 - This bit is used to select SPI module clock source in master mode. 1: PLL_CLK_80M. 0: XTAL CLK."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mst_clk_sel(&mut self) -> SPI_MST_CLK_SEL_W<2> {
