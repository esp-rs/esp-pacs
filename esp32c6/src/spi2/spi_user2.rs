...
pub type SPI_USR_COMMAND_VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_USER2_SPEC, u16, u16, 16, O>;
...
pub type SPI_MST_REMPTY_ERR_END_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_USER2_SPEC, bool, O>;
...
pub type SPI_USR_COMMAND_BITLEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_USER2_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_usr_command_value(&mut self) -> SPI_USR_COMMAND_VALUE_W<0> {
        SPI_USR_COMMAND_VALUE_W::new(self)
    }
    #[doc = "Bit 27 - 1: SPI transfer is ended when SPI TX AFIFO read empty error is valid in GP-SPI master FD/HD-mode. 0: SPI transfer is not ended when SPI TX AFIFO read empty error is valid in GP-SPI master FD/HD-mode."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mst_rempty_err_end_en(&mut self) -> SPI_MST_REMPTY_ERR_END_EN_W<27> {
        SPI_MST_REMPTY_ERR_END_EN_W::new(self)
    }
    #[doc = "Bits 28:31 - The length in bits of command phase. The register value shall be (bit_num-1). Can be configured in CONF state."]
    #[inline(always)]
    #[must_use]
    pub fn spi_usr_command_bitlen(&mut self) -> SPI_USR_COMMAND_BITLEN_W<28> {
