...
pub type SPI_BUF0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_BUF0` writer - data buffer"]
pub type SPI_BUF0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI_W0_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_buf0(&mut self) -> SPI_BUF0_W<0> {
        SPI_BUF0_W::new(self)
    }
