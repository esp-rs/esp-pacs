...
pub type SPI_BUF4_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SPI_BUF4` writer - data buffer"]
pub type SPI_BUF4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SPI_W4_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_buf4(&mut self) -> SPI_BUF4_W<0> {
        SPI_BUF4_W::new(self)
    }
