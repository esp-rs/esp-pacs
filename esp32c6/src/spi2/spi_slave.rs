...
pub type SPI_CLK_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_SLAVE_SPEC, u8, u8, 2, O>;
...
pub type SPI_CLK_MODE_13_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_SLAVE_SPEC, bool, O>;
...
pub type SPI_RSCK_DATA_OUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_SLAVE_SPEC, bool, O>;
...
pub type SPI_SLV_RDDMA_BITLEN_EN_W<'a, const O: u8> =
...
pub type SPI_SLV_WRDMA_BITLEN_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_SPEC, bool, O>;
...
pub type SPI_SLV_RDBUF_BITLEN_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_SPEC, bool, O>;
...
pub type SPI_SLV_WRBUF_BITLEN_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_SPEC, bool, O>;
...
pub type SPI_DMA_SEG_MAGIC_VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SPI_SLAVE_SPEC, u8, u8, 4, O>;
...
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_SLAVE_SPEC, bool, O>;
...
pub type SPI_SOFT_RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_SLAVE_SPEC, bool, O>;
...
pub type SPI_USR_CONF_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_SLAVE_SPEC, bool, O>;
...
pub type SPI_MST_FD_WAIT_DMA_TX_DATA_R = crate::BitReader<bool>;
...
pub type SPI_MST_FD_WAIT_DMA_TX_DATA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_clk_mode(&mut self) -> SPI_CLK_MODE_W<0> {
        SPI_CLK_MODE_W::new(self)
    }
    #[doc = "Bit 2 - {CPOL, CPHA},1: support spi clk mode 1 and 3, first edge output data B\\[0\\]/B\\[7\\]. 0: support spi clk mode 0 and 2, first edge output data B\\[1\\]/B\\[6\\]."]
    #[inline(always)]
    #[must_use]
    pub fn spi_clk_mode_13(&mut self) -> SPI_CLK_MODE_13_W<2> {
        SPI_CLK_MODE_13_W::new(self)
    }
    #[doc = "Bit 3 - It saves half a cycle when tsck is the same as rsck. 1: output data at rsck posedge 0: output data at tsck posedge"]
    #[inline(always)]
    #[must_use]
    pub fn spi_rsck_data_out(&mut self) -> SPI_RSCK_DATA_OUT_W<3> {
        SPI_RSCK_DATA_OUT_W::new(self)
    }
    #[doc = "Bit 8 - 1: SPI_SLV_DATA_BITLEN stores data bit length of master-read-slave data length in DMA controlled mode(Rd_DMA). 0: others"]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_rddma_bitlen_en(&mut self) -> SPI_SLV_RDDMA_BITLEN_EN_W<8> {
        SPI_SLV_RDDMA_BITLEN_EN_W::new(self)
    }
    #[doc = "Bit 9 - 1: SPI_SLV_DATA_BITLEN stores data bit length of master-write-to-slave data length in DMA controlled mode(Wr_DMA). 0: others"]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_wrdma_bitlen_en(&mut self) -> SPI_SLV_WRDMA_BITLEN_EN_W<9> {
        SPI_SLV_WRDMA_BITLEN_EN_W::new(self)
    }
    #[doc = "Bit 10 - 1: SPI_SLV_DATA_BITLEN stores data bit length of master-read-slave data length in CPU controlled mode(Rd_BUF). 0: others"]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_rdbuf_bitlen_en(&mut self) -> SPI_SLV_RDBUF_BITLEN_EN_W<10> {
        SPI_SLV_RDBUF_BITLEN_EN_W::new(self)
    }
    #[doc = "Bit 11 - 1: SPI_SLV_DATA_BITLEN stores data bit length of master-write-to-slave data length in CPU controlled mode(Wr_BUF). 0: others"]
    #[inline(always)]
    #[must_use]
    pub fn spi_slv_wrbuf_bitlen_en(&mut self) -> SPI_SLV_WRBUF_BITLEN_EN_W<11> {
        SPI_SLV_WRBUF_BITLEN_EN_W::new(self)
    }
    #[doc = "Bits 22:25 - The magic value of BM table in master DMA seg-trans."]
    #[inline(always)]
    #[must_use]
    pub fn spi_dma_seg_magic_value(&mut self) -> SPI_DMA_SEG_MAGIC_VALUE_W<22> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_soft_reset(&mut self) -> SPI_SOFT_RESET_W<27> {
        SPI_SOFT_RESET_W::new(self)
    }
    #[doc = "Bit 28 - 1: Enable the DMA CONF phase of current seg-trans operation, which means seg-trans will start. 0: This is not seg-trans mode."]
    #[inline(always)]
    #[must_use]
    pub fn spi_usr_conf(&mut self) -> SPI_USR_CONF_W<28> {
        SPI_USR_CONF_W::new(self)
    }
    #[doc = "Bit 29 - In master full-duplex mode, 1: GP-SPI will wait DMA TX data is ready before starting SPI transfer. 0: GP-SPI does not wait DMA TX data before starting SPI transfer."]
    #[inline(always)]
    #[must_use]
    pub fn spi_mst_fd_wait_dma_tx_data(&mut self) -> SPI_MST_FD_WAIT_DMA_TX_DATA_W<29> {
        SPI_MST_FD_WAIT_DMA_TX_DATA_W::new(self)
    }
