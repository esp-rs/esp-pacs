///Register `CFG_UHS1_INT_MODE` reader
pub type R = crate::R<CFG_UHS1_INT_MODE_SPEC>;
///Register `CFG_UHS1_INT_MODE` writer
pub type W = crate::W<CFG_UHS1_INT_MODE_SPEC>;
///Field `INTOE_END_AHEAD_MODE` reader - intoe on dat1 end ahead of time: 0/3-no, 1-ahead 1sdclk, 2-ahead 2sdclk
pub type INTOE_END_AHEAD_MODE_R = crate::FieldReader;
///Field `INTOE_END_AHEAD_MODE` writer - intoe on dat1 end ahead of time: 0/3-no, 1-ahead 1sdclk, 2-ahead 2sdclk
pub type INTOE_END_AHEAD_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `INT_END_AHEAD_MODE` reader - int on dat1 end ahead of time: 0/3-no, 1-ahead 1sdclk, 2-ahead 2sdclk
pub type INT_END_AHEAD_MODE_R = crate::FieldReader;
///Field `INT_END_AHEAD_MODE` writer - int on dat1 end ahead of time: 0/3-no, 1-ahead 1sdclk, 2-ahead 2sdclk
pub type INT_END_AHEAD_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `INTOE_ST_AHEAD_MODE` reader - intoe on dat1 start ahead of time: 0/3-no, 1-ahead 1sdclk, 2-ahead 2sdclk
pub type INTOE_ST_AHEAD_MODE_R = crate::FieldReader;
///Field `INTOE_ST_AHEAD_MODE` writer - intoe on dat1 start ahead of time: 0/3-no, 1-ahead 1sdclk, 2-ahead 2sdclk
pub type INTOE_ST_AHEAD_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `INT_ST_AHEAD_MODE` reader - int on dat1 start ahead of time: 0/3-no, 1-ahead 1sdclk, 2-ahead 2sdclk
pub type INT_ST_AHEAD_MODE_R = crate::FieldReader;
///Field `INT_ST_AHEAD_MODE` writer - int on dat1 start ahead of time: 0/3-no, 1-ahead 1sdclk, 2-ahead 2sdclk
...
///`read()` method returns [`cfg_uhs1_int_mode::R`](R) reader structure
impl crate::Readable for CFG_UHS1_INT_MODE_SPEC {}
///`write(|w| ..)` method takes [`cfg_uhs1_int_mode::W`](W) writer structure
impl crate::Writable for CFG_UHS1_INT_MODE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CFG_UHS1_INT_MODE to value 0
