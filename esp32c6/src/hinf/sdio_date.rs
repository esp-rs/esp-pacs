...
///`read()` method returns [`sdio_date::R`](R) reader structure
impl crate::Readable for SDIO_DATE_SPEC {}
///`write(|w| ..)` method takes [`sdio_date::W`](W) writer structure
impl crate::Writable for SDIO_DATE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDIO_DATE to value 0x0220_3150
