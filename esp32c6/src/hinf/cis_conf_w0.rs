///Register `CIS_CONF_W0` reader
pub type R = crate::R<CIS_CONF_W0_SPEC>;
///Register `CIS_CONF_W0` writer
pub type W = crate::W<CIS_CONF_W0_SPEC>;
///Field `CIS_CONF_W0` reader - Configure cis addr 39~36
pub type CIS_CONF_W0_R = crate::FieldReader<u32>;
///Field `CIS_CONF_W0` writer - Configure cis addr 39~36
pub type CIS_CONF_W0_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configure cis addr 39~36
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`cis_conf_w0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cis_conf_w0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CIS_CONF_W0_SPEC;
impl crate::RegisterSpec for CIS_CONF_W0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`cis_conf_w0::R`](R) reader structure
impl crate::Readable for CIS_CONF_W0_SPEC {}
///`write(|w| ..)` method takes [`cis_conf_w0::W`](W) writer structure
impl crate::Writable for CIS_CONF_W0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CIS_CONF_W0 to value 0xffff_ffff
