///Register `CONF_STATUS` reader
pub type R = crate::R<CONF_STATUS_SPEC>;
///Field `FUNC0_CONFIG0` reader - func0 config0 (addr: 0x20f0 ) status
pub type FUNC0_CONFIG0_R = crate::FieldReader;
///Field `SDR25_ST` reader - sdr25 status
pub type SDR25_ST_R = crate::BitReader;
///Field `SDR50_ST` reader - sdr50 status
pub type SDR50_ST_R = crate::BitReader;
///Field `SDR104_ST` reader - sdr104 status
pub type SDR104_ST_R = crate::BitReader;
///Field `DDR50_ST` reader - ddr50 status
pub type DDR50_ST_R = crate::BitReader;
///Field `TUNE_ST` reader - tune_st fsm status
pub type TUNE_ST_R = crate::FieldReader;
///Field `SDIO_SWITCH_VOLT_ST` reader - sdio switch voltage status:0-3.3V, 1-1.8V.
pub type SDIO_SWITCH_VOLT_ST_R = crate::BitReader;
///Field `SDIO_SWITCH_END` reader - sdio switch voltage ldo ready
pub type SDIO_SWITCH_END_R = crate::BitReader;
impl R {
    ///Bits 0:7 - func0 config0 (addr: 0x20f0 ) status
    #[inline(always)]
...
///`read()` method returns [`conf_status::R`](R) reader structure
impl crate::Readable for CONF_STATUS_SPEC {}
///`reset()` method sets CONF_STATUS to value 0
