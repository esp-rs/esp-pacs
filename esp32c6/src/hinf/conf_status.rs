...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CONF_STATUS")
            .field("func0_config0", &self.func0_config0().bits())
            .field("sdr25_st", &self.sdr25_st().bit())
            .field("sdr50_st", &self.sdr50_st().bit())
            .field("sdr104_st", &self.sdr104_st().bit())
            .field("ddr50_st", &self.ddr50_st().bit())
            .field("tune_st", &self.tune_st().bits())
            .field("sdio_switch_volt_st", &self.sdio_switch_volt_st().bit())
            .field("sdio_switch_end", &self.sdio_switch_end().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
