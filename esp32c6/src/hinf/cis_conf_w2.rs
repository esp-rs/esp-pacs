///Register `CIS_CONF_W2` reader
pub type R = crate::R<CIS_CONF_W2_SPEC>;
///Register `CIS_CONF_W2` writer
pub type W = crate::W<CIS_CONF_W2_SPEC>;
///Field `CIS_CONF_W2` reader - Configure cis addr 47~44
pub type CIS_CONF_W2_R = crate::FieldReader<u32>;
///Field `CIS_CONF_W2` writer - Configure cis addr 47~44
pub type CIS_CONF_W2_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configure cis addr 47~44
    #[inline(always)]
...
///`read()` method returns [`cis_conf_w2::R`](R) reader structure
impl crate::Readable for CIS_CONF_W2_SPEC {}
///`write(|w| ..)` method takes [`cis_conf_w2::W`](W) writer structure
impl crate::Writable for CIS_CONF_W2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CIS_CONF_W2 to value 0xffff_ffff
