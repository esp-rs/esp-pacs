...
pub struct R(crate::R<CIS_CONF_W2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CIS_CONF_W2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CIS_CONF_W2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CIS_CONF_W2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CIS_CONF_W2` writer"]
pub struct W(crate::W<CIS_CONF_W2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CIS_CONF_W2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CIS_CONF_W2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CIS_CONF_W2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CIS_CONF_W2_W<'a, const O: u8> = crate::FieldWriter<'a, CIS_CONF_W2_SPEC, 32, O, u32, u32>;
impl R {
