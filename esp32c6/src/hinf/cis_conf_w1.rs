///Register `CIS_CONF_W1` reader
pub type R = crate::R<CIS_CONF_W1_SPEC>;
///Register `CIS_CONF_W1` writer
pub type W = crate::W<CIS_CONF_W1_SPEC>;
///Field `CIS_CONF_W1` reader - Configure cis addr 43~40
pub type CIS_CONF_W1_R = crate::FieldReader<u32>;
///Field `CIS_CONF_W1` writer - Configure cis addr 43~40
pub type CIS_CONF_W1_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Configure cis addr 43~40
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CIS_CONF_W1")
            .field("cis_conf_w1", &self.cis_conf_w1())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cis_conf_w1(&mut self) -> CIS_CONF_W1_W<CIS_CONF_W1_SPEC> {
...
///`read()` method returns [`cis_conf_w1::R`](R) reader structure
impl crate::Readable for CIS_CONF_W1_SPEC {}
///`write(|w| ..)` method takes [`cis_conf_w1::W`](W) writer structure
impl crate::Writable for CIS_CONF_W1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CIS_CONF_W1 to value 0xffff_ffff
