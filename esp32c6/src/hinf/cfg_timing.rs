///Register `CFG_TIMING` reader
pub type R = crate::R<CFG_TIMING_SPEC>;
///Register `CFG_TIMING` writer
pub type W = crate::W<CFG_TIMING_SPEC>;
///Field `NCRC` reader - configure Ncrc parameter in sdr50/104 mode, no more than 6.
pub type NCRC_R = crate::FieldReader;
///Field `NCRC` writer - configure Ncrc parameter in sdr50/104 mode, no more than 6.
pub type NCRC_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `PST_END_CMD_LOW_VALUE` reader - configure cycles to lower cmd after voltage is changed to 1.8V.
pub type PST_END_CMD_LOW_VALUE_R = crate::FieldReader;
///Field `PST_END_CMD_LOW_VALUE` writer - configure cycles to lower cmd after voltage is changed to 1.8V.
pub type PST_END_CMD_LOW_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
///Field `PST_END_DATA_LOW_VALUE` reader - configure cycles to lower data after voltage is changed to 1.8V.
pub type PST_END_DATA_LOW_VALUE_R = crate::FieldReader;
///Field `PST_END_DATA_LOW_VALUE` writer - configure cycles to lower data after voltage is changed to 1.8V.
pub type PST_END_DATA_LOW_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `SDCLK_STOP_THRES` reader - Configure the number of cycles of module clk to judge sdclk has stopped
pub type SDCLK_STOP_THRES_R = crate::FieldReader<u16>;
///Field `SDCLK_STOP_THRES` writer - Configure the number of cycles of module clk to judge sdclk has stopped
pub type SDCLK_STOP_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `SAMPLE_CLK_DIVIDER` reader - module clk divider to sample sdclk
pub type SAMPLE_CLK_DIVIDER_R = crate::FieldReader;
///Field `SAMPLE_CLK_DIVIDER` writer - module clk divider to sample sdclk
...
///`read()` method returns [`cfg_timing::R`](R) reader structure
impl crate::Readable for CFG_TIMING_SPEC {}
///`write(|w| ..)` method takes [`cfg_timing::W`](W) writer structure
impl crate::Writable for CFG_TIMING_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CFG_TIMING to value 0x1578_0812
