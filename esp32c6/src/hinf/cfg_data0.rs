...
///Field `DEVICE_ID_FN1` reader - configure device id of function1 in cis
pub type DEVICE_ID_FN1_R = crate::FieldReader<u16>;
///Field `DEVICE_ID_FN1` writer - configure device id of function1 in cis
pub type DEVICE_ID_FN1_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `USER_ID_FN1` reader - configure user id of function1 in cis
pub type USER_ID_FN1_R = crate::FieldReader<u16>;
///Field `USER_ID_FN1` writer - configure user id of function1 in cis
...
///`reset()` method sets CFG_DATA0 to value 0x0092_6666
