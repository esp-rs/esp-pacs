///Register `SDIO_SLAVE_ECO_LOW` reader
pub type R = crate::R<SDIO_SLAVE_ECO_LOW_SPEC>;
///Register `SDIO_SLAVE_ECO_LOW` writer
pub type W = crate::W<SDIO_SLAVE_ECO_LOW_SPEC>;
///Field `RDN_ECO_LOW` reader - redundant registers for sdio_slave
pub type RDN_ECO_LOW_R = crate::FieldReader<u32>;
///Field `RDN_ECO_LOW` writer - redundant registers for sdio_slave
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rdn_eco_low(&mut self) -> RDN_ECO_LOW_W<SDIO_SLAVE_ECO_LOW_SPEC> {
...
///`read()` method returns [`sdio_slave_eco_low::R`](R) reader structure
impl crate::Readable for SDIO_SLAVE_ECO_LOW_SPEC {}
///`write(|w| ..)` method takes [`sdio_slave_eco_low::W`](W) writer structure
impl crate::Writable for SDIO_SLAVE_ECO_LOW_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDIO_SLAVE_ECO_LOW to value 0
