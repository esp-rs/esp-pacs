...
///Field `TIE_LOW_GLOBAL_BBPLL_ICG` writer - need_des
...
///Field `TIE_LOW_XPD_BB_I2C` writer - need_des
pub type TIE_LOW_XPD_BB_I2C_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIE_LOW_XPD_BBPLL_I2C` writer - need_des
pub type TIE_LOW_XPD_BBPLL_I2C_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIE_LOW_XPD_BBPLL` writer - need_des
...
///Field `TIE_HIGH_GLOBAL_BBPLL_ICG` writer - need_des
...
///Field `TIE_HIGH_XPD_BB_I2C` writer - need_des
pub type TIE_HIGH_XPD_BB_I2C_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIE_HIGH_XPD_BBPLL_I2C` writer - need_des
pub type TIE_HIGH_XPD_BBPLL_I2C_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIE_HIGH_XPD_BBPLL` writer - need_des
