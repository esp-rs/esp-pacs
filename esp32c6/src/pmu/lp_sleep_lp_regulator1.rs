///Register `LP_SLEEP_LP_REGULATOR1` reader
pub type R = crate::R<LP_SLEEP_LP_REGULATOR1_SPEC>;
///Register `LP_SLEEP_LP_REGULATOR1` writer
pub type W = crate::W<LP_SLEEP_LP_REGULATOR1_SPEC>;
///Field `LP_SLEEP_LP_REGULATOR_DRV_B` reader - need_des
pub type LP_SLEEP_LP_REGULATOR_DRV_B_R = crate::FieldReader;
///Field `LP_SLEEP_LP_REGULATOR_DRV_B` writer - need_des
...
///`read()` method returns [`lp_sleep_lp_regulator1::R`](R) reader structure
impl crate::Readable for LP_SLEEP_LP_REGULATOR1_SPEC {}
///`write(|w| ..)` method takes [`lp_sleep_lp_regulator1::W`](W) writer structure
