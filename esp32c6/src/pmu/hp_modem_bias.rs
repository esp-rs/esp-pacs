...
///Field `HP_MODEM_DBG_ATTEN` reader - need_des
...
///Field `HP_MODEM_PD_CUR` reader - need_des
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_MODEM_BIAS")
            ...
            .field("hp_modem_dbg_atten", &self.hp_modem_dbg_atten())
...
///`read()` method returns [`hp_modem_bias::R`](R) reader structure
...
///`reset()` method sets HP_MODEM_BIAS to value 0
