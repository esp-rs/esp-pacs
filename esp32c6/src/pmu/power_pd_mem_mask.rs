...
///`read()` method returns [`power_pd_mem_mask::R`](R) reader structure
impl crate::Readable for POWER_PD_MEM_MASK_SPEC {}
///`write(|w| ..)` method takes [`power_pd_mem_mask::W`](W) writer structure
