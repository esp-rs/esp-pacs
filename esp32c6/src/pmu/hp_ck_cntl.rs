...
///`read()` method returns [`hp_ck_cntl::R`](R) reader structure
impl crate::Readable for HP_CK_CNTL_SPEC {}
///`write(|w| ..)` method takes [`hp_ck_cntl::W`](W) writer structure
