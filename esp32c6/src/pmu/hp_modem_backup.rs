...
///Field `HP_MODEM_RETENTION_MODE` reader - need_des
...
///Field `HP_SLEEP2MODEM_RETENTION_EN` reader - need_des
...
///Field `HP_SLEEP2MODEM_BACKUP_CLK_SEL` reader - need_des
...
///Field `HP_SLEEP2MODEM_BACKUP_MODE` reader - need_des
...
///Field `HP_SLEEP2MODEM_BACKUP_EN` reader - need_des
...
///`read()` method returns [`hp_modem_backup::R`](R) reader structure
