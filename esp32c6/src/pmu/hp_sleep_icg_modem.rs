///Register `HP_SLEEP_ICG_MODEM` reader
pub type R = crate::R<HP_SLEEP_ICG_MODEM_SPEC>;
///Register `HP_SLEEP_ICG_MODEM` writer
pub type W = crate::W<HP_SLEEP_ICG_MODEM_SPEC>;
///Field `HP_SLEEP_DIG_ICG_MODEM_CODE` reader - need_des
pub type HP_SLEEP_DIG_ICG_MODEM_CODE_R = crate::FieldReader;
///Field `HP_SLEEP_DIG_ICG_MODEM_CODE` writer - need_des
...
///`read()` method returns [`hp_sleep_icg_modem::R`](R) reader structure
impl crate::Readable for HP_SLEEP_ICG_MODEM_SPEC {}
///`write(|w| ..)` method takes [`hp_sleep_icg_modem::W`](W) writer structure
