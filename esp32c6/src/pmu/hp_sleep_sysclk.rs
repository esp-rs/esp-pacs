...
///`read()` method returns [`hp_sleep_sysclk::R`](R) reader structure
impl crate::Readable for HP_SLEEP_SYSCLK_SPEC {}
///`write(|w| ..)` method takes [`hp_sleep_sysclk::W`](W) writer structure
