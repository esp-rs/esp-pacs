...
pub type HP_SLEEP_UART_WAKEUP_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_SLEEP_LP_PAD_HOLD_ALL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_SLEEP_HP_PAD_HOLD_ALL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_SLEEP_DIG_PAD_SLP_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_SLEEP_DIG_PAUSE_WDT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_SLEEP_DIG_CPU_STALL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_sleep_uart_wakeup_en(
        &mut self,
    ) -> HP_SLEEP_UART_WAKEUP_EN_W<HP_SLEEP_HP_SYS_CNTL_SPEC, 24> {
    ...
    pub fn hp_sleep_lp_pad_hold_all(
        &mut self,
    ) -> HP_SLEEP_LP_PAD_HOLD_ALL_W<HP_SLEEP_HP_SYS_CNTL_SPEC, 25> {
    ...
    pub fn hp_sleep_hp_pad_hold_all(
        &mut self,
    ) -> HP_SLEEP_HP_PAD_HOLD_ALL_W<HP_SLEEP_HP_SYS_CNTL_SPEC, 26> {
    ...
    pub fn hp_sleep_dig_pad_slp_sel(
        &mut self,
    ) -> HP_SLEEP_DIG_PAD_SLP_SEL_W<HP_SLEEP_HP_SYS_CNTL_SPEC, 27> {
    ...
    pub fn hp_sleep_dig_pause_wdt(
        &mut self,
    ) -> HP_SLEEP_DIG_PAUSE_WDT_W<HP_SLEEP_HP_SYS_CNTL_SPEC, 28> {
    ...
    pub fn hp_sleep_dig_cpu_stall(
        &mut self,
    ) -> HP_SLEEP_DIG_CPU_STALL_W<HP_SLEEP_HP_SYS_CNTL_SPEC, 29> {
