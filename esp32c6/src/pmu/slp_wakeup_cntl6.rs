...
///`read()` method returns [`slp_wakeup_cntl6::R`](R) reader structure
impl crate::Readable for SLP_WAKEUP_CNTL6_SPEC {}
///`write(|w| ..)` method takes [`slp_wakeup_cntl6::W`](W) writer structure
