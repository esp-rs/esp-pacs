...
pub type HP_MODEM_I2C_ISO_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_I2C_RETENTION_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_XPD_BB_I2C_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_XPD_BBPLL_I2C_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_MODEM_XPD_BBPLL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_i2c_iso_en(&mut self) -> HP_MODEM_I2C_ISO_EN_W<HP_MODEM_HP_CK_POWER_SPEC, 26> {
    ...
    pub fn hp_modem_i2c_retention(
        &mut self,
    ) -> HP_MODEM_I2C_RETENTION_W<HP_MODEM_HP_CK_POWER_SPEC, 27> {
        HP_MODEM_I2C_RETENTION_W::new(self)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_xpd_bb_i2c(&mut self) -> HP_MODEM_XPD_BB_I2C_W<HP_MODEM_HP_CK_POWER_SPEC, 28> {
    ...
    pub fn hp_modem_xpd_bbpll_i2c(
        &mut self,
    ) -> HP_MODEM_XPD_BBPLL_I2C_W<HP_MODEM_HP_CK_POWER_SPEC, 29> {
        HP_MODEM_XPD_BBPLL_I2C_W::new(self)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_xpd_bbpll(&mut self) -> HP_MODEM_XPD_BBPLL_W<HP_MODEM_HP_CK_POWER_SPEC, 30> {
