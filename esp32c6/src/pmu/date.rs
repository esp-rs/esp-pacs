...
pub type PMU_DATE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 31, O, u32>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pmu_date(&mut self) -> PMU_DATE_W<DATE_SPEC, 0> {
        PMU_DATE_W::new(self)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_6250;
}
