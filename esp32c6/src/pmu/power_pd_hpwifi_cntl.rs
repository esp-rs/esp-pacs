...
///`read()` method returns [`power_pd_hpwifi_cntl::R`](R) reader structure
impl crate::Readable for POWER_PD_HPWIFI_CNTL_SPEC {}
///`write(|w| ..)` method takes [`power_pd_hpwifi_cntl::W`](W) writer structure
