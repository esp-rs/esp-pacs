///Register `HP_ACTIVE_ICG_HP_FUNC` reader
pub type R = crate::R<HP_ACTIVE_ICG_HP_FUNC_SPEC>;
///Register `HP_ACTIVE_ICG_HP_FUNC` writer
pub type W = crate::W<HP_ACTIVE_ICG_HP_FUNC_SPEC>;
///Field `HP_ACTIVE_DIG_ICG_FUNC_EN` reader - need_des
pub type HP_ACTIVE_DIG_ICG_FUNC_EN_R = crate::FieldReader<u32>;
///Field `HP_ACTIVE_DIG_ICG_FUNC_EN` writer - need_des
...
///`read()` method returns [`hp_active_icg_hp_func::R`](R) reader structure
impl crate::Readable for HP_ACTIVE_ICG_HP_FUNC_SPEC {}
///`write(|w| ..)` method takes [`hp_active_icg_hp_func::W`](W) writer structure
