///Register `HP_MODEM_ICG_HP_APB` reader
pub type R = crate::R<HP_MODEM_ICG_HP_APB_SPEC>;
///Register `HP_MODEM_ICG_HP_APB` writer
pub type W = crate::W<HP_MODEM_ICG_HP_APB_SPEC>;
///Field `HP_MODEM_DIG_ICG_APB_EN` reader - need_des
...
///`read()` method returns [`hp_modem_icg_hp_apb::R`](R) reader structure
impl crate::Readable for HP_MODEM_ICG_HP_APB_SPEC {}
///`write(|w| ..)` method takes [`hp_modem_icg_hp_apb::W`](W) writer structure
