...
pub type LP_CPU_EXC_INT_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_INT_CLR_SPEC, bool, O>;
#[doc = "Field `SDIO_IDLE_INT_CLR` writer - need_des"]
pub type SDIO_IDLE_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HP_INT_CLR_SPEC, bool, O>;
#[doc = "Field `SW_INT_CLR` writer - need_des"]
pub type SW_INT_CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, HP_INT_CLR_SPEC, bool, O>;
#[doc = "Field `SOC_SLEEP_REJECT_INT_CLR` writer - need_des"]
pub type SOC_SLEEP_REJECT_INT_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_INT_CLR_SPEC, bool, O>;
#[doc = "Field `SOC_WAKEUP_INT_CLR` writer - need_des"]
pub type SOC_WAKEUP_INT_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_INT_CLR_SPEC, bool, O>;
impl W {
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
