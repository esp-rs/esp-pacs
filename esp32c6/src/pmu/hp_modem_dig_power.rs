...
pub struct R(crate::R<HP_MODEM_DIG_POWER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HP_MODEM_DIG_POWER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HP_MODEM_DIG_POWER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HP_MODEM_DIG_POWER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HP_MODEM_DIG_POWER` writer"]
pub struct W(crate::W<HP_MODEM_DIG_POWER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HP_MODEM_DIG_POWER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HP_MODEM_DIG_POWER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HP_MODEM_DIG_POWER_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_vdd_spi_pd_en(&mut self) -> HP_MODEM_VDD_SPI_PD_EN_W<21> {
        HP_MODEM_VDD_SPI_PD_EN_W::new(self)
    }
    #[doc = "Bit 22 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_hp_mem_dslp(&mut self) -> HP_MODEM_HP_MEM_DSLP_W<22> {
        HP_MODEM_HP_MEM_DSLP_W::new(self)
    }
    #[doc = "Bits 23:26 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_hp_mem_pd_en(&mut self) -> HP_MODEM_PD_HP_MEM_PD_EN_W<23> {
        HP_MODEM_PD_HP_MEM_PD_EN_W::new(self)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_hp_wifi_pd_en(&mut self) -> HP_MODEM_PD_HP_WIFI_PD_EN_W<27> {
        HP_MODEM_PD_HP_WIFI_PD_EN_W::new(self)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_hp_cpu_pd_en(&mut self) -> HP_MODEM_PD_HP_CPU_PD_EN_W<29> {
        HP_MODEM_PD_HP_CPU_PD_EN_W::new(self)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_hp_aon_pd_en(&mut self) -> HP_MODEM_PD_HP_AON_PD_EN_W<30> {
        HP_MODEM_PD_HP_AON_PD_EN_W::new(self)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_modem_pd_top_pd_en(&mut self) -> HP_MODEM_PD_TOP_PD_EN_W<31> {
...
#[doc = "need_des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hp_modem_dig_power](index.html) module"]
