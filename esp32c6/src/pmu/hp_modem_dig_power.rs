///Register `HP_MODEM_DIG_POWER` reader
pub type R = crate::R<HP_MODEM_DIG_POWER_SPEC>;
///Register `HP_MODEM_DIG_POWER` writer
pub type W = crate::W<HP_MODEM_DIG_POWER_SPEC>;
///Field `HP_MODEM_VDD_SPI_PD_EN` reader - need_des
pub type HP_MODEM_VDD_SPI_PD_EN_R = crate::BitReader;
///Field `HP_MODEM_VDD_SPI_PD_EN` writer - need_des
pub type HP_MODEM_VDD_SPI_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HP_MODEM_HP_MEM_DSLP` reader - need_des
...
///Field `HP_MODEM_PD_HP_MEM_PD_EN` reader - need_des
...
///Field `HP_MODEM_PD_HP_WIFI_PD_EN` reader - need_des
pub type HP_MODEM_PD_HP_WIFI_PD_EN_R = crate::BitReader;
///Field `HP_MODEM_PD_HP_WIFI_PD_EN` writer - need_des
pub type HP_MODEM_PD_HP_WIFI_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HP_MODEM_PD_HP_CPU_PD_EN` reader - need_des
...
///Field `HP_MODEM_PD_HP_AON_PD_EN` reader - need_des
pub type HP_MODEM_PD_HP_AON_PD_EN_R = crate::BitReader;
///Field `HP_MODEM_PD_HP_AON_PD_EN` writer - need_des
pub type HP_MODEM_PD_HP_AON_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HP_MODEM_PD_TOP_PD_EN` reader - need_des
...
///`read()` method returns [`hp_modem_dig_power::R`](R) reader structure
impl crate::Readable for HP_MODEM_DIG_POWER_SPEC {}
///`write(|w| ..)` method takes [`hp_modem_dig_power::W`](W) writer structure
