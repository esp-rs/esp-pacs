...
pub type LP_SLEEP_DBG_ATTEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_sleep_dbg_atten(&mut self) -> LP_SLEEP_DBG_ATTEN_W<LP_SLEEP_BIAS_SPEC, 26> {
