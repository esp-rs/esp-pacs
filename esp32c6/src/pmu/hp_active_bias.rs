...
pub type HP_ACTIVE_DBG_ATTEN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `HP_ACTIVE_DBG_ATTEN` writer - need_des"]
pub type HP_ACTIVE_DBG_ATTEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HP_ACTIVE_BIAS_SPEC, u8, u8, 4, O>;
