...
pub type HP_ACTIVE_XPD_BIAS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HP_ACTIVE_DBG_ATTEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type HP_ACTIVE_PD_CUR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_active_xpd_bias(&mut self) -> HP_ACTIVE_XPD_BIAS_W<HP_ACTIVE_BIAS_SPEC, 25> {
        HP_ACTIVE_XPD_BIAS_W::new(self)
    }
    #[doc = "Bits 26:29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_active_dbg_atten(&mut self) -> HP_ACTIVE_DBG_ATTEN_W<HP_ACTIVE_BIAS_SPEC, 26> {
        HP_ACTIVE_DBG_ATTEN_W::new(self)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn hp_active_pd_cur(&mut self) -> HP_ACTIVE_PD_CUR_W<HP_ACTIVE_BIAS_SPEC, 30> {
        HP_ACTIVE_PD_CUR_W::new(self)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn sleep(&mut self) -> SLEEP_W<HP_ACTIVE_BIAS_SPEC, 31> {
        SLEEP_W::new(self)
    }
