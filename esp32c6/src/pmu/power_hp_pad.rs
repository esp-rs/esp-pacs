...
///`read()` method returns [`power_hp_pad::R`](R) reader structure
impl crate::Readable for POWER_HP_PAD_SPEC {}
///`write(|w| ..)` method takes [`power_hp_pad::W`](W) writer structure
