...
///`read()` method returns [`hp_active_sysclk::R`](R) reader structure
impl crate::Readable for HP_ACTIVE_SYSCLK_SPEC {}
///`write(|w| ..)` method takes [`hp_active_sysclk::W`](W) writer structure
