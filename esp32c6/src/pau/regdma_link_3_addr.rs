...
pub struct R(crate::R<REGDMA_LINK_3_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REGDMA_LINK_3_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REGDMA_LINK_3_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REGDMA_LINK_3_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REGDMA_LINK_3_ADDR` writer"]
pub struct W(crate::W<REGDMA_LINK_3_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REGDMA_LINK_3_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REGDMA_LINK_3_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REGDMA_LINK_3_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `LINK_ADDR_3` reader - Link_3_addr reg"]
pub type LINK_ADDR_3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LINK_ADDR_3` writer - Link_3_addr reg"]
pub type LINK_ADDR_3_W<'a, const O: u8> =
    crate::FieldWriter<'a, REGDMA_LINK_3_ADDR_SPEC, 32, O, u32, u32>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<REGDMA_LINK_3_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn link_addr_3(&mut self) -> LINK_ADDR_3_W<0> {
        LINK_ADDR_3_W::new(self)
    }
...
#[doc = "Link_3_addr\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [regdma_link_3_addr](index.html) module"]
