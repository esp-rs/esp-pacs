///Register `RETENTION_CFG` reader
pub type R = crate::R<RETENTION_CFG_SPEC>;
///Register `RETENTION_CFG` writer
pub type W = crate::W<RETENTION_CFG_SPEC>;
///Field `RET_INV_CFG` reader - retention inv scan out
pub type RET_INV_CFG_R = crate::FieldReader<u32>;
///Field `RET_INV_CFG` writer - retention inv scan out
pub type RET_INV_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - retention inv scan out
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RETENTION_CFG")
            .field("ret_inv_cfg", &self.ret_inv_cfg())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`retention_cfg::R`](R) reader structure
impl crate::Readable for RETENTION_CFG_SPEC {}
///`write(|w| ..)` method takes [`retention_cfg::W`](W) writer structure
