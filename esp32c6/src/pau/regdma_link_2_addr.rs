...
///`read()` method returns [`regdma_link_2_addr::R`](R) reader structure
impl crate::Readable for REGDMA_LINK_2_ADDR_SPEC {}
///`write(|w| ..)` method takes [`regdma_link_2_addr::W`](W) writer structure
