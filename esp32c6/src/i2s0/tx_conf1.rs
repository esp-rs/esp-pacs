...
///Field `TX_TDM_WS_WIDTH` reader - The width of tx_ws_out in TDM mode is (I2S_TX_TDM_WS_WIDTH\[6:0\] +1) * T_bck
pub type TX_TDM_WS_WIDTH_R = crate::FieldReader;
///Field `TX_TDM_WS_WIDTH` writer - The width of tx_ws_out in TDM mode is (I2S_TX_TDM_WS_WIDTH\[6:0\] +1) * T_bck
