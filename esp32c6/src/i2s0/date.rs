...
///Field `DATE` reader - I2S version control register
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - I2S version control register
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - I2S version control register
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x0220_1070
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0220_1070;
}
