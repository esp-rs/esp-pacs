...
pub struct R(crate::R<WIFI_MAC_INTR_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WIFI_MAC_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WIFI_MAC_INTR_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WIFI_MAC_INTR_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `WIFI_MAC_INTR_MAP` writer"]
pub struct W(crate::W<WIFI_MAC_INTR_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<WIFI_MAC_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<WIFI_MAC_INTR_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WIFI_MAC_INTR_MAP_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `WIFI_MAC_INTR_MAP` reader - Need add description"]
pub type WIFI_MAC_INTR_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WIFI_MAC_INTR_MAP` writer - Need add description"]
pub type WIFI_MAC_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, WIFI_MAC_INTR_MAP_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wifi_mac_intr_map(&mut self) -> WIFI_MAC_INTR_MAP_W<0> {
        WIFI_MAC_INTR_MAP_W::new(self)
    }
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wifi_mac_intr_map](index.html) module"]
