...
pub type WIFI_MAC_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wifi_mac_intr_map(&mut self) -> WIFI_MAC_INTR_MAP_W<WIFI_MAC_INTR_MAP_SPEC, 0> {
