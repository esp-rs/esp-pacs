...
pub type HP_APM_M3_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_apm_m3_intr_map(&mut self) -> HP_APM_M3_INTR_MAP_W<HP_APM_M3_INTR_MAP_SPEC, 0> {
