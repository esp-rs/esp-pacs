...
pub struct R(crate::R<CPU_PERI_TIMEOUT_INTR_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CPU_PERI_TIMEOUT_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CPU_PERI_TIMEOUT_INTR_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CPU_PERI_TIMEOUT_INTR_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CPU_PERI_TIMEOUT_INTR_MAP` writer"]
pub struct W(crate::W<CPU_PERI_TIMEOUT_INTR_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CPU_PERI_TIMEOUT_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CPU_PERI_TIMEOUT_INTR_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CPU_PERI_TIMEOUT_INTR_MAP_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CPU_PERI_TIMEOUT_INTR_MAP` reader - Need add description"]
pub type CPU_PERI_TIMEOUT_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `CPU_PERI_TIMEOUT_INTR_MAP` writer - Need add description"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpu_peri_timeout_intr_map(&mut self) -> CPU_PERI_TIMEOUT_INTR_MAP_W<0> {
        CPU_PERI_TIMEOUT_INTR_MAP_W::new(self)
    }
...
#[doc = "register description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cpu_peri_timeout_intr_map](index.html) module"]
