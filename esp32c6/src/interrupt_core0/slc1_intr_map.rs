...
#[doc = "Field `SLC1_INTR_MAP` reader - Need add description"]
pub type SLC1_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `SLC1_INTR_MAP` writer - Need add description"]
pub type SLC1_INTR_MAP_W<'a, const O: u8> = crate::FieldWriter<'a, SLC1_INTR_MAP_SPEC, 5, O>;
impl R {
