...
pub type HP_APM_M0_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_APM_M0_INTR_MAP")
            .field(
                "hp_apm_m0_intr_map",
                &format_args!("{}", self.hp_apm_m0_intr_map().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hp_apm_m0_intr_map(&mut self) -> HP_APM_M0_INTR_MAP_W<HP_APM_M0_INTR_MAP_SPEC, 0> {
