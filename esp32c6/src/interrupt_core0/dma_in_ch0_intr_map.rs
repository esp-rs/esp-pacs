...
pub type DMA_IN_CH0_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_in_ch0_intr_map(&mut self) -> DMA_IN_CH0_INTR_MAP_W<DMA_IN_CH0_INTR_MAP_SPEC, 0> {
