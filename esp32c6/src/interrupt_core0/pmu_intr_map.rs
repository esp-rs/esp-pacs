...
#[doc = "Field `PMU_INTR_MAP` reader - Need add description"]
pub type PMU_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `PMU_INTR_MAP` writer - Need add description"]
pub type PMU_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pmu_intr_map(&mut self) -> PMU_INTR_MAP_W<PMU_INTR_MAP_SPEC, 0> {
