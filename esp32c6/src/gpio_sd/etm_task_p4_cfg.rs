...
pub type ETM_TASK_GPIO16_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P4_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO16_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, ETM_TASK_P4_CFG_SPEC, 3, O>;
...
pub type ETM_TASK_GPIO17_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P4_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO18_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P4_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO19_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P4_CFG_SPEC, O>;
