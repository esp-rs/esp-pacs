...
pub type ETM_TASK_GPIO24_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO24_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ETM_TASK_GPIO25_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO25_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ETM_TASK_GPIO26_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO26_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ETM_TASK_GPIO27_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO27_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio24_en(&mut self) -> ETM_TASK_GPIO24_EN_W<ETM_TASK_P6_CFG_SPEC, 0> {
        ETM_TASK_GPIO24_EN_W::new(self)
    }
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio24_sel(&mut self) -> ETM_TASK_GPIO24_SEL_W<ETM_TASK_P6_CFG_SPEC, 1> {
        ETM_TASK_GPIO24_SEL_W::new(self)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio25_en(&mut self) -> ETM_TASK_GPIO25_EN_W<ETM_TASK_P6_CFG_SPEC, 8> {
        ETM_TASK_GPIO25_EN_W::new(self)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio25_sel(&mut self) -> ETM_TASK_GPIO25_SEL_W<ETM_TASK_P6_CFG_SPEC, 9> {
        ETM_TASK_GPIO25_SEL_W::new(self)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio26_en(&mut self) -> ETM_TASK_GPIO26_EN_W<ETM_TASK_P6_CFG_SPEC, 16> {
        ETM_TASK_GPIO26_EN_W::new(self)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio26_sel(&mut self) -> ETM_TASK_GPIO26_SEL_W<ETM_TASK_P6_CFG_SPEC, 17> {
        ETM_TASK_GPIO26_SEL_W::new(self)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio27_en(&mut self) -> ETM_TASK_GPIO27_EN_W<ETM_TASK_P6_CFG_SPEC, 24> {
        ETM_TASK_GPIO27_EN_W::new(self)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio27_sel(&mut self) -> ETM_TASK_GPIO27_SEL_W<ETM_TASK_P6_CFG_SPEC, 25> {
