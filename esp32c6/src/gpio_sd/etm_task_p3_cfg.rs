...
pub struct R(crate::R<ETM_TASK_P3_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETM_TASK_P3_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETM_TASK_P3_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETM_TASK_P3_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ETM_TASK_P3_CFG` writer"]
pub struct W(crate::W<ETM_TASK_P3_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ETM_TASK_P3_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio12_en(&mut self) -> ETM_TASK_GPIO12_EN_W<0> {
        ETM_TASK_GPIO12_EN_W::new(self)
    }
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio12_sel(&mut self) -> ETM_TASK_GPIO12_SEL_W<1> {
        ETM_TASK_GPIO12_SEL_W::new(self)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio13_en(&mut self) -> ETM_TASK_GPIO13_EN_W<8> {
        ETM_TASK_GPIO13_EN_W::new(self)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio13_sel(&mut self) -> ETM_TASK_GPIO13_SEL_W<9> {
        ETM_TASK_GPIO13_SEL_W::new(self)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio14_en(&mut self) -> ETM_TASK_GPIO14_EN_W<16> {
        ETM_TASK_GPIO14_EN_W::new(self)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio14_sel(&mut self) -> ETM_TASK_GPIO14_SEL_W<17> {
        ETM_TASK_GPIO14_SEL_W::new(self)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio15_en(&mut self) -> ETM_TASK_GPIO15_EN_W<24> {
        ETM_TASK_GPIO15_EN_W::new(self)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio15_sel(&mut self) -> ETM_TASK_GPIO15_SEL_W<25> {
