...
pub type ETM_TASK_GPIO20_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P5_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO20_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, ETM_TASK_P5_CFG_SPEC, 3, O>;
...
pub type ETM_TASK_GPIO21_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P5_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO22_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P5_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO23_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P5_CFG_SPEC, O>;
