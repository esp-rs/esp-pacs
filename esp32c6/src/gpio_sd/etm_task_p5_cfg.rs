///Register `ETM_TASK_P5_CFG` reader
pub type R = crate::R<ETM_TASK_P5_CFG_SPEC>;
///Register `ETM_TASK_P5_CFG` writer
pub type W = crate::W<ETM_TASK_P5_CFG_SPEC>;
///Field `GPIO_EN(20-23)` reader - Enable bit of GPIO response etm task.
pub type GPIO_EN_R = crate::BitReader;
///Field `GPIO_EN(20-23)` writer - Enable bit of GPIO response etm task.
pub type GPIO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GPIO_SEL(20-23)` reader - GPIO choose a etm task channel.
pub type GPIO_SEL_R = crate::FieldReader;
///Field `GPIO_SEL(20-23)` writer - GPIO choose a etm task channel.
pub type GPIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Enable bit of GPIO response etm task.
    ///
    ///NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO20_EN` field
    #[inline(always)]
    ...
    ///
    ///NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO20_SEL` field
    #[inline(always)]
...
///`read()` method returns [`etm_task_p5_cfg::R`](R) reader structure
impl crate::Readable for ETM_TASK_P5_CFG_SPEC {}
///`write(|w| ..)` method takes [`etm_task_p5_cfg::W`](W) writer structure
