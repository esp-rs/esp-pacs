...
pub type ETM_TASK_GPIO4_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P1_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO4_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, ETM_TASK_P1_CFG_SPEC, 3, O>;
...
pub type ETM_TASK_GPIO5_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P1_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO5_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, ETM_TASK_P1_CFG_SPEC, 3, O>;
...
pub type ETM_TASK_GPIO6_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P1_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO6_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, ETM_TASK_P1_CFG_SPEC, 3, O>;
...
pub type ETM_TASK_GPIO7_EN_W<'a, const O: u8> = crate::BitWriter<'a, ETM_TASK_P1_CFG_SPEC, O>;
...
pub type ETM_TASK_GPIO7_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, ETM_TASK_P1_CFG_SPEC, 3, O>;
impl R {
