...
pub type ETM_TASK_GPIO0_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO0_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ETM_TASK_GPIO1_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO1_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ETM_TASK_GPIO2_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO2_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type ETM_TASK_GPIO3_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ETM_TASK_GPIO3_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio0_en(&mut self) -> ETM_TASK_GPIO0_EN_W<ETM_TASK_P0_CFG_SPEC, 0> {
        ETM_TASK_GPIO0_EN_W::new(self)
    }
    #[doc = "Bits 1:3 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio0_sel(&mut self) -> ETM_TASK_GPIO0_SEL_W<ETM_TASK_P0_CFG_SPEC, 1> {
        ETM_TASK_GPIO0_SEL_W::new(self)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio1_en(&mut self) -> ETM_TASK_GPIO1_EN_W<ETM_TASK_P0_CFG_SPEC, 8> {
        ETM_TASK_GPIO1_EN_W::new(self)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio1_sel(&mut self) -> ETM_TASK_GPIO1_SEL_W<ETM_TASK_P0_CFG_SPEC, 9> {
        ETM_TASK_GPIO1_SEL_W::new(self)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio2_en(&mut self) -> ETM_TASK_GPIO2_EN_W<ETM_TASK_P0_CFG_SPEC, 16> {
        ETM_TASK_GPIO2_EN_W::new(self)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio2_sel(&mut self) -> ETM_TASK_GPIO2_SEL_W<ETM_TASK_P0_CFG_SPEC, 17> {
        ETM_TASK_GPIO2_SEL_W::new(self)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio3_en(&mut self) -> ETM_TASK_GPIO3_EN_W<ETM_TASK_P0_CFG_SPEC, 24> {
        ETM_TASK_GPIO3_EN_W::new(self)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn etm_task_gpio3_sel(&mut self) -> ETM_TASK_GPIO3_SEL_W<ETM_TASK_P0_CFG_SPEC, 25> {
