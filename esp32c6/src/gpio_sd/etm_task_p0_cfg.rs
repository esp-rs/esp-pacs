...
#[doc = "Field `GPIO_EN(0-3)` reader - Enable bit of GPIO response etm task."]
pub type GPIO_EN_R = crate::BitReader;
#[doc = "Field `GPIO_EN(0-3)` writer - Enable bit of GPIO response etm task."]
pub type GPIO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `GPIO_SEL(0-3)` reader - GPIO choose a etm task channel."]
pub type GPIO_SEL_R = crate::FieldReader;
#[doc = "Field `GPIO_SEL(0-3)` writer - GPIO choose a etm task channel."]
pub type GPIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Enable bit of GPIO response etm task."]
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO0_EN` field"]
    #[inline(always)]
    ...
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO0_SEL` field"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETM_TASK_P0_CFG")
            .field("gpio0_en", &format_args!("{}", self.gpio0_en().bit()))
            .field("gpio1_en", &format_args!("{}", self.gpio1_en().bit()))
            .field("gpio2_en", &format_args!("{}", self.gpio2_en().bit()))
            .field("gpio3_en", &format_args!("{}", self.gpio3_en().bit()))
            .field("gpio0_sel", &format_args!("{}", self.gpio0_sel().bits()))
            .field("gpio1_sel", &format_args!("{}", self.gpio1_sel().bits()))
            .field("gpio2_sel", &format_args!("{}", self.gpio2_sel().bits()))
            .field("gpio3_sel", &format_args!("{}", self.gpio3_sel().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_en(&mut self, n: u8) -> GPIO_EN_W<ETM_TASK_P0_CFG_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0_en(&mut self) -> GPIO_EN_W<ETM_TASK_P0_CFG_SPEC> {
        GPIO_EN_W::new(self, 0)
    }
    #[doc = "Bit 8 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn gpio1_en(&mut self) -> GPIO_EN_W<ETM_TASK_P0_CFG_SPEC> {
        GPIO_EN_W::new(self, 8)
    }
    #[doc = "Bit 16 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn gpio2_en(&mut self) -> GPIO_EN_W<ETM_TASK_P0_CFG_SPEC> {
        GPIO_EN_W::new(self, 16)
    }
    #[doc = "Bit 24 - Enable bit of GPIO response etm task."]
    #[inline(always)]
    #[must_use]
    pub fn gpio3_en(&mut self) -> GPIO_EN_W<ETM_TASK_P0_CFG_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_sel(&mut self, n: u8) -> GPIO_SEL_W<ETM_TASK_P0_CFG_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P0_CFG_SPEC> {
        GPIO_SEL_W::new(self, 1)
    }
    #[doc = "Bits 9:11 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn gpio1_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P0_CFG_SPEC> {
        GPIO_SEL_W::new(self, 9)
    }
    #[doc = "Bits 17:19 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn gpio2_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P0_CFG_SPEC> {
        GPIO_SEL_W::new(self, 17)
    }
    #[doc = "Bits 25:27 - GPIO choose a etm task channel."]
    #[inline(always)]
    #[must_use]
    pub fn gpio3_sel(&mut self) -> GPIO_SEL_W<ETM_TASK_P0_CFG_SPEC> {
