...
impl R {
    ...
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO28_EN` field"]
    #[inline(always)]
    ...
    #[doc = ""]
    #[doc = "NOTE: `n` is number of field in register. `n == 0` corresponds to `GPIO28_SEL` field"]
    #[inline(always)]
