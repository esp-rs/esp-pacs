...
#[doc = "Field `DATE` reader - need_des"]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - need_des"]
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATE_SPEC, u32, u32, 31, O>;
...
#[doc = "`reset()` method sets DATE to value 0x0220_5280"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_5280;
}
