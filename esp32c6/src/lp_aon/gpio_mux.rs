///Register `GPIO_MUX` reader
pub type R = crate::R<GPIO_MUX_SPEC>;
///Register `GPIO_MUX` writer
pub type W = crate::W<GPIO_MUX_SPEC>;
///Field `SEL` reader - need_des
pub type SEL_R = crate::FieldReader;
///Field `SEL` writer - need_des
...
///`read()` method returns [`gpio_mux::R`](R) reader structure
impl crate::Readable for GPIO_MUX_SPEC {}
///`write(|w| ..)` method takes [`gpio_mux::W`](W) writer structure
