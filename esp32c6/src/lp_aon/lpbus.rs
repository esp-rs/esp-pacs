...
pub type FAST_MEM_MUX_SEL_UPDATE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LPBUS_SPEC, bool, O>;
...
pub type FAST_MEM_MUX_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPBUS_SPEC, bool, O>;
impl R {
