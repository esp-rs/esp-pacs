...
///Field `CNT_H_LIM` reader - This register is used to configure the thr_h_lim value for unit %s.
pub type CNT_H_LIM_R = crate::FieldReader<u16>;
///Field `CNT_H_LIM` writer - This register is used to configure the thr_h_lim value for unit %s.
pub type CNT_H_LIM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `CNT_L_LIM` reader - This register is used to configure the thr_l_lim value for unit %s.
pub type CNT_L_LIM_R = crate::FieldReader<u16>;
///Field `CNT_L_LIM` writer - This register is used to configure the thr_l_lim value for unit %s.
pub type CNT_L_LIM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - This register is used to configure the thr_h_lim value for unit %s.
    #[inline(always)]
    pub fn cnt_h_lim(&self) -> CNT_H_LIM_R {
        CNT_H_LIM_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - This register is used to configure the thr_l_lim value for unit %s.
    #[inline(always)]
