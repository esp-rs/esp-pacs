...
#[doc = "Field `DATE` reader - This is the PCNT version control register."]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - This is the PCNT version control register."]
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - This is the PCNT version control register."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x1907_2601"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x1907_2601;
}
