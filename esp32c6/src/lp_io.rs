...
///need des
pub mod out_data;
/**OUT_DATA_W1TS (w) register accessor: need des
...
/**OUT_DATA_W1TC (w) register accessor: need des
...
///need des
pub mod out_enable;
/**OUT_ENABLE_W1TS (w) register accessor: need des
...
/**OUT_ENABLE_W1TC (w) register accessor: need des
...
///need des
pub mod in_;
/**PIN0 (rw) register accessor: need des
...
///need des
pub mod pin0;
/**PIN1 (rw) register accessor: need des
...
///need des
pub mod pin1;
/**PIN2 (rw) register accessor: need des
...
///need des
pub mod pin2;
/**PIN3 (rw) register accessor: need des
...
///need des
pub mod pin3;
/**PIN4 (rw) register accessor: need des
...
///need des
pub mod pin4;
/**PIN5 (rw) register accessor: need des
...
///need des
pub mod pin5;
/**PIN6 (rw) register accessor: need des
...
///need des
pub mod pin6;
/**PIN7 (rw) register accessor: need des
...
///need des
pub mod pin7;
/**GPIO0 (rw) register accessor: need des
...
///need des
pub mod gpio0;
/**GPIO1 (rw) register accessor: need des
...
///need des
pub mod gpio1;
/**GPIO2 (rw) register accessor: need des
...
///need des
pub mod gpio2;
/**GPIO3 (rw) register accessor: need des
...
///need des
pub mod gpio3;
/**GPIO4 (rw) register accessor: need des
...
///need des
pub mod gpio4;
/**GPIO5 (rw) register accessor: need des
...
///need des
pub mod gpio5;
/**GPIO6 (rw) register accessor: need des
...
///need des
pub mod gpio6;
/**GPIO7 (rw) register accessor: need des
...
///need des
pub mod gpio7;
/**STATUS_INTERRUPT (r) register accessor: need des
...
/**DEBUG_SEL0 (rw) register accessor: need des
...
///need des
pub mod debug_sel0;
/**DEBUG_SEL1 (rw) register accessor: need des
...
///need des
pub mod debug_sel1;
/**LPI2C (rw) register accessor: need des
