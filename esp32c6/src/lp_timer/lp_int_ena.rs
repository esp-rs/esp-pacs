...
pub type MAIN_TIMER_OVERFLOW_LP_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MAIN_TIMER_LP_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    pub fn main_timer_overflow_lp_int_ena(
        &mut self,
    ) -> MAIN_TIMER_OVERFLOW_LP_INT_ENA_W<LP_INT_ENA_SPEC, 30> {
        MAIN_TIMER_OVERFLOW_LP_INT_ENA_W::new(self)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn main_timer_lp_int_ena(&mut self) -> MAIN_TIMER_LP_INT_ENA_W<LP_INT_ENA_SPEC, 31> {
