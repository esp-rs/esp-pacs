...
pub struct RegisterBlock {
    ...
    pub lp_timer_intr_map: LP_TIMER_INTR_MAP,
    ...
    pub i2c_mst_intr_map: I2C_MST_INTR_MAP,
    ...
    pub lp_uart_intr_map: LP_UART_INTR_MAP,
    #[doc = "0x44 - register description"]
    pub lp_i2c_intr_map: LP_I2C_INTR_MAP,
...
#[doc = "WIFI_MAC_INTR_MAP (rw) register accessor: an alias for `Reg<WIFI_MAC_INTR_MAP_SPEC>`"]
...
#[doc = "WIFI_PWR_INTR_MAP (rw) register accessor: an alias for `Reg<WIFI_PWR_INTR_MAP_SPEC>`"]
pub type WIFI_PWR_INTR_MAP = crate::Reg<wifi_pwr_intr_map::WIFI_PWR_INTR_MAP_SPEC>;
#[doc = "register description"]
pub mod wifi_pwr_intr_map;
#[doc = "WIFI_BB_INTR_MAP (rw) register accessor: an alias for `Reg<WIFI_BB_INTR_MAP_SPEC>`"]
...
#[doc = "LP_TIMER_INTR_MAP (rw) register accessor: an alias for `Reg<LP_TIMER_INTR_MAP_SPEC>`"]
...
#[doc = "I2C_MST_INTR_MAP (rw) register accessor: an alias for `Reg<I2C_MST_INTR_MAP_SPEC>`"]
...
#[doc = "LP_UART_INTR_MAP (rw) register accessor: an alias for `Reg<LP_UART_INTR_MAP_SPEC>`"]
pub type LP_UART_INTR_MAP = crate::Reg<lp_uart_intr_map::LP_UART_INTR_MAP_SPEC>;
#[doc = "register description"]
pub mod lp_uart_intr_map;
#[doc = "LP_I2C_INTR_MAP (rw) register accessor: an alias for `Reg<LP_I2C_INTR_MAP_SPEC>`"]
...
#[doc = "LP_APM_M1_INTR_MAP (rw) register accessor: an alias for `Reg<LP_APM_M1_INTR_MAP_SPEC>`"]
...
#[doc = "MODEM_PERI_TIMEOUT_INTR_MAP (rw) register accessor: an alias for `Reg<MODEM_PERI_TIMEOUT_INTR_MAP_SPEC>`"]
...
#[doc = "LP_APM0_INTR_MAP (rw) register accessor: an alias for `Reg<LP_APM0_INTR_MAP_SPEC>`"]
...
#[doc = "CAN1_INTR_MAP (rw) register accessor: an alias for `Reg<CAN1_INTR_MAP_SPEC>`"]
...
#[doc = "TG0_T1_INTR_MAP (rw) register accessor: an alias for `Reg<TG0_T1_INTR_MAP_SPEC>`"]
...
#[doc = "TG1_T1_INTR_MAP (rw) register accessor: an alias for `Reg<TG1_T1_INTR_MAP_SPEC>`"]
...
#[doc = "PARL_IO_INTR_MAP (rw) register accessor: an alias for `Reg<PARL_IO_INTR_MAP_SPEC>`"]
