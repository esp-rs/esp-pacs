...
You can [`read`](crate::generic::Reg::read) this register and get [`rx_ack_timeout_cnt::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rx_ack_timeout_cnt::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RX_ACK_TIMEOUT_CNT_SPEC;
impl crate::RegisterSpec for RX_ACK_TIMEOUT_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rx_ack_timeout_cnt::R`](R) reader structure
impl crate::Readable for RX_ACK_TIMEOUT_CNT_SPEC {}
///`write(|w| ..)` method takes [`rx_ack_timeout_cnt::W`](W) writer structure
