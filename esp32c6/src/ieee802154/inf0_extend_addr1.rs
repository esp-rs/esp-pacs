...
You can [`read`](crate::generic::Reg::read) this register and get [`inf0_extend_addr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`inf0_extend_addr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct INF0_EXTEND_ADDR1_SPEC;
impl crate::RegisterSpec for INF0_EXTEND_ADDR1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`inf0_extend_addr1::R`](R) reader structure
impl crate::Readable for INF0_EXTEND_ADDR1_SPEC {}
///`write(|w| ..)` method takes [`inf0_extend_addr1::W`](W) writer structure
