...
You can [`read`](crate::generic::Reg::read) this register and get [`sec_key1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sec_key1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct SEC_KEY1_SPEC;
impl crate::RegisterSpec for SEC_KEY1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`sec_key1::R`](R) reader structure
impl crate::Readable for SEC_KEY1_SPEC {}
///`write(|w| ..)` method takes [`sec_key1::W`](W) writer structure
