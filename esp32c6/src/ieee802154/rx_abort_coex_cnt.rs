...
///`read()` method returns [`rx_abort_coex_cnt::R`](R) reader structure
impl crate::Readable for RX_ABORT_COEX_CNT_SPEC {}
///`write(|w| ..)` method takes [`rx_abort_coex_cnt::W`](W) writer structure
