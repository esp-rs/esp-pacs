...
///`read()` method returns [`clk_counter::R`](R) reader structure
impl crate::Readable for CLK_COUNTER_SPEC {}
///`write(|w| ..)` method takes [`clk_counter::W`](W) writer structure
