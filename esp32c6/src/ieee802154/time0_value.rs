...
///`read()` method returns [`time0_value::R`](R) reader structure
impl crate::Readable for TIME0_VALUE_SPEC {}
///`write(|w| ..)` method takes [`time0_value::W`](W) writer structure
