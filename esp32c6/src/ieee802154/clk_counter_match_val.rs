...
///`read()` method returns [`clk_counter_match_val::R`](R) reader structure
impl crate::Readable for CLK_COUNTER_MATCH_VAL_SPEC {}
///`write(|w| ..)` method takes [`clk_counter_match_val::W`](W) writer structure
