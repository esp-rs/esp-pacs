...
///`read()` method returns [`crc_error_cnt::R`](R) reader structure
impl crate::Readable for CRC_ERROR_CNT_SPEC {}
///`write(|w| ..)` method takes [`crc_error_cnt::W`](W) writer structure
