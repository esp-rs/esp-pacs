...
You can [`read`](crate::generic::Reg::read) this register and get [`tx_ack_abort_coex_cnt::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tx_ack_abort_coex_cnt::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct TX_ACK_ABORT_COEX_CNT_SPEC;
impl crate::RegisterSpec for TX_ACK_ABORT_COEX_CNT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`tx_ack_abort_coex_cnt::R`](R) reader structure
impl crate::Readable for TX_ACK_ABORT_COEX_CNT_SPEC {}
///`write(|w| ..)` method takes [`tx_ack_abort_coex_cnt::W`](W) writer structure
