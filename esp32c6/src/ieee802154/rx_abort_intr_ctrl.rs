...
You can [`read`](crate::generic::Reg::read) this register and get [`rx_abort_intr_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rx_abort_intr_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct RX_ABORT_INTR_CTRL_SPEC;
impl crate::RegisterSpec for RX_ABORT_INTR_CTRL_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rx_abort_intr_ctrl::R`](R) reader structure
impl crate::Readable for RX_ABORT_INTR_CTRL_SPEC {}
///`write(|w| ..)` method takes [`rx_abort_intr_ctrl::W`](W) writer structure
