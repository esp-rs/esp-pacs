...
///`read()` method returns [`tx_break_coex_cnt::R`](R) reader structure
impl crate::Readable for TX_BREAK_COEX_CNT_SPEC {}
///`write(|w| ..)` method takes [`tx_break_coex_cnt::W`](W) writer structure
