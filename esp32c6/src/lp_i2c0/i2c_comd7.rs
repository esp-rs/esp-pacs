...
pub type I2C_COMMAND7_W<'a, const O: u8> = crate::FieldWriter<'a, I2C_COMD7_SPEC, 14, O, u16, u16>;
...
pub type I2C_COMMAND7_DONE_W<'a, const O: u8> = crate::BitWriter<'a, I2C_COMD7_SPEC, O>;
impl R {
