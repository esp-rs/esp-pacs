...
pub type I2C_SCLK_ACTIVE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_sclk_div_num(&mut self) -> I2C_SCLK_DIV_NUM_W<I2C_CLK_CONF_SPEC, 0> {
        I2C_SCLK_DIV_NUM_W::new(self)
    }
    #[doc = "Bits 8:13 - the numerator of the fractional part of the fractional divisor for i2c module"]
    #[inline(always)]
    #[must_use]
    pub fn i2c_sclk_div_a(&mut self) -> I2C_SCLK_DIV_A_W<I2C_CLK_CONF_SPEC, 8> {
        I2C_SCLK_DIV_A_W::new(self)
    }
    #[doc = "Bits 14:19 - the denominator of the fractional part of the fractional divisor for i2c module"]
    #[inline(always)]
    #[must_use]
    pub fn i2c_sclk_div_b(&mut self) -> I2C_SCLK_DIV_B_W<I2C_CLK_CONF_SPEC, 14> {
        I2C_SCLK_DIV_B_W::new(self)
    }
    #[doc = "Bit 20 - The clock selection for i2c module:0-XTAL,1-CLK_8MHz."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_sclk_sel(&mut self) -> I2C_SCLK_SEL_W<I2C_CLK_CONF_SPEC, 20> {
        I2C_SCLK_SEL_W::new(self)
    }
    #[doc = "Bit 21 - The clock switch for i2c module"]
    #[inline(always)]
    #[must_use]
    pub fn i2c_sclk_active(&mut self) -> I2C_SCLK_ACTIVE_W<I2C_CLK_CONF_SPEC, 21> {
