...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<I2C_SDA_HOLD_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn time(&mut self) -> TIME_W<I2C_SDA_HOLD_SPEC, 0> {
        TIME_W::new(self)
    }
...
#[doc = "Configures the hold time after a negative SCL edge.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`i2c_sda_hold::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`i2c_sda_hold::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
