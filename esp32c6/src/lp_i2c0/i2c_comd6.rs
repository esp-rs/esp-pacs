...
pub type I2C_COMMAND6_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
pub type I2C_COMMAND6_DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_command6(&mut self) -> I2C_COMMAND6_W<I2C_COMD6_SPEC, 0> {
        I2C_COMMAND6_W::new(self)
    }
    #[doc = "Bit 31 - When command 6 is done in I2C Master mode, this bit changes to high level."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_command6_done(&mut self) -> I2C_COMMAND6_DONE_W<I2C_COMD6_SPEC, 31> {
