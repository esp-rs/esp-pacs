...
pub type I2C_RXFIFO_WM_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_TXFIFO_WM_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_RXFIFO_OVF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_END_DETECT_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_BYTE_TRANS_DONE_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_ARBITRATION_LOST_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_MST_TXFIFO_UDF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_TRANS_COMPLETE_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_TIME_OUT_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_TRANS_START_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_NACK_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_TXFIFO_OVF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_RXFIFO_UDF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_SCL_ST_TO_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_SCL_MAIN_ST_TO_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type I2C_DET_START_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_rxfifo_wm_int_ena(&mut self) -> I2C_RXFIFO_WM_INT_ENA_W<I2C_INT_ENA_SPEC, 0> {
        I2C_RXFIFO_WM_INT_ENA_W::new(self)
    }
    #[doc = "Bit 1 - The interrupt enable bit for I2C_TXFIFO_WM_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_txfifo_wm_int_ena(&mut self) -> I2C_TXFIFO_WM_INT_ENA_W<I2C_INT_ENA_SPEC, 1> {
        I2C_TXFIFO_WM_INT_ENA_W::new(self)
    }
    #[doc = "Bit 2 - The interrupt enable bit for I2C_RXFIFO_OVF_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_rxfifo_ovf_int_ena(&mut self) -> I2C_RXFIFO_OVF_INT_ENA_W<I2C_INT_ENA_SPEC, 2> {
        I2C_RXFIFO_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 3 - The interrupt enable bit for the I2C_END_DETECT_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_end_detect_int_ena(&mut self) -> I2C_END_DETECT_INT_ENA_W<I2C_INT_ENA_SPEC, 3> {
    ...
    pub fn i2c_byte_trans_done_int_ena(
        &mut self,
    ) -> I2C_BYTE_TRANS_DONE_INT_ENA_W<I2C_INT_ENA_SPEC, 4> {
    ...
    pub fn i2c_arbitration_lost_int_ena(
        &mut self,
    ) -> I2C_ARBITRATION_LOST_INT_ENA_W<I2C_INT_ENA_SPEC, 5> {
    ...
    pub fn i2c_mst_txfifo_udf_int_ena(
        &mut self,
    ) -> I2C_MST_TXFIFO_UDF_INT_ENA_W<I2C_INT_ENA_SPEC, 6> {
    ...
    pub fn i2c_trans_complete_int_ena(
        &mut self,
    ) -> I2C_TRANS_COMPLETE_INT_ENA_W<I2C_INT_ENA_SPEC, 7> {
        I2C_TRANS_COMPLETE_INT_ENA_W::new(self)
    }
    #[doc = "Bit 8 - The interrupt enable bit for the I2C_TIME_OUT_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_time_out_int_ena(&mut self) -> I2C_TIME_OUT_INT_ENA_W<I2C_INT_ENA_SPEC, 8> {
        I2C_TIME_OUT_INT_ENA_W::new(self)
    }
    #[doc = "Bit 9 - The interrupt enable bit for the I2C_TRANS_START_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_trans_start_int_ena(&mut self) -> I2C_TRANS_START_INT_ENA_W<I2C_INT_ENA_SPEC, 9> {
        I2C_TRANS_START_INT_ENA_W::new(self)
    }
    #[doc = "Bit 10 - The interrupt enable bit for I2C_SLAVE_STRETCH_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_nack_int_ena(&mut self) -> I2C_NACK_INT_ENA_W<I2C_INT_ENA_SPEC, 10> {
        I2C_NACK_INT_ENA_W::new(self)
    }
    #[doc = "Bit 11 - The interrupt enable bit for I2C_TXFIFO_OVF_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_txfifo_ovf_int_ena(&mut self) -> I2C_TXFIFO_OVF_INT_ENA_W<I2C_INT_ENA_SPEC, 11> {
        I2C_TXFIFO_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 12 - The interrupt enable bit for I2C_RXFIFO_UDF_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_rxfifo_udf_int_ena(&mut self) -> I2C_RXFIFO_UDF_INT_ENA_W<I2C_INT_ENA_SPEC, 12> {
        I2C_RXFIFO_UDF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 13 - The interrupt enable bit for I2C_SCL_ST_TO_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_scl_st_to_int_ena(&mut self) -> I2C_SCL_ST_TO_INT_ENA_W<I2C_INT_ENA_SPEC, 13> {
    ...
    pub fn i2c_scl_main_st_to_int_ena(
        &mut self,
    ) -> I2C_SCL_MAIN_ST_TO_INT_ENA_W<I2C_INT_ENA_SPEC, 14> {
        I2C_SCL_MAIN_ST_TO_INT_ENA_W::new(self)
    }
    #[doc = "Bit 15 - The interrupt enable bit for I2C_DET_START_INT interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_det_start_int_ena(&mut self) -> I2C_DET_START_INT_ENA_W<I2C_INT_ENA_SPEC, 15> {
