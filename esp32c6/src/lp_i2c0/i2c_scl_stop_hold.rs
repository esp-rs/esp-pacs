...
pub struct R(crate::R<I2C_SCL_STOP_HOLD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2C_SCL_STOP_HOLD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2C_SCL_STOP_HOLD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2C_SCL_STOP_HOLD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2C_SCL_STOP_HOLD` writer"]
pub struct W(crate::W<I2C_SCL_STOP_HOLD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2C_SCL_STOP_HOLD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2C_SCL_STOP_HOLD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2C_SCL_STOP_HOLD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TIME_W<'a, const O: u8> = crate::FieldWriter<'a, I2C_SCL_STOP_HOLD_SPEC, 9, O, u16, u16>;
impl R {
