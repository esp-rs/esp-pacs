...
pub type I2C_COMMAND1_W<'a, const O: u8> = crate::FieldWriter<'a, I2C_COMD1_SPEC, 14, O, u16, u16>;
...
pub type I2C_COMMAND1_DONE_W<'a, const O: u8> = crate::BitWriter<'a, I2C_COMD1_SPEC, O>;
impl R {
