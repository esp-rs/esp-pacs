...
pub type I2C_COMMAND2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 14, O, u16>;
...
pub type I2C_COMMAND2_DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<I2C_COMD2_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_command2(&mut self) -> I2C_COMMAND2_W<I2C_COMD2_SPEC, 0> {
        I2C_COMMAND2_W::new(self)
    }
    #[doc = "Bit 31 - When command 2 is done in I2C Master mode, this bit changes to high Level."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_command2_done(&mut self) -> I2C_COMMAND2_DONE_W<I2C_COMD2_SPEC, 31> {
...
#[doc = "I2C command register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`i2c_comd2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`i2c_comd2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
