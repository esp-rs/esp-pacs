...
pub struct R(crate::R<I2C_SCL_ST_TIME_OUT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2C_SCL_ST_TIME_OUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2C_SCL_ST_TIME_OUT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2C_SCL_ST_TIME_OUT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2C_SCL_ST_TIME_OUT` writer"]
pub struct W(crate::W<I2C_SCL_ST_TIME_OUT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2C_SCL_ST_TIME_OUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2C_SCL_ST_TIME_OUT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2C_SCL_ST_TIME_OUT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type I2C_SCL_ST_TO_I2C_W<'a, const O: u8> =
    crate::FieldWriter<'a, I2C_SCL_ST_TIME_OUT_SPEC, 5, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C_SCL_ST_TIME_OUT")
            .field(
                "i2c_scl_st_to_i2c",
                &format_args!("{}", self.i2c_scl_st_to_i2c().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<I2C_SCL_ST_TIME_OUT_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_scl_st_to_i2c(&mut self) -> I2C_SCL_ST_TO_I2C_W<0> {
        I2C_SCL_ST_TO_I2C_W::new(self)
    }
...
#[doc = "SCL status time out register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2c_scl_st_time_out](index.html) module"]
