...
pub struct R(crate::R<I2C_COMD5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2C_COMD5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2C_COMD5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2C_COMD5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2C_COMD5` writer"]
pub struct W(crate::W<I2C_COMD5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2C_COMD5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2C_COMD5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2C_COMD5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type I2C_COMMAND5_R = crate::FieldReader<u16, u16>;
...
pub type I2C_COMMAND5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2C_COMD5_SPEC, u16, u16, 14, O>;
#[doc = "Field `I2C_COMMAND5_DONE` reader - When command 5 is done in I2C Master mode, this bit changes to high level."]
pub type I2C_COMMAND5_DONE_R = crate::BitReader<bool>;
#[doc = "Field `I2C_COMMAND5_DONE` writer - When command 5 is done in I2C Master mode, this bit changes to high level."]
pub type I2C_COMMAND5_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_COMD5_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_command5(&mut self) -> I2C_COMMAND5_W<0> {
        I2C_COMMAND5_W::new(self)
    }
    #[doc = "Bit 31 - When command 5 is done in I2C Master mode, this bit changes to high level."]
    #[inline(always)]
    #[must_use]
    pub fn i2c_command5_done(&mut self) -> I2C_COMMAND5_DONE_W<31> {
