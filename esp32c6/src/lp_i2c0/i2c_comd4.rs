...
pub type I2C_COMMAND4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2C_COMD4_SPEC, u16, u16, 14, O>;
#[doc = "Field `I2C_COMMAND4_DONE` reader - When command 4 is done in I2C Master mode, this bit changes to high level."]
pub type I2C_COMMAND4_DONE_R = crate::BitReader<bool>;
#[doc = "Field `I2C_COMMAND4_DONE` writer - When command 4 is done in I2C Master mode, this bit changes to high level."]
pub type I2C_COMMAND4_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_COMD4_SPEC, bool, O>;
impl R {
