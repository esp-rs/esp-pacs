...
pub type I2C_SDA_FORCE_OUT_R = crate::BitReader<bool>;
#[doc = "Field `I2C_SDA_FORCE_OUT` writer - 1: direct output, 0: open drain output."]
pub type I2C_SDA_FORCE_OUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
#[doc = "Field `I2C_SCL_FORCE_OUT` reader - 1: direct output, 0: open drain output."]
pub type I2C_SCL_FORCE_OUT_R = crate::BitReader<bool>;
#[doc = "Field `I2C_SCL_FORCE_OUT` writer - 1: direct output, 0: open drain output."]
pub type I2C_SCL_FORCE_OUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
...
pub type I2C_SAMPLE_SCL_LEVEL_R = crate::BitReader<bool>;
...
pub type I2C_SAMPLE_SCL_LEVEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
...
pub type I2C_RX_FULL_ACK_LEVEL_R = crate::BitReader<bool>;
...
pub type I2C_RX_FULL_ACK_LEVEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
#[doc = "Field `I2C_TRANS_START` writer - Set this bit to start sending the data in txfifo."]
pub type I2C_TRANS_START_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
...
pub type I2C_TX_LSB_FIRST_R = crate::BitReader<bool>;
...
pub type I2C_TX_LSB_FIRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
...
pub type I2C_RX_LSB_FIRST_R = crate::BitReader<bool>;
...
pub type I2C_RX_LSB_FIRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
#[doc = "Field `I2C_CLK_EN` reader - Reserved"]
pub type I2C_CLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `I2C_CLK_EN` writer - Reserved"]
pub type I2C_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
#[doc = "Field `I2C_ARBITRATION_EN` reader - This is the enable bit for arbitration_lost."]
pub type I2C_ARBITRATION_EN_R = crate::BitReader<bool>;
#[doc = "Field `I2C_ARBITRATION_EN` writer - This is the enable bit for arbitration_lost."]
pub type I2C_ARBITRATION_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
#[doc = "Field `I2C_FSM_RST` writer - This register is used to reset the scl FMS."]
pub type I2C_FSM_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
#[doc = "Field `I2C_CONF_UPGATE` writer - synchronization bit"]
pub type I2C_CONF_UPGATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_CTR_SPEC, bool, O>;
impl R {
