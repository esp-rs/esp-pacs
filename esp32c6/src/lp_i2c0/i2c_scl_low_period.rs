...
pub type I2C_SCL_LOW_PERIOD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 9, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c_scl_low_period(&mut self) -> I2C_SCL_LOW_PERIOD_W<I2C_SCL_LOW_PERIOD_SPEC, 0> {
