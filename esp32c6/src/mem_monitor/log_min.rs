///Register `LOG_MIN` reader
pub type R = crate::R<LOG_MIN_SPEC>;
///Register `LOG_MIN` writer
pub type W = crate::W<LOG_MIN_SPEC>;
///Field `LOG_MIN` reader - the min address of log range
pub type LOG_MIN_R = crate::FieldReader<u32>;
///Field `LOG_MIN` writer - the min address of log range
pub type LOG_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - the min address of log range
    #[inline(always)]
...
///`read()` method returns [`log_min::R`](R) reader structure
impl crate::Readable for LOG_MIN_SPEC {}
///`write(|w| ..)` method takes [`log_min::W`](W) writer structure
