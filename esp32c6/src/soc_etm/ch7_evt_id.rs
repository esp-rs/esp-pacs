...
pub struct R(crate::R<CH7_EVT_ID_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH7_EVT_ID_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH7_EVT_ID_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH7_EVT_ID_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH7_EVT_ID` writer"]
pub struct W(crate::W<CH7_EVT_ID_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH7_EVT_ID_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH7_EVT_ID_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH7_EVT_ID_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CH7_EVT_ID` reader - ch7_evt_id"]
pub type CH7_EVT_ID_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CH7_EVT_ID` writer - ch7_evt_id"]
pub type CH7_EVT_ID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH7_EVT_ID_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch7_evt_id(&mut self) -> CH7_EVT_ID_W<0> {
        CH7_EVT_ID_W::new(self)
    }
