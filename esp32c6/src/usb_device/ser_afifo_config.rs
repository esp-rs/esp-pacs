///Register `SER_AFIFO_CONFIG` reader
pub type R = crate::R<SER_AFIFO_CONFIG_SPEC>;
///Register `SER_AFIFO_CONFIG` writer
pub type W = crate::W<SER_AFIFO_CONFIG_SPEC>;
///Field `SERIAL_IN_AFIFO_RESET_WR` reader - Write 1 to reset CDC_ACM IN async FIFO write clock domain.
pub type SERIAL_IN_AFIFO_RESET_WR_R = crate::BitReader;
///Field `SERIAL_IN_AFIFO_RESET_WR` writer - Write 1 to reset CDC_ACM IN async FIFO write clock domain.
pub type SERIAL_IN_AFIFO_RESET_WR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SERIAL_IN_AFIFO_RESET_RD` reader - Write 1 to reset CDC_ACM IN async FIFO read clock domain.
pub type SERIAL_IN_AFIFO_RESET_RD_R = crate::BitReader;
///Field `SERIAL_IN_AFIFO_RESET_RD` writer - Write 1 to reset CDC_ACM IN async FIFO read clock domain.
pub type SERIAL_IN_AFIFO_RESET_RD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SERIAL_OUT_AFIFO_RESET_WR` reader - Write 1 to reset CDC_ACM OUT async FIFO write clock domain.
pub type SERIAL_OUT_AFIFO_RESET_WR_R = crate::BitReader;
///Field `SERIAL_OUT_AFIFO_RESET_WR` writer - Write 1 to reset CDC_ACM OUT async FIFO write clock domain.
pub type SERIAL_OUT_AFIFO_RESET_WR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SERIAL_OUT_AFIFO_RESET_RD` reader - Write 1 to reset CDC_ACM OUT async FIFO read clock domain.
pub type SERIAL_OUT_AFIFO_RESET_RD_R = crate::BitReader;
///Field `SERIAL_OUT_AFIFO_RESET_RD` writer - Write 1 to reset CDC_ACM OUT async FIFO read clock domain.
pub type SERIAL_OUT_AFIFO_RESET_RD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SERIAL_OUT_AFIFO_REMPTY` reader - CDC_ACM OUTOUT async FIFO empty signal in read clock domain.
pub type SERIAL_OUT_AFIFO_REMPTY_R = crate::BitReader;
///Field `SERIAL_IN_AFIFO_WFULL` reader - CDC_ACM OUT IN async FIFO empty signal in write clock domain.
pub type SERIAL_IN_AFIFO_WFULL_R = crate::BitReader;
impl R {
    ///Bit 0 - Write 1 to reset CDC_ACM IN async FIFO write clock domain.
    #[inline(always)]
    pub fn serial_in_afifo_reset_wr(&self) -> SERIAL_IN_AFIFO_RESET_WR_R {
        SERIAL_IN_AFIFO_RESET_WR_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Write 1 to reset CDC_ACM IN async FIFO read clock domain.
    #[inline(always)]
    pub fn serial_in_afifo_reset_rd(&self) -> SERIAL_IN_AFIFO_RESET_RD_R {
        SERIAL_IN_AFIFO_RESET_RD_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Write 1 to reset CDC_ACM OUT async FIFO write clock domain.
    #[inline(always)]
    pub fn serial_out_afifo_reset_wr(&self) -> SERIAL_OUT_AFIFO_RESET_WR_R {
        SERIAL_OUT_AFIFO_RESET_WR_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Write 1 to reset CDC_ACM OUT async FIFO read clock domain.
    #[inline(always)]
    pub fn serial_out_afifo_reset_rd(&self) -> SERIAL_OUT_AFIFO_RESET_RD_R {
        SERIAL_OUT_AFIFO_RESET_RD_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - CDC_ACM OUTOUT async FIFO empty signal in read clock domain.
    #[inline(always)]
    pub fn serial_out_afifo_rempty(&self) -> SERIAL_OUT_AFIFO_REMPTY_R {
        SERIAL_OUT_AFIFO_REMPTY_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - CDC_ACM OUT IN async FIFO empty signal in write clock domain.
    #[inline(always)]
...
///`read()` method returns [`ser_afifo_config::R`](R) reader structure
impl crate::Readable for SER_AFIFO_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`ser_afifo_config::W`](W) writer structure
