///Register `JFIFO_ST` reader
pub type R = crate::R<JFIFO_ST_SPEC>;
///Register `JFIFO_ST` writer
pub type W = crate::W<JFIFO_ST_SPEC>;
///Field `IN_FIFO_CNT` reader - JTAT in fifo counter.
pub type IN_FIFO_CNT_R = crate::FieldReader;
///Field `IN_FIFO_EMPTY` reader - 1: JTAG in fifo is empty.
pub type IN_FIFO_EMPTY_R = crate::BitReader;
///Field `IN_FIFO_FULL` reader - 1: JTAG in fifo is full.
pub type IN_FIFO_FULL_R = crate::BitReader;
///Field `OUT_FIFO_CNT` reader - JTAT out fifo counter.
pub type OUT_FIFO_CNT_R = crate::FieldReader;
///Field `OUT_FIFO_EMPTY` reader - 1: JTAG out fifo is empty.
pub type OUT_FIFO_EMPTY_R = crate::BitReader;
///Field `OUT_FIFO_FULL` reader - 1: JTAG out fifo is full.
pub type OUT_FIFO_FULL_R = crate::BitReader;
///Field `IN_FIFO_RESET` reader - Write 1 to reset JTAG in fifo.
pub type IN_FIFO_RESET_R = crate::BitReader;
///Field `IN_FIFO_RESET` writer - Write 1 to reset JTAG in fifo.
pub type IN_FIFO_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUT_FIFO_RESET` reader - Write 1 to reset JTAG out fifo.
pub type OUT_FIFO_RESET_R = crate::BitReader;
///Field `OUT_FIFO_RESET` writer - Write 1 to reset JTAG out fifo.
...
///`read()` method returns [`jfifo_st::R`](R) reader structure
impl crate::Readable for JFIFO_ST_SPEC {}
///`write(|w| ..)` method takes [`jfifo_st::W`](W) writer structure
