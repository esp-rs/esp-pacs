...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb_serial_jtag_in_fifo_reset(&mut self) -> USB_SERIAL_JTAG_IN_FIFO_RESET_W<8> {
        USB_SERIAL_JTAG_IN_FIFO_RESET_W::new(self)
    }
    #[doc = "Bit 9 - Write 1 to reset JTAG out fifo."]
    #[inline(always)]
    #[must_use]
    pub fn usb_serial_jtag_out_fifo_reset(&mut self) -> USB_SERIAL_JTAG_OUT_FIFO_RESET_W<9> {
        USB_SERIAL_JTAG_OUT_FIFO_RESET_W::new(self)
    }
