...
impl W {
    ...
    ///Bit 12 - Set this bit to clear the USB_DEVICE_RTS_CHG_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn rts_chg(&mut self) -> RTS_CHG_W<INT_CLR_SPEC> {
        RTS_CHG_W::new(self, 12)
    }
    ///Bit 13 - Set this bit to clear the USB_DEVICE_DTR_CHG_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn dtr_chg(&mut self) -> DTR_CHG_W<INT_CLR_SPEC> {
        DTR_CHG_W::new(self, 13)
    }
    ///Bit 14 - Set this bit to clear the USB_DEVICE_GET_LINE_CODE_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn get_line_code(&mut self) -> GET_LINE_CODE_W<INT_CLR_SPEC> {
        GET_LINE_CODE_W::new(self, 14)
    }
    ///Bit 15 - Set this bit to clear the USB_DEVICE_SET_LINE_CODE_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn set_line_code(&mut self) -> SET_LINE_CODE_W<INT_CLR_SPEC> {
