...
#[doc = "Field `RTS_CHG_INT_ST` reader - The raw interrupt status bit for the USB_DEVICE_RTS_CHG_INT interrupt."]
pub type RTS_CHG_INT_ST_R = crate::BitReader<bool>;
#[doc = "Field `DTR_CHG_INT_ST` reader - The raw interrupt status bit for the USB_DEVICE_DTR_CHG_INT interrupt."]
pub type DTR_CHG_INT_ST_R = crate::BitReader<bool>;
#[doc = "Field `GET_LINE_CODE_INT_ST` reader - The raw interrupt status bit for the USB_DEVICE_GET_LINE_CODE_INT interrupt."]
pub type GET_LINE_CODE_INT_ST_R = crate::BitReader<bool>;
#[doc = "Field `SET_LINE_CODE_INT_ST` reader - The raw interrupt status bit for the USB_DEVICE_SET_LINE_CODE_INT interrupt."]
pub type SET_LINE_CODE_INT_ST_R = crate::BitReader<bool>;
impl R {
