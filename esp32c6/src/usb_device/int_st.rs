...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            ...
            .field(
                "rts_chg_int_st",
                &format_args!("{}", self.rts_chg_int_st().bit()),
            )
            .field(
                "dtr_chg_int_st",
                &format_args!("{}", self.dtr_chg_int_st().bit()),
            )
            .field(
                "get_line_code_int_st",
                &format_args!("{}", self.get_line_code_int_st().bit()),
            )
            .field(
                "set_line_code_int_st",
                &format_args!("{}", self.set_line_code_int_st().bit()),
            )
            .finish()
    }
}
