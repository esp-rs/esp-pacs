...
pub type RMT_DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `RMT_DATE` writer - This is the version register."]
pub type RMT_DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATE_SPEC, u32, u32, 28, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rmt_date(&mut self) -> RMT_DATE_W<0> {
        RMT_DATE_W::new(self)
    }
...
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0210_8213;
}
