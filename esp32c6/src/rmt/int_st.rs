...
///Field `CH_TX_END(0-1)` reader - The masked interrupt status bit for CH%s_TX_END_INT.
pub type CH_TX_END_R = crate::BitReader;
///Field `CH_RX_END(2-3)` reader - The masked interrupt status bit for CH2_RX_END_INT.
pub type CH_RX_END_R = crate::BitReader;
///Field `CH_TX_ERR(0-1)` reader - The masked interrupt status bit for CH4_ERR_INT.
pub type CH_TX_ERR_R = crate::BitReader;
///Field `CH_RX_ERR(2-3)` reader - The masked interrupt status bit for CH6_ERR_INT.
pub type CH_RX_ERR_R = crate::BitReader;
///Field `CH_TX_THR_EVENT(0-1)` reader - The masked interrupt status bit for CH%s_TX_THR_EVENT_INT.
pub type CH_TX_THR_EVENT_R = crate::BitReader;
///Field `CH_RX_THR_EVENT(2-3)` reader - The masked interrupt status bit for CH2_RX_THR_EVENT_INT.
pub type CH_RX_THR_EVENT_R = crate::BitReader;
///Field `CH_X_LOOP(0-1)` reader - The masked interrupt status bit for CH%s_TX_LOOP_INT.
