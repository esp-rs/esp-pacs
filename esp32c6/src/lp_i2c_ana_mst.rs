...
/**I2C0_CTRL (rw) register accessor: need_des
...
///need_des
pub mod i2c0_ctrl;
/**I2C0_CONF (rw) register accessor: need_des
...
///need_des
pub mod i2c0_conf;
/**I2C0_DATA (rw) register accessor: need_des
...
///need_des
pub mod i2c0_data;
/**ANA_CONF1 (rw) register accessor: need_des
...
///need_des
pub mod ana_conf1;
/**NOUSE (rw) register accessor: need_des
...
///need_des
pub mod nouse;
/**DEVICE_EN (rw) register accessor: need_des
