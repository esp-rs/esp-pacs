///Register `INTR_ENA` reader
pub type R = crate::R<INTR_ENA_SPEC>;
///Register `INTR_ENA` writer
pub type W = crate::W<INTR_ENA_SPEC>;
///Field `FIFO_OVERFLOW_INTR_ENA` reader - Set 1 enable fifo_overflow interrupt
pub type FIFO_OVERFLOW_INTR_ENA_R = crate::BitReader;
///Field `FIFO_OVERFLOW_INTR_ENA` writer - Set 1 enable fifo_overflow interrupt
pub type FIFO_OVERFLOW_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_FULL_INTR_ENA` reader - Set 1 enable mem_full interrupt
pub type MEM_FULL_INTR_ENA_R = crate::BitReader;
///Field `MEM_FULL_INTR_ENA` writer - Set 1 enable mem_full interrupt
...
///`read()` method returns [`intr_ena::R`](R) reader structure
impl crate::Readable for INTR_ENA_SPEC {}
///`write(|w| ..)` method takes [`intr_ena::W`](W) writer structure
