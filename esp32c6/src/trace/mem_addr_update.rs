...
///Field `MEM_CURRENT_ADDR_UPDATE` writer - when set this reg, the current_mem_addr will update to start_addr
...
impl W {
    ///Bit 0 - when set this reg, the current_mem_addr will update to start_addr
    #[inline(always)]
    #[must_use]
