...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MODEM_RST_CONF")
            .field("rst_wifibb", &self.rst_wifibb().bit())
            .field("rst_wifimac", &self.rst_wifimac().bit())
            .field("rst_fe", &self.rst_fe().bit())
            .field("rst_btmac_apb", &self.rst_btmac_apb().bit())
            .field("rst_btmac", &self.rst_btmac().bit())
            .field("rst_btbb_apb", &self.rst_btbb_apb().bit())
            .field("rst_btbb", &self.rst_btbb().bit())
            .field("rst_etm", &self.rst_etm().bit())
            .field("rst_zbmac", &self.rst_zbmac().bit())
            .field("rst_modem_ecb", &self.rst_modem_ecb().bit())
            .field("rst_modem_ccm", &self.rst_modem_ccm().bit())
            .field("rst_modem_bah", &self.rst_modem_bah().bit())
            .field("rst_modem_sec", &self.rst_modem_sec().bit())
            .field("rst_ble_timer", &self.rst_ble_timer().bit())
            .field("rst_data_dump", &self.rst_data_dump().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
