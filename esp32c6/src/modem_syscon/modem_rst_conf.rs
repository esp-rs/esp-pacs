...
///`read()` method returns [`modem_rst_conf::R`](R) reader structure
impl crate::Readable for MODEM_RST_CONF_SPEC {}
///`write(|w| ..)` method takes [`modem_rst_conf::W`](W) writer structure
