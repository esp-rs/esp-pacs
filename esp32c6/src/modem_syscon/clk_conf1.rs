...
impl W {
    ...
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn clk_fe_cal_160m_en(&mut self) -> CLK_FE_CAL_160M_EN_W<'_, CLK_CONF1_SPEC> {
    ...
    #[doc = "Bit 19"]
    #[inline(always)]
    pub fn clk_wifibb_480m_en(&mut self) -> CLK_WIFIBB_480M_EN_W<'_, CLK_CONF1_SPEC> {
        CLK_WIFIBB_480M_EN_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn clk_fe_480m_en(&mut self) -> CLK_FE_480M_EN_W<'_, CLK_CONF1_SPEC> {
        CLK_FE_480M_EN_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn clk_fe_anamode_40m_en(&mut self) -> CLK_FE_ANAMODE_40M_EN_W<'_, CLK_CONF1_SPEC> {
        CLK_FE_ANAMODE_40M_EN_W::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    pub fn clk_fe_anamode_80m_en(&mut self) -> CLK_FE_ANAMODE_80M_EN_W<'_, CLK_CONF1_SPEC> {
        CLK_FE_ANAMODE_80M_EN_W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    pub fn clk_fe_anamode_160m_en(&mut self) -> CLK_FE_ANAMODE_160M_EN_W<'_, CLK_CONF1_SPEC> {
