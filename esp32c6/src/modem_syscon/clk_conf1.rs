...
pub type CLK_WIFIBB_480M_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CLK_FE_480M_EN` reader - "]
pub type CLK_FE_480M_EN_R = crate::BitReader;
#[doc = "Field `CLK_FE_480M_EN` writer - "]
pub type CLK_FE_480M_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CLK_FE_ANAMODE_40M_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CLK_FE_ANAMODE_80M_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CLK_FE_ANAMODE_160M_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_22m_en(&mut self) -> CLK_WIFIBB_22M_EN_W<CLK_CONF1_SPEC, 0> {
        CLK_WIFIBB_22M_EN_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_40m_en(&mut self) -> CLK_WIFIBB_40M_EN_W<CLK_CONF1_SPEC, 1> {
        CLK_WIFIBB_40M_EN_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_44m_en(&mut self) -> CLK_WIFIBB_44M_EN_W<CLK_CONF1_SPEC, 2> {
        CLK_WIFIBB_44M_EN_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_80m_en(&mut self) -> CLK_WIFIBB_80M_EN_W<CLK_CONF1_SPEC, 3> {
        CLK_WIFIBB_80M_EN_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_40x_en(&mut self) -> CLK_WIFIBB_40X_EN_W<CLK_CONF1_SPEC, 4> {
        CLK_WIFIBB_40X_EN_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_80x_en(&mut self) -> CLK_WIFIBB_80X_EN_W<CLK_CONF1_SPEC, 5> {
        CLK_WIFIBB_80X_EN_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_40x1_en(&mut self) -> CLK_WIFIBB_40X1_EN_W<CLK_CONF1_SPEC, 6> {
        CLK_WIFIBB_40X1_EN_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_80x1_en(&mut self) -> CLK_WIFIBB_80X1_EN_W<CLK_CONF1_SPEC, 7> {
        CLK_WIFIBB_80X1_EN_W::new(self)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_160x1_en(&mut self) -> CLK_WIFIBB_160X1_EN_W<CLK_CONF1_SPEC, 8> {
        CLK_WIFIBB_160X1_EN_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifimac_en(&mut self) -> CLK_WIFIMAC_EN_W<CLK_CONF1_SPEC, 9> {
        CLK_WIFIMAC_EN_W::new(self)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn clk_wifi_apb_en(&mut self) -> CLK_WIFI_APB_EN_W<CLK_CONF1_SPEC, 10> {
        CLK_WIFI_APB_EN_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn clk_fe_20m_en(&mut self) -> CLK_FE_20M_EN_W<CLK_CONF1_SPEC, 11> {
        CLK_FE_20M_EN_W::new(self)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn clk_fe_40m_en(&mut self) -> CLK_FE_40M_EN_W<CLK_CONF1_SPEC, 12> {
        CLK_FE_40M_EN_W::new(self)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn clk_fe_80m_en(&mut self) -> CLK_FE_80M_EN_W<CLK_CONF1_SPEC, 13> {
        CLK_FE_80M_EN_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn clk_fe_160m_en(&mut self) -> CLK_FE_160M_EN_W<CLK_CONF1_SPEC, 14> {
        CLK_FE_160M_EN_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn clk_fe_cal_160m_en(&mut self) -> CLK_FE_CAL_160M_EN_W<CLK_CONF1_SPEC, 15> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk_wifibb_480m_en(&mut self) -> CLK_WIFIBB_480M_EN_W<CLK_CONF1_SPEC, 19> {
        CLK_WIFIBB_480M_EN_W::new(self)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn clk_fe_480m_en(&mut self) -> CLK_FE_480M_EN_W<CLK_CONF1_SPEC, 20> {
        CLK_FE_480M_EN_W::new(self)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn clk_fe_anamode_40m_en(&mut self) -> CLK_FE_ANAMODE_40M_EN_W<CLK_CONF1_SPEC, 21> {
        CLK_FE_ANAMODE_40M_EN_W::new(self)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn clk_fe_anamode_80m_en(&mut self) -> CLK_FE_ANAMODE_80M_EN_W<CLK_CONF1_SPEC, 22> {
        CLK_FE_ANAMODE_80M_EN_W::new(self)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn clk_fe_anamode_160m_en(&mut self) -> CLK_FE_ANAMODE_160M_EN_W<CLK_CONF1_SPEC, 23> {
