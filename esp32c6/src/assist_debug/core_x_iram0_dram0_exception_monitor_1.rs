///Register `CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_1` reader
pub type R = crate::R<CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_1_SPEC>;
///Register `CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_1` writer
...
///Field `CORE_X_IRAM0_DRAM0_LIMIT_CYCLE_1` writer - reg_core_x_iram0_dram0_limit_cycle_1
pub type CORE_X_IRAM0_DRAM0_LIMIT_CYCLE_1_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19 - reg_core_x_iram0_dram0_limit_cycle_1
    #[inline(always)]
...
///`read()` method returns [`core_x_iram0_dram0_exception_monitor_1::R`](R) reader structure
impl crate::Readable for CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_1_SPEC {}
///`write(|w| ..)` method takes [`core_x_iram0_dram0_exception_monitor_1::W`](W) writer structure
