///Register `CORE_0_AREA_PIF_1_MIN` reader
pub type R = crate::R<CORE_0_AREA_PIF_1_MIN_SPEC>;
///Register `CORE_0_AREA_PIF_1_MIN` writer
pub type W = crate::W<CORE_0_AREA_PIF_1_MIN_SPEC>;
///Field `CORE_0_AREA_PIF_1_MIN` reader - Core0 PIF region1 start addr
pub type CORE_0_AREA_PIF_1_MIN_R = crate::FieldReader<u32>;
///Field `CORE_0_AREA_PIF_1_MIN` writer - Core0 PIF region1 start addr
pub type CORE_0_AREA_PIF_1_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Core0 PIF region1 start addr
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_AREA_PIF_1_MIN")
            .field("core_0_area_pif_1_min", &self.core_0_area_pif_1_min())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`core_0_area_pif_1_min::R`](R) reader structure
impl crate::Readable for CORE_0_AREA_PIF_1_MIN_SPEC {}
///`write(|w| ..)` method takes [`core_0_area_pif_1_min::W`](W) writer structure
