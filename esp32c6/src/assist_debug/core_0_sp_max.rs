///Register `CORE_0_SP_MAX` reader
pub type R = crate::R<CORE_0_SP_MAX_SPEC>;
///Register `CORE_0_SP_MAX` writer
pub type W = crate::W<CORE_0_SP_MAX_SPEC>;
///Field `CORE_0_SP_MAX` reader - core0 sp pc status register
pub type CORE_0_SP_MAX_R = crate::FieldReader<u32>;
///Field `CORE_0_SP_MAX` writer - core0 sp pc status register
pub type CORE_0_SP_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - core0 sp pc status register
    #[inline(always)]
...
///`read()` method returns [`core_0_sp_max::R`](R) reader structure
impl crate::Readable for CORE_0_SP_MAX_SPEC {}
///`write(|w| ..)` method takes [`core_0_sp_max::W`](W) writer structure
