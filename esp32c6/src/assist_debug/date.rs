...
pub type ASSIST_DEBUG_DATE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 28, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn assist_debug_date(&mut self) -> ASSIST_DEBUG_DATE_W<DATE_SPEC, 0> {
...
#[doc = "`reset()` method sets DATE to value 0x0210_9130"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0210_9130;
}
