...
pub type BOD_MODE1_RESET_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bod_mode1_reset_ena(&mut self) -> BOD_MODE1_RESET_ENA_W<BOD_MODE1_CNTL_SPEC, 31> {
