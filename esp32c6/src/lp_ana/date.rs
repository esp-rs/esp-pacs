...
#[doc = "Field `LP_ANA_DATE` reader - need_des"]
pub type LP_ANA_DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LP_ANA_DATE` writer - need_des"]
pub type LP_ANA_DATE_W<'a, const O: u8> = crate::FieldWriter<'a, DATE_SPEC, 31, O, u32, u32>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DATE")
            .field(
                "lp_ana_date",
                &format_args!("{}", self.lp_ana_date().bits()),
            )
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_ana_date(&mut self) -> LP_ANA_DATE_W<0> {
        LP_ANA_DATE_W::new(self)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets DATE to value 0x0220_2260"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_2260;
}
