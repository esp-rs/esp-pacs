...
/**CFG_DATA0 (rw) register accessor: Configure sdio cis content
...
pub mod cfg_data0;
/**CFG_DATA1 (rw) register accessor: SDIO configuration register
...
pub mod cfg_data1;
/**CFG_TIMING (rw) register accessor: Timing configuration registers
...
pub mod cfg_timing;
/**CFG_UPDATE (w) register accessor: update sdio configurations
...
pub mod cfg_update;
/**CFG_DATA7 (rw) register accessor: SDIO configuration register
...
///SDIO configuration register
pub mod cfg_data7;
/**CIS_CONF_W0 (rw) register accessor: SDIO cis configuration register
...
pub mod cis_conf_w0;
/**CIS_CONF_W1 (rw) register accessor: SDIO cis configuration register
...
///SDIO cis configuration register
pub mod cis_conf_w1;
/**CIS_CONF_W2 (rw) register accessor: SDIO cis configuration register
...
///SDIO cis configuration register
pub mod cis_conf_w2;
/**CIS_CONF_W3 (rw) register accessor: SDIO cis configuration register
...
///SDIO cis configuration register
pub mod cis_conf_w3;
/**CIS_CONF_W4 (rw) register accessor: SDIO cis configuration register
...
///SDIO cis configuration register
pub mod cis_conf_w4;
/**CIS_CONF_W5 (rw) register accessor: SDIO cis configuration register
...
///SDIO cis configuration register
pub mod cis_conf_w5;
/**CIS_CONF_W6 (rw) register accessor: SDIO cis configuration register
...
///SDIO cis configuration register
pub mod cis_conf_w6;
/**CIS_CONF_W7 (rw) register accessor: SDIO cis configuration register
...
///SDIO cis configuration register
pub mod cis_conf_w7;
/**CFG_DATA16 (rw) register accessor: SDIO cis configuration register
...
///SDIO cis configuration register
pub mod cfg_data16;
/**CFG_UHS1_INT_MODE (rw) register accessor: configure int to start and end ahead of time in uhs1 mode
...
/**CONF_STATUS (r) register accessor: func0 config0 status
...
pub mod conf_status;
/**SDIO_SLAVE_ECO_LOW (rw) register accessor: sdio_slave redundant control registers
...
/**SDIO_SLAVE_ECO_HIGH (rw) register accessor: sdio_slave redundant control registers
...
/**SDIO_SLAVE_ECO_CONF (rw) register accessor: sdio_slave redundant control registers
...
/**SDIO_SLAVE_LDO_CONF (rw) register accessor: sdio slave ldo control register
...
/**SDIO_DATE (rw) register accessor: ******* Description ***********
