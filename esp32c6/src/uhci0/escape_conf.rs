...
///Field `TX_C0_ESC_EN` reader - Set this bit to enable resolve char 0xC0 when DMA receiving data.
pub type TX_C0_ESC_EN_R = crate::BitReader;
///Field `TX_C0_ESC_EN` writer - Set this bit to enable resolve char 0xC0 when DMA receiving data.
pub type TX_C0_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_DB_ESC_EN` reader - Set this bit to enable resolve char 0xDB when DMA receiving data.
pub type TX_DB_ESC_EN_R = crate::BitReader;
///Field `TX_DB_ESC_EN` writer - Set this bit to enable resolve char 0xDB when DMA receiving data.
pub type TX_DB_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_11_ESC_EN` reader - Set this bit to enable resolve flow control char 0x11 when DMA receiving data.
pub type TX_11_ESC_EN_R = crate::BitReader;
///Field `TX_11_ESC_EN` writer - Set this bit to enable resolve flow control char 0x11 when DMA receiving data.
pub type TX_11_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_13_ESC_EN` reader - Set this bit to enable resolve flow control char 0x13 when DMA receiving data.
pub type TX_13_ESC_EN_R = crate::BitReader;
///Field `TX_13_ESC_EN` writer - Set this bit to enable resolve flow control char 0x13 when DMA receiving data.
pub type TX_13_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_C0_ESC_EN` reader - Set this bit to enable replacing 0xC0 with special char when DMA receiving data.
pub type RX_C0_ESC_EN_R = crate::BitReader;
///Field `RX_C0_ESC_EN` writer - Set this bit to enable replacing 0xC0 with special char when DMA receiving data.
pub type RX_C0_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_DB_ESC_EN` reader - Set this bit to enable replacing 0xDB with special char when DMA receiving data.
pub type RX_DB_ESC_EN_R = crate::BitReader;
///Field `RX_DB_ESC_EN` writer - Set this bit to enable replacing 0xDB with special char when DMA receiving data.
pub type RX_DB_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_11_ESC_EN` reader - Set this bit to enable replacing 0x11 with special char when DMA receiving data.
pub type RX_11_ESC_EN_R = crate::BitReader;
///Field `RX_11_ESC_EN` writer - Set this bit to enable replacing 0x11 with special char when DMA receiving data.
pub type RX_11_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_13_ESC_EN` reader - Set this bit to enable replacing 0x13 with special char when DMA receiving data.
pub type RX_13_ESC_EN_R = crate::BitReader;
///Field `RX_13_ESC_EN` writer - Set this bit to enable replacing 0x13 with special char when DMA receiving data.
pub type RX_13_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit to enable resolve char 0xC0 when DMA receiving data.
    #[inline(always)]
    pub fn tx_c0_esc_en(&self) -> TX_C0_ESC_EN_R {
        TX_C0_ESC_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set this bit to enable resolve char 0xDB when DMA receiving data.
    #[inline(always)]
    pub fn tx_db_esc_en(&self) -> TX_DB_ESC_EN_R {
        TX_DB_ESC_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Set this bit to enable resolve flow control char 0x11 when DMA receiving data.
    #[inline(always)]
    pub fn tx_11_esc_en(&self) -> TX_11_ESC_EN_R {
        TX_11_ESC_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 3 - Set this bit to enable resolve flow control char 0x13 when DMA receiving data.
    #[inline(always)]
    pub fn tx_13_esc_en(&self) -> TX_13_ESC_EN_R {
        TX_13_ESC_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
    ///Bit 4 - Set this bit to enable replacing 0xC0 with special char when DMA receiving data.
    #[inline(always)]
    pub fn rx_c0_esc_en(&self) -> RX_C0_ESC_EN_R {
        RX_C0_ESC_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    ///Bit 5 - Set this bit to enable replacing 0xDB with special char when DMA receiving data.
    #[inline(always)]
    pub fn rx_db_esc_en(&self) -> RX_DB_ESC_EN_R {
        RX_DB_ESC_EN_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 6 - Set this bit to enable replacing 0x11 with special char when DMA receiving data.
    #[inline(always)]
    pub fn rx_11_esc_en(&self) -> RX_11_ESC_EN_R {
        RX_11_ESC_EN_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 7 - Set this bit to enable replacing 0x13 with special char when DMA receiving data.
    #[inline(always)]
