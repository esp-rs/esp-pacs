...
#[doc = "Field `SEND_Q0_WORD1` reader - Serves as quick sending register in specified mode in UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM."]
pub type SEND_Q0_WORD1_R = crate::FieldReader<u32>;
#[doc = "Field `SEND_Q0_WORD1` writer - Serves as quick sending register in specified mode in UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM."]
