...
///Field `ACK_NUM` reader - Indicates the ACK number during software flow control.
pub type ACK_NUM_R = crate::FieldReader;
///Field `ACK_NUM` writer - Indicates the ACK number during software flow control.
pub type ACK_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `LOAD` writer - Set this bit to load the ACK value of UHCI_ACK_NUM.
pub type LOAD_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:2 - Indicates the ACK number during software flow control.
    #[inline(always)]
...
impl W {
    ...
    ///Bit 3 - Set this bit to load the ACK value of UHCI_ACK_NUM.
    #[inline(always)]
    #[must_use]
