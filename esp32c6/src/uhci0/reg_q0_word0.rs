...
#[doc = "Field `SEND_Q0_WORD0` reader - Serves as quick sending register in specified mode in UHCI_ALWAYS_SEND_NUM or UHCI_SINGLE_SEND_NUM."]
...
pub type SEND_Q0_WORD0_W<'a, const O: u8> = crate::FieldWriter<'a, REG_Q0_WORD0_SPEC, 32, O, u32>;
impl R {
