...
#[doc = "Field `SINGLE_SEND_NUM` reader - Configures single_send mode."]
pub type SINGLE_SEND_NUM_R = crate::FieldReader;
#[doc = "Field `SINGLE_SEND_NUM` writer - Configures single_send mode."]
pub type SINGLE_SEND_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, QUICK_SENT_SPEC, 3, O>;
#[doc = "Field `SINGLE_SEND_EN` writer - Set this bit to enable sending short packet with single_send mode."]
pub type SINGLE_SEND_EN_W<'a, const O: u8> = crate::BitWriter<'a, QUICK_SENT_SPEC, O>;
#[doc = "Field `ALWAYS_SEND_NUM` reader - Configures always_send mode."]
pub type ALWAYS_SEND_NUM_R = crate::FieldReader;
#[doc = "Field `ALWAYS_SEND_NUM` writer - Configures always_send mode."]
pub type ALWAYS_SEND_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, QUICK_SENT_SPEC, 3, O>;
#[doc = "Field `ALWAYS_SEND_EN` reader - Set this bit to enable sending short packet with always_send mode."]
pub type ALWAYS_SEND_EN_R = crate::BitReader;
#[doc = "Field `ALWAYS_SEND_EN` writer - Set this bit to enable sending short packet with always_send mode."]
pub type ALWAYS_SEND_EN_W<'a, const O: u8> = crate::BitWriter<'a, QUICK_SENT_SPEC, O>;
impl R {
    #[doc = "Bits 0:2 - Configures single_send mode."]
    #[inline(always)]
    pub fn single_send_num(&self) -> SINGLE_SEND_NUM_R {
        SINGLE_SEND_NUM_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 4:6 - Configures always_send mode."]
    #[inline(always)]
    pub fn always_send_num(&self) -> ALWAYS_SEND_NUM_R {
        ALWAYS_SEND_NUM_R::new(((self.bits >> 4) & 7) as u8)
    }
    #[doc = "Bit 7 - Set this bit to enable sending short packet with always_send mode."]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 3 - Set this bit to enable sending short packet with single_send mode."]
    #[inline(always)]
    #[must_use]
