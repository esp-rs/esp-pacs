...
#[doc = "Field `DATE` reader - HP-SYSTEM date information/ HP-SYSTEM version information."]
pub type DATE_R = crate::FieldReader<u32>;
#[doc = "Field `DATE` writer - HP-SYSTEM date information/ HP-SYSTEM version information."]
pub type DATE_W<'a, const O: u8> = crate::FieldWriter<'a, DATE_SPEC, 28, O, u32>;
impl R {
    #[doc = "Bits 0:27 - HP-SYSTEM date information/ HP-SYSTEM version information."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x0220_6110"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0220_6110;
}
