...
///Field `DATE` reader - HP-SYSTEM date information/ HP-SYSTEM version information.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - HP-SYSTEM date information/ HP-SYSTEM version information.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - HP-SYSTEM date information/ HP-SYSTEM version information.
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x0220_6110
