...
///Field `ENABLE_SPI_MANUAL_ENCRYPT` reader - Set this bit as 1 to enable mspi xts manual encrypt in spi boot mode.
pub type ENABLE_SPI_MANUAL_ENCRYPT_R = crate::BitReader;
///Field `ENABLE_SPI_MANUAL_ENCRYPT` writer - Set this bit as 1 to enable mspi xts manual encrypt in spi boot mode.
pub type ENABLE_SPI_MANUAL_ENCRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENABLE_DOWNLOAD_DB_ENCRYPT` reader - reserved
pub type ENABLE_DOWNLOAD_DB_ENCRYPT_R = crate::BitReader;
///Field `ENABLE_DOWNLOAD_DB_ENCRYPT` writer - reserved
pub type ENABLE_DOWNLOAD_DB_ENCRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENABLE_DOWNLOAD_G0CB_DECRYPT` reader - Set this bit as 1 to enable mspi xts auto decrypt in download boot mode.
pub type ENABLE_DOWNLOAD_G0CB_DECRYPT_R = crate::BitReader;
///Field `ENABLE_DOWNLOAD_G0CB_DECRYPT` writer - Set this bit as 1 to enable mspi xts auto decrypt in download boot mode.
pub type ENABLE_DOWNLOAD_G0CB_DECRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ENABLE_DOWNLOAD_MANUAL_ENCRYPT` reader - Set this bit as 1 to enable mspi xts manual encrypt in download boot mode.
pub type ENABLE_DOWNLOAD_MANUAL_ENCRYPT_R = crate::BitReader;
///Field `ENABLE_DOWNLOAD_MANUAL_ENCRYPT` writer - Set this bit as 1 to enable mspi xts manual encrypt in download boot mode.
