...
pub type HP_PERI_TIMEOUT_THRES_R = crate::FieldReader<u16, u16>;
...
pub type HP_PERI_TIMEOUT_THRES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HP_PERI_TIMEOUT_CONF_SPEC, u16, u16, 16, O>;
...
pub type HP_PERI_TIMEOUT_INT_CLEAR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HP_PERI_TIMEOUT_CONF_SPEC, bool, O>;
...
pub type HP_PERI_TIMEOUT_PROTECT_EN_R = crate::BitReader<bool>;
