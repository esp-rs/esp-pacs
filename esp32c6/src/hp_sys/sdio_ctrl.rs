...
pub type DIS_SDIO_PROB_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dis_sdio_prob(&mut self) -> DIS_SDIO_PROB_W<SDIO_CTRL_SPEC, 0> {
        DIS_SDIO_PROB_W::new(self)
    }
    #[doc = "Bit 1 - Enable sdio slave to access other peripherals on the chip"]
    #[inline(always)]
    #[must_use]
    pub fn sdio_win_access_en(&mut self) -> SDIO_WIN_ACCESS_EN_W<SDIO_CTRL_SPEC, 1> {
