///Register `SDIO_CTRL` reader
pub type R = crate::R<SDIO_CTRL_SPEC>;
///Register `SDIO_CTRL` writer
pub type W = crate::W<SDIO_CTRL_SPEC>;
///Field `DIS_SDIO_PROB` reader - Set this bit as 1 to disable SDIO_PROB function. disable by default.
pub type DIS_SDIO_PROB_R = crate::BitReader;
///Field `DIS_SDIO_PROB` writer - Set this bit as 1 to disable SDIO_PROB function. disable by default.
pub type DIS_SDIO_PROB_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDIO_WIN_ACCESS_EN` reader - Enable sdio slave to access other peripherals on the chip
pub type SDIO_WIN_ACCESS_EN_R = crate::BitReader;
///Field `SDIO_WIN_ACCESS_EN` writer - Enable sdio slave to access other peripherals on the chip
pub type SDIO_WIN_ACCESS_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set this bit as 1 to disable SDIO_PROB function. disable by default.
    #[inline(always)]
    pub fn dis_sdio_prob(&self) -> DIS_SDIO_PROB_R {
        DIS_SDIO_PROB_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Enable sdio slave to access other peripherals on the chip
    #[inline(always)]
...
///`read()` method returns [`sdio_ctrl::R`](R) reader structure
impl crate::Readable for SDIO_CTRL_SPEC {}
///`write(|w| ..)` method takes [`sdio_ctrl::W`](W) writer structure
impl crate::Writable for SDIO_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDIO_CTRL to value 0x03
