///Register `SRAM_USAGE_CONF` reader
pub type R = crate::R<SRAM_USAGE_CONF_SPEC>;
///Register `SRAM_USAGE_CONF` writer
pub type W = crate::W<SRAM_USAGE_CONF_SPEC>;
///Field `CACHE_USAGE` reader - reserved
pub type CACHE_USAGE_R = crate::BitReader;
///Field `SRAM_USAGE` reader - 0: cpu use hp-memory. 1:mac-dump accessing hp-memory.
pub type SRAM_USAGE_R = crate::FieldReader;
///Field `SRAM_USAGE` writer - 0: cpu use hp-memory. 1:mac-dump accessing hp-memory.
pub type SRAM_USAGE_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `MAC_DUMP_ALLOC` reader - Set this bit as 1 to add an offset (64KB) when mac-dump accessing hp-memory.
pub type MAC_DUMP_ALLOC_R = crate::BitReader;
///Field `MAC_DUMP_ALLOC` writer - Set this bit as 1 to add an offset (64KB) when mac-dump accessing hp-memory.
...
///`read()` method returns [`sram_usage_conf::R`](R) reader structure
impl crate::Readable for SRAM_USAGE_CONF_SPEC {}
///`write(|w| ..)` method takes [`sram_usage_conf::W`](W) writer structure
