...
pub type SRAM_USAGE_W<'a, const O: u8> = crate::FieldWriter<'a, SRAM_USAGE_CONF_SPEC, 4, O>;
...
pub type MAC_DUMP_ALLOC_W<'a, const O: u8> = crate::BitWriter<'a, SRAM_USAGE_CONF_SPEC, O>;
impl R {
    #[doc = "Bit 0 - reserved"]
    #[inline(always)]
