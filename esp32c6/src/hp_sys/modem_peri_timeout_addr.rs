///Register `MODEM_PERI_TIMEOUT_ADDR` reader
pub type R = crate::R<MODEM_PERI_TIMEOUT_ADDR_SPEC>;
///Field `MODEM_PERI_TIMEOUT_ADDR` reader - Record the address information of abnormal access
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MODEM_PERI_TIMEOUT_ADDR")
            .field("modem_peri_timeout_addr", &self.modem_peri_timeout_addr())
            .finish()
    }
}
...
///`read()` method returns [`modem_peri_timeout_addr::R`](R) reader structure
impl crate::Readable for MODEM_PERI_TIMEOUT_ADDR_SPEC {}
///`reset()` method sets MODEM_PERI_TIMEOUT_ADDR to value 0
