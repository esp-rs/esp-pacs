///Register `MODEM_PERI_TIMEOUT_CONF` reader
pub type R = crate::R<MODEM_PERI_TIMEOUT_CONF_SPEC>;
///Register `MODEM_PERI_TIMEOUT_CONF` writer
pub type W = crate::W<MODEM_PERI_TIMEOUT_CONF_SPEC>;
///Field `MODEM_PERI_TIMEOUT_THRES` reader - Set the timeout threshold for bus access, corresponding to the number of clock cycles of the clock domain.
pub type MODEM_PERI_TIMEOUT_THRES_R = crate::FieldReader<u16>;
///Field `MODEM_PERI_TIMEOUT_THRES` writer - Set the timeout threshold for bus access, corresponding to the number of clock cycles of the clock domain.
pub type MODEM_PERI_TIMEOUT_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `MODEM_PERI_TIMEOUT_INT_CLEAR` writer - Set this bit as 1 to clear timeout interrupt
pub type MODEM_PERI_TIMEOUT_INT_CLEAR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MODEM_PERI_TIMEOUT_PROTECT_EN` reader - Set this bit as 1 to enable timeout protection for accessing modem registers
pub type MODEM_PERI_TIMEOUT_PROTECT_EN_R = crate::BitReader;
///Field `MODEM_PERI_TIMEOUT_PROTECT_EN` writer - Set this bit as 1 to enable timeout protection for accessing modem registers
...
impl R {
    ...
    ///Bit 17 - Set this bit as 1 to enable timeout protection for accessing modem registers
    #[inline(always)]
...
///`read()` method returns [`modem_peri_timeout_conf::R`](R) reader structure
impl crate::Readable for MODEM_PERI_TIMEOUT_CONF_SPEC {}
///`write(|w| ..)` method takes [`modem_peri_timeout_conf::W`](W) writer structure
impl crate::Writable for MODEM_PERI_TIMEOUT_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MODEM_PERI_TIMEOUT_CONF to value 0x0002_ffff
