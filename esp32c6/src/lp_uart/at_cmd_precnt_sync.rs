...
pub struct R(crate::R<AT_CMD_PRECNT_SYNC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AT_CMD_PRECNT_SYNC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AT_CMD_PRECNT_SYNC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AT_CMD_PRECNT_SYNC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `AT_CMD_PRECNT_SYNC` writer"]
pub struct W(crate::W<AT_CMD_PRECNT_SYNC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AT_CMD_PRECNT_SYNC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AT_CMD_PRECNT_SYNC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AT_CMD_PRECNT_SYNC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRE_IDLE_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AT_CMD_PRECNT_SYNC_SPEC, u16, u16, 16, O>;
impl R {
