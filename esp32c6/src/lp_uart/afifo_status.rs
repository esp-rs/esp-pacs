...
pub type TX_AFIFO_FULL_R = crate::BitReader<bool>;
#[doc = "Field `TX_AFIFO_EMPTY` reader - Empty signal of APB TX AFIFO."]
pub type TX_AFIFO_EMPTY_R = crate::BitReader<bool>;
#[doc = "Field `RX_AFIFO_FULL` reader - Full signal of APB RX AFIFO."]
pub type RX_AFIFO_FULL_R = crate::BitReader<bool>;
#[doc = "Field `RX_AFIFO_EMPTY` reader - Empty signal of APB RX AFIFO."]
pub type RX_AFIFO_EMPTY_R = crate::BitReader<bool>;
impl R {
