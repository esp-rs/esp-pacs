...
pub type TASK_GAMMA_RESTART_CH0_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESTART_CH1_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESTART_CH2_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESTART_CH3_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESTART_CH4_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESTART_CH5_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_PAUSE_CH0_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_PAUSE_CH1_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_PAUSE_CH2_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_PAUSE_CH3_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_PAUSE_CH4_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_PAUSE_CH5_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESUME_CH0_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESUME_CH1_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESUME_CH2_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESUME_CH3_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESUME_CH4_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TASK_GAMMA_RESUME_CH5_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn task_gamma_restart_ch0_en(
        &mut self,
    ) -> TASK_GAMMA_RESTART_CH0_EN_W<EVT_TASK_EN2_SPEC, 0> {
    ...
    pub fn task_gamma_restart_ch1_en(
        &mut self,
    ) -> TASK_GAMMA_RESTART_CH1_EN_W<EVT_TASK_EN2_SPEC, 1> {
    ...
    pub fn task_gamma_restart_ch2_en(
        &mut self,
    ) -> TASK_GAMMA_RESTART_CH2_EN_W<EVT_TASK_EN2_SPEC, 2> {
    ...
    pub fn task_gamma_restart_ch3_en(
        &mut self,
    ) -> TASK_GAMMA_RESTART_CH3_EN_W<EVT_TASK_EN2_SPEC, 3> {
    ...
    pub fn task_gamma_restart_ch4_en(
        &mut self,
    ) -> TASK_GAMMA_RESTART_CH4_EN_W<EVT_TASK_EN2_SPEC, 4> {
    ...
    pub fn task_gamma_restart_ch5_en(
        &mut self,
    ) -> TASK_GAMMA_RESTART_CH5_EN_W<EVT_TASK_EN2_SPEC, 5> {
        TASK_GAMMA_RESTART_CH5_EN_W::new(self)
    }
    #[doc = "Bit 8 - Ledc ch0 gamma pause task enable register, write 1 to enable this task."]
    #[inline(always)]
    #[must_use]
    pub fn task_gamma_pause_ch0_en(&mut self) -> TASK_GAMMA_PAUSE_CH0_EN_W<EVT_TASK_EN2_SPEC, 8> {
        TASK_GAMMA_PAUSE_CH0_EN_W::new(self)
    }
    #[doc = "Bit 9 - Ledc ch1 gamma pause task enable register, write 1 to enable this task."]
    #[inline(always)]
    #[must_use]
    pub fn task_gamma_pause_ch1_en(&mut self) -> TASK_GAMMA_PAUSE_CH1_EN_W<EVT_TASK_EN2_SPEC, 9> {
        TASK_GAMMA_PAUSE_CH1_EN_W::new(self)
    }
    #[doc = "Bit 10 - Ledc ch2 gamma pause task enable register, write 1 to enable this task."]
    #[inline(always)]
    #[must_use]
    pub fn task_gamma_pause_ch2_en(&mut self) -> TASK_GAMMA_PAUSE_CH2_EN_W<EVT_TASK_EN2_SPEC, 10> {
        TASK_GAMMA_PAUSE_CH2_EN_W::new(self)
    }
    #[doc = "Bit 11 - Ledc ch3 gamma pause task enable register, write 1 to enable this task."]
    #[inline(always)]
    #[must_use]
    pub fn task_gamma_pause_ch3_en(&mut self) -> TASK_GAMMA_PAUSE_CH3_EN_W<EVT_TASK_EN2_SPEC, 11> {
        TASK_GAMMA_PAUSE_CH3_EN_W::new(self)
    }
    #[doc = "Bit 12 - Ledc ch4 gamma pause task enable register, write 1 to enable this task."]
    #[inline(always)]
    #[must_use]
    pub fn task_gamma_pause_ch4_en(&mut self) -> TASK_GAMMA_PAUSE_CH4_EN_W<EVT_TASK_EN2_SPEC, 12> {
        TASK_GAMMA_PAUSE_CH4_EN_W::new(self)
    }
    #[doc = "Bit 13 - Ledc ch5 gamma pause task enable register, write 1 to enable this task."]
    #[inline(always)]
    #[must_use]
    pub fn task_gamma_pause_ch5_en(&mut self) -> TASK_GAMMA_PAUSE_CH5_EN_W<EVT_TASK_EN2_SPEC, 13> {
    ...
    pub fn task_gamma_resume_ch0_en(
        &mut self,
    ) -> TASK_GAMMA_RESUME_CH0_EN_W<EVT_TASK_EN2_SPEC, 16> {
    ...
    pub fn task_gamma_resume_ch1_en(
        &mut self,
    ) -> TASK_GAMMA_RESUME_CH1_EN_W<EVT_TASK_EN2_SPEC, 17> {
    ...
    pub fn task_gamma_resume_ch2_en(
        &mut self,
    ) -> TASK_GAMMA_RESUME_CH2_EN_W<EVT_TASK_EN2_SPEC, 18> {
    ...
    pub fn task_gamma_resume_ch3_en(
        &mut self,
    ) -> TASK_GAMMA_RESUME_CH3_EN_W<EVT_TASK_EN2_SPEC, 19> {
    ...
    pub fn task_gamma_resume_ch4_en(
        &mut self,
    ) -> TASK_GAMMA_RESUME_CH4_EN_W<EVT_TASK_EN2_SPEC, 20> {
    ...
    pub fn task_gamma_resume_ch5_en(
        &mut self,
    ) -> TASK_GAMMA_RESUME_CH5_EN_W<EVT_TASK_EN2_SPEC, 21> {
