...
///Field `DUTY_CHNG_END_CH(0-5)` writer - Set this bit to clear the DUTY_CHNG_END_CH%s interrupt.
pub type DUTY_CHNG_END_CH_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `OVF_CNT_CH(0-5)` writer - Set this bit to clear the OVF_CNT_CH%s interrupt.
...
impl W {
    ...
    ///Set this bit to clear the DUTY_CHNG_END_CH(0-5) interrupt.
    ///
    ...
    ///Set this bit to clear the OVF_CNT_CH(0-5) interrupt.
    ///
