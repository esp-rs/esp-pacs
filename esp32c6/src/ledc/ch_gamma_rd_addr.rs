///Register `CH%s_GAMMA_RD_ADDR` reader
pub type R = crate::R<CH_GAMMA_RD_ADDR_SPEC>;
///Register `CH%s_GAMMA_RD_ADDR` writer
pub type W = crate::W<CH_GAMMA_RD_ADDR_SPEC>;
///Field `CH_GAMMA_RD_ADDR` reader - Ledc ch%s gamma ram read address.
pub type CH_GAMMA_RD_ADDR_R = crate::FieldReader;
///Field `CH_GAMMA_RD_ADDR` writer - Ledc ch%s gamma ram read address.
pub type CH_GAMMA_RD_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ///Bits 0:3 - Ledc ch%s gamma ram read address.
    #[inline(always)]
...
///`read()` method returns [`ch_gamma_rd_addr::R`](R) reader structure
impl crate::Readable for CH_GAMMA_RD_ADDR_SPEC {}
///`write(|w| ..)` method takes [`ch_gamma_rd_addr::W`](W) writer structure
