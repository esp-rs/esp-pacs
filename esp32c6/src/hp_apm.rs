...
impl RegisterBlock {
    ...
    #[doc = "0x04..0xc4 - Cluster REGION%s, containing REGION*_ADDR_START, REGION*_ADDR_END, REGION*_PMS_ATTR"]
    #[inline(always)]
    ...
    #[doc = "0xc8..0x108 - Cluster M%s, containing M?_STATUS, M?_STATUS_CLR, M?_EXCEPTION_INFO0, M?_EXCEPTION_INFO1"]
    #[inline(always)]
