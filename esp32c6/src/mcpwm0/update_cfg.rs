...
///Field `GLOBAL_UP_EN` reader - The global enable of update of all active registers in MCPWM module
pub type GLOBAL_UP_EN_R = crate::BitReader;
///Field `GLOBAL_UP_EN` writer - The global enable of update of all active registers in MCPWM module
pub type GLOBAL_UP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GLOBAL_FORCE_UP` reader - a toggle (software invert its value) will trigger a forced update of all active registers in MCPWM module
pub type GLOBAL_FORCE_UP_R = crate::BitReader;
///Field `GLOBAL_FORCE_UP` writer - a toggle (software invert its value) will trigger a forced update of all active registers in MCPWM module
pub type GLOBAL_FORCE_UP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OP0_UP_EN` reader - When set and PWM_GLOBAL_UP_EN is set, update of active registers in PWM operator 0 are enabled
pub type OP0_UP_EN_R = crate::BitReader;
///Field `OP0_UP_EN` writer - When set and PWM_GLOBAL_UP_EN is set, update of active registers in PWM operator 0 are enabled
pub type OP0_UP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OP0_FORCE_UP` reader - a toggle (software invert its value) will trigger a forced update of active registers in PWM operator 0
pub type OP0_FORCE_UP_R = crate::BitReader;
///Field `OP0_FORCE_UP` writer - a toggle (software invert its value) will trigger a forced update of active registers in PWM operator 0
pub type OP0_FORCE_UP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OP1_UP_EN` reader - When set and PWM_GLOBAL_UP_EN is set, update of active registers in PWM operator 1 are enabled
pub type OP1_UP_EN_R = crate::BitReader;
///Field `OP1_UP_EN` writer - When set and PWM_GLOBAL_UP_EN is set, update of active registers in PWM operator 1 are enabled
pub type OP1_UP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OP1_FORCE_UP` reader - a toggle (software invert its value) will trigger a forced update of active registers in PWM operator 1
pub type OP1_FORCE_UP_R = crate::BitReader;
///Field `OP1_FORCE_UP` writer - a toggle (software invert its value) will trigger a forced update of active registers in PWM operator 1
pub type OP1_FORCE_UP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OP2_UP_EN` reader - When set and PWM_GLOBAL_UP_EN is set, update of active registers in PWM operator 2 are enabled
pub type OP2_UP_EN_R = crate::BitReader;
///Field `OP2_UP_EN` writer - When set and PWM_GLOBAL_UP_EN is set, update of active registers in PWM operator 2 are enabled
pub type OP2_UP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OP2_FORCE_UP` reader - a toggle (software invert its value) will trigger a forced update of active registers in PWM operator 2
pub type OP2_FORCE_UP_R = crate::BitReader;
///Field `OP2_FORCE_UP` writer - a toggle (software invert its value) will trigger a forced update of active registers in PWM operator 2
