...
pub type TZ2_CLR_OST_W<'a, const O: u8> = crate::BitWriter<'a, u32, FH2_CFG1_SPEC, bool, O>;
...
pub type TZ2_CBCPULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FH2_CFG1_SPEC, u8, u8, 2, O>;
...
pub type TZ2_FORCE_CBC_W<'a, const O: u8> = crate::BitWriter<'a, u32, FH2_CFG1_SPEC, bool, O>;
...
pub type TZ2_FORCE_OST_W<'a, const O: u8> = crate::BitWriter<'a, u32, FH2_CFG1_SPEC, bool, O>;
impl R {
