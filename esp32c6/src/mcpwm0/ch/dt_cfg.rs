...
///Field `FED_UPMETHOD` reader - Update method for FED (rising edge delay) active register. 0: immediate, when bit0 is set to 1: tez, when bit1 is set to 1:tep, when bit2 is set to 1: sync, when bit3 is set to 1: disable the update
pub type FED_UPMETHOD_R = crate::FieldReader;
///Field `FED_UPMETHOD` writer - Update method for FED (rising edge delay) active register. 0: immediate, when bit0 is set to 1: tez, when bit1 is set to 1:tep, when bit2 is set to 1: sync, when bit3 is set to 1: disable the update
pub type FED_UPMETHOD_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `RED_UPMETHOD` reader - Update method for RED (rising edge delay) active register. 0: immediate, when bit0 is set to 1: tez, when bit1 is set to 1:tep, when bit2 is set to 1: sync, when bit3 is set to 1: disable the update
pub type RED_UPMETHOD_R = crate::FieldReader;
///Field `RED_UPMETHOD` writer - Update method for RED (rising edge delay) active register. 0: immediate, when bit0 is set to 1: tez, when bit1 is set to 1:tep, when bit2 is set to 1: sync, when bit3 is set to 1: disable the update
pub type RED_UPMETHOD_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `DEB_MODE` reader - S8 in table, dual-edge B mode, 0: fed/red take effect on different path separately, 1: fed/red take effect on B path, A out is in bypass or dulpB mode
pub type DEB_MODE_R = crate::BitReader;
///Field `DEB_MODE` writer - S8 in table, dual-edge B mode, 0: fed/red take effect on different path separately, 1: fed/red take effect on B path, A out is in bypass or dulpB mode
pub type DEB_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `A_OUTSWAP` reader - S6 in table
pub type A_OUTSWAP_R = crate::BitReader;
///Field `A_OUTSWAP` writer - S6 in table
pub type A_OUTSWAP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `B_OUTSWAP` reader - S7 in table
pub type B_OUTSWAP_R = crate::BitReader;
///Field `B_OUTSWAP` writer - S7 in table
pub type B_OUTSWAP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RED_INSEL` reader - S4 in table
pub type RED_INSEL_R = crate::BitReader;
///Field `RED_INSEL` writer - S4 in table
pub type RED_INSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FED_INSEL` reader - S5 in table
pub type FED_INSEL_R = crate::BitReader;
///Field `FED_INSEL` writer - S5 in table
pub type FED_INSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RED_OUTINVERT` reader - S2 in table
pub type RED_OUTINVERT_R = crate::BitReader;
///Field `RED_OUTINVERT` writer - S2 in table
pub type RED_OUTINVERT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FED_OUTINVERT` reader - S3 in table
pub type FED_OUTINVERT_R = crate::BitReader;
///Field `FED_OUTINVERT` writer - S3 in table
pub type FED_OUTINVERT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `A_OUTBYPASS` reader - S1 in table
pub type A_OUTBYPASS_R = crate::BitReader;
///Field `A_OUTBYPASS` writer - S1 in table
pub type A_OUTBYPASS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `B_OUTBYPASS` reader - S0 in table
pub type B_OUTBYPASS_R = crate::BitReader;
///Field `B_OUTBYPASS` writer - S0 in table
pub type B_OUTBYPASS_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_SEL` reader - Dead time generator 0 clock selection. 0: PWM_clk, 1: PT_clk
pub type CLK_SEL_R = crate::BitReader;
///Field `CLK_SEL` writer - Dead time generator 0 clock selection. 0: PWM_clk, 1: PT_clk
pub type CLK_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:3 - Update method for FED (rising edge delay) active register. 0: immediate, when bit0 is set to 1: tez, when bit1 is set to 1:tep, when bit2 is set to 1: sync, when bit3 is set to 1: disable the update
    #[inline(always)]
