...
///Field `UTEZ` reader - Action on PWM0A triggered by event TEZ when timer increasing
pub type UTEZ_R = crate::FieldReader;
///Field `UTEZ` writer - Action on PWM0A triggered by event TEZ when timer increasing
pub type UTEZ_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `UTEP` reader - Action on PWM0A triggered by event TEP when timer increasing
pub type UTEP_R = crate::FieldReader;
///Field `UTEP` writer - Action on PWM0A triggered by event TEP when timer increasing
pub type UTEP_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `UTEA` reader - Action on PWM0A triggered by event TEA when timer increasing
pub type UTEA_R = crate::FieldReader;
///Field `UTEA` writer - Action on PWM0A triggered by event TEA when timer increasing
pub type UTEA_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `UTEB` reader - Action on PWM0A triggered by event TEB when timer increasing
pub type UTEB_R = crate::FieldReader;
///Field `UTEB` writer - Action on PWM0A triggered by event TEB when timer increasing
pub type UTEB_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `UT0` reader - Action on PWM0A triggered by event_t0 when timer increasing
pub type UT0_R = crate::FieldReader;
///Field `UT0` writer - Action on PWM0A triggered by event_t0 when timer increasing
pub type UT0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `UT1` reader - Action on PWM0A triggered by event_t1 when timer increasing
pub type UT1_R = crate::FieldReader;
///Field `UT1` writer - Action on PWM0A triggered by event_t1 when timer increasing
pub type UT1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DTEZ` reader - Action on PWM0A triggered by event TEZ when timer decreasing
pub type DTEZ_R = crate::FieldReader;
///Field `DTEZ` writer - Action on PWM0A triggered by event TEZ when timer decreasing
pub type DTEZ_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DTEP` reader - Action on PWM0A triggered by event TEP when timer decreasing
pub type DTEP_R = crate::FieldReader;
///Field `DTEP` writer - Action on PWM0A triggered by event TEP when timer decreasing
pub type DTEP_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DTEA` reader - Action on PWM0A triggered by event TEA when timer decreasing
pub type DTEA_R = crate::FieldReader;
///Field `DTEA` writer - Action on PWM0A triggered by event TEA when timer decreasing
pub type DTEA_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DTEB` reader - Action on PWM0A triggered by event TEB when timer decreasing
pub type DTEB_R = crate::FieldReader;
///Field `DTEB` writer - Action on PWM0A triggered by event TEB when timer decreasing
pub type DTEB_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DT0` reader - Action on PWM0A triggered by event_t0 when timer decreasing
pub type DT0_R = crate::FieldReader;
///Field `DT0` writer - Action on PWM0A triggered by event_t0 when timer decreasing
pub type DT0_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DT1` reader - Action on PWM0A triggered by event_t1 when timer decreasing. 0: no change, 1: low, 2: high, 3: toggle
pub type DT1_R = crate::FieldReader;
///Field `DT1` writer - Action on PWM0A triggered by event_t1 when timer decreasing. 0: no change, 1: low, 2: high, 3: toggle
