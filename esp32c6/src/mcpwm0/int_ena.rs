...
///Field `TIMER0_STOP` reader - The enable bit for the interrupt triggered when the timer 0 stops.
pub type TIMER0_STOP_R = crate::BitReader;
///Field `TIMER0_STOP` writer - The enable bit for the interrupt triggered when the timer 0 stops.
pub type TIMER0_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER1_STOP` reader - The enable bit for the interrupt triggered when the timer 1 stops.
pub type TIMER1_STOP_R = crate::BitReader;
///Field `TIMER1_STOP` writer - The enable bit for the interrupt triggered when the timer 1 stops.
pub type TIMER1_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER2_STOP` reader - The enable bit for the interrupt triggered when the timer 2 stops.
pub type TIMER2_STOP_R = crate::BitReader;
///Field `TIMER2_STOP` writer - The enable bit for the interrupt triggered when the timer 2 stops.
pub type TIMER2_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER0_TEZ` reader - The enable bit for the interrupt triggered by a PWM timer 0 TEZ event.
pub type TIMER0_TEZ_R = crate::BitReader;
///Field `TIMER0_TEZ` writer - The enable bit for the interrupt triggered by a PWM timer 0 TEZ event.
pub type TIMER0_TEZ_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER1_TEZ` reader - The enable bit for the interrupt triggered by a PWM timer 1 TEZ event.
pub type TIMER1_TEZ_R = crate::BitReader;
///Field `TIMER1_TEZ` writer - The enable bit for the interrupt triggered by a PWM timer 1 TEZ event.
pub type TIMER1_TEZ_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER2_TEZ` reader - The enable bit for the interrupt triggered by a PWM timer 2 TEZ event.
pub type TIMER2_TEZ_R = crate::BitReader;
///Field `TIMER2_TEZ` writer - The enable bit for the interrupt triggered by a PWM timer 2 TEZ event.
pub type TIMER2_TEZ_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER0_TEP` reader - The enable bit for the interrupt triggered by a PWM timer 0 TEP event.
pub type TIMER0_TEP_R = crate::BitReader;
///Field `TIMER0_TEP` writer - The enable bit for the interrupt triggered by a PWM timer 0 TEP event.
pub type TIMER0_TEP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER1_TEP` reader - The enable bit for the interrupt triggered by a PWM timer 1 TEP event.
pub type TIMER1_TEP_R = crate::BitReader;
///Field `TIMER1_TEP` writer - The enable bit for the interrupt triggered by a PWM timer 1 TEP event.
pub type TIMER1_TEP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIMER2_TEP` reader - The enable bit for the interrupt triggered by a PWM timer 2 TEP event.
pub type TIMER2_TEP_R = crate::BitReader;
///Field `TIMER2_TEP` writer - The enable bit for the interrupt triggered by a PWM timer 2 TEP event.
...
///Field `FAULT0` writer - The enable bit for the interrupt triggered when event_f0 starts.
pub type FAULT0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FAULT1` reader - The enable bit for the interrupt triggered when event_f1 starts.
pub type FAULT1_R = crate::BitReader;
///Field `FAULT1` writer - The enable bit for the interrupt triggered when event_f1 starts.
pub type FAULT1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FAULT2` reader - The enable bit for the interrupt triggered when event_f2 starts.
pub type FAULT2_R = crate::BitReader;
///Field `FAULT2` writer - The enable bit for the interrupt triggered when event_f2 starts.
pub type FAULT2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FAULT0_CLR` reader - The enable bit for the interrupt triggered when event_f0 ends.
pub type FAULT0_CLR_R = crate::BitReader;
///Field `FAULT0_CLR` writer - The enable bit for the interrupt triggered when event_f0 ends.
pub type FAULT0_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FAULT1_CLR` reader - The enable bit for the interrupt triggered when event_f1 ends.
pub type FAULT1_CLR_R = crate::BitReader;
///Field `FAULT1_CLR` writer - The enable bit for the interrupt triggered when event_f1 ends.
pub type FAULT1_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FAULT2_CLR` reader - The enable bit for the interrupt triggered when event_f2 ends.
pub type FAULT2_CLR_R = crate::BitReader;
///Field `FAULT2_CLR` writer - The enable bit for the interrupt triggered when event_f2 ends.
pub type FAULT2_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CMPR0_TEA` reader - The enable bit for the interrupt triggered by a PWM operator 0 TEA event
pub type CMPR0_TEA_R = crate::BitReader;
///Field `CMPR0_TEA` writer - The enable bit for the interrupt triggered by a PWM operator 0 TEA event
pub type CMPR0_TEA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CMPR1_TEA` reader - The enable bit for the interrupt triggered by a PWM operator 1 TEA event
pub type CMPR1_TEA_R = crate::BitReader;
///Field `CMPR1_TEA` writer - The enable bit for the interrupt triggered by a PWM operator 1 TEA event
pub type CMPR1_TEA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CMPR2_TEA` reader - The enable bit for the interrupt triggered by a PWM operator 2 TEA event
pub type CMPR2_TEA_R = crate::BitReader;
///Field `CMPR2_TEA` writer - The enable bit for the interrupt triggered by a PWM operator 2 TEA event
pub type CMPR2_TEA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CMPR0_TEB` reader - The enable bit for the interrupt triggered by a PWM operator 0 TEB event
pub type CMPR0_TEB_R = crate::BitReader;
///Field `CMPR0_TEB` writer - The enable bit for the interrupt triggered by a PWM operator 0 TEB event
pub type CMPR0_TEB_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CMPR1_TEB` reader - The enable bit for the interrupt triggered by a PWM operator 1 TEB event
pub type CMPR1_TEB_R = crate::BitReader;
///Field `CMPR1_TEB` writer - The enable bit for the interrupt triggered by a PWM operator 1 TEB event
pub type CMPR1_TEB_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CMPR2_TEB` reader - The enable bit for the interrupt triggered by a PWM operator 2 TEB event
pub type CMPR2_TEB_R = crate::BitReader;
///Field `CMPR2_TEB` writer - The enable bit for the interrupt triggered by a PWM operator 2 TEB event
pub type CMPR2_TEB_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TZ0_CBC` reader - The enable bit for the interrupt triggered by a cycle-by-cycle mode action on PWM0.
pub type TZ0_CBC_R = crate::BitReader;
///Field `TZ0_CBC` writer - The enable bit for the interrupt triggered by a cycle-by-cycle mode action on PWM0.
pub type TZ0_CBC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TZ1_CBC` reader - The enable bit for the interrupt triggered by a cycle-by-cycle mode action on PWM1.
pub type TZ1_CBC_R = crate::BitReader;
///Field `TZ1_CBC` writer - The enable bit for the interrupt triggered by a cycle-by-cycle mode action on PWM1.
pub type TZ1_CBC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TZ2_CBC` reader - The enable bit for the interrupt triggered by a cycle-by-cycle mode action on PWM2.
pub type TZ2_CBC_R = crate::BitReader;
///Field `TZ2_CBC` writer - The enable bit for the interrupt triggered by a cycle-by-cycle mode action on PWM2.
pub type TZ2_CBC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TZ0_OST` reader - The enable bit for the interrupt triggered by a one-shot mode action on PWM0.
pub type TZ0_OST_R = crate::BitReader;
///Field `TZ0_OST` writer - The enable bit for the interrupt triggered by a one-shot mode action on PWM0.
pub type TZ0_OST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TZ1_OST` reader - The enable bit for the interrupt triggered by a one-shot mode action on PWM1.
pub type TZ1_OST_R = crate::BitReader;
///Field `TZ1_OST` writer - The enable bit for the interrupt triggered by a one-shot mode action on PWM1.
pub type TZ1_OST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TZ2_OST` reader - The enable bit for the interrupt triggered by a one-shot mode action on PWM2.
pub type TZ2_OST_R = crate::BitReader;
///Field `TZ2_OST` writer - The enable bit for the interrupt triggered by a one-shot mode action on PWM2.
pub type TZ2_OST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAP0` reader - The enable bit for the interrupt triggered by capture on channel 0.
pub type CAP0_R = crate::BitReader;
///Field `CAP0` writer - The enable bit for the interrupt triggered by capture on channel 0.
pub type CAP0_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAP1` reader - The enable bit for the interrupt triggered by capture on channel 1.
pub type CAP1_R = crate::BitReader;
///Field `CAP1` writer - The enable bit for the interrupt triggered by capture on channel 1.
pub type CAP1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CAP2` reader - The enable bit for the interrupt triggered by capture on channel 2.
pub type CAP2_R = crate::BitReader;
///Field `CAP2` writer - The enable bit for the interrupt triggered by capture on channel 2.
