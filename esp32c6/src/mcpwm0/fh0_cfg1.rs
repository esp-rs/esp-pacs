...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tz0_clr_ost(&mut self) -> TZ0_CLR_OST_W<FH0_CFG1_SPEC, 0> {
        TZ0_CLR_OST_W::new(self)
    }
    #[doc = "Bits 1:2 - cycle-by-cycle mode action refresh moment selection. When bit0 is set to 1: TEZ, when bit1 is set to 1:TEP"]
    #[inline(always)]
    #[must_use]
    pub fn tz0_cbcpulse(&mut self) -> TZ0_CBCPULSE_W<FH0_CFG1_SPEC, 1> {
        TZ0_CBCPULSE_W::new(self)
    }
    #[doc = "Bit 3 - a toggle trigger a cycle-by-cycle mode action"]
    #[inline(always)]
    #[must_use]
    pub fn tz0_force_cbc(&mut self) -> TZ0_FORCE_CBC_W<FH0_CFG1_SPEC, 3> {
        TZ0_FORCE_CBC_W::new(self)
    }
    #[doc = "Bit 4 - a toggle (software negate its value) triggers a one-shot mode action"]
    #[inline(always)]
    #[must_use]
    pub fn tz0_force_ost(&mut self) -> TZ0_FORCE_OST_W<FH0_CFG1_SPEC, 4> {
