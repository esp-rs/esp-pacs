...
pub type TZ0_CLR_OST_W<'a, const O: u8> = crate::BitWriter<'a, u32, FH0_CFG1_SPEC, bool, O>;
...
pub type TZ0_CBCPULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FH0_CFG1_SPEC, u8, u8, 2, O>;
...
pub type TZ0_FORCE_CBC_W<'a, const O: u8> = crate::BitWriter<'a, u32, FH0_CFG1_SPEC, bool, O>;
...
pub type TZ0_FORCE_OST_W<'a, const O: u8> = crate::BitWriter<'a, u32, FH0_CFG1_SPEC, bool, O>;
impl R {
