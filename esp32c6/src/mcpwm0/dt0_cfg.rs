...
pub type DB0_FED_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, DT0_CFG_SPEC, 4, O>;
...
pub type DB0_RED_UPMETHOD_W<'a, const O: u8> = crate::FieldWriter<'a, DT0_CFG_SPEC, 4, O>;
...
pub type DB0_DEB_MODE_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
...
pub type DB0_A_OUTSWAP_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
...
pub type DB0_B_OUTSWAP_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
...
pub type DB0_RED_INSEL_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
...
pub type DB0_FED_INSEL_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
...
pub type DB0_RED_OUTINVERT_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
...
pub type DB0_FED_OUTINVERT_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
...
pub type DB0_A_OUTBYPASS_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
...
pub type DB0_B_OUTBYPASS_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
...
pub type DB0_CLK_SEL_W<'a, const O: u8> = crate::BitWriter<'a, DT0_CFG_SPEC, O>;
impl R {
