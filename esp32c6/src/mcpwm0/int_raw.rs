...
pub type TIMER0_STOP_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMER1_STOP_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMER2_STOP_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMER0_TEZ_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMER1_TEZ_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMER2_TEZ_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMER0_TEP_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMER1_TEP_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TIMER2_TEP_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FAULT0_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FAULT1_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FAULT2_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FAULT0_CLR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FAULT1_CLR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FAULT2_CLR_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMPR0_TEA_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMPR1_TEA_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMPR2_TEA_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMPR0_TEB_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMPR1_TEB_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CMPR2_TEB_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TZ0_CBC_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TZ1_CBC_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TZ2_CBC_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TZ0_OST_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TZ1_OST_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TZ2_OST_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CAP0_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CAP1_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CAP2_INT_RAW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer0_stop_int_raw(&mut self) -> TIMER0_STOP_INT_RAW_W<INT_RAW_SPEC, 0> {
        TIMER0_STOP_INT_RAW_W::new(self)
    }
    #[doc = "Bit 1 - The raw status bit for the interrupt triggered when the timer 1 stops."]
    #[inline(always)]
    #[must_use]
    pub fn timer1_stop_int_raw(&mut self) -> TIMER1_STOP_INT_RAW_W<INT_RAW_SPEC, 1> {
        TIMER1_STOP_INT_RAW_W::new(self)
    }
    #[doc = "Bit 2 - The raw status bit for the interrupt triggered when the timer 2 stops."]
    #[inline(always)]
    #[must_use]
    pub fn timer2_stop_int_raw(&mut self) -> TIMER2_STOP_INT_RAW_W<INT_RAW_SPEC, 2> {
        TIMER2_STOP_INT_RAW_W::new(self)
    }
    #[doc = "Bit 3 - The raw status bit for the interrupt triggered by a PWM timer 0 TEZ event."]
    #[inline(always)]
    #[must_use]
    pub fn timer0_tez_int_raw(&mut self) -> TIMER0_TEZ_INT_RAW_W<INT_RAW_SPEC, 3> {
        TIMER0_TEZ_INT_RAW_W::new(self)
    }
    #[doc = "Bit 4 - The raw status bit for the interrupt triggered by a PWM timer 1 TEZ event."]
    #[inline(always)]
    #[must_use]
    pub fn timer1_tez_int_raw(&mut self) -> TIMER1_TEZ_INT_RAW_W<INT_RAW_SPEC, 4> {
        TIMER1_TEZ_INT_RAW_W::new(self)
    }
    #[doc = "Bit 5 - The raw status bit for the interrupt triggered by a PWM timer 2 TEZ event."]
    #[inline(always)]
    #[must_use]
    pub fn timer2_tez_int_raw(&mut self) -> TIMER2_TEZ_INT_RAW_W<INT_RAW_SPEC, 5> {
        TIMER2_TEZ_INT_RAW_W::new(self)
    }
    #[doc = "Bit 6 - The raw status bit for the interrupt triggered by a PWM timer 0 TEP event."]
    #[inline(always)]
    #[must_use]
    pub fn timer0_tep_int_raw(&mut self) -> TIMER0_TEP_INT_RAW_W<INT_RAW_SPEC, 6> {
        TIMER0_TEP_INT_RAW_W::new(self)
    }
    #[doc = "Bit 7 - The raw status bit for the interrupt triggered by a PWM timer 1 TEP event."]
    #[inline(always)]
    #[must_use]
    pub fn timer1_tep_int_raw(&mut self) -> TIMER1_TEP_INT_RAW_W<INT_RAW_SPEC, 7> {
        TIMER1_TEP_INT_RAW_W::new(self)
    }
    #[doc = "Bit 8 - The raw status bit for the interrupt triggered by a PWM timer 2 TEP event."]
    #[inline(always)]
    #[must_use]
    pub fn timer2_tep_int_raw(&mut self) -> TIMER2_TEP_INT_RAW_W<INT_RAW_SPEC, 8> {
        TIMER2_TEP_INT_RAW_W::new(self)
    }
    #[doc = "Bit 9 - The raw status bit for the interrupt triggered when event_f0 starts."]
    #[inline(always)]
    #[must_use]
    pub fn fault0_int_raw(&mut self) -> FAULT0_INT_RAW_W<INT_RAW_SPEC, 9> {
        FAULT0_INT_RAW_W::new(self)
    }
    #[doc = "Bit 10 - The raw status bit for the interrupt triggered when event_f1 starts."]
    #[inline(always)]
    #[must_use]
    pub fn fault1_int_raw(&mut self) -> FAULT1_INT_RAW_W<INT_RAW_SPEC, 10> {
        FAULT1_INT_RAW_W::new(self)
    }
    #[doc = "Bit 11 - The raw status bit for the interrupt triggered when event_f2 starts."]
    #[inline(always)]
    #[must_use]
    pub fn fault2_int_raw(&mut self) -> FAULT2_INT_RAW_W<INT_RAW_SPEC, 11> {
        FAULT2_INT_RAW_W::new(self)
    }
    #[doc = "Bit 12 - The raw status bit for the interrupt triggered when event_f0 ends."]
    #[inline(always)]
    #[must_use]
    pub fn fault0_clr_int_raw(&mut self) -> FAULT0_CLR_INT_RAW_W<INT_RAW_SPEC, 12> {
        FAULT0_CLR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 13 - The raw status bit for the interrupt triggered when event_f1 ends."]
    #[inline(always)]
    #[must_use]
    pub fn fault1_clr_int_raw(&mut self) -> FAULT1_CLR_INT_RAW_W<INT_RAW_SPEC, 13> {
        FAULT1_CLR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 14 - The raw status bit for the interrupt triggered when event_f2 ends."]
    #[inline(always)]
    #[must_use]
    pub fn fault2_clr_int_raw(&mut self) -> FAULT2_CLR_INT_RAW_W<INT_RAW_SPEC, 14> {
        FAULT2_CLR_INT_RAW_W::new(self)
    }
    #[doc = "Bit 15 - The raw status bit for the interrupt triggered by a PWM operator 0 TEA event"]
    #[inline(always)]
    #[must_use]
    pub fn cmpr0_tea_int_raw(&mut self) -> CMPR0_TEA_INT_RAW_W<INT_RAW_SPEC, 15> {
        CMPR0_TEA_INT_RAW_W::new(self)
    }
    #[doc = "Bit 16 - The raw status bit for the interrupt triggered by a PWM operator 1 TEA event"]
    #[inline(always)]
    #[must_use]
    pub fn cmpr1_tea_int_raw(&mut self) -> CMPR1_TEA_INT_RAW_W<INT_RAW_SPEC, 16> {
        CMPR1_TEA_INT_RAW_W::new(self)
    }
    #[doc = "Bit 17 - The raw status bit for the interrupt triggered by a PWM operator 2 TEA event"]
    #[inline(always)]
    #[must_use]
    pub fn cmpr2_tea_int_raw(&mut self) -> CMPR2_TEA_INT_RAW_W<INT_RAW_SPEC, 17> {
        CMPR2_TEA_INT_RAW_W::new(self)
    }
    #[doc = "Bit 18 - The raw status bit for the interrupt triggered by a PWM operator 0 TEB event"]
    #[inline(always)]
    #[must_use]
    pub fn cmpr0_teb_int_raw(&mut self) -> CMPR0_TEB_INT_RAW_W<INT_RAW_SPEC, 18> {
        CMPR0_TEB_INT_RAW_W::new(self)
    }
    #[doc = "Bit 19 - The raw status bit for the interrupt triggered by a PWM operator 1 TEB event"]
    #[inline(always)]
    #[must_use]
    pub fn cmpr1_teb_int_raw(&mut self) -> CMPR1_TEB_INT_RAW_W<INT_RAW_SPEC, 19> {
        CMPR1_TEB_INT_RAW_W::new(self)
    }
    #[doc = "Bit 20 - The raw status bit for the interrupt triggered by a PWM operator 2 TEB event"]
    #[inline(always)]
    #[must_use]
    pub fn cmpr2_teb_int_raw(&mut self) -> CMPR2_TEB_INT_RAW_W<INT_RAW_SPEC, 20> {
        CMPR2_TEB_INT_RAW_W::new(self)
    }
    #[doc = "Bit 21 - The raw status bit for the interrupt triggered by a cycle-by-cycle mode action on PWM0."]
    #[inline(always)]
    #[must_use]
    pub fn tz0_cbc_int_raw(&mut self) -> TZ0_CBC_INT_RAW_W<INT_RAW_SPEC, 21> {
        TZ0_CBC_INT_RAW_W::new(self)
    }
    #[doc = "Bit 22 - The raw status bit for the interrupt triggered by a cycle-by-cycle mode action on PWM1."]
    #[inline(always)]
    #[must_use]
    pub fn tz1_cbc_int_raw(&mut self) -> TZ1_CBC_INT_RAW_W<INT_RAW_SPEC, 22> {
        TZ1_CBC_INT_RAW_W::new(self)
    }
    #[doc = "Bit 23 - The raw status bit for the interrupt triggered by a cycle-by-cycle mode action on PWM2."]
    #[inline(always)]
    #[must_use]
    pub fn tz2_cbc_int_raw(&mut self) -> TZ2_CBC_INT_RAW_W<INT_RAW_SPEC, 23> {
        TZ2_CBC_INT_RAW_W::new(self)
    }
    #[doc = "Bit 24 - The raw status bit for the interrupt triggered by a one-shot mode action on PWM0."]
    #[inline(always)]
    #[must_use]
    pub fn tz0_ost_int_raw(&mut self) -> TZ0_OST_INT_RAW_W<INT_RAW_SPEC, 24> {
        TZ0_OST_INT_RAW_W::new(self)
    }
    #[doc = "Bit 25 - The raw status bit for the interrupt triggered by a one-shot mode action on PWM1."]
    #[inline(always)]
    #[must_use]
    pub fn tz1_ost_int_raw(&mut self) -> TZ1_OST_INT_RAW_W<INT_RAW_SPEC, 25> {
        TZ1_OST_INT_RAW_W::new(self)
    }
    #[doc = "Bit 26 - The raw status bit for the interrupt triggered by a one-shot mode action on PWM2."]
    #[inline(always)]
    #[must_use]
    pub fn tz2_ost_int_raw(&mut self) -> TZ2_OST_INT_RAW_W<INT_RAW_SPEC, 26> {
        TZ2_OST_INT_RAW_W::new(self)
    }
    #[doc = "Bit 27 - The raw status bit for the interrupt triggered by capture on channel 0."]
    #[inline(always)]
    #[must_use]
    pub fn cap0_int_raw(&mut self) -> CAP0_INT_RAW_W<INT_RAW_SPEC, 27> {
        CAP0_INT_RAW_W::new(self)
    }
    #[doc = "Bit 28 - The raw status bit for the interrupt triggered by capture on channel 1."]
    #[inline(always)]
    #[must_use]
    pub fn cap1_int_raw(&mut self) -> CAP1_INT_RAW_W<INT_RAW_SPEC, 28> {
        CAP1_INT_RAW_W::new(self)
    }
    #[doc = "Bit 29 - The raw status bit for the interrupt triggered by capture on channel 2."]
    #[inline(always)]
    #[must_use]
    pub fn cap2_int_raw(&mut self) -> CAP2_INT_RAW_W<INT_RAW_SPEC, 29> {
