///Register `SDIO_SLAVE_CONF` reader
pub type R = crate::R<SDIO_SLAVE_CONF_SPEC>;
///Register `SDIO_SLAVE_CONF` writer
pub type W = crate::W<SDIO_SLAVE_CONF_SPEC>;
///Field `SDIO_SLAVE_CLK_EN` reader - Set 1 to enable sdio_slave clock
pub type SDIO_SLAVE_CLK_EN_R = crate::BitReader;
///Field `SDIO_SLAVE_CLK_EN` writer - Set 1 to enable sdio_slave clock
pub type SDIO_SLAVE_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SDIO_SLAVE_RST_EN` reader - Set 0 to reset sdio_slave module
pub type SDIO_SLAVE_RST_EN_R = crate::BitReader;
///Field `SDIO_SLAVE_RST_EN` writer - Set 0 to reset sdio_slave module
pub type SDIO_SLAVE_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to enable sdio_slave clock
    #[inline(always)]
    pub fn sdio_slave_clk_en(&self) -> SDIO_SLAVE_CLK_EN_R {
        SDIO_SLAVE_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 0 to reset sdio_slave module
    #[inline(always)]
...
///`read()` method returns [`sdio_slave_conf::R`](R) reader structure
impl crate::Readable for SDIO_SLAVE_CONF_SPEC {}
///`write(|w| ..)` method takes [`sdio_slave_conf::W`](W) writer structure
impl crate::Writable for SDIO_SLAVE_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDIO_SLAVE_CONF to value 0x01
