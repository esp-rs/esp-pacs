...
impl R {
    ...
    ///Bits 20:21 - set this field to select clock-source. 0: do not select anyone clock, 1(default): 80MHz, 2: FOSC, 3: XTAL.
    #[inline(always)]
    pub fn sclk_sel(&self) -> SCLK_SEL_R {
        SCLK_SEL_R::new(((self.bits >> 20) & 3) as u8)
    }
    ///Bit 22 - Set 1 to enable rmt function clock
    #[inline(always)]
...
///`reset()` method sets RMT_SCLK_CONF to value 0x0050_1000
