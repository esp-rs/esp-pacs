...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sclk_div_a(&mut self) -> SCLK_DIV_A_W<RMT_SCLK_CONF_SPEC, 0> {
        SCLK_DIV_A_W::new(self)
    }
    #[doc = "Bits 6:11 - The numerator of the frequency divider factor of the rmt function clock."]
    #[inline(always)]
    #[must_use]
    pub fn sclk_div_b(&mut self) -> SCLK_DIV_B_W<RMT_SCLK_CONF_SPEC, 6> {
        SCLK_DIV_B_W::new(self)
    }
    #[doc = "Bits 12:19 - The integral part of the frequency divider factor of the rmt function clock."]
    #[inline(always)]
    #[must_use]
    pub fn sclk_div_num(&mut self) -> SCLK_DIV_NUM_W<RMT_SCLK_CONF_SPEC, 12> {
        SCLK_DIV_NUM_W::new(self)
    }
    #[doc = "Bits 20:21 - set this field to select clock-source. 0: do not select anyone clock, 1(default): 80MHz, 2: FOSC, 3: XTAL."]
    #[inline(always)]
    #[must_use]
    pub fn sclk_sel(&mut self) -> SCLK_SEL_W<RMT_SCLK_CONF_SPEC, 20> {
        SCLK_SEL_W::new(self)
    }
    #[doc = "Bit 22 - Set 1 to enable rmt function clock"]
    #[inline(always)]
    #[must_use]
    pub fn sclk_en(&mut self) -> SCLK_EN_W<RMT_SCLK_CONF_SPEC, 22> {
        SCLK_EN_W::new(self)
    }
