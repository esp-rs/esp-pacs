///Register `CACHE_CONF` reader
pub type R = crate::R<CACHE_CONF_SPEC>;
///Register `CACHE_CONF` writer
pub type W = crate::W<CACHE_CONF_SPEC>;
///Field `CACHE_CLK_EN` reader - Set 1 to enable cache clock
pub type CACHE_CLK_EN_R = crate::BitReader;
///Field `CACHE_CLK_EN` writer - Set 1 to enable cache clock
pub type CACHE_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CACHE_RST_EN` reader - Set 0 to reset cache module
pub type CACHE_RST_EN_R = crate::BitReader;
///Field `CACHE_RST_EN` writer - Set 0 to reset cache module
...
You can [`read`](crate::generic::Reg::read) this register and get [`cache_conf::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cache_conf::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CACHE_CONF_SPEC;
impl crate::RegisterSpec for CACHE_CONF_SPEC {
    type Ux = u32;
}
///`read()` method returns [`cache_conf::R`](R) reader structure
impl crate::Readable for CACHE_CONF_SPEC {}
///`write(|w| ..)` method takes [`cache_conf::W`](W) writer structure
