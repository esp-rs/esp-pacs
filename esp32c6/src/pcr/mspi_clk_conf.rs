...
pub type MSPI_FAST_LS_DIV_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, MSPI_CLK_CONF_SPEC, 8, O>;
...
pub type MSPI_FAST_HS_DIV_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, MSPI_CLK_CONF_SPEC, 8, O>;
impl R {
