...
impl R {
    ...
    ///Bits 8:15 - Set as one within (3,4,5) to generate div4(default)/div5/div6 of high-speed clock-source to drive clk_mspi_fast. Only avaiable whe the clck-source is a high-speed clock-source such as SPLL.
    #[inline(always)]
...
///`reset()` method sets MSPI_CLK_CONF to value 0x0300
