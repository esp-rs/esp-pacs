...
pub type MSPI_FAST_LS_DIV_NUM_R = crate::FieldReader<u8, u8>;
...
pub type MSPI_FAST_LS_DIV_NUM_W<'a, const O: u8> =
...
pub type MSPI_FAST_HS_DIV_NUM_R = crate::FieldReader<u8, u8>;
...
pub type MSPI_FAST_HS_DIV_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MSPI_CLK_CONF_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mspi_fast_ls_div_num(&mut self) -> MSPI_FAST_LS_DIV_NUM_W<0> {
        MSPI_FAST_LS_DIV_NUM_W::new(self)
    }
    #[doc = "Bits 8:15 - Set as one within (3,4,5) to generate div4(default)/div5/div6 of high-speed clock-source to drive clk_mspi_fast. Only avaiable whe the clck-source is a high-speed clock-source such as SPLL."]
    #[inline(always)]
    #[must_use]
    pub fn mspi_fast_hs_div_num(&mut self) -> MSPI_FAST_HS_DIV_NUM_W<8> {
