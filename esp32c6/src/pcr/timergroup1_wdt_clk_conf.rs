///Register `TIMERGROUP1_WDT_CLK_CONF` reader
pub type R = crate::R<TIMERGROUP1_WDT_CLK_CONF_SPEC>;
///Register `TIMERGROUP1_WDT_CLK_CONF` writer
pub type W = crate::W<TIMERGROUP1_WDT_CLK_CONF_SPEC>;
///Field `TG1_WDT_CLK_SEL` reader - set this field to select clock-source. 0(default): XTAL, 1: 80MHz, 2: FOSC, 3: reserved.
pub type TG1_WDT_CLK_SEL_R = crate::FieldReader;
///Field `TG1_WDT_CLK_SEL` writer - set this field to select clock-source. 0(default): XTAL, 1: 80MHz, 2: FOSC, 3: reserved.
pub type TG1_WDT_CLK_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TG1_WDT_CLK_EN` reader - Set 1 to enable timer_group0 wdt clock
pub type TG1_WDT_CLK_EN_R = crate::BitReader;
///Field `TG1_WDT_CLK_EN` writer - Set 1 to enable timer_group0 wdt clock
...
///`read()` method returns [`timergroup1_wdt_clk_conf::R`](R) reader structure
impl crate::Readable for TIMERGROUP1_WDT_CLK_CONF_SPEC {}
///`write(|w| ..)` method takes [`timergroup1_wdt_clk_conf::W`](W) writer structure
