...
pub type TG1_WDT_CLK_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type TG1_WDT_CLK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tg1_wdt_clk_sel(&mut self) -> TG1_WDT_CLK_SEL_W<TIMERGROUP1_WDT_CLK_CONF_SPEC, 20> {
        TG1_WDT_CLK_SEL_W::new(self)
    }
    #[doc = "Bit 22 - Set 1 to enable timer_group0 wdt clock"]
    #[inline(always)]
    #[must_use]
    pub fn tg1_wdt_clk_en(&mut self) -> TG1_WDT_CLK_EN_W<TIMERGROUP1_WDT_CLK_CONF_SPEC, 22> {
