...
#[doc = "`reset()` method sets SYSCLK_CONF to value 0x2800_0200"]
impl crate::Resettable for SYSCLK_CONF_SPEC {
    const RESET_VALUE: Self::Ux = 0x2800_0200;
}
