///Register `RETENTION_CONF` reader
pub type R = crate::R<RETENTION_CONF_SPEC>;
///Register `RETENTION_CONF` writer
pub type W = crate::W<RETENTION_CONF_SPEC>;
///Field `RETENTION_CLK_EN` reader - Set 1 to enable retention clock
pub type RETENTION_CLK_EN_R = crate::BitReader;
///Field `RETENTION_CLK_EN` writer - Set 1 to enable retention clock
pub type RETENTION_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RETENTION_RST_EN` reader - Set 0 to reset retention module
pub type RETENTION_RST_EN_R = crate::BitReader;
///Field `RETENTION_RST_EN` writer - Set 0 to reset retention module
pub type RETENTION_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to enable retention clock
    #[inline(always)]
    pub fn retention_clk_en(&self) -> RETENTION_CLK_EN_R {
        RETENTION_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 0 to reset retention module
    #[inline(always)]
...
///`read()` method returns [`retention_conf::R`](R) reader structure
impl crate::Readable for RETENTION_CONF_SPEC {}
///`write(|w| ..)` method takes [`retention_conf::W`](W) writer structure
impl crate::Writable for RETENTION_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RETENTION_CONF to value 0
