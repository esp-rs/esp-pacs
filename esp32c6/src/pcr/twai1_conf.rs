///Register `TWAI1_CONF` reader
pub type R = crate::R<TWAI1_CONF_SPEC>;
///Register `TWAI1_CONF` writer
pub type W = crate::W<TWAI1_CONF_SPEC>;
///Field `TWAI1_CLK_EN` reader - Set 1 to enable twai1 apb clock
pub type TWAI1_CLK_EN_R = crate::BitReader;
///Field `TWAI1_CLK_EN` writer - Set 1 to enable twai1 apb clock
pub type TWAI1_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TWAI1_RST_EN` reader - Set 0 to reset twai1 module
pub type TWAI1_RST_EN_R = crate::BitReader;
///Field `TWAI1_RST_EN` writer - Set 0 to reset twai1 module
pub type TWAI1_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - Set 1 to enable twai1 apb clock
    #[inline(always)]
    pub fn twai1_clk_en(&self) -> TWAI1_CLK_EN_R {
        TWAI1_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set 0 to reset twai1 module
    #[inline(always)]
...
///`read()` method returns [`twai1_conf::R`](R) reader structure
impl crate::Readable for TWAI1_CONF_SPEC {}
///`write(|w| ..)` method takes [`twai1_conf::W`](W) writer structure
impl crate::Writable for TWAI1_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TWAI1_CONF to value 0x01
