///Register `I2C_SCLK_CONF` reader
pub type R = crate::R<I2C_SCLK_CONF_SPEC>;
///Register `I2C_SCLK_CONF` writer
pub type W = crate::W<I2C_SCLK_CONF_SPEC>;
///Field `I2C_SCLK_DIV_A` reader - The denominator of the frequency divider factor of the i2c function clock.
pub type I2C_SCLK_DIV_A_R = crate::FieldReader;
///Field `I2C_SCLK_DIV_A` writer - The denominator of the frequency divider factor of the i2c function clock.
pub type I2C_SCLK_DIV_A_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `I2C_SCLK_DIV_B` reader - The numerator of the frequency divider factor of the i2c function clock.
pub type I2C_SCLK_DIV_B_R = crate::FieldReader;
///Field `I2C_SCLK_DIV_B` writer - The numerator of the frequency divider factor of the i2c function clock.
pub type I2C_SCLK_DIV_B_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `I2C_SCLK_DIV_NUM` reader - The integral part of the frequency divider factor of the i2c function clock.
pub type I2C_SCLK_DIV_NUM_R = crate::FieldReader;
///Field `I2C_SCLK_DIV_NUM` writer - The integral part of the frequency divider factor of the i2c function clock.
pub type I2C_SCLK_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `I2C_SCLK_SEL` reader - set this field to select clock-source. 0(default): XTAL, 1: FOSC.
pub type I2C_SCLK_SEL_R = crate::BitReader;
///Field `I2C_SCLK_SEL` writer - set this field to select clock-source. 0(default): XTAL, 1: FOSC.
pub type I2C_SCLK_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C_SCLK_EN` reader - Set 1 to enable i2c function clock
pub type I2C_SCLK_EN_R = crate::BitReader;
///Field `I2C_SCLK_EN` writer - Set 1 to enable i2c function clock
...
///`read()` method returns [`i2c_sclk_conf::R`](R) reader structure
impl crate::Readable for I2C_SCLK_CONF_SPEC {}
///`write(|w| ..)` method takes [`i2c_sclk_conf::W`](W) writer structure
impl crate::Writable for I2C_SCLK_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets I2C_SCLK_CONF to value 0x0040_0000
