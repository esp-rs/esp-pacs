...
pub type I2C_SCLK_DIV_A_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2C_SCLK_CONF_SPEC, u8, u8, 6, O>;
...
pub type I2C_SCLK_DIV_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2C_SCLK_CONF_SPEC, u8, u8, 8, O>;
...
pub type I2C_SCLK_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_SCLK_CONF_SPEC, bool, O>;
#[doc = "Field `I2C_SCLK_EN` reader - Set 1 to enable i2c function clock"]
pub type I2C_SCLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `I2C_SCLK_EN` writer - Set 1 to enable i2c function clock"]
pub type I2C_SCLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C_SCLK_CONF_SPEC, bool, O>;
impl R {
