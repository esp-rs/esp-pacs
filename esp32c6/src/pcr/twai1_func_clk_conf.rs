///Register `TWAI1_FUNC_CLK_CONF` reader
pub type R = crate::R<TWAI1_FUNC_CLK_CONF_SPEC>;
///Register `TWAI1_FUNC_CLK_CONF` writer
pub type W = crate::W<TWAI1_FUNC_CLK_CONF_SPEC>;
///Field `TWAI1_FUNC_CLK_SEL` reader - set this field to select clock-source. 0(default): XTAL, 1: FOSC.
pub type TWAI1_FUNC_CLK_SEL_R = crate::BitReader;
///Field `TWAI1_FUNC_CLK_SEL` writer - set this field to select clock-source. 0(default): XTAL, 1: FOSC.
pub type TWAI1_FUNC_CLK_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TWAI1_FUNC_CLK_EN` reader - Set 1 to enable twai1 function clock
pub type TWAI1_FUNC_CLK_EN_R = crate::BitReader;
///Field `TWAI1_FUNC_CLK_EN` writer - Set 1 to enable twai1 function clock
...
impl R {
    ...
    ///Bit 22 - Set 1 to enable twai1 function clock
    #[inline(always)]
...
///`read()` method returns [`twai1_func_clk_conf::R`](R) reader structure
impl crate::Readable for TWAI1_FUNC_CLK_CONF_SPEC {}
///`write(|w| ..)` method takes [`twai1_func_clk_conf::W`](W) writer structure
impl crate::Writable for TWAI1_FUNC_CLK_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TWAI1_FUNC_CLK_CONF to value 0x0040_0000
