...
pub type TWAI1_FUNC_CLK_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TWAI1_FUNC_CLK_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn twai1_func_clk_sel(&mut self) -> TWAI1_FUNC_CLK_SEL_W<TWAI1_FUNC_CLK_CONF_SPEC, 20> {
        TWAI1_FUNC_CLK_SEL_W::new(self)
    }
    #[doc = "Bit 22 - Set 1 to enable twai1 function clock"]
    #[inline(always)]
    #[must_use]
    pub fn twai1_func_clk_en(&mut self) -> TWAI1_FUNC_CLK_EN_W<TWAI1_FUNC_CLK_CONF_SPEC, 22> {
