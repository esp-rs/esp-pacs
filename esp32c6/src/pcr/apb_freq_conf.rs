...
///`read()` method returns [`apb_freq_conf::R`](R) reader structure
impl crate::Readable for APB_FREQ_CONF_SPEC {}
///`write(|w| ..)` method takes [`apb_freq_conf::W`](W) writer structure
