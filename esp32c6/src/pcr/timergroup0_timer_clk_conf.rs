...
pub struct R(crate::R<TIMERGROUP0_TIMER_CLK_CONF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMERGROUP0_TIMER_CLK_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMERGROUP0_TIMER_CLK_CONF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMERGROUP0_TIMER_CLK_CONF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMERGROUP0_TIMER_CLK_CONF` writer"]
pub struct W(crate::W<TIMERGROUP0_TIMER_CLK_CONF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMERGROUP0_TIMER_CLK_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMERGROUP0_TIMER_CLK_CONF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMERGROUP0_TIMER_CLK_CONF_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TG0_TIMER_CLK_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, TIMERGROUP0_TIMER_CLK_CONF_SPEC, 2, O>;
...
pub type TG0_TIMER_CLK_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, TIMERGROUP0_TIMER_CLK_CONF_SPEC, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMERGROUP0_TIMER_CLK_CONF")
            .field(
                "tg0_timer_clk_sel",
                &format_args!("{}", self.tg0_timer_clk_sel().bits()),
            )
            .field(
                "tg0_timer_clk_en",
                &format_args!("{}", self.tg0_timer_clk_en().bit()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<TIMERGROUP0_TIMER_CLK_CONF_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tg0_timer_clk_sel(&mut self) -> TG0_TIMER_CLK_SEL_W<20> {
        TG0_TIMER_CLK_SEL_W::new(self)
    }
    #[doc = "Bit 22 - Set 1 to enable timer_group0 timer clock"]
    #[inline(always)]
    #[must_use]
    pub fn tg0_timer_clk_en(&mut self) -> TG0_TIMER_CLK_EN_W<22> {
        TG0_TIMER_CLK_EN_W::new(self)
    }
