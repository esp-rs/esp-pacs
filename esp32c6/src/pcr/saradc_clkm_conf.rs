///Register `SARADC_CLKM_CONF` reader
pub type R = crate::R<SARADC_CLKM_CONF_SPEC>;
///Register `SARADC_CLKM_CONF` writer
pub type W = crate::W<SARADC_CLKM_CONF_SPEC>;
///Field `SARADC_CLKM_DIV_A` reader - The denominator of the frequency divider factor of the saradc function clock.
pub type SARADC_CLKM_DIV_A_R = crate::FieldReader;
///Field `SARADC_CLKM_DIV_A` writer - The denominator of the frequency divider factor of the saradc function clock.
pub type SARADC_CLKM_DIV_A_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `SARADC_CLKM_DIV_B` reader - The numerator of the frequency divider factor of the saradc function clock.
pub type SARADC_CLKM_DIV_B_R = crate::FieldReader;
///Field `SARADC_CLKM_DIV_B` writer - The numerator of the frequency divider factor of the saradc function clock.
pub type SARADC_CLKM_DIV_B_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `SARADC_CLKM_DIV_NUM` reader - The integral part of the frequency divider factor of the saradc function clock.
pub type SARADC_CLKM_DIV_NUM_R = crate::FieldReader;
///Field `SARADC_CLKM_DIV_NUM` writer - The integral part of the frequency divider factor of the saradc function clock.
pub type SARADC_CLKM_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SARADC_CLKM_SEL` reader - set this field to select clock-source. 0(default): XTAL, 1: 240MHz, 2: FOSC, 3: reserved.
pub type SARADC_CLKM_SEL_R = crate::FieldReader;
///Field `SARADC_CLKM_SEL` writer - set this field to select clock-source. 0(default): XTAL, 1: 240MHz, 2: FOSC, 3: reserved.
pub type SARADC_CLKM_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SARADC_CLKM_EN` reader - Set 1 to enable saradc function clock
pub type SARADC_CLKM_EN_R = crate::BitReader;
///Field `SARADC_CLKM_EN` writer - Set 1 to enable saradc function clock
pub type SARADC_CLKM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:5 - The denominator of the frequency divider factor of the saradc function clock.
    #[inline(always)]
    pub fn saradc_clkm_div_a(&self) -> SARADC_CLKM_DIV_A_R {
        SARADC_CLKM_DIV_A_R::new((self.bits & 0x3f) as u8)
    }
    ///Bits 6:11 - The numerator of the frequency divider factor of the saradc function clock.
    #[inline(always)]
    ...
    ///Bit 22 - Set 1 to enable saradc function clock
    #[inline(always)]
...
///`read()` method returns [`saradc_clkm_conf::R`](R) reader structure
impl crate::Readable for SARADC_CLKM_CONF_SPEC {}
///`write(|w| ..)` method takes [`saradc_clkm_conf::W`](W) writer structure
