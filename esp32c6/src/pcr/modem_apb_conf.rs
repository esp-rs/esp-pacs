///Register `MODEM_APB_CONF` reader
pub type R = crate::R<MODEM_APB_CONF_SPEC>;
///Register `MODEM_APB_CONF` writer
pub type W = crate::W<MODEM_APB_CONF_SPEC>;
///Field `MODEM_APB_CLK_EN` reader - This field indicates if modem_apb clock is enable. 0: disable, 1: enable(default).
pub type MODEM_APB_CLK_EN_R = crate::BitReader;
///Field `MODEM_APB_CLK_EN` writer - This field indicates if modem_apb clock is enable. 0: disable, 1: enable(default).
pub type MODEM_APB_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MODEM_RST_EN` reader - Set this file as 1 to reset modem-subsystem.
pub type MODEM_RST_EN_R = crate::BitReader;
///Field `MODEM_RST_EN` writer - Set this file as 1 to reset modem-subsystem.
pub type MODEM_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 0 - This field indicates if modem_apb clock is enable. 0: disable, 1: enable(default).
    #[inline(always)]
    pub fn modem_apb_clk_en(&self) -> MODEM_APB_CLK_EN_R {
        MODEM_APB_CLK_EN_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Set this file as 1 to reset modem-subsystem.
    #[inline(always)]
...
///`read()` method returns [`modem_apb_conf::R`](R) reader structure
impl crate::Readable for MODEM_APB_CONF_SPEC {}
///`write(|w| ..)` method takes [`modem_apb_conf::W`](W) writer structure
impl crate::Writable for MODEM_APB_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MODEM_APB_CONF to value 0x01
