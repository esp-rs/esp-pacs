///Register `I2S_RX_CLKM_CONF` reader
pub type R = crate::R<I2S_RX_CLKM_CONF_SPEC>;
///Register `I2S_RX_CLKM_CONF` writer
pub type W = crate::W<I2S_RX_CLKM_CONF_SPEC>;
///Field `I2S_RX_CLKM_DIV_NUM` reader - Integral I2S clock divider value
pub type I2S_RX_CLKM_DIV_NUM_R = crate::FieldReader;
///Field `I2S_RX_CLKM_DIV_NUM` writer - Integral I2S clock divider value
pub type I2S_RX_CLKM_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `I2S_RX_CLKM_SEL` reader - Select I2S Rx module source clock. 0: no clock. 1: APLL. 2: CLK160. 3: I2S_MCLK_in.
pub type I2S_RX_CLKM_SEL_R = crate::FieldReader;
///Field `I2S_RX_CLKM_SEL` writer - Select I2S Rx module source clock. 0: no clock. 1: APLL. 2: CLK160. 3: I2S_MCLK_in.
pub type I2S_RX_CLKM_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `I2S_RX_CLKM_EN` reader - Set 1 to enable i2s_rx function clock
pub type I2S_RX_CLKM_EN_R = crate::BitReader;
///Field `I2S_RX_CLKM_EN` writer - Set 1 to enable i2s_rx function clock
pub type I2S_RX_CLKM_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2S_MCLK_SEL` reader - This field is used to select master-clock. 0(default): clk_i2s_rx, 1: clk_i2s_tx
pub type I2S_MCLK_SEL_R = crate::BitReader;
///Field `I2S_MCLK_SEL` writer - This field is used to select master-clock. 0(default): clk_i2s_rx, 1: clk_i2s_tx
...
///`read()` method returns [`i2s_rx_clkm_conf::R`](R) reader structure
impl crate::Readable for I2S_RX_CLKM_CONF_SPEC {}
///`write(|w| ..)` method takes [`i2s_rx_clkm_conf::W`](W) writer structure
