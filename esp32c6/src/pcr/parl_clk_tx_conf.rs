...
pub type PARL_CLK_TX_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, PARL_CLK_TX_CONF_SPEC, 2, O>;
...
pub type PARL_CLK_TX_EN_W<'a, const O: u8> = crate::BitWriter<'a, PARL_CLK_TX_CONF_SPEC, O>;
...
pub type PARL_TX_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, PARL_CLK_TX_CONF_SPEC, O>;
impl R {
