...
pub type PCNT_RST_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcnt_clk_en(&mut self) -> PCNT_CLK_EN_W<PCNT_CONF_SPEC, 0> {
        PCNT_CLK_EN_W::new(self)
    }
    #[doc = "Bit 1 - Set 0 to reset pcnt module"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt_rst_en(&mut self) -> PCNT_RST_EN_W<PCNT_CONF_SPEC, 1> {
