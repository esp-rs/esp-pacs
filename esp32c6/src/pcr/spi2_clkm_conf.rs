///Register `SPI2_CLKM_CONF` reader
pub type R = crate::R<SPI2_CLKM_CONF_SPEC>;
///Register `SPI2_CLKM_CONF` writer
pub type W = crate::W<SPI2_CLKM_CONF_SPEC>;
///Field `SPI2_CLKM_SEL` reader - set this field to select clock-source. 0(default): XTAL, 1: 80MHz, 2: FOSC, 3: reserved.
pub type SPI2_CLKM_SEL_R = crate::FieldReader;
///Field `SPI2_CLKM_SEL` writer - set this field to select clock-source. 0(default): XTAL, 1: 80MHz, 2: FOSC, 3: reserved.
pub type SPI2_CLKM_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SPI2_CLKM_EN` reader - Set 1 to enable spi2 function clock
pub type SPI2_CLKM_EN_R = crate::BitReader;
///Field `SPI2_CLKM_EN` writer - Set 1 to enable spi2 function clock
...
impl R {
    ...
    ///Bit 22 - Set 1 to enable spi2 function clock
    #[inline(always)]
...
///`read()` method returns [`spi2_clkm_conf::R`](R) reader structure
impl crate::Readable for SPI2_CLKM_CONF_SPEC {}
///`write(|w| ..)` method takes [`spi2_clkm_conf::W`](W) writer structure
