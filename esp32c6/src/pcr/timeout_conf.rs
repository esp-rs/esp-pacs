///Register `TIMEOUT_CONF` reader
pub type R = crate::R<TIMEOUT_CONF_SPEC>;
///Register `TIMEOUT_CONF` writer
pub type W = crate::W<TIMEOUT_CONF_SPEC>;
///Field `CPU_TIMEOUT_RST_EN` reader - Set 0 to reset cpu_peri timeout module
pub type CPU_TIMEOUT_RST_EN_R = crate::BitReader;
///Field `CPU_TIMEOUT_RST_EN` writer - Set 0 to reset cpu_peri timeout module
pub type CPU_TIMEOUT_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `HP_TIMEOUT_RST_EN` reader - Set 0 to reset hp_peri timeout module and hp_modem timeout module
pub type HP_TIMEOUT_RST_EN_R = crate::BitReader;
///Field `HP_TIMEOUT_RST_EN` writer - Set 0 to reset hp_peri timeout module and hp_modem timeout module
pub type HP_TIMEOUT_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 1 - Set 0 to reset cpu_peri timeout module
    #[inline(always)]
    pub fn cpu_timeout_rst_en(&self) -> CPU_TIMEOUT_RST_EN_R {
        CPU_TIMEOUT_RST_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bit 2 - Set 0 to reset hp_peri timeout module and hp_modem timeout module
    #[inline(always)]
...
///`read()` method returns [`timeout_conf::R`](R) reader structure
impl crate::Readable for TIMEOUT_CONF_SPEC {}
///`write(|w| ..)` method takes [`timeout_conf::W`](W) writer structure
