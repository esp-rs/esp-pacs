...
pub type I2S_TX_CLKM_DIV_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, I2S_TX_CLKM_CONF_SPEC, 8, O>;
...
pub type I2S_TX_CLKM_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, I2S_TX_CLKM_CONF_SPEC, 2, O>;
...
pub type I2S_TX_CLKM_EN_W<'a, const O: u8> = crate::BitWriter<'a, I2S_TX_CLKM_CONF_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2s_tx_clkm_div_num(&mut self) -> I2S_TX_CLKM_DIV_NUM_W<12> {
        I2S_TX_CLKM_DIV_NUM_W::new(self)
    }
    #[doc = "Bits 20:21 - Select I2S Tx module source clock. 0: XTAL clock. 1: APLL. 2: CLK160. 3: I2S_MCLK_in."]
    #[inline(always)]
    #[must_use]
    pub fn i2s_tx_clkm_sel(&mut self) -> I2S_TX_CLKM_SEL_W<20> {
        I2S_TX_CLKM_SEL_W::new(self)
    }
    #[doc = "Bit 22 - Set 1 to enable i2s_tx function clock"]
    #[inline(always)]
    #[must_use]
    pub fn i2s_tx_clkm_en(&mut self) -> I2S_TX_CLKM_EN_W<22> {
