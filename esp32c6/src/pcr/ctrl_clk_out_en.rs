...
///`read()` method returns [`ctrl_clk_out_en::R`](R) reader structure
impl crate::Readable for CTRL_CLK_OUT_EN_SPEC {}
///`write(|w| ..)` method takes [`ctrl_clk_out_en::W`](W) writer structure
impl crate::Writable for CTRL_CLK_OUT_EN_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CTRL_CLK_OUT_EN to value 0x07ff
