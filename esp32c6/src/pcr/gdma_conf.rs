...
///Register `GDMA_CONF` writer
pub type W = crate::W<GDMA_CONF_SPEC>;
///Field `GDMA_CLK_EN` reader - Set 1 to enable gdma clock
pub type GDMA_CLK_EN_R = crate::BitReader;
///Field `GDMA_CLK_EN` writer - Set 1 to enable gdma clock
pub type GDMA_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GDMA_RST_EN` reader - Set 0 to reset gdma module
pub type GDMA_RST_EN_R = crate::BitReader;
///Field `GDMA_RST_EN` writer - Set 0 to reset gdma module
...
///`read()` method returns [`gdma_conf::R`](R) reader structure
impl crate::Readable for GDMA_CONF_SPEC {}
///`write(|w| ..)` method takes [`gdma_conf::W`](W) writer structure
