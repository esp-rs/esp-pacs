...
pub type REGDMA_CLK_EN_R = crate::BitReader<bool>;
#[doc = "Field `REGDMA_CLK_EN` writer - Set 1 to enable regdma clock"]
pub type REGDMA_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, REGDMA_CONF_SPEC, bool, O>;
#[doc = "Field `REGDMA_RST_EN` reader - Set 0 to reset regdma module"]
pub type REGDMA_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `REGDMA_RST_EN` writer - Set 0 to reset regdma module"]
pub type REGDMA_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, REGDMA_CONF_SPEC, bool, O>;
impl R {
