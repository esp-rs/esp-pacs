///Register `SARADC_CONF` reader
pub type R = crate::R<SARADC_CONF_SPEC>;
///Register `SARADC_CONF` writer
pub type W = crate::W<SARADC_CONF_SPEC>;
///Field `SARADC_CLK_EN` reader - no use
pub type SARADC_CLK_EN_R = crate::BitReader;
///Field `SARADC_CLK_EN` writer - no use
pub type SARADC_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_RST_EN` reader - Set 0 to reset function_register of saradc module
pub type SARADC_RST_EN_R = crate::BitReader;
///Field `SARADC_RST_EN` writer - Set 0 to reset function_register of saradc module
pub type SARADC_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_REG_CLK_EN` reader - Set 1 to enable saradc apb clock
pub type SARADC_REG_CLK_EN_R = crate::BitReader;
///Field `SARADC_REG_CLK_EN` writer - Set 1 to enable saradc apb clock
pub type SARADC_REG_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_REG_RST_EN` reader - Set 0 to reset apb_register of saradc module
pub type SARADC_REG_RST_EN_R = crate::BitReader;
///Field `SARADC_REG_RST_EN` writer - Set 0 to reset apb_register of saradc module
...
///`read()` method returns [`saradc_conf::R`](R) reader structure
impl crate::Readable for SARADC_CONF_SPEC {}
///`write(|w| ..)` method takes [`saradc_conf::W`](W) writer structure
