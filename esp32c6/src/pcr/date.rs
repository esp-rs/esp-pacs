...
///Field `DATE` reader - PCR version information.
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - PCR version information.
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - PCR version information.
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x0220_6150
