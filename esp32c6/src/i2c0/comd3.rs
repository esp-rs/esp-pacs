...
pub type COMMAND3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMD3_SPEC, u16, u16, 14, O>;
...
pub type COMMAND3_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMD3_SPEC, bool, O>;
impl R {
