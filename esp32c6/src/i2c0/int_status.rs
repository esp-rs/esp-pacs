...
pub type GENERAL_CALL_INT_ST_R = crate::BitReader<bool>;
#[doc = "Field `SLAVE_ADDR_UNMATCH_INT_ST` reader - The masked interrupt status bit for I2C_SLAVE_ADDR_UNMATCH_INT interrupt."]
pub type SLAVE_ADDR_UNMATCH_INT_ST_R = crate::BitReader<bool>;
impl R {
    ...
    #[doc = "Bit 18 - The masked interrupt status bit for I2C_SLAVE_ADDR_UNMATCH_INT interrupt."]
    #[inline(always)]
