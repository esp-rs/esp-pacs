...
pub type COMMAND0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMD0_SPEC, u16, u16, 14, O>;
...
pub type COMMAND0_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMD0_SPEC, bool, O>;
impl R {
