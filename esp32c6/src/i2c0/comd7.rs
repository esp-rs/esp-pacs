...
pub type COMMAND7_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMD7_SPEC, u16, u16, 14, O>;
...
pub type COMMAND7_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMD7_SPEC, bool, O>;
impl R {
