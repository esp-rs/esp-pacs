...
pub type COMMAND2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMD2_SPEC, u16, u16, 14, O>;
...
pub type COMMAND2_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMD2_SPEC, bool, O>;
impl R {
