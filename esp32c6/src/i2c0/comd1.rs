...
pub type COMMAND1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMD1_SPEC, u16, u16, 14, O>;
...
pub type COMMAND1_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMD1_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn command1_done(&mut self) -> COMMAND1_DONE_W<31> {
