...
#[doc = "Field `GENERAL_CALL` reader - The raw interrupt bit for I2C_GENARAL_CALL_INT interrupt."]
pub type GENERAL_CALL_R = crate::BitReader;
#[doc = "Field `SLAVE_ADDR_UNMATCH` reader - The raw interrupt bit for I2C_SLAVE_ADDR_UNMATCH_INT_RAW interrupt."]
...
impl R {
    ...
    #[doc = "Bit 17 - The raw interrupt bit for I2C_GENARAL_CALL_INT interrupt."]
    #[inline(always)]
    pub fn general_call(&self) -> GENERAL_CALL_R {
        GENERAL_CALL_R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - The raw interrupt bit for I2C_SLAVE_ADDR_UNMATCH_INT_RAW interrupt."]
    #[inline(always)]
