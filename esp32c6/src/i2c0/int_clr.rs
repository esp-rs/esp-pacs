...
///Field `SLAVE_STRETCH` writer - Set this bit to clear I2C_SLAVE_STRETCH_INT interrupt.
pub type SLAVE_STRETCH_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `GENERAL_CALL` writer - Set this bit to clear I2C_GENARAL_CALL_INT interrupt.
pub type GENERAL_CALL_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `SLAVE_ADDR_UNMATCH` writer - Set this bit to clear I2C_SLAVE_ADDR_UNMATCH_INT_RAW interrupt.
...
impl W {
    ...
    ///Bit 17 - Set this bit to clear I2C_GENARAL_CALL_INT interrupt.
    #[inline(always)]
    #[must_use]
    pub fn general_call(&mut self) -> GENERAL_CALL_W<INT_CLR_SPEC> {
        GENERAL_CALL_W::new(self, 17)
    }
    ///Bit 18 - Set this bit to clear I2C_SLAVE_ADDR_UNMATCH_INT_RAW interrupt.
    #[inline(always)]
    #[must_use]
