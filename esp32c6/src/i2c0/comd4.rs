...
pub type COMMAND4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMD4_SPEC, u16, u16, 14, O>;
...
pub type COMMAND4_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMD4_SPEC, bool, O>;
impl R {
