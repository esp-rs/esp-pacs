...
pub type COMMAND5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMD5_SPEC, u16, u16, 14, O>;
...
pub type COMMAND5_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMD5_SPEC, bool, O>;
impl R {
