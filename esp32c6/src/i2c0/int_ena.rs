...
///Field `SLAVE_STRETCH` reader - The interrupt enable bit for I2C_SLAVE_STRETCH_INT interrupt.
pub type SLAVE_STRETCH_R = crate::BitReader;
///Field `SLAVE_STRETCH` writer - The interrupt enable bit for I2C_SLAVE_STRETCH_INT interrupt.
pub type SLAVE_STRETCH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `GENERAL_CALL` reader - The interrupt enable bit for I2C_GENARAL_CALL_INT interrupt.
pub type GENERAL_CALL_R = crate::BitReader;
///Field `GENERAL_CALL` writer - The interrupt enable bit for I2C_GENARAL_CALL_INT interrupt.
pub type GENERAL_CALL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLAVE_ADDR_UNMATCH` reader - The interrupt enable bit for I2C_SLAVE_ADDR_UNMATCH_INT interrupt.
pub type SLAVE_ADDR_UNMATCH_R = crate::BitReader;
///Field `SLAVE_ADDR_UNMATCH` writer - The interrupt enable bit for I2C_SLAVE_ADDR_UNMATCH_INT interrupt.
