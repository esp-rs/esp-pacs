...
pub type COMMAND6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMD6_SPEC, u16, u16, 14, O>;
...
pub type COMMAND6_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMD6_SPEC, bool, O>;
impl R {
