...
///Field `TEXT_OUT` reader - This bits stores text_out_0 that is a part of result text material.
pub type TEXT_OUT_R = crate::FieldReader<u32>;
///Field `TEXT_OUT` writer - This bits stores text_out_0 that is a part of result text material.
pub type TEXT_OUT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This bits stores text_out_0 that is a part of result text material.
    #[inline(always)]
...
/**result text material text_out_%s configure register
