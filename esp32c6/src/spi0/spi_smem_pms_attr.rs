...
pub type SPI_SMEM_PMS_ECC_R = crate::BitReader<bool>;
...
pub type SPI_SMEM_PMS_ECC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SMEM_PMS_ATTR_SPEC, bool, O>;
impl R {
