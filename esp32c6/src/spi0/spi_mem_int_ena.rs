...
pub type SPI_MEM_ECC_ERR_INT_ENA_R = crate::BitReader<bool>;
#[doc = "Field `SPI_MEM_PMS_REJECT_INT_ENA` reader - The enable bit for SPI_MEM_PMS_REJECT_INT interrupt."]
pub type SPI_MEM_PMS_REJECT_INT_ENA_R = crate::BitReader<bool>;
...
pub type SPI_MEM_AXI_RADDR_ERR_INT_ENA_R = crate::BitReader<bool>;
...
pub type SPI_MEM_AXI_WR_FLASH_ERR_INT_ENA_R = crate::BitReader<bool>;
#[doc = "Field `SPI_MEM_AXI_WADDR_ERR_INT__ENA` reader - The enable bit for SPI_MEM_AXI_WADDR_ERR_INT interrupt."]
pub type SPI_MEM_AXI_WADDR_ERR_INT__ENA_R = crate::BitReader<bool>;
impl R {
