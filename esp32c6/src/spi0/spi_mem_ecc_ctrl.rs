...
pub type SPI_FMEM_ECC_ERR_INT_NUM_R = crate::FieldReader<u8, u8>;
...
pub type SPI_FMEM_PAGE_SIZE_R = crate::FieldReader<u8, u8>;
...
pub type SPI_MEM_ECC_CONTINUE_RECORD_ERR_EN_R = crate::BitReader<bool>;
...
pub type SPI_MEM_ECC_ERR_BITS_R = crate::FieldReader<u8, u8>;
impl R {
