...
pub type SPI_MEM_WDUMMY_ALWAYS_OUT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SPI_MEM_DATA_IE_ALWAYS_ON_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    pub fn spi_mem_wdummy_always_out(
        &mut self,
    ) -> SPI_MEM_WDUMMY_ALWAYS_OUT_W<SPI_MEM_CTRL_SPEC, 1> {
    ...
    pub fn spi_mem_data_ie_always_on(
        &mut self,
    ) -> SPI_MEM_DATA_IE_ALWAYS_ON_W<SPI_MEM_CTRL_SPEC, 31> {
