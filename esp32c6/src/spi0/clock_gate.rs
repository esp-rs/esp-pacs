...
///Field `SPI_CLK_EN` reader - Register clock gate enable signal. 1: Enable. 0: Disable.
pub type SPI_CLK_EN_R = crate::BitReader;
///Field `SPI_CLK_EN` writer - Register clock gate enable signal. 1: Enable. 0: Disable.
