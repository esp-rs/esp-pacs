...
pub type SPI_MEM_USR_COMMAND_VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, SPI_MEM_USER2_SPEC, 16, O, u16>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_command_value(&mut self) -> SPI_MEM_USR_COMMAND_VALUE_W<0> {
        SPI_MEM_USR_COMMAND_VALUE_W::new(self)
    }
    #[doc = "Bits 28:31 - The length in bits of command phase. The register value shall be (bit_num-1)"]
    #[inline(always)]
    #[must_use]
    pub fn spi_mem_usr_command_bitlen(&mut self) -> SPI_MEM_USR_COMMAND_BITLEN_W<28> {
