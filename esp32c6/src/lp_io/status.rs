...
pub type LP_GPIO_STATUS_INTERRUPT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio_status_interrupt(&mut self) -> LP_GPIO_STATUS_INTERRUPT_W<STATUS_SPEC, 0> {
