...
pub type LP_GPIO2_SYNC_BYPASS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type LP_GPIO2_PAD_DRIVER_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_GPIO2_EDGE_WAKEUP_CLR` writer - need des"]
pub type LP_GPIO2_EDGE_WAKEUP_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO2_INT_TYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type LP_GPIO2_WAKEUP_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO2_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_sync_bypass(&mut self) -> LP_GPIO2_SYNC_BYPASS_W<PIN2_SPEC> {
        LP_GPIO2_SYNC_BYPASS_W::new(self, 0)
    }
    #[doc = "Bit 2 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_pad_driver(&mut self) -> LP_GPIO2_PAD_DRIVER_W<PIN2_SPEC> {
        LP_GPIO2_PAD_DRIVER_W::new(self, 2)
    }
    #[doc = "Bit 3 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_edge_wakeup_clr(&mut self) -> LP_GPIO2_EDGE_WAKEUP_CLR_W<PIN2_SPEC> {
        LP_GPIO2_EDGE_WAKEUP_CLR_W::new(self, 3)
    }
    #[doc = "Bits 7:9 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_int_type(&mut self) -> LP_GPIO2_INT_TYPE_W<PIN2_SPEC> {
        LP_GPIO2_INT_TYPE_W::new(self, 7)
    }
    #[doc = "Bit 10 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_wakeup_enable(&mut self) -> LP_GPIO2_WAKEUP_ENABLE_W<PIN2_SPEC> {
        LP_GPIO2_WAKEUP_ENABLE_W::new(self, 10)
    }
    #[doc = "Bit 11 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_filter_en(&mut self) -> LP_GPIO2_FILTER_EN_W<PIN2_SPEC> {
        LP_GPIO2_FILTER_EN_W::new(self, 11)
    }
