...
pub type LP_GPIO2_SYNC_BYPASS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LP_GPIO2_SYNC_BYPASS` writer - need des"]
pub type LP_GPIO2_SYNC_BYPASS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PIN2_SPEC, u8, u8, 2, O>;
#[doc = "Field `LP_GPIO2_PAD_DRIVER` reader - need des"]
pub type LP_GPIO2_PAD_DRIVER_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO2_PAD_DRIVER` writer - need des"]
pub type LP_GPIO2_PAD_DRIVER_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIN2_SPEC, bool, O>;
#[doc = "Field `LP_GPIO2_EDGE_WAKEUP_CLR` writer - need des"]
pub type LP_GPIO2_EDGE_WAKEUP_CLR_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PIN2_SPEC, bool, O>;
#[doc = "Field `LP_GPIO2_INT_TYPE` reader - need des"]
pub type LP_GPIO2_INT_TYPE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LP_GPIO2_INT_TYPE` writer - need des"]
pub type LP_GPIO2_INT_TYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PIN2_SPEC, u8, u8, 3, O>;
#[doc = "Field `LP_GPIO2_WAKEUP_ENABLE` reader - need des"]
pub type LP_GPIO2_WAKEUP_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO2_WAKEUP_ENABLE` writer - need des"]
pub type LP_GPIO2_WAKEUP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIN2_SPEC, bool, O>;
#[doc = "Field `LP_GPIO2_FILTER_EN` reader - need des"]
pub type LP_GPIO2_FILTER_EN_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO2_FILTER_EN` writer - need des"]
pub type LP_GPIO2_FILTER_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIN2_SPEC, bool, O>;
impl R {
