...
pub type LP_GPIO6_SYNC_BYPASS_R = crate::FieldReader;
#[doc = "Field `LP_GPIO6_SYNC_BYPASS` writer - need des"]
pub type LP_GPIO6_SYNC_BYPASS_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `LP_GPIO6_PAD_DRIVER` reader - need des"]
pub type LP_GPIO6_PAD_DRIVER_R = crate::BitReader;
#[doc = "Field `LP_GPIO6_PAD_DRIVER` writer - need des"]
pub type LP_GPIO6_PAD_DRIVER_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_GPIO6_EDGE_WAKEUP_CLR` writer - need des"]
pub type LP_GPIO6_EDGE_WAKEUP_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_GPIO6_INT_TYPE` reader - need des"]
pub type LP_GPIO6_INT_TYPE_R = crate::FieldReader;
#[doc = "Field `LP_GPIO6_INT_TYPE` writer - need des"]
pub type LP_GPIO6_INT_TYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `LP_GPIO6_WAKEUP_ENABLE` reader - need des"]
pub type LP_GPIO6_WAKEUP_ENABLE_R = crate::BitReader;
#[doc = "Field `LP_GPIO6_WAKEUP_ENABLE` writer - need des"]
pub type LP_GPIO6_WAKEUP_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_GPIO6_FILTER_EN` reader - need des"]
pub type LP_GPIO6_FILTER_EN_R = crate::BitReader;
#[doc = "Field `LP_GPIO6_FILTER_EN` writer - need des"]
pub type LP_GPIO6_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio6_sync_bypass(&mut self) -> LP_GPIO6_SYNC_BYPASS_W<PIN6_SPEC> {
        LP_GPIO6_SYNC_BYPASS_W::new(self, 0)
    }
    #[doc = "Bit 2 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio6_pad_driver(&mut self) -> LP_GPIO6_PAD_DRIVER_W<PIN6_SPEC> {
        LP_GPIO6_PAD_DRIVER_W::new(self, 2)
    }
    #[doc = "Bit 3 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio6_edge_wakeup_clr(&mut self) -> LP_GPIO6_EDGE_WAKEUP_CLR_W<PIN6_SPEC> {
        LP_GPIO6_EDGE_WAKEUP_CLR_W::new(self, 3)
    }
    #[doc = "Bits 7:9 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio6_int_type(&mut self) -> LP_GPIO6_INT_TYPE_W<PIN6_SPEC> {
        LP_GPIO6_INT_TYPE_W::new(self, 7)
    }
    #[doc = "Bit 10 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio6_wakeup_enable(&mut self) -> LP_GPIO6_WAKEUP_ENABLE_W<PIN6_SPEC> {
        LP_GPIO6_WAKEUP_ENABLE_W::new(self, 10)
    }
    #[doc = "Bit 11 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio6_filter_en(&mut self) -> LP_GPIO6_FILTER_EN_W<PIN6_SPEC> {
        LP_GPIO6_FILTER_EN_W::new(self, 11)
    }
