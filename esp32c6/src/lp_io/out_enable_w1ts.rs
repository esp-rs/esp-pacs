///Register `OUT_ENABLE_W1TS` writer
pub type W = crate::W<OUT_ENABLE_W1TS_SPEC>;
///Field `ENABLE_W1TS` writer - set one time output data
...
///`write(|w| ..)` method takes [`out_enable_w1ts::W`](W) writer structure
impl crate::Writable for OUT_ENABLE_W1TS_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OUT_ENABLE_W1TS to value 0
