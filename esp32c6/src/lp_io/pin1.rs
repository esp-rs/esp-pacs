...
pub type LP_GPIO1_SYNC_BYPASS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type LP_GPIO1_PAD_DRIVER_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `LP_GPIO1_EDGE_WAKEUP_CLR` writer - need des"]
pub type LP_GPIO1_EDGE_WAKEUP_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO1_INT_TYPE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type LP_GPIO1_WAKEUP_ENABLE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO1_FILTER_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio1_sync_bypass(&mut self) -> LP_GPIO1_SYNC_BYPASS_W<PIN1_SPEC, 0> {
        LP_GPIO1_SYNC_BYPASS_W::new(self)
    }
    #[doc = "Bit 2 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio1_pad_driver(&mut self) -> LP_GPIO1_PAD_DRIVER_W<PIN1_SPEC, 2> {
        LP_GPIO1_PAD_DRIVER_W::new(self)
    }
    #[doc = "Bit 3 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio1_edge_wakeup_clr(&mut self) -> LP_GPIO1_EDGE_WAKEUP_CLR_W<PIN1_SPEC, 3> {
        LP_GPIO1_EDGE_WAKEUP_CLR_W::new(self)
    }
    #[doc = "Bits 7:9 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio1_int_type(&mut self) -> LP_GPIO1_INT_TYPE_W<PIN1_SPEC, 7> {
        LP_GPIO1_INT_TYPE_W::new(self)
    }
    #[doc = "Bit 10 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio1_wakeup_enable(&mut self) -> LP_GPIO1_WAKEUP_ENABLE_W<PIN1_SPEC, 10> {
        LP_GPIO1_WAKEUP_ENABLE_W::new(self)
    }
    #[doc = "Bit 11 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio1_filter_en(&mut self) -> LP_GPIO1_FILTER_EN_W<PIN1_SPEC, 11> {
