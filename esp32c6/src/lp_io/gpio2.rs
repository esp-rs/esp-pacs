...
pub type LP_GPIO2_MCU_OE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO2_SLP_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO2_MCU_WPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO2_MCU_WPU_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO2_MCU_IE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO2_MCU_DRV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type LP_GPIO2_FUN_WPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO2_FUN_WPU_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO2_FUN_IE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LP_GPIO2_FUN_DRV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type LP_GPIO2_MCU_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
impl R {
    #[doc = "Bit 0 - need des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_mcu_oe(&mut self) -> LP_GPIO2_MCU_OE_W<GPIO2_SPEC, 0> {
        LP_GPIO2_MCU_OE_W::new(self)
    }
    #[doc = "Bit 1 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_slp_sel(&mut self) -> LP_GPIO2_SLP_SEL_W<GPIO2_SPEC, 1> {
        LP_GPIO2_SLP_SEL_W::new(self)
    }
    #[doc = "Bit 2 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_mcu_wpd(&mut self) -> LP_GPIO2_MCU_WPD_W<GPIO2_SPEC, 2> {
        LP_GPIO2_MCU_WPD_W::new(self)
    }
    #[doc = "Bit 3 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_mcu_wpu(&mut self) -> LP_GPIO2_MCU_WPU_W<GPIO2_SPEC, 3> {
        LP_GPIO2_MCU_WPU_W::new(self)
    }
    #[doc = "Bit 4 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_mcu_ie(&mut self) -> LP_GPIO2_MCU_IE_W<GPIO2_SPEC, 4> {
        LP_GPIO2_MCU_IE_W::new(self)
    }
    #[doc = "Bits 5:6 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_mcu_drv(&mut self) -> LP_GPIO2_MCU_DRV_W<GPIO2_SPEC, 5> {
        LP_GPIO2_MCU_DRV_W::new(self)
    }
    #[doc = "Bit 7 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_fun_wpd(&mut self) -> LP_GPIO2_FUN_WPD_W<GPIO2_SPEC, 7> {
        LP_GPIO2_FUN_WPD_W::new(self)
    }
    #[doc = "Bit 8 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_fun_wpu(&mut self) -> LP_GPIO2_FUN_WPU_W<GPIO2_SPEC, 8> {
        LP_GPIO2_FUN_WPU_W::new(self)
    }
    #[doc = "Bit 9 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_fun_ie(&mut self) -> LP_GPIO2_FUN_IE_W<GPIO2_SPEC, 9> {
        LP_GPIO2_FUN_IE_W::new(self)
    }
    #[doc = "Bits 10:11 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_fun_drv(&mut self) -> LP_GPIO2_FUN_DRV_W<GPIO2_SPEC, 10> {
        LP_GPIO2_FUN_DRV_W::new(self)
    }
    #[doc = "Bits 12:14 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio2_mcu_sel(&mut self) -> LP_GPIO2_MCU_SEL_W<GPIO2_SPEC, 12> {
