...
pub struct W(crate::W<OUT_DATA_W1TS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OUT_DATA_W1TS_SPEC>;
    #[inline(always)]
...
impl From<crate::W<OUT_DATA_W1TS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OUT_DATA_W1TS_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `LP_GPIO_OUT_DATA_W1TS` writer - set one time output data"]
pub type LP_GPIO_OUT_DATA_W1TS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OUT_DATA_W1TS_SPEC, u8, u8, 8, O>;
impl W {
    #[doc = "Bits 0:7 - set one time output data"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio_out_data_w1ts(&mut self) -> LP_GPIO_OUT_DATA_W1TS_W<0> {
...
#[doc = "need des\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [out_data_w1ts](index.html) module"]
