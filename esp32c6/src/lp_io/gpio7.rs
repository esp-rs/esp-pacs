...
pub type LP_GPIO7_MCU_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO7_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO7_MCU_WPD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO7_MCU_WPU_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO7_MCU_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO7_MCU_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type LP_GPIO7_FUN_WPD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO7_FUN_WPU_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO7_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type LP_GPIO7_FUN_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type LP_GPIO7_MCU_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bit 0 - need des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_oe(&mut self) -> LP_GPIO7_MCU_OE_W<GPIO7_SPEC> {
        LP_GPIO7_MCU_OE_W::new(self, 0)
    }
    #[doc = "Bit 1 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_slp_sel(&mut self) -> LP_GPIO7_SLP_SEL_W<GPIO7_SPEC> {
        LP_GPIO7_SLP_SEL_W::new(self, 1)
    }
    #[doc = "Bit 2 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_wpd(&mut self) -> LP_GPIO7_MCU_WPD_W<GPIO7_SPEC> {
        LP_GPIO7_MCU_WPD_W::new(self, 2)
    }
    #[doc = "Bit 3 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_wpu(&mut self) -> LP_GPIO7_MCU_WPU_W<GPIO7_SPEC> {
        LP_GPIO7_MCU_WPU_W::new(self, 3)
    }
    #[doc = "Bit 4 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_ie(&mut self) -> LP_GPIO7_MCU_IE_W<GPIO7_SPEC> {
        LP_GPIO7_MCU_IE_W::new(self, 4)
    }
    #[doc = "Bits 5:6 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_drv(&mut self) -> LP_GPIO7_MCU_DRV_W<GPIO7_SPEC> {
        LP_GPIO7_MCU_DRV_W::new(self, 5)
    }
    #[doc = "Bit 7 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_fun_wpd(&mut self) -> LP_GPIO7_FUN_WPD_W<GPIO7_SPEC> {
        LP_GPIO7_FUN_WPD_W::new(self, 7)
    }
    #[doc = "Bit 8 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_fun_wpu(&mut self) -> LP_GPIO7_FUN_WPU_W<GPIO7_SPEC> {
        LP_GPIO7_FUN_WPU_W::new(self, 8)
    }
    #[doc = "Bit 9 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_fun_ie(&mut self) -> LP_GPIO7_FUN_IE_W<GPIO7_SPEC> {
        LP_GPIO7_FUN_IE_W::new(self, 9)
    }
    #[doc = "Bits 10:11 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_fun_drv(&mut self) -> LP_GPIO7_FUN_DRV_W<GPIO7_SPEC> {
        LP_GPIO7_FUN_DRV_W::new(self, 10)
    }
    #[doc = "Bits 12:14 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_sel(&mut self) -> LP_GPIO7_MCU_SEL_W<GPIO7_SPEC> {
        LP_GPIO7_MCU_SEL_W::new(self, 12)
    }
