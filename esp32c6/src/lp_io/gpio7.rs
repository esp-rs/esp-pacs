...
pub struct R(crate::R<GPIO7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO7` writer"]
pub struct W(crate::W<GPIO7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIO7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO7_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `LP_GPIO7_MCU_OE` reader - need des"]
pub type LP_GPIO7_MCU_OE_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO7_MCU_OE` writer - need des"]
pub type LP_GPIO7_MCU_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO7_SPEC, bool, O>;
#[doc = "Field `LP_GPIO7_SLP_SEL` reader - need des"]
pub type LP_GPIO7_SLP_SEL_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO7_SLP_SEL` writer - need des"]
pub type LP_GPIO7_SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO7_SPEC, bool, O>;
#[doc = "Field `LP_GPIO7_MCU_WPD` reader - need des"]
pub type LP_GPIO7_MCU_WPD_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO7_MCU_WPD` writer - need des"]
pub type LP_GPIO7_MCU_WPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO7_SPEC, bool, O>;
#[doc = "Field `LP_GPIO7_MCU_WPU` reader - need des"]
pub type LP_GPIO7_MCU_WPU_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO7_MCU_WPU` writer - need des"]
pub type LP_GPIO7_MCU_WPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO7_SPEC, bool, O>;
#[doc = "Field `LP_GPIO7_MCU_IE` reader - need des"]
pub type LP_GPIO7_MCU_IE_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO7_MCU_IE` writer - need des"]
pub type LP_GPIO7_MCU_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO7_SPEC, bool, O>;
#[doc = "Field `LP_GPIO7_MCU_DRV` reader - need des"]
pub type LP_GPIO7_MCU_DRV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LP_GPIO7_MCU_DRV` writer - need des"]
pub type LP_GPIO7_MCU_DRV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO7_SPEC, u8, u8, 2, O>;
#[doc = "Field `LP_GPIO7_FUN_WPD` reader - need des"]
pub type LP_GPIO7_FUN_WPD_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO7_FUN_WPD` writer - need des"]
pub type LP_GPIO7_FUN_WPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO7_SPEC, bool, O>;
#[doc = "Field `LP_GPIO7_FUN_WPU` reader - need des"]
pub type LP_GPIO7_FUN_WPU_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO7_FUN_WPU` writer - need des"]
pub type LP_GPIO7_FUN_WPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO7_SPEC, bool, O>;
#[doc = "Field `LP_GPIO7_FUN_IE` reader - need des"]
pub type LP_GPIO7_FUN_IE_R = crate::BitReader<bool>;
#[doc = "Field `LP_GPIO7_FUN_IE` writer - need des"]
pub type LP_GPIO7_FUN_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO7_SPEC, bool, O>;
#[doc = "Field `LP_GPIO7_FUN_DRV` reader - need des"]
pub type LP_GPIO7_FUN_DRV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LP_GPIO7_FUN_DRV` writer - need des"]
pub type LP_GPIO7_FUN_DRV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO7_SPEC, u8, u8, 2, O>;
#[doc = "Field `LP_GPIO7_MCU_SEL` reader - need des"]
pub type LP_GPIO7_MCU_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LP_GPIO7_MCU_SEL` writer - need des"]
pub type LP_GPIO7_MCU_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIO7_SPEC, u8, u8, 3, O>;
impl R {
    #[doc = "Bit 0 - need des"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_oe(&mut self) -> LP_GPIO7_MCU_OE_W<0> {
        LP_GPIO7_MCU_OE_W::new(self)
    }
    #[doc = "Bit 1 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_slp_sel(&mut self) -> LP_GPIO7_SLP_SEL_W<1> {
        LP_GPIO7_SLP_SEL_W::new(self)
    }
    #[doc = "Bit 2 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_wpd(&mut self) -> LP_GPIO7_MCU_WPD_W<2> {
        LP_GPIO7_MCU_WPD_W::new(self)
    }
    #[doc = "Bit 3 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_wpu(&mut self) -> LP_GPIO7_MCU_WPU_W<3> {
        LP_GPIO7_MCU_WPU_W::new(self)
    }
    #[doc = "Bit 4 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_ie(&mut self) -> LP_GPIO7_MCU_IE_W<4> {
        LP_GPIO7_MCU_IE_W::new(self)
    }
    #[doc = "Bits 5:6 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_drv(&mut self) -> LP_GPIO7_MCU_DRV_W<5> {
        LP_GPIO7_MCU_DRV_W::new(self)
    }
    #[doc = "Bit 7 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_fun_wpd(&mut self) -> LP_GPIO7_FUN_WPD_W<7> {
        LP_GPIO7_FUN_WPD_W::new(self)
    }
    #[doc = "Bit 8 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_fun_wpu(&mut self) -> LP_GPIO7_FUN_WPU_W<8> {
        LP_GPIO7_FUN_WPU_W::new(self)
    }
    #[doc = "Bit 9 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_fun_ie(&mut self) -> LP_GPIO7_FUN_IE_W<9> {
        LP_GPIO7_FUN_IE_W::new(self)
    }
    #[doc = "Bits 10:11 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_fun_drv(&mut self) -> LP_GPIO7_FUN_DRV_W<10> {
        LP_GPIO7_FUN_DRV_W::new(self)
    }
    #[doc = "Bits 12:14 - need des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio7_mcu_sel(&mut self) -> LP_GPIO7_MCU_SEL_W<12> {
...
#[doc = "need des\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio7](index.html) module"]
