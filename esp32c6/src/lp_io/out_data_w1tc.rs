///Register `OUT_DATA_W1TC` writer
pub type W = crate::W<OUT_DATA_W1TC_SPEC>;
///Field `OUT_DATA_W1TC` writer - clear one time output data
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn out_data_w1tc(&mut self) -> OUT_DATA_W1TC_W<OUT_DATA_W1TC_SPEC> {
...
///`write(|w| ..)` method takes [`out_data_w1tc::W`](W) writer structure
impl crate::Writable for OUT_DATA_W1TC_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets OUT_DATA_W1TC to value 0
