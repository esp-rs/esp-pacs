...
pub type LP_GPIO_ENABLE_W1TC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio_enable_w1tc(&mut self) -> LP_GPIO_ENABLE_W1TC_W<OUT_ENABLE_W1TC_SPEC, 0> {
