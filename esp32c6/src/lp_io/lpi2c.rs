...
pub type LP_I2C_SDA_IE_R = crate::BitReader<bool>;
#[doc = "Field `LP_I2C_SDA_IE` writer - need des"]
pub type LP_I2C_SDA_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPI2C_SPEC, bool, O>;
#[doc = "Field `LP_I2C_SCL_IE` reader - need des"]
pub type LP_I2C_SCL_IE_R = crate::BitReader<bool>;
#[doc = "Field `LP_I2C_SCL_IE` writer - need des"]
pub type LP_I2C_SCL_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPI2C_SPEC, bool, O>;
impl R {
    #[doc = "Bit 30 - need des"]
    #[inline(always)]
