...
pub type LP_GPIO_STATUS_W1TC_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_gpio_status_w1tc(&mut self) -> LP_GPIO_STATUS_W1TC_W<STATUS_W1TC_SPEC> {
        LP_GPIO_STATUS_W1TC_W::new(self, 0)
    }
