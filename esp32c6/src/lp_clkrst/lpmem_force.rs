///Register `LPMEM_FORCE` reader
pub type R = crate::R<LPMEM_FORCE_SPEC>;
///Register `LPMEM_FORCE` writer
pub type W = crate::W<LPMEM_FORCE_SPEC>;
///Field `LPMEM_CLK_FORCE_ON` reader - need_des
pub type LPMEM_CLK_FORCE_ON_R = crate::BitReader;
///Field `LPMEM_CLK_FORCE_ON` writer - need_des
...
///`read()` method returns [`lpmem_force::R`](R) reader structure
impl crate::Readable for LPMEM_FORCE_SPEC {}
///`write(|w| ..)` method takes [`lpmem_force::W`](W) writer structure
