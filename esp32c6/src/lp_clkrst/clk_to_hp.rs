...
///`read()` method returns [`clk_to_hp::R`](R) reader structure
impl crate::Readable for CLK_TO_HP_SPEC {}
///`write(|w| ..)` method takes [`clk_to_hp::W`](W) writer structure
