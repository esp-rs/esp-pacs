///Register `LP_CLK_EN` reader
pub type R = crate::R<LP_CLK_EN_SPEC>;
///Register `LP_CLK_EN` writer
pub type W = crate::W<LP_CLK_EN_SPEC>;
///Field `FAST_ORI_GATE` reader - need_des
pub type FAST_ORI_GATE_R = crate::BitReader;
///Field `FAST_ORI_GATE` writer - need_des
...
///`read()` method returns [`lp_clk_en::R`](R) reader structure
impl crate::Readable for LP_CLK_EN_SPEC {}
///`write(|w| ..)` method takes [`lp_clk_en::W`](W) writer structure
