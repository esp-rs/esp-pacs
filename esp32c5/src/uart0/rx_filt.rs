...
#[doc = "Field `GLITCH_FILT` reader - Configures the width of a pulse to be filtered.\\\\Measurement unit: UART Core's clock cycle.\\\\Pulses whose width is lower than this value will be ignored."]
pub type GLITCH_FILT_R = crate::FieldReader;
#[doc = "Field `GLITCH_FILT` writer - Configures the width of a pulse to be filtered.\\\\Measurement unit: UART Core's clock cycle.\\\\Pulses whose width is lower than this value will be ignored."]
pub type GLITCH_FILT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `GLITCH_FILT_EN` reader - Configures whether or not to enable RX signal filter.\\\\ 0: Disable\\\\ 1: Enable"]
pub type GLITCH_FILT_EN_R = crate::BitReader;
#[doc = "Field `GLITCH_FILT_EN` writer - Configures whether or not to enable RX signal filter.\\\\ 0: Disable\\\\ 1: Enable"]
