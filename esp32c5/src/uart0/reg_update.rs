...
#[doc = "Field `REG_UPDATE` reader - Configures whether or not to synchronize registers.\\\\ 0: Not synchronize\\\\ 1: Synchronize\\\\"]
pub type REG_UPDATE_R = crate::BitReader;
#[doc = "Field `REG_UPDATE` writer - Configures whether or not to synchronize registers.\\\\ 0: Not synchronize\\\\ 1: Synchronize\\\\"]
