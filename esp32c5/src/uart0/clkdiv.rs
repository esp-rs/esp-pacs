...
#[doc = "Field `FRAG` reader - Configures the fractional part of the divisor for baud rate generation."]
pub type FRAG_R = crate::FieldReader;
#[doc = "Field `FRAG` writer - Configures the fractional part of the divisor for baud rate generation."]
