...
#[doc = "Field `CNT_H_LIM` reader - Configures the thr_h_lim value for unit %s. When pulse_cnt reaches this value, the counter will be cleared to 0."]
pub type CNT_H_LIM_R = crate::FieldReader<u16>;
#[doc = "Field `CNT_H_LIM` writer - Configures the thr_h_lim value for unit %s. When pulse_cnt reaches this value, the counter will be cleared to 0."]
pub type CNT_H_LIM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `CNT_L_LIM` reader - Configures the thr_l_lim value for unit %s. When pulse_cnt reaches this value, the counter will be cleared to 0."]
pub type CNT_L_LIM_R = crate::FieldReader<u16>;
#[doc = "Field `CNT_L_LIM` writer - Configures the thr_l_lim value for unit %s. When pulse_cnt reaches this value, the counter will be cleared to 0."]
