...
#[doc = "Field `CNT_THRES0` reader - Configures the thres0 value for unit %s."]
pub type CNT_THRES0_R = crate::FieldReader<u16>;
#[doc = "Field `CNT_THRES0` writer - Configures the thres0 value for unit %s."]
pub type CNT_THRES0_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `CNT_THRES1` reader - Configures the thres1 value for unit %s."]
pub type CNT_THRES1_R = crate::FieldReader<u16>;
#[doc = "Field `CNT_THRES1` writer - Configures the thres1 value for unit %s."]
