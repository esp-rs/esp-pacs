...
impl W {
    #[doc = "Bits 0:15 - Configures the step value for unit 2."]
    #[inline(always)]
    pub fn cnt_step_u2(&mut self) -> CNT_STEP_U2_W<'_, U2_CHANGE_CONF_SPEC> {
        CNT_STEP_U2_W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Configures the step limit value for unit 2."]
    #[inline(always)]
    pub fn cnt_step_lim_u2(&mut self) -> CNT_STEP_LIM_U2_W<'_, U2_CHANGE_CONF_SPEC> {
        CNT_STEP_LIM_U2_W::new(self, 16)
    }
}
#[doc = "Configuration register for unit $n's step value.\n\nYou can [`read`](crate::Reg::read) this register and get [`u2_change_conf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`u2_change_conf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
