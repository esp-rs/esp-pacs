...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            .field("cnt_thr_event_u0_int_st", &self.cnt_thr_event_u0_int_st())
            .field("cnt_thr_event_u1_int_st", &self.cnt_thr_event_u1_int_st())
            .field("cnt_thr_event_u2_int_st", &self.cnt_thr_event_u2_int_st())
            .field("cnt_thr_event_u3_int_st", &self.cnt_thr_event_u3_int_st())
            .finish()
    }
}
