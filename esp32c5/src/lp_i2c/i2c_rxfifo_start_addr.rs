...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C_RXFIFO_START_ADDR")
            .field("i2c_rxfifo_start_addr", &self.i2c_rxfifo_start_addr())
            .finish()
    }
}
#[doc = "I2C RXFIFO base address register\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c_rxfifo_start_addr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
