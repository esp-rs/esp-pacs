...
pub type R = crate::R<I2C_INT_STATUS_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C_INT_STATUS")
            .field("i2c_rxfifo_wm_int_st", &self.i2c_rxfifo_wm_int_st())
            .field("i2c_txfifo_wm_int_st", &self.i2c_txfifo_wm_int_st())
            .field("i2c_rxfifo_ovf_int_st", &self.i2c_rxfifo_ovf_int_st())
            .field("i2c_end_detect_int_st", &self.i2c_end_detect_int_st())
            .field(
                "i2c_byte_trans_done_int_st",
                &self.i2c_byte_trans_done_int_st(),
            )
            .field(
            ...
            .field(
                ...
                &self.i2c_mst_txfifo_udf_int_st(),
            )
            .field(
                "i2c_trans_complete_int_st",
                &self.i2c_trans_complete_int_st(),
            )
            .field("i2c_time_out_int_st", &self.i2c_time_out_int_st())
            .field("i2c_trans_start_int_st", &self.i2c_trans_start_int_st())
            .field("i2c_nack_int_st", &self.i2c_nack_int_st())
            .field("i2c_txfifo_ovf_int_st", &self.i2c_txfifo_ovf_int_st())
            .field("i2c_rxfifo_udf_int_st", &self.i2c_rxfifo_udf_int_st())
            .field("i2c_scl_st_to_int_st", &self.i2c_scl_st_to_int_st())
            .field(
                "i2c_scl_main_st_to_int_st",
                &self.i2c_scl_main_st_to_int_st(),
            )
            .field("i2c_det_start_int_st", &self.i2c_det_start_int_st())
            .finish()
    }
}
#[doc = "Status of captured I2C communication events\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c_int_status::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
