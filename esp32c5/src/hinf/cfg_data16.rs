...
#[doc = "CFG_DATA16\n\nYou can [`read`](crate::Reg::read) this register and get [`cfg_data16::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfg_data16::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets CFG_DATA16 to value 0x009a_7767"]
impl crate::Resettable for CFG_DATA16_SPEC {
    const RESET_VALUE: u32 = 0x009a_7767;
}
