...
#[doc = "Field `START` writer - Write 1 to continue Key Manager operation at LOAD/GAIN state."]
pub type START_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CONTINUE` writer - Write 1 to start Key Manager at IDLE state."]
