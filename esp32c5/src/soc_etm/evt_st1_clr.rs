...
impl W {
    ...
    pub fn mcpwm0_evt_timer2_tez_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TIMER2_TEZ_ST_CLR_W<EVT_ST1_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_timer0_tep_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TIMER0_TEP_ST_CLR_W<EVT_ST1_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_timer1_tep_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TIMER1_TEP_ST_CLR_W<EVT_ST1_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_timer2_tep_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TIMER2_TEP_ST_CLR_W<EVT_ST1_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_op0_tea_st_clr(&mut self) -> MCPWM0_EVT_OP0_TEA_ST_CLR_W<EVT_ST1_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_op1_tea_st_clr(&mut self) -> MCPWM0_EVT_OP1_TEA_ST_CLR_W<EVT_ST1_CLR_SPEC> {
