...
impl W {
    ...
    pub fn ledc_task_timer0_res_update_st_clr(
        &mut self,
    ) -> LEDC_TASK_TIMER0_RES_UPDATE_ST_CLR_W<'_, TASK_ST0_CLR_SPEC> {
    ...
    pub fn ledc_task_timer1_res_update_st_clr(
        &mut self,
    ) -> LEDC_TASK_TIMER1_RES_UPDATE_ST_CLR_W<'_, TASK_ST0_CLR_SPEC> {
    ...
    pub fn ledc_task_timer2_res_update_st_clr(
        &mut self,
    ) -> LEDC_TASK_TIMER2_RES_UPDATE_ST_CLR_W<'_, TASK_ST0_CLR_SPEC> {
    ...
    pub fn ledc_task_timer3_res_update_st_clr(
        &mut self,
    ) -> LEDC_TASK_TIMER3_RES_UPDATE_ST_CLR_W<'_, TASK_ST0_CLR_SPEC> {
    ...
    pub fn ledc_task_duty_scale_update_ch0_st_clr(
        &mut self,
    ) -> LEDC_TASK_DUTY_SCALE_UPDATE_CH0_ST_CLR_W<'_, TASK_ST0_CLR_SPEC> {
    ...
    pub fn ledc_task_duty_scale_update_ch1_st_clr(
        &mut self,
    ) -> LEDC_TASK_DUTY_SCALE_UPDATE_CH1_ST_CLR_W<'_, TASK_ST0_CLR_SPEC> {
    ...
    pub fn ledc_task_duty_scale_update_ch2_st_clr(
        &mut self,
    ) -> LEDC_TASK_DUTY_SCALE_UPDATE_CH2_ST_CLR_W<'_, TASK_ST0_CLR_SPEC> {
    ...
    pub fn ledc_task_duty_scale_update_ch3_st_clr(
        &mut self,
    ) -> LEDC_TASK_DUTY_SCALE_UPDATE_CH3_ST_CLR_W<'_, TASK_ST0_CLR_SPEC> {
