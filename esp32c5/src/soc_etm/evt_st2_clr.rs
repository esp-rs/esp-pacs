...
impl W {
    ...
    #[inline(always)]
    pub fn adc_evt_conv_cmplt0_st_clr(&mut self) -> ADC_EVT_CONV_CMPLT0_ST_CLR_W<EVT_ST2_CLR_SPEC> {
    ...
    pub fn adc_evt_eq_above_thresh0_st_clr(
        &mut self,
    ) -> ADC_EVT_EQ_ABOVE_THRESH0_ST_CLR_W<EVT_ST2_CLR_SPEC> {
    ...
    pub fn adc_evt_eq_above_thresh1_st_clr(
        &mut self,
    ) -> ADC_EVT_EQ_ABOVE_THRESH1_ST_CLR_W<EVT_ST2_CLR_SPEC> {
    ...
    pub fn adc_evt_eq_below_thresh0_st_clr(
        &mut self,
    ) -> ADC_EVT_EQ_BELOW_THRESH0_ST_CLR_W<EVT_ST2_CLR_SPEC> {
    ...
    pub fn adc_evt_eq_below_thresh1_st_clr(
        &mut self,
    ) -> ADC_EVT_EQ_BELOW_THRESH1_ST_CLR_W<EVT_ST2_CLR_SPEC> {
    ...
    pub fn adc_evt_result_done0_st_clr(
        &mut self,
    ) -> ADC_EVT_RESULT_DONE0_ST_CLR_W<EVT_ST2_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn adc_evt_stopped0_st_clr(&mut self) -> ADC_EVT_STOPPED0_ST_CLR_W<EVT_ST2_CLR_SPEC> {
