...
impl W {
    ...
    pub fn ulp_task_wakeup_cpu_st_clr(
        &mut self,
    ) -> ULP_TASK_WAKEUP_CPU_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn ulp_task_int_cpu_st_clr(&mut self) -> ULP_TASK_INT_CPU_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_task_start_st_clr(&mut self) -> RTC_TASK_START_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_task_stop_st_clr(&mut self) -> RTC_TASK_STOP_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_task_clr_st_clr(&mut self) -> RTC_TASK_CLR_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    pub fn rtc_task_triggerflw_st_clr(
        &mut self,
    ) -> RTC_TASK_TRIGGERFLW_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    pub fn gdma_task_in_start_ch0_st_clr(
        &mut self,
    ) -> GDMA_TASK_IN_START_CH0_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    pub fn gdma_task_in_start_ch1_st_clr(
        &mut self,
    ) -> GDMA_TASK_IN_START_CH1_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    pub fn gdma_task_in_start_ch2_st_clr(
        &mut self,
    ) -> GDMA_TASK_IN_START_CH2_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    pub fn gdma_task_out_start_ch0_st_clr(
        &mut self,
    ) -> GDMA_TASK_OUT_START_CH0_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    pub fn gdma_task_out_start_ch1_st_clr(
        &mut self,
    ) -> GDMA_TASK_OUT_START_CH1_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
    ...
    pub fn gdma_task_out_start_ch2_st_clr(
        &mut self,
    ) -> GDMA_TASK_OUT_START_CH2_ST_CLR_W<'_, TASK_ST4_CLR_SPEC> {
