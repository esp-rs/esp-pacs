...
impl W {
    ...
    pub fn gdma_evt_out_done_ch0_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_DONE_CH0_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_done_ch1_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_DONE_CH1_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_done_ch2_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_DONE_CH2_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_eof_ch0_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_EOF_CH0_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_eof_ch1_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_EOF_CH1_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_eof_ch2_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_EOF_CH2_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_total_eof_ch0_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_TOTAL_EOF_CH0_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_total_eof_ch1_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_TOTAL_EOF_CH1_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_total_eof_ch2_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_TOTAL_EOF_CH2_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_fifo_empty_ch0_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_FIFO_EMPTY_CH0_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_fifo_empty_ch1_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_FIFO_EMPTY_CH1_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_fifo_empty_ch2_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_FIFO_EMPTY_CH2_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_fifo_full_ch0_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_FIFO_FULL_CH0_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_fifo_full_ch1_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_FIFO_FULL_CH1_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn gdma_evt_out_fifo_full_ch2_st_clr(
        &mut self,
    ) -> GDMA_EVT_OUT_FIFO_FULL_CH2_ST_CLR_W<EVT_ST4_CLR_SPEC> {
    ...
    pub fn pmu_evt_sleep_weekup_st_clr(
        &mut self,
    ) -> PMU_EVT_SLEEP_WEEKUP_ST_CLR_W<EVT_ST4_CLR_SPEC> {
