...
#[doc = "Field `CH_DISABLE(32-49)` writer - Configures whether or not to clear ch%s enable.\\\\0: Invalid, No effect\\\\1: Clear"]
...
impl W {
    ...
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `CH_DISABLE32` field.</div>"]
    #[inline(always)]
    pub fn ch_disable(&mut self, n: u8) -> CH_DISABLE_W<'_, CH_ENA_AD1_CLR_SPEC> {
