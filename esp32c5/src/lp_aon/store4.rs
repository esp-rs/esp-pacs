...
#[doc = "Field `LP_AON_STORE4` reader - store the software massege4 in always-on field"]
pub type LP_AON_STORE4_R = crate::FieldReader<u32>;
#[doc = "Field `LP_AON_STORE4` writer - store the software massege4 in always-on field"]
pub type LP_AON_STORE4_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - store the software massege4 in always-on field"]
    #[inline(always)]
