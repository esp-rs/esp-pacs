...
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 31, u32>;
#[doc = "Field `CLK_EN` reader - version register"]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - version register"]
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:30 - version register"]
    #[inline(always)]
    pub fn date(&self) -> DATE_R {
        DATE_R::new(self.bits & 0x7fff_ffff)
    }
    #[doc = "Bit 31 - version register"]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x0231_2270"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0231_2270;
}
