...
#[doc = "Field `CH_RX_END(2-3)` reader - The interrupt raw bit for CHANNEL%s. Triggered when reception done."]
pub type CH_RX_END_R = crate::BitReader;
#[doc = "Field `CH_RX_END(2-3)` writer - The interrupt raw bit for CHANNEL%s. Triggered when reception done."]
...
#[doc = "Field `CH_RX_THR_EVENT(2-3)` reader - The interrupt raw bit for CHANNEL%s. Triggered when receiver receive more data than configured value."]
pub type CH_RX_THR_EVENT_R = crate::BitReader;
#[doc = "Field `CH_RX_THR_EVENT(2-3)` writer - The interrupt raw bit for CHANNEL%s. Triggered when receiver receive more data than configured value."]
