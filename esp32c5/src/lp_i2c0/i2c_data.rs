...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C_DATA")
            .field("i2c_fifo_rdata", &self.i2c_fifo_rdata())
            .finish()
    }
}
#[doc = "Rx FIFO read data.\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c_data::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
