...
#[doc = "Field `I2C_COMMAND5` reader - This is the content of command 5. It consists of three parts:op_code is the command, 1: WRITE, 2: STOP, 3: READ, 4: END, 6: RSTART. Byte_num represents the number of bytes that need to be sent or received.ack_check_en, ack_exp and ack are used to control the ACK bit. See I2C cmd structure for moreInformation."]
pub type I2C_COMMAND5_R = crate::FieldReader<u16>;
#[doc = "Field `I2C_COMMAND5` writer - This is the content of command 5. It consists of three parts:op_code is the command, 1: WRITE, 2: STOP, 3: READ, 4: END, 6: RSTART. Byte_num represents the number of bytes that need to be sent or received.ack_check_en, ack_exp and ack are used to control the ACK bit. See I2C cmd structure for moreInformation."]
pub type I2C_COMMAND5_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
...
pub type I2C_COMMAND5_DONE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C_COMD5")
            .field("i2c_command5", &self.i2c_command5())
            .field("i2c_command5_done", &self.i2c_command5_done())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:13 - This is the content of command 5. It consists of three parts:op_code is the command, 1: WRITE, 2: STOP, 3: READ, 4: END, 6: RSTART. Byte_num represents the number of bytes that need to be sent or received.ack_check_en, ack_exp and ack are used to control the ACK bit. See I2C cmd structure for moreInformation."]
    #[inline(always)]
    pub fn i2c_command5(&mut self) -> I2C_COMMAND5_W<'_, I2C_COMD5_SPEC> {
        I2C_COMMAND5_W::new(self, 0)
    }
    #[doc = "Bit 31 - When command 5 is done in I2C Master mode, this bit changes to high level."]
    #[inline(always)]
    pub fn i2c_command5_done(&mut self) -> I2C_COMMAND5_DONE_W<'_, I2C_COMD5_SPEC> {
        I2C_COMMAND5_DONE_W::new(self, 31)
    }
}
#[doc = "I2C command register 5\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c_comd5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c_comd5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
