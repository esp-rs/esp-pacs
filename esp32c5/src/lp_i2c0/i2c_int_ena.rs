...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C_INT_ENA")
            .field("i2c_rxfifo_wm_int_ena", &self.i2c_rxfifo_wm_int_ena())
            .field("i2c_txfifo_wm_int_ena", &self.i2c_txfifo_wm_int_ena())
            .field("i2c_rxfifo_ovf_int_ena", &self.i2c_rxfifo_ovf_int_ena())
            .field("i2c_end_detect_int_ena", &self.i2c_end_detect_int_ena())
            .field(
                "i2c_byte_trans_done_int_ena",
                &self.i2c_byte_trans_done_int_ena(),
            )
            .field(
                "i2c_arbitration_lost_int_ena",
                &self.i2c_arbitration_lost_int_ena(),
            )
            .field(
                "i2c_mst_txfifo_udf_int_ena",
                &self.i2c_mst_txfifo_udf_int_ena(),
            )
            .field(
                "i2c_trans_complete_int_ena",
                &self.i2c_trans_complete_int_ena(),
            )
            .field("i2c_time_out_int_ena", &self.i2c_time_out_int_ena())
            .field("i2c_trans_start_int_ena", &self.i2c_trans_start_int_ena())
            .field("i2c_nack_int_ena", &self.i2c_nack_int_ena())
            .field("i2c_txfifo_ovf_int_ena", &self.i2c_txfifo_ovf_int_ena())
            .field("i2c_rxfifo_udf_int_ena", &self.i2c_rxfifo_udf_int_ena())
            .field("i2c_scl_st_to_int_ena", &self.i2c_scl_st_to_int_ena())
            .field(
                "i2c_scl_main_st_to_int_ena",
                &self.i2c_scl_main_st_to_int_ena(),
            )
            .field("i2c_det_start_int_ena", &self.i2c_det_start_int_ena())
            .finish()
    }
}
impl W {
...
#[doc = "Interrupt enable bits\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c_int_ena::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c_int_ena::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
