...
#[doc = "Field `LOG_MEM_START` reader - Configures the starting address of the storage space for recorded data."]
pub type LOG_MEM_START_R = crate::FieldReader<u32>;
#[doc = "Field `LOG_MEM_START` writer - Configures the starting address of the storage space for recorded data."]
pub type LOG_MEM_START_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the starting address of the storage space for recorded data."]
    #[inline(always)]
