...
#[doc = "Field `LOG_CHECK_DATA` reader - Configures the data to be monitored during bus accessing."]
pub type LOG_CHECK_DATA_R = crate::FieldReader<u32>;
#[doc = "Field `LOG_CHECK_DATA` writer - Configures the data to be monitored during bus accessing."]
