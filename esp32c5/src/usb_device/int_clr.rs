...
impl W {
    ...
    pub fn serial_out_recv_pkt_int_clr(
        &mut self,
    ) -> SERIAL_OUT_RECV_PKT_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    pub fn in_token_rec_in_ep1_int_clr(
        &mut self,
    ) -> IN_TOKEN_REC_IN_EP1_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    pub fn out_ep1_zero_payload_int_clr(
        &mut self,
    ) -> OUT_EP1_ZERO_PAYLOAD_INT_CLR_W<'_, INT_CLR_SPEC> {
