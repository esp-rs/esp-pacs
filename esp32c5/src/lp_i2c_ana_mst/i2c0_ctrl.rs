...
#[doc = "Field `I2C0_CTRL` reader - need_des"]
pub type I2C0_CTRL_R = crate::FieldReader<u32>;
#[doc = "Field `I2C0_CTRL` writer - need_des"]
pub type I2C0_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
#[doc = "Field `I2C0_BUSY` reader - need_des"]
...
impl W {
    #[doc = "Bits 0:24 - need_des"]
    #[inline(always)]
    pub fn i2c0_ctrl(&mut self) -> I2C0_CTRL_W<'_, I2C0_CTRL_SPEC> {
