...
#[doc = "Field `I2C_DEVICE_EN` reader - need_des"]
pub type I2C_DEVICE_EN_R = crate::FieldReader<u16>;
#[doc = "Field `I2C_DEVICE_EN` writer - need_des"]
pub type I2C_DEVICE_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    #[doc = "Bits 0:11 - need_des"]
    #[inline(always)]
    pub fn i2c_device_en(&self) -> I2C_DEVICE_EN_R {
        I2C_DEVICE_EN_R::new((self.bits & 0x0fff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DEVICE_EN")
            .field("i2c_device_en", &self.i2c_device_en())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:11 - need_des"]
    #[inline(always)]
    pub fn i2c_device_en(&mut self) -> I2C_DEVICE_EN_W<'_, DEVICE_EN_SPEC> {
        I2C_DEVICE_EN_W::new(self, 0)
    }
}
