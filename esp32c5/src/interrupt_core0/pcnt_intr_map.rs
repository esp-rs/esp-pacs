...
#[doc = "Field `PCNT_INTR_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type PCNT_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `PCNT_INTR_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type PCNT_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn pcnt_intr_map(&self) -> PCNT_INTR_MAP_R {
        PCNT_INTR_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
