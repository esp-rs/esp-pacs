...
#[doc = "Field `DMA_IN_CH2_INTR_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type DMA_IN_CH2_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `DMA_IN_CH2_INTR_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type DMA_IN_CH2_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn dma_in_ch2_intr_map(&self) -> DMA_IN_CH2_INTR_MAP_R {
        DMA_IN_CH2_INTR_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_IN_CH2_INTR_MAP")
            .field("dma_in_ch2_intr_map", &self.dma_in_ch2_intr_map())
            .finish()
    }
}
impl W {
...
#[doc = "DMA_IN_CH2_INTR mapping register\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_in_ch2_intr_map::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_in_ch2_intr_map::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
