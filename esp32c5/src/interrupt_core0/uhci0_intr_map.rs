...
#[doc = "Field `UHCI0_INTR_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type UHCI0_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `UHCI0_INTR_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type UHCI0_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn uhci0_intr_map(&self) -> UHCI0_INTR_MAP_R {
        UHCI0_INTR_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
