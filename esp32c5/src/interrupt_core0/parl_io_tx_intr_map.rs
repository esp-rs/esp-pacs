...
#[doc = "Field `PARL_IO_TX_INTR_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type PARL_IO_TX_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `PARL_IO_TX_INTR_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type PARL_IO_TX_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn parl_io_tx_intr_map(&self) -> PARL_IO_TX_INTR_MAP_R {
        PARL_IO_TX_INTR_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
