...
#[doc = "Field `RMT_INTR_MAP` reader - Configures the interrupt source into one CPU interrupt."]
pub type RMT_INTR_MAP_R = crate::FieldReader;
#[doc = "Field `RMT_INTR_MAP` writer - Configures the interrupt source into one CPU interrupt."]
pub type RMT_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - Configures the interrupt source into one CPU interrupt."]
    #[inline(always)]
    pub fn rmt_intr_map(&self) -> RMT_INTR_MAP_R {
        RMT_INTR_MAP_R::new((self.bits & 0x3f) as u8)
    }
}
