...
impl RegisterBlock {
    ...
    #[doc = "0x08..0x18 - Duty cycle configuration register for SDM channel %s"]
    #[inline(always)]
    ...
    #[doc = "0x58 - Configuration register for zero-crossing detection"]
    #[inline(always)]
    pub const fn pad_comp_config_0(&self) -> &PAD_COMP_CONFIG_0 {
        &self.pad_comp_config_0
    }
    #[doc = "0x5c - Configuration register for interrupt source mask period of zero-crossing detection"]
    #[inline(always)]
