...
#[doc = "Field `LP_PERI_TIMEOUT_ADDR` reader - when bus timeout, this register will record the timeout address"]
pub type LP_PERI_TIMEOUT_ADDR_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - when bus timeout, this register will record the timeout address"]
    #[inline(always)]
...
#[doc = "the timeout address register\n\nYou can [`read`](crate::Reg::read) this register and get [`bus_timeout_addr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
