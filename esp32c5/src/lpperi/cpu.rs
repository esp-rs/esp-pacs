...
#[doc = "Field `LPCORE_DBGM_UNAVALIABLE` reader - disable lp cpu dbg bus 1: disable 0: enable"]
pub type LPCORE_DBGM_UNAVALIABLE_R = crate::BitReader;
#[doc = "Field `LPCORE_DBGM_UNAVALIABLE` writer - disable lp cpu dbg bus 1: disable 0: enable"]
pub type LPCORE_DBGM_UNAVALIABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 31 - disable lp cpu dbg bus 1: disable 0: enable"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 31 - disable lp cpu dbg bus 1: disable 0: enable"]
    #[inline(always)]
    pub fn lpcore_dbgm_unavaliable(&mut self) -> LPCORE_DBGM_UNAVALIABLE_W<'_, CPU_SPEC> {
