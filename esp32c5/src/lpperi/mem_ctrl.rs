...
#[doc = "Field `UART_WAKEUP_FLAG_CLR` writer - clear uart wakeup latch 1: clear 0: no operation"]
pub type UART_WAKEUP_FLAG_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `UART_WAKEUP_FLAG` reader - latch uart wakeup event"]
pub type UART_WAKEUP_FLAG_R = crate::BitReader;
#[doc = "Field `UART_WAKEUP_FLAG` writer - latch uart wakeup event"]
pub type UART_WAKEUP_FLAG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `UART_WAKEUP_EN` reader - enable uart wakeup not not"]
pub type UART_WAKEUP_EN_R = crate::BitReader;
#[doc = "Field `UART_WAKEUP_EN` writer - enable uart wakeup not not"]
pub type UART_WAKEUP_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `UART_MEM_FORCE_PD` reader - force off uart memory"]
pub type UART_MEM_FORCE_PD_R = crate::BitReader;
#[doc = "Field `UART_MEM_FORCE_PD` writer - force off uart memory"]
pub type UART_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `UART_MEM_FORCE_PU` reader - force on uart memory"]
pub type UART_MEM_FORCE_PU_R = crate::BitReader;
#[doc = "Field `UART_MEM_FORCE_PU` writer - force on uart memory"]
