...
#[doc = "Field `RX_DONE_MODE` reader - 1: I2S trigger rx_done when in_suc_eof is 1. 0: I2S trigger rx_done when RX FIFO is full."]
pub type RX_DONE_MODE_R = crate::BitReader;
#[doc = "Field `RX_DONE_MODE` writer - 1: I2S trigger rx_done when in_suc_eof is 1. 0: I2S trigger rx_done when RX FIFO is full."]
pub type RX_DONE_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn rx_done_mode(&self) -> RX_DONE_MODE_R {
        RX_DONE_MODE_R::new(((self.bits >> 14) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_CONF")
            ...
            .field("rx_done_mode", &self.rx_done_mode())
