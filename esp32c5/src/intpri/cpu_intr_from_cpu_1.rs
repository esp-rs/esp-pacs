...
#[doc = "Field `CPU_INTR_FROM_CPU_1` reader - CPU_INTR_FROM_CPU_1 mapping register."]
pub type CPU_INTR_FROM_CPU_1_R = crate::BitReader;
#[doc = "Field `CPU_INTR_FROM_CPU_1` writer - CPU_INTR_FROM_CPU_1 mapping register."]
pub type CPU_INTR_FROM_CPU_1_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - CPU_INTR_FROM_CPU_1 mapping register."]
    #[inline(always)]
