...
#[doc = "Field `CPU_INTR_FROM_CPU_0` reader - CPU_INTR_FROM_CPU_0 mapping register."]
pub type CPU_INTR_FROM_CPU_0_R = crate::BitReader;
#[doc = "Field `CPU_INTR_FROM_CPU_0` writer - CPU_INTR_FROM_CPU_0 mapping register."]
pub type CPU_INTR_FROM_CPU_0_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - CPU_INTR_FROM_CPU_0 mapping register."]
    #[inline(always)]
