...
#[doc = "Field `CORE_0_SP_MIN` reader - Configures the lower bound address of SP."]
pub type CORE_0_SP_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_0_SP_MIN` writer - Configures the lower bound address of SP."]
pub type CORE_0_SP_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the lower bound address of SP."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Configures the lower bound address of SP."]
    #[inline(always)]
    pub fn core_0_sp_min(&mut self) -> CORE_0_SP_MIN_W<'_, CORE_0_SP_MIN_SPEC> {
