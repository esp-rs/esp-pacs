...
#[doc = "Field `CORE_0_AREA_PIF_1_MIN` reader - Configures the lower bound address of Peripheral bus region 1."]
pub type CORE_0_AREA_PIF_1_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_0_AREA_PIF_1_MIN` writer - Configures the lower bound address of Peripheral bus region 1."]
