...
#[doc = "Field `BLOCK_NUM` reader - Represents the Block Number of plaintext or ciphertext when the AES accelerator operates under the DMA-AES working mode. For details, see Section <a href=sec:aes-block-number\">link</a>. \""]
pub type BLOCK_NUM_R = crate::FieldReader<u32>;
#[doc = "Field `BLOCK_NUM` writer - Represents the Block Number of plaintext or ciphertext when the AES accelerator operates under the DMA-AES working mode. For details, see Section <a href=sec:aes-block-number\">link</a>. \""]
pub type BLOCK_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the Block Number of plaintext or ciphertext when the AES accelerator operates under the DMA-AES working mode. For details, see Section <a href=sec:aes-block-number\">link</a>. \""]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Represents the Block Number of plaintext or ciphertext when the AES accelerator operates under the DMA-AES working mode. For details, see Section <a href=sec:aes-block-number\">link</a>. \""]
    #[inline(always)]
    pub fn block_num(&mut self) -> BLOCK_NUM_W<'_, BLOCK_NUM_SPEC> {
