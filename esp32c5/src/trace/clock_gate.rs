...
#[doc = "Field `CLK_EN` reader - Configures register clock gating. \\\\0: Support clock only when the application writes registers to save power. \\\\1:Always force the clock on for registers \\\\ This bit does't affect register access."]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Configures register clock gating. \\\\0: Support clock only when the application writes registers to save power. \\\\1:Always force the clock on for registers \\\\ This bit does't affect register access."]
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures register clock gating. \\\\0: Support clock only when the application writes registers to save power. \\\\1:Always force the clock on for registers \\\\ This bit does't affect register access."]
    #[inline(always)]
