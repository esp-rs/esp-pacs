...
#[doc = "Field `HBURST` reader - Configures the AHB burst mode. \\\\0: SIGNLE \\\\1: INCR(length not defined) \\\\2:INCR4 \\\\4:INCR8 \\\\Others:Invalid"]
pub type HBURST_R = crate::FieldReader;
#[doc = "Field `HBURST` writer - Configures the AHB burst mode. \\\\0: SIGNLE \\\\1: INCR(length not defined) \\\\2:INCR4 \\\\4:INCR8 \\\\Others:Invalid"]
pub type HBURST_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `MAX_INCR` reader - Configures the maximum burst length for INCR mode"]
pub type MAX_INCR_R = crate::FieldReader;
#[doc = "Field `MAX_INCR` writer - Configures the maximum burst length for INCR mode"]
