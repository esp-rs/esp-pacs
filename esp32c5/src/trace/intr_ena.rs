...
#[doc = "Field `FIFO_OVERFLOW_INTR_ENA` reader - Write 1 to enable TRACE_FIFO_OVERFLOW_INTR"]
pub type FIFO_OVERFLOW_INTR_ENA_R = crate::BitReader;
#[doc = "Field `FIFO_OVERFLOW_INTR_ENA` writer - Write 1 to enable TRACE_FIFO_OVERFLOW_INTR"]
pub type FIFO_OVERFLOW_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MEM_FULL_INTR_ENA` reader - Write 1 to enable TRACE_MEM_FULL_INTR"]
pub type MEM_FULL_INTR_ENA_R = crate::BitReader;
#[doc = "Field `MEM_FULL_INTR_ENA` writer - Write 1 to enable TRACE_MEM_FULL_INTR"]
pub type MEM_FULL_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Write 1 to enable TRACE_FIFO_OVERFLOW_INTR"]
    #[inline(always)]
    pub fn fifo_overflow_intr_ena(&self) -> FIFO_OVERFLOW_INTR_ENA_R {
        FIFO_OVERFLOW_INTR_ENA_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Write 1 to enable TRACE_MEM_FULL_INTR"]
    #[inline(always)]
