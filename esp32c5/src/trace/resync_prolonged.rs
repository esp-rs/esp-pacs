...
#[doc = "Field `RESYNC_PROLONGED` reader - Configures the threshold for synchronization counter"]
pub type RESYNC_PROLONGED_R = crate::FieldReader<u32>;
#[doc = "Field `RESYNC_PROLONGED` writer - Configures the threshold for synchronization counter"]
pub type RESYNC_PROLONGED_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
#[doc = "Field `RESYNC_MODE` reader - Configures the synchronization mode: \\\\0: Disable the synchronization counter \\\\1: Invalid \\\\2: Synchronization counter counts by packet \\\\3: Synchronization counter counts by cycle\\\\"]
pub type RESYNC_MODE_R = crate::FieldReader;
#[doc = "Field `RESYNC_MODE` writer - Configures the synchronization mode: \\\\0: Disable the synchronization counter \\\\1: Invalid \\\\2: Synchronization counter counts by packet \\\\3: Synchronization counter counts by cycle\\\\"]
