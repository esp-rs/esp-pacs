...
#[doc = "Field `FIFO_OVERFLOW_INTR_CLR` writer - Write 1 to clear TRACE_FIFO_OVERFLOW_INTR"]
pub type FIFO_OVERFLOW_INTR_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MEM_FULL_INTR_CLR` writer - Write 1 to clear TRACE_MEM_FULL_INTR"]
