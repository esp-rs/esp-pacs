...
#[doc = "Field `LP_WDT_DATE` reader - Version control register"]
pub type LP_WDT_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `LP_WDT_DATE` writer - Version control register"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DATE")
            .field("lp_wdt_date", &self.lp_wdt_date())
...
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0211_2080;
}
