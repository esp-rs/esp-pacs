...
#[doc = "Field `HOLD` reader - Configure the timeout time for stage0. \\\\Measurement unit: LP\\_DYN\\_SLOW\\_CLK"]
pub type HOLD_R = crate::FieldReader<u32>;
#[doc = "Field `HOLD` writer - Configure the timeout time for stage0. \\\\Measurement unit: LP\\_DYN\\_SLOW\\_CLK"]
