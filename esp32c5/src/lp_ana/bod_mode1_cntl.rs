...
#[doc = "Field `BOD_MODE1_RESET_ENA` reader - enable brownout mode1 reset or not 1: enable 0: disable"]
pub type BOD_MODE1_RESET_ENA_R = crate::BitReader;
#[doc = "Field `BOD_MODE1_RESET_ENA` writer - enable brownout mode1 reset or not 1: enable 0: disable"]
