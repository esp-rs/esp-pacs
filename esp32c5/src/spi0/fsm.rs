...
impl R {
    ...
    #[doc = "Bit 12 - The lock enable for FLASH to lock spi0 trans req.1: Enable. 0: Disable."]
    #[inline(always)]
    pub fn flash_lock_en(&self) -> FLASH_LOCK_EN_R {
        FLASH_LOCK_EN_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - The lock enable for external RAM to lock spi0 trans req.1: Enable. 0: Disable."]
    #[inline(always)]
    pub fn sram_lock_en(&self) -> SRAM_LOCK_EN_R {
        SRAM_LOCK_EN_R::new(((self.bits >> 13) & 1) != 0)
    }
}
