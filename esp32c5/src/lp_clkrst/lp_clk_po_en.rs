...
#[doc = "Field `AON_SLOW_OEN` reader - Configures the clock gate to pad of the LP_DYN_SLOW_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type AON_SLOW_OEN_R = crate::BitReader;
#[doc = "Field `AON_SLOW_OEN` writer - Configures the clock gate to pad of the LP_DYN_SLOW_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type AON_SLOW_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `AON_FAST_OEN` reader - Configures the clock gate to pad of the LP_DYN_FAST_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type AON_FAST_OEN_R = crate::BitReader;
#[doc = "Field `AON_FAST_OEN` writer - Configures the clock gate to pad of the LP_DYN_FAST_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type AON_FAST_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOSC_OEN` reader - Configures the clock gate to pad of the OSC_SLOW_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type SOSC_OEN_R = crate::BitReader;
#[doc = "Field `SOSC_OEN` writer - Configures the clock gate to pad of the OSC_SLOW_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type SOSC_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FOSC_OEN` reader - Configures the clock gate to pad of the RC_FAST_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type FOSC_OEN_R = crate::BitReader;
#[doc = "Field `FOSC_OEN` writer - Configures the clock gate to pad of the RC_FAST_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type FOSC_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OSC32K_OEN` reader - Configures the clock gate to pad of the RC32K_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type OSC32K_OEN_R = crate::BitReader;
#[doc = "Field `OSC32K_OEN` writer - Configures the clock gate to pad of the RC32K_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type OSC32K_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `XTAL32K_OEN` reader - Configures the clock gate to pad of the XTAL32K_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type XTAL32K_OEN_R = crate::BitReader;
#[doc = "Field `XTAL32K_OEN` writer - Configures the clock gate to pad of the XTAL32K_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type XTAL32K_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_EFUSE_OEN` reader - Configures the clock gate to pad of the EFUSE_CTRL clock. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type CORE_EFUSE_OEN_R = crate::BitReader;
#[doc = "Field `CORE_EFUSE_OEN` writer - Configures the clock gate to pad of the EFUSE_CTRL clock. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type CORE_EFUSE_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLOW_OEN` reader - Configures the clock gate to pad of the LP_SLOW_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type SLOW_OEN_R = crate::BitReader;
#[doc = "Field `SLOW_OEN` writer - Configures the clock gate to pad of the LP_SLOW_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type SLOW_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FAST_OEN` reader - Configures the clock gate to pad of the LP_FAST_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type FAST_OEN_R = crate::BitReader;
#[doc = "Field `FAST_OEN` writer - Configures the clock gate to pad of the LP_FAST_CLK. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type FAST_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RNG_OEN` reader - Configures the clock gate to pad of the RNG clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type RNG_OEN_R = crate::BitReader;
#[doc = "Field `RNG_OEN` writer - Configures the clock gate to pad of the RNG clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type RNG_OEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LPBUS_OEN` reader - Configures the clock gate to pad of the LP bus clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
pub type LPBUS_OEN_R = crate::BitReader;
#[doc = "Field `LPBUS_OEN` writer - Configures the clock gate to pad of the LP bus clk. 0: Disable the clk pass clock gate 1: Enable the clk pass clock gate"]
