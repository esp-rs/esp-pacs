...
#[doc = "Field `CLKRST_DATE` reader - Version control register"]
pub type CLKRST_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `CLKRST_DATE` writer - Version control register"]
pub type CLKRST_DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 31, u32>;
#[doc = "Field `CLK_EN` reader - configure register clk bypass clk gate"]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - configure register clk bypass clk gate"]
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:30 - Version control register"]
    #[inline(always)]
    pub fn clkrst_date(&self) -> CLKRST_DATE_R {
        CLKRST_DATE_R::new(self.bits & 0x7fff_ffff)
    }
    #[doc = "Bit 31 - configure register clk bypass clk gate"]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x0230_5080"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0230_5080;
}
