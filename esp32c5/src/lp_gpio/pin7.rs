...
#[doc = "Field `PAD_DRIVER` reader - Configures to select the pin dirve mode of GPIO7.\\\\ 0: Normal output\\\\ 1: Open drain output\\\\"]
pub type PAD_DRIVER_R = crate::BitReader;
#[doc = "Field `PAD_DRIVER` writer - Configures to select the pin dirve mode of GPIO7.\\\\ 0: Normal output\\\\ 1: Open drain output\\\\"]
...
#[doc = "Field `INT_TYPE` reader - Configures GPIO7 interrupt type.\\\\ 0: GPIO interrupt disabled \\\\ 1: Rising edge trigger \\\\ 2: Falling edge trigger \\\\ 3: Any edge trigger \\\\ 4: Low level trigger \\\\ 5: High level trigger \\\\"]
pub type INT_TYPE_R = crate::FieldReader;
#[doc = "Field `INT_TYPE` writer - Configures GPIO7 interrupt type.\\\\ 0: GPIO interrupt disabled \\\\ 1: Rising edge trigger \\\\ 2: Falling edge trigger \\\\ 3: Any edge trigger \\\\ 4: Low level trigger \\\\ 5: High level trigger \\\\"]
pub type INT_TYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `WAKEUP_ENABLE` reader - Configures whether or not to enable GPIO7 wake-up function.\\\\ 0: Not enable\\\\ 1: Enable\\\\ This function is disabled when PD_LP_PERI is powered off.\\\\"]
pub type WAKEUP_ENABLE_R = crate::BitReader;
#[doc = "Field `WAKEUP_ENABLE` writer - Configures whether or not to enable GPIO7 wake-up function.\\\\ 0: Not enable\\\\ 1: Enable\\\\ This function is disabled when PD_LP_PERI is powered off.\\\\"]
...
impl R {
    ...
    #[doc = "Bit 2 - Configures to select the pin dirve mode of GPIO7.\\\\ 0: Normal output\\\\ 1: Open drain output\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bits 7:9 - Configures GPIO7 interrupt type.\\\\ 0: GPIO interrupt disabled \\\\ 1: Rising edge trigger \\\\ 2: Falling edge trigger \\\\ 3: Any edge trigger \\\\ 4: Low level trigger \\\\ 5: High level trigger \\\\"]
    #[inline(always)]
    pub fn int_type(&self) -> INT_TYPE_R {
        INT_TYPE_R::new(((self.bits >> 7) & 7) as u8)
    }
    #[doc = "Bit 10 - Configures whether or not to enable GPIO7 wake-up function.\\\\ 0: Not enable\\\\ 1: Enable\\\\ This function is disabled when PD_LP_PERI is powered off.\\\\"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:1 - Configures whether or not to synchronize GPIO input data on either edge of LP IO MUX operating clock for the second-level synchronization.\\\\ 0: Not synchronize\\\\ 1: Synchronize on falling edge\\\\ 2: Synchronize on rising edge\\\\ 3: Synchronize on rising edge\\\\"]
    #[inline(always)]
    pub fn sync2_bypass(&mut self) -> SYNC2_BYPASS_W<PIN7_SPEC> {
        SYNC2_BYPASS_W::new(self, 0)
    }
    #[doc = "Bit 2 - Configures to select the pin dirve mode of GPIO7.\\\\ 0: Normal output\\\\ 1: Open drain output\\\\"]
    #[inline(always)]
    pub fn pad_driver(&mut self) -> PAD_DRIVER_W<PIN7_SPEC> {
        PAD_DRIVER_W::new(self, 2)
    }
    #[doc = "Bits 3:4 - Configures whether or not to synchronize GPIO input data on either edge of LP IO MUX operating clock for the first-level synchronization.\\\\ 0: Not synchronize\\\\ 1: Synchronize on falling edge\\\\ 2: Synchronize on rising edge\\\\ 3: Synchronize on rising edge\\\\"]
    #[inline(always)]
    pub fn sync1_bypass(&mut self) -> SYNC1_BYPASS_W<PIN7_SPEC> {
