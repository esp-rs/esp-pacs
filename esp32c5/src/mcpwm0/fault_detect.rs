...
#[doc = "Field `F_EN(0-2)` reader - Configures whether or not to enable event_f%s generation.\\\\0: Disable\\\\1: Enable"]
pub type F_EN_R = crate::BitReader;
#[doc = "Field `F_EN(0-2)` writer - Configures whether or not to enable event_f%s generation.\\\\0: Disable\\\\1: Enable"]
...
impl R {
    #[doc = "Configures whether or not to enable event_f(0-2) generation.\\\\0: Disable\\\\1: Enable"]
    #[doc = ""]
