...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GEN_FORCE")
            .field("gen_cntuforce_upmethod", &self.gen_cntuforce_upmethod())
            .field("gen_a_cntuforce_mode", &self.gen_a_cntuforce_mode())
            .field("gen_b_cntuforce_mode", &self.gen_b_cntuforce_mode())
            .field("gen_a_nciforce", &self.gen_a_nciforce())
            .field("gen_a_nciforce_mode", &self.gen_a_nciforce_mode())
            .field("gen_b_nciforce", &self.gen_b_nciforce())
            .field("gen_b_nciforce_mode", &self.gen_b_nciforce_mode())
            .finish()
    }
}
impl W {
