...
#[doc = "Field `CORE_0_AREA_PIF_0_MIN` reader - Configures the lower bound address of Peripheral bus region 0."]
pub type CORE_0_AREA_PIF_0_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_0_AREA_PIF_0_MIN` writer - Configures the lower bound address of Peripheral bus region 0."]
...
impl W {
    ...
    pub fn core_0_area_pif_0_min(
        &mut self,
    ) -> CORE_0_AREA_PIF_0_MIN_W<'_, CORE_0_AREA_PIF_0_MIN_SPEC> {
