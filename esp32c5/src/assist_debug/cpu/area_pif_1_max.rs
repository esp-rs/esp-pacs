...
#[doc = "Field `AREA_PIF_1_MAX` reader - Configures the upper bound address of Peripheral bus region 1."]
pub type AREA_PIF_1_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_PIF_1_MAX` writer - Configures the upper bound address of Peripheral bus region 1."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AREA_PIF_1_MAX")
            .field("area_pif_1_max", &self.area_pif_1_max())
            .finish()
    }
}
impl W {
