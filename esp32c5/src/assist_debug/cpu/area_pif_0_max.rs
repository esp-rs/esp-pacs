...
#[doc = "Field `AREA_PIF_0_MAX` reader - Configures the upper bound address of Peripheral bus region 0."]
pub type AREA_PIF_0_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_PIF_0_MAX` writer - Configures the upper bound address of Peripheral bus region 0."]
