...
#[doc = "Field `AREA_PIF_0_MIN` reader - Configures the lower bound address of Peripheral bus region 0."]
pub type AREA_PIF_0_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_PIF_0_MIN` writer - Configures the lower bound address of Peripheral bus region 0."]
