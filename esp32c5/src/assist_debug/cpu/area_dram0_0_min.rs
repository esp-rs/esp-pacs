...
#[doc = "Field `AREA_DRAM0_0_MIN` reader - Configures the lower bound address of Data bus region 0."]
pub type AREA_DRAM0_0_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_DRAM0_0_MIN` writer - Configures the lower bound address of Data bus region 0."]
pub type AREA_DRAM0_0_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the lower bound address of Data bus region 0."]
    #[inline(always)]
    pub fn area_dram0_0_min(&self) -> AREA_DRAM0_0_MIN_R {
        AREA_DRAM0_0_MIN_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AREA_DRAM0_0_MIN")
            .field("area_dram0_0_min", &self.area_dram0_0_min())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Configures the lower bound address of Data bus region 0."]
    #[inline(always)]
    pub fn area_dram0_0_min(&mut self) -> AREA_DRAM0_0_MIN_W<'_, AREA_DRAM0_0_MIN_SPEC> {
        AREA_DRAM0_0_MIN_W::new(self, 0)
    }
}
