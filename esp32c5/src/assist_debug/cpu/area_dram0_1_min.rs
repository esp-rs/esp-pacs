...
#[doc = "Field `AREA_DRAM0_1_MIN` reader - Configures the lower bound address of Data bus region 1."]
pub type AREA_DRAM0_1_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_DRAM0_1_MIN` writer - Configures the lower bound address of Data bus region 1."]
