...
#[doc = "Field `OUTLINK_DSCR_BF0_CH` reader - Represents the address of the current transmit descriptor y that has already been fetched."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_DSCR_BF0_CH")
            .field("outlink_dscr_bf0_ch", &self.outlink_dscr_bf0_ch())
            .finish()
    }
}
