...
#[doc = "Field `OUTFIFO_WDATA_CH` reader - Configures the data that need to be pushed into AHB_DMA FIFO."]
pub type OUTFIFO_WDATA_CH_R = crate::FieldReader<u16>;
#[doc = "Field `OUTFIFO_WDATA_CH` writer - Configures the data that need to be pushed into AHB_DMA FIFO."]
pub type OUTFIFO_WDATA_CH_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
#[doc = "Field `OUTFIFO_PUSH_CH` writer - Configures whether or not to push data into AHB_DMA FIFO.\\\\0: Invalid. No effect\\\\1: Push\\\\"]
