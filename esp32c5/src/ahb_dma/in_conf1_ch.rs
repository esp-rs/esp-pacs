...
#[doc = "Field `IN_CHECK_OWNER_CH` reader - Configures whether or not to enable owner bit check for RX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
pub type IN_CHECK_OWNER_CH_R = crate::BitReader;
#[doc = "Field `IN_CHECK_OWNER_CH` writer - Configures whether or not to enable owner bit check for RX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
