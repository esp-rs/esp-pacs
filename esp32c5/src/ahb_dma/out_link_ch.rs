...
#[doc = "Field `OUTLINK_STOP_CH` writer - Configures whether or not to stop AHB_DMA's TX channel %s from transmitting data.\\\\0: Invalid. No effect\\\\1: Stop\\\\"]
pub type OUTLINK_STOP_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTLINK_START_CH` writer - Configures whether or not to enable AHB_DMA's TX channel %s for data transfer.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUTLINK_START_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTLINK_RESTART_CH` writer - Configures whether or not to restart TX channel %s for AHB_DMA transfer.\\\\0: Invalid. No effect\\\\1: Restart\\\\"]
pub type OUTLINK_RESTART_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTLINK_PARK_CH` reader - Represents the status of the transmit descriptor's FSM.\\\\0: Running\\\\1: Idle\\\\"]
...
impl W {
    ...
    #[inline(always)]
    pub fn outlink_stop_ch(&mut self) -> OUTLINK_STOP_CH_W<OUT_LINK_CH_SPEC> {
    ...
    #[inline(always)]
    pub fn outlink_start_ch(&mut self) -> OUTLINK_START_CH_W<OUT_LINK_CH_SPEC> {
    ...
    #[inline(always)]
    pub fn outlink_restart_ch(&mut self) -> OUTLINK_RESTART_CH_W<OUT_LINK_CH_SPEC> {
