...
#[doc = "Field `INLINK_DSCR_BF0_CH` reader - Represents the address of the current receive descriptor x that has already been fetched."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_DSCR_BF0_CH")
            .field("inlink_dscr_bf0_ch", &self.inlink_dscr_bf0_ch())
            .finish()
    }
}
