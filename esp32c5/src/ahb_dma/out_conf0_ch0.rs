...
#[doc = "Field `OUT_AUTO_WRBACK_CH0` reader - Configures whether or not to enable automatic outlink write-back when all the data in TX FIFO has been transmitted.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUT_AUTO_WRBACK_CH0_R = crate::BitReader;
#[doc = "Field `OUT_AUTO_WRBACK_CH0` writer - Configures whether or not to enable automatic outlink write-back when all the data in TX FIFO has been transmitted.\\\\0: Disable\\\\1: Enable\\\\"]
...
#[doc = "Field `OUTDSCR_BURST_EN_CH0` reader - Configures whether or not to enable INCR burst transfer for TX channel 0 reading descriptors.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUTDSCR_BURST_EN_CH0_R = crate::BitReader;
#[doc = "Field `OUTDSCR_BURST_EN_CH0` writer - Configures whether or not to enable INCR burst transfer for TX channel 0 reading descriptors.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUTDSCR_BURST_EN_CH0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_ETM_EN_CH0` reader - Configures whether or not to enable ETM control for TX channel 0.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUT_ETM_EN_CH0_R = crate::BitReader;
#[doc = "Field `OUT_ETM_EN_CH0` writer - Configures whether or not to enable ETM control for TX channel 0.\\\\0: Disable\\\\1: Enable\\\\"]
...
impl R {
    ...
    #[doc = "Bit 4 - Configures whether or not to enable INCR burst transfer for TX channel 0 reading descriptors.\\\\0: Disable\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn outdscr_burst_en_ch0(&self) -> OUTDSCR_BURST_EN_CH0_R {
        OUTDSCR_BURST_EN_CH0_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 6 - Configures whether or not to enable ETM control for TX channel 0.\\\\0: Disable\\\\1: Enable\\\\"]
    #[inline(always)]
