...
#[doc = "Field `INFIFO_RDATA_CH` reader - Represents the data popped from AHB_DMA FIFO."]
pub type INFIFO_RDATA_CH_R = crate::FieldReader<u16>;
#[doc = "Field `INFIFO_POP_CH` writer - Configures whether or not to pop data from AHB_DMA FIFO.\\\\0: Invalid. No effect\\\\1: Pop\\\\"]
