...
#[doc = "Field `INFIFO_POP` writer - Configures whether or not to pop data from AHB_DMA FIFO.\\\\0: Invalid. No effect\\\\1: Pop\\\\"]
...
impl W {
    ...
    #[inline(always)]
    pub fn infifo_pop(&mut self) -> INFIFO_POP_W<IN_POP_CH_SPEC> {
