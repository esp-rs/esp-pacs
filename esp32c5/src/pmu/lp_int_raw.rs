...
pub type MODEM_SWITCH_ACTIVE_END_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SLEEP_SWITCH_MODEM_END_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type MODEM_SWITCH_SLEEP_END_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type MODEM_SWITCH_ACTIVE_START_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SLEEP_SWITCH_MODEM_START_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type MODEM_SWITCH_SLEEP_START_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_INT_RAW")
            .field("lp_cpu_wakeup_int_raw", &self.lp_cpu_wakeup_int_raw())
            .field(
                "modem_switch_active_end_int_raw",
                &self.modem_switch_active_end_int_raw(),
            )
            .field(
                "sleep_switch_active_end_int_raw",
                &self.sleep_switch_active_end_int_raw(),
            )
            .field(
                "sleep_switch_modem_end_int_raw",
                &self.sleep_switch_modem_end_int_raw(),
            )
            .field(
                "modem_switch_sleep_end_int_raw",
                &self.modem_switch_sleep_end_int_raw(),
            )
            .field(
                "active_switch_sleep_end_int_raw",
                &self.active_switch_sleep_end_int_raw(),
            )
            .field(
                "modem_switch_active_start_int_raw",
                &self.modem_switch_active_start_int_raw(),
            )
            .field(
                "sleep_switch_active_start_int_raw",
                &self.sleep_switch_active_start_int_raw(),
            )
            .field(
                "sleep_switch_modem_start_int_raw",
                &self.sleep_switch_modem_start_int_raw(),
            )
            .field(
                "modem_switch_sleep_start_int_raw",
                &self.modem_switch_sleep_start_int_raw(),
            )
            .field(
                "active_switch_sleep_start_int_raw",
                &self.active_switch_sleep_start_int_raw(),
            )
            .field("hp_sw_trigger_int_raw", &self.hp_sw_trigger_int_raw())
            .finish()
    }
}
impl W {
    #[doc = "Bit 20 - need_des"]
    #[inline(always)]
    pub fn lp_cpu_wakeup_int_raw(&mut self) -> LP_CPU_WAKEUP_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        LP_CPU_WAKEUP_INT_RAW_W::new(self, 20)
    }
    #[doc = "Bit 21 - need_des"]
    #[inline(always)]
    pub fn modem_switch_active_end_int_raw(
        &mut self,
    ) -> MODEM_SWITCH_ACTIVE_END_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        MODEM_SWITCH_ACTIVE_END_INT_RAW_W::new(self, 21)
    }
    #[doc = "Bit 22 - need_des"]
    #[inline(always)]
    pub fn sleep_switch_active_end_int_raw(
        &mut self,
    ) -> SLEEP_SWITCH_ACTIVE_END_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        SLEEP_SWITCH_ACTIVE_END_INT_RAW_W::new(self, 22)
    }
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn sleep_switch_modem_end_int_raw(
        &mut self,
    ) -> SLEEP_SWITCH_MODEM_END_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        SLEEP_SWITCH_MODEM_END_INT_RAW_W::new(self, 23)
    }
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
    pub fn modem_switch_sleep_end_int_raw(
        &mut self,
    ) -> MODEM_SWITCH_SLEEP_END_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        MODEM_SWITCH_SLEEP_END_INT_RAW_W::new(self, 24)
    }
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
    pub fn active_switch_sleep_end_int_raw(
        &mut self,
    ) -> ACTIVE_SWITCH_SLEEP_END_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        ACTIVE_SWITCH_SLEEP_END_INT_RAW_W::new(self, 25)
    }
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn modem_switch_active_start_int_raw(
        &mut self,
    ) -> MODEM_SWITCH_ACTIVE_START_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        MODEM_SWITCH_ACTIVE_START_INT_RAW_W::new(self, 26)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn sleep_switch_active_start_int_raw(
        &mut self,
    ) -> SLEEP_SWITCH_ACTIVE_START_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        SLEEP_SWITCH_ACTIVE_START_INT_RAW_W::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn sleep_switch_modem_start_int_raw(
        &mut self,
    ) -> SLEEP_SWITCH_MODEM_START_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        SLEEP_SWITCH_MODEM_START_INT_RAW_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn modem_switch_sleep_start_int_raw(
        &mut self,
    ) -> MODEM_SWITCH_SLEEP_START_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        MODEM_SWITCH_SLEEP_START_INT_RAW_W::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn active_switch_sleep_start_int_raw(
        &mut self,
    ) -> ACTIVE_SWITCH_SLEEP_START_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
        ACTIVE_SWITCH_SLEEP_START_INT_RAW_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn hp_sw_trigger_int_raw(&mut self) -> HP_SW_TRIGGER_INT_RAW_W<'_, LP_INT_RAW_SPEC> {
