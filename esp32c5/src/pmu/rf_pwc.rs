...
#[doc = "Field `XPD_CKGEN5G` reader - need_des"]
pub type XPD_CKGEN5G_R = crate::BitReader;
#[doc = "Field `XPD_CKGEN5G` writer - need_des"]
pub type XPD_CKGEN5G_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `XPD_TC5G_I2C` reader - need_des"]
pub type XPD_TC5G_I2C_R = crate::BitReader;
#[doc = "Field `XPD_TC5G_I2C` writer - need_des"]
pub type XPD_TC5G_I2C_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `XPD_RX5G_I2C` reader - need_des"]
pub type XPD_RX5G_I2C_R = crate::BitReader;
#[doc = "Field `XPD_RX5G_I2C` writer - need_des"]
pub type XPD_RX5G_I2C_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn xpd_ckgen5g(&self) -> XPD_CKGEN5G_R {
        XPD_CKGEN5G_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
    pub fn xpd_tc5g_i2c(&self) -> XPD_TC5G_I2C_R {
        XPD_TC5G_I2C_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
    pub fn xpd_rx5g_i2c(&self) -> XPD_RX5G_I2C_R {
        XPD_RX5G_I2C_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RF_PWC")
            .field("xpd_ckgen5g", &self.xpd_ckgen5g())
            .field("xpd_tc5g_i2c", &self.xpd_tc5g_i2c())
            .field("xpd_rx5g_i2c", &self.xpd_rx5g_i2c())
...
impl W {
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn xpd_ckgen5g(&mut self) -> XPD_CKGEN5G_W<'_, RF_PWC_SPEC> {
        XPD_CKGEN5G_W::new(self, 23)
    }
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
