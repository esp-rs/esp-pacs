...
#[doc = "Field `HP_SLEEP_HP_REGULATOR_SLP_CONNECT_EN` reader - need_des"]
pub type HP_SLEEP_HP_REGULATOR_SLP_CONNECT_EN_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_HP_REGULATOR_SLP_CONNECT_EN` writer - need_des"]
pub type HP_SLEEP_HP_REGULATOR_SLP_CONNECT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 15 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_hp_regulator_slp_connect_en(&self) -> HP_SLEEP_HP_REGULATOR_SLP_CONNECT_EN_R {
        HP_SLEEP_HP_REGULATOR_SLP_CONNECT_EN_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_SLEEP_HP_REGULATOR0")
            .field(
                "hp_sleep_hp_regulator_slp_connect_en",
                &self.hp_sleep_hp_regulator_slp_connect_en(),
            )
            .field(
...
#[doc = "`reset()` method sets HP_SLEEP_HP_REGULATOR0 to value 0xc667_8000"]
