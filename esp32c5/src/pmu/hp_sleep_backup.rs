...
pub type HP_MODEM2SLEEP_BACKUP_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
pub type HP_ACTIVE2SLEEP_BACKUP_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
impl R {
    ...
    #[doc = "Bits 20:24 - need_des"]
    #[inline(always)]
    pub fn hp_modem2sleep_backup_mode(&self) -> HP_MODEM2SLEEP_BACKUP_MODE_R {
        HP_MODEM2SLEEP_BACKUP_MODE_R::new(((self.bits >> 20) & 0x1f) as u8)
    }
    #[doc = "Bits 25:29 - need_des"]
    #[inline(always)]
    pub fn hp_active2sleep_backup_mode(&self) -> HP_ACTIVE2SLEEP_BACKUP_MODE_R {
        HP_ACTIVE2SLEEP_BACKUP_MODE_R::new(((self.bits >> 25) & 0x1f) as u8)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
...
impl W {
    ...
    pub fn hp_modem2sleep_backup_mode(
        ...
        HP_MODEM2SLEEP_BACKUP_MODE_W::new(self, 20)
    }
    #[doc = "Bits 25:29 - need_des"]
    #[inline(always)]
    pub fn hp_active2sleep_backup_mode(
        ...
        HP_ACTIVE2SLEEP_BACKUP_MODE_W::new(self, 25)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
