...
#[doc = "Field `DG_HP_PD_WAIT_TIMER` reader - need_des"]
pub type DG_HP_PD_WAIT_TIMER_R = crate::FieldReader<u16>;
#[doc = "Field `DG_HP_PD_WAIT_TIMER` writer - need_des"]
pub type DG_HP_PD_WAIT_TIMER_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    ...
    #[inline(always)]
    pub fn dg_hp_pd_wait_timer(&self) -> DG_HP_PD_WAIT_TIMER_R {
        DG_HP_PD_WAIT_TIMER_R::new(((self.bits >> 23) & 0x01ff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("POWER_WAIT_TIMER0")
            ...
            .field("dg_hp_pd_wait_timer", &self.dg_hp_pd_wait_timer())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bits 23:31 - need_des"]
    #[inline(always)]
    pub fn dg_hp_pd_wait_timer(&mut self) -> DG_HP_PD_WAIT_TIMER_W<'_, POWER_WAIT_TIMER0_SPEC> {
        DG_HP_PD_WAIT_TIMER_W::new(self, 23)
    }
}
