...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_INT_ST")
            .field("lp_cpu_exc_int_st", &self.lp_cpu_exc_int_st())
            .field("sdio_idle_int_st", &self.sdio_idle_int_st())
            .field("sw_int_st", &self.sw_int_st())
            .field("soc_sleep_reject_int_st", &self.soc_sleep_reject_int_st())
