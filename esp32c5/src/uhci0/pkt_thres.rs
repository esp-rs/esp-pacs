...
#[doc = "Field `PKT_THRS` reader - Configures the maximum value of the packet length.\\\\Measurement unit: byte.\\\\Valid only when UHCI_HEAD_EN is 0."]
pub type PKT_THRS_R = crate::FieldReader<u16>;
#[doc = "Field `PKT_THRS` writer - Configures the maximum value of the packet length.\\\\Measurement unit: byte.\\\\Valid only when UHCI_HEAD_EN is 0."]
pub type PKT_THRS_W<'a, REG> = crate::FieldWriter<'a, REG, 13, u16>;
impl R {
    #[doc = "Bits 0:12 - Configures the maximum value of the packet length.\\\\Measurement unit: byte.\\\\Valid only when UHCI_HEAD_EN is 0."]
    #[inline(always)]
