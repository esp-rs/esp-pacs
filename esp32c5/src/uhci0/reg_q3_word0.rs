...
#[doc = "Field `SEND_Q3_WORD0` reader - Data to be transmitted in Q3 register."]
pub type SEND_Q3_WORD0_R = crate::FieldReader<u32>;
#[doc = "Field `SEND_Q3_WORD0` writer - Data to be transmitted in Q3 register."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REG_Q3_WORD0")
            .field("send_q3_word0", &self.send_q3_word0())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Data to be transmitted in Q3 register."]
    #[inline(always)]
    pub fn send_q3_word0(&mut self) -> SEND_Q3_WORD0_W<'_, REG_Q3_WORD0_SPEC> {
        SEND_Q3_WORD0_W::new(self, 0)
    }
}
#[doc = "Q3 WORD0 quick send register\n\nYou can [`read`](crate::Reg::read) this register and get [`reg_q3_word0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`reg_q3_word0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
