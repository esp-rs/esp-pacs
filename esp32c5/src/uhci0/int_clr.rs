...
impl W {
    ...
    #[inline(always)]
    pub fn rx_start_int_clr(&mut self) -> RX_START_INT_CLR_W<'_, INT_CLR_SPEC> {
        RX_START_INT_CLR_W::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 to clear UHCI_TX_START_INT."]
    #[inline(always)]
    pub fn tx_start_int_clr(&mut self) -> TX_START_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn send_s_reg_q_int_clr(&mut self) -> SEND_S_REG_Q_INT_CLR_W<'_, INT_CLR_SPEC> {
        SEND_S_REG_Q_INT_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - Write 1 to clear UHCI_SEND_A_REG_Q_INT."]
    #[inline(always)]
    pub fn send_a_reg_q_int_clr(&mut self) -> SEND_A_REG_Q_INT_CLR_W<'_, INT_CLR_SPEC> {
        SEND_A_REG_Q_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to clear UHCI_OUTLINK_EOF_ERR_INT."]
    #[inline(always)]
    pub fn outlink_eof_err_int_clr(&mut self) -> OUTLINK_EOF_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
        OUTLINK_EOF_ERR_INT_CLR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to clear UHCI_APP_CTRL0_INT."]
    #[inline(always)]
    pub fn app_ctrl0_int_clr(&mut self) -> APP_CTRL0_INT_CLR_W<'_, INT_CLR_SPEC> {
        APP_CTRL0_INT_CLR_W::new(self, 7)
    }
    #[doc = "Bit 8 - Write 1 to clear UHCI_APP_CTRL1_INT."]
    #[inline(always)]
    pub fn app_ctrl1_int_clr(&mut self) -> APP_CTRL1_INT_CLR_W<'_, INT_CLR_SPEC> {
