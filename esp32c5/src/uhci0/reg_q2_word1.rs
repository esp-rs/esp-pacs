...
#[doc = "Field `SEND_Q2_WORD1` reader - Data to be transmitted in Q2 register."]
pub type SEND_Q2_WORD1_R = crate::FieldReader<u32>;
#[doc = "Field `SEND_Q2_WORD1` writer - Data to be transmitted in Q2 register."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REG_Q2_WORD1")
            .field("send_q2_word1", &self.send_q2_word1())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Data to be transmitted in Q2 register."]
    #[inline(always)]
    pub fn send_q2_word1(&mut self) -> SEND_Q2_WORD1_W<'_, REG_Q2_WORD1_SPEC> {
        SEND_Q2_WORD1_W::new(self, 0)
    }
}
#[doc = "Q2 WORD1 quick send register\n\nYou can [`read`](crate::Reg::read) this register and get [`reg_q2_word1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`reg_q2_word1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
