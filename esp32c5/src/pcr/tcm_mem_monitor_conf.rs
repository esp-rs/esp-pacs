...
#[doc = "Field `TCM_MEM_MONITOR_RST_EN` reader - Set 0 to reset tcm_mem_monitor module"]
pub type TCM_MEM_MONITOR_RST_EN_R = crate::BitReader;
#[doc = "Field `TCM_MEM_MONITOR_RST_EN` writer - Set 0 to reset tcm_mem_monitor module"]
