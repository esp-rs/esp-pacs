...
#[doc = "Field `WDT_CLK_SEL` reader - Configures the clock source of WDT in Timer Group 0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
pub type WDT_CLK_SEL_R = crate::FieldReader;
#[doc = "Field `WDT_CLK_SEL` writer - Configures the clock source of WDT in Timer Group 0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
