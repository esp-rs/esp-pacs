...
#[doc = "Field `UART0_MEM_FORCE_PU` reader - Set this bit to force power up UART0 memory."]
pub type UART0_MEM_FORCE_PU_R = crate::BitReader;
#[doc = "Field `UART0_MEM_FORCE_PU` writer - Set this bit to force power up UART0 memory."]
pub type UART0_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `UART0_MEM_FORCE_PD` reader - Set this bit to force power down UART0 memory."]
pub type UART0_MEM_FORCE_PD_R = crate::BitReader;
#[doc = "Field `UART0_MEM_FORCE_PD` writer - Set this bit to force power down UART0 memory."]
