...
#[doc = "Field `LEDC_MEM_FORCE_PU` reader - Set this bit to force power up LEDC memory."]
pub type LEDC_MEM_FORCE_PU_R = crate::BitReader;
#[doc = "Field `LEDC_MEM_FORCE_PU` writer - Set this bit to force power up LEDC memory."]
pub type LEDC_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LEDC_MEM_FORCE_PD` reader - Set this bit to force power down LEDC memory."]
pub type LEDC_MEM_FORCE_PD_R = crate::BitReader;
#[doc = "Field `LEDC_MEM_FORCE_PD` writer - Set this bit to force power down LEDC memory."]
pub type LEDC_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 1 - Set this bit to force power up LEDC memory."]
    #[inline(always)]
    pub fn ledc_mem_force_pu(&self) -> LEDC_MEM_FORCE_PU_R {
        LEDC_MEM_FORCE_PU_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Set this bit to force power down LEDC memory."]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 1 - Set this bit to force power up LEDC memory."]
    #[inline(always)]
    pub fn ledc_mem_force_pu(&mut self) -> LEDC_MEM_FORCE_PU_W<'_, LEDC_PD_CTRL_SPEC> {
        LEDC_MEM_FORCE_PU_W::new(self, 1)
    }
    #[doc = "Bit 2 - Set this bit to force power down LEDC memory."]
    #[inline(always)]
    pub fn ledc_mem_force_pd(&mut self) -> LEDC_MEM_FORCE_PD_W<'_, LEDC_PD_CTRL_SPEC> {
...
#[doc = "`reset()` method sets LEDC_PD_CTRL to value 0x04"]
