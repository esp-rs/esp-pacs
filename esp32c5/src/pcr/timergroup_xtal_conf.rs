...
#[doc = "Field `TG0_XTAL_RST_EN` reader - Set 0 to reset timer_group0 xtal clock domain"]
pub type TG0_XTAL_RST_EN_R = crate::BitReader;
#[doc = "Field `TG0_XTAL_RST_EN` writer - Set 0 to reset timer_group0 xtal clock domain"]
pub type TG0_XTAL_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TG1_XTAL_RST_EN` reader - Set 0 to reset timer_group1 xtal clock domain"]
pub type TG1_XTAL_RST_EN_R = crate::BitReader;
#[doc = "Field `TG1_XTAL_RST_EN` writer - Set 0 to reset timer_group1 xtal clock domain"]
...
impl R {
    #[doc = "Bit 0 - Set 0 to reset timer_group0 xtal clock domain"]
    #[inline(always)]
    pub fn tg0_xtal_rst_en(&self) -> TG0_XTAL_RST_EN_R {
        TG0_XTAL_RST_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set 0 to reset timer_group1 xtal clock domain"]
    #[inline(always)]
