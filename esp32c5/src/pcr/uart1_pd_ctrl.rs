...
#[doc = "Field `UART1_MEM_FORCE_PU` reader - Set this bit to force power up UART1 memory."]
pub type UART1_MEM_FORCE_PU_R = crate::BitReader;
#[doc = "Field `UART1_MEM_FORCE_PU` writer - Set this bit to force power up UART1 memory."]
pub type UART1_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `UART1_MEM_FORCE_PD` reader - Set this bit to force power down UART1 memory."]
pub type UART1_MEM_FORCE_PD_R = crate::BitReader;
#[doc = "Field `UART1_MEM_FORCE_PD` writer - Set this bit to force power down UART1 memory."]
pub type UART1_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 1 - Set this bit to force power up UART1 memory."]
    #[inline(always)]
    pub fn uart1_mem_force_pu(&self) -> UART1_MEM_FORCE_PU_R {
        UART1_MEM_FORCE_PU_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Set this bit to force power down UART1 memory."]
    #[inline(always)]
