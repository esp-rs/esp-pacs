...
#[doc = "Field `SPI2_CLKM_SEL` reader - Configures the clock source of SPI2.\\\\ 0 (default): XTAL_CLK\\\\ 1: PLL_F160M_CLK\\\\ 2: RC_FAST_CLK\\\\ 3: PLL_F120M_CLK\\\\"]
pub type SPI2_CLKM_SEL_R = crate::FieldReader;
#[doc = "Field `SPI2_CLKM_SEL` writer - Configures the clock source of SPI2.\\\\ 0 (default): XTAL_CLK\\\\ 1: PLL_F160M_CLK\\\\ 2: RC_FAST_CLK\\\\ 3: PLL_F120M_CLK\\\\"]
