...
#[doc = "Field `SYSTIMER_FUNC_CLK_SEL` reader - Configures the clock source of System Timer.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
pub type SYSTIMER_FUNC_CLK_SEL_R = crate::BitReader;
#[doc = "Field `SYSTIMER_FUNC_CLK_SEL` writer - Configures the clock source of System Timer.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
...
impl R {
    #[doc = "Bit 20 - Configures the clock source of System Timer.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\"]
    #[inline(always)]
