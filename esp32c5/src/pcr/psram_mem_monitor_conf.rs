...
#[doc = "Field `PSRAM_MEM_MONITOR_RST_EN` reader - Set 0 to reset psram_mem_monitor module"]
pub type PSRAM_MEM_MONITOR_RST_EN_R = crate::BitReader;
#[doc = "Field `PSRAM_MEM_MONITOR_RST_EN` writer - Set 0 to reset psram_mem_monitor module"]
