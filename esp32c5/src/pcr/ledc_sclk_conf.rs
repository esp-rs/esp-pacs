...
#[doc = "Field `LEDC_SCLK_SEL` reader - Configures the clock source of LEDC.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
pub type LEDC_SCLK_SEL_R = crate::FieldReader;
#[doc = "Field `LEDC_SCLK_SEL` writer - Configures the clock source of LEDC.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
...
impl R {
    #[doc = "Bits 20:21 - Configures the clock source of LEDC.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
    #[inline(always)]
...
#[doc = "`reset()` method sets LEDC_SCLK_CONF to value 0"]
