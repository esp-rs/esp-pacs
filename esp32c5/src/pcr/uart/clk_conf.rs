...
#[doc = "Field `SCLK_SEL` reader - Configures the clock source of UART0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
pub type SCLK_SEL_R = crate::FieldReader;
#[doc = "Field `SCLK_SEL` writer - Configures the clock source of UART0.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
...
#[doc = "`reset()` method sets CLK_CONF to value 0x0040_0000"]
