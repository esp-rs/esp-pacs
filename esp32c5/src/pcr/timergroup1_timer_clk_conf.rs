...
#[doc = "Field `TG1_TIMER_CLK_SEL` reader - Configures the clock source of general-purpose timers in Timer Group 1.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
pub type TG1_TIMER_CLK_SEL_R = crate::FieldReader;
#[doc = "Field `TG1_TIMER_CLK_SEL` writer - Configures the clock source of general-purpose timers in Timer Group 1.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
...
impl R {
    #[doc = "Bits 20:21 - Configures the clock source of general-purpose timers in Timer Group 1.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
    #[inline(always)]
...
impl W {
    ...
    pub fn tg1_timer_clk_sel(
        &mut self,
    ) -> TG1_TIMER_CLK_SEL_W<'_, TIMERGROUP1_TIMER_CLK_CONF_SPEC> {
        TG1_TIMER_CLK_SEL_W::new(self, 20)
    }
    #[doc = "Bit 22 - Set 1 to enable timer_group1 timer clock"]
    #[inline(always)]
    pub fn tg1_timer_clk_en(&mut self) -> TG1_TIMER_CLK_EN_W<'_, TIMERGROUP1_TIMER_CLK_CONF_SPEC> {
        TG1_TIMER_CLK_EN_W::new(self, 22)
    }
}
#[doc = "TIMERGROUP1_TIMER_CLK configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`timergroup1_timer_clk_conf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timergroup1_timer_clk_conf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
