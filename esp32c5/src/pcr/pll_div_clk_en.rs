...
#[doc = "Field `PLL_60M_CLK_EN` reader - This field is used to open 60 MHz clock (div8 of SPLL) drived from SPLL. 0: close, 1: open(default). Only avaliable when high-speed clock-source SPLL is active."]
pub type PLL_60M_CLK_EN_R = crate::BitReader;
#[doc = "Field `PLL_60M_CLK_EN` writer - This field is used to open 60 MHz clock (div8 of SPLL) drived from SPLL. 0: close, 1: open(default). Only avaliable when high-speed clock-source SPLL is active."]
pub type PLL_60M_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `PLL_12M_CLK_EN` reader - This field is used to open 12 MHz clock (div40 of SPLL) drived from SPLL. 0: close, 1: open(default). Only avaliable when high-speed clock-source SPLL is active."]
pub type PLL_12M_CLK_EN_R = crate::BitReader;
#[doc = "Field `PLL_12M_CLK_EN` writer - This field is used to open 12 MHz clock (div40 of SPLL) drived from SPLL. 0: close, 1: open(default). Only avaliable when high-speed clock-source SPLL is active."]
pub type PLL_12M_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn pll_60m_clk_en(&self) -> PLL_60M_CLK_EN_R {
        PLL_60M_CLK_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    pub fn pll_48m_clk_en(&self) -> PLL_48M_CLK_EN_R {
        PLL_48M_CLK_EN_R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    pub fn pll_40m_clk_en(&self) -> PLL_40M_CLK_EN_R {
        PLL_40M_CLK_EN_R::new(((self.bits >> 6) & 1) != 0)
    }
    ...
    pub fn pll_20m_clk_en(&self) -> PLL_20M_CLK_EN_R {
        PLL_20M_CLK_EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn pll_12m_clk_en(&self) -> PLL_12M_CLK_EN_R {
        PLL_12M_CLK_EN_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
#[doc = "`reset()` method sets PLL_DIV_CLK_EN to value 0x01ff"]
