...
#[doc = "Field `IOMUX_FUNC_CLK_SEL` reader - Configures the clock source of IO MUX.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
pub type IOMUX_FUNC_CLK_SEL_R = crate::FieldReader;
#[doc = "Field `IOMUX_FUNC_CLK_SEL` writer - Configures the clock source of IO MUX.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
...
impl R {
    #[doc = "Bits 20:21 - Configures the clock source of IO MUX.\\\\ 0 (default): XTAL_CLK\\\\ 1: RC_FAST_CLK\\\\ 2: PLL_F80M_CLK\\\\"]
    #[inline(always)]
