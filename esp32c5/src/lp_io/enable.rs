...
#[doc = "Field `DATA` reader - Configures whether or not to enable the output of GPIO0 ~ GPIO7.\\\\ 0: Not enable\\\\ 1: Enable\\\\ bit0 ~ bit7 are corresponding to GPIO0 ~ GPIO7.\\\\"]
pub type DATA_R = crate::FieldReader;
#[doc = "Field `DATA` writer - Configures whether or not to enable the output of GPIO0 ~ GPIO7.\\\\ 0: Not enable\\\\ 1: Enable\\\\ bit0 ~ bit7 are corresponding to GPIO0 ~ GPIO7.\\\\"]
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures whether or not to enable the output of GPIO0 ~ GPIO7.\\\\ 0: Not enable\\\\ 1: Enable\\\\ bit0 ~ bit7 are corresponding to GPIO0 ~ GPIO7.\\\\"]
    #[inline(always)]
