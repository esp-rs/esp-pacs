...
#[doc = "Field `DATA_ORIG` reader - Configures the output of GPIO0 ~ GPIO7.\\\\ 0: Low level\\\\ 1: High level\\\\ bit0 ~ bit7 are corresponding to GPIO0 ~ GPIO7.\\\\"]
pub type DATA_ORIG_R = crate::FieldReader;
#[doc = "Field `DATA_ORIG` writer - Configures the output of GPIO0 ~ GPIO7.\\\\ 0: Low level\\\\ 1: High level\\\\ bit0 ~ bit7 are corresponding to GPIO0 ~ GPIO7.\\\\"]
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures the output of GPIO0 ~ GPIO7.\\\\ 0: Low level\\\\ 1: High level\\\\ bit0 ~ bit7 are corresponding to GPIO0 ~ GPIO7.\\\\"]
    #[inline(always)]
