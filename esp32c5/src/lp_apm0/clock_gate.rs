...
#[doc = "Field `CLK_EN` reader - Configures whether to keep the clock always on.\\\\ 0: enable automatic clock gating \\\\ 1: keep the clock always on \\\\"]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Configures whether to keep the clock always on.\\\\ 0: enable automatic clock gating \\\\ 1: keep the clock always on \\\\"]
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether to keep the clock always on.\\\\ 0: enable automatic clock gating \\\\ 1: keep the clock always on \\\\"]
    #[inline(always)]
