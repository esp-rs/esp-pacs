...
#[doc = "Field `M_APM(0-1)` reader - Configures to enable APM M%s interrupt.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M_APM_R = crate::BitReader;
#[doc = "Field `M_APM(0-1)` writer - Configures to enable APM M%s interrupt.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M_APM_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Configures to enable APM M(0-1) interrupt.\\\\ 0: disable \\\\ 1: enable \\\\"]
    #[doc = ""]
