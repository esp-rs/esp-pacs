...
#[doc = "Field `ICACHE2_FAIL_ID` reader - The register records the ID of fail-access when cache2 accesses ICache."]
pub type ICACHE2_FAIL_ID_R = crate::FieldReader<u16>;
#[doc = "Field `ICACHE2_FAIL_ATTR` reader - The register records the attribution of fail-access when cache2 accesses ICache."]
pub type ICACHE2_FAIL_ATTR_R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:15 - The register records the ID of fail-access when cache2 accesses ICache."]
    #[inline(always)]
    pub fn icache2_fail_id(&self) -> ICACHE2_FAIL_ID_R {
        ICACHE2_FAIL_ID_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - The register records the attribution of fail-access when cache2 accesses ICache."]
    #[inline(always)]
