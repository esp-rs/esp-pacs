...
#[doc = "Field `ICACHE2_MISS_DISABLE_ACCESS` writer - Reserved"]
pub type ICACHE2_MISS_DISABLE_ACCESS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_MISS_DISABLE_ACCESS` reader - Set this bit as 1 to disable early restart of DCache"]
pub type CACHE_MISS_DISABLE_ACCESS_R = crate::BitReader;
#[doc = "Field `CACHE_MISS_DISABLE_ACCESS` writer - Set this bit as 1 to disable early restart of DCache"]
...
impl R {
    ...
    #[doc = "Bit 4 - Set this bit as 1 to disable early restart of DCache"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn icache2_miss_disable_access(
        &mut self,
    ) -> ICACHE2_MISS_DISABLE_ACCESS_W<'_, CACHE_MISS_ACCESS_CTRL_SPEC> {
        ICACHE2_MISS_DISABLE_ACCESS_W::new(self, 2)
    }
    #[doc = "Bit 4 - Set this bit as 1 to disable early restart of DCache"]
    #[inline(always)]
