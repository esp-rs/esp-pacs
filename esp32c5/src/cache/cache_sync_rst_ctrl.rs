...
#[doc = "Field `ICACHE2_SYNC_RST` writer - Reserved"]
pub type ICACHE2_SYNC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_SYNC_RST` reader - set this bit to reset sync-logic inside Cache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
pub type CACHE_SYNC_RST_R = crate::BitReader;
#[doc = "Field `CACHE_SYNC_RST` writer - set this bit to reset sync-logic inside Cache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
...
impl R {
    ...
    #[doc = "Bit 4 - set this bit to reset sync-logic inside Cache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn icache2_sync_rst(&mut self) -> ICACHE2_SYNC_RST_W<'_, CACHE_SYNC_RST_CTRL_SPEC> {
        ICACHE2_SYNC_RST_W::new(self, 2)
    }
    #[doc = "Bit 4 - set this bit to reset sync-logic inside Cache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
    #[inline(always)]
    pub fn cache_sync_rst(&mut self) -> CACHE_SYNC_RST_W<'_, CACHE_SYNC_RST_CTRL_SPEC> {
