...
#[doc = "Field `LOCK_ADDR` reader - Those bits are used to configure the start address of the lock/unlock operation, which should be used together with CACHE_LOCK_SIZE_REG"]
pub type LOCK_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `LOCK_ADDR` writer - Those bits are used to configure the start address of the lock/unlock operation, which should be used together with CACHE_LOCK_SIZE_REG"]
