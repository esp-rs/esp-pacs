...
#[doc = "Field `IBUS3_CONFLICT_CNT` reader - The register records the number of access-conflicts when bus3 accesses ICache3."]
pub type IBUS3_CONFLICT_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of access-conflicts when bus3 accesses ICache3."]
    #[inline(always)]
