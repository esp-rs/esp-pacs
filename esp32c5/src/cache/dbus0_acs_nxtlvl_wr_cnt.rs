...
#[doc = "Field `BUS0_NXTLVL_WR_CNT` reader - The register records the number of write back when bus0 accesses Cache."]
pub type BUS0_NXTLVL_WR_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of write back when bus0 accesses Cache."]
    #[inline(always)]
