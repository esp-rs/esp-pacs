...
#[doc = "Field `DBUS1_NXTLVL_RD_CNT` reader - The register records the number of times that Cache accesses L2-Cache due to bus1 accessing Cache."]
pub type DBUS1_NXTLVL_RD_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of times that Cache accesses L2-Cache due to bus1 accessing Cache."]
    #[inline(always)]
