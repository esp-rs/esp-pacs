...
#[doc = "Field `CACHE_PRELOAD_SIZE` reader - Those bits are used to configure the size of the first section of prelock on Cache, which should be used together with CACHE_PRELOAD_ADDR_REG"]
pub type CACHE_PRELOAD_SIZE_R = crate::FieldReader<u16>;
#[doc = "Field `CACHE_PRELOAD_SIZE` writer - Those bits are used to configure the size of the first section of prelock on Cache, which should be used together with CACHE_PRELOAD_ADDR_REG"]
pub type CACHE_PRELOAD_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    #[doc = "Bits 0:13 - Those bits are used to configure the size of the first section of prelock on Cache, which should be used together with CACHE_PRELOAD_ADDR_REG"]
    #[inline(always)]
