...
#[doc = "Field `BUS1_MISS_CNT` reader - The register records the number of missing when bus1 accesses Cache."]
pub type BUS1_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of missing when bus1 accesses Cache."]
    #[inline(always)]
