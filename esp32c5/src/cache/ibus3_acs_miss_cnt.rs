...
#[doc = "Field `IBUS3_MISS_CNT` reader - The register records the number of missing when bus3 accesses ICache3."]
pub type IBUS3_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of missing when bus3 accesses ICache3."]
    #[inline(always)]
