...
#[doc = "Field `CACHE_AUTOLOAD_SCT1_ADDR` reader - Those bits are used to configure the start address of the second section for autoload operation on Cache. Note that it should be used together with CACHE_AUTOLOAD_SCT1_SIZE and CACHE_AUTOLOAD_SCT1_ENA."]
pub type CACHE_AUTOLOAD_SCT1_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `CACHE_AUTOLOAD_SCT1_ADDR` writer - Those bits are used to configure the start address of the second section for autoload operation on Cache. Note that it should be used together with CACHE_AUTOLOAD_SCT1_SIZE and CACHE_AUTOLOAD_SCT1_ENA."]
pub type CACHE_AUTOLOAD_SCT1_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Those bits are used to configure the start address of the second section for autoload operation on Cache. Note that it should be used together with CACHE_AUTOLOAD_SCT1_SIZE and CACHE_AUTOLOAD_SCT1_ENA."]
    #[inline(always)]
...
impl W {
    ...
    pub fn cache_autoload_sct1_addr(
        &mut self,
    ) -> CACHE_AUTOLOAD_SCT1_ADDR_W<'_, CACHE_AUTOLOAD_SCT1_ADDR_SPEC> {
