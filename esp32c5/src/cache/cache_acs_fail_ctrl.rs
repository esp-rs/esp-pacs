...
#[doc = "Field `ICACHE2_ACS_FAIL_CHECK_MODE` reader - The bit is used to configure icache2 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type ICACHE2_ACS_FAIL_CHECK_MODE_R = crate::BitReader;
#[doc = "Field `ICACHE2_ACS_FAIL_CHECK_MODE` writer - The bit is used to configure icache2 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type ICACHE2_ACS_FAIL_CHECK_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_ACS_FAIL_CHECK_MODE` reader - The bit is used to configure cache access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type CACHE_ACS_FAIL_CHECK_MODE_R = crate::BitReader;
#[doc = "Field `CACHE_ACS_FAIL_CHECK_MODE` writer - The bit is used to configure cache access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type CACHE_ACS_FAIL_CHECK_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 2 - The bit is used to configure icache2 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    #[inline(always)]
    pub fn icache2_acs_fail_check_mode(&self) -> ICACHE2_ACS_FAIL_CHECK_MODE_R {
        ICACHE2_ACS_FAIL_CHECK_MODE_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 4 - The bit is used to configure cache access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 2 - The bit is used to configure icache2 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    #[inline(always)]
    pub fn icache2_acs_fail_check_mode(
        &mut self,
    ) -> ICACHE2_ACS_FAIL_CHECK_MODE_W<'_, CACHE_ACS_FAIL_CTRL_SPEC> {
        ICACHE2_ACS_FAIL_CHECK_MODE_W::new(self, 2)
    }
    #[doc = "Bit 4 - The bit is used to configure cache access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    #[inline(always)]
