...
#[doc = "Field `IBUS2_MISS_CNT` reader - The register records the number of missing when bus2 accesses ICache2."]
pub type IBUS2_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of missing when bus2 accesses ICache2."]
    #[inline(always)]
