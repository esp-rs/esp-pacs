...
#[doc = "Field `ICACHE2_FAIL_INT_ENA` writer - Reserved"]
pub type ICACHE2_FAIL_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_FAIL_INT_ENA` reader - The bit is used to enable interrupt of access fail that occurs in DCache due to cpu accesses DCache."]
pub type CACHE_FAIL_INT_ENA_R = crate::BitReader;
#[doc = "Field `CACHE_FAIL_INT_ENA` writer - The bit is used to enable interrupt of access fail that occurs in DCache due to cpu accesses DCache."]
...
impl R {
    ...
    #[doc = "Bit 4 - The bit is used to enable interrupt of access fail that occurs in DCache due to cpu accesses DCache."]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn icache2_fail_int_ena(
        &mut self,
    ) -> ICACHE2_FAIL_INT_ENA_W<'_, CACHE_ACS_FAIL_INT_ENA_SPEC> {
        ICACHE2_FAIL_INT_ENA_W::new(self, 2)
    }
    #[doc = "Bit 4 - The bit is used to enable interrupt of access fail that occurs in DCache due to cpu accesses DCache."]
    #[inline(always)]
