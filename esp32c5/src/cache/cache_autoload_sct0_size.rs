...
#[doc = "Field `CACHE_AUTOLOAD_SCT0_SIZE` reader - Those bits are used to configure the size of the first section for autoload operation on Cache. Note that it should be used together with CACHE_AUTOLOAD_SCT0_ADDR and CACHE_AUTOLOAD_SCT0_ENA."]
pub type CACHE_AUTOLOAD_SCT0_SIZE_R = crate::FieldReader<u32>;
#[doc = "Field `CACHE_AUTOLOAD_SCT0_SIZE` writer - Those bits are used to configure the size of the first section for autoload operation on Cache. Note that it should be used together with CACHE_AUTOLOAD_SCT0_ADDR and CACHE_AUTOLOAD_SCT0_ENA."]
pub type CACHE_AUTOLOAD_SCT0_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
    #[doc = "Bits 0:24 - Those bits are used to configure the size of the first section for autoload operation on Cache. Note that it should be used together with CACHE_AUTOLOAD_SCT0_ADDR and CACHE_AUTOLOAD_SCT0_ENA."]
    #[inline(always)]
