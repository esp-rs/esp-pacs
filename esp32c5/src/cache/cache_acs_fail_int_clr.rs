...
#[doc = "Field `CACHE_FAIL_INT_CLR` writer - The bit is used to clear interrupt of access fail that occurs in DCache due to cpu accesses DCache."]
...
impl W {
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn icache2_fail_int_clr(
        &mut self,
    ) -> ICACHE2_FAIL_INT_CLR_W<'_, CACHE_ACS_FAIL_INT_CLR_SPEC> {
        ICACHE2_FAIL_INT_CLR_W::new(self, 2)
    }
    #[doc = "Bit 4 - The bit is used to clear interrupt of access fail that occurs in DCache due to cpu accesses DCache."]
    #[inline(always)]
    pub fn cache_fail_int_clr(&mut self) -> CACHE_FAIL_INT_CLR_W<'_, CACHE_ACS_FAIL_INT_CLR_SPEC> {
