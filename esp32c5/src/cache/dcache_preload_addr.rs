...
#[doc = "Field `CACHE_PRELOAD_ADDR` reader - Those bits are used to configure the start address of preload on Cache, which should be used together with CACHE_PRELOAD_SIZE_REG"]
pub type CACHE_PRELOAD_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `CACHE_PRELOAD_ADDR` writer - Those bits are used to configure the start address of preload on Cache, which should be used together with CACHE_PRELOAD_SIZE_REG"]
pub type CACHE_PRELOAD_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Those bits are used to configure the start address of preload on Cache, which should be used together with CACHE_PRELOAD_SIZE_REG"]
    #[inline(always)]
