...
#[doc = "Field `CACHE_FAIL_ID` reader - The register records the ID of fail-access when cache accesses Cache."]
pub type CACHE_FAIL_ID_R = crate::FieldReader<u16>;
#[doc = "Field `CACHE_FAIL_ATTR` reader - The register records the attribution of fail-access when cache accesses Cache."]
pub type CACHE_FAIL_ATTR_R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:15 - The register records the ID of fail-access when cache accesses Cache."]
    #[inline(always)]
    pub fn cache_fail_id(&self) -> CACHE_FAIL_ID_R {
        CACHE_FAIL_ID_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - The register records the attribution of fail-access when cache accesses Cache."]
    #[inline(always)]
