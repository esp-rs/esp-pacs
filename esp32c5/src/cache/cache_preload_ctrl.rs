...
#[doc = "Field `CACHE_PRELOAD_ENA` reader - The bit is used to enable preload operation on Cache. It will be cleared by hardware automatically after preload operation is done."]
pub type CACHE_PRELOAD_ENA_R = crate::BitReader;
#[doc = "Field `CACHE_PRELOAD_ENA` writer - The bit is used to enable preload operation on Cache. It will be cleared by hardware automatically after preload operation is done."]
...
#[doc = "Field `CACHE_PRELOAD_RGID` reader - The bit is used to set the gid of cache preload."]
pub type CACHE_PRELOAD_RGID_R = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - The bit is used to enable preload operation on Cache. It will be cleared by hardware automatically after preload operation is done."]
    #[inline(always)]
    ...
    #[doc = "Bits 3:6 - The bit is used to set the gid of cache preload."]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - The bit is used to enable preload operation on Cache. It will be cleared by hardware automatically after preload operation is done."]
    #[inline(always)]
    pub fn cache_preload_ena(&mut self) -> CACHE_PRELOAD_ENA_W<'_, CACHE_PRELOAD_CTRL_SPEC> {
        CACHE_PRELOAD_ENA_W::new(self, 0)
    }
    #[doc = "Bit 2 - The bit is used to configure the direction of preload operation. 0: ascending, 1: descending."]
    #[inline(always)]
    pub fn cache_preload_order(&mut self) -> CACHE_PRELOAD_ORDER_W<'_, CACHE_PRELOAD_CTRL_SPEC> {
...
#[doc = "`reset()` method sets CACHE_PRELOAD_CTRL to value 0"]
