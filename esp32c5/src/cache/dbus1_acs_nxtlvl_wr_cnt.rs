...
#[doc = "Field `DBUS1_NXTLVL_WR_CNT` reader - The register records the number of write back when bus1 accesses Cache."]
pub type DBUS1_NXTLVL_WR_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of write back when bus1 accesses Cache."]
    #[inline(always)]
