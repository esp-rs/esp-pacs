...
#[doc = "Field `ICACHE2_FAIL_ADDR` reader - The register records the address of fail-access when cache2 accesses ICache."]
pub type ICACHE2_FAIL_ADDR_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the address of fail-access when cache2 accesses ICache."]
    #[inline(always)]
