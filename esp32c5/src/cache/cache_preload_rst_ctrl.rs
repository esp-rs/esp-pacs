...
#[doc = "Field `ICACHE2_PLD_RST` writer - Reserved"]
pub type ICACHE2_PLD_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_PLD_RST` reader - set this bit to reset preload-logic inside Cache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs."]
pub type CACHE_PLD_RST_R = crate::BitReader;
#[doc = "Field `CACHE_PLD_RST` writer - set this bit to reset preload-logic inside Cache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs."]
...
impl R {
    ...
    #[doc = "Bit 4 - set this bit to reset preload-logic inside Cache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs."]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn icache2_pld_rst(&mut self) -> ICACHE2_PLD_RST_W<'_, CACHE_PRELOAD_RST_CTRL_SPEC> {
        ICACHE2_PLD_RST_W::new(self, 2)
    }
    #[doc = "Bit 4 - set this bit to reset preload-logic inside Cache. Recommend that this should only be used to initialize preload-logic when some fatal error of preload-logic occurs."]
    #[inline(always)]
