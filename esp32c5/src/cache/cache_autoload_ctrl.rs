...
#[doc = "Field `CACHE_AUTOLOAD_ENA` reader - The bit is used to enable and disable autoload operation on Cache. 1: enable, 0: disable."]
pub type CACHE_AUTOLOAD_ENA_R = crate::BitReader;
#[doc = "Field `CACHE_AUTOLOAD_ENA` writer - The bit is used to enable and disable autoload operation on Cache. 1: enable, 0: disable."]
pub type CACHE_AUTOLOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_AUTOLOAD_DONE` reader - The bit is used to indicate whether autoload operation on Cache is finished or not. 0: not finished. 1: finished."]
pub type CACHE_AUTOLOAD_DONE_R = crate::BitReader;
#[doc = "Field `CACHE_AUTOLOAD_ORDER` reader - The bit is used to configure the direction of autoload operation on Cache. 0: ascending. 1: descending."]
pub type CACHE_AUTOLOAD_ORDER_R = crate::BitReader;
#[doc = "Field `CACHE_AUTOLOAD_ORDER` writer - The bit is used to configure the direction of autoload operation on Cache. 0: ascending. 1: descending."]
pub type CACHE_AUTOLOAD_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_AUTOLOAD_TRIGGER_MODE` reader - The field is used to configure trigger mode of autoload operation on Cache. 0/3: miss-trigger, 1: hit-trigger, 2: miss-hit-trigger."]
pub type CACHE_AUTOLOAD_TRIGGER_MODE_R = crate::FieldReader;
#[doc = "Field `CACHE_AUTOLOAD_TRIGGER_MODE` writer - The field is used to configure trigger mode of autoload operation on Cache. 0/3: miss-trigger, 1: hit-trigger, 2: miss-hit-trigger."]
pub type CACHE_AUTOLOAD_TRIGGER_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `CACHE_AUTOLOAD_SCT0_ENA` reader - The bit is used to enable the first section for autoload operation on Cache."]
pub type CACHE_AUTOLOAD_SCT0_ENA_R = crate::BitReader;
#[doc = "Field `CACHE_AUTOLOAD_SCT0_ENA` writer - The bit is used to enable the first section for autoload operation on Cache."]
pub type CACHE_AUTOLOAD_SCT0_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_AUTOLOAD_SCT1_ENA` reader - The bit is used to enable the second section for autoload operation on Cache."]
pub type CACHE_AUTOLOAD_SCT1_ENA_R = crate::BitReader;
#[doc = "Field `CACHE_AUTOLOAD_SCT1_ENA` writer - The bit is used to enable the second section for autoload operation on Cache."]
pub type CACHE_AUTOLOAD_SCT1_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - The bit is used to enable and disable autoload operation on Cache. 1: enable, 0: disable."]
    #[inline(always)]
    pub fn cache_autoload_ena(&self) -> CACHE_AUTOLOAD_ENA_R {
        CACHE_AUTOLOAD_ENA_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The bit is used to indicate whether autoload operation on Cache is finished or not. 0: not finished. 1: finished."]
    #[inline(always)]
    pub fn cache_autoload_done(&self) -> CACHE_AUTOLOAD_DONE_R {
        CACHE_AUTOLOAD_DONE_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The bit is used to configure the direction of autoload operation on Cache. 0: ascending. 1: descending."]
    #[inline(always)]
    pub fn cache_autoload_order(&self) -> CACHE_AUTOLOAD_ORDER_R {
        CACHE_AUTOLOAD_ORDER_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bits 3:4 - The field is used to configure trigger mode of autoload operation on Cache. 0/3: miss-trigger, 1: hit-trigger, 2: miss-hit-trigger."]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - The bit is used to enable the first section for autoload operation on Cache."]
    #[inline(always)]
    pub fn cache_autoload_sct0_ena(&self) -> CACHE_AUTOLOAD_SCT0_ENA_R {
        CACHE_AUTOLOAD_SCT0_ENA_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - The bit is used to enable the second section for autoload operation on Cache."]
    #[inline(always)]
...
#[doc = "`reset()` method sets CACHE_AUTOLOAD_CTRL to value 0"]
