...
#[doc = "Field `CACHE_PRELOCK_SCT1_ADDR` reader - Those bits are used to configure the start address of the second section of prelock on Cache, which should be used together with CACHE_PRELOCK_SCT1_SIZE_REG"]
pub type CACHE_PRELOCK_SCT1_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `CACHE_PRELOCK_SCT1_ADDR` writer - Those bits are used to configure the start address of the second section of prelock on Cache, which should be used together with CACHE_PRELOCK_SCT1_SIZE_REG"]
pub type CACHE_PRELOCK_SCT1_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Those bits are used to configure the start address of the second section of prelock on Cache, which should be used together with CACHE_PRELOCK_SCT1_SIZE_REG"]
    #[inline(always)]
...
impl W {
    ...
    pub fn cache_prelock_sct1_addr(
        &mut self,
    ) -> CACHE_PRELOCK_SCT1_ADDR_W<'_, DCACHE_PRELOCK_SCT1_ADDR_SPEC> {
