...
#[doc = "Field `BUS0_MISS_CNT` reader - The register records the number of missing when bus0 accesses Cache."]
pub type BUS0_MISS_CNT_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - The register records the number of missing when bus0 accesses Cache."]
    #[inline(always)]
