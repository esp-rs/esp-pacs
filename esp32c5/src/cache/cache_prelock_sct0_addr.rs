...
#[doc = "Field `CACHE_PRELOCK_SCT0_ADDR` reader - Those bits are used to configure the start address of the first section of prelock on Cache, which should be used together with CACHE_PRELOCK_SCT0_SIZE_REG"]
pub type CACHE_PRELOCK_SCT0_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `CACHE_PRELOCK_SCT0_ADDR` writer - Those bits are used to configure the start address of the first section of prelock on Cache, which should be used together with CACHE_PRELOCK_SCT0_SIZE_REG"]
pub type CACHE_PRELOCK_SCT0_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Those bits are used to configure the start address of the first section of prelock on Cache, which should be used together with CACHE_PRELOCK_SCT0_SIZE_REG"]
    #[inline(always)]
...
impl W {
    ...
    pub fn cache_prelock_sct0_addr(
        &mut self,
    ) -> CACHE_PRELOCK_SCT0_ADDR_W<'_, CACHE_PRELOCK_SCT0_ADDR_SPEC> {
