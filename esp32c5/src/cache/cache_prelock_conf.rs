...
#[doc = "Field `CACHE_PRELOCK_SCT0_EN` reader - The bit is used to enable the first section of prelock function on Cache."]
pub type CACHE_PRELOCK_SCT0_EN_R = crate::BitReader;
#[doc = "Field `CACHE_PRELOCK_SCT0_EN` writer - The bit is used to enable the first section of prelock function on Cache."]
pub type CACHE_PRELOCK_SCT0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_PRELOCK_SCT1_EN` reader - The bit is used to enable the second section of prelock function on Cache."]
pub type CACHE_PRELOCK_SCT1_EN_R = crate::BitReader;
#[doc = "Field `CACHE_PRELOCK_SCT1_EN` writer - The bit is used to enable the second section of prelock function on Cache."]
pub type CACHE_PRELOCK_SCT1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CACHE_PRELOCK_RGID` reader - The bit is used to set the gid of cache prelock."]
pub type CACHE_PRELOCK_RGID_R = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - The bit is used to enable the first section of prelock function on Cache."]
    #[inline(always)]
    pub fn cache_prelock_sct0_en(&self) -> CACHE_PRELOCK_SCT0_EN_R {
        CACHE_PRELOCK_SCT0_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The bit is used to enable the second section of prelock function on Cache."]
    #[inline(always)]
    pub fn cache_prelock_sct1_en(&self) -> CACHE_PRELOCK_SCT1_EN_R {
        CACHE_PRELOCK_SCT1_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:5 - The bit is used to set the gid of cache prelock."]
    #[inline(always)]
