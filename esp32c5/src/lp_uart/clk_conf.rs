...
#[doc = "Field `SCLK_EN` reader - Configures whether or not to enable LP UART RX clock.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type SCLK_EN_R = crate::BitReader;
#[doc = "Field `SCLK_EN` writer - Configures whether or not to enable LP UART RX clock.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
...
#[doc = "Field `RST_CORE` reader - Write 1 and then write 0 to reset LP UART RX."]
pub type RST_CORE_R = crate::BitReader;
#[doc = "Field `RST_CORE` writer - Write 1 and then write 0 to reset LP UART RX."]
