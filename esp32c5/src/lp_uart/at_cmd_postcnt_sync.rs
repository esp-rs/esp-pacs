...
#[doc = "Field `POST_IDLE_NUM` reader - Configures the interval between the last AT_CMD and subsequent data.\\\\Measurement unit: bit time (the time to transmit 1 bit)."]
pub type POST_IDLE_NUM_R = crate::FieldReader<u16>;
#[doc = "Field `POST_IDLE_NUM` writer - Configures the interval between the last AT_CMD and subsequent data.\\\\Measurement unit: bit time (the time to transmit 1 bit)."]
