...
#[doc = "Field `CTS_INV` reader - Configures whether or not to invert the level of LP UART CTS signal.\\\\ 0: Not invert\\\\ 1: Invert\\\\"]
pub type CTS_INV_R = crate::BitReader;
#[doc = "Field `CTS_INV` writer - Configures whether or not to invert the level of LP UART CTS signal.\\\\ 0: Not invert\\\\ 1: Invert\\\\"]
pub type CTS_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DSR_INV` reader - Configures whether or not to invert the level of LP UART DSR signal.\\\\ 0: Not invert\\\\ 1: Invert\\\\"]
pub type DSR_INV_R = crate::BitReader;
#[doc = "Field `DSR_INV` writer - Configures whether or not to invert the level of LP UART DSR signal.\\\\ 0: Not invert\\\\ 1: Invert\\\\"]
pub type DSR_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RTS_INV` reader - Configures whether or not to invert the level of LP UART RTS signal.\\\\ 0: Not invert\\\\ 1: Invert\\\\"]
pub type RTS_INV_R = crate::BitReader;
#[doc = "Field `RTS_INV` writer - Configures whether or not to invert the level of LP UART RTS signal.\\\\ 0: Not invert\\\\ 1: Invert\\\\"]
pub type RTS_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DTR_INV` reader - Configures whether or not to invert the level of LP UART DTR signal.\\\\ 0: Not invert\\\\ 1: Invert\\\\"]
pub type DTR_INV_R = crate::BitReader;
#[doc = "Field `DTR_INV` writer - Configures whether or not to invert the level of LP UART DTR signal.\\\\ 0: Not invert\\\\ 1: Invert\\\\"]
