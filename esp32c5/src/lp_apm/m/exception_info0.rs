...
#[doc = "Field `EXCEPTION_REGION` reader - Represents the region where an exception occurs."]
pub type EXCEPTION_REGION_R = crate::FieldReader;
#[doc = "Field `EXCEPTION_MODE` reader - Represents the master's security mode when an exception occurs."]
pub type EXCEPTION_MODE_R = crate::FieldReader;
#[doc = "Field `EXCEPTION_ID` reader - Represents master ID when an exception occurs."]
pub type EXCEPTION_ID_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - Represents the region where an exception occurs."]
    #[inline(always)]
    pub fn exception_region(&self) -> EXCEPTION_REGION_R {
        EXCEPTION_REGION_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 16:17 - Represents the master's security mode when an exception occurs."]
    #[inline(always)]
    pub fn exception_mode(&self) -> EXCEPTION_MODE_R {
        EXCEPTION_MODE_R::new(((self.bits >> 16) & 3) as u8)
    }
    #[doc = "Bits 18:22 - Represents master ID when an exception occurs."]
    #[inline(always)]
