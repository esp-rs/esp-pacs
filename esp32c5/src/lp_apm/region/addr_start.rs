...
#[doc = "Field `ADDR_START` reader - Configures the start address of region 0."]
pub type ADDR_START_R = crate::FieldReader<u32>;
#[doc = "Field `ADDR_START` writer - Configures the start address of region 0."]
pub type ADDR_START_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the start address of region 0."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Configures the start address of region 0."]
    #[inline(always)]
    pub fn addr_start(&mut self) -> ADDR_START_W<'_, ADDR_START_SPEC> {
