...
#[doc = "Field `ADDR_END` reader - Configures the end address of region 0."]
pub type ADDR_END_R = crate::FieldReader<u32>;
#[doc = "Field `ADDR_END` writer - Configures the end address of region 0."]
pub type ADDR_END_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the end address of region 0."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Configures the end address of region 0."]
    #[inline(always)]
    pub fn addr_end(&mut self) -> ADDR_END_W<'_, ADDR_END_SPEC> {
...
#[doc = "`reset()` method sets ADDR_END to value 0"]
