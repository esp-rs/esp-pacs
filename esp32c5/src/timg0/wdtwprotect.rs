...
#[doc = "Field `WDT_WKEY` reader - Configures a different value than its reset value to enable write protection."]
pub type WDT_WKEY_R = crate::FieldReader<u32>;
#[doc = "Field `WDT_WKEY` writer - Configures a different value than its reset value to enable write protection."]
pub type WDT_WKEY_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures a different value than its reset value to enable write protection."]
    #[inline(always)]
