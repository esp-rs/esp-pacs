...
#[doc = "Field `HOLD` reader - Configures the stage 0 timeout value. Valid only when write protection is disabled. \\\\ Measurement unit: mwdt_clk \\\\"]
pub type HOLD_R = crate::FieldReader<u32>;
#[doc = "Field `HOLD` writer - Configures the stage 0 timeout value. Valid only when write protection is disabled. \\\\ Measurement unit: mwdt_clk \\\\"]
...
impl W {
    #[doc = "Bits 0:31 - Configures the stage 0 timeout value. Valid only when write protection is disabled. \\\\ Measurement unit: mwdt_clk \\\\"]
    #[inline(always)]
    pub fn hold(&mut self) -> HOLD_W<WDTCONFIG_SPEC> {
        HOLD_W::new(self, 0)
    }
}
