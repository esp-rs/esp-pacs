...
#[doc = "Field `UPDATE` reader - Configures to latch the counter value. \\\\ 0: Latch \\\\ 1: Latch \\\\"]
pub type UPDATE_R = crate::BitReader;
#[doc = "Field `UPDATE` writer - Configures to latch the counter value. \\\\ 0: Latch \\\\ 1: Latch \\\\"]
