...
#[doc = "Field `EXCEPTION_REGION` reader - Represents exception region."]
pub type EXCEPTION_REGION_R = crate::FieldReader<u16>;
#[doc = "Field `EXCEPTION_MODE` reader - Represents exception mode."]
pub type EXCEPTION_MODE_R = crate::FieldReader;
#[doc = "Field `EXCEPTION_ID` reader - Represents exception id information."]
