...
#[doc = "Field `REGION_FILTER_EN` reader - Configure bit 0 (0-15) to enable region 0.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type REGION_FILTER_EN_R = crate::FieldReader<u16>;
#[doc = "Field `REGION_FILTER_EN` writer - Configure bit 0 (0-15) to enable region 0.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type REGION_FILTER_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Configure bit 0 (0-15) to enable region 0.\\\\ 0: disable \\\\ 1: enable \\\\"]
    #[inline(always)]
