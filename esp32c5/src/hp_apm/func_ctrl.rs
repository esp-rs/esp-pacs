...
impl W {
    ...
    #[doc = "Bit 2 - PMS M2 function enable"]
    #[inline(always)]
    pub fn m2_func_en(&mut self) -> M2_FUNC_EN_W<FUNC_CTRL_SPEC> {
        M2_FUNC_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - PMS M3 function enable"]
    #[inline(always)]
    pub fn m3_func_en(&mut self) -> M3_FUNC_EN_W<FUNC_CTRL_SPEC> {
        M3_FUNC_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - PMS M4 function enable"]
    #[inline(always)]
    pub fn m4_func_en(&mut self) -> M4_FUNC_EN_W<FUNC_CTRL_SPEC> {
