...
#[doc = "Field `APB2OTP_BLOCK10_W10` reader - Otp block10 word10 data."]
pub type APB2OTP_BLOCK10_W10_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block10 word10 data."]
    #[inline(always)]
    pub fn apb2otp_block10_w10(&self) -> APB2OTP_BLOCK10_W10_R {
        APB2OTP_BLOCK10_W10_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB2OTP_BLK10_W10")
            .field("apb2otp_block10_w10", &self.apb2otp_block10_w10())
            .finish()
    }
}
