...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB2OTP_EN")
            .field("apb2otp_apb2otp_en", &self.apb2otp_apb2otp_en())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - Apb2otp mode enable signal."]
    #[inline(always)]
    pub fn apb2otp_apb2otp_en(&mut self) -> APB2OTP_APB2OTP_EN_W<'_, APB2OTP_EN_SPEC> {
        APB2OTP_APB2OTP_EN_W::new(self, 0)
    }
}
#[doc = "eFuse apb2otp enable configuration register.\n\nYou can [`read`](crate::Reg::read) this register and get [`apb2otp_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`apb2otp_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
