...
#[doc = "Field `BLOCK10_W10` reader - Otp block10 word10 data."]
pub type BLOCK10_W10_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Otp block10 word10 data."]
    #[inline(always)]
    pub fn block10_w10(&self) -> BLOCK10_W10_R {
        BLOCK10_W10_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK10_W10")
            .field("block10_w10", &self.block10_w10())
            .finish()
    }
}
