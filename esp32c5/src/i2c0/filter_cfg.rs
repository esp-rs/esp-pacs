...
#[doc = "Field `SCL_FILTER_EN` reader - Configures to enable the filter function for SCL. \\\\ 0: No effect \\\\ 1: Enable \\\\"]
pub type SCL_FILTER_EN_R = crate::BitReader;
#[doc = "Field `SCL_FILTER_EN` writer - Configures to enable the filter function for SCL. \\\\ 0: No effect \\\\ 1: Enable \\\\"]
pub type SCL_FILTER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDA_FILTER_EN` reader - Configures to enable the filter function for SDA. \\\\ 0: No effect \\\\ 1: Enable \\\\"]
pub type SDA_FILTER_EN_R = crate::BitReader;
#[doc = "Field `SDA_FILTER_EN` writer - Configures to enable the filter function for SDA. \\\\ 0: No effect \\\\ 1: Enable \\\\"]
...
impl R {
    ...
    #[doc = "Bit 8 - Configures to enable the filter function for SCL. \\\\ 0: No effect \\\\ 1: Enable \\\\"]
    #[inline(always)]
    pub fn scl_filter_en(&self) -> SCL_FILTER_EN_R {
        SCL_FILTER_EN_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Configures to enable the filter function for SDA. \\\\ 0: No effect \\\\ 1: Enable \\\\"]
    #[inline(always)]
