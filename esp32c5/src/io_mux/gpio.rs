...
#[doc = "Field `MCU_OE` reader - Configures whether or not to enable the output of GPIO%s in sleep mode. 0: Disable\\\\ 1: Enable\\\\"]
pub type MCU_OE_R = crate::BitReader;
#[doc = "Field `MCU_OE` writer - Configures whether or not to enable the output of GPIO%s in sleep mode. 0: Disable\\\\ 1: Enable\\\\"]
pub type MCU_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLP_SEL` reader - Configures whether or not to enter sleep mode for GPIO%s.\\\\ 0: Not enter\\\\ 1: Enter\\\\"]
pub type SLP_SEL_R = crate::BitReader;
#[doc = "Field `SLP_SEL` writer - Configures whether or not to enter sleep mode for GPIO%s.\\\\ 0: Not enter\\\\ 1: Enter\\\\"]
pub type SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MCU_WPD` reader - Configure whether or not to enable pull-down resistor of GPIO%s in sleep mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type MCU_WPD_R = crate::BitReader;
#[doc = "Field `MCU_WPD` writer - Configure whether or not to enable pull-down resistor of GPIO%s in sleep mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type MCU_WPD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MCU_WPU` reader - Configures whether or not to enable pull-up resistor of GPIO%s during sleep mode. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type MCU_WPU_R = crate::BitReader;
#[doc = "Field `MCU_WPU` writer - Configures whether or not to enable pull-up resistor of GPIO%s during sleep mode. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type MCU_WPU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MCU_IE` reader - Configures whether or not to enable the input of GPIO%s during sleep mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type MCU_IE_R = crate::BitReader;
#[doc = "Field `MCU_IE` writer - Configures whether or not to enable the input of GPIO%s during sleep mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type MCU_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MCU_DRV` reader - Configures the drive strength of GPIO%s during sleep mode. \\\\ 0: ~5 mA\\\\ 1: ~10 mA\\\\ 2: ~20 mA\\\\ 3: ~40 mA\\\\"]
pub type MCU_DRV_R = crate::FieldReader;
#[doc = "Field `MCU_DRV` writer - Configures the drive strength of GPIO%s during sleep mode. \\\\ 0: ~5 mA\\\\ 1: ~10 mA\\\\ 2: ~20 mA\\\\ 3: ~40 mA\\\\"]
pub type MCU_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `FUN_WPD` reader - Configures whether or not to enable pull-down resistor of GPIO%s.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type FUN_WPD_R = crate::BitReader;
#[doc = "Field `FUN_WPD` writer - Configures whether or not to enable pull-down resistor of GPIO%s.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type FUN_WPD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FUN_WPU` reader - Configures whether or not enable pull-up resistor of GPIO%s.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type FUN_WPU_R = crate::BitReader;
#[doc = "Field `FUN_WPU` writer - Configures whether or not enable pull-up resistor of GPIO%s.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type FUN_WPU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FUN_IE` reader - Configures whether or not to enable input of GPIO%s.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type FUN_IE_R = crate::BitReader;
#[doc = "Field `FUN_IE` writer - Configures whether or not to enable input of GPIO%s.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FUN_DRV` reader - Configures the drive strength of GPIO%s. \\\\ 0: ~5 mA\\\\ 1: ~10 mA\\\\ 2: ~20 mA\\\\ 3: ~40 mA\\\\"]
pub type FUN_DRV_R = crate::FieldReader;
#[doc = "Field `FUN_DRV` writer - Configures the drive strength of GPIO%s. \\\\ 0: ~5 mA\\\\ 1: ~10 mA\\\\ 2: ~20 mA\\\\ 3: ~40 mA\\\\"]
pub type FUN_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `MCU_SEL` reader - Configures to select IO MUX function for this signal. \\\\ 0: Select Function 0\\\\ 1: Select Function 1\\\\ ......\\\\"]
pub type MCU_SEL_R = crate::FieldReader;
#[doc = "Field `MCU_SEL` writer - Configures to select IO MUX function for this signal. \\\\ 0: Select Function 0\\\\ 1: Select Function 1\\\\ ......\\\\"]
...
#[doc = "Field `HYS_EN` reader - Configures whether or not to enable the hysteresis function of the pin when IO_MUX_GPIO%s_HYS_SEL is set to 1.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type HYS_EN_R = crate::BitReader;
#[doc = "Field `HYS_EN` writer - Configures whether or not to enable the hysteresis function of the pin when IO_MUX_GPIO%s_HYS_SEL is set to 1.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type HYS_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HYS_SEL` reader - Configures to choose the signal for enabling the hysteresis function for GPIO%s. \\\\ 0: Choose the output enable signal of eFuse\\\\ 1: Choose the output enable signal of IO_MUX_GPIO%s_HYS_EN\\\\"]
pub type HYS_SEL_R = crate::BitReader;
#[doc = "Field `HYS_SEL` writer - Configures to choose the signal for enabling the hysteresis function for GPIO%s. \\\\ 0: Choose the output enable signal of eFuse\\\\ 1: Choose the output enable signal of IO_MUX_GPIO%s_HYS_EN\\\\"]
pub type HYS_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether or not to enable the output of GPIO%s in sleep mode. 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn mcu_oe(&self) -> MCU_OE_R {
        MCU_OE_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures whether or not to enter sleep mode for GPIO%s.\\\\ 0: Not enter\\\\ 1: Enter\\\\"]
    #[inline(always)]
    pub fn slp_sel(&self) -> SLP_SEL_R {
        SLP_SEL_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Configure whether or not to enable pull-down resistor of GPIO%s in sleep mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn mcu_wpd(&self) -> MCU_WPD_R {
        MCU_WPD_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Configures whether or not to enable pull-up resistor of GPIO%s during sleep mode. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn mcu_wpu(&self) -> MCU_WPU_R {
        MCU_WPU_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Configures whether or not to enable the input of GPIO%s during sleep mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - Configures whether or not to enable pull-down resistor of GPIO%s.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn fun_wpd(&self) -> FUN_WPD_R {
        FUN_WPD_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - Configures whether or not enable pull-up resistor of GPIO%s.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn fun_wpu(&self) -> FUN_WPU_R {
        FUN_WPU_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Configures whether or not to enable input of GPIO%s.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn fun_ie(&self) -> FUN_IE_R {
        FUN_IE_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bits 10:11 - Configures the drive strength of GPIO%s. \\\\ 0: ~5 mA\\\\ 1: ~10 mA\\\\ 2: ~20 mA\\\\ 3: ~40 mA\\\\"]
    #[inline(always)]
    pub fn fun_drv(&self) -> FUN_DRV_R {
        FUN_DRV_R::new(((self.bits >> 10) & 3) as u8)
    }
    #[doc = "Bits 12:14 - Configures to select IO MUX function for this signal. \\\\ 0: Select Function 0\\\\ 1: Select Function 1\\\\ ......\\\\"]
    #[inline(always)]
