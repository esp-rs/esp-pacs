...
#[doc = "Field `MCU_OE` reader - Configures whether or not to enable the output of GPIO%s during sleep mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type MCU_OE_R = crate::BitReader;
#[doc = "Field `MCU_OE` writer - Configures whether or not to enable the output of GPIO%s during sleep mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type MCU_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SLP_SEL` reader - Configures whether or not to enable the sleep mode for GPIO%s.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type SLP_SEL_R = crate::BitReader;
#[doc = "Field `SLP_SEL` writer - Configures whether or not to enable the sleep mode for GPIO%s.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MCU_WPD` reader - Configures whether or not to enable the pull-down resistor of GPIO%s during sleep mode. \\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type MCU_WPD_R = crate::BitReader;
#[doc = "Field `MCU_WPD` writer - Configures whether or not to enable the pull-down resistor of GPIO%s during sleep mode. \\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type MCU_WPD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MCU_WPU` reader - Configures whether or not to enable the pull-up resistor of GPIO%s during sleep mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type MCU_WPU_R = crate::BitReader;
#[doc = "Field `MCU_WPU` writer - Configures whether or not to enable the pull-up resistor of GPIO%s during sleep mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type MCU_WPU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MCU_IE` reader - Configures whether or not to enable the input of GPIO%s during sleep mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type MCU_IE_R = crate::BitReader;
#[doc = "Field `MCU_IE` writer - Configures whether or not to enable the input of GPIO%s during sleep mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
...
#[doc = "Field `FUN_WPD` reader - Configures whether or not to enable the pull-down resistor of GPIO%s in normal execution mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type FUN_WPD_R = crate::BitReader;
#[doc = "Field `FUN_WPD` writer - Configures whether or not to enable the pull-down resistor of GPIO%s in normal execution mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type FUN_WPD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FUN_WPU` reader - Configures whether or not to enable the pull-up resistor of GPIO%s in normal execution mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type FUN_WPU_R = crate::BitReader;
#[doc = "Field `FUN_WPU` writer - Configures whether or not to enable the pull-up resistor of GPIO%s in normal execution mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type FUN_WPU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FUN_IE` reader - Configures whether or not to enable the input of GPIO%s in normal execution mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type FUN_IE_R = crate::BitReader;
#[doc = "Field `FUN_IE` writer - Configures whether or not to enable the input of GPIO%s in normal execution mode.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FUN_DRV` reader - Configures the drive strength of GPIO%s in normal execution mode.\\\\ 0: ~5 mA\\\\ 1: ~10 mA\\\\ 2: ~20 mA\\\\ 3: ~40 mA\\\\"]
pub type FUN_DRV_R = crate::FieldReader;
#[doc = "Field `FUN_DRV` writer - Configures the drive strength of GPIO%s in normal execution mode.\\\\ 0: ~5 mA\\\\ 1: ~10 mA\\\\ 2: ~20 mA\\\\ 3: ~40 mA\\\\"]
pub type FUN_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `MCU_SEL` reader - Configures to select the LP IO MUX function for GPIO%s in normal execution mode.\\\\ 0: Select Function 0\\\\ 1: Select Function 1\\\\ ......\\\\"]
pub type MCU_SEL_R = crate::FieldReader;
#[doc = "Field `MCU_SEL` writer - Configures to select the LP IO MUX function for GPIO%s in normal execution mode.\\\\ 0: Select Function 0\\\\ 1: Select Function 1\\\\ ......\\\\"]
