...
#[doc = "Field `DATE` reader - Version data"]
pub type DATE_R = crate::FieldReader<u32>;
#[doc = "Field `DATE` writer - Version data"]
...
#[doc = "`reset()` method sets DATE to value 0x0231_1090"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0231_1090;
}
