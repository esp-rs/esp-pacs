...
#[doc = "Field `OVERFLOW_ENA` reader - Enable the RTC main timer overflow interrupt..\\\\0 : Disable \\\\1: Enable"]
pub type OVERFLOW_ENA_R = crate::BitReader;
#[doc = "Field `OVERFLOW_ENA` writer - Enable the RTC main timer overflow interrupt..\\\\0 : Disable \\\\1: Enable"]
pub type OVERFLOW_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOC_WAKEUP_INT_ENA` reader - Enable the RTC main timer interrupt..\\\\0 : Disable \\\\1: Enable"]
pub type SOC_WAKEUP_INT_ENA_R = crate::BitReader;
#[doc = "Field `SOC_WAKEUP_INT_ENA` writer - Enable the RTC main timer interrupt..\\\\0 : Disable \\\\1: Enable"]
