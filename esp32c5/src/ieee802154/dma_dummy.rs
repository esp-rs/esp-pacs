...
pub type DMA_DUMMY_DATA_R = crate::FieldReader<u32>;
#[doc = "Field `DMA_DUMMY_DATA` writer - "]
pub type DMA_DUMMY_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_DUMMY")
            .field("dma_dummy_data", &self.dma_dummy_data())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn dma_dummy_data(&mut self) -> DMA_DUMMY_DATA_W<'_, DMA_DUMMY_SPEC> {
