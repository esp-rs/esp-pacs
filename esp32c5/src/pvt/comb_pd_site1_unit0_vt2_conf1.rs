...
#[doc = "Field `TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT0` reader - needs field desc"]
pub type TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT0_R = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn timing_err_cnt_clr_vt2_pd_site1_unit0(&self) -> TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT0_R {
        TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT0_R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE1_UNIT0_VT2_CONF1")
            ...
            .field(
                ...
                &self.timing_err_cnt_clr_vt2_pd_site1_unit0(),
            )
            .field(
...
#[doc = "needs desc\n\nYou can [`read`](crate::Reg::read) this register and get [`comb_pd_site1_unit0_vt2_conf1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
