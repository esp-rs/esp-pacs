...
#[doc = "Field `HP_PERI_TIMEOUT_UID` reader - Represents the master id\\[4:0\\] and master permission\\[6:5\\] when trigger timeout. This register will be cleared after the interrupt is cleared."]
