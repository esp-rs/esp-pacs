...
#[doc = "Field `ENABLE_SPI_MANUAL_ENCRYPT` reader - Configures whether or not to enable MSPI XTS manual encryption in SPI boot mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type ENABLE_SPI_MANUAL_ENCRYPT_R = crate::BitReader;
#[doc = "Field `ENABLE_SPI_MANUAL_ENCRYPT` writer - Configures whether or not to enable MSPI XTS manual encryption in SPI boot mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
...
#[doc = "Field `ENABLE_DOWNLOAD_G0CB_DECRYPT` reader - Configures whether or not to enable MSPI XTS auto decryption in download boot mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type ENABLE_DOWNLOAD_G0CB_DECRYPT_R = crate::BitReader;
#[doc = "Field `ENABLE_DOWNLOAD_G0CB_DECRYPT` writer - Configures whether or not to enable MSPI XTS auto decryption in download boot mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type ENABLE_DOWNLOAD_G0CB_DECRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ENABLE_DOWNLOAD_MANUAL_ENCRYPT` reader - Configures whether or not to enable MSPI XTS manual encryption in download boot mode. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type ENABLE_DOWNLOAD_MANUAL_ENCRYPT_R = crate::BitReader;
#[doc = "Field `ENABLE_DOWNLOAD_MANUAL_ENCRYPT` writer - Configures whether or not to enable MSPI XTS manual encryption in download boot mode. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type ENABLE_DOWNLOAD_MANUAL_ENCRYPT_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether or not to enable MSPI XTS manual encryption in SPI boot mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - Configures whether or not to enable MSPI XTS auto decryption in download boot mode.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - Configures whether or not to enable MSPI XTS manual encryption in download boot mode. \\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
