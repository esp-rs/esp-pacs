...
#[doc = "Field `CS0_DIS` reader - Configures whether or not to disable SPI_CS0 pin.\\\\ 0: SPI_CS0 signal is from/to SPI_CS0 pin.\\\\ 1: Disable SPI_CS0 pin.\\\\ Can be configured in CONF state."]
pub type CS0_DIS_R = crate::BitReader;
#[doc = "Field `CS0_DIS` writer - Configures whether or not to disable SPI_CS0 pin.\\\\ 0: SPI_CS0 signal is from/to SPI_CS0 pin.\\\\ 1: Disable SPI_CS0 pin.\\\\ Can be configured in CONF state."]
pub type CS0_DIS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CS1_DIS` reader - Configures whether or not to disable SPI_CS1 pin.\\\\ 0: SPI_CS1 signal is from/to SPI_CS1 pin.\\\\ 1: Disable SPI_CS1 pin.\\\\ Can be configured in CONF state."]
pub type CS1_DIS_R = crate::BitReader;
#[doc = "Field `CS1_DIS` writer - Configures whether or not to disable SPI_CS1 pin.\\\\ 0: SPI_CS1 signal is from/to SPI_CS1 pin.\\\\ 1: Disable SPI_CS1 pin.\\\\ Can be configured in CONF state."]
pub type CS1_DIS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CS2_DIS` reader - Configures whether or not to disable SPI_CS2 pin.\\\\ 0: SPI_CS2 signal is from/to SPI_CS2 pin.\\\\ 1: Disable SPI_CS2 pin.\\\\ Can be configured in CONF state."]
pub type CS2_DIS_R = crate::BitReader;
#[doc = "Field `CS2_DIS` writer - Configures whether or not to disable SPI_CS2 pin.\\\\ 0: SPI_CS2 signal is from/to SPI_CS2 pin.\\\\ 1: Disable SPI_CS2 pin.\\\\ Can be configured in CONF state."]
pub type CS2_DIS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CS3_DIS` reader - Configures whether or not to disable SPI_CS3 pin.\\\\ 0: SPI_CS3 signal is from/to SPI_CS3 pin.\\\\ 1: Disable SPI_CS3 pin.\\\\ Can be configured in CONF state."]
pub type CS3_DIS_R = crate::BitReader;
#[doc = "Field `CS3_DIS` writer - Configures whether or not to disable SPI_CS3 pin.\\\\ 0: SPI_CS3 signal is from/to SPI_CS3 pin.\\\\ 1: Disable SPI_CS3 pin.\\\\ Can be configured in CONF state."]
pub type CS3_DIS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CS4_DIS` reader - Configures whether or not to disable SPI_CS4 pin.\\\\ 0: SPI_CS4 signal is from/to SPI_CS4 pin.\\\\ 1: Disable SPI_CS4 pin.\\\\ Can be configured in CONF state."]
pub type CS4_DIS_R = crate::BitReader;
#[doc = "Field `CS4_DIS` writer - Configures whether or not to disable SPI_CS4 pin.\\\\ 0: SPI_CS4 signal is from/to SPI_CS4 pin.\\\\ 1: Disable SPI_CS4 pin.\\\\ Can be configured in CONF state."]
pub type CS4_DIS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CS5_DIS` reader - Configures whether or not to disable SPI_CS5 pin.\\\\ 0: SPI_CS5 signal is from/to SPI_CS5 pin.\\\\ 1: Disable SPI_CS5 pin.\\\\ Can be configured in CONF state."]
pub type CS5_DIS_R = crate::BitReader;
#[doc = "Field `CS5_DIS` writer - Configures whether or not to disable SPI_CS5 pin.\\\\ 0: SPI_CS5 signal is from/to SPI_CS5 pin.\\\\ 1: Disable SPI_CS5 pin.\\\\ Can be configured in CONF state."]
pub type CS5_DIS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CK_DIS` reader - Configures whether or not to disable SPI_CLK output.\\\\ 0: Enable\\\\ 1: Disable\\\\ Can be configured in CONF state."]
pub type CK_DIS_R = crate::BitReader;
#[doc = "Field `CK_DIS` writer - Configures whether or not to disable SPI_CLK output.\\\\ 0: Enable\\\\ 1: Disable\\\\ Can be configured in CONF state."]
pub type CK_DIS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MASTER_CS_POL` reader - Configures the polarity of SPI_CS7 (7 = 0-5) line in master transfer.\\\\ 0: SPI_CS7 is low active.\\\\ 1: SPI_CS7 is high active.\\\\ Can be configured in CONF state."]
pub type MASTER_CS_POL_R = crate::FieldReader;
#[doc = "Field `MASTER_CS_POL` writer - Configures the polarity of SPI_CS7 (7 = 0-5) line in master transfer.\\\\ 0: SPI_CS7 is low active.\\\\ 1: SPI_CS7 is high active.\\\\ Can be configured in CONF state."]
...
#[doc = "Field `SLAVE_CS_POL` reader - Configures whether or not invert SPI slave input CS polarity.\\\\ 0: Not change\\\\ 1: Invert\\\\ Can be configured in CONF state."]
pub type SLAVE_CS_POL_R = crate::BitReader;
#[doc = "Field `SLAVE_CS_POL` writer - Configures whether or not invert SPI slave input CS polarity.\\\\ 0: Not change\\\\ 1: Invert\\\\ Can be configured in CONF state."]
...
#[doc = "Field `CK_IDLE_EDGE` reader - Configures the level of SPI_CLK line when GP-SPI2 is in idle.\\\\ 0: Low\\\\ 1: High\\\\ Can be configured in CONF state."]
pub type CK_IDLE_EDGE_R = crate::BitReader;
#[doc = "Field `CK_IDLE_EDGE` writer - Configures the level of SPI_CLK line when GP-SPI2 is in idle.\\\\ 0: Low\\\\ 1: High\\\\ Can be configured in CONF state."]
pub type CK_IDLE_EDGE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CS_KEEP_ACTIVE` reader - Configures whether or not to keep the SPI_CS line low.\\\\ 0: Not keep low\\\\ 1: Keep low\\\\ Can be configured in CONF state."]
pub type CS_KEEP_ACTIVE_R = crate::BitReader;
#[doc = "Field `CS_KEEP_ACTIVE` writer - Configures whether or not to keep the SPI_CS line low.\\\\ 0: Not keep low\\\\ 1: Keep low\\\\ Can be configured in CONF state."]
