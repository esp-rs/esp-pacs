...
#[doc = "Field `DIN0_MODE` reader - Configures the input mode for FSPID signal.\\\\ 0: Input without delay\\\\ 1: Input at the (SPI_DIN0_NUM + 1)th falling edge of clk_spi_mst\\\\ 2: Input at the (SPI_DIN0_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle\\\\ 3: Input at the (SPI_DIN0_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst falling edge cycle\\\\ Can be configured in CONF state."]
pub type DIN0_MODE_R = crate::FieldReader;
#[doc = "Field `DIN0_MODE` writer - Configures the input mode for FSPID signal.\\\\ 0: Input without delay\\\\ 1: Input at the (SPI_DIN0_NUM + 1)th falling edge of clk_spi_mst\\\\ 2: Input at the (SPI_DIN0_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle\\\\ 3: Input at the (SPI_DIN0_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst falling edge cycle\\\\ Can be configured in CONF state."]
pub type DIN0_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `DIN1_MODE` reader - Configures the input mode for FSPIQ signal.\\\\ 0: Input without delay\\\\ 1: Input at the (SPI_DIN1_NUM+1)th falling edge of clk_spi_mst\\\\ 2: Input at the (SPI_DIN1_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle\\\\ 3: Input at the (SPI_DIN1_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst falling edge cycle\\\\ Can be configured in CONF state."]
pub type DIN1_MODE_R = crate::FieldReader;
#[doc = "Field `DIN1_MODE` writer - Configures the input mode for FSPIQ signal.\\\\ 0: Input without delay\\\\ 1: Input at the (SPI_DIN1_NUM+1)th falling edge of clk_spi_mst\\\\ 2: Input at the (SPI_DIN1_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle\\\\ 3: Input at the (SPI_DIN1_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst falling edge cycle\\\\ Can be configured in CONF state."]
pub type DIN1_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `DIN2_MODE` reader - Configures the input mode for FSPIWP signal.\\\\ 0: Input without delay\\\\ 1: Input at the (SPI_DIN2_NUM + 1)th falling edge of clk_spi_mst\\\\ 2: Input at the (SPI_DIN2_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle\\\\ 3: Input at the (SPI_DIN2_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst falling edge cycle\\\\ Can be configured in CONF state."]
pub type DIN2_MODE_R = crate::FieldReader;
#[doc = "Field `DIN2_MODE` writer - Configures the input mode for FSPIWP signal.\\\\ 0: Input without delay\\\\ 1: Input at the (SPI_DIN2_NUM + 1)th falling edge of clk_spi_mst\\\\ 2: Input at the (SPI_DIN2_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle\\\\ 3: Input at the (SPI_DIN2_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst falling edge cycle\\\\ Can be configured in CONF state."]
pub type DIN2_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `DIN3_MODE` reader - Configures the input mode for FSPIHD signal.\\\\ 0: Input without delay\\\\ 1: Input at the (SPI_DIN3_NUM + 1)th falling edge of clk_spi_mst\\\\ 2: Input at the (SPI_DIN3_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle\\\\ 3: Input at the (SPI_DIN3_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst falling edge cycle\\\\ Can be configured in CONF state."]
pub type DIN3_MODE_R = crate::FieldReader;
#[doc = "Field `DIN3_MODE` writer - Configures the input mode for FSPIHD signal.\\\\ 0: Input without delay\\\\ 1: Input at the (SPI_DIN3_NUM + 1)th falling edge of clk_spi_mst\\\\ 2: Input at the (SPI_DIN3_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst rising edge cycle\\\\ 3: Input at the (SPI_DIN3_NUM + 1)th rising edge of clk_hclk plus one clk_spi_mst falling edge cycle\\\\ Can be configured in CONF state."]
...
#[doc = "Field `TIMING_HCLK_ACTIVE` reader - Configures whether or not to enable HCLK (high-frequency clock) in SPI input timing module.\\\\ 0: Disable\\\\ 1: Enable\\\\ Can be configured in CONF state."]
pub type TIMING_HCLK_ACTIVE_R = crate::BitReader;
#[doc = "Field `TIMING_HCLK_ACTIVE` writer - Configures whether or not to enable HCLK (high-frequency clock) in SPI input timing module.\\\\ 0: Disable\\\\ 1: Enable\\\\ Can be configured in CONF state."]
