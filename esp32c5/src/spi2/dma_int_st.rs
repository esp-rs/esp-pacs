...
#[doc = "Field `DMA_INFIFO_FULL_ERR` reader - The interrupt status of SPI_DMA_INFIFO_FULL_ERR_INT interrupt."]
pub type DMA_INFIFO_FULL_ERR_R = crate::BitReader;
#[doc = "Field `DMA_OUTFIFO_EMPTY_ERR` reader - The interrupt status of SPI_DMA_OUTFIFO_EMPTY_ERR_INT interrupt."]
pub type DMA_OUTFIFO_EMPTY_ERR_R = crate::BitReader;
#[doc = "Field `SLV_EX_QPI` reader - The interrupt status of SPI_SLV_EX_QPI_INT interrupt."]
pub type SLV_EX_QPI_R = crate::BitReader;
#[doc = "Field `SLV_EN_QPI` reader - The interrupt status of SPI_SLV_EN_QPI_INT interrupt."]
pub type SLV_EN_QPI_R = crate::BitReader;
#[doc = "Field `SLV_CMD7` reader - The interrupt status of SPI_SLV_CMD7_INT interrupt."]
pub type SLV_CMD7_R = crate::BitReader;
#[doc = "Field `SLV_CMD8` reader - The interrupt status of SPI_SLV_CMD8_INT interrupt."]
pub type SLV_CMD8_R = crate::BitReader;
#[doc = "Field `SLV_CMD9` reader - The interrupt status of SPI_SLV_CMD9_INT interrupt."]
pub type SLV_CMD9_R = crate::BitReader;
#[doc = "Field `SLV_CMDA` reader - The interrupt status of SPI_SLV_CMDA_INT interrupt."]
pub type SLV_CMDA_R = crate::BitReader;
#[doc = "Field `SLV_RD_DMA_DONE` reader - The interrupt status of SPI_SLV_RD_DMA_DONE_INT interrupt."]
pub type SLV_RD_DMA_DONE_R = crate::BitReader;
#[doc = "Field `SLV_WR_DMA_DONE` reader - The interrupt status of SPI_SLV_WR_DMA_DONE_INT interrupt."]
pub type SLV_WR_DMA_DONE_R = crate::BitReader;
#[doc = "Field `SLV_RD_BUF_DONE` reader - The interrupt status of SPI_SLV_RD_BUF_DONE_INT interrupt."]
pub type SLV_RD_BUF_DONE_R = crate::BitReader;
#[doc = "Field `SLV_WR_BUF_DONE` reader - The interrupt status of SPI_SLV_WR_BUF_DONE_INT interrupt."]
pub type SLV_WR_BUF_DONE_R = crate::BitReader;
#[doc = "Field `TRANS_DONE` reader - The interrupt status of SPI_TRANS_DONE_INT interrupt."]
pub type TRANS_DONE_R = crate::BitReader;
#[doc = "Field `DMA_SEG_TRANS_DONE` reader - The interrupt status of SPI_DMA_SEG_TRANS_DONE_INT interrupt."]
pub type DMA_SEG_TRANS_DONE_R = crate::BitReader;
#[doc = "Field `SEG_MAGIC_ERR` reader - The interrupt status of SPI_SEG_MAGIC_ERR_INT interrupt."]
...
#[doc = "Field `SLV_CMD_ERR` reader - The interrupt status of SPI_SLV_CMD_ERR_INT interrupt."]
pub type SLV_CMD_ERR_R = crate::BitReader;
#[doc = "Field `MST_RX_AFIFO_WFULL_ERR` reader - The interrupt status of SPI_MST_RX_AFIFO_WFULL_ERR_INT interrupt."]
pub type MST_RX_AFIFO_WFULL_ERR_R = crate::BitReader;
#[doc = "Field `MST_TX_AFIFO_REMPTY_ERR` reader - The interrupt status of SPI_MST_TX_AFIFO_REMPTY_ERR_INT interrupt."]
pub type MST_TX_AFIFO_REMPTY_ERR_R = crate::BitReader;
#[doc = "Field `APP2` reader - The interrupt status of SPI_APP2_INT interrupt."]
pub type APP2_R = crate::BitReader;
#[doc = "Field `APP1` reader - The interrupt status of SPI_APP1_INT interrupt."]
