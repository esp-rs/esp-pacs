...
#[doc = "Field `DMA_INFIFO_FULL_ERR` writer - Write 1 to clear SPI_DMA_INFIFO_FULL_ERR_INT interrupt."]
pub type DMA_INFIFO_FULL_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `DMA_OUTFIFO_EMPTY_ERR` writer - Write 1 to clear SPI_DMA_OUTFIFO_EMPTY_ERR_INT interrupt."]
pub type DMA_OUTFIFO_EMPTY_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_EX_QPI` writer - Write 1 to clear SPI_SLV_EX_QPI_INT interrupt."]
pub type SLV_EX_QPI_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_EN_QPI` writer - Write 1 to clear SPI_SLV_EN_QPI_INT interrupt."]
pub type SLV_EN_QPI_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_CMD7` writer - Write 1 to clear SPI_SLV_CMD7_INT interrupt."]
pub type SLV_CMD7_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_CMD8` writer - Write 1 to clear SPI_SLV_CMD8_INT interrupt."]
pub type SLV_CMD8_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_CMD9` writer - Write 1 to clear SPI_SLV_CMD9_INT interrupt."]
pub type SLV_CMD9_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_CMDA` writer - Write 1 to clear SPI_SLV_CMDA_INT interrupt."]
pub type SLV_CMDA_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_RD_DMA_DONE` writer - Write 1 to clear SPI_SLV_RD_DMA_DONE_INT interrupt."]
pub type SLV_RD_DMA_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_WR_DMA_DONE` writer - Write 1 to clear SPI_SLV_WR_DMA_DONE_INT interrupt."]
pub type SLV_WR_DMA_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_RD_BUF_DONE` writer - Write 1 to clear SPI_SLV_RD_BUF_DONE_INT interrupt."]
pub type SLV_RD_BUF_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SLV_WR_BUF_DONE` writer - Write 1 to clear SPI_SLV_WR_BUF_DONE_INT interrupt."]
pub type SLV_WR_BUF_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `TRANS_DONE` writer - Write 1 to clear SPI_TRANS_DONE_INT interrupt."]
pub type TRANS_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `DMA_SEG_TRANS_DONE` writer - Write 1 to clear SPI_DMA_SEG_TRANS_DONE_INT interrupt."]
pub type DMA_SEG_TRANS_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SEG_MAGIC_ERR` writer - Write 1 to clear SPI_SEG_MAGIC_ERR_INT interrupt."]
...
#[doc = "Field `SLV_CMD_ERR` writer - Write 1 to clear SPI_SLV_CMD_ERR_INT interrupt."]
pub type SLV_CMD_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `MST_RX_AFIFO_WFULL_ERR` writer - Write 1 to clear SPI_MST_RX_AFIFO_WFULL_ERR_INT interrupt."]
pub type MST_RX_AFIFO_WFULL_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `MST_TX_AFIFO_REMPTY_ERR` writer - Write 1 to clear SPI_MST_TX_AFIFO_REMPTY_ERR_INT interrupt."]
pub type MST_TX_AFIFO_REMPTY_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `APP2` writer - Write 1 to clear SPI_APP2_INT interrupt."]
pub type APP2_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `APP1` writer - Write 1 to clear SPI_APP1_INT interrupt."]
...
impl W {
    ...
    #[inline(always)]
    pub fn dma_infifo_full_err(&mut self) -> DMA_INFIFO_FULL_ERR_W<'_, DMA_INT_CLR_SPEC> {
        DMA_INFIFO_FULL_ERR_W::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 to clear SPI_DMA_OUTFIFO_EMPTY_ERR_INT interrupt."]
    #[inline(always)]
    pub fn dma_outfifo_empty_err(&mut self) -> DMA_OUTFIFO_EMPTY_ERR_W<'_, DMA_INT_CLR_SPEC> {
        DMA_OUTFIFO_EMPTY_ERR_W::new(self, 1)
    }
    #[doc = "Bit 2 - Write 1 to clear SPI_SLV_EX_QPI_INT interrupt."]
    #[inline(always)]
    pub fn slv_ex_qpi(&mut self) -> SLV_EX_QPI_W<'_, DMA_INT_CLR_SPEC> {
        SLV_EX_QPI_W::new(self, 2)
    }
    #[doc = "Bit 3 - Write 1 to clear SPI_SLV_EN_QPI_INT interrupt."]
    #[inline(always)]
    pub fn slv_en_qpi(&mut self) -> SLV_EN_QPI_W<'_, DMA_INT_CLR_SPEC> {
