...
#[doc = "Field `DOUT0_MODE` reader - Configures the output mode for FSPID signal.\\\\ 0: Output without delay\\\\ 1: Output with a delay of a SPI module clock cycle at its falling edge\\\\ Can be configured in CONF state."]
pub type DOUT0_MODE_R = crate::BitReader;
#[doc = "Field `DOUT0_MODE` writer - Configures the output mode for FSPID signal.\\\\ 0: Output without delay\\\\ 1: Output with a delay of a SPI module clock cycle at its falling edge\\\\ Can be configured in CONF state."]
pub type DOUT0_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DOUT1_MODE` reader - Configures the output mode for FSPIQ signal.\\\\ 0: Output without delay\\\\ 1: Output with a delay of a SPI module clock cycle at its falling edge\\\\ Can be configured in CONF state."]
pub type DOUT1_MODE_R = crate::BitReader;
#[doc = "Field `DOUT1_MODE` writer - Configures the output mode for FSPIQ signal.\\\\ 0: Output without delay\\\\ 1: Output with a delay of a SPI module clock cycle at its falling edge\\\\ Can be configured in CONF state."]
pub type DOUT1_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DOUT2_MODE` reader - Configures the output mode for FSPIWP signal.\\\\ 0: Output without delay\\\\ 1: Output with a delay of a SPI module clock cycle at its falling edge\\\\ Can be configured in CONF state."]
pub type DOUT2_MODE_R = crate::BitReader;
#[doc = "Field `DOUT2_MODE` writer - Configures the output mode for FSPIWP signal.\\\\ 0: Output without delay\\\\ 1: Output with a delay of a SPI module clock cycle at its falling edge\\\\ Can be configured in CONF state."]
pub type DOUT2_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DOUT3_MODE` reader - Configures the output mode for FSPIHD signal.\\\\ 0: Output without delay\\\\ 1: Output with a delay of a SPI module clock cycle at its falling edge\\\\ Can be configured in CONF state."]
pub type DOUT3_MODE_R = crate::BitReader;
#[doc = "Field `DOUT3_MODE` writer - Configures the output mode for FSPIHD signal.\\\\ 0: Output without delay\\\\ 1: Output with a delay of a SPI module clock cycle at its falling edge\\\\ Can be configured in CONF state."]
