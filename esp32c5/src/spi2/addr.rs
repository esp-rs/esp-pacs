...
#[doc = "Field `USR_ADDR_VALUE` reader - Configures the address to slave. Can be configured in CONF state."]
pub type USR_ADDR_VALUE_R = crate::FieldReader<u32>;
#[doc = "Field `USR_ADDR_VALUE` writer - Configures the address to slave. Can be configured in CONF state."]
