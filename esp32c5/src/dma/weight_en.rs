...
#[doc = "Field `WEIGHT_EN` reader - Configures whether to enable weight arbitration for TX. 0: Disable 1: Enable"]
pub type WEIGHT_EN_R = crate::BitReader;
#[doc = "Field `WEIGHT_EN` writer - Configures whether to enable weight arbitration for TX. 0: Disable 1: Enable"]
...
impl W {
    #[doc = "Bit 0 - Configures whether to enable weight arbitration for TX. 0: Disable 1: Enable"]
    #[inline(always)]
    pub fn weight_en(&mut self) -> WEIGHT_EN_W<'_, WEIGHT_EN_SPEC> {
