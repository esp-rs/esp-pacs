...
#[doc = "Field `ARB_PRI_DIS` reader - Configures whether or not to disable the fixed-priority channel arbitration.\\\\0: Enable\\\\1: Disable\\\\"]
pub type ARB_PRI_DIS_R = crate::BitReader;
#[doc = "Field `ARB_PRI_DIS` writer - Configures whether or not to disable the fixed-priority channel arbitration.\\\\0: Enable\\\\1: Disable\\\\"]
...
impl R {
    ...
    #[doc = "Bit 2 - Configures whether or not to disable the fixed-priority channel arbitration.\\\\0: Enable\\\\1: Disable\\\\"]
    #[inline(always)]
