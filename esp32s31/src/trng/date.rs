...
#[doc = "Field `DATE` reader - TRNG date information"]
pub type DATE_R = crate::FieldReader<u32>;
#[doc = "Field `DATE` writer - TRNG date information"]
...
impl R {
    #[doc = "Bits 0:27 - TRNG date information"]
    #[inline(always)]
    pub fn date(&self) -> DATE_R {
        DATE_R::new(self.bits & 0x0fff_ffff)
    }
    #[doc = "Bit 28 - clock enable"]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x0025_0730"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0025_0730;
}
