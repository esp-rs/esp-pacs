...
#[doc = "Field `SLAVE_RW` reader - Represents the transfer direction in Slave mode.\\\\ 0: Master writes to slave\\\\ 1: Master reads from slave\\\\"]
...
#[doc = "Field `BUS_BUSY` reader - Represents the I2C bus state.\\\\ 0: The I2C bus is in idle state\\\\ 1: The I2C bus is busy transferring data\\\\"]
...
impl R {
    ...
    #[doc = "Bit 1 - Represents the transfer direction in Slave mode.\\\\ 0: Master writes to slave\\\\ 1: Master reads from slave\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Represents the I2C bus state.\\\\ 0: The I2C bus is in idle state\\\\ 1: The I2C bus is busy transferring data\\\\"]
    #[inline(always)]
