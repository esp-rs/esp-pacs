...
#[doc = "Field `SCL_RST_SLV_EN` reader - Configures whether or not to send out SCL pulses when I2C master is IDLE. The number of pulses equals to I2C_SCL_RST_SLV_NUM\\[4:0\\]."]
pub type SCL_RST_SLV_EN_R = crate::BitReader;
#[doc = "Field `SCL_RST_SLV_EN` writer - Configures whether or not to send out SCL pulses when I2C master is IDLE. The number of pulses equals to I2C_SCL_RST_SLV_NUM\\[4:0\\]."]
...
#[doc = "Field `SCL_PD_EN` reader - Configures whether or not to power down the I2C output SCL line. \\\\ 0: Not power down\\\\ 1: Power down\\\\ Valid only when I2C_SCL_FORCE_OUT is 1."]
pub type SCL_PD_EN_R = crate::BitReader;
#[doc = "Field `SCL_PD_EN` writer - Configures whether or not to power down the I2C output SCL line. \\\\ 0: Not power down\\\\ 1: Power down\\\\ Valid only when I2C_SCL_FORCE_OUT is 1."]
pub type SCL_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDA_PD_EN` reader - Configures whether or not to power down the I2C output SDA line. \\\\ 0: Not power down\\\\ 1: Power down\\\\ Valid only when I2C_SDA_FORCE_OUT is 1."]
pub type SDA_PD_EN_R = crate::BitReader;
#[doc = "Field `SDA_PD_EN` writer - Configures whether or not to power down the I2C output SDA line. \\\\ 0: Not power down\\\\ 1: Power down\\\\ Valid only when I2C_SDA_FORCE_OUT is 1."]
pub type SDA_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether or not to send out SCL pulses when I2C master is IDLE. The number of pulses equals to I2C_SCL_RST_SLV_NUM\\[4:0\\]."]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - Configures whether or not to power down the I2C output SCL line. \\\\ 0: Not power down\\\\ 1: Power down\\\\ Valid only when I2C_SCL_FORCE_OUT is 1."]
    #[inline(always)]
    pub fn scl_pd_en(&self) -> SCL_PD_EN_R {
        SCL_PD_EN_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Configures whether or not to power down the I2C output SDA line. \\\\ 0: Not power down\\\\ 1: Power down\\\\ Valid only when I2C_SDA_FORCE_OUT is 1."]
    #[inline(always)]
