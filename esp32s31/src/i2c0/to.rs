...
#[doc = "Field `TIME_OUT_EN` reader - Configures whether to enable timeout control.\\\\ 0: No effect \\\\ 1: Enable \\\\"]
pub type TIME_OUT_EN_R = crate::BitReader;
#[doc = "Field `TIME_OUT_EN` writer - Configures whether to enable timeout control.\\\\ 0: No effect \\\\ 1: Enable \\\\"]
...
impl R {
    ...
    #[doc = "Bit 5 - Configures whether to enable timeout control.\\\\ 0: No effect \\\\ 1: Enable \\\\"]
    #[inline(always)]
