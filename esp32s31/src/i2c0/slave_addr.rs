...
#[doc = "Field `SLAVE_ADDR` reader - Configures the slave address of the I2C slave.\\\\"]
pub type SLAVE_ADDR_R = crate::FieldReader<u16>;
#[doc = "Field `SLAVE_ADDR` writer - Configures the slave address of the I2C slave.\\\\"]
pub type SLAVE_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
#[doc = "Field `ADDR_10BIT_EN` reader - Configures whether to enable the slave 10-bit addressing mode in Master mode.\\\\ 0: No effect \\\\ 1: Enable \\\\"]
pub type ADDR_10BIT_EN_R = crate::BitReader;
#[doc = "Field `ADDR_10BIT_EN` writer - Configures whether to enable the slave 10-bit addressing mode in Master mode.\\\\ 0: No effect \\\\ 1: Enable \\\\"]
pub type ADDR_10BIT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:14 - Configures the slave address of the I2C slave.\\\\"]
    #[inline(always)]
    pub fn slave_addr(&self) -> SLAVE_ADDR_R {
        SLAVE_ADDR_R::new((self.bits & 0x7fff) as u16)
    }
    #[doc = "Bit 31 - Configures whether to enable the slave 10-bit addressing mode in Master mode.\\\\ 0: No effect \\\\ 1: Enable \\\\"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 31 - Configures whether to enable the slave 10-bit addressing mode in Master mode.\\\\ 0: No effect \\\\ 1: Enable \\\\"]
    #[inline(always)]
    pub fn addr_10bit_en(&mut self) -> ADDR_10BIT_EN_W<'_, SLAVE_ADDR_SPEC> {
