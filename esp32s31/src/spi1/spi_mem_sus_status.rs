...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_SUS_STATUS")
            .field("spi_mem_flash_sus", &self.spi_mem_flash_sus())
            .field("spi_mem_wait_pesr_cmd_2b", &self.spi_mem_wait_pesr_cmd_2b())
            .field(
                "spi_mem_flash_hpm_dly_128",
                &self.spi_mem_flash_hpm_dly_128(),
            )
            .field(
                "spi_mem_flash_res_dly_128",
                &self.spi_mem_flash_res_dly_128(),
            )
            .field("spi_mem_flash_dp_dly_128", &self.spi_mem_flash_dp_dly_128())
            .field(
                "spi_mem_flash_per_dly_128",
                &self.spi_mem_flash_per_dly_128(),
            )
            .field(
                "spi_mem_flash_pes_dly_128",
                &self.spi_mem_flash_pes_dly_128(),
            )
            .field("spi_mem_spi0_lock_en", &self.spi_mem_spi0_lock_en())
            .field(
                "spi_mem_flash_pesr_cmd_2b",
                &self.spi_mem_flash_pesr_cmd_2b(),
            )
            .field(
                "spi_mem_flash_per_command",
                &self.spi_mem_flash_per_command(),
            )
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - The status of flash suspend, only used in SPI1."]
    #[inline(always)]
    pub fn spi_mem_flash_sus(&mut self) -> SPI_MEM_FLASH_SUS_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
    ...
    pub fn spi_mem_wait_pesr_cmd_2b(
        &mut self,
    ) -> SPI_MEM_WAIT_PESR_CMD_2B_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
    ...
    pub fn spi_mem_flash_hpm_dly_128(
        &mut self,
    ) -> SPI_MEM_FLASH_HPM_DLY_128_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
    ...
    pub fn spi_mem_flash_res_dly_128(
        &mut self,
    ) -> SPI_MEM_FLASH_RES_DLY_128_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
    ...
    pub fn spi_mem_flash_dp_dly_128(
        &mut self,
    ) -> SPI_MEM_FLASH_DP_DLY_128_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
    ...
    pub fn spi_mem_flash_per_dly_128(
        &mut self,
    ) -> SPI_MEM_FLASH_PER_DLY_128_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
    ...
    pub fn spi_mem_flash_pes_dly_128(
        &mut self,
    ) -> SPI_MEM_FLASH_PES_DLY_128_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
        SPI_MEM_FLASH_PES_DLY_128_W::new(self, 6)
    }
    #[doc = "Bit 7 - 1: Enable SPI0 lock SPI0/1 arbiter option. 0: Disable it."]
    #[inline(always)]
    pub fn spi_mem_spi0_lock_en(&mut self) -> SPI_MEM_SPI0_LOCK_EN_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
    ...
    pub fn spi_mem_flash_pesr_cmd_2b(
        &mut self,
    ) -> SPI_MEM_FLASH_PESR_CMD_2B_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
    ...
    pub fn spi_mem_flash_per_command(
        &mut self,
    ) -> SPI_MEM_FLASH_PER_COMMAND_W<'_, SPI_MEM_SUS_STATUS_SPEC> {
        SPI_MEM_FLASH_PER_COMMAND_W::new(self, 16)
    }
}
#[doc = "SPI1 flash suspend status register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_sus_status::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_sus_status::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
