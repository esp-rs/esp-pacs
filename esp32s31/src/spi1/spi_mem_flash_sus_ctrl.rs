...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_FLASH_SUS_CTRL")
            .field("spi_mem_flash_per", &self.spi_mem_flash_per())
            .field("spi_mem_flash_pes", &self.spi_mem_flash_pes())
            .field(
                "spi_mem_flash_per_wait_en",
                &self.spi_mem_flash_per_wait_en(),
            )
            .field(
                "spi_mem_flash_pes_wait_en",
                &self.spi_mem_flash_pes_wait_en(),
            )
            .field("spi_mem_pes_per_en", &self.spi_mem_pes_per_en())
            .field("spi_mem_flash_pes_en", &self.spi_mem_flash_pes_en())
            .field("spi_mem_pesr_end_msk", &self.spi_mem_pesr_end_msk())
            .field("spi_fmem_rd_sus_2b", &self.spi_fmem_rd_sus_2b())
            .field("spi_mem_per_end_en", &self.spi_mem_per_end_en())
            .field("spi_mem_pes_end_en", &self.spi_mem_pes_end_en())
            .field("spi_mem_sus_timeout_cnt", &self.spi_mem_sus_timeout_cnt())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - program erase resume bit, program erase suspend operation will be triggered when the bit is set. The bit will be cleared once the operation done.1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_flash_per(&mut self) -> SPI_MEM_FLASH_PER_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
        SPI_MEM_FLASH_PER_W::new(self, 0)
    }
    #[doc = "Bit 1 - program erase suspend bit, program erase suspend operation will be triggered when the bit is set. The bit will be cleared once the operation done.1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_flash_pes(&mut self) -> SPI_MEM_FLASH_PES_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
    ...
    pub fn spi_mem_flash_per_wait_en(
        &mut self,
    ) -> SPI_MEM_FLASH_PER_WAIT_EN_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
    ...
    pub fn spi_mem_flash_pes_wait_en(
        &mut self,
    ) -> SPI_MEM_FLASH_PES_WAIT_EN_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
        SPI_MEM_FLASH_PES_WAIT_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - Set this bit to enable PES end triggers PER transfer option. If this bit is 0, application should send PER after PES is done."]
    #[inline(always)]
    pub fn spi_mem_pes_per_en(&mut self) -> SPI_MEM_PES_PER_EN_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
    ...
    pub fn spi_mem_flash_pes_en(
        &mut self,
    ) -> SPI_MEM_FLASH_PES_EN_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
    ...
    pub fn spi_mem_pesr_end_msk(
        &mut self,
    ) -> SPI_MEM_PESR_END_MSK_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
        SPI_MEM_PESR_END_MSK_W::new(self, 6)
    }
    #[doc = "Bit 22 - 1: Read two bytes when check flash SUS/SUS1/SUS2 status bit. 0: Read one byte when check flash SUS/SUS1/SUS2 status bit"]
    #[inline(always)]
    pub fn spi_fmem_rd_sus_2b(&mut self) -> SPI_FMEM_RD_SUS_2B_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
        SPI_FMEM_RD_SUS_2B_W::new(self, 22)
    }
    #[doc = "Bit 23 - 1: Both WIP and SUS/SUS1/SUS2 bits should be checked to insure the resume status of flash. 0: Only need to check WIP is 0."]
    #[inline(always)]
    pub fn spi_mem_per_end_en(&mut self) -> SPI_MEM_PER_END_EN_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
        SPI_MEM_PER_END_EN_W::new(self, 23)
    }
    #[doc = "Bit 24 - 1: Both WIP and SUS/SUS1/SUS2 bits should be checked to insure the suspend status of flash. 0: Only need to check WIP is 0."]
    #[inline(always)]
    pub fn spi_mem_pes_end_en(&mut self) -> SPI_MEM_PES_END_EN_W<'_, SPI_MEM_FLASH_SUS_CTRL_SPEC> {
