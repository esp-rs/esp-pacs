...
pub type SPI_MEM_FWRITE_DUAL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_MEM_FWRITE_QUAD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_MEM_FWRITE_DIO_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_MEM_FWRITE_QIO_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_USR_MISO_HIGHPART` writer - read-data phase only access to high-part of the buffer spi_mem_w8~spi_mem_w15. 1: enable 0: disable."]
pub type SPI_MEM_USR_MISO_HIGHPART_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_USR_MOSI_HIGHPART` writer - write-data phase only access to high-part of the buffer spi_mem_w8~spi_mem_w15. 1: enable 0: disable."]
pub type SPI_MEM_USR_MOSI_HIGHPART_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_MEM_USR_MOSI_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_MEM_USR_MISO_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_MEM_USR_ADDR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_MEM_USR_COMMAND_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_USER")
            .field("spi_mem_ck_out_edge", &self.spi_mem_ck_out_edge())
            .field("spi_mem_fwrite_dual", &self.spi_mem_fwrite_dual())
            .field("spi_mem_fwrite_quad", &self.spi_mem_fwrite_quad())
            .field("spi_mem_fwrite_dio", &self.spi_mem_fwrite_dio())
            .field("spi_mem_fwrite_qio", &self.spi_mem_fwrite_qio())
            .field(
                "spi_mem_usr_miso_highpart",
                &self.spi_mem_usr_miso_highpart(),
            )
            .field(
                "spi_mem_usr_mosi_highpart",
                &self.spi_mem_usr_mosi_highpart(),
            )
            .field("spi_mem_usr_dummy_idle", &self.spi_mem_usr_dummy_idle())
            .field("spi_mem_usr_mosi", &self.spi_mem_usr_mosi())
            .field("spi_mem_usr_miso", &self.spi_mem_usr_miso())
            .field("spi_mem_usr_dummy", &self.spi_mem_usr_dummy())
            .field("spi_mem_usr_addr", &self.spi_mem_usr_addr())
            .field("spi_mem_usr_command", &self.spi_mem_usr_command())
            .finish()
    }
}
impl W {
    #[doc = "Bit 9 - the bit combined with spi_mem_mosi_delay_mode bits to set mosi signal delay mode."]
    #[inline(always)]
    pub fn spi_mem_ck_out_edge(&mut self) -> SPI_MEM_CK_OUT_EDGE_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_CK_OUT_EDGE_W::new(self, 9)
    }
    #[doc = "Bit 12 - In the write operations read-data phase apply 2 signals"]
    #[inline(always)]
    pub fn spi_mem_fwrite_dual(&mut self) -> SPI_MEM_FWRITE_DUAL_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_FWRITE_DUAL_W::new(self, 12)
    }
    #[doc = "Bit 13 - In the write operations read-data phase apply 4 signals"]
    #[inline(always)]
    pub fn spi_mem_fwrite_quad(&mut self) -> SPI_MEM_FWRITE_QUAD_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_FWRITE_QUAD_W::new(self, 13)
    }
    #[doc = "Bit 14 - In the write operations address phase and read-data phase apply 2 signals."]
    #[inline(always)]
    pub fn spi_mem_fwrite_dio(&mut self) -> SPI_MEM_FWRITE_DIO_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_FWRITE_DIO_W::new(self, 14)
    }
    #[doc = "Bit 15 - In the write operations address phase and read-data phase apply 4 signals."]
    #[inline(always)]
    pub fn spi_mem_fwrite_qio(&mut self) -> SPI_MEM_FWRITE_QIO_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_FWRITE_QIO_W::new(self, 15)
    }
    #[doc = "Bit 24 - read-data phase only access to high-part of the buffer spi_mem_w8~spi_mem_w15. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_usr_miso_highpart(
        &mut self,
    ) -> SPI_MEM_USR_MISO_HIGHPART_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_MISO_HIGHPART_W::new(self, 24)
    }
    #[doc = "Bit 25 - write-data phase only access to high-part of the buffer spi_mem_w8~spi_mem_w15. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_usr_mosi_highpart(
        &mut self,
    ) -> SPI_MEM_USR_MOSI_HIGHPART_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_MOSI_HIGHPART_W::new(self, 25)
    }
    #[doc = "Bit 26 - SPI clock is disable in dummy phase when the bit is enable."]
    #[inline(always)]
    pub fn spi_mem_usr_dummy_idle(&mut self) -> SPI_MEM_USR_DUMMY_IDLE_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_DUMMY_IDLE_W::new(self, 26)
    }
    #[doc = "Bit 27 - This bit enable the write-data phase of an operation."]
    #[inline(always)]
    pub fn spi_mem_usr_mosi(&mut self) -> SPI_MEM_USR_MOSI_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_MOSI_W::new(self, 27)
    }
    #[doc = "Bit 28 - This bit enable the read-data phase of an operation."]
    #[inline(always)]
    pub fn spi_mem_usr_miso(&mut self) -> SPI_MEM_USR_MISO_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_MISO_W::new(self, 28)
    }
    #[doc = "Bit 29 - This bit enable the dummy phase of an operation."]
    #[inline(always)]
    pub fn spi_mem_usr_dummy(&mut self) -> SPI_MEM_USR_DUMMY_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_DUMMY_W::new(self, 29)
    }
    #[doc = "Bit 30 - This bit enable the address phase of an operation."]
    #[inline(always)]
    pub fn spi_mem_usr_addr(&mut self) -> SPI_MEM_USR_ADDR_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_ADDR_W::new(self, 30)
    }
    #[doc = "Bit 31 - This bit enable the command phase of an operation."]
    #[inline(always)]
    pub fn spi_mem_usr_command(&mut self) -> SPI_MEM_USR_COMMAND_W<'_, SPI_MEM_USER_SPEC> {
        SPI_MEM_USR_COMMAND_W::new(self, 31)
    }
}
#[doc = "SPI1 user register.\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_user::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_user::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
