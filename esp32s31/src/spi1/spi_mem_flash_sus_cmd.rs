...
pub type SPI_MEM_FLASH_PES_COMMAND_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
pub type SPI_MEM_WAIT_PESR_COMMAND_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_FLASH_SUS_CMD")
            .field(
                ...
                &self.spi_mem_flash_pes_command(),
            )
            .field(
                "spi_mem_wait_pesr_command",
                &self.spi_mem_wait_pesr_command(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn spi_mem_flash_pes_command(
        &mut self,
    ) -> SPI_MEM_FLASH_PES_COMMAND_W<'_, SPI_MEM_FLASH_SUS_CMD_SPEC> {
        SPI_MEM_FLASH_PES_COMMAND_W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Flash SUS/SUS1/SUS2 status bit read command. The command should be sent when SUS/SUS1/SUS2 bit should be checked to insure the suspend or resume status of flash."]
    #[inline(always)]
    pub fn spi_mem_wait_pesr_command(
        &mut self,
    ) -> SPI_MEM_WAIT_PESR_COMMAND_W<'_, SPI_MEM_FLASH_SUS_CMD_SPEC> {
        SPI_MEM_WAIT_PESR_COMMAND_W::new(self, 16)
    }
}
#[doc = "SPI1 flash suspend command register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_flash_sus_cmd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_flash_sus_cmd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
