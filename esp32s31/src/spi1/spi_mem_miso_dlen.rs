...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_MISO_DLEN")
            .field("spi_mem_usr_miso_dbitlen", &self.spi_mem_usr_miso_dbitlen())
            .finish()
    }
}
impl W {
    ...
    pub fn spi_mem_usr_miso_dbitlen(
        &mut self,
    ) -> SPI_MEM_USR_MISO_DBITLEN_W<'_, SPI_MEM_MISO_DLEN_SPEC> {
        SPI_MEM_USR_MISO_DBITLEN_W::new(self, 0)
    }
}
#[doc = "SPI1 receive data bit length control register.\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_miso_dlen::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_miso_dlen::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
