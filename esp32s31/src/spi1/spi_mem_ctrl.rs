...
pub type SPI_MEM_FCS_CRC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_MEM_TX_CRC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_CTRL")
            ...
            .field("spi_mem_fcs_crc_en", &self.spi_mem_fcs_crc_en())
            .field("spi_mem_tx_crc_en", &self.spi_mem_tx_crc_en())
            .field("spi_mem_fastrd_mode", &self.spi_mem_fastrd_mode())
            .field("spi_mem_fread_dual", &self.spi_mem_fread_dual())
            .field("spi_mem_resandres", &self.spi_mem_resandres())
            ...
            .field("spi_mem_wrsr_2b", &self.spi_mem_wrsr_2b())
...
impl W {
    ...
    #[doc = "Bit 10 - For SPI1, initialize crc32 module before writing encrypted data to flash. Active low."]
    #[inline(always)]
    pub fn spi_mem_fcs_crc_en(&mut self) -> SPI_MEM_FCS_CRC_EN_W<'_, SPI_MEM_CTRL_SPEC> {
        SPI_MEM_FCS_CRC_EN_W::new(self, 10)
    }
    #[doc = "Bit 11 - For SPI1, enable crc32 when writing encrypted data to flash. 1: enable 0:disable"]
    #[inline(always)]
    pub fn spi_mem_tx_crc_en(&mut self) -> SPI_MEM_TX_CRC_EN_W<'_, SPI_MEM_CTRL_SPEC> {
        SPI_MEM_TX_CRC_EN_W::new(self, 11)
    }
    #[doc = "Bit 13 - This bit enable the bits: spi_mem_fread_qio, spi_mem_fread_dio, spi_mem_fread_qout and spi_mem_fread_dout. 1: enable 0: disable."]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - The Device ID is read out to SPI_MEM_RD_STATUS register, this bit combine with spi_mem_flash_res bit. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_resandres(&mut self) -> SPI_MEM_RESANDRES_W<'_, SPI_MEM_CTRL_SPEC> {
    ...
    #[doc = "Bit 22 - two bytes data will be written to status register when it is set. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_wrsr_2b(&mut self) -> SPI_MEM_WRSR_2B_W<'_, SPI_MEM_CTRL_SPEC> {
