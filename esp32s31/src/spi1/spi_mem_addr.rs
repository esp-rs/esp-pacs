...
impl W {
    #[doc = "Bits 0:31 - In user mode, it is the memory address. other then the bit0-bit23 is the memory address, the bit24-bit31 are the byte length of a transfer."]
    #[inline(always)]
    pub fn spi_mem_usr_addr_value(&mut self) -> SPI_MEM_USR_ADDR_VALUE_W<'_, SPI_MEM_ADDR_SPEC> {
        SPI_MEM_USR_ADDR_VALUE_W::new(self, 0)
    }
}
#[doc = "SPI1 address register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_addr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_addr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
