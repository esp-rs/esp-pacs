...
#[doc = "Field `SPI_MEM_CLK_EQU_SYSCLK` reader - reserved"]
pub type SPI_MEM_CLK_EQU_SYSCLK_R = crate::BitReader;
#[doc = "Field `SPI_MEM_CLK_EQU_SYSCLK` writer - reserved"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_CLOCK")
            .field("spi_mem_clkcnt_l", &self.spi_mem_clkcnt_l())
            .field("spi_mem_clkcnt_h", &self.spi_mem_clkcnt_h())
            .field("spi_mem_clkcnt_n", &self.spi_mem_clkcnt_n())
            .field("spi_mem_clk_equ_sysclk", &self.spi_mem_clk_equ_sysclk())
            .finish()
    }
}
impl W {
...
#[doc = "SPI1 clock division control register.\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_clock::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_clock::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
