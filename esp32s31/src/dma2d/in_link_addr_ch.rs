...
#[doc = "Field `INLINK_ADDR_CH` reader - This register stores the first inlink descriptor's address."]
pub type INLINK_ADDR_CH_R = crate::FieldReader<u32>;
#[doc = "Field `INLINK_ADDR_CH` writer - This register stores the first inlink descriptor's address."]
