...
pub type OUTFIFO_OVF_L1_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_UDF_L1_CH_INT_CLR` writer - Set this bit to clear the OUTFIFO_UDF_L1_CH_INT interrupt."]
pub type OUTFIFO_UDF_L1_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_OVF_L2_CH_INT_CLR` writer - Set this bit to clear the OUTFIFO_OVF_L2_CH_INT interrupt."]
pub type OUTFIFO_OVF_L2_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_UDF_L2_CH_INT_CLR` writer - Set this bit to clear the OUTFIFO_UDF_L2_CH_INT interrupt."]
pub type OUTFIFO_UDF_L2_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_OVF_L3_CH_INT_CLR` writer - Set this bit to clear the OUTFIFO_OVF_L3_CH_INT interrupt."]
pub type OUTFIFO_OVF_L3_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_UDF_L3_CH_INT_CLR` writer - Set this bit to clear the OUTFIFO_UDF_L3_CH_INT interrupt."]
pub type OUTFIFO_UDF_L3_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_RO_OVF_CH_INT_CLR` writer - Set this bit to clear the OUTFIFO_RO_OVF_CH_INT interrupt."]
pub type OUTFIFO_RO_OVF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_RO_UDF_CH_INT_CLR` writer - Set this bit to clear the OUTFIFO_RO_UDF_CH_INT interrupt."]
pub type OUTFIFO_RO_UDF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_DSCR_TASK_OVF_CH_INT_CLR` writer - Set this bit to clear the OUT_DSCR_TASK_OVF_CH_INT interrupt."]
pub type OUT_DSCR_TASK_OVF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn outfifo_ovf_l1_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_OVF_L1_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_OVF_L1_CH_INT_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - Set this bit to clear the OUTFIFO_UDF_L1_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_udf_l1_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_UDF_L1_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_UDF_L1_CH_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Set this bit to clear the OUTFIFO_OVF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_ovf_l2_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_OVF_L2_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_OVF_L2_CH_INT_CLR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Set this bit to clear the OUTFIFO_UDF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_udf_l2_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_UDF_L2_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_UDF_L2_CH_INT_CLR_W::new(self, 7)
    }
    #[doc = "Bit 8 - Set this bit to clear the OUTFIFO_OVF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_ovf_l3_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_OVF_L3_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_OVF_L3_CH_INT_CLR_W::new(self, 8)
    }
    #[doc = "Bit 9 - Set this bit to clear the OUTFIFO_UDF_L3_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_udf_l3_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_UDF_L3_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_UDF_L3_CH_INT_CLR_W::new(self, 9)
    }
    #[doc = "Bit 10 - Set this bit to clear the OUTFIFO_RO_OVF_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_ro_ovf_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_RO_OVF_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_RO_OVF_CH_INT_CLR_W::new(self, 10)
    }
    #[doc = "Bit 11 - Set this bit to clear the OUTFIFO_RO_UDF_CH_INT interrupt."]
    #[inline(always)]
    pub fn outfifo_ro_udf_ch_int_clr(
        &mut self,
    ) -> OUTFIFO_RO_UDF_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_RO_UDF_CH_INT_CLR_W::new(self, 11)
    }
    #[doc = "Bit 12 - Set this bit to clear the OUT_DSCR_TASK_OVF_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_dscr_task_ovf_ch_int_clr(
        &mut self,
    ) -> OUT_DSCR_TASK_OVF_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUT_DSCR_TASK_OVF_CH_INT_CLR_W::new(self, 12)
    }
}
