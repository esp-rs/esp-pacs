...
pub type INFIFO_OVF_L1_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `INFIFO_UDF_L1_CH_INT_ST` reader - The raw interrupt status bit for the INFIFO_UDF_L1_CH_INT interrupt."]
pub type INFIFO_UDF_L1_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `INFIFO_OVF_L2_CH_INT_ST` reader - The raw interrupt status bit for the INFIFO_OVF_L2_CH_INT interrupt."]
pub type INFIFO_OVF_L2_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `INFIFO_UDF_L2_CH_INT_ST` reader - The raw interrupt status bit for the INFIFO_UDF_L2_CH_INT interrupt."]
pub type INFIFO_UDF_L2_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `INFIFO_OVF_L3_CH_INT_ST` reader - The raw interrupt status bit for the INFIFO_OVF_L3_CH_INT interrupt."]
pub type INFIFO_OVF_L3_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `INFIFO_UDF_L3_CH_INT_ST` reader - The raw interrupt status bit for the INFIFO_UDF_L3_CH_INT interrupt."]
pub type INFIFO_UDF_L3_CH_INT_ST_R = crate::BitReader;
...
#[doc = "Field `INFIFO_RO_OVF_CH_INT_ST` reader - The raw interrupt status bit for the INFIFO_RO_OVF_CH_INT interrupt."]
pub type INFIFO_RO_OVF_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `INFIFO_RO_UDF_CH_INT_ST` reader - The raw interrupt status bit for the INFIFO_RO_UDF_CH_INT interrupt."]
pub type INFIFO_RO_UDF_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `IN_DSCR_TASK_OVF_CH_INT_ST` reader - The raw interrupt status bit for the IN_DSCR_TASK_OVF_CH_INT interrupt."]
pub type IN_DSCR_TASK_OVF_CH_INT_ST_R = crate::BitReader;
impl R {
    ...
    pub fn infifo_ovf_l1_ch_int_st(&self) -> INFIFO_OVF_L1_CH_INT_ST_R {
        INFIFO_OVF_L1_CH_INT_ST_R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    pub fn infifo_udf_l1_ch_int_st(&self) -> INFIFO_UDF_L1_CH_INT_ST_R {
        INFIFO_UDF_L1_CH_INT_ST_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - The raw interrupt status bit for the INFIFO_OVF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn infifo_ovf_l2_ch_int_st(&self) -> INFIFO_OVF_L2_CH_INT_ST_R {
        INFIFO_OVF_L2_CH_INT_ST_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - The raw interrupt status bit for the INFIFO_UDF_L2_CH_INT interrupt."]
    #[inline(always)]
    pub fn infifo_udf_l2_ch_int_st(&self) -> INFIFO_UDF_L2_CH_INT_ST_R {
        INFIFO_UDF_L2_CH_INT_ST_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[doc = "Bit 10 - The raw interrupt status bit for the IN_DSCR_EMPTY_CH_INT interrupt."]
    #[inline(always)]
    pub fn in_dscr_empty_ch_int_st(&self) -> IN_DSCR_EMPTY_CH_INT_ST_R {
        IN_DSCR_EMPTY_CH_INT_ST_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - The raw interrupt status bit for the INFIFO_RO_OVF_CH_INT interrupt."]
    #[inline(always)]
    pub fn infifo_ro_ovf_ch_int_st(&self) -> INFIFO_RO_OVF_CH_INT_ST_R {
        INFIFO_RO_OVF_CH_INT_ST_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - The raw interrupt status bit for the INFIFO_RO_UDF_CH_INT interrupt."]
    #[inline(always)]
    pub fn infifo_ro_udf_ch_int_st(&self) -> INFIFO_RO_UDF_CH_INT_ST_R {
        INFIFO_RO_UDF_CH_INT_ST_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - The raw interrupt status bit for the IN_DSCR_TASK_OVF_CH_INT interrupt."]
    #[inline(always)]
    pub fn in_dscr_task_ovf_ch_int_st(&self) -> IN_DSCR_TASK_OVF_CH_INT_ST_R {
        IN_DSCR_TASK_OVF_CH_INT_ST_R::new(((self.bits >> 13) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_INT_ST_CH")
            .field("in_done_ch_int_st", &self.in_done_ch_int_st())
            .field("in_suc_eof_ch_int_st", &self.in_suc_eof_ch_int_st())
            .field("in_err_eof_ch_int_st", &self.in_err_eof_ch_int_st())
            .field("in_dscr_err_ch_int_st", &self.in_dscr_err_ch_int_st())
            .field("infifo_ovf_l1_ch_int_st", &self.infifo_ovf_l1_ch_int_st())
            .field("infifo_udf_l1_ch_int_st", &self.infifo_udf_l1_ch_int_st())
            .field("infifo_ovf_l2_ch_int_st", &self.infifo_ovf_l2_ch_int_st())
            .field("infifo_udf_l2_ch_int_st", &self.infifo_udf_l2_ch_int_st())
            .field("infifo_ovf_l3_ch_int_st", &self.infifo_ovf_l3_ch_int_st())
            .field("infifo_udf_l3_ch_int_st", &self.infifo_udf_l3_ch_int_st())
            .field("in_dscr_empty_ch_int_st", &self.in_dscr_empty_ch_int_st())
            .field("infifo_ro_ovf_ch_int_st", &self.infifo_ro_ovf_ch_int_st())
            .field("infifo_ro_udf_ch_int_st", &self.infifo_ro_udf_ch_int_st())
            .field(
                "in_dscr_task_ovf_ch_int_st",
                &self.in_dscr_task_ovf_ch_int_st(),
            )
            .finish()
    }
}
