...
#[doc = "Field `OUTLINK_ADDR_CH` reader - This register stores the first outlink descriptor's address."]
pub type OUTLINK_ADDR_CH_R = crate::FieldReader<u32>;
#[doc = "Field `OUTLINK_ADDR_CH` writer - This register stores the first outlink descriptor's address."]
...
impl W {
    #[doc = "Bits 0:31 - This register stores the first outlink descriptor's address."]
    #[inline(always)]
    pub fn outlink_addr_ch(&mut self) -> OUTLINK_ADDR_CH_W<'_, OUT_LINK_ADDR_CH_SPEC> {
