#[doc = "Register `LP_AONCLKRST_LPCORE_RESET_CAUSE` reader"]
pub type R = crate::R<LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC>;
#[doc = "Register `LP_AONCLKRST_LPCORE_RESET_CAUSE` writer"]
pub type W = crate::W<LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC>;
...
impl R {
    ...
    pub fn lp_aonclkrst_lpcore_reset_flag(&self) -> LP_AONCLKRST_LPCORE_RESET_FLAG_R {
        LP_AONCLKRST_LPCORE_RESET_FLAG_R::new((self.bits & 1) != 0)
    }
    ...
    pub fn lp_aonclkrst_lpcore_reset_cause(&self) -> LP_AONCLKRST_LPCORE_RESET_CAUSE_R {
        LP_AONCLKRST_LPCORE_RESET_CAUSE_R::new(((self.bits >> 1) & 0x3f) as u8)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_AONCLKRST_LPCORE_RESET_CAUSE")
            .field(
...
impl W {
    #[doc = "Bit 29 - 1'b0: enable lpcore pmu_lp_cpu_reset reset_cause, 1'b1: disable lpcore pmu_lp_cpu_reset reset_cause"]
    #[inline(always)]
    pub fn pmu_lp_cpu_mask(
        &mut self,
    ) -> PMU_LP_CPU_MASK_W<'_, LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC> {
        PMU_LP_CPU_MASK_W::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn clr(&mut self) -> CLR_W<'_, LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC> {
        CLR_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn lp_aonclkrst_lpcore_reset_flag_clr(
        &mut self,
    ) -> LP_AONCLKRST_LPCORE_RESET_FLAG_CLR_W<'_, LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC> {
        LP_AONCLKRST_LPCORE_RESET_FLAG_CLR_W::new(self, 31)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`lp_aonclkrst_lpcore_reset_cause::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lp_aonclkrst_lpcore_reset_cause::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC;
impl crate::RegisterSpec for LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lp_aonclkrst_lpcore_reset_cause::R`](R) reader structure"]
impl crate::Readable for LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`lp_aonclkrst_lpcore_reset_cause::W`](W) writer structure"]
impl crate::Writable for LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LP_AONCLKRST_LPCORE_RESET_CAUSE to value 0x2000_0000"]
impl crate::Resettable for LP_AONCLKRST_LPCORE_RESET_CAUSE_SPEC {
