...
pub type R = crate::R<SPI_MEM_SRAM_CMD_SPEC>;
#[doc = "Register `SPI_MEM_SRAM_CMD` writer"]
pub type W = crate::W<SPI_MEM_SRAM_CMD_SPEC>;
...
#[doc = "Field `SPI_MEM_SCLK_MODE` writer - SPI clock mode bits. 0: SPI clock is off when CS inactive 1: SPI clock is delayed one cycle after CS inactive 2: SPI clock is delayed two cycles after CS inactive 3: SPI clock is always on."]
pub type SPI_MEM_SCLK_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
#[doc = "Field `SPI_MEM_SWB_MODE` writer - Mode bits in the external RAM fast read mode it is combined with spi_mem_fastrd_mode bit."]
pub type SPI_MEM_SWB_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
#[doc = "Field `SPI_MEM_SDIN_DUAL` writer - For SPI0 external RAM , din phase apply 2 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_dio."]
pub type SPI_MEM_SDIN_DUAL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SDOUT_DUAL` writer - For SPI0 external RAM , dout phase apply 2 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_dio."]
pub type SPI_MEM_SDOUT_DUAL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SADDR_DUAL` writer - For SPI0 external RAM , address phase apply 2 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_dio."]
pub type SPI_MEM_SADDR_DUAL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SDIN_QUAD` writer - For SPI0 external RAM , din phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
pub type SPI_MEM_SDIN_QUAD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SDOUT_QUAD` writer - For SPI0 external RAM , dout phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
pub type SPI_MEM_SDOUT_QUAD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SADDR_QUAD` writer - For SPI0 external RAM , address phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
pub type SPI_MEM_SADDR_QUAD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SCMD_QUAD` writer - For SPI0 external RAM , cmd phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
pub type SPI_MEM_SCMD_QUAD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SDIN_OCT` writer - For SPI0 external RAM , din phase apply 8 signals. 1: enable 0: disable."]
pub type SPI_MEM_SDIN_OCT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SDOUT_OCT` writer - For SPI0 external RAM , dout phase apply 8 signals. 1: enable 0: disable."]
pub type SPI_MEM_SDOUT_OCT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SADDR_OCT` writer - For SPI0 external RAM , address phase apply 4 signals. 1: enable 0: disable."]
pub type SPI_MEM_SADDR_OCT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SCMD_OCT` writer - For SPI0 external RAM , cmd phase apply 8 signals. 1: enable 0: disable."]
pub type SPI_MEM_SCMD_OCT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SDUMMY_WOUT` writer - In the dummy phase of a MSPI write data transfer when accesses to external RAM, the signal level of SPI bus is output by the MSPI controller."]
pub type SPI_MEM_SDUMMY_WOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SDIN_HEX` reader - For SPI0 external RAM , din phase apply 16 signals. 1: enable 0: disable."]
pub type SPI_MEM_SDIN_HEX_R = crate::BitReader;
#[doc = "Field `SPI_MEM_SDIN_HEX` writer - For SPI0 external RAM , din phase apply 16 signals. 1: enable 0: disable."]
pub type SPI_MEM_SDIN_HEX_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPI_MEM_SDOUT_HEX` reader - For SPI0 external RAM , dout phase apply 16 signals. 1: enable 0: disable."]
pub type SPI_MEM_SDOUT_HEX_R = crate::BitReader;
#[doc = "Field `SPI_MEM_SDOUT_HEX` writer - For SPI0 external RAM , dout phase apply 16 signals. 1: enable 0: disable."]
pub type SPI_MEM_SDOUT_HEX_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn spi_mem_sdin_hex(&self) -> SPI_MEM_SDIN_HEX_R {
        SPI_MEM_SDIN_HEX_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - For SPI0 external RAM , dout phase apply 16 signals. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_sdout_hex(&self) -> SPI_MEM_SDOUT_HEX_R {
        SPI_MEM_SDOUT_HEX_R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_SRAM_CMD")
            .field("spi_mem_sclk_mode", &self.spi_mem_sclk_mode())
            .field("spi_mem_swb_mode", &self.spi_mem_swb_mode())
            .field("spi_mem_sdin_dual", &self.spi_mem_sdin_dual())
            .field("spi_mem_sdout_dual", &self.spi_mem_sdout_dual())
            .field("spi_mem_saddr_dual", &self.spi_mem_saddr_dual())
            .field("spi_mem_sdin_quad", &self.spi_mem_sdin_quad())
            .field("spi_mem_sdout_quad", &self.spi_mem_sdout_quad())
            .field("spi_mem_saddr_quad", &self.spi_mem_saddr_quad())
            .field("spi_mem_scmd_quad", &self.spi_mem_scmd_quad())
            .field("spi_mem_sdin_oct", &self.spi_mem_sdin_oct())
            .field("spi_mem_sdout_oct", &self.spi_mem_sdout_oct())
            .field("spi_mem_saddr_oct", &self.spi_mem_saddr_oct())
            .field("spi_mem_scmd_oct", &self.spi_mem_scmd_oct())
            .field("spi_mem_sdummy_rin", &self.spi_mem_sdummy_rin())
            .field("spi_mem_sdummy_wout", &self.spi_mem_sdummy_wout())
            .field(
            ...
            .field("spi_mem_sdin_hex", &self.spi_mem_sdin_hex())
            .field("spi_mem_sdout_hex", &self.spi_mem_sdout_hex())
            .field(
...
impl W {
    #[doc = "Bits 0:1 - SPI clock mode bits. 0: SPI clock is off when CS inactive 1: SPI clock is delayed one cycle after CS inactive 2: SPI clock is delayed two cycles after CS inactive 3: SPI clock is always on."]
    #[inline(always)]
    pub fn spi_mem_sclk_mode(&mut self) -> SPI_MEM_SCLK_MODE_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SCLK_MODE_W::new(self, 0)
    }
    #[doc = "Bits 2:9 - Mode bits in the external RAM fast read mode it is combined with spi_mem_fastrd_mode bit."]
    #[inline(always)]
    pub fn spi_mem_swb_mode(&mut self) -> SPI_MEM_SWB_MODE_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SWB_MODE_W::new(self, 2)
    }
    #[doc = "Bit 10 - For SPI0 external RAM , din phase apply 2 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_dio."]
    #[inline(always)]
    pub fn spi_mem_sdin_dual(&mut self) -> SPI_MEM_SDIN_DUAL_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDIN_DUAL_W::new(self, 10)
    }
    #[doc = "Bit 11 - For SPI0 external RAM , dout phase apply 2 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_dio."]
    #[inline(always)]
    pub fn spi_mem_sdout_dual(&mut self) -> SPI_MEM_SDOUT_DUAL_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDOUT_DUAL_W::new(self, 11)
    }
    #[doc = "Bit 12 - For SPI0 external RAM , address phase apply 2 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_dio."]
    #[inline(always)]
    pub fn spi_mem_saddr_dual(&mut self) -> SPI_MEM_SADDR_DUAL_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SADDR_DUAL_W::new(self, 12)
    }
    #[doc = "Bit 14 - For SPI0 external RAM , din phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
    #[inline(always)]
    pub fn spi_mem_sdin_quad(&mut self) -> SPI_MEM_SDIN_QUAD_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDIN_QUAD_W::new(self, 14)
    }
    #[doc = "Bit 15 - For SPI0 external RAM , dout phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
    #[inline(always)]
    pub fn spi_mem_sdout_quad(&mut self) -> SPI_MEM_SDOUT_QUAD_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDOUT_QUAD_W::new(self, 15)
    }
    #[doc = "Bit 16 - For SPI0 external RAM , address phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
    #[inline(always)]
    pub fn spi_mem_saddr_quad(&mut self) -> SPI_MEM_SADDR_QUAD_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SADDR_QUAD_W::new(self, 16)
    }
    #[doc = "Bit 17 - For SPI0 external RAM , cmd phase apply 4 signals. 1: enable 0: disable. The bit is the same with spi_mem_usr_sram_qio."]
    #[inline(always)]
    pub fn spi_mem_scmd_quad(&mut self) -> SPI_MEM_SCMD_QUAD_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SCMD_QUAD_W::new(self, 17)
    }
    #[doc = "Bit 18 - For SPI0 external RAM , din phase apply 8 signals. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_sdin_oct(&mut self) -> SPI_MEM_SDIN_OCT_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDIN_OCT_W::new(self, 18)
    }
    #[doc = "Bit 19 - For SPI0 external RAM , dout phase apply 8 signals. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_sdout_oct(&mut self) -> SPI_MEM_SDOUT_OCT_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDOUT_OCT_W::new(self, 19)
    }
    #[doc = "Bit 20 - For SPI0 external RAM , address phase apply 4 signals. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_saddr_oct(&mut self) -> SPI_MEM_SADDR_OCT_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SADDR_OCT_W::new(self, 20)
    }
    #[doc = "Bit 21 - For SPI0 external RAM , cmd phase apply 8 signals. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_scmd_oct(&mut self) -> SPI_MEM_SCMD_OCT_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SCMD_OCT_W::new(self, 21)
    }
    #[doc = "Bit 22 - In the dummy phase of a MSPI read data transfer when accesses to external RAM, the signal level of SPI bus is output by the MSPI controller."]
    #[inline(always)]
    pub fn spi_mem_sdummy_rin(&mut self) -> SPI_MEM_SDUMMY_RIN_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDUMMY_RIN_W::new(self, 22)
    }
    #[doc = "Bit 23 - In the dummy phase of a MSPI write data transfer when accesses to external RAM, the signal level of SPI bus is output by the MSPI controller."]
    #[inline(always)]
    pub fn spi_mem_sdummy_wout(&mut self) -> SPI_MEM_SDUMMY_WOUT_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDUMMY_WOUT_W::new(self, 23)
    }
    #[doc = "Bit 24 - In the dummy phase of an MSPI write data transfer when accesses to external RAM, the level of SPI_DQS is output by the MSPI controller."]
    #[inline(always)]
    pub fn spi_smem_wdummy_dqs_always_out(
        &mut self,
    ) -> SPI_SMEM_WDUMMY_DQS_ALWAYS_OUT_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
    ...
    pub fn spi_smem_wdummy_always_out(
        &mut self,
    ) -> SPI_SMEM_WDUMMY_ALWAYS_OUT_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_SMEM_WDUMMY_ALWAYS_OUT_W::new(self, 25)
    }
    #[doc = "Bit 26 - For SPI0 external RAM , din phase apply 16 signals. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_sdin_hex(&mut self) -> SPI_MEM_SDIN_HEX_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDIN_HEX_W::new(self, 26)
    }
    #[doc = "Bit 27 - For SPI0 external RAM , dout phase apply 16 signals. 1: enable 0: disable."]
    #[inline(always)]
    pub fn spi_mem_sdout_hex(&mut self) -> SPI_MEM_SDOUT_HEX_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_MEM_SDOUT_HEX_W::new(self, 27)
    }
    #[doc = "Bit 30 - When accesses to external RAM, 1: the IE signals of pads connected to SPI_DQS are always 1. 0: Others."]
    #[inline(always)]
    pub fn spi_smem_dqs_ie_always_on(
        &mut self,
    ) -> SPI_SMEM_DQS_IE_ALWAYS_ON_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
    ...
    pub fn spi_smem_data_ie_always_on(
        &mut self,
    ) -> SPI_SMEM_DATA_IE_ALWAYS_ON_W<'_, SPI_MEM_SRAM_CMD_SPEC> {
        SPI_SMEM_DATA_IE_ALWAYS_ON_W::new(self, 31)
    }
}
#[doc = "SPI0 external RAM mode control register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_sram_cmd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_sram_cmd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
