...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_CTRL1")
            ...
            .field("spi_mem_rresp_ecc_err_en", &self.spi_mem_rresp_ecc_err_en())
            .field("spi_mem_ar_splice_en", &self.spi_mem_ar_splice_en())
            .field("spi_mem_aw_splice_en", &self.spi_mem_aw_splice_en())
            .field("spi_mem_ram0_en", &self.spi_mem_ram0_en())
            .field("spi_mem_dual_ram_en", &self.spi_mem_dual_ram_en())
            .field("spi_mem_fast_write_en", &self.spi_mem_fast_write_en())
            .finish()
    }
}
impl W {
    ...
    pub fn spi_ar_size0_1_support_en(
        &mut self,
    ) -> SPI_AR_SIZE0_1_SUPPORT_EN_W<'_, SPI_MEM_CTRL1_SPEC> {
    ...
    pub fn spi_aw_size0_1_support_en(
        &mut self,
    ) -> SPI_AW_SIZE0_1_SUPPORT_EN_W<'_, SPI_MEM_CTRL1_SPEC> {
    ...
    pub fn spi_mem_rresp_ecc_err_en(
        &mut self,
    ) -> SPI_MEM_RRESP_ECC_ERR_EN_W<'_, SPI_MEM_CTRL1_SPEC> {
        SPI_MEM_RRESP_ECC_ERR_EN_W::new(self, 24)
    }
    #[doc = "Bit 25 - Set this bit to enable AXI Read Splice-transfer."]
    #[inline(always)]
    pub fn spi_mem_ar_splice_en(&mut self) -> SPI_MEM_AR_SPLICE_EN_W<'_, SPI_MEM_CTRL1_SPEC> {
        SPI_MEM_AR_SPLICE_EN_W::new(self, 25)
    }
    #[doc = "Bit 26 - Set this bit to enable AXI Write Splice-transfer."]
    #[inline(always)]
    pub fn spi_mem_aw_splice_en(&mut self) -> SPI_MEM_AW_SPLICE_EN_W<'_, SPI_MEM_CTRL1_SPEC> {
        SPI_MEM_AW_SPLICE_EN_W::new(self, 26)
    }
    #[doc = "Bit 29 - Set this bit to write data faster, do not wait write data has been stored in tx_bus_fifo_l2. It will wait 4*T_clk_ctrl to insure the write data has been stored in tx_bus_fifo_l2."]
    #[inline(always)]
    pub fn spi_mem_fast_write_en(&mut self) -> SPI_MEM_FAST_WRITE_EN_W<'_, SPI_MEM_CTRL1_SPEC> {
    ...
    #[inline(always)]
    pub fn spi_mem_rxfifo_rst(&mut self) -> SPI_MEM_RXFIFO_RST_W<'_, SPI_MEM_CTRL1_SPEC> {
    ...
    #[inline(always)]
    pub fn spi_mem_txfifo_rst(&mut self) -> SPI_MEM_TXFIFO_RST_W<'_, SPI_MEM_CTRL1_SPEC> {
...
#[doc = "`reset()` method sets SPI_MEM_CTRL1 to value 0x28c0_0000"]
