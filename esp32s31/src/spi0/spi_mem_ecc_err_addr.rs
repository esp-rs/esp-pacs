...
impl R {
    ...
    pub fn spi_mem_ecc_err_addr(&self) -> SPI_MEM_ECC_ERR_ADDR_R {
        SPI_MEM_ECC_ERR_ADDR_R::new(self.bits & 0x1fff_ffff)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_ECC_ERR_ADDR")
            .field("spi_mem_ecc_err_addr", &self.spi_mem_ecc_err_addr())
            .finish()
    }
}
#[doc = "MSPI ECC error address register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_ecc_err_addr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
