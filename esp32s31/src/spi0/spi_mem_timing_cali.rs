...
#[doc = "Field `SPI_MEM_DLL_TIMING_CALI` writer - Set this bit to enable DLL for timing calibration in DDR mode when accessed to flash."]
pub type SPI_MEM_DLL_TIMING_CALI_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_TIMING_CALI")
            .field("spi_mem_timing_clk_ena", &self.spi_mem_timing_clk_ena())
            .field("spi_mem_timing_cali", &self.spi_mem_timing_cali())
            .field(
                "spi_mem_extra_dummy_cyclelen",
                &self.spi_mem_extra_dummy_cyclelen(),
            )
            .field("spi_mem_dll_timing_cali", &self.spi_mem_dll_timing_cali())
            .finish()
    }
}
impl W {
    ...
    pub fn spi_mem_timing_clk_ena(
        &mut self,
    ) -> SPI_MEM_TIMING_CLK_ENA_W<'_, SPI_MEM_TIMING_CALI_SPEC> {
    ...
    #[doc = "Bit 5 - Set this bit to enable DLL for timing calibration in DDR mode when accessed to flash."]
    #[inline(always)]
    pub fn spi_mem_dll_timing_cali(
        &mut self,
    ) -> SPI_MEM_DLL_TIMING_CALI_W<'_, SPI_MEM_TIMING_CALI_SPEC> {
        SPI_MEM_DLL_TIMING_CALI_W::new(self, 5)
    }
    #[doc = "Bit 6 - Set this bit to update delay mode, delay num and extra dummy in MSPI."]
    #[inline(always)]
    pub fn update(&mut self) -> UPDATE_W<'_, SPI_MEM_TIMING_CALI_SPEC> {
        UPDATE_W::new(self, 6)
    }
}
