...
#[doc = "Field `SPI_XTS_SHADOW_FOR_SEC` reader - 1: shadow core mode for security (against fault injection attack). 0: shadow core mode for performance."]
pub type SPI_XTS_SHADOW_FOR_SEC_R = crate::BitReader;
#[doc = "Field `SPI_XTS_SHADOW_FOR_SEC` writer - 1: shadow core mode for security (against fault injection attack). 0: shadow core mode for performance."]
...
impl W {
    ...
    pub fn spi_crypt_security_level(
        &mut self,
    ) -> SPI_CRYPT_SECURITY_LEVEL_W<'_, SPI_MEM_DPA_CTRL_SPEC> {
    ...
    pub fn spi_crypt_calc_d_dpa_en(
        &mut self,
    ) -> SPI_CRYPT_CALC_D_DPA_EN_W<'_, SPI_MEM_DPA_CTRL_SPEC> {
    ...
    pub fn spi_crypt_dpa_select_register(
        &mut self,
    ) -> SPI_CRYPT_DPA_SELECT_REGISTER_W<'_, SPI_MEM_DPA_CTRL_SPEC> {
        SPI_CRYPT_DPA_SELECT_REGISTER_W::new(self, 4)
    }
    #[doc = "Bit 5 - 1: shadow core mode for security (against fault injection attack). 0: shadow core mode for performance."]
    #[inline(always)]
    pub fn spi_xts_shadow_for_sec(
        &mut self,
    ) -> SPI_XTS_SHADOW_FOR_SEC_W<'_, SPI_MEM_DPA_CTRL_SPEC> {
        SPI_XTS_SHADOW_FOR_SEC_W::new(self, 5)
    }
}
#[doc = "SPI memory cryption DPA register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_dpa_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_dpa_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets SPI_MEM_DPA_CTRL to value 0x2f"]
