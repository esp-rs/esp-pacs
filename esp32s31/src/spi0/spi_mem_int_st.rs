...
#[doc = "Field `SPI_MEM_XTS_FAULT_DETECTED_INT_ST` reader - The status bit for SPI_MEM_XTS_FAULT_DETECTED_INT interrupt."]
pub type SPI_MEM_XTS_FAULT_DETECTED_INT_ST_R = crate::BitReader;
#[doc = "Field `SPI_MEM_RX_TRANS_OVF_INT_ST` reader - The status bit for SPI_MEM_RX_TRANS_OVF_INT interrupt."]
pub type SPI_MEM_RX_TRANS_OVF_INT_ST_R = crate::BitReader;
#[doc = "Field `SPI_MEM_TX_TRANS_UDF_INT_ST` reader - The status bit for SPI_MEM_TX_TRANS_UDF_INT interrupt."]
pub type SPI_MEM_TX_TRANS_UDF_INT_ST_R = crate::BitReader;
#[doc = "Field `SPI_MEM_DQS0_AFIFO_OVF_INT_ST` reader - The status bit for SPI_MEM_DQS0_AFIFO_OVF_INT interrupt."]
pub type SPI_MEM_DQS0_AFIFO_OVF_INT_ST_R = crate::BitReader;
#[doc = "Field `SPI_MEM_DQS1_AFIFO_OVF_INT_ST` reader - The status bit for SPI_MEM_DQS1_AFIFO_OVF_INT interrupt."]
pub type SPI_MEM_DQS1_AFIFO_OVF_INT_ST_R = crate::BitReader;
#[doc = "Field `SPI_MEM_BUS_FIFO1_UDF_INT_ST` reader - The status bit for SPI_MEM_BUS_FIFO1_UDF_INT interrupt."]
pub type SPI_MEM_BUS_FIFO1_UDF_INT_ST_R = crate::BitReader;
#[doc = "Field `SPI_MEM_BUS_FIFO0_UDF_INT_ST` reader - The status bit for SPI_MEM_BUS_FIFO0_UDF_INT interrupt."]
pub type SPI_MEM_BUS_FIFO0_UDF_INT_ST_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn spi_mem_xts_fault_detected_int_st(&self) -> SPI_MEM_XTS_FAULT_DETECTED_INT_ST_R {
        SPI_MEM_XTS_FAULT_DETECTED_INT_ST_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 26 - The status bit for SPI_MEM_RX_TRANS_OVF_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_rx_trans_ovf_int_st(&self) -> SPI_MEM_RX_TRANS_OVF_INT_ST_R {
        SPI_MEM_RX_TRANS_OVF_INT_ST_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - The status bit for SPI_MEM_TX_TRANS_UDF_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_tx_trans_udf_int_st(&self) -> SPI_MEM_TX_TRANS_UDF_INT_ST_R {
        SPI_MEM_TX_TRANS_UDF_INT_ST_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - The status bit for SPI_MEM_DQS0_AFIFO_OVF_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_dqs0_afifo_ovf_int_st(&self) -> SPI_MEM_DQS0_AFIFO_OVF_INT_ST_R {
        SPI_MEM_DQS0_AFIFO_OVF_INT_ST_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - The status bit for SPI_MEM_DQS1_AFIFO_OVF_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_dqs1_afifo_ovf_int_st(&self) -> SPI_MEM_DQS1_AFIFO_OVF_INT_ST_R {
        SPI_MEM_DQS1_AFIFO_OVF_INT_ST_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - The status bit for SPI_MEM_BUS_FIFO1_UDF_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_bus_fifo1_udf_int_st(&self) -> SPI_MEM_BUS_FIFO1_UDF_INT_ST_R {
        SPI_MEM_BUS_FIFO1_UDF_INT_ST_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - The status bit for SPI_MEM_BUS_FIFO0_UDF_INT interrupt."]
    #[inline(always)]
    pub fn spi_mem_bus_fifo0_udf_int_st(&self) -> SPI_MEM_BUS_FIFO0_UDF_INT_ST_R {
        SPI_MEM_BUS_FIFO0_UDF_INT_ST_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_INT_ST")
            ...
            .field(
                "spi_mem_xts_fault_detected_int_st",
                &self.spi_mem_xts_fault_detected_int_st(),
            )
            .field(
                "spi_mem_rx_trans_ovf_int_st",
                &self.spi_mem_rx_trans_ovf_int_st(),
            )
            .field(
                "spi_mem_tx_trans_udf_int_st",
                &self.spi_mem_tx_trans_udf_int_st(),
            )
            .field(
                "spi_mem_dqs0_afifo_ovf_int_st",
                &self.spi_mem_dqs0_afifo_ovf_int_st(),
            )
            .field(
                "spi_mem_dqs1_afifo_ovf_int_st",
                &self.spi_mem_dqs1_afifo_ovf_int_st(),
            )
            .field(
                "spi_mem_bus_fifo1_udf_int_st",
                &self.spi_mem_bus_fifo1_udf_int_st(),
            )
            .field(
                "spi_mem_bus_fifo0_udf_int_st",
                &self.spi_mem_bus_fifo0_udf_int_st(),
            )
            .finish()
    }
}
