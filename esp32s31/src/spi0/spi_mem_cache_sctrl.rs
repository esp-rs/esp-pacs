    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_CACHE_SCTRL")
            .field(
                ...
                &self.spi_mem_cache_usr_saddr_4byte(),
            )
            .field("spi_mem_usr_sram_dio", &self.spi_mem_usr_sram_dio())
            .field("spi_mem_usr_sram_qio", &self.spi_mem_usr_sram_qio())
            .field(
                "spi_mem_usr_wr_sram_dummy",
                &self.spi_mem_usr_wr_sram_dummy(),
            )
            .field(
                "spi_mem_usr_rd_sram_dummy",
                &self.spi_mem_usr_rd_sram_dummy(),
            )
            .field(
                "spi_mem_cache_sram_usr_rcmd",
                &self.spi_mem_cache_sram_usr_rcmd(),
            )
            .field(
                "spi_mem_sram_rdummy_cyclelen",
                &self.spi_mem_sram_rdummy_cyclelen(),
            )
            .field("spi_mem_sram_addr_bitlen", &self.spi_mem_sram_addr_bitlen())
            .field(
                "spi_mem_cache_sram_usr_wcmd",
                &self.spi_mem_cache_sram_usr_wcmd(),
            )
            .field("spi_mem_sram_oct", &self.spi_mem_sram_oct())
            .field(
                "spi_mem_sram_wdummy_cyclelen",
                &self.spi_mem_sram_wdummy_cyclelen(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn spi_mem_cache_usr_saddr_4byte(
        &mut self,
    ) -> SPI_MEM_CACHE_USR_SADDR_4BYTE_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
        SPI_MEM_CACHE_USR_SADDR_4BYTE_W::new(self, 0)
    }
    #[doc = "Bit 1 - For SPI0, In the external RAM mode, spi dual I/O mode enable, 1: enable, 0:disable"]
    #[inline(always)]
    pub fn spi_mem_usr_sram_dio(&mut self) -> SPI_MEM_USR_SRAM_DIO_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
        SPI_MEM_USR_SRAM_DIO_W::new(self, 1)
    }
    #[doc = "Bit 2 - For SPI0, In the external RAM mode, spi quad I/O mode enable, 1: enable, 0:disable"]
    #[inline(always)]
    pub fn spi_mem_usr_sram_qio(&mut self) -> SPI_MEM_USR_SRAM_QIO_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
    ...
    pub fn spi_mem_usr_wr_sram_dummy(
        &mut self,
    ) -> SPI_MEM_USR_WR_SRAM_DUMMY_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
    ...
    pub fn spi_mem_usr_rd_sram_dummy(
        &mut self,
    ) -> SPI_MEM_USR_RD_SRAM_DUMMY_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
    ...
    pub fn spi_mem_cache_sram_usr_rcmd(
        &mut self,
    ) -> SPI_MEM_CACHE_SRAM_USR_RCMD_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
    ...
    pub fn spi_mem_sram_rdummy_cyclelen(
        &mut self,
    ) -> SPI_MEM_SRAM_RDUMMY_CYCLELEN_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
    ...
    pub fn spi_mem_sram_addr_bitlen(
        &mut self,
    ) -> SPI_MEM_SRAM_ADDR_BITLEN_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
    ...
    pub fn spi_mem_cache_sram_usr_wcmd(
        &mut self,
    ) -> SPI_MEM_CACHE_SRAM_USR_WCMD_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
        SPI_MEM_CACHE_SRAM_USR_WCMD_W::new(self, 20)
    }
    #[doc = "Bit 21 - reserved"]
    #[inline(always)]
    pub fn spi_mem_sram_oct(&mut self) -> SPI_MEM_SRAM_OCT_W<'_, SPI_MEM_CACHE_SCTRL_SPEC> {
