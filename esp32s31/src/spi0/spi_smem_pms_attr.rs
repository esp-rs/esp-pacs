...
#[doc = "Field `SPI_SMEM_PMS_NONSECURE_RD_ATTR` reader - 1: SPI1 external RAM non-secure PMS section %s read accessible. 0: Not allowed."]
pub type SPI_SMEM_PMS_NONSECURE_RD_ATTR_R = crate::BitReader;
#[doc = "Field `SPI_SMEM_PMS_NONSECURE_RD_ATTR` writer - 1: SPI1 external RAM non-secure PMS section %s read accessible. 0: Not allowed."]
pub type SPI_SMEM_PMS_NONSECURE_RD_ATTR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPI_SMEM_PMS_NONSECURE_WR_ATTR` reader - 1: SPI1 external RAM non-secure PMS section %s write accessible. 0: Not allowed."]
pub type SPI_SMEM_PMS_NONSECURE_WR_ATTR_R = crate::BitReader;
#[doc = "Field `SPI_SMEM_PMS_NONSECURE_WR_ATTR` writer - 1: SPI1 external RAM non-secure PMS section %s write accessible. 0: Not allowed."]
pub type SPI_SMEM_PMS_NONSECURE_WR_ATTR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPI_SMEM_PMS_NONSECURE_ECC` reader - SPI1 external RAM non-secure PMS section %s ECC mode, 1: enable ECC mode. 0: Disable it. The external RAM PMS section %s is configured by registers SPI_SMEM_PMS%s_ADDR_REG and SPI_SMEM_PMS%s_SIZE_REG."]
pub type SPI_SMEM_PMS_NONSECURE_ECC_R = crate::BitReader;
#[doc = "Field `SPI_SMEM_PMS_NONSECURE_ECC` writer - SPI1 external RAM non-secure PMS section %s ECC mode, 1: enable ECC mode. 0: Disable it. The external RAM PMS section %s is configured by registers SPI_SMEM_PMS%s_ADDR_REG and SPI_SMEM_PMS%s_SIZE_REG."]
pub type SPI_SMEM_PMS_NONSECURE_ECC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn spi_smem_pms_nonsecure_rd_attr(&self) -> SPI_SMEM_PMS_NONSECURE_RD_ATTR_R {
        SPI_SMEM_PMS_NONSECURE_RD_ATTR_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - 1: SPI1 external RAM non-secure PMS section %s write accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms_nonsecure_wr_attr(&self) -> SPI_SMEM_PMS_NONSECURE_WR_ATTR_R {
        SPI_SMEM_PMS_NONSECURE_WR_ATTR_R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn spi_smem_pms_nonsecure_ecc(&self) -> SPI_SMEM_PMS_NONSECURE_ECC_R {
        SPI_SMEM_PMS_NONSECURE_ECC_R::new(((self.bits >> 5) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_SMEM_PMS_ATTR")
            ...
            .field(
                "spi_smem_pms_nonsecure_rd_attr",
                &self.spi_smem_pms_nonsecure_rd_attr(),
            )
            .field(
                "spi_smem_pms_nonsecure_wr_attr",
                &self.spi_smem_pms_nonsecure_wr_attr(),
            )
            .field(
                "spi_smem_pms_nonsecure_ecc",
                &self.spi_smem_pms_nonsecure_ecc(),
            )
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 3 - 1: SPI1 external RAM non-secure PMS section %s read accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms_nonsecure_rd_attr(
        &mut self,
    ) -> SPI_SMEM_PMS_NONSECURE_RD_ATTR_W<'_, SPI_SMEM_PMS_ATTR_SPEC> {
        SPI_SMEM_PMS_NONSECURE_RD_ATTR_W::new(self, 3)
    }
    #[doc = "Bit 4 - 1: SPI1 external RAM non-secure PMS section %s write accessible. 0: Not allowed."]
    #[inline(always)]
    pub fn spi_smem_pms_nonsecure_wr_attr(
        &mut self,
    ) -> SPI_SMEM_PMS_NONSECURE_WR_ATTR_W<'_, SPI_SMEM_PMS_ATTR_SPEC> {
        SPI_SMEM_PMS_NONSECURE_WR_ATTR_W::new(self, 4)
    }
    #[doc = "Bit 5 - SPI1 external RAM non-secure PMS section %s ECC mode, 1: enable ECC mode. 0: Disable it. The external RAM PMS section %s is configured by registers SPI_SMEM_PMS%s_ADDR_REG and SPI_SMEM_PMS%s_SIZE_REG."]
    #[inline(always)]
    pub fn spi_smem_pms_nonsecure_ecc(
        &mut self,
    ) -> SPI_SMEM_PMS_NONSECURE_ECC_W<'_, SPI_SMEM_PMS_ATTR_SPEC> {
        SPI_SMEM_PMS_NONSECURE_ECC_W::new(self, 5)
    }
}
