...
#[doc = "Field `XTS_FAULT_DETECTED` reader - The enable bit for SPI_MEM_XTS_FAULT_DETECTED_INT interrupt."]
pub type XTS_FAULT_DETECTED_R = crate::BitReader;
#[doc = "Field `XTS_FAULT_DETECTED` writer - The enable bit for SPI_MEM_XTS_FAULT_DETECTED_INT interrupt."]
...
impl W {
    ...
    #[doc = "Bit 5 - The enable bit for SPI_MEM_ECC_ERR_INT interrupt."]
    #[inline(always)]
    pub fn ecc_err(&mut self) -> ECC_ERR_W<'_, INT_ENA_SPEC> {
    ...
    #[doc = "Bit 8 - The enable bit for SPI_MEM_AXI_WR_FALSH_ERR_INT interrupt."]
    #[inline(always)]
    pub fn axi_wr_flash_err(&mut self) -> AXI_WR_FLASH_ERR_W<'_, INT_ENA_SPEC> {
    ...
    #[doc = "Bit 13 - The enable bit for SPI_MEM_XTS_FAULT_DETECTED_INT interrupt."]
    #[inline(always)]
    pub fn xts_fault_detected(&mut self) -> XTS_FAULT_DETECTED_W<'_, INT_ENA_SPEC> {
    ...
    #[doc = "Bit 28 - The enable bit for SPI_MEM_DQS0_AFIFO_OVF_INT interrupt."]
    #[inline(always)]
    pub fn dqs0_afifo_ovf(&mut self) -> DQS0_AFIFO_OVF_W<'_, INT_ENA_SPEC> {
        DQS0_AFIFO_OVF_W::new(self, 28)
    }
    #[doc = "Bit 29 - The enable bit for SPI_MEM_DQS1_AFIFO_OVF_INT interrupt."]
    #[inline(always)]
    pub fn dqs1_afifo_ovf(&mut self) -> DQS1_AFIFO_OVF_W<'_, INT_ENA_SPEC> {
        DQS1_AFIFO_OVF_W::new(self, 29)
    }
    #[doc = "Bit 30 - The enable bit for SPI_MEM_BUS_FIFO1_UDF_INT interrupt."]
    #[inline(always)]
    pub fn bus_fifo1_udf(&mut self) -> BUS_FIFO1_UDF_W<'_, INT_ENA_SPEC> {
        BUS_FIFO1_UDF_W::new(self, 30)
    }
    #[doc = "Bit 31 - The enable bit for SPI_MEM_BUS_FIFO0_UDF_INT interrupt."]
    #[inline(always)]
    pub fn bus_fifo0_udf(&mut self) -> BUS_FIFO0_UDF_W<'_, INT_ENA_SPEC> {
