...
#[doc = "Field `SPI_MEM_SCLKCNT_L` reader - For SPI0 external RAM interface, it must be equal to SPI_MEM_SCLKCNT_N."]
pub type SPI_MEM_SCLKCNT_L_R = crate::FieldReader;
#[doc = "Field `SPI_MEM_SCLKCNT_L` writer - For SPI0 external RAM interface, it must be equal to SPI_MEM_SCLKCNT_N."]
pub type SPI_MEM_SCLKCNT_L_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `SPI_MEM_SCLKCNT_H` reader - For SPI0 external RAM interface, it must be floor((SPI_MEM_SCLKCNT_N+1)/2-1)."]
pub type SPI_MEM_SCLKCNT_H_R = crate::FieldReader;
#[doc = "Field `SPI_MEM_SCLKCNT_H` writer - For SPI0 external RAM interface, it must be floor((SPI_MEM_SCLKCNT_N+1)/2-1)."]
pub type SPI_MEM_SCLKCNT_H_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `SPI_MEM_SCLKCNT_N` reader - For SPI0 external RAM interface, it is the divider of spi_mem_clk. So spi_mem_clk frequency is system/(SPI_MEM_SCLKCNT_N+1)"]
pub type SPI_MEM_SCLKCNT_N_R = crate::FieldReader;
#[doc = "Field `SPI_MEM_SCLKCNT_N` writer - For SPI0 external RAM interface, it is the divider of spi_mem_clk. So spi_mem_clk frequency is system/(SPI_MEM_SCLKCNT_N+1)"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_SRAM_CLK")
            .field("spi_mem_sclkcnt_l", &self.spi_mem_sclkcnt_l())
            .field("spi_mem_sclkcnt_h", &self.spi_mem_sclkcnt_h())
            .field("spi_mem_sclkcnt_n", &self.spi_mem_sclkcnt_n())
            .field("spi_mem_sclk_equ_sysclk", &self.spi_mem_sclk_equ_sysclk())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:7 - For SPI0 external RAM interface, it must be equal to SPI_MEM_SCLKCNT_N."]
    #[inline(always)]
    pub fn spi_mem_sclkcnt_l(&mut self) -> SPI_MEM_SCLKCNT_L_W<'_, SPI_MEM_SRAM_CLK_SPEC> {
        SPI_MEM_SCLKCNT_L_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - For SPI0 external RAM interface, it must be floor((SPI_MEM_SCLKCNT_N+1)/2-1)."]
    #[inline(always)]
    pub fn spi_mem_sclkcnt_h(&mut self) -> SPI_MEM_SCLKCNT_H_W<'_, SPI_MEM_SRAM_CLK_SPEC> {
        SPI_MEM_SCLKCNT_H_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - For SPI0 external RAM interface, it is the divider of spi_mem_clk. So spi_mem_clk frequency is system/(SPI_MEM_SCLKCNT_N+1)"]
    #[inline(always)]
    pub fn spi_mem_sclkcnt_n(&mut self) -> SPI_MEM_SCLKCNT_N_W<'_, SPI_MEM_SRAM_CLK_SPEC> {
        SPI_MEM_SCLKCNT_N_W::new(self, 16)
    }
    #[doc = "Bit 31 - For SPI0 external RAM interface, 1: spi_mem_clk is eqaul to system 0: spi_mem_clk is divided from system clock."]
    #[inline(always)]
    pub fn spi_mem_sclk_equ_sysclk(
        &mut self,
    ) -> SPI_MEM_SCLK_EQU_SYSCLK_W<'_, SPI_MEM_SRAM_CLK_SPEC> {
        SPI_MEM_SCLK_EQU_SYSCLK_W::new(self, 31)
    }
}
#[doc = "SPI0 external RAM clock control register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_sram_clk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_sram_clk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
