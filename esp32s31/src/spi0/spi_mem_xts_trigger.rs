...
impl W {
    ...
    #[inline(always)]
    pub fn spi_xts_trigger(&mut self) -> SPI_XTS_TRIGGER_W<'_, SPI_MEM_XTS_TRIGGER_SPEC> {
        SPI_XTS_TRIGGER_W::new(self, 0)
    }
}
#[doc = "Manual Encryption physical address register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_xts_trigger::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
