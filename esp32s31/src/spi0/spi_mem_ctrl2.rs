...
#[doc = "Field `SPI_MEM_ECC_CS_HOLD_TIME` writer - SPI_MEM_CS_HOLD_TIME + SPI_MEM_ECC_CS_HOLD_TIME is the SPI0 CS hold cycle in ECC mode when accessed flash."]
pub type SPI_MEM_ECC_CS_HOLD_TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
#[doc = "Field `SPI_MEM_ECC_SKIP_PAGE_CORNER` writer - 1: SPI0 and SPI1 skip page corner when accesses flash. 0: Not skip page corner when accesses flash."]
pub type SPI_MEM_ECC_SKIP_PAGE_CORNER_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_ECC_16TO18_BYTE_EN` writer - Set this bit to enable SPI0 and SPI1 ECC 16 bytes data with 2 ECC bytes mode when accesses flash."]
pub type SPI_MEM_ECC_16TO18_BYTE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SPI_MEM_SPLIT_TRANS_EN` writer - Set this bit to enable SPI0 split one AXI read flash transfer into two SPI transfers when one transfer will cross flash or EXT_RAM page corner, valid no matter whether there is an ECC region or not."]
pub type SPI_MEM_SPLIT_TRANS_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_CTRL2")
            .field("spi_mem_cs_setup_time", &self.spi_mem_cs_setup_time())
            .field("spi_mem_cs_hold_time", &self.spi_mem_cs_hold_time())
            .field("spi_mem_ecc_cs_hold_time", &self.spi_mem_ecc_cs_hold_time())
            .field(
                "spi_mem_ecc_skip_page_corner",
                &self.spi_mem_ecc_skip_page_corner(),
            )
            .field(
                "spi_mem_ecc_16to18_byte_en",
                &self.spi_mem_ecc_16to18_byte_en(),
            )
            .field("spi_mem_split_trans_en", &self.spi_mem_split_trans_en())
            .field("spi_mem_cs_hold_delay", &self.spi_mem_cs_hold_delay())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:4 - (cycles-1) of prepare phase by SPI Bus clock, this bits are combined with SPI_MEM_CS_SETUP bit."]
    #[inline(always)]
    pub fn spi_mem_cs_setup_time(&mut self) -> SPI_MEM_CS_SETUP_TIME_W<'_, SPI_MEM_CTRL2_SPEC> {
        SPI_MEM_CS_SETUP_TIME_W::new(self, 0)
    }
    #[doc = "Bits 5:9 - SPI CS signal is delayed to inactive by SPI bus clock, this bits are combined with SPI_MEM_CS_HOLD bit."]
    #[inline(always)]
    pub fn spi_mem_cs_hold_time(&mut self) -> SPI_MEM_CS_HOLD_TIME_W<'_, SPI_MEM_CTRL2_SPEC> {
        SPI_MEM_CS_HOLD_TIME_W::new(self, 5)
    }
    #[doc = "Bits 10:12 - SPI_MEM_CS_HOLD_TIME + SPI_MEM_ECC_CS_HOLD_TIME is the SPI0 CS hold cycle in ECC mode when accessed flash."]
    #[inline(always)]
    pub fn spi_mem_ecc_cs_hold_time(
        &mut self,
    ) -> SPI_MEM_ECC_CS_HOLD_TIME_W<'_, SPI_MEM_CTRL2_SPEC> {
        SPI_MEM_ECC_CS_HOLD_TIME_W::new(self, 10)
    }
    #[doc = "Bit 13 - 1: SPI0 and SPI1 skip page corner when accesses flash. 0: Not skip page corner when accesses flash."]
    #[inline(always)]
    pub fn spi_mem_ecc_skip_page_corner(
        &mut self,
    ) -> SPI_MEM_ECC_SKIP_PAGE_CORNER_W<'_, SPI_MEM_CTRL2_SPEC> {
        SPI_MEM_ECC_SKIP_PAGE_CORNER_W::new(self, 13)
    }
    #[doc = "Bit 14 - Set this bit to enable SPI0 and SPI1 ECC 16 bytes data with 2 ECC bytes mode when accesses flash."]
    #[inline(always)]
    pub fn spi_mem_ecc_16to18_byte_en(
        &mut self,
    ) -> SPI_MEM_ECC_16TO18_BYTE_EN_W<'_, SPI_MEM_CTRL2_SPEC> {
        SPI_MEM_ECC_16TO18_BYTE_EN_W::new(self, 14)
    }
    #[doc = "Bit 24 - Set this bit to enable SPI0 split one AXI read flash transfer into two SPI transfers when one transfer will cross flash or EXT_RAM page corner, valid no matter whether there is an ECC region or not."]
    #[inline(always)]
    pub fn spi_mem_split_trans_en(&mut self) -> SPI_MEM_SPLIT_TRANS_EN_W<'_, SPI_MEM_CTRL2_SPEC> {
        SPI_MEM_SPLIT_TRANS_EN_W::new(self, 24)
    }
    #[doc = "Bits 25:30 - These bits are used to set the minimum CS high time tSHSL between SPI burst transfer when accesses to flash. tSHSL is (SPI_MEM_CS_HOLD_DELAY\\[5:0\\] + 1) MSPI core clock cycles."]
    #[inline(always)]
    pub fn spi_mem_cs_hold_delay(&mut self) -> SPI_MEM_CS_HOLD_DELAY_W<'_, SPI_MEM_CTRL2_SPEC> {
...
#[doc = "SPI0 control2 register.\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_ctrl2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_ctrl2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
