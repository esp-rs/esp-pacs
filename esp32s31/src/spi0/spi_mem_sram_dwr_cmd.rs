    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_MEM_SRAM_DWR_CMD")
            .field(
                ...
                &self.spi_mem_cache_sram_usr_wr_cmd_value(),
            )
            .field(
                "spi_mem_cache_sram_usr_wr_cmd_bitlen",
                &self.spi_mem_cache_sram_usr_wr_cmd_bitlen(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn spi_mem_cache_sram_usr_wr_cmd_value(
        &mut self,
    ) -> SPI_MEM_CACHE_SRAM_USR_WR_CMD_VALUE_W<'_, SPI_MEM_SRAM_DWR_CMD_SPEC> {
    ...
    pub fn spi_mem_cache_sram_usr_wr_cmd_bitlen(
        &mut self,
    ) -> SPI_MEM_CACHE_SRAM_USR_WR_CMD_BITLEN_W<'_, SPI_MEM_SRAM_DWR_CMD_SPEC> {
        SPI_MEM_CACHE_SRAM_USR_WR_CMD_BITLEN_W::new(self, 28)
    }
}
#[doc = "SPI0 external RAM DDR write command control register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_sram_dwr_cmd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_sram_dwr_cmd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
