...
#[doc = "Field `SMEM_DQS1_270_SEL` reader - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SMEM_DQS1_270_SEL_R = crate::FieldReader;
#[doc = "Field `SMEM_DQS1_270_SEL` writer - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SMEM_DQS1_270_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `SMEM_DQS1_90_SEL` reader - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SMEM_DQS1_90_SEL_R = crate::FieldReader;
#[doc = "Field `SMEM_DQS1_90_SEL` writer - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SMEM_DQS1_90_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ...
    #[inline(always)]
    pub fn smem_dqs1_270_sel(&self) -> SMEM_DQS1_270_SEL_R {
        SMEM_DQS1_270_SEL_R::new(((self.bits >> 11) & 3) as u8)
    }
    #[doc = "Bits 13:14 - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn smem_dqs1_90_sel(&self) -> SMEM_DQS1_90_SEL_R {
        SMEM_DQS1_90_SEL_R::new(((self.bits >> 13) & 3) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_SMEM_TIMING_CALI")
            ...
            .field("smem_dqs1_270_sel", &self.smem_dqs1_270_sel())
            .field("smem_dqs1_90_sel", &self.smem_dqs1_90_sel())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - For sram, the bit is used to enable timing adjust clock for all reading operations."]
    #[inline(always)]
    pub fn smem_timing_clk_ena(&mut self) -> SMEM_TIMING_CLK_ENA_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SMEM_TIMING_CLK_ENA_W::new(self, 0)
    }
    #[doc = "Bit 1 - For sram, the bit is used to enable timing auto-calibration for all reading operations."]
    #[inline(always)]
    pub fn smem_timing_cali(&mut self) -> SMEM_TIMING_CALI_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
    ...
    pub fn smem_extra_dummy_cyclelen(
        &mut self,
    ) -> SMEM_EXTRA_DUMMY_CYCLELEN_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SMEM_EXTRA_DUMMY_CYCLELEN_W::new(self, 2)
    }
    #[doc = "Bit 5 - Set this bit to enable DLL for timing calibration in DDR mode when accessed to EXT_RAM."]
    #[inline(always)]
    pub fn smem_dll_timing_cali(
        &mut self,
    ) -> SMEM_DLL_TIMING_CALI_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SMEM_DLL_TIMING_CALI_W::new(self, 5)
    }
    #[doc = "Bits 7:8 - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn smem_dqs0_270_sel(&mut self) -> SMEM_DQS0_270_SEL_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SMEM_DQS0_270_SEL_W::new(self, 7)
    }
    #[doc = "Bits 9:10 - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn smem_dqs0_90_sel(&mut self) -> SMEM_DQS0_90_SEL_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SMEM_DQS0_90_SEL_W::new(self, 9)
    }
    #[doc = "Bits 11:12 - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn smem_dqs1_270_sel(&mut self) -> SMEM_DQS1_270_SEL_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SMEM_DQS1_270_SEL_W::new(self, 11)
    }
    #[doc = "Bits 13:14 - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn smem_dqs1_90_sel(&mut self) -> SMEM_DQS1_90_SEL_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SMEM_DQS1_90_SEL_W::new(self, 13)
    }
}
