...
#[doc = "Field `SPI_SMEM_DQS0_270_SEL` reader - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SPI_SMEM_DQS0_270_SEL_R = crate::FieldReader;
#[doc = "Field `SPI_SMEM_DQS0_270_SEL` writer - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SPI_SMEM_DQS0_270_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `SPI_SMEM_DQS0_90_SEL` reader - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SPI_SMEM_DQS0_90_SEL_R = crate::FieldReader;
#[doc = "Field `SPI_SMEM_DQS0_90_SEL` writer - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SPI_SMEM_DQS0_90_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `SPI_SMEM_DQS1_270_SEL` reader - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SPI_SMEM_DQS1_270_SEL_R = crate::FieldReader;
#[doc = "Field `SPI_SMEM_DQS1_270_SEL` writer - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SPI_SMEM_DQS1_270_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `SPI_SMEM_DQS1_90_SEL` reader - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SPI_SMEM_DQS1_90_SEL_R = crate::FieldReader;
#[doc = "Field `SPI_SMEM_DQS1_90_SEL` writer - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
pub type SPI_SMEM_DQS1_90_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ...
    #[inline(always)]
    pub fn spi_smem_dqs0_270_sel(&self) -> SPI_SMEM_DQS0_270_SEL_R {
        SPI_SMEM_DQS0_270_SEL_R::new(((self.bits >> 7) & 3) as u8)
    }
    #[doc = "Bits 9:10 - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn spi_smem_dqs0_90_sel(&self) -> SPI_SMEM_DQS0_90_SEL_R {
        SPI_SMEM_DQS0_90_SEL_R::new(((self.bits >> 9) & 3) as u8)
    }
    #[doc = "Bits 11:12 - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn spi_smem_dqs1_270_sel(&self) -> SPI_SMEM_DQS1_270_SEL_R {
        SPI_SMEM_DQS1_270_SEL_R::new(((self.bits >> 11) & 3) as u8)
    }
    #[doc = "Bits 13:14 - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn spi_smem_dqs1_90_sel(&self) -> SPI_SMEM_DQS1_90_SEL_R {
        SPI_SMEM_DQS1_90_SEL_R::new(((self.bits >> 13) & 3) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_SMEM_TIMING_CALI")
            ...
            .field("spi_smem_dqs0_270_sel", &self.spi_smem_dqs0_270_sel())
            .field("spi_smem_dqs0_90_sel", &self.spi_smem_dqs0_90_sel())
            .field("spi_smem_dqs1_270_sel", &self.spi_smem_dqs1_270_sel())
            .field("spi_smem_dqs1_90_sel", &self.spi_smem_dqs1_90_sel())
            .finish()
    }
}
impl W {
    ...
    pub fn spi_smem_dll_timing_cali(
        &mut self,
    ) -> SPI_SMEM_DLL_TIMING_CALI_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SPI_SMEM_DLL_TIMING_CALI_W::new(self, 5)
    }
    #[doc = "Bits 7:8 - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn spi_smem_dqs0_270_sel(
        &mut self,
    ) -> SPI_SMEM_DQS0_270_SEL_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SPI_SMEM_DQS0_270_SEL_W::new(self, 7)
    }
    #[doc = "Bits 9:10 - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn spi_smem_dqs0_90_sel(
        &mut self,
    ) -> SPI_SMEM_DQS0_90_SEL_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SPI_SMEM_DQS0_90_SEL_W::new(self, 9)
    }
    #[doc = "Bits 11:12 - Set these bits to delay dqs signal & invert delayed signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn spi_smem_dqs1_270_sel(
        &mut self,
    ) -> SPI_SMEM_DQS1_270_SEL_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SPI_SMEM_DQS1_270_SEL_W::new(self, 11)
    }
    #[doc = "Bits 13:14 - Set these bits to delay dqs signal for DLL timing adjust. 2'd0: 0.5ns, 2'd1: 1.0ns, 2'd2: 1.5ns 2'd3: 2.0ns."]
    #[inline(always)]
    pub fn spi_smem_dqs1_90_sel(
        &mut self,
    ) -> SPI_SMEM_DQS1_90_SEL_W<'_, SPI_SMEM_TIMING_CALI_SPEC> {
        SPI_SMEM_DQS1_90_SEL_W::new(self, 13)
    }
}
...
#[doc = "`reset()` method sets SPI_SMEM_TIMING_CALI to value 0x2a81"]
