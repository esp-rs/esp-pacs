...
impl W {
    #[doc = "Bits 0:29 - This bits stores the last modified-time of manual encryption feature."]
    #[inline(always)]
    pub fn spi_xts_date(&mut self) -> SPI_XTS_DATE_W<'_, SPI_MEM_XTS_DATE_SPEC> {
        SPI_XTS_DATE_W::new(self, 0)
    }
}
#[doc = "Manual Encryption version register\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_mem_xts_date::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi_mem_xts_date::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets SPI_MEM_XTS_DATE to value 0x2021_0907"]
