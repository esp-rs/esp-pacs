...
#[doc = "Field `AREA_PIF_1_MIN` reader - Configures the lower bound address of Peripheral bus region 1."]
pub type AREA_PIF_1_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_PIF_1_MIN` writer - Configures the lower bound address of Peripheral bus region 1."]
...
impl W {
    #[doc = "Bits 0:31 - Configures the lower bound address of Peripheral bus region 1."]
    #[inline(always)]
    pub fn area_pif_1_min(&mut self) -> AREA_PIF_1_MIN_W<'_, AREA_PIF_1_MIN_SPEC> {
