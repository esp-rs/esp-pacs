...
#[doc = "Field `RCD_RECORDEN` reader - Configures whether to enable PC and SP logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG starts to record PC in real time, BUS_MONITOR_CORE_0_RCD_PDEBUGSP_REG starts to record SP in real time\\\\"]
pub type RCD_RECORDEN_R = crate::BitReader;
#[doc = "Field `RCD_RECORDEN` writer - Configures whether to enable PC and SP logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG starts to record PC in real time, BUS_MONITOR_CORE_0_RCD_PDEBUGSP_REG starts to record SP in real time\\\\"]
pub type RCD_RECORDEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RCD_PDEBUGEN` reader - Configures whether to enable HP CPU debugging.\\\\ 0: Disable\\\\ 1: HP CPU outputs PC\\\\"]
pub type RCD_PDEBUGEN_R = crate::BitReader;
#[doc = "Field `RCD_PDEBUGEN` writer - Configures whether to enable HP CPU debugging.\\\\ 0: Disable\\\\ 1: HP CPU outputs PC\\\\"]
pub type RCD_PDEBUGEN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether to enable PC and SP logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG starts to record PC in real time, BUS_MONITOR_CORE_0_RCD_PDEBUGSP_REG starts to record SP in real time\\\\"]
    #[inline(always)]
