...
#[doc = "Field `AREA_DRAM0_1_MAX` reader - Configures the upper bound address of Data bus region 1."]
pub type AREA_DRAM0_1_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `AREA_DRAM0_1_MAX` writer - Configures the upper bound address of Data bus region 1."]
pub type AREA_DRAM0_1_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the upper bound address of Data bus region 1."]
    #[inline(always)]
    pub fn area_dram0_1_max(&self) -> AREA_DRAM0_1_MAX_R {
        AREA_DRAM0_1_MAX_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AREA_DRAM0_1_MAX")
            .field("area_dram0_1_max", &self.area_dram0_1_max())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Configures the upper bound address of Data bus region 1."]
    #[inline(always)]
    pub fn area_dram0_1_max(&mut self) -> AREA_DRAM0_1_MAX_W<'_, AREA_DRAM0_1_MAX_SPEC> {
        AREA_DRAM0_1_MAX_W::new(self, 0)
    }
}
