...
#[doc = "Field `CORE_1_DEBUG_MODE` reader - Represents whether RISC-V CPU (HP CPU) is in debugging mode.\\\\ 1: In debugging mode\\\\ 0: Not in debugging mode\\\\"]
pub type CORE_1_DEBUG_MODE_R = crate::BitReader;
#[doc = "Field `CORE_1_DEBUG_MODULE_ACTIVE` reader - Represents the status of the RISC-V CPU (HP CPU) debug module.\\\\ 1: Active status\\\\ Other: Inactive status\\\\"]
