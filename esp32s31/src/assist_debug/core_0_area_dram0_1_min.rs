...
#[doc = "Field `CORE_0_AREA_DRAM0_1_MIN` reader - Configures the lower bound address of Data bus region 1."]
pub type CORE_0_AREA_DRAM0_1_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_0_AREA_DRAM0_1_MIN` writer - Configures the lower bound address of Data bus region 1."]
...
impl W {
    ...
    pub fn core_0_area_dram0_1_min(
        &mut self,
    ) -> CORE_0_AREA_DRAM0_1_MIN_W<'_, CORE_0_AREA_DRAM0_1_MIN_SPEC> {
