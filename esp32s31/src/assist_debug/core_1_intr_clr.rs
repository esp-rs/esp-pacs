...
#[doc = "Field `CORE_1_AREA_DRAM0_0_RD_CLR` writer - Write 1 to clear the interrupt for read operations in region 0 by Data bus."]
pub type CORE_1_AREA_DRAM0_0_RD_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_AREA_DRAM0_0_WR_CLR` writer - Write 1 to clear the interrupt for write operations in region 0 by Data bus."]
pub type CORE_1_AREA_DRAM0_0_WR_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_AREA_DRAM0_1_RD_CLR` writer - Write 1 to clear the interrupt for read operations in region 1 by Data bus."]
pub type CORE_1_AREA_DRAM0_1_RD_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_AREA_DRAM0_1_WR_CLR` writer - Write 1 to clear the interrupt for write operations in region 1 by Data bus."]
pub type CORE_1_AREA_DRAM0_1_WR_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_AREA_PIF_0_RD_CLR` writer - Write 1 to clear the interrupt for read operations in region 0 by Peripheral bus."]
pub type CORE_1_AREA_PIF_0_RD_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_AREA_PIF_0_WR_CLR` writer - Write 1 to clear the interrupt for write operations in region 0 by Peripheral bus."]
pub type CORE_1_AREA_PIF_0_WR_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_AREA_PIF_1_RD_CLR` writer - Write 1 to clear the interrupt for read operations in region 1 by Peripheral bus."]
pub type CORE_1_AREA_PIF_1_RD_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_AREA_PIF_1_WR_CLR` writer - Write 1 to clear the interrupt for write operations in region 1 by Peripheral bus."]
pub type CORE_1_AREA_PIF_1_WR_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_SP_SPILL_MIN_CLR` writer - Write 1 to clear the interrupt for SP exceeding the lower bound address of SP monitored region."]
pub type CORE_1_SP_SPILL_MIN_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_SP_SPILL_MAX_CLR` writer - Write 1 to clear the interrupt for SP exceeding the upper bound address of SP monitored region."]
...
impl W {
    ...
    pub fn core_1_area_dram0_0_rd_clr(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_0_RD_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_area_dram0_0_wr_clr(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_0_WR_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_area_dram0_1_rd_clr(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_1_RD_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_area_dram0_1_wr_clr(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_1_WR_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_area_pif_0_rd_clr(
        &mut self,
    ) -> CORE_1_AREA_PIF_0_RD_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_area_pif_0_wr_clr(
        &mut self,
    ) -> CORE_1_AREA_PIF_0_WR_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_area_pif_1_rd_clr(
        &mut self,
    ) -> CORE_1_AREA_PIF_1_RD_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_area_pif_1_wr_clr(
        &mut self,
    ) -> CORE_1_AREA_PIF_1_WR_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_sp_spill_min_clr(
        &mut self,
    ) -> CORE_1_SP_SPILL_MIN_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_sp_spill_max_clr(
        &mut self,
    ) -> CORE_1_SP_SPILL_MAX_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_iram0_exception_monitor_clr(
        &mut self,
    ) -> CORE_1_IRAM0_EXCEPTION_MONITOR_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
    ...
    pub fn core_1_dram0_exception_monitor_clr(
        &mut self,
    ) -> CORE_1_DRAM0_EXCEPTION_MONITOR_CLR_W<'_, CORE_1_INTR_CLR_SPEC> {
