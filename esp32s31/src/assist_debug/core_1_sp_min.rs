...
#[doc = "Field `CORE_1_SP_MIN` reader - Configures the lower bound address of SP."]
pub type CORE_1_SP_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_SP_MIN` writer - Configures the lower bound address of SP."]
...
impl W {
    #[doc = "Bits 0:31 - Configures the lower bound address of SP."]
    #[inline(always)]
    pub fn core_1_sp_min(&mut self) -> CORE_1_SP_MIN_W<'_, CORE_1_SP_MIN_SPEC> {
