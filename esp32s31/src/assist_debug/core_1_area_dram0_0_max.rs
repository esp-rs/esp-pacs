...
#[doc = "Field `CORE_1_AREA_DRAM0_0_MAX` reader - Configures the upper bound address of Data bus region 0."]
pub type CORE_1_AREA_DRAM0_0_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_DRAM0_0_MAX` writer - Configures the upper bound address of Data bus region 0."]
