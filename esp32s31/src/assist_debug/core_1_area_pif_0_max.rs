...
#[doc = "Field `CORE_1_AREA_PIF_0_MAX` reader - Configures the upper bound address of Peripheral bus region 0."]
pub type CORE_1_AREA_PIF_0_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_PIF_0_MAX` writer - Configures the upper bound address of Peripheral bus region 0."]
pub type CORE_1_AREA_PIF_0_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the upper bound address of Peripheral bus region 0."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Configures the upper bound address of Peripheral bus region 0."]
    #[inline(always)]
    pub fn core_1_area_pif_0_max(
        &mut self,
    ) -> CORE_1_AREA_PIF_0_MAX_W<'_, CORE_1_AREA_PIF_0_MAX_SPEC> {
