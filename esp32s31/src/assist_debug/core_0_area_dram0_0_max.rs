...
#[doc = "Field `CORE_0_AREA_DRAM0_0_MAX` reader - Configures the upper bound address of Data bus region 0."]
pub type CORE_0_AREA_DRAM0_0_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_0_AREA_DRAM0_0_MAX` writer - Configures the upper bound address of Data bus region 0."]
pub type CORE_0_AREA_DRAM0_0_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the upper bound address of Data bus region 0."]
    #[inline(always)]
