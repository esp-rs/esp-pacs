...
#[doc = "Field `RX_TOUT_EN` reader - Configures whether or not to enable LP UART receiver's timeout function.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type RX_TOUT_EN_R = crate::BitReader;
#[doc = "Field `RX_TOUT_EN` writer - Configures whether or not to enable LP UART receiver's timeout function.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
pub type RX_TOUT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RX_TOUT_FLOW_DIS` reader - Configures whether or not to stop the idle status counter when hardware flow control is enabled.\\\\ 0: Invalid. No effect\\\\ 1: Stop\\\\"]
pub type RX_TOUT_FLOW_DIS_R = crate::BitReader;
#[doc = "Field `RX_TOUT_FLOW_DIS` writer - Configures whether or not to stop the idle status counter when hardware flow control is enabled.\\\\ 0: Invalid. No effect\\\\ 1: Stop\\\\"]
...
impl R {
    #[doc = "Bit 0 - Configures whether or not to enable LP UART receiver's timeout function.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn rx_tout_en(&self) -> RX_TOUT_EN_R {
        RX_TOUT_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures whether or not to stop the idle status counter when hardware flow control is enabled.\\\\ 0: Invalid. No effect\\\\ 1: Stop\\\\"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Configures whether or not to enable LP UART receiver's timeout function.\\\\ 0: Disable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn rx_tout_en(&mut self) -> RX_TOUT_EN_W<'_, TOUT_CONF_SYNC_SPEC> {
        RX_TOUT_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Configures whether or not to stop the idle status counter when hardware flow control is enabled.\\\\ 0: Invalid. No effect\\\\ 1: Stop\\\\"]
    #[inline(always)]
    pub fn rx_tout_flow_dis(&mut self) -> RX_TOUT_FLOW_DIS_W<'_, TOUT_CONF_SYNC_SPEC> {
        RX_TOUT_FLOW_DIS_W::new(self, 1)
    }
    #[doc = "Bits 2:11 - Configures the amount of time that the bus can remain idle before timeout.\\\\ Measurement unit: bit time (the time to transmit 1 bit)."]
    #[inline(always)]
    pub fn rx_tout_thrhd(&mut self) -> RX_TOUT_THRHD_W<'_, TOUT_CONF_SYNC_SPEC> {
