...
#[doc = "Field `RXFIFO_FULL` writer - Write 1 to clear LP_UART_RXFIFO_FULL_INT."]
pub type RXFIFO_FULL_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `TXFIFO_EMPTY` writer - Write 1 to clear LP_UART_TXFIFO_EMPTY_INT."]
pub type TXFIFO_EMPTY_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `PARITY_ERR` writer - Write 1 to clear LP_UART_PARITY_ERR_INT."]
pub type PARITY_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `FRM_ERR` writer - Write 1 to clear LP_UART_FRM_ERR_INT."]
pub type FRM_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `RXFIFO_OVF` writer - Write 1 to clear LP_UART_RXFIFO_OVF_INT."]
pub type RXFIFO_OVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `DSR_CHG` writer - Write 1 to clear LP_UART_DSR_CHG_INT."]
pub type DSR_CHG_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `CTS_CHG` writer - Write 1 to clear LP_UART_CTS_CHG_INT."]
pub type CTS_CHG_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `BRK_DET` writer - Write 1 to clear LP_UART_BRK_DET_INT."]
pub type BRK_DET_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `RXFIFO_TOUT` writer - Write 1 to clear LP_UART_RXFIFO_TOUT_INT."]
pub type RXFIFO_TOUT_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SW_XON` writer - Write 1 to clear LP_UART_SW_XON_INT."]
pub type SW_XON_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `SW_XOFF` writer - Write 1 to clear LP_UART_SW_XOFF_INT."]
pub type SW_XOFF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `GLITCH_DET` writer - Write 1 to clear LP_UART_GLITCH_DET_INT."]
pub type GLITCH_DET_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `TX_BRK_DONE` writer - Write 1 to clear LP_UART_TX_BRK_DONE_INT."]
pub type TX_BRK_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `TX_BRK_IDLE_DONE` writer - Write 1 to clear LP_UART_TX_BRK_IDLE_DONE_INT."]
pub type TX_BRK_IDLE_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `TX_DONE` writer - Write 1 to clear LP_UART_TX_DONE_INT."]
pub type TX_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `AT_CMD_CHAR_DET` writer - Write 1 to clear LP_UART_AT_CMD_CHAR_DET_INT."]
pub type AT_CMD_CHAR_DET_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `WAKEUP` writer - Write 1 to clear LP_UART_WAKEUP_INT."]
...
impl W {
    ...
    #[inline(always)]
    pub fn tx_brk_done(&mut self) -> TX_BRK_DONE_W<'_, INT_CLR_SPEC> {
        TX_BRK_DONE_W::new(self, 12)
    }
    #[doc = "Bit 13 - Write 1 to clear LP_UART_TX_BRK_IDLE_DONE_INT."]
    #[inline(always)]
    pub fn tx_brk_idle_done(&mut self) -> TX_BRK_IDLE_DONE_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn at_cmd_char_det(&mut self) -> AT_CMD_CHAR_DET_W<'_, INT_CLR_SPEC> {
        AT_CMD_CHAR_DET_W::new(self, 18)
    }
    #[doc = "Bit 19 - Write 1 to clear LP_UART_WAKEUP_INT."]
    #[inline(always)]
    pub fn wakeup(&mut self) -> WAKEUP_W<'_, INT_CLR_SPEC> {
