...
#[doc = "Field `XON_XOFF_STILL_SEND` reader - Configures whether the LP UART transmitter can send XON or XOFF characters when it is disabled.\\\\ 0: Cannot send\\\\ 1: Can send\\\\"]
pub type XON_XOFF_STILL_SEND_R = crate::BitReader;
#[doc = "Field `XON_XOFF_STILL_SEND` writer - Configures whether the LP UART transmitter can send XON or XOFF characters when it is disabled.\\\\ 0: Cannot send\\\\ 1: Can send\\\\"]
...
impl R {
    ...
    #[doc = "Bit 16 - Configures whether the LP UART transmitter can send XON or XOFF characters when it is disabled.\\\\ 0: Cannot send\\\\ 1: Can send\\\\"]
    #[inline(always)]
