...
#[doc = "Field `TX_BRK_NUM` reader - Configures the number of NULL characters to be sent after finishing data transmission.\\\\Valid only when LP_UART_TXD_BRK is 1."]
pub type TX_BRK_NUM_R = crate::FieldReader;
#[doc = "Field `TX_BRK_NUM` writer - Configures the number of NULL characters to be sent after finishing data transmission.\\\\Valid only when LP_UART_TXD_BRK is 1."]
pub type TX_BRK_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures the number of NULL characters to be sent after finishing data transmission.\\\\Valid only when LP_UART_TXD_BRK is 1."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:7 - Configures the number of NULL characters to be sent after finishing data transmission.\\\\Valid only when LP_UART_TXD_BRK is 1."]
    #[inline(always)]
    pub fn tx_brk_num(&mut self) -> TX_BRK_NUM_W<'_, TXBRK_CONF_SYNC_SPEC> {
