...
#[doc = "Field `RX_GAP_TOUT` reader - Configures the interval between two AT_CMD characters.\\\\Measurement unit: bit time (the time to transmit 1 bit)."]
pub type RX_GAP_TOUT_R = crate::FieldReader<u16>;
#[doc = "Field `RX_GAP_TOUT` writer - Configures the interval between two AT_CMD characters.\\\\Measurement unit: bit time (the time to transmit 1 bit)."]
...
impl W {
    #[doc = "Bits 0:15 - Configures the interval between two AT_CMD characters.\\\\Measurement unit: bit time (the time to transmit 1 bit)."]
    #[inline(always)]
    pub fn rx_gap_tout(&mut self) -> RX_GAP_TOUT_W<'_, AT_CMD_GAPTOUT_SYNC_SPEC> {
        RX_GAP_TOUT_W::new(self, 0)
    }
}
#[doc = "Timeout configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`at_cmd_gaptout_sync::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`at_cmd_gaptout_sync::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
