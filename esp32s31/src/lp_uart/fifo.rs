...
#[doc = "Field `RXFIFO_RD_BYTE` reader - Represents the data LP UART 0 read from FIFO.\\\\ Measurement unit: byte."]
pub type RXFIFO_RD_BYTE_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7 - Represents the data LP UART 0 read from FIFO.\\\\ Measurement unit: byte."]
    #[inline(always)]
