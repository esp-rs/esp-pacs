...
impl W {
    ...
    pub fn log_mon_addr_dma_0_update(
        &mut self,
    ) -> LOG_MON_ADDR_DMA_0_UPDATE_W<'_, LOG_MON_ADDR_UPDATE_1_SPEC> {
    ...
    pub fn log_mon_addr_dma_1_update(
        &mut self,
    ) -> LOG_MON_ADDR_DMA_1_UPDATE_W<'_, LOG_MON_ADDR_UPDATE_1_SPEC> {
    ...
    pub fn log_mon_addr_dma_2_update(
        &mut self,
    ) -> LOG_MON_ADDR_DMA_2_UPDATE_W<'_, LOG_MON_ADDR_UPDATE_1_SPEC> {
    ...
    pub fn log_mon_addr_dma_3_update(
        &mut self,
    ) -> LOG_MON_ADDR_DMA_3_UPDATE_W<'_, LOG_MON_ADDR_UPDATE_1_SPEC> {
