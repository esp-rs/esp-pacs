...
#[doc = "Field `M0_APM_INT_EN` reader - Configures APM M0 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M0_APM_INT_EN_R = crate::BitReader;
#[doc = "Field `M0_APM_INT_EN` writer - Configures APM M0 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M0_APM_INT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `M1_APM_INT_EN` reader - Configures APM M1 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M1_APM_INT_EN_R = crate::BitReader;
#[doc = "Field `M1_APM_INT_EN` writer - Configures APM M1 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M1_APM_INT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `M2_APM_INT_EN` reader - Configures APM M2 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M2_APM_INT_EN_R = crate::BitReader;
#[doc = "Field `M2_APM_INT_EN` writer - Configures APM M2 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M2_APM_INT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `M3_APM_INT_EN` reader - Configures APM M3 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M3_APM_INT_EN_R = crate::BitReader;
#[doc = "Field `M3_APM_INT_EN` writer - Configures APM M3 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M3_APM_INT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures APM M0 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
    #[inline(always)]
    pub fn m0_apm_int_en(&self) -> M0_APM_INT_EN_R {
        M0_APM_INT_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures APM M1 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
    #[inline(always)]
    pub fn m1_apm_int_en(&self) -> M1_APM_INT_EN_R {
        M1_APM_INT_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Configures APM M2 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
    #[inline(always)]
    pub fn m2_apm_int_en(&self) -> M2_APM_INT_EN_R {
        M2_APM_INT_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Configures APM M3 interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
    #[inline(always)]
