...
#[doc = "Field `M_APM(0-3)` reader - Configures APM M%s interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M_APM_R = crate::BitReader;
#[doc = "Field `M_APM(0-3)` writer - Configures APM M%s interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type M_APM_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Configures APM M(0-3) interrupt enable.\\\\ 0: disable \\\\ 1: enable \\\\"]
    #[doc = ""]
