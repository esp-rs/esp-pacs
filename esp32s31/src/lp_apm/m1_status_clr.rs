...
#[doc = "Field `M1_EXCEPTION_STATUS_CLR` writer - Configures to clear exception status"]
pub type M1_EXCEPTION_STATUS_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn m1_exception_status_clr(&mut self) -> M1_EXCEPTION_STATUS_CLR_W<'_, M1_STATUS_CLR_SPEC> {
        M1_EXCEPTION_STATUS_CLR_W::new(self, 0)
    }
}
#[doc = "M1 status clear register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m1_status_clr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
