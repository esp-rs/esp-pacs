...
#[doc = "Field `REGION_FILTER_EN` reader - Configure bit 0(0-7) to enable region 0.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type REGION_FILTER_EN_R = crate::FieldReader;
#[doc = "Field `REGION_FILTER_EN` writer - Configure bit 0(0-7) to enable region 0.\\\\ 0: disable \\\\ 1: enable \\\\"]
pub type REGION_FILTER_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configure bit 0(0-7) to enable region 0.\\\\ 0: disable \\\\ 1: enable \\\\"]
    #[inline(always)]
