...
#[doc = "Field `M1_EXCEPTION_STATUS` reader - Represents exception status.\\\\ bit0: 1 represents authority_exception \\\\ bit1: 1 represents space_exception \\\\"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("M1_STATUS")
            .field("m1_exception_status", &self.m1_exception_status())
            .finish()
    }
}
#[doc = "M1 status register\n\nYou can [`read`](crate::Reg::read) this register and get [`m1_status::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
