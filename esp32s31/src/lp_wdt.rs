...
impl RegisterBlock {
    ...
    #[doc = "0x34 - need_des"]
    #[inline(always)]
    pub const fn pause_en(&self) -> &PAUSE_EN {
        &self.pause_en
    }
    #[doc = "0x3fc - need_des"]
    #[inline(always)]
...
#[doc = "need_des"]
pub mod int_clr;
#[doc = "PAUSE_EN (rw) register accessor: need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`pause_en::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pause_en::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pause_en`] module"]
pub type PAUSE_EN = crate::Reg<pause_en::PAUSE_EN_SPEC>;
#[doc = "need_des"]
pub mod pause_en;
