...
#[doc = "Field `OUT_LINK_SWITCH_CH_INT_RAW` reader - The raw interrupt bit turns to high level when the dma switch to new link for Tx channel0."]
pub type OUT_LINK_SWITCH_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `OUT_LINK_SWITCH_CH_INT_RAW` writer - The raw interrupt bit turns to high level when the dma switch to new link for Tx channel0."]
pub type OUT_LINK_SWITCH_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn out_link_switch_ch_int_raw(&self) -> OUT_LINK_SWITCH_CH_INT_RAW_R {
        OUT_LINK_SWITCH_CH_INT_RAW_R::new(((self.bits >> 10) & 1) != 0)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_INT_RAW_CH")
            ...
            .field(
                ...
                &self.outfifo_l1_ovf_ch_int_raw(),
            )
            .field(
                "outfifo_l1_udf_ch_int_raw",
                &self.outfifo_l1_udf_ch_int_raw(),
            )
            .field(
                "outfifo_l2_ovf_ch_int_raw",
                &self.outfifo_l2_ovf_ch_int_raw(),
            )
            .field(
                "outfifo_l2_udf_ch_int_raw",
                &self.outfifo_l2_udf_ch_int_raw(),
            )
            .field(
                "outfifo_l3_ovf_ch_int_raw",
                &self.outfifo_l3_ovf_ch_int_raw(),
            )
            .field(
                "outfifo_l3_udf_ch_int_raw",
                &self.outfifo_l3_udf_ch_int_raw(),
            )
            .field(
                "out_link_switch_ch_int_raw",
                &self.out_link_switch_ch_int_raw(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn outfifo_l1_ovf_ch_int_raw(
        &mut self,
    ) -> OUTFIFO_L1_OVF_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
    ...
    pub fn outfifo_l1_udf_ch_int_raw(
        &mut self,
    ) -> OUTFIFO_L1_UDF_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
    ...
    pub fn outfifo_l2_ovf_ch_int_raw(
        &mut self,
    ) -> OUTFIFO_L2_OVF_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
    ...
    pub fn outfifo_l2_udf_ch_int_raw(
        &mut self,
    ) -> OUTFIFO_L2_UDF_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
    ...
    pub fn outfifo_l3_ovf_ch_int_raw(
        &mut self,
    ) -> OUTFIFO_L3_OVF_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
    ...
    pub fn outfifo_l3_udf_ch_int_raw(
        &mut self,
    ) -> OUTFIFO_L3_UDF_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
        OUTFIFO_L3_UDF_CH_INT_RAW_W::new(self, 9)
    }
    #[doc = "Bit 10 - The raw interrupt bit turns to high level when the dma switch to new link for Tx channel0."]
    #[inline(always)]
    pub fn out_link_switch_ch_int_raw(
        &mut self,
    ) -> OUT_LINK_SWITCH_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
        OUT_LINK_SWITCH_CH_INT_RAW_W::new(self, 10)
    }
}
