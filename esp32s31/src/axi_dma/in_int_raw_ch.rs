...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_INT_RAW_CH")
            ...
            .field("infifo_l1_ovf_ch_int_raw", &self.infifo_l1_ovf_ch_int_raw())
            .field("infifo_l1_udf_ch_int_raw", &self.infifo_l1_udf_ch_int_raw())
            .field("infifo_l2_ovf_ch_int_raw", &self.infifo_l2_ovf_ch_int_raw())
            .field("infifo_l2_udf_ch_int_raw", &self.infifo_l2_udf_ch_int_raw())
            .field("infifo_l3_ovf_ch_int_raw", &self.infifo_l3_ovf_ch_int_raw())
            .field("infifo_l3_udf_ch_int_raw", &self.infifo_l3_udf_ch_int_raw())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 5 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
    #[inline(always)]
    pub fn infifo_l1_ovf_ch_int_raw(
        &mut self,
    ) -> INFIFO_L1_OVF_CH_INT_RAW_W<'_, IN_INT_RAW_CH_SPEC> {
        INFIFO_L1_OVF_CH_INT_RAW_W::new(self, 5)
    }
    #[doc = "Bit 6 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    pub fn infifo_l1_udf_ch_int_raw(
        &mut self,
    ) -> INFIFO_L1_UDF_CH_INT_RAW_W<'_, IN_INT_RAW_CH_SPEC> {
        INFIFO_L1_UDF_CH_INT_RAW_W::new(self, 6)
    }
    #[doc = "Bit 7 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
    #[inline(always)]
    pub fn infifo_l2_ovf_ch_int_raw(
        &mut self,
    ) -> INFIFO_L2_OVF_CH_INT_RAW_W<'_, IN_INT_RAW_CH_SPEC> {
        INFIFO_L2_OVF_CH_INT_RAW_W::new(self, 7)
    }
    #[doc = "Bit 8 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    pub fn infifo_l2_udf_ch_int_raw(
        &mut self,
    ) -> INFIFO_L2_UDF_CH_INT_RAW_W<'_, IN_INT_RAW_CH_SPEC> {
        INFIFO_L2_UDF_CH_INT_RAW_W::new(self, 8)
    }
    #[doc = "Bit 9 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is overflow."]
    #[inline(always)]
    pub fn infifo_l3_ovf_ch_int_raw(
        &mut self,
    ) -> INFIFO_L3_OVF_CH_INT_RAW_W<'_, IN_INT_RAW_CH_SPEC> {
        INFIFO_L3_OVF_CH_INT_RAW_W::new(self, 9)
    }
    #[doc = "Bit 10 - This raw interrupt bit turns to high level when level 1 fifo of Rx channel 0 is underflow."]
    #[inline(always)]
    pub fn infifo_l3_udf_ch_int_raw(
        &mut self,
    ) -> INFIFO_L3_UDF_CH_INT_RAW_W<'_, IN_INT_RAW_CH_SPEC> {
