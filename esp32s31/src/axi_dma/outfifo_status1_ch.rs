...
#[doc = "Field `L1OUTFIFO_CNT_CH` reader - The register stores the byte number of the data in L1 Tx FIFO for Tx channel 0."]
pub type L1OUTFIFO_CNT_CH_R = crate::FieldReader;
#[doc = "Field `L2OUTFIFO_CNT_CH` reader - The register stores the byte number of the data in L2 Tx FIFO for Tx channel 0."]
pub type L2OUTFIFO_CNT_CH_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:5 - The register stores the byte number of the data in L1 Tx FIFO for Tx channel 0."]
    #[inline(always)]
    pub fn l1outfifo_cnt_ch(&self) -> L1OUTFIFO_CNT_CH_R {
        L1OUTFIFO_CNT_CH_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 6:9 - The register stores the byte number of the data in L2 Tx FIFO for Tx channel 0."]
    #[inline(always)]
    pub fn l2outfifo_cnt_ch(&self) -> L2OUTFIFO_CNT_CH_R {
        L2OUTFIFO_CNT_CH_R::new(((self.bits >> 6) & 0x0f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUTFIFO_STATUS1_CH")
            .field("l1outfifo_cnt_ch", &self.l1outfifo_cnt_ch())
            .field("l2outfifo_cnt_ch", &self.l2outfifo_cnt_ch())
            .finish()
    }
}
