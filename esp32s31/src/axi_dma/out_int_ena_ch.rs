...
#[doc = "Field `OUT_LINK_SWITCH_CH_INT_ENA` reader - The interrupt enable bit for the OUT_LINK_SWITCH_CH_INT interrupt."]
pub type OUT_LINK_SWITCH_CH_INT_ENA_R = crate::BitReader;
#[doc = "Field `OUT_LINK_SWITCH_CH_INT_ENA` writer - The interrupt enable bit for the OUT_LINK_SWITCH_CH_INT interrupt."]
pub type OUT_LINK_SWITCH_CH_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 10 - The interrupt enable bit for the OUT_LINK_SWITCH_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_link_switch_ch_int_ena(&self) -> OUT_LINK_SWITCH_CH_INT_ENA_R {
        OUT_LINK_SWITCH_CH_INT_ENA_R::new(((self.bits >> 10) & 1) != 0)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_INT_ENA_CH")
            ...
            .field(
                ...
                &self.outfifo_l1_ovf_ch_int_ena(),
            )
            .field(
                "outfifo_l1_udf_ch_int_ena",
                &self.outfifo_l1_udf_ch_int_ena(),
            )
            .field(
                "outfifo_l2_ovf_ch_int_ena",
                &self.outfifo_l2_ovf_ch_int_ena(),
            )
            .field(
                "outfifo_l2_udf_ch_int_ena",
                &self.outfifo_l2_udf_ch_int_ena(),
            )
            .field(
                "outfifo_l3_ovf_ch_int_ena",
                &self.outfifo_l3_ovf_ch_int_ena(),
            )
            .field(
                "outfifo_l3_udf_ch_int_ena",
                &self.outfifo_l3_udf_ch_int_ena(),
            )
            .field(
                "out_link_switch_ch_int_ena",
                &self.out_link_switch_ch_int_ena(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn outfifo_l1_ovf_ch_int_ena(
        &mut self,
    ) -> OUTFIFO_L1_OVF_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
    ...
    pub fn outfifo_l1_udf_ch_int_ena(
        &mut self,
    ) -> OUTFIFO_L1_UDF_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
    ...
    pub fn outfifo_l2_ovf_ch_int_ena(
        &mut self,
    ) -> OUTFIFO_L2_OVF_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
    ...
    pub fn outfifo_l2_udf_ch_int_ena(
        &mut self,
    ) -> OUTFIFO_L2_UDF_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
    ...
    pub fn outfifo_l3_ovf_ch_int_ena(
        &mut self,
    ) -> OUTFIFO_L3_OVF_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
    ...
    pub fn outfifo_l3_udf_ch_int_ena(
        &mut self,
    ) -> OUTFIFO_L3_UDF_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
        OUTFIFO_L3_UDF_CH_INT_ENA_W::new(self, 9)
    }
    #[doc = "Bit 10 - The interrupt enable bit for the OUT_LINK_SWITCH_CH_INT interrupt."]
    #[inline(always)]
    pub fn out_link_switch_ch_int_ena(
        &mut self,
    ) -> OUT_LINK_SWITCH_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
        OUT_LINK_SWITCH_CH_INT_ENA_W::new(self, 10)
    }
}
