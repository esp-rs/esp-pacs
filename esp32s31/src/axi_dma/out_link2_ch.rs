...
impl W {
    #[doc = "Bits 0:31 - This register stores the 32 least significant bits of the first outlink descriptor's address."]
    #[inline(always)]
    pub fn outlink_addr_ch(&mut self) -> OUTLINK_ADDR_CH_W<'_, OUT_LINK2_CH_SPEC> {
        OUTLINK_ADDR_CH_W::new(self, 0)
    }
}
#[doc = "Link descriptor configure and control register of Tx channel%s\n\nYou can [`read`](crate::Reg::read) this register and get [`out_link2_ch::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`out_link2_ch::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
