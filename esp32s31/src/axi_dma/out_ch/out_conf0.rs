...
impl W {
    ...
    #[doc = "Bits 5:7 - 3'b000-3'b100:burst length 8byte~128byte"]
    #[inline(always)]
    pub fn out_burst_size_sel(&mut self) -> OUT_BURST_SIZE_SEL_W<'_, OUT_CONF0_SPEC> {
        OUT_BURST_SIZE_SEL_W::new(self, 5)
    }
    #[doc = "Bit 8 - 1:mean disable cmd of this ch0"]
    #[inline(always)]
    pub fn out_cmd_disable(&mut self) -> OUT_CMD_DISABLE_W<'_, OUT_CONF0_SPEC> {
        OUT_CMD_DISABLE_W::new(self, 8)
    }
    #[doc = "Bit 9 - 1: mean access ecc or aes domain,0: mean not"]
    #[inline(always)]
    pub fn out_ecc_aec_en(&mut self) -> OUT_ECC_AEC_EN_W<'_, OUT_CONF0_SPEC> {
