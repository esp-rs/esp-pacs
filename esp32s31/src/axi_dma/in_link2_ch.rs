...
impl W {
    #[doc = "Bits 0:31 - This register stores the 20 least significant bits of the first inlink descriptor's address."]
    #[inline(always)]
    pub fn inlink_addr_ch(&mut self) -> INLINK_ADDR_CH_W<'_, IN_LINK2_CH_SPEC> {
        INLINK_ADDR_CH_W::new(self, 0)
    }
}
#[doc = "Link descriptor configure and control register of Rx channel %s\n\nYou can [`read`](crate::Reg::read) this register and get [`in_link2_ch::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`in_link2_ch::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
