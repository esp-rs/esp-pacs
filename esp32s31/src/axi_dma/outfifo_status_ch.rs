...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUTFIFO_STATUS_CH")
            .field("outfifo_l3_full_ch", &self.outfifo_l3_full_ch())
            .field("outfifo_l3_empty_ch", &self.outfifo_l3_empty_ch())
            .field("outfifo_l3_cnt_ch", &self.outfifo_l3_cnt_ch())
            .field("outfifo_l3_udf_ch", &self.outfifo_l3_udf_ch())
            .field("outfifo_l3_ovf_ch", &self.outfifo_l3_ovf_ch())
            .field("outfifo_l1_full_ch", &self.outfifo_l1_full_ch())
            .field("outfifo_l1_empty_ch", &self.outfifo_l1_empty_ch())
            .field("outfifo_l1_udf_ch", &self.outfifo_l1_udf_ch())
            .field("outfifo_l1_ovf_ch", &self.outfifo_l1_ovf_ch())
            .field("outfifo_l2_full_ch", &self.outfifo_l2_full_ch())
            .field("outfifo_l2_empty_ch", &self.outfifo_l2_empty_ch())
            .field("outfifo_l2_udf_ch", &self.outfifo_l2_udf_ch())
            .field("outfifo_l2_ovf_ch", &self.outfifo_l2_ovf_ch())
...
#[doc = "`reset()` method sets OUTFIFO_STATUS_CH%s to value 0x7f80_8802"]
