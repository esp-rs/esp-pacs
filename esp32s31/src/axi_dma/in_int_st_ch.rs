...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_INT_ST_CH")
            ...
            .field("infifo_l1_ovf_ch_int_st", &self.infifo_l1_ovf_ch_int_st())
            .field("infifo_l1_udf_ch_int_st", &self.infifo_l1_udf_ch_int_st())
            .field("infifo_l3_ovf_ch_int_st", &self.infifo_l3_ovf_ch_int_st())
            .field("infifo_l3_udf_ch_int_st", &self.infifo_l3_udf_ch_int_st())
            .finish()
    }
}
