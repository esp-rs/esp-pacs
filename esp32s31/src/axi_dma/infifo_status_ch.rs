...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INFIFO_STATUS_CH")
            .field("infifo_l3_full_ch", &self.infifo_l3_full_ch())
            .field("infifo_l3_empty_ch", &self.infifo_l3_empty_ch())
            .field("infifo_l3_cnt_ch", &self.infifo_l3_cnt_ch())
            .field("infifo_l3_udf_ch", &self.infifo_l3_udf_ch())
            .field("infifo_l3_ovf_ch", &self.infifo_l3_ovf_ch())
            .field("infifo_l1_full_ch", &self.infifo_l1_full_ch())
            .field("infifo_l1_empty_ch", &self.infifo_l1_empty_ch())
            .field("infifo_l1_udf_ch", &self.infifo_l1_udf_ch())
            .field("infifo_l1_ovf_ch", &self.infifo_l1_ovf_ch())
            .field("infifo_l2_full_ch", &self.infifo_l2_full_ch())
            .field("infifo_l2_empty_ch", &self.infifo_l2_empty_ch())
            .field("infifo_l2_udf_ch", &self.infifo_l2_udf_ch())
            .field("infifo_l2_ovf_ch", &self.infifo_l2_ovf_ch())
