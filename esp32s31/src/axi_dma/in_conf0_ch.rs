...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_CONF0_CH")
            ...
            .field("in_burst_size_sel_ch", &self.in_burst_size_sel_ch())
            .field("in_cmd_disable_ch", &self.in_cmd_disable_ch())
            .field("in_ecc_aec_en_ch", &self.in_ecc_aec_en_ch())
...
impl W {
    ...
    #[doc = "Bits 4:6 - 3'b000-3'b100:burst length 8byte~128byte"]
    #[inline(always)]
    pub fn in_burst_size_sel_ch(&mut self) -> IN_BURST_SIZE_SEL_CH_W<'_, IN_CONF0_CH_SPEC> {
    ...
    #[doc = "Bit 8 - 1: mean access ecc or aes domain,0: mean not"]
    #[inline(always)]
    pub fn in_ecc_aec_en_ch(&mut self) -> IN_ECC_AEC_EN_CH_W<'_, IN_CONF0_CH_SPEC> {
