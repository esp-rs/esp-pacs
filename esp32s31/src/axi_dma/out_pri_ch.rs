...
impl W {
    ...
    #[doc = "Bits 4:7 - The weight of Tx channel0"]
    #[inline(always)]
    pub fn tx_ch_arb_weigh_ch(&mut self) -> TX_CH_ARB_WEIGH_CH_W<'_, OUT_PRI_CH_SPEC> {
        TX_CH_ARB_WEIGH_CH_W::new(self, 4)
    }
    #[doc = "Bit 8 - 0: mean not optimazation weight function ,1: mean optimazation"]
    #[inline(always)]
    pub fn tx_arb_weigh_opt_dir_ch(&mut self) -> TX_ARB_WEIGH_OPT_DIR_CH_W<'_, OUT_PRI_CH_SPEC> {
