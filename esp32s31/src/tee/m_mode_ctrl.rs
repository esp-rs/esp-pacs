...
#[doc = "Field `M_LOCK` reader - Set 1 to lock m3 tee configuration"]
pub type M_LOCK_R = crate::BitReader;
#[doc = "Field `M_LOCK` writer - Set 1 to lock m3 tee configuration"]
...
impl R {
    ...
    #[doc = "Bit 2 - Set 1 to lock m3 tee configuration"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:1 - Configures M%s security level mode.\\\\ 0: tee_mode \\\\ 1: ree_mode0 \\\\ 2: ree_mode1 \\\\ 3: ree_mode2 \\\\"]
    #[inline(always)]
    pub fn m_mode(&mut self) -> M_MODE_W<'_, M_MODE_CTRL_SPEC> {
        M_MODE_W::new(self, 0)
    }
    #[doc = "Bit 2 - Set 1 to lock m3 tee configuration"]
    #[inline(always)]
    pub fn m_lock(&mut self) -> M_LOCK_W<'_, M_MODE_CTRL_SPEC> {
        M_LOCK_W::new(self, 2)
    }
}
