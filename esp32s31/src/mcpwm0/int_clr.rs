...
impl W {
    ...
    #[inline(always)]
    pub fn cmpr0_tea_int_clr(&mut self) -> CMPR0_TEA_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn cmpr1_tea_int_clr(&mut self) -> CMPR1_TEA_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn cmpr2_tea_int_clr(&mut self) -> CMPR2_TEA_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn cmpr0_teb_int_clr(&mut self) -> CMPR0_TEB_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn cmpr1_teb_int_clr(&mut self) -> CMPR1_TEB_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn cmpr2_teb_int_clr(&mut self) -> CMPR2_TEB_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn tz0_cbc_int_clr(&mut self) -> TZ0_CBC_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn tz1_cbc_int_clr(&mut self) -> TZ1_CBC_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn tz2_cbc_int_clr(&mut self) -> TZ2_CBC_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn tz0_ost_int_clr(&mut self) -> TZ0_OST_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn tz1_ost_int_clr(&mut self) -> TZ1_OST_INT_CLR_W<'_, INT_CLR_SPEC> {
