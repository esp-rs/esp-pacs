...
#[doc = "Field `OUT_W1TC` writer - Configures whether or not to clear the output register LP_GPIO_OUT_REG of LP_GPIO0 ~ LP_GPIO7 output.\\\\ 0: Not clear\\\\ 1: The corresponding bit in LP_GPIO_OUT_REG will be cleared.\\\\ Bit0 ~ bit7 are corresponding to LP_GPIO0 ~ LP_GPIO7. Bitxx ~ bitxx is invalid. \\\\ Recommended operation: use this register to clear LP_GPIO_OUT_REG. \\\\"]
