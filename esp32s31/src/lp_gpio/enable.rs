...
#[doc = "Field `DATA` reader - Configures whether or not to enable the output of LP_GPIO0 ~ LP_GPIO7.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit0 ~ bit7 are corresponding to LP_GPIO0 ~ LP_GPIO7. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_R = crate::FieldReader;
#[doc = "Field `DATA` writer - Configures whether or not to enable the output of LP_GPIO0 ~ LP_GPIO7.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit0 ~ bit7 are corresponding to LP_GPIO0 ~ LP_GPIO7. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures whether or not to enable the output of LP_GPIO0 ~ LP_GPIO7.\\\\ 0: Not enable\\\\ 1: Enable\\\\ Bit0 ~ bit7 are corresponding to LP_GPIO0 ~ LP_GPIO7. Bitxx ~ bitxx is invalid.\\\\"]
    #[inline(always)]
