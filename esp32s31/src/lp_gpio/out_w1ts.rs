...
#[doc = "Field `OUT_W1TS` writer - Configures whether or not to set the output register LP_GPIO_OUT_REG of LP_GPIO0 ~ LP_GPIO7.\\\\ 0: Not set\\\\ 1: The corresponding bit in LP_GPIO_OUT_REG will be set to 1\\\\ Bit0 ~ bit7 are corresponding to LP_GPIO0 ~ LP_GPIO7. Bitxx ~ bitxx is invalid. \\\\ Recommended operation: use this register to set LP_GPIO_OUT_REG. \\\\"]
