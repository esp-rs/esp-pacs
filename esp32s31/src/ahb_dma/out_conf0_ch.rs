...
#[doc = "Field `OUT_AUTO_WRBACK_CH` reader - Configures whether to enable automatic outlink write-back when all the data in TX FIFO has been transmitted.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUT_AUTO_WRBACK_CH_R = crate::BitReader;
#[doc = "Field `OUT_AUTO_WRBACK_CH` writer - Configures whether to enable automatic outlink write-back when all the data in TX FIFO has been transmitted.\\\\0: Disable\\\\1: Enable\\\\"]
...
#[doc = "Field `OUTDSCR_BURST_EN_CH` reader - Configures whether to enable INCR burst transfer for TX channel %s reading descriptors.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUTDSCR_BURST_EN_CH_R = crate::BitReader;
#[doc = "Field `OUTDSCR_BURST_EN_CH` writer - Configures whether to enable INCR burst transfer for TX channel %s reading descriptors.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUTDSCR_BURST_EN_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_ETM_EN_CH` reader - Configures whether to enable ETM control for TX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
pub type OUT_ETM_EN_CH_R = crate::BitReader;
#[doc = "Field `OUT_ETM_EN_CH` writer - Configures whether to enable ETM control for TX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
...
impl W {
    ...
    #[doc = "Bit 6 - Configures whether to enable ETM control for TX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn out_etm_en_ch(&mut self) -> OUT_ETM_EN_CH_W<'_, OUT_CONF0_CH_SPEC> {
    ...
    pub fn out_data_burst_mode_sel_ch(
        &mut self,
    ) -> OUT_DATA_BURST_MODE_SEL_CH_W<'_, OUT_CONF0_CH_SPEC> {
