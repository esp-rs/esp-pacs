...
#[doc = "Field `OUT_DONE_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_OUT_DONE_CH%s_INT."]
pub type OUT_DONE_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_EOF_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_OUT_EOF_CH%s_INT."]
pub type OUT_EOF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_DSCR_ERR_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_OUT_DSCR_ERR_CH%s_INT."]
pub type OUT_DSCR_ERR_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_TOTAL_EOF_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_OUT_TOTAL_EOF_CH%s_INT."]
pub type OUT_TOTAL_EOF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_OVF_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_OUTFIFO_OVF_CH%s_INT."]
pub type OUTFIFO_OVF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTFIFO_UDF_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_OUTFIFO_UDF_CH%s_INT."]
pub type OUTFIFO_UDF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_AHBINF_RESP_ERR_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_OUT_RESP_ERR_CH%s_INT."]
pub type OUT_AHBINF_RESP_ERR_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn outfifo_ovf_ch_int_clr(&mut self) -> OUTFIFO_OVF_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_OVF_CH_INT_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - Write 1 to clear AHB_DMA_OUTFIFO_UDF_CH%s_INT."]
    #[inline(always)]
    pub fn outfifo_udf_ch_int_clr(&mut self) -> OUTFIFO_UDF_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUTFIFO_UDF_CH_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to clear AHB_DMA_OUT_RESP_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn out_ahbinf_resp_err_ch_int_clr(
        &mut self,
    ) -> OUT_AHBINF_RESP_ERR_CH_INT_CLR_W<'_, OUT_INT_CLR_CH_SPEC> {
        OUT_AHBINF_RESP_ERR_CH_INT_CLR_W::new(self, 6)
    }
}
