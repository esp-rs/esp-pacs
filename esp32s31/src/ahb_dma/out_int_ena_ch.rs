...
#[doc = "Field `OUT_AHBINF_RESP_ERR_CH_INT_ENA` reader - Write 1 to enable AHB_DMA_OUT_RESP_ERR_CH%s_INT."]
pub type OUT_AHBINF_RESP_ERR_CH_INT_ENA_R = crate::BitReader;
#[doc = "Field `OUT_AHBINF_RESP_ERR_CH_INT_ENA` writer - Write 1 to enable AHB_DMA_OUT_RESP_ERR_CH%s_INT."]
pub type OUT_AHBINF_RESP_ERR_CH_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn out_ahbinf_resp_err_ch_int_ena(&self) -> OUT_AHBINF_RESP_ERR_CH_INT_ENA_R {
        OUT_AHBINF_RESP_ERR_CH_INT_ENA_R::new(((self.bits >> 6) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_INT_ENA_CH")
            ...
            .field(
                "out_ahbinf_resp_err_ch_int_ena",
                &self.out_ahbinf_resp_err_ch_int_ena(),
            )
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 4 - Write 1 to enable AHB_DMA_OUTFIFO_OVF_CH%s_INT."]
    #[inline(always)]
    pub fn outfifo_ovf_ch_int_ena(&mut self) -> OUTFIFO_OVF_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
        OUTFIFO_OVF_CH_INT_ENA_W::new(self, 4)
    }
    #[doc = "Bit 5 - Write 1 to enable AHB_DMA_OUTFIFO_UDF_CH%s_INT."]
    #[inline(always)]
    pub fn outfifo_udf_ch_int_ena(&mut self) -> OUTFIFO_UDF_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
        OUTFIFO_UDF_CH_INT_ENA_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to enable AHB_DMA_OUT_RESP_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn out_ahbinf_resp_err_ch_int_ena(
        &mut self,
    ) -> OUT_AHBINF_RESP_ERR_CH_INT_ENA_W<'_, OUT_INT_ENA_CH_SPEC> {
        OUT_AHBINF_RESP_ERR_CH_INT_ENA_W::new(self, 6)
    }
}
