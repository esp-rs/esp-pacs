...
#[doc = "Field `IN_DONE_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_IN_DONE_CH%s_INT."]
pub type IN_DONE_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_SUC_EOF_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_IN_SUC_EOF_CH%s_INT."]
pub type IN_SUC_EOF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_ERR_EOF_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_IN_ERR_EOF_CH%s_INT."]
pub type IN_ERR_EOF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_DSCR_ERR_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_IN_DSCR_ERR_CH%s_INT."]
pub type IN_DSCR_ERR_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_DSCR_EMPTY_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_IN_DSCR_EMPTY_CH%s_INT."]
pub type IN_DSCR_EMPTY_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_OVF_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_INFIFO_OVF_CH%s_INT."]
pub type INFIFO_OVF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_UDF_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_INFIFO_UDF_CH%s_INT."]
pub type INFIFO_UDF_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_AHBINF_RESP_ERR_CH_INT_CLR` writer - Write 1 to clear AHB_DMA_IN_RESP_ERR_CH%s_INT."]
pub type IN_AHBINF_RESP_ERR_CH_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn infifo_ovf_ch_int_clr(&mut self) -> INFIFO_OVF_CH_INT_CLR_W<'_, IN_INT_CLR_CH_SPEC> {
        INFIFO_OVF_CH_INT_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to clear AHB_DMA_INFIFO_UDF_CH%s_INT."]
    #[inline(always)]
    pub fn infifo_udf_ch_int_clr(&mut self) -> INFIFO_UDF_CH_INT_CLR_W<'_, IN_INT_CLR_CH_SPEC> {
        INFIFO_UDF_CH_INT_CLR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to clear AHB_DMA_IN_RESP_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn in_ahbinf_resp_err_ch_int_clr(
        &mut self,
    ) -> IN_AHBINF_RESP_ERR_CH_INT_CLR_W<'_, IN_INT_CLR_CH_SPEC> {
        IN_AHBINF_RESP_ERR_CH_INT_CLR_W::new(self, 7)
    }
}
