...
#[doc = "Field `TX_CH_ARB_WEIGH` reader - Configures the weight(i.e the number of tokens) of TX channel%s"]
pub type TX_CH_ARB_WEIGH_R = crate::FieldReader;
#[doc = "Field `TX_CH_ARB_WEIGH` writer - Configures the weight(i.e the number of tokens) of TX channel%s"]
...
impl W {
    #[doc = "Bits 0:3 - Configures the weight(i.e the number of tokens) of TX channel%s"]
    #[inline(always)]
    pub fn tx_ch_arb_weigh(&mut self) -> TX_CH_ARB_WEIGH_W<'_, TX_CH_ARB_WEIGH_SPEC> {
        TX_CH_ARB_WEIGH_W::new(self, 0)
    }
}
#[doc = "TX channel 0 arbitration weight configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`tx_ch_arb_weigh::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tx_ch_arb_weigh::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
