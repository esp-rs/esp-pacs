...
#[doc = "Field `OUT_AHBINF_RESP_ERR_CH_INT_RAW` reader - The raw interrupt status of AHB_DMA_OUT_RESP_ERR_CH%s_INT."]
pub type OUT_AHBINF_RESP_ERR_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `OUT_AHBINF_RESP_ERR_CH_INT_RAW` writer - The raw interrupt status of AHB_DMA_OUT_RESP_ERR_CH%s_INT."]
pub type OUT_AHBINF_RESP_ERR_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn out_ahbinf_resp_err_ch_int_raw(&self) -> OUT_AHBINF_RESP_ERR_CH_INT_RAW_R {
        OUT_AHBINF_RESP_ERR_CH_INT_RAW_R::new(((self.bits >> 6) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_INT_RAW_CH")
            ...
            .field(
                "out_ahbinf_resp_err_ch_int_raw",
                &self.out_ahbinf_resp_err_ch_int_raw(),
            )
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 6 - The raw interrupt status of AHB_DMA_OUT_RESP_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn out_ahbinf_resp_err_ch_int_raw(
        &mut self,
    ) -> OUT_AHBINF_RESP_ERR_CH_INT_RAW_W<'_, OUT_INT_RAW_CH_SPEC> {
        OUT_AHBINF_RESP_ERR_CH_INT_RAW_W::new(self, 6)
    }
}
