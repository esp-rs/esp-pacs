...
#[doc = "Field `IN_DONE_CH_INT_ST` reader - The masked interrupt status of AHB_DMA_IN_DONE_CH%s_INT."]
pub type IN_DONE_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `IN_SUC_EOF_CH_INT_ST` reader - The masked interrupt status of AHB_DMA_IN_SUC_EOF_CH%s_INT."]
pub type IN_SUC_EOF_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `IN_ERR_EOF_CH_INT_ST` reader - The masked interrupt status of AHB_DMA_IN_ERR_EOF_CH%s_INT."]
pub type IN_ERR_EOF_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `IN_DSCR_ERR_CH_INT_ST` reader - The masked interrupt status of AHB_DMA_IN_DSCR_ERR_CH%s_INT."]
pub type IN_DSCR_ERR_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `IN_DSCR_EMPTY_CH_INT_ST` reader - The masked interrupt status of AHB_DMA_IN_DSCR_EMPTY_CH%s_INT."]
pub type IN_DSCR_EMPTY_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `INFIFO_OVF_CH_INT_ST` reader - The masked interrupt status of AHB_DMA_INFIFO_OVF_CH%s_INT."]
pub type INFIFO_OVF_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `INFIFO_UDF_CH_INT_ST` reader - The masked interrupt status of AHB_DMA_INFIFO_UDF_CH%s_INT."]
pub type INFIFO_UDF_CH_INT_ST_R = crate::BitReader;
#[doc = "Field `IN_AHBINF_RESP_ERR_CH_INT_ST` reader - The masked interrupt status of AHB_DMA_IN_RESP_ERR_CH%s_INT."]
pub type IN_AHBINF_RESP_ERR_CH_INT_ST_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn in_ahbinf_resp_err_ch_int_st(&self) -> IN_AHBINF_RESP_ERR_CH_INT_ST_R {
        IN_AHBINF_RESP_ERR_CH_INT_ST_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_INT_ST_CH")
            ...
            .field("infifo_ovf_ch_int_st", &self.infifo_ovf_ch_int_st())
            .field("infifo_udf_ch_int_st", &self.infifo_udf_ch_int_st())
            .field(
                "in_ahbinf_resp_err_ch_int_st",
                &self.in_ahbinf_resp_err_ch_int_st(),
            )
            .finish()
    }
}
