...
#[doc = "Field `INLINK_ADDR_CH` reader - Configures the 32 bits of the first receive descriptor's address."]
pub type INLINK_ADDR_CH_R = crate::FieldReader<u32>;
#[doc = "Field `INLINK_ADDR_CH` writer - Configures the 32 bits of the first receive descriptor's address."]
...
impl W {
    #[doc = "Bits 0:31 - Configures the 32 bits of the first receive descriptor's address."]
    #[inline(always)]
    pub fn inlink_addr_ch(&mut self) -> INLINK_ADDR_CH_W<'_, IN_LINK_ADDR_CH_SPEC> {
