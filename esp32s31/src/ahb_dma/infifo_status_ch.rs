...
#[doc = "Field `INFIFO_FULL_CH` reader - Represents whether L1 RX FIFO is full.\\\\0: Not Full\\\\1: Full\\\\"]
pub type INFIFO_FULL_CH_R = crate::BitReader;
#[doc = "Field `INFIFO_EMPTY_CH` reader - Represents whether L1 RX FIFO is empty.\\\\0: Not empty\\\\1: Empty\\\\"]
