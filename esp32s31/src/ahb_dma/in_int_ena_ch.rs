...
#[doc = "Field `IN_AHBINF_RESP_ERR_CH_INT_ENA` reader - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH%s_INT."]
pub type IN_AHBINF_RESP_ERR_CH_INT_ENA_R = crate::BitReader;
#[doc = "Field `IN_AHBINF_RESP_ERR_CH_INT_ENA` writer - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH%s_INT."]
pub type IN_AHBINF_RESP_ERR_CH_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn in_ahbinf_resp_err_ch_int_ena(&self) -> IN_AHBINF_RESP_ERR_CH_INT_ENA_R {
        IN_AHBINF_RESP_ERR_CH_INT_ENA_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_INT_ENA_CH")
            ...
            .field(
                "in_ahbinf_resp_err_ch_int_ena",
                &self.in_ahbinf_resp_err_ch_int_ena(),
            )
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 5 - Write 1 to enable AHB_DMA_INFIFO_OVF_CH%s_INT."]
    #[inline(always)]
    pub fn infifo_ovf_ch_int_ena(&mut self) -> INFIFO_OVF_CH_INT_ENA_W<'_, IN_INT_ENA_CH_SPEC> {
        INFIFO_OVF_CH_INT_ENA_W::new(self, 5)
    }
    #[doc = "Bit 6 - Write 1 to enable AHB_DMA_INFIFO_UDF_CH%s_INT."]
    #[inline(always)]
    pub fn infifo_udf_ch_int_ena(&mut self) -> INFIFO_UDF_CH_INT_ENA_W<'_, IN_INT_ENA_CH_SPEC> {
        INFIFO_UDF_CH_INT_ENA_W::new(self, 6)
    }
    #[doc = "Bit 7 - Write 1 to enable AHB_DMA_IN_RESP_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn in_ahbinf_resp_err_ch_int_ena(
        &mut self,
    ) -> IN_AHBINF_RESP_ERR_CH_INT_ENA_W<'_, IN_INT_ENA_CH_SPEC> {
        IN_AHBINF_RESP_ERR_CH_INT_ENA_W::new(self, 7)
    }
}
