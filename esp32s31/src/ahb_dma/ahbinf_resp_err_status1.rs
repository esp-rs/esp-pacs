...
#[doc = "Field `AHBINF_RESP_ERR_CH_ID` reader - Represents the AHB response error request channel id.bit\\[3\\]=1:TX channel.\\\\bit\\[3\\]=0:RX channel.\\\\"]
...
impl R {
    ...
    pub fn ahbinf_resp_err_id(&self) -> AHBINF_RESP_ERR_ID_R {
        AHBINF_RESP_ERR_ID_R::new(((self.bits >> 1) & 0x1f) as u8)
    }
    #[doc = "Bits 6:9 - Represents the AHB response error request channel id.bit\\[3\\]=1:TX channel.\\\\bit\\[3\\]=0:RX channel.\\\\"]
    #[inline(always)]
    pub fn ahbinf_resp_err_ch_id(&self) -> AHBINF_RESP_ERR_CH_ID_R {
        AHBINF_RESP_ERR_CH_ID_R::new(((self.bits >> 6) & 0x0f) as u8)
    }
}
...
#[doc = "`reset()` method sets AHBINF_RESP_ERR_STATUS1 to value 0x3e"]
