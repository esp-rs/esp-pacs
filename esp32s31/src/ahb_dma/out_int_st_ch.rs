...
#[doc = "Field `OUT_AHBINF_RESP_ERR_CH_INT_ST` reader - The masked interrupt status of AHB_DMA_OUT_RESP_ERR_CH%s_INT."]
pub type OUT_AHBINF_RESP_ERR_CH_INT_ST_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn out_ahbinf_resp_err_ch_int_st(&self) -> OUT_AHBINF_RESP_ERR_CH_INT_ST_R {
        OUT_AHBINF_RESP_ERR_CH_INT_ST_R::new(((self.bits >> 6) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_INT_ST_CH")
            ...
            .field(
                "out_ahbinf_resp_err_ch_int_st",
                &self.out_ahbinf_resp_err_ch_int_st(),
            )
            .finish()
    }
}
