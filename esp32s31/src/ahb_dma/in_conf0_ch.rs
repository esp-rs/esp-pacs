...
#[doc = "Field `INDSCR_BURST_EN_CH` reader - Configures whether to enable INCR burst transfer for RX channel %s to read descriptors.\\\\0: Disable\\\\1: Enable\\\\"]
pub type INDSCR_BURST_EN_CH_R = crate::BitReader;
#[doc = "Field `INDSCR_BURST_EN_CH` writer - Configures whether to enable INCR burst transfer for RX channel %s to read descriptors.\\\\0: Disable\\\\1: Enable\\\\"]
pub type INDSCR_BURST_EN_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MEM_TRANS_EN_CH` reader - Configures whether to enable memory-to-memory data transfer.\\\\0: Disable\\\\1: Enable\\\\"]
pub type MEM_TRANS_EN_CH_R = crate::BitReader;
#[doc = "Field `MEM_TRANS_EN_CH` writer - Configures whether to enable memory-to-memory data transfer.\\\\0: Disable\\\\1: Enable\\\\"]
pub type MEM_TRANS_EN_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_ETM_EN_CH` reader - Configures whether to enable ETM control for RX channel%s.\\\\0: Disable\\\\1: Enable\\\\"]
pub type IN_ETM_EN_CH_R = crate::BitReader;
#[doc = "Field `IN_ETM_EN_CH` writer - Configures whether to enable ETM control for RX channel%s.\\\\0: Disable\\\\1: Enable\\\\"]
...
impl W {
    ...
    #[doc = "Bit 4 - Configures whether to enable memory-to-memory data transfer.\\\\0: Disable\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn mem_trans_en_ch(&mut self) -> MEM_TRANS_EN_CH_W<'_, IN_CONF0_CH_SPEC> {
        MEM_TRANS_EN_CH_W::new(self, 4)
    }
    #[doc = "Bit 5 - Configures whether to enable ETM control for RX channel%s.\\\\0: Disable\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn in_etm_en_ch(&mut self) -> IN_ETM_EN_CH_W<'_, IN_CONF0_CH_SPEC> {
        IN_ETM_EN_CH_W::new(self, 5)
    }
    #[doc = "Bits 6:7 - Configures max burst size for Rx channel%s.\\\\2'b00: single\\\\ 2'b01: incr4\\\\ 2'b10: incr8\\\\ 2'b11: incr16\\\\"]
    #[inline(always)]
    pub fn in_data_burst_mode_sel_ch(
        &mut self,
    ) -> IN_DATA_BURST_MODE_SEL_CH_W<'_, IN_CONF0_CH_SPEC> {
