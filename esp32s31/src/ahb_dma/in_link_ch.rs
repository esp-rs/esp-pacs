...
#[doc = "Field `INLINK_AUTO_RET_CH` reader - Configures whether to return to current receive descriptor's address when there are some errors in current receiving data.\\\\0: Not return\\\\1: Return\\\\"]
pub type INLINK_AUTO_RET_CH_R = crate::BitReader;
#[doc = "Field `INLINK_AUTO_RET_CH` writer - Configures whether to return to current receive descriptor's address when there are some errors in current receiving data.\\\\0: Not return\\\\1: Return\\\\"]
pub type INLINK_AUTO_RET_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INLINK_STOP_CH` writer - Configures whether to stop AHB_DMA's RX channel %s from receiving data.\\\\0: Invalid. No effect\\\\1: Stop\\\\"]
pub type INLINK_STOP_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INLINK_START_CH` writer - Configures whether to enable AHB_DMA's RX channel %s for data transfer.\\\\0: Disable\\\\1: Enable\\\\"]
pub type INLINK_START_CH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INLINK_RESTART_CH` writer - Configures whether to restart RX channel %s for AHB_DMA transfer.\\\\0: Invalid. No effect\\\\1: Restart\\\\"]
...
impl W {
    #[doc = "Bit 0 - Configures whether to return to current receive descriptor's address when there are some errors in current receiving data.\\\\0: Not return\\\\1: Return\\\\"]
    #[inline(always)]
    pub fn inlink_auto_ret_ch(&mut self) -> INLINK_AUTO_RET_CH_W<'_, IN_LINK_CH_SPEC> {
    ...
    #[inline(always)]
    pub fn inlink_stop_ch(&mut self) -> INLINK_STOP_CH_W<'_, IN_LINK_CH_SPEC> {
    ...
    #[inline(always)]
    pub fn inlink_start_ch(&mut self) -> INLINK_START_CH_W<'_, IN_LINK_CH_SPEC> {
    ...
    #[inline(always)]
    pub fn inlink_restart_ch(&mut self) -> INLINK_RESTART_CH_W<'_, IN_LINK_CH_SPEC> {
