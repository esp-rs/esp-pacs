...
#[doc = "Field `OUTFIFO_FULL_CH` reader - Represents whether L1 TX FIFO is full.\\\\0: Not Full\\\\1: Full\\\\"]
pub type OUTFIFO_FULL_CH_R = crate::BitReader;
#[doc = "Field `OUTFIFO_EMPTY_CH` reader - Represents whether L1 TX FIFO is empty.\\\\0: Not empty\\\\1: Empty\\\\"]
