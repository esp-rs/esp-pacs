...
#[doc = "Field `IN_AHBINF_RESP_ERR` reader - The raw interrupt status of AHB_DMA_IN_RESP_ERR_CH%s_INT."]
pub type IN_AHBINF_RESP_ERR_R = crate::BitReader;
#[doc = "Field `IN_AHBINF_RESP_ERR` writer - The raw interrupt status of AHB_DMA_IN_RESP_ERR_CH%s_INT."]
...
impl W {
    ...
    #[doc = "Bit 7 - The raw interrupt status of AHB_DMA_IN_RESP_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn in_ahbinf_resp_err(&mut self) -> IN_AHBINF_RESP_ERR_W<'_, RAW_SPEC> {
