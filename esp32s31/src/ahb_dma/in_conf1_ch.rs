...
#[doc = "Field `IN_CHECK_OWNER_CH` reader - Configures whether to enable owner bit check for RX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
pub type IN_CHECK_OWNER_CH_R = crate::BitReader;
#[doc = "Field `IN_CHECK_OWNER_CH` writer - Configures whether to enable owner bit check for RX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
...
impl W {
    #[doc = "Bit 12 - Configures whether to enable owner bit check for RX channel %s.\\\\0: Disable\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn in_check_owner_ch(&mut self) -> IN_CHECK_OWNER_CH_W<'_, IN_CONF1_CH_SPEC> {
        IN_CHECK_OWNER_CH_W::new(self, 12)
    }
}
#[doc = "Configuration register 1 of RX channel %s\n\nYou can [`read`](crate::Reg::read) this register and get [`in_conf1_ch::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`in_conf1_ch::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
