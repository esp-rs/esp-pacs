...
#[doc = "Field `TX_PRI_CH` reader - Configures the priority of TX channel %s.The larger of the value, the higher of the priority."]
pub type TX_PRI_CH_R = crate::FieldReader;
#[doc = "Field `TX_PRI_CH` writer - Configures the priority of TX channel %s.The larger of the value, the higher of the priority."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OUT_PRI_CH")
            .field("tx_pri_ch", &self.tx_pri_ch())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:3 - Configures the priority of TX channel %s.The larger of the value, the higher of the priority."]
    #[inline(always)]
    pub fn tx_pri_ch(&mut self) -> TX_PRI_CH_W<'_, OUT_PRI_CH_SPEC> {
        TX_PRI_CH_W::new(self, 0)
    }
}
#[doc = "Priority register of TX channel %s\n\nYou can [`read`](crate::Reg::read) this register and get [`out_pri_ch::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`out_pri_ch::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
