...
#[doc = "Field `IN_DONE_CH_INT_RAW` reader - The raw interrupt status of AHB_DMA_IN_DONE_CH%s_INT."]
pub type IN_DONE_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `IN_DONE_CH_INT_RAW` writer - The raw interrupt status of AHB_DMA_IN_DONE_CH%s_INT."]
pub type IN_DONE_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_SUC_EOF_CH_INT_RAW` reader - The raw interrupt status of AHB_DMA_IN_SUC_EOF_CH%s_INT."]
pub type IN_SUC_EOF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `IN_SUC_EOF_CH_INT_RAW` writer - The raw interrupt status of AHB_DMA_IN_SUC_EOF_CH%s_INT."]
pub type IN_SUC_EOF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_ERR_EOF_CH_INT_RAW` reader - The raw interrupt status of AHB_DMA_IN_ERR_EOF_CH%s_INT."]
pub type IN_ERR_EOF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `IN_ERR_EOF_CH_INT_RAW` writer - The raw interrupt status of AHB_DMA_IN_ERR_EOF_CH%s_INT."]
pub type IN_ERR_EOF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_DSCR_ERR_CH_INT_RAW` reader - The raw interrupt status of AHB_DMA_IN_DSCR_ERR_CH%s_INT."]
pub type IN_DSCR_ERR_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `IN_DSCR_ERR_CH_INT_RAW` writer - The raw interrupt status of AHB_DMA_IN_DSCR_ERR_CH%s_INT."]
pub type IN_DSCR_ERR_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_DSCR_EMPTY_CH_INT_RAW` reader - The raw interrupt status of AHB_DMA_IN_DSCR_EMPTY_CH%s_INT."]
pub type IN_DSCR_EMPTY_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `IN_DSCR_EMPTY_CH_INT_RAW` writer - The raw interrupt status of AHB_DMA_IN_DSCR_EMPTY_CH%s_INT."]
pub type IN_DSCR_EMPTY_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_OVF_CH_INT_RAW` reader - The raw interrupt status of AHB_DMA_INFIFO_OVF_CH%s_INT."]
pub type INFIFO_OVF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `INFIFO_OVF_CH_INT_RAW` writer - The raw interrupt status of AHB_DMA_INFIFO_OVF_CH%s_INT."]
pub type INFIFO_OVF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INFIFO_UDF_CH_INT_RAW` reader - The raw interrupt status of AHB_DMA_INFIFO_UDF_CH%s_INT."]
pub type INFIFO_UDF_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `INFIFO_UDF_CH_INT_RAW` writer - The raw interrupt status of AHB_DMA_INFIFO_UDF_CH%s_INT."]
pub type INFIFO_UDF_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_AHBINF_RESP_ERR_CH_INT_RAW` reader - The raw interrupt status of AHB_DMA_IN_RESP_ERR_CH%s_INT."]
pub type IN_AHBINF_RESP_ERR_CH_INT_RAW_R = crate::BitReader;
#[doc = "Field `IN_AHBINF_RESP_ERR_CH_INT_RAW` writer - The raw interrupt status of AHB_DMA_IN_RESP_ERR_CH%s_INT."]
pub type IN_AHBINF_RESP_ERR_CH_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn in_ahbinf_resp_err_ch_int_raw(&self) -> IN_AHBINF_RESP_ERR_CH_INT_RAW_R {
        IN_AHBINF_RESP_ERR_CH_INT_RAW_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IN_INT_RAW_CH")
            ...
            .field("infifo_ovf_ch_int_raw", &self.infifo_ovf_ch_int_raw())
            .field("infifo_udf_ch_int_raw", &self.infifo_udf_ch_int_raw())
            .field(
                "in_ahbinf_resp_err_ch_int_raw",
                &self.in_ahbinf_resp_err_ch_int_raw(),
            )
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 5 - The raw interrupt status of AHB_DMA_INFIFO_OVF_CH%s_INT."]
    #[inline(always)]
    pub fn infifo_ovf_ch_int_raw(&mut self) -> INFIFO_OVF_CH_INT_RAW_W<'_, IN_INT_RAW_CH_SPEC> {
        INFIFO_OVF_CH_INT_RAW_W::new(self, 5)
    }
    #[doc = "Bit 6 - The raw interrupt status of AHB_DMA_INFIFO_UDF_CH%s_INT."]
    #[inline(always)]
    pub fn infifo_udf_ch_int_raw(&mut self) -> INFIFO_UDF_CH_INT_RAW_W<'_, IN_INT_RAW_CH_SPEC> {
        INFIFO_UDF_CH_INT_RAW_W::new(self, 6)
    }
    #[doc = "Bit 7 - The raw interrupt status of AHB_DMA_IN_RESP_ERR_CH%s_INT."]
    #[inline(always)]
    pub fn in_ahbinf_resp_err_ch_int_raw(
        &mut self,
    ) -> IN_AHBINF_RESP_ERR_CH_INT_RAW_W<'_, IN_INT_RAW_CH_SPEC> {
        IN_AHBINF_RESP_ERR_CH_INT_RAW_W::new(self, 7)
    }
}
