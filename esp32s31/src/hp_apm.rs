...
pub struct RegisterBlock {
    ...
    m5_status: M5_STATUS,
    m5_status_clr: M5_STATUS_CLR,
    m5_exception_info0: M5_EXCEPTION_INFO0,
    m5_exception_info1: M5_EXCEPTION_INFO1,
    _reserved29: [u8; 0x04],
    m6_status: M6_STATUS,
    m6_status_clr: M6_STATUS_CLR,
    m6_exception_info0: M6_EXCEPTION_INFO0,
    m6_exception_info1: M6_EXCEPTION_INFO1,
    _reserved33: [u8; 0x10],
    int_en: INT_EN,
    axi_block_en: AXI_BLOCK_EN,
    bus_err_conf: BUS_ERR_CONF,
    _reserved36: [u8; 0x02a0],
...
impl RegisterBlock {
    ...
    #[doc = "0x118 - M5 status register"]
    #[inline(always)]
    pub const fn m5_status(&self) -> &M5_STATUS {
        &self.m5_status
    }
    #[doc = "0x11c - M5 status clear register"]
    #[inline(always)]
    pub const fn m5_status_clr(&self) -> &M5_STATUS_CLR {
        &self.m5_status_clr
    }
    #[doc = "0x120 - M5 exception_info0 register"]
    #[inline(always)]
    pub const fn m5_exception_info0(&self) -> &M5_EXCEPTION_INFO0 {
        &self.m5_exception_info0
    }
    #[doc = "0x124 - M5 exception_info1 register"]
    #[inline(always)]
    pub const fn m5_exception_info1(&self) -> &M5_EXCEPTION_INFO1 {
        &self.m5_exception_info1
    }
    #[doc = "0x12c - M6 status register"]
    #[inline(always)]
    pub const fn m6_status(&self) -> &M6_STATUS {
        &self.m6_status
    }
    #[doc = "0x130 - M6 status clear register"]
    #[inline(always)]
    pub const fn m6_status_clr(&self) -> &M6_STATUS_CLR {
        &self.m6_status_clr
    }
    #[doc = "0x134 - M6 exception_info0 register"]
    #[inline(always)]
    pub const fn m6_exception_info0(&self) -> &M6_EXCEPTION_INFO0 {
        &self.m6_exception_info0
    }
    #[doc = "0x138 - M6 exception_info1 register"]
    #[inline(always)]
    pub const fn m6_exception_info1(&self) -> &M6_EXCEPTION_INFO1 {
        &self.m6_exception_info1
    }
    #[doc = "0x14c - APM interrupt enable register"]
    #[inline(always)]
    pub const fn int_en(&self) -> &INT_EN {
        &self.int_en
    }
    #[doc = "0x150 - M6 status clear register"]
    #[inline(always)]
    pub const fn axi_block_en(&self) -> &AXI_BLOCK_EN {
        &self.axi_block_en
    }
    #[doc = "0x154 - APM interrupt enable register"]
    #[inline(always)]
...
#[doc = "M5_STATUS (r) register accessor: M5 status register\n\nYou can [`read`](crate::Reg::read) this register and get [`m5_status::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@m5_status`] module"]
pub type M5_STATUS = crate::Reg<m5_status::M5_STATUS_SPEC>;
#[doc = "M5 status register"]
pub mod m5_status;
#[doc = "M5_STATUS_CLR (w) register accessor: M5 status clear register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m5_status_clr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@m5_status_clr`] module"]
pub type M5_STATUS_CLR = crate::Reg<m5_status_clr::M5_STATUS_CLR_SPEC>;
#[doc = "M5 status clear register"]
pub mod m5_status_clr;
#[doc = "M5_EXCEPTION_INFO0 (r) register accessor: M5 exception_info0 register\n\nYou can [`read`](crate::Reg::read) this register and get [`m5_exception_info0::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@m5_exception_info0`] module"]
pub type M5_EXCEPTION_INFO0 = crate::Reg<m5_exception_info0::M5_EXCEPTION_INFO0_SPEC>;
#[doc = "M5 exception_info0 register"]
pub mod m5_exception_info0;
#[doc = "M5_EXCEPTION_INFO1 (r) register accessor: M5 exception_info1 register\n\nYou can [`read`](crate::Reg::read) this register and get [`m5_exception_info1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@m5_exception_info1`] module"]
pub type M5_EXCEPTION_INFO1 = crate::Reg<m5_exception_info1::M5_EXCEPTION_INFO1_SPEC>;
#[doc = "M5 exception_info1 register"]
pub mod m5_exception_info1;
#[doc = "M6_STATUS (r) register accessor: M6 status register\n\nYou can [`read`](crate::Reg::read) this register and get [`m6_status::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@m6_status`] module"]
pub type M6_STATUS = crate::Reg<m6_status::M6_STATUS_SPEC>;
#[doc = "M6 status register"]
pub mod m6_status;
#[doc = "M6_STATUS_CLR (w) register accessor: M6 status clear register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`m6_status_clr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@m6_status_clr`] module"]
pub type M6_STATUS_CLR = crate::Reg<m6_status_clr::M6_STATUS_CLR_SPEC>;
#[doc = "M6 status clear register"]
pub mod m6_status_clr;
#[doc = "M6_EXCEPTION_INFO0 (r) register accessor: M6 exception_info0 register\n\nYou can [`read`](crate::Reg::read) this register and get [`m6_exception_info0::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@m6_exception_info0`] module"]
pub type M6_EXCEPTION_INFO0 = crate::Reg<m6_exception_info0::M6_EXCEPTION_INFO0_SPEC>;
#[doc = "M6 exception_info0 register"]
pub mod m6_exception_info0;
#[doc = "M6_EXCEPTION_INFO1 (r) register accessor: M6 exception_info1 register\n\nYou can [`read`](crate::Reg::read) this register and get [`m6_exception_info1::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@m6_exception_info1`] module"]
pub type M6_EXCEPTION_INFO1 = crate::Reg<m6_exception_info1::M6_EXCEPTION_INFO1_SPEC>;
#[doc = "M6 exception_info1 register"]
pub mod m6_exception_info1;
...
pub mod int_en;
#[doc = "AXI_BLOCK_EN (rw) register accessor: M6 status clear register\n\nYou can [`read`](crate::Reg::read) this register and get [`axi_block_en::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`axi_block_en::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@axi_block_en`] module"]
pub type AXI_BLOCK_EN = crate::Reg<axi_block_en::AXI_BLOCK_EN_SPEC>;
#[doc = "M6 status clear register"]
pub mod axi_block_en;
