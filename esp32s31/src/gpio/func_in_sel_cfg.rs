...
#[doc = "Field `IN_SEL` reader - Configures to select a pin from the 63 GPIO pins to connect the input signal %s."]
pub type IN_SEL_R = crate::FieldReader;
#[doc = "Field `IN_SEL` writer - Configures to select a pin from the 63 GPIO pins to connect the input signal %s."]
pub type IN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
...
#[doc = "Field `SEL` reader - Configures whether or not to route signals via GPIO matrix. 0: Bypass GPIO matrix. 1: Route via GPIO matrix."]
pub type SEL_R = crate::BitReader;
#[doc = "Field `SEL` writer - Configures whether or not to route signals via GPIO matrix. 0: Bypass GPIO matrix. 1: Route via GPIO matrix."]
