...
#[doc = "Field `FUNC_IN_SEL` reader - Configures to select a pin from the 63 GPIO pins to connect the input signal %s.\\\\ 0: Select GPIO0\\\\ 1: Select GPIO1\\\\ ......\\\\ 61: Select GPIO61\\\\ 62: Select GPIO62\\\\ Or\\\\ 0x80: A constantly high input\\\\ 0xc0: A constantly low input\\\\"]
pub type FUNC_IN_SEL_R = crate::FieldReader;
#[doc = "Field `FUNC_IN_SEL` writer - Configures to select a pin from the 63 GPIO pins to connect the input signal %s.\\\\ 0: Select GPIO0\\\\ 1: Select GPIO1\\\\ ......\\\\ 61: Select GPIO61\\\\ 62: Select GPIO62\\\\ Or\\\\ 0x80: A constantly high input\\\\ 0xc0: A constantly low input\\\\"]
...
#[doc = "Field `SIG_IN_SEL` reader - Configures whether or not to route signals via GPIO matrix.\\\\ 0: Bypass GPIO matrix, i.e., connect signals directly to peripheral configured in IO MUX.\\\\ 1: Route signals via GPIO matrix.\\\\"]
pub type SIG_IN_SEL_R = crate::BitReader;
#[doc = "Field `SIG_IN_SEL` writer - Configures whether or not to route signals via GPIO matrix.\\\\ 0: Bypass GPIO matrix, i.e., connect signals directly to peripheral configured in IO MUX.\\\\ 1: Route signals via GPIO matrix.\\\\"]
pub type SIG_IN_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:7 - Configures to select a pin from the 63 GPIO pins to connect the input signal %s.\\\\ 0: Select GPIO0\\\\ 1: Select GPIO1\\\\ ......\\\\ 61: Select GPIO61\\\\ 62: Select GPIO62\\\\ Or\\\\ 0x80: A constantly high input\\\\ 0xc0: A constantly low input\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - Configures whether or not to route signals via GPIO matrix.\\\\ 0: Bypass GPIO matrix, i.e., connect signals directly to peripheral configured in IO MUX.\\\\ 1: Route signals via GPIO matrix.\\\\"]
    #[inline(always)]
...
#[doc = "`reset()` method sets FUNC%s_IN_SEL_CFG to value 0x80"]
