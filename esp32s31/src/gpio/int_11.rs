#[doc = "Register `INT_11` reader"]
pub type R = crate::R<INT_11_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_11")
            .field("int_11", &self.int_11())
            .finish()
    }
}
#[doc = "GPIO_INT_1 interrupt status register\n\nYou can [`read`](crate::Reg::read) this register and get [`int_11::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct INT_11_SPEC;
impl crate::RegisterSpec for INT_11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`int_11::R`](R) reader structure"]
impl crate::Readable for INT_11_SPEC {}
#[doc = "`reset()` method sets INT_11 to value 0"]
impl crate::Resettable for INT_11_SPEC {}
