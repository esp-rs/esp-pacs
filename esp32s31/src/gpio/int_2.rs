#[doc = "Register `INT_2` reader"]
pub type R = crate::R<INT_2_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_2")
            .field("int_2", &self.int_2())
            .finish()
    }
}
#[doc = "GPIO_INT_2 interrupt status register\n\nYou can [`read`](crate::Reg::read) this register and get [`int_2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct INT_2_SPEC;
impl crate::RegisterSpec for INT_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`int_2::R`](R) reader structure"]
impl crate::Readable for INT_2_SPEC {}
#[doc = "`reset()` method sets INT_2 to value 0"]
impl crate::Resettable for INT_2_SPEC {}
