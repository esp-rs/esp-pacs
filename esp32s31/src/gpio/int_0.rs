#[doc = "Register `INT_0` reader"]
pub type R = crate::R<INT_0_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_0")
            .field("int_0", &self.int_0())
            .finish()
    }
}
#[doc = "GPIO_INT_0 interrupt status register\n\nYou can [`read`](crate::Reg::read) this register and get [`int_0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct INT_0_SPEC;
impl crate::RegisterSpec for INT_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`int_0::R`](R) reader structure"]
impl crate::Readable for INT_0_SPEC {}
#[doc = "`reset()` method sets INT_0 to value 0"]
impl crate::Resettable for INT_0_SPEC {}
