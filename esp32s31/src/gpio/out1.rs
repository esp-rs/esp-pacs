...
#[doc = "Field `DATA_ORIG` reader - Configures the output value of GPIO32 ~ 63 output in simple GPIO output mode.\\\\ 0: Low level\\\\ 1: High level\\\\ The value of bit32 ~ bit63 correspond to the output value of GPIO32 ~ GPIO63 respectively. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_ORIG_R = crate::FieldReader<u32>;
#[doc = "Field `DATA_ORIG` writer - Configures the output value of GPIO32 ~ 63 output in simple GPIO output mode.\\\\ 0: Low level\\\\ 1: High level\\\\ The value of bit32 ~ bit63 correspond to the output value of GPIO32 ~ GPIO63 respectively. Bitxx ~ bitxx is invalid.\\\\"]
pub type DATA_ORIG_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the output value of GPIO32 ~ 63 output in simple GPIO output mode.\\\\ 0: Low level\\\\ 1: High level\\\\ The value of bit32 ~ bit63 correspond to the output value of GPIO32 ~ GPIO63 respectively. Bitxx ~ bitxx is invalid.\\\\"]
    #[inline(always)]
