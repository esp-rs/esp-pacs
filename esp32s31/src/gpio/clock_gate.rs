...
#[doc = "Field `CLK_EN` reader - Configures whether or not to enable clock gate.\\\\ 0: Not enable\\\\ 1: Enable, the clock is free running. \\\\"]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Configures whether or not to enable clock gate.\\\\ 0: Not enable\\\\ 1: Enable, the clock is free running. \\\\"]
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether or not to enable clock gate.\\\\ 0: Not enable\\\\ 1: Enable, the clock is free running. \\\\"]
    #[inline(always)]
