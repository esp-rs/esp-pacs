...
#[doc = "Field `TX_SYNC_INT_CLR` writer - Set this bit to clear the i2s_tx_sync_int interrupt"]
pub type TX_SYNC_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[doc = "Bit 4 - Set this bit to clear the i2s_tx_sync_int interrupt"]
    #[inline(always)]
    pub fn tx_sync_int_clr(&mut self) -> TX_SYNC_INT_CLR_W<'_, INT_CLR_SPEC> {
        TX_SYNC_INT_CLR_W::new(self, 4)
    }
}
