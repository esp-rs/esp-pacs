...
#[doc = "Field `TX_SYNC` writer - Set this bit to clear the i2s_tx_sync_int interrupt"]
pub type TX_SYNC_W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn tx_sync(&mut self) -> TX_SYNC_W<'_, INT_CLR_SPEC> {
