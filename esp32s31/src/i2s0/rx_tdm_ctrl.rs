...
#[doc = "Field `RX_TDM_BITS_MODE_DET_EN` reader - 1: Auto detect bit mode in tdm slave mode. 0: Disable."]
pub type RX_TDM_BITS_MODE_DET_EN_R = crate::BitReader;
#[doc = "Field `RX_TDM_BITS_MODE_DET_EN` writer - 1: Auto detect bit mode in tdm slave mode. 0: Disable."]
pub type RX_TDM_BITS_MODE_DET_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 20 - 1: Auto detect bit mode in tdm slave mode. 0: Disable."]
    #[inline(always)]
    pub fn rx_tdm_bits_mode_det_en(&self) -> RX_TDM_BITS_MODE_DET_EN_R {
        RX_TDM_BITS_MODE_DET_EN_R::new(((self.bits >> 20) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_TDM_CTRL")
            ...
            .field("rx_tdm_bits_mode_det_en", &self.rx_tdm_bits_mode_det_en())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 20 - 1: Auto detect bit mode in tdm slave mode. 0: Disable."]
    #[inline(always)]
    pub fn rx_tdm_bits_mode_det_en(&mut self) -> RX_TDM_BITS_MODE_DET_EN_W<'_, RX_TDM_CTRL_SPEC> {
        RX_TDM_BITS_MODE_DET_EN_W::new(self, 20)
    }
}
