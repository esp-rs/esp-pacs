...
#[doc = "Field `TX_SYNC_INT_RAW` reader - The raw interrupt status bit for the i2s_tx_sync_int interrupt"]
pub type TX_SYNC_INT_RAW_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn tx_sync_int_raw(&self) -> TX_SYNC_INT_RAW_R {
        TX_SYNC_INT_RAW_R::new(((self.bits >> 4) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW")
            ...
            .field("tx_sync_int_raw", &self.tx_sync_int_raw())
            .finish()
    }
}
