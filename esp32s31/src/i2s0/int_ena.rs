...
#[doc = "Field `TX_SYNC_INT_ENA` reader - The interrupt enable bit for the i2s_tx_sync_int interrupt"]
pub type TX_SYNC_INT_ENA_R = crate::BitReader;
#[doc = "Field `TX_SYNC_INT_ENA` writer - The interrupt enable bit for the i2s_tx_sync_int interrupt"]
pub type TX_SYNC_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 4 - The interrupt enable bit for the i2s_tx_sync_int interrupt"]
    #[inline(always)]
    pub fn tx_sync_int_ena(&self) -> TX_SYNC_INT_ENA_R {
        TX_SYNC_INT_ENA_R::new(((self.bits >> 4) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            .field("rx_done_int_ena", &self.rx_done_int_ena())
            ...
            .field("tx_sync_int_ena", &self.tx_sync_int_ena())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 4 - The interrupt enable bit for the i2s_tx_sync_int interrupt"]
    #[inline(always)]
    pub fn tx_sync_int_ena(&mut self) -> TX_SYNC_INT_ENA_W<'_, INT_ENA_SPEC> {
        TX_SYNC_INT_ENA_W::new(self, 4)
    }
}
