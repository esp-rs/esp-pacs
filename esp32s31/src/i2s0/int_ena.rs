...
#[doc = "Field `TX_SYNC` reader - The interrupt enable bit for the i2s_tx_sync_int interrupt"]
pub type TX_SYNC_R = crate::BitReader;
#[doc = "Field `TX_SYNC` writer - The interrupt enable bit for the i2s_tx_sync_int interrupt"]
pub type TX_SYNC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn tx_sync(&self) -> TX_SYNC_R {
        TX_SYNC_R::new(((self.bits >> 4) & 1) != 0)
    }
}
...
impl W {
    ...
    #[doc = "Bit 4 - The interrupt enable bit for the i2s_tx_sync_int interrupt"]
    #[inline(always)]
    pub fn tx_sync(&mut self) -> TX_SYNC_W<'_, INT_ENA_SPEC> {
        TX_SYNC_W::new(self, 4)
    }
}
