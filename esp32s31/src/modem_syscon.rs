...
impl RegisterBlock {
    ...
    #[doc = "0x2c - MEM_MODE_CONF"]
    #[inline(always)]
    pub const fn mem_mode_conf(&self) -> &MEM_MODE_CONF {
        &self.mem_mode_conf
    }
    #[doc = "0x30 - DATE"]
    #[inline(always)]
...
#[doc = "MEM_MODE_CONF (rw) register accessor: MEM_MODE_CONF\n\nYou can [`read`](crate::Reg::read) this register and get [`mem_mode_conf::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mem_mode_conf::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mem_mode_conf`] module"]
pub type MEM_MODE_CONF = crate::Reg<mem_mode_conf::MEM_MODE_CONF_SPEC>;
#[doc = "MEM_MODE_CONF"]
