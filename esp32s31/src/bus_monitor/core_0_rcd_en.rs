...
#[doc = "Field `CORE_0_RCD_RECORDEN` reader - Configures whether to enable PC and SP logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG starts to record PC in real time, BUS_MONITOR_CORE_0_RCD_PDEBUGSP_REG starts to record SP in real time\\\\"]
pub type CORE_0_RCD_RECORDEN_R = crate::BitReader;
#[doc = "Field `CORE_0_RCD_RECORDEN` writer - Configures whether to enable PC and SP logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG starts to record PC in real time, BUS_MONITOR_CORE_0_RCD_PDEBUGSP_REG starts to record SP in real time\\\\"]
...
impl W {
    #[doc = "Bit 0 - Configures whether to enable PC and SP logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG starts to record PC in real time, BUS_MONITOR_CORE_0_RCD_PDEBUGSP_REG starts to record SP in real time\\\\"]
    #[inline(always)]
    pub fn core_0_rcd_recorden(&mut self) -> CORE_0_RCD_RECORDEN_W<'_, CORE_0_RCD_EN_SPEC> {
        CORE_0_RCD_RECORDEN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Configures whether to enable HP CPU debugging.\\\\ 0: Disable\\\\ 1: HP CPU outputs PC\\\\"]
    #[inline(always)]
    pub fn core_0_rcd_pdebugen(&mut self) -> CORE_0_RCD_PDEBUGEN_W<'_, CORE_0_RCD_EN_SPEC> {
