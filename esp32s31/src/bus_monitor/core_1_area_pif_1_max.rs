...
#[doc = "Field `CORE_1_AREA_PIF_1_MAX` reader - Configures the upper bound address of Peripheral bus region 1."]
pub type CORE_1_AREA_PIF_1_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_PIF_1_MAX` writer - Configures the upper bound address of Peripheral bus region 1."]
...
impl W {
    #[doc = "Bits 0:31 - Configures the upper bound address of Peripheral bus region 1."]
    #[inline(always)]
    pub fn core_1_area_pif_1_max(
        &mut self,
    ) -> CORE_1_AREA_PIF_1_MAX_W<'_, CORE_1_AREA_PIF_1_MAX_SPEC> {
