...
#[doc = "Field `CORE_1_AREA_DRAM0_0_MIN` reader - Configures the lower bound address of Data bus region 0."]
pub type CORE_1_AREA_DRAM0_0_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_DRAM0_0_MIN` writer - Configures the lower bound address of Data bus region 0."]
