...
impl R {
    #[doc = "Bits 0:29 - reg_core_1_iram0_recording_addr_0"]
    #[inline(always)]
    pub fn core_1_iram0_recording_addr_0(&self) -> CORE_1_IRAM0_RECORDING_ADDR_0_R {
        CORE_1_IRAM0_RECORDING_ADDR_0_R::new(self.bits & 0x3fff_ffff)
    }
    #[doc = "Bit 30 - reg_core_1_iram0_recording_wr_0"]
    #[inline(always)]
    pub fn core_1_iram0_recording_wr_0(&self) -> CORE_1_IRAM0_RECORDING_WR_0_R {
        CORE_1_IRAM0_RECORDING_WR_0_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - reg_core_1_iram0_recording_loadstore_0"]
    #[inline(always)]
    pub fn core_1_iram0_recording_loadstore_0(&self) -> CORE_1_IRAM0_RECORDING_LOADSTORE_0_R {
        CORE_1_IRAM0_RECORDING_LOADSTORE_0_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
#[doc = "exception monitor status register0\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_iram0_exception_monitor_0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
