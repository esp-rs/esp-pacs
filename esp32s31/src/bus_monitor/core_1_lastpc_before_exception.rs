...
#[doc = "Field `CORE_1_LASTPC_BEFORE_EXC` reader - Represents the PC of the last command before the HP CPU enters exception."]
pub type CORE_1_LASTPC_BEFORE_EXC_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the PC of the last command before the HP CPU enters exception."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_LASTPC_BEFORE_EXCEPTION")
            .field("core_1_lastpc_before_exc", &self.core_1_lastpc_before_exc())
            .finish()
    }
}
#[doc = "cpu status register\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_lastpc_before_exception::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
