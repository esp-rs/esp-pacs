...
#[doc = "Field `CORE_1_AREA_DRAM0_0_RD_RAW` reader - The raw interrupt status of read operations in region 0 by Data bus."]
pub type CORE_1_AREA_DRAM0_0_RD_RAW_R = crate::BitReader;
#[doc = "Field `CORE_1_AREA_DRAM0_0_WR_RAW` reader - The raw interrupt status of write operations in region 0 by Data bus."]
pub type CORE_1_AREA_DRAM0_0_WR_RAW_R = crate::BitReader;
#[doc = "Field `CORE_1_AREA_DRAM0_1_RD_RAW` reader - The raw interrupt status of read operations in region 1 by Data bus."]
pub type CORE_1_AREA_DRAM0_1_RD_RAW_R = crate::BitReader;
#[doc = "Field `CORE_1_AREA_DRAM0_1_WR_RAW` reader - The raw interrupt status of write operations in region 1 by Data bus."]
pub type CORE_1_AREA_DRAM0_1_WR_RAW_R = crate::BitReader;
#[doc = "Field `CORE_1_AREA_PIF_0_RD_RAW` reader - The raw interrupt status of read operations in region 0 by Peripheral bus."]
pub type CORE_1_AREA_PIF_0_RD_RAW_R = crate::BitReader;
#[doc = "Field `CORE_1_AREA_PIF_0_WR_RAW` reader - The raw interrupt status of write operations in region 0 by Peripheral bus."]
pub type CORE_1_AREA_PIF_0_WR_RAW_R = crate::BitReader;
#[doc = "Field `CORE_1_AREA_PIF_1_RD_RAW` reader - The raw interrupt status of read operations in region 1 by Peripheral bus."]
pub type CORE_1_AREA_PIF_1_RD_RAW_R = crate::BitReader;
#[doc = "Field `CORE_1_AREA_PIF_1_WR_RAW` reader - The raw interrupt status of write operations in region 1 by Peripheral bus."]
pub type CORE_1_AREA_PIF_1_WR_RAW_R = crate::BitReader;
#[doc = "Field `CORE_1_SP_SPILL_MIN_RAW` reader - The raw interrupt status of SP exceeding the lower bound address of SP monitored region."]
pub type CORE_1_SP_SPILL_MIN_RAW_R = crate::BitReader;
#[doc = "Field `CORE_1_SP_SPILL_MAX_RAW` reader - The raw interrupt status of SP exceeding the upper bound address of SP monitored region."]
