...
#[doc = "Field `CORE_1_RCD_RECORDEN` reader - Configures whether to enable PC and SP logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_1_RCD_PDEBUGPC_REG starts to record PC in real time, BUS_MONITOR_CORE_1_RCD_PDEBUGSP_REG starts to record SP in real time\\\\"]
pub type CORE_1_RCD_RECORDEN_R = crate::BitReader;
#[doc = "Field `CORE_1_RCD_RECORDEN` writer - Configures whether to enable PC and SP logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_1_RCD_PDEBUGPC_REG starts to record PC in real time, BUS_MONITOR_CORE_1_RCD_PDEBUGSP_REG starts to record SP in real time\\\\"]
pub type CORE_1_RCD_RECORDEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_RCD_PDEBUGEN` reader - Configures whether to enable HP CPU debugging.\\\\ 0: Disable\\\\ 1: HP CPU outputs PC\\\\"]
pub type CORE_1_RCD_PDEBUGEN_R = crate::BitReader;
#[doc = "Field `CORE_1_RCD_PDEBUGEN` writer - Configures whether to enable HP CPU debugging.\\\\ 0: Disable\\\\ 1: HP CPU outputs PC\\\\"]
pub type CORE_1_RCD_PDEBUGEN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether to enable PC and SP logging.\\\\ 0: Disable\\\\ 1: ASSIST_DEBUG_CORE_1_RCD_PDEBUGPC_REG starts to record PC in real time, BUS_MONITOR_CORE_1_RCD_PDEBUGSP_REG starts to record SP in real time\\\\"]
    #[inline(always)]
...
#[doc = "HP CPU PC logging enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_rcd_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_1_rcd_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
