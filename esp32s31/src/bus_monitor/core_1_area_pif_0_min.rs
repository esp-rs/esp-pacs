...
pub type R = crate::R<CORE_1_AREA_PIF_0_MIN_SPEC>;
#[doc = "Register `CORE_1_AREA_PIF_0_MIN` writer"]
pub type W = crate::W<CORE_1_AREA_PIF_0_MIN_SPEC>;
#[doc = "Field `CORE_1_AREA_PIF_0_MIN` reader - Configures the lower bound address of Peripheral bus region 0."]
pub type CORE_1_AREA_PIF_0_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_PIF_0_MIN` writer - Configures the lower bound address of Peripheral bus region 0."]
pub type CORE_1_AREA_PIF_0_MIN_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the lower bound address of Peripheral bus region 0."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_AREA_PIF_0_MIN")
            .field("core_1_area_pif_0_min", &self.core_1_area_pif_0_min())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Configures the lower bound address of Peripheral bus region 0."]
    #[inline(always)]
    pub fn core_1_area_pif_0_min(
        &mut self,
    ) -> CORE_1_AREA_PIF_0_MIN_W<'_, CORE_1_AREA_PIF_0_MIN_SPEC> {
        CORE_1_AREA_PIF_0_MIN_W::new(self, 0)
    }
}
#[doc = "Configures lower boundary address of region 0 monitored on Peripheral bus\n\nYou can [`read`](crate::Reg::read) this register and get [`core_1_area_pif_0_min::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core_1_area_pif_0_min::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
