...
#[doc = "Field `CORE_0_AREA_PIF_0_MAX` reader - Configures the upper bound address of Peripheral bus region 0."]
pub type CORE_0_AREA_PIF_0_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_0_AREA_PIF_0_MAX` writer - Configures the upper bound address of Peripheral bus region 0."]
pub type CORE_0_AREA_PIF_0_MAX_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_0_AREA_PIF_0_MAX")
            .field("core_0_area_pif_0_max", &self.core_0_area_pif_0_max())
            .finish()
    }
}
impl W {
