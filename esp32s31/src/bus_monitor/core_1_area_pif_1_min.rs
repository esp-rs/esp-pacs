...
#[doc = "Field `CORE_1_AREA_PIF_1_MIN` reader - Configures the lower bound address of Peripheral bus region 1."]
pub type CORE_1_AREA_PIF_1_MIN_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_AREA_PIF_1_MIN` writer - Configures the lower bound address of Peripheral bus region 1."]
...
impl W {
    #[doc = "Bits 0:31 - Configures the lower bound address of Peripheral bus region 1."]
    #[inline(always)]
    pub fn core_1_area_pif_1_min(
        &mut self,
    ) -> CORE_1_AREA_PIF_1_MIN_W<'_, CORE_1_AREA_PIF_1_MIN_SPEC> {
