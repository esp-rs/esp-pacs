...
#[doc = "Field `CORE_1_SP_SPILL_MIN_INTR_ENA` reader - Core1 stackpoint underflow monitor interrupt enable"]
pub type CORE_1_SP_SPILL_MIN_INTR_ENA_R = crate::BitReader;
#[doc = "Field `CORE_1_SP_SPILL_MIN_INTR_ENA` writer - Core1 stackpoint underflow monitor interrupt enable"]
pub type CORE_1_SP_SPILL_MIN_INTR_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CORE_1_SP_SPILL_MAX_INTR_ENA` reader - Core1 stackpoint overflow monitor interrupt enable"]
pub type CORE_1_SP_SPILL_MAX_INTR_ENA_R = crate::BitReader;
#[doc = "Field `CORE_1_SP_SPILL_MAX_INTR_ENA` writer - Core1 stackpoint overflow monitor interrupt enable"]
...
impl W {
    ...
    pub fn core_1_area_dram0_0_rd_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_0_RD_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_area_dram0_0_wr_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_0_WR_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_area_dram0_1_rd_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_1_RD_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_area_dram0_1_wr_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_DRAM0_1_WR_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_area_pif_0_rd_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_PIF_0_RD_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_area_pif_0_wr_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_PIF_0_WR_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_area_pif_1_rd_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_PIF_1_RD_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_area_pif_1_wr_intr_ena(
        &mut self,
    ) -> CORE_1_AREA_PIF_1_WR_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_sp_spill_min_intr_ena(
        &mut self,
    ) -> CORE_1_SP_SPILL_MIN_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_sp_spill_max_intr_ena(
        &mut self,
    ) -> CORE_1_SP_SPILL_MAX_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_iram0_exception_monitor_intr_ena(
        &mut self,
    ) -> CORE_1_IRAM0_EXCEPTION_MONITOR_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
    ...
    pub fn core_1_dram0_exception_monitor_intr_ena(
        &mut self,
    ) -> CORE_1_DRAM0_EXCEPTION_MONITOR_INTR_ENA_W<'_, CORE_1_INTR_ENA_SPEC> {
