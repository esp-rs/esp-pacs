...
#[doc = "Field `CORE_1_SP_MAX` reader - Configures the upper bound address of SP."]
pub type CORE_1_SP_MAX_R = crate::FieldReader<u32>;
#[doc = "Field `CORE_1_SP_MAX` writer - Configures the upper bound address of SP."]
...
impl W {
    #[doc = "Bits 0:31 - Configures the upper bound address of SP."]
    #[inline(always)]
    pub fn core_1_sp_max(&mut self) -> CORE_1_SP_MAX_W<'_, CORE_1_SP_MAX_SPEC> {
