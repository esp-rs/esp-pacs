...
#[doc = "Field `L1_ICACHE3_AUTOLOAD_ENA` reader - Configures and disable autoload operation on L1-ICache3. 1: enable, 0: disable."]
...
#[doc = "Field `L1_ICACHE3_AUTOLOAD_ORDER` reader - Configures the direction of autoload operation on L1-ICache3. 0: ascending. 1: descending."]
...
#[doc = "Field `L1_ICACHE3_AUTOLOAD_SCT0_ENA` reader - Configures the first section for autoload operation on L1-ICache3."]
pub type L1_ICACHE3_AUTOLOAD_SCT0_ENA_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_AUTOLOAD_SCT1_ENA` reader - Configures the second section for autoload operation on L1-ICache3."]
pub type L1_ICACHE3_AUTOLOAD_SCT1_ENA_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_AUTOLOAD_RGID` reader - Configures the gid of l1 icache3 autoload."]
pub type L1_ICACHE3_AUTOLOAD_RGID_R = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - Configures and disable autoload operation on L1-ICache3. 1: enable, 0: disable."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - Configures the direction of autoload operation on L1-ICache3. 0: ascending. 1: descending."]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Configures the first section for autoload operation on L1-ICache3."]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - Configures the second section for autoload operation on L1-ICache3."]
    #[inline(always)]
    ...
    #[doc = "Bits 10:13 - Configures the gid of l1 icache3 autoload."]
    #[inline(always)]
