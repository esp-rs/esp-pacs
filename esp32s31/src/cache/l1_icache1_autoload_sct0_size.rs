...
pub type W = crate::W<L1_ICACHE1_AUTOLOAD_SCT0_SIZE_SPEC>;
#[doc = "Field `L1_ICACHE1_AUTOLOAD_SCT0_SIZE` reader - Configures the size of the first section for autoload operation on L1-ICache1. Note that it should be used together with L1_ICACHE1_AUTOLOAD_SCT0_ADDR and L1_ICACHE_AUTOLOAD_SCT0_ENA."]
pub type L1_ICACHE1_AUTOLOAD_SCT0_SIZE_R = crate::FieldReader<u32>;
#[doc = "Field `L1_ICACHE1_AUTOLOAD_SCT0_SIZE` writer - Configures the size of the first section for autoload operation on L1-ICache1. Note that it should be used together with L1_ICACHE1_AUTOLOAD_SCT0_ADDR and L1_ICACHE_AUTOLOAD_SCT0_ENA."]
pub type L1_ICACHE1_AUTOLOAD_SCT0_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    #[doc = "Bits 0:27 - Configures the size of the first section for autoload operation on L1-ICache1. Note that it should be used together with L1_ICACHE1_AUTOLOAD_SCT0_ADDR and L1_ICACHE_AUTOLOAD_SCT0_ENA."]
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_icache1_autoload_sct0_size(
        &mut self,
    ) -> L1_ICACHE1_AUTOLOAD_SCT0_SIZE_W<'_, L1_ICACHE1_AUTOLOAD_SCT0_SIZE_SPEC> {
        L1_ICACHE1_AUTOLOAD_SCT0_SIZE_W::new(self, 0)
    }
}
...
impl crate::Writable for L1_ICACHE1_AUTOLOAD_SCT0_SIZE_SPEC {
