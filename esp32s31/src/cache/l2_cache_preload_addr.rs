...
#[doc = "Field `L2_CACHE_PRELOAD_ADDR` reader - Configures the start address of preload on L2-Cache, which should be used together with L2_CACHE_PRELOAD_SIZE_REG"]
pub type L2_CACHE_PRELOAD_ADDR_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the start address of preload on L2-Cache, which should be used together with L2_CACHE_PRELOAD_SIZE_REG"]
    #[inline(always)]
