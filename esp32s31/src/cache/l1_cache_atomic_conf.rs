...
#[doc = "Field `L1_DCACHE_ATOMIC_EN` reader - Configures atomic feature on L1-DCache when multiple cores access L1-DCache. \\\\1: Enable\\\\"]
pub type L1_DCACHE_ATOMIC_EN_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_ATOMIC_EN` writer - Configures atomic feature on L1-DCache when multiple cores access L1-DCache. \\\\1: Enable\\\\"]
pub type L1_DCACHE_ATOMIC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures atomic feature on L1-DCache when multiple cores access L1-DCache. \\\\1: Enable\\\\"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Configures atomic feature on L1-DCache when multiple cores access L1-DCache. \\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_atomic_en(&mut self) -> L1_DCACHE_ATOMIC_EN_W<'_, L1_CACHE_ATOMIC_CONF_SPEC> {
