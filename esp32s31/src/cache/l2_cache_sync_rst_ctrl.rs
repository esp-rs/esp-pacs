...
#[doc = "Field `L2_CACHE_SYNC_RST` reader - Configures reset sync-logic inside L2-Cache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
pub type L2_CACHE_SYNC_RST_R = crate::BitReader;
impl R {
    #[doc = "Bit 5 - Configures reset sync-logic inside L2-Cache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
    #[inline(always)]
