...
#[doc = "Field `L1_DCACHE_PRELOAD_SIZE` reader - Configures the size of the first section of prelock on L1-DCache, which should be used together with L1_DCACHE_PRELOAD_ADDR_REG"]
pub type L1_DCACHE_PRELOAD_SIZE_R = crate::FieldReader<u16>;
#[doc = "Field `L1_DCACHE_PRELOAD_SIZE` writer - Configures the size of the first section of prelock on L1-DCache, which should be used together with L1_DCACHE_PRELOAD_ADDR_REG"]
pub type L1_DCACHE_PRELOAD_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    #[doc = "Bits 0:13 - Configures the size of the first section of prelock on L1-DCache, which should be used together with L1_DCACHE_PRELOAD_ADDR_REG"]
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_dcache_preload_size(
        &mut self,
    ) -> L1_DCACHE_PRELOAD_SIZE_W<'_, L1_DCACHE_PRELOAD_SIZE_SPEC> {
