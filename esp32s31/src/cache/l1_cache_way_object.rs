...
#[doc = "Field `L1_CACHE_WAY_OBJECT` reader - Configures way of the tag-object will be accessed. \\\\1: way1\\\\"]
pub type L1_CACHE_WAY_OBJECT_R = crate::FieldReader;
#[doc = "Field `L1_CACHE_WAY_OBJECT` writer - Configures way of the tag-object will be accessed. \\\\1: way1\\\\"]
pub type L1_CACHE_WAY_OBJECT_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:2 - Configures way of the tag-object will be accessed. \\\\1: way1\\\\"]
    #[inline(always)]
