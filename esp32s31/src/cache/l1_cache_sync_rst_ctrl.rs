...
#[doc = "Field `L1_ICACHE0_SYNC_RST` reader - Configures reset sync-logic inside L1-ICache0. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
pub type L1_ICACHE0_SYNC_RST_R = crate::BitReader;
#[doc = "Field `L1_ICACHE0_SYNC_RST` writer - Configures reset sync-logic inside L1-ICache0. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
pub type L1_ICACHE0_SYNC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE1_SYNC_RST` reader - Configures reset sync-logic inside L1-ICache1. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
pub type L1_ICACHE1_SYNC_RST_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_SYNC_RST` writer - Configures reset sync-logic inside L1-ICache1. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
...
#[doc = "Field `L1_ICACHE2_SYNC_RST` writer - Reserved"]
pub type L1_ICACHE2_SYNC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE3_SYNC_RST` reader - Reserved"]
pub type L1_ICACHE3_SYNC_RST_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_SYNC_RST` writer - Reserved"]
pub type L1_ICACHE3_SYNC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_SYNC_RST` reader - Configures reset sync-logic inside L1-DCache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
pub type L1_DCACHE_SYNC_RST_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_SYNC_RST` writer - Configures reset sync-logic inside L1-DCache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
pub type L1_DCACHE_SYNC_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures reset sync-logic inside L1-ICache0. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
    #[inline(always)]
    pub fn l1_icache0_sync_rst(&self) -> L1_ICACHE0_SYNC_RST_R {
        L1_ICACHE0_SYNC_RST_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures reset sync-logic inside L1-ICache1. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Configures reset sync-logic inside L1-DCache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn l1_icache2_sync_rst(
        &mut self,
    ) -> L1_ICACHE2_SYNC_RST_W<'_, L1_CACHE_SYNC_RST_CTRL_SPEC> {
        L1_ICACHE2_SYNC_RST_W::new(self, 2)
    }
    #[doc = "Bit 3 - Reserved"]
    #[inline(always)]
    pub fn l1_icache3_sync_rst(
        &mut self,
    ) -> L1_ICACHE3_SYNC_RST_W<'_, L1_CACHE_SYNC_RST_CTRL_SPEC> {
        L1_ICACHE3_SYNC_RST_W::new(self, 3)
    }
    #[doc = "Bit 4 - Configures reset sync-logic inside L1-DCache. Recommend that this should only be used to initialize sync-logic when some fatal error of sync-logic occurs."]
    #[inline(always)]
