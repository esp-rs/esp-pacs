...
#[doc = "Register `L1_ICACHE0_PRELOCK_SCT_SIZE` writer"]
pub type W = crate::W<L1_ICACHE0_PRELOCK_SCT_SIZE_SPEC>;
#[doc = "Field `L1_ICACHE0_PRELOCK_SCT0_SIZE` reader - Configures the size of the first section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT0_ADDR_REG"]
pub type L1_ICACHE0_PRELOCK_SCT0_SIZE_R = crate::FieldReader<u16>;
#[doc = "Field `L1_ICACHE0_PRELOCK_SCT0_SIZE` writer - Configures the size of the first section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT0_ADDR_REG"]
pub type L1_ICACHE0_PRELOCK_SCT0_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
#[doc = "Field `L1_ICACHE0_PRELOCK_SCT1_SIZE` reader - Configures the size of the second section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT1_ADDR_REG"]
pub type L1_ICACHE0_PRELOCK_SCT1_SIZE_R = crate::FieldReader<u16>;
#[doc = "Field `L1_ICACHE0_PRELOCK_SCT1_SIZE` writer - Configures the size of the second section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT1_ADDR_REG"]
pub type L1_ICACHE0_PRELOCK_SCT1_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    #[doc = "Bits 0:13 - Configures the size of the first section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT0_ADDR_REG"]
    #[inline(always)]
    ...
    #[doc = "Bits 16:29 - Configures the size of the second section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT1_ADDR_REG"]
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_icache0_prelock_sct0_size(
        &mut self,
    ) -> L1_ICACHE0_PRELOCK_SCT0_SIZE_W<'_, L1_ICACHE0_PRELOCK_SCT_SIZE_SPEC> {
