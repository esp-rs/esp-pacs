...
#[doc = "Field `L1_ICACHE1_PRELOAD_ADDR` reader - Configures the start address of preload on L1-ICache1, which should be used together with L1_ICACHE1_PRELOAD_SIZE_REG"]
pub type L1_ICACHE1_PRELOAD_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `L1_ICACHE1_PRELOAD_ADDR` writer - Configures the start address of preload on L1-ICache1, which should be used together with L1_ICACHE1_PRELOAD_SIZE_REG"]
pub type L1_ICACHE1_PRELOAD_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the start address of preload on L1-ICache1, which should be used together with L1_ICACHE1_PRELOAD_SIZE_REG"]
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_icache1_preload_addr(
        &mut self,
    ) -> L1_ICACHE1_PRELOAD_ADDR_W<'_, L1_ICACHE1_PRELOAD_ADDR_SPEC> {
