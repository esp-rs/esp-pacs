...
#[doc = "Field `BYPASS_L1_ICACHE0_EN` reader - Configures bypass L1-ICache0. \\\\1: Enable\\\\"]
pub type BYPASS_L1_ICACHE0_EN_R = crate::BitReader;
#[doc = "Field `BYPASS_L1_ICACHE0_EN` writer - Configures bypass L1-ICache0. \\\\1: Enable\\\\"]
pub type BYPASS_L1_ICACHE0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BYPASS_L1_ICACHE1_EN` reader - Configures bypass L1-ICache1. \\\\1: Enable\\\\"]
pub type BYPASS_L1_ICACHE1_EN_R = crate::BitReader;
#[doc = "Field `BYPASS_L1_ICACHE1_EN` writer - Configures bypass L1-ICache1. \\\\1: Enable\\\\"]
...
#[doc = "Field `BYPASS_L1_DCACHE_EN` reader - Configures bypass L1-DCache. \\\\1: Enable\\\\"]
pub type BYPASS_L1_DCACHE_EN_R = crate::BitReader;
#[doc = "Field `BYPASS_L1_DCACHE_EN` writer - Configures bypass L1-DCache. \\\\1: Enable\\\\"]
pub type BYPASS_L1_DCACHE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures bypass L1-ICache0. \\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn bypass_l1_icache0_en(&self) -> BYPASS_L1_ICACHE0_EN_R {
        BYPASS_L1_ICACHE0_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures bypass L1-ICache1. \\\\1: Enable\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Configures bypass L1-DCache. \\\\1: Enable\\\\"]
    #[inline(always)]
