...
#[doc = "Field `L1_ICACHE3_PRELOAD_ADDR` reader - Configures the start address of preload on L1-ICache3, which should be used together with L1_ICACHE3_PRELOAD_SIZE_REG"]
pub type L1_ICACHE3_PRELOAD_ADDR_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the start address of preload on L1-ICache3, which should be used together with L1_ICACHE3_PRELOAD_SIZE_REG"]
    #[inline(always)]
