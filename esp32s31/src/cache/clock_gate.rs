...
#[doc = "Field `CLK_EN` reader - Configures clock gate when access all registers in this module."]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Configures clock gate when access all registers in this module."]
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures clock gate when access all registers in this module."]
    #[inline(always)]
