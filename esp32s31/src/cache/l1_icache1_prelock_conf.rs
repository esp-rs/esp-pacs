...
#[doc = "Register `L1_ICACHE1_PRELOCK_CONF` writer"]
pub type W = crate::W<L1_ICACHE1_PRELOCK_CONF_SPEC>;
#[doc = "Field `L1_ICACHE1_PRELOCK_SCT0_EN` reader - Configures whether to enable the prelocking function in Section 0 of icache.\\\\1: Enable\\\\"]
pub type L1_ICACHE1_PRELOCK_SCT0_EN_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_PRELOCK_SCT0_EN` writer - Configures whether to enable the prelocking function in Section 0 of icache.\\\\1: Enable\\\\"]
pub type L1_ICACHE1_PRELOCK_SCT0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE1_PRELOCK_SCT1_EN` reader - Configures whether to enable the prelocking function in Section 1 of icache.\\\\1: Enable\\\\"]
pub type L1_ICACHE1_PRELOCK_SCT1_EN_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_PRELOCK_SCT1_EN` writer - Configures whether to enable the prelocking function in Section 1 of icache.\\\\1: Enable\\\\"]
pub type L1_ICACHE1_PRELOCK_SCT1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE1_PRELOCK_RGID` reader - Configures the gid of l1 icache1 prelock."]
pub type L1_ICACHE1_PRELOCK_RGID_R = crate::FieldReader;
#[doc = "Field `L1_ICACHE1_PRELOCK_RGID` writer - Configures the gid of l1 icache1 prelock."]
pub type L1_ICACHE1_PRELOCK_RGID_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ...
    #[doc = "Bits 2:5 - Configures the gid of l1 icache1 prelock."]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Configures whether to enable the prelocking function in Section 0 of icache.\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_icache1_prelock_sct0_en(
        &mut self,
    ) -> L1_ICACHE1_PRELOCK_SCT0_EN_W<'_, L1_ICACHE1_PRELOCK_CONF_SPEC> {
        L1_ICACHE1_PRELOCK_SCT0_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Configures whether to enable the prelocking function in Section 1 of icache.\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_icache1_prelock_sct1_en(
        &mut self,
    ) -> L1_ICACHE1_PRELOCK_SCT1_EN_W<'_, L1_ICACHE1_PRELOCK_CONF_SPEC> {
        L1_ICACHE1_PRELOCK_SCT1_EN_W::new(self, 1)
    }
    #[doc = "Bits 2:5 - Configures the gid of l1 icache1 prelock."]
    #[inline(always)]
    pub fn l1_icache1_prelock_rgid(
        &mut self,
    ) -> L1_ICACHE1_PRELOCK_RGID_W<'_, L1_ICACHE1_PRELOCK_CONF_SPEC> {
...
#[doc = "`write(|w| ..)` method takes [`l1_icache1_prelock_conf::W`](W) writer structure"]
impl crate::Writable for L1_ICACHE1_PRELOCK_CONF_SPEC {
