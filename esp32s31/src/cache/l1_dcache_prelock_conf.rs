...
#[doc = "Field `L1_DCACHE_PRELOCK_SCT0_EN` reader - Configures whether to enable the prelocking function in Section 0 of dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_PRELOCK_SCT0_EN_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_PRELOCK_SCT0_EN` writer - Configures whether to enable the prelocking function in Section 0 of dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_PRELOCK_SCT0_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_PRELOCK_SCT1_EN` reader - Configures whether to enable the prelocking function in Section 1 of dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_PRELOCK_SCT1_EN_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_PRELOCK_SCT1_EN` writer - Configures whether to enable the prelocking function in Section 1 of dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_PRELOCK_SCT1_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_PRELOCK_RGID` reader - Configures the gid of l1 dcache prelock."]
pub type L1_DCACHE_PRELOCK_RGID_R = crate::FieldReader;
#[doc = "Field `L1_DCACHE_PRELOCK_RGID` writer - Configures the gid of l1 dcache prelock."]
pub type L1_DCACHE_PRELOCK_RGID_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bit 0 - Configures whether to enable the prelocking function in Section 0 of dcache.\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_prelock_sct0_en(&self) -> L1_DCACHE_PRELOCK_SCT0_EN_R {
        L1_DCACHE_PRELOCK_SCT0_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures whether to enable the prelocking function in Section 1 of dcache.\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_prelock_sct1_en(&self) -> L1_DCACHE_PRELOCK_SCT1_EN_R {
        L1_DCACHE_PRELOCK_SCT1_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:5 - Configures the gid of l1 dcache prelock."]
    #[inline(always)]
