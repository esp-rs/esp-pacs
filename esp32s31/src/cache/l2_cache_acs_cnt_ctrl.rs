...
#[doc = "Field `L2_IBUS0_CNT_ENA` reader - Configures ibus0 counter in L2-Cache."]
pub type L2_IBUS0_CNT_ENA_R = crate::BitReader;
#[doc = "Field `L2_IBUS1_CNT_ENA` reader - Configures ibus1 counter in L2-Cache."]
...
#[doc = "Field `L2_DBUS0_CNT_ENA` reader - Configures dbus0 counter in L2-Cache."]
pub type L2_DBUS0_CNT_ENA_R = crate::BitReader;
#[doc = "Field `L2_DBUS1_CNT_ENA` reader - Configures dbus1 counter in L2-Cache."]
...
impl R {
    #[doc = "Bit 8 - Configures ibus0 counter in L2-Cache."]
    #[inline(always)]
    pub fn l2_ibus0_cnt_ena(&self) -> L2_IBUS0_CNT_ENA_R {
        L2_IBUS0_CNT_ENA_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Configures ibus1 counter in L2-Cache."]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Configures dbus0 counter in L2-Cache."]
    #[inline(always)]
    pub fn l2_dbus0_cnt_ena(&self) -> L2_DBUS0_CNT_ENA_R {
        L2_DBUS0_CNT_ENA_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Configures dbus1 counter in L2-Cache."]
    #[inline(always)]
