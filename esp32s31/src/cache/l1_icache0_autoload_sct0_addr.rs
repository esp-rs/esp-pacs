...
#[doc = "Field `L1_ICACHE0_AUTOLOAD_SCT0_ADDR` reader - Configures the start address of the first section for autoload operation on L1-ICache0. Note that it should be used together with L1_ICACHE0_AUTOLOAD_SCT0_SIZE and L1_ICACHE_AUTOLOAD_SCT0_ENA."]
pub type L1_ICACHE0_AUTOLOAD_SCT0_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `L1_ICACHE0_AUTOLOAD_SCT0_ADDR` writer - Configures the start address of the first section for autoload operation on L1-ICache0. Note that it should be used together with L1_ICACHE0_AUTOLOAD_SCT0_SIZE and L1_ICACHE_AUTOLOAD_SCT0_ENA."]
pub type L1_ICACHE0_AUTOLOAD_SCT0_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the start address of the first section for autoload operation on L1-ICache0. Note that it should be used together with L1_ICACHE0_AUTOLOAD_SCT0_SIZE and L1_ICACHE_AUTOLOAD_SCT0_ENA."]
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_icache0_autoload_sct0_addr(
        &mut self,
    ) -> L1_ICACHE0_AUTOLOAD_SCT0_ADDR_W<'_, L1_ICACHE0_AUTOLOAD_SCT0_ADDR_SPEC> {
