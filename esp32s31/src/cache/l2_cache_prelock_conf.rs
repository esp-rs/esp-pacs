...
#[doc = "Field `L2_CACHE_PRELOCK_SCT0_EN` reader - Configures the first section of prelock function on L2-Cache."]
pub type L2_CACHE_PRELOCK_SCT0_EN_R = crate::BitReader;
#[doc = "Field `L2_CACHE_PRELOCK_SCT1_EN` reader - Configures the second section of prelock function on L2-Cache."]
pub type L2_CACHE_PRELOCK_SCT1_EN_R = crate::BitReader;
#[doc = "Field `L2_CACHE_PRELOCK_RGID` reader - Configures the gid of l2 cache prelock."]
pub type L2_CACHE_PRELOCK_RGID_R = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - Configures the first section of prelock function on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_prelock_sct0_en(&self) -> L2_CACHE_PRELOCK_SCT0_EN_R {
        L2_CACHE_PRELOCK_SCT0_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures the second section of prelock function on L2-Cache."]
    #[inline(always)]
    pub fn l2_cache_prelock_sct1_en(&self) -> L2_CACHE_PRELOCK_SCT1_EN_R {
        L2_CACHE_PRELOCK_SCT1_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:5 - Configures the gid of l2 cache prelock."]
    #[inline(always)]
