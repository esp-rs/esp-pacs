...
#[doc = "Register `L1_ICACHE0_PRELOCK_SCT1_ADDR` writer"]
pub type W = crate::W<L1_ICACHE0_PRELOCK_SCT1_ADDR_SPEC>;
#[doc = "Field `L1_ICACHE0_PRELOCK_SCT1_ADDR` reader - Configures the start address of the second section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT1_SIZE_REG"]
pub type L1_ICACHE0_PRELOCK_SCT1_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `L1_ICACHE0_PRELOCK_SCT1_ADDR` writer - Configures the start address of the second section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT1_SIZE_REG"]
pub type L1_ICACHE0_PRELOCK_SCT1_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the start address of the second section of prelock on L1-ICache0, which should be used together with L1_ICACHE0_PRELOCK_SCT1_SIZE_REG"]
    #[inline(always)]
...
impl W {
    ...
    pub fn l1_icache0_prelock_sct1_addr(
        &mut self,
    ) -> L1_ICACHE0_PRELOCK_SCT1_ADDR_W<'_, L1_ICACHE0_PRELOCK_SCT1_ADDR_SPEC> {
        L1_ICACHE0_PRELOCK_SCT1_ADDR_W::new(self, 0)
    }
}
#[doc = "L1 instruction Cache 0 prelock section1 address configure register\n\nYou can [`read`](crate::Reg::read) this register and get [`l1_icache0_prelock_sct1_addr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l1_icache0_prelock_sct1_addr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`l1_icache0_prelock_sct1_addr::W`](W) writer structure"]
