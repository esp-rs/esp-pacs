...
#[doc = "Field `L2_CACHE_WAY_OBJECT` reader - Configures way of the tag-object will be accessed. \\\\7: way7\\\\"]
pub type L2_CACHE_WAY_OBJECT_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:2 - Configures way of the tag-object will be accessed. \\\\7: way7\\\\"]
    #[inline(always)]
