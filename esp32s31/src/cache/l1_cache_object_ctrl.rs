...
#[doc = "Field `L1_ICACHE0_TAG_OBJECT` reader - Configures set L1-ICache0 tag memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_ICACHE0_TAG_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_ICACHE0_TAG_OBJECT` writer - Configures set L1-ICache0 tag memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_ICACHE0_TAG_OBJECT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE1_TAG_OBJECT` reader - Configures set L1-ICache1 tag memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_ICACHE1_TAG_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_TAG_OBJECT` writer - Configures set L1-ICache1 tag memory as object. This bit should be onehot with the others fields inside this register."]
...
#[doc = "Field `L1_ICACHE2_TAG_OBJECT` writer - Reserved"]
pub type L1_ICACHE2_TAG_OBJECT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE3_TAG_OBJECT` reader - Reserved"]
pub type L1_ICACHE3_TAG_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_TAG_OBJECT` writer - Reserved"]
pub type L1_ICACHE3_TAG_OBJECT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_TAG_OBJECT` reader - Configures set L1-DCache tag memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_DCACHE_TAG_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_TAG_OBJECT` writer - Configures set L1-DCache tag memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_DCACHE_TAG_OBJECT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE0_MEM_OBJECT` reader - Configures set L1-ICache0 data memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_ICACHE0_MEM_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_ICACHE0_MEM_OBJECT` writer - Configures set L1-ICache0 data memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_ICACHE0_MEM_OBJECT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE1_MEM_OBJECT` reader - Configures set L1-ICache1 data memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_ICACHE1_MEM_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_MEM_OBJECT` writer - Configures set L1-ICache1 data memory as object. This bit should be onehot with the others fields inside this register."]
...
#[doc = "Field `L1_ICACHE2_MEM_OBJECT` writer - Reserved"]
pub type L1_ICACHE2_MEM_OBJECT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE3_MEM_OBJECT` reader - Reserved"]
pub type L1_ICACHE3_MEM_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_MEM_OBJECT` writer - Reserved"]
pub type L1_ICACHE3_MEM_OBJECT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_MEM_OBJECT` reader - Configures set L1-DCache data memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_DCACHE_MEM_OBJECT_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_MEM_OBJECT` writer - Configures set L1-DCache data memory as object. This bit should be onehot with the others fields inside this register."]
pub type L1_DCACHE_MEM_OBJECT_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures set L1-ICache0 tag memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
    pub fn l1_icache0_tag_object(&self) -> L1_ICACHE0_TAG_OBJECT_R {
        L1_ICACHE0_TAG_OBJECT_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures set L1-ICache1 tag memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Configures set L1-DCache tag memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
    pub fn l1_dcache_tag_object(&self) -> L1_DCACHE_TAG_OBJECT_R {
        L1_DCACHE_TAG_OBJECT_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 6 - Configures set L1-ICache0 data memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
    pub fn l1_icache0_mem_object(&self) -> L1_ICACHE0_MEM_OBJECT_R {
        L1_ICACHE0_MEM_OBJECT_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Configures set L1-ICache1 data memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - Configures set L1-DCache data memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn l1_icache2_tag_object(
        &mut self,
    ) -> L1_ICACHE2_TAG_OBJECT_W<'_, L1_CACHE_OBJECT_CTRL_SPEC> {
        L1_ICACHE2_TAG_OBJECT_W::new(self, 2)
    }
    #[doc = "Bit 3 - Reserved"]
    #[inline(always)]
    pub fn l1_icache3_tag_object(
        &mut self,
    ) -> L1_ICACHE3_TAG_OBJECT_W<'_, L1_CACHE_OBJECT_CTRL_SPEC> {
        L1_ICACHE3_TAG_OBJECT_W::new(self, 3)
    }
    #[doc = "Bit 4 - Configures set L1-DCache tag memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Reserved"]
    #[inline(always)]
    pub fn l1_icache2_mem_object(
        &mut self,
    ) -> L1_ICACHE2_MEM_OBJECT_W<'_, L1_CACHE_OBJECT_CTRL_SPEC> {
        L1_ICACHE2_MEM_OBJECT_W::new(self, 8)
    }
    #[doc = "Bit 9 - Reserved"]
    #[inline(always)]
    pub fn l1_icache3_mem_object(
        &mut self,
    ) -> L1_ICACHE3_MEM_OBJECT_W<'_, L1_CACHE_OBJECT_CTRL_SPEC> {
        L1_ICACHE3_MEM_OBJECT_W::new(self, 9)
    }
    #[doc = "Bit 10 - Configures set L1-DCache data memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
