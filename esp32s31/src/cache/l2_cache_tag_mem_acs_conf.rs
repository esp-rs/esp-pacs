...
#[doc = "Field `L2_CACHE_TAG_MEM_RD_EN` reader - Configures config-bus read L2-Cache tag memoryory. 0: disable, 1: enable."]
pub type L2_CACHE_TAG_MEM_RD_EN_R = crate::BitReader;
#[doc = "Field `L2_CACHE_TAG_MEM_WR_EN` reader - Configures config-bus write L2-Cache tag memoryory. 0: disable, 1: enable."]
pub type L2_CACHE_TAG_MEM_WR_EN_R = crate::BitReader;
impl R {
    #[doc = "Bit 20 - Configures config-bus read L2-Cache tag memoryory. 0: disable, 1: enable."]
    #[inline(always)]
    pub fn l2_cache_tag_mem_rd_en(&self) -> L2_CACHE_TAG_MEM_RD_EN_R {
        L2_CACHE_TAG_MEM_RD_EN_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Configures config-bus write L2-Cache tag memoryory. 0: disable, 1: enable."]
    #[inline(always)]
