...
#[doc = "Field `SYNC_SIZE` reader - Configures the size of the sync operation, which should be used together with CACHE_SYNC_ADDR_REG"]
pub type SYNC_SIZE_R = crate::FieldReader<u32>;
#[doc = "Field `SYNC_SIZE` writer - Configures the size of the sync operation, which should be used together with CACHE_SYNC_ADDR_REG"]
pub type SYNC_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    #[doc = "Bits 0:27 - Configures the size of the sync operation, which should be used together with CACHE_SYNC_ADDR_REG"]
    #[inline(always)]
