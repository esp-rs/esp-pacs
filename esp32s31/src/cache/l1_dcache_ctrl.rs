...
#[doc = "Field `L1_DCACHE_SHUT_DBUS0` reader - Configures whether to disable DBUS0 to access dcache.\\\\1: Disable\\\\"]
pub type L1_DCACHE_SHUT_DBUS0_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_SHUT_DBUS0` writer - Configures whether to disable DBUS0 to access dcache.\\\\1: Disable\\\\"]
pub type L1_DCACHE_SHUT_DBUS0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_SHUT_DBUS1` reader - Configures whether to disable DBUS1 to access dcache.\\\\1: Disable\\\\"]
pub type L1_DCACHE_SHUT_DBUS1_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_SHUT_DBUS1` writer - Configures whether to disable DBUS1 to access dcache.\\\\1: Disable\\\\"]
pub type L1_DCACHE_SHUT_DBUS1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_SHUT_DBUS2` reader - Configures whether to disable DBUS2 to access ROM cache.\\\\1: Disable\\\\"]
pub type L1_DCACHE_SHUT_DBUS2_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_SHUT_DBUS2` writer - Configures whether to disable DBUS2 to access ROM cache.\\\\1: Disable\\\\"]
pub type L1_DCACHE_SHUT_DBUS2_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_SHUT_DBUS3` reader - Configures whether to disable DBUS3 to access ROM cache.\\\\1: Disable\\\\"]
pub type L1_DCACHE_SHUT_DBUS3_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_SHUT_DBUS3` writer - Configures whether to disable DBUS3 to access ROM cache.\\\\1: Disable\\\\"]
pub type L1_DCACHE_SHUT_DBUS3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 0 - Configures whether to disable DBUS0 to access dcache.\\\\1: Disable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_shut_dbus0(&self) -> L1_DCACHE_SHUT_DBUS0_R {
        L1_DCACHE_SHUT_DBUS0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures whether to disable DBUS1 to access dcache.\\\\1: Disable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_shut_dbus1(&self) -> L1_DCACHE_SHUT_DBUS1_R {
        L1_DCACHE_SHUT_DBUS1_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Configures whether to disable DBUS2 to access ROM cache.\\\\1: Disable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_shut_dbus2(&self) -> L1_DCACHE_SHUT_DBUS2_R {
        L1_DCACHE_SHUT_DBUS2_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Configures whether to disable DBUS3 to access ROM cache.\\\\1: Disable\\\\"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 2 - Configures whether to disable DBUS2 to access ROM cache.\\\\1: Disable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_shut_dbus2(&mut self) -> L1_DCACHE_SHUT_DBUS2_W<'_, L1_DCACHE_CTRL_SPEC> {
        L1_DCACHE_SHUT_DBUS2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Configures whether to disable DBUS3 to access ROM cache.\\\\1: Disable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_shut_dbus3(&mut self) -> L1_DCACHE_SHUT_DBUS3_W<'_, L1_DCACHE_CTRL_SPEC> {
        L1_DCACHE_SHUT_DBUS3_W::new(self, 3)
    }
    #[doc = "Bit 4 - The bit is used to disable DMA access L1-DCache, 0: enable, 1: disable"]
    #[inline(always)]
