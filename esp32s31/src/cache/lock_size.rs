...
#[doc = "Field `LOCK_SIZE` reader - Configures the size of the lock/unlock operation, which should be used together with CACHE_LOCK_ADDR_REG"]
pub type LOCK_SIZE_R = crate::FieldReader<u16>;
#[doc = "Field `LOCK_SIZE` writer - Configures the size of the lock/unlock operation, which should be used together with CACHE_LOCK_ADDR_REG"]
pub type LOCK_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Configures the size of the lock/unlock operation, which should be used together with CACHE_LOCK_ADDR_REG"]
    #[inline(always)]
