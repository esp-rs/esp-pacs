...
#[doc = "Field `L2_CACHE_AUTOLOAD_ENA` reader - Configures and disable autoload operation on L2-Cache. 1: enable, 0: disable."]
...
#[doc = "Field `L2_CACHE_AUTOLOAD_ORDER` reader - Configures the direction of autoload operation on L2-Cache. 0: ascending. 1: descending."]
...
#[doc = "Field `L2_CACHE_AUTOLOAD_SCT0_ENA` reader - Configures the first section for autoload operation on L2-Cache."]
pub type L2_CACHE_AUTOLOAD_SCT0_ENA_R = crate::BitReader;
#[doc = "Field `L2_CACHE_AUTOLOAD_SCT1_ENA` reader - Configures the second section for autoload operation on L2-Cache."]
pub type L2_CACHE_AUTOLOAD_SCT1_ENA_R = crate::BitReader;
#[doc = "Field `L2_CACHE_AUTOLOAD_SCT2_ENA` reader - Configures the third section for autoload operation on L2-Cache."]
pub type L2_CACHE_AUTOLOAD_SCT2_ENA_R = crate::BitReader;
#[doc = "Field `L2_CACHE_AUTOLOAD_SCT3_ENA` reader - Configures the fourth section for autoload operation on L2-Cache."]
pub type L2_CACHE_AUTOLOAD_SCT3_ENA_R = crate::BitReader;
#[doc = "Field `L2_CACHE_AUTOLOAD_RGID` reader - Configures the gid of l2 cache autoload."]
pub type L2_CACHE_AUTOLOAD_RGID_R = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - Configures and disable autoload operation on L2-Cache. 1: enable, 0: disable."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - Configures the direction of autoload operation on L2-Cache. 0: ascending. 1: descending."]
    #[inline(always)]
