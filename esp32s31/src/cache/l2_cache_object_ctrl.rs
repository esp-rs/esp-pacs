...
#[doc = "Field `L2_CACHE_TAG_OBJECT` reader - Configures set L2-Cache tag memory as object. This bit should be onehot with the others fields inside this register."]
pub type L2_CACHE_TAG_OBJECT_R = crate::BitReader;
#[doc = "Field `L2_CACHE_MEM_OBJECT` reader - Configures set L2-Cache data memory as object. This bit should be onehot with the others fields inside this register."]
pub type L2_CACHE_MEM_OBJECT_R = crate::BitReader;
impl R {
    #[doc = "Bit 5 - Configures set L2-Cache tag memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
    pub fn l2_cache_tag_object(&self) -> L2_CACHE_TAG_OBJECT_R {
        L2_CACHE_TAG_OBJECT_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 11 - Configures set L2-Cache data memory as object. This bit should be onehot with the others fields inside this register."]
    #[inline(always)]
