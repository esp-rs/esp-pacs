...
#[doc = "Field `SYNC_MAP` reader - Configures which cache to perform the locking or the unlocking operation.\\\\Other bits: Reserved\\\\"]
pub type SYNC_MAP_R = crate::FieldReader;
#[doc = "Field `SYNC_MAP` writer - Configures which cache to perform the locking or the unlocking operation.\\\\Other bits: Reserved\\\\"]
pub type SYNC_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    #[doc = "Bits 0:5 - Configures which cache to perform the locking or the unlocking operation.\\\\Other bits: Reserved\\\\"]
    #[inline(always)]
