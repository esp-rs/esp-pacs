...
#[doc = "Field `L2_CACHE_FAIL_INT_ENA` reader - Configures interrupt of access fail that occurs in L2-Cache due to l1 cache accesses L2-Cache."]
pub type L2_CACHE_FAIL_INT_ENA_R = crate::BitReader;
impl R {
    #[doc = "Bit 5 - Configures interrupt of access fail that occurs in L2-Cache due to l1 cache accesses L2-Cache."]
    #[inline(always)]
