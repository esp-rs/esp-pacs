...
#[doc = "Field `L2_CACHE_PLD_DONE_INT_ENA` reader - Configures interrupt of L2-Cache preload-operation done."]
pub type L2_CACHE_PLD_DONE_INT_ENA_R = crate::BitReader;
#[doc = "Field `L2_CACHE_PLD_ERR_INT_ENA` reader - Configures interrupt of L2-Cache preload-operation error."]
pub type L2_CACHE_PLD_ERR_INT_ENA_R = crate::BitReader;
impl R {
    #[doc = "Bit 5 - Configures interrupt of L2-Cache preload-operation done."]
    #[inline(always)]
    pub fn l2_cache_pld_done_int_ena(&self) -> L2_CACHE_PLD_DONE_INT_ENA_R {
        L2_CACHE_PLD_DONE_INT_ENA_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 12 - Configures interrupt of L2-Cache preload-operation error."]
    #[inline(always)]
