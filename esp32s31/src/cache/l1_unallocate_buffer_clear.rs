...
#[doc = "Field `L1_ICACHE2_UNALLOC_CLR` writer - Reserved"]
pub type L1_ICACHE2_UNALLOC_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE3_UNALLOC_CLR` reader - Reserved"]
pub type L1_ICACHE3_UNALLOC_CLR_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_UNALLOC_CLR` writer - Reserved"]
pub type L1_ICACHE3_UNALLOC_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn l1_icache2_unalloc_clr(
        &mut self,
    ) -> L1_ICACHE2_UNALLOC_CLR_W<'_, L1_UNALLOCATE_BUFFER_CLEAR_SPEC> {
        L1_ICACHE2_UNALLOC_CLR_W::new(self, 2)
    }
    #[doc = "Bit 3 - Reserved"]
    #[inline(always)]
    pub fn l1_icache3_unalloc_clr(
        &mut self,
    ) -> L1_ICACHE3_UNALLOC_CLR_W<'_, L1_UNALLOCATE_BUFFER_CLEAR_SPEC> {
        L1_ICACHE3_UNALLOC_CLR_W::new(self, 3)
    }
    #[doc = "Bit 4 - The bit is used to clear the unallocate request buffer of l1 dcache where the unallocate request is responsed but not completed."]
    #[inline(always)]
