...
#[doc = "Field `L1_ICACHE0_WRAP` reader - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
pub type L1_ICACHE0_WRAP_R = crate::BitReader;
#[doc = "Field `L1_ICACHE0_WRAP` writer - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
pub type L1_ICACHE0_WRAP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE1_WRAP` reader - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
pub type L1_ICACHE1_WRAP_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_WRAP` writer - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
...
#[doc = "Field `L1_DCACHE_WRAP` reader - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
pub type L1_DCACHE_WRAP_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_WRAP` writer - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
pub type L1_DCACHE_WRAP_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_icache0_wrap(&self) -> L1_ICACHE0_WRAP_R {
        L1_ICACHE0_WRAP_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_icache0_wrap(&mut self) -> L1_ICACHE0_WRAP_W<'_, L1_CACHE_WRAP_AROUND_CTRL_SPEC> {
        L1_ICACHE0_WRAP_W::new(self, 0)
    }
    #[doc = "Bit 1 - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_icache1_wrap(&mut self) -> L1_ICACHE1_WRAP_W<'_, L1_CACHE_WRAP_AROUND_CTRL_SPEC> {
        L1_ICACHE1_WRAP_W::new(self, 1)
    }
    #[doc = "Bit 4 - Configures whether to enable the critical word first function.\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_wrap(&mut self) -> L1_DCACHE_WRAP_W<'_, L1_CACHE_WRAP_AROUND_CTRL_SPEC> {
