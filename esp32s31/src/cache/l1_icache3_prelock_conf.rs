...
#[doc = "Field `L1_ICACHE3_PRELOCK_SCT0_EN` reader - Configures the first section of prelock function on L1-ICache3."]
pub type L1_ICACHE3_PRELOCK_SCT0_EN_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_PRELOCK_SCT1_EN` reader - Configures the second section of prelock function on L1-ICache3."]
pub type L1_ICACHE3_PRELOCK_SCT1_EN_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_PRELOCK_RGID` reader - Configures the gid of l1 icache3 prelock."]
pub type L1_ICACHE3_PRELOCK_RGID_R = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - Configures the first section of prelock function on L1-ICache3."]
    #[inline(always)]
    pub fn l1_icache3_prelock_sct0_en(&self) -> L1_ICACHE3_PRELOCK_SCT0_EN_R {
        L1_ICACHE3_PRELOCK_SCT0_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures the second section of prelock function on L1-ICache3."]
    #[inline(always)]
    pub fn l1_icache3_prelock_sct1_en(&self) -> L1_ICACHE3_PRELOCK_SCT1_EN_R {
        L1_ICACHE3_PRELOCK_SCT1_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:5 - Configures the gid of l1 icache3 prelock."]
    #[inline(always)]
