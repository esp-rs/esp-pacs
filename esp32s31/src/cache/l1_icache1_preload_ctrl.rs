...
#[doc = "Field `L1_ICACHE1_PRELOAD_ENA` reader - Configures whether to enable the preloading operation in icache1. Hardware will clear it once the operation has finished.\\\\1: Enable\\\\"]
pub type L1_ICACHE1_PRELOAD_ENA_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_PRELOAD_ENA` writer - Configures whether to enable the preloading operation in icache1. Hardware will clear it once the operation has finished.\\\\1: Enable\\\\"]
pub type L1_ICACHE1_PRELOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE1_PRELOAD_DONE` reader - Represents whether the preloading operation has finished.\\\\1: Finished\\\\"]
pub type L1_ICACHE1_PRELOAD_DONE_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_PRELOAD_ORDER` reader - Configures the direction of the preloading operation.\\\\1: Descending\\\\"]
pub type L1_ICACHE1_PRELOAD_ORDER_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_PRELOAD_ORDER` writer - Configures the direction of the preloading operation.\\\\1: Descending\\\\"]
pub type L1_ICACHE1_PRELOAD_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE1_PRELOAD_RGID` reader - Configures the gid of l1 icache1 preload."]
pub type L1_ICACHE1_PRELOAD_RGID_R = crate::FieldReader;
#[doc = "Field `L1_ICACHE1_PRELOAD_RGID` writer - Configures the gid of l1 icache1 preload."]
pub type L1_ICACHE1_PRELOAD_RGID_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `L1_ICACHE1_PRELOAD_MODE` reader - Configures the mode of l1 icache1 preload, 0: load data from next level memory, 1: not load data from next level memory."]
pub type L1_ICACHE1_PRELOAD_MODE_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_PRELOAD_MODE` writer - Configures the mode of l1 icache1 preload, 0: load data from next level memory, 1: not load data from next level memory."]
pub type L1_ICACHE1_PRELOAD_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures whether to enable the preloading operation in icache1. Hardware will clear it once the operation has finished.\\\\1: Enable\\\\"]
    #[inline(always)]
    ...
    #[doc = "Bits 3:6 - Configures the gid of l1 icache1 preload."]
    #[inline(always)]
    pub fn l1_icache1_preload_rgid(&self) -> L1_ICACHE1_PRELOAD_RGID_R {
        L1_ICACHE1_PRELOAD_RGID_R::new(((self.bits >> 3) & 0x0f) as u8)
    }
    #[doc = "Bit 7 - Configures the mode of l1 icache1 preload, 0: load data from next level memory, 1: not load data from next level memory."]
    #[inline(always)]
    pub fn l1_icache1_preload_mode(&self) -> L1_ICACHE1_PRELOAD_MODE_R {
        L1_ICACHE1_PRELOAD_MODE_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_ICACHE1_PRELOAD_CTRL")
            ...
            .field("l1_icache1_preload_mode", &self.l1_icache1_preload_mode())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 7 - Configures the mode of l1 icache1 preload, 0: load data from next level memory, 1: not load data from next level memory."]
    #[inline(always)]
    pub fn l1_icache1_preload_mode(
        &mut self,
    ) -> L1_ICACHE1_PRELOAD_MODE_W<'_, L1_ICACHE1_PRELOAD_CTRL_SPEC> {
        L1_ICACHE1_PRELOAD_MODE_W::new(self, 7)
    }
}
