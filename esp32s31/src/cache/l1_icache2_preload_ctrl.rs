...
#[doc = "Field `L1_ICACHE2_PRELOAD_ENA` reader - Configures preload operation on L1-ICache2. It will be cleared by hardware automatically after preload operation is done."]
pub type L1_ICACHE2_PRELOAD_ENA_R = crate::BitReader;
#[doc = "Field `L1_ICACHE2_PRELOAD_ENA` writer - Configures preload operation on L1-ICache2. It will be cleared by hardware automatically after preload operation is done."]
...
#[doc = "Field `L1_ICACHE2_PRELOAD_ORDER` reader - Configures the direction of preload operation. 0: ascending, 1: descending."]
pub type L1_ICACHE2_PRELOAD_ORDER_R = crate::BitReader;
#[doc = "Field `L1_ICACHE2_PRELOAD_RGID` reader - Configures the gid of l1 icache2 preload."]
pub type L1_ICACHE2_PRELOAD_RGID_R = crate::FieldReader;
#[doc = "Field `L1_ICACHE2_PRELOAD_MODE` reader - Configures the mode of l1 icache2 preload, 0: load data from next level memory, 1: not load data from next level memory."]
pub type L1_ICACHE2_PRELOAD_MODE_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Configures preload operation on L1-ICache2. It will be cleared by hardware automatically after preload operation is done."]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - Configures the direction of preload operation. 0: ascending, 1: descending."]
    #[inline(always)]
    pub fn l1_icache2_preload_order(&self) -> L1_ICACHE2_PRELOAD_ORDER_R {
        L1_ICACHE2_PRELOAD_ORDER_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bits 3:6 - Configures the gid of l1 icache2 preload."]
    #[inline(always)]
    pub fn l1_icache2_preload_rgid(&self) -> L1_ICACHE2_PRELOAD_RGID_R {
        L1_ICACHE2_PRELOAD_RGID_R::new(((self.bits >> 3) & 0x0f) as u8)
    }
    #[doc = "Bit 7 - Configures the mode of l1 icache2 preload, 0: load data from next level memory, 1: not load data from next level memory."]
    #[inline(always)]
    pub fn l1_icache2_preload_mode(&self) -> L1_ICACHE2_PRELOAD_MODE_R {
        L1_ICACHE2_PRELOAD_MODE_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_ICACHE2_PRELOAD_CTRL")
            ...
            .field("l1_icache2_preload_mode", &self.l1_icache2_preload_mode())
            .finish()
    }
}
impl W {
