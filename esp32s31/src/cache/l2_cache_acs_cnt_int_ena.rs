...
#[doc = "Field `L2_IBUS0_OVF_INT_ENA` reader - Configures interrupt of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
pub type L2_IBUS0_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L2_IBUS1_OVF_INT_ENA` reader - Configures interrupt of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
...
#[doc = "Field `L2_DBUS0_OVF_INT_ENA` reader - Configures interrupt of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
pub type L2_DBUS0_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L2_DBUS1_OVF_INT_ENA` reader - Configures interrupt of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
...
impl R {
    #[doc = "Bit 8 - Configures interrupt of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_ibus0_ovf_int_ena(&self) -> L2_IBUS0_OVF_INT_ENA_R {
        L2_IBUS0_OVF_INT_ENA_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Configures interrupt of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Configures interrupt of one of counters overflow that occurs in L2-Cache due to bus0 accesses L2-Cache."]
    #[inline(always)]
    pub fn l2_dbus0_ovf_int_ena(&self) -> L2_DBUS0_OVF_INT_ENA_R {
        L2_DBUS0_OVF_INT_ENA_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Configures interrupt of one of counters overflow that occurs in L2-Cache due to bus1 accesses L2-Cache."]
    #[inline(always)]
