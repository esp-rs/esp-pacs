...
#[doc = "Field `L1_IBUS0_OVF_INT_ENA` reader - Configures interrupt of one of counters overflow that occurs in L1-ICache0 due to bus0 accesses L1-ICache0."]
pub type L1_IBUS0_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_IBUS0_OVF_INT_ENA` writer - Configures interrupt of one of counters overflow that occurs in L1-ICache0 due to bus0 accesses L1-ICache0."]
pub type L1_IBUS0_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_IBUS1_OVF_INT_ENA` reader - Configures interrupt of one of counters overflow that occurs in L1-ICache1 due to bus1 accesses L1-ICache1."]
pub type L1_IBUS1_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_IBUS1_OVF_INT_ENA` writer - Configures interrupt of one of counters overflow that occurs in L1-ICache1 due to bus1 accesses L1-ICache1."]
...
#[doc = "Field `L1_IBUS2_OVF_INT_ENA` writer - Reserved"]
pub type L1_IBUS2_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_IBUS3_OVF_INT_ENA` reader - Reserved"]
pub type L1_IBUS3_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_IBUS3_OVF_INT_ENA` writer - Reserved"]
pub type L1_IBUS3_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DBUS0_OVF_INT_ENA` reader - Configures interrupt of one of counters overflow that occurs in L1-DCache due to bus0 accesses L1-DCache."]
pub type L1_DBUS0_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_DBUS0_OVF_INT_ENA` writer - Configures interrupt of one of counters overflow that occurs in L1-DCache due to bus0 accesses L1-DCache."]
pub type L1_DBUS0_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DBUS1_OVF_INT_ENA` reader - Configures interrupt of one of counters overflow that occurs in L1-DCache due to bus1 accesses L1-DCache."]
pub type L1_DBUS1_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_DBUS1_OVF_INT_ENA` writer - Configures interrupt of one of counters overflow that occurs in L1-DCache due to bus1 accesses L1-DCache."]
...
#[doc = "Field `L1_DBUS2_OVF_INT_ENA` writer - Reserved"]
pub type L1_DBUS2_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DBUS3_OVF_INT_ENA` reader - Reserved"]
pub type L1_DBUS3_OVF_INT_ENA_R = crate::BitReader;
#[doc = "Field `L1_DBUS3_OVF_INT_ENA` writer - Reserved"]
pub type L1_DBUS3_OVF_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures interrupt of one of counters overflow that occurs in L1-ICache0 due to bus0 accesses L1-ICache0."]
    #[inline(always)]
    pub fn l1_ibus0_ovf_int_ena(&self) -> L1_IBUS0_OVF_INT_ENA_R {
        L1_IBUS0_OVF_INT_ENA_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Configures interrupt of one of counters overflow that occurs in L1-ICache1 due to bus1 accesses L1-ICache1."]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Configures interrupt of one of counters overflow that occurs in L1-DCache due to bus0 accesses L1-DCache."]
    #[inline(always)]
    pub fn l1_dbus0_ovf_int_ena(&self) -> L1_DBUS0_OVF_INT_ENA_R {
        L1_DBUS0_OVF_INT_ENA_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Configures interrupt of one of counters overflow that occurs in L1-DCache due to bus1 accesses L1-DCache."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_ACS_CNT_INT_ENA")
            ...
            .field("l1_dbus0_ovf_int_ena", &self.l1_dbus0_ovf_int_ena())
            .field("l1_dbus1_ovf_int_ena", &self.l1_dbus1_ovf_int_ena())
...
impl W {
    ...
    pub fn l1_ibus0_ovf_int_ena(
        &mut self,
    ) -> L1_IBUS0_OVF_INT_ENA_W<'_, L1_CACHE_ACS_CNT_INT_ENA_SPEC> {
    ...
    pub fn l1_ibus1_ovf_int_ena(
        &mut self,
    ) -> L1_IBUS1_OVF_INT_ENA_W<'_, L1_CACHE_ACS_CNT_INT_ENA_SPEC> {
        L1_IBUS1_OVF_INT_ENA_W::new(self, 1)
    }
    #[doc = "Bit 2 - Reserved"]
    #[inline(always)]
    pub fn l1_ibus2_ovf_int_ena(
        &mut self,
    ) -> L1_IBUS2_OVF_INT_ENA_W<'_, L1_CACHE_ACS_CNT_INT_ENA_SPEC> {
        L1_IBUS2_OVF_INT_ENA_W::new(self, 2)
    }
    #[doc = "Bit 3 - Reserved"]
    #[inline(always)]
    pub fn l1_ibus3_ovf_int_ena(
        &mut self,
    ) -> L1_IBUS3_OVF_INT_ENA_W<'_, L1_CACHE_ACS_CNT_INT_ENA_SPEC> {
        L1_IBUS3_OVF_INT_ENA_W::new(self, 3)
    }
    #[doc = "Bit 4 - Configures interrupt of one of counters overflow that occurs in L1-DCache due to bus0 accesses L1-DCache."]
    #[inline(always)]
    pub fn l1_dbus0_ovf_int_ena(
        &mut self,
    ) -> L1_DBUS0_OVF_INT_ENA_W<'_, L1_CACHE_ACS_CNT_INT_ENA_SPEC> {
    ...
    pub fn l1_dbus1_ovf_int_ena(
        &mut self,
    ) -> L1_DBUS1_OVF_INT_ENA_W<'_, L1_CACHE_ACS_CNT_INT_ENA_SPEC> {
        L1_DBUS1_OVF_INT_ENA_W::new(self, 5)
    }
    #[doc = "Bit 6 - Reserved"]
    #[inline(always)]
    pub fn l1_dbus2_ovf_int_ena(
        &mut self,
    ) -> L1_DBUS2_OVF_INT_ENA_W<'_, L1_CACHE_ACS_CNT_INT_ENA_SPEC> {
        L1_DBUS2_OVF_INT_ENA_W::new(self, 6)
    }
    #[doc = "Bit 7 - Reserved"]
    #[inline(always)]
    pub fn l1_dbus3_ovf_int_ena(
        &mut self,
    ) -> L1_DBUS3_OVF_INT_ENA_W<'_, L1_CACHE_ACS_CNT_INT_ENA_SPEC> {
        L1_DBUS3_OVF_INT_ENA_W::new(self, 7)
    }
}
