...
#[doc = "Field `L1_DCACHE_AUTOLOAD_ENA` reader - Configures whether to enable the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_ENA_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_AUTOLOAD_ENA` writer - Configures whether to enable the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_AUTOLOAD_DONE` reader - Indicates whether the autoloading operation in dcache has finished.\\\\1: Finished\\\\"]
pub type L1_DCACHE_AUTOLOAD_DONE_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_AUTOLOAD_ORDER` reader - Configures the direction of the autoloading operation in dcache.\\\\1: Descending\\\\"]
pub type L1_DCACHE_AUTOLOAD_ORDER_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_AUTOLOAD_ORDER` writer - Configures the direction of the autoloading operation in dcache.\\\\1: Descending\\\\"]
pub type L1_DCACHE_AUTOLOAD_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_AUTOLOAD_TRIGGER_MODE` reader - Configures the trigger mode of the autoloading operation in dcache.\\\\2: Triggered by cache miss or hit\\\\"]
pub type L1_DCACHE_AUTOLOAD_TRIGGER_MODE_R = crate::FieldReader;
#[doc = "Field `L1_DCACHE_AUTOLOAD_TRIGGER_MODE` writer - Configures the trigger mode of the autoloading operation in dcache.\\\\2: Triggered by cache miss or hit\\\\"]
pub type L1_DCACHE_AUTOLOAD_TRIGGER_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `L1_DCACHE_AUTOLOAD_SCT0_ENA` reader - Configures whether to enable Section 0 for the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_SCT0_ENA_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_AUTOLOAD_SCT0_ENA` writer - Configures whether to enable Section 0 for the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_SCT0_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_AUTOLOAD_SCT1_ENA` reader - Configures whether to enable Section 1 for the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_SCT1_ENA_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_AUTOLOAD_SCT1_ENA` writer - Configures whether to enable Section 1 for the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_SCT1_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_AUTOLOAD_SCT2_ENA` reader - Configures whether to enable Section 2 for the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_SCT2_ENA_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_AUTOLOAD_SCT2_ENA` writer - Configures whether to enable Section 2 for the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_SCT2_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_AUTOLOAD_SCT3_ENA` reader - Configures whether to enable Section 3 for the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_SCT3_ENA_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_AUTOLOAD_SCT3_ENA` writer - Configures whether to enable Section 3 for the autoloading operation in dcache.\\\\1: Enable\\\\"]
pub type L1_DCACHE_AUTOLOAD_SCT3_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_AUTOLOAD_RGID` reader - Configures the gid of l1 dcache autoload."]
pub type L1_DCACHE_AUTOLOAD_RGID_R = crate::FieldReader;
#[doc = "Field `L1_DCACHE_AUTOLOAD_RGID` writer - Configures the gid of l1 dcache autoload."]
pub type L1_DCACHE_AUTOLOAD_RGID_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bit 0 - Configures whether to enable the autoloading operation in dcache.\\\\1: Enable\\\\"]
    #[inline(always)]
    pub fn l1_dcache_autoload_ena(&self) -> L1_DCACHE_AUTOLOAD_ENA_R {
        L1_DCACHE_AUTOLOAD_ENA_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Indicates whether the autoloading operation in dcache has finished.\\\\1: Finished\\\\"]
    #[inline(always)]
    pub fn l1_dcache_autoload_done(&self) -> L1_DCACHE_AUTOLOAD_DONE_R {
        L1_DCACHE_AUTOLOAD_DONE_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Configures the direction of the autoloading operation in dcache.\\\\1: Descending\\\\"]
    #[inline(always)]
    pub fn l1_dcache_autoload_order(&self) -> L1_DCACHE_AUTOLOAD_ORDER_R {
        L1_DCACHE_AUTOLOAD_ORDER_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bits 3:4 - Configures the trigger mode of the autoloading operation in dcache.\\\\2: Triggered by cache miss or hit\\\\"]
    #[inline(always)]
