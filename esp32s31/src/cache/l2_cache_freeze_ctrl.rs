...
#[doc = "Field `L2_CACHE_FREEZE_EN` reader - Configures freeze operation on L2-Cache. It can be cleared by software."]
pub type L2_CACHE_FREEZE_EN_R = crate::BitReader;
#[doc = "Field `L2_CACHE_FREEZE_MODE` reader - Configures mode of freeze operation L2-Cache. 0: a miss-access will not stuck. 1: a miss-access will stuck."]
...
impl R {
    #[doc = "Bit 20 - Configures freeze operation on L2-Cache. It can be cleared by software."]
    #[inline(always)]
    pub fn l2_cache_freeze_en(&self) -> L2_CACHE_FREEZE_EN_R {
        L2_CACHE_FREEZE_EN_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Configures mode of freeze operation L2-Cache. 0: a miss-access will not stuck. 1: a miss-access will stuck."]
    #[inline(always)]
