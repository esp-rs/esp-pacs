...
#[doc = "Field `L1_ICACHE3_PRELOAD_ENA` reader - Configures preload operation on L1-ICache3. It will be cleared by hardware automatically after preload operation is done."]
pub type L1_ICACHE3_PRELOAD_ENA_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_PRELOAD_ENA` writer - Configures preload operation on L1-ICache3. It will be cleared by hardware automatically after preload operation is done."]
...
#[doc = "Field `L1_ICACHE3_PRELOAD_ORDER` reader - Configures the direction of preload operation. 0: ascending, 1: descending."]
pub type L1_ICACHE3_PRELOAD_ORDER_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_PRELOAD_RGID` reader - Configures the gid of l1 icache3 preload."]
pub type L1_ICACHE3_PRELOAD_RGID_R = crate::FieldReader;
#[doc = "Field `L1_ICACHE3_PRELOAD_MODE` reader - Configures the mode of l1 icache3 preload, 0: load data from next level memory, 1: not load data from next level memory."]
pub type L1_ICACHE3_PRELOAD_MODE_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Configures preload operation on L1-ICache3. It will be cleared by hardware automatically after preload operation is done."]
    #[inline(always)]
    ...
    #[doc = "Bits 3:6 - Configures the gid of l1 icache3 preload."]
    #[inline(always)]
    pub fn l1_icache3_preload_rgid(&self) -> L1_ICACHE3_PRELOAD_RGID_R {
        L1_ICACHE3_PRELOAD_RGID_R::new(((self.bits >> 3) & 0x0f) as u8)
    }
    #[doc = "Bit 7 - Configures the mode of l1 icache3 preload, 0: load data from next level memory, 1: not load data from next level memory."]
    #[inline(always)]
