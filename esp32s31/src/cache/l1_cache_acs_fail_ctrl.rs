...
#[doc = "Field `L1_ICACHE0_ACS_FAIL_CHECK_MODE` reader - Configures l1 icache0 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_ICACHE0_ACS_FAIL_CHECK_MODE_R = crate::BitReader;
#[doc = "Field `L1_ICACHE0_ACS_FAIL_CHECK_MODE` writer - Configures l1 icache0 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_ICACHE0_ACS_FAIL_CHECK_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE1_ACS_FAIL_CHECK_MODE` reader - Configures l1 icache1 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_ICACHE1_ACS_FAIL_CHECK_MODE_R = crate::BitReader;
#[doc = "Field `L1_ICACHE1_ACS_FAIL_CHECK_MODE` writer - Configures l1 icache1 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_ICACHE1_ACS_FAIL_CHECK_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE2_ACS_FAIL_CHECK_MODE` reader - Configures l1 icache2 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_ICACHE2_ACS_FAIL_CHECK_MODE_R = crate::BitReader;
#[doc = "Field `L1_ICACHE2_ACS_FAIL_CHECK_MODE` writer - Configures l1 icache2 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_ICACHE2_ACS_FAIL_CHECK_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_ICACHE3_ACS_FAIL_CHECK_MODE` reader - Configures l1 icache3 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_ICACHE3_ACS_FAIL_CHECK_MODE_R = crate::BitReader;
#[doc = "Field `L1_ICACHE3_ACS_FAIL_CHECK_MODE` writer - Configures l1 icache3 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_ICACHE3_ACS_FAIL_CHECK_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `L1_DCACHE_ACS_FAIL_CHECK_MODE` reader - Configures l1 dcache access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_DCACHE_ACS_FAIL_CHECK_MODE_R = crate::BitReader;
#[doc = "Field `L1_DCACHE_ACS_FAIL_CHECK_MODE` writer - Configures l1 dcache access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
pub type L1_DCACHE_ACS_FAIL_CHECK_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Configures l1 icache0 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    #[inline(always)]
    ...
    #[doc = "Bit 1 - Configures l1 icache1 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - Configures l1 icache2 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - Configures l1 icache3 access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Configures l1 dcache access fail check mode. 0: the access fail is not propagated to the request, 1: the access fail is propagated to the request"]
    #[inline(always)]
...
#[doc = "Cache Access Fail Configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`l1_cache_acs_fail_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`l1_cache_acs_fail_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
