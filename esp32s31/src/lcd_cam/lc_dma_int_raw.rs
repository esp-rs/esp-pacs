...
#[doc = "Field `LCD_UNDERRUN_INT_RAW` reader - The raw bit for LCD underrun interrupt"]
pub type LCD_UNDERRUN_INT_RAW_R = crate::BitReader;
#[doc = "Field `CAM_OVERFLOW_INT_RAW` reader - The raw bit for Camera overflow interrupt"]
pub type CAM_OVERFLOW_INT_RAW_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 4 - The raw bit for LCD underrun interrupt"]
    #[inline(always)]
    pub fn lcd_underrun_int_raw(&self) -> LCD_UNDERRUN_INT_RAW_R {
        LCD_UNDERRUN_INT_RAW_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - The raw bit for Camera overflow interrupt"]
    #[inline(always)]
    pub fn cam_overflow_int_raw(&self) -> CAM_OVERFLOW_INT_RAW_R {
        CAM_OVERFLOW_INT_RAW_R::new(((self.bits >> 5) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LC_DMA_INT_RAW")
            ...
            .field("lcd_underrun_int_raw", &self.lcd_underrun_int_raw())
            .field("cam_overflow_int_raw", &self.cam_overflow_int_raw())
            .finish()
    }
}
