...
#[doc = "Field `LCD_CONV_HOR_PIXEL_NUM` reader - the horizontal pixel number when rgb trans to yuv420"]
pub type LCD_CONV_HOR_PIXEL_NUM_R = crate::FieldReader<u16>;
#[doc = "Field `LCD_CONV_HOR_PIXEL_NUM` writer - the horizontal pixel number when rgb trans to yuv420"]
pub type LCD_CONV_HOR_PIXEL_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
#[doc = "Field `LCD_CONV_MEM_CLK_EN` reader - 0:Open the clock gate for lcd convert memory.1: Close the clock gate for lcd convert memory"]
pub type LCD_CONV_MEM_CLK_EN_R = crate::BitReader;
#[doc = "Field `LCD_CONV_MEM_CLK_EN` writer - 0:Open the clock gate for lcd convert memory.1: Close the clock gate for lcd convert memory"]
pub type LCD_CONV_MEM_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `LCD_CONV_RGB_MODE` reader - 0:rgb565.1:rgb888.Determine the rgb format yuv420 trans to."]
pub type LCD_CONV_RGB_MODE_R = crate::BitReader;
#[doc = "Field `LCD_CONV_RGB_MODE` writer - 0:rgb565.1:rgb888.Determine the rgb format yuv420 trans to."]
pub type LCD_CONV_RGB_MODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LCD_CONV_RGB2RGB_MODE` reader - 0: to rgb565. 1: to rgb888. Others: disabled.To enable rgb2rgb mode, trans_mode must be set to 0."]
pub type LCD_CONV_RGB2RGB_MODE_R = crate::FieldReader;
#[doc = "Field `LCD_CONV_RGB2RGB_MODE` writer - 0: to rgb565. 1: to rgb888. Others: disabled.To enable rgb2rgb mode, trans_mode must be set to 0."]
...
impl R {
    #[doc = "Bits 5:15 - the horizontal pixel number when rgb trans to yuv420"]
    #[inline(always)]
    pub fn lcd_conv_hor_pixel_num(&self) -> LCD_CONV_HOR_PIXEL_NUM_R {
        LCD_CONV_HOR_PIXEL_NUM_R::new(((self.bits >> 5) & 0x07ff) as u16)
    }
    #[doc = "Bit 16 - 0:Open the clock gate for lcd convert memory.1: Close the clock gate for lcd convert memory"]
    #[inline(always)]
    pub fn lcd_conv_mem_clk_en(&self) -> LCD_CONV_MEM_CLK_EN_R {
        LCD_CONV_MEM_CLK_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - 1:invert every two 8bits input data. 2. disabled."]
    #[inline(always)]
    pub fn lcd_conv_8bits_data_inv(&self) -> LCD_CONV_8BITS_DATA_INV_R {
        LCD_CONV_8BITS_DATA_INV_R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - 0: txtorx mode off. 1: txtorx mode on."]
    #[inline(always)]
    pub fn lcd_conv_txtorx(&self) -> LCD_CONV_TXTORX_R {
        LCD_CONV_TXTORX_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - 0:rgb565.1:rgb888.Determine the rgb format yuv420 trans to."]
    #[inline(always)]
    pub fn lcd_conv_rgb_mode(&self) -> LCD_CONV_RGB_MODE_R {
        LCD_CONV_RGB_MODE_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bits 20:21 - 0: to rgb565. 1: to rgb888. Others: disabled.To enable rgb2rgb mode, trans_mode must be set to 0."]
    #[inline(always)]
    pub fn lcd_conv_rgb2rgb_mode(&self) -> LCD_CONV_RGB2RGB_MODE_R {
        LCD_CONV_RGB2RGB_MODE_R::new(((self.bits >> 20) & 3) as u8)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LCD_RGB_YUV")
            .field("lcd_conv_hor_pixel_num", &self.lcd_conv_hor_pixel_num())
            .field("lcd_conv_mem_clk_en", &self.lcd_conv_mem_clk_en())
            .field("lcd_conv_8bits_data_inv", &self.lcd_conv_8bits_data_inv())
            .field("lcd_conv_txtorx", &self.lcd_conv_txtorx())
            .field("lcd_conv_rgb_mode", &self.lcd_conv_rgb_mode())
...
impl W {
    #[doc = "Bits 5:15 - the horizontal pixel number when rgb trans to yuv420"]
    #[inline(always)]
    pub fn lcd_conv_hor_pixel_num(&mut self) -> LCD_CONV_HOR_PIXEL_NUM_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_HOR_PIXEL_NUM_W::new(self, 5)
    }
    #[doc = "Bit 16 - 0:Open the clock gate for lcd convert memory.1: Close the clock gate for lcd convert memory"]
    #[inline(always)]
    pub fn lcd_conv_mem_clk_en(&mut self) -> LCD_CONV_MEM_CLK_EN_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_MEM_CLK_EN_W::new(self, 16)
    }
    #[doc = "Bit 17 - 1:invert every two 8bits input data. 2. disabled."]
    #[inline(always)]
    pub fn lcd_conv_8bits_data_inv(&mut self) -> LCD_CONV_8BITS_DATA_INV_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_8BITS_DATA_INV_W::new(self, 17)
    }
    #[doc = "Bit 18 - 0: txtorx mode off. 1: txtorx mode on."]
    #[inline(always)]
    pub fn lcd_conv_txtorx(&mut self) -> LCD_CONV_TXTORX_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_TXTORX_W::new(self, 18)
    }
    #[doc = "Bit 19 - 0:rgb565.1:rgb888.Determine the rgb format yuv420 trans to."]
    #[inline(always)]
    pub fn lcd_conv_rgb_mode(&mut self) -> LCD_CONV_RGB_MODE_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_RGB_MODE_W::new(self, 19)
    }
    #[doc = "Bits 20:21 - 0: to rgb565. 1: to rgb888. Others: disabled.To enable rgb2rgb mode, trans_mode must be set to 0."]
    #[inline(always)]
    pub fn lcd_conv_rgb2rgb_mode(&mut self) -> LCD_CONV_RGB2RGB_MODE_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_RGB2RGB_MODE_W::new(self, 20)
    }
    #[doc = "Bits 22:23 - 0: to yuv422. 1: to yuv420. 2: to yuv411. 3: disabled. To enable yuv2yuv mode, trans_mode must be set to 1."]
    #[inline(always)]
    ...
    #[doc = "Bit 26 - 0:BT601. 1:BT709."]
    #[inline(always)]
    pub fn lcd_conv_protocol_mode(&mut self) -> LCD_CONV_PROTOCOL_MODE_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_PROTOCOL_MODE_W::new(self, 26)
    }
    #[doc = "Bit 27 - LIMIT or FULL mode of Data out. 0: limit. 1: full"]
    #[inline(always)]
    pub fn lcd_conv_data_out_mode(&mut self) -> LCD_CONV_DATA_OUT_MODE_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_DATA_OUT_MODE_W::new(self, 27)
    }
    #[doc = "Bit 28 - LIMIT or FULL mode of Data in. 0: limit. 1: full"]
    #[inline(always)]
    pub fn lcd_conv_data_in_mode(&mut self) -> LCD_CONV_DATA_IN_MODE_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_DATA_IN_MODE_W::new(self, 28)
    }
    #[doc = "Bit 29 - 0: 16bits mode. 1: 8bits mode."]
    #[inline(always)]
    pub fn lcd_conv_mode_8bits_on(&mut self) -> LCD_CONV_MODE_8BITS_ON_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_MODE_8BITS_ON_W::new(self, 29)
    }
    #[doc = "Bit 30 - 0: YUV to RGB. 1: RGB to YUV."]
    #[inline(always)]
    pub fn lcd_conv_trans_mode(&mut self) -> LCD_CONV_TRANS_MODE_W<'_, LCD_RGB_YUV_SPEC> {
        LCD_CONV_TRANS_MODE_W::new(self, 30)
    }
    #[doc = "Bit 31 - 0: Bypass converter. 1: Enable converter."]
    #[inline(always)]
    pub fn lcd_conv_enable(&mut self) -> LCD_CONV_ENABLE_W<'_, LCD_RGB_YUV_SPEC> {
...
#[doc = "`reset()` method sets LCD_RGB_YUV to value 0x00e0_0000"]
