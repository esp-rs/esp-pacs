#[doc = "Register `LCD_RGB_CTRL` reader"]
pub type R = crate::R<LCD_RGB_CTRL_SPEC>;
#[doc = "Register `LCD_RGB_CTRL` writer"]
pub type W = crate::W<LCD_RGB_CTRL_SPEC>;
#[doc = "Field `LCD_VSYNC_WIDTH` reader - It is the position of LCD_VSYNC active pulse in a line."]
pub type LCD_VSYNC_WIDTH_R = crate::FieldReader<u16>;
#[doc = "Field `LCD_VSYNC_WIDTH` writer - It is the position of LCD_VSYNC active pulse in a line."]
pub type LCD_VSYNC_WIDTH_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
...
impl R {
    #[doc = "Bits 0:9 - It is the position of LCD_VSYNC active pulse in a line."]
    #[inline(always)]
    pub fn lcd_vsync_width(&self) -> LCD_VSYNC_WIDTH_R {
        LCD_VSYNC_WIDTH_R::new((self.bits & 0x03ff) as u16)
    }
    #[doc = "Bit 10 - It is the idle value of LCD_VSYNC."]
    #[inline(always)]
    pub fn lcd_vsync_idle_pol(&self) -> LCD_VSYNC_IDLE_POL_R {
        LCD_VSYNC_IDLE_POL_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - It is the idle value of LCD_DE."]
    #[inline(always)]
    pub fn lcd_de_idle_pol(&self) -> LCD_DE_IDLE_POL_R {
        LCD_DE_IDLE_POL_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - 1: The pulse of LCD_HSYNC is out in vertical blanking lines RGB mode. 0: LCD_HSYNC pulse is valid only in active region lines in RGB mode."]
    #[inline(always)]
    pub fn lcd_hs_blank_en(&self) -> LCD_HS_BLANK_EN_R {
        LCD_HS_BLANK_EN_R::new(((self.bits >> 12) & 1) != 0)
    }
...
impl W {
    #[doc = "Bits 0:9 - It is the position of LCD_VSYNC active pulse in a line."]
    #[inline(always)]
    pub fn lcd_vsync_width(&mut self) -> LCD_VSYNC_WIDTH_W<'_, LCD_RGB_CTRL_SPEC> {
        LCD_VSYNC_WIDTH_W::new(self, 0)
    }
    #[doc = "Bit 10 - It is the idle value of LCD_VSYNC."]
    #[inline(always)]
    pub fn lcd_vsync_idle_pol(&mut self) -> LCD_VSYNC_IDLE_POL_W<'_, LCD_RGB_CTRL_SPEC> {
        LCD_VSYNC_IDLE_POL_W::new(self, 10)
    }
    #[doc = "Bit 11 - It is the idle value of LCD_DE."]
    #[inline(always)]
    pub fn lcd_de_idle_pol(&mut self) -> LCD_DE_IDLE_POL_W<'_, LCD_RGB_CTRL_SPEC> {
        LCD_DE_IDLE_POL_W::new(self, 11)
    }
    #[doc = "Bit 12 - 1: The pulse of LCD_HSYNC is out in vertical blanking lines RGB mode. 0: LCD_HSYNC pulse is valid only in active region lines in RGB mode."]
    #[inline(always)]
    pub fn lcd_hs_blank_en(&mut self) -> LCD_HS_BLANK_EN_W<'_, LCD_RGB_CTRL_SPEC> {
        LCD_HS_BLANK_EN_W::new(self, 12)
    }
    #[doc = "Bits 16:22 - It is the position of LCD_HSYNC active pulse in a line."]
    #[inline(always)]
    pub fn lcd_hsync_width(&mut self) -> LCD_HSYNC_WIDTH_W<'_, LCD_RGB_CTRL_SPEC> {
        LCD_HSYNC_WIDTH_W::new(self, 16)
    }
    #[doc = "Bit 23 - It is the idle value of LCD_HSYNC."]
    #[inline(always)]
    pub fn lcd_hsync_idle_pol(&mut self) -> LCD_HSYNC_IDLE_POL_W<'_, LCD_RGB_CTRL_SPEC> {
        LCD_HSYNC_IDLE_POL_W::new(self, 23)
    }
    #[doc = "Bits 24:31 - It is the position of LCD_HSYNC active pulse in a line."]
    #[inline(always)]
    pub fn lcd_hsync_position(&mut self) -> LCD_HSYNC_POSITION_W<'_, LCD_RGB_CTRL_SPEC> {
        LCD_HSYNC_POSITION_W::new(self, 24)
    }
}
#[doc = "LCD config register.\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_rgb_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_rgb_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LCD_RGB_CTRL_SPEC;
impl crate::RegisterSpec for LCD_RGB_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_rgb_ctrl::R`](R) reader structure"]
impl crate::Readable for LCD_RGB_CTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`lcd_rgb_ctrl::W`](W) writer structure"]
impl crate::Writable for LCD_RGB_CTRL_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RGB_CTRL to value 0x0001_0001"]
impl crate::Resettable for LCD_RGB_CTRL_SPEC {
