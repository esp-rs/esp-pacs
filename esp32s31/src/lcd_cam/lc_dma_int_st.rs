...
#[doc = "Field `CAM_OVERFLOW_INT_ST` reader - The status bit for Camera overflow interrupt"]
pub type CAM_OVERFLOW_INT_ST_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 5 - The status bit for Camera overflow interrupt"]
    #[inline(always)]
    pub fn cam_overflow_int_st(&self) -> CAM_OVERFLOW_INT_ST_R {
        CAM_OVERFLOW_INT_ST_R::new(((self.bits >> 5) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LC_DMA_INT_ST")
            ...
            .field("cam_overflow_int_st", &self.cam_overflow_int_st())
            .finish()
    }
}
