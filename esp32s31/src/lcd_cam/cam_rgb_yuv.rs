...
#[doc = "Field `CAM_CONV_HOR_PIXEL_NUM` reader - the horizontal pixel number when rgb trans to yuv420"]
pub type CAM_CONV_HOR_PIXEL_NUM_R = crate::FieldReader<u16>;
#[doc = "Field `CAM_CONV_HOR_PIXEL_NUM` writer - the horizontal pixel number when rgb trans to yuv420"]
pub type CAM_CONV_HOR_PIXEL_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
...
#[doc = "Field `CAM_CONV_YUV_MODE` reader - 0: yuv422. 1: yuv420. 2: yuv411.The format that Data_in should be converted to."]
pub type CAM_CONV_YUV_MODE_R = crate::FieldReader;
#[doc = "Field `CAM_CONV_YUV_MODE` writer - 0: yuv422. 1: yuv420. 2: yuv411.The format that Data_in should be converted to."]
...
impl R {
    #[doc = "Bits 10:20 - the horizontal pixel number when rgb trans to yuv420"]
    #[inline(always)]
    pub fn cam_conv_hor_pixel_num(&self) -> CAM_CONV_HOR_PIXEL_NUM_R {
        CAM_CONV_HOR_PIXEL_NUM_R::new(((self.bits >> 10) & 0x07ff) as u16)
    }
    ...
    #[doc = "Bits 24:25 - 0: yuv422. 1: yuv420. 2: yuv411.The format that Data_in should be converted to."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CAM_RGB_YUV")
            .field("cam_conv_hor_pixel_num", &self.cam_conv_hor_pixel_num())
...
impl W {
    #[doc = "Bits 10:20 - the horizontal pixel number when rgb trans to yuv420"]
    #[inline(always)]
    pub fn cam_conv_hor_pixel_num(&mut self) -> CAM_CONV_HOR_PIXEL_NUM_W<'_, CAM_RGB_YUV_SPEC> {
        CAM_CONV_HOR_PIXEL_NUM_W::new(self, 10)
    }
    #[doc = "Bit 21 - 1:invert every two 8bits input data. 2. disabled."]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - 0: Bypass converter. 1: Enable converter."]
    #[inline(always)]
    pub fn cam_conv_enable(&mut self) -> CAM_CONV_ENABLE_W<'_, CAM_RGB_YUV_SPEC> {
