...
impl R {
    #[doc = "Bit 3 - 1: Enable LCD RGB mode. 0: Disable LCD RGB mode."]
    #[inline(always)]
    pub fn lcd_rgb_mode_en(&self) -> LCD_RGB_MODE_EN_R {
        LCD_RGB_MODE_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 3 - 1: Enable LCD RGB mode. 0: Disable LCD RGB mode."]
    #[inline(always)]
    pub fn lcd_rgb_mode_en(&mut self) -> LCD_RGB_MODE_EN_W<'_, LCD_MISC_SPEC> {
        LCD_RGB_MODE_EN_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - The wire width of LCD output. 0: 8bit. 1: 16bit 2: 24bit"]
    #[inline(always)]
    pub fn lcd_wire_mode(&mut self) -> LCD_WIRE_MODE_W<'_, LCD_MISC_SPEC> {
