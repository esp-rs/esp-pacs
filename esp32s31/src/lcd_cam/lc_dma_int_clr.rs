...
#[doc = "Field `LCD_UNDERRUN_INT_CLR` writer - The clear bit for LCD underrun interrupt"]
pub type LCD_UNDERRUN_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CAM_OVERFLOW_INT_CLR` writer - The clear bit for Camera overflow interrupt"]
pub type CAM_OVERFLOW_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[doc = "Bit 4 - The clear bit for LCD underrun interrupt"]
    #[inline(always)]
    pub fn lcd_underrun_int_clr(&mut self) -> LCD_UNDERRUN_INT_CLR_W<'_, LC_DMA_INT_CLR_SPEC> {
        LCD_UNDERRUN_INT_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - The clear bit for Camera overflow interrupt"]
    #[inline(always)]
    pub fn cam_overflow_int_clr(&mut self) -> CAM_OVERFLOW_INT_CLR_W<'_, LC_DMA_INT_CLR_SPEC> {
        CAM_OVERFLOW_INT_CLR_W::new(self, 5)
    }
}
