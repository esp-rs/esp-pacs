...
#[doc = "Field `CAM_OVERFLOW_INT_ENA` reader - The enable bit for Camera overflow interrupt"]
pub type CAM_OVERFLOW_INT_ENA_R = crate::BitReader;
#[doc = "Field `CAM_OVERFLOW_INT_ENA` writer - The enable bit for Camera overflow interrupt"]
pub type CAM_OVERFLOW_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 5 - The enable bit for Camera overflow interrupt"]
    #[inline(always)]
    pub fn cam_overflow_int_ena(&self) -> CAM_OVERFLOW_INT_ENA_R {
        CAM_OVERFLOW_INT_ENA_R::new(((self.bits >> 5) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LC_DMA_INT_ENA")
            ...
            .field("cam_overflow_int_ena", &self.cam_overflow_int_ena())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - The enable bit for LCD frame end interrupt."]
    #[inline(always)]
    pub fn lcd_vsync_int_ena(&mut self) -> LCD_VSYNC_INT_ENA_W<'_, LC_DMA_INT_ENA_SPEC> {
        LCD_VSYNC_INT_ENA_W::new(self, 0)
    }
    #[doc = "Bit 1 - The enable bit for lcd transfer end interrupt."]
    #[inline(always)]
    pub fn lcd_trans_done_int_ena(&mut self) -> LCD_TRANS_DONE_INT_ENA_W<'_, LC_DMA_INT_ENA_SPEC> {
        LCD_TRANS_DONE_INT_ENA_W::new(self, 1)
    }
    #[doc = "Bit 2 - The enable bit for Camera frame end interrupt."]
    #[inline(always)]
    pub fn cam_vsync_int_ena(&mut self) -> CAM_VSYNC_INT_ENA_W<'_, LC_DMA_INT_ENA_SPEC> {
    ...
    #[doc = "Bit 5 - The enable bit for Camera overflow interrupt"]
    #[inline(always)]
    pub fn cam_overflow_int_ena(&mut self) -> CAM_OVERFLOW_INT_ENA_W<'_, LC_DMA_INT_ENA_SPEC> {
        CAM_OVERFLOW_INT_ENA_W::new(self, 5)
    }
}
