...
pub struct RegisterBlock {
    ...
    rx_conf1: RX_CONF1,
    tx_conf1: TX_CONF1,
    rx_recomb_ctrl: RX_RECOMB_CTRL,
    rx_recomb_dma_ch0: RX_RECOMB_DMA_CH0,
    rx_recomb_dma_ch1: RX_RECOMB_DMA_CH1,
    rx_recomb_dma_ch2: RX_RECOMB_DMA_CH2,
    rx_recomb_dma_ch3: RX_RECOMB_DMA_CH3,
    ...
    bck_cnt: BCK_CNT,
    cnt_diff: CNT_DIFF,
    sync_sw_thres: SYNC_SW_THRES,
    sync_hw_thres: SYNC_HW_THRES,
    hw_sync_conf: HW_SYNC_CONF,
    hw_sync_data: HW_SYNC_DATA,
    _reserved33: [u8; 0x60],
...
impl RegisterBlock {
    ...
    #[doc = "0x30 - I2S RX configure register 1"]
    #[inline(always)]
    pub const fn rx_recomb_ctrl(&self) -> &RX_RECOMB_CTRL {
        &self.rx_recomb_ctrl
    }
    #[doc = "0x34 - I2S RX recombined-dma-channel configuration register"]
    #[inline(always)]
    pub const fn rx_recomb_dma_ch0(&self) -> &RX_RECOMB_DMA_CH0 {
        &self.rx_recomb_dma_ch0
    }
    #[doc = "0x38 - I2S RX recombined-dma-channel configuration register"]
    #[inline(always)]
    pub const fn rx_recomb_dma_ch1(&self) -> &RX_RECOMB_DMA_CH1 {
        &self.rx_recomb_dma_ch1
    }
    #[doc = "0x3c - I2S RX recombined-dma-channel configuration register"]
    #[inline(always)]
    pub const fn rx_recomb_dma_ch2(&self) -> &RX_RECOMB_DMA_CH2 {
        &self.rx_recomb_dma_ch2
    }
    #[doc = "0x40 - I2S RX recombined-dma-channel configuration register"]
    #[inline(always)]
    pub const fn rx_recomb_dma_ch3(&self) -> &RX_RECOMB_DMA_CH3 {
        &self.rx_recomb_dma_ch3
    }
    ...
    #[doc = "0x48 - I2S TX PCM2PDM configuration register"]
    #[inline(always)]
    pub const fn tx_pcm2pdm_conf1(&self) -> &TX_PCM2PDM_CONF1 {
        &self.tx_pcm2pdm_conf1
    }
    #[doc = "0x4c - I2S RX configure register"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn ideal_cnt(&self) -> &IDEAL_CNT {
        &self.ideal_cnt
    }
    ...
    #[doc = "0x7c - I2S sync counter register"]
    #[inline(always)]
    pub const fn bck_cnt(&self) -> &BCK_CNT {
        &self.bck_cnt
    }
    #[doc = "0x80 - I2S sync counter register"]
    #[inline(always)]
    pub const fn cnt_diff(&self) -> &CNT_DIFF {
        &self.cnt_diff
    }
    #[doc = "0x84 - I2S sync counter register"]
    #[inline(always)]
    pub const fn sync_sw_thres(&self) -> &SYNC_SW_THRES {
        &self.sync_sw_thres
    }
    #[doc = "0x88 - I2S sync counter register"]
    #[inline(always)]
    pub const fn sync_hw_thres(&self) -> &SYNC_HW_THRES {
        &self.sync_hw_thres
    }
    #[doc = "0x8c - I2S TX hardware sync function configuration register"]
    #[inline(always)]
    pub const fn hw_sync_conf(&self) -> &HW_SYNC_CONF {
        &self.hw_sync_conf
    }
    #[doc = "0x90 - I2S TX hardware sync function configuration register"]
    #[inline(always)]
    pub const fn hw_sync_data(&self) -> &HW_SYNC_DATA {
        &self.hw_sync_data
    }
    #[doc = "0xf4 - I2S TX status register"]
    #[inline(always)]
...
pub mod tx_conf1;
#[doc = "RX_RECOMB_CTRL (rw) register accessor: I2S RX configure register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_recomb_ctrl::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_recomb_ctrl::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rx_recomb_ctrl`] module"]
pub type RX_RECOMB_CTRL = crate::Reg<rx_recomb_ctrl::RX_RECOMB_CTRL_SPEC>;
#[doc = "I2S RX configure register 1"]
pub mod rx_recomb_ctrl;
#[doc = "RX_RECOMB_DMA_CH0 (rw) register accessor: I2S RX recombined-dma-channel configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_recomb_dma_ch0::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_recomb_dma_ch0::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rx_recomb_dma_ch0`] module"]
pub type RX_RECOMB_DMA_CH0 = crate::Reg<rx_recomb_dma_ch0::RX_RECOMB_DMA_CH0_SPEC>;
#[doc = "I2S RX recombined-dma-channel configuration register"]
pub mod rx_recomb_dma_ch0;
#[doc = "RX_RECOMB_DMA_CH1 (rw) register accessor: I2S RX recombined-dma-channel configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_recomb_dma_ch1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_recomb_dma_ch1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rx_recomb_dma_ch1`] module"]
pub type RX_RECOMB_DMA_CH1 = crate::Reg<rx_recomb_dma_ch1::RX_RECOMB_DMA_CH1_SPEC>;
#[doc = "I2S RX recombined-dma-channel configuration register"]
pub mod rx_recomb_dma_ch1;
#[doc = "RX_RECOMB_DMA_CH2 (rw) register accessor: I2S RX recombined-dma-channel configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_recomb_dma_ch2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_recomb_dma_ch2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rx_recomb_dma_ch2`] module"]
pub type RX_RECOMB_DMA_CH2 = crate::Reg<rx_recomb_dma_ch2::RX_RECOMB_DMA_CH2_SPEC>;
#[doc = "I2S RX recombined-dma-channel configuration register"]
pub mod rx_recomb_dma_ch2;
#[doc = "RX_RECOMB_DMA_CH3 (rw) register accessor: I2S RX recombined-dma-channel configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_recomb_dma_ch3::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_recomb_dma_ch3::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rx_recomb_dma_ch3`] module"]
pub type RX_RECOMB_DMA_CH3 = crate::Reg<rx_recomb_dma_ch3::RX_RECOMB_DMA_CH3_SPEC>;
#[doc = "I2S RX recombined-dma-channel configuration register"]
pub mod rx_recomb_dma_ch3;
...
pub mod etm_conf;
#[doc = "IDEAL_CNT (rw) register accessor: I2S sync counter register\n\nYou can [`read`](crate::Reg::read) this register and get [`ideal_cnt::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ideal_cnt::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ideal_cnt`] module"]
pub type IDEAL_CNT = crate::Reg<ideal_cnt::IDEAL_CNT_SPEC>;
...
#[doc = "I2S sync counter register"]
pub mod bck_cnt;
#[doc = "CNT_DIFF (rw) register accessor: I2S sync counter register\n\nYou can [`read`](crate::Reg::read) this register and get [`cnt_diff::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cnt_diff::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cnt_diff`] module"]
pub type CNT_DIFF = crate::Reg<cnt_diff::CNT_DIFF_SPEC>;
#[doc = "I2S sync counter register"]
pub mod cnt_diff;
#[doc = "SYNC_SW_THRES (rw) register accessor: I2S sync counter register\n\nYou can [`read`](crate::Reg::read) this register and get [`sync_sw_thres::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sync_sw_thres::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sync_sw_thres`] module"]
pub type SYNC_SW_THRES = crate::Reg<sync_sw_thres::SYNC_SW_THRES_SPEC>;
#[doc = "I2S sync counter register"]
pub mod sync_sw_thres;
#[doc = "SYNC_HW_THRES (rw) register accessor: I2S sync counter register\n\nYou can [`read`](crate::Reg::read) this register and get [`sync_hw_thres::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sync_hw_thres::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sync_hw_thres`] module"]
pub type SYNC_HW_THRES = crate::Reg<sync_hw_thres::SYNC_HW_THRES_SPEC>;
#[doc = "I2S sync counter register"]
pub mod sync_hw_thres;
#[doc = "HW_SYNC_CONF (rw) register accessor: I2S TX hardware sync function configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`hw_sync_conf::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hw_sync_conf::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@hw_sync_conf`] module"]
pub type HW_SYNC_CONF = crate::Reg<hw_sync_conf::HW_SYNC_CONF_SPEC>;
#[doc = "I2S TX hardware sync function configuration register"]
pub mod hw_sync_conf;
#[doc = "HW_SYNC_DATA (rw) register accessor: I2S TX hardware sync function configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`hw_sync_data::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hw_sync_data::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@hw_sync_data`] module"]
pub type HW_SYNC_DATA = crate::Reg<hw_sync_data::HW_SYNC_DATA_SPEC>;
#[doc = "I2S TX hardware sync function configuration register"]
pub mod hw_sync_data;
#[doc = "DESTINATION (rw) register accessor: I2S TX status register\n\nYou can [`read`](crate::Reg::read) this register and get [`destination::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`destination::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@destination`] module"]
