#[doc = "Register `SEL_AG5_METRIC_RANGE0` reader"]
pub type R = crate::R<SEL_AG5_METRIC_RANGE0_SPEC>;
#[doc = "Register `SEL_AG5_METRIC_RANGE0` writer"]
pub type W = crate::W<SEL_AG5_METRIC_RANGE0_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SEL_AG5_METRIC_RANGE0")
...
impl W {
    #[doc = "Bits 0:15 - The x Upper limit of interval statistics for sel metric in sel agent"]
    #[inline(always)]
    pub fn cnt_high(&mut self) -> CNT_HIGH_W<'_, SEL_AG5_METRIC_RANGE0_SPEC> {
        CNT_HIGH_W::new(self, 0)
    }
    #[doc = "Bits 16:31 - The x Lower limit of interval statistics for sel metric in sel agent"]
    #[inline(always)]
    pub fn cnt_low(&mut self) -> CNT_LOW_W<'_, SEL_AG5_METRIC_RANGE0_SPEC> {
        CNT_LOW_W::new(self, 16)
    }
}
#[doc = "reserved\n\nYou can [`read`](crate::Reg::read) this register and get [`sel_ag5_metric_range0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sel_ag5_metric_range0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SEL_AG5_METRIC_RANGE0_SPEC;
impl crate::RegisterSpec for SEL_AG5_METRIC_RANGE0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sel_ag5_metric_range0::R`](R) reader structure"]
impl crate::Readable for SEL_AG5_METRIC_RANGE0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`sel_ag5_metric_range0::W`](W) writer structure"]
impl crate::Writable for SEL_AG5_METRIC_RANGE0_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SEL_AG5_METRIC_RANGE0 to value 0"]
impl crate::Resettable for SEL_AG5_METRIC_RANGE0_SPEC {}
