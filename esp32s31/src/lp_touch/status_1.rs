...
#[doc = "Field `PAD1_NN_CNT` reader - need_des"]
pub type PAD1_NN_CNT_R = crate::FieldReader;
impl R {
    ...
    #[inline(always)]
    pub fn pad1_nn_cnt(&self) -> PAD1_NN_CNT_R {
        PAD1_NN_CNT_R::new(((self.bits >> 19) & 0x0f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS_1")
            ...
            .field("pad1_nn_cnt", &self.pad1_nn_cnt())
            .finish()
    }
}
