...
#[doc = "Field `PAD2_NN_CNT` reader - need_des"]
pub type PAD2_NN_CNT_R = crate::FieldReader;
impl R {
    ...
    #[inline(always)]
    pub fn pad2_nn_cnt(&self) -> PAD2_NN_CNT_R {
        PAD2_NN_CNT_R::new(((self.bits >> 19) & 0x0f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS_2")
            ...
            .field("pad2_nn_cnt", &self.pad2_nn_cnt())
            .finish()
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`status_2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
