...
#[doc = "Field `FREQ_SCAN_CNT` reader - need_des"]
pub type FREQ_SCAN_CNT_R = crate::FieldReader;
impl R {
    ...
    #[inline(always)]
    pub fn freq_scan_cnt(&self) -> FREQ_SCAN_CNT_R {
        FREQ_SCAN_CNT_R::new(((self.bits >> 23) & 3) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS_17")
            ...
            .field("freq_scan_cnt", &self.freq_scan_cnt())
            .finish()
    }
}
