...
#[doc = "Field `SLP_NN_CNT` reader - need_des"]
pub type SLP_NN_CNT_R = crate::FieldReader;
impl R {
    ...
    #[inline(always)]
    pub fn slp_nn_cnt(&self) -> SLP_NN_CNT_R {
        SLP_NN_CNT_R::new(((self.bits >> 19) & 0x0f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STATUS_15")
            ...
            .field("slp_nn_cnt", &self.slp_nn_cnt())
            .finish()
    }
}
...
#[doc = "`reset()` method sets STATUS_15 to value 0xffff"]
