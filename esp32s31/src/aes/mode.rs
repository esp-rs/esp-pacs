...
#[doc = "Field `USE_HARDWARE_KEY` reader - Configures the AES accelerator use software key or hardware key.\\\\ 0: Software key. \\\\ 1: Hardware key. \\\\"]
pub type USE_HARDWARE_KEY_R = crate::BitReader;
#[doc = "Field `USE_HARDWARE_KEY` writer - Configures the AES accelerator use software key or hardware key.\\\\ 0: Software key. \\\\ 1: Hardware key. \\\\"]
pub type USE_HARDWARE_KEY_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 4 - Configures the AES accelerator use software key or hardware key.\\\\ 0: Software key. \\\\ 1: Hardware key. \\\\"]
    #[inline(always)]
    pub fn use_hardware_key(&self) -> USE_HARDWARE_KEY_R {
        USE_HARDWARE_KEY_R::new(((self.bits >> 4) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MODE")
            ...
            .field("use_hardware_key", &self.use_hardware_key())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 4 - Configures the AES accelerator use software key or hardware key.\\\\ 0: Software key. \\\\ 1: Hardware key. \\\\"]
    #[inline(always)]
    pub fn use_hardware_key(&mut self) -> USE_HARDWARE_KEY_W<'_, MODE_SPEC> {
        USE_HARDWARE_KEY_W::new(self, 4)
    }
}
