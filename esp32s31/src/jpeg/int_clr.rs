...
#[doc = "Field `ENCODE_TIMEOUT_INT_CLR` writer - The clear interrupt bit to sign that encode can not output bitstream time is longer than the setting encode timeout time when encoding."]
pub type ENCODE_TIMEOUT_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn done_int_clr(&mut self) -> DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
        DONE_INT_CLR_W::new(self, 0)
    }
    #[doc = "Bit 1 - The clear interrupt bit to sign that rle parallel error when decoding."]
    #[inline(always)]
    pub fn rle_parallel_err_int_clr(&mut self) -> RLE_PARALLEL_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn cid_err_int_clr(&mut self) -> CID_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn c_dht_dc_id_err_int_clr(&mut self) -> C_DHT_DC_ID_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn c_dht_ac_id_err_int_clr(&mut self) -> C_DHT_AC_ID_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn c_dqt_id_err_int_clr(&mut self) -> C_DQT_ID_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rst_uxp_err_int_clr(&mut self) -> RST_UXP_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rst_check_none_err_int_clr(&mut self) -> RST_CHECK_NONE_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rst_check_pos_err_int_clr(&mut self) -> RST_CHECK_POS_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn out_eof_int_clr(&mut self) -> OUT_EOF_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn sr_color_mode_err_int_clr(&mut self) -> SR_COLOR_MODE_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
        SR_COLOR_MODE_ERR_INT_CLR_W::new(self, 10)
    }
    #[doc = "Bit 11 - The clear interrupt bit to sign that one dct calculation is finished."]
    #[inline(always)]
    pub fn dct_done_int_clr(&mut self) -> DCT_DONE_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn bs_last_block_eof_int_clr(&mut self) -> BS_LAST_BLOCK_EOF_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn scan_check_none_err_int_clr(
        &mut self,
    ) -> SCAN_CHECK_NONE_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn scan_check_pos_err_int_clr(&mut self) -> SCAN_CHECK_POS_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn uxp_det_int_clr(&mut self) -> UXP_DET_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn en_frame_eof_err_int_clr(&mut self) -> EN_FRAME_EOF_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn en_frame_eof_lack_int_clr(&mut self) -> EN_FRAME_EOF_LACK_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn de_frame_eof_err_int_clr(&mut self) -> DE_FRAME_EOF_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn de_frame_eof_lack_int_clr(&mut self) -> DE_FRAME_EOF_LACK_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn sos_unmatch_err_int_clr(&mut self) -> SOS_UNMATCH_ERR_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn marker_err_fst_scan_int_clr(
        &mut self,
    ) -> MARKER_ERR_FST_SCAN_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    pub fn marker_err_other_scan_int_clr(
        &mut self,
    ) -> MARKER_ERR_OTHER_SCAN_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn undet_int_clr(&mut self) -> UNDET_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn decode_timeout_int_clr(&mut self) -> DECODE_TIMEOUT_INT_CLR_W<'_, INT_CLR_SPEC> {
        DECODE_TIMEOUT_INT_CLR_W::new(self, 24)
    }
    #[doc = "Bit 25 - The clear interrupt bit to sign that encode can not output bitstream time is longer than the setting encode timeout time when encoding."]
    #[inline(always)]
    pub fn encode_timeout_int_clr(&mut self) -> ENCODE_TIMEOUT_INT_CLR_W<'_, INT_CLR_SPEC> {
        ENCODE_TIMEOUT_INT_CLR_W::new(self, 25)
    }
}
