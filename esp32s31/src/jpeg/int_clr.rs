...
#[doc = "Field `ENCODE_TIMEOUT` writer - The clear interrupt bit to sign that encode can not output bitstream time is longer than the setting encode timeout time when encoding."]
pub type ENCODE_TIMEOUT_W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn rle_parallel_err(&mut self) -> RLE_PARALLEL_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn cid_err(&mut self) -> CID_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn c_dht_dc_id_err(&mut self) -> C_DHT_DC_ID_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn c_dht_ac_id_err(&mut self) -> C_DHT_AC_ID_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn c_dqt_id_err(&mut self) -> C_DQT_ID_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rst_uxp_err(&mut self) -> RST_UXP_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rst_check_none_err(&mut self) -> RST_CHECK_NONE_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rst_check_pos_err(&mut self) -> RST_CHECK_POS_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn scan_check_none_err(&mut self) -> SCAN_CHECK_NONE_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn scan_check_pos_err(&mut self) -> SCAN_CHECK_POS_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn uxp_det(&mut self) -> UXP_DET_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn en_frame_eof_err(&mut self) -> EN_FRAME_EOF_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn en_frame_eof_lack(&mut self) -> EN_FRAME_EOF_LACK_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn de_frame_eof_err(&mut self) -> DE_FRAME_EOF_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn de_frame_eof_lack(&mut self) -> DE_FRAME_EOF_LACK_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn sos_unmatch_err(&mut self) -> SOS_UNMATCH_ERR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn marker_err_fst_scan(&mut self) -> MARKER_ERR_FST_SCAN_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn marker_err_other_scan(&mut self) -> MARKER_ERR_OTHER_SCAN_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn undet(&mut self) -> UNDET_W<'_, INT_CLR_SPEC> {
        UNDET_W::new(self, 23)
    }
    ...
    #[inline(always)]
    pub fn decode_timeout(&mut self) -> DECODE_TIMEOUT_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn encode_timeout(&mut self) -> ENCODE_TIMEOUT_W<'_, INT_CLR_SPEC> {
...
impl crate::Writable for INT_CLR_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x03ff_ffff;
}
