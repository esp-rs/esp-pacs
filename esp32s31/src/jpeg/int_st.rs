...
#[doc = "Field `ENCODE_TIMEOUT` reader - The status interrupt bit to sign that encode can not output bitstream time is longer than the setting encode timeout time when encoding."]
