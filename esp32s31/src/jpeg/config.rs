...
#[doc = "Field `COLOR_SPACE` reader - configure picture's color space:0-rgb888,1-yuv422,2-rgb565,3-gray,4-yuv444,5-yuv420"]
pub type COLOR_SPACE_R = crate::FieldReader;
#[doc = "Field `COLOR_SPACE` writer - configure picture's color space:0-rgb888,1-yuv422,2-rgb565,3-gray,4-yuv444,5-yuv420"]
pub type COLOR_SPACE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
impl R {
    ...
    #[doc = "Bit 6 - 0:normal mode,1:debug mode for direct output from input"]
    #[inline(always)]
    pub fn debug_direct_out_en(&self) -> DEBUG_DIRECT_OUT_EN_R {
        DEBUG_DIRECT_OUT_EN_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - 0:use non-fifo way to access qnr ram,1:use fifo way to access qnr ram"]
    #[inline(always)]
    pub fn qnr_fifo_en(&self) -> QNR_FIFO_EN_R {
        QNR_FIFO_EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bits 8:9 - choose luminance quntization table id(TBD)"]
    #[inline(always)]
    pub fn lqnr_tbl_sel(&self) -> LQNR_TBL_SEL_R {
        LQNR_TBL_SEL_R::new(((self.bits >> 8) & 3) as u8)
    }
    #[doc = "Bits 10:11 - choose chrominance quntization table id (TBD)"]
    #[inline(always)]
    pub fn cqnr_tbl_sel(&self) -> CQNR_TBL_SEL_R {
        CQNR_TBL_SEL_R::new(((self.bits >> 10) & 3) as u8)
    }
    #[doc = "Bits 12:14 - configure picture's color space:0-rgb888,1-yuv422,2-rgb565,3-gray,4-yuv444,5-yuv420"]
    #[inline(always)]
    pub fn color_space(&self) -> COLOR_SPACE_R {
        COLOR_SPACE_R::new(((self.bits >> 12) & 7) as u8)
    }
...
#[doc = "`reset()` method sets CONFIG to value 0x0040_8498"]
impl crate::Resettable for CONFIG_SPEC {
    const RESET_VALUE: u32 = 0x0040_8498;
}
