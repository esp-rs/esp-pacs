...
#[doc = "Field `CNT_THR_H_STEP_LAT_U` reader - Represents the latched value of step counter event of PCNT_U%s when step counter event interrupt is valid. 1: the current pulse counter decrement equals to reg_cnt_step and step counter event is valid. 0: others"]
pub type CNT_THR_H_STEP_LAT_U_R = crate::BitReader;
#[doc = "Field `CNT_THR_L_STEP_LAT_U` reader - Represents the latched value of step counter event of PCNT_U%s when step counter event interrupt is valid. 1: the current pulse counter increment equals to reg_cnt_step and step counter event is valid. 0: others"]
pub type CNT_THR_L_STEP_LAT_U_R = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn cnt_thr_h_step_lat_u(&self) -> CNT_THR_H_STEP_LAT_U_R {
        CNT_THR_H_STEP_LAT_U_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn cnt_thr_l_step_lat_u(&self) -> CNT_THR_L_STEP_LAT_U_R {
        CNT_THR_L_STEP_LAT_U_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("U_STATUS")
            ...
            .field("cnt_thr_h_step_lat_u", &self.cnt_thr_h_step_lat_u())
            .field("cnt_thr_l_step_lat_u", &self.cnt_thr_l_step_lat_u())
            .finish()
    }
}
