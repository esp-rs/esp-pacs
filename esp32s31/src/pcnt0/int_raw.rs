...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW")
            .field("cnt_thr_event_u0_int_raw", &self.cnt_thr_event_u0_int_raw())
            .field("cnt_thr_event_u1_int_raw", &self.cnt_thr_event_u1_int_raw())
            .field("cnt_thr_event_u2_int_raw", &self.cnt_thr_event_u2_int_raw())
            .field("cnt_thr_event_u3_int_raw", &self.cnt_thr_event_u3_int_raw())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - The raw interrupt status bit for the PCNT_CNT_THR_EVENT_U0_INT interrupt."]
    #[inline(always)]
    pub fn cnt_thr_event_u0_int_raw(&mut self) -> CNT_THR_EVENT_U0_INT_RAW_W<'_, INT_RAW_SPEC> {
        CNT_THR_EVENT_U0_INT_RAW_W::new(self, 0)
    }
    #[doc = "Bit 1 - The raw interrupt status bit for the PCNT_CNT_THR_EVENT_U1_INT interrupt."]
    #[inline(always)]
    pub fn cnt_thr_event_u1_int_raw(&mut self) -> CNT_THR_EVENT_U1_INT_RAW_W<'_, INT_RAW_SPEC> {
        CNT_THR_EVENT_U1_INT_RAW_W::new(self, 1)
    }
    #[doc = "Bit 2 - The raw interrupt status bit for the PCNT_CNT_THR_EVENT_U2_INT interrupt."]
    #[inline(always)]
    pub fn cnt_thr_event_u2_int_raw(&mut self) -> CNT_THR_EVENT_U2_INT_RAW_W<'_, INT_RAW_SPEC> {
        CNT_THR_EVENT_U2_INT_RAW_W::new(self, 2)
    }
    #[doc = "Bit 3 - The raw interrupt status bit for the PCNT_CNT_THR_EVENT_U3_INT interrupt."]
    #[inline(always)]
    pub fn cnt_thr_event_u3_int_raw(&mut self) -> CNT_THR_EVENT_U3_INT_RAW_W<'_, INT_RAW_SPEC> {
