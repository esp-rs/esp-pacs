...
#[doc = "Field `ENA_SW_SEL_SYS_CLK` reader - "]
...
#[doc = "Field `SW_SYS_CLK_SRC_SEL` reader - "]
pub type SW_SYS_CLK_SRC_SEL_R = crate::BitReader;
#[doc = "Field `SW_SYS_CLK_SRC_SEL` writer - "]
...
impl W {
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn ena_sw_sel_sys_clk(&mut self) -> ENA_SW_SEL_SYS_CLK_W<'_, CLK_SEL_CTRL_SPEC> {
        ENA_SW_SEL_SYS_CLK_W::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    pub fn sw_sys_clk_src_sel(&mut self) -> SW_SYS_CLK_SRC_SEL_W<'_, CLK_SEL_CTRL_SPEC> {
