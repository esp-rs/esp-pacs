...
#[doc = "Field `LP_CPU_BOOT_ADDR` reader - "]
pub type LP_CPU_BOOT_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `LP_CPU_BOOT_ADDR` writer - "]
...
#[doc = "`reset()` method sets LP_CORE_BOOT_ADDR to value 0x2e00_0000"]
impl crate::Resettable for LP_CORE_BOOT_ADDR_SPEC {
    const RESET_VALUE: u32 = 0x2e00_0000;
}
