...
#[doc = "Field `EXT_WAKEUP1_STATUS` reader - "]
pub type EXT_WAKEUP1_STATUS_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
    pub fn ext_wakeup1_status(&self) -> EXT_WAKEUP1_STATUS_R {
        EXT_WAKEUP1_STATUS_R::new((self.bits & 0xff) as u8)
    }
}
...
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`ext_wakeup1_status::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
