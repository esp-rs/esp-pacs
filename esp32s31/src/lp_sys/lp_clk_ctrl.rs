...
#[doc = "Field `LP_FOSC_HP_CKEN` reader - "]
pub type LP_FOSC_HP_CKEN_R = crate::BitReader;
#[doc = "Field `LP_FOSC_HP_CKEN` writer - "]
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn clk_en(&mut self) -> CLK_EN_W<'_, LP_CLK_CTRL_SPEC> {
        CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn lp_fosc_hp_cken(&mut self) -> LP_FOSC_HP_CKEN_W<'_, LP_CLK_CTRL_SPEC> {
