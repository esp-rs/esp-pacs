...
impl R {
    ...
    #[doc = "Bits 22:24"]
    #[inline(always)]
    pub fn regdma_error(&self) -> REGDMA_ERROR_R {
        REGDMA_ERROR_R::new(((self.bits >> 22) & 7) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BACKUP_DMA_CFG0")
            ...
            .field("regdma_error", &self.regdma_error())
            .finish()
    }
}
impl W {
    ...
    pub fn link_backup_tout_thres_aon(
        &mut self,
    ) -> LINK_BACKUP_TOUT_THRES_AON_W<'_, BACKUP_DMA_CFG0_SPEC> {
...
#[doc = "`reset()` method sets BACKUP_DMA_CFG0 to value 0x0006_414a"]
impl crate::Resettable for BACKUP_DMA_CFG0_SPEC {
    const RESET_VALUE: u32 = 0x0006_414a;
}
