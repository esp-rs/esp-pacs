...
#[doc = "Field `LP_CORE_ERR_RESP_DIS` reader - "]
pub type LP_CORE_ERR_RESP_DIS_R = crate::FieldReader;
#[doc = "Field `LP_CORE_ERR_RESP_DIS` writer - "]
...
impl W {
    #[doc = "Bits 0:2"]
    #[inline(always)]
    pub fn lp_core_err_resp_dis(
        &mut self,
    ) -> LP_CORE_ERR_RESP_DIS_W<'_, LP_CORE_ERR_RESP_DIS_SPEC> {
