...
#[doc = "Field `LP_TCM_RAM_RDN_ECO_EN` reader - "]
pub type LP_TCM_RAM_RDN_ECO_EN_R = crate::BitReader;
#[doc = "Field `LP_TCM_RAM_RDN_ECO_EN` writer - "]
pub type LP_TCM_RAM_RDN_ECO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_TCM_RAM_RDN_ECO_RESULT` reader - "]
...
impl W {
    ...
    pub fn lp_tcm_ram_rdn_eco_en(
        &mut self,
    ) -> LP_TCM_RAM_RDN_ECO_EN_W<'_, LP_TCM_RAM_RDN_ECO_CS_SPEC> {
