...
#[doc = "Field `FIFO_OVERFLOW_INT_RAW` reader - need_des"]
pub type FIFO_OVERFLOW_INT_RAW_R = crate::BitReader;
#[doc = "Field `FIFO_OVERFLOW_INT_RAW` writer - need_des"]
pub type FIFO_OVERFLOW_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
    pub fn fifo_overflow_int_raw(&self) -> FIFO_OVERFLOW_INT_RAW_R {
        FIFO_OVERFLOW_INT_RAW_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW")
            .field("fifo_overflow_int_raw", &self.fifo_overflow_int_raw())
            .field("thres1_low_int_raw", &self.thres1_low_int_raw())
            .field("thres0_low_int_raw", &self.thres0_low_int_raw())
            .field("thres1_high_int_raw", &self.thres1_high_int_raw())
            .field("thres0_high_int_raw", &self.thres0_high_int_raw())
            .field("sar2_done_int_raw", &self.sar2_done_int_raw())
            .field("sar1_done_int_raw", &self.sar1_done_int_raw())
            .finish()
    }
}
impl W {
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
    pub fn fifo_overflow_int_raw(&mut self) -> FIFO_OVERFLOW_INT_RAW_W<'_, INT_RAW_SPEC> {
        FIFO_OVERFLOW_INT_RAW_W::new(self, 25)
    }
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn thres1_low_int_raw(&mut self) -> THRES1_LOW_INT_RAW_W<'_, INT_RAW_SPEC> {
        THRES1_LOW_INT_RAW_W::new(self, 26)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn thres0_low_int_raw(&mut self) -> THRES0_LOW_INT_RAW_W<'_, INT_RAW_SPEC> {
        THRES0_LOW_INT_RAW_W::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn thres1_high_int_raw(&mut self) -> THRES1_HIGH_INT_RAW_W<'_, INT_RAW_SPEC> {
        THRES1_HIGH_INT_RAW_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn thres0_high_int_raw(&mut self) -> THRES0_HIGH_INT_RAW_W<'_, INT_RAW_SPEC> {
        THRES0_HIGH_INT_RAW_W::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn sar2_done_int_raw(&mut self) -> SAR2_DONE_INT_RAW_W<'_, INT_RAW_SPEC> {
        SAR2_DONE_INT_RAW_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn sar1_done_int_raw(&mut self) -> SAR1_DONE_INT_RAW_W<'_, INT_RAW_SPEC> {
