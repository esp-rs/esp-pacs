...
#[doc = "Field `ADC_RND_ECO_HIGH` reader - rnd eco high"]
pub type ADC_RND_ECO_HIGH_R = crate::FieldReader<u32>;
#[doc = "Field `ADC_RND_ECO_HIGH` writer - rnd eco high"]
pub type ADC_RND_ECO_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - rnd eco high"]
    #[inline(always)]
    pub fn adc_rnd_eco_high(&self) -> ADC_RND_ECO_HIGH_R {
        ADC_RND_ECO_HIGH_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RND_ECO_HIGH")
            .field("adc_rnd_eco_high", &self.adc_rnd_eco_high())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - rnd eco high"]
    #[inline(always)]
    pub fn adc_rnd_eco_high(&mut self) -> ADC_RND_ECO_HIGH_W<'_, RND_ECO_HIGH_SPEC> {
        ADC_RND_ECO_HIGH_W::new(self, 0)
    }
}
