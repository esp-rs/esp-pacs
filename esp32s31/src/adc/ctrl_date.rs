...
impl W {
    #[doc = "Bits 0:30 - need_des"]
    #[inline(always)]
    pub fn ctrl_date(&mut self) -> CTRL_DATE_W<'_, CTRL_DATE_SPEC> {
        CTRL_DATE_W::new(self, 0)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn clk_en(&mut self) -> CLK_EN_W<'_, CTRL_DATE_SPEC> {
...
#[doc = "`reset()` method sets CTRL_DATE to value 0x0250_8220"]
impl crate::Resettable for CTRL_DATE_SPEC {
    const RESET_VALUE: u32 = 0x0250_8220;
}
