...
#[doc = "Field `DMA_EOF_NUM_CLR` writer - clear eof cnt"]
pub type DMA_EOF_NUM_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMA_CONF")
            .field("apb_adc_eof_num", &self.apb_adc_eof_num())
            .field("apb_adc_trans", &self.apb_adc_trans())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:15 - the dma_in_suc_eof gen when sample cnt = spi_eof_num"]
    #[inline(always)]
    pub fn apb_adc_eof_num(&mut self) -> APB_ADC_EOF_NUM_W<'_, DMA_CONF_SPEC> {
        APB_ADC_EOF_NUM_W::new(self, 0)
    }
    #[doc = "Bit 16 - clear eof cnt"]
    #[inline(always)]
    pub fn dma_eof_num_clr(&mut self) -> DMA_EOF_NUM_CLR_W<'_, DMA_CONF_SPEC> {
        DMA_EOF_NUM_CLR_W::new(self, 16)
    }
    #[doc = "Bit 31 - enable apb_adc use spi_dma"]
    #[inline(always)]
    pub fn apb_adc_trans(&mut self) -> APB_ADC_TRANS_W<'_, DMA_CONF_SPEC> {
