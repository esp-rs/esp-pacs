...
#[doc = "Field `SAR2_STATE` reader - "]
pub type SAR2_STATE_R = crate::FieldReader;
impl R {
    #[doc = "Bits 29:31"]
    #[inline(always)]
    pub fn sar2_state(&self) -> SAR2_STATE_R {
        SAR2_STATE_R::new(((self.bits >> 29) & 7) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR2_STATUS")
            .field("sar2_state", &self.sar2_state())
            .finish()
    }
}
