...
#[doc = "Field `ADC_RND_ECO_LOW` reader - rnd eco low"]
pub type ADC_RND_ECO_LOW_R = crate::FieldReader<u32>;
#[doc = "Field `ADC_RND_ECO_LOW` writer - rnd eco low"]
pub type ADC_RND_ECO_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - rnd eco low"]
    #[inline(always)]
    pub fn adc_rnd_eco_low(&self) -> ADC_RND_ECO_LOW_R {
        ADC_RND_ECO_LOW_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RND_ECO_LOW")
            .field("adc_rnd_eco_low", &self.adc_rnd_eco_low())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - rnd eco low"]
    #[inline(always)]
    pub fn adc_rnd_eco_low(&mut self) -> ADC_RND_ECO_LOW_W<'_, RND_ECO_LOW_SPEC> {
        ADC_RND_ECO_LOW_W::new(self, 0)
    }
}
