...
impl R {
    ...
    pub fn thres1_en(&self) -> THRES1_EN_R {
        THRES1_EN_R::new(((self.bits >> 5) & 1) != 0)
    }
}
...
impl W {
    ...
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    pub fn thres1_en(&mut self) -> THRES1_EN_W<'_, THRES1_CTRL_SPEC> {
        THRES1_EN_W::new(self, 5)
    }
}
...
#[doc = "`reset()` method sets THRES1_CTRL to value 0x0d"]
