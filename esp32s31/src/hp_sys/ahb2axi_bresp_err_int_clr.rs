...
#[doc = "Field `SDMMC_ICM_H2X_BRESP_ERR_INT_CLR` writer - Write 1 to clear sdmmc_icm_h2x_bresp_err int"]
pub type SDMMC_ICM_H2X_BRESP_ERR_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn sdmmc_icm_h2x_bresp_err_int_clr(
        &mut self,
    ) -> SDMMC_ICM_H2X_BRESP_ERR_INT_CLR_W<'_, AHB2AXI_BRESP_ERR_INT_CLR_SPEC> {
        SDMMC_ICM_H2X_BRESP_ERR_INT_CLR_W::new(self, 30)
    }
