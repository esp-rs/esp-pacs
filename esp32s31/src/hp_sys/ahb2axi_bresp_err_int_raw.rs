...
#[doc = "Field `SDMMC_ICM_H2X_BRESP_ERR_INT_RAW` reader - the raw interrupt status of bresp error, triggered when if bresp err occurs in post write mode in ahb2axi."]
pub type SDMMC_ICM_H2X_BRESP_ERR_INT_RAW_R = crate::BitReader;
#[doc = "Field `SDMMC_ICM_H2X_BRESP_ERR_INT_RAW` writer - the raw interrupt status of bresp error, triggered when if bresp err occurs in post write mode in ahb2axi."]
pub type SDMMC_ICM_H2X_BRESP_ERR_INT_RAW_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn sdmmc_icm_h2x_bresp_err_int_raw(&self) -> SDMMC_ICM_H2X_BRESP_ERR_INT_RAW_R {
        SDMMC_ICM_H2X_BRESP_ERR_INT_RAW_R::new(((self.bits >> 30) & 1) != 0)
    }
    ...
    pub fn cpu_icm_h2x_bresp_err_int_raw(&self) -> CPU_ICM_H2X_BRESP_ERR_INT_RAW_R {
        CPU_ICM_H2X_BRESP_ERR_INT_RAW_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHB2AXI_BRESP_ERR_INT_RAW")
            .field(
                "sdmmc_icm_h2x_bresp_err_int_raw",
                &self.sdmmc_icm_h2x_bresp_err_int_raw(),
            )
            .field(
...
impl W {
    #[doc = "Bit 30 - the raw interrupt status of bresp error, triggered when if bresp err occurs in post write mode in ahb2axi."]
    #[inline(always)]
    pub fn sdmmc_icm_h2x_bresp_err_int_raw(
        &mut self,
    ) -> SDMMC_ICM_H2X_BRESP_ERR_INT_RAW_W<'_, AHB2AXI_BRESP_ERR_INT_RAW_SPEC> {
        SDMMC_ICM_H2X_BRESP_ERR_INT_RAW_W::new(self, 30)
    }
    #[doc = "Bit 31 - the raw interrupt status of bresp error, triggered when if bresp err occurs in post write mode in ahb2axi."]
    #[inline(always)]
    pub fn cpu_icm_h2x_bresp_err_int_raw(
        ...
        CPU_ICM_H2X_BRESP_ERR_INT_RAW_W::new(self, 31)
    }
}
