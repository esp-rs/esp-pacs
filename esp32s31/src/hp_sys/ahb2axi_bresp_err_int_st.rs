...
#[doc = "Field `SDMMC_ICM_H2X_BRESP_ERR_INT_ST` reader - the masked interrupt status of sdmmc_icm_h2x_bresp_err"]
pub type SDMMC_ICM_H2X_BRESP_ERR_INT_ST_R = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn sdmmc_icm_h2x_bresp_err_int_st(&self) -> SDMMC_ICM_H2X_BRESP_ERR_INT_ST_R {
        SDMMC_ICM_H2X_BRESP_ERR_INT_ST_R::new(((self.bits >> 30) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHB2AXI_BRESP_ERR_INT_ST")
            .field(
                "sdmmc_icm_h2x_bresp_err_int_st",
                &self.sdmmc_icm_h2x_bresp_err_int_st(),
            )
            .field(
