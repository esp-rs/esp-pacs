...
impl W {
    #[doc = "Bits 0:31 - register for DV"]
    #[inline(always)]
    pub fn hp_dfv0(&mut self) -> HP_DFV0_W<'_, HP_DESIGN_FOR_VERIFICATION0_SPEC> {
        HP_DFV0_W::new(self, 0)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_design_for_verification0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_design_for_verification0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
