    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_CORE_TIMEOUT_INT_ENA")
            .field(
                ...
                &self.hp_core0_ibus_timeout_int_ena(),
            )
            .field(
                "hp_core1_ibus_timeout_int_ena",
                &self.hp_core1_ibus_timeout_int_ena(),
            )
            .field(
                "hp_core0_dbus_timeout_int_ena",
                &self.hp_core0_dbus_timeout_int_ena(),
            )
            .field(
                "hp_core1_dbus_timeout_int_ena",
                &self.hp_core1_dbus_timeout_int_ena(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn hp_core0_ibus_timeout_int_ena(
        &mut self,
    ) -> HP_CORE0_IBUS_TIMEOUT_INT_ENA_W<'_, HP_CORE_TIMEOUT_INT_ENA_SPEC> {
    ...
    pub fn hp_core1_ibus_timeout_int_ena(
        &mut self,
    ) -> HP_CORE1_IBUS_TIMEOUT_INT_ENA_W<'_, HP_CORE_TIMEOUT_INT_ENA_SPEC> {
    ...
    pub fn hp_core0_dbus_timeout_int_ena(
        &mut self,
    ) -> HP_CORE0_DBUS_TIMEOUT_INT_ENA_W<'_, HP_CORE_TIMEOUT_INT_ENA_SPEC> {
    ...
    pub fn hp_core1_dbus_timeout_int_ena(
        &mut self,
    ) -> HP_CORE1_DBUS_TIMEOUT_INT_ENA_W<'_, HP_CORE_TIMEOUT_INT_ENA_SPEC> {
        HP_CORE1_DBUS_TIMEOUT_INT_ENA_W::new(self, 5)
    }
}
#[doc = "masked interrupt register\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_core_timeout_int_ena::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_core_timeout_int_ena::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
