    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_CORE_TIMEOUT_INT_ST")
            .field(
                ...
                &self.hp_core0_ibus_timeout_int_st(),
            )
            .field(
                "hp_core1_ibus_timeout_int_st",
                &self.hp_core1_ibus_timeout_int_st(),
            )
            .field(
                "hp_core0_dbus_timeout_int_st",
                &self.hp_core0_dbus_timeout_int_st(),
            )
            .field(
                "hp_core1_dbus_timeout_int_st",
                &self.hp_core1_dbus_timeout_int_st(),
            )
            .finish()
    }
}
#[doc = "masked interrupt register\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_core_timeout_int_st::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
