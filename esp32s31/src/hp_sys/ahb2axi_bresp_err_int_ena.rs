...
#[doc = "Field `SDMMC_ICM_H2X_BRESP_ERR_INT_ENA` reader - Write 1 to enable sdmmc_icm_h2x_bresp_err int"]
pub type SDMMC_ICM_H2X_BRESP_ERR_INT_ENA_R = crate::BitReader;
#[doc = "Field `SDMMC_ICM_H2X_BRESP_ERR_INT_ENA` writer - Write 1 to enable sdmmc_icm_h2x_bresp_err int"]
pub type SDMMC_ICM_H2X_BRESP_ERR_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn sdmmc_icm_h2x_bresp_err_int_ena(&self) -> SDMMC_ICM_H2X_BRESP_ERR_INT_ENA_R {
        SDMMC_ICM_H2X_BRESP_ERR_INT_ENA_R::new(((self.bits >> 30) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHB2AXI_BRESP_ERR_INT_ENA")
            .field(
                "sdmmc_icm_h2x_bresp_err_int_ena",
                &self.sdmmc_icm_h2x_bresp_err_int_ena(),
            )
            .field(
...
impl W {
    #[doc = "Bit 30 - Write 1 to enable sdmmc_icm_h2x_bresp_err int"]
    #[inline(always)]
    pub fn sdmmc_icm_h2x_bresp_err_int_ena(
        &mut self,
    ) -> SDMMC_ICM_H2X_BRESP_ERR_INT_ENA_W<'_, AHB2AXI_BRESP_ERR_INT_ENA_SPEC> {
        SDMMC_ICM_H2X_BRESP_ERR_INT_ENA_W::new(self, 30)
    }
    #[doc = "Bit 31 - Write 1 to enable cpu_icm_h2x_bresp_err int"]
    #[inline(always)]
    pub fn cpu_icm_h2x_bresp_err_int_ena(
        &mut self,
    ) -> CPU_ICM_H2X_BRESP_ERR_INT_ENA_W<'_, AHB2AXI_BRESP_ERR_INT_ENA_SPEC> {
