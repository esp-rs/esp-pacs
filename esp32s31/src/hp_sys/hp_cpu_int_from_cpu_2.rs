...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_CPU_INT_FROM_CPU_2")
            .field("hp_cpu_int_from_cpu_2", &self.hp_cpu_int_from_cpu_2())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - set 1 will triger a interrupt"]
    #[inline(always)]
    pub fn hp_cpu_int_from_cpu_2(
        &mut self,
    ) -> HP_CPU_INT_FROM_CPU_2_W<'_, HP_CPU_INT_FROM_CPU_2_SPEC> {
        HP_CPU_INT_FROM_CPU_2_W::new(self, 0)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_cpu_int_from_cpu_2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_cpu_int_from_cpu_2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
