...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_PROBEB_CTRL")
            .field("hp_reg_probe_b_mod_sel", &self.hp_reg_probe_b_mod_sel())
            .field("hp_reg_probe_b_top_sel", &self.hp_reg_probe_b_top_sel())
            .field("hp_reg_probe_b_en", &self.hp_reg_probe_b_en())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:15 - Tihs field is used to selec probe_group from probe_group0 to probe_group15 for module's probe_out\\[31:0\\] in b mode."]
    #[inline(always)]
    pub fn hp_reg_probe_b_mod_sel(&mut self) -> HP_REG_PROBE_B_MOD_SEL_W<'_, HP_PROBEB_CTRL_SPEC> {
        HP_REG_PROBE_B_MOD_SEL_W::new(self, 0)
    }
    #[doc = "Bits 16:23 - Tihs field is used to select module's probe_out\\[31:0\\] as probe_out in b mode"]
    #[inline(always)]
    pub fn hp_reg_probe_b_top_sel(&mut self) -> HP_REG_PROBE_B_TOP_SEL_W<'_, HP_PROBEB_CTRL_SPEC> {
        HP_REG_PROBE_B_TOP_SEL_W::new(self, 16)
    }
    #[doc = "Bit 24 - Set this bit to enable b mode for debug probe. 1: b mode, 0: a mode."]
    #[inline(always)]
    pub fn hp_reg_probe_b_en(&mut self) -> HP_REG_PROBE_B_EN_W<'_, HP_PROBEB_CTRL_SPEC> {
        HP_REG_PROBE_B_EN_W::new(self, 24)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_probeb_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_probeb_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
