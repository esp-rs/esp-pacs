...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_PROBEA_CTRL")
            .field("hp_reg_probe_a_mod_sel", &self.hp_reg_probe_a_mod_sel())
            .field("hp_reg_probe_a_top_sel", &self.hp_reg_probe_a_top_sel())
            .field("hp_reg_probe_l_sel", &self.hp_reg_probe_l_sel())
            .field("hp_reg_probe_h_sel", &self.hp_reg_probe_h_sel())
            .field("hp_reg_probe_global_en", &self.hp_reg_probe_global_en())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:15 - Tihs field is used to selec probe_group from probe_group0 to probe_group15 for module's probe_out\\[31:0\\] in a mode"]
    #[inline(always)]
    pub fn hp_reg_probe_a_mod_sel(&mut self) -> HP_REG_PROBE_A_MOD_SEL_W<'_, HP_PROBEA_CTRL_SPEC> {
        HP_REG_PROBE_A_MOD_SEL_W::new(self, 0)
    }
    #[doc = "Bits 16:23 - Tihs field is used to selec module's probe_out\\[31:0\\] as probe out in a mode"]
    #[inline(always)]
    pub fn hp_reg_probe_a_top_sel(&mut self) -> HP_REG_PROBE_A_TOP_SEL_W<'_, HP_PROBEA_CTRL_SPEC> {
        HP_REG_PROBE_A_TOP_SEL_W::new(self, 16)
    }
    #[doc = "Bits 24:25 - Tihs field is used to selec probe_out\\[31:16\\]"]
    #[inline(always)]
    pub fn hp_reg_probe_l_sel(&mut self) -> HP_REG_PROBE_L_SEL_W<'_, HP_PROBEA_CTRL_SPEC> {
        HP_REG_PROBE_L_SEL_W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Tihs field is used to selec probe_out\\[31:16\\]"]
    #[inline(always)]
    pub fn hp_reg_probe_h_sel(&mut self) -> HP_REG_PROBE_H_SEL_W<'_, HP_PROBEA_CTRL_SPEC> {
        HP_REG_PROBE_H_SEL_W::new(self, 26)
    }
    #[doc = "Bit 28 - Set this bit to enable global debug probe in hp system."]
    #[inline(always)]
    pub fn hp_reg_probe_global_en(&mut self) -> HP_REG_PROBE_GLOBAL_EN_W<'_, HP_PROBEA_CTRL_SPEC> {
        HP_REG_PROBE_GLOBAL_EN_W::new(self, 28)
    }
}
#[doc = "NA\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_probea_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_probea_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
