    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_CRYPTO_CTRL")
            .field(
                ...
                &self.hp_reg_enable_spi_manual_encrypt(),
            )
            .field(
                "hp_reg_enable_download_db_encrypt",
                &self.hp_reg_enable_download_db_encrypt(),
            )
            .field(
                "hp_reg_enable_download_g0cb_decrypt",
                &self.hp_reg_enable_download_g0cb_decrypt(),
            )
            .field(
                "hp_reg_enable_download_manual_encrypt",
                &self.hp_reg_enable_download_manual_encrypt(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn hp_reg_enable_spi_manual_encrypt(
        &mut self,
    ) -> HP_REG_ENABLE_SPI_MANUAL_ENCRYPT_W<'_, HP_CRYPTO_CTRL_SPEC> {
    ...
    pub fn hp_reg_enable_download_db_encrypt(
        &mut self,
    ) -> HP_REG_ENABLE_DOWNLOAD_DB_ENCRYPT_W<'_, HP_CRYPTO_CTRL_SPEC> {
    ...
    pub fn hp_reg_enable_download_g0cb_decrypt(
        &mut self,
    ) -> HP_REG_ENABLE_DOWNLOAD_G0CB_DECRYPT_W<'_, HP_CRYPTO_CTRL_SPEC> {
    ...
    pub fn hp_reg_enable_download_manual_encrypt(
        &mut self,
    ) -> HP_REG_ENABLE_DOWNLOAD_MANUAL_ENCRYPT_W<'_, HP_CRYPTO_CTRL_SPEC> {
