    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_CPU_WAITI_CONF")
            .field(
                ...
                &self.hp_cpu_wait_mode_force_on(),
            )
            .field("hp_cpu_waiti_delay_num", &self.hp_cpu_waiti_delay_num())
            .finish()
    }
}
impl W {
    ...
    pub fn hp_cpu_wait_mode_force_on(
        &mut self,
    ) -> HP_CPU_WAIT_MODE_FORCE_ON_W<'_, HP_CPU_WAITI_CONF_SPEC> {
        HP_CPU_WAIT_MODE_FORCE_ON_W::new(self, 0)
    }
    #[doc = "Bits 1:4 - This field used to set delay cycle when cpu enter waiti mode, after delay waiti_clk will close"]
    #[inline(always)]
    pub fn hp_cpu_waiti_delay_num(
        &mut self,
    ) -> HP_CPU_WAITI_DELAY_NUM_W<'_, HP_CPU_WAITI_CONF_SPEC> {
        HP_CPU_WAITI_DELAY_NUM_W::new(self, 1)
    }
}
#[doc = "CPU_WAITI configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`hp_cpu_waiti_conf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hp_cpu_waiti_conf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
