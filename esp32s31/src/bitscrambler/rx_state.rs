...
#[doc = "Field `RX_CRC_RDY` reader - represents the crc calculate result of bitscrambler rx path is ready"]
pub type RX_CRC_RDY_R = crate::BitReader;
...
impl R {
    ...
    #[doc = "Bit 5 - represents the crc calculate result of bitscrambler rx path is ready"]
    #[inline(always)]
    pub fn rx_crc_rdy(&self) -> RX_CRC_RDY_R {
        RX_CRC_RDY_R::new(((self.bits >> 5) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_STATE")
            ...
            .field("rx_crc_rdy", &self.rx_crc_rdy())
...
impl W {
    ...
    #[inline(always)]
    pub fn rx_eof_trace_clr(&mut self) -> RX_EOF_TRACE_CLR_W<'_, RX_STATE_SPEC> {
