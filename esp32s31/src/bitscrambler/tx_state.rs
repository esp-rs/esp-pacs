...
#[doc = "Field `TX_CRC_RDY` reader - represents the crc calculate result of bitscrambler tx path is ready"]
pub type TX_CRC_RDY_R = crate::BitReader;
...
impl R {
    ...
    #[doc = "Bit 5 - represents the crc calculate result of bitscrambler tx path is ready"]
    #[inline(always)]
    pub fn tx_crc_rdy(&self) -> TX_CRC_RDY_R {
        TX_CRC_RDY_R::new(((self.bits >> 5) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TX_STATE")
            ...
            .field("tx_crc_rdy", &self.tx_crc_rdy())
...
impl W {
    ...
    #[inline(always)]
    pub fn tx_eof_trace_clr(&mut self) -> TX_EOF_TRACE_CLR_W<'_, TX_STATE_SPEC> {
...
#[doc = "`reset()` method sets TX_STATE to value 0x11"]
