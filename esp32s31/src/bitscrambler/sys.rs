...
#[doc = "Field `CLK_EN` reader - Write this bit to enable the configuration register clock to be always-on. 0: turn on during access, 1: always-on."]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Write this bit to enable the configuration register clock to be always-on. 0: turn on during access, 1: always-on."]
...
impl R {
    ...
    #[doc = "Bit 31 - Write this bit to enable the configuration register clock to be always-on. 0: turn on during access, 1: always-on."]
    #[inline(always)]
