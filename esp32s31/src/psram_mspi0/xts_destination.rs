...
#[doc = "Field `SPI_XTS_DESTINATION` reader - "]
pub type SPI_XTS_DESTINATION_R = crate::BitReader;
#[doc = "Field `SPI_XTS_DESTINATION` writer - "]
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn spi_xts_destination(&mut self) -> SPI_XTS_DESTINATION_W<'_, XTS_DESTINATION_SPEC> {
