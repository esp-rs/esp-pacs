...
#[doc = "Field `USR_DBYTELEN` reader - "]
pub type USR_DBYTELEN_R = crate::FieldReader;
#[doc = "Field `USR_DBYTELEN` writer - "]
pub type USR_DBYTELEN_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
impl R {
    ...
    #[doc = "Bits 6:11"]
    #[inline(always)]
    pub fn usr_dbytelen(&self) -> USR_DBYTELEN_R {
        USR_DBYTELEN_R::new(((self.bits >> 6) & 0x3f) as u8)
    }
    #[doc = "Bits 26:31"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 6:11"]
    #[inline(always)]
    pub fn usr_dbytelen(&mut self) -> USR_DBYTELEN_W<'_, USER1_SPEC> {
        USR_DBYTELEN_W::new(self, 6)
    }
    #[doc = "Bits 26:31"]
    #[inline(always)]
