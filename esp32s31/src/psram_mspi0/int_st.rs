...
#[doc = "Field `ECC_ERR_INT_ST` reader - "]
pub type ECC_ERR_INT_ST_R = crate::BitReader;
#[doc = "Field `PMS_REJECT_INT_ST` reader - "]
pub type PMS_REJECT_INT_ST_R = crate::BitReader;
#[doc = "Field `AXI_RADDR_ERR_INT_ST` reader - "]
pub type AXI_RADDR_ERR_INT_ST_R = crate::BitReader;
#[doc = "Field `AXI_WR_FLASH_ERR_INT_ST` reader - "]
pub type AXI_WR_FLASH_ERR_INT_ST_R = crate::BitReader;
#[doc = "Field `AXI_WADDR_ERR_INT_ST` reader - "]
pub type AXI_WADDR_ERR_INT_ST_R = crate::BitReader;
#[doc = "Field `XTS_FAULT_DETECTED_INT_ST` reader - "]
pub type XTS_FAULT_DETECTED_INT_ST_R = crate::BitReader;
#[doc = "Field `RX_TRANS_OVF_INT_ST` reader - "]
pub type RX_TRANS_OVF_INT_ST_R = crate::BitReader;
#[doc = "Field `TX_TRANS_UDF_INT_ST` reader - "]
pub type TX_TRANS_UDF_INT_ST_R = crate::BitReader;
#[doc = "Field `DQS0_AFIFO_OVF_INT_ST` reader - "]
pub type DQS0_AFIFO_OVF_INT_ST_R = crate::BitReader;
#[doc = "Field `DQS1_AFIFO_OVF_INT_ST` reader - "]
pub type DQS1_AFIFO_OVF_INT_ST_R = crate::BitReader;
#[doc = "Field `BUS_FIFO1_UDF_INT_ST` reader - "]
pub type BUS_FIFO1_UDF_INT_ST_R = crate::BitReader;
#[doc = "Field `BUS_FIFO0_UDF_INT_ST` reader - "]
...
impl R {
    ...
    #[doc = "Bit 13"]
    #[inline(always)]
    pub fn xts_fault_detected_int_st(&self) -> XTS_FAULT_DETECTED_INT_ST_R {
        XTS_FAULT_DETECTED_INT_ST_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    pub fn rx_trans_ovf_int_st(&self) -> RX_TRANS_OVF_INT_ST_R {
        RX_TRANS_OVF_INT_ST_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn tx_trans_udf_int_st(&self) -> TX_TRANS_UDF_INT_ST_R {
        TX_TRANS_UDF_INT_ST_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            ...
            .field(
                "xts_fault_detected_int_st",
                &self.xts_fault_detected_int_st(),
            )
            .field("rx_trans_ovf_int_st", &self.rx_trans_ovf_int_st())
            .field("tx_trans_udf_int_st", &self.tx_trans_udf_int_st())
