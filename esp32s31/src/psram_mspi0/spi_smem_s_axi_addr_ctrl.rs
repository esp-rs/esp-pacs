#[doc = "Register `SPI_SMEM_S_AXI_ADDR_CTRL` reader"]
pub type R = crate::R<SPI_SMEM_S_AXI_ADDR_CTRL_SPEC>;
#[doc = "Field `ALL_FIFO_EMPTY` reader - "]
pub type ALL_FIFO_EMPTY_R = crate::BitReader;
#[doc = "Field `SPI_RDATA_AFIFO_REMPTY` reader - "]
pub type SPI_RDATA_AFIFO_REMPTY_R = crate::BitReader;
#[doc = "Field `SPI_RADDR_AFIFO_REMPTY` reader - "]
pub type SPI_RADDR_AFIFO_REMPTY_R = crate::BitReader;
#[doc = "Field `SPI_WDATA_AFIFO_REMPTY` reader - "]
pub type SPI_WDATA_AFIFO_REMPTY_R = crate::BitReader;
#[doc = "Field `SPI_WBLEN_AFIFO_REMPTY` reader - "]
pub type SPI_WBLEN_AFIFO_REMPTY_R = crate::BitReader;
#[doc = "Field `SPI_ALL_AXI_TRANS_AFIFO_EMPTY` reader - "]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_SMEM_S_AXI_ADDR_CTRL")
...
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`spi_smem_s_axi_addr_ctrl::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SPI_SMEM_S_AXI_ADDR_CTRL_SPEC;
impl crate::RegisterSpec for SPI_SMEM_S_AXI_ADDR_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi_smem_s_axi_addr_ctrl::R`](R) reader structure"]
impl crate::Readable for SPI_SMEM_S_AXI_ADDR_CTRL_SPEC {}
#[doc = "`reset()` method sets SPI_SMEM_S_AXI_ADDR_CTRL to value 0xfc00_0000"]
impl crate::Resettable for SPI_SMEM_S_AXI_ADDR_CTRL_SPEC {
