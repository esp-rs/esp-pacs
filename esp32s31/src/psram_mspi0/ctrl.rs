...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn wdummy_dqs_always_out(&mut self) -> WDUMMY_DQS_ALWAYS_OUT_W<'_, CTRL_SPEC> {
    ...
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn dqs_ie_always_on(&mut self) -> DQS_IE_ALWAYS_ON_W<'_, CTRL_SPEC> {
