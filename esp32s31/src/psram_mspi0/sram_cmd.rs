...
#[doc = "Field `SDUMMY_RIN` reader - "]
pub type SDUMMY_RIN_R = crate::BitReader;
#[doc = "Field `SDUMMY_RIN` writer - "]
pub type SDUMMY_RIN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDUMMY_WOUT` reader - "]
pub type SDUMMY_WOUT_R = crate::BitReader;
#[doc = "Field `SDUMMY_WOUT` writer - "]
pub type SDUMMY_WOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPI_SMEM_S_WDUMMY_DQS_ALWAYS_OUT` reader - "]
pub type SPI_SMEM_S_WDUMMY_DQS_ALWAYS_OUT_R = crate::BitReader;
#[doc = "Field `SPI_SMEM_S_WDUMMY_DQS_ALWAYS_OUT` writer - "]
pub type SPI_SMEM_S_WDUMMY_DQS_ALWAYS_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPI_SMEM_S_WDUMMY_ALWAYS_OUT` reader - "]
pub type SPI_SMEM_S_WDUMMY_ALWAYS_OUT_R = crate::BitReader;
#[doc = "Field `SPI_SMEM_S_WDUMMY_ALWAYS_OUT` writer - "]
pub type SPI_SMEM_S_WDUMMY_ALWAYS_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIN_HEX` reader - "]
pub type SDIN_HEX_R = crate::BitReader;
#[doc = "Field `SDIN_HEX` writer - "]
pub type SDIN_HEX_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDOUT_HEX` reader - "]
pub type SDOUT_HEX_R = crate::BitReader;
#[doc = "Field `SDOUT_HEX` writer - "]
pub type SDOUT_HEX_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPI_SMEM_S_DQS_IE_ALWAYS_ON` reader - "]
pub type SPI_SMEM_S_DQS_IE_ALWAYS_ON_R = crate::BitReader;
#[doc = "Field `SPI_SMEM_S_DQS_IE_ALWAYS_ON` writer - "]
pub type SPI_SMEM_S_DQS_IE_ALWAYS_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPI_SMEM_S_DATA_IE_ALWAYS_ON` reader - "]
pub type SPI_SMEM_S_DATA_IE_ALWAYS_ON_R = crate::BitReader;
#[doc = "Field `SPI_SMEM_S_DATA_IE_ALWAYS_ON` writer - "]
pub type SPI_SMEM_S_DATA_IE_ALWAYS_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:1"]
    #[inline(always)]
    ...
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn spi_smem_s_wdummy_dqs_always_out(&self) -> SPI_SMEM_S_WDUMMY_DQS_ALWAYS_OUT_R {
        SPI_SMEM_S_WDUMMY_DQS_ALWAYS_OUT_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn spi_smem_s_wdummy_always_out(&self) -> SPI_SMEM_S_WDUMMY_ALWAYS_OUT_R {
        SPI_SMEM_S_WDUMMY_ALWAYS_OUT_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    ...
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn spi_smem_s_dqs_ie_always_on(&self) -> SPI_SMEM_S_DQS_IE_ALWAYS_ON_R {
        SPI_SMEM_S_DQS_IE_ALWAYS_ON_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn spi_smem_s_data_ie_always_on(&self) -> SPI_SMEM_S_DATA_IE_ALWAYS_ON_R {
        SPI_SMEM_S_DATA_IE_ALWAYS_ON_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SRAM_CMD")
            ...
            .field(
                "spi_smem_s_wdummy_dqs_always_out",
                &self.spi_smem_s_wdummy_dqs_always_out(),
            )
            .field(
                "spi_smem_s_wdummy_always_out",
                &self.spi_smem_s_wdummy_always_out(),
            )
            .field("sdin_hex", &self.sdin_hex())
            .field("sdout_hex", &self.sdout_hex())
            .field(
                "spi_smem_s_dqs_ie_always_on",
                &self.spi_smem_s_dqs_ie_always_on(),
            )
            .field(
                "spi_smem_s_data_ie_always_on",
                &self.spi_smem_s_data_ie_always_on(),
            )
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn spi_smem_s_wdummy_dqs_always_out(
        &mut self,
    ) -> SPI_SMEM_S_WDUMMY_DQS_ALWAYS_OUT_W<'_, SRAM_CMD_SPEC> {
        SPI_SMEM_S_WDUMMY_DQS_ALWAYS_OUT_W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn spi_smem_s_wdummy_always_out(
        &mut self,
    ) -> SPI_SMEM_S_WDUMMY_ALWAYS_OUT_W<'_, SRAM_CMD_SPEC> {
        SPI_SMEM_S_WDUMMY_ALWAYS_OUT_W::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    pub fn sdin_hex(&mut self) -> SDIN_HEX_W<'_, SRAM_CMD_SPEC> {
        SDIN_HEX_W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn sdout_hex(&mut self) -> SDOUT_HEX_W<'_, SRAM_CMD_SPEC> {
        SDOUT_HEX_W::new(self, 27)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn spi_smem_s_dqs_ie_always_on(
        &mut self,
    ) -> SPI_SMEM_S_DQS_IE_ALWAYS_ON_W<'_, SRAM_CMD_SPEC> {
        SPI_SMEM_S_DQS_IE_ALWAYS_ON_W::new(self, 30)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn spi_smem_s_data_ie_always_on(
        &mut self,
    ) -> SPI_SMEM_S_DATA_IE_ALWAYS_ON_W<'_, SRAM_CMD_SPEC> {
        SPI_SMEM_S_DATA_IE_ALWAYS_ON_W::new(self, 31)
    }
}
