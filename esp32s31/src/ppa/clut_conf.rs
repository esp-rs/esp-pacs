...
#[doc = "Field `BLEND_CLUT_MEM_FORCE_PD` reader - 1: force power down BLEND CLUT memory."]
pub type BLEND_CLUT_MEM_FORCE_PD_R = crate::BitReader;
#[doc = "Field `BLEND_CLUT_MEM_FORCE_PD` writer - 1: force power down BLEND CLUT memory."]
pub type BLEND_CLUT_MEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BLEND_CLUT_MEM_FORCE_PU` reader - 1: force power up BLEND CLUT memory."]
pub type BLEND_CLUT_MEM_FORCE_PU_R = crate::BitReader;
#[doc = "Field `BLEND_CLUT_MEM_FORCE_PU` writer - 1: force power up BLEND CLUT memory."]
pub type BLEND_CLUT_MEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BLEND_CLUT_MEM_CLK_ENA` reader - 1: Force clock on for BLEND CLUT memory."]
pub type BLEND_CLUT_MEM_CLK_ENA_R = crate::BitReader;
#[doc = "Field `BLEND_CLUT_MEM_CLK_ENA` writer - 1: Force clock on for BLEND CLUT memory."]
pub type BLEND_CLUT_MEM_CLK_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - 1'b0: fifo mode to wr/rd clut0/clut1 RAM through register PPA_SRM_CLUT_DATA_REG/PPA_BLEND0_CLUT_DATA_REG/PPA_BLEND1_CLUT_DATA_REG. 1'b1: memory mode to wr/rd sr/blend0/blend1 clut RAM. The bit 11 and 10 of the waddr should be 01 to access sr clut and should be 10 to access blend0 clut and should be 11 to access blend 1 clut in memory mode."]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn blend_clut_mem_force_pd(&self) -> BLEND_CLUT_MEM_FORCE_PD_R {
        BLEND_CLUT_MEM_FORCE_PD_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - 1: force power up BLEND CLUT memory."]
    #[inline(always)]
    pub fn blend_clut_mem_force_pu(&self) -> BLEND_CLUT_MEM_FORCE_PU_R {
        BLEND_CLUT_MEM_FORCE_PU_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - 1: Force clock on for BLEND CLUT memory."]
    #[inline(always)]
    pub fn blend_clut_mem_clk_ena(&self) -> BLEND_CLUT_MEM_CLK_ENA_R {
        BLEND_CLUT_MEM_CLK_ENA_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLUT_CONF")
            ...
            .field("blend_clut_mem_force_pd", &self.blend_clut_mem_force_pd())
            .field("blend_clut_mem_force_pu", &self.blend_clut_mem_force_pu())
            .field("blend_clut_mem_clk_ena", &self.blend_clut_mem_clk_ena())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 5 - 1: force power down BLEND CLUT memory."]
    #[inline(always)]
    pub fn blend_clut_mem_force_pd(&mut self) -> BLEND_CLUT_MEM_FORCE_PD_W<'_, CLUT_CONF_SPEC> {
        BLEND_CLUT_MEM_FORCE_PD_W::new(self, 5)
    }
    #[doc = "Bit 6 - 1: force power up BLEND CLUT memory."]
    #[inline(always)]
    pub fn blend_clut_mem_force_pu(&mut self) -> BLEND_CLUT_MEM_FORCE_PU_W<'_, CLUT_CONF_SPEC> {
        BLEND_CLUT_MEM_FORCE_PU_W::new(self, 6)
    }
    #[doc = "Bit 7 - 1: Force clock on for BLEND CLUT memory."]
    #[inline(always)]
    pub fn blend_clut_mem_clk_ena(&mut self) -> BLEND_CLUT_MEM_CLK_ENA_W<'_, CLUT_CONF_SPEC> {
        BLEND_CLUT_MEM_CLK_ENA_W::new(self, 7)
    }
}
