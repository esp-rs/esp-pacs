...
#[doc = "Field `BLEND0_RX_CM` reader - The source image color mode for background plane. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 4: L8. 5: L4. 8: YUV420. 9: YUV422"]
pub type BLEND0_RX_CM_R = crate::FieldReader;
#[doc = "Field `BLEND0_RX_CM` writer - The source image color mode for background plane. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 4: L8. 5: L4. 8: YUV420. 9: YUV422"]
...
#[doc = "Field `BLEND_TX_CM` reader - The destination image color mode for output of blender. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 8: YUV420. 9: YUV422."]
pub type BLEND_TX_CM_R = crate::FieldReader;
#[doc = "Field `BLEND_TX_CM` writer - The destination image color mode for output of blender. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 8: YUV420. 9: YUV422."]
...
impl R {
    #[doc = "Bits 0:3 - The source image color mode for background plane. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 4: L8. 5: L4. 8: YUV420. 9: YUV422"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:11 - The destination image color mode for output of blender. 0: ARGB8888. 1: RGB888. 2: RGB565. 3: Reserved. 8: YUV420. 9: YUV422."]
    #[inline(always)]
