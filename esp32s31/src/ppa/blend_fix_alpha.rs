...
#[doc = "Field `BLEND0_RX_ALPHA_MOD` reader - Alpha mode. 0/3: not replace alpha. 1: replace alpha with PPA_BLEND0_FIX_ALPHA. 2: Original alpha multiply with PPA_SRM_FIX_ALPHA/256."]
pub type BLEND0_RX_ALPHA_MOD_R = crate::FieldReader;
#[doc = "Field `BLEND0_RX_ALPHA_MOD` writer - Alpha mode. 0/3: not replace alpha. 1: replace alpha with PPA_BLEND0_FIX_ALPHA. 2: Original alpha multiply with PPA_SRM_FIX_ALPHA/256."]
pub type BLEND0_RX_ALPHA_MOD_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `BLEND1_RX_ALPHA_MOD` reader - Alpha mode. 0/3: not replace alpha. 1: replace alpha with PPA_BLEND1_FIX_ALPHA. 2: Original alpha multiply with PPA_SRM_FIX_ALPHA/256."]
pub type BLEND1_RX_ALPHA_MOD_R = crate::FieldReader;
#[doc = "Field `BLEND1_RX_ALPHA_MOD` writer - Alpha mode. 0/3: not replace alpha. 1: replace alpha with PPA_BLEND1_FIX_ALPHA. 2: Original alpha multiply with PPA_SRM_FIX_ALPHA/256."]
...
impl R {
    ...
    #[doc = "Bits 16:17 - Alpha mode. 0/3: not replace alpha. 1: replace alpha with PPA_BLEND0_FIX_ALPHA. 2: Original alpha multiply with PPA_SRM_FIX_ALPHA/256."]
    #[inline(always)]
    pub fn blend0_rx_alpha_mod(&self) -> BLEND0_RX_ALPHA_MOD_R {
        BLEND0_RX_ALPHA_MOD_R::new(((self.bits >> 16) & 3) as u8)
    }
    #[doc = "Bits 18:19 - Alpha mode. 0/3: not replace alpha. 1: replace alpha with PPA_BLEND1_FIX_ALPHA. 2: Original alpha multiply with PPA_SRM_FIX_ALPHA/256."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:7 - The value would replace the alpha value in received pixel for background plane of blender when PPA_BLEND0_RX_ALPHA_CONF_EN is enabled."]
    #[inline(always)]
    pub fn blend0_rx_fix_alpha(&mut self) -> BLEND0_RX_FIX_ALPHA_W<'_, BLEND_FIX_ALPHA_SPEC> {
        BLEND0_RX_FIX_ALPHA_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - The value would replace the alpha value in received pixel for foreground plane of blender when PPA_BLEND1_RX_ALPHA_CONF_EN is enabled."]
    #[inline(always)]
    pub fn blend1_rx_fix_alpha(&mut self) -> BLEND1_RX_FIX_ALPHA_W<'_, BLEND_FIX_ALPHA_SPEC> {
        BLEND1_RX_FIX_ALPHA_W::new(self, 8)
    }
    #[doc = "Bits 16:17 - Alpha mode. 0/3: not replace alpha. 1: replace alpha with PPA_BLEND0_FIX_ALPHA. 2: Original alpha multiply with PPA_SRM_FIX_ALPHA/256."]
    #[inline(always)]
    pub fn blend0_rx_alpha_mod(&mut self) -> BLEND0_RX_ALPHA_MOD_W<'_, BLEND_FIX_ALPHA_SPEC> {
        BLEND0_RX_ALPHA_MOD_W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Alpha mode. 0/3: not replace alpha. 1: replace alpha with PPA_BLEND1_FIX_ALPHA. 2: Original alpha multiply with PPA_SRM_FIX_ALPHA/256."]
    #[inline(always)]
    pub fn blend1_rx_alpha_mod(&mut self) -> BLEND1_RX_ALPHA_MOD_W<'_, BLEND_FIX_ALPHA_SPEC> {
        BLEND1_RX_ALPHA_MOD_W::new(self, 18)
    }
    #[doc = "Bit 20 - Set this bit to invert the original alpha value. When RX color mode is RGB565/RGB88. The original alpha value is 255."]
    #[inline(always)]
    pub fn blend0_rx_alpha_inv(&mut self) -> BLEND0_RX_ALPHA_INV_W<'_, BLEND_FIX_ALPHA_SPEC> {
        BLEND0_RX_ALPHA_INV_W::new(self, 20)
    }
    #[doc = "Bit 21 - Set this bit to invert the original alpha value. When RX color mode is RGB565/RGB88. The original alpha value is 255."]
    #[inline(always)]
    pub fn blend1_rx_alpha_inv(&mut self) -> BLEND1_RX_ALPHA_INV_W<'_, BLEND_FIX_ALPHA_SPEC> {
