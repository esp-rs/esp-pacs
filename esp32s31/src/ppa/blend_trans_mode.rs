...
#[doc = "Field `BLEND_TX_INF_SEL` reader - Configures blend tx interface. 0: dma2d only, 1: le_enc only, 2: dma2d and ls_enc"]
pub type BLEND_TX_INF_SEL_R = crate::FieldReader;
#[doc = "Field `BLEND_TX_INF_SEL` writer - Configures blend tx interface. 0: dma2d only, 1: le_enc only, 2: dma2d and ls_enc"]
...
impl R {
    ...
    #[doc = "Bits 5:6 - Configures blend tx interface. 0: dma2d only, 1: le_enc only, 2: dma2d and ls_enc"]
    #[inline(always)]
