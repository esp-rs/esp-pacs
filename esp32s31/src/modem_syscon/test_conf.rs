...
#[doc = "Field `MODEM_DIS_WIFI6_FORCE` reader - "]
pub type MODEM_DIS_WIFI6_FORCE_R = crate::BitReader;
#[doc = "Field `MODEM_DIS_WIFI6_FORCE` writer - "]
pub type MODEM_DIS_WIFI6_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    ...
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn modem_dis_wifi6_force(&self) -> MODEM_DIS_WIFI6_FORCE_R {
        MODEM_DIS_WIFI6_FORCE_R::new(((self.bits >> 9) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TEST_CONF")
            ...
            .field("modem_dis_wifi6_force", &self.modem_dis_wifi6_force())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn modem_dis_wifi6_force(&mut self) -> MODEM_DIS_WIFI6_FORCE_W<'_, TEST_CONF_SPEC> {
        MODEM_DIS_WIFI6_FORCE_W::new(self, 9)
    }
}
