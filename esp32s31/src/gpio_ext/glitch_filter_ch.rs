...
#[doc = "Field `FILTER_CH0_INPUT_IO_NUM` reader - Configures to select the input GPIO for Glitch Filter. \\\\ 0: Select GPIO0\\\\ 1: Select GPIO1\\\\ ......\\\\ 61: Select GPIO61\\\\ 62: Select GPIO62\\\\ 63 ~ 127: Reserved\\\\"]
pub type FILTER_CH0_INPUT_IO_NUM_R = crate::FieldReader;
#[doc = "Field `FILTER_CH0_INPUT_IO_NUM` writer - Configures to select the input GPIO for Glitch Filter. \\\\ 0: Select GPIO0\\\\ 1: Select GPIO1\\\\ ......\\\\ 61: Select GPIO61\\\\ 62: Select GPIO62\\\\ 63 ~ 127: Reserved\\\\"]
pub type FILTER_CH0_INPUT_IO_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
...
impl R {
    ...
    pub fn filter_ch0_input_io_num(&self) -> FILTER_CH0_INPUT_IO_NUM_R {
        FILTER_CH0_INPUT_IO_NUM_R::new(((self.bits >> 1) & 0x7f) as u8)
    }
