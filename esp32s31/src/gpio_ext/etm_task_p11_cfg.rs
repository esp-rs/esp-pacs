...
#[doc = "Field `GPIO_SEL(55-59)` reader - Configures to select an ETM task channel for GPIO%s.\\\\ 0: Select channel 0\\\\ 1: Select channel 1\\\\ ......\\\\ 7: Select channel 7\\\\"]
pub type GPIO_SEL_R = crate::FieldReader;
#[doc = "Field `GPIO_SEL(55-59)` writer - Configures to select an ETM task channel for GPIO%s.\\\\ 0: Select channel 0\\\\ 1: Select channel 1\\\\ ......\\\\ 7: Select channel 7\\\\"]
pub type GPIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `GPIO_EN(55-59)` reader - Configures whether or not to enable GPIO%s to response ETM task.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type GPIO_EN_R = crate::BitReader;
#[doc = "Field `GPIO_EN(55-59)` writer - Configures whether or not to enable GPIO%s to response ETM task.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
pub type GPIO_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Configures to select an ETM task channel for GPIO(55-59).\\\\ 0: Select channel 0\\\\ 1: Select channel 1\\\\ ......\\\\ 7: Select channel 7\\\\"]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO55_SEL` field.</div>"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn gpio55_sel(&self) -> GPIO_SEL_R {
    ...
    #[inline(always)]
    pub fn gpio56_sel(&self) -> GPIO_SEL_R {
    ...
    #[inline(always)]
    pub fn gpio57_sel(&self) -> GPIO_SEL_R {
    ...
    #[inline(always)]
    pub fn gpio58_sel(&self) -> GPIO_SEL_R {
    ...
    #[inline(always)]
    pub fn gpio59_sel(&self) -> GPIO_SEL_R {
        GPIO_SEL_R::new(((self.bits >> 24) & 7) as u8)
    }
    #[doc = "Configures whether or not to enable GPIO(55-59) to response ETM task.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO55_EN` field.</div>"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn gpio55_en(&self) -> GPIO_EN_R {
    ...
    #[inline(always)]
    pub fn gpio56_en(&self) -> GPIO_EN_R {
    ...
    #[inline(always)]
    pub fn gpio57_en(&self) -> GPIO_EN_R {
    ...
    #[inline(always)]
    pub fn gpio58_en(&self) -> GPIO_EN_R {
    ...
    #[inline(always)]
    pub fn gpio59_en(&self) -> GPIO_EN_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETM_TASK_P11_CFG")
            .field("gpio55_sel", &self.gpio55_sel())
            .field("gpio56_sel", &self.gpio56_sel())
            .field("gpio57_sel", &self.gpio57_sel())
            .field("gpio58_sel", &self.gpio58_sel())
            .field("gpio59_sel", &self.gpio59_sel())
            .field("gpio55_en", &self.gpio55_en())
            .field("gpio56_en", &self.gpio56_en())
            .field("gpio57_en", &self.gpio57_en())
            .field("gpio58_en", &self.gpio58_en())
            .field("gpio59_en", &self.gpio59_en())
            .finish()
    }
}
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO55_SEL` field.</div>"]
    #[inline(always)]
    pub fn gpio_sel(&mut self, n: u8) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
    ...
    #[doc = "Bits 0:2 - Configures to select an ETM task channel for GPIO55.\\\\ 0: Select channel 0\\\\ 1: Select channel 1\\\\ ......\\\\ 7: Select channel 7\\\\"]
    #[inline(always)]
    pub fn gpio55_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_SEL_W::new(self, 0)
    }
    #[doc = "Bits 6:8 - Configures to select an ETM task channel for GPIO56.\\\\ 0: Select channel 0\\\\ 1: Select channel 1\\\\ ......\\\\ 7: Select channel 7\\\\"]
    #[inline(always)]
    pub fn gpio56_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_SEL_W::new(self, 6)
    }
    #[doc = "Bits 12:14 - Configures to select an ETM task channel for GPIO57.\\\\ 0: Select channel 0\\\\ 1: Select channel 1\\\\ ......\\\\ 7: Select channel 7\\\\"]
    #[inline(always)]
    pub fn gpio57_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_SEL_W::new(self, 12)
    }
    #[doc = "Bits 18:20 - Configures to select an ETM task channel for GPIO58.\\\\ 0: Select channel 0\\\\ 1: Select channel 1\\\\ ......\\\\ 7: Select channel 7\\\\"]
    #[inline(always)]
    pub fn gpio58_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_SEL_W::new(self, 18)
    }
    #[doc = "Bits 24:26 - Configures to select an ETM task channel for GPIO59.\\\\ 0: Select channel 0\\\\ 1: Select channel 1\\\\ ......\\\\ 7: Select channel 7\\\\"]
    #[inline(always)]
    pub fn gpio59_sel(&mut self) -> GPIO_SEL_W<'_, ETM_TASK_P11_CFG_SPEC> {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `GPIO55_EN` field.</div>"]
    #[inline(always)]
    pub fn gpio_en(&mut self, n: u8) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
    ...
    #[doc = "Bit 5 - Configures whether or not to enable GPIO55 to response ETM task.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn gpio55_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_EN_W::new(self, 5)
    }
    #[doc = "Bit 11 - Configures whether or not to enable GPIO56 to response ETM task.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn gpio56_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_EN_W::new(self, 11)
    }
    #[doc = "Bit 17 - Configures whether or not to enable GPIO57 to response ETM task.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn gpio57_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_EN_W::new(self, 17)
    }
    #[doc = "Bit 23 - Configures whether or not to enable GPIO58 to response ETM task.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn gpio58_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
        GPIO_EN_W::new(self, 23)
    }
    #[doc = "Bit 29 - Configures whether or not to enable GPIO59 to response ETM task.\\\\ 0: Not enable\\\\ 1: Enable\\\\"]
    #[inline(always)]
    pub fn gpio59_en(&mut self) -> GPIO_EN_W<'_, ETM_TASK_P11_CFG_SPEC> {
