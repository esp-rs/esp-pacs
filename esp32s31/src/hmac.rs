...
impl RegisterBlock {
    ...
    #[doc = "0x48 - HMAC parameters configuration register"]
    #[inline(always)]
    ...
    #[doc = "0x50 - HMAC message control register"]
    #[inline(always)]
    ...
    #[doc = "0x5c - HMAC result reading finish register"]
    #[inline(always)]
    ...
    #[doc = "0x68 - Stores matching results between keys generated by users and corresponding purposes"]
    #[inline(always)]
    pub const fn query_error(&self) -> &QUERY_ERROR {
        &self.query_error
    }
    #[doc = "0x6c - Busy state of HMAC module"]
    #[inline(always)]
    pub const fn query_busy(&self) -> &QUERY_BUSY {
        &self.query_busy
    }
    #[doc = "0x70 - HMAC timeout limit configurate register"]
    #[inline(always)]
    ...
    #[doc = "0xfc - Re-enable JTAG register 1"]
    #[inline(always)]
