...
impl RegisterBlock {
    ...
    #[doc = "0x20 - ECC free status register"]
    #[inline(always)]
    pub const fn mult_free(&self) -> &MULT_FREE {
        &self.mult_free
    }
...
pub mod mult_conf;
#[doc = "MULT_FREE (rw) register accessor: ECC free status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mult_free::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mult_free::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mult_free`] module"]
pub type MULT_FREE = crate::Reg<mult_free::MULT_FREE_SPEC>;
