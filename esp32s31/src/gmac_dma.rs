...
impl RegisterBlock {
    ...
    #[doc = "0x04 - Used by the host to instruct the DMA to poll the Transmit Descriptor list"]
    #[inline(always)]
    pub const fn dmatxpolldemand(&self) -> &DMATXPOLLDEMAND {
        &self.dmatxpolldemand
    }
    #[doc = "0x08 - Used by the host to instruct the DMA to poll the Receive Descriptor list"]
    #[inline(always)]
    pub const fn dmarxpolldemand(&self) -> &DMARXPOLLDEMAND {
        &self.dmarxpolldemand
    }
    #[doc = "0x0c - Points the DMA to the start of the Receive Descriptor list"]
    #[inline(always)]
    pub const fn dmarxbaseaddr(&self) -> &DMARXBASEADDR {
        &self.dmarxbaseaddr
    }
    #[doc = "0x10 - Points the DMA to the start of the Transmit Descriptor list"]
    #[inline(always)]
    ...
    #[doc = "0x48 - Points to the start of current Transmit Descriptor read by the DMA"]
    #[inline(always)]
    pub const fn dmatxcurrdesc(&self) -> &DMATXCURRDESC {
        &self.dmatxcurrdesc
    }
    #[doc = "0x4c - Points to the start of current Receive Descriptor read by the DMA"]
    #[inline(always)]
    pub const fn dmarxcurrdesc(&self) -> &DMARXCURRDESC {
        &self.dmarxcurrdesc
    }
    #[doc = "0x50 - Points to the current Transmit Buffer address read by the DMA"]
    #[inline(always)]
    pub const fn dmatxcurraddr_buf(&self) -> &DMATXCURRADDR_BUF {
        &self.dmatxcurraddr_buf
    }
    #[doc = "0x54 - Points to the current Receive Buffer address read by the DMA"]
    #[inline(always)]
