...
#[doc = "Field `READ_DONE_INT_ENA` reader - Write 1 to enable EFUSE_READ_DONE_INT."]
pub type READ_DONE_INT_ENA_R = crate::BitReader;
#[doc = "Field `READ_DONE_INT_ENA` writer - Write 1 to enable EFUSE_READ_DONE_INT."]
pub type READ_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PGM_DONE_INT_ENA` reader - Write 1 to enable EFUSE_PGM_DONE_INT."]
pub type PGM_DONE_INT_ENA_R = crate::BitReader;
#[doc = "Field `PGM_DONE_INT_ENA` writer - Write 1 to enable EFUSE_PGM_DONE_INT."]
pub type PGM_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Write 1 to enable EFUSE_READ_DONE_INT."]
    #[inline(always)]
    pub fn read_done_int_ena(&self) -> READ_DONE_INT_ENA_R {
        READ_DONE_INT_ENA_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Write 1 to enable EFUSE_PGM_DONE_INT."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            .field("read_done_int_ena", &self.read_done_int_ena())
            .field("pgm_done_int_ena", &self.pgm_done_int_ena())
            .finish()
    }
}
impl W {
