...
#[doc = "Field `SYS_DATA_PART2_0` reader - Represents the zeroth 32-bit of second part of system data."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_SYS_PART2_DATA0")
            .field("sys_data_part2_0", &self.sys_data_part2_0())
            .finish()
    }
}
#[doc = "Represents rd_sys_part2_data\n\nYou can [`read`](crate::Reg::read) this register and get [`rd_sys_part2_data0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
