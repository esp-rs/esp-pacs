...
impl R {
    ...
    #[doc = "Bit 10 - Represents the programming error of EFUSE_DIS_USB_JTAG"]
    #[inline(always)]
    pub fn dis_usb_jtag_err(&self) -> DIS_USB_JTAG_ERR_R {
        DIS_USB_JTAG_ERR_R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    #[doc = "Bit 22 - Represents the programming error of EFUSE_DIS_WIFI6"]
    #[inline(always)]
    pub fn dis_wifi6_err(&self) -> DIS_WIFI6_ERR_R {
        DIS_WIFI6_ERR_R::new(((self.bits >> 22) & 1) != 0)
    }
