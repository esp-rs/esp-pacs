...
impl R {
    #[doc = "Bits 0:2 - Represents the error number of registers.\\\\The value of this signal means the number of error bytes in rd_sys_part2_data"]
    #[inline(always)]
    pub fn rd_sys_part2_data_err_num(&self) -> RD_SYS_PART2_DATA_ERR_NUM_R {
        RD_SYS_PART2_DATA_ERR_NUM_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bit 3 - Represents error status of register.\\\\0: Means no failure and that the data of rd_sys_part2_data is reliable\\\\ 1: Means that programming rd_sys_part2_data failed and the number of error bytes is over 6."]
    #[inline(always)]
    pub fn rd_sys_part2_data_fail(&self) -> RD_SYS_PART2_DATA_FAIL_R {
        RD_SYS_PART2_DATA_FAIL_R::new(((self.bits >> 3) & 1) != 0)
    }
}
