...
#[doc = "Register `APB2OTP_BLK0_BACKUP1_W3` writer"]
pub type W = crate::W<APB2OTP_BLK0_BACKUP1_W3_SPEC>;
...
#[doc = "Field `APB2OTP_BLOCK0_BACKUP1_W3` writer - OTP block0 backup1 word3 data."]
pub type APB2OTP_BLOCK0_BACKUP1_W3_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - OTP block0 backup1 word3 data."]
    #[inline(always)]
    pub fn apb2otp_block0_backup1_w3(
        &mut self,
    ) -> APB2OTP_BLOCK0_BACKUP1_W3_W<'_, APB2OTP_BLK0_BACKUP1_W3_SPEC> {
        APB2OTP_BLOCK0_BACKUP1_W3_W::new(self, 0)
    }
}
#[doc = "eFuse apb2otp block0 data register4.\n\nYou can [`read`](crate::Reg::read) this register and get [`apb2otp_blk0_backup1_w3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`apb2otp_blk0_backup1_w3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`write(|w| ..)` method takes [`apb2otp_blk0_backup1_w3::W`](W) writer structure"]
impl crate::Writable for APB2OTP_BLK0_BACKUP1_W3_SPEC {
