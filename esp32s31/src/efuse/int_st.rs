...
#[doc = "Field `READ_DONE` reader - The masked interrupt status of EFUSE_READ_DONE_INT."]
pub type READ_DONE_R = crate::BitReader;
#[doc = "Field `PGM_DONE` reader - The masked interrupt status of EFUSE_PGM_DONE_INT."]
