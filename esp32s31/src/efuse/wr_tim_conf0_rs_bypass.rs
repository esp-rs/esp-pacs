...
#[doc = "Field `BYPASS_RS_CORRECTION` reader - Configures whether to bypass the Reed-Solomon (RS) correction step.\\\\ 0: Not bypass\\\\ 1: Bypass\\\\"]
pub type BYPASS_RS_CORRECTION_R = crate::BitReader;
#[doc = "Field `BYPASS_RS_CORRECTION` writer - Configures whether to bypass the Reed-Solomon (RS) correction step.\\\\ 0: Not bypass\\\\ 1: Bypass\\\\"]
pub type BYPASS_RS_CORRECTION_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BYPASS_RS_BLK_NUM` reader - Configures which block number to bypass the Reed-Solomon (RS) correction step."]
pub type BYPASS_RS_BLK_NUM_R = crate::FieldReader<u16>;
#[doc = "Field `BYPASS_RS_BLK_NUM` writer - Configures which block number to bypass the Reed-Solomon (RS) correction step."]
pub type BYPASS_RS_BLK_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
#[doc = "Field `UPDATE` writer - Configures whether to update multi-bit register signals.\\\\ 1: Update\\\\ 0: No effect\\\\"]
pub type UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TPGM_INACTIVE` reader - Configures the inactive programming time. Measurement unit: One cycle of the eFuse core clock."]
pub type TPGM_INACTIVE_R = crate::FieldReader;
#[doc = "Field `TPGM_INACTIVE` writer - Configures the inactive programming time. Measurement unit: One cycle of the eFuse core clock."]
pub type TPGM_INACTIVE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bit 0 - Configures whether to bypass the Reed-Solomon (RS) correction step.\\\\ 0: Not bypass\\\\ 1: Bypass\\\\"]
    #[inline(always)]
    pub fn bypass_rs_correction(&self) -> BYPASS_RS_CORRECTION_R {
        BYPASS_RS_CORRECTION_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:11 - Configures which block number to bypass the Reed-Solomon (RS) correction step."]
    #[inline(always)]
    pub fn bypass_rs_blk_num(&self) -> BYPASS_RS_BLK_NUM_R {
        BYPASS_RS_BLK_NUM_R::new(((self.bits >> 1) & 0x07ff) as u16)
    }
    #[doc = "Bits 13:20 - Configures the inactive programming time. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
...
impl W {
    ...
    pub fn bypass_rs_correction(
        &mut self,
    ) -> BYPASS_RS_CORRECTION_W<'_, WR_TIM_CONF0_RS_BYPASS_SPEC> {
        BYPASS_RS_CORRECTION_W::new(self, 0)
    }
    #[doc = "Bits 1:11 - Configures which block number to bypass the Reed-Solomon (RS) correction step."]
    #[inline(always)]
    pub fn bypass_rs_blk_num(&mut self) -> BYPASS_RS_BLK_NUM_W<'_, WR_TIM_CONF0_RS_BYPASS_SPEC> {
        BYPASS_RS_BLK_NUM_W::new(self, 1)
    }
    #[doc = "Bit 12 - Configures whether to update multi-bit register signals.\\\\ 1: Update\\\\ 0: No effect\\\\"]
    #[inline(always)]
    pub fn update(&mut self) -> UPDATE_W<'_, WR_TIM_CONF0_RS_BYPASS_SPEC> {
        UPDATE_W::new(self, 12)
    }
    #[doc = "Bits 13:20 - Configures the inactive programming time. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
    pub fn tpgm_inactive(&mut self) -> TPGM_INACTIVE_W<'_, WR_TIM_CONF0_RS_BYPASS_SPEC> {
