...
#[doc = "Field `READ_DONE_INT_RAW` reader - The raw interrupt status of EFUSE_READ_DONE_INT."]
pub type READ_DONE_INT_RAW_R = crate::BitReader;
#[doc = "Field `PGM_DONE_INT_RAW` reader - The raw interrupt status of EFUSE_PGM_DONE_INT."]
pub type PGM_DONE_INT_RAW_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - The raw interrupt status of EFUSE_READ_DONE_INT."]
    #[inline(always)]
    pub fn read_done_int_raw(&self) -> READ_DONE_INT_RAW_R {
        READ_DONE_INT_RAW_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The raw interrupt status of EFUSE_PGM_DONE_INT."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW")
            .field("read_done_int_raw", &self.read_done_int_raw())
            .field("pgm_done_int_raw", &self.pgm_done_int_raw())
            .finish()
    }
}
