...
#[doc = "Register `APB2OTP_BLK3_W6` writer"]
pub type W = crate::W<APB2OTP_BLK3_W6_SPEC>;
#[doc = "Field `APB2OTP_BLOCK3_W6` reader - OTP block3 word6 data."]
pub type APB2OTP_BLOCK3_W6_R = crate::FieldReader<u32>;
#[doc = "Field `APB2OTP_BLOCK3_W6` writer - OTP block3 word6 data."]
pub type APB2OTP_BLOCK3_W6_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - OTP block3 word6 data."]
    #[inline(always)]
    pub fn apb2otp_block3_w6(&mut self) -> APB2OTP_BLOCK3_W6_W<'_, APB2OTP_BLK3_W6_SPEC> {
        APB2OTP_BLOCK3_W6_W::new(self, 0)
    }
}
...
#[doc = "`write(|w| ..)` method takes [`apb2otp_blk3_w6::W`](W) writer structure"]
impl crate::Writable for APB2OTP_BLK3_W6_SPEC {
