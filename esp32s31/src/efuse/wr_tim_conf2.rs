...
#[doc = "Field `PWR_OFF_NUM` reader - Configures the power outage time for VDDQ. Measurement unit: One cycle of the eFuse core clock."]
pub type PWR_OFF_NUM_R = crate::FieldReader<u16>;
#[doc = "Field `PWR_OFF_NUM` writer - Configures the power outage time for VDDQ. Measurement unit: One cycle of the eFuse core clock."]
pub type PWR_OFF_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `TPGM` reader - Configures the active programming time (>10us). Measurement unit: One cycle of the eFuse core clock."]
pub type TPGM_R = crate::FieldReader<u16>;
#[doc = "Field `TPGM` writer - Configures the active programming time (>10us). Measurement unit: One cycle of the eFuse core clock."]
pub type TPGM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Configures the power outage time for VDDQ. Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
    pub fn pwr_off_num(&self) -> PWR_OFF_NUM_R {
        PWR_OFF_NUM_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Configures the active programming time (>10us). Measurement unit: One cycle of the eFuse core clock."]
    #[inline(always)]
...
#[doc = "`reset()` method sets WR_TIM_CONF2 to value 0x00f0_01e0"]
impl crate::Resettable for WR_TIM_CONF2_SPEC {
    const RESET_VALUE: u32 = 0x00f0_01e0;
}
