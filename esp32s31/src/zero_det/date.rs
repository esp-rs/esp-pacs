...
#[doc = "Field `DATE` reader - zero det reg change date"]
pub type DATE_R = crate::FieldReader<u32>;
#[doc = "Field `DATE` writer - zero det reg change date"]
...
impl R {
    #[doc = "Bits 0:27 - zero det reg change date"]
    #[inline(always)]
    pub fn date(&self) -> DATE_R {
        DATE_R::new(self.bits & 0x0fff_ffff)
    }
    #[doc = "Bit 28 - reg clk en"]
    #[inline(always)]
    pub fn clk_en(&self) -> CLK_EN_R {
        CLK_EN_R::new(((self.bits >> 28) & 1) != 0)
    }
}
...
#[doc = "`reset()` method sets DATE to value 0x0240_6180"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0240_6180;
}
