...
#[doc = "Field `COMP_START` writer - enable comp task by software"]
pub type COMP_START_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    #[doc = "Bit 0 - enable comp task by software"]
    #[inline(always)]
    pub fn comp_start(&mut self) -> COMP_START_W<'_, START_SPEC> {
        COMP_START_W::new(self, 0)
    }
}
