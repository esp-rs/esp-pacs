    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ENA")
            ...
            .field(
                ...
                &self.duty_chng_end_ch6_int_ena(),
            )
            .field(
                "duty_chng_end_ch7_int_ena",
                &self.duty_chng_end_ch7_int_ena(),
            )
            ...
            .field("ovf_cnt_ch6_int_ena", &self.ovf_cnt_ch6_int_ena())
            .field("ovf_cnt_ch7_int_ena", &self.ovf_cnt_ch7_int_ena())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 10 - Enable bit: Write 1 to enable LEDC_DUTY_CHNG_END_CH6_INT."]
    #[inline(always)]
    pub fn duty_chng_end_ch6_int_ena(&mut self) -> DUTY_CHNG_END_CH6_INT_ENA_W<'_, INT_ENA_SPEC> {
        DUTY_CHNG_END_CH6_INT_ENA_W::new(self, 10)
    }
    #[doc = "Bit 11 - Enable bit: Write 1 to enable LEDC_DUTY_CHNG_END_CH7_INT."]
    #[inline(always)]
    pub fn duty_chng_end_ch7_int_ena(&mut self) -> DUTY_CHNG_END_CH7_INT_ENA_W<'_, INT_ENA_SPEC> {
    ...
    #[doc = "Bit 18 - Enable bit: Write 1 to enable LEDC_OVF_CNT_CH6_INT."]
    #[inline(always)]
    pub fn ovf_cnt_ch6_int_ena(&mut self) -> OVF_CNT_CH6_INT_ENA_W<'_, INT_ENA_SPEC> {
        OVF_CNT_CH6_INT_ENA_W::new(self, 18)
    }
    #[doc = "Bit 19 - Enable bit: Write 1 to enable LEDC_OVF_CNT_CH7_INT."]
    #[inline(always)]
    pub fn ovf_cnt_ch7_int_ena(&mut self) -> OVF_CNT_CH7_INT_ENA_W<'_, INT_ENA_SPEC> {
