...
impl W {
    ...
    #[inline(always)]
    pub fn duty_chng_end_ch6_int_clr(&mut self) -> DUTY_CHNG_END_CH6_INT_CLR_W<'_, INT_CLR_SPEC> {
        DUTY_CHNG_END_CH6_INT_CLR_W::new(self, 10)
    }
    #[doc = "Bit 11 - Clear bit: Write 1 to clear LEDC_DUTY_CHNG_END_CH7_INT."]
    #[inline(always)]
    pub fn duty_chng_end_ch7_int_clr(&mut self) -> DUTY_CHNG_END_CH7_INT_CLR_W<'_, INT_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn ovf_cnt_ch6_int_clr(&mut self) -> OVF_CNT_CH6_INT_CLR_W<'_, INT_CLR_SPEC> {
        OVF_CNT_CH6_INT_CLR_W::new(self, 18)
    }
    #[doc = "Bit 19 - Clear bit: Write 1 to clear LEDC_OVF_CNT_CH7_INT."]
    #[inline(always)]
    pub fn ovf_cnt_ch7_int_clr(&mut self) -> OVF_CNT_CH7_INT_CLR_W<'_, INT_CLR_SPEC> {
