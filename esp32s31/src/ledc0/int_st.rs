...
#[doc = "Field `DUTY_CHNG_END_CH6_INT_ST` reader - Masked status bit: The masked interrupt status of LEDC_DUTY_CHNG_END_CH6_INT. Valid only when LEDC_DUTY_CHNG_END_CH6_INT_ENA is set to 1."]
pub type DUTY_CHNG_END_CH6_INT_ST_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_CH7_INT_ST` reader - Masked status bit: The masked interrupt status of LEDC_DUTY_CHNG_END_CH7_INT. Valid only when LEDC_DUTY_CHNG_END_CH7_INT_ENA is set to 1."]
pub type DUTY_CHNG_END_CH7_INT_ST_R = crate::BitReader;
...
#[doc = "Field `OVF_CNT_CH6_INT_ST` reader - Masked status bit: The masked interrupt status of LEDC_OVF_CNT_CH6_INT. Valid only when LEDC_OVF_CNT_CH6_INT_ENA is set to 1."]
pub type OVF_CNT_CH6_INT_ST_R = crate::BitReader;
#[doc = "Field `OVF_CNT_CH7_INT_ST` reader - Masked status bit: The masked interrupt status of LEDC_OVF_CNT_CH7_INT. Valid only when LEDC_OVF_CNT_CH7_INT_ENA is set to 1."]
pub type OVF_CNT_CH7_INT_ST_R = crate::BitReader;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            ...
            .field("duty_chng_end_ch6_int_st", &self.duty_chng_end_ch6_int_st())
            .field("duty_chng_end_ch7_int_st", &self.duty_chng_end_ch7_int_st())
            ...
            .field("ovf_cnt_ch6_int_st", &self.ovf_cnt_ch6_int_st())
            .field("ovf_cnt_ch7_int_st", &self.ovf_cnt_ch7_int_st())
            .finish()
    }
}
