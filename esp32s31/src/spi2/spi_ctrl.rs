...
pub type SPI_FADDR_OCT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_FCMD_OCT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SPI_FREAD_OCT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    #[doc = "Bit 3 - 0: In the dummy phase, the FSPI bus signals are not output. 1: In the dummy phase, the FSPI bus signals are output. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_dummy_out(&mut self) -> SPI_DUMMY_OUT_W<'_, SPI_CTRL_SPEC> {
        SPI_DUMMY_OUT_W::new(self, 3)
    }
    #[doc = "Bit 5 - Apply 2 signals during addr phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_faddr_dual(&mut self) -> SPI_FADDR_DUAL_W<'_, SPI_CTRL_SPEC> {
        SPI_FADDR_DUAL_W::new(self, 5)
    }
    #[doc = "Bit 6 - Apply 4 signals during addr phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_faddr_quad(&mut self) -> SPI_FADDR_QUAD_W<'_, SPI_CTRL_SPEC> {
        SPI_FADDR_QUAD_W::new(self, 6)
    }
    #[doc = "Bit 7 - Apply 8 signals during addr phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_faddr_oct(&mut self) -> SPI_FADDR_OCT_W<'_, SPI_CTRL_SPEC> {
        SPI_FADDR_OCT_W::new(self, 7)
    }
    #[doc = "Bit 8 - Apply 2 signals during command phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_fcmd_dual(&mut self) -> SPI_FCMD_DUAL_W<'_, SPI_CTRL_SPEC> {
        SPI_FCMD_DUAL_W::new(self, 8)
    }
    #[doc = "Bit 9 - Apply 4 signals during command phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_fcmd_quad(&mut self) -> SPI_FCMD_QUAD_W<'_, SPI_CTRL_SPEC> {
        SPI_FCMD_QUAD_W::new(self, 9)
    }
    #[doc = "Bit 10 - Apply 8 signals during command phase 1:enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_fcmd_oct(&mut self) -> SPI_FCMD_OCT_W<'_, SPI_CTRL_SPEC> {
        SPI_FCMD_OCT_W::new(self, 10)
    }
    #[doc = "Bit 14 - In the read operations, read-data phase apply 2 signals. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_fread_dual(&mut self) -> SPI_FREAD_DUAL_W<'_, SPI_CTRL_SPEC> {
        SPI_FREAD_DUAL_W::new(self, 14)
    }
    #[doc = "Bit 15 - In the read operations read-data phase apply 4 signals. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_fread_quad(&mut self) -> SPI_FREAD_QUAD_W<'_, SPI_CTRL_SPEC> {
        SPI_FREAD_QUAD_W::new(self, 15)
    }
    #[doc = "Bit 16 - In the read operations read-data phase apply 8 signals. 1: enable 0: disable. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_fread_oct(&mut self) -> SPI_FREAD_OCT_W<'_, SPI_CTRL_SPEC> {
        SPI_FREAD_OCT_W::new(self, 16)
    }
    #[doc = "Bit 18 - The bit is used to set MISO line polarity, 1: high 0, low. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_q_pol(&mut self) -> SPI_Q_POL_W<'_, SPI_CTRL_SPEC> {
        SPI_Q_POL_W::new(self, 18)
    }
    #[doc = "Bit 19 - The bit is used to set MOSI line polarity, 1: high 0, low. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_d_pol(&mut self) -> SPI_D_POL_W<'_, SPI_CTRL_SPEC> {
        SPI_D_POL_W::new(self, 19)
    }
    #[doc = "Bit 20 - SPI_HOLD output value when SPI is idle. 1: output high, 0: output low. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_hold_pol(&mut self) -> SPI_HOLD_POL_W<'_, SPI_CTRL_SPEC> {
        SPI_HOLD_POL_W::new(self, 20)
    }
    #[doc = "Bit 21 - Write protect signal output when SPI is idle. 1: output high, 0: output low. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_wp_pol(&mut self) -> SPI_WP_POL_W<'_, SPI_CTRL_SPEC> {
        SPI_WP_POL_W::new(self, 21)
    }
    #[doc = "Bits 23:24 - In read-data (MISO) phase 1: LSB first 0: MSB first. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_rd_bit_order(&mut self) -> SPI_RD_BIT_ORDER_W<'_, SPI_CTRL_SPEC> {
        SPI_RD_BIT_ORDER_W::new(self, 23)
    }
    #[doc = "Bits 25:26 - In command address write-data (MOSI) phases 1: LSB firs 0: MSB first. Can be configured in CONF state."]
    #[inline(always)]
    pub fn spi_wr_bit_order(&mut self) -> SPI_WR_BIT_ORDER_W<'_, SPI_CTRL_SPEC> {
