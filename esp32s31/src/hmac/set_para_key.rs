...
#[doc = "Field `KEY_SET` writer - Configures HMAC key. There are six keys with index 0~5. Write the index of the selected key to this field."]
...
impl W {
    #[doc = "Bits 0:2 - Configures HMAC key. There are six keys with index 0~5. Write the index of the selected key to this field."]
    #[inline(always)]
    pub fn key_set(&mut self) -> KEY_SET_W<'_, SET_PARA_KEY_SPEC> {
        KEY_SET_W::new(self, 0)
    }
}
#[doc = "HMAC parameters configuration register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`set_para_key::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
