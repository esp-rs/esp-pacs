...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn i2c1_scl_pulse_dur(&mut self) -> I2C1_SCL_PULSE_DUR_W<'_, I2C1_CTRL1_SPEC> {
        I2C1_SCL_PULSE_DUR_W::new(self, 0)
    }
    #[doc = "Bits 6:10"]
    #[inline(always)]
    pub fn i2c1_sda_side_guard(&mut self) -> I2C1_SDA_SIDE_GUARD_W<'_, I2C1_CTRL1_SPEC> {
