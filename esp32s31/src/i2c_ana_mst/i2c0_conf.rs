...
#[doc = "Field `I2C0_CONF` reader - "]
pub type I2C0_CONF_R = crate::FieldReader<u32>;
#[doc = "Field `I2C0_CONF` writer - "]
pub type I2C0_CONF_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
#[doc = "Field `I2C0_STATUS` reader - "]
pub type I2C0_STATUS_R = crate::FieldReader;
#[doc = "Field `I2C0_STATUS` writer - "]
pub type I2C0_STATUS_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:23"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:23"]
    #[inline(always)]
    pub fn i2c0_conf(&mut self) -> I2C0_CONF_W<'_, I2C0_CONF_SPEC> {
        I2C0_CONF_W::new(self, 0)
    }
    #[doc = "Bits 24:31"]
    #[inline(always)]
    pub fn i2c0_status(&mut self) -> I2C0_STATUS_W<'_, I2C0_CONF_SPEC> {
        I2C0_STATUS_W::new(self, 24)
    }
}
