...
#[doc = "Field `ANA_CONF2` reader - "]
pub type ANA_CONF2_R = crate::FieldReader<u32>;
#[doc = "Field `ANA_CONF2` writer - "]
pub type ANA_CONF2_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
#[doc = "Field `ANA_STATUS2` reader - "]
pub type ANA_STATUS2_R = crate::FieldReader;
#[doc = "Field `ANA_STATUS2` writer - "]
pub type ANA_STATUS2_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:23"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 24:31"]
    #[inline(always)]
    pub fn ana_status2(&mut self) -> ANA_STATUS2_W<'_, ANA_CONF2_SPEC> {
