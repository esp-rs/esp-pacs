...
#[doc = "Field `I2C1_CONF` reader - "]
pub type I2C1_CONF_R = crate::FieldReader<u32>;
#[doc = "Field `I2C1_CONF` writer - "]
pub type I2C1_CONF_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
#[doc = "Field `I2C1_STATUS` reader - "]
pub type I2C1_STATUS_R = crate::FieldReader;
#[doc = "Field `I2C1_STATUS` writer - "]
pub type I2C1_STATUS_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:23"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:23"]
    #[inline(always)]
    pub fn i2c1_conf(&mut self) -> I2C1_CONF_W<'_, I2C1_CONF_SPEC> {
        I2C1_CONF_W::new(self, 0)
    }
    #[doc = "Bits 24:31"]
    #[inline(always)]
    pub fn i2c1_status(&mut self) -> I2C1_STATUS_W<'_, I2C1_CONF_SPEC> {
        I2C1_STATUS_W::new(self, 24)
    }
}
