...
#[doc = "Field `RND_ECO_HIGH` reader - "]
pub type RND_ECO_HIGH_R = crate::FieldReader<u32>;
#[doc = "Field `RND_ECO_HIGH` writer - "]
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn rnd_eco_high(&mut self) -> RND_ECO_HIGH_W<'_, LP_RND_ECO_HIGH_SPEC> {
...
#[doc = "`reset()` method sets LP_RND_ECO_HIGH to value 0xffff"]
