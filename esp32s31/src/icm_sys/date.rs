...
#[doc = "Field `REG_DATE` reader - "]
pub type REG_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `REG_DATE` writer - "]
pub type REG_DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_date(&self) -> REG_DATE_R {
        REG_DATE_R::new(self.bits)
    }
}
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn reg_date(&mut self) -> REG_DATE_W<'_, DATE_SPEC> {
...
#[doc = "`reset()` method sets DATE to value 0x015f_ba94"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x015f_ba94;
}
