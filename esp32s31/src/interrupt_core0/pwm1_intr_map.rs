...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn map(&mut self) -> MAP_W<'_, PWM1_INTR_MAP_SPEC> {
        MAP_W::new(self, 0)
    }
    #[doc = "Bits 8:9"]
    #[inline(always)]
    pub fn pass_level(&mut self) -> PASS_LEVEL_W<'_, PWM1_INTR_MAP_SPEC> {
...
#[doc = "`reset()` method sets PWM1_INTR_MAP to value 0"]
