...
#[doc = "Field `FREE` reader - Represents if SHA Accelerator is free or not. \\\\ 0: non-free\\\\ 1: free\\\\"]
pub type FREE_R = crate::BitReader;
#[doc = "Field `FREE` writer - Represents if SHA Accelerator is free or not. \\\\ 0: non-free\\\\ 1: free\\\\"]
pub type FREE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Represents if SHA Accelerator is free or not. \\\\ 0: non-free\\\\ 1: free\\\\"]
    #[inline(always)]
