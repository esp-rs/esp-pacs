#[doc = "Register `PAD_BIST_SDIO` reader"]
pub type R = crate::R<PAD_BIST_SDIO_SPEC>;
#[doc = "Register `PAD_BIST_SDIO` writer"]
pub type W = crate::W<PAD_BIST_SDIO_SPEC>;
...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn out_clk_sel(&mut self) -> OUT_CLK_SEL_W<'_, PAD_BIST_SDIO_SPEC> {
        OUT_CLK_SEL_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn out_clk_en(&mut self) -> OUT_CLK_EN_W<'_, PAD_BIST_SDIO_SPEC> {
        OUT_CLK_EN_W::new(self, 1)
    }
    #[doc = "Bits 2:5 - need_des"]
    #[inline(always)]
    pub fn out_clk_div_num(&mut self) -> OUT_CLK_DIV_NUM_W<'_, PAD_BIST_SDIO_SPEC> {
        OUT_CLK_DIV_NUM_W::new(self, 2)
    }
    #[doc = "Bits 6:8 - need_des"]
    #[inline(always)]
    pub fn in_clk_sel(&mut self) -> IN_CLK_SEL_W<'_, PAD_BIST_SDIO_SPEC> {
        IN_CLK_SEL_W::new(self, 6)
    }
    #[doc = "Bit 9 - need_des"]
    #[inline(always)]
    pub fn in_clk_en(&mut self) -> IN_CLK_EN_W<'_, PAD_BIST_SDIO_SPEC> {
        IN_CLK_EN_W::new(self, 9)
    }
    #[doc = "Bit 10 - need_des"]
    #[inline(always)]
    pub fn rst_en(&mut self) -> RST_EN_W<'_, PAD_BIST_SDIO_SPEC> {
        RST_EN_W::new(self, 10)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`pad_bist_sdio::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pad_bist_sdio::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PAD_BIST_SDIO_SPEC;
impl crate::RegisterSpec for PAD_BIST_SDIO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pad_bist_sdio::R`](R) reader structure"]
impl crate::Readable for PAD_BIST_SDIO_SPEC {}
#[doc = "`write(|w| ..)` method takes [`pad_bist_sdio::W`](W) writer structure"]
impl crate::Writable for PAD_BIST_SDIO_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PAD_BIST_SDIO to value 0x0c"]
impl crate::Resettable for PAD_BIST_SDIO_SPEC {
