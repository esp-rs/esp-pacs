...
#[doc = "Field `REG_HPCORE1_STALL_EN` reader - need_des"]
pub type REG_HPCORE1_STALL_EN_R = crate::BitReader;
#[doc = "Field `REG_HPCORE1_STALL_EN` writer - need_des"]
pub type REG_HPCORE1_STALL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REG_HPCORE1_STALL_WAIT_NUM` reader - need_des"]
pub type REG_HPCORE1_STALL_WAIT_NUM_R = crate::FieldReader;
#[doc = "Field `REG_HPCORE1_STALL_WAIT_NUM` writer - need_des"]
pub type REG_HPCORE1_STALL_WAIT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `REG_WDT_HPCORE1_RST_LEN` reader - need_des"]
pub type REG_WDT_HPCORE1_RST_LEN_R = crate::FieldReader;
#[doc = "Field `REG_WDT_HPCORE1_RST_LEN` writer - need_des"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HPWDT_CORE1_RST_CTRL0")
            .field("reg_hpcore1_stall_en", &self.reg_hpcore1_stall_en())
            .field(
                "reg_hpcore1_stall_wait_num",
                &self.reg_hpcore1_stall_wait_num(),
            )
            .field("reg_wdt_hpcore1_rst_len", &self.reg_wdt_hpcore1_rst_len())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn reg_hpcore1_stall_en(
        &mut self,
    ) -> REG_HPCORE1_STALL_EN_W<'_, HPWDT_CORE1_RST_CTRL0_SPEC> {
    ...
    pub fn reg_hpcore1_stall_wait_num(
        &mut self,
    ) -> REG_HPCORE1_STALL_WAIT_NUM_W<'_, HPWDT_CORE1_RST_CTRL0_SPEC> {
    ...
    pub fn reg_wdt_hpcore1_rst_len(
        &mut self,
    ) -> REG_WDT_HPCORE1_RST_LEN_W<'_, HPWDT_CORE1_RST_CTRL0_SPEC> {
