...
#[doc = "Field `HPCORE1_STALL_WAIT_NUM` reader - need_des"]
pub type HPCORE1_STALL_WAIT_NUM_R = crate::FieldReader;
#[doc = "Field `HPCORE1_STALL_WAIT_NUM` writer - need_des"]
pub type HPCORE1_STALL_WAIT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `WDT_HPCORE1_RST_LEN` reader - need_des"]
pub type WDT_HPCORE1_RST_LEN_R = crate::FieldReader;
#[doc = "Field `WDT_HPCORE1_RST_LEN` writer - need_des"]
...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn hpcore1_stall_en(&mut self) -> HPCORE1_STALL_EN_W<'_, HPWDT_CORE1_RST_CTRL0_SPEC> {
    ...
    pub fn hpcore1_stall_wait_num(
        &mut self,
    ) -> HPCORE1_STALL_WAIT_NUM_W<'_, HPWDT_CORE1_RST_CTRL0_SPEC> {
        HPCORE1_STALL_WAIT_NUM_W::new(self, 1)
    }
    #[doc = "Bits 9:16 - need_des"]
    #[inline(always)]
    pub fn wdt_hpcore1_rst_len(&mut self) -> WDT_HPCORE1_RST_LEN_W<'_, HPWDT_CORE1_RST_CTRL0_SPEC> {
