...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn apb_clk_en(&mut self) -> APB_CLK_EN_W<'_, TIMERGRP0_CTRL0_SPEC> {
        APB_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn rst_en(&mut self) -> RST_EN_W<'_, TIMERGRP0_CTRL0_SPEC> {
        RST_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn force_norst(&mut self) -> FORCE_NORST_W<'_, TIMERGRP0_CTRL0_SPEC> {
        FORCE_NORST_W::new(self, 2)
    }
    #[doc = "Bits 3:4 - need_des"]
    #[inline(always)]
    pub fn t0_src_sel(&mut self) -> T0_SRC_SEL_W<'_, TIMERGRP0_CTRL0_SPEC> {
        T0_SRC_SEL_W::new(self, 3)
    }
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    pub fn t0_clk_en(&mut self) -> T0_CLK_EN_W<'_, TIMERGRP0_CTRL0_SPEC> {
        T0_CLK_EN_W::new(self, 5)
    }
    #[doc = "Bits 6:7 - need_des"]
    #[inline(always)]
    pub fn t1_src_sel(&mut self) -> T1_SRC_SEL_W<'_, TIMERGRP0_CTRL0_SPEC> {
        T1_SRC_SEL_W::new(self, 6)
    }
    #[doc = "Bit 8 - need_des"]
    #[inline(always)]
    pub fn t1_clk_en(&mut self) -> T1_CLK_EN_W<'_, TIMERGRP0_CTRL0_SPEC> {
        T1_CLK_EN_W::new(self, 8)
    }
    #[doc = "Bits 9:10 - need_des"]
    #[inline(always)]
    pub fn wdt_src_sel(&mut self) -> WDT_SRC_SEL_W<'_, TIMERGRP0_CTRL0_SPEC> {
        WDT_SRC_SEL_W::new(self, 9)
    }
    #[doc = "Bit 11 - need_des"]
    #[inline(always)]
    pub fn wdt_clk_en(&mut self) -> WDT_CLK_EN_W<'_, TIMERGRP0_CTRL0_SPEC> {
