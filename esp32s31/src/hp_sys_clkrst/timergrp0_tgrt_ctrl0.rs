...
#[doc = "Field `TIMERGRP0_TGRT_CLK_EN` reader - need_des"]
pub type TIMERGRP0_TGRT_CLK_EN_R = crate::BitReader;
#[doc = "Field `TIMERGRP0_TGRT_CLK_EN` writer - need_des"]
pub type TIMERGRP0_TGRT_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TIMERGRP0_TGRT_CLK_SRC_SEL` reader - need_des"]
pub type TIMERGRP0_TGRT_CLK_SRC_SEL_R = crate::FieldReader;
#[doc = "Field `TIMERGRP0_TGRT_CLK_SRC_SEL` writer - need_des"]
pub type TIMERGRP0_TGRT_CLK_SRC_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TIMERGRP0_TGRT_CLK_DIV_NUM` reader - need_des"]
pub type TIMERGRP0_TGRT_CLK_DIV_NUM_R = crate::FieldReader<u16>;
#[doc = "Field `TIMERGRP0_TGRT_CLK_DIV_NUM` writer - need_des"]
...
impl W {
    ...
    pub fn timergrp0_tgrt_clk_en(
        &mut self,
    ) -> TIMERGRP0_TGRT_CLK_EN_W<'_, TIMERGRP0_TGRT_CTRL0_SPEC> {
        TIMERGRP0_TGRT_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:4 - need_des"]
    #[inline(always)]
    pub fn timergrp0_tgrt_clk_src_sel(
        &mut self,
    ) -> TIMERGRP0_TGRT_CLK_SRC_SEL_W<'_, TIMERGRP0_TGRT_CTRL0_SPEC> {
        TIMERGRP0_TGRT_CLK_SRC_SEL_W::new(self, 1)
    }
    #[doc = "Bits 5:20 - need_des"]
    #[inline(always)]
    pub fn timergrp0_tgrt_clk_div_num(
        &mut self,
    ) -> TIMERGRP0_TGRT_CLK_DIV_NUM_W<'_, TIMERGRP0_TGRT_CTRL0_SPEC> {
        TIMERGRP0_TGRT_CLK_DIV_NUM_W::new(self, 5)
    }
}
