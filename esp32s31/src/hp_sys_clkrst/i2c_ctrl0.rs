#[doc = "Register `I2C_CTRL0%s` reader"]
pub type R = crate::R<I2C_CTRL0_SPEC>;
#[doc = "Register `I2C_CTRL0%s` writer"]
pub type W = crate::W<I2C_CTRL0_SPEC>;
...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn apb_clk_en(&mut self) -> APB_CLK_EN_W<'_, I2C_CTRL0_SPEC> {
        APB_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn rst_en(&mut self) -> RST_EN_W<'_, I2C_CTRL0_SPEC> {
        RST_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn force_norst(&mut self) -> FORCE_NORST_W<'_, I2C_CTRL0_SPEC> {
        FORCE_NORST_W::new(self, 2)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    pub fn clk_src_sel(&mut self) -> CLK_SRC_SEL_W<'_, I2C_CTRL0_SPEC> {
        CLK_SRC_SEL_W::new(self, 3)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    pub fn clk_en(&mut self) -> CLK_EN_W<'_, I2C_CTRL0_SPEC> {
        CLK_EN_W::new(self, 4)
    }
    #[doc = "Bits 5:12 - need_des"]
    #[inline(always)]
    pub fn clk_div_num(&mut self) -> CLK_DIV_NUM_W<'_, I2C_CTRL0_SPEC> {
        CLK_DIV_NUM_W::new(self, 5)
    }
    #[doc = "Bits 13:20 - need_des"]
    #[inline(always)]
    pub fn clk_div_numerator(&mut self) -> CLK_DIV_NUMERATOR_W<'_, I2C_CTRL0_SPEC> {
        CLK_DIV_NUMERATOR_W::new(self, 13)
    }
    #[doc = "Bits 21:28 - need_des"]
    #[inline(always)]
    pub fn clk_div_denominator(&mut self) -> CLK_DIV_DENOMINATOR_W<'_, I2C_CTRL0_SPEC> {
        CLK_DIV_DENOMINATOR_W::new(self, 21)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`i2c_ctrl0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i2c_ctrl0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I2C_CTRL0_SPEC;
impl crate::RegisterSpec for I2C_CTRL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i2c_ctrl0::R`](R) reader structure"]
impl crate::Readable for I2C_CTRL0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`i2c_ctrl0::W`](W) writer structure"]
impl crate::Writable for I2C_CTRL0_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I2C_CTRL0%s to value 0"]
impl crate::Resettable for I2C_CTRL0_SPEC {}
