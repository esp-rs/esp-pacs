...
#[doc = "Field `MODEM_CLK_SOURCE_SEL` reader - modem clk source sel"]
pub type MODEM_CLK_SOURCE_SEL_R = crate::BitReader;
#[doc = "Field `MODEM_CLK_SOURCE_SEL` writer - modem clk source sel"]
pub type MODEM_CLK_SOURCE_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MODEM_PLL_CLK_EN` reader - modem clk source pll on"]
pub type MODEM_PLL_CLK_EN_R = crate::BitReader;
#[doc = "Field `MODEM_PLL_CLK_EN` writer - modem clk source pll on"]
pub type MODEM_PLL_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MODEM_XTAL_CLK_EN` reader - modem clk source xtal on"]
pub type MODEM_XTAL_CLK_EN_R = crate::BitReader;
#[doc = "Field `MODEM_XTAL_CLK_EN` writer - modem clk source xtal on"]
pub type MODEM_XTAL_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 3 - modem clk source sel"]
    #[inline(always)]
    pub fn modem_clk_source_sel(&self) -> MODEM_CLK_SOURCE_SEL_R {
        MODEM_CLK_SOURCE_SEL_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - modem clk source pll on"]
    #[inline(always)]
    pub fn modem_pll_clk_en(&self) -> MODEM_PLL_CLK_EN_R {
        MODEM_PLL_CLK_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - modem clk source xtal on"]
    #[inline(always)]
    pub fn modem_xtal_clk_en(&self) -> MODEM_XTAL_CLK_EN_R {
        MODEM_XTAL_CLK_EN_R::new(((self.bits >> 5) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MODEM_CONF")
            ...
            .field("modem_clk_source_sel", &self.modem_clk_source_sel())
            .field("modem_pll_clk_en", &self.modem_pll_clk_en())
            .field("modem_xtal_clk_en", &self.modem_xtal_clk_en())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bit 3 - modem clk source sel"]
    #[inline(always)]
    pub fn modem_clk_source_sel(&mut self) -> MODEM_CLK_SOURCE_SEL_W<'_, MODEM_CONF_SPEC> {
        MODEM_CLK_SOURCE_SEL_W::new(self, 3)
    }
    #[doc = "Bit 4 - modem clk source pll on"]
    #[inline(always)]
    pub fn modem_pll_clk_en(&mut self) -> MODEM_PLL_CLK_EN_W<'_, MODEM_CONF_SPEC> {
        MODEM_PLL_CLK_EN_W::new(self, 4)
    }
    #[doc = "Bit 5 - modem clk source xtal on"]
    #[inline(always)]
    pub fn modem_xtal_clk_en(&mut self) -> MODEM_XTAL_CLK_EN_W<'_, MODEM_CONF_SPEC> {
        MODEM_XTAL_CLK_EN_W::new(self, 5)
    }
}
