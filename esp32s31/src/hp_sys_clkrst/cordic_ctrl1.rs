...
#[doc = "Field `CLK_DIV_DENONIMATOR` reader - need_des"]
pub type CLK_DIV_DENONIMATOR_R = crate::FieldReader;
#[doc = "Field `CLK_DIV_DENONIMATOR` writer - need_des"]
pub type CLK_DIV_DENONIMATOR_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ...
    pub fn clk_div_numerator(&self) -> CLK_DIV_NUMERATOR_R {
        CLK_DIV_NUMERATOR_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - need_des"]
    #[inline(always)]
    pub fn clk_div_denonimator(&self) -> CLK_DIV_DENONIMATOR_R {
        CLK_DIV_DENONIMATOR_R::new(((self.bits >> 16) & 0xff) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORDIC_CTRL1")
            ...
            .field("clk_div_denonimator", &self.clk_div_denonimator())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:7 - need_des"]
    #[inline(always)]
    pub fn clk_div_num(&mut self) -> CLK_DIV_NUM_W<'_, CORDIC_CTRL1_SPEC> {
        CLK_DIV_NUM_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - need_des"]
    #[inline(always)]
    pub fn clk_div_numerator(&mut self) -> CLK_DIV_NUMERATOR_W<'_, CORDIC_CTRL1_SPEC> {
        CLK_DIV_NUMERATOR_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - need_des"]
    #[inline(always)]
    pub fn clk_div_denonimator(&mut self) -> CLK_DIV_DENONIMATOR_W<'_, CORDIC_CTRL1_SPEC> {
        CLK_DIV_DENONIMATOR_W::new(self, 16)
    }
}
