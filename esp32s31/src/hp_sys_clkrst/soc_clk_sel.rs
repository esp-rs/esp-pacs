...
#[doc = "Field `SOC_CLK_SEL` reader - Configures to select the clock source of HP_ROOT_CLK.\\\\ 0 (default): XTAL_CLK\\\\ 1: PLL_F300M_CLK\\\\ 2: RC_FAST_CLK\\\\"]
pub type SOC_CLK_SEL_R = crate::FieldReader;
#[doc = "Field `SOC_CLK_SEL` writer - Configures to select the clock source of HP_ROOT_CLK.\\\\ 0 (default): XTAL_CLK\\\\ 1: PLL_F300M_CLK\\\\ 2: RC_FAST_CLK\\\\"]
...
impl R {
    ...
    pub fn soc_clk_sel(&self) -> SOC_CLK_SEL_R {
        SOC_CLK_SEL_R::new((self.bits & 3) as u8)
    }
}
...
impl W {
    #[doc = "Bits 0:1 - Configures to select the clock source of HP_ROOT_CLK.\\\\ 0 (default): XTAL_CLK\\\\ 1: PLL_F300M_CLK\\\\ 2: RC_FAST_CLK\\\\"]
    #[inline(always)]
    pub fn soc_clk_sel(&mut self) -> SOC_CLK_SEL_W<'_, SOC_CLK_SEL_SPEC> {
        SOC_CLK_SEL_W::new(self, 0)
    }
}
