...
#[doc = "Field `LEVEL` reader - need_des"]
pub type LEVEL_R = crate::FieldReader;
#[doc = "Field `LEVEL` writer - need_des"]
pub type LEVEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `CFG_SEL` reader - need_des"]
pub type CFG_SEL_R = crate::BitReader;
#[doc = "Field `CFG_SEL` writer - need_des"]
pub type CFG_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn cfg_sel(&self) -> CFG_SEL_R {
        CFG_SEL_R::new(((self.bits >> 2) & 1) != 0)
    }
}
...
impl W {
    #[doc = "Bits 0:1 - need_des"]
    #[inline(always)]
    pub fn level(&mut self) -> LEVEL_W<'_, DPA_CTRL0_SPEC> {
        LEVEL_W::new(self, 0)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn cfg_sel(&mut self) -> CFG_SEL_W<'_, DPA_CTRL0_SPEC> {
        CFG_SEL_W::new(self, 2)
    }
}
