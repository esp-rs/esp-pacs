...
#[doc = "Field `REG_SEC_DPA_LEVEL` reader - need_des"]
pub type REG_SEC_DPA_LEVEL_R = crate::FieldReader;
#[doc = "Field `REG_SEC_DPA_LEVEL` writer - need_des"]
pub type REG_SEC_DPA_LEVEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `REG_SEC_DPA_CFG_SEL` reader - need_des"]
pub type REG_SEC_DPA_CFG_SEL_R = crate::BitReader;
#[doc = "Field `REG_SEC_DPA_CFG_SEL` writer - need_des"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DPA_CTRL0")
            .field("reg_sec_dpa_level", &self.reg_sec_dpa_level())
            .field("reg_sec_dpa_cfg_sel", &self.reg_sec_dpa_cfg_sel())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:1 - need_des"]
    #[inline(always)]
    pub fn reg_sec_dpa_level(&mut self) -> REG_SEC_DPA_LEVEL_W<'_, DPA_CTRL0_SPEC> {
        REG_SEC_DPA_LEVEL_W::new(self, 0)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn reg_sec_dpa_cfg_sel(&mut self) -> REG_SEC_DPA_CFG_SEL_W<'_, DPA_CTRL0_SPEC> {
