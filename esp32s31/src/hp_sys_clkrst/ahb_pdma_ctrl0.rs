#[doc = "Register `AHB_PDMA_CTRL0` reader"]
...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn sys_clk_en(&mut self) -> SYS_CLK_EN_W<'_, AHB_PDMA_CTRL0_SPEC> {
        SYS_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn rst_en(&mut self) -> RST_EN_W<'_, AHB_PDMA_CTRL0_SPEC> {
        RST_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn force_norst(&mut self) -> FORCE_NORST_W<'_, AHB_PDMA_CTRL0_SPEC> {
...
pub struct AHB_PDMA_CTRL0_SPEC;
impl crate::RegisterSpec for AHB_PDMA_CTRL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ahb_pdma_ctrl0::R`](R) reader structure"]
impl crate::Readable for AHB_PDMA_CTRL0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ahb_pdma_ctrl0::W`](W) writer structure"]
impl crate::Writable for AHB_PDMA_CTRL0_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AHB_PDMA_CTRL0 to value 0x01"]
impl crate::Resettable for AHB_PDMA_CTRL0_SPEC {
