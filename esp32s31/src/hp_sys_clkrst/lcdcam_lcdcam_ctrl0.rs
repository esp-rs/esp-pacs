...
impl W {
    #[doc = "Bits 0:1 - need_des"]
    #[inline(always)]
    pub fn clk_src_sel(&mut self) -> CLK_SRC_SEL_W<'_, LCDCAM_LCDCAM_CTRL0_SPEC> {
        CLK_SRC_SEL_W::new(self, 0)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn clk_en(&mut self) -> CLK_EN_W<'_, LCDCAM_LCDCAM_CTRL0_SPEC> {
        CLK_EN_W::new(self, 2)
    }
    #[doc = "Bits 3:10 - need_des"]
    #[inline(always)]
    pub fn clk_div_num(&mut self) -> CLK_DIV_NUM_W<'_, LCDCAM_LCDCAM_CTRL0_SPEC> {
        CLK_DIV_NUM_W::new(self, 3)
    }
    #[doc = "Bits 11:18 - need_des"]
    #[inline(always)]
    pub fn clk_div_numerator(&mut self) -> CLK_DIV_NUMERATOR_W<'_, LCDCAM_LCDCAM_CTRL0_SPEC> {
        CLK_DIV_NUMERATOR_W::new(self, 11)
    }
    #[doc = "Bits 19:26 - need_des"]
    #[inline(always)]
    pub fn clk_div_denominator(&mut self) -> CLK_DIV_DENOMINATOR_W<'_, LCDCAM_LCDCAM_CTRL0_SPEC> {
