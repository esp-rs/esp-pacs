...
#[doc = "Field `APB_CLK_DIV_NUM` reader - need_des"]
pub type APB_CLK_DIV_NUM_R = crate::FieldReader;
#[doc = "Field `APB_CLK_DIV_NUM` writer - need_des"]
pub type APB_CLK_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `APB_CLK_DIV_NUMERATOR` reader - need_des"]
pub type APB_CLK_DIV_NUMERATOR_R = crate::FieldReader;
#[doc = "Field `APB_CLK_DIV_NUMERATOR` writer - need_des"]
pub type APB_CLK_DIV_NUMERATOR_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `APB_CLK_DIV_DENOMINATOR` reader - need_des"]
pub type APB_CLK_DIV_DENOMINATOR_R = crate::FieldReader;
#[doc = "Field `APB_CLK_DIV_DENOMINATOR` writer - need_des"]
pub type APB_CLK_DIV_DENOMINATOR_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:7 - need_des"]
    #[inline(always)]
    pub fn apb_clk_div_num(&self) -> APB_CLK_DIV_NUM_R {
        APB_CLK_DIV_NUM_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:10 - need_des"]
    #[inline(always)]
    pub fn apb_clk_div_numerator(&self) -> APB_CLK_DIV_NUMERATOR_R {
        APB_CLK_DIV_NUMERATOR_R::new(((self.bits >> 8) & 7) as u8)
    }
    #[doc = "Bits 11:13 - need_des"]
    #[inline(always)]
    pub fn apb_clk_div_denominator(&self) -> APB_CLK_DIV_DENOMINATOR_R {
        APB_CLK_DIV_DENOMINATOR_R::new(((self.bits >> 11) & 7) as u8)
    }
}
...
impl W {
    #[doc = "Bits 0:7 - need_des"]
    #[inline(always)]
    pub fn apb_clk_div_num(&mut self) -> APB_CLK_DIV_NUM_W<'_, APB_FREQ_CTRL0_SPEC> {
        APB_CLK_DIV_NUM_W::new(self, 0)
    }
    #[doc = "Bits 8:10 - need_des"]
    #[inline(always)]
    pub fn apb_clk_div_numerator(&mut self) -> APB_CLK_DIV_NUMERATOR_W<'_, APB_FREQ_CTRL0_SPEC> {
        APB_CLK_DIV_NUMERATOR_W::new(self, 8)
    }
    #[doc = "Bits 11:13 - need_des"]
    #[inline(always)]
    pub fn apb_clk_div_denominator(
        &mut self,
    ) -> APB_CLK_DIV_DENOMINATOR_W<'_, APB_FREQ_CTRL0_SPEC> {
        APB_CLK_DIV_DENOMINATOR_W::new(self, 11)
    }
}
