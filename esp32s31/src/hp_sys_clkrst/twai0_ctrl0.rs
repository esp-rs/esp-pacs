...
#[doc = "Field `TWAI0_APB_CLK_EN` reader - need_des"]
pub type TWAI0_APB_CLK_EN_R = crate::BitReader;
#[doc = "Field `TWAI0_APB_CLK_EN` writer - need_des"]
pub type TWAI0_APB_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TWAI0_CLK_SRC_SEL` reader - need_des"]
pub type TWAI0_CLK_SRC_SEL_R = crate::FieldReader;
#[doc = "Field `TWAI0_CLK_SRC_SEL` writer - need_des"]
pub type TWAI0_CLK_SRC_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `TWAI0_CLK_EN` reader - need_des"]
pub type TWAI0_CLK_EN_R = crate::BitReader;
#[doc = "Field `TWAI0_CLK_EN` writer - need_des"]
pub type TWAI0_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TWAI0_RST_EN` reader - need_des"]
pub type TWAI0_RST_EN_R = crate::BitReader;
#[doc = "Field `TWAI0_RST_EN` writer - need_des"]
pub type TWAI0_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TWAI0_FORCE_NORST` reader - need_des"]
pub type TWAI0_FORCE_NORST_R = crate::BitReader;
#[doc = "Field `TWAI0_FORCE_NORST` writer - need_des"]
pub type TWAI0_FORCE_NORST_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn twai0_apb_clk_en(&self) -> TWAI0_APB_CLK_EN_R {
        TWAI0_APB_CLK_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:2 - need_des"]
    #[inline(always)]
    pub fn twai0_clk_src_sel(&self) -> TWAI0_CLK_SRC_SEL_R {
        TWAI0_CLK_SRC_SEL_R::new(((self.bits >> 1) & 3) as u8)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    pub fn twai0_clk_en(&self) -> TWAI0_CLK_EN_R {
        TWAI0_CLK_EN_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    pub fn twai0_rst_en(&self) -> TWAI0_RST_EN_R {
        TWAI0_RST_EN_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    pub fn twai0_force_norst(&self) -> TWAI0_FORCE_NORST_R {
        TWAI0_FORCE_NORST_R::new(((self.bits >> 5) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TWAI0_CTRL0")
            ...
            .field("twai0_force_norst", &self.twai0_force_norst())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn twai0_apb_clk_en(&mut self) -> TWAI0_APB_CLK_EN_W<'_, TWAI0_CTRL0_SPEC> {
        TWAI0_APB_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - need_des"]
    #[inline(always)]
    pub fn twai0_clk_src_sel(&mut self) -> TWAI0_CLK_SRC_SEL_W<'_, TWAI0_CTRL0_SPEC> {
        TWAI0_CLK_SRC_SEL_W::new(self, 1)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    pub fn twai0_clk_en(&mut self) -> TWAI0_CLK_EN_W<'_, TWAI0_CTRL0_SPEC> {
        TWAI0_CLK_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    pub fn twai0_rst_en(&mut self) -> TWAI0_RST_EN_W<'_, TWAI0_CTRL0_SPEC> {
        TWAI0_RST_EN_W::new(self, 4)
    }
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    pub fn twai0_force_norst(&mut self) -> TWAI0_FORCE_NORST_W<'_, TWAI0_CTRL0_SPEC> {
        TWAI0_FORCE_NORST_W::new(self, 5)
    }
}
