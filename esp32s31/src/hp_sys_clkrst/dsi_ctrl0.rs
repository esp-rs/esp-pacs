...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DSI_CTRL0")
            .field("reg_dsi_sys_clk_en", &self.reg_dsi_sys_clk_en())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn reg_dsi_sys_clk_en(&mut self) -> REG_DSI_SYS_CLK_EN_W<'_, DSI_CTRL0_SPEC> {
        REG_DSI_SYS_CLK_EN_W::new(self, 0)
    }
}
