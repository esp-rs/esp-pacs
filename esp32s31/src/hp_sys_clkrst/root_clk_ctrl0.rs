...
impl W {
    ...
    pub fn soc_clk_div_update(&mut self) -> SOC_CLK_DIV_UPDATE_W<'_, ROOT_CLK_CTRL0_SPEC> {
        SOC_CLK_DIV_UPDATE_W::new(self, 0)
    }
}
