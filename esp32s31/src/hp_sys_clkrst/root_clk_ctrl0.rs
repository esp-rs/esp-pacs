...
#[doc = "Field `REG_SOC_CLK_UPDATE` reader - need_des"]
pub type REG_SOC_CLK_UPDATE_R = crate::BitReader;
#[doc = "Field `REG_SOC_CLK_UPDATE` writer - need_des"]
pub type REG_SOC_CLK_UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn reg_soc_clk_update(&self) -> REG_SOC_CLK_UPDATE_R {
        REG_SOC_CLK_UPDATE_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ROOT_CLK_CTRL0")
            .field("reg_soc_clk_update", &self.reg_soc_clk_update())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn reg_soc_clk_update(&mut self) -> REG_SOC_CLK_UPDATE_W<'_, ROOT_CLK_CTRL0_SPEC> {
        REG_SOC_CLK_UPDATE_W::new(self, 0)
    }
}
