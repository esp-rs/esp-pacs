...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GDMA_CTRL0")
            .field("reg_gdma_sys_clk_en", &self.reg_gdma_sys_clk_en())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn reg_gdma_sys_clk_en(&mut self) -> REG_GDMA_SYS_CLK_EN_W<'_, GDMA_CTRL0_SPEC> {
        REG_GDMA_SYS_CLK_EN_W::new(self, 0)
    }
}
