...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn regdma_sys_clk_en(&mut self) -> REGDMA_SYS_CLK_EN_W<'_, REGDMA_CTRL0_SPEC> {
        REGDMA_SYS_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn regdma_rst_en(&mut self) -> REGDMA_RST_EN_W<'_, REGDMA_CTRL0_SPEC> {
