...
#[doc = "Field `REG_SYS_CLK_DIV_NUM` reader - need_des"]
pub type REG_SYS_CLK_DIV_NUM_R = crate::FieldReader;
#[doc = "Field `REG_SYS_CLK_DIV_NUM` writer - need_des"]
pub type REG_SYS_CLK_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `REG_SYS_CLK_DIV_NUMERATOR` reader - need_des"]
pub type REG_SYS_CLK_DIV_NUMERATOR_R = crate::FieldReader;
#[doc = "Field `REG_SYS_CLK_DIV_NUMERATOR` writer - need_des"]
pub type REG_SYS_CLK_DIV_NUMERATOR_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `REG_SYS_CLK_DIV_DENOMINATOR` reader - need_des"]
pub type REG_SYS_CLK_DIV_DENOMINATOR_R = crate::FieldReader;
#[doc = "Field `REG_SYS_CLK_DIV_DENOMINATOR` writer - need_des"]
pub type REG_SYS_CLK_DIV_DENOMINATOR_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bits 0:7 - need_des"]
    #[inline(always)]
    pub fn reg_sys_clk_div_num(&self) -> REG_SYS_CLK_DIV_NUM_R {
        REG_SYS_CLK_DIV_NUM_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:10 - need_des"]
    #[inline(always)]
    pub fn reg_sys_clk_div_numerator(&self) -> REG_SYS_CLK_DIV_NUMERATOR_R {
        REG_SYS_CLK_DIV_NUMERATOR_R::new(((self.bits >> 8) & 7) as u8)
    }
    #[doc = "Bits 11:13 - need_des"]
    #[inline(always)]
    pub fn reg_sys_clk_div_denominator(&self) -> REG_SYS_CLK_DIV_DENOMINATOR_R {
        REG_SYS_CLK_DIV_DENOMINATOR_R::new(((self.bits >> 11) & 7) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SYS_FREQ_CTRL0")
            .field("reg_sys_clk_div_num", &self.reg_sys_clk_div_num())
            .field(
                "reg_sys_clk_div_numerator",
                &self.reg_sys_clk_div_numerator(),
            )
            .field(
                "reg_sys_clk_div_denominator",
                &self.reg_sys_clk_div_denominator(),
            )
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:7 - need_des"]
    #[inline(always)]
    pub fn reg_sys_clk_div_num(&mut self) -> REG_SYS_CLK_DIV_NUM_W<'_, SYS_FREQ_CTRL0_SPEC> {
        REG_SYS_CLK_DIV_NUM_W::new(self, 0)
    }
    #[doc = "Bits 8:10 - need_des"]
    #[inline(always)]
    pub fn reg_sys_clk_div_numerator(
        &mut self,
    ) -> REG_SYS_CLK_DIV_NUMERATOR_W<'_, SYS_FREQ_CTRL0_SPEC> {
        REG_SYS_CLK_DIV_NUMERATOR_W::new(self, 8)
    }
    #[doc = "Bits 11:13 - need_des"]
    #[inline(always)]
    pub fn reg_sys_clk_div_denominator(
        &mut self,
    ) -> REG_SYS_CLK_DIV_DENOMINATOR_W<'_, SYS_FREQ_CTRL0_SPEC> {
        REG_SYS_CLK_DIV_DENOMINATOR_W::new(self, 11)
    }
}
