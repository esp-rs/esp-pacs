...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2S1_RX_DIV_CTRL0")
            .field("reg_i2s1_rx_div_x", &self.reg_i2s1_rx_div_x())
            .field("reg_i2s1_rx_div_y", &self.reg_i2s1_rx_div_y())
            .field("reg_i2s1_rx_div_z", &self.reg_i2s1_rx_div_z())
            .field("reg_i2s1_rx_div_yn1", &self.reg_i2s1_rx_div_yn1())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:8 - need_des"]
    #[inline(always)]
    pub fn reg_i2s1_rx_div_x(&mut self) -> REG_I2S1_RX_DIV_X_W<'_, I2S1_RX_DIV_CTRL0_SPEC> {
        REG_I2S1_RX_DIV_X_W::new(self, 0)
    }
    #[doc = "Bits 9:17 - need_des"]
    #[inline(always)]
    pub fn reg_i2s1_rx_div_y(&mut self) -> REG_I2S1_RX_DIV_Y_W<'_, I2S1_RX_DIV_CTRL0_SPEC> {
        REG_I2S1_RX_DIV_Y_W::new(self, 9)
    }
    #[doc = "Bits 18:26 - need_des"]
    #[inline(always)]
    pub fn reg_i2s1_rx_div_z(&mut self) -> REG_I2S1_RX_DIV_Z_W<'_, I2S1_RX_DIV_CTRL0_SPEC> {
        REG_I2S1_RX_DIV_Z_W::new(self, 18)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn reg_i2s1_rx_div_yn1(&mut self) -> REG_I2S1_RX_DIV_YN1_W<'_, I2S1_RX_DIV_CTRL0_SPEC> {
