...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn emac_sys_clk_en(&mut self) -> EMAC_SYS_CLK_EN_W<'_, EMAC_CTRL0_SPEC> {
        EMAC_SYS_CLK_EN_W::new(self, 0)
    }
}
