#[doc = "Register `TCMMON_CTRL0` reader"]
...
pub struct TCMMON_CTRL0_SPEC;
impl crate::RegisterSpec for TCMMON_CTRL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tcmmon_ctrl0::R`](R) reader structure"]
impl crate::Readable for TCMMON_CTRL0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`tcmmon_ctrl0::W`](W) writer structure"]
impl crate::Writable for TCMMON_CTRL0_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TCMMON_CTRL0 to value 0"]
impl crate::Resettable for TCMMON_CTRL0_SPEC {}
