...
#[doc = "Field `REG_REF_500M_SEL` reader - need_des"]
pub type REG_REF_500M_SEL_R = crate::BitReader;
#[doc = "Field `REG_REF_500M_SEL` writer - need_des"]
pub type REG_REF_500M_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn reg_ref_500m_sel(&self) -> REG_REF_500M_SEL_R {
        REG_REF_500M_SEL_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REF_500M_CTRL0")
            .field("reg_ref_500m_sel", &self.reg_ref_500m_sel())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn reg_ref_500m_sel(&mut self) -> REG_REF_500M_SEL_W<'_, REF_500M_CTRL0_SPEC> {
        REG_REF_500M_SEL_W::new(self, 0)
    }
}
