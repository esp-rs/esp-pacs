...
#[doc = "Field `APB_CLK_EN` reader - cnnt_iomux clk en"]
pub type APB_CLK_EN_R = crate::BitReader;
#[doc = "Field `APB_CLK_EN` writer - cnnt_iomux clk en"]
...
impl W {
    #[doc = "Bit 0 - cnnt_iomux clk en"]
    #[inline(always)]
    pub fn apb_clk_en(&mut self) -> APB_CLK_EN_W<'_, CNNT_IOMUX_CTRL0_SPEC> {
