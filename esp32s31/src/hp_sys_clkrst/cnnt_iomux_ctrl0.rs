...
#[doc = "Field `REG_CNNT_IOMUX_APB_CLK_EN` reader - cnnt_iomux clk en"]
pub type REG_CNNT_IOMUX_APB_CLK_EN_R = crate::BitReader;
#[doc = "Field `REG_CNNT_IOMUX_APB_CLK_EN` writer - cnnt_iomux clk en"]
pub type REG_CNNT_IOMUX_APB_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - cnnt_iomux clk en"]
    #[inline(always)]
    pub fn reg_cnnt_iomux_apb_clk_en(&self) -> REG_CNNT_IOMUX_APB_CLK_EN_R {
        REG_CNNT_IOMUX_APB_CLK_EN_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CNNT_IOMUX_CTRL0")
            .field(
                "reg_cnnt_iomux_apb_clk_en",
                &self.reg_cnnt_iomux_apb_clk_en(),
            )
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - cnnt_iomux clk en"]
    #[inline(always)]
    pub fn reg_cnnt_iomux_apb_clk_en(
        &mut self,
    ) -> REG_CNNT_IOMUX_APB_CLK_EN_W<'_, CNNT_IOMUX_CTRL0_SPEC> {
        REG_CNNT_IOMUX_APB_CLK_EN_W::new(self, 0)
    }
}
