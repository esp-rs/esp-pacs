...
#[doc = "Field `MEM_CLK_DIV_NUM` reader - need_des"]
pub type MEM_CLK_DIV_NUM_R = crate::BitReader;
#[doc = "Field `MEM_CLK_DIV_NUM` writer - need_des"]
pub type MEM_CLK_DIV_NUM_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn mem_clk_div_num(&self) -> MEM_CLK_DIV_NUM_R {
        MEM_CLK_DIV_NUM_R::new((self.bits & 1) != 0)
    }
}
...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn mem_clk_div_num(&mut self) -> MEM_CLK_DIV_NUM_W<'_, MEM_FREQ_CTRL0_SPEC> {
