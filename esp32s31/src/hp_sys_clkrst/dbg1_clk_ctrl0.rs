...
impl W {
    #[doc = "Bits 0:7 - need_des"]
    #[inline(always)]
    pub fn dbg_ch1_sel(&mut self) -> DBG_CH1_SEL_W<'_, DBG1_CLK_CTRL0_SPEC> {
        DBG_CH1_SEL_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - need_des"]
    #[inline(always)]
    pub fn dbg_ch1_div_num(&mut self) -> DBG_CH1_DIV_NUM_W<'_, DBG1_CLK_CTRL0_SPEC> {
        DBG_CH1_DIV_NUM_W::new(self, 8)
    }
    #[doc = "Bit 16 - need_des"]
    #[inline(always)]
    pub fn dbg_ch1_en(&mut self) -> DBG_CH1_EN_W<'_, DBG1_CLK_CTRL0_SPEC> {
        DBG_CH1_EN_W::new(self, 16)
    }
}
