...
impl R {
    ...
    #[doc = "Bits 11:13 - cpu current div numerator"]
    #[inline(always)]
    pub fn reg_cpu_div_numerator_cur(&self) -> REG_CPU_DIV_NUMERATOR_CUR_R {
        REG_CPU_DIV_NUMERATOR_CUR_R::new(((self.bits >> 11) & 7) as u8)
    }
    #[doc = "Bits 14:16 - cpu current div denominator"]
    #[inline(always)]
    pub fn reg_cpu_div_denominator_cur(&self) -> REG_CPU_DIV_DENOMINATOR_CUR_R {
        REG_CPU_DIV_DENOMINATOR_CUR_R::new(((self.bits >> 14) & 7) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CPU_CLK_STATUS0")
            .field("reg_asic_or_fpga", &self.reg_asic_or_fpga())
            .field("reg_cpu_div_effect", &self.reg_cpu_div_effect())
            .field("reg_cpu_src_is_cpll", &self.reg_cpu_src_is_cpll())
            .field("reg_cpu_div_num_cur", &self.reg_cpu_div_num_cur())
            .field(
                "reg_cpu_div_numerator_cur",
                &self.reg_cpu_div_numerator_cur(),
            )
            .field(
                "reg_cpu_div_denominator_cur",
                &self.reg_cpu_div_denominator_cur(),
            )
            .finish()
    }
}
