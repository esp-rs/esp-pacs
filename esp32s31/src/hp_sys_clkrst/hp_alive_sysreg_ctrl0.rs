...
#[doc = "Field `APB_CLK_EN` reader - hp alive_sysreg clk en"]
pub type APB_CLK_EN_R = crate::BitReader;
#[doc = "Field `APB_CLK_EN` writer - hp alive_sysreg clk en"]
...
impl W {
    #[doc = "Bit 0 - hp alive_sysreg clk en"]
    #[inline(always)]
    pub fn apb_clk_en(&mut self) -> APB_CLK_EN_W<'_, HP_ALIVE_SYSREG_CTRL0_SPEC> {
