...
impl W {
    #[doc = "Bits 0:7 - need_des"]
    #[inline(always)]
    pub fn ref_240m_clk_div_num(&mut self) -> REF_240M_CLK_DIV_NUM_W<'_, REF_240M_CTRL0_SPEC> {
        REF_240M_CLK_DIV_NUM_W::new(self, 0)
    }
    #[doc = "Bit 8 - need_des"]
    #[inline(always)]
    pub fn ref_240m_clk_en(&mut self) -> REF_240M_CLK_EN_W<'_, REF_240M_CTRL0_SPEC> {
        REF_240M_CLK_EN_W::new(self, 8)
    }
}
