...
#[doc = "Field `REG_KEY_MANAGER_SYS_CLK_EN` reader - need_des"]
pub type REG_KEY_MANAGER_SYS_CLK_EN_R = crate::BitReader;
#[doc = "Field `REG_KEY_MANAGER_SYS_CLK_EN` writer - need_des"]
pub type REG_KEY_MANAGER_SYS_CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REG_CRYPTO_KM_RST_EN` reader - need_des"]
pub type REG_CRYPTO_KM_RST_EN_R = crate::BitReader;
#[doc = "Field `REG_CRYPTO_KM_RST_EN` writer - need_des"]
pub type REG_CRYPTO_KM_RST_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REG_CRYPTO_KM_CLK_EN` reader - need_des"]
pub type REG_CRYPTO_KM_CLK_EN_R = crate::BitReader;
#[doc = "Field `REG_CRYPTO_KM_CLK_EN` writer - need_des"]
...
impl R {
    ...
    pub fn reg_key_manager_sys_clk_en(&self) -> REG_KEY_MANAGER_SYS_CLK_EN_R {
        REG_KEY_MANAGER_SYS_CLK_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn reg_crypto_km_rst_en(&self) -> REG_CRYPTO_KM_RST_EN_R {
        REG_CRYPTO_KM_RST_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn reg_crypto_km_clk_en(&self) -> REG_CRYPTO_KM_CLK_EN_R {
        REG_CRYPTO_KM_CLK_EN_R::new(((self.bits >> 2) & 1) != 0)
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("KEY_MANAGER_CTRL0")
            .field(
                ...
                &self.reg_key_manager_sys_clk_en(),
            )
            .field("reg_crypto_km_rst_en", &self.reg_crypto_km_rst_en())
            .field("reg_crypto_km_clk_en", &self.reg_crypto_km_clk_en())
            .finish()
    }
}
impl W {
    ...
    pub fn reg_key_manager_sys_clk_en(
        &mut self,
    ) -> REG_KEY_MANAGER_SYS_CLK_EN_W<'_, KEY_MANAGER_CTRL0_SPEC> {
        REG_KEY_MANAGER_SYS_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn reg_crypto_km_rst_en(&mut self) -> REG_CRYPTO_KM_RST_EN_W<'_, KEY_MANAGER_CTRL0_SPEC> {
        REG_CRYPTO_KM_RST_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn reg_crypto_km_clk_en(&mut self) -> REG_CRYPTO_KM_CLK_EN_W<'_, KEY_MANAGER_CTRL0_SPEC> {
        REG_CRYPTO_KM_CLK_EN_W::new(self, 2)
    }
}
