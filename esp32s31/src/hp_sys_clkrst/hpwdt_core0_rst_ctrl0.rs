...
#[doc = "Field `HPCORE0_STALL_WAIT_NUM` reader - need_des"]
pub type HPCORE0_STALL_WAIT_NUM_R = crate::FieldReader;
#[doc = "Field `HPCORE0_STALL_WAIT_NUM` writer - need_des"]
pub type HPCORE0_STALL_WAIT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `WDT_HPCORE0_RST_LEN` reader - need_des"]
pub type WDT_HPCORE0_RST_LEN_R = crate::FieldReader;
#[doc = "Field `WDT_HPCORE0_RST_LEN` writer - need_des"]
