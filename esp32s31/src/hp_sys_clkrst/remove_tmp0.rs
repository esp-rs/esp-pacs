...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn gdma_cpu_clk_en(&mut self) -> GDMA_CPU_CLK_EN_W<'_, REMOVE_TMP0_SPEC> {
        GDMA_CPU_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn vpu_cpu_clk_en(&mut self) -> VPU_CPU_CLK_EN_W<'_, REMOVE_TMP0_SPEC> {
        VPU_CPU_CLK_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn vpu_sys_clk_en(&mut self) -> VPU_SYS_CLK_EN_W<'_, REMOVE_TMP0_SPEC> {
        VPU_SYS_CLK_EN_W::new(self, 2)
    }
}
