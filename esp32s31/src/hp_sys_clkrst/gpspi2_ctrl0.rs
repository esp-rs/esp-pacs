...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn sys_clk_en(&mut self) -> SYS_CLK_EN_W<'_, GPSPI2_CTRL0_SPEC> {
        SYS_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn apb_clk_en(&mut self) -> APB_CLK_EN_W<'_, GPSPI2_CTRL0_SPEC> {
        APB_CLK_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn rst_en(&mut self) -> RST_EN_W<'_, GPSPI2_CTRL0_SPEC> {
        RST_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    pub fn force_norst(&mut self) -> FORCE_NORST_W<'_, GPSPI2_CTRL0_SPEC> {
        FORCE_NORST_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - need_des"]
    #[inline(always)]
    pub fn clk_src_sel(&mut self) -> CLK_SRC_SEL_W<'_, GPSPI2_CTRL0_SPEC> {
        CLK_SRC_SEL_W::new(self, 4)
    }
    #[doc = "Bit 6 - need_des"]
    #[inline(always)]
    pub fn hs_clk_en(&mut self) -> HS_CLK_EN_W<'_, GPSPI2_CTRL0_SPEC> {
        HS_CLK_EN_W::new(self, 6)
    }
    #[doc = "Bits 7:14 - need_des"]
    #[inline(always)]
    pub fn hs_clk_div_num(&mut self) -> HS_CLK_DIV_NUM_W<'_, GPSPI2_CTRL0_SPEC> {
        HS_CLK_DIV_NUM_W::new(self, 7)
    }
    #[doc = "Bits 15:22 - need_des"]
    #[inline(always)]
    pub fn mst_clk_div_num(&mut self) -> MST_CLK_DIV_NUM_W<'_, GPSPI2_CTRL0_SPEC> {
        MST_CLK_DIV_NUM_W::new(self, 15)
    }
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn mst_clk_en(&mut self) -> MST_CLK_EN_W<'_, GPSPI2_CTRL0_SPEC> {
