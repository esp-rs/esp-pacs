...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn sys_clk_en(&mut self) -> SYS_CLK_EN_W<'_, PSRAM_CTRL0_SPEC> {
        SYS_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn axi_rst_en(&mut self) -> AXI_RST_EN_W<'_, PSRAM_CTRL0_SPEC> {
        AXI_RST_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn apb_rst_en(&mut self) -> APB_RST_EN_W<'_, PSRAM_CTRL0_SPEC> {
        APB_RST_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - need_des"]
    #[inline(always)]
    pub fn axi_force_norst(&mut self) -> AXI_FORCE_NORST_W<'_, PSRAM_CTRL0_SPEC> {
        AXI_FORCE_NORST_W::new(self, 3)
    }
    #[doc = "Bit 4 - need_des"]
    #[inline(always)]
    pub fn apb_force_norst(&mut self) -> APB_FORCE_NORST_W<'_, PSRAM_CTRL0_SPEC> {
        APB_FORCE_NORST_W::new(self, 4)
    }
    #[doc = "Bits 5:6 - need_des"]
    #[inline(always)]
    pub fn clk_src_sel(&mut self) -> CLK_SRC_SEL_W<'_, PSRAM_CTRL0_SPEC> {
        CLK_SRC_SEL_W::new(self, 5)
    }
    #[doc = "Bit 7 - need_des"]
    #[inline(always)]
    pub fn pll_clk_en(&mut self) -> PLL_CLK_EN_W<'_, PSRAM_CTRL0_SPEC> {
        PLL_CLK_EN_W::new(self, 7)
    }
    #[doc = "Bit 8 - need_des"]
    #[inline(always)]
    pub fn core_clk_en(&mut self) -> CORE_CLK_EN_W<'_, PSRAM_CTRL0_SPEC> {
        CORE_CLK_EN_W::new(self, 8)
    }
    #[doc = "Bits 9:16 - need_des"]
    #[inline(always)]
    pub fn core_clk_div_num(&mut self) -> CORE_CLK_DIV_NUM_W<'_, PSRAM_CTRL0_SPEC> {
