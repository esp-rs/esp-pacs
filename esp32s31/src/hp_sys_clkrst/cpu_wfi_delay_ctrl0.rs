...
#[doc = "Field `REG_CPUICM_DELAY_NUM` reader - need_des"]
pub type REG_CPUICM_DELAY_NUM_R = crate::FieldReader;
#[doc = "Field `REG_CPUICM_DELAY_NUM` writer - need_des"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CPU_WFI_DELAY_CTRL0")
            .field("reg_cpuicm_delay_num", &self.reg_cpuicm_delay_num())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:3 - need_des"]
    #[inline(always)]
    pub fn reg_cpuicm_delay_num(&mut self) -> REG_CPUICM_DELAY_NUM_W<'_, CPU_WFI_DELAY_CTRL0_SPEC> {
