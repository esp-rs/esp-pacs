...
#[doc = "Field `REG_REF_25M_CLK_DIV_NUM` reader - need_des"]
pub type REG_REF_25M_CLK_DIV_NUM_R = crate::FieldReader;
#[doc = "Field `REG_REF_25M_CLK_DIV_NUM` writer - need_des"]
pub type REG_REF_25M_CLK_DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `REG_REF_25M_CLK_EN` reader - need_des"]
pub type REG_REF_25M_CLK_EN_R = crate::BitReader;
#[doc = "Field `REG_REF_25M_CLK_EN` writer - need_des"]
...
impl R {
    ...
    pub fn reg_ref_25m_clk_div_num(&self) -> REG_REF_25M_CLK_DIV_NUM_R {
        REG_REF_25M_CLK_DIV_NUM_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bit 8 - need_des"]
    #[inline(always)]
    pub fn reg_ref_25m_clk_en(&self) -> REG_REF_25M_CLK_EN_R {
        REG_REF_25M_CLK_EN_R::new(((self.bits >> 8) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REF_25M_CTRL0")
            .field("reg_ref_25m_clk_div_num", &self.reg_ref_25m_clk_div_num())
            .field("reg_ref_25m_clk_en", &self.reg_ref_25m_clk_en())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:7 - need_des"]
    #[inline(always)]
    pub fn reg_ref_25m_clk_div_num(&mut self) -> REG_REF_25M_CLK_DIV_NUM_W<'_, REF_25M_CTRL0_SPEC> {
        REG_REF_25M_CLK_DIV_NUM_W::new(self, 0)
    }
    #[doc = "Bit 8 - need_des"]
    #[inline(always)]
    pub fn reg_ref_25m_clk_en(&mut self) -> REG_REF_25M_CLK_EN_W<'_, REF_25M_CTRL0_SPEC> {
        REG_REF_25M_CLK_EN_W::new(self, 8)
    }
}
