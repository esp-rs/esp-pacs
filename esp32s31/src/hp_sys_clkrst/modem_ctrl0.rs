...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn modem_clk_en(&mut self) -> MODEM_CLK_EN_W<'_, MODEM_CTRL0_SPEC> {
        MODEM_CLK_EN_W::new(self, 0)
    }
}
