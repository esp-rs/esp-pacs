...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn i2s1_rx_clk_en(&mut self) -> I2S1_RX_CLK_EN_W<'_, I2S1_RX_CTRL0_SPEC> {
        I2S1_RX_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bits 1:2 - need_des"]
    #[inline(always)]
    pub fn i2s1_rx_clk_src_sel(&mut self) -> I2S1_RX_CLK_SRC_SEL_W<'_, I2S1_RX_CTRL0_SPEC> {
        I2S1_RX_CLK_SRC_SEL_W::new(self, 1)
    }
    #[doc = "Bits 3:10 - need_des"]
    #[inline(always)]
    pub fn i2s1_rx_div_n(&mut self) -> I2S1_RX_DIV_N_W<'_, I2S1_RX_CTRL0_SPEC> {
        I2S1_RX_DIV_N_W::new(self, 3)
    }
    #[doc = "Bit 11 - need_des"]
    #[inline(always)]
    pub fn i2s1_mst_clk_sel(&mut self) -> I2S1_MST_CLK_SEL_W<'_, I2S1_RX_CTRL0_SPEC> {
        I2S1_MST_CLK_SEL_W::new(self, 11)
    }
}
