...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn apb_clk_en(&mut self) -> APB_CLK_EN_W<'_, MCPWM3_CTRL0_SPEC> {
        APB_CLK_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn rst_en(&mut self) -> RST_EN_W<'_, MCPWM3_CTRL0_SPEC> {
        RST_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - need_des"]
    #[inline(always)]
    pub fn force_norst(&mut self) -> FORCE_NORST_W<'_, MCPWM3_CTRL0_SPEC> {
        FORCE_NORST_W::new(self, 2)
    }
    #[doc = "Bits 3:4 - need_des"]
    #[inline(always)]
    pub fn clk_src_sel(&mut self) -> CLK_SRC_SEL_W<'_, MCPWM3_CTRL0_SPEC> {
        CLK_SRC_SEL_W::new(self, 3)
    }
    #[doc = "Bit 5 - need_des"]
    #[inline(always)]
    pub fn clk_en(&mut self) -> CLK_EN_W<'_, MCPWM3_CTRL0_SPEC> {
        CLK_EN_W::new(self, 5)
    }
    #[doc = "Bits 6:13 - need_des"]
    #[inline(always)]
    pub fn clk_div_num(&mut self) -> CLK_DIV_NUM_W<'_, MCPWM3_CTRL0_SPEC> {
