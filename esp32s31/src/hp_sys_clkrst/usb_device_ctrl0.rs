...
impl W {
    #[doc = "Bit 0 - need_des"]
    #[inline(always)]
    pub fn usb_device_apb_clk_en(&mut self) -> USB_DEVICE_APB_CLK_EN_W<'_, USB_DEVICE_CTRL0_SPEC> {
        USB_DEVICE_APB_CLK_EN_W::new(self, 0)
    }
}
