#[doc = "Register `EVT_ST8_CLR` writer"]
pub type W = crate::W<EVT_ST8_CLR_SPEC>;
...
#[doc = "Field `REGDMA_EVT_FAIL0_ST_CLR` writer - Configures whether or not to clear REGDMA_evt_fail0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
pub type REGDMA_EVT_FAIL0_ST_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REGDMA_EVT_FAIL1_ST_CLR` writer - Configures whether or not to clear REGDMA_evt_fail1 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
pub type REGDMA_EVT_FAIL1_ST_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REGDMA_EVT_FAIL2_ST_CLR` writer - Configures whether or not to clear REGDMA_evt_fail2 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
pub type REGDMA_EVT_FAIL2_ST_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REGDMA_EVT_FAIL3_ST_CLR` writer - Configures whether or not to clear REGDMA_evt_fail3 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
pub type REGDMA_EVT_FAIL3_ST_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `PDMA_AHB_EVT_IN_DONE_CH3_ST_CLR` writer - Configures whether or not to clear PDMA_AHB_evt_in_done_ch3 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
pub type PDMA_AHB_EVT_IN_DONE_CH3_ST_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PDMA_AHB_EVT_IN_DONE_CH4_ST_CLR` writer - Configures whether or not to clear PDMA_AHB_evt_in_done_ch4 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
pub type PDMA_AHB_EVT_IN_DONE_CH4_ST_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `PDMA_AHB_EVT_IN_SUC_EOF_CH3_ST_CLR` writer - Configures whether or not to clear PDMA_AHB_evt_in_suc_eof_ch3 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
pub type PDMA_AHB_EVT_IN_SUC_EOF_CH3_ST_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<EVT_ST8_CLR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    pub fn regdma_evt_done1_st_clr(&mut self) -> REGDMA_EVT_DONE1_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn regdma_evt_done2_st_clr(&mut self) -> REGDMA_EVT_DONE2_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn regdma_evt_done3_st_clr(&mut self) -> REGDMA_EVT_DONE3_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        REGDMA_EVT_DONE3_ST_CLR_W::new(self, 2)
    }
    #[doc = "Bit 3 - Configures whether or not to clear REGDMA_evt_fail0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn regdma_evt_fail0_st_clr(&mut self) -> REGDMA_EVT_FAIL0_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        REGDMA_EVT_FAIL0_ST_CLR_W::new(self, 3)
    }
    #[doc = "Bit 4 - Configures whether or not to clear REGDMA_evt_fail1 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn regdma_evt_fail1_st_clr(&mut self) -> REGDMA_EVT_FAIL1_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        REGDMA_EVT_FAIL1_ST_CLR_W::new(self, 4)
    }
    #[doc = "Bit 5 - Configures whether or not to clear REGDMA_evt_fail2 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn regdma_evt_fail2_st_clr(&mut self) -> REGDMA_EVT_FAIL2_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        REGDMA_EVT_FAIL2_ST_CLR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Configures whether or not to clear REGDMA_evt_fail3 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn regdma_evt_fail3_st_clr(&mut self) -> REGDMA_EVT_FAIL3_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        REGDMA_EVT_FAIL3_ST_CLR_W::new(self, 6)
    }
    ...
    pub fn tmpsnsr_evt_over_limit_st_clr(
        &mut self,
    ) -> TMPSNSR_EVT_OVER_LIMIT_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s0_evt_rx_done_st_clr(&mut self) -> I2S0_EVT_RX_DONE_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s0_evt_tx_done_st_clr(&mut self) -> I2S0_EVT_TX_DONE_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    pub fn i2s0_evt_x_words_received_st_clr(
        &mut self,
    ) -> I2S0_EVT_X_WORDS_RECEIVED_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    pub fn i2s0_evt_x_words_sent_st_clr(
        &mut self,
    ) -> I2S0_EVT_X_WORDS_SENT_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_evt_rx_done_st_clr(&mut self) -> I2S1_EVT_RX_DONE_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn i2s1_evt_tx_done_st_clr(&mut self) -> I2S1_EVT_TX_DONE_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    pub fn i2s1_evt_x_words_received_st_clr(
        &mut self,
    ) -> I2S1_EVT_X_WORDS_RECEIVED_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    pub fn i2s1_evt_x_words_sent_st_clr(
        &mut self,
    ) -> I2S1_EVT_X_WORDS_SENT_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn ulp_evt_err_intr_st_clr(&mut self) -> ULP_EVT_ERR_INTR_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn ulp_evt_halt_st_clr(&mut self) -> ULP_EVT_HALT_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    pub fn ulp_evt_start_intr_st_clr(
        &mut self,
    ) -> ULP_EVT_START_INTR_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_evt_tick_st_clr(&mut self) -> RTC_EVT_TICK_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_evt_ovf_st_clr(&mut self) -> RTC_EVT_OVF_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn rtc_evt_cmp_st_clr(&mut self) -> RTC_EVT_CMP_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        RTC_EVT_CMP_ST_CLR_W::new(self, 21)
    }
    #[doc = "Bit 22 - Configures whether or not to clear PMU_evt_sleep_weekup trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pmu_evt_sleep_weekup_st_clr(
        &mut self,
    ) -> PMU_EVT_SLEEP_WEEKUP_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PMU_EVT_SLEEP_WEEKUP_ST_CLR_W::new(self, 22)
    }
    #[doc = "Bit 23 - Configures whether or not to clear PDMA_AHB_evt_in_done_ch0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pdma_ahb_evt_in_done_ch0_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_IN_DONE_CH0_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PDMA_AHB_EVT_IN_DONE_CH0_ST_CLR_W::new(self, 23)
    }
    #[doc = "Bit 24 - Configures whether or not to clear PDMA_AHB_evt_in_done_ch1 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pdma_ahb_evt_in_done_ch1_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_IN_DONE_CH1_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PDMA_AHB_EVT_IN_DONE_CH1_ST_CLR_W::new(self, 24)
    }
    #[doc = "Bit 25 - Configures whether or not to clear PDMA_AHB_evt_in_done_ch2 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pdma_ahb_evt_in_done_ch2_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_IN_DONE_CH2_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PDMA_AHB_EVT_IN_DONE_CH2_ST_CLR_W::new(self, 25)
    }
    #[doc = "Bit 26 - Configures whether or not to clear PDMA_AHB_evt_in_done_ch3 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pdma_ahb_evt_in_done_ch3_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_IN_DONE_CH3_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PDMA_AHB_EVT_IN_DONE_CH3_ST_CLR_W::new(self, 26)
    }
    #[doc = "Bit 27 - Configures whether or not to clear PDMA_AHB_evt_in_done_ch4 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pdma_ahb_evt_in_done_ch4_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_IN_DONE_CH4_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PDMA_AHB_EVT_IN_DONE_CH4_ST_CLR_W::new(self, 27)
    }
    #[doc = "Bit 28 - Configures whether or not to clear PDMA_AHB_evt_in_suc_eof_ch0 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pdma_ahb_evt_in_suc_eof_ch0_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_IN_SUC_EOF_CH0_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PDMA_AHB_EVT_IN_SUC_EOF_CH0_ST_CLR_W::new(self, 28)
    }
    #[doc = "Bit 29 - Configures whether or not to clear PDMA_AHB_evt_in_suc_eof_ch1 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pdma_ahb_evt_in_suc_eof_ch1_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_IN_SUC_EOF_CH1_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PDMA_AHB_EVT_IN_SUC_EOF_CH1_ST_CLR_W::new(self, 29)
    }
    #[doc = "Bit 30 - Configures whether or not to clear PDMA_AHB_evt_in_suc_eof_ch2 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pdma_ahb_evt_in_suc_eof_ch2_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_IN_SUC_EOF_CH2_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PDMA_AHB_EVT_IN_SUC_EOF_CH2_ST_CLR_W::new(self, 30)
    }
    #[doc = "Bit 31 - Configures whether or not to clear PDMA_AHB_evt_in_suc_eof_ch3 trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn pdma_ahb_evt_in_suc_eof_ch3_st_clr(
        &mut self,
    ) -> PDMA_AHB_EVT_IN_SUC_EOF_CH3_ST_CLR_W<'_, EVT_ST8_CLR_SPEC> {
        PDMA_AHB_EVT_IN_SUC_EOF_CH3_ST_CLR_W::new(self, 31)
    }
}
#[doc = "Events trigger status clear register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`evt_st8_clr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EVT_ST8_CLR_SPEC;
impl crate::RegisterSpec for EVT_ST8_CLR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`evt_st8_clr::W`](W) writer structure"]
impl crate::Writable for EVT_ST8_CLR_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EVT_ST8_CLR to value 0"]
impl crate::Resettable for EVT_ST8_CLR_SPEC {}
