...
impl W {
    ...
    pub fn mcpwm0_evt_op2_tea_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP2_TEA_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_op0_teb_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP0_TEB_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_op1_teb_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP1_TEB_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_op2_teb_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP2_TEB_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_f0_st_clr(&mut self) -> MCPWM0_EVT_F0_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_f1_st_clr(&mut self) -> MCPWM0_EVT_F1_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_f2_st_clr(&mut self) -> MCPWM0_EVT_F2_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_f0_clr_st_clr(&mut self) -> MCPWM0_EVT_F0_CLR_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_f1_clr_st_clr(&mut self) -> MCPWM0_EVT_F1_CLR_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_f2_clr_st_clr(&mut self) -> MCPWM0_EVT_F2_CLR_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_tz0_cbc_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TZ0_CBC_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_tz1_cbc_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TZ1_CBC_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_tz2_cbc_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TZ2_CBC_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_tz0_ost_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TZ0_OST_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_tz1_ost_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TZ1_OST_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_tz2_ost_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_TZ2_OST_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_cap0_st_clr(&mut self) -> MCPWM0_EVT_CAP0_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_cap1_st_clr(&mut self) -> MCPWM0_EVT_CAP1_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    #[inline(always)]
    pub fn mcpwm0_evt_cap2_st_clr(&mut self) -> MCPWM0_EVT_CAP2_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_op0_tee1_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP0_TEE1_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_op1_tee1_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP1_TEE1_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_op2_tee1_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP2_TEE1_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_op0_tee2_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP0_TEE2_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_op1_tee2_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP1_TEE2_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
    ...
    pub fn mcpwm0_evt_op2_tee2_st_clr(
        &mut self,
    ) -> MCPWM0_EVT_OP2_TEE2_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
        MCPWM0_EVT_OP2_TEE2_ST_CLR_W::new(self, 24)
    }
    #[doc = "Bit 25 - Configures whether or not to clear MCPWM1_evt_timer0_stop trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn mcpwm1_evt_timer0_stop_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_TIMER0_STOP_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
        MCPWM1_EVT_TIMER0_STOP_ST_CLR_W::new(self, 25)
    }
    #[doc = "Bit 26 - Configures whether or not to clear MCPWM1_evt_timer1_stop trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn mcpwm1_evt_timer1_stop_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_TIMER1_STOP_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
        MCPWM1_EVT_TIMER1_STOP_ST_CLR_W::new(self, 26)
    }
    #[doc = "Bit 27 - Configures whether or not to clear MCPWM1_evt_timer2_stop trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn mcpwm1_evt_timer2_stop_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_TIMER2_STOP_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
        MCPWM1_EVT_TIMER2_STOP_ST_CLR_W::new(self, 27)
    }
    #[doc = "Bit 28 - Configures whether or not to clear MCPWM1_evt_timer0_tez trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn mcpwm1_evt_timer0_tez_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_TIMER0_TEZ_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
        MCPWM1_EVT_TIMER0_TEZ_ST_CLR_W::new(self, 28)
    }
    #[doc = "Bit 29 - Configures whether or not to clear MCPWM1_evt_timer1_tez trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn mcpwm1_evt_timer1_tez_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_TIMER1_TEZ_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
        MCPWM1_EVT_TIMER1_TEZ_ST_CLR_W::new(self, 29)
    }
    #[doc = "Bit 30 - Configures whether or not to clear MCPWM1_evt_timer2_tez trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn mcpwm1_evt_timer2_tez_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_TIMER2_TEZ_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
        MCPWM1_EVT_TIMER2_TEZ_ST_CLR_W::new(self, 30)
    }
    #[doc = "Bit 31 - Configures whether or not to clear MCPWM1_evt_timer0_tep trigger status.\\\\0: Invalid, No effect\\\\1: Clear"]
    #[inline(always)]
    pub fn mcpwm1_evt_timer0_tep_st_clr(
        &mut self,
    ) -> MCPWM1_EVT_TIMER0_TEP_ST_CLR_W<'_, EVT_ST3_CLR_SPEC> {
        MCPWM1_EVT_TIMER0_TEP_ST_CLR_W::new(self, 31)
    }
}
