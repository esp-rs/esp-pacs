...
#[doc = "Field `TASK_ID` reader - Configures ch%s_task_id"]
pub type TASK_ID_R = crate::FieldReader<u16>;
#[doc = "Field `TASK_ID` writer - Configures ch%s_task_id"]
pub type TASK_ID_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    #[doc = "Bits 0:8 - Configures ch%s_task_id"]
    #[inline(always)]
    pub fn task_id(&self) -> TASK_ID_R {
        TASK_ID_R::new((self.bits & 0x01ff) as u16)
    }
}
...
impl W {
    #[doc = "Bits 0:8 - Configures ch%s_task_id"]
    #[inline(always)]
    pub fn task_id(&mut self) -> TASK_ID_W<'_, TASK_ID_SPEC> {
