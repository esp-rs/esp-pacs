...
#[doc = "Field `EVT_ID` reader - Configures ch%s_evt_id"]
pub type EVT_ID_R = crate::FieldReader<u16>;
#[doc = "Field `EVT_ID` writer - Configures ch%s_evt_id"]
pub type EVT_ID_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
impl R {
    #[doc = "Bits 0:8 - Configures ch%s_evt_id"]
    #[inline(always)]
    pub fn evt_id(&self) -> EVT_ID_R {
        EVT_ID_R::new((self.bits & 0x01ff) as u16)
    }
}
...
impl W {
    #[doc = "Bits 0:8 - Configures ch%s_evt_id"]
    #[inline(always)]
    pub fn evt_id(&mut self) -> EVT_ID_W<'_, EVT_ID_SPEC> {
        EVT_ID_W::new(self, 0)
    }
}
