...
#[doc = "Field `FORCE_ACC_HPMEM_EN` reader - Configures whether to allow LP CPU to force access to HP_MEM regardless of permission management.\\\\ 0x5a: enable force access HP_MEM \\\\ other: disable force access HP_MEM \\\\"]
pub type FORCE_ACC_HPMEM_EN_R = crate::FieldReader;
#[doc = "Field `FORCE_ACC_HPMEM_EN` writer - Configures whether to allow LP CPU to force access to HP_MEM regardless of permission management.\\\\ 0x5a: enable force access HP_MEM \\\\ other: disable force access HP_MEM \\\\"]
pub type FORCE_ACC_HPMEM_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - Configures whether to allow LP CPU to force access to HP_MEM regardless of permission management.\\\\ 0x5a: enable force access HP_MEM \\\\ other: disable force access HP_MEM \\\\"]
    #[inline(always)]
    pub fn force_acc_hpmem_en(&self) -> FORCE_ACC_HPMEM_EN_R {
        FORCE_ACC_HPMEM_EN_R::new((self.bits & 0xff) as u8)
    }
}
