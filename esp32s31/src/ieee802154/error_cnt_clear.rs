...
#[doc = "Field `RX_FILTER_NOT_WORK_CNT_CLEAR` reader - "]
pub type RX_FILTER_NOT_WORK_CNT_CLEAR_R = crate::BitReader;
#[doc = "Field `RX_FILTER_NOT_WORK_CNT_CLEAR` writer - "]
pub type RX_FILTER_NOT_WORK_CNT_CLEAR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RX_PREAMBLE_DETECT_ERR_CNT_CLEAR` reader - "]
pub type RX_PREAMBLE_DETECT_ERR_CNT_CLEAR_R = crate::BitReader;
#[doc = "Field `RX_PREAMBLE_DETECT_ERR_CNT_CLEAR` writer - "]
pub type RX_PREAMBLE_DETECT_ERR_CNT_CLEAR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn ed_scan_coex_cnt_clear(&self) -> ED_SCAN_COEX_CNT_CLEAR_R {
        ED_SCAN_COEX_CNT_CLEAR_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn cca_busy_cnt_clear(&self) -> CCA_BUSY_CNT_CLEAR_R {
        CCA_BUSY_CNT_CLEAR_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn cca_fail_cnt_clear(&self) -> CCA_FAIL_CNT_CLEAR_R {
        CCA_FAIL_CNT_CLEAR_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn ed_abort_cnt_clear(&self) -> ED_ABORT_CNT_CLEAR_R {
        ED_ABORT_CNT_CLEAR_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn tx_security_error_cnt_clear(&self) -> TX_SECURITY_ERROR_CNT_CLEAR_R {
        TX_SECURITY_ERROR_CNT_CLEAR_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn tx_break_coex_cnt_clear(&self) -> TX_BREAK_COEX_CNT_CLEAR_R {
        TX_BREAK_COEX_CNT_CLEAR_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    ...
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn rx_filter_not_work_cnt_clear(&self) -> RX_FILTER_NOT_WORK_CNT_CLEAR_R {
        RX_FILTER_NOT_WORK_CNT_CLEAR_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn rx_preamble_detect_err_cnt_clear(&self) -> RX_PREAMBLE_DETECT_ERR_CNT_CLEAR_R {
        RX_PREAMBLE_DETECT_ERR_CNT_CLEAR_R::new(((self.bits >> 16) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ERROR_CNT_CLEAR")
            ...
            .field(
                "rx_filter_not_work_cnt_clear",
                &self.rx_filter_not_work_cnt_clear(),
            )
            .field(
                "rx_preamble_detect_err_cnt_clear",
                &self.rx_preamble_detect_err_cnt_clear(),
            )
            .finish()
    }
}
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn ed_scan_coex_cnt_clear(&mut self) -> ED_SCAN_COEX_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        ED_SCAN_COEX_CNT_CLEAR_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn cca_busy_cnt_clear(&mut self) -> CCA_BUSY_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        CCA_BUSY_CNT_CLEAR_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn cca_fail_cnt_clear(&mut self) -> CCA_FAIL_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        CCA_FAIL_CNT_CLEAR_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn ed_abort_cnt_clear(&mut self) -> ED_ABORT_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        ED_ABORT_CNT_CLEAR_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn tx_security_error_cnt_clear(
        &mut self,
    ) -> TX_SECURITY_ERROR_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        TX_SECURITY_ERROR_CNT_CLEAR_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn tx_break_coex_cnt_clear(
        &mut self,
    ) -> TX_BREAK_COEX_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        TX_BREAK_COEX_CNT_CLEAR_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn tx_ack_abort_coex_cnt_clear(
        &mut self,
    ) -> TX_ACK_ABORT_COEX_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
    ...
    pub fn rx_ack_timeout_cnt_clear(
        &mut self,
    ) -> RX_ACK_TIMEOUT_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        RX_ACK_TIMEOUT_CNT_CLEAR_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn rx_restart_cnt_clear(&mut self) -> RX_RESTART_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        RX_RESTART_CNT_CLEAR_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn rx_ack_abort_coex_cnt_clear(
        &mut self,
    ) -> RX_ACK_ABORT_COEX_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        RX_ACK_ABORT_COEX_CNT_CLEAR_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    pub fn rx_abort_coex_cnt_clear(
        &mut self,
    ) -> RX_ABORT_COEX_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        RX_ABORT_COEX_CNT_CLEAR_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    pub fn no_rss_detect_cnt_clear(
        &mut self,
    ) -> NO_RSS_DETECT_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        NO_RSS_DETECT_CNT_CLEAR_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn rx_filter_fail_cnt_clear(
        &mut self,
    ) -> RX_FILTER_FAIL_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        RX_FILTER_FAIL_CNT_CLEAR_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    pub fn crc_error_cnt_clear(&mut self) -> CRC_ERROR_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        CRC_ERROR_CNT_CLEAR_W::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn sfd_timeout_cnt_clear(&mut self) -> SFD_TIMEOUT_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        SFD_TIMEOUT_CNT_CLEAR_W::new(self, 14)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn rx_filter_not_work_cnt_clear(
        &mut self,
    ) -> RX_FILTER_NOT_WORK_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        RX_FILTER_NOT_WORK_CNT_CLEAR_W::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn rx_preamble_detect_err_cnt_clear(
        &mut self,
    ) -> RX_PREAMBLE_DETECT_ERR_CNT_CLEAR_W<'_, ERROR_CNT_CLEAR_SPEC> {
        RX_PREAMBLE_DETECT_ERR_CNT_CLEAR_W::new(self, 16)
    }
}
