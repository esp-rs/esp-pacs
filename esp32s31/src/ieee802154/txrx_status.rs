...
#[doc = "Field `RX_TIMEOUT` reader - "]
pub type RX_TIMEOUT_R = crate::BitReader;
#[doc = "Field `RX_TIMEOUT` writer - "]
pub type RX_TIMEOUT_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `LAST_TX_ANT` reader - "]
pub type LAST_TX_ANT_R = crate::BitReader;
#[doc = "Field `LAST_TX_ANT` writer - "]
pub type LAST_TX_ANT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LAST_RX_ANT` reader - "]
pub type LAST_RX_ANT_R = crate::BitReader;
#[doc = "Field `LAST_RX_ANT` writer - "]
pub type LAST_RX_ANT_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:3"]
    #[inline(always)]
    ...
    pub fn rx_timeout(&self) -> RX_TIMEOUT_R {
        RX_TIMEOUT_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bits 16:19"]
    #[inline(always)]
    ...
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn last_tx_ant(&self) -> LAST_TX_ANT_R {
        LAST_TX_ANT_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn last_rx_ant(&self) -> LAST_RX_ANT_R {
        LAST_RX_ANT_R::new(((self.bits >> 21) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TXRX_STATUS")
            ...
            .field("last_tx_ant", &self.last_tx_ant())
            .field("last_rx_ant", &self.last_rx_ant())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:3"]
    #[inline(always)]
    pub fn txrx_state(&mut self) -> TXRX_STATE_W<'_, TXRX_STATUS_SPEC> {
        TXRX_STATE_W::new(self, 0)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn tx_proc(&mut self) -> TX_PROC_W<'_, TXRX_STATUS_SPEC> {
        TX_PROC_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn rx_proc(&mut self) -> RX_PROC_W<'_, TXRX_STATUS_SPEC> {
        RX_PROC_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    pub fn ed_proc(&mut self) -> ED_PROC_W<'_, TXRX_STATUS_SPEC> {
        ED_PROC_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    pub fn ed_trigger_tx_proc(&mut self) -> ED_TRIGGER_TX_PROC_W<'_, TXRX_STATUS_SPEC> {
        ED_TRIGGER_TX_PROC_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn rx_timeout(&mut self) -> RX_TIMEOUT_W<'_, TXRX_STATUS_SPEC> {
        RX_TIMEOUT_W::new(self, 12)
    }
    #[doc = "Bits 16:19"]
    #[inline(always)]
    pub fn rf_ctrl_state(&mut self) -> RF_CTRL_STATE_W<'_, TXRX_STATUS_SPEC> {
        RF_CTRL_STATE_W::new(self, 16)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn last_tx_ant(&mut self) -> LAST_TX_ANT_W<'_, TXRX_STATUS_SPEC> {
        LAST_TX_ANT_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn last_rx_ant(&mut self) -> LAST_RX_ANT_W<'_, TXRX_STATUS_SPEC> {
        LAST_RX_ANT_W::new(self, 21)
    }
}
