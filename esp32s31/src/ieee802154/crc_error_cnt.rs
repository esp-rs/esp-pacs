...
#[doc = "Field `RX_PREAMBLE_DETECT_ERR_CNT` reader - "]
pub type RX_PREAMBLE_DETECT_ERR_CNT_R = crate::FieldReader<u16>;
#[doc = "Field `RX_PREAMBLE_DETECT_ERR_CNT` writer - "]
pub type RX_PREAMBLE_DETECT_ERR_CNT_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
    ...
    #[doc = "Bits 16:31"]
    #[inline(always)]
    pub fn rx_preamble_detect_err_cnt(&self) -> RX_PREAMBLE_DETECT_ERR_CNT_R {
        RX_PREAMBLE_DETECT_ERR_CNT_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CRC_ERROR_CNT")
            ...
            .field(
                "rx_preamble_detect_err_cnt",
                &self.rx_preamble_detect_err_cnt(),
            )
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bits 16:31"]
    #[inline(always)]
    pub fn rx_preamble_detect_err_cnt(
        &mut self,
    ) -> RX_PREAMBLE_DETECT_ERR_CNT_W<'_, CRC_ERROR_CNT_SPEC> {
        RX_PREAMBLE_DETECT_ERR_CNT_W::new(self, 16)
    }
}
#[doc = "CRC_ERROR_CNT\n\nYou can [`read`](crate::Reg::read) this register and get [`crc_error_cnt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`crc_error_cnt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
