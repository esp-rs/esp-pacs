...
#[doc = "Field `CUR_CH_INDEX` reader - "]
pub type CUR_CH_INDEX_R = crate::BitReader;
#[doc = "Field `CUR_CH_INDEX` writer - "]
pub type CUR_CH_INDEX_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 19"]
    #[inline(always)]
    pub fn cur_ch_index(&self) -> CUR_CH_INDEX_R {
        CUR_CH_INDEX_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RX_STATUS")
            ...
            .field("cur_ch_index", &self.cur_ch_index())
...
impl W {
    ...
    #[doc = "Bit 19"]
    #[inline(always)]
    pub fn cur_ch_index(&mut self) -> CUR_CH_INDEX_W<'_, RX_STATUS_SPEC> {
        CUR_CH_INDEX_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
