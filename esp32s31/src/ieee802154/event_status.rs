...
pub type EVENT_STATUS_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    #[doc = "Bits 0:13"]
    #[inline(always)]
    pub fn event_status(&self) -> EVENT_STATUS_R {
        EVENT_STATUS_R::new((self.bits & 0x3fff) as u16)
    }
}
...
impl W {
    #[doc = "Bits 0:13"]
    #[inline(always)]
    pub fn event_status(&mut self) -> EVENT_STATUS_W<'_, EVENT_STATUS_SPEC> {
