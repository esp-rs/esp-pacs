...
pub type TX_PATH_DELAY_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
#[doc = "Field `RX_PATH_DELAY` reader - "]
pub type RX_PATH_DELAY_R = crate::FieldReader;
#[doc = "Field `RX_PATH_DELAY` writer - "]
pub type RX_PATH_DELAY_W<'a, REG> = crate::FieldWriter<'a, REG, 7>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn tx_path_delay(&self) -> TX_PATH_DELAY_R {
        TX_PATH_DELAY_R::new((self.bits & 0x7f) as u8)
    }
    #[doc = "Bits 16:22"]
    #[inline(always)]
    pub fn rx_path_delay(&self) -> RX_PATH_DELAY_R {
        RX_PATH_DELAY_R::new(((self.bits >> 16) & 0x7f) as u8)
    }
}
...
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn tx_path_delay(&mut self) -> TX_PATH_DELAY_W<'_, TXRX_PATH_DELAY_SPEC> {
        TX_PATH_DELAY_W::new(self, 0)
    }
    #[doc = "Bits 16:22"]
    #[inline(always)]
    pub fn rx_path_delay(&mut self) -> RX_PATH_DELAY_W<'_, TXRX_PATH_DELAY_SPEC> {
        RX_PATH_DELAY_W::new(self, 16)
    }
}
#[doc = "TXRX_PATH_DELAY\n\nYou can [`read`](crate::Reg::read) this register and get [`txrx_path_delay::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`txrx_path_delay::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
