...
#[doc = "Field `RX_START` reader - The raw interrupt status of UHCI_RX_START_INT."]
pub type RX_START_R = crate::BitReader;
#[doc = "Field `RX_START` writer - The raw interrupt status of UHCI_RX_START_INT."]
pub type RX_START_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_START` reader - The raw interrupt status of UHCI_TX_START_INT."]
pub type TX_START_R = crate::BitReader;
#[doc = "Field `TX_START` writer - The raw interrupt status of UHCI_TX_START_INT."]
pub type TX_START_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RX_HUNG` reader - The raw interrupt status of UHCI_RX_HUNG_INT."]
pub type RX_HUNG_R = crate::BitReader;
#[doc = "Field `RX_HUNG` writer - The raw interrupt status of UHCI_RX_HUNG_INT."]
pub type RX_HUNG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_HUNG` reader - The raw interrupt status of UHCI_TX_HUNG_INT."]
pub type TX_HUNG_R = crate::BitReader;
#[doc = "Field `TX_HUNG` writer - The raw interrupt status of UHCI_TX_HUNG_INT."]
pub type TX_HUNG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SEND_S_REG_Q` reader - The raw interrupt status of UHCI_SEND_S_REG_Q_INT."]
pub type SEND_S_REG_Q_R = crate::BitReader;
#[doc = "Field `SEND_S_REG_Q` writer - The raw interrupt status of UHCI_SEND_S_REG_Q_INT."]
pub type SEND_S_REG_Q_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SEND_A_REG_Q` reader - The raw interrupt status of UHCI_SEND_A_REG_Q_INT."]
pub type SEND_A_REG_Q_R = crate::BitReader;
#[doc = "Field `SEND_A_REG_Q` writer - The raw interrupt status of UHCI_SEND_A_REG_Q_INT."]
pub type SEND_A_REG_Q_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_EOF` reader - The raw interrupt status of UHCI_OUT_EOF_INT."]
pub type OUT_EOF_R = crate::BitReader;
#[doc = "Field `OUT_EOF` writer - The raw interrupt status of UHCI_OUT_EOF_INT."]
pub type OUT_EOF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `APP_CTRL0` reader - The raw interrupt status of UHCI_APP_CTRL0_INT."]
pub type APP_CTRL0_R = crate::BitReader;
#[doc = "Field `APP_CTRL0` writer - The raw interrupt status of UHCI_APP_CTRL0_INT."]
pub type APP_CTRL0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `APP_CTRL1` reader - The raw interrupt status of UHCI_APP_CTRL1_INT."]
pub type APP_CTRL1_R = crate::BitReader;
#[doc = "Field `APP_CTRL1` writer - The raw interrupt status of UHCI_APP_CTRL1_INT."]
