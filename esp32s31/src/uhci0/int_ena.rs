...
#[doc = "Field `RX_START` reader - Write 1 to enable UHCI_RX_START_INT."]
pub type RX_START_R = crate::BitReader;
#[doc = "Field `RX_START` writer - Write 1 to enable UHCI_RX_START_INT."]
pub type RX_START_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_START` reader - Write 1 to enable UHCI_TX_START_INT."]
pub type TX_START_R = crate::BitReader;
#[doc = "Field `TX_START` writer - Write 1 to enable UHCI_TX_START_INT."]
pub type TX_START_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RX_HUNG` reader - Write 1 to enable UHCI_RX_HUNG_INT."]
pub type RX_HUNG_R = crate::BitReader;
#[doc = "Field `RX_HUNG` writer - Write 1 to enable UHCI_RX_HUNG_INT."]
pub type RX_HUNG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_HUNG` reader - Write 1 to enable UHCI_TX_HUNG_INT."]
pub type TX_HUNG_R = crate::BitReader;
#[doc = "Field `TX_HUNG` writer - Write 1 to enable UHCI_TX_HUNG_INT."]
pub type TX_HUNG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SEND_S_REG_Q` reader - Write 1 to enable UHCI_SEND_S_REG_Q_INT."]
pub type SEND_S_REG_Q_R = crate::BitReader;
#[doc = "Field `SEND_S_REG_Q` writer - Write 1 to enable UHCI_SEND_S_REG_Q_INT."]
pub type SEND_S_REG_Q_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SEND_A_REG_Q` reader - Write 1 to enable UHCI_SEND_A_REG_Q_INT."]
pub type SEND_A_REG_Q_R = crate::BitReader;
#[doc = "Field `SEND_A_REG_Q` writer - Write 1 to enable UHCI_SEND_A_REG_Q_INT."]
pub type SEND_A_REG_Q_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTLINK_EOF_ERR` reader - Write 1 to enable UHCI_OUTLINK_EOF_ERR_INT."]
pub type OUTLINK_EOF_ERR_R = crate::BitReader;
#[doc = "Field `OUTLINK_EOF_ERR` writer - Write 1 to enable UHCI_OUTLINK_EOF_ERR_INT."]
pub type OUTLINK_EOF_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `APP_CTRL0` reader - Write 1 to enable UHCI_APP_CTRL0_INT."]
pub type APP_CTRL0_R = crate::BitReader;
#[doc = "Field `APP_CTRL0` writer - Write 1 to enable UHCI_APP_CTRL0_INT."]
pub type APP_CTRL0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `APP_CTRL1` reader - Write 1 to enable UHCI_APP_CTRL1_INT."]
pub type APP_CTRL1_R = crate::BitReader;
#[doc = "Field `APP_CTRL1` writer - Write 1 to enable UHCI_APP_CTRL1_INT."]
