...
#[doc = "Field `RX_START` reader - The masked interrupt status of UHCI_RX_START_INT."]
pub type RX_START_R = crate::BitReader;
#[doc = "Field `TX_START` reader - The masked interrupt status of UHCI_TX_START_INT."]
pub type TX_START_R = crate::BitReader;
#[doc = "Field `RX_HUNG` reader - The masked interrupt status of UHCI_RX_HUNG_INT."]
pub type RX_HUNG_R = crate::BitReader;
#[doc = "Field `TX_HUNG` reader - The masked interrupt status of UHCI_TX_HUNG_INT."]
pub type TX_HUNG_R = crate::BitReader;
#[doc = "Field `SEND_S_REG_Q` reader - The masked interrupt status of UHCI_SEND_S_REG_Q_INT."]
pub type SEND_S_REG_Q_R = crate::BitReader;
#[doc = "Field `SEND_A_REG_Q` reader - The masked interrupt status of UHCI_SEND_A_REG_Q_INT."]
pub type SEND_A_REG_Q_R = crate::BitReader;
#[doc = "Field `OUTLINK_EOF_ERR` reader - The masked interrupt status of UHCI_OUTLINK_EOF_ERR_INT."]
pub type OUTLINK_EOF_ERR_R = crate::BitReader;
#[doc = "Field `APP_CTRL0` reader - The masked interrupt status of UHCI_APP_CTRL0_INT."]
pub type APP_CTRL0_R = crate::BitReader;
#[doc = "Field `APP_CTRL1` reader - The masked interrupt status of UHCI_APP_CTRL1_INT."]
