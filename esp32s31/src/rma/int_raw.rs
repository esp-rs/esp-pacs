...
#[doc = "Field `PROC_DONE_INT_RAW` reader - The raw interrupt status bit for the rma_proc_done_int interrupt"]
pub type PROC_DONE_INT_RAW_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - The raw interrupt status bit for the rma_proc_done_int interrupt"]
    #[inline(always)]
    pub fn proc_done_int_raw(&self) -> PROC_DONE_INT_RAW_R {
        PROC_DONE_INT_RAW_R::new((self.bits & 1) != 0)
    }
}
