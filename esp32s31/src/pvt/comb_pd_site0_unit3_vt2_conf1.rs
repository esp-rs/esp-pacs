...
impl W {
    ...
    pub fn monitor_en_vt2_pd_site0_unit3(
        &mut self,
    ) -> MONITOR_EN_VT2_PD_SITE0_UNIT3_W<'_, COMB_PD_SITE0_UNIT3_VT2_CONF1_SPEC> {
    ...
    pub fn timing_err_cnt_clr_vt2_pd_site0_unit3(
        &mut self,
    ) -> TIMING_ERR_CNT_CLR_VT2_PD_SITE0_UNIT3_W<'_, COMB_PD_SITE0_UNIT3_VT2_CONF1_SPEC> {
    ...
    pub fn delay_limit_vt2_pd_site0_unit3(
        &mut self,
    ) -> DELAY_LIMIT_VT2_PD_SITE0_UNIT3_W<'_, COMB_PD_SITE0_UNIT3_VT2_CONF1_SPEC> {
