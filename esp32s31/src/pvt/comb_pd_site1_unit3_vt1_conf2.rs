...
impl W {
    ...
    pub fn monitor_edg_mod_vt1_pd_site1_unit3(
        &mut self,
    ) -> MONITOR_EDG_MOD_VT1_PD_SITE1_UNIT3_W<'_, COMB_PD_SITE1_UNIT3_VT1_CONF2_SPEC> {
        MONITOR_EDG_MOD_VT1_PD_SITE1_UNIT3_W::new(self, 0)
    }
}
#[doc = "needs desc\n\nYou can [`read`](crate::Reg::read) this register and get [`comb_pd_site1_unit3_vt1_conf2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comb_pd_site1_unit3_vt1_conf2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
