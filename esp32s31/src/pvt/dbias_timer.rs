...
#[doc = "Field `FRC_MONITOR_EN` reader - needs field desc"]
pub type FRC_MONITOR_EN_R = crate::BitReader;
#[doc = "Field `FRC_MONITOR_EN` writer - needs field desc"]
pub type FRC_MONITOR_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PERIOD_DBIAS_EN` reader - needs field desc"]
pub type PERIOD_DBIAS_EN_R = crate::BitReader;
#[doc = "Field `PERIOD_DBIAS_EN` writer - needs field desc"]
pub type PERIOD_DBIAS_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 13 - needs field desc"]
    #[inline(always)]
    pub fn frc_monitor_en(&self) -> FRC_MONITOR_EN_R {
        FRC_MONITOR_EN_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - needs field desc"]
    #[inline(always)]
    pub fn period_dbias_en(&self) -> PERIOD_DBIAS_EN_R {
        PERIOD_DBIAS_EN_R::new(((self.bits >> 14) & 1) != 0)
    }
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DBIAS_TIMER")
            .field("frc_monitor_en", &self.frc_monitor_en())
            .field("period_dbias_en", &self.period_dbias_en())
...
impl W {
    #[doc = "Bit 13 - needs field desc"]
    #[inline(always)]
    pub fn frc_monitor_en(&mut self) -> FRC_MONITOR_EN_W<'_, DBIAS_TIMER_SPEC> {
        FRC_MONITOR_EN_W::new(self, 13)
    }
    #[doc = "Bit 14 - needs field desc"]
    #[inline(always)]
    pub fn period_dbias_en(&mut self) -> PERIOD_DBIAS_EN_W<'_, DBIAS_TIMER_SPEC> {
        PERIOD_DBIAS_EN_W::new(self, 14)
    }
    #[doc = "Bits 15:30 - needs field desc"]
    #[inline(always)]
    pub fn timer_target(&mut self) -> TIMER_TARGET_W<'_, DBIAS_TIMER_SPEC> {
        TIMER_TARGET_W::new(self, 15)
    }
    #[doc = "Bit 31 - needs field desc"]
    #[inline(always)]
    pub fn timer_en(&mut self) -> TIMER_EN_W<'_, DBIAS_TIMER_SPEC> {
...
#[doc = "`reset()` method sets DBIAS_TIMER to value 0x7fff_a000"]
impl crate::Resettable for DBIAS_TIMER_SPEC {
    const RESET_VALUE: u32 = 0x7fff_a000;
}
