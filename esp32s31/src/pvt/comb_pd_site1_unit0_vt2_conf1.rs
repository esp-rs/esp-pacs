...
impl W {
    ...
    pub fn monitor_en_vt2_pd_site1_unit0(
        &mut self,
    ) -> MONITOR_EN_VT2_PD_SITE1_UNIT0_W<'_, COMB_PD_SITE1_UNIT0_VT2_CONF1_SPEC> {
    ...
    pub fn timing_err_cnt_clr_vt2_pd_site1_unit0(
        &mut self,
    ) -> TIMING_ERR_CNT_CLR_VT2_PD_SITE1_UNIT0_W<'_, COMB_PD_SITE1_UNIT0_VT2_CONF1_SPEC> {
    ...
    pub fn delay_limit_vt2_pd_site1_unit0(
        &mut self,
    ) -> DELAY_LIMIT_VT2_PD_SITE1_UNIT0_W<'_, COMB_PD_SITE1_UNIT0_VT2_CONF1_SPEC> {
        DELAY_LIMIT_VT2_PD_SITE1_UNIT0_W::new(self, 2)
    }
}
#[doc = "needs desc\n\nYou can [`read`](crate::Reg::read) this register and get [`comb_pd_site1_unit0_vt2_conf1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`comb_pd_site1_unit0_vt2_conf1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
