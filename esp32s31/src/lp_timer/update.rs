...
#[doc = "Field `TICKUPDATE` reader - need_des"]
pub type TICKUPDATE_R = crate::BitReader;
#[doc = "Field `TICKUPDATE` writer - need_des"]
pub type TICKUPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MAIN_TIMER_UPDATE` writer - need_des"]
pub type MAIN_TIMER_UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MAIN_TIMER_REGDMA_WORK` reader - need_des"]
pub type MAIN_TIMER_REGDMA_WORK_R = crate::BitReader;
#[doc = "Field `MAIN_TIMER_REGDMA_WORK` writer - need_des"]
...
impl R {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn tickupdate(&self) -> TICKUPDATE_R {
        TICKUPDATE_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UPDATE")
            .field("tickupdate", &self.tickupdate())
...
impl W {
    #[doc = "Bit 26 - need_des"]
    #[inline(always)]
    pub fn tickupdate(&mut self) -> TICKUPDATE_W<'_, UPDATE_SPEC> {
        TICKUPDATE_W::new(self, 26)
    }
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
