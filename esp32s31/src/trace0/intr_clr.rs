...
#[doc = "Field `FIFO_OVERFLOW_INTR_CLR` writer - Set 1 to clear fifo overflow interrupt"]
pub type FIFO_OVERFLOW_INTR_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `MEM_FULL_INTR_CLR` writer - Set 1 to clear mem full interrupt"]
