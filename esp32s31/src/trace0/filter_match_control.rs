...
#[doc = "Field `MATCH_CHOICE_PRIVILEGE` reader - Select match which privilege level when \\hyperref\\[fielddesc:TRACEMATCHPRIVILEGE\\]{TRACE_MATCH_PRIVILEGE} is set. \\\\2'b11: machine mode. \\\\2'b0: user mode. \\\\2'b01: supervisor mode"]
pub type MATCH_CHOICE_PRIVILEGE_R = crate::FieldReader;
#[doc = "Field `MATCH_CHOICE_PRIVILEGE` writer - Select match which privilege level when \\hyperref\\[fielddesc:TRACEMATCHPRIVILEGE\\]{TRACE_MATCH_PRIVILEGE} is set. \\\\2'b11: machine mode. \\\\2'b0: user mode. \\\\2'b01: supervisor mode"]
pub type MATCH_CHOICE_PRIVILEGE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `MATCH_VALUE_INTERRUPT` reader - Select which match which itype when \\hyperref\\[fielddesc:TRACEMATCHINTERRUPT\\]{TRACE_MATCH_INTERRUP} is set. \\\\1: match itype of 2. \\\\0: match itype of 1."]
pub type MATCH_VALUE_INTERRUPT_R = crate::BitReader;
#[doc = "Field `MATCH_VALUE_INTERRUPT` writer - Select which match which itype when \\hyperref\\[fielddesc:TRACEMATCHINTERRUPT\\]{TRACE_MATCH_INTERRUP} is set. \\\\1: match itype of 2. \\\\0: match itype of 1."]
...
impl R {
    #[doc = "Bits 0:1 - Select match which privilege level when \\hyperref\\[fielddesc:TRACEMATCHPRIVILEGE\\]{TRACE_MATCH_PRIVILEGE} is set. \\\\2'b11: machine mode. \\\\2'b0: user mode. \\\\2'b01: supervisor mode"]
    #[inline(always)]
    pub fn match_choice_privilege(&self) -> MATCH_CHOICE_PRIVILEGE_R {
        MATCH_CHOICE_PRIVILEGE_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 2 - Select which match which itype when \\hyperref\\[fielddesc:TRACEMATCHINTERRUPT\\]{TRACE_MATCH_INTERRUP} is set. \\\\1: match itype of 2. \\\\0: match itype of 1."]
    #[inline(always)]
    pub fn match_value_interrupt(&self) -> MATCH_VALUE_INTERRUPT_R {
        MATCH_VALUE_INTERRUPT_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bits 3:8 - specified which ecause matched."]
    #[inline(always)]
    pub fn match_choice_ecause(&self) -> MATCH_CHOICE_ECAUSE_R {
        MATCH_CHOICE_ECAUSE_R::new(((self.bits >> 3) & 0x3f) as u8)
    }
}
