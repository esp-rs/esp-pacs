...
#[doc = "Field `RESYNC_MODE` reader - resyc mode sel: \\\\0: off, \\\\2: package num count \\\\3: cycle count"]
pub type RESYNC_MODE_R = crate::FieldReader;
#[doc = "Field `RESYNC_MODE` writer - resyc mode sel: \\\\0: off, \\\\2: package num count \\\\3: cycle count"]
...
impl R {
    ...
    #[doc = "Bits 24:25 - resyc mode sel: \\\\0: off, \\\\2: package num count \\\\3: cycle count"]
    #[inline(always)]
