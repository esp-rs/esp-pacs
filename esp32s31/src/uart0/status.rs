...
#[doc = "Field `DSRN` reader - Represents the level of the internal UART DSR signal."]
pub type DSRN_R = crate::BitReader;
#[doc = "Field `CTSN` reader - Represents the level of the internal UART CTS signal."]
pub type CTSN_R = crate::BitReader;
#[doc = "Field `RXD` reader - Represents the level of the internal UART RXD signal."]
...
#[doc = "Field `DTRN` reader - Represents the level of the internal UART DTR signal."]
pub type DTRN_R = crate::BitReader;
#[doc = "Field `RTSN` reader - Represents the level of the internal UART RTS signal."]
pub type RTSN_R = crate::BitReader;
#[doc = "Field `TXD` reader - Represents the level of the internal UART TXD signal."]
pub type TXD_R = crate::BitReader;
impl R {
    #[doc = "Bits 0:7 - Represents the number of valid data bytes in RX FIFO."]
    #[inline(always)]
    pub fn rxfifo_cnt(&self) -> RXFIFO_CNT_R {
        RXFIFO_CNT_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bit 13 - Represents the level of the internal UART DSR signal."]
    #[inline(always)]
    pub fn dsrn(&self) -> DSRN_R {
        DSRN_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Represents the level of the internal UART CTS signal."]
    #[inline(always)]
    pub fn ctsn(&self) -> CTSN_R {
        CTSN_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Represents the level of the internal UART RXD signal."]
    #[inline(always)]
    pub fn rxd(&self) -> RXD_R {
        RXD_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bits 16:23 - Represents the number of valid data bytes in RX FIFO."]
    #[inline(always)]
    pub fn txfifo_cnt(&self) -> TXFIFO_CNT_R {
        TXFIFO_CNT_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bit 29 - Represents the level of the internal UART DTR signal."]
    #[inline(always)]
    pub fn dtrn(&self) -> DTRN_R {
        DTRN_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - Represents the level of the internal UART RTS signal."]
    #[inline(always)]
    pub fn rtsn(&self) -> RTSN_R {
        RTSN_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Represents the level of the internal UART TXD signal."]
    #[inline(always)]
