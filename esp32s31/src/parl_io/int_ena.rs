...
impl W {
    #[doc = "Bit 0 - Write 1 to enable TX_FIFO_REMPTY_INT."]
    #[inline(always)]
    pub fn tx_fifo_rempty_int_ena(&mut self) -> TX_FIFO_REMPTY_INT_ENA_W<'_, INT_ENA_SPEC> {
        TX_FIFO_REMPTY_INT_ENA_W::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 to enable RX_FIFO_WOVF_INT."]
    #[inline(always)]
    pub fn rx_fifo_wovf_int_ena(&mut self) -> RX_FIFO_WOVF_INT_ENA_W<'_, INT_ENA_SPEC> {
        RX_FIFO_WOVF_INT_ENA_W::new(self, 1)
    }
    #[doc = "Bit 2 - Write 1 to enable TX_EOF_INT."]
    #[inline(always)]
    pub fn tx_eof_int_ena(&mut self) -> TX_EOF_INT_ENA_W<'_, INT_ENA_SPEC> {
