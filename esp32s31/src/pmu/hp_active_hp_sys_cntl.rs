...
#[doc = "Field `HP_ACTIVE_C_CHANNEL` reader - need_des"]
pub type HP_ACTIVE_C_CHANNEL_R = crate::BitReader;
#[doc = "Field `HP_ACTIVE_C_CHANNEL` writer - need_des"]
pub type HP_ACTIVE_C_CHANNEL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn hp_active_c_channel(&self) -> HP_ACTIVE_C_CHANNEL_R {
        HP_ACTIVE_C_CHANNEL_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_ACTIVE_HP_SYS_CNTL")
            .field("hp_active_c_channel", &self.hp_active_c_channel())
...
impl W {
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn hp_active_c_channel(&mut self) -> HP_ACTIVE_C_CHANNEL_W<'_, HP_ACTIVE_HP_SYS_CNTL_SPEC> {
        HP_ACTIVE_C_CHANNEL_W::new(self, 23)
    }
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
