...
impl W {
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn lp_cpu_exc_int_raw(&mut self) -> LP_CPU_EXC_INT_RAW_W<'_, INT_RAW_SPEC> {
        LP_CPU_EXC_INT_RAW_W::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn sdio_idle_int_raw(&mut self) -> SDIO_IDLE_INT_RAW_W<'_, INT_RAW_SPEC> {
        SDIO_IDLE_INT_RAW_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn sw_int_raw(&mut self) -> SW_INT_RAW_W<'_, INT_RAW_SPEC> {
        SW_INT_RAW_W::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn soc_sleep_reject_int_raw(&mut self) -> SOC_SLEEP_REJECT_INT_RAW_W<'_, INT_RAW_SPEC> {
