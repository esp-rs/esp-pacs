...
impl W {
    ...
    pub fn modem_switch_active_end_int_clr(
        &mut self,
    ) -> MODEM_SWITCH_ACTIVE_END_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn sleep_switch_active_end_int_clr(
        &mut self,
    ) -> SLEEP_SWITCH_ACTIVE_END_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn sleep_switch_modem_end_int_clr(
        &mut self,
    ) -> SLEEP_SWITCH_MODEM_END_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn modem_switch_sleep_end_int_clr(
        &mut self,
    ) -> MODEM_SWITCH_SLEEP_END_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn active_switch_sleep_end_int_clr(
        &mut self,
    ) -> ACTIVE_SWITCH_SLEEP_END_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn modem_switch_active_start_int_clr(
        &mut self,
    ) -> MODEM_SWITCH_ACTIVE_START_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn sleep_switch_active_start_int_clr(
        &mut self,
    ) -> SLEEP_SWITCH_ACTIVE_START_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn sleep_switch_modem_start_int_clr(
        &mut self,
    ) -> SLEEP_SWITCH_MODEM_START_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn modem_switch_sleep_start_int_clr(
        &mut self,
    ) -> MODEM_SWITCH_SLEEP_START_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
    ...
    pub fn active_switch_sleep_start_int_clr(
        &mut self,
    ) -> ACTIVE_SWITCH_SLEEP_START_INT_CLR_W<'_, LP_INT_CLR_SPEC> {
