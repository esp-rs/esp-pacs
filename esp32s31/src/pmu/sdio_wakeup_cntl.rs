...
#[doc = "Field `SDIO_ACT_DNUM` reader - delay number config for sdio wakeup control"]
pub type SDIO_ACT_DNUM_R = crate::FieldReader<u16>;
#[doc = "Field `SDIO_ACT_DNUM` writer - delay number config for sdio wakeup control"]
pub type SDIO_ACT_DNUM_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    #[doc = "Bits 0:9 - delay number config for sdio wakeup control"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:9 - delay number config for sdio wakeup control"]
    #[inline(always)]
    pub fn sdio_act_dnum(&mut self) -> SDIO_ACT_DNUM_W<'_, SDIO_WAKEUP_CNTL_SPEC> {
