...
pub type HP_MODEM_XPD_PLL_I2C_R = crate::FieldReader;
...
pub type HP_MODEM_XPD_PLL_R = crate::FieldReader;
...
impl R {
    ...
    pub fn hp_modem_xpd_pll_i2c(&self) -> HP_MODEM_XPD_PLL_I2C_R {
        HP_MODEM_XPD_PLL_I2C_R::new(((self.bits >> 23) & 0x0f) as u8)
    }
    #[doc = "Bits 27:30 - need_des"]
    #[inline(always)]
    pub fn hp_modem_xpd_pll(&self) -> HP_MODEM_XPD_PLL_R {
        HP_MODEM_XPD_PLL_R::new(((self.bits >> 27) & 0x0f) as u8)
    }
}
