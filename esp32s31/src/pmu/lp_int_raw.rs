...
impl W {
    ...
    #[doc = "Bit 21 - need_des"]
    #[inline(always)]
    pub fn modem_switch_active_end(&mut self) -> MODEM_SWITCH_ACTIVE_END_W<'_, LP_INT_RAW_SPEC> {
    ...
    #[doc = "Bit 23 - need_des"]
    #[inline(always)]
    pub fn sleep_switch_modem_end(&mut self) -> SLEEP_SWITCH_MODEM_END_W<'_, LP_INT_RAW_SPEC> {
        SLEEP_SWITCH_MODEM_END_W::new(self, 23)
    }
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
    pub fn modem_switch_sleep_end(&mut self) -> MODEM_SWITCH_SLEEP_END_W<'_, LP_INT_RAW_SPEC> {
    ...
    pub fn modem_switch_active_start(
        &mut self,
    ) -> MODEM_SWITCH_ACTIVE_START_W<'_, LP_INT_RAW_SPEC> {
    ...
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn sleep_switch_modem_start(&mut self) -> SLEEP_SWITCH_MODEM_START_W<'_, LP_INT_RAW_SPEC> {
        SLEEP_SWITCH_MODEM_START_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn modem_switch_sleep_start(&mut self) -> MODEM_SWITCH_SLEEP_START_W<'_, LP_INT_RAW_SPEC> {
