...
impl core::fmt::Debug for crate::generic::Reg<IMM_HP_CK_POWER_0_SPEC> {
...
#[doc = "need_des\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`imm_hp_ck_power_0::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
