...
#[doc = "Field `HP_SLEEP_PD_HP_ALIVE_PD_EN` reader - need_des"]
pub type HP_SLEEP_PD_HP_ALIVE_PD_EN_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_PD_HP_ALIVE_PD_EN` writer - need_des"]
pub type HP_SLEEP_PD_HP_ALIVE_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `HP_SLEEP_PD_MODEM_TOP_PD_EN` reader - need_des"]
pub type HP_SLEEP_PD_MODEM_TOP_PD_EN_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_PD_MODEM_TOP_PD_EN` writer - need_des"]
pub type HP_SLEEP_PD_MODEM_TOP_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HP_SLEEP_PD_HP_CNNT_PD_EN` reader - need_des"]
pub type HP_SLEEP_PD_HP_CNNT_PD_EN_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_PD_HP_CNNT_PD_EN` writer - need_des"]
pub type HP_SLEEP_PD_HP_CNNT_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `HP_SLEEP_PD_MODEM_PWR_PD_EN` reader - need_des"]
pub type HP_SLEEP_PD_MODEM_PWR_PD_EN_R = crate::BitReader;
#[doc = "Field `HP_SLEEP_PD_MODEM_PWR_PD_EN` writer - need_des"]
pub type HP_SLEEP_PD_MODEM_PWR_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn hp_sleep_vdd_spi_pd_en(&self) -> HP_SLEEP_VDD_SPI_PD_EN_R {
        HP_SLEEP_VDD_SPI_PD_EN_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_pd_hp_alive_pd_en(&self) -> HP_SLEEP_PD_HP_ALIVE_PD_EN_R {
        HP_SLEEP_PD_HP_ALIVE_PD_EN_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - need_des"]
    #[inline(always)]
    ...
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_pd_modem_top_pd_en(&self) -> HP_SLEEP_PD_MODEM_TOP_PD_EN_R {
        HP_SLEEP_PD_MODEM_TOP_PD_EN_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_pd_hp_cnnt_pd_en(&self) -> HP_SLEEP_PD_HP_CNNT_PD_EN_R {
        HP_SLEEP_PD_HP_CNNT_PD_EN_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_pd_modem_pwr_pd_en(&self) -> HP_SLEEP_PD_MODEM_PWR_PD_EN_R {
        HP_SLEEP_PD_MODEM_PWR_PD_EN_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_SLEEP_DIG_POWER")
            ...
            .field(
                "hp_sleep_pd_hp_alive_pd_en",
                &self.hp_sleep_pd_hp_alive_pd_en(),
            )
            .field("hp_sleep_hp_mem_dslp", &self.hp_sleep_hp_mem_dslp())
            .field("hp_sleep_pd_hp_mem_pd_en", &self.hp_sleep_pd_hp_mem_pd_en())
            .field(
                "hp_sleep_pd_modem_top_pd_en",
                &self.hp_sleep_pd_modem_top_pd_en(),
            )
            .field(
                "hp_sleep_pd_hp_cnnt_pd_en",
                &self.hp_sleep_pd_hp_cnnt_pd_en(),
            )
            .field("hp_sleep_pd_hp_cpu_pd_en", &self.hp_sleep_pd_hp_cpu_pd_en())
            .field(
                "hp_sleep_pd_modem_pwr_pd_en",
                &self.hp_sleep_pd_modem_pwr_pd_en(),
            )
...
impl W {
    ...
    pub fn hp_sleep_vdd_spi_pd_en(
        &mut self,
    ) -> HP_SLEEP_VDD_SPI_PD_EN_W<'_, HP_SLEEP_DIG_POWER_SPEC> {
        HP_SLEEP_VDD_SPI_PD_EN_W::new(self, 20)
    }
    #[doc = "Bit 21 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_pd_hp_alive_pd_en(
        &mut self,
    ) -> HP_SLEEP_PD_HP_ALIVE_PD_EN_W<'_, HP_SLEEP_DIG_POWER_SPEC> {
        HP_SLEEP_PD_HP_ALIVE_PD_EN_W::new(self, 21)
    }
    #[doc = "Bit 22 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_hp_mem_dslp(&mut self) -> HP_SLEEP_HP_MEM_DSLP_W<'_, HP_SLEEP_DIG_POWER_SPEC> {
    ...
    #[doc = "Bit 27 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_pd_modem_top_pd_en(
        &mut self,
    ) -> HP_SLEEP_PD_MODEM_TOP_PD_EN_W<'_, HP_SLEEP_DIG_POWER_SPEC> {
        HP_SLEEP_PD_MODEM_TOP_PD_EN_W::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_pd_hp_cnnt_pd_en(
        &mut self,
    ) -> HP_SLEEP_PD_HP_CNNT_PD_EN_W<'_, HP_SLEEP_DIG_POWER_SPEC> {
        HP_SLEEP_PD_HP_CNNT_PD_EN_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_pd_modem_pwr_pd_en(
        &mut self,
    ) -> HP_SLEEP_PD_MODEM_PWR_PD_EN_W<'_, HP_SLEEP_DIG_POWER_SPEC> {
        HP_SLEEP_PD_MODEM_PWR_PD_EN_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn hp_sleep_pd_top_pd_en(
        &mut self,
    ) -> HP_SLEEP_PD_TOP_PD_EN_W<'_, HP_SLEEP_DIG_POWER_SPEC> {
