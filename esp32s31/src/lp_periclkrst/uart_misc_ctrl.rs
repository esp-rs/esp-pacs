#[doc = "Register `UART_MISC_CTRL` reader"]
pub type R = crate::R<UART_MISC_CTRL_SPEC>;
#[doc = "Register `UART_MISC_CTRL` writer"]
pub type W = crate::W<UART_MISC_CTRL_SPEC>;
...
impl W {
    ...
    pub fn lp_uart_wakeup_flag_clr(
        &mut self,
    ) -> LP_UART_WAKEUP_FLAG_CLR_W<'_, UART_MISC_CTRL_SPEC> {
        LP_UART_WAKEUP_FLAG_CLR_W::new(self, 0)
    }
    #[doc = "Bit 1 - need_des"]
    #[inline(always)]
    pub fn lp_uart_wakeup_flag(&mut self) -> LP_UART_WAKEUP_FLAG_W<'_, UART_MISC_CTRL_SPEC> {
        LP_UART_WAKEUP_FLAG_W::new(self, 1)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    pub fn lp_uart_wakeup_en(&mut self) -> LP_UART_WAKEUP_EN_W<'_, UART_MISC_CTRL_SPEC> {
        LP_UART_WAKEUP_EN_W::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    pub fn lp_uart_mem_force_pd(&mut self) -> LP_UART_MEM_FORCE_PD_W<'_, UART_MISC_CTRL_SPEC> {
        LP_UART_MEM_FORCE_PD_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn lp_uart_mem_force_pu(&mut self) -> LP_UART_MEM_FORCE_PU_W<'_, UART_MISC_CTRL_SPEC> {
        LP_UART_MEM_FORCE_PU_W::new(self, 31)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`uart_misc_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uart_misc_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UART_MISC_CTRL_SPEC;
impl crate::RegisterSpec for UART_MISC_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uart_misc_ctrl::R`](R) reader structure"]
impl crate::Readable for UART_MISC_CTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`uart_misc_ctrl::W`](W) writer structure"]
impl crate::Writable for UART_MISC_CTRL_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets UART_MISC_CTRL to value 0x4000_0000"]
impl crate::Resettable for UART_MISC_CTRL_SPEC {
