...
#[doc = "Field `T0_INT_RAW` reader - The raw interrupt status bit of the TIMG_T0_INT interrupt."]
pub type T0_INT_RAW_R = crate::BitReader;
#[doc = "Field `T1_INT_RAW` reader - The raw interrupt status bit of the TIMG_T1_INT interrupt."]
pub type T1_INT_RAW_R = crate::BitReader;
#[doc = "Field `WDT_INT_RAW` reader - The raw interrupt status bit of the TIMG_WDT_INT interrupt."]
pub type WDT_INT_RAW_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - The raw interrupt status bit of the TIMG_T0_INT interrupt."]
    #[inline(always)]
    pub fn t0_int_raw(&self) -> T0_INT_RAW_R {
        T0_INT_RAW_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The raw interrupt status bit of the TIMG_T1_INT interrupt."]
    #[inline(always)]
    pub fn t1_int_raw(&self) -> T1_INT_RAW_R {
        T1_INT_RAW_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The raw interrupt status bit of the TIMG_WDT_INT interrupt."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_RAW_TIMERS")
            .field("t0_int_raw", &self.t0_int_raw())
            .field("t1_int_raw", &self.t1_int_raw())
            .field("wdt_int_raw", &self.wdt_int_raw())
            .finish()
    }
}
