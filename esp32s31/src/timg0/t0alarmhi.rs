...
#[doc = "Field `T_ALARM_HI` reader - Configures the high 22 bits of timer 0 alarm trigger time-base counter value. Valid only when TIMG_T0_ALARM_EN is 1. \\\\ Measurement unit: T0_clk \\\\"]
pub type T_ALARM_HI_R = crate::FieldReader<u32>;
#[doc = "Field `T_ALARM_HI` writer - Configures the high 22 bits of timer 0 alarm trigger time-base counter value. Valid only when TIMG_T0_ALARM_EN is 1. \\\\ Measurement unit: T0_clk \\\\"]
...
impl W {
    #[doc = "Bits 0:21 - Configures the high 22 bits of timer 0 alarm trigger time-base counter value. Valid only when TIMG_T0_ALARM_EN is 1. \\\\ Measurement unit: T0_clk \\\\"]
    #[inline(always)]
    pub fn t_alarm_hi(&mut self) -> T_ALARM_HI_W<'_, T0ALARMHI_SPEC> {
        T_ALARM_HI_W::new(self, 0)
    }
}
#[doc = "Timer 0 alarm value, high bits\n\nYou can [`read`](crate::Reg::read) this register and get [`t0alarmhi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`t0alarmhi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
