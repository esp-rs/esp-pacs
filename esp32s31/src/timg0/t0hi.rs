...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("T0HI").field("t_hi", &self.t_hi()).finish()
    }
}
#[doc = "Timer 0 current value, high 22 bits\n\nYou can [`read`](crate::Reg::read) this register and get [`t0hi::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
