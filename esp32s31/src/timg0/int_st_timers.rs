...
#[doc = "Field `T0_INT_ST` reader - The masked interrupt status bit of the TIMG_T0_INT interrupt."]
pub type T0_INT_ST_R = crate::BitReader;
#[doc = "Field `T1_INT_ST` reader - The masked interrupt status bit of the TIMG_T1_INT interrupt."]
pub type T1_INT_ST_R = crate::BitReader;
#[doc = "Field `WDT_INT_ST` reader - The masked interrupt status bit of the TIMG_WDT_INT interrupt."]
pub type WDT_INT_ST_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - The masked interrupt status bit of the TIMG_T0_INT interrupt."]
    #[inline(always)]
    pub fn t0_int_st(&self) -> T0_INT_ST_R {
        T0_INT_ST_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The masked interrupt status bit of the TIMG_T1_INT interrupt."]
    #[inline(always)]
    pub fn t1_int_st(&self) -> T1_INT_ST_R {
        T1_INT_ST_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - The masked interrupt status bit of the TIMG_WDT_INT interrupt."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST_TIMERS")
            .field("t0_int_st", &self.t0_int_st())
            .field("t1_int_st", &self.t1_int_st())
