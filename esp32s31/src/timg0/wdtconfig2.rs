...
#[doc = "Field `WDT_STG0_HOLD` reader - Configures the stage 0 timeout value. Valid only when write protection is disabled. \\\\ Measurement unit: mwdt_clk \\\\"]
pub type WDT_STG0_HOLD_R = crate::FieldReader<u32>;
#[doc = "Field `WDT_STG0_HOLD` writer - Configures the stage 0 timeout value. Valid only when write protection is disabled. \\\\ Measurement unit: mwdt_clk \\\\"]
pub type WDT_STG0_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Configures the stage 0 timeout value. Valid only when write protection is disabled. \\\\ Measurement unit: mwdt_clk \\\\"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Configures the stage 0 timeout value. Valid only when write protection is disabled. \\\\ Measurement unit: mwdt_clk \\\\"]
    #[inline(always)]
    pub fn wdt_stg0_hold(&mut self) -> WDT_STG0_HOLD_W<'_, WDTCONFIG2_SPEC> {
