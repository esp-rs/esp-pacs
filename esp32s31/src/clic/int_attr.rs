...
#[doc = "Represents whether the interrupt is a hardware vector interrupt.\n\nValue on reset: 0"]
...
#[doc = "Field `SHV` reader - Represents whether the interrupt is a hardware vector interrupt."]
...
#[doc = "Field `SHV` writer - Represents whether the interrupt is a hardware vector interrupt."]
...
#[doc = "Configures the trigger type and polarity of the interrupt.\n\nValue on reset: 0"]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum TRIG {
...
#[doc = "Field `TRIG` reader - Configures the trigger type and polarity of the interrupt."]
...
#[doc = "Field `TRIG` writer - Configures the trigger type and polarity of the interrupt."]
...
#[doc = "Field `MODE` reader - Privilege mode of the interrupt, hardwired to 0x3 (machine mode)."]
pub type MODE_R = crate::FieldReader;
impl R {
    #[doc = "Bit 0 - Represents whether the interrupt is a hardware vector interrupt."]
    #[inline(always)]
    pub fn shv(&self) -> SHV_R {
        SHV_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 1:2 - Configures the trigger type and polarity of the interrupt."]
    #[inline(always)]
    pub fn trig(&self) -> TRIG_R {
        TRIG_R::new((self.bits >> 1) & 3)
    }
    #[doc = "Bits 6:7 - Privilege mode of the interrupt, hardwired to 0x3 (machine mode)."]
    #[inline(always)]
