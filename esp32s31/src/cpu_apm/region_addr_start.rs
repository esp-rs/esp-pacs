...
pub type REGION_ADDR_START_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `H` reader - High 13 bit, start address of region %s."]
pub type H_R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:12 - Low 12 bit, start address of region %s."]
    #[inline(always)]
    pub fn l(&self) -> L_R {
        L_R::new((self.bits & 0x1fff) as u16)
    }
    #[doc = "Bits 13:28 - Configures start address of region %s."]
    #[inline(always)]
    pub fn region_addr_start(&self) -> REGION_ADDR_START_R {
        REGION_ADDR_START_R::new(((self.bits >> 13) & 0xffff) as u16)
    }
    #[doc = "Bits 29:31 - High 13 bit, start address of region %s."]
    #[inline(always)]
    pub fn h(&self) -> H_R {
...
impl W {
    ...
    pub fn region_addr_start(&mut self) -> REGION_ADDR_START_W<'_, REGION_ADDR_START_SPEC> {
        REGION_ADDR_START_W::new(self, 13)
    }
}
...
#[doc = "`reset()` method sets REGION%s_ADDR_START to value 0x4000_0000"]
