...
#[doc = "Field `REGION_TEE_X` reader - Configures the execution authority of TEE_MODE in region %s."]
pub type REGION_TEE_X_R = crate::BitReader;
#[doc = "Field `REGION_TEE_X` writer - Configures the execution authority of TEE_MODE in region %s."]
pub type REGION_TEE_X_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REGION_TEE_W` reader - Configures the write authority of TEE_MODE in region %s."]
pub type REGION_TEE_W_R = crate::BitReader;
#[doc = "Field `REGION_TEE_W` writer - Configures the write authority of TEE_MODE in region %s."]
pub type REGION_TEE_W_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REGION_TEE_R` reader - Configures the read authority of TEE_MODE in region %s."]
pub type REGION_TEE_R_R = crate::BitReader;
#[doc = "Field `REGION_TEE_R` writer - Configures the read authority of TEE_MODE in region %s."]
pub type REGION_TEE_R_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 12 - Configures the execution authority of TEE_MODE in region %s."]
    #[inline(always)]
    pub fn region_tee_x(&self) -> REGION_TEE_X_R {
        REGION_TEE_X_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Configures the write authority of TEE_MODE in region %s."]
    #[inline(always)]
    pub fn region_tee_w(&self) -> REGION_TEE_W_R {
        REGION_TEE_W_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Configures the read authority of TEE_MODE in region %s."]
    #[inline(always)]
    pub fn region_tee_r(&self) -> REGION_TEE_R_R {
        REGION_TEE_R_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 16 - Set 1 to lock region0 configuration"]
    #[inline(always)]
    pub fn region_lock(&self) -> REGION_LOCK_R {
        REGION_LOCK_R::new(((self.bits >> 16) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REGION_ATTR")
            ...
            .field("region_tee_x", &self.region_tee_x())
            .field("region_tee_w", &self.region_tee_w())
            .field("region_tee_r", &self.region_tee_r())
...
impl W {
    ...
    #[doc = "Bit 12 - Configures the execution authority of TEE_MODE in region %s."]
    #[inline(always)]
    pub fn region_tee_x(&mut self) -> REGION_TEE_X_W<'_, REGION_ATTR_SPEC> {
        REGION_TEE_X_W::new(self, 12)
    }
    #[doc = "Bit 13 - Configures the write authority of TEE_MODE in region %s."]
    #[inline(always)]
    pub fn region_tee_w(&mut self) -> REGION_TEE_W_W<'_, REGION_ATTR_SPEC> {
        REGION_TEE_W_W::new(self, 13)
    }
    #[doc = "Bit 14 - Configures the read authority of TEE_MODE in region %s."]
    #[inline(always)]
    pub fn region_tee_r(&mut self) -> REGION_TEE_R_W<'_, REGION_ATTR_SPEC> {
        REGION_TEE_R_W::new(self, 14)
    }
    #[doc = "Bit 16 - Set 1 to lock region0 configuration"]
    #[inline(always)]
    pub fn region_lock(&mut self) -> REGION_LOCK_W<'_, REGION_ATTR_SPEC> {
        REGION_LOCK_W::new(self, 16)
    }
}
...
#[doc = "`reset()` method sets REGION%s_ATTR to value 0x7000"]
