#[doc = "Register `HCDMAB12` reader"]
pub type R = crate::R<HCDMAB12_SPEC>;
...
pub struct HCDMAB12_SPEC;
impl crate::RegisterSpec for HCDMAB12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcdmab12::R`](R) reader structure"]
impl crate::Readable for HCDMAB12_SPEC {}
#[doc = "`reset()` method sets HCDMAB12 to value 0"]
impl crate::Resettable for HCDMAB12_SPEC {}
