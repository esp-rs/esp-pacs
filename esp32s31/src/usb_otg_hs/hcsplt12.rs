#[doc = "Register `HCSPLT12` reader"]
pub type R = crate::R<HCSPLT12_SPEC>;
#[doc = "Register `HCSPLT12` writer"]
pub type W = crate::W<HCSPLT12_SPEC>;
...
#[doc = "This register contains the Split characteristics of the Host Channel.\n\nYou can [`read`](crate::Reg::read) this register and get [`hcsplt12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hcsplt12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCSPLT12_SPEC;
impl crate::RegisterSpec for HCSPLT12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcsplt12::R`](R) reader structure"]
impl crate::Readable for HCSPLT12_SPEC {}
