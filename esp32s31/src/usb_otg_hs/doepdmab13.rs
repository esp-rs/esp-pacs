#[doc = "Register `DOEPDMAB13` reader"]
pub type R = crate::R<DOEPDMAB13_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DOEPDMAB13")
            .field("dmabufferaddr", &self.dmabufferaddr())
            .finish()
    }
}
#[doc = "This register contains the DMA Buffer Address for the OUT Endpoint 13 of the Device controller.\n\nYou can [`read`](crate::Reg::read) this register and get [`doepdmab13::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DOEPDMAB13_SPEC;
impl crate::RegisterSpec for DOEPDMAB13_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doepdmab13::R`](R) reader structure"]
impl crate::Readable for DOEPDMAB13_SPEC {}
#[doc = "`reset()` method sets DOEPDMAB13 to value 0"]
impl crate::Resettable for DOEPDMAB13_SPEC {}
