#[doc = "Register `HCDMAB13` reader"]
pub type R = crate::R<HCDMAB13_SPEC>;
...
pub struct HCDMAB13_SPEC;
impl crate::RegisterSpec for HCDMAB13_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcdmab13::R`](R) reader structure"]
impl crate::Readable for HCDMAB13_SPEC {}
#[doc = "`reset()` method sets HCDMAB13 to value 0"]
impl crate::Resettable for HCDMAB13_SPEC {}
