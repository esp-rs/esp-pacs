#[doc = "Register `DTXFSTS12` reader"]
pub type R = crate::R<DTXFSTS12_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DTXFSTS12")
            .field("ineptxfspcavail", &self.ineptxfspcavail())
            .finish()
    }
}
#[doc = "This register reflects the status of the IN Endpoint Transmit FIFO Status Register 12 of the Device controller. Note: This register exists for an endpoint i if the OTG_EP_DIR_i parameter is 0 or 1 for that endpoint.\n\nYou can [`read`](crate::Reg::read) this register and get [`dtxfsts12::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DTXFSTS12_SPEC;
impl crate::RegisterSpec for DTXFSTS12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dtxfsts12::R`](R) reader structure"]
impl crate::Readable for DTXFSTS12_SPEC {}
#[doc = "`reset()` method sets DTXFSTS12 to value 0x0400"]
impl crate::Resettable for DTXFSTS12_SPEC {
