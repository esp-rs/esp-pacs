#[doc = "Register `DOEPTSIZ8` reader"]
pub type R = crate::R<DOEPTSIZ8_SPEC>;
#[doc = "Register `DOEPTSIZ8` writer"]
pub type W = crate::W<DOEPTSIZ8_SPEC>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer Size (XferSize) Indicates the transfer size in bytes for the endpoint. The core interrupts the application only after it has exhausted the transfer size amount of data. The transfer size can be Set to the maximum packet size of the endpoint, to be interrupted at the end of each packet. The core decrements this field every time a packet is read from the RxFIFO and written to the external memory."]
    #[inline(always)]
    pub fn xfersize(&mut self) -> XFERSIZE_W<'_, DOEPTSIZ8_SPEC> {
        XFERSIZE_W::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet Count (PktCnt) This field is decremented to zero after a packet is written into the RxFIFO."]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, DOEPTSIZ8_SPEC> {
...
pub struct DOEPTSIZ8_SPEC;
impl crate::RegisterSpec for DOEPTSIZ8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doeptsiz8::R`](R) reader structure"]
impl crate::Readable for DOEPTSIZ8_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doeptsiz8::W`](W) writer structure"]
impl crate::Writable for DOEPTSIZ8_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DOEPTSIZ8 to value 0"]
impl crate::Resettable for DOEPTSIZ8_SPEC {}
