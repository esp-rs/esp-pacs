...
#[doc = "Field `STSPHSERCVDMSK` reader - Status Phase Received Mask (StsPhseRcvdMsk) Applies to control OUT endpoints only."]
pub type STSPHSERCVDMSK_R = crate::BitReader;
#[doc = "Field `STSPHSERCVDMSK` writer - Status Phase Received Mask (StsPhseRcvdMsk) Applies to control OUT endpoints only."]
...
impl R {
    ...
    #[doc = "Bit 5 - Status Phase Received Mask (StsPhseRcvdMsk) Applies to control OUT endpoints only."]
    #[inline(always)]
