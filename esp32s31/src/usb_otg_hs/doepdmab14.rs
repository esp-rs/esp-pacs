#[doc = "Register `DOEPDMAB14` reader"]
pub type R = crate::R<DOEPDMAB14_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DOEPDMAB14")
            .field("dmabufferaddr", &self.dmabufferaddr())
            .finish()
    }
}
#[doc = "This register contains the DMA Buffer Address for the OUT Endpoint 14 of the Device controller.\n\nYou can [`read`](crate::Reg::read) this register and get [`doepdmab14::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DOEPDMAB14_SPEC;
impl crate::RegisterSpec for DOEPDMAB14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doepdmab14::R`](R) reader structure"]
impl crate::Readable for DOEPDMAB14_SPEC {}
#[doc = "`reset()` method sets DOEPDMAB14 to value 0"]
impl crate::Resettable for DOEPDMAB14_SPEC {}
