#[doc = "Register `HCDMAB11` reader"]
pub type R = crate::R<HCDMAB11_SPEC>;
...
pub struct HCDMAB11_SPEC;
impl crate::RegisterSpec for HCDMAB11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcdmab11::R`](R) reader structure"]
impl crate::Readable for HCDMAB11_SPEC {}
#[doc = "`reset()` method sets HCDMAB11 to value 0"]
impl crate::Resettable for HCDMAB11_SPEC {}
