#[doc = "Register `DIEPDMAB8` reader"]
pub type R = crate::R<DIEPDMAB8_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DIEPDMAB8")
            .field("dmabufferaddr", &self.dmabufferaddr())
            .finish()
    }
}
#[doc = "This register contains the DMA Buffer Address of the IN Endpoint 8 of the Device controller. Note: This register exists for an endpoint i if the OTG_EP_DIR_i parameter is 0 or 1 for that endpoint.\n\nYou can [`read`](crate::Reg::read) this register and get [`diepdmab8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIEPDMAB8_SPEC;
impl crate::RegisterSpec for DIEPDMAB8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepdmab8::R`](R) reader structure"]
impl crate::Readable for DIEPDMAB8_SPEC {}
#[doc = "`reset()` method sets DIEPDMAB8 to value 0"]
impl crate::Resettable for DIEPDMAB8_SPEC {}
