#[doc = "Register `HCDMAB15` reader"]
pub type R = crate::R<HCDMAB15_SPEC>;
...
pub struct HCDMAB15_SPEC;
impl crate::RegisterSpec for HCDMAB15_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcdmab15::R`](R) reader structure"]
impl crate::Readable for HCDMAB15_SPEC {}
#[doc = "`reset()` method sets HCDMAB15 to value 0"]
impl crate::Resettable for HCDMAB15_SPEC {}
