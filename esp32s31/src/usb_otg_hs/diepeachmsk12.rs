#[doc = "Register `DIEPEACHMSK12` reader"]
pub type R = crate::R<DIEPEACHMSK12_SPEC>;
#[doc = "Register `DIEPEACHMSK12` writer"]
pub type W = crate::W<DIEPEACHMSK12_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Transfer Completed Interrupt Mask (XferComplMsk)"]
    #[inline(always)]
    pub fn xfercomplmsk(&mut self) -> XFERCOMPLMSK_W<'_, DIEPEACHMSK12_SPEC> {
        XFERCOMPLMSK_W::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint Disabled Interrupt Mask (EPDisbldMsk)"]
    #[inline(always)]
    pub fn epdisbldmsk(&mut self) -> EPDISBLDMSK_W<'_, DIEPEACHMSK12_SPEC> {
        EPDISBLDMSK_W::new(self, 1)
    }
    #[doc = "Bit 2 - AHB Error Mask (AHBErrMsk)"]
    #[inline(always)]
    pub fn ahberrmsk(&mut self) -> AHBERRMSK_W<'_, DIEPEACHMSK12_SPEC> {
        AHBERRMSK_W::new(self, 2)
    }
    #[doc = "Bit 3 - Timeout Condition Mask (TimeOUTMsk) (Non-isochronous endpoints)"]
    #[inline(always)]
    pub fn timeoutmsk(&mut self) -> TIMEOUTMSK_W<'_, DIEPEACHMSK12_SPEC> {
        TIMEOUTMSK_W::new(self, 3)
    }
    #[doc = "Bit 4 - IN Token Received When TxFIFO Empty Mask(INTknTXFEmpMsk)"]
    #[inline(always)]
    pub fn intkntxfempmsk(&mut self) -> INTKNTXFEMPMSK_W<'_, DIEPEACHMSK12_SPEC> {
        INTKNTXFEMPMSK_W::new(self, 4)
    }
    #[doc = "Bit 5 - IN Token received with EP Mismatch Mask (INTknEPMisMsk)"]
    #[inline(always)]
    pub fn intknepmismsk(&mut self) -> INTKNEPMISMSK_W<'_, DIEPEACHMSK12_SPEC> {
        INTKNEPMISMSK_W::new(self, 5)
    }
    #[doc = "Bit 6 - IN Endpoint NAK Effective Mask (INEPNakEffMsk)"]
    #[inline(always)]
    pub fn inepnakeffmsk(&mut self) -> INEPNAKEFFMSK_W<'_, DIEPEACHMSK12_SPEC> {
        INEPNAKEFFMSK_W::new(self, 6)
    }
    #[doc = "Bit 8 - Fifo Underrun Mask (TxfifoUndrnMsk)"]
    #[inline(always)]
    pub fn txfifoundrnmsk(&mut self) -> TXFIFOUNDRNMSK_W<'_, DIEPEACHMSK12_SPEC> {
        TXFIFOUNDRNMSK_W::new(self, 8)
    }
    #[doc = "Bit 9 - BNA interrupt Mask (BNAInIntrMsk)"]
    #[inline(always)]
    pub fn bnainintrmsk(&mut self) -> BNAININTRMSK_W<'_, DIEPEACHMSK12_SPEC> {
        BNAININTRMSK_W::new(self, 9)
    }
    #[doc = "Bit 13 - NAK interrupt Mask (NAKMsk)"]
    #[inline(always)]
    pub fn nakmsk(&mut self) -> NAKMSK_W<'_, DIEPEACHMSK12_SPEC> {
        NAKMSK_W::new(self, 13)
    }
}
#[doc = "This register contains the interrupts for the IN Endpoints of the Device controller. Note: This register exists for an endpoint i if the OTG_EP_DIR_i parameter is 0 or 1 for that endpoint.\n\nYou can [`read`](crate::Reg::read) this register and get [`diepeachmsk12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`diepeachmsk12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIEPEACHMSK12_SPEC;
impl crate::RegisterSpec for DIEPEACHMSK12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepeachmsk12::R`](R) reader structure"]
impl crate::Readable for DIEPEACHMSK12_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diepeachmsk12::W`](W) writer structure"]
impl crate::Writable for DIEPEACHMSK12_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DIEPEACHMSK12 to value 0"]
impl crate::Resettable for DIEPEACHMSK12_SPEC {}
