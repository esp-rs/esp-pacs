#[doc = "Register `DOEPTSIZ11` reader"]
pub type R = crate::R<DOEPTSIZ11_SPEC>;
#[doc = "Register `DOEPTSIZ11` writer"]
pub type W = crate::W<DOEPTSIZ11_SPEC>;
...
impl W {
    #[doc = "Bits 0:18 - Transfer Size (XferSize) Indicates the transfer size in bytes for the endpoint. The core interrupts the application only after it has exhausted the transfer size amount of data. The transfer size can be Set to the maximum packet size of the endpoint, to be interrupted at the end of each packet. The core decrements this field every time a packet is read from the RxFIFO and written to the external memory."]
    #[inline(always)]
    pub fn xfersize(&mut self) -> XFERSIZE_W<'_, DOEPTSIZ11_SPEC> {
        XFERSIZE_W::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet Count (PktCnt) This field is decremented to zero after a packet is written into the RxFIFO."]
    #[inline(always)]
    pub fn pktcnt(&mut self) -> PKTCNT_W<'_, DOEPTSIZ11_SPEC> {
        PKTCNT_W::new(self, 19)
    }
}
#[doc = "This register contains the Transfer Size for the OUT Endpoint 11 of the Device controller.\n\nYou can [`read`](crate::Reg::read) this register and get [`doeptsiz11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`doeptsiz11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DOEPTSIZ11_SPEC;
impl crate::RegisterSpec for DOEPTSIZ11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doeptsiz11::R`](R) reader structure"]
impl crate::Readable for DOEPTSIZ11_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doeptsiz11::W`](W) writer structure"]
impl crate::Writable for DOEPTSIZ11_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DOEPTSIZ11 to value 0"]
impl crate::Resettable for DOEPTSIZ11_SPEC {}
