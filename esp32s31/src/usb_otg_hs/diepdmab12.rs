#[doc = "Register `DIEPDMAB12` reader"]
pub type R = crate::R<DIEPDMAB12_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DIEPDMAB12")
            .field("dmabufferaddr", &self.dmabufferaddr())
            .finish()
    }
}
#[doc = "This register contains the DMA Buffer Address of the IN Endpoint 12 of the Device controller. Note: This register exists for an endpoint i if the OTG_EP_DIR_i parameter is 0 or 1 for that endpoint.\n\nYou can [`read`](crate::Reg::read) this register and get [`diepdmab12::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIEPDMAB12_SPEC;
impl crate::RegisterSpec for DIEPDMAB12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepdmab12::R`](R) reader structure"]
impl crate::Readable for DIEPDMAB12_SPEC {}
#[doc = "`reset()` method sets DIEPDMAB12 to value 0"]
impl crate::Resettable for DIEPDMAB12_SPEC {}
