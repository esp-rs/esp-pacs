#[doc = "Register `HCDMAB10` reader"]
pub type R = crate::R<HCDMAB10_SPEC>;
...
pub struct HCDMAB10_SPEC;
impl crate::RegisterSpec for HCDMAB10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcdmab10::R`](R) reader structure"]
impl crate::Readable for HCDMAB10_SPEC {}
#[doc = "`reset()` method sets HCDMAB10 to value 0"]
impl crate::Resettable for HCDMAB10_SPEC {}
