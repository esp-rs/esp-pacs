#[doc = "Register `DIEPDMAB15` reader"]
pub type R = crate::R<DIEPDMAB15_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DIEPDMAB15")
            .field("dmabufferaddr", &self.dmabufferaddr())
            .finish()
    }
}
#[doc = "This register contains the DMA Buffer Address of the IN Endpoint 15 of the Device controller. Note: This register exists for an endpoint i if the OTG_EP_DIR_i parameter is 0 or 1 for that endpoint.\n\nYou can [`read`](crate::Reg::read) this register and get [`diepdmab15::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIEPDMAB15_SPEC;
impl crate::RegisterSpec for DIEPDMAB15_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepdmab15::R`](R) reader structure"]
impl crate::Readable for DIEPDMAB15_SPEC {}
#[doc = "`reset()` method sets DIEPDMAB15 to value 0"]
impl crate::Resettable for DIEPDMAB15_SPEC {}
