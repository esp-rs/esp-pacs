#[doc = "Register `DOEPDMAB9` reader"]
pub type R = crate::R<DOEPDMAB9_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DOEPDMAB9")
            .field("dmabufferaddr", &self.dmabufferaddr())
            .finish()
    }
}
#[doc = "This register contains the DMA Buffer Address for the OUT Endpoint 9 of the Device controller.\n\nYou can [`read`](crate::Reg::read) this register and get [`doepdmab9::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DOEPDMAB9_SPEC;
impl crate::RegisterSpec for DOEPDMAB9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doepdmab9::R`](R) reader structure"]
impl crate::Readable for DOEPDMAB9_SPEC {}
#[doc = "`reset()` method sets DOEPDMAB9 to value 0"]
impl crate::Resettable for DOEPDMAB9_SPEC {}
