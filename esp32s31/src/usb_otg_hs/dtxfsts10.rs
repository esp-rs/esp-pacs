#[doc = "Register `DTXFSTS10` reader"]
pub type R = crate::R<DTXFSTS10_SPEC>;
...
#[doc = "This register reflects the status of the IN Endpoint Transmit FIFO Status Register 10 of the Device controller. Note: This register exists for an endpoint i if the OTG_EP_DIR_i parameter is 0 or 1 for that endpoint.\n\nYou can [`read`](crate::Reg::read) this register and get [`dtxfsts10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DTXFSTS10_SPEC;
impl crate::RegisterSpec for DTXFSTS10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dtxfsts10::R`](R) reader structure"]
impl crate::Readable for DTXFSTS10_SPEC {}
#[doc = "`reset()` method sets DTXFSTS10 to value 0x0400"]
impl crate::Resettable for DTXFSTS10_SPEC {
