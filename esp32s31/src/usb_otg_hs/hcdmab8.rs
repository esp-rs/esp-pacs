#[doc = "Register `HCDMAB8` reader"]
pub type R = crate::R<HCDMAB8_SPEC>;
...
pub struct HCDMAB8_SPEC;
impl crate::RegisterSpec for HCDMAB8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcdmab8::R`](R) reader structure"]
impl crate::Readable for HCDMAB8_SPEC {}
#[doc = "`reset()` method sets HCDMAB8 to value 0"]
impl crate::Resettable for HCDMAB8_SPEC {}
