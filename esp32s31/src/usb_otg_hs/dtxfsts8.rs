#[doc = "Register `DTXFSTS8` reader"]
pub type R = crate::R<DTXFSTS8_SPEC>;
...
pub struct DTXFSTS8_SPEC;
impl crate::RegisterSpec for DTXFSTS8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dtxfsts8::R`](R) reader structure"]
impl crate::Readable for DTXFSTS8_SPEC {}
#[doc = "`reset()` method sets DTXFSTS8 to value 0x0400"]
impl crate::Resettable for DTXFSTS8_SPEC {
