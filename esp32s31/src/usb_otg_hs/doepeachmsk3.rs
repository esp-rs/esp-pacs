#[doc = "Register `DOEPEACHMSK3` reader"]
pub type R = crate::R<DOEPEACHMSK3_SPEC>;
#[doc = "Register `DOEPEACHMSK3` writer"]
pub type W = crate::W<DOEPEACHMSK3_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Transfer Completed Interrupt Mask (XferComplMsk)"]
    #[inline(always)]
    pub fn xfercomplmsk(&mut self) -> XFERCOMPLMSK_W<'_, DOEPEACHMSK3_SPEC> {
        XFERCOMPLMSK_W::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint Disabled Interrupt Mask (EPDisbldMsk)"]
    #[inline(always)]
    pub fn epdisbldmsk(&mut self) -> EPDISBLDMSK_W<'_, DOEPEACHMSK3_SPEC> {
        EPDISBLDMSK_W::new(self, 1)
    }
    #[doc = "Bit 2 - AHB Error (AHBErrMsk)"]
    #[inline(always)]
    pub fn ahberrmsk(&mut self) -> AHBERRMSK_W<'_, DOEPEACHMSK3_SPEC> {
        AHBERRMSK_W::new(self, 2)
    }
    #[doc = "Bit 3 - SETUP Phase Done Mask (SetUPMsk) Applies to control endpoints only."]
    #[inline(always)]
    pub fn setupmsk(&mut self) -> SETUPMSK_W<'_, DOEPEACHMSK3_SPEC> {
        SETUPMSK_W::new(self, 3)
    }
    #[doc = "Bit 4 - OUT Token Received when Endpoint Disabled Mask (OUTTknEPdisMsk) Applies to control OUT endpoints only."]
    #[inline(always)]
    pub fn outtknepdismsk(&mut self) -> OUTTKNEPDISMSK_W<'_, DOEPEACHMSK3_SPEC> {
        OUTTKNEPDISMSK_W::new(self, 4)
    }
    #[doc = "Bit 5 - Status Phase Received Mask (StsPhsRcvdMsk) Applies to control OUT endpoints only."]
    #[inline(always)]
    pub fn stsphsrcvdmsk(&mut self) -> STSPHSRCVDMSK_W<'_, DOEPEACHMSK3_SPEC> {
        STSPHSRCVDMSK_W::new(self, 5)
    }
    #[doc = "Bit 6 - Back-to-Back SETUP Packets Received Mask (Back2BackSETup) Applies to control OUT endpoints only."]
    #[inline(always)]
    pub fn back2backsetup(&mut self) -> BACK2BACKSETUP_W<'_, DOEPEACHMSK3_SPEC> {
        BACK2BACKSETUP_W::new(self, 6)
    }
    #[doc = "Bit 8 - OUT Packet Error Mask (OutPktErrMsk)"]
    #[inline(always)]
    pub fn outpkterrmsk(&mut self) -> OUTPKTERRMSK_W<'_, DOEPEACHMSK3_SPEC> {
        OUTPKTERRMSK_W::new(self, 8)
    }
    #[doc = "Bit 9 - BNA interrupt Mask (BnaOutIntrMsk)"]
    #[inline(always)]
    pub fn bnaoutintrmsk(&mut self) -> BNAOUTINTRMSK_W<'_, DOEPEACHMSK3_SPEC> {
        BNAOUTINTRMSK_W::new(self, 9)
    }
    #[doc = "Bit 12 - Babble Error interrupt Mask (BbleErrMsk)"]
    #[inline(always)]
    pub fn bbleerrmsk(&mut self) -> BBLEERRMSK_W<'_, DOEPEACHMSK3_SPEC> {
        BBLEERRMSK_W::new(self, 12)
    }
    #[doc = "Bit 13 - NAK interrupt Mask (NAKMsk)"]
    #[inline(always)]
    pub fn nakmsk(&mut self) -> NAKMSK_W<'_, DOEPEACHMSK3_SPEC> {
        NAKMSK_W::new(self, 13)
    }
    #[doc = "Bit 14 - NYET interrupt Mask (NYETMsk)"]
    #[inline(always)]
    pub fn nyetmsk(&mut self) -> NYETMSK_W<'_, DOEPEACHMSK3_SPEC> {
        NYETMSK_W::new(self, 14)
    }
}
#[doc = "This register contains the interrupts for the OUT Endpoints of the Device controller. Note: This register exists for an endpoint i if the OTG_EP_DIR_i parameter is 0 or 1 for that endpoint.\n\nYou can [`read`](crate::Reg::read) this register and get [`doepeachmsk3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`doepeachmsk3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DOEPEACHMSK3_SPEC;
impl crate::RegisterSpec for DOEPEACHMSK3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doepeachmsk3::R`](R) reader structure"]
impl crate::Readable for DOEPEACHMSK3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doepeachmsk3::W`](W) writer structure"]
impl crate::Writable for DOEPEACHMSK3_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DOEPEACHMSK3 to value 0"]
impl crate::Resettable for DOEPEACHMSK3_SPEC {}
