#[doc = "Register `DTXFSTS11` reader"]
pub type R = crate::R<DTXFSTS11_SPEC>;
...
#[doc = "This register reflects the status of the IN Endpoint Transmit FIFO Status Register 11 of the Device controller. Note: This register exists for an endpoint i if the OTG_EP_DIR_i parameter is 0 or 1 for that endpoint.\n\nYou can [`read`](crate::Reg::read) this register and get [`dtxfsts11::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DTXFSTS11_SPEC;
impl crate::RegisterSpec for DTXFSTS11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dtxfsts11::R`](R) reader structure"]
impl crate::Readable for DTXFSTS11_SPEC {}
#[doc = "`reset()` method sets DTXFSTS11 to value 0x0400"]
impl crate::Resettable for DTXFSTS11_SPEC {
