#[doc = "Register `HCDMAB14` reader"]
pub type R = crate::R<HCDMAB14_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HCDMAB14")
            .field("hcdmab", &self.hcdmab())
            .finish()
    }
}
#[doc = "This register is present only in case of Scatter/Gather DMA. It is implemented in RAM instead of flop-based implementation. This register holds the current buffer address.\n\nYou can [`read`](crate::Reg::read) this register and get [`hcdmab14::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCDMAB14_SPEC;
impl crate::RegisterSpec for HCDMAB14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcdmab14::R`](R) reader structure"]
impl crate::Readable for HCDMAB14_SPEC {}
#[doc = "`reset()` method sets HCDMAB14 to value 0"]
impl crate::Resettable for HCDMAB14_SPEC {}
