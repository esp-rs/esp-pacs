#[doc = "Register `DIEPDMAB7` reader"]
pub type R = crate::R<DIEPDMAB7_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DIEPDMAB7")
            .field("dmabufferaddr", &self.dmabufferaddr())
            .finish()
    }
}
#[doc = "This register contains the DMA Buffer Address of the IN Endpoint 7 of the Device controller. Note: This register exists for an endpoint i if the OTG_EP_DIR_i parameter is 0 or 1 for that endpoint.\n\nYou can [`read`](crate::Reg::read) this register and get [`diepdmab7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIEPDMAB7_SPEC;
impl crate::RegisterSpec for DIEPDMAB7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepdmab7::R`](R) reader structure"]
impl crate::Readable for DIEPDMAB7_SPEC {}
#[doc = "`reset()` method sets DIEPDMAB7 to value 0"]
impl crate::Resettable for DIEPDMAB7_SPEC {}
