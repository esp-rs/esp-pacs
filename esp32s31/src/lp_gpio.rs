...
pub struct RegisterBlock {
    ...
    pin: [PIN; 8],
    _reserved12: [u8; 0x60],
    func_in_sel_cfg: [FUNC_IN_SEL_CFG; 9],
    _reserved13: [u8; 0x01dc],
    func_out_sel_cfg: [FUNC_OUT_SEL_CFG; 8],
    _reserved14: [u8; 0x0128],
    clock_gate: CLOCK_GATE,
    date: DATE,
}
impl RegisterBlock {
    #[doc = "0x04 - LP_GPIO output register"]
    #[inline(always)]
    pub const fn out(&self) -> &OUT {
        &self.out
    }
    #[doc = "0x08 - LP_GPIO output set register"]
    #[inline(always)]
    pub const fn out_w1ts(&self) -> &OUT_W1TS {
        &self.out_w1ts
    }
    #[doc = "0x0c - LP_GPIO output clear register"]
    #[inline(always)]
    pub const fn out_w1tc(&self) -> &OUT_W1TC {
        &self.out_w1tc
    }
    #[doc = "0x10 - LP_GPIO output enable register"]
    #[inline(always)]
    ...
    #[doc = "0x20 - LP_GPIO interrupt status register"]
    #[inline(always)]
    pub const fn status(&self) -> &STATUS {
        &self.status
    }
    #[doc = "0x24 - LP_GPIO interrupt status set register"]
    #[inline(always)]
    pub const fn status_w1ts(&self) -> &STATUS_W1TS {
        &self.status_w1ts
    }
    #[doc = "0x28 - LP_GPIO interrupt status clear register"]
    #[inline(always)]
    pub const fn status_w1tc(&self) -> &STATUS_W1TC {
        &self.status_w1tc
    }
    #[doc = "0x2c - LP_GPIO interrupt source register"]
    #[inline(always)]
    pub const fn status_next(&self) -> &STATUS_NEXT {
        &self.status_next
    }
    #[doc = "0x30..0x50 - LP_GPIO%s configuration register"]
    #[inline(always)]
    ...
    #[doc = "0xb0..0xd4 - Configuration register for input signal %s"]
    #[inline(always)]
