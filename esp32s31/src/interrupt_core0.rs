...
pub struct RegisterBlock {
    core_0_intr_map: [CORE_0_INTR_MAP; 169],
    sig_idx_assert_in_sec: SIG_IDX_ASSERT_IN_SEC,
    core_0_intr_status: [CORE_0_INTR_STATUS; 5],
    core_0_intr_status5: CORE_0_INTR_STATUS5,
...
impl RegisterBlock {
    ...
    #[doc = "0x2bc - "]
    #[inline(always)]
    pub const fn core_0_intr_status5(&self) -> &CORE_0_INTR_STATUS5 {
        &self.core_0_intr_status5
    }
    #[doc = "0x2c0..0x2d4 - "]
    #[inline(always)]
...
#[doc = "CORE_0_INTR_STATUS5 (r) register accessor: \n\nYou can [`read`](crate::Reg::read) this register and get [`core_0_intr_status5::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@core_0_intr_status5`] module"]
pub type CORE_0_INTR_STATUS5 = crate::Reg<core_0_intr_status5::CORE_0_INTR_STATUS5_SPEC>;
#[doc = ""]
pub mod core_0_intr_status5;
