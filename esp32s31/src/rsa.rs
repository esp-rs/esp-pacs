...
impl RegisterBlock {
    ...
    #[doc = "0x834 - RSA mem clk force register"]
    #[inline(always)]
    pub const fn clk_force_on(&self) -> &CLK_FORCE_ON {
        &self.clk_force_on
    }
    #[doc = "0x838 - RSA free state register"]
    #[inline(always)]
...
pub mod date;
#[doc = "CLK_FORCE_ON (rw) register accessor: RSA mem clk force register\n\nYou can [`read`](crate::Reg::read) this register and get [`clk_force_on::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`clk_force_on::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@clk_force_on`] module"]
pub type CLK_FORCE_ON = crate::Reg<clk_force_on::CLK_FORCE_ON_SPEC>;
#[doc = "RSA mem clk force register"]
pub mod clk_force_on;
#[doc = "FREE (rw) register accessor: RSA free state register\n\nYou can [`read`](crate::Reg::read) this register and get [`free::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`free::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@free`] module"]
pub type FREE = crate::Reg<free::FREE_SPEC>;
#[doc = "RSA free state register"]
pub mod free;
