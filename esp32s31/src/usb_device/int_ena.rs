...
#[doc = "Field `JTAG_IN_FLUSH` reader - The interrupt enable bit for the USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT interrupt."]
pub type JTAG_IN_FLUSH_R = crate::BitReader;
#[doc = "Field `JTAG_IN_FLUSH` writer - The interrupt enable bit for the USB_SERIAL_JTAG_JTAG_IN_FLUSH_INT interrupt."]
pub type JTAG_IN_FLUSH_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOF` reader - The interrupt enable bit for the USB_SERIAL_JTAG_SOF_INT interrupt."]
pub type SOF_R = crate::BitReader;
#[doc = "Field `SOF` writer - The interrupt enable bit for the USB_SERIAL_JTAG_SOF_INT interrupt."]
pub type SOF_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SERIAL_OUT_RECV_PKT` reader - The interrupt enable bit for the USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT interrupt."]
pub type SERIAL_OUT_RECV_PKT_R = crate::BitReader;
#[doc = "Field `SERIAL_OUT_RECV_PKT` writer - The interrupt enable bit for the USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT interrupt."]
pub type SERIAL_OUT_RECV_PKT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SERIAL_IN_EMPTY` reader - The interrupt enable bit for the USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT interrupt."]
pub type SERIAL_IN_EMPTY_R = crate::BitReader;
#[doc = "Field `SERIAL_IN_EMPTY` writer - The interrupt enable bit for the USB_SERIAL_JTAG_SERIAL_IN_EMPTY_INT interrupt."]
pub type SERIAL_IN_EMPTY_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PID_ERR` reader - The interrupt enable bit for the USB_SERIAL_JTAG_PID_ERR_INT interrupt."]
pub type PID_ERR_R = crate::BitReader;
#[doc = "Field `PID_ERR` writer - The interrupt enable bit for the USB_SERIAL_JTAG_PID_ERR_INT interrupt."]
pub type PID_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CRC5_ERR` reader - The interrupt enable bit for the USB_SERIAL_JTAG_CRC5_ERR_INT interrupt."]
pub type CRC5_ERR_R = crate::BitReader;
#[doc = "Field `CRC5_ERR` writer - The interrupt enable bit for the USB_SERIAL_JTAG_CRC5_ERR_INT interrupt."]
pub type CRC5_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CRC16_ERR` reader - The interrupt enable bit for the USB_SERIAL_JTAG_CRC16_ERR_INT interrupt."]
pub type CRC16_ERR_R = crate::BitReader;
#[doc = "Field `CRC16_ERR` writer - The interrupt enable bit for the USB_SERIAL_JTAG_CRC16_ERR_INT interrupt."]
pub type CRC16_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `STUFF_ERR` reader - The interrupt enable bit for the USB_SERIAL_JTAG_STUFF_ERR_INT interrupt."]
pub type STUFF_ERR_R = crate::BitReader;
#[doc = "Field `STUFF_ERR` writer - The interrupt enable bit for the USB_SERIAL_JTAG_STUFF_ERR_INT interrupt."]
pub type STUFF_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IN_TOKEN_REC_IN_EP1` reader - The interrupt enable bit for the USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT interrupt."]
pub type IN_TOKEN_REC_IN_EP1_R = crate::BitReader;
#[doc = "Field `IN_TOKEN_REC_IN_EP1` writer - The interrupt enable bit for the USB_SERIAL_JTAG_IN_TOKEN_REC_IN_EP1_INT interrupt."]
pub type IN_TOKEN_REC_IN_EP1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `USB_BUS_RESET` reader - The interrupt enable bit for the USB_SERIAL_JTAG_USB_BUS_RESET_INT interrupt."]
pub type USB_BUS_RESET_R = crate::BitReader;
#[doc = "Field `USB_BUS_RESET` writer - The interrupt enable bit for the USB_SERIAL_JTAG_USB_BUS_RESET_INT interrupt."]
pub type USB_BUS_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_EP1_ZERO_PAYLOAD` reader - The interrupt enable bit for the USB_SERIAL_JTAG_OUT_EP1_ZERO_PAYLOAD_INT interrupt."]
pub type OUT_EP1_ZERO_PAYLOAD_R = crate::BitReader;
#[doc = "Field `OUT_EP1_ZERO_PAYLOAD` writer - The interrupt enable bit for the USB_SERIAL_JTAG_OUT_EP1_ZERO_PAYLOAD_INT interrupt."]
pub type OUT_EP1_ZERO_PAYLOAD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUT_EP2_ZERO_PAYLOAD` reader - The interrupt enable bit for the USB_SERIAL_JTAG_OUT_EP2_ZERO_PAYLOAD_INT interrupt."]
pub type OUT_EP2_ZERO_PAYLOAD_R = crate::BitReader;
#[doc = "Field `OUT_EP2_ZERO_PAYLOAD` writer - The interrupt enable bit for the USB_SERIAL_JTAG_OUT_EP2_ZERO_PAYLOAD_INT interrupt."]
pub type OUT_EP2_ZERO_PAYLOAD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RTS_CHG` reader - The interrupt enable bit for the USB_SERIAL_JTAG_RTS_CHG_INT interrupt."]
pub type RTS_CHG_R = crate::BitReader;
#[doc = "Field `RTS_CHG` writer - The interrupt enable bit for the USB_SERIAL_JTAG_RTS_CHG_INT interrupt."]
pub type RTS_CHG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DTR_CHG` reader - The interrupt enable bit for the USB_SERIAL_JTAG_DTR_CHG_INT interrupt."]
pub type DTR_CHG_R = crate::BitReader;
#[doc = "Field `DTR_CHG` writer - The interrupt enable bit for the USB_SERIAL_JTAG_DTR_CHG_INT interrupt."]
pub type DTR_CHG_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `GET_LINE_CODE` reader - The interrupt enable bit for the USB_SERIAL_JTAG_GET_LINE_CODE_INT interrupt."]
pub type GET_LINE_CODE_R = crate::BitReader;
#[doc = "Field `GET_LINE_CODE` writer - The interrupt enable bit for the USB_SERIAL_JTAG_GET_LINE_CODE_INT interrupt."]
pub type GET_LINE_CODE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SET_LINE_CODE` reader - The interrupt enable bit for the USB_SERIAL_JTAG_SET_LINE_CODE_INT interrupt."]
pub type SET_LINE_CODE_R = crate::BitReader;
#[doc = "Field `SET_LINE_CODE` writer - The interrupt enable bit for the USB_SERIAL_JTAG_SET_LINE_CODE_INT interrupt."]
...
impl W {
    ...
    #[doc = "Bit 12 - The interrupt enable bit for the USB_SERIAL_JTAG_RTS_CHG_INT interrupt."]
    #[inline(always)]
    pub fn rts_chg(&mut self) -> RTS_CHG_W<'_, INT_ENA_SPEC> {
        RTS_CHG_W::new(self, 12)
    }
    #[doc = "Bit 13 - The interrupt enable bit for the USB_SERIAL_JTAG_DTR_CHG_INT interrupt."]
    #[inline(always)]
    pub fn dtr_chg(&mut self) -> DTR_CHG_W<'_, INT_ENA_SPEC> {
        DTR_CHG_W::new(self, 13)
    }
    #[doc = "Bit 14 - The interrupt enable bit for the USB_SERIAL_JTAG_GET_LINE_CODE_INT interrupt."]
    #[inline(always)]
    pub fn get_line_code(&mut self) -> GET_LINE_CODE_W<'_, INT_ENA_SPEC> {
        GET_LINE_CODE_W::new(self, 14)
    }
    #[doc = "Bit 15 - The interrupt enable bit for the USB_SERIAL_JTAG_SET_LINE_CODE_INT interrupt."]
    #[inline(always)]
    pub fn set_line_code(&mut self) -> SET_LINE_CODE_W<'_, INT_ENA_SPEC> {
