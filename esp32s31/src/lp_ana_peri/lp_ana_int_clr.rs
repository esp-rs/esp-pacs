...
impl W {
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn lp_ana_bod_mode0_int_clr(
        &mut self,
    ) -> LP_ANA_BOD_MODE0_INT_CLR_W<'_, LP_ANA_INT_CLR_SPEC> {
        LP_ANA_BOD_MODE0_INT_CLR_W::new(self, 31)
    }
}
#[doc = "need_des\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lp_ana_int_clr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
