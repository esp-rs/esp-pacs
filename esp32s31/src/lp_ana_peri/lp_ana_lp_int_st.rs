    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_ANA_LP_INT_ST")
            .field(
                ...
                &self.lp_ana_bod_mode0_lp_int_st(),
            )
            .finish()
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`lp_ana_lp_int_st::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
