...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LP_ANA_DATE")
            .field("lp_ana_lp_ana_date", &self.lp_ana_lp_ana_date())
            .field("lp_ana_clk_en", &self.lp_ana_clk_en())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:30 - need_des"]
    #[inline(always)]
    pub fn lp_ana_lp_ana_date(&mut self) -> LP_ANA_LP_ANA_DATE_W<'_, LP_ANA_DATE_SPEC> {
        LP_ANA_LP_ANA_DATE_W::new(self, 0)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    pub fn lp_ana_clk_en(&mut self) -> LP_ANA_CLK_EN_W<'_, LP_ANA_DATE_SPEC> {
        LP_ANA_CLK_EN_W::new(self, 31)
    }
}
#[doc = "need_des\n\nYou can [`read`](crate::Reg::read) this register and get [`lp_ana_date::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lp_ana_date::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets LP_ANA_DATE to value 0x0250_5140"]
impl crate::Resettable for LP_ANA_DATE_SPEC {
    const RESET_VALUE: u32 = 0x0250_5140;
}
