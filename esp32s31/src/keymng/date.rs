...
#[doc = "Field `DATE` reader - Key Manager version control register."]
pub type DATE_R = crate::FieldReader<u32>;
#[doc = "Field `DATE` writer - Key Manager version control register."]
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    #[doc = "Bits 0:27 - Key Manager version control register."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DATE to value 0x0250_8190"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x0250_8190;
}
