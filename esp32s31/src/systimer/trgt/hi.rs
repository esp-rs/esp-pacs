...
#[doc = "Field `HI` reader - Configures the alarm value to be loaded to COMP0, high 20 bits."]
pub type HI_R = crate::FieldReader<u32>;
#[doc = "Field `HI` writer - Configures the alarm value to be loaded to COMP0, high 20 bits."]
