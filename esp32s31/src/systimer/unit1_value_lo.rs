...
#[doc = "Field `TIMER_UNIT1_VALUE_LO` reader - Represents UNIT1 read value, low 32 bits."]
pub type TIMER_UNIT1_VALUE_LO_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents UNIT1 read value, low 32 bits."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UNIT1_VALUE_LO")
            .field("timer_unit1_value_lo", &self.timer_unit1_value_lo())
            .finish()
    }
}
#[doc = "UNIT1 value, low 32 bits\n\nYou can [`read`](crate::Reg::read) this register and get [`unit1_value_lo::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
