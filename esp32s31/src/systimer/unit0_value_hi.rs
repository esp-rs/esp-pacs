...
#[doc = "Field `TIMER_UNIT0_VALUE_HI` reader - Represents UNIT0 read value, high 20 bits."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UNIT0_VALUE_HI")
            .field("timer_unit0_value_hi", &self.timer_unit0_value_hi())
            .finish()
    }
}
#[doc = "UNIT0 value, high 20 bits\n\nYou can [`read`](crate::Reg::read) this register and get [`unit0_value_hi::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
