...
#[doc = "Field `TIMER_UNIT1_LOAD_HI` reader - Configures the value to be loaded to UNIT1, high 20 bits."]
pub type TIMER_UNIT1_LOAD_HI_R = crate::FieldReader<u32>;
#[doc = "Field `TIMER_UNIT1_LOAD_HI` writer - Configures the value to be loaded to UNIT1, high 20 bits."]
pub type TIMER_UNIT1_LOAD_HI_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    #[doc = "Bits 0:19 - Configures the value to be loaded to UNIT1, high 20 bits."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("UNIT1_LOAD_HI")
            .field("timer_unit1_load_hi", &self.timer_unit1_load_hi())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:19 - Configures the value to be loaded to UNIT1, high 20 bits."]
    #[inline(always)]
    pub fn timer_unit1_load_hi(&mut self) -> TIMER_UNIT1_LOAD_HI_W<'_, UNIT1_LOAD_HI_SPEC> {
        TIMER_UNIT1_LOAD_HI_W::new(self, 0)
    }
}
#[doc = "High 20 bits to be loaded to UNIT1\n\nYou can [`read`](crate::Reg::read) this register and get [`unit1_load_hi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`unit1_load_hi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
