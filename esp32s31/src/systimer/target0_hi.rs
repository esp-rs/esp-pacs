...
#[doc = "Field `TIMER_TARGET0_HI` reader - Configures the alarm value to be loaded to COMP0, high 20 bits."]
pub type TIMER_TARGET0_HI_R = crate::FieldReader<u32>;
#[doc = "Field `TIMER_TARGET0_HI` writer - Configures the alarm value to be loaded to COMP0, high 20 bits."]
pub type TIMER_TARGET0_HI_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    #[doc = "Bits 0:19 - Configures the alarm value to be loaded to COMP0, high 20 bits."]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TARGET0_HI")
            .field("timer_target0_hi", &self.timer_target0_hi())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:19 - Configures the alarm value to be loaded to COMP0, high 20 bits."]
    #[inline(always)]
    pub fn timer_target0_hi(&mut self) -> TIMER_TARGET0_HI_W<'_, TARGET0_HI_SPEC> {
        TIMER_TARGET0_HI_W::new(self, 0)
    }
}
#[doc = "Alarm value to be loaded to COMP0, high 20 bits\n\nYou can [`read`](crate::Reg::read) this register and get [`target0_hi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`target0_hi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
