...
#[doc = "Field `TARGET0_HI_RO` reader - Represents the actual target value of COMP0, high 20 bits."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REAL_TARGET0_HI")
            .field("target0_hi_ro", &self.target0_hi_ro())
            .finish()
    }
}
#[doc = "Actual target value of COMP0, high 20 bits\n\nYou can [`read`](crate::Reg::read) this register and get [`real_target0_hi::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
