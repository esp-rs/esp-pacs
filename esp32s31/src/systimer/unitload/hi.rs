...
#[doc = "Field `LOAD_HI` reader - Configures the value to be loaded to UNIT0, high 20 bits."]
pub type LOAD_HI_R = crate::FieldReader<u32>;
#[doc = "Field `LOAD_HI` writer - Configures the value to be loaded to UNIT0, high 20 bits."]
