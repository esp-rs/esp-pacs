...
#[doc = "Field `LOAD_LO` reader - Configures the value to be loaded to UNIT0, low 32 bits."]
pub type LOAD_LO_R = crate::FieldReader<u32>;
#[doc = "Field `LOAD_LO` writer - Configures the value to be loaded to UNIT0, low 32 bits."]
...
impl W {
    #[doc = "Bits 0:31 - Configures the value to be loaded to UNIT0, low 32 bits."]
    #[inline(always)]
    pub fn load_lo(&mut self) -> LOAD_LO_W<'_, LO_SPEC> {
