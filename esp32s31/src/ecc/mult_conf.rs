...
#[doc = "Field `MULT_KEY_LENGTH` reader - Configures the key length mode bit of ECC Accelerator. \\\\ 0: P-192\\\\ 1: P-256\\\\ 2: P-384\\\\ 3: SM2.\\\\"]
pub type MULT_KEY_LENGTH_R = crate::FieldReader;
#[doc = "Field `MULT_KEY_LENGTH` writer - Configures the key length mode bit of ECC Accelerator. \\\\ 0: P-192\\\\ 1: P-256\\\\ 2: P-384\\\\ 3: SM2.\\\\"]
