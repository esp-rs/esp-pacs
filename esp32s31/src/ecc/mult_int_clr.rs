...
#[doc = "Field `MULT_CALC_DONE_INT_CLR` writer - Write 1 to clear the ECC_CALC_DONE_INT interrupt."]
pub type MULT_CALC_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    pub fn mult_calc_done_int_clr(&mut self) -> MULT_CALC_DONE_INT_CLR_W<'_, MULT_INT_CLR_SPEC> {
        MULT_CALC_DONE_INT_CLR_W::new(self, 0)
    }
}
