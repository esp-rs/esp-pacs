...
#[doc = "Field `MULT_CALC_DONE_INT_RAW` reader - The raw interrupt status of the ECC_CALC_DONE_INT interrupt."]
pub type MULT_CALC_DONE_INT_RAW_R = crate::BitReader;
impl R {
    #[doc = "Bit 0 - The raw interrupt status of the ECC_CALC_DONE_INT interrupt."]
    #[inline(always)]
    pub fn mult_calc_done_int_raw(&self) -> MULT_CALC_DONE_INT_RAW_R {
        MULT_CALC_DONE_INT_RAW_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MULT_INT_RAW")
            .field("mult_calc_done_int_raw", &self.mult_calc_done_int_raw())
            .finish()
    }
}
