...
#[doc = "Field `ECC_CURVE` reader - The ecc curve select bit of ECDSA Accelerator. 0: P-192. 1: P-256. 2: P-384 3: SM2."]
pub type ECC_CURVE_R = crate::FieldReader;
#[doc = "Field `ECC_CURVE` writer - The ecc curve select bit of ECDSA Accelerator. 0: P-192. 1: P-256. 2: P-384 3: SM2."]
pub type ECC_CURVE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
#[doc = "Field `USE_HARDWARE_KEY` reader - Configures the ECDSA use software key or hardware key.\\\\ 0: Software key. \\\\ 1: Hardware key. \\\\"]
pub type USE_HARDWARE_KEY_R = crate::BitReader;
#[doc = "Field `USE_HARDWARE_KEY` writer - Configures the ECDSA use software key or hardware key.\\\\ 0: Software key. \\\\ 1: Hardware key. \\\\"]
...
impl R {
    ...
    #[doc = "Bits 2:3 - The ecc curve select bit of ECDSA Accelerator. 0: P-192. 1: P-256. 2: P-384 3: SM2."]
    #[inline(always)]
    pub fn ecc_curve(&self) -> ECC_CURVE_R {
        ECC_CURVE_R::new(((self.bits >> 2) & 3) as u8)
    }
    ...
    pub fn software_set_k(&self) -> SOFTWARE_SET_K_R {
        SOFTWARE_SET_K_R::new(((self.bits >> 4) & 1) != 0)
    }
    ...
    pub fn software_set_z(&self) -> SOFTWARE_SET_Z_R {
        SOFTWARE_SET_Z_R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    pub fn deterministic_k(&self) -> DETERMINISTIC_K_R {
        DETERMINISTIC_K_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Configures the ECDSA use software key or hardware key.\\\\ 0: Software key. \\\\ 1: Hardware key. \\\\"]
    #[inline(always)]
    pub fn use_hardware_key(&self) -> USE_HARDWARE_KEY_R {
        USE_HARDWARE_KEY_R::new(((self.bits >> 7) & 1) != 0)
    }
}
...
impl W {
    ...
    pub fn software_set_k(&mut self) -> SOFTWARE_SET_K_W<'_, CONF_SPEC> {
        SOFTWARE_SET_K_W::new(self, 4)
    }
    #[doc = "Bit 5 - The source of z select bit. 0: z is generated from SHA result. 1: z is written by software."]
    #[inline(always)]
    pub fn software_set_z(&mut self) -> SOFTWARE_SET_Z_W<'_, CONF_SPEC> {
        SOFTWARE_SET_Z_W::new(self, 5)
    }
    #[doc = "Bit 6 - The source of hardware generated k. 0: k is generated by TRNG. 1: k is generated by deterministic derivation algorithm."]
    #[inline(always)]
    pub fn deterministic_k(&mut self) -> DETERMINISTIC_K_W<'_, CONF_SPEC> {
        DETERMINISTIC_K_W::new(self, 6)
    }
    #[doc = "Bit 7 - Configures the ECDSA use software key or hardware key.\\\\ 0: Software key. \\\\ 1: Hardware key. \\\\"]
    #[inline(always)]
    pub fn use_hardware_key(&mut self) -> USE_HARDWARE_KEY_W<'_, CONF_SPEC> {
        USE_HARDWARE_KEY_W::new(self, 7)
    }
}
