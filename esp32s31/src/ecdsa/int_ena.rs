...
#[doc = "Field `PREP_DONE_INT_ENA` reader - The interrupt enable bit for the ecdsa_prep_done_int interrupt"]
pub type PREP_DONE_INT_ENA_R = crate::BitReader;
#[doc = "Field `PREP_DONE_INT_ENA` writer - The interrupt enable bit for the ecdsa_prep_done_int interrupt"]
pub type PREP_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PROC_DONE_INT_ENA` reader - The interrupt enable bit for the ecdsa_proc_done_int interrupt"]
pub type PROC_DONE_INT_ENA_R = crate::BitReader;
#[doc = "Field `PROC_DONE_INT_ENA` writer - The interrupt enable bit for the ecdsa_proc_done_int interrupt"]
pub type PROC_DONE_INT_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `POST_DONE_INT_ENA` reader - The interrupt enable bit for the ecdsa_post_done_int interrupt"]
pub type POST_DONE_INT_ENA_R = crate::BitReader;
#[doc = "Field `POST_DONE_INT_ENA` writer - The interrupt enable bit for the ecdsa_post_done_int interrupt"]
