...
pub struct RegisterBlock {
    ...
    lcd_user: LCD_USER,
    lcd_misc: LCD_MISC,
    lcd_rgb_vertical: LCD_RGB_VERTICAL,
    lcd_rgb_horizontal: LCD_RGB_HORIZONTAL,
    lcd_rgb_blank: LCD_RGB_BLANK,
    lcd_rgb_ctrl: LCD_RGB_CTRL,
    ...
    lcd_trans_buff_cfg: LCD_TRANS_BUFF_CFG,
    lcd_data_dbg: LCD_DATA_DBG,
    lcd_bw_monitor_dbg: LCD_BW_MONITOR_DBG,
    cam_data_dbg: CAM_DATA_DBG,
    _reserved19: [u8; 0x18],
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn lcd_rgb_vertical(&self) -> &LCD_RGB_VERTICAL {
        &self.lcd_rgb_vertical
    }
    #[doc = "0x20 - LCD config register."]
    #[inline(always)]
    pub const fn lcd_rgb_horizontal(&self) -> &LCD_RGB_HORIZONTAL {
        &self.lcd_rgb_horizontal
    }
    #[doc = "0x24 - LCD config register."]
    #[inline(always)]
    pub const fn lcd_rgb_blank(&self) -> &LCD_RGB_BLANK {
        &self.lcd_rgb_blank
    }
    #[doc = "0x28 - LCD config register."]
    #[inline(always)]
    pub const fn lcd_rgb_ctrl(&self) -> &LCD_RGB_CTRL {
        &self.lcd_rgb_ctrl
    }
    ...
    #[doc = "0x3c - LCD trans buffer register"]
    #[inline(always)]
    pub const fn lcd_trans_buff_cfg(&self) -> &LCD_TRANS_BUFF_CFG {
        &self.lcd_trans_buff_cfg
    }
    #[doc = "0x40 - LCDCAM LCD debug data register"]
    #[inline(always)]
    pub const fn lcd_data_dbg(&self) -> &LCD_DATA_DBG {
        &self.lcd_data_dbg
    }
    #[doc = "0x44 - LCDCAM LCD monitor bandwidth debug register"]
    #[inline(always)]
    pub const fn lcd_bw_monitor_dbg(&self) -> &LCD_BW_MONITOR_DBG {
        &self.lcd_bw_monitor_dbg
    }
    #[doc = "0x48 - LCDCAM CAM debug data register"]
    #[inline(always)]
    pub const fn cam_data_dbg(&self) -> &CAM_DATA_DBG {
        &self.cam_data_dbg
    }
...
#[doc = "LCD config register."]
pub mod lcd_misc;
#[doc = "LCD_RGB_VERTICAL (rw) register accessor: LCD config register.\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_rgb_vertical::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_rgb_vertical::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_rgb_vertical`] module"]
pub type LCD_RGB_VERTICAL = crate::Reg<lcd_rgb_vertical::LCD_RGB_VERTICAL_SPEC>;
#[doc = "LCD config register."]
pub mod lcd_rgb_vertical;
#[doc = "LCD_RGB_HORIZONTAL (rw) register accessor: LCD config register.\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_rgb_horizontal::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_rgb_horizontal::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_rgb_horizontal`] module"]
pub type LCD_RGB_HORIZONTAL = crate::Reg<lcd_rgb_horizontal::LCD_RGB_HORIZONTAL_SPEC>;
#[doc = "LCD config register."]
pub mod lcd_rgb_horizontal;
#[doc = "LCD_RGB_BLANK (rw) register accessor: LCD config register.\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_rgb_blank::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_rgb_blank::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_rgb_blank`] module"]
pub type LCD_RGB_BLANK = crate::Reg<lcd_rgb_blank::LCD_RGB_BLANK_SPEC>;
#[doc = "LCD config register."]
pub mod lcd_rgb_blank;
#[doc = "LCD_RGB_CTRL (rw) register accessor: LCD config register.\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_rgb_ctrl::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_rgb_ctrl::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_rgb_ctrl`] module"]
pub type LCD_RGB_CTRL = crate::Reg<lcd_rgb_ctrl::LCD_RGB_CTRL_SPEC>;
#[doc = "LCD config register."]
pub mod lcd_rgb_ctrl;
#[doc = "LCD_FIRST_CMD_VAL (rw) register accessor: LCD config register.\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_first_cmd_val::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_first_cmd_val::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_first_cmd_val`] module"]
pub type LCD_FIRST_CMD_VAL = crate::Reg<lcd_first_cmd_val::LCD_FIRST_CMD_VAL_SPEC>;
#[doc = "LCD config register."]
pub mod lcd_first_cmd_val;
#[doc = "LCD_LATTER_CMD_VAL (rw) register accessor: LCD config register.\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_latter_cmd_val::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_latter_cmd_val::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_latter_cmd_val`] module"]
pub type LCD_LATTER_CMD_VAL = crate::Reg<lcd_latter_cmd_val::LCD_LATTER_CMD_VAL_SPEC>;
#[doc = "LCD config register."]
pub mod lcd_latter_cmd_val;
#[doc = "LCD_DLY_MODE_CFG1 (rw) register accessor: LCD config register.\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_dly_mode_cfg1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_dly_mode_cfg1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_dly_mode_cfg1`] module"]
pub type LCD_DLY_MODE_CFG1 = crate::Reg<lcd_dly_mode_cfg1::LCD_DLY_MODE_CFG1_SPEC>;
#[doc = "LCD config register."]
pub mod lcd_dly_mode_cfg1;
#[doc = "LCD_DLY_MODE_CFG2 (rw) register accessor: LCD config register.\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_dly_mode_cfg2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_dly_mode_cfg2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_dly_mode_cfg2`] module"]
pub type LCD_DLY_MODE_CFG2 = crate::Reg<lcd_dly_mode_cfg2::LCD_DLY_MODE_CFG2_SPEC>;
#[doc = "LCD config register."]
pub mod lcd_dly_mode_cfg2;
#[doc = "LCD_TRANS_BUFF_CFG (rw) register accessor: LCD trans buffer register\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_trans_buff_cfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_trans_buff_cfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_trans_buff_cfg`] module"]
pub type LCD_TRANS_BUFF_CFG = crate::Reg<lcd_trans_buff_cfg::LCD_TRANS_BUFF_CFG_SPEC>;
#[doc = "LCD trans buffer register"]
pub mod lcd_trans_buff_cfg;
#[doc = "LCD_DATA_DBG (rw) register accessor: LCDCAM LCD debug data register\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_data_dbg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_data_dbg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_data_dbg`] module"]
pub type LCD_DATA_DBG = crate::Reg<lcd_data_dbg::LCD_DATA_DBG_SPEC>;
#[doc = "LCDCAM LCD debug data register"]
pub mod lcd_data_dbg;
#[doc = "LCD_BW_MONITOR_DBG (rw) register accessor: LCDCAM LCD monitor bandwidth debug register\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_bw_monitor_dbg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_bw_monitor_dbg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@lcd_bw_monitor_dbg`] module"]
pub type LCD_BW_MONITOR_DBG = crate::Reg<lcd_bw_monitor_dbg::LCD_BW_MONITOR_DBG_SPEC>;
#[doc = "LCDCAM LCD monitor bandwidth debug register"]
pub mod lcd_bw_monitor_dbg;
#[doc = "CAM_DATA_DBG (rw) register accessor: LCDCAM CAM debug data register\n\nYou can [`read`](crate::Reg::read) this register and get [`cam_data_dbg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cam_data_dbg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cam_data_dbg`] module"]
pub type CAM_DATA_DBG = crate::Reg<cam_data_dbg::CAM_DATA_DBG_SPEC>;
#[doc = "LCDCAM CAM debug data register"]
pub mod cam_data_dbg;
