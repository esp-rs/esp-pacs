...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, DDR_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn var_dummy(&mut self) -> VAR_DUMMY_W<'_, DDR_SPEC> {
        VAR_DUMMY_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn rdat_swp(&mut self) -> RDAT_SWP_W<'_, DDR_SPEC> {
        RDAT_SWP_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn wdat_swp(&mut self) -> WDAT_SWP_W<'_, DDR_SPEC> {
        WDAT_SWP_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn cmd_dis(&mut self) -> CMD_DIS_W<'_, DDR_SPEC> {
        CMD_DIS_W::new(self, 4)
    }
    #[doc = "Bits 5:11"]
    #[inline(always)]
    pub fn outminbytelen(&mut self) -> OUTMINBYTELEN_W<'_, DDR_SPEC> {
        OUTMINBYTELEN_W::new(self, 5)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn tx_ddr_msk_en(&mut self) -> TX_DDR_MSK_EN_W<'_, DDR_SPEC> {
        TX_DDR_MSK_EN_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    pub fn rx_ddr_msk_en(&mut self) -> RX_DDR_MSK_EN_W<'_, DDR_SPEC> {
        RX_DDR_MSK_EN_W::new(self, 13)
    }
    #[doc = "Bits 14:20"]
    #[inline(always)]
    pub fn usr_ddr_dqs_thd(&mut self) -> USR_DDR_DQS_THD_W<'_, DDR_SPEC> {
        USR_DDR_DQS_THD_W::new(self, 14)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn dqs_loop(&mut self) -> DQS_LOOP_W<'_, DDR_SPEC> {
        DQS_LOOP_W::new(self, 21)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn clk_diff_en(&mut self) -> CLK_DIFF_EN_W<'_, DDR_SPEC> {
        CLK_DIFF_EN_W::new(self, 24)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    pub fn dqs_ca_in(&mut self) -> DQS_CA_IN_W<'_, DDR_SPEC> {
        DQS_CA_IN_W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn hyperbus_dummy_2x(&mut self) -> HYPERBUS_DUMMY_2X_W<'_, DDR_SPEC> {
        HYPERBUS_DUMMY_2X_W::new(self, 27)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    pub fn clk_diff_inv(&mut self) -> CLK_DIFF_INV_W<'_, DDR_SPEC> {
        CLK_DIFF_INV_W::new(self, 28)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    pub fn octa_ram_addr(&mut self) -> OCTA_RAM_ADDR_W<'_, DDR_SPEC> {
        OCTA_RAM_ADDR_W::new(self, 29)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    pub fn hyperbus_ca(&mut self) -> HYPERBUS_CA_W<'_, DDR_SPEC> {
