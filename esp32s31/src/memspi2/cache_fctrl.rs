...
#[doc = "Field `ARB_REQ_PRI(0-1)` reader - "]
pub type ARB_REQ_PRI_R = crate::BitReader;
#[doc = "Field `ARB_REQ_PRI(0-1)` writer - "]
pub type ARB_REQ_PRI_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ARB_REQ_WEI(0-1)` reader - "]
pub type ARB_REQ_WEI_R = crate::FieldReader;
#[doc = "Field `ARB_REQ_WEI(0-1)` writer - "]
pub type ARB_REQ_WEI_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `SAME_AW_AR_ADDR_CHK_EN` reader - "]
pub type SAME_AW_AR_ADDR_CHK_EN_R = crate::BitReader;
#[doc = "Field `SAME_AW_AR_ADDR_CHK_EN` writer - "]
pub type SAME_AW_AR_ADDR_CHK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CLOSE_AXI_INF_EN` reader - "]
pub type CLOSE_AXI_INF_EN_R = crate::BitReader;
#[doc = "Field `CLOSE_AXI_INF_EN` writer - "]
...
impl R {
    ...
    #[doc = ""]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `ARB_REQ0_PRI` field.</div>"]
    #[inline(always)]
    pub fn arb_req_pri(&self, n: u8) -> ARB_REQ_PRI_R {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        ARB_REQ_PRI_R::new(((self.bits >> (n + 10)) & 1) != 0)
    }
    #[doc = "Iterator for array of:"]
    #[doc = ""]
    #[inline(always)]
    pub fn arb_req_pri_iter(&self) -> impl Iterator<Item = ARB_REQ_PRI_R> + '_ {
        (0..2).map(move |n| ARB_REQ_PRI_R::new(((self.bits >> (n + 10)) & 1) != 0))
    }
    #[doc = "Bit 10 - ARB_REQ0_PRI"]
    #[inline(always)]
    pub fn arb_req0_pri(&self) -> ARB_REQ_PRI_R {
        ARB_REQ_PRI_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - ARB_REQ1_PRI"]
    #[inline(always)]
    pub fn arb_req1_pri(&self) -> ARB_REQ_PRI_R {
        ARB_REQ_PRI_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = ""]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `ARB_REQ0_WEI` field.</div>"]
    #[inline(always)]
    pub fn arb_req_wei(&self, n: u8) -> ARB_REQ_WEI_R {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        ARB_REQ_WEI_R::new(((self.bits >> (n * 4 + 12)) & 0x0f) as u8)
    }
    #[doc = "Iterator for array of:"]
    #[doc = ""]
    #[inline(always)]
    pub fn arb_req_wei_iter(&self) -> impl Iterator<Item = ARB_REQ_WEI_R> + '_ {
        (0..2).map(move |n| ARB_REQ_WEI_R::new(((self.bits >> (n * 4 + 12)) & 0x0f) as u8))
    }
    #[doc = "Bits 12:15 - ARB_REQ0_WEI"]
    #[inline(always)]
    pub fn arb_req0_wei(&self) -> ARB_REQ_WEI_R {
        ARB_REQ_WEI_R::new(((self.bits >> 12) & 0x0f) as u8)
    }
    #[doc = "Bits 16:19 - ARB_REQ1_WEI"]
    #[inline(always)]
    pub fn arb_req1_wei(&self) -> ARB_REQ_WEI_R {
        ARB_REQ_WEI_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `ARB_REQ0_PRI` field.</div>"]
    #[inline(always)]
    pub fn arb_req_pri(&mut self, n: u8) -> ARB_REQ_PRI_W<'_, CACHE_FCTRL_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        ARB_REQ_PRI_W::new(self, n + 10)
    }
    #[doc = "Bit 10 - ARB_REQ0_PRI"]
    #[inline(always)]
    pub fn arb_req0_pri(&mut self) -> ARB_REQ_PRI_W<'_, CACHE_FCTRL_SPEC> {
        ARB_REQ_PRI_W::new(self, 10)
    }
    #[doc = "Bit 11 - ARB_REQ1_PRI"]
    #[inline(always)]
    pub fn arb_req1_pri(&mut self) -> ARB_REQ_PRI_W<'_, CACHE_FCTRL_SPEC> {
        ARB_REQ_PRI_W::new(self, 11)
    }
    #[doc = ""]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `ARB_REQ0_WEI` field.</div>"]
    #[inline(always)]
    pub fn arb_req_wei(&mut self, n: u8) -> ARB_REQ_WEI_W<'_, CACHE_FCTRL_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        ARB_REQ_WEI_W::new(self, n * 4 + 12)
    }
    #[doc = "Bits 12:15 - ARB_REQ0_WEI"]
    #[inline(always)]
    pub fn arb_req0_wei(&mut self) -> ARB_REQ_WEI_W<'_, CACHE_FCTRL_SPEC> {
        ARB_REQ_WEI_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - ARB_REQ1_WEI"]
    #[inline(always)]
    pub fn arb_req1_wei(&mut self) -> ARB_REQ_WEI_W<'_, CACHE_FCTRL_SPEC> {
        ARB_REQ_WEI_W::new(self, 16)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
