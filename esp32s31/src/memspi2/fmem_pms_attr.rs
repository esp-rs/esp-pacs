#[doc = "Register `FMEM_PMS%s_ATTR` reader"]
pub type R = crate::R<FMEM_PMS_ATTR_SPEC>;
#[doc = "Register `FMEM_PMS%s_ATTR` writer"]
pub type W = crate::W<FMEM_PMS_ATTR_SPEC>;
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn rd_attr(&mut self) -> RD_ATTR_W<'_, FMEM_PMS_ATTR_SPEC> {
        RD_ATTR_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn wr_attr(&mut self) -> WR_ATTR_W<'_, FMEM_PMS_ATTR_SPEC> {
        WR_ATTR_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn ecc(&mut self) -> ECC_W<'_, FMEM_PMS_ATTR_SPEC> {
        ECC_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn nonsecure_rd_attr(&mut self) -> NONSECURE_RD_ATTR_W<'_, FMEM_PMS_ATTR_SPEC> {
        NONSECURE_RD_ATTR_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn nonsecure_wr_attr(&mut self) -> NONSECURE_WR_ATTR_W<'_, FMEM_PMS_ATTR_SPEC> {
        NONSECURE_WR_ATTR_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn nonsecure_ecc(&mut self) -> NONSECURE_ECC_W<'_, FMEM_PMS_ATTR_SPEC> {
        NONSECURE_ECC_W::new(self, 5)
    }
}
#[doc = "SPI1 flash PMS section 0 attribute register\n\nYou can [`read`](crate::Reg::read) this register and get [`fmem_pms_attr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmem_pms_attr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FMEM_PMS_ATTR_SPEC;
impl crate::RegisterSpec for FMEM_PMS_ATTR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fmem_pms_attr::R`](R) reader structure"]
impl crate::Readable for FMEM_PMS_ATTR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fmem_pms_attr::W`](W) writer structure"]
impl crate::Writable for FMEM_PMS_ATTR_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FMEM_PMS%s_ATTR to value 0x1b"]
impl crate::Resettable for FMEM_PMS_ATTR_SPEC {
