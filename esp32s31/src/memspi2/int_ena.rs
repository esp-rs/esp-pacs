...
impl W {
    ...
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn axi_waddr_err(&mut self) -> AXI_WADDR_ERR_W<'_, INT_ENA_SPEC> {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `DQS0_AFIFO_OVF` field.</div>"]
    #[inline(always)]
    pub fn dqs_afifo_ovf(&mut self, n: u8) -> DQS_AFIFO_OVF_W<'_, INT_ENA_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
    ...
    #[doc = "Bit 28 - DQS0_AFIFO_OVF"]
    #[inline(always)]
    pub fn dqs0_afifo_ovf(&mut self) -> DQS_AFIFO_OVF_W<'_, INT_ENA_SPEC> {
        DQS_AFIFO_OVF_W::new(self, 28)
    }
    #[doc = "Bit 29 - DQS1_AFIFO_OVF"]
    #[inline(always)]
    pub fn dqs1_afifo_ovf(&mut self) -> DQS_AFIFO_OVF_W<'_, INT_ENA_SPEC> {
