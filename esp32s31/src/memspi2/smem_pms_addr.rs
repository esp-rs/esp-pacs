...
#[doc = "Field `ADDR_S` reader - "]
pub type ADDR_S_R = crate::FieldReader<u32>;
#[doc = "Field `ADDR_S` writer - "]
pub type ADDR_S_W<'a, REG> = crate::FieldWriter<'a, REG, 29, u32>;
impl R {
    #[doc = "Bits 0:28"]
    #[inline(always)]
    pub fn addr_s(&self) -> ADDR_S_R {
        ADDR_S_R::new(self.bits & 0x1fff_ffff)
    }
}
...
impl W {
    #[doc = "Bits 0:28"]
    #[inline(always)]
    pub fn addr_s(&mut self) -> ADDR_S_W<'_, SMEM_PMS_ADDR_SPEC> {
        ADDR_S_W::new(self, 0)
    }
}
