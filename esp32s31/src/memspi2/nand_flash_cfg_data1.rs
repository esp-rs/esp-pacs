...
#[doc = "Field `CFG_DATA(2-3)` reader - "]
pub type CFG_DATA_R = crate::FieldReader<u16>;
impl R {
    #[doc = ""]
    #[doc = ""]
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `CFG_DATA2` field.</div>"]
    #[inline(always)]
    ...
    #[doc = "Bits 0:15 - CFG_DATA2"]
    #[inline(always)]
    pub fn cfg_data2(&self) -> CFG_DATA_R {
        CFG_DATA_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - CFG_DATA3"]
    #[inline(always)]
    pub fn cfg_data3(&self) -> CFG_DATA_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("NAND_FLASH_CFG_DATA1")
            .field("cfg_data2", &self.cfg_data2())
            .field("cfg_data3", &self.cfg_data3())
            .finish()
    }
}
