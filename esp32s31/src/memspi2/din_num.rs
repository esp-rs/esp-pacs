...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `DIN0_NUM` field.</div>"]
    #[inline(always)]
    pub fn din_num(&mut self, n: u8) -> DIN_NUM_W<'_, DIN_NUM_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[doc = "Bits 0:1 - DIN0_NUM"]
    #[inline(always)]
    pub fn din0_num(&mut self) -> DIN_NUM_W<'_, DIN_NUM_SPEC> {
        DIN_NUM_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - DIN1_NUM"]
    #[inline(always)]
    pub fn din1_num(&mut self) -> DIN_NUM_W<'_, DIN_NUM_SPEC> {
        DIN_NUM_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - DIN2_NUM"]
    #[inline(always)]
    pub fn din2_num(&mut self) -> DIN_NUM_W<'_, DIN_NUM_SPEC> {
        DIN_NUM_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - DIN3_NUM"]
    #[inline(always)]
    pub fn din3_num(&mut self) -> DIN_NUM_W<'_, DIN_NUM_SPEC> {
        DIN_NUM_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - DIN4_NUM"]
    #[inline(always)]
    pub fn din4_num(&mut self) -> DIN_NUM_W<'_, DIN_NUM_SPEC> {
        DIN_NUM_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - DIN5_NUM"]
    #[inline(always)]
    pub fn din5_num(&mut self) -> DIN_NUM_W<'_, DIN_NUM_SPEC> {
        DIN_NUM_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - DIN6_NUM"]
    #[inline(always)]
    pub fn din6_num(&mut self) -> DIN_NUM_W<'_, DIN_NUM_SPEC> {
        DIN_NUM_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - DIN7_NUM"]
    #[inline(always)]
    pub fn din7_num(&mut self) -> DIN_NUM_W<'_, DIN_NUM_SPEC> {
