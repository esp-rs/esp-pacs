...
impl W {
    ...
    #[doc = "<div class=\"warning\">`n` is number of field in register. `n == 0` corresponds to `DIN0_MODE` field.</div>"]
    #[inline(always)]
    pub fn din_mode(&mut self, n: u8) -> DIN_MODE_W<'_, DIN_MODE_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[doc = "Bits 0:2 - DIN0_MODE"]
    #[inline(always)]
    pub fn din0_mode(&mut self) -> DIN_MODE_W<'_, DIN_MODE_SPEC> {
        DIN_MODE_W::new(self, 0)
    }
    #[doc = "Bits 3:5 - DIN1_MODE"]
    #[inline(always)]
    pub fn din1_mode(&mut self) -> DIN_MODE_W<'_, DIN_MODE_SPEC> {
        DIN_MODE_W::new(self, 3)
    }
    #[doc = "Bits 6:8 - DIN2_MODE"]
    #[inline(always)]
    pub fn din2_mode(&mut self) -> DIN_MODE_W<'_, DIN_MODE_SPEC> {
        DIN_MODE_W::new(self, 6)
    }
    #[doc = "Bits 9:11 - DIN3_MODE"]
    #[inline(always)]
    pub fn din3_mode(&mut self) -> DIN_MODE_W<'_, DIN_MODE_SPEC> {
        DIN_MODE_W::new(self, 9)
    }
    #[doc = "Bits 12:14 - DIN4_MODE"]
    #[inline(always)]
    pub fn din4_mode(&mut self) -> DIN_MODE_W<'_, DIN_MODE_SPEC> {
        DIN_MODE_W::new(self, 12)
    }
    #[doc = "Bits 15:17 - DIN5_MODE"]
    #[inline(always)]
    pub fn din5_mode(&mut self) -> DIN_MODE_W<'_, DIN_MODE_SPEC> {
        DIN_MODE_W::new(self, 15)
    }
    #[doc = "Bits 18:20 - DIN6_MODE"]
    #[inline(always)]
    pub fn din6_mode(&mut self) -> DIN_MODE_W<'_, DIN_MODE_SPEC> {
        DIN_MODE_W::new(self, 18)
    }
    #[doc = "Bits 21:23 - DIN7_MODE"]
    #[inline(always)]
    pub fn din7_mode(&mut self) -> DIN_MODE_W<'_, DIN_MODE_SPEC> {
        DIN_MODE_W::new(self, 21)
    }
    #[doc = "Bits 24:26"]
    #[inline(always)]
    pub fn dins_mode(&mut self) -> DINS_MODE_W<'_, DIN_MODE_SPEC> {
