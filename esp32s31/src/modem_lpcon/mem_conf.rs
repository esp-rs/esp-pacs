...
#[doc = "Field `CFR_MEM_MODE` reader - "]
pub type CFR_MEM_MODE_R = crate::FieldReader;
#[doc = "Field `CFR_MEM_MODE` writer - "]
pub type CFR_MEM_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `CFR_MEM_FORCE` reader - "]
pub type CFR_MEM_FORCE_R = crate::BitReader;
#[doc = "Field `CFR_MEM_FORCE` writer - "]
pub type CFR_MEM_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:2"]
    #[inline(always)]
    ...
    #[doc = "Bits 24:26"]
    #[inline(always)]
    pub fn cfr_mem_mode(&self) -> CFR_MEM_MODE_R {
        CFR_MEM_MODE_R::new(((self.bits >> 24) & 7) as u8)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn cfr_mem_force(&self) -> CFR_MEM_FORCE_R {
        CFR_MEM_FORCE_R::new(((self.bits >> 27) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MEM_CONF")
            ...
            .field("cfr_mem_mode", &self.cfr_mem_mode())
            .field("cfr_mem_force", &self.cfr_mem_force())
            .finish()
    }
}
impl W {
    ...
    #[doc = "Bits 24:26"]
    #[inline(always)]
    pub fn cfr_mem_mode(&mut self) -> CFR_MEM_MODE_W<'_, MEM_CONF_SPEC> {
        CFR_MEM_MODE_W::new(self, 24)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn cfr_mem_force(&mut self) -> CFR_MEM_FORCE_W<'_, MEM_CONF_SPEC> {
        CFR_MEM_FORCE_W::new(self, 27)
    }
}
...
#[doc = "`reset()` method sets MEM_CONF to value 0x0888_8888"]
impl crate::Resettable for MEM_CONF_SPEC {
    const RESET_VALUE: u32 = 0x0888_8888;
}
