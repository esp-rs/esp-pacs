...
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn modem_pwr_tick_target(&self) -> MODEM_PWR_TICK_TARGET_R {
        MODEM_PWR_TICK_TARGET_R::new((self.bits & 0x3f) as u8)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TICK_CONF")
            .field("modem_pwr_tick_target", &self.modem_pwr_tick_target())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn modem_pwr_tick_target(&mut self) -> MODEM_PWR_TICK_TARGET_W<'_, TICK_CONF_SPEC> {
        MODEM_PWR_TICK_TARGET_W::new(self, 0)
    }
}
