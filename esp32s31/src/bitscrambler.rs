...
pub struct RegisterBlock {
    ...
    tx_state: TX_STATE,
    rx_state: RX_STATE,
    tx_cnt_cfg: TX_CNT_CFG,
    rx_cnt_cfg: RX_CNT_CFG,
    tx_cnt_state: TX_CNT_STATE,
    rx_cnt_state: RX_CNT_STATE,
    _reserved18: [u8; 0xb0],
    sys: SYS,
    version: VERSION,
}
impl RegisterBlock {
    ...
    #[doc = "0x38 - TX Counter cfg registers"]
    #[inline(always)]
    pub const fn tx_cnt_cfg(&self) -> &TX_CNT_CFG {
        &self.tx_cnt_cfg
    }
    #[doc = "0x3c - RX Counter cfg registers"]
    #[inline(always)]
    pub const fn rx_cnt_cfg(&self) -> &RX_CNT_CFG {
        &self.rx_cnt_cfg
    }
    #[doc = "0x40 - TX Counter state registers"]
    #[inline(always)]
    pub const fn tx_cnt_state(&self) -> &TX_CNT_STATE {
        &self.tx_cnt_state
    }
    #[doc = "0x44 - RX Counter state registers"]
    #[inline(always)]
    pub const fn rx_cnt_state(&self) -> &RX_CNT_STATE {
        &self.rx_cnt_state
    }
...
#[doc = "Status registers"]
pub mod rx_state;
#[doc = "TX_CNT_CFG (rw) register accessor: TX Counter cfg registers\n\nYou can [`read`](crate::Reg::read) this register and get [`tx_cnt_cfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tx_cnt_cfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tx_cnt_cfg`] module"]
pub type TX_CNT_CFG = crate::Reg<tx_cnt_cfg::TX_CNT_CFG_SPEC>;
#[doc = "TX Counter cfg registers"]
pub mod tx_cnt_cfg;
#[doc = "RX_CNT_CFG (rw) register accessor: RX Counter cfg registers\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_cnt_cfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_cnt_cfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rx_cnt_cfg`] module"]
pub type RX_CNT_CFG = crate::Reg<rx_cnt_cfg::RX_CNT_CFG_SPEC>;
#[doc = "RX Counter cfg registers"]
pub mod rx_cnt_cfg;
#[doc = "TX_CNT_STATE (r) register accessor: TX Counter state registers\n\nYou can [`read`](crate::Reg::read) this register and get [`tx_cnt_state::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tx_cnt_state`] module"]
pub type TX_CNT_STATE = crate::Reg<tx_cnt_state::TX_CNT_STATE_SPEC>;
#[doc = "TX Counter state registers"]
pub mod tx_cnt_state;
#[doc = "RX_CNT_STATE (r) register accessor: RX Counter state registers\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_cnt_state::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rx_cnt_state`] module"]
pub type RX_CNT_STATE = crate::Reg<rx_cnt_state::RX_CNT_STATE_SPEC>;
#[doc = "RX Counter state registers"]
pub mod rx_cnt_state;
