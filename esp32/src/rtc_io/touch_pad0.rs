///Register `TOUCH_PAD0` reader
pub type R = crate::R<TOUCH_PAD0_SPEC>;
///Register `TOUCH_PAD0` writer
pub type W = crate::W<TOUCH_PAD0_SPEC>;
///Field `TO_GPIO` reader - connect the rtc pad input to digital pad input Ó0Ó is availbale GPIO4
pub type TO_GPIO_R = crate::BitReader;
///Field `TO_GPIO` writer - connect the rtc pad input to digital pad input Ó0Ó is availbale GPIO4
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn to_gpio(&mut self) -> TO_GPIO_W<TOUCH_PAD0_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac(&mut self) -> DAC_W<TOUCH_PAD0_SPEC> {
        DAC_W::new(self, 23)
    }
    ///Bit 27 - the pull up enable of the pad
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HOLD_W<TOUCH_PAD0_SPEC> {
        HOLD_W::new(self, 31)
    }
}
/**
...
///`read()` method returns [`touch_pad0::R`](R) reader structure
impl crate::Readable for TOUCH_PAD0_SPEC {}
///`write(|w| ..)` method takes [`touch_pad0::W`](W) writer structure
impl crate::Writable for TOUCH_PAD0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_PAD0 to value 0x5200_0000
