///Register `XTAL_32K_PAD` reader
pub type R = crate::R<XTAL_32K_PAD_SPEC>;
///Register `XTAL_32K_PAD` writer
pub type W = crate::W<XTAL_32K_PAD_SPEC>;
///Field `DBIAS_XTAL_32K` reader - 32K XTAL self-bias reference control.
pub type DBIAS_XTAL_32K_R = crate::FieldReader;
///Field `DBIAS_XTAL_32K` writer - 32K XTAL self-bias reference control.
pub type DBIAS_XTAL_32K_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DRES_XTAL_32K` reader - 32K XTAL resistor bias control.
pub type DRES_XTAL_32K_R = crate::FieldReader;
///Field `DRES_XTAL_32K` writer - 32K XTAL resistor bias control.
pub type DRES_XTAL_32K_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `X32P_FUN_IE` reader - the input enable of the pad
pub type X32P_FUN_IE_R = crate::BitReader;
///Field `X32P_FUN_IE` writer - the input enable of the pad
pub type X32P_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32P_SLP_OE` reader - the output enable of the pad in sleep status
pub type X32P_SLP_OE_R = crate::BitReader;
///Field `X32P_SLP_OE` writer - the output enable of the pad in sleep status
pub type X32P_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32P_SLP_IE` reader - the input enable of the pad in sleep status
pub type X32P_SLP_IE_R = crate::BitReader;
///Field `X32P_SLP_IE` writer - the input enable of the pad in sleep status
pub type X32P_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32P_SLP_SEL` reader - the sleep status selection signal of the pad
pub type X32P_SLP_SEL_R = crate::BitReader;
///Field `X32P_SLP_SEL` writer - the sleep status selection signal of the pad
pub type X32P_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32P_FUN_SEL` reader - the functional selection signal of the pad
pub type X32P_FUN_SEL_R = crate::FieldReader;
///Field `X32P_FUN_SEL` writer - the functional selection signal of the pad
pub type X32P_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `X32N_FUN_IE` reader - the input enable of the pad
pub type X32N_FUN_IE_R = crate::BitReader;
///Field `X32N_FUN_IE` writer - the input enable of the pad
pub type X32N_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32N_SLP_OE` reader - the output enable of the pad in sleep status
pub type X32N_SLP_OE_R = crate::BitReader;
///Field `X32N_SLP_OE` writer - the output enable of the pad in sleep status
pub type X32N_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32N_SLP_IE` reader - the input enable of the pad in sleep status
pub type X32N_SLP_IE_R = crate::BitReader;
///Field `X32N_SLP_IE` writer - the input enable of the pad in sleep status
pub type X32N_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32N_SLP_SEL` reader - the sleep status selection signal of the pad
pub type X32N_SLP_SEL_R = crate::BitReader;
///Field `X32N_SLP_SEL` writer - the sleep status selection signal of the pad
pub type X32N_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32N_FUN_SEL` reader - the functional selection signal of the pad
pub type X32N_FUN_SEL_R = crate::FieldReader;
///Field `X32N_FUN_SEL` writer - the functional selection signal of the pad
pub type X32N_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `X32P_MUX_SEL` reader - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type X32P_MUX_SEL_R = crate::BitReader;
///Field `X32P_MUX_SEL` writer - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type X32P_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32N_MUX_SEL` reader - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type X32N_MUX_SEL_R = crate::BitReader;
///Field `X32N_MUX_SEL` writer - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type X32N_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `XPD_XTAL_32K` reader - Power up 32kHz crystal oscillator
pub type XPD_XTAL_32K_R = crate::BitReader;
///Field `XPD_XTAL_32K` writer - Power up 32kHz crystal oscillator
pub type XPD_XTAL_32K_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DAC_XTAL_32K` reader - 32K XTAL bias current DAC.
pub type DAC_XTAL_32K_R = crate::FieldReader;
///Field `DAC_XTAL_32K` writer - 32K XTAL bias current DAC.
pub type DAC_XTAL_32K_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `X32P_RUE` reader - the pull up enable of the pad
pub type X32P_RUE_R = crate::BitReader;
///Field `X32P_RUE` writer - the pull up enable of the pad
pub type X32P_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32P_RDE` reader - the pull down enable of the pad
pub type X32P_RDE_R = crate::BitReader;
///Field `X32P_RDE` writer - the pull down enable of the pad
pub type X32P_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32P_HOLD` reader - hold the current value of the output when setting the hold to Ò1Ó
pub type X32P_HOLD_R = crate::BitReader;
///Field `X32P_HOLD` writer - hold the current value of the output when setting the hold to Ò1Ó
pub type X32P_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32P_DRV` reader - the driver strength of the pad
pub type X32P_DRV_R = crate::FieldReader;
///Field `X32P_DRV` writer - the driver strength of the pad
pub type X32P_DRV_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `X32N_RUE` reader - the pull up enable of the pad
pub type X32N_RUE_R = crate::BitReader;
///Field `X32N_RUE` writer - the pull up enable of the pad
pub type X32N_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32N_RDE` reader - the pull down enable of the pad
pub type X32N_RDE_R = crate::BitReader;
///Field `X32N_RDE` writer - the pull down enable of the pad
pub type X32N_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32N_HOLD` reader - hold the current value of the output when setting the hold to Ò1Ó
pub type X32N_HOLD_R = crate::BitReader;
///Field `X32N_HOLD` writer - hold the current value of the output when setting the hold to Ò1Ó
pub type X32N_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32N_DRV` reader - the driver strength of the pad
pub type X32N_DRV_R = crate::FieldReader;
///Field `X32N_DRV` writer - the driver strength of the pad
...
///`read()` method returns [`xtal_32k_pad::R`](R) reader structure
impl crate::Readable for XTAL_32K_PAD_SPEC {}
///`write(|w| ..)` method takes [`xtal_32k_pad::W`](W) writer structure
impl crate::Writable for XTAL_32K_PAD_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets XTAL_32K_PAD to value 0x8410_0010
