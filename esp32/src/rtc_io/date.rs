...
#[doc = "Field `IO_DATE` reader - date"]
pub type IO_DATE_R = crate::FieldReader<u32>;
#[doc = "Field `IO_DATE` writer - date"]
pub type IO_DATE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 28, O, u32>;
impl R {
    #[doc = "Bits 0:27 - date"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn io_date(&mut self) -> IO_DATE_W<DATE_SPEC, 0> {
        IO_DATE_W::new(self)
    }
...
#[doc = "`reset()` method sets DATE to value 0x0160_3160"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0160_3160;
}
