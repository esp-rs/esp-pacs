...
pub type TO_GPIO_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD7_SPEC, bool, O>;
...
pub type DAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TOUCH_PAD7_SPEC, u8, u8, 3, O>;
...
pub type HOLD_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD7_SPEC, bool, O>;
impl R {
