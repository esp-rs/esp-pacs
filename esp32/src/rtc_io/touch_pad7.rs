///Register `TOUCH_PAD7` reader
pub type R = crate::R<TOUCH_PAD7_SPEC>;
///Register `TOUCH_PAD7` writer
pub type W = crate::W<TOUCH_PAD7_SPEC>;
///Field `TO_GPIO` reader - connect the rtc pad input to digital pad input Ó0Ó is availbale.GPIO27
pub type TO_GPIO_R = crate::BitReader;
///Field `TO_GPIO` writer - connect the rtc pad input to digital pad input Ó0Ó is availbale.GPIO27
...
///`read()` method returns [`touch_pad7::R`](R) reader structure
impl crate::Readable for TOUCH_PAD7_SPEC {}
///`write(|w| ..)` method takes [`touch_pad7::W`](W) writer structure
impl crate::Writable for TOUCH_PAD7_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_PAD7 to value 0x4200_0000
