...
#[doc = "Field `TO_GPIO` reader - connect the rtc pad input to digital pad input"]
pub type TO_GPIO_R = crate::BitReader;
#[doc = "Field `TO_GPIO` writer - connect the rtc pad input to digital pad input"]
...
#[doc = "Field `MUX_SEL` reader - 1 select the digital function, 0 selects the rtc function"]
pub type MUX_SEL_R = crate::BitReader;
#[doc = "Field `MUX_SEL` writer - 1 select the digital function, 0 selects the rtc function"]
...
#[doc = "Field `HOLD` reader - hold the current value of the output when setting the hold to 1"]
pub type HOLD_R = crate::BitReader;
#[doc = "Field `HOLD` writer - hold the current value of the output when setting the hold to 1"]
pub type HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 12 - connect the rtc pad input to digital pad input"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - 1 select the digital function, 0 selects the rtc function"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - hold the current value of the output when setting the hold to 1"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn to_gpio(&mut self) -> TO_GPIO_W<TOUCH_PAD_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HOLD_W<TOUCH_PAD_SPEC> {
        HOLD_W::new(self, 31)
    }
}
