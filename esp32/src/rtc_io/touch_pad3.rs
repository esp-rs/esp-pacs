///Register `TOUCH_PAD3` reader
pub type R = crate::R<TOUCH_PAD3_SPEC>;
///Register `TOUCH_PAD3` writer
pub type W = crate::W<TOUCH_PAD3_SPEC>;
///Field `TO_GPIO` reader - connect the rtc pad input to digital pad input Ó0Ó is availbale.MTDO
pub type TO_GPIO_R = crate::BitReader;
///Field `TO_GPIO` writer - connect the rtc pad input to digital pad input Ó0Ó is availbale.MTDO
...
///`read()` method returns [`touch_pad3::R`](R) reader structure
impl crate::Readable for TOUCH_PAD3_SPEC {}
///`write(|w| ..)` method takes [`touch_pad3::W`](W) writer structure
impl crate::Writable for TOUCH_PAD3_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_PAD3 to value 0x4a00_0000
