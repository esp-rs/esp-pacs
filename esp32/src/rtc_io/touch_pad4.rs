///Register `TOUCH_PAD4` reader
pub type R = crate::R<TOUCH_PAD4_SPEC>;
///Register `TOUCH_PAD4` writer
pub type W = crate::W<TOUCH_PAD4_SPEC>;
///Field `TO_GPIO` reader - connect the rtc pad input to digital pad input Ó0Ó is availbale.MTCK
pub type TO_GPIO_R = crate::BitReader;
///Field `TO_GPIO` writer - connect the rtc pad input to digital pad input Ó0Ó is availbale.MTCK
...
///`read()` method returns [`touch_pad4::R`](R) reader structure
impl crate::Readable for TOUCH_PAD4_SPEC {}
///`write(|w| ..)` method takes [`touch_pad4::W`](W) writer structure
impl crate::Writable for TOUCH_PAD4_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_PAD4 to value 0x5200_0000
