///Register `TOUCH_CFG` reader
pub type R = crate::R<TOUCH_CFG_SPEC>;
///Register `TOUCH_CFG` writer
pub type W = crate::W<TOUCH_CFG_SPEC>;
///Field `TOUCH_DCUR` reader - touch sensor bias current. Should have option to tie with BIAS_SLEEP(When BIAS_SLEEP this setting is available
pub type TOUCH_DCUR_R = crate::FieldReader;
///Field `TOUCH_DCUR` writer - touch sensor bias current. Should have option to tie with BIAS_SLEEP(When BIAS_SLEEP this setting is available
pub type TOUCH_DCUR_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_DRANGE` reader - touch sensor saw wave voltage range.
pub type TOUCH_DRANGE_R = crate::FieldReader;
///Field `TOUCH_DRANGE` writer - touch sensor saw wave voltage range.
pub type TOUCH_DRANGE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_DREFL` reader - touch sensor saw wave bottom voltage.
pub type TOUCH_DREFL_R = crate::FieldReader;
///Field `TOUCH_DREFL` writer - touch sensor saw wave bottom voltage.
pub type TOUCH_DREFL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_DREFH` reader - touch sensor saw wave top voltage.
pub type TOUCH_DREFH_R = crate::FieldReader;
///Field `TOUCH_DREFH` writer - touch sensor saw wave top voltage.
pub type TOUCH_DREFH_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `TOUCH_XPD_BIAS` reader - touch sensor bias power on.
pub type TOUCH_XPD_BIAS_R = crate::BitReader;
///Field `TOUCH_XPD_BIAS` writer - touch sensor bias power on.
...
///`read()` method returns [`touch_cfg::R`](R) reader structure
impl crate::Readable for TOUCH_CFG_SPEC {}
///`write(|w| ..)` method takes [`touch_cfg::W`](W) writer structure
impl crate::Writable for TOUCH_CFG_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_CFG to value 0x6600_0000
