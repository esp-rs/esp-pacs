...
///Field `PDAC2_DAC_XPD_FORCE` reader - Power on DAC2. Usually we need to tristate PDAC2 if we power on the DAC i.e. IE=0 OE=0 RDE=0 RUE=0
pub type PDAC2_DAC_XPD_FORCE_R = crate::BitReader;
///Field `PDAC2_DAC_XPD_FORCE` writer - Power on DAC2. Usually we need to tristate PDAC2 if we power on the DAC i.e. IE=0 OE=0 RDE=0 RUE=0
pub type PDAC2_DAC_XPD_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_FUN_IE` reader - the input enable of the pad
pub type PDAC2_FUN_IE_R = crate::BitReader;
///Field `PDAC2_FUN_IE` writer - the input enable of the pad
pub type PDAC2_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_SLP_OE` reader - the output enable of the pad in sleep status
pub type PDAC2_SLP_OE_R = crate::BitReader;
///Field `PDAC2_SLP_OE` writer - the output enable of the pad in sleep status
pub type PDAC2_SLP_OE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_SLP_IE` reader - the input enable of the pad in sleep status
pub type PDAC2_SLP_IE_R = crate::BitReader;
///Field `PDAC2_SLP_IE` writer - the input enable of the pad in sleep status
pub type PDAC2_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_SLP_SEL` reader - the sleep status selection signal of the pad
pub type PDAC2_SLP_SEL_R = crate::BitReader;
///Field `PDAC2_SLP_SEL` writer - the sleep status selection signal of the pad
pub type PDAC2_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_FUN_SEL` reader - the functional selection signal of the pad
pub type PDAC2_FUN_SEL_R = crate::FieldReader;
///Field `PDAC2_FUN_SEL` writer - the functional selection signal of the pad
pub type PDAC2_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `PDAC2_MUX_SEL` reader - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type PDAC2_MUX_SEL_R = crate::BitReader;
///Field `PDAC2_MUX_SEL` writer - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type PDAC2_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_XPD_DAC` reader - Power on DAC2. Usually we need to tristate PDAC1 if we power on the DAC i.e. IE=0 OE=0 RDE=0 RUE=0
pub type PDAC2_XPD_DAC_R = crate::BitReader;
///Field `PDAC2_XPD_DAC` writer - Power on DAC2. Usually we need to tristate PDAC1 if we power on the DAC i.e. IE=0 OE=0 RDE=0 RUE=0
pub type PDAC2_XPD_DAC_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_DAC` reader - PAD DAC2 control code.
pub type PDAC2_DAC_R = crate::FieldReader;
///Field `PDAC2_DAC` writer - PAD DAC2 control code.
pub type PDAC2_DAC_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `PDAC2_RUE` reader - the pull up enable of the pad
pub type PDAC2_RUE_R = crate::BitReader;
///Field `PDAC2_RUE` writer - the pull up enable of the pad
pub type PDAC2_RUE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_RDE` reader - the pull down enable of the pad
pub type PDAC2_RDE_R = crate::BitReader;
///Field `PDAC2_RDE` writer - the pull down enable of the pad
pub type PDAC2_RDE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_HOLD` reader - hold the current value of the output when setting the hold to Ò1Ó
pub type PDAC2_HOLD_R = crate::BitReader;
///Field `PDAC2_HOLD` writer - hold the current value of the output when setting the hold to Ò1Ó
pub type PDAC2_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PDAC2_DRV` reader - the driver strength of the pad
pub type PDAC2_DRV_R = crate::FieldReader;
///Field `PDAC2_DRV` writer - the driver strength of the pad
...
///`reset()` method sets PAD_DAC2 to value 0x8000_0000
