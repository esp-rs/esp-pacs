///Register `TOUCH_PAD5` reader
pub type R = crate::R<TOUCH_PAD5_SPEC>;
///Register `TOUCH_PAD5` writer
pub type W = crate::W<TOUCH_PAD5_SPEC>;
///Field `TO_GPIO` reader - connect the rtc pad input to digital pad input Ó0Ó is availbale.MTDI
pub type TO_GPIO_R = crate::BitReader;
///Field `TO_GPIO` writer - connect the rtc pad input to digital pad input Ó0Ó is availbale.MTDI
...
impl R {
    ///Bit 12 - connect the rtc pad input to digital pad input Ó0Ó is availbale.MTDI
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn to_gpio(&mut self) -> TO_GPIO_W<TOUCH_PAD5_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac(&mut self) -> DAC_W<TOUCH_PAD5_SPEC> {
        DAC_W::new(self, 23)
    }
    ///Bit 27 - the pull up enable of the pad
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn hold(&mut self) -> HOLD_W<TOUCH_PAD5_SPEC> {
        HOLD_W::new(self, 31)
    }
}
/**
...
///`read()` method returns [`touch_pad5::R`](R) reader structure
impl crate::Readable for TOUCH_PAD5_SPEC {}
///`write(|w| ..)` method takes [`touch_pad5::W`](W) writer structure
impl crate::Writable for TOUCH_PAD5_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TOUCH_PAD5 to value 0x5200_0000
