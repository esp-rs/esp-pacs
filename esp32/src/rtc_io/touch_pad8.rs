...
///Field `TO_GPIO` reader - connect the rtc pad input to digital pad input Ó0Ó is availbale
pub type TO_GPIO_R = crate::BitReader;
///Field `TO_GPIO` writer - connect the rtc pad input to digital pad input Ó0Ó is availbale
...
///`reset()` method sets TOUCH_PAD8 to value 0x0200_0000
