...
///Field `TO_GPIO` reader - connect the rtc pad input to digital pad input Ó0Ó is availbale.GPIO0
pub type TO_GPIO_R = crate::BitReader;
///Field `TO_GPIO` writer - connect the rtc pad input to digital pad input Ó0Ó is availbale.GPIO0
...
impl R {
    ///Bit 12 - connect the rtc pad input to digital pad input Ó0Ó is availbale.GPIO0
    #[inline(always)]
...
///`reset()` method sets TOUCH_PAD1 to value 0x4a00_0000
