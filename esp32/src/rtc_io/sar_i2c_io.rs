...
///Field `SAR_I2C_SCL_SEL` reader - Ò0Ó using TOUCH_PAD\[0\] as i2c clk Ò1Ó using TOUCH_PAD\[2\] as i2c clk
pub type SAR_I2C_SCL_SEL_R = crate::FieldReader;
///Field `SAR_I2C_SCL_SEL` writer - Ò0Ó using TOUCH_PAD\[0\] as i2c clk Ò1Ó using TOUCH_PAD\[2\] as i2c clk
pub type SAR_I2C_SCL_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SAR_I2C_SDA_SEL` reader - Ò0Ó using TOUCH_PAD\[1\] as i2c sda Ò1Ó using TOUCH_PAD\[3\] as i2c sda
pub type SAR_I2C_SDA_SEL_R = crate::FieldReader;
///Field `SAR_I2C_SDA_SEL` writer - Ò0Ó using TOUCH_PAD\[1\] as i2c sda Ò1Ó using TOUCH_PAD\[3\] as i2c sda
