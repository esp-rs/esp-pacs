...
///Field `SENSE4_FUN_IE` reader - the input enable of the pad
pub type SENSE4_FUN_IE_R = crate::BitReader;
///Field `SENSE4_FUN_IE` writer - the input enable of the pad
pub type SENSE4_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE4_SLP_IE` reader - the input enable of the pad in sleep status
pub type SENSE4_SLP_IE_R = crate::BitReader;
///Field `SENSE4_SLP_IE` writer - the input enable of the pad in sleep status
pub type SENSE4_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE4_SLP_SEL` reader - the sleep status selection signal of the pad
pub type SENSE4_SLP_SEL_R = crate::BitReader;
///Field `SENSE4_SLP_SEL` writer - the sleep status selection signal of the pad
pub type SENSE4_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE4_FUN_SEL` reader - the functional selection signal of the pad
pub type SENSE4_FUN_SEL_R = crate::FieldReader;
///Field `SENSE4_FUN_SEL` writer - the functional selection signal of the pad
pub type SENSE4_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SENSE3_FUN_IE` reader - the input enable of the pad
pub type SENSE3_FUN_IE_R = crate::BitReader;
///Field `SENSE3_FUN_IE` writer - the input enable of the pad
pub type SENSE3_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE3_SLP_IE` reader - the input enable of the pad in sleep status
pub type SENSE3_SLP_IE_R = crate::BitReader;
///Field `SENSE3_SLP_IE` writer - the input enable of the pad in sleep status
pub type SENSE3_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE3_SLP_SEL` reader - the sleep status selection signal of the pad
pub type SENSE3_SLP_SEL_R = crate::BitReader;
///Field `SENSE3_SLP_SEL` writer - the sleep status selection signal of the pad
pub type SENSE3_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE3_FUN_SEL` reader - the functional selection signal of the pad
pub type SENSE3_FUN_SEL_R = crate::FieldReader;
///Field `SENSE3_FUN_SEL` writer - the functional selection signal of the pad
pub type SENSE3_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SENSE2_FUN_IE` reader - the input enable of the pad
pub type SENSE2_FUN_IE_R = crate::BitReader;
///Field `SENSE2_FUN_IE` writer - the input enable of the pad
pub type SENSE2_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE2_SLP_IE` reader - the input enable of the pad in sleep status
pub type SENSE2_SLP_IE_R = crate::BitReader;
///Field `SENSE2_SLP_IE` writer - the input enable of the pad in sleep status
pub type SENSE2_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE2_SLP_SEL` reader - the sleep status selection signal of the pad
pub type SENSE2_SLP_SEL_R = crate::BitReader;
///Field `SENSE2_SLP_SEL` writer - the sleep status selection signal of the pad
pub type SENSE2_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE2_FUN_SEL` reader - the functional selection signal of the pad
pub type SENSE2_FUN_SEL_R = crate::FieldReader;
///Field `SENSE2_FUN_SEL` writer - the functional selection signal of the pad
pub type SENSE2_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SENSE1_FUN_IE` reader - the input enable of the pad
pub type SENSE1_FUN_IE_R = crate::BitReader;
///Field `SENSE1_FUN_IE` writer - the input enable of the pad
pub type SENSE1_FUN_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE1_SLP_IE` reader - the input enable of the pad in sleep status
pub type SENSE1_SLP_IE_R = crate::BitReader;
///Field `SENSE1_SLP_IE` writer - the input enable of the pad in sleep status
pub type SENSE1_SLP_IE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE1_SLP_SEL` reader - the sleep status selection signal of the pad
pub type SENSE1_SLP_SEL_R = crate::BitReader;
///Field `SENSE1_SLP_SEL` writer - the sleep status selection signal of the pad
pub type SENSE1_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE1_FUN_SEL` reader - the functional selection signal of the pad
pub type SENSE1_FUN_SEL_R = crate::FieldReader;
///Field `SENSE1_FUN_SEL` writer - the functional selection signal of the pad
pub type SENSE1_FUN_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SENSE4_MUX_SEL` reader - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type SENSE4_MUX_SEL_R = crate::BitReader;
///Field `SENSE4_MUX_SEL` writer - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type SENSE4_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE3_MUX_SEL` reader - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type SENSE3_MUX_SEL_R = crate::BitReader;
///Field `SENSE3_MUX_SEL` writer - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type SENSE3_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE2_MUX_SEL` reader - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type SENSE2_MUX_SEL_R = crate::BitReader;
///Field `SENSE2_MUX_SEL` writer - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type SENSE2_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE1_MUX_SEL` reader - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type SENSE1_MUX_SEL_R = crate::BitReader;
///Field `SENSE1_MUX_SEL` writer - Ò1Ó select the digital function Ó0Óslection the rtc function
pub type SENSE1_MUX_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE4_HOLD` reader - hold the current value of the output when setting the hold to Ò1Ó
pub type SENSE4_HOLD_R = crate::BitReader;
///Field `SENSE4_HOLD` writer - hold the current value of the output when setting the hold to Ò1Ó
pub type SENSE4_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE3_HOLD` reader - hold the current value of the output when setting the hold to Ò1Ó
pub type SENSE3_HOLD_R = crate::BitReader;
///Field `SENSE3_HOLD` writer - hold the current value of the output when setting the hold to Ò1Ó
pub type SENSE3_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE2_HOLD` reader - hold the current value of the output when setting the hold to Ò1Ó
pub type SENSE2_HOLD_R = crate::BitReader;
///Field `SENSE2_HOLD` writer - hold the current value of the output when setting the hold to Ò1Ó
pub type SENSE2_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SENSE1_HOLD` reader - hold the current value of the output when setting the hold to Ò1Ó
pub type SENSE1_HOLD_R = crate::BitReader;
///Field `SENSE1_HOLD` writer - hold the current value of the output when setting the hold to Ò1Ó
...
///`read()` method returns [`sensor_pads::R`](R) reader structure
impl crate::Readable for SENSOR_PADS_SPEC {}
///`write(|w| ..)` method takes [`sensor_pads::W`](W) writer structure
