...
///Field `DIG_PAD_HOLD` reader - select the digital pad hold value.
pub type DIG_PAD_HOLD_R = crate::FieldReader<u32>;
///Field `DIG_PAD_HOLD` writer - select the digital pad hold value.
pub type DIG_PAD_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - select the digital pad hold value.
    #[inline(always)]
