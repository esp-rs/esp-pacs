#[doc = "Register `TOUCH_PAD2` reader"]
pub struct R(crate::R<TOUCH_PAD2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TOUCH_PAD2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TOUCH_PAD2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TOUCH_PAD2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TOUCH_PAD2` writer"]
pub struct W(crate::W<TOUCH_PAD2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TOUCH_PAD2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TOUCH_PAD2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TOUCH_PAD2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TO_GPIO_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
...
pub type FUN_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
...
pub type SLP_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
...
pub type SLP_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
...
pub type SLP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
...
pub type FUN_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TOUCH_PAD2_SPEC, u8, u8, 2, O>;
...
pub type MUX_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
#[doc = "Field `XPD` reader - touch sensor power on."]
pub type XPD_R = crate::BitReader<bool>;
#[doc = "Field `XPD` writer - touch sensor power on."]
pub type XPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
...
pub type TIE_OPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
#[doc = "Field `START` reader - start touch sensor."]
pub type START_R = crate::BitReader<bool>;
#[doc = "Field `START` writer - start touch sensor."]
pub type START_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
...
pub type DAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TOUCH_PAD2_SPEC, u8, u8, 3, O>;
...
pub type RUE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
...
pub type RDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
...
pub type DRV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TOUCH_PAD2_SPEC, u8, u8, 2, O>;
...
pub type HOLD_W<'a, const O: u8> = crate::BitWriter<'a, u32, TOUCH_PAD2_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets TOUCH_PAD2 to value 0x5200_0000"]
impl crate::Resettable for TOUCH_PAD2_SPEC {
