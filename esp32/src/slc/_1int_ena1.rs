...
pub type FRHOST_BIT8_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FRHOST_BIT9_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FRHOST_BIT10_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FRHOST_BIT11_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FRHOST_BIT12_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FRHOST_BIT13_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FRHOST_BIT14_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FRHOST_BIT15_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_RX_START_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TX_START_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TX_DONE_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TX_SUC_EOF_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_RX_DONE_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_RX_EOF_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TOHOST_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TX_DSCR_ERR_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_RX_DSCR_ERR_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TX_DSCR_EMPTY_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_HOST_RD_ACK_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_WR_RETRY_DONE_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLC1_TX_ERR_EOF_INT_ENA1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit8_int_ena1(&mut self) -> FRHOST_BIT8_INT_ENA1_W<_1INT_ENA1_SPEC, 0> {
        FRHOST_BIT8_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit9_int_ena1(&mut self) -> FRHOST_BIT9_INT_ENA1_W<_1INT_ENA1_SPEC, 1> {
        FRHOST_BIT9_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit10_int_ena1(&mut self) -> FRHOST_BIT10_INT_ENA1_W<_1INT_ENA1_SPEC, 2> {
        FRHOST_BIT10_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit11_int_ena1(&mut self) -> FRHOST_BIT11_INT_ENA1_W<_1INT_ENA1_SPEC, 3> {
        FRHOST_BIT11_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit12_int_ena1(&mut self) -> FRHOST_BIT12_INT_ENA1_W<_1INT_ENA1_SPEC, 4> {
        FRHOST_BIT12_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit13_int_ena1(&mut self) -> FRHOST_BIT13_INT_ENA1_W<_1INT_ENA1_SPEC, 5> {
        FRHOST_BIT13_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit14_int_ena1(&mut self) -> FRHOST_BIT14_INT_ENA1_W<_1INT_ENA1_SPEC, 6> {
        FRHOST_BIT14_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit15_int_ena1(&mut self) -> FRHOST_BIT15_INT_ENA1_W<_1INT_ENA1_SPEC, 7> {
        FRHOST_BIT15_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_rx_start_int_ena1(&mut self) -> SLC1_RX_START_INT_ENA1_W<_1INT_ENA1_SPEC, 8> {
        SLC1_RX_START_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_tx_start_int_ena1(&mut self) -> SLC1_TX_START_INT_ENA1_W<_1INT_ENA1_SPEC, 9> {
        SLC1_TX_START_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_rx_udf_int_ena1(&mut self) -> SLC1_RX_UDF_INT_ENA1_W<_1INT_ENA1_SPEC, 10> {
        SLC1_RX_UDF_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_tx_ovf_int_ena1(&mut self) -> SLC1_TX_OVF_INT_ENA1_W<_1INT_ENA1_SPEC, 11> {
    ...
    pub fn slc1_token0_1to0_int_ena1(
        &mut self,
    ) -> SLC1_TOKEN0_1TO0_INT_ENA1_W<_1INT_ENA1_SPEC, 12> {
    ...
    pub fn slc1_token1_1to0_int_ena1(
        &mut self,
    ) -> SLC1_TOKEN1_1TO0_INT_ENA1_W<_1INT_ENA1_SPEC, 13> {
        SLC1_TOKEN1_1TO0_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_tx_done_int_ena1(&mut self) -> SLC1_TX_DONE_INT_ENA1_W<_1INT_ENA1_SPEC, 14> {
        SLC1_TX_DONE_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_tx_suc_eof_int_ena1(&mut self) -> SLC1_TX_SUC_EOF_INT_ENA1_W<_1INT_ENA1_SPEC, 15> {
        SLC1_TX_SUC_EOF_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_rx_done_int_ena1(&mut self) -> SLC1_RX_DONE_INT_ENA1_W<_1INT_ENA1_SPEC, 16> {
        SLC1_RX_DONE_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_rx_eof_int_ena1(&mut self) -> SLC1_RX_EOF_INT_ENA1_W<_1INT_ENA1_SPEC, 17> {
        SLC1_RX_EOF_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_tohost_int_ena1(&mut self) -> SLC1_TOHOST_INT_ENA1_W<_1INT_ENA1_SPEC, 18> {
    ...
    pub fn slc1_tx_dscr_err_int_ena1(
        &mut self,
    ) -> SLC1_TX_DSCR_ERR_INT_ENA1_W<_1INT_ENA1_SPEC, 19> {
    ...
    pub fn slc1_rx_dscr_err_int_ena1(
        &mut self,
    ) -> SLC1_RX_DSCR_ERR_INT_ENA1_W<_1INT_ENA1_SPEC, 20> {
    ...
    pub fn slc1_tx_dscr_empty_int_ena1(
        &mut self,
    ) -> SLC1_TX_DSCR_EMPTY_INT_ENA1_W<_1INT_ENA1_SPEC, 21> {
    ...
    pub fn slc1_host_rd_ack_int_ena1(
        &mut self,
    ) -> SLC1_HOST_RD_ACK_INT_ENA1_W<_1INT_ENA1_SPEC, 22> {
    ...
    pub fn slc1_wr_retry_done_int_ena1(
        &mut self,
    ) -> SLC1_WR_RETRY_DONE_INT_ENA1_W<_1INT_ENA1_SPEC, 23> {
        SLC1_WR_RETRY_DONE_INT_ENA1_W::new(self)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_tx_err_eof_int_ena1(&mut self) -> SLC1_TX_ERR_EOF_INT_ENA1_W<_1INT_ENA1_SPEC, 24> {
