///Register `_0INT_ST` reader
pub type R = crate::R<_0INT_ST_SPEC>;
///Field `FRHOST_BIT0_INT_ST` reader -
pub type FRHOST_BIT0_INT_ST_R = crate::BitReader;
///Field `FRHOST_BIT1_INT_ST` reader -
pub type FRHOST_BIT1_INT_ST_R = crate::BitReader;
///Field `FRHOST_BIT2_INT_ST` reader -
pub type FRHOST_BIT2_INT_ST_R = crate::BitReader;
///Field `FRHOST_BIT3_INT_ST` reader -
pub type FRHOST_BIT3_INT_ST_R = crate::BitReader;
///Field `FRHOST_BIT4_INT_ST` reader -
pub type FRHOST_BIT4_INT_ST_R = crate::BitReader;
///Field `FRHOST_BIT5_INT_ST` reader -
pub type FRHOST_BIT5_INT_ST_R = crate::BitReader;
///Field `FRHOST_BIT6_INT_ST` reader -
pub type FRHOST_BIT6_INT_ST_R = crate::BitReader;
///Field `FRHOST_BIT7_INT_ST` reader -
pub type FRHOST_BIT7_INT_ST_R = crate::BitReader;
///Field `SLC0_RX_START_INT_ST` reader -
pub type SLC0_RX_START_INT_ST_R = crate::BitReader;
///Field `SLC0_TX_START_INT_ST` reader -
pub type SLC0_TX_START_INT_ST_R = crate::BitReader;
///Field `SLC0_RX_UDF_INT_ST` reader -
pub type SLC0_RX_UDF_INT_ST_R = crate::BitReader;
///Field `SLC0_TX_OVF_INT_ST` reader -
pub type SLC0_TX_OVF_INT_ST_R = crate::BitReader;
///Field `SLC0_TOKEN0_1TO0_INT_ST` reader -
pub type SLC0_TOKEN0_1TO0_INT_ST_R = crate::BitReader;
///Field `SLC0_TOKEN1_1TO0_INT_ST` reader -
pub type SLC0_TOKEN1_1TO0_INT_ST_R = crate::BitReader;
///Field `SLC0_TX_DONE_INT_ST` reader -
pub type SLC0_TX_DONE_INT_ST_R = crate::BitReader;
///Field `SLC0_TX_SUC_EOF_INT_ST` reader -
pub type SLC0_TX_SUC_EOF_INT_ST_R = crate::BitReader;
///Field `SLC0_RX_DONE_INT_ST` reader -
pub type SLC0_RX_DONE_INT_ST_R = crate::BitReader;
///Field `SLC0_RX_EOF_INT_ST` reader -
pub type SLC0_RX_EOF_INT_ST_R = crate::BitReader;
///Field `SLC0_TOHOST_INT_ST` reader -
pub type SLC0_TOHOST_INT_ST_R = crate::BitReader;
///Field `SLC0_TX_DSCR_ERR_INT_ST` reader -
pub type SLC0_TX_DSCR_ERR_INT_ST_R = crate::BitReader;
///Field `SLC0_RX_DSCR_ERR_INT_ST` reader -
pub type SLC0_RX_DSCR_ERR_INT_ST_R = crate::BitReader;
///Field `SLC0_TX_DSCR_EMPTY_INT_ST` reader -
pub type SLC0_TX_DSCR_EMPTY_INT_ST_R = crate::BitReader;
///Field `SLC0_HOST_RD_ACK_INT_ST` reader -
pub type SLC0_HOST_RD_ACK_INT_ST_R = crate::BitReader;
///Field `SLC0_WR_RETRY_DONE_INT_ST` reader -
pub type SLC0_WR_RETRY_DONE_INT_ST_R = crate::BitReader;
///Field `SLC0_TX_ERR_EOF_INT_ST` reader -
pub type SLC0_TX_ERR_EOF_INT_ST_R = crate::BitReader;
///Field `CMD_DTC_INT_ST` reader -
pub type CMD_DTC_INT_ST_R = crate::BitReader;
///Field `SLC0_RX_QUICK_EOF_INT_ST` reader -
pub type SLC0_RX_QUICK_EOF_INT_ST_R = crate::BitReader;
impl R {
    ///Bit 0
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("_0INT_ST")
            .field("frhost_bit0_int_st", &self.frhost_bit0_int_st())
            .field("frhost_bit1_int_st", &self.frhost_bit1_int_st())
            .field("frhost_bit2_int_st", &self.frhost_bit2_int_st())
            .field("frhost_bit3_int_st", &self.frhost_bit3_int_st())
            .field("frhost_bit4_int_st", &self.frhost_bit4_int_st())
            .field("frhost_bit5_int_st", &self.frhost_bit5_int_st())
            .field("frhost_bit6_int_st", &self.frhost_bit6_int_st())
            .field("frhost_bit7_int_st", &self.frhost_bit7_int_st())
            .field("slc0_rx_start_int_st", &self.slc0_rx_start_int_st())
            .field("slc0_tx_start_int_st", &self.slc0_tx_start_int_st())
            ...
            .field("slc0_tx_done_int_st", &self.slc0_tx_done_int_st())
            .field("slc0_tx_suc_eof_int_st", &self.slc0_tx_suc_eof_int_st())
            .field("slc0_rx_done_int_st", &self.slc0_rx_done_int_st())
            .field("slc0_rx_eof_int_st", &self.slc0_rx_eof_int_st())
...
You can [`read`](crate::generic::Reg::read) this register and get [`_0int_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct _0INT_ST_SPEC;
impl crate::RegisterSpec for _0INT_ST_SPEC {
    type Ux = u32;
}
///`read()` method returns [`_0int_st::R`](R) reader structure
impl crate::Readable for _0INT_ST_SPEC {}
///`reset()` method sets _0INT_ST to value 0
