///Register `_0_TO_EOF_DES_ADDR` reader
pub type R = crate::R<_0_TO_EOF_DES_ADDR_SPEC>;
///Field `SLC0_TO_EOF_DES_ADDR` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`_0_to_eof_des_addr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct _0_TO_EOF_DES_ADDR_SPEC;
impl crate::RegisterSpec for _0_TO_EOF_DES_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`_0_to_eof_des_addr::R`](R) reader structure
impl crate::Readable for _0_TO_EOF_DES_ADDR_SPEC {}
///`reset()` method sets _0_TO_EOF_DES_ADDR to value 0
