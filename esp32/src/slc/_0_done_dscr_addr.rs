///Register `_0_DONE_DSCR_ADDR` reader
pub type R = crate::R<_0_DONE_DSCR_ADDR_SPEC>;
///Field `SLC0_RX_DONE_DSCR_ADDR` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`_0_done_dscr_addr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct _0_DONE_DSCR_ADDR_SPEC;
impl crate::RegisterSpec for _0_DONE_DSCR_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`_0_done_dscr_addr::R`](R) reader structure
impl crate::Readable for _0_DONE_DSCR_ADDR_SPEC {}
///`reset()` method sets _0_DONE_DSCR_ADDR to value 0
