...
pub struct R(crate::R<_0_DONE_DSCR_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<_0_DONE_DSCR_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<_0_DONE_DSCR_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<_0_DONE_DSCR_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `SLC0_RX_DONE_DSCR_ADDR` reader - "]
pub type SLC0_RX_DONE_DSCR_ADDR_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<_0_DONE_DSCR_ADDR_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [_0_done_dscr_addr](index.html) module"]
