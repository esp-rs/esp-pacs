...
///`read()` method returns [`sdio_crc_st1::R`](R) reader structure
impl crate::Readable for SDIO_CRC_ST1_SPEC {}
///`write(|w| ..)` method takes [`sdio_crc_st1::W`](W) writer structure
