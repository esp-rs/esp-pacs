///Register `_0_RXPKTU_H_DSCR` reader
pub type R = crate::R<_0_RXPKTU_H_DSCR_SPEC>;
///Field `SLC0_RX_PKT_START_DSCR_ADDR` reader -
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("_0_RXPKTU_H_DSCR")
            .field(
                ...
                &self.slc0_rx_pkt_start_dscr_addr(),
            )
            .finish()
    }
}
...
///`read()` method returns [`_0_rxpktu_h_dscr::R`](R) reader structure
impl crate::Readable for _0_RXPKTU_H_DSCR_SPEC {}
///`reset()` method sets _0_RXPKTU_H_DSCR to value 0
