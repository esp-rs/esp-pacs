///Register `_1_RXLINK_DSCR` reader
pub type R = crate::R<_1_RXLINK_DSCR_SPEC>;
///Field `SLC1_RXLINK_DSCR` reader -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("_1_RXLINK_DSCR")
            .field("slc1_rxlink_dscr", &self.slc1_rxlink_dscr())
            .finish()
    }
}
/**
...
///`read()` method returns [`_1_rxlink_dscr::R`](R) reader structure
impl crate::Readable for _1_RXLINK_DSCR_SPEC {}
///`reset()` method sets _1_RXLINK_DSCR to value 0
