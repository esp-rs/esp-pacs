///Register `_1_TX_ERREOF_DES_ADDR` reader
pub type R = crate::R<_1_TX_ERREOF_DES_ADDR_SPEC>;
///Field `SLC1_TX_ERR_EOF_DES_ADDR` reader -
...
///`read()` method returns [`_1_tx_erreof_des_addr::R`](R) reader structure
impl crate::Readable for _1_TX_ERREOF_DES_ADDR_SPEC {}
///`reset()` method sets _1_TX_ERREOF_DES_ADDR to value 0
