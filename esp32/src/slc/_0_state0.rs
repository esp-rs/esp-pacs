///Register `_0_STATE0` reader
pub type R = crate::R<_0_STATE0_SPEC>;
///Field `SLC0_STATE0` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`_0_state0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct _0_STATE0_SPEC;
impl crate::RegisterSpec for _0_STATE0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`_0_state0::R`](R) reader structure
impl crate::Readable for _0_STATE0_SPEC {}
///`reset()` method sets _0_STATE0 to value 0
