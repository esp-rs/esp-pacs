...
///`read()` method returns [`_1int_raw::R`](R) reader structure
impl crate::Readable for _1INT_RAW_SPEC {}
///`reset()` method sets _1INT_RAW to value 0
