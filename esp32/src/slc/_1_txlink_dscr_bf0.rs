///Register `_1_TXLINK_DSCR_BF0` reader
pub type R = crate::R<_1_TXLINK_DSCR_BF0_SPEC>;
///Field `SLC1_TXLINK_DSCR_BF0` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`_1_txlink_dscr_bf0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct _1_TXLINK_DSCR_BF0_SPEC;
impl crate::RegisterSpec for _1_TXLINK_DSCR_BF0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`_1_txlink_dscr_bf0::R`](R) reader structure
impl crate::Readable for _1_TXLINK_DSCR_BF0_SPEC {}
///`reset()` method sets _1_TXLINK_DSCR_BF0 to value 0
