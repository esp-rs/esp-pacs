...
pub type SLC1_TOKEN1_WDATA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
#[doc = "Field `SLC1_TOKEN1_WR` writer - "]
pub type SLC1_TOKEN1_WR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SLC1_TOKEN1_INC` writer - "]
pub type SLC1_TOKEN1_INC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SLC1_TOKEN1_INC_MORE` writer - "]
pub type SLC1_TOKEN1_INC_MORE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slc1_token1_wdata(&mut self) -> SLC1_TOKEN1_WDATA_W<_1TOKEN1_SPEC, 0> {
        SLC1_TOKEN1_WDATA_W::new(self)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_token1_wr(&mut self) -> SLC1_TOKEN1_WR_W<_1TOKEN1_SPEC, 12> {
        SLC1_TOKEN1_WR_W::new(self)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_token1_inc(&mut self) -> SLC1_TOKEN1_INC_W<_1TOKEN1_SPEC, 13> {
        SLC1_TOKEN1_INC_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn slc1_token1_inc_more(&mut self) -> SLC1_TOKEN1_INC_MORE_W<_1TOKEN1_SPEC, 14> {
