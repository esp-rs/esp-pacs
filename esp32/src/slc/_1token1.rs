...
///`read()` method returns [`_1token1::R`](R) reader structure
impl crate::Readable for _1TOKEN1_SPEC {}
///`write(|w| ..)` method takes [`_1token1::W`](W) writer structure
impl crate::Writable for _1TOKEN1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets _1TOKEN1 to value 0
