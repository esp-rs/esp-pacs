///Register `_0_TX_EOF_DES_ADDR` reader
pub type R = crate::R<_0_TX_EOF_DES_ADDR_SPEC>;
///Field `SLC0_TX_SUC_EOF_DES_ADDR` reader -
...
///`read()` method returns [`_0_tx_eof_des_addr::R`](R) reader structure
impl crate::Readable for _0_TX_EOF_DES_ADDR_SPEC {}
///`reset()` method sets _0_TX_EOF_DES_ADDR to value 0
