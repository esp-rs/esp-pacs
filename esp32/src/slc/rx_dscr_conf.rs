...
///`read()` method returns [`rx_dscr_conf::R`](R) reader structure
impl crate::Readable for RX_DSCR_CONF_SPEC {}
///`write(|w| ..)` method takes [`rx_dscr_conf::W`](W) writer structure
impl crate::Writable for RX_DSCR_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets RX_DSCR_CONF to value 0x101b_101a
