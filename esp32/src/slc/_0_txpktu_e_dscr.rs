///Register `_0_TXPKTU_E_DSCR` reader
pub type R = crate::R<_0_TXPKTU_E_DSCR_SPEC>;
///Field `SLC0_TX_PKT_END_DSCR_ADDR` reader -
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("_0_TXPKTU_E_DSCR")
            .field(
                ...
                &self.slc0_tx_pkt_end_dscr_addr(),
            )
            .finish()
    }
}
...
///`read()` method returns [`_0_txpktu_e_dscr::R`](R) reader structure
impl crate::Readable for _0_TXPKTU_E_DSCR_SPEC {}
///`reset()` method sets _0_TXPKTU_E_DSCR to value 0
