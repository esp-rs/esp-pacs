...
///`read()` method returns [`_0_len_conf::R`](R) reader structure
impl crate::Readable for _0_LEN_CONF_SPEC {}
///`write(|w| ..)` method takes [`_0_len_conf::W`](W) writer structure
impl crate::Writable for _0_LEN_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets _0_LEN_CONF to value 0
