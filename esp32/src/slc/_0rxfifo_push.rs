...
///`read()` method returns [`_0rxfifo_push::R`](R) reader structure
impl crate::Readable for _0RXFIFO_PUSH_SPEC {}
///`write(|w| ..)` method takes [`_0rxfifo_push::W`](W) writer structure
impl crate::Writable for _0RXFIFO_PUSH_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets _0RXFIFO_PUSH to value 0
