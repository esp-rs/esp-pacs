///Register `_1_TXLINK_DSCR` reader
pub type R = crate::R<_1_TXLINK_DSCR_SPEC>;
///Field `SLC1_TXLINK_DSCR` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`_1_txlink_dscr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct _1_TXLINK_DSCR_SPEC;
impl crate::RegisterSpec for _1_TXLINK_DSCR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`_1_txlink_dscr::R`](R) reader structure
impl crate::Readable for _1_TXLINK_DSCR_SPEC {}
///`reset()` method sets _1_TXLINK_DSCR to value 0
