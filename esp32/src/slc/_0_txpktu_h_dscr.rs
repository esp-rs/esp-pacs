...
pub struct R(crate::R<_0_TXPKTU_H_DSCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<_0_TXPKTU_H_DSCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<_0_TXPKTU_H_DSCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<_0_TXPKTU_H_DSCR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<_0_TXPKTU_H_DSCR_SPEC> {
