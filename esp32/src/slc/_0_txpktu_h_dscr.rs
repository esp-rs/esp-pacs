///Register `_0_TXPKTU_H_DSCR` reader
pub type R = crate::R<_0_TXPKTU_H_DSCR_SPEC>;
///Field `SLC0_TX_PKT_START_DSCR_ADDR` reader -
...
///`read()` method returns [`_0_txpktu_h_dscr::R`](R) reader structure
impl crate::Readable for _0_TXPKTU_H_DSCR_SPEC {}
///`reset()` method sets _0_TXPKTU_H_DSCR to value 0
