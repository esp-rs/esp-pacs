...
///`read()` method returns [`_0int_raw::R`](R) reader structure
impl crate::Readable for _0INT_RAW_SPEC {}
///`reset()` method sets _0INT_RAW to value 0
