...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("_0INT_RAW")
            .field("frhost_bit0_int_raw", &self.frhost_bit0_int_raw().bit())
            .field("frhost_bit1_int_raw", &self.frhost_bit1_int_raw().bit())
            .field("frhost_bit2_int_raw", &self.frhost_bit2_int_raw().bit())
            .field("frhost_bit3_int_raw", &self.frhost_bit3_int_raw().bit())
            .field("frhost_bit4_int_raw", &self.frhost_bit4_int_raw().bit())
            .field("frhost_bit5_int_raw", &self.frhost_bit5_int_raw().bit())
            .field("frhost_bit6_int_raw", &self.frhost_bit6_int_raw().bit())
            .field("frhost_bit7_int_raw", &self.frhost_bit7_int_raw().bit())
            .field("slc0_rx_start_int_raw", &self.slc0_rx_start_int_raw().bit())
            .field("slc0_tx_start_int_raw", &self.slc0_tx_start_int_raw().bit())
            ...
            .field("slc0_tx_done_int_raw", &self.slc0_tx_done_int_raw().bit())
            .field(
                "slc0_tx_suc_eof_int_raw",
                &self.slc0_tx_suc_eof_int_raw().bit(),
            )
            .field("slc0_rx_done_int_raw", &self.slc0_rx_done_int_raw().bit())
            .field("slc0_rx_eof_int_raw", &self.slc0_rx_eof_int_raw().bit())
            .field("slc0_tohost_int_raw", &self.slc0_tohost_int_raw().bit())
            .field(
                "slc0_tx_dscr_err_int_raw",
                &self.slc0_tx_dscr_err_int_raw().bit(),
            )
            .field(
                "slc0_rx_dscr_err_int_raw",
                &self.slc0_rx_dscr_err_int_raw().bit(),
            )
            .field(
                "slc0_tx_dscr_empty_int_raw",
                &self.slc0_tx_dscr_empty_int_raw().bit(),
            )
            .field(
                "slc0_host_rd_ack_int_raw",
                &self.slc0_host_rd_ack_int_raw().bit(),
            )
            .field(
                "slc0_wr_retry_done_int_raw",
                &self.slc0_wr_retry_done_int_raw().bit(),
            )
            .field(
                "slc0_tx_err_eof_int_raw",
                &self.slc0_tx_err_eof_int_raw().bit(),
            )
            .field("cmd_dtc_int_raw", &self.cmd_dtc_int_raw().bit())
            .field(
                "slc0_rx_quick_eof_int_raw",
                &self.slc0_rx_quick_eof_int_raw().bit(),
            )
            .finish()
    }
}
