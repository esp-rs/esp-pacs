...
impl W {
    ...
    pub fn slc0_tx_pkt_e_dscr_addr(
        &mut self,
    ) -> SLC0_TX_PKT_E_DSCR_ADDR_W<'_, _0_TXPKT_E_DSCR_SPEC> {
        SLC0_TX_PKT_E_DSCR_ADDR_W::new(self, 0)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`_0_txpkt_e_dscr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_0_txpkt_e_dscr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
