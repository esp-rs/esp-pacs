...
pub type SLC0_TX_PKT_E_DSCR_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SLC0_TX_PKT_E_DSCR_ADDR` writer - "]
pub type SLC0_TX_PKT_E_DSCR_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, _0_TXPKT_E_DSCR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slc0_tx_pkt_e_dscr_addr(&mut self) -> SLC0_TX_PKT_E_DSCR_ADDR_W<0> {
        SLC0_TX_PKT_E_DSCR_ADDR_W::new(self)
    }
