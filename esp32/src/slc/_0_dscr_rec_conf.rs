...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slc0_rx_dscr_rec_lim(&mut self) -> SLC0_RX_DSCR_REC_LIM_W<_0_DSCR_REC_CONF_SPEC> {
...
///`read()` method returns [`_0_dscr_rec_conf::R`](R) reader structure
impl crate::Readable for _0_DSCR_REC_CONF_SPEC {}
///`write(|w| ..)` method takes [`_0_dscr_rec_conf::W`](W) writer structure
impl crate::Writable for _0_DSCR_REC_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets _0_DSCR_REC_CONF to value 0x03ff
