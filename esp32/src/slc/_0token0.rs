...
///`read()` method returns [`_0token0::R`](R) reader structure
impl crate::Readable for _0TOKEN0_SPEC {}
///`write(|w| ..)` method takes [`_0token0::W`](W) writer structure
impl crate::Writable for _0TOKEN0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets _0TOKEN0 to value 0
