///Register `_0_PUSH_DSCR_ADDR` reader
pub type R = crate::R<_0_PUSH_DSCR_ADDR_SPEC>;
///Field `SLC0_RX_PUSH_DSCR_ADDR` reader -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("_0_PUSH_DSCR_ADDR")
            .field("slc0_rx_push_dscr_addr", &self.slc0_rx_push_dscr_addr())
            .finish()
    }
}
/**
...
///`read()` method returns [`_0_push_dscr_addr::R`](R) reader structure
impl crate::Readable for _0_PUSH_DSCR_ADDR_SPEC {}
///`reset()` method sets _0_PUSH_DSCR_ADDR to value 0
