...
pub struct R(crate::R<_0_RXLINK_DSCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<_0_RXLINK_DSCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<_0_RXLINK_DSCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<_0_RXLINK_DSCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `SLC0_RXLINK_DSCR` reader - "]
pub type SLC0_RXLINK_DSCR_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [_0_rxlink_dscr](index.html) module"]
