...
impl W {
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn slc0_txfifo_pop(&mut self) -> SLC0_TXFIFO_POP_W<'_, _0TXFIFO_POP_SPEC> {
        SLC0_TXFIFO_POP_W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`_0txfifo_pop::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_0txfifo_pop::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
