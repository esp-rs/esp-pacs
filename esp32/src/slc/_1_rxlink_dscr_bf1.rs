///Register `_1_RXLINK_DSCR_BF1` reader
pub type R = crate::R<_1_RXLINK_DSCR_BF1_SPEC>;
///Field `SLC1_RXLINK_DSCR_BF1` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`_1_rxlink_dscr_bf1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct _1_RXLINK_DSCR_BF1_SPEC;
impl crate::RegisterSpec for _1_RXLINK_DSCR_BF1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`_1_rxlink_dscr_bf1::R`](R) reader structure
impl crate::Readable for _1_RXLINK_DSCR_BF1_SPEC {}
///`reset()` method sets _1_RXLINK_DSCR_BF1 to value 0
