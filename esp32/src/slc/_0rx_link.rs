...
pub type SLC0_RXLINK_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, _0RX_LINK_SPEC, u32, u32, 20, O>;
#[doc = "Field `SLC0_RXLINK_STOP` reader - "]
pub type SLC0_RXLINK_STOP_R = crate::BitReader<bool>;
#[doc = "Field `SLC0_RXLINK_STOP` writer - "]
pub type SLC0_RXLINK_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, _0RX_LINK_SPEC, bool, O>;
#[doc = "Field `SLC0_RXLINK_START` reader - "]
pub type SLC0_RXLINK_START_R = crate::BitReader<bool>;
#[doc = "Field `SLC0_RXLINK_START` writer - "]
pub type SLC0_RXLINK_START_W<'a, const O: u8> = crate::BitWriter<'a, u32, _0RX_LINK_SPEC, bool, O>;
...
pub type SLC0_RXLINK_RESTART_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, _0RX_LINK_SPEC, bool, O>;
