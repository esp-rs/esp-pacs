...
///`read()` method returns [`_0rx_link::R`](R) reader structure
impl crate::Readable for _0RX_LINK_SPEC {}
///`write(|w| ..)` method takes [`_0rx_link::W`](W) writer structure
impl crate::Writable for _0RX_LINK_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets _0RX_LINK to value 0
