///Register `_0_RXLINK_DSCR_BF0` reader
pub type R = crate::R<_0_RXLINK_DSCR_BF0_SPEC>;
///Field `SLC0_RXLINK_DSCR_BF0` reader -
...
///`read()` method returns [`_0_rxlink_dscr_bf0::R`](R) reader structure
impl crate::Readable for _0_RXLINK_DSCR_BF0_SPEC {}
///`reset()` method sets _0_RXLINK_DSCR_BF0 to value 0
