///Register `_0_RXPKT_H_DSCR` reader
pub type R = crate::R<_0_RXPKT_H_DSCR_SPEC>;
///Register `_0_RXPKT_H_DSCR` writer
pub type W = crate::W<_0_RXPKT_H_DSCR_SPEC>;
///Field `SLC0_RX_PKT_H_DSCR_ADDR` reader -
pub type SLC0_RX_PKT_H_DSCR_ADDR_R = crate::FieldReader<u32>;
///Field `SLC0_RX_PKT_H_DSCR_ADDR` writer -
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slc0_rx_pkt_h_dscr_addr(&mut self) -> SLC0_RX_PKT_H_DSCR_ADDR_W<_0_RXPKT_H_DSCR_SPEC> {
...
///`read()` method returns [`_0_rxpkt_h_dscr::R`](R) reader structure
impl crate::Readable for _0_RXPKT_H_DSCR_SPEC {}
///`write(|w| ..)` method takes [`_0_rxpkt_h_dscr::W`](W) writer structure
impl crate::Writable for _0_RXPKT_H_DSCR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets _0_RXPKT_H_DSCR to value 0
