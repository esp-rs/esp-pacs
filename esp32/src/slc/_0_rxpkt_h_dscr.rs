...
pub struct R(crate::R<_0_RXPKT_H_DSCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<_0_RXPKT_H_DSCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<_0_RXPKT_H_DSCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<_0_RXPKT_H_DSCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `_0_RXPKT_H_DSCR` writer"]
pub struct W(crate::W<_0_RXPKT_H_DSCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<_0_RXPKT_H_DSCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<_0_RXPKT_H_DSCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<_0_RXPKT_H_DSCR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SLC0_RX_PKT_H_DSCR_ADDR` reader - "]
pub type SLC0_RX_PKT_H_DSCR_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SLC0_RX_PKT_H_DSCR_ADDR` writer - "]
pub type SLC0_RX_PKT_H_DSCR_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, _0_RXPKT_H_DSCR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [_0_rxpkt_h_dscr](index.html) module"]
