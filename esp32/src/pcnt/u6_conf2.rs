...
pub type CNT_H_LIM_U6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, U6_CONF2_SPEC, u16, u16, 16, O>;
...
pub type CNT_L_LIM_U6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, U6_CONF2_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - This register is used to configure thr_h_lim value for unit6."]
    #[inline(always)]
    pub fn cnt_h_lim_u6(&mut self) -> CNT_H_LIM_U6_W<0> {
        CNT_H_LIM_U6_W::new(self)
    }
    #[doc = "Bits 16:31 - This register is used to confiugre thr_l_lim value for unit6."]
    #[inline(always)]
    pub fn cnt_l_lim_u6(&mut self) -> CNT_L_LIM_U6_W<16> {
