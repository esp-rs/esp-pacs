...
///Field `CNT_RST_U(0-7)` reader - Set this bit to clear unit%s's counter.
pub type CNT_RST_U_R = crate::BitReader;
///Field `CNT_RST_U(0-7)` writer - Set this bit to clear unit%s's counter.
pub type CNT_RST_U_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CNT_PAUSE_U(0-7)` reader - Set this bit to pause unit%s's counter.
pub type CNT_PAUSE_U_R = crate::BitReader;
///Field `CNT_PAUSE_U(0-7)` writer - Set this bit to pause unit%s's counter.
...
impl R {
    ///Set this bit to clear unit(0-7)'s counter.
    ///
    ...
    ///Set this bit to pause unit(0-7)'s counter.
    ///
...
///`reset()` method sets CTRL to value 0x5555
