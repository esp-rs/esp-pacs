...
impl W {
    ...
    #[doc = "Bit 8 - Set this bit to clear unit4's counter."]
    #[inline(always)]
    pub fn cnt_rst_u4(&mut self) -> CNT_RST_U_W<'_, CTRL_SPEC> {
        CNT_RST_U_W::new(self, 8)
    }
    #[doc = "Bit 10 - Set this bit to clear unit5's counter."]
    #[inline(always)]
    pub fn cnt_rst_u5(&mut self) -> CNT_RST_U_W<'_, CTRL_SPEC> {
        CNT_RST_U_W::new(self, 10)
    }
    #[doc = "Bit 12 - Set this bit to clear unit6's counter."]
    #[inline(always)]
    pub fn cnt_rst_u6(&mut self) -> CNT_RST_U_W<'_, CTRL_SPEC> {
        CNT_RST_U_W::new(self, 12)
    }
    #[doc = "Bit 14 - Set this bit to clear unit7's counter."]
    #[inline(always)]
    pub fn cnt_rst_u7(&mut self) -> CNT_RST_U_W<'_, CTRL_SPEC> {
    ...
    #[doc = "Bit 9 - Set this bit to pause unit4's counter."]
    #[inline(always)]
    pub fn cnt_pause_u4(&mut self) -> CNT_PAUSE_U_W<'_, CTRL_SPEC> {
        CNT_PAUSE_U_W::new(self, 9)
    }
    #[doc = "Bit 11 - Set this bit to pause unit5's counter."]
    #[inline(always)]
    pub fn cnt_pause_u5(&mut self) -> CNT_PAUSE_U_W<'_, CTRL_SPEC> {
        CNT_PAUSE_U_W::new(self, 11)
    }
    #[doc = "Bit 13 - Set this bit to pause unit6's counter."]
    #[inline(always)]
    pub fn cnt_pause_u6(&mut self) -> CNT_PAUSE_U_W<'_, CTRL_SPEC> {
        CNT_PAUSE_U_W::new(self, 13)
    }
    #[doc = "Bit 15 - Set this bit to pause unit7's counter."]
    #[inline(always)]
    pub fn cnt_pause_u7(&mut self) -> CNT_PAUSE_U_W<'_, CTRL_SPEC> {
