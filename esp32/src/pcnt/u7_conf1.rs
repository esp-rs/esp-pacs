...
pub type CNT_THRES0_U7_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, U7_CONF1_SPEC, u16, u16, 16, O>;
...
pub type CNT_THRES1_U7_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, U7_CONF1_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - This register is used to configure thres0 value for unit7."]
    #[inline(always)]
    pub fn cnt_thres0_u7(&mut self) -> CNT_THRES0_U7_W<0> {
        CNT_THRES0_U7_W::new(self)
    }
    #[doc = "Bits 16:31 - This register is used to configure thres1 value for unit7."]
    #[inline(always)]
    pub fn cnt_thres1_u7(&mut self) -> CNT_THRES1_U7_W<16> {
