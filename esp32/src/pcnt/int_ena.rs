...
///Field `CNT_THR_EVENT_U(0-7)` reader - This is the interrupt enable bit for channel%s event.
pub type CNT_THR_EVENT_U_R = crate::BitReader;
///Field `CNT_THR_EVENT_U(0-7)` writer - This is the interrupt enable bit for channel%s event.
