...
///Field `CNT_H_LIM` reader - This register is used to configure thr_h_lim value for unit0.
pub type CNT_H_LIM_R = crate::FieldReader<u16>;
///Field `CNT_H_LIM` writer - This register is used to configure thr_h_lim value for unit0.
pub type CNT_H_LIM_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `CNT_L_LIM` reader - This register is used to confiugre thr_l_lim value for unit0.
pub type CNT_L_LIM_R = crate::FieldReader<u16>;
///Field `CNT_L_LIM` writer - This register is used to confiugre thr_l_lim value for unit0.
