...
///Field `CNT_THRES0` reader - This register is used to configure thres0 value for unit0.
pub type CNT_THRES0_R = crate::FieldReader<u16>;
///Field `CNT_THRES0` writer - This register is used to configure thres0 value for unit0.
pub type CNT_THRES0_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `CNT_THRES1` reader - This register is used to configure thres1 value for unit0.
pub type CNT_THRES1_R = crate::FieldReader<u16>;
///Field `CNT_THRES1` writer - This register is used to configure thres1 value for unit0.
pub type CNT_THRES1_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - This register is used to configure thres0 value for unit0.
    #[inline(always)]
    pub fn cnt_thres0(&self) -> CNT_THRES0_R {
        CNT_THRES0_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - This register is used to configure thres1 value for unit0.
    #[inline(always)]
