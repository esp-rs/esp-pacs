...
pub type CNT_THRES0_U2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, U2_CONF1_SPEC, u16, u16, 16, O>;
...
pub type CNT_THRES1_U2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, U2_CONF1_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt_thres0_u2(&mut self) -> CNT_THRES0_U2_W<0> {
        CNT_THRES0_U2_W::new(self)
    }
    #[doc = "Bits 16:31 - This register is used to configure thres1 value for unit2."]
    #[inline(always)]
    #[must_use]
    pub fn cnt_thres1_u2(&mut self) -> CNT_THRES1_U2_W<16> {
