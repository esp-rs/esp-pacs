...
pub type TX_WMARK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FIFOTH_SPEC, u16, u16, 12, O>;
...
pub type RX_WMARK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FIFOTH_SPEC, u16, u16, 11, O>;
...
pub type DMA_MULTIPLE_TRANSACTION_SIZE_R = crate::FieldReader<u8, u8>;
...
pub type DMA_MULTIPLE_TRANSACTION_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FIFOTH_SPEC, u8, u8, 3, O>;
impl R {
