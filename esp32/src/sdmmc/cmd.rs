...
pub type INDEX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMD_SPEC, u8, u8, 6, O>;
...
pub type CARD_NUMBER_R = crate::FieldReader<u8, u8>;
...
pub type CARD_NUMBER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMD_SPEC, u8, u8, 5, O>;
...
pub type USE_HOLE_R = crate::BitReader<bool>;
...
pub type USE_HOLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMD_SPEC, bool, O>;
