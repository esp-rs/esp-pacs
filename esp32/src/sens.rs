...
/**SAR_READ_CTRL (rw) register accessor:
...
/**SAR_READ_STATUS1 (r) register accessor:
...
/**SAR_MEAS_WAIT1 (rw) register accessor:
...
/**SAR_MEAS_WAIT2 (rw) register accessor:
...
/**SAR_MEAS_CTRL (rw) register accessor:
...
/**SAR_READ_STATUS2 (r) register accessor:
...
/**ULP_CP_SLEEP_CYC0 (rw) register accessor:
...
/**ULP_CP_SLEEP_CYC1 (rw) register accessor:
...
/**ULP_CP_SLEEP_CYC2 (rw) register accessor:
...
/**ULP_CP_SLEEP_CYC3 (rw) register accessor:
...
/**ULP_CP_SLEEP_CYC4 (rw) register accessor:
...
/**SAR_START_FORCE (rw) register accessor:
...
/**SAR_MEM_WR_CTRL (rw) register accessor:
...
/**SAR_ATTEN1 (rw) register accessor:
...
///
pub mod sar_atten1;
/**SAR_ATTEN2 (rw) register accessor:
...
///
pub mod sar_atten2;
/**SAR_SLAVE_ADDR1 (rw) register accessor:
...
/**SAR_SLAVE_ADDR2 (rw) register accessor:
...
/**SAR_SLAVE_ADDR3 (rw) register accessor:
...
/**SAR_SLAVE_ADDR4 (rw) register accessor:
...
/**SAR_TSENS_CTRL (rw) register accessor:
...
/**SAR_I2C_CTRL (rw) register accessor:
...
/**SAR_MEAS_START1 (rw) register accessor:
...
/**SAR_TOUCH_CTRL1 (rw) register accessor:
...
/**SAR_TOUCH_THRES1 (rw) register accessor:
...
/**SAR_TOUCH_THRES2 (rw) register accessor:
...
/**SAR_TOUCH_THRES3 (rw) register accessor:
...
/**SAR_TOUCH_THRES4 (rw) register accessor:
...
/**SAR_TOUCH_THRES5 (rw) register accessor:
...
/**SAR_TOUCH_OUT1 (r) register accessor:
...
/**SAR_TOUCH_OUT2 (r) register accessor:
...
/**SAR_TOUCH_OUT3 (r) register accessor:
...
/**SAR_TOUCH_OUT4 (r) register accessor:
...
/**SAR_TOUCH_OUT5 (r) register accessor:
...
/**SAR_TOUCH_CTRL2 (rw) register accessor:
...
/**SAR_TOUCH_ENABLE (rw) register accessor:
...
/**SAR_READ_CTRL2 (rw) register accessor:
...
/**SAR_MEAS_START2 (rw) register accessor:
...
/**SAR_DAC_CTRL1 (rw) register accessor:
...
/**SAR_DAC_CTRL2 (rw) register accessor:
...
/**SAR_MEAS_CTRL2 (rw) register accessor:
...
/**SAR_NOUSE (rw) register accessor:
