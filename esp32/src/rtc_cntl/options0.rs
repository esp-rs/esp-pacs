...
impl W {
    ...
    #[doc = "Bit 14 - BIAS_SLEEP follow CK8M"]
    #[inline(always)]
    pub fn bias_sleep_folw_8m(&mut self) -> BIAS_SLEEP_FOLW_8M_W<'_, OPTIONS0_SPEC> {
        BIAS_SLEEP_FOLW_8M_W::new(self, 14)
    }
    #[doc = "Bit 15 - BIAS_SLEEP force sleep"]
    #[inline(always)]
    pub fn bias_force_sleep(&mut self) -> BIAS_FORCE_SLEEP_W<'_, OPTIONS0_SPEC> {
        BIAS_FORCE_SLEEP_W::new(self, 15)
    }
    #[doc = "Bit 16 - BIAS_SLEEP force no sleep"]
    #[inline(always)]
    pub fn bias_force_nosleep(&mut self) -> BIAS_FORCE_NOSLEEP_W<'_, OPTIONS0_SPEC> {
        BIAS_FORCE_NOSLEEP_W::new(self, 16)
    }
    #[doc = "Bit 17 - BIAS_I2C follow CK8M"]
    #[inline(always)]
    pub fn bias_i2c_folw_8m(&mut self) -> BIAS_I2C_FOLW_8M_W<'_, OPTIONS0_SPEC> {
        BIAS_I2C_FOLW_8M_W::new(self, 17)
    }
    #[doc = "Bit 18 - BIAS_I2C force power down"]
    #[inline(always)]
    pub fn bias_i2c_force_pd(&mut self) -> BIAS_I2C_FORCE_PD_W<'_, OPTIONS0_SPEC> {
        BIAS_I2C_FORCE_PD_W::new(self, 18)
    }
    #[doc = "Bit 19 - BIAS_I2C force power up"]
    #[inline(always)]
    pub fn bias_i2c_force_pu(&mut self) -> BIAS_I2C_FORCE_PU_W<'_, OPTIONS0_SPEC> {
        BIAS_I2C_FORCE_PU_W::new(self, 19)
    }
    #[doc = "Bit 20 - BIAS_CORE follow CK8M"]
    #[inline(always)]
    pub fn bias_core_folw_8m(&mut self) -> BIAS_CORE_FOLW_8M_W<'_, OPTIONS0_SPEC> {
        BIAS_CORE_FOLW_8M_W::new(self, 20)
    }
    #[doc = "Bit 21 - BIAS_CORE force power down"]
    #[inline(always)]
    pub fn bias_core_force_pd(&mut self) -> BIAS_CORE_FORCE_PD_W<'_, OPTIONS0_SPEC> {
        BIAS_CORE_FORCE_PD_W::new(self, 21)
    }
    #[doc = "Bit 22 - BIAS_CORE force power up"]
    #[inline(always)]
    pub fn bias_core_force_pu(&mut self) -> BIAS_CORE_FORCE_PU_W<'_, OPTIONS0_SPEC> {
