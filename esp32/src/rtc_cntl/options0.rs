...
///Field `BIAS_SLEEP_FOLW_8M` reader - BIAS_SLEEP follow CK8M
pub type BIAS_SLEEP_FOLW_8M_R = crate::BitReader;
///Field `BIAS_SLEEP_FOLW_8M` writer - BIAS_SLEEP follow CK8M
pub type BIAS_SLEEP_FOLW_8M_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_FORCE_SLEEP` reader - BIAS_SLEEP force sleep
pub type BIAS_FORCE_SLEEP_R = crate::BitReader;
///Field `BIAS_FORCE_SLEEP` writer - BIAS_SLEEP force sleep
pub type BIAS_FORCE_SLEEP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_FORCE_NOSLEEP` reader - BIAS_SLEEP force no sleep
pub type BIAS_FORCE_NOSLEEP_R = crate::BitReader;
///Field `BIAS_FORCE_NOSLEEP` writer - BIAS_SLEEP force no sleep
pub type BIAS_FORCE_NOSLEEP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_I2C_FOLW_8M` reader - BIAS_I2C follow CK8M
pub type BIAS_I2C_FOLW_8M_R = crate::BitReader;
///Field `BIAS_I2C_FOLW_8M` writer - BIAS_I2C follow CK8M
pub type BIAS_I2C_FOLW_8M_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_I2C_FORCE_PD` reader - BIAS_I2C force power down
pub type BIAS_I2C_FORCE_PD_R = crate::BitReader;
///Field `BIAS_I2C_FORCE_PD` writer - BIAS_I2C force power down
pub type BIAS_I2C_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_I2C_FORCE_PU` reader - BIAS_I2C force power up
pub type BIAS_I2C_FORCE_PU_R = crate::BitReader;
///Field `BIAS_I2C_FORCE_PU` writer - BIAS_I2C force power up
pub type BIAS_I2C_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_CORE_FOLW_8M` reader - BIAS_CORE follow CK8M
pub type BIAS_CORE_FOLW_8M_R = crate::BitReader;
///Field `BIAS_CORE_FOLW_8M` writer - BIAS_CORE follow CK8M
pub type BIAS_CORE_FOLW_8M_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_CORE_FORCE_PD` reader - BIAS_CORE force power down
pub type BIAS_CORE_FORCE_PD_R = crate::BitReader;
///Field `BIAS_CORE_FORCE_PD` writer - BIAS_CORE force power down
pub type BIAS_CORE_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `BIAS_CORE_FORCE_PU` reader - BIAS_CORE force power up
pub type BIAS_CORE_FORCE_PU_R = crate::BitReader;
///Field `BIAS_CORE_FORCE_PU` writer - BIAS_CORE force power up
...
///`reset()` method sets OPTIONS0 to value 0x1c49_2000
