...
pub type CNTL_DATE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 28, O, u32>;
impl R {
    #[doc = "Bits 0:27"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cntl_date(&mut self) -> CNTL_DATE_W<DATE_SPEC, 0> {
...
#[doc = "`reset()` method sets DATE to value 0x0160_4280"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0160_4280;
}
