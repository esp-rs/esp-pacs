...
///Field `TIME_VALID` writer - Clear RTC time valid interrupt state
pub type TIME_VALID_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `SAR` writer - Clear ULP-coprocessor interrupt state
pub type SAR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
///Field `TOUCH` writer - Clear touch interrupt state
