...
pub type TIME_VALID_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SAR_INT_CLR` writer - Clear ULP-coprocessor interrupt state"]
pub type SAR_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `TOUCH_INT_CLR` writer - Clear touch interrupt state"]
pub type TOUCH_INT_CLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slp_wakeup_int_clr(&mut self) -> SLP_WAKEUP_INT_CLR_W<INT_CLR_SPEC, 0> {
        SLP_WAKEUP_INT_CLR_W::new(self)
    }
    #[doc = "Bit 1 - Clear sleep reject interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn slp_reject_int_clr(&mut self) -> SLP_REJECT_INT_CLR_W<INT_CLR_SPEC, 1> {
        SLP_REJECT_INT_CLR_W::new(self)
    }
    #[doc = "Bit 2 - Clear SDIO idle interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn sdio_idle_int_clr(&mut self) -> SDIO_IDLE_INT_CLR_W<INT_CLR_SPEC, 2> {
        SDIO_IDLE_INT_CLR_W::new(self)
    }
    #[doc = "Bit 3 - Clear RTC WDT interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn wdt_int_clr(&mut self) -> WDT_INT_CLR_W<INT_CLR_SPEC, 3> {
        WDT_INT_CLR_W::new(self)
    }
    #[doc = "Bit 4 - Clear RTC time valid interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn time_valid_int_clr(&mut self) -> TIME_VALID_INT_CLR_W<INT_CLR_SPEC, 4> {
        TIME_VALID_INT_CLR_W::new(self)
    }
    #[doc = "Bit 5 - Clear ULP-coprocessor interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn sar_int_clr(&mut self) -> SAR_INT_CLR_W<INT_CLR_SPEC, 5> {
        SAR_INT_CLR_W::new(self)
    }
    #[doc = "Bit 6 - Clear touch interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn touch_int_clr(&mut self) -> TOUCH_INT_CLR_W<INT_CLR_SPEC, 6> {
        TOUCH_INT_CLR_W::new(self)
    }
    #[doc = "Bit 7 - Clear brown out interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn brown_out_int_clr(&mut self) -> BROWN_OUT_INT_CLR_W<INT_CLR_SPEC, 7> {
        BROWN_OUT_INT_CLR_W::new(self)
    }
    #[doc = "Bit 8 - Clear RTC main timer interrupt state"]
    #[inline(always)]
    #[must_use]
    pub fn main_timer_int_clr(&mut self) -> MAIN_TIMER_INT_CLR_W<INT_CLR_SPEC, 8> {
