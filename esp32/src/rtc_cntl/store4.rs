///Register `STORE4` reader
pub type R = crate::R<STORE4_SPEC>;
///Register `STORE4` writer
pub type W = crate::W<STORE4_SPEC>;
///Field `SCRATCH4` reader - 32-bit general purpose retention register
pub type SCRATCH4_R = crate::FieldReader<u32>;
///Field `SCRATCH4` writer - 32-bit general purpose retention register
...
///`read()` method returns [`store4::R`](R) reader structure
impl crate::Readable for STORE4_SPEC {}
///`write(|w| ..)` method takes [`store4::W`](W) writer structure
