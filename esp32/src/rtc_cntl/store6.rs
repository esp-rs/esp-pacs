///Register `STORE6` reader
pub type R = crate::R<STORE6_SPEC>;
///Register `STORE6` writer
pub type W = crate::W<STORE6_SPEC>;
///Field `SCRATCH6` reader - 32-bit general purpose retention register
pub type SCRATCH6_R = crate::FieldReader<u32>;
///Field `SCRATCH6` writer - 32-bit general purpose retention register
pub type SCRATCH6_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - 32-bit general purpose retention register
    #[inline(always)]
...
///`read()` method returns [`store6::R`](R) reader structure
impl crate::Readable for STORE6_SPEC {}
///`write(|w| ..)` method takes [`store6::W`](W) writer structure
