...
#[doc = "Field `SCRATCH3` reader - 32-bit general purpose retention register"]
pub type SCRATCH3_R = crate::FieldReader<u32>;
#[doc = "Field `SCRATCH3` writer - 32-bit general purpose retention register"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("STORE3")
            .field("scratch3", &self.scratch3().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
