///Register `WAKEUP_STATE` reader
pub type R = crate::R<WAKEUP_STATE_SPEC>;
///Register `WAKEUP_STATE` writer
pub type W = crate::W<WAKEUP_STATE_SPEC>;
///Field `WAKEUP_CAUSE` reader - wakeup cause
pub type WAKEUP_CAUSE_R = crate::FieldReader<u16>;
///Field `WAKEUP_ENA` reader - wakeup enable bitmap
...
///`read()` method returns [`wakeup_state::R`](R) reader structure
impl crate::Readable for WAKEUP_STATE_SPEC {}
///`write(|w| ..)` method takes [`wakeup_state::W`](W) writer structure
impl crate::Writable for WAKEUP_STATE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets WAKEUP_STATE to value 0x6000
