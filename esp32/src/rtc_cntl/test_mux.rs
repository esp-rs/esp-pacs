...
///`read()` method returns [`test_mux::R`](R) reader structure
impl crate::Readable for TEST_MUX_SPEC {}
///`write(|w| ..)` method takes [`test_mux::W`](W) writer structure
