...
///`read()` method returns [`hold_force::R`](R) reader structure
impl crate::Readable for HOLD_FORCE_SPEC {}
///`write(|w| ..)` method takes [`hold_force::W`](W) writer structure
