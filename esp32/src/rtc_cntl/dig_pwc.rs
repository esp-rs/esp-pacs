...
///Field `DG_WRAP_PD_EN` reader - enable power down digital core in sleep
pub type DG_WRAP_PD_EN_R = crate::BitReader;
///Field `DG_WRAP_PD_EN` writer - enable power down digital core in sleep
...
///`reset()` method sets DIG_PWC to value 0x0015_5550
