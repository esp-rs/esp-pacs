...
///Field `SW_STALL_PROCPU_C1` reader - {reg_sw_stall_procpu_c1\[5:0\] reg_sw_stall_procpu_c0\[1:0\]} == 0x86 will stall PRO CPU
pub type SW_STALL_PROCPU_C1_R = crate::FieldReader;
///Field `SW_STALL_PROCPU_C1` writer - {reg_sw_stall_procpu_c1\[5:0\] reg_sw_stall_procpu_c0\[1:0\]} == 0x86 will stall PRO CPU
