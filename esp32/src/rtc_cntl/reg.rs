...
impl W {
    #[doc = "Bit 7 - N/A"]
    #[inline(always)]
    pub fn sck_dcap_force(&mut self) -> SCK_DCAP_FORCE_W<'_, REG_SPEC> {
        SCK_DCAP_FORCE_W::new(self, 7)
    }
    #[doc = "Bits 8:10 - DIG_REG_DBIAS during sleep"]
    #[inline(always)]
    pub fn dig_dbias_slp(&mut self) -> DIG_DBIAS_SLP_W<'_, REG_SPEC> {
        DIG_DBIAS_SLP_W::new(self, 8)
    }
    #[doc = "Bits 11:13 - DIG_REG_DBIAS during wakeup"]
    #[inline(always)]
    pub fn dig_dbias_wak(&mut self) -> DIG_DBIAS_WAK_W<'_, REG_SPEC> {
    ...
    #[doc = "Bit 30 - RTC_REG force power down (for RTC_REG power down means decrease the voltage to 0.8v or lower )"]
    #[inline(always)]
    pub fn force_pd(&mut self) -> FORCE_PD_W<'_, REG_SPEC> {
        FORCE_PD_W::new(self, 30)
    }
    #[doc = "Bit 31 - RTC_REG force power up"]
    #[inline(always)]
    pub fn force_pu(&mut self) -> FORCE_PU_W<'_, REG_SPEC> {
