...
///Field `SCK_DCAP_FORCE` reader - N/A
pub type SCK_DCAP_FORCE_R = crate::BitReader;
///Field `SCK_DCAP_FORCE` writer - N/A
pub type SCK_DCAP_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DIG_DBIAS_SLP` reader - DIG_REG_DBIAS during sleep
pub type DIG_DBIAS_SLP_R = crate::FieldReader;
///Field `DIG_DBIAS_SLP` writer - DIG_REG_DBIAS during sleep
pub type DIG_DBIAS_SLP_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `DIG_DBIAS_WAK` reader - DIG_REG_DBIAS during wakeup
pub type DIG_DBIAS_WAK_R = crate::FieldReader;
///Field `DIG_DBIAS_WAK` writer - DIG_REG_DBIAS during wakeup
pub type DIG_DBIAS_WAK_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `SCK_DCAP` reader - SCK_DCAP
pub type SCK_DCAP_R = crate::FieldReader;
///Field `SCK_DCAP` writer - SCK_DCAP
pub type SCK_DCAP_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `DBIAS_SLP` reader - RTC_DBIAS during sleep
pub type DBIAS_SLP_R = crate::FieldReader;
///Field `DBIAS_SLP` writer - RTC_DBIAS during sleep
pub type DBIAS_SLP_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
///Field `DBIAS_WAK` reader - RTC_DBIAS during wakeup
pub type DBIAS_WAK_R = crate::FieldReader;
///Field `DBIAS_WAK` writer - RTC_DBIAS during wakeup
...
///Field `FORCE_PD` reader - RTC_REG force power down (for RTC_REG power down means decrease the voltage to 0.8v or lower )
pub type FORCE_PD_R = crate::BitReader;
///Field `FORCE_PD` writer - RTC_REG force power down (for RTC_REG power down means decrease the voltage to 0.8v or lower )
pub type FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FORCE_PU` reader - RTC_REG force power up
pub type FORCE_PU_R = crate::BitReader;
///Field `FORCE_PU` writer - RTC_REG force power up
...
///`reset()` method sets REG to value 0x2900_2400
