...
pub type RTC_MEM_CRC_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, BROWN_OUT_SPEC, 11, O, u16>;
...
pub type RTC_MEM_CRC_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, BROWN_OUT_SPEC, 11, O, u16>;
