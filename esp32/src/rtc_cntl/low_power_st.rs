...
///Field `LOW_POWER_DIAG0` reader -
pub type LOW_POWER_DIAG0_R = crate::FieldReader<u32>;
///Field `RDY_FOR_WAKEUP` reader - 1 if RTC controller is ready to execute WAKE instruction, 0 otherwise
...
impl R {
    ...
    ///Bit 19 - 1 if RTC controller is ready to execute WAKE instruction, 0 otherwise
    #[inline(always)]
