...
///Field `CK8M_DFREQ_FORCE` reader -
pub type CK8M_DFREQ_FORCE_R = crate::BitReader;
///Field `CK8M_DFREQ_FORCE` writer -
...
///Field `SOC_CLK_SEL` reader - SOC clock sel. 0: XTAL 1: PLL 2: CK8M 3: APLL
...
///Field `ANA_CLK_RTC_SEL` reader - slow_clk_rtc sel. 0: SLOW_CK 1: CK_XTAL_32K 2: CK8M_D256_OUT
...
///Field `ANA_CLK_RTC_SEL` writer - slow_clk_rtc sel. 0: SLOW_CK 1: CK_XTAL_32K 2: CK8M_D256_OUT
...
///`reset()` method sets CLK_CONF to value 0x2210
