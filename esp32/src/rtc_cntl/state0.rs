...
///Field `TOUCH_WAKEUP_FORCE_EN` reader - touch controller force wake up
pub type TOUCH_WAKEUP_FORCE_EN_R = crate::BitReader;
///Field `TOUCH_WAKEUP_FORCE_EN` writer - touch controller force wake up
pub type TOUCH_WAKEUP_FORCE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ULP_CP_WAKEUP_FORCE_EN` reader - ULP-coprocessor force wake up
pub type ULP_CP_WAKEUP_FORCE_EN_R = crate::BitReader;
///Field `ULP_CP_WAKEUP_FORCE_EN` writer - ULP-coprocessor force wake up
...
///Field `ULP_CP_SLP_TIMER_EN` reader - ULP-coprocessor timer enable bit
pub type ULP_CP_SLP_TIMER_EN_R = crate::BitReader;
///Field `ULP_CP_SLP_TIMER_EN` writer - ULP-coprocessor timer enable bit
...
///Field `SLP_WAKEUP` reader - sleep wakeup bit
pub type SLP_WAKEUP_R = crate::BitReader;
///Field `SLP_WAKEUP` writer - sleep wakeup bit
pub type SLP_WAKEUP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLP_REJECT` reader - sleep reject bit
pub type SLP_REJECT_R = crate::BitReader;
///Field `SLP_REJECT` writer - sleep reject bit
...
///`reset()` method sets STATE0 to value 0x0030_0000
