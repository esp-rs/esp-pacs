...
impl W {
    #[doc = "Bit 20 - touch controller force wake up"]
    #[inline(always)]
    pub fn touch_wakeup_force_en(&mut self) -> TOUCH_WAKEUP_FORCE_EN_W<'_, STATE0_SPEC> {
        TOUCH_WAKEUP_FORCE_EN_W::new(self, 20)
    }
    #[doc = "Bit 21 - ULP-coprocessor force wake up"]
    #[inline(always)]
    pub fn ulp_cp_wakeup_force_en(&mut self) -> ULP_CP_WAKEUP_FORCE_EN_W<'_, STATE0_SPEC> {
    ...
    #[doc = "Bit 23 - touch timer enable bit"]
    #[inline(always)]
    pub fn touch_slp_timer_en(&mut self) -> TOUCH_SLP_TIMER_EN_W<'_, STATE0_SPEC> {
        TOUCH_SLP_TIMER_EN_W::new(self, 23)
    }
    #[doc = "Bit 24 - ULP-coprocessor timer enable bit"]
    #[inline(always)]
    pub fn ulp_cp_slp_timer_en(&mut self) -> ULP_CP_SLP_TIMER_EN_W<'_, STATE0_SPEC> {
