...
///Field `FASTMEM_FORCE_NOISO` reader - Fast RTC memory force no ISO
pub type FASTMEM_FORCE_NOISO_R = crate::BitReader;
///Field `FASTMEM_FORCE_NOISO` writer - Fast RTC memory force no ISO
pub type FASTMEM_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FASTMEM_FORCE_ISO` reader - Fast RTC memory force ISO
pub type FASTMEM_FORCE_ISO_R = crate::BitReader;
///Field `FASTMEM_FORCE_ISO` writer - Fast RTC memory force ISO
pub type FASTMEM_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLOWMEM_FORCE_NOISO` reader - RTC memory force no ISO
pub type SLOWMEM_FORCE_NOISO_R = crate::BitReader;
///Field `SLOWMEM_FORCE_NOISO` writer - RTC memory force no ISO
pub type SLOWMEM_FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLOWMEM_FORCE_ISO` reader - RTC memory force ISO
pub type SLOWMEM_FORCE_ISO_R = crate::BitReader;
///Field `SLOWMEM_FORCE_ISO` writer - RTC memory force ISO
pub type SLOWMEM_FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FORCE_ISO` reader - rtc_peri force ISO
pub type FORCE_ISO_R = crate::BitReader;
///Field `FORCE_ISO` writer - rtc_peri force ISO
pub type FORCE_ISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FORCE_NOISO` reader - rtc_peri force no ISO
pub type FORCE_NOISO_R = crate::BitReader;
///Field `FORCE_NOISO` writer - rtc_peri force no ISO
pub type FORCE_NOISO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FASTMEM_FOLW_CPU` reader - 1: Fast RTC memory PD following CPU 0: fast RTC memory PD following RTC state machine
pub type FASTMEM_FOLW_CPU_R = crate::BitReader;
///Field `FASTMEM_FOLW_CPU` writer - 1: Fast RTC memory PD following CPU 0: fast RTC memory PD following RTC state machine
pub type FASTMEM_FOLW_CPU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FASTMEM_FORCE_LPD` reader - Fast RTC memory force PD
pub type FASTMEM_FORCE_LPD_R = crate::BitReader;
///Field `FASTMEM_FORCE_LPD` writer - Fast RTC memory force PD
pub type FASTMEM_FORCE_LPD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FASTMEM_FORCE_LPU` reader - Fast RTC memory force no PD
pub type FASTMEM_FORCE_LPU_R = crate::BitReader;
///Field `FASTMEM_FORCE_LPU` writer - Fast RTC memory force no PD
pub type FASTMEM_FORCE_LPU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLOWMEM_FOLW_CPU` reader - 1: RTC memory PD following CPU 0: RTC memory PD following RTC state machine
pub type SLOWMEM_FOLW_CPU_R = crate::BitReader;
///Field `SLOWMEM_FOLW_CPU` writer - 1: RTC memory PD following CPU 0: RTC memory PD following RTC state machine
pub type SLOWMEM_FOLW_CPU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLOWMEM_FORCE_LPD` reader - RTC memory force PD
pub type SLOWMEM_FORCE_LPD_R = crate::BitReader;
///Field `SLOWMEM_FORCE_LPD` writer - RTC memory force PD
pub type SLOWMEM_FORCE_LPD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLOWMEM_FORCE_LPU` reader - RTC memory force no PD
pub type SLOWMEM_FORCE_LPU_R = crate::BitReader;
///Field `SLOWMEM_FORCE_LPU` writer - RTC memory force no PD
pub type SLOWMEM_FORCE_LPU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FASTMEM_FORCE_PD` reader - Fast RTC memory force power down
pub type FASTMEM_FORCE_PD_R = crate::BitReader;
///Field `FASTMEM_FORCE_PD` writer - Fast RTC memory force power down
pub type FASTMEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FASTMEM_FORCE_PU` reader - Fast RTC memory force power up
pub type FASTMEM_FORCE_PU_R = crate::BitReader;
///Field `FASTMEM_FORCE_PU` writer - Fast RTC memory force power up
pub type FASTMEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FASTMEM_PD_EN` reader - enable power down fast RTC memory in sleep
pub type FASTMEM_PD_EN_R = crate::BitReader;
///Field `FASTMEM_PD_EN` writer - enable power down fast RTC memory in sleep
pub type FASTMEM_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLOWMEM_FORCE_PD` reader - RTC memory force power down
pub type SLOWMEM_FORCE_PD_R = crate::BitReader;
///Field `SLOWMEM_FORCE_PD` writer - RTC memory force power down
pub type SLOWMEM_FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLOWMEM_FORCE_PU` reader - RTC memory force power up
pub type SLOWMEM_FORCE_PU_R = crate::BitReader;
///Field `SLOWMEM_FORCE_PU` writer - RTC memory force power up
pub type SLOWMEM_FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLOWMEM_PD_EN` reader - enable power down RTC memory in sleep
pub type SLOWMEM_PD_EN_R = crate::BitReader;
///Field `SLOWMEM_PD_EN` writer - enable power down RTC memory in sleep
pub type SLOWMEM_PD_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FORCE_PD` reader - rtc_peri force power down
pub type FORCE_PD_R = crate::BitReader;
///Field `FORCE_PD` writer - rtc_peri force power down
pub type FORCE_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `FORCE_PU` reader - rtc_peri force power up
pub type FORCE_PU_R = crate::BitReader;
///Field `FORCE_PU` writer - rtc_peri force power up
pub type FORCE_PU_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PD_EN` reader - enable power down rtc_peri in sleep
pub type PD_EN_R = crate::BitReader;
///Field `PD_EN` writer - enable power down rtc_peri in sleep
...
///`reset()` method sets PWC to value 0x0001_2925
