...
///Field `SDIO_PD_EN` reader - power down SDIO_REG in sleep. Only active when reg_sdio_force = 0
pub type SDIO_PD_EN_R = crate::BitReader;
///Field `SDIO_PD_EN` writer - power down SDIO_REG in sleep. Only active when reg_sdio_force = 0
...
///Field `XPD_SDIO` reader - SW option for XPD_SDIO_REG. Only active when reg_sdio_force = 1
pub type XPD_SDIO_R = crate::BitReader;
///Field `XPD_SDIO` writer - SW option for XPD_SDIO_REG. Only active when reg_sdio_force = 1
...
///`reset()` method sets SDIO_CONF to value 0x02a0_0000
