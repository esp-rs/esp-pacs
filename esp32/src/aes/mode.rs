...
///Field `MODE` reader - Selects the AES accelerator mode of operation. See Table 22-1 for details.
pub type MODE_R = crate::FieldReader;
///Field `MODE` writer - Selects the AES accelerator mode of operation. See Table 22-1 for details.
