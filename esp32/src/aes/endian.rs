...
///Field `ENDIAN` reader - Endianness selection register. See Table 22-2 for details.
pub type ENDIAN_R = crate::FieldReader;
///Field `ENDIAN` writer - Endianness selection register. See Table 22-2 for details.
pub type ENDIAN_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - Endianness selection register. See Table 22-2 for details.
    #[inline(always)]
