///Register `HOST_SLCHOST_WIN_CMD` reader
pub type R = crate::R<HOST_SLCHOST_WIN_CMD_SPEC>;
///Register `HOST_SLCHOST_WIN_CMD` writer
...
///`read()` method returns [`host_slchost_win_cmd::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_WIN_CMD_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_win_cmd::W`](W) writer structure
impl crate::Writable for HOST_SLCHOST_WIN_CMD_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HOST_SLCHOST_WIN_CMD to value 0
