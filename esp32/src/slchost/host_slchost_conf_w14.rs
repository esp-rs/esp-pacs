...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLCHOST_CONF_W14")
            .field("host_slchost_conf56", &self.host_slchost_conf56())
            .field("host_slchost_conf57", &self.host_slchost_conf57())
            .field("host_slchost_conf58", &self.host_slchost_conf58())
            .field("host_slchost_conf59", &self.host_slchost_conf59())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`host_slchost_conf_w14::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W14_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w14::W`](W) writer structure
