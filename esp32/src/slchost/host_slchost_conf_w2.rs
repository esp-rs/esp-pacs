...
///`read()` method returns [`host_slchost_conf_w2::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W2_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w2::W`](W) writer structure
