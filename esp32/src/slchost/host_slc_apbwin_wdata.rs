...
///`read()` method returns [`host_slc_apbwin_wdata::R`](R) reader structure
impl crate::Readable for HOST_SLC_APBWIN_WDATA_SPEC {}
///`write(|w| ..)` method takes [`host_slc_apbwin_wdata::W`](W) writer structure
