///Register `HOST_SLC_APBWIN_RDATA` reader
pub type R = crate::R<HOST_SLC_APBWIN_RDATA_SPEC>;
///Field `HOST_SLC_APBWIN_RDATA` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`host_slc_apbwin_rdata::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct HOST_SLC_APBWIN_RDATA_SPEC;
impl crate::RegisterSpec for HOST_SLC_APBWIN_RDATA_SPEC {
    type Ux = u32;
}
///`read()` method returns [`host_slc_apbwin_rdata::R`](R) reader structure
