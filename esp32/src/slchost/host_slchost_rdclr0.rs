...
///`read()` method returns [`host_slchost_rdclr0::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_RDCLR0_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_rdclr0::W`](W) writer structure
impl crate::Writable for HOST_SLCHOST_RDCLR0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HOST_SLCHOST_RDCLR0 to value 0x0003_c044
