...
///`read()` method returns [`host_slchost_conf_w10::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W10_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w10::W`](W) writer structure
