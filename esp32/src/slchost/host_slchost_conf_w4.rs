...
///`read()` method returns [`host_slchost_conf_w4::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W4_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w4::W`](W) writer structure
impl crate::Writable for HOST_SLCHOST_CONF_W4_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HOST_SLCHOST_CONF_W4 to value 0x01ff
