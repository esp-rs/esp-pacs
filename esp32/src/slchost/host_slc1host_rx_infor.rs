///Register `HOST_SLC1HOST_RX_INFOR` reader
pub type R = crate::R<HOST_SLC1HOST_RX_INFOR_SPEC>;
///Register `HOST_SLC1HOST_RX_INFOR` writer
pub type W = crate::W<HOST_SLC1HOST_RX_INFOR_SPEC>;
///Field `HOST_SLC1HOST_RX_INFOR` reader -
pub type HOST_SLC1HOST_RX_INFOR_R = crate::FieldReader<u32>;
///Field `HOST_SLC1HOST_RX_INFOR` writer -
pub type HOST_SLC1HOST_RX_INFOR_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLC1HOST_RX_INFOR")
            .field("host_slc1host_rx_infor", &self.host_slc1host_rx_infor())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`host_slc1host_rx_infor::R`](R) reader structure
impl crate::Readable for HOST_SLC1HOST_RX_INFOR_SPEC {}
///`write(|w| ..)` method takes [`host_slc1host_rx_infor::W`](W) writer structure
