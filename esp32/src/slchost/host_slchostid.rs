...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn host_slchost_id(&mut self) -> HOST_SLCHOST_ID_W<HOST_SLCHOSTID_SPEC> {
...
///`read()` method returns [`host_slchostid::R`](R) reader structure
impl crate::Readable for HOST_SLCHOSTID_SPEC {}
///`write(|w| ..)` method takes [`host_slchostid::W`](W) writer structure
impl crate::Writable for HOST_SLCHOSTID_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HOST_SLCHOSTID to value 0x0600
