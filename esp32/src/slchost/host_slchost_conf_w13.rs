...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLCHOST_CONF_W13")
            .field("host_slchost_conf52", &self.host_slchost_conf52().bits())
            .field("host_slchost_conf53", &self.host_slchost_conf53().bits())
            .field("host_slchost_conf54", &self.host_slchost_conf54().bits())
            .field("host_slchost_conf55", &self.host_slchost_conf55().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
