///Register `HOST_SLCHOST_CONF_W5` reader
pub type R = crate::R<HOST_SLCHOST_CONF_W5_SPEC>;
///Register `HOST_SLCHOST_CONF_W5` writer
...
///`read()` method returns [`host_slchost_conf_w5::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W5_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w5::W`](W) writer structure
