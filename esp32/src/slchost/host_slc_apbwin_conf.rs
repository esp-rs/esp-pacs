...
///`read()` method returns [`host_slc_apbwin_conf::R`](R) reader structure
impl crate::Readable for HOST_SLC_APBWIN_CONF_SPEC {}
///`write(|w| ..)` method takes [`host_slc_apbwin_conf::W`](W) writer structure
