...
impl W {
    ...
    pub fn host_slc_apbwin_addr(
        &mut self,
    ) -> HOST_SLC_APBWIN_ADDR_W<'_, HOST_SLC_APBWIN_CONF_SPEC> {
        HOST_SLC_APBWIN_ADDR_W::new(self, 0)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    pub fn host_slc_apbwin_wr(&mut self) -> HOST_SLC_APBWIN_WR_W<'_, HOST_SLC_APBWIN_CONF_SPEC> {
    ...
    pub fn host_slc_apbwin_start(
        &mut self,
    ) -> HOST_SLC_APBWIN_START_W<'_, HOST_SLC_APBWIN_CONF_SPEC> {
