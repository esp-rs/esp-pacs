///Register `HOST_SLCHOST_CONF_W7` reader
pub type R = crate::R<HOST_SLCHOST_CONF_W7_SPEC>;
///Register `HOST_SLCHOST_CONF_W7` writer
...
///`read()` method returns [`host_slchost_conf_w7::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W7_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w7::W`](W) writer structure
