...
impl W {
    #[doc = "Bits 0:7"]
    #[inline(always)]
    pub fn host_slchost_conf36(&mut self) -> HOST_SLCHOST_CONF36_W<'_, HOST_SLCHOST_CONF_W9_SPEC> {
        HOST_SLCHOST_CONF36_W::new(self, 0)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    pub fn host_slchost_conf37(&mut self) -> HOST_SLCHOST_CONF37_W<'_, HOST_SLCHOST_CONF_W9_SPEC> {
        HOST_SLCHOST_CONF37_W::new(self, 8)
    }
    #[doc = "Bits 16:23"]
    #[inline(always)]
    pub fn host_slchost_conf38(&mut self) -> HOST_SLCHOST_CONF38_W<'_, HOST_SLCHOST_CONF_W9_SPEC> {
        HOST_SLCHOST_CONF38_W::new(self, 16)
    }
    #[doc = "Bits 24:31"]
    #[inline(always)]
    pub fn host_slchost_conf39(&mut self) -> HOST_SLCHOST_CONF39_W<'_, HOST_SLCHOST_CONF_W9_SPEC> {
