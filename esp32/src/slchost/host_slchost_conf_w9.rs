...
///`read()` method returns [`host_slchost_conf_w9::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W9_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w9::W`](W) writer structure
