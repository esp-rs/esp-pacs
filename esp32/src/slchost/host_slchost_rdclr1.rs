...
pub type HOST_SLCHOST_SLC1_BIT7_CLRADDR_W<'a, REG, const O: u8> =
...
pub type HOST_SLCHOST_SLC1_BIT6_CLRADDR_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 9, O, u16>;
impl R {
    #[doc = "Bits 0:8"]
    #[inline(always)]
...
impl W {
    ...
    pub fn host_slchost_slc1_bit7_clraddr(
        &mut self,
    ) -> HOST_SLCHOST_SLC1_BIT7_CLRADDR_W<HOST_SLCHOST_RDCLR1_SPEC, 0> {
    ...
    pub fn host_slchost_slc1_bit6_clraddr(
        &mut self,
    ) -> HOST_SLCHOST_SLC1_BIT6_CLRADDR_W<HOST_SLCHOST_RDCLR1_SPEC, 9> {
