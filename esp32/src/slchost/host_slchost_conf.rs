...
///`read()` method returns [`host_slchost_conf::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf::W`](W) writer structure
