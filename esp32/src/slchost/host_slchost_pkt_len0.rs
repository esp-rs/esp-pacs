///Register `HOST_SLCHOST_PKT_LEN0` reader
pub type R = crate::R<HOST_SLCHOST_PKT_LEN0_SPEC>;
///Field `HOST_HOSTSLC0_LEN0` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`host_slchost_pkt_len0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct HOST_SLCHOST_PKT_LEN0_SPEC;
impl crate::RegisterSpec for HOST_SLCHOST_PKT_LEN0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`host_slchost_pkt_len0::R`](R) reader structure
