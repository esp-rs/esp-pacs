...
///`read()` method returns [`host_slchost_conf_w1::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W1_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w1::W`](W) writer structure
