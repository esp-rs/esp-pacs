///Register `HOST_SLCHOST_PKT_LEN` reader
pub type R = crate::R<HOST_SLCHOST_PKT_LEN_SPEC>;
///Field `HOST_HOSTSLC0_LEN` reader -
pub type HOST_HOSTSLC0_LEN_R = crate::FieldReader<u32>;
///Field `HOST_HOSTSLC0_LEN_CHECK` reader -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLCHOST_PKT_LEN")
            .field("host_hostslc0_len", &self.host_hostslc0_len())
            .field("host_hostslc0_len_check", &self.host_hostslc0_len_check())
            .finish()
    }
}
/**
...
///`read()` method returns [`host_slchost_pkt_len::R`](R) reader structure
