///Register `HOST_SLCHOST_FUNC2_2` reader
pub type R = crate::R<HOST_SLCHOST_FUNC2_2_SPEC>;
///Register `HOST_SLCHOST_FUNC2_2` writer
pub type W = crate::W<HOST_SLCHOST_FUNC2_2_SPEC>;
///Field `HOST_SLC_FUNC1_MDSTAT` reader -
pub type HOST_SLC_FUNC1_MDSTAT_R = crate::BitReader;
///Field `HOST_SLC_FUNC1_MDSTAT` writer -
...
///`read()` method returns [`host_slchost_func2_2::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_FUNC2_2_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_func2_2::W`](W) writer structure
impl crate::Writable for HOST_SLCHOST_FUNC2_2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HOST_SLCHOST_FUNC2_2 to value 0x01
