...
impl W {
    ...
    pub fn host_slc1_tohost_bit0_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOHOST_BIT0_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_tohost_bit1_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOHOST_BIT1_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_tohost_bit2_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOHOST_BIT2_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_tohost_bit3_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOHOST_BIT3_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_tohost_bit4_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOHOST_BIT4_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_tohost_bit5_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOHOST_BIT5_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_tohost_bit6_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOHOST_BIT6_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_tohost_bit7_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOHOST_BIT7_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_token0_1to0_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOKEN0_1TO0_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_token1_1to0_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOKEN1_1TO0_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_token0_0to1_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOKEN0_0TO1_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_token1_0to1_int_clr(
        &mut self,
    ) -> HOST_SLC1_TOKEN1_0TO1_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1host_rx_sof_int_clr(
        &mut self,
    ) -> HOST_SLC1HOST_RX_SOF_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1host_rx_eof_int_clr(
        &mut self,
    ) -> HOST_SLC1HOST_RX_EOF_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1host_rx_start_int_clr(
        &mut self,
    ) -> HOST_SLC1HOST_RX_START_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1host_tx_start_int_clr(
        &mut self,
    ) -> HOST_SLC1HOST_TX_START_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_rx_udf_int_clr(
        &mut self,
    ) -> HOST_SLC1_RX_UDF_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_tx_ovf_int_clr(
        &mut self,
    ) -> HOST_SLC1_TX_OVF_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_rx_pf_valid_int_clr(
        &mut self,
    ) -> HOST_SLC1_RX_PF_VALID_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_ext_bit0_int_clr(
        &mut self,
    ) -> HOST_SLC1_EXT_BIT0_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_ext_bit1_int_clr(
        &mut self,
    ) -> HOST_SLC1_EXT_BIT1_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_ext_bit2_int_clr(
        &mut self,
    ) -> HOST_SLC1_EXT_BIT2_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_ext_bit3_int_clr(
        &mut self,
    ) -> HOST_SLC1_EXT_BIT3_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_wifi_rx_new_packet_int_clr(
        &mut self,
    ) -> HOST_SLC1_WIFI_RX_NEW_PACKET_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_host_rd_retry_int_clr(
        &mut self,
    ) -> HOST_SLC1_HOST_RD_RETRY_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
    ...
    pub fn host_slc1_bt_rx_new_packet_int_clr(
        &mut self,
    ) -> HOST_SLC1_BT_RX_NEW_PACKET_INT_CLR_W<'_, HOST_SLC1HOST_INT_CLR_SPEC> {
