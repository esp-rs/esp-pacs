...
pub type HOST_FN2_SLC0_TOHOST_BIT0_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOHOST_BIT1_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOHOST_BIT2_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOHOST_BIT3_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOHOST_BIT4_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOHOST_BIT5_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOHOST_BIT6_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOHOST_BIT7_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOKEN0_1TO0_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOKEN1_1TO0_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOKEN0_0TO1_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TOKEN1_0TO1_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0HOST_RX_SOF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0HOST_RX_EOF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0HOST_RX_START_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0HOST_TX_START_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_RX_UDF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_TX_OVF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_RX_PF_VALID_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_EXT_BIT0_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_EXT_BIT1_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_EXT_BIT2_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_EXT_BIT3_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_RX_NEW_PACKET_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_SLC0_HOST_RD_RETRY_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_FN2_GPIO_SDIO_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    pub fn host_fn2_slc0_tohost_bit0_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOHOST_BIT0_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 0> {
    ...
    pub fn host_fn2_slc0_tohost_bit1_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOHOST_BIT1_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 1> {
    ...
    pub fn host_fn2_slc0_tohost_bit2_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOHOST_BIT2_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 2> {
    ...
    pub fn host_fn2_slc0_tohost_bit3_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOHOST_BIT3_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 3> {
    ...
    pub fn host_fn2_slc0_tohost_bit4_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOHOST_BIT4_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 4> {
    ...
    pub fn host_fn2_slc0_tohost_bit5_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOHOST_BIT5_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 5> {
    ...
    pub fn host_fn2_slc0_tohost_bit6_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOHOST_BIT6_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 6> {
    ...
    pub fn host_fn2_slc0_tohost_bit7_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOHOST_BIT7_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 7> {
    ...
    pub fn host_fn2_slc0_token0_1to0_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOKEN0_1TO0_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 8> {
    ...
    pub fn host_fn2_slc0_token1_1to0_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOKEN1_1TO0_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 9> {
    ...
    pub fn host_fn2_slc0_token0_0to1_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOKEN0_0TO1_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 10> {
    ...
    pub fn host_fn2_slc0_token1_0to1_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TOKEN1_0TO1_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 11> {
    ...
    pub fn host_fn2_slc0host_rx_sof_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0HOST_RX_SOF_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 12> {
    ...
    pub fn host_fn2_slc0host_rx_eof_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0HOST_RX_EOF_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 13> {
    ...
    pub fn host_fn2_slc0host_rx_start_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0HOST_RX_START_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 14> {
    ...
    pub fn host_fn2_slc0host_tx_start_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0HOST_TX_START_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 15> {
    ...
    pub fn host_fn2_slc0_rx_udf_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_RX_UDF_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 16> {
    ...
    pub fn host_fn2_slc0_tx_ovf_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_TX_OVF_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 17> {
    ...
    pub fn host_fn2_slc0_rx_pf_valid_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_RX_PF_VALID_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 18> {
    ...
    pub fn host_fn2_slc0_ext_bit0_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_EXT_BIT0_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 19> {
    ...
    pub fn host_fn2_slc0_ext_bit1_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_EXT_BIT1_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 20> {
    ...
    pub fn host_fn2_slc0_ext_bit2_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_EXT_BIT2_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 21> {
    ...
    pub fn host_fn2_slc0_ext_bit3_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_EXT_BIT3_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 22> {
    ...
    pub fn host_fn2_slc0_rx_new_packet_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_RX_NEW_PACKET_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 23> {
    ...
    pub fn host_fn2_slc0_host_rd_retry_int_ena(
        &mut self,
    ) -> HOST_FN2_SLC0_HOST_RD_RETRY_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 24> {
    ...
    pub fn host_fn2_gpio_sdio_int_ena(
        &mut self,
    ) -> HOST_FN2_GPIO_SDIO_INT_ENA_W<HOST_SLC0HOST_FUNC2_INT_ENA_SPEC, 25> {
