///Register `HOST_SLCHOST_PKT_LEN2` reader
pub type R = crate::R<HOST_SLCHOST_PKT_LEN2_SPEC>;
///Field `HOST_HOSTSLC0_LEN2` reader -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLCHOST_PKT_LEN2")
            .field("host_hostslc0_len2", &self.host_hostslc0_len2())
            .finish()
    }
}
/**
...
///`read()` method returns [`host_slchost_pkt_len2::R`](R) reader structure
