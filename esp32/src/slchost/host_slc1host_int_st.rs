    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLC1HOST_INT_ST")
            ...
            .field(
                ...
                &self.host_slc1host_tx_start_int_st(),
            )
            ...
            .field(
                ...
                &self.host_slc1_host_rd_retry_int_st(),
            )
            .field(
                "host_slc1_bt_rx_new_packet_int_st",
                &self.host_slc1_bt_rx_new_packet_int_st(),
            )
            .finish()
    }
}
...
You can [`read`](crate::generic::Reg::read) this register and get [`host_slc1host_int_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct HOST_SLC1HOST_INT_ST_SPEC;
impl crate::RegisterSpec for HOST_SLC1HOST_INT_ST_SPEC {
    type Ux = u32;
}
///`read()` method returns [`host_slc1host_int_st::R`](R) reader structure
