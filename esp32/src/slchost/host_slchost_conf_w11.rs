...
///`read()` method returns [`host_slchost_conf_w11::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W11_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w11::W`](W) writer structure
