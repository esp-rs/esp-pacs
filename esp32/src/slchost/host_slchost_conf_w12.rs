...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLCHOST_CONF_W12")
            .field("host_slchost_conf48", &self.host_slchost_conf48())
            .field("host_slchost_conf49", &self.host_slchost_conf49())
            .field("host_slchost_conf50", &self.host_slchost_conf50())
            .field("host_slchost_conf51", &self.host_slchost_conf51())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:7"]
    #[inline(always)]
    pub fn host_slchost_conf48(&mut self) -> HOST_SLCHOST_CONF48_W<'_, HOST_SLCHOST_CONF_W12_SPEC> {
        HOST_SLCHOST_CONF48_W::new(self, 0)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    pub fn host_slchost_conf49(&mut self) -> HOST_SLCHOST_CONF49_W<'_, HOST_SLCHOST_CONF_W12_SPEC> {
        HOST_SLCHOST_CONF49_W::new(self, 8)
    }
    #[doc = "Bits 16:23"]
    #[inline(always)]
    pub fn host_slchost_conf50(&mut self) -> HOST_SLCHOST_CONF50_W<'_, HOST_SLCHOST_CONF_W12_SPEC> {
        HOST_SLCHOST_CONF50_W::new(self, 16)
    }
    #[doc = "Bits 24:31"]
    #[inline(always)]
    pub fn host_slchost_conf51(&mut self) -> HOST_SLCHOST_CONF51_W<'_, HOST_SLCHOST_CONF_W12_SPEC> {
        HOST_SLCHOST_CONF51_W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`host_slchost_conf_w12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`host_slchost_conf_w12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
