...
///`read()` method returns [`host_slchost_conf_w12::R`](R) reader structure
impl crate::Readable for HOST_SLCHOST_CONF_W12_SPEC {}
///`write(|w| ..)` method takes [`host_slchost_conf_w12::W`](W) writer structure
