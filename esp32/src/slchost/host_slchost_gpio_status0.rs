///Register `HOST_SLCHOST_GPIO_STATUS0` reader
pub type R = crate::R<HOST_SLCHOST_GPIO_STATUS0_SPEC>;
///Field `HOST_GPIO_SDIO_INT0` reader -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLCHOST_GPIO_STATUS0")
            .field("host_gpio_sdio_int0", &self.host_gpio_sdio_int0())
            .finish()
    }
}
/**

You can [`read`](crate::generic::Reg::read) this register and get [`host_slchost_gpio_status0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct HOST_SLCHOST_GPIO_STATUS0_SPEC;
impl crate::RegisterSpec for HOST_SLCHOST_GPIO_STATUS0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`host_slchost_gpio_status0::R`](R) reader structure
