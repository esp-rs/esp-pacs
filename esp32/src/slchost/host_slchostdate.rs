...
///`read()` method returns [`host_slchostdate::R`](R) reader structure
impl crate::Readable for HOST_SLCHOSTDATE_SPEC {}
///`write(|w| ..)` method takes [`host_slchostdate::W`](W) writer structure
impl crate::Writable for HOST_SLCHOSTDATE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets HOST_SLCHOSTDATE to value 0x1602_2500
