///Register `HOST_SLCHOST_PKT_LEN1` reader
pub type R = crate::R<HOST_SLCHOST_PKT_LEN1_SPEC>;
///Field `HOST_HOSTSLC0_LEN1` reader -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLCHOST_PKT_LEN1")
            .field("host_hostslc0_len1", &self.host_hostslc0_len1())
            .finish()
    }
}
/**
...
///`read()` method returns [`host_slchost_pkt_len1::R`](R) reader structure
