...
pub type HOST_SLC0HOST_RX_INFOR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 20, O, u32>;
impl R {
    #[doc = "Bits 0:19"]
    #[inline(always)]
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<HOST_SLC0HOST_RX_INFOR_SPEC> {
...
impl W {
    ...
    pub fn host_slc0host_rx_infor(
        &mut self,
    ) -> HOST_SLC0HOST_RX_INFOR_W<HOST_SLC0HOST_RX_INFOR_SPEC, 0> {
