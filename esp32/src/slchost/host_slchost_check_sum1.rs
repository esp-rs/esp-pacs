///Register `HOST_SLCHOST_CHECK_SUM1` reader
pub type R = crate::R<HOST_SLCHOST_CHECK_SUM1_SPEC>;
///Field `HOST_SLCHOST_CHECK_SUM1` reader -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HOST_SLCHOST_CHECK_SUM1")
            .field("host_slchost_check_sum1", &self.host_slchost_check_sum1())
            .finish()
    }
}
/**
...
///`read()` method returns [`host_slchost_check_sum1::R`](R) reader structure
