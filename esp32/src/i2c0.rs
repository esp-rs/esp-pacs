...
#[doc = ""]
pub mod slave_addr;
#[doc = "RXFIFO_ST (r) register accessor: \n\nYou can [`read`](crate::Reg::read) this register and get [`rxfifo_st::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rxfifo_st`] module"]
...
#[doc = "SCL_FILTER_CFG (rw) register accessor: \n\nYou can [`read`](crate::Reg::read) this register and get [`scl_filter_cfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scl_filter_cfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@scl_filter_cfg`] module"]
pub type SCL_FILTER_CFG = crate::Reg<scl_filter_cfg::SCL_FILTER_CFG_SPEC>;
#[doc = ""]
pub mod scl_filter_cfg;
#[doc = "SDA_FILTER_CFG (rw) register accessor: \n\nYou can [`read`](crate::Reg::read) this register and get [`sda_filter_cfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sda_filter_cfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sda_filter_cfg`] module"]
...
pub use crate::apb_ctrl::DATE;
#[doc = "FIFO_START_ADDR (rw) register accessor: \n\nYou can [`read`](crate::Reg::read) this register and get [`fifo_start_addr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fifo_start_addr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fifo_start_addr`] module"]
