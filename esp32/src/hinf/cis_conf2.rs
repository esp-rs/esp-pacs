...
pub type CIS_CONF_W2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CIS_CONF2_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cis_conf_w2(&mut self) -> CIS_CONF_W2_W<CIS_CONF2_SPEC, 0> {
