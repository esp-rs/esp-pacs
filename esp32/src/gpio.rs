...
/**BT_SELECT (rw) register accessor:
...
///
pub mod out1;
/**OUT1_W1TS (rw) register accessor:
...
///
pub mod out1_w1ts;
/**OUT1_W1TC (rw) register accessor:
...
///
pub mod out1_w1tc;
/**SDIO_SELECT (rw) register accessor:
...
///
pub mod acpu_int;
/**ACPU_NMI_INT (r) register accessor:
...
///
pub mod pcpu_int;
/**PCPU_NMI_INT (r) register accessor:
...
/**CPUSDIO_INT (r) register accessor:
...
///
pub mod acpu_int1;
/**ACPU_NMI_INT1 (r) register accessor:
...
///
pub mod pcpu_int1;
/**PCPU_NMI_INT1 (r) register accessor:
...
/**CPUSDIO_INT1 (rw) register accessor:
...
///
pub mod pin;
/**cali_conf (rw) register accessor:
...
///
pub mod cali_data;
/**FUNC_IN_SEL_CFG (rw) register accessor:
...
/**FUNC_OUT_SEL_CFG (rw) register accessor:
