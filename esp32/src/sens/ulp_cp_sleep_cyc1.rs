...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ULP_CP_SLEEP_CYC1")
            .field("sleep_cycles_s1", &self.sleep_cycles_s1())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`ulp_cp_sleep_cyc1::R`](R) reader structure
impl crate::Readable for ULP_CP_SLEEP_CYC1_SPEC {}
///`write(|w| ..)` method takes [`ulp_cp_sleep_cyc1::W`](W) writer structure
impl crate::Writable for ULP_CP_SLEEP_CYC1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ULP_CP_SLEEP_CYC1 to value 0x64
