...
///`read()` method returns [`sar_touch_thres1::R`](R) reader structure
impl crate::Readable for SAR_TOUCH_THRES1_SPEC {}
///`write(|w| ..)` method takes [`sar_touch_thres1::W`](W) writer structure
