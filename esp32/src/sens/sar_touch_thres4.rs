...
///`read()` method returns [`sar_touch_thres4::R`](R) reader structure
impl crate::Readable for SAR_TOUCH_THRES4_SPEC {}
///`write(|w| ..)` method takes [`sar_touch_thres4::W`](W) writer structure
