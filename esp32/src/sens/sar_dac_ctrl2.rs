...
///Field `DAC_SCALE1` reader - 00: no scale 01: scale to 1/2 10: scale to 1/4 scale to 1/8
pub type DAC_SCALE1_R = crate::FieldReader;
///Field `DAC_SCALE1` writer - 00: no scale 01: scale to 1/2 10: scale to 1/4 scale to 1/8
pub type DAC_SCALE1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DAC_SCALE2` reader - 00: no scale 01: scale to 1/2 10: scale to 1/4 scale to 1/8
pub type DAC_SCALE2_R = crate::FieldReader;
///Field `DAC_SCALE2` writer - 00: no scale 01: scale to 1/2 10: scale to 1/4 scale to 1/8
pub type DAC_SCALE2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DAC_INV1` reader - 00: do not invert any bits 01: invert all bits 10: invert MSB 11: invert all bits except MSB
pub type DAC_INV1_R = crate::FieldReader;
///Field `DAC_INV1` writer - 00: do not invert any bits 01: invert all bits 10: invert MSB 11: invert all bits except MSB
pub type DAC_INV1_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DAC_INV2` reader - 00: do not invert any bits 01: invert all bits 10: invert MSB 11: invert all bits except MSB
pub type DAC_INV2_R = crate::FieldReader;
///Field `DAC_INV2` writer - 00: do not invert any bits 01: invert all bits 10: invert MSB 11: invert all bits except MSB
pub type DAC_INV2_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `DAC_CW_EN1` reader - 1: to select CW generator as source to PDAC1_DAC\[7:0\] 0: to select register reg_pdac1_dac\[7:0\] as source to PDAC1_DAC\[7:0\]
pub type DAC_CW_EN1_R = crate::BitReader;
///Field `DAC_CW_EN1` writer - 1: to select CW generator as source to PDAC1_DAC\[7:0\] 0: to select register reg_pdac1_dac\[7:0\] as source to PDAC1_DAC\[7:0\]
pub type DAC_CW_EN1_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DAC_CW_EN2` reader - 1: to select CW generator as source to PDAC2_DAC\[7:0\] 0: to select register reg_pdac2_dac\[7:0\] as source to PDAC2_DAC\[7:0\]
pub type DAC_CW_EN2_R = crate::BitReader;
///Field `DAC_CW_EN2` writer - 1: to select CW generator as source to PDAC2_DAC\[7:0\] 0: to select register reg_pdac2_dac\[7:0\] as source to PDAC2_DAC\[7:0\]
