...
///Field `TSENS_RDY_OUT` reader - indicate temperature sensor out ready
...
impl R {
    ...
    ///Bits 22:29 - temperature sensor data out
    #[inline(always)]
    pub fn tsens_out(&self) -> TSENS_OUT_R {
        TSENS_OUT_R::new(((self.bits >> 22) & 0xff) as u8)
    }
    ///Bit 30 - indicate temperature sensor out ready
    #[inline(always)]
