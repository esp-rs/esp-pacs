///Register `SAR_TOUCH_OUT5` reader
pub type R = crate::R<SAR_TOUCH_OUT5_SPEC>;
///Field `TOUCH_MEAS_OUT9` reader - the counter for touch pad 9
pub type TOUCH_MEAS_OUT9_R = crate::FieldReader<u16>;
///Field `TOUCH_MEAS_OUT8` reader - the counter for touch pad 8
...
///`read()` method returns [`sar_touch_out5::R`](R) reader structure
