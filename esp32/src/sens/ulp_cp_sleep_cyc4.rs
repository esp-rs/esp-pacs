...
///`read()` method returns [`ulp_cp_sleep_cyc4::R`](R) reader structure
impl crate::Readable for ULP_CP_SLEEP_CYC4_SPEC {}
///`write(|w| ..)` method takes [`ulp_cp_sleep_cyc4::W`](W) writer structure
impl crate::Writable for ULP_CP_SLEEP_CYC4_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ULP_CP_SLEEP_CYC4 to value 0x14
