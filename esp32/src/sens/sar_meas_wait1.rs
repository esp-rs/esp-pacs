///Register `SAR_MEAS_WAIT1` reader
pub type R = crate::R<SAR_MEAS_WAIT1_SPEC>;
///Register `SAR_MEAS_WAIT1` writer
...
///`read()` method returns [`sar_meas_wait1::R`](R) reader structure
impl crate::Readable for SAR_MEAS_WAIT1_SPEC {}
///`write(|w| ..)` method takes [`sar_meas_wait1::W`](W) writer structure
impl crate::Writable for SAR_MEAS_WAIT1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAR_MEAS_WAIT1 to value 0x000a_000a
