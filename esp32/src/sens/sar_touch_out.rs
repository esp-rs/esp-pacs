#[doc = "Register `SAR_TOUCH_OUT%s` reader"]
pub type R = crate::R<SAR_TOUCH_OUT_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_TOUCH_OUT")
            .field("touch_meas_out1", &self.touch_meas_out1())
            .field("touch_meas_out0", &self.touch_meas_out0())
            .finish()
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`sar_touch_out::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SAR_TOUCH_OUT_SPEC;
impl crate::RegisterSpec for SAR_TOUCH_OUT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sar_touch_out::R`](R) reader structure"]
impl crate::Readable for SAR_TOUCH_OUT_SPEC {}
#[doc = "`reset()` method sets SAR_TOUCH_OUT%s to value 0"]
impl crate::Resettable for SAR_TOUCH_OUT_SPEC {}
