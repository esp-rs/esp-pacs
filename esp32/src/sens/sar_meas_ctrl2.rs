...
///`read()` method returns [`sar_meas_ctrl2::R`](R) reader structure
impl crate::Readable for SAR_MEAS_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`sar_meas_ctrl2::W`](W) writer structure
impl crate::Writable for SAR_MEAS_CTRL2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAR_MEAS_CTRL2 to value 0x03
