...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SAR_MEM_WR_CTRL")
            .field("mem_wr_addr_init", &self.mem_wr_addr_init())
            .field("mem_wr_addr_size", &self.mem_wr_addr_size())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`sar_mem_wr_ctrl::R`](R) reader structure
impl crate::Readable for SAR_MEM_WR_CTRL_SPEC {}
///`write(|w| ..)` method takes [`sar_mem_wr_ctrl::W`](W) writer structure
impl crate::Writable for SAR_MEM_WR_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAR_MEM_WR_CTRL to value 0x0010_0200
