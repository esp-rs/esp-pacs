...
///Field `SW_TONE_EN` reader - 1: enable CW generator 0: disable CW generator
pub type SW_TONE_EN_R = crate::BitReader;
///Field `SW_TONE_EN` writer - 1: enable CW generator 0: disable CW generator
...
///Field `DAC_DIG_FORCE` reader - 1: DAC1 &amp; DAC2 use DMA 0: DAC1 &amp; DAC2 do not use DMA
pub type DAC_DIG_FORCE_R = crate::BitReader;
///Field `DAC_DIG_FORCE` writer - 1: DAC1 &amp; DAC2 use DMA 0: DAC1 &amp; DAC2 do not use DMA
