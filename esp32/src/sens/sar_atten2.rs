...
///Field `SAR2_ATTEN` reader - 2-bit attenuation for each pad 11:1dB 10:6dB 01:3dB 00:0dB
pub type SAR2_ATTEN_R = crate::FieldReader<u32>;
///Field `SAR2_ATTEN` writer - 2-bit attenuation for each pad 11:1dB 10:6dB 01:3dB 00:0dB
