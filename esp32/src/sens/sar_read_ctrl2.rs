///Register `SAR_READ_CTRL2` reader
pub type R = crate::R<SAR_READ_CTRL2_SPEC>;
///Register `SAR_READ_CTRL2` writer
...
///Field `SAR2_SAMPLE_CYCLE` reader - sample cycles for SAR ADC2
pub type SAR2_SAMPLE_CYCLE_R = crate::FieldReader;
///Field `SAR2_SAMPLE_CYCLE` writer - sample cycles for SAR ADC2
pub type SAR2_SAMPLE_CYCLE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SAR2_SAMPLE_BIT` reader - 00: for 9-bit width 01: for 10-bit width 10: for 11-bit width 11: for 12-bit width
pub type SAR2_SAMPLE_BIT_R = crate::FieldReader;
///Field `SAR2_SAMPLE_BIT` writer - 00: for 9-bit width 01: for 10-bit width 10: for 11-bit width 11: for 12-bit width
...
///Field `SAR2_PWDET_FORCE` reader -
pub type SAR2_PWDET_FORCE_R = crate::BitReader;
///Field `SAR2_PWDET_FORCE` writer -
pub type SAR2_PWDET_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR2_DIG_FORCE` reader - 1: SAR ADC2 controlled by DIG ADC2 CTRL or PWDET CTRL 0: SAR ADC2 controlled by RTC ADC2 CTRL
pub type SAR2_DIG_FORCE_R = crate::BitReader;
///Field `SAR2_DIG_FORCE` writer - 1: SAR ADC2 controlled by DIG ADC2 CTRL or PWDET CTRL 0: SAR ADC2 controlled by RTC ADC2 CTRL
...
You can [`read`](crate::generic::Reg::read) this register and get [`sar_read_ctrl2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sar_read_ctrl2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct SAR_READ_CTRL2_SPEC;
impl crate::RegisterSpec for SAR_READ_CTRL2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`sar_read_ctrl2::R`](R) reader structure
impl crate::Readable for SAR_READ_CTRL2_SPEC {}
///`write(|w| ..)` method takes [`sar_read_ctrl2::W`](W) writer structure
impl crate::Writable for SAR_READ_CTRL2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAR_READ_CTRL2 to value 0x0007_0902
