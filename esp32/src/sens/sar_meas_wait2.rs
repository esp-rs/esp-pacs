...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn force_xpd_sar_sw(&mut self) -> FORCE_XPD_SAR_SW_W<'_, SAR_MEAS_WAIT2_SPEC> {
        FORCE_XPD_SAR_SW_W::new(self, 0)
    }
    #[doc = "Bits 0:15"]
    #[inline(always)]
    pub fn sar_amp_wait3(&mut self) -> SAR_AMP_WAIT3_W<'_, SAR_MEAS_WAIT2_SPEC> {
        SAR_AMP_WAIT3_W::new(self, 0)
    }
    #[doc = "Bits 16:17"]
    #[inline(always)]
    pub fn force_xpd_amp(&mut self) -> FORCE_XPD_AMP_W<'_, SAR_MEAS_WAIT2_SPEC> {
        FORCE_XPD_AMP_W::new(self, 16)
    }
    #[doc = "Bits 18:19"]
    #[inline(always)]
    pub fn force_xpd_sar(&mut self) -> FORCE_XPD_SAR_W<'_, SAR_MEAS_WAIT2_SPEC> {
        FORCE_XPD_SAR_W::new(self, 18)
    }
    #[doc = "Bits 20:27"]
    #[inline(always)]
    pub fn sar2_rstb_wait(&mut self) -> SAR2_RSTB_WAIT_W<'_, SAR_MEAS_WAIT2_SPEC> {
        SAR2_RSTB_WAIT_W::new(self, 20)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`sar_meas_wait2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sar_meas_wait2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
