...
pub type SLEEP_CYCLES_S2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sleep_cycles_s2(&mut self) -> SLEEP_CYCLES_S2_W<ULP_CP_SLEEP_CYC2_SPEC, 0> {
