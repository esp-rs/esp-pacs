///Register `SAR_READ_CTRL` reader
pub type R = crate::R<SAR_READ_CTRL_SPEC>;
///Register `SAR_READ_CTRL` writer
pub type W = crate::W<SAR_READ_CTRL_SPEC>;
///Field `SAR1_CLK_DIV` reader - clock divider
pub type SAR1_CLK_DIV_R = crate::FieldReader;
///Field `SAR1_CLK_DIV` writer - clock divider
pub type SAR1_CLK_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SAR1_SAMPLE_CYCLE` reader - sample cycles for SAR ADC1
pub type SAR1_SAMPLE_CYCLE_R = crate::FieldReader;
///Field `SAR1_SAMPLE_CYCLE` writer - sample cycles for SAR ADC1
pub type SAR1_SAMPLE_CYCLE_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SAR1_SAMPLE_BIT` reader - 00: for 9-bit width 01: for 10-bit width 10: for 11-bit width 11: for 12-bit width
pub type SAR1_SAMPLE_BIT_R = crate::FieldReader;
///Field `SAR1_SAMPLE_BIT` writer - 00: for 9-bit width 01: for 10-bit width 10: for 11-bit width 11: for 12-bit width
pub type SAR1_SAMPLE_BIT_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SAR1_CLK_GATED` reader -
pub type SAR1_CLK_GATED_R = crate::BitReader;
///Field `SAR1_CLK_GATED` writer -
pub type SAR1_CLK_GATED_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR1_SAMPLE_NUM` reader -
pub type SAR1_SAMPLE_NUM_R = crate::FieldReader;
///Field `SAR1_SAMPLE_NUM` writer -
pub type SAR1_SAMPLE_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SAR1_DIG_FORCE` reader - 1: SAR ADC1 controlled by DIG ADC1 CTRL 0: SAR ADC1 controlled by RTC ADC1 CTRL
pub type SAR1_DIG_FORCE_R = crate::BitReader;
///Field `SAR1_DIG_FORCE` writer - 1: SAR ADC1 controlled by DIG ADC1 CTRL 0: SAR ADC1 controlled by RTC ADC1 CTRL
pub type SAR1_DIG_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR1_DATA_INV` reader - Invert SAR ADC1 data
pub type SAR1_DATA_INV_R = crate::BitReader;
///Field `SAR1_DATA_INV` writer - Invert SAR ADC1 data
...
///`read()` method returns [`sar_read_ctrl::R`](R) reader structure
impl crate::Readable for SAR_READ_CTRL_SPEC {}
///`write(|w| ..)` method takes [`sar_read_ctrl::W`](W) writer structure
impl crate::Writable for SAR_READ_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAR_READ_CTRL to value 0x0007_0902
