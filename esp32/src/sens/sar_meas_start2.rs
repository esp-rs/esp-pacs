///Register `SAR_MEAS_START2` reader
pub type R = crate::R<SAR_MEAS_START2_SPEC>;
///Register `SAR_MEAS_START2` writer
pub type W = crate::W<SAR_MEAS_START2_SPEC>;
...
///Field `MEAS2_START_SAR` reader - SAR ADC2 controller (in RTC) starts conversion only active when reg_meas2_start_force = 1
pub type MEAS2_START_SAR_R = crate::BitReader;
///Field `MEAS2_START_SAR` writer - SAR ADC2 controller (in RTC) starts conversion only active when reg_meas2_start_force = 1
pub type MEAS2_START_SAR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEAS2_START_FORCE` reader - 1: SAR ADC2 controller (in RTC) is started by SW 0: SAR ADC2 controller is started by ULP-coprocessor
pub type MEAS2_START_FORCE_R = crate::BitReader;
///Field `MEAS2_START_FORCE` writer - 1: SAR ADC2 controller (in RTC) is started by SW 0: SAR ADC2 controller is started by ULP-coprocessor
pub type MEAS2_START_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR2_EN_PAD` reader - SAR ADC2 pad enable bitmap only active when reg_sar2_en_pad_force = 1
pub type SAR2_EN_PAD_R = crate::FieldReader<u16>;
///Field `SAR2_EN_PAD` writer - SAR ADC2 pad enable bitmap only active when reg_sar2_en_pad_force = 1
pub type SAR2_EN_PAD_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `SAR2_EN_PAD_FORCE` reader - 1: SAR ADC2 pad enable bitmap is controlled by SW 0: SAR ADC2 pad enable bitmap is controlled by ULP-coprocessor
pub type SAR2_EN_PAD_FORCE_R = crate::BitReader;
///Field `SAR2_EN_PAD_FORCE` writer - 1: SAR ADC2 pad enable bitmap is controlled by SW 0: SAR ADC2 pad enable bitmap is controlled by ULP-coprocessor
...
You can [`read`](crate::generic::Reg::read) this register and get [`sar_meas_start2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sar_meas_start2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct SAR_MEAS_START2_SPEC;
impl crate::RegisterSpec for SAR_MEAS_START2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`sar_meas_start2::R`](R) reader structure
impl crate::Readable for SAR_MEAS_START2_SPEC {}
///`write(|w| ..)` method takes [`sar_meas_start2::W`](W) writer structure
