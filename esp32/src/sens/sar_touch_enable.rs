///Register `SAR_TOUCH_ENABLE` reader
pub type R = crate::R<SAR_TOUCH_ENABLE_SPEC>;
///Register `SAR_TOUCH_ENABLE` writer
pub type W = crate::W<SAR_TOUCH_ENABLE_SPEC>;
///Field `TOUCH_PAD_WORKEN` reader - Bitmap defining the working set during the measurement.
pub type TOUCH_PAD_WORKEN_R = crate::FieldReader<u16>;
///Field `TOUCH_PAD_WORKEN` writer - Bitmap defining the working set during the measurement.
pub type TOUCH_PAD_WORKEN_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `TOUCH_PAD_OUTEN2` reader - Bitmap defining SET2 for generating wakeup interrupt. SET2 is "touched" only if at least one of touch pad in SET2 is "touched".
pub type TOUCH_PAD_OUTEN2_R = crate::FieldReader<u16>;
///Field `TOUCH_PAD_OUTEN2` writer - Bitmap defining SET2 for generating wakeup interrupt. SET2 is "touched" only if at least one of touch pad in SET2 is "touched".
pub type TOUCH_PAD_OUTEN2_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
///Field `TOUCH_PAD_OUTEN1` reader - Bitmap defining SET1 for generating wakeup interrupt. SET1 is "touched" only if at least one of touch pad in SET1 is "touched".
pub type TOUCH_PAD_OUTEN1_R = crate::FieldReader<u16>;
///Field `TOUCH_PAD_OUTEN1` writer - Bitmap defining SET1 for generating wakeup interrupt. SET1 is "touched" only if at least one of touch pad in SET1 is "touched".
...
///`read()` method returns [`sar_touch_enable::R`](R) reader structure
impl crate::Readable for SAR_TOUCH_ENABLE_SPEC {}
///`write(|w| ..)` method takes [`sar_touch_enable::W`](W) writer structure
impl crate::Writable for SAR_TOUCH_ENABLE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAR_TOUCH_ENABLE to value 0x3fff_ffff
