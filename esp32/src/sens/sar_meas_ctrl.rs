///Register `SAR_MEAS_CTRL` reader
pub type R = crate::R<SAR_MEAS_CTRL_SPEC>;
///Register `SAR_MEAS_CTRL` writer
...
///`read()` method returns [`sar_meas_ctrl::R`](R) reader structure
impl crate::Readable for SAR_MEAS_CTRL_SPEC {}
///`write(|w| ..)` method takes [`sar_meas_ctrl::W`](W) writer structure
impl crate::Writable for SAR_MEAS_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SAR_MEAS_CTRL to value 0x0707_338f
