...
///Field `CH_TX_END(0-7)` reader - Set this bit to enable rmt_ch%s_tx_end_int_st.
pub type CH_TX_END_R = crate::BitReader;
///Field `CH_TX_END(0-7)` writer - Set this bit to enable rmt_ch%s_tx_end_int_st.
pub type CH_TX_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_RX_END(0-7)` reader - Set this bit to enable rmt_ch%s_rx_end_int_st.
pub type CH_RX_END_R = crate::BitReader;
///Field `CH_RX_END(0-7)` writer - Set this bit to enable rmt_ch%s_rx_end_int_st.
pub type CH_RX_END_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_ERR(0-7)` reader - Set this bit to enable rmt_ch%s_err_int_st.
pub type CH_ERR_R = crate::BitReader;
///Field `CH_ERR(0-7)` writer - Set this bit to enable rmt_ch%s_err_int_st.
pub type CH_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CH_TX_THR_EVENT(0-7)` reader - Set this bit to enable rmt_ch%s_tx_thr_event_int_st.
pub type CH_TX_THR_EVENT_R = crate::BitReader;
///Field `CH_TX_THR_EVENT(0-7)` writer - Set this bit to enable rmt_ch%s_tx_thr_event_int_st.
pub type CH_TX_THR_EVENT_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Set this bit to enable rmt_ch(0-7)_tx_end_int_st.
    ///
    ...
    ///Bit 0 - Set this bit to enable rmt_ch0_tx_end_int_st.
    #[inline(always)]
    ...
    ///Bit 6 - Set this bit to enable rmt_ch2_tx_end_int_st.
    #[inline(always)]
    pub fn ch2_tx_end(&self) -> CH_TX_END_R {
        CH_TX_END_R::new(((self.bits >> 6) & 1) != 0)
    }
    ///Bit 9 - Set this bit to enable rmt_ch3_tx_end_int_st.
    #[inline(always)]
    pub fn ch3_tx_end(&self) -> CH_TX_END_R {
        CH_TX_END_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 12 - Set this bit to enable rmt_ch4_tx_end_int_st.
    #[inline(always)]
    pub fn ch4_tx_end(&self) -> CH_TX_END_R {
        CH_TX_END_R::new(((self.bits >> 12) & 1) != 0)
    }
    ///Bit 15 - Set this bit to enable rmt_ch5_tx_end_int_st.
    #[inline(always)]
    ...
    ///Bit 21 - Set this bit to enable rmt_ch7_tx_end_int_st.
    #[inline(always)]
    pub fn ch7_tx_end(&self) -> CH_TX_END_R {
        CH_TX_END_R::new(((self.bits >> 21) & 1) != 0)
    }
    ///Set this bit to enable rmt_ch(0-7)_rx_end_int_st.
    ///
    ...
    ///Bit 2 - Set this bit to enable rmt_ch0_err_int_st.
    #[inline(always)]
    pub fn ch0_err(&self) -> CH_ERR_R {
        CH_ERR_R::new(((self.bits >> 2) & 1) != 0)
    }
    ///Bit 5 - Set this bit to enable rmt_ch1_err_int_st.
    #[inline(always)]
    pub fn ch1_err(&self) -> CH_ERR_R {
        CH_ERR_R::new(((self.bits >> 5) & 1) != 0)
    }
    ///Bit 8 - Set this bit to enable rmt_ch2_err_int_st.
    #[inline(always)]
    pub fn ch2_err(&self) -> CH_ERR_R {
        CH_ERR_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 11 - Set this bit to enable rmt_ch3_err_int_st.
    #[inline(always)]
    ...
    ///Bit 17 - Set this bit to enable rmt_ch5_err_int_st.
    #[inline(always)]
    pub fn ch5_err(&self) -> CH_ERR_R {
        CH_ERR_R::new(((self.bits >> 17) & 1) != 0)
    }
    ///Bit 20 - Set this bit to enable rmt_ch6_err_int_st.
    #[inline(always)]
    pub fn ch6_err(&self) -> CH_ERR_R {
        CH_ERR_R::new(((self.bits >> 20) & 1) != 0)
    }
    ///Bit 23 - Set this bit to enable rmt_ch7_err_int_st.
    #[inline(always)]
    pub fn ch7_err(&self) -> CH_ERR_R {
        CH_ERR_R::new(((self.bits >> 23) & 1) != 0)
    }
    ///Set this bit to enable rmt_ch(0-7)_tx_thr_event_int_st.
    ///
    ...
    ///Bit 31 - Set this bit to enable rmt_ch7_tx_thr_event_int_st.
    #[inline(always)]
