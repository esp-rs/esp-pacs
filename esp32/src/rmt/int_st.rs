...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            ...
            .field("ch4_tx_end", &self.ch4_tx_end().bit())
            .field("ch5_tx_end", &self.ch5_tx_end().bit())
            .field("ch6_tx_end", &self.ch6_tx_end().bit())
            .field("ch7_tx_end", &self.ch7_tx_end().bit())
            ...
            .field("ch4_err", &self.ch4_err().bit())
            .field("ch5_err", &self.ch5_err().bit())
            .field("ch6_err", &self.ch6_err().bit())
            .field("ch7_err", &self.ch7_err().bit())
            ...
            .field("ch4_tx_thr_event", &self.ch4_tx_thr_event().bit())
            .field("ch5_tx_thr_event", &self.ch5_tx_thr_event().bit())
            .field("ch6_tx_thr_event", &self.ch6_tx_thr_event().bit())
            .field("ch7_tx_thr_event", &self.ch7_tx_thr_event().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
