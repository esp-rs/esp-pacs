...
pub type CARRIER_LOW_W<'a, const O: u8> = crate::FieldWriter<'a, CH2CARRIER_DUTY_SPEC, 16, O, u16>;
...
pub type CARRIER_HIGH_W<'a, const O: u8> = crate::FieldWriter<'a, CH2CARRIER_DUTY_SPEC, 16, O, u16>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH2CARRIER_DUTY")
            .field(
                "carrier_low",
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CH2CARRIER_DUTY_SPEC> {
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch2carrier_duty](index.html) module"]
pub struct CH2CARRIER_DUTY_SPEC;
impl crate::RegisterSpec for CH2CARRIER_DUTY_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch2carrier_duty::R](R) reader structure"]
impl crate::Readable for CH2CARRIER_DUTY_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch2carrier_duty::W](W) writer structure"]
