...
pub type CARRIER_LOW_W<'a, const O: u8> = crate::FieldWriter<'a, CH6CARRIER_DUTY_SPEC, 16, O, u16>;
...
pub type CARRIER_HIGH_W<'a, const O: u8> = crate::FieldWriter<'a, CH6CARRIER_DUTY_SPEC, 16, O, u16>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CH6CARRIER_DUTY")
            .field(
                "carrier_low",
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CH6CARRIER_DUTY_SPEC> {
