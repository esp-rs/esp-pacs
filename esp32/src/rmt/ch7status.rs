...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<CH7STATUS_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        self.read().fmt(f)
    }
}
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch7status](index.html) module"]
pub struct CH7STATUS_SPEC;
impl crate::RegisterSpec for CH7STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch7status::R](R) reader structure"]
