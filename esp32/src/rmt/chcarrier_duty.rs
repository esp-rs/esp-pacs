...
///Field `CARRIER_LOW` reader - This register is used to configure carrier wave's low level value for channel0.
pub type CARRIER_LOW_R = crate::FieldReader<u16>;
///Field `CARRIER_LOW` writer - This register is used to configure carrier wave's low level value for channel0.
pub type CARRIER_LOW_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `CARRIER_HIGH` reader - This register is used to configure carrier wave's high level value for channel0.
pub type CARRIER_HIGH_R = crate::FieldReader<u16>;
///Field `CARRIER_HIGH` writer - This register is used to configure carrier wave's high level value for channel0.
pub type CARRIER_HIGH_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - This register is used to configure carrier wave's low level value for channel0.
    #[inline(always)]
    pub fn carrier_low(&self) -> CARRIER_LOW_R {
        CARRIER_LOW_R::new((self.bits & 0xffff) as u16)
    }
    ///Bits 16:31 - This register is used to configure carrier wave's high level value for channel0.
    #[inline(always)]
