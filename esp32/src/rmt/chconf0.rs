...
///Field `DIV_CNT` reader - This register is used to configure the frequency divider's factor in channel0.
pub type DIV_CNT_R = crate::FieldReader;
///Field `DIV_CNT` writer - This register is used to configure the frequency divider's factor in channel0.
pub type DIV_CNT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `IDLE_THRES` reader - In receive mode when no edge is detected on the input signal for longer than reg_idle_thres_ch0 then the receive process is done.
pub type IDLE_THRES_R = crate::FieldReader<u16>;
///Field `IDLE_THRES` writer - In receive mode when no edge is detected on the input signal for longer than reg_idle_thres_ch0 then the receive process is done.
pub type IDLE_THRES_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `MEM_SIZE` reader - This register is used to configure the the amount of memory blocks allocated to channel0.
pub type MEM_SIZE_R = crate::FieldReader;
///Field `MEM_SIZE` writer - This register is used to configure the the amount of memory blocks allocated to channel0.
pub type MEM_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `CARRIER_EN` reader - This is the carrier modulation enable control bit for channel0.
pub type CARRIER_EN_R = crate::BitReader;
///Field `CARRIER_EN` writer - This is the carrier modulation enable control bit for channel0.
pub type CARRIER_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CARRIER_OUT_LV` reader - This bit is used to configure the way carrier wave is modulated for channel0.1'b1:transmit on low output level 1'b0:transmit on high output level.
pub type CARRIER_OUT_LV_R = crate::BitReader;
///Field `CARRIER_OUT_LV` writer - This bit is used to configure the way carrier wave is modulated for channel0.1'b1:transmit on low output level 1'b0:transmit on high output level.
pub type CARRIER_OUT_LV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MEM_PD` reader - This bit is used to reduce power consumed by mem. 1:mem is in low power state.
pub type MEM_PD_R = crate::BitReader;
///Field `MEM_PD` writer - This bit is used to reduce power consumed by mem. 1:mem is in low power state.
pub type MEM_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CLK_EN` reader - This bit is used to control clock.when software config RMT internal registers it controls the register clock.
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - This bit is used to control clock.when software config RMT internal registers it controls the register clock.
...
///`read()` method returns [`chconf0::R`](R) reader structure
impl crate::Readable for CHCONF0_SPEC {}
///`write(|w| ..)` method takes [`chconf0::W`](W) writer structure
impl crate::Writable for CHCONF0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CH%sCONF0 to value 0x3110_0002
