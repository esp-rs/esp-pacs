...
///Field `SLAVE_TRANS_COMPLETE` reader - Slave accepted 1 byte and address matched
pub type SLAVE_TRANS_COMPLETE_R = crate::BitReader;
///Field `SLAVE_TRANS_COMPLETE` writer - Slave accepted 1 byte and address matched
pub type SLAVE_TRANS_COMPLETE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ARBITRATION_LOST` reader - Master lost arbitration
pub type ARBITRATION_LOST_R = crate::BitReader;
///Field `ARBITRATION_LOST` writer - Master lost arbitration
...
///Field `TRANS_COMPLETE` reader - Stop condition has been detected interrupt raw status
pub type TRANS_COMPLETE_R = crate::BitReader;
///Field `TRANS_COMPLETE` writer - Stop condition has been detected interrupt raw status
pub type TRANS_COMPLETE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIME_OUT` reader - time out interrupt raw status
