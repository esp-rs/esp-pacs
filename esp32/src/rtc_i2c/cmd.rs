...
///Field `VAL` reader - Command content
pub type VAL_R = crate::FieldReader<u16>;
///Field `VAL` writer - Command content
pub type VAL_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
///Field `DONE` reader - Bit is set by HW when command is done
pub type DONE_R = crate::BitReader;
///Field `DONE` writer - Bit is set by HW when command is done
