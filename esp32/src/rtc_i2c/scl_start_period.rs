...
///Field `SCL_START_PERIOD` reader - Number of FAST_CLK cycles to wait before generating start condition
pub type SCL_START_PERIOD_R = crate::FieldReader<u32>;
///Field `SCL_START_PERIOD` writer - Number of FAST_CLK cycles to wait before generating start condition
pub type SCL_START_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19 - Number of FAST_CLK cycles to wait before generating start condition
    #[inline(always)]
