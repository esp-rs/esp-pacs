...
///Field `TIMEOUT` reader - Maximum number of FAST_CLK cycles that the transmission can take
pub type TIMEOUT_R = crate::FieldReader<u32>;
///Field `TIMEOUT` writer - Maximum number of FAST_CLK cycles that the transmission can take
pub type TIMEOUT_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19 - Maximum number of FAST_CLK cycles that the transmission can take
    #[inline(always)]
