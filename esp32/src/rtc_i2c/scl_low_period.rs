...
///Field `SCL_LOW_PERIOD` reader - number of cycles that scl == 0
pub type SCL_LOW_PERIOD_R = crate::FieldReader<u32>;
///Field `SCL_LOW_PERIOD` writer - number of cycles that scl == 0
pub type SCL_LOW_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
