...
///Field `SCL_STOP_PERIOD` reader - Number of FAST_CLK cycles to wait before generating stop condition
pub type SCL_STOP_PERIOD_R = crate::FieldReader<u32>;
///Field `SCL_STOP_PERIOD` writer - Number of FAST_CLK cycles to wait before generating stop condition
