...
///Field `ADDRESS` writer - The physical address on the off-chip flash must be 8-word boundary aligned.
...
impl W {
    ///Bits 0:7 - The physical address on the off-chip flash must be 8-word boundary aligned.
    #[inline(always)]
    #[must_use]
