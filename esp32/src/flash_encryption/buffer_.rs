///Register `BUFFER_%s` writer
pub type W = crate::W<BUFFER__SPEC>;
///Field `BUFFER` writer - Data buffers for encryption.
...
impl W {
    ///Bits 0:7 - Data buffers for encryption.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`buffer_::W`](W) writer structure
impl crate::Writable for BUFFER__SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets BUFFER_%s to value 0
