...
pub type R = crate::R<HSCH_CONF0_SPEC>;
#[doc = "Register `HSCH%s_CONF0` writer"]
pub type W = crate::W<HSCH_CONF0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer_sel(&mut self) -> TIMER_SEL_W<HSCH_CONF0_SPEC, 0> {
        TIMER_SEL_W::new(self)
    }
    #[doc = "Bit 2 - This is the output enable control bit for high speed channel0"]
    #[inline(always)]
    #[must_use]
    pub fn sig_out_en(&mut self) -> SIG_OUT_EN_W<HSCH_CONF0_SPEC, 2> {
        SIG_OUT_EN_W::new(self)
    }
    #[doc = "Bit 3 - This bit is used to control the output value when high speed channel0 is off."]
    #[inline(always)]
    #[must_use]
    pub fn idle_lv(&mut self) -> IDLE_LV_W<HSCH_CONF0_SPEC, 3> {
        IDLE_LV_W::new(self)
    }
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hsch_conf0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hsch_conf0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
