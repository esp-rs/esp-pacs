...
pub type DUTY_RES_W<'a, const O: u8> = crate::FieldWriter<'a, LSTIMER_CONF_SPEC, 5, O>;
...
pub type DIV_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, LSTIMER_CONF_SPEC, 18, O, u32, u32>;
...
pub type PAUSE_W<'a, const O: u8> = crate::BitWriter<'a, LSTIMER_CONF_SPEC, O>;
...
pub type RST_W<'a, const O: u8> = crate::BitWriter<'a, LSTIMER_CONF_SPEC, O>;
...
pub type TICK_SEL_W<'a, const O: u8> = crate::BitWriter<'a, LSTIMER_CONF_SPEC, O>;
...
pub type PARA_UP_W<'a, const O: u8> = crate::BitWriter<'a, LSTIMER_CONF_SPEC, O>;
#[doc = "Field `LIM` reader - "]
pub type LIM_R = crate::FieldReader;
#[doc = "Field `LIM` writer - "]
pub type LIM_W<'a, const O: u8> = crate::FieldWriter<'a, LSTIMER_CONF_SPEC, 5, O>;
impl R {
