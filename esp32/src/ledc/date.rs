...
///Field `DATE` reader - This register represents the version .
pub type DATE_R = crate::FieldReader<u32>;
///Field `DATE` writer - This register represents the version .
pub type DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - This register represents the version .
    #[inline(always)]
...
///`reset()` method sets DATE to value 0x1603_1700
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: u32 = 0x1603_1700;
}
