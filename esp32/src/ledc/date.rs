...
#[doc = "Field `DATE` reader - This register represents the version ."]
pub type DATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATE` writer - This register represents the version ."]
...
#[doc = "`reset()` method sets DATE to value 0x1603_1700"]
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x1603_1700;
}
