...
pub type DUTY_SCALE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HSCH_CONF1_SPEC, u16, u16, 10, O>;
...
pub type DUTY_INC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSCH_CONF1_SPEC, bool, O>;
...
pub type DUTY_START_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSCH_CONF1_SPEC, bool, O>;
impl R {
