...
pub type HSTIMER0_OVF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HSTIMER1_OVF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HSTIMER2_OVF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HSTIMER3_OVF_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_HSCH0_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_HSCH1_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_HSCH2_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_HSCH3_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_HSCH4_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_HSCH5_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_HSCH6_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_HSCH7_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_LSCH6_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DUTY_CHNG_END_LSCH7_INT_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hstimer0_ovf_int_ena(&mut self) -> HSTIMER0_OVF_INT_ENA_W<INT_ENA_SPEC, 0> {
        HSTIMER0_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 1 - The interrupt enable bit for high speed channel1 counter overflow interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn hstimer1_ovf_int_ena(&mut self) -> HSTIMER1_OVF_INT_ENA_W<INT_ENA_SPEC, 1> {
        HSTIMER1_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 2 - The interrupt enable bit for high speed channel2 counter overflow interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn hstimer2_ovf_int_ena(&mut self) -> HSTIMER2_OVF_INT_ENA_W<INT_ENA_SPEC, 2> {
        HSTIMER2_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 3 - The interrupt enable bit for high speed channel3 counter overflow interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn hstimer3_ovf_int_ena(&mut self) -> HSTIMER3_OVF_INT_ENA_W<INT_ENA_SPEC, 3> {
        HSTIMER3_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 4 - The interrupt enable bit for low speed channel0 counter overflow interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer0_ovf_int_ena(&mut self) -> LSTIMER0_OVF_INT_ENA_W<INT_ENA_SPEC, 4> {
        LSTIMER0_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 5 - The interrupt enable bit for low speed channel1 counter overflow interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer1_ovf_int_ena(&mut self) -> LSTIMER1_OVF_INT_ENA_W<INT_ENA_SPEC, 5> {
        LSTIMER1_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 6 - The interrupt enable bit for low speed channel2 counter overflow interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer2_ovf_int_ena(&mut self) -> LSTIMER2_OVF_INT_ENA_W<INT_ENA_SPEC, 6> {
        LSTIMER2_OVF_INT_ENA_W::new(self)
    }
    #[doc = "Bit 7 - The interrupt enable bit for low speed channel3 counter overflow interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer3_ovf_int_ena(&mut self) -> LSTIMER3_OVF_INT_ENA_W<INT_ENA_SPEC, 7> {
    ...
    pub fn duty_chng_end_hsch0_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_HSCH0_INT_ENA_W<INT_ENA_SPEC, 8> {
    ...
    pub fn duty_chng_end_hsch1_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_HSCH1_INT_ENA_W<INT_ENA_SPEC, 9> {
    ...
    pub fn duty_chng_end_hsch2_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_HSCH2_INT_ENA_W<INT_ENA_SPEC, 10> {
    ...
    pub fn duty_chng_end_hsch3_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_HSCH3_INT_ENA_W<INT_ENA_SPEC, 11> {
    ...
    pub fn duty_chng_end_hsch4_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_HSCH4_INT_ENA_W<INT_ENA_SPEC, 12> {
    ...
    pub fn duty_chng_end_hsch5_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_HSCH5_INT_ENA_W<INT_ENA_SPEC, 13> {
    ...
    pub fn duty_chng_end_hsch6_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_HSCH6_INT_ENA_W<INT_ENA_SPEC, 14> {
    ...
    pub fn duty_chng_end_hsch7_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_HSCH7_INT_ENA_W<INT_ENA_SPEC, 15> {
    ...
    pub fn duty_chng_end_lsch0_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH0_INT_ENA_W<INT_ENA_SPEC, 16> {
    ...
    pub fn duty_chng_end_lsch1_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH1_INT_ENA_W<INT_ENA_SPEC, 17> {
    ...
    pub fn duty_chng_end_lsch2_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH2_INT_ENA_W<INT_ENA_SPEC, 18> {
    ...
    pub fn duty_chng_end_lsch3_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH3_INT_ENA_W<INT_ENA_SPEC, 19> {
    ...
    pub fn duty_chng_end_lsch4_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH4_INT_ENA_W<INT_ENA_SPEC, 20> {
    ...
    pub fn duty_chng_end_lsch5_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH5_INT_ENA_W<INT_ENA_SPEC, 21> {
    ...
    pub fn duty_chng_end_lsch6_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH6_INT_ENA_W<INT_ENA_SPEC, 22> {
    ...
    pub fn duty_chng_end_lsch7_int_ena(
        &mut self,
    ) -> DUTY_CHNG_END_LSCH7_INT_ENA_W<INT_ENA_SPEC, 23> {
