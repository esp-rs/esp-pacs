...
///Field `HSTIMER_OVF(0-3)` reader - The interrupt enable bit for high speed channel%s counter overflow interrupt.
pub type HSTIMER_OVF_R = crate::BitReader;
///Field `HSTIMER_OVF(0-3)` writer - The interrupt enable bit for high speed channel%s counter overflow interrupt.
pub type HSTIMER_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `LSTIMER_OVF(0-3)` reader - The interrupt enable bit for low speed channel%s counter overflow interrupt.
pub type LSTIMER_OVF_R = crate::BitReader;
///Field `LSTIMER_OVF(0-3)` writer - The interrupt enable bit for low speed channel%s counter overflow interrupt.
pub type LSTIMER_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DUTY_CHNG_END_HSCH(0-7)` reader - The interrupt enable bit for high speed channel %s duty change done interrupt.
pub type DUTY_CHNG_END_HSCH_R = crate::BitReader;
///Field `DUTY_CHNG_END_HSCH(0-7)` writer - The interrupt enable bit for high speed channel %s duty change done interrupt.
pub type DUTY_CHNG_END_HSCH_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DUTY_CHNG_END_LSCH(0-7)` reader - The interrupt enable bit for low speed channel %s duty change done interrupt.
pub type DUTY_CHNG_END_LSCH_R = crate::BitReader;
///Field `DUTY_CHNG_END_LSCH(0-7)` writer - The interrupt enable bit for low speed channel %s duty change done interrupt.
