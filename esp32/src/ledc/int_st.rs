...
///Field `HSTIMER_OVF(0-3)` reader - The interrupt status bit for high speed channel%s counter overflow event.
pub type HSTIMER_OVF_R = crate::BitReader;
///Field `LSTIMER_OVF(0-3)` reader - The interrupt status bit for low speed channel%s counter overflow event.
pub type LSTIMER_OVF_R = crate::BitReader;
///Field `DUTY_CHNG_END_HSCH(0-7)` reader - The interrupt status bit for high speed channel %s duty change done event.
pub type DUTY_CHNG_END_HSCH_R = crate::BitReader;
///Field `DUTY_CHNG_END_LSCH(0-7)` reader - The interrupt status bit for low speed channel %s duty change done event.
pub type DUTY_CHNG_END_LSCH_R = crate::BitReader;
impl R {
    ///The interrupt status bit for high speed channel(0-3) counter overflow event.
    ///
    ...
    ///The interrupt status bit for low speed channel(0-3) counter overflow event.
    ///
