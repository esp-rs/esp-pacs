...
#[doc = "Field `HSTIMER0_OVF` reader - The interrupt status bit for high speed channel0 counter overflow event."]
pub type HSTIMER0_OVF_R = crate::BitReader;
#[doc = "Field `HSTIMER1_OVF` reader - The interrupt status bit for high speed channel1 counter overflow event."]
pub type HSTIMER1_OVF_R = crate::BitReader;
#[doc = "Field `HSTIMER2_OVF` reader - The interrupt status bit for high speed channel2 counter overflow event."]
pub type HSTIMER2_OVF_R = crate::BitReader;
#[doc = "Field `HSTIMER3_OVF` reader - The interrupt status bit for high speed channel3 counter overflow event."]
pub type HSTIMER3_OVF_R = crate::BitReader;
#[doc = "Field `LSTIMER0_OVF` reader - The interrupt status bit for low speed channel0 counter overflow event."]
pub type LSTIMER0_OVF_R = crate::BitReader;
#[doc = "Field `LSTIMER1_OVF` reader - The interrupt status bit for low speed channel1 counter overflow event."]
pub type LSTIMER1_OVF_R = crate::BitReader;
#[doc = "Field `LSTIMER2_OVF` reader - The interrupt status bit for low speed channel2 counter overflow event."]
pub type LSTIMER2_OVF_R = crate::BitReader;
#[doc = "Field `LSTIMER3_OVF` reader - The interrupt status bit for low speed channel3 counter overflow event."]
pub type LSTIMER3_OVF_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_HSCH0` reader - The interrupt status bit for high speed channel 0 duty change done event."]
pub type DUTY_CHNG_END_HSCH0_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_HSCH1` reader - The interrupt status bit for high speed channel 1 duty change done event."]
pub type DUTY_CHNG_END_HSCH1_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_HSCH2` reader - The interrupt status bit for high speed channel 2 duty change done event."]
pub type DUTY_CHNG_END_HSCH2_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_HSCH3` reader - The interrupt status bit for high speed channel 3 duty change done event."]
pub type DUTY_CHNG_END_HSCH3_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_HSCH4` reader - The interrupt status bit for high speed channel 4 duty change done event."]
pub type DUTY_CHNG_END_HSCH4_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_HSCH5` reader - The interrupt status bit for high speed channel 5 duty change done event."]
pub type DUTY_CHNG_END_HSCH5_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_HSCH6` reader - The interrupt status bit for high speed channel 6 duty change done event."]
pub type DUTY_CHNG_END_HSCH6_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_HSCH7` reader - The interrupt status bit for high speed channel 7 duty change done event."]
pub type DUTY_CHNG_END_HSCH7_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_LSCH0` reader - The interrupt status bit for low speed channel 0 duty change done event."]
pub type DUTY_CHNG_END_LSCH0_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_LSCH1` reader - The interrupt status bit for low speed channel 1 duty change done event."]
pub type DUTY_CHNG_END_LSCH1_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_LSCH2` reader - The interrupt status bit for low speed channel 2 duty change done event."]
pub type DUTY_CHNG_END_LSCH2_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_LSCH3` reader - The interrupt status bit for low speed channel 3 duty change done event."]
pub type DUTY_CHNG_END_LSCH3_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_LSCH4` reader - The interrupt status bit for low speed channel 4 duty change done event."]
pub type DUTY_CHNG_END_LSCH4_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_LSCH5` reader - The interrupt status bit for low speed channel 5 duty change done event."]
pub type DUTY_CHNG_END_LSCH5_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_LSCH6` reader - The interrupt status bit for low speed channel 6 duty change done event."]
pub type DUTY_CHNG_END_LSCH6_R = crate::BitReader;
#[doc = "Field `DUTY_CHNG_END_LSCH7` reader - The interrupt status bit for low speed channel 7 duty change done event"]
