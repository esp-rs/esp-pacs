...
///Field `DUTY_R` reader - This register represents the current duty cycle of the output signal for low-speed channel %s
pub type DUTY_R_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:24 - This register represents the current duty cycle of the output signal for low-speed channel %s
    #[inline(always)]
