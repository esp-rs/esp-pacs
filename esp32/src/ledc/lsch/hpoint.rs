...
///Field `HPOINT` reader - The output value changes to high when lstimerx(x=\[0 3\]) selected by low speed channel0 has reached reg_hpoint_lsch0\[19:0\]
pub type HPOINT_R = crate::FieldReader<u32>;
///Field `HPOINT` writer - The output value changes to high when lstimerx(x=\[0 3\]) selected by low speed channel0 has reached reg_hpoint_lsch0\[19:0\]
pub type HPOINT_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19 - The output value changes to high when lstimerx(x=\[0 3\]) selected by low speed channel0 has reached reg_hpoint_lsch0\[19:0\]
    #[inline(always)]
