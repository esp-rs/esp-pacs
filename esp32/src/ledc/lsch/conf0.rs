...
///Field `TIMER_SEL` reader - There are four low speed timers the two bits are used to select one of them for low speed channel0. 2'b00: seletc lstimer0. 2'b01: select lstimer1. 2'b10: select lstimer2. 2'b11: select lstimer3.
pub type TIMER_SEL_R = crate::FieldReader;
///Field `TIMER_SEL` writer - There are four low speed timers the two bits are used to select one of them for low speed channel0. 2'b00: seletc lstimer0. 2'b01: select lstimer1. 2'b10: select lstimer2. 2'b11: select lstimer3.
pub type TIMER_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SIG_OUT_EN` reader - This is the output enable control bit for low speed channel0.
pub type SIG_OUT_EN_R = crate::BitReader;
///Field `SIG_OUT_EN` writer - This is the output enable control bit for low speed channel0.
pub type SIG_OUT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IDLE_LV` reader - This bit is used to control the output value when low speed channel0 is off.
pub type IDLE_LV_R = crate::BitReader;
///Field `IDLE_LV` writer - This bit is used to control the output value when low speed channel0 is off.
pub type IDLE_LV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `PARA_UP` reader - This bit is used to update register LEDC_LSCH0_HPOINT and LEDC_LSCH0_DUTY for low speed channel0.
pub type PARA_UP_R = crate::BitReader;
///Field `PARA_UP` writer - This bit is used to update register LEDC_LSCH0_HPOINT and LEDC_LSCH0_DUTY for low speed channel0.
