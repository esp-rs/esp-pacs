...
#[doc = "Field `HSTIMER0_OVF` writer - The interrupt raw bit for high speed channel0 counter overflow."]
...
#[doc = "Field `HSTIMER1_OVF` writer - The interrupt raw bit for high speed channel1 counter overflow."]
...
#[doc = "Field `HSTIMER2_OVF` writer - The interrupt raw bit for high speed channel2 counter overflow."]
...
#[doc = "Field `HSTIMER3_OVF` writer - The interrupt raw bit for high speed channel3 counter overflow."]
...
#[doc = "Field `LSTIMER0_OVF` writer - The interrupt raw bit for low speed channel0 counter overflow."]
...
#[doc = "Field `LSTIMER1_OVF` writer - The interrupt raw bit for low speed channel1 counter overflow."]
...
#[doc = "Field `LSTIMER2_OVF` writer - The interrupt raw bit for low speed channel2 counter overflow."]
...
#[doc = "Field `LSTIMER3_OVF` writer - The interrupt raw bit for low speed channel3 counter overflow."]
...
#[doc = "Field `DUTY_CHNG_END_HSCH0` writer - The interrupt raw bit for high speed channel 0 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_HSCH1` writer - The interrupt raw bit for high speed channel 1 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_HSCH2` writer - The interrupt raw bit for high speed channel 2 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_HSCH3` writer - The interrupt raw bit for high speed channel 3 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_HSCH4` writer - The interrupt raw bit for high speed channel 4 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_HSCH5` writer - The interrupt raw bit for high speed channel 5 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_HSCH6` writer - The interrupt raw bit for high speed channel 6 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_HSCH7` writer - The interrupt raw bit for high speed channel 7 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_LSCH0` writer - The interrupt raw bit for low speed channel 0 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_LSCH1` writer - The interrupt raw bit for low speed channel 1 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_LSCH2` writer - The interrupt raw bit for low speed channel 2 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_LSCH3` writer - The interrupt raw bit for low speed channel 3 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_LSCH4` writer - The interrupt raw bit for low speed channel 4 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_LSCH5` writer - The interrupt raw bit for low speed channel 5 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_LSCH6` writer - The interrupt raw bit for low speed channel 6 duty change done."]
...
#[doc = "Field `DUTY_CHNG_END_LSCH7` writer - The interrupt raw bit for low speed channel 7 duty change done."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hstimer0_ovf(&mut self) -> HSTIMER0_OVF_W<INT_RAW_SPEC> {
        HSTIMER0_OVF_W::new(self, 0)
    }
    #[doc = "Bit 1 - The interrupt raw bit for high speed channel1 counter overflow."]
    #[inline(always)]
    #[must_use]
    pub fn hstimer1_ovf(&mut self) -> HSTIMER1_OVF_W<INT_RAW_SPEC> {
        HSTIMER1_OVF_W::new(self, 1)
    }
    #[doc = "Bit 2 - The interrupt raw bit for high speed channel2 counter overflow."]
    #[inline(always)]
    #[must_use]
    pub fn hstimer2_ovf(&mut self) -> HSTIMER2_OVF_W<INT_RAW_SPEC> {
        HSTIMER2_OVF_W::new(self, 2)
    }
    #[doc = "Bit 3 - The interrupt raw bit for high speed channel3 counter overflow."]
    #[inline(always)]
    #[must_use]
    pub fn hstimer3_ovf(&mut self) -> HSTIMER3_OVF_W<INT_RAW_SPEC> {
        HSTIMER3_OVF_W::new(self, 3)
    }
    #[doc = "Bit 4 - The interrupt raw bit for low speed channel0 counter overflow."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer0_ovf(&mut self) -> LSTIMER0_OVF_W<INT_RAW_SPEC> {
        LSTIMER0_OVF_W::new(self, 4)
    }
    #[doc = "Bit 5 - The interrupt raw bit for low speed channel1 counter overflow."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer1_ovf(&mut self) -> LSTIMER1_OVF_W<INT_RAW_SPEC> {
        LSTIMER1_OVF_W::new(self, 5)
    }
    #[doc = "Bit 6 - The interrupt raw bit for low speed channel2 counter overflow."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer2_ovf(&mut self) -> LSTIMER2_OVF_W<INT_RAW_SPEC> {
        LSTIMER2_OVF_W::new(self, 6)
    }
    #[doc = "Bit 7 - The interrupt raw bit for low speed channel3 counter overflow."]
    #[inline(always)]
    #[must_use]
    pub fn lstimer3_ovf(&mut self) -> LSTIMER3_OVF_W<INT_RAW_SPEC> {
        LSTIMER3_OVF_W::new(self, 7)
    }
    #[doc = "Bit 8 - The interrupt raw bit for high speed channel 0 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_hsch0(&mut self) -> DUTY_CHNG_END_HSCH0_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_HSCH0_W::new(self, 8)
    }
    #[doc = "Bit 9 - The interrupt raw bit for high speed channel 1 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_hsch1(&mut self) -> DUTY_CHNG_END_HSCH1_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_HSCH1_W::new(self, 9)
    }
    #[doc = "Bit 10 - The interrupt raw bit for high speed channel 2 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_hsch2(&mut self) -> DUTY_CHNG_END_HSCH2_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_HSCH2_W::new(self, 10)
    }
    #[doc = "Bit 11 - The interrupt raw bit for high speed channel 3 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_hsch3(&mut self) -> DUTY_CHNG_END_HSCH3_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_HSCH3_W::new(self, 11)
    }
    #[doc = "Bit 12 - The interrupt raw bit for high speed channel 4 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_hsch4(&mut self) -> DUTY_CHNG_END_HSCH4_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_HSCH4_W::new(self, 12)
    }
    #[doc = "Bit 13 - The interrupt raw bit for high speed channel 5 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_hsch5(&mut self) -> DUTY_CHNG_END_HSCH5_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_HSCH5_W::new(self, 13)
    }
    #[doc = "Bit 14 - The interrupt raw bit for high speed channel 6 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_hsch6(&mut self) -> DUTY_CHNG_END_HSCH6_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_HSCH6_W::new(self, 14)
    }
    #[doc = "Bit 15 - The interrupt raw bit for high speed channel 7 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_hsch7(&mut self) -> DUTY_CHNG_END_HSCH7_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_HSCH7_W::new(self, 15)
    }
    #[doc = "Bit 16 - The interrupt raw bit for low speed channel 0 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch0(&mut self) -> DUTY_CHNG_END_LSCH0_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH0_W::new(self, 16)
    }
    #[doc = "Bit 17 - The interrupt raw bit for low speed channel 1 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch1(&mut self) -> DUTY_CHNG_END_LSCH1_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH1_W::new(self, 17)
    }
    #[doc = "Bit 18 - The interrupt raw bit for low speed channel 2 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch2(&mut self) -> DUTY_CHNG_END_LSCH2_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH2_W::new(self, 18)
    }
    #[doc = "Bit 19 - The interrupt raw bit for low speed channel 3 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch3(&mut self) -> DUTY_CHNG_END_LSCH3_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH3_W::new(self, 19)
    }
    #[doc = "Bit 20 - The interrupt raw bit for low speed channel 4 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch4(&mut self) -> DUTY_CHNG_END_LSCH4_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH4_W::new(self, 20)
    }
    #[doc = "Bit 21 - The interrupt raw bit for low speed channel 5 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch5(&mut self) -> DUTY_CHNG_END_LSCH5_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH5_W::new(self, 21)
    }
    #[doc = "Bit 22 - The interrupt raw bit for low speed channel 6 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch6(&mut self) -> DUTY_CHNG_END_LSCH6_W<INT_RAW_SPEC> {
        DUTY_CHNG_END_LSCH6_W::new(self, 22)
    }
    #[doc = "Bit 23 - The interrupt raw bit for low speed channel 7 duty change done."]
    #[inline(always)]
    #[must_use]
    pub fn duty_chng_end_lsch7(&mut self) -> DUTY_CHNG_END_LSCH7_W<INT_RAW_SPEC> {
