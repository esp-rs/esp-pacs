...
///Field `DUTY_RES` reader - This register controls the range of the counter in high speed timer0. the counter range is \[0 2**reg_hstimer0_lim\] the max bit width for counter is 20.
pub type DUTY_RES_R = crate::FieldReader;
///Field `DUTY_RES` writer - This register controls the range of the counter in high speed timer0. the counter range is \[0 2**reg_hstimer0_lim\] the max bit width for counter is 20.
pub type DUTY_RES_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `DIV_NUM` reader - This register is used to configure parameter for divider in high speed timer0 the least significant eight bits represent the decimal part.
pub type DIV_NUM_R = crate::FieldReader<u32>;
///Field `DIV_NUM` writer - This register is used to configure parameter for divider in high speed timer0 the least significant eight bits represent the decimal part.
pub type DIV_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 18, u32>;
///Field `PAUSE` reader - This bit is used to pause the counter in high speed timer0
pub type PAUSE_R = crate::BitReader;
///Field `PAUSE` writer - This bit is used to pause the counter in high speed timer0
pub type PAUSE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RST` reader - This bit is used to reset high speed timer0 the counter will be 0 after reset.
pub type RST_R = crate::BitReader;
///Field `RST` writer - This bit is used to reset high speed timer0 the counter will be 0 after reset.
pub type RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TICK_SEL` reader - This bit is used to choose apb_clk or ref_tick for high speed timer0. 1'b1:apb_clk 0:ref_tick
pub type TICK_SEL_R = crate::BitReader;
///Field `TICK_SEL` writer - This bit is used to choose apb_clk or ref_tick for high speed timer0. 1'b1:apb_clk 0:ref_tick
