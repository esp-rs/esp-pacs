...
///Field `DUTY` reader - This register represents the current duty of the output signal for high speed channel0.
pub type DUTY_R = crate::FieldReader<u32>;
///Field `DUTY` writer - This register represents the current duty of the output signal for high speed channel0.
pub type DUTY_W<'a, REG> = crate::FieldWriter<'a, REG, 25, u32>;
impl R {
    ///Bits 0:24 - This register represents the current duty of the output signal for high speed channel0.
    #[inline(always)]
