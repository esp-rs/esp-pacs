...
///Field `TIMER_SEL` reader - There are four high speed timers the two bits are used to select one of them for high speed channel0. 2'b00: seletc hstimer0. 2'b01: select hstimer1. 2'b10: select hstimer2. 2'b11: select hstimer3.
pub type TIMER_SEL_R = crate::FieldReader;
///Field `TIMER_SEL` writer - There are four high speed timers the two bits are used to select one of them for high speed channel0. 2'b00: seletc hstimer0. 2'b01: select hstimer1. 2'b10: select hstimer2. 2'b11: select hstimer3.
pub type TIMER_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SIG_OUT_EN` reader - This is the output enable control bit for high speed channel0
pub type SIG_OUT_EN_R = crate::BitReader;
///Field `SIG_OUT_EN` writer - This is the output enable control bit for high speed channel0
pub type SIG_OUT_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IDLE_LV` reader - This bit is used to control the output value when high speed channel0 is off.
pub type IDLE_LV_R = crate::BitReader;
///Field `IDLE_LV` writer - This bit is used to control the output value when high speed channel0 is off.
