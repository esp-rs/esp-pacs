...
///Field `CNT` reader - software can read this register to get the current counter value in low speed timer0.
pub type CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:19 - software can read this register to get the current counter value in low speed timer0.
    #[inline(always)]
