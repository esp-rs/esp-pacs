///Register `STATUS_W1TC` reader
pub type R = crate::R<STATUS_W1TC_SPEC>;
///Register `STATUS_W1TC` writer
pub type W = crate::W<STATUS_W1TC_SPEC>;
///Field `STATUS_INT_W1TC` reader - GPIO0~31 interrupt status write 1 to clear
pub type STATUS_INT_W1TC_R = crate::FieldReader<u32>;
///Field `STATUS_INT_W1TC` writer - GPIO0~31 interrupt status write 1 to clear
...
///`read()` method returns [`status_w1tc::R`](R) reader structure
