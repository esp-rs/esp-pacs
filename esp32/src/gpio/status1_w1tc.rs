///Register `STATUS1_W1TC` reader
pub type R = crate::R<STATUS1_W1TC_SPEC>;
///Register `STATUS1_W1TC` writer
pub type W = crate::W<STATUS1_W1TC_SPEC>;
///Field `STATUS1_INT_W1TC` reader - GPIO32~39 interrupt status write 1 to clear
pub type STATUS1_INT_W1TC_R = crate::FieldReader;
///Field `STATUS1_INT_W1TC` writer - GPIO32~39 interrupt status write 1 to clear
...
///`read()` method returns [`status1_w1tc::R`](R) reader structure
