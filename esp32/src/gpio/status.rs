...
///Field `INT` reader - GPIO0~31 interrupt status
pub type INT_R = crate::FieldReader<u32>;
///Field `INT` writer - GPIO0~31 interrupt status
pub type INT_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - GPIO0~31 interrupt status
    #[inline(always)]
