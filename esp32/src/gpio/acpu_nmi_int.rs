///Register `ACPU_NMI_INT` reader
pub type R = crate::R<ACPU_NMI_INT_SPEC>;
///Field `APPCPU_NMI_INT` reader - GPIO0~31 APP CPU non-maskable interrupt status
pub type APPCPU_NMI_INT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - GPIO0~31 APP CPU non-maskable interrupt status
    #[inline(always)]
...
///`read()` method returns [`acpu_nmi_int::R`](R) reader structure
