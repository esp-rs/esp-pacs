...
///Field `SDIO_SEL` reader - SDIO PADS on/off control from outside
pub type SDIO_SEL_R = crate::FieldReader;
///Field `SDIO_SEL` writer - SDIO PADS on/off control from outside
pub type SDIO_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - SDIO PADS on/off control from outside
    #[inline(always)]
