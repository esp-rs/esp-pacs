///Register `OUT_W1TS` reader
pub type R = crate::R<OUT_W1TS_SPEC>;
///Register `OUT_W1TS` writer
pub type W = crate::W<OUT_W1TS_SPEC>;
///Field `OUT_DATA_W1TS` reader - GPIO0~31 output value write 1 to set
pub type OUT_DATA_W1TS_R = crate::FieldReader<u32>;
///Field `OUT_DATA_W1TS` writer - GPIO0~31 output value write 1 to set
...
///`read()` method returns [`out_w1ts::R`](R) reader structure
