///Register `ENABLE_W1TC` reader
pub type R = crate::R<ENABLE_W1TC_SPEC>;
///Register `ENABLE_W1TC` writer
pub type W = crate::W<ENABLE_W1TC_SPEC>;
///Field `ENABLE_DATA_W1TC` reader - GPIO0~31 output enable write 1 to clear
pub type ENABLE_DATA_W1TC_R = crate::FieldReader<u32>;
///Field `ENABLE_DATA_W1TC` writer - GPIO0~31 output enable write 1 to clear
...
///`read()` method returns [`enable_w1tc::R`](R) reader structure
