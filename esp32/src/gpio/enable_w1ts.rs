///Register `ENABLE_W1TS` reader
pub type R = crate::R<ENABLE_W1TS_SPEC>;
///Register `ENABLE_W1TS` writer
pub type W = crate::W<ENABLE_W1TS_SPEC>;
///Field `ENABLE_DATA_W1TS` reader - GPIO0~31 output enable write 1 to set
pub type ENABLE_DATA_W1TS_R = crate::FieldReader<u32>;
///Field `ENABLE_DATA_W1TS` writer - GPIO0~31 output enable write 1 to set
...
///`read()` method returns [`enable_w1ts::R`](R) reader structure
