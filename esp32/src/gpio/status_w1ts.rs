///Register `STATUS_W1TS` reader
pub type R = crate::R<STATUS_W1TS_SPEC>;
///Register `STATUS_W1TS` writer
pub type W = crate::W<STATUS_W1TS_SPEC>;
///Field `STATUS_INT_W1TS` reader - GPIO0~31 interrupt status write 1 to set
pub type STATUS_INT_W1TS_R = crate::FieldReader<u32>;
///Field `STATUS_INT_W1TS` writer - GPIO0~31 interrupt status write 1 to set
...
///`read()` method returns [`status_w1ts::R`](R) reader structure
