...
///`read()` method returns [`cpusdio_int1::R`](R) reader structure
impl crate::Readable for CPUSDIO_INT1_SPEC {}
///`write(|w| ..)` method takes [`cpusdio_int1::W`](W) writer structure
