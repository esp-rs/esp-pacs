///Register `STATUS1_W1TS` reader
pub type R = crate::R<STATUS1_W1TS_SPEC>;
///Register `STATUS1_W1TS` writer
pub type W = crate::W<STATUS1_W1TS_SPEC>;
///Field `STATUS1_INT_W1TS` reader - GPIO32~39 interrupt status write 1 to set
pub type STATUS1_INT_W1TS_R = crate::FieldReader;
///Field `STATUS1_INT_W1TS` writer - GPIO32~39 interrupt status write 1 to set
...
///`read()` method returns [`status1_w1ts::R`](R) reader structure
