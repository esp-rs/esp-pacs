...
///`read()` method returns [`cali_conf::R`](R) reader structure
impl crate::Readable for CALI_CONF_SPEC {}
///`write(|w| ..)` method takes [`cali_conf::W`](W) writer structure
