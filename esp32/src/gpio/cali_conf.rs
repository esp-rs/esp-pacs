...
impl W {
    #[doc = "Bits 0:9"]
    #[inline(always)]
    pub fn cali_rtc_max(&mut self) -> CALI_RTC_MAX_W<'_, CALI_CONF_SPEC> {
        CALI_RTC_MAX_W::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn cali_start(&mut self) -> CALI_START_W<'_, CALI_CONF_SPEC> {
        CALI_START_W::new(self, 31)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`cali_conf::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cali_conf::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
