///Register `ENABLE1_W1TC` reader
pub type R = crate::R<ENABLE1_W1TC_SPEC>;
///Register `ENABLE1_W1TC` writer
pub type W = crate::W<ENABLE1_W1TC_SPEC>;
///Field `ENABLE1_DATA_W1TC` reader - GPIO32~39 output enable write 1 to clear
pub type ENABLE1_DATA_W1TC_R = crate::FieldReader;
///Field `ENABLE1_DATA_W1TC` writer - GPIO32~39 output enable write 1 to clear
...
///`read()` method returns [`enable1_w1tc::R`](R) reader structure
