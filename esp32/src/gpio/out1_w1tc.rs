///Register `OUT1_W1TC` reader
pub type R = crate::R<OUT1_W1TC_SPEC>;
///Register `OUT1_W1TC` writer
pub type W = crate::W<OUT1_W1TC_SPEC>;
///Field `OUT1_DATA_W1TC` reader - GPIO32~39 output value write 1 to clear
pub type OUT1_DATA_W1TC_R = crate::FieldReader;
///Field `OUT1_DATA_W1TC` writer - GPIO32~39 output value write 1 to clear
...
///`read()` method returns [`out1_w1tc::R`](R) reader structure
