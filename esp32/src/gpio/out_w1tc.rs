///Register `OUT_W1TC` reader
pub type R = crate::R<OUT_W1TC_SPEC>;
///Register `OUT_W1TC` writer
pub type W = crate::W<OUT_W1TC_SPEC>;
///Field `OUT_DATA_W1TC` reader - GPIO0~31 output value write 1 to clear
pub type OUT_DATA_W1TC_R = crate::FieldReader<u32>;
///Field `OUT_DATA_W1TC` writer - GPIO0~31 output value write 1 to clear
...
///`read()` method returns [`out_w1tc::R`](R) reader structure
