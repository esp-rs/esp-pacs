///Register `ENABLE1_W1TS` reader
pub type R = crate::R<ENABLE1_W1TS_SPEC>;
///Register `ENABLE1_W1TS` writer
pub type W = crate::W<ENABLE1_W1TS_SPEC>;
///Field `ENABLE1_DATA_W1TS` reader - GPIO32~39 output enable write 1 to set
pub type ENABLE1_DATA_W1TS_R = crate::FieldReader;
///Field `ENABLE1_DATA_W1TS` writer - GPIO32~39 output enable write 1 to set
...
///`read()` method returns [`enable1_w1ts::R`](R) reader structure
