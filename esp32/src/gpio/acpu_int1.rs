///Register `ACPU_INT1` reader
pub type R = crate::R<ACPU_INT1_SPEC>;
///Field `APPCPU_INT_H` reader - GPIO32~39 APP CPU interrupt status
pub type APPCPU_INT_H_R = crate::FieldReader;
impl R {
    ///Bits 0:7 - GPIO32~39 APP CPU interrupt status
    #[inline(always)]
...
///`read()` method returns [`acpu_int1::R`](R) reader structure
