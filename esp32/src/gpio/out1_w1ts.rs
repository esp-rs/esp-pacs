///Register `OUT1_W1TS` reader
pub type R = crate::R<OUT1_W1TS_SPEC>;
///Register `OUT1_W1TS` writer
pub type W = crate::W<OUT1_W1TS_SPEC>;
///Field `OUT1_DATA_W1TS` reader - GPIO32~39 output value write 1 to set
pub type OUT1_DATA_W1TS_R = crate::FieldReader;
///Field `OUT1_DATA_W1TS` writer - GPIO32~39 output value write 1 to set
pub type OUT1_DATA_W1TS_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - GPIO32~39 output value write 1 to set
    #[inline(always)]
...
///`read()` method returns [`out1_w1ts::R`](R) reader structure
