...
///`read()` method returns [`apll_tick_conf::R`](R) reader structure
impl crate::Readable for APLL_TICK_CONF_SPEC {}
///`write(|w| ..)` method takes [`apll_tick_conf::W`](W) writer structure
impl crate::Writable for APLL_TICK_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APLL_TICK_CONF to value 0x63
