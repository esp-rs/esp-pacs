...
pub type SARADC_START_FORCE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, APB_SARADC_CTRL_SPEC, bool, O>;
#[doc = "Field `SARADC_START` reader - "]
pub type SARADC_START_R = crate::BitReader<bool>;
#[doc = "Field `SARADC_START` writer - "]
pub type SARADC_START_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB_SARADC_CTRL_SPEC, bool, O>;
...
pub type SARADC_SAR2_MUX_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, APB_SARADC_CTRL_SPEC, bool, O>;
...
pub type SARADC_WORK_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, APB_SARADC_CTRL_SPEC, u8, u8, 2, O>;
...
pub type SARADC_SAR_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, APB_SARADC_CTRL_SPEC, bool, O>;
...
pub type SARADC_SAR_CLK_GATED_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, APB_SARADC_CTRL_SPEC, bool, O>;
...
pub type SARADC_SAR_CLK_DIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, APB_SARADC_CTRL_SPEC, u8, u8, 8, O>;
...
pub type SARADC_SAR1_PATT_LEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, APB_SARADC_CTRL_SPEC, u8, u8, 4, O>;
...
pub type SARADC_DATA_SAR_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, APB_SARADC_CTRL_SPEC, bool, O>;
...
pub type SARADC_DATA_TO_I2S_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, APB_SARADC_CTRL_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
