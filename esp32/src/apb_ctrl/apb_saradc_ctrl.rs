///Register `APB_SARADC_CTRL` reader
pub type R = crate::R<APB_SARADC_CTRL_SPEC>;
///Register `APB_SARADC_CTRL` writer
pub type W = crate::W<APB_SARADC_CTRL_SPEC>;
///Field `SARADC_START_FORCE` reader -
pub type SARADC_START_FORCE_R = crate::BitReader;
///Field `SARADC_START_FORCE` writer -
pub type SARADC_START_FORCE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_START` reader -
pub type SARADC_START_R = crate::BitReader;
///Field `SARADC_START` writer -
pub type SARADC_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_SAR2_MUX` reader - 1: SAR ADC2 is controlled by DIG ADC2 CTRL 0: SAR ADC2 is controlled by PWDET CTRL
pub type SARADC_SAR2_MUX_R = crate::BitReader;
///Field `SARADC_SAR2_MUX` writer - 1: SAR ADC2 is controlled by DIG ADC2 CTRL 0: SAR ADC2 is controlled by PWDET CTRL
pub type SARADC_SAR2_MUX_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_WORK_MODE` reader - 0: single mode 1: double mode 2: alternate mode
pub type SARADC_WORK_MODE_R = crate::FieldReader;
///Field `SARADC_WORK_MODE` writer - 0: single mode 1: double mode 2: alternate mode
pub type SARADC_WORK_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `SARADC_SAR_SEL` reader - 0: SAR1 1: SAR2 only work for single SAR mode
pub type SARADC_SAR_SEL_R = crate::BitReader;
///Field `SARADC_SAR_SEL` writer - 0: SAR1 1: SAR2 only work for single SAR mode
pub type SARADC_SAR_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_SAR_CLK_GATED` reader -
pub type SARADC_SAR_CLK_GATED_R = crate::BitReader;
///Field `SARADC_SAR_CLK_GATED` writer -
pub type SARADC_SAR_CLK_GATED_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_SAR_CLK_DIV` reader - SAR clock divider
pub type SARADC_SAR_CLK_DIV_R = crate::FieldReader;
///Field `SARADC_SAR_CLK_DIV` writer - SAR clock divider
pub type SARADC_SAR_CLK_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
///Field `SARADC_SAR1_PATT_LEN` reader - 0 ~ 15 means length 1 ~ 16
pub type SARADC_SAR1_PATT_LEN_R = crate::FieldReader;
///Field `SARADC_SAR1_PATT_LEN` writer - 0 ~ 15 means length 1 ~ 16
pub type SARADC_SAR1_PATT_LEN_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SARADC_SAR2_PATT_LEN` reader - 0 ~ 15 means length 1 ~ 16
pub type SARADC_SAR2_PATT_LEN_R = crate::FieldReader;
///Field `SARADC_SAR2_PATT_LEN` writer - 0 ~ 15 means length 1 ~ 16
pub type SARADC_SAR2_PATT_LEN_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `SARADC_SAR1_PATT_P_CLEAR` reader - clear the pointer of pattern table for DIG ADC1 CTRL
pub type SARADC_SAR1_PATT_P_CLEAR_R = crate::BitReader;
///Field `SARADC_SAR1_PATT_P_CLEAR` writer - clear the pointer of pattern table for DIG ADC1 CTRL
pub type SARADC_SAR1_PATT_P_CLEAR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_SAR2_PATT_P_CLEAR` reader - clear the pointer of pattern table for DIG ADC2 CTRL
pub type SARADC_SAR2_PATT_P_CLEAR_R = crate::BitReader;
///Field `SARADC_SAR2_PATT_P_CLEAR` writer - clear the pointer of pattern table for DIG ADC2 CTRL
pub type SARADC_SAR2_PATT_P_CLEAR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_DATA_SAR_SEL` reader - 1: sar_sel will be coded by the MSB of the 16-bit output data in this case the resolution should not be larger than 11 bits.
pub type SARADC_DATA_SAR_SEL_R = crate::BitReader;
///Field `SARADC_DATA_SAR_SEL` writer - 1: sar_sel will be coded by the MSB of the 16-bit output data in this case the resolution should not be larger than 11 bits.
pub type SARADC_DATA_SAR_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SARADC_DATA_TO_I2S` reader - 1: I2S input data is from SAR ADC (for DMA) 0: I2S input data is from GPIO matrix
pub type SARADC_DATA_TO_I2S_R = crate::BitReader;
///Field `SARADC_DATA_TO_I2S` writer - 1: I2S input data is from SAR ADC (for DMA) 0: I2S input data is from GPIO matrix
...
///`read()` method returns [`apb_saradc_ctrl::R`](R) reader structure
impl crate::Readable for APB_SARADC_CTRL_SPEC {}
///`write(|w| ..)` method takes [`apb_saradc_ctrl::W`](W) writer structure
impl crate::Writable for APB_SARADC_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APB_SARADC_CTRL to value 0x007f_8240
