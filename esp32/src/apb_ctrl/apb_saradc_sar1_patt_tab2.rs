...
pub type R = crate::R<APB_SARADC_SAR1_PATT_TAB2_SPEC>;
#[doc = "Register `APB_SARADC_SAR1_PATT_TAB2` writer"]
pub type W = crate::W<APB_SARADC_SAR1_PATT_TAB2_SPEC>;
#[doc = "Field `SARADC_SAR1_PATT_TAB2` reader - Item 4 ~ 7 for pattern table 1 (each item one byte)"]
pub type SARADC_SAR1_PATT_TAB2_R = crate::FieldReader<u32>;
#[doc = "Field `SARADC_SAR1_PATT_TAB2` writer - Item 4 ~ 7 for pattern table 1 (each item one byte)"]
pub type SARADC_SAR1_PATT_TAB2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB_SARADC_SAR1_PATT_TAB2")
            .field(
                "saradc_sar1_patt_tab2",
                &format_args!("{}", self.saradc_sar1_patt_tab2().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<APB_SARADC_SAR1_PATT_TAB2_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn saradc_sar1_patt_tab2(
        &mut self,
    ) -> SARADC_SAR1_PATT_TAB2_W<APB_SARADC_SAR1_PATT_TAB2_SPEC, 0> {
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apb_saradc_sar1_patt_tab2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apb_saradc_sar1_patt_tab2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
