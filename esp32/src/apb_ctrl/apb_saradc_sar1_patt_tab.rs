///Register `APB_SARADC_SAR1_PATT_TAB%s` reader
pub type R = crate::R<APB_SARADC_SAR1_PATT_TAB_SPEC>;
///Register `APB_SARADC_SAR1_PATT_TAB%s` writer
pub type W = crate::W<APB_SARADC_SAR1_PATT_TAB_SPEC>;
///Field `SARADC_SAR1_PATT_TAB1` reader - item 0 ~ 3 for pattern table 1 (each item one byte)
pub type SARADC_SAR1_PATT_TAB1_R = crate::FieldReader<u32>;
///Field `SARADC_SAR1_PATT_TAB1` writer - item 0 ~ 3 for pattern table 1 (each item one byte)
...
///`read()` method returns [`apb_saradc_sar1_patt_tab::R`](R) reader structure
impl crate::Readable for APB_SARADC_SAR1_PATT_TAB_SPEC {}
///`write(|w| ..)` method takes [`apb_saradc_sar1_patt_tab::W`](W) writer structure
impl crate::Writable for APB_SARADC_SAR1_PATT_TAB_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APB_SARADC_SAR1_PATT_TAB%s to value 0x0f0f_0f0f
