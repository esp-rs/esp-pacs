...
///`read()` method returns [`apb_saradc_fsm::R`](R) reader structure
impl crate::Readable for APB_SARADC_FSM_SPEC {}
///`write(|w| ..)` method takes [`apb_saradc_fsm::W`](W) writer structure
impl crate::Writable for APB_SARADC_FSM_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APB_SARADC_FSM to value 0x0208_ff08
