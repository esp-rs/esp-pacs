...
///
pub mod m_prime;
/**MODEXP_MODE (rw) register accessor:
...
///
pub mod modexp_mode;
/**MODEXP_START (w) register accessor:
...
/**MULT_MODE (rw) register accessor:
...
///
pub mod mult_mode;
/**MULT_START (w) register accessor:
...
///
pub mod mult_start;
/**INTERRUPT (rw) register accessor:
