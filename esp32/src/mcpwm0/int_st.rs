...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_ST")
            ...
            .field("op0_tea", &self.op0_tea().bit())
            .field("op1_tea", &self.op1_tea().bit())
            .field("op2_tea", &self.op2_tea().bit())
            .field("op0_teb", &self.op0_teb().bit())
            .field("op1_teb", &self.op1_teb().bit())
            .field("op2_teb", &self.op2_teb().bit())
            .field("fh0_cbc", &self.fh0_cbc().bit())
            .field("fh1_cbc", &self.fh1_cbc().bit())
            .field("fh2_cbc", &self.fh2_cbc().bit())
            .field("fh0_ost", &self.fh0_ost().bit())
            .field("fh1_ost", &self.fh1_ost().bit())
            .field("fh2_ost", &self.fh2_ost().bit())
