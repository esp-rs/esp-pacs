...
#[doc = "Field `TIMER_SYNCISEL(0-2)` reader - "]
pub type TIMER_SYNCISEL_R = crate::FieldReader;
#[doc = "Field `TIMER_SYNCISEL(0-2)` writer - "]
pub type TIMER_SYNCISEL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `EXTERNAL_SYNCI_INVERT(0-2)` reader - "]
pub type EXTERNAL_SYNCI_INVERT_R = crate::BitReader;
#[doc = "Field `EXTERNAL_SYNCI_INVERT(0-2)` writer - "]
