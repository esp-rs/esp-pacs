...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fh2_clr_ost(&mut self) -> FH2_CLR_OST_W<FH2_CFG1_SPEC, 0> {
        FH2_CLR_OST_W::new(self)
    }
    #[doc = "Bits 1:2"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_cbcpulse(&mut self) -> FH2_CBCPULSE_W<FH2_CFG1_SPEC, 1> {
        FH2_CBCPULSE_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_force_cbc(&mut self) -> FH2_FORCE_CBC_W<FH2_CFG1_SPEC, 3> {
        FH2_FORCE_CBC_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_force_ost(&mut self) -> FH2_FORCE_OST_W<FH2_CFG1_SPEC, 4> {
