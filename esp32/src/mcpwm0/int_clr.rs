...
impl W {
    ...
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn op0_tea(&mut self) -> OP0_TEA_W<'_, INT_CLR_SPEC> {
        OP0_TEA_W::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn op1_tea(&mut self) -> OP1_TEA_W<'_, INT_CLR_SPEC> {
        OP1_TEA_W::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    pub fn op2_tea(&mut self) -> OP2_TEA_W<'_, INT_CLR_SPEC> {
        OP2_TEA_W::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    pub fn op0_teb(&mut self) -> OP0_TEB_W<'_, INT_CLR_SPEC> {
        OP0_TEB_W::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    pub fn op1_teb(&mut self) -> OP1_TEB_W<'_, INT_CLR_SPEC> {
        OP1_TEB_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn op2_teb(&mut self) -> OP2_TEB_W<'_, INT_CLR_SPEC> {
        OP2_TEB_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn fh0_cbc(&mut self) -> FH0_CBC_W<'_, INT_CLR_SPEC> {
        FH0_CBC_W::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    pub fn fh1_cbc(&mut self) -> FH1_CBC_W<'_, INT_CLR_SPEC> {
        FH1_CBC_W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    pub fn fh2_cbc(&mut self) -> FH2_CBC_W<'_, INT_CLR_SPEC> {
        FH2_CBC_W::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn fh0_ost(&mut self) -> FH0_OST_W<'_, INT_CLR_SPEC> {
        FH0_OST_W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn fh1_ost(&mut self) -> FH1_OST_W<'_, INT_CLR_SPEC> {
        FH1_OST_W::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    pub fn fh2_ost(&mut self) -> FH2_OST_W<'_, INT_CLR_SPEC> {
