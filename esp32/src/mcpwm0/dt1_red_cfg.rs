...
pub type DT1_RED_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DT1_RED` writer - "]
pub type DT1_RED_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DT1_RED_CFG_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dt1_red(&mut self) -> DT1_RED_W<0> {
        DT1_RED_W::new(self)
    }
