...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fh0_sw_cbc(&mut self) -> FH0_SW_CBC_W<FH0_CFG0_SPEC> {
        FH0_SW_CBC_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_f2_cbc(&mut self) -> FH0_F2_CBC_W<FH0_CFG0_SPEC> {
        FH0_F2_CBC_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_f1_cbc(&mut self) -> FH0_F1_CBC_W<FH0_CFG0_SPEC> {
        FH0_F1_CBC_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_f0_cbc(&mut self) -> FH0_F0_CBC_W<FH0_CFG0_SPEC> {
        FH0_F0_CBC_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_sw_ost(&mut self) -> FH0_SW_OST_W<FH0_CFG0_SPEC> {
        FH0_SW_OST_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_f2_ost(&mut self) -> FH0_F2_OST_W<FH0_CFG0_SPEC> {
        FH0_F2_OST_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_f1_ost(&mut self) -> FH0_F1_OST_W<FH0_CFG0_SPEC> {
        FH0_F1_OST_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_f0_ost(&mut self) -> FH0_F0_OST_W<FH0_CFG0_SPEC> {
        FH0_F0_OST_W::new(self, 7)
    }
    #[doc = "Bits 8:9"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_a_cbc_d(&mut self) -> FH0_A_CBC_D_W<FH0_CFG0_SPEC> {
        FH0_A_CBC_D_W::new(self, 8)
    }
    #[doc = "Bits 10:11"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_a_cbc_u(&mut self) -> FH0_A_CBC_U_W<FH0_CFG0_SPEC> {
        FH0_A_CBC_U_W::new(self, 10)
    }
    #[doc = "Bits 12:13"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_a_ost_d(&mut self) -> FH0_A_OST_D_W<FH0_CFG0_SPEC> {
        FH0_A_OST_D_W::new(self, 12)
    }
    #[doc = "Bits 14:15"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_a_ost_u(&mut self) -> FH0_A_OST_U_W<FH0_CFG0_SPEC> {
        FH0_A_OST_U_W::new(self, 14)
    }
    #[doc = "Bits 16:17"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_b_cbc_d(&mut self) -> FH0_B_CBC_D_W<FH0_CFG0_SPEC> {
        FH0_B_CBC_D_W::new(self, 16)
    }
    #[doc = "Bits 18:19"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_b_cbc_u(&mut self) -> FH0_B_CBC_U_W<FH0_CFG0_SPEC> {
        FH0_B_CBC_U_W::new(self, 18)
    }
    #[doc = "Bits 20:21"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_b_ost_d(&mut self) -> FH0_B_OST_D_W<FH0_CFG0_SPEC> {
        FH0_B_OST_D_W::new(self, 20)
    }
    #[doc = "Bits 22:23"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_b_ost_u(&mut self) -> FH0_B_OST_U_W<FH0_CFG0_SPEC> {
        FH0_B_OST_U_W::new(self, 22)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fh0_cfg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fh0_cfg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
