...
#[doc = "Field `TIMER_PHASE` reader - "]
pub type TIMER_PHASE_R = crate::FieldReader<u32>;
#[doc = "Field `TIMER_PHASE` writer - "]
pub type TIMER_PHASE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn timer_phase(&self) -> TIMER_PHASE_R {
        TIMER_PHASE_R::new(self.bits)
    }
}
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn timer_phase(&mut self) -> TIMER_PHASE_W<'_, CAP_TIMER_PHASE_SPEC> {
        TIMER_PHASE_W::new(self, 0)
    }
}
