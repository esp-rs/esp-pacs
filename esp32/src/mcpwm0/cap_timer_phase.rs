...
pub type CAP_TIMER_PHASE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CAP_TIMER_PHASE")
            .field(
                "cap_timer_phase",
                &format_args!("{}", self.cap_timer_phase().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cap_timer_phase(&mut self) -> CAP_TIMER_PHASE_W<CAP_TIMER_PHASE_SPEC, 0> {
        CAP_TIMER_PHASE_W::new(self)
    }
