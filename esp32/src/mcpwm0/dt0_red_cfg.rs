...
pub type DT0_RED_R = crate::FieldReader<u16>;
#[doc = "Field `DT0_RED` writer - "]
pub type DT0_RED_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dt0_red(&mut self) -> DT0_RED_W<DT0_RED_CFG_SPEC> {
        DT0_RED_W::new(self, 0)
    }
}
