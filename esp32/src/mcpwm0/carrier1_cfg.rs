...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn carrier1_en(&mut self) -> CARRIER1_EN_W<0> {
        CARRIER1_EN_W::new(self)
    }
    #[doc = "Bits 1:4"]
    #[inline(always)]
    #[must_use]
    pub fn carrier1_prescale(&mut self) -> CARRIER1_PRESCALE_W<1> {
        CARRIER1_PRESCALE_W::new(self)
    }
    #[doc = "Bits 5:7"]
    #[inline(always)]
    #[must_use]
    pub fn carrier1_duty(&mut self) -> CARRIER1_DUTY_W<5> {
        CARRIER1_DUTY_W::new(self)
    }
    #[doc = "Bits 8:11"]
    #[inline(always)]
    #[must_use]
    pub fn carrier1_oshtwth(&mut self) -> CARRIER1_OSHTWTH_W<8> {
        CARRIER1_OSHTWTH_W::new(self)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn carrier1_out_invert(&mut self) -> CARRIER1_OUT_INVERT_W<12> {
        CARRIER1_OUT_INVERT_W::new(self)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn carrier1_in_invert(&mut self) -> CARRIER1_IN_INVERT_W<13> {
