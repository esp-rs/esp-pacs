...
pub type GEN1_B_R = crate::FieldReader<u16>;
#[doc = "Field `GEN1_B` writer - "]
pub type GEN1_B_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gen1_b(&mut self) -> GEN1_B_W<GEN1_TSTMP_B_SPEC, 0> {
        GEN1_B_W::new(self)
    }
