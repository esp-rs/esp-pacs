...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gen0_a_upmethod(&mut self) -> GEN0_A_UPMETHOD_W<GEN0_STMP_CFG_SPEC, 0> {
        GEN0_A_UPMETHOD_W::new(self)
    }
    #[doc = "Bits 4:7"]
    #[inline(always)]
    #[must_use]
    pub fn gen0_b_upmethod(&mut self) -> GEN0_B_UPMETHOD_W<GEN0_STMP_CFG_SPEC, 4> {
        GEN0_B_UPMETHOD_W::new(self)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn gen0_a_shdw_full(&mut self) -> GEN0_A_SHDW_FULL_W<GEN0_STMP_CFG_SPEC, 8> {
        GEN0_A_SHDW_FULL_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn gen0_b_shdw_full(&mut self) -> GEN0_B_SHDW_FULL_W<GEN0_STMP_CFG_SPEC, 9> {
