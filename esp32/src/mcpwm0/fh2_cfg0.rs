...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fh2_sw_cbc(&mut self) -> FH2_SW_CBC_W<FH2_CFG0_SPEC, 0> {
        FH2_SW_CBC_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_f2_cbc(&mut self) -> FH2_F2_CBC_W<FH2_CFG0_SPEC, 1> {
        FH2_F2_CBC_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_f1_cbc(&mut self) -> FH2_F1_CBC_W<FH2_CFG0_SPEC, 2> {
        FH2_F1_CBC_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_f0_cbc(&mut self) -> FH2_F0_CBC_W<FH2_CFG0_SPEC, 3> {
        FH2_F0_CBC_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_sw_ost(&mut self) -> FH2_SW_OST_W<FH2_CFG0_SPEC, 4> {
        FH2_SW_OST_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_f2_ost(&mut self) -> FH2_F2_OST_W<FH2_CFG0_SPEC, 5> {
        FH2_F2_OST_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_f1_ost(&mut self) -> FH2_F1_OST_W<FH2_CFG0_SPEC, 6> {
        FH2_F1_OST_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_f0_ost(&mut self) -> FH2_F0_OST_W<FH2_CFG0_SPEC, 7> {
        FH2_F0_OST_W::new(self)
    }
    #[doc = "Bits 8:9"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_a_cbc_d(&mut self) -> FH2_A_CBC_D_W<FH2_CFG0_SPEC, 8> {
        FH2_A_CBC_D_W::new(self)
    }
    #[doc = "Bits 10:11"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_a_cbc_u(&mut self) -> FH2_A_CBC_U_W<FH2_CFG0_SPEC, 10> {
        FH2_A_CBC_U_W::new(self)
    }
    #[doc = "Bits 12:13"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_a_ost_d(&mut self) -> FH2_A_OST_D_W<FH2_CFG0_SPEC, 12> {
        FH2_A_OST_D_W::new(self)
    }
    #[doc = "Bits 14:15"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_a_ost_u(&mut self) -> FH2_A_OST_U_W<FH2_CFG0_SPEC, 14> {
        FH2_A_OST_U_W::new(self)
    }
    #[doc = "Bits 16:17"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_b_cbc_d(&mut self) -> FH2_B_CBC_D_W<FH2_CFG0_SPEC, 16> {
        FH2_B_CBC_D_W::new(self)
    }
    #[doc = "Bits 18:19"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_b_cbc_u(&mut self) -> FH2_B_CBC_U_W<FH2_CFG0_SPEC, 18> {
        FH2_B_CBC_U_W::new(self)
    }
    #[doc = "Bits 20:21"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_b_ost_d(&mut self) -> FH2_B_OST_D_W<FH2_CFG0_SPEC, 20> {
        FH2_B_OST_D_W::new(self)
    }
    #[doc = "Bits 22:23"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_b_ost_u(&mut self) -> FH2_B_OST_U_W<FH2_CFG0_SPEC, 22> {
