...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn op0_tea_int_ena(&mut self) -> OP0_TEA_INT_ENA_W<INT_ENA_SPEC> {
        OP0_TEA_INT_ENA_W::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn op1_tea_int_ena(&mut self) -> OP1_TEA_INT_ENA_W<INT_ENA_SPEC> {
        OP1_TEA_INT_ENA_W::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn op2_tea_int_ena(&mut self) -> OP2_TEA_INT_ENA_W<INT_ENA_SPEC> {
        OP2_TEA_INT_ENA_W::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn op0_teb_int_ena(&mut self) -> OP0_TEB_INT_ENA_W<INT_ENA_SPEC> {
        OP0_TEB_INT_ENA_W::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn op1_teb_int_ena(&mut self) -> OP1_TEB_INT_ENA_W<INT_ENA_SPEC> {
        OP1_TEB_INT_ENA_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn op2_teb_int_ena(&mut self) -> OP2_TEB_INT_ENA_W<INT_ENA_SPEC> {
        OP2_TEB_INT_ENA_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_cbc_int_ena(&mut self) -> FH0_CBC_INT_ENA_W<INT_ENA_SPEC> {
        FH0_CBC_INT_ENA_W::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn fh1_cbc_int_ena(&mut self) -> FH1_CBC_INT_ENA_W<INT_ENA_SPEC> {
        FH1_CBC_INT_ENA_W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_cbc_int_ena(&mut self) -> FH2_CBC_INT_ENA_W<INT_ENA_SPEC> {
        FH2_CBC_INT_ENA_W::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_ost_int_ena(&mut self) -> FH0_OST_INT_ENA_W<INT_ENA_SPEC> {
        FH0_OST_INT_ENA_W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn fh1_ost_int_ena(&mut self) -> FH1_OST_INT_ENA_W<INT_ENA_SPEC> {
        FH1_OST_INT_ENA_W::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_ost_int_ena(&mut self) -> FH2_OST_INT_ENA_W<INT_ENA_SPEC> {
        FH2_OST_INT_ENA_W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
