...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn op0_tea_int_ena(&mut self) -> OP0_TEA_INT_ENA_W<INT_ENA_SPEC, 15> {
        OP0_TEA_INT_ENA_W::new(self)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn op1_tea_int_ena(&mut self) -> OP1_TEA_INT_ENA_W<INT_ENA_SPEC, 16> {
        OP1_TEA_INT_ENA_W::new(self)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn op2_tea_int_ena(&mut self) -> OP2_TEA_INT_ENA_W<INT_ENA_SPEC, 17> {
        OP2_TEA_INT_ENA_W::new(self)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn op0_teb_int_ena(&mut self) -> OP0_TEB_INT_ENA_W<INT_ENA_SPEC, 18> {
        OP0_TEB_INT_ENA_W::new(self)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn op1_teb_int_ena(&mut self) -> OP1_TEB_INT_ENA_W<INT_ENA_SPEC, 19> {
        OP1_TEB_INT_ENA_W::new(self)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn op2_teb_int_ena(&mut self) -> OP2_TEB_INT_ENA_W<INT_ENA_SPEC, 20> {
        OP2_TEB_INT_ENA_W::new(self)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_cbc_int_ena(&mut self) -> FH0_CBC_INT_ENA_W<INT_ENA_SPEC, 21> {
        FH0_CBC_INT_ENA_W::new(self)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn fh1_cbc_int_ena(&mut self) -> FH1_CBC_INT_ENA_W<INT_ENA_SPEC, 22> {
        FH1_CBC_INT_ENA_W::new(self)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_cbc_int_ena(&mut self) -> FH2_CBC_INT_ENA_W<INT_ENA_SPEC, 23> {
        FH2_CBC_INT_ENA_W::new(self)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn fh0_ost_int_ena(&mut self) -> FH0_OST_INT_ENA_W<INT_ENA_SPEC, 24> {
        FH0_OST_INT_ENA_W::new(self)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn fh1_ost_int_ena(&mut self) -> FH1_OST_INT_ENA_W<INT_ENA_SPEC, 25> {
        FH1_OST_INT_ENA_W::new(self)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn fh2_ost_int_ena(&mut self) -> FH2_OST_INT_ENA_W<INT_ENA_SPEC, 26> {
