...
///Field `WDT_CLK_PRESCALE` reader - SWDT clock prescale value. Period = 12.5ns * value stored in this register
pub type WDT_CLK_PRESCALE_R = crate::FieldReader<u16>;
///Field `WDT_CLK_PRESCALE` writer - SWDT clock prescale value. Period = 12.5ns * value stored in this register
pub type WDT_CLK_PRESCALE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 16:31 - SWDT clock prescale value. Period = 12.5ns * value stored in this register
    #[inline(always)]
