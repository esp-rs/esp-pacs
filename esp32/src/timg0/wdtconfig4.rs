...
///Field `WDT_STG2_HOLD` reader - Stage 2 timeout value in SWDT clock cycles
pub type WDT_STG2_HOLD_R = crate::FieldReader<u32>;
///Field `WDT_STG2_HOLD` writer - Stage 2 timeout value in SWDT clock cycles
pub type WDT_STG2_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Stage 2 timeout value in SWDT clock cycles
    #[inline(always)]
