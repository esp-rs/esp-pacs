...
#[doc = "Field `WDT_STG1_HOLD` reader - Stage 1 timeout value in SWDT clock cycles"]
pub type WDT_STG1_HOLD_R = crate::FieldReader<u32>;
#[doc = "Field `WDT_STG1_HOLD` writer - Stage 1 timeout value in SWDT clock cycles"]
pub type WDT_STG1_HOLD_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Stage 1 timeout value in SWDT clock cycles"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("WDTCONFIG3")
            .field("wdt_stg1_hold", &self.wdt_stg1_hold().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
