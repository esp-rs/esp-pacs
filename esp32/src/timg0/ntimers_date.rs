...
///Field `NTIMERS_DATE` reader - Version of this regfile
pub type NTIMERS_DATE_R = crate::FieldReader<u32>;
///Field `NTIMERS_DATE` writer - Version of this regfile
pub type NTIMERS_DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    ///Bits 0:27 - Version of this regfile
    #[inline(always)]
...
///`reset()` method sets NTIMERS_DATE to value 0x0160_4290
