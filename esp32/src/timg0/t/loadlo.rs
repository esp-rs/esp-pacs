///Register `LOADLO` reader
pub type R = crate::R<LOADLO_SPEC>;
///Register `LOADLO` writer
pub type W = crate::W<LOADLO_SPEC>;
///Field `LOAD_LO` reader - Lower 32 bits of the value that will load into timer 0 time-base counter
pub type LOAD_LO_R = crate::FieldReader<u32>;
///Field `LOAD_LO` writer - Lower 32 bits of the value that will load into timer 0 time-base counter
pub type LOAD_LO_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Lower 32 bits of the value that will load into timer 0 time-base counter
    #[inline(always)]
...
///`read()` method returns [`loadlo::R`](R) reader structure
impl crate::Readable for LOADLO_SPEC {}
///`write(|w| ..)` method takes [`loadlo::W`](W) writer structure
