...
///Field `ALARM_HI` reader - Timer 0 time-base counter value higher 32 bits that will trigger the alarm
pub type ALARM_HI_R = crate::FieldReader<u32>;
///Field `ALARM_HI` writer - Timer 0 time-base counter value higher 32 bits that will trigger the alarm
pub type ALARM_HI_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - Timer 0 time-base counter value higher 32 bits that will trigger the alarm
    #[inline(always)]
