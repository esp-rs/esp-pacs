...
///Field `LOAD` writer - Write any value will trigger timer 0 time-base counter reload
...
impl W {
    ///Bits 0:31 - Write any value will trigger timer 0 time-base counter reload
    #[inline(always)]
    #[must_use]
