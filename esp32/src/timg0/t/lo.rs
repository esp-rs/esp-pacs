...
///Field `LO` reader - Register to store timer 0 time-base counter current value lower 32 bits.
pub type LO_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Register to store timer 0 time-base counter current value lower 32 bits.
    #[inline(always)]
    pub fn lo(&self) -> LO_R {
        LO_R::new(self.bits)
    }
