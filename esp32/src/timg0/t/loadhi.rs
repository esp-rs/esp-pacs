...
///Field `LOAD_HI` reader - higher 32 bits of the value that will load into timer 0 time-base counter
pub type LOAD_HI_R = crate::FieldReader<u32>;
///Field `LOAD_HI` writer - higher 32 bits of the value that will load into timer 0 time-base counter
