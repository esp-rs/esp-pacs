///Register `TIMGCLK` reader
pub type R = crate::R<TIMGCLK_SPEC>;
///Register `TIMGCLK` writer
pub type W = crate::W<TIMGCLK_SPEC>;
///Field `CLK_EN` reader - Force clock enable for this regfile
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - Force clock enable for this regfile
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bit 31 - Force clock enable for this regfile
    #[inline(always)]
...
///`read()` method returns [`timgclk::R`](R) reader structure
impl crate::Readable for TIMGCLK_SPEC {}
///`write(|w| ..)` method takes [`timgclk::W`](W) writer structure
