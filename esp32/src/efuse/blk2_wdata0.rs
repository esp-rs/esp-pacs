...
///`read()` method returns [`blk2_wdata0::R`](R) reader structure
impl crate::Readable for BLK2_WDATA0_SPEC {}
///`write(|w| ..)` method takes [`blk2_wdata0::W`](W) writer structure
