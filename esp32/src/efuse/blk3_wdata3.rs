...
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn adc1_tp_low(&mut self) -> ADC1_TP_LOW_W<'_, BLK3_WDATA3_SPEC> {
        ADC1_TP_LOW_W::new(self, 0)
    }
    #[doc = "Bits 7:15"]
    #[inline(always)]
    pub fn adc1_tp_high(&mut self) -> ADC1_TP_HIGH_W<'_, BLK3_WDATA3_SPEC> {
        ADC1_TP_HIGH_W::new(self, 7)
    }
    #[doc = "Bits 16:22"]
    #[inline(always)]
    pub fn adc2_tp_low(&mut self) -> ADC2_TP_LOW_W<'_, BLK3_WDATA3_SPEC> {
        ADC2_TP_LOW_W::new(self, 16)
    }
    #[doc = "Bits 23:31"]
    #[inline(always)]
    pub fn adc2_tp_high(&mut self) -> ADC2_TP_HIGH_W<'_, BLK3_WDATA3_SPEC> {
        ADC2_TP_HIGH_W::new(self, 23)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`blk3_wdata3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`blk3_wdata3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
