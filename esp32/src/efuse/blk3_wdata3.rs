...
///`read()` method returns [`blk3_wdata3::R`](R) reader structure
impl crate::Readable for BLK3_WDATA3_SPEC {}
///`write(|w| ..)` method takes [`blk3_wdata3::W`](W) writer structure
