...
///`read()` method returns [`blk1_wdata4::R`](R) reader structure
impl crate::Readable for BLK1_WDATA4_SPEC {}
///`write(|w| ..)` method takes [`blk1_wdata4::W`](W) writer structure
