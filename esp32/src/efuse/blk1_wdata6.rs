...
///`read()` method returns [`blk1_wdata6::R`](R) reader structure
impl crate::Readable for BLK1_WDATA6_SPEC {}
///`write(|w| ..)` method takes [`blk1_wdata6::W`](W) writer structure
