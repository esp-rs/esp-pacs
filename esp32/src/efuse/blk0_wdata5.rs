...
///`read()` method returns [`blk0_wdata5::R`](R) reader structure
impl crate::Readable for BLK0_WDATA5_SPEC {}
///`write(|w| ..)` method takes [`blk0_wdata5::W`](W) writer structure
