...
///`read()` method returns [`blk3_wdata5::R`](R) reader structure
impl crate::Readable for BLK3_WDATA5_SPEC {}
///`write(|w| ..)` method takes [`blk3_wdata5::W`](W) writer structure
