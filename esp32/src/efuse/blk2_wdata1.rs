...
#[doc = "Field `BLK2_DIN1` reader - program for BLOCK2"]
pub type BLK2_DIN1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `BLK2_DIN1` writer - program for BLOCK2"]
pub type BLK2_DIN1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BLK2_WDATA1_SPEC, u32, u32, 32, O>;
impl R {
