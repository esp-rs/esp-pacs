///Register `BLK2_RDATA0` reader
pub type R = crate::R<BLK2_RDATA0_SPEC>;
///Field `RD_BLOCK2` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk2_rdata0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK2_RDATA0_SPEC;
impl crate::RegisterSpec for BLK2_RDATA0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk2_rdata0::R`](R) reader structure
