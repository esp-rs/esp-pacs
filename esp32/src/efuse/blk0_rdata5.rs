...
impl W {
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn rd_reserve_0_181(&mut self) -> RD_RESERVE_0_181_W<'_, BLK0_RDATA5_SPEC> {
        RD_RESERVE_0_181_W::new(self, 21)
    }
    #[doc = "Bits 26:27"]
    #[inline(always)]
    pub fn rd_reserve_0_186(&mut self) -> RD_RESERVE_0_186_W<'_, BLK0_RDATA5_SPEC> {
        RD_RESERVE_0_186_W::new(self, 26)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`blk0_rdata5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`blk0_rdata5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
