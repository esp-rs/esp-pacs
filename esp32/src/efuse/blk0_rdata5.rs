...
///`read()` method returns [`blk0_rdata5::R`](R) reader structure
impl crate::Readable for BLK0_RDATA5_SPEC {}
///`write(|w| ..)` method takes [`blk0_rdata5::W`](W) writer structure
