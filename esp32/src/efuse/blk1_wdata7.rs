...
pub struct R(crate::R<BLK1_WDATA7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK1_WDATA7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK1_WDATA7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK1_WDATA7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BLK1_WDATA7` writer"]
pub struct W(crate::W<BLK1_WDATA7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BLK1_WDATA7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BLK1_WDATA7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BLK1_WDATA7_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `BLK1_DIN7` reader - program for BLOCK1"]
pub type BLK1_DIN7_R = crate::FieldReader<u32, u32>;
#[doc = "Field `BLK1_DIN7` writer - program for BLOCK1"]
pub type BLK1_DIN7_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BLK1_WDATA7_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk1_wdata7](index.html) module"]
