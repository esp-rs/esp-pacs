...
///`read()` method returns [`blk1_wdata7::R`](R) reader structure
impl crate::Readable for BLK1_WDATA7_SPEC {}
///`write(|w| ..)` method takes [`blk1_wdata7::W`](W) writer structure
