...
///`read()` method returns [`blk1_wdata1::R`](R) reader structure
impl crate::Readable for BLK1_WDATA1_SPEC {}
///`write(|w| ..)` method takes [`blk1_wdata1::W`](W) writer structure
