...
///`read()` method returns [`blk0_rdata6::R`](R) reader structure
impl crate::Readable for BLK0_RDATA6_SPEC {}
///`write(|w| ..)` method takes [`blk0_rdata6::W`](W) writer structure
