...
///Field `FLASH_CRYPT_CNT` reader -
pub type FLASH_CRYPT_CNT_R = crate::FieldReader;
///Field `FLASH_CRYPT_CNT` writer -
...
///`read()` method returns [`blk0_wdata0::R`](R) reader structure
impl crate::Readable for BLK0_WDATA0_SPEC {}
///`write(|w| ..)` method takes [`blk0_wdata0::W`](W) writer structure
