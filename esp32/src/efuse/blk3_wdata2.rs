...
///`read()` method returns [`blk3_wdata2::R`](R) reader structure
impl crate::Readable for BLK3_WDATA2_SPEC {}
///`write(|w| ..)` method takes [`blk3_wdata2::W`](W) writer structure
