...
pub struct R(crate::R<BLK3_WDATA2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BLK3_WDATA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BLK3_WDATA2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BLK3_WDATA2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BLK3_WDATA2` writer"]
pub struct W(crate::W<BLK3_WDATA2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BLK3_WDATA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BLK3_WDATA2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BLK3_WDATA2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BLK3_DIN2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BLK3_WDATA2_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - program for BLOCK3"]
    #[inline(always)]
    pub fn blk3_din2(&mut self) -> BLK3_DIN2_W<0> {
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [blk3_wdata2](index.html) module"]
