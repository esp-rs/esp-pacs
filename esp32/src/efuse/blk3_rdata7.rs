///Register `BLK3_RDATA7` reader
pub type R = crate::R<BLK3_RDATA7_SPEC>;
///Field `RD_BLK3_RESERVED_7` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`blk3_rdata7::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK3_RDATA7_SPEC;
impl crate::RegisterSpec for BLK3_RDATA7_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk3_rdata7::R`](R) reader structure
