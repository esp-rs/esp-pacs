...
#[doc = "Field `BLK1_DOUT5` reader - read for BLOCK1"]
pub type BLK1_DOUT5_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31 - read for BLOCK1"]
    #[inline(always)]
    pub fn blk1_dout5(&self) -> BLK1_DOUT5_R {
        BLK1_DOUT5_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK1_RDATA5")
            .field("blk1_dout5", &format_args!("{}", self.blk1_dout5().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
