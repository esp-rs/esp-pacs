...
///`read()` method returns [`blk0_rdata3::R`](R) reader structure
impl crate::Readable for BLK0_RDATA3_SPEC {}
///`write(|w| ..)` method takes [`blk0_rdata3::W`](W) writer structure
