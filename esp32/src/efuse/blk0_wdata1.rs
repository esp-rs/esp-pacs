...
///`read()` method returns [`blk0_wdata1::R`](R) reader structure
impl crate::Readable for BLK0_WDATA1_SPEC {}
///`write(|w| ..)` method takes [`blk0_wdata1::W`](W) writer structure
