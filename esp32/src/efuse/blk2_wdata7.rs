...
///`read()` method returns [`blk2_wdata7::R`](R) reader structure
impl crate::Readable for BLK2_WDATA7_SPEC {}
///`write(|w| ..)` method takes [`blk2_wdata7::W`](W) writer structure
