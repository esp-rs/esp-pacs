...
///`read()` method returns [`blk1_wdata3::R`](R) reader structure
impl crate::Readable for BLK1_WDATA3_SPEC {}
///`write(|w| ..)` method takes [`blk1_wdata3::W`](W) writer structure
