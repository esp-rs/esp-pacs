...
///`read()` method returns [`blk2_wdata2::R`](R) reader structure
impl crate::Readable for BLK2_WDATA2_SPEC {}
///`write(|w| ..)` method takes [`blk2_wdata2::W`](W) writer structure
