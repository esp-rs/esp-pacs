...
///`read()` method returns [`blk0_wdata6::R`](R) reader structure
impl crate::Readable for BLK0_WDATA6_SPEC {}
///`write(|w| ..)` method takes [`blk0_wdata6::W`](W) writer structure
