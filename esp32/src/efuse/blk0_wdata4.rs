...
///`read()` method returns [`blk0_wdata4::R`](R) reader structure
impl crate::Readable for BLK0_WDATA4_SPEC {}
///`write(|w| ..)` method takes [`blk0_wdata4::W`](W) writer structure
