...
///`read()` method returns [`blk2_wdata6::R`](R) reader structure
impl crate::Readable for BLK2_WDATA6_SPEC {}
///`write(|w| ..)` method takes [`blk2_wdata6::W`](W) writer structure
