...
///`read()` method returns [`blk0_wdata3::R`](R) reader structure
impl crate::Readable for BLK0_WDATA3_SPEC {}
///`write(|w| ..)` method takes [`blk0_wdata3::W`](W) writer structure
