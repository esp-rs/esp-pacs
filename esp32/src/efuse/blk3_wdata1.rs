...
///`read()` method returns [`blk3_wdata1::R`](R) reader structure
impl crate::Readable for BLK3_WDATA1_SPEC {}
///`write(|w| ..)` method takes [`blk3_wdata1::W`](W) writer structure
