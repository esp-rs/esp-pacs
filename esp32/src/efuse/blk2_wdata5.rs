...
///`read()` method returns [`blk2_wdata5::R`](R) reader structure
impl crate::Readable for BLK2_WDATA5_SPEC {}
///`write(|w| ..)` method takes [`blk2_wdata5::W`](W) writer structure
