...
///`read()` method returns [`blk3_wdata6::R`](R) reader structure
impl crate::Readable for BLK3_WDATA6_SPEC {}
///`write(|w| ..)` method takes [`blk3_wdata6::W`](W) writer structure
