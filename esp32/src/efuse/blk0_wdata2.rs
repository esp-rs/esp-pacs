...
///`read()` method returns [`blk0_wdata2::R`](R) reader structure
impl crate::Readable for BLK0_WDATA2_SPEC {}
///`write(|w| ..)` method takes [`blk0_wdata2::W`](W) writer structure
