...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BLK1_RDATA7")
            .field("rd_block1_7", &self.rd_block1_7())
            .finish()
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`blk1_rdata7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
