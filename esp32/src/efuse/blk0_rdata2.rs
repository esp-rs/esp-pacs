...
///`read()` method returns [`blk0_rdata2::R`](R) reader structure
impl crate::Readable for BLK0_RDATA2_SPEC {}
///`write(|w| ..)` method takes [`blk0_rdata2::W`](W) writer structure
