...
///`read()` method returns [`blk1_wdata0::R`](R) reader structure
impl crate::Readable for BLK1_WDATA0_SPEC {}
///`write(|w| ..)` method takes [`blk1_wdata0::W`](W) writer structure
