...
///`read()` method returns [`blk0_rdata4::R`](R) reader structure
impl crate::Readable for BLK0_RDATA4_SPEC {}
///`write(|w| ..)` method takes [`blk0_rdata4::W`](W) writer structure
