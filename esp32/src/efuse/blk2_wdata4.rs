...
///`read()` method returns [`blk2_wdata4::R`](R) reader structure
impl crate::Readable for BLK2_WDATA4_SPEC {}
///`write(|w| ..)` method takes [`blk2_wdata4::W`](W) writer structure
