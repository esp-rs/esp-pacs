...
You can [`read`](crate::generic::Reg::read) this register and get [`blk1_wdata2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`blk1_wdata2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BLK1_WDATA2_SPEC;
impl crate::RegisterSpec for BLK1_WDATA2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`blk1_wdata2::R`](R) reader structure
impl crate::Readable for BLK1_WDATA2_SPEC {}
///`write(|w| ..)` method takes [`blk1_wdata2::W`](W) writer structure
