...
///Register `TX_CRC` writer
pub type W = crate::W<TX_CRC_SPEC>;
///Field `DATA` reader - For SPI1 the value of crc32 for 256 bits data.
pub type DATA_R = crate::FieldReader<u32>;
///Field `DATA` writer - For SPI1 the value of crc32 for 256 bits data.
pub type DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    ///Bits 0:31 - For SPI1 the value of crc32 for 256 bits data.
    #[inline(always)]
...
///`write(|w| ..)` method takes [`tx_crc::W`](W) writer structure
