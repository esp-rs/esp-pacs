///Register `SLV_RD_BIT` reader
pub type R = crate::R<SLV_RD_BIT_SPEC>;
///Register `SLV_RD_BIT` writer
pub type W = crate::W<SLV_RD_BIT_SPEC>;
///Field `SLV_RDATA_BIT` reader - In the slave mode it is the bit length of read data. The value is the length - 1.
pub type SLV_RDATA_BIT_R = crate::FieldReader<u32>;
///Field `SLV_RDATA_BIT` writer - In the slave mode it is the bit length of read data. The value is the length - 1.
...
///`read()` method returns [`slv_rd_bit::R`](R) reader structure
impl crate::Readable for SLV_RD_BIT_SPEC {}
///`write(|w| ..)` method takes [`slv_rd_bit::W`](W) writer structure
