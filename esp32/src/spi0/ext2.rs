///Register `EXT2` reader
pub type R = crate::R<EXT2_SPEC>;
///Field `ST` reader - The status of spi state machine .
pub type ST_R = crate::FieldReader;
impl R {
    ///Bits 0:2 - The status of spi state machine .
    #[inline(always)]
    pub fn st(&self) -> ST_R {
...
///`read()` method returns [`ext2::R`](R) reader structure
