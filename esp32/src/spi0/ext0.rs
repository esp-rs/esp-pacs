///Register `EXT0` reader
pub type R = crate::R<EXT0_SPEC>;
///Register `EXT0` writer
pub type W = crate::W<EXT0_SPEC>;
///Field `T_PP_TIME` reader - page program delay time by system clock.
pub type T_PP_TIME_R = crate::FieldReader<u16>;
///Field `T_PP_TIME` writer - page program delay time by system clock.
pub type T_PP_TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `T_PP_SHIFT` reader - page program delay time shift .
pub type T_PP_SHIFT_R = crate::FieldReader;
///Field `T_PP_SHIFT` writer - page program delay time shift .
pub type T_PP_SHIFT_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `T_PP_ENA` reader - page program delay enable.
pub type T_PP_ENA_R = crate::BitReader;
///Field `T_PP_ENA` writer - page program delay enable.
...
///`read()` method returns [`ext0::R`](R) reader structure
impl crate::Readable for EXT0_SPEC {}
///`write(|w| ..)` method takes [`ext0::W`](W) writer structure
impl crate::Writable for EXT0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EXT0 to value 0x800a_0050
