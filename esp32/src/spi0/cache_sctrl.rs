...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CACHE_SCTRL")
            ...
            .field("sram_bytes_len", &self.sram_bytes_len())
            .field("sram_dummy_cyclelen", &self.sram_dummy_cyclelen())
...
impl W {
    ...
    #[doc = "Bits 6:13 - For SPI0 In the sram mode it is the byte length of spi read sram data."]
    #[inline(always)]
    pub fn sram_bytes_len(&mut self) -> SRAM_BYTES_LEN_W<'_, CACHE_SCTRL_SPEC> {
        SRAM_BYTES_LEN_W::new(self, 6)
    }
    #[doc = "Bits 14:21 - For SPI0 In the sram mode it is the length in bits of address phase. The register value shall be (bit_num-1)."]
    #[inline(always)]
    pub fn sram_dummy_cyclelen(&mut self) -> SRAM_DUMMY_CYCLELEN_W<'_, CACHE_SCTRL_SPEC> {
