...
///Field `DOUTDIN` reader - Set the bit to enable full duplex communication. 1: enable 0: disable.
pub type DOUTDIN_R = crate::BitReader;
///Field `DOUTDIN` writer - Set the bit to enable full duplex communication. 1: enable 0: disable.
...
///Field `CK_I_EDGE` reader - In the slave mode the bit is same as spi_ck_out_edge in master mode. It is combined with spi_miso_delay_mode bits.
pub type CK_I_EDGE_R = crate::BitReader;
///Field `CK_I_EDGE` writer - In the slave mode the bit is same as spi_ck_out_edge in master mode. It is combined with spi_miso_delay_mode bits.
pub type CK_I_EDGE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `CK_OUT_EDGE` reader - the bit combined with spi_mosi_delay_mode bits to set mosi signal delay mode.
pub type CK_OUT_EDGE_R = crate::BitReader;
///Field `CK_OUT_EDGE` writer - the bit combined with spi_mosi_delay_mode bits to set mosi signal delay mode.
pub type CK_OUT_EDGE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RD_BYTE_ORDER` reader - In read-data (MISO) phase 1: big-endian 0: little_endian
pub type RD_BYTE_ORDER_R = crate::BitReader;
///Field `RD_BYTE_ORDER` writer - In read-data (MISO) phase 1: big-endian 0: little_endian
pub type RD_BYTE_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `WR_BYTE_ORDER` reader - In command address write-data (MOSI) phases 1: big-endian 0: litte_endian
pub type WR_BYTE_ORDER_R = crate::BitReader;
///Field `WR_BYTE_ORDER` writer - In command address write-data (MOSI) phases 1: big-endian 0: litte_endian
...
///Field `SIO` reader - Set the bit to enable 3-line half duplex communication mosi and miso signals share the same pin. 1: enable 0: disable.
pub type SIO_R = crate::BitReader;
///Field `SIO` writer - Set the bit to enable 3-line half duplex communication mosi and miso signals share the same pin. 1: enable 0: disable.
pub type SIO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USR_HOLD_POL` reader - It is combined with hold bits to set the polarity of spi hold line 1: spi will be held when spi hold line is high 0: spi will be held when spi hold line is low
pub type USR_HOLD_POL_R = crate::BitReader;
///Field `USR_HOLD_POL` writer - It is combined with hold bits to set the polarity of spi hold line 1: spi will be held when spi hold line is high 0: spi will be held when spi hold line is low
pub type USR_HOLD_POL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USR_DOUT_HOLD` reader - spi is hold at data out state the bit combined with spi_usr_hold_pol bit.
pub type USR_DOUT_HOLD_R = crate::BitReader;
///Field `USR_DOUT_HOLD` writer - spi is hold at data out state the bit combined with spi_usr_hold_pol bit.
pub type USR_DOUT_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USR_DIN_HOLD` reader - spi is hold at data in state the bit combined with spi_usr_hold_pol bit.
pub type USR_DIN_HOLD_R = crate::BitReader;
///Field `USR_DIN_HOLD` writer - spi is hold at data in state the bit combined with spi_usr_hold_pol bit.
pub type USR_DIN_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USR_DUMMY_HOLD` reader - spi is hold at dummy state the bit combined with spi_usr_hold_pol bit.
pub type USR_DUMMY_HOLD_R = crate::BitReader;
///Field `USR_DUMMY_HOLD` writer - spi is hold at dummy state the bit combined with spi_usr_hold_pol bit.
pub type USR_DUMMY_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USR_ADDR_HOLD` reader - spi is hold at address state the bit combined with spi_usr_hold_pol bit.
pub type USR_ADDR_HOLD_R = crate::BitReader;
///Field `USR_ADDR_HOLD` writer - spi is hold at address state the bit combined with spi_usr_hold_pol bit.
pub type USR_ADDR_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USR_CMD_HOLD` reader - spi is hold at command state the bit combined with spi_usr_hold_pol bit.
pub type USR_CMD_HOLD_R = crate::BitReader;
///Field `USR_CMD_HOLD` writer - spi is hold at command state the bit combined with spi_usr_hold_pol bit.
pub type USR_CMD_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USR_PREP_HOLD` reader - spi is hold at prepare state the bit combined with spi_usr_hold_pol bit.
pub type USR_PREP_HOLD_R = crate::BitReader;
///Field `USR_PREP_HOLD` writer - spi is hold at prepare state the bit combined with spi_usr_hold_pol bit.
pub type USR_PREP_HOLD_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USR_MISO_HIGHPART` reader - read-data phase only access to high-part of the buffer spi_w8~spi_w15. 1: enable 0: disable.
pub type USR_MISO_HIGHPART_R = crate::BitReader;
///Field `USR_MISO_HIGHPART` writer - read-data phase only access to high-part of the buffer spi_w8~spi_w15. 1: enable 0: disable.
pub type USR_MISO_HIGHPART_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `USR_MOSI_HIGHPART` reader - write-data phase only access to high-part of the buffer spi_w8~spi_w15. 1: enable 0: disable.
pub type USR_MOSI_HIGHPART_R = crate::BitReader;
///Field `USR_MOSI_HIGHPART` writer - write-data phase only access to high-part of the buffer spi_w8~spi_w15. 1: enable 0: disable.
...
///`reset()` method sets USER to value 0x8000_0040
