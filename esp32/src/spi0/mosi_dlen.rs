...
///Field `USR_MOSI_DBITLEN` reader - The length in bits of write-data. The register value shall be (bit_num-1).
pub type USR_MOSI_DBITLEN_R = crate::FieldReader<u32>;
///Field `USR_MOSI_DBITLEN` writer - The length in bits of write-data. The register value shall be (bit_num-1).
pub type USR_MOSI_DBITLEN_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
    ///Bits 0:23 - The length in bits of write-data. The register value shall be (bit_num-1).
    #[inline(always)]
