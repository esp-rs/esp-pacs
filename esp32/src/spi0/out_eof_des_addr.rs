...
///Field `DMA_OUT_EOF_DES_ADDR` reader - The last outlink descriptor address when spi dma produce to_eof.
pub type DMA_OUT_EOF_DES_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The last outlink descriptor address when spi dma produce to_eof.
    #[inline(always)]
