///Register `EXT3` reader
pub type R = crate::R<EXT3_SPEC>;
///Register `EXT3` writer
pub type W = crate::W<EXT3_SPEC>;
///Field `INT_HOLD_ENA` reader - This register is for two SPI masters to share the same cs clock and data signals. The bits of one SPI are set if the other SPI is busy the SPI will be hold. 1(3): hold at ¡°idle¡± phase 2: hold at ¡°prepare¡± phase.
pub type INT_HOLD_ENA_R = crate::FieldReader;
///Field `INT_HOLD_ENA` writer - This register is for two SPI masters to share the same cs clock and data signals. The bits of one SPI are set if the other SPI is busy the SPI will be hold. 1(3): hold at ¡°idle¡± phase 2: hold at ¡°prepare¡± phase.
...
///`read()` method returns [`ext3::R`](R) reader structure
impl crate::Readable for EXT3_SPEC {}
///`write(|w| ..)` method takes [`ext3::W`](W) writer structure
