...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SLAVE")
            ...
            .field("slv_rd_sta_done", &self.slv_rd_sta_done().bit())
            .field("slv_wr_sta_done", &self.slv_wr_sta_done().bit())
            .field("trans_done", &self.trans_done().bit())
            .field("int_en", &self.int_en().bits())
            .field("cs_i_mode", &self.cs_i_mode().bits())
            .field("slv_last_command", &self.slv_last_command().bits())
            .field("slv_last_state", &self.slv_last_state().bits())
            .field("trans_cnt", &self.trans_cnt().bits())
            .field("slv_cmd_define", &self.slv_cmd_define().bit())
            .field("slv_wr_rd_sta_en", &self.slv_wr_rd_sta_en().bit())
            .field("slv_wr_rd_buf_en", &self.slv_wr_rd_buf_en().bit())
