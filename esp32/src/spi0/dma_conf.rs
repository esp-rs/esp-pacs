...
///Field `OUT_AUTO_WRBACK` reader - when the link is empty jump to next automatically.
pub type OUT_AUTO_WRBACK_R = crate::BitReader;
///Field `OUT_AUTO_WRBACK` writer - when the link is empty jump to next automatically.
