///Register `EXT1` reader
pub type R = crate::R<EXT1_SPEC>;
///Register `EXT1` writer
pub type W = crate::W<EXT1_SPEC>;
///Field `T_ERASE_TIME` reader - erase flash delay time by system clock.
pub type T_ERASE_TIME_R = crate::FieldReader<u16>;
///Field `T_ERASE_TIME` writer - erase flash delay time by system clock.
pub type T_ERASE_TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
///Field `T_ERASE_SHIFT` reader - erase flash delay time shift.
pub type T_ERASE_SHIFT_R = crate::FieldReader;
///Field `T_ERASE_SHIFT` writer - erase flash delay time shift.
pub type T_ERASE_SHIFT_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `T_ERASE_ENA` reader - erase flash delay enable.
pub type T_ERASE_ENA_R = crate::BitReader;
///Field `T_ERASE_ENA` writer - erase flash delay enable.
...
///`read()` method returns [`ext1::R`](R) reader structure
impl crate::Readable for EXT1_SPEC {}
///`write(|w| ..)` method takes [`ext1::W`](W) writer structure
impl crate::Writable for EXT1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EXT1 to value 0x800f_0000
