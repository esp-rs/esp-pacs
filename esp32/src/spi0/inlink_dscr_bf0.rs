...
///Field `DMA_INLINK_DSCR_BF0` reader - The content of next in descriptor pointer.
pub type DMA_INLINK_DSCR_BF0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The content of next in descriptor pointer.
    #[inline(always)]
...
///`read()` method returns [`inlink_dscr_bf0::R`](R) reader structure
