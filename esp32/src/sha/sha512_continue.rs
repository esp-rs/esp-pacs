///Register `SHA512_CONTINUE` writer
pub type W = crate::W<SHA512_CONTINUE_SPEC>;
///Field `SHA512_CONTINUE` writer - Write 1 to continue the SHA-512 operation with subsequent blocks.
...
impl W {
    ///Bit 0 - Write 1 to continue the SHA-512 operation with subsequent blocks.
    #[inline(always)]
    #[must_use]
    pub fn sha512_continue(&mut self) -> SHA512_CONTINUE_W<SHA512_CONTINUE_SPEC> {
...
///`write(|w| ..)` method takes [`sha512_continue::W`](W) writer structure
impl crate::Writable for SHA512_CONTINUE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHA512_CONTINUE to value 0
