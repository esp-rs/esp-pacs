///Register `SHA384_LOAD` writer
pub type W = crate::W<SHA384_LOAD_SPEC>;
///Field `SHA384_LOAD` writer - Write 1 to finish the SHA-384 operation to calculate the final message hash.
...
impl W {
    ///Bit 0 - Write 1 to finish the SHA-384 operation to calculate the final message hash.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`sha384_load::W`](W) writer structure
impl crate::Writable for SHA384_LOAD_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHA384_LOAD to value 0
