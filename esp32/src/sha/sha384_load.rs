...
impl W {
    ...
    #[inline(always)]
    pub fn sha384_load(&mut self) -> SHA384_LOAD_W<'_, SHA384_LOAD_SPEC> {
        SHA384_LOAD_W::new(self, 0)
    }
}
#[doc = "\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sha384_load::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
