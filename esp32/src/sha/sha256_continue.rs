...
///Field `SHA256_CONTINUE` writer - Write 1 to continue the SHA-256 operation with subsequent blocks.
...
///`write(|w| ..)` method takes [`sha256_continue::W`](W) writer structure
impl crate::Writable for SHA256_CONTINUE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHA256_CONTINUE to value 0
