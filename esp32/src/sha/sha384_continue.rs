///Register `SHA384_CONTINUE` writer
pub type W = crate::W<SHA384_CONTINUE_SPEC>;
///Field `SHA384_CONTINUE` writer - Write 1 to continue the SHA-384 operation with subsequent blocks.
...
impl W {
    ///Bit 0 - Write 1 to continue the SHA-384 operation with subsequent blocks.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`sha384_continue::W`](W) writer structure
impl crate::Writable for SHA384_CONTINUE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHA384_CONTINUE to value 0
