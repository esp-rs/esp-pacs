///Register `SHA512_BUSY` reader
pub type R = crate::R<SHA512_BUSY_SPEC>;
///Field `SHA512_BUSY` reader - SHA-512 operation status: 1 if the SHA accelerator is processing data, 0 if it is idle.
pub type SHA512_BUSY_R = crate::BitReader;
impl R {
    ///Bit 0 - SHA-512 operation status: 1 if the SHA accelerator is processing data, 0 if it is idle.
    #[inline(always)]
...
///`read()` method returns [`sha512_busy::R`](R) reader structure
impl crate::Readable for SHA512_BUSY_SPEC {}
///`reset()` method sets SHA512_BUSY to value 0
