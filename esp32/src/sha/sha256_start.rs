...
///Field `SHA256_START` writer - Write 1 to start an SHA-256 operation on the first message block.
...
///`write(|w| ..)` method takes [`sha256_start::W`](W) writer structure
impl crate::Writable for SHA256_START_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHA256_START to value 0
