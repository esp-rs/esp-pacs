...
impl W {
    ///Bit 0 - Write 1 to start an SHA-1 operation on the first message block.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`sha1_start::W`](W) writer structure
impl crate::Writable for SHA1_START_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHA1_START to value 0
