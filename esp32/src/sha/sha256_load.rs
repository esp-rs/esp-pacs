...
///Field `SHA256_LOAD` writer - Write 1 to finish the SHA-256 operation to calculate the final message hash.
...
///`write(|w| ..)` method takes [`sha256_load::W`](W) writer structure
impl crate::Writable for SHA256_LOAD_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHA256_LOAD to value 0
