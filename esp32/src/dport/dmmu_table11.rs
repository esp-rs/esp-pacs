...
pub type DMMU_TABLE11_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMMU_TABLE11")
            .field(
                "dmmu_table11",
                &format_args!("{}", self.dmmu_table11().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<DMMU_TABLE11_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmmu_table11(&mut self) -> DMMU_TABLE11_W<DMMU_TABLE11_SPEC, 0> {
