///Register `AHBLITE_MPU_TABLE_SPI3` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_SPI3_SPEC>;
///Register `AHBLITE_MPU_TABLE_SPI3` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_SPI3_SPEC>;
///Field `SPI3_ACCESS_GRANT_CONFIG` reader -
pub type SPI3_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `SPI3_ACCESS_GRANT_CONFIG` writer -
pub type SPI3_ACCESS_GRANT_CONFIG_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHBLITE_MPU_TABLE_SPI3")
            .field("spi3_access_grant_config", &self.spi3_access_grant_config())
            .finish()
    }
}
impl W {
    ...
    pub fn spi3_access_grant_config(
        &mut self,
    ) -> SPI3_ACCESS_GRANT_CONFIG_W<AHBLITE_MPU_TABLE_SPI3_SPEC> {
        SPI3_ACCESS_GRANT_CONFIG_W::new(self, 0)
    }
}
/**
...
///`read()` method returns [`ahblite_mpu_table_spi3::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_SPI3_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_spi3::W`](W) writer structure
