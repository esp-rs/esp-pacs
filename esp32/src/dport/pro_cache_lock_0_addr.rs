///Register `PRO_CACHE_LOCK_0_ADDR` reader
pub type R = crate::R<PRO_CACHE_LOCK_0_ADDR_SPEC>;
///Register `PRO_CACHE_LOCK_0_ADDR` writer
...
///`read()` method returns [`pro_cache_lock_0_addr::R`](R) reader structure
impl crate::Readable for PRO_CACHE_LOCK_0_ADDR_SPEC {}
///`write(|w| ..)` method takes [`pro_cache_lock_0_addr::W`](W) writer structure
