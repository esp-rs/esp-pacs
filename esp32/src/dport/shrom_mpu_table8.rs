...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SHROM_MPU_TABLE8")
            .field("shrom_mpu_table8", &self.shrom_mpu_table8())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`shrom_mpu_table8::R`](R) reader structure
impl crate::Readable for SHROM_MPU_TABLE8_SPEC {}
///`write(|w| ..)` method takes [`shrom_mpu_table8::W`](W) writer structure
impl crate::Writable for SHROM_MPU_TABLE8_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHROM_MPU_TABLE8 to value 0x01
