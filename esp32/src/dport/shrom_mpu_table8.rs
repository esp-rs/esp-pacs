...
pub type SHROM_MPU_TABLE8_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SHROM_MPU_TABLE8` writer - "]
pub type SHROM_MPU_TABLE8_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SHROM_MPU_TABLE8_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:1"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn shrom_mpu_table8(&mut self) -> SHROM_MPU_TABLE8_W<0> {
        SHROM_MPU_TABLE8_W::new(self)
    }
