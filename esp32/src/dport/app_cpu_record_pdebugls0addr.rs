///Register `APP_CPU_RECORD_PDEBUGLS0ADDR` reader
pub type R = crate::R<APP_CPU_RECORD_PDEBUGLS0ADDR_SPEC>;
///Field `RECORD_APP_PDEBUGLS0ADDR` reader -
...
///`read()` method returns [`app_cpu_record_pdebugls0addr::R`](R) reader structure
