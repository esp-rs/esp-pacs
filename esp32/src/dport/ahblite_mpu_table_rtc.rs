///Register `AHBLITE_MPU_TABLE_RTC` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_RTC_SPEC>;
///Register `AHBLITE_MPU_TABLE_RTC` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_RTC_SPEC>;
///Field `RTC_ACCESS_GRANT_CONFIG` reader -
pub type RTC_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `RTC_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_rtc::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_RTC_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_rtc::W`](W) writer structure
