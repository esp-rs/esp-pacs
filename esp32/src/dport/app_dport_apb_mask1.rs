...
///`read()` method returns [`app_dport_apb_mask1::R`](R) reader structure
impl crate::Readable for APP_DPORT_APB_MASK1_SPEC {}
///`write(|w| ..)` method takes [`app_dport_apb_mask1::W`](W) writer structure
