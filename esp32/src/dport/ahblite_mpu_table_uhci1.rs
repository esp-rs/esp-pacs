///Register `AHBLITE_MPU_TABLE_UHCI1` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_UHCI1_SPEC>;
///Register `AHBLITE_MPU_TABLE_UHCI1` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_UHCI1_SPEC>;
///Field `UHCI1_ACCESS_GRANT_CONFIG` reader -
pub type UHCI1_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `UHCI1_ACCESS_GRANT_CONFIG` writer -
...
You can [`read`](crate::generic::Reg::read) this register and get [`ahblite_mpu_table_uhci1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ahblite_mpu_table_uhci1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct AHBLITE_MPU_TABLE_UHCI1_SPEC;
impl crate::RegisterSpec for AHBLITE_MPU_TABLE_UHCI1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`ahblite_mpu_table_uhci1::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_UHCI1_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_uhci1::W`](W) writer structure
