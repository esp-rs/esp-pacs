///Register `AHBLITE_MPU_TABLE_FE` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_FE_SPEC>;
///Register `AHBLITE_MPU_TABLE_FE` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_FE_SPEC>;
///Field `FE_ACCESS_GRANT_CONFIG` reader -
pub type FE_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `FE_ACCESS_GRANT_CONFIG` writer -
...
You can [`read`](crate::generic::Reg::read) this register and get [`ahblite_mpu_table_fe::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ahblite_mpu_table_fe::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct AHBLITE_MPU_TABLE_FE_SPEC;
impl crate::RegisterSpec for AHBLITE_MPU_TABLE_FE_SPEC {
    type Ux = u32;
}
///`read()` method returns [`ahblite_mpu_table_fe::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_FE_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_fe::W`](W) writer structure
