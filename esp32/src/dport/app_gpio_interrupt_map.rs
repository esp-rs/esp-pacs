///Register `APP_GPIO_INTERRUPT_MAP` reader
pub type R = crate::R<APP_GPIO_INTERRUPT_MAP_SPEC>;
///Register `APP_GPIO_INTERRUPT_MAP` writer
pub type W = crate::W<APP_GPIO_INTERRUPT_MAP_SPEC>;
///Field `APP_GPIO_INTERRUPT_APP_MAP` reader -
pub type APP_GPIO_INTERRUPT_APP_MAP_R = crate::FieldReader;
///Field `APP_GPIO_INTERRUPT_APP_MAP` writer -
...
You can [`read`](crate::generic::Reg::read) this register and get [`app_gpio_interrupt_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`app_gpio_interrupt_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APP_GPIO_INTERRUPT_MAP_SPEC;
impl crate::RegisterSpec for APP_GPIO_INTERRUPT_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`app_gpio_interrupt_map::R`](R) reader structure
impl crate::Readable for APP_GPIO_INTERRUPT_MAP_SPEC {}
///`write(|w| ..)` method takes [`app_gpio_interrupt_map::W`](W) writer structure
impl crate::Writable for APP_GPIO_INTERRUPT_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APP_GPIO_INTERRUPT_MAP to value 0x10
