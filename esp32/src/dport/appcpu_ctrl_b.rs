///Register `APPCPU_CTRL_B` reader
pub type R = crate::R<APPCPU_CTRL_B_SPEC>;
///Register `APPCPU_CTRL_B` writer
pub type W = crate::W<APPCPU_CTRL_B_SPEC>;
///Field `APPCPU_CLKGATE_EN` reader -
pub type APPCPU_CLKGATE_EN_R = crate::BitReader;
///Field `APPCPU_CLKGATE_EN` writer -
...
///`read()` method returns [`appcpu_ctrl_b::R`](R) reader structure
impl crate::Readable for APPCPU_CTRL_B_SPEC {}
///`write(|w| ..)` method takes [`appcpu_ctrl_b::W`](W) writer structure
