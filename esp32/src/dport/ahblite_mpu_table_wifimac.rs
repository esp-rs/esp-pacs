///Register `AHBLITE_MPU_TABLE_WIFIMAC` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_WIFIMAC_SPEC>;
///Register `AHBLITE_MPU_TABLE_WIFIMAC` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_WIFIMAC_SPEC>;
///Field `WIFIMAC_ACCESS_GRANT_CONFIG` reader -
pub type WIFIMAC_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `WIFIMAC_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_wifimac::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_WIFIMAC_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_wifimac::W`](W) writer structure
