...
pub type IMMU_TABLE12_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IMMU_TABLE12")
            .field(
                "immu_table12",
                &format_args!("{}", self.immu_table12().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<IMMU_TABLE12_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn immu_table12(&mut self) -> IMMU_TABLE12_W<IMMU_TABLE12_SPEC, 0> {
