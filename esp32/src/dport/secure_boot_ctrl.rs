///Register `SECURE_BOOT_CTRL` reader
pub type R = crate::R<SECURE_BOOT_CTRL_SPEC>;
///Register `SECURE_BOOT_CTRL` writer
pub type W = crate::W<SECURE_BOOT_CTRL_SPEC>;
///Field `SW_BOOTLOADER_SEL` reader -
pub type SW_BOOTLOADER_SEL_R = crate::BitReader;
///Field `SW_BOOTLOADER_SEL` writer -
...
///`read()` method returns [`secure_boot_ctrl::R`](R) reader structure
impl crate::Readable for SECURE_BOOT_CTRL_SPEC {}
///`write(|w| ..)` method takes [`secure_boot_ctrl::W`](W) writer structure
