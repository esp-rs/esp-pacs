...
pub type APP_SPI_INTR_0_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_spi_intr_0_map(&mut self) -> APP_SPI_INTR_0_MAP_W<APP_SPI_INTR_0_MAP_SPEC, 0> {
