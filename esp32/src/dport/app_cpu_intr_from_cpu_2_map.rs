///Register `APP_CPU_INTR_FROM_CPU_2_MAP` reader
pub type R = crate::R<APP_CPU_INTR_FROM_CPU_2_MAP_SPEC>;
///Register `APP_CPU_INTR_FROM_CPU_2_MAP` writer
pub type W = crate::W<APP_CPU_INTR_FROM_CPU_2_MAP_SPEC>;
///Field `APP_CPU_INTR_FROM_CPU_2_MAP` reader -
pub type APP_CPU_INTR_FROM_CPU_2_MAP_R = crate::FieldReader;
///Field `APP_CPU_INTR_FROM_CPU_2_MAP` writer -
...
///`read()` method returns [`app_cpu_intr_from_cpu_2_map::R`](R) reader structure
impl crate::Readable for APP_CPU_INTR_FROM_CPU_2_MAP_SPEC {}
///`write(|w| ..)` method takes [`app_cpu_intr_from_cpu_2_map::W`](W) writer structure
impl crate::Writable for APP_CPU_INTR_FROM_CPU_2_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APP_CPU_INTR_FROM_CPU_2_MAP to value 0x10
