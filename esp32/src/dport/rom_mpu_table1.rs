...
///`read()` method returns [`rom_mpu_table1::R`](R) reader structure
impl crate::Readable for ROM_MPU_TABLE1_SPEC {}
///`write(|w| ..)` method takes [`rom_mpu_table1::W`](W) writer structure
impl crate::Writable for ROM_MPU_TABLE1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ROM_MPU_TABLE1 to value 0x01
