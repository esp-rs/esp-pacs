///Register `AHBLITE_MPU_TABLE_HINF` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_HINF_SPEC>;
///Register `AHBLITE_MPU_TABLE_HINF` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_HINF_SPEC>;
///Field `HINF_ACCESS_GRANT_CONFIG` reader -
pub type HINF_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `HINF_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_hinf::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_HINF_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_hinf::W`](W) writer structure
