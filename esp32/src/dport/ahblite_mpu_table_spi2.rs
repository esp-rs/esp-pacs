///Register `AHBLITE_MPU_TABLE_SPI2` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_SPI2_SPEC>;
///Register `AHBLITE_MPU_TABLE_SPI2` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_SPI2_SPEC>;
///Field `SPI2_ACCESS_GRANT_CONFIG` reader -
pub type SPI2_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `SPI2_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_spi2::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_SPI2_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_spi2::W`](W) writer structure
