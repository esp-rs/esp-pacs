...
///`read()` method returns [`sram_pd_ctrl_1::R`](R) reader structure
impl crate::Readable for SRAM_PD_CTRL_1_SPEC {}
///`write(|w| ..)` method takes [`sram_pd_ctrl_1::W`](W) writer structure
