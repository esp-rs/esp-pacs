...
pub type PRO_I2C_EXT0_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_i2c_ext0_intr_map(
        &mut self,
    ) -> PRO_I2C_EXT0_INTR_MAP_W<PRO_I2C_EXT0_INTR_MAP_SPEC, 0> {
