...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_DCACHE_DBUG7")
            .field("app_iram1addr_ia", &self.app_iram1addr_ia())
            .finish()
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`app_dcache_dbug7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
