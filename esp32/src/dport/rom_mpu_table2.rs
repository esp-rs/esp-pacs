...
You can [`read`](crate::generic::Reg::read) this register and get [`rom_mpu_table2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rom_mpu_table2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct ROM_MPU_TABLE2_SPEC;
impl crate::RegisterSpec for ROM_MPU_TABLE2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`rom_mpu_table2::R`](R) reader structure
impl crate::Readable for ROM_MPU_TABLE2_SPEC {}
///`write(|w| ..)` method takes [`rom_mpu_table2::W`](W) writer structure
impl crate::Writable for ROM_MPU_TABLE2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets ROM_MPU_TABLE2 to value 0x01
