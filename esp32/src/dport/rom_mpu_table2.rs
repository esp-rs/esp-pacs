...
pub type ROM_MPU_TABLE2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    #[doc = "Bits 0:1"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ROM_MPU_TABLE2")
            .field(
                "rom_mpu_table2",
                &format_args!("{}", self.rom_mpu_table2().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<ROM_MPU_TABLE2_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rom_mpu_table2(&mut self) -> ROM_MPU_TABLE2_W<ROM_MPU_TABLE2_SPEC, 0> {
