...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IMMU_TABLE10")
            .field("immu_table10", &self.immu_table10())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`immu_table10::R`](R) reader structure
impl crate::Readable for IMMU_TABLE10_SPEC {}
///`write(|w| ..)` method takes [`immu_table10::W`](W) writer structure
impl crate::Writable for IMMU_TABLE10_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets IMMU_TABLE10 to value 0x0a
