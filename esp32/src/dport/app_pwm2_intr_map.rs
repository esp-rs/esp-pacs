...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_PWM2_INTR_MAP")
            .field("app_pwm2_intr_map", &self.app_pwm2_intr_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`app_pwm2_intr_map::R`](R) reader structure
impl crate::Readable for APP_PWM2_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`app_pwm2_intr_map::W`](W) writer structure
impl crate::Writable for APP_PWM2_INTR_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APP_PWM2_INTR_MAP to value 0x10
