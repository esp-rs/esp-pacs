///Register `AHBLITE_MPU_TABLE_TIMER` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_TIMER_SPEC>;
///Register `AHBLITE_MPU_TABLE_TIMER` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_TIMER_SPEC>;
///Field `TIMER_ACCESS_GRANT_CONFIG` reader -
pub type TIMER_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `TIMER_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_timer::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_TIMER_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_timer::W`](W) writer structure
