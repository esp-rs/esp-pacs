///Register `APP_GPIO_INTERRUPT_NMI_MAP` reader
pub type R = crate::R<APP_GPIO_INTERRUPT_NMI_MAP_SPEC>;
///Register `APP_GPIO_INTERRUPT_NMI_MAP` writer
pub type W = crate::W<APP_GPIO_INTERRUPT_NMI_MAP_SPEC>;
///Field `APP_GPIO_INTERRUPT_APP_NMI_MAP` reader -
pub type APP_GPIO_INTERRUPT_APP_NMI_MAP_R = crate::FieldReader;
///Field `APP_GPIO_INTERRUPT_APP_NMI_MAP` writer -
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_GPIO_INTERRUPT_NMI_MAP")
            .field(
                ...
                &self.app_gpio_interrupt_app_nmi_map(),
            )
            .finish()
    }
}
...
///`read()` method returns [`app_gpio_interrupt_nmi_map::R`](R) reader structure
impl crate::Readable for APP_GPIO_INTERRUPT_NMI_MAP_SPEC {}
///`write(|w| ..)` method takes [`app_gpio_interrupt_nmi_map::W`](W) writer structure
impl crate::Writable for APP_GPIO_INTERRUPT_NMI_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APP_GPIO_INTERRUPT_NMI_MAP to value 0x10
