...
pub type APP_GPIO_INTERRUPT_APP_NMI_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    pub fn app_gpio_interrupt_app_nmi_map(
        &mut self,
    ) -> APP_GPIO_INTERRUPT_APP_NMI_MAP_W<APP_GPIO_INTERRUPT_NMI_MAP_SPEC, 0> {
