...
pub type R = crate::R<APP_CACHE_LOCK_0_ADDR_SPEC>;
#[doc = "Register `APP_CACHE_LOCK_0_ADDR` writer"]
pub type W = crate::W<APP_CACHE_LOCK_0_ADDR_SPEC>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_CACHE_LOCK_0_ADDR")
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<APP_CACHE_LOCK_0_ADDR_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pre(&mut self) -> PRE_W<APP_CACHE_LOCK_0_ADDR_SPEC, 0> {
        PRE_W::new(self)
    }
    #[doc = "Bits 14:17"]
    #[inline(always)]
    #[must_use]
    pub fn min(&mut self) -> MIN_W<APP_CACHE_LOCK_0_ADDR_SPEC, 14> {
        MIN_W::new(self)
    }
    #[doc = "Bits 18:21"]
    #[inline(always)]
    #[must_use]
    pub fn max(&mut self) -> MAX_W<APP_CACHE_LOCK_0_ADDR_SPEC, 18> {
        MAX_W::new(self)
    }
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`app_cache_lock_0_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`app_cache_lock_0_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct APP_CACHE_LOCK_0_ADDR_SPEC;
impl crate::RegisterSpec for APP_CACHE_LOCK_0_ADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`app_cache_lock_0_addr::R`](R) reader structure"]
impl crate::Readable for APP_CACHE_LOCK_0_ADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`app_cache_lock_0_addr::W`](W) writer structure"]
