///Register `APP_VECBASE_CTRL` reader
pub type R = crate::R<APP_VECBASE_CTRL_SPEC>;
///Register `APP_VECBASE_CTRL` writer
pub type W = crate::W<APP_VECBASE_CTRL_SPEC>;
///Field `APP_OUT_VECBASE_SEL` reader -
pub type APP_OUT_VECBASE_SEL_R = crate::FieldReader;
///Field `APP_OUT_VECBASE_SEL` writer -
...
///`read()` method returns [`app_vecbase_ctrl::R`](R) reader structure
impl crate::Readable for APP_VECBASE_CTRL_SPEC {}
///`write(|w| ..)` method takes [`app_vecbase_ctrl::W`](W) writer structure
