...
///`read()` method returns [`mmu_ia_int_en::R`](R) reader structure
impl crate::Readable for MMU_IA_INT_EN_SPEC {}
///`write(|w| ..)` method takes [`mmu_ia_int_en::W`](W) writer structure
