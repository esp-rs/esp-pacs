...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn pro_rom_fo(&mut self) -> PRO_ROM_FO_W<'_, ROM_FO_CTRL_SPEC> {
        PRO_ROM_FO_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn app_rom_fo(&mut self) -> APP_ROM_FO_W<'_, ROM_FO_CTRL_SPEC> {
        APP_ROM_FO_W::new(self, 1)
    }
    #[doc = "Bits 2:7"]
    #[inline(always)]
    pub fn share_rom_fo(&mut self) -> SHARE_ROM_FO_W<'_, ROM_FO_CTRL_SPEC> {
        SHARE_ROM_FO_W::new(self, 2)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`rom_fo_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rom_fo_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
