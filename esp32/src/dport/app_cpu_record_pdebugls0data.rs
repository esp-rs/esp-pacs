///Register `APP_CPU_RECORD_PDEBUGLS0DATA` reader
pub type R = crate::R<APP_CPU_RECORD_PDEBUGLS0DATA_SPEC>;
///Field `RECORD_APP_PDEBUGLS0DATA` reader -
...
///`read()` method returns [`app_cpu_record_pdebugls0data::R`](R) reader structure
