///Register `AHBLITE_MPU_TABLE_BTMAC` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_BTMAC_SPEC>;
///Register `AHBLITE_MPU_TABLE_BTMAC` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_BTMAC_SPEC>;
///Field `BTMAC_ACCESS_GRANT_CONFIG` reader -
pub type BTMAC_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `BTMAC_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_btmac::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_BTMAC_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_btmac::W`](W) writer structure
