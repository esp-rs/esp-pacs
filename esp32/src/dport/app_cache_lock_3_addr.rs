///Register `APP_CACHE_LOCK_3_ADDR` reader
pub type R = crate::R<APP_CACHE_LOCK_3_ADDR_SPEC>;
///Register `APP_CACHE_LOCK_3_ADDR` writer
...
///`read()` method returns [`app_cache_lock_3_addr::R`](R) reader structure
impl crate::Readable for APP_CACHE_LOCK_3_ADDR_SPEC {}
///`write(|w| ..)` method takes [`app_cache_lock_3_addr::W`](W) writer structure
