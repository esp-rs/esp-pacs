///Register `AHBLITE_MPU_TABLE_I2S0` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_I2S0_SPEC>;
///Register `AHBLITE_MPU_TABLE_I2S0` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_I2S0_SPEC>;
///Field `I2S0_ACCESS_GRANT_CONFIG` reader -
pub type I2S0_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `I2S0_ACCESS_GRANT_CONFIG` writer -
pub type I2S0_ACCESS_GRANT_CONFIG_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHBLITE_MPU_TABLE_I2S0")
            .field("i2s0_access_grant_config", &self.i2s0_access_grant_config())
            .finish()
    }
}
impl W {
    ...
    pub fn i2s0_access_grant_config(
        &mut self,
    ) -> I2S0_ACCESS_GRANT_CONFIG_W<AHBLITE_MPU_TABLE_I2S0_SPEC> {
        I2S0_ACCESS_GRANT_CONFIG_W::new(self, 0)
    }
}
/**
...
///`read()` method returns [`ahblite_mpu_table_i2s0::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_I2S0_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_i2s0::W`](W) writer structure
