///Register `PRO_DCACHE_DBUG6` reader
pub type R = crate::R<PRO_DCACHE_DBUG6_SPEC>;
///Field `PRO_IRAM0ADDR_IA` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`pro_dcache_dbug6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PRO_DCACHE_DBUG6_SPEC;
impl crate::RegisterSpec for PRO_DCACHE_DBUG6_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pro_dcache_dbug6::R`](R) reader structure
