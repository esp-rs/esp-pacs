///Register `AHBLITE_MPU_TABLE_UART1` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_UART1_SPEC>;
///Register `AHBLITE_MPU_TABLE_UART1` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_UART1_SPEC>;
///Field `UART1_ACCESS_GRANT_CONFIG` reader -
pub type UART1_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `UART1_ACCESS_GRANT_CONFIG` writer -
pub type UART1_ACCESS_GRANT_CONFIG_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHBLITE_MPU_TABLE_UART1")
            .field(
                ...
                &self.uart1_access_grant_config(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn uart1_access_grant_config(
        &mut self,
    ) -> UART1_ACCESS_GRANT_CONFIG_W<AHBLITE_MPU_TABLE_UART1_SPEC> {
        UART1_ACCESS_GRANT_CONFIG_W::new(self, 0)
    }
}
/**
...
///`read()` method returns [`ahblite_mpu_table_uart1::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_UART1_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_uart1::W`](W) writer structure
