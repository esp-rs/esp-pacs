...
///`read()` method returns [`sram_fo_ctrl_0::R`](R) reader structure
impl crate::Readable for SRAM_FO_CTRL_0_SPEC {}
///`write(|w| ..)` method takes [`sram_fo_ctrl_0::W`](W) writer structure
impl crate::Writable for SRAM_FO_CTRL_0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SRAM_FO_CTRL_0 to value 0xffff_ffff
