...
pub type SRAM_FO_0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SRAM_FO_CTRL_0")
            .field("sram_fo_0", &format_args!("{}", self.sram_fo_0().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SRAM_FO_CTRL_0_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sram_fo_0(&mut self) -> SRAM_FO_0_W<SRAM_FO_CTRL_0_SPEC, 0> {
