...
///`read()` method returns [`pro_cache_ctrl1::R`](R) reader structure
impl crate::Readable for PRO_CACHE_CTRL1_SPEC {}
///`write(|w| ..)` method takes [`pro_cache_ctrl1::W`](W) writer structure
impl crate::Writable for PRO_CACHE_CTRL1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PRO_CACHE_CTRL1 to value 0x08ff
