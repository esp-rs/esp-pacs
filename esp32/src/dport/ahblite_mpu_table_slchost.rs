///Register `AHBLITE_MPU_TABLE_SLCHOST` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_SLCHOST_SPEC>;
///Register `AHBLITE_MPU_TABLE_SLCHOST` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_SLCHOST_SPEC>;
///Field `SLCHOST_ACCESS_GRANT_CONFIG` reader -
pub type SLCHOST_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `SLCHOST_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_slchost::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_SLCHOST_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_slchost::W`](W) writer structure
