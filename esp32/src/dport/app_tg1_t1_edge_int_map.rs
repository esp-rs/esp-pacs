///Register `APP_TG1_T1_EDGE_INT_MAP` reader
pub type R = crate::R<APP_TG1_T1_EDGE_INT_MAP_SPEC>;
///Register `APP_TG1_T1_EDGE_INT_MAP` writer
pub type W = crate::W<APP_TG1_T1_EDGE_INT_MAP_SPEC>;
///Field `APP_TG1_T1_EDGE_INT_MAP` reader -
pub type APP_TG1_T1_EDGE_INT_MAP_R = crate::FieldReader;
///Field `APP_TG1_T1_EDGE_INT_MAP` writer -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_TG1_T1_EDGE_INT_MAP")
            .field("app_tg1_t1_edge_int_map", &self.app_tg1_t1_edge_int_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`app_tg1_t1_edge_int_map::R`](R) reader structure
impl crate::Readable for APP_TG1_T1_EDGE_INT_MAP_SPEC {}
///`write(|w| ..)` method takes [`app_tg1_t1_edge_int_map::W`](W) writer structure
impl crate::Writable for APP_TG1_T1_EDGE_INT_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APP_TG1_T1_EDGE_INT_MAP to value 0x10
