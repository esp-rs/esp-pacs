...
You can [`read`](crate::generic::Reg::read) this register and get [`mem_access_dbug1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct MEM_ACCESS_DBUG1_SPEC;
impl crate::RegisterSpec for MEM_ACCESS_DBUG1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`mem_access_dbug1::R`](R) reader structure
