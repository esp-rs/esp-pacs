...
pub type SPI0_ACCESS_GRANT_CONFIG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<AHBLITE_MPU_TABLE_SPI0_SPEC> {
...
impl W {
    ...
    pub fn spi0_access_grant_config(
        &mut self,
    ) -> SPI0_ACCESS_GRANT_CONFIG_W<AHBLITE_MPU_TABLE_SPI0_SPEC, 0> {
