...
///`read()` method returns [`peri_clk_en::R`](R) reader structure
impl crate::Readable for PERI_CLK_EN_SPEC {}
///`write(|w| ..)` method takes [`peri_clk_en::W`](W) writer structure
