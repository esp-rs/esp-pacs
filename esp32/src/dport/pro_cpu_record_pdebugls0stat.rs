...
///`read()` method returns [`pro_cpu_record_pdebugls0stat::R`](R) reader structure
impl crate::Readable for PRO_CPU_RECORD_PDEBUGLS0STAT_SPEC {}
///`write(|w| ..)` method takes [`pro_cpu_record_pdebugls0stat::W`](W) writer structure
