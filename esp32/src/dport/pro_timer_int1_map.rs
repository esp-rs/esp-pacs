...
pub type PRO_TIMER_INT1_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_timer_int1_map(&mut self) -> PRO_TIMER_INT1_MAP_W<PRO_TIMER_INT1_MAP_SPEC, 0> {
