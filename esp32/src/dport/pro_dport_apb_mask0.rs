...
///`read()` method returns [`pro_dport_apb_mask0::R`](R) reader structure
impl crate::Readable for PRO_DPORT_APB_MASK0_SPEC {}
///`write(|w| ..)` method takes [`pro_dport_apb_mask0::W`](W) writer structure
