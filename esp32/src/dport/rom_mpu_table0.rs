...
pub struct R(crate::R<ROM_MPU_TABLE0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ROM_MPU_TABLE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ROM_MPU_TABLE0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ROM_MPU_TABLE0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ROM_MPU_TABLE0` writer"]
pub struct W(crate::W<ROM_MPU_TABLE0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ROM_MPU_TABLE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ROM_MPU_TABLE0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ROM_MPU_TABLE0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ROM_MPU_TABLE0` reader - "]
pub type ROM_MPU_TABLE0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ROM_MPU_TABLE0` writer - "]
pub type ROM_MPU_TABLE0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ROM_MPU_TABLE0_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:1"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rom_mpu_table0(&mut self) -> ROM_MPU_TABLE0_W<0> {
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rom_mpu_table0](index.html) module"]
