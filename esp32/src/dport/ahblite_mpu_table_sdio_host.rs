///Register `AHBLITE_MPU_TABLE_SDIO_HOST` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_SDIO_HOST_SPEC>;
///Register `AHBLITE_MPU_TABLE_SDIO_HOST` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_SDIO_HOST_SPEC>;
///Field `SDIOHOST_ACCESS_GRANT_CONFIG` reader -
pub type SDIOHOST_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `SDIOHOST_ACCESS_GRANT_CONFIG` writer -
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHBLITE_MPU_TABLE_SDIO_HOST")
            .field(
                ...
                &self.sdiohost_access_grant_config(),
            )
            .finish()
    }
}
...
///`read()` method returns [`ahblite_mpu_table_sdio_host::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_SDIO_HOST_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_sdio_host::W`](W) writer structure
