...
///`read()` method returns [`immu_table0::R`](R) reader structure
impl crate::Readable for IMMU_TABLE0_SPEC {}
///`write(|w| ..)` method takes [`immu_table0::W`](W) writer structure
