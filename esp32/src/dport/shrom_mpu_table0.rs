...
///`read()` method returns [`shrom_mpu_table0::R`](R) reader structure
impl crate::Readable for SHROM_MPU_TABLE0_SPEC {}
///`write(|w| ..)` method takes [`shrom_mpu_table0::W`](W) writer structure
impl crate::Writable for SHROM_MPU_TABLE0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHROM_MPU_TABLE0 to value 0x01
