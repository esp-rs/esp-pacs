///Register `AHBLITE_MPU_TABLE_BB` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_BB_SPEC>;
///Register `AHBLITE_MPU_TABLE_BB` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_BB_SPEC>;
///Field `BB_ACCESS_GRANT_CONFIG` reader -
pub type BB_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `BB_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_bb::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_BB_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_bb::W`](W) writer structure
