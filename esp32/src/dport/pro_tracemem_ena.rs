...
///`read()` method returns [`pro_tracemem_ena::R`](R) reader structure
impl crate::Readable for PRO_TRACEMEM_ENA_SPEC {}
///`write(|w| ..)` method takes [`pro_tracemem_ena::W`](W) writer structure
