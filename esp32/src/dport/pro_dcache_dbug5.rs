///Register `PRO_DCACHE_DBUG5` reader
pub type R = crate::R<PRO_DCACHE_DBUG5_SPEC>;
///Field `PRO_DROM0ADDR0_IA` reader -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_DCACHE_DBUG5")
            .field("pro_drom0addr0_ia", &self.pro_drom0addr0_ia())
            .finish()
    }
}
/**
...
///`read()` method returns [`pro_dcache_dbug5::R`](R) reader structure
