...
pub type TIMERGROUP_ACCESS_GRANT_CONFIG_W<'a, const O: u8> =
    crate::FieldWriter<'a, AHBLITE_MPU_TABLE_TIMERGROUP_SPEC, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timergroup_access_grant_config(&mut self) -> TIMERGROUP_ACCESS_GRANT_CONFIG_W<0> {
