...
pub type PWM2_ACCESS_GRANT_CONFIG_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHBLITE_MPU_TABLE_PWM2")
            .field(
                ...
                &format_args!("{}", self.pwm2_access_grant_config().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<AHBLITE_MPU_TABLE_PWM2_SPEC> {
...
impl W {
    ...
    pub fn pwm2_access_grant_config(
        &mut self,
    ) -> PWM2_ACCESS_GRANT_CONFIG_W<AHBLITE_MPU_TABLE_PWM2_SPEC, 0> {
