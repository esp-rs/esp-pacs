...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRO_DCACHE_DBUG8")
            .field("pro_irom0addr_ia", &self.pro_irom0addr_ia())
            .finish()
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`pro_dcache_dbug8::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
