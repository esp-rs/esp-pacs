///Register `AHBLITE_MPU_TABLE_UHCI0` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_UHCI0_SPEC>;
///Register `AHBLITE_MPU_TABLE_UHCI0` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_UHCI0_SPEC>;
///Field `UHCI0_ACCESS_GRANT_CONFIG` reader -
pub type UHCI0_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `UHCI0_ACCESS_GRANT_CONFIG` writer -
pub type UHCI0_ACCESS_GRANT_CONFIG_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHBLITE_MPU_TABLE_UHCI0")
            .field(
                ...
                &self.uhci0_access_grant_config(),
            )
            .finish()
    }
}
impl W {
    ...
    pub fn uhci0_access_grant_config(
        &mut self,
    ) -> UHCI0_ACCESS_GRANT_CONFIG_W<AHBLITE_MPU_TABLE_UHCI0_SPEC> {
        UHCI0_ACCESS_GRANT_CONFIG_W::new(self, 0)
    }
}
/**
...
///`read()` method returns [`ahblite_mpu_table_uhci0::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_UHCI0_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_uhci0::W`](W) writer structure
