///Register `PRO_CACHE_LOCK_2_ADDR` reader
pub type R = crate::R<PRO_CACHE_LOCK_2_ADDR_SPEC>;
///Register `PRO_CACHE_LOCK_2_ADDR` writer
...
///`read()` method returns [`pro_cache_lock_2_addr::R`](R) reader structure
impl crate::Readable for PRO_CACHE_LOCK_2_ADDR_SPEC {}
///`write(|w| ..)` method takes [`pro_cache_lock_2_addr::W`](W) writer structure
