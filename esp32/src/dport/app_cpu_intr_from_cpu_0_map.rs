...
pub struct R(crate::R<APP_CPU_INTR_FROM_CPU_0_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<APP_CPU_INTR_FROM_CPU_0_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<APP_CPU_INTR_FROM_CPU_0_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<APP_CPU_INTR_FROM_CPU_0_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `APP_CPU_INTR_FROM_CPU_0_MAP` writer"]
pub struct W(crate::W<APP_CPU_INTR_FROM_CPU_0_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<APP_CPU_INTR_FROM_CPU_0_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<APP_CPU_INTR_FROM_CPU_0_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<APP_CPU_INTR_FROM_CPU_0_MAP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type APP_CPU_INTR_FROM_CPU_0_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, APP_CPU_INTR_FROM_CPU_0_MAP_SPEC, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_CPU_INTR_FROM_CPU_0_MAP")
            .field(
                ...
                &format_args!("{}", self.app_cpu_intr_from_cpu_0_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<APP_CPU_INTR_FROM_CPU_0_MAP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_cpu_intr_from_cpu_0_map(&mut self) -> APP_CPU_INTR_FROM_CPU_0_MAP_W<0> {
        APP_CPU_INTR_FROM_CPU_0_MAP_W::new(self)
    }
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [app_cpu_intr_from_cpu_0_map](index.html) module"]
