...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPI_DMA_CHAN_SEL")
            .field("spi1_dma_chan_sel", &self.spi1_dma_chan_sel().bits())
            .field("spi2_dma_chan_sel", &self.spi2_dma_chan_sel().bits())
            .field("spi3_dma_chan_sel", &self.spi3_dma_chan_sel().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
