...
You can [`read`](crate::generic::Reg::read) this register and get [`pro_boot_remap_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pro_boot_remap_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PRO_BOOT_REMAP_CTRL_SPEC;
impl crate::RegisterSpec for PRO_BOOT_REMAP_CTRL_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pro_boot_remap_ctrl::R`](R) reader structure
impl crate::Readable for PRO_BOOT_REMAP_CTRL_SPEC {}
///`write(|w| ..)` method takes [`pro_boot_remap_ctrl::W`](W) writer structure
