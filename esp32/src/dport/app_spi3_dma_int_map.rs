...
pub type APP_SPI3_DMA_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_spi3_dma_int_map(&mut self) -> APP_SPI3_DMA_INT_MAP_W<APP_SPI3_DMA_INT_MAP_SPEC, 0> {
