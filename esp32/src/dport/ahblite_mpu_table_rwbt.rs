///Register `AHBLITE_MPU_TABLE_RWBT` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_RWBT_SPEC>;
///Register `AHBLITE_MPU_TABLE_RWBT` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_RWBT_SPEC>;
///Field `RWBT_ACCESS_GRANT_CONFIG` reader -
pub type RWBT_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `RWBT_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_rwbt::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_RWBT_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_rwbt::W`](W) writer structure
