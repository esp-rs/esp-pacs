///Register `AHBLITE_MPU_TABLE_LEDC` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_LEDC_SPEC>;
///Register `AHBLITE_MPU_TABLE_LEDC` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_LEDC_SPEC>;
///Field `LEDC_ACCESS_GRANT_CONFIG` reader -
pub type LEDC_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `LEDC_ACCESS_GRANT_CONFIG` writer -
pub type LEDC_ACCESS_GRANT_CONFIG_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
impl R {
    ///Bits 0:5
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHBLITE_MPU_TABLE_LEDC")
            .field("ledc_access_grant_config", &self.ledc_access_grant_config())
            .finish()
    }
}
impl W {
    ...
    pub fn ledc_access_grant_config(
        &mut self,
    ) -> LEDC_ACCESS_GRANT_CONFIG_W<AHBLITE_MPU_TABLE_LEDC_SPEC> {
        LEDC_ACCESS_GRANT_CONFIG_W::new(self, 0)
    }
}
/**
...
///`read()` method returns [`ahblite_mpu_table_ledc::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_LEDC_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_ledc::W`](W) writer structure
