///Register `APP_CACHE_LOCK_2_ADDR` reader
pub type R = crate::R<APP_CACHE_LOCK_2_ADDR_SPEC>;
///Register `APP_CACHE_LOCK_2_ADDR` writer
pub type W = crate::W<APP_CACHE_LOCK_2_ADDR_SPEC>;
///Field `PRE` reader -
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pre(&mut self) -> PRE_W<APP_CACHE_LOCK_2_ADDR_SPEC> {
        PRE_W::new(self, 0)
    }
    ///Bits 14:17
    #[inline(always)]
    #[must_use]
    pub fn min(&mut self) -> MIN_W<APP_CACHE_LOCK_2_ADDR_SPEC> {
        MIN_W::new(self, 14)
    }
    ///Bits 18:21
    #[inline(always)]
    #[must_use]
    pub fn max(&mut self) -> MAX_W<APP_CACHE_LOCK_2_ADDR_SPEC> {
        MAX_W::new(self, 18)
    }
}
/**

You can [`read`](crate::generic::Reg::read) this register and get [`app_cache_lock_2_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`app_cache_lock_2_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APP_CACHE_LOCK_2_ADDR_SPEC;
impl crate::RegisterSpec for APP_CACHE_LOCK_2_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`app_cache_lock_2_addr::R`](R) reader structure
impl crate::Readable for APP_CACHE_LOCK_2_ADDR_SPEC {}
///`write(|w| ..)` method takes [`app_cache_lock_2_addr::W`](W) writer structure
