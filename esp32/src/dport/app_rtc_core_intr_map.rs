///Register `APP_RTC_CORE_INTR_MAP` reader
pub type R = crate::R<APP_RTC_CORE_INTR_MAP_SPEC>;
///Register `APP_RTC_CORE_INTR_MAP` writer
pub type W = crate::W<APP_RTC_CORE_INTR_MAP_SPEC>;
///Field `APP_RTC_CORE_INTR_MAP` reader -
pub type APP_RTC_CORE_INTR_MAP_R = crate::FieldReader;
///Field `APP_RTC_CORE_INTR_MAP` writer -
pub type APP_RTC_CORE_INTR_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_RTC_CORE_INTR_MAP")
            .field("app_rtc_core_intr_map", &self.app_rtc_core_intr_map())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`app_rtc_core_intr_map::R`](R) reader structure
impl crate::Readable for APP_RTC_CORE_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`app_rtc_core_intr_map::W`](W) writer structure
impl crate::Writable for APP_RTC_CORE_INTR_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APP_RTC_CORE_INTR_MAP to value 0x10
