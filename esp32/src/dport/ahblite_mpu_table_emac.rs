///Register `AHBLITE_MPU_TABLE_EMAC` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_EMAC_SPEC>;
///Register `AHBLITE_MPU_TABLE_EMAC` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_EMAC_SPEC>;
///Field `EMAC_ACCESS_GRANT_CONFIG` reader -
pub type EMAC_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `EMAC_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_emac::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_EMAC_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_emac::W`](W) writer structure
