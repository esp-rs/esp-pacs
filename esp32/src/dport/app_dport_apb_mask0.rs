...
///`read()` method returns [`app_dport_apb_mask0::R`](R) reader structure
impl crate::Readable for APP_DPORT_APB_MASK0_SPEC {}
///`write(|w| ..)` method takes [`app_dport_apb_mask0::W`](W) writer structure
