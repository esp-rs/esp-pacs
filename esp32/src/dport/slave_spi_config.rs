...
///`read()` method returns [`slave_spi_config::R`](R) reader structure
impl crate::Readable for SLAVE_SPI_CONFIG_SPEC {}
///`write(|w| ..)` method takes [`slave_spi_config::W`](W) writer structure
impl crate::Writable for SLAVE_SPI_CONFIG_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SLAVE_SPI_CONFIG to value 0
