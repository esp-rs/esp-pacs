...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn slave_spi_mask_pro(&mut self) -> SLAVE_SPI_MASK_PRO_W<'_, SLAVE_SPI_CONFIG_SPEC> {
        SLAVE_SPI_MASK_PRO_W::new(self, 0)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn slave_spi_mask_app(&mut self) -> SLAVE_SPI_MASK_APP_W<'_, SLAVE_SPI_CONFIG_SPEC> {
        SLAVE_SPI_MASK_APP_W::new(self, 4)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn spi_encrypt_enable(&mut self) -> SPI_ENCRYPT_ENABLE_W<'_, SLAVE_SPI_CONFIG_SPEC> {
        SPI_ENCRYPT_ENABLE_W::new(self, 8)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn spi_decrypt_enable(&mut self) -> SPI_DECRYPT_ENABLE_W<'_, SLAVE_SPI_CONFIG_SPEC> {
