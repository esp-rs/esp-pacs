...
You can [`read`](crate::generic::Reg::read) this register and get [`dmmu_table9::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dmmu_table9::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DMMU_TABLE9_SPEC;
impl crate::RegisterSpec for DMMU_TABLE9_SPEC {
    type Ux = u32;
}
///`read()` method returns [`dmmu_table9::R`](R) reader structure
impl crate::Readable for DMMU_TABLE9_SPEC {}
///`write(|w| ..)` method takes [`dmmu_table9::W`](W) writer structure
impl crate::Writable for DMMU_TABLE9_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMMU_TABLE9 to value 0x09
