...
pub type SHROM_MPU_TABLE14_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    #[doc = "Bits 0:1"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn shrom_mpu_table14(&mut self) -> SHROM_MPU_TABLE14_W<SHROM_MPU_TABLE14_SPEC, 0> {
