...
You can [`read`](crate::generic::Reg::read) this register and get [`shrom_mpu_table14::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`shrom_mpu_table14::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct SHROM_MPU_TABLE14_SPEC;
impl crate::RegisterSpec for SHROM_MPU_TABLE14_SPEC {
    type Ux = u32;
}
///`read()` method returns [`shrom_mpu_table14::R`](R) reader structure
impl crate::Readable for SHROM_MPU_TABLE14_SPEC {}
///`write(|w| ..)` method takes [`shrom_mpu_table14::W`](W) writer structure
impl crate::Writable for SHROM_MPU_TABLE14_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHROM_MPU_TABLE14 to value 0x01
