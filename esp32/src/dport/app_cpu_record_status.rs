///Register `APP_CPU_RECORD_STATUS` reader
pub type R = crate::R<APP_CPU_RECORD_STATUS_SPEC>;
///Field `APP_CPU_RECORDING` reader -
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_CPU_RECORD_STATUS")
            .field("app_cpu_recording", &self.app_cpu_recording())
            .finish()
    }
}
/**
...
///`read()` method returns [`app_cpu_record_status::R`](R) reader structure
