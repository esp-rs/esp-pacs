...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SHROM_MPU_TABLE20")
            .field("shrom_mpu_table20", &self.shrom_mpu_table20())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`shrom_mpu_table20::R`](R) reader structure
impl crate::Readable for SHROM_MPU_TABLE20_SPEC {}
///`write(|w| ..)` method takes [`shrom_mpu_table20::W`](W) writer structure
impl crate::Writable for SHROM_MPU_TABLE20_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SHROM_MPU_TABLE20 to value 0x01
