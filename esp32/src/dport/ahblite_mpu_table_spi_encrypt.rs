///Register `AHBLITE_MPU_TABLE_SPI_ENCRYPT` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_SPI_ENCRYPT_SPEC>;
///Register `AHBLITE_MPU_TABLE_SPI_ENCRYPT` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_SPI_ENCRYPT_SPEC>;
///Field `SPI_ENCRYPY_ACCESS_GRANT_CONFIG` reader -
pub type SPI_ENCRYPY_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `SPI_ENCRYPY_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_spi_encrypt::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_SPI_ENCRYPT_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_spi_encrypt::W`](W) writer structure
