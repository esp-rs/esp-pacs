///Register `AHBLITE_MPU_TABLE_IO_MUX` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_IO_MUX_SPEC>;
///Register `AHBLITE_MPU_TABLE_IO_MUX` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_IO_MUX_SPEC>;
///Field `IOMUX_ACCESS_GRANT_CONFIG` reader -
pub type IOMUX_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `IOMUX_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_io_mux::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_IO_MUX_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_io_mux::W`](W) writer structure
