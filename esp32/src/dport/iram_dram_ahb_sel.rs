...
///`read()` method returns [`iram_dram_ahb_sel::R`](R) reader structure
impl crate::Readable for IRAM_DRAM_AHB_SEL_SPEC {}
///`write(|w| ..)` method takes [`iram_dram_ahb_sel::W`](W) writer structure
