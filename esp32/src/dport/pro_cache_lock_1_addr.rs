///Register `PRO_CACHE_LOCK_1_ADDR` reader
pub type R = crate::R<PRO_CACHE_LOCK_1_ADDR_SPEC>;
///Register `PRO_CACHE_LOCK_1_ADDR` writer
pub type W = crate::W<PRO_CACHE_LOCK_1_ADDR_SPEC>;
///Field `PRE` reader -
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pre(&mut self) -> PRE_W<PRO_CACHE_LOCK_1_ADDR_SPEC> {
        PRE_W::new(self, 0)
    }
    ///Bits 14:17
    #[inline(always)]
    #[must_use]
    pub fn min(&mut self) -> MIN_W<PRO_CACHE_LOCK_1_ADDR_SPEC> {
        MIN_W::new(self, 14)
    }
    ///Bits 18:21
    #[inline(always)]
    #[must_use]
    pub fn max(&mut self) -> MAX_W<PRO_CACHE_LOCK_1_ADDR_SPEC> {
        MAX_W::new(self, 18)
    }
}
/**

You can [`read`](crate::generic::Reg::read) this register and get [`pro_cache_lock_1_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pro_cache_lock_1_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PRO_CACHE_LOCK_1_ADDR_SPEC;
impl crate::RegisterSpec for PRO_CACHE_LOCK_1_ADDR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pro_cache_lock_1_addr::R`](R) reader structure
impl crate::Readable for PRO_CACHE_LOCK_1_ADDR_SPEC {}
///`write(|w| ..)` method takes [`pro_cache_lock_1_addr::W`](W) writer structure
