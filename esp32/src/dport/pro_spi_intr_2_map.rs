...
pub type PRO_SPI_INTR_2_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_spi_intr_2_map(&mut self) -> PRO_SPI_INTR_2_MAP_W<PRO_SPI_INTR_2_MAP_SPEC, 0> {
