///Register `AHBLITE_MPU_TABLE_GPIO` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_GPIO_SPEC>;
///Register `AHBLITE_MPU_TABLE_GPIO` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_GPIO_SPEC>;
///Field `GPIO_ACCESS_GRANT_CONFIG` reader -
pub type GPIO_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `GPIO_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_gpio::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_GPIO_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_gpio::W`](W) writer structure
