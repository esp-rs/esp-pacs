...
///`read()` method returns [`app_dcache_dbug3::R`](R) reader structure
impl crate::Readable for APP_DCACHE_DBUG3_SPEC {}
///`write(|w| ..)` method takes [`app_dcache_dbug3::W`](W) writer structure
