...
pub type PRO_EFUSE_INT_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pro_efuse_int_map(&mut self) -> PRO_EFUSE_INT_MAP_W<PRO_EFUSE_INT_MAP_SPEC, 0> {
