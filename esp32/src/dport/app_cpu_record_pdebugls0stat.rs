///Register `APP_CPU_RECORD_PDEBUGLS0STAT` reader
pub type R = crate::R<APP_CPU_RECORD_PDEBUGLS0STAT_SPEC>;
///Field `RECORD_APP_PDEBUGLS0STAT` reader -
...
You can [`read`](crate::generic::Reg::read) this register and get [`app_cpu_record_pdebugls0stat::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APP_CPU_RECORD_PDEBUGLS0STAT_SPEC;
impl crate::RegisterSpec for APP_CPU_RECORD_PDEBUGLS0STAT_SPEC {
    type Ux = u32;
}
///`read()` method returns [`app_cpu_record_pdebugls0stat::R`](R) reader structure
