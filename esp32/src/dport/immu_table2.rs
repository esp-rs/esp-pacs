...
pub type IMMU_TABLE2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IMMU_TABLE2` writer - "]
pub type IMMU_TABLE2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IMMU_TABLE2_SPEC, u8, u8, 7, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn immu_table2(&mut self) -> IMMU_TABLE2_W<0> {
        IMMU_TABLE2_W::new(self)
    }
