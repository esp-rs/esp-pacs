...
///`read()` method returns [`immu_table2::R`](R) reader structure
impl crate::Readable for IMMU_TABLE2_SPEC {}
///`write(|w| ..)` method takes [`immu_table2::W`](W) writer structure
impl crate::Writable for IMMU_TABLE2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets IMMU_TABLE2 to value 0x02
