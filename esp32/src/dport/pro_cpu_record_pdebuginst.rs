///Register `PRO_CPU_RECORD_PDEBUGINST` reader
...
///`read()` method returns [`pro_cpu_record_pdebuginst::R`](R) reader structure
impl crate::Readable for PRO_CPU_RECORD_PDEBUGINST_SPEC {}
///`write(|w| ..)` method takes [`pro_cpu_record_pdebuginst::W`](W) writer structure
