///Register `AHBLITE_MPU_TABLE_PWM1` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_PWM1_SPEC>;
///Register `AHBLITE_MPU_TABLE_PWM1` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_PWM1_SPEC>;
///Field `PWM1_ACCESS_GRANT_CONFIG` reader -
pub type PWM1_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `PWM1_ACCESS_GRANT_CONFIG` writer -
...
///`read()` method returns [`ahblite_mpu_table_pwm1::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_PWM1_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_pwm1::W`](W) writer structure
