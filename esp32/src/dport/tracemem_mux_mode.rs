...
///`read()` method returns [`tracemem_mux_mode::R`](R) reader structure
impl crate::Readable for TRACEMEM_MUX_MODE_SPEC {}
///`write(|w| ..)` method takes [`tracemem_mux_mode::W`](W) writer structure
