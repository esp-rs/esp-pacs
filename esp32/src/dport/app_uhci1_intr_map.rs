...
pub struct R(crate::R<APP_UHCI1_INTR_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<APP_UHCI1_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<APP_UHCI1_INTR_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<APP_UHCI1_INTR_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `APP_UHCI1_INTR_MAP` writer"]
pub struct W(crate::W<APP_UHCI1_INTR_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<APP_UHCI1_INTR_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<APP_UHCI1_INTR_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<APP_UHCI1_INTR_MAP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type APP_UHCI1_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, APP_UHCI1_INTR_MAP_SPEC, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_UHCI1_INTR_MAP")
            .field(
                "app_uhci1_intr_map",
                &format_args!("{}", self.app_uhci1_intr_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<APP_UHCI1_INTR_MAP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_uhci1_intr_map(&mut self) -> APP_UHCI1_INTR_MAP_W<0> {
        APP_UHCI1_INTR_MAP_W::new(self)
    }
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [app_uhci1_intr_map](index.html) module"]
