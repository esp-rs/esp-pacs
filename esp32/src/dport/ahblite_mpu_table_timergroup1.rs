...
pub type TIMERGROUP1_ACCESS_GRANT_CONFIG_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    pub fn timergroup1_access_grant_config(
        &mut self,
    ) -> TIMERGROUP1_ACCESS_GRANT_CONFIG_W<AHBLITE_MPU_TABLE_TIMERGROUP1_SPEC, 0> {
