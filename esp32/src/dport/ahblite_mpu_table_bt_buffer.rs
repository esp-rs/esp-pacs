///Register `AHBLITE_MPU_TABLE_BT_BUFFER` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_BT_BUFFER_SPEC>;
///Register `AHBLITE_MPU_TABLE_BT_BUFFER` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_BT_BUFFER_SPEC>;
///Field `BTBUFFER_ACCESS_GRANT_CONFIG` reader -
pub type BTBUFFER_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `BTBUFFER_ACCESS_GRANT_CONFIG` writer -
