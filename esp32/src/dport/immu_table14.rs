...
pub type IMMU_TABLE14_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
impl R {
    #[doc = "Bits 0:6"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IMMU_TABLE14")
            .field(
                "immu_table14",
                &format_args!("{}", self.immu_table14().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn immu_table14(&mut self) -> IMMU_TABLE14_W<IMMU_TABLE14_SPEC, 0> {
