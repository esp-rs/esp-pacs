...
pub type APP_UART1_INTR_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, APP_UART1_INTR_MAP_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_uart1_intr_map(&mut self) -> APP_UART1_INTR_MAP_W<0> {
