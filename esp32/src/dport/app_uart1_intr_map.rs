...
pub type APP_UART1_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_uart1_intr_map(&mut self) -> APP_UART1_INTR_MAP_W<APP_UART1_INTR_MAP_SPEC, 0> {
