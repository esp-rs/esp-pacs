...
You can [`read`](crate::generic::Reg::read) this register and get [`app_rmt_intr_map::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`app_rmt_intr_map::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct APP_RMT_INTR_MAP_SPEC;
impl crate::RegisterSpec for APP_RMT_INTR_MAP_SPEC {
    type Ux = u32;
}
///`read()` method returns [`app_rmt_intr_map::R`](R) reader structure
impl crate::Readable for APP_RMT_INTR_MAP_SPEC {}
///`write(|w| ..)` method takes [`app_rmt_intr_map::W`](W) writer structure
impl crate::Writable for APP_RMT_INTR_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APP_RMT_INTR_MAP to value 0x10
