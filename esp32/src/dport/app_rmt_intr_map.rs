...
pub type APP_RMT_INTR_MAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_RMT_INTR_MAP")
            .field(
                "app_rmt_intr_map",
                &format_args!("{}", self.app_rmt_intr_map().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<APP_RMT_INTR_MAP_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_rmt_intr_map(&mut self) -> APP_RMT_INTR_MAP_W<APP_RMT_INTR_MAP_SPEC, 0> {
        APP_RMT_INTR_MAP_W::new(self)
    }
