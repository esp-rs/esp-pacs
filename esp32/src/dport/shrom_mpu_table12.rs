...
pub type SHROM_MPU_TABLE12_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    #[doc = "Bits 0:1"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SHROM_MPU_TABLE12")
            .field(
                "shrom_mpu_table12",
                &format_args!("{}", self.shrom_mpu_table12().bits()),
            )
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SHROM_MPU_TABLE12_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn shrom_mpu_table12(&mut self) -> SHROM_MPU_TABLE12_W<SHROM_MPU_TABLE12_SPEC, 0> {
