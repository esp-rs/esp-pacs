///Register `AHBLITE_MPU_TABLE_I2C_EXT0` reader
pub type R = crate::R<AHBLITE_MPU_TABLE_I2C_EXT0_SPEC>;
///Register `AHBLITE_MPU_TABLE_I2C_EXT0` writer
pub type W = crate::W<AHBLITE_MPU_TABLE_I2C_EXT0_SPEC>;
///Field `I2CEXT0_ACCESS_GRANT_CONFIG` reader -
pub type I2CEXT0_ACCESS_GRANT_CONFIG_R = crate::FieldReader;
///Field `I2CEXT0_ACCESS_GRANT_CONFIG` writer -
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AHBLITE_MPU_TABLE_I2C_EXT0")
            .field(
                ...
                &self.i2cext0_access_grant_config(),
            )
            .finish()
    }
}
...
///`read()` method returns [`ahblite_mpu_table_i2c_ext0::R`](R) reader structure
impl crate::Readable for AHBLITE_MPU_TABLE_I2C_EXT0_SPEC {}
///`write(|w| ..)` method takes [`ahblite_mpu_table_i2c_ext0::W`](W) writer structure
