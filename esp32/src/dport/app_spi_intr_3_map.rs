///Register `APP_SPI_INTR_3_MAP` reader
pub type R = crate::R<APP_SPI_INTR_3_MAP_SPEC>;
///Register `APP_SPI_INTR_3_MAP` writer
pub type W = crate::W<APP_SPI_INTR_3_MAP_SPEC>;
///Field `APP_SPI_INTR_3_MAP` reader -
pub type APP_SPI_INTR_3_MAP_R = crate::FieldReader;
///Field `APP_SPI_INTR_3_MAP` writer -
pub type APP_SPI_INTR_3_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
impl R {
    ///Bits 0:4
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APP_SPI_INTR_3_MAP")
            .field("app_spi_intr_3_map", &self.app_spi_intr_3_map())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_spi_intr_3_map(&mut self) -> APP_SPI_INTR_3_MAP_W<APP_SPI_INTR_3_MAP_SPEC> {
        APP_SPI_INTR_3_MAP_W::new(self, 0)
    }
}
/**
...
///`read()` method returns [`app_spi_intr_3_map::R`](R) reader structure
impl crate::Readable for APP_SPI_INTR_3_MAP_SPEC {}
///`write(|w| ..)` method takes [`app_spi_intr_3_map::W`](W) writer structure
impl crate::Writable for APP_SPI_INTR_3_MAP_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets APP_SPI_INTR_3_MAP to value 0x10
