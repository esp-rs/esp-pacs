...
pub struct R(crate::R<APP_SPI_INTR_3_MAP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<APP_SPI_INTR_3_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<APP_SPI_INTR_3_MAP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<APP_SPI_INTR_3_MAP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `APP_SPI_INTR_3_MAP` writer"]
pub struct W(crate::W<APP_SPI_INTR_3_MAP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<APP_SPI_INTR_3_MAP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<APP_SPI_INTR_3_MAP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<APP_SPI_INTR_3_MAP_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `APP_SPI_INTR_3_MAP` reader - "]
pub type APP_SPI_INTR_3_MAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `APP_SPI_INTR_3_MAP` writer - "]
pub type APP_SPI_INTR_3_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, APP_SPI_INTR_3_MAP_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn app_spi_intr_3_map(&mut self) -> APP_SPI_INTR_3_MAP_W<0> {
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [app_spi_intr_3_map](index.html) module"]
