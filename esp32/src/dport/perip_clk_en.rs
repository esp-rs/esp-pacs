...
///`read()` method returns [`perip_clk_en::R`](R) reader structure
impl crate::Readable for PERIP_CLK_EN_SPEC {}
///`write(|w| ..)` method takes [`perip_clk_en::W`](W) writer structure
impl crate::Writable for PERIP_CLK_EN_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PERIP_CLK_EN to value 0xf9c1_e06f
