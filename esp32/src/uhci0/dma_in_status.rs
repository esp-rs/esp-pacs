...
///Field `IN_FULL` reader -
pub type IN_FULL_R = crate::BitReader;
///Field `IN_EMPTY` reader -
pub type IN_EMPTY_R = crate::BitReader;
///Field `RX_ERR_CAUSE` reader - This register stores the errors caused in out link descriptor's data packet.
...
impl R {
    ...
    ///Bits 4:6 - This register stores the errors caused in out link descriptor's data packet.
    #[inline(always)]
