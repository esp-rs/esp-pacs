...
///Field `OUTLINK_DSCR_BF0` reader - The content of current out link descriptor's first dword
pub type OUTLINK_DSCR_BF0_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The content of current out link descriptor's first dword
    #[inline(always)]
