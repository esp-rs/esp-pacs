///Register `DMA_OUT_EOF_BFR_DES_ADDR` reader
pub type R = crate::R<DMA_OUT_EOF_BFR_DES_ADDR_SPEC>;
///Field `OUT_EOF_BFR_DES_ADDR` reader - This register stores the address of out link descriptor when there are some errors in this descriptor.
pub type OUT_EOF_BFR_DES_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the address of out link descriptor when there are some errors in this descriptor.
    #[inline(always)]
...
///`read()` method returns [`dma_out_eof_bfr_des_addr::R`](R) reader structure
