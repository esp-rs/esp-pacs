...
///Field `INFIFO_RDATA` reader - This register stores the data pop from in link descriptor's fifo.
pub type INFIFO_RDATA_R = crate::FieldReader<u16>;
///Field `INFIFO_POP` reader - Set this bit to pop data in in link descriptor's fifo.
pub type INFIFO_POP_R = crate::BitReader;
///Field `INFIFO_POP` writer - Set this bit to pop data in in link descriptor's fifo.
