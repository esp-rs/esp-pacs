...
///Field `IN_ERR_EOF_DES_ADDR` reader - This register stores the address of in link descriptor when there are some errors in this descriptor.
pub type IN_ERR_EOF_DES_ADDR_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - This register stores the address of in link descriptor when there are some errors in this descriptor.
    #[inline(always)]
