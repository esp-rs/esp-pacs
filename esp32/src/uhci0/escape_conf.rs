...
///Field `TX_C0_ESC_EN` reader - Set this bit to enable 0xc0 char decode when DMA receives data.
pub type TX_C0_ESC_EN_R = crate::BitReader;
///Field `TX_C0_ESC_EN` writer - Set this bit to enable 0xc0 char decode when DMA receives data.
pub type TX_C0_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_DB_ESC_EN` reader - Set this bit to enable 0xdb char decode when DMA receives data.
pub type TX_DB_ESC_EN_R = crate::BitReader;
///Field `TX_DB_ESC_EN` writer - Set this bit to enable 0xdb char decode when DMA receives data.
pub type TX_DB_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_11_ESC_EN` reader - Set this bit to enable flow control char 0x11 decode when DMA receives data.
pub type TX_11_ESC_EN_R = crate::BitReader;
///Field `TX_11_ESC_EN` writer - Set this bit to enable flow control char 0x11 decode when DMA receives data.
pub type TX_11_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_13_ESC_EN` reader - Set this bit to enable flow control char 0x13 decode when DMA receives data.
pub type TX_13_ESC_EN_R = crate::BitReader;
///Field `TX_13_ESC_EN` writer - Set this bit to enable flow control char 0x13 decode when DMA receives data.
pub type TX_13_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_C0_ESC_EN` reader - Set this bit to enable 0xc0 char replace when DMA sends data.
pub type RX_C0_ESC_EN_R = crate::BitReader;
///Field `RX_C0_ESC_EN` writer - Set this bit to enable 0xc0 char replace when DMA sends data.
pub type RX_C0_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_DB_ESC_EN` reader - Set this bit to enable 0xdb char replace when DMA sends data.
pub type RX_DB_ESC_EN_R = crate::BitReader;
///Field `RX_DB_ESC_EN` writer - Set this bit to enable 0xdb char replace when DMA sends data.
pub type RX_DB_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_11_ESC_EN` reader - Set this bit to enable flow control char 0x11 replace when DMA sends data.
pub type RX_11_ESC_EN_R = crate::BitReader;
///Field `RX_11_ESC_EN` writer - Set this bit to enable flow control char 0x11 replace when DMA sends data.
pub type RX_11_ESC_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_13_ESC_EN` reader - Set this bit to enable flow control char 0x13 replace when DMA sends data.
pub type RX_13_ESC_EN_R = crate::BitReader;
///Field `RX_13_ESC_EN` writer - Set this bit to enable flow control char 0x13 replace when DMA sends data.
