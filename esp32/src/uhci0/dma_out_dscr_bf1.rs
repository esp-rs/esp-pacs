///Register `DMA_OUT_DSCR_BF1` reader
pub type R = crate::R<DMA_OUT_DSCR_BF1_SPEC>;
///Field `OUTLINK_DSCR_BF1` reader - The content of current out link descriptor's second dword
pub type OUTLINK_DSCR_BF1_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - The content of current out link descriptor's second dword
    #[inline(always)]
...
///`read()` method returns [`dma_out_dscr_bf1::R`](R) reader structure
