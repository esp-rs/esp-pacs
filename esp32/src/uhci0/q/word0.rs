...
#[doc = "Field `SEND_WORD` reader - This register stores the content of short packet's first dword"]
pub type SEND_WORD_R = crate::FieldReader<u32>;
#[doc = "Field `SEND_WORD` writer - This register stores the content of short packet's first dword"]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("WORD0")
            .field("send_word", &format_args!("{}", self.send_word().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
