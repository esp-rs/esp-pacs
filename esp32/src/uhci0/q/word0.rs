...
///Field `SEND_WORD` reader - This register stores the content of short packet's first dword
pub type SEND_WORD_R = crate::FieldReader<u32>;
///Field `SEND_WORD` writer - This register stores the content of short packet's first dword
