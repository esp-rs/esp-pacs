...
pub type SEND_S_Q_INT_ENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_ENA_SPEC, bool, O>;
#[doc = "Field `SEND_A_Q_INT_ENA` reader - "]
pub type SEND_A_Q_INT_ENA_R = crate::BitReader<bool>;
#[doc = "Field `SEND_A_Q_INT_ENA` writer - "]
pub type SEND_A_Q_INT_ENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_ENA_SPEC, bool, O>;
...
pub type DMA_INFIFO_FULL_WM_INT_ENA_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INT_ENA_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn send_s_q_int_ena(&mut self) -> SEND_S_Q_INT_ENA_W<14> {
        SEND_S_Q_INT_ENA_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn send_a_q_int_ena(&mut self) -> SEND_A_Q_INT_ENA_W<15> {
