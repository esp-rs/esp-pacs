...
///Field `OUTLINK_ADDR` reader - This register stores the least 20 bits of the first out link descriptor's address.
pub type OUTLINK_ADDR_R = crate::FieldReader<u32>;
///Field `OUTLINK_ADDR` writer - This register stores the least 20 bits of the first out link descriptor's address.
pub type OUTLINK_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
///Field `OUTLINK_STOP` reader - Set this bit to stop dealing with the out link descriptors.
pub type OUTLINK_STOP_R = crate::BitReader;
///Field `OUTLINK_STOP` writer - Set this bit to stop dealing with the out link descriptors.
pub type OUTLINK_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTLINK_START` reader - Set this bit to start dealing with the out link descriptors.
pub type OUTLINK_START_R = crate::BitReader;
///Field `OUTLINK_START` writer - Set this bit to start dealing with the out link descriptors.
pub type OUTLINK_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTLINK_RESTART` reader - Set this bit to mount on new out link descriptors
pub type OUTLINK_RESTART_R = crate::BitReader;
///Field `OUTLINK_RESTART` writer - Set this bit to mount on new out link descriptors
pub type OUTLINK_RESTART_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `OUTLINK_PARK` reader - 1£º the out link descriptor's fsm is in idle state. 0:the out link descriptor's fsm is working.
