...
#[doc = "Field `OUTLINK_ADDR` reader - This register stores the least 20 bits of the first out link descriptor's address."]
...
impl R {
    ...
    #[doc = "Bit 31 - 1£º the out link descriptor's fsm is in idle state. 0:the out link descriptor's fsm is working."]
    #[inline(always)]
