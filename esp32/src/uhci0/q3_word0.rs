...
pub struct R(crate::R<Q3_WORD0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<Q3_WORD0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<Q3_WORD0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<Q3_WORD0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Q3_WORD0` writer"]
pub struct W(crate::W<Q3_WORD0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<Q3_WORD0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<Q3_WORD0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<Q3_WORD0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SEND_Q3_WORD0` reader - This register stores the content of short packet's first dword"]
pub type SEND_Q3_WORD0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SEND_Q3_WORD0` writer - This register stores the content of short packet's first dword"]
pub type SEND_Q3_WORD0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, Q3_WORD0_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn send_q3_word0(&mut self) -> SEND_Q3_WORD0_W<0> {
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [q3_word0](index.html) module"]
