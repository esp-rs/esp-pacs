...
pub type R = crate::R<Q4_WORD1_SPEC>;
#[doc = "Register `Q4_WORD1` writer"]
pub type W = crate::W<Q4_WORD1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn send_q4_word1(&mut self) -> SEND_Q4_WORD1_W<Q4_WORD1_SPEC, 0> {
...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`q4_word1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`q4_word1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
