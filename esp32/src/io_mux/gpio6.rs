///Register `GPIO6` reader
pub type R = crate::R<GPIO6_SPEC>;
///Register `GPIO6` writer
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mcu_drv(&mut self) -> MCU_DRV_W<GPIO6_SPEC> {
...
///`read()` method returns [`gpio6::R`](R) reader structure
impl crate::Readable for GPIO6_SPEC {}
///`write(|w| ..)` method takes [`gpio6::W`](W) writer structure
impl crate::Writable for GPIO6_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO6 to value 0
