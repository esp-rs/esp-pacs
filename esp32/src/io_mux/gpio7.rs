///Register `GPIO7` reader
pub type R = crate::R<GPIO7_SPEC>;
///Register `GPIO7` writer
...
///`read()` method returns [`gpio7::R`](R) reader structure
impl crate::Readable for GPIO7_SPEC {}
///`write(|w| ..)` method takes [`gpio7::W`](W) writer structure
impl crate::Writable for GPIO7_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO7 to value 0
