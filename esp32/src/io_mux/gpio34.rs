///Register `GPIO34` reader
pub type R = crate::R<GPIO34_SPEC>;
///Register `GPIO34` writer
...
///`read()` method returns [`gpio34::R`](R) reader structure
impl crate::Readable for GPIO34_SPEC {}
///`write(|w| ..)` method takes [`gpio34::W`](W) writer structure
impl crate::Writable for GPIO34_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO34 to value 0
