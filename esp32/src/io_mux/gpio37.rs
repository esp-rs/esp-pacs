///Register `GPIO37` reader
pub type R = crate::R<GPIO37_SPEC>;
///Register `GPIO37` writer
...
///`read()` method returns [`gpio37::R`](R) reader structure
impl crate::Readable for GPIO37_SPEC {}
///`write(|w| ..)` method takes [`gpio37::W`](W) writer structure
impl crate::Writable for GPIO37_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO37 to value 0
