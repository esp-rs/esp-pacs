///Register `GPIO19` reader
pub type R = crate::R<GPIO19_SPEC>;
///Register `GPIO19` writer
...
///`read()` method returns [`gpio19::R`](R) reader structure
impl crate::Readable for GPIO19_SPEC {}
///`write(|w| ..)` method takes [`gpio19::W`](W) writer structure
impl crate::Writable for GPIO19_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO19 to value 0
