...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mcu_drv(&mut self) -> MCU_DRV_W<GPIO2_SPEC> {
...
///`read()` method returns [`gpio2::R`](R) reader structure
impl crate::Readable for GPIO2_SPEC {}
///`write(|w| ..)` method takes [`gpio2::W`](W) writer structure
impl crate::Writable for GPIO2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO2 to value 0
