///Register `GPIO0` reader
pub type R = crate::R<GPIO0_SPEC>;
///Register `GPIO0` writer
...
///`read()` method returns [`gpio0::R`](R) reader structure
impl crate::Readable for GPIO0_SPEC {}
///`write(|w| ..)` method takes [`gpio0::W`](W) writer structure
impl crate::Writable for GPIO0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets GPIO0 to value 0
