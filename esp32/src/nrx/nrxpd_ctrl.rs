...
///Field `CHAN_EST_FORCE_PU` writer -
...
///`read()` method returns [`nrxpd_ctrl::R`](R) reader structure
impl crate::Readable for NRXPD_CTRL_SPEC {}
///`write(|w| ..)` method takes [`nrxpd_ctrl::W`](W) writer structure
