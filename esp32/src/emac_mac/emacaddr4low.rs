///Register `EMACADDR4LOW` reader
pub type R = crate::R<EMACADDR4LOW_SPEC>;
///Register `EMACADDR4LOW` writer
...
///`read()` method returns [`emacaddr4low::R`](R) reader structure
impl crate::Readable for EMACADDR4LOW_SPEC {}
///`write(|w| ..)` method takes [`emacaddr4low::W`](W) writer structure
impl crate::Writable for EMACADDR4LOW_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR4LOW to value 0
