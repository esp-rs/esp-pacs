///Register `EMACADDR2LOW` reader
pub type R = crate::R<EMACADDR2LOW_SPEC>;
///Register `EMACADDR2LOW` writer
...
///`read()` method returns [`emacaddr2low::R`](R) reader structure
impl crate::Readable for EMACADDR2LOW_SPEC {}
///`write(|w| ..)` method takes [`emacaddr2low::W`](W) writer structure
impl crate::Writable for EMACADDR2LOW_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR2LOW to value 0
