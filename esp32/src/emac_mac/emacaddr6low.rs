///Register `EMACADDR6LOW` reader
pub type R = crate::R<EMACADDR6LOW_SPEC>;
///Register `EMACADDR6LOW` writer
...
///`read()` method returns [`emacaddr6low::R`](R) reader structure
impl crate::Readable for EMACADDR6LOW_SPEC {}
///`write(|w| ..)` method takes [`emacaddr6low::W`](W) writer structure
impl crate::Writable for EMACADDR6LOW_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR6LOW to value 0
