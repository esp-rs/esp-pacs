///Register `EMACGMIIADDR` reader
pub type R = crate::R<EMACGMIIADDR_SPEC>;
///Register `EMACGMIIADDR` writer
...
///Field `MIIWRITE` reader - When set this bit indicates to the PHY that this is a Write operation using the MII Data register. If this bit is not set it indicates that this is a Read operation that is placing the data in the MII Data register.
pub type MIIWRITE_R = crate::BitReader;
///Field `MIIWRITE` writer - When set this bit indicates to the PHY that this is a Write operation using the MII Data register. If this bit is not set it indicates that this is a Read operation that is placing the data in the MII Data register.
pub type MIIWRITE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MIICSRCLK` reader - CSR clock range: 1.0 MHz ~ 2.5 MHz. 4'b0000: When the APB clock frequency is 80 MHz the MDC clock frequency is APB CLK/42 4'b0011: When the APB clock frequency is 40 MHz the MDC clock frequency is APB CLK/26.
pub type MIICSRCLK_R = crate::FieldReader;
///Field `MIICSRCLK` writer - CSR clock range: 1.0 MHz ~ 2.5 MHz. 4'b0000: When the APB clock frequency is 80 MHz the MDC clock frequency is APB CLK/42 4'b0011: When the APB clock frequency is 40 MHz the MDC clock frequency is APB CLK/26.
pub type MIICSRCLK_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
///Field `MIIREG` reader - These bits select the desired MII register in the selected PHY device.
pub type MIIREG_R = crate::FieldReader;
///Field `MIIREG` writer - These bits select the desired MII register in the selected PHY device.
pub type MIIREG_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `MIIDEV` reader - This field indicates which of the 32 possible PHY devices are being accessed.
pub type MIIDEV_R = crate::FieldReader;
///Field `MIIDEV` writer - This field indicates which of the 32 possible PHY devices are being accessed.
...
impl R {
    ...
    ///Bit 1 - When set this bit indicates to the PHY that this is a Write operation using the MII Data register. If this bit is not set it indicates that this is a Read operation that is placing the data in the MII Data register.
    #[inline(always)]
    pub fn miiwrite(&self) -> MIIWRITE_R {
        MIIWRITE_R::new(((self.bits >> 1) & 1) != 0)
    }
    ///Bits 2:5 - CSR clock range: 1.0 MHz ~ 2.5 MHz. 4'b0000: When the APB clock frequency is 80 MHz the MDC clock frequency is APB CLK/42 4'b0011: When the APB clock frequency is 40 MHz the MDC clock frequency is APB CLK/26.
    #[inline(always)]
    pub fn miicsrclk(&self) -> MIICSRCLK_R {
        MIICSRCLK_R::new(((self.bits >> 2) & 0x0f) as u8)
    }
    ///Bits 6:10 - These bits select the desired MII register in the selected PHY device.
    #[inline(always)]
    pub fn miireg(&self) -> MIIREG_R {
        MIIREG_R::new(((self.bits >> 6) & 0x1f) as u8)
    }
    ///Bits 11:15 - This field indicates which of the 32 possible PHY devices are being accessed.
    #[inline(always)]
...
///`read()` method returns [`emacgmiiaddr::R`](R) reader structure
impl crate::Readable for EMACGMIIADDR_SPEC {}
///`write(|w| ..)` method takes [`emacgmiiaddr::W`](W) writer structure
impl crate::Writable for EMACGMIIADDR_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACGMIIADDR to value 0
