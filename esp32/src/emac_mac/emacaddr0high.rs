///Register `EMACADDR0HIGH` reader
pub type R = crate::R<EMACADDR0HIGH_SPEC>;
///Register `EMACADDR0HIGH` writer
pub type W = crate::W<EMACADDR0HIGH_SPEC>;
///Field `ADDRESS0_HI` reader - This field contains the upper 16 bits (47:32) of the first 6-byte MAC address.The MAC uses this field for filtering the received frames and inserting the MAC address in the Transmit Flow Control (Pause) Frames.
pub type ADDRESS0_HI_R = crate::FieldReader<u16>;
///Field `ADDRESS0_HI` writer - This field contains the upper 16 bits (47:32) of the first 6-byte MAC address.The MAC uses this field for filtering the received frames and inserting the MAC address in the Transmit Flow Control (Pause) Frames.
...
impl R {
    ///Bits 0:15 - This field contains the upper 16 bits (47:32) of the first 6-byte MAC address.The MAC uses this field for filtering the received frames and inserting the MAC address in the Transmit Flow Control (Pause) Frames.
    #[inline(always)]
...
///`read()` method returns [`emacaddr0high::R`](R) reader structure
impl crate::Readable for EMACADDR0HIGH_SPEC {}
///`write(|w| ..)` method takes [`emacaddr0high::W`](W) writer structure
impl crate::Writable for EMACADDR0HIGH_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR0HIGH to value 0
