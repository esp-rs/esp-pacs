///Register `EMACADDR0LOW` reader
pub type R = crate::R<EMACADDR0LOW_SPEC>;
///Register `EMACADDR0LOW` writer
...
///`read()` method returns [`emacaddr0low::R`](R) reader structure
impl crate::Readable for EMACADDR0LOW_SPEC {}
///`write(|w| ..)` method takes [`emacaddr0low::W`](W) writer structure
impl crate::Writable for EMACADDR0LOW_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR0LOW to value 0
