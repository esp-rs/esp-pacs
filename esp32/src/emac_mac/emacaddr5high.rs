///Register `EMACADDR5HIGH` reader
pub type R = crate::R<EMACADDR5HIGH_SPEC>;
///Register `EMACADDR5HIGH` writer
pub type W = crate::W<EMACADDR5HIGH_SPEC>;
///Field `MAC_ADDRESS5_HI` reader - This field contains the upper 16 bits Bits\[47:32\] of the sixth 6-byte MAC address.
pub type MAC_ADDRESS5_HI_R = crate::FieldReader<u16>;
///Field `MAC_ADDRESS5_HI` writer - This field contains the upper 16 bits Bits\[47:32\] of the sixth 6-byte MAC address.
pub type MAC_ADDRESS5_HI_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `MASK_BYTE_CONTROL5` reader - These bits are mask control bits for comparison of each of the EMACADDR5 bytes. When set high the MAC does not compare the corresponding byte of received DA or SA with the contents of EMACADDR5 registers. Each bit controls the masking of the bytes as follows: Bit\[29\]: EMACADDR5 High \[15:8\]. Bit\[28\]: EMACADDR5 High \[7:0\]. Bit\[27\]: EMACADDR5 Low \[31:24\]. Bit\[24\]: EMACADDR5 Low \[7:0\].You can filter a group of addresses (known as group address filtering) by masking one or more bytes of the address.
pub type MASK_BYTE_CONTROL5_R = crate::FieldReader;
///Field `MASK_BYTE_CONTROL5` writer - These bits are mask control bits for comparison of each of the EMACADDR5 bytes. When set high the MAC does not compare the corresponding byte of received DA or SA with the contents of EMACADDR5 registers. Each bit controls the masking of the bytes as follows: Bit\[29\]: EMACADDR5 High \[15:8\]. Bit\[28\]: EMACADDR5 High \[7:0\]. Bit\[27\]: EMACADDR5 Low \[31:24\]. Bit\[24\]: EMACADDR5 Low \[7:0\].You can filter a group of addresses (known as group address filtering) by masking one or more bytes of the address.
pub type MASK_BYTE_CONTROL5_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `SOURCE_ADDRESS5` reader - When this bit is set the EMACADDR5\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR5\[47:0\] is used to compare with the DA fields of the received frame.
pub type SOURCE_ADDRESS5_R = crate::BitReader;
///Field `SOURCE_ADDRESS5` writer - When this bit is set the EMACADDR5\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR5\[47:0\] is used to compare with the DA fields of the received frame.
pub type SOURCE_ADDRESS5_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADDRESS_ENABLE5` reader - When this bit is set the address filter module uses the sixth MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
pub type ADDRESS_ENABLE5_R = crate::BitReader;
///Field `ADDRESS_ENABLE5` writer - When this bit is set the address filter module uses the sixth MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
pub type ADDRESS_ENABLE5_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:15 - This field contains the upper 16 bits Bits\[47:32\] of the sixth 6-byte MAC address.
    #[inline(always)]
    ...
    ///Bit 30 - When this bit is set the EMACADDR5\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR5\[47:0\] is used to compare with the DA fields of the received frame.
    #[inline(always)]
    pub fn source_address5(&self) -> SOURCE_ADDRESS5_R {
        SOURCE_ADDRESS5_R::new(((self.bits >> 30) & 1) != 0)
    }
    ///Bit 31 - When this bit is set the address filter module uses the sixth MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
    #[inline(always)]
...
///`read()` method returns [`emacaddr5high::R`](R) reader structure
impl crate::Readable for EMACADDR5HIGH_SPEC {}
///`write(|w| ..)` method takes [`emacaddr5high::W`](W) writer structure
impl crate::Writable for EMACADDR5HIGH_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR5HIGH to value 0
