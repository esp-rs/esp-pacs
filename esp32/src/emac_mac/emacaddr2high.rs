...
///Register `EMACADDR2HIGH` writer
pub type W = crate::W<EMACADDR2HIGH_SPEC>;
///Field `MAC_ADDRESS2_HI` reader - This field contains the upper 16 bits Bits\[47:32\] of the third 6-byte MAC address.
pub type MAC_ADDRESS2_HI_R = crate::FieldReader<u16>;
///Field `MAC_ADDRESS2_HI` writer - This field contains the upper 16 bits Bits\[47:32\] of the third 6-byte MAC address.
pub type MAC_ADDRESS2_HI_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `MASK_BYTE_CONTROL2` reader - These bits are mask control bits for comparison of each of the EMACADDR2 bytes. When set high the MAC does not compare the corresponding byte of received DA or SA with the contents of EMACADDR2 registers. Each bit controls the masking of the bytes as follows: Bit\[29\]: EMACADDR2 High \[15:8\]. Bit\[28\]: EMACADDR2 High \[7:0\]. Bit\[27\]: EMACADDR2 Low \[31:24\]. Bit\[24\]: EMACADDR2 Low \[7:0\].You can filter a group of addresses (known as group address filtering) by masking one or more bytes of the address.
pub type MASK_BYTE_CONTROL2_R = crate::FieldReader;
///Field `MASK_BYTE_CONTROL2` writer - These bits are mask control bits for comparison of each of the EMACADDR2 bytes. When set high the MAC does not compare the corresponding byte of received DA or SA with the contents of EMACADDR2 registers. Each bit controls the masking of the bytes as follows: Bit\[29\]: EMACADDR2 High \[15:8\]. Bit\[28\]: EMACADDR2 High \[7:0\]. Bit\[27\]: EMACADDR2 Low \[31:24\]. Bit\[24\]: EMACADDR2 Low \[7:0\].You can filter a group of addresses (known as group address filtering) by masking one or more bytes of the address.
pub type MASK_BYTE_CONTROL2_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `SOURCE_ADDRESS2` reader - When this bit is set the EMACADDR2\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR2\[47:0\] is used to compare with the DA fields of the received frame.
pub type SOURCE_ADDRESS2_R = crate::BitReader;
///Field `SOURCE_ADDRESS2` writer - When this bit is set the EMACADDR2\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR2\[47:0\] is used to compare with the DA fields of the received frame.
pub type SOURCE_ADDRESS2_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADDRESS_ENABLE2` reader - When this bit is set the address filter module uses the third MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
pub type ADDRESS_ENABLE2_R = crate::BitReader;
///Field `ADDRESS_ENABLE2` writer - When this bit is set the address filter module uses the third MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
pub type ADDRESS_ENABLE2_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EMACADDR2HIGH")
            .field("mac_address2_hi", &self.mac_address2_hi())
            .field("mask_byte_control2", &self.mask_byte_control2())
            .field("source_address2", &self.source_address2())
            .field("address_enable2", &self.address_enable2())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mac_address2_hi(&mut self) -> MAC_ADDRESS2_HI_W<EMACADDR2HIGH_SPEC> {
        MAC_ADDRESS2_HI_W::new(self, 0)
    }
    ///Bits 24:29 - These bits are mask control bits for comparison of each of the EMACADDR2 bytes. When set high the MAC does not compare the corresponding byte of received DA or SA with the contents of EMACADDR2 registers. Each bit controls the masking of the bytes as follows: Bit\[29\]: EMACADDR2 High \[15:8\]. Bit\[28\]: EMACADDR2 High \[7:0\]. Bit\[27\]: EMACADDR2 Low \[31:24\]. Bit\[24\]: EMACADDR2 Low \[7:0\].You can filter a group of addresses (known as group address filtering) by masking one or more bytes of the address.
    #[inline(always)]
    #[must_use]
    pub fn mask_byte_control2(&mut self) -> MASK_BYTE_CONTROL2_W<EMACADDR2HIGH_SPEC> {
        MASK_BYTE_CONTROL2_W::new(self, 24)
    }
    ///Bit 30 - When this bit is set the EMACADDR2\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR2\[47:0\] is used to compare with the DA fields of the received frame.
    #[inline(always)]
    #[must_use]
    pub fn source_address2(&mut self) -> SOURCE_ADDRESS2_W<EMACADDR2HIGH_SPEC> {
        SOURCE_ADDRESS2_W::new(self, 30)
    }
    ///Bit 31 - When this bit is set the address filter module uses the third MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
    #[inline(always)]
    #[must_use]
    pub fn address_enable2(&mut self) -> ADDRESS_ENABLE2_W<EMACADDR2HIGH_SPEC> {
        ADDRESS_ENABLE2_W::new(self, 31)
    }
}
...
///`read()` method returns [`emacaddr2high::R`](R) reader structure
impl crate::Readable for EMACADDR2HIGH_SPEC {}
///`write(|w| ..)` method takes [`emacaddr2high::W`](W) writer structure
impl crate::Writable for EMACADDR2HIGH_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR2HIGH to value 0
