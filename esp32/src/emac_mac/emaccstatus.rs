...
impl R {
    ///Bit 0 - This bit indicates the current mode of operation of the link: 1'b0: Half-duplex mode. 1'b1: Full-duplex mode.
    #[inline(always)]
    pub fn link_mode(&self) -> LINK_MODE_R {
        LINK_MODE_R::new((self.bits & 1) != 0)
    }
    ///Bits 1:2 - This bit indicates the current speed of the link: 2'b00: 2.5 MHz. 2'b01: 25 MHz. 2'b10: 125 MHz.
    #[inline(always)]
    pub fn link_speed(&self) -> LINK_SPEED_R {
        LINK_SPEED_R::new(((self.bits >> 1) & 3) as u8)
    }
    ///Bit 4 - This bit indicates whether there is jabber timeout error (1'b1) in the received Frame.
    #[inline(always)]
...
///`read()` method returns [`emaccstatus::R`](R) reader structure
impl crate::Readable for EMACCSTATUS_SPEC {}
///`reset()` method sets EMACCSTATUS to value 0
