///Register `EMACADDR5LOW` reader
pub type R = crate::R<EMACADDR5LOW_SPEC>;
///Register `EMACADDR5LOW` writer
...
///`read()` method returns [`emacaddr5low::R`](R) reader structure
impl crate::Readable for EMACADDR5LOW_SPEC {}
///`write(|w| ..)` method takes [`emacaddr5low::W`](W) writer structure
impl crate::Writable for EMACADDR5LOW_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR5LOW to value 0
