...
///Field `SOURCE_ADDRESS6` reader - When this bit is set the EMACADDR6\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR6\[47:0\] is used to compare with the DA fields of the received frame.
pub type SOURCE_ADDRESS6_R = crate::BitReader;
///Field `SOURCE_ADDRESS6` writer - When this bit is set the EMACADDR6\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR6\[47:0\] is used to compare with the DA fields of the received frame.
pub type SOURCE_ADDRESS6_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADDRESS_ENABLE6` reader - When this bit is set the address filter module uses the seventh MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
pub type ADDRESS_ENABLE6_R = crate::BitReader;
///Field `ADDRESS_ENABLE6` writer - When this bit is set the address filter module uses the seventh MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
pub type ADDRESS_ENABLE6_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:15 - This field contains the upper 16 bits Bits\[47:32\] of the seventh 6-byte MAC Address.
    #[inline(always)]
    ...
    ///Bit 30 - When this bit is set the EMACADDR6\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR6\[47:0\] is used to compare with the DA fields of the received frame.
    #[inline(always)]
    pub fn source_address6(&self) -> SOURCE_ADDRESS6_R {
        SOURCE_ADDRESS6_R::new(((self.bits >> 30) & 1) != 0)
    }
    ///Bit 31 - When this bit is set the address filter module uses the seventh MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
    #[inline(always)]
...
You can [`read`](crate::generic::Reg::read) this register and get [`emacaddr6high::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`emacaddr6high::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct EMACADDR6HIGH_SPEC;
impl crate::RegisterSpec for EMACADDR6HIGH_SPEC {
    type Ux = u32;
}
///`read()` method returns [`emacaddr6high::R`](R) reader structure
impl crate::Readable for EMACADDR6HIGH_SPEC {}
///`write(|w| ..)` method takes [`emacaddr6high::W`](W) writer structure
impl crate::Writable for EMACADDR6HIGH_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR6HIGH to value 0
