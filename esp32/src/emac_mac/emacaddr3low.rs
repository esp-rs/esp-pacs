///Register `EMACADDR3LOW` reader
pub type R = crate::R<EMACADDR3LOW_SPEC>;
///Register `EMACADDR3LOW` writer
...
///`read()` method returns [`emacaddr3low::R`](R) reader structure
impl crate::Readable for EMACADDR3LOW_SPEC {}
///`write(|w| ..)` method takes [`emacaddr3low::W`](W) writer structure
impl crate::Writable for EMACADDR3LOW_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR3LOW to value 0
