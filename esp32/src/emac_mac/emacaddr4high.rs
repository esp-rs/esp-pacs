///Register `EMACADDR4HIGH` reader
pub type R = crate::R<EMACADDR4HIGH_SPEC>;
///Register `EMACADDR4HIGH` writer
pub type W = crate::W<EMACADDR4HIGH_SPEC>;
///Field `MAC_ADDRESS4_HI` reader - This field contains the upper 16 bits Bits\[47:32\] of the fifth 6-byte MAC address.
pub type MAC_ADDRESS4_HI_R = crate::FieldReader<u16>;
///Field `MAC_ADDRESS4_HI` writer - This field contains the upper 16 bits Bits\[47:32\] of the fifth 6-byte MAC address.
pub type MAC_ADDRESS4_HI_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
///Field `MASK_BYTE_CONTROL4` reader - These bits are mask control bits for comparison of each of the EMACADDR4 bytes. When set high the MAC does not compare the corresponding byte of received DA or SA with the contents of EMACADDR4 registers. Each bit controls the masking of the bytes as follows: Bit\[29\]: EMACADDR4 High \[15:8\]. Bit\[28\]: EMACADDR4 High \[7:0\]. Bit\[27\]: EMACADDR4 Low \[31:24\]. Bit\[24\]: EMACADDR4 Low \[7:0\].You can filter a group of addresses (known as group address filtering) by masking one or more bytes of the address.
pub type MASK_BYTE_CONTROL4_R = crate::FieldReader;
///Field `MASK_BYTE_CONTROL4` writer - These bits are mask control bits for comparison of each of the EMACADDR4 bytes. When set high the MAC does not compare the corresponding byte of received DA or SA with the contents of EMACADDR4 registers. Each bit controls the masking of the bytes as follows: Bit\[29\]: EMACADDR4 High \[15:8\]. Bit\[28\]: EMACADDR4 High \[7:0\]. Bit\[27\]: EMACADDR4 Low \[31:24\]. Bit\[24\]: EMACADDR4 Low \[7:0\].You can filter a group of addresses (known as group address filtering) by masking one or more bytes of the address.
pub type MASK_BYTE_CONTROL4_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
///Field `SOURCE_ADDRESS4` reader - When this bit is set the EMACADDR4\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR4\[47:0\] is used to compare with the DA fields of the received frame.
pub type SOURCE_ADDRESS4_R = crate::BitReader;
///Field `SOURCE_ADDRESS4` writer - When this bit is set the EMACADDR4\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR4\[47:0\] is used to compare with the DA fields of the received frame.
pub type SOURCE_ADDRESS4_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ADDRESS_ENABLE4` reader - When this bit is set the address filter module uses the fifth MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
pub type ADDRESS_ENABLE4_R = crate::BitReader;
///Field `ADDRESS_ENABLE4` writer - When this bit is set the address filter module uses the fifth MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
pub type ADDRESS_ENABLE4_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ///Bits 0:15 - This field contains the upper 16 bits Bits\[47:32\] of the fifth 6-byte MAC address.
    #[inline(always)]
    ...
    ///Bit 30 - When this bit is set the EMACADDR4\[47:0\] is used to compare with the SA fields of the received frame. When this bit is reset the EMACADDR4\[47:0\] is used to compare with the DA fields of the received frame.
    #[inline(always)]
    pub fn source_address4(&self) -> SOURCE_ADDRESS4_R {
        SOURCE_ADDRESS4_R::new(((self.bits >> 30) & 1) != 0)
    }
    ///Bit 31 - When this bit is set the address filter module uses the fifth MAC address for perfect filtering. When this bit is reset the address filter module ignores the address for filtering.
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EMACADDR4HIGH")
            .field("mac_address4_hi", &self.mac_address4_hi())
            .field("mask_byte_control4", &self.mask_byte_control4())
            .field("source_address4", &self.source_address4())
            .field("address_enable4", &self.address_enable4())
            .finish()
    }
}
impl W {
...
///`read()` method returns [`emacaddr4high::R`](R) reader structure
impl crate::Readable for EMACADDR4HIGH_SPEC {}
///`write(|w| ..)` method takes [`emacaddr4high::W`](W) writer structure
impl crate::Writable for EMACADDR4HIGH_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EMACADDR4HIGH to value 0
