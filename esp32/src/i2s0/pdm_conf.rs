...
///`read()` method returns [`pdm_conf::R`](R) reader structure
impl crate::Readable for PDM_CONF_SPEC {}
///`write(|w| ..)` method takes [`pdm_conf::W`](W) writer structure
impl crate::Writable for PDM_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PDM_CONF to value 0x0155_0020
