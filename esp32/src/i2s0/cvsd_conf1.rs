...
impl W {
    #[doc = "Bits 0:15"]
    #[inline(always)]
    pub fn cvsd_sigma_max(&mut self) -> CVSD_SIGMA_MAX_W<'_, CVSD_CONF1_SPEC> {
        CVSD_SIGMA_MAX_W::new(self, 0)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    pub fn cvsd_sigma_min(&mut self) -> CVSD_SIGMA_MIN_W<'_, CVSD_CONF1_SPEC> {
        CVSD_SIGMA_MIN_W::new(self, 16)
    }
}
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`cvsd_conf1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cvsd_conf1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
