...
///`read()` method returns [`plc_conf0::R`](R) reader structure
impl crate::Readable for PLC_CONF0_SPEC {}
///`write(|w| ..)` method takes [`plc_conf0::W`](W) writer structure
impl crate::Writable for PLC_CONF0_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PLC_CONF0 to value 0x08a8_0339
