...
///Field `OUT_RST` reader -
pub type OUT_RST_R = crate::BitReader;
///Field `OUT_RST` writer -
...
///`read()` method returns [`lc_conf::R`](R) reader structure
impl crate::Readable for LC_CONF_SPEC {}
///`write(|w| ..)` method takes [`lc_conf::W`](W) writer structure
impl crate::Writable for LC_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets LC_CONF to value 0x0100
