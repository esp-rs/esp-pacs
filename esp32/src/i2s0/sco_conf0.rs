...
///`read()` method returns [`sco_conf0::R`](R) reader structure
impl crate::Readable for SCO_CONF0_SPEC {}
///`write(|w| ..)` method takes [`sco_conf0::W`](W) writer structure
