...
pub type I2SDATE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `I2SDATE` writer - "]
pub type I2SDATE_W<'a, const O: u8> = crate::FieldWriter<'a, DATE_SPEC, 32, O, u32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DATE")
            .field("i2sdate", &format_args!("{}", self.i2sdate().bits()))
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2sdate(&mut self) -> I2SDATE_W<0> {
        I2SDATE_W::new(self)
    }
...
impl crate::Resettable for DATE_SPEC {
    const RESET_VALUE: Self::Ux = 0x0160_4201;
}
