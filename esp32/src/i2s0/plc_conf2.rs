...
///`read()` method returns [`plc_conf2::R`](R) reader structure
impl crate::Readable for PLC_CONF2_SPEC {}
///`write(|w| ..)` method takes [`plc_conf2::W`](W) writer structure
impl crate::Writable for PLC_CONF2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PLC_CONF2 to value 0x28
