///Register `CVSD_CONF2` reader
pub type R = crate::R<CVSD_CONF2_SPEC>;
///Register `CVSD_CONF2` writer
...
///Field `CVSD_BETA` reader -
pub type CVSD_BETA_R = crate::FieldReader<u16>;
///Field `CVSD_BETA` writer -
...
///`read()` method returns [`cvsd_conf2::R`](R) reader structure
impl crate::Readable for CVSD_CONF2_SPEC {}
///`write(|w| ..)` method takes [`cvsd_conf2::W`](W) writer structure
impl crate::Writable for CVSD_CONF2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets CVSD_CONF2 to value 0x0005_02a4
