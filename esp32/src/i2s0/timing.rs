...
impl W {
    #[doc = "Bits 0:1"]
    #[inline(always)]
    pub fn tx_bck_in_delay(&mut self) -> TX_BCK_IN_DELAY_W<'_, TIMING_SPEC> {
        TX_BCK_IN_DELAY_W::new(self, 0)
    }
    #[doc = "Bits 2:3"]
    #[inline(always)]
    pub fn tx_ws_in_delay(&mut self) -> TX_WS_IN_DELAY_W<'_, TIMING_SPEC> {
        TX_WS_IN_DELAY_W::new(self, 2)
    }
    #[doc = "Bits 4:5"]
    #[inline(always)]
    pub fn rx_bck_in_delay(&mut self) -> RX_BCK_IN_DELAY_W<'_, TIMING_SPEC> {
        RX_BCK_IN_DELAY_W::new(self, 4)
    }
    #[doc = "Bits 6:7"]
    #[inline(always)]
    pub fn rx_ws_in_delay(&mut self) -> RX_WS_IN_DELAY_W<'_, TIMING_SPEC> {
        RX_WS_IN_DELAY_W::new(self, 6)
    }
    #[doc = "Bits 8:9"]
    #[inline(always)]
    pub fn rx_sd_in_delay(&mut self) -> RX_SD_IN_DELAY_W<'_, TIMING_SPEC> {
        RX_SD_IN_DELAY_W::new(self, 8)
    }
    #[doc = "Bits 10:11"]
    #[inline(always)]
    pub fn tx_bck_out_delay(&mut self) -> TX_BCK_OUT_DELAY_W<'_, TIMING_SPEC> {
        TX_BCK_OUT_DELAY_W::new(self, 10)
    }
    #[doc = "Bits 12:13"]
    #[inline(always)]
    pub fn tx_ws_out_delay(&mut self) -> TX_WS_OUT_DELAY_W<'_, TIMING_SPEC> {
        TX_WS_OUT_DELAY_W::new(self, 12)
    }
    #[doc = "Bits 14:15"]
    #[inline(always)]
    pub fn tx_sd_out_delay(&mut self) -> TX_SD_OUT_DELAY_W<'_, TIMING_SPEC> {
        TX_SD_OUT_DELAY_W::new(self, 14)
    }
    #[doc = "Bits 16:17"]
    #[inline(always)]
    pub fn rx_ws_out_delay(&mut self) -> RX_WS_OUT_DELAY_W<'_, TIMING_SPEC> {
        RX_WS_OUT_DELAY_W::new(self, 16)
    }
    #[doc = "Bits 18:19"]
    #[inline(always)]
    pub fn rx_bck_out_delay(&mut self) -> RX_BCK_OUT_DELAY_W<'_, TIMING_SPEC> {
        RX_BCK_OUT_DELAY_W::new(self, 18)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn tx_dsync_sw(&mut self) -> TX_DSYNC_SW_W<'_, TIMING_SPEC> {
        TX_DSYNC_SW_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn rx_dsync_sw(&mut self) -> RX_DSYNC_SW_W<'_, TIMING_SPEC> {
        RX_DSYNC_SW_W::new(self, 21)
    }
    #[doc = "Bits 22:23"]
    #[inline(always)]
    pub fn data_enable_delay(&mut self) -> DATA_ENABLE_DELAY_W<'_, TIMING_SPEC> {
        DATA_ENABLE_DELAY_W::new(self, 22)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn tx_bck_in_inv(&mut self) -> TX_BCK_IN_INV_W<'_, TIMING_SPEC> {
