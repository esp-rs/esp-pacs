...
///`read()` method returns [`plc_conf1::R`](R) reader structure
impl crate::Readable for PLC_CONF1_SPEC {}
///`write(|w| ..)` method takes [`plc_conf1::W`](W) writer structure
impl crate::Writable for PLC_CONF1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PLC_CONF1 to value 0xa017_8a05
