...
///`read()` method returns [`pd_conf::R`](R) reader structure
impl crate::Readable for PD_CONF_SPEC {}
///`write(|w| ..)` method takes [`pd_conf::W`](W) writer structure
impl crate::Writable for PD_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PD_CONF to value 0x0a
