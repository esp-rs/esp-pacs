...
/**CFG_DATA0 (rw) register accessor:
...
///
pub mod cfg_data0;
/**CFG_DATA1 (rw) register accessor:
...
///
pub mod cfg_data1;
/**CFG_DATA7 (rw) register accessor:
...
///
pub mod cfg_data7;
/**CIS_CONF0 (rw) register accessor:
...
///
pub mod cis_conf0;
/**CIS_CONF1 (rw) register accessor:
...
///
pub mod cis_conf2;
/**CIS_CONF3 (rw) register accessor:
...
///
pub mod cis_conf3;
/**CIS_CONF4 (rw) register accessor:
...
///
pub mod cis_conf4;
/**CIS_CONF5 (rw) register accessor:
...
///
pub mod cis_conf5;
/**CIS_CONF6 (rw) register accessor:
...
///
pub mod cis_conf6;
/**CIS_CONF7 (rw) register accessor:
...
///
pub mod cis_conf7;
/**CFG_DATA16 (rw) register accessor:
