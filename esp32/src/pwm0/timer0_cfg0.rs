...
pub type TIMER0_PRESCALE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TIMER0_PRESCALE` writer - "]
pub type TIMER0_PRESCALE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIMER0_CFG0_SPEC, u8, u8, 8, O>;
...
pub type TIMER0_PERIOD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIMER0_CFG0_SPEC, u16, u16, 16, O>;
#[doc = "Field `TIMER0_PERIOD_UPMETHOD` reader - "]
pub type TIMER0_PERIOD_UPMETHOD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TIMER0_PERIOD_UPMETHOD` writer - "]
pub type TIMER0_PERIOD_UPMETHOD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIMER0_CFG0_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
