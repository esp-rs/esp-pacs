...
pub type TIMER2_PHASE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIMER2_SYNC_SPEC, u16, u16, 16, O>;
#[doc = "Field `TIMER2_PHASE_DIRECTION` reader - "]
pub type TIMER2_PHASE_DIRECTION_R = crate::BitReader<bool>;
#[doc = "Field `TIMER2_PHASE_DIRECTION` writer - "]
pub type TIMER2_PHASE_DIRECTION_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TIMER2_SYNC_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
