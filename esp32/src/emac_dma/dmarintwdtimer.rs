///Register `DMARINTWDTIMER` reader
pub type R = crate::R<DMARINTWDTIMER_SPEC>;
///Register `DMARINTWDTIMER` writer
pub type W = crate::W<DMARINTWDTIMER_SPEC>;
///Field `RIWTC` reader - This bit indicates the number of system clock cycles multiplied by 256 for which the watchdog timer is set. The watchdog timer gets triggered with the programmed value after the Rx DMA completes the transfer of a frame for which the RI(RECV_INT) status bit is not set because of the setting in the corresponding descriptor RDES1\[31\]. When the watchdog timer runs out the RI bit is set and the timer is stopped. The watchdog timer is reset when the RI bit is set high because of automatic setting of RI as per RDES1\[31\] of any received frame.
pub type RIWTC_R = crate::FieldReader;
///Field `RIWTC` writer - This bit indicates the number of system clock cycles multiplied by 256 for which the watchdog timer is set. The watchdog timer gets triggered with the programmed value after the Rx DMA completes the transfer of a frame for which the RI(RECV_INT) status bit is not set because of the setting in the corresponding descriptor RDES1\[31\]. When the watchdog timer runs out the RI bit is set and the timer is stopped. The watchdog timer is reset when the RI bit is set high because of automatic setting of RI as per RDES1\[31\] of any received frame.
...
///`read()` method returns [`dmarintwdtimer::R`](R) reader structure
impl crate::Readable for DMARINTWDTIMER_SPEC {}
///`write(|w| ..)` method takes [`dmarintwdtimer::W`](W) writer structure
impl crate::Writable for DMARINTWDTIMER_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets DMARINTWDTIMER to value 0
