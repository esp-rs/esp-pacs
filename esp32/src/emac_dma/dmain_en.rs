...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DMAIN_EN")
            .field("dmain_tie", &self.dmain_tie().bit())
            .field("dmain_tse", &self.dmain_tse().bit())
            .field("dmain_tbue", &self.dmain_tbue().bit())
            .field("dmain_tjte", &self.dmain_tjte().bit())
            .field("dmain_oie", &self.dmain_oie().bit())
            .field("dmain_uie", &self.dmain_uie().bit())
            .field("dmain_rie", &self.dmain_rie().bit())
            .field("dmain_rbue", &self.dmain_rbue().bit())
            .field("dmain_rse", &self.dmain_rse().bit())
            .field("dmain_rwte", &self.dmain_rwte().bit())
            .field("dmain_etie", &self.dmain_etie().bit())
            .field("dmain_fbee", &self.dmain_fbee().bit())
            .field("dmain_erie", &self.dmain_erie().bit())
            .field("dmain_aise", &self.dmain_aise().bit())
            .field("dmain_nise", &self.dmain_nise().bit())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
