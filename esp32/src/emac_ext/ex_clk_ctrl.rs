///Register `EX_CLK_CTRL` reader
pub type R = crate::R<EX_CLK_CTRL_SPEC>;
///Register `EX_CLK_CTRL` writer
...
///`read()` method returns [`ex_clk_ctrl::R`](R) reader structure
impl crate::Readable for EX_CLK_CTRL_SPEC {}
///`write(|w| ..)` method takes [`ex_clk_ctrl::W`](W) writer structure
impl crate::Writable for EX_CLK_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EX_CLK_CTRL to value 0
