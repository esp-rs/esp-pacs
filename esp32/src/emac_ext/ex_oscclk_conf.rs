...
///`read()` method returns [`ex_oscclk_conf::R`](R) reader structure
impl crate::Readable for EX_OSCCLK_CONF_SPEC {}
///`write(|w| ..)` method takes [`ex_oscclk_conf::W`](W) writer structure
impl crate::Writable for EX_OSCCLK_CONF_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EX_OSCCLK_CONF to value 0
