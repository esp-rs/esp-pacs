...
///`read()` method returns [`pd_sel::R`](R) reader structure
impl crate::Readable for PD_SEL_SPEC {}
///`write(|w| ..)` method takes [`pd_sel::W`](W) writer structure
impl crate::Writable for PD_SEL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets PD_SEL to value 0
