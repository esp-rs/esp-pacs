///Register `EX_DATE` reader
pub type R = crate::R<EX_DATE_SPEC>;
///Register `EX_DATE` writer
...
///`read()` method returns [`ex_date::R`](R) reader structure
impl crate::Readable for EX_DATE_SPEC {}
///`write(|w| ..)` method takes [`ex_date::W`](W) writer structure
impl crate::Writable for EX_DATE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets EX_DATE to value 0
