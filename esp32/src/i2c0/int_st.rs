...
///Field `RXFIFO_FULL` reader - The masked interrupt status for rxfifo_full_int interrupt.
pub type RXFIFO_FULL_R = crate::BitReader;
///Field `TXFIFO_EMPTY` reader - The masked interrupt status for txfifo_empty_int interrupt.
pub type TXFIFO_EMPTY_R = crate::BitReader;
///Field `RXFIFO_OVF` reader - The masked interrupt status for rxfifo_ovf_int interrupt.
pub type RXFIFO_OVF_R = crate::BitReader;
///Field `END_DETECT` reader - The masked interrupt status for end_detect_int interrupt.
pub type END_DETECT_R = crate::BitReader;
///Field `SLAVE_TRAN_COMP` reader - The masked interrupt status for slave_tran_comp_int interrupt.
pub type SLAVE_TRAN_COMP_R = crate::BitReader;
///Field `ARBITRATION_LOST` reader - The masked interrupt status for arbitration_lost_int interrupt.
pub type ARBITRATION_LOST_R = crate::BitReader;
///Field `MASTER_TRAN_COMP` reader - The masked interrupt status for master_tran_comp_int interrupt.
pub type MASTER_TRAN_COMP_R = crate::BitReader;
///Field `TRANS_COMPLETE` reader - The masked interrupt status for trans_complete_int interrupt.
pub type TRANS_COMPLETE_R = crate::BitReader;
///Field `TIME_OUT` reader - The masked interrupt status for time_out_int interrupt.
pub type TIME_OUT_R = crate::BitReader;
///Field `TRANS_START` reader - The masked interrupt status for trans_start_int interrupt.
pub type TRANS_START_R = crate::BitReader;
///Field `ACK_ERR` reader - The masked interrupt status for ack_err_int interrupt.
pub type ACK_ERR_R = crate::BitReader;
///Field `RX_REC_FULL` reader - The masked interrupt status for rx_rec_full_int interrupt.
pub type RX_REC_FULL_R = crate::BitReader;
///Field `TX_SEND_EMPTY` reader - The masked interrupt status for tx_send_empty_int interrupt.
