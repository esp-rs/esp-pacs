///Register `FIFO_START_ADDR` reader
pub type R = crate::R<FIFO_START_ADDR_SPEC>;
///Register `FIFO_START_ADDR` writer
...
///`read()` method returns [`fifo_start_addr::R`](R) reader structure
impl crate::Readable for FIFO_START_ADDR_SPEC {}
///`write(|w| ..)` method takes [`fifo_start_addr::W`](W) writer structure
