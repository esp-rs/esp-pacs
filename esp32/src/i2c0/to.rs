...
///Field `TIME_OUT` reader - This register is used to configure the max clock number of receiving a data.
pub type TIME_OUT_R = crate::FieldReader<u32>;
///Field `TIME_OUT` writer - This register is used to configure the max clock number of receiving a data.
pub type TIME_OUT_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
impl R {
    ///Bits 0:19 - This register is used to configure the max clock number of receiving a data.
    #[inline(always)]
