...
///Field `SLAVE_ADDR` reader - when configured as i2c slave this register is used to configure slave's address.
pub type SLAVE_ADDR_R = crate::FieldReader<u16>;
///Field `SLAVE_ADDR` writer - when configured as i2c slave this register is used to configure slave's address.
pub type SLAVE_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 15, u16>;
///Field `ADDR_10BIT_EN` reader - This register is used to enable slave 10bit address mode.
pub type ADDR_10BIT_EN_R = crate::BitReader;
///Field `ADDR_10BIT_EN` writer - This register is used to enable slave 10bit address mode.
