...
///Field `TIME` reader - This register is used to configure the clock num after the STOP bit's posedge.
pub type TIME_R = crate::FieldReader<u16>;
///Field `TIME` writer - This register is used to configure the clock num after the STOP bit's posedge.
pub type TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    ///Bits 0:13 - This register is used to configure the clock num after the STOP bit's posedge.
    #[inline(always)]
