...
///Register `SCL_FILTER_CFG` writer
pub type W = crate::W<SCL_FILTER_CFG_SPEC>;
///Field `SCL_FILTER_THRES` reader - When input SCL's pulse width is smaller than this register value I2C ignores this pulse.
pub type SCL_FILTER_THRES_R = crate::FieldReader;
///Field `SCL_FILTER_THRES` writer - When input SCL's pulse width is smaller than this register value I2C ignores this pulse.
...
///`read()` method returns [`scl_filter_cfg::R`](R) reader structure
impl crate::Readable for SCL_FILTER_CFG_SPEC {}
///`write(|w| ..)` method takes [`scl_filter_cfg::W`](W) writer structure
impl crate::Writable for SCL_FILTER_CFG_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SCL_FILTER_CFG to value 0x08
