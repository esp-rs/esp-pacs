...
///Field `TIME` reader - This register is used to configure the clock num between the posedge of SCL and the posedge of SDA.
pub type TIME_R = crate::FieldReader<u16>;
///Field `TIME` writer - This register is used to configure the clock num between the posedge of SCL and the posedge of SDA.
pub type TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    ///Bits 0:9 - This register is used to configure the clock num between the posedge of SCL and the posedge of SDA.
    #[inline(always)]
