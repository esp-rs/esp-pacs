...
///Field `RXFIFO_FULL` reader - The enable bit for rxfifo_full_int interrupt.
pub type RXFIFO_FULL_R = crate::BitReader;
///Field `RXFIFO_FULL` writer - The enable bit for rxfifo_full_int interrupt.
pub type RXFIFO_FULL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_EMPTY` reader - The enable bit for txfifo_empty_int interrupt.
pub type TXFIFO_EMPTY_R = crate::BitReader;
///Field `TXFIFO_EMPTY` writer - The enable bit for txfifo_empty_int interrupt.
pub type TXFIFO_EMPTY_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RXFIFO_OVF` reader - The enable bit for rxfifo_ovf_int interrupt.
pub type RXFIFO_OVF_R = crate::BitReader;
///Field `RXFIFO_OVF` writer - The enable bit for rxfifo_ovf_int interrupt.
pub type RXFIFO_OVF_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `END_DETECT` reader - The enable bit for end_detect_int interrupt.
pub type END_DETECT_R = crate::BitReader;
///Field `END_DETECT` writer - The enable bit for end_detect_int interrupt.
pub type END_DETECT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SLAVE_TRAN_COMP` reader - The enable bit for slave_tran_comp_int interrupt.
pub type SLAVE_TRAN_COMP_R = crate::BitReader;
///Field `SLAVE_TRAN_COMP` writer - The enable bit for slave_tran_comp_int interrupt.
pub type SLAVE_TRAN_COMP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ARBITRATION_LOST` reader - The enable bit for arbitration_lost_int interrupt.
pub type ARBITRATION_LOST_R = crate::BitReader;
///Field `ARBITRATION_LOST` writer - The enable bit for arbitration_lost_int interrupt.
pub type ARBITRATION_LOST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MASTER_TRAN_COMP` reader - The enable bit for master_tran_comp_int interrupt.
pub type MASTER_TRAN_COMP_R = crate::BitReader;
///Field `MASTER_TRAN_COMP` writer - The enable bit for master_tran_comp_int interrupt.
pub type MASTER_TRAN_COMP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_COMPLETE` reader - The enable bit for trans_complete_int interrupt.
pub type TRANS_COMPLETE_R = crate::BitReader;
///Field `TRANS_COMPLETE` writer - The enable bit for trans_complete_int interrupt.
pub type TRANS_COMPLETE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIME_OUT` reader - The enable bit for time_out_int interrupt.
pub type TIME_OUT_R = crate::BitReader;
///Field `TIME_OUT` writer - The enable bit for time_out_int interrupt.
pub type TIME_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_START` reader - The enable bit for trans_start_int interrupt.
pub type TRANS_START_R = crate::BitReader;
///Field `TRANS_START` writer - The enable bit for trans_start_int interrupt.
pub type TRANS_START_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ACK_ERR` reader - The enable bit for ack_err_int interrupt.
pub type ACK_ERR_R = crate::BitReader;
///Field `ACK_ERR` writer - The enable bit for ack_err_int interrupt.
pub type ACK_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_REC_FULL` reader - The enable bit for rx_rec_full_int interrupt.
pub type RX_REC_FULL_R = crate::BitReader;
///Field `RX_REC_FULL` writer - The enable bit for rx_rec_full_int interrupt.
pub type RX_REC_FULL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_SEND_EMPTY` reader - The enable bit for tx_send_empty_int interrupt.
pub type TX_SEND_EMPTY_R = crate::BitReader;
///Field `TX_SEND_EMPTY` writer - The enable bit for tx_send_empty_int interrupt.
