...
///Field `SDA_FILTER_THRES` reader - When input SCL's pulse width is smaller than this register value I2C ignores this pulse.
pub type SDA_FILTER_THRES_R = crate::FieldReader;
///Field `SDA_FILTER_THRES` writer - When input SCL's pulse width is smaller than this register value I2C ignores this pulse.
...
///`read()` method returns [`sda_filter_cfg::R`](R) reader structure
impl crate::Readable for SDA_FILTER_CFG_SPEC {}
///`write(|w| ..)` method takes [`sda_filter_cfg::W`](W) writer structure
impl crate::Writable for SDA_FILTER_CFG_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets SDA_FILTER_CFG to value 0x08
