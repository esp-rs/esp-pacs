...
///Field `SCL_HIGH_PERIOD` reader - This register is used to configure the clock num during SCL is low level.
pub type SCL_HIGH_PERIOD_R = crate::FieldReader<u16>;
///Field `SCL_HIGH_PERIOD` writer - This register is used to configure the clock num during SCL is low level.
pub type SCL_HIGH_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    ///Bits 0:13 - This register is used to configure the clock num during SCL is low level.
    #[inline(always)]
