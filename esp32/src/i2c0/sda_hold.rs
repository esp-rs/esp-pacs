...
///Field `TIME` reader - This register is used to configure the clock num I2C used to hold the data after the negedge of SCL.
pub type TIME_R = crate::FieldReader<u16>;
///Field `TIME` writer - This register is used to configure the clock num I2C used to hold the data after the negedge of SCL.
pub type TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    ///Bits 0:9 - This register is used to configure the clock num I2C used to hold the data after the negedge of SCL.
    #[inline(always)]
