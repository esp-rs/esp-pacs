...
///Field `SCL_LOW_PERIOD` reader - This register is used to configure the low level width of SCL clock.
pub type SCL_LOW_PERIOD_R = crate::FieldReader<u16>;
///Field `SCL_LOW_PERIOD` writer - This register is used to configure the low level width of SCL clock.
pub type SCL_LOW_PERIOD_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    ///Bits 0:13 - This register is used to configure the low level width of SCL clock.
    #[inline(always)]
