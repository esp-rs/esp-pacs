...
///Field `FIFO_RDATA` reader - The register represent the byte data read from rxfifo when use apb fifo access
pub type FIFO_RDATA_R = crate::FieldReader;
impl R {
    ///Bits 0:7 - The register represent the byte data read from rxfifo when use apb fifo access
    #[inline(always)]
