...
///
pub mod fifo_conf;
/**RXEOF_NUM (rw) register accessor:
...
///
pub mod rxeof_num;
/**CONF_SIGLE_DATA (rw) register accessor:
...
/**CONF_CHAN (rw) register accessor:
...
/**IN_EOF_DES_ADDR (r) register accessor:
...
///
pub mod lc_conf;
/**OUTFIFO_PUSH (rw) register accessor:
...
/**INFIFO_POP (rw) register accessor:
...
///
pub mod lc_state1;
/**LC_HUNG_CONF (rw) register accessor:
...
/**CVSD_CONF0 (rw) register accessor:
...
///
pub mod cvsd_conf0;
/**CVSD_CONF1 (rw) register accessor:
...
///
pub mod cvsd_conf2;
/**PLC_CONF0 (rw) register accessor:
...
///
pub mod plc_conf0;
/**PLC_CONF1 (rw) register accessor:
...
///
pub mod plc_conf2;
/**ESCO_CONF0 (rw) register accessor:
...
///
pub mod esco_conf0;
/**SCO_CONF0 (rw) register accessor:
...
///
pub mod conf2;
/**CLKM_CONF (rw) register accessor:
...
///
pub mod clkm_conf;
/**SAMPLE_RATE_CONF (rw) register accessor:
...
///
pub mod pdm_conf;
/**PDM_FREQ_CONF (rw) register accessor:
