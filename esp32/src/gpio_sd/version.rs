...
pub type SD_DATE_W<'a, REG> = crate::FieldWriter<'a, REG, 28, u32>;
impl R {
    #[doc = "Bits 0:27"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sd_date(&mut self) -> SD_DATE_W<VERSION_SPEC> {
        SD_DATE_W::new(self, 0)
    }
...
impl crate::Resettable for VERSION_SPEC {
    const RESET_VALUE: Self::Ux = 0x0150_6190;
}
