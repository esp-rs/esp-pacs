...
pub type GPIO_SD1_IN_W<'a, const O: u8> =
...
pub type GPIO_SD1_PRESCALE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SIGMADELTA1_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:7"]
    #[inline(always)]
    pub fn gpio_sd1_in(&mut self) -> GPIO_SD1_IN_W<0> {
        GPIO_SD1_IN_W::new(self)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    pub fn gpio_sd1_prescale(&mut self) -> GPIO_SD1_PRESCALE_W<8> {
