///Register `MODEXP_MODE` reader
pub type R = crate::R<MODEXP_MODE_SPEC>;
///Register `MODEXP_MODE` writer
pub type W = crate::W<MODEXP_MODE_SPEC>;
///Field `MODEXP_MODE` reader - This register contains the mode of modular exponentiation.
pub type MODEXP_MODE_R = crate::FieldReader;
///Field `MODEXP_MODE` writer - This register contains the mode of modular exponentiation.
pub type MODEXP_MODE_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ///Bits 0:2 - This register contains the mode of modular exponentiation.
    #[inline(always)]
...
///`read()` method returns [`modexp_mode::R`](R) reader structure
impl crate::Readable for MODEXP_MODE_SPEC {}
///`write(|w| ..)` method takes [`modexp_mode::W`](W) writer structure
impl crate::Writable for MODEXP_MODE_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets MODEXP_MODE to value 0
