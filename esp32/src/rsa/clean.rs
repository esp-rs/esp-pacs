...
///Field `CLEAN` reader - This bit will read 1 once the memory initialization is completed.
pub type CLEAN_R = crate::BitReader;
impl R {
    ///Bit 0 - This bit will read 1 once the memory initialization is completed.
    #[inline(always)]
