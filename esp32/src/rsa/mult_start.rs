...
///Field `MULT_START` writer - Write 1 to start modular multiplication or multiplication.
...
impl W {
    ///Bit 0 - Write 1 to start modular multiplication or multiplication.
    #[inline(always)]
    #[must_use]
...
///`write(|w| ..)` method takes [`mult_start::W`](W) writer structure
