...
#[doc = "Field `RXFIFO_RD_BYTE` reader - This register stores one byte data read by rx fifo."]
pub type RXFIFO_RD_BYTE_R = crate::FieldReader;
#[doc = "Field `RXFIFO_RD_BYTE` writer - This register stores one byte data read by rx fifo."]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FIFO")
            .field("rxfifo_rd_byte", &self.rxfifo_rd_byte().bits())
            .finish()
    }
}
#[cfg(feature = "impl-register-debug")]
