...
///Field `CHAR_NUM` reader - This register is used to configure the num of continous at_cmd chars received by receiver.
pub type CHAR_NUM_R = crate::FieldReader;
///Field `CHAR_NUM` writer - This register is used to configure the num of continous at_cmd chars received by receiver.
