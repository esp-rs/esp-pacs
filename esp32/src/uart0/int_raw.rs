...
///Field `RXFIFO_FULL` reader - This interrupt raw bit turns to high level when receiver receives more data than (rx_flow_thrhd_h3 rx_flow_thrhd).
pub type RXFIFO_FULL_R = crate::BitReader;
///Field `TXFIFO_EMPTY` reader - This interrupt raw bit turns to high level when the amount of data in transmitter's fifo is less than ((tx_mem_cnttxfifo_cnt) .
pub type TXFIFO_EMPTY_R = crate::BitReader;
///Field `PARITY_ERR` reader - This interrupt raw bit turns to high level when receiver detects the parity error of data.
pub type PARITY_ERR_R = crate::BitReader;
///Field `FRM_ERR` reader - This interrupt raw bit turns to high level when receiver detects data's frame error .
...
///Field `BRK_DET` reader - This interrupt raw bit turns to high level when receiver detects the 0 after the stop bit.
...
///Field `SW_XON` reader - This interrupt raw bit turns to high level when receiver receives xoff char with uart_sw_flow_con_en is set to 1.
pub type SW_XON_R = crate::BitReader;
///Field `SW_XOFF` reader - This interrupt raw bit turns to high level when receiver receives xon char with uart_sw_flow_con_en is set to 1.
pub type SW_XOFF_R = crate::BitReader;
///Field `GLITCH_DET` reader - This interrupt raw bit turns to high level when receiver detects the start bit.
pub type GLITCH_DET_R = crate::BitReader;
///Field `TX_BRK_DONE` reader - This interrupt raw bit turns to high level when transmitter completes sendding 0 after all the datas in transmitter's fifo are send.
pub type TX_BRK_DONE_R = crate::BitReader;
///Field `TX_BRK_IDLE_DONE` reader - This interrupt raw bit turns to high level when transmitter has kept the shortest duration after the last data has been send.
pub type TX_BRK_IDLE_DONE_R = crate::BitReader;
///Field `TX_DONE` reader - This interrupt raw bit turns to high level when transmitter has send all the data in fifo.
pub type TX_DONE_R = crate::BitReader;
///Field `RS485_PARITY_ERR` reader - This interrupt raw bit turns to high level when rs485 detects the parity error.
pub type RS485_PARITY_ERR_R = crate::BitReader;
///Field `RS485_FRM_ERR` reader - This interrupt raw bit turns to high level when rs485 detects the data frame error.
pub type RS485_FRM_ERR_R = crate::BitReader;
///Field `RS485_CLASH` reader - This interrupt raw bit turns to high level when rs485 detects the clash between transmitter and receiver.
pub type RS485_CLASH_R = crate::BitReader;
///Field `AT_CMD_CHAR_DET` reader - This interrupt raw bit turns to high level when receiver detects the configured at_cmd chars.
