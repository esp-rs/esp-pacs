///Register `LOWPULSE` reader
pub type R = crate::R<LOWPULSE_SPEC>;
///Field `MIN_CNT` reader - This register stores the value of the minimum duration time for the low level pulse. it is used in baudrate-detect process.
pub type MIN_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:19 - This register stores the value of the minimum duration time for the low level pulse. it is used in baudrate-detect process.
    #[inline(always)]
...
///`read()` method returns [`lowpulse::R`](R) reader structure
impl crate::Readable for LOWPULSE_SPEC {}
///`reset()` method sets LOWPULSE to value 0x000f_ffff
