///Register `HIGHPULSE` reader
pub type R = crate::R<HIGHPULSE_SPEC>;
///Field `MIN_CNT` reader - This register stores the value of the maxinum duration time for the high level pulse. it is used in baudrate-detect process.
pub type MIN_CNT_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:19 - This register stores the value of the maxinum duration time for the high level pulse. it is used in baudrate-detect process.
    #[inline(always)]
...
///`read()` method returns [`highpulse::R`](R) reader structure
impl crate::Readable for HIGHPULSE_SPEC {}
///`reset()` method sets HIGHPULSE to value 0x000f_ffff
