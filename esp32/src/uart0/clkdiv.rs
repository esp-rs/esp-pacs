...
///Field `CLKDIV` reader - The register value is the integer part of the frequency divider's factor.
pub type CLKDIV_R = crate::FieldReader<u32>;
///Field `CLKDIV` writer - The register value is the integer part of the frequency divider's factor.
pub type CLKDIV_W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
///Field `FRAG` reader - The register value is the decimal part of the frequency divider's factor.
