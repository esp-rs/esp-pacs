...
///Field `BIT_NUM` reader - This registe is used to set the length of data: 0:5bits 1:6bits 2:7bits 3:8bits
pub type BIT_NUM_R = crate::FieldReader;
///Field `BIT_NUM` writer - This registe is used to set the length of data: 0:5bits 1:6bits 2:7bits 3:8bits
pub type BIT_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `STOP_BIT_NUM` reader - This register is used to set the length of stop bit. 1:1bit 2:1.5bits 3:2bits
...
///Field `TXD_BRK` reader - Set this bit to enbale transmitter to send 0 when the process of sending data is done.
pub type TXD_BRK_R = crate::BitReader;
///Field `TXD_BRK` writer - Set this bit to enbale transmitter to send 0 when the process of sending data is done.
...
///Field `IRDA_WCTL` reader - 1.the irda transmitter's 11th bit is the same to the 10th bit. 0.set irda transmitter's 11th bit to 0.
pub type IRDA_WCTL_R = crate::BitReader;
///Field `IRDA_WCTL` writer - 1.the irda transmitter's 11th bit is the same to the 10th bit. 0.set irda transmitter's 11th bit to 0.
pub type IRDA_WCTL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IRDA_TX_INV` reader - Set this bit to inverse the level value of irda transmitter's level.
pub type IRDA_TX_INV_R = crate::BitReader;
///Field `IRDA_TX_INV` writer - Set this bit to inverse the level value of irda transmitter's level.
pub type IRDA_TX_INV_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `IRDA_RX_INV` reader - Set this bit to inverse the level value of irda receiver's level.
pub type IRDA_RX_INV_R = crate::BitReader;
///Field `IRDA_RX_INV` writer - Set this bit to inverse the level value of irda receiver's level.
...
///Field `TX_FLOW_EN` reader - Set this bit to enable transmitter's flow control function.
pub type TX_FLOW_EN_R = crate::BitReader;
///Field `TX_FLOW_EN` writer - Set this bit to enable transmitter's flow control function.
...
///Field `RXFIFO_RST` reader - Set this bit to reset uart receiver's fifo.
pub type RXFIFO_RST_R = crate::BitReader;
///Field `RXFIFO_RST` writer - Set this bit to reset uart receiver's fifo.
pub type RXFIFO_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TXFIFO_RST` reader - Set this bit to reset uart transmitter's fifo.
pub type TXFIFO_RST_R = crate::BitReader;
///Field `TXFIFO_RST` writer - Set this bit to reset uart transmitter's fifo.
...
///Field `CLK_EN` reader - 1.force clock on for registers.support clock only when write registers
pub type CLK_EN_R = crate::BitReader;
///Field `CLK_EN` writer - 1.force clock on for registers.support clock only when write registers
pub type CLK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ERR_WR_MASK` reader - 1.receiver stops storing data int fifo when data is wrong. 0.receiver stores the data even if the received data is wrong.
pub type ERR_WR_MASK_R = crate::BitReader;
///Field `ERR_WR_MASK` writer - 1.receiver stops storing data int fifo when data is wrong. 0.receiver stores the data even if the received data is wrong.
pub type ERR_WR_MASK_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TICK_REF_ALWAYS_ON` reader - This register is used to select the clock.1.apb clock 0:ref_tick
pub type TICK_REF_ALWAYS_ON_R = crate::BitReader;
///Field `TICK_REF_ALWAYS_ON` writer - This register is used to select the clock.1.apb clock 0:ref_tick
...
///`reset()` method sets CONF0 to value 0x0800_001c
impl crate::Resettable for CONF0_SPEC {
    const RESET_VALUE: u32 = 0x0800_001c;
}
