...
///Field `MEM_RX_STATUS` reader - This register stores the current uart rx mem read address and rx mem write address
pub type MEM_RX_STATUS_R = crate::FieldReader<u32>;
///Field `MEM_RX_RD_ADDR` reader - This register stores the rx mem read address
pub type MEM_RX_RD_ADDR_R = crate::FieldReader<u16>;
///Field `MEM_RX_WR_ADDR` reader - This register stores the rx mem write address
