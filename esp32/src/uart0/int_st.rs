...
///Field `FRM_ERR` reader - This is the status bit for frm_err_int_raw when fm_err_int_ena is set to 1.
...
///Field `RS485_FRM_ERR` reader - This is the status bit for rs485_fm_err_int_raw when rs485_fm_err_int_ena is set to 1.
