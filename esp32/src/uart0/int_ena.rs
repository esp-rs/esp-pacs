...
#[doc = "Field `TXFIFO_EMPTY` reader - This is the enable bit for rxfifo_full_int_st register."]
pub type TXFIFO_EMPTY_R = crate::BitReader;
#[doc = "Field `TXFIFO_EMPTY` writer - This is the enable bit for rxfifo_full_int_st register."]
