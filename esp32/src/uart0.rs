...
///
pub mod rxd_cnt;
/**FLOW_CONF (rw) register accessor:
...
///
pub mod flow_conf;
/**SLEEP_CONF (rw) register accessor:
...
///
pub mod sleep_conf;
/**SWFC_CONF (rw) register accessor:
...
///
pub mod swfc_conf;
/**IDLE_CONF (rw) register accessor:
...
///
pub mod idle_conf;
/**RS485_CONF (rw) register accessor:
...
///
pub mod rs485_conf;
/**AT_CMD_PRECNT (rw) register accessor:
...
/**AT_CMD_POSTCNT (rw) register accessor:
...
/**AT_CMD_GAPTOUT (rw) register accessor:
...
/**AT_CMD_CHAR (rw) register accessor:
...
/**MEM_CNT_STATUS (r) register accessor:
