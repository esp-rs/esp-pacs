///Register `TIMER_INT` reader
pub type R = crate::R<TIMER_INT_SPEC>;
///Register `TIMER_INT` writer
...
///`read()` method returns [`timer_int::R`](R) reader structure
impl crate::Readable for TIMER_INT_SPEC {}
///`write(|w| ..)` method takes [`timer_int::W`](W) writer structure
impl crate::Writable for TIMER_INT_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMER_INT to value 0
