...
///`read()` method returns [`timer_ctrl::R`](R) reader structure
impl crate::Readable for TIMER_CTRL_SPEC {}
///`write(|w| ..)` method takes [`timer_ctrl::W`](W) writer structure
impl crate::Writable for TIMER_CTRL_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMER_CTRL to value 0
