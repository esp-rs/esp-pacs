///Register `TIMER_LOAD` reader
pub type R = crate::R<TIMER_LOAD_SPEC>;
///Register `TIMER_LOAD` writer
...
///`read()` method returns [`timer_load::R`](R) reader structure
impl crate::Readable for TIMER_LOAD_SPEC {}
///`write(|w| ..)` method takes [`timer_load::W`](W) writer structure
impl crate::Writable for TIMER_LOAD_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMER_LOAD to value 0
