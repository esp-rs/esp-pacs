...
///`read()` method returns [`timer_alarm::R`](R) reader structure
impl crate::Readable for TIMER_ALARM_SPEC {}
///`write(|w| ..)` method takes [`timer_alarm::W`](W) writer structure
impl crate::Writable for TIMER_ALARM_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMER_ALARM to value 0
