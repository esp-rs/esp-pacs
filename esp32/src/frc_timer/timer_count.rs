...
///`read()` method returns [`timer_count::R`](R) reader structure
impl crate::Readable for TIMER_COUNT_SPEC {}
///`write(|w| ..)` method takes [`timer_count::W`](W) writer structure
impl crate::Writable for TIMER_COUNT_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
///`reset()` method sets TIMER_COUNT to value 0
