...
///
pub mod int_clr;
/**DMA_OUT_STATUS (r) register accessor:
...
/**DMA_OUT_PUSH (rw) register accessor:
...
/**DMA_IN_POP (rw) register accessor:
...
///
pub mod state1;
/**DMA_OUT_EOF_DES_ADDR (r) register accessor:
...
/**DMA_IN_SUC_EOF_DES_ADDR (r) register accessor:
...
/**DMA_IN_ERR_EOF_DES_ADDR (r) register accessor:
...
/**DMA_OUT_EOF_BFR_DES_ADDR (r) register accessor:
...
///
pub mod ahb_test;
/**DMA_IN_DSCR (r) register accessor:
...
///
pub mod dma_in_dscr;
/**DMA_IN_DSCR_BF0 (r) register accessor:
...
/**DMA_IN_DSCR_BF1 (r) register accessor:
...
/**DMA_OUT_DSCR (r) register accessor:
...
/**DMA_OUT_DSCR_BF0 (r) register accessor:
...
/**DMA_OUT_DSCR_BF1 (r) register accessor:
...
/**ESCAPE_CONF (rw) register accessor:
...
///
pub mod escape_conf;
/**HUNG_CONF (rw) register accessor:
...
///
pub mod rx_head;
/**QUICK_SENT (rw) register accessor:
...
///
pub mod esc_conf;
/**PKT_THRES (rw) register accessor:
