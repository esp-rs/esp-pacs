...
pub type CD_W<'a> = crate::FieldWriter<'a, u32, CLOCK_DIVIDER_SPEC, u8, u8, 3, 0>;
...
pub type CLOCK_OFF_W<'a> = crate::BitWriter<'a, u32, CLOCK_DIVIDER_SPEC, bool, 3>;
...
pub type EXT_MODE_W<'a> = crate::BitWriter<'a, u32, CLOCK_DIVIDER_SPEC, bool, 7>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 7 - This bit can be configured under reset mode. 1: Extended mode, compatible with CAN2.0B; 0: Basic mode"]
    #[inline(always)]
    pub fn ext_mode(&mut self) -> EXT_MODE_W {
        EXT_MODE_W::new(self)
    }
