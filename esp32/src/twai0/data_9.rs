...
///Field `TX_BYTE_9` reader - Stored the 9th byte information of the data to be transmitted under operating mode.
pub type TX_BYTE_9_R = crate::FieldReader;
///Field `TX_BYTE_9` writer - Stored the 9th byte information of the data to be transmitted under operating mode.
