...
///Field `RX_ERR_CNT` reader - The RX error counter register, reflects value changes under reception status.
pub type RX_ERR_CNT_R = crate::FieldReader;
///Field `RX_ERR_CNT` writer - The RX error counter register, reflects value changes under reception status.
pub type RX_ERR_CNT_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - The RX error counter register, reflects value changes under reception status.
    #[inline(always)]
