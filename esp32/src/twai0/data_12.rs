...
///Field `TX_BYTE_12` reader - Stored the 12th byte information of the data to be transmitted under operating mode.
pub type TX_BYTE_12_R = crate::FieldReader;
///Field `TX_BYTE_12` writer - Stored the 12th byte information of the data to be transmitted under operating mode.
pub type TX_BYTE_12_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - Stored the 12th byte information of the data to be transmitted under operating mode.
    #[inline(always)]
