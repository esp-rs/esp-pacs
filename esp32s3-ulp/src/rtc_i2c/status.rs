...
///Field `ACK_REC` reader - ack response
pub type ACK_REC_R = crate::BitReader;
///Field `SLAVE_RW` reader - slave read or write
pub type SLAVE_RW_R = crate::BitReader;
///Field `ARB_LOST` reader - arbitration is lost
pub type ARB_LOST_R = crate::BitReader;
///Field `BUS_BUSY` reader - bus is busy
pub type BUS_BUSY_R = crate::BitReader;
///Field `SLAVE_ADDRESSED` reader - slave reg sub address
pub type SLAVE_ADDRESSED_R = crate::BitReader;
///Field `BYTE_TRANS` reader - One byte transit done
pub type BYTE_TRANS_R = crate::BitReader;
///Field `OP_CNT` reader - which operation is working
