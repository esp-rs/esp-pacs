...
///Field `I2C_CTRL_CLK_GATE_EN` reader - configure i2c ctrl clk enable
pub type I2C_CTRL_CLK_GATE_EN_R = crate::BitReader;
///Field `I2C_CTRL_CLK_GATE_EN` writer - configure i2c ctrl clk enable
pub type I2C_CTRL_CLK_GATE_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2C_RESET` reader - rtc i2c sw reset
pub type I2C_RESET_R = crate::BitReader;
///Field `I2C_RESET` writer - rtc i2c sw reset
pub type I2C_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `I2CCLK_EN` reader - rtc i2c reg clk gating
pub type I2CCLK_EN_R = crate::BitReader;
///Field `I2CCLK_EN` writer - rtc i2c reg clk gating
