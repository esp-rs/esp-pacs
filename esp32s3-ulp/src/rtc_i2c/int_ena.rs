...
///Field `SLAVE_TRAN_COMP` reader - enable slave transit complete interrupt
pub type SLAVE_TRAN_COMP_R = crate::BitReader;
///Field `SLAVE_TRAN_COMP` writer - enable slave transit complete interrupt
pub type SLAVE_TRAN_COMP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ARBITRATION_LOST` reader - enable arbitration lost interrupt
pub type ARBITRATION_LOST_R = crate::BitReader;
///Field `ARBITRATION_LOST` writer - enable arbitration lost interrupt
pub type ARBITRATION_LOST_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MASTER_TRAN_COMP` reader - enable master transit complete interrupt
pub type MASTER_TRAN_COMP_R = crate::BitReader;
///Field `MASTER_TRAN_COMP` writer - enable master transit complete interrupt
pub type MASTER_TRAN_COMP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TRANS_COMPLETE` reader - enable transit complete interrupt
pub type TRANS_COMPLETE_R = crate::BitReader;
///Field `TRANS_COMPLETE` writer - enable transit complete interrupt
pub type TRANS_COMPLETE_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TIME_OUT` reader - enable time out interrupt
pub type TIME_OUT_R = crate::BitReader;
///Field `TIME_OUT` writer - enable time out interrupt
pub type TIME_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ACK_ERR` reader - enable eack error interrupt
pub type ACK_ERR_R = crate::BitReader;
///Field `ACK_ERR` writer - enable eack error interrupt
pub type ACK_ERR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `RX_DATA` reader - enable receive data interrupt
pub type RX_DATA_R = crate::BitReader;
///Field `RX_DATA` writer - enable receive data interrupt
pub type RX_DATA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `TX_DATA` reader - enable transit data interrupt
pub type TX_DATA_R = crate::BitReader;
///Field `TX_DATA` writer - enable transit data interrupt
pub type TX_DATA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `DETECT_START` reader - enable detect start interrupt
pub type DETECT_START_R = crate::BitReader;
///Field `DETECT_START` writer - enable detect start interrupt
