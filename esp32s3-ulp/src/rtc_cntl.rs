...
/**RTC_ULP_CP_TIMER (rw) register accessor: configure ulp
...
/**RTC_ULP_CP_CTRL (rw) register accessor: configure ulp
...
///configure ulp-riscv
pub mod cocpu_ctrl;
/**RTC_ULP_CP_TIMER_1 (rw) register accessor: configure ulp sleep time
