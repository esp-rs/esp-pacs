...
pub struct R(crate::R<RTC_COCPU_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_COCPU_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_COCPU_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_COCPU_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_COCPU_CTRL` writer"]
pub struct W(crate::W<RTC_COCPU_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_COCPU_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_COCPU_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_COCPU_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type COCPU_CLK_FO_W<'a, const O: u8> = crate::BitWriter<'a, RTC_COCPU_CTRL_SPEC, O>;
...
pub type COCPU_START_2_RESET_DIS_W<'a, const O: u8> =
    crate::FieldWriter<'a, RTC_COCPU_CTRL_SPEC, 6, O>;
...
pub type COCPU_SHUT_W<'a, const O: u8> = crate::BitWriter<'a, RTC_COCPU_CTRL_SPEC, O>;
...
pub type COCPU_SHUT_2_CLK_DIS_W<'a, const O: u8> =
    crate::FieldWriter<'a, RTC_COCPU_CTRL_SPEC, 8, O>;
...
pub type COCPU_SHUT_RESET_EN_W<'a, const O: u8> = crate::BitWriter<'a, RTC_COCPU_CTRL_SPEC, O>;
...
pub type COCPU_SEL_W<'a, const O: u8> = crate::BitWriter<'a, RTC_COCPU_CTRL_SPEC, O>;
...
pub type COCPU_DONE_FORCE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_COCPU_CTRL_SPEC, O>;
...
pub type COCPU_DONE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_COCPU_CTRL_SPEC, O>;
#[doc = "Field `COCPU_SW_INT_TRIGGER` writer - trigger cocpu register interrupt"]
pub type COCPU_SW_INT_TRIGGER_W<'a, const O: u8> = crate::BitWriter<'a, RTC_COCPU_CTRL_SPEC, O>;
...
pub type COCPU_CLKGATE_EN_W<'a, const O: u8> = crate::BitWriter<'a, RTC_COCPU_CTRL_SPEC, O>;
impl R {
...
#[doc = "configure ulp-riscv\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_cocpu_ctrl](index.html) module"]
