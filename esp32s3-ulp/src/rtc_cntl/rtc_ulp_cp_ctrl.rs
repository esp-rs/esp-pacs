///Register `RTC_ULP_CP_CTRL` reader
pub type R = crate::R<RTC_ULP_CP_CTRL_SPEC>;
///Register `RTC_ULP_CP_CTRL` writer
pub type W = crate::W<RTC_ULP_CP_CTRL_SPEC>;
///Field `ULP_CP_MEM_ADDR_INIT` reader - No public
pub type ULP_CP_MEM_ADDR_INIT_R = crate::FieldReader<u16>;
///Field `ULP_CP_MEM_ADDR_INIT` writer - No public
pub type ULP_CP_MEM_ADDR_INIT_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `ULP_CP_MEM_ADDR_SIZE` reader - No public
pub type ULP_CP_MEM_ADDR_SIZE_R = crate::FieldReader<u16>;
///Field `ULP_CP_MEM_ADDR_SIZE` writer - No public
pub type ULP_CP_MEM_ADDR_SIZE_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
///Field `ULP_CP_MEM_OFFST_CLR` writer - No public
pub type ULP_CP_MEM_OFFST_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ULP_CP_CLK_FO` reader - ulp coprocessor clk force on
pub type ULP_CP_CLK_FO_R = crate::BitReader;
///Field `ULP_CP_CLK_FO` writer - ulp coprocessor clk force on
pub type ULP_CP_CLK_FO_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ULP_CP_RESET` reader - ulp coprocessor clk software reset
pub type ULP_CP_RESET_R = crate::BitReader;
///Field `ULP_CP_RESET` writer - ulp coprocessor clk software reset
pub type ULP_CP_RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ULP_CP_FORCE_START_TOP` reader - 1: ULP-coprocessor is started by SW
pub type ULP_CP_FORCE_START_TOP_R = crate::BitReader;
///Field `ULP_CP_FORCE_START_TOP` writer - 1: ULP-coprocessor is started by SW
pub type ULP_CP_FORCE_START_TOP_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ULP_CP_START_TOP` reader - Write 1 to start ULP-coprocessor
pub type ULP_CP_START_TOP_R = crate::BitReader;
///Field `ULP_CP_START_TOP` writer - Write 1 to start ULP-coprocessor
...
///`read()` method returns [`rtc_ulp_cp_ctrl::R`](R) reader structure
impl crate::Readable for RTC_ULP_CP_CTRL_SPEC {}
///`write(|w| ..)` method takes [`rtc_ulp_cp_ctrl::W`](W) writer structure
