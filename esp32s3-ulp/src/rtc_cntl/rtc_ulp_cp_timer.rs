...
impl W {
    #[doc = "Bits 0:10 - ULP-coprocessor PC initial address"]
    #[inline(always)]
    pub fn ulp_cp_pc_init(&mut self) -> ULP_CP_PC_INIT_W<'_, RTC_ULP_CP_TIMER_SPEC> {
    ...
    pub fn ulp_cp_gpio_wakeup_ena(
        &mut self,
    ) -> ULP_CP_GPIO_WAKEUP_ENA_W<'_, RTC_ULP_CP_TIMER_SPEC> {
    ...
    pub fn ulp_cp_gpio_wakeup_clr(
        &mut self,
    ) -> ULP_CP_GPIO_WAKEUP_CLR_W<'_, RTC_ULP_CP_TIMER_SPEC> {
        ULP_CP_GPIO_WAKEUP_CLR_W::new(self, 30)
    }
    #[doc = "Bit 31 - ULP-coprocessor timer enable bit"]
    #[inline(always)]
    pub fn ulp_cp_slp_timer_en(&mut self) -> ULP_CP_SLP_TIMER_EN_W<'_, RTC_ULP_CP_TIMER_SPEC> {
        ULP_CP_SLP_TIMER_EN_W::new(self, 31)
    }
}
#[doc = "configure ulp\n\nYou can [`read`](crate::Reg::read) this register and get [`rtc_ulp_cp_timer::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rtc_ulp_cp_timer::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
