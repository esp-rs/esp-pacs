///Register `RTC_ULP_CP_TIMER` reader
pub type R = crate::R<RTC_ULP_CP_TIMER_SPEC>;
///Register `RTC_ULP_CP_TIMER` writer
...
///Field `ULP_CP_GPIO_WAKEUP_ENA` reader - ULP-coprocessor wakeup by GPIO enable
pub type ULP_CP_GPIO_WAKEUP_ENA_R = crate::BitReader;
///Field `ULP_CP_GPIO_WAKEUP_ENA` writer - ULP-coprocessor wakeup by GPIO enable
pub type ULP_CP_GPIO_WAKEUP_ENA_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `ULP_CP_GPIO_WAKEUP_CLR` writer - ULP-coprocessor wakeup by GPIO state clear
...
///`read()` method returns [`rtc_ulp_cp_timer::R`](R) reader structure
impl crate::Readable for RTC_ULP_CP_TIMER_SPEC {}
///`write(|w| ..)` method takes [`rtc_ulp_cp_timer::W`](W) writer structure
