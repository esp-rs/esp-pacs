///Register `TOUCH_PAD12` reader
pub type R = crate::R<TOUCH_PAD12_SPEC>;
///Register `TOUCH_PAD12` writer
...
///`read()` method returns [`touch_pad12::R`](R) reader structure
impl crate::Readable for TOUCH_PAD12_SPEC {}
///`write(|w| ..)` method takes [`touch_pad12::W`](W) writer structure
