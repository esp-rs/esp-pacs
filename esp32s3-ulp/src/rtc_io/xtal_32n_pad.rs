...
///Field `X32N_FUN_IE` reader - input enable in work mode
pub type X32N_FUN_IE_R = crate::BitReader;
///Field `X32N_FUN_IE` writer - input enable in work mode
...
///Field `X32N_SLP_SEL` reader - 1: enable sleep mode during sleep,0: no sleep mode
pub type X32N_SLP_SEL_R = crate::BitReader;
///Field `X32N_SLP_SEL` writer - 1: enable sleep mode during sleep,0: no sleep mode
pub type X32N_SLP_SEL_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `X32N_FUN_SEL` reader - function sel
pub type X32N_FUN_SEL_R = crate::FieldReader;
///Field `X32N_FUN_SEL` writer - function sel
