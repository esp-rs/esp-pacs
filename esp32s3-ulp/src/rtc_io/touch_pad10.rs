///Register `TOUCH_PAD10` reader
pub type R = crate::R<TOUCH_PAD10_SPEC>;
///Register `TOUCH_PAD10` writer
pub type W = crate::W<TOUCH_PAD10_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fun_ie(&mut self) -> FUN_IE_W<TOUCH_PAD10_SPEC> {
        FUN_IE_W::new(self, 13)
    }
    ///Bit 14 - output enable in sleep mode
    #[inline(always)]
    #[must_use]
    pub fn slp_oe(&mut self) -> SLP_OE_W<TOUCH_PAD10_SPEC> {
        SLP_OE_W::new(self, 14)
    }
    ///Bit 15 - input enable in sleep mode
    #[inline(always)]
    #[must_use]
    pub fn slp_ie(&mut self) -> SLP_IE_W<TOUCH_PAD10_SPEC> {
        SLP_IE_W::new(self, 15)
    }
    ///Bit 16 - 1: enable sleep mode during sleep,0: no sleep mode
    #[inline(always)]
    #[must_use]
    pub fn slp_sel(&mut self) -> SLP_SEL_W<TOUCH_PAD10_SPEC> {
        SLP_SEL_W::new(self, 16)
    }
    ///Bits 17:18 - function sel
    #[inline(always)]
    #[must_use]
    pub fn fun_sel(&mut self) -> FUN_SEL_W<TOUCH_PAD10_SPEC> {
        FUN_SEL_W::new(self, 17)
    }
    ///Bit 19 - 1: use RTC GPIO,0: use digital GPIO
    #[inline(always)]
    #[must_use]
    pub fn mux_sel(&mut self) -> MUX_SEL_W<TOUCH_PAD10_SPEC> {
        MUX_SEL_W::new(self, 19)
    }
    ///Bit 20 - TOUCH_XPD
    #[inline(always)]
    #[must_use]
    pub fn xpd(&mut self) -> XPD_W<TOUCH_PAD10_SPEC> {
        XPD_W::new(self, 20)
    }
    ///Bit 21 - TOUCH_TIE_OPT
    #[inline(always)]
    #[must_use]
    pub fn tie_opt(&mut self) -> TIE_OPT_W<TOUCH_PAD10_SPEC> {
        TIE_OPT_W::new(self, 21)
    }
    ///Bit 22 - TOUCH_START
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> START_W<TOUCH_PAD10_SPEC> {
        START_W::new(self, 22)
    }
    ///Bit 27 - RUE
    #[inline(always)]
    #[must_use]
    pub fn rue(&mut self) -> RUE_W<TOUCH_PAD10_SPEC> {
        RUE_W::new(self, 27)
    }
    ///Bit 28 - RDE
    #[inline(always)]
    #[must_use]
    pub fn rde(&mut self) -> RDE_W<TOUCH_PAD10_SPEC> {
        RDE_W::new(self, 28)
    }
    ///Bits 29:30 - DRV
    #[inline(always)]
    #[must_use]
    pub fn drv(&mut self) -> DRV_W<TOUCH_PAD10_SPEC> {
        DRV_W::new(self, 29)
    }
}
/**configure RTC PAD10

You can [`read`](crate::generic::Reg::read) this register and get [`touch_pad10::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`touch_pad10::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct TOUCH_PAD10_SPEC;
impl crate::RegisterSpec for TOUCH_PAD10_SPEC {
    type Ux = u32;
}
///`read()` method returns [`touch_pad10::R`](R) reader structure
impl crate::Readable for TOUCH_PAD10_SPEC {}
///`write(|w| ..)` method takes [`touch_pad10::W`](W) writer structure
