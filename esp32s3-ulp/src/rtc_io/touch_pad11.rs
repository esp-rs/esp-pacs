///Register `TOUCH_PAD11` reader
pub type R = crate::R<TOUCH_PAD11_SPEC>;
///Register `TOUCH_PAD11` writer
...
///`read()` method returns [`touch_pad11::R`](R) reader structure
impl crate::Readable for TOUCH_PAD11_SPEC {}
///`write(|w| ..)` method takes [`touch_pad11::W`](W) writer structure
