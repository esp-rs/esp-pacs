...
pub type PAD_DRIVER_W<'a, const O: u8> = crate::BitWriter<'a, RTC_GPIO_PIN14_SPEC, O>;
...
pub type INT_TYPE_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_GPIO_PIN14_SPEC, 3, O>;
...
pub type WAKEUP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_GPIO_PIN14_SPEC, O>;
impl R {
