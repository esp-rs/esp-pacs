///Register `TOUCH_PAD14` reader
pub type R = crate::R<TOUCH_PAD14_SPEC>;
///Register `TOUCH_PAD14` writer
...
///`read()` method returns [`touch_pad14::R`](R) reader structure
impl crate::Readable for TOUCH_PAD14_SPEC {}
///`write(|w| ..)` method takes [`touch_pad14::W`](W) writer structure
