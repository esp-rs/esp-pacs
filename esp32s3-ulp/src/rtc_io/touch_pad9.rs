...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fun_ie(&mut self) -> FUN_IE_W<TOUCH_PAD9_SPEC> {
        FUN_IE_W::new(self, 13)
    }
    ///Bit 14 - output enable in sleep mode
    #[inline(always)]
    #[must_use]
    pub fn slp_oe(&mut self) -> SLP_OE_W<TOUCH_PAD9_SPEC> {
        SLP_OE_W::new(self, 14)
    }
    ///Bit 15 - input enable in sleep mode
    #[inline(always)]
    #[must_use]
    pub fn slp_ie(&mut self) -> SLP_IE_W<TOUCH_PAD9_SPEC> {
        SLP_IE_W::new(self, 15)
    }
    ///Bit 16 - 1: enable sleep mode during sleep,0: no sleep mode
    #[inline(always)]
    #[must_use]
    pub fn slp_sel(&mut self) -> SLP_SEL_W<TOUCH_PAD9_SPEC> {
        SLP_SEL_W::new(self, 16)
    }
    ///Bits 17:18 - function sel
    #[inline(always)]
    #[must_use]
    pub fn fun_sel(&mut self) -> FUN_SEL_W<TOUCH_PAD9_SPEC> {
        FUN_SEL_W::new(self, 17)
    }
    ///Bit 19 - 1: use RTC GPIO,0: use digital GPIO
    #[inline(always)]
    #[must_use]
    pub fn mux_sel(&mut self) -> MUX_SEL_W<TOUCH_PAD9_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rue(&mut self) -> RUE_W<TOUCH_PAD9_SPEC> {
        RUE_W::new(self, 27)
    }
    ///Bit 28 - RDE
    #[inline(always)]
    #[must_use]
    pub fn rde(&mut self) -> RDE_W<TOUCH_PAD9_SPEC> {
        RDE_W::new(self, 28)
    }
    ///Bits 29:30 - DRV
    #[inline(always)]
    #[must_use]
    pub fn drv(&mut self) -> DRV_W<TOUCH_PAD9_SPEC> {
        DRV_W::new(self, 29)
    }
}
/**configure RTC PAD9
...
///`read()` method returns [`touch_pad9::R`](R) reader structure
impl crate::Readable for TOUCH_PAD9_SPEC {}
///`write(|w| ..)` method takes [`touch_pad9::W`](W) writer structure
