///Register `TOUCH_PAD13` reader
pub type R = crate::R<TOUCH_PAD13_SPEC>;
///Register `TOUCH_PAD13` writer
...
///`read()` method returns [`touch_pad13::R`](R) reader structure
impl crate::Readable for TOUCH_PAD13_SPEC {}
///`write(|w| ..)` method takes [`touch_pad13::W`](W) writer structure
