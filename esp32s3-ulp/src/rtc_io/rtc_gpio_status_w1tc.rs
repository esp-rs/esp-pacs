...
pub type RTC_GPIO_STATUS_INT_W1TC_W<'a, const O: u8> =
    crate::FieldWriter<'a, RTC_GPIO_STATUS_W1TC_SPEC, 22, O, u32>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtc_gpio_status_int_w1tc(&mut self) -> RTC_GPIO_STATUS_INT_W1TC_W<10> {
