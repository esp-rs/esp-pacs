...
pub type R = crate::R<RTC_GPIO_PIN16_SPEC>;
#[doc = "Register `RTC_GPIO_PIN16` writer"]
pub type W = crate::W<RTC_GPIO_PIN16_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pad_driver(&mut self) -> PAD_DRIVER_W<RTC_GPIO_PIN16_SPEC, 2> {
        PAD_DRIVER_W::new(self)
    }
    #[doc = "Bits 7:9 - if set to 0: GPIO interrupt disable, if set to 1: rising edge trigger, if set to 2: falling edge trigger, if set to 3: any edge trigger, if set to 4: low level trigger, if set to 5: high level trigger"]
    #[inline(always)]
    #[must_use]
    pub fn int_type(&mut self) -> INT_TYPE_W<RTC_GPIO_PIN16_SPEC, 7> {
        INT_TYPE_W::new(self)
    }
    #[doc = "Bit 10 - RTC GPIO wakeup enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn wakeup_enable(&mut self) -> WAKEUP_ENABLE_W<RTC_GPIO_PIN16_SPEC, 10> {
...
#[doc = "configure RTC GPIO16\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rtc_gpio_pin16::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rtc_gpio_pin16::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
