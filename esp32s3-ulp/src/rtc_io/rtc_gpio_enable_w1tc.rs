...
pub type RTC_GPIO_ENABLE_W1TC_W<'a, REG> = crate::FieldWriter<'a, REG, 22, u32>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtc_gpio_enable_w1tc(&mut self) -> RTC_GPIO_ENABLE_W1TC_W<RTC_GPIO_ENABLE_W1TC_SPEC> {
        RTC_GPIO_ENABLE_W1TC_W::new(self, 10)
    }
