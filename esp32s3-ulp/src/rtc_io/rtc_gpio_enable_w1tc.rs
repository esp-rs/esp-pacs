...
pub type RTC_GPIO_ENABLE_W1TC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 22, O, u32>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtc_gpio_enable_w1tc(
        &mut self,
    ) -> RTC_GPIO_ENABLE_W1TC_W<RTC_GPIO_ENABLE_W1TC_SPEC, 10> {
