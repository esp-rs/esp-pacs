#[doc = "Register `RTC_GPIO_PIN5` reader"]
pub struct R(crate::R<RTC_GPIO_PIN5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_GPIO_PIN5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_GPIO_PIN5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_GPIO_PIN5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_GPIO_PIN5` writer"]
pub struct W(crate::W<RTC_GPIO_PIN5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_GPIO_PIN5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_GPIO_PIN5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_GPIO_PIN5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PAD_DRIVER_W<'a, const O: u8> = crate::BitWriter<'a, RTC_GPIO_PIN5_SPEC, O>;
...
pub type INT_TYPE_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_GPIO_PIN5_SPEC, 3, O>;
...
pub type WAKEUP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_GPIO_PIN5_SPEC, O>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RTC_GPIO_PIN5_SPEC> {
...
#[doc = "configure RTC GPIO5\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_gpio_pin5](index.html) module"]
pub struct RTC_GPIO_PIN5_SPEC;
impl crate::RegisterSpec for RTC_GPIO_PIN5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_gpio_pin5::R](R) reader structure"]
impl crate::Readable for RTC_GPIO_PIN5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_gpio_pin5::W](W) writer structure"]
impl crate::Writable for RTC_GPIO_PIN5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RTC_GPIO_PIN5 to value 0"]
impl crate::Resettable for RTC_GPIO_PIN5_SPEC {
