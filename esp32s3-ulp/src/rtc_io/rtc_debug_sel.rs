...
///Field `DEBUG_SEL0` reader - configure rtc debug
pub type DEBUG_SEL0_R = crate::FieldReader;
///Field `DEBUG_SEL0` writer - configure rtc debug
pub type DEBUG_SEL0_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `DEBUG_SEL1` reader - configure rtc debug
pub type DEBUG_SEL1_R = crate::FieldReader;
///Field `DEBUG_SEL1` writer - configure rtc debug
pub type DEBUG_SEL1_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `DEBUG_SEL2` reader - configure rtc debug
pub type DEBUG_SEL2_R = crate::FieldReader;
///Field `DEBUG_SEL2` writer - configure rtc debug
pub type DEBUG_SEL2_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `DEBUG_SEL3` reader - configure rtc debug
pub type DEBUG_SEL3_R = crate::FieldReader;
///Field `DEBUG_SEL3` writer - configure rtc debug
pub type DEBUG_SEL3_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `DEBUG_SEL4` reader - configure rtc debug
pub type DEBUG_SEL4_R = crate::FieldReader;
///Field `DEBUG_SEL4` writer - configure rtc debug
pub type DEBUG_SEL4_W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
///Field `DEBUG_12M_NO_GATING` reader - configure rtc debug
pub type DEBUG_12M_NO_GATING_R = crate::BitReader;
///Field `DEBUG_12M_NO_GATING` writer - configure rtc debug
