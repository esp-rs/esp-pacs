///Register `PIN21` reader
pub type R = crate::R<PIN21_SPEC>;
///Register `PIN21` writer
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pad_driver(&mut self) -> PAD_DRIVER_W<PIN21_SPEC> {
        PAD_DRIVER_W::new(self, 2)
    }
    ///Bits 7:9 - if set to 0: GPIO interrupt disable, if set to 1: rising edge trigger, if set to 2: falling edge trigger, if set to 3: any edge trigger, if set to 4: low level trigger, if set to 5: high level trigger
    #[inline(always)]
    #[must_use]
    pub fn int_type(&mut self) -> INT_TYPE_W<PIN21_SPEC> {
        INT_TYPE_W::new(self, 7)
    }
    ///Bit 10 - RTC GPIO wakeup enable bit
    #[inline(always)]
    #[must_use]
    pub fn wakeup_enable(&mut self) -> WAKEUP_ENABLE_W<PIN21_SPEC> {
        WAKEUP_ENABLE_W::new(self, 10)
    }
}
/**configure RTC GPIO21

You can [`read`](crate::generic::Reg::read) this register and get [`pin21::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pin21::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct PIN21_SPEC;
impl crate::RegisterSpec for PIN21_SPEC {
    type Ux = u32;
}
///`read()` method returns [`pin21::R`](R) reader structure
impl crate::Readable for PIN21_SPEC {}
///`write(|w| ..)` method takes [`pin21::W`](W) writer structure
