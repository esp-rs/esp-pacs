#[doc = "Register `RTC_GPIO_PIN6` reader"]
pub struct R(crate::R<RTC_GPIO_PIN6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_GPIO_PIN6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_GPIO_PIN6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_GPIO_PIN6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_GPIO_PIN6` writer"]
pub struct W(crate::W<RTC_GPIO_PIN6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_GPIO_PIN6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_GPIO_PIN6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_GPIO_PIN6_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PAD_DRIVER_W<'a, const O: u8> = crate::BitWriter<'a, RTC_GPIO_PIN6_SPEC, O>;
...
pub type INT_TYPE_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_GPIO_PIN6_SPEC, 3, O>;
...
pub type WAKEUP_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, RTC_GPIO_PIN6_SPEC, O>;
impl R {
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<RTC_GPIO_PIN6_SPEC> {
...
#[doc = "`reset()` method sets RTC_GPIO_PIN6 to value 0"]
impl crate::Resettable for RTC_GPIO_PIN6_SPEC {
