...
///Field `SAR_COCPU_TOUCH_DONE_INT_CLR` writer - int clear of touch done
pub type SAR_COCPU_TOUCH_DONE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_COCPU_TOUCH_INACTIVE_INT_CLR` writer - int clear of from touch inactive
pub type SAR_COCPU_TOUCH_INACTIVE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_COCPU_TOUCH_ACTIVE_INT_CLR` writer - int clear of touch active
pub type SAR_COCPU_TOUCH_ACTIVE_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_COCPU_SARADC1_INT_CLR` writer - int clear of from saradc1
pub type SAR_COCPU_SARADC1_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_COCPU_SARADC2_INT_CLR` writer - int clear of from saradc2
pub type SAR_COCPU_SARADC2_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_COCPU_TSENS_INT_CLR` writer - int clear of tsens
pub type SAR_COCPU_TSENS_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_COCPU_START_INT_CLR` writer - int clear of start
pub type SAR_COCPU_START_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_COCPU_SW_INT_CLR` writer - int clear of software
pub type SAR_COCPU_SW_INT_CLR_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `SAR_COCPU_SWD_INT_CLR` writer - int clear of super watch dog
