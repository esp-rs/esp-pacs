...
impl W {
    ...
    pub fn sar_cocpu_touch_done_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_DONE_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
    ...
    pub fn sar_cocpu_touch_inactive_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_INACTIVE_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
    ...
    pub fn sar_cocpu_touch_active_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_ACTIVE_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
    ...
    pub fn sar_cocpu_saradc1_int_ena(
        &mut self,
    ) -> SAR_COCPU_SARADC1_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
    ...
    pub fn sar_cocpu_saradc2_int_ena(
        &mut self,
    ) -> SAR_COCPU_SARADC2_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
    ...
    pub fn sar_cocpu_tsens_int_ena(
        &mut self,
    ) -> SAR_COCPU_TSENS_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
    ...
    pub fn sar_cocpu_start_int_ena(
        &mut self,
    ) -> SAR_COCPU_START_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
        SAR_COCPU_START_INT_ENA_W::new(self, 6)
    }
    #[doc = "Bit 7 - int enable of software"]
    #[inline(always)]
    pub fn sar_cocpu_sw_int_ena(&mut self) -> SAR_COCPU_SW_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
        SAR_COCPU_SW_INT_ENA_W::new(self, 7)
    }
    #[doc = "Bit 8 - int enable of super watch dog"]
    #[inline(always)]
    pub fn sar_cocpu_swd_int_ena(&mut self) -> SAR_COCPU_SWD_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
    ...
    pub fn sar_cocpu_touch_timeout_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_TIMEOUT_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
    ...
    pub fn sar_cocpu_touch_approach_loop_done_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
    ...
    pub fn sar_cocpu_touch_scan_done_int_ena(
        &mut self,
    ) -> SAR_COCPU_TOUCH_SCAN_DONE_INT_ENA_W<'_, SAR_COCPU_INT_ENA_SPEC> {
