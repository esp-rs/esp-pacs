...
///`read()` method returns [`sar_slave_addr4::R`](R) reader structure
impl crate::Readable for SAR_SLAVE_ADDR4_SPEC {}
///`write(|w| ..)` method takes [`sar_slave_addr4::W`](W) writer structure
